...
// Function ID: 5425
// Name: RefreshControl
// Dependencies: [32, 109, 19, 17, 21, 5387, 5357, 5388]

// Module 5424 (RefreshControl)
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  const items = [];
  items[HermesBuiltin.arraySpread(require(5357) /* toArray */.toArray(waitFor), 0)] = ref;
  obj.waitFor = items;
...
export const FlatList = importAllResult.forwardRef((arg0, ref) => {
  ...
  while (tmp3 !== undefined) {
    ...
    let nativeViewProps = ref(5388).nativeViewProps;
    let tmp12 = first;
    let tmp13 = tmp9;
