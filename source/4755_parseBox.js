...
// Function ID: 41301
// Name: parseBox
// Dependencies: [4756, 4749, 4746]

// Module 4755 (parseBox)
const require = arg1;
const module = arg2;
...
function parseBox(getUint32, sum) {
  ...
  if (length >= 8) {
    ...
    if (1718909296 === uint32) {
      let obj = { type: "ftyp", majorBrand: require(4746) /* getStringFromDataView */.getStringFromDataView(getUint32, contentOffset, 4), length };
      return obj;
      ...
      if (1835365473 === uint32) {
        ...
        const obj7 = require(4756) /* getItems */;
        ...
        if (!tmp3) {
          ...
          const sum3 = sum2 + 2;
          obj2 = require(4746) /* getStringFromDataView */;
        ...
        if (uint8 >= 2) {
          ...
          const sum7 = sum6 + 4;
          obj3 = require(4746) /* getStringFromDataView */;
          obj4.itemName = obj3.getNullTerminatedStringFromDataView(getUint32, sum7);
          const sum8 = sum7 + (obj4.itemName.length + 1);
          if (obj4.itemType === c4) {
            obj4 = require(4746) /* getStringFromDataView */;
            obj4.contentType = obj4.getNullTerminatedStringFromDataView(getUint32, sum8);
            const sum9 = sum8 + (obj4.contentType.length + 1);
            parseItemLocationBoxResult = obj4;
            if (sum + length > sum9) {
              obj4.contentEncoding = require(4746) /* getStringFromDataView */.getNullTerminatedStringFromDataView(getUint32, sum9);
              const sum10 = obj4.contentEncoding.length + 1;
              parseItemLocationBoxResult = obj4;
              const obj6 = require(4746) /* getStringFromDataView */;
            }
          } else {
            parseItemLocationBoxResult = obj4;
            if (obj4.itemType === c5) {
              obj4.itemUri = require(4746) /* getStringFromDataView */.getNullTerminatedStringFromDataView(getUint32, sum8);
              const sum11 = obj4.itemUri.length + 1;
              parseItemLocationBoxResult = obj4;
              const obj14 = require(4746) /* getStringFromDataView */;
            }
          }
        }
