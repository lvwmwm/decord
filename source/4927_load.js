...
// Function ID: 4928
// Name: load
// Dependencies: [4928, 4929, 4930, 4931, 4932, 4945, 4947, 4948, 4960, 4964, 4968, 4970, 4972, 4973, 4974, 4975, 4976, 4977, 4978, 4979, 4980, 4981, 4954]
// Exports: load
  ...
  if (typeof response === "string") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(4929).dataUriToBuffer(response));
        const obj5 = response(4929);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
