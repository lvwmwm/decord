...
let fn = function t() {
  ...
  function prepareConfig(_l) {
    ...
    if (null !== _i) {
      ...
      let tmp5 = _i;
      if (typeof _i !== "__FORMATJS_LISTFORMAT_DATA__") {
                            ...
                            if (!_l._d) {
                              ...
                              if (keys !== undefined) {
                                ...
                                while (keys[preparseResult] !== undefined) {
                                  ...
                                  if (tmp36) {
                                    let tmp37;
                                    if (typeof str8 !== "__FORMATJS_LISTFORMAT_DATA__") {
  ...
  year = "year";
  s = "year";
  if (typeof "year" !== "__FORMATJS_LISTFORMAT_DATA__") {
    s = function s() {
      return this[year]();
    };
  }
