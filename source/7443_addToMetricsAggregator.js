...
// Dependencies: [7343, 7346, 7348, 7374, 7352, 7375, 7347, 7444, 7361, 7381, 7382]

// Module 7443 (addToMetricsAggregator)
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = require(7374) /* getClient */.getClient();
    const obj2 = require(7374) /* getClient */;
  }
  if (client) {
    const activeSpan = require(7352) /* spanTimeInputToSeconds */.getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    const globalSingleton = require(7348) /* getGlobalSingleton */.getGlobalSingleton("globalMetricsAggregators", () => {
    ...
    const tmp3Result1 = require(7348) /* getGlobalSingleton */;
  }
}
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7444).COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7444).DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, require(7444).SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7444).GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    ...
    if (typeof fn === "function") {
      ...
      return _require(7381).startSpanManual(obj, (arg0) => {
        const callback = arg0;
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _require(7444).DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
  ...
  getMetricsAggregatorForClient(on) {
    ...
    const obj = require(7348) /* getGlobalSingleton */;
  }
};
