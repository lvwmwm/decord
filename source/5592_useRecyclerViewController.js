...
// Dependencies: [5593, 5550, 19, 17, 5594, 5595, 5565, 5596, 5590]
// Exports: useRecyclerViewController

// Module 5592 (useRecyclerViewController)
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  const unmountFlag = _require(5594).useUnmountFlag();
  let obj = _require(5594);
  ...
  _setTimeout = _require(5595).useUnmountAwareTimeout().setTimeout;
