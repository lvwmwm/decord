...
// Function ID: 57695
// Name: trpcMiddleware
// Dependencies: [77, 5, 6307, 6310, 6311, 6339, 6325, 6335, 6359, 6338, 6356, 6345, 6326]
// Exports: trpcMiddleware

// Module 6417 (trpcMiddleware)
import _defineProperty from "_defineProperty";
import asyncGeneratorStep from "module_6339";
      ...
      let closure_0 = outer1_3(async (arg0) => {
        ...
        lib(outer3_1[9]).withScope((setContext) => {
          ...
          return obj.startSpanManual(obj, (() => {
            let closure_0 = outer5_3(/* F57702 */ function*() { ... });
            return () => { ... };
          })());
        });
      });
