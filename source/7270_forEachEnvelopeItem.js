...
// Module 7270 (forEachEnvelopeItem)
...
let closure_4 = { "Bool(true)": "MUR", "Bool(true)": "png", "Bool(true)": "platformTypes", "Bool(true)": "userAvatarSource", "Bool(true)": "Array", "Bool(true)": "unread", "Bool(true)": "Array", "Bool(true)": "ThreadPlusIcon", "Bool(true)": "isArray", "Bool(true)": "isArrayBuffer", "Bool(true)": "tryUpdateSubscriptionForHereMention", "Bool(true)": "WISHLIST_ITEM", "Bool(true)": "unsigned", "Bool(true)": "th", "Bool(true)": "MUR", "Bool(true)": "png" };
