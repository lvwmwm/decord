...
arg5.isFLV = function isFLV(fileChunk) {
  fileChunk = require(4882) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4883).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "flv") && require(4882) /* getFileChunk */.isFlvStringIncluded(fileChunk);
};
arg5.isM4V = function isM4V(fileChunk) {
  fileChunk = require(4882) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4883).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "m4v") && require(4882) /* getFileChunk */.isftypStringIncluded(fileChunk);
};
arg5.isMKV = function isMKV(fileChunk) {
  fileChunk = require(4882) /* getFileChunk */.getFileChunk(fileChunk, 64);
  const FileTypes = require(4883).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "mkv") && "mkv" === require(4882) /* getFileChunk */.findMatroskaDocTypeElements(fileChunk);
};
...
arg5.isWEBM = function isWEBM(fileChunk) {
  fileChunk = require(4882) /* getFileChunk */.getFileChunk(fileChunk, 64);
  const FileTypes = require(4883).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "webm") && "webm" === require(4882) /* getFileChunk */.findMatroskaDocTypeElements(fileChunk);
};
