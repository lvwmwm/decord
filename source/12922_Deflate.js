...
// Function ID: 12923
// Name: Deflate
// Dependencies: [12921, 12923, 12924, 12925, 12929]

// Module 12922 (Deflate)
const require = arg1;
    ...
    if (this instanceof Deflate) {
      ...
      if (options.raw) {
        ...
        if (0 !== deflateInit2Result) {
          ...
          tmp23 = new.target;
          tmp24 = new.target;
          error = new Error(require("module_12925")[deflateInit2Result]);
          tmp26 = error;
          throw error;
        } else {
          if (options.header) {
          ...
          if (options.dictionary) {
            ...
            if (0 !== deflateSetDictionaryResult) {
              ...
              tmp18 = new.target;
              tmp19 = new.target;
              error1 = new Error(require("module_12925")[deflateSetDictionaryResult]);
              tmp21 = error1;
              throw error1;
            } else {
              flag2 = true;
