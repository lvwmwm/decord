...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8549, 8557, 8563, 8556, 8644, 8640, 8565]

// Module 8643 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(8557).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
      ...
      if (tmp5) {
        ...
        obj[6] = midLine;
        const merged = Object.assign(withoutXYResult, importDefault(8563)(obj, true), obj);
        withoutXYResult.ref = self.refMethod;
        obj1 = {};
        const merged1 = Object.assign(withoutXYResult);
        return jsx(importDefault(8644), {});
      } else {
        ...
        obj[1] = children;
        return jsx(importDefault(8640), { ref: null, children: null });
      }
