...
function XorAndSalsa(B32, sum, V, sum2, B32, sum1) {
  ...
  do {
    ...
    let tmp65 = tmp51 ^ require(8815) /* asciiToBase16 */.rotl(tmp47 + tmp59 | 0, 7);
    let tmp66 = tmp55 ^ require(8815) /* asciiToBase16 */.rotl(tmp65 + tmp47 | 0, 9);
    let tmp67 = tmp59 ^ require(8815) /* asciiToBase16 */.rotl(tmp66 + tmp65 | 0, 13);
    let tmp68 = tmp47 ^ require(8815) /* asciiToBase16 */.rotl(tmp67 + tmp66 | 0, 18);
    let tmp69 = tmp56 ^ require(8815) /* asciiToBase16 */.rotl(tmp52 + tmp48 | 0, 7);
    let tmp70 = tmp60 ^ require(8815) /* asciiToBase16 */.rotl(tmp69 + tmp52 | 0, 9);
    let tmp71 = tmp48 ^ require(8815) /* asciiToBase16 */.rotl(tmp70 + tmp69 | 0, 13);
    let tmp72 = tmp52 ^ require(8815) /* asciiToBase16 */.rotl(tmp71 + tmp70 | 0, 18);
    let tmp73 = tmp61 ^ require(8815) /* asciiToBase16 */.rotl(tmp57 + tmp53 | 0, 7);
    let tmp74 = tmp49 ^ require(8815) /* asciiToBase16 */.rotl(tmp73 + tmp57 | 0, 9);
    let tmp75 = tmp53 ^ require(8815) /* asciiToBase16 */.rotl(tmp74 + tmp73 | 0, 13);
    let tmp76 = tmp57 ^ require(8815) /* asciiToBase16 */.rotl(tmp75 + tmp74 | 0, 18);
    let tmp77 = tmp50 ^ require(8815) /* asciiToBase16 */.rotl(tmp62 + tmp58 | 0, 7);
    let tmp78 = tmp54 ^ require(8815) /* asciiToBase16 */.rotl(tmp77 + tmp62 | 0, 9);
    let tmp79 = tmp58 ^ require(8815) /* asciiToBase16 */.rotl(tmp78 + tmp77 | 0, 13);
    let tmp80 = tmp62 ^ require(8815) /* asciiToBase16 */.rotl(tmp79 + tmp78 | 0, 18);
    tmp81 = tmp71 ^ require(8815) /* asciiToBase16 */.rotl(tmp68 + tmp77 | 0, 7);
    tmp82 = tmp74 ^ require(8815) /* asciiToBase16 */.rotl(tmp81 + tmp68 | 0, 9);
    tmp83 = tmp77 ^ require(8815) /* asciiToBase16 */.rotl(tmp82 + tmp81 | 0, 13);
    tmp84 = tmp68 ^ require(8815) /* asciiToBase16 */.rotl(tmp83 + tmp82 | 0, 18);
    tmp85 = tmp75 ^ require(8815) /* asciiToBase16 */.rotl(tmp72 + tmp65 | 0, 7);
    tmp86 = tmp78 ^ require(8815) /* asciiToBase16 */.rotl(tmp85 + tmp72 | 0, 9);
    tmp87 = tmp65 ^ require(8815) /* asciiToBase16 */.rotl(tmp86 + tmp85 | 0, 13);
    tmp88 = tmp72 ^ require(8815) /* asciiToBase16 */.rotl(tmp87 + tmp86 | 0, 18);
    tmp89 = tmp79 ^ require(8815) /* asciiToBase16 */.rotl(tmp76 + tmp69 | 0, 7);
    tmp90 = tmp66 ^ require(8815) /* asciiToBase16 */.rotl(tmp89 + tmp76 | 0, 9);
    tmp91 = tmp69 ^ require(8815) /* asciiToBase16 */.rotl(tmp90 + tmp89 | 0, 13);
    tmp92 = tmp76 ^ require(8815) /* asciiToBase16 */.rotl(tmp91 + tmp90 | 0, 18);
    tmp93 = tmp67 ^ require(8815) /* asciiToBase16 */.rotl(tmp80 + tmp73 | 0, 7);
    tmp94 = tmp70 ^ require(8815) /* asciiToBase16 */.rotl(tmp93 + tmp80 | 0, 9);
    tmp95 = tmp73 ^ require(8815) /* asciiToBase16 */.rotl(tmp94 + tmp93 | 0, 13);
    tmp96 = tmp80 ^ require(8815) /* asciiToBase16 */.rotl(tmp95 + tmp94 | 0, 18);
    num = num + 2;
    tmp47 = tmp84;
    tmp48 = tmp81;
    tmp49 = tmp82;
...
function scryptOutput(B, dkLen, B, V, arr3) {
  ...
  V.fill(0);
  arr3.fill(0);
  return require(8818) /* pbkdf2Init */.pbkdf2(require(8820) /* _callSuper */.sha256, B, B, { c: 1, dkLen });
}
...
export const scrypt = function scrypt(B, B) {
  ...
  if (!require(8815) /* asciiToBase16 */.isLE) {
    require(8815) /* asciiToBase16 */.byteSwap32(B32);
  }
