...
// Dependencies: [7506, 7509, 7522, 7545, 7546, 7532, 7504, 7547, 7540, 7516]

// Module 7544 (applyClientOptions)
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = require(7504) /* isMatchingPattern */.truncate(environment.message, num);
    const obj = require(7504) /* isMatchingPattern */;
  }
  let value = iter;
  ...
  if (value) {
    iter.value = require(7504) /* isMatchingPattern */.truncate(iter.value, num);
    const obj2 = require(7504) /* isMatchingPattern */;
  }
  ...
  if (url) {
    request.url = require(7504) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(7504) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(7547).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = dependencyMap(7540).normalize(data.data, dependencyMap, dependencyMap);
                  data = obj;
                  const obj3 = dependencyMap(7540);
                }
