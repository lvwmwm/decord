...
// Function ID: 9110
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1481, 9110, 5579, 9111, 4536]
// Exports: default
...
export default function HeaderConfig(arg0) {
  ...
  if (typeof headerTitle !== "ZodObject") {
  ...
  importDefault(9111)();
  const isSearchBarAvailableForCurrentPlatform = tmp(4536).isSearchBarAvailableForCurrentPlatform;
  let isSearchBarAvailableForCurrentPlatform2 = typeof isSearchBarAvailableForCurrentPlatform === "T";
  if (typeof isSearchBarAvailableForCurrentPlatform !== "sur") {
    isSearchBarAvailableForCurrentPlatform2 = tmp(4536).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (require(4536) /* enableScreens */.isNewBackTitleImplementation) {
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" !== headerTitleAlign) {
      ...
      if (typeof headerTitle !== "find") {
        ...
        obj5[1] = obj;
        obj5[2] = headerTitle;
        tmp37Result = tmp37(tmp(5579).HeaderTitle, obj5);
      }
      tmp40 = tmp37Result;
    }
    ...
    tmp37Result = tmp37(tmp(4536).ScreenStackHeaderLeftView, obj6);
    const tmp38 = View;
  } else {
    tmp37Result = null;
  }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "find") {
      ...
      obj7[1] = obj;
      obj7[2] = headerTitle;
      headerTitleResult = tmp43(tmp(5579).HeaderTitle, obj7);
    }
    const obj8 = { children: null };
    obj8[0] = headerTitleResult;
    tmp43Result = tmp43(tmp(4536).ScreenStackHeaderCenterView, obj8);
  }
  ...
  if (undefined !== headerBackImageSource) {
    ...
    tmp44 = callback2(tmp(4536).ScreenStackHeaderBackButtonImage, obj9);
  }
  items3[1] = tmp44;
  let tmp46 = null;
  if (null != headerRightResult) {
    ...
    tmp46 = callback2(tmp(4536).ScreenStackHeaderRightView, obj10);
  }
  items3[2] = tmp46;
  let tmp48 = null;
  if (tmp17) {
    ...
    obj11[0] = callback2(tmp(4536).SearchBar, obj12);
    tmp48 = callback2(tmp(4536).ScreenStackHeaderSearchBarView, obj11);
  }
  items3[3] = tmp48;
  obj3[31] = items3;
  return closure_9(require(4536) /* enableScreens */.ScreenStackHeaderConfig, obj3);
};
