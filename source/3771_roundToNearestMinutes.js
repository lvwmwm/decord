...
// Dependencies: [3363, 3367, 3557]
// Exports: default

// Module 3771 (roundToNearestMinutes)
  ...
  if (arguments.length < 1) {
    ...
    if (defaultResult >= 1) {
      if (defaultResult <= 30) {
        ...
        const _Math = Math;
        const result = require(3557) /* getRoundingMethod */.getRoundingMethod(roundingMethod)(sum / defaultResult) * defaultResult;
        const _Date = Date;
