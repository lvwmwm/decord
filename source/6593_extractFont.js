...
// Function ID: 6594
// Name: extractFont
// Dependencies: [19, 21, 6587, 6592]
// Exports: default, setTSpan

// Module 6593 (extractFont)
import "noop";
...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(6587) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "string") {
    ...
    obj[7] = importDefault(6592)(tmp);
    obj[8] = importDefault(6592)(tmp2);
    obj[9] = importDefault(6592)(tmp3);
    obj[10] = importDefault(6592)(tmp4);
    obj[11] = importDefault(6592)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
