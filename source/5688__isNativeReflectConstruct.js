...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5689, 5659, 5704, 5691, 5706, 5702, 5707, 5692, 5708]
...
function getProgressFromGesture(interpolate, width, options) {
  ...
  if (undefined !== gestureDirection) {
    const tmp10 = importDefault(5691)(obj, gestureDirection);
    if (tmp10 > 0) {
        ...
        if (undefined === detachPreviousScreen) {
          ...
          if (tmp7) {
            ...
            if (isModalPresentation) {
              ...
              tmp11 = diff !== importDefault(5706)(scenes, (descriptor) => {
