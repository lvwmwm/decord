...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 7998, 8057, 8000, 8009]
...
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8057 */;
...
const items = [
  {
    ...
    value: function render() {
      ...
      let obj = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: self(7998).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
      [tmp2, tmp3] = parts;
      const tmp6 = self(7998).meetOrSliceTypes[tmp3] || 0;
      obj[6] = self(7998).alignEnum[tmp2] || "xMidYMid";
      ...
      const tmp7 = self(7998).alignEnum[tmp2] || "xMidYMid";
