...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8057, 8058, 8059, 8060, 8064, 8065, 8066, 8076]

// Module 8056 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import extractOpacityDefault from "extractOpacity" /* 8058 */;
import keysDefault from "keys" /* 8059 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8064 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8066 */;
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8076 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (transform) {
        ...
        tmp.transform = self(8060).extractTransformSvgView(tmp);
        const obj3 = self(8060);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(8065)({ viewBox, preserveAspectRatio }));
