...
// Function ID: 4578
// Name: TabsHost
// Dependencies: [32, 109, 19, 17, 21, 4578, 4553, 4579, 4580, 4582]
// Exports: default
...
export default function TabsHost(onNativeFocusChange) {
  ...
  let obj = onNativeFocusChange(4578);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4553).experiment.controlledBottomTabs;
  }
