    ...
    if (null === this._root) {
      ...
      if (null !== require("module_1")) {
        do {
          ...
          tmp9 = tmp28;
          tmp10 = tmp29;
          if (!is_red(get_childResult)) {
            tmp11 = is_red;
            tmp8 = obj3;
            tmp9 = tmp28;
            tmp10 = tmp29;
            if (!is_red(get_childResult.get_child(tmp2))) {
              tmp12 = is_red;
              tmp13 = !tmp2;
              if (is_red(get_childResult.get_child(tmp13))) {
                tmp24 = single_rotate;
                tmp25 = single_rotate(get_childResult, tmp2);
                ...
                if (!is_red(get_childResult.get_child(tmp13))) {
                  ...
                  if (null !== get_childResult1) {
                    tmp38 = is_red;
                    if (!is_red(get_childResult1.get_child(tmp15))) {
                      tmp16 = is_red;
                      if (!is_red(get_childResult1.get_child(num))) {
                        obj3.red = false;
                    ...
                    if (is_red(get_childResult1.get_child(num))) {
                      tmp22 = double_rotate;
                      set_childResult1 = tmp27.set_child(tmp17, double_rotate(obj3, num));
                    } else {
                      tmp19 = is_red;
                      if (is_red(get_childResult1.get_child(tmp15))) {
                        tmp20 = single_rotate;
                        set_childResult2 = tmp27.set_child(tmp17, single_rotate(obj3, num));
                      }
                    }
...
function is_red(child) {
  return null !== child && child.red;
}
