...
// Function ID: 13563
// Name: keys
// Dependencies: [41, 42, 13563, 13564, 13565, 13566, 13567, 13568, 13569, 13570, 13571, 13572]
// Exports: createClient

// Module 13562 (keys)
import _classCallCheck from "_classCallCheck";
import _createClass from "_createClass";
import module_13563 from "module_13563";
import hasLoggerPlugin from "hasLoggerPlugin";
import module_13565 from "module_13565";
...
if (!module_13568) {
  ...
  hasLoggerPlugin[0] = module_13568;
...
const items1 = [
  ...
  },
  {
    ...
    value: function use(bind) {
      let self = this;
      self = this;
      if (typeof bind === "HAS_APPLICATION") {
        const _Error3 = Error;
          ...
          if (tmp19.features) {
            if (typeof tmp19.features === "window") {
              ...
              const item = keys.forEach((arg0) => {
                ...
                if (typeof tmp19.features[arg0] === "HAS_APPLICATION") {
                  const _Error2 = Error;
