...
export const bytesToHex = function bytesToHex(arg0) {
  let length;
  require(8889) /* number */.bytes(arg0);
  let num = 0;
  let str = "";
  let str2 = "";
  if (0 < arg0.length) {
...
export const concatBytes = function concatBytes() {
  ...
  if (0 < arguments.length) {
    do {
      ...
      let bytesResult = require(8889) /* number */.bytes(tmp);
      num = num + tmp.length;
      num2 = num2 + 1;
      num3 = num;
...
export const randomBytes = function randomBytes(result) {
  ...
  if (require(8890) /* _crypto */.crypto) {
    if ("function" === typeof require(8890) /* _crypto */.crypto.getRandomValues) {
      const _crypto2 = require(8890) /* _crypto */.crypto;
      const _Uint8Array = Uint8Array;
  ...
  if (require(8890) /* _crypto */.crypto) {
    if ("function" === typeof require(8890) /* _crypto */.crypto.randomBytes) {
      const _crypto = require(8890) /* _crypto */.crypto;
