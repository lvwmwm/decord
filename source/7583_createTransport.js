...
// Dependencies: [7584, 7564, 7585, 7544, 7548, 7520, 7577]

// Module 7583 (createTransport)
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(7564).envelopeItemTypeToDataCategory(arg1);
        const obj = items(7564);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: null };
          obj[0] = items(7564).serializeEnvelope(dependencyMap);
          const obj2 = items(7564);
          ...
          if (arg0 instanceof items(7577).SentryError) {
