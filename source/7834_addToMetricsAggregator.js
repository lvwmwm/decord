...
// Dependencies: [7734, 7737, 7739, 7765, 7743, 7766, 7738, 7835, 7752, 7772, 7773]
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (client) {
    const activeSpan = require(7743) /* spanTimeInputToSeconds */.getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    const globalSingleton = require(7739) /* getGlobalSingleton */.getGlobalSingleton("globalMetricsAggregators", () => {
    ...
    const tmp3Result1 = require(7739) /* getGlobalSingleton */;
  }
}
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7835).COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7835).DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, require(7835).SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7835).GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
  ...
  getMetricsAggregatorForClient(on) {
    ...
    const obj = require(7739) /* getGlobalSingleton */;
  }
};
