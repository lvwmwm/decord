...
// Function ID: 13265
// Name: Deflate
// Dependencies: [13263, 13265, 13266, 13267, 13271]

// Module 13264 (Deflate)
    ...
    if (this instanceof Deflate) {
      ...
      if (options.raw) {
        ...
        if (0 !== deflateInit2Result) {
          ...
          tmp23 = new.target;
          tmp24 = new.target;
          error = new Error(require("module_13267")[deflateInit2Result]);
          tmp26 = error;
          throw error;
        } else {
          if (options.header) {
          ...
          if (options.dictionary) {
            ...
            if (0 !== deflateSetDictionaryResult) {
              ...
              tmp18 = new.target;
              tmp19 = new.target;
              error1 = new Error(require("module_13267")[deflateSetDictionaryResult]);
              tmp21 = error1;
              throw error1;
            } else {
              flag2 = true;
