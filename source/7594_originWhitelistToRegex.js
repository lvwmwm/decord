...
// Dependencies: [31, 27, 33, 7595, 7596]
// Exports: defaultRenderError, defaultRenderLoading, useWebWiewLogic

// Module 7594 (originWhitelistToRegex)
...
function originWhitelistToRegex(arg0) {
  return "^".concat(importDefault(7595)(arg0).replace(/\\\*/g, ".*"));
}
...
export const defaultRenderLoading = function defaultRenderLoading() {
  return callback(closure_7, { style: importDefault(7596).loadingOrErrorView, children: callback(closure_8, {}) });
};
export const defaultRenderError = function defaultRenderError(arg0, arg1, arg2) {
  let obj = { style: importDefault(7596).loadingOrErrorView };
  obj = { style: importDefault(7596).errorTextTitle, children: "Error loading page" };
  const items = [callback(closure_9, obj), , , ];
  obj = { style: importDefault(7596).errorText, children: "Domain: ".concat(arg0) };
  items[1] = callback(closure_9, obj);
  items[2] = callback(closure_9, { style: importDefault(7596).errorText, children: "Error Code: ".concat(arg1) });
  const obj1 = { style: importDefault(7596).errorText, children: "Error Code: ".concat(arg1) };
  items[3] = callback(closure_9, { style: importDefault(7596).errorText, children: "Description: ".concat(arg2) });
  obj.children = items;
