...
// Function ID: 63813
// Name: extractStroke
// Dependencies: [8036, 8024, 8039]

// Module 8038 (extractStroke)
const module = arg2;
...
arg5.default = function extractStroke(arg0, arg1, arr) {
  ...
  if (null != stroke) {
    arr.push("stroke");
    arg0.stroke = module(8036)(stroke);
  }
  if (null != strokeWidth) {
  ...
  if (null != strokeOpacity) {
    ...
    arg0.strokeOpacity = module(8024)(strokeOpacity);
  }
  if (null != strokeDasharray) {
    ...
    if (strokeDasharray) {
      ...
      if ("none" !== strokeDasharray) {
        tmp9 = module(8039)(strokeDasharray);
      }
    }
    let combined = tmp9;
    if (tmp9) {
