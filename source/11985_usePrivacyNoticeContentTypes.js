...
// Module 11985 (usePrivacyNoticeContentTypes)
...
obj.container = obj;
obj.icon = { "Bool(true)": "0 0 4px 0 hsl(none 0% 0% / 0.08)", "Bool(true)": "drop-shadow(0 0 4px hsl(none 0% 0% / 0.08))" };
obj.text = { flex: 1 };
...
export default function UserProfilePrivacyNotice() {
  ...
  callback = React.useCallback((children) => {
    const obj = {
      INTEGRATION_CREATE: "<string:2151743489>",
      ConstraintReasonCode: "<string:1912603161>",
      onPress() {
  ...
  if (tmp3[0] !== callback(dependencyMap[13]).DismissibleContent.PRIVATE_PROFILE_INLINE_NOTICE) {
    ...
    const obj1 = { Promise: "xs", marginTop: "interactive-text-default", flags: "md", style: tmp.text };
