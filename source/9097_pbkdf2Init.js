...
// Function ID: 9098
// Name: pbkdf2Init
// Dependencies: [5, 9095, 9094, 9098]
// Exports: pbkdf2, pbkdf2Async

// Module 9097 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  let c;
  let dkLen;
  require(9095) /* number */.hash(sha256);
  ({ c, dkLen, asyncTick } = require(9094) /* _asyncLoop */.checkOpts({ dkLen: 32, asyncTick: 10 }, arg3));
  require(9095) /* number */.number(c);
  require(9095) /* number */.number(dkLen);
  require(9095) /* number */.number(asyncTick);
  if (c < 1) {
    const _Error = Error;
  ...
  const checkOptsResult = require(9094) /* _asyncLoop */.checkOpts({ dkLen: 32, asyncTick: 10 }, arg3);
}
...
export const pbkdf2 = function pbkdf2(sha256, B, B, arg3) {
  ...
  const uint8Array = new Uint8Array(4);
  const view = require(9094) /* _asyncLoop */.createView(uint8Array);
