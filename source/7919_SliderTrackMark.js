...
export const SliderTrackMark = function SliderTrackMark(arg0) {
  ...
  let obj = jsxProd;
  obj = { style: require(7917) /* styles */.styles.trackMarkContainer, children: null };
  ...
  if (thumbImage) {
    ...
    if (isTrue) {
      ...
      obj1[0] = tmp2(7917).styles.thumbImageContainer;
      const obj2 = { source: null, style: null };
      obj2[0] = thumbImage;
      obj2[1] = tmp2(7917).styles.thumbImage;
  ...
  items[1] = jsxResult1;
  obj[1] = items;
  return <get ActivityIndicator.View style={require(7917) /* styles */.styles.trackMarkContainer}>{null}</get ActivityIndicator.View>;
};
