...
// Function ID: 7567
// Name: NativeModules
// Dependencies: [5, 17, 7567, 7568, 7573, 7574, 7575, 7576, 7577]
...
// Module 7566 (NativeModules)
import _mod7568 from "module_7568" /* 7568 */;
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 7574 */;
import NativeModulesAll from "NativeModules" /* 7575 */;
import fetchJsonOrThrowAll from "fetchJsonOrThrow" /* 7576 */;
import syncAll from "sync" /* 7577 */;
...
const subs = require("module_7567").ProductType.subs;
const inapp = require("module_7567").ProductType.inapp;
...
export const isIosStorekit2 = require("module_7568").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod7568.storekit1Mode();
    const obj4 = _mod7568;
  } else if ("STOREKIT2_MODE" === str) {
    _mod7568.storekit2Mode();
    const obj3 = _mod7568;
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod7568.storekitHybridMode();
    const obj2 = _mod7568;
  }
};
export const initConnection = () => {
  const nativeModule = _mod7568.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod7568.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      closure_1 = tmp5;
      closure_0 = tmp2;
      const obj3 = closure_1_0(7568);
      const androidModule = obj3.getAndroidModule();
      yield androidModule.getItemsByType(closure_1_7, closure_1_0);
      closure_0 = arg1.map(closure_1_0(7573).singleProductAndroidMap);
      const obj = closure_1_0(7568);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      ...
      androidModuleType = closure_1_0(7568).getAndroidModuleType();
      const obj10 = closure_1_0(7568);
      const androidModule = closure_1_0(7568).getAndroidModule();
      closure_1 = yield androidModule.getItemsByType(closure_1_6, closure_1_0);
      if ("android" === closure_1_0) {
        return closure_1_8(closure_1, closure_1_0(7567).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp35) {
        const _Error = Error;
      ...
      const obj2 = closure_1_0(7568);
      dependencyMap = yield obj2.fillProductsWithAdditionalData(dependencyMap);
      return closure_1_8(dependencyMap, closure_1_0(7567).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
