...
// Dependencies: [31, 33, 8479, 8484]
// Exports: default, setTSpan

// Module 8485 (extractSingleFontFamily)
import "result";
...
export default function extractText(children) {
  ...
  if ("string" !== typeof children) {
    ...
    obj.x = importDefault(8484)(tmp);
    obj.y = importDefault(8484)(tmp2);
    obj.dx = importDefault(8484)(tmp3);
    obj.dy = importDefault(8484)(tmp4);
    obj.rotate = importDefault(8484)(tmp5);
    return obj;
  }
  let tmp16 = null;
  if (arg1) {
