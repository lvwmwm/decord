  ...
  return (arg0) => {
    ...
    const features = {
      ...
      logImportant() {
        ...
        const obj = { level: "debug", message: first };
        closure_0.send("log", obj, true);
      },
      debug(message) {
        return closure_0.send("log", { level: "debug", message }, arguments.length > 1 && undefined !== arguments[1] && arguments[1]);
      },
      warn(message) {
