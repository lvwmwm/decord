...
// Dependencies: [1582, 5251, 5224]

// Module 5333 (useGestureHandler)
const require = arg1;
...
arg5.useGestureHandler = function useGestureHandler(CONTENT, animatedContentGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize) {
  ...
  obj = { state: animatedContentGestureState, State: _require(5251).State, gestureSource: sharedValue, source: CONTENT, onStart: handleOnStart };
  ...
  obj = { gestureSource: sharedValue, source: CONTENT, state: animatedContentGestureState, GESTURE_SOURCE: _require(5224).GESTURE_SOURCE, onEnd: handleOnEnd };
  ...
  obj1 = { gestureSource: sharedValue, source: CONTENT, state: animatedContentGestureState, GESTURE_SOURCE: _require(5224).GESTURE_SOURCE, onFinalize: handleOnFinalize };
