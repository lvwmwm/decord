...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5859, 5861, 5338, 5863, 5865, 5866, 5875, 5876]
...
function getDistanceFromOptions(width, gestureDirection) {
  ...
  if (gestureDirection) {
    return CardStack(5863).getDistanceForDirection(width, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(5859).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(5859).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
    ...
    return tmp3(5863).getDistanceForDirection(width, gestureDirection, arg2);
  }
}
...
obj = {
  ...
  value: function render() {
    ...
    items2[1] = renderHeader(CardStack(5865).MaybeScreenContainer, obj2);
    obj[1] = items2;
