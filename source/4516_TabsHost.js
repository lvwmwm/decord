...
// Function ID: 39746
// Name: TabsHost
// Dependencies: [57, 29, 31, 27, 33, 4517, 4492, 4518, 4519, 4521]
// Exports: default

// Module 4516 (TabsHost)
...
export default function TabsHost(onNativeFocusChange) {
  ...
  let obj = onNativeFocusChange(4517);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4492).experiment.controlledBottomTabs;
  }
  ...
  obj.children = items1;
  return closure_9(ref(4518), Object.assign(obj, tmp4, obj));
};
