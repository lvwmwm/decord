...
// Dependencies: [27, 5255, 5254, 5275, 5260]
// Exports: filterConfig, findNodeHandle, scheduleFlushOperations

// Module 5274 (transformIntoHandlerTags)
...
function transformIntoHandlerTags(arg0) {
  ...
  const mapped = require(5255) /* hasProperty */.toArray(arg0).map((current) => {
...
export const scheduleFlushOperations = function scheduleFlushOperations() {
  if (!c4) {
    c4 = true;
    require(5275).ghQueueMicrotask(() => {
      outer1_1(outer1_2[4]).flushOperations();
      let c4 = false;
    });
    const obj = require(5275);
  }
};
