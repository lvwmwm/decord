...
// Dependencies: [1257, 13185, 13186, 13250, 13257, 13262, 13277, 13278]

// Module 13184 (mergeUnicodeLanguageId)
...
function addLikelySubtags(locale) {
  ...
  let script;
  let variants;
  const parseUnicodeLocaleIdResult = require(13250) /* isStructurallyValidLanguageTag */.parseUnicodeLocaleId(locale);
  ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
  if (script) {
    if (region) {
      let obj = { lang, script, region, variants: [] };
      const tmp4 = require(13250) /* isStructurallyValidLanguageTag */.likelySubtags[require(undefined, 13250) /* isStructurallyValidLanguageTag */.emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        parseUnicodeLocaleIdResult.lang = mergeUnicodeLanguageId(undefined, undefined, undefined, variants, require(13250) /* isStructurallyValidLanguageTag */.parseUnicodeLanguageId(tmp4));
        return require(13250) /* isStructurallyValidLanguageTag */.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    obj = { lang, script, variants: [] };
    const tmp7 = require(13250) /* isStructurallyValidLanguageTag */.likelySubtags[require(undefined, 13250) /* isStructurallyValidLanguageTag */.emitUnicodeLanguageId(undefined, obj)];
    if (tmp7) {
      parseUnicodeLocaleIdResult.lang = mergeUnicodeLanguageId(undefined, undefined, region, variants, require(13250) /* isStructurallyValidLanguageTag */.parseUnicodeLanguageId(tmp7));
      return require(13250) /* isStructurallyValidLanguageTag */.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
    }
  }
  if (region) {
    obj = { lang, region, variants: [] };
    const tmp10 = require(13250) /* isStructurallyValidLanguageTag */.likelySubtags[require(undefined, 13250) /* isStructurallyValidLanguageTag */.emitUnicodeLanguageId(undefined, obj)];
    if (tmp10) {
      parseUnicodeLocaleIdResult.lang = mergeUnicodeLanguageId(undefined, script, undefined, variants, require(13250) /* isStructurallyValidLanguageTag */.parseUnicodeLanguageId(tmp10));
      return require(13250) /* isStructurallyValidLanguageTag */.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
    }
  }
  let tmp11 = require(13250) /* isStructurallyValidLanguageTag */.likelySubtags[lang];
  if (!tmp11) {
    const obj1 = { lang: "und", script, variants: [] };
    tmp11 = require(13250) /* isStructurallyValidLanguageTag */.likelySubtags[require(undefined, 13250) /* isStructurallyValidLanguageTag */.emitUnicodeLanguageId(undefined, obj1)];
  }
  if (tmp11) {
    parseUnicodeLocaleIdResult.lang = mergeUnicodeLanguageId(undefined, script, region, variants, require(13250) /* isStructurallyValidLanguageTag */.parseUnicodeLanguageId(tmp11));
    return require(13250) /* isStructurallyValidLanguageTag */.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
  } else {
    const _Error = Error;
