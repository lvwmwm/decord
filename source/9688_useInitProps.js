...
export const useInitProps = function useInitProps(defaultIndex) {
  ...
  const memo = React.useMemo(() => {
    let obj = data(tmp[1]);
    obj = { loop: tmp, autoFillData: tmp2, data, dataLength: data.length };
