...
// Dependencies: [4134, 1306, 4148, 4151, 4043, 2]
// Exports: default

// Module 4150 (defaultMeridiem)
...
function getLocaleData() {
  ...
  if (typeof weekdays === "function") {
    dependencyMap = weekdays.bind(tmp(4043).localeData());
    let fn3 = (arg0, arg1) => {
      closure_0 = arg0;
      return callback({ [closure_0]: () => closure_0 }, arg1);
    };
  ...
  if (typeof weekdaysShort === "function") {
    dependencyMap = weekdaysShort.bind(tmp(4043).localeData());
    let fn4 = (arg0, arg1) => {
      closure_0 = arg0;
      return callback({ [closure_0]: () => closure_0 }, arg1);
    };
    const tmpResult2 = tmp(4043);
  } else {
    const _Array4 = Array;
  ...
  if (typeof weekdaysMin === "function") {
    dependencyMap = weekdaysMin.bind(tmp(4043).localeData());
    let fn5 = (arg0, arg1) => {
      closure_0 = arg0;
      return callback({ [closure_0]: () => closure_0 }, arg1);
    };
...
export default function makeFormatter(str) {
  ...
  if (result) {
    result = undefined !== _require(4148).makeFormatter;
  }
  if (result) {
    result = _require(4148).supportsSystemDateFormatter();
    const obj = _require(4148);
  }
  let replaced = str;
  if (!result) {
    _require = str;
