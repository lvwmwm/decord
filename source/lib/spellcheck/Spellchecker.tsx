...
// Dependencies: [5, 57, 6, 7, 1922, 3, 3776, 5172, 5173, 5174, 22, 1835, 1327, 2]
// Exports: install

// Module 5171 (normalizeLocale)
...
function normalizeLocale(arg0) {
  let str = arg0;
  const tmp = importDefault(5172)[arg0];
  if (null != tmp) {
    str = tmp;
  }
  const parsed = require(5173) /* parse */.parse(str.replace(/[_-]/g, "-"));
  if (null != parsed) {
