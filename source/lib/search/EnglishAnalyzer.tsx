...
// Dependencies: [12, 15785, 15787, 2]
// Exports: analyze, createASTHighlighter

// Module 15784 (stripPossessive)
...
function shouldHighlight(arg0, set) {
  ...
  if (isBlank(tmp)) {
    ...
    const snowballStemResult = require(15785) /* snowballStem */.snowballStem(tmp);
    if (flag) {
    ...
    const obj = require(15785) /* snowballStem */;
  }
}
...
export const analyze = function analyze(str) {
  ...
  return mapped1.reject(isStopWord).map(require(15785) /* snowballStem */.snowballStem).value();
};
