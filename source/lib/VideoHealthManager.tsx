...
// Function ID: 13019
// Name: calculateFps
// Dependencies: [676, 3, 4538, 13019, 4377, 687, 2]

// Module 13018 (calculateFps)
        ...
        if (Number.isFinite(calculateFpsResult)) {
          ...
          if (self.perUserFpsWindow[arg0].length >= self.windowLength) {
            ...
            if (arr3.filter((arg0) => arg0 < self.fpsThreshold).length >= self.fpsWindowBorderlineCount) {
              ...
              importDefault(13019)(arg0, VideoToggleState.DISABLED);
              ...
              importDefault(13019)(arg0, tmp7.AUTO_ENABLED);
            }
...
prototype["reenableVideo"] = function reenableVideo(arr) {
  ...
  if (flag) {
    const logger = self.logger;
    const _HermesInternal = HermesInternal;
    logger.info("reenableVideo called for user " + arr + " - time = " + require(4377) /* sleep */.now());
    ...
    importDefault(13019)(arr, VideoToggleState.AUTO_PROBING);
    flag = true;
    const obj = require(4377) /* sleep */;
  }
  return flag;
};
