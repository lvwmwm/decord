...
// Function ID: 12968
// Name: calculateFps
// Dependencies: [676, 3, 4491, 12968, 4330, 687, 2]

// Module 12967 (calculateFps)
        ...
        if (Number.isFinite(calculateFpsResult)) {
          ...
          if (self.perUserFpsWindow[arg0].length >= self.windowLength) {
            ...
            if (arr3.filter((arg0) => arg0 < self.fpsThreshold).length >= self.fpsWindowBorderlineCount) {
              ...
              importDefault(12968)(arg0, VideoToggleState.DISABLED);
              ...
              importDefault(12968)(arg0, tmp7.AUTO_ENABLED);
            }
...
prototype["reenableVideo"] = function reenableVideo(arr) {
  ...
  if (flag) {
    const logger = self.logger;
    const _HermesInternal = HermesInternal;
    logger.info("reenableVideo called for user " + arr + " - time = " + require(4330) /* sleep */.now());
    ...
    importDefault(12968)(arr, VideoToggleState.AUTO_PROBING);
    flag = true;
