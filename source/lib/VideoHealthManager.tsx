...
// Function ID: 12880
// Name: calculateFps
// Dependencies: [676, 3, 4426, 12880, 4265, 687, 2]

// Module 12879 (calculateFps)
        ...
        if (Number.isFinite(calculateFpsResult)) {
          ...
          if (self.perUserFpsWindow[arg0].length >= self.windowLength) {
            ...
            if (arr3.filter((arg0) => arg0 < self.fpsThreshold).length >= self.fpsWindowBorderlineCount) {
              ...
              importDefault(12880)(arg0, VideoToggleState.DISABLED);
              ...
              importDefault(12880)(arg0, tmp7.AUTO_ENABLED);
            }
...
prototype["reenableVideo"] = function reenableVideo(arr) {
  ...
  if (flag) {
    ...
    importDefault(12880)(arr, VideoToggleState.AUTO_PROBING);
    flag = true;
