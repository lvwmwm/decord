...
// Function ID: 13089
// Name: calculateFps
// Dependencies: [676, 3, 4540, 13089, 4379, 687, 2]

// Module 13088 (calculateFps)
        ...
        if (Number.isFinite(calculateFpsResult)) {
          ...
          if (self.perUserFpsWindow[arg0].length >= self.windowLength) {
            ...
            if (arr3.filter((arg0) => arg0 < self.fpsThreshold).length >= self.fpsWindowBorderlineCount) {
              ...
              importDefault(13089)(arg0, VideoToggleState.DISABLED);
              ...
              importDefault(13089)(arg0, tmp7.AUTO_ENABLED);
            }
...
prototype["reenableVideo"] = function reenableVideo(arr) {
  ...
  if (flag) {
    ...
    importDefault(13089)(arr, VideoToggleState.AUTO_PROBING);
    flag = true;
