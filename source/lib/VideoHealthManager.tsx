...
// Function ID: 13005
// Name: calculateFps
// Dependencies: [676, 3, 4521, 13005, 4360, 687, 2]

// Module 13004 (calculateFps)
        ...
        if (Number.isFinite(calculateFpsResult)) {
          ...
          if (self.perUserFpsWindow[arg0].length >= self.windowLength) {
            ...
            if (arr3.filter((arg0) => arg0 < self.fpsThreshold).length >= self.fpsWindowBorderlineCount) {
              ...
              importDefault(13005)(arg0, VideoToggleState.DISABLED);
              ...
              importDefault(13005)(arg0, tmp7.AUTO_ENABLED);
            }
...
prototype["reenableVideo"] = function reenableVideo(arr) {
  ...
  if (flag) {
    ...
    importDefault(13005)(arr, VideoToggleState.AUTO_PROBING);
    flag = true;
