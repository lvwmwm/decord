...
// Function ID: 13091
// Name: calculateFps
// Dependencies: [676, 3, 4540, 13091, 4379, 687, 2]

// Module 13090 (calculateFps)
        ...
        if (Number.isFinite(calculateFpsResult)) {
          ...
          if (self.perUserFpsWindow[arg0].length >= self.windowLength) {
            ...
            if (arr3.filter((arg0) => arg0 < self.fpsThreshold).length >= self.fpsWindowBorderlineCount) {
              ...
              importDefault(13091)(arg0, VideoToggleState.DISABLED);
              ...
              importDefault(13091)(arg0, tmp7.AUTO_ENABLED);
            }
...
prototype["reenableVideo"] = function reenableVideo(arr) {
  ...
  if (flag) {
    ...
    importDefault(13091)(arr, VideoToggleState.AUTO_PROBING);
    flag = true;
