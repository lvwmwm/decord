...
// Function ID: 13158
// Name: calculateFps
// Dependencies: [676, 3, 4581, 13158, 4420, 687, 2]

// Module 13157 (calculateFps)
        ...
        if (Number.isFinite(calculateFpsResult)) {
          ...
          if (self.perUserFpsWindow[arg0].length >= self.windowLength) {
            ...
            if (arr3.filter((arg0) => arg0 < self.fpsThreshold).length >= self.fpsWindowBorderlineCount) {
              ...
              importDefault(13158)(arg0, VideoToggleState.DISABLED);
              ...
              importDefault(13158)(arg0, tmp7.AUTO_ENABLED);
            }
...
prototype["reenableVideo"] = function reenableVideo(arr) {
  ...
  if (flag) {
    ...
    importDefault(13158)(arr, VideoToggleState.AUTO_PROBING);
    flag = true;
