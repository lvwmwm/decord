...
// Function ID: 13391
// Name: round
// Dependencies: [4547, 13387, 4523, 7420, 4544, 7419, 12, 500, 11, 1433, 2]
...
import _initStatsDefault from "_initStats" /* 13387 */;
...
prototype["getCodecUsageStats"] = function getCodecUsageStats(receiver, userId) {
  ...
  if ("sender" !== receiver) {
    if ("streamer" !== receiver) {
      ...
      obj[1] = num;
      let num2 = value.get(tmp2(7419).CodecTypes.H265);
      if (num2 == null) {
        num2 = 0;
      }
      obj[2] = num2;
      let num3 = value.get(tmp2(7419).CodecTypes.VP8);
      if (num3 == null) {
        num3 = 0;
      }
      obj[3] = num3;
      let num4 = value.get(tmp2(7419).CodecTypes.VP9);
      if (num4 == null) {
        num4 = 0;
      }
      obj[4] = num4;
      let num5 = value.get(tmp2(7419).CodecTypes.AV1);
      if (num5 == null) {
        num5 = 0;
      }
      obj[5] = num5;
      let num6 = value.get(tmp2(7419).CodecTypes.UNKNOWN);
      if (num6 == null) {
        num6 = 0;
      }
      obj[6] = num6;
  ...
  obj[1] = num8;
  let num9 = map.get(tmp7(7419).CodecTypes.H265);
  if (num9 == null) {
    num9 = 0;
  }
  obj[2] = num9;
  let num10 = map.get(tmp7(7419).CodecTypes.VP8);
  if (num10 == null) {
    num10 = 0;
  }
  obj[3] = num10;
  let num11 = map.get(tmp7(7419).CodecTypes.VP9);
  if (num11 == null) {
    num11 = 0;
  }
  obj[4] = num11;
  let num12 = map.get(tmp7(7419).CodecTypes.AV1);
  if (num12 == null) {
    num12 = 0;
  }
  obj[5] = num12;
  let num13 = map.get(tmp7(7419).CodecTypes.UNKNOWN);
  if (num13 == null) {
    num13 = 0;
  }
  obj[6] = num13;
...
prototype["receivedStats"] = function receivedStats(nowResult, transport, streamParameters) {
  ...
  let tmp7 = self.connection.context === tmp(4544).MediaEngineContextTypes.DEFAULT;
  if (tmp7) {
    tmp7 = null != transport.camera;
  }
  self.cameraDuration.value = tmp7;
  let tmp9 = self.connection.context === tmp(4544).MediaEngineContextTypes.DEFAULT;
  if (tmp9) {
  ...
  let tmp11 = self.connection.context === tmp(4544).MediaEngineContextTypes.DEFAULT;
  if (tmp11) {
