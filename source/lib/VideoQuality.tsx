...
// Function ID: 12962
// Name: round
// Dependencies: [4355, 12958, 4331, 7110, 4352, 7109, 12, 500, 11, 1414, 2]
...
prototype["setOutboundSsrc"] = function setOutboundSsrc(ssrc) {
  ...
  if (null == this.outboundStats[ssrc]) {
    const outboundStats = new require(7109) /* parseEncoder */.OutboundStats(self.timestampProducer);
...
prototype["getOrCreateInboundStats"] = function getOrCreateInboundStats(userId) {
  ...
  if (null == this.inboundStats[userId]) {
    const inboundStats = new require(7109) /* parseEncoder */.InboundStats(self.timestampProducer);
...
prototype["setInboundUser"] = function setInboundUser(userId, videoSsrc) {
  ...
  orCreateInboundStats.setVideoStopped(0 === videoSsrc, require(7109) /* parseEncoder */.VideoStoppedReasons.SenderStopped);
};
prototype["setUserVideoDisabled"] = function setUserVideoDisabled(userId, arg1) {
  const orCreateInboundStats = this.getOrCreateInboundStats(userId);
  orCreateInboundStats.setVideoStopped(arg1, require(7109) /* parseEncoder */.VideoStoppedReasons.ClientSideDisableVideo);
  let tmp2 = !arg1;
  if (!arg1) {
...
prototype["getCodecUsageStats"] = function getCodecUsageStats(receiver, userId) {
  ...
  if ("sender" !== receiver) {
    if ("streamer" !== receiver) {
      ...
      obj[0] = tmp;
      let num = value.get(require(7109) /* parseEncoder */.CodecTypes.H264);
      if (num == null) {
        num = 0;
      }
      obj[1] = num;
      let num2 = value.get(tmp2(7109).CodecTypes.H265);
      if (num2 == null) {
        num2 = 0;
      }
      obj[2] = num2;
      let num3 = value.get(tmp2(7109).CodecTypes.VP8);
      if (num3 == null) {
        num3 = 0;
      }
      obj[3] = num3;
      let num4 = value.get(tmp2(7109).CodecTypes.VP9);
      if (num4 == null) {
        num4 = 0;
      }
      obj[4] = num4;
      let num5 = value.get(tmp2(7109).CodecTypes.AV1);
      if (num5 == null) {
        num5 = 0;
      }
      obj[5] = num5;
      let num6 = value.get(tmp2(7109).CodecTypes.UNKNOWN);
      if (num6 == null) {
        num6 = 0;
      }
      obj[6] = num6;
  ...
  let num8 = map.get(require(7109) /* parseEncoder */.CodecTypes.H264);
  if (num8 == null) {
    num8 = 0;
  }
  obj[1] = num8;
  let num9 = map.get(tmp7(7109).CodecTypes.H265);
  if (num9 == null) {
    num9 = 0;
  }
  obj[2] = num9;
  let num10 = map.get(tmp7(7109).CodecTypes.VP8);
  if (num10 == null) {
    num10 = 0;
  }
  obj[3] = num10;
  let num11 = map.get(tmp7(7109).CodecTypes.VP9);
  if (num11 == null) {
    num11 = 0;
  }
  obj[4] = num11;
  let num12 = map.get(tmp7(7109).CodecTypes.AV1);
  if (num12 == null) {
    num12 = 0;
  }
  obj[5] = num12;
  let num13 = map.get(tmp7(7109).CodecTypes.UNKNOWN);
  if (num13 == null) {
    num13 = 0;
  }
  obj[6] = num13;
...
prototype["getStats"] = function getStats(aggregationDuration) {
  ...
  if (null == aggregationDuration) {
    ...
    const tmp47 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.FFMPEG];
    let num53 = 0;
    if (null != tmp47) {
      const _Math45 = Math;
    ...
    obj[84] = num53;
    const tmp48 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.DAV1D];
    let num54 = 0;
    if (null != tmp48) {
      const _Math46 = Math;
    ...
    obj[85] = num54;
    const tmp49 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.VP8_LIBVPX];
    let num55 = 0;
    if (null != tmp49) {
      const _Math47 = Math;
    ...
    obj[86] = num55;
    const tmp50 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.ELECTRON];
    let num56 = 0;
    if (null != tmp50) {
      const _Math48 = Math;
    ...
    obj[87] = num56;
    const tmp51 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.VIDEOTOOLBOX];
    let num57 = 0;
    if (null != tmp51) {
      const _Math49 = Math;
    ...
    obj[88] = num57;
    const tmp52 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.UNCATEGORIZED];
    let num58 = 0;
    if (null != tmp52) {
      const _Math50 = Math;
    ...
    obj[89] = num58;
    const tmp53 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.UNKNOWN];
    let num59 = 0;
    if (null != tmp53) {
      const _Math51 = Math;
    ...
    obj[90] = num59;
    const tmp54 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.EXYNOS];
    let num60 = 0;
    if (null != tmp54) {
      const _Math52 = Math;
    ...
    obj[91] = num60;
    const tmp55 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.WEBRTC];
    let num61 = 0;
    if (null != tmp55) {
      const _Math53 = Math;
    ...
    obj[92] = num61;
    const tmp56 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.QUALCOMM];
    let num62 = 0;
    if (null != tmp56) {
      const _Math54 = Math;
    ...
    obj[93] = num62;
    const tmp57 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.MEDIATEK];
    let num63 = 0;
    if (null != tmp57) {
      const _Math55 = Math;
    ...
    obj[94] = num63;
    const tmp58 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.D3D11VIDEODECODER];
    let num64 = 0;
    if (null != tmp58) {
      const _Math56 = Math;
    ...
    obj[95] = num64;
    const tmp59 = aggregationDuration.decoderBuckets[require(undefined, 7109) /* parseEncoder */.Decoders.ANDROID];
    let num65 = 0;
    if (null != tmp59) {
      const _Math57 = Math;
    ...
    if (aggregationDuration instanceof require(7109) /* parseEncoder */.OutboundStats) {
...
prototype["receivedStats"] = function receivedStats(nowResult, transport, streamParameters) {
  ...
  let tmp7 = self.connection.context === tmp(4352).MediaEngineContextTypes.DEFAULT;
  if (tmp7) {
    tmp7 = null != transport.camera;
  }
  self.cameraDuration.value = tmp7;
  let tmp9 = self.connection.context === tmp(4352).MediaEngineContextTypes.DEFAULT;
  if (tmp9) {
  ...
  let tmp11 = self.connection.context === tmp(4352).MediaEngineContextTypes.DEFAULT;
  if (tmp11) {
