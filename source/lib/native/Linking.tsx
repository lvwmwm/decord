...
export default {
  openURL(arg0, arg1) {
    ...
    require(4012) /* sanitizeURLPart */.default(arg0, arg1, { allowExternal: flag });
  },
  openURLExternally(href, SAFARI) {
    require(4012) /* sanitizeURLPart */.default(href, SAFARI, { forceExternalBrowser: true });
  },
