...
export default {
  openURL(arg0, arg1) {
    ...
    require(3976) /* sanitizeURLPart */.default(arg0, arg1, { allowExternal: flag });
  },
  openURLExternally(href, SAFARI) {
    require(3976) /* sanitizeURLPart */.default(href, SAFARI, { forceExternalBrowser: true });
  },
