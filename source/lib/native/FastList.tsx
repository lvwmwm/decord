...
// Dependencies: [109, 32, 19, 17, 21, 12, 643, 5820, 4340, 500, 4083, 8050, 8051, 5438, 8052, 2]
// Exports: getItemSizeOverrideKey

// Module 8049 (renderDefaultEmpty)
...
let closure_21 = importAllResult.memo(function _FastListSectionRenderer(disableWrapper) {
  ...
  obj1[3] = section;
  closure_10(importDefault(5820), obj1);
});
...
let closure_23 = importAllResult.memo(function _FastListItemRenderer(disableWrapper) {
  ...
  obj[2] = items;
  childrenResult = closure_10(importDefault(5820), obj);
});
...
let closure_25 = importAllResult.memo(function _FastListSpacer(layoutSize) {
  ...
  return closure_11(importDefault(5820), { collapsable: false, style });
});
let c26 = 1000;
let c27 = 0.5;
...
prototype4["getInitialState"] = function getInitialState(result, setInfo, isFirstLayout) {
  ...
  if (null != scrollPosValue) {
    ...
    self.scrollPosValue = require(4083).makeMutable(tmp10);
...
prototype4["render"] = function render() {
  ...
  if (props.inActionSheet) {
    let BottomSheetScrollView = require(5438) /* BottomSheetModal */.BottomSheetScrollView;
  } else {
  ...
  obj.ref = importDefault(8052)(self.scrollView);
