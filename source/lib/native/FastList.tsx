...
let closure_21 = importAllResult.memo(function _FastListSectionRenderer(disableWrapper) {
  ...
  obj1[3] = section;
  closure_10(importDefault(5568), obj1);
});
...
let closure_23 = importAllResult.memo(function _FastListItemRenderer(disableWrapper) {
  ...
  obj[2] = items;
  childrenResult = closure_10(importDefault(5568), obj);
});
...
let closure_25 = importAllResult.memo(function _FastListSpacer(layoutSize) {
  ...
  return closure_11(importDefault(5568), { collapsable: false, style });
});
let c26 = 1000;
let c27 = 0.5;
...
prototype4["getInitialState"] = function getInitialState(result, setInfo, isFirstLayout) {
  ...
  if (null != scrollPosValue) {
    ...
    self.scrollPosValue = require(4050).makeMutable(tmp10);
...
prototype4["render"] = function render() {
  ...
  if (props.inActionSheet) {
    let BottomSheetScrollView = require(5245) /* BottomSheetModal */.BottomSheetScrollView;
  } else {
...
const animatedComponent = require("module_4050").createAnimatedComponent(FastList);
