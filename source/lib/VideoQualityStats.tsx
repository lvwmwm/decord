...
let closure_9 = [];
let closure_10 = [false, false, false, false, false, false, false, false, false, false, false, null, null];
let closure_11 = [null, null, null];
let closure_12 = [];
...
const tmp3 = () => {
  class InboundStats {
    constructor(arg0) {
      ...
      this.codecBuckets = { ao: true, shapes: true, ip: true, op: true, st: true, bm: true };
      this.statsWindow = [];
