...
// Dependencies: [32, 1218, 676, 4364, 687, 4621, 13071, 4403, 4413, 4188, 10697, 11, 12, 500, 643, 4400, 2]

// Module 13070 (getDefaultWants)
...
function getDefaultWants(arg0) {
  let obj = require(13071) /* getBrowserInvertedWantsConfig */;
...
prototype["shouldReceiveFromUser"] = function shouldReceiveFromUser(arg0) {
  ...
  const WindowVisibilityVideoManager = require(10697) /* isIncomingVideoEnabled */.WindowVisibilityVideoManager;
...
prototype["reset"] = function reset() {
  ...
  WindowVisibilityVideoManager.off(require(10697) /* isIncomingVideoEnabled */.WindowVisibilityEvent.IncomingVideoEnabledChanged, self.incomingVideoEnabledChanged);
};
