...
// Dependencies: [32, 1218, 676, 4364, 687, 4621, 13073, 4403, 4413, 4188, 10698, 11, 12, 500, 643, 4400, 2]

// Module 13072 (getDefaultWants)
...
function getDefaultWants(arg0) {
  let obj = require(13073) /* getBrowserInvertedWantsConfig */;
...
prototype["shouldReceiveFromUser"] = function shouldReceiveFromUser(arg0) {
  ...
  const WindowVisibilityVideoManager = require(10698) /* isIncomingVideoEnabled */.WindowVisibilityVideoManager;
...
prototype["reset"] = function reset() {
  ...
  WindowVisibilityVideoManager.off(require(10698) /* isIncomingVideoEnabled */.WindowVisibilityEvent.IncomingVideoEnabledChanged, self.incomingVideoEnabledChanged);
};
