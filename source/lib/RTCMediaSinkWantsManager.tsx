...
// Dependencies: [57, 6, 7, 15, 17, 18, 1194, 653, 4192, 664, 4450, 12797, 4279, 21, 477, 620, 22, 4016, 10496, 4228, 4298, 2]
...
function getDefaultWants(any) {
  let obj = require(12797) /* getBrowserInvertedWantsConfig */;
