...
// Function ID: 4988
// Name: mergeMessage
// Dependencies: [676, 3, 4521, 12, 4234, 11, 4988, 4989, 4990, 4991, 2]
// Exports: flatMapChannelMessages

// Module 4987 (mergeMessage)
import ME from "ME";
...
function mergeMessage(self, id) {
  ...
  messageRecord = require(4521) /* createMinimalMessageRecord */.createMessageRecord(id);
}
...
ChannelMessages["getOrCreate"] = function getOrCreate(channelId) {
  ...
  if (null == tmp2) {
    ...
    obj[2] = require(4234) /* GuildThemeSourcePreference */.JumpType.ANIMATED;
    obj[21] = [];
    if (typeof MessageCache !== "function") {
      HermesBuiltin.throwTypeError();
    }
...
prototype2["mergeDelta"] = function mergeDelta(new_messages, modified_messages, deleted_message_ids) {
  ...
  return this.mutate((_before) => {
    ...
    const mapped = set.map((message) => set(4521).createMessageRecord(message));
    const combined = found.concat(mapped, items1.map((message) => set(4521).createMessageRecord(message)));
...
prototype2["receiveMessage"] = function receiveMessage(nonce) {
    ...
    if (id === id1) {
      if (null != nonce.nonce) {
        if (value.id === nonce.nonce) {
          const messageRecord = messageRecord1(4521).createMessageRecord(nonce);
  ...
  if (self.hasMoreAfter) {
    ...
    messageRecord1 = messageRecord1(4521).createMessageRecord(nonce);
    const lastResult = self.last();
    if (null != lastResult) {
...
prototype2["receivePushNotification"] = function receivePushNotification(closure_1, closure_2) {
  ...
  if (null != value) {
    ...
    let obj = require(4990) /* isIOSPushNotificationRawPayloadFixExperimentEnabled */;
...
prototype2["loadComplete"] = function loadComplete(newMessages) {
  ...
  if (flag) {
    if (null == jump) {
      ...
      if (jumpType == null) {
        jumpType = require(4234) /* GuildThemeSourcePreference */.JumpType.ANIMATED;
      }
