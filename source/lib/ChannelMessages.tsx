...
// Function ID: 41880
// Name: mergeMessage
// Dependencies: [153, 6, 7, 653, 3, 4386, 22, 4097, 21, 4839, 4840, 4841, 4842, 2]
// Exports: flatMapChannelMessages

// Module 4838 (mergeMessage)
...
function mergeMessage(get, id) {
  ...
  messageRecord = require(4386) /* createMinimalMessageRecord */.createMessageRecord(id);
}
