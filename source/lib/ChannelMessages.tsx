...
// Function ID: 4971
// Name: mergeMessage
// Dependencies: [676, 3, 4504, 12, 4217, 11, 4971, 4972, 4973, 4974, 2]
// Exports: flatMapChannelMessages

// Module 4970 (mergeMessage)
import ME from "ME";
...
prototype2["receivePushNotification"] = function receivePushNotification(closure_1, closure_2) {
  ...
  if (null != value) {
    ...
    let obj = require(4973) /* isIOSPushNotificationRawPayloadFixExperimentEnabled */;
