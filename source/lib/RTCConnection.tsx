...
// Dependencies: [5, 4359, 4369, 9133, 9072, 1218, 1372, 1891, 4332, 4356, 10840, 4377, 1903, 676, 1905, 12983, 4345, 584, 4360, 4384, 1208, 3, 12984, 514, 12986, 12988, 10634, 10841, 1454, 500, 3895, 1467, 709, 12989, 1384, 4380, 14, 5120, 12991, 12992, 10630, 698, 4279, 7052, 12993, 12995, 12996, 12997, 4381, 12998, 12999, 13001, 7129, 13002, 9092, 6854, 13003, 13004, 10525, 13006, 4623, 1236, 636, 1217, 2]

// Module 4358 (getEventHistoryString)
...
prototype["connect"] = function connect(endpoint, token) {
  ...
  if (this._destroyed) {
    ...
    if (null != self.endpoint) {
      ...
      const obj5 = new importDefault(12989)(self.endpoint, self.context);
      self._socket = obj5;
      const _handleConnecting = self._handleConnecting;
      obj5.on(require(12989) /* noop */.SocketEvent.Connecting, _handleConnecting.bind(self, obj5));
      const _handleConnect = self._handleConnect;
      obj5.on(require(12989) /* noop */.SocketEvent.Connect, _handleConnect.bind(self, obj5));
      const _handleDisconnect = self._handleDisconnect;
      obj5.on(require(12989) /* noop */.SocketEvent.Disconnect, _handleDisconnect.bind(self, obj5));
      const _handleResuming = self._handleResuming;
      obj5.on(require(12989) /* noop */.SocketEvent.Resuming, _handleResuming.bind(self, obj5));
      const _handleReady = self._handleReady;
      obj5.on(require(12989) /* noop */.SocketEvent.Ready, _handleReady.bind(self, obj5));
      const _handleSfuUpdate = self._handleSfuUpdate;
      obj5.on(require(12989) /* noop */.SocketEvent.SfuUpdate, _handleSfuUpdate.bind(self, obj5));
      const _handleSpeaking = self._handleSpeaking;
      obj5.on(require(12989) /* noop */.SocketEvent.Speaking, _handleSpeaking.bind(self, obj5));
      const _handleVideo = self._handleVideo;
      obj5.on(require(12989) /* noop */.SocketEvent.Video, _handleVideo.bind(self, obj5));
      const _handleControlPing = self._handleControlPing;
      obj5.on(require(12989) /* noop */.SocketEvent.Ping, _handleControlPing.bind(self));
      const _handleClientDisconnect = self._handleClientDisconnect;
      obj5.on(require(12989) /* noop */.SocketEvent.ClientDisconnect, _handleClientDisconnect.bind(self));
      const _handleClientConnect = self._handleClientConnect;
      obj5.on(require(12989) /* noop */.SocketEvent.ClientConnect, _handleClientConnect.bind(self));
      const _handleCodecs = self._handleCodecs;
      obj5.on(require(12989) /* noop */.SocketEvent.Codecs, _handleCodecs.bind(self));
      const _handleMediaSessionId = self._handleMediaSessionId;
      obj5.on(require(12989) /* noop */.SocketEvent.MediaSessionId, _handleMediaSessionId.bind(self));
      const _handleMediaSinkWants = self._handleMediaSinkWants;
      obj5.on(require(12989) /* noop */.SocketEvent.MediaSinkWants, _handleMediaSinkWants.bind(self));
      const _handleCodeVersion = self._handleCodeVersion;
      obj5.on(require(12989) /* noop */.SocketEvent.VoiceBackendVersion, _handleCodeVersion.bind(self));
      const _handleKeyframeInterval = self._handleKeyframeInterval;
      obj5.on(require(12989) /* noop */.SocketEvent.KeyframeInterval, _handleKeyframeInterval.bind(self));
      const handleFlags = self.handleFlags;
      obj5.on(require(12989) /* noop */.SocketEvent.Flags, handleFlags.bind(self));
      const handlePlatform = self.handlePlatform;
      obj5.on(require(12989) /* noop */.SocketEvent.Platform, handlePlatform.bind(self));
      const _handleBandwidthEstimationExperiment = self._handleBandwidthEstimationExperiment;
      obj5.on(require(12989) /* noop */.SocketEvent.BandwidthEstimationExperiment, _handleBandwidthEstimationExperiment.bind(self));
      const _handleSecureFramesInit = self._handleSecureFramesInit;
      obj5.on(require(12989) /* noop */.SocketEvent.SecureFramesInit, _handleSecureFramesInit.bind(self));
      const _handleSecureFramesPrepareTransition = self._handleSecureFramesPrepareTransition;
      obj5.on(require(12989) /* noop */.SocketEvent.SecureFramesPrepareTransition, _handleSecureFramesPrepareTransition.bind(self));
      const _handleSecureFramesPrepareEpoch = self._handleSecureFramesPrepareEpoch;
      obj5.on(require(12989) /* noop */.SocketEvent.SecureFramesPrepareEpoch, _handleSecureFramesPrepareEpoch.bind(self));
      const _handleSecureFramesExecuteTransition = self._handleSecureFramesExecuteTransition;
      obj5.on(require(12989) /* noop */.SocketEvent.SecureFramesExecuteTransition, _handleSecureFramesExecuteTransition.bind(self));
      const _handleMLSExternalSenderPackage = self._handleMLSExternalSenderPackage;
      obj5.on(require(12989) /* noop */.SocketEvent.MLSExternalSenderPackage, _handleMLSExternalSenderPackage.bind(self));
      const _handleMLSProposals = self._handleMLSProposals;
      obj5.on(require(12989) /* noop */.SocketEvent.MLSProposals, _handleMLSProposals.bind(self, obj5));
      const _handleMLSPrepareCommitTransition = self._handleMLSPrepareCommitTransition;
      obj5.on(require(12989) /* noop */.SocketEvent.MLSPrepareCommitTransition, _handleMLSPrepareCommitTransition.bind(self));
      const _handleMLSWelcome = self._handleMLSWelcome;
      obj5.on(require(12989) /* noop */.SocketEvent.MLSWelcome, _handleMLSWelcome.bind(self));
      const _recordMessageEvent = self._recordMessageEvent;
      obj5.on(require(12989) /* noop */.SocketEvent.ReceiveMessage, _recordMessageEvent.bind(self, tmp3.MESSAGE_RECEIVE));
      const _recordMessageEvent2 = self._recordMessageEvent;
      obj5.on(require(12989) /* noop */.SocketEvent.SendMessage, _recordMessageEvent2.bind(self, tmp3.MESSAGE_SEND));
...
prototype["destroy"] = function destroy() {
  ...
  WindowVisibilityVideoManager2.off(require(10634) /* isIncomingVideoEnabled */.WindowVisibilityEvent.WindowVisibilityChanged, self.windowVisibilityChanged);
  self._cancelReconnect();
  self._cleanupSocket();
...
prototype["_chooseExperiments"] = function _chooseExperiments(items) {
  ...
  const config = importDefault(5120).getConfig({ location: "_chooseExperiments" });
  if (config.enabled) {
...
prototype["_connectMediaEngineWithEndpoint"] = function _connectMediaEngineWithEndpoint(_sfuEndpoint, _readyData) {
  ...
  const ProcessBoostExperiment = _require(12995).ProcessBoostExperiment;
  ...
  connectResult.on(_require(4381).BaseConnectionEvent.Stats, importDefault(6854).create());
...
prototype["_handleBandwidthEstimationExperiment"] = function _handleBandwidthEstimationExperiment(_bandwidthEstimationExperiment) {
  ...
  const mediaEngineExperiments = importDefault(13006).getMediaEngineExperiments(_bandwidthEstimationExperiment);
