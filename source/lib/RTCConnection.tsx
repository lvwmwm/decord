...
// Dependencies: [5, 4419, 4429, 9260, 9199, 1218, 1391, 1910, 4393, 4416, 10891, 4437, 1922, 676, 1924, 13135, 4406, 584, 4420, 4444, 1208, 3, 13136, 514, 13138, 13140, 10670, 10892, 1473, 500, 3972, 1486, 709, 13141, 1403, 4440, 14, 5179, 13143, 13144, 10666, 698, 4336, 7177, 13145, 13147, 13148, 13149, 4441, 13150, 13151, 13153, 7253, 13154, 9219, 6981, 13155, 13156, 10580, 13158, 4683, 1236, 636, 1217, 2]
...
prototype["destroy"] = function destroy() {
  ...
  WindowVisibilityVideoManager2.off(require(10670) /* isIncomingVideoEnabled */.WindowVisibilityEvent.WindowVisibilityChanged, self.windowVisibilityChanged);
  self._cancelReconnect();
  self._cleanupSocket();
