...
// Dependencies: [5, 4419, 4429, 9260, 9199, 1218, 1391, 1910, 4393, 4416, 10893, 4437, 1922, 676, 1924, 13136, 4406, 584, 4420, 4444, 1208, 3, 13137, 514, 13139, 13141, 10672, 10894, 1473, 500, 3972, 1486, 709, 13142, 1403, 4440, 14, 5179, 13144, 13145, 10668, 698, 4336, 7177, 13146, 13148, 13149, 13150, 4441, 13151, 13152, 13154, 7253, 13155, 9219, 6981, 13156, 13157, 10582, 13159, 4683, 1236, 636, 1217, 2]

// Module 4418 (getEventHistoryString)
...
prototype["connect"] = function connect(endpoint, token) {
  ...
  if (this._destroyed) {
    ...
    if (null != self.endpoint) {
      ...
      const obj5 = new importDefault(13142)(self.endpoint, self.context);
      self._socket = obj5;
      const _handleConnecting = self._handleConnecting;
      obj5.on(require(13142) /* noop */.SocketEvent.Connecting, _handleConnecting.bind(self, obj5));
      const _handleConnect = self._handleConnect;
      obj5.on(require(13142) /* noop */.SocketEvent.Connect, _handleConnect.bind(self, obj5));
      const _handleDisconnect = self._handleDisconnect;
      obj5.on(require(13142) /* noop */.SocketEvent.Disconnect, _handleDisconnect.bind(self, obj5));
      const _handleResuming = self._handleResuming;
      obj5.on(require(13142) /* noop */.SocketEvent.Resuming, _handleResuming.bind(self, obj5));
      const _handleReady = self._handleReady;
      obj5.on(require(13142) /* noop */.SocketEvent.Ready, _handleReady.bind(self, obj5));
      const _handleSfuUpdate = self._handleSfuUpdate;
      obj5.on(require(13142) /* noop */.SocketEvent.SfuUpdate, _handleSfuUpdate.bind(self, obj5));
      const _handleSpeaking = self._handleSpeaking;
      obj5.on(require(13142) /* noop */.SocketEvent.Speaking, _handleSpeaking.bind(self, obj5));
      const _handleVideo = self._handleVideo;
      obj5.on(require(13142) /* noop */.SocketEvent.Video, _handleVideo.bind(self, obj5));
      const _handleControlPing = self._handleControlPing;
      obj5.on(require(13142) /* noop */.SocketEvent.Ping, _handleControlPing.bind(self));
      const _handleClientDisconnect = self._handleClientDisconnect;
      obj5.on(require(13142) /* noop */.SocketEvent.ClientDisconnect, _handleClientDisconnect.bind(self));
      const _handleClientConnect = self._handleClientConnect;
      obj5.on(require(13142) /* noop */.SocketEvent.ClientConnect, _handleClientConnect.bind(self));
      const _handleCodecs = self._handleCodecs;
      obj5.on(require(13142) /* noop */.SocketEvent.Codecs, _handleCodecs.bind(self));
      const _handleMediaSessionId = self._handleMediaSessionId;
      obj5.on(require(13142) /* noop */.SocketEvent.MediaSessionId, _handleMediaSessionId.bind(self));
      const _handleMediaSinkWants = self._handleMediaSinkWants;
      obj5.on(require(13142) /* noop */.SocketEvent.MediaSinkWants, _handleMediaSinkWants.bind(self));
      const _handleCodeVersion = self._handleCodeVersion;
      obj5.on(require(13142) /* noop */.SocketEvent.VoiceBackendVersion, _handleCodeVersion.bind(self));
      const _handleKeyframeInterval = self._handleKeyframeInterval;
      obj5.on(require(13142) /* noop */.SocketEvent.KeyframeInterval, _handleKeyframeInterval.bind(self));
      const handleFlags = self.handleFlags;
      obj5.on(require(13142) /* noop */.SocketEvent.Flags, handleFlags.bind(self));
      const handlePlatform = self.handlePlatform;
      obj5.on(require(13142) /* noop */.SocketEvent.Platform, handlePlatform.bind(self));
      const _handleBandwidthEstimationExperiment = self._handleBandwidthEstimationExperiment;
      obj5.on(require(13142) /* noop */.SocketEvent.BandwidthEstimationExperiment, _handleBandwidthEstimationExperiment.bind(self));
      const _handleSecureFramesInit = self._handleSecureFramesInit;
      obj5.on(require(13142) /* noop */.SocketEvent.SecureFramesInit, _handleSecureFramesInit.bind(self));
      const _handleSecureFramesPrepareTransition = self._handleSecureFramesPrepareTransition;
      obj5.on(require(13142) /* noop */.SocketEvent.SecureFramesPrepareTransition, _handleSecureFramesPrepareTransition.bind(self));
      const _handleSecureFramesPrepareEpoch = self._handleSecureFramesPrepareEpoch;
      obj5.on(require(13142) /* noop */.SocketEvent.SecureFramesPrepareEpoch, _handleSecureFramesPrepareEpoch.bind(self));
      const _handleSecureFramesExecuteTransition = self._handleSecureFramesExecuteTransition;
      obj5.on(require(13142) /* noop */.SocketEvent.SecureFramesExecuteTransition, _handleSecureFramesExecuteTransition.bind(self));
      const _handleMLSExternalSenderPackage = self._handleMLSExternalSenderPackage;
      obj5.on(require(13142) /* noop */.SocketEvent.MLSExternalSenderPackage, _handleMLSExternalSenderPackage.bind(self));
      const _handleMLSProposals = self._handleMLSProposals;
      obj5.on(require(13142) /* noop */.SocketEvent.MLSProposals, _handleMLSProposals.bind(self, obj5));
      const _handleMLSPrepareCommitTransition = self._handleMLSPrepareCommitTransition;
      obj5.on(require(13142) /* noop */.SocketEvent.MLSPrepareCommitTransition, _handleMLSPrepareCommitTransition.bind(self));
      const _handleMLSWelcome = self._handleMLSWelcome;
      obj5.on(require(13142) /* noop */.SocketEvent.MLSWelcome, _handleMLSWelcome.bind(self));
      const _recordMessageEvent = self._recordMessageEvent;
      obj5.on(require(13142) /* noop */.SocketEvent.ReceiveMessage, _recordMessageEvent.bind(self, tmp3.MESSAGE_RECEIVE));
      const _recordMessageEvent2 = self._recordMessageEvent;
      obj5.on(require(13142) /* noop */.SocketEvent.SendMessage, _recordMessageEvent2.bind(self, tmp3.MESSAGE_SEND));
      self._connectStartTime = require(4420) /* sleep */.now();
...
prototype["destroy"] = function destroy() {
  ...
  WindowVisibilityVideoManager2.off(require(10672) /* isIncomingVideoEnabled */.WindowVisibilityEvent.WindowVisibilityChanged, self.windowVisibilityChanged);
  self._cancelReconnect();
  self._cleanupSocket();
...
prototype["getDuration"] = function getDuration() {
  ...
  if (this._connectCompletedTime > 0) {
    num = require(4420) /* sleep */.now() - tmp._connectCompletedTime;
...
prototype["setState"] = function setState(s) {
  ...
  this.emit(require(4440) /* RTCConnectionEvent */.RTCConnectionEvent.State, s, obj, obj);
};
...
prototype["_chooseExperiments"] = function _chooseExperiments(items) {
  ...
  const config = importDefault(5179).getConfig({ location: "_chooseExperiments" });
  if (config.enabled) {
...
prototype["_connectMediaEngineWithEndpoint"] = function _connectMediaEngineWithEndpoint(_sfuEndpoint, _readyData) {
  ...
  const ProcessBoostExperiment = _require(13148).ProcessBoostExperiment;
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.Speaking, (arg0, _lastSentSpeakingStatus, _lastSentSSRC) => {
    if (self.userId === arg0) {
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.NativeMuteChanged, (arg0) => {
    if (self.context === outer1_25.DEFAULT) {
      _sfuEndpoint(_undefined[49]).nativeMuteChanged(arg0);
      const obj = _sfuEndpoint(_undefined[49]);
    }
  });
  connectResult.on(_require(4441).BaseConnectionEvent.Video, (userId, streamId, audioSsrc, arg3, arg4, arr) => {
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.FirstFrame, (arg0, arg1, arg2) => {
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.Silence, (arg0) => {
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.Connected, (protocol, sdp) => {
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.VideoEncoderFallback, (arr) => {
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.VideoDecoderFallback, (arr) => {
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.VideoCodecError, (codecStandard) => {
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.Error, (error) => {
    let obj = self;
    if (socket === self._socket) {
      let preferredRegion = null;
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.ConnectionStateChange, (arg0) => {
    const logger = self.logger;
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.SecureFramesUpdate, (_secureFramesState) => {
  ...
  connectResult.on(_require(4441).BaseConnectionEvent.Ping, _handlePing.bind(self));
  const _handlePingTimeout = self._handlePingTimeout;
  connectResult.on(_require(4441).BaseConnectionEvent.PingTimeout, _handlePingTimeout.bind(self));
  const _handleOutboundLossRate = self._handleOutboundLossRate;
  connectResult.on(_require(4441).BaseConnectionEvent.OutboundLossRate, _handleOutboundLossRate.bind(self));
  const _handleLocalVideoDisabled = self._handleLocalVideoDisabled;
  connectResult.on(_require(4441).BaseConnectionEvent.LocalVideoDisabled, _handleLocalVideoDisabled.bind(self));
  tmp14 = constants5;
  const tmp2Result1 = _require(500);
  connectResult.on(_require(4441).BaseConnectionEvent.Stats, importDefault(6981).create());
  const _handleRemoteStreamsReady = self._handleRemoteStreamsReady;
  connectResult.on(_require(4441).BaseConnectionEvent.RemoteStreamsReady, _handleRemoteStreamsReady.bind(self));
  const handleUsersMerged = self.handleUsersMerged;
  connectResult.on(_require(4441).BaseConnectionEvent.UsersMerged, handleUsersMerged.bind(self));
  connectResult.on(_require(4441).BaseConnectionEvent.NoiseCancellationError, (_noiseCancellationError) => {
    self._noiseCancellationError = _noiseCancellationError;
  });
  const _handleMLSFailure = self._handleMLSFailure;
  connectResult.on(_require(4441).BaseConnectionEvent.MLSFailure, _handleMLSFailure.bind(self));
...
prototype["handleFlags"] = function handleFlags(arg0, arg1) {
  this.emit(require(4440) /* RTCConnectionEvent */.RTCConnectionEvent.Flags, arg0, arg1);
};
prototype["handlePlatform"] = function handlePlatform(arg0, arg1) {
  this.emit(require(4440) /* RTCConnectionEvent */.RTCConnectionEvent.Platform, arg0, arg1, this.channelId);
};
prototype["handleUsersMerged"] = function handleUsersMerged(arr) {
  this.emit(require(4440) /* RTCConnectionEvent */.RTCConnectionEvent.UsersMerged, arr.map((id) => id.id), this.context);
};
...
prototype["_handlePing"] = function _handlePing(arg0) {
  ...
  if (undefined !== arg0) {
    ...
    self.emit(require(4440) /* RTCConnectionEvent */.RTCConnectionEvent.Ping, self._pings, self.quality);
  }
};
...
prototype["_handleOutboundLossRate"] = function _handleOutboundLossRate(_outboundLossRate) {
  ...
  this.emit(require(4440) /* RTCConnectionEvent */.RTCConnectionEvent.OutboundLossRate, _outboundLossRate);
};
...
prototype["_handleClientDisconnect"] = function _handleClientDisconnect(sender_user_id) {
  ...
  if (null != _videoQuality) {
    if (self.context === constants6.DEFAULT) {
      ...
      if (tmp) {
        ...
        obj = {};
        const merged = Object.assign(self._getAnalyticsProperties());
        obj.app_hardware_acceleration_enabled = importDefault(4336).getAppHardwareAccelerationEnabled();
        obj.media_session_id = self.getMediaSessionId();
        obj.sender_user_id = sender_user_id;
  ...
  self.emit(require(4440) /* RTCConnectionEvent */.RTCConnectionEvent.ClientDisconnect, sender_user_id);
  const _localMediaSinkWantsManager2 = self._localMediaSinkWantsManager;
  ...
  if (1 === self._userIds.size) {
    self._secureFramesLastBecameAloneTime = require(4420) /* sleep */.now();
    const tmp22Result = require(4420) /* sleep */;
  }
};
  ...
  if (!this._voiceConnectionSuccessTracked) {
    if (self.state === constants3.RTC_CONNECTED) {
      if (self._hasCodecs) {
        ...
        obj.connect_time = require(4420) /* sleep */.now() - (1 === self._connectCount ? self._createdTime : self._connectStartTime);
...
prototype["_handleBandwidthEstimationExperiment"] = function _handleBandwidthEstimationExperiment(_bandwidthEstimationExperiment) {
  ...
  const mediaEngineExperiments = importDefault(13159).getMediaEngineExperiments(_bandwidthEstimationExperiment);
...
prototype["_handleSecureFramesInit"] = function _handleSecureFramesInit(v) {
  ...
  if (v > 0) {
    ...
    const tmpResult = require(4420) /* sleep */;
  } else {
