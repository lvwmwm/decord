...
let closure_9 = (arg0) => {
  ...
  callback3(TypeMismatchError, arg0);
  return callback(TypeMismatchError);
}(_module(Error));
let closure_10 = (arg0) => {
  ...
  callback3(QuotaExceededError, arg0);
  return callback(QuotaExceededError);
}(_module(Error));
