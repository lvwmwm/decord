// Module ID: 13352
// Function ID: 102226
// Dependencies: [13353, 13301, 13297, 13298, 13317, 13354, 13355, 13320]
...
if (getOwnPropertyDescriptor) {
  getOwnPropertyDescriptor = !require("module_13298")(() => 8 !== defineProperty(() => {
...
const fn = (name, toString) => {
  ...
  let tmp9 = !require(13317) /* call */(name, "name");
  if (!tmp9) {
    let CONFIGURABLE = require(13354).CONFIGURABLE;
    if (CONFIGURABLE) {
  ...
  if (tmp9) {
    if (require(13297) /* getOwnPropertyDescriptor */) {
  ...
  if (tmp22) {
    tmp22 = require(13317) /* call */(arg2, "arity");
  }
  if (tmp22) {
  ...
  if (arg2) {
    if (require(13317) /* call */(arg2, "constructor")) {
      if (arg2.constructor) {
        if (require(13297) /* getOwnPropertyDescriptor */) {
          obj = { writable: false };
      ...
      while (true) {
        ...
        let num4 = 6;
        let obj4 = require(13355) /* state */;
        let tmp43 = name;
        let enforceResult = obj4.enforce(name);
        let tmp45 = enforceResult;
        let str10 = "source";
        if (require(13317) /* call */(enforceResult, "source")) {
          break;
        } else {
          let tmp48 = text;
          let str11 = "";
...
Function.prototype.toString = fn(function toString() {
  const self = this;
  let source = require(13320) /* all */(this);
  if (source) {
    source = require(13355) /* state */.get(self).source;
    const obj = require(13355) /* state */;
  }
  if (!source) {
