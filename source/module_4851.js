// Module ID: 4851
// Function ID: 4852
// Dependencies: [4811, 4826, 4827, 4823, 4806]
...
arg5.default = {
  read(buffer, sum) {
    ...
    let obj2 = require(4826) /* readTag */;
    const ifd = obj1.readIfd(buffer, require(4827) /* importDefaultResult1 */.IFD_TYPE_MPF, sum, obj2.get0thIfdOffset(buffer, sum, byteOrder), byteOrder, arg2);
    if (ifd.MPEntry) {
      const items = [];
      const _Math = Math;
      let num13 = 0;
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let obj3 = module(4823);
          let typeSize = obj3.getTypeSize("LONG");
          let tmp10 = num13;
          if (byteOrder === module(4811).LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
          ...
          if (0 !== num13) {
            ...
            let obj15 = require(4806) /* getDataView */;
        ...
        const typeSize4 = module(4823).getTypeSize("LONG");
        if (byteOrder === module(4811).LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
