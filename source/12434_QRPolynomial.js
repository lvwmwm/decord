...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = _mod12435;
      const glogResult = _mod12435.glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - _mod12435.glog(getLength.get(0));
