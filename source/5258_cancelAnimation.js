...
// Dependencies: [1582, 5255]

// Module 5258 (cancelAnimation)
...
while (true) {
  ...
  if (!setGestureState) {
    ...
    function pnpm_reanimatedWrapperTs1() {
      console.warn(require(5255) /* hasProperty */.tagMessage("Please use newer version of react-native-reanimated in order to control state of the gestures."));
    }
    obj = {};
