...
// Function ID: 13647
// Name: URLImpl
// Dependencies: [41, 42, 13647, 13651, 13650]

// Module 13646 (URLImpl)
...
class URLImpl {
  constructor(arg0, arg1) {
    ...
    if (null === basicURLParseResult1) {
      ...
      tmp7Result = require("module_13651");
      items = [];
      items[0] = str;
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(13647).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(13647).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(13650).parseUrlencoded(query);
          const tmpResult = tmp(13650);
        }
      }
      const obj = URLImpl(13647);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(13647).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
  ...
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13647).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(13647);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13647).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(13647);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(13647).serializeHost(host);
        const obj3 = URLImpl(13647);
      } else {
        const obj = URLImpl(13647);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(13647).serializeInteger(host.port)}`;
        const obj2 = URLImpl(13647);
      }
    },
    set(arg0) {
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(13647).serializeHost(tmp._url.host);
        const obj = URLImpl(13647);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(13647).serializeInteger(tmp._url.port);
        const obj = URLImpl(13647);
      }
      return str;
    },
    set(arg0) {
      ...
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        if ("" === arg0) {
          ...
          obj[0] = self._url;
          URLImpl(13647).basicURLParse(arg0, obj);
          const tmpResult = URLImpl(13647);
        }
      }
    }
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        self._query._list = URLImpl(13650).parseUrlencoded(substr);
      }
    }
  },
  {
