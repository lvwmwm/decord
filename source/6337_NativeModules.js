...
// Function ID: 6338
// Name: NativeModules
// Dependencies: [5, 17, 6338, 6339, 6344, 6345, 6346, 6347, 6348]
...
const subs = require("module_6338").ProductType.subs;
const inapp = require("module_6338").ProductType.inapp;
...
export const isIosStorekit2 = require("module_6339").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    require(6339).storekit1Mode();
    const obj4 = require(6339);
  } else if ("STOREKIT2_MODE" === str) {
    require(6339).storekit2Mode();
    const obj3 = require(6339);
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    require(6339).storekitHybridMode();
    const obj2 = require(6339);
  }
};
export const initConnection = () => {
  const nativeModule = require(6339).getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = require(6339).getAndroidModule();
      ...
      if (c3 === 2) {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            ...
            closure_0 = arg1.map(outer1_0(6344).singleProductAndroidMap);
            obj = outer1_0(6339);
            c3 = 3;
        ...
        try {
          ...
          if (0 === closure_2) {
            if (arg0 === 1) {
              ...
              c1 = undefined;
              closure_2 = undefined;
              androidModuleType = outer1_0(6339).getAndroidModuleType();
              const obj10 = outer1_0(6339);
              const androidModule = outer1_0(6339).getAndroidModule();
              closure_2 = 1;
              c3 = 1;
              const obj1 = { value: null, done: false };
            ...
            if (arg0 === 1) {
              ...
              if ("android" === outer1_0) {
                ...
                obj3[0] = outer1_8(outer1_1, outer1_0(6338).SubscriptionPlatform.android);
                return obj3;
            ...
            c3 = 3;
            obj = { value: null, done: true };
            obj[0] = outer1_8(closure_2, outer1_0(6338).SubscriptionPlatform.amazon);
            return obj;
          }
        } catch (tmp28) {
          c3 = tmp;
