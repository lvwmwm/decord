...
// Dependencies: [5, 17, 82, 13780, 13782, 13784, 13785, 13788, 13789, 13802, 13804, 13806, 13807, 13808, 13809, 13790]
...
import module_13788 from "module_13788";
import objectifyError from "objectifyError";
import onSend from "onSend";
import module_13804 from "module_13804";
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL !== "string") {
        ...
        return require(13809) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
