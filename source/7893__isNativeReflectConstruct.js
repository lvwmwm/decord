...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7894, 7875, 7876]

// Module 7893 (_isNativeReflectConstruct)
...
let obj = {
  ...
  value: function render() {
    ...
    const tmp = importDefault(7894);
    const merged = Object.assign(self(7875).extractFilter(this.props));
    const obj2 = self(7875);
    const merged1 = Object.assign(self(7875).extractFeMerge(this.props, this));
