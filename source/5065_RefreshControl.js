...
let closure_10 = importDefault(dependencyMap[6])(ScrollView, { defaultDrawDistance: true, supportsOffsetCorrection: true });
...
const tmp3 = importDefault(dependencyMap[6])(RefreshControl, { defaultDrawDistance: true, supportsOffsetCorrection: true });
