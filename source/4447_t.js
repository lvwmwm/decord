...
const fn = function t(exports, React) {
  ...
  function registerWithStripeJs(_registerWrapper) {
    ...
    if (registerAppInfo) {
      _registerWrapper._registerWrapper({ soundsharing: false, deaf_person: false });
    ...
    const tmp3 = arg1 ? function ServerElement(id) {
      ...
      const effect = options.useEffect(() => {
        if (closure_6.current) {
          const tmp4 = callback2(options, tmp23, ["delete"]);
          let tmp5 = tmp4;
          if (tmp4) {
...
if ("function" === typeof globalThis.define) {
  if (globalThis.define.amd) {
    globalThis.define(["<string:962072674>", "<string:1312811188>"], fn);
  }
}
