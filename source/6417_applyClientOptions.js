...
// Dependencies: [6379, 6382, 6395, 6418, 6419, 6405, 6377, 6420, 6413, 6389]

// Module 6417 (applyClientOptions)
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = require(6377) /* isMatchingPattern */.truncate(environment.message, num);
    const obj = require(6377) /* isMatchingPattern */;
  }
  let value = iter;
  ...
  if (value) {
    iter.value = require(6377) /* isMatchingPattern */.truncate(iter.value, num);
    const obj2 = require(6377) /* isMatchingPattern */;
  }
  ...
  if (url) {
    request.url = require(6377) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(6377) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(6420).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = dependencyMap(6413).normalize(data.data, dependencyMap, dependencyMap);
                  data = obj;
                  const obj3 = dependencyMap(6413);
                }
