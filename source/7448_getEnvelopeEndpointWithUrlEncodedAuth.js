...
// Module 7448 (getEnvelopeEndpointWithUrlEncodedAuth)
const require = arg1;
...
arg5.getReportDialogEndpoint = function getReportDialogEndpoint(arg0, user) {
  const url = require(7441) /* dsnFromString */.makeDsn(arg0);
  if (url) {
    let str = "";
    if (url.protocol) {
      const _HermesInternal = HermesInternal;
    ...
    const _HermesInternal6 = HermesInternal;
    let combined1 = "dsn=" + tmp2(7441).dsnToString(url);
    let tmp16 = combined1;
  ...
  const obj = require(7441) /* dsnFromString */;
  tmp2 = require;
};
