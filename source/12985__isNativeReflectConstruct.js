...
// Module 12985 (_isNativeReflectConstruct)
...
({ Animated: closure_7, Easing: closure_8, TouchableOpacity: closure_9 } = require("__exportStarResult1"));
const tmp4 = (PureComponent) => {
  ...
  items[4] = {
    ...
    value: function render() {
      ...
      let obj = { opacity: animOpacity.interpolate({ inputRange: [77601039, 1612144654], outputRange: items }) };
      ...
      obj = { scale: animTransform.interpolate({ inputRange: [77601039, 1612144654], outputRange: items1 }) };
      const items1 = [inactiveScale, 1];
      const items2 = [obj];
      obj.transform = items2;
      if (this._shouldAnimateColor) {
        obj = {};
        const obj1 = { inputRange: [77601039, 1612144654] };
...
tmp4.propTypes = { inactiveOpacity: require("__exportStarResult1").number.isRequired, inactiveScale: require("__exportStarResult1").number.isRequired, active: require("__exportStarResult1").bool, activeOpacity: require("__exportStarResult1").number, carouselRef: require("__exportStarResult1").object, color: require("__exportStarResult1").string, containerStyle: require("__exportStarResult1").ViewPropTypes.style, inactiveColor: require("__exportStarResult1").string, inactiveStyle: require("__exportStarResult1").ViewPropTypes.style, index: require("__exportStarResult1").number, style: require("__exportStarResult1").ViewPropTypes.style, tappable: require("__exportStarResult1").bool };
