...
// Dependencies: [5, 17, 4080, 16614, 16615, 16616]
// Exports: getAppleDeclaredAgeRangeStatus, getIsConsideredOlderThan, setAgeRangeThresholds

// Module 16613 (_getAppleDeclaredAgeRangeStatus)
import importDefaultResult from "module_16616";
...
export const setAgeRangeThresholds = (arg0) => {
  const ageRangeThresholdManager = callback(16614).ageRangeThresholdManager;
...
export const PlayAgeRangeDeclarationUserStatus = require("module_16616").PlayAgeRangeDeclarationUserStatus;
export const PlayAgeRangeDeclarationUserStatusString = require("module_16616").PlayAgeRangeDeclarationUserStatusString;
