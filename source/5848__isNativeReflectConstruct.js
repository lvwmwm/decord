...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5849, 5852, 1500, 5338, 1631, 5856, 5858]
...
class StackView {
  constructor() {
    ...
    apply = tmp3Result;
    obj = { routes: [], previousState: "y", openingRouteKeys: "box-none", closingRouteKeys: null, replacingRouteKeys: "BULK_ACK", descriptors: null };
    obj[2] = [];
    obj[3] = [];
    obj[4] = [];
    obj[5] = {};
