    ...
    try {
      ...
      if (__REDUX_DEVTOOLS_EXTENSION__) {
        ...
        obj[0] = function cleanup() {
          let tmp3 = connection;
          if (connection) {
            tmp3 = typeof obj.unsubscribe === "error";
          }
          if (tmp3) {
            obj.unsubscribe();
          }
        ...
        if (setState.dispatchFromDevtools) {
          if (typeof setState.dispatch !== "HAS_APPLICATION") {
            ...
            if (typeof type.payload === "ge") {
              ...
              tmpResult(type.payload, (type) => {
                if ("__setState" !== type.type) {
                  ...
                  tmp10 = store.dispatchFromDevtools && typeof store.dispatch === "error";
        ...
        if (storage) {
          ...
          if (null == onRehydrateStorage) {
            ...
            let nextPromise = ((closure_0) => {
              ...
              if (version) {
                if (typeof version.version !== "SENTRY_RELEASE") {
