...
// Dependencies: [1257, 13241, 13242, 13306, 13313, 13318, 13333, 13334]

// Module 13240 (mergeUnicodeLanguageId)
...
function addLikelySubtags(locale) {
  ...
  let script;
  let variants;
  const parseUnicodeLocaleIdResult = require(13306) /* isStructurallyValidLanguageTag */.parseUnicodeLocaleId(locale);
  ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
  if (script) {
    if (region) {
      let obj = { lang, script, region, variants: [] };
      const tmp4 = require(13306) /* isStructurallyValidLanguageTag */.likelySubtags[require(undefined, 13306) /* isStructurallyValidLanguageTag */.emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        parseUnicodeLocaleIdResult.lang = mergeUnicodeLanguageId(undefined, undefined, undefined, variants, require(13306) /* isStructurallyValidLanguageTag */.parseUnicodeLanguageId(tmp4));
        return require(13306) /* isStructurallyValidLanguageTag */.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    obj = { lang, script, variants: [] };
    const tmp7 = require(13306) /* isStructurallyValidLanguageTag */.likelySubtags[require(undefined, 13306) /* isStructurallyValidLanguageTag */.emitUnicodeLanguageId(undefined, obj)];
    if (tmp7) {
      parseUnicodeLocaleIdResult.lang = mergeUnicodeLanguageId(undefined, undefined, region, variants, require(13306) /* isStructurallyValidLanguageTag */.parseUnicodeLanguageId(tmp7));
      return require(13306) /* isStructurallyValidLanguageTag */.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
    }
  }
  if (region) {
    obj = { lang, region, variants: [] };
    const tmp10 = require(13306) /* isStructurallyValidLanguageTag */.likelySubtags[require(undefined, 13306) /* isStructurallyValidLanguageTag */.emitUnicodeLanguageId(undefined, obj)];
    if (tmp10) {
      parseUnicodeLocaleIdResult.lang = mergeUnicodeLanguageId(undefined, script, undefined, variants, require(13306) /* isStructurallyValidLanguageTag */.parseUnicodeLanguageId(tmp10));
      return require(13306) /* isStructurallyValidLanguageTag */.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
    }
  }
  let tmp11 = require(13306) /* isStructurallyValidLanguageTag */.likelySubtags[lang];
  if (!tmp11) {
    const obj1 = { lang: "und", script, variants: [] };
    tmp11 = require(13306) /* isStructurallyValidLanguageTag */.likelySubtags[require(undefined, 13306) /* isStructurallyValidLanguageTag */.emitUnicodeLanguageId(undefined, obj1)];
  }
  if (tmp11) {
    parseUnicodeLocaleIdResult.lang = mergeUnicodeLanguageId(undefined, script, region, variants, require(13306) /* isStructurallyValidLanguageTag */.parseUnicodeLanguageId(tmp11));
    return require(13306) /* isStructurallyValidLanguageTag */.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
  } else {
    const _Error = Error;
