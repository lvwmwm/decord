...
// Function ID: 7766
// Name: getClient
// Dependencies: [7756, 7757, 7739, 7759, 7744]

// Module 7765 (getClient)
const require = arg1;
...
arg5.getClient = function getClient() {
  ...
  const asyncContextStrategy = require(7757) /* getAsyncContextStrategy */.getAsyncContextStrategy(mainCarrier);
...
arg5.getGlobalScope = function getGlobalScope() {
  return require(7739) /* getGlobalSingleton */.getGlobalSingleton("globalScope", () => {
...
arg5.getTraceContextFromScope = function getTraceContextFromScope(getPropagationContext) {
  ...
  return require(7744) /* addNonEnumerableProperty */.dropUndefinedKeys({ trace_id, span_id, parent_span_id });
};
arg5.withIsolationScope = function withIsolationScope() {
  ...
  const obj2 = require(7757) /* getAsyncContextStrategy */;
};
