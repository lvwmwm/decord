...
// Dependencies: [13648, 13649, 1281, 13650, 13651]
...
arg5.getCalendarPreferenceDataForRegion = function getCalendarPreferenceDataForRegion(region) {
  ...
  return require(13648).calendars[str] || require(13648).calendars["001"].map((arg0) => {
    let str = "gregory";
    if ("gregorian" !== arg0) {
      let str2 = "islamicc";
...
arg5.getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = require(13649).hourCycles[formatted] || tmp2(13649).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
...
arg5.getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  const items = [];
  if (require(13650).timezones[formatted]) {
...
arg5.getWeekDataForRegion = function getWeekDataForRegion(region) {
  ...
  return require(13651).weekData[str] || require(13651).weekData["001"];
};
