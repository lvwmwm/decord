// Module ID: 5510
// Function ID: 5511
// Dependencies: [1653, 4082, 5499, 5511, 5472]
...
try {
  ...
  try {
    ...
    const _module2 = require("module_5499");
    _module2.ghQueueMicrotask(() => {
      const NativeProxy = require(5511) /* n */.NativeProxy;
      if (!NativeProxy.installUIRuntimeBindings()) {
        const _console = console;
        console.warn(require(5472) /* tagMessage */.tagMessage("Failed to install UI runtime bindings. Please report this at https://github.com/software-mansion/react-native-gesture-handler/issues."));
        const tmpResult = require(5472) /* tagMessage */;
      }
    });
    let useSharedValue;
    if (_module != null) {
    ...
    if (!setGestureState) {
      const fn2 = function o() {
        console.warn(require(5472) /* tagMessage */.tagMessage("Please use newer version of react-native-reanimated in order to control state of the gestures."));
      };
