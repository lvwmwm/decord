...
function rgbaToDataURL(w, h, rgba) {
  ...
  const items = ["View", "getChannel", "Text", "guild", "ct", "Array", "isArray", "__workletHash", "fill", "max", "r", "isArray", "get", "assign", "Array", "isArray", "_distance", "unicodeVersion", w >> 8, 255 & w, 0, 0, h >> 8, 255 & h, 8, 6, 0, 0, 0, 0, 0, 0, 0, sum1 >>> 24, sum1 >> 16 & 255, sum1 >> 8 & 255, 255 & sum1, 73, 68, 65, 84, 120, 1];
  let arr1 = items;
