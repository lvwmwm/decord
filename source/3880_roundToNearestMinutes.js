...
// Dependencies: [3472, 3476, 3666]
// Exports: default

// Module 3880 (roundToNearestMinutes)
  ...
  if (arguments.length < 1) {
    ...
    if (defaultResult >= 1) {
      if (defaultResult <= 30) {
        ...
        const _Math = Math;
        const result = require(3666) /* getRoundingMethod */.getRoundingMethod(roundingMethod)(sum / defaultResult) * defaultResult;
        const _Date = Date;
