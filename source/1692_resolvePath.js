...
// Function ID: 1693
// Name: resolvePath
// Dependencies: [1693, 1696, 1704, 1657]

// Module 1692 (resolvePath)
const require = arg1;
...
function withStyleAnimation(animations) {
  ...
  obj = { ColorProperties: _require(1696).ColorProperties, setPath, processColor: _require(1696).processColor, styleAnimations: animations, resolvePath, __DEV__: false, logger: _require(1657).logger, isValidLayoutAnimationProp: _require(1693).isValidLayoutAnimationProp, withTiming: _require(1704).withTiming };
  fn.__closure = obj;
