...
// Function ID: 8622
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1500, 1631, 5317, 8622, 4691, 8623, 8625, 8626, 8627, 8628]
// Exports: NativeStackView

// Module 8621 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5317).HeaderShownContext);
  let num5 = React.useContext(num6(5317).HeaderHeightContext);
  const context1 = React.useContext(num6(5317).HeaderBackContext);
  let obj3 = num6(5317);
  ...
  callback = obj2.useCallback(num6(8622).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4691).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4691).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5317).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5317);
  ...
  let eventResult;
  const headerConfigProps = num6(8623).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  obj15[1] = closure_10(num6(5317).HeaderBackContext.Provider, obj16);
  items5[2] = closure_10(num6(5317).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = closure_11(num6(5317).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(8625).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4691).ScreenStackItem, obj4);
