...
// Dependencies: [7603, 7607, 7609, 7611, 7612, 7613, 7614, 7615, 7616, 7619, 7624, 7597]

// Module 7602 (spanTimeInputToSeconds)
  ...
  if ((function spanIsSentrySpan(getSpanJSON) {
    ...
    try {
      ...
      if ((function spanIsOpenTelemetrySdkTraceBaseSpan(attributes) {
        ...
        obj[8] = attributes[_mod7612.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj[9] = attributes[_mod7612.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== getSpanStatusFromHttpCode.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== tmp(7614).SPAN_STATUS_OK) {
