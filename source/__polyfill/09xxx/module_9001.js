// Module ID: 9001
// Function ID: 9002
// Dependencies: [5, 8935, 8998, 9002, 9003, 9004, 8997]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(8997).createStandardJSONSchemaMethod(_standard, "input"), output: _require(8997).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(8997).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
