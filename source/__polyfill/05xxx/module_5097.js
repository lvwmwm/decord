// Module ID: 5097
// Function ID: 5098
// Dependencies: [5098, 5099, 5100, 5101, 5102, 5095, 5094]

// Module 5097
import getFileChunk from "getFileChunk" /* 5094 */;
import _mod5095 from "module_5095" /* 5095 */;
import isAAC from "isAAC" /* 5098 */;
import is7Z from "is7Z" /* 5099 */;
import isAVIF from "isAVIF" /* 5100 */;
import isBLEND from "isBLEND" /* 5101 */;
import isAVI from "isAVI" /* 5102 */;
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = _mod5095.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = _mod5095.FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = _mod5095.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
      if (FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(item10079.toLowerCase())) {
        let tmp25 = tmp20;
        let tmp26 = tmp22;
        let FileTypes3 = tmp21(5095).FileTypes;
        let tmp27 = item10079;
    ...
    const FileTypes4 = _mod5095.FileTypes;
    ...
    if (detectSignatureResult) {
      if (items3.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes5 = _mod5095.FileTypes;
