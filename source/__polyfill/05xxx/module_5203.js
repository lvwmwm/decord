...
arg5.default = {
  read(byteLength, sum) {
    ...
    if (sum + 10 + 1 <= byteLength.byteLength) {
      const byteAt2 = module(5174).getByteAt(byteLength, sum + 10);
      ...
      obj4[1] = str6;
      tmp20 = obj4;
      const obj10 = module(5174);
    }
    obj[4] = tmp20;
    let tmp24;
    if (sum + 11 + 1 <= byteLength.byteLength) {
      const byteAt3 = module(5174).getByteAt(byteLength, sum + 11);
