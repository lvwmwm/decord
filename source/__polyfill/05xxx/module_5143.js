...
arg5.default = {
  read(buffer, sum) {
    ...
    let tmp12;
    if (9 <= shortAt) {
      const byteAt2 = tmp3(5142).getByteAt(buffer, sum + 7);
      const tmp3Result1 = tmp3(5142);
      const byteAt3 = tmp3(5142).getByteAt(buffer, sum + 7 + 1);
    ...
    let tmp15;
    if (10 <= shortAt) {
      const byteAt4 = tmp3(5142).getByteAt(buffer, sum + 9);
      ...
      obj3[1] = str6;
      tmp15 = obj3;
      const tmp3Result3 = tmp3(5142);
    }
    obj2[1] = tmp15;
    let tmp17;
    if (12 <= shortAt) {
      const shortAt1 = tmp3(5142).getShortAt(buffer, sum + 10);
    ...
    let tmp19;
    if (14 <= shortAt) {
      const shortAt2 = tmp3(5142).getShortAt(buffer, sum + 12);
      const obj5 = { value: null, description: null };
      obj5[0] = shortAt2;
      obj5[1] = "" + shortAt2;
      tmp19 = obj5;
      const tmp3Result5 = tmp3(5142);
    }
    obj2[3] = tmp19;
    obj2[4] = tmp6;
    obj2[5] = tmp9;
