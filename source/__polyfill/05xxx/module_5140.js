// Module ID: 5140
// Function ID: 5141
// Dependencies: [5141, 5142, 5143, 5144, 5145, 5138, 5137]

// Module 5140
import getFileChunk from "getFileChunk" /* 5137 */;
import _mod5138 from "module_5138" /* 5138 */;
import isAAC from "isAAC" /* 5141 */;
import is7Z from "is7Z" /* 5142 */;
import isAVIF from "isAVIF" /* 5143 */;
import isBLEND from "isBLEND" /* 5144 */;
import isAVI from "isAVI" /* 5145 */;
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = _mod5138.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = _mod5138.FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = _mod5138.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
      if (FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(item10079.toLowerCase())) {
        let tmp25 = tmp20;
        let tmp26 = tmp22;
        let FileTypes3 = tmp21(5138).FileTypes;
        let tmp27 = item10079;
    ...
    if (detectSignatureResult) {
      if (items3.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes5 = _mod5138.FileTypes;
