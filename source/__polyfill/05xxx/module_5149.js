// Module ID: 5149
// Function ID: 5150
// Dependencies: [5150, 5151, 5152, 5153, 5154, 5147, 5146]

// Module 5149
import getFileChunk from "getFileChunk" /* 5146 */;
import _mod5147 from "module_5147" /* 5147 */;
import isAAC from "isAAC" /* 5150 */;
import is7Z from "is7Z" /* 5151 */;
import isAVIF from "isAVIF" /* 5152 */;
import isBLEND from "isBLEND" /* 5153 */;
import isAVI from "isAVI" /* 5154 */;
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = _mod5147.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = _mod5147.FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = _mod5147.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
      if (FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(item10079.toLowerCase())) {
        let tmp25 = tmp20;
        let tmp26 = tmp22;
        let FileTypes3 = tmp21(5147).FileTypes;
        let tmp27 = item10079;
    ...
    const FileTypes4 = _mod5147.FileTypes;
    ...
    if (detectSignatureResult) {
      if (items3.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes5 = _mod5147.FileTypes;
