    ...
    if (ifd.MPEntry) {
      ...
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let tmp10 = num13;
          if (byteOrder === module(5218).LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
        ...
        const typeSize4 = module(5230).getTypeSize("LONG");
        if (byteOrder === module(5218).LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
