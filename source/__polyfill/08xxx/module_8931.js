// Module ID: 8931
// Function ID: 8932
// Dependencies: [5, 8865, 8928, 8932, 8933, 8934, 8927]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_8 = fn(_mod8932);
    let closure_9 = fn(_mod8933);
    let closure_10 = fn(_mod8934);
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(8927).createStandardJSONSchemaMethod(_standard, "input"), output: _require(8927).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(8927).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
