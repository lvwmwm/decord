// Module ID: 1412
// Function ID: 1413
// Dependencies: [571, 1407, 1413, 539, 543, 1415, 1417]
...
import availableTypedArrays from "availableTypedArrays" /* 1413 */;
import forEach from "forEach" /* 1415 */;
      ...
      forEach(tmp2, (arg0) => {
        ...
        if (Symbol.toStringTag in tmp) {
          if (getProto) {
            ...
            const text = `$${arg0}`;
            closure_8[`$${arg0}`] = tmp2(1417)(tmp6.get);
          }
        }
      });
    }
        ...
        if (typeof obj === "object") {
          if (closure_3) {
            ...
            if (_require(539)) {
              _require = obj;
              dependencyMap = false;
              _require(1415)(closure_8, (arg0, arg1) => {
                if (!closure_1) {
                  try {
