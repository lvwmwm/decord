// Module ID: 1413
// Function ID: 1414
// Dependencies: [571, 1408, 1414, 539, 543, 1416, 1418]
    ...
    if (getProto) {
      forEach(tmp2, (arg0) => {
        ...
        if (Symbol.toStringTag in tmp) {
          if (getProto) {
            const tmp4 = tmp2(543)(tmp);
            const _Symbol = Symbol;
            const tmp5 = tmp2(539)(tmp4, Symbol.toStringTag);
            let tmp6 = tmp5;
            if (!tmp5) {
              tmp6 = tmp5;
              if (tmp4) {
                const _Symbol2 = Symbol;
                tmp6 = tmp2(539)(tmp2(543)(tmp4), Symbol.toStringTag);
                const tmp7 = tmp2(543)(tmp4);
              }
            }
            const text = `$${arg0}`;
