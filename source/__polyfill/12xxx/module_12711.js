// Module ID: 12711
// Function ID: 12712
// Dependencies: [5, 12645, 12708, 12712, 12713, 12714, 12707]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12645).util;
    ...
    let closure_8 = fn(_mod12712);
    let closure_9 = fn(_mod12713);
    let closure_10 = fn(_mod12714);
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12707).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12707).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12707).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
