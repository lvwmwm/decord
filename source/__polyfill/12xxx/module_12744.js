// Module ID: 12744
// Function ID: 12745
// Dependencies: [5, 12678, 12741, 12745, 12746, 12747, 12740]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12678).util;
    ...
    let closure_8 = fn(_mod12745);
    let closure_9 = fn(_mod12746);
    let closure_10 = fn(_mod12747);
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12740).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12740).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12740).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
