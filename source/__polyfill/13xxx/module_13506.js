// Module ID: 13506
// Function ID: 13507
// Dependencies: [13500, 13471, 13491]

// Module 13506

export default (arg0, arg1) => {
  let _require;
  let obj = new _require(13500)(arg0, arg1);
  const tmp3 = new _require(13471)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(13471)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
        ...
        do {
          ...
          if (_require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = _require;
              tmp16 = !_require(13491)(tmp14, _require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
