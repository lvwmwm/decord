// Module ID: 13810
// Function ID: 13811
// Dependencies: [13804, 13775, 13795]

// Module 13810

export default (arg0, arg1) => {
  let _require;
  let obj = new _require(13804)(arg0, arg1);
  const tmp3 = new _require(13775)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(13775)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
        ...
        do {
          ...
          if (_require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = _require;
              tmp16 = !_require(13795)(tmp14, _require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
