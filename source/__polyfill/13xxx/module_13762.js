// Module ID: 13762
// Function ID: 13763
// Dependencies: [13756, 13727, 13747]

// Module 13762

export default (arg0, arg1) => {
  let _require;
  let obj = new _require(13756)(arg0, arg1);
  const tmp3 = new _require(13727)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(13727)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
        ...
        do {
          ...
          if (_require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = _require;
              tmp16 = !_require(13747)(tmp14, _require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
