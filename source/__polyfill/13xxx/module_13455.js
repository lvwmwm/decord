// Module ID: 13455
// Function ID: 13456
// Dependencies: [13418, 13447, 13438, 13443, 13439, 13442, 13449, 13446]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13418)(arg0, arg3);
  const tmp4 = new _require(13447)(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(13438);
    let tmpResult = tmp(13443);
    tmpResult = tmp(13439);
    closure_2 = tmpResult;
    let str3 = ">=";
    let str = ">";
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13439);
      tmpResult = tmp(13442);
      tmpResult1 = tmp(13438);
  ...
  if (_require(13449)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
