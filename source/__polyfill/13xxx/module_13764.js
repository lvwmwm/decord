// Module ID: 13764
// Function ID: 13765
// Dependencies: [13727, 13756, 13747, 13752, 13748, 13751, 13758, 13755]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13727)(arg0, arg3);
  const tmp4 = new _require(13756)(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(13747);
    let tmpResult = tmp(13752);
    tmpResult = tmp(13748);
    closure_2 = tmpResult;
    let str3 = ">=";
    let str = ">";
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13748);
      tmpResult = tmp(13751);
      tmpResult1 = tmp(13747);
  ...
  if (_require(13758)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
