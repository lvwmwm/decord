// Module ID: 13966
// Function ID: 13967
// Dependencies: [41, 42, 32, 13960, 13967, 13968]

// Module 13966
import SymbolResult1 from "SymbolResult1" /* 13960 */;
import URLSearchParamsImpl from "URLSearchParamsImpl" /* 13967 */;
...
obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, SymbolResult1.implSymbol)) {
        if (arg0[tmp(undefined, 13960).implSymbol] instanceof tmp(13967).implementation) {
          return true;
        }
      }
  ...
  setup(wrapper) {
    ...
    if (URLSearchParamsImpl.init) {
      tmp2(13967).init(wrapper[tmp2(undefined, 13960).implSymbol], obj);
      const tmp2Result = tmp2(13967);
    }
    return wrapper;
  },
  install(arg0) {
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(URLSearchParams(13968).USVString(arguments[0], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 1" }));
              obj = URLSearchParams(13968);
              items.push(URLSearchParams(13968).USVString(arguments[1], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 2" }));
              const tmp12 = self[URLSearchParams(undefined, 13960).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13968).USVString(arguments[0], { context: "Failed to execute 'delete' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13960).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13968).USVString(arguments[0], { context: "Failed to execute 'get' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13960).implSymbol];
                const get = tmp6.get;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13968).USVString(arguments[0], { context: "Failed to execute 'getAll' on 'URLSearchParams': parameter 1" }));
                obj = URLSearchParams(13968);
                const tmp11 = self[URLSearchParams(undefined, 13960).implSymbol];
                const getAll = tmp11.getAll;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return URLSearchParams(13960).tryWrapperForImpl(HermesBuiltin.apply(items1, tmp11));
              }
            }
          }
          const typeError1 = new TypeError("Illegal invocation");
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13968).USVString(arguments[0], { context: "Failed to execute 'has' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13960).implSymbol];
                const has = tmp6.has;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 2) {
                ...
                const items = [];
                items.push(URLSearchParams(13968).USVString(arguments[0], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 1" }));
                obj = URLSearchParams(13968);
                items.push(URLSearchParams(13968).USVString(arguments[1], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 2" }));
                const tmp12 = self[URLSearchParams(undefined, 13960).implSymbol];
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return HermesBuiltin.apply(items1, tmp12);
      ...
      },
      {
        ...
        value: function sort() {
          ...
          if (this) {
            const _exports = closure_1.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 13960).implSymbol].sort();
            }
          }
      ...
      },
      {
        ...
        value: function toString() {
          ...
          if (this) {
            const _exports = closure_1.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 13960).implSymbol].toString();
            }
          }
          const typeError = new TypeError("Illegal invocation");
          throw typeError;
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const _Array2 = Array;
                let arr = Array.from(self[URLSearchParams(undefined, 13960).implSymbol]);
                let num2 = 0;
                let tmp11 = arr;
                if (0 < arr.length) {
                  do {
                    ...
                    let tmp5 = callback2;
                    let tmp6 = callback2(arr.map(URLSearchParams(13960).tryWrapperForImpl), 2);
                    [tmp7, tmp8] = tmp6;
                    let call = fn.call;
                    let tmp9 = num2;
                    ...
                    let _Array = Array;
                    arr = Array.from(self[tmp3(undefined, 13960).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr;
    ...
    if (undefined === arg0[URLSearchParams(undefined, 13960).ctorRegistrySymbol]) {
      let _Object = Object;
    ...
    arg0[URLSearchParams(undefined, 13960).ctorRegistrySymbol].URLSearchParams = tmp;
