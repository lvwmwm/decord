// Module ID: 13812
// Function ID: 13813
// Dependencies: [13775, 13804, 13795, 13800, 13796, 13799, 13806, 13803]

// Module 13812
import Comparator from "Comparator" /* 13803 */;


export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13775)(arg0, arg3);
  const tmp4 = new _require(13804)(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(13795);
    let tmpResult = tmp(13800);
    tmpResult = tmp(13796);
    closure_2 = tmpResult;
    let str3 = ">=";
    let str = ">";
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13796);
      tmpResult = tmp(13799);
      tmpResult1 = tmp(13795);
  ...
  if (_require(13806)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
