// Module ID: 13539
// Function ID: 13540
// Dependencies: [13533, 13504, 13524]

// Module 13539

export default (arg0, arg1) => {
  let _require;
  let obj = new _require(13533)(arg0, arg1);
  const tmp3 = new _require(13504)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(13504)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
        ...
        do {
          ...
          if (_require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = _require;
              tmp16 = !_require(13524)(tmp14, _require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
