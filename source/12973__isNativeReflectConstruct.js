...
const tmp5 = (Component) => {
  ...
  items[33] = {
    ...
    value: function _getSlideAnimation(_activeItem, toValue) {
      ...
      let obj = { toValue };
      const merged = Object.assign({}, activeAnimationOptions, obj);
