// Module ID: 4942
// Function ID: 4943
// Dependencies: [4902, 4917, 4918, 4914, 4897]
    ...
    if (ifd.MPEntry) {
      ...
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let tmp10 = num13;
          if (byteOrder === module(4902).LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
        ...
        const typeSize4 = module(4914).getTypeSize("LONG");
        if (byteOrder === module(4902).LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
