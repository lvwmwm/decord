...
// Module 5113 (ResourceSavingScene)
let Platform;
let StyleSheet;
let closure_0 = [0.979, 0.886, 0.761];
let closure_1 = importDefault(dependencyMap[0]);
importAll(dependencyMap[1]);
({ Platform, StyleSheet, View: closure_2 } = arg1(dependencyMap[2]));
const jsx = arg1(dependencyMap[3]).jsx;
const styles = StyleSheet.create({ container: {}, attached: { flex: 1 }, detached: { "Null": "PRIMARY_200", "Null": 1 } });
...
export default function ResourceSavingScene(visible) {
  ...
  obj = { "Bool(false)": 1766088043, "Bool(false)": 827788593 };
  if (visible) {
    str = "auto";
  }
