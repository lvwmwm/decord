...
const fn = function t(exports, React) {
  ...
  function ownKeys(arg0, arg1) {
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      if (arg1) {
        found = ownPropertySymbols.filter((arg0) => Object.getOwnPropertyDescriptor(closure_0, arg0).enumerable);
      }
    ...
    if (tmp) {
      ...
      if (arg0) {
        if ("string" !== typeof arg0) {
          ...
          tmp33 = "Object" === substr && arg0.constructor;
        }
      }
  ...
  let obj = {
    ...
    exports: (function requireFactoryWithThrowingShims() {
      ...
      let c1 = emptyFunction;
      function emptyFunctionWithReset() {

      }
      let c2 = emptyFunctionWithReset;
      if (c4) {
        ...
        factoryWithThrowingShims = function factoryWithThrowingShims() {
          ...
          obj = { array: shim, bool: shim, func: shim, number: shim, object: shim, string: shim, symbol: shim, any: shim, arrayOf: getShim, element: shim, elementType: shim, instanceOf: getShim, node: shim, objectOf: getShim, oneOf: getShim, oneOfType: getShim, shape: getShim, exact: getShim, checkPropTypes: c2, resetWarningCache: c1, PropTypes: obj };
          return obj;
        };
        return factoryWithThrowingShims;
      }
  ...
  function useAttachEvent(arg0, arg1, arg2) {
    ...
    let closure_2 = arg2;
    let closure_3 = tmp;
    const ref = React.useRef(arg2);
    const items = [arg2];
    const effect = React.useEffect(() => {
      ref.current = closure_2;
    }, items);
    const items1 = [arg2, arg1, arg0, ref];
    const effect1 = React.useEffect(() => {
      if (closure_3) {
        if (decoratedCb) {
          ...
          decoratedCb.on(closure_1, decoratedCb);
          return () => {
          ...
          if (tmp4 !== (toString2.call(stripe) === "[object Object]")) {
            ...
            if (keys.length !== keys1.length) {
              ...
              if (keys2.length !== keys.length) {
                ...
                let closure_1 = stripe;
                return keys2.every(function pred(arg0) {
                  return outer1_32(stripe[arg0], stripe2[arg0]);
                });
              }
            }
          }
  ...
  function extractAllowedOptionsUpdates(stripe) {
    ...
    if (isUnknownObject(stripe)) {
      ...
      reduced = keys.reduce((arg0, arg1) => {
        const tmp = outer1_8(table);
        let tmp2 = !tmp;
        if (tmp) {
          tmp2 = !outer1_9(stripe[arg1], table[arg1]);
        }
        if (closure_2.includes(arg1)) {
          let tmp6 = arg0;
          if (tmp2) {
          ...
          if (tmp2) {
            ...
            outer1_26(obj, obj);
            obj = {};
            outer1_28(obj, arg1, stripe[arg1]);
            outer1_26(obj, {}, obj);
            tmp6 = obj;
          }
        }
  ...
  function registerWithStripeJs(_registerWrapper) {
    ...
    if (registerAppInfo) {
      _registerWrapper._registerWrapper({ name: "react-stripe-js", version: "3.7.0" });
      _registerWrapper.registerAppInfo({ name: "react-stripe-js", version: "3.7.0", url: "https://stripe.com/docs/stripe-js/react" });
    }
  }
  ...
  class Elements {
    constructor(arg0) {
      ...
      effect = stripe.useEffect(() => {
        ...
        function safeSetContext(stripe) {
          ...
          outer1_4((stripe) => {
            let tmp = stripe;
            if (!stripe.stripe) {
              const obj = { stripe, elements: stripe.elements(safeSetContext) };
              tmp = obj;
            }
            return tmp;
          });
      ...
      items2[0] = tmp5;
      items2[1] = stripe;
      effect1 = stripe.useEffect(() => {
        let tmp = null !== closure_5;
        if (tmp) {
          tmp = closure_5 !== stripe;
        }
        if (tmp) {
          const _console = console;
      ...
      effect2 = stripe.useEffect(() => {
        if (value.elements) {
          const tmp4 = outer1_10(options, closure_6, ["clientSecret", "fonts"]);
          if (tmp4) {
      ...
      effect3 = stripe.useEffect(() => {
        outer1_13(value.stripe);
      }, items4);
      return stripe.createElement(call.Provider, { value: first }, exports.children);
    }
  }
  obj = {};
  ...
  class CheckoutProvider {
    constructor(arg0) {
      ...
      items = [];
      items[0] = stripe;
      memo = stripe.useMemo(() => outer1_12(stripe, "Invalid prop `stripe` supplied to `CheckoutProvider`. We recommend using the `loadStripe` utility from `@stripe/stripe-js`. See https://stripe.com/docs/stripe-js/react#elements-props-stripe for details."), items);
      closure_2 = memo;
      element = null;
      tmp3 = _slicedToArray(stripe.useState(null), 2);
      first = tmp3[0];
      closure_3 = first;
      tmp5 = tmp3[1];
      useState = tmp5;
      tmp6 = _slicedToArray(stripe.useState(() => {
        const obj = {};
        let stripe = null;
        if ("sync" === memo.tag) {
          stripe = memo.stripe;
      ...
      safeSetContext = function safeSetContext(checkoutSdk) {
        ...
        callback((stripe) => {
          let tmp = stripe;
          if (!stripe.stripe) {
            const obj = { stripe: closure_0, checkoutSdk: closure_1 };
            tmp = obj;
          }
          return tmp;
        });
      };
      c8 = stripe.useRef(false);
      items1 = [, , , ];
      items1[0] = memo;
      items1[1] = first1;
      items1[2] = options;
      ...
      effect = stripe.useEffect(() => {
          ...
          if (!first1.stripe) {
            memo.stripePromise.then((initCheckout) => {
              ...
              if (tmp) {
                ...
                checkout.then((on) => {
                  if (on) {
                    outer2_7(closure_0, on);
                    on.on("change", outer2_4);
                  }
                });
              }
            });
        ...
        if (stripe) {
          ...
          let checkout = stripe2.initCheckout(options);
          checkout.then((on) => {
            if (on) {
              outer1_7(outer1_2.stripe, on);
      ...
      effect2 = stripe.useEffect(() => {
        if (first1.checkoutSdk) {
          ...
          tmp9 = !tmp9(appearance1, appearance);
          let checkoutSdk = !closure_11;
          if (checkoutSdk) {
      ...
      if (first1.checkoutSdk) {
        ...
        obj = {};
        obj.value = tmp15;
        element = stripe.createElement(isRequired.Provider, obj, stripe.createElement(isRequired.Provider, obj, exports.children));
      }
      return element;
    }
  }
  const obj1 = { stripe: _default.any };
  let obj2 = { fetchClientSecret: _default.func.isRequired, elementsOptions: _default.object };
  ...
  function createElementComponent(address, arg1) {
    ...
    const tmp3 = arg1 ? (function ServerElement(id) {
      outer1_21("mounts <".concat(combined, ">"));
      ...
      const tmp = outer1_21("mounts <".concat(readyCallback, ">"));
      let elements = null;
      if ("elements" in tmp) {
      ...
      let tmp4 = outer1_30(address.useState(null), 2);
      const first = tmp4[0];
      let closure_5 = tmp4[1];
      let closure_6 = address.useRef(null);
      const ref = address.useRef(null);
      outer1_6(first, "blur", onBlur);
      outer1_6(first, "focus", onFocus);
      outer1_6(first, "escape", onEscape);
      outer1_6(first, "click", onClick);
      outer1_6(first, "loaderror", onLoadError);
      outer1_6(first, "loaderstart", onLoaderStart);
      outer1_6(first, "networkschange", onNetworksChange);
      outer1_6(first, "confirm", onConfirm);
      outer1_6(first, "cancel", onCancel);
      outer1_6(first, "shippingaddresschange", onShippingAddressChange);
      outer1_6(first, "shippingratechange", onShippingRateChange);
      outer1_6(first, "change", onChange);
      let tmp19;
      if (readyCallback) {
              ...
              if (checkoutSdk) {
                if ("payment" === options) {
                  ...
                  if ("mode" in options) {
                    ...
                    const tmp28 = outer2_29(options, outer2_22);
                    if ("shipping" === mode) {
      ...
      const tmp23 = outer1_7(options);
      let closure_8 = tmp23;
      const items1 = [options, tmp23];
      const effect = address.useEffect(() => {
        if (closure_6.current) {
          const tmp4 = outer2_10(options, closure_8, ["paymentRequest"]);
          let tmp5 = tmp4;
          if (tmp4) {
      ...
      const layoutEffect1 = address.useLayoutEffect(() => () => {
        if (outer1_6.current) {
          if ("function" === typeof outer1_6.current.destroy) {
  ...
  exports.EmbeddedCheckout = "undefined" === typeof window ? (function EmbeddedCheckoutServerElement(arg0) {
    ...
    let closure_1 = embeddedCheckout.useRef(false);
    const ref = embeddedCheckout.useRef(null);
    const items = [embeddedCheckout];
    const layoutEffect = embeddedCheckout.useLayoutEffect(() => {
  ...
  exports.EmbeddedCheckoutProvider = function EmbeddedCheckoutProvider(stripe) {
    ...
    const items = [stripe];
    const memo = stripe.useMemo(() => outer1_12(stripe, "Invalid prop `stripe` supplied to `EmbeddedCheckoutProvider`. We recommend using the `loadStripe` utility from `@stripe/stripe-js`. See https://stripe.com/docs/stripe-js/react#elements-props-stripe for details."), items);
    let closure_3 = stripe.useRef(null);
    const ref = stripe.useRef(null);
    const tmp3 = _slicedToArray(stripe.useState({ embeddedCheckout: null }), 2);
    const value = tmp3[0];
      ...
      if (!ref.current) {
        if (!ref.current) {
          function setStripeAndInitEmbeddedCheckout(stripe) {
            let current = outer1_4.current;
            if (!current) {
              current = outer1_3.current;
            }
            if (!current) {
              outer1_4.current = stripe;
    ...
    const effect1 = stripe.useEffect(() => () => {
      if (outer1_5.embeddedCheckout) {
        tmp.current = null;
        let embeddedCheckout = outer1_5.embeddedCheckout;
        embeddedCheckout.destroy();
      } else if (tmp.current) {
        const current = outer1_3.current;
        current.then(() => {
          outer2_3.current = null;
          if (outer2_5.embeddedCheckout) {
            const embeddedCheckout = outer2_5.embeddedCheckout;
            embeddedCheckout.destroy();
          }
        });
      }
    ...
    const effect3 = stripe.useEffect(() => {
      let tmp = null !== closure_7;
      if (tmp) {
        tmp = closure_7 !== stripe;
      }
      if (tmp) {
        const _console = console;
    ...
    const effect4 = stripe.useEffect(() => {
      if (null != tmp10) {
        if (null != options) {
  ...
  exports.useCheckout = function useCheckout() {
    parseCheckoutSdkContext(React.useContext(context1), "calls useCheckout()");
