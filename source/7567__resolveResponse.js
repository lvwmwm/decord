...
// Dependencies: [32, 5, 7454, 7568, 7462, 7457, 7470, 7463]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 7567 (_resolveResponse)
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(7454) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(7454) /* addHandler */;
  require(7454) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(7454).addHandler("fetch", arg0);
  let obj = _require(7454);
  _require(7454).maybeInstrument("fetch", () => {
    let flag = callback;
