...
// Dependencies: [6375, 6347, 6403, 6350]

// Module 6436 (_shouldDropEvent)
...
function _isSameStacktrace(arg0, arg1) {
  const framesFromEvent = require(6350) /* createStackParser */.getFramesFromEvent(arg0);
  const obj = require(6350) /* createStackParser */;
  const framesFromEvent1 = require(6350) /* createStackParser */.getFramesFromEvent(arg1);
  if (!framesFromEvent) {
    if (!framesFromEvent1) {
      return true;
    }
