...
// Dependencies: [7405, 7408, 7421, 7444, 7445, 7431, 7403, 7446, 7439, 7415]

// Module 7443 (applyClientOptions)
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = require(7403) /* isMatchingPattern */.truncate(environment.message, num);
    const obj = require(7403) /* isMatchingPattern */;
  }
  let value = iter;
  ...
  if (value) {
    iter.value = require(7403) /* isMatchingPattern */.truncate(iter.value, num);
    const obj2 = require(7403) /* isMatchingPattern */;
  }
  ...
  if (url) {
    request.url = require(7403) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(7403) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(7446).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = dependencyMap(7439).normalize(data.data, dependencyMap, dependencyMap);
                  data = obj;
                  const obj3 = dependencyMap(7439);
                }
