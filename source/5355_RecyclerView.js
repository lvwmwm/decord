...
// Module 5355 (RecyclerView)
let forwardRef;
let closure_2 = [];
let closure_3 = importDefault(dependencyMap[0]);
let closure_4 = importDefault(dependencyMap[1]);
({ useCallback: closure_5, useLayoutEffect: closure_6, useMemo: closure_7, useRef: closure_8, useState: closure_9, useId: closure_10, forwardRef } = arg1(dependencyMap[2]));
const tmp2 = arg1(dependencyMap[2]);
const importDefaultResult = importDefault(dependencyMap[2]);
({ Animated: closure_11, I18nManager: closure_12 } = arg1(dependencyMap[3]));
...
class RecyclerViewComponent {
  constructor(arg0, arg1) {
    ...
    tmp17 = extraData(require("module_0"), 2);
    tmp18 = tmp17[num];
    stickyHeaderConfig = tmp18;
    tmp19 = extraData(require("module_0"), 2);
    ...
    items9[4] = closure_13(arg1(dependencyMap[21]).ViewHolderCollection, obj5);
    ...
    obj.children = tmp47(arg1(dependencyMap[19]).CompatView, obj1);
    return tmp46(arg1(dependencyMap[15]).RecyclerViewContextProvider, obj);
  }
}
RecyclerViewComponent.displayName = "FlashList";

export const RecyclerView = importDefaultResult.memo(forwardRef(RecyclerViewComponent));
