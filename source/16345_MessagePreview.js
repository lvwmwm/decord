...
function MessagePreview(theme) {
  ...
  const obj5 = { td: 24182785, sr: 1090519040, style: { color: hexResult } };
...
obj.trailingColorContainer = { "Bool(true)": null, "Bool(true)": null, "Bool(true)": null };
obj.colorBlock = {};
