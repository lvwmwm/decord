...
// Function ID: 5730
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 5723, 5724, 1502, 5730, 5709, 5269, 5731, 5732, 5733, 5734]
// Exports: Card

// Module 5729 (StyleSheet)
...
export const Card = function Card(shadowEnabled) {
  ...
  if (typeof backgroundColor === "string") {
    tmp16 = 0 === tmp5(5269)(backgroundColor).alpha();
    const obj12 = tmp5(5269)(backgroundColor);
  }
  ...
  let merged = Object.assign(flag2(5732).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }));
  ...
  const items13 = [tmp27, gesture(flag2(5733).CardContent, { enabled: pageOverflowEnabled, layout, style: contentStyle, children })];
  obj5[3] = items13;
  obj4.children = layout(closing.View, obj5);
  obj3[2] = gesture(flag2(5709).PanGestureHandler, obj4);
  items5[2] = gesture(closing.View, obj3);
  obj[1] = items5;
  return layout(flag2(5731).CardAnimationContext.Provider, obj);
};
