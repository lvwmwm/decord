...
// Dependencies: [29, 6, 7, 15, 17, 18, 31, 27, 33, 5559, 5560, 5524, 5556, 5561, 5569, 5570, 5571]
// Exports: getIsModalPresentation

// Module 5558 (_isNativeReflectConstruct)
import _objectWithoutProperties from "_objectWithoutProperties";
import result from "result";
import getActivityIndicator from "get ActivityIndicator";
import module_5570 from "module_5570";
...
export const getIsModalPresentation = function getIsModalPresentation(cardStyleInterpolator) {
  let tmp = cardStyleInterpolator === require(5571) /* Animated */.forModalPresentationIOS;
  if (!tmp) {
