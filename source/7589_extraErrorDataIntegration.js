...
// Dependencies: [7555, 7506, 7544, 7505, 7508, 7527, 7499]

// Module 7589 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(7527).DEBUG_BUILD) {
                const logger = callback(7499).logger;
