...
// Dependencies: [32, 5, 7345, 7459, 7353, 7348, 7361, 7354]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 7458 (_resolveResponse)
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(7345) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(7345) /* addHandler */;
  require(7345) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    const callback = closure_5;
    {
      callback(7353).fill(callback(7348).GLOBAL_OBJ, "fetch", (arg0) => {
        let closure_0 = arg0;
        return () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(7345).addHandler("fetch", arg0);
  let obj = _require(7345);
  _require(7345).maybeInstrument("fetch", () => {
    let flag = callback;
