...
// Dependencies: [16208, 16209]

// Module 16207 (CanonicalizeLocaleList)
let require = arg1;
          ...
          if (StringResult in ObjectResult) {
            ...
            if (null == tmp4) {
              ...
              if (typeof tmp4 === "string") {
                ...
                let expBCP47Syntax = require(16208) /* RegExpResult1 */.expBCP47Syntax;
                ...
                if (isMatch) {
                  ...
                  let tmp9 = !isMatch;
                  if (!isMatch) {
                    let expSingletonDupes = tmp5(16208).expSingletonDupes;
                ...
                if (isMatch) {
                  ...
                  let match = str8.match(require(16208) /* RegExpResult1 */.expExtSequences);
                  let tmp19 = str8;
                  let tmp20 = match;
                  if (match) {
                  ...
                  if (!tmp20) {
                    ...
                    let RegExpResult = RegExp(`(?:${tmp17(16208).expExtSequences.source})+`, "i");
...
function InitializeDateTimeFormat(prototype) {
  ...
  if (true === result["[[initializedIntlObject]]"]) {
    ...
    if ("[object Array]" !== (typeof call6 === "unknown" ? toString() : call6(formats))) {
      obj2 = require(16209) /* createDateTimeFormat */;
...
class List {
  constructor() {
    tmp = f63322(this, "length", { writable: true, value: 0 });
    if (!arguments.length) {
      return;
    } else {
      tmp3 = slice;
...
fn(obj, "__addLocaleData", {
  value(locale) {
    ...
    const expBCP47Syntax = require(16208) /* RegExpResult1 */.expBCP47Syntax;
    ...
    if (isMatch) {
      ...
      let tmp5 = !isMatch;
      if (!isMatch) {
        const expSingletonDupes = tmp(16208).expSingletonDupes;
