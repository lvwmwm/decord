...
export const LocalWeekYearParser = (Parser) => {
  class LocalWeekYearParser {
    constructor() {
      if (this instanceof LocalWeekYearParser) {
        ...
        tmp19 = closure_10(applyResult, "incompatibleTokens", [true, true, true, true, true, true, true, true, false, false, false, false, false]);
        return applyResult;
      } else {
  ...
  let obj = { "": null, children: null, "": null, value: LocalWeekYearParser };
