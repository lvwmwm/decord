  ...
  class Client {
    constructor(arg0) {
      ...
      if (null == bufferSize) {
        ...
        tmp4 = f9559;
        num = 6;
        bufferSize = f9564(f9559[6]).DEFAULT_TRANSPORT_BUFFER_SIZE;
      }
      ...
      if (self._options.enableLogs) {
        ...
        str3 = "flushLogs";
        tmp20 = self;
        tmp21 = outer1_13(self, "afterCaptureLog", "flushLogs", outer1_18, f9564(f9559[11])._INTERNAL_flushLogsBuffer);
      }
      ...
      if (tmp23) {
        ...
        str5 = "flushMetrics";
        tmp28 = self;
        tmp29 = outer1_13(self, "afterCaptureMetric", "flushMetrics", outer1_17, f9564(f9559[12])._INTERNAL_flushMetricsBuffer);
      }
      return;
    }
  }
