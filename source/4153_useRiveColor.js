...
// Function ID: 4154
// Name: useRiveColor
// Dependencies: [32, 19, 4135, 4148, 4143]
// Exports: useRiveColor

// Module 4153 (useRiveColor)
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(require(4148) /* useRiveProperty */.useRiveProperty(instance, FillColor, f29193), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
    if (undefined !== tmp5) {
      let RiveColor = require(4143) /* RiveColor */.RiveColor;
