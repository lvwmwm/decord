...
// Function ID: 56959
// Name: updateSession
// Dependencies: [6310, 6311, 6335, 6325, 6322, 6317]
// Exports: closeSession, makeSession

// Module 6334 (updateSession)
...
function updateSession(ipAddress) {
  if (arguments.length > 1) {
    ...
    if (!timestamp) {
      timestamp = require(6325) /* dateTimestampInSeconds */.timestampInSeconds();
    ...
    if (!obj.sid) {
      ...
      if (32 === obj.sid.length) {
        ...
        sid = require(6322) /* getFirstException */.uuid4();
        const obj3 = require(6322) /* getFirstException */;
      }
      ipAddress.sid = sid;
    }
  }
