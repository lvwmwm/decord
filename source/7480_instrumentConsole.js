...
// Dependencies: [7392, 7395, 7394, 7400]

// Module 7480 (instrumentConsole)
const require = arg1;
const dependencyMap = arg6;
function instrumentConsole() {
  if ("console" in require(7395) /* getGlobalSingleton */.GLOBAL_OBJ) {
    const CONSOLE_LEVELS = require(7394) /* consoleSandbox */.CONSOLE_LEVELS;
...
arg5.addConsoleInstrumentationHandler = function addConsoleInstrumentationHandler(arg0) {
  require(7392) /* addHandler */.addHandler("console", arg0);
  const obj = require(7392) /* addHandler */;
  require(7392) /* addHandler */.maybeInstrument("console", instrumentConsole);
};
