...
arg5.default = {
  isPngFile(dataView) {
    let tmp = dataView;
    if (tmp) {
      tmp = require(4931) /* getDataView */.getStringFromDataView(dataView, 0, u0089PNGrnu001An.length) === u0089PNGrnu001An;
  ...
  findPngOffsets(byteLength, flag2) {
    ...
    if (length + c4 + c5 <= byteLength.byteLength) {
      while (true) {
        ...
        let tmp3 = length;
        if (module(4934).USE_PNG_FILE) {
          let tmp4 = require;
          let obj1 = require(4931) /* getDataView */;
          let tmp5 = c7;
          let tmp6 = c5;
        ...
        let tmp14 = require;
        let obj5 = require(4931) /* getDataView */;
        let tmp15 = c7;
        let tmp16 = c5;
