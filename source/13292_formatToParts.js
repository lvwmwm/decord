...
// Function ID: 13293
// Name: formatToParts
// Dependencies: [1281, 13270, 13293, 13288, 13294, 13290]
// Exports: default

// Module 13292 (formatToParts)
import e from "e";
import digitsToString from "digitsToString";

const regExp = new RegExp("^".concat(require("module_13293").S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(require("module_13293").S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13288).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13294).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13290).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
