...
// Dependencies: [32, 19, 17, 21, 1500, 5346, 5317, 5347, 5318, 5351]
// Exports: HeaderBackButton

// Module 5345 (HeaderBackButton)
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[0] = importDefault(5317);
    obj1[1] = tintColor;
    const items1 = [tmp10.icon, "minimal" !== displayMode && tmp10.iconWithLabel];
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(5346).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(5346).ICON_MARGIN);
      }
    }
  ...
  return closure_7(require(5351) /* HeaderButton */.HeaderButton, obj);
};
