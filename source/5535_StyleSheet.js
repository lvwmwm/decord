...
// Function ID: 47101
// Name: StyleSheet
// Dependencies: [29, 31, 27, 33, 1560, 5536, 5533, 5538, 5539]
// Exports: default

// Module 5535 (StyleSheet)
...
export default function Header(children) {
  ...
  const context = React.useContext(importDefault(5536));
  if (undefined === layout) {
  ...
  if (headerBackground) {
    ...
    if (!headerTransparent) {
      ...
      headerBackgroundResult = callback2(importDefault(5539), obj5);
    }
  }
