...
// Function ID: 13375
// Name: formatToParts
// Dependencies: [1281, 13352, 13375, 13370, 13376, 13372]
// Exports: default

// Module 13374 (formatToParts)
import e from "e";
import digitsToString from "digitsToString";

const regExp = new RegExp("^".concat(require("module_13375").S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(require("module_13375").S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13370).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13376).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13372).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
