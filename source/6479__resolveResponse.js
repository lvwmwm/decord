...
// Dependencies: [32, 5, 6366, 6480, 6374, 6369, 6382, 6375]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 6479 (_resolveResponse)
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(6366) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(6366) /* addHandler */;
  require(6366) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    const callback = closure_5;
    {
      callback(6374).fill(callback(6369).GLOBAL_OBJ, "fetch", (arg0) => {
        let closure_0 = arg0;
        return () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(6366).addHandler("fetch", arg0);
  let obj = _require(6366);
  _require(6366).maybeInstrument("fetch", () => {
    let flag = callback;
