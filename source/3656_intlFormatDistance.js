...
// Dependencies: [3525, 3549, 3550, 3552, 3553, 3555, 3560, 3566, 3363, 3364, 3542]
// Exports: default

// Module 3656 (intlFormatDistance)
...
export default function intlFormatDistance(arg0, arg1, unit) {
  ...
  if (absolute < require(3542) /* keys */.secondsInMinute) {
    ...
    if (absolute1 < tmp6(3542).secondsInHour) {
      ...
      if (absolute3 < tmp6(3542).secondsInWeek) {
        num2 = tmp3.default(defaultResult1, defaultResult2);
        if (num2) {
          const _Math3 = Math;
          str = "day";
      ...
      if (absolute4 < tmp6(3542).secondsInMonth) {
        num2 = tmp9.default(defaultResult1, defaultResult2);
        str = "week";
      } else {
        const _Math8 = Math;
        const absolute5 = Math.abs(defaultResult3);
        if (absolute5 < tmp6(3542).secondsInQuarter) {
          num2 = tmp5.default(defaultResult1, defaultResult2);
          str = "month";
        } else {
          const _Math5 = Math;
          const absolute6 = Math.abs(defaultResult3);
          if (absolute6 < tmp6(3542).secondsInYear) {
