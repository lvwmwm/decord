...
arg5.isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4869) /* getFileChunk */.isAvifStringIncluded(fileChunk);
};
...
arg5.isHEIC = function isHEIC(fileChunk) {
  fileChunk = require(4869) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4870).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4869) /* getFileChunk */.isHeicSignatureIncluded(fileChunk);
};
