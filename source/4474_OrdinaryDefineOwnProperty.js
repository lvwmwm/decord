...
// Dependencies: [4411, 518, 4458, 4462, 519, 4475, 539, 4467, 4463, 4476, 4477]

// Module 4474 (OrdinaryDefineOwnProperty)

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (require(4411) /* isObject */(arg0)) {
    if (tmp(4458)(arg1)) {
      if (tmp8(4462)(__Writable__)) {
        if (tmp15(519)) {
          const tmp45 = tmp22(519)(arg0, arg1);
          let tmp46 = tmp45;
          if (tmp45) {
            tmp46 = require(4463) /* ToPropertyDescriptor */(tmp45);
          }
          return require(4477) /* ValidateAndApplyPropertyDescriptor */(arg0, arg1, require(4476) /* getEvalledConstructor */(arg0), __Writable__, tmp46);
        } else if (tmp22(4475)(__Writable__)) {
          ...
          return require(4467) /* SameValue */(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
