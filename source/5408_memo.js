...
// Function ID: 5409
// Name: memo
// Dependencies: [19, 17, 21, 1606, 5261, 5254, 5250, 5277]
...
const memoResult = memo(function BottomSheetRefreshControlComponent(arg0) {
  ...
  let dependencyMap;
  let iter;
  const tmp4 = iter(scrollableGesture(5261).BottomSheetDraggableContext);
  dependencyMap = tmp4;
  let obj = scrollableGesture(5254);
  ...
  obj = { animatedScrollableState: iter, SCROLLABLE_STATE: tmp2(5250).SCROLLABLE_STATE };
  fn.__closure = obj;
  ...
  if (tmp7) {
    ...
    let tmp8Result = tmp8(tmp2(5277).GestureDetector, obj);
  } else {
    const obj2 = {};
