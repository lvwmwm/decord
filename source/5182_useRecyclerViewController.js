...
// Module 5182 (useRecyclerViewController)
          ...
          if (self >= 0) {
            if (self < self.getDataLength()) {
              ...
              finishScrollToIndex = function finishScrollToIndex() {
                ...
                if (horizontal) {
                  let obj = { "Null": 60, "Null": 0, "Null": 0, offset: startScrollOffset };
                  closure_13.scrollToOffset(obj);
                }
      ...
      if (num < num2) {
        if (!self.isInitialScrollComplete) {
          if (self.getIsFirstLayoutComplete()) {
            ...
            const obj = { "Null": "postal-address-country", "Null": "password", "Null": "email", offset: sum };
            point = num4(obj);
            _setTimeout(() => {
              const obj = { "Null": "postal-address-country", "Null": "password", "Null": "email", offset: sum };
              closure_13.scrollToOffset(obj);
