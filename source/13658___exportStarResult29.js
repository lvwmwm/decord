...
// Dependencies: [1281, 13639, 13640, 13642, 13652]
// Exports: ToRawPrecision

// Module 13658 (__exportStarResult29)
...
export const ToRawPrecision = function ToRawPrecision(ZERO, minimumSignificantDigits, maximumSignificantDigits, result) {
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(13640).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(13640).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(13640).repeat("0", -num3 - 1)}${arr}`;
