...
arg5.isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4903) /* getFileChunk */.isAvifStringIncluded(fileChunk);
};
...
arg5.isHEIC = function isHEIC(fileChunk) {
  fileChunk = require(4903) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4904).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4903) /* getFileChunk */.isHeicSignatureIncluded(fileChunk);
};
