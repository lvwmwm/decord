...
// Module 10412 (ForumPostActionBar)
...
obj.actionRow = { <string:1373927010>: null, <string:1650543116>: 0, <string:810443091>: 360, <string:1629053384>: 0 };
obj.reactionRow = { <string:1373927010>: null, <string:1650543116>: 0, <string:810443091>: 360, <string:1629053384>: 0 };
const obj1 = { 1948712964: "<string:3745579009>", 1320026116: "<string:1627390376>", 1320091652: "<string:1781154295>", -1454309372: "<string:1866596353>", -1323867642: "<string:2969567617>", 1097496657: "<string:285212960>", 287034: "<string:98062593>", -269683630: "container", borderRadius: require("result").radii.xs, backgroundColor: require("result").colors.CONTROL_SECONDARY_BACKGROUND_DEFAULT, borderColor: require("result").colors.CONTROL_SECONDARY_BACKGROUND_DEFAULT };
obj.actionButton = obj1;
...
export default function ForumPostActionBar(channel) {
  ...
  if (!!stateFromStores2) {
    ...
    if (stateFromStores1) {
      ...
      obj5.onPress = items9;
      intl = callback2;
      items9 = [callback2(tmp20(tmp21[18]).CheckmarkLargeIcon, { flexDirection: null, alignItems: null }), ];
      ...
      const obj8 = { Promise: "2026-05-app-store-overlay-feature-gate", marginTop: "user", flags: "2026-03-quest-reload-video-on-obscured", style: tmp.buttonText };
