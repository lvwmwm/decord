...
let forwardRef;
let closure_3 = ["sr", "unicodeVersion", "state", "isArray", "constructor", "LengthDelimited", "x", "source", "isArray", "", "exports", "mn"];
...
const styles = StyleSheet.create({ commitView: { transparent: null, aliceblue: 0.3 } });
