...
// Dependencies: [7520, 7501, 7500, 7531]

// Module 7545 (applyScopeDataToEvent)
const require = arg1;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  const dropUndefinedKeysResult3 = require(7501) /* addNonEnumerableProperty */.dropUndefinedKeys(contexts);
...
arg5.mergeAndOverwriteScopeData = function mergeAndOverwriteScopeData(arg0, arg1, arg2) {
  arg0[arg1] = require(7520) /* merge */.merge(arg0[arg1], arg2, 1);
};
arg5.mergeScopeData = function mergeScopeData(extra) {
  ...
  let obj = require(7520) /* merge */;
  extra.extra = obj.merge(extra.extra, extra, 1);
  extra.tags = require(7520) /* merge */.merge(extra.tags, tags, 1);
  const obj2 = require(7520) /* merge */;
  extra.user = require(7520) /* merge */.merge(extra.user, user, 1);
  const obj3 = require(7520) /* merge */;
  extra.contexts = require(7520) /* merge */.merge(extra.contexts, contexts, 1);
  const obj4 = require(7520) /* merge */;
  extra.sdkProcessingMetadata = require(7520) /* merge */.merge(extra.sdkProcessingMetadata, sdkProcessingMetadata, 2);
  if (level) {
    extra.level = level;
  }
  if (transactionName) {
