...
// Function ID: 7517
// Name: ScopeClass
// Dependencies: [32, 41, 42, 7505, 7517, 7518, 7502, 7509, 7520, 7506, 7495]

// Module 7516 (ScopeClass)
...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      let obj1 = ScopeClass(7505);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(7505);
      ...
      let tmp3Result = tmp3(7517);
      tmp3Result = tmp3(7517);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(7518).updateSession(self._session, obj);
        const obj2 = ScopeClass(7518);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(7517)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(7517);
      obj[0] = ScopeClass(7505).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(7509).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      obj[12] = ScopeClass(7517)._getSpanForScope(self);
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(7520).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      ...
      obj[0] = ScopeClass(7505).generateSpanId();
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(7495).logger;
