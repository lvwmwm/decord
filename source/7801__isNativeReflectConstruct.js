...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7802, 7796, 7797]

// Module 7801 (_isNativeReflectConstruct)
...
let obj = {
  ...
  value: function render() {
    ...
    const tmp = importDefault(7802);
    const merged = Object.assign(self(7796).extractFilter(this.props));
    const obj2 = self(7796);
    const merged1 = Object.assign(self(7796).extractFeComposite(this.props));
