...
// Dependencies: [32, 3940, 3953]
// Exports: useRiveBoolean

// Module 3956 (getBooleanProperty)
...
export const useRiveBoolean = function useRiveBoolean(reducedMotion, instance) {
  ...
  const obj2 = require(3953) /* useRiveProperty */;
  [tmp3, tmp4, tmp5] = callback(require(3953) /* useRiveProperty */.useRiveProperty(instance, reducedMotion, getBooleanProperty), 3);
  if (cResult[0] === tmp5) {
    if (cResult[1] === tmp4) {
      if (cResult[2] === tmp3) {
        let tmp6 = cResult[3];
