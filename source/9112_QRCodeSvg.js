...
// Function ID: 9113
// Name: QRCodeSvg
// Dependencies: [9109, 19, 7835]

// Module 9112 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(7835) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(7835) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(7835) /* inlineStyles */.Path, { d, fill }));
});
