...
(Decimal) => {
  ...
  function convertBase(str, closure_19, closure_19) {
    const items = [0.229];
    let num = 0;
    if (0 < str.length) {
      do {
        ...
        if (tmp) {
          do {
            items[diff] = items[diff] * closure_19;
            let tmp3 = +diff;
            diff = tmp3 - 1;
          } while (tmp3);
        }
        ...
        for (let num2 = 0; num2 < items.length; num2 = num2 + 1) {
          if (items[num2] > closure_19 - 1) {
            if (undefined === items[num2 + 1]) {
              items[num2 + 1] = 0;
            }
            let sum = num2 + 1;
            items[sum] = items[sum] + (items[num2] / closure_19 | 0);
            items[num2] = items[num2] % closure_19;
          }
        }
      } while (num < length);
    }
            ...
            if (d[0]) {
              ...
              if (tmp23) {
                while (0 != diff1) {
                  ...
                  let tmp32 = closure_19;
                  if (d[diff1] == closure_19) {
                    let tmp33 = +diff1;
                    diff1 = tmp33 - 1;
                    d[tmp33] = 0;
                    num19 = 1;
      ...
      if (arg1) {
        if (arg2) {
          ...
          if (diff > 0) {
            ...
            let text2 = `${arr.charAt(0)}.${arr.slice(1)}${closure_34(tmp25)}`;
          }
          let str7 = "e+";
          if (constructor.e < 0) {
            str7 = "e";
        ...
        const text4 = `0.${closure_34(-e - 1)}${arr}`;
        let tmp22 = arg2;
        if (arg2) {
  ...
  function getLn10(arg0, precision, precision) {
    if (precision > closure_20) {
      ...
      const _Error = Error;
      throw Error(closure_10);
    } else {
      const prototype = arg0.prototype;
      const tmp5 = new arg0(cloneResult);
        ...
        if (constructor.e <= 17) {
          ...
          while (true) {
            ...
            if (substr === substr1) {
              ...
              if (tmp55) {
                do {
                  let tmp32 = closure_28;
                  let timesResult3 = obj5.times(obj5);
                  let tmp34 = closure_28(timesResult3, tmp30, 1);
                  let tmp35 = +diff;
                  diff = tmp35 - 1;
                  obj5 = timesResult3;
                  tmp37 = diff;
  ...
  function parseOther(s, arr) {
    ...
    const arr4 = convertBase(tmp14, num, closure_19);
  ...
  function toLessThanHalfPi(constructor, self) {
    ...
    if (absResult.lte(timesResult)) {
      ...
      if (divToIntResult.isZero()) {
        ...
        const lteResult = minusResult.lte(timesResult);
      }
      return obj5.minus(obj).abs();
    }
  }
  function toStringBinary(isFinite, closure_19, arg2, arg3) {
    let d;
    let e;
    let precision;
    let result1;
      ...
      if (arr3[0]) {
        ...
        if (tmp) {
          ...
          if (tmp54 > 1) {
            ...
            const arr4 = convertBase(tmp68, num5, closure_19);
            let tmp71 = length3;
            let tmp72 = length3;
  ...
  function config(defaults) {
    ...
    if (defaults) {
      if ("object" === typeof defaults) {
        const items = ["unsafeStringify", "FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID", 1000000000, "rounding", 0, 8, "toExpNeg", -9000000000000000, 0, "toExpPos", 0, 9000000000000000, "maxE", 0, 9000000000000000, "minE", -9000000000000000, 0, "modulo", 0, 9];
        let num = 0;
        if (0 < items.length) {
          while (true) {
            tmp = items[num];
          ...
          const _Error = Error;
          throw Error(closure_9 + tmp + ": " + tmp3);
        }
          ...
          if (true !== _crypto) {
            if (false !== _crypto) {
              if (0 !== _crypto) {
                if (1 !== _crypto) {
                  const _Error3 = Error;
                  throw Error(closure_9 + "crypto" + ": " + _crypto);
                }
              }
            }
          }
  ...
  function isDecimalInstance(toStringTag) {
    let flag = toStringTag instanceof cloneResult;
    if (!flag) {
      let tmp = toStringTag;
      if (toStringTag) {
        tmp = toStringTag.toStringTag === closure_12;
      }
      flag = tmp;
    }
    if (!flag) {
  ...
  function pow(result, exponent) {
    return new this(result).pow(exponent);
  }
  ...
  let cloneResult = "2.";
  ...
  let obj = {};
  let closure_8 = true;
  let closure_9 = "[DecimalError] Invalid argument: ";
  let closure_10 = "[DecimalError] Precision limit exceeded";
  let closure_11 = "[DecimalError] crypto unavailable";
  let closure_12 = "[object Decimal]";
  floor = Math.floor;
  pow = Math.pow;
  let closure_15 = /^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i;
  let closure_16 = /^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i;
  let closure_17 = /^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i;
  let closure_18 = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i;
  let closure_19 = 10000000;
    ...
    if (constructor.s) {
      if (constructor1.s) {
        if (obj.gt(constructor1)) {
          const _Error = Error;
          throw Error(closure_9 + constructor1);
        } else {
          if (self.cmp(obj) >= 0) {
        ...
        if (d[0]) {
          if (!self.eq(1)) {
            ...
            if (checkRoundingDigits(tmp29.d, precision, rounding)) {
              ...
              const arr2 = digitsToString(tmp41.d);
            }
            closure_8 = true;
              ...
              if (length5 > num5) {
                do {
                  ...
                  if (arr3[diff3] < arr4[diff3]) {
                    ...
                    arr3[diff3] = arr3[diff3] + closure_19;
                    let tmp49 = tmp44;
                  }
          ...
          if (d[0]) {
            if (d1[0]) {
              ...
              while (length3) {
                ...
                arr3[length3] = sum1;
                let tmp32 = closure_19;
                num5 = sum1 / closure_19 | 0;
                let tmp33 = closure_19;
                arr3[length3] = arr3[length3] % closure_19;
                num6 = num5;
              }
              let sum2 = tmp19;
              if (num6) {
              ...
              do {
                ...
                if (sum2 > diff1) {
                  do {
                    ...
                    items[tmp22] = sum3 % closure_19 | 0;
                    let tmp24 = closure_19;
                    num9 = sum3 / closure_19 | 0;
                    num10 = num9;
                    tmp20 = sum2;
                  } while (sum2 > diff1);
                }
                let tmp25 = closure_19;
                items[tmp20] = (items[tmp20] + num10) % closure_19 | 0;
                diff1 = diff1 - 1;
                tmp18 = num10;
              } while (diff1 >= 0);
            }
  ...
  obj.toFraction = function(arg0) {
    ...
    if (d) {
      ...
      if (null == arg0) {
        ...
        const _Error = Error;
        throw Error(closure_9 + constructor3);
      }
      let closure_8 = false;
      const prototype4 = constructor.prototype;
      ...
      if (1 != plusResult.cmp(obj3)) {
        do {
          ...
          let num12 = 1;
          let num13 = 1;
          let obj11 = closure_23(tmp40, minusResult, 0, 1, 1);
          ...
          if (constructor.d[0]) {
            ...
            if (constructor1.eq(1)) {
              ...
              if (constructor.eq(1)) {
                  ...
                  if (e <= constructor.maxE + 1) {
                    if (e >= constructor.minE - 1) {
                      ...
                      if (d) {
                        ...
                        const arr = digitsToString(tmp29.d);
                      }
                ...
                const _Math = Math;
                const _Math2 = Math;
                e = floor(tmp * (Math.log(`0.${closure_24(obj2.d)}`) / Math.LN10 + constructor1.e + 1));
              }
            }
            const tmp6 = constructor1;
          }
        }
      }
    }
          ...
          if (d1) {
            if (d1[0]) {
              if (arg5) {
                ...
                tmp5 = closure_19;
                num8 = 7;
                diff = callback(s.e / 7) - callback(s2.e / 7);
                const tmp7 = callback(s.e / 7);
              }
              let length = d1.length;
              const prototype = constructor.prototype;
              constructor = new constructor(num);
          ...
          if (closure_67(arg0)) {
            ...
            if ("number" === tmp8) {
              ...
              if (0 === arg0) {
                ...
                {
                  tmp21 = closure_41;
                  tmp22 = closure_41(self, str4.toString());
                  tmp23 = self;
                }
                return tmp23;
              }
              ...
              if ("string" === tmp8) {
                ...
                tmp15 = closure_18;
                tmp16 = substr2;
                if (closure_18.test(substr2)) {
                  tmp19 = closure_41;
                  tmp20 = closure_41(self, substr2);
                  tmp18 = self;
                } else {
                  tmp17 = closure_42;
                  tmp18 = closure_42(self, substr2);
                }
                return tmp18;
              } else {
                str2 = "bigint";
                if ("bigint" === tmp8) {
                  ...
                  tmp11 = closure_41;
                  tmp12 = closure_41(self, str3.toString());
                  return self;
                } else {
                  tmp9 = globalThis;
                  _Error = Error;
