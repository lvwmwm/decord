...
// Function ID: 5753
// Name: JSFPSMonitor
// Dependencies: [5699, 5700, 5687, 5753]

// Module 5752 (JSFPSMonitor)
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        const error = new Error(JSFPSMonitor(5687).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      obj[0] = JSFPSMonitor(5753).roundToDecimalPlaces(self.minFPS, 1);
      const obj2 = JSFPSMonitor(5753);
      obj[1] = JSFPSMonitor(5753).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(5753);
      obj[2] = JSFPSMonitor(5753).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    }
  }
];
