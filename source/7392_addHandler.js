...
// Function ID: 7393
// Name: addHandler
// Dependencies: [7393, 7394, 7397]

// Module 7392 (addHandler)
const require = arg1;
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (require(7393) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
          const logger = tmp19(7394).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(7397).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(7397);
        }
      }
    }
