...
// Function ID: 7346
// Name: addHandler
// Dependencies: [7346, 7347, 7350]

// Module 7345 (addHandler)
const require = arg1;
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (require(7346) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
          const logger = tmp19(7347).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(7350).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(7350);
        }
      }
    }
