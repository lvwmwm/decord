...
// Function ID: 6344
// Name: useFrameSize
// Dependencies: [19, 17, 21, 6344, 6345, 1522]
...
export const FrameSizeProvider = function FrameSizeProvider(initialFrame) {
  ...
  const tmp2 = importDefault(1522)(() => ref.current);
  dependencyMap = tmp2;
  const tmp3 = importDefault(1522)((arg0) => {
    let closure_0 = arg0;
  ...
  React = tmp3;
  const tmp4 = importDefault(1522)((arg0) => {
    let closure_0 = arg0;
    let c2 = false;
  ...
  const tmp6 = importDefault(1522)((height) => {
    if (!tmp2) {
