...
// Function ID: 6481
// Name: supportsFetch
// Dependencies: [6369, 6367, 6368]

// Module 6480 (supportsFetch)
const require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in require(6369) /* getGlobalSingleton */.GLOBAL_OBJ) {
    try {
...
arg5.supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "y") {
    ...
    if (isNativeFunction(require(6369) /* getGlobalSingleton */.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = tmp5(6369).GLOBAL_OBJ.document;
      if (_document) {
...
arg5.supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in require(6369) /* getGlobalSingleton */.GLOBAL_OBJ;
};
