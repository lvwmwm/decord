...
// Dependencies: [7576, 7548, 7520, 7531, 7529]

// Module 7595 (_getEventFilterUrl)
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (require(7548) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + tmp6(7531).getEventDescription(tmp));
      const tmp6Result = tmp6(7531);
    }
    return null;
  }
}
