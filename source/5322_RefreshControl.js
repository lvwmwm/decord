...
// Function ID: 45778
// Name: RefreshControl
// Dependencies: [57, 65, 29, 31, 27, 33, 5285, 5255, 5286]

// Module 5322 (RefreshControl)
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  const items1 = [ref];
  obj.waitFor = items.concat(tmp5(require(5255) /* hasProperty */.toArray(waitFor)), items1);
...
export const FlatList = importAllResult.forwardRef((arg0, ref) => {
  ...
  while (tmp3 !== undefined) {
    ...
    let nativeViewProps = ref(5286).nativeViewProps;
