...
const items = [];
const items1 = ["home", "ZqK0uI", "GIFT_CODE_RESOLVE_SUCCESS", "_$esjava$bra", "targetFrames", "back", "useThirdPartyTaskDetails", "HappeningNowCardsDisabled"];
