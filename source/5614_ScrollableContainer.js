...
// Dependencies: [19, 21, 5615, 5616, 5618]

// Module 5614 (ScrollableContainer)
import "noop";
...
export const ScrollableContainer = require("noop").forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  const tmp6 = jsx(require(5615) /* BottomSheetDraggableScrollable */.BottomSheetDraggableScrollable, { ref });
  let tmp2Result = tmp6;
  if (onRefresh) {
    ...
    obj[3] = onRefresh;
    obj[4] = require(5618) /* styles */.styles.container;
    obj[5] = tmp6;
    tmp2Result = jsx(importDefault(5616), { scrollableGesture: null, refreshing: null, progressViewOffset: null, onRefresh: null, style: null, children: null });
    const tmp9 = importDefault(5616);
  }
  return tmp2Result;
});
