...
// Dependencies: [57, 65, 12076, 12077, 12075, 12069]

// Module 12081 (convertBaseSchema)
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema($schema, defaultTarget) {
      if ("boolean" === typeof $schema) {
        ...
        if (null == registry) {
          registry = require(12069) /* registry */.globalRegistry;
        }
        obj.registry = registry;
        return convertSchema($schema, obj);
      }
    };
    const fnResult = fn(require("module_12076"));
    let _Object4 = Object;
    obj = { iso: fn(require("module_12077")) };
    let _Object5 = Object;
