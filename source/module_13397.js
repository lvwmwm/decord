// Module ID: 13397
// Function ID: 102404
// Dependencies: [13398, 13346, 13342, 13343, 13362, 13399, 13400, 13365]
...
if (getOwnPropertyDescriptor) {
  getOwnPropertyDescriptor = !require("module_13343")(() => 8 !== defineProperty(() => {
...
const fn = (name, toString) => {
  ...
  let tmp9 = !require(13362) /* call */(name, "name");
  if (!tmp9) {
    let CONFIGURABLE = require(13399).CONFIGURABLE;
    if (CONFIGURABLE) {
  ...
  if (tmp9) {
    if (require(13342) /* getOwnPropertyDescriptor */) {
  ...
  if (tmp22) {
    tmp22 = require(13362) /* call */(arg2, "arity");
  }
  if (tmp22) {
  ...
  if (arg2) {
    if (require(13362) /* call */(arg2, "constructor")) {
      if (arg2.constructor) {
        if (require(13342) /* getOwnPropertyDescriptor */) {
          obj = { writable: false };
      ...
      while (true) {
        ...
        let num4 = 6;
        let obj4 = require(13400) /* state */;
        let tmp43 = name;
        let enforceResult = obj4.enforce(name);
        let tmp45 = enforceResult;
        let str10 = "source";
        if (require(13362) /* call */(enforceResult, "source")) {
          break;
        } else {
          let tmp48 = text;
          let str11 = "";
...
Function.prototype.toString = fn(function toString() {
  const self = this;
  let source = require(13365) /* all */(this);
  if (source) {
    source = require(13400) /* state */.get(self).source;
    const obj = require(13400) /* state */;
  }
  if (!source) {
