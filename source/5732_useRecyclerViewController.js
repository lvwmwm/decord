...
// Dependencies: [5733, 5690, 19, 17, 5734, 5735, 5705, 5736, 5730]
// Exports: useRecyclerViewController

// Module 5732 (useRecyclerViewController)
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  const unmountFlag = _require(5734).useUnmountFlag();
  ...
  _setTimeout = _require(5735).useUnmountAwareTimeout().setTimeout;
