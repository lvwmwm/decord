...
// Dependencies: [5678, 5679, 5683, 5684]

// Module 5677 (RenderTimeTracker)
...
const items = [
  {
    ...
    value: function startTracking() {
      ...
      let trackAverageRenderTimeForOffsetProjection = RenderTimeTracker(5684).PlatformConfig.trackAverageRenderTimeForOffsetProjection;
  ...
  },
  {
    ...
    value: function getAverageRenderTime() {
      const self = this;
      if (RenderTimeTracker(5684).PlatformConfig.trackAverageRenderTimeForOffsetProjection) {
        const _Math = Math;
        const _Math2 = Math;
        const _Math3 = Math;
