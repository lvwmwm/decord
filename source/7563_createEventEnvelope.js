...
// Dependencies: [7519, 7520, 7564, 7567, 7556, 7525]
// Exports: createEventEnvelope, createSessionEnvelope, createSpanEnvelope

// Module 7563 (createEventEnvelope)
...
export const createEventEnvelope = function createEventEnvelope(type, arg1, sdk) {
  const sdkMetadataForEnvelopeHeader = require(7564) /* forEachEnvelopeItem */.getSdkMetadataForEnvelopeHeader(sdk);
  let str = "event";
  if (type.type) {
    str = "event";
...
export const createSessionEnvelope = function createSessionEnvelope(toJSON) {
  let obj = require(7564) /* forEachEnvelopeItem */;
