...
// Function ID: 68076
// Name: percentToFloat
// Dependencies: [31, 27, 8513, 8585, 8515]
// Exports: default

// Module 8584 (percentToFloat)
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
      ...
      while (true) {
        ...
        if ("number" === typeof tmp7) {
          ...
          if (!isNaN(tmp5Result)) {
            ...
            let items1 = [tmp5Result, 16777215 & tmp7 | Math.round(255 * importDefault(8513)(stopOpacity)) << 24];
    ...
    if (gradientUnits) {
      num10 = importDefault(8585)[gradientUnits];
    }
    if (!num10) {
      num10 = 0;
    }
    ...
    obj.gradientTransform = importDefault(8515)(gradientTransform);
    return obj;
  } else {
    return null;
  }
