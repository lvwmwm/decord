        ...
        if (match2) {
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              let items1 = ["<string:1010630658>", "<string:1246494722>", "<string:3003122491>", "<string:352322212>"];
            } else {
              items1 = null;
