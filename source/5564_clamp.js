        ...
        if (match2) {
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              items1 = null;
              if (hasOwnProperty.call(require(5562) /* keys */, match4[1])) {
                const tmp15 = require(5562) /* keys */[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
            }
...
obj.to.hex = () => {
  const tmp = require(5565) /* swizzle */(arguments);
...
obj.to.rgb = () => {
  const arr = require(5565) /* swizzle */(arguments);
  if (arr.length >= 4) {
    if (1 !== arr[3]) {
      const _Math = Math;
      const _Math2 = Math;
