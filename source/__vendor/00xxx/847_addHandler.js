...
// Function ID: 848
// Name: addHandler
// Dependencies: [820, 821, 830]

// Module 847 (addHandler)
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (__SENTRY_DEBUG__.DEBUG_BUILD) {
          const debug = tmp19(821).debug;
          debug.error(tmp2 + tmp6 + tmp3 + tmp19(830).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(830);
        }
      }
    }
