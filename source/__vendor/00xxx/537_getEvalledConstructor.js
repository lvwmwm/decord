...
// Dependencies: [538, 539, 541, 543, 555, 556, 546, 557, 558, 559, 560, 553, 554, 561, 545, 562, 563, 564, 565, 566, 567, 568, 544, 551, 570]

// Module 537 (getEvalledConstructor)
import _mod538 from "module_538" /* 538 */;
import _mod539 from "module_539" /* 539 */;
import _Symbol6 from "_Symbol" /* 541 */;
import getProto from "getProto" /* 543 */;
import getPrototypeOf from "getPrototypeOf" /* 544 */;
import _mod545 from "module_545" /* 545 */;
import _mod546 from "module_546" /* 546 */;
import _mod555 from "module_555" /* 555 */;
...
if (_mod539) {
  throwTypeError = (() => {
    try {
      ...
      try {
        return _mod539(arguments, "callee").get;
      } catch (err) {
        return throwTypeError;
      }
    }
...
let closure_9 = typeof call === "unknown" ? bind(concat) : call(module_553, concat);
const call2 = bind.call;
let closure_10 = typeof call2 === "unknown" ? bind(splice) : call2(module_554, splice);
const call3 = bind.call;
let closure_11 = typeof call3 === "unknown" ? bind(replace) : call3(module_553, replace);
const call4 = bind.call;
let closure_12 = typeof call4 === "unknown" ? bind(slice) : call4(module_553, slice);
const call5 = bind.call;
let closure_13 = typeof call5 === "unknown" ? bind(exec) : call5(module_553, exec);
...
export default function GetIntrinsic(str, flag) {
    ...
    if (0 !== str.length) {
      ...
      if (arguments.length > 1) {
        if (typeof flag !== "boolean") {
          throwTypeErrorResult = new items(538)("\"allowMissing\" argument must be a boolean");
          throw throwTypeErrorResult;
        }
      }
      throwTypeErrorResult = callback5;
      if (null === callback5(/^%?[^%]*%?$/, str)) {
        const tmp94 = new items(559)("`%` may not be present anywhere but at the beginning and end of the intrinsic name");
        throw tmp94;
      } else {
        ...
        if ("%" === throwTypeErrorResult) {
          if ("%" !== throwTypeErrorResult) {
            const tmp88 = new items(559)("invalid intrinsic syntax, expected closing `%`");
            throw tmp88;
          }
        }
        if ("%" === throwTypeErrorResult) {
          if ("%" !== throwTypeErrorResult) {
            const tmp82 = new items(559)("invalid intrinsic syntax, expected opening `%`");
            throw tmp82;
          }
        }
        items = [];
        ...
        const text1 = `${tmp7}%`;
        let text2 = text1;
        if (items(570)(obj, `${tmp7}%`)) {
          const tmp14 = tmp11[`${tmp7}%`];
          text2 = `${"%" + tmp14[0]}%`;
        }
        if (items(570)(obj, text2)) {
          if (tmp15[text2] !== obj) {
            if (undefined === tmp23) {
              if (!flag) {
                const _HermesInternal2 = HermesInternal;
                let tmp9Result = tmp9(538);
            ...
            if (1 < items.length) {
                            ...
                            if (tmp45 in tmp43) {
                              if (tmp56(539)) {
                                if (num + 1 >= items.length) {
                                  let tmp67 = tmp56(539)(tmp43, tmp45);
                                  let tmp68 = tmp67;
                                  if (tmp68) {
                                    if ("get" in tmp67) {
                              ...
                              let tmp65 = tmp56(570)(tmp43, tmp45);
                              ...
                              let tmp63 = new tmp56(538)("base intrinsic for " + str + " exists, but the property is not available.");
                              let tmp64 = tmp63;
                              throw tmp63;
                            }
                          }
              ...
              const tmp76 = new items(559)("property names with quotes must have matching quotes");
              throw tmp76;
            }
            return tmp44;
          } else {
            ...
            if ("%AsyncFunction%" === text2) {
              ...
              if ("%AsyncGeneratorFunction%" === text2) {
                ...
                if ("%AsyncIteratorPrototype%" === text2) {
                  ...
                  if (prototype) {
                    tmp9Result1 = tmp9(543);
                  }
                  if (tmp9Result1) {
                    prototype = tmp9(543)(prototype.prototype);
                  }
                }
              }
          ...
          const _HermesInternal = HermesInternal;
          const tmp9Result21 = new tmp9(559)("intrinsic " + text1 + " does not exist!");
          throw tmp9Result21;
        }
        tmp11 = obj;
      }
  ...
  throwTypeErrorResult = new items(538)("intrinsic name must be a non-empty string");
  throw throwTypeErrorResult;
};
