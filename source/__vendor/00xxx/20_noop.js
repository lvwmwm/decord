  ...
  map: function mapChildren(element) {
    ...
    if (null == element) {
      ...
      mapIntoArray(element, items, "", "", (arg0) => {
        const call = f68799.call;
        closure_2 = tmp3 + 1;
        return typeof call === "unknown" ? f68799(arg0, +closure_2) : call(closure_1, arg0, +closure_2);
      });
      return items;
    }
  },
  forEach(element) {
    const f68797 = function() {
      const self = this;
      const apply = f68797.apply;
