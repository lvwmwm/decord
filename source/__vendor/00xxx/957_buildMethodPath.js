...
// Dependencies: [955, 958]

// Module 957 (buildMethodPath)
...
arg5.setTokenUsageAttributes = function setTokenUsageAttributes(setAttributes) {
  ...
  if (undefined !== arg1) {
    let obj = {};
    obj[_mod955.GEN_AI_USAGE_INPUT_TOKENS_ATTRIBUTE] = num;
    setAttributes.setAttributes(obj);
  }
  let num2 = arg2;
  if (undefined !== arg2) {
    obj = {};
    obj[_mod955.GEN_AI_USAGE_OUTPUT_TOKENS_ATTRIBUTE] = num2;
    setAttributes.setAttributes(obj);
  }
  let num3 = arg3;
  let num4 = arg4;
