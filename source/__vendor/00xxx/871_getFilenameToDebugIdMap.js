...
// Dependencies: [818, 830]

// Module 871 (getFilenameToDebugIdMap)
...
function getFilenameToDebugIdMap(arg0) {
  const _require = arg0;
  const _sentryDebugIds = _require(818).GLOBAL_OBJ._sentryDebugIds;
  const _debugIds = _require(818).GLOBAL_OBJ._debugIds;
  if (!_sentryDebugIds) {
    if (!_debugIds) {
      return {};
    }
