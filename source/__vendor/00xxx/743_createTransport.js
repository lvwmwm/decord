  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(729).envelopeItemTypeToDataCategory(arg1);
        const obj = items(729);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: items(729).serializeEnvelope(dependencyMap) };
          const obj2 = items(729);
          ...
          if (arg0 === items(742).SENTRY_BUFFER_FULL_ERROR) {
