...
class SentrySpan {
  constructor() {
    ...
    obj[require("module_704").SEMANTIC_ATTRIBUTE_SENTRY_OP] = obj.op;
...
let items = [
  ...
  },
  {
    ...
    value: function getSpanJSON() {
      ...
      obj[12] = SentrySpan(727).timedEventsToMeasurements(this._events);
      ...
      obj[15] = SentrySpan(684).convertSpanLinksForEnvelope(self._links);
      return obj;
    }
  },
  {
    ...
    value: function _convertSpanToTransaction() {
      ...
      if (tmp6) {
        ...
        if (true === self._sampled) {
          ...
          const mapped = found.map((arg0) => self(684).spanToJSON(arg0));
          ...
          obj = { trace: null };
          obj[0] = tmp3(684).spanToTransactionTraceContext(self);
          obj[0] = obj;
          let substr = found1;
          ...
          obj1[2] = tmp3(722).getDynamicSamplingContextFromSpan(self);
          obj[6] = obj1;
