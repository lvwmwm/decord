...
// Module 841 (AsyncFromSyncIterator)
            ...
            switch (c11) {
              ...
              case 1:
                ...
                if (obj1.responseId) {
                  ...
                  throwTypeErrorResult = dependencyMap;
                  throwTypeErrorResult = obj1;
                  obj24[store(823).GEN_AI_RESPONSE_ID_ATTRIBUTE] = obj1.responseId;
                }
                throwTypeErrorResult = value2;
                throwTypeErrorResult = obj1;
                if (obj1.responseModel) {
                  ...
                  throwTypeErrorResult = dependencyMap;
                  throwTypeErrorResult = obj1;
                  obj24[store(823).GEN_AI_RESPONSE_MODEL_ATTRIBUTE] = obj1.responseModel;
                }
                throwTypeErrorResult = value2;
                throwTypeErrorResult = obj1;
                if (undefined !== obj1.promptTokens) {
                  ...
                  throwTypeErrorResult = dependencyMap;
                  throwTypeErrorResult = obj1;
                  obj24[store(823).GEN_AI_USAGE_INPUT_TOKENS_ATTRIBUTE] = obj1.promptTokens;
                }
                throwTypeErrorResult = value2;
                throwTypeErrorResult = obj1;
                if (undefined !== obj1.completionTokens) {
                  ...
                  throwTypeErrorResult = dependencyMap;
                  throwTypeErrorResult = obj1;
                  obj24[store(823).GEN_AI_USAGE_OUTPUT_TOKENS_ATTRIBUTE] = obj1.completionTokens;
                }
                throwTypeErrorResult = value2;
                throwTypeErrorResult = obj1;
                if (undefined !== obj1.totalTokens) {
                  ...
                  throwTypeErrorResult = dependencyMap;
                  throwTypeErrorResult = obj1;
                  obj24[store(823).GEN_AI_USAGE_TOTAL_TOKENS_ATTRIBUTE] = obj1.totalTokens;
                }
                throwTypeErrorResult = value2;
                throwTypeErrorResult = obj1;
                if (obj1.finishReasons.length) {
                  ...
                  const _JSON17 = JSON;
                  throwTypeErrorResult = obj1;
                  obj24[store(823).GEN_AI_RESPONSE_FINISH_REASONS_ATTRIBUTE] = JSON.stringify(obj1.finishReasons);
                }
                throwTypeErrorResult = value2;
                ...
                if (length17) {
                  ...
                  obj24[store(823).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts9.join("");
                }
                throwTypeErrorResult = value2;
                ...
                if (length18) {
                  ...
                  const _JSON18 = JSON;
                  throwTypeErrorResult = obj1;
                  obj24[store(823).GEN_AI_RESPONSE_TOOL_CALLS_ATTRIBUTE] = JSON.stringify(obj1.toolCalls);
                }
                throwTypeErrorResult = value2;
                throwTypeErrorResult = store;
                throwTypeErrorResult = obj24;
              ...
              case 4:
                ...
                if (throwTypeErrorResult) {
                  ...
                  if (callback2) {
                    ...
                    throwTypeErrorResult = store;
                    throwTypeErrorResult = dependencyMap;
                    obj6[store(823).GEN_AI_RESPONSE_STREAMING_ATTRIBUTE] = true;
                    obj24 = obj6;
                    throwTypeErrorResult = obj1;
                    if (obj1.responseId) {
                      throwTypeErrorResult = value2;
                    ...
                    if (length15) {
                      ...
                      obj24[store(823).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts8.join("");
                    }
                    throwTypeErrorResult = value2;
                  ...
                  if (arg0 === 2) {
                    ...
                    if (throwTypeErrorResult) {
                      ...
                      if (callback2) {
                        ...
                        throwTypeErrorResult = store;
                        throwTypeErrorResult = dependencyMap;
                        obj8[store(823).GEN_AI_RESPONSE_STREAMING_ATTRIBUTE] = true;
                        obj24 = obj8;
                        throwTypeErrorResult = obj1;
                        if (obj1.responseId) {
                          throwTypeErrorResult = value2;
                        ...
                        if (length13) {
                          ...
                          obj24[store(823).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts7.join("");
                        }
                        throwTypeErrorResult = value2;
                    ...
                    if (done2) {
                      ...
                      if (throwTypeErrorResult) {
                        ...
                        if (callback2) {
                          ...
                          throwTypeErrorResult = store;
                          throwTypeErrorResult = dependencyMap;
                          obj11[store(823).GEN_AI_RESPONSE_STREAMING_ATTRIBUTE] = true;
                          obj24 = obj11;
                          throwTypeErrorResult = obj1;
                          if (obj1.responseId) {
                            throwTypeErrorResult = value2;
                          ...
                          if (length9) {
                            ...
                            obj24[store(823).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts5.join("");
                          }
                          throwTypeErrorResult = value2;
                    ...
                    if (throwTypeErrorResult) {
                      ...
                      if (callback2) {
                        ...
                        if (length11) {
                          ...
                          obj24[store(823).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts6.join("");
                        }
                        throwTypeErrorResult = value2;
              ...
              case 9:
                if (arg0 === 1) {
                  ...
                  if (callback2) {
                    ...
                    throwTypeErrorResult = store;
                    throwTypeErrorResult = dependencyMap;
                    obj17[store(823).GEN_AI_RESPONSE_STREAMING_ATTRIBUTE] = true;
                    obj24 = obj17;
                    throwTypeErrorResult = obj1;
                    if (obj1.responseId) {
                      throwTypeErrorResult = value2;
                    ...
                    if (length7) {
                      ...
                      obj24[store(823).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts4.join("");
                    }
                    throwTypeErrorResult = value2;
              ...
              case 11:
                if (arg0 === 1) {
                  ...
                  if (callback2) {
                    ...
                    throwTypeErrorResult = store;
                    throwTypeErrorResult = dependencyMap;
                    obj19[store(823).GEN_AI_RESPONSE_STREAMING_ATTRIBUTE] = true;
                    obj24 = obj19;
                    throwTypeErrorResult = obj1;
                    if (obj1.responseId) {
                      throwTypeErrorResult = value2;
                    ...
                    if (length5) {
                      ...
                      obj24[store(823).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts3.join("");
                    }
                    throwTypeErrorResult = value2;
              ...
              case 13:
                if (arg0 === 1) {
                  ...
                  if (callback2) {
                    ...
                    obj24 = 0;
                    const obj21 = {};
                    obj21[store(823).GEN_AI_RESPONSE_STREAMING_ATTRIBUTE] = true;
                    obj24 = obj21;
                    if (obj1.responseId) {
                      throwTypeErrorResult = iter;
                      throwTypeErrorResult = obj24;
                    ...
                    if (length3) {
                      ...
                      obj24[store(823).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts2.join("");
                    }
                    throwTypeErrorResult = value2;
                ...
                if (arg0 === 1) {
                  ...
                  if (callback2) {
                    ...
                    if (length) {
                      ...
                      obj24[store(823).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts.join("");
                    }
              ...
              default:
                if (arg0 === 1) {
                  ...
                  if (callback2) {
                    ...
                    throwTypeErrorResult = store;
                    throwTypeErrorResult = dependencyMap;
                    obj24[store(823).GEN_AI_RESPONSE_STREAMING_ATTRIBUTE] = true;
                    throwTypeErrorResult = obj1;
                    if (obj1.responseId) {
                      throwTypeErrorResult = value2;
                      throwTypeErrorResult = iter;
                    ...
                    if (length19) {
                      ...
                      obj24[store(823).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts10.join("");
                    }
                    throwTypeErrorResult = value2;
