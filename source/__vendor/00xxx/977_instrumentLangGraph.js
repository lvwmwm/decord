...
// Dependencies: [5, 863, 836, 978, 955, 837, 866, 979, 975, 958]
// Exports: instrumentLangGraph, instrumentStateGraphCompile

// Module 977 (instrumentLangGraph)
            ...
            applyResult.invoke = (function instrumentCompiledGraphInvoke(arg0, applyResult, arg2, closure_0) {
              ...
              const proxy = new Proxy(arg0, {
                apply(arg0, arg1, arg2) {
                  ...
                  obj = {};
                  obj[applyResult(836).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = applyResult(978).LANGGRAPH_ORIGIN;
                  obj[applyResult(836).SEMANTIC_ATTRIBUTE_SENTRY_OP] = applyResult(955).GEN_AI_INVOKE_AGENT_OPERATION_ATTRIBUTE;
                  obj[applyResult(955).GEN_AI_OPERATION_NAME_ATTRIBUTE] = "invoke_agent";
                  obj[2] = obj;
                  applyResult = undefined;
                  applyResult = callback(/* F124981 */ function() { ... });
