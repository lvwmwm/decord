...
// Dependencies: [874, 861, 876, 820, 821]

// Module 875 (createTransport)
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(861).envelopeItemTypeToDataCategory(arg1);
        const obj = items(861);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: items(861).serializeEnvelope(dependencyMap) };
          const obj2 = items(861);
          ...
          if (arg0 === items(874).SENTRY_BUFFER_FULL_ERROR) {
