...
// Function ID: 8385
// Name: inlineStyles
// Dependencies: [8385, 8386, 8489, 8490, 8492, 8493, 8407]

// Module 8384 (inlineStyles)
import CircleDefault from "Circle" /* 8386 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8407 */;
import showErrorCSS from "showErrorCSS" /* 8489 */;
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 8490 */;
import _fetchText from "_fetchText" /* 8492 */;
import RNSVGCircle from "RNSVGCircle" /* 8493 */;

for (const key10013 in require("module_8385")) {
  let tmp2 = key10013;
  arg5[key10013] = require("module_8385")[key10013];
  continue;
}
