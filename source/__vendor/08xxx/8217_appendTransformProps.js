...
// Dependencies: [8218, 8219, 8220]

// Module 8217 (appendTransformProps)
import append from "append" /* 8218 */;
import peg$SyntaxError from "peg$SyntaxError" /* 8219 */;
import peg$SyntaxError2 from "peg$SyntaxError" /* 8220 */;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(8219);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(8218);
