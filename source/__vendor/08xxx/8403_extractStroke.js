...
// Function ID: 8404
// Name: extractStroke
// Dependencies: [8401, 8389, 8404]

// Module 8403 (extractStroke)
const module = arg2;
...
arg5.default = function extractStroke(arg0, arg1, arr) {
  ...
  if (null != stroke) {
    arr.push("stroke");
    arg0.stroke = module(8401)(stroke);
  }
  if (null != strokeWidth) {
  ...
  if (null != strokeOpacity) {
    ...
    arg0.strokeOpacity = module(8389)(strokeOpacity);
  }
  if (null != strokeDasharray) {
    ...
    if (strokeDasharray) {
      ...
      if ("none" !== strokeDasharray) {
        tmp9 = module(8404)(strokeDasharray);
      }
    }
    let combined = tmp9;
    if (tmp9) {
