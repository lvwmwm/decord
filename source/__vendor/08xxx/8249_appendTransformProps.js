...
// Dependencies: [8250, 8251, 8252]

// Module 8249 (appendTransformProps)
import append from "append" /* 8250 */;
import peg$SyntaxError from "peg$SyntaxError" /* 8251 */;
import peg$SyntaxError2 from "peg$SyntaxError" /* 8252 */;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(8251);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(8250);
