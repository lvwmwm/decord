...
// Function ID: 8399
// Name: extractProps
// Dependencies: [8399, 8390, 8400, 8403, 8391, 8389]

// Module 8398 (extractProps)
import pickNotNil from "pickNotNil" /* 8399 */;
...
function extractProps(markerMid) {
  ...
  const obj = {};
  const items = [];
  module(8390)(obj, markerMid, arg1);
  module(8400)(obj, markerMid, items);
  module(8403)(obj, markerMid, items);
  if (markerMid.color) {
  ...
  const tmp6 = module(8391)(markerMid);
  if (null !== tmp6) {
    obj.matrix = tmp6;
  }
  if (null != opacity) {
    obj.opacity = tmp(8389)(opacity);
  }
  if (null != display) {
    let str4;
    if ("none" === display) {
