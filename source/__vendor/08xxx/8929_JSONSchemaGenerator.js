...
// Dependencies: [109, 41, 42, 8927, 8928]

// Module 8929 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(8927).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(8927).extractDefs(self.ctx, _idmap);
      return callback(JSONSchemaGenerator(8927).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
