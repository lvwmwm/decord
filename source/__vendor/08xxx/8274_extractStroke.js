...
// Function ID: 8275
// Name: extractStroke
// Dependencies: [8272, 8260, 8275]

// Module 8274 (extractStroke)
const module = arg2;
...
arg5.default = function extractStroke(arg0, arg1, arr) {
  ...
  if (null != stroke) {
    arr.push("stroke");
    arg0.stroke = module(8272)(stroke);
  }
  if (null != strokeWidth) {
  ...
  if (null != strokeOpacity) {
    ...
    arg0.strokeOpacity = module(8260)(strokeOpacity);
  }
  if (null != strokeDasharray) {
    ...
    if (strokeDasharray) {
      ...
      if ("none" !== strokeDasharray) {
        tmp9 = module(8275)(strokeDasharray);
      }
    }
    let combined = tmp9;
    if (tmp9) {
