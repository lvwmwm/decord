...
// Dependencies: [8392, 8393, 8394]

// Module 8391 (appendTransformProps)
import append from "append" /* 8392 */;
import peg$SyntaxError from "peg$SyntaxError" /* 8393 */;
import peg$SyntaxError2 from "peg$SyntaxError" /* 8394 */;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(8393);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(8392);
