...
// Function ID: 8243
// Name: inlineStyles
// Dependencies: [8243, 8244, 8347, 8348, 8350, 8351, 8265]

// Module 8242 (inlineStyles)
import CircleDefault from "Circle" /* 8244 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8265 */;
import showErrorCSS from "showErrorCSS" /* 8347 */;
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 8348 */;
import _fetchText from "_fetchText" /* 8350 */;
import RNSVGCircle from "RNSVGCircle" /* 8351 */;

for (const key10013 in require("module_8243")) {
  let tmp2 = key10013;
  arg5[key10013] = require("module_8243")[key10013];
  continue;
}
