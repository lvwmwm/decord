...
// Function ID: 8189
// Name: inlineStyles
// Dependencies: [8189, 8190, 8293, 8294, 8296, 8297, 8211]

// Module 8188 (inlineStyles)
import CircleDefault from "Circle" /* 8190 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8211 */;
import showErrorCSS from "showErrorCSS" /* 8293 */;
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 8294 */;
import _fetchText from "_fetchText" /* 8296 */;
import RNSVGCircle from "RNSVGCircle" /* 8297 */;

for (const key10013 in require("module_8189")) {
  let tmp2 = key10013;
  arg5[key10013] = require("module_8189")[key10013];
  continue;
}
