...
// Dependencies: [19, 17, 8260, 8332, 8262]
// Exports: default

// Module 8331 (offsetComparator)
import extractOpacityDefault from "extractOpacity" /* 8260 */;
import appendTransformPropsDefault from "appendTransformProps" /* 8262 */;
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
    ...
    if (gradientUnits) {
      num12 = _modDef8332[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
