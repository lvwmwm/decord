...
// Dependencies: [19, 17, 8389, 8461, 8391]
// Exports: default

// Module 8460 (offsetComparator)
import extractOpacityDefault from "extractOpacity" /* 8389 */;
import appendTransformPropsDefault from "appendTransformProps" /* 8391 */;
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
    ...
    if (gradientUnits) {
      num12 = _modDef8461[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
