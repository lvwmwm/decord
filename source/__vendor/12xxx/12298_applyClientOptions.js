...
// Dependencies: [12260, 12263, 12276, 12299, 12300, 12286, 12258, 12301, 12294, 12270]

// Module 12298 (applyClientOptions)
...
function applyDebugIds(exception) {
  _require = _require(12301).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = callback(12294).normalize(data.data, callback, dependencyMap);
                  data = obj;
                  const obj3 = callback(12294);
                }
