...
// Function ID: 12570
// Name: addHandler
// Dependencies: [12570, 12571, 12574]

// Module 12569 (addHandler)
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (__SENTRY_DEBUG__.DEBUG_BUILD) {
          const logger = tmp19(12571).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(12574).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(12574);
        }
      }
    }
