...
// Dependencies: [12303, 12311, 12308]

// Module 12313 (addContextToFrame)
...
arg5.addContextToFrame = function addContextToFrame(arr, lineno) {
  ...
  if (undefined !== lineno.lineno) {
    ...
    lineno.pre_context = substr.map((arg0) => callback(12311).snipLine(arg0, 0));
    const _Math5 = Math;
    ...
    lineno.post_context = substr1.map((arg0) => callback(12311).snipLine(arg0, 0));
