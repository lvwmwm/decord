...
// Dependencies: [12293, 12274, 12273, 12304]

// Module 12318 (applyScopeDataToEvent)
import addNonEnumerableProperty from "addNonEnumerableProperty" /* 12274 */;
import merge from "merge" /* 12293 */;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  if (span) {
    ...
    obj3[0] = tmp3(12273).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(12273);
    obj4[0] = tmp3(12304).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(12304);
    const rootSpan = tmp3(12273).getRootSpan(span);
    const tmp3Result4 = tmp3(12273);
    const description = tmp3(12273).spanToJSON(rootSpan).description;
