...
// Dependencies: [109, 41, 42, 12707, 12708]

// Module 12709 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(12707).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(12707).extractDefs(self.ctx, _idmap);
      return callback(JSONSchemaGenerator(12707).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
