...
// Function ID: 12383
// Name: dsnFromString
// Dependencies: [32, 12335, 12334]
// Exports: dsnToString, makeDsn

// Module 12382 (dsnFromString)
    ...
    if (obj(12334).DEBUG_BUILD) {
      ...
      if (found) {
        ...
        if (tmp6) {
          ...
          if (num3) {
            const logger3 = error(12335).logger;
            error = logger3.error;
            const _HermesInternal3 = HermesInternal;
          ...
          const logger2 = error(12335).logger;
          const _HermesInternal2 = HermesInternal;
