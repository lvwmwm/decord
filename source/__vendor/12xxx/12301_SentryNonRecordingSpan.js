...
// Dependencies: [41, 42, 12278, 12273]

// Module 12301 (SentryNonRecordingSpan)
...
const items = [
  {
    ...
    value: function spanContext() {
      return { spanId: this._spanId, traceId: this._traceId, traceFlags: SentryNonRecordingSpan(12273).TRACE_FLAG_NONE };
    }
  },
  {
    key: "end",
