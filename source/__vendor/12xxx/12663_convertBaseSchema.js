...
// Dependencies: [32, 12658, 12659, 12657, 12651]

// Module 12663 (convertBaseSchema)
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const fnResult = fn(_mod12658);
    let obj = {};
    let merged = Object.assign(fn(_mod12657));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(_mod12659);
    let _Set = Set;
