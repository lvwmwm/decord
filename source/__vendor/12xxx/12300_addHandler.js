...
// Function ID: 12301
// Name: addHandler
// Dependencies: [12301, 12302, 12305]

// Module 12300 (addHandler)
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (__SENTRY_DEBUG__.DEBUG_BUILD) {
          const logger = tmp19(12302).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(12305).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(12305);
        }
      }
    }
