...
// Dependencies: [12267, 12268, 12312, 12315, 12304, 12273]
// Exports: createEventEnvelope, createSessionEnvelope, createSpanEnvelope

// Module 12311 (createEventEnvelope)
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(12315).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(12315);
  }
