...
// Dependencies: [41, 42, 12259, 12254]

// Module 12282 (SentryNonRecordingSpan)
...
const items = [
  {
    ...
    value: function spanContext() {
      return { spanId: this._spanId, traceId: this._traceId, traceFlags: SentryNonRecordingSpan(12254).TRACE_FLAG_NONE };
    }
  },
  {
    key: "end",
