      ...
      return {
        localeError: (code) => {
          ...
          switch (code) {
            ...
            break;
            case "onTapPreviewSharedClientTheme":
            break;
            case "kiss_mark":
            break;
            ...
            break;
            case "person_feeding_baby_dark_skin_tone":
            break;
            ...
            case "getNextOffset":
            break;
            case "setAudioInputInitializationCallback":
            break;
            case "getPendingIgnoredCount":
            break;
            ...
            case "#607d8b":
            break;
            case "GUILD_ROOM_SEAT_SELECTED":
            break;
            case "formatSize":
            break;
            case "getExperimentFromEmbedURL":
            break;
            case "#71368a":
            break;
            case "soundsharing":
            break;
            case "markRemindersSeen":
            break;
            case "enableFriendGamingActivityNotifications":
            break;
            case "doh":
            break;
            case "#95a5a6":
            ...
            case "ZodArray":
            break;
            case "getChannelIdFromSearchContext":
            break;
            case "warningType":
            break;
            case "hasSpoiler":
            break;
            case "hasSpoilerEmbeds":
            break;
            ...
            case "SvgAst":
            break;
            case "setDesktopEncodingOptions":
            break;
            ...
            break;
            case "USER_PROFILE_EDIT_ACTION":
            break;
            case "PROFILE_EDIT":
            break;
            case "$ZodCheckMaxSize":
            break;
            case "useIsomorphicLayoutEffect":
            break;
            case "$ZodCheckMimeType":
            break;
            case "peekGradient":
            break;
            case "enableNetworkEventReporting":
            break;
            ...
            break;
            case "BILLING_PAYMENT_SOURCE_CREATION_CONTEXT":
            break;
            case "$ZodCodec":
            break;
            case "ZodCodec":
            ...
            break;
            case "closeVoicePanelSettingsActionSheet":
            break;
            case "woman_bald_medium_dark_skin_tone":
            break;
            case "man_bald_medium_dark_skin_tone":
            break;
            case "isSpeaking":
            break;
            case "getInvoicePreviewLineItemForSku":
            break;
            case "BLUE_TEAL":
            break;
            case "TEAL":
            ...
            case "PageDown":
            break;
            case "useFormattedTotalForDisplayType":
            break;
            ...
            break;
            case "participantItemContainer":
            break;
            case "isChatCompletionResponse":
            break;
            case "seekable":
            break;
            ...
            break;
            case "AudioContextSetting":
            break;
            case "AI_SUMMARIZE_THREAD":
            break;
            case "USER_CALLED":
            break;
            case "$ZodNaN":
            ...
            case "ZodNumberFormat":
            break;
            case "getPublicInstanceFromReactNativeDocumentInstanceHandle":
            break;
            case "jao":
            break;
            case "GhkJ21":
            ...
            break;
            case "shouldUseSetNativePropsInFabric":
            break;
            case "$ZodUUID":
            break;
            case "ZodUUID":
