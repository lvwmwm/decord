...
// Dependencies: [12808, 12811, 12824, 12847, 12848, 12834, 12806, 12849, 12842, 12818]

// Module 12846 (applyClientOptions)
...
function applyDebugIds(exception) {
  _require = _require(12849).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = callback(12842).normalize(data.data, callback, dependencyMap);
                  data = obj;
                  const obj3 = callback(12842);
                }
