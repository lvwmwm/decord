...
// Dependencies: [12728, 12729, 12773, 12776, 12765, 12734]
// Exports: createEventEnvelope, createSessionEnvelope, createSpanEnvelope

// Module 12772 (createEventEnvelope)
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(12776).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(12776);
  }
