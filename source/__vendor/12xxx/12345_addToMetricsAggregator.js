...
// Dependencies: [12245, 12248, 12250, 12276, 12254, 12277, 12249, 12346, 12263, 12283, 12284]

// Module 12345 (addToMetricsAggregator)
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = _require(12276).getClient();
    const obj2 = _require(12276);
  }
  if (client) {
    const activeSpan = _require(12254).getActiveSpan();
    let rootSpan;
    if (activeSpan) {
      let tmp3Result = tmp3(12254);
      rootSpan = tmp3Result.getRootSpan(activeSpan);
    }
    let description = rootSpan;
    if (rootSpan) {
      tmp3Result = tmp3(12254);
    ...
    if (_require(12277).DEBUG_BUILD) {
      const logger = tmp3(12249).logger;
      const _HermesInternal = HermesInternal;
      logger.log("Adding value of " + arg3 + " to " + SET_METRIC_TYPE + " metric " + arg2);
    }
    const obj3 = _require(12254);
    const globalSingleton = _require(12250).getGlobalSingleton("globalMetricsAggregators", () => {
    ...
    const tmp3Result1 = _require(12250);
  }
}
errorCallback;
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12346.COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12346.DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, _mod12346.SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12346.GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    dependencyMap = arg1;
    ...
    if (typeof fn === "function") {
      ...
      return _require(12283).startSpanManual(obj, (arg0) => {
        const callback = arg0;
        return callback(table[10]).handleCallbackErrors(() => callback(), () => {
          ...
          closure_2(lib, lib(12346).DISTRIBUTION_METRIC_TYPE, closure_1_1, parsed, obj);
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _require(12346).DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
