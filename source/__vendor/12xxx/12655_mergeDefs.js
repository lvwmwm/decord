        ...
        localeError: (code) => {
          switch (code.code) {
            ...
            case "discovery_splash":
              let combined = _HermesInternal15.concat(stringifyPrimitiveResult);
              return combined;
            case "splash":
              ...
              if (obj.test(code.expected)) {
                ...
                let combined1 = "Tipo inv\u00E1lido: esperado instanceof " + code.expected + ", recebido " + tmp52;
              } else {
                const _HermesInternal16 = HermesInternal;
                combined1 = "Tipo inv\u00E1lido: esperado " + expected + ", recebido " + tmp52;
              }
              return combined1;
            case "hash_mask":
            break;
            case "maskContentUnits":
              if (1 === code.values.length) {
                ...
                combined = "Op\u00E7\u00E3o inv\u00E1lida: esperada uma das " + closure_2.joinValues(code.values, "|");
              }
            break;
            ...
            break;
            case "contain":
              combined = _HermesInternal15.concat(stringifyPrimitiveResult);
              return combined;
