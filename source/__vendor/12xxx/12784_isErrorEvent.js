...
// Function ID: 12785
// Name: isErrorEvent
// Dependencies: [32, 41, 42, 12776, 12757, 12729, 12783, 12740, 12736, 12752, 12753, 12785, 12772, 12773, 12756, 12778, 12765, 12786, 12769, 12787, 12734]

// Module 12784 (isErrorEvent)
...
let items = [
  ...
  },
  {
    ...
    value: function captureMessage(arg0, arg1, arg2, arg3) {
      ...
      self = this;
      dependencyMap = arg3;
      obj = { event_id: obj(12740).uuid4() };
      const merged = Object.assign(arg2);
      const obj2 = obj(12740);
      const tmp = obj;
  ...
  },
  {
    ...
    value: function captureSession(release) {
      if (typeof release.release !== "string") {
        if (BaseClient(12757).DEBUG_BUILD) {
          const logger = tmp(12729).logger;
        ...
        BaseClient(12752).updateSession(release, { init: false });
        const obj = BaseClient(12752);
      }
    }
  },
  {
  ...
  },
  {
    ...
    value: function addIntegration(arg0) {
      BaseClient(12785).setupIntegration(this, arg0, this._integrations);
      if (!this._integrations[arg0.name]) {
        const items = [arg0];
        const result = BaseClient(12785).afterSetupIntegrations(this, items);
        const tmpResult = BaseClient(12785);
      }
    }
  },
  {
  ...
  },
  {
    ...
    value: function sendSession(arg0) {
      this.sendEnvelope(BaseClient(12772).createSessionEnvelope(arg0, this._dsn, this._options._metadata, this._options.tunnel));
    }
  },
  {
    ...
    value: function recordDroppedEvent(arg0, arg1, num) {
      ...
      if (this._options.sendClientReports) {
        ...
        if (BaseClient(12757).DEBUG_BUILD) {
          const logger = tmp6(12729).logger;
          let str3 = "";
          if (num2 > 1) {
  ...
  },
  {
    ...
    value: function sendEnvelope(arg0) {
      ...
      if (BaseClient(12757).DEBUG_BUILD) {
        let logger = tmp2(12729).logger;
        logger.error("Transport disabled");
      }
      nextPromise = BaseClient(12753).resolvedSyncPromise({});
    }
  },
  {
    ...
    value: function _setupIntegrations() {
      ...
      this._integrations = BaseClient(12785).setupIntegrations(this, integrations);
      const obj = BaseClient(12785);
      const result = BaseClient(12785).afterSetupIntegrations(this, integrations);
    }
  },
  {
  ...
  },
  {
    ...
    value: function _processEvent(type) {
      ...
      if (undefined !== sampleRate) {
        const parseSampleRateResult = str(12769).parseSampleRate(sampleRate);
        let obj = str(12769);
      }
      if (undefined === type) {
        if (typeof parseSampleRateResult === "number") {
          ...
          if (Math.random() > parseSampleRateResult) {
            ...
            let sentryError = new str(12786).SentryError("Discarding event because it's not included in the random sample (sampling rate = " + sampleRate + ")", "log");
            return str(12753).rejectedSyncPromise(sentryError);
          }
        }
      }
      str = "replay";
  ...
  },
  {
    ...
    value: function _flushOutcomes() {
      ...
      if (0 !== _clearOutcomesResult.length) {
        const DEBUG_BUILD = tmp(12757).DEBUG_BUILD;
        if (self._dsn) {
          if (DEBUG_BUILD) {
            const logger4 = tmp(12729).logger;
            logger4.log("Sending outcomes:", _clearOutcomesResult);
          }
          let tmpResult = tmp(12787);
