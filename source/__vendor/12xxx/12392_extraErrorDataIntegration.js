...
// Dependencies: [12358, 12309, 12347, 12308, 12311, 12330, 12302]

// Module 12392 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(12330).DEBUG_BUILD) {
                const logger = callback(12302).logger;
