...
// Function ID: 12322
// Name: SessionFlusher
// Dependencies: [41, 42, 12274, 12295]

// Module 12321 (SessionFlusher)
...
const items = [
  ...
  },
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12274).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12295).getIsolationScope();
        ...
        const obj = SessionFlusher(12295);
      }
    }
  },
  {
