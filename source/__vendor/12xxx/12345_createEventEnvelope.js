...
// Dependencies: [12301, 12302, 12346, 12349, 12338, 12307]
// Exports: createEventEnvelope, createSessionEnvelope, createSpanEnvelope

// Module 12345 (createEventEnvelope)
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(12349).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(12349);
  }
