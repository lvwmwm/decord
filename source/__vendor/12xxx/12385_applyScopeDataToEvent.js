...
// Dependencies: [12360, 12341, 12340, 12371]

// Module 12385 (applyScopeDataToEvent)
import addNonEnumerableProperty from "addNonEnumerableProperty" /* 12341 */;
import merge from "merge" /* 12360 */;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  if (span) {
    ...
    obj3[0] = tmp3(12340).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(12340);
    obj4[0] = tmp3(12371).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(12371);
    const rootSpan = tmp3(12340).getRootSpan(span);
    const tmp3Result4 = tmp3(12340);
    const description = tmp3(12340).spanToJSON(rootSpan).description;
