        ...
        localeError: (code) => {
          ...
          switch (str) {
            ...
            case "BOT_HTTP_INTERACTIONS":
              let expected = str[code.expected];
              if (expected == null) {
                expected = code.expected;
              }
              let parsedTypeResult = closure_2.parsedType(code.input);
              let tmp49 = str[parsedTypeResult];
              if (tmp49 == null) {
              ...
              if (isMatch) {
                ...
                let combined = "\u063A\u0644\u0637 \u0627\u0646 \u067E\u0679: instanceof " + code.expected + " \u0645\u062A\u0648\u0642\u0639 \u062A\u06BE\u0627\u060C " + tmp49 + " \u0645\u0648\u0635\u0648\u0644 \u06C1\u0648\u0627";
              } else {
                let _HermesInternal14 = HermesInternal;
                combined = "\u063A\u0644\u0637 \u0627\u0646 \u067E\u0679: " + expected + " \u0645\u062A\u0648\u0642\u0639 \u062A\u06BE\u0627\u060C " + tmp49 + " \u0645\u0648\u0635\u0648\u0644 \u06C1\u0648\u0627";
              }
              return combined;
            case "H":
              str = closure_2;
            ...
            break;
            case "GuildEntityDao":
              expected = str[code.expected];
              if (expected == null) {
                expected = code.expected;
              }
              parsedTypeResult = closure_2.parsedType(code.input);
              tmp49 = str[parsedTypeResult];
              if (tmp49 == null) {
                tmp49 = parsedTypeResult;
              }
              obj = /^[A-Z]/;
              ...
              if (isMatch) {
                ...
                combined = "\u063A\u0644\u0637 \u0627\u0646 \u067E\u0679: instanceof " + code.expected + " \u0645\u062A\u0648\u0642\u0639 \u062A\u06BE\u0627\u060C " + tmp49 + " \u0645\u0648\u0635\u0648\u0644 \u06C1\u0648\u0627";
              } else {
                _HermesInternal14 = HermesInternal;
                combined = "\u063A\u0644\u0637 \u0627\u0646 \u067E\u0679: " + expected + " \u0645\u062A\u0648\u0642\u0639 \u062A\u06BE\u0627\u060C " + tmp49 + " \u0645\u0648\u0635\u0648\u0644 \u06C1\u0648\u0627";
              }
              return combined;
            case "EntityDao":
