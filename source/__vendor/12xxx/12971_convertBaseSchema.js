...
// Dependencies: [32, 12966, 12967, 12965, 12959]

// Module 12971 (convertBaseSchema)
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const fnResult = fn(_mod12966);
    let obj = {};
    let merged = Object.assign(fn(_mod12965));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(_mod12967);
    let _Set = Set;
