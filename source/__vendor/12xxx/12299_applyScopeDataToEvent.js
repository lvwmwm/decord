...
// Dependencies: [12274, 12255, 12254, 12285]

// Module 12299 (applyScopeDataToEvent)
import addNonEnumerableProperty from "addNonEnumerableProperty" /* 12255 */;
import merge from "merge" /* 12274 */;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  if (span) {
    ...
    obj3[0] = tmp3(12254).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(12254);
    obj4[0] = tmp3(12285).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(12285);
    const rootSpan = tmp3(12254).getRootSpan(span);
    const tmp3Result4 = tmp3(12254);
    const description = tmp3(12254).spanToJSON(rootSpan).description;
