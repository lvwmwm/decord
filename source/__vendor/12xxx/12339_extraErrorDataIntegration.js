...
// Dependencies: [12305, 12256, 12294, 12255, 12258, 12277, 12249]

// Module 12339 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(12277).DEBUG_BUILD) {
                const logger = callback(12249).logger;
