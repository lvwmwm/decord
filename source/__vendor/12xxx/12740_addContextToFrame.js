...
// Dependencies: [12730, 12738, 12735]

// Module 12740 (addContextToFrame)
...
arg5.addContextToFrame = function addContextToFrame(arr, lineno) {
  ...
  if (undefined !== lineno.lineno) {
    ...
    lineno.pre_context = substr.map((arg0) => callback(12738).snipLine(arg0, 0));
    const _Math5 = Math;
    ...
    lineno.post_context = substr1.map((arg0) => callback(12738).snipLine(arg0, 0));
