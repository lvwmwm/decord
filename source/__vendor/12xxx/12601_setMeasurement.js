...
// Function ID: 12602
// Name: setMeasurement
// Dependencies: [12564, 12587, 12559, 12574]

// Module 12601 (setMeasurement)
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (rootSpan) {
    if (__SENTRY_DEBUG__.DEBUG_BUILD) {
      const logger = tmp9(12559).logger;
      const _HermesInternal = HermesInternal;
      logger.log("[Measurement] Setting measurement on root span: " + arg0 + " = " + arg1 + " " + arg2);
    }
    obj = {};
    obj[_mod12574.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[_mod12574.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
