...
// Dependencies: [109, 41, 42, 12973, 12974]

// Module 12975 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(12973).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(12973).extractDefs(self.ctx, _idmap);
      return callback(JSONSchemaGenerator(12973).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
