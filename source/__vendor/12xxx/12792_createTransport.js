...
// Dependencies: [12793, 12773, 12794, 12753, 12757, 12729, 12786]

// Module 12792 (createTransport)
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(12773).envelopeItemTypeToDataCategory(arg1);
        const obj = items(12773);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: items(12773).serializeEnvelope(dependencyMap) };
          const obj2 = items(12773);
          ...
          if (arg0 instanceof items(12786).SentryError) {
