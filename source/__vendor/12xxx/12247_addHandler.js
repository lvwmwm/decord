...
// Function ID: 12248
// Name: addHandler
// Dependencies: [12248, 12249, 12252]

// Module 12247 (addHandler)
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (__SENTRY_DEBUG__.DEBUG_BUILD) {
          const logger = tmp19(12249).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(12252).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(12252);
        }
      }
    }
