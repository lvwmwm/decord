...
// Dependencies: [12627, 12578, 12616, 12577, 12580, 12599, 12571]

// Module 12661 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(12599).DEBUG_BUILD) {
                const logger = callback(12571).logger;
