...
// Dependencies: [32, 12978, 12979, 12977, 12971]

// Module 12983 (convertBaseSchema)
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const fnResult = fn(_mod12978);
    let obj = {};
    let merged = Object.assign(fn(_mod12977));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(_mod12979);
    let _Set = Set;
