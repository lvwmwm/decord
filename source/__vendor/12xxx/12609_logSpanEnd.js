...
// Function ID: 12610
// Name: logSpanEnd
// Dependencies: [12599, 12576, 12571]

// Module 12609 (logSpanEnd)
...
arg5.logSpanStart = function logSpanStart(spanContext) {
  if (__SENTRY_DEBUG__.DEBUG_BUILD) {
    ...
    const rootSpan = tmp(12576).getRootSpan(spanContext);
    let str3 = "unsampled";
    ...
    if (rootSpan !== spanContext) {
      ...
      ({ op: op2, description: description2 } = tmp(12576).spanToJSON(rootSpan));
      ...
      const spanToJSONResult1 = tmp(12576).spanToJSON(rootSpan);
    }
    const logger = tmp(12571).logger;
