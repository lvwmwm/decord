...
// Function ID: 12350
// Name: dsnFromString
// Dependencies: [32, 12302, 12301]
// Exports: dsnToString, makeDsn

// Module 12349 (dsnFromString)
    ...
    if (obj(12301).DEBUG_BUILD) {
      ...
      if (found) {
        ...
        if (tmp6) {
          ...
          if (num3) {
            const logger3 = error(12302).logger;
            error = logger3.error;
            const _HermesInternal3 = HermesInternal;
          ...
          const logger2 = error(12302).logger;
          const _HermesInternal2 = HermesInternal;
