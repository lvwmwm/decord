...
// Dependencies: [12754, 12735, 12734, 12765]

// Module 12779 (applyScopeDataToEvent)
import addNonEnumerableProperty from "addNonEnumerableProperty" /* 12735 */;
import merge from "merge" /* 12754 */;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  if (span) {
    ...
    obj3[0] = tmp3(12734).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(12734);
    obj4[0] = tmp3(12765).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(12765);
    const rootSpan = tmp3(12734).getRootSpan(span);
    const tmp3Result4 = tmp3(12734);
    const description = tmp3(12734).spanToJSON(rootSpan).description;
