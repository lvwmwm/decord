...
// Dependencies: [12334, 12335, 12379, 12382, 12371, 12340]
// Exports: createEventEnvelope, createSessionEnvelope, createSpanEnvelope

// Module 12378 (createEventEnvelope)
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(12382).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(12382);
  }
