...
// Dependencies: [41, 42, 12312, 12307]

// Module 12335 (SentryNonRecordingSpan)
...
const items = [
  {
    ...
    value: function spanContext() {
      return { spanId: this._spanId, traceId: this._traceId, traceFlags: SentryNonRecordingSpan(12307).TRACE_FLAG_NONE };
    }
  },
  {
    key: "end",
