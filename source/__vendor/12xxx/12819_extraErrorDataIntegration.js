...
// Dependencies: [12785, 12736, 12774, 12735, 12738, 12757, 12729]

// Module 12819 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(12757).DEBUG_BUILD) {
                const logger = callback(12729).logger;
