        ...
        localeError: (code) => {
          ...
          switch (code) {
            ...
            case "ro":
              ...
              let tmp54 = closure_2[parsedTypeResult];
              if (tmp54 == null) {
            ...
            case "SEMANTIC_ATTRIBUTE_SENTRY_SOURCE":
              if (1 === code.values.length) {
                ...
                code = "Nevalida enigo: atendi\u011Dis " + closure_2.stringifyPrimitive(code.values[0]);
              } else {
                const _HermesInternal13 = HermesInternal;
                code = "Nevalida opcio: atendi\u011Dis unu el " + closure_2.joinValues(code.values, "|");
              }
            break;
            ...
            case "H":
              ...
              if (tmp34) {
                ...
                let combined1 = "Tro granda: atendi\u011Dis ke " + str27 + " havu " + str26 + str + " " + str33;
                ...
                combined1 = "Tro granda: atendi\u011Dis ke " + str28 + " havu " + str26 + code.maximum.toString();
            ...
            case "TP":
              ...
              if (tmp22) {
                ...
                let combined2 = "Tro malgranda: atendi\u011Dis ke " + origin + " havu " + str20 + str1 + " " + tmp22.unit;
              } else {
                const _HermesInternal9 = HermesInternal;
                combined2 = "Tro malgranda: atendi\u011Dis ke " + origin + " estu " + str20 + str1;
              }
              return combined2;
            case "P":
            break;
            case "INTERACTIONS":
              if ("starts_with" === code.format) {
                ...
                let combined3 = "Nevalida karaktraro: devas komenci\u011Di per \"" + code.prefix + "\"";
              } else if ("ends_with" === code.format) {
                const _HermesInternal7 = HermesInternal;
                combined3 = "Nevalida karaktraro: devas fini\u011Di per \"" + code.suffix + "\"";
              } else if ("includes" === code.format) {
                const _HermesInternal6 = HermesInternal;
                combined3 = "Nevalida karaktraro: devas inkluzivi \"" + code.includes + "\"";
              } else if ("regex" === code.format) {
                const _HermesInternal5 = HermesInternal;
                combined3 = "Nevalida karaktraro: devas kongrui kun la modelo " + code.pattern;
              } else {
            ...
            case "INVITE_EMBED":
              ...
              let combined4 = "Nekonata" + str4 + " \u015Dlosilo" + str3 + ": " + joinValuesResult;
              return combined4;
            case "INVITE_EMBED_ACTIONED":
            break;
            case "rm":
              let _HermesInternal2 = HermesInternal;
              let combined5 = "Nevalida \u015Dlosilo en " + code.origin;
              return combined5;
            case "m":
            break;
            case "me":
            ...
            case "I":
              ...
              let combined6 = "Nevalida valoro en " + code.origin;
              return combined6;
            case "InternalCard":
            break;
            case "ter":
            ...
            case "dy":
              ...
              str = "Nevalida valoro en ";
              combined6 = "Nevalida valoro en " + code.origin;
              return combined6;
            case "safeAreaRight":
            break;
            case "bor":
            ...
            case "ParentalControlledDefaultGuildsRestrictedV2":
              ...
              combined4 = "Nekonata" + str4 + " \u015Dlosilo" + str3 + ": " + joinValuesResult;
              return combined4;
            case "ar":
            break;
            case "DefaultGuildsRestricted":
              _HermesInternal2 = HermesInternal;
              combined5 = "Nevalida \u015Dlosilo en " + code.origin;
              return combined5;
