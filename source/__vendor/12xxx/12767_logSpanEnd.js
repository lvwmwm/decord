...
// Function ID: 12768
// Name: logSpanEnd
// Dependencies: [12757, 12734, 12729]

// Module 12767 (logSpanEnd)
...
arg5.logSpanStart = function logSpanStart(spanContext) {
  if (__SENTRY_DEBUG__.DEBUG_BUILD) {
    ...
    const rootSpan = tmp(12734).getRootSpan(spanContext);
    let str3 = "unsampled";
    ...
    if (rootSpan !== spanContext) {
      ...
      ({ op: op2, description: description2 } = tmp(12734).spanToJSON(rootSpan));
      ...
      const spanToJSONResult1 = tmp(12734).spanToJSON(rootSpan);
    }
    const logger = tmp(12729).logger;
