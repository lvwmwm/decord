...
// Function ID: 12783
// Name: SessionFlusher
// Dependencies: [41, 42, 12735, 12756]

// Module 12782 (SessionFlusher)
...
const items = [
  ...
  },
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12735).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12756).getIsolationScope();
        ...
        const obj = SessionFlusher(12756);
      }
    }
  },
  {
