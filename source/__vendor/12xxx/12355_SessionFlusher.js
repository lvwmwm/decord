...
// Function ID: 12356
// Name: SessionFlusher
// Dependencies: [41, 42, 12308, 12329]

// Module 12355 (SessionFlusher)
...
const items = [
  ...
  },
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12308).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12329).getIsolationScope();
        ...
        const obj = SessionFlusher(12329);
      }
    }
  },
  {
