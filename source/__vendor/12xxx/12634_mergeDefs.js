        ...
        localeError: (code) => {
          ...
          switch (str) {
            ...
            case "SERVER_INVITE":
              ...
              let tmp57 = closure_2[parsedTypeResult];
              if (tmp57 == null) {
                tmp57 = parsedTypeResult;
              }
              if (obj.test(code.expected)) {
                const _HermesInternal17 = HermesInternal;
                let combined = "Entr\u00E9e invalide : instanceof " + code.expected + " attendu, " + tmp57 + " re\u00E7u";
              } else {
                const _HermesInternal16 = HermesInternal;
                combined = "Entr\u00E9e invalide : " + expected + " attendu, " + tmp57 + " re\u00E7u";
              }
              return combined;
            case "INVITE_EMBED":
            break;
            case "INVITE_EMBED_ACTIONED":
              if (1 === code.values.length) {
                ...
                str = "Entr\u00E9e invalide : " + closure_2.stringifyPrimitive(code.values[0]) + " attendu";
              } else {
                const _HermesInternal14 = HermesInternal;
                str = "Option invalide : une valeur parmi ";
                str = `Option invalide : une valeur parmi ` + closure_2.joinValues(code.values, "|") + " attendue";
              }
            break;
            ...
            case "rm":
              ...
              if (tmp36) {
                ...
                let combined1 = "Trop grand : " + str33 + " doit " + verb + " " + str32 + str + " " + str39;
                ...
                combined1 = "Trop grand : " + str34 + " doit \u00EAtre " + str32 + code.maximum.toString();
            ...
            case "me":
              ...
              if (tmp24) {
                ...
                let combined2 = "Trop petit : " + origin + " doit " + tmp24.verb + " " + str22 + str1 + " " + tmp24.unit;
              } else {
                let str23 = code.minimum;
                let str2 = str23.toString();
                let _HermesInternal10 = HermesInternal;
                combined2 = "Trop petit : " + origin + " doit \u00EAtre " + str22 + str2;
              }
              return combined2;
            case "mes":
            break;
            case "I":
              if ("starts_with" === code.format) {
                ...
                let combined3 = "Cha\u00EEne invalide : doit commencer par \"" + code.prefix + "\"";
              } else if ("ends_with" === code.format) {
                let _HermesInternal8 = HermesInternal;
                combined3 = "Cha\u00EEne invalide : doit se terminer par \"" + code.suffix + "\"";
              } else if ("includes" === code.format) {
                let _HermesInternal7 = HermesInternal;
                combined3 = "Cha\u00EEne invalide : doit inclure \"" + code.includes + "\"";
              } else if ("regex" === code.format) {
                let _HermesInternal6 = HermesInternal;
                combined3 = "Cha\u00EEne invalide : doit correspondre au mod\u00E8le " + code.pattern;
              } else {
            ...
            case "ter":
              ...
              let combined4 = "Nombre invalide : doit \u00EAtre un multiple de " + code.divisor;
              return combined4;
            case "na":
            break;
            case "al":
              ...
              let combined5 = "Cl\u00E9" + str5 + " non reconnue" + str4 + " : " + joinValuesResult;
              return combined5;
            case "CardA11yWrapper":
            break;
            case "perGuildMaxCount":
              let _HermesInternal2 = HermesInternal;
              let combined6 = "Cl\u00E9 invalide dans " + code.origin;
              return combined6;
            case "getChannelIcon":
            break;
            ...
            case "co":
              ...
              let combined7 = "Valeur invalide dans " + code.origin;
              return combined7;
            case "C":
            break;
            case "Component":
            ...
            case "cat":
              ...
              if (tmp24) {
                ...
                combined2 = "Trop petit : " + origin + " doit " + tmp24.verb + " " + str22 + str1 + " " + tmp24.unit;
              } else {
                str23 = code.minimum;
                str2 = str23.toString();
            ...
            case "io":
              if ("starts_with" === code.format) {
                ...
                combined3 = "Cha\u00EEne invalide : doit commencer par \"" + code.prefix + "\"";
              } else if ("ends_with" === code.format) {
            ...
            case "_applyCombination":
              ...
              combined4 = "Nombre invalide : doit \u00EAtre un multiple de " + code.divisor;
              return combined4;
            case "ly":
            break;
            case "trequest":
              ...
              combined5 = "Cl\u00E9" + str5 + " non reconnue" + str4 + " : " + joinValuesResult;
              return combined5;
            case "requestActivityItems":
            break;
            case "black_nib":
              _HermesInternal2 = HermesInternal;
              combined6 = "Cl\u00E9 invalide dans " + code.origin;
              return combined6;
            ...
            case "background":
              ...
              str2 = "Valeur invalide dans ";
              combined7 = "Valeur invalide dans " + code.origin;
              return combined7;
