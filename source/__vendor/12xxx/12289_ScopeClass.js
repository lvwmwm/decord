...
// Function ID: 12290
// Name: ScopeClass
// Dependencies: [32, 41, 42, 12278, 12290, 12291, 12275, 12282, 12293, 12279, 12268]

// Module 12289 (ScopeClass)
...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      obj1 = ScopeClass(12278);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(12278);
      ...
      let tmp3Result = tmp3(12290);
      tmp3Result = tmp3(12290);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(12291).updateSession(self._session, obj);
        const obj2 = ScopeClass(12291);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(12290)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(12290);
      obj[0] = ScopeClass(12278).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(12282).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, extra: this._extra, user: this._user, level: this._level, fingerprint: tmp, eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: ScopeClass(12290)._getSpanForScope(self) };
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(12293).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      const obj = { spanId: ScopeClass(12278).generateSpanId() };
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(12268).logger;
          logger.warn("No client configured on scope - will not capture exception!");
          return event_id;
        }
      }
      obj = ScopeClass(12279);
      event_id = obj.uuid4();
    }
  },
  {
