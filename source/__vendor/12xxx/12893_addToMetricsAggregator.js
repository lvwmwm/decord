...
// Dependencies: [12793, 12796, 12798, 12824, 12802, 12825, 12797, 12894, 12811, 12831, 12832]

// Module 12893 (addToMetricsAggregator)
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = _require(12824).getClient();
    const obj2 = _require(12824);
  }
  if (client) {
    const activeSpan = _require(12802).getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    const obj3 = _require(12802);
    const globalSingleton = _require(12798).getGlobalSingleton("globalMetricsAggregators", () => {
    ...
    const tmp3Result1 = _require(12798);
  }
}
errorCallback;
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12894.COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12894.DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, _mod12894.SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12894.GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    dependencyMap = arg1;
    ...
    if (typeof fn === "function") {
      ...
      return _require(12831).startSpanManual(obj, (arg0) => {
        const callback = arg0;
        return callback(table[10]).handleCallbackErrors(() => callback(), () => {
          ...
          closure_2(lib, lib(12894).DISTRIBUTION_METRIC_TYPE, closure_1_1, parsed, obj);
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _require(12894).DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
