...
// Function ID: 12728
// Name: addHandler
// Dependencies: [12728, 12729, 12732]

// Module 12727 (addHandler)
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (__SENTRY_DEBUG__.DEBUG_BUILD) {
          const logger = tmp19(12729).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(12732).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(12732);
        }
      }
    }
