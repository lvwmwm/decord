...
// Dependencies: [12735, 12739, 12741, 12743, 12744, 12745, 12746, 12747, 12748, 12751, 12756, 12729]

// Module 12734 (spanTimeInputToSeconds)
  ...
  if ((function spanIsSentrySpan(getSpanJSON) {
    ...
    try {
      ...
      if ((function spanIsOpenTelemetrySdkTraceBaseSpan(attributes) {
        ...
        obj[8] = attributes[_mod12744.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj[9] = attributes[_mod12744.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== getSpanStatusFromHttpCode.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== tmp(12746).SPAN_STATUS_OK) {
