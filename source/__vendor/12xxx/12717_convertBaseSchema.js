...
// Dependencies: [32, 12712, 12713, 12711, 12705]

// Module 12717 (convertBaseSchema)
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const fnResult = fn(_mod12712);
    let obj = {};
    let merged = Object.assign(fn(_mod12711));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(_mod12713);
    let _Set = Set;
