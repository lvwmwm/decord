...
// Dependencies: [12279, 12282, 12295, 12318, 12319, 12305, 12277, 12320, 12313, 12289]

// Module 12317 (applyClientOptions)
...
function applyDebugIds(exception) {
  _require = _require(12320).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = callback(12313).normalize(data.data, callback, dependencyMap);
                  data = obj;
                  const obj3 = callback(12313);
                }
