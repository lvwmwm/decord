...
// Dependencies: [109, 41, 42, 12653, 12654]

// Module 12655 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(12653).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(12653).extractDefs(self.ctx, _idmap);
      return callback(JSONSchemaGenerator(12653).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
