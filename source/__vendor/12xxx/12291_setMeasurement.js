...
// Function ID: 12292
// Name: setMeasurement
// Dependencies: [12254, 12277, 12249, 12264]

// Module 12291 (setMeasurement)
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (rootSpan) {
    if (__SENTRY_DEBUG__.DEBUG_BUILD) {
      const logger = tmp9(12249).logger;
      const _HermesInternal = HermesInternal;
      logger.log("[Measurement] Setting measurement on root span: " + arg0 + " = " + arg1 + " " + arg2);
    }
    obj = {};
    obj[_mod12264.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[_mod12264.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
