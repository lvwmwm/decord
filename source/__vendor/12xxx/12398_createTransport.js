...
// Dependencies: [12399, 12379, 12400, 12359, 12363, 12335, 12392]

// Module 12398 (createTransport)
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(12379).envelopeItemTypeToDataCategory(arg1);
        const obj = items(12379);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: items(12379).serializeEnvelope(dependencyMap) };
          const obj2 = items(12379);
          ...
          if (arg0 instanceof items(12392).SentryError) {
