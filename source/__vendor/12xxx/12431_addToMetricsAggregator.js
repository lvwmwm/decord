...
// Dependencies: [12331, 12334, 12336, 12362, 12340, 12363, 12335, 12432, 12349, 12369, 12370]

// Module 12431 (addToMetricsAggregator)
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = _require(12362).getClient();
    const obj2 = _require(12362);
  }
  if (client) {
    const activeSpan = _require(12340).getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    const obj3 = _require(12340);
    const globalSingleton = _require(12336).getGlobalSingleton("globalMetricsAggregators", () => {
    ...
    const tmp3Result1 = _require(12336);
  }
}
errorCallback;
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12432.COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12432.DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, _mod12432.SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod12432.GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    dependencyMap = arg1;
    ...
    if (typeof fn === "function") {
      ...
      return _require(12369).startSpanManual(obj, (arg0) => {
        const callback = arg0;
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _require(12432).DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
