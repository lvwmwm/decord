...
// Dependencies: [12615, 12566, 12604, 12565, 12568, 12587, 12559]

// Module 12649 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(12587).DEBUG_BUILD) {
                const logger = callback(12559).logger;
