...
// Function ID: 12345
// Name: setMeasurement
// Dependencies: [12307, 12330, 12302, 12317]

// Module 12344 (setMeasurement)
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (rootSpan) {
    if (__SENTRY_DEBUG__.DEBUG_BUILD) {
      const logger = tmp9(12302).logger;
      const _HermesInternal = HermesInternal;
      logger.log("[Measurement] Setting measurement on root span: " + arg0 + " = " + arg1 + " " + arg2);
    }
    obj = {};
    obj[_mod12317.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[_mod12317.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
