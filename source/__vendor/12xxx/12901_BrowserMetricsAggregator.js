...
// Dependencies: [41, 42, 12894, 12811, 12898, 12899, 12802, 12900]

// Module 12901 (BrowserMetricsAggregator)
...
class BrowserMetricsAggregator {
  constructor(arg0) {
    ...
    map = new Map();
    this._buckets = map;
    this._interval = setInterval(() => self.flush(), require("module_12894").DEFAULT_BROWSER_FLUSH_INTERVAL);
    return;
  }
}
const items = [
  {
    ...
    value: function add(arg0, arg1, diff) {
      ...
      const bucketKey = BrowserMetricsAggregator(12898).getBucketKey(arg0, sanitizeMetricKeyResult, sanitizeUnitResult, sanitizeTagsResult);
      ...
      if (value) {
        ...
        const tmp16 = new tmp5(12899).METRIC_MAP[arg0](diff);
        obj[0] = tmp16;
        obj[1] = rounded;
        obj[2] = arg0;
      ...
      const result1 = BrowserMetricsAggregator(12802).updateMetricSummaryOnActiveSpan(arg0, sanitizeMetricKeyResult, diff, sanitizeUnitResult, obj, bucketKey);
    }
  },
  {
    key: "flush",
