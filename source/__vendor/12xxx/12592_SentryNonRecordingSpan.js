...
// Dependencies: [41, 42, 12569, 12564]

// Module 12592 (SentryNonRecordingSpan)
...
const items = [
  {
    ...
    value: function spanContext() {
      return { spanId: this._spanId, traceId: this._traceId, traceFlags: SentryNonRecordingSpan(12564).TRACE_FLAG_NONE };
    }
  },
  {
    key: "end",
