...
// Dependencies: [12341, 12345, 12347, 12349, 12350, 12351, 12352, 12353, 12354, 12357, 12362, 12335]

// Module 12340 (spanTimeInputToSeconds)
  ...
  if ((function spanIsSentrySpan(getSpanJSON) {
    ...
    try {
      ...
      if ((function spanIsOpenTelemetrySdkTraceBaseSpan(attributes) {
        ...
        obj[8] = attributes[_mod12350.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj[9] = attributes[_mod12350.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== getSpanStatusFromHttpCode.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== tmp(12352).SPAN_STATUS_OK) {
