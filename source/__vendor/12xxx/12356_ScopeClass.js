...
// Function ID: 12357
// Name: ScopeClass
// Dependencies: [32, 41, 42, 12345, 12357, 12358, 12342, 12349, 12360, 12346, 12335]

// Module 12356 (ScopeClass)
...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      obj1 = ScopeClass(12345);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(12345);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(12358).updateSession(self._session, obj);
        const obj2 = ScopeClass(12358);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(12357);
      obj[0] = ScopeClass(12345).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(12349).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      const obj = { spanId: ScopeClass(12345).generateSpanId() };
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(12335).logger;
