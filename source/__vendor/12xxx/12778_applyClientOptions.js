...
// Dependencies: [12740, 12743, 12756, 12779, 12780, 12766, 12738, 12781, 12774, 12750]

// Module 12778 (applyClientOptions)
...
function applyDebugIds(exception) {
  _require = _require(12781).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = callback(12774).normalize(data.data, callback, dependencyMap);
                  data = obj;
                  const obj3 = callback(12774);
                }
