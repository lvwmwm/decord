...
// Function ID: 12777
// Name: dsnFromString
// Dependencies: [32, 12729, 12728]
// Exports: dsnToString, makeDsn

// Module 12776 (dsnFromString)
    ...
    if (obj(12728).DEBUG_BUILD) {
      ...
      if (found) {
        ...
        if (tmp6) {
          ...
          if (num3) {
            const logger3 = error(12729).logger;
            error = logger3.error;
            const _HermesInternal3 = HermesInternal;
          ...
          const logger2 = error(12729).logger;
          const _HermesInternal2 = HermesInternal;
