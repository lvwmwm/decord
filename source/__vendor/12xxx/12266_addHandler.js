...
// Function ID: 12267
// Name: addHandler
// Dependencies: [12267, 12268, 12271]

// Module 12266 (addHandler)
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (__SENTRY_DEBUG__.DEBUG_BUILD) {
          const logger = tmp19(12268).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(12271).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(12271);
        }
      }
    }
