...
// Dependencies: [3733, 3757, 3758, 3760, 3761, 3763, 3768, 3774, 3571, 3572, 3750]
// Exports: default

// Module 3864 (intlFormatDistance)
...
import differenceInCalendarQuarters from "differenceInCalendarQuarters" /* 3758 */;
...
export default function intlFormatDistance(arg0, arg1, unit) {
  ...
  if (absolute < keys.secondsInMinute) {
    ...
    if (absolute1 < tmp6(3750).secondsInHour) {
      num2 = differenceInMinutes.default(defaultResult1, defaultResult2);
      str = "minute";
    } else {
      const _Math7 = Math;
      const absolute2 = Math.abs(defaultResult3);
      if (absolute2 < tmp6(3750).secondsInDay) {
        const _Math = Math;
      ...
      if (absolute3 < tmp6(3750).secondsInWeek) {
        num2 = differenceInCalendarDays.default(defaultResult1, defaultResult2);
        if (num2) {
          const _Math3 = Math;
          str = "day";
      ...
      if (absolute4 < tmp6(3750).secondsInMonth) {
        num2 = differenceInCalendarWeeks.default(defaultResult1, defaultResult2);
        str = "week";
      } else {
        const _Math8 = Math;
        const absolute5 = Math.abs(defaultResult3);
        if (absolute5 < tmp6(3750).secondsInQuarter) {
          num2 = differenceInCalendarMonths.default(defaultResult1, defaultResult2);
          str = "month";
        } else {
          const _Math5 = Math;
          const absolute6 = Math.abs(defaultResult3);
          if (absolute6 < tmp6(3750).secondsInYear) {
