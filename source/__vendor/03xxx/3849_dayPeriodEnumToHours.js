...
// Dependencies: [3720, 3850]

// Module 3849 (dayPeriodEnumToHours)
...
arg5.parseAnyDigitsSigned = function parseAnyDigitsSigned(str) {
  const match = str.match(_mod3850.numericPatterns.anyDigitsSigned);
  let tmp2 = null;
  if (match) {
    const obj = { value: null, rest: null };
...
arg5.parseNDigits = function parseNDigits(length, str) {
  if (1 === length) {
    const match = str.match(_mod3850.numericPatterns.singleDigit);
    let tmp20 = null;
    if (match) {
    ...
    const match1 = str.match(_mod3850.numericPatterns.twoDigits);
    let tmp15 = null;
    if (match1) {
    ...
    const match2 = str.match(_mod3850.numericPatterns.threeDigits);
    let tmp10 = null;
    if (match2) {
    ...
    const match3 = str.match(_mod3850.numericPatterns.fourDigits);
    let tmp5 = null;
    if (match3) {
...
arg5.parseNDigitsSigned = function parseNDigitsSigned(length, str) {
  if (1 === length) {
    const match = str.match(_mod3850.numericPatterns.singleDigitSigned);
    let tmp20 = null;
    if (match) {
      let obj = { value: null, rest: null };
      const _parseInt5 = parseInt;
    ...
    const match1 = str.match(_mod3850.numericPatterns.twoDigitsSigned);
    let tmp15 = null;
    if (match1) {
      obj = { value: null, rest: null };
      const _parseInt4 = parseInt;
    ...
    const match2 = str.match(_mod3850.numericPatterns.threeDigitsSigned);
    let tmp10 = null;
    if (match2) {
      obj1 = { value: null, rest: null };
      const _parseInt3 = parseInt;
    ...
    const match3 = str.match(_mod3850.numericPatterns.fourDigitsSigned);
    let tmp5 = null;
    if (match3) {
      const obj2 = { value: null, rest: null };
      const _parseInt2 = parseInt;
