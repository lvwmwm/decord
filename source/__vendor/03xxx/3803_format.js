...
// Function ID: 3804
// Name: format
// Dependencies: [3753, 3804, 3571, 3805, 3816, 3734, 3575, 3572, 3817, 3576, 3818]
// Exports: default
...
import G from "G" /* 3805 */;
import dateLongFormatter from "dateLongFormatter" /* 3816 */;
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = _require(3576).getDefaultOptions();
  locale = undefined;
  if (null != locale) {
              ...
              if (isValid.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3818).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3818).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3818).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
