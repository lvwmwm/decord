...
// Function ID: 3775
// Name: format
// Dependencies: [3724, 3775, 3542, 3776, 3787, 3705, 3546, 3543, 3788, 3547, 3789]
// Exports: default

// Module 3774 (format)
import isValid from "isValid" /* 3724 */;
import subMilliseconds from "subMilliseconds" /* 3775 */;
import _typeof from "_typeof" /* 3542 */;
import G from "G" /* 3776 */;
import dateLongFormatter from "dateLongFormatter" /* 3787 */;
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = _require(3547).getDefaultOptions();
  locale = undefined;
  if (null != locale) {
              ...
              if (isValid.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3789).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3789).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3789).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
