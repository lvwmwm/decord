...
// Function ID: 9878
// Name: QRCode
// Dependencies: [9878, 9880, 9882, 9883, 9884]

// Module 9877 (QRCode)
import QR8bitByte from "QR8bitByte" /* 9878 */;
import QRRSBlock from "QRRSBlock" /* 9880 */;
import QRBitBuffer from "QRBitBuffer" /* 9882 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9883.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9883.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9883.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
