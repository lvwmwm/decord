...
// Function ID: 9984
// Name: QRCode
// Dependencies: [9984, 9986, 9988, 9989, 9990]

// Module 9983 (QRCode)
import QR8bitByte from "QR8bitByte" /* 9984 */;
import QRRSBlock from "QRRSBlock" /* 9986 */;
import QRBitBuffer from "QRBitBuffer" /* 9988 */;
import _mod9989 from "module_9989" /* 9989 */;
import QRPolynomial from "QRPolynomial" /* 9990 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9989.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9989.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9989.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
