...
// Function ID: 9751
// Name: XorAndSalsa
// Dependencies: [5, 9751, 9752, 9754, 9756]
// Exports: scrypt, scryptAsync

// Module 9750 (XorAndSalsa)
import _asyncLoop from "_asyncLoop" /* 9751 */;
import pbkdf2Init from "pbkdf2Init" /* 9754 */;
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 9756 */;
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9751).isLE) {
                callback(9751).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
