...
// Function ID: 9791
// Name: XorAndSalsa
// Dependencies: [5, 9791, 9792, 9794, 9796]
// Exports: scrypt, scryptAsync

// Module 9790 (XorAndSalsa)
import _asyncLoop from "_asyncLoop" /* 9791 */;
import pbkdf2Init from "pbkdf2Init" /* 9794 */;
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 9796 */;
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9791).isLE) {
                callback(9791).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
