...
// Function ID: 9980
// Name: QRCode
// Dependencies: [9980, 9982, 9984, 9985, 9986]

// Module 9979 (QRCode)
import QR8bitByte from "QR8bitByte" /* 9980 */;
import QRRSBlock from "QRRSBlock" /* 9982 */;
import QRBitBuffer from "QRBitBuffer" /* 9984 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9985.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9985.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9985.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
