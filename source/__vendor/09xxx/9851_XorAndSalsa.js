...
// Function ID: 9852
// Name: XorAndSalsa
// Dependencies: [5, 9852, 9853, 9855, 9857]
// Exports: scrypt, scryptAsync

// Module 9851 (XorAndSalsa)
import _asyncLoop from "_asyncLoop" /* 9852 */;
import pbkdf2Init from "pbkdf2Init" /* 9855 */;
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 9857 */;
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9852).isLE) {
                callback(9852).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
