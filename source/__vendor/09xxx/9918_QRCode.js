...
// Function ID: 9919
// Name: QRCode
// Dependencies: [9919, 9921, 9923, 9924, 9925]

// Module 9918 (QRCode)
import QR8bitByte from "QR8bitByte" /* 9919 */;
import QRRSBlock from "QRRSBlock" /* 9921 */;
import QRBitBuffer from "QRBitBuffer" /* 9923 */;
import _mod9924 from "module_9924" /* 9924 */;
import QRPolynomial from "QRPolynomial" /* 9925 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9924.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9924.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9924.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
