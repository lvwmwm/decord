...
// Function ID: 9796
// Name: QRCode
// Dependencies: [9796, 9798, 9800, 9801, 9802]

// Module 9795 (QRCode)
import QR8bitByte from "QR8bitByte" /* 9796 */;
import QRRSBlock from "QRRSBlock" /* 9798 */;
import QRBitBuffer from "QRBitBuffer" /* 9800 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9801.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9801.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9801.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
