...
// Function ID: 9070
// Name: XorAndSalsa
// Dependencies: [5, 9070, 9071, 9073, 9075]
// Exports: scrypt, scryptAsync

// Module 9069 (XorAndSalsa)
import _asyncLoop from "_asyncLoop" /* 9070 */;
import pbkdf2Init from "pbkdf2Init" /* 9073 */;
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 9075 */;
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9070).isLE) {
                callback(9070).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
