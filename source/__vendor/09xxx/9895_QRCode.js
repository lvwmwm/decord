...
// Function ID: 9896
// Name: QRCode
// Dependencies: [9896, 9898, 9900, 9901, 9902]

// Module 9895 (QRCode)
import QR8bitByte from "QR8bitByte" /* 9896 */;
import QRRSBlock from "QRRSBlock" /* 9898 */;
import QRBitBuffer from "QRBitBuffer" /* 9900 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9901.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9901.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9901.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
