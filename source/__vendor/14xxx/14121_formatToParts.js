...
// Function ID: 14122
// Name: formatToParts
// Dependencies: [1280, 14099, 14122, 14117, 14123, 14119]
// Exports: default

// Module 14121 (formatToParts)
...
const regExp = new RegExp("^".concat(_mod14122.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod14122.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(14117).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(14123).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(14119).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
