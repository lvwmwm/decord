...
// Function ID: 14253
// Name: state
// Dependencies: [14216, 14191, 14253, 14207, 14254, 14236, 14214, 14247]
...
import all from "all" /* 14253 */;
import __core_js_shared__2 from "__core-js_shared__" /* 14254 */;
  ...
  if (!__core_js_shared__.state) {
    ...
    let fn = function t(facade) {
      if (call(facade, closure_6)) {
        const typeError = new tmp(14191).TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        tmp(14247)(facade, tmp3, arg1);
        return arg1;
      }
      tmp3 = closure_6;
    };
...
if (!state) {
  ...
  const weakMap = new _mod14191.WeakMap();
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new _mod14191.TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
