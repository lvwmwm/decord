...
// Function ID: 14046
// Name: Range
// Dependencies: [41, 42, 14017, 14044, 14018, 14020, 14019, 14016, 14046]
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_14017")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (value) {
        ...
        let str5 = str3.replace(tmp11(14020).safeRe[tmp11(undefined, 14020).t.TILDETRIM], tmp11(14020).tildeTrimReplace);
        tmp11(14019)("tilde trim", str5);
        const str7 = str5.replace(tmp11(14020).safeRe[tmp11(undefined, 14020).t.CARETTRIM], tmp11(14020).caretTrimReplace);
