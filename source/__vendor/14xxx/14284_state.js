...
// Function ID: 14285
// Name: state
// Dependencies: [14248, 14223, 14285, 14239, 14286, 14268, 14246, 14279]
...
import all from "all" /* 14285 */;
import __core_js_shared__2 from "__core-js_shared__" /* 14286 */;
  ...
  if (!__core_js_shared__.state) {
    ...
    let fn = function t(facade) {
      if (call(facade, closure_6)) {
        const typeError = new tmp(14223).TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        tmp(14279)(facade, tmp3, arg1);
        return arg1;
      }
      tmp3 = closure_6;
    };
...
if (!state) {
  ...
  const weakMap = new _mod14223.WeakMap();
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new _mod14223.TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
