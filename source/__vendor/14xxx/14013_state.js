...
// Function ID: 14014
// Name: state
// Dependencies: [13977, 13952, 14014, 13968, 14015, 13997, 13975, 14008]
...
import all from "all" /* 14014 */;
import __core_js_shared__2 from "__core-js_shared__" /* 14015 */;
  ...
  if (!__core_js_shared__.state) {
    ...
    let fn = function t(facade) {
      if (call(facade, closure_6)) {
        const typeError = new tmp(13952).TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        tmp(14008)(facade, tmp3, arg1);
        return arg1;
      }
      tmp3 = closure_6;
    };
...
if (!state) {
  ...
  const weakMap = new _mod13952.WeakMap();
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new _mod13952.TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
