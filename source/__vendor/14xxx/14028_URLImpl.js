...
// Function ID: 14029
// Name: URLImpl
// Dependencies: [41, 42, 14029, 14033, 14032]

// Module 14028 (URLImpl)
...
class URLImpl {
  constructor(arg0, arg1) {
    ...
    if (null === basicURLParseResult1) {
      ...
      tmp7Result = require("module_14033");
      items = [];
      items[0] = str;
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(14029).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(14029).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(14032).parseUrlencoded(query);
          const tmpResult = tmp(14032);
        }
      }
  ...
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(14029).serializeHost(host);
        const obj3 = URLImpl(14029);
      } else {
        const obj = URLImpl(14029);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(14029).serializeInteger(host.port)}`;
        const obj2 = URLImpl(14029);
      }
    },
    set(arg0) {
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(14029).serializeHost(tmp._url.host);
        const obj = URLImpl(14029);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(14029).serializeInteger(tmp._url.port);
        const obj = URLImpl(14029);
      }
      return str;
    },
    set(arg0) {
      ...
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        if ("" === arg0) {
          ...
          obj[0] = self._url;
          URLImpl(14029).basicURLParse(arg0, obj);
          const tmpResult = URLImpl(14029);
        }
      }
    }
