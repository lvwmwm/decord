...
f96330 = (arg0, arg1) => {
  class I {
    ...
    contains(arg0) {
      closure_0 = arg0;
      tmp = closure_0(this, /* F113655 */ function() { ... }) || false;
      return tmp;
    }
  }
  closure_3 = I;
        ...
        if (self.dashjs) {
          ...
          if (dashjs) {
            if (dashjs.on) {
              ...
              closure_10 = { video: "method", audio: "T", totalBitrate: "Map" };
