...
// Function ID: 14106
// Name: formatToParts
// Dependencies: [1280, 14083, 14106, 14101, 14107, 14103]
// Exports: default

// Module 14105 (formatToParts)
...
const regExp = new RegExp("^".concat(_mod14106.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod14106.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(14101).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(14107).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(14103).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
