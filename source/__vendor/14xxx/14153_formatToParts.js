...
// Function ID: 14154
// Name: formatToParts
// Dependencies: [1280, 14131, 14154, 14149, 14155, 14151]
// Exports: default

// Module 14153 (formatToParts)
import digitsToString from "digitsToString" /* 14131 */;
import _mod14154 from "module_14154" /* 14154 */;
import e from "e" /* 1280 */;

let closure_2 = e.__importDefault(digitsToString);
const regExp = new RegExp("^".concat(_mod14154.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod14154.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(14149).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(14155).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(14151).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
