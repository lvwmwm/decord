...
// Function ID: 14252
// Name: URLImpl
// Dependencies: [41, 42, 14252, 14256, 14255]

// Module 14251 (URLImpl)
...
class URLImpl {
  constructor(arg0, arg1) {
    ...
    if (null === basicURLParseResult1) {
      ...
      tmp7Result = require("module_14256");
      items = [];
      items[0] = str;
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(14252).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(14252).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(14255).parseUrlencoded(query);
          const tmpResult = tmp(14255);
        }
      }
      const obj = URLImpl(14252);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(14252).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
  ...
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14252).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(14252);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14252).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(14252);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(14252).serializeHost(host);
        const obj3 = URLImpl(14252);
      } else {
        const obj = URLImpl(14252);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(14252).serializeInteger(host.port)}`;
        const obj2 = URLImpl(14252);
      }
    },
    set(arg0) {
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(14252).serializeHost(tmp._url.host);
        const obj = URLImpl(14252);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(14252).serializeInteger(tmp._url.port);
        const obj = URLImpl(14252);
      }
      return str;
    },
    set(arg0) {
      ...
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        if ("" === arg0) {
          ...
          obj[0] = self._url;
          URLImpl(14252).basicURLParse(arg0, obj);
          const tmpResult = URLImpl(14252);
        }
      }
    }
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        self._query._list = URLImpl(14255).parseUrlencoded(substr);
      }
    }
  },
  {
