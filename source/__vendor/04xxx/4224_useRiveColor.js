...
// Function ID: 4225
// Name: useRiveColor
// Dependencies: [32, 19, 4206, 4219, 4214]
// Exports: useRiveColor

// Module 4224 (useRiveColor)
import c from "c" /* 4206 */;
import RiveColor2 from "RiveColor" /* 4214 */;
import useRiveProperty from "useRiveProperty" /* 4219 */;
import closure_2 from "_slicedToArray" /* 32 */;

require = arg1;
require("noop").useCallback;
const f29579 = (colorProperty) => colorProperty.colorProperty(arg1);

export const useRiveColor = function useRiveColor(FillColor, instance) {
  let obj = c;
  const cResult = obj.c(8);
  const tmp4 = callback(useRiveProperty.useRiveProperty(instance, FillColor, f29579), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
