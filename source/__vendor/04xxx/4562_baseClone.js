...
// Function ID: 4563
// Name: baseClone
// Dependencies: [606, 599, 4563, 4564, 770, 621, 4565, 4566, 4569, 4573, 4577, 4578, 4579, 775, 4585, 4587, 4589, 792, 4574, 616, 600, 4571]

// Module 4562 (baseClone)
let obj = {};
  ...
  if (!arg2) {
    {
      if (_require(606)(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4563)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4564)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(621)(arr)) {
            return tmp32(4565)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (obj[tmp11]) {
                  tmp14 = tmp32(4579)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4569);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4573)(obj, arr));
                } else {
                  tmp32Result = tmp32(4577);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4578)(obj, arr));
                }
