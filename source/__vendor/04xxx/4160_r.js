        ...
        constructor(arg0) {
          ...
          if (typeof global !== "function") {
            ...
            if (obj.shouldCatchExceptions(obj)) {
              ...
              catchPromise = _promise.catch(/* F124257 */ function() { ... });
            }
        ...
        arg0.loadAxo = function loadAxo(arg0) {
          ...
          const f124274 = function() {
            ...
            if (typeof Symbol === "function") {
              let _Symbol = Symbol;
              obj[Symbol.iterator] = /* F124268 */ function() { ... };
            }
            return obj;
          };
      ...
      class Framebus {
        ...
        targetFramesAsWindows() {
          if (this.limitBroadcastToFramesArray) {
            ...
            found = mapped.filter(/* F124281 */ function() { ... });
          } else {
            found = [];
          }
          return found;
        ...
        hasMatchingTargetFrame(arg0) {
          ...
          if (this.limitBroadcastToFramesArray) {
            ...
            tmp = globalThis;
            _Boolean = Boolean;
            return Boolean(result.find(/* F124282 */ function() { ... }));
          } else {
            flag = true;
            return true;
          }
    ...
    (arg0, arg1, arg2) => {
      class ApplePay {
        ...
        _createPaymentRequestSynchronously(arg0) {
          _client = this._client;
          applePayWeb = _client.getConfiguration().gatewayConfiguration.applePayWeb;
          obj = { countryCode: applePayWeb.countryCode, currencyCode: applePayWeb.currencyCode, merchantCapabilities: tmp, supportedNetworks: supportedNetworks.map(/* F120516 */ function() { ... }) };
    ...
    (arg0, arg1, arg2) => {
      class PayPalCheckout {
        ...
        teardown() {
          ...
          catchPromise = _frameServicePromise.catch(/* F120681 */ function() { ... });
    ...
    (arg0, arg1, arg2) => {
      class InlineIframeFramework {
        ...
        _addV1IframeToPage() {
          ...
          _emitResult = this._emit(InlineIframeFramework.events.AUTHENTICATION_IFRAME_AVAILABLE, obj, /* F120727 */ function() { ... });
          return;
        }
    ...
    (arg0, arg1, arg2) => {
      class SongbirdFramework {
        ...
        prepareLookup(arg0) {
          ...
          nextPromise1 = nextPromise.then(() => { ... });
          catchPromise = nextPromise1.catch(/* F120741 */ function() { ... });
