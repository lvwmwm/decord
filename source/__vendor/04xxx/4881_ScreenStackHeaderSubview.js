...
// Dependencies: [109, 19, 17, 21, 4882, 4878, 4883, 4884, 4879, 4885]
...
// Module 4881 (ScreenStackHeaderSubview)
import noopDefault from "noop" /* 19 */;
import get_controlledBottomTabsDefault from "get controlledBottomTabs" /* 4879 */;
import context from "context" /* 4882 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 4885 */;
...
const forwardRefResult = noopDefault.forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4878).isHeaderBarButtonsAvailableForCurrentPlatform) {
      let tmpResult = tmp(4883);
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4878).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4879).experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(result1(4884), {});
});
