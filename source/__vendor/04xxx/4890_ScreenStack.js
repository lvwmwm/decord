...
// Function ID: 4891
// Name: ScreenStack
// Dependencies: [109, 19, 21, 4875, 4891, 4892, 4879]
// Exports: default

// Module 4890 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(ref1(4891).GHContext);
  obj = {
  ...
  ref2(4875)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4875)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4879).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = children;
  obj1[6] = jsx(ref2(4892), {});
  ...
  return jsx(tmp4(4891).RNSScreensRefContext.Provider, { value: ref, children: null });
};
