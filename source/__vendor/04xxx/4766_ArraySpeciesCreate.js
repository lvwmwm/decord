...
// Dependencies: [540, 4767, 541, 4768, 4770, 4776, 4730, 4778]

// Module 4766 (ArraySpeciesCreate)
...
export default function ArraySpeciesCreate(arg0, arg1) {
  if (isInteger(arg1)) {
    if (arg1 >= 0) {
      if (tmp(4768)(arg0)) {
        const tmp3 = tmp(4776)(arg0, "constructor");
        let tmp5 = closure_2;
        if (closure_2) {
          tmp5 = tmp(4730)(tmp3);
        }
        let tmp6 = tmp3;
        if (tmp5) {
          const tmp7 = tmp(4776)(tmp3, tmp4);
          tmp5 = null === tmp7;
          tmp6 = tmp7;
        }
        if (undefined === tmp6) {
          return tmp(4770)(arg1);
        } else if (tmp(4778)(tmp6)) {
          tmp6 = new tmp6(arg1);
          return tmp6;
        } else {
