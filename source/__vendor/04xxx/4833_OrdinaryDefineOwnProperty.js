...
// Dependencies: [4770, 538, 4817, 4821, 539, 4834, 559, 4826, 4822, 4835, 4836]

// Module 4833 (OrdinaryDefineOwnProperty)
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (isObject(arg0)) {
    if (tmp(4817)(arg1)) {
      if (tmp(4821)(__Writable__)) {
        if (tmp(539)) {
          const tmp30 = tmp(539)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4822)(tmp30);
          }
          return tmp(4836)(arg0, arg1, tmp(4835)(arg0), __Writable__, tmp31);
        } else if (tmp(4834)(__Writable__)) {
          ...
          return tmp(4826)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
