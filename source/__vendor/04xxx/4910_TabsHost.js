...
// Function ID: 4911
// Name: TabsHost
// Dependencies: [32, 109, 19, 17, 21, 4911, 4886, 4912, 4913, 4915]
// Exports: default

// Module 4910 (TabsHost)
...
export default function TabsHost(onNativeFocusChange) {
  let obj = onNativeFocusChange(4911);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4886).experiment.controlledBottomTabs;
  }
