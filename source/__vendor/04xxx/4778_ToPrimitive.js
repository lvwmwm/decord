...
// Function ID: 4779
// Name: ToPrimitive
// Dependencies: [1416, 4779, 4780, 4781]

// Module 4778 (ToPrimitive)
import apply from "apply" /* 1416 */;
import isPrimitive from "isPrimitive" /* 4779 */;
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4781)(arg0) || tmp(4780)(arg0);
          const tmp15 = tmp(4781)(arg0) || tmp(4780)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
