...
// Function ID: 4237
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4237, 4238, 4240, 4214]
// Exports: RiveView

// Module 4236 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + _mod4237.RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp18 = jsx(_require(4214).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
