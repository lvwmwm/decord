...
// Dependencies: [4830, 4763, 538, 4810, 4814, 4827, 4817, 4818, 4819, 4820, 4831, 4832]

// Module 4829 (ValidateAndApplyPropertyDescriptor)
import isPropertyKey from "isPropertyKey" /* 4810 */;
import Type from "Type" /* 4830 */;
...
export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, flag, __Configurable__) {
  ...
  if (isPropertyKey(arg1)) {
    if (typeof flag !== "boolean") {
      ...
      throw tmp87;
    } else if (tmp(4814)(__Configurable__)) {
      __Set__ = arg4;
      if (undefined !== arg4) {
        if (!tmp(4814)(__Set__)) {
      ...
      if (undefined === __Set__) {
        ...
        if (tmp64) {
          if ("Undefined" === tmp3) {
            ...
            tmp66 = tmp(4827)(__Configurable__);
          }
        }
        return tmp64;
      } else {
        ...
        if (tmpResult3(obj, __Set__)) {
          if (!__Set__["[[Configurable]]"]) {
            ...
            if ("[[Enumerable]]" in __Configurable__) {
              if (!tmp(4819)(__Configurable__["[[Enumerable]]"], __Set__["[[Enumerable]]"])) {
                return false;
              }
            }
            if (!tmp(4832)(__Configurable__)) {
              const tmpResult4 = tmp(4819);
              if (!tmpResult4(tmp26, tmp(4827)(__Set__))) {
                return false;
              }
              tmp26 = tmp(4827)(__Configurable__);
            }
            if (tmp(4827)(__Set__)) {
              if ("[[Get]]" in __Configurable__) {
                if (!tmp(4819)(__Configurable__["[[Get]]"], __Set__["[[Get]]"])) {
                  return false;
                }
              }
              if ("[[Set]]" in __Configurable__) {
                if (!tmp(4819)(__Configurable__["[[Set]]"], __Set__["[[Set]]"])) {
                  return false;
                }
              }
              ...
              if ("[[Value]]" in __Configurable__) {
                if (!tmp(4819)(__Configurable__["[[Value]]"], __Set__["[[Value]]"])) {
                  return false;
                }
              }
            }
          ...
          if ("Undefined" === tmp3) {
            ...
            if (!tmp(4818)(__Set__)) {
              if (tmp(4827)(__Set__)) {
                if (tmp(4818)(__Configurable__)) {
                  ...
                  const tmpResult7 = tmp(4819);
                  const tmpResult8 = tmp(4820);
                  ...
                  let tmpResult6Result = tmp(4817)(tmpResult6, tmpResult7, tmpResult8, arg0, arg1, obj);
                  const tmpResult5 = tmp(4817);
                }
              }
              const tmpResult10 = tmp(4818);
              const tmpResult9 = tmp(4817);
              tmpResult6Result = tmpResult9(tmpResult10, tmp(4819), tmp(4820), arg0, arg1, __Configurable__);
              const tmpResult11 = tmp(4819);
            }
            let tmp50 = __Set__;
            if ("[[Configurable]]" in __Configurable__) {
            ...
            const tmpResult14 = tmp(4819);
            const tmpResult15 = tmp(4820);
            ...
            __Set__ = __Set__["[[Set]]"];
            obj1[3] = __Set__;
            tmpResult6Result = tmp(4817)(tmpResult13, tmpResult14, tmpResult15, arg0, arg1, obj1);
            const tmpResult12 = tmp(4817);
          }
        } else {
