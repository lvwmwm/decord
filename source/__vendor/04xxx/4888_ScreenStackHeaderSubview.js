...
// Dependencies: [109, 19, 17, 21, 4889, 4885, 4890, 4891, 4886, 4892]
...
// Module 4888 (ScreenStackHeaderSubview)
import noopDefault from "noop" /* 19 */;
import get_controlledBottomTabsDefault from "get controlledBottomTabs" /* 4886 */;
import context from "context" /* 4889 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 4892 */;
...
const forwardRefResult = noopDefault.forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4885).isHeaderBarButtonsAvailableForCurrentPlatform) {
      let tmpResult = tmp(4890);
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4885).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4886).experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(result1(4891), {});
});
