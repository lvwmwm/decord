...
// Function ID: 4903
// Name: TabsHost
// Dependencies: [32, 109, 19, 17, 21, 4903, 4878, 4904, 4905, 4907]
// Exports: default

// Module 4902 (TabsHost)
...
export default function TabsHost(onNativeFocusChange) {
  let obj = onNativeFocusChange(4903);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4878).experiment.controlledBottomTabs;
  }
