...
// Function ID: 4601
// Name: baseClone
// Dependencies: [603, 596, 4601, 4602, 767, 618, 4603, 4604, 4607, 4611, 4615, 4616, 4617, 772, 4623, 4625, 4627, 789, 4612, 613, 597, 4609]

// Module 4600 (baseClone)
let obj = {};
  ...
  if (!arg2) {
    {
      if (_require(603)(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4601)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4602)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(618)(arr)) {
            return tmp32(4603)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (obj[tmp11]) {
                  tmp14 = tmp32(4617)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4607);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4611)(obj, arr));
                } else {
                  tmp32Result = tmp32(4615);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4616)(obj, arr));
                }
