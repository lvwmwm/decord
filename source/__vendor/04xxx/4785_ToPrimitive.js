...
// Function ID: 4786
// Name: ToPrimitive
// Dependencies: [1417, 4786, 4787, 4788]

// Module 4785 (ToPrimitive)
import apply from "apply" /* 1417 */;
import isPrimitive from "isPrimitive" /* 4786 */;
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4788)(arg0) || tmp(4787)(arg0);
          const tmp15 = tmp(4788)(arg0) || tmp(4787)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
