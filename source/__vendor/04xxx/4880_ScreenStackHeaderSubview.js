...
// Dependencies: [109, 19, 17, 21, 4881, 4877, 4882, 4883, 4878, 4884]
...
// Module 4880 (ScreenStackHeaderSubview)
import noopDefault from "noop" /* 19 */;
import get_controlledBottomTabsDefault from "get controlledBottomTabs" /* 4878 */;
import context from "context" /* 4881 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 4884 */;
...
const forwardRefResult = noopDefault.forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4877).isHeaderBarButtonsAvailableForCurrentPlatform) {
      let tmpResult = tmp(4882);
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4877).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4878).experiment.synchronousHeaderConfigUpdatesEnabled;
