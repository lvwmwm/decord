...
// Function ID: 4206
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4206, 4207, 4209, 4183]
// Exports: RiveView

// Module 4205 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + _mod4206.RiveErrorType[message.type] + "] " + message.message);
}

export const RiveView = function RiveView(arg0) {
  let obj = _require(4207);
  ...
  const tmp18 = jsx(_require(4183).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
