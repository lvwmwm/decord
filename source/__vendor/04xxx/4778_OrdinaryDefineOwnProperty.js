...
// Dependencies: [4715, 541, 4762, 4766, 542, 4779, 562, 4771, 4767, 4780, 4781]

// Module 4778 (OrdinaryDefineOwnProperty)
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (isObject(arg0)) {
    if (tmp(4762)(arg1)) {
      if (tmp(4766)(__Writable__)) {
        if (tmp(542)) {
          const tmp30 = tmp(542)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4767)(tmp30);
          }
          return tmp(4781)(arg0, arg1, tmp(4780)(arg0), __Writable__, tmp31);
        } else if (tmp(4779)(__Writable__)) {
          ...
          return tmp(4771)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
