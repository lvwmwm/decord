...
// Function ID: 4359
// Name: registerHost
// Dependencies: [4359, 4354]

// Module 4358 (registerHost)
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (portalName(4354).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4354).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4354).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4354).ACTIONS.REMOVE_PORTAL === type) {
