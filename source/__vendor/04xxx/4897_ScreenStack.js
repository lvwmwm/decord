...
// Function ID: 4898
// Name: ScreenStack
// Dependencies: [109, 19, 21, 4882, 4898, 4899, 4886]
// Exports: default

// Module 4897 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(ref1(4898).GHContext);
  obj = {
  ...
  ref2(4882)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4882)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4886).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = children;
  obj1[6] = jsx(ref2(4899), {});
  ...
  return jsx(tmp4(4898).RNSScreensRefContext.Provider, { value: ref, children: null });
};
