...
// Dependencies: [4185, 4189]

// Module 4184 (installWorkletsSupport)
import _mod4185 from "module_4185" /* 4185 */;
import getInstalledNitro from "getInstalledNitro" /* 4189 */;
...
arg5.installWorkletsSupport = function installWorkletsSupport() {
  try {
    ...
    obj[3] = fn3;
    const result = _mod4185.registerCustomSerializable(obj);
  } catch (err) {
  }
};
