...
// Function ID: 4236
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4236, 4237, 4239, 4213]
// Exports: RiveView

// Module 4235 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + _mod4236.RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp18 = jsx(_require(4213).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
