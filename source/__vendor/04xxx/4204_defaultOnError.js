...
// Function ID: 4205
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4205, 4206, 4208, 4182]
// Exports: RiveView

// Module 4204 (defaultOnError)
import _mod4205 from "module_4205" /* 4205 */;
...
function defaultOnError(message) {
  return console.error("[" + _mod4205.RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp18 = jsx(_require(4182).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
