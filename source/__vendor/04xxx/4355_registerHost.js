...
// Function ID: 4356
// Name: registerHost
// Dependencies: [4356, 4351]

// Module 4355 (registerHost)
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (portalName(4351).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4351).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4351).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4351).ACTIONS.REMOVE_PORTAL === type) {
