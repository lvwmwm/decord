...
// Function ID: 4855
// Name: TabsHost
// Dependencies: [32, 109, 19, 17, 21, 4855, 4830, 4856, 4857, 4859]
// Exports: default

// Module 4854 (TabsHost)
...
export default function TabsHost(onNativeFocusChange) {
  let obj = onNativeFocusChange(4855);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4830).experiment.controlledBottomTabs;
  }
