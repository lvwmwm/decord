...
// Function ID: 5119
// Name: parseBox
// Dependencies: [5119, 5112, 5109]

// Module 5118 (parseBox)
import getDataView from "getDataView" /* 5109 */;
import parseItemLocationBox from "parseItemLocationBox" /* 5119 */;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(5109).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(5109);
            }
          }
        }
      } else {
