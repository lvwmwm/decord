...
// Function ID: 5222
// Name: constructTag
// Dependencies: [5177, 5193, 5205, 5174, 5181, 5207]

// Module 5221 (constructTag)
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  if (type !== _mod5181.TYPE_TEXT) {
    combined = stringValueFromArray;
    if (0 !== items2.length) {
      const _HermesInternal = HermesInternal;
      combined = "" + stringValueFromArray + " (" + tmp4(5174).getStringValueFromArray(items2) + ")";
      const tmp4Result = tmp4(5174);
    }
  }
  obj = { name: combined, value: stringFromDataView, description: null };
  if (type === _mod5181.TYPE_ITXT) {
    stringFromDataView = module(5207).decode("UTF-8", decompressResult);
    const obj5 = module(5207);
  }
