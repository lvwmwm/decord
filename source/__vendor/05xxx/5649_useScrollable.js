...
// Function ID: 5650
// Name: useScrollable
// Dependencies: [19, 1652, 5634, 5650]
// Exports: useScrollable

// Module 5649 (useScrollable)
...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(_require(5634).SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = _require(1652).useSharedValue(0);
  const obj2 = _require(1652);
  const sharedValue2 = _require(1652).useSharedValue(_require(5634).SCROLLABLE_STATE.UNDETERMINED);
  const obj3 = _require(1652);
  const sharedValue3 = _require(1652).useSharedValue(false);
