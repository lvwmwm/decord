...
// Function ID: 5167
// Name: parseBox
// Dependencies: [5167, 5160, 5157]

// Module 5166 (parseBox)
import getDataView from "getDataView" /* 5157 */;
import parseItemLocationBox from "parseItemLocationBox" /* 5167 */;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(5157).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(5157);
            }
          }
        }
      } else {
