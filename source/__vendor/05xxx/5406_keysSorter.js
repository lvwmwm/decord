...
// Function ID: 5407
// Name: keysSorter
// Dependencies: [5407, 5408, 1556]

// Module 5406 (keysSorter)
const require = arg1;
...
arg5.stringify = (arg0, arg1) => {
  let _require = arg0;
  dependencyMap = arg1;
  const tmp = _require(5408)({ encode: true, strict: true, arrayFormat: "none" }, arg1);
  dependencyMap = tmp;
  _require = tmp;
  ...
  if ("index" === arrayFormat) {
    let fn = (arg0, arg1, arg2) => {
      if (null === arg1) {
        if (!lib.encode) {
          ...
          let encodeURIComponentResult = lib(5407)(arg0);
        } else {
    ...
    fn = "bracket" === arrayFormat ? ((arg0, arg1) => {
      if (null === arg1) {
        ...
        let encodeURIComponentResult2 = lib(5407)(arg0);
      } else {
        const _encodeURIComponent = encodeURIComponent;
      ...
      if (undefined === lib[arg0]) {
        ...
        if (Array.isArray(arr)) {
          ...
          if (!tmp.encode) {
            ...
            let encodeURIComponentResult1 = lib(5407)(arr);
          } else {
            const _encodeURIComponent2 = encodeURIComponent;
