...
// Function ID: 5488
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1500, 5479, 5488, 5489]
// Exports: Button

// Module 5487 (ButtonLink)
import noopAll from "noop" /* 19 */;
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1500 */;
import ColorDefault from "Color" /* 5479 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj10.isDark()) {
      const obj2 = tmp9(5479)(color);
      str4 = tmp9(5479)(color).darken(0.71).string();
      const darkenResult = tmp9(5479)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
