...
obj = { name: "XResolution", description: require("module_5180").XResolution };
obj[282] = obj;
obj = { name: "YResolution", description: require("module_5180").YResolution };
obj[283] = obj;
obj[286] = {
  name: "XPosition",
  description(arg0) {
...
obj[296] = { name: "ResolutionUnit", description: require("module_5180").ResolutionUnit };
obj[318] = {
  name: "WhitePoint",
  description(arr) {
...
const obj1 = { name: "ResolutionUnit", description: require("module_5180").ResolutionUnit };
obj[50778] = { name: "CalibrationIlluminant1", description: require("module_5180").LightSource };
const obj2 = { name: "CalibrationIlluminant1", description: require("module_5180").LightSource };
obj[50779] = { name: "CalibrationIlluminant2", description: require("module_5180").LightSource };
obj[50941] = {
