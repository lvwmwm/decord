...
// Dependencies: [5815, 5816, 5820, 5821]

// Module 5814 (RenderTimeTracker)
...
const items = [
  {
    ...
    value: function startTracking() {
      ...
      let trackAverageRenderTimeForOffsetProjection = RenderTimeTracker(5821).PlatformConfig.trackAverageRenderTimeForOffsetProjection;
  ...
  },
  {
    ...
    value: function getAverageRenderTime() {
      const self = this;
      if (RenderTimeTracker(5821).PlatformConfig.trackAverageRenderTimeForOffsetProjection) {
        const _Math = Math;
        const _Math2 = Math;
        const _Math3 = Math;
