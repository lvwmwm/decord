...
// Function ID: 5719
// Name: items2
// Dependencies: [5719, 5721, 5722, 5723, 5724, 5725, 5726]

// Module 5718 (items2)
import ComposedGestureName from "ComposedGestureName" /* 5719 */;
import set6 from "set" /* 5721 */;
import set7 from "set" /* 5722 */;
import set8 from "set" /* 5723 */;
import set9 from "set" /* 5724 */;
import set10 from "set" /* 5725 */;
import set11 from "set" /* 5726 */;
