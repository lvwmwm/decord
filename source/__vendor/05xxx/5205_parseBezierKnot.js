...
// Dependencies: [32, 5165, 5182]

// Module 5205 (parseBezierKnot)
...
obj = {
  ...
  path(dataView, sum) {
    const items = [_modDef5182.getShortAt(dataView, sum)];
    return items;
  }
};
let closure_4 = {
  ...
  [obj.CLIPBOARD]: {
    ...
    path: function parseClipboard(dataView, sum) {
      const longAt = _modDef5182.getLongAt(dataView, sum);
      let num = -1;
      let num2 = -1;
      if (longAt >>> 31 === 0) {
        num2 = 1;
      }
      const obj = _modDef5182;
      ...
      let tmp4Result = tmp4(5165);
      const obj4 = getDataView;
      tmp4Result = tmp4(5165);
      ...
      const longAt3 = _modDef5182.getLongAt(dataView, sum2);
      let num5 = num;
      if (longAt3 >>> 31 === 0) {
        num5 = 1;
      }
      const tmpResult1 = _modDef5182;
      ...
      const longAt4 = _modDef5182.getLongAt(dataView, sum3);
      if (longAt4 >>> 31 === 0) {
        num = 1;
      }
      const tmpResult2 = _modDef5182;
