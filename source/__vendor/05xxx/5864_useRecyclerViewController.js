...
// Dependencies: [5865, 5822, 19, 17, 5866, 5867, 5837, 5868, 5862]
// Exports: useRecyclerViewController

// Module 5864 (useRecyclerViewController)
import closure_2 from "asyncGeneratorStep" /* 5865 */;
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  dependencyMap = arg2;
  closure_2 = arg3;
  const unmountFlag = _require(5866).useUnmountFlag();
  let obj = _require(5866);
  ...
  _setTimeout = _require(5867).useUnmountAwareTimeout().setTimeout;
