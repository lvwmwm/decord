...
// Dependencies: [32, 19, 17, 21, 1499, 5540, 5511, 5541, 5512, 5545]
// Exports: HeaderBackButton

// Module 5539 (HeaderBackButton)
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1499 */;
import registerAssetDefault from "registerAsset" /* 5511 */;
import HeaderButton from "HeaderButton" /* 5545 */;
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(5540).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(5540).ICON_MARGIN);
      }
    }
