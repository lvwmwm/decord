...
// Function ID: 5165
// Name: load
// Dependencies: [5165, 5166, 5167, 5168, 5169, 5182, 5184, 5185, 5197, 5201, 5205, 5207, 5209, 5210, 5211, 5212, 5213, 5214, 5215, 5216, 5217, 5218, 5191]
// Exports: load

// Module 5164 (load)
import errorDefault from "error" /* 5165 */;
  ...
  if (typeof response === "string") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(5166).dataUriToBuffer(response));
        const obj5 = response(5166);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
