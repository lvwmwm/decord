...
// Function ID: 5184
// Name: parseBox
// Dependencies: [5184, 5177, 5174]

// Module 5183 (parseBox)
import getDataView from "getDataView" /* 5174 */;
import parseItemLocationBox from "parseItemLocationBox" /* 5184 */;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(5174).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(5174);
            }
          }
        }
      } else {
