...
// Function ID: 5869
// Name: JSFPSMonitor
// Dependencies: [5815, 5816, 5803, 5869]

// Module 5868 (JSFPSMonitor)
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        error = new Error(JSFPSMonitor(5803).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      const obj = { minFPS: JSFPSMonitor(5869).roundToDecimalPlaces(self.minFPS, 1), maxFPS: null, averageFPS: null };
      const obj2 = JSFPSMonitor(5869);
      obj[1] = JSFPSMonitor(5869).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(5869);
      obj[2] = JSFPSMonitor(5869).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    }
  }
];
