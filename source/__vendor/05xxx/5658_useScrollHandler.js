...
// Dependencies: [5659, 1652, 5649]

// Module 5658 (useScrollHandler)
const require = arg1;
...
arg5.useScrollHandler = (arg0, onScroll, onScrollBeginDrag, onScrollEndDrag) => {
  ...
  if (arg0 === undefined) {
    useScrollEventsHandlersDefault = _require(5659).useScrollEventsHandlersDefault;
  }
  _require = onScroll;
  ...
  obj1 = { handleOnScroll: workletNoop, onScroll, runOnJS: tmp3(1652).runOnJS };
  fn.__closure = obj1;
  ...
  const tmp3Result = _require(1652);
  fn2.__closure = { handleOnBeginDrag: workletNoop2, onScrollBeginDrag, runOnJS: _require(1652).runOnJS };
  ...
  const obj2 = { handleOnBeginDrag: workletNoop2, onScrollBeginDrag, runOnJS: _require(1652).runOnJS };
  O.__closure = { handleOnEndDrag: workletNoop3, onScrollEndDrag, runOnJS: _require(1652).runOnJS };
