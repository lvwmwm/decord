...
function create(handlerTag) {
  ...
  obj = { wrappedSetGestureState: fn, handlerTag, State: _require(5666).State };
  fn.__closure = obj;
  ...
  S.__closure = { wrappedSetGestureState: fn, handlerTag, State: _require(5666).State };
  ...
  obj1 = { wrappedSetGestureState: fn, handlerTag, State: _require(5666).State };
  fn3.__closure = { wrappedSetGestureState: fn, handlerTag, State: _require(5666).State };
  fn3.__workletHash = 6198601582791;
  fn3.__initData = closure_6;
  obj[4] = fn3;
  return obj;
}
obj = { wrappedSetGestureState: fn, State: require("module_5666").State };
