...
// Function ID: 5175
// Name: parseBox
// Dependencies: [5175, 5168, 5165]

// Module 5174 (parseBox)
import getDataView from "getDataView" /* 5165 */;
import parseItemLocationBox from "parseItemLocationBox" /* 5175 */;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(5165).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(5165);
            }
          }
        }
      } else {
