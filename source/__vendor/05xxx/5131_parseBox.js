...
// Function ID: 5132
// Name: parseBox
// Dependencies: [5132, 5125, 5122]

// Module 5131 (parseBox)
import getDataView from "getDataView" /* 5122 */;
import parseItemLocationBox from "parseItemLocationBox" /* 5132 */;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(5122).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(5122);
            }
          }
        }
      } else {
