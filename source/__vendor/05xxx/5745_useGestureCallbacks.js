...
// Dependencies: [5729, 5746, 5704, 5748]

// Module 5745 (useGestureCallbacks)
import isGestureEnabled from "isGestureEnabled" /* 5729 */;
import useGestureEventHandler from "useGestureEventHandler" /* 5746 */;
...
arg5.useGestureCallbacks = function useGestureCallbacks(handlerTag, disableReanimated) {
  ...
  if (!disableReanimated.disableReanimated) {
    const Reanimated = tmp(5704).Reanimated;
    let handler;
    if (Reanimated != null) {
      handler = Reanimated.useHandler(memoizedGestureCallbacks);
    }
    const tmpResult = tmp(5748);
