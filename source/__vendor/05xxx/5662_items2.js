...
// Function ID: 5663
// Name: items2
// Dependencies: [5663, 5665, 5666, 5667, 5668, 5669, 5670]

// Module 5662 (items2)
import ComposedGestureName from "ComposedGestureName" /* 5663 */;
import set6 from "set" /* 5665 */;
import set7 from "set" /* 5666 */;
import set8 from "set" /* 5667 */;
import set9 from "set" /* 5668 */;
import set10 from "set" /* 5669 */;
import set11 from "set" /* 5670 */;
