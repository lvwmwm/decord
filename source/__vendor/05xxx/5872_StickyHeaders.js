...
// Function ID: 5873
// Name: StickyHeaders
// Dependencies: [5819, 19, 21, 5869, 5873, 5834]
// Exports: StickyHeaders

// Module 5872 (StickyHeaders)
...
export const StickyHeaders = (stickyHeaderIndices) => {
  ...
  tmp3Result = tmp3(() => {
    ...
    if (-1 !== currentStickyIndex) {
      tmpResult = null;
      if (tmp4 < data.length) {
        obj1 = { index: null, item: null, renderItem: null, layout: null, refHolder: null, extraData: null, trailingItem: "accessibilityRole", target: "y", hidden: "LanternSpotIllustration", inverted: "getScreens" };
        obj1[0] = tmp4;
        obj1[1] = tmp6[tmp4];
        obj1[2] = renderItem;
