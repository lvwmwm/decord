...
// Dependencies: [32, 19, 17, 21, 5695, 5622, 5697, 5684, 5693, 5692, 5671]
// Exports: VirtualDetector

// Module 5696 (VirtualDetector)
    ...
    callback(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: null, handlerTags: null, methods: null, viewRef: "a", userSelect: "ger", touchAction: "\u00EEnfofolit", enableContextMenu: "m\u00E2n\u0103" };
          obj[0] = tmp;
          obj[1] = closure_7;
