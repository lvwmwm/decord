...
// Function ID: 5606
// Name: useScrollable
// Dependencies: [19, 1654, 5590, 5606]
// Exports: useScrollable

// Module 5605 (useScrollable)
...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(_require(5590).SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = _require(1654).useSharedValue(0);
  const obj2 = _require(1654);
  const sharedValue2 = _require(1654).useSharedValue(_require(5590).SCROLLABLE_STATE.UNDETERMINED);
