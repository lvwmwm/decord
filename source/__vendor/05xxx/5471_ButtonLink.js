...
// Function ID: 5472
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1501, 5463, 5472, 5473]
// Exports: Button

// Module 5471 (ButtonLink)
import noopAll from "noop" /* 19 */;
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1501 */;
import ColorDefault from "Color" /* 5463 */;
import Animated from "Animated" /* 5472 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj10.isDark()) {
      const obj2 = tmp9(5463)(color);
      str4 = tmp9(5463)(color).darken(0.71).string();
      const darkenResult = tmp9(5463)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
