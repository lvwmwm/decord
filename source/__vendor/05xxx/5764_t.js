...
const fn2 = function _(arg0) {
  const ACTIVE = _mod5658.State.ACTIVE;
...
obj = { setGestureState: fn, State: require("module_5658").State };
fn2.__closure = obj;
...
const fn3 = function n(arg0) {
  const FAILED = _mod5658.State.FAILED;
  if (typeof fn !== "function") {
    HermesBuiltin.throwTypeError();
  }
  const _globalThis = globalThis;
...
fn3.__closure = { setGestureState: fn, State: require("module_5658").State };
...
const obj1 = { setGestureState: fn, State: require("module_5658").State };
fn4.__closure = { setGestureState: fn, State: require("module_5658").State };
