...
// Function ID: 5121
// Name: load
// Dependencies: [5121, 5122, 5123, 5124, 5125, 5138, 5140, 5141, 5153, 5157, 5161, 5163, 5165, 5166, 5167, 5168, 5169, 5170, 5171, 5172, 5173, 5174, 5147]
// Exports: load

// Module 5120 (load)
import errorDefault from "error" /* 5121 */;
  ...
  if (typeof response === "string") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(5122).dataUriToBuffer(response));
        const obj5 = response(5122);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
