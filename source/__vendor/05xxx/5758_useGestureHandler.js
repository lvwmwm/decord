...
// Dependencies: [1654, 5617, 5590]

// Module 5758 (useGestureHandler)
const require = arg1;
...
arg5.useGestureHandler = (source, state, gestureSource, onStart, onChange, onEnd, onFinalize) => {
  ...
  obj = { state, State: _require(5617).State, gestureSource, source, onStart };
  R.__closure = obj;
  ...
  obj = { gestureSource, source, state, GESTURE_SOURCE: _require(5590).GESTURE_SOURCE, onEnd };
  C.__closure = obj;
  ...
  obj1 = { gestureSource, source, state, GESTURE_SOURCE: _require(5590).GESTURE_SOURCE, onFinalize };
  T.__closure = obj1;
