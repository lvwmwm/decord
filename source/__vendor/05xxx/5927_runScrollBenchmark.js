...
// Dependencies: [5905, 5862, 19, 5923, 5859, 5924, 5922]
// Exports: useFlatListBenchmark

// Module 5927 (runScrollBenchmark)
import closure_2 from "asyncGeneratorStep" /* 5905 */;
import closure_3 from "_slicedToArray" /* 5862 */;
          ...
          try {
            ...
            if (0 === c2) {
              if (arg0 === 1) {
                ...
                c2 = undefined;
                jSFPSMonitor = new callback(5924).JSFPSMonitor();
