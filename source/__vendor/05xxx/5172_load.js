...
// Function ID: 5173
// Name: load
// Dependencies: [5173, 5174, 5175, 5176, 5177, 5190, 5192, 5193, 5205, 5209, 5213, 5215, 5217, 5218, 5219, 5220, 5221, 5222, 5223, 5224, 5225, 5226, 5199]
// Exports: load

// Module 5172 (load)
import errorDefault from "error" /* 5173 */;
  ...
  if (typeof response === "string") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(5174).dataUriToBuffer(response));
        const obj5 = response(5174);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
