...
// Function ID: 5485
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1501, 5476, 5485, 5486]
// Exports: Button

// Module 5484 (ButtonLink)
import noopAll from "noop" /* 19 */;
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1501 */;
import ColorDefault from "Color" /* 5476 */;
import Animated from "Animated" /* 5485 */;
import Text from "Text" /* 5486 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj10.isDark()) {
      const obj2 = tmp9(5476)(color);
      str4 = tmp9(5476)(color).darken(0.71).string();
      const darkenResult = tmp9(5476)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
