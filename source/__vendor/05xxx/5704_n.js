...
let Reanimated = _mod5660.Reanimated;
let mutable;
if (Reanimated != null) {
...
export const useReanimatedEventHandler = function useReanimatedEventHandler(handlerTag, memoizedGestureCallbacks, handler, changeEventCalculator, fillInDefaultValues) {
  ...
  fn.__closure = { lastUpdateEventMap: mutable, eventHandler: _require(5703).eventHandler, handlerTag, workletizedHandlers: tmp, changeEventCalculator, fillInDefaultValues };
  ...
  let Reanimated = _require(5660).Reanimated;
  let event;
  if (Reanimated != null) {
