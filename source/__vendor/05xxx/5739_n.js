...
let Reanimated = _mod5695.Reanimated;
let mutable;
if (Reanimated != null) {
...
export const useReanimatedEventHandler = function useReanimatedEventHandler(handlerTag, memoizedGestureCallbacks, handler, changeEventCalculator, fillInDefaultValues) {
  ...
  fn.__closure = { lastUpdateEventMap: mutable, eventHandler: _require(5738).eventHandler, handlerTag, workletizedHandlers: tmp, changeEventCalculator, fillInDefaultValues };
  ...
  let Reanimated = _require(5695).Reanimated;
  let event;
  if (Reanimated != null) {
