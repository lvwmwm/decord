...
// Function ID: 5216
// Name: parseTags
// Dependencies: [5174, 5216]

// Module 5215 (parseTags)
...
function parseTags(buffer) {
  ...
  if (buffer.byteLength !== buffer.getUint32()) {
    ...
    const keys = Object.keys(_mod5216.iccProfile);
    for (let num = 0; num < keys.length; num = num + 1) {
      let tmp = keys[num];
      let tmp2 = require;
      let tmp3 = dependencyMap;
      let iter = _mod5216.iccProfile[tmp];
            ...
            if (uint321 > buffer.length) {
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (uint323 > uint322) {
                  ...
                  if (tmp55(5216).iccTags[stringFromDataView]) {
                    obj = { value: null, description: null };
                    obj[0] = applyResult;
                    obj[1] = applyResult;
                    obj[tmp55(5216).iccTags[stringFromDataView].name] = obj;
                  } else {
                ...
                if (stringFromDataView1 === mluc) {
                  ...
                  if (1 === uint324) {
                    text = items[0].text;
                    if (tmp25(5216).iccTags[stringFromDataView]) {
                      let obj3 = { value: null, description: null };
                      obj3[0] = text;
                      obj3[1] = text;
                      obj[tmp25(5216).iccTags[stringFromDataView].name] = obj3;
                    } else {
                    ...
                    if (_mod5216.iccTags[stringFromDataView]) {
                      obj6 = { value: null, description: null };
                      obj6[0] = obj5;
                      obj6[1] = obj5;
                      obj[tmp33(5216).iccTags[stringFromDataView].name] = obj6;
                    } else {
                  ...
                  if (stringFromDataView1 === text) {
                    ...
                    if (tmp55(5216).iccTags[stringFromDataView]) {
                      ...
                      obj8[0] = applyResult1;
                      obj8[1] = applyResult1;
                      obj[tmp55(5216).iccTags[stringFromDataView].name] = obj8;
                    } else {
                    ...
                    if (stringFromDataView1 === c7) {
                      ...
                      if (tmp55(5216).iccTags[stringFromDataView]) {
                        ...
                        obj[tmp55(5216).iccTags[stringFromDataView].name] = obj10;
                      } else {
