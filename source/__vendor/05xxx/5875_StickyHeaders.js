...
// Function ID: 5876
// Name: StickyHeaders
// Dependencies: [5822, 19, 21, 5872, 5876, 5837]
// Exports: StickyHeaders

// Module 5875 (StickyHeaders)
...
export const StickyHeaders = (stickyHeaderIndices) => {
  ...
  tmp3Result = tmp3(() => {
    ...
    if (-1 !== currentStickyIndex) {
      tmpResult = null;
      if (tmp4 < data.length) {
        obj1 = { index: null, item: null, renderItem: null, layout: null, refHolder: null, extraData: null, trailingItem: "accessibilityLabel", target: false, hidden: false, inverted: false };
        obj1[0] = tmp4;
        obj1[1] = tmp6[tmp4];
        obj1[2] = renderItem;
