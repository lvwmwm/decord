...
// Function ID: 5711
// Name: items2
// Dependencies: [5711, 5713, 5714, 5715, 5716, 5717, 5718]

// Module 5710 (items2)
import ComposedGestureName from "ComposedGestureName" /* 5711 */;
import set6 from "set" /* 5713 */;
import set7 from "set" /* 5714 */;
import set8 from "set" /* 5715 */;
import set9 from "set" /* 5716 */;
import set10 from "set" /* 5717 */;
import set11 from "set" /* 5718 */;
