...
let Reanimated = _mod5647.Reanimated;
let mutable;
if (Reanimated != null) {
...
export const useReanimatedEventHandler = function useReanimatedEventHandler(handlerTag, memoizedGestureCallbacks, handler, changeEventCalculator, fillInDefaultValues) {
  ...
  fn.__closure = { lastUpdateEventMap: mutable, eventHandler: _require(5690).eventHandler, handlerTag, workletizedHandlers: tmp, changeEventCalculator, fillInDefaultValues };
