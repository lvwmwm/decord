...
// Dependencies: [5600, 1653, 5593, 5620]

// Module 5619 (useScrollEventsHandlersDefault)
const require = arg1;
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj = { animatedSheetState, SHEET_STATE: _require(5593).SHEET_STATE, animatedHandleGestureState, State: _require(5620).State, animatedScrollableState, SCROLLABLE_STATE: _require(5593).SCROLLABLE_STATE, isLockingScroll: sharedValue1, scrollTo: _require(1653).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue };
  E.__closure = obj;
  ...
  obj1 = { scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, rootScrollableContentOffsetY: animatedScrollableContentOffsetY, animatedSheetState, SHEET_STATE: _require(5593).SHEET_STATE };
  O.__closure = obj1;
  ...
  obj2 = { animatedScrollableState, SCROLLABLE_STATE: _require(5593).SCROLLABLE_STATE, isLockingScroll: sharedValue1, scrollTo: _require(1653).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5593).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
  fn2.__closure = obj2;
