...
// Dependencies: [32, 19, 17, 21, 1499, 5541, 5512, 5542, 5513, 5546]
// Exports: HeaderBackButton

// Module 5540 (HeaderBackButton)
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1499 */;
import registerAssetDefault from "registerAsset" /* 5512 */;
import HeaderButton from "HeaderButton" /* 5546 */;
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(5541).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(5541).ICON_MARGIN);
      }
    }
