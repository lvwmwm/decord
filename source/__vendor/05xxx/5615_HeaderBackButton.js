...
// Dependencies: [32, 19, 17, 21, 1499, 5616, 5587, 5617, 5588, 5621]
// Exports: HeaderBackButton

// Module 5615 (HeaderBackButton)
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1499 */;
import registerAssetDefault from "registerAsset" /* 5587 */;
import HeaderButton from "HeaderButton" /* 5621 */;
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(5616).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(5616).ICON_MARGIN);
      }
    }
