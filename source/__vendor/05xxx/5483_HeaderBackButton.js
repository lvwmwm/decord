...
// Dependencies: [32, 19, 17, 21, 1501, 5484, 5455, 5485, 5456, 5489]
// Exports: HeaderBackButton

// Module 5483 (HeaderBackButton)
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1501 */;
import registerAssetDefault from "registerAsset" /* 5455 */;
import HeaderButton from "HeaderButton" /* 5489 */;
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(5484).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(5484).ICON_MARGIN);
      }
    }
