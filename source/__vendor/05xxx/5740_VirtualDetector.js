...
// Dependencies: [32, 19, 17, 21, 5739, 5666, 5741, 5728, 5737, 5736, 5715]
// Exports: VirtualDetector

// Module 5740 (VirtualDetector)
    ...
    callback(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: null, handlerTags: null, methods: null, viewRef: "a", userSelect: "h\u00F6ga hus", touchAction: "skyskrapa", enableContextMenu: "stadsbild" };
          obj[0] = tmp;
          obj[1] = closure_7;
