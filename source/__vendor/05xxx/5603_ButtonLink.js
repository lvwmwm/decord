...
// Function ID: 5604
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1499, 5595, 5604, 5605]
// Exports: Button

// Module 5603 (ButtonLink)
import noopAll from "noop" /* 19 */;
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1499 */;
import ColorDefault from "Color" /* 5595 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj10.isDark()) {
      const obj2 = tmp9(5595)(color);
      str4 = tmp9(5595)(color).darken(0.71).string();
      const darkenResult = tmp9(5595)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
