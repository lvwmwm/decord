...
// Function ID: 5146
// Name: detectFile
// Dependencies: [5146, 5147]

// Module 5145 (detectFile)
...
arg5.detectFile = function detectFile(uint8Array, chunkSize) {
  ...
  if (0 !== fileChunk.length) {
    const items = [];
    const items1 = [];
    for (const key10027 in _mod5147.FileTypes) {
      let tmp22 = key10027;
      let _Object4 = Object;
      let call2 = hasOwnProperty2.call;
      let tmp23 = require;
      let tmp24 = dependencyMap;
      let FileTypes5 = _mod5147.FileTypes;
