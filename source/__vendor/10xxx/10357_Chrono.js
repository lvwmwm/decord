...
// Function ID: 10358
// Name: Chrono
// Dependencies: [41, 42, 10358, 10364]
...
obj = {
  ...
  value: function executeParser(closure_0, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof index(10364).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10364).ParsingComponents)) {
...
obj = {
  ...
  value: function createParsingComponents(extractResult) {
    ...
    if (!(extractResult instanceof ParsingContext(10364).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10364).ParsingComponents(this.reference, extractResult);
    }
...
const items2 = [
  obj,
  {
    ...
    value: function createParsingResult(index, length2, extractResult, extractResult) {
      ...
      return new ParsingContext(10364).ParsingResult(self.reference, index, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
