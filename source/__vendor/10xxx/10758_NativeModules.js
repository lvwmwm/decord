...
// Function ID: 10759
// Name: NativeModules
// Dependencies: [5, 17, 10759, 10760, 10765, 10766, 10767, 10768, 10769]
...
// Module 10758 (NativeModules)
import _mod10760 from "module_10760" /* 10760 */;
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 10766 */;
import NativeModulesAll from "NativeModules" /* 10767 */;
import fetchJsonOrThrowAll from "fetchJsonOrThrow" /* 10768 */;
import syncAll from "sync" /* 10769 */;
...
const subs = require("module_10759").ProductType.subs;
const inapp = require("module_10759").ProductType.inapp;
...
export const isIosStorekit2 = require("module_10760").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod10760.storekit1Mode();
    const obj4 = _mod10760;
  } else if ("STOREKIT2_MODE" === str) {
    _mod10760.storekit2Mode();
    const obj3 = _mod10760;
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod10760.storekitHybridMode();
    const obj2 = _mod10760;
  }
};
export const initConnection = () => {
  const nativeModule = _mod10760.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod10760.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      closure_1 = tmp5;
      closure_0 = tmp2;
      const obj3 = closure_1_0(10760);
      const androidModule = obj3.getAndroidModule();
      yield androidModule.getItemsByType(closure_1_7, closure_1_0);
      closure_0 = arg1.map(closure_1_0(10765).singleProductAndroidMap);
      const obj = closure_1_0(10760);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      ...
      androidModuleType = closure_1_0(10760).getAndroidModuleType();
      const obj10 = closure_1_0(10760);
      const androidModule = closure_1_0(10760).getAndroidModule();
      closure_1 = yield androidModule.getItemsByType(closure_1_6, closure_1_0);
      if ("android" === closure_1_0) {
        return closure_1_8(closure_1, closure_1_0(10759).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp35) {
        const _Error = Error;
      ...
      const obj2 = closure_1_0(10760);
      dependencyMap = yield obj2.fillProductsWithAdditionalData(dependencyMap);
      return closure_1_8(dependencyMap, closure_1_0(10759).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
