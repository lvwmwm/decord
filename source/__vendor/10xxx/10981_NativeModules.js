...
// Function ID: 10982
// Name: NativeModules
// Dependencies: [5, 17, 10982, 10983, 10988, 10989, 10990, 10991, 10992]
...
// Module 10981 (NativeModules)
import _mod10983 from "module_10983" /* 10983 */;
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 10989 */;
import NativeModulesAll from "NativeModules" /* 10990 */;
import fetchJsonOrThrowAll from "fetchJsonOrThrow" /* 10991 */;
import syncAll from "sync" /* 10992 */;
...
const subs = require("module_10982").ProductType.subs;
const inapp = require("module_10982").ProductType.inapp;
...
export const isIosStorekit2 = require("module_10983").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod10983.storekit1Mode();
    const obj4 = _mod10983;
  } else if ("STOREKIT2_MODE" === str) {
    _mod10983.storekit2Mode();
    const obj3 = _mod10983;
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod10983.storekitHybridMode();
    const obj2 = _mod10983;
  }
};
export const initConnection = () => {
  const nativeModule = _mod10983.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod10983.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      closure_1 = tmp5;
      closure_0 = tmp2;
      const obj3 = closure_1_0(10983);
      const androidModule = obj3.getAndroidModule();
      yield androidModule.getItemsByType(closure_1_7, closure_1_0);
      closure_0 = arg1.map(closure_1_0(10988).singleProductAndroidMap);
      const obj = closure_1_0(10983);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      ...
      androidModuleType = closure_1_0(10983).getAndroidModuleType();
      const obj10 = closure_1_0(10983);
      const androidModule = closure_1_0(10983).getAndroidModule();
      closure_1 = yield androidModule.getItemsByType(closure_1_6, closure_1_0);
      if ("android" === closure_1_0) {
        return closure_1_8(closure_1, closure_1_0(10982).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp35) {
        const _Error = Error;
      ...
      const obj2 = closure_1_0(10983);
      dependencyMap = yield obj2.fillProductsWithAdditionalData(dependencyMap);
      return closure_1_8(dependencyMap, closure_1_0(10982).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
