...
closure_0 = importDefaultResult((arg0) => {
  ...
  const iter = (function*(arg0) {
    ...
    yield closure_1_3.getPackageName();
...
export const getInstallSourceAndroid = () => {
  const InstallSourceAndroid = callback(10797).InstallSourceAndroid;
