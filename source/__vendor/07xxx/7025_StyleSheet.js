...
// Module 7025 (StyleSheet)
import closure_3 from "_slicedToArray" /* 32 */;
import closure_4 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import jsxProd from "jsxProd" /* 21 */;
import getShadowStyle from "getShadowStyle" /* 7030 */;
...
export const Card = function Card(shadowEnabled) {
  ...
  if (typeof backgroundColor === "string") {
    ...
    const obj12 = tmp5(5640)(backgroundColor);
  }
  ...
  const items13 = [tmp27, gesture(flag2(7029).CardContent, { enabled: pageOverflowEnabled, layout, style: contentStyle, children })];
  obj5[3] = items13;
  obj4.children = layout(closing.View, obj5);
  obj3[2] = gesture(flag2(7005).PanGestureHandler, obj4);
  items5[2] = gesture(closing.View, obj3);
  obj[1] = items5;
  return layout(flag2(7027).CardAnimationContext.Provider, obj);
};
