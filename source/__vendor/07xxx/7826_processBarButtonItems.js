...
// Dependencies: [32, 109, 17, 21, 5511, 1500, 7827, 5502, 4865]
// Exports: useHeaderConfigProps

// Module 7826 (processBarButtonItems)
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      ...
      if (typeof headerTitle === "function") {
        ...
        obj9[1] = obj;
        obj9[2] = headerTitle;
        obj8[1] = tmp63(tmp(5502).HeaderTitle, obj9);
      }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      obj10[1] = obj;
      obj10[2] = headerTitle;
      headerTitleResult = tmp39(tmp(5502).HeaderTitle, obj10);
    }
