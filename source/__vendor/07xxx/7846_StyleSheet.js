...
// Function ID: 7847
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1499, 1630, 5586, 7847, 4873, 7848, 7850, 7851, 7852, 7853]
// Exports: NativeStackView

// Module 7846 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5586).HeaderShownContext);
  let num5 = React.useContext(num6(5586).HeaderHeightContext);
  const context1 = React.useContext(num6(5586).HeaderBackContext);
  let obj3 = num6(5586);
  ...
  callback = obj2.useCallback(num6(7847).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4873).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4873).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5586).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5586);
  ...
  let eventResult;
  const headerConfigProps = num6(7848).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  const tmp8Result3 = num6(7848);
  obj15[1] = closure_10(num6(5586).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(5586).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = tmp38(num6(5586).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(7850).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4873).ScreenStackItem, obj4);
