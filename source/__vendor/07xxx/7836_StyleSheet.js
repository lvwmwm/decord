...
// Function ID: 7837
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1499, 1630, 5511, 7837, 4866, 7838, 7840, 7841, 7842, 7843]
// Exports: NativeStackView

// Module 7836 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5511).HeaderShownContext);
  let num5 = React.useContext(num6(5511).HeaderHeightContext);
  const context1 = React.useContext(num6(5511).HeaderBackContext);
  let obj3 = num6(5511);
  ...
  callback = obj2.useCallback(num6(7837).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4866).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4866).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5511).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5511);
  ...
  let eventResult;
  const headerConfigProps = num6(7838).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  const tmp8Result3 = num6(7838);
  obj15[1] = closure_10(num6(5511).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(5511).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = tmp38(num6(5511).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(7840).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4866).ScreenStackItem, obj4);
  return closure_10(num6(1499).NavigationProvider, obj3);
}
