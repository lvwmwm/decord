...
// Function ID: 7758
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1501, 1632, 5454, 7758, 4817, 7759, 7761, 7762, 7763, 7764]
// Exports: NativeStackView

// Module 7757 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5454).HeaderShownContext);
  let num5 = React.useContext(num6(5454).HeaderHeightContext);
  const context1 = React.useContext(num6(5454).HeaderBackContext);
  let obj3 = num6(5454);
  ...
  callback = obj2.useCallback(num6(7758).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4817).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4817).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5454).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5454);
  ...
  let eventResult;
  const headerConfigProps = num6(7759).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  const tmp8Result3 = num6(7759);
  obj15[1] = closure_10(num6(5454).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(5454).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = tmp38(num6(5454).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(7761).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4817).ScreenStackItem, obj4);
