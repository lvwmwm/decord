...
// Dependencies: [32, 109, 17, 21, 5479, 1500, 7795, 5470, 4833]
// Exports: useHeaderConfigProps

// Module 7794 (processBarButtonItems)
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  const isSearchBarAvailableForCurrentPlatform = tmp(4833).isSearchBarAvailableForCurrentPlatform;
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = tmp(4833).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      items5[1] = null;
      obj6[1] = items5;
      let tmp33Result = tmp33(tmp(4833).ScreenStackHeaderLeftView, obj6);
    } else {
      if (typeof headerTitle === "function") {
        ...
        obj9[1] = obj;
        obj9[2] = headerTitle;
        obj8[1] = tmp63(tmp(5470).HeaderTitle, obj9);
      }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      obj10[1] = obj;
      obj10[2] = headerTitle;
      headerTitleResult = tmp39(tmp(5470).HeaderTitle, obj10);
    }
    const obj11 = { children: null };
    obj11[0] = headerTitleResult;
    tmp39Result = tmp39(tmp(4833).ScreenStackHeaderCenterView, obj11);
  }
  ...
  if (undefined !== headerBackIcon) {
    ...
    obj12[0] = source;
    let tmp41Result = callback3(tmp(4833).ScreenStackHeaderBackButtonImage, obj12);
  ...
  if (null != headerRightResult) {
    ...
    tmp43 = callback3(tmp(4833).ScreenStackHeaderRightView, obj13);
  }
  items7[2] = tmp43;
  let tmp45 = null;
  if (isSearchBarAvailableForCurrentPlatform2) {
    ...
    obj14[0] = callback3(tmp(4833).SearchBar, obj15);
    tmp45 = callback3(tmp(4833).ScreenStackHeaderSearchBarView, obj14);
  }
  items7[3] = tmp45;
  const obj16 = { backButtonInCustomView: tmp24, backgroundColor, backTitle: headerBackTitle, backTitleVisible: "minimal" !== headerBackButtonDisplayMode, backButtonDisplayMode: "fill", backTitleFontFamily: true, backTitleFontSize: true, blurEffect: true, color: true, direction: true, disableBackButtonMenu: true, hidden: true, hideBackButton: true, hideShadow: true, largeTitle: true, largeTitleBackgroundColor: true, largeTitleColor: true, largeTitleFontFamily: true, largeTitleFontSize: true, largeTitleFontWeight: true, largeTitleHideShadow: 150, title: 0.25, titleColor: 40, titleFontFamily: true, titleFontSize: "/assets/.cache/intl/ZGVzaWdu", titleFontWeight: null, topInsetEnabled: "86b91484df1ac0b8ccad956aae12b775", disableTopInsetApplication: "bg.messages.86b91484df1ac0b8ccad956aae12b775.compiled.messages", disableLeftInsetApplication: "jsona", disableRightInsetApplication: 150, disableBottomInsetApplication: 0.35, translucent: 40, children: true, headerLeftBarButtonItems: "/assets/.cache/intl/ZGVzaWdu", headerRightBarButtonItems: null, experimental_userInterfaceStyle: "72a624908b343db34ae78e6d520bec11" };
  obj16[5] = tmp10;
  obj16[6] = fontSize;
