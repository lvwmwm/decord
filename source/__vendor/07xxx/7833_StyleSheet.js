...
// Function ID: 7834
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1499, 1630, 5510, 7834, 4865, 7835, 7837, 7838, 7839, 7840]
// Exports: NativeStackView

// Module 7833 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5510).HeaderShownContext);
  let num5 = React.useContext(num6(5510).HeaderHeightContext);
  const context1 = React.useContext(num6(5510).HeaderBackContext);
  let obj3 = num6(5510);
  ...
  callback = obj2.useCallback(num6(7834).debounce(tmp18, 100), []);
  ...
  if (previousDescriptor) {
    title = tmp8(5510).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5510);
  ...
  let eventResult;
  const headerConfigProps = num6(7835).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  const tmp8Result3 = num6(7835);
  obj15[1] = closure_10(num6(5510).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(5510).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = tmp38(num6(5510).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(7837).AnimatedHeaderHeightContext.Provider, obj7);
