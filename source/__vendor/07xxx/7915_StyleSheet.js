...
// Function ID: 7916
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1484, 1614, 5631, 7916, 4912, 7917, 7919, 7920, 7921, 7922]
// Exports: NativeStackView

// Module 7915 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5631).HeaderShownContext);
  let num5 = React.useContext(num6(5631).HeaderHeightContext);
  const context1 = React.useContext(num6(5631).HeaderBackContext);
  let obj3 = num6(5631);
  ...
  callback = obj2.useCallback(num6(7916).debounce(tmp18, 100), []);
  ...
  obj15[1] = closure_10(num6(5631).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(5631).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = tmp38(num6(5631).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(7919).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4912).ScreenStackItem, obj4);
