...
// Function ID: 16912
// Name: PriorityQueue
// Dependencies: [41, 42, 16912]

// Module 16911 (PriorityQueue)
...
const items = [
  {
    ...
    value: function enqueue(arg0, arg1) {
      ...
      _queue1.splice(PriorityQueue(16912).default(self._queue, obj, (priority, priority2) => priority2.priority - priority.priority), 0, obj);
    }
  },
  {
    key: "dequeue",
