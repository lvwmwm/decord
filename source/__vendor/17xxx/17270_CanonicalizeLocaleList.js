...
// Dependencies: [17271, 17272]

// Module 17270 (CanonicalizeLocaleList)
import RegExpResult1 from "RegExpResult1" /* 17271 */;
import createDateTimeFormat from "createDateTimeFormat" /* 17272 */;
...
class List {
  constructor() {
    tmp = f66966(this, "length", { writable: true, value: 0 });
    if (!arguments.length) {
      return;
    } else {
      tmp3 = slice;
