...
// Function ID: 6851
// Name: StickyHeaders
// Dependencies: [6797, 19, 21, 6847, 6851, 6812]
// Exports: StickyHeaders

// Module 6850 (StickyHeaders)
...
export const StickyHeaders = (stickyHeaderIndices) => {
  ...
  tmp3Result = tmp3(() => {
    ...
    if (-1 !== currentStickyIndex) {
      tmpResult = null;
      if (tmp4 < data.length) {
        obj1 = { index: null, item: null, renderItem: null, layout: null, refHolder: null, extraData: null, trailingItem: "accessible", target: "__d", hidden: "y", inverted: "isArray" };
        obj1[0] = tmp4;
        obj1[1] = tmp6[tmp4];
        obj1[2] = renderItem;
