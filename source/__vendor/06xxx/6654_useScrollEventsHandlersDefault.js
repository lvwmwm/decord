...
// Module 6654 (useScrollEventsHandlersDefault)
const require = arg1;
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj = { animatedSheetState, SHEET_STATE: _require(6628).SHEET_STATE, animatedHandleGestureState, State: _require(6655).State, animatedScrollableState, SCROLLABLE_STATE: _require(6628).SCROLLABLE_STATE, isLockingScroll: sharedValue1, scrollTo: _require(1636).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue };
  E.__closure = obj;
  ...
  obj[0] = _require(1636).useWorkletCallback(E, items);
  const obj6 = _require(1636);
  class O {
    constructor(arg0, arg1) {
      y = scrollableRef.contentOffset.y;
      closure_1.value = y;
  ...
  obj1 = { scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, rootScrollableContentOffsetY: animatedScrollableContentOffsetY, animatedSheetState, SHEET_STATE: _require(6628).SHEET_STATE };
  O.__closure = obj1;
  ...
  obj[1] = _require(1636).useWorkletCallback(O, items1);
  const obj8 = _require(1636);
  ...
  obj2 = { animatedScrollableState, SCROLLABLE_STATE: _require(6628).SCROLLABLE_STATE, isLockingScroll: sharedValue1, scrollTo: _require(1636).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(6628).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
  fn2.__closure = obj2;
  ...
  obj[2] = _require(1636).useWorkletCallback(fn2, items2);
  const obj10 = _require(1636);
  class C {
    constructor(arg0, arg1) {
      y = scrollableRef.contentOffset.y;
      tmp = closure_0;
  ...
  obj[3] = _require(1636).useWorkletCallback(C, items3);
  return obj;
};
