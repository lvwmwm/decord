...
function exp(constructor) {
  ...
  if (16 < tmp3) {
    ...
    do {
      ...
      let tmp31 = f108401;
      let plusResult = obj5.plus(f108401(timesResult1, timesResult2, sum));
    ...
    if (s.eq(10)) {
      ...
      if (Math.abs(tmp10) < 1500000000000000) {
        if (charAtResult >= 7) {
          ...
          const tmp36 = f108401(constructor2.minus(Decimal), constructor2.plus(Decimal), sum);
          times = tmp36.times;
...
const fn14 = function(arg0) {
  ...
  if (self.s < 1) {
    ...
    if (self.eq(Decimal)) {
      ...
      c2 = false;
      constructor2 = f108401(ln(self, sum), ln(constructor, sum), sum);
      c2 = true;
...
const fn16 = function(arg0) {
  ...
  if (constructor.s) {
    if (self.s) {
      c2 = false;
      c2 = true;
      let minusResult = self.minus(f108401(self, tmp2, 0, 1).times(constructor));
      obj = f108401(self, tmp2, 0, 1);
    } else {
