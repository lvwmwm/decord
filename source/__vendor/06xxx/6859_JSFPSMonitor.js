...
// Function ID: 6860
// Name: JSFPSMonitor
// Dependencies: [6806, 6807, 6794, 6860]

// Module 6859 (JSFPSMonitor)
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        error = new Error(JSFPSMonitor(6794).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      const obj = { minFPS: JSFPSMonitor(6860).roundToDecimalPlaces(self.minFPS, 1), maxFPS: null, averageFPS: null };
      const obj2 = JSFPSMonitor(6860);
      obj[1] = JSFPSMonitor(6860).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(6860);
      obj[2] = JSFPSMonitor(6860).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    }
  }
];
