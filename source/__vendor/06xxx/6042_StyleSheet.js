...
// Function ID: 6043
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 6036, 6037, 1520, 6043, 6022, 5520, 6044, 6045, 6046, 6047]
// Exports: Card

// Module 6042 (StyleSheet)
import closure_3 from "_slicedToArray" /* 32 */;
import closure_4 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import jsxProd from "jsxProd" /* 21 */;
import getShadowStyle from "getShadowStyle" /* 6047 */;
...
export const Card = function Card(shadowEnabled) {
  ...
  if (typeof backgroundColor === "string") {
    tmp16 = 0 === tmp5(5520)(backgroundColor).alpha();
    const obj12 = tmp5(5520)(backgroundColor);
  }
  ...
  let merged = Object.assign(flag2(6045).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }));
  ...
  const items13 = [tmp27, gesture(flag2(6046).CardContent, { enabled: pageOverflowEnabled, layout, style: contentStyle, children })];
  obj5[3] = items13;
  obj4.children = layout(closing.View, obj5);
  obj3[2] = gesture(flag2(6022).PanGestureHandler, obj4);
  items5[2] = gesture(closing.View, obj3);
  obj[1] = items5;
  return layout(flag2(6044).CardAnimationContext.Provider, obj);
};
