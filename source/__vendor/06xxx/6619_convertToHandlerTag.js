...
// Dependencies: [32, 19, 6620, 6621, 6631, 6632, 6633, 6635, 6636, 6637, 6616, 6600, 6638, 6598]
// Exports: checkGestureCallbacksForWorklets, extractGestureRelations, useForceRender, useWebEventHandlers

// Module 6619 (convertToHandlerTag)
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 6616 */;
...
export const useWebEventHandlers = function useWebEventHandlers() {
  return callback3({
    onGestureHandlerEvent(nativeEvent) {
      const result = callback(6598).onGestureHandlerEvent(nativeEvent.nativeEvent);
    },
