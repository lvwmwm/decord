...
// Function ID: 6034
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 6027, 6028, 1521, 6034, 6013, 5511, 6035, 6036, 6037, 6038]
// Exports: Card

// Module 6033 (StyleSheet)
import closure_3 from "_slicedToArray" /* 32 */;
import closure_4 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import jsxProd from "jsxProd" /* 21 */;
import getShadowStyle from "getShadowStyle" /* 6038 */;
...
export const Card = function Card(shadowEnabled) {
  ...
  if (typeof backgroundColor === "string") {
    tmp16 = 0 === tmp5(5511)(backgroundColor).alpha();
  ...
  obj[1] = items5;
  return layout(flag2(6035).CardAnimationContext.Provider, obj);
};
