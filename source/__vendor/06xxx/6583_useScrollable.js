...
// Function ID: 6584
// Name: useScrollable
// Dependencies: [19, 1652, 6568, 6584]
// Exports: useScrollable

// Module 6583 (useScrollable)
...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(_require(6568).SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = _require(1652).useSharedValue(0);
  const obj2 = _require(1652);
  const sharedValue2 = _require(1652).useSharedValue(_require(6568).SCROLLABLE_STATE.UNDETERMINED);
