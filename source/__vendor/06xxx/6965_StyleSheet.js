...
// Function ID: 6966
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 6959, 6960, 1520, 6966, 6945, 5595, 6967, 6968, 6969, 6970]
// Exports: Card

// Module 6965 (StyleSheet)
import closure_3 from "_slicedToArray" /* 32 */;
import closure_4 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import jsxProd from "jsxProd" /* 21 */;
import getShadowStyle from "getShadowStyle" /* 6970 */;
...
export const Card = function Card(shadowEnabled) {
  ...
  if (typeof backgroundColor === "string") {
    tmp16 = 0 === tmp5(5595)(backgroundColor).alpha();
    const obj12 = tmp5(5595)(backgroundColor);
  }
  ...
  let merged = Object.assign(flag2(6968).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }));
  ...
  const items13 = [tmp27, gesture(flag2(6969).CardContent, { enabled: pageOverflowEnabled, layout, style: contentStyle, children })];
  obj5[3] = items13;
  obj4.children = layout(closing.View, obj5);
  obj3[2] = gesture(flag2(6945).PanGestureHandler, obj4);
  items5[2] = gesture(closing.View, obj3);
  obj[1] = items5;
  return layout(flag2(6967).CardAnimationContext.Provider, obj);
};
