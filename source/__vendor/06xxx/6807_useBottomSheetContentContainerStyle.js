...
// Module 6807 (useBottomSheetContentContainerStyle)
...
export const useBottomSheetContentContainerStyle = function useBottomSheetContentContainerStyle(flag, contentContainerStyle) {
  ...
  obj = { enableFooterMarginAdjustment: flag, runOnJS: _require(1636).runOnJS, setFooterHeight: tmp3, Platform: closure_5, animatedContentHeight };
  fn.__closure = obj;
  fn.__workletHash = 1149497927090;
  fn.__initData = closure_8;
  const items2 = [animatedFooterHeight, animatedContentHeight, flag];
  const animatedReaction = _require(1636).useAnimatedReaction(H, fn, items2);
  return tmp6;
};
