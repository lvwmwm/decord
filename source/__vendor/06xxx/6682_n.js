...
// Function ID: 6683
// Name: n
// Dependencies: [19, 6638, 6681]
// Exports: useReanimatedEventHandler

// Module 6682 (n)
import _mod6638 from "module_6638" /* 6638 */;
...
let Reanimated = _mod6638.Reanimated;
let mutable;
if (Reanimated != null) {
...
export const useReanimatedEventHandler = function useReanimatedEventHandler(handlerTag, memoizedGestureCallbacks, handler, changeEventCalculator, fillInDefaultValues) {
  ...
  fn.__closure = { lastUpdateEventMap: mutable, eventHandler: _require(6681).eventHandler, handlerTag, workletizedHandlers: tmp, changeEventCalculator, fillInDefaultValues };
  ...
  let Reanimated = _require(6638).Reanimated;
  let event;
  if (Reanimated != null) {
