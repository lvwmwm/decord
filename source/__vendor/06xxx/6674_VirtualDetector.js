...
// Dependencies: [32, 19, 17, 21, 6673, 6600, 6675, 6662, 6671, 6670, 6649]
// Exports: VirtualDetector

// Module 6674 (VirtualDetector)
    ...
    callback(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: null, handlerTags: null, methods: null, viewRef: "a", userSelect: "<string:2422931457>", touchAction: "<string:2422996994>", enableContextMenu: "<string:2538078210>" };
          obj[0] = tmp;
          obj[1] = closure_7;
