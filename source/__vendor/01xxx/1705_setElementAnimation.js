...
// Module 1705 (setElementAnimation)
...
import weakMap from "weakMap" /* 1722 */;
...
function setElementAnimation(dummy, dummyAnimationConfig, arg2) {
  ...
  if (dummyAnimationConfig.animationType === _require(1661).LayoutAnimationType.ENTERING) {
  ...
  if (!(animationName in _require(1692).Animations)) {
...
arg5.handleExitingAnimation = function handleExitingAnimation(offsetParent, processedConfig) {
  ...
  _require(1722).setElementPosition(cloneNodeResult, rect);
