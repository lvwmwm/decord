...
// Function ID: 1728
// Name: validateConfig
// Dependencies: [1663, 1692, 1728, 1729, 1730]

// Module 1727 (validateConfig)
...
let fn = function n(userConfig, callback) {
  ...
  obj = { userConfig, isValidRubberBandConfig: _require(1728).isValidRubberBandConfig, rubberBandDecay: _require(1729).rubberBandDecay, rigidDecay: _require(1730).rigidDecay, validateConfig, callback, getReduceMotionForAnimation: _require(1692).getReduceMotionForAnimation };
  fn.__closure = obj;
