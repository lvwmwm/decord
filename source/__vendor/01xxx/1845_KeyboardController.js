...
// Module 1845 (KeyboardController)
import importDefaultResult from "asyncGeneratorStep" /* 5 */;
import { KeyboardEvents, KeyboardEvents as KeyboardEvents2 } from "nativeEventEmitter" /* 1643 */;
        ...
        if (arg0 === 1) {
          ...
          const promise = new Promise((arg0) => {
            ...
            if (c2) {
              ...
              const KeyboardEvents = callback(1643).KeyboardEvents;
              dependencyMap = KeyboardEvents.addListener("keyboardDidHide", () => {
                callback(undefined);
                closure_1.remove();
              });
              const KeyboardControllerNative = callback(1643).KeyboardControllerNative;
