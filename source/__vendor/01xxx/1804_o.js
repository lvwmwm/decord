...
import useSharedValue from "useSharedValue" /* 1788 */;
...
const fn4 = function a(arg0, arg1, arg2, gamma) {
  ...
  const interpolateResult = num(1805).interpolate(arg0, arg1, tmp3, num(1805).Extrapolation.CLAMP);
  const obj = num(1805);
  const interpolateResult1 = num(1805).interpolate(arg0, arg1, tmp2, num(1805).Extrapolation.CLAMP);
  const obj2 = num(1805);
  const interpolateResult2 = num(1805).interpolate(arg0, arg1, mapped2, num(1805).Extrapolation.CLAMP);
  const obj3 = num(1805);
  const interpolateResult3 = num(1805).interpolate(arg0, arg1, arg2.a, num(1805).Extrapolation.CLAMP);
  if (1 === num) {
...
const fn9 = function i(arg0) {
  const tmp = fn6(arg0, (arg0) => {
    const convert = callback2(1806).oklab.convert;
