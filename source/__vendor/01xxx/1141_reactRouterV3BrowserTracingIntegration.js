  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f107925 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f107925, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f120136 = (name) => {
            ...
            obj[f107925(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            result = obj.startBrowserTracingNavigationSpan(f120136, obj);
          };
