...
// Function ID: 1847
// Name: useResizeMode
// Dependencies: [19, 1844, 1847, 1845, 1652, 1848, 1849]
...
// Module 1846 (useResizeMode)
import NOOP from "NOOP" /* 1845 */;
...
export const useGenericKeyboardHandler = function useGenericKeyboardHandler(handler, items10) {
  ...
  dependencyMap = _require(1845).useKeyboardContext();
  const obj = _require(1845);
  const obj2 = _require(1652);
  ...
  closure_2 = _require(1652).useEvent(fn, ["onKeyboardMoveStart", "onKeyboardMove", "onKeyboardMoveEnd", "onKeyboardMoveInteractive"], obj2.useHandler(handler, items10).doDependenciesDiffer);
  callback2(() => {
...
export const useKeyboardHandler = function useKeyboardHandler(handler, items) {
  ...
  fn.__workletHash = 7080794218426;
  fn.__initData = closure_5;
  callback = _require(1652).useEvent(fn, ["onKeyboardMoveStart", "onKeyboardMove", "onKeyboardMoveEnd", "onKeyboardMoveInteractive"], obj2.useHandler(handler, items).doDependenciesDiffer);
  callback2(() => {
    keyboardHandlers.setKeyboardHandlers(closure_2);
    return () => callback();
  }, items);
...
export const useFocusedInputHandler = function useFocusedInputHandler(handler, items10) {
  ...
  closure_2 = _require(1652).useEvent(fn, ["onFocusedInputTextChanged", "onFocusedInputSelectionChanged"], obj2.useHandler(handler, items10).doDependenciesDiffer);
  callback2(() => {
