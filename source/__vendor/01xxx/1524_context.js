...
export const NavigationProvider = function NavigationProvider(route) {
  ...
  obj[1] = jsx(NavigationContext.NavigationContext.Provider, { value: navigation, children: jsx(tmp(1525).IsFocusedContext.Provider, { value: tmp6, children }) });
  return <context.Provider value={navigation}>{jsx(tmp(1525).IsFocusedContext.Provider, { value: tmp6, children })}</context.Provider>;
};
