...
// Dependencies: [109, 19, 21, 1501, 1597, 1599]
// Exports: createStandardNavigationFactories

// Module 1596 (createStandardNavigationFactories)
...
export const createStandardNavigationFactories = function createStandardNavigationFactories(arg0, arg1, arg2) {
  ...
  if ("standard" !== type) {
    ...
    obj[0] = _require(1501).createNavigatorFactory(function StandardNavigationNavigator(UNSTABLE_routeNamesChangeBehavior) {
      let obj = callback(1501);
      navigationBuilder = obj.useNavigationBuilder(navigationBuilder, UNSTABLE_routeNamesChangeBehavior);
      dependencyMap = callback(1597).useBuildHref();
      let tmp2 = callback(1599);
    ...
    const obj2 = _require(1501);
    obj[1] = _require(1501).createScreenFactory();
    return obj;
  }
};
