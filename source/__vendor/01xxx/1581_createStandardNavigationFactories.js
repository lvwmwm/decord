...
// Module 1581 (createStandardNavigationFactories)
...
export const createStandardNavigationFactories = function createStandardNavigationFactories(arg0, arg1, arg2) {
  ...
  if ("standard" !== type) {
    ...
    obj[0] = _require(1486).createNavigatorFactory(function StandardNavigationNavigator(UNSTABLE_routeNamesChangeBehavior) {
      let obj = callback(1486);
      navigationBuilder = obj.useNavigationBuilder(navigationBuilder, UNSTABLE_routeNamesChangeBehavior);
      dependencyMap = callback(1582).useBuildHref();
      let tmp2 = callback(1584);
    ...
    const obj2 = _require(1486);
    obj[1] = _require(1486).createScreenFactory();
    return obj;
  }
};
