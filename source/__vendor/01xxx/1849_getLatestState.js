...
// Function ID: 1850
// Name: getLatestState
// Dependencies: [32, 19, 1844, 1642]
// Exports: useKeyboardState

// Module 1849 (getLatestState)
...
export const useKeyboardState = function useKeyboardState(arg0) {
  ...
  const tmp2 = callback(callback3(() => {
    ...
    const obj = {};
    const KeyboardController = callback(1844).KeyboardController;
    const merged = Object.assign(KeyboardController.state());
    const KeyboardController2 = callback(1844).KeyboardController;
  ...
  callback2(() => {
    ...
    let obj = {};
    let KeyboardController = callback(1844).KeyboardController;
    let merged = Object.assign(KeyboardController.state());
    let KeyboardController2 = callback(1844).KeyboardController;
    obj.isVisible = KeyboardController2.isVisible();
