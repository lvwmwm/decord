...
// Module 1028 (exceptionFromError)
  ...
  if (!tmp2Result.isDOMError(error)) {
    ...
    if (!tmp2Result.isDOMException(error)) {
      if (tmp2Result1.isError(error)) {
          ...
          if (!tmp2Result3.isEvent(error)) {
            ...
            if (arg3) {
              if (arg2) {
                ...
                const result = tmp2(814).addExceptionMechanism(obj3, { synthetic: true });
                const tmp2Result4 = tmp2(814);
              }
            }
            ...
            tmp2Result5 = tmp2(814);
            const _HermesInternal = HermesInternal;
            const result1 = tmp2(814).addExceptionTypeValue(obj3, "" + error, undefined);
            const tmp2Result6 = tmp2(814);
            const result2 = tmp2(814).addExceptionMechanism(obj3, { synthetic: true });
            const tmp2Result7 = tmp2(814);
          }
          tmp2Result3 = tmp2(814);
        }
        tmp2Result2 = tmp2(814);
        const client = tmp2(814).getClient();
        let normalizeDepth;
        if (client != null) {
        ...
        const tmp2Result8 = tmp2(814);
        obj8[0] = tmp2(814).normalizeToSize(error, normalizeDepth);
  ...
  if ("stack" in error) {
    ...
    if (arg3) {
      if (arg2) {
        ...
        const result4 = tmp2(814).addExceptionMechanism(obj15, { synthetic: true });
        const tmp2Result12 = tmp2(814);
      }
    }
    ...
    tmp2Result13 = tmp2(814);
    const result5 = tmp2(814).addExceptionTypeValue(obj15, combined1);
    const tmp2Result14 = tmp2(814);
  }
  if ("code" in error) {
    const obj20 = {};
