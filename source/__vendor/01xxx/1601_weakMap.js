...
// Function ID: 1602
// Name: weakMap
// Dependencies: [32, 19, 17, 21, 1602, 1501, 1604, 1605, 1606, 1608, 1609, 1598]
...
export const NavigationContainer = importAllResult.forwardRef(function NavigationContainerInner(direction, ref) {
  ...
  if (DefaultTheme === undefined) {
    DefaultTheme = linking(1602).DefaultTheme;
  }
  ...
  const obj6 = linking(1608);
  [tmp20, initialState] = ref(linking(1608).useThenable(obj3.useLinking(ref, obj).getInitialState), 2);
  ...
  if (tmp22) {
    ...
    obj2.ref = ref;
    obj1[1] = tmp23(tmp12(1501).BaseNavigationContainer, obj2);
    obj[1] = tmp23(tmp12(1598).LinkingContext.Provider, obj1);
    let tmp24 = obj;
  } else {
    obj3 = { value: null, children: null };
    obj3[0] = DefaultTheme;
    obj3[1] = fallback;
    obj[1] = tmp23(tmp12(1501).ThemeProvider, obj3);
    tmp24 = obj;
  }
  return jsx(linking(1609).LocaleDirContext.Provider, tmp24);
});
