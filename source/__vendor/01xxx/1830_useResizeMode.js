...
export const useGenericKeyboardHandler = function useGenericKeyboardHandler(handler, items10) {
  ...
  dependencyMap = _require(1829).useKeyboardContext();
  const obj = _require(1829);
  ...
  closure_2 = _require(1636).useEvent(fn, ["onKeyboardMoveStart", "onKeyboardMove", "onKeyboardMoveEnd", "onKeyboardMoveInteractive"], obj2.useHandler(handler, items10).doDependenciesDiffer);
  callback2(() => {
...
export const useKeyboardHandler = function useKeyboardHandler(handler, items) {
  ...
  fn.__workletHash = 7080794218426;
  fn.__initData = closure_5;
  callback = _require(1636).useEvent(fn, ["onKeyboardMoveStart", "onKeyboardMove", "onKeyboardMoveEnd", "onKeyboardMoveInteractive"], obj2.useHandler(handler, items).doDependenciesDiffer);
  callback2(() => {
    keyboardHandlers.setKeyboardHandlers(closure_2);
    return () => callback();
  }, items);
...
export const useFocusedInputHandler = function useFocusedInputHandler(handler, items10) {
  ...
  closure_2 = _require(1636).useEvent(fn, ["onFocusedInputTextChanged", "onFocusedInputSelectionChanged"], obj2.useHandler(handler, items10).doDependenciesDiffer);
  callback2(() => {
