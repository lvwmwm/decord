...
// Dependencies: [116, 1663]

// Module 1681 (findHostInstance)
const require = arg1;
    ...
    (function resolveFindHostInstance_DEPRECATED() {
      if (undefined === prop) {
        try {
          ...
          const reanimatedError = new callback(1663).ReanimatedError("Failed to resolve findHostInstance_DEPRECATED");
