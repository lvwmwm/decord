...
// Dependencies: [999, 814, 998, 1010, 1127, 1128]

// Module 1126 (mobileReplayIntegrationNoop)
const require = arg1;
          ...
          on.on("createDsc", (replay_id) => {
            if (!replay_id.replay_id) {
              ...
              if (null === currentReplayId) {
                const NATIVE = closure_1_0(998).NATIVE;
        ...
        return updateCachedReplayId(this, undefined, undefined, function*() {
          if (c5 === 2) {
            ...
            try {
              ...
              const NATIVE2 = lib(998).NATIVE;
              isHardCrashResult = lib(1010).isHardCrash(closure_1_0);
