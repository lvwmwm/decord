...
// Module 1142 (tanstackRouterBrowserTracingIntegration)
const require = arg1;
...
arg5.tanstackRouterBrowserTracingIntegration = function tanstackRouterBrowserTracingIntegration(arg0) {
  ...
  let result = _require(1021).browserTracingIntegration(obj);
  ...
  obj.afterAllSetup = function afterAllSetup(f107925) {
    obj1 = f107925;
    _undefined.afterAllSetup(f107925);
    ...
    if (closure_2) {
      if (_location) {
        ...
        result[1] = obj;
        result = tmp2(tmp3[0]).startBrowserTracingPageLoadSpan(f107925, result);
      ...
      const subscription = obj1.subscribe("onBeforeNavigate", (fromLocation) => {
        if (fromLocation.fromLocation) {
          if (fromLocation.toLocation.state !== fromLocation.fromLocation.state) {
            ...
            obj[0] = tmp2 ? tmp2.routeId : obj1(1021).WINDOW.location.pathname;
            obj = {};
            obj[obj1(814).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "navigation";
            obj[obj1(814).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = "auto.navigation.react.tanstack_router";
            let str4 = "url";
            if (tmp2) {
              str4 = "route";
            }
            obj[obj1(814).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str4;
            obj[1] = obj;
