...
export const createReactRouterV6CompatibleTracingIntegration = function createReactRouterV6CompatibleTracingIntegration(instrumentPageLoad, _6) {
  ...
  obj.afterAllSetup = function afterAllSetup(f107925) {
    closure_2.afterAllSetup(f107925);
    ...
    if (tmp4) {
      ...
      obj[1] = obj;
      result = tmp2(1021).startBrowserTracingPageLoadSpan(f107925, obj);
      const tmp2Result = tmp2(1021);
    }
    if (num) {
      lazyRouteTimeout.add(f107925);
    }
  };
  return obj;
};
