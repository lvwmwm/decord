...
// Function ID: 1540
// Name: context
// Dependencies: [19, 21, 1540, 1542]
// Exports: NavigationProvider

// Module 1539 (context)
import context12 from "context1" /* 1540 */;
...
export const NavigationProvider = function NavigationProvider(route) {
  ...
  obj = { value: navigation, children: jsx(tmp(1540).IsFocusedContext.Provider, { value: tmp6, children }) };
  obj[1] = jsx(NavigationContext.NavigationContext.Provider, { value: navigation, children: jsx(tmp(1540).IsFocusedContext.Provider, { value: tmp6, children }) });
  return <context.Provider value={navigation}>{jsx(tmp(1540).IsFocusedContext.Provider, { value: tmp6, children })}</context.Provider>;
};
