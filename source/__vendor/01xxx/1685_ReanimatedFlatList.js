...
// Dependencies: [109, 19, 17, 21, 1686, 1792, 1790, 1791]

// Module 1685 (ReanimatedFlatList)
...
export const ReanimatedFlatList = isReactRendering.componentWithRef((skipEnteringExitingAnimations, ref) => {
  ...
  if (undefined !== skipEnteringExitingAnimations.skipEnteringExitingAnimations) {
    ...
    obj[2] = tmp7;
    tmp5Result = jsx(_require(1790).LayoutAnimationConfig, { skipEntering: true, skipExiting: true, children: null });
  }
  return tmp5Result;
});
