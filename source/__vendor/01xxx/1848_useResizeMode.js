...
// Function ID: 1849
// Name: useResizeMode
// Dependencies: [19, 1846, 1849, 1847, 1654, 1850, 1851]
...
export const useKeyboardHandler = function useKeyboardHandler(handler, items) {
  ...
  fn.__workletHash = 7080794218426;
  fn.__initData = closure_5;
  callback = _require(1654).useEvent(fn, ["onKeyboardMoveStart", "onKeyboardMove", "onKeyboardMoveEnd", "onKeyboardMoveInteractive"], obj2.useHandler(handler, items).doDependenciesDiffer);
  callback2(() => {
    keyboardHandlers.setKeyboardHandlers(closure_2);
    return () => callback();
  }, items);
