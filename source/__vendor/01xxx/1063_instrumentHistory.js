...
// Dependencies: [814, 1036]

// Module 1063 (instrumentHistory)
...
function instrumentHistory() {
  ...
  if (obj.supportsHistory()) {
    ...
    tmpResult.fill(tmp(1036).WINDOW.history, "pushState", historyReplacementFunction);
    tmpResult = tmp(814);
    tmpResult.fill(tmp(1036).WINDOW.history, "replaceState", historyReplacementFunction);
  }
}
