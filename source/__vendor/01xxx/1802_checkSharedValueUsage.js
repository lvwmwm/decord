...
// Dependencies: [19, 17, 1655, 1803, 1798, 1752, 1663, 1804, 1724, 1696, 1750]
// Exports: useAnimatedStyle

// Module 1802 (checkSharedValueUsage)
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import t from "t" /* 1663 */;
import updateProps from "updateProps" /* 1752 */;
import isAnimated from "isAnimated" /* 1798 */;
import o from "o" /* 1803 */;
...
function styleUpdater(arg0, arg1, animations) {
  ...
  if (boxShadow) {
    _require(1803).processBoxShadow(obj);
    const obj3 = _require(1803);
  }
  obj = {};
  let flag2 = false;
  let flag3 = false;
  ...
  if (flag5) {
    ...
    if (flag4) {
      _require(1752).updateProps(arg0, obj);
      const obj8 = _require(1752);
    }
  } else {
    animations.isAnimationCancelled = true;
    animations.animations = [];
    let shallowEqualResult = _require(1798).shallowEqual(last, obj);
    if (shallowEqualResult) {
      shallowEqualResult = !arg5;
    }
    if (!shallowEqualResult) {
      tmp19(1752).updateProps(arg0, obj, flag);
      const tmp19Result = tmp19(1752);
    }
    const obj6 = _require(1798);
    tmp19 = _require;
  }
  animations.last = obj;
}
