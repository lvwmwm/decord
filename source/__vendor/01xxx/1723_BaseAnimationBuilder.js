...
// Dependencies: [41, 42, 1677, 1663, 1724, 1692]

// Module 1723 (BaseAnimationBuilder)
  ...
  },
  {
    ...
    value: function getDelayFunction() {
      ...
      if (tmp) {
        ...
        obj[0] = reduceMotion(1724).withDelay;
        obj[1] = reduceMotion;
        fn2.__closure = obj;
        ...
        obj[0] = reduceMotion(1692).getReduceMotionFromConfig;
        obj[1] = reduceMotion;
        fn.__closure = obj;
