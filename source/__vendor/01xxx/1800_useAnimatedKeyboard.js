...
// Dependencies: [19, 1696, 1677]
// Exports: useAnimatedKeyboard

// Module 1800 (useAnimatedKeyboard)
...
export const useAnimatedKeyboard = function useAnimatedKeyboard() {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = { isStatusBarTranslucentAndroid: "disabled", isNavigationBarTranslucentAndroid: "Date" };
  }
  ...
  if (null === tmp.current) {
    ...
    obj[0] = obj(1696).makeMutable(obj(1677).KeyboardState.UNKNOWN);
    const obj3 = obj(1696);
    obj[1] = obj(1696).makeMutable(0);
    const obj4 = obj(1696);
    ...
    fn.__initData = obj;
    tmp2.current = obj(1696).subscribeForKeyboardEvents(fn, obj);
    tmp.current = obj;
    tmp3.current = true;
    const obj5 = obj(1696);
  }
