...
// Function ID: 1821
// Name: o
// Dependencies: [1821, 1695, 1822, 1663, 1804, 1696]
...
import useSharedValue from "useSharedValue" /* 1804 */;
import getVal from "getVal" /* 1821 */;
import convertLrgbToOklabDefault from "convertLrgbToOklab" /* 1822 */;
...
const fn4 = function a(arg0, arg1, arg2, gamma) {
  ...
  const interpolateResult = num(1821).interpolate(arg0, arg1, tmp3, num(1821).Extrapolation.CLAMP);
  const obj = num(1821);
  const interpolateResult1 = num(1821).interpolate(arg0, arg1, tmp2, num(1821).Extrapolation.CLAMP);
  const obj2 = num(1821);
  const interpolateResult2 = num(1821).interpolate(arg0, arg1, mapped2, num(1821).Extrapolation.CLAMP);
  const obj3 = num(1821);
  const interpolateResult3 = num(1821).interpolate(arg0, arg1, arg2.a, num(1821).Extrapolation.CLAMP);
  if (1 === num) {
    let tmp6Result = tmp6(1695);
    let rgbaColorResult = tmp6Result.rgbaColor(interpolateResult, interpolateResult1, interpolateResult2, interpolateResult3);
  } else {
    tmp6Result = tmp6(1695);
...
const fn9 = function i(arg0) {
  const tmp = fn6(arg0, (arg0) => {
    const convert = callback2(1822).oklab.convert;
