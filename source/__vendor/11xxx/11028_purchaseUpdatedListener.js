...
export const purchaseUpdatedListener = (arg0, arg1) => {
  ...
  const _require = arg0;
  dependencyMap = arg1;
  const obj = _require(11018);
  const obj2 = new NativeEventEmitter(_require(11018).getNativeModule());
