...
// Function ID: 13661
// Name: Inflate
// Dependencies: [13651, 13653, 13661, 13664, 13655, 13665, 13659]

// Module 13660 (Inflate)
...
class Inflate {
  constructor(arg0) {
    ...
    if (this instanceof Inflate) {
      ...
      if (inflateInit2Result !== require("module_13664").Z_OK) {
        tmp19 = globalThis;
        _Error = Error;
        tmp20 = new.target;
        tmp21 = new.target;
        error = new Error(require("module_13655")[inflateInit2Result]);
        tmp23 = error;
        throw error;
      } else {
        tmp14 = new.target;
    ...
    if (this.ended) {
      ...
      if (arg1 === ~~arg1) {
        ...
        if (true === arg1) {
          tmp5 = closure_0;
          tmp6 = closure_1;
          Z_NO_FLUSH = require("module_13664").Z_FINISH;
        } else {
          tmp3 = closure_0;
          tmp4 = closure_1;
          Z_NO_FLUSH = require("module_13664").Z_NO_FLUSH;
        }
        tmp7 = Z_NO_FLUSH;
      }
    }
  ...
  onEnd(arg0) {
    ...
    tmp = closure_0;
    tmp2 = closure_1;
    if (arg0 === require("module_13664").Z_OK) {
      str = "string";
