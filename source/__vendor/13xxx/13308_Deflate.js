...
// Function ID: 13309
// Name: Deflate
// Dependencies: [13307, 13309, 13310, 13311, 13315]

// Module 13308 (Deflate)
import assign from "assign" /* 13307 */;
import _mod13311 from "module_13311" /* 13311 */;
import assign2 from "assign" /* 13315 */;
    ...
    if (this instanceof Deflate) {
      ...
      if (options.raw) {
        ...
        if (0 !== deflateInit2Result) {
          ...
          tmp23 = new.target;
          tmp24 = new.target;
          error = new Error(require("module_13311")[deflateInit2Result]);
          tmp26 = error;
          throw error;
        } else {
          if (options.header) {
          ...
          if (options.dictionary) {
            ...
            if (0 !== deflateSetDictionaryResult) {
              ...
              tmp18 = new.target;
              tmp19 = new.target;
              error1 = new Error(require("module_13311")[deflateSetDictionaryResult]);
              tmp21 = error1;
              throw error1;
            } else {
              flag2 = true;
