...
// Function ID: 13805
// Name: Range
// Dependencies: [41, 42, 13776, 13803, 13777, 13779, 13778, 13775, 13805]

// Module 13804 (Range)
import _createClass from "_createClass" /* 42 */;
import LRUCache from "LRUCache" /* 13805 */;
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13776")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13777).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13777).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13778)("hyphen replace", str);
        let str3 = str.replace(tmp11(13779).safeRe[tmp11(undefined, 13779).t.COMPARATORTRIM], tmp11(13779).comparatorTrimReplace);
        tmp11(13778)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13779).safeRe[tmp11(undefined, 13779).t.TILDETRIM], tmp11(13779).tildeTrimReplace);
        tmp11(13778)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13779).safeRe[tmp11(undefined, 13779).t.CARETTRIM], tmp11(13779).caretTrimReplace);
        tmp11(13778)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13775)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13778)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13803).ANY) {
