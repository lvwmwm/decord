...
// Function ID: 13284
// Name: Inflate
// Dependencies: [13274, 13276, 13284, 13287, 13278, 13288, 13282]

// Module 13283 (Inflate)
import assign from "assign" /* 13274 */;
import ZStream from "ZStream" /* 13276 */;
import _mod13278 from "module_13278" /* 13278 */;
import assign2 from "assign" /* 13282 */;
import _mod13287 from "module_13287" /* 13287 */;
...
class Inflate {
  constructor(arg0) {
    ...
    if (this instanceof Inflate) {
      ...
      if (inflateInit2Result !== require("module_13287").Z_OK) {
        tmp19 = globalThis;
        _Error = Error;
        tmp20 = new.target;
        tmp21 = new.target;
        error = new Error(require("module_13278")[inflateInit2Result]);
        tmp23 = error;
        throw error;
      } else {
        tmp14 = new.target;
    ...
    if (this.ended) {
      ...
      if (arg1 === ~~arg1) {
        ...
        if (true === arg1) {
          tmp5 = closure_0;
          tmp6 = closure_1;
          Z_NO_FLUSH = require("module_13287").Z_FINISH;
        } else {
          tmp3 = closure_0;
          tmp4 = closure_1;
          Z_NO_FLUSH = require("module_13287").Z_NO_FLUSH;
        }
        tmp7 = Z_NO_FLUSH;
      }
    }
  ...
  onEnd(arg0) {
    ...
    tmp = closure_0;
    tmp2 = closure_1;
    if (arg0 === require("module_13287").Z_OK) {
      str = "string";
