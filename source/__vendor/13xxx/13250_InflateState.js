...
// Function ID: 13251
// Name: InflateState
// Dependencies: [13240, 13251, 13247, 13252, 13246]

// Module 13250 (InflateState)
import assign from "assign" /* 13240 */;
import _mod13247 from "module_13247" /* 13247 */;
import inflate_table from "inflate_table" /* 13251 */;
import inflate_fast from "inflate_fast" /* 13252 */;
        ...
        while (true) {
          ...
          if (1 === mode) {
              ...
              if (bits >= 16) {
                if (2 & state.wrap) {
                  if (35615 === buf8) {
                    ...
                    num = 2;
                    num = 0;
                    state.check = _mod13247(check10, tmp2, 2, 0);
                    state.mode = 2;
                    bits = 0;
                    hold = 0;
                    diff8 = buf8;
            ...
            if (2 === mode) {
              ...
              if (bits >= 16) {
                ...
                if (8 !== (255 & state.flags)) {
                  ...
                  if (512 & state.flags) {
                    ...
                    let num89 = 2;
                    let num90 = 0;
                    state.check = _mod13247(check3, tmp2, 2, 0);
                  }
                  state.mode = 3;
                  let num91 = 0;
                  let num92 = 0;
                      ...
                      if (!(1024 & state.flags)) {
                        ...
                        if (length4) {
                          ...
                          if (512 & state.flags) {
                            ...
                            buf8 = length4;
                            buf8 = tmp14;
                            state.check = _mod13247(check7, tmp16, length4, buf8);
                          }
                          buf8 = tmp12 - length4;
                          buf8 = tmp14 + length4;
                          ...
                          if (4096 & state.flags) {
                            ...
                            if (0 !== tmp12) {
                              ...
                              if (512 & state.flags) {
                                ...
                                buf8 = input;
                                buf8 = tmp14;
                                state.check = _mod13247(check9, tmp16, buf8, buf8);
                              }
                              buf8 = tmp12 - buf8;
                              buf8 = tmp14 + buf8;
                              num61 = num56;
                                                                  ...
                                                                  if (bits >= 32) {
                                                                    ...
                                                                    if (!diff3) {
                                                                      ...
                                                                      if (state.flags) {
                                                                        ...
                                                                        let tmp44 = output;
                                                                        let tmp45 = diff3;
                                                                        tmp46 = tmp41(13246)(check, tmp15, diff3, next_out - diff3);
                                                                      }
                                                                      state.check = tmp46;
                                                                      state.adler = tmp46;
                                                                    }
                                              ...
                                              if (state.mode === 30) {
                                                ...
                                                if (0 === state.lens[256]) {
                                                  ...
                                                  if (buf8) {
                                                    ...
                                                    let num74 = 0;
                                                    buf8 = obj;
                                                    buf8 = buf8(13251)(2, lens2, state.nlen, state.ndist, state.distcode, 0, state.work, obj);
                    ...
                    if (2048 & state.flags) {
                      ...
                      if (0 !== buf8) {
                        ...
                        if (512 & state.flags) {
                          ...
                          buf8 = check8;
                          buf8 = input;
                          state.check = _mod13247(check8, tmp16, buf8, buf8);
                        }
                        buf8 = buf8 - buf8;
                        buf8 = buf8 + buf8;
                        num61 = num56;
              ...
              if (num95 >= 16) {
                ...
                if (512 & state.flags) {
                  ...
                  let num97 = 2;
                  let num98 = 0;
                  state.check = _mod13247(check5, tmp2, 2, 0);
                }
                state.mode = 5;
                num99 = 0;
                num = 0;
            ...
            if (num91 >= 32) {
              ...
              if (512 & state.flags) {
                ...
                let num93 = 4;
                let num94 = 0;
                state.check = _mod13247(check4, tmp2, 4, 0);
              }
              state.mode = 4;
              num95 = 0;
              num96 = 0;
          ...
          if (!buf8) {
            ...
            if (state.flags) {
              ...
              buf8 = check11;
              buf8 = output;
              buf8 = buf8(13246)(check11, tmp15, buf8, state.next_out - buf8);
            }
            state.check = buf8;
            state.adler = buf8;
          }
