...
// Function ID: 13514
// Name: items
// Dependencies: [13500, 13499, 13485, 13502]

// Module 13513 (items)
import SemVer from "SemVer" /* 13485 */;
import Comparator from "Comparator" /* 13499 */;
import Range from "Range" /* 13500 */;
import Range2 from "Range" /* 13502 */;
    ...
    if (1 === arg0.length) {
      ...
      if (arg0[0].semver === Comparator.ANY) {
        if (1 === item10015.length) {
          if (item10015[0].semver === tmp6(13499).ANY) {
            return true;
          }
        }
      }
