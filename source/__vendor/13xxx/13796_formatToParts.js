...
// Function ID: 13797
// Name: formatToParts
// Dependencies: [1281, 13774, 13797, 13792, 13798, 13794]
// Exports: default

// Module 13796 (formatToParts)
...
const regExp = new RegExp("^".concat(_mod13797.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod13797.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13792).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13798).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13794).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
