...
// Function ID: 13448
// Name: Range
// Dependencies: [41, 42, 13419, 13446, 13420, 13422, 13421, 13418, 13448]

// Module 13447 (Range)
import _createClass from "_createClass" /* 42 */;
import LRUCache from "LRUCache" /* 13448 */;
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13419")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13420).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13420).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13421)("hyphen replace", str);
        let str3 = str.replace(tmp11(13422).safeRe[tmp11(undefined, 13422).t.COMPARATORTRIM], tmp11(13422).comparatorTrimReplace);
        tmp11(13421)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13422).safeRe[tmp11(undefined, 13422).t.TILDETRIM], tmp11(13422).tildeTrimReplace);
        tmp11(13421)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13422).safeRe[tmp11(undefined, 13422).t.CARETTRIM], tmp11(13422).caretTrimReplace);
        tmp11(13421)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13418)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13421)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13446).ANY) {
