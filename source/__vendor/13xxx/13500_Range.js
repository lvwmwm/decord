...
// Function ID: 13501
// Name: Range
// Dependencies: [41, 42, 13472, 13499, 13473, 13475, 13474, 13471, 13501]

// Module 13500 (Range)
import _createClass from "_createClass" /* 42 */;
import LRUCache from "LRUCache" /* 13501 */;
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13472")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13473).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13473).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13474)("hyphen replace", str);
        let str3 = str.replace(tmp11(13475).safeRe[tmp11(undefined, 13475).t.COMPARATORTRIM], tmp11(13475).comparatorTrimReplace);
        tmp11(13474)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13475).safeRe[tmp11(undefined, 13475).t.TILDETRIM], tmp11(13475).tildeTrimReplace);
        tmp11(13474)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13475).safeRe[tmp11(undefined, 13475).t.CARETTRIM], tmp11(13475).caretTrimReplace);
        tmp11(13474)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13471)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13474)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13499).ANY) {
