...
// Function ID: 13850
// Name: formatToParts
// Dependencies: [1281, 13827, 13850, 13845, 13851, 13847]
// Exports: default

// Module 13849 (formatToParts)
...
const regExp = new RegExp("^".concat(_mod13850.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod13850.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13845).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13851).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13847).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
