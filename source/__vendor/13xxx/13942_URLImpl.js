...
// Function ID: 13943
// Name: URLImpl
// Dependencies: [41, 42, 13943, 13947, 13946]

// Module 13942 (URLImpl)
...
class URLImpl {
  constructor(arg0, arg1) {
    ...
    if (null === basicURLParseResult1) {
      ...
      tmp7Result = require("module_13947");
      items = [];
      items[0] = str;
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(13943).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(13943).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(13946).parseUrlencoded(query);
          const tmpResult = tmp(13946);
        }
      }
      const obj = URLImpl(13943);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(13943).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
  ...
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13943).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(13943);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13943).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(13943);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(13943).serializeHost(host);
        const obj3 = URLImpl(13943);
      } else {
        const obj = URLImpl(13943);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(13943).serializeInteger(host.port)}`;
        const obj2 = URLImpl(13943);
      }
    },
    set(arg0) {
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(13943).serializeHost(tmp._url.host);
        const obj = URLImpl(13943);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(13943).serializeInteger(tmp._url.port);
        const obj = URLImpl(13943);
      }
      return str;
    },
    set(arg0) {
      ...
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        if ("" === arg0) {
          ...
          obj[0] = self._url;
          URLImpl(13943).basicURLParse(arg0, obj);
          const tmpResult = URLImpl(13943);
        }
      }
    }
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        self._query._list = URLImpl(13946).parseUrlencoded(substr);
      }
    }
  },
  {
