...
// Function ID: 13534
// Name: Range
// Dependencies: [41, 42, 13505, 13532, 13506, 13508, 13507, 13504, 13534]

// Module 13533 (Range)
import _createClass from "_createClass" /* 42 */;
import LRUCache from "LRUCache" /* 13534 */;
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13505")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13506).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13506).FLAG_LOOSE;
      }
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13504)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13507)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13532).ANY) {
