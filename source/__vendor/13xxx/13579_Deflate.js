...
// Function ID: 13580
// Name: Deflate
// Dependencies: [13578, 13580, 13581, 13582, 13586]

// Module 13579 (Deflate)
import assign from "assign" /* 13578 */;
import _mod13582 from "module_13582" /* 13582 */;
import assign2 from "assign" /* 13586 */;
    ...
    if (this instanceof Deflate) {
      ...
      if (options.raw) {
        ...
        if (0 !== deflateInit2Result) {
          ...
          tmp23 = new.target;
          tmp24 = new.target;
          error = new Error(require("module_13582")[deflateInit2Result]);
          tmp26 = error;
          throw error;
        } else {
          if (options.header) {
          ...
          if (options.dictionary) {
            ...
            if (0 !== deflateSetDictionaryResult) {
              ...
              tmp18 = new.target;
              tmp19 = new.target;
              error1 = new Error(require("module_13582")[deflateSetDictionaryResult]);
              tmp21 = error1;
              throw error1;
            } else {
              flag2 = true;
