...
// Function ID: 13242
// Name: Deflate
// Dependencies: [13240, 13242, 13243, 13244, 13248]

// Module 13241 (Deflate)
import assign from "assign" /* 13240 */;
import _mod13244 from "module_13244" /* 13244 */;
import assign2 from "assign" /* 13248 */;
    ...
    if (this instanceof Deflate) {
      ...
      if (options.raw) {
        ...
        if (0 !== deflateInit2Result) {
          ...
          tmp23 = new.target;
          tmp24 = new.target;
          error = new Error(require("module_13244")[deflateInit2Result]);
          tmp26 = error;
          throw error;
        } else {
          if (options.header) {
          ...
          if (options.dictionary) {
            ...
            if (0 !== deflateSetDictionaryResult) {
              ...
              tmp18 = new.target;
              tmp19 = new.target;
              error1 = new Error(require("module_13244")[deflateSetDictionaryResult]);
              tmp21 = error1;
              throw error1;
            } else {
              flag2 = true;
