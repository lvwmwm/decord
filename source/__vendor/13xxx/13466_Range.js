...
// Function ID: 13467
// Name: Range
// Dependencies: [41, 42, 13438, 13465, 13439, 13441, 13440, 13437, 13467]

// Module 13466 (Range)
import _createClass from "_createClass" /* 42 */;
import LRUCache from "LRUCache" /* 13467 */;
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13438")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13439).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13439).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13440)("hyphen replace", str);
        let str3 = str.replace(tmp11(13441).safeRe[tmp11(undefined, 13441).t.COMPARATORTRIM], tmp11(13441).comparatorTrimReplace);
        tmp11(13440)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13441).safeRe[tmp11(undefined, 13441).t.TILDETRIM], tmp11(13441).tildeTrimReplace);
        tmp11(13440)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13441).safeRe[tmp11(undefined, 13441).t.CARETTRIM], tmp11(13441).caretTrimReplace);
        tmp11(13440)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13437)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13440)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13465).ANY) {
