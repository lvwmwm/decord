...
// Function ID: 13816
// Name: formatToParts
// Dependencies: [1281, 13793, 13816, 13811, 13817, 13813]
// Exports: default

// Module 13815 (formatToParts)
...
const regExp = new RegExp("^".concat(_mod13816.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod13816.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13811).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13817).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13813).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
