...
// Function ID: 7762
// Name: updateSession
// Dependencies: [7737, 7738, 7762, 7752, 7749, 7744]
// Exports: closeSession, makeSession

// Module 7761 (updateSession)
...
function updateSession(ipAddress) {
  ...
  if (!timestamp) {
    timestamp = require(7752) /* dateTimestampInSeconds */.timestampInSeconds();
    const obj2 = require(7752) /* dateTimestampInSeconds */;
  }
  ...
  if (!obj.sid) {
    ...
    if (32 === obj.sid.length) {
      ...
      sid = require(7749) /* addContextToFrame */.uuid4();
