...
// Function ID: 39828
// Name: ScreenStack
// Dependencies: [29, 31, 33, 4522, 4538, 4516, 4523, 4539, 4526]
// Exports: default

// Module 4537 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = React.useContext(_require(4538).GHContext);
  let obj = {
  ...
  ref2(4522)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4522)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  obj = { value: ref };
  ...
  const tmp5 = _require;
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4526).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = mapped;
  obj1.children = jsx(ref2(4539), Object.assign({}, tmp, obj2));
  obj.children = <context gestureDetectorBridge={ref2} goBackGesture={goBackGesture} transitionAnimation={transitionAnimation} />;
  return jsx(tmp5(4538).RNSScreensRefContext.Provider, { value: ref });
};
