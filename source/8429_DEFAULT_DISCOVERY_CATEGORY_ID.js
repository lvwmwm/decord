...
// Module 8429 (DEFAULT_DISCOVERY_CATEGORY_ID)
...
let result = 10 * importDefault(dependencyMap[0]).Millis.MINUTE;
const result1 = result.fileFinishedImporting("modules/global_discovery_servers/GlobalDiscoveryServersConstants.tsx");
