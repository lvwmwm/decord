...
let obj = { strategy: require("createExporter").strategies.variadic };
obj = { strategy: require("createExporter").strategies.variadic };
obj = { strategy: require("createExporter").strategies.variadic };
const obj1 = { strategy: require("createExporter").strategies.variadic };
const obj2 = { strategy: require("createExporter").strategies.variadic };
...
export const defineProperty = function defineProperty(arg0, arg1, value) {
  Object.defineProperty(arg0, arg1, { value: value.value });
};
export const createDataProperty = function createDataProperty(arg0, direction, firstDay) {
  const obj = { 9223372036854775807: "Small", 9223372036854775807: "sm", 9223372036854775807: "Placeholder", value: firstDay };
...
export const createMemoizedNumberFormat = require("createExporter").memoize(() => {
  let length;
  const items = [];
  let num = 0;
...
export const createMemoizedDateTimeFormat = require("createExporter").memoize(() => {
  let length;
  const items = [];
  let num = 0;
  if (0 < arguments.length) {
...
export const createMemoizedPluralRules = require("createExporter").memoize(() => {
  let length;
  const items = [];
  let num = 0;
  if (0 < arguments.length) {
...
export const createMemoizedLocale = require("createExporter").memoize(() => {
  let length;
  const items = [];
  let num = 0;
  if (0 < arguments.length) {
...
export const createMemoizedListFormat = require("createExporter").memoize(() => {
  let length;
  const items = [];
  let num = 0;
  if (0 < arguments.length) {
