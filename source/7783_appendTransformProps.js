...
// Dependencies: [7784, 7785, 7786]

// Module 7783 (appendTransformProps)
const require = arg1;
...
function appendTransformProps(arg0) {
  ...
  require(7784) /* append */.appendTransform(x + originX, y + originY, scaleX, scaleY, rotation, skewX, skewY, originX, originY);
}
...
function transformToMatrix(arg0, arr) {
  ...
  const obj = require(7784) /* append */;
  return require(7784) /* append */.toArray();
}
arg5.default = function extractTransform(arr) {
  ...
  if (typeof arr === "string") {
    try {
      const parsed = require(7785) /* peg$SyntaxError */.parse(arr);
      const items = [, , , , , ];
      ...
      const _console = tmp.console;
      _console.error(tmp6);
      return require(7784) /* append */.identity;
    }
  } else {
    let transform;
    if (arr != null) {
...
arg5.extractTransformSvgView = function extractTransformSvgView(transform) {
  if (typeof transform.transform === "string") {
    transform = require(7786) /* peg$SyntaxError */.parse(transform.transform);
    const obj = require(7786) /* peg$SyntaxError */;
  } else {
