...
// Dependencies: [1654, 6408, 6991]

// Module 7018 (useGestureHandler)
const require = arg1;
...
arg5.useGestureHandler = (source, state, gestureSource, onStart, onChange, onEnd, onFinalize) => {
  ...
  obj = { state, State: _require(6408).State, gestureSource, source, onStart };
  R.__closure = obj;
  ...
  obj = { gestureSource, source, state, GESTURE_SOURCE: _require(6991).GESTURE_SOURCE, onEnd };
  C.__closure = obj;
  ...
  obj1 = { gestureSource, source, state, GESTURE_SOURCE: _require(6991).GESTURE_SOURCE, onFinalize };
  T.__closure = obj1;
