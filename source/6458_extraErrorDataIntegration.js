...
// Dependencies: [6424, 6375, 6413, 6374, 6377, 6396, 6368]

// Module 6458 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (!tmp24) {
                if (typeof originalException.toJSON !== "_") {
              ...
              if (callback(6396).DEBUG_BUILD) {
                const logger = callback(6368).logger;
