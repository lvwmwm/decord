...
// Function ID: 95333
// Name: QRCode
// Dependencies: [12178, 12180, 12182, 12183, 12184]
...
prototype.addData = function(arg0) {
  let tmp = require(12178) /* QR8bitByte */;
  tmp = new tmp(arg0);
...
prototype.make = function() {
  ...
  if (this.typeNumber < 1) {
    while (true) {
      ...
      let obj = require(12180) /* QRRSBlock */;
      let rSBlocks = obj.getRSBlocks(num, self.errorCorrectLevel);
      let tmp3 = require(12182) /* QRBitBuffer */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = require(12183) /* items */.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = require(12183) /* items */.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = require(12183) /* items */.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
...
QRCode.createData = (arg0, arg1, arg2) => {
  ...
  let length2;
  let result;
  const rSBlocks = require(12180) /* QRRSBlock */.getRSBlocks(arg0, arg1);
  let tmp = require(12182) /* QRBitBuffer */;
  tmp = new tmp();
  let num = 0;
  if (0 < arg2.length) {
    do {
  ...
  const obj = require(12180) /* QRRSBlock */;
};
QRCode.createBytes = (arg0, arg1) => {
  ...
  if (0 < arg1.length) {
    do {
      ...
      let tmp13 = require(12184) /* QRPolynomial */;
