...
// Dependencies: [19, 17, 7764, 7836, 7766]
// Exports: default

// Module 7835 (offsetComparator)
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
      ...
      while (true) {
        ...
        if (typeof tmp10 === "number") {
          ...
          if (!isNaN(num9)) {
            ...
            let items1 = [num9, 16777215 & tmp10 | Math.round(255 * importDefault(7764)(stopOpacity)) << 24];
    ...
    if (gradientUnits) {
      num12 = importDefault(7836)[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
    ...
    obj[4] = importDefault(7766)(gradientTransform);
    return obj;
  } else {
    return null;
  }
