...
// Dependencies: [8418, 8419, 8420]

// Module 8417 (appendTransformProps)
const require = arg1;
...
function appendTransformProps(arg0) {
  ...
  require(8418) /* append */.appendTransform(x + originX, y + originY, scaleX, scaleY, rotation, skewX, skewY, originX, originY);
}
...
function transformToMatrix(arg0, arr) {
  ...
  const obj = require(8418) /* append */;
  return require(8418) /* append */.toArray();
}
arg5.default = function extractTransform(arr) {
  ...
  if (typeof arr === "string") {
    try {
      const parsed = require(8419) /* peg$SyntaxError */.parse(arr);
      const items = [, , , , , ];
      ...
      const _console = tmp.console;
      _console.error(tmp6);
      return require(8418) /* append */.identity;
    }
  } else {
    let transform;
    if (arr != null) {
...
arg5.extractTransformSvgView = function extractTransformSvgView(transform) {
  if (typeof transform.transform === "string") {
    transform = require(8420) /* peg$SyntaxError */.parse(transform.transform);
    const obj = require(8420) /* peg$SyntaxError */;
  } else {
