...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8584, 8569, 8570]
...
let obj = {
  ...
  value: function render() {
    ...
    const tmp = importDefault(8584);
    const merged1 = Object.assign(self(8569).extractFilter(this.props));
    const obj2 = self(8569);
    const merged2 = Object.assign(self(8569).extractIn(this.props));
