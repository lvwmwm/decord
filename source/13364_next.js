...
// Function ID: 102289
// Name: next
// Dependencies: [6, 7, 77, 57, 13358, 13365, 13366]
...
let obj = {
  value: function next() {
    ...
    let tmp7;
    let tmp8;
    const tmp = this[require(undefined, 13358) /* wrapperForImpl */.iterInternalSymbol];
    ({ kind, index } = tmp);
    const arr = Array.from(tmp.target[require(undefined, 13358) /* wrapperForImpl */.implSymbol]);
    if (index >= arr.length) {
      let obj = { value: undefined, done: true };
      return obj;
    } else {
      tmp.index = index + 1;
      [tmp7, tmp8] = _slicedToArray(arr[index].map(require(13358) /* wrapperForImpl */.tryWrapperForImpl), 2);
      if ("key" === kind) {
        let tmp2 = tmp7;
      } else if ("value" === kind) {
        tmp2 = tmp8;
...
obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(tmp, require(13358) /* wrapperForImpl */.implSymbol)) {
        if (tmp[require(undefined, 13358) /* wrapperForImpl */.implSymbol] instanceof require(13365) /* URLSearchParamsImpl */.implementation) {
          return true;
        }
      }
  ...
  isImpl(getAll) {
    if (getAll) {
      if (getAll instanceof require(13365) /* URLSearchParamsImpl */.implementation) {
        return true;
      } else {
  ...
  createDefaultIterator(self, key) {
    ...
    Object.defineProperty(obj, require(13358) /* wrapperForImpl */.iterInternalSymbol, { value: obj, configurable: true });
    return obj;
  },
  create(arg0, arg1, arg2) {
    if (undefined === arg0[require(undefined, 13358) /* wrapperForImpl */.ctorRegistrySymbol]) {
      ...
      const _URLSearchParams = arg0[require(undefined, 13358) /* wrapperForImpl */.ctorRegistrySymbol].URLSearchParams;
  ...
  setup(wrapper) {
    if (arguments.length > 2) {
      ...
      if (arguments.length > 3) {
        ...
        const _Object = Object;
        obj = {};
        let implementation = require(13365) /* URLSearchParamsImpl */.implementation;
        ...
        if (require(13365) /* URLSearchParamsImpl */.init) {
          require(13365) /* URLSearchParamsImpl */.init(wrapper[require(undefined, 13358) /* wrapperForImpl */.implSymbol], obj);
          const obj3 = require(13365) /* URLSearchParamsImpl */;
        }
        return wrapper;
      }
      obj = {};
  ...
  install(arg0) {
    ...
    arg0[_require(undefined, 13358).ctorRegistrySymbol].URLSearchParams = tmp;
