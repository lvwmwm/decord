...
// Function ID: 4639
// Name: TabsHost
// Dependencies: [32, 109, 19, 17, 21, 4639, 4614, 4640, 4641, 4643]
// Exports: default

// Module 4638 (TabsHost)
...
export default function TabsHost(onNativeFocusChange) {
  ...
  let obj = onNativeFocusChange(4639);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4614).experiment.controlledBottomTabs;
  }
