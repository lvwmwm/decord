...
// Function ID: 59127
// Name: CounterMetric
// Dependencies: [2370821952, 1934519959, 7232, 7230, 7231]

// Module 7333 (CounterMetric)
...
const tmp3 = () => {
  ...
  items[2] = obj;
  return getGlobalSingleton(CounterMetric, items);
}();
const tmp4 = () => {
  class GaugeMetric {
    constructor(arg0) {
  ...
  items[2] = obj;
  return getGlobalSingleton(GaugeMetric, items);
}();
const tmp5 = () => {
  ...
  items[2] = obj;
  return getGlobalSingleton(DistributionMetric, items);
}();
const tmp6 = () => {
  class SetMetric {
    constructor(arg0) {
  ...
  items[2] = obj;
  return getGlobalSingleton(SetMetric, items);
}();
const _moduleResult = _module({}, require("consoleSandbox").COUNTER_METRIC_TYPE, tmp3);
const _moduleResult1 = _module(_module({}, require("consoleSandbox").COUNTER_METRIC_TYPE, tmp3), require("consoleSandbox").GAUGE_METRIC_TYPE, tmp4);

export const CounterMetric = tmp3;
export const DistributionMetric = tmp5;
export const GaugeMetric = tmp4;
export const METRIC_MAP = _module(_module(_module(_module({}, require("consoleSandbox").COUNTER_METRIC_TYPE, tmp3), require("consoleSandbox").GAUGE_METRIC_TYPE, tmp4), require("consoleSandbox").DISTRIBUTION_METRIC_TYPE, tmp5), require("consoleSandbox").SET_METRIC_TYPE, tmp6);
