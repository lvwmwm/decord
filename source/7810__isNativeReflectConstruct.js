...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7811, 7796, 7797]

// Module 7810 (_isNativeReflectConstruct)
...
let obj = {
  ...
  value: function render() {
    ...
    const tmp = importDefault(7811);
    const merged1 = Object.assign(self(7796).extractFilter(this.props));
    const obj2 = self(7796);
    const merged2 = Object.assign(self(7796).extractIn(this.props));
