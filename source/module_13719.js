// Module ID: 13719
// Function ID: 13720
// Dependencies: [41, 42, 32, 13713, 13720, 13721]
...
obj = {
  ...
  isImpl(arg0) {
    if (arg0) {
      if (arg0 instanceof require(13720) /* URLSearchParamsImpl */.implementation) {
        return true;
      } else {
        const _mixedIntoPredicates = module.exports._mixedIntoPredicates;
  ...
  createDefaultIterator(self, key) {
    ...
    Object.defineProperty(obj, require(13713) /* SymbolResult1 */.iterInternalSymbol, { value: obj, configurable: true });
    return obj;
  },
  ...
  setup(wrapper) {
    ...
    const implementation = new require(13720) /* URLSearchParamsImpl */.implementation(arg1, items, obj);
    ...
    if (require(13720) /* URLSearchParamsImpl */.init) {
