...
// Function ID: 7476
// Name: ScopeClass
// Dependencies: [32, 41, 42, 7464, 7476, 7477, 7461, 7468, 7479, 7465, 7454]

// Module 7475 (ScopeClass)
...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      let obj1 = ScopeClass(7464);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(7464);
      ...
      let tmp3Result = tmp3(7476);
      tmp3Result = tmp3(7476);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(7477).updateSession(self._session, obj);
        const obj2 = ScopeClass(7477);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(7476)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(7476);
      obj[0] = ScopeClass(7464).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(7468).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      obj[12] = ScopeClass(7476)._getSpanForScope(self);
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(7479).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      ...
      obj[0] = ScopeClass(7464).generateSpanId();
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(7454).logger;
