...
// Dependencies: [41, 42, 7373, 7368]

// Module 7396 (SentryNonRecordingSpan)
...
const items = [
  {
    ...
    value: function spanContext() {
      return { spanId: this._spanId, traceId: this._traceId, traceFlags: SentryNonRecordingSpan(7368).TRACE_FLAG_NONE };
    }
  },
  {
    key: "end",
