...
// Dependencies: [5, 17, 82, 13679, 13681, 13683, 13684, 13687, 13688, 13701, 13703, 13705, 13706, 13707, 13708, 13689]

// Module 13678 (reactNativeCorePlugins)
...
import module_13687 from "module_13687";
import objectifyError from "objectifyError";
import onSend from "onSend";
import module_13703 from "module_13703";
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL !== "string") {
        ...
        return require(13708) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
