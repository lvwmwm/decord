...
// Function ID: 12930
// Name: Range
// Dependencies: [41, 42, 12901, 12928, 12902, 12904, 12903, 12900, 12930]
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_12901")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(12902).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(12902).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(12903)("hyphen replace", str);
        let str3 = str.replace(tmp11(12904).safeRe[tmp11(undefined, 12904).t.COMPARATORTRIM], tmp11(12904).comparatorTrimReplace);
        tmp11(12903)("comparator trim", str3);
        let str5 = str3.replace(tmp11(12904).safeRe[tmp11(undefined, 12904).t.TILDETRIM], tmp11(12904).tildeTrimReplace);
        tmp11(12903)("tilde trim", str5);
        const str7 = str5.replace(tmp11(12904).safeRe[tmp11(undefined, 12904).t.CARETTRIM], tmp11(12904).caretTrimReplace);
        tmp11(12903)("caret trim", str7);
  ...
  },
  {
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp !== "tee") {
          try {
            tmp = new Range(12900)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(12903)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(12928).ANY) {
