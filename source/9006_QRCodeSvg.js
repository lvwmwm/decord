...
// Function ID: 9007
// Name: QRCodeSvg
// Dependencies: [9003, 19, 8409]

// Module 9006 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(8409) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(8409) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(8409) /* inlineStyles */.Path, { d, fill }));
});
