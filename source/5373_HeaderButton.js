...
// Function ID: 5374
// Name: HeaderButton
// Dependencies: [19, 17, 21, 5356]

// Module 5373 (HeaderButton)
...
const forwardRefResult = require("noop").forwardRef(function HeaderButtonInternal(disabled, ref) {
  ...
  obj[11] = children;
  return jsx(require(5356) /* Animated */.PlatformPressable, { ref, disabled, href, "aria-label": accessibilityLabel, testID, onPress, pressColor, pressOpacity, android_ripple: obj, style: null, hitSlop: null, children: null });
});
