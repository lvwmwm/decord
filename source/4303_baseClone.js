...
// Function ID: 4304
// Name: baseClone
// Dependencies: [606, 599, 4304, 4305, 770, 621, 4306, 4307, 4310, 4314, 4318, 4319, 4320, 775, 4326, 4328, 4330, 792, 4315, 616, 600, 4312]

// Module 4303 (baseClone)
let obj = {};
  ...
  if (!arg2) {
    {
      if (_require(606)(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4304)(arr);
          obj = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4305)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(621)(arr)) {
            return tmp32(4306)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (obj[tmp11]) {
                  tmp14 = tmp32(4320)(arr, tmp11, tmp);
                  obj = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4310);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4314)(obj, arr));
                } else {
                  tmp32Result = tmp32(4318);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4319)(obj, arr));
                }
