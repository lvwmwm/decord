...
// Function ID: 10133
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 10133, 1653, 10110, 10134]
// Exports: ItemRenderer

// Module 10132 (ItemRenderer)
...
export const ItemRenderer = (arg0) => {
  ...
  let obj = require(10133) /* isArraysEqual */;
  ...
  obj = { runOnJS: require(1653) /* cancelAnimation */.runOnJS, setDisplayedItems: tmp4 };
  fn2.__closure = obj;
  fn2.__workletHash = 13763650073050;
  fn2.__initData = visibleRanges;
  const items = [visibleRanges];
  const animatedReaction = require(1653) /* cancelAnimation */.useAnimatedReaction(fn, fn2, items);
  let tmp6 = null;
  if (first) {
    obj = { children: null };
