...
// Function ID: 7545
// Name: normalize
// Dependencies: [32, 7545, 7505, 7506, 7502]
// Exports: normalizeUrlToBase

// Module 7544 (normalize)
...
function visit(arg0, num) {
  ...
  if (arg4 === undefined) {
    memoBuilderResult = require(7545) /* memoBuilder */.memoBuilder();
    let obj = require(7545) /* memoBuilder */;
  }
      ...
      if (str.startsWith("[object ")) {
        if (num.__sentry_skip_normalization__) {
          ...
          if (0 === num) {
            ...
            const convertToPlainObjectResult = require(7505) /* addNonEnumerableProperty */.convertToPlainObject(num);
            let num6 = 0;
