...
let obj = {
  enumerable: true,
  get() {
    return arg1(arg6[0]).typeofJsonValue;
  }
};
...
obj = {
  enumerable: true,
  get() {
    return arg1(arg6[0]).isJsonObject;
  }
};
...
obj = {
  enumerable: true,
  get() {
    return arg1(arg6[1]).base64decode;
  }
};
