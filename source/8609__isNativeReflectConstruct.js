...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8606, 8610, 8611, 8543, 8552]

// Module 8609 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = importDefault(8606)[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = importDefault(8606)[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
