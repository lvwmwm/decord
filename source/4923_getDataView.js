...
arg5.default = {
  isWebpFile(dataView) {
    let tmp = dataView;
    if (tmp) {
      tmp = require(4910) /* getDataView */.getStringFromDataView(dataView, 0, 4) === "RIFF";
      const obj = require(4910) /* getDataView */;
    }
    if (tmp) {
      tmp = require(4910) /* getDataView */.getStringFromDataView(dataView, 8, 4) === "WEBP";
