...
// Dependencies: [5, 41, 42, 93, 95, 98, 19, 17, 21, 81, 8148, 4018, 8150, 8151, 8152, 8170]

// Module 8147 (_isNativeReflectConstruct)
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f115338);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f115338);
    ...
    f115338 = undefined;
    f115338 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8150").NONE, require("module_8150").INVERT, require("module_8150").MONOCHROME, require("module_8150").POSTERIZE, require("module_8150").FALSE, require("module_8150").MAXIMUMCOMPONENT, require("module_8150").MINIMUMCOMPONENT, require("module_8150").CHROME, require("module_8150").FADE, require("module_8150").INSTANT, require("module_8150").MONO, require("module_8150").NOIR, require("module_8150").PROCESS, require("module_8150").TONAL, require("module_8150").TRANSFER, require("module_8150").SEPIA];
...
const items4 = [require("module_8151").CLEARKEY, require("module_8151").FAIRPLAY, require("module_8151").WIDEVINE, require("module_8151").PLAYREADY];
...
const items8 = [require("module_8170").SRT, require("module_8170").TTML, require("module_8170").VTT];
...
export const TextTrackType = require("module_8170");
export const FilterType = require("module_8150");
export const DRMType = require("module_8151");
