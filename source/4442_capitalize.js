...
const fn = function() {
  ...
  function parse(arg0) {
    ...
    if (text1) {
      ...
      const items2 = [, , , , , , , , , , , , , , , , , {}, "Midori", "Nook Browser", "PaleMoon", "PhantomJS", "Raven", "Rekonq", "RockMelt", {}, "SeaMonkey", { INVITE_UPDATE: null, INVITE_DELETE: 0 }, "Sleipnir", "SlimBrowser", {}, "Sunrise", "Swiftfox", "Waterfox", "WebPositive", "Opera Mini", {}, "Opera", {}, "Chrome", { INVITE_UPDATE: null, INVITE_DELETE: null }, {}, {}, {}, {}, "Safari"];
      ...
      obj = { Apple: {}, Archos: {}, Amazon: { 0: "innocent", 9223372036854775807: "innocent" } };
      obj = { Transformer: 1 };
      obj.Asus = obj;
      obj1 = { Nook: 1 };
      ...
      const items4 = ["GUILD_DELETE", "GUILD_EMOJIS_UPDATE", "GUILD_ROLE_CREATE", { INVITE_UPDATE: true, INVITE_DELETE: true }, "Debian", "Fedora", "FreeBSD", "Gentoo", "Haiku", "Kubuntu", "Linux Mint", "OpenBSD", "Red Hat", "SuSE", "Ubuntu", "Xubuntu", "Cygwin", "Symbian OS", "hpwOS", "webOS ", "webOS", "Tablet OS", "Tizen", "Linux", "Mac OS X", "Macintosh", "Mac", "Windows 98;", "Windows "];
      ...
      if ("IE" == text2) {
        ...
        if (!joined) {
          const items7 = [true, true, qualify(text2)];
