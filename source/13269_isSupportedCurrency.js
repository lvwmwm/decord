...
// Dependencies: [13186, 13270]

// Module 13269 (isSupportedCurrency)
const require = arg1;
...
function isSupportedCurrency(arr3, locale) {
  ...
  const memoizedNumberFormat = require(13186) /* _formatToParts */.createMemoizedNumberFormat(str, obj);
...
arg5.getSupportedCurrencies = function getSupportedCurrencies(locale) {
  const items = [];
  const currencies = require(13270).currencies;
  let num = 0;
