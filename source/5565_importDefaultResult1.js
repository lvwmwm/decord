...
// Dependencies: [32, 109, 19, 17, 21, 5478, 5479, 5498, 5538, 5534]
// Exports: FlatList

// Module 5565 (importDefaultResult1)
...
export const FlatList = (ref) => {
  ...
  for (const item10028 of entries) {
    ...
    let NativeWrapperProps = require(5534) /* isGestureEnabled */.NativeWrapperProps;
    let tmp12 = first1;
    let tmp13 = tmp9;
