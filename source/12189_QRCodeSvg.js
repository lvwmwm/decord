...
// Function ID: 95392
// Name: QRCodeSvg
// Dependencies: [12186, 31, 8463]

// Module 12189 (QRCodeSvg)
...
const forwardRefResult = result.forwardRef((obj, ref) => {
  ...
  const element = mod.default.createElement(require(8463) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return mod.default.createElement(require(8463) /* inlineStyles */.Svg, callback({}, obj, obj), element, mod.default.createElement(require(8463) /* inlineStyles */.Path, { d, fill }));
});
