...
// Function ID: 5156
// Name: keysSorter
// Dependencies: [5156, 5157, 1538]

// Module 5155 (keysSorter)
const require = arg1;
...
arg5.stringify = (arg0, arg1) => {
  ...
  const tmp = _require(5157)({ encode: true, strict: true, arrayFormat: "none" }, arg1);
  dependencyMap = tmp;
  _require = tmp;
  ...
  if ("index" === arrayFormat) {
    let fn = (arg0, arg1, arg2) => {
      if (null === arg1) {
        if (!lib.encode) {
          ...
          let encodeURIComponentResult = lib(5156)(arg0);
        } else {
    ...
    fn = "bracket" === arrayFormat ? ((arg0, arg1) => {
      if (null === arg1) {
        ...
        let encodeURIComponentResult2 = lib(5156)(arg0);
      } else {
        const _encodeURIComponent = encodeURIComponent;
      ...
      if (undefined === lib[arg0]) {
        ...
        if (Array.isArray(arr)) {
          ...
          if (!tmp.encode) {
            ...
            let encodeURIComponentResult1 = lib(5156)(arr);
          } else {
            const _encodeURIComponent2 = encodeURIComponent;
