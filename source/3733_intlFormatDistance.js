...
// Dependencies: [3602, 3626, 3627, 3629, 3630, 3632, 3637, 3643, 3440, 3441, 3619]
// Exports: default

// Module 3733 (intlFormatDistance)
...
export default function intlFormatDistance(arg0, arg1, unit) {
  ...
  if (absolute < require(3619) /* keys */.secondsInMinute) {
    ...
    if (absolute1 < tmp6(3619).secondsInHour) {
      ...
      if (absolute3 < tmp6(3619).secondsInWeek) {
        num2 = tmp3.default(defaultResult1, defaultResult2);
        if (num2) {
          const _Math3 = Math;
          str = "day";
      ...
      if (absolute4 < tmp6(3619).secondsInMonth) {
        num2 = tmp9.default(defaultResult1, defaultResult2);
        str = "week";
      } else {
        const _Math8 = Math;
        const absolute5 = Math.abs(defaultResult3);
        if (absolute5 < tmp6(3619).secondsInQuarter) {
          num2 = tmp5.default(defaultResult1, defaultResult2);
          str = "month";
        } else {
          const _Math5 = Math;
          const absolute6 = Math.abs(defaultResult3);
          if (absolute6 < tmp6(3619).secondsInYear) {
