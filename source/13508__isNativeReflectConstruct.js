...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 13509, 8925, 4173]

// Module 13508 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      const items6 = [ParallaxImage(13509).image, style, { position: "relative" }, obj];
      obj3.style = items6;
  ...
  },
  {
    ...
    get() {
      ...
      if (!tmp) {
        ...
        obj[0] = ParallaxImage(13509).loaderContainer;
  ...
  },
  {
    ...
    value: function render() {
      ...
      const items = [this.props.containerStyle, self(13509).container];
      obj[2] = items;
