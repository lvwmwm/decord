...
// Dependencies: [65, 6, 7, 15, 17, 18, 77, 31, 27, 33, 5271, 5255, 5260, 5256, 5272, 5254, 5273, 5274, 5275, 5276, 5277, 5266]
// Exports: default
...
import module_5275 from "module_5275";
...
UIManager.setJSResponder = (prototype, _invoke) => {
  importDefault(5260).handleSetJSResponder(prototype, _invoke);
  fn(prototype, _invoke);
};
UIManager.clearJSResponder = () => {
  const result = importDefault(5260).handleClearJSResponder();
  fn2();
};
const importDefaultResultResult = importDefaultResult({}, require("module_5256").State.UNDETERMINED, undefined);
const importDefaultResultResult1 = importDefaultResult(importDefaultResult({}, require("module_5256").State.UNDETERMINED, undefined), require("module_5256").State.BEGAN, "onBegan");
const importDefaultResultResult2 = importDefaultResult(importDefaultResult(importDefaultResult({}, require("module_5256").State.UNDETERMINED, undefined), require("module_5256").State.BEGAN, "onBegan"), require("module_5256").State.FAILED, "onFailed");
const importDefaultResultResult3 = importDefaultResult(importDefaultResult(importDefaultResult(importDefaultResult({}, require("module_5256").State.UNDETERMINED, undefined), require("module_5256").State.BEGAN, "onBegan"), require("module_5256").State.FAILED, "onFailed"), require("module_5256").State.CANCELLED, "onCancelled");
let closure_12 = importDefaultResult(importDefaultResult(importDefaultResult(importDefaultResult(importDefaultResult(importDefaultResult({}, require("module_5256").State.UNDETERMINED, undefined), require("module_5256").State.BEGAN, "onBegan"), require("module_5256").State.FAILED, "onFailed"), require("module_5256").State.CANCELLED, "onCancelled"), require("module_5256").State.ACTIVE, "onActivated"), require("module_5256").State.END, "onEnded");
