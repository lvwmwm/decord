// Module ID: 12514
// Function ID: 12515
// Dependencies: [5, 12448, 12511, 12515, 12516, 12517, 12510]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12448).util;
    ...
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12510).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12510).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12510).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
