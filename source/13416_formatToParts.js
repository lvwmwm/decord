...
// Function ID: 13417
// Name: formatToParts
// Dependencies: [1281, 13394, 13417, 13412, 13418, 13414]
// Exports: default

// Module 13416 (formatToParts)
import e from "e";
import digitsToString from "digitsToString";

const regExp = new RegExp("^".concat(require("module_13417").S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(require("module_13417").S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13412).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13418).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13414).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
