...
// Dependencies: [1656, 1657, 1660, 1664, 1668]
// Exports: initializeUIRuntime

// Module 1655 (overrideLogFunctionImplementation)
...
function overrideLogFunctionImplementation() {
  let obj = require(1657) /* addLogBoxLog */;
  const fn = function e(arg0) {
    callback(1660).runOnJS(callback(1657).logToLogBoxAndConsole)(arg0);
  };
  obj = { runOnJS: require(1660) /* runWorkletOnJS */.runOnJS, logToLogBoxAndConsole: require(1657) /* addLogBoxLog */.logToLogBoxAndConsole };
  fn.__closure = obj;
...
function setupConsole() {
  if (!isJest) {
    ...
    obj[0] = require(1660) /* runWorkletOnJS */.runOnJS(closure_9.assert);
    const obj2 = require(1660) /* runWorkletOnJS */;
    obj[1] = require(1660) /* runWorkletOnJS */.runOnJS(closure_9.debug);
    const obj3 = require(1660) /* runWorkletOnJS */;
    obj[2] = require(1660) /* runWorkletOnJS */.runOnJS(closure_9.log);
    const obj4 = require(1660) /* runWorkletOnJS */;
    obj[3] = require(1660) /* runWorkletOnJS */.runOnJS(closure_9.warn);
    const obj5 = require(1660) /* runWorkletOnJS */;
    obj[4] = require(1660) /* runWorkletOnJS */.runOnJS(closure_9.error);
    const obj6 = require(1660) /* runWorkletOnJS */;
    obj[5] = require(1660) /* runWorkletOnJS */.runOnJS(closure_9.info);
    global.console = obj;
    const obj7 = require(1660) /* runWorkletOnJS */;
  }
}
...
export const initializeUIRuntime = function initializeUIRuntime(ReanimatedModule) {
  let obj = require(1656) /* isJest */;
  if (!obj.isWeb()) {
    if (ReanimatedModule) {
      if (isJest) {
        const _globalThis = globalThis;
        globalThis.requestAnimationFrame = tmp(1668).mockedRequestAnimationFrame;
      }
      const fn = function o() {
