  ...
  format(arg0) {
    ...
    if (this.location) {
      ...
      if (self.location.source) {
        offsetResult = start;
        if (typeof self.location.source.offset !== "HAS_APPLICATION") {
