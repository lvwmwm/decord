...
// Dependencies: [5, 77, 4138, 4139]

// Module 4137 (importDefaultResult1)
...
let obj = {
    ...
    if (arguments.length > 0) {
      ...
      if (arguments.length > 1) {
        ...
        if (c6) {
          ...
          importDefault(4139).trigger(selection, Object.assign({}, closure_5, tmp2));
          const obj2 = importDefault(4139);
        }
      }
      obj = {};
    }
    selection = require(4138) /* isRingerSilent */.HapticFeedbackTypes.selection;
  },
  stop() {
    if (c6) {
      importDefault(4139).stop();
      const obj = importDefault(4139);
    }
  },
  isSupported() {
    return importDefault(4139).isSupported();
  },
  triggerPattern(arg0) {
    if (arguments.length > 1) {
      if (c6) {
        let obj = importDefault(4139);
        const _Object = Object;
        obj = {};
  ...
  playAHAP(arg0) {
    if (c6) {
      return importDefault(4139).playAHAP(arg0);
    } else {
    ...
    if (arguments.length > 0) {
      ...
      if (arguments.length > 2) {
        ...
        if (c6) {
          ...
          const items = [obj];
          const _Object = Object;
          importDefault(4139).triggerPattern(items, Object.assign({}, closure_5, tmp2));
          const obj2 = importDefault(4139);
        }
      }
      obj = {};
    }
    impactMedium = require(4138) /* isRingerSilent */.HapticFeedbackTypes.impactMedium;
  }
};
