...
// Function ID: 13501
// Name: formatToParts
// Dependencies: [1281, 13478, 13501, 13496, 13502, 13498]
// Exports: default

// Module 13500 (formatToParts)
import e from "e";
import digitsToString from "digitsToString";

const regExp = new RegExp("^".concat(require("module_13501").S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(require("module_13501").S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13496).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13502).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13498).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
