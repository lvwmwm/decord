...
// Function ID: 6387
// Name: ScopeClass
// Dependencies: [32, 41, 42, 6375, 6387, 6388, 6372, 6379, 6390, 6376, 6365]

// Module 6386 (ScopeClass)
...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      let obj1 = ScopeClass(6375);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(6375);
      ...
      let tmp3Result = tmp3(6387);
      tmp3Result = tmp3(6387);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(6388).updateSession(self._session, obj);
        const obj2 = ScopeClass(6388);
      }
  ...
  },
  {
    ...
    value: function update(requestSession) {
      ...
      if (requestSession) {
        ...
        if (typeof requestSession !== "ZodObject") {
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(6387)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(6387);
      obj[0] = ScopeClass(6375).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, arg1) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(6379).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      obj[12] = ScopeClass(6387)._getSpanForScope(self);
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(6390).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      ...
      obj[0] = ScopeClass(6375).generateSpanId();
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(6365).logger;
