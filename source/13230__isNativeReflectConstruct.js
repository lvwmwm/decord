...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 13231, 4014, 8148]
...
let items = [
  ...
  },
  {
    ...
    value: function render() {
      ...
      const items4 = [PaginationDot(13231).sliderPaginationDotContainer, ];
      if (!containerStyle) {
        containerStyle = {};
      }
      items4[1] = containerStyle;
      const items5 = [PaginationDot(13231).sliderPaginationDot, , , , ];
      if (!style) {
        style = {};
      }
      items5[1] = style;
