...
// Function ID: 5477
// Name: useScrollable
// Dependencies: [19, 1653, 5461, 5477]
// Exports: useScrollable

// Module 5476 (useScrollable)
...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(require(5461) /* GESTURE_SOURCE */.SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = require(1653) /* cancelAnimation */.useSharedValue(0);
  const obj2 = require(1653) /* cancelAnimation */;
  const sharedValue2 = require(1653) /* cancelAnimation */.useSharedValue(require(5461) /* GESTURE_SOURCE */.SCROLLABLE_STATE.UNDETERMINED);
