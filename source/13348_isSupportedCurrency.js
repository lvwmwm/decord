...
// Dependencies: [13265, 13349]

// Module 13348 (isSupportedCurrency)
const require = arg1;
...
function isSupportedCurrency(arr3, locale) {
  ...
  try {
    ...
    obj[2] = arr3;
    const memoizedNumberFormat = require(13265) /* _formatToParts */.createMemoizedNumberFormat(str, obj);
...
arg5.getSupportedCurrencies = function getSupportedCurrencies(locale) {
  const items = [];
  const currencies = require(13349).currencies;
