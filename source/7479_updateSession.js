...
// Function ID: 7480
// Name: updateSession
// Dependencies: [7455, 7456, 7480, 7470, 7467, 7462]
// Exports: closeSession, makeSession

// Module 7479 (updateSession)
...
function updateSession(ipAddress) {
  ...
  if (!timestamp) {
    timestamp = require(7470) /* dateTimestampInSeconds */.timestampInSeconds();
    const obj2 = require(7470) /* dateTimestampInSeconds */;
  }
  ...
  if (!obj.sid) {
    ...
    if (32 === obj.sid.length) {
      ...
      sid = require(7467) /* addContextToFrame */.uuid4();
