...
// Dependencies: [7994, 7995, 7996]

// Module 7993 (appendTransformProps)
import append from "append" /* 7994 */;
import peg$SyntaxError from "peg$SyntaxError" /* 7995 */;
import peg$SyntaxError2 from "peg$SyntaxError" /* 7996 */;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(7995);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(7994);
