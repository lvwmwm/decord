...
const uint32Array = new Uint32Array(["isArray", "isArray", "bm", "i", "duration", "track", "surrogates", "Text", "isArray", "isArray", "resolve", "a", "round", "LengthDelimited", "textAlign", "Text", "isArray", "isArray", "delete", "now", "resolve", "registerAsset", "textAlign", "Text", "isArray", "isArray", "height", "lc", "opacity", "description", "transform", "Text", "current", "concat", "height", "cix", "values", "h", "next", "index", "value", "type", "unicodeVersion", "Object", "s", "_desired", "count", "__packager_asset", "t", "location", "ml", "lc", "i", "lj", "Boolean", "op", "PX_16", "set", "np", "right", "st", "_oneway", "paths", "hasDiversityParent"]);
const uint32Array1 = new Uint32Array(["<string:3023192129>", "<string:2680059592>", "<string:3544206554>", "<string:1477468749>", "<string:1900024377>", "isArray", "identifyCompressedByteSize", "jfifDataOffset"]);
