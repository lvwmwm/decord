...
try {
  ...
  try {
    ...
    _module2.ghQueueMicrotask(() => {
      const NativeProxy = require(5471) /* n */.NativeProxy;
      if (!NativeProxy.installUIRuntimeBindings()) {
        const _console = console;
        console.warn(require(5432) /* tagMessage */.tagMessage("Failed to install UI runtime bindings. Please report this at https://github.com/software-mansion/react-native-gesture-handler/issues."));
        const tmpResult = require(5432) /* tagMessage */;
      }
    });
    let useSharedValue;
    if (_module != null) {
    ...
    if (!setGestureState) {
      const fn2 = function o() {
        console.warn(require(5432) /* tagMessage */.tagMessage("Please use newer version of react-native-reanimated in order to control state of the gestures."));
      };
