...
// Module 13063 (SetNumberFormatDigitOptions)
arg5.SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(internalSlots, result1, minimumFractionDigits, arg3, GetOptionResult1) {
  ...
  GetOptionResult1 = result1(arg6[2]).GetOption(result1, "roundingPriority", "string", ["%DatePrototype%", "tidaWebformEnabled", "animationOptimizationsEnabled"], "auto");
  const GetOptionResult = result1(arg6[2]).GetOption(result1, "roundingMode", "string", ["<string:3395506552>", null, null, null, null, null, null, "DARK", "DARK"], "halfExpand");
  ...
  internalSlots.trailingZeroDisplay = result1(arg6[2]).GetOption(result1, "trailingZeroDisplay", "string", [0, 0.659], "auto");
  let flag = true;
  let flag2 = true;
