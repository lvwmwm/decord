// Module ID: 12940
// Function ID: 12941
// Dependencies: [12934, 12905, 12925]

// Module 12940

export default (arg0, arg1) => {
  let require;
  let obj = new require(12934) /* Range */(arg0, arg1);
  const tmp3 = new require(12905) /* SemVer */("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(12905)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
        ...
        do {
          ...
          if (require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = require;
              tmp16 = !require(12925) /* SemVer */(tmp14, require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
