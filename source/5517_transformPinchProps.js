...
// Module 5517 (transformPinchProps)
const require = arg1;
...
arg5.usePinchGesture = function usePinchGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(5495) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformPinchProps);
  const obj = require(5495) /* isGestureEnabled */;
  return require(5510) /* useGesture */.useGesture(require(5486) /* ComposedGestureName */.SingleGestureName.Pinch, clonedAndRemappedConfig);
};
