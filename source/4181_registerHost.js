...
// Function ID: 4182
// Name: registerHost
// Dependencies: [4182, 4177]

// Module 4181 (registerHost)
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (portalName(4177).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4177).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4177).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4177).ACTIONS.REMOVE_PORTAL === type) {
