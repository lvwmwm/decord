...
// Function ID: 1801
// Name: isAnimated
// Dependencies: [1679, 1665]

// Module 1800 (isAnimated)
let isAnimated = arg1;
...
function validateAnimatedStyles(obj) {
  if (typeof obj !== "object") {
    ...
    const reanimatedError = new isAnimated(1665).ReanimatedError("`useAnimatedStyle` has to return an object, found " + typeof obj + " instead.");
    throw reanimatedError;
  } else {
    const _Array = Array;
    if (Array.isArray(obj)) {
      const reanimatedError1 = new isAnimated(1665).ReanimatedError("`useAnimatedStyle` has to return an object and cannot return static styles combined with dynamic ones. Please do merging where a component receives props.");
