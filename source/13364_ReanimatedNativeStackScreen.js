...
// Module 13364 (ReanimatedNativeStackScreen)
let closure_3 = [906643286];
...
const forwardRefResult = importDefaultResult.forwardRef((children, ref) => {
  ...
  obj.onTransitionProgressReanimated = ref(dependencyMap[4]).useEvent(pnpm_ReanimatedNativeStackScreenTsx1, [94527]);
  ...
  obj.onHeaderHeightChangeReanimated = ref(dependencyMap[4]).useEvent(pnpm_ReanimatedNativeStackScreenTsx2, ["google_sku_ids"]);
  obj = {};
