...
// Dependencies: [6, 7, 15, 17, 18, 31, 27, 33, 15232]
// Exports: captureScreen

// Module 15231 (_isNativeReflectConstruct)
...
function captureRef(current, options) {
  ...
  return importDefault(15232).captureRef(tmp8, tmp15.options);
}
function releaseCapture(arg0) {
  if ("string" === typeof arg0) {
    importDefault(15232).releaseCapture(arg0);
    const obj = importDefault(15232);
  }
}
...
export const captureScreen = function captureScreen(options) {
  ...
  return importDefault(15232).captureScreen(tmp2.options);
};
