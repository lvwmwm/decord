...
const fn = function() {
  ...
  let closure_3 = [];
  let closure_4 = ["avif", "M4V", "M4A", 255, 241, 255, 249, 35, 33, 65, 77, 82, 102];
  obj.date = (str) => {
    if (undefined === arg1) {
      const _Date3 = Date;
      let date = new Date();
    ...
    let closure_5 = {
      ...
      S() {
        ...
        if (jResult <= 4) {
          let str = { borderTopStartRadius: "lightAppearance", borderTopEndRadius: "%NumberPrototype%", display: "COPY_INSTANT_INVITE" }[jResult % 10] || "th";
          const tmp2 = { borderTopStartRadius: "lightAppearance", borderTopEndRadius: "%NumberPrototype%", display: "COPY_INSTANT_INVITE" }[jResult % 10] || "th";
        } else {
          str = "th";
        }
        return str;
  ...
  obj.ordinal = (replaced) => {
    ...
    if (result <= 4) {
      let str2 = { borderTopStartRadius: "lightAppearance", borderTopEndRadius: "%NumberPrototype%", display: "COPY_INSTANT_INVITE" }[absolute % 10] || "th";
      const tmp5 = { borderTopStartRadius: "lightAppearance", borderTopEndRadius: "%NumberPrototype%", display: "COPY_INSTANT_INVITE" }[absolute % 10] || "th";
    } else {
      str2 = "th";
    }
    return sum + str2;
