...
// Dependencies: [65, 57, 5, 6355, 6358, 6365]
// Exports: makeMultiplexedTransport

// Module 6378 (eventFromEnvelope)
...
function eventFromEnvelope(arg0, arg1) {
  const _require = arg1;
  _require(6355).forEachEnvelopeItem(arg0, (arg0, arg1) => {
    ...
    function getTransport(arg0, assign) {
      ...
      if (value) {
        ...
        if (dsnFromStringResult) {
          let envelopeEndpointWithUrlEncodedAuth = lib(6365).getEnvelopeEndpointWithUrlEncodedAuth(dsnFromStringResult, lib.tunnel);
          let tmp11 = lib;
          obj = globalThis;
          if (assign) {
            ...
            let tmp11Result = (function makeOverrideReleaseTransport(arg0, assign) {
              ...
              return (arg0) => {
                ...
                let closure_1 = tmp;
                const obj = {};
                callback = outer4_4(/* F57419 */ function*() { ... });
