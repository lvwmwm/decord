...
// Function ID: 13408
// Name: formatToParts
// Dependencies: [1281, 13385, 13408, 13403, 13409, 13405]
// Exports: default

// Module 13407 (formatToParts)
import e from "e";
import digitsToString from "digitsToString";

const regExp = new RegExp("^".concat(require("module_13408").S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(require("module_13408").S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13403).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13409).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13405).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
