// Module ID: 4740
// Function ID: 4741
// Dependencies: [109, 19, 17, 21, 4738, 4729, 4722, 4741, 4728, 4744, 4717]
...
export default importAllResult.forwardRef(function ScreenStackItem(unstable_sheetFooter, ref) {
  ...
  importDefault(4722)(flag5, "[RNScreens] Using both `blurEffect` and `scrollEdgeEffects` simultaneously may cause overlapping effects.");
  ...
  obj[1] = callback(importDefault(4741), { contentStyle, style: container, stackPresentation, children });
  ...
  const tmp11 = importDefault(4722);
  ...
  return callback(importDefault(4717), obj2);
});
