...
// Dependencies: [7346, 7347, 7391, 7394, 7383, 7352]
// Exports: createEventEnvelope, createSessionEnvelope, createSpanEnvelope

// Module 7390 (createEventEnvelope)
...
export const createEventEnvelope = function createEventEnvelope(type, arg1, sdk) {
  const sdkMetadataForEnvelopeHeader = require(7391) /* forEachEnvelopeItem */.getSdkMetadataForEnvelopeHeader(sdk);
  let str = "event";
  if (type.type) {
    str = "event";
...
export const createSessionEnvelope = function createSessionEnvelope(toJSON) {
  let obj = require(7391) /* forEachEnvelopeItem */;
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    const obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(7394).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(7394);
  }
