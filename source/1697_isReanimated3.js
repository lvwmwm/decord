...
export const registerEventHandler = function registerEventHandler(eventHandler) {
  ...
  const ReanimatedModule = require(1661) /* ReanimatedModule */.ReanimatedModule;
  return ReanimatedModule.registerEventHandler(require(1683) /* freezeObjectInDev */.makeShareableCloneRecursive(handleAndFlushAnimationFrame), arg1, num);
};
...
export const subscribeForKeyboardEvents = function subscribeForKeyboardEvents(eventHandler, isStatusBarTranslucentAndroid) {
  ...
  const shareableCloneRecursive = require(1683) /* freezeObjectInDev */.makeShareableCloneRecursive(handleAndFlushAnimationFrame);
...
export const registerSensor = function registerSensor(arg0, arg1, arg2) {
  if (!global.__sensorContainer) {
    const sensorContainer = new require(1699) /* SensorContainer */.SensorContainer();
    tmp.__sensorContainer = sensorContainer;
  }
  const __sensorContainer = tmp.__sensorContainer;
  return __sensorContainer.registerSensor(arg0, arg1, require(1683) /* freezeObjectInDev */.makeShareableCloneRecursive(arg2));
};
...
export const enableLayoutAnimations = function enableLayoutAnimations(enableLayoutAnimations) {
  ...
  if (flag) {
    ...
    const ReanimatedModule2 = require(1661) /* ReanimatedModule */.ReanimatedModule;
