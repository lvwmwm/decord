...
// Function ID: 7440
// Name: normalize
// Dependencies: [32, 7440, 7400, 7401, 7397]
// Exports: normalizeUrlToBase

// Module 7439 (normalize)
...
function visit(arg0, num) {
  ...
  if (arg4 === undefined) {
    memoBuilderResult = require(7440) /* memoBuilder */.memoBuilder();
    let obj = require(7440) /* memoBuilder */;
  }
      ...
      if (str.startsWith("[object ")) {
        if (num.__sentry_skip_normalization__) {
          ...
          if (0 === num) {
            ...
            const convertToPlainObjectResult = require(7400) /* addNonEnumerableProperty */.convertToPlainObject(num);
            let num6 = 0;
