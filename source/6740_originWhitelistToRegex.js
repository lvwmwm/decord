...
// Dependencies: [31, 27, 33, 6741, 6742]
// Exports: defaultRenderError, defaultRenderLoading, useWebWiewLogic

// Module 6740 (originWhitelistToRegex)
...
function originWhitelistToRegex(arg0) {
  return "^".concat(importDefault(6741)(arg0).replace(/\\\*/g, ".*"));
}
...
export const defaultRenderLoading = function defaultRenderLoading() {
  return callback(closure_7, { style: importDefault(6742).loadingOrErrorView, children: callback(closure_8, {}) });
};
export const defaultRenderError = function defaultRenderError(arg0, arg1, arg2) {
  let obj = { style: importDefault(6742).loadingOrErrorView };
  obj = { style: importDefault(6742).errorTextTitle, children: "Error loading page" };
  const items = [callback(closure_9, obj), , , ];
  obj = { style: importDefault(6742).errorText, children: "Domain: ".concat(arg0) };
  items[1] = callback(closure_9, obj);
  items[2] = callback(closure_9, { style: importDefault(6742).errorText, children: "Error Code: ".concat(arg1) });
  const obj1 = { style: importDefault(6742).errorText, children: "Error Code: ".concat(arg1) };
  items[3] = callback(closure_9, { style: importDefault(6742).errorText, children: "Description: ".concat(arg2) });
  obj.children = items;
