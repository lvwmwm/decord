  ...
  items[7] = {
    ...
    value: function getLayout(arg0) {
      ...
      if (arg0 >= this.layouts.length) {
        ...
        if (!tmp) {
          const obj = { <string:80573440>: "r", <string:80533760>: "onRequireModeratorMFAClick", <string:80487680>: "Array", <string:80573184>: "isSpamMessageRequest" };
