...
// Dependencies: [6447, 6448, 6449, 6372, 6410, 6374, 6364, 6365, 6371]

// Module 6446 (extractRequestData)
const require = arg1;
  ...
  if (!obj.customRoute) {
    if (!method.route) {
      ...
      if (tmp) {
        ...
        str5 = require(6447) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
        str4 = "url";
        const obj2 = require(6447) /* getNumberOfUrlSegments */;
      }
...
arg5.httpRequestToRequestData = function httpRequestToRequestData(headers) {
  ...
  return require(6371) /* addNonEnumerableProperty */.dropUndefinedKeys(obj);
};
