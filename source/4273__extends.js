...
// Function ID: 4274
// Name: _extends
// Dependencies: [19, 4274, 1229, 1230, 1223, 4277]

// Module 4273 (_extends)
...
export const MemoryRouter = Component2(4277).Redirect;
export const Prompt = Component2(4277).Redirect;
export const Redirect = Component2(4277).Redirect;
export const Route = Component2(4277).Route;
export const Router = Component2(4277).Router;
export const StaticRouter = Component2(4277).StaticRouter;
export const Switch = Component2(4277).Switch;
export const generatePath = Component2(4277).generatePath;
export const matchPath = Component2(4277).matchPath;
export const useHistory = Component2(4277).useHistory;
export const useLocation = Component2(4277).useLocation;
export const useParams = Component2(4277).useParams;
export const useRouteMatch = Component2(4277).useRouteMatch;
export const withRouter = Component2(4277).withRouter;
