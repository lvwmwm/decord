...
// Function ID: 7416
// Name: ScopeClass
// Dependencies: [32, 41, 42, 7404, 7416, 7417, 7401, 7408, 7419, 7405, 7394]

// Module 7415 (ScopeClass)
...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      let obj1 = ScopeClass(7404);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(7404);
      ...
      let tmp3Result = tmp3(7416);
      tmp3Result = tmp3(7416);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(7417).updateSession(self._session, obj);
        const obj2 = ScopeClass(7417);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(7416)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(7416);
      obj[0] = ScopeClass(7404).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(7408).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      obj[12] = ScopeClass(7416)._getSpanForScope(self);
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(7419).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      ...
      obj[0] = ScopeClass(7404).generateSpanId();
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(7394).logger;
