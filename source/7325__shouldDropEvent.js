...
// Dependencies: [7264, 7236, 7292, 7239]

// Module 7325 (_shouldDropEvent)
...
function _isSameStacktrace(arg0, arg1) {
  const framesFromEvent = require(7239) /* createStackParser */.getFramesFromEvent(arg0);
  const obj = require(7239) /* createStackParser */;
  const framesFromEvent1 = require(7239) /* createStackParser */.getFramesFromEvent(arg1);
  if (!framesFromEvent) {
    if (!framesFromEvent1) {
      return true;
    }
