...
// Dependencies: [32, 7483, 7489, 7478, 7491, 7461, 7473, 7474, 7475, 7468, 7466, 7484, 7456, 7488, 7492, 7494, 7485, 7495, 7497, 7471]
// Exports: continueTrace, startInactiveSpan, startNewTrace, startSpan, startSpanManual, suppressTracing, withActiveSpan

// Module 7490 (createChildOrRootSpan)
...
function _startRootSpan(name) {
  ...
  obj1.attributes = { [require(7471).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE]: "custom" };
  obj1.sampled = tmp6;
...
export const continueTrace = (arg0, arg1) => {
  ...
  let dependencyMap;
  const _require = arg1;
  const mainCarrier = _require(7474).getMainCarrier();
  const obj = _require(7474);
  const tmp = _require;
  const asyncContextStrategy = _require(7475).getAsyncContextStrategy(mainCarrier);
...
export const startNewTrace = function startNewTrace(arg0) {
  const _require = arg0;
  return _require(7483).withScope((setPropagationContext) => {
