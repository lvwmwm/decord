...
// Dependencies: [41, 42, 93, 95, 98, 19, 5435, 5411, 5426, 5424]

// Module 5434 (_isNativeReflectConstruct)
...
let obj = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(5411).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  obj,
