...
// Module 6354 (createEventEnvelope)
...
export const createEventEnvelope = function createEventEnvelope(type, arg1, sdk) {
  let obj = require(6355) /* forEachEnvelopeItem */;
  ...
  const eventEnvelopeHeaders = require(6355) /* forEachEnvelopeItem */.createEventEnvelopeHeaders(type, sdkMetadataForEnvelopeHeader, arg3, arg1);
  delete tmp.sdkProcessingMetadata;
  obj = { type: str };
  const items2 = [obj, type];
  const obj2 = require(6355) /* forEachEnvelopeItem */;
  const items3 = [items2];
  return require(6355) /* forEachEnvelopeItem */.createEnvelope(eventEnvelopeHeaders, items3);
};
export const createSessionEnvelope = function createSessionEnvelope(toJSON) {
  ...
  if (tmp4) {
    const obj1 = { dsn: require(6358) /* dsnFromString */.dsnToString(arg1) };
    tmp4 = obj1;
    const obj6 = require(6358) /* dsnFromString */;
  }
  const obj2 = {};
  ...
  const date = new Date();
  const items2 = [items1];
  return require(6355) /* forEachEnvelopeItem */.createEnvelope(merged, items2);
};
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  let num = arg0;
  let obj = beforeSendSpan(6347);
  ...
  if (tmp6) {
    const obj1 = { dsn: beforeSendSpan(6358).dsnToString(dsn) };
    tmp6 = obj1;
    const obj6 = beforeSendSpan(6358);
  }
