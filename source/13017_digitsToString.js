  ...
  function config(defaults) {
    ...
    if (defaults) {
      if ("object" === typeof defaults) {
        const items = ["persistantItemData", "markRenderYielded", 1000000000, "rounding", 0, 8, "toExpNeg", -9000000000000000, 0, "toExpPos", 0, 9000000000000000, "maxE", 0, 9000000000000000, "minE", -9000000000000000, 0, "modulo", 0, 9];
        let num = 0;
        if (0 < items.length) {
          while (true) {
            tmp = items[num];
