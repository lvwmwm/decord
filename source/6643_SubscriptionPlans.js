...
let obj = { GENERIC_SUBSCRIPTION: require(dependencyMap[1]).AppleProductIds.GENERIC_SUBSCRIPTION, GENERIC_CONSUMABLE: require(dependencyMap[1]).AppleProductIds.GENERIC_CONSUMABLE };
