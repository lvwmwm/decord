...
// Dependencies: [5, 41, 42, 93, 95, 98, 19, 17, 21, 81, 8812, 4126, 8814, 8815, 8816, 8834]
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f116067);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f116067);
    ...
    f116067 = undefined;
    f116067 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8814").NONE, require("module_8814").INVERT, require("module_8814").MONOCHROME, require("module_8814").POSTERIZE, require("module_8814").FALSE, require("module_8814").MAXIMUMCOMPONENT, require("module_8814").MINIMUMCOMPONENT, require("module_8814").CHROME, require("module_8814").FADE, require("module_8814").INSTANT, require("module_8814").MONO, require("module_8814").NOIR, require("module_8814").PROCESS, require("module_8814").TONAL, require("module_8814").TRANSFER, require("module_8814").SEPIA];
...
const items4 = [require("module_8815").CLEARKEY, require("module_8815").FAIRPLAY, require("module_8815").WIDEVINE, require("module_8815").PLAYREADY];
...
const items8 = [require("module_8834").SRT, require("module_8834").TTML, require("module_8834").VTT];
...
export const TextTrackType = require("module_8834");
export const FilterType = require("module_8814");
export const DRMType = require("module_8815");
