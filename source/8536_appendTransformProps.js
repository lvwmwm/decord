...
// Dependencies: [8537, 8538, 8539]

// Module 8536 (appendTransformProps)
const require = arg1;
...
function appendTransformProps(arg0) {
  ...
  require(8537) /* append */.appendTransform(x + originX, y + originY, scaleX, scaleY, rotation, skewX, skewY, originX, originY);
}
...
function transformToMatrix(arg0, arr) {
  ...
  const obj = require(8537) /* append */;
  return require(8537) /* append */.toArray();
}
arg5.default = function extractTransform(transform) {
  ...
  if (typeof transform === "y") {
    try {
      const parsed = require(8538) /* peg$SyntaxError */.parse(transform);
      const items = [, , , , , ];
      ...
      const _console = tmp.console;
      _console.error(tmp6);
      return require(8537) /* append */.identity;
    }
  } else {
    transform = undefined;
    if (transform != null) {
...
arg5.extractTransformSvgView = function extractTransformSvgView(transform) {
  if (typeof transform.transform === "y") {
    transform = require(8539) /* peg$SyntaxError */.parse(transform.transform);
    const obj = require(8539) /* peg$SyntaxError */;
  } else {
    transform = transform.transform;
  }
  return transform;
