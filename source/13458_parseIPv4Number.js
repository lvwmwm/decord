...
// Dependencies: [13459, 13460, 511, 13461]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    if ("]" !== buffer[buffer.length - 1]) {
      ...
      const ucs22 = require(13459) /* error */.ucs2;
                  ...
                  if (undefined === decodeResult[diff3]) {
                    ...
                    while (true) {
                      ...
                      if (0 >= num18) {
                        ...
                        let obj6 = require(13460);
                        if (obj6.isASCIIDigit(decodeResult[sum7])) {
                          let tmp49Result = tmp49(13460);
                          let tmp51 = null;
                          let tmp52 = sum7;
                          let tmp53 = null;
                          let tmp54 = sum7;
    ...
    if (-1 !== buffer.search(/\u0000|\u0009|\u000A|\u000D|\u0020|#|\/|:|\?|@|\[|\\|\]/)) {
      ...
      const ucs2 = require(13459) /* error */.ucs2;
          ...
          if (tmp8) {
            ...
            if (0 < fromResult.length) {
              do {
                ...
                let obj3 = require(13461) /* replaceByteInByteSequence */;
    ...
    let str = require(13461) /* replaceByteInByteSequence */.percentDecode(_Buffer.from(buffer));
    str = str.toString();
    if (null === str) {
      str = closure_4;
    }
    ...
    const obj = require(13461) /* replaceByteInByteSequence */;
  }
}
      ...
      if (47 !== arg0) {
        ...
        if (undefined === closure_3[self.url.scheme]) {
          ...
          if (!tmp) {
            ...
            if (isASCIIHexResult) {
              tmp2Result = require("module_13460");
              num6 = 2;
    ...
    if (63 === arg0) {
      ...
      if (35 === arg0) {
        ...
        if (!tmp2) {
          ...
          isASCIIHexResult = obj.isASCIIHex(self.input[self.pointer + 1]);
          if (isASCIIHexResult) {
            tmp3Result = require("module_13460");
            num4 = 2;
    ...
    if (!isNaN(arg0)) {
      ...
      if (0 === arg0) {
        ...
        if (!tmp4) {
          ...
          isASCIIHexResult = obj.isASCIIHex(self.input[self.pointer + 1]);
          if (isASCIIHexResult) {
            tmpResult = require("module_13460");
            num3 = 2;
    ...
    if (hasItem) {
      ...
      if (0 < fromResult.length) {
        do {
          ...
          let obj = require(13461) /* replaceByteInByteSequence */;
