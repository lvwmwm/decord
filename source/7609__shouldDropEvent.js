...
// Dependencies: [7548, 7520, 7576, 7523]

// Module 7609 (_shouldDropEvent)
        ...
        if (message) {
          ...
          if (message === message2) {
            ...
            if (_isSameFingerprint(message, message2)) {
              const framesFromEvent = require(7523) /* createStackParser */.getFramesFromEvent(message);
              const obj = require(7523) /* createStackParser */;
              const framesFromEvent1 = require(7523) /* createStackParser */.getFramesFromEvent(message2);
              if (framesFromEvent) {
                if (!framesFromEvent) {
                  if (framesFromEvent) {
                    let flag2 = false;
              ...
              const obj2 = require(7523) /* createStackParser */;
            }
          }
        } else {
          flag = false;
        ...
        if (iter2) {
          ...
          if (iter.type === iter2.type) {
            ...
            if (iter.value === iter2.value) {
              flag3 = false;
              if (_isSameFingerprint(message, message2)) {
                const framesFromEvent2 = require(7523) /* createStackParser */.getFramesFromEvent(message);
                const obj3 = require(7523) /* createStackParser */;
                const framesFromEvent3 = require(7523) /* createStackParser */.getFramesFromEvent(message2);
                if (framesFromEvent2) {
                  if (!framesFromEvent2) {
                    if (framesFromEvent2) {
                      let flag4 = false;
                ...
                const obj4 = require(7523) /* createStackParser */;
              }
            }
          }
        }
