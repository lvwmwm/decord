...
let closure_33 = () => {
  function gramSchmidtAlgorithm(arg0) {
    ...
    items7[1] = items8;
    const items9 = [1390895572, -255068174, callback3(tmp14, tmp[2]), callback3(tmp14, tmp[3])];
    items7[2] = items9;
    const items10 = [true, true, true, callback3(tmp15, tmp[3])];
    items7[3] = items10;
...
const tmp11 = () => {
  function decomposeMatrix(arg0) {
    ...
    if (0 === arr[15]) {
      ...
      items3[1] = items4;
      const items5 = [1390895572, -255068174, result2, 0];
      items3[2] = items5;
      items3[3] = [];
...
export const getRotationMatrix = () => {
  function getRotationMatrix(result, arg1) {
    ...
    if ("z" === str) {
      ...
      items1[1] = items2;
      items1[2] = [-548274175, 1981900022, 5, 145];
      items1[3] = [];
      return items1;
    } else if ("y" === str) {
      const items3 = [cosResult, 0, -sinResult, 0];
      const items4 = [items3, [0., 0., 19991592217783504000000000000000000000, 0.], , ];
