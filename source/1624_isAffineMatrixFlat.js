...
let closure_33 = () => {
  function gramSchmidtAlgorithm(arg0) {
    ...
    items7[1] = items8;
    const items9 = ["<string:53040003>", "<string:806589490>", callback3(tmp14, tmp[2]), callback3(tmp14, tmp[3])];
    items7[2] = items9;
    const items10 = [null, null, null, callback3(tmp15, tmp[3])];
    items7[3] = items10;
...
const tmp11 = () => {
  function decomposeMatrix(arg0) {
    ...
    if (0 === arr[15]) {
      ...
      items3[1] = items4;
      const items5 = ["<string:53040003>", "<string:806589490>", result2, 0];
      items3[2] = items5;
      items3[3] = [];
...
export const getRotationMatrix = () => {
  function getRotationMatrix(result, arg1) {
    ...
    if ("z" === str) {
      ...
      items1[1] = items2;
      items1[2] = [-, 0., 0., 0.];
      items1[3] = [];
      return items1;
    } else if ("y" === str) {
