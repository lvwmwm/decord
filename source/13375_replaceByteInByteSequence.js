...
// Dependencies: [57, 488, 13374]

// Module 13375 (replaceByteInByteSequence)
...
function percentDecode(_Buffer) {
  _Buffer = require(488) /* createBuffer */.Buffer;
  ...
  if (0 < _Buffer.length) {
    while (true) {
      if (37 === _Buffer[num2]) {
        ...
        let obj = require(13374) /* isASCIIDigit */;
        if (obj.isASCIIHex(_Buffer[num2 + 1])) {
          let tmp3 = require;
          let tmp4 = dependencyMap;
          let obj2 = require(13374) /* isASCIIDigit */;
...
export default {
  ...
  parseUrlencoded(first) {
    let _Buffer = require(488) /* createBuffer */.Buffer;
      ...
      while (iter !== undefined) {
        ...
        if (0 === nextResult.length) {
          ...
          if (index1 >= 0) {
            ...
            let tmp6 = outer1_0;
            let tmp7 = outer1_1;
            _Buffer = outer1_0(outer1_1[1]).Buffer;
            substr1 = _Buffer.alloc(0);
          }
          let tmp11 = outer1_3;
          let tmp12 = outer1_0;
          let tmp13 = outer1_1;
          let _Buffer2 = outer1_0(outer1_1[1]).Buffer;
          let tmp14 = substr;
          let fromResult = _Buffer2.from(substr);
          let tmp16 = outer1_3(fromResult, 43, 32);
          let tmp17 = fromResult;
          let _Buffer3 = outer1_0(outer1_1[1]).Buffer;
          let tmp18 = substr1;
          let fromResult1 = _Buffer3.from(substr1);
          let tmp20 = outer1_3(fromResult1, 43, 32);
          let tmp21 = fromResult1;
          let tmp22 = items1;
          let tmp23 = outer1_5;
          let str = outer1_5(fromResult);
          let items2 = [str.toString(), ];
          let str2 = outer1_5(fromResult1);
  ...
  serializeUrlencoded(_list) {
    ...
    while (tmp3 !== undefined) {
      ...
      let tmp22 = _slicedToArray(tmp4, 2);
      [tmp23, arr] = tmp22;
      let tmp24 = arr;
      let tmp25 = serializeUrlencodedByte;
      let tmp26 = require;
      let tmp27 = dependencyMap;
      let _Buffer2 = require(488) /* createBuffer */.Buffer;
