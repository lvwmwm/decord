...
// Function ID: 1674
// Name: resolvePath
// Dependencies: [1674, 1677, 1685, 1638]

// Module 1673 (resolvePath)
const require = arg1;
...
function withStyleAnimation(animations) {
  ...
  obj = { ColorProperties: _require(1677).ColorProperties, setPath, processColor: _require(1677).processColor, styleAnimations: animations, resolvePath, __DEV__: false, logger: _require(1638).logger, isValidLayoutAnimationProp: _require(1674).isValidLayoutAnimationProp, withTiming: _require(1685).withTiming };
  fn.__closure = obj;
