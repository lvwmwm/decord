...
// Dependencies: [5520, 5521, 5508]

// Module 5537 (ViewabilityHelper)
      ...
      if (null !== prop) {
        ...
        if (undefined !== prop1) {
          ...
          if (null !== prop2) {
            ...
            if (undefined !== prop3) {
              const _Error = Error;
              const error = new Error(timerId(5508).ErrorMessages.multipleViewabilityThresholdTypesNotSupported);
              throw error;
            }
          }
        }
