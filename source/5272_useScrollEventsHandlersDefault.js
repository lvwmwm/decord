...
// Dependencies: [5253, 1606, 5246, 5273]

// Module 5272 (useScrollEventsHandlersDefault)
const require = arg1;
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj = { animatedSheetState, SHEET_STATE: _require(5246).SHEET_STATE, animatedHandleGestureState, State: _require(5273).State, animatedScrollableState, SCROLLABLE_STATE: _require(5246).SCROLLABLE_STATE, scrollTo: _require(1606).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue };
  E.__closure = obj;
  ...
  obj1 = { scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, rootScrollableContentOffsetY: animatedScrollableContentOffsetY, animatedSheetState, SHEET_STATE: _require(5246).SHEET_STATE };
  O.__closure = obj1;
  ...
  obj2 = { animatedScrollableState, SCROLLABLE_STATE: _require(5246).SCROLLABLE_STATE, scrollTo: _require(1606).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5246).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
  fn2.__closure = obj2;
  ...
  C.__closure = { animatedScrollableState, SCROLLABLE_STATE: _require(5246).SCROLLABLE_STATE, scrollTo: _require(1606).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5246).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
