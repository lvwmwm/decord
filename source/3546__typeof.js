...
// Function ID: 27073
// Name: _typeof
// Dependencies: [3490, 3477, 3244, 3494, 3489, 3407, 3248, 3245, 3249, 3547, 3491, 3548]
// Exports: default

// Module 3546 (_typeof)
import module_3490 from "module_3490";
...
export default function parse(arg0, arg1, defaultResult1, locale) {
  ...
  const module_3490 = String(arg0);
  const StringResult = String(arg1);
  const subMilliseconds = StringResult;
  const defaultOptions = _require(3249).getDefaultOptions();
  locale = undefined;
  if (null != locale) {
        ...
        if (defaultResult2 >= 0) {
          if (tmp26 <= 6) {
            if ("" === str) {
              ...
              const DateToSystemTimezoneSetter = _require(3547).DateToSystemTimezoneSetter;
              ...
              while (true) {
                let tmp40 = obj8;
                let fResult1 = obj8.f();
                let tmp42 = module_3490;
                if (module_3490.length <= 0) {
                  break;
                } else {
                  let tmp43 = regex;
                  let tmp44 = module_3490;
                  if (!regex.test(module_3490)) {
                    break;
                  } else {
                    let _Date3 = Date;
                    let _NaN3 = NaN;
