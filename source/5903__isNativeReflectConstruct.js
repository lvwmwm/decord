...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5904, 5906, 5383, 5908, 5910, 5911, 5920, 5921]
...
function getDistanceFromOptions(width, gestureDirection) {
  ...
  if (gestureDirection) {
    return CardStack(5908).getDistanceForDirection(width, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(5904).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(5904).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
    ...
    return tmp3(5908).getDistanceForDirection(width, gestureDirection, arg2);
  }
}
...
obj = {
  ...
  value: function render() {
    ...
    items2[1] = renderHeader(CardStack(5910).MaybeScreenContainer, obj2);
    obj[1] = items2;
