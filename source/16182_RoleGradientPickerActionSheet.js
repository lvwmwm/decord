...
obj = {};
obj = { paddingVertical: importDefault(dependencyMap[6]).space.PX_12, paddingHorizontal: importDefault(dependencyMap[6]).space.PX_12, gap: importDefault(dependencyMap[6]).space.PX_16 };
obj.body = obj;
...
const obj6 = { borderRadius: importDefault(dependencyMap[6]).radii.sm };
