...
// Function ID: 6404
// Name: logSpanEnd
// Dependencies: [6393, 6370, 6365]

// Module 6403 (logSpanEnd)
const require = arg1;
...
arg5.logSpanStart = function logSpanStart(spanContext) {
  ...
  if (require(6393) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
    ...
    const rootSpan = tmp(6370).getRootSpan(spanContext);
    let str3 = "unsampled";
    ...
    if (rootSpan !== spanContext) {
      ...
      ({ op: op2, description: description2 } = tmp(6370).spanToJSON(rootSpan));
      ...
      const spanToJSONResult1 = tmp(6370).spanToJSON(rootSpan);
    }
    const logger = tmp(6365).logger;
