...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 7780, 7781, 7782, 7783, 7787, 7788, 7789, 7799]

// Module 7779 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(7781)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(7782)(tmp, tmp, this);
      ...
      if (transform) {
        ...
        tmp.transform = self(7783).extractTransformSvgView(tmp);
        const obj3 = self(7783);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(7788)({ viewBox, preserveAspectRatio }));
      obj.children = jsx(importDefault(7789), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(7787), {});
    }
  }
];
