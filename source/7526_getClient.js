...
// Function ID: 7527
// Name: getClient
// Dependencies: [7517, 7518, 7500, 7520, 7505]

// Module 7526 (getClient)
const require = arg1;
...
arg5.getGlobalScope = function getGlobalScope() {
  return require(7500) /* getGlobalSingleton */.getGlobalSingleton("globalScope", () => {
...
arg5.getTraceContextFromScope = function getTraceContextFromScope(getPropagationContext) {
  ...
  return require(7505) /* addNonEnumerableProperty */.dropUndefinedKeys({ trace_id, span_id, parent_span_id });
};
arg5.withIsolationScope = function withIsolationScope() {
  ...
  const obj2 = require(7518) /* getAsyncContextStrategy */;
};
