...
// Dependencies: [57, 7, 6, 15, 17, 18, 162, 4746, 4782, 4783, 4784]

// Module 4781 (_isNativeReflectConstruct)
...
function readTags(_raw, byteLength, arg2) {
  ...
  require(4746) /* getStringFromDataView */.objectAssign(_raw, parseXMPObject(convertToObject(tmp2, true)));
  return true;
}
...
function getDescription(arr) {
  ...
  if (Array.isArray(arr)) {
    ...
    if (tmp2) {
      tmp18 = tmp16;
      if ("function" === typeof importDefault(4784)[tmp2]) {
        tmp18 = importDefault(4784)[tmp](arr, tmp16);
        const tmp24 = importDefault(4784);
      }
    }
    return tmp18;
    ...
    if (tmp2) {
      if ("function" === typeof importDefault(4784)[tmp2]) {
        let decodeURIComponentResult = importDefault(4784)[tmp2](arr);
        const tmp11 = importDefault(4784);
      }
...
function parseNodeAsStructureRdfDescription(value, arg1) {
  ...
  let iter = value;
  if (undefined !== value.value["rdf:Description"]) {
    require(4746) /* getStringFromDataView */.objectAssign(obj.value, parseNodeAttributesAsTags(value.value["rdf:Description"].attributes));
    const obj2 = require(4746) /* getStringFromDataView */;
    require(4746) /* getStringFromDataView */.objectAssign(obj.attributes, parseNodeAttributes(value));
    iter = value.value["rdf:Description"];
    const obj3 = require(4746) /* getStringFromDataView */;
  }
  require(4746) /* getStringFromDataView */.objectAssign(obj.value, parseNodeChildrenAsTags(iter.value));
