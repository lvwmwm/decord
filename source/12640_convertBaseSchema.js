...
// Dependencies: [32, 12635, 12636, 12634, 12628]

// Module 12640 (convertBaseSchema)
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const fnResult = fn(_mod12635);
    let obj = {};
    let merged = Object.assign(fn(_mod12634));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(_mod12636);
    let _Set = Set;
