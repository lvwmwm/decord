...
let c7 = 0;
const items3 = [["\\s", 1], , ];
const items4 = ["\\d", require("module_12829").MAX_LENGTH];
items3[1] = items4;
const items5 = ["[a-zA-Z0-9-]", require("module_12829").MAX_SAFE_BUILD_LENGTH];
items3[2] = items5;
function createToken(BUILD, arg1, arg2) {
  ...
  while (tmp !== undefined) {
    ...
    let tmp11 = _slicedToArray(tmp2, 2);
    [tmp12, tmp13] = tmp11;
    let tmp14 = str;
  ...
  require(12830)(BUILD, +closure_7, arg1);
  obj[BUILD] = +closure_7;
...
const token22 = createToken("COERCEPLAIN", "(^|[^\\d])(\\d{1," + require("module_12829").MAX_SAFE_COMPONENT_LENGTH + "})(?:\\.(\\d{1," + require("module_12829").MAX_SAFE_COMPONENT_LENGTH + "}))?(?:\\.(\\d{1," + require("module_12829").MAX_SAFE_COMPONENT_LENGTH + "}))?");
