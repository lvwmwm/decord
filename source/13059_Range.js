...
// Function ID: 13060
// Name: Range
// Dependencies: [41, 42, 13031, 13058, 13032, 13034, 13033, 13030, 13060]
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13031")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13032).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13032).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13033)("hyphen replace", str);
        let str3 = str.replace(tmp11(13034).safeRe[tmp11(undefined, 13034).t.COMPARATORTRIM], tmp11(13034).comparatorTrimReplace);
        tmp11(13033)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13034).safeRe[tmp11(undefined, 13034).t.TILDETRIM], tmp11(13034).tildeTrimReplace);
        tmp11(13033)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13034).safeRe[tmp11(undefined, 13034).t.CARETTRIM], tmp11(13034).caretTrimReplace);
        tmp11(13033)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13030)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13033)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13058).ANY) {
