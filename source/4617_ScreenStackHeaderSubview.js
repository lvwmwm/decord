...
// Dependencies: [109, 19, 17, 21, 4618, 4614, 4619, 4620, 4615, 4621]
...
// Module 4617 (ScreenStackHeaderSubview)
...
const forwardRefResult = require("noop").forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4614).isHeaderBarButtonsAvailableForCurrentPlatform) {
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4614).isHeaderBarButtonsAvailableForCurrentPlatform;
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  obj[2] = importDefault(4615).experiment.synchronousHeaderSubviewUpdatesEnabled;
  obj = { resizeMode: "center", fadeDuration: 0 };
  const merged = Object.assign(arg0);
  obj[3] = <closure_7 resizeMode="center" fadeDuration={0} />;
  return jsx(importDefault(4621), { resizeMode: "center", fadeDuration: 0 });
};
export const ScreenStackHeaderRightView = (style) => {
  ...
  obj.type = "right";
  obj.synchronousShadowStateUpdatesEnabled = importDefault(4615).experiment.synchronousHeaderSubviewUpdatesEnabled;
  const items = [closure_9.headerSubview, style.style];
  obj.style = items;
  return jsx(importDefault(4621), {});
};
