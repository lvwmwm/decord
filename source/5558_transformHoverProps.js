...
// Module 5558 (transformHoverProps)
const require = arg1;
...
arg5.useHoverGesture = function useHoverGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(5534) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformHoverProps);
  const obj = require(5534) /* isGestureEnabled */;
  return require(5549) /* useGesture */.useGesture(require(5525) /* ComposedGestureName */.SingleGestureName.Hover, clonedAndRemappedConfig);
};
