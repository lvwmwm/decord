...
// Dependencies: [32, 12346, 12347, 12345, 12339]

// Module 12351 (convertBaseSchema)
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema(flag, defaultTarget) {
      if (typeof flag === "boolean") {
        ...
        if (registry == null) {
          registry = require(12339) /* $output */.globalRegistry;
        }
        obj[5] = registry;
        return convertSchema(flag, obj);
      }
    };
    const fnResult = fn(require("module_12346"));
    let obj = {};
    let merged = Object.assign(fn(require("module_12345")));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(require("module_12347"));
    let _Set = Set;
