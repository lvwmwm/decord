...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7909, 7979, 7988, 7914, 7925]

// Module 7987 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      const tmp3Result = self(7909)(patternTransform);
      ...
      if (patternContentUnits) {
        num2 = tmp(7979)[patternContentUnits];
      }
      obj[8] = num2;
      obj = {
        ref(arg0) {
      ...
      const tmp3 = self(7909);
      const merged = Object.assign(obj);
      const merged1 = Object.assign(tmp(7914)({ viewBox, preserveAspectRatio }));
      obj.children = children;
      return jsx(self(7988), {
        ref(arg0) {
          return self.refMethod(arg0);
        }
      });
