...
// Dependencies: [93, 95, 98, 42, 41, 5510, 5493]

// Module 5509 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      let obj = ContinousBaseGesture(5510);
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5493).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(5493);
      }
      return tmp;
    }
  }
