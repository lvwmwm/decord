...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7843, 7913, 7922, 7848, 7859]
...
const items = [
  {
    ...
    value: function render() {
      ...
      const tmp3Result = self(7843)(patternTransform);
      ...
      if (patternContentUnits) {
        num2 = tmp(7913)[patternContentUnits];
      }
      obj[8] = num2;
      obj = {
        ref(arg0) {
      ...
      const tmp3 = self(7843);
      const merged = Object.assign(obj);
      const merged1 = Object.assign(tmp(7848)({ viewBox, preserveAspectRatio }));
      obj.children = children;
      return jsx(self(7922), {
        ref(arg0) {
          return self.refMethod(arg0);
        }
      });
