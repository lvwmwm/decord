...
// Function ID: 7500
// Name: normalize
// Dependencies: [32, 7500, 7460, 7461, 7457]
// Exports: normalizeUrlToBase

// Module 7499 (normalize)
...
function visit(arg0, num) {
  ...
  if (arg4 === undefined) {
    memoBuilderResult = require(7500) /* memoBuilder */.memoBuilder();
    let obj = require(7500) /* memoBuilder */;
  }
      ...
      if (str.startsWith("[object ")) {
        if (num.__sentry_skip_normalization__) {
          ...
          if (0 === num) {
            ...
            const convertToPlainObjectResult = require(7460) /* addNonEnumerableProperty */.convertToPlainObject(num);
            let num6 = 0;
