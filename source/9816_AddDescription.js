...
obj.image = { height: undefined, borderRadius: importDefault(dependencyMap[7]).radii.sm };
const obj2 = { height: undefined, borderRadius: importDefault(dependencyMap[7]).radii.sm };
