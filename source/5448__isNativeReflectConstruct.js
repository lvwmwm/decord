...
// Dependencies: [93, 95, 98, 42, 41, 5449, 5432]

// Module 5448 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      let obj = ContinousBaseGesture(5449);
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5432).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(5432);
      }
      return tmp;
    }
  }
