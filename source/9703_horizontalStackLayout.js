...
// Module 9703 (horizontalStackLayout)
...
let closure_9 = () => {
  function getCommonStyles(arg0) {
    ...
    if ("left" === snapDirection) {
      ...
      const items3 = ["<string:3813801986>", "<string:1419299473>", 1 - (validLength - 1) * opacityInterval, 0.25];
      ...
      items4[3] = 1;
      items4[4] = 1.5;
      const items5 = [false, validLength - 1, validLength, validLength];
      ...
      const items7 = ["<string:3813801986>", 1 - (validLength - 1) * opacityInterval, 1, 0.25];
