...
// Function ID: 4063
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4063, 4064, 4066, 4038]
// Exports: RiveView

// Module 4062 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + require(4063).RiveErrorType[message.type] + "] " + message.message);
}

export const RiveView = function RiveView(arg0) {
  let hybridRef;
  let onError;
  let obj = _require(4064);
  ...
  const tmp18 = jsx(_require(4038).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
