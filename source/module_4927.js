// Module ID: 4927
// Function ID: 4928
// Dependencies: [4887, 4902, 4903, 4899, 4882]
...
arg5.default = {
  read(buffer, sum) {
    ...
    let obj2 = require(4902) /* readTag */;
    const ifd = obj1.readIfd(buffer, require(4903) /* importDefaultResult1 */.IFD_TYPE_MPF, sum, obj2.get0thIfdOffset(buffer, sum, byteOrder), byteOrder, arg2);
    if (ifd.MPEntry) {
      const items = [];
      const _Math = Math;
      let num13 = 0;
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          if (0 !== num13) {
            ...
            let obj15 = require(4882) /* getDataView */;
