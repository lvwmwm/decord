...
// Dependencies: [5, 17, 82, 13677, 13679, 13681, 13682, 13685, 13686, 13699, 13701, 13703, 13704, 13705, 13706, 13687]

// Module 13676 (reactNativeCorePlugins)
...
import module_13685 from "module_13685";
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL !== "string") {
        ...
        return require(13706) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
