...
// Function ID: 5684
// Name: hasOwnProperty
// Dependencies: [5681, 5684]

// Module 5683 (hasOwnProperty)
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5681)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
              tmp12 = require(5681) /* keys */;
              tmp9 = hasOwnProperty;
            }
          }
        }
...
obj.to.hex = () => {
  const tmp = require(5684) /* swizzle */(arguments);
...
obj.to.rgb = () => {
  const arr = require(5684) /* swizzle */(arguments);
  if (arr.length >= 4) {
    if (1 !== arr[3]) {
      const _Math = Math;
      const _Math2 = Math;
