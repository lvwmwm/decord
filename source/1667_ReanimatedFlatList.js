...
// Dependencies: [109, 19, 17, 21, 1668, 1774, 1772, 1773]

// Module 1667 (ReanimatedFlatList)
...
export const ReanimatedFlatList = isReactRendering.componentWithRef((skipEnteringExitingAnimations, ref) => {
  ...
  if (undefined !== skipEnteringExitingAnimations.skipEnteringExitingAnimations) {
    ...
    obj[2] = tmp7;
    tmp5Result = jsx(require(1772) /* _isNativeReflectConstruct */.LayoutAnimationConfig, { skipEntering: true, skipExiting: true, children: null });
  }
  return tmp5Result;
});
