...
// Dependencies: [7524, 7505, 7504, 7535]

// Module 7549 (applyScopeDataToEvent)
const require = arg1;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  let obj = require(7505) /* addNonEnumerableProperty */;
  ...
  const dropUndefinedKeysResult3 = require(7505) /* addNonEnumerableProperty */.dropUndefinedKeys(contexts);
  ...
  if (span) {
    ...
    obj3[0] = tmp3(7504).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(7504);
    obj4[0] = tmp3(7535).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(7535);
    const rootSpan = tmp3(7504).getRootSpan(span);
    const tmp3Result4 = tmp3(7504);
    const description = tmp3(7504).spanToJSON(rootSpan).description;
...
arg5.mergeAndOverwriteScopeData = function mergeAndOverwriteScopeData(arg0, arg1, arg2) {
  arg0[arg1] = require(7524) /* merge */.merge(arg0[arg1], arg2, 1);
};
arg5.mergeScopeData = function mergeScopeData(extra) {
  ...
  let obj = require(7524) /* merge */;
  extra.extra = obj.merge(extra.extra, extra, 1);
  extra.tags = require(7524) /* merge */.merge(extra.tags, tags, 1);
  const obj2 = require(7524) /* merge */;
  extra.user = require(7524) /* merge */.merge(extra.user, user, 1);
  const obj3 = require(7524) /* merge */;
  extra.contexts = require(7524) /* merge */.merge(extra.contexts, contexts, 1);
  const obj4 = require(7524) /* merge */;
  extra.sdkProcessingMetadata = require(7524) /* merge */.merge(extra.sdkProcessingMetadata, sdkProcessingMetadata, 2);
  if (level) {
    extra.level = level;
  }
  if (transactionName) {
