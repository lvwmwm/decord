...
// Function ID: 1745
// Name: r
// Dependencies: [1745, 1677, 1746, 1645]
...
function processColorNumber(arr) {
  const result = require(1677) /* call */.processColorInitially(arr);
  const obj = require(1677) /* call */;
  let tmp3 = result;
  if (tmp2) {
    tmp3 = result | 0;
  }
...
function processColor(arr, target) {
  ...
  tmp4 = require(1745) /* JEST_WORKER_ID */.IS_ANDROID && typeof result === "number";
}
...
function processColorsInProps(obj) {
  for (const key10005 in arg0) {
    ...
    let ColorProperties = require(1677) /* call */.ColorProperties;
