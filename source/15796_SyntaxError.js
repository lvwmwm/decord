...
arg5.default = () => {
  ...
  return {
    ...
    parse(arg0) {
      ...
      let closure_6 = /^[^ \t\n\r,.+={}#]/;
      let closure_7 = { "Bool(true)": "literal", "Bool(true)": "\\u", "Bool(true)": "\"\\\\u\"" };
      let closure_8 = "{";
      let closure_9 = { "Bool(true)": 1, "Bool(true)": 1, "Bool(true)": false };
      let closure_10 = null;
      let closure_11 = ",";
      let closure_12 = { "Bool(true)": "en-150", "Bool(true)": "en-001", "Bool(true)": "en-AG" };
      let closure_13 = "}";
      let closure_14 = { "Bool(true)": "en-AI", "Bool(true)": "en-001", "Bool(true)": "en-AT" };
      function peg$c14(id) {
      ...
      let closure_17 = { "Bool(true)": false, "Bool(true)": false, "Bool(true)": false };
      let closure_18 = "date";
      let closure_19 = {};
      let closure_20 = "time";
      let closure_21 = { "Bool(true)": "<string:889541130>", "Bool(true)": "<string:3746695763>", "Bool(true)": "<string:1376408330>" };
      ...
      let closure_39 = { fillOpacity: null, fillRule: null };
      let closure_40 = /^[ \t\n\r]/;
      let closure_41 = { "Bool(true)": null, "Bool(true)": null, "Bool(true)": null };
      let closure_42 = { fillOpacity: false, fillRule: false };
      let closure_43 = /^[0-9]/;
      let closure_44 = { "Bool(true)": null, "Bool(true)": null, "Bool(true)": null };
      let closure_45 = /^[0-9a-f]/i;
      let closure_46 = { "Bool(true)": "padding", "Bool(true)": "View", "Bool(true)": "accessible" };
      let closure_47 = "0";
      let closure_48 = { "Bool(true)": "USER_ACCOUNT_EMAIL_CHANGE_FLOW", "Bool(true)": "en-GM", "Bool(true)": "en-001" };
      let closure_49 = /^[1-9]/;
      let closure_50 = { "Bool(true)": "en-HK", "Bool(true)": "en-001", "Bool(true)": "en-IL" };
      function peg$c50(replaced) {
        return parseInt(replaced, 10);
      }
      let closure_52 = /^[^{}\\\0-\x1F \t\n\r]/;
      let closure_53 = { "Bool(true)": "padding", "Bool(true)": "View", "Bool(true)": "accessible" };
      let closure_54 = "\\\\";
      let closure_55 = { "Bool(true)": null, "Bool(true)": null, "Bool(true)": null };
      function peg$c55() {
        return "\\";
      }
      let closure_57 = "\\#";
      let closure_58 = { "Bool(true)": false, "Bool(true)": false, "Bool(true)": false };
      function peg$c58() {
        return "\\#";
      }
      let closure_60 = "\\{";
      let closure_61 = { "Bool(true)": "USER_ACCOUNT_EMAIL_CHANGE_FLOW", "Bool(true)": "en-KY", "Bool(true)": "en-001" };
      function peg$c61() {
        return "{";
      }
      let closure_63 = "\\}";
      let closure_64 = { "Bool(true)": "en-LR", "Bool(true)": "en-001", "Bool(true)": "en-LS" };
      function peg$c64() {
        return "}";
      }
      let closure_66 = "\\u";
      let closure_67 = { "Bool(true)": "<string:609964554>", "Bool(true)": "<string:1347553875>", "Bool(true)": "<string:1376408504>" };
      ...
      let closure_70 = 0;
      let closure_71 = 0;
      let closure_72 = { CONTROL_SECONDARY_BACKGROUND_DEFAULT: null, pillDisabled: null, refBinWriter: null };
      let closure_73 = 0;
      let closure_74 = [];
      let closure_75 = 0;
      if ("startRule" in tmp) {
      ...
      if (tmp8) {
        const result1 = peg$fail({ fillOpacity: 2912769, fillRule: 1310720 });
      }
