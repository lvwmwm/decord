...
// Module 12976 (_isNativeReflectConstruct)
...
const tmp4 = (PureComponent) => {
  ...
  items[4] = {
    ...
    value: function render() {
      ...
      let obj = { opacity: animOpacity.interpolate({ inputRange: ["Text", "lc"], outputRange: items }) };
      ...
      obj = { scale: animTransform.interpolate({ inputRange: ["Text", "lc"], outputRange: items1 }) };
