...
// Dependencies: [1606, 5277]

// Module 5280 (cancelAnimation)
try {
  ...
  if (!setGestureState) {
    const fn = function t() {
      console.warn(require(5277) /* toArray */.tagMessage("Please use newer version of react-native-reanimated in order to control state of the gestures."));
    };
