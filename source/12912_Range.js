...
// Function ID: 100188
// Name: Range
// Dependencies: [65, 6, 7, 12884, 12911, 12885, 12887, 12886, 12883, 12913]

// Module 12912 (Range)
import _toConsumableArray from "_toConsumableArray";
import _classCallCheck from "items";
import _defineProperties from "module_12886";
...
function replaceTilde(str, loose) {
  const _require = str;
  const safeRe = _require(12887).safeRe;
  const t = _require(12887).t;
  if (loose.loose) {
...
function replaceXRanges(str, arg1) {
  const _require = arg1;
  _require(12886)("replaceXRanges", str, arg1);
...
function replaceStars(str, arg1) {
  require(12886)("replaceStars", str, arg1);
  return str.trim().replace(require(12887) /* items */.safeRe[require(undefined, 12887) /* items */.t.STAR], "");
}
function replaceGTE0(str) {
  require(12886)("replaceGTE0", str, arg1);
  const t = require(12887) /* items */.t;
  return str.trim().replace(require(12887) /* items */.safeRe[arg1.includePrerelease ? t.GTE0PRE : t.GTE0], "");
}
    ...
    if (!includePrerelease.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = require(12886)(arg0[num4].semver);
          let tmp6 = tmp2;
          if (arg0[num4].semver !== require(12911) /* Comparator */.ANY) {
            tmp6 = tmp2;
