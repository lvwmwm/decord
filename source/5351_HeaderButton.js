...
// Function ID: 5352
// Name: HeaderButton
// Dependencies: [19, 17, 21, 5334]

// Module 5351 (HeaderButton)
...
const forwardRefResult = require("noop").forwardRef(function HeaderButtonInternal(disabled, ref) {
  ...
  obj[11] = children;
  return jsx(require(5334) /* Animated */.PlatformPressable, { ref, disabled, href, "aria-label": accessibilityLabel, testID, onPress, pressColor, pressOpacity, android_ripple: obj, style: null, hitSlop: null, children: null });
});
