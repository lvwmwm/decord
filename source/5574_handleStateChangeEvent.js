...
// Dependencies: [5556, 5494, 5509, 5496, 5558]

// Module 5574 (handleStateChangeEvent)
const require = arg1;
...
function handleUpdateEvent(lastUpdateEvent, arg1, arg2, lastUpdateEvent2) {
  ...
  const result = require(5556) /* isGestureEnabled */.flattenAndFilterEvent(tmp);
  const obj = require(5556) /* isGestureEnabled */;
  require(5556) /* isGestureEnabled */.runCallback(require(5509) /* _isNativeReflectConstruct */.CALLBACK_TYPE.UPDATE, arg1, result);
  if (lastUpdateEvent2) {
...
function handleTouchEvent(eventType) {
  if (eventType.eventType !== require(5496).TouchEventType.UNDETERMINED) {
    let tmpResult = tmp(5556);
    tmpResult = tmp(5556);
...
function eventHandler(arg0, nativeEvent, arg2, arg3, lastUpdateEvent) {
  const result = require(5556) /* isGestureEnabled */.maybeExtractNativeEvent(nativeEvent);
  const obj = require(5556) /* isGestureEnabled */;
