...
// Module 12055 (getRussianPlural)
const self = this;
function getRussianPlural(arg0, arg1, arg2, arg3) {
  let tmp = arg1;
      ...
      return (code) => {
        ...
        if ("invalid_type" === code) {
          ...
          if (obj.test(code.expected)) {
            ...
            let combined = "\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u0432\u0432\u043E\u0434: \u043E\u0436\u0438\u0434\u0430\u043B\u043E\u0441\u044C instanceof " + code.expected + ", \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u043E " + tmp48;
          } else {
            const _HermesInternal16 = HermesInternal;
            combined = "\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u0432\u0432\u043E\u0434: \u043E\u0436\u0438\u0434\u0430\u043B\u043E\u0441\u044C " + expected + ", \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u043E " + tmp48;
          }
          return combined;
          ...
          const tmp25 = getSizing(code.origin);
          if (tmp25) {
            const _Number2 = Number;
            const tmp32 = outer1_4(Number(code.maximum), tmp25.unit.one, tmp25.unit.few, tmp25.unit.many);
            ...
            return "\u0421\u043B\u0438\u0448\u043A\u043E\u043C \u0431\u043E\u043B\u044C\u0448\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435: \u043E\u0436\u0438\u0434\u0430\u043B\u043E\u0441\u044C, \u0447\u0442\u043E " + str36 + " \u0431\u0443\u0434\u0435\u0442 \u0438\u043C\u0435\u0442\u044C " + str31 + code.maximum.toString() + " " + tmp32;
          } else {
            ...
            return "\u0421\u043B\u0438\u0448\u043A\u043E\u043C \u0431\u043E\u043B\u044C\u0448\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435: \u043E\u0436\u0438\u0434\u0430\u043B\u043E\u0441\u044C, \u0447\u0442\u043E " + str32 + " \u0431\u0443\u0434\u0435\u0442 " + str31 + code.maximum.toString();
          }
          ...
          if (tmp17) {
            ...
            return "\u0421\u043B\u0438\u0448\u043A\u043E\u043C \u043C\u0430\u043B\u0435\u043D\u044C\u043A\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435: \u043E\u0436\u0438\u0434\u0430\u043B\u043E\u0441\u044C, \u0447\u0442\u043E " + code.origin + " \u0431\u0443\u0434\u0435\u0442 \u0438\u043C\u0435\u0442\u044C " + str24 + code.minimum.toString() + " " + outer1_4(Number(code.minimum), tmp17.unit.one, tmp17.unit.few, tmp17.unit.many);
          } else {
            ({ minimum, origin } = code);
            const _HermesInternal10 = HermesInternal;
            return "\u0421\u043B\u0438\u0448\u043A\u043E\u043C \u043C\u0430\u043B\u0435\u043D\u044C\u043A\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435: \u043E\u0436\u0438\u0434\u0430\u043B\u043E\u0441\u044C, \u0447\u0442\u043E " + origin + " \u0431\u0443\u0434\u0435\u0442 " + str24 + minimum.toString();
          }
          ...
          return "\u041D\u0435\u0440\u0430\u0441\u043F\u043E\u0437\u043D\u0430\u043D\u043D" + str7 + " \u043A\u043B\u044E\u0447" + str8 + ": " + closure_2.joinValues(code.keys, ", ");
