...
// Dependencies: [57, 5, 6345, 6459, 6353, 6348, 6361, 6354]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 6458 (instrumentFetch)
...
function instrumentFetch(arg0) {
  ...
  if (tmp) {
    tmp = !_require(6459).supportsNativeFetch();
    let obj = _require(6459);
  }
  if (!tmp) {
    _require(6353).fill(_require(6348).GLOBAL_OBJ, "fetch", (arg0) => {
      let closure_0 = arg0;
      return () => {
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(6345) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  const obj = require(6345) /* addHandler */;
  require(6345) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    outer1_4(outer1_6);
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(6345).addHandler("fetch", arg0);
  const obj = _require(6345);
  _require(6345).maybeInstrument("fetch", () => {
