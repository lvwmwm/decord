...
// Dependencies: [1606, 5343]

// Module 5346 (cancelAnimation)
try {
  ...
  if (!setGestureState) {
    const fn = function t() {
      console.warn(require(5343) /* toArray */.tagMessage("Please use newer version of react-native-reanimated in order to control state of the gestures."));
    };
