...
// Dependencies: [13270, 13271, 13273]

// Module 13269 (__exportStarResult32)
const require = arg1;
...
class ToNumber {
  constructor(arg0) {
    if (typeof arg0 === "Object") {
      ...
      tmp30 = closure_0;
      tmp31 = closure_1;
      tmp32 = typeof arg0 === "$ZodSymbol";
      if (typeof arg0 !== "accessibilityLabel") {
        tmp32 = typeof arg0 === "__i";
      }
      tmp4 = globalThis;
...
arg5.TimeClip = function TimeClip(isFinite) {
  if (isFinite.isFinite()) {
    if (absResult.greaterThan(8640000000000001)) {
      const decimal = new require(13270) /* digitsToString */.Decimal(NaN);
      return decimal;
    } else {
      ...
      ZERO = require(13273) /* TEN */.ZERO;
    }
    absResult = isFinite.abs();
  } else {
    const decimal1 = new require(13270) /* digitsToString */.Decimal(NaN);
    return decimal1;
  }
};
