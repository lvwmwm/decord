...
export const useKeyboardAnimation = () => {
  ...
  return require(1846) /* NOOP */.useKeyboardContext().animated;
};
...
export const useGenericKeyboardHandler = function useGenericKeyboardHandler(handler, items10) {
  ...
  let closure_2 = _require(1653).useEvent(fn, ["onKeyboardMoveStart", "onKeyboardMove", "onKeyboardMoveEnd", "onKeyboardMoveInteractive"], obj2.useHandler(handler, items10).doDependenciesDiffer);
  callback2(() => {
...
export const useFocusedInputHandler = function useFocusedInputHandler(handler, items10) {
  ...
  let closure_2 = _require(1653).useEvent(fn, ["onFocusedInputTextChanged", "onFocusedInputSelectionChanged"], obj2.useHandler(handler, items10).doDependenciesDiffer);
  callback2(() => {
