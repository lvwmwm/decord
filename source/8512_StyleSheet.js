...
// Function ID: 8513
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1481, 1612, 5276, 8513, 4648, 8514, 8516, 8517, 8518, 8519]
// Exports: NativeStackView

// Module 8512 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5276).HeaderShownContext);
  let num5 = React.useContext(num6(5276).HeaderHeightContext);
  const context1 = React.useContext(num6(5276).HeaderBackContext);
  let obj3 = num6(5276);
  ...
  callback = obj2.useCallback(num6(8513).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4648).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4648).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5276).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5276);
  ...
  let eventResult;
  const headerConfigProps = num6(8514).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  obj15[1] = closure_10(num6(5276).HeaderBackContext.Provider, obj16);
  items5[2] = closure_10(num6(5276).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = closure_11(num6(5276).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(8516).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4648).ScreenStackItem, obj4);
