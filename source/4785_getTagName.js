...
// Function ID: 41619
// Name: getTagName
// Dependencies: [57, 4746, 4763, 4786]

// Module 4785 (getTagName)
          ...
          if (importDefault(4786)[shortAt]) {
            ...
            while (true) {
              ...
              if (tagName) {
                ...
                let tmp32 = shortAt;
                name = importDefault(4786)[shortAt].name;
                break;
              }
              let tmp33 = name;
              let tmp34 = obj;
