...
// Dependencies: [5425, 5426, 5430, 5431]

// Module 5424 (RenderTimeTracker)
...
const items = [
  {
    ...
    value: function startTracking() {
      ...
      let trackAverageRenderTimeForOffsetProjection = RenderTimeTracker(5431).PlatformConfig.trackAverageRenderTimeForOffsetProjection;
  ...
  },
  {
    ...
    value: function getAverageRenderTime() {
      const self = this;
      if (RenderTimeTracker(5431).PlatformConfig.trackAverageRenderTimeForOffsetProjection) {
        const _Math = Math;
        const _Math2 = Math;
        const _Math3 = Math;
