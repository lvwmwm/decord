...
// Function ID: 13074
// Name: Range
// Dependencies: [41, 42, 13045, 13072, 13046, 13048, 13047, 13044, 13074]
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13045")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13046).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13046).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13047)("hyphen replace", str);
        let str3 = str.replace(tmp11(13048).safeRe[tmp11(undefined, 13048).t.COMPARATORTRIM], tmp11(13048).comparatorTrimReplace);
        tmp11(13047)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13048).safeRe[tmp11(undefined, 13048).t.TILDETRIM], tmp11(13048).tildeTrimReplace);
        tmp11(13047)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13048).safeRe[tmp11(undefined, 13048).t.CARETTRIM], tmp11(13048).caretTrimReplace);
        tmp11(13047)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13044)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13047)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13072).ANY) {
