...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 13741, 13744, 4635]
// Exports: default

// Module 13740 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4635).ScreenContext.Provider, { value: closure_8, children: children.children });
};
