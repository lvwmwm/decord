...
// Function ID: 7387
// Name: updateSession
// Dependencies: [7362, 7363, 7387, 7377, 7374, 7369]
// Exports: closeSession, makeSession

// Module 7386 (updateSession)
...
function updateSession(ipAddress) {
  ...
  if (!timestamp) {
    timestamp = require(7377) /* dateTimestampInSeconds */.timestampInSeconds();
    const obj2 = require(7377) /* dateTimestampInSeconds */;
  }
  ...
  if (!obj.sid) {
    ...
    if (32 === obj.sid.length) {
      ...
      sid = require(7374) /* addContextToFrame */.uuid4();
