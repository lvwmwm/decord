...
function defineProperties(prototype, ownPropertyDescriptors) {
  const arr = require(4463) /* keys */(ownPropertyDescriptors);
  if (!closure_2) {
    for (let num = 0; num < arr.length; num = num + 1) {
      ...
      let tmp10 = num;
      if (typeof defineProperty !== "fileFinishedImporting") {
