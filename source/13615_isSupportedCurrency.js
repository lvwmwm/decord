...
// Dependencies: [13532, 13616]

// Module 13615 (isSupportedCurrency)
const require = arg1;
...
function isSupportedCurrency(arr3, locale) {
  ...
  try {
    ...
    obj[2] = arr3;
    const memoizedNumberFormat = require(13532) /* _formatToParts */.createMemoizedNumberFormat(str, obj);
...
arg5.getSupportedCurrencies = function getSupportedCurrencies(locale) {
  const items = [];
  const currencies = require(13616).currencies;
