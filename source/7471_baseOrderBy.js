...
// Function ID: 59995
// Name: baseOrderBy
// Dependencies: [741, 591, 704, 618, 609, 697, 7472, 7473, 7474]

// Module 7471 (baseOrderBy)
...
export default function baseOrderBy(arg0, arg1, arg2) {
  ...
  return _require(7473)(_require(7472)(arg0, (value) => {
    const callback = value;
    const sum = c2 + 1;
    c2 = sum;
    return { criteria: callback(741)(callback, (arg0) => arg0(closure_0)), index: sum, value };
  }), (arg0, arg1) => callback(7474)(arg0, arg1, dependencyMap));
};
