...
class URLStateMachine {
  constructor(arg0, arg1, arg2, arg3, arg4) {
    ...
    if (!self.url) {
      obj = { "Bool(false)": "fr", "Bool(false)": "french", "Bool(false)": true, "Bool(false)": "/assets/.cache/intl/aW50bA==", "Bool(false)": null, "Bool(false)": "859b8a75ee740764629b8ea0f491c8f0", "Bool(false)": "el.messages.859b8a75ee740764629b8ea0f491c8f0.compiled.messages", "Bool(false)": "jsona", "Bool(false)": "Deutsch" };
      str3 = "";
      obj.path = [];
      self.url = obj;
      str4 = self.input;
...
const set = new Set([]);
const set1 = new Set([]);
const set2 = new Set([true, true, true, true]);
