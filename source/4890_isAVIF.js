...
arg5.isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4884) /* getFileChunk */.isAvifStringIncluded(fileChunk);
};
...
arg5.isHEIC = function isHEIC(fileChunk) {
  fileChunk = require(4884) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4885).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4884) /* getFileChunk */.isHeicSignatureIncluded(fileChunk);
};
