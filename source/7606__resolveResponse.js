...
// Dependencies: [32, 5, 7493, 7607, 7501, 7496, 7509, 7502]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 7606 (_resolveResponse)
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(7493) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(7493) /* addHandler */;
  require(7493) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    const callback = closure_5;
    {
      callback(7501).fill(callback(7496).GLOBAL_OBJ, "fetch", (arg0) => {
        let closure_0 = arg0;
        return () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(7493).addHandler("fetch", arg0);
  let obj = _require(7493);
  _require(7493).maybeInstrument("fetch", () => {
    let flag = callback;
