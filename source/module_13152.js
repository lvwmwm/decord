// Module ID: 13152
// Function ID: 13153
// Dependencies: [13125, 13129, 13124]

// Module 13152

export default (num) => {
  if (num instanceof require(13125) /* SemVer */) {
    return num;
  } else {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(13129).safeRe;
        const t2 = tmp(13129).t;
      ...
      if (null === match2) {
        ...
        return require(13124) /* SemVer */("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
