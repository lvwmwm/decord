...
// Dependencies: [19, 17, 6577, 6649, 6579]
// Exports: default

// Module 6648 (offsetComparator)
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
      ...
      while (true) {
        ...
        if (typeof tmp10 === "number") {
          ...
          if (!isNaN(num9)) {
            ...
            let items1 = [num9, 16777215 & tmp10 | Math.round(255 * importDefault(6577)(stopOpacity)) << 24];
    ...
    if (gradientUnits) {
      num12 = importDefault(6649)[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
    ...
    obj[4] = importDefault(6579)(gradientTransform);
    return obj;
  } else {
    return null;
  }
