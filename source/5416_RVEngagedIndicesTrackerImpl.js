...
// Dependencies: [5417, 5403, 5404, 5409, 5421]

// Module 5416 (RVEngagedIndicesTrackerImpl)
...
export const RVEngagedIndicesTrackerImpl = (() => {
  class RVEngagedIndicesTrackerImpl {
    constructor() {
      tmp = outer1_3(this, RVEngagedIndicesTrackerImpl);
      this.scrollOffset = 0;
      this.drawDistance = RVEngagedIndicesTrackerImpl(outer1_1[3]).PlatformConfig.defaultDrawDistance;
      this.enableOffsetProjection = true;
      this.averageRenderTime = 16;
      this.forceDisableOffsetProjection = false;
      this.engagedIndices = RVEngagedIndicesTrackerImpl(outer1_1[4]).ConsecutiveNumbers.EMPTY;
  ...
  items[3] = {
    ...
    value: function getMedianVelocity() {
      const sorted = outer1_2(this.velocityHistory).sort((arg0, arg1) => arg0 - arg1);
      ...
      const obj = outer1_2(this.velocityHistory);
    }
  };
  items[4] = {
