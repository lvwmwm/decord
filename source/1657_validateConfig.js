...
const tmp2 = () => {
  function validateConfig(clamp) {
    if (clamp.clamp) {
      ...
      if (Array.isArray(clamp.clamp)) {
        if (2 !== clamp.clamp.length) {
          const ReanimatedError4 = callback(closure_1[0]).ReanimatedError;
    ...
    if (clamp.velocityFactor <= 0) {
      const ReanimatedError3 = callback(closure_1[0]).ReanimatedError;
...
pnpm_decayTs2.__closure = { defineAnimation: arg1(arg6[1]).defineAnimation, isValidRubberBandConfig: arg1(arg6[2]).isValidRubberBandConfig, rubberBandDecay: arg1(arg6[3]).rubberBandDecay, rigidDecay: arg1(arg6[4]).rigidDecay, validateConfig: tmp2, getReduceMotionForAnimation: arg1(arg6[1]).getReduceMotionForAnimation };
