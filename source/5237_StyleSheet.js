...
// Function ID: 5238
// Name: StyleSheet
// Dependencies: [109, 19, 17, 21, 1584, 5238, 5235, 5240, 5241]
// Exports: default

// Module 5237 (StyleSheet)
...
export default function Header(children) {
  ...
  const context = React.useContext(importDefault(5238));
  if (undefined === layout) {
  ...
  if (headerBackground) {
    ...
    if (!headerTransparent) {
      ...
      obj4[0] = items;
      headerBackgroundResult = tmp15(importDefault(5241), obj4);
    }
  }
  ...
  tmp8 = importDefault(5235)(layout, undefined !== modal && modal, headerStatusBarHeight);
