...
function measureFabric(arg0) {
  if (globalThis._WORKLET) {
    const tmp3 = arg0();
    if (-1 === tmp3) {
      const logger4 = require(1638) /* addLogBoxLog */.logger;
      ...
      if (null === _measureFabricResult) {
        const logger3 = require(1638) /* addLogBoxLog */.logger;
        ...
        const logger2 = require(1638) /* addLogBoxLog */.logger;
