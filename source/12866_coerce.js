...
// Function ID: 100005
// Name: coerce
// Dependencies: [12839, 12843, 12838]
...
export default function coerce(arg0, arg1) {
  ...
  if (arg0 instanceof require(12839) /* SemVer */) {
    ...
    if ("string" !== typeof StringResult) {
      ...
      if (obj.rtl) {
        const safeRe2 = require(12843) /* items */.safeRe;
        const t2 = require(12843) /* items */.t;
        ...
        const safeRe = require(12843) /* items */.safeRe;
      ...
      if (null === match2) {
        ...
        return require(12838) /* parse */("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str4 + str6, obj);
      }
    }
  }
};
