...
// Function ID: 4666
// Name: ToPrimitive
// Dependencies: [1421, 4666, 4667, 4668]

// Module 4665 (ToPrimitive)
import apply from "apply" /* 1421 */;
import isPrimitive from "isPrimitive" /* 4666 */;
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4668)(arg0) || tmp(4667)(arg0);
          const tmp15 = tmp(4668)(arg0) || tmp(4667)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
