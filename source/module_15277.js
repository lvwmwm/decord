...
if ("function" === typeof Symbol) {
    ...
    let closure_12 = (arg0) => {
      ...
      const items1 = [
        ...
        },
        {
          ...
          get() {
            delete r1.g_v_WXY;
            const items = [-415039485, 1677721920, -201326229, 1191183111, 88540];
      ...
      const items1 = [
        ...
        },
        {
          ...
          get() {
            ...
            const items = [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null];
    ...
    let closure_28 = (arg0) => {
      ...
      const items1 = [
        ...
        },
        {
          ...
          get() {
            delete r1.g_vowel3;
            const items = ["acq", "ar", "acw", "ar", "acx", "ar", "acy", "ar", "adf", "ar", "ads", "sgn", "aeb", "ar", "aec", "ar", "aed", "sgn", "aen", "sgn", "afb", "ar", "afg", "sgn", "ajp", "ar", "apc"];
  ...
  if ("function" === typeof globalThis.define) {
    if (globalThis.define.amd) {
      globalThis.define("snowballFactory", [], fn2);
    }
  }
