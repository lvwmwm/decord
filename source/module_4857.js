// Module ID: 4857
// Function ID: 4858
// Dependencies: [4858, 4859, 4860, 4861, 4862, 4855, 4854]
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = require(4855).FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = require(4855).FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = require(4855).FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
    ...
    fileChunk = require(4854) /* getFileChunk */.getFileChunk(fileChunk, num2);
    const FileTypes4 = require(4855).FileTypes;
