// Module ID: 4847
// Function ID: 4848
// Dependencies: [4807, 4822, 4823, 4819, 4802]
...
arg5.default = {
  read(buffer, sum) {
    ...
    let obj2 = require(4822) /* readTag */;
    const ifd = obj1.readIfd(buffer, require(4823) /* importDefaultResult1 */.IFD_TYPE_MPF, sum, obj2.get0thIfdOffset(buffer, sum, byteOrder), byteOrder, arg2);
    if (ifd.MPEntry) {
      const items = [];
      const _Math = Math;
      let num13 = 0;
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let tmp10 = num13;
          if (byteOrder === module(4807).LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
          ...
          if (0 !== num13) {
            ...
            let obj15 = require(4802) /* getDataView */;
        ...
        const typeSize4 = module(4819).getTypeSize("LONG");
        if (byteOrder === module(4807).LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
