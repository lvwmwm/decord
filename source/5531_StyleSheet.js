...
const styles = StyleSheet.create({ content: {}, title: { -9223372036854775808: "center", 9223372036854775807: "center" }, left: {}, right: { IS_MEDIA_CHANNEL: 22, SUMMARIES_DISABLED: 22 }, expand: { MCP_RESOURCE_URI_ATTRIBUTE: null, handleFeedItemUnseen: null } });
...
export default function Header(children) {
  ...
  const items = [obj, false === headerShadowVisible && {}];
