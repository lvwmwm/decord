...
// Function ID: 4071
// Name: useRiveColor
// Dependencies: [32, 19, 4052, 4065, 4060]
// Exports: useRiveColor

// Module 4070 (useRiveColor)
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(require(4065) /* useRiveProperty */.useRiveProperty(instance, FillColor, f28837), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
    if (undefined !== tmp5) {
      let RiveColor = require(4060) /* RiveColor */.RiveColor;
