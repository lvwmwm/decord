...
// Function ID: 13051
// Name: Range
// Dependencies: [41, 42, 13022, 13049, 13023, 13025, 13024, 13021, 13051]
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13022")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13023).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13023).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13024)("hyphen replace", str);
        let str3 = str.replace(tmp11(13025).safeRe[tmp11(undefined, 13025).t.COMPARATORTRIM], tmp11(13025).comparatorTrimReplace);
        tmp11(13024)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13025).safeRe[tmp11(undefined, 13025).t.TILDETRIM], tmp11(13025).tildeTrimReplace);
        tmp11(13024)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13025).safeRe[tmp11(undefined, 13025).t.CARETTRIM], tmp11(13025).caretTrimReplace);
        tmp11(13024)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13021)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13024)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13049).ANY) {
