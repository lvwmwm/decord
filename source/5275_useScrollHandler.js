...
arg5.useScrollHandler = (arg0, onScroll, onScrollBeginDrag, onScrollEndDrag) => {
  ...
  if (arg0 === undefined) {
    useScrollEventsHandlersDefault = _require(5276).useScrollEventsHandlersDefault;
  }
  _require = onScroll;
