...
// Dependencies: [13198, 13282]

// Module 13281 (isSupportedCurrency)
const require = arg1;
...
function isSupportedCurrency(arr3, locale) {
  ...
  const memoizedNumberFormat = require(13198) /* _formatToParts */.createMemoizedNumberFormat(str, obj);
...
arg5.getSupportedCurrencies = function getSupportedCurrencies(locale) {
  const items = [];
  const currencies = require(13282).currencies;
  let num = 0;
