...
// Dependencies: [5, 17, 82, 13551, 13553, 13555, 13556, 13559, 13560, 13573, 13575, 13577, 13578, 13579, 13580, 13561]

// Module 13550 (reactNativeCorePlugins)
...
import module_13559 from "module_13559";
import objectifyError from "objectifyError";
import onSend from "onSend";
import module_13575 from "module_13575";
...
const obj18 = {
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL === "ge") {
        const _Error = Error;
        const error = new Error("Invalid non-string URL");
        throw error;
      } else {
        return require(13580) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
