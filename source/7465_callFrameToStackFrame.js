...
// Dependencies: [7353, 7350, 7463]

// Module 7465 (callFrameToStackFrame)
const require = arg1;
...
arg5.callFrameToStackFrame = function callFrameToStackFrame(location, str) {
  ...
  obj[2] = location.functionName || require(7350) /* createStackParser */.UNKNOWN_FUNCTION;
  obj[3] = sum;
  obj[4] = sum1;
  let filenameIsInAppResult;
  if (replaced) {
    filenameIsInAppResult = tmp4(7463).filenameIsInApp(replaced);
    const tmp4Result = tmp4(7463);
  }
