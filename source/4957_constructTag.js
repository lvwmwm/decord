...
// Function ID: 4958
// Name: constructTag
// Dependencies: [4913, 4929, 4941, 4910, 4917, 4943]
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  const stringValueFromArray = require(4910) /* getDataView */.getStringValueFromArray(items1);
  let combined = stringValueFromArray;
  if (type !== require(4917).TYPE_TEXT) {
  ...
  if (type === require(4917).TYPE_ITXT) {
