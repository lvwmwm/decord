...
// Module 5402 (useRecyclerViewController)
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
          ...
          if (self >= 0) {
            if (self < self.getDataLength()) {
              ...
              finishScrollToIndex = function finishScrollToIndex() {
                ...
                if (horizontal) {
                  let obj = { GiftingBadgeExperiment: 60, EMOJI_PICKER: 0, alignSelf: 0, offset: startScrollOffset };
                  closure_13.scrollToOffset(obj);
                }
      ...
      if (num < num2) {
        if (!self.isInitialScrollComplete) {
          if (self.getIsFirstLayoutComplete()) {
            ...
            const obj = { GiftingBadgeExperiment: "HTTP", EMOJI_PICKER: "Date", alignSelf: "HTTP", offset: sum };
            point = num4(obj);
            _setTimeout(() => {
              const obj = { GiftingBadgeExperiment: "HTTP", EMOJI_PICKER: "Date", alignSelf: "HTTP", offset: sum };
              closure_13.scrollToOffset(obj);
  ...
  callback3(arg1, () => {
    ...
    const obj = {
      <string:508650076>: null,
      <string:2874434054>: null,
      <string:1677985361>: null,
      get() {
        return props.props;
      }
    };
