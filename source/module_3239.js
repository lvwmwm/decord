...
export default { code: "en-GB", formatDistance: result.default, formatLong: require(dependencyMap[4]), formatRelative: result1.default, localize: result2.default, match: result3.default, options: { body: false, add: false } };
