...
// Dependencies: [32, 19, 17, 21, 5611, 5538, 5613, 5600, 5609, 5608, 5587]
// Exports: VirtualDetector

// Module 5612 (VirtualDetector)
    ...
    callback(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: null, handlerTags: null, methods: null, viewRef: "a", userSelect: "r", touchAction: "Ripple", enableContextMenu: "a" };
          obj[0] = tmp;
          obj[1] = closure_7;
