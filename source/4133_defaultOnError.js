...
// Function ID: 4134
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4134, 4135, 4137, 4111]
// Exports: RiveView
...
function defaultOnError(message) {
  return console.error("[" + require(4134).RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp18 = jsx(_require(4111).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
