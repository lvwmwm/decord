...
// Dependencies: [32, 19, 17, 21, 1501, 5479, 5450, 5480, 5451, 5484]
// Exports: HeaderBackButton

// Module 5478 (HeaderBackButton)
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1501 */;
import registerAssetDefault from "registerAsset" /* 5450 */;
import HeaderButton from "HeaderButton" /* 5484 */;
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(5479).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(5479).ICON_MARGIN);
      }
    }
