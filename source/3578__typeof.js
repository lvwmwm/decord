...
// Function ID: 3579
// Name: _typeof
// Dependencies: [3510, 3271, 3576, 3574]
...
let items = [
  {
    ...
    value: function parse(arg0, arg1, ordinalNumber) {
      ...
      if ("Y" === arg1) {
        return _createSuperInternal(3576).mapValue(_createSuperInternal(3576).parseNDigits(4, arg0), valueCallback);
      } else if ("Yo" === arg1) {
        return _createSuperInternal(3576).mapValue(ordinalNumber.ordinalNumber(arg0, { unit: "year" }), valueCallback);
      } else {
  ...
  },
  {
    ...
    value: function set(setUTCFullYear, era, isTwoDigitYear, firstWeekContainsDate) {
      if (isTwoDigitYear.isTwoDigitYear) {
        setUTCFullYear.setUTCFullYear(_createSuperInternal(3576).normalizeTwoDigitYear(isTwoDigitYear.year, tmp), 0, firstWeekContainsDate.firstWeekContainsDate);
