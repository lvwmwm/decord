...
// Dependencies: [32, 109, 19, 21, 1484, 1527, 1528, 1555, 1521, 1512, 1503, 1497, 1510, 1502, 1544, 1485, 1556, 1557, 1501, 1508, 1559, 1504, 1505, 1560, 1562, 1513, 1563, 1564, 1565, 1566, 1570, 1571, 1549, 1546, 1572, 1522, 1551]
// Exports: useNavigationBuilder

// Module 1554 (isNavigationState)
...
export const useNavigationBuilder = function useNavigationBuilder(StackRouter, UNSTABLE_routeNamesChangeBehavior) {
  ...
  let obj = _require(1555);
  const dependencyMap = obj.useRegisterNavigator();
  const context = React.useContext(_require(1521).NavigationRouteContext);
  const context1 = React.useContext(_require(1512).ConsumedParamsContext);
  let params;
  if (context != null) {
  ...
  const lazyValue = _require(1503).useLazyValue(() => {
  ...
  if (mapped.length) {
    ...
    const context2 = React.useContext(_require(1497).NavigationStateContext);
    ...
    const tmp30Result12 = _require(1544);
    ...
    tmp51 = _require(1544).isArrayEqual(tmp39.routeNames, mapped) && 0 === found.length;
  } else {
    let _Error = Error;
