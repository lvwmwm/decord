...
// Function ID: 7504
// Name: dsnFromString
// Dependencies: [32, 7456, 7455]
// Exports: dsnToString, makeDsn

// Module 7503 (dsnFromString)
    ...
    if (obj(7455).DEBUG_BUILD) {
      ...
      if (found) {
        ...
        if (tmp6) {
          ...
          if (num3) {
            const logger3 = error(7456).logger;
            error = logger3.error;
            const _HermesInternal3 = HermesInternal;
          ...
          const logger2 = error(7456).logger;
          const _HermesInternal2 = HermesInternal;
