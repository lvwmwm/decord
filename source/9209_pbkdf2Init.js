...
// Function ID: 9210
// Name: pbkdf2Init
// Dependencies: [5, 9207, 9206, 9210]
// Exports: pbkdf2, pbkdf2Async

// Module 9209 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  let c;
  let dkLen;
  require(9207) /* number */.hash(sha256);
  ({ c, dkLen, asyncTick } = require(9206) /* _asyncLoop */.checkOpts({ dkLen: 32, asyncTick: 10 }, arg3));
  require(9207) /* number */.number(c);
  require(9207) /* number */.number(dkLen);
  require(9207) /* number */.number(asyncTick);
  if (c < 1) {
    const _Error = Error;
  ...
  const checkOptsResult = require(9206) /* _asyncLoop */.checkOpts({ dkLen: 32, asyncTick: 10 }, arg3);
}
...
export const pbkdf2 = function pbkdf2(sha256, B, B, arg3) {
  ...
  const uint8Array = new Uint8Array(4);
  const view = require(9206) /* _asyncLoop */.createView(uint8Array);
