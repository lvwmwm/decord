...
// Function ID: 56486
// Name: NativeModules
// Dependencies: [5, 27, 6278, 6279, 6284, 6285, 6286, 6287, 6288]
...
const subs = require("module_6278").ProductType.subs;
const inapp = require("module_6278").ProductType.inapp;
...
export const isIosStorekit2 = require("module_6279").isIosStorekit2;
...
export const flushFailedPurchasesCachedAsPendingAndroid = function flushFailedPurchasesCachedAsPendingAndroid() {
  const androidModule = require(6279).getAndroidModule();
...
export const deepLinkToSubscriptions = function deepLinkToSubscriptions(isAmazonDevice) {
  ...
  let closure_0 = callback(async () => {
    if (obj) {
      return obj.resume();
    } else if (callback(6279).isAmazon) {
      obj = { isAmazonDevice: outer1_2 };
      const result = outer2_1(6285).deepLinkToSubscriptionsAmazon(obj);
      const obj4 = outer2_1(6285);
    } else if (outer1_1) {
      obj = { sku: outer1_1 };
      const result1 = outer2_1(6286).deepLinkToSubscriptionsAndroid(obj);
      const obj2 = outer2_1(6286);
    } else {
      const _Error = Error;
