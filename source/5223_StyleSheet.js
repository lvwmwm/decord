...
// Function ID: 5224
// Name: StyleSheet
// Dependencies: [109, 19, 17, 21, 1584, 5224, 5221, 5226, 5227]
// Exports: default

// Module 5223 (StyleSheet)
...
export default function Header(children) {
  ...
  const context = React.useContext(importDefault(5224));
  if (undefined === layout) {
  ...
  if (headerBackground) {
    ...
    if (!headerTransparent) {
      ...
      obj4[0] = items;
      headerBackgroundResult = tmp15(importDefault(5227), obj4);
    }
  }
  ...
  tmp8 = importDefault(5221)(layout, undefined !== modal && modal, headerStatusBarHeight);
