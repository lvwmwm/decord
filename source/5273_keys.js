...
export default (arg0) => {
  let require;
  let obj = {};
  const keys = Object.keys(require(5271) /* keys */);
  ...
  while (items.length) {
    ...
    let keys1 = Object.keys(require(5271) /* keys */[arr]);
  ...
  for (let num3 = 0; num3 < length3; num3 = num3 + 1) {
    ...
    if (null !== obj[tmp8].parent) {
      ...
      let fn = require(5271) /* keys */[obj[tmp8].parent][tmp8];
      ...
      if (obj[parent3].parent) {
        do {
          ...
          require = require(5271) /* keys */[obj[parent3].parent][parent3];
          dependencyMap = fn;
