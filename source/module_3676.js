...
let obj = {};
obj = { matchPattern: /^[०१२३४५६७८९]+/i, parsePattern: /^[०१२३४५६७८९]+/i, valueCallback: require(dependencyMap[2]).localeToNumber };
obj.ordinalNumber = require(dependencyMap[1])(obj);
