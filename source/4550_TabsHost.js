...
// Function ID: 39861
// Name: TabsHost
// Dependencies: [57, 29, 31, 27, 33, 4551, 4526, 4552, 4553, 4555]
// Exports: default

// Module 4550 (TabsHost)
...
export default function TabsHost(onNativeFocusChange) {
  ...
  let obj = onNativeFocusChange(4551);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4526).experiment.controlledBottomTabs;
  }
  ...
  obj.children = items1;
  return closure_9(ref(4552), Object.assign(obj, tmp4, obj));
};
