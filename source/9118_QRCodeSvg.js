...
// Function ID: 9119
// Name: QRCodeSvg
// Dependencies: [9115, 19, 7837]

// Module 9118 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(7837) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(7837) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(7837) /* inlineStyles */.Path, { d, fill }));
});
