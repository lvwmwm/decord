...
// Dependencies: [57, 31, 27, 33, 1457, 4487, 9152, 4478, 1560, 5526, 9153, 9156, 9157]
// Exports: default

// Module 9151 (NativeStackViewInner)
...
function MaybeNestedStack(children) {
  ...
  return closure_7(importDefault(9152), obj);
}
function SceneView(arg0) {
  ...
  items1[2] = callback2(importDefault(9153), Object.assign({}, options, obj13));
