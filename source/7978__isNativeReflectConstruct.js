...
// Dependencies: [41, 42, 93, 95, 98, 19, 7979, 21, 7888, 7895, 7896, 7902, 7981, 7904]
...
let items = [
  {
    ...
    value: function render() {
      ...
      obj.x = null;
      obj.y = null;
      const tmp2Result = importDefault(7895)(obj, this);
      const merged1 = Object.assign(tmp2Result, importDefault(7902)(propsAndStylesResult, true));
      tmp2Result.ref = this.refMethod;
      obj = {};
      const tmp2 = importDefault(7895);
      const merged2 = Object.assign(tmp2Result);
      return jsx(importDefault(7981), {});
    }
  }
];
