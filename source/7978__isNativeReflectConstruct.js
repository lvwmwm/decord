...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 7884, 7892, 7898, 7891, 7979, 7975, 7900]

// Module 7978 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(7892).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
      ...
      if (tmp5) {
        ...
        obj[6] = midLine;
        const merged = Object.assign(withoutXYResult, importDefault(7898)(obj, true), obj);
        withoutXYResult.ref = self.refMethod;
        obj1 = {};
        const merged1 = Object.assign(withoutXYResult);
        return jsx(importDefault(7979), {});
      } else {
        ...
        obj[1] = children;
        return jsx(importDefault(7975), { ref: null, children: null });
      }
