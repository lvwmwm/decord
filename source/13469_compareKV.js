...
// Function ID: 13470
// Name: compareKV
// Dependencies: [1281, 13470, 13468, 13471, 13472]

// Module 13469 (compareKV)
const require = arg1;
...
function canonicalizeUnicodeLanguageId(lang) {
  ...
  if (lang.variants.length) {
    ...
    if (0 < variants.length) {
      ...
      obj[1] = items;
      const str = require(13470).languageAlias[require(undefined, 13468) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj)];
      while (!str) {
        num3 = num3 + 1;
        tmp = lang;
      }
      obj = { lang: null, script: null, region: null, variants: null };
      const result = tmp2(13471).parseUnicodeLanguageId(str.split(tmp2(13471).SEPARATOR));
      obj[0] = result.lang;
  ...
  if (tmp.script) {
    ...
    if (tmp.region) {
      ...
      obj[3] = [];
      const str2 = require(13470).languageAlias[require(undefined, 13468) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj)];
      tmp9 = tmp;
      if (str2) {
        const obj1 = { lang: null, script: null, region: null, variants: null };
        const result1 = tmp10(13471).parseUnicodeLanguageId(str2.split(tmp10(13471).SEPARATOR));
  ...
  if (tmp9.region) {
    ...
    obj2[2] = [];
    const str3 = require(13470).languageAlias[require(undefined, 13468) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj2)];
    tmp13 = tmp9;
    if (str3) {
      const obj3 = { lang: null, script: null, region: null, variants: null };
      const result2 = tmp14(13471).parseUnicodeLanguageId(str3.split(tmp14(13471).SEPARATOR));
      obj3[0] = result2.lang;
  ...
  const str4 = require(13470).languageAlias[require(undefined, 13468) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj4)];
  let tmp19 = tmp13;
  if (str4) {
    const obj5 = { lang: null, script: null, region: null, variants: null };
    const result3 = tmp17(13471).parseUnicodeLanguageId(str4.split(tmp17(13471).SEPARATOR));
    obj5[0] = result3.lang;
  ...
  if (tmp19.region) {
    ...
    const str6 = tmp17(13470).territoryAlias[formatted];
    let tmp22;
    if (str6) {
      ...
      obj6[2] = [];
      const str8 = tmp17(13472).likelySubtags[tmp17(undefined, 13468).emitUnicodeLanguageId(undefined, obj6)];
      tmp22 = first;
      if (str8) {
        const region = tmp17(13471).parseUnicodeLanguageId(str8.split(tmp17(13471).SEPARATOR)).region;
        let tmp24 = region;
        if (region) {
  ...
  if (tmp19.script) {
    ...
    if (tmp17(13470).scriptAlias[tmp19.script]) {
      tmp19.script = tmp17(13470).scriptAlias[tmp19.script];
    }
  ...
  if (tmp19.variants.length) {
    for (let num7 = 0; num7 < tmp19.variants.length; num7 = num7 + 1) {
      ...
      let tmp29 = num7;
      if (require(13470).variantAlias[formatted2]) {
        let tmp30 = tmp27(13470).variantAlias[formatted2];
        if (tmp27(13471).isUnicodeVariantSubtag(tmp30)) {
          tmp19.variants[num7] = tmp30;
        } else if (tmp27(13471).isUnicodeLanguageSubtag(tmp30)) {
          tmp19.lang = tmp30;
        }
      }
    }
