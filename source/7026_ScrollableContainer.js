...
// Dependencies: [19, 21, 7027, 7028, 7030]
...
export const ScrollableContainer = require("noop").forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  const tmp6 = jsx(require(7027) /* BottomSheetDraggableScrollable */.BottomSheetDraggableScrollable, { ref });
  let tmp2Result = tmp6;
  if (onRefresh) {
    ...
    obj[3] = onRefresh;
    obj[4] = require(7030) /* styles */.styles.container;
    obj[5] = tmp6;
    tmp2Result = jsx(importDefault(7028), { scrollableGesture: null, refreshing: null, progressViewOffset: null, onRefresh: null, style: null, children: null });
    const tmp9 = importDefault(7028);
  }
  return tmp2Result;
});
