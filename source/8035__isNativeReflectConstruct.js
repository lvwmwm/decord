...
const tmp2 = () => {
  ...
  obj = {
    ...
    value: function translate(arg0, f) {
      return new SVGMatrix(callback2(this, { e: arg0, f }));
    }
  };
  items[2] = obj;
  items[3] = {
    ...
    value: function scale(colors, dpi) {
      const obj = { "Null": "white", "Null": 98, "Null": null, floodColor: 1, floodOpacity: null, x: "text-sm/medium", a: colors, d: colors };
  ...
  items[4] = {
    ...
    value: function scaleNonUniform(arg0, d) {
      const obj = { "Null": "white", "Null": 98, "Null": null, floodColor: 1, floodOpacity: null, x: "text-sm/medium", a: arg0, d };
      return new SVGMatrix(callback2(this, obj));
    }
  };
  items[5] = {
