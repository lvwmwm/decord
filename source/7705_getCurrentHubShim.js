...
// Dependencies: [7624, 7645, 7670]

// Module 7705 (getCurrentHubShim)
...
function getCurrentHubShim() {
  return {
    bindClient(arg0) {
      const currentScope = callback(7624).getCurrentScope();
      currentScope.setClient(arg0);
    },
    withScope: getClient.withScope,
    getClient() {
      return callback(7624).getClient();
    },
    ...
    getIntegration(id) {
      const client = callback(7624).getClient();
