...
export const MODAL_STACK_BEHAVIOR = { space: 0., TypeError: 0., borderRadius: 0. };
export const KEYBOARD_BEHAVIOR = { overflow: false, Cell: true, StickyHeader: false };
export const KEYBOARD_BLUR_BEHAVIOR = {};
export const KEYBOARD_INPUT_MODE = { "Bool(false)": true, "Bool(false)": true };
