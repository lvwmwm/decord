...
// Dependencies: [7455, 7456, 7500, 7503, 7492, 7461]
// Exports: createEventEnvelope, createSessionEnvelope, createSpanEnvelope

// Module 7499 (createEventEnvelope)
...
export const createEventEnvelope = function createEventEnvelope(type, arg1, sdk) {
  const sdkMetadataForEnvelopeHeader = require(7500) /* forEachEnvelopeItem */.getSdkMetadataForEnvelopeHeader(sdk);
  let str = "event";
  if (type.type) {
    str = "event";
...
export const createSessionEnvelope = function createSessionEnvelope(toJSON) {
  let obj = require(7500) /* forEachEnvelopeItem */;
