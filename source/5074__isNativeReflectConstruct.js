  ...
  class DrawerLayout {
    constructor(arg0) {
      ...
      tmp2Result.updateAnimatedEvent = (drawerWidth, drawerTranslation) => {
        ...
        tmp2Result.openValue = RN.add(addResult2, drawerTranslation.drawerTranslation).interpolate({ inputRange: items1, outputRange: ["Text", "lc"], extrapolate: "clamp" });
...
tmp4.defaultProps = { "Bool(false)": 1, "Bool(false)": 1, "Bool(false)": 1, "Bool(false)": null, "Bool(false)": 0, "Bool(false)": null, "Bool(false)": 0, "Bool(false)": 240, "Bool(false)": 0 };
tmp4.positions = { "Bool(true)": null, "Bool(true)": null };
const tmp3 = arg1(dependencyMap[7]);
const styles = StyleSheet.create({ drawerContainer: Object.assign({}, StyleSheet.absoluteFillObject, { 1728054477: null, -1258289972: null }), containerInFront: Object.assign({}, StyleSheet.absoluteFillObject, { zIndex: 1002 }), containerOnBack: Object.assign({}, StyleSheet.absoluteFillObject), main: { "Bool(true)": -0.00000000000012789793692990043, "Bool(true)": 8594663808.000595, "Bool(true)": 0. }, overlay: Object.assign({}, StyleSheet.absoluteFillObject, { zIndex: 1000 }) });
