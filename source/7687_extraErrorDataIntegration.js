...
// Dependencies: [7653, 7604, 7642, 7603, 7606, 7625, 7597]

// Module 7687 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(7625).DEBUG_BUILD) {
                const logger = callback(7597).logger;
