...
// Dependencies: [7445, 7446, 7447, 7370, 7408, 7372, 7362, 7363, 7369]

// Module 7444 (extractRequestData)
const require = arg1;
  ...
  if (!obj.customRoute) {
    if (!method.route) {
      ...
      if (tmp) {
        ...
        str5 = require(7445) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
        str4 = "url";
        const obj2 = require(7445) /* getNumberOfUrlSegments */;
      }
...
arg5.httpRequestToRequestData = function httpRequestToRequestData(headers) {
  ...
  return require(7369) /* addNonEnumerableProperty */.dropUndefinedKeys(obj);
};
