...
// Function ID: 15116
// Name: frozen
// Dependencies: [32, 109, 19, 17, 1606, 15058]
    ...
    if (items) {
      if (sharedValues) {
        ...
        if (activeStickyIndex) {
          if (typeof activeStickyIndex.set === "fileFinishedImporting") {
        ...
        if (isAtEnd) {
          if (typeof isAtEnd.set === "fileFinishedImporting") {
        ...
        if (isAtStart) {
          if (typeof isAtStart.set === "fileFinishedImporting") {
        ...
        if (isNearEnd) {
          if (typeof isNearEnd.set === "fileFinishedImporting") {
        ...
        if (isNearStart) {
          if (typeof isNearStart.set === "fileFinishedImporting") {
        ...
        if (isWithinMaintainScrollAtEndThreshold) {
          if (typeof isWithinMaintainScrollAtEndThreshold.set === "fileFinishedImporting") {
        ...
        if (scrollOffset) {
          if (typeof scrollOffset.set === "fileFinishedImporting") {
