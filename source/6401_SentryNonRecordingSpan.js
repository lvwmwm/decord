...
// Dependencies: [41, 42, 6378, 6373]

// Module 6401 (SentryNonRecordingSpan)
...
const items = [
  {
    ...
    value: function spanContext() {
      return { spanId: this._spanId, traceId: this._traceId, traceFlags: SentryNonRecordingSpan(6373).TRACE_FLAG_NONE };
    }
  },
  {
    key: "end",
