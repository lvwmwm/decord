...
// Module 4485 (ScreenStackHeaderSubview)
let Platform;
let StyleSheet;
let closure_3 = [null];
let closure_4 = [null];
...
const obj = { "Bool(false)": "<string:218103808>", "Bool(false)": "<string:218103808>", "Bool(false)": "<string:452984832>", "Bool(false)": "<string:1107296256>", alignItems: undefined };
const styles = StyleSheet.create({ headerSubview: { "Bool(true)": null, "Bool(true)": null, "Bool(true)": null }, headerSubviewCenter: { "Bool(true)": null, "Bool(true)": null, "Bool(true)": null, "Bool(true)": null }, headerConfig: obj });
