...
// Dependencies: [93, 95, 98, 42, 41, 5488, 5471]

// Module 5487 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      let obj = ContinousBaseGesture(5488);
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5471).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(5471);
      }
      return tmp;
    }
  }
