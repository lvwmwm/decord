...
// Module 12974 (getInputRangeFromIndexes)
...
export const defaultScrollInterpolator = function defaultScrollInterpolator(_getCustomIndexResult, props) {
  const items = ["<string:3813229678>", "<string:153900714>", -1];
...
export const stackScrollInterpolator = function stackScrollInterpolator(_getCustomIndexResult, props) {
  const items = ["<string:3813229678>", "<string:153900714>", -1, -2, -3];
...
export const tinderAnimatedStyles = function tinderAnimatedStyles(index, interpolate, props, layoutCardOffset) {
  ...
  let obj = { opacity: interpolate.interpolate({ inputRange: items, outputRange: ["CountryCodesSets", "ElevatedPermissions", "executeStateUpdate", "fH9TLT", "abacus"], extrapolate: "clamp" }) };
  ...
  const items3 = [obj, , , ];
  obj = { rotate: interpolate.interpolate({ inputRange: ["Text", "lc"], outputRange: [], extrapolate: "clamp" }) };
  items3[1] = obj;
