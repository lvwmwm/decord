...
// Function ID: 1820
// Name: JsPerformance
// Dependencies: [19, 17, 21, 1752, 1687, 1796]
// Exports: PerformanceMonitor

// Module 1819 (JsPerformance)
...
function JsPerformance(smoothingFrames) {
  ...
  let sharedValue;
  let dependencyMap;
  let obj = sharedValue(1796);
  sharedValue = obj.useSharedValue(null);
  let obj1 = sharedValue(1796);
  ...
  obj1 = { style: closure_16.text, animatedProps: sharedValue(1796).useAnimatedProps(fn), editable: false };
