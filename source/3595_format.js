...
// Function ID: 3596
// Name: format
// Dependencies: [3545, 3596, 3363, 3597, 3608, 3526, 3367, 3364, 3609, 3368, 3610]
// Exports: default
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = _require(3368).getDefaultOptions();
  locale = undefined;
  if (null != locale) {
              ...
              if (tmp3.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3610).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3610).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3610).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
