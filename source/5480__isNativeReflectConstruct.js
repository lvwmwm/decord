...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5412, 5437, 5425]

// Module 5480 (_isNativeReflectConstruct)
...
class Swipeable {
  constructor(arg0) {
    ...
    obj = { dragX: value, rowTranslation: null, rowState: 0, leftWidth: "channel", rightOffset: "flex", rowWidth: "y" };
...
let items = [
  obj,
  {
    ...
    value: function render() {
      ...
      items8[2] = callback3(self(5425).TapGestureHandler, obj8);
      obj7[2] = items8;
      obj6.children = callback4(RN.View, obj7);
      return callback3(self(5437).PanGestureHandler, obj6);
    }
  }
];
