  ...
  if (!globalThis._WORKLET) {
    if (!isJest) {
      ...
      if (!factory) {
        ...
        obj = require(1679) /* isWorkletFunction */;
        tmp5 = require;
      }
    }
  }
...
function recognizePrefixSuffix(current) {
  if (typeof current === "string") {
    ...
    if (match) {
      ...
      const reanimatedError = new require(1665) /* t */.ReanimatedError("Couldn't parse animation value.");
      throw reanimatedError;
    }
  } else {
...
function getReduceMotionFromConfig(reduceMotion) {
  if (reduceMotion) {
    if (reduceMotion !== require(1679) /* isWorkletFunction */.ReduceMotion.System) {
      let value = reduceMotion === require(1679) /* isWorkletFunction */.ReduceMotion.Always;
    }
    return value;
  }
  value = uiValue.value;
...
function applyProgressToMatrix(arg0, arr, arr) {
  const obj = require(1696) /* isAffineMatrixFlat */;
  const obj2 = require(1696) /* isAffineMatrixFlat */;
  return obj.addMatrices(arr, obj2.scaleMatrix(require(1696) /* isAffineMatrixFlat */.subtractMatrices(arr, arr), arg0));
}
