...
// Function ID: 98071
// Name: Deflate
// Dependencies: [12690, 12692, 12693, 12694, 12698]

// Module 12691 (Deflate)
const require = arg1;
    ...
    if (this instanceof Deflate) {
      ...
      if (options.raw) {
        ...
        if (0 !== deflateInit2Result) {
          ...
          tmp41 = new.target;
          tmp42 = new.target;
          error = new Error(require("module_12694")[deflateInit2Result]);
          tmp44 = error;
          throw error;
        } else {
          if (options.header) {
          ...
          if (options.dictionary) {
            ...
            if (0 !== deflateSetDictionaryResult) {
              ...
              tmp34 = new.target;
              tmp35 = new.target;
              error1 = new Error(require("module_12694")[deflateSetDictionaryResult]);
              tmp37 = error1;
              throw error1;
            } else {
              flag2 = true;
