...
// Dependencies: [109, 41, 42, 12313, 12314]

// Module 12315 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(12313).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(12313).extractDefs(self.ctx, _idmap);
      return callback(JSONSchemaGenerator(12313).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
