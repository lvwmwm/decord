...
// Function ID: 7860
// Name: extractFont
// Dependencies: [19, 21, 7853, 7858]
// Exports: default, setTSpan

// Module 7859 (extractFont)
import "noop";
...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(7853) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "string") {
    ...
    obj[7] = importDefault(7858)(tmp);
    obj[8] = importDefault(7858)(tmp2);
    obj[9] = importDefault(7858)(tmp3);
    obj[10] = importDefault(7858)(tmp4);
    obj[11] = importDefault(7858)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
