...
// Function ID: 4930
// Name: constructTag
// Dependencies: [4885, 4901, 4913, 4882, 4889, 4915]

// Module 4929 (constructTag)
const require = arg1;
const module = arg2;
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  const stringValueFromArray = require(4882) /* getDataView */.getStringValueFromArray(items1);
  let combined = stringValueFromArray;
  if (type !== require(4889).TYPE_TEXT) {
  ...
  if (type === require(4889).TYPE_ITXT) {
