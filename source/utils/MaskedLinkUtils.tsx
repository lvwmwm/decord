...
// Function ID: 8573
// Name: isLinkTrusted
// Dependencies: [8573, 1391, 1910, 8574, 4688, 4098, 1981, 676, 4160, 4809, 1236, 698, 8575, 8576, 8577, 8579, 4152, 12725, 12729, 4906, 12730, 12732, 2]
// Exports: handleClick, isLinkTrusted

// Module 8572 (isLinkTrusted)
import closure_3 from "isBlockedDomain" /* 8573 */;
import closure_4 from "ensureGuildLoaded" /* 1391 */;
import closure_5 from "createGuildRecordFromRust" /* 1910 */;
import closure_6 from "set" /* 8574 */;
  ...
  if (null == sanitizeUrlResult) {
    ...
    try {
      ...
      if (null == onClick) {
        ...
        obj3[2] = messageId;
        obj3[3] = channelId;
        const defaultResult = _require(8579).default(tmp8, obj3);
      }
      if (onCancel == null) {
        onCancel = () => {
      ...
      if (null !== guild_id.isBlockedDomain(tmp8)) {
        ...
        if (!trustedResult) {
          const TRUSTED_URLS = _require(12729).TRUSTED_URLS;
          trustedResult = TRUSTED_URLS.has(tmp8);
        }
        const protocol = _require(8575).getProtocol(tmp8);
        ...
        if (null == preventDefault) {
          ...
          obj6[3] = tmp12;
          obj6[4] = tmp11;
          let result = tmp3(8577).trackAnnouncementMessageLinkClicked(obj6);
          const tmp3Result6 = tmp3(8577);
        }
        const obj10 = _require(8575);
      }
      const tmp3Result2 = tmp3(8577);
    } catch (err) {
