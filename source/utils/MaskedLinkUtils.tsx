...
// Function ID: 8939
// Name: isLinkTrusted
// Dependencies: [8939, 1391, 1910, 8940, 4521, 3957, 1979, 676, 4019, 4642, 1236, 698, 8941, 8942, 8943, 8945, 4011, 12227, 12231, 4739, 12232, 12234, 2]
// Exports: handleClick, isLinkTrusted

// Module 8938 (isLinkTrusted)
  ...
  if (null == sanitizeUrlResult) {
    ...
    try {
      ...
      if (null == onClick) {
        ...
        obj3[2] = messageId;
        obj3[3] = channelId;
        const defaultResult = _require(8945).default(tmp8, obj3);
      }
      if (onCancel == null) {
        onCancel = () => {
      ...
      if (null !== guild_id.isBlockedDomain(tmp8)) {
        ...
        if (!trustedResult) {
          const TRUSTED_URLS = _require(12231).TRUSTED_URLS;
          trustedResult = TRUSTED_URLS.has(tmp8);
        }
        const protocol = _require(8941).getProtocol(tmp8);
