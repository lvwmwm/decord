...
// Function ID: 8588
// Name: isLinkTrusted
// Dependencies: [8588, 1391, 1910, 8589, 4701, 4099, 1982, 676, 4161, 4822, 1236, 698, 8590, 8591, 8592, 8594, 4153, 12744, 12748, 4919, 12749, 12751, 2]
// Exports: handleClick, isLinkTrusted

// Module 8587 (isLinkTrusted)
import closure_3 from "isBlockedDomain" /* 8588 */;
import closure_4 from "ensureGuildLoaded" /* 1391 */;
import closure_5 from "createGuildRecordFromRust" /* 1910 */;
import closure_6 from "set" /* 8589 */;
...
export const handleClick = function handleClick(href, preventDefault) {
  ...
  if (null == sanitizeUrlResult) {
    ...
    try {
      ...
      tmp3(8592).trackLinkClicked(tmp8);
      if (null == onClick) {
        const obj3 = { skipExtensionCheck: "a", analyticsLocations: "krydda", messageId: "salt", channelId: "saltkar" };
        obj3[1] = items;
        obj3[2] = messageId;
        obj3[3] = channelId;
        const defaultResult = _require(8594).default(tmp8, obj3);
      }
      if (onCancel == null) {
        onCancel = () => {
      ...
      if (null !== guild_id.isBlockedDomain(tmp8)) {
        ...
        if (!trustedResult) {
          const TRUSTED_URLS = _require(12748).TRUSTED_URLS;
          trustedResult = TRUSTED_URLS.has(tmp8);
        }
        const protocol = _require(8590).getProtocol(tmp8);
        ...
        if (null == preventDefault) {
          ...
          obj6[3] = tmp12;
          obj6[4] = tmp11;
          let result = tmp3(8592).trackAnnouncementMessageLinkClicked(obj6);
          const tmp3Result6 = tmp3(8592);
        }
        const obj10 = _require(8590);
      }
      const tmp3Result2 = tmp3(8592);
    } catch (err) {
