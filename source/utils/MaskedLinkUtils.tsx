...
// Function ID: 8856
// Name: isLinkTrusted
// Dependencies: [8856, 1372, 1891, 8857, 4502, 3921, 1960, 676, 3983, 4623, 1236, 698, 8858, 8859, 8860, 8862, 3975, 12140, 12144, 4720, 12145, 12147, 2]
// Exports: handleClick, isLinkTrusted

// Module 8855 (isLinkTrusted)
  ...
  if (null == sanitizeUrlResult) {
    ...
    try {
      ...
      if (null !== guild_id.isBlockedDomain(tmp8)) {
        ...
        if (!trustedResult) {
          const TRUSTED_URLS = _require(12144).TRUSTED_URLS;
          trustedResult = TRUSTED_URLS.has(tmp8);
        }
        const protocol = _require(8858).getProtocol(tmp8);
        ...
        if (null == preventDefault) {
          ...
          obj6[3] = tmp12;
          obj6[4] = tmp11;
          let result = tmp3(8860).trackAnnouncementMessageLinkClicked(obj6);
          const tmp3Result6 = tmp3(8860);
        }
        const obj10 = _require(8858);
      }
      const tmp3Result2 = tmp3(8860);
    } catch (err) {
