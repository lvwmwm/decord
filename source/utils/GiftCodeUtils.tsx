...
let items = [require("set").escape(window.GLOBAL_ENV.GIFT_CODE_HOST), ...items1.map((arg0) => importDefault(4330).escape(arg0))];
...
const items3 = [...items2.map((arg0) => importDefault(4330).escape(arg0))];
