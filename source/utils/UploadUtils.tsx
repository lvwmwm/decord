...
export const getAttachmentPayload = function getAttachmentPayload(closure_0, closure_1, name) {
  ...
  if (tmp6) {
    ...
    obj.clip_created_at = require(4916) /* getClipCreatedAt */.getClipCreatedAt(closure_0.clip.createdAt);
    const obj2 = require(4916) /* getClipCreatedAt */;
    obj.clip_participant_ids = require(4916) /* getClipCreatedAt */.getClipParticipantIds(closure_0.clip.users);
    obj.clip_remote_id = closure_0.clip.remoteClipId;
    const obj3 = require(4916) /* getClipCreatedAt */;
    obj.clip_events_timeline = require(4916) /* getClipCreatedAt */.getClipEventsTimeline(closure_0.clip);
    const obj4 = require(4916) /* getClipCreatedAt */;
  }
  let tmp9 = "item" in closure_0 && null != closure_0.item;
  if (tmp9) {
    tmp9 = closure_0.item.platform === require(4914) /* cancel */.UploadPlatform.WEB;
  }
  if (tmp9) {
    str = "mimeType";
