...
// Function ID: 67480
// Name: GameGenres
// Dependencies: [57, 653, 3987, 1212, 4404, 477, 3747, 2]
...
export const canUserInstall = function canUserInstall(type) {
  const obj = require(4404) /* _httpGetWithCountryCodeQuery */;
...
export const getReadablePreorderReleaseDate = function getReadablePreorderReleaseDate(arg0) {
  ...
  if (null != preorderReleaseAt) {
    ...
    if (0 < items.length) {
      ...
      const obj = importDefault(3747)(preorderApproximateReleaseDate, tmp4, true);
      while (!obj.isValid()) {
        num = num + 1;
        let tmp8 = items;
      }
