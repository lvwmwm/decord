...
// Dependencies: [32, 3939, 1218, 1372, 1891, 3938, 1903, 676, 1236, 11, 8034, 8038, 4491, 4492, 8039, 8041, 4530, 4521, 8042, 8043, 6915, 2]

// Module 8033 (getSystemMessageUserJoinMobile)
    ...
    if (null == first) {
      ...
      if (constants.RECIPIENT_ADD === type) {
        if (null != null) {
          ...
          obj[3] = closure_12;
          return require(8034) /* reactParserFor */.astToString(intl18.formatToParts(require(1236) /* getSystemLocale */.t["7/Xl0S"], obj));
        }
        ...
        if (null != null) {
          ...
          if (null != author) {
            if (author.id !== null.id) {
              ...
              obj[2] = tmp6Result.getName(null, channel_id, null);
              obj[3] = closure_12;
              let astToStringResult = require(8034) /* reactParserFor */.astToString(intl17.formatToParts(require(1236) /* getSystemLocale */.t.QtZ0RD, obj));
              const obj58 = require(8034) /* reactParserFor */;
            }
          ...
          obj1[0] = name;
          obj1[1] = closure_12;
          astToStringResult = require(8034) /* reactParserFor */.astToString(intl16.formatToParts(require(1236) /* getSystemLocale */.t["Qn5+Lf"], obj1));
          const obj56 = require(8034) /* reactParserFor */;
        }
        ...
        if (null != call) {
          ...
          if (-1 === participants.indexOf(id.getId())) {
            ...
            obj2[0] = name;
            obj2[1] = closure_12;
            astToStringResult1 = require(8034) /* reactParserFor */.astToString(intl15.formatToParts(require(1236) /* getSystemLocale */.t.DbgSA0, obj2));
            const obj54 = require(8034) /* reactParserFor */;
          }
        }
        return astToStringResult1;
      } else if (tmp9.CHANNEL_NAME_CHANGE === type) {
        const intl14 = require(1236) /* getSystemLocale */.intl;
        const obj52 = require(8034) /* reactParserFor */;
        ...
        obj4[0] = name;
        obj4[1] = closure_12;
        return require(8034) /* reactParserFor */.astToString(intl13.formatToParts(require(1236) /* getSystemLocale */.t.wypJZ0, obj4));
        ...
        obj5[0] = name;
        obj5[1] = closure_12;
        return require(8034) /* reactParserFor */.astToString(intl12.formatToParts(require(1236) /* getSystemLocale */.t["/M60j0"], obj5));
      } else if (tmp9.USER_JOIN === type) {
        const intl11 = require(1236) /* getSystemLocale */.intl;
        const obj6 = { username: null, usernameOnClick: null };
        obj6[0] = name;
        obj6[1] = closure_12;
        return require(8034) /* reactParserFor */.astToString(intl11.formatToParts(getSystemMessageUserJoinMobile(mentions.id), obj6));
      } else if (tmp9.GUILD_BOOST === type) {
        const intl10 = require(1236) /* getSystemLocale */.intl;
        const obj7 = { username: null, usernameOnClick: null };
        obj7[0] = name;
        obj7[1] = closure_12;
        return require(8034) /* reactParserFor */.astToString(intl10.formatToParts(require(1236) /* getSystemLocale */.t.ihxM9x, obj7));
      } else {
          ...
          if (tmp9.GUILD_BOOST_TIER_2 !== type) {
            if (tmp9.GUILD_BOOST_TIER_3 !== type) {
              if (tmp9.GUILD_INVITE_REMINDER === type) {
                ...
                obj8[0] = name;
                obj8[1] = require(4492) /* computeChannelName */.computeChannelName(isForumPost, authStore, upsertRelationship);
                ...
                if (!(mentions instanceof hasFlag)) {
                  const obj34 = require(8034) /* reactParserFor */;
                  ...
                  astToStringResult2 = obj34.astToString(require(8039) /* identityHook */.getRoleSubscriptionPurchaseSystemMessageContentMobile(obj9));
                  const obj35 = require(8039) /* identityHook */;
                }
                ...
                if (!(mentions instanceof hasFlag)) {
                  ...
                  if (null != product_name) {
                    const obj31 = require(8034) /* reactParserFor */;
                    const obj10 = { username: null, productName: null };
                    obj10[0] = name;
                    obj10[1] = mentions.purchase_notification.guild_product_purchase.product_name;
                    astToStringResult3 = obj31.astToString(require(8041) /* getGuildProductPurchaseSystemMessageContentMobile */.getGuildProductPurchaseSystemMessageContentMobile(obj10));
                    const obj32 = require(8041) /* getGuildProductPurchaseSystemMessageContentMobile */;
                  }
                }
                ...
                if (mentions instanceof hasFlag) {
                  ...
                  const obj26 = require(4530) /* useNullableMessageAuthor */;
                  const messageAuthor = obj26.getMessageAuthor(require(4521) /* createMinimalMessageRecord */.createMessageRecord(mentions));
                  const obj27 = require(4521) /* createMinimalMessageRecord */;
                  const obj28 = require(8034) /* reactParserFor */;
                  const obj11 = { application: null, username: null };
                  obj11[0] = mentions.application;
                  obj11[1] = messageAuthor.nick;
                  return obj28.astToString(require(8042) /* getApplicationSubscriptionSystemMessageASTContent */.getApplicationSubscriptionSystemMessageASTContent(obj11));
                }
              } else if (tmp9.PRIVATE_CHANNEL_INTEGRATION_ADDED === type) {
                let astToStringResult4 = null;
                if (!(mentions instanceof hasFlag)) {
                  let obj20 = require(8034) /* reactParserFor */;
                  const obj12 = { application: null, username: null };
                  obj12[0] = mentions.application;
                  const obj22 = require(8043) /* getPrivateChannelIntegrationAddedSystemMessageContent */;
                  const obj24 = require(4530) /* useNullableMessageAuthor */;
                  obj12[1] = obj24.getMessageAuthor(require(4521) /* createMinimalMessageRecord */.createMessageRecord(mentions)).nick;
                  astToStringResult4 = obj20.astToString(obj22.getPrivateChannelIntegrationAddedSystemMessageASTContent(obj12));
                  const obj25 = require(4521) /* createMinimalMessageRecord */;
                }
                return astToStringResult4;
              } else if (tmp9.PRIVATE_CHANNEL_INTEGRATION_REMOVED === type) {
                let astToStringResult5 = null;
                if (!(mentions instanceof hasFlag)) {
                  let obj15 = require(8034) /* reactParserFor */;
                  let obj16 = require(8043) /* getPrivateChannelIntegrationAddedSystemMessageContent */;
                  const obj13 = { application: null, username: null };
                  obj13[0] = mentions.application;
                  let obj18 = require(4530) /* useNullableMessageAuthor */;
                  let obj19 = require(4521) /* createMinimalMessageRecord */;
                ...
                if (someResult) {
                  ...
                  if (null != channel) {
                    ...
                    if (null != guild) {
                      if (require(8038) /* AutomodNotificationEmbedTypeKeys */.AutomodNotificationEmbedTypeKeys.ACTIVITY_ALERTS_ENABLED === value) {
                ...
                if (null != channel1) {
                  ...
                  if (null != guild1) {
                    obj5 = require(8034) /* reactParserFor */;
                ...
                if (null != channel2) {
                  ...
                  if (null != guild2) {
                    obj2 = require(8034) /* reactParserFor */;
        ...
        if (null != channel3) {
          if (null != store2.getGuild(channel3.getGuildId())) {
            ...
            obj19[0] = name;
            obj19[1] = closure_12;
            let astToStringResult9 = require(8034) /* reactParserFor */.astToString(intl8.formatToParts(require(1236) /* getSystemLocale */.t.ihxM9x, obj19));
            const obj40 = require(8034) /* reactParserFor */;
          }
        ...
        obj20[0] = name;
        obj20[1] = closure_12;
        astToStringResult9 = require(8034) /* reactParserFor */.astToString(intl9.formatToParts(require(1236) /* getSystemLocale */.t.ihxM9x, obj20));
        const obj42 = require(8034) /* reactParserFor */;
      }
