...
// Dependencies: [109, 19, 699, 706, 676, 13254, 4215, 1869, 697, 503, 13252, 1208, 709, 5958, 1236, 7, 514, 2, 13255]
...
function expandEventProperties(arg0) {
  ...
  if (null == obj.location) {
    if (null == obj.source) {
      tmp.client_performance_cpu = importDefault(5958).getCurrentCPUUsagePercent();
      const obj6 = importDefault(5958);
      tmp.client_performance_memory = importDefault(5958).getCurrentMemoryUsageKB();
      const obj7 = importDefault(5958);
      tmp.cpu_core_count = importDefault(5958).getCPUCoreCount();
      ...
      const obj8 = importDefault(5958);
      const processUptime = importDefault(5958).getProcessUptime();
...
function addBreadcrumb(arg0) {
  const IGNORE_ANALYTICS_BREADCRUMB_EVENTS = require(13252) /* IGNORE_ANALYTICS_BREADCRUMB_EVENTS */.IGNORE_ANALYTICS_BREADCRUMB_EVENTS;
