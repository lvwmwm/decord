...
// Dependencies: [109, 19, 699, 706, 676, 13397, 4328, 1898, 697, 503, 13395, 1208, 709, 7075, 1236, 7, 514, 2, 13398]
...
function expandEventProperties(arg0) {
  ...
  if (null == obj.location) {
    if (null == obj.source) {
      tmp.client_performance_cpu = importDefault(7075).getCurrentCPUUsagePercent();
      const obj6 = importDefault(7075);
      tmp.client_performance_memory = importDefault(7075).getCurrentMemoryUsageKB();
      const obj7 = importDefault(7075);
      tmp.cpu_core_count = importDefault(7075).getCPUCoreCount();
      ...
      const obj8 = importDefault(7075);
      const processUptime = importDefault(7075).getProcessUptime();
...
function addBreadcrumb(arg0) {
  const IGNORE_ANALYTICS_BREADCRUMB_EVENTS = require(13395) /* IGNORE_ANALYTICS_BREADCRUMB_EVENTS */.IGNORE_ANALYTICS_BREADCRUMB_EVENTS;
