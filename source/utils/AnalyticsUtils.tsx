...
// Dependencies: [109, 19, 699, 706, 676, 13259, 4215, 1869, 697, 503, 13257, 1208, 709, 5960, 1236, 7, 514, 2, 13260]
...
function expandEventProperties(arg0) {
  ...
  if (null == obj.location) {
    if (null == obj.source) {
      tmp.client_performance_cpu = importDefault(5960).getCurrentCPUUsagePercent();
      const obj6 = importDefault(5960);
      tmp.client_performance_memory = importDefault(5960).getCurrentMemoryUsageKB();
      const obj7 = importDefault(5960);
      tmp.cpu_core_count = importDefault(5960).getCPUCoreCount();
      ...
      const obj8 = importDefault(5960);
      const processUptime = importDefault(5960).getProcessUptime();
...
function addBreadcrumb(arg0) {
  const IGNORE_ANALYTICS_BREADCRUMB_EVENTS = require(13257) /* IGNORE_ANALYTICS_BREADCRUMB_EVENTS */.IGNORE_ANALYTICS_BREADCRUMB_EVENTS;
