...
// Dependencies: [32, 5, 676, 38, 4217, 500, 595, 5332, 4319, 4, 5333, 5334, 1467, 530, 4346, 2]

// Module 5331 (sanitizeFilename)
...
obj.beforeUnload = function beforeUnload() {
  ...
  try {
    ...
    if (supportsFeatureResult) {
      ...
      supportsFeatureResult = true !== Storage.get(require(5332) /* DomainMigrationEventType */.DOMAIN_MIGRATION_SUCCESS_KEY);
    }
    if (supportsFeatureResult) {
...
obj.setSystemTrayIcon = function setSystemTrayIcon(arg0) {
  if (require(500) /* set */.isPlatformEmbedded) {
    const self = this;
    this.sendIPC(require(5333) /* IPCEvents */.IPCEvents.SYSTEM_TRAY_SET_ICON, arg0);
  }
};
...
obj.setSystemTrayApplications = function setSystemTrayApplications(arg0) {
  if (require(500) /* set */.isPlatformEmbedded) {
    const self = this;
    this.sendIPC(require(5333) /* IPCEvents */.IPCEvents.SYSTEM_TRAY_SET_APPLICATIONS, arg0);
  }
};
...
obj.clearNavigationHistory = function clearNavigationHistory() {
  backwardCompatSend(require(5333) /* IPCEvents */.IPCEvents.NAVIGATION_HISTORY_CLEAR);
};
...
obj.setApplicationBackgroundColor = function setApplicationBackgroundColor(arg0) {
  this.sendIPC(require(5333) /* IPCEvents */.IPCEvents.SETTINGS_UPDATE_BACKGROUND_COLOR, arg0);
};
...
obj.appViewed = function appViewed() {
  if (obj.isDesktop()) {
    ...
    this.sendIPC(require(5333) /* IPCEvents */.IPCEvents.APP_VIEWED);
  }
};
obj.appFirstRenderAfterReadyPayload = function appFirstRenderAfterReadyPayload(arg0) {
  if (obj.isDesktop()) {
    ...
    this.sendIPC(require(5333) /* IPCEvents */.IPCEvents.APP_FIRST_RENDER_AFTER_READY_PAYLOAD, arg0);
  }
};
obj.appLoaded = function appLoaded() {
  backwardCompatSend(require(5333) /* IPCEvents */.IPCEvents.APP_LOADED);
};
obj.indexLoadedAsync = function indexLoadedAsync() {
  backwardCompatSend(require(5333) /* IPCEvents */.IPCEvents.APP_ASYNC_INDEX_TSX_LOADED);
};
