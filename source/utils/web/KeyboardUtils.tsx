...
function getCodeToKeyLanguageCorrection(keyCode, key, arg2) {
  ...
  const BACKTICK_CODES = require(13233) /* normalizeKey */.BACKTICK_CODES;
  if (BACKTICK_CODES.has(keyCode)) {
    let tmp2Result = tmp2(13233);
  ...
  if (arg1 !== undefined) {
    ...
    if (arg1 !== undefined) {
        ...
        if (tmp20 === true) {
          ...
          if (tmp23 === true) {
            ...
            if (tmp25 === true) {
              ...
              if (tmp27 === true) {
                const tmp39 = importDefault(13232);
      ...
      if (null != tmp17) {
        ...
        const keyboardEventShapeFromKey = require(13233) /* normalizeKey */.getKeyboardEventShapeFromKey(toLocaleLowerCase);
        let keyCode = null;
...
function codeToKey(items1) {
  ...
  if (null != tmp4) {
    ...
    const keyboardEventShapeFromKeycode = require(13233) /* normalizeKey */.getKeyboardEventShapeFromKeycode(tmp2);
    let tmp8 = null;
...
export const getRawCodeFromKey = function getRawCodeFromKey(arg0) {
  if (arg1 !== undefined) {
    if (arg1 === KeyboardEnvs.BROWSER) {
      let tmp10 = importDefault(13232)(arg0);
    } else {
      tmp10 = set[arg0];
    }
    return tmp10;
...
export const toCombo = function toCombo(shortcut) {
  if (arg1 !== undefined) {
    ...
    const parts = shortcut.replace(/numpad plus/i, "").replace(/NUMPAD \+/i, "numpad plus").replace(/mod/i, KEYBOARD_KEY(13234).modKey).split("+");
  ...
  const mapped = arr.map((arg0) => {
    ...
    if (typeof tmp3 === "number") {
      ...
      if (null != tmp17) {
        ...
        const keyboardEventShapeFromKeycode = callback(13233).getKeyboardEventShapeFromKeycode(tmp15);
        combined = null;
        if (null != keyboardEventShapeFromKeycode) {
          combined = callback3(keyboardEventShapeFromKeycode.keyCode, keyboardEventShapeFromKeycode.key, tmp16);
        }
        const obj3 = callback(13233);
      }
      if (combined == null) {
