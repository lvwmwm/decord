...
// Module 12702 (_createForOfIteratorHelperLoose)
let LinuxKeyToCode;
...
export const toBrowserEvents = function toBrowserEvents(arr) {
  let closure_0 = { alignItems: "isArray", flex: "Array", "Bool(false)": "x", "Bool(false)": "props", "Bool(false)": "bm", "Bool(false)": "r", "Bool(false)": "isArray" };
  if (null == arr) {
    let items = [];
  } else {
