...
// Dependencies: [1376, 1372, 1932, 3883, 1931, 4328, 676, 1876, 3888, 506, 1906, 4439, 4440, 1236, 4094, 4441, 11, 2, 4448]
...
// Module 4438 (allowChannelAccess)
...
export const isChannelFull = function isChannelFull(channel, outer1_11, handleConnectionOpen) {
  ...
  if (channel.type === closure_23) {
    ...
    if (tmp8) {
      ...
      if (!hasVideoResult) {
        hasVideoResult = require(4439) /* hasStream */.hasStream(voiceStatesForChannel);
        const obj2 = require(4439) /* hasStream */;
      }
      tmp8 = hasVideoResult;
    }
    if (tmp8) {
      ...
      if (null != tmp10) {
        ...
        if (obj.isGuildStageVoice()) {
          ...
          for (const item10017 of tmp10) {
            ...
            let obj3 = require(4440) /* useAudienceRequestToSpeakState */;
            let audienceRequestToSpeakState = obj3.getAudienceRequestToSpeakState(item10017.voiceState);
            if (audienceRequestToSpeakState === require(4440) /* useAudienceRequestToSpeakState */.RequestToSpeakStates.ON_STAGE) {
              let tmp7 = obj2;
              obj2.return();
              let tmp8 = iter;
              iter.return();
