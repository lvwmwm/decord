...
// Dependencies: [1376, 1372, 1932, 3913, 1931, 4357, 676, 1876, 3918, 506, 1906, 4468, 4469, 1236, 4124, 4470, 11, 2, 4477]
...
function allowChannelAccess(id, channelType, MEMBER) {
  ...
  return { id, type: MEMBER, deny: importAll(3918).NONE, allow: addResult2 };
}
