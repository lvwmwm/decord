...
// Dependencies: [32, 6053, 3817, 676, 38, 5965, 2]

// Module 9571 (parsedItemUsesEveryoneRole)
...
export default {
  ...
  extractEveryoneRole(arg0, getGuildId) {
    ...
    const obj2 = importDefault(5965).parsePreprocessor(getGuildId, arg0)[Symbol.iterator]();
