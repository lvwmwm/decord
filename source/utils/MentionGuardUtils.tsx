...
// Dependencies: [32, 5818, 3912, 676, 38, 7063, 2]

// Module 9829 (parsedItemUsesEveryoneRole)
...
export default {
  ...
  extractEveryoneRole(arg0, getGuildId) {
    ...
    const obj2 = importDefault(7063).parsePreprocessor(getGuildId, arg0)[Symbol.iterator]();
