...
// Dependencies: [32, 5837, 3929, 676, 38, 7082, 2]

// Module 9845 (parsedItemUsesEveryoneRole)
...
export default {
  ...
  extractEveryoneRole(arg0, getGuildId) {
    ...
    const obj2 = importDefault(7082).parsePreprocessor(getGuildId, arg0)[Symbol.iterator]();
