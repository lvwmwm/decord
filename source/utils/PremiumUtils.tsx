...
// Dependencies: [32, 19, 3902, 1874, 3903, 3904, 3906, 3907, 676, 1876, 3915, 505, 3, 3916, 3913, 1897, 38, 1236, 2837, 3837, 3925, 3946, 5749, 3914, 12609, 687, 589, 10306, 4150, 13206, 6909, 1890, 1892, 8593, 2]
...
function getBillingInformationString(status, subscriptionPeriodStart, first1, flag, fractionalPremiumInfo) {
  ...
  const formatPrice = require(5749) /* formatSingleCurrencyPrice */.formatPrice;
  if (flag) {
...
function getUnactivatedFractionalPremiumDurationString(unactivatedUnits) {
  ...
  if (reduced > 0) {
    if (unactivatedUnits.fractionalState === constants6.NONE) {
      ...
      const obj2 = require(12609) /* roundFPCountdownUnits */;
...
function getFormattedPriceForPlan(id, arg1, arg2, flag) {
  ...
  const formatPriceResult = require(5749) /* formatSingleCurrencyPrice */.formatPrice(tmp5.amount, tmp5.currency);
...
function getItemsWithUpsertedPlanIdForGroup(renewalMutations, basePlanId, arg2, closure_31) {
  ...
  if (closure_31.has(basePlanId)) {
    ...
    obj[1] = closure_31;
    obj[1] = obj;
    const checkoutError = new _require(10306).CheckoutError(obj);
    throw checkoutError;
  }
}
...
function formatPriceString(amount) {
  ...
  return "" + require(5749) /* formatSingleCurrencyPrice */.formatPrice(amount.amount, amount.currency) + "/" + stringResult;
}
...
obj = {
  ...
  canUseAnimatedEmojis(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.ANIMATED_EMOJIS, currentUser);
  },
  canUseEmojisEverywhere(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.EMOJIS_EVERYWHERE, currentUser);
  },
  canUseSoundboardEverywhere(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.SOUNDBOARD_EVERYWHERE, currentUser);
  },
  canUseCustomCallSounds(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.CUSTOM_CALL_SOUNDS, currentUser);
  },
  canUploadLargeFiles(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.UPLOAD_LARGE_FILES, currentUser);
  },
  canUseBadges(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.PROFILE_BADGES, currentUser);
  },
  canUseHighVideoUploadQuality(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.INCREASED_VIDEO_UPLOAD_QUALITY, currentUser);
  },
  canEditDiscriminator(stateFromStores) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.CUSTOM_DISCRIMINATOR, stateFromStores);
  },
  hasBoostDiscount(stateFromStores) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.BOOST_DISCOUNT, stateFromStores);
  },
  canUseAnimatedAvatar(c3) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.ANIMATED_AVATAR, c3);
  },
  canInstallPremiumApplications(isPremiumWithFractionalPremiumOnly) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.INSTALL_PREMIUM_APPLICATIONS, isPremiumWithFractionalPremiumOnly);
  },
  canUseIncreasedMessageLength(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.INCREASED_MESSAGE_LENGTH, currentUser);
  },
  canUseIncreasedGuildCap(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.INCREASED_GUILD_LIMIT, currentUser);
  },
  canRedeemPremiumPerks(isPremiumWithFractionalPremiumOnly) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.REDEEM_PREMIUM_PERKS, isPremiumWithFractionalPremiumOnly);
  },
  canUsePremiumProfileCustomization(isPremiumWithFractionalPremiumOnly) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.PROFILE_PREMIUM_FEATURES, isPremiumWithFractionalPremiumOnly);
  },
  canUsePremiumAppIcons(c0) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.APP_ICONS, c0);
  },
  canUsePremiumGuildMemberProfile(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.PREMIUM_GUILD_MEMBER_PROFILE, currentUser);
  },
  canUseClientThemes(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.CLIENT_THEMES, currentUser);
  },
  canStreamQuality(HIGH, user) {
    if (HIGH === obj.HIGH) {
      let canUserUseResult = require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.STREAM_HIGH_QUALITY, user);
      const obj2 = require(13206) /* ProductCatalogFeature */;
    } else {
      obj = require(13206) /* ProductCatalogFeature */;
      canUserUseResult = obj.canUserUse(require(13206) /* ProductCatalogFeature */.STREAM_MID_QUALITY, user);
    }
    return canUserUseResult;
  },
  canUseQuestOrbMultiplier(perks) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.QUEST_ORB_MULTIPLIER, perks);
  },
  hasFreeBoosts(stateFromStores) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.FREE_BOOSTS, stateFromStores);
  },
  canUseCustomStickersEverywhere(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.STICKERS_EVERYWHERE, currentUser);
  },
  canUseCustomBackgrounds(currentUser) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.VIDEO_FILTER_ASSETS, currentUser);
  },
  canUseCollectibles(user) {
    return require(13206) /* ProductCatalogFeature */.canUserUse(require(13206) /* ProductCatalogFeature */.COLLECTIBLES, user);
  },
  canUseMonthlyOrbs(stateFromStores) {
    let hasPerkResult = require(6909) /* apexExperiment */.getIsCrepeEnabled("canUseMonthlyOrbs");
    if (hasPerkResult) {
      let perks;
  ...
  canUseShopDiscounts(currentUser) {
    let isCrepeEnabled = require(6909) /* apexExperiment */.getIsCrepeEnabled("canUseShopDiscounts");
    if (isCrepeEnabled) {
  ...
  canUseMoreQuestOrbs(perks) {
    let isCrepeEnabled = require(6909) /* apexExperiment */.getIsCrepeEnabled("canUseMoreQuestOrbs");
    if (isCrepeEnabled) {
      let tmpResult = tmp(1890);
      perks = undefined;
      if (perks != null) {
...
export const getPlanDescriptionFromInvoice = function getPlanDescriptionFromInvoice(hasDiscountApplied) {
  ...
  obj[2] = obj3.formatRate(require(5749) /* formatSingleCurrencyPrice */.formatPrice(amount, renewalInvoicePreview.currency), value.interval, value.intervalCount);
...
export const getPremiumGuildHeaderDescription = function getPremiumGuildHeaderDescription(arg0) {
  ...
  let str = "";
  if (null != tmp10) {
    let obj1 = require(5749) /* formatSingleCurrencyPrice */;
...
export const getFormattedRateForPlan = function getFormattedRateForPlan(interval) {
  ...
  return require(5749) /* formatSingleCurrencyPrice */.formatRate(tmp, interval.interval, interval.intervalCount);
};
...
export const getFormattedPlanPriceFromInvoice = function getFormattedPlanPriceFromInvoice(findInvoiceItemByPlanId, arg1, id) {
  ...
  const obj2 = require(5749) /* formatSingleCurrencyPrice */;
  return obj2.formatRate(require(5749) /* formatSingleCurrencyPrice */.formatPrice(amount, findInvoiceItemByPlanId.currency), id.interval, id.intervalCount);
};
