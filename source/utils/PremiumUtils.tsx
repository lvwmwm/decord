...
// Dependencies: [32, 19, 3948, 1903, 3949, 3950, 3952, 3953, 676, 1905, 3961, 505, 3, 3962, 3959, 1926, 38, 1236, 2866, 3883, 3971, 3992, 5795, 3960, 12661, 687, 589, 10353, 4197, 13257, 6955, 1919, 1921, 8639, 2]
...
function getBillingInformationString(status, subscriptionPeriodStart, first1, flag, fractionalPremiumInfo) {
  ...
  const formatPrice = require(5795) /* formatSingleCurrencyPrice */.formatPrice;
  if (flag) {
...
function getUnactivatedFractionalPremiumDurationString(unactivatedUnits) {
  ...
  if (reduced > 0) {
    if (unactivatedUnits.fractionalState === constants6.NONE) {
      ...
      const obj2 = require(12661) /* roundFPCountdownUnits */;
...
function getFormattedPriceForPlan(id, arg1, arg2, flag) {
  ...
  const formatPriceResult = require(5795) /* formatSingleCurrencyPrice */.formatPrice(tmp5.amount, tmp5.currency);
...
function getItemsWithUpsertedPlanIdForGroup(renewalMutations, basePlanId, arg2, closure_31) {
  ...
  if (closure_31.has(basePlanId)) {
    ...
    obj[1] = closure_31;
    obj[1] = obj;
    const checkoutError = new _require(10353).CheckoutError(obj);
    throw checkoutError;
  }
}
...
function formatPriceString(amount) {
  ...
  return "" + require(5795) /* formatSingleCurrencyPrice */.formatPrice(amount.amount, amount.currency) + "/" + stringResult;
}
...
obj = {
  ...
  canUseAnimatedEmojis(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.ANIMATED_EMOJIS, currentUser);
  },
  canUseEmojisEverywhere(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.EMOJIS_EVERYWHERE, currentUser);
  },
  canUseSoundboardEverywhere(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.SOUNDBOARD_EVERYWHERE, currentUser);
  },
  canUseCustomCallSounds(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.CUSTOM_CALL_SOUNDS, currentUser);
  },
  canUploadLargeFiles(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.UPLOAD_LARGE_FILES, currentUser);
  },
  canUseBadges(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.PROFILE_BADGES, currentUser);
  },
  canUseHighVideoUploadQuality(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.INCREASED_VIDEO_UPLOAD_QUALITY, currentUser);
  },
  canEditDiscriminator(stateFromStores) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.CUSTOM_DISCRIMINATOR, stateFromStores);
  },
  hasBoostDiscount(stateFromStores) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.BOOST_DISCOUNT, stateFromStores);
  },
  canUseAnimatedAvatar(c3) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.ANIMATED_AVATAR, c3);
  },
  canInstallPremiumApplications(isPremiumWithFractionalPremiumOnly) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.INSTALL_PREMIUM_APPLICATIONS, isPremiumWithFractionalPremiumOnly);
  },
  canUseIncreasedMessageLength(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.INCREASED_MESSAGE_LENGTH, currentUser);
  },
  canUseIncreasedGuildCap(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.INCREASED_GUILD_LIMIT, currentUser);
  },
  canRedeemPremiumPerks(isPremiumWithFractionalPremiumOnly) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.REDEEM_PREMIUM_PERKS, isPremiumWithFractionalPremiumOnly);
  },
  canUsePremiumProfileCustomization(isPremiumWithFractionalPremiumOnly) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.PROFILE_PREMIUM_FEATURES, isPremiumWithFractionalPremiumOnly);
  },
  canUsePremiumAppIcons(c0) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.APP_ICONS, c0);
  },
  canUsePremiumGuildMemberProfile(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.PREMIUM_GUILD_MEMBER_PROFILE, currentUser);
  },
  canUseClientThemes(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.CLIENT_THEMES, currentUser);
  },
  canStreamQuality(HIGH, user) {
    if (HIGH === obj.HIGH) {
      let canUserUseResult = require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.STREAM_HIGH_QUALITY, user);
      const obj2 = require(13257) /* ProductCatalogFeature */;
    } else {
      obj = require(13257) /* ProductCatalogFeature */;
      canUserUseResult = obj.canUserUse(require(13257) /* ProductCatalogFeature */.STREAM_MID_QUALITY, user);
    }
    return canUserUseResult;
  },
  canUseQuestOrbMultiplier(perks) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.QUEST_ORB_MULTIPLIER, perks);
  },
  hasFreeBoosts(stateFromStores) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.FREE_BOOSTS, stateFromStores);
  },
  canUseCustomStickersEverywhere(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.STICKERS_EVERYWHERE, currentUser);
  },
  canUseCustomBackgrounds(currentUser) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.VIDEO_FILTER_ASSETS, currentUser);
  },
  canUseCollectibles(user) {
    return require(13257) /* ProductCatalogFeature */.canUserUse(require(13257) /* ProductCatalogFeature */.COLLECTIBLES, user);
  },
  canUseMonthlyOrbs(stateFromStores) {
    let hasPerkResult = require(6955) /* apexExperiment */.getIsCrepeEnabled("canUseMonthlyOrbs");
    if (hasPerkResult) {
      let perks;
  ...
  canUseShopDiscounts(currentUser) {
    let isCrepeEnabled = require(6955) /* apexExperiment */.getIsCrepeEnabled("canUseShopDiscounts");
    if (isCrepeEnabled) {
  ...
  canUseMoreQuestOrbs(perks) {
    let isCrepeEnabled = require(6955) /* apexExperiment */.getIsCrepeEnabled("canUseMoreQuestOrbs");
    if (isCrepeEnabled) {
      let tmpResult = tmp(1919);
      perks = undefined;
      if (perks != null) {
...
export const getPlanDescriptionFromInvoice = function getPlanDescriptionFromInvoice(hasDiscountApplied) {
  ...
  obj[2] = obj3.formatRate(require(5795) /* formatSingleCurrencyPrice */.formatPrice(amount, renewalInvoicePreview.currency), value.interval, value.intervalCount);
...
export const getPremiumGuildHeaderDescription = function getPremiumGuildHeaderDescription(arg0) {
  ...
  let str = "";
  if (null != tmp10) {
    let obj1 = require(5795) /* formatSingleCurrencyPrice */;
...
export const getFormattedRateForPlan = function getFormattedRateForPlan(interval) {
  ...
  return require(5795) /* formatSingleCurrencyPrice */.formatRate(tmp, interval.interval, interval.intervalCount);
};
...
export const getFormattedPlanPriceFromInvoice = function getFormattedPlanPriceFromInvoice(findInvoiceItemByPlanId, arg1, id) {
  ...
  const obj2 = require(5795) /* formatSingleCurrencyPrice */;
  return obj2.formatRate(require(5795) /* formatSingleCurrencyPrice */.formatPrice(amount, findInvoiceItemByPlanId.currency), id.interval, id.intervalCount);
};
...
export const getMaxFileSizeForPremiumType = function getMaxFileSizeForPremiumType(TIER_0, arg1) {
  ...
  return require(4197) /* formatSize */.formatSize(table3[TIER_0].fileSize / 1024, obj);
};
