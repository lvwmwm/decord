...
// Dependencies: [5, 3, 38, 4954, 4963, 4955, 2]
// Exports: cancelGetAttachmentFile, fileIsInAppDir, getAttachmentFile

// Module 4962 (_getAttachmentFile)
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (arg0 === 1) {
              ...
              closure_3 = arg1;
              logger = lib(4955).getAttachmentPayload(lib, callback, closure_3.name);
              c6 = 2;
              const obj10 = lib(4955);
              c7 = 4;
              c8 = 1;
              const obj4 = { value: null, done: false };
              obj4[0] = lib(4963).getFileSize(closure_3.uri);
              return obj4;
            }
          } else {
            if (3 === tmp7) {
