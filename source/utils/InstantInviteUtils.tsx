...
// Function ID: 9008
// Name: isGuildMember
// Dependencies: [1371, 1372, 1971, 4314, 3938, 1903, 5780, 676, 7136, 5158, 9008, 1236, 2]
...
obj = {
  ...
  getMaxAgeOptions(arg0) {
    const _require = arg0;
    const MAX_AGE_OPTIONS = _require(9008).MAX_AGE_OPTIONS;
