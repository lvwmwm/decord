...
// Function ID: 9113
// Name: isGuildMember
// Dependencies: [1390, 1391, 1990, 4356, 3998, 1922, 5879, 676, 7236, 5199, 9113, 1236, 2]
...
obj = {
  ...
  getMaxAgeOptions(arg0) {
    const _require = arg0;
    const MAX_AGE_OPTIONS = _require(9113).MAX_AGE_OPTIONS;
