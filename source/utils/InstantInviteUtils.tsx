...
// Function ID: 8962
// Name: isGuildMember
// Dependencies: [1371, 1372, 1942, 4267, 3892, 1874, 5734, 676, 7090, 5111, 8962, 1236, 2]
...
obj = {
  ...
  getMaxAgeOptions(arg0) {
    const _require = arg0;
    const MAX_AGE_OPTIONS = _require(8962).MAX_AGE_OPTIONS;
