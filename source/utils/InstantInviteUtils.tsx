...
// Function ID: 9117
// Name: isGuildMember
// Dependencies: [1390, 1391, 1990, 4357, 3998, 1922, 5880, 676, 7241, 5200, 9117, 1236, 2]
...
obj = {
  ...
  getMaxAgeOptions(arg0) {
    const _require = arg0;
    const MAX_AGE_OPTIONS = _require(9117).MAX_AGE_OPTIONS;
