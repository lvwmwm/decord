...
// Function ID: 8991
// Name: isGuildMember
// Dependencies: [1371, 1372, 1971, 4297, 3921, 1903, 5761, 676, 7117, 5141, 8991, 1236, 2]
...
obj = {
  ...
  getMaxAgeOptions(arg0) {
    const _require = arg0;
    const MAX_AGE_OPTIONS = _require(8991).MAX_AGE_OPTIONS;
