...
// Dependencies: [653, 3840, 688, 13848, 1212, 1282, 2]
...
// Module 13847 (mapColorToHighlightColor)
import ME from "ME";
...
function mapColorToHighlightColor(arg0) {
  if (obj.unsafe_getRawColor("PRIMARY_400") === arg0) {
    return require(13848) /* HighlightColors */.HighlightColors.ACCENT;
  } else {
    if (obj3.unsafe_getRawColor("GREEN_360") === arg0) {
      return require(13848) /* HighlightColors */.HighlightColors.GREEN;
    } else {
      if (obj4.unsafe_getRawColor("YELLOW_360") === arg0) {
        return require(13848) /* HighlightColors */.HighlightColors.YELLOW;
      } else {
        if (obj5.unsafe_getRawColor("ORANGE_345") === arg0) {
          return require(13848) /* HighlightColors */.HighlightColors.ORANGE;
        } else {
          if (obj2.unsafe_getRawColor("RED_400") === arg0) {
            return require(13848) /* HighlightColors */.HighlightColors.RED;
          } else {
            return require(13848) /* HighlightColors */.HighlightColors.NONE;
          }
