...
// Function ID: 4192
// Name: hexToRgba
// Dependencies: [32, 689, 1236, 3, 4192, 2]
...
export const mixColors = function mixColors(mixColorOverride, red) {
  ...
  return new importDefault(4192)(sum, sum1, sum2, sum3);
};
export { hex2rgb2hsv };
