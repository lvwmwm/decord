...
// Function ID: 8235
// Name: defaultRules
// Dependencies: [4060, 8235, 4783, 4801, 4802, 4334, 2]
// Exports: renderChangelogMessageMarkup

// Module 8234 (defaultRules)
const require = arg1;
function defaultRules(uri) {
  let obj = {};
  const merged = Object.assign(_require(8235).baseRules);
  if (null != _require(8235).customRules.strong) {
    obj = {};
    ...
    obj5[0] = importDefault(4783).order;
...
export default {
  ...
  getSpecialRules(uri) {
    ...
    if (typeof _require(8235).customRules.lheading === "function") {
  ...
  getMessageRules(uri) {
    ...
    obj.newline = obj;
    obj.text = importDefault(4783);
    obj.list = importDefault(4801);
    obj.subtext = importDefault(4802);
