...
// Function ID: 8196
// Name: defaultRules
// Dependencies: [4019, 8196, 4743, 4761, 4762, 4293, 2]
// Exports: renderChangelogMessageMarkup

// Module 8195 (defaultRules)
const require = arg1;
function defaultRules(uri) {
  let obj = {};
  const merged = Object.assign(_require(8196).baseRules);
  if (null != _require(8196).customRules.strong) {
    obj = {};
    ...
    obj5[0] = importDefault(4743).order;
...
export default {
  ...
  getSpecialRules(uri) {
    ...
    if (typeof _require(8196).customRules.lheading === "function") {
  ...
  getMessageRules(uri) {
    ...
    const merged = Object.assign(defaultRules(uri));
    obj = {};
    const merged1 = Object.assign(importDefault(4019).defaultRules.newline);
    obj.newline = obj;
