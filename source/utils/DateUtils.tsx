...
// Function ID: 3955
// Name: resetCache
// Dependencies: [1975, 3, 3955, 3957, 1306, 3971, 1236, 709, 3973, 3866, 2]
...
function syncHourCycleToIntlConfig() {
  ...
  if (result) {
    result = tmp4(3971).supportsSystemDateFormatter();
    const tmp4Result = tmp4(3971);
  }
...
export const calendarFormat = function calendarFormat(timestamp, arg1, setting) {
  ...
  const localeDataResult = importDefault(3866).localeData();
...
export const dateStringToMoment = function dateStringToMoment(arg0) {
  if (arg0.length >= 200) {
    ...
    return importDefault(3866)(arg0);
  }
};
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, tmp(3866)(timestamp), tmp(3866)(date));
    const tmp6 = tmp(3866)(timestamp);
  }
...
export const formatDateForDatetimeLocal = function formatDateForDatetimeLocal(arg0) {
  ...
  if (null != arg0) {
    if (arg0.length >= 200) {
      ...
      str = importDefault(3866)(arg0).format("YYYY-MM-DDTHH:mm");
