...
// Function ID: 3860
// Name: resetCache
// Dependencies: [1946, 3, 3860, 3862, 1306, 3876, 1236, 709, 3878, 3771, 2]
...
function syncHourCycleToIntlConfig() {
  ...
  let result = setting !== require(1306) /* create */.TimestampHourCycle.AUTO;
  if (result) {
    result = tmp4(3876).supportsSystemDateFormatter();
    const tmp4Result = tmp4(3876);
  }
  ...
  while (iter !== undefined) {
    ...
    if (tmp14) {
      if (result) {
        ...
        if (setting === require(1306) /* create */.TimestampHourCycle.H12) {
      ...
      if (result) {
        ...
        if (setting === require(1306) /* create */.TimestampHourCycle.H23) {
...
export const calendarFormat = function calendarFormat(timestamp, arg1, setting) {
  ...
  const localeDataResult = importDefault(3771).localeData();
...
export const dateStringToMoment = function dateStringToMoment(arg0) {
  if (arg0.length >= 200) {
    ...
    return importDefault(3771)(arg0);
  }
};
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, tmp(3771)(timestamp), tmp(3771)(date));
    const tmp6 = tmp(3771)(timestamp);
  }
...
export const formatDateForDatetimeLocal = function formatDateForDatetimeLocal(arg0) {
  ...
  if (null != arg0) {
    if (arg0.length >= 200) {
      ...
      str = importDefault(3771)(arg0).format("YYYY-MM-DDTHH:mm");
