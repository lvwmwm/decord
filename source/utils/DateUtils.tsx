...
// Function ID: 31212
// Name: resetCache
// Dependencies: [1922, 3, 3836, 3838, 1282, 3852, 1212, 686, 3854, 3747, 2]
...
function syncHourCycleToIntlConfig() {
  ...
  if (result) {
    result = require(3852) /* __DiscordCreateDateFormatter */.supportsSystemDateFormatter();
    const obj = require(3852) /* __DiscordCreateDateFormatter */;
  }
...
function dateFormat(date, LL, setting) {
  ...
  if (null == tmp6) {
    const tmp10 = importDefault(3854)(LL);
...
function dateStringToMoment(arg0) {
  if (arg0.length >= 200) {
    ...
    return importDefault(3747)(arg0);
  }
}
function toMoment(timestamp) {
  let tmp = timestamp;
  if (!obj.isMoment(timestamp)) {
    tmp = importDefault(3747)(timestamp);
  }
  return tmp;
}
...
export const calendarFormat = function calendarFormat(timestamp, arg1, setting) {
  ...
  const localeDataResult = importDefault(3747).localeData();
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, importDefault(3747)(timestamp), importDefault(3747)(date));
    const tmp6 = importDefault(3747)(timestamp);
  }
