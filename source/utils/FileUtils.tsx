...
// Dependencies: [1891, 1903, 676, 1905, 12, 4838, 4212, 3930, 4180, 1236, 2]
...
// Module 4837 (getUploadFileSizeSum)
...
export const sizeString = function sizeString(createGuildRecordFromRust) {
  return importDefault(4838).filesize(createGuildRecordFromRust);
};
export const maxFileSize = function maxFileSize(guildId) {
  const currentUser = authStore.getCurrentUser();
  const userMaxFileSize = enabled(3930).getUserMaxFileSize(currentUser);
  if (null == guildId) {
