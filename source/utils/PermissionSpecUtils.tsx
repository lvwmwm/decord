...
// Dependencies: [1395, 1910, 676, 7783, 15921, 5871, 4753, 15922, 1236, 1993, 5889, 5135, 15923, 5888, 15924, 9027, 7227, 2]

// Module 15920 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15921) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(15922) /* experiment */;
