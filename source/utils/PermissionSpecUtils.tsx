...
// Dependencies: [1376, 1862, 676, 7676, 15756, 5765, 4704, 15757, 1236, 1945, 5783, 5087, 15758, 5782, 15759, 8915, 7120, 2]

// Module 15755 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15756) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(15757) /* experiment */;
...
export default {
  ...
  generateGuildPermissionSpec(features) {
    ...
    if (enabled) {
      ...
      obj[0] = features.id;
      enabled = importDefault(5782).getCurrentConfig(obj).enabled;
      const obj2 = importDefault(5782);
    }
    if (!enabled) {
      set.add(constants4.MANAGE_OFFICIAL_MESSAGES.toString());
