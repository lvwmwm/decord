...
// Dependencies: [1395, 1910, 676, 7826, 15979, 5912, 4794, 15980, 1236, 1993, 5930, 5176, 15981, 5929, 15982, 9070, 7271, 2]

// Module 15978 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15979) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(15980) /* experiment */;
