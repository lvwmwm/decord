...
// Dependencies: [1376, 1891, 676, 7704, 15796, 5792, 4734, 15797, 1236, 1974, 5810, 5117, 15798, 5809, 15799, 8944, 7147, 2]

// Module 15795 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15796) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(15797) /* experiment */;
  obj2[0] = importDefault(1974).getArticleURL(constants.SOUNDBOARD);
...
export default {
  ...
  generateGuildPermissionSpec(features) {
    ...
    if (enabled) {
      ...
      obj[0] = features.id;
      enabled = importDefault(5809).getCurrentConfig(obj).enabled;
      const obj2 = importDefault(5809);
    }
    if (!enabled) {
      set.add(constants4.MANAGE_OFFICIAL_MESSAGES.toString());
