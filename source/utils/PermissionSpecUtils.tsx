...
// Dependencies: [1395, 1910, 676, 8064, 16047, 7217, 6821, 16048, 1236, 1993, 7234, 4988, 16049, 7233, 16050, 8874, 7514, 2]
...
function getPermissionOptions(id) {
  let obj = require(16047) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(16048) /* experiment */;
...
export default {
  ...
  generateGuildPermissionSpec(features) {
    ...
    if (enabled) {
      ...
      obj[0] = features.id;
      enabled = importDefault(7233).getCurrentConfig(obj).enabled;
      const obj2 = importDefault(7233);
    }
    if (!enabled) {
      set.add(constants4.MANAGE_OFFICIAL_MESSAGES.toString());
