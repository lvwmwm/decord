...
// Dependencies: [1376, 1891, 676, 7781, 15904, 5871, 4753, 15905, 1236, 1974, 5889, 5135, 15906, 5888, 15907, 9021, 7226, 2]

// Module 15903 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15904) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(15905) /* experiment */;
