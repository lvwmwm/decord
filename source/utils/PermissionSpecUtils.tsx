...
// Dependencies: [1352, 1838, 653, 6661, 15572, 7716, 4583, 15573, 1212, 1921, 5996, 4951, 15574, 5995, 15575, 8242, 6026, 2]

// Module 15571 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15572) /* isGuildEligibleForStageChannels */;
  const result = obj.isGuildEligibleForStageChannels(id);
  const guild = store.getGuild(id);
  let result1 = null != guild;
  if (result1) {
    let obj1 = require(7716) /* isCreatorMonetizationEnabledGuild */;
    result1 = obj1.isCreatorMonetizationEnabledGuild(guild);
  }
  let obj2 = require(4583) /* getSoundmojiRenderingExperiment */;
  ...
  obj2 = {};
  const obj4 = require(15573) /* items */;
  obj2.helpCenterArticle = importDefault(1921).getArticleURL(constants.SOUNDBOARD);
...
export default {
  generateChannelPermissionSpec(guild_id, stateFromStores, arg2) {
    ...
    const VoiceInThreadsExperiment = _require(5996).VoiceInThreadsExperiment;
    ...
    let obj2 = _require(4951);
    let obj3 = _require(15574);
    ...
    if (constants2.GUILD_CATEGORY === type) {
      ...
      const items = [importAll(15575).generateChannelGeneralSection(tmp3, intl21.string(_require(1212).t["AkPxc+"])), , , , , ];
      const obj34 = importAll(15575);
      const intl22 = _require(1212).intl;
      items[1] = importAll(15575).generateChannelMembershipSection(tmp3, intl22.string(_require(1212).t.Ny49TN));
      const obj35 = importAll(15575);
      const intl23 = _require(1212).intl;
      const obj1 = { showPrivateThreads: true, showCreateThreads: true, inSoundmojiExperiment };
      items[2] = importAll(15575).generateChannelTextSection(tmp3, intl23.string(_require(1212).t.cKobO5), obj1);
      const obj36 = importAll(15575);
      const intl24 = _require(1212).intl;
      items[3] = importAll(15575).generateChannelVoiceSection(tmp3, intl24.string(_require(1212).t["46Ra1b"]));
      const obj38 = importAll(15575);
      const intl25 = _require(1212).intl;
      items[4] = importAll(15575).generateChannelAppsSection(tmp3, intl25.string(_require(1212).t["rrh/W6"]));
      ...
      const obj39 = importAll(15575);
      const intl26 = _require(1212).intl;
      items[arraySpreadResult] = importAll(15575).generateChannelEventsSection(tmp3, intl26.string(_require(1212).t.b8lplT));
      const sum = arraySpreadResult + 1;
      let items3 = items;
      const obj40 = importAll(15575);
    } else if (constants2.GUILD_VOICE === type) {
      const intl14 = _require(1212).intl;
      obj2 = { showManageWebhooks: true };
      const items1 = [importAll(15575).generateChannelGeneralSection(tmp3, intl14.string(_require(1212).t.ouHggI), obj2), , , , , ];
      const obj25 = importAll(15575);
      const intl15 = _require(1212).intl;
      items1[1] = importAll(15575).generateChannelMembershipSection(tmp3, intl15.string(_require(1212).t.Ny49TN));
      const obj27 = importAll(15575);
      const intl16 = _require(1212).intl;
      items1[2] = importAll(15575).generateChannelVoiceSection(tmp3, intl16.string(_require(1212).t["46Ra1b"]));
      const obj28 = importAll(15575);
      const intl17 = _require(1212).intl;
      obj3 = {};
      let formatResult;
      const obj29 = importAll(15575);
      if (result) {
      ...
      items1[4] = importAll(15575).generateChannelEventsSection(tmp3, intl19.string(_require(1212).t.b8lplT));
      const obj32 = importAll(15575);
      const intl20 = _require(1212).intl;
      items1[5] = importAll(15575).generateChannelAppsSection(tmp3, intl20.string(_require(1212).t["rrh/W6"]));
      items3 = items1;
      const obj33 = importAll(15575);
    } else if (constants2.GUILD_STAGE_VOICE === type) {
      const intl6 = _require(1212).intl;
      obj5 = { showManageWebhooks: false };
      const items2 = [importAll(15575).generateChannelGeneralSection(tmp3, intl6.string(_require(1212).t.ouHggI), obj5), , , , , , ];
      const obj14 = importAll(15575);
      const intl7 = _require(1212).intl;
      items2[1] = importAll(15575).generateChannelMembershipSection(tmp3, intl7.string(_require(1212).t.Ny49TN));
      const obj16 = importAll(15575);
      const intl8 = _require(1212).intl;
      items2[2] = importAll(15575).generateChannelStageVoiceSection(tmp3, intl8.string(_require(1212).t["46Ra1b"]), isStageVideoEnabledResult);
      const obj17 = importAll(15575);
      const intl9 = _require(1212).intl;
      items2[3] = importAll(15575).generateChannelStageSection(tmp3, intl9.string(_require(1212).t.yniauk));
      const obj18 = importAll(15575);
      const intl10 = _require(1212).intl;
      items2[4] = importAll(15575).generateChannelEventsSection(tmp3, intl10.string(_require(1212).t.b8lplT));
      const obj19 = importAll(15575);
      const intl11 = _require(1212).intl;
      const obj6 = {};
      let formatResult1;
      const obj20 = importAll(15575);
      if (result) {
      ...
      items2[6] = importAll(15575).generateChannelAppsSection(tmp3, intl13.string(_require(1212).t["rrh/W6"]), obj8);
      items3 = items2;
      const obj23 = importAll(15575);
    } else {
      if (constants2.GUILD_FORUM !== type) {
        if (constants2.GUILD_MEDIA !== type) {
          const intl27 = _require(1212).intl;
          items3 = [importAll(15575).generateChannelGeneralSection(tmp3, intl27.string(_require(1212).t.ouHggI)), , , ];
          const obj41 = importAll(15575);
          const intl28 = _require(1212).intl;
          items3[1] = importAll(15575).generateChannelMembershipSection(tmp3, intl28.string(_require(1212).t.Ny49TN));
          const obj42 = importAll(15575);
          ...
          items3[2] = importAll(15575).generateChannelTextSection(tmp3, intl29.string(_require(1212).t.cKobO5), obj9);
          const obj43 = importAll(15575);
          const intl30 = _require(1212).intl;
          items3[3] = importAll(15575).generateChannelAppsSection(tmp3, intl30.string(_require(1212).t["rrh/W6"]));
      ...
      items4[3] = importAll(15575).generateChannelAppsSection(tmp3, intl5.string(_require(1212).t["rrh/W6"]));
      HermesBuiltin.arraySpread(conditionalPermissionSpec(enabled, () => {
        const intl = guild_id(outer1_3[8]).intl;
        return isMediaChannelResult(outer1_3[14]).generateChannelVoiceSection(closure_1, intl.string(guild_id(outer1_3[8]).t["46Ra1b"]));
      }), 4);
      items3 = items4;
      const obj13 = importAll(15575);
  ...
  generateGuildPermissionSpec(features) {
    ...
    if (enabled) {
      ...
      enabled = importDefault(5995).getCurrentConfig(obj).enabled;
      const obj2 = importDefault(5995);
    }
    if (!enabled) {
      set.add(constants4.MANAGE_OFFICIAL_MESSAGES.toString());
      const str3 = constants4.MANAGE_OFFICIAL_MESSAGES;
    }
    return filterPermissions(importAll(15575).generateGuildPermissionSpec(getPermissionOptions(features.id)), set);
  },
  getGuildPermissionSpecMap(id) {
    return importAll(15575).getGuildPermissionSpec(getPermissionOptions(id.id));
  }
};
