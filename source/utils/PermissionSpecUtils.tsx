...
// Dependencies: [1376, 1891, 676, 7781, 15895, 5871, 4753, 15896, 1236, 1974, 5889, 5135, 15897, 5888, 15898, 9021, 7226, 2]

// Module 15894 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15895) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(15896) /* experiment */;
...
export default {
  ...
  generateGuildPermissionSpec(features) {
    ...
    if (enabled) {
      ...
      obj[0] = features.id;
      enabled = importDefault(5888).getCurrentConfig(obj).enabled;
