...
// Dependencies: [1395, 1910, 676, 7822, 15978, 5910, 4793, 15979, 1236, 1993, 5928, 5175, 15980, 5927, 15981, 9066, 7266, 2]

// Module 15977 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15978) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(15979) /* experiment */;
...
export default {
  ...
  generateGuildPermissionSpec(features) {
    ...
    if (enabled) {
      ...
      obj[0] = features.id;
      enabled = importDefault(5927).getCurrentConfig(obj).enabled;
      const obj2 = importDefault(5927);
    }
    if (!enabled) {
      set.add(constants4.MANAGE_OFFICIAL_MESSAGES.toString());
