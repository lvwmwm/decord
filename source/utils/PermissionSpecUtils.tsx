...
// Dependencies: [31, 33, 689, 3831, 15389, 2, 6, 7, 15, 17, 18, 5, 31, 27, 1348, 1907, 1838, 3756]

// Module 15379 (getPermissionOptions)
...
export default {
  generateChannelPermissionSpec(guild_id, stateFromStores, arg2) {
    ...
    if (constants2.GUILD_CATEGORY === type) {
      ...
      const obj1 = { -579216024: null, -580199063: null, inSoundmojiExperiment };
