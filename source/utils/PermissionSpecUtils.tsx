...
// Dependencies: [1376, 1891, 676, 7721, 15820, 5811, 4751, 15821, 1236, 1974, 5829, 5134, 15822, 5828, 15823, 8961, 7166, 2]

// Module 15819 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15820) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(15821) /* experiment */;
...
export default {
  ...
  generateGuildPermissionSpec(features) {
    ...
    if (enabled) {
      ...
      obj[0] = features.id;
      enabled = importDefault(5828).getCurrentConfig(obj).enabled;
      const obj2 = importDefault(5828);
    }
    if (!enabled) {
      set.add(constants4.MANAGE_OFFICIAL_MESSAGES.toString());
