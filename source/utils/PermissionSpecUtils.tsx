...
// Dependencies: [1376, 1862, 676, 6715, 15652, 7772, 4639, 15653, 1236, 1945, 6046, 5007, 15654, 6045, 15655, 8301, 6076, 2]

// Module 15651 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15652) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(15653) /* experiment */;
...
export default {
  generateChannelPermissionSpec(guild_id, stateFromStores, arg2) {
    ...
    const VoiceInThreadsExperiment = set(6046).VoiceInThreadsExperiment;
    ...
    if (constants2.GUILD_CATEGORY === type) {
      ...
      const items = [importAll(15655).generateChannelGeneralSection(tmp3, intl23.string(tmp4(1236).t["AkPxc+"])), , , , , ];
      const obj34 = importAll(15655);
      const intl24 = tmp4(1236).intl;
      items[1] = importAll(15655).generateChannelMembershipSection(tmp3, intl24.string(tmp4(1236).t.Ny49TN));
      const obj35 = importAll(15655);
      ...
      items[2] = importAll(15655).generateChannelTextSection(tmp3, intl25.string(tmp4(1236).t.cKobO5), obj1);
      const obj36 = importAll(15655);
      const intl26 = tmp4(1236).intl;
      items[3] = importAll(15655).generateChannelVoiceSection(tmp3, intl26.string(tmp4(1236).t["46Ra1b"]));
      const obj38 = importAll(15655);
      const intl27 = tmp4(1236).intl;
      items[4] = importAll(15655).generateChannelAppsSection(tmp3, intl27.string(tmp4(1236).t["rrh/W6"]));
      if (tmp.showStageChannelPermissions) {
        const intl28 = tmp4(1236).intl;
        const items1 = [obj33(15655).generateChannelStageSection(tmp3, intl28.string(tmp4(1236).t.yniauk))];
        let items2 = items1;
        const obj33Result = obj33(15655);
      } else {
        items2 = [];
      }
      ...
      const obj39 = importAll(15655);
    } else {
      if (tmp16.GUILD_VOICE === type) {
        const intl16 = tmp4(1236).intl;
        const items3 = [importAll(15655).generateChannelGeneralSection(tmp3, intl16.string(tmp4(1236).t.ouHggI), { showManageWebhooks: true }), , , , , ];
        const obj25 = importAll(15655);
        const intl17 = tmp4(1236).intl;
        items3[1] = importAll(15655).generateChannelMembershipSection(tmp3, intl17.string(tmp4(1236).t.Ny49TN));
        const obj26 = importAll(15655);
        const intl18 = tmp4(1236).intl;
        items3[2] = importAll(15655).generateChannelVoiceSection(tmp3, intl18.string(tmp4(1236).t["46Ra1b"]));
        const obj27 = importAll(15655);
        const intl19 = tmp4(1236).intl;
        let formatResult;
        const obj28 = importAll(15655);
        if (result) {
        ...
        const items4 = [importAll(15655).generateChannelGeneralSection(tmp3, intl8.string(tmp4(1236).t.ouHggI), { showManageWebhooks: false }), , , , , , ];
        const obj16 = importAll(15655);
        const tmp27 = importAll;
        const intl9 = tmp4(1236).intl;
        items4[1] = importAll(15655).generateChannelMembershipSection(tmp3, intl9.string(tmp4(1236).t.Ny49TN));
        const obj17 = importAll(15655);
        const intl10 = tmp4(1236).intl;
        items4[2] = importAll(15655).generateChannelStageVoiceSection(tmp3, intl10.string(tmp4(1236).t["46Ra1b"]), isStageVideoEnabledResult);
        const obj18 = importAll(15655);
        const intl11 = tmp4(1236).intl;
        items4[3] = importAll(15655).generateChannelStageSection(tmp3, intl11.string(tmp4(1236).t.yniauk));
        const obj19 = importAll(15655);
        const intl12 = tmp4(1236).intl;
        items4[4] = importAll(15655).generateChannelEventsSection(tmp3, intl12.string(tmp4(1236).t.b8lplT));
        const obj20 = importAll(15655);
        const intl13 = tmp4(1236).intl;
        let formatResult1;
        const obj21 = importAll(15655);
        if (result) {
        ...
        items4[6] = tmp27(15655).generateChannelAppsSection(tmp3, intl15.string(tmp4(1236).t["rrh/W6"]), { showActivities: false });
        items5 = items4;
        const tmp27Result = tmp27(15655);
      } else {
        if (tmp16.GUILD_FORUM !== type) {
          if (tmp16.GUILD_MEDIA !== type) {
            const intl30 = tmp4(1236).intl;
            items5 = [importAll(15655).generateChannelGeneralSection(tmp3, intl30.string(tmp4(1236).t.ouHggI)), , , ];
            const obj41 = importAll(15655);
            const tmp38 = importAll;
            const intl31 = tmp4(1236).intl;
            items5[1] = importAll(15655).generateChannelMembershipSection(tmp3, intl31.string(tmp4(1236).t.Ny49TN));
            const obj42 = importAll(15655);
            ...
            items5[2] = importAll(15655).generateChannelTextSection(tmp3, intl32.string(tmp4(1236).t.cKobO5), obj6);
            const obj43 = importAll(15655);
            const intl33 = tmp4(1236).intl;
            items5[3] = importAll(15655).generateChannelAppsSection(tmp3, intl33.string(tmp4(1236).t["rrh/W6"]));
            if (enabled) {
              const intl = tmp4(1236).intl;
              const items6 = [tmp38(15655).generateChannelVoiceSection(tmp3, intl.string(tmp4(1236).t["46Ra1b"]))];
              let items7 = items6;
              const tmp38Result = tmp38(15655);
            } else {
              items7 = [];
            }
            arraySpreadResult = HermesBuiltin.arraySpread(items7, 4);
            const obj45 = importAll(15655);
          }
        }
        ...
        let obj8 = importAll(15655);
        const intl3 = tmp4(1236).intl;
        const items8 = [obj8.generateChannelGeneralSection(tmp3, intl3.string(tmp4(1236).t.ouHggI)), , , ];
        const intl4 = tmp4(1236).intl;
        items8[1] = importAll(15655).generateChannelMembershipSection(tmp3, intl4.string(tmp4(1236).t.Ny49TN));
        const obj10 = importAll(15655);
        ...
        items8[2] = importAll(15655).generateChannelTextSection(tmp3, stringResult2, obj8);
        let tmp22Result = tmp22(15655);
        const intl6 = tmp4(1236).intl;
        items8[3] = tmp22Result.generateChannelAppsSection(tmp3, intl6.string(tmp4(1236).t["rrh/W6"]));
        if (enabled) {
          tmp22Result = tmp22(15655);
  ...
  generateGuildPermissionSpec(features) {
    ...
    if (enabled) {
      ...
      obj[0] = features.id;
      enabled = importDefault(6045).getCurrentConfig(obj).enabled;
      const obj2 = importDefault(6045);
    }
    if (!enabled) {
      set.add(constants4.MANAGE_OFFICIAL_MESSAGES.toString());
      const str2 = constants4.MANAGE_OFFICIAL_MESSAGES;
    }
    const guildPermissionSpec = importAll(15655).generateGuildPermissionSpec(getPermissionOptions(features.id));
  ...
  getGuildPermissionSpecMap(id) {
    return importAll(15655).getGuildPermissionSpec(getPermissionOptions(id.id));
  }
};
