...
// Dependencies: [1395, 1910, 676, 7847, 15997, 5933, 4816, 15998, 1236, 1993, 5951, 5197, 15999, 5950, 16000, 9084, 7293, 2]

// Module 15996 (getPermissionOptions)
...
function getPermissionOptions(id) {
  let obj = require(15997) /* isGuildEligibleForStageChannels */;
  ...
  const tmpResult1 = require(15998) /* experiment */;
...
export default {
  ...
  generateGuildPermissionSpec(features) {
    ...
    if (enabled) {
      ...
      obj[0] = features.id;
      enabled = importDefault(5950).getCurrentConfig(obj).enabled;
      const obj2 = importDefault(5950);
    }
    if (!enabled) {
      set.add(constants4.MANAGE_OFFICIAL_MESSAGES.toString());
