...
function formatSingleCurrencyPrice(result, BGN, localeOverride) {
  ...
  return require(5796) /* CurrencyCodes */.formatPrice(result, BGN, localeOverride, obj);
}
