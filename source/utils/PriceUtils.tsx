...
function formatSingleCurrencyPrice(result, BGN, localeOverride) {
  ...
  return require(5918) /* CurrencyCodes */.formatPrice(result, BGN, localeOverride, obj);
}
