...
function formatSingleCurrencyPrice(result, BGN, localeOverride) {
  ...
  return require(5897) /* CurrencyCodes */.formatPrice(result, BGN, localeOverride, obj);
}
