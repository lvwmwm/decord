...
// Dependencies: [5257, 1372, 4519, 4497, 676, 3941, 4498, 685, 1384, 4496, 698, 2]
...
// Module 5256 (UserNotificationSettings)
...
export const trackGuildNotificationSettingsUpdate = function trackGuildNotificationSettingsUpdate(guild_id, muteSettings, currentGuildSettings, label, location) {
  ...
  importDefault(4496).trackWithMetadata(constants.NOTIFICATION_SETTINGS_UPDATED, obj);
};
