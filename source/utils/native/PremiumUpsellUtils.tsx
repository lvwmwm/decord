...
// Dependencies: [19, 1922, 676, 1924, 21, 8407, 1236, 8408, 8409, 8410, 8411, 8412, 8413, 4683, 8734, 2007, 4007, 6952, 8668, 4207, 698, 4312, 8667, 2]
// Exports: getUpsellItems, usePremiumUpsellConfig

// Module 8406 (usePremiumUpsellConfig)
...
export const getUpsellItems = function getUpsellItems() {
  let obj = { key: constants.GLOBAL_EMOJI, image: importDefault(8407), activeTitle: null, passiveTitle: null, description: null };
  ...
  const items = [obj, , , , , ];
  obj = { key: constants.ANIMATED_EMOJI, image: importDefault(8408), activeTitle: null, passiveTitle: null, description: null };
  ...
  items[1] = obj;
  obj = { key: constants.ANIMATED_AVATAR, image: importDefault(8409), activeTitle: null, passiveTitle: null, description: null };
  ...
  items[2] = obj;
  const obj1 = { key: constants.UPLOAD, image: importDefault(8410), activeTitle: null, passiveTitle: null, description: null };
  ...
  items[3] = obj1;
  const obj3 = { key: constants.BADGE, image: importDefault(8411), activeTitle: null, passiveTitle: null, description: null };
  ...
  items[4] = obj3;
  const obj4 = { key: constants.APP_ICONS, image: importDefault(8412), activeTitle: null, passiveTitle: null, description: null };
