...
export const shouldRenderInvite = function shouldRenderInvite(channels, guild) {
  ...
  if (!tmp2) {
    tmp2 = !require(8203) /* canViewInviteModal */.canViewInviteModal(closure_6, guild);
    const obj = require(8203) /* canViewInviteModal */;
  }
  let tmp6 = !tmp2;
  if (tmp2) {
...
export const useShouldShowInviteInActionBar = function useShouldShowInviteInActionBar(id) {
  ...
  if (!tmp3) {
    tmp3 = !_require(8203).canViewInviteModal(closure_6, id);
    const obj2 = _require(8203);
  }
  let tmp7 = !tmp3;
  if (tmp3) {
