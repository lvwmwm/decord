...
export const dismissKeyboard = function dismissKeyboard() {
  let obj = require(1891) /* dismissGlobalKeyboard */;
  ...
  const result1 = require(4210) /* zustandStore */.closePortalKeyboardRequest();
};
