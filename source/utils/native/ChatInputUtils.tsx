...
export const dismissKeyboard = function dismissKeyboard() {
  ...
  const result1 = require(4032) /* closePortalKeyboard */.closePortalKeyboardRequest();
};
