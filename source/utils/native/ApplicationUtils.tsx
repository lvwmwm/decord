...
// Dependencies: [676, 10557, 698, 8855, 3981, 10558, 506, 4490, 10561, 1988, 8825, 2]
// Exports: installApplication, installPrivateChannelIntegration, openOAuth2Modal

// Module 10556 (installApplication)
...
export const openOAuth2Modal = function openOAuth2Modal(arg0) {
  ...
  obj2.pushLazy(_require(1988)(10561, dependencyMap.paths), obj, closure_5);
};
export const installPrivateChannelIntegration = function installPrivateChannelIntegration(arg0) {
  ...
  const items = [require(8825) /* set */.OAuth2Scopes.APPLICATIONS_COMMANDS];
  obj[1] = items;
  obj[2] = channelId;
  ...
  obj[5] = callback;
  obj.pushLazy(require(1988) /* asyncRequireImpl */(10561, dependencyMap.paths), obj, closure_5);
};
