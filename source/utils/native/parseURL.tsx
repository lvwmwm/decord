...
// Function ID: 4171
// Name: parseQuery
// Dependencies: [32, 676, 678, 4171, 4172, 1464, 3888, 1469, 4173, 4178, 12279, 4424, 12981, 1467, 4381, 8945, 6551, 1577, 500, 8897, 698, 513, 12982, 2]
// Exports: default
          ...
          if (null != tryParseChannelPathResult) {
            ...
            if (null != pathname.match(closure_27)) {
              ...
              if (null != pathname.match(closure_16)) {
                ...
                const result1 = tmp5(8945).parseOAuth2AuthorizeProps(str5);
                if (null != result1) {
                  ...
                  if (null != match6) {
                    ...
                    if (null != uRL) {
                      ...
                      if (null != uRL) {
                        ...
                        obj59[1] = tmp41[1];
                        obj59[2] = uRL(12982)(closure_5, tmp41[2]);
                        obj59[3] = uRL(12982)(closure_6, tmp41[3]);
                        obj58[3] = obj59;
                        return obj58;
                      } else {
                        uRL = closure_23;
                        ...
                        if (null != uRL) {
                          ...
                          obj61[1] = uRL(12982)(closure_5, tmp36[1]);
                          obj61[2] = uRL(12982)(closure_6, tmp36[2]);
