...
// Function ID: 4459
// Name: parseQuery
// Dependencies: [32, 673, 675, 4459, 4460, 1482, 4192, 1487, 4461, 4466, 13042, 4753, 13826, 1485, 4675, 9304, 7159, 1623, 1234, 9875, 695, 510, 13827, 2]
// Exports: default
...
import urlPartToSettingsEnumDefault from "urlPartToSettingsEnum" /* 13827 */;
          ...
          if (null != tryParseChannelPathResult) {
            ...
            if (null != pathname.match(closure_27)) {
              ...
              if (null != pathname.match(closure_16)) {
                ...
                const result1 = tmp5(9304).parseOAuth2AuthorizeProps(str5);
                if (null != result1) {
