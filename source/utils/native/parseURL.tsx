...
// Function ID: 4237
// Name: parseQuery
// Dependencies: [32, 676, 678, 4237, 4238, 1464, 3954, 1469, 4239, 4244, 12403, 4490, 13069, 1467, 4447, 9135, 6765, 1577, 500, 9087, 698, 513, 13070, 2]
// Exports: default
...
export default function parseURL(arg0) {
  ...
  if (null == sanitizeUrlResult) {
    ...
    const findGiftCodesResult = require(4490) /* _resolveGiftCode */.findGiftCodes(sanitizeUrlResult);
    if (findGiftCodesResult.length > 0) {
      ...
      if (null != pathname) {
        const tryParseDiceRollLinkResult = tmp5(4447).tryParseDiceRollLink(pathname);
        if (null != tryParseDiceRollLinkResult) {
          ...
          const tryParseChannelPathResult = tmp5(4447).tryParseChannelPath(pathname);
          if (null != tryParseChannelPathResult) {
            ...
            if (null != pathname.match(closure_27)) {
              ...
              if (null != pathname.match(closure_16)) {
                ...
                const result1 = tmp5(9135).parseOAuth2AuthorizeProps(str5);
                if (null != result1) {
              ...
              if (null != pathname.match(closure_17)) {
                ...
                const result2 = tmp5(4447).tryParseEventDetailsPath(pathname);
                if (null != result2) {
                  ...
                  if (null != match6) {
                    ...
                    if (null != uRL) {
                      ...
                      if (null != uRL) {
                        ...
                        obj59[1] = tmp41[1];
                        obj59[2] = uRL(13070)(closure_5, tmp41[2]);
                        obj59[3] = uRL(13070)(closure_6, tmp41[3]);
                        obj58[3] = obj59;
                        return obj58;
                      } else {
                        uRL = closure_23;
                        ...
                        if (null != uRL) {
                          ...
                          obj61[1] = uRL(13070)(closure_5, tmp36[1]);
                          obj61[2] = uRL(13070)(closure_6, tmp36[2]);
                ...
                const tmp5Result4 = tmp5(4447);
              }
            }
          }
          const tmp5Result2 = tmp5(4447);
        }
        const tmp5Result1 = tmp5(4447);
      }
      uRLResult1 = uRL(1467);
    }
