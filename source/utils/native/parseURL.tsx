...
// Function ID: 4175
// Name: parseQuery
// Dependencies: [32, 676, 678, 4175, 4176, 1464, 3892, 1469, 4177, 4182, 12305, 4428, 13006, 1467, 4385, 8958, 6557, 1577, 500, 8910, 698, 513, 13007, 2]
// Exports: default
  ...
  if (null == sanitizeUrlResult) {
    ...
    if (null != findCodedLinkResult) {
      ...
      if (tmp5(4182).CodedLinkType.INVITE === type) {
        ...
        obj1[3] = obj2;
        return obj1;
      } else if (tmp5(4182).CodedLinkType.TEMPLATE === type) {
        ...
        if (tmp5(4182).CodedLinkType.BUILD_OVERRIDE !== type) {
          if (tmp5(4182).CodedLinkType.MANUAL_BUILD_OVERRIDE !== type) {
            if (tmp5(4182).CodedLinkType.EXPERIMENT !== type) {
              if (tmp5(4182).CodedLinkType.EVENT !== type) {
                if (tmp5(4182).CodedLinkType.CHANNEL_LINK !== type) {
                  if (tmp5(4182).CodedLinkType.APP_DIRECTORY_PROFILE !== type) {
                    if (tmp5(4182).CodedLinkType.ACTIVITY_BOOKMARK === type) {
                      ...
                      obj5[3] = obj6;
                      return obj5;
                    } else if (tmp5(4182).CodedLinkType.EMBEDDED_ACTIVITY_INVITE !== type) {
                      if (tmp5(4182).CodedLinkType.GUILD_PRODUCT !== type) {
                        if (tmp5(4182).CodedLinkType.SERVER_SHOP !== type) {
                          if (tmp5(4182).CodedLinkType.SOCIAL_LAYER_STOREFRONT !== type) {
                            if (tmp5(4182).CodedLinkType.SOCIAL_LAYER_STOREFRONT_APP !== type) {
                              if (tmp5(4182).CodedLinkType.QUESTS_EMBED !== type) {
                                if (tmp5(4182).CodedLinkType.GAME_PROFILE === type) {
                                  ...
                                  obj7[3] = obj8;
                                  return obj7;
                                } else if (tmp5(4182).CodedLinkType.APP_DIRECTORY_STOREFRONT !== type) {
                                  if (tmp5(4182).CodedLinkType.APP_DIRECTORY_STOREFRONT_SKU !== type) {
                                    if (tmp5(4182).CodedLinkType.APP_OAUTH2_LINK !== type) {
                                      if (tmp5(4182).CodedLinkType.COLLECTIBLES_SHOP === type) {
                                      ...
                                      } else if (tmp5(4182).CodedLinkType.GAME_SERVER_SHARE !== type) {
                                        const _Error2 = Error;
    ...
    const findGiftCodesResult = require(4428) /* _resolveGiftCode */.findGiftCodes(sanitizeUrlResult);
    if (findGiftCodesResult.length > 0) {
      ...
      if (null != pathname) {
        const tryParseDiceRollLinkResult = tmp5(4385).tryParseDiceRollLink(pathname);
        if (null != tryParseDiceRollLinkResult) {
          ...
          const tryParseChannelPathResult = tmp5(4385).tryParseChannelPath(pathname);
          if (null != tryParseChannelPathResult) {
            ...
            if (null != pathname.match(closure_27)) {
              ...
              if (null != pathname.match(closure_16)) {
                ...
                const result1 = tmp5(8958).parseOAuth2AuthorizeProps(str5);
                if (null != result1) {
              ...
              if (null != pathname.match(closure_17)) {
                ...
                const result2 = tmp5(4385).tryParseEventDetailsPath(pathname);
                if (null != result2) {
                  ...
                  if (null != match6) {
                    ...
                    if (null != uRL) {
                      ...
                      if (null != uRL) {
                        ...
                        obj57[1] = tmp41[1];
                        obj57[2] = uRL(13007)(closure_5, tmp41[2]);
                        obj57[3] = uRL(13007)(closure_6, tmp41[3]);
                        obj56[3] = obj57;
                        return obj56;
                      } else {
                        uRL = closure_23;
                        ...
                        if (null != uRL) {
                          ...
                          obj59[1] = uRL(13007)(closure_5, tmp36[1]);
                          obj59[2] = uRL(13007)(closure_6, tmp36[2]);
                ...
                const tmp5Result4 = tmp5(4385);
              }
            }
          }
          const tmp5Result2 = tmp5(4385);
        }
        const tmp5Result1 = tmp5(4385);
      }
      uRLResult1 = uRL(1467);
    }
