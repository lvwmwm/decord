...
// Function ID: 4462
// Name: parseQuery
// Dependencies: [32, 673, 675, 4462, 4463, 1482, 4192, 1487, 4464, 4469, 12877, 4760, 13858, 1485, 4682, 9166, 7339, 1623, 1234, 9089, 695, 510, 13859, 2]
// Exports: default

// Module 4461 (parseQuery)
...
import urlPartToSettingsEnumDefault from "urlPartToSettingsEnum" /* 13859 */;
import closure_3 from "_slicedToArray" /* 32 */;
import ME from "ME" /* 673 */;
import items from "items" /* 675 */;
import { UPDATE_CONFIG } from "UPDATE_CHECK_INTERVAL" /* 4462 */;
import CustomCheckoutFlow from "CustomCheckoutFlow" /* 4463 */;
...
export default function parseURL(arg0) {
  ...
  if (null == sanitizeUrlResult) {
    ...
    ({ username, didRegister, custom_id, link_id } = tmp86Result);
    ...
    if (null != findCodedLinkResult) {
      ...
      if (tmp5(4469).CodedLinkType.INVITE === type) {
        ...
        obj1[4] = obj2;
        return obj1;
      } else if (tmp5(4469).CodedLinkType.TEMPLATE === type) {
        ...
        if (tmp5(4469).CodedLinkType.BUILD_OVERRIDE !== type) {
          if (tmp5(4469).CodedLinkType.MANUAL_BUILD_OVERRIDE !== type) {
            if (tmp5(4469).CodedLinkType.EXPERIMENT !== type) {
              if (tmp5(4469).CodedLinkType.EVENT !== type) {
                if (tmp5(4469).CodedLinkType.CHANNEL_LINK !== type) {
                  if (tmp5(4469).CodedLinkType.APP_DIRECTORY_PROFILE !== type) {
                    if (tmp5(4469).CodedLinkType.ACTIVITY_BOOKMARK === type) {
                      ...
                      obj5[3] = obj6;
                      return obj5;
                    } else if (tmp5(4469).CodedLinkType.EMBEDDED_ACTIVITY_INVITE !== type) {
                      if (tmp5(4469).CodedLinkType.GUILD_PRODUCT !== type) {
                        if (tmp5(4469).CodedLinkType.SERVER_SHOP !== type) {
                          if (tmp5(4469).CodedLinkType.SOCIAL_LAYER_STOREFRONT !== type) {
                            if (tmp5(4469).CodedLinkType.SOCIAL_LAYER_STOREFRONT_APP !== type) {
                              if (tmp5(4469).CodedLinkType.QUESTS_EMBED !== type) {
                                if (tmp5(4469).CodedLinkType.GAME_PROFILE === type) {
                                  ...
                                  obj7[3] = obj8;
                                  return obj7;
                                } else if (tmp5(4469).CodedLinkType.APP_DIRECTORY_STOREFRONT !== type) {
                                  if (tmp5(4469).CodedLinkType.APP_DIRECTORY_STOREFRONT_SKU !== type) {
                                    if (tmp5(4469).CodedLinkType.APP_OAUTH2_LINK !== type) {
                                      if (tmp5(4469).CodedLinkType.COLLECTIBLES_SHOP === type) {
                                        let tmp5Result = tmp5(12877);
                                      ...
                                      } else if (tmp5(4469).CodedLinkType.GAME_SERVER_SHARE !== type) {
                                        if (tmp5(4469).CodedLinkType.USER_PROFILE !== type) {
                                          const _Error2 = Error;
    ...
    if (findGiftCodesResult.length > 0) {
      ...
      if (null != pathname) {
        const tryParseDiceRollLinkResult = tmp5(4682).tryParseDiceRollLink(pathname);
        if (null != tryParseDiceRollLinkResult) {
          ...
          ({ guildId: obj63[1], channelId: obj63[2], diceCount: obj63[3], diceSides: obj63[4] } = tryParseDiceRollLinkResult);
          obj23[3] = obj24;
          return obj23;
        } else {
          const tryParseChannelPathResult = tmp5(4682).tryParseChannelPath(pathname);
          if (null != tryParseChannelPathResult) {
            ...
            obj26[0] = CHANNEL;
            ({ guildId: obj61[1], channelId: obj61[2], messageId: obj61[3] } = tryParseChannelPathResult);
            ...
            if (null != pathname.match(closure_27)) {
              ...
              if (null != pathname.match(closure_16)) {
                ...
                const result1 = tmp5(9166).parseOAuth2AuthorizeProps(str5);
                if (null != result1) {
              ...
              if (null != pathname.match(closure_17)) {
                ...
                if (null != match5) {
                  let num7 = 1;
                  const tmp34Result = tmp34(uRL, num7);
                  let str7 = query;
                  if (query == null) {
                    str7 = "";
                  }
                  ...
                  const obj48 = { type: null, settingsSection: null, settingsSubsection: null, feature: null };
                  obj48[0] = closure_7.GUILD_SETTINGS_PICKER;
                  obj48[1] = urlPartToSettingsEnumDefault(closure_5, tmp34Result[1]);
                  obj48[2] = urlPartToSettingsEnumDefault(closure_6, tmp34Result[2]);
                  obj48[3] = tmp86(str7).feature;
                  obj47[3] = obj48;
                  return obj47;
                }
                const result2 = tmp5(4682).tryParseEventDetailsPath(pathname);
                if (null != result2) {
                  ...
                  tmp86Result = tmp86(decodeURIComponent(query));
                  ...
                  obj53[1] = tmp5(510).maybeExtractId(fingerprint2);
                  const obj54 = { fingerprint: null };
                  obj54[0] = fingerprint2;
                  uRLResult5.track(constants.MOBILE_WEB_HANDOFF_FAILURE, obj53, obj54);
                  const _Error = Error;
                  ...
                  if (null != match6) {
                    ...
                    obj56[1] = match6[1];
                    ({ code: obj31[2], state: obj31[3] } = tmp86(decodeURIComponent(str9)));
                    obj55[3] = obj56;
                    return obj55;
                  } else {
                    const match7 = pathname.match(closure_21);
                    if (null != match7) {
                      const tmp45 = callback(match7, 2);
                      const first = tmp45[0];
                      let str8 = query;
                      if (query == null) {
                        str8 = "";
                      ...
                      obj58[1] = tmp45[1];
                      obj58[2] = tmp86(decodeURIComponent(str8));
                      obj57[3] = obj58;
                      return obj57;
                    } else {
                      uRL = closure_22;
                      ...
                      if (null != uRL) {
                        ...
                        obj60[1] = tmp40[1];
                        obj60[2] = urlPartToSettingsEnumDefault(closure_5, tmp40[2]);
                        obj60[3] = urlPartToSettingsEnumDefault(closure_6, tmp40[3]);
                        obj59[3] = obj60;
                        return obj59;
                      } else {
                        uRL = closure_23;
                        ...
                        if (null != uRL) {
                          ...
                          if (null != pathname.match(closure_24)) {
                            ...
                            const obj62 = { type: null, userCode: null };
                            obj62[0] = closure_7.ACTIVATE_DEVICE;
                            obj62[1] = tmp86(decodeURIComponent(str6)).user_code;
                            obj61[3] = obj62;
                            return obj61;
                          }
                        }
                ...
                const tmp5Result4 = tmp5(4682);
              }
            }
          }
          const tmp5Result2 = tmp5(4682);
        }
        const tmp5Result1 = tmp5(4682);
      }
