...
if (!isJest.isJest()) {
  require = () => {
    const reanimatedError = new require(1645) /* t */.ReanimatedError("`setUpTests` is available only in Jest environment.");
