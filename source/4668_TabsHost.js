...
// Function ID: 4669
// Name: TabsHost
// Dependencies: [32, 109, 19, 17, 21, 4669, 4644, 4670, 4671, 4673]
// Exports: default

// Module 4668 (TabsHost)
...
export default function TabsHost(onNativeFocusChange) {
  ...
  let obj = onNativeFocusChange(4669);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4644).experiment.controlledBottomTabs;
  }
