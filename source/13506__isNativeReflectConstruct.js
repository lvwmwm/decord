...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 13507, 4173, 8925]

// Module 13506 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    value: function render() {
      ...
      const items4 = [PaginationDot(13507).sliderPaginationDotContainer, ];
      if (!containerStyle) {
        containerStyle = {};
      }
      items4[1] = containerStyle;
      const items5 = [PaginationDot(13507).sliderPaginationDot, , , , ];
      if (!style) {
        style = {};
      }
      items5[1] = style;
