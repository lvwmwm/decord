...
// Dependencies: [5411, 5414, 5412]

// Module 5413 (setGestureState)
...
function create(handlerTag) {
  ...
  obj = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5412).State, warningMessage: closure_2 };
  T.__closure = obj;
  ...
  fn.__closure = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5412).State, warningMessage: closure_2 };
  ...
  const obj1 = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5412).State, warningMessage: closure_2 };
  fn2.__closure = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5412).State, warningMessage: closure_2 };
  fn2.__workletHash = 2856860112444;
  fn2.__initData = closure_8;
  obj[4] = fn2;
  return obj;
}
obj = { REANIMATED_AVAILABLE: tmp4, setGestureState, State: require("module_5412").State, warningMessage: tagMessageResult };
