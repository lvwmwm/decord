...
// Function ID: 4051
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4051, 4052, 4054, 4032]
// Exports: RiveView

// Module 4050 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + require(4051).RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp18 = jsx(_require(4032).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
