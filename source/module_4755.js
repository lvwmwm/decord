// Module ID: 4755
// Function ID: 41198
// Dependencies: [65, 4756, 4757, 4758, 4759, 4760, 4753, 4752]
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    while (iter !== undefined) {
      ...
      if (hasOwnProperty2.call(require(4753).FileTypes, nextResult)) {
        let tmp9 = items;
    ...
    for (const item10070 of items) {
      ...
      let tmp39 = item10070;
      let FileTypes4 = require(4753).FileTypes;
      let tmp42 = items1;
    ...
    fileChunk = require(4752) /* getFileChunk */.getFileChunk(fileChunk, num4);
    const FileTypes2 = require(4753).FileTypes;
    ...
    if (detectSignatureResult) {
      if (items2.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes3 = require(4753).FileTypes;
