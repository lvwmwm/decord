...
// Function ID: 7775
// Name: addHandler
// Dependencies: [7775, 7776, 7779]

// Module 7774 (addHandler)
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (__SENTRY_DEBUG__.DEBUG_BUILD) {
          const logger = tmp19(7776).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(7779).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(7779);
        }
      }
    }
