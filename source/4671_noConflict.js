...
const fn = function() {
  ...
  obj.date = (str) => {
    ...
    let closure_5 = {
      ...
      z() {
        if (lib.L()) {
          let tmp3 = dependencyMap2[lib.n(lib)];
        } else {
          tmp3 = dependencyMap[lib.n(lib)];
        }
        return tmp3 + lib.j() - 1;
      },
      W() {
  ...
  obj.filesize = (arg0, arg1, arg2, arg3, arg4, arg5) => {
    ...
    if (arg0 > 0) {
      ...
      str2 = obj.intword(arg0, ["bytes", "KB", "MB", "GB", "TB", "PB"], num2, num, arg3, arg4, str);
      tmp = arg0 < num2 && undefined === num;
    }
    return str2;
  };
