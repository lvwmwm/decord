...
obj = {
  ...
  match(arg0) {
    const CHANNEL_OR_MESSAGES_URL_RE = require(4536) /* ME */.CHANNEL_OR_MESSAGES_URL_RE;
...
obj[2] = {
  ...
  requiredFirstCharacters: ["h"],
  match(arg0) {
    const MEDIA_POST_URL_RE = require(4536) /* ME */.MEDIA_POST_URL_RE;
