...
// Function ID: 4767
// Name: MarkupText
// Dependencies: [19, 17, 4662, 1391, 1983, 1910, 676, 1398, 505, 21, 4767, 4734, 4661, 712, 4768, 4488, 4230, 5260, 8929, 4827, 1236, 7167, 4093, 7188, 1297, 1487, 8775, 4090, 10800, 10781, 8308, 589, 4223, 8186, 4342, 10784, 2007, 11, 4066, 5449, 10757, 13066, 9560, 4765, 10062, 13067, 13069, 4318, 6809, 500, 6832, 13071, 10064, 2]
...
function MarkupBlockQuote(state) {
  ...
  obj[1] = textColor;
  obj[2] = require(8308) /* smartOutput */.smartOutput(node, output, state);
...
function MarkupCodeBlock(state) {
  ...
  obj[1] = textColor;
  const items = [require(8308) /* smartOutput */.smartOutput(node, output, state), "\n"];
  obj[2] = items;
...
function MarkupCustomEmoji(styles) {
  ...
  if (node.src) {
    ...
    obj1[2] = tmp13;
    let tmp4Result = tmp4(importDefault(5449), obj1, state.key);
...
function MarkupCommandMention(state) {
  ...
  obj[3] = mention;
  return tmp2(importDefault(9560), obj, state.key);
}
  ...
  return {
    ...
    [closure_0(closure_2[43]).AST_KEY.HIGHLIGHT]: {
      react(node, output, textColor) {
        ...
        obj[1] = obj(8308).smartOutput(node, output, textColor);
        return closure_15(closure_19, obj, textColor.key);
      }
    },
    ...
    [closure_0(closure_2[43]).AST_KEY.CHANNEL]: {
      react(iconType, output, textColor) {
        ...
        obj[1] = obj(6832).getChannelMentionIcon(str);
        const fontScale = store.getFontScale();
        if (fontScale < 1) {
...
export const plainMentionRenderer = function plainMentionRenderer(content, output, state) {
  if (typeof content.content === "string") {
    ...
    content = require(8308) /* smartOutput */.smartOutput(content, output, state);
    const obj = require(8308) /* smartOutput */;
  }
  return content;
};
