...
// Dependencies: [19, 1391, 1498, 4778, 4779, 21, 7030, 4198, 4310, 1626, 4684, 1236, 1297, 9594, 4061, 5796, 4034, 9596, 5801, 9598, 4338, 4205, 9601, 8241, 2]
// Exports: default

// Module 9593 (handleTapCommandMention)
...
function handleLongPressCommandMention(arg0, arg1) {
  ...
  obj[1] = _require(9594).SlashBoxIcon;
  ...
  const items = [obj];
  const DeveloperMode = _require(4034).DeveloperMode;
  ...
  const result = _require(5801).showSimpleActionSheet({ key: "LongPressCommandMention", options: items, hasIcons: true });
}
