...
// Dependencies: [19, 21, 4189, 712, 1236, 4180, 11487, 5141, 8480, 8486, 4185, 2]
// Exports: default

// Module 12985 (MarkupGameMention)
import "noop";
...
export default function MarkupGameMention(arg0) {
  ...
  if (tmp5) {
    ...
    let tmp9Result = callback(tmp2(11487).UnknownGameIcon, obj);
    if (tmp11) {
      ...
      obj1[0] = icon;
      obj[1] = obj1;
      tmp9Result = tmp9(importDefault(5141), obj);
    }
    let str3 = "button";
    ...
    obj2[4] = items;
    return closure_3(tmp2(4180).MarkupText, obj2, state.key);
  } else {
    let textColor1;
    if (state != null) {
    ...
    obj[1] = items1;
    return closure_3(tmp2(4180).MarkupText, obj, state.key);
  }
};
