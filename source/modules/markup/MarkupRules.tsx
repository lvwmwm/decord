...
// Function ID: 4778
// Name: parseLink
// Dependencies: [32, 853, 1391, 1983, 1910, 1922, 676, 4778, 4779, 4780, 1236, 4783, 1986, 4534, 4187, 4060, 4784, 4785, 4788, 4002, 4789, 4799, 4800, 4801, 4802, 4803, 4776, 4804, 12, 2]
// Exports: hydrateCommandMention

// Module 4777 (parseLink)
...
function parseLink(arg0) {
  let obj = require(4780) /* validateContentTypes */;
...
function hydrateRoleMention(arg0, guildId) {
  ...
  if (null == role) {
    ...
    let hasEnhancedRoleColorsForRole = require(4783) /* useHasEnhancedRoleColors */.getHasEnhancedRoleColorsForRole(id, role);
...
function hydrateUserMention(everyoneOrHere, channelId) {
  ...
  if (null != str) {
    str = str.toString();
    if (null != channel) {
      let nickname = importDefault(4534).getNickname(channel.getGuildId(), channelId.channelId, str);
      if (nickname == null) {
...
obj.match = function match(arg0, allowEscape) {
  ...
  if (false !== allowEscape.allowEscape) {
    match = importDefault(4060).defaultRules.escape.match(arg0, allowEscape, arg2);
    const str = importDefault(4060).defaultRules.escape;
  }
  return match;
};
obj[2] = obj;
...
obj5.parse = function parse(arg0, arg1, parseInlineCodeChildContent) {
  const inlineCode = importDefault(4060).defaultRules.inlineCode;
...
obj[27] = {
  ...
  requiredFirstCharacters: [":"],
  match(arg0) {
    const EMOJI_NAME_RE = importDefault(4002).EMOJI_NAME_RE;
    ...
    if (null != match) {
      ...
      tmpResult = importDefault(4002);
    }
    return tmp4;
  },
  parse(arg0) {
    let content = importDefault(4002).convertNameToSurrogate(arg0[1]);
    if (null == content) {
      const _HermesInternal = HermesInternal;
      content = ":" + arg0[1] + ":";
    }
...
obj[28] = {
  ...
  requiredFirstCharacters: ["<"],
  match(arg0) {
    const soundmojiRawFormatRegex = require(4789) /* getSoundmojiASTFromString */.soundmojiRawFormatRegex;
    return soundmojiRawFormatRegex.exec(arg0);
  },
  parse(arg0, arg1, arg2) {
    return importDefault(4789)(arg0, arg2);
  }
};
const obj15 = {
  order: require("textRegexp").order,
...
obj[30] = {
  ...
  requiredFirstCharacters: ["<"],
  match(arg0) {
    const TIMESTAMP_REGEX = require(4799) /* TIMESTAMP_FORMATS */.TIMESTAMP_REGEX;
  ...
  parse(arg0) {
    ...
    let tmp3;
    [tmp, tmp2, tmp3] = arg0;
    let obj = require(4799) /* TIMESTAMP_FORMATS */;
...
obj[33] = {
  ...
  parse(arg0, arg1, guildId) {
    ...
    let obj = require(4800) /* staticRouteToTranslation */;
    const result = obj.staticRouteToTranslation(tmp2);
    let obj1 = require(4800) /* staticRouteToTranslation */;
    if (null != guildId.guildId) {
      let guild = store2.getGuild(guildId.guildId);
    } else {
      guild = null;
