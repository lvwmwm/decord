...
// Function ID: 4777
// Name: parseLink
// Dependencies: [32, 853, 1391, 1983, 1910, 1922, 676, 4777, 4778, 4779, 1236, 4782, 1986, 4533, 4189, 4060, 4783, 4784, 4787, 4002, 4788, 4798, 4799, 4800, 4801, 4802, 4775, 4803, 12, 2]
// Exports: hydrateCommandMention

// Module 4776 (parseLink)
...
function parseLink(arg0) {
  let obj = require(4779) /* validateContentTypes */;
...
function hydrateRoleMention(arg0, guildId) {
  ...
  if (null == role) {
    ...
    let hasEnhancedRoleColorsForRole = require(4782) /* useHasEnhancedRoleColors */.getHasEnhancedRoleColorsForRole(id, role);
...
function hydrateUserMention(everyoneOrHere, channelId) {
  ...
  if (null != str) {
    str = str.toString();
    if (null != channel) {
      let nickname = importDefault(4533).getNickname(channel.getGuildId(), channelId.channelId, str);
      if (nickname == null) {
...
obj[28] = {
  ...
  requiredFirstCharacters: ["<"],
  match(arg0) {
    const soundmojiRawFormatRegex = require(4788) /* getSoundmojiASTFromString */.soundmojiRawFormatRegex;
    return soundmojiRawFormatRegex.exec(arg0);
  },
  parse(arg0, arg1, arg2) {
    return importDefault(4788)(arg0, arg2);
  }
};
const obj15 = {
  order: require("textRegexp").order,
...
obj[30] = {
  ...
  requiredFirstCharacters: ["<"],
  match(arg0) {
    const TIMESTAMP_REGEX = require(4798) /* TIMESTAMP_FORMATS */.TIMESTAMP_REGEX;
  ...
  parse(arg0) {
    ...
    let tmp3;
    [tmp, tmp2, tmp3] = arg0;
    let obj = require(4798) /* TIMESTAMP_FORMATS */;
...
obj[33] = {
  ...
  parse(arg0, arg1, guildId) {
    ...
    let obj = require(4799) /* staticRouteToTranslation */;
    const result = obj.staticRouteToTranslation(tmp2);
    let obj1 = require(4799) /* staticRouteToTranslation */;
    if (null != guildId.guildId) {
      let guild = store2.getGuild(guildId.guildId);
    } else {
      guild = null;
