...
// Dependencies: [1390, 7257, 1377, 13612, 13613, 1955, 13614, 1404, 2]
...
import closure_3 from "getMarketingBySurface" /* 7257 */;
...
export const getVersionedDismissibleContentCurrentVersion = function getVersionedDismissibleContentCurrentVersion(closure_0) {
  if (DismissibleContent.DismissibleContent.COLLECTIBLES_SHOP_ENTRY_MARKETING === closure_0) {
    marketingBySurface = marketingBySurface.getMarketingBySurface(tmp(13612).CollectiblesMarketingSurface.MOBILE_SHOP_BUTTON);
    let num5;
