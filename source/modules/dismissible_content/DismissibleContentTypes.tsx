...
const items = [require(dependencyMap[0]).DismissibleContent.COLLECTIBLES_SHOP_ENTRY_MARKETING, require(dependencyMap[0]).DismissibleContent.ACTIVITIES_VOICE_LAUNCHER_BADGE, require(dependencyMap[0]).DismissibleContent.GUILD_POWERUP_NEW_PERK_AVAILABLE_COACHMARK, require(dependencyMap[0]).DismissibleContent.GUILD_POWERUP_NEW_PERK_AVAILABLE_BADGE, require(dependencyMap[0]).DismissibleContent.COLLECTIBLES_SHOP_WIDE_BANNER, require(dependencyMap[0]).DismissibleContent.GAME_SHOP_ANNOUNCEMENT_MODAL, require(dependencyMap[0]).DismissibleContent.SLAYER_STOREFRONT_VC_GIFTING_STREAM_HEADER_NEW_BADGE, require(dependencyMap[0]).DismissibleContent.SLAYER_STOREFRONT_VC_GIFTING_PANEL_APP_WIDGET_CTA, require(dependencyMap[0]).DismissibleContent.COLLECTIBLES_SHOP_SLAYER_STOREFRONT_PROMOTIONAL_BANNER, require(dependencyMap[0]).DismissibleContent.COLLECTIBLES_SHOP_GAME_SERVER_HOSTING_BANNER];
