...
// Dependencies: [19, 1340, 4267, 1381, 1383, 676, 685, 698, 1377, 6205, 589, 1379, 4288, 1376, 4266, 11, 2]
...
// Module 6204 (canShowTimeRecurringContent)
...
export const useGetDismissibleContent = function useGetDismissibleContent(items3, APP_LAUNCHER_ONBOARDING) {
  ...
  const newUserDismissibleContent = found1(4288).useNewUserDismissibleContent(items3);
  found1 = null;
  ...
  const obj3 = found1(4288);
  let tmpResult = tmp(6205);
...
export const useGetSingleUseGuildDismissibleContent_UNSAFE = function useGetSingleUseGuildDismissibleContent_UNSAFE(items4, current, CHANNEL_NOTICES) {
  ...
  dependencyMap = stateFromStores;
  let obj = found1(589);
  const newUserDismissibleContent = found1(4288).useNewUserDismissibleContent(items4);
  found1 = null;
  if (closure_4.hasLoaded(UserSettingsTypes.PRELOADED_USER_SETTINGS)) {
