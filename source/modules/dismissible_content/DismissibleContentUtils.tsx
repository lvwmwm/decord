...
// Dependencies: [32, 5, 1340, 1361, 1362, 1364, 1369, 676, 1359, 1370, 11, 1355, 4145, 589, 1358, 709, 9718, 698, 1363, 2]
...
function markDismissibleContentAsDismissedPreProcessing(closure_0, closure_2) {
  ...
  require(9718) /* handleDCShownToUser */.handleDCDismissed(closure_0, guildId);
}
