...
// Dependencies: [19, 1372, 1862, 4271, 3885, 676, 21, 1236, 8919, 5192, 10365, 4197, 7132, 10375, 9265, 4219, 4209, 10519, 4775, 9284, 7814, 4199, 10377, 10380, 4223, 10458, 1959, 10382, 10383, 10523, 589, 5769, 12, 9322, 4446, 3928, 10525, 5632, 1297, 5617, 10526, 5619, 9825, 5609, 3955, 2]
// Exports: default
...
function ThreadLongPressActionSheetConnected(channel) {
  ...
  const tmp12 = isMuted(9322)(channel);
  const DeveloperMode = channel(3928).DeveloperMode;
  setting = DeveloperMode.useSetting();
  const tmp13 = isMuted(4446)(channel, true);
  if (null != stateFromStores) {
    obj = { guild: null, size: null };
    obj[0] = stateFromStores;
    obj[1] = tmp(5632).GuildIconSizes.LARGE;
    let tmp17 = callback(tmp11(5632), obj);
    let tmp16 = callback;
    const tmp11Result = tmp11(5632);
  } else {
    tmp16 = callback;
  ...
  obj1[1] = items5;
  items4.push(obj1);
  const tmp23 = isMuted(10365)(isMuted(10525)(channel, "ThreadLongPressActionSheet"));
  if (null != tmp23) {
  ...
  if (hasJoined) {
    ...
    obj6[0] = stringResult;
    obj6[1] = tmp(10375).GroupPlusIcon;
    ...
    if (null == tmp21) {
      ...
      if (isThreadModerator) {
        ...
        if (isLockedThreadResult) {
          ...
          obj9[1] = tmp(10519).LockUnlockedIcon;
      ...
      if (!isThreadModerator) {
        ...
        if (isMuted) {
          ...
          obj12[1] = tmp(10380).BellSlashIcon;
          obj12[2] = function onPress() {
          ...
          obj13[1] = tmp(10383).ChannelNotificationIcon;
          ...
          obj15[0] = tmp13;
          obj15[1] = tmp17;
          obj14[0] = tmp16(tmp(10526).ActionSheetIconHeader, obj15);
          const items8 = [
            items4.map((buttons) => {
          ...
          if (setting) {
            ...
            obj18[0] = tmp(9825).IdIcon;
            obj17[0] = tmp16(tmp(5619).ActionSheetRow.Icon, obj18);
            ...
            obj16[1] = tmp16(tmp(5619).ActionSheetRow, obj17);
            setting = tmp16(tmp(5619).ActionSheetRow.Group, obj16, "developer-actions");
          }
          items8[1] = setting;
          obj14[1] = items8;
          return closure_13(tmp(5617).ActionSheet, obj14);
        }
      } else {
      ...
      obj20[1] = tmp(9265).PhoneCallIcon;
      obj20[2] = tmp21;
