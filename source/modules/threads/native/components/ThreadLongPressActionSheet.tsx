...
// Dependencies: [19, 1391, 1910, 4395, 4399, 4027, 676, 21, 9882, 1236, 9883, 9885, 8652, 5359, 9858, 4321, 7368, 9872, 8555, 4343, 4333, 10053, 4925, 9822, 8167, 4323, 9876, 9887, 4347, 9974, 2009, 9284, 9889, 10348, 589, 5996, 12, 8568, 4574, 4070, 10350, 5885, 1297, 5870, 10351, 5872, 9696, 5862, 4097, 2]
// Exports: default

// Module 15472 (ThreadLongPressActionSheetConnected)
import closure_3 from "noop" /* 19 */;
import closure_4 from "ensureGuildLoaded" /* 1391 */;
import closure_5 from "createGuildRecordFromRust" /* 1910 */;
import closure_6 from "generateOldThreadCutoff" /* 4395 */;
import closure_7 from "updateVoiceState" /* 4399 */;
import closure_8 from "storeThread" /* 4027 */;
...
function ThreadLongPressActionSheetConnected(channel) {
  ...
  const tmp14 = isMuted(8568)(channel);
  const DeveloperMode = channel(4070).DeveloperMode;
  setting = DeveloperMode.useSetting();
  const tmp15 = isMuted(4574)(channel, true);
  if (null != stateFromStores) {
    obj = { guild: null, size: null };
    obj[0] = stateFromStores;
    obj[1] = tmp(5885).GuildIconSizes.LARGE;
    let tmp19 = callback(tmp13(5885), obj);
    let tmp18 = callback;
    const tmp13Result = tmp13(5885);
  } else {
    tmp18 = callback;
  ...
  const MarkChannelUnreadExperiment = tmp(9882).MarkChannelUnreadExperiment;
  if (MarkChannelUnreadExperiment.getConfig({ location: "thread_action_sheet" }).enabled) {
    if (!stateFromStores1) {
      if (canMarkChannelUnread) {
        ...
        obj2[1] = tmp(9883).ChatMarkUnreadIcon;
        ...
        if (null == tmp23) {
          ...
          if (isThreadModerator) {
            ...
            if (isLockedThreadResult) {
              ...
              obj9[1] = tmp(10053).LockUnlockedIcon;
          ...
          if (!isThreadModerator) {
            ...
            if (isMuted) {
              ...
              obj12[1] = tmp(9887).BellSlashIcon;
              obj12[2] = function onPress() {
              ...
              obj13[1] = tmp(9889).ChannelNotificationIcon;
              ...
              obj15[0] = tmp15;
              obj15[1] = tmp19;
              obj14[0] = tmp18(tmp(10351).ActionSheetIconHeader, obj15);
              const items8 = [
                items5.map((buttons) => {
              ...
              if (setting) {
                ...
                obj18[0] = tmp(9696).IdIcon;
                obj17[0] = tmp18(tmp(5872).ActionSheetRow.Icon, obj18);
                ...
                obj16[1] = tmp18(tmp(5872).ActionSheetRow, obj17);
                setting = tmp18(tmp(5872).ActionSheetRow.Group, obj16, "developer-actions");
              }
              items8[1] = setting;
              obj14[1] = items8;
              return closure_14(tmp(5870).ActionSheet, obj14);
            }
          } else {
          ...
          obj20[1] = tmp(8555).PhoneCallIcon;
          obj20[2] = tmp23;
