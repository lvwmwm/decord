...
// Dependencies: [19, 1391, 1910, 4461, 4465, 4092, 676, 21, 10257, 1236, 10258, 10260, 7690, 5443, 10242, 4387, 7456, 10053, 7570, 4409, 4399, 10262, 5009, 10264, 8693, 4389, 10630, 10176, 4413, 10163, 2010, 9685, 10636, 10887, 589, 6081, 12, 7592, 4640, 4135, 10649, 5969, 1297, 5954, 10673, 5956, 8987, 5946, 4162, 2]
// Exports: default

// Module 15634 (ThreadLongPressActionSheetConnected)
import closure_3 from "noop" /* 19 */;
import closure_4 from "ensureGuildLoaded" /* 1391 */;
import closure_5 from "createGuildRecordFromRust" /* 1910 */;
import closure_6 from "generateOldThreadCutoff" /* 4461 */;
import closure_7 from "updateVoiceState" /* 4465 */;
import closure_8 from "storeThread" /* 4092 */;
...
function ThreadLongPressActionSheetConnected(channel) {
  ...
  const tmp14 = isMuted(7592)(channel);
  const DeveloperMode = channel(4135).DeveloperMode;
  setting = DeveloperMode.useSetting();
  const tmp15 = isMuted(4640)(channel, true);
  if (null != stateFromStores) {
    obj = { guild: null, size: null };
    obj[0] = stateFromStores;
    obj[1] = tmp(5969).GuildIconSizes.LARGE;
    let tmp19 = callback(tmp13(5969), obj);
    let tmp18 = callback;
    const tmp13Result = tmp13(5969);
  } else {
    tmp18 = callback;
  ...
  const MarkChannelUnreadExperiment = tmp(10257).MarkChannelUnreadExperiment;
  if (MarkChannelUnreadExperiment.getConfig({ location: "thread_action_sheet" }).enabled) {
    if (!stateFromStores1) {
      if (canMarkChannelUnread) {
        ...
        obj2[1] = tmp(10258).ChatMarkUnreadIcon;
      ...
      if (hasJoined) {
        ...
        obj6[0] = stringResult;
        obj6[1] = tmp(10053).GroupPlusIcon;
        ...
        if (null == tmp23) {
          ...
          if (isThreadModerator) {
            ...
            if (isLockedThreadResult) {
              ...
              obj9[1] = tmp(10262).LockUnlockedIcon;
          ...
          if (!isThreadModerator) {
            ...
            if (isMuted) {
              ...
              obj12[1] = tmp(10176).BellSlashIcon;
              obj12[2] = function onPress() {
              ...
              obj13[1] = tmp(10636).ChannelNotificationIcon;
              ...
              obj15[0] = tmp15;
              obj15[1] = tmp19;
              obj14[0] = tmp18(tmp(10673).ActionSheetIconHeader, obj15);
              const items8 = [
                items5.map((buttons) => {
              ...
              if (setting) {
                ...
                obj18[0] = tmp(8987).IdIcon;
                obj17[0] = tmp18(tmp(5956).ActionSheetRow.Icon, obj18);
                ...
                obj16[1] = tmp18(tmp(5956).ActionSheetRow, obj17);
                setting = tmp18(tmp(5956).ActionSheetRow.Group, obj16, "developer-actions");
              }
              items8[1] = setting;
              obj14[1] = items8;
              return closure_14(tmp(5954).ActionSheet, obj14);
            }
          } else {
          ...
          obj20[1] = tmp(7570).PhoneCallIcon;
          obj20[2] = tmp23;
