...
// Dependencies: [19, 1386, 1908, 4493, 4497, 4122, 673, 21, 10342, 1233, 10343, 10345, 7752, 5486, 10327, 4419, 7519, 10137, 7633, 4441, 4431, 10347, 5048, 10349, 8767, 4421, 10913, 10260, 4445, 10247, 2008, 9768, 10919, 11169, 586, 6124, 12, 7654, 4674, 4166, 10932, 6012, 1296, 5997, 10956, 5999, 9061, 5989, 4193, 2]
// Exports: default

// Module 15935 (ThreadLongPressActionSheetConnected)
...
function ThreadLongPressActionSheetConnected(channel) {
  ...
  const tmp14 = isMuted(7654)(channel);
  ...
  if (null != stateFromStores) {
    ...
    let tmp19 = callback(tmp13(6012), obj);
    let tmp18 = callback;
    const tmp13Result = tmp13(6012);
  } else {
    tmp18 = callback;
  ...
  const MarkChannelUnreadExperiment = tmp(10342).MarkChannelUnreadExperiment;
  if (MarkChannelUnreadExperiment.getConfig({ location: "thread_action_sheet" }).enabled) {
    if (!stateFromStores1) {
      if (canMarkChannelUnread) {
        ...
        obj2[1] = tmp(10343).ChatMarkUnreadIcon;
      ...
      if (hasJoined) {
        ...
        obj6[0] = stringResult;
        obj6[1] = tmp(10137).GroupPlusIcon;
        ...
        if (null == tmp23) {
          ...
          if (isThreadModerator) {
            ...
            if (isLockedThreadResult) {
              ...
              obj9[1] = tmp(10347).LockUnlockedIcon;
          ...
          if (!isThreadModerator) {
            ...
            if (isMuted) {
              ...
              obj12[1] = tmp(10260).BellSlashIcon;
              obj12[2] = function onPress() {
              ...
              obj13[1] = tmp(10919).ChannelNotificationIcon;
              ...
              obj15[0] = tmp15;
              obj15[1] = tmp19;
              obj14[0] = tmp18(tmp(10956).ActionSheetIconHeader, obj15);
              const items8 = [
                items5.map((buttons) => {
              ...
              if (setting) {
                ...
                obj18[0] = tmp(9061).IdIcon;
                obj17[0] = tmp18(tmp(5999).ActionSheetRow.Icon, obj18);
                ...
                obj16[1] = tmp18(tmp(5999).ActionSheetRow, obj17);
                setting = tmp18(tmp(5999).ActionSheetRow.Group, obj16, "developer-actions");
              }
              items8[1] = setting;
              obj14[1] = items8;
              return closure_14(tmp(5997).ActionSheet, obj14);
            }
          } else {
          ...
          obj20[1] = tmp(7633).PhoneCallIcon;
          obj20[2] = tmp23;
