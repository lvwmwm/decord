...
// Dependencies: [19, 1372, 1891, 4301, 3914, 676, 21, 1236, 8420, 5236, 9627, 4227, 7145, 9639, 8321, 4249, 4239, 9820, 4804, 9591, 7939, 4229, 9643, 9649, 4253, 9736, 1988, 9059, 9651, 10111, 589, 5810, 12, 8334, 4475, 3957, 10113, 5700, 1297, 5685, 10114, 5687, 9464, 5677, 3984, 2]
// Exports: default

// Module 15154 (ThreadLongPressActionSheetConnected)
...
function ThreadLongPressActionSheetConnected(channel) {
  ...
  const tmp12 = isMuted(8334)(channel);
  const DeveloperMode = channel(3957).DeveloperMode;
  ...
  if (null != stateFromStores) {
    ...
    let tmp17 = callback(tmp11(5700), obj);
    let tmp16 = callback;
    const tmp11Result = tmp11(5700);
  } else {
    tmp16 = callback;
  ...
  obj1[1] = items5;
  items4.push(obj1);
  const tmp23 = isMuted(9627)(isMuted(10113)(channel, "ThreadLongPressActionSheet"));
  if (null != tmp23) {
    ...
    if (null == tmp21) {
      ...
      if (isThreadModerator) {
        ...
        if (isLockedThreadResult) {
          ...
          obj9[1] = tmp(9820).LockUnlockedIcon;
      ...
      if (!isThreadModerator) {
        ...
        if (isMuted) {
          ...
          obj12[1] = tmp(9649).BellSlashIcon;
          obj12[2] = function onPress() {
          ...
          obj13[1] = tmp(9651).ChannelNotificationIcon;
          ...
          obj15[0] = tmp13;
          obj15[1] = tmp17;
          obj14[0] = tmp16(tmp(10114).ActionSheetIconHeader, obj15);
          const items8 = [
            items4.map((buttons) => {
          ...
          if (setting) {
            ...
            obj17[0] = tmp16(tmp(5687).ActionSheetRow.Icon, obj18);
            ...
            obj16[1] = tmp16(tmp(5687).ActionSheetRow, obj17);
            setting = tmp16(tmp(5687).ActionSheetRow.Group, obj16, "developer-actions");
          }
          items8[1] = setting;
          obj14[1] = items8;
          return closure_13(tmp(5685).ActionSheet, obj14);
        }
      } else {
      ...
      obj20[1] = tmp(8321).PhoneCallIcon;
      obj20[2] = tmp21;
