...
// Dependencies: [19, 1372, 1862, 4301, 3915, 676, 21, 1236, 8308, 5221, 9627, 4227, 7144, 9637, 8209, 4249, 4239, 9818, 4804, 9591, 7826, 4229, 9641, 9647, 4253, 9734, 1959, 9058, 9649, 10109, 589, 5798, 12, 8222, 4475, 3958, 10111, 5661, 1297, 5646, 10112, 5648, 9464, 5638, 3985, 2]
// Exports: default

// Module 15137 (ThreadLongPressActionSheetConnected)
...
function ThreadLongPressActionSheetConnected(channel) {
  ...
  const tmp12 = isMuted(8222)(channel);
  const DeveloperMode = channel(3958).DeveloperMode;
  setting = DeveloperMode.useSetting();
  const tmp13 = isMuted(4475)(channel, true);
  if (null != stateFromStores) {
    obj = { guild: null, size: null };
    obj[0] = stateFromStores;
    obj[1] = tmp(5661).GuildIconSizes.LARGE;
    let tmp17 = callback(tmp11(5661), obj);
    let tmp16 = callback;
    const tmp11Result = tmp11(5661);
  } else {
    tmp16 = callback;
  ...
  obj1[1] = items5;
  items4.push(obj1);
  const tmp23 = isMuted(9627)(isMuted(10111)(channel, "ThreadLongPressActionSheet"));
  if (null != tmp23) {
    ...
    if (null == tmp21) {
      ...
      if (isThreadModerator) {
        ...
        if (isLockedThreadResult) {
          ...
          obj9[1] = tmp(9818).LockUnlockedIcon;
      ...
      if (!isThreadModerator) {
        ...
        if (isMuted) {
          ...
          obj12[1] = tmp(9647).BellSlashIcon;
          obj12[2] = function onPress() {
          ...
          obj13[1] = tmp(9649).ChannelNotificationIcon;
          ...
          obj15[0] = tmp13;
          obj15[1] = tmp17;
          obj14[0] = tmp16(tmp(10112).ActionSheetIconHeader, obj15);
          const items8 = [
            items4.map((buttons) => {
          ...
          if (setting) {
            ...
            obj18[0] = tmp(9464).IdIcon;
            obj17[0] = tmp16(tmp(5648).ActionSheetRow.Icon, obj18);
            ...
            obj16[1] = tmp16(tmp(5648).ActionSheetRow, obj17);
            setting = tmp16(tmp(5648).ActionSheetRow.Group, obj16, "developer-actions");
          }
          items8[1] = setting;
          obj14[1] = items8;
          return closure_13(tmp(5646).ActionSheet, obj14);
        }
      } else {
      ...
      obj20[1] = tmp(8209).PhoneCallIcon;
      obj20[2] = tmp21;
