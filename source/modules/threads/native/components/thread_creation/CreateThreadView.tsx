...
// Dependencies: [5, 32, 19, 17, 4855, 7442, 673, 21, 4478, 709, 8173, 7532, 5962, 5982, 1627, 5603, 5079, 5027, 16457, 6002, 1233, 16459, 11784, 11759, 12416, 11219, 1499, 695, 4701, 4357, 1219, 10358, 16458, 4340, 2]

// Module 16456 (CreateThreadViewInner)
import ThemesDefault from "Themes" /* 709 */;
import useCreateThreadViewPropsDefault from "useCreateThreadViewProps" /* 11219 */;
...
function CreateThreadViewInner(screenIndex) {
  ...
  callback = importAllResult.useCallback((guild_id) => {
    if ("Message Shortcut" === threadSettingsDraft.location) {
      ...
      const merged1 = Object.assign(lib(4701).collectChannelAnalyticsMetadata(tmp23));
  ...
  obj[4] = str;
  obj[5] = callback;
  const tmp12Result = threadSettingsDraft(10358)(obj);
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              if (!current) {
                ...
                if (null == parentMessageId.parentMessageId) {
                  ...
                  closure_1_2(lib(16458).makeEmptyTitleError());
                  const obj8 = lib(16458);
            ...
            if (1 === current) {
              ...
              if (code === closure_2_10.AUTOMOD_TITLE_BLOCKED) {
                closure_1_2(lib(16458).makeAutomodViolationError(lib.body, lib));
                const obj5 = lib(16458);
                lib(4340).dismissKeyboard();
                const obj6 = lib(4340);
              } else {
  ...
  const tmp12 = threadSettingsDraft(10358);
  const tmp11Result = threadSettingsDraft(5962);
  const tmp16 = threadSettingsDraft(1627)();
  const ref = obj1.useRef(null);
  const ref1 = obj1.useRef(null);
  obj = { value: tmp11Result(tmp11(5982).CREATE_THREAD).analyticsLocations, children: null };
  const items3 = [callback2(threadSettingsDraft(5079), { absolute: true }), ];
  obj1 = { style: items4, children: null };
  items4 = [tmp.container, { marginBottom: threadSettingsDraft(5603)({ isKeyboardAwareOnAndroid: false, includeKeyboardHeight: true }).insets.bottom - tmp16.bottom }];
  ...
  const items6 = [callback2(closure_6, { style: tmp.threadIconContainer, children: callback2(_require(5027).ThreadIcon, { size: "lg" }) }), callback2(threadSettingsDraft(16457), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
  let tmp22Result = null;
  if (!isForumLikeChannelResult) {
    tmp22Result = null;
    if (null == threadSettingsDraft.parentMessageId) {
      tmp22Result = null;
      if (privateThreadMode !== tmp2(8173).PrivateThreadMode.Disabled) {
  ...
  if (null != threadSettingsDraft.parentMessageId) {
    ...
    items8[1] = tmp22(tmp2(16459).ThreadCreationStarterMessage, obj11);
    obj9[1] = items8;
  ...
  if (parentChannel.rateLimitPerUser > 0) {
    ...
    obj12[1] = tmp22(tmp11(11784), obj13);
    tmp22Result = tmp22(tmp23, obj12);
  }
  items5[2] = tmp22Result;
  items5[3] = callback2(threadSettingsDraft(11759), { ref, channel: parentChannel, onJumpToPresent: closure_12, screenIndex: screenIndex.screenIndex, secondaryTextFieldRef: ref1, threadCreationCallback: callback1 });
  items5[4] = callback2(threadSettingsDraft(12416), { channelId: parentChannel.id });
  obj1[1] = items5;
  items3[1] = closure_14(closure_6, obj1);
  obj[1] = items3;
  return closure_14(_require(5962).AnalyticsLocationProvider, obj);
}
