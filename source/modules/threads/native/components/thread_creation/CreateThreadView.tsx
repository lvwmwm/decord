...
// Dependencies: [5, 32, 19, 17, 4862, 7620, 673, 21, 4481, 709, 9234, 7709, 7102, 7122, 1627, 6921, 5086, 5034, 16543, 7141, 1233, 16545, 11915, 11890, 12574, 11290, 1499, 695, 4708, 4360, 1219, 10184, 16544, 4343, 2]

// Module 16542 (CreateThreadViewInner)
import ThemesDefault from "Themes" /* 709 */;
import useCreateThreadViewPropsDefault from "useCreateThreadViewProps" /* 11290 */;
...
function CreateThreadViewInner(screenIndex) {
  ...
  callback = importAllResult.useCallback((guild_id) => {
    if ("Message Shortcut" === threadSettingsDraft.location) {
      ...
      const merged1 = Object.assign(lib(4708).collectChannelAnalyticsMetadata(tmp23));
    ...
    if (null != navigation) {
      ...
      obj[3] = lib(4360).CREATE_THREAD_SCREEN_KEY;
  ...
  obj[4] = str;
  obj[5] = callback;
  const tmp12Result = threadSettingsDraft(10184)(obj);
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              if (!current) {
                ...
                if (null == parentMessageId.parentMessageId) {
                  ...
                  closure_1_2(lib(16544).makeEmptyTitleError());
                  const obj8 = lib(16544);
                  lib(4343).dismissKeyboard();
            ...
            if (1 === current) {
              ...
              if (code === closure_2_10.AUTOMOD_TITLE_BLOCKED) {
                closure_1_2(lib(16544).makeAutomodViolationError(lib.body, lib));
                const obj5 = lib(16544);
                lib(4343).dismissKeyboard();
                const obj6 = lib(4343);
              } else {
  ...
  const tmp12 = threadSettingsDraft(10184);
  const tmp11Result = threadSettingsDraft(7102);
  const tmp16 = threadSettingsDraft(1627)();
  const ref = obj1.useRef(null);
  const ref1 = obj1.useRef(null);
  obj = { value: tmp11Result(tmp11(7122).CREATE_THREAD).analyticsLocations, children: null };
  const items3 = [callback2(threadSettingsDraft(5086), { absolute: true }), ];
  obj1 = { style: items4, children: null };
  items4 = [tmp.container, { marginBottom: threadSettingsDraft(6921)({ isKeyboardAwareOnAndroid: false, includeKeyboardHeight: true }).insets.bottom - tmp16.bottom }];
  ...
  const items6 = [callback2(closure_6, { style: tmp.threadIconContainer, children: callback2(_require(5034).ThreadIcon, { size: "lg" }) }), callback2(threadSettingsDraft(16543), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
  let tmp22Result = null;
  if (!isForumLikeChannelResult) {
    tmp22Result = null;
    if (null == threadSettingsDraft.parentMessageId) {
      tmp22Result = null;
      if (privateThreadMode !== tmp2(9234).PrivateThreadMode.Disabled) {
  ...
  if (null != threadSettingsDraft.parentMessageId) {
    ...
    items8[1] = tmp22(tmp2(16545).ThreadCreationStarterMessage, obj11);
    obj9[1] = items8;
  ...
  if (parentChannel.rateLimitPerUser > 0) {
    ...
    obj12[1] = tmp22(tmp11(11915), obj13);
    tmp22Result = tmp22(tmp23, obj12);
  }
  items5[2] = tmp22Result;
  items5[3] = callback2(threadSettingsDraft(11890), { ref, channel: parentChannel, onJumpToPresent: closure_12, screenIndex: screenIndex.screenIndex, secondaryTextFieldRef: ref1, threadCreationCallback: callback1 });
  items5[4] = callback2(threadSettingsDraft(12574), { channelId: parentChannel.id });
  obj1[1] = items5;
  items3[1] = closure_14(closure_6, obj1);
  obj[1] = items3;
  return closure_14(_require(7102).AnalyticsLocationProvider, obj);
}
