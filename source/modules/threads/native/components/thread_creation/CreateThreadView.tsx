...
// Dependencies: [5, 32, 19, 17, 4638, 7086, 676, 21, 4302, 712, 8294, 7176, 5668, 5688, 1609, 5368, 4846, 4800, 15618, 5708, 1236, 15620, 11572, 11298, 11932, 10267, 1481, 698, 4496, 4182, 1222, 9842, 15619, 4160, 2]

// Module 15617 (CreateThreadViewInner)
...
function CreateThreadViewInner(screenIndex) {
  ...
  obj[4] = str;
  obj[5] = callback;
  const tmp12Result = threadSettingsDraft(9842)(obj);
  c6 = tmp12Result;
  _require = undefined;
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              if (!current) {
                ...
                if (null == parentMessageId.parentMessageId) {
                  ...
                  outer1_2(lib(15619).makeEmptyTitleError());
                  const obj8 = lib(15619);
                  lib(4160).dismissKeyboard();
            ...
            if (1 === current) {
              ...
              if (code === outer2_10.AUTOMOD_TITLE_BLOCKED) {
                outer1_2(lib(15619).makeAutomodViolationError(lib.body, lib));
                const obj5 = lib(15619);
                lib(4160).dismissKeyboard();
                const obj6 = lib(4160);
              } else {
  ...
  const tmp12 = threadSettingsDraft(9842);
  const tmp11Result = threadSettingsDraft(5668);
  const tmp16 = threadSettingsDraft(1609)();
  const ref = obj1.useRef(null);
  const ref1 = obj1.useRef(null);
  obj = { value: tmp11Result(tmp11(5688).CREATE_THREAD).analyticsLocations, children: null };
  const items3 = [callback2(threadSettingsDraft(4846), { absolute: true }), ];
  obj1 = { style: items4, children: null };
  items4 = [tmp.container, { marginBottom: threadSettingsDraft(5368)({ isKeyboardAwareOnAndroid: false, includeKeyboardHeight: true }).insets.bottom - tmp16.bottom }];
  ...
  const items6 = [callback2(c6, { style: tmp.threadIconContainer, children: callback2(_require(4800).ThreadIcon, { size: "lg" }) }), callback2(threadSettingsDraft(15618), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
  let tmp22Result = null;
  if (!isForumLikeChannelResult) {
    tmp22Result = null;
    if (null == threadSettingsDraft.parentMessageId) {
      tmp22Result = null;
      if (privateThreadMode !== tmp2(8294).PrivateThreadMode.Disabled) {
        ...
        obj8[2] = privateThreadMode !== tmp2(8294).PrivateThreadMode.Enabled;
        const intl = tmp2(1236).intl;
        obj8[3] = intl.string(tmp2(1236).t.F1zyvU);
        const intl2 = tmp2(1236).intl;
        obj8[4] = intl2.string(tmp2(1236).t.Wy5RIQ);
        obj8[5] = tmp2(8294).getIsPrivate(threadSettingsDraft, privateThreadMode);
        ...
        obj7[1] = tmp22(tmp2(5708).TableSwitchRow, obj8);
  ...
  if (null != threadSettingsDraft.parentMessageId) {
    ...
    items8[1] = tmp22(tmp2(15620).ThreadCreationStarterMessage, obj11);
    obj9[1] = items8;
  ...
  if (parentChannel.rateLimitPerUser > 0) {
    ...
    obj12[1] = tmp22(tmp11(11572), obj13);
    tmp22Result = tmp22(tmp23, obj12);
  }
  items5[2] = tmp22Result;
  items5[3] = callback2(threadSettingsDraft(11298), { ref, channel: parentChannel, onJumpToPresent: closure_12, screenIndex: screenIndex.screenIndex, secondaryTextFieldRef: ref1, threadCreationCallback: callback1 });
  items5[4] = callback2(threadSettingsDraft(11932), { channelId: parentChannel.id });
  obj1[1] = items5;
  items3[1] = closure_14(c6, obj1);
  obj[1] = items3;
  return closure_14(_require(5668).AnalyticsLocationProvider, obj);
}
...
const memoResult = importAllResult.memo((arg0) => {
  ...
  const tmp = importDefault(10267)(channelId);
  let tmp2 = null;
  if (null != tmp) {
