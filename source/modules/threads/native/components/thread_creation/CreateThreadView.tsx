...
// Dependencies: [5, 32, 19, 17, 4640, 7147, 676, 21, 4303, 712, 8359, 7237, 5728, 5748, 1628, 5369, 4848, 4802, 15718, 5768, 1236, 15720, 11642, 11370, 12002, 10339, 1500, 698, 4498, 4183, 1222, 9914, 15719, 4166, 2]

// Module 15717 (CreateThreadViewInner)
...
function CreateThreadViewInner(screenIndex) {
  ...
  obj[4] = str;
  obj[5] = callback;
  const tmp12Result = threadSettingsDraft(9914)(obj);
  c6 = tmp12Result;
  _require = undefined;
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              if (!current) {
                ...
                if (null == parentMessageId.parentMessageId) {
                  ...
                  outer1_2(lib(15719).makeEmptyTitleError());
                  const obj8 = lib(15719);
            ...
            if (1 === current) {
              ...
              if (code === outer2_10.AUTOMOD_TITLE_BLOCKED) {
                outer1_2(lib(15719).makeAutomodViolationError(lib.body, lib));
                const obj5 = lib(15719);
                lib(4166).dismissKeyboard();
                const obj6 = lib(4166);
              } else {
  ...
  const tmp12 = threadSettingsDraft(9914);
  ...
  const items6 = [callback2(c6, { style: tmp.threadIconContainer, children: callback2(_require(4802).ThreadIcon, { size: "lg" }) }), callback2(threadSettingsDraft(15718), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
  let tmp22Result = null;
  if (!isForumLikeChannelResult) {
    tmp22Result = null;
    if (null == threadSettingsDraft.parentMessageId) {
      tmp22Result = null;
      if (privateThreadMode !== tmp2(8359).PrivateThreadMode.Disabled) {
        ...
        obj8[2] = privateThreadMode !== tmp2(8359).PrivateThreadMode.Enabled;
        const intl = tmp2(1236).intl;
        obj8[3] = intl.string(tmp2(1236).t.F1zyvU);
        const intl2 = tmp2(1236).intl;
        obj8[4] = intl2.string(tmp2(1236).t.Wy5RIQ);
        obj8[5] = tmp2(8359).getIsPrivate(threadSettingsDraft, privateThreadMode);
  ...
  if (null != threadSettingsDraft.parentMessageId) {
    ...
    items8[1] = tmp22(tmp2(15720).ThreadCreationStarterMessage, obj11);
    obj9[1] = items8;
  ...
  if (parentChannel.rateLimitPerUser > 0) {
    ...
    obj12[1] = tmp22(tmp11(11642), obj13);
    tmp22Result = tmp22(tmp23, obj12);
  }
  items5[2] = tmp22Result;
  items5[3] = callback2(threadSettingsDraft(11370), { ref, channel: parentChannel, onJumpToPresent: closure_12, screenIndex: screenIndex.screenIndex, secondaryTextFieldRef: ref1, threadCreationCallback: callback1 });
  items5[4] = callback2(threadSettingsDraft(12002), { channelId: parentChannel.id });
  obj1[1] = items5;
...
const memoResult = importAllResult.memo((arg0) => {
  ...
  const tmp = importDefault(10339)(channelId);
  let tmp2 = null;
  if (null != tmp) {
