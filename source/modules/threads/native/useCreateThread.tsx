...
// Dependencies: [5, 19, 4820, 4439, 5918, 8107, 7148, 7374, 8111, 8109, 7530, 5088, 5043, 8112, 2]
// Exports: default, useCreateForumPost

// Module 10269 (useCreateThread)
...
export default function useCreateThread(arg0) {
  ...
  let obj = analyticsLocations(8107);
  obj = {
    parentChannel,
    parentMessageId,
    threadSettings,
    ...
    return (function*(arg0) {
      ...
      obj7.on("progress", (currentSize) => {
        if (currentSize.currentSize > c3) {
          ...
          obj[4] = obj7;
          closure_2_1(8112)(obj);
          const tmp10 = closure_2_1(8112);
        }
      });
