...
// Dependencies: [5, 19, 4807, 4438, 5905, 8093, 7135, 7360, 8097, 8095, 7516, 5075, 5030, 8098, 2]
// Exports: default, useCreateForumPost

// Module 10251 (useCreateThread)
...
export default function useCreateThread(arg0) {
  ...
  let obj = analyticsLocations(8093);
  obj = {
    parentChannel,
    parentMessageId,
    threadSettings,
    ...
    return (function*(arg0) {
      ...
      obj7.on("progress", (currentSize) => {
        if (currentSize.currentSize > c3) {
          ...
          obj[4] = obj7;
          closure_2_1(8098)(obj);
          const tmp10 = closure_2_1(8098);
        }
      });
