...
// Dependencies: [5, 19, 4591, 4248, 5595, 8137, 6811, 7036, 8141, 8140, 7192, 4848, 4807, 8142, 2]
// Exports: default, useCreateForumPost

// Module 9795 (useCreateThread)
...
export default function useCreateThread(arg0) {
  ...
  let obj = analyticsLocations(8137);
  obj = {
    parentChannel,
    parentMessageId,
    threadSettings,
