...
// Dependencies: [109, 4463, 4669, 4093, 1235, 676, 1236, 7212, 4668, 698, 7486, 5450, 1399, 589, 11, 4045, 2]
...
// Module 7493 (getAccessibilityLabelFormatter)
...
export const trackThreadNotificationSettingsUpdated = function trackThreadNotificationSettingsUpdated(closure_1_0, c1) {
  ...
  if (null != result) {
    ...
    if (null != c1.mute_config) {
      result1 = tmp(5450).muteConfigToTimestamp(c1.mute_config);
      const tmpResult1 = tmp(5450);
    }
