...
// Dependencies: [109, 4461, 4667, 4092, 1235, 676, 1236, 7191, 4666, 698, 7465, 5447, 1403, 589, 11, 4044, 2]
...
// Module 7472 (getAccessibilityLabelFormatter)
...
export const trackThreadNotificationSettingsUpdated = function trackThreadNotificationSettingsUpdated(closure_1_0, c1) {
  ...
  if (null != result) {
    ...
    if (null != c1.mute_config) {
      result1 = tmp(5447).muteConfigToTimestamp(c1.mute_config);
      const tmpResult1 = tmp(5447);
    }
