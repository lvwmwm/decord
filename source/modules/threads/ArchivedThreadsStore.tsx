...
// Function ID: 7514
// Name: listKey
// Dependencies: [32, 1395, 1391, 4772, 4023, 1400, 7514, 12, 1402, 11, 7272, 589, 709, 2]
...
function getSortValue(id) {
  if (arg1 === require(1400) /* set */.ThreadSortOrder.LATEST_ACTIVITY) {
    ...
    if (0 === iter.size) {
      ...
      if (null == value) {
        ...
        if (tmp9) {
          ...
          const result = require(7514) /* trackForumChannelSeenBatch */.trackForumMorePostsLoaded(obj);
          const obj3 = require(7514) /* trackForumChannelSeenBatch */;
        }
