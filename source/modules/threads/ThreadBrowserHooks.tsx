...
// Dependencies: [57, 31, 11840, 1348, 3793, 4177, 5075, 6059, 3795, 482, 6074, 566, 22, 1327, 21, 6058, 9111, 2]
// Exports: useActiveGuildThreads, useActiveThreads, useArchivedThreads, useTrackThreadBrowserTab

// Module 11839 (useActiveThreadIds)
...
export const useArchivedThreads = function useArchivedThreads(channel, LATEST_ACTIVITY, loadMore, MATCH_SOME) {
  ...
  obj.threadIds = _require(566).useStateFromStoresArray(items4, () => {
    ...
    return LATEST_ACTIVITY(loadMore[12])(outer1_10.getThreads(user.id, LATEST_ACTIVITY, loadMore, _slicedToArray)).filter((channelId) => {
      if (outer1_4) {
        if (!outer1_5) {
          return false;
        }
