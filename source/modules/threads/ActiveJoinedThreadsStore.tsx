...
// Dependencies: [6, 7, 15, 17, 18, 1352, 1348, 1838, 4177, 1907, 5075, 3795, 1355, 21, 4380, 5076, 686, 22, 566, 2]
    ...
    if (null != tmp5) {
      ...
      if (keys !== undefined) {
        while (keys[14] !== undefined) {
          ...
          let obj2 = require(4380) /* shouldAgeVerifyForAgeGate */;
...
function parseThreadState(channel) {
  ...
  if (isActiveThreadResult) {
    const _Date = Date;
    tmp6 = importDefault(5076)(channel) > Date.now();
    const tmp9 = importDefault(5076)(channel);
  }
  const obj = {};
  if (!isActiveThreadResult) {
...
obj = {
  ...
  CHANNEL_UPDATES: function handleChannelUpdates(channels) {
    ...
    if (!iter.done) {
      ...
      const result = require(4380) /* shouldAgeVerifyForAgeGate */.isChannelContentGated(value);
