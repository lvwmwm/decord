...
// Dependencies: [19, 21, 4444, 8019, 8020, 4877, 4440, 11567, 17301, 11335, 2]
// Exports: default

// Module 17303 (SafetyFlowTaskScreen)
...
export default function SafetyFlowTaskScreen(action) {
  ...
  if (tmp7Result) {
    ...
    obj[2] = tmp2.header;
    obj[3] = subtitle;
    tmp7Result = tmp7(tmp4(4440).Text, obj);
  }
  obj = { children: null };
  items[2] = tmp7Result;
  ...
  if (undefined === footer) {
    ...
    if (tmp7Result) {
      ...
      obj1[2] = onAction;
      obj1[3] = submitting;
      tmp7Result = tmp7(tmp4(11335).ModalActionButton, obj1);
    }
    const obj2 = { children: null };
    items3[1] = tmp7Result;
    obj2[0] = items3;
    footer = tmp3(tmp4(11567).ModalFooter, obj2);
  }
  children[1] = footer;
