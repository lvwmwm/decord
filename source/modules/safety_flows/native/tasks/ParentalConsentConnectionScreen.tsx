...
// Dependencies: [5, 32, 19, 17, 6905, 1874, 6906, 21, 4285, 712, 16829, 16828, 11236, 4711, 16418, 14030, 7259, 589, 14028, 16839, 16823, 3986, 1236, 2547, 4253, 14029, 1959, 16832, 11246, 4693, 16840, 10181, 16841, 4281, 2285, 14031, 2]
// Exports: default

// Module 16838 (ParentalConsentConnectionScreen)
...
export default function ParentalConsentConnectionScreen() {
  ...
  let obj = onTaskComplete(16829);
  onTaskComplete = obj.useOnTaskComplete();
  let obj1 = onTaskComplete(16828);
  ...
  const derivedPendingRequests = onTaskComplete(16839).useDerivedPendingRequests(arr, stateFromStores1);
  const tmp2Result6 = onTaskComplete(16839);
  ...
  const items8 = [closure_10(getLinkCode(16840), {}), ];
  ...
  if (tmp16) {
    ...
    obj6[4] = callback;
    obj6[5] = callback2;
    tmp30Result = tmp30(tmp5(16841), obj6);
  } else {
    ...
    obj9[2] = parsed;
    obj9[3] = getLinkCode;
    items9[1] = tmp30(tmp2(14031).ConnectGuardianCard, obj9);
    obj7[1] = items9;
