...
// Dependencies: [5, 32, 19, 17, 6890, 1874, 6891, 21, 4255, 712, 16810, 16809, 11208, 4681, 16399, 14004, 7231, 589, 14002, 16820, 16804, 3956, 1236, 2517, 4223, 14003, 1959, 16813, 11218, 4663, 16821, 10152, 16822, 4251, 2255, 14005, 2]
// Exports: default

// Module 16819 (ParentalConsentConnectionScreen)
...
export default function ParentalConsentConnectionScreen() {
  ...
  const derivedPendingRequests = onTaskComplete(16820).useDerivedPendingRequests(arr, stateFromStores1);
  const tmp2Result6 = onTaskComplete(16820);
  ...
  const items8 = [closure_10(getLinkCode(16821), {}), ];
  ...
  if (tmp16) {
    ...
    obj3[3] = tmp27;
    obj3[4] = callback1;
    tmp30Result = tmp30(tmp2(10152).ModalActionButton, obj3);
  }
  const tmp14Result = tmp14(obj9.useState(false), 2);
  items8[1] = tmp30Result;
  obj2[1] = items8;
  obj[4] = closure_10(onTaskComplete(11218).ModalFooter, { children: closure_11(onTaskComplete(4663).Stack, obj2) });
  ...
  if (tmp16) {
    ...
    obj6[4] = callback;
    obj6[5] = callback2;
    tmp30Result = tmp30(tmp5(16822), obj6);
  } else {
    ...
    obj9[2] = parsed;
    obj9[3] = getLinkCode;
    items9[1] = tmp30(tmp2(14005).ConnectGuardianCard, obj9);
    obj7[1] = items9;
    tmp30Result = tmp36(View, obj7);
  }
  obj5[2] = tmp30Result;
  obj[5] = closure_10(onTaskComplete(4663).Stack, obj5);
