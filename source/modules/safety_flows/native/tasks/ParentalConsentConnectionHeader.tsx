...
// Dependencies: [19, 17, 1922, 21, 4344, 5306, 712, 1628, 589, 4340, 5866, 1236, 2565, 2]
// Exports: ParentalConsentConnectionNavbar

// Module 17034 (ParentalConsentConnectionNavbar)
import "noop";
...
export const ParentalConsentConnectionNavbar = function ParentalConsentConnectionNavbar() {
  ...
  if (tmp5Result) {
    ...
    tmp5Result = tmp5(require(4340) /* Text */.Text, obj2);
  }
  items1[1] = tmp5Result;
  obj[1] = items1;
