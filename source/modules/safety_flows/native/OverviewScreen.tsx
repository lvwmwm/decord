...
// Function ID: 16828
// Name: OverviewScreen
// Dependencies: [19, 21, 4285, 16828, 1480, 16829, 7757, 7758, 4693, 712, 4281, 1236, 2547, 5649, 7764, 16823, 11246, 16830, 10181, 2]
// Exports: default

// Module 16827 (OverviewScreen)
import set from "set";
...
export default function OverviewScreen() {
  ...
  obj[2] = intl.string(navigation(2547).RRamMH);
  ...
  obj1[2] = intl2.string(navigation(2547).I2Ctk1);
  ...
  const items2 = [callback(task(5649).TableRowGroup, { hasIcons: true, children: mapped }), ];
  const obj5 = { variant: "text-xs/medium", color: "text-muted", children: null };
  const intl3 = tmp2(1236).intl;
  obj5[2] = intl3.string(navigation(2547)["0TnUrG"]);
  ...
  obj7[2] = callback;
  items4[1] = callback(task(10181).ModalActionButton, obj7);
  obj6[0] = items4;
  items3[1] = closure_5(task(11246).ModalFooter, obj6);
  obj3[0] = items3;
  return closure_5(task(7757).ModalScreen, obj3);
};
