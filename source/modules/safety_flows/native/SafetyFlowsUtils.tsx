...
// Dependencies: [5, 19, 1922, 17022, 17024, 4550, 17023, 4062, 9922, 1236, 2565, 1499, 17027, 2]
// Exports: getScreensForTaskType, useOnTaskComplete

// Module 17028 (fetchAndUpdateTask)
...
function navigateToScreenForTask(closure_1, closure_0) {
  if (null == closure_0) {
    ...
    obj.popWithKey(require(17023) /* SAFETY_FLOWS_MODAL_KEY */.SAFETY_FLOWS_MODAL_KEY);
    ...
    const tmp16 = require(17022) /* TaskType */.TASK_TYPE_TO_SCREENS[task_type];
    let tmp5 = null;
    if (null != tmp16) {
      let tmp = tmp16;
...
export const getScreensForTaskType = function getScreensForTaskType(task_type) {
  const tmp3 = require(17022) /* TaskType */.TASK_TYPE_TO_SCREENS[task_type];
  let tmp4 = null;
  if (null != tmp3) {
    let tmp5 = tmp3;
