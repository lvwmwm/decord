...
// Dependencies: [5, 19, 1922, 17031, 17033, 4550, 17032, 4062, 9922, 1236, 2565, 1499, 17036, 2]
// Exports: getScreensForTaskType, useOnTaskComplete

// Module 17037 (fetchAndUpdateTask)
...
export const getScreensForTaskType = function getScreensForTaskType(task_type) {
  const tmp3 = require(17031) /* TaskType */.TASK_TYPE_TO_SCREENS[task_type];
  let tmp4 = null;
  if (null != tmp3) {
    let tmp5 = tmp3;
