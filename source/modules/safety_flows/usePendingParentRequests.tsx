...
// Dependencies: [32, 19, 5798, 1874, 5799, 589, 6258, 11124, 2]
...
export const usePendingRequestListController = function usePendingRequestListController(pendingRequests) {
  ...
  const familyCenterActions = pendingRequests(11124).useFamilyCenterActions(obj);
  ...
  const obj3 = pendingRequests(11124);
