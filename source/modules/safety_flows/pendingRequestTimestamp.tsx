...
// Dependencies: [1236, 2517, 6946, 2]
// Exports: formatPendingRequestSentText

// Module 16823 (SENT_TIMESTAMP_FORMATTER)
...
export const formatPendingRequestSentText = function formatPendingRequestSentText(created_at) {
  return require(6946) /* getEmptyActivityFormatter */.formatLinkTimestamp(Date.parse(created_at), SENT_TIMESTAMP_FORMATTER);
};
