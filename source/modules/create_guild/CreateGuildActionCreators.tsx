...
// Dependencies: [5, 676, 4999, 503, 4088, 2]

// Module 10072 (_createGuildFromTemplate)
import set from "set";
        ...
        try {
          ...
          if (0 === c9) {
            if (arg0 === 1) {
              ...
              obj5[0] = callback2(4999).post(obj1);
              return obj5;
            }
          } else if (1 === tmp7) {
            c8 = 0;
...
const result = require("module_4999").fileFinishedImporting("modules/create_guild/CreateGuildActionCreators.tsx");
