...
// Function ID: 11986
// Name: CreationIntent
// Dependencies: [19, 17, 8430, 676, 21, 4285, 5250, 712, 1480, 4681, 4691, 11956, 698, 5311, 4281, 1236, 5688, 11614, 5948, 2]
// Exports: default

// Module 11985 (CreationIntent)
import set from "set";
...
export default function CreationIntent(arg0) {
  ...
  const tmp14 = require(5948) /* AccountAgeTier10LargeBadge */;
  if (closure_14) {
  ...
  obj4[1] = callback2(require(5688) /* TableRowGroupTitle */.TableRowGroup, tmp16);
