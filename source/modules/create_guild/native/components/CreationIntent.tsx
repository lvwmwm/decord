...
// Function ID: 11886
// Name: CreationIntent
// Dependencies: [19, 17, 8617, 676, 21, 4661, 6370, 712, 1500, 4721, 4731, 11856, 698, 6803, 4734, 1236, 6286, 11491, 5447, 2]
// Exports: default
...
export default function CreationIntent(arg0) {
  ...
  items2[1] = callback(require(4734) /* Text */.Text, obj3);
  obj1[1] = items2;
  ...
  const tmp14 = require(5447) /* AccountAgeTier10LargeBadge */;
  if (closure_14) {
  ...
  obj4[1] = callback2(require(6286) /* TableRowGroupTitle */.TableRowGroup, tmp16);
  ...
  items3[2] = callback(require(4734) /* Text */.Text, obj9);
  obj[1] = items3;
