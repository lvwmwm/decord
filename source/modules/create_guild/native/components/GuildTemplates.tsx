...
// Dependencies: [57, 31, 27, 11773, 9199, 653, 33, 4165, 5118, 689, 4161, 1212, 1456, 1557, 4578, 11749, 675, 10055, 11777, 5155, 5536, 2]
// Exports: default

// Module 11776 (GuildTemplatesHeader)
...
function GuildTemplatesHeader() {
  ...
  const items = [callback3(require(4161) /* Text */.Text, obj), ];
...
function GuildTemplatesJoinFooter(trigger) {
  ...
  const items2 = [callback3(trigger(4161).Text, obj1), ];
  const obj2 = {
    variant: "primary",
    grow: true,
    text: stringResult,
  ...
  items2[1] = callback3(trigger(4578).Button, obj2);
  obj.children = items2;
...
function GuildTemplatesItem(guildTemplate) {
  ...
  const obj = {
    Icon: guildTemplate(11777).GUILD_TEMPLATE_ICON_COMPONENTS[guildTemplate.id],
    message: guildTemplate.label,
    onPress() {
      return onGuildTemplatePress(guildTemplate);
    }
  };
  return callback3(onGuildTemplatePress(10055), obj);
}
