...
// Function ID: 11869
// Name: CreateGuild
// Dependencies: [19, 17, 1922, 676, 21, 4448, 712, 4883, 4892, 4894, 4444, 1236, 11333, 7673, 5961, 4896, 7682, 2]
// Exports: default

// Module 11868 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  obj1 = isScreenReaderEnabled(4883);
  ...
  obj[5] = customTitle;
  const items1 = [closure_7(isScreenReaderEnabled(4444).Text, obj), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4444).Text, obj1);
  items1[2] = closure_7(ref(11333), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(7673).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5961).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4444).Text, obj5);
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4896).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(7682), obj8);
        const tmp12Result = ref(7682);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4894).Stack, { children: items1 });
