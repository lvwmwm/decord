...
// Function ID: 11838
// Name: CreateGuild
// Dependencies: [19, 17, 1923, 676, 21, 4446, 712, 4880, 4889, 4891, 4442, 1236, 11304, 7652, 5958, 4893, 7661, 2]
// Exports: default

// Module 11837 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  obj1 = isScreenReaderEnabled(4880);
  ...
  obj[5] = customTitle;
  const items1 = [closure_7(isScreenReaderEnabled(4442).Text, obj), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4442).Text, obj1);
  items1[2] = closure_7(ref(11304), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(7652).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5958).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4442).Text, obj5);
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4893).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(7661), obj8);
        const tmp12Result = ref(7661);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4891).Stack, { children: items1 });
