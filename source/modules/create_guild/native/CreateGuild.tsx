...
// Function ID: 11619
// Name: CreateGuild
// Dependencies: [19, 17, 1874, 676, 21, 4285, 712, 4681, 4691, 4693, 4281, 1236, 11109, 7713, 5650, 4695, 8280, 2]
// Exports: default

// Module 11618 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  let obj1 = isScreenReaderEnabled(4681);
  ...
  obj[5] = customTitle;
  const items1 = [closure_7(isScreenReaderEnabled(4281).Text, obj), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4281).Text, obj1);
  items1[2] = closure_7(ref(11109), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(7713).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5650).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4281).Text, obj5);
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4695).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(8280), obj8);
        const tmp12Result = ref(8280);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4693).Stack, { children: items1 });
