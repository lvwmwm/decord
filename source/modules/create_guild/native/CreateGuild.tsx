...
// Function ID: 10244
// Name: CreateGuild
// Dependencies: [19, 17, 1874, 676, 21, 4255, 712, 4652, 4662, 4664, 4251, 1236, 10244, 7701, 5621, 4666, 9185, 2]
// Exports: default

// Module 10243 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  let obj1 = isScreenReaderEnabled(4652);
  ...
  obj[5] = customTitle;
  const items1 = [closure_7(isScreenReaderEnabled(4251).Text, obj), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4251).Text, obj1);
  items1[2] = closure_7(ref(10244), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(7701).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5621).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4251).Text, obj5);
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4666).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(9185), obj8);
        const tmp12Result = ref(9185);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4664).Stack, { children: items1 });
