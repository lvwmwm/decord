...
// Function ID: 11767
// Name: CreateGuild
// Dependencies: [19, 17, 1922, 676, 21, 4344, 712, 4740, 4750, 4752, 4340, 1236, 11256, 7831, 5807, 4754, 8514, 2]
// Exports: default

// Module 11766 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  let obj1 = isScreenReaderEnabled(4740);
  ...
  obj[5] = customTitle;
  const items1 = [closure_7(isScreenReaderEnabled(4340).Text, obj), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4340).Text, obj1);
  items1[2] = closure_7(ref(11256), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(7831).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5807).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4340).Text, obj5);
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4754).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(8514), obj8);
        const tmp12Result = ref(8514);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4752).Stack, { children: items1 });
