...
// Function ID: 11765
// Name: CreateGuild
// Dependencies: [19, 17, 1922, 676, 21, 4342, 712, 4741, 4751, 4753, 4338, 1236, 11247, 7835, 5808, 4755, 8518, 2]
// Exports: default

// Module 11764 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  let obj1 = isScreenReaderEnabled(4741);
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(7835).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5808).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4755).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(8518), obj8);
        const tmp12Result = ref(8518);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4753).Stack, { children: items1 });
