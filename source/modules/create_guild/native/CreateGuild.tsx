...
// Function ID: 11819
// Name: CreateGuild
// Dependencies: [19, 17, 1922, 676, 21, 4445, 712, 4867, 4876, 4878, 4441, 1236, 11285, 7638, 5945, 4880, 7647, 2]
// Exports: default

// Module 11818 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  obj1 = isScreenReaderEnabled(4867);
  ...
  obj[5] = customTitle;
  const items1 = [closure_7(isScreenReaderEnabled(4441).Text, obj), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4441).Text, obj1);
  items1[2] = closure_7(ref(11285), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(7638).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5945).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4441).Text, obj5);
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4880).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(7647), obj8);
        const tmp12Result = ref(7647);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4878).Stack, { children: items1 });
