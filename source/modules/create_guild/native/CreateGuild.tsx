...
// Function ID: 11591
// Name: CreateGuild
// Dependencies: [19, 17, 1874, 676, 21, 4255, 712, 4651, 4661, 4663, 4251, 1236, 11081, 7685, 5635, 4665, 8252, 2]
// Exports: default

// Module 11590 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  let obj1 = isScreenReaderEnabled(4651);
  ...
  items1[2] = closure_7(ref(11081), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(7685).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5635).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4665).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(8252), obj8);
        const tmp12Result = ref(8252);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4663).Stack, { children: items1 });
