...
// Function ID: 11640
// Name: CreateGuild
// Dependencies: [19, 17, 1903, 676, 21, 4302, 712, 4698, 4708, 4710, 4298, 1236, 11130, 7730, 5708, 4712, 8409, 2]
// Exports: default

// Module 11639 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  let obj1 = isScreenReaderEnabled(4698);
  ...
  obj[5] = customTitle;
  const items1 = [closure_7(isScreenReaderEnabled(4298).Text, obj), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4298).Text, obj1);
  items1[2] = closure_7(ref(11130), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(7730).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5708).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4298).Text, obj5);
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4712).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(8409), obj8);
        const tmp12Result = ref(8409);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4710).Stack, { children: items1 });
