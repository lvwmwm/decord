...
// Function ID: 10102
// Name: CreateGuild
// Dependencies: [19, 17, 1874, 676, 21, 4193, 712, 4590, 4600, 4602, 4189, 1236, 10102, 6730, 5559, 4604, 9008, 2]
// Exports: default
...
export default function CreateGuild(arg0) {
  ...
  let obj1 = isScreenReaderEnabled(4590);
  ...
  obj[5] = customTitle;
  const items1 = [closure_7(isScreenReaderEnabled(4189).Text, obj), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4189).Text, obj1);
  items1[2] = closure_7(ref(10102), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(6730).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5559).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4189).Text, obj5);
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4604).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(9008), obj8);
        const tmp12Result = ref(9008);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4602).Stack, { children: items1 });
