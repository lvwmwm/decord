...
// Function ID: 11975
// Name: CreateGuild
// Dependencies: [19, 17, 1922, 676, 21, 4444, 712, 4866, 4875, 4877, 4440, 1236, 11430, 8002, 5940, 4879, 8694, 2]
// Exports: default

// Module 11974 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  obj1 = isScreenReaderEnabled(4866);
  ...
  obj[5] = customTitle;
  const items1 = [closure_7(isScreenReaderEnabled(4440).Text, obj), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4440).Text, obj1);
  items1[2] = closure_7(ref(11430), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(8002).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5940).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4440).Text, obj5);
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4879).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(8694), obj8);
        const tmp12Result = ref(8694);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4877).Stack, { children: items1 });
