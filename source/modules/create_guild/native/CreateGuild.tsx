...
// Function ID: 11782
// Name: CreateGuild
// Dependencies: [19, 17, 1922, 676, 21, 4342, 712, 4763, 4773, 4775, 4338, 1236, 11264, 7856, 5829, 4777, 8540, 2]
// Exports: default

// Module 11781 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  let obj1 = isScreenReaderEnabled(4763);
  ...
  obj[5] = customTitle;
  const items1 = [closure_7(isScreenReaderEnabled(4338).Text, obj), , , , , , , ];
  ...
  items1[2] = closure_7(ref(11264), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  obj3[5] = autoFocus;
  items1[3] = closure_7(isScreenReaderEnabled(7856).TextInput, obj3);
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5829).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4338).Text, obj5);
  ...
  obj7[4] = onCreate;
  obj7[5] = submitting;
  items1[6] = closure_7(isScreenReaderEnabled(4777).Button, obj7);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(8540), obj8);
        const tmp12Result = ref(8540);
      }
    }
  }
  items1[7] = tmp9Result;
  obj[6] = closure_8(isScreenReaderEnabled(4775).Stack, { children: items1 });
