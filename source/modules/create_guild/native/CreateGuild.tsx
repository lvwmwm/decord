...
// Function ID: 11625
// Name: CreateGuild
// Dependencies: [19, 17, 1903, 676, 21, 4285, 712, 4681, 4691, 4693, 4281, 1236, 11115, 7713, 5689, 4695, 8392, 2]
// Exports: default

// Module 11624 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  items1[2] = closure_7(ref(11115), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(5689).TableSwitchRow, obj4);
  }
  items1[4] = tmp9Result;
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        obj8[0] = message2;
        tmp9Result = tmp9(ref(8392), obj8);
        const tmp12Result = ref(8392);
      }
    }
  }
  items1[7] = tmp9Result;
