...
// Dependencies: [19, 17, 1376, 1936, 676, 5835, 21, 4255, 712, 5189, 5717, 38, 1581, 1937, 4251, 1236, 11081, 8248, 4665, 7302, 1297, 12, 8865, 11086, 11087, 9590, 688, 2]
// Exports: default

// Module 11080 (GuildTemplateResolving)
import "Divider";
...
function GuildTemplateResolving() {
  return callback(closure_4, { style: createCacheKey().resolvingContainer, children: callback(require(5717) /* ActivityIndicator */.ActivityIndicator, {}) });
}
function GuildTemplateResolved(guildTemplate) {
  ...
  items1[2] = callback(importDefault(11081), { iconBackgroundColor: tmp.wrapper.backgroundColor, style: tmp.iconUploader, onPress: chooseIcon, icon });
  ...
  obj2[3] = name;
  obj2[4] = setName;
  items1[3] = callback(importDefault(8248), obj2);
  ...
  obj4[1] = callback(guildTemplate(4665).Button, obj5);
  items1[4] = callback(closure_4, obj4);
  items1[5] = callback(importDefault(7302), { style: tmp.divider, outer: true });
