...
// Dependencies: [19, 17, 1395, 1987, 676, 6136, 21, 4446, 712, 5426, 6013, 1297, 11300, 1236, 38, 1629, 1988, 4442, 11304, 7651, 4893, 8315, 12, 9622, 11309, 11310, 10622, 688, 2]
// Exports: default

// Module 11299 (GuildTemplateResolving)
...
import getInvalidLinkSource from "getInvalidLinkSource" /* 11300 */;
import renderIconDefault from "renderIcon" /* 11304 */;
...
function GuildTemplateResolved(guildTemplate) {
  ...
  obj2[3] = name;
  obj2[4] = setName;
  items1[3] = callback(_modDef7651, obj2);
  ...
  obj4[1] = callback(guildTemplate(4893).Button, obj5);
  ...
  items1[6] = callback(guildTemplate(4442).Text, obj7);
  ...
  items1[7] = callback(guildTemplate(4442).Text, obj8);
  ...
  obj10[3] = items3;
  items1[9] = closure_12(guildTemplate(4442).Text, obj10);
  let tmp7Result = null;
  if (found.length > 0) {
    ...
    const items4 = [tmp9(tmp10(4442).Text, obj13), , ];
    ...
    items4[1] = tmp9(tmp10(4442).Text, obj14);
