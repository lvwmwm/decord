...
// Dependencies: [19, 17, 1376, 1965, 676, 5881, 21, 4302, 712, 5235, 5763, 1297, 11128, 1236, 38, 1609, 1966, 4298, 11130, 8405, 4712, 7349, 12, 8911, 11135, 11136, 9635, 688, 2]
// Exports: default

// Module 11127 (GuildTemplateResolving)
...
import importAllResult from "module_8405";
...
function GuildTemplateResolving() {
  return callback(closure_4, { style: callback2().resolvingContainer, children: callback(require(5763) /* ActivityIndicator */.ActivityIndicator, {}) });
}
function GuildTemplateResolved(guildTemplate) {
  ...
  const items1 = [callback(guildTemplate(4298).Text, obj), , , , , , , , , , ];
  obj = { style: tmp.description, variant: "text-lg/medium", color: "text-default", children: guildTemplate.name };
  items1[1] = callback(guildTemplate(4298).Text, obj);
  items1[2] = callback(importDefault(11130), { iconBackgroundColor: tmp.wrapper.backgroundColor, style: tmp.iconUploader, onPress: chooseIcon, icon });
  ...
  obj2[3] = name;
  obj2[4] = setName;
  items1[3] = callback(importDefault(8405), obj2);
  ...
  obj4[1] = callback(guildTemplate(4712).Button, obj5);
  items1[4] = callback(closure_4, obj4);
  items1[5] = callback(importDefault(7349), { style: tmp.divider, outer: true });
  ...
  items1[6] = callback(guildTemplate(4298).Text, obj7);
  ...
  items1[7] = callback(guildTemplate(4298).Text, obj8);
  ...
  obj10[3] = items3;
  items1[9] = closure_12(guildTemplate(4298).Text, obj10);
  let tmp7Result = null;
  if (found.length > 0) {
    ...
    const items4 = [tmp9(tmp10(4298).Text, obj13), , ];
    ...
    items4[1] = tmp9(tmp10(4298).Text, obj14);
...
let closure_16 = importAllResult.memo(() => {
  ...
  obj[0] = require(11128) /* getInvalidLinkSource */.InvalidLink;
