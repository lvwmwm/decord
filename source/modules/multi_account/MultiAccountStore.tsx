...
// Function ID: 11701
// Name: initialize
// Dependencies: [11701, 11702, 707, 11703, 589, 709, 2]
...
obj = {
  ...
  MULTI_ACCOUNT_MOVE_ACCOUNT: function handleMoveAccount(arg0) {
    ...
    let to;
    ({ from, to } = arg0);
    closure_8 = require(11703) /* calculatePositionDeltas */.moveItemFromTo(closure_8, from, to);
  },
