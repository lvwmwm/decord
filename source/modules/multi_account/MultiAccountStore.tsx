...
// Function ID: 11667
// Name: initialize
// Dependencies: [11667, 11668, 707, 11669, 589, 709, 2]

// Module 11666 (initialize)
...
obj = {
  ...
  MULTI_ACCOUNT_MOVE_ACCOUNT: function handleMoveAccount(arg0) {
    ...
    let to;
    ({ from, to } = arg0);
    closure_8 = require(11669) /* calculatePositionDeltas */.moveItemFromTo(closure_8, from, to);
  },
