...
// Function ID: 11505
// Name: initialize
// Dependencies: [11505, 11506, 707, 11507, 589, 709, 2]
...
obj = {
  ...
  MULTI_ACCOUNT_MOVE_ACCOUNT: function handleMoveAccount(arg0) {
    ...
    let to;
    ({ from, to } = arg0);
    closure_8 = require(11507) /* calculatePositionDeltas */.moveItemFromTo(closure_8, from, to);
  },
