...
// Dependencies: [19, 17, 1930, 4188, 1922, 11840, 21, 4342, 589, 4303, 712, 4298, 4338, 1236, 4887, 4073, 1297, 4187, 2]
// Exports: default

// Module 15164 (AccountStatusIcon)
import "noop";
...
export default function AccountSwitcherListItem(arg0) {
  ...
  if (user.id === id) {
    if (showActiveAccountLabel) {
      ...
      let tmp8 = callback(tmp2(4338).Text, obj);
    }
    if (null == onPressUser) {
    ...
    obj7[1] = str;
    obj6[4] = importDefault(4187).getUserTag(obj2, obj7);
    ...
    if (tmp18Result) {
      ...
      tmp18Result = tmp18(tmp2(4338).Text, obj8);
    }
  ...
  if (user.tokenStatus === MultiAccountTokenStatus.INVALID) {
    ...
    tmp8 = callback(tmp2(4338).Text, obj10);
  }
};
