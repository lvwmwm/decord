...
// Dependencies: [5, 1218, 11785, 676, 3, 707, 709, 530, 698, 5827, 2]
...
// Module 11789 (validateMultiAccountTokens)
...
export const switchAccount = function switchAccount(id, switchSynchronously, CHOOSE_ACCOUNT) {
  ...
  if (null == token) {
    ...
    resolved = importDefault(5827).switchAccountToken(token, switchSynchronously);
    const tmp5Result = importDefault(5827);
  }
  return resolved;
};
