...
// Function ID: 10253
// Name: _setUserStatus
// Dependencies: [5, 5131, 4867, 676, 4028, 1236, 10253, 1355, 1337, 4004, 698, 2]
// Exports: default

// Module 10252 (_setUserStatus)
      ...
      if (globalStats === 2) {
        ...
        try {
          ...
          if (0 === c3) {
            ...
            const AccessibilityAnnouncer = callback(4004).AccessibilityAnnouncer;
