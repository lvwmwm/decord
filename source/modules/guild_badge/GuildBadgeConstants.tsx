...
// Dependencies: [8438, 1212, 8439, 2]
// Exports: getBadgeTooltip

// Module 8437 (getBadgeTooltip)
...
export const getBadgeTooltip = function getBadgeTooltip(arg0, arg1) {
  if (arg1 === require(8438) /* isPremiumGuild */.GuildVisibility.PUBLIC) {
    const intl3 = require(1212) /* getSystemLocale */.intl;
    let stringResult = intl3.string(require(1212) /* getSystemLocale */.t.op2cJ6);
  } else if (arg1 === require(8438) /* isPremiumGuild */.GuildVisibility.APPLY_TO_JOIN) {
  ...
  if (require(8439) /* BadgeCategory */.BadgeCategory.STAFF === arg0) {
    let obj = {};
    ...
    return obj;
  } else if (require(8439) /* BadgeCategory */.BadgeCategory.VERIFIED === arg0) {
    obj = {};
    ...
    return obj;
  } else if (require(8439) /* BadgeCategory */.BadgeCategory.PARTNERED === arg0) {
    const obj1 = {};
    ...
    return obj1;
  } else if (require(8439) /* BadgeCategory */.BadgeCategory.VERIFIED_AND_PARTNERED === arg0) {
    const obj2 = {};
    ...
    return obj2;
  } else if (require(8439) /* BadgeCategory */.BadgeCategory.COMMUNITY === arg0) {
    const obj3 = {};
    const intl7 = require(1212) /* getSystemLocale */.intl;
    obj3.tooltipTitle = intl7.string(require(1212) /* getSystemLocale */.t.K7iRig);
    obj3.tooltipDescription = stringResult;
    return obj3;
  } else if (require(8439) /* BadgeCategory */.BadgeCategory.DISCOVERABLE === arg0) {
    const obj4 = {};
