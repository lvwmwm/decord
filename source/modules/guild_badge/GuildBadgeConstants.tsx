...
// Dependencies: [8459, 1236, 8460, 2]
// Exports: getBadgeTooltip

// Module 8458 (getBadgeTooltip)
...
export const getBadgeTooltip = function getBadgeTooltip(arg0, arg1) {
  if (arg1 === require(8459) /* GuildVisibility */.GuildVisibility.PUBLIC) {
    const intl3 = tmp(1236).intl;
    let stringResult = intl3.string(tmp(1236).t.op2cJ6);
  } else if (arg1 === tmp(8459).GuildVisibility.APPLY_TO_JOIN) {
  ...
  if (require(8460) /* BadgeCategory */.BadgeCategory.STAFF === arg0) {
    ...
    return obj;
  } else if (tmp(8460).BadgeCategory.VERIFIED === arg0) {
    ...
    obj[2] = stringResult;
    return obj;
  } else if (tmp(8460).BadgeCategory.PARTNERED === arg0) {
    ...
    obj1[2] = stringResult;
    return obj1;
  } else if (tmp(8460).BadgeCategory.VERIFIED_AND_PARTNERED === arg0) {
