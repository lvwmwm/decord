...
export const useCanUseGuildSpace = function useCanUseGuildSpace(id, useGuildActionRows) {
  ...
  const guildSpaceExperimentEnabled = stateFromStores(7165).useGuildSpaceExperimentEnabled(id, useGuildActionRows);
