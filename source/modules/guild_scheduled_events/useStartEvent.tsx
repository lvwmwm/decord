...
// Function ID: 8334
// Name: useStartEvent
// Dependencies: [5, 32, 19, 8334, 8335, 4088, 2]
// Exports: default

// Module 8333 (useStartEvent)
          ...
          try {
            ...
            if (0 === c7) {
              ...
              if (arg0 === 1) {
                ...
                obj2[0] = callback2(8334).preStartEventActions(callback, permissionOverwrites);
                return obj2;
              }
            } else {
              if (2 === tmp7) {
                c6 = 0;
                const outer1_5 = noop;
                const aPIError = new callback(4088).APIError(outer1_5);
