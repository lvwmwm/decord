...
// Function ID: 9740
// Name: useStartEvent
// Dependencies: [5, 32, 19, 9740, 9741, 4379, 2]
// Exports: default

// Module 9739 (useStartEvent)
          ...
          try {
            ...
            if (0 === c7) {
              ...
              if (arg0 === 1) {
                ...
                obj2[0] = callback2(9740).preStartEventActions(callback, permissionOverwrites);
                return obj2;
              }
            } else {
              if (2 === tmp7) {
                c6 = 0;
                aPIError = new callback(4379).APIError(closure_5);
                callback2(aPIError);
                callback(false);
                callback(false);
                c8 = 3;
