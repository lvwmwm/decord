...
// Function ID: 8337
// Name: useStartEvent
// Dependencies: [5, 32, 19, 8337, 8338, 4088, 2]
// Exports: default

// Module 8336 (useStartEvent)
          ...
          try {
            ...
            if (0 === c7) {
              ...
              if (arg0 === 1) {
                ...
                obj2[0] = callback2(8337).preStartEventActions(callback, permissionOverwrites);
                return obj2;
              }
            } else {
              if (2 === tmp7) {
