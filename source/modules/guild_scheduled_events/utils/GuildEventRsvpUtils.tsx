...
// Dependencies: [1194, 6758, 1354, 1212, 8395, 8396, 8390, 2]
// Exports: getResponseOptions, handleRsvp

// Module 8394 (getExistingRsvp)
...
export const handleRsvp = function handleRsvp(openRsvpPicker) {
  ...
  if (null != guildScheduledEvent) {
    const eventException = require(8395) /* _getEventException */.getEventException(recurrenceId, eventId);
    const obj3 = require(8395) /* _getEventException */;
    ...
    if (null != scheduled_start_time) {
      ...
      recurrenceStatus = require(8390) /* getNextBucketedTime */.getRecurrenceStatus(eventException, obj4.getEventSchedule(guildScheduledEvent, recurrenceId).startTime, _Date);
      const obj = require(8390) /* getNextBucketedTime */;
    }
    if (null == recurrenceStatus) {
      if (null == recurrenceId) {
        recurrenceId = require(8390) /* getNextBucketedTime */.getNextRecurrenceIdInEvent(guildScheduledEvent);
    ...
    obj4 = require(8396) /* _getEventSchedule */;
  }
};
