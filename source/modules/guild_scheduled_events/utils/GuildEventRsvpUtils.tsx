...
export const handleRsvp = function handleRsvp(openRsvpPicker) {
  ...
  if (null != guildScheduledEvent) {
    const eventException = require(8153) /* _getEventException */.getEventException(recurrenceId, eventId);
    const obj3 = require(8153) /* _getEventException */;
    ...
    if (null != scheduled_start_time) {
      ...
      recurrenceStatus = require(8148) /* getNextBucketedTime */.getRecurrenceStatus(eventException, obj4.getEventSchedule(guildScheduledEvent, recurrenceId).startTime, _Date);
      const obj = require(8148) /* getNextBucketedTime */;
    }
    if (null == recurrenceStatus) {
      if (null == recurrenceId) {
        recurrenceId = require(8148) /* getNextBucketedTime */.getNextRecurrenceIdInEvent(guildScheduledEvent);
    ...
    obj4 = require(8154) /* _getEventSchedule */;
  }
};
