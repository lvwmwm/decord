...
// Dependencies: [1218, 6906, 1378, 1236, 8870, 8871, 8865, 2]
// Exports: getExistingRsvp, getResponseOptions, handleRsvp

// Module 8869 (getExistingRsvp)
...
export const handleRsvp = function handleRsvp(openRsvpPicker) {
  ...
  if (null != guildScheduledEvent) {
    const eventException = require(8870) /* useEventException */.getEventException(recurrenceId, eventId);
    const obj4 = require(8870) /* useEventException */;
    ...
    obj5 = require(8871) /* useEventSchedule */;
  }
};
