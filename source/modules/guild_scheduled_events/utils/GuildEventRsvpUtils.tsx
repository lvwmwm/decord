...
// Dependencies: [1194, 5761, 1354, 1212, 8191, 8192, 8186, 2]
// Exports: getResponseOptions, handleRsvp

// Module 8190 (getExistingRsvp)
...
let closure_5;
const require = arg1;
function getExistingRsvp(id, outer1_1) {
  return store.getRsvp(id, outer1_1, id.getId());
}
...
export const handleRsvp = function handleRsvp(openRsvpPicker) {
  ...
  if (null != guildScheduledEvent) {
    const eventException = require(8191) /* _getEventException */.getEventException(recurrenceId, eventId);
    const obj3 = require(8191) /* _getEventException */;
    ...
    if (null != scheduled_start_time) {
      ...
      recurrenceStatus = require(8186) /* getNextBucketedTime */.getRecurrenceStatus(eventException, obj4.getEventSchedule(guildScheduledEvent, recurrenceId).startTime, _Date);
      const obj = require(8186) /* getNextBucketedTime */;
    }
    if (null == recurrenceStatus) {
      if (null == recurrenceId) {
        recurrenceId = require(8186) /* getNextBucketedTime */.getNextRecurrenceIdInEvent(guildScheduledEvent);
    ...
    obj4 = require(8192) /* _getEventSchedule */;
  }
};
