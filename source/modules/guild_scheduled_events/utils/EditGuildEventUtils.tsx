...
// Dependencies: [1218, 1397, 8987, 8990, 2]
...
// Module 8986 (EditGuildEventScreens)
...
export const getInitialGuildEventData = function getInitialGuildEventData(initialGuildEvent, targetChannel) {
  ...
  if (scheduled_start_time == null) {
    const initialEventStartDate = require(8987) /* getRRule */.getInitialEventStartDate();
  ...
  if (tmp23) {
    ...
    if (entity_type1 === constants.EXTERNAL) {
      const locationFromEvent = require(8990) /* getChannelFromEvent */.getLocationFromEvent(initialGuildEvent);
      if (null != locationFromEvent) {
        obj = { location: null };
        obj[0] = locationFromEvent;
        obj.entityMetadata = obj;
      }
      const obj7 = require(8990) /* getChannelFromEvent */;
    }
    return obj;
  }
  if (tmp26) {
