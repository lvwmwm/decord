...
// Dependencies: [1218, 1378, 8865, 8868, 2]
...
// Module 8864 (EditGuildEventScreens)
...
export const getInitialGuildEventData = function getInitialGuildEventData(initialGuildEvent, targetChannel) {
  ...
  if (scheduled_start_time == null) {
    const initialEventStartDate = require(8865) /* getRRule */.getInitialEventStartDate();
  ...
  if (tmp23) {
    ...
    if (entity_type1 === constants.EXTERNAL) {
      const locationFromEvent = require(8868) /* getChannelFromEvent */.getLocationFromEvent(initialGuildEvent);
      if (null != locationFromEvent) {
        obj = { location: null };
        obj[0] = locationFromEvent;
        obj.entityMetadata = obj;
      }
      const obj7 = require(8868) /* getChannelFromEvent */;
    }
    return obj;
  }
  if (tmp26) {
