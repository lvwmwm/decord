...
// Function ID: 9666
// Name: getRRule
// Dependencies: [1371, 9666, 1963, 9667, 1114, 4153, 4242, 11, 1090, 12, 2]
...
import { RecurrenceOptions } from "RecurrenceOptions" /* 9666 */;
...
export const recurrenceOptionToRecurrenceRule = function recurrenceOptionToRecurrenceRule(c7, toDate) {
  ...
  if (RecurrenceOptions.NONE !== c7) {
    if (tmp8.WEEKLY === c7) {
      ...
      obj1[1] = tmp4(9667).RRule.MONTHLY;
