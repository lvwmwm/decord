...
// Function ID: 9556
// Name: getRRule
// Dependencies: [1922, 9556, 1397, 9557, 1236, 4043, 4131, 11, 687, 12, 2]
...
import m from "m" /* 9557 */;
import closure_3 from "mergeGuildAvatar" /* 1922 */;
import { RecurrenceOptions } from "RecurrenceOptions" /* 9556 */;
      ...
      if (uTCHours === date1.getUTCHours()) {
        ...
        if (uTCMinutes === date1.getUTCMinutes()) {
          ...
          if (uTCSeconds === date1.getUTCSeconds()) {
            ...
            } else if (tmp(9557).RRule.YEARLY === frequency) {
...
export const recurrenceOptionToRecurrenceRule = function recurrenceOptionToRecurrenceRule(c7, toDate) {
  ...
  if (RecurrenceOptions.NONE !== c7) {
    if (tmp8.WEEKLY === c7) {
      ...
      obj[0] = toDateResult2;
      obj[1] = tmp4(9557).RRule.WEEKLY;
      rRule = new tmp4(9557).RRule(obj);
...
export const recurrenceRuleToOption = function recurrenceRuleToOption(startDate, recurrenceRule) {
  if (null == recurrenceRule) {
    ...
    } else if (tmp14(9557).RRule.YEARLY === freq) {
      return RecurrenceOptions.YEARLY;
    } else if (tmp14(9557).RRule.MONTHLY === freq) {
      return RecurrenceOptions.MONTHLY;
    } else if (tmp14(9557).RRule.DAILY === freq) {
