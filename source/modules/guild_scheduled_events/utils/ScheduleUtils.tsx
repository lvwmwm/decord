...
// Function ID: 9648
// Name: getRRule
// Dependencies: [1921, 9648, 1392, 9649, 1233, 4074, 4163, 11, 684, 12, 2]
...
import m from "m" /* 9649 */;
import closure_3 from "mergeGuildAvatar" /* 1921 */;
import { RecurrenceOptions } from "RecurrenceOptions" /* 9648 */;
      ...
      if (uTCHours === date1.getUTCHours()) {
        ...
        if (uTCMinutes === date1.getUTCMinutes()) {
          ...
          if (uTCSeconds === date1.getUTCSeconds()) {
            ...
            } else if (tmp(9649).RRule.YEARLY === frequency) {
...
export const recurrenceOptionToRecurrenceRule = function recurrenceOptionToRecurrenceRule(c7, toDate) {
  ...
  if (RecurrenceOptions.NONE !== c7) {
    if (tmp8.WEEKLY === c7) {
      ...
      obj[0] = toDateResult2;
      obj[1] = tmp4(9649).RRule.WEEKLY;
      rRule = new tmp4(9649).RRule(obj);
...
export const recurrenceRuleToOption = function recurrenceRuleToOption(startDate, recurrenceRule) {
  if (null == recurrenceRule) {
    ...
    } else if (tmp14(9649).RRule.YEARLY === freq) {
      return RecurrenceOptions.YEARLY;
    } else if (tmp14(9649).RRule.MONTHLY === freq) {
      return RecurrenceOptions.MONTHLY;
    } else if (tmp14(9649).RRule.DAILY === freq) {
