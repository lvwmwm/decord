...
// Dependencies: [19, 21, 4683, 1236, 2]
// Exports: default

// Module 8929 (EditGuildScheduledEventResetWarningAlert)
import "noop";
...
export default function EditGuildScheduledEventResetWarningAlert(arg0) {
  ...
  obj[5] = importDefault(4683).Colors.GREEN;
  const intl4 = require(1236) /* getSystemLocale */.intl;
  obj[6] = intl4.string(require(1236) /* getSystemLocale */.t["ETE/oC"]);
  return jsx(importDefault(4683), { onClose, onConfirm, title: null, body: null, confirmText: null, confirmColor: null, cancelText: null });
};
