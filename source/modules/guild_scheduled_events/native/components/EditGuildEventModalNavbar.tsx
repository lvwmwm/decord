...
// Dependencies: [32, 19, 17, 21, 4303, 8941, 1351, 5328, 4299, 1236, 6008, 8027, 2]
// Exports: default

// Module 8964 (EditGuildEventModalNavbar)
...
export default function EditGuildEventModalNavbar(screen) {
  ...
  const tmp = callback4();
  if (require(8941) /* EditGuildEventScreens */.EditGuildEventScreens.CHANNEL_SELECTOR === screen) {
    let items = [1, 3];
  ...
  obj3[2] = importDefault(8027);
  obj3[3] = tmp.rightButton;
  obj2[1] = callback2(require(6008) /* HeaderActionButton */.HeaderActionButton, obj3);
