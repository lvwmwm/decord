...
// Module 8392 (EditGuildEventWhere)
...
export default function EditGuildEventWhere(guild) {
  ...
  items5[3] = hasItem;
  if (stateFromStores1) {
    const obj7 = { Promise: "xs", marginTop: "interactive-text-default", flags: "md", style: tmp.text };
