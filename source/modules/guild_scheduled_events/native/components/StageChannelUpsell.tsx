...
// Dependencies: [32, 19, 17, 1376, 8930, 8890, 676, 21, 4302, 712, 4844, 1297, 7967, 8931, 4298, 1236, 4712, 4507, 8932, 1988, 4270, 2]
// Exports: default

// Module 8929 (StageChannelUpsell)
...
export default function StageChannelUpsell(arg0) {
  ...
  if (!tmp2[0]) {
    ...
    const items = [callback3(require(4844) /* PressableBase */.PressableOpacity, obj), , , , , ];
    const obj1 = { source: null, style: null };
    obj1[0] = importDefault(8931);
    obj1[1] = tmp.image;
    ...
    items[2] = callback3(require(4298) /* Text */.Text, obj2);
    ...
    items[3] = callback3(require(4298) /* Text */.Text, obj3);
    ...
    items[4] = callback3(require(4298) /* Text */.Text, obj4);
    ...
    obj6[1] = callback3(require(4712) /* Button */.Button, obj7);
