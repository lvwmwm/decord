...
// Dependencies: [32, 19, 17, 1376, 8912, 8872, 676, 21, 4285, 712, 4812, 1297, 7837, 8913, 4281, 1236, 4695, 4490, 8914, 1959, 4253, 2]
// Exports: default

// Module 8911 (StageChannelUpsell)
...
export default function StageChannelUpsell(arg0) {
  ...
  if (!tmp2[0]) {
    ...
    const items = [callback3(require(4812) /* PressableBase */.PressableOpacity, obj), , , , , ];
    const obj1 = { source: null, style: null };
    obj1[0] = importDefault(8913);
    obj1[1] = tmp.image;
    ...
    items[2] = callback3(require(4281) /* Text */.Text, obj2);
    ...
    items[3] = callback3(require(4281) /* Text */.Text, obj3);
    ...
    items[4] = callback3(require(4281) /* Text */.Text, obj4);
    ...
    obj6[1] = callback3(require(4695) /* Button */.Button, obj7);
