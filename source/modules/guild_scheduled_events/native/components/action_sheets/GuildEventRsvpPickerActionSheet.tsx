...
// Dependencies: [32, 19, 17, 1392, 21, 4481, 709, 9635, 1233, 7090, 7089, 7063, 5640, 5643, 4936, 9627, 4448, 2]
// Exports: default

// Module 9748 (GuildEventRsvpPickerActionSheet)
...
export default function GuildEventRsvpPickerActionSheet(event) {
  ...
  closure_5 = undefined;
  let tmp = callback4();
  const tmp4 = callback(first.useState(event(9635).ResponseOptions.SERIES), 2);
  first = tmp4[0];
  let obj = event(9635);
  ...
  obj2[1] = callback2(event(4936).Button, obj3);
  items[1] = callback2(closure_5, obj2);
  obj[2] = items;
  obj[1] = callback3(event(7063).SafeAreaPaddingView, obj);
  return callback2(event(7090).BottomSheet, obj);
};
