...
// Dependencies: [19, 17, 4121, 4130, 1922, 7271, 676, 21, 4478, 712, 6229, 9696, 9682, 4674, 589, 4981, 9684, 9685, 1236, 4474, 5068, 1891, 9699, 9668, 4445, 9364, 2009, 1297, 9681, 2]
// Exports: default

// Module 9698 (EditGuildEventChannelSelection)
...
export default function EditGuildEventChannelSelection(guild) {
  ...
  items6[2] = callback(guild(1297).Icon, { source: channel(9681) });
  obj1[6] = items6;
  items4[1] = closure_12(guild(5068).PressableOpacity, obj1);
  obj[1] = items4;
