...
// Dependencies: [5, 32, 19, 21, 4661, 712, 8790, 8785, 8798, 1892, 8806, 4745, 1236, 8807, 8784, 8808, 8809, 4734, 6312, 2]
// Exports: default
...
export default function EditGuildEventRecurrenceModal(guildEvent) {
  ...
  const tmp2 = importDefault(8790)(recurrenceId, guildEvent.id);
  dependencyMap = tmp2;
  ...
  first = tmp6[0];
  closure_8 = tmp6[1];
  const tmp8 = callback(importDefault(8798)(() => {
