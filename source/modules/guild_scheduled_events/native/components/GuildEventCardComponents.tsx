...
// Dependencies: [5, 32, 19, 17, 1218, 1372, 1942, 1862, 3821, 1874, 5784, 1378, 676, 505, 21, 4193, 712, 8230, 8232, 6685, 1236, 8233, 5547, 3893, 12258, 4138, 589, 8270, 8973, 4145, 10243, 12291, 8214, 5109, 6693, 12292, 4533, 8212, 4622, 4403, 1351, 1474, 1416, 12290, 8224, 1297, 4707, 4129, 8219, 8220, 12293, 4721, 4189, 8331, 8321, 4384, 8217, 8319, 8320, 5570, 2]
...
export const GuildEventShareAction = function GuildEventShareAction(event) {
  ...
  let importDefault;
  let dependencyMap;
  const tmp3 = importDefault(8230)(event);
  importDefault = tmp3;
  let obj = event(8232);
  ...
  obj[2] = importDefault(tmp3 ? 12258 : 4138);
  return closure_22(event(6685).IconButton, obj);
};
...
export const GuildEventIndicateInterestAction = function GuildEventIndicateInterestAction(event) {
  ...
  if (first) {
    let BellIcon = tmp(4145).CheckmarkLargeIcon;
  } else {
    BellIcon = tmp(10243).BellIcon;
  }
  obj = { accessibilityRole: "togglebutton", accessibilityState: { checked: first }, accessibilityLabel: null, variant: null, icon: null, text: null, onPress: null, grow: true };
  ...
  obj[6] = tmp3[1];
  return callback4(importDefault(12291), obj);
};
...
export const GuildEventCardImageHeader = function GuildEventCardImageHeader(event) {
  ...
  if (null == event.image) {
    ...
    obj[1] = obj.makeSource(tmp2(12290)(event, width));
...
export const GuildEventCardHeader = function GuildEventCardHeader(event) {
  ...
  let obj = importDefault(8219)(recurrenceId, id);
  if (obj == null) {
    obj = {};
  }
  const is_canceled = obj.is_canceled;
  const tmp8 = tmp2(8220)(event, recurrenceId);
  ...
  if (showUserCount) {
    ...
    if (!flag2) {
      ...
      obj2[2] = tmp18;
      tmp16Result = tmp16(tmp13(4721).PressableOpacity, obj2);
    }
    tmp15 = tmp16Result;
    tmp16 = callback4;
  }
  const tmp5 = importDefault(8219);
  ...
  if (flag4) {
    ...
    obj6[1] = color;
    obj6[2] = tmp.dateIcon;
    tmp25Result = tmp25(tmp13(8331).CalendarIcon, obj6);
    tmp27 = tmp25;
  }
  ...
  obj7[1] = tmp27(event(4189).Text, obj9);
...
export const GuildEventSimpleLocation = function GuildEventSimpleLocation(event) {
  ...
  const tmp7 = stateFromStores(4384)(stateFromStores);
  let obj2 = channel_id(8217);
  ...
  if (null != stateFromStores) {
    ...
    let combined = stateFromStores(8320)(obj2);
  ...
  obj1[4] = result;
  items4[1] = callback4(channel_id(4189).Text, obj1);
  obj[1] = items4;
...
export const GuildEventCardSimpleGuildInfo = function GuildEventCardSimpleGuildInfo(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    obj[1] = tmp2(5570).GuildIconSizes.XSMALL_20;
    obj[2] = tmp.guildIcon;
    const items3 = [callback4(importDefault(5570), obj), ];
    const obj1 = { style: null, children: null };
    obj1[0] = tmp.guildInfo;
    const obj2 = { variant: "text-sm/semibold", style: null, children: null };
    obj2[1] = textStyle;
    obj2[2] = stateFromStores.name;
    obj1[1] = callback4(tmp2(4189).Text, obj2);
