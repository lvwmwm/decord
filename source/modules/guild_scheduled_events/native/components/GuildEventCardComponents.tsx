...
// Dependencies: [5, 32, 19, 17, 1218, 1372, 1971, 1891, 3912, 1903, 6906, 1378, 676, 505, 21, 4285, 712, 8881, 8883, 7672, 1236, 8884, 5677, 3984, 9016, 4230, 589, 8909, 8528, 4237, 9059, 9060, 8865, 5215, 5878, 9061, 4624, 8863, 4713, 4494, 1351, 1474, 1416, 9058, 8875, 1297, 4798, 4221, 8870, 8871, 9062, 4827, 4281, 8967, 8957, 4475, 8868, 8955, 8956, 5700, 2]
...
// Module 8880 (usePrimaryActionButtonType)
...
export const GuildEventShareAction = function GuildEventShareAction(event) {
  ...
  let importDefault;
  let dependencyMap;
  const tmp3 = importDefault(8881)(event);
  importDefault = tmp3;
  let obj = event(8883);
  ...
  obj[2] = importDefault(tmp3 ? 9016 : 4230);
...
export const GuildEventIndicateInterestAction = function GuildEventIndicateInterestAction(event) {
  ...
  obj[6] = tmp3[1];
  return callback4(importDefault(9060), obj);
};
...
export const GuildEventCardImageHeader = function GuildEventCardImageHeader(event) {
  ...
  if (null == event.image) {
    ...
    obj[1] = obj.makeSource(tmp2(9058)(event, width));
...
export const GuildEventCardHeader = function GuildEventCardHeader(event) {
  ...
  let obj = importDefault(8870)(recurrenceId, id);
  if (obj == null) {
    obj = {};
  }
  const is_canceled = obj.is_canceled;
  const tmp8 = tmp2(8871)(event, recurrenceId);
  ...
  if (showUserCount) {
    ...
    if (!flag2) {
      ...
      obj2[2] = tmp18;
      tmp16Result = tmp16(tmp13(4827).PressableOpacity, obj2);
    }
    tmp15 = tmp16Result;
    tmp16 = callback4;
  }
  const tmp5 = importDefault(8870);
  ...
  if (flag4) {
    ...
    obj6[1] = color;
    obj6[2] = tmp.dateIcon;
    tmp25Result = tmp25(tmp13(8967).CalendarIcon, obj6);
    tmp27 = tmp25;
  }
...
export const GuildEventSimpleLocation = function GuildEventSimpleLocation(event) {
  ...
  let tmp7 = stateFromStores(4475)(stateFromStores);
  let obj2 = channel_id(8868);
  ...
  if (null != stateFromStores) {
    ...
    let combined = stateFromStores(8956)(obj2);
...
export const GuildEventCardSimpleGuildInfo = function GuildEventCardSimpleGuildInfo(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    obj[1] = tmp2(5700).GuildIconSizes.XSMALL_20;
    obj[2] = tmp.guildIcon;
    const items3 = [callback4(importDefault(5700), obj), ];
