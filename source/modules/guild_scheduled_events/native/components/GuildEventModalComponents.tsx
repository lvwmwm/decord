...
// Dependencies: [19, 17, 1397, 676, 21, 4303, 7792, 1236, 8948, 4299, 8669, 1891, 4271, 8974, 2007, 8975, 8976, 8977, 4829, 8978, 8979, 8015, 4825, 7987, 7986, 7978, 3902, 8981, 4712, 2]
...
export const GuildEventTopic = function GuildEventTopic(arg0) {
  ...
  obj[4] = topic;
  obj[5] = closure_9;
  obj[1] = callback(require(7792) /* TextInput */.TextInput, obj);
...
export const GuildEventEntityTypeSelection = function GuildEventEntityTypeSelection(arg0) {
  ...
  let obj = require(8976) /* useChannelsUserCanStartStageIn */;
  ...
  obj[3] = importDefault(8978);
  obj[4] = require(8979) /* LocationIcon */.LocationIcon;
  obj[5] = disabled;
  items[1] = obj;
  ...
  return callback(require(7987) /* context */.TableRadioGroup, obj2);
};
...
export const GuildEventDatetime = function GuildEventDatetime(dateLabel) {
  ...
  obj3[2] = () => {
    if (!disabled) {
      ...
      openLazyResult = obj2.openLazy(require(2007) /* asyncRequireImpl */(8981, dependencyMap.paths), "DatePicker", obj);
      obj5 = outer1_3;
      const tmp8 = require(2007) /* asyncRequireImpl */(8981, dependencyMap.paths);
    }
  };
  obj3[3] = disabled;
