...
// Dependencies: [19, 17, 1378, 676, 21, 4303, 7790, 1236, 8942, 4299, 8663, 1872, 4271, 8968, 1988, 8969, 8970, 8971, 4829, 8972, 8973, 8013, 4825, 7985, 7984, 7976, 3883, 8975, 4712, 2]
...
export const GuildEventTopic = function GuildEventTopic(arg0) {
  ...
  obj[4] = topic;
  obj[5] = closure_9;
  obj[1] = callback(require(7790) /* TextInput */.TextInput, obj);
...
export const GuildEventEntityTypeSelection = function GuildEventEntityTypeSelection(arg0) {
  ...
  let obj = require(8970) /* useChannelsUserCanStartStageIn */;
  ...
  obj[3] = importDefault(8971);
  obj[4] = require(4829) /* VoiceNormalIcon */.VoiceNormalIcon;
  obj[5] = disabled;
  const items = [obj, ];
  obj = { name: null, value: null, description: null, icon: null, IconComponent: null, disabled: null };
  const intl3 = require(1236) /* getSystemLocale */.intl;
  ...
  obj[3] = importDefault(8972);
  obj[4] = require(8973) /* LocationIcon */.LocationIcon;
  obj[5] = disabled;
  items[1] = obj;
  ...
  return callback(require(7985) /* context */.TableRadioGroup, obj2);
};
...
export const GuildEventDatetime = function GuildEventDatetime(dateLabel) {
  ...
  obj3[2] = () => {
    if (!disabled) {
      ...
      openLazyResult = obj2.openLazy(require(1988) /* asyncRequireImpl */(8975, dependencyMap.paths), "DatePicker", obj);
      obj5 = outer1_3;
      const tmp8 = require(1988) /* asyncRequireImpl */(8975, dependencyMap.paths);
    }
  };
  obj3[3] = disabled;
