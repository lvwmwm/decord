...
// Dependencies: [19, 17, 1392, 673, 21, 4481, 6547, 1233, 9594, 4477, 8832, 1890, 4448, 9355, 2008, 9640, 9641, 9642, 5062, 9643, 9644, 8552, 5058, 5640, 5643, 7025, 4074, 9646, 4934, 2]
...
import registerAssetDefault from "registerAsset" /* 8552 */;
import useChannelsUserCanStartStageIn from "useChannelsUserCanStartStageIn" /* 9641 */;
import registerAssetDefault2 from "registerAsset" /* 9642 */;
import registerAssetDefault3 from "registerAsset" /* 9643 */;
import LocationIcon from "LocationIcon" /* 9644 */;
...
export const GuildEventRecurrence = function GuildEventRecurrence(startDate) {
  ...
  obj[1] = callback(startDate(4477).Text, obj1);
  ...
  obj2[2] = label;
  obj2[3] = recurrenceRule(9640);
  const intl3 = tmp2(1233).intl;
  obj2[5] = intl3.string(startDate(1233).t["59TVxL"]);
  obj2[6] = label;
  items1[1] = callback(startDate(8832).InputButton, obj2);
  obj[1] = items1;
...
export const GuildEventDescription = function GuildEventDescription(onFocus) {
  ...
  obj[5] = description;
  obj[2] = callback(onFocus(7025).TextArea, obj);
  return callback(View, obj);
};
export const GuildEventDatetime = function GuildEventDatetime(dateLabel) {
  ...
  const items = [callback(time(4477).Text, { style: tmp5.formHeader, variant: "text-sm/semibold", color: "text-subtle", children: dateLabel }), ];
  time = "date";
  items[1] = callback(time(8832).InputButton, {
    text: dateLabel,
    ...
    onPress: () => {
      if (!disabled) {
        ...
        openLazyResult = obj2.openLazy(asyncRequireImpl(9646, dependencyMap.paths), "DatePicker", obj);
        obj5 = closure_1_3;
        const tmp8 = asyncRequireImpl(9646, dependencyMap.paths);
      }
    },
    disabled
  });
  ...
  const items2 = [callback(time(4477).Text, { style: tmp5.formHeader, variant: "text-sm/semibold", color: "text-subtle", children: timeLabel }), ];
  ...
  time = "time";
  items2[1] = callback(time(8832).InputButton, {
    text: timeLabel,
  ...
  obj[2] = items1;
  obj[1] = callback2(time(4934).Stack, obj);
