// Module ID: 8989
// Function ID: 8990
// Dependencies: [5, 32, 19, 1397, 21, 4303, 712, 8947, 8961, 1891, 8946, 1351, 1236, 8951, 8990, 8970, 8993, 9036, 9037, 5783, 2]
...
const memoResult = importAllResult.memo((guild) => {
  ...
  obj[1] = () => jsx(importDefault(8970), { screen: PREVIEW, onClose: outer1_1 });
  ...
  obj1[1] = () => jsx(importDefault(8970), { screen: PREVIEW, onClose: outer1_1 });
  ...
  obj2[1] = () => jsx(importDefault(8970), { screen: PREVIEW, onClose: outer1_1 });
