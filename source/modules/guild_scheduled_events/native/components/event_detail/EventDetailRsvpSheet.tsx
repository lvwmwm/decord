...
function FetchErrorDisplay(style) {
  ...
  obj = { Promise: false, marginTop: 0, flags: 4, style: callback3().emptyDisplayTitle };
...
let obj = { staticMessageContentContainer: { "Bool(true)": null, "Bool(true)": null }, userList: { paddingTop: 16 }, userListRow: { paddingVertical: 8 } };
