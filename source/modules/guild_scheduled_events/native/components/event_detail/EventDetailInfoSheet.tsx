...
// Dependencies: [19, 17, 4277, 1942, 1862, 4356, 1874, 1378, 8872, 505, 21, 4285, 712, 5204, 4253, 589, 8863, 8875, 8874, 8879, 9058, 4281, 1236, 1297, 4124, 7719, 5117, 8969, 2]
// Exports: closeGuildEventInfoActionSheet, default

// Module 9065 (EventDetailInfoSheet)
...
export default function EventDetailInfoSheet(guildEvent) {
  ...
  const items8 = [callback(guildEvent(8879).GuildEventCardHeader, obj1), , , , , , , , , ];
  obj2 = { event: guildEvent, textStyle: tmp.eventTitle, style: tmp.eventTitleContainer };
  items8[1] = callback(guildEvent(8879).GuildEventCardTitle, obj2);
  obj3 = { event: guildEvent, textStyle: tmp.guildTextStyle };
  items8[2] = callback(guildEvent(8879).GuildEventCardSimpleGuildInfo, obj3);
  items8[3] = callback(guildEvent(8879).GuildEventSimpleLocation, { event: guildEvent });
  ...
  items8[6] = callback(guildEvent(8879).GuildEventCardDescription, { event: guildEvent, style: tmp.eventDescriptionContainer });
  ...
  const items12 = [
    callback(guildEvent(8879).GuildEventCardPrimaryAction, {
      event: guildEvent,
      onCloseAction() {
  ...
  if (stateFromStores1) {
    ...
    obj15[0] = guildEvent;
    tmp13Result = tmp13(tmp2(8879).GuildEventShareAction, obj15);
  }
  items12[1] = tmp13Result;
  items12[2] = callback(guildEvent(8879).GuildEventModeratorAction, { event: guildEvent, recurrenceId });
  obj13[2] = items12;
  items8[8] = callback2(guildEvent(5117).ButtonGroup, obj13);
  ...
  if (tmp13Result) {
    ...
    tmp13Result = tmp13(tmp7(8969), obj16);
  }
