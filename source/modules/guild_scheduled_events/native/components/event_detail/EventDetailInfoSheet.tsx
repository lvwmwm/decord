...
// Dependencies: [19, 17, 4662, 1990, 1910, 4539, 1922, 1397, 8793, 505, 21, 4661, 712, 6782, 4342, 589, 8784, 8796, 8795, 8800, 10003, 4734, 1236, 1297, 4219, 8077, 6687, 8900, 2]
// Exports: closeGuildEventInfoActionSheet, default

// Module 12406 (EventDetailInfoSheet)
...
export default function EventDetailInfoSheet(guildEvent) {
  ...
  obj6[2] = intl.format(guildEvent(1236).t["+DLsD8"], { count: importDefault(8795)(guildEvent.guild_id, guildEvent.id, recurrenceId) });
  ...
  if (hasItem) {
    ...
    hasItem = tmp13(tmp7(8077), obj12);
    const tmp7Result = tmp7(8077);
  }
  items8[7] = hasItem;
  ...
  if (stateFromStores1) {
    ...
    obj15[0] = guildEvent;
    tmp13Result = tmp13(tmp2(8800).GuildEventShareAction, obj15);
  }
  ...
  if (tmp13Result) {
    ...
    tmp13Result = tmp13(tmp7(8900), obj16);
  }
...
export const closeGuildEventInfoActionSheet = function closeGuildEventInfoActionSheet() {
  importDefault(4342).hideActionSheet(closure_11);
};
