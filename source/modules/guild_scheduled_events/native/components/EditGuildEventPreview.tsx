...
// Function ID: 9179
// Name: PreviewBody
// Dependencies: [19, 17, 1391, 676, 21, 4380, 712, 500, 589, 4574, 9092, 9179, 4376, 1236, 9180, 1297, 9181, 9088, 5434, 9104, 4815, 9089, 4745, 9182, 2009, 2]
// Exports: default

// Module 9178 (PreviewBody)
...
function PreviewBody(event) {
  ...
  eventLocationIconSource = _require(9179).getEventLocationIconSource(event, stateFromStores, true);
  ...
  const items2 = [callback(_require(4376).Text, obj), ];
  ...
  obj1[4] = formatResult;
  items2[1] = callback(_require(4376).Text, obj1);
  obj[1] = items2;
