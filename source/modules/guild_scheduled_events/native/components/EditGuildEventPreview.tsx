...
// Function ID: 9678
// Name: PreviewBody
// Dependencies: [19, 17, 1391, 676, 21, 4446, 712, 500, 589, 4640, 9614, 9678, 4442, 1236, 9364, 1297, 9679, 9613, 5518, 9680, 4893, 9573, 4823, 9696, 2010, 2]
// Exports: default

// Module 9677 (PreviewBody)
...
function PreviewBody(event) {
  ...
  const tmp6 = channel_id(4640)(stateFromStores);
  dependencyMap = tmp6;
  obj1 = _require(9614);
  ...
  eventLocationIconSource = _require(9678).getEventLocationIconSource(event, stateFromStores, true);
  ...
  const items2 = [callback(_require(4442).Text, obj), ];
    ...
    obj4[1] = function channelHook() {
      ...
      if (dependencyMap == null) {
        ...
        if (null != locationFromEvent) {
          result = lib(9679).guildEventLocationParser(tmp12, true);
          const tmp9Result = lib(9679);
        }
        tmp11 = result;
      }
      obj = { children: null };
      items[1] = closure_1_6(lib(4442).Text, { accessibilityElementsHidden: true, importantForAccessibility: "no", variant: "text-sm/medium", color: "text-default", children: tmp11 });
      obj[0] = items;
  ...
  obj1[4] = formatResult;
  items2[1] = callback(_require(4442).Text, obj1);
  obj[1] = items2;
