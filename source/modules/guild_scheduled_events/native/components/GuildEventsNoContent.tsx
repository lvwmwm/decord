...
// Dependencies: [19, 17, 3929, 676, 505, 21, 4303, 5236, 712, 589, 7787, 9043, 9044, 4299, 1236, 9021, 2]
// Exports: default

// Module 9042 (GuildEventsNoContent)
import "noop";
...
export default function GuildEventsNoContent(guild) {
  ...
  obj[0] = onClose(9043);
  obj[1] = guild(9044).CalendarIcon;
  const items2 = [callback(onClose(7787), obj), , , ];
  ...
  items2[1] = callback(guild(4299).Text, obj1);
  ...
  items2[2] = callback(guild(4299).Text, obj2);
  if (stateFromStores) {
    ...
    stateFromStores = callback(tmp2(4299).Text, obj3);
  }
