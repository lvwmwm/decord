...
function StartEventHeader(children) {
  ...
  obj = { "Null": "<string:4294472349>", "Null": "<string:4294508543>", alignItems: "<string:1107427327>", style: tmp.headerPrivacyLevel };
  const intl = arg1(dependencyMap[13]).intl;
...
obj.container = { lineHeight: 0., textAlign: 0., paddingHorizontal: 0., marginBottom: 0. };
...
obj.footerContainer = { position: 0., location: 0. };
const tmp3 = arg1(dependencyMap[8]);
obj.header = { alignItems: "center", paddingTop: importDefault(dependencyMap[10]).space.PX_24 };
obj.headerTitle = { "Bool(true)": true, "Bool(true)": null };
const obj3 = { position: 0., location: 0., gap: importDefault(dependencyMap[10]).space.PX_8, marginTop: importDefault(dependencyMap[10]).space.PX_16 };
obj.buttonContainer = obj3;
const obj4 = { "Null": "<string:1589182465>", "Null": "<string:994246657>", flexDirection: "r", flexWrap: "EdgeRuntime", justifyContent: "r", borderColor: importDefault(dependencyMap[10]).colors.BORDER_SUBTLE, backgroundColor: importDefault(dependencyMap[10]).colors.BACKGROUND_SURFACE_HIGH, shadowOffset: { hideWhenScrolling: "\u{1F9D1}\u200D\u{1F3A8}", autoCapitalize: true } };
...
export default function StartEventModal(event) {
  ...
  ({ loading, error } = tmp8);
  obj = { "Null": null, "Null": null, style: tmp.mainContainer };
  ...
  let tmp24 = null;
  if (null != error) {
    const obj6 = { cachedAt: 1, edpbxy: "center", children: error.getAnyErrorMessage() };
