...
// Dependencies: [19, 17, 4356, 1397, 676, 4540, 21, 4344, 9082, 5435, 1236, 9021, 9006, 9083, 8998, 8994, 4770, 698, 5292, 5436, 9086, 5368, 2]
// Exports: default

// Module 9081 (GuildEventsListHeader)
...
function GuildEventsListHeader(arg0) {
  ...
  let importDefault;
  let tmp3Result = importDefault(9082)(guild.id);
  ...
  if (tmp3Result) {
    ...
    tmp3Result = tmp3(tmp4(9021).ActionSheetHeaderPressableText, obj);
  }
  obj[1] = tmp3Result;
  return jsx(guild(5435).BottomSheetTitleHeader, { title: formatToPlainStringResult, trailing: null });
}
...
export default function GuildEventsListActionSheet(guild) {
  ...
  obj1[5] = arr(5368)(ref);
  obj[1] = jsx(arr(9086), { inActionSheet: true, events: arr, onPressEvent: callback1, onCloseAction: callback, guild, lastAckedId: null });
  obj[5] = <View style={tmp.container}>{null}</View>;
  return jsx(guild(5436).BottomSheet, { style: tmp.container, children: null });
};
