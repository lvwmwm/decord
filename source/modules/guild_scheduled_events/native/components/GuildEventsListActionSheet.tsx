...
// Dependencies: [19, 17, 4205, 1378, 676, 4390, 21, 4193, 8324, 5246, 1236, 8258, 8233, 8325, 8225, 8221, 4620, 698, 5130, 5247, 8328, 5182, 2]
// Exports: default
...
function GuildEventsListHeader(arg0) {
  ...
  let importDefault;
  let tmp3Result = importDefault(8324)(guild.id);
  ...
  if (tmp3Result) {
    ...
    tmp3Result = tmp3(tmp4(8258).ActionSheetHeaderPressableText, obj);
  }
  obj[1] = tmp3Result;
  return jsx(guild(5246).BottomSheetTitleHeader, { title: formatToPlainStringResult, trailing: null });
}
...
export default function GuildEventsListActionSheet(guild) {
  ...
  obj1[5] = arr(5182)(ref);
  obj[1] = jsx(arr(8328), { inActionSheet: true, events: arr, onPressEvent: callback1, onCloseAction: callback, guild, lastAckedId: null });
  obj[5] = <View style={tmp.container}>{null}</View>;
  return jsx(guild(5247).BottomSheet, { style: tmp.container, children: null });
};
