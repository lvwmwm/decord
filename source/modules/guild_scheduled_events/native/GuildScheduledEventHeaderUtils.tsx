...
// Dependencies: [6985, 1378, 8942, 712, 9043, 1236, 8013, 9140, 2]
// Exports: getGuildScheduledEventHeaderProps

// Module 9139 (getGuildScheduledEventHeaderProps)
...
export const getGuildScheduledEventHeaderProps = function getGuildScheduledEventHeaderProps(eventTimeData) {
  ...
  let tmp8Result = importDefault(9043);
  if (tmp4) {
    const intl4 = tmp(1236).intl;
    let stringResult = intl4.string(tmp(1236).t["X2K3/4"]);
    if (isStage) {
      tmp8Result = tmp8(8013);
    }
    let entity_type;
    if (event != null) {
