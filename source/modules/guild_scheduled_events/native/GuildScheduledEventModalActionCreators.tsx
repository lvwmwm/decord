...
// Dependencies: [5, 19, 1372, 1932, 1862, 3883, 6879, 1378, 8844, 676, 21, 4460, 38, 8856, 1959, 4223, 8877, 8930, 8946, 8956, 4595, 8834, 3956, 1236, 8957, 8937, 8840, 8958, 8852, 5623, 3955, 8959, 7651, 8843, 8841, 8836, 9028, 7802, 3928, 5622, 1474, 9029, 5628, 2]
...
// Module 8855 (openCreateOrEditGuildEventModal)
...
function openCreateOrEditGuildEventModal(guild, arg1) {
  ...
  if (null != recurrenceId) {
    ...
    obj[1] = recurrenceId;
    obj[2] = handleClose;
    importDefault(4460).pushLazy(require(1959) /* asyncRequireImpl */(8856, dependencyMap.paths), obj, closure_13);
    ...
    obj[2] = guildEvent;
    obj[3] = handleClose;
    importDefault(4460).pushLazy(require(1959) /* asyncRequireImpl */(8877, dependencyMap.paths), obj, closure_13);
...
export const openGuildEventListActionSheet = function openGuildEventListActionSheet(closure_0) {
  ...
  obj = { guild: closure_0 };
  obj.openLazy(require(1959) /* asyncRequireImpl */(8930, dependencyMap.paths), closure_14, obj);
};
...
export const openStartGuildEventModal = function openStartGuildEventModal(event, nextRecurrenceIdInEvent, onCloseActionSheet) {
  ...
  importDefault(4460).pushLazy(require(1959) /* asyncRequireImpl */(8946, dependencyMap.paths), obj, closure_15);
};
...
export const updateRsvp = function updateRsvp(arg0, arg1, arg2, arg3) {
  let closure_0 = arg3;
  importDefault(8834).updateRsvp(arg0, arg1, arg2, arg3, (arg0) => {
    let tmp2 = tmp;
    if (null == arg0) {
...
export const openShareEvent = function openShareEvent(event, arg1) {
  ...
  if (null != channel) {
    const result = require(8852) /* canEveryoneRoleViewEvent */.isGuildEventInvitable(event);
    if (result) {
      ...
      if (tmp11) {
        tmp7(5623).copy(arg1);
        const tmp7Result1 = tmp7(5623);
        tmp7(3955).presentLinkCopied();
        const tmp7Result2 = tmp7(3955);
      }
    }
    const obj3 = require(8852) /* canEveryoneRoleViewEvent */;
  } else {
