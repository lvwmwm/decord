...
// Dependencies: [19, 4267, 4450, 4451, 589, 8932, 4741, 8195, 8855, 4223, 11633, 1959, 1236, 11637, 2]
// Exports: default

// Module 11632 (useEventsButtonProps)
...
export default function useEventsButtonProps(id) {
  ...
  const arr4 = importDefault(8932)(id.id);
  const items3 = [id];
  const items4 = [id.id];
