...
// Dependencies: [19, 4357, 4540, 4541, 589, 9087, 4831, 8461, 9010, 4310, 11808, 2007, 1236, 11812, 2]
// Exports: default

// Module 11807 (useEventsButtonProps)
...
export default function useEventsButtonProps(id) {
  ...
  const arr4 = importDefault(9087)(id.id);
  const items3 = [id];
  const items4 = [id.id];
