...
// Dependencies: [19, 4315, 4499, 4500, 589, 9044, 4790, 8418, 8967, 4271, 11752, 2007, 1236, 11756, 2]
// Exports: default

// Module 11751 (useEventsButtonProps)
...
export default function useEventsButtonProps(id) {
  ...
  const arr4 = importDefault(9044)(id.id);
  const items3 = [id];
  const items4 = [id.id];
