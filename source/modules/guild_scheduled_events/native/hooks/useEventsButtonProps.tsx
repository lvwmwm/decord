...
// Dependencies: [19, 4356, 4539, 4540, 589, 9083, 4830, 8457, 9006, 4312, 11809, 2007, 1236, 11813, 2]
// Exports: default

// Module 11808 (useEventsButtonProps)
...
export default function useEventsButtonProps(id) {
  ...
  const arr4 = importDefault(9083)(id.id);
  const items3 = [id];
  const items4 = [id.id];
