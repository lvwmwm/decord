...
// Module 9057 (restoreEventRecurrence)
...
export default function restoreEventRecurrence(arg0, guild_id, id, c2) {
  ...
  if (null == scheduled_start_time) {
    if (null == scheduled_end_time) {
      let result = importDefault(8863).deleteGuildEventException(guild_id, id, c2);
      const obj3 = importDefault(8863);
    }
    return result;
  }
  let obj = importDefault(8863);
