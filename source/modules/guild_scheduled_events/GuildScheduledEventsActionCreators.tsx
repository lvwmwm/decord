// Module ID: 8989
// Function ID: 8990
// Dependencies: [5, 1218, 7033, 1397, 676, 530, 5170, 1222, 8990, 4582, 709, 8995, 11, 2]
...
export default {
  ...
  joinVoiceEvent(arg0, id) {
    const voiceChannel = importDefault(5170).selectVoiceChannel(id);
  ...
  saveEvent(arg0, entityType) {
    ...
    obj[9] = require(8990) /* EditGuildEventScreens */.recurrenceRuleToServer(entityType.recurrenceRule);
    const HTTP = require(530) /* sendRequest */.HTTP;
    obj = { url: closure_10.GUILD_EVENT(arg2, arg0), body: obj, rejectWithError: null };
    const obj3 = require(8990) /* EditGuildEventScreens */;
    obj[2] = require(530) /* sendRequest */.rejectWithMigratedError();
    return HTTP.patch(obj);
  },
  createGuildEvent(first, id) {
    ...
    obj[9] = require(8990) /* EditGuildEventScreens */.recurrenceRuleToServer(first.recurrenceRule);
    const HTTP = require(530) /* sendRequest */.HTTP;
    obj = { url: closure_10.GUILD_EVENTS_FOR_GUILD(id), body: obj, rejectWithError: null };
    const obj2 = require(8990) /* EditGuildEventScreens */;
    obj[2] = require(530) /* sendRequest */.rejectWithMigratedError();
