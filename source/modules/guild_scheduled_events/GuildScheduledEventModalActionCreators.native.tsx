...
// Dependencies: [5, 1397, 8995, 4312, 8996, 2007, 8987, 9193, 2]
// Exports: openEndEventModal, transitionToEventDetailsFromInvite

// Module 8994 (openGuildEventDetails)
...
function openGuildEventDetails(arg0) {
  ...
  if (recurrenceId == null) {
    recurrenceId = require(8987) /* getRRule */.getNextRecurrenceIdInEvent(event);
    const tmp2Result = require(8987) /* getRRule */;
  }
  obj[3] = recurrenceId;
  obj.openLazy(require(2007) /* asyncRequireImpl */(8996, dependencyMap.paths), closure_5, obj, "stack");
}
...
export const openEndEventModal = function openEndEventModal(channel) {
  let obj = importDefault(4312);
  obj = { channel };
  obj.openLazy(require(2007) /* asyncRequireImpl */(9193, dependencyMap.paths), closure_4, obj);
};
