...
// Dependencies: [5, 1392, 9628, 4448, 9719, 2008, 9594, 9734, 2]
// Exports: openEndEventModal, transitionToEventDetailsFromInvite

// Module 9718 (openGuildEventDetails)
...
import { GUILD_EVENT_INFO_ACTION_SHEET_KEY as closure_5 } from "CREATE_GUILD_EVENT_MODAL_KEY" /* 9628 */;
...
function openGuildEventDetails(arg0) {
  ...
  obj[3] = recurrenceId;
  obj.openLazy(asyncRequireImpl(9719, dependencyMap.paths), closure_5, obj, "stack");
}
