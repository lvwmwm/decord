...
// Dependencies: [19, 17, 5366, 1391, 1910, 4090, 12125, 12129, 676, 1926, 505, 21, 4446, 712, 5426, 589, 4640, 1222, 4413, 5458, 1435, 4103, 4442, 1297, 11310, 8309, 709, 12127, 698, 5954, 12130, 1236, 2]
// Exports: default

// Module 12128 (WelcomeChannelRow)
...
import closure_10 from "handleInviteData" /* 12125 */;
import { NO_WELCOME_SCREEN } from "handleInviteData" /* 12125 */;
import { WELCOME_SCREEN_TYPE } from "WELCOME_SCREEN_TYPE" /* 12129 */;
...
export default function GuildWelcomeActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != welcomeScreen) {
      ...
      obj1[2] = onHide(12130).Sizes.MEDIUM;
      const items9 = [callback(onHide(12130), obj1), , , , ];
      ...
      items9[1] = callback(tmp2(4442).Text, obj2);
      ...
      tmp12 = callback(tmp2(5954).ActionSheet, obj);
