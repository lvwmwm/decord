...
// Dependencies: [19, 17, 6884, 5213, 4450, 9681, 21, 4255, 500, 712, 4251, 4797, 11992, 9367, 10917, 9556, 1348, 589, 4445, 12018, 5209, 1236, 5629, 10918, 5890, 2]
// Exports: CategoryChannel, RecentlyActiveCategory, SuggestedCategory, useCategoryPressEvents

// Module 15113 (renderCategoryItem)
...
function renderCategoryItem(arg0) {
  ...
  if (null == trailingAction) {
    ...
    obj4[6] = items;
    obj4[7] = tmp14Result;
    tmp24Result = callback(trailingAction(4797).PressableHighlight, obj4);
    ...
    colors = tmp6(trailingAction(11992).PlusMediumIcon, obj8);
    obj7[4] = colors;
    obj7 = tmp6(trailingAction(4797).PressableOpacity, obj7);
    obj6[1] = obj7;
    callback(View, obj6);
    const tmp7 = View;
  }
...
export const CategoryChannel = function CategoryChannel(channel) {
  ...
  obj[6] = styles(tmp2);
  obj[7] = tmp2;
  obj[8] = collapsed(12018)(channel);
  const collapsed2 = obj.collapsed;
  const merged = Object.assign(obj, Object.create(null));
  const colors = collapsed(712).colors;
  obj = {};
  const merged1 = Object.assign(merged);
  obj.icon = callback(id(9367).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed2 ? createCacheKey : obj1 });
...
export const RecentlyActiveCategory = function RecentlyActiveCategory(guildId) {
  ...
  obj = {};
  const merged1 = Object.assign(merged);
  obj.icon = callback(guildId(9367).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed ? createCacheKey : obj1 });
