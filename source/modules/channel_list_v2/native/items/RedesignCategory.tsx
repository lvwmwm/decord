...
// Dependencies: [19, 17, 7038, 5300, 4540, 9844, 21, 4342, 500, 712, 4338, 12170, 4887, 9528, 11004, 9715, 1367, 589, 4535, 12196, 15315, 5296, 1236, 5802, 11005, 6039, 2]
// Exports: CategoryChannel, RecentlyActiveCategory, SuggestedCategory, useCategoryPressEvents

// Module 15314 (renderCategoryItem)
...
function renderCategoryItem(longPressAction) {
  ...
  if (null == trailingAction) {
    ...
    if (tmp) {
      ...
      obj5[6] = items;
      obj5[7] = tmp18Result;
      let tmp29Result = tmp29(trailingAction(4887).PressableHighlight, obj5);
    } else {
    ...
    obj8[6] = colors;
    obj8 = tmp9(trailingAction(4887).PressableOpacity, obj8);
    obj7[1] = obj8;
    callback(View, obj7);
    const tmp10 = View;
  }
...
export const CategoryChannel = function CategoryChannel(channel) {
  ...
  obj.icon = callback(tmp5(9528).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed2 ? createCacheKey : obj1 });
...
export const RecentlyActiveCategory = function RecentlyActiveCategory(guildId) {
  ...
  obj = {};
  const merged1 = Object.assign(merged);
  obj.icon = callback(guildId(9528).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed ? createCacheKey : obj1 });
