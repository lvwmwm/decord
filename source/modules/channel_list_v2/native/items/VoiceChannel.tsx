...
// Dependencies: [5, 19, 17, 6880, 3883, 4267, 4450, 4327, 9681, 676, 21, 712, 4741, 8195, 1959, 4464, 8932, 15212, 15217, 9630, 589, 15205, 9340, 4245, 7843, 8927, 698, 15206, 15117, 9556, 1236, 4437, 15128, 15122, 11330, 2]

// Module 15216 (_handleVoiceChannelPress)
...
let closure_17 = importAllResult.memo((channel) => {
  ...
  if (!tmpResult.shouldSkipAccessibilityLabels()) {
    ...
    tmp13 = gameMentionsAsPlainText(8927)(obj);
  }
  const items2 = [, , ];
  ...
  const tmp19 = jsx(gameMentionsAsPlainText(15206), { channel, isChannelSelected: selected, isChannelCollapsed: collapsed, voiceStates: ensureSyncedChannelVoiceStates, enableConnectedUserLimit: true, enableActivities: true });
  ...
  if (0 !== ensureSyncedChannelVoiceStates.length) {
    if (collapsed) {
      ...
      obj6[1] = tmp17(tmp18(15122), obj7);
      tmp17Result = tmp17(View, obj6);
    }
  }
  obj1[15] = tmp17Result;
  return jsx(gameMentionsAsPlainText(15117), {
    onPress() {
      return (function handleVoiceChannelPress(channel) {
        const self = this;
        const apply = closure_16.apply;
...
const memoResult = importAllResult.memo((channel) => {
  ...
  const arr3 = importDefault(11330)(channel);
