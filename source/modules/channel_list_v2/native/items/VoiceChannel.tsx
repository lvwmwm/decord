...
// Dependencies: [5, 19, 17, 6907, 3912, 4297, 4480, 4357, 9712, 676, 21, 712, 4771, 8335, 1988, 4494, 8961, 15251, 15256, 9661, 589, 15244, 9369, 4275, 7984, 8956, 698, 15245, 15155, 9585, 1236, 4467, 15166, 15160, 11364, 2]

// Module 15255 (_handleVoiceChannelPress)
...
let closure_17 = importAllResult.memo((channel) => {
  ...
  if (null != gameMentionsAsPlainText) {
    let obj7 = gameMentionsAsPlainText(4275);
  ...
  if (!tmpResult.shouldSkipAccessibilityLabels()) {
    ...
    tmp13 = gameMentionsAsPlainText(8956)(obj);
  }
  const items2 = [, , ];
  ...
  const tmp19 = jsx(gameMentionsAsPlainText(15245), { channel, isChannelSelected: selected, isChannelCollapsed: collapsed, voiceStates: ensureSyncedChannelVoiceStates, enableConnectedUserLimit: true, enableActivities: true });
  ...
  if (0 !== ensureSyncedChannelVoiceStates.length) {
    if (collapsed) {
      ...
      obj6[1] = tmp17(tmp18(15160), obj7);
      tmp17Result = tmp17(View, obj6);
    }
  }
  obj1[15] = tmp17Result;
  return jsx(gameMentionsAsPlainText(15155), {
    onPress() {
      return (function handleVoiceChannelPress(channel) {
        const self = this;
        const apply = closure_16.apply;
...
const memoResult = importAllResult.memo((channel) => {
  ...
  const arr3 = importDefault(11364)(channel);
