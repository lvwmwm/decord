...
// Dependencies: [5, 19, 17, 7056, 3989, 4357, 4550, 4417, 9855, 676, 21, 712, 4853, 8483, 2007, 4576, 9101, 15443, 15446, 9804, 589, 15436, 9514, 4332, 8127, 9096, 698, 15437, 15328, 9726, 1236, 4527, 15342, 15333, 11519, 2]

// Module 15445 (_handleVoiceChannelPress)
...
let closure_17 = importAllResult.memo((channel) => {
  ...
  if (!tmpResult.shouldSkipAccessibilityLabels()) {
    ...
    tmp13 = gameMentionsAsPlainText(9096)(obj);
  }
  const items2 = [, , ];
  ...
  const tmp19 = jsx(gameMentionsAsPlainText(15437), { channel, isChannelSelected: selected, isChannelCollapsed: collapsed, voiceStates: ensureSyncedChannelVoiceStates, enableConnectedUserLimit: true, enableActivities: true });
  ...
  if (0 !== ensureSyncedChannelVoiceStates.length) {
    if (collapsed) {
      ...
      obj6[1] = tmp17(tmp18(15333), obj7);
      tmp17Result = tmp17(View, obj6);
    }
  }
  obj1[15] = tmp17Result;
  return jsx(gameMentionsAsPlainText(15328), {
    onPress() {
      return (function handleVoiceChannelPress(channel) {
        const self = this;
        const apply = closure_16.apply;
...
const memoResult = importAllResult.memo((channel) => {
  ...
  const arr3 = importDefault(11519)(channel);
