// Module ID: 15434
// Function ID: 15435
// Dependencies: [19, 4357, 4540, 9844, 4541, 21, 4342, 712, 9715, 4353, 589, 15234, 15314, 9082, 2]
...
const memoResult = importAllResult.memo((channel) => {
  ...
  obj[5] = importDefault(9082)({ channel, unread: hasUnread, mentionCount, isIncomingCall, isOngoingCall });
  obj[6] = { selected };
  obj[7] = channel;
  obj[8] = selected;
  obj[9] = hasUnread;
