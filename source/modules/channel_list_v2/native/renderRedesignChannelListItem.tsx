...
// Dependencies: [19, 17, 5177, 1395, 1391, 1980, 4417, 9844, 1398, 7041, 21, 15384, 15386, 15390, 712, 8053, 7035, 15304, 1236, 11726, 15379, 15392, 15328, 4759, 15394, 15396, 15398, 15401, 15403, 15404, 15405, 15406, 15407, 15410, 15412, 15415, 15311, 15419, 692, 15430, 15432, 15434, 1913, 15435, 15321, 5183, 15319, 15436, 2]
...
export const renderChannelListSectionHeader = function renderChannelListSectionHeader(guildChannels, section, recentlyActiveChannelsEnabled, arg3, categoryStyles, c9) {
  if (guildChannels.favoritesSectionNumber === section) {
    ...
    let tmp11 = null;
    if (flag2) {
      tmp11 = callback4(importDefault(11726), {});
    }
    const items = [tmp11, ];
  ...
  if (guildChannels.favoritesSectionNumber !== section) {
    if (guildChannels.recentsSectionNumber !== section) {
      if (guildChannels.voiceChannelsSectionNumber === section) {
        ...
        let num4 = 0;
        if (flag2) {
          num4 = require(11726) /* Divider */.DIVIDER_HEIGHT;
        }
        let sum = num4;
        if (flag) {
          sum = num4 + tmp;
...
export const renderChannelListSectionFooter = function renderChannelListSectionFooter(guildChannels, section, ref, result, c9) {
  ...
  if (require(7035) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES === section) {
    ...
    if (c9) {
      ...
      tmp19 = null;
      if (flag) {
        tmp19 = callback4(importDefault(11726), {});
      }
    }
    return tmp19;
  } else {
    ...
    return callback4(importDefault(11726), {});
  }
};
