...
// Dependencies: [19, 17, 5176, 1395, 1391, 1980, 4416, 9841, 1398, 7035, 21, 15384, 15386, 15390, 712, 8049, 7029, 15304, 1236, 11727, 15379, 15392, 15328, 4758, 15394, 15396, 15398, 15401, 15403, 15404, 15405, 15406, 15407, 15410, 15412, 15415, 15311, 15419, 692, 15430, 15432, 15434, 1913, 15435, 15321, 5182, 15319, 15436, 2]
...
// Module 15385 (getFastListRecyclerKey)
import "Divider";
...
export const getFastListRecyclerKey = function getFastListRecyclerKey(guildChannels, arg1, arg2, arg3) {
  if (arg1 === require(8049) /* renderDefaultEmpty */.FastListItemTypes.ITEM) {
    if (null != arg3) {
...
export const renderChannelListSectionHeader = function renderChannelListSectionHeader(guildChannels, section, recentlyActiveChannelsEnabled, arg3, categoryStyles, c9) {
  if (guildChannels.favoritesSectionNumber === section) {
    ...
    obj[3] = c9;
    return require(15304) /* CategoryChannel */.renderCategoryItem(obj);
  } else if (guildChannels.recentsSectionNumber === section) {
    const tmp22 = require(15304) /* CategoryChannel */;
    ...
    let tmp11 = null;
    if (flag2) {
      tmp11 = callback4(importDefault(11727), {});
    }
    const items = [tmp11, ];
    let renderCategoryItemResult = null;
    if (flag) {
      let obj3 = require(15304) /* CategoryChannel */;
    ...
    obj = require(15379) /* isFavoritesSection */;
  ...
  if (guildChannels.favoritesSectionNumber !== section) {
    if (guildChannels.recentsSectionNumber !== section) {
      if (guildChannels.voiceChannelsSectionNumber === section) {
        ...
        let num4 = 0;
        if (flag2) {
          num4 = require(11727) /* Divider */.DIVIDER_HEIGHT;
        }
        let sum = num4;
        if (flag) {
          sum = num4 + tmp;
...
export const renderChannelListSectionFooter = function renderChannelListSectionFooter(guildChannels, section, ref, result, c9) {
  ...
  if (null != result) {
    ...
    obj[0] = guildChannels.id;
    obj[1] = result;
    tmp = callback4(require(15304) /* CategoryChannel */.RedesignVoiceUserSummary, obj);
  }
  if (require(7029) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return null;
    ...
    if (c9) {
      ...
      tmp19 = null;
      if (flag) {
        tmp19 = callback4(importDefault(11727), {});
      }
    }
    return tmp19;
  } else {
      ...
      if (guildChannels.recentsSectionNumber !== section) {
        if (guildChannels.voiceChannelsSectionNumber === section) {
          ...
          if (obj.render) {
            ...
            obj3[1] = section;
            obj3[2] = ref;
            obj2[1] = callback4(importDefault(15392), obj3);
...
export const getChannelListSectionFooterSize = function getChannelListSectionFooterSize(guildChannels, section, result, c9) {
  ...
  let num = 0;
  if (null != result) {
    num = require(15328) /* VOICE_USER_SUMMARY_HEIGHT */.VOICE_USER_SUMMARY_HEIGHT;
  }
  if (require(7029) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return 0;
...
export const calculateVoiceSummary = function calculateVoiceSummary(arg0) {
  ...
  let obj = require(15379) /* isFavoritesSection */;
