...
// Dependencies: [19, 17, 5136, 1376, 1372, 1961, 4376, 9794, 1379, 6993, 21, 15307, 15309, 15313, 712, 8008, 6987, 15236, 1236, 11666, 15302, 15315, 15255, 4718, 15317, 15319, 15321, 15322, 15324, 15325, 15326, 15327, 15328, 15331, 15333, 15336, 15238, 15340, 692, 15352, 15354, 15356, 1894, 15357, 15248, 5142, 15246, 15358, 2]
...
// Module 15308 (getFastListRecyclerKey)
import "Divider";
...
export const getFastListRecyclerKey = function getFastListRecyclerKey(guildChannels, arg1, arg2, arg3) {
  if (arg1 === require(8008) /* renderDefaultEmpty */.FastListItemTypes.ITEM) {
    if (null != arg3) {
...
export const renderChannelListSectionHeader = function renderChannelListSectionHeader(guildChannels, section, recentlyActiveChannelsEnabled, arg3, categoryStyles, c8) {
  if (guildChannels.favoritesSectionNumber === section) {
    ...
    obj[3] = c8;
    return require(15236) /* CategoryChannel */.renderCategoryItem(obj);
  } else if (guildChannels.recentsSectionNumber === section) {
    const tmp22 = require(15236) /* CategoryChannel */;
    ...
    let tmp11 = null;
    if (flag2) {
      tmp11 = callback4(importDefault(11666), {});
    }
    const items = [tmp11, ];
    let renderCategoryItemResult = null;
    if (flag) {
      let obj3 = require(15236) /* CategoryChannel */;
    ...
    obj = require(15302) /* isFavoritesSection */;
  ...
  if (guildChannels.favoritesSectionNumber !== section) {
    if (guildChannels.recentsSectionNumber !== section) {
      if (guildChannels.voiceChannelsSectionNumber === section) {
        ...
        let num4 = 0;
        if (flag2) {
          num4 = require(11666) /* Divider */.DIVIDER_HEIGHT;
        }
        let sum = num4;
        if (flag) {
          sum = num4 + tmp;
...
export const renderChannelListSectionFooter = function renderChannelListSectionFooter(guildChannels, section, ref, result, c8) {
  ...
  if (null != result) {
    ...
    obj[0] = guildChannels.id;
    obj[1] = result;
    tmp = callback4(require(15236) /* CategoryChannel */.RedesignVoiceUserSummary, obj);
  }
  if (require(6987) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return null;
    ...
    if (c8) {
      ...
      tmp19 = null;
      if (flag) {
        tmp19 = callback4(importDefault(11666), {});
      }
    }
    return tmp19;
  } else {
      ...
      if (guildChannels.recentsSectionNumber !== section) {
        if (guildChannels.voiceChannelsSectionNumber === section) {
          ...
          if (obj.render) {
            ...
            obj3[1] = section;
            obj3[2] = ref;
            obj2[1] = callback4(importDefault(15315), obj3);
...
export const getChannelListSectionFooterSize = function getChannelListSectionFooterSize(guildChannels, section, result, c8) {
  ...
  let num = 0;
  if (null != result) {
    num = require(15255) /* VOICE_USER_SUMMARY_HEIGHT */.VOICE_USER_SUMMARY_HEIGHT;
  }
  if (require(6987) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return 0;
...
export const calculateVoiceSummary = function calculateVoiceSummary(arg0) {
  ...
  let obj = require(15302) /* isFavoritesSection */;
