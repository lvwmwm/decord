...
// Dependencies: [19, 17, 4989, 1395, 1391, 1980, 4545, 10055, 1398, 5281, 21, 15449, 15451, 15455, 712, 8124, 5272, 15368, 1236, 11462, 15444, 15457, 15392, 4749, 15459, 15461, 15463, 15467, 15469, 15470, 15471, 15472, 15473, 15476, 15478, 15481, 15375, 15485, 692, 15495, 15497, 15499, 1913, 15500, 15385, 6703, 15383, 15501, 2]
...
export const getFastListRecyclerKey = function getFastListRecyclerKey(guildChannels, arg1, arg2, arg3) {
  if (arg1 === require(8124) /* renderDefaultEmpty */.FastListItemTypes.ITEM) {
    if (null != arg3) {
...
export const renderChannelListSectionHeader = function renderChannelListSectionHeader(guildChannels, section, recentlyActiveChannelsEnabled, arg3, categoryStyles, c9) {
  if (guildChannels.favoritesSectionNumber === section) {
    ...
    obj[3] = c9;
    return require(15368) /* CategoryChannel */.renderCategoryItem(obj);
  } else if (guildChannels.recentsSectionNumber === section) {
    const tmp22 = require(15368) /* CategoryChannel */;
    ...
    if (flag) {
      let obj3 = require(15368) /* CategoryChannel */;
    ...
    obj = require(15444) /* isFavoritesSection */;
...
export const renderChannelListSectionFooter = function renderChannelListSectionFooter(guildChannels, section, ref, result, c9) {
  ...
  if (null != result) {
    ...
    obj[0] = guildChannels.id;
    obj[1] = result;
    tmp = callback4(require(15368) /* CategoryChannel */.RedesignVoiceUserSummary, obj);
  }
  if (require(5272) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return null;
      ...
      if (guildChannels.recentsSectionNumber !== section) {
        if (guildChannels.voiceChannelsSectionNumber === section) {
          ...
          if (obj.render) {
            ...
            obj3[1] = section;
            obj3[2] = ref;
            obj2[1] = callback4(importDefault(15457), obj3);
...
export const getChannelListSectionHasFooterDivider = function getChannelListSectionHasFooterDivider(guildChannels, arg1, c9) {
  if (require(5272) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES === arg1) {
    return false;
...
export const getChannelListSectionFooterSize = function getChannelListSectionFooterSize(guildChannels, section, result, c9) {
  ...
  let num = 0;
  if (null != result) {
    num = require(15392) /* VOICE_USER_SUMMARY_HEIGHT */.VOICE_USER_SUMMARY_HEIGHT;
  }
  if (require(5272) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return 0;
...
export const calculateVoiceSummary = function calculateVoiceSummary(arg0) {
  ...
  let obj = require(15444) /* isFavoritesSection */;
