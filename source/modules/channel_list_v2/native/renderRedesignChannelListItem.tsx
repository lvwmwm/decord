...
// Dependencies: [19, 17, 5177, 1395, 1391, 1980, 4417, 9844, 1398, 7041, 21, 15393, 15395, 15399, 712, 8053, 7035, 15313, 1236, 11725, 15388, 15401, 15337, 4759, 15403, 15405, 15407, 15410, 15412, 15413, 15414, 15415, 15416, 15419, 15421, 15424, 15320, 15428, 692, 15439, 15441, 15443, 1913, 15444, 15330, 5183, 15328, 15445, 2]
...
// Module 15394 (getFastListRecyclerKey)
import "Divider";
...
export const getFastListRecyclerKey = function getFastListRecyclerKey(guildChannels, arg1, arg2, arg3) {
  if (arg1 === require(8053) /* renderDefaultEmpty */.FastListItemTypes.ITEM) {
    if (null != arg3) {
...
export const renderChannelListSectionHeader = function renderChannelListSectionHeader(guildChannels, section, recentlyActiveChannelsEnabled, arg3, categoryStyles, c9) {
  if (guildChannels.favoritesSectionNumber === section) {
    ...
    obj[3] = c9;
    return require(15313) /* CategoryChannel */.renderCategoryItem(obj);
  } else if (guildChannels.recentsSectionNumber === section) {
    const tmp22 = require(15313) /* CategoryChannel */;
    ...
    let tmp11 = null;
    if (flag2) {
      tmp11 = callback4(importDefault(11725), {});
    }
    const items = [tmp11, ];
    let renderCategoryItemResult = null;
    if (flag) {
      let obj3 = require(15313) /* CategoryChannel */;
    ...
    obj = require(15388) /* isFavoritesSection */;
  ...
  if (guildChannels.favoritesSectionNumber !== section) {
    if (guildChannels.recentsSectionNumber !== section) {
      if (guildChannels.voiceChannelsSectionNumber === section) {
        ...
        let num4 = 0;
        if (flag2) {
          num4 = require(11725) /* Divider */.DIVIDER_HEIGHT;
        }
        let sum = num4;
        if (flag) {
          sum = num4 + tmp;
...
export const renderChannelListSectionFooter = function renderChannelListSectionFooter(guildChannels, section, ref, result, c9) {
  ...
  if (null != result) {
    ...
    obj[0] = guildChannels.id;
    obj[1] = result;
    tmp = callback4(require(15313) /* CategoryChannel */.RedesignVoiceUserSummary, obj);
  }
  if (require(7035) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return null;
    ...
    if (c9) {
      ...
      tmp19 = null;
      if (flag) {
        tmp19 = callback4(importDefault(11725), {});
      }
    }
    return tmp19;
  } else {
      ...
      if (guildChannels.recentsSectionNumber !== section) {
        if (guildChannels.voiceChannelsSectionNumber === section) {
          ...
          if (obj.render) {
            ...
            obj3[1] = section;
            obj3[2] = ref;
            obj2[1] = callback4(importDefault(15401), obj3);
...
export const getChannelListSectionFooterSize = function getChannelListSectionFooterSize(guildChannels, section, result, c9) {
  ...
  let num = 0;
  if (null != result) {
    num = require(15337) /* VOICE_USER_SUMMARY_HEIGHT */.VOICE_USER_SUMMARY_HEIGHT;
  }
  if (require(7035) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return 0;
...
export const calculateVoiceSummary = function calculateVoiceSummary(arg0) {
  ...
  let obj = require(15388) /* isFavoritesSection */;
