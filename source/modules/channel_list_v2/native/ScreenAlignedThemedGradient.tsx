...
// Dependencies: [17, 21, 4255, 10138, 8176, 4799, 15033, 4116, 2]
// Exports: ScreenAlignedThemedGradientSliding, default

// Module 15224 (ScreenAlignedThemedGradient)
...
let closure_6 = createCacheKey.createStyles((arg0, arg1) => {
  ...
  obj = { translateX: importDefault(10138)(-arg0) };
  const items = [obj, { translateY: importDefault(10138)(-arg1) }];
  obj.transform = items;
  obj[0] = obj;
  return obj;
});
...
export default function ScreenAlignedThemedGradient(arg0) {
  ...
  obj = { pointerEvents: "none", style: callback(offsetX, offsetY).container, children: jsx(importDefault(4799), { absolute: true, tall: true, wide: true, mix: isClientThemeOrCustomThemeActive }) };
  return <closure_4 pointerEvents="none" style={callback(offsetX, offsetY).container}>{jsx(importDefault(4799), { absolute: true, tall: true, wide: true, mix: isClientThemeOrCustomThemeActive })}</closure_4>;
};
