...
// Dependencies: [19, 21, 1297, 11596, 4298, 1236, 1879, 2]
// Exports: renderChannelBadge

// Module 11597 (renderChannelBadge)
import "noop";
...
export const renderChannelBadge = function renderChannelBadge(newChannel) {
  ...
  if (flag) {
    tmp2 = jsx(require(11596) /* renderChannelBadge */.NewBadge, {});
  } else {
    if (null != newPostCount) {
      if (newPostCount > 0) {
        ...
        tmp2 = jsx(require(4298) /* Text */.Text, { variant: "text-xs/bold", color: "text-brand", children: null });
    ...
    if (null != postsWithUnreadsCount) {
      if (postsWithUnreadsCount > 0) {
        ...
        tmp2 = jsx(require(4298) /* Text */.Text, { variant: "text-xs/bold", color: "text-muted", children: null });
      }
    }
    tmp2 = null;
