...
// Dependencies: [19, 21, 1297, 11666, 4299, 1236, 1898, 2]
// Exports: renderChannelBadge

// Module 11667 (renderChannelBadge)
import "noop";
...
export const renderChannelBadge = function renderChannelBadge(newChannel) {
  ...
  if (flag) {
    tmp2 = jsx(require(11666) /* renderChannelBadge */.NewBadge, {});
  } else {
    ...
    if (null != postsWithUnreadsCount) {
      if (postsWithUnreadsCount > 0) {
        ...
        tmp2 = jsx(require(4299) /* Text */.Text, { variant: "text-xs/bold", color: "text-muted", children: null });
      }
    }
    tmp2 = null;
