...
// Module 14852 (ChannelListStickyHeader)
...
let closure_10 = arg1(dependencyMap[6]).createStyles((arg0) => {
  ...
  let obj = { chevron: { "Bool(false)": false, <string:1419386345>: true } };
  ...
  const obj3 = { -9223372036854775808: true, filter: true, paddingHorizontal: importDefault(dependencyMap[7]).space.PX_16, gap: importDefault(dependencyMap[7]).space.PX_8 };
  obj.subheader = obj3;
  const obj4 = {};
...
export default function ChannelListStickyHeader(guild) {
  ...
  if (null != tmp5) {
    ...
    if (tmp5 > 0) {
      ...
      const obj6 = { "Bool(false)": "M44.2994 29.7789H30.1249C29.6356 29.7789 29.239 30.18 29.239 30.6745C29.239 31.1692 29.6356 31.5701 30.1249 31.5701H44.2994C44.7885 31.5701 45.1853 31.1692 45.1853 30.6745C45.1853 30.18 44.7885 29.7789 44.2994 29.7789Z", "Bool(false)": "white", "Bool(false)": "white", "Bool(false)": "0.723776", variant: token1 };
      ...
      const obj9 = { "Bool(false)": "M44.2994 29.7789H30.1249C29.6356 29.7789 29.239 30.18 29.239 30.6745C29.239 31.1692 29.6356 31.5701 30.1249 31.5701H44.2994C44.7885 31.5701 45.1853 31.1692 45.1853 30.6745C45.1853 30.18 44.7885 29.7789 44.2994 29.7789Z", "Bool(false)": "white", "Bool(false)": "white", "Bool(false)": "0.723776", variant: token1 };
  ...
  if (flag) {
    tmp34 = null;
    if (!enabled) {
      const obj10 = { "Bool(true)": null, "Bool(true)": null, "Bool(true)": null, guild };
