...
// Dependencies: [19, 17, 673, 21, 4218, 4481, 709, 16026, 1911, 1233, 16058, 13917, 16056, 5565, 4197, 10164, 4477, 8670, 1296, 7149, 16072, 12229, 16077, 16078, 2]
// Exports: default

// Module 16057 (ChannelListStickyHeader)
import ThemesDefault from "Themes" /* 709 */;
import GuildBadgeV2Default from "GuildBadgeV2" /* 8670 */;
...
let closure_9 = createCacheKey.createStyles(() => {
  ...
  obj[2] = num;
  obj[1] = obj;
  obj = { height: 1, backgroundColor: tmp(709).colors.BORDER_SUBTLE, marginHorizontal: tmp(709).space.PX_16 };
  obj[2] = obj;
  obj[3] = { margin: 0 };
  obj[4] = { flexShrink: 1 };
...
export default function ChannelListStickyHeader(guild) {
  ...
  const token = guild(4197).useToken(tmp2(709).modules.mobile.CHANNEL_LIST_TITLE_TEXT_STYLE);
  const tmp6Result1 = guild(4197);
  const tmp8 = isFavoritesGuildIdResult ? t.hW8QDk : t["Gpyp/e"];
  const token1 = guild(4197).useToken(tmp2(709).modules.mobile.CHANNEL_LIST_SUBTITLE_TEXT_STYLE);
  ...
  if (isFavoritesGuildIdResult) {
    ...
    tmp22 = callback(tmp6(10164).StarIcon, obj1);
  }
  const items2 = [tmp22, , , ];
  const tmp16 = closure_8;
  const tmp6Result2 = guild(4197);
  items2[1] = callback(closure_4, { ref, collapsable: false, style: tmp.flex, children: callback(guild(4477).Text, { experimental_useNativeText: true, color: "mobile-text-heading-primary", variant: token, lineClamp: 1, children: favoritesAwareGuildName }) });
  const obj3 = { guild, size: null, style: null };
  const obj2 = { ref, collapsable: false, style: tmp.flex, children: callback(guild(4477).Text, { experimental_useNativeText: true, color: "mobile-text-heading-primary", variant: token, lineClamp: 1, children: favoritesAwareGuildName }) };
  obj3[1] = guild(1296).Icon.Sizes.REFRESH_SMALL_16;
  ...
  if (flag2) {
    ...
    obj4[2] = tmp.chevron;
    tmp24Result = tmp24(tmp6(7149).ChevronSmallRightIcon, obj4);
  }
  ...
  if (null != tmp10) {
    ...
    if (tmp10 > 0) {
      ...
      obj7[0] = tmp10;
      obj6[4] = intl2.format(tmp6(1233).t.zRl6XR, obj7);
      const items4 = [tmp24(tmp6(4477).Text, obj6), , ];
      ...
      obj9[4] = intl3.string(tmp6(1233).t["1g9A/f"]);
      items4[2] = tmp24(tmp6(4477).Text, obj9);
      obj5[1] = items4;
  ...
  tmp24Result = null;
  if (isFavoritesGuildIdResult) {
    tmp24Result = tmp24(tmp6(16072).FavoritesGuildHeaderActionButton, {});
  }
  ...
  if (flag) {
    ...
    obj12[0] = guild;
    tmp24Result1 = tmp24(tmp2(12229), obj12);
  }
  ...
  if (tmp24Result2) {
    ...
    obj13[1] = tmp24(tmp2(16077), obj14);
  ...
  if (flag3) {
    ...
    obj16[0] = ref;
    obj16[1] = guild;
    tmp24Result3 = tmp24(tmp2(16078), obj16);
  }
