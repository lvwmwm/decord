...
let closure_7 = require("module_4036").createAnimatedComponent(Pressable);
...
export default function ChannelListStickyHeader(guild) {
  ...
  if (isFavoritesGuildIdResult) {
    ...
    tmp22 = callback(tmp6(8744).StarIcon, obj1);
  }
  const items2 = [tmp22, , , ];
  ...
  items2[2] = callback(importDefault(9263), obj3);
  let tmp24Result = null;
  if (flag2) {
    const obj4 = { size: "xxs", color: null, style: null };
    obj4[1] = tmp(712).colors.TEXT_SUBTLE;
    obj4[2] = tmp4.chevron;
    tmp24Result = tmp24(tmp6(5778).ChevronSmallRightIcon, obj4);
  }
  ...
  if (null != tmp10) {
    ...
    if (tmp10 > 0) {
      ...
      const items4 = [tmp24(tmp6(4299).Text, obj6), , ];
      ...
      items4[2] = tmp24(tmp6(4299).Text, obj9);
      obj5[1] = items4;
