...
// Dependencies: [32, 19, 17, 4336, 1391, 7137, 4356, 4539, 9841, 4540, 21, 4344, 7029, 4760, 8049, 14407, 636, 643, 589, 4083, 15330, 7682, 4313, 4314, 15378, 2]
...
function shouldSkipSection(diff1) {
  if (require(7029) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES !== diff1) {
    if (require(7029) /* computeSubtitle */.SECTION_INDEX_GUILD_ACTIONS !== diff1) {
      return false;
    }
  }
  return true;
...
function findNearestUnreadItem(containerSize, id) {
  ...
  if (null == MENTION) {
    ...
    const result = getScaledChannelRowHeight(require(4760) /* getFontScale */.getFontScale()) / 2;
    ...
    for (const item10031 of items) {
      ...
      if (item10031.layoutStart >= layoutStart) {
        ...
        if (tmp12.type === require(8049) /* renderDefaultEmpty */.FastListItemTypes.ITEM) {
          let tmp16 = item10031;
          if (tmp12.layoutStart > tmp8) {
            ...
            let tmp19 = tmp70;
            let tmp20 = tmp72;
            if (tmp12.type !== tmp71(8049).FastListItemTypes.ITEM) {
              tmp9 = item10031;
            } else {
    ...
    const obj6 = require(4760) /* getFontScale */;
  }
}
