...
// Dependencies: [32, 19, 17, 4372, 1391, 7242, 4395, 4589, 9950, 4590, 21, 4380, 7134, 4821, 8159, 14550, 636, 643, 589, 4120, 15489, 7785, 4348, 4349, 15539, 2]

// Module 15538 (shouldSkipSection)
      ...
      if (item10031.layoutStart >= layoutStart) {
        ...
        if (tmp12.type === renderDefaultEmpty.FastListItemTypes.ITEM) {
          ...
          if (tmp12.layoutStart > tmp8) {
            ...
            let tmp19 = tmp70;
            let tmp20 = tmp72;
            if (tmp12.type !== tmp71(8159).FastListItemTypes.ITEM) {
              tmp9 = item10031;
            } else {
