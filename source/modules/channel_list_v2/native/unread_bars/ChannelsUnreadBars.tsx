...
// Dependencies: [32, 19, 17, 4277, 1372, 7018, 4297, 4480, 9712, 4481, 21, 4285, 6908, 4701, 7931, 14256, 636, 643, 589, 4145, 15168, 7562, 4254, 4255, 15204, 2]

// Module 15203 (shouldSkipSection)
...
function shouldSkipSection(diff1) {
  if (require(6908) /* computeSubtitle */.SECTION_INDEX_CHANNEL_NOTICES !== diff1) {
    if (require(6908) /* computeSubtitle */.SECTION_INDEX_GUILD_ACTIONS !== diff1) {
      return false;
    }
  }
  return true;
  ...
  if (null == MENTION) {
    ...
    for (const item10031 of items) {
      ...
      if (item10031.layoutStart >= layoutStart) {
        ...
        if (tmp12.type === require(7931) /* renderDefaultEmpty */.FastListItemTypes.ITEM) {
          let tmp16 = item10031;
          if (tmp12.layoutStart > tmp8) {
            ...
            let tmp19 = tmp70;
            let tmp20 = tmp72;
            if (tmp12.type !== tmp71(7931).FastListItemTypes.ITEM) {
              tmp9 = item10031;
            } else {
