...
// Dependencies: [32, 19, 17, 4669, 1391, 5388, 4777, 5048, 10094, 5049, 21, 4668, 5277, 4756, 8163, 14520, 636, 643, 589, 4119, 15458, 7964, 4347, 4348, 15507, 2]

// Module 15506 (shouldSkipSection)
...
import closure_8 from "updateGuildUnreadSentinel" /* 5388 */;
import closure_9 from "generateOldThreadCutoff" /* 4777 */;
import closure_10 from "updateUserGuildSettingsInternal" /* 5048 */;
import { getScaledChannelRowHeight } from "hairlineWidth" /* 10094 */;
      ...
      if (item10031.layoutStart >= layoutStart) {
        ...
        if (tmp12.type === renderDefaultEmpty.FastListItemTypes.ITEM) {
          ...
          if (tmp12.layoutStart > tmp8) {
            ...
            let tmp19 = tmp70;
            let tmp20 = tmp72;
            if (tmp12.type !== tmp71(8163).FastListItemTypes.ITEM) {
              tmp9 = item10031;
            } else {
