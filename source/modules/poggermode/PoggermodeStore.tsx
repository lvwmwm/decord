...
// Function ID: 7185
// Name: updateCombo
// Dependencies: [1218, 1931, 7032, 7033, 676, 3879, 4140, 7185, 1231, 589, 709, 2]
// Exports: getComboId, isComboing, shouldTrackMessage

// Module 7184 (updateCombo)
...
prototype["getComboScore"] = function getComboScore(arg0, arg1) {
  ...
  let num = 0;
  if (null != value) {
    num = require(7185) /* getComboShakeIntensity */.getComboScore(value);
    const obj = require(7185) /* getComboShakeIntensity */;
  }
  return num;
};
...
prototype["getUserComboShakeIntensity"] = function getUserComboShakeIntensity(id, throwTypeErrorResult, arg2, LEVEL_4) {
  ...
  let num = 0;
  if (null != userCombo) {
    num = require(7185) /* getComboShakeIntensity */.getComboShakeIntensity(userCombo, LEVEL_4) * arg2;
    const obj = require(7185) /* getComboShakeIntensity */;
  }
  return num;
};
