...
// Dependencies: [6, 7, 15, 17, 18, 1194, 1907, 5944, 5945, 653, 3789, 4050, 6125, 1207, 566, 686, 2]

// Module 6124 (_isNativeReflectConstruct)
...
function updateCombo(value) {
  ...
  if (null == decayInterval) {
    const Interval = obj(4050).Interval;
          ...
          if (closure_9.screenshakeEnabledLocations[constants.MENTION]) {
            if (null != mentions) {
              if (null != mentions.find((id) => id.id === id)) {
                if (null != value) {
                  const comboShakeIntensity = id(6125).getComboShakeIntensity(value, LEVEL_4.LEVEL_4);
                  let num3 = 0.001;
