...
export default function CaptchaModal(arg0) {
  ...
  let obj = { headerStyle: null, headerShadowVisible: null };
  ...
  const obj2 = { hasMaxConnections: true, isBoostOnlySubscription: "md", style: tmp.description };
  if (null == bodyText) {
