// Module ID: 17206
// Function ID: 17207
// Dependencies: [4186, 11211, 586, 4448, 17207, 2008, 11209, 2]
...
export default {
  showCaptcha(options) {
    ...
    obj2.openLazy(_require(2008)(17207, dependencyMap.paths), CAPTCHA_MODAL_KEY, obj);
  },
  showCaptchaAsync(nextResult1) {
    ...
    return new Promise((arg0, arg1) => {
      ...
      obj = {
        ...
        onReject(arg0) {
          if (arg0 === obj(11209).CaptchaError.CANCEL) {
            const captchaCancelError = new obj(11209).CaptchaCancelError();
        ...
        close() {
          return callback2(4448).hideActionSheet(closure_4);
        }
      };
