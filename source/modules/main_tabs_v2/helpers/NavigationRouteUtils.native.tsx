...
// Dependencies: [57, 31, 653, 4017, 491, 1457, 4018, 4023, 4024, 2]
  ...
  if (null != rootNavigationRef) {
    if (rootNavigationRef.isReady()) {
      if (resetRoot) {
        ...
        obj = { name: "tabs" };
        const obj3 = require(4018) /* wrapRouteForRootNavigator */;
...
export const pushModal = function pushModal(key) {
  ...
  let flag = !tmp4;
  if (flag) {
    require(4024) /* getHighestActiveScreenIndex */.dismissKeyboard();
    obj = { name: "modal" };
    if (null == key) {
      const _HermesInternal = HermesInternal;
    ...
    rootNavigationRef.navigate(obj);
    flag = true;
    const obj4 = require(4024) /* getHighestActiveScreenIndex */;
  }
  return flag;
};
export { popModal };
...
export const popScreens = function popScreens(arg0) {
  const _require = arg0;
  const rootNavigationRef = _require(4017).getRootNavigationRef();
  let flag = null != rootNavigationRef;
  if (flag) {
    rootNavigationRef.dispatch(() => {
      let callback;
