...
// Dependencies: [32, 19, 676, 4041, 514, 1481, 4042, 4047, 4048, 2]
...
// Module 4040 (navigationToRootTabHelper)
...
export const resetToAuthRoute = function resetToAuthRoute() {
  ...
  if (!tmp) {
    rootNavigationRef.dispatch(() => {
      ...
      return CommonActions.reset(callback(4042).getInitialAuthState());
    });
    flag = true;
  }
  return flag;
...
export const popModalsAboveKey = function popModalsAboveKey(voiceChannelKey) {
  ...
  if (null != rootNavigationRef) {
    if (rootNavigationRef.isReady()) {
      const rootNavigationRef1 = require(4041) /* getRootNavigationRef */.getRootNavigationRef();
      let tmp3;
      ...
      const tmpResult = require(4041) /* getRootNavigationRef */;
    }
  }
  return false;
};
...
export const popScreens = function popScreens(arg0) {
  const _require = arg0;
  const rootNavigationRef = _require(4041).getRootNavigationRef();
  let flag = null != rootNavigationRef;
  if (flag) {
    rootNavigationRef.dispatch(() => {
      let callback;
