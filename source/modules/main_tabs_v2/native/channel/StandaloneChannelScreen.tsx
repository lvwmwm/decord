...
// Function ID: 15640
// Name: Header
// Dependencies: [19, 17, 1372, 8383, 676, 1379, 21, 4303, 712, 1481, 1609, 8391, 589, 1894, 9704, 1236, 4158, 8598, 8384, 5715, 12543, 8394, 10444, 4745, 5844, 4239, 1348, 8895, 12553, 4161, 1297, 4848, 15640, 15657, 15675, 15692, 10315, 15696, 2]
...
const memoResult = importAllResult.memo(function StandaloneChannelScreen(arg0) {
  ...
  const needSubscriptionToAccess = importDefault(4745)(channelId).needSubscriptionToAccess;
  let obj2 = frame(5844);
  let tmp6 = guildId;
  if (guildId == null) {
    tmp6 = closure_8;
  ...
  const tmp9 = importDefault(4239)() === constants.MIDNIGHT;
