...
// Function ID: 12422
// Name: ChannelHeader
// Dependencies: [19, 1372, 676, 1379, 21, 500, 4114, 10331, 1231, 4107, 647, 4468, 12422, 12423, 12424, 12430, 1236, 12432, 2]
// Exports: default, navigateToChannelDetails

// Module 12421 (ChannelHeader)
import "noop";
...
export default function ChannelHeader(channelId) {
  ...
  if (channelId === StaticChannelRoute.ROLE_SUBSCRIPTIONS) {
    let tmp8Result = jsx(importDefault(12422), {});
  } else if (channelId === tmp5.GUILD_HOME) {
    tmp8Result = jsx(importDefault(12423), {});
  } else {
    let isPrivateResult;
    ...
    if (isPrivateResult) {
      ...
      obj[1] = tmp4;
      obj[2] = screenIndex;
      tmp8Result = jsx(importDefault(12424), { channelId: null, pressable: null, screenIndex: null });
    } else {
