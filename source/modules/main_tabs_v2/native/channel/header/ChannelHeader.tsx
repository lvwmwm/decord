...
// Function ID: 12459
// Name: ChannelHeader
// Dependencies: [19, 1372, 676, 1379, 21, 500, 4143, 10362, 1231, 4136, 647, 4498, 12459, 12460, 12461, 12467, 1236, 12469, 2]
// Exports: default, navigateToChannelDetails

// Module 12458 (ChannelHeader)
import "noop";
...
export default function ChannelHeader(channelId) {
  ...
  if (channelId === StaticChannelRoute.ROLE_SUBSCRIPTIONS) {
    let tmp8Result = jsx(importDefault(12459), {});
  } else if (channelId === tmp5.GUILD_HOME) {
    tmp8Result = jsx(importDefault(12460), {});
  } else {
    let isPrivateResult;
    ...
    if (isPrivateResult) {
      ...
      obj[1] = tmp4;
      obj[2] = screenIndex;
      tmp8Result = jsx(importDefault(12461), { channelId: null, pressable: null, screenIndex: null });
    } else {
...
export const navigateToChannelDetails = function navigateToChannelDetails(channelId, screenIndex, arg2) {
  ...
  if (tmpResult.isSwipeToMemberListEnabled()) {
    ...
    const rootNavigationRef = tmp(4136).getRootNavigationRef();
    let isReadyResult;
