...
const memoResult = require("noop").memo((arg0) => {
  ...
  let obj = require(12618) /* useIsForumChannelSearchActive */;
  if (obj.useIsForumChannelSearchActive(channelId)) {
    ...
    obj[1] = tmp4(require(12604) /* ForumChannelCloseSearchButton */.ForumChannelSearchInput, obj);
    ...
    obj1[5] = screenIndex;
    tmp4Result = tmp4(importDefault(12619), obj1);
  }
  return tmp4Result;
});
