// Module ID: 12618
// Function ID: 12619
// Dependencies: [19, 17, 8432, 21, 4342, 12619, 12605, 12620, 2]
...
const memoResult = require("noop").memo((arg0) => {
  ...
  let obj = require(12619) /* useIsForumChannelSearchActive */;
  if (obj.useIsForumChannelSearchActive(channelId)) {
    ...
    obj[1] = tmp4(require(12605) /* ForumChannelCloseSearchButton */.ForumChannelSearchInput, obj);
    ...
    obj1[5] = screenIndex;
    tmp4Result = tmp4(importDefault(12620), obj1);
  }
  return tmp4Result;
});
