// Module ID: 12467
// Function ID: 12468
// Dependencies: [19, 17, 8306, 21, 4285, 12468, 12454, 12469, 2]
...
const memoResult = require("noop").memo((arg0) => {
  ...
  let obj = require(12468) /* useIsForumChannelSearchActive */;
  if (obj.useIsForumChannelSearchActive(channelId)) {
    ...
    obj[1] = tmp4(require(12454) /* ForumChannelCloseSearchButton */.ForumChannelSearchInput, obj);
    ...
    obj1[5] = screenIndex;
    tmp4Result = tmp4(importDefault(12469), obj1);
  }
  return tmp4Result;
});
