// Module ID: 12430
// Function ID: 12431
// Dependencies: [19, 17, 8166, 21, 4255, 12431, 12417, 12432, 2]
...
const memoResult = require("noop").memo((arg0) => {
  ...
  let obj = require(12431) /* useIsForumChannelSearchActive */;
  if (obj.useIsForumChannelSearchActive(channelId)) {
    ...
    obj[1] = tmp4(require(12417) /* ForumChannelCloseSearchButton */.ForumChannelSearchInput, obj);
    ...
    obj1[5] = screenIndex;
    tmp4Result = tmp4(importDefault(12432), obj1);
  }
  return tmp4Result;
});
