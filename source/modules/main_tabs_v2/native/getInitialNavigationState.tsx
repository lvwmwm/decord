...
// Dependencies: [32, 1218, 4105, 1960, 676, 3, 4138, 1222, 4106, 4119, 4141, 2]
// Exports: computeInitialNavigationState, default, getInitialAuthState, wrapRouteForRootNavigator

// Module 4137 (getInitialGuildState)
...
function getInitialGuildState(closure_6, channelId, flag, flag2) {
  ...
  let obj = require(4138) /* useChatLayout */;
...
function computeInitialNavigationStateWithoutLogging() {
  ...
  if (null != token.getToken()) {
    ...
    let obj2 = require(4106) /* matchPath */;
    let obj = { path: null };
    const RouteParam = require(4119) /* RouteParam */.RouteParam;
    const RouteParam2 = require(4119) /* RouteParam */.RouteParam;
