...
// Dependencies: [19, 17, 21, 8353, 4255, 712, 5650, 6828, 1581, 8165, 1236, 9568, 15799, 15818, 15819, 2]
// Exports: default

// Module 15798 (MessageRequestsNavigator)
...
export default function MessageRequestsNavigator() {
  ...
  let merged = Object.assign(importDefault(9568)());
  obj1[1] = obj2;
  ...
  let merged1 = Object.assign(importDefault(9568)());
  obj3[1] = obj4;
  ...
  const merged2 = Object.assign(importDefault(9568)());
  obj5[1] = obj6;
