// Module ID: 16031
// Function ID: 16032
// Dependencies: [32, 19, 17, 21, 4342, 712, 9005, 1236, 16032, 16048, 9191, 9611, 11345, 2]
...
const memoResult = importAllResult.memo((navigation) => {
  ...
  obj[2] = callback2(importDefault(16032), { goToMessageRequestPreview: callback });
  const items1 = [obj, ];
  const obj1 = { label: null, id: null, page: null };
  const intl2 = navigation(1236).intl;
  obj1[0] = intl2.string(navigation(1236).t.ulKXHp);
  obj1[1] = constants.SPAM;
  obj1[2] = callback2(importDefault(16048), { goToMessageRequestPreview: callback });
  items1[1] = obj1;
  obj[0] = items1;
  obj[1] = tmp2[0];
