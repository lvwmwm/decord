...
// Dependencies: [19, 4315, 676, 21, 11800, 9744, 9748, 15959, 10315, 2]
// Exports: default

// Module 15958 (MessageRequestsScreen)
...
export default function MessageRequestsScreen(route) {
  ...
  if (isMessageRequestRestrictedViewer) {
    obj = { channelId: null };
    obj[0] = channelId;
    let tmp5Result = tmp5(tmp7(15959), obj);
  } else {
    const obj1 = { guildId: null, channelId: null, chatInputRef: null, HACK_fixModalInteraction: true, screenIndex: "message-request" };
    obj1[0] = tmp6;
    obj1[1] = channelId;
    obj1[2] = ref;
    tmp5Result = tmp5(tmp7(10315), obj1);
  }
  obj[2] = tmp5Result;
  return jsx(channelId(9748).ChannelContainer, { guildId: ME, channelId, children: null });
};
