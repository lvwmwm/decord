...
// Dependencies: [12827, 14217, 12828, 589, 2]
// Exports: useConnectionBannerHeight

// Module 14220 (useConnectionBannerHeight)
...
export const useConnectionBannerHeight = function useConnectionBannerHeight() {
  let hidden;
  let timeoutMs;
  const config = importDefault(12828).useConfig({ location: "useConnectionBannerHeight" });
