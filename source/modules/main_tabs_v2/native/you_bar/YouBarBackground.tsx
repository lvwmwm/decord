...
// Dependencies: [19, 17, 14254, 21, 4285, 712, 5293, 4706, 689, 3988, 14337, 4145, 4694, 2]

// Module 15392 (YouBarMaskedBackground)
...
function YouBarAnimatedBackground(arg0) {
  ...
  const tmp3 = importDefault(14337)(token);
  _require = tmp3;
  const tmp4 = importDefault(14337)(token, YOU_BAR_HEIGHT / 2);
  importDefault = tmp4;
  const tmp = callback3();
  const fn = function u() {
  ...
  const animatedStyle = _require(4145).useAnimatedStyle(fn);
  ...
  return callback(importDefault(4145).View, { style });
}
