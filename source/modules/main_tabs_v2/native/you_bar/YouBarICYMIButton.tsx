// Module ID: 15422
// Function ID: 15423
// Dependencies: [19, 14268, 21, 4302, 712, 15423, 15424, 12219, 4153, 1236, 2]
...
const memoResult = require("noop").memo(function YouBarICYMIButton(hasNameplate) {
  ...
  obj[2] = str;
  obj[1] = jsx(require(12219) /* FlashIcon */.FlashIcon, { size: "custom", style: tmp.icon, color: null });
  obj[2] = importDefault(15423)().showDot;
  obj[3] = tmp.badge;
  ...
  return jsx(importDefault(15424), { size: "custom", style: tmp.icon, color: null });
});
