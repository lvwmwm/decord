// Module ID: 15497
// Function ID: 15498
// Dependencies: [19, 14338, 21, 4303, 712, 15498, 15499, 12286, 4159, 1236, 2]
...
const memoResult = require("noop").memo(function YouBarICYMIButton(hasNameplate) {
  ...
  obj[2] = str;
  obj[1] = jsx(require(12286) /* FlashIcon */.FlashIcon, { size: "custom", style: tmp.icon, color: null });
  obj[2] = importDefault(15498)().showDot;
  obj[3] = tmp.badge;
  ...
  return jsx(importDefault(15499), { size: "custom", style: tmp.icon, color: null });
});
