// Module ID: 15505
// Function ID: 15506
// Dependencies: [19, 14340, 21, 4303, 712, 15506, 15507, 12288, 4159, 1236, 2]
...
const memoResult = require("noop").memo(function YouBarICYMIButton(hasNameplate) {
  ...
  obj[2] = str;
  obj[1] = jsx(require(12288) /* FlashIcon */.FlashIcon, { size: "custom", style: tmp.icon, color: null });
  obj[2] = importDefault(15506)().showDot;
  obj[3] = tmp.badge;
  ...
  return jsx(importDefault(15507), { size: "custom", style: tmp.icon, color: null });
});
