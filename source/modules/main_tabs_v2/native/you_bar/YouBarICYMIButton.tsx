// Module ID: 15174
// Function ID: 115593
// Dependencies: [31, 14058, 33, 4131, 689, 15175, 15176, 11936, 3983, 1212, 2]
...
const memoResult = require("result").memo(function YouBarICYMIButton(hasNameplate) {
  ...
  obj.color = str;
  obj.icon = jsx(require(11936) /* FlashIcon */.FlashIcon, { size: "custom", style: tmp.icon });
  obj.hasBadge = importDefault(15175)().showDot;
  ...
  return jsx(importDefault(15176), { size: "custom", style: tmp.icon });
});
