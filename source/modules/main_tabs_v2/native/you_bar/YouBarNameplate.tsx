// Module ID: 15972
// Function ID: 15973
// Dependencies: [19, 4470, 14699, 21, 4197, 712, 14785, 589, 4217, 4927, 8522, 2]

// Module 15972
import closure_3 from "maybeApplyNoTextColorForLightCustomTheme" /* 4470 */;
import { YOU_BAR_SPRING_CONFIG } from "CONNECTION_BANNER_HEIGHT" /* 14699 */;
...
const memoResult = importAllResult.memo(function YouBarNameplate(isQuestRendered) {
  ...
  obj2[2] = str;
  obj1[2] = jsx(token(8522), { nameplate, isFocused: true, animate: null });
