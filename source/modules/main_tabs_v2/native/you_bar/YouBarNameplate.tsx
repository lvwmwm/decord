// Module ID: 16308
// Function ID: 16309
// Dependencies: [19, 4473, 15022, 21, 4197, 709, 15108, 586, 4218, 4935, 8748, 2]

// Module 16308
import closure_3 from "maybeApplyNoTextColorForLightCustomTheme" /* 4473 */;
import { YOU_BAR_SPRING_CONFIG } from "CONNECTION_BANNER_HEIGHT" /* 15022 */;
...
const memoResult = importAllResult.memo(function YouBarNameplate(isQuestRendered) {
  ...
  obj = { withSpring: isQuestRendered(4935).withSpring, isQuestRendered, questDockAnimatedBorderRadius: tmp4, borderRadius: token, YOU_BAR_SPRING_CONFIG };
  fn.__closure = obj;
  ...
  obj2[2] = str;
  obj1[2] = jsx(token(8748), { nameplate, isFocused: true, animate: null });
  return jsx(token(4218).View, { style: items1, pointerEvents: "none", children: null });
});
