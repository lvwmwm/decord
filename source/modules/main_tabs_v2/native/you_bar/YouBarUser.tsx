// Module ID: 15356
// Function ID: 15357
// Dependencies: [19, 17, 1874, 14217, 21, 4255, 712, 589, 4116, 4664, 4094, 15357, 15358, 15359, 2]
...
const memoResult = importAllResult.memo(function YouBarUser(isQuestRendered) {
  ...
  if (null != stateFromStores) {
    if (null != name) {
      ...
      const items2 = [callback(tmp9(15358), obj), ];
      ...
      obj2[1] = name;
      obj1[1] = callback(tmp9(15359), obj2);
  ...
  const items5 = [callback(sharedValue(15357), { isLarge: !isQuestRendered }), ];
