// Module ID: 15418
// Function ID: 15419
// Dependencies: [19, 17, 1903, 14268, 21, 4302, 712, 589, 4162, 4711, 4140, 15419, 15420, 15421, 2]
...
const memoResult = importAllResult.memo(function YouBarUser(isQuestRendered) {
  ...
  const animatedStyle = _require(4162).useAnimatedStyle(S);
  let obj3 = sharedValue(4140);
  ...
  if (null != stateFromStores) {
    if (null != name) {
      ...
      const items2 = [callback(tmp9(15420), obj), ];
      ...
      obj2[1] = name;
      obj1[1] = callback(tmp9(15421), obj2);
      items2[1] = callback(tmp9(4162).View, obj1);
      obj[1] = items2;
    }
  ...
  const items5 = [callback(sharedValue(15419), { isLarge: !isQuestRendered }), ];
  ...
  items5[1] = callback(sharedValue(4162).View, obj4);
  obj3[1] = items5;
  obj = obj3;
});
