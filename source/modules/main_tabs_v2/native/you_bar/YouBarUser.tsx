// Module ID: 15345
// Function ID: 15346
// Dependencies: [19, 17, 1874, 14210, 21, 4255, 712, 589, 4116, 4665, 4094, 15346, 15347, 15348, 2]
...
const memoResult = importAllResult.memo(function YouBarUser(isQuestRendered) {
  ...
  const animatedStyle = _require(4116).useAnimatedStyle(S);
  let obj3 = sharedValue(4094);
  ...
  if (null != stateFromStores) {
    if (null != name) {
      ...
      const items2 = [callback(tmp9(15347), obj), ];
      ...
      obj2[1] = name;
      obj1[1] = callback(tmp9(15348), obj2);
      items2[1] = callback(tmp9(4116).View, obj1);
      obj[1] = items2;
    }
  ...
  const items5 = [callback(sharedValue(15346), { isLarge: !isQuestRendered }), ];
  ...
  items5[1] = callback(sharedValue(4116).View, obj4);
  obj3[1] = items5;
  obj = obj3;
});
