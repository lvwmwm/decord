// Module ID: 15710
// Function ID: 15711
// Dependencies: [19, 17, 1922, 14518, 21, 4668, 712, 589, 4119, 4749, 4223, 15711, 15712, 15713, 2]
...
const memoResult = importAllResult.memo(function YouBarUser(isQuestRendered) {
  ...
  const animatedStyle = _require(4119).useAnimatedStyle(S);
  ...
  const tmp2 = _require;
  const tmp2Result = _require(4119);
