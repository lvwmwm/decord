// Module ID: 15583
// Function ID: 15584
// Dependencies: [19, 17, 1922, 14414, 21, 4342, 712, 589, 4083, 4754, 4187, 15584, 15585, 15586, 2]
...
const memoResult = importAllResult.memo(function YouBarUser(isQuestRendered) {
  ...
  if (null != stateFromStores) {
    if (null != name) {
      ...
      const items2 = [callback(tmp9(15585), obj), ];
      ...
      obj2[1] = name;
      obj1[1] = callback(tmp9(15586), obj2);
  ...
  const items5 = [callback(sharedValue(15584), { isLarge: !isQuestRendered }), ];
