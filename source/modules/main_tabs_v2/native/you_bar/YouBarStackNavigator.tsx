...
// Dependencies: [19, 17, 1980, 4302, 11016, 21, 7844, 15937, 16325, 16373, 586, 16447, 8282, 6940, 7096, 2]

// Module 15936 (getGuildsComponent)
...
function getICYMIComponent() {
  return require(16373) /* ICYMINavigator */.default;
}
