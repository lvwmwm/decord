...
// Dependencies: [19, 17, 1981, 4267, 10751, 21, 7755, 15517, 15902, 15950, 589, 16024, 8554, 5960, 5892, 2]

// Module 15516 (getGuildsComponent)
...
function getICYMIComponent() {
  return require(15950) /* ICYMINavigator */.default;
}
