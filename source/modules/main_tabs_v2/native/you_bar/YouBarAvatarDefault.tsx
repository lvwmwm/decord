...
// Function ID: 15585
// Name: AvatarDefault
// Dependencies: [19, 17, 14414, 676, 21, 4342, 712, 4065, 1297, 8341, 7700, 2]

// Module 15584 (AvatarDefault)
...
function AvatarDefault() {
  ...
  const items2 = [callback(View, { style: tmp.placeholderAvatarBackground }), callback(require(7700) /* ReactionIcon */.ReactionIcon, { size: "custom", style: { width: tmp7, height: tmp7 }, color: "background-mod-strong" })];
  obj3[1] = items2;
  obj2[1] = callback2(View, obj3);
  const items3 = [callback(importDefault(8341), obj2), callback(require(1297) /* Button */.Status, { size: num, status: StatusTypes.OFFLINE, isMobileOnline: false, isVROnline: false, streaming: false, style: obj6 })];
  obj[1] = items3;
...
function AvatarDefaultLarge() {
  ...
  obj = { shape: require(8341) /* SolidCutout */.CutoutShape.Circle, x: diff + closure_10, y: diff + closure_10, size: 2 * sum };
  obj = { style: null, children: null };
  ...
  obj7[1] = obj8;
  items3[1] = callback(require(7700) /* ReactionIcon */.ReactionIcon, obj7);
  obj5[1] = items3;
  obj4[1] = callback2(View, obj5);
  const items4 = [callback(importDefault(8341), obj4), callback(require(1297) /* Button */.Status, { size: closure_8, status: StatusTypes.OFFLINE, isMobileOnline: false, isVROnline: false, streaming: false, style: obj10 })];
  obj2[1] = items4;
