...
// Function ID: 15420
// Name: AvatarDefault
// Dependencies: [19, 17, 14268, 676, 21, 4302, 712, 4005, 1297, 8233, 7595, 2]

// Module 15419 (AvatarDefault)
...
function AvatarDefault() {
  ...
  const items2 = [callback(View, { style: tmp.placeholderAvatarBackground }), callback(require(7595) /* ReactionIcon */.ReactionIcon, { size: "custom", style: { width: tmp7, height: tmp7 }, color: "background-mod-strong" })];
  obj3[1] = items2;
  obj2[1] = callback2(View, obj3);
  const items3 = [callback(importDefault(8233), obj2), callback(require(1297) /* Button */.Status, { size: num, status: StatusTypes.OFFLINE, isMobileOnline: false, isVROnline: false, streaming: false, style: obj6 })];
  obj[1] = items3;
...
function AvatarDefaultLarge() {
  ...
  obj = { shape: require(8233) /* SolidCutout */.CutoutShape.Circle, x: diff + closure_10, y: diff + closure_10, size: 2 * sum };
  obj = { style: null, children: null };
  ...
  obj7[1] = obj8;
  items3[1] = callback(require(7595) /* ReactionIcon */.ReactionIcon, obj7);
  obj5[1] = items3;
  obj4[1] = callback2(View, obj5);
  const items4 = [callback(importDefault(8233), obj4), callback(require(1297) /* Button */.Status, { size: closure_8, status: StatusTypes.OFFLINE, isMobileOnline: false, isVROnline: false, streaming: false, style: obj10 })];
  obj2[1] = items4;
