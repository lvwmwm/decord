...
// Function ID: 16311
// Name: AvatarDefault
// Dependencies: [19, 17, 15022, 673, 21, 4481, 709, 4197, 1296, 8743, 8687, 2]

// Module 16310 (AvatarDefault)
...
function AvatarDefault() {
  ...
  obj = { shape: tmp2(8743).CutoutShape.Circle, x: diff, y: diff, size: 2 * sum };
