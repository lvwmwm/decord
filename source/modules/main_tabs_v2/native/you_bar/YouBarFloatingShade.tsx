// Module ID: 15527
// Function ID: 15528
// Dependencies: [19, 17, 4124, 14348, 15424, 21, 4303, 589, 4024, 712, 14350, 1493, 4161, 15163, 4042, 4123, 688, 4725, 2]
...
const memoResult = require("noop").memo(function YouBarFloatingShade() {
  const tmp = callback3();
  let obj = require(14350) /* useYouBarTotalHeight */;
  ...
  const token = require(4024) /* map */.useToken(tmp6(712).colors.BACKGROUND_BASE_LOWER);
