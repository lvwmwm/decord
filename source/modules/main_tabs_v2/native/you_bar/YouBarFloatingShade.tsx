// Module ID: 15354
// Function ID: 15355
// Dependencies: [19, 17, 4067, 14210, 15248, 21, 4255, 589, 3959, 712, 14212, 1474, 4109, 15015, 4116, 4066, 688, 4677, 2]
...
const memoResult = require("noop").memo(function YouBarFloatingShade() {
  const tmp = callback3();
  let obj = require(14212) /* useYouBarTotalHeight */;
  ...
  items2[1] = callback(width(4677), { style: items3, colors: items4, start: { x: 0, y: 0 }, end: { x: 0, y: 1 }, locations: [0, 1], pointerEvents: "none" });
