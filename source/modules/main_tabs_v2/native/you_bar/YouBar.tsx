// Module ID: 15625
// Function ID: 15626
// Dependencies: [5, 32, 19, 17, 4195, 4197, 7250, 1922, 14450, 676, 1388, 21, 4661, 712, 1494, 14443, 10719, 4232, 14449, 14453, 4115, 4744, 9058, 15626, 589, 8961, 4219, 7256, 9287, 15628, 8375, 1236, 7360, 4230, 4343, 1370, 12, 15629, 2007, 4229, 9569, 7302, 1377, 15276, 6377, 1297, 15640, 15641, 15642, 15646, 15649, 4104, 15651, 15652, 2]
...
let closure_27 = importAllResult.memo(() => {
  ...
  let obj1 = isMobileQuestDockRenderedBase(14443);
  ...
  let filterPlayingActivities = youBarHorizontalMargin(4219).useName(stateFromStores);
  ...
  mergeGuildAvatar = isMobileQuestDockRenderedBase(9287).useGameMentionsAsPlainText(state);
  ...
  let closure_19 = isMobileQuestDockRenderedBase(4115).useSharedValue(0);
  ...
  obj[3] = items10;
  return closure_21(youBarHorizontalMargin(4115).View, obj);
});
const memoResult = importAllResult.memo(function YouBarThemed() {
  ...
  const items1 = [callback(importDefault(15651), {}), callback(closure_27, {}), callback(importDefault(15652), {})];
  obj[1] = items1;
