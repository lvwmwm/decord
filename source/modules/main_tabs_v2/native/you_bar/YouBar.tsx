// Module ID: 15566
// Function ID: 15567
// Dependencies: [5, 32, 19, 17, 4163, 4165, 5037, 1922, 14414, 676, 1388, 21, 4342, 712, 1493, 14407, 10970, 4200, 14413, 14417, 4083, 4754, 8963, 15567, 589, 8863, 4187, 9498, 9501, 15569, 8314, 1236, 6059, 4198, 4311, 1370, 12, 15570, 2007, 4197, 9602, 6000, 1377, 15222, 5467, 1297, 15581, 15582, 15583, 15587, 15590, 4072, 15592, 15593, 2]
...
let closure_27 = importAllResult.memo(() => {
  ...
  let obj1 = isMobileQuestDockRenderedBase(14407);
  isMobileQuestDockRenderedBase = obj1.useIsMobileQuestDockRenderedBase(mobileQuestDock);
  let obj2 = isMobileQuestDockRenderedBase(10970);
  const drawerWidth = obj2.useDrawerWidth();
  let obj3 = isMobileQuestDockRenderedBase(14413);
  ...
  obj = { withSpring: tmp4(4754).withSpring, barMarginBottom: youBarBottomMargin, connectionBannerHeight, YOU_BAR_SPRING_CONFIG: closure_14, isPressedValue: sharedValue, isQuestRendered: isMobileQuestDockRenderedBase };
  fn.__closure = obj;
  ...
  const iCYMIEnabled = isMobileQuestDockRenderedBase(8963).useICYMIEnabled("TabsNavigator");
  const tmp4Result3 = isMobileQuestDockRenderedBase(8963);
  const youBarCoachmark = isMobileQuestDockRenderedBase(15567).useYouBarCoachmark({ isQuestRendered: isMobileQuestDockRenderedBase });
  ...
  const tmp4Result4 = isMobileQuestDockRenderedBase(15567);
  ...
  const nameplate = isMobileQuestDockRenderedBase(8863).useNameplate({ user: stateFromStores });
  const tmp4Result6 = isMobileQuestDockRenderedBase(8863);
  ...
  const customStatusActivity = isMobileQuestDockRenderedBase(9498).useCustomStatusActivity();
  const tmp4Result7 = isMobileQuestDockRenderedBase(9498);
  let state;
  if (customStatusActivity != null) {
    state = customStatusActivity.state;
  }
  mergeGuildAvatar = isMobileQuestDockRenderedBase(9501).useGameMentionsAsPlainText(state);
  const tmp4Result8 = isMobileQuestDockRenderedBase(9501);
  let tag;
  if (tmp4Result9.useIsYouBarGuildTagEnabled("YouBar")) {
    ...
    tag = tmp4(8314).getUserPrimaryGuild(primaryGuild).tag;
    const tmp4Result10 = tmp4(8314);
  }
  tmp4Result9 = isMobileQuestDockRenderedBase(15569);
  ...
  const context = obj7.useContext(tmp2(15222));
  ...
  const items10 = [callback(youBarHorizontalMargin(15581), { hasNameplate: null != nameplate, isLargeAvatar: !isMobileQuestDockRenderedBase, barWidth: tmp10, isQuestRendered: isMobileQuestDockRenderedBase, avatarSize: tmp40 }), , , ];
  ...
  if (null != nameplate) {
    ...
    obj1[3] = tmp40;
    tmp43Result = tmp43(tmp2(15582), obj1);
  }
  ...
  obj3[10] = callback1;
  obj3[11] = gesture;
  obj3[12] = callback(youBarHorizontalMargin(15583), { isQuestRendered: isMobileQuestDockRenderedBase, onAvatarPress: memo2 });
  obj2[1] = callback(markAsDismissed, obj3);
  items10[2] = callback(isMobileQuestDockRenderedBase(5467).GestureDetector, obj2);
  const obj4 = { style: tmp.youRowRight, children: null };
  tmp43Result = null;
  if (iCYMIEnabled) {
    const obj5 = { hasNameplate: null };
    obj5[0] = tmp21;
    tmp43Result = tmp43(tmp2(15587), obj5);
  }
  const items11 = [tmp43Result, callback(youBarHorizontalMargin(15590), { hasNameplate: null != nameplate })];
  obj4[1] = items11;
...
const memoResult = importAllResult.memo(function YouBarThemed() {
  ...
  const items1 = [callback(importDefault(15592), {}), callback(closure_27, {}), callback(importDefault(15593), {})];
  obj[1] = items1;
