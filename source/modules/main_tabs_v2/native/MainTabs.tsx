// Module ID: 15137
// Function ID: 15138
// Dependencies: [19, 17, 21, 4303, 4154, 8393, 1609, 4013, 4848, 15138, 2]
...
const memoResult = require("noop").memo(function MainTabs() {
  ...
  const items1 = [callback(importDefault(4848), { absolute: true, mix: isCustomThemeActive }), callback(importDefault(15138), {})];
  obj[1] = items1;
