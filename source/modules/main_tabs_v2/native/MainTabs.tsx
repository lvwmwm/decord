// Module ID: 14910
// Function ID: 14911
// Dependencies: [19, 17, 21, 4189, 4036, 8822, 1581, 3901, 4719, 14911, 2]
...
const memoResult = require("noop").memo(function MainTabs() {
  let obj = require(8822) /* useActiveThemeType */;
  ...
  const items1 = [callback(importDefault(4719), { absolute: true, mix: isCustomThemeActive }), callback(importDefault(14911), {})];
  obj[1] = items1;
