// Module ID: 15219
// Function ID: 15220
// Dependencies: [19, 17, 21, 4342, 4193, 8464, 1628, 4072, 4911, 15220, 2]
...
const memoResult = require("noop").memo(function MainTabs() {
  ...
  const items1 = [callback(importDefault(4911), { absolute: true, mix: isCustomThemeActive }), callback(importDefault(15220), {})];
  obj[1] = items1;
