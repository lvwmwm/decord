...
// Module 10262 (getMuteSettingLabel)
...
export const handleUnmutePress = function handleUnmutePress(channelId, guildId) {
  ...
  if (null != channel) {
    if (channel.isThread()) {
      ...
      const result1 = tmp6Result.updateChannelOverrideSettings(guildId, channel.id, { flexGrow: 0., position: 0.0000000000000000000000000000000000000000000000015576649385897736 }, guildId(tmp7[12]).NotificationLabels.Unmuted);
    }
  }
};
