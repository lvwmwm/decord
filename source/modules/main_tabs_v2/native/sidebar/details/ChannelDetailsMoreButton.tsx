...
// Function ID: 16276
// Name: MoreButton
// Dependencies: [19, 21, 10613, 7578, 7575, 1236, 9729, 2]
// Exports: default

// Module 16275 (MoreButton)
...
export default function MoreButton(channel) {
  ...
  if (null != channel) {
    if (channel.isDM()) {
      ...
      obj[2] = tmp;
      obj[0] = jsx(channel(7575).HeaderIconButton, { accessibilityLabel: null, source: null, onPress: null });
