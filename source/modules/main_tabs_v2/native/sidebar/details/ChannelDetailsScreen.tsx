// Module ID: 15932
// Function ID: 15933
// Dependencies: [19, 21, 1481, 4163, 15705, 2]
...
const memoResult = importAllResult.memo((navigation) => {
  ...
  return jsx(importDefault(15705), { channelId: route.params.channelId, isSearchLocked: true === route.params.search, onBackPress: callback, componentWidth: importDefault(4163)().width, onChannelDeleted: callback, expandTopic: true === route.params.expandTopic });
});
