...
// Dependencies: [32, 19, 17, 12827, 14217, 676, 21, 4255, 712, 1236, 3959, 15367, 15369, 4251, 689, 4116, 5245, 4676, 589, 698, 14216, 4664, 12828, 2]
// Exports: default

// Module 15366 (ConnectionBannerIcon)
...
function ConnectionBannerIcon(state) {
  ...
  if (constants.WAITING_FOR_NETWORK === state) {
    ...
    obj1[1] = callback2(tmp2(15367).ConnectionUnknownIcon, obj2);
    ...
    obj[1] = callback2(tmp2(15369).ConnectionFineIcon, obj3);
    return callback2(closure_6, obj);
  }
}
...
function BackOnlineGlow(opacity) {
  ...
  obj[1] = callback2(importDefault(4676), { style: tmp.glowMaskGradient, colors: closure_14, locations: closure_15, start: closure_16, end: closure_17 });
  obj[2] = callback2(importDefault(4676), { style: tmp.glowMaskGradient, colors: memo, locations: closure_18, start: closure_19, end: closure_20 });
  obj[2] = callback2(importDefault(5245), obj);
...
export default function ConnectionBanner() {
  const config = stateFromStores(12828).useConfig({ location: "ConnectionBanner" });
  const hidden = config.hidden;
  stateFromStores = undefined;
  let dependencyMap;
  let obj = stateFromStores(12828);
