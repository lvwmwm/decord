...
// Dependencies: [32, 19, 17, 12864, 14254, 676, 21, 4285, 712, 1236, 3988, 15405, 15407, 4281, 689, 4145, 5293, 4706, 589, 698, 14253, 4694, 12865, 2]
// Exports: default

// Module 15404 (ConnectionBannerIcon)
...
function ConnectionBannerIcon(state) {
  ...
  if (constants.WAITING_FOR_NETWORK === state) {
    ...
    obj1[1] = callback2(tmp2(15405).ConnectionUnknownIcon, obj2);
    ...
    obj[1] = callback2(tmp2(15407).ConnectionFineIcon, obj3);
    return callback2(closure_6, obj);
  }
}
...
function BackOnlineGlow(opacity) {
  ...
  obj[2] = callback2(importDefault(5293), obj);
  return callback2(importDefault(4145).View, obj);
}
...
export default function ConnectionBanner() {
  const config = stateFromStores(12865).useConfig({ location: "ConnectionBanner" });
  const hidden = config.hidden;
  stateFromStores = undefined;
  let dependencyMap;
  let obj = stateFromStores(12865);
