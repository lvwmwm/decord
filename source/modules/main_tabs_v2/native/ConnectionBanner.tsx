...
// Dependencies: [32, 19, 17, 12856, 14244, 676, 21, 4285, 712, 1236, 3989, 15387, 15389, 4281, 689, 4146, 5260, 4706, 589, 698, 14243, 4694, 12857, 2]
// Exports: default

// Module 15386 (ConnectionBannerIcon)
...
function ConnectionBannerIcon(state) {
  ...
  if (constants.WAITING_FOR_NETWORK === state) {
    ...
    obj1[1] = callback2(tmp2(15387).ConnectionUnknownIcon, obj2);
    ...
    obj[1] = callback2(tmp2(15389).ConnectionFineIcon, obj3);
    return callback2(closure_6, obj);
  }
}
...
export default function ConnectionBanner() {
  const config = stateFromStores(12857).useConfig({ location: "ConnectionBanner" });
  const hidden = config.hidden;
  stateFromStores = undefined;
  let dependencyMap;
  let obj = stateFromStores(12857);
