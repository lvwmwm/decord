...
// Function ID: 15590
// Name: goBack
// Dependencies: [19, 17, 9619, 1388, 21, 4344, 712, 4200, 7682, 8419, 15590, 5367, 4886, 1236, 15591, 4340, 15592, 8424, 15594, 5767, 5787, 6976, 5315, 5754, 15598, 15599, 11354, 4195, 1628, 15217, 4888, 4072, 2]
...
let closure_12 = importAllResult.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  obj[1] = tmp10Result;
  const items4 = [closure_7(_require(5367).SafeAreaPaddingView, obj), ];
