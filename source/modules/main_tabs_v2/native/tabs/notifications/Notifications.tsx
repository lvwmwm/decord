...
// Function ID: 15509
// Name: goBack
// Dependencies: [19, 17, 9574, 1369, 21, 4303, 712, 4159, 7641, 8375, 15509, 5328, 4846, 1236, 15510, 4299, 15511, 8381, 15513, 5728, 5748, 6934, 5276, 5715, 15517, 15518, 11294, 4154, 1609, 15149, 4848, 4013, 2]
...
let closure_12 = importAllResult.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  obj[1] = tmp10Result;
  const items4 = [closure_7(_require(5328).SafeAreaPaddingView, obj), ];
