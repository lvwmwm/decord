...
// Function ID: 15372
// Name: goBack
// Dependencies: [19, 17, 9463, 1369, 21, 4255, 712, 4107, 7534, 8158, 15372, 5257, 4797, 1236, 15373, 4251, 15374, 8164, 15376, 5595, 5615, 6828, 5229, 5582, 15380, 15381, 11179, 4102, 1581, 15025, 4799, 3967, 2]
...
let closure_12 = importAllResult.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  obj[1] = tmp10Result;
  const items4 = [closure_7(_require(5257).SafeAreaPaddingView, obj), ];
