...
// Function ID: 15599
// Name: goBack
// Dependencies: [19, 17, 9623, 1388, 21, 4342, 712, 4198, 7686, 8423, 15599, 5368, 4887, 1236, 15600, 4338, 15601, 8428, 15603, 5768, 5788, 6982, 5316, 5755, 15607, 15608, 11345, 4193, 1628, 15226, 4889, 4072, 2]
...
let closure_12 = importAllResult.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  obj[1] = tmp10Result;
  const items4 = [closure_7(_require(5368).SafeAreaPaddingView, obj), ];
