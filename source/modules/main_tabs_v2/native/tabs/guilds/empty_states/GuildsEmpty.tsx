...
// Dependencies: [32, 19, 17, 1218, 1909, 4269, 676, 21, 4448, 712, 4444, 12213, 15825, 1236, 4894, 4896, 1500, 647, 8855, 503, 1912, 4304, 5039, 14668, 2]

// Module 15824 (handleJoinGuild)
...
import registerAssetDefault from "registerAsset" /* 15825 */;
...
function handleJoinGuild() {
  const result = _modDef12213.openGuildJoinServerScreen();
}
function handleCreateGuild() {
  _modDef12213.openCreateGuildModal();
}
...
const memoResult = importAllResult.memo(function GuildsEmpty(arg0) {
  ...
  if (stateFromStores) {
    ...
    obj2[1] = callback(tmp2(4444).Text, obj3);
