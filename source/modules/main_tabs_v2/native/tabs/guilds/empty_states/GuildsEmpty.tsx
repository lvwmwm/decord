...
// Dependencies: [32, 19, 17, 1218, 1862, 4006, 676, 21, 4189, 712, 4185, 11799, 15235, 1236, 4598, 4600, 1481, 647, 8426, 503, 1865, 4042, 4720, 14127, 2]

// Module 15234 (handleJoinGuild)
...
function handleJoinGuild() {
  const result = importDefault(11799).openGuildJoinServerScreen();
}
function handleCreateGuild() {
  importDefault(11799).openCreateGuildModal();
}
