...
// Dependencies: [32, 19, 17, 1218, 1862, 4072, 676, 21, 4255, 712, 4251, 11947, 15253, 1236, 4663, 4665, 1481, 647, 9238, 503, 1865, 4108, 4800, 14219, 2]

// Module 15252 (handleJoinGuild)
...
function handleJoinGuild() {
  const result = importDefault(11947).openGuildJoinServerScreen();
}
function handleCreateGuild() {
  importDefault(11947).openCreateGuildModal();
}
...
const memoResult = importAllResult.memo(function GuildsEmpty(arg0) {
  ...
  if (stateFromStores) {
    ...
    obj2[1] = callback(tmp2(4251).Text, obj3);
