...
// Dependencies: [32, 19, 17, 1218, 1862, 4072, 676, 21, 4255, 712, 4251, 11915, 15239, 1236, 4664, 4666, 1481, 647, 8741, 503, 1865, 4108, 4786, 14212, 2]

// Module 15238 (handleJoinGuild)
...
function handleJoinGuild() {
  const result = importDefault(11915).openGuildJoinServerScreen();
}
function handleCreateGuild() {
  importDefault(11915).openCreateGuildModal();
}
