// Module ID: 15396
// Function ID: 15397
// Dependencies: [19, 17, 3948, 676, 21, 4303, 4299, 712, 647, 9027, 9002, 14350, 7972, 1297, 15397, 1236, 15398, 4715, 2]
...
const memoResult = importAllResult.memo(function ChannelsEmpty(guild) {
  ...
  const items6 = [callback(closure_5, { source: importDefault(15398) }), , , ];
