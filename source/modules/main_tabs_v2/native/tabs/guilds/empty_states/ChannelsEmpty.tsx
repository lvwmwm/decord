// Module ID: 15452
// Function ID: 15453
// Dependencies: [19, 17, 3989, 676, 21, 4344, 4340, 712, 647, 9066, 9041, 14407, 8011, 1297, 15453, 1236, 15454, 4755, 2]
...
const memoResult = importAllResult.memo(function ChannelsEmpty(guild) {
  ...
  if (canCustomizeGuild) {
    ...
    obj2[2] = callback;
    obj1[1] = callback(tmp2(8011).RowButton, obj2);
  ...
  items6[1] = callback(guild(4340).Text, obj6);
  ...
  items6[2] = callback(guild(4340).Text, obj7);
  if (canCreateChannel) {
    ...
    obj9[4] = callback1;
    obj8[1] = tmp11(tmp2(4755).BaseTextButton, obj9);
