...
// Dependencies: [19, 21, 1348, 712, 9387, 11768, 11771, 7910, 15245, 1236, 11882, 2]
// Exports: default, getScaledGuildProgressButtonHeight

// Module 15244 (GuildProgressButton)
...
export default function GuildProgressButton(guild) {
  ...
  obj = { source: null };
  obj[0] = completed(15245);
  obj[0] = jsx(guild(7910).RowButton.Icon, { source: null });
  const intl = guild(1236).intl;
  obj[1] = intl.string(guild(1236).t.o3HK3d);
  obj[2] = subtitle;
  obj[3] = callback;
  obj[4] = jsx(completed(11882), { percent: percentComplete });
  return jsx(guild(7910).RowButton, { source: null });
};
export const getScaledGuildProgressButtonHeight = function getScaledGuildProgressButtonHeight(fontScale, isRefreshEnabled) {
  ...
  const sum = refreshToken + require(9387) /* map */.scaleTextLineHeight("text-md/semibold", fontScale);
  const obj2 = require(9387) /* map */;
  return sum + 2 * require(9387) /* map */.scaleTextLineHeight("text-xs/medium", fontScale) + refreshToken;
};
