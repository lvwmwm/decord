...
// Dependencies: [32, 19, 17, 21, 4668, 1494, 1500, 9214, 503, 8981, 14520, 15381, 4739, 1236, 4750, 2]
// Exports: default

// Module 15380 (MessagesEmptyState)
...
export default function MessagesEmptyState() {
  ...
  const obj5 = { resizeMode: "contain", source: tmp2(15381), style: null };
  let num = 350;
  if (result < 622) {
    num = result / 622 * 350;
  }
  const tmp10 = navigation(9214);
