...
// Dependencies: [32, 19, 17, 21, 4255, 1474, 1480, 8741, 503, 4786, 14212, 15049, 4251, 1236, 4666, 2]
// Exports: default
...
export default function MessagesEmptyState() {
  ...
  obj11[1] = callback1;
  obj10[1] = closure_8(require(4666) /* Button */.Button, obj11);
