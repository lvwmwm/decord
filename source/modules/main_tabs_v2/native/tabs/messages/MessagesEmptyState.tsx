...
// Dependencies: [32, 19, 17, 21, 4302, 1474, 1480, 9284, 503, 4847, 14270, 15116, 4298, 1236, 4712, 2]
// Exports: default

// Module 15115 (MessagesEmptyState)
...
export default function MessagesEmptyState() {
  ...
  const obj5 = { resizeMode: "contain", source: tmp2(15116), style: null };
  let num = 350;
  if (result < 622) {
    num = result / 622 * 350;
  }
  const tmp10 = navigation(9284);
  ...
  const items3 = [closure_8(require(4298) /* Text */.Heading, obj8), ];
  ...
  items3[1] = closure_8(require(4298) /* Text */.Text, obj9);
  obj7[1] = items3;
  ...
  obj11[1] = callback1;
  obj10[1] = closure_8(require(4712) /* Button */.Button, obj11);
