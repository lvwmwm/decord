...
// Dependencies: [32, 19, 17, 21, 4380, 1494, 1500, 9497, 503, 4952, 14550, 15411, 4376, 1236, 4815, 2]
// Exports: default

// Module 15410 (MessagesEmptyState)
...
export default function MessagesEmptyState() {
  ...
  const obj5 = { resizeMode: "contain", source: tmp2(15411), style: null };
  let num = 350;
  if (result < 622) {
    num = result / 622 * 350;
  }
  const tmp10 = navigation(9497);
