...
// Dependencies: [32, 19, 17, 21, 4285, 1474, 1480, 9267, 503, 4830, 14256, 15100, 4281, 1236, 4695, 2]
// Exports: default

// Module 15099 (MessagesEmptyState)
...
export default function MessagesEmptyState() {
  ...
  const obj5 = { resizeMode: "contain", source: tmp2(15100), style: null };
  let num = 350;
  if (result < 622) {
    num = result / 622 * 350;
  }
  const tmp10 = navigation(9267);
  ...
  const items3 = [closure_8(require(4281) /* Text */.Heading, obj8), ];
  ...
  items3[1] = closure_8(require(4281) /* Text */.Text, obj9);
  obj7[1] = items3;
  ...
  obj11[1] = callback1;
  obj10[1] = closure_8(require(4695) /* Button */.Button, obj11);
