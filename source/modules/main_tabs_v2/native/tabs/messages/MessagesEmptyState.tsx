...
// Dependencies: [32, 19, 17, 21, 4342, 1493, 1499, 9399, 503, 4890, 14416, 15263, 4338, 1236, 4755, 2]
// Exports: default

// Module 15262 (MessagesEmptyState)
...
export default function MessagesEmptyState() {
  ...
  const obj5 = { resizeMode: "contain", source: tmp2(15263), style: null };
  let num = 350;
  if (result < 622) {
    num = result / 622 * 350;
  }
  const tmp10 = navigation(9399);
  ...
  const items3 = [closure_8(require(4338) /* Text */.Heading, obj8), ];
  ...
  items3[1] = closure_8(require(4338) /* Text */.Text, obj9);
  obj7[1] = items3;
  ...
  obj11[1] = callback1;
  obj10[1] = closure_8(require(4755) /* Button */.Button, obj11);
