...
// Dependencies: [32, 19, 17, 21, 4193, 1474, 1480, 8436, 503, 4724, 14145, 15069, 4189, 1236, 4604, 2]
// Exports: default
...
export default function MessagesEmptyState() {
  ...
  const obj5 = { resizeMode: "contain", source: tmp2(15069), style: null };
  let num = 350;
  if (result < 622) {
    num = result / 622 * 350;
  }
  const tmp10 = navigation(8436);
  ...
  const items3 = [closure_8(require(4189) /* Text */.Heading, obj8), ];
  ...
  items3[1] = closure_8(require(4189) /* Text */.Text, obj9);
  obj7[1] = items3;
  ...
  obj11[1] = callback1;
  obj10[1] = closure_8(require(4604) /* Button */.Button, obj11);
