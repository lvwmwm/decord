...
// Dependencies: [32, 19, 17, 3998, 676, 21, 4344, 712, 9498, 8828, 2007, 647, 1236, 4189, 15245, 15246, 698, 4886, 1297, 4340, 4754, 4290, 7786, 15243, 2]
...
export const getMessagesItemSuggestedFriendHeight = function getMessagesItemSuggestedFriendHeight(fontScale) {
  ...
  const scaleTextLineHeightResult = require(9498) /* map */.scaleTextLineHeight("redesign/channel-title/semibold", fontScale);
  const sum = scaleTextLineHeightResult + require(9498) /* map */.scaleTextLineHeight("text-xs/medium", fontScale);
