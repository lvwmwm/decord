...
// Dependencies: [32, 19, 17, 3892, 676, 21, 4255, 712, 9341, 8677, 1959, 647, 1236, 4094, 15053, 15054, 698, 4797, 1297, 4251, 4665, 4201, 7638, 15051, 2]
// Exports: getMessagesItemSuggestedFriendHeight

// Module 15052 (getMessagesItemSuggestedFriendHeight)
...
export const getMessagesItemSuggestedFriendHeight = function getMessagesItemSuggestedFriendHeight(fontScale) {
  ...
  const scaleTextLineHeightResult = require(9341) /* map */.scaleTextLineHeight("redesign/channel-title/semibold", fontScale);
  const sum = scaleTextLineHeightResult + require(9341) /* map */.scaleTextLineHeight("text-xs/medium", fontScale);
