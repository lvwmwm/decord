...
// Dependencies: [19, 17, 4297, 9712, 4481, 21, 4285, 712, 1297, 8510, 8419, 9739, 9642, 3994, 4221, 1348, 589, 14465, 3866, 8859, 15084, 11, 4475, 15085, 3988, 9388, 9389, 4281, 9170, 9054, 9707, 3962, 9557, 1236, 15087, 2]

// Module 15083 (MessagesItemChannelContentIcon)
...
const memoResult = importAllResult.memo(function MessagesItemChannelContent(channel) {
  ...
  const isThemeLightResult = obj.isThemeLight(importDefault(4221)());
  ...
  const tmp12 = importDefault(14465)(channel, { unread: hasUnreadMessages });
  ...
  const tmp18 = importDefault(15085)(channel, stateFromStores);
  ...
  obj[0] = channel(3988).useToken(importDefault(712).modules.mobile.MESSAGES_ITEM_CHANNEL_NAME_TEXT_STYLE);
  const items1 = [, ];
