...
// Dependencies: [19, 17, 4201, 10280, 4386, 21, 4189, 712, 1297, 8360, 8361, 10304, 9976, 3899, 4125, 1348, 589, 14330, 3771, 8201, 15027, 11, 4380, 15028, 3893, 8377, 8378, 4185, 8449, 8387, 10277, 3867, 9058, 1236, 15030, 2]

// Module 15026 (MessagesItemChannelContentIcon)
...
const memoResult = importAllResult.memo(function MessagesItemChannelContent(channel) {
  ...
  const tmp12 = importDefault(14330)(channel, { unread: hasUnreadMessages });
  ...
  const tmp18 = importDefault(15028)(channel, stateFromStores);
  ...
  if (channel.isDM()) {
    if (null != channel.recipients) {
      if (channel.recipients.length > 0) {
        ...
        const EffectDisplayType = tmp(8378).EffectDisplayType;
  ...
  if (tmp16) {
    ...
    tmp21Result = tmp21(tmp3(8449), obj6);
  }
  ...
  if (channel.isSystemDM()) {
    ...
    obj7[0] = tmp9.botTag;
    obj7[1] = tmp3(8387).Types.SYSTEM_DM;
    tmp21Result = tmp21(tmp3(8387), obj7);
    const tmp3Result1 = tmp3(8387);
  }
  ...
  if (!hasNameplate) {
    ...
    if (tmp13) {
      ...
      obj15[4] = muted;
      let tmp21Result2 = tmp21(tmp(10277).ChannelRowPreview, obj15);
      ...
      obj16[2] = guild_id;
      tmp21Result2 = tmp21(tmp3(9058), obj16);
      const tmp3Result2 = tmp3(9058);
    } else {
      tmp21Result2 = null;
      if (tmp3(8201)(channel.id)) {
    ...
    if (waveShouldShow) {
      ...
      tmp21Result3 = tmp21(tmp3(15030), obj18);
    }
