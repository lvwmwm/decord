// Module ID: 15241
// Function ID: 15242
// Dependencies: [19, 21, 4754, 1236, 4340, 2]
...
const memoResult = require("noop").memo(function MessagesItemChannelWave(hasNameplate) {
  ...
  obj[1] = jsx(require(4340) /* Text */.Text, { style: { marginTop: 3 }, variant: "text-sm/semibold", "aria-hidden": true, children: "\u{1F44B}" });
  let str = "secondary";
  if (flag) {
  ...
  return jsx(require(4754) /* Button */.Button, { text: null, icon: null, variant: null, size: "sm", onPress: null });
});
