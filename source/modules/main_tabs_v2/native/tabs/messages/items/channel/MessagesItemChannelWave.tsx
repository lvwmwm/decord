// Module ID: 15103
// Function ID: 15104
// Dependencies: [19, 21, 4712, 1236, 4298, 2]
...
const memoResult = require("noop").memo(function MessagesItemChannelWave(hasNameplate) {
  ...
  obj[1] = jsx(require(4298) /* Text */.Text, { style: { marginTop: 3 }, variant: "text-sm/semibold", "aria-hidden": true, children: "\u{1F44B}" });
  let str = "secondary";
  if (flag) {
  ...
  return jsx(require(4712) /* Button */.Button, { text: null, icon: null, variant: null, size: "sm", onPress: null });
});
