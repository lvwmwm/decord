...
// Dependencies: [19, 17, 14595, 21, 1367, 712, 4344, 4065, 8338, 15258, 2]
...
export default require("noop").memo(function MessagesItemHappeningNow(listRef) {
  ...
  return jsx(require(8338) /* useCutoutBackgroundColor */.CutoutBackgroundProvider, { style: callback(closure_4 + obj.useToken(importDefault(712).modules.mobile.MESSAGES_ITEM_HAPPENING_NOW_PADDING_BOTTOM)).container, collapsable: false, children: null });
});
