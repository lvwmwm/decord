...
// Function ID: 15087
// Name: PX_16
// Dependencies: [19, 17, 676, 21, 712, 1348, 9387, 4716, 4302, 4162, 4711, 15087, 4153, 11643, 5270, 7691, 9641, 1236, 4298, 5947, 5946, 15092, 4712, 4241, 4240, 2]
...
export const getMessagesHeaderHeight = function getMessagesHeaderHeight(fontScale, closure_2) {
  ...
  const sum = require(9387) /* map */.scaleTextLineHeight("redesign/heading-18/bold", bound) + PX_8;
  return sum + require(4716) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_HEIGHT + PX_16 + refreshToken;
};
