...
// Function ID: 15225
// Name: PX_16
// Dependencies: [19, 17, 676, 21, 712, 1367, 9498, 4758, 4344, 4083, 4753, 15225, 4200, 11770, 5310, 7792, 9751, 1236, 4340, 6048, 6047, 15230, 4754, 4283, 4282, 2]
...
export const getMessagesHeaderHeight = function getMessagesHeaderHeight(fontScale, closure_2) {
  ...
  const sum = require(9498) /* map */.scaleTextLineHeight("redesign/heading-18/bold", bound) + PX_8;
  return sum + require(4758) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_HEIGHT + PX_16 + refreshToken;
};
