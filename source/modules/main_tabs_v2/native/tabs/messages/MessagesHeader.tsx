...
const memoResult = importAllResult.memo(function MessagesHeader(height) {
  ...
  const callback1 = importAllResult.useCallback(() => {
    ...
    if (null != rootNavigationRef) {
      obj = { screen: "add-friends", params: { height: null, flexDirection: null } };
  ...
  obj = { "Bool(false)": 1557463041, "Bool(false)": 24182788, "Bool(false)": 1090519040 };
  ...
  const obj6 = { enlargeSquare: 44, fillAspectRatio: null, <string:1650710705>: true, onPress: callback2 };
  if (tmp2) {
