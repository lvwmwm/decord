...
// Function ID: 15964
// Name: items
// Dependencies: [19, 17, 21, 15611, 712, 8363, 4342, 1236, 8726, 4338, 2]
...
const memoResult = importAllResult.memo(importAllResult.forwardRef((arg0, ref) => {
  ...
  if (showRedDot) {
    ...
    obj[0] = items;
    obj[1] = tmp3;
    items = [tmp2(importDefault(8363), obj), ];
  ...
  obj3[7] = items1;
  return callback2(require(8726) /* TwinButtons */.PressableScale, obj3);
}));
