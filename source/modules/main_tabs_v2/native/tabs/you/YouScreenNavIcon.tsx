...
// Function ID: 15946
// Name: items
// Dependencies: [19, 17, 21, 15593, 712, 8341, 4342, 1236, 8712, 4338, 2]
...
const memoResult = importAllResult.memo(importAllResult.forwardRef((arg0, ref) => {
  ...
  if (showRedDot) {
    ...
    obj[0] = items;
    obj[1] = tmp3;
    items = [tmp2(importDefault(8341), obj), ];
  ...
  obj3[7] = items1;
  return callback2(require(8712) /* TwinButtons */.PressableScale, obj3);
}));
