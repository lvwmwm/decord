// Module ID: 15766
// Function ID: 15767
// Dependencies: [32, 19, 6836, 12602, 1369, 21, 8085, 589, 5943, 1358, 15761, 15763, 7625, 1236, 2]
...
const memoResult = importAllResult.memo(function SubscriberNitroIcon(onPress) {
  ...
  obj = { cooldownDurationMs: tmp(15761).REFERRAL_NITRO_BUTTON_RED_DOT_COOLDOWN_MS };
  ...
  obj[2] = callback;
  obj[3] = tmp7;
  return jsx(showReferralNotificationDot(15763), { IconComponent: null, accessibilityLabel: null, onPress: null, showRedDot: null });
});
