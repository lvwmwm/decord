...
let obj = {};
obj = { "Bool(false)": -1941831677, "Bool(false)": -1677720845, "Bool(false)": 1107297141, "Bool(false)": 259691, borderRadius: importDefault(dependencyMap[5]).radii.xl };
obj.container = obj;
...
const memoResult = importAllResult.memo(function YouNavigator(route) {
  route = route.route;
  let tmp = callback();
...
const result = arg1(dependencyMap[12]).fileFinishedImporting("modules/main_tabs_v2/native/tabs/you/YouNavigator.tsx");
