...
// Dependencies: [19, 17, 11842, 1302, 1930, 7219, 4190, 1922, 676, 11843, 21, 4344, 712, 5419, 13430, 13427, 13428, 13429, 4034, 9810, 4312, 8026, 1236, 8025, 9078, 1367, 589, 14484, 11414, 8743, 14568, 1347, 15564, 10251, 14570, 4189, 1297, 15154, 15566, 698, 5787, 11846, 4886, 4340, 9809, 5806, 5807, 9777, 15571, 2007, 15561, 9494, 4065, 9497, 5415, 9500, 9569, 7696, 9507, 8101, 5311, 5803, 5435, 4752, 13908, 2]

// Module 15563 (YouStatusRadioGroup)
...
function ThemeRadioGroup() {
  ...
  obj[0] = callback(require(14568) /* ThemeLightIcon */.ThemeLightIcon, {});
  let obj3 = require(1347) /* getThemeForColor */;
  obj[1] = obj3.getThemeName(constants.LIGHT, tmp2);
  obj[2] = constants.LIGHT;
  const items1 = [callback(require(8025) /* TableRadioRow */.TableRadioRow, obj), , , ];
  let tmp6Result = tmp2;
  if (tmp2) {
  ...
  items1[2] = callback(require(8025) /* TableRadioRow */.TableRadioRow, obj3);
  const obj4 = { icon: null, label: null, value: null };
  obj4[0] = callback(require(14570) /* ThemeMidnightIcon */.ThemeMidnightIcon, {});
  obj4[1] = require(1347) /* getThemeForColor */.getThemeName(constants.MIDNIGHT, tmp2);
  obj4[2] = constants.MIDNIGHT;
  items1[3] = callback(require(8025) /* TableRadioRow */.TableRadioRow, obj4);
  obj[4] = items1;
  obj2[0] = closure_20(require(8026) /* context */.TableRadioGroup, obj);
...
function FocusModeSetting() {
  ...
  let tmp5Result = require(9809) /* useFocusModeEnabled */;
...
function CustomStatus() {
  const tmp = callback2();
  let obj = require(9494) /* _activityFromSetting */;
  ...
  items[1] = closure_19(require(4340) /* Text */.Text, obj4);
  obj[5] = items;
  const items1 = [closure_20(require(4886) /* PressableBase */.PressableOpacity, obj), ];
  tmp15Result = null;
  ...
  obj[3] = items1;
  return closure_19(require(5806) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: closure_20(require(5415) /* PressableCard */.Card, obj) });
}
...
const memoResult = importAllResult.memo((statusOnly) => {
  ...
  const tmp5 = importDefault(5311)("theme_setting_in_account_sheet");
  const items1 = [init];
  ...
  obj[1] = closure_19(require(5435) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: stringResult });
  let tmp7Result = tmp5;
  if (tmp5) {
  ...
  if (tmp7Result1) {
    tmp7Result1 = tmp7(importDefault(13908), { title: "Developer Tools", embedded: true });
  }
  items2[5] = tmp7Result1;
  obj[3] = closure_20(require(4752) /* Stack */.Stack, { spacing: 24, children: items2 });
  return closure_19(require(5803) /* ActionSheet */.ActionSheet, obj);
});
