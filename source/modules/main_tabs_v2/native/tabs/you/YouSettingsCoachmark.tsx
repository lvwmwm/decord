...
// Dependencies: [15716, 8547, 2]
// Exports: default, useYouSettingsCoachmark

// Module 15715 (YouSettingsCoachmark)
...
export const useYouSettingsCoachmark = function useYouSettingsCoachmark(disabled) {
  let referralProgramCoachmark = require(15716) /* ReferralProgramCoachmarkImg */.useReferralProgramCoachmark({ disabled: disabled.disabled });
