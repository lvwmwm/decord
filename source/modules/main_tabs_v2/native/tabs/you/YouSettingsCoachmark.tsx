...
// Dependencies: [15956, 8716, 2]
// Exports: default, useYouSettingsCoachmark

// Module 15955 (YouSettingsCoachmark)
...
export const useYouSettingsCoachmark = function useYouSettingsCoachmark(disabled) {
  let referralProgramCoachmark = require(15956) /* ReferralProgramCoachmarkImg */.useReferralProgramCoachmark({ disabled: disabled.disabled });
