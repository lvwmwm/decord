...
// Dependencies: [15756, 8576, 2]
// Exports: default, useYouSettingsCoachmark

// Module 15755 (YouSettingsCoachmark)
...
export const useYouSettingsCoachmark = function useYouSettingsCoachmark(disabled) {
  let referralProgramCoachmark = require(15756) /* ReferralProgramCoachmarkImg */.useReferralProgramCoachmark({ disabled: disabled.disabled });
