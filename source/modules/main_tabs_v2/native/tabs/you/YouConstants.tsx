...
export const YOU_AVATAR_SIZE = require("Button").AVATAR_SIZE_MAP[require("Button").AvatarSizes.XXLARGE];
...
export const YOU_CARD_BORDER_RADIUS = require("_createForOfIteratorHelperLoose").radii.lg;
