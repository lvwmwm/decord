...
// Dependencies: [19, 17, 21, 4342, 712, 4911, 15946, 2]
// Exports: default

// Module 15945 (FriendRequestsSettingsScreen)
import "noop";
...
export default function FriendRequestsSettingsScreen() {
  ...
  const items = [callback(importDefault(4911), { absolute: true }), ];
  obj = { style: createCacheKey().container, children: callback(importDefault(15946), {}) };
