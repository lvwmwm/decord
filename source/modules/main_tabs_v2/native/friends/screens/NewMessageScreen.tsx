...
// Dependencies: [5, 32, 19, 17, 1376, 1372, 3938, 5840, 9620, 676, 21, 4036, 4299, 4303, 712, 500, 4313, 5843, 709, 589, 698, 15832, 15833, 4304, 8382, 1236, 10316, 15834, 5728, 5748, 5369, 4730, 8394, 1222, 4001, 9722, 9721, 4242, 4241, 10253, 4714, 11740, 2]
// Exports: default

// Module 15831 (isPrivateChannelMatch)
...
function ChatPreview(channelId) {
  ...
  navigateToChannel(15832)(callback);
  ...
  const items2 = [callback3(navigateToChannel(10316), obj), ];
  const obj1 = { portal: null };
  const ref = React.useRef(null);
  obj1[0] = channelId(500).isAndroid();
  items2[1] = callback3(channelId(15834).PortalKeyboardRenderer, obj1);
  obj[1] = items2;
...
export default function NewMessageScreen(navigation) {
    ...
    if (null == FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) {
      if (null == outer1_22(navigation)) {
        ...
        return () => {
          ...
          obj = { id: callback(5843).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID, guild_id: "Array", parent_id: "call" };
          obj[1] = obj;
          obj.dispatch(obj);
        };
      }
          ...
          if (0 === c3) {
            if (arg0 === 1) {
              ...
              if (callback instanceof c7) {
                ...
                if (-1 === index) {
                  if (arr.length >= FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID(15833)() - 1) {
  ...
  obj[1] = callback3(tmp2(11740), obj1);
