...
// Dependencies: [32, 19, 17, 5929, 3830, 1874, 8822, 676, 9069, 21, 4193, 712, 15631, 1959, 4534, 647, 5930, 3866, 15306, 5931, 11, 5519, 5539, 698, 12068, 5525, 15632, 659, 8363, 1236, 1480, 5558, 5224, 4189, 8228, 4723, 8764, 4721, 9928, 6790, 8829, 2]
// Exports: default
...
export default function FriendRequestsScreen() {
  ...
  const analyticsLocations = first(5519)(first(5539).FRIEND_REQUESTS).analyticsLocations;
  ...
  const NotificationCenterAckedBeforeId = stateFromStoresArray(3866).NotificationCenterAckedBeforeId;
  ...
  items10[1] = obj1;
  obj[3] = items10;
  const segmentedControlState = stateFromStoresArray(8228).useSegmentedControlState(obj);
  obj2 = { value: analyticsLocations, children: null };
  const items11 = [outgoingData(first(4723), { absolute: true }), ];
  obj3 = { style: tmp.container, children: null };
  obj4 = { style: tmp.tabs, children: outgoingData(tmp4(8764).SegmentedControl, { state: segmentedControlState }) };
  ...
  if (tmp28) {
    ...
    obj6[2] = tmp32(tmp4(4189).Text, obj7);
    obj5[1] = tmp32(tmp4(4721).PressableOpacity, obj6);
  ...
  if (tmp26) {
    ...
    obj9[0] = stringResult;
    WumpusCouchSpotIllustration = tmp4(6790).WumpusCouchSpotIllustration;
    obj9[1] = WumpusCouchSpotIllustration;
    obj8[1] = tmp32(tmp2(9928), obj9);
    tmp32Result = tmp32(tmp33, obj8);
    const tmp2Result = tmp2(9928);
  } else {
    if (first1 === tmp25.Incoming) {
    ...
    obj10[1] = callback2;
    obj10[2] = callback1;
    items12[2] = tmp32(tmp4(8829).UsersFastList, obj10);
    obj3[1] = items12;
    items11[1] = tmp31(tmp33, obj3);
    obj2[1] = items11;
    return tmp31(tmp4(5519).AnalyticsLocationProvider, obj2);
  }
};
