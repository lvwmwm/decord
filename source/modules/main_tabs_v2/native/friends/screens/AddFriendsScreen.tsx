...
// Dependencies: [57, 5, 31, 27, 5891, 3768, 1850, 11725, 653, 11704, 33, 4131, 689, 11702, 6636, 3831, 1212, 5992, 11706, 477, 5462, 5482, 4560, 675, 8297, 624, 22, 3970, 14971, 5468, 4663, 12168, 5584, 8752, 5164, 3833, 4648, 15513, 15514, 15516, 15517, 2]
// Exports: default

// Module 15512 (_createForOfIteratorHelperLoose)
...
function handleFindFriends() {
  require(11702) /* handleNameInputScreenOrSuggestions */.openContactSyncModal({}, constants.FRIENDS_ADD_FRIENDS_MODAL);
}
...
export default function AddFriendsScreen(navigation) {
  ...
  [module_12168, closure_6] = callback(React.useState([]), 2);
  ...
  const stateFromStoresArray = obj.useStateFromStoresArray(items2, () => {
    ...
    const items1 = [];
    const item = module_12168.forEach((arg0) => {
      ...
      getItemProps(arg0, arg1) {
          ...
          if (friendSuggestions.FIND_FRIENDS === arg0) {
            ...
            obj.component = function component() {
              const obj = {
                added: outer1_17.includes(module_12168),
                suggestedFriend: module_12168,
                start: closure_0,
                end: closure_1,
                onPress: outer1_14,
