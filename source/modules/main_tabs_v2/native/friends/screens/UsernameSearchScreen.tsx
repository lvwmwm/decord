...
// Dependencies: [19, 17, 676, 21, 4285, 712, 698, 5349, 4681, 8314, 500, 5745, 4829, 13118, 1236, 2]
// Exports: default

// Module 15743 (UsernameSearchScreen)
...
export default function UsernameSearchScreen(navigation) {
  ...
  let tmp3Result = tmp3(5745);
  const items2 = [callback(ref(4829), { absolute: true }), ];
