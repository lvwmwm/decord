...
// Dependencies: [19, 17, 676, 21, 4285, 712, 698, 5310, 4681, 8202, 500, 5733, 4814, 13109, 1236, 2]
// Exports: default

// Module 15722 (UsernameSearchScreen)
...
export default function UsernameSearchScreen(navigation) {
  ...
  let tmp3Result = tmp3(5733);
  const items2 = [callback(ref(4814), { absolute: true }), ];
