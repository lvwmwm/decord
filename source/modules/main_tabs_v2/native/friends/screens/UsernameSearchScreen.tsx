...
// Dependencies: [19, 17, 676, 21, 4445, 712, 698, 5546, 4867, 7549, 500, 6001, 5022, 13508, 1236, 2]
// Exports: default

// Module 16268 (UsernameSearchScreen)
...
export default function UsernameSearchScreen(navigation) {
  ...
  let tmp3Result = tmp3(6001);
  const items2 = [callback(ref(5022), { absolute: true }), ];
