...
// Dependencies: [19, 17, 676, 21, 4255, 712, 698, 5295, 4651, 8174, 500, 5718, 4799, 13081, 1236, 2]
// Exports: default

// Module 15703 (UsernameSearchScreen)
...
export default function UsernameSearchScreen(navigation) {
  ...
  let tmp3Result = tmp3(5718);
  const items2 = [callback(ref(4799), { absolute: true }), ];
