...
// Dependencies: [32, 19, 17, 1922, 676, 12095, 21, 4342, 712, 12097, 4187, 698, 1236, 8972, 8431, 500, 4889, 4338, 13270, 13272, 2]
// Exports: default

// Module 15927 (AddFriendScreen)
import _slicedToArray from "_slicedToArray";
import module_13272 from "module_13272";
...
export default function AddFriendScreen(navigation) {
  ...
  let obj = navigation(12097);
  contactSyncAccount = obj.useContactSyncAccount();
  let obj1 = navigation(12097);
  ...
  const items2 = [callback(navigation(4338).Text, obj), , , ];
  ...
  items2[2] = callback(contactSyncAccount(13270), { style: tmp.input, autoFocusInput: false, sourcePage: navigation.route.params.sourcePage });
  ...
  const items3 = [callback(navigation(4338).Text, obj4), ];
  let tmp10Result = null;
  if (tmp5) {
    const obj5 = { style: null, location: "Add Friend Modal" };
    obj5[0] = tmp.rowContainer;
    tmp10Result = callback(contactSyncAccount(13272), obj5);
  }
