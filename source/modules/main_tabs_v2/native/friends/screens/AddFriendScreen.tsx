...
// Dependencies: [32, 19, 17, 1922, 676, 12093, 21, 4344, 712, 12095, 4189, 698, 1236, 8968, 8427, 500, 4888, 4340, 13269, 13271, 2]
// Exports: default

// Module 15917 (AddFriendScreen)
import _slicedToArray from "_slicedToArray";
import module_13271 from "module_13271";
...
export default function AddFriendScreen(navigation) {
  ...
  let obj = navigation(12095);
  contactSyncAccount = obj.useContactSyncAccount();
  let obj1 = navigation(12095);
  ...
  const items1 = [callback(contactSyncAccount(4888), { absolute: true }), ];
  ...
  const items2 = [callback(navigation(4340).Text, obj), , , ];
  ...
  items2[2] = callback(contactSyncAccount(13269), { style: tmp.input, autoFocusInput: false, sourcePage: navigation.route.params.sourcePage });
  ...
  const items3 = [callback(navigation(4340).Text, obj4), ];
  let tmp10Result = null;
  if (tmp5) {
    const obj5 = { style: null, location: "Add Friend Modal" };
    obj5[0] = tmp.rowContainer;
    tmp10Result = callback(contactSyncAccount(13271), obj5);
  }
