...
// Dependencies: [32, 19, 17, 1922, 676, 12036, 21, 4303, 712, 12038, 4148, 698, 1236, 8929, 8388, 500, 4848, 4299, 13212, 13214, 2]
// Exports: default

// Module 15861 (AddFriendScreen)
import _slicedToArray from "_slicedToArray";
import module_13214 from "module_13214";
...
export default function AddFriendScreen(navigation) {
  ...
  let obj = navigation(12038);
  contactSyncAccount = obj.useContactSyncAccount();
  let obj1 = navigation(12038);
  ...
  items2[2] = callback(contactSyncAccount(13212), { style: tmp.input, autoFocusInput: false, sourcePage: navigation.route.params.sourcePage });
  ...
  if (tmp5) {
    ...
    tmp10Result = callback(contactSyncAccount(13214), obj5);
  }
