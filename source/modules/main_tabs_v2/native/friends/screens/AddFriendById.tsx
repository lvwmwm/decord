...
// Function ID: 13482
// Name: ErrorMessage
// Dependencies: [32, 19, 17, 676, 21, 4444, 712, 1236, 4440, 6168, 13482, 9463, 9459, 4161, 698, 1351, 8194, 4879, 2]

// Module 13481 (ErrorMessage)
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        obj2[2] = sourcePage(9459).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED;
        let tmp9;
        ...
        obj2[3] = tmp9;
        const obj5 = ref(9459);
        ref(9459).sendRequest(obj2).then(() => {
          ...
          if (null != note) {
            ...
            obj[2] = sourcePage(9463).humanizeAbortCode(num, substr);
            obj = sourcePage(9463);
            let num2;
            if (body != null) {
            ...
            const obj4 = sourcePage(9463);
            const tmp3 = substr;
          }
          closure_1_6(obj);
        });
        const sendRequestResult = ref(9459).sendRequest(obj2);
      }
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(4879).Button, obj3);
    obj1[0] = items6;
    ...
    const items8 = [tmp17(sourcePage(4440).Text, obj5), , ];
    ...
    obj6[6] = str2;
    items8[1] = tmp17(sourcePage(8194).TextArea, obj6);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4440).Text, obj7);
