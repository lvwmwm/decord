...
// Function ID: 13528
// Name: ErrorMessage
// Dependencies: [32, 19, 17, 676, 21, 4446, 712, 1236, 4442, 6187, 13528, 9002, 8998, 4162, 698, 1351, 7755, 4893, 2]

// Module 13527 (ErrorMessage)
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        obj2[2] = sourcePage(8998).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED;
        let tmp9;
        ...
        obj2[3] = tmp9;
        const obj5 = ref(8998);
        ref(8998).sendRequest(obj2).then(() => {
          ...
          closure_1_6(obj);
          const result = sourcePage(4162).presentAddedFriendToast();
          closure_6.dismiss();
        }, (body) => {
          let note;
          if (body != null) {
          ...
          if (null != note) {
            ...
            obj[2] = sourcePage(9002).humanizeAbortCode(num, substr);
            obj = sourcePage(9002);
            let num2;
            if (body != null) {
            ...
            const obj4 = sourcePage(9002);
            const tmp3 = substr;
          }
          closure_1_6(obj);
        });
        const sendRequestResult = ref(8998).sendRequest(obj2);
      }
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(4893).Button, obj3);
    obj1[0] = items6;
    ...
    const items8 = [tmp17(sourcePage(4442).Text, obj5), , ];
    ...
    obj6[6] = str2;
    items8[1] = tmp17(sourcePage(7755).TextArea, obj6);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4442).Text, obj7);
