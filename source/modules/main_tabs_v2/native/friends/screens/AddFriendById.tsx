...
// Function ID: 13205
// Name: ErrorMessage
// Dependencies: [32, 19, 17, 676, 21, 4303, 712, 1236, 4299, 5993, 13205, 9247, 9243, 4001, 698, 4014, 7976, 4714, 2]

// Module 13204 (ErrorMessage)
...
function ErrorMessage(children) {
  ...
  return callback(require(4299) /* Text */.Text, { variant: "text-xs/medium", color: "text-feedback-critical", style, children: children.errorMessage });
}
...
let closure_16 = importAllResult.forwardRef((headerTextStyle, ref) => {
  ...
  const items1 = [callback(require(4299) /* Text */.Text, { style: items, variant: "text-sm/semibold", color: "text-muted", children: headerText }), , ];
  ...
  obj[18] = str2;
  items1[1] = callback(require(5993) /* TextField */.TextField, obj);
  let tmp9Result = null;
  if (null != message) {
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        obj2[2] = sourcePage(9243).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED;
        let tmp9;
        ...
        obj2[3] = tmp9;
        const obj5 = ref(9243);
        ref(9243).sendRequest(obj2).then(() => {
          ...
          outer1_6(obj);
          const result = sourcePage(4001).presentAddedFriendToast();
          closure_6.dismiss();
        }, (body) => {
          let note;
          if (body != null) {
          ...
          if (null != note) {
            ...
            obj[2] = sourcePage(9247).humanizeAbortCode(num, substr);
            obj = sourcePage(9247);
            let num2;
            if (body != null) {
            ...
            const obj4 = sourcePage(9247);
            const tmp3 = substr;
          }
          outer1_6(obj);
        });
        const sendRequestResult = ref(9243).sendRequest(obj2);
      }
    }
  }
  ...
  const effect1 = importAllResult.useEffect(() => {
    ...
    if (tmp2) {
      const AccessibilityAnnouncer = sourcePage(4014).AccessibilityAnnouncer;
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(4714).Button, obj3);
    obj1[0] = items6;
    ...
    const items8 = [tmp17(sourcePage(4299).Text, obj5), , ];
    ...
    obj6[6] = str2;
    items8[1] = tmp17(sourcePage(7976).TextArea, obj6);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4299).Text, obj7);
