...
// Function ID: 13133
// Name: ErrorMessage
// Dependencies: [32, 19, 17, 676, 21, 4302, 712, 1236, 4298, 5933, 13133, 9183, 9179, 4001, 698, 4014, 7916, 4712, 2]

// Module 13132 (ErrorMessage)
...
function ErrorMessage(children) {
  ...
  return callback(require(4298) /* Text */.Text, { variant: "text-xs/medium", color: "text-feedback-critical", style, children: children.errorMessage });
}
...
let closure_16 = importAllResult.forwardRef((headerTextStyle, ref) => {
  ...
  const items1 = [callback(require(4298) /* Text */.Text, { style: items, variant: "text-sm/semibold", color: "text-muted", children: headerText }), , ];
  ...
  obj[18] = str2;
  items1[1] = callback(require(5933) /* TextField */.TextField, obj);
  let tmp9Result = null;
  if (null != message) {
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        obj2[2] = sourcePage(9179).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED;
        let tmp9;
        ...
        obj2[3] = tmp9;
        const obj5 = ref(9179);
        ref(9179).sendRequest(obj2).then(() => {
          ...
          if (null != note) {
            ...
            obj[2] = sourcePage(9183).humanizeAbortCode(num, substr);
            obj = sourcePage(9183);
            let num2;
            if (body != null) {
            ...
            const obj4 = sourcePage(9183);
            const tmp3 = substr;
          }
          outer1_6(obj);
        });
        const sendRequestResult = ref(9179).sendRequest(obj2);
      }
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(4712).Button, obj3);
    obj1[0] = items6;
    ...
    const items8 = [tmp17(sourcePage(4298).Text, obj5), , ];
    ...
    obj6[6] = str2;
    items8[1] = tmp17(sourcePage(7916).TextArea, obj6);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4298).Text, obj7);
