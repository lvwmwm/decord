...
// Function ID: 13509
// Name: ErrorMessage
// Dependencies: [32, 19, 17, 676, 21, 4445, 712, 1236, 4441, 6174, 13509, 8984, 8980, 4161, 698, 1351, 7741, 4880, 2]

// Module 13508 (ErrorMessage)
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        obj2[2] = sourcePage(8980).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED;
        let tmp9;
        ...
        obj2[3] = tmp9;
        const obj5 = ref(8980);
        ref(8980).sendRequest(obj2).then(() => {
          ...
          closure_1_6(obj);
          const result = sourcePage(4161).presentAddedFriendToast();
          closure_6.dismiss();
        }, (body) => {
          let note;
          if (body != null) {
          ...
          if (null != note) {
            ...
            obj[2] = sourcePage(8984).humanizeAbortCode(num, substr);
            obj = sourcePage(8984);
            let num2;
            if (body != null) {
            ...
            const obj4 = sourcePage(8984);
            const tmp3 = substr;
          }
          closure_1_6(obj);
        });
        const sendRequestResult = ref(8980).sendRequest(obj2);
      }
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(4880).Button, obj3);
    obj1[0] = items6;
    ...
    const items8 = [tmp17(sourcePage(4441).Text, obj5), , ];
    ...
    obj6[6] = str2;
    items8[1] = tmp17(sourcePage(7741).TextArea, obj6);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4441).Text, obj7);
