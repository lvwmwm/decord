...
// Function ID: 13270
// Name: ErrorMessage
// Dependencies: [32, 19, 17, 676, 21, 4344, 712, 1236, 4340, 6034, 13270, 9293, 9289, 4061, 698, 1351, 8017, 4754, 2]

// Module 13269 (ErrorMessage)
...
function ErrorMessage(children) {
  ...
  return callback(require(4340) /* Text */.Text, { variant: "text-xs/medium", color: "text-feedback-critical", style, children: children.errorMessage });
}
...
let closure_16 = importAllResult.forwardRef((headerTextStyle, ref) => {
  ...
  const items1 = [callback(require(4340) /* Text */.Text, { style: items, variant: "text-sm/semibold", color: "text-muted", children: headerText }), , ];
  ...
  obj[18] = str2;
  items1[1] = callback(require(6034) /* TextField */.TextField, obj);
  let tmp9Result = null;
  if (null != message) {
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        obj2[2] = sourcePage(9289).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED;
        let tmp9;
        ...
        obj2[3] = tmp9;
        const obj5 = ref(9289);
        ref(9289).sendRequest(obj2).then(() => {
          ...
          if (null != note) {
            ...
            obj[2] = sourcePage(9293).humanizeAbortCode(num, substr);
            obj = sourcePage(9293);
            let num2;
            if (body != null) {
            ...
            const obj4 = sourcePage(9293);
            const tmp3 = substr;
          }
          outer1_6(obj);
        });
        const sendRequestResult = ref(9289).sendRequest(obj2);
      }
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(4754).Button, obj3);
    obj1[0] = items6;
    ...
    const items8 = [tmp17(sourcePage(4340).Text, obj5), , ];
    ...
    obj6[6] = str2;
    items8[1] = tmp17(sourcePage(8017).TextArea, obj6);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4340).Text, obj7);
