...
// Function ID: 13119
// Name: ErrorMessage
// Dependencies: [32, 19, 17, 676, 21, 4285, 712, 1236, 4281, 5914, 13119, 9166, 9162, 3984, 698, 3997, 7899, 4695, 2]

// Module 13118 (ErrorMessage)
...
function ErrorMessage(children) {
  ...
  return callback(require(4281) /* Text */.Text, { variant: "text-xs/medium", color: "text-feedback-critical", style, children: children.errorMessage });
}
...
let closure_16 = importAllResult.forwardRef((headerTextStyle, ref) => {
  ...
  const items1 = [callback(require(4281) /* Text */.Text, { style: items, variant: "text-sm/semibold", color: "text-muted", children: headerText }), , ];
  ...
  obj[18] = str2;
  items1[1] = callback(require(5914) /* TextField */.TextField, obj);
  let tmp9Result = null;
  if (null != message) {
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        obj2[2] = sourcePage(9162).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED;
        let tmp9;
        ...
        obj2[3] = tmp9;
        const obj5 = ref(9162);
        ref(9162).sendRequest(obj2).then(() => {
          ...
          outer1_6(obj);
          const result = sourcePage(3984).presentAddedFriendToast();
          closure_6.dismiss();
        }, (body) => {
          let note;
          if (body != null) {
          ...
          if (null != note) {
            ...
            obj[2] = sourcePage(9166).humanizeAbortCode(num, substr);
            obj = sourcePage(9166);
            let num2;
            if (body != null) {
            ...
            const obj4 = sourcePage(9166);
            const tmp3 = substr;
          }
          outer1_6(obj);
        });
        const sendRequestResult = ref(9162).sendRequest(obj2);
      }
    }
  }
  ...
  const effect1 = importAllResult.useEffect(() => {
    ...
    if (tmp2) {
      const AccessibilityAnnouncer = sourcePage(3997).AccessibilityAnnouncer;
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(4695).Button, obj3);
    obj1[0] = items6;
    ...
    const items8 = [tmp17(sourcePage(4281).Text, obj5), , ];
    ...
    obj6[6] = str2;
    items8[1] = tmp17(sourcePage(7899).TextArea, obj6);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4281).Text, obj7);
