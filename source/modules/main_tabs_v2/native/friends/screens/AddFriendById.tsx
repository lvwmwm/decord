...
// Function ID: 13866
// Name: ErrorMessage
// Dependencies: [32, 19, 17, 673, 21, 4481, 709, 1233, 4477, 6553, 13866, 8976, 8972, 4193, 695, 1350, 7025, 4936, 2]

// Module 13865 (ErrorMessage)
import ThemesDefault from "Themes" /* 709 */;
import getSystemLocale from "getSystemLocale" /* 1233 */;
import Text from "Text" /* 4477 */;
import TextField from "TextField" /* 6553 */;
import apexExperimentDefault from "apexExperiment" /* 13866 */;
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        obj2[2] = sourcePage(8972).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED;
        let tmp9;
        ...
        obj2[3] = tmp9;
        const obj5 = ref(8972);
        ref(8972).sendRequest(obj2).then(() => {
          ...
          if (null != note) {
            ...
            obj[2] = sourcePage(8976).humanizeAbortCode(num, substr);
            obj = sourcePage(8976);
            let num2;
            if (body != null) {
            ...
            const obj4 = sourcePage(8976);
            const tmp3 = substr;
          }
          closure_1_6(obj);
        });
        const sendRequestResult = ref(8972).sendRequest(obj2);
      }
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(4936).Button, obj3);
    obj1[0] = items6;
    ...
    const items8 = [tmp17(sourcePage(4477).Text, obj5), , ];
    ...
    obj6[6] = str2;
    items8[1] = tmp17(sourcePage(7025).TextArea, obj6);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4477).Text, obj7);
