...
// Function ID: 13082
// Name: ErrorMessage
// Dependencies: [32, 19, 17, 676, 21, 4255, 712, 1236, 4251, 5887, 13082, 9137, 9133, 3955, 698, 3968, 7758, 4665, 2]

// Module 13081 (ErrorMessage)
...
let closure_16 = importAllResult.forwardRef((headerTextStyle, ref) => {
  ...
  obj[18] = str2;
  items1[1] = callback(require(5887) /* TextField */.TextField, obj);
  let tmp9Result = null;
  if (null != message) {
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        obj2[2] = sourcePage(9133).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED;
        let tmp9;
        ...
        obj2[3] = tmp9;
        const obj5 = ref(9133);
        ref(9133).sendRequest(obj2).then(() => {
          ...
          if (null != note) {
            ...
            obj[2] = sourcePage(9137).humanizeAbortCode(num, substr);
            obj = sourcePage(9137);
            let num2;
            if (body != null) {
            ...
            const obj4 = sourcePage(9137);
            const tmp3 = substr;
          }
          outer1_6(obj);
        });
        const sendRequestResult = ref(9133).sendRequest(obj2);
      }
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(4665).Button, obj3);
    obj1[0] = items6;
    ...
    obj6[6] = str2;
    items8[1] = tmp17(sourcePage(7758).TextArea, obj6);
    if (first1.status !== tmp4.ERROR) {
