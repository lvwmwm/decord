...
// Function ID: 13562
// Name: ErrorMessage
// Dependencies: [32, 19, 17, 676, 21, 4448, 712, 1236, 4444, 6190, 13562, 9025, 9021, 4163, 698, 1351, 7776, 4896, 2]

// Module 13561 (ErrorMessage)
import ThemesDefault from "Themes" /* 712 */;
import getSystemLocale from "getSystemLocale" /* 1236 */;
import Text from "Text" /* 4444 */;
import TextField from "TextField" /* 6190 */;
import apexExperimentDefault from "apexExperiment" /* 13562 */;
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        obj2[2] = sourcePage(9021).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED;
        let tmp9;
        ...
        obj2[3] = tmp9;
        const obj5 = ref(9021);
        ref(9021).sendRequest(obj2).then(() => {
          ...
          closure_1_6(obj);
          const result = sourcePage(4163).presentAddedFriendToast();
          closure_6.dismiss();
        }, (body) => {
          let note;
          if (body != null) {
          ...
          if (null != note) {
            ...
            obj[2] = sourcePage(9025).humanizeAbortCode(num, substr);
            obj = sourcePage(9025);
            let num2;
            if (body != null) {
            ...
            const obj4 = sourcePage(9025);
            const tmp3 = substr;
          }
          closure_1_6(obj);
        });
        const sendRequestResult = ref(9021).sendRequest(obj2);
      }
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(4896).Button, obj3);
    obj1[0] = items6;
    ...
    const items8 = [tmp17(sourcePage(4444).Text, obj5), , ];
    ...
    obj6[6] = str2;
    items8[1] = tmp17(sourcePage(7776).TextArea, obj6);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4444).Text, obj7);
