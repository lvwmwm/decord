...
// Dependencies: [32, 5, 19, 17, 1387, 13375, 4522, 1922, 10594, 676, 21, 4448, 712, 4461, 4695, 9832, 12432, 4415, 589, 16299, 698, 4164, 1236, 7575, 7585, 9907, 8617, 7471, 1297, 10595, 2]
// Exports: default

// Module 16312 (handleOneRecipientInDM)
...
import closure_9 from "performQuery" /* 13375 */;
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            arr(4415).hideActionSheet(closure_16);
            c6 = 3;
            const obj12 = arr(4415);
          }
        } catch (tmp77) {
          c6 = tmp;
          throw tmp77;
