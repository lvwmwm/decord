...
// Dependencies: [32, 5, 19, 17, 1386, 13646, 4554, 1921, 10857, 673, 21, 4478, 709, 4491, 4728, 9897, 12701, 4445, 586, 16588, 695, 4194, 1233, 7618, 7628, 9972, 8668, 7514, 1296, 10858, 2]
// Exports: default
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            arr(4445).hideActionSheet(closure_16);
            c6 = 3;
            const obj12 = arr(4445);
          }
        } catch (tmp77) {
          c6 = tmp;
          throw tmp77;
