...
// Dependencies: [31, 27, 33, 9041, 4131, 689, 9053, 9050, 11626, 1212, 15491, 5703, 5517, 15492, 15498, 15510, 15511, 15512, 15518, 15519, 15520, 15522, 15525, 15526, 3978, 1557, 3843, 2]
// Exports: default

// Module 15490 (RequestsSettingsModalButton)
...
function RequestsSettingsModalButton(onPress) {
  ...
  obj = { source: importDefault(11626), onPress: onPress.onPress };
...
function FriendsNavigator() {
  ...
  importDefault = importDefault(15491)();
