...
// Dependencies: [19, 17, 21, 8633, 4342, 712, 8456, 8453, 12034, 1236, 7004, 5844, 15916, 15922, 15935, 15936, 15937, 15943, 15944, 15945, 15947, 15950, 15951, 4193, 1628, 4072, 2]
// Exports: default

// Module 15915 (RequestsSettingsModalButton)
...
function RequestsSettingsModalButton(onPress) {
  ...
  obj[1] = callback(require(8453) /* GenericHeaderTitle */.HeaderIconButton, obj);
  return callback(importDefault(8456), obj);
}
function FriendsNavigator() {
  const _require = createNativeStackNavigator();
  const layoutEffect = React.useLayoutEffect(() => lib(7004).trackAppUIViewed(), []);
