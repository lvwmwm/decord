...
// Dependencies: [19, 17, 21, 9109, 4189, 712, 9121, 9118, 11690, 1236, 15577, 5731, 5570, 15578, 15584, 15596, 15597, 15598, 15604, 15605, 15606, 15608, 15611, 15612, 4036, 1581, 3901, 2]
// Exports: default

// Module 15576 (RequestsSettingsModalButton)
...
function RequestsSettingsModalButton(onPress) {
  ...
  obj[0] = importDefault(11690);
  obj[1] = onPress.onPress;
  const intl = require(1236) /* getSystemLocale */.intl;
  obj[2] = intl.string(require(1236) /* getSystemLocale */.t["3D5yo/"]);
  obj[1] = callback(require(9118) /* GenericHeaderTitle */.HeaderIconButton, obj);
  return callback(importDefault(9121), obj);
}
function FriendsNavigator() {
  const _require = createNativeStackNavigator();
  importDefault = importDefault(15577)();
    ...
    screenOptions(arg0) {
      ...
      if (navigation.getState().routes[0].key === route.key) {
        ...
        if ("card" !== presentation2) {
          let renderModalCloseImage = lib(9118).getRenderModalCloseImage(navigation);
          const obj3 = lib(9118);
        }
      ...
      renderModalCloseImage = lib(9118).getRenderModalBackImage(navigation);
    },
    children: null
  };
  obj = {
