...
// Dependencies: [19, 17, 21, 8510, 4302, 712, 8325, 8322, 11888, 1236, 6874, 5723, 15741, 15747, 15759, 15760, 15761, 15767, 15768, 15769, 15771, 15774, 15775, 4148, 1609, 4013, 2]
// Exports: default

// Module 15740 (RequestsSettingsModalButton)
...
function RequestsSettingsModalButton(onPress) {
  ...
  obj[0] = importDefault(11888);
  obj[1] = onPress.onPress;
  const intl = require(1236) /* getSystemLocale */.intl;
  obj[2] = intl.string(require(1236) /* getSystemLocale */.t["3D5yo/"]);
  obj[1] = callback(require(8322) /* GenericHeaderTitle */.HeaderIconButton, obj);
  return callback(importDefault(8325), obj);
}
function FriendsNavigator() {
  const _require = createNativeStackNavigator();
  const layoutEffect = React.useLayoutEffect(() => lib(6874).trackAppUIViewed(), []);
