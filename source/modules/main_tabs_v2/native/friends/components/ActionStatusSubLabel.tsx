...
// Dependencies: [19, 21, 4302, 4014, 4162, 4298, 4718, 4303, 2]
// Exports: ActionStatusSubLabel

// Module 15474 (announceActioned)
import "noop";
...
let closure_7 = require("module_4162").createAnimatedComponent(require("Text").Text);
