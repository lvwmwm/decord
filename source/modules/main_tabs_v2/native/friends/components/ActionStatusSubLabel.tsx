...
// Dependencies: [19, 21, 4285, 3998, 4146, 4281, 4701, 4286, 2]
// Exports: ActionStatusSubLabel

// Module 15431 (announceActioned)
import "noop";
...
let closure_7 = require("module_4146").createAnimatedComponent(require("Text").Text);
