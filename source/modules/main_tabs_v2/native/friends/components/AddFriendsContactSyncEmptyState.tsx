...
// Dependencies: [19, 17, 21, 4255, 712, 11900, 4251, 1236, 11887, 4666, 11883, 2]
// Exports: default

// Module 15691 (AddFriendsContactSyncEmptyState)
import "noop";
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  obj = { resizeMode: "contain", style: tmp.headerImage, source: importDefault(11900) };
  ...
  obj3[0] = require(11887) /* _uploadContacts */.handleOpenLearnMoreLink;
