...
// Dependencies: [19, 17, 21, 4285, 712, 11966, 4281, 1236, 11953, 4695, 11949, 2]
// Exports: default

// Module 15742 (AddFriendsContactSyncEmptyState)
import "noop";
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  obj = { resizeMode: "contain", style: tmp.headerImage, source: importDefault(11966) };
  ...
  obj3[0] = require(11953) /* _uploadContacts */.handleOpenLearnMoreLink;
