...
// Dependencies: [19, 17, 21, 4342, 712, 12110, 4338, 1236, 12097, 4755, 12093, 2]
// Exports: default

// Module 15933 (AddFriendsContactSyncEmptyState)
import "noop";
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  obj = { resizeMode: "contain", style: tmp.headerImage, source: importDefault(12110) };
  ...
  obj3[0] = require(12097) /* _uploadContacts */.handleOpenLearnMoreLink;
