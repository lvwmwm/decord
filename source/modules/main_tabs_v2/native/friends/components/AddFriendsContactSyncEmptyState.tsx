...
// Dependencies: [19, 17, 21, 4255, 712, 11932, 4251, 1236, 11919, 4665, 11915, 2]
// Exports: default

// Module 15702 (AddFriendsContactSyncEmptyState)
import "noop";
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  obj = { resizeMode: "contain", style: tmp.headerImage, source: importDefault(11932) };
  ...
  obj3[0] = require(11919) /* _uploadContacts */.handleOpenLearnMoreLink;
