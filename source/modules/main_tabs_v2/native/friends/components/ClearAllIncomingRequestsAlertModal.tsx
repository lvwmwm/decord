...
// Function ID: 15610
// Name: handleConfirm
// Dependencies: [5, 19, 21, 8918, 4533, 1236, 4533, 2]
// Exports: default

// Module 15609 (handleConfirm)
...
export default function ClearAllIncomingRequestsAlertModal(incomingRequestCount) {
  ...
  const items = [callback2(require(4533) /* getAlertModalItemKey */.AlertActionButton, obj, "confirm"), ];
  const obj1 = { variant: "secondary", text: null };
  const intl4 = require(1236) /* getSystemLocale */.intl;
  obj1[1] = intl4.string(require(1236) /* getSystemLocale */.t["ETE/oC"]);
  items[1] = callback2(require(4533) /* getAlertModalItemKey */.AlertActionButton, obj1, "cancel");
  obj[0] = items;
  obj[2] = callback3(require(4533) /* getAlertModalItemKey */.AlertActions, obj);
  return callback2(require(4533) /* getAlertModalItemKey */.AlertModal, obj);
};
