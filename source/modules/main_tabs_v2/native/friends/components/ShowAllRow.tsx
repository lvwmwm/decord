...
// Function ID: 15921
// Name: ShowAllRow
// Dependencies: [19, 17, 21, 4342, 712, 5414, 13497, 1297, 4338, 1236, 2]
// Exports: default

// Module 15920 (ShowAllRow)
import "noop";
...
export default function ShowAllRow(users) {
  ...
  const items = [callback(require(13497) /* AvatarDuoPile */.AvatarDuoPile, obj), ];
  ...
  obj[4] = callback(require(5414) /* TableRowInner */.TableRow.Arrow, {});
