...
// Function ID: 15838
// Name: ShowAllRow
// Dependencies: [19, 17, 21, 4303, 712, 5374, 13428, 1297, 4299, 1236, 2]
// Exports: default

// Module 15837 (ShowAllRow)
import "noop";
...
export default function ShowAllRow(users) {
  ...
  const items = [callback(require(13428) /* AvatarDuoPile */.AvatarDuoPile, obj), ];
  ...
  obj[4] = callback(require(5374) /* TableRowInner */.TableRow.Arrow, {});
