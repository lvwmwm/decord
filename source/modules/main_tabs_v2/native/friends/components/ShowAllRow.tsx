...
// Function ID: 15920
// Name: ShowAllRow
// Dependencies: [19, 17, 21, 4344, 712, 5413, 13495, 1297, 4340, 1236, 2]
// Exports: default

// Module 15919 (ShowAllRow)
import "noop";
...
export default function ShowAllRow(users) {
  ...
  const items = [callback(require(13495) /* AvatarDuoPile */.AvatarDuoPile, obj), ];
  ...
  obj[4] = callback(require(5413) /* TableRowInner */.TableRow.Arrow, {});
