...
// Dependencies: [19, 17, 5750, 5751, 21, 4285, 589, 15059, 4695, 1236, 7672, 12444, 9039, 2]
// Exports: default

// Module 15058 (MessageRequestAnimation)
...
function MessageRequestAnimation(color) {
  ...
  return callback(ref(15059).MessageRequestLottie, { ref, color: color.color, size: "sm", autoPlay: true });
}
...
export default function MessageRequestsButton(alternateVariant) {
  ...
  if (flag) {
    ...
    const items2 = [tmp21, str > 0 && tmp16(tmp3(12444).ButtonBadge, { badgePosition: "right" })];
    obj[2] = items2;
