...
// Dependencies: [19, 17, 5902, 5903, 21, 4342, 589, 15245, 4777, 1236, 7817, 12622, 9181, 2]
// Exports: default

// Module 15244 (MessageRequestAnimation)
...
function MessageRequestAnimation(color) {
  ...
  return callback(ref(15245).MessageRequestLottie, { ref, color: color.color, size: "sm", autoPlay: true });
}
...
export default function MessageRequestsButton(alternateVariant) {
  ...
  if (flag) {
    ...
    if (null != str) {
      ...
      let tmp21 = callback(tmp3(4777).Button, obj);
      let tmp16 = callback;
    } else {
      tmp16 = callback;
      ...
      tmp21 = callback(tmp3(7817).IconButton, obj1);
    }
    const items2 = [tmp21, str > 0 && tmp16(tmp3(12622).ButtonBadge, { badgePosition: "right" })];
    obj[2] = items2;
    return closure_8(View, obj);
  } else {
    const obj2 = { source: null, IconComponent: null, accessibilityLabel: null, buttonText: null, badge: null, badgePosition: "right" };
    obj2[0] = importDefault(9181);
    ...
    return callback(importDefault(12622), obj2);
  }
  tmp2 = callback2();
};
