...
// Dependencies: [9517, 4671, 2]
// Exports: default

// Module 9519 (useScaledSectionHeight)
...
export default function useScaledSectionHeight() {
  return closure_2 + Math.max(Math.min(require(4671) /* getFontScale */.useFontScale(), 2) * closure_3 - closure_3, 0);
};
