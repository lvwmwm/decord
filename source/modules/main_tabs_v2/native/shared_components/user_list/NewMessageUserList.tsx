...
// Dependencies: [32, 19, 17, 1372, 3921, 1903, 9539, 21, 4285, 712, 5212, 4123, 4475, 12, 9541, 1236, 4281, 9543, 9545, 10170, 11659, 2]
// Exports: default, useSearchGDMNames

// Module 11658 (matchGroupDMRecipients)
...
function matchGroupDMRecipients(trimmed1, recipients) {
  ...
  while (obj !== undefined) {
    ...
    if (null != user) {
      ...
      if (importDefault(5212)(trimmed1, toLocaleLowerCaseResult)) {
        let tmp16 = obj;
        obj.return();
        let num3 = 1;
        return 1;
      } else {
        let tmp19Result = tmp19(4123);
        let tmp5 = user;
