...
// Dependencies: [32, 19, 17, 1372, 3892, 1874, 9510, 21, 4255, 712, 5182, 4094, 4445, 12, 9512, 1236, 4251, 9514, 9516, 10139, 11625, 2]
// Exports: default, useSearchGDMNames

// Module 11624 (matchGroupDMRecipients)
...
function matchGroupDMRecipients(trimmed1, recipients) {
  ...
  while (obj !== undefined) {
    ...
    if (null != user) {
      ...
      if (importDefault(5182)(trimmed1, toLocaleLowerCaseResult)) {
        let tmp16 = obj;
        obj.return();
        let num3 = 1;
        return 1;
...
function matchGroupDM(id, trimmed1) {
  if ("" === trimmed1) {
    ...
    const channelName = require(4445) /* computeChannelName */.computeChannelName(id, mergeGuildAvatar, upsertRelationship);
