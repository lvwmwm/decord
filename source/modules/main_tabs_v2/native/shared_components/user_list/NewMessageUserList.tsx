...
// Dependencies: [32, 19, 17, 1372, 3922, 1874, 9539, 21, 4285, 712, 5197, 4124, 4475, 12, 9541, 1236, 4281, 9543, 9545, 10168, 11653, 2]
// Exports: default, useSearchGDMNames

// Module 11652 (matchGroupDMRecipients)
...
function matchGroupDMRecipients(trimmed1, recipients) {
  ...
  while (obj !== undefined) {
    ...
    if (null != user) {
      ...
      if (importDefault(5197)(trimmed1, toLocaleLowerCaseResult)) {
        let tmp16 = obj;
        obj.return();
        let num3 = 1;
        return 1;
      } else {
        let tmp19Result = tmp19(4124);
        let tmp5 = user;
...
function matchGroupDM(id, trimmed1) {
  if ("" === trimmed1) {
    ...
    const channelName = require(4475) /* computeChannelName */.computeChannelName(id, mergeGuildAvatar, upsertRelationship);
