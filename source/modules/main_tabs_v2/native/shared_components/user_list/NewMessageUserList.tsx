...
// Dependencies: [32, 19, 17, 1391, 3998, 1922, 9665, 21, 4344, 712, 5268, 4189, 4534, 12, 9667, 1236, 4340, 9669, 9671, 10299, 11801, 2]
// Exports: default, useSearchGDMNames

// Module 11800 (matchGroupDMRecipients)
...
function matchGroupDMRecipients(trimmed1, recipients) {
  ...
  while (obj !== undefined) {
    ...
    if (null != user) {
      ...
      if (importDefault(5268)(trimmed1, toLocaleLowerCaseResult)) {
        let tmp16 = obj;
        obj.return();
        let num3 = 1;
        return 1;
...
function matchGroupDM(id, trimmed1) {
  if ("" === trimmed1) {
    ...
    const channelName = require(4534) /* computeChannelName */.computeChannelName(id, mergeGuildAvatar, markAllUserIdListsStale);
