// Module ID: 5900
// Function ID: 5901
// Dependencies: [19, 17, 21, 4285, 5235, 712, 4812, 1236, 500, 5242, 4281, 5901, 2]
...
const forwardRefResult = importAllResult.forwardRef((onClose, ref) => {
  ...
  if (obj1.isAndroid()) {
    ...
    let tmp3Result = tmp3(tmp4(5242).ArrowLargeLeftIcon, obj);
  } else {
  ...
  obj[4] = tmp3Result;
  tmp3Result = tmp3(require(4812) /* PressableBase */.PressableOpacity, obj);
  ...
  obj3[0] = closure_3(require(5901) /* SearchField */.SearchField, { size: "md", isRound: true, ref });
