// Module ID: 5885
// Function ID: 5886
// Dependencies: [19, 17, 21, 4255, 5220, 712, 4797, 1236, 500, 5227, 4251, 5886, 2]
...
const forwardRefResult = importAllResult.forwardRef((onClose, ref) => {
  ...
  if (obj1.isAndroid()) {
    ...
    let tmp3Result = tmp3(tmp4(5227).ArrowLargeLeftIcon, obj);
  } else {
  ...
  obj[4] = tmp3Result;
  tmp3Result = tmp3(require(4797) /* PressableBase */.PressableOpacity, obj);
  ...
  obj3[0] = closure_3(require(5886) /* SearchField */.SearchField, { size: "md", isRound: true, ref });
