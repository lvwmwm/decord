// Module ID: 6055
// Function ID: 6056
// Dependencies: [19, 17, 21, 4342, 5328, 712, 4909, 1236, 500, 5335, 4338, 6056, 2]
...
const forwardRefResult = importAllResult.forwardRef((onClose, ref) => {
  ...
  if (obj1.isAndroid()) {
    ...
    let tmp3Result = tmp3(tmp4(5335).ArrowLargeLeftIcon, obj);
  } else {
  ...
  obj[4] = tmp3Result;
  tmp3Result = tmp3(require(4909) /* PressableBase */.PressableOpacity, obj);
  ...
  obj3[0] = closure_3(require(6056) /* SearchField */.SearchField, { size: "md", isRound: true, ref });
