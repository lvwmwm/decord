// Module ID: 6188
// Function ID: 6189
// Dependencies: [19, 17, 21, 4448, 5460, 712, 5036, 1236, 500, 5467, 4444, 6189, 2]
...
const forwardRefResult = importAllResult.forwardRef((onClose, ref) => {
  ...
  if (obj1.isAndroid()) {
    ...
    let tmp3Result = tmp3(tmp4(5467).ArrowLargeLeftIcon, obj);
  } else {
    ...
    tmp3Result = tmp3(tmp4(4444).Text, obj);
  }
  obj[4] = tmp3Result;
