...
// Dependencies: [19, 17, 4247, 21, 4255, 712, 5110, 1348, 4101, 5258, 647, 4116, 4256, 4664, 4251, 5221, 2]
// Exports: default

// Module 12198 (AnimatedContainer)
...
function GroupMemberCount(count) {
  ...
  obj = { style: tmp.overflowCount, children: callback2(require(4251) /* Text */.Text, { variant: "text-sm/semibold", children: items }) };
  items = ["+", count.count];
...
let closure_12 = createCacheKey.createStyles((arg0) => {
  ...
  if (!arg0) {
    DARK_03_LIGHT_02 = require(5110) /* result */.DARK_03_LIGHT_02;
  }
