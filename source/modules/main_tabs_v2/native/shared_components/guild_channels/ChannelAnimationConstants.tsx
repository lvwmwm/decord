...
const fn = function n() {
  ...
  obj = { scale: null };
  obj[0] = require(4711) /* CONFIG_NEVER_ANIMATE */.withSpring(1, obj);
  const items1 = [obj];
  obj[0] = items1;
  const obj4 = require(4711) /* CONFIG_NEVER_ANIMATE */;
  obj[1] = require(4711) /* CONFIG_NEVER_ANIMATE */.withSpring(1, obj);
  obj[1] = obj;
  return obj;
};
...
const fn2 = function t() {
  ...
  obj = { transform: null, opacity: null };
  obj = { scale: null };
  obj[0] = require(4711) /* CONFIG_NEVER_ANIMATE */.withSpring(0, obj);
  const items1 = [obj];
  obj[0] = items1;
  const obj4 = require(4711) /* CONFIG_NEVER_ANIMATE */;
  obj[1] = require(4711) /* CONFIG_NEVER_ANIMATE */.withSpring(0, obj);
  obj[1] = obj;
  return obj;
};
obj = { withSpring: require("CONFIG_NEVER_ANIMATE").withSpring, CHANNEL_SPRING_CONFIG: obj };
