...
// Dependencies: [19, 17, 1891, 3921, 1903, 4481, 21, 8956, 1236, 4285, 712, 9713, 589, 5700, 11494, 7023, 15449, 9582, 15636, 4475, 2]
// Exports: getChannelAccessibilityProps, renderChannelItem

// Module 15638 (LaunchpadChannelIcon)
...
function LaunchpadChannelIcon(channel) {
  ...
  obj[1] = callback(importDefault(5700), obj);
...
export const getChannelAccessibilityProps = function getChannelAccessibilityProps(channel) {
  ...
  let voiceStates;
  channel = channel.channel;
  let obj = { accessible: true, accessibilityRole: "button", accessibilityLabel: importDefault(8956)({ channel, unread, mentionCount, voiceStates, embeddedActivitiesCount }) };
...
export const renderChannelItem = function renderChannelItem(unread) {
  ...
  if (null != latestMessageTimestamp) {
    ...
    if (!flag3) {
      let obj = require(7023) /* getRelativeTimestamp */;
  ...
  let obj2 = require(15449) /* renderChannelWrapper */;
  ...
  const merged = Object.assign(require(9713) /* getLayoutStyles */.makeSizeStyle(layoutStyles.icon.wrapper.size));
