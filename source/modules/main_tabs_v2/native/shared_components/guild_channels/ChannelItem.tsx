...
// Dependencies: [19, 17, 1862, 3892, 1874, 4451, 21, 8927, 1236, 4255, 712, 9682, 589, 5646, 11460, 6996, 15411, 9553, 15598, 4445, 2]
// Exports: getChannelAccessibilityProps, renderChannelItem

// Module 15600 (LaunchpadChannelIcon)
...
function LaunchpadChannelIcon(channel) {
  ...
  obj[1] = callback(importDefault(5646), obj);
...
export const getChannelAccessibilityProps = function getChannelAccessibilityProps(channel) {
  ...
  let voiceStates;
  channel = channel.channel;
  let obj = { accessible: true, accessibilityRole: "button", accessibilityLabel: importDefault(8927)({ channel, unread, mentionCount, voiceStates, embeddedActivitiesCount }) };
...
export const renderChannelItem = function renderChannelItem(unread) {
  ...
  if (null != latestMessageTimestamp) {
    ...
    if (!flag3) {
      let obj = require(6996) /* getRelativeTimestamp */;
  ...
  let obj2 = require(15411) /* renderChannelWrapper */;
  ...
  const merged = Object.assign(require(9682) /* getLayoutStyles */.makeSizeStyle(layoutStyles.icon.wrapper.size));
  ...
  if (channel.isGroupDM()) {
    ...
    let tmp10Result = tmp10(importDefault(9553), obj1);
  } else {
