// Module ID: 15249
// Function ID: 15250
// Dependencies: [19, 17, 9855, 4551, 21, 4342, 9856, 4783, 8459, 2]
...
const memoResult = require("noop").memo(function ChannelUnreadBadge(panelVariant) {
  ...
  if (unread) {
    ...
    const items1 = [obj1];
    obj[2] = items1;
    obj[1] = jsx(importDefault(8459), { classic: null, size: null, badgeStyle: null });
    tmp8Result = tmp8(tmp9, obj);
    const tmp12 = importDefault(8459);
  }
  return tmp8Result;
});
