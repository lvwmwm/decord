...
// Dependencies: [19, 21, 9713, 4281, 15244, 9710, 2]
// Exports: renderChannelSubtitle

// Module 15632 (ChannelSubtitle)
import "noop";
...
export const renderChannelSubtitle = function renderChannelSubtitle(arg0) {
  ...
  if (null == subtitle) {
    ...
    obj[0] = require(9713) /* getLayoutStyles */.getLayoutStyles(layout).messagePreview.text.variant;
