...
// Dependencies: [19, 21, 9682, 4251, 15205, 9679, 2]
// Exports: renderChannelSubtitle

// Module 15594 (ChannelSubtitle)
import "noop";
...
export const renderChannelSubtitle = function renderChannelSubtitle(arg0) {
  ...
  if (null == subtitle) {
    ...
    obj[0] = require(9682) /* getLayoutStyles */.getLayoutStyles(layout).messagePreview.text.variant;
