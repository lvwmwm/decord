...
// Dependencies: [19, 21, 9729, 4298, 15268, 9726, 2]
// Exports: renderChannelSubtitle

// Module 15656 (ChannelSubtitle)
import "noop";
...
export const renderChannelSubtitle = function renderChannelSubtitle(arg0) {
  ...
  if (null == subtitle) {
    ...
    obj[0] = require(9729) /* getLayoutStyles */.getLayoutStyles(layout).messagePreview.text.variant;
