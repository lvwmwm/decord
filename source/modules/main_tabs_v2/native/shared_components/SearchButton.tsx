...
// Dependencies: [19, 17, 21, 4285, 712, 5915, 4281, 1236, 2]
// Exports: SearchButtonContent

// Module 11656 (SEARCH_BAR_HEIGHT)
import "noop";
...
export const SearchButtonContent = function SearchButtonContent(panelVariant) {
  ...
  obj.style = items;
  const items1 = [callback(require(5915) /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { size: "xs" }), ];
