...
// Dependencies: [19, 17, 21, 4255, 712, 5900, 4251, 1236, 2]
// Exports: SearchButtonContent

// Module 11628 (SEARCH_BAR_HEIGHT)
import "noop";
...
export const SearchButtonContent = function SearchButtonContent(panelVariant) {
  ...
  obj.style = items;
  const items1 = [callback(require(5900) /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { size: "xs" }), ];
