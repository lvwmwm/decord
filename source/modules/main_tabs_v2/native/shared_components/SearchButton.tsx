...
// Dependencies: [19, 17, 21, 4302, 712, 5946, 4298, 1236, 2]
// Exports: SearchButtonContent

// Module 11677 (SEARCH_BAR_HEIGHT)
import "noop";
...
export const SearchButtonContent = function SearchButtonContent(panelVariant) {
  ...
  obj.style = items;
  const items1 = [callback(require(5946) /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { size: "xs" }), ];
