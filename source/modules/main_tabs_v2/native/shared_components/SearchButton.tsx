...
// Dependencies: [19, 17, 21, 4255, 712, 5905, 4251, 1236, 2]
// Exports: SearchButtonContent

// Module 11593 (SEARCH_BAR_HEIGHT)
import "noop";
...
export const SearchButtonContent = function SearchButtonContent(panelVariant) {
  ...
  obj.style = items;
  const items1 = [callback(require(5905) /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { size: "xs" }), ];
