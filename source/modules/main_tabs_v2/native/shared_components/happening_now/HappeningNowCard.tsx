...
// Dependencies: [19, 17, 14595, 21, 4344, 712, 7682, 1367, 4195, 5415, 4340, 2]
// Exports: HappeningNowCardHeader, HappeningNowCardSubtitle, default

// Module 14596 (HAPPENING_NOW_CARD_MARGIN_RIGHT)
import "noop";
...
export default function HappeningNowCard(IconComponent) {
  ...
  const tmp5Result = closure_21(width, panelVariant, importDefault(7682)(), tmp4);
  IconComponent = IconComponent.IconComponent;
  const tmp = importDefault;
  const tmp3 = importDefault(7682)();
  ...
  obj[9] = items1;
  return closure_19(require(5415) /* PressableCard */.Card, obj);
};
export const HappeningNowCardHeader = function HappeningNowCardHeader(displayNameFont) {
  ...
  return closure_18(require(4340) /* Text */.Text, obj);
};
