...
// Dependencies: [19, 17, 14528, 21, 4303, 712, 7641, 1348, 4154, 5376, 4299, 2]
// Exports: HappeningNowCardHeader, HappeningNowCardSubtitle, default

// Module 14529 (HAPPENING_NOW_CARD_MARGIN_RIGHT)
import "noop";
...
export default function HappeningNowCard(IconComponent) {
  ...
  obj[9] = items1;
  return closure_19(require(5376) /* PressableCard */.Card, obj);
};
export const HappeningNowCardHeader = function HappeningNowCardHeader(displayNameFont) {
  ...
  return closure_18(require(4299) /* Text */.Text, obj);
};
