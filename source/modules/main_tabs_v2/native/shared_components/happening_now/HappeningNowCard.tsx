...
// Dependencies: [19, 17, 14608, 21, 4342, 712, 7707, 1367, 4193, 5437, 4338, 2]
// Exports: HappeningNowCardHeader, HappeningNowCardSubtitle, default

// Module 14609 (HAPPENING_NOW_CARD_MARGIN_RIGHT)
import "noop";
...
export default function HappeningNowCard(IconComponent) {
  ...
  const tmp5Result = closure_21(width, panelVariant, importDefault(7707)(), tmp4);
  IconComponent = IconComponent.IconComponent;
  const tmp = importDefault;
  const tmp3 = importDefault(7707)();
  ...
  obj[9] = items1;
  return closure_19(require(5437) /* PressableCard */.Card, obj);
};
