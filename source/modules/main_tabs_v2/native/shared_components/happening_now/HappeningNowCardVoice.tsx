...
// Dependencies: [19, 17, 7041, 1903, 4301, 14442, 676, 21, 4285, 698, 10893, 1988, 15115, 14443, 4810, 12232, 15125, 8096, 589, 12, 1351, 4474, 1236, 2]
// Exports: useVoiceChannelUsers

// Module 15132 (formatVoiceActivityTitle)
...
export const useVoiceChannelUsers = function useVoiceChannelUsers(channelId) {
  ...
  const voiceUserAffinitySortType = _require(8096).useVoiceUserAffinitySortType("useVoiceChannelUsers");
  const obj = _require(8096);
