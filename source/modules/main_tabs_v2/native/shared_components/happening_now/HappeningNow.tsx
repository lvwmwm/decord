...
// Function ID: 15193
// Name: renderCard
// Dependencies: [32, 19, 17, 14530, 676, 21, 8010, 4303, 712, 5427, 8491, 15193, 698, 4730, 1481, 15194, 5728, 5748, 15201, 15202, 4036, 10331, 12, 7745, 1236, 15203, 15204, 15221, 15223, 15224, 15207, 15220, 15225, 15219, 15206, 1351, 2]

// Module 15192 (renderCard)
...
function renderCard(kind, fullWidth) {
  ...
  return jsx(require(15203) /* HappeningNowCardPlaceholder */.HappeningNowCardPlaceholder, { fullWidth: fullWidth.fullwidth, panelVariant: fullWidth.panelVariant });
}
