...
// Dependencies: [57, 31, 27, 14244, 653, 33, 7621, 4131, 689, 5217, 8193, 14979, 675, 4560, 1457, 14980, 5462, 5482, 14987, 14988, 3992, 9980, 22, 6619, 1212, 14989, 14990, 15007, 15009, 15010, 14993, 15006, 15011, 15005, 14992, 1327, 2]

// Module 14978 (shouldTrackViewedEvent)
...
function renderCard(kind, fullWidth) {
  if ("placeholder" !== kind.kind) {
    if (!fullWidth.loading) {
      ...
      if ("live-guild-stage" === kind) {
        ...
        merged = fullWidth;
        merged = Object.assign(fullWidth);
        return jsx(importDefault(15009), {});
      } else if ("user" === kind) {
        const obj2 = {};
        ...
        return jsx(importDefault(15005), {});
        ...
        return jsx(importDefault(14992), {});
      } else {
        merged = require;
  ...
  return jsx(require(14989) /* HappeningNowCardPlaceholder */.HappeningNowCardPlaceholder, { fullWidth: fullWidth.fullwidth, panelVariant: fullWidth.panelVariant });
}
