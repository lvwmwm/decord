...
// Dependencies: [19, 17, 1980, 1910, 1979, 14608, 676, 21, 4342, 712, 698, 9059, 15306, 1236, 9084, 15307, 9128, 15308, 11755, 12205, 14609, 4338, 2]
...
// Module 15305 (HappeningNowCardCreateChannel)
...
let closure_15 = importAllResult.memo((panelVariant) => {
  ...
  const items = [callback(closure_4, obj), callback(require(4338) /* Text */.Text, { variant: "text-sm/normal", maxFontSizeMultiplier: 2, children: text })];
  obj[4] = items;
  return callback2(importDefault(14609), obj);
});
