...
// Dependencies: [19, 17, 1980, 1910, 1979, 14538, 676, 21, 4303, 712, 698, 9002, 15235, 1236, 9027, 15236, 9071, 15237, 11683, 12127, 14539, 4299, 2]
...
// Module 15234 (HappeningNowCardCreateChannel)
...
let closure_15 = importAllResult.memo((panelVariant) => {
  ...
  obj[4] = items;
  return callback2(importDefault(14539), obj);
});
