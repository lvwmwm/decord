...
// Dependencies: [19, 17, 1980, 1910, 1979, 14595, 676, 21, 4344, 712, 698, 9041, 15292, 1236, 9066, 15293, 9110, 15294, 11740, 12184, 14596, 4340, 2]
...
// Module 15291 (HappeningNowCardCreateChannel)
...
let closure_15 = importAllResult.memo((panelVariant) => {
  ...
  const items = [callback(closure_4, obj), callback(require(4340) /* Text */.Text, { variant: "text-sm/normal", maxFontSizeMultiplier: 2, children: text })];
  obj[4] = items;
  return callback2(importDefault(14596), obj);
});
