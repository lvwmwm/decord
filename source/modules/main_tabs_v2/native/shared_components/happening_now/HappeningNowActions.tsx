...
// Dependencies: [19, 17, 1932, 1862, 1931, 14405, 676, 21, 4255, 712, 698, 8890, 15100, 1236, 8915, 15101, 8959, 15102, 11564, 12008, 14406, 4251, 2]
...
// Module 15099 (HappeningNowCardCreateChannel)
...
let closure_15 = importAllResult.memo((panelVariant) => {
  ...
  obj[4] = items;
  return callback2(importDefault(14406), obj);
});
