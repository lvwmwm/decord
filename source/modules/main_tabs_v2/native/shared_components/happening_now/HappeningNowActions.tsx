...
// Dependencies: [19, 17, 1980, 1910, 1979, 14640, 676, 21, 4661, 712, 698, 8849, 15355, 1236, 8874, 15356, 8918, 15357, 11475, 11948, 14641, 4734, 2]
...
let closure_15 = importAllResult.memo((panelVariant) => {
  ...
  const items = [callback(closure_4, obj), callback(require(4734) /* Text */.Text, { variant: "text-sm/normal", maxFontSizeMultiplier: 2, children: text })];
  obj[4] = items;
  return callback2(importDefault(14641), obj);
});
