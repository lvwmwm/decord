...
// Dependencies: [19, 1371, 4208, 3826, 21, 15062, 15074, 15075, 647, 15052, 2]
// Exports: default, useCallActivityData

// Module 15061 (HappeningNowCardUnifiedVC)
import "noop";
...
export default function HappeningNowCardUnifiedVC(arg0) {
  ...
  if (null != stream) {
    ...
    obj[4] = fullwidth;
    obj[5] = panelVariant;
    let tmp5 = jsx(importDefault(15062), { index: null, userId: null, guildId: null, stream: null, fullwidth: null, panelVariant: null });
    ...
    obj[6] = cardKey;
    obj[7] = panelVariant;
    tmp5 = jsx(importDefault(15074), { index: null, voiceState: null, fullwidth: null, guildId: null, activity: null, userId: null, cardKey: null, panelVariant: null });
  } else {
    ...
    obj1[3] = guildId;
    obj1[4] = panelVariant;
    tmp5 = jsx(importDefault(15075), { index: null, voiceState: null, fullwidth: null, guildId: null, panelVariant: null });
  }
  return tmp5;
};
