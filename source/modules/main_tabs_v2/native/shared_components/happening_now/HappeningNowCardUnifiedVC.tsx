...
// Dependencies: [31, 1347, 4184, 3802, 33, 15038, 15050, 15051, 624, 15028, 2]
// Exports: default

// Module 15037 (useCallActivityData)
import "result";
...
export default function HappeningNowCardUnifiedVC(arg0) {
  ...
  if (null != stream) {
    ...
    let tmp5 = jsx(importDefault(15038), { index, userId: stream.ownerId, guildId, stream, fullwidth, panelVariant });
  } else if (null != activity) {
    obj = { index, voiceState, fullwidth, guildId, activity, userId, cardKey, panelVariant };
    tmp5 = jsx(importDefault(15050), { index, voiceState, fullwidth, guildId, activity, userId, cardKey, panelVariant });
  } else {
    obj = { index, voiceState, fullwidth, guildId, panelVariant };
    tmp5 = jsx(importDefault(15051), { index, voiceState, fullwidth, guildId, panelVariant });
  }
  return tmp5;
};
