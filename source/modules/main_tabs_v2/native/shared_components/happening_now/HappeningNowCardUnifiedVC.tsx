...
// Dependencies: [19, 1390, 4364, 3998, 21, 15282, 15294, 15295, 647, 15272, 2]
// Exports: default, useCallActivityData

// Module 15281 (HappeningNowCardUnifiedVC)
import "noop";
...
export default function HappeningNowCardUnifiedVC(arg0) {
  ...
  if (null != stream) {
    ...
    obj[4] = fullwidth;
    obj[5] = panelVariant;
    let tmp5 = jsx(importDefault(15282), { index: null, userId: null, guildId: null, stream: null, fullwidth: null, panelVariant: null });
    ...
    obj[6] = cardKey;
    obj[7] = panelVariant;
    tmp5 = jsx(importDefault(15294), { index: null, voiceState: null, fullwidth: null, guildId: null, activity: null, userId: null, cardKey: null, panelVariant: null });
  } else {
    ...
    obj1[3] = guildId;
    obj1[4] = panelVariant;
    tmp5 = jsx(importDefault(15295), { index: null, voiceState: null, fullwidth: null, guildId: null, panelVariant: null });
  }
  return tmp5;
};
