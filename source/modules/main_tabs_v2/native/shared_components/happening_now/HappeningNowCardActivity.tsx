...
// Function ID: 15063
// Name: IconOrPreview
// Dependencies: [19, 17, 1377, 1874, 14307, 676, 505, 21, 15063, 15064, 4189, 712, 5515, 589, 5521, 698, 10875, 1959, 8356, 15058, 4379, 15065, 14308, 15059, 1297, 15068, 9075, 15069, 9070, 11987, 8506, 4711, 8931, 1236, 4033, 10846, 5141, 15060, 15071, 10849, 7914, 15073, 7977, 2]

// Module 15062 (IconOrPreview)
...
function IconOrPreview(arg0) {
  ...
  const previewUrl = importDefault(10849)(guildId, channelId, ownerId).previewUrl;
  let assetImage;
  if (null != previewUrl) {
...
function StageStreamAvatars(stage) {
  ...
  let audienceFriends;
  stage = stage.stage;
  let obj = require(15060) /* useLiveStageData */;
  ...
  obj[1] = callback(require(15071) /* HappeningNowAvatarStack */.HappeningNowAvatarStack, obj);
  return callback(closure_4, obj);
}
