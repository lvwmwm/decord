...
// Function ID: 15217
// Name: IconOrPreview
// Dependencies: [19, 17, 1396, 1922, 14538, 676, 505, 21, 15217, 15218, 4303, 712, 5728, 589, 5734, 698, 10977, 2007, 8789, 15212, 4493, 15219, 14539, 15213, 1297, 15222, 9659, 15223, 9654, 12280, 9311, 4825, 8768, 1236, 4152, 10945, 5268, 15214, 15225, 10948, 8245, 15227, 8309, 2]

// Module 15216 (IconOrPreview)
...
function IconOrPreview(arg0) {
  ...
  const previewUrl = importDefault(10948)(guildId, channelId, ownerId).previewUrl;
  let assetImage;
  if (null != previewUrl) {
...
function StageStreamAvatars(stage) {
  ...
  let audienceFriends;
  stage = stage.stage;
  let obj = require(15214) /* useLiveStageData */;
  ...
  obj[1] = callback(require(15225) /* HappeningNowAvatarStack */.HappeningNowAvatarStack, obj);
  return callback(closure_4, obj);
}
