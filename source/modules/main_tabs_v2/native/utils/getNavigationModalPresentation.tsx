...
// Dependencies: [500, 7643, 4283, 8901, 2]
// Exports: default

// Module 9683 (getNavigationModalPresentation)
import set from "set";
import set from "set";
...
export default function getNavigationModalPresentation() {
  ...
  let tmp4;
  if (lockOrientation) {
    const orientationLock = require(8901) /* handleOrientationChange */.getOrientationLock();
    let str2 = "landscape";
    let str4 = "landscape";
