...
// Dependencies: [500, 7581, 4282, 8835, 2]
// Exports: default

// Module 9613 (getNavigationModalPresentation)
import set from "set";
import set from "set";
...
export default function getNavigationModalPresentation() {
  ...
  let tmp4;
  if (lockOrientation) {
    const orientationLock = require(8835) /* handleOrientationChange */.getOrientationLock();
    let str2 = "landscape";
    let str4 = "landscape";
    ...
    tmp4 = str4;
    const obj2 = require(8835) /* handleOrientationChange */;
  }
  obj[1] = tmp4;
  return obj;
};
