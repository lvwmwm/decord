...
let closure_6 = arg1(dependencyMap[3]).createStyles({ container: { -656831359: 131420590, 1390021337: -1717986767, -742727557: -644245095, alignItems: 94527 } });
...
const memoResult = importAllResult.memo(function ThemedHeaderBackgroundGradient(baseColor) {
  ...
  obj1 = { style: absoluteFill.absoluteFill, colors: items1, start: { 0: "%FunctionPrototype%", 0: "paddingStart" }, end: {} };
