...
// Dependencies: [32, 19, 1372, 1960, 4101, 676, 1379, 4136, 4135, 4138, 2]
// Exports: default, isActiveTabsGuilds

// Module 15054 (getActiveTabsRoute)
  ...
  if (null != coerceTabsRouteResult) {
    ...
    if (null != tmp3) {
      ...
      if (null != screen) {
        ...
        obj = require(4136) /* getRootNavigationRef */;
...
function resolveBackgroundScreen(index) {
  ...
  if (null == coerceTabsRouteResult) {
    ...
    if (null == tmp11) {
      ...
      const coerceGuildsRouteResult = require(4135) /* navigationToRootTabHelper */.coerceGuildsRoute(tmp11);
...
export const isActiveTabsGuilds = function isActiveTabsGuilds(state) {
  const coerceTabsRouteResult = require(4135) /* navigationToRootTabHelper */.coerceTabsRoute(state.routes[0]);
  if (null == coerceTabsRouteResult) {
    return false;
  } else {
