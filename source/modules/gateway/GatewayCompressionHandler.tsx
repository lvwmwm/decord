...
// Function ID: 12918
// Name: items
// Dependencies: [17, 12918, 12920, 3, 500, 12919, 4863, 2]
...
const fn = (arg0) => {
  ...
  tmp._stream = require(12918) /* supportsZstd */.createZstdContextWeb();
  return tmp;
};
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = require(12920);
...
fn4["canUse"] = function canUse() {
  if (obj.isAndroid()) {
    let tmp5 = null != require(12919) /* enforcing */.default;
  } else {
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  const obj = require(12918) /* supportsZstd */;
  const supportsZstdResult = require(12918) /* supportsZstd */.supportsZstd();
