...
// Function ID: 13542
// Name: items
// Dependencies: [17, 13542, 13544, 3, 1234, 13543, 5094, 2]
...
import supportsZstd from "supportsZstd" /* 13542 */;
import enforcing from "enforcing" /* 13543 */;
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = _mod13544;
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(13543).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(13543).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(13543).default;
      if (_default != null) {
