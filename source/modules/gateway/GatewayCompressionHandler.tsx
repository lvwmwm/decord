...
// Function ID: 13002
// Name: items
// Dependencies: [17, 13002, 13004, 3, 500, 13003, 4926, 2]
...
const fn = (arg0) => {
  ...
  tmp._stream = require(13002) /* supportsZstd */.createZstdContextWeb();
  return tmp;
};
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = require(13004);
...
fn4["canUse"] = function canUse() {
  if (obj.isAndroid()) {
    let tmp5 = null != require(13003) /* enforcing */.default;
  } else {
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  const obj = require(13002) /* supportsZstd */;
  const supportsZstdResult = require(13002) /* supportsZstd */.supportsZstd();
  const isAndroidResult = require(500) /* set */.isAndroid();
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(13003).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(13003).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(13003).default;
      if (_default != null) {
...
let result = require("module_13004").fileFinishedImporting("modules/gateway/GatewayCompressionHandler.tsx");
