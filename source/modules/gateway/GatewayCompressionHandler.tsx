...
// Function ID: 12703
// Name: items
// Dependencies: [17, 12703, 12705, 3, 500, 12704, 4734, 2]
...
const fn = (arg0) => {
  ...
  tmp._stream = require(12703) /* supportsZstd */.createZstdContextWeb();
  return tmp;
};
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = require(12705);
...
fn4["canUse"] = function canUse() {
  if (obj.isAndroid()) {
    let tmp5 = null != require(12704) /* enforcing */.default;
  } else {
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  const obj = require(12703) /* supportsZstd */;
  const supportsZstdResult = require(12703) /* supportsZstd */.supportsZstd();
  const isAndroidResult = require(500) /* set */.isAndroid();
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(12704).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(12704).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(12704).default;
      if (_default != null) {
...
let result = require("module_12705").fileFinishedImporting("modules/gateway/GatewayCompressionHandler.tsx");
