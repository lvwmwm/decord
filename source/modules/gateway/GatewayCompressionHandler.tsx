...
// Function ID: 12796
// Name: items
// Dependencies: [17, 12796, 12798, 3, 500, 12797, 4814, 2]
...
const fn = (arg0) => {
  ...
  tmp._stream = require(12796) /* supportsZstd */.createZstdContextWeb();
  return tmp;
};
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = require(12798);
...
fn4["canUse"] = function canUse() {
  if (obj.isAndroid()) {
    let tmp5 = null != require(12797) /* enforcing */.default;
  } else {
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  const obj = require(12796) /* supportsZstd */;
  const supportsZstdResult = require(12796) /* supportsZstd */.supportsZstd();
  const isAndroidResult = require(500) /* set */.isAndroid();
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(12797).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(12797).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(12797).default;
      if (_default != null) {
...
let result = require("module_12798").fileFinishedImporting("modules/gateway/GatewayCompressionHandler.tsx");
