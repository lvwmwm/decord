...
// Function ID: 13271
// Name: items
// Dependencies: [17, 13271, 13273, 3, 500, 13272, 5053, 2]
...
import supportsZstd from "supportsZstd" /* 13271 */;
import enforcing from "enforcing" /* 13272 */;
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = _mod13273;
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(13272).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(13272).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(13272).default;
      if (_default != null) {
