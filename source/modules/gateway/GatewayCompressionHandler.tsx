...
// Function ID: 13237
// Name: items
// Dependencies: [17, 13237, 13239, 3, 500, 13238, 5050, 2]
...
import supportsZstd from "supportsZstd" /* 13237 */;
import enforcing from "enforcing" /* 13238 */;
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = _mod13239;
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(13238).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(13238).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(13238).default;
      if (_default != null) {
