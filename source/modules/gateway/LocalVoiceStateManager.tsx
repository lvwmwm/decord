...
// Function ID: 13010
// Name: guildId
// Dependencies: [4365, 4364, 1391, 4393, 4437, 676, 13007, 4034, 1403, 4403, 2]

// Module 13009 (guildId)
...
prototype["computeVoiceFlags"] = function computeVoiceFlags() {
  ...
  let isClipsEnabledResult = require(4403) /* isClipsEnabled */.isClipsEnabled();
