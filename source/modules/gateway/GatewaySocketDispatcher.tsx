...
// Function ID: 13533
// Name: set
// Dependencies: [32, 13533, 3, 13534, 13537, 4558, 13538, 13536, 13539, 586, 13540, 2]

// Module 13532 (set)
import timestampDefault from "timestamp" /* 3 */;
import sleep from "sleep" /* 4558 */;
import prettyPrintTrace_ from "prettyPrintTrace_" /* 13537 */;
import isVoiceServerUpdateImmediateEnabled from "isVoiceServerUpdateImmediateEnabled" /* 13538 */;
import CLOSEDDefault from "CLOSED" /* 13539 */;
import closure_3 from "_slicedToArray" /* 32 */;
import { DISPATCHER_IDEAL_TIME_LIMIT_MS as closure_4 } from "DISPATCHER_STANDARD_TIMEOUT_MS" /* 13533 */;
...
prototype["dispatchMultiple"] = function dispatchMultiple(items, arg1) {
  ...
  if (0 === items.length) {
    ...
    telemetry2.measure(_require(13536).WorkSchedulerTelemetryMeasurement.COUNT_INITIAL_DISPATCHS_LENGTH, items.length);
    try {
      closure_5 = [];
      ...
      if (closure_5.length > 0) {
        ...
        telemetry.measure(tmp21(13536).WorkSchedulerTelemetryMeasurement.COUNT_DISPATCHES_LEFT_AFTER_YIELD, closure_5.length);
        const queue = self.queue;
