...
// Dependencies: [5, 1340, 1218, 5036, 1391, 4393, 4416, 4437, 1979, 5037, 4430, 676, 685, 12966, 13010, 3, 595, 5996, 5170, 500, 13002, 12, 4408, 12981, 589, 709, 2]
...
function handleClipsFlags() {
  const localVoiceState = require(12966) /* handleIdentify */.localVoiceState;
...
function handleLocalPresenceChange() {
  const localPresenceState = require(12966) /* handleIdentify */.localPresenceState;
...
prototype["getSocket"] = function getSocket() {
  return require(12966) /* handleIdentify */.socket;
};
prototype["isTryingToConnect"] = function isTryingToConnect() {
  const socket = require(12966) /* handleIdentify */.socket;
...
const gatewayConnectionStore = new GatewayConnectionStore(require("dispatcher"), {
  START_SESSION: function handleSessionStart() {
    ...
    if (socket.isClosed()) {
      ...
      const socket2 = require(12966) /* handleIdentify */.socket;
  ...
  CLEAR_CACHES: function handleClearCaches(resetSocket) {
    if (resetSocket.resetSocket) {
      const socket = require(12966) /* handleIdentify */.socket;
      socket.close();
      const dispatcher = require(12966) /* handleIdentify */.socket.dispatcher;
      dispatcher.clear();
      const socket2 = require(12966) /* handleIdentify */.socket;
      socket2.connect();
    }
  ...
  GUILD_DELETE: function handleGuildDelete(guild) {
    if (guild.guild.id === require(12966) /* handleIdentify */.localVoiceState.guildId) {
      const localVoiceState = require(12966) /* handleIdentify */.localVoiceState;
      localVoiceState.setState({ guildId: null, channelId: null });
    }
  },
  CHANNEL_DELETE: function handleChannelDelete(channel) {
    if (channel.channel.id === require(12966) /* handleIdentify */.localVoiceState.channelId) {
      const localVoiceState = require(12966) /* handleIdentify */.localVoiceState;
      localVoiceState.setState({ guildId: null, channelId: null });
    }
  },
  CALL_DELETE: function handleCallDelete(channelId) {
    ...
    if (channelId === require(12966) /* handleIdentify */.localVoiceState.channelId) {
      if (c24 === channelId) {
        return false;
      } else {
        const localVoiceState = require(12966) /* handleIdentify */.localVoiceState;
  ...
  GUILD_MEMBERS_REQUEST: function handleGuildMembersRequest(userIds) {
    ...
    let socket = _require(12966).socket;
    if (socket.isSessionEstablished()) {
      if ("userIds" in userIds) {
        ...
        const socket2 = _require(12966).socket;
  ...
  CALL_CONNECT_MULTIPLE: function handleCallConnectMultiple(channelIds) {
    ...
    let socket = require(12966) /* handleIdentify */.socket;
    if (socket.isSessionEstablished()) {
  ...
  STREAM_WATCH: function handleStreamWatch(arg0) {
    ...
    if (socket.isSessionEstablished()) {
      ...
      let socket2 = _require(12966).socket;
  ...
  RESET_SOCKET: function handleResetSocket(args) {
    if (require(12966) /* handleIdentify */.socket.connectionState !== importDefault(12981).WILL_RECONNECT) {
      const socket = require(12966) /* handleIdentify */.socket;
