...
// Dependencies: [19, 676, 1398, 9844, 21, 4342, 712, 1222, 11811, 1236, 13258, 2]
// Exports: default

// Module 15412 (GuildHomeChannelRow)
...
export default function GuildHomeChannelRow(selected) {
  ...
  return jsx(importDefault(11811), { mode: DEFAULT, IconComponent: null });
};
