...
// Dependencies: [19, 17, 13383, 1910, 15750, 676, 21, 4342, 712, 4083, 1493, 4278, 13384, 500, 1435, 8487, 4343, 4346, 589, 7686, 10970, 1363, 15751, 15752, 5819, 4338, 1297, 4887, 4062, 1236, 15753, 2]

// Module 15749 (GuildFeedBanner)
...
function GuildFeedBanner(guild) {
  ...
  const tmp12 = sharedValue(7686)();
  dependencyMap = tmp12;
  const size = tmp6(1493)();
  width = size.width;
  height = size.height;
  const tmp8 = sharedValue(4278)();
  drawerWidth = guild(10970).useDrawerWidth();
  ...
  if (null != memo) {
    ...
    if (tmp2Result2.isThemeDark(tmp8)) {
      let tmp6Result = tmp6(15751);
    } else {
      tmp6Result = tmp6(15752);
    }
    obj2[1] = tmp6Result;
    obj2[2] = handleLoad;
  ...
  tmp6Result = tmp6(5819);
  obj7[2] = guild(5819).GuildIconSizes.XLARGE;
  obj6[1] = closure_11(tmp6Result, obj7);
  const items10 = [closure_11(height, obj6), , , ];
  const obj8 = { style: tmp.textContainer, children: null };
  const items11 = [closure_11(guild(4338).Text, { lineClamp: 1, variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", style: tmp.title, children: guild.name }), ];
  ...
  if (null != description) {
    ...
    obj11[3] = description;
    tmp17Result = tmp17(tmp2(4338).Text, obj11);
  }
  ...
  if (tmp15Result1) {
    ...
    if (features.has(GuildFeatures.DISCOVERABLE)) {
      ...
      items12[1] = tmp17(tmp2(4338).Text, obj15);
      obj13[3] = items12;
      tmp15Result = tmp15(tmp2(4887).PressableOpacity, obj13);
    }
    ...
    if (null != discoverableGuild.presenceCount) {
      ...
      if (null != discoverableGuild.memberCount) {
        ...
        items14[1] = tmp17(tmp2(4338).Text, obj18);
        obj16[0] = items14;
