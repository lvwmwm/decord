...
// Dependencies: [19, 17, 13382, 1910, 15741, 676, 21, 4344, 712, 4083, 1493, 4280, 13383, 500, 1435, 8483, 4345, 4348, 589, 7682, 11055, 1363, 15742, 15743, 5818, 4340, 1297, 4886, 4062, 1236, 15744, 2]
...
function GuildFeedBanner(guild) {
  ...
  const tmp12 = sharedValue(7682)();
  dependencyMap = tmp12;
  const size = tmp6(1493)();
  width = size.width;
  height = size.height;
  const tmp8 = sharedValue(4280)();
  drawerWidth = guild(11055).useDrawerWidth();
  ...
  tmp6Result = tmp6(5818);
  obj7[2] = guild(5818).GuildIconSizes.XLARGE;
  obj6[1] = closure_11(tmp6Result, obj7);
  const items10 = [closure_11(height, obj6), , , ];
  const obj8 = { style: tmp.textContainer, children: null };
  const items11 = [closure_11(guild(4340).Text, { lineClamp: 1, variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", style: tmp.title, children: guild.name }), ];
  ...
  if (null != description) {
    ...
    obj11[3] = description;
    tmp17Result = tmp17(tmp2(4340).Text, obj11);
  }
  ...
  if (tmp15Result1) {
    ...
    if (features.has(GuildFeatures.DISCOVERABLE)) {
      ...
      items12[1] = tmp17(tmp2(4340).Text, obj15);
      obj13[3] = items12;
      tmp15Result = tmp15(tmp2(4886).PressableOpacity, obj13);
    }
    ...
    if (null != discoverableGuild.presenceCount) {
      ...
      if (null != discoverableGuild.memberCount) {
        ...
        items14[1] = tmp17(tmp2(4340).Text, obj18);
        obj16[0] = items14;
