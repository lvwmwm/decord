...
// Dependencies: [19, 17, 13189, 1862, 15512, 676, 21, 4255, 712, 4116, 1474, 4191, 13190, 500, 1416, 9349, 4256, 4259, 589, 7550, 11026, 4101, 15513, 15514, 5632, 4251, 1297, 4783, 3956, 1236, 15515, 2]

// Module 15511 (GuildFeedBanner)
...
function GuildFeedBanner(guild) {
  ...
  const tmp12 = sharedValue(7550)();
  dependencyMap = tmp12;
  const size = tmp6(1474)();
  width = size.width;
  height = size.height;
  const tmp8 = sharedValue(4191)();
  drawerWidth = guild(11026).useDrawerWidth();
  ...
  if (null != memo) {
    ...
    if (tmp2Result2.isThemeDark(tmp8)) {
      let tmp6Result = tmp6(15513);
    } else {
      tmp6Result = tmp6(15514);
    }
    obj2[1] = tmp6Result;
    obj2[2] = handleLoad;
  ...
  tmp6Result = tmp6(5632);
  obj7[2] = guild(5632).GuildIconSizes.XLARGE;
  ...
  if (tmp15Result1) {
    ...
    if (features.has(GuildFeatures.DISCOVERABLE)) {
      ...
      obj13[3] = items12;
      tmp15Result = tmp15(tmp2(4783).PressableOpacity, obj13);
    }
