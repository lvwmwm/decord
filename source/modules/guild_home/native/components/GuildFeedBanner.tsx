...
// Dependencies: [19, 17, 13396, 1910, 15759, 676, 21, 4342, 712, 4083, 1493, 4278, 13397, 500, 1435, 8509, 4343, 4346, 589, 7707, 10987, 1363, 15760, 15761, 5840, 4338, 1297, 4909, 4062, 1236, 15762, 2]

// Module 15758 (GuildFeedBanner)
...
function GuildFeedBanner(guild) {
  ...
  const tmp12 = sharedValue(7707)();
  dependencyMap = tmp12;
  const size = tmp6(1493)();
  width = size.width;
  height = size.height;
  const tmp8 = sharedValue(4278)();
  drawerWidth = guild(10987).useDrawerWidth();
  ...
  if (null != memo) {
    ...
    if (tmp2Result2.isThemeDark(tmp8)) {
      let tmp6Result = tmp6(15760);
    } else {
      tmp6Result = tmp6(15761);
    }
    obj2[1] = tmp6Result;
    obj2[2] = handleLoad;
  ...
  tmp6Result = tmp6(5840);
  obj7[2] = guild(5840).GuildIconSizes.XLARGE;
  ...
  if (tmp15Result1) {
    ...
    if (features.has(GuildFeatures.DISCOVERABLE)) {
      ...
      obj13[3] = items12;
      tmp15Result = tmp15(tmp2(4909).PressableOpacity, obj13);
    }
