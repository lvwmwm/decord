...
function GuildFeedBanner(guild) {
  ...
  drawerWidth = guild(10911).useDrawerWidth();
  ...
  tmp6Result = tmp6(5661);
  obj7[2] = guild(5661).GuildIconSizes.XLARGE;
  ...
  if (tmp15Result1) {
    ...
    if (features.has(GuildFeatures.DISCOVERABLE)) {
      ...
      obj13[3] = items12;
      tmp15Result = tmp15(tmp2(4812).PressableOpacity, obj13);
    }
