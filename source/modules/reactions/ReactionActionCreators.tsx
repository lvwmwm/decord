...
// Dependencies: [5, 1218, 1391, 4561, 676, 687, 4682, 1236, 1231, 709, 7262, 530, 7264, 698, 4538, 1363, 7282, 4006, 2]
// Exports: getReactors, playBurstReaction

// Module 7263 (checkReactionResponse)
import set from "set";
...
function optimisticDispatch(type, channelId, messageId, arg3, userId) {
  ...
  obj[6] = colors;
  const ReactionTypes = require(7262) /* ReactionTypes */.ReactionTypes;
...
function makeURL(type) {
  ...
  if (NORMAL === undefined) {
    NORMAL = require(7262) /* ReactionTypes */.ReactionTypes.NORMAL;
  }
  if (null != emoji.id) {
