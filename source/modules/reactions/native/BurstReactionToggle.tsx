...
// Dependencies: [19, 17, 4295, 1388, 21, 4042, 589, 4024, 712, 4304, 4713, 4303, 8658, 1236, 7703, 2]
// Exports: default

// Module 8657 (BurstReactionToggle)
...
obj[1] = Easing.out(require("module_4042").Easing.quad);
