...
// Dependencies: [19, 17, 4440, 1384, 21, 4187, 589, 4167, 712, 4449, 4895, 4448, 9075, 1236, 8198, 2]
// Exports: default

// Module 9074 (BurstReactionToggle)
...
obj[1] = Easing.out(require("module_4187").Easing.quad);
