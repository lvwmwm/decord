...
// Dependencies: [5, 1218, 16332, 676, 530, 12938, 709, 16336, 8482, 8489, 12939, 2]
...
// Module 16335 (_guildRoomConnect)
...
export const guildRoomDisconnect = function guildRoomDisconnect(guildId, channelId) {
  ...
  if (channelId !== guildId) {
    ...
    obj[0] = guildId;
    obj[1] = channelId;
    const result = require(16336) /* trackGuildRoomObjectInteracted */.trackGuildRoomUserDisconnected(obj);
    const obj3 = require(16336) /* trackGuildRoomObjectInteracted */;
  }
};
