...
// Dependencies: [5, 1218, 16292, 676, 530, 12901, 709, 16296, 8342, 8349, 12902, 2]
...
// Module 16295 (_guildRoomConnect)
...
export const guildRoomDisconnect = function guildRoomDisconnect(guildId, channelId) {
  ...
  if (channelId !== guildId) {
    ...
    obj[0] = guildId;
    obj[1] = channelId;
    const result = require(16296) /* trackGuildRoomObjectInteracted */.trackGuildRoomUserDisconnected(obj);
    const obj3 = require(16296) /* trackGuildRoomObjectInteracted */;
  }
};
