...
// Dependencies: [5, 1218, 16519, 676, 530, 13088, 709, 16523, 8608, 8615, 13094, 2]
...
// Module 16522 (_guildRoomConnect)
...
export const guildRoomDisconnect = function guildRoomDisconnect(guildId, channelId) {
  ...
  if (channelId !== guildId) {
    ...
    obj[0] = guildId;
    obj[1] = channelId;
    const result = require(16523) /* getBaseProperties */.trackGuildRoomUserDisconnected(obj);
    const obj3 = require(16523) /* getBaseProperties */;
  }
};
