...
// Dependencies: [1218, 1372, 16435, 5261, 16436, 16437, 2]

// Module 16434 (isExperimentEnabled)
  ...
  while (iter !== undefined) {
    ...
    if (userId === id.getId()) {
      ...
      if (sessionId === obj.getSessionId()) {
        ...
        if (channelId !== channelId) {
          ...
          if (isExperimentEnabledResult) {
            ...
            let obj3 = require(16437) /* _guildRoomConnect */;
            let tmp18 = guildId;
            let tmp19 = channelId;
          ...
          if (null != channelId) {
            ...
            if (null != guildId) {
              ...
              if (self.isExperimentEnabled(guildId, "VOICE_STATE_UPDATE")) {
                ...
                let obj4 = require(16437) /* _guildRoomConnect */;
                let tmp28 = guildId;
                let tmp29 = channelId;
      ...
      if (tmp4) {
        ...
        let obj2 = require(16437) /* _guildRoomConnect */;
        let tmp9 = userId;
...
prototype["handleEmbeddedActivityLaunchSuccess"] = function handleEmbeddedActivityLaunchSuccess(channelId) {
  if (null != channelId.channelId) {
    ...
    if (isExperimentEnabledResult) {
      const result = require(16437) /* _guildRoomConnect */.guildRoomToggleLayout(channelId.channelId, true);
      const obj = require(16437) /* _guildRoomConnect */;
    }
  }
};
