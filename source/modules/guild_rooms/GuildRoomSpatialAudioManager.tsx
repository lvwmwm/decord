...
// Function ID: 16343
// Name: _initialize
// Dependencies: [32, 4199, 1212, 1218, 1372, 4332, 4356, 16332, 5244, 9078, 16333, 16343, 2]

// Module 16342 (_initialize)
    ...
    if (null != channelId) {
      ...
      if (this.isLivingRoomAvailable()) {
        ...
        if (!isGuildStageVoiceResult) {
          ...
          obj[1] = id.getId();
          obj[2] = channelId;
          _require = _require(16343).computeLivingRoomWorldPoints(obj);
