...
// Dependencies: [12953, 2]
// Exports: serverGuildRoomToClient

// Module 12952 (serverGuildRoomObjectToClient)
function serverGuildRoomObjectToClient(object_type) {
  if (object_type.object_type === require(12953) /* GuildRoomObjectTypes */.GuildRoomObjectTypes.PLANT) {
    let obj = { objectType: null };
    obj[0] = tmp(12953).GuildRoomObjectTypes.PLANT;
    ...
    obj = { objectType: null };
    obj[0] = tmp(12953).GuildRoomObjectTypes.NOTE;
