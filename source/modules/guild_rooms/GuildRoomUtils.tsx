...
// Dependencies: [12809, 2]
// Exports: serverGuildRoomToClient

// Module 12808 (serverGuildRoomObjectToClient)
function serverGuildRoomObjectToClient(object_type) {
  if (object_type.object_type === require(12809) /* GuildRoomObjectTypes */.GuildRoomObjectTypes.PLANT) {
    let obj = { objectType: null };
    obj[0] = tmp(12809).GuildRoomObjectTypes.PLANT;
    ...
    obj = { objectType: null };
    obj[0] = tmp(12809).GuildRoomObjectTypes.NOTE;
