...
// Dependencies: [1218, 1372, 4375, 4319, 16444, 16449, 676, 16450, 4498, 2]
...
// Module 16448 (getBaseProperties)
...
function getBaseProperties(merged) {
  ...
  if (background == null) {
    background = require(16450) /* GuildRoomBackgrounds */.GuildRoomBackgrounds.DEFAULT;
  }
  obj[5] = background;
  return obj;
}
