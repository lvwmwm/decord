...
// Dependencies: [1218, 1391, 4416, 4361, 16519, 676, 13088, 13090, 4539, 2]
...
// Module 16523 (getBaseProperties)
...
function getBaseProperties(merged) {
  ...
  if (background == null) {
    background = require(13090) /* GuildRoomBackgrounds */.GuildRoomBackgrounds.DEFAULT;
  }
  obj[5] = background;
  return obj;
}
