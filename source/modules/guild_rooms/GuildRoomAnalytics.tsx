...
// Dependencies: [1218, 1391, 4375, 4319, 16460, 676, 13028, 13030, 4498, 2]
...
// Module 16464 (getBaseProperties)
...
function getBaseProperties(merged) {
  ...
  if (background == null) {
    background = require(13030) /* GuildRoomBackgrounds */.GuildRoomBackgrounds.DEFAULT;
  }
  obj[5] = background;
  return obj;
}
