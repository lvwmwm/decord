...
// Dependencies: [109, 1218, 4373, 1960, 589, 12953, 709, 2]

// Module 16358 (handleSelectedChannelStoreChange)
...
prototype["getNotes"] = function getNotes(closure_1) {
  ...
  let value = roomObjects.get(require(12953) /* GuildRoomObjectTypes */.GuildRoomObjectTypes.NOTE);
  if (value == null) {
    value = closure_11;
  }
  return value;
