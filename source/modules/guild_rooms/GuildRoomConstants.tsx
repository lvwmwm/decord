...
items[15] = obj15;
const obj16 = { position: arg1(dependencyMap[2]).GUILD_ROOM_BACKGROUND_POSITIONS[arg1(undefined, dependencyMap[0]).GuildRoomBackgrounds.DEFAULT][16] };
items[16] = obj16;
const obj17 = { error: "MUR", height: "USER_REQUIRED_ACTION_UPDATE", width: "CONNECTION_OPEN_SUPPLEMENTAL", position: arg1(dependencyMap[2]).GUILD_ROOM_BACKGROUND_POSITIONS[arg1(undefined, dependencyMap[0]).GuildRoomBackgrounds.DEFAULT][17] };
items[17] = obj17;
...
export const DEFAULT_BACKGROUND_POSITION = { borderRadius: "r", width: "onRequireModeratorMFAClick", height: "Array", bottom: "isSpamMessageRequest" };
