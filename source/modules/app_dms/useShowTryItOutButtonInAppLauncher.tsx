...
// Dependencies: [10622, 11536, 10600, 2]
// Exports: default

// Module 11535 (useShowTryItOutButtonInAppLauncher)
...
export default function useShowTryItOutButtonInAppLauncher(arg0) {
  ...
  let obj = require(10622) /* _getPrimaryAppCommand */;
  ...
  const tmp = require;
  const tmp4 = importDefault(11536);
  const tmp4Result = importDefault(11536)(channel);
