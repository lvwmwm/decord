...
// Dependencies: [10589, 11589, 10567, 2]
// Exports: default

// Module 11588 (useShowTryItOutButtonInAppLauncher)
...
export default function useShowTryItOutButtonInAppLauncher(arg0) {
  ...
  let obj = require(10589) /* _getPrimaryAppCommand */;
  ...
  const tmp = require;
  const tmp4 = importDefault(11589);
  const tmp4Result = importDefault(11589)(channel);
  const canLaunchFrameResult = tmp(10567).canLaunchFrame(application);
