...
// Dependencies: [10857, 11417, 10481, 2]
// Exports: default

// Module 11416 (useShowTryItOutButtonInAppLauncher)
...
export default function useShowTryItOutButtonInAppLauncher(arg0) {
  ...
  let obj = require(10857) /* _getPrimaryAppCommand */;
  ...
  const tmp = require;
  const tmp4 = importDefault(11417);
  const tmp4Result = importDefault(11417)(channel);
  const canLaunchFrameResult = tmp(10481).canLaunchFrame(application);
