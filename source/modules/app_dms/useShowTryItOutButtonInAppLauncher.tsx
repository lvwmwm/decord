...
// Dependencies: [10591, 11590, 10569, 2]
// Exports: default

// Module 11589 (useShowTryItOutButtonInAppLauncher)
...
export default function useShowTryItOutButtonInAppLauncher(arg0) {
  ...
  let obj = require(10591) /* _getPrimaryAppCommand */;
  ...
  const tmp = require;
  const tmp4 = importDefault(11590);
  const tmp4Result = importDefault(11590)(channel);
  const canLaunchFrameResult = tmp(10569).canLaunchFrame(application);
