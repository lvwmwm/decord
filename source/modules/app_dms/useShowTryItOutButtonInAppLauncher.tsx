...
// Dependencies: [10675, 11593, 10653, 2]
// Exports: default

// Module 11592 (useShowTryItOutButtonInAppLauncher)
...
export default function useShowTryItOutButtonInAppLauncher(arg0) {
  ...
  let obj = require(10675) /* _getPrimaryAppCommand */;
  ...
  const tmp = require;
  const tmp4 = importDefault(11593);
  const tmp4Result = importDefault(11593)(channel);
  const canLaunchFrameResult = tmp(10653).canLaunchFrame(application);
