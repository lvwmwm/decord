...
// Dependencies: [11295, 11322, 10505, 2]
// Exports: default

// Module 11321 (useShowTryItOutButtonInAppLauncher)
...
export default function useShowTryItOutButtonInAppLauncher(arg0) {
  ...
  let obj = require(11295) /* _getPrimaryAppCommand */;
  ...
  const tmp = require;
  const tmp4 = importDefault(11322);
  const tmp4Result = importDefault(11322)(channel);
  const canLaunchFrameResult = tmp(10505).canLaunchFrame(application);
