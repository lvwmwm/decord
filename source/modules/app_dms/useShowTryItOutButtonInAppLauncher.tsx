...
// Dependencies: [10550, 11466, 10528, 2]
// Exports: default

// Module 11465 (useShowTryItOutButtonInAppLauncher)
...
export default function useShowTryItOutButtonInAppLauncher(arg0) {
  ...
  let obj = require(10550) /* _getPrimaryAppCommand */;
  ...
  const tmp = require;
  const tmp4 = importDefault(11466);
  const tmp4Result = importDefault(11466)(channel);
  const canLaunchFrameResult = tmp(10528).canLaunchFrame(application);
