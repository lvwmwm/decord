...
// Dependencies: [32, 5, 12213, 7233, 7234, 684, 3, 5495, 17182, 7511, 1234, 1955, 1956, 1972, 2]

// Module 17181 (handleAppStateUpdate)
import timestampDefault from "timestamp" /* 3 */;
import setDefault from "set" /* 684 */;
import initializeDefault from "initialize" /* 5495 */;
import reportMalformedStorageValuesDefault from "reportMalformedStorageValues" /* 17182 */;
...
import closure_8 from "handleSelectedChannelStoreChanged" /* 7233 */;
import closure_9 from "result" /* 7234 */;
      ...
      try {
        ...
        if (0 === c4) {
          if (arg0 === 1) {
            ...
            if (closure_1_0.hasConnected) {
              if (!closure_1_0.isCleaning) {
                ...
                c5 = 1;
                obj1 = { value: null, done: false };
                obj1[0] = closure_1_1(7511).startBackgroundTask();
                return obj1;
              }
            }
            c5 = 3;
          ...
          if (arg0 === 1) {
            ...
            dependencyMap = arg1;
            if (obj10.isIOS()) {
              if (dependencyMap === closure_1_1(7511).backgroundTaskIdentifierInvalid) {
                c5 = 3;
                return { value: "HermesInternal", done: null };
              }
            }
