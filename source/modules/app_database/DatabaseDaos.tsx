...
class DatabaseDaos extends Store {
  constructor() {
    ...
    f70571 = (database) => {
      const guildEntityDao = new f70571(1908).GuildEntityDao("guild_channels", f70571(1908).TableId.KvCache, database);
    ...
    applyArgumentsResult.channels = (arg0) => {
      ...
      if (null != databaseResult) {
        tmp5 = f70571(databaseResult);
      }
      return tmp5;
    };
    f70571 = (database) => {
      const guildDao = new f70571(1908).GuildDao("guild_channels_temp", f70571(1908).TableId.KvCache, database);
      return guildDao;
    };
    ...
    f70571 = (database) => {
      const dao = new f70571(1908).Dao("basic_channels", f70571(1908).TableId.KvCache, database);
      return dao;
    };
    ...
    f70571 = (database) => {
      const dao = new f70571(1908).Dao("basic_channels_synced", f70571(1908).TableId.KvCache, database);
      return dao;
    };
    ...
    f70571 = (database) => {
      const dao = new f70571(1908).Dao("cache", f70571(1908).TableId.KvCache, database);
      return dao;
    };
    ...
    f70571 = (database) => {
      const dao = new f70571(1908).Dao("force_resync_version", f70571(1908).TableId.KvCache, database);
      return dao;
    };
    ...
    f70571 = (database) => {
      const guildEntityDao = new f70571(1908).GuildEntityDao("guild_emojis", f70571(1908).TableId.KvCache, database);
      return guildEntityDao;
    };
    ...
    f70571 = (database) => {
      const entityDao = new f70571(1908).EntityDao("guilds", f70571(1908).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f70571 = (database) => {
      const entityDao = new f70571(1908).EntityDao("guilds_requiring_deleted_ids_sync", f70571(1908).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f70571 = (database) => {
      const entityDao = new f70571(1908).EntityDao("guilds_requiring_channel_sync", f70571(1908).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f70571 = (database) => {
      const messageDao = new f70571(1908).MessageDao("messages", f70571(1908).TableId.Messages, database);
      return messageDao;
    };
    ...
    f70571 = (database) => {
      const guildEntityDao = new f70571(1908).GuildEntityDao("guild_stickers", f70571(1908).TableId.KvCache, database);
      return guildEntityDao;
    };
    ...
    f70571 = (database) => {
      const entityDao = new f70571(1908).EntityDao("guild_versions", f70571(1908).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f70571 = (database) => {
      const entityDao = new f70571(1908).EntityDao("non_guild_versions", f70571(1908).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f70571 = (database) => {
      const entityDao = new f70571(1908).EntityDao("user_settings", f70571(1908).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f70571 = (database) => {
      const dao = new f70571(1908).Dao("read_states", f70571(1908).TableId.KvCache, database);
      return dao;
    };
    ...
    f70571 = (database) => {
      const dao = new f70571(1908).Dao("user_guild_settings", f70571(1908).TableId.KvCache, database);
      return dao;
    };
    ...
    f70571 = (database) => {
      const entityDao = new f70571(1908).EntityDao("user_search_items", f70571(1908).TableId.KvCache, database);
      return entityDao;
    };
    ...
    applyArgumentsResult.userGuildSettingsTransaction = function userGuildSettingsTransaction(database) {
      return f70571.userGuildSettings(database.database).upgradeTransaction(database);
    };
    applyArgumentsResult.guildsRequiringDeletedIdsSyncTransaction = function guildsRequiringDeletedIdsSyncTransaction(database) {
      const result = f70571.guildsRequiringDeletedIdsSync(database.database);
    ...
    applyArgumentsResult.guildsRequiringChannelSyncTransaction = function guildsRequiringChannelSyncTransaction(database) {
      const result = f70571.guildsRequiringChannelSync(database.database);
      return result.upgradeTransaction(database);
    };
    applyArgumentsResult.userSearchItemsTransaction = function userSearchItemsTransaction(database) {
      return f70571.userSearchItems(database.database).upgradeTransaction(database);
    };
