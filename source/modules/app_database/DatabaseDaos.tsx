...
class DatabaseDaos extends Store {
  constructor() {
    ...
    f71293 = (database) => {
      const guildEntityDao = new f71293(1937).GuildEntityDao("guild_channels", f71293(1937).TableId.KvCache, database);
    ...
    applyArgumentsResult.channels = (arg0) => {
      ...
      if (null != databaseResult) {
        tmp5 = f71293(databaseResult);
      }
      return tmp5;
    };
    f71293 = (database) => {
      const guildDao = new f71293(1937).GuildDao("guild_channels_temp", f71293(1937).TableId.KvCache, database);
      return guildDao;
    };
    ...
    f71293 = (database) => {
      const dao = new f71293(1937).Dao("basic_channels", f71293(1937).TableId.KvCache, database);
      return dao;
    };
    ...
    f71293 = (database) => {
      const dao = new f71293(1937).Dao("basic_channels_synced", f71293(1937).TableId.KvCache, database);
      return dao;
    };
    ...
    f71293 = (database) => {
      const dao = new f71293(1937).Dao("cache", f71293(1937).TableId.KvCache, database);
      return dao;
    };
    ...
    f71293 = (database) => {
      const dao = new f71293(1937).Dao("force_resync_version", f71293(1937).TableId.KvCache, database);
      return dao;
    };
    ...
    f71293 = (database) => {
      const guildEntityDao = new f71293(1937).GuildEntityDao("guild_emojis", f71293(1937).TableId.KvCache, database);
      return guildEntityDao;
    };
    ...
    f71293 = (database) => {
      const entityDao = new f71293(1937).EntityDao("guilds", f71293(1937).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f71293 = (database) => {
      const entityDao = new f71293(1937).EntityDao("guilds_requiring_deleted_ids_sync", f71293(1937).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f71293 = (database) => {
      const entityDao = new f71293(1937).EntityDao("guilds_requiring_channel_sync", f71293(1937).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f71293 = (database) => {
      const messageDao = new f71293(1937).MessageDao("messages", f71293(1937).TableId.Messages, database);
      return messageDao;
    };
    ...
    f71293 = (database) => {
      const guildEntityDao = new f71293(1937).GuildEntityDao("guild_stickers", f71293(1937).TableId.KvCache, database);
      return guildEntityDao;
    };
    ...
    f71293 = (database) => {
      const entityDao = new f71293(1937).EntityDao("guild_versions", f71293(1937).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f71293 = (database) => {
      const entityDao = new f71293(1937).EntityDao("non_guild_versions", f71293(1937).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f71293 = (database) => {
      const entityDao = new f71293(1937).EntityDao("user_settings", f71293(1937).TableId.KvCache, database);
      return entityDao;
    };
    ...
    f71293 = (database) => {
      const dao = new f71293(1937).Dao("read_states", f71293(1937).TableId.KvCache, database);
      return dao;
    };
    ...
    f71293 = (database) => {
      const dao = new f71293(1937).Dao("user_guild_settings", f71293(1937).TableId.KvCache, database);
      return dao;
    };
    ...
    f71293 = (database) => {
      const entityDao = new f71293(1937).EntityDao("user_search_items", f71293(1937).TableId.KvCache, database);
      return entityDao;
    };
    ...
    applyArgumentsResult.userGuildSettingsTransaction = function userGuildSettingsTransaction(database) {
      return f71293.userGuildSettings(database.database).upgradeTransaction(database);
    };
    applyArgumentsResult.guildsRequiringDeletedIdsSyncTransaction = function guildsRequiringDeletedIdsSyncTransaction(database) {
      const result = f71293.guildsRequiringDeletedIdsSync(database.database);
    ...
    applyArgumentsResult.guildsRequiringChannelSyncTransaction = function guildsRequiringChannelSyncTransaction(database) {
      const result = f71293.guildsRequiringChannelSync(database.database);
      return result.upgradeTransaction(database);
    };
    applyArgumentsResult.userSearchItemsTransaction = function userSearchItemsTransaction(database) {
      return f71293.userSearchItems(database.database).upgradeTransaction(database);
    };
