...
// Dependencies: [32, 1391, 5155, 676, 6942, 6946, 6947, 2]
// Exports: withFallbacks

// Module 6948 (isSaveableChannel)
...
export const withFallbacks = function withFallbacks(extendedMemoryLru, arg1) {
  if (extendedMemoryLru.totalLength >= arg1) {
    ...
    extendedMemoryLru = new require(6942) /* totalLength */.ExtendedMemoryLru(extendedMemoryLru.primaryCapacity, extendedMemoryLru.extendedCapacity);
      ...
      for (const item10013 of guildIds) {
        ...
        for (const item10025 of values) {
          ...
          if (isReadableChannelResult) {
            ...
            let obj3 = require(6946) /* isReadableChannel */;
            let tmp15 = item10025;
          ...
          if (isReadableChannelResult) {
            ...
            let obj4 = require(6947) /* LIMITED_GUILD_MEMBER_THRESHOLD */;
            let tmp18 = item10025;
