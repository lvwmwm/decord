...
// Dependencies: [5, 32, 4931, 1372, 6834, 3, 4930, 1907, 6840, 6843, 1908, 2]
// Exports: isLikelyNotDelta

// Module 6833 (computeUsersAndMembers)
...
prototype2["insertStale"] = function insertStale(guildId, channel_id, item10009, database) {
  ...
  const KvMessage = obj(6843).KvMessage;
...
prototype2["upsertMany"] = function upsertMany(guild_id, channelId, messages, database) {
  ...
  while (iter !== undefined) {
    let tmp3 = obj;
    let tmp4 = dependencyMap;
    let KvMessage = obj(6843).KvMessage;
    let tmp5 = KvMessage;
    let tmp6 = guild_id;
    let tmp7 = channelId;
    let tmp8 = nextResult;
