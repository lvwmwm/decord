...
// Dependencies: [19, 1391, 5398, 9932, 21, 4042, 4168, 1626, 589, 9933, 4271, 1493, 1628, 5267, 500, 8679, 5397, 9934, 2]
// Exports: default

// Module 9931 (ExpressionPickerActionSheet)
...
export default function ExpressionPickerActionSheet(arg0) {
  ...
  const diff = height - require(5267) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT_MULTILINE - importDefault(1628)().top;
  ...
  if (undefined !== stateFromStores) {
    ...
    if (isIOSResult) {
      ...
      obj[0] = sharedValue;
      isIOSResult = callback(tmp7(8679), obj);
    }
    obj = { children: null };
    ...
    obj2[11] = diff;
    obj1[5] = callback(tmp7(9934), obj2);
