...
// Dependencies: [19, 1372, 5378, 9844, 21, 4145, 4150, 1607, 589, 9845, 4253, 1474, 1609, 5250, 500, 8596, 5377, 9846, 2]
// Exports: default

// Module 9843 (ExpressionPickerActionSheet)
...
export default function ExpressionPickerActionSheet(arg0) {
  ...
  let obj1 = require(4150) /* useKeyboardType */;
  ...
  const diff = height - require(5250) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT_MULTILINE - importDefault(1609)().top;
