...
// Dependencies: [31, 1348, 5188, 9568, 33, 3991, 3996, 1555, 566, 9569, 4098, 1450, 1557, 5084, 477, 9342, 5187, 9570, 2]
// Exports: default

// Module 9567 (ExpressionPickerActionSheet)
...
export default function ExpressionPickerActionSheet(arg0) {
  ...
  if (undefined !== stateFromStores) {
    ...
    if (isIOSResult) {
      ...
      isIOSResult = callback(importDefault(9342), obj);
    }
    ...
    obj1.children = callback(importDefault(9570), obj2);
