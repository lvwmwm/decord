...
// Dependencies: [19, 17, 1369, 21, 4255, 712, 4071, 5323, 1297, 4251, 4665, 4223, 2]
// Exports: default

// Module 8530 (PremiumUpsellTooltipActionSheet)
import "noop";
...
export default function PremiumUpsellTooltipActionSheet(arg0) {
  ...
  const items4 = [closure_6(require(4665) /* Button */.Button, obj5), ];
  tmp2Result = null;
  ...
  return closure_6(require(5323) /* Background */.BottomSheet, obj);
};
