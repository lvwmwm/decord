...
// Dependencies: [19, 17, 1388, 21, 4661, 712, 4196, 6950, 1297, 4734, 4745, 4342, 2]
// Exports: default
...
export default function PremiumUpsellTooltipActionSheet(arg0) {
  ...
  const items2 = [closure_6(require(1297) /* Button */.NitroWheel, { style: tmp.nitroWheel }), closure_6(require(4734) /* Text */.Text, { variant: "heading-xl/bold", style: tmp.title, color: "mobile-text-heading-primary", accessibilityRole: "header", children: title })];
  obj1[1] = items2;
  items1[1] = closure_7(closure_4, obj1);
  const items3 = [tmp.description, descriptionStyle];
  items1[2] = closure_6(require(4734) /* Text */.Text, { style: items3, variant: "text-md/medium", color: "text-default", children: description });
  ...
  const items4 = [closure_6(require(4745) /* Button */.Button, obj5), ];
  tmp2Result = null;
  ...
  return closure_6(require(6950) /* Background */.BottomSheet, obj);
};
