...
// Dependencies: [32, 19, 17, 10564, 10565, 21, 5774, 16184, 16186, 16190, 16191, 16209, 589, 16201, 2]

// Module 16208 (FramePanelHeaderContentInner)
...
function FramePanelHeaderContentInner(arg0) {
  ...
  let obj = require(16184) /* useBaseActivityPanelHeaderContent */;
  ...
  let obj1 = require(16184) /* useBaseActivityPanelHeaderContent */;
  const minimizeAndQuestButtonContainerStyles = obj1.useMinimizeAndQuestButtonContainerStyles();
  let id;
  if (first != null) {
    id = first.id;
  }
  const tmp7Result = closure_7(importDefault(16186), { applicationId: id });
  ...
  const tmp12 = View;
  const tmp4 = require;
  const tmp8 = importDefault(16186);
  if (!landscape) {
    let name;
    if (first != null) {
      name = first.name;
  ...
  const items2 = [closure_7(importDefault(16190), { activityName: tmp15, setMode }), , ];
  obj1 = { applicationId: frame.applicationId };
  items2[1] = closure_7(importDefault(16191), obj1);
  let tmp17 = null;
  if (landscape) {
    tmp17 = tmp7Result;
  }
  ...
  items3[1] = tmp18;
  items3[2] = closure_7(importDefault(16209), { frame, setMode });
  obj[5] = items3;
...
const memoResult = importAllResult.memo(() => {
  let obj = require(16184) /* useBaseActivityPanelHeaderContent */;
  obj = { context: importDefault(16201) };
