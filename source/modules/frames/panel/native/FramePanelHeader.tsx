...
// Dependencies: [32, 19, 17, 10592, 10593, 21, 5734, 16099, 16101, 16105, 16106, 16124, 589, 16116, 2]

// Module 16123 (FramePanelHeaderContentInner)
...
function FramePanelHeaderContentInner(arg0) {
  ...
  let obj = require(16099) /* useBaseActivityPanelHeaderContent */;
  ...
  let obj1 = require(16099) /* useBaseActivityPanelHeaderContent */;
  const minimizeAndQuestButtonContainerStyles = obj1.useMinimizeAndQuestButtonContainerStyles();
  let id;
  if (first != null) {
    id = first.id;
  }
  const tmp7Result = closure_7(importDefault(16101), { applicationId: id });
  ...
  const tmp12 = View;
  const tmp4 = require;
  const tmp8 = importDefault(16101);
  if (!landscape) {
    let name;
    if (first != null) {
      name = first.name;
  ...
  const items2 = [closure_7(importDefault(16105), { activityName: tmp15, setMode }), , ];
  obj1 = { applicationId: frame.applicationId };
  items2[1] = closure_7(importDefault(16106), obj1);
  let tmp17 = null;
  if (landscape) {
    tmp17 = tmp7Result;
  }
  ...
  items3[1] = tmp18;
  items3[2] = closure_7(importDefault(16124), { frame, setMode });
  obj[5] = items3;
...
const memoResult = importAllResult.memo(() => {
  let obj = require(16099) /* useBaseActivityPanelHeaderContent */;
  obj = { context: importDefault(16116) };
