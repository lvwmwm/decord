...
// Module 15578 (QuestActivityButtonInner)
...
let obj = { container: {}, completionGlow: { shadowOffset: { aze: false, azj: true } }, canvas: { position: "absolute", transform: items } };
const items = [{ rotate: "-90deg" }];
obj = { color: importDefault(dependencyMap[10]).colors.STATUS_POSITIVE };
obj.progressPath = obj;
obj.buttonWrapper = { channelId: 4, isPreload: null, limit: null };
