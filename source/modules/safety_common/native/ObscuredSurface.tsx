...
// Dependencies: [19, 17, 21, 4302, 712, 9245, 4808, 4298, 1236, 2]
// Exports: default

// Module 9244 (ObscuredSurface)
import "noop";
...
export default function ObscuredSurface(obscured) {
  ...
  if (obscured.obscured) {
    ...
    obj[0] = require(9245) /* context */.OBSCURED_VALUE;
    ...
    const items1 = [callback(require(4808) /* ImageWarningIcon */.ImageWarningIcon, obj3), , ];
    if (heading == null) {
    ...
    tmp3Result = tmp3(require(9245) /* context */.ObscuredSurfaceContext.Provider, obj);
  }
  return tmp3Result;
};
