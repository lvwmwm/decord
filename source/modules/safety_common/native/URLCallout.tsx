...
export const URLCallout = function URLCallout(url) {
  ...
  const items1 = [callback(require(4185) /* Text */.Text, { variant: "text-md/normal", color: "text-muted", children: items }), callback2(require(4185) /* Text */.Text, { variant: "text-md/semibold", color: "text-default", children: hostname }), callback2(require(4185) /* Text */.Text, { variant: "text-md/normal", color: "text-muted", children: theRestOfTheUrl })];
  obj[2] = items1;
