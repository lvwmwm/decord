...
// Dependencies: [32, 1218, 11170, 11, 11158, 1236, 2757, 2]
// Exports: default

// Module 12635 (getRequestToStreamCTAAndIsDisabled)
...
export default function getRequestToStreamCTAAndIsDisabled(id) {
  const tmp3 = callback(require(11170) /* canFulfillStreamRequest */.canFulfillStreamRequest(id, true), 2);
  id = id.getId();
  const obj = require(11170) /* canFulfillStreamRequest */;
  const obj2 = importDefault(11);
  const sum = importDefault(11).extractTimestamp(id.id) + require(11158) /* result */.EMBED_LIFETIME;
