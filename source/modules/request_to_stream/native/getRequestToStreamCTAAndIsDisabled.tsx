...
// Dependencies: [32, 1218, 11231, 11, 11219, 1236, 2757, 2]
// Exports: default

// Module 12713 (getRequestToStreamCTAAndIsDisabled)
...
export default function getRequestToStreamCTAAndIsDisabled(id) {
  const tmp3 = callback(require(11231) /* canFulfillStreamRequest */.canFulfillStreamRequest(id, true), 2);
  id = id.getId();
  const obj = require(11231) /* canFulfillStreamRequest */;
  const obj2 = importDefault(11);
  const sum = importDefault(11).extractTimestamp(id.id) + require(11219) /* result */.EMBED_LIFETIME;
