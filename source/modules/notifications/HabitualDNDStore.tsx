...
// Function ID: 12898
// Name: initialize
// Dependencies: [4977, 676, 687, 3957, 709, 589, 2]

// Module 12897 (initialize)
...
prototype["getTemp"] = function getTemp() {
  const obj = { x: null };
  const StatusExpiresAtSetting = require(3957) /* explicitContentFromProto */.StatusExpiresAtSetting;
