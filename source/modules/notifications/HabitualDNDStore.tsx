...
// Function ID: 12989
// Name: initialize
// Dependencies: [4996, 676, 687, 3993, 709, 589, 2]

// Module 12988 (initialize)
...
prototype["getTemp"] = function getTemp() {
  const obj = { x: null };
  const StatusExpiresAtSetting = require(3993) /* explicitContentFromProto */.StatusExpiresAtSetting;
