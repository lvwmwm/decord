...
// Dependencies: [57, 13486, 13493, 2]
// Exports: getAssignedNotifSettingsAndMappings

// Module 13492 (_createForOfIteratorHelperLoose)
  ...
  if (!iter.done) {
    while (true) {
      ...
      if (null == value.experiment) {
        ...
        obj2 = require(13493) /* knownExperimentConfigs */.knownExperimentConfigs[value.experiment];
