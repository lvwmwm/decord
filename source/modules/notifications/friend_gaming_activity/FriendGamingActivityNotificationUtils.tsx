...
// Module 14691 (onFriendGamingActivityNotificationSettingsChanged)
...
export const onFriendGamingActivityNotificationSettingsChanged = function onFriendGamingActivityNotificationSettingsChanged(friend_gaming_activity_notifications) {
  const EnableFriendGamingActivityNotifications = require(3974) /* explicitContentFromProto */.EnableFriendGamingActivityNotifications;
