...
// Module 14778 (onServerTrendingNotificationSettingsChanged)
...
export const onServerTrendingNotificationSettingsChanged = function onServerTrendingNotificationSettingsChanged(server_trending_notifications) {
  const EnableServerTrendingNotifications = require(4034) /* explicitContentFromProto */.EnableServerTrendingNotifications;
