...
// Module 14448 (onServerTrendingNotificationSettingsChanged)
...
export const onServerTrendingNotificationSettingsChanged = function onServerTrendingNotificationSettingsChanged(server_trending_notifications) {
  const EnableServerTrendingNotifications = require(3838) /* explicitContentFromProto */.EnableServerTrendingNotifications;
