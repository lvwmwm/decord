...
// Dependencies: [6, 7, 15, 17, 18, 5, 4810, 16503, 653, 482, 664, 507, 1184, 686, 3803, 5078, 2]

// Module 16502 (_isNativeReflectConstruct)
...
tmp2 = new tmp2();
let result = require("_possibleConstructorReturn").fileFinishedImporting("modules/notifications/friend_online/FriendOnlineTimer.tsx");
