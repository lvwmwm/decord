...
// Dependencies: [1371, 3913, 5762, 3914, 4495, 1376, 1372, 1891, 4356, 3921, 1960, 4101, 4977, 4480, 1366, 1903, 9675, 676, 9676, 1235, 4498, 3957, 1384, 9677, 9678, 4518, 4136, 9679, 7065, 4475, 1236, 8242, 4474, 5811, 8016, 3, 5839, 4123, 1935, 7063, 9680, 589, 2]
...
function renderTitle(channelName, channel, channel) {
  const obj = require(7065) /* FSI */;
  const isolateResult = require(7065) /* FSI */.isolate(channelName);
  const obj2 = require(7065) /* FSI */;
        ...
        if (shouldNotifyBase(currentUser, user, channel1, obj)) {
          if (messageRequest.isMessageRequest(channel_id)) {
            ...
            if (!flag) {
              ...
              obj5 = require(9677) /* isChannelCurrentlyVisible */;
            }
            if (upsertRelationship.isBlockedOrIgnoredForMessage(message)) {
              ...
              if (set2.has(channel1.type)) {
                if (muted.isMuted(channel1.id)) {
                  ...
                  const threadNotificationSetting = require(9678) /* computeThreadNotificationSetting */.computeThreadNotificationSetting(channel1);
  ...
  if (tmp3) {
    ...
    if (tmp9) {
      ...
      if (!result) {
        let result1 = !flag;
        if (!flag) {
          result1 = require(9677) /* isChannelCurrentlyVisible */.isChannelCurrentlyVisible(channel2.id);
          const obj3 = require(9677) /* isChannelCurrentlyVisible */;
        }
    ...
    if (tmp10) {
      ...
      if (tmp11) {
        ...
        if (!includeSelectedChannel) {
          result = require(9677) /* isChannelCurrentlyVisible */.isChannelCurrentlyVisible(channel.id);
          const obj = require(9677) /* isChannelCurrentlyVisible */;
        }
        tmp11 = !result;
      }
      tmp10 = tmp11;
...
export const shouldIncludeSelectedChannel = function shouldIncludeSelectedChannel() {
  ...
  if (!state.isVoicePanelFullscreen()) {
    if (null == store.getConnectedActivityLocation()) {
      ...
      flag = tmp5;
      const obj3 = require(4136) /* getRootNavigationRef */;
      tmp3 = require;
    } else {
      flag = true;
    }
        ...
        if (tmp4.ANNOUNCEMENT_THREAD !== type) {
          if (tmp4.PUBLIC_THREAD !== type) {
            ...
            if ("message_reference" in content) {
              let obj4 = require(5839) /* isForwardMessage */;
...
export const useAllowInAppNotifications = function useAllowInAppNotifications() {
  ...
  const focusModeEnabled = require(9680) /* useFocusModeEnabled */.useFocusModeEnabled();
  const obj = require(9680) /* useFocusModeEnabled */;
