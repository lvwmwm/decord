...
// Dependencies: [1371, 3884, 5735, 3885, 4465, 1376, 1372, 1862, 4326, 3892, 1931, 4072, 4947, 4450, 1366, 1874, 9644, 676, 9645, 1235, 4468, 3928, 1384, 9646, 9647, 4488, 4107, 9648, 7038, 4445, 1236, 8102, 4444, 5784, 7875, 3, 5812, 4094, 1906, 7036, 9649, 589, 2]
...
function renderTitle(channelName, channel, channel) {
  const obj = require(7038) /* FSI */;
  const isolateResult = require(7038) /* FSI */.isolate(channelName);
  const obj2 = require(7038) /* FSI */;
  ...
  return "" + isolateResult + " (" + obj2.isolate(require(4445) /* computeChannelName */.computeChannelName(channel, mergeGuildAvatar, upsertRelationship, true)) + str + ")";
}
        ...
        if (shouldNotifyBase(currentUser, user, channel1, obj)) {
          if (messageRequest.isMessageRequest(channel_id)) {
            ...
            if (!flag) {
              ...
              obj5 = require(9646) /* isChannelCurrentlyVisible */;
            }
            if (upsertRelationship.isBlockedOrIgnoredForMessage(message)) {
              ...
              if (set2.has(channel1.type)) {
                if (muted.isMuted(channel1.id)) {
                  ...
                  const threadNotificationSetting = require(9647) /* computeThreadNotificationSetting */.computeThreadNotificationSetting(channel1);
                  ...
                  if (tmp39) {
                    ...
                    if (!result) {
                      ...
                      result = require(4488) /* isMentioned */.isRawMessageMentioned(obj);
                      const tmp36Result = require(4488) /* isMentioned */;
                    }
                    tmp39 = result;
                  }
                  return tmp39;
                ...
                obj1[2] = result1;
                obj1[3] = result2;
                return require(4488) /* isMentioned */.isRawMessageMentioned(obj1);
              }
            }
          }
        } else {
  ...
  if (tmp3) {
    ...
    if (tmp9) {
      ...
      if (!result) {
        let result1 = !flag;
        if (!flag) {
          result1 = require(9646) /* isChannelCurrentlyVisible */.isChannelCurrentlyVisible(channel2.id);
          const obj3 = require(9646) /* isChannelCurrentlyVisible */;
        }
    ...
    if (tmp10) {
      ...
      if (tmp11) {
        ...
        if (!includeSelectedChannel) {
          result = require(9646) /* isChannelCurrentlyVisible */.isChannelCurrentlyVisible(channel.id);
          const obj = require(9646) /* isChannelCurrentlyVisible */;
        }
        tmp11 = !result;
      }
      tmp10 = tmp11;
          ...
          if (tmp4.PUBLIC_THREAD !== type) {
            if (tmp4.PRIVATE_THREAD !== type) {
              ...
              if (tmp4.GROUP_DM === type) {
                ...
                if (tmp6) {
                  let obj1 = require(4445) /* computeChannelName */;
            ...
            if ("message_reference" in content) {
              let obj4 = require(5812) /* isForwardMessage */;
...
export const useAllowInAppNotifications = function useAllowInAppNotifications() {
  ...
  const focusModeEnabled = require(9649) /* useFocusModeEnabled */.useFocusModeEnabled();
  const obj = require(9649) /* useFocusModeEnabled */;
