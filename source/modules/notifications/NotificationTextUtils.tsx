...
// Dependencies: [1390, 3990, 5902, 3991, 4577, 1395, 1391, 1910, 4416, 3998, 1979, 4165, 5059, 4550, 1385, 1922, 9819, 676, 9820, 1235, 4580, 4034, 1403, 9821, 9822, 4600, 4198, 9823, 7212, 4535, 1236, 8389, 4534, 5952, 8159, 3, 5980, 4187, 1954, 7210, 9824, 589, 2]
...
function renderTitle(channelName, channel, channel) {
  const obj = require(7212) /* FSI */;
  const isolateResult = require(7212) /* FSI */.isolate(channelName);
  const obj2 = require(7212) /* FSI */;
  const obj3 = require(4535) /* computeChannelName */;
  ...
  return "" + isolateResult + " (" + obj2.isolate(require(4535) /* computeChannelName */.computeChannelName(channel, mergeGuildAvatar, markAllUserIdListsStale, true)) + str + ")";
}
        ...
        if (shouldNotifyBase(currentUser, user, channel1, obj)) {
          if (messageRequest.isMessageRequest(channel_id)) {
            ...
            if (!flag) {
              ...
              obj5 = require(9821) /* isChannelCurrentlyVisible */;
            }
            if (markAllUserIdListsStale.isBlockedOrIgnoredForMessage(message)) {
              ...
              if (set2.has(channel1.type)) {
                if (muted.isMuted(channel1.id)) {
                  ...
                  const threadNotificationSetting = require(9822) /* computeThreadNotificationSetting */.computeThreadNotificationSetting(channel1);
                  ...
                  if (tmp39) {
                    ...
                    if (!result) {
                      ...
                      result = require(4600) /* isMentioned */.isRawMessageMentioned(obj);
                      const tmp36Result = require(4600) /* isMentioned */;
                    }
                    tmp39 = result;
                  }
                  return tmp39;
                ...
                obj1[2] = result1;
                obj1[3] = result2;
                return require(4600) /* isMentioned */.isRawMessageMentioned(obj1);
              }
            }
          }
        } else {
  ...
  if (tmp3) {
    ...
    if (tmp9) {
      ...
      if (!result) {
        let result1 = !flag;
        if (!flag) {
          result1 = require(9821) /* isChannelCurrentlyVisible */.isChannelCurrentlyVisible(channel2.id);
          const obj3 = require(9821) /* isChannelCurrentlyVisible */;
        }
    ...
    if (tmp10) {
      ...
      if (tmp11) {
        ...
        if (!includeSelectedChannel) {
          result = require(9821) /* isChannelCurrentlyVisible */.isChannelCurrentlyVisible(channel.id);
          const obj = require(9821) /* isChannelCurrentlyVisible */;
        }
        tmp11 = !result;
      }
      tmp10 = tmp11;
...
export const shouldIncludeSelectedChannel = function shouldIncludeSelectedChannel() {
  ...
  if (!state.isVoicePanelFullscreen()) {
    if (null == store.getConnectedActivityLocation()) {
      ...
      flag = tmp5;
      const obj3 = require(4198) /* getRootNavigationRef */;
      tmp3 = require;
    } else {
      flag = true;
    }
          ...
          if (tmp4.PUBLIC_THREAD !== type) {
            if (tmp4.PRIVATE_THREAD !== type) {
              ...
              if (tmp4.GROUP_DM === type) {
                ...
                if (tmp6) {
                  let obj1 = require(4535) /* computeChannelName */;
            ...
            if ("message_reference" in content) {
              let obj4 = require(5980) /* isForwardMessage */;
              ...
              if (content.type === constants4.PREMIUM_REFERRAL) {
                ...
                if (null != content.components) {
                  if (content.components.length > 0) {
                    if (content.components[0].type === require(1954) /* PermissionOverwriteType */.ComponentType.CHECKPOINT_CARD) {
...
export const useAllowInAppNotifications = function useAllowInAppNotifications() {
  ...
  const focusModeEnabled = require(9824) /* useFocusModeEnabled */.useFocusModeEnabled();
  const obj = require(9824) /* useFocusModeEnabled */;
