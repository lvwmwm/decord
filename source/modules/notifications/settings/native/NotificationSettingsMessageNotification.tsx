...
// Dependencies: [19, 17, 21, 4478, 709, 10264, 4474, 1233, 5076, 10265, 10262, 4445, 10267, 2008, 10254, 10269, 2]
// Exports: NotificationSettingsChannelMessageNotification, NotificationSettingsGuildMessageNotification

// Module 10263 (NotificationSettingsMessageNotification)
...
export const NotificationSettingsGuildMessageNotification = function NotificationSettingsGuildMessageNotification(style) {
  ...
  let obj = {
    context: "guild",
    style: style.style,
    setting: _require(10262).useGuildPresetSettings(style.guildId).notification,
    onCustomize() {
...
export const NotificationSettingsChannelMessageNotification = function NotificationSettingsChannelMessageNotification(style) {
  ...
  let obj = {
    context: "channel",
    style: style.style,
    setting: _require(10254).useChannelPresetSettings(style.channel).notification,
    onCustomize() {
      let obj = closure_1_1(closure_1_2[11]);
