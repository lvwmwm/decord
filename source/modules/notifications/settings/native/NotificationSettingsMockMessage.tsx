...
// Dependencies: [19, 17, 1903, 676, 21, 4302, 712, 589, 4140, 4162, 4303, 4306, 4298, 1236, 1297, 9769, 2]
// Exports: default

// Module 9768 (NotificationSettingsMockMessage)
...
export default function NotificationSettingsMockMessage(notificationSetting) {
  ...
  const items5 = [tmp12(require(4298) /* Text */.Text, obj9), tmp11];
  obj8[1] = items5;
