...
// Dependencies: [19, 17, 1922, 676, 21, 4303, 712, 589, 4148, 4042, 4304, 4307, 4299, 1236, 1297, 9841, 2]
// Exports: default

// Module 9840 (NotificationSettingsMockMessage)
...
export default function NotificationSettingsMockMessage(notificationSetting) {
  ...
  const items5 = [tmp12(require(4299) /* Text */.Text, obj9), tmp11];
  obj8[1] = items5;
