...
// Dependencies: [31, 27, 33, 1212, 4329, 4092, 10254, 10165, 4131, 689, 8162, 4127, 4544, 8687, 10256, 10250, 2]
// Exports: NotificationSettingsChannelPresets, NotificationSettingsGuildPresets

// Module 10253 (NotificationSettingsPresets)
...
export const NotificationSettingsGuildPresets = function NotificationSettingsGuildPresets(guildId) {
  ...
  const obj = {
    preset: _require(10256).useGuildPresetSettings(guildId.guildId).preset,
    updatePreset(arg0) {
...
export const NotificationSettingsChannelPresets = function NotificationSettingsChannelPresets(channel) {
  ...
  const obj = {
    preset: _require(10250).useChannelPresetSettings(channel.channel).preset,
    updatePreset(arg0) {
