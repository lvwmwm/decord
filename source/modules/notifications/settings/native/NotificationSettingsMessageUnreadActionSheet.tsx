...
// Dependencies: [19, 17, 4481, 21, 4285, 712, 5377, 9758, 4281, 1236, 7908, 7907, 2]
// Exports: default

// Module 9761 (NotificationSettingsMessageUnreadActionSheet)
import "noop";
...
export default function NotificationSettingsMessageUnreadActionSheet(defaultValue) {
  ...
  obj[1] = callback(importDefault(9758), obj);
  ...
  const items2 = [callback(require(7907) /* TableRadioRow */.TableRadioRow, obj6), ];
  ...
  items2[1] = callback(require(7907) /* TableRadioRow */.TableRadioRow, obj7);
  obj5[3] = items2;
  obj4[1] = callback2(require(7908) /* context */.TableRadioGroup, obj5);
