...
// Dependencies: [19, 17, 4498, 21, 4302, 712, 5396, 9774, 4298, 1236, 7925, 7924, 2]
// Exports: default

// Module 9777 (NotificationSettingsMessageUnreadActionSheet)
import "noop";
...
export default function NotificationSettingsMessageUnreadActionSheet(defaultValue) {
  ...
  obj[1] = callback(importDefault(9774), obj);
  ...
  const items2 = [callback(require(7924) /* TableRadioRow */.TableRadioRow, obj6), ];
  ...
  items2[1] = callback(require(7924) /* TableRadioRow */.TableRadioRow, obj7);
  obj5[3] = items2;
  obj4[1] = callback2(require(7925) /* context */.TableRadioGroup, obj5);
