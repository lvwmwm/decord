...
export default function NotificationSettingsMessageUnreadActionSheet(defaultValue) {
  ...
  const items2 = [callback(require(7984) /* TableRadioRow */.TableRadioRow, obj6), ];
  ...
  items2[1] = callback(require(7984) /* TableRadioRow */.TableRadioRow, obj7);
  obj5[3] = items2;
  obj4[1] = callback2(require(7985) /* context */.TableRadioGroup, obj5);
