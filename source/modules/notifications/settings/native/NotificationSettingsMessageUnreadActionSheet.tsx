...
// Dependencies: [19, 17, 4451, 21, 4255, 712, 5323, 9727, 4251, 1236, 7767, 7766, 2]
// Exports: default

// Module 9730 (NotificationSettingsMessageUnreadActionSheet)
import "noop";
...
export default function NotificationSettingsMessageUnreadActionSheet(defaultValue) {
  ...
  obj[1] = callback(importDefault(9727), obj);
  ...
  const items2 = [callback(require(7766) /* TableRadioRow */.TableRadioRow, obj6), ];
  ...
  items2[1] = callback(require(7766) /* TableRadioRow */.TableRadioRow, obj7);
  obj5[3] = items2;
  obj4[1] = callback2(require(7767) /* context */.TableRadioGroup, obj5);
