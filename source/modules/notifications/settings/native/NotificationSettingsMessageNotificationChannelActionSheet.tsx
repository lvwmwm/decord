...
// Dependencies: [19, 4499, 676, 4500, 685, 21, 9831, 9843, 1236, 9832, 5262, 5257, 2]
// Exports: default

// Module 9844 (NotificationSettingsMessageNotificationChannelActionSheet)
import "noop";
...
export default function NotificationSettingsMessageNotificationChannelActionSheet(channel) {
  ...
  return jsx(unread(9843), { context: "channel", value: notification, allMessagesSubLabel: null, onChange: null });
};
