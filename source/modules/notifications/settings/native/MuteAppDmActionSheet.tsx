...
// Dependencies: [19, 17, 21, 4448, 712, 5590, 9707, 4444, 1236, 4896, 5455, 5450, 4415, 4164, 1297, 7826, 2]
// Exports: default

// Module 12130 (MuteAppDMActionSheet)
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj = { style: tmp.iconContainer, children: callback(View, { style: tmp.iconBackground, "aria-hidden": true, children: callback(_require(9707).BellIcon, { size: "md", color: "interactive-text-default" }) }) };
  ...
  items[2] = callback(_require(4444).Text, obj3);
  ...
  items[3] = callback(_require(4896).Button, obj4);
  ...
  obj5[1] = callback(_require(4896).Button, obj6);
  items[4] = callback(View, obj5);
  obj[1] = items;
  obj[1] = callback2(View, obj);
  return callback(_require(5590).BottomSheet, obj);
};
