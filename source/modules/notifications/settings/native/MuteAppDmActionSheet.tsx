...
// Dependencies: [19, 17, 21, 4344, 712, 5436, 11670, 9182, 1236, 4340, 4754, 5301, 5296, 4312, 4062, 1297, 8099, 2]
// Exports: default

// Module 12018 (MuteAppDMActionSheet)
import "noop";
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj1[1] = require(9182) /* BellIcon */.BellIcon;
  let intl = require(1236) /* getSystemLocale */.intl;
  obj1[3] = intl.string(require(1236) /* getSystemLocale */.t.uAmAiL);
  obj[1] = callback(channel(11670), obj1);
