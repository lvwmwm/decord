...
// Dependencies: [19, 17, 21, 4255, 712, 5323, 11494, 9030, 1236, 4251, 4665, 5215, 5210, 4223, 3956, 1297, 7840, 2]
// Exports: default

// Module 11842 (MuteAppDMActionSheet)
import "noop";
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj1[1] = require(9030) /* BellIcon */.BellIcon;
  let intl = require(1236) /* getSystemLocale */.intl;
  obj1[3] = intl.string(require(1236) /* getSystemLocale */.t.uAmAiL);
  obj[1] = callback(channel(11494), obj1);
  ...
  items[3] = callback(require(4665) /* Button */.Button, obj4);
