...
// Dependencies: [19, 17, 21, 4380, 712, 5503, 9284, 4376, 1236, 4815, 5368, 5363, 4347, 4098, 1297, 8209, 2]
// Exports: default

// Module 12157 (MuteAppDMActionSheet)
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj = { style: tmp.iconContainer, children: callback(View, { style: tmp.iconBackground, "aria-hidden": true, children: callback(_require(9284).BellIcon, { size: "md", color: "interactive-text-default" }) }) };
  ...
  items[2] = callback(_require(4376).Text, obj3);
  ...
  items[3] = callback(_require(4815).Button, obj4);
  ...
  obj5[1] = callback(_require(4815).Button, obj6);
  items[4] = callback(View, obj5);
  obj[1] = items;
  obj[1] = callback2(View, obj);
  return callback(_require(5503).BottomSheet, obj);
};
