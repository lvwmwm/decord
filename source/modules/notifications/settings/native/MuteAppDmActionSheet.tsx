...
// Dependencies: [19, 17, 21, 4668, 712, 6988, 10042, 4739, 1236, 4750, 6835, 6832, 4346, 4097, 1297, 8213, 2]
// Exports: default

// Module 11817 (MuteAppDMActionSheet)
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj = { style: tmp.iconContainer, children: callback(View, { style: tmp.iconBackground, "aria-hidden": true, children: callback(_require(10042).BellIcon, { size: "md", color: "interactive-text-default" }) }) };
  ...
  items[2] = callback(_require(4739).Text, obj3);
  ...
  items[3] = callback(_require(4750).Button, obj4);
  ...
  obj5[1] = callback(_require(4750).Button, obj6);
