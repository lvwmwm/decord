...
// Dependencies: [19, 17, 21, 4189, 712, 4185, 4600, 1236, 2]
// Exports: NotificationSettingsMuteBanner, getMuteBannerSubtitleFromConfig

// Module 10314 (NotificationSettingsMuteBanner)
import "noop";
...
export const NotificationSettingsMuteBanner = function NotificationSettingsMuteBanner(children) {
  ...
  const items1 = [callback(require(4185) /* Text */.Text, obj), callback(require(4185) /* Text */.Text, { variant: "text-xs/medium", color: "text-overlay-light", children: children.subtitle })];
  obj[1] = items1;
  ...
  items2[1] = callback(require(4600) /* Button */.Button, obj2);
  obj[1] = items2;
