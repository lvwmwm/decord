...
// Module 10270 (NotificationSettingsMuteBanner)
importAll(dependencyMap[0]);
const View = arg1(dependencyMap[1]).View;
({ jsx: closure_3, jsxs: closure_4 } = arg1(dependencyMap[2]));
let obj = arg1(dependencyMap[3]);
obj = {};
obj = { "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, borderRadius: importDefault(dependencyMap[4]).radii.lg + 8, backgroundColor: importDefault(dependencyMap[4]).colors.BACKGROUND_BRAND };
obj.card = obj;
...
export const NotificationSettingsMuteBanner = function NotificationSettingsMuteBanner(children) {
  ...
  obj.style = items;
  obj = { style: {} };
  obj = { INTEGRATION_CREATE: true, ConstraintReasonCode: true, children: children.title };
