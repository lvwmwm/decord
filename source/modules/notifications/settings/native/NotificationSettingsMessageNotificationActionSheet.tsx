...
// Dependencies: [19, 17, 676, 21, 4302, 712, 5396, 9768, 4298, 1236, 7925, 7924, 2]
// Exports: default

// Module 9771 (NotificationSettingsMessageNotificationActionSheet)
import "noop";
...
export default function NotificationSettingsMessageNotificationActionSheet(defaultValue) {
  ...
  obj[1] = callback(importDefault(9768), obj);
  ...
  const items1 = [callback(require(4298) /* Text */.Text, obj2), callback(require(4298) /* Text */.Text, { variant: "text-xs/medium", color: "text-muted" }), ];
  ...
  const items2 = [callback(require(7924) /* TableRadioRow */.TableRadioRow, obj5), , ];
  ...
  items2[1] = callback(require(7924) /* TableRadioRow */.TableRadioRow, obj6);
  ...
  items2[2] = callback(require(7924) /* TableRadioRow */.TableRadioRow, obj7);
  obj4[3] = items2;
  obj3[1] = callback2(require(7925) /* context */.TableRadioGroup, obj4);
