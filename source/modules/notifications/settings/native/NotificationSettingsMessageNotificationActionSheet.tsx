...
// Dependencies: [19, 17, 676, 21, 4285, 712, 5338, 9750, 4281, 1236, 7795, 7794, 2]
// Exports: default

// Module 9753 (NotificationSettingsMessageNotificationActionSheet)
import "noop";
...
export default function NotificationSettingsMessageNotificationActionSheet(defaultValue) {
  ...
  obj[1] = callback(importDefault(9750), obj);
  ...
  const items1 = [callback(require(4281) /* Text */.Text, obj2), callback(require(4281) /* Text */.Text, { variant: "text-xs/medium", color: "text-muted" }), ];
  ...
  const items2 = [callback(require(7794) /* TableRadioRow */.TableRadioRow, obj5), , ];
  ...
  items2[1] = callback(require(7794) /* TableRadioRow */.TableRadioRow, obj6);
  ...
  items2[2] = callback(require(7794) /* TableRadioRow */.TableRadioRow, obj7);
  obj4[3] = items2;
  obj3[1] = callback2(require(7795) /* context */.TableRadioGroup, obj4);
