...
// Dependencies: [32, 1391, 4539, 676, 4540, 685, 647, 4542, 9870, 5301, 9873, 5296, 2]
...
// Module 9872 (useChannelPresetSettings)
...
export const useChannelPresetSettings = function useChannelPresetSettings(channel) {
  ...
  obj[2] = _require(4542).presetFromSettings(stateFromStores, stateFromStores1);
  return obj;
};
...
export const updateChannelPreset = function updateChannelPreset(guild_id, id, arg2) {
  ...
  if (arg2 === require(4542) /* Presets */.Presets.ALL_MESSAGES) {
    const obj4 = importDefault(5301);
    ...
    const result = obj4.updateChannelOverrideSettings(guild_id, id, obj, tmp2(5296).NotificationLabels.PresetAll);
  } else if (arg2 === tmp2(4542).Presets.MENTIONS) {
    obj = importDefault(5301);
    ...
    const result1 = obj.updateChannelOverrideSettings(guild_id, id, obj, tmp2(5296).NotificationLabels.PresetMentions);
  } else if (arg2 === tmp2(4542).Presets.NOTHING) {
    const obj7 = importDefault(5301);
    const obj1 = { message_notifications: null, flags: null };
    obj1[0] = UserNotificationSettings.NO_MESSAGES;
    obj1[1] = tmp2(9873).withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ONLY_MENTIONS);
    const result2 = obj7.updateChannelOverrideSettings(guild_id, id, obj1, tmp2(5296).NotificationLabels.PresetNothing);
...
export const updateChannelToGuildDefault = function updateChannelToGuildDefault(guild_id, id) {
  ...
  obj[1] = require(9873) /* resetGuildUnreadFlags */.resetChannelUnreadFlags(store.getChannelIdFlags(guild_id, id));
  const result = obj.updateChannelOverrideSettings(guild_id, id, obj, require(5296) /* UserNotificationSettings */.NotificationLabels.PresetDefault);
};
export const updateChannelUnreadSetting = function updateChannelUnreadSetting(guild_id, id, ALL_MESSAGES) {
  ...
  obj = { flags: require(9873) /* resetGuildUnreadFlags */.withChannelUnreadFlags(channelIdFlags, UNREADS_ONLY_MENTIONS) };
