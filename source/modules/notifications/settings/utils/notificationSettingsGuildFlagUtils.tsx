...
// Dependencies: [4450, 676, 685, 4453, 5215, 9713, 5210, 647, 2]
// Exports: updateGuildPreset, useGuildPresetSettings

// Module 9718 (updateGuildPreset)
...
export const updateGuildPreset = function updateGuildPreset(guildId, arg1) {
  ...
  if (arg1 === require(4453) /* Presets */.Presets.ALL_MESSAGES) {
    ...
    const result = importDefault(5215).updateGuildNotificationSettings(guildId, obj, tmp2(5210).NotificationLabels.PresetAll);
