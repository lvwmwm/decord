...
// Dependencies: [4499, 676, 685, 4502, 5262, 9827, 5257, 647, 2]
// Exports: updateGuildPreset, useGuildPresetSettings

// Module 9832 (updateGuildPreset)
...
export const updateGuildPreset = function updateGuildPreset(guildId, arg1) {
  ...
  if (arg1 === require(4502) /* Presets */.Presets.ALL_MESSAGES) {
    ...
    const result = importDefault(5262).updateGuildNotificationSettings(guildId, obj, tmp2(5257).NotificationLabels.PresetAll);
