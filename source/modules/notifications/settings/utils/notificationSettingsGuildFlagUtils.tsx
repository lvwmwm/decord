...
// Dependencies: [4539, 676, 685, 4542, 5301, 9873, 5296, 647, 2]
// Exports: updateGuildPreset, useGuildPresetSettings

// Module 9878 (updateGuildPreset)
...
export const updateGuildPreset = function updateGuildPreset(guildId, arg1) {
  ...
  if (arg1 === require(4542) /* Presets */.Presets.ALL_MESSAGES) {
    ...
    const result = importDefault(5301).updateGuildNotificationSettings(guildId, obj, tmp2(5296).NotificationLabels.PresetAll);
