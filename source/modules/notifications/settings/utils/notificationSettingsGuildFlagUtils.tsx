...
// Dependencies: [4709, 673, 682, 4712, 7059, 10079, 7054, 644, 2]
// Exports: updateGuildPreset, useGuildPresetSettings

// Module 10084 (updateGuildPreset)
...
export const updateGuildPreset = function updateGuildPreset(guildId, arg1) {
  ...
  if (arg1 === Presets.Presets.ALL_MESSAGES) {
    ...
    const result = _modDef7059.updateGuildNotificationSettings(guildId, obj, tmp2(7054).NotificationLabels.PresetAll);
    const obj4 = _modDef7059;
  } else if (arg1 === tmp2(4712).Presets.MENTIONS) {
    obj = _modDef7059;
    ...
    const result1 = obj.updateGuildNotificationSettings(guildId, obj, tmp2(7054).NotificationLabels.PresetMentions);
  } else if (arg1 === tmp2(4712).Presets.NOTHING) {
    obj1 = { message_notifications: null, flags: null };
    obj1[0] = UserNotificationSettings.NO_MESSAGES;
    const obj7 = _modDef7059;
    obj1[1] = tmp2(10079).withGuildUnreadFlags(guildFlags, constants.UNREADS_ONLY_MENTIONS);
    const result2 = obj7.updateGuildNotificationSettings(guildId, obj1, tmp2(7054).NotificationLabels.PresetNothing);
