...
// Function ID: 10997
// Name: onClose
// Dependencies: [19, 17, 676, 21, 4255, 5189, 712, 4223, 5323, 5322, 5632, 10997, 4251, 1236, 1945, 2]
// Exports: default

// Module 10996 (onClose)
import "noop";
...
export default function NotificationSurveyResponseActionSheet(header) {
  ...
  if (tmp5) {
    ...
    obj = { onPress: null };
    obj[0] = onClose;
    obj[1] = callback(tmp3(5632).ActionSheetCloseButton, obj);
    tmp5 = callback(tmp3(5322).BottomSheetTitleHeader, obj);
  }
  obj = { children: null };
  const items = [tmp5, ];
  const obj1 = { style: tmp.view, children: null };
  const items1 = [callback(closure_4, { style: tmp.rating, source: importDefault(10997) }), , ];
  ...
  const obj2 = { style: tmp.rating, source: importDefault(10997) };
  ...
  items1[2] = callback(require(4251) /* Text */.Text, obj4);
  obj1[1] = items1;
  items[1] = closure_7(closure_3, obj1);
  obj[0] = items;
  return closure_7(require(5323) /* Background */.BottomSheet, obj);
};
