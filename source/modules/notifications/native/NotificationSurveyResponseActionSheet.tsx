...
// Function ID: 11085
// Name: onClose
// Dependencies: [19, 17, 676, 21, 4342, 5276, 712, 4310, 5437, 5436, 5805, 11085, 4338, 1236, 1993, 2]
// Exports: default

// Module 11084 (onClose)
import "noop";
...
export default function NotificationSurveyResponseActionSheet(header) {
  ...
  if (tmp5) {
    ...
    obj = { onPress: null };
    obj[0] = onClose;
    obj[1] = callback(tmp3(5805).ActionSheetCloseButton, obj);
    tmp5 = callback(tmp3(5436).BottomSheetTitleHeader, obj);
  }
  obj = { children: null };
  const items = [tmp5, ];
  const obj1 = { style: tmp.view, children: null };
  const items1 = [callback(closure_4, { style: tmp.rating, source: importDefault(11085) }), , ];
  ...
  const obj2 = { style: tmp.rating, source: importDefault(11085) };
  ...
  items1[2] = callback(require(4338) /* Text */.Text, obj4);
  obj1[1] = items1;
  items[1] = closure_7(closure_3, obj1);
  obj[0] = items;
  return closure_7(require(5437) /* Background */.BottomSheet, obj);
};
