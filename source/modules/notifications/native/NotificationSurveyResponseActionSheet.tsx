...
// Function ID: 9703
// Name: onClose
// Dependencies: [19, 17, 676, 21, 4255, 5175, 712, 4223, 5309, 5308, 5618, 9703, 4251, 1236, 1945, 2]
// Exports: default
...
export default function NotificationSurveyResponseActionSheet(header) {
  ...
  if (tmp5) {
    ...
    obj = { onPress: null };
    obj[0] = onClose;
    obj[1] = callback(tmp3(5618).ActionSheetCloseButton, obj);
    tmp5 = callback(tmp3(5308).BottomSheetTitleHeader, obj);
  }
  obj = { children: null };
  const items = [tmp5, ];
  const obj1 = { style: tmp.view, children: null };
  const items1 = [callback(closure_4, { style: tmp.rating, source: importDefault(9703) }), , ];
  ...
  const obj2 = { style: tmp.rating, source: importDefault(9703) };
  ...
  obj[0] = items;
  return closure_7(require(5309) /* Background */.BottomSheet, obj);
};
