...
// Function ID: 11025
// Name: onClose
// Dependencies: [19, 17, 676, 21, 4285, 5204, 712, 4253, 5338, 5337, 5647, 11025, 4281, 1236, 1945, 2]
// Exports: default

// Module 11024 (onClose)
import "noop";
...
export default function NotificationSurveyResponseActionSheet(header) {
  ...
  if (tmp5) {
    ...
    obj = { onPress: null };
    obj[0] = onClose;
    obj[1] = callback(tmp3(5647).ActionSheetCloseButton, obj);
    tmp5 = callback(tmp3(5337).BottomSheetTitleHeader, obj);
  }
  obj = { children: null };
  const items = [tmp5, ];
  const obj1 = { style: tmp.view, children: null };
  const items1 = [callback(closure_4, { style: tmp.rating, source: importDefault(11025) }), , ];
  ...
  const obj2 = { style: tmp.rating, source: importDefault(11025) };
  ...
  items1[2] = callback(require(4281) /* Text */.Text, obj4);
  obj1[1] = items1;
  items[1] = closure_7(closure_3, obj1);
  obj[0] = items;
  return closure_7(require(5338) /* Background */.BottomSheet, obj);
};
