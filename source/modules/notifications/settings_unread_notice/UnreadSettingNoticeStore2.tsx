...
// Function ID: 10312
// Name: startInterval
// Dependencies: [1218, 1372, 1891, 1960, 4480, 676, 4481, 685, 687, 11, 1384, 589, 9743, 709, 2]

// Module 10311 (startInterval)
  ...
  if (shouldTrackChannel(id)) {
    ...
    if (tmp6) {
      ...
      if (flag2) {
        ...
        delete tmp[tmp2];
        set.add(id);
        const result = require(9743) /* useChannelPresetSettings */.updateChannelUnreadSetting(basicChannel.guild_id, basicChannel.id, UnreadSetting.ALL_MESSAGES);
        flag2 = true;
        let obj = require(9743) /* useChannelPresetSettings */;
      }
      tmp6 = flag2;
    }
    return tmp6;
