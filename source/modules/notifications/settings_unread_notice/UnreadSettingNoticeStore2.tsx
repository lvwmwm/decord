...
// Function ID: 10369
// Name: startInterval
// Dependencies: [1218, 1391, 1910, 1979, 4550, 676, 4551, 685, 687, 11, 1403, 589, 9886, 709, 2]

// Module 10368 (startInterval)
  ...
  if (shouldTrackChannel(id)) {
    ...
    if (tmp6) {
      ...
      if (flag2) {
        ...
        delete tmp[tmp2];
        set.add(id);
        const result = require(9886) /* useChannelPresetSettings */.updateChannelUnreadSetting(basicChannel.guild_id, basicChannel.id, UnreadSetting.ALL_MESSAGES);
        flag2 = true;
        let obj = require(9886) /* useChannelPresetSettings */;
      }
      tmp6 = flag2;
    }
    return tmp6;
