...
// Dependencies: [19, 17, 685, 21, 4255, 712, 10286, 4251, 1236, 4797, 10287, 2]
// Exports: default

// Module 10285 (UnreadSettingNoticeConnected)
import "noop";
...
export default function UnreadSettingNoticeConnected(channel) {
  ...
  const items = [callback(importDefault(10286), obj), , ];
  ...
  obj2[1] = callback(_require(4797).PressableOpacity, obj3);
