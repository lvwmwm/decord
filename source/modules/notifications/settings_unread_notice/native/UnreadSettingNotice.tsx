...
// Dependencies: [19, 17, 685, 21, 4344, 712, 10446, 4340, 1236, 4886, 10447, 2]
// Exports: default

// Module 10445 (UnreadSettingNoticeConnected)
import "noop";
...
export default function UnreadSettingNoticeConnected(channel) {
  ...
  const items = [callback(importDefault(10446), obj), , ];
  ...
  obj[1] = callback(_require(4340).Text, obj1);
  ...
  obj3[3] = callback(_require(4340).Text, obj4);
  obj2[1] = callback(_require(4886).PressableOpacity, obj3);
