...
// Dependencies: [19, 17, 685, 21, 4285, 712, 10317, 4281, 1236, 4827, 10318, 2]
// Exports: default

// Module 10316 (UnreadSettingNoticeConnected)
import "noop";
...
export default function UnreadSettingNoticeConnected(channel) {
  ...
  const items = [callback(importDefault(10317), obj), , ];
  ...
  obj2[1] = callback(_require(4827).PressableOpacity, obj3);
