...
// Module 13886 (isRateLimited)
import { Store } from "initialize";

let closure_2 = { taken: null, error: "T", rateLimited: null };
...
obj[3] = { migration: { suggestion: { username: "Array" }, fetched: false, usernameSuggestionLoading: false }, registration: { suggestion: { username: "Array" }, source: "PX_8", fetched: "locomotief" } };
...
obj = {
  ...
  UNIQUE_USERNAME_SUGGESTIONS_RESET: function handleUniqueUsernameSuggestionsReset() {
    ...
    obj.suggestions.registration = { suggestion: { username: "Array" }, source: "PX_8", fetched: "locomotief" };
  },
