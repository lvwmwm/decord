...
// Dependencies: [4544, 14080, 1236, 2]
// Exports: formatUsernameLiveCheckValidation

// Module 14085 (formatUsernameLiveCheckValidation)
...
export const formatUsernameLiveCheckValidation = function formatUsernameLiveCheckValidation(arg0) {
  const match = require(4544) /* t */.match(arg0);
  const str = require(4544) /* t */;
  let obj = { error: null };
  const P = require(4544) /* t */.P;
  obj[0] = P.not(require(4544) /* t */.P.nullish);
  ...
  obj = { error: require(4544) /* t */.P.nullish };
