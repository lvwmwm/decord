...
// Dependencies: [4486, 14116, 1236, 2]
...
export const formatUsernameLiveCheckValidation = function formatUsernameLiveCheckValidation(arg0) {
  const match = require(4486) /* t */.match(arg0);
  const str = require(4486) /* t */;
  let obj = { error: null };
  const P = require(4486) /* t */.P;
  obj[0] = P.not(require(4486) /* t */.P.nullish);
  ...
  obj = { error: require(4486) /* t */.P.nullish };
