...
// Dependencies: [19, 17, 7047, 676, 21, 4344, 9401, 712, 9420, 9421, 1949, 9433, 9423, 9441, 9443, 8256, 9444, 4065, 4072, 1370, 2]
// Exports: default

// Module 9400 (CollectiblesPreview)
...
class CollectiblesPreview {
  constructor(arg0) {
    ...
    tmp3 = f46622(size2.width, size2.height);
...
function CollectiblesSKUPreview(sku) {
  ...
  if (DEFAULT_ITEM_SIZE === undefined) {
    DEFAULT_ITEM_SIZE = sku(9401).DEFAULT_ITEM_SIZE;
  }
  const items = [sku];
...
class SocialLayerStorefrontSKUPreview {
  constructor(arg0) {
    ...
    tmp3 = f46622(size.width, size.height);
    tmp4 = closure_2;
...
let closure_8 = createCacheKey.createStyles((width, height) => {
  ...
  obj = { width: require(9401) /* SourceIcon */.DEFAULT_ITEM_SIZE, height: require(9401) /* SourceIcon */.DEFAULT_ITEM_SIZE, justifyContent: "center", alignItems: "center", transform: null };
  obj = { scaleX: width / require(9401) /* SourceIcon */.DEFAULT_ITEM_SIZE };
  const items = [obj, { scaleY: height / require(9401) /* SourceIcon */.DEFAULT_ITEM_SIZE }];
  obj[4] = items;
  obj[1] = obj;
  obj[2] = { paddingTop: 20 };
  obj[3] = { width, height };
  const obj1 = { scaleY: height / require(9401) /* SourceIcon */.DEFAULT_ITEM_SIZE };
...
export default function SKUPreview(arg0) {
  ...
  ({ sku, size } = arg0);
  if (size === undefined) {
    size = require(9401) /* SourceIcon */.DEFAULT_ITEM_SIZE;
  }
