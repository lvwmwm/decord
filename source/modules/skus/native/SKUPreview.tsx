...
// Dependencies: [19, 17, 6899, 676, 21, 4255, 9244, 712, 9263, 9264, 1901, 9276, 9266, 9284, 9286, 7995, 9287, 3959, 3967, 1351, 2]
// Exports: default

// Module 9243 (CollectiblesPreview)
...
class CollectiblesPreview {
  constructor(arg0) {
    ...
    tmp3 = f46159(size2.width, size2.height);
...
function CollectiblesSKUPreview(sku) {
  ...
  if (DEFAULT_ITEM_SIZE === undefined) {
    DEFAULT_ITEM_SIZE = sku(9244).DEFAULT_ITEM_SIZE;
  }
  const items = [sku];
...
class SocialLayerStorefrontSKUPreview {
  constructor(arg0) {
    ...
    tmp3 = f46159(size.width, size.height);
    tmp4 = closure_2;
...
let closure_8 = createCacheKey.createStyles((width, height) => {
  ...
  obj = { width: require(9244) /* SourceIcon */.DEFAULT_ITEM_SIZE, height: require(9244) /* SourceIcon */.DEFAULT_ITEM_SIZE, justifyContent: "center", alignItems: "center", transform: null };
  obj = { scaleX: width / require(9244) /* SourceIcon */.DEFAULT_ITEM_SIZE };
  const items = [obj, { scaleY: height / require(9244) /* SourceIcon */.DEFAULT_ITEM_SIZE }];
  obj[4] = items;
  obj[1] = obj;
  obj[2] = { paddingTop: 20 };
  obj[3] = { width, height };
  const obj1 = { scaleY: height / require(9244) /* SourceIcon */.DEFAULT_ITEM_SIZE };
...
export default function SKUPreview(arg0) {
  ...
  ({ sku, size } = arg0);
  if (size === undefined) {
    size = require(9244) /* SourceIcon */.DEFAULT_ITEM_SIZE;
  }
