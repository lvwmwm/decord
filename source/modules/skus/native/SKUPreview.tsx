...
// Dependencies: [19, 17, 7008, 676, 21, 4303, 9361, 712, 9380, 9381, 1949, 9393, 9383, 9401, 9403, 8217, 9404, 4024, 4031, 1370, 2]
// Exports: default

// Module 9360 (CollectiblesPreview)
...
class CollectiblesPreview {
  constructor(arg0) {
    ...
    tmp3 = f46525(size2.width, size2.height);
...
function CollectiblesSKUPreview(sku) {
  ...
  if (DEFAULT_ITEM_SIZE === undefined) {
    DEFAULT_ITEM_SIZE = sku(9361).DEFAULT_ITEM_SIZE;
  }
  const items = [sku];
...
class SocialLayerStorefrontSKUPreview {
  constructor(arg0) {
    ...
    tmp3 = f46525(size.width, size.height);
    tmp4 = closure_2;
...
let closure_8 = createCacheKey.createStyles((width, height) => {
  ...
  obj = { width: require(9361) /* SourceIcon */.DEFAULT_ITEM_SIZE, height: require(9361) /* SourceIcon */.DEFAULT_ITEM_SIZE, justifyContent: "center", alignItems: "center", transform: null };
  obj = { scaleX: width / require(9361) /* SourceIcon */.DEFAULT_ITEM_SIZE };
  const items = [obj, { scaleY: height / require(9361) /* SourceIcon */.DEFAULT_ITEM_SIZE }];
  obj[4] = items;
  obj[1] = obj;
  obj[2] = { paddingTop: 20 };
  obj[3] = { width, height };
  const obj1 = { scaleY: height / require(9361) /* SourceIcon */.DEFAULT_ITEM_SIZE };
...
export default function SKUPreview(arg0) {
  ...
  ({ sku, size } = arg0);
  if (size === undefined) {
    size = require(9361) /* SourceIcon */.DEFAULT_ITEM_SIZE;
  }
