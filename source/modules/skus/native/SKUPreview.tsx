...
// Dependencies: [19, 17, 7005, 676, 21, 4303, 9355, 712, 9374, 9375, 1930, 9387, 9377, 9395, 9397, 8213, 9398, 4005, 4013, 1351, 2]
// Exports: default

// Module 9354 (CollectiblesPreview)
...
class CollectiblesPreview {
  constructor(arg0) {
    ...
    tmp3 = f46476(size2.width, size2.height);
...
function CollectiblesSKUPreview(sku) {
  ...
  if (DEFAULT_ITEM_SIZE === undefined) {
    DEFAULT_ITEM_SIZE = sku(9355).DEFAULT_ITEM_SIZE;
  }
  const items = [sku];
...
class SocialLayerStorefrontSKUPreview {
  constructor(arg0) {
    ...
    tmp3 = f46476(size.width, size.height);
    tmp4 = closure_2;
...
let closure_8 = createCacheKey.createStyles((width, height) => {
  ...
  obj = { width: require(9355) /* SourceIcon */.DEFAULT_ITEM_SIZE, height: require(9355) /* SourceIcon */.DEFAULT_ITEM_SIZE, justifyContent: "center", alignItems: "center", transform: null };
  obj = { scaleX: width / require(9355) /* SourceIcon */.DEFAULT_ITEM_SIZE };
  const items = [obj, { scaleY: height / require(9355) /* SourceIcon */.DEFAULT_ITEM_SIZE }];
  obj[4] = items;
  obj[1] = obj;
  obj[2] = { paddingTop: 20 };
  obj[3] = { width, height };
  const obj1 = { scaleY: height / require(9355) /* SourceIcon */.DEFAULT_ITEM_SIZE };
...
export default function SKUPreview(arg0) {
  ...
  ({ sku, size } = arg0);
  if (size === undefined) {
    size = require(9355) /* SourceIcon */.DEFAULT_ITEM_SIZE;
  }
