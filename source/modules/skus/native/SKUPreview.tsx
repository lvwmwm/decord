...
// Dependencies: [19, 17, 6926, 676, 21, 4285, 9273, 712, 9292, 9293, 1930, 9305, 9295, 9313, 9315, 8136, 9316, 3988, 3996, 1351, 2]
// Exports: default

// Module 9272 (CollectiblesPreview)
...
class CollectiblesPreview {
  constructor(arg0) {
    ...
    tmp3 = f46273(size2.width, size2.height);
...
function CollectiblesSKUPreview(sku) {
  ...
  if (DEFAULT_ITEM_SIZE === undefined) {
    DEFAULT_ITEM_SIZE = sku(9273).DEFAULT_ITEM_SIZE;
  }
  const items = [sku];
...
class SocialLayerStorefrontSKUPreview {
  constructor(arg0) {
    ...
    tmp3 = f46273(size.width, size.height);
    tmp4 = closure_2;
