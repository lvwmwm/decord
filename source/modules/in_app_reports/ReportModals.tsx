...
// Dependencies: [5, 1377, 3939, 1911, 676, 7961, 7962, 7964, 1411, 4496, 2]
...
// Module 7960 (_submitHamReportForFirstDM)
...
function _submitReportForInappropriateConversationSafetyAlert() {
  ...
  const tmp = callback((arg0, arg1, arg2) => {
    ...
    return (function*(arg0, arg1, arg2) {
      ...
      let c5 = 1;
      const obj1 = { name: null, record: null };
      obj1[0] = callback(7961).ReportNames.MESSAGE;
      obj1[1] = callback;
      yield callback(7964).submitHeadlessReport(obj1, { variant: "safety_alerts_headless_v1" });
      if (1 === tmp7) {
        c5 = 0;
        if (callback2 != null) {
          callback2();
...
export const showReportModalForGuild = function showReportModalForGuild(guild) {
  ...
  let obj1 = importDefault(4496);
  obj = { report_type: require(7961) /* ReportNames */.ReportNames.GUILD };
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.ReportNames.GUILD, record: guild };
  obj1 = { onSubmit: arg1 };
  require(7962) /* _showReportModal */.showReportModal(obj, {}, obj1);
};
export const showReportModalForGuildDirectoryEntry = function showReportModalForGuildDirectoryEntry(entry) {
  ...
  let obj1 = importDefault(4496);
  obj = { report_type: require(7961) /* ReportNames */.ReportNames.GUILD_DIRECTORY_ENTRY };
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.ReportNames.GUILD_DIRECTORY_ENTRY, record: entry };
  obj1 = { onSubmit: arg1 };
  require(7962) /* _showReportModal */.showReportModal(obj, {}, obj1);
};
export const showReportModalForMessage = function showReportModalForMessage(message, mobile_media_message_preview_action_sheet) {
  ...
  let obj1 = importDefault(4496);
  obj = { report_type: require(7961) /* ReportNames */.ReportNames.MESSAGE };
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.ReportNames.MESSAGE, record: message };
  obj1 = { onSubmit: arg2 };
  require(7962) /* _showReportModal */.showReportModal(obj, {}, obj1);
};
export const showStaffTestReportModalForMessage = function showStaffTestReportModalForMessage(id, arg1, onSubmit) {
  ...
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.ReportNames.MESSAGE, record: id };
  obj1 = { onSubmit };
  require(7962) /* _showReportModal */.showReportModal(obj, { variant: "staff" }, obj1);
};
export const showStaffTestReportModalForGuild = function showStaffTestReportModalForGuild(guild_id, arg1, onSubmit) {
  ...
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.ReportNames.GUILD, record: guild_id };
  obj1 = { onSubmit };
  require(7962) /* _showReportModal */.showReportModal(obj, { variant: "staff" }, obj1);
};
export const showReportModalForStageChannel = function showReportModalForStageChannel(channel) {
  ...
  if (null != stageInstanceByChannel) {
    ...
    obj[0] = require(7961) /* ReportNames */.ReportNames.STAGE_CHANNEL;
    const merged = Object.assign(obj);
    obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
    ...
    obj1[0] = arg1;
    require(7962) /* _showReportModal */.showReportModal(obj, {}, obj1);
    const obj4 = require(7962) /* _showReportModal */;
  }
};
export const showReportModalForGuildScheduledEvent = function showReportModalForGuildScheduledEvent(closure_0) {
  ...
  obj[2] = channel_id;
  let obj1 = importDefault(4496);
  obj = { report_type: require(7961) /* ReportNames */.ReportNames.GUILD_SCHEDULED_EVENT };
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: tmp(7961).ReportNames.GUILD_SCHEDULED_EVENT, record: closure_0 };
  obj1 = { onSubmit: arg1 };
  require(7962) /* _showReportModal */.showReportModal(obj, {}, obj1);
};
export const showReportModalForFirstDM = function showReportModalForFirstDM(id, onSubmit) {
  let obj = { message_id: id.id, channel_id: id.channel_id };
  let obj1 = importDefault(4496);
  obj = { report_type: require(7961) /* ReportNames */.ReportNames.FIRST_DM };
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.ReportNames.FIRST_DM, record: id };
...
export const showReportModalForUser = function showReportModalForUser(closure_0, closure_1, closure_2, ReportNames) {
  ...
  let obj1 = importDefault(4496);
  obj = { report_type: require(7961) /* ReportNames */.ReportNames.USER };
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.ReportNames.USER, record: closure_0, contextualGuildId: closure_1 };
...
export const showStaffTestReportModalForUser = function showStaffTestReportModalForUser(id, contextualGuildId, onSubmit, appContext) {
  ...
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.ReportNames.USER, record: id, contextualGuildId };
...
export const showUnauthenticatedReportModalForUser = function showUnauthenticatedReportModalForUser(emailToken, onClose) {
  ...
  let obj1 = importDefault(4496);
  obj = { report_type: require(7961) /* ReportNames */.UnauthenticatedReportNames.USER };
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.UnauthenticatedReportNames.USER, record: tmp };
...
export const showUnauthenticatedReportModalForGuild = function showUnauthenticatedReportModalForGuild(emailToken, onClose) {
  ...
  let obj2 = importDefault(4496);
  obj = { report_type: require(7961) /* ReportNames */.UnauthenticatedReportNames.GUILD };
  const merged = Object.assign(obj);
  obj2.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  const obj5 = require(7962) /* _showReportModal */;
  obj2 = { onClose, isEligibleForFeedback: false, isAuthenticated: false, emailToken };
  obj5.showReportModal({ name: require(7961) /* ReportNames */.UnauthenticatedReportNames.GUILD, record: result }, {}, obj2);
};
export const showUnauthenticatedReportModalForTida = function showUnauthenticatedReportModalForTida(emailToken, onClose) {
  ...
  obj = { report_type: require(7961) /* ReportNames */.UnauthenticatedReportNames.MEDIA_TAKEDOWN };
  const merged = Object.assign({});
  obj.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.UnauthenticatedReportNames.MEDIA_TAKEDOWN };
  require(7962) /* _showReportModal */.showReportModal(obj, {}, { onClose, isEligibleForFeedback: false, isAuthenticated: false, emailToken });
};
export const showUnauthenticatedReportModalForMessage = function showUnauthenticatedReportModalForMessage(emailToken, onClose) {
  let obj = importDefault(4496);
  obj = { report_type: require(7961) /* ReportNames */.UnauthenticatedReportNames.MESSAGE };
  const merged = Object.assign({ message_id: "Array", channel_id: "PX_8" });
  obj.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  const tmp = new hasFlag({});
  obj = { name: require(7961) /* ReportNames */.UnauthenticatedReportNames.MESSAGE, record: tmp };
  require(7962) /* _showReportModal */.showReportModal(obj, {}, { onClose, isEligibleForFeedback: false, isAuthenticated: false, emailToken });
};
...
export const showReportModalForInappropriateConversationSafetyAlert = function showReportModalForInappropriateConversationSafetyAlert(createdAt) {
  ...
  const merged = Object.assign(obj);
  obj1.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, obj);
  obj = { name: require(7961) /* ReportNames */.ReportNames.MESSAGE, record: createdAt };
  obj1 = { onSubmit: arg1 };
  require(7962) /* _showReportModal */.showReportModal(obj, { variant: "safety_alerts_v1" }, obj1);
};
export const showReportModalForWidget = function showReportModalForWidget(closure_0, closure_1) {
  let obj = require(7962) /* _showReportModal */;
  obj = { name: require(7961) /* ReportNames */.ReportNames.WIDGET, widget_id: null, user_id: null, widget: null };
...
export const showReportModalForApp = function showReportModalForApp(arg0) {
  ...
  const merged = Object.assign(obj);
  obj4.trackWithMetadata(AnalyticEvents.IAR_MODAL_OPEN, { report_type: require(7961) /* ReportNames */.ReportNames.APPLICATION });
  const obj1 = { report_type: require(7961) /* ReportNames */.ReportNames.APPLICATION };
  const obj6 = require(7962) /* _showReportModal */;
  obj6.showReportModal({ name: require(7961) /* ReportNames */.ReportNames.APPLICATION, record: application, contextualGuildId, contextualChannelId, entrypoint }, {}, { onSubmit, appContext });
};
export const showReportToModMessageModal = function showReportToModMessageModal(message) {
  let obj = require(7962) /* _showReportModal */;
  obj = { name: require(7961) /* ReportNames */.ModeratorReportNames.MESSAGE, record: message };
