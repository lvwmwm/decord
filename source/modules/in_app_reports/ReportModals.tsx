...
// Dependencies: [5, 1353, 3769, 1858, 653, 7634, 7635, 7637, 1387, 4325, 2]
...
// Module 7633 (_submitHamReportForFirstDM)
...
export const showReportModalForGuild = function showReportModalForGuild(guild) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.GUILD, obj);
  obj = { name: require(7634) /* ReportNames */.ReportNames.GUILD, record: guild };
  obj = { onSubmit: arg1 };
  require(7635) /* _showReportModal */.showReportModal(obj, {}, obj);
};
export const showReportModalForGuildDirectoryEntry = function showReportModalForGuildDirectoryEntry(entry) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.GUILD_DIRECTORY_ENTRY, obj);
  obj = { name: require(7634) /* ReportNames */.ReportNames.GUILD_DIRECTORY_ENTRY, record: entry };
  obj = { onSubmit: arg1 };
  require(7635) /* _showReportModal */.showReportModal(obj, {}, obj);
};
export const showReportModalForMessage = function showReportModalForMessage(message, mobile_media_message_preview_action_sheet) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.MESSAGE, obj);
  obj = { name: require(7634) /* ReportNames */.ReportNames.MESSAGE, record: message };
  obj = { onSubmit: arg2 };
  require(7635) /* _showReportModal */.showReportModal(obj, {}, obj);
};
export const showStaffTestReportModalForMessage = function showStaffTestReportModalForMessage(id, arg1, onSubmit) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.MESSAGE, obj);
  obj = { name: require(7634) /* ReportNames */.ReportNames.MESSAGE, record: id };
  obj = { onSubmit };
  require(7635) /* _showReportModal */.showReportModal(obj, { variant: "staff" }, obj);
};
export const showStaffTestReportModalForGuild = function showStaffTestReportModalForGuild(guild_id, arg1, onSubmit) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.GUILD, obj);
  obj = { name: require(7634) /* ReportNames */.ReportNames.GUILD, record: guild_id };
  obj = { onSubmit };
  require(7635) /* _showReportModal */.showReportModal(obj, { variant: "staff" }, obj);
};
export const showReportModalForStageChannel = function showReportModalForStageChannel(channel) {
  ...
  if (null != stageInstanceByChannel) {
    ...
    trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.STAGE_CHANNEL, obj);
    obj = { name: require(7634) /* ReportNames */.ReportNames.STAGE_CHANNEL, record: stageInstanceByChannel };
    obj = { onSubmit: arg1 };
    require(7635) /* _showReportModal */.showReportModal(obj, {}, obj);
    const obj2 = require(7635) /* _showReportModal */;
  }
};
export const showReportModalForGuildScheduledEvent = function showReportModalForGuildScheduledEvent(closure_0) {
  ...
  obj.channel_id = tmp2;
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.GUILD_SCHEDULED_EVENT, obj);
  obj = { name: require(7634) /* ReportNames */.ReportNames.GUILD_SCHEDULED_EVENT, record: closure_0 };
  obj = { onSubmit: arg1 };
  require(7635) /* _showReportModal */.showReportModal(obj, {}, obj);
};
export const showReportModalForFirstDM = function showReportModalForFirstDM(message, onSubmit) {
  let obj = { message_id: message.id, channel_id: message.channel_id };
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.FIRST_DM, obj);
  obj = { name: require(7634) /* ReportNames */.ReportNames.FIRST_DM, record: message };
...
export const showReportModalForUser = function showReportModalForUser(closure_0, closure_1, closure_2, ReportNames) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.USER, obj);
  obj = { name: require(7634) /* ReportNames */.ReportNames.USER, record: closure_0, contextualGuildId: closure_1 };
...
export const showStaffTestReportModalForUser = function showStaffTestReportModalForUser(id, contextualGuildId, onSubmit, appContext) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.USER, obj);
  obj = { name: require(7634) /* ReportNames */.ReportNames.USER, record: id, contextualGuildId };
...
export const showUnauthenticatedReportModalForUser = function showUnauthenticatedReportModalForUser(emailToken, onClose) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.UnauthenticatedReportNames.USER, obj);
  obj = { name: require(7634) /* ReportNames */.UnauthenticatedReportNames.USER, record: tmp };
...
export const showUnauthenticatedReportModalForGuild = function showUnauthenticatedReportModalForGuild(emailToken, onClose) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.UnauthenticatedReportNames.GUILD, obj);
  obj = { name: require(7634) /* ReportNames */.UnauthenticatedReportNames.GUILD, record: result };
  const obj1 = { onClose, isEligibleForFeedback: false, isAuthenticated: false, emailToken };
  require(7635) /* _showReportModal */.showReportModal(obj, {}, obj1);
};
export const showUnauthenticatedReportModalForTida = function showUnauthenticatedReportModalForTida(emailToken, onClose) {
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.UnauthenticatedReportNames.MEDIA_TAKEDOWN, {});
  let obj = require(7635) /* _showReportModal */;
  obj = { name: require(7634) /* ReportNames */.UnauthenticatedReportNames.MEDIA_TAKEDOWN };
  obj = { onClose, isEligibleForFeedback: false, isAuthenticated: false, emailToken };
...
export const showUnauthenticatedReportModalForMessage = function showUnauthenticatedReportModalForMessage(emailToken, onClose) {
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.UnauthenticatedReportNames.MESSAGE, { message_id: undefined, channel_id: undefined });
  let obj = require(7635) /* _showReportModal */;
  obj = { name: require(7634) /* ReportNames */.UnauthenticatedReportNames.MESSAGE, record: new _callSuper({}) };
  obj = { onClose, isEligibleForFeedback: false, isAuthenticated: false, emailToken };
  obj.showReportModal(obj, {}, obj);
};
...
export const showReportModalForInappropriateConversationSafetyAlert = function showReportModalForInappropriateConversationSafetyAlert(lastChannelMessage) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.MESSAGE, obj);
  obj = { name: require(7634) /* ReportNames */.ReportNames.MESSAGE, record: lastChannelMessage };
  obj = { onSubmit: arg1 };
  require(7635) /* _showReportModal */.showReportModal(obj, { variant: "safety_alerts_v1" }, obj);
};
export const showReportModalForWidget = function showReportModalForWidget(closure_0, closure_1) {
  let obj = require(7635) /* _showReportModal */;
  obj = { name: require(7634) /* ReportNames */.ReportNames.WIDGET };
...
export const showReportModalForApp = function showReportModalForApp(arg0) {
  ...
  trackShowReportModalAnalytics(require(7634) /* ReportNames */.ReportNames.APPLICATION, obj);
  const obj4 = require(7635) /* _showReportModal */;
  obj4.showReportModal({ name: require(7634) /* ReportNames */.ReportNames.APPLICATION, record: application, contextualGuildId, contextualChannelId, entrypoint }, {}, { onSubmit, appContext });
};
export const showReportToModMessageModal = function showReportToModMessageModal(message) {
  let obj = require(7635) /* _showReportModal */;
  obj = { name: require(7634) /* ReportNames */.ModeratorReportNames.MESSAGE, record: message };
