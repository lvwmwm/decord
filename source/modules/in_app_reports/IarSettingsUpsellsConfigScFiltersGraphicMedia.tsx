...
// Function ID: 7976
// Name: items
// Dependencies: [5857, 1306, 1236, 7961, 2]
...
obj[4] = function onApply() {
  ...
  const goreContentSettingOrDefault = require(5857) /* resolveGoreSettingWithDefaults */.getGoreContentSettingOrDefault();
  obj = {};
...
obj[5] = function predicate() {
  ...
  const goreContentSettingOrDefault = require(5857) /* resolveGoreSettingWithDefaults */.getGoreContentSettingOrDefault();
  ({ goreContentGuilds, goreContentFriendDm, goreContentNonFriendDm } = goreContentSettingOrDefault);
  const obj = require(5857) /* resolveGoreSettingWithDefaults */;
