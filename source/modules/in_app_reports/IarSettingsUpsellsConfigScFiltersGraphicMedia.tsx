...
// Function ID: 7959
// Name: items
// Dependencies: [5838, 1306, 1236, 7944, 2]
...
obj[4] = function onApply() {
  ...
  const goreContentSettingOrDefault = require(5838) /* resolveGoreSettingWithDefaults */.getGoreContentSettingOrDefault();
  obj = {};
...
obj[5] = function predicate() {
  ...
  const goreContentSettingOrDefault = require(5838) /* resolveGoreSettingWithDefaults */.getGoreContentSettingOrDefault();
  ({ goreContentGuilds, goreContentFriendDm, goreContentNonFriendDm } = goreContentSettingOrDefault);
  const obj = require(5838) /* resolveGoreSettingWithDefaults */;
