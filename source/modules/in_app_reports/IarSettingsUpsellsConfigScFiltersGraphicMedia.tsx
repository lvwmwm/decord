...
obj[4] = function onApply() {
  ...
  const goreContentSettingOrDefault = require(5917) /* resolveGoreSettingWithDefaults */.getGoreContentSettingOrDefault();
  obj = {};
...
obj[5] = function predicate() {
  ...
  const goreContentSettingOrDefault = require(5917) /* resolveGoreSettingWithDefaults */.getGoreContentSettingOrDefault();
  ({ goreContentGuilds, goreContentFriendDm, goreContentNonFriendDm } = goreContentSettingOrDefault);
  const obj = require(5917) /* resolveGoreSettingWithDefaults */;
