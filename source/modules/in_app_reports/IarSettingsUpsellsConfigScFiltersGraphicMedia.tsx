...
// Function ID: 8102
// Name: items
// Dependencies: [5979, 1306, 1236, 8087, 2]
...
obj[4] = function onApply() {
  ...
  const goreContentSettingOrDefault = require(5979) /* resolveGoreSettingWithDefaults */.getGoreContentSettingOrDefault();
  obj = {};
...
obj[5] = function predicate() {
  ...
  const goreContentSettingOrDefault = require(5979) /* resolveGoreSettingWithDefaults */.getGoreContentSettingOrDefault();
  ({ goreContentGuilds, goreContentFriendDm, goreContentNonFriendDm } = goreContentSettingOrDefault);
  const obj = require(5979) /* resolveGoreSettingWithDefaults */;
