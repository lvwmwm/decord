...
// Function ID: 8077
// Name: items
// Dependencies: [5956, 1306, 1236, 8062, 2]
...
obj[4] = function onApply() {
  ...
  const goreContentSettingOrDefault = require(5956) /* resolveGoreSettingWithDefaults */.getGoreContentSettingOrDefault();
  obj = {};
...
obj[5] = function predicate() {
  ...
  const goreContentSettingOrDefault = require(5956) /* resolveGoreSettingWithDefaults */.getGoreContentSettingOrDefault();
  ({ goreContentGuilds, goreContentFriendDm, goreContentNonFriendDm } = goreContentSettingOrDefault);
  const obj = require(5956) /* resolveGoreSettingWithDefaults */;
