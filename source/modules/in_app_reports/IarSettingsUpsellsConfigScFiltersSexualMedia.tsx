...
// Function ID: 7704
// Name: items
// Dependencies: [5879, 1306, 1236, 7690, 2]
...
obj[4] = function onApply() {
  ...
  const explicitContentSettingOrDefault = require(5879) /* resolveExplicitContentSettingWithDefaults */.getExplicitContentSettingOrDefault();
  obj = {};
...
obj[5] = function predicate() {
  ...
  const explicitContentSettingOrDefault = require(5879) /* resolveExplicitContentSettingWithDefaults */.getExplicitContentSettingOrDefault();
  ({ explicitContentGuilds, explicitContentFriendDm, explicitContentNonFriendDm } = explicitContentSettingOrDefault);
  const obj = require(5879) /* resolveExplicitContentSettingWithDefaults */;
