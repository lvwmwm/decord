...
// Function ID: 8101
// Name: items
// Dependencies: [5977, 1306, 1236, 8087, 2]
...
obj[4] = function onApply() {
  ...
  const explicitContentSettingOrDefault = require(5977) /* resolveExplicitContentSettingWithDefaults */.getExplicitContentSettingOrDefault();
  obj = {};
...
obj[5] = function predicate() {
  ...
  const explicitContentSettingOrDefault = require(5977) /* resolveExplicitContentSettingWithDefaults */.getExplicitContentSettingOrDefault();
  ({ explicitContentGuilds, explicitContentFriendDm, explicitContentNonFriendDm } = explicitContentSettingOrDefault);
  const obj = require(5977) /* resolveExplicitContentSettingWithDefaults */;
