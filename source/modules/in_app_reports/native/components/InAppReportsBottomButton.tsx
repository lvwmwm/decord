...
// Dependencies: [19, 17, 505, 21, 4444, 712, 1236, 2469, 4440, 4879, 1297, 2]
// Exports: default

// Module 12938 (InAppReportsBottomButton)
  ...
  if (null == button) {
    ...
    if ("submit" === button.type) {
      ...
      if (null != tmp3) {
        ...
        obj1[3] = tmp3;
        tmp14Result = tmp14(tmp17(4440).Text, obj1);
      }
      ...
      obj2[3] = str2;
      items1[1] = callback(tmp17(4879).Button, obj2);
      tmp14Result = null;
      if (hasError) {
