...
// Dependencies: [19, 17, 21, 4255, 712, 5634, 1236, 2]
// Exports: default

// Module 12525 (RemediationsElement)
import "noop";
...
export default function RemediationsElement(children) {
  ...
  obj[1] = jsx(require(5634) /* TableRowGroupTitle */.TableRowGroup, { title: null, hasIcons: true, children: null });
