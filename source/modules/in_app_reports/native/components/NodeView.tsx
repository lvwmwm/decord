...
// Function ID: 8029
// Name: HeaderView
// Dependencies: [32, 19, 17, 4302, 1372, 3929, 8029, 8026, 676, 505, 21, 4303, 712, 5716, 4733, 4299, 4151, 4259, 589, 4846, 8030, 1480, 4700, 4710, 8023, 8021, 4498, 4014, 8032, 8036, 7337, 5328, 8037, 8038, 8039, 8040, 12640, 12641, 12642, 12643, 12644, 12645, 12646, 12647, 12648, 12650, 12651, 12652, 12653, 12654, 12655, 12656, 12657, 12660, 2]
// Exports: default
...
function HeaderView(node) {
  ...
  if (tmp6) {
    ...
    obj[1] = tmp.header;
    obj[5] = header;
    tmp6 = callback2(require(4299) /* Text */.Text, obj);
  }
  const items = [tmp6, , ];
  let tmp9 = null;
  if (null != subheader) {
    ...
    if (subheader.length > 0) {
      ...
      tmp9 = callback2(require(4299) /* Text */.Text, obj);
    }
  }
  items[1] = tmp9;
  let tmp12 = null;
...
function InfoView(node) {
  ...
  if (null != info) {
    ...
    const items1 = [callback2(require(4259) /* CircleInformationIcon */.CircleInformationIcon, obj), ];
