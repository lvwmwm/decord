...
// Function ID: 8074
// Name: HeaderView
// Dependencies: [32, 19, 17, 4341, 1391, 3989, 8074, 8071, 676, 505, 21, 4342, 712, 5756, 4774, 4338, 4191, 4298, 589, 4887, 8075, 1499, 4741, 4751, 8068, 8066, 4539, 1351, 8077, 8081, 7381, 5368, 8082, 8083, 8084, 8085, 12705, 12706, 12707, 12708, 12709, 12710, 12711, 12712, 12713, 12715, 12716, 12717, 12718, 12719, 12720, 12721, 12722, 12725, 2]
// Exports: default
...
function HeaderView(node) {
  ...
  if (tmp6) {
    ...
    obj[1] = tmp.header;
    obj[5] = header;
    tmp6 = callback2(require(4338) /* Text */.Text, obj);
  }
  const items = [tmp6, , ];
  let tmp9 = null;
  if (null != subheader) {
    ...
    if (subheader.length > 0) {
      ...
      tmp9 = callback2(require(4338) /* Text */.Text, obj);
    }
  }
  items[1] = tmp9;
  let tmp12 = null;
...
function InfoView(node) {
  ...
  if (null != info) {
    ...
    obj[0] = require(4191) /* hexToRgba */.hexWithOpacity(tmp.infoBox.backgroundColor, 0.1);
    items[1] = obj;
    obj[0] = items;
    obj = { size: "md", color: null };
    obj[1] = tmp.infoBox.backgroundColor;
    const items1 = [callback2(require(4298) /* CircleInformationIcon */.CircleInformationIcon, obj), ];
