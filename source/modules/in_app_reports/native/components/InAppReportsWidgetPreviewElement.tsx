...
// Function ID: 8710
// Name: WidgetPreview
// Dependencies: [19, 17, 21, 4445, 712, 8462, 7308, 8710, 7301, 8725, 4441, 1236, 2]
// Exports: default

// Module 8709 (WidgetPreview)
  ...
  if (widget instanceof createDefaultFieldsSection.UserProfilePersonalWidget) {
    ...
    if (tmp5Result.isGameWidget(widget)) {
      ...
      if (widget.games.length > 0) {
        ...
        obj[3] = items1;
        tmp6 = callback(tmp5(8725).WidgetSection, obj);
      }
    }
    tmp5Result = tmp5(7301);
  }
  let tmp9 = null;
  if (null !== tmp6) {
    ...
    const items2 = [callback(tmp5(4441).Text, obj2), tmp6];
    obj1[1] = items2;
