...
// Function ID: 8038
// Name: ShieldElement
// Dependencies: [19, 17, 21, 4303, 6027, 2]
// Exports: default

// Module 8037 (ShieldElement)
import "noop";
...
export default function ShieldElement(element) {
  ...
  if (null != element) {
    ...
    if ("success" === element.type) {
      ...
      obj[0] = tmp.container;
      obj[1] = jsx(require(6027) /* AccountAgeTier10LargeBadge */.ShieldSpotIllustration, { width: 100, height: 100 });
