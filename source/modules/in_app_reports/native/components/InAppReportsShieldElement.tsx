...
// Function ID: 7978
// Name: ShieldElement
// Dependencies: [19, 17, 21, 4302, 5967, 2]
// Exports: default

// Module 7977 (ShieldElement)
import "noop";
...
export default function ShieldElement(element) {
  ...
  if (null != element) {
    ...
    if ("success" === element.type) {
      ...
      obj[0] = tmp.container;
      obj[1] = jsx(require(5967) /* AccountAgeTier10LargeBadge */.ShieldSpotIllustration, { width: 100, height: 100 });
