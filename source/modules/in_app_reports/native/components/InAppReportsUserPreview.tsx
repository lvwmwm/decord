...
export default function UserPreview(user) {
  ...
  if (tmp7Result) {
    ...
    tmp7Result = tmp7(tmp2(4299).Text, obj4);
  }
  const items3 = [tmp7Result, callback(require(4299) /* Text */.Text, { color: "text-default", variant: "text-sm/normal", children: user.username })];
  obj3[1] = items3;
