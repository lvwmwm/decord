...
// Function ID: 12571
// Name: UserPreview
// Dependencies: [19, 17, 21, 4302, 712, 4145, 4298, 1236, 1297, 2]
// Exports: default

// Module 12570 (UserPreview)
import "noop";
...
export default function UserPreview(user) {
  ...
  if (tmp7Result) {
    ...
    tmp7Result = tmp7(tmp2(4298).Text, obj4);
  }
  const items3 = [tmp7Result, callback(require(4298) /* Text */.Text, { color: "text-default", variant: "text-sm/normal", children: user.username })];
  obj3[1] = items3;
