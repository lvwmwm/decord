...
// Function ID: 12559
// Name: GuildPreview
// Dependencies: [19, 17, 21, 4285, 712, 4128, 4281, 1236, 5700, 2]
// Exports: default

// Module 12558 (GuildPreview)
import "noop";
...
export default function GuildPreview(guild) {
  ...
  obj2[0] = require(5700) /* GuildIconSizes */.GuildIconSizes.LARGE;
  obj2[1] = guild;
  const items2 = [callback(importDefault(5700), obj2), callback(require(4281) /* Text */.Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", style: tmp.guildInfo, children: guild.name })];
  obj1[1] = items2;
