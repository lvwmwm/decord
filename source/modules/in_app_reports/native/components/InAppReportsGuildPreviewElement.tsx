...
export default function GuildPreview(guild) {
  ...
  obj2[0] = require(5661) /* GuildIconSizes */.GuildIconSizes.LARGE;
  obj2[1] = guild;
  const items2 = [callback(importDefault(5661), obj2), callback(require(4281) /* Text */.Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", style: tmp.guildInfo, children: guild.name })];
  obj1[1] = items2;
