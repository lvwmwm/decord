...
// Function ID: 12393
// Name: GuildPreview
// Dependencies: [19, 17, 21, 4189, 712, 4033, 4185, 1236, 5566, 2]
// Exports: default

// Module 12392 (GuildPreview)
import "noop";
...
export default function GuildPreview(guild) {
  ...
  obj2[0] = require(5566) /* GuildIconSizes */.GuildIconSizes.LARGE;
  obj2[1] = guild;
  const items2 = [callback(importDefault(5566), obj2), callback(require(4185) /* Text */.Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", style: tmp.guildInfo, children: guild.name })];
  obj1[1] = items2;
