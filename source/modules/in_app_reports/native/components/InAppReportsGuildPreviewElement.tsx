...
// Function ID: 12574
// Name: GuildPreview
// Dependencies: [19, 17, 21, 4302, 712, 4145, 4298, 1236, 5719, 2]
// Exports: default

// Module 12573 (GuildPreview)
import "noop";
...
export default function GuildPreview(guild) {
  ...
  obj2[0] = require(5719) /* GuildIconSizes */.GuildIconSizes.LARGE;
  obj2[1] = guild;
  const items2 = [callback(importDefault(5719), obj2), callback(require(4298) /* Text */.Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", style: tmp.guildInfo, children: guild.name })];
  obj1[1] = items2;
