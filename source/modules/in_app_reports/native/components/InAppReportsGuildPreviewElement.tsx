...
// Function ID: 12517
// Name: GuildPreview
// Dependencies: [19, 17, 21, 4255, 712, 4099, 4251, 1236, 5632, 2]
// Exports: default

// Module 12516 (GuildPreview)
import "noop";
...
export default function GuildPreview(guild) {
  ...
  obj2[0] = require(5632) /* GuildIconSizes */.GuildIconSizes.LARGE;
  obj2[1] = guild;
  const items2 = [callback(importDefault(5632), obj2), callback(require(4251) /* Text */.Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", style: tmp.guildInfo, children: guild.name })];
  obj1[1] = items2;
