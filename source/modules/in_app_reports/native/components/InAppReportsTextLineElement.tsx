...
obj = { container: { __workletHash: null, ind: null }, header: { marginBottom: 8 }, description: { marginBottom: 16 }, trailingButtonContainer: { paddingHorizontal: 8 }, smsInfoContainer: { id: 8, title: null, options: "\u270A\u{1F3FF}" } };
obj = { "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, borderRadius: importDefault(dependencyMap[6]).radii.xs, borderColor: importDefault(dependencyMap[6]).colors.BACKGROUND_BASE_LOWEST, backgroundColor: importDefault(dependencyMap[6]).colors.BACKGROUND_BASE_LOW };
...
obj.startButtonContainer = { 0: true, REMEDIATION_ELEMENT_TYPES: true, "Null": true };
...
export default function TextLineElement(element) {
  ...
  if (is_localized) {
    ...
    obj = { "Null": "781324642736144424", "Null": null, "Null": "Cheerful Choco preens against window", "Null": "Affection", style: tmp.header, children: title };
    ...
    obj2.style = items1;
    const obj3 = { cachedAt: null, edpbxy: null, children: sms };
