...
// Dependencies: [19, 17, 4277, 21, 4285, 712, 589, 4128, 4281, 1236, 5700, 1411, 2]
// Exports: default

// Module 12560 (GuildDiscoveryPreviewElement)
import "noop";
...
export default function GuildDiscoveryPreviewElement(guild) {
  ...
  let obj1 = require(4128) /* hexToRgba */;
