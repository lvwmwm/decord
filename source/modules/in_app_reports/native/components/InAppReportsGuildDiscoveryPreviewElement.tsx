...
// Dependencies: [19, 17, 4185, 21, 4193, 712, 589, 4037, 4189, 1236, 5570, 1411, 2]
// Exports: default
...
export default function GuildDiscoveryPreviewElement(guild) {
  ...
  let obj1 = require(4037) /* hexToRgba */;
  ...
  const tmp4 = importDefault(5570);
  obj3[1] = require(1411) /* fromGuildPropertiesWithAdditionalFields */.fromClientDiscoverableGuild(guild);
  obj3[2] = !stateFromStores;
  const items3 = [callback(tmp4, obj3), callback(require(4189) /* Text */.Text, { style: tmp.guildName, variant: "text-sm/medium", color: "text-default", children: guild.name })];
  obj2[1] = items3;
