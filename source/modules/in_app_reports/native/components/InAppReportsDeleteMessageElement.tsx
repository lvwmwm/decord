...
// Dependencies: [32, 19, 4502, 676, 21, 589, 4479, 6838, 12564, 1236, 4244, 2]
// Exports: default

// Module 12568 (DeleteMessageElement)
...
export default function DeleteMessageElement(message) {
  ...
  obj[3] = tmp[0];
  obj[5] = callback;
  obj[6] = jsx(message(4244).TrashIcon, { color: "text-feedback-critical" });
  return jsx(reportId(12564), { title: null, disabledTitle: null, description: null, disabled: null, variant: "danger", onPress: null, icon: null });
};
