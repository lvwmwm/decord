...
// Dependencies: [32, 19, 4519, 676, 21, 589, 4496, 6857, 12579, 1236, 4261, 2]
// Exports: default

// Module 12583 (DeleteMessageElement)
...
export default function DeleteMessageElement(message) {
  ...
  obj[3] = tmp[0];
  obj[5] = callback;
  obj[6] = jsx(message(4261).TrashIcon, { color: "text-feedback-critical" });
  return jsx(reportId(12579), { title: null, disabledTitle: null, description: null, disabled: null, variant: "danger", onPress: null, icon: null });
};
