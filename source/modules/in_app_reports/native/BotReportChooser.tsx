...
// Dependencies: [19, 4382, 21, 5803, 4340, 1236, 5805, 4312, 8061, 589, 5768, 2]
// Exports: default

// Module 12332 (ReportAppProfile)
import "noop";
...
function ReportAppProfile(arg0) {
  ...
  obj[0] = callback(require(4340) /* Text */.Text, obj);
  ...
  return callback(require(5805) /* ActionSheetRowIcon */.ActionSheetRow, obj);
}
function ReportAppBehavior(arg0) {
  ...
  let obj1 = require(5768) /* fetchApplication */;
  ...
  obj[1] = callback(require(4340) /* Text */.Text, obj1);
  obj[2] = function onPress() {
    if (null != data) {
