...
// Dependencies: [5, 5829, 676, 12980, 12978, 501, 4477, 698, 709, 2]
// Exports: detectLocalApps

// Module 12979 (isGameCommunityAddServerEntryEnabled)
...
function isGameCommunityAddServerEntryEnabled() {
  const GameCommunityAddServerEntryExperiment = require(12980) /* GAME_COMMUNITY_ADD_SERVER_ENTRY_EXPERIMENT */.GameCommunityAddServerEntryExperiment;
