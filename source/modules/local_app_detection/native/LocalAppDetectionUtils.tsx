...
// Dependencies: [5, 5647, 676, 12784, 12782, 501, 4367, 698, 709, 2]
...
function getDetectableApp(arg0) {
  if (require(12782) /* DetectableAppNames */.DetectableAppNames.ROBLOX === arg0) {
    ...
    return obj4;
  } else if (tmp(12782).DetectableAppNames.MOBILE_LEGENDS_BANG_BANG === arg0) {
    ...
    return obj5;
  } else if (tmp(12782).DetectableAppNames.GARENA_FREE_FIRE === arg0) {
    ...
    return obj8;
  } else if (tmp(12782).DetectableAppNames.CLASH_ROYALE === arg0) {
    ...
    return obj11;
  } else if (tmp(12782).DetectableAppNames.BRAWL_STARS === arg0) {
