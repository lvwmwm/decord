...
// Dependencies: [5, 5769, 676, 12904, 12902, 501, 4475, 698, 709, 2]
// Exports: detectLocalApps

// Module 12903 (isGameCommunityUpsellMultiExperimentEnabled)
...
function isGameCommunityUpsellMultiExperimentEnabled() {
  const GameCommunityUpsellMultiExperiment = require(12904) /* GAME_COMMUNITY_UPSELL_MULTI_EXPERIMENT */.GameCommunityUpsellMultiExperiment;
...
function getDetectableApp(arg0) {
  if (require(12902) /* DetectableAppNames */.DetectableAppNames.ROBLOX === arg0) {
    ...
    return obj4;
  } else if (tmp(12902).DetectableAppNames.MOBILE_LEGENDS_BANG_BANG === arg0) {
    ...
    return obj5;
  } else if (tmp(12902).DetectableAppNames.GARENA_FREE_FIRE === arg0) {
    ...
    return obj8;
  } else if (tmp(12902).DetectableAppNames.CLASH_ROYALE === arg0) {
    ...
    return obj11;
  } else if (tmp(12902).DetectableAppNames.BRAWL_STARS === arg0) {
