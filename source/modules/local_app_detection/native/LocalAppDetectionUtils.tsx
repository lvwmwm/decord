...
// Dependencies: [5, 5750, 676, 12889, 12887, 501, 4458, 698, 709, 2]
// Exports: detectLocalApps

// Module 12888 (isGameCommunityUpsellMultiExperimentEnabled)
...
function getDetectableApp(arg0) {
  if (require(12887) /* DetectableAppNames */.DetectableAppNames.ROBLOX === arg0) {
    ...
    return obj4;
  } else if (tmp(12887).DetectableAppNames.MOBILE_LEGENDS_BANG_BANG === arg0) {
    ...
    return obj5;
  } else if (tmp(12887).DetectableAppNames.GARENA_FREE_FIRE === arg0) {
    ...
    return obj8;
  } else if (tmp(12887).DetectableAppNames.CLASH_ROYALE === arg0) {
    ...
    return obj11;
  } else if (tmp(12887).DetectableAppNames.BRAWL_STARS === arg0) {
