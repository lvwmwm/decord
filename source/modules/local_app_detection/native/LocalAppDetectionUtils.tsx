...
// Dependencies: [5, 5723, 676, 12852, 12850, 501, 4428, 698, 709, 2]
// Exports: detectLocalApps

// Module 12851 (isGameCommunityUpsellMultiExperimentEnabled)
...
function isGameCommunityUpsellMultiExperimentEnabled() {
  const GameCommunityUpsellMultiExperiment = require(12852) /* GAME_COMMUNITY_UPSELL_MULTI_EXPERIMENT */.GameCommunityUpsellMultiExperiment;
...
function getDetectableApp(arg0) {
  if (require(12850) /* DetectableAppNames */.DetectableAppNames.ROBLOX === arg0) {
    ...
    return obj4;
  } else if (tmp(12850).DetectableAppNames.MOBILE_LEGENDS_BANG_BANG === arg0) {
    ...
    return obj5;
  } else if (tmp(12850).DetectableAppNames.GARENA_FREE_FIRE === arg0) {
    ...
    return obj8;
  } else if (tmp(12850).DetectableAppNames.CLASH_ROYALE === arg0) {
    ...
    return obj11;
  } else if (tmp(12850).DetectableAppNames.BRAWL_STARS === arg0) {
