...
function isGameCommunityAddServerEntryEnabled() {
  const GameCommunityAddServerEntryExperiment = require(13039) /* GAME_COMMUNITY_ADD_SERVER_ENTRY_EXPERIMENT */.GameCommunityAddServerEntryExperiment;
