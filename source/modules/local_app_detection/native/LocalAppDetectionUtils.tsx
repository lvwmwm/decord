...
// Dependencies: [5, 5625, 653, 12743, 12741, 478, 4339, 675, 686, 2]
// Exports: detectLocalApps

// Module 12742 (_createForOfIteratorHelperLoose)
...
function isGameCommunityUpsellMultiExperimentEnabled() {
  const GameCommunityUpsellMultiExperiment = require(12743) /* GAME_COMMUNITY_UPSELL_MULTI_EXPERIMENT */.GameCommunityUpsellMultiExperiment;
