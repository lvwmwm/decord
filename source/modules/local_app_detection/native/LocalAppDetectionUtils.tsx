...
// Dependencies: [5, 5643, 676, 12759, 12757, 501, 4363, 698, 709, 2]
// Exports: detectLocalApps

// Module 12758 (isGameCommunityUpsellMultiExperimentEnabled)
...
function isGameCommunityUpsellMultiExperimentEnabled() {
  const GameCommunityUpsellMultiExperiment = require(12759) /* GAME_COMMUNITY_UPSELL_MULTI_EXPERIMENT */.GameCommunityUpsellMultiExperiment;
...
function getDetectableApp(arg0) {
  if (require(12757) /* DetectableAppNames */.DetectableAppNames.ROBLOX === arg0) {
    ...
    return obj4;
  } else if (tmp(12757).DetectableAppNames.MOBILE_LEGENDS_BANG_BANG === arg0) {
    ...
    return obj5;
  } else if (tmp(12757).DetectableAppNames.GARENA_FREE_FIRE === arg0) {
    ...
    return obj8;
  } else if (tmp(12757).DetectableAppNames.CLASH_ROYALE === arg0) {
    ...
    return obj11;
  } else if (tmp(12757).DetectableAppNames.BRAWL_STARS === arg0) {
