...
// Dependencies: [5, 5590, 653, 12700, 12698, 478, 4305, 675, 686, 2]
// Exports: detectLocalApps

// Module 12699 (_createForOfIteratorHelperLoose)
...
function isGameCommunityUpsellMultiExperimentEnabled() {
  const GameCommunityUpsellMultiExperiment = require(12700) /* GAME_COMMUNITY_UPSELL_MULTI_EXPERIMENT */.GameCommunityUpsellMultiExperiment;
