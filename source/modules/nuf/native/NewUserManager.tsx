...
// Dependencies: [5, 7, 6, 15, 17, 18, 9124, 4813, 1850, 6638, 11731, 653, 11756, 16172, 11702, 11730, 668, 8286, 686, 11709, 11784, 5078, 2]
...
let items = [
  ...
  obj,
  {
    ...
    transitionToStep() {
      const result = require(11730) /* _startContactSyncForDiscoverability */.transitionToHubEmailConnectionModal(require(668) /* keys */.ModalAnimation.SLIDE_IN, true);
    }
  },
  {
    ...
    transitionToStep() {
      return require(11730) /* _startContactSyncForDiscoverability */.transitionToNUFGuildTemplatesModal(require(668) /* keys */.ModalAnimation.SLIDE_IN);
    }
  },
