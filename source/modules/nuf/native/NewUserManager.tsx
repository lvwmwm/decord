...
// Function ID: 16589
// Name: items
// Dependencies: [5, 8520, 5039, 1922, 5385, 12122, 676, 12136, 16589, 12093, 12121, 691, 9114, 709, 5301, 12100, 12163, 2]
...
const items = [
  ...
  obj,
  {
    ...
    transitionToStep() {
      const result = require(12121) /* _startContactSyncForDiscoverability */.transitionToHubEmailConnectionModal(require(691) /* keys */.ModalAnimation.SLIDE_IN, true);
    }
  },
  {
    ...
    transitionToStep() {
      return require(12121) /* _startContactSyncForDiscoverability */.transitionToNUFGuildTemplatesModal(require(691) /* keys */.ModalAnimation.SLIDE_IN);
    }
  },
