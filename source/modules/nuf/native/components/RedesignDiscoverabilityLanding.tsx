...
// Dependencies: [31, 27, 33, 4165, 689, 1557, 5118, 4161, 1212, 5119, 11828, 11746, 4578, 2]
// Exports: default

// Module 16243 (RedesignDiscoverabilityLanding)
import "result";
...
export default function RedesignDiscoverabilityLanding(onNext) {
  ...
  obj = { flexGrow: 2, paddingTop: require(5118) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT + 32, paddingBottom: importDefault(1557)().bottom + 16, paddingHorizontal: importDefault(689).space.PX_16 };
  ...
  const obj3 = { resizeMode: "contain", style: tmp.image, source: importDefault(11828) };
  items[3] = callback(importDefault(5119), obj3);
  ...
  items[4] = callback2(require(4161) /* Text */.Text, obj4);
  ...
  items[6] = callback(require(4578) /* Button */.Button, obj7);
  obj.children = items;
