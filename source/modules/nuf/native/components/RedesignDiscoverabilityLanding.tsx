...
// Dependencies: [19, 17, 21, 4344, 712, 1628, 5306, 4340, 1236, 5307, 12165, 12095, 4754, 2]
// Exports: default

// Module 16598 (RedesignDiscoverabilityLanding)
import "noop";
...
export default function RedesignDiscoverabilityLanding(onNext) {
  ...
  obj[1] = require(5306) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT + 32;
  ...
  obj3[2] = importDefault(12165);
  items[3] = callback(importDefault(5307), obj3);
  ...
  obj4[3] = items1;
  items[4] = callback2(require(4340) /* Text */.Text, obj4);
  ...
  items[6] = callback(require(4754) /* Button */.Button, obj7);
  obj[3] = items;
