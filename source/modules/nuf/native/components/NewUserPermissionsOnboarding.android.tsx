...
// Dependencies: [19, 17, 21, 4302, 5266, 712, 4298, 4712, 1236, 2]
// Exports: default

// Module 11976 (NewUserPermissionsOnboarding)
import "noop";
...
export default function NewUserPermissionsOnboarding(showSkip) {
  ...
  const items1 = [callback(require(4298) /* Text */.Text, { style: tmp.alertTitle, variant: "heading-lg/bold", color: "text-default", children: title }), callback(require(4298) /* Text */.Text, { style: tmp.alertSubtitle, variant: "text-sm/medium", color: "text-default", children: subtitle }), , ];
  ...
  obj6[3] = onAllow;
  obj6[4] = loading;
  obj5[1] = callback(require(4712) /* Button */.Button, obj6);
