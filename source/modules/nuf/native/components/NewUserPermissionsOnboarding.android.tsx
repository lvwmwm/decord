...
// Dependencies: [19, 17, 21, 4661, 6370, 712, 4734, 4745, 1236, 2]
// Exports: default
...
export default function NewUserPermissionsOnboarding(showSkip) {
  ...
  const items1 = [callback(require(4734) /* Text */.Text, { style: tmp.alertTitle, variant: "heading-lg/bold", color: "text-default", children: title }), callback(require(4734) /* Text */.Text, { style: tmp.alertSubtitle, variant: "text-sm/medium", color: "text-default", children: subtitle }), , ];
