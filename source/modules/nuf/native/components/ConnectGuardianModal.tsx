...
// Dependencies: [19, 17, 676, 6891, 21, 4255, 712, 1581, 16380, 698, 5717, 4251, 1236, 2255, 14005, 4665, 2]
// Exports: default

// Module 16379 (ConnectGuardianModal)
...
export default function ConnectGuardianModal(route) {
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj[0] = items1;
    obj[1] = callback(tmp4(5717).ActivityIndicator, {});
    ...
    items4[1] = callback(tmp4(14005).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    obj4[1] = items4;
    ...
    obj8[1] = callback(tmp4(4665).Button, obj10);
