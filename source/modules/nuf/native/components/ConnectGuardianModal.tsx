...
// Dependencies: [19, 17, 676, 7210, 21, 4444, 712, 1629, 16880, 698, 5995, 4440, 1236, 2369, 14409, 4879, 2]
// Exports: default

// Module 16879 (ConnectGuardianModal)
...
export default function ConnectGuardianModal(route) {
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj[0] = items1;
    obj[1] = callback(tmp4(5995).ActivityIndicator, {});
    ...
    const items2 = [callback(tmp4(4440).Text, obj2), ];
    ...
    items2[1] = callback(tmp4(4440).Text, obj3);
    obj1[1] = items2;
    ...
    const items4 = [callback(tmp4(4440).Text, obj5), ];
    ({ linkCode: obj9[1], expiresAt: obj9[2], refresh: obj9[3] } = connectGuardianGate);
    items4[1] = callback(tmp4(14409).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    obj4[1] = items4;
    ...
    obj8[1] = callback(tmp4(4879).Button, obj10);
