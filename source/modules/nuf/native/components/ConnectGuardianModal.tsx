...
// Dependencies: [19, 17, 673, 7471, 21, 4481, 709, 1627, 17375, 695, 5532, 4477, 1233, 2368, 14806, 4936, 2]
// Exports: default

// Module 17374 (ConnectGuardianModal)
import ThemesDefault from "Themes" /* 709 */;
import closure_3 from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import { AnalyticEvents } from "ME" /* 673 */;
import { FamilyCenterAction } from "items" /* 7471 */;
...
export default function ConnectGuardianModal(route) {
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj[0] = items1;
    obj[1] = callback(tmp4(5532).ActivityIndicator, {});
    ...
    obj2[3] = intl.string(tmp2(2368).ITlV6p);
    ...
    obj3[3] = intl2.format(tmp2(2368).F4GT2S, { link: "https://support.discord.com/hc/articles/14155060633623" });
    ...
    const items4 = [callback(tmp4(4477).Text, obj5), ];
    ({ linkCode: obj9[1], expiresAt: obj9[2], refresh: obj9[3] } = connectGuardianGate);
    items4[1] = callback(tmp4(14806).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
    obj4[1] = items4;
    ...
    obj9[0] = connectGuardianGate(1627)().bottom + tmp2(709).space.PX_16;
    items5[1] = obj9;
    obj8[0] = items5;
    const obj10 = { variant: "primary", size: "lg", text: null, onPress: null };
    const intl4 = tmp4(1233).intl;
    obj10[2] = intl4.string(tmp4(1233).t["3PatSz"]);
    ...
    obj8[1] = callback(tmp4(4936).Button, obj10);
