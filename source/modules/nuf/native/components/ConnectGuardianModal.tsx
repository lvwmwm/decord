...
// Dependencies: [19, 17, 676, 7039, 21, 4344, 712, 1628, 16600, 698, 5862, 4340, 1236, 2303, 14193, 4754, 2]
// Exports: default

// Module 16599 (ConnectGuardianModal)
...
export default function ConnectGuardianModal(route) {
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj[0] = items1;
    obj[1] = callback(tmp4(5862).ActivityIndicator, {});
    ...
    const items4 = [callback(tmp4(4340).Text, obj5), ];
    ...
    obj8[1] = callback(tmp4(4754).Button, obj10);
