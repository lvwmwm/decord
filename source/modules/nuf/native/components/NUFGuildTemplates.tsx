...
// Function ID: 12061
// Name: onCreateGuild
// Dependencies: [5, 19, 17, 4128, 676, 12061, 8507, 21, 5232, 11834, 9551, 12062, 12098, 698, 503, 5270, 12037, 1222, 12064, 12066, 11704, 1236, 12069, 12070, 12099, 12081, 5783, 2]
// Exports: default

// Module 12060 (onCreateGuild)
...
export default function NUFGuildTemplates() {
  ...
  return jsx(require(5783) /* NavigationStack */.Navigator, { screens: null, onWillFocus: null, headerBackTitle: null, initialRouteName: null });
};
