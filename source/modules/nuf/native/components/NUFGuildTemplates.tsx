...
// Function ID: 11798
// Name: onCreateGuild
// Dependencies: [5, 19, 17, 4010, 676, 11798, 9223, 21, 5105, 11566, 10926, 11799, 11847, 698, 503, 5143, 11774, 1222, 11801, 11803, 10085, 1236, 11811, 11812, 11848, 11829, 5570, 2]
// Exports: default

// Module 11797 (onCreateGuild)
      ...
      if (c4 === 2) {
        ...
        try {
          ...
          if (0 === c3) {
            ...
            const guildProgress = callback(11566).createGuildProgress(callback);
            callback2(10926)();
            const obj6 = callback(11566);
            const result = callback2(11799).closeCreateGuildOnboardingModal();
            const obj7 = callback2(11799);
            const result1 = callback(11847).showInstantInviteModal(callback);
            const obj8 = callback(11847);
...
export default function NUFGuildTemplates() {
  ...
  obj[0] = React.useMemo(() => {
    ...
    obj[4] = obj2.getHeaderCloseButton(() => {
      callback(11774).trackNUFStep(constants2.STEP_GUILD_TEMPLATE, constants2.STEP_FRIEND_LIST, { skip: true });
      const obj = callback(11774);
      callback(1222).transitionTo(fallbackRoute.fallbackRoute);
      const obj2 = callback(1222);
      const result = callback2(11799).closeCreateGuildOnboardingModal();
    });
    obj[5] = function render() {
      return callback3(callback2(11801), { trigger: constants.NUF });
    };
    ...
    obj = {
      ...
      render(guildTemplate) {
        return callback3(callback2(11803), { guildTemplate: guildTemplate.guildTemplate, trigger: constants.NUF });
      }
    };
    ...
    obj[constants.CREATE_SERVER] = {
      ...
      render(arg0, arg1) {
        ...
        return callback3(callback2(10085), obj);
      }
    };
    obj2 = {
      ...
      render() {
        ...
        obj[1] = callback2(11799).closeCreateGuildModal;
        return callback3(callback2(11811), obj);
      }
    };
    ...
    obj[constants.ACCEPT_INVITE] = {
      ...
      render(code) {
        ...
        obj[1] = callback2(11799).closeCreateGuildModal;
        return callback3(callback2(11812), obj);
      }
    };
    const obj3 = {
      impressionName: callback(503).ImpressionNames.GUILD_ADD_ACCEPT_INVITE,
    ...
    obj[constants.CHANNEL_PROMPT] = {
      ...
      render(guildId) {
        ...
        return callback3(callback2(11848), obj);
      }
    };
    ...
    obj5[6] = function render() {
      return callback3(callback2(11829), { isNestedNavigator: true });
    };
  ...
  return jsx(require(5570) /* NavigationStack */.Navigator, { screens: null, onWillFocus: null, headerBackTitle: null, initialRouteName: null });
};
