...
// Dependencies: [5, 17, 4122, 1215, 1386, 4709, 12341, 12342, 673, 4738, 4448, 17377, 2008, 500, 4074, 12344, 10014, 695, 1234, 7058, 15405, 688, 2]

// Module 17376 (haveNotSeenPromptSince)
import hooksDefault from "hooks" /* 4074 */;
import initializeDefault from "initialize" /* 7058 */;
import getOrRefreshPushSyncToken from "getOrRefreshPushSyncToken" /* 12344 */;
...
import closure_9 from "set" /* 12341 */;
import { PermissionPromptType } from "set" /* 12341 */;
import EventActionType from "EventActionType" /* 12342 */;
import ME from "ME" /* 673 */;
import { NotificationAuthorizationStatus as closure_16 } from "NativePermissionStatus" /* 4738 */;
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          callback = arg1;
          callback2 = callback(10014).allowInAppNotifications();
          const obj5 = callback(10014);
