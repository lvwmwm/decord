...
// Dependencies: [32, 5, 19, 17, 11836, 11837, 676, 4557, 10748, 698, 11839, 11845, 11846, 589, 2]
...
// Module 11838 (_requestPushNotificationPermission)
...
export const useCanSeePushNotificationNudge = function useCanSeePushNotificationNudge() {
  let require;
  let tmp4;
  const isTeenInStrictCountry = require(11846) /* set */.useIsTeenInStrictCountry();
  const obj = require(11846) /* set */;
  const items = [set];
