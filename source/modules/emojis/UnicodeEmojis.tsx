...
// Dependencies: [4104, 4105, 4106, 4107, 12, 13656, 2]
// Exports: asUnicodeEmoji

// Module 4103 (parseRawEmojiObject)
import applyDefault from "apply" /* 12 */;
import EmojiTypes from "EmojiTypes" /* 4106 */;
import _mod13656 from "module_13656" /* 13656 */;
import closure_3 from "defaultImageSrcGenerator" /* 4104 */;
...
function findInlineEmojisFromSurrogates(content, arg1) {
      ...
      if (null != ``) {
        if ("" !== ``) {
          ...
          if (tmp3 === closure_13) {
            ...
            let tmp18 = require(4105).surrogateToEmoji[`${tmp3}`];
            let tmp19 = null;
            if (null != tmp18) {
              tmp19 = tmp16(4105).emojis[tmp18];
            }
            let first;
            if (tmp19 != null) {
              first = tmp19.names[0];
            ...
            if (regex2.test(tmp3)) {
              ...
              let tmp12 = require(4105).surrogateToEmoji[str];
              let tmp13 = null;
              if (null != tmp12) {
                tmp13 = tmp10(4105).emojis[tmp12];
              }
              let first1;
              if (tmp13 != null) {
  ...
  if (!tmp23) {
    ...
    const tmp26 = require(4105).surrogateToEmoji[str2];
    let tmp27 = null;
    if (null != tmp26) {
      tmp27 = tmp24(4105).emojis[tmp26];
    }
    let first2;
    if (tmp27 != null) {
  ...
  constructor(arg0) {
    ...
    if (null != global.diversityChildren) {
      ...
      while (tmp15 !== undefined) {
        tmp5 = closure_0;
        tmp6 = closure_2;
        tmp7 = require("module_4105").emojis[tmp3];
        tmp8 = tmp7;
...
Object.defineProperty(prototype, "url", {
  get: function url() {
    ...
    if (null != defaultDiversityChild) {
      let uRL = importDefault(4107).getURL(defaultDiversityChild.surrogates);
      const obj2 = importDefault(4107);
    } else {
      uRL = importDefault(4107).getURL(tmp.surrogates);
      const obj = importDefault(4107);
    }
    return uRL;
  },
  set: undefined
...
Object.defineProperty(prototype, "name", {
  get: function name() {
    ...
    if (this.hasDiversity) {
      if (null != c4) {
        const tmp6 = require(4105).surrogateToEmoji[c4];
        let tmp7 = null;
        if (null != tmp6) {
          tmp7 = tmp4(4105).emojis[tmp6];
        }
        let first;
        if (tmp7 != null) {
          first = tmp7.names[0];
...
let obj = {
  ...
  getCategories() {
    return Object.keys(require(4105).emojisByCategory);
  },
  getByName(arg0) {
    const tmp3 = require(4105).nameToEmoji[arg0];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require(4105).emojis[tmp3];
    }
    let tmp5 = null;
    if (null != tmp4) {
  ...
  getByCategory(name) {
    ...
    if (null == value) {
      const tmp4 = require(4105).emojisByCategory[name];
      const emojis = require(4105).emojis;
      const result = importDefault(4107).filterUnsupportedEmojis(emojis.slice(tmp4[0], tmp4[1]));
  ...
  convertNameToSurrogate(emojiName) {
    ...
    const tmp3 = require(4105).nameToEmoji[emojiName];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require(4105).emojis[tmp3];
    }
  ...
  convertSurrogateToName(name, arg1) {
    ...
    const tmp3 = require(4105).surrogateToEmoji[name];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require(4105).emojis[tmp3];
    }
  ...
  convertSurrogateToBase(surrogates) {
    ...
    const tmp4 = require(4105).surrogateToEmoji[reduced];
    let tmp5 = null;
    if (null != tmp4) {
      tmp5 = tmp2(4105).emojis[tmp4];
    }
    let str;
    if (tmp5 != null) {
      str = tmp5.names[0];
    ...
    const tmp6 = require(4105).nameToEmoji[str];
    let tmp7 = null;
    if (null != tmp6) {
      tmp7 = tmp2(4105).emojis[tmp6];
    }
    let tmp8 = null;
    if (null != tmp7) {
  ...
  numDiversitySprites: require("module_4105").numDiversitySprites,
  numNonDiversitySprites: require("module_4105").numNonDiversitySprites,
