...
// Dependencies: [4223, 4224, 689, 7530, 2]
...
function buildPlatformedThemedEmojiColorPalette(shouldProcessMobileColors) {
  ...
  return importDefault(7530).applyPlatformToThemedEmojiColorPalette({ palette, shouldProcessMobileColors });
}
let c3 = "#ffffff";
let c4 = "#36393e";
