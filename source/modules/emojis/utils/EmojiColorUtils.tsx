...
// Dependencies: [4151, 4152, 689, 7242, 2]
// Exports: buildEmojiColorPalette

// Module 8066 (buildPlatformedThemedEmojiColorPalette)
function buildPlatformedThemedEmojiColorPalette(shouldProcessMobileColors) {
  ...
  return importDefault(7242).applyPlatformToThemedEmojiColorPalette({ palette, shouldProcessMobileColors });
}
let c3 = "#ffffff";
let c4 = "#36393e";
