...
// Dependencies: [19, 17, 14943, 21, 4255, 712, 4251, 4665, 4223, 4797, 5255, 4245, 5631, 2]
// Exports: default

// Module 14947 (ScreenRecordingActionSheet)
import "noop";
...
export default function ScreenRecordingActionSheet() {
  ...
  items[2] = callback(_require(4665).Button, obj);
  obj[1] = items;
  ...
  obj2[3] = callback(_require(5255).XSmallIcon, { size: "md", color: "text-default" });
  const items1 = [callback(_require(4797).PressableOpacity, obj2), callback(_require(4251).Text, { variant: "heading-xl/bold", children: tmp5.title }), , ];
  ...
  obj5[1] = callback(_require(4665).Button, {
    disabled: tmp12,
    text: "Next",
    loading: tmp2,
    onPress() {
