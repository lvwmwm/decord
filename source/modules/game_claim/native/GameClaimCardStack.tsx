...
// Dependencies: [19, 17, 21, 712, 689, 4303, 9438, 2]
// Exports: default

// Module 15330 (importDefaultResult1)
import "noop";
...
export default function GameClaimCardStack(uri) {
  ...
  obj1[1] = callback(closure_3, { style: tmp.addIconWrapper, children: callback(require(9438) /* PlusSmallIcon */.PlusSmallIcon, { size: "sm", color: "text-brand" }) });
