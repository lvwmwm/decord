...
// Dependencies: [19, 17, 21, 712, 689, 4302, 9367, 2]
// Exports: default

// Module 15237 (importDefaultResult1)
import "noop";
...
export default function GameClaimCardStack(uri) {
  ...
  obj1[1] = callback(closure_3, { style: tmp.addIconWrapper, children: callback(require(9367) /* PlusSmallIcon */.PlusSmallIcon, { size: "sm", color: "text-brand" }) });
