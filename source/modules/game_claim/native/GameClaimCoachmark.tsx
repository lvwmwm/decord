...
// Function ID: 15161
// Name: PX_8
// Dependencies: [5, 19, 17, 676, 1369, 21, 712, 15161, 9911, 4604, 4189, 15162, 12063, 1236, 5222, 4717, 5175, 4185, 4600, 7622, 11814, 2]
...
const memoResult = importAllResult.memo((arg0) => {
  ...
  const tmp = callback4();
  let obj = require(15162) /* fetchUnclaimedGames */;
  ...
  const tmp6 = importDefault(12063);
  const coverImageUrl = importDefault(12063)(first, intl.string(require(1236) /* getSystemLocale */.t.VQq92a)).coverImageUrl;
  if (null == coverImageUrl) {
    ...
    items[1] = callback2(tmp5(15161), obj1);
    ...
    obj6[3] = callback2(tmp2(7622).LinkExternalSmallIcon, { size: "xs", color: "white" });
  ...
  const tmp6Result = importDefault(12063)(first, intl.string(require(1236) /* getSystemLocale */.t.VQq92a));
});
...
export const getScaledGameClaimNoticeHeight = function getScaledGameClaimNoticeHeight(fontScale) {
  ...
  const sum1 = sum + require(15161) /* importDefaultResult1 */.CARD_STACK_HEIGHT;
  const sum2 = sum1 + require(9911) /* map */.scaleTextLineHeight("text-md/medium", fontScale);
  const sum3 = sum2 + importDefault(712).space.PX_4;
  const obj = require(9911) /* map */;
  const result = 2 * require(9911) /* map */.scaleTextLineHeight("text-sm/normal", fontScale);
