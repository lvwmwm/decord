...
// Function ID: 15175
// Name: PX_8
// Dependencies: [5, 19, 17, 676, 1369, 21, 712, 15175, 9341, 4669, 4255, 15176, 12229, 1236, 5302, 4797, 5255, 4251, 4665, 7737, 5825, 2]
...
const memoResult = importAllResult.memo((arg0) => {
  ...
  const tmp = callback4();
  let obj = require(15176) /* fetchUnclaimedGames */;
  ...
  const tmp6 = importDefault(12229);
  const coverImageUrl = importDefault(12229)(first, intl.string(require(1236) /* getSystemLocale */.t.VQq92a)).coverImageUrl;
  ...
  const tmp6Result = importDefault(12229)(first, intl.string(require(1236) /* getSystemLocale */.t.VQq92a));
});
...
export const getScaledGameClaimNoticeHeight = function getScaledGameClaimNoticeHeight(fontScale) {
  ...
  const sum1 = sum + require(15175) /* importDefaultResult1 */.CARD_STACK_HEIGHT;
  const sum2 = sum1 + require(9341) /* map */.scaleTextLineHeight("text-md/medium", fontScale);
  const sum3 = sum2 + importDefault(712).space.PX_4;
  const obj = require(9341) /* map */;
  const result = 2 * require(9341) /* map */.scaleTextLineHeight("text-sm/normal", fontScale);
  const sum4 = sum3 + result + importDefault(712).space.PX_8;
  return sum4 + require(4669) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_HEIGHT + PX_82;
};
