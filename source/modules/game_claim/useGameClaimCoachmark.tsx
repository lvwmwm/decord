...
// Dependencies: [3817, 676, 15229, 589, 15162, 2]
// Exports: useCanShowGameClaimCoachmark

// Module 15228 (useCanShowGameClaimCoachmark)
...
export const useCanShowGameClaimCoachmark = function useCanShowGameClaimCoachmark(id) {
  const _require = id;
  let gameClaimCoachmarkEnabled = _require(15229).useGameClaimCoachmarkEnabled(id, "useCanShowGameClaimCoachmark");
  const obj = _require(15229);
  const tmp = _require;
