...
// Dependencies: [3948, 676, 15404, 589, 15331, 2]
// Exports: useCanShowGameClaimCoachmark

// Module 15403 (useCanShowGameClaimCoachmark)
...
export const useCanShowGameClaimCoachmark = function useCanShowGameClaimCoachmark(id) {
  const _require = id;
  let gameClaimCoachmarkEnabled = _require(15404).useGameClaimCoachmarkEnabled(id, "useCanShowGameClaimCoachmark");
  const obj = _require(15404);
  const tmp = _require;
