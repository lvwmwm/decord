...
// Function ID: 10604
// Name: sum
// Dependencies: [4332, 676, 5378, 10604, 10607, 10214, 589, 2]
// Exports: default
...
export default function useActionBarHeight(id) {
  const isFiveButtonLayout = require(10607) /* useIsFiveButtonLayout */.useIsFiveButtonLayout(id);
  const obj = require(10607) /* useIsFiveButtonLayout */;
  const tmp2 = importDefault(10214)(id);
