...
// Function ID: 10726
// Name: sum
// Dependencies: [4392, 676, 5437, 10726, 10729, 10343, 589, 2]
// Exports: default
...
export default function useActionBarHeight(id) {
  const isFiveButtonLayout = require(10729) /* useIsFiveButtonLayout */.useIsFiveButtonLayout(id);
  const obj = require(10729) /* useIsFiveButtonLayout */;
  const tmp2 = importDefault(10343)(id);
