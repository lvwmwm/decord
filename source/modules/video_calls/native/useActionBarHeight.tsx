...
// Function ID: 10601
// Name: sum
// Dependencies: [4349, 676, 5397, 10601, 10604, 10230, 589, 2]
// Exports: default
...
export default function useActionBarHeight(id) {
  const isFiveButtonLayout = require(10604) /* useIsFiveButtonLayout */.useIsFiveButtonLayout(id);
  const obj = require(10604) /* useIsFiveButtonLayout */;
  const tmp2 = importDefault(10230)(id);
