...
// Dependencies: [19, 3977, 4299, 9657, 21, 589, 9659, 10591, 500, 4221, 7669, 10592, 2]
// Exports: default

// Module 10590 (useRevealProviderValue)
...
function useRevealProviderValue(arg0, channel) {
  ...
  const tmp2 = require;
  const tmp5 = importDefault(9659)(channel);
  ...
  require = tmp;
  const tmp8 = importDefault(10591)(channel.id);
