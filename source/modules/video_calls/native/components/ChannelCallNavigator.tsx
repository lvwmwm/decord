...
// Dependencies: [5, 32, 19, 17, 10798, 10389, 676, 10799, 21, 4255, 1474, 10393, 4116, 10800, 10387, 10392, 4469, 4461, 10173, 1959, 1231, 10857, 10188, 4102, 10813, 500, 3967, 4136, 5636, 2]
// Exports: default

// Module 10797 (CallWithVoiceChat)
...
function CallWithVoiceChat(channel) {
  ...
  if (channel.isGuildStageVoice()) {
    ...
    obj3[0] = channel;
    tmp16 = callback2(tmp2(10800), obj3);
  }
  const items1 = [tmp16, ];
  ...
  if (tmp11[0]) {
    ...
    obj5[0] = channel;
    tmp18Result = tmp18(tmp2(10387), obj5);
  }
  obj4[1] = tmp18Result;
...
function MainCallScreen(channel) {
  ...
  let id;
  let obj = isConnectedToVoiceChannel(10392);
  ...
  let obj1 = isConnectedToVoiceChannel(4469);
  ...
  if (isChannelContentGated) {
    ...
    if (channel.isGuildStageVoice()) {
      ...
      obj2[0] = channel;
      tmp14Result = tmp14(id(10800), obj2);
    }
    obj1[1] = tmp14Result;
...
export default function ChannelCallNavigator(channel) {
  ...
  obj = { value: guild_id, children: tmp2(channel(5636).Navigator, { screens: { [ChannelCallScreens.MAIN_CALL_SCREEN]: obj }, initialRouteName: ChannelCallScreens.MAIN_CALL_SCREEN }) };
  obj = {
    headerShown: false,
    ignoreKeyboard: true,
