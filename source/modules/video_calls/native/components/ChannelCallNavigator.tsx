...
// Dependencies: [5, 32, 19, 17, 10755, 9739, 676, 10620, 21, 4303, 1474, 9747, 4036, 10756, 9737, 9742, 4517, 4509, 10624, 1988, 1231, 10814, 10957, 4154, 10770, 500, 4013, 4184, 5783, 2]
// Exports: default

// Module 10754 (CallWithVoiceChat)
...
function CallWithVoiceChat(channel) {
  ...
  if (channel.isGuildStageVoice()) {
    ...
    obj3[0] = channel;
    tmp16 = callback2(tmp2(10756), obj3);
  }
  const items1 = [tmp16, ];
  ...
  if (tmp11[0]) {
    ...
    obj5[0] = channel;
    tmp18Result = tmp18(tmp2(9737), obj5);
  }
  obj4[1] = tmp18Result;
...
function MainCallScreen(channel) {
  ...
  let id;
  let obj = isConnectedToVoiceChannel(9742);
  ...
  if (isChannelContentGated) {
    ...
    if (channel.isGuildStageVoice()) {
      ...
      obj2[0] = channel;
      tmp14Result = tmp14(id(10756), obj2);
    }
    obj1[1] = tmp14Result;
