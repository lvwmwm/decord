...
// Dependencies: [32, 19, 17, 8669, 8670, 676, 21, 500, 4661, 712, 6782, 1297, 1629, 4115, 12502, 691, 1236, 7124, 4196, 1377, 4664, 6377, 10202, 1494, 8695, 1231, 4104, 4725, 1363, 10544, 2]
// Exports: default

// Module 12501 (FocusedControlsExpanded)
...
function FocusedControlsBottomDrawerTooltip(positionY) {
  ...
  if (canShowTooltip) {
    ...
    tmp7 = callback2(importDefault(4115).View, obj);
  }
  return tmp7;
}
function FocusedControlsAboveActionBarView(positionY) {
  ...
  const animatedStyle = obj.useAnimatedStyle(fn);
  const items = [callback2(FocusedControlsBottomDrawerTooltip, { positionY }), callback2(positionY(7124).ActionSheetHeaderBar, {}), ];
...
class FocusedControlsBottomDrawer {
  constructor(arg0) {
    ...
    callback1 = onClose.useCallback(() => {
      ...
      const result = first1.set(require(4664) /* CONFIG_NEVER_ANIMATE_TIMING */.withTiming(num, obj3));
      if (tmp) {
        outer2_9();
        callback();
      } else {
    ...
    obj = { runOnJS: require("module_4115").runOnJS, clearFocusTimer: Math, drawerOpen: sharedValue2, positionY: sharedValue, CLOSE_DRAWER_POSITION: 0, velocity: sharedValue3, startY: sharedValue1 };
    M.__closure = obj;
...
export default function FocusedControlsBottomControls(omitPTT) {
  ...
  if (!flag) {
    ...
    obj[0] = _require(10544).CallPTTButtonLooks.BLUR;
    obj[1] = tmp.ptbButton;
    obj[2] = closure_8;
    obj[3] = closure_9;
    tmp4Result = tmp4(importDefault(10544), obj);
    const tmp11 = importDefault(10544);
  }
  items[2] = tmp4Result;
  obj[1] = items;
