...
// Dependencies: [32, 19, 17, 9626, 9627, 676, 21, 500, 4255, 712, 5189, 1297, 1581, 4116, 10644, 691, 1236, 5579, 4071, 1358, 4256, 5353, 9828, 1474, 10550, 1231, 3967, 4655, 4101, 10200, 2]
// Exports: default

// Module 10643 (FocusedControlsExpanded)
...
function FocusedControlsAboveActionBarView(positionY) {
  ...
  const animatedStyle = obj.useAnimatedStyle(fn);
  const items = [callback2(FocusedControlsBottomDrawerTooltip, { positionY }), callback2(positionY(5579).ActionSheetHeaderBar, {}), ];
...
export default function FocusedControlsBottomControls(omitPTT) {
  ...
  if (!flag) {
    ...
    obj[0] = _require(10200).CallPTTButtonLooks.BLUR;
    obj[1] = tmp.ptbButton;
    obj[2] = closure_8;
    obj[3] = closure_9;
    tmp4Result = tmp4(importDefault(10200), obj);
    const tmp11 = importDefault(10200);
  }
  items[2] = tmp4Result;
  obj[1] = items;
