...
// Dependencies: [32, 19, 17, 9657, 9658, 676, 21, 500, 4285, 712, 5219, 1297, 1609, 4145, 10699, 691, 1236, 5633, 4100, 1358, 4286, 5407, 9859, 1474, 10605, 1231, 3996, 4685, 4130, 10231, 2]
// Exports: default

// Module 10698 (FocusedControlsExpanded)
...
function FocusedControlsBottomDrawerTooltip(positionY) {
  ...
  if (canShowTooltip) {
    ...
    tmp7 = callback2(importDefault(4145).View, obj);
  }
  return tmp7;
}
function FocusedControlsAboveActionBarView(positionY) {
  ...
  const animatedStyle = obj.useAnimatedStyle(fn);
  const items = [callback2(FocusedControlsBottomDrawerTooltip, { positionY }), callback2(positionY(5633).ActionSheetHeaderBar, {}), ];
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(offsetY(4145).View, obj2);
  }
  items[2] = tmp4Result;
  obj1[1] = items;
...
class FocusedControlsBottomDrawer {
  constructor(arg0) {
    ...
    bottom = first;
    isIOS = tmp22[1];
    tmp19Result = require("module_4145");
    sharedValue = require("_slicedToArray");
    Math = sharedValue;
    tmp19Result1 = require("module_4145");
    class O {
      constructor() {
        tmp = reveal;
        if (onDrawerClose) {
    ...
    c9 = derivedValue;
    tmp19Result2 = require("module_4145");
    sharedValue1 = require("_slicedToArray");
    height = sharedValue1;
    tmp19Result3 = require("module_4145");
    sharedValue2 = tmp19Result3.useSharedValue(false);
    c11 = sharedValue2;
    tmp19Result4 = require("module_4145");
    ...
    obj = { runOnJS: require("module_4145").runOnJS, clearFocusTimer: Math, drawerOpen: sharedValue2, positionY: sharedValue, CLOSE_DRAWER_POSITION: 0, velocity: sharedValue3, startY: sharedValue1 };
    M.__closure = obj;
    ...
    tmp33 = tmp31[2];
    c9 = tmp33;
    tmp19Result5 = require("module_4145");
    fn = function f() {
      let num = 0;
      if (!reveal) {
        num = first;
    ...
    tmp19Result6 = require("module_4145");
    class Z {
      constructor() {
    ...
    obj5[1] = items8;
    obj4[1] = tmp41(require("module_4145").View, obj5);
    obj3[2] = tmp40(require("Directions").GestureDetector, obj4);
    return tmp40(require("module_4145").View, obj3);
  }
}
...
export default function FocusedControlsBottomControls(omitPTT) {
  ...
  if (!flag) {
    ...
    obj[0] = _require(10231).CallPTTButtonLooks.BLUR;
    obj[1] = tmp.ptbButton;
    obj[2] = closure_8;
    obj[3] = closure_9;
    tmp4Result = tmp4(importDefault(10231), obj);
    const tmp11 = importDefault(10231);
  }
  items[2] = tmp4Result;
  obj[1] = items;
