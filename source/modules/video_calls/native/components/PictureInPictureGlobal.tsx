...
// Dependencies: [32, 19, 17, 1371, 4202, 9310, 1218, 4236, 676, 4207, 21, 4189, 1297, 712, 10522, 589, 10511, 10510, 4399, 10521, 4720, 10524, 8167, 10540, 10544, 10554, 10570, 10601, 10506, 10541, 10520, 10253, 4050, 4190, 5140, 15737, 1581, 2]
// Exports: default

// Module 15736 (PictureInPictureGlobal)
...
let closure_20 = importAllResult.memo((channel) => {
  ...
  return callback3(importDefault(10520), obj);
});
