...
// Module 15476 (PictureInPictureGlobal)
...
let obj = { container: { externalPipEnabled: true, selectedStreamId: true, focusedStreamId: true } };
...
export default function PictureInPictureGlobal(channel) {
  ...
  const fn2 = function o() {
    ...
    obj.marginTop = num(derivedValue[32]).interpolate(value, [77601039, 1612144654], items);
    ...
    obj.marginBottom = num(derivedValue[32]).interpolate(value, [77601039, 1612144654], items1);
    return obj;
  };
