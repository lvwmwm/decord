...
// Dependencies: [1390, 4778, 1218, 4485, 4549, 8724, 589, 4782, 8708, 2]
// Exports: useShouldForcePipOrientation

// Module 8723 (useShouldForcePipOrientation)
import usePipVideoOrStreamDefault from "usePipVideoOrStream" /* 8724 */;
