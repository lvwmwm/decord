...
// Function ID: 10737
// Name: VideoButton
// Dependencies: [19, 17, 1371, 4202, 4203, 4208, 1218, 4236, 10514, 4207, 21, 4189, 10523, 10737, 589, 8833, 5007, 10738, 8827, 10532, 10524, 1236, 10740, 10741, 10235, 10757, 10758, 4383, 4369, 4253, 10605, 10759, 6047, 9051, 5515, 5535, 10527, 10760, 10792, 10802, 2]
// Exports: default, useActionBarPrimaryButton, useActionBarSecondButtons

// Module 10736 (VideoButton)
...
class DisconnectStreamButton {
  constructor(arg0) {
    ...
    items[0] = View;
    items[1] = View;
    f85480 = obj.useStateFromStores(items, () => {
...
function LeaveActivityButton(isSmallSize) {
  ...
  obj[2] = importDefault(10759);
  obj[3] = isSmallSize.isSmallSize;
  return callback(importAll(10524).PrimaryActionButton, obj);
}
function useActionBarSecondButton(channel) {
  channel = channel.channel;
  let obj = require(10235) /* useIsConnectedToVoiceChannel */;
  ...
  if (isActive) {
    isActive = importDefault(10741)(channel).isActive;
  }
...
export default function ChannelCallActionBar(arg0) {
  ...
  const tmp4 = importDefault(6047)();
  let obj = require(10527) /* useIsFiveButtonLayout */;
  const isFiveButtonLayout = obj.useIsFiveButtonLayout(channel.id);
  obj = { value: importDefault(5515)(tmp2(5535).CHANNEL_CALL_ACTION_BAR).analyticsLocations, children: null };
  ...
  if (shouldShowConnectingScreen) {
    ...
    obj1[0] = channel;
    let tmp13Result = tmp11(tmp9(10760).CallConnectingActionBar, obj1);
  } else {
    ...
    items[2] = tmp11(tmp9(10792).ChannelCallMicButton, obj5);
    if (tmp7.END_REMOTE === END_REMOTE) {
      const obj6 = { channel: null, isSmallSize: null };
      obj6[0] = channel;
      obj6[1] = isFiveButtonLayout;
      let tmp11Result2 = tmp11(tmp9(10802).DisconnectRemoteButton, obj6);
  ...
  return closure_14(require(5515) /* context */.AnalyticsLocationProvider, obj);
};
export { VideoButton };
