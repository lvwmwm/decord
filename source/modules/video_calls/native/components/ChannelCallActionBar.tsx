...
// Function ID: 10741
// Name: VideoButton
// Dependencies: [19, 17, 1371, 4202, 4203, 4208, 1218, 4236, 10518, 4207, 21, 4189, 10527, 10741, 589, 8837, 5007, 10742, 8831, 10536, 10528, 1236, 10744, 10745, 10239, 10761, 10762, 4383, 4369, 4253, 10609, 10763, 6049, 9055, 5515, 5535, 10531, 10764, 10796, 10806, 2]
// Exports: default, useActionBarPrimaryButton, useActionBarSecondButtons

// Module 10740 (VideoButton)
...
class DisconnectStreamButton {
  constructor(arg0) {
    ...
    items[0] = View;
    items[1] = View;
    f85458 = obj.useStateFromStores(items, () => {
...
function LeaveActivityButton(isSmallSize) {
  ...
  obj[2] = importDefault(10763);
  obj[3] = isSmallSize.isSmallSize;
  return callback(importAll(10528).PrimaryActionButton, obj);
}
function useActionBarSecondButton(channel) {
  channel = channel.channel;
  let obj = require(10239) /* useIsConnectedToVoiceChannel */;
  ...
  if (isActive) {
    isActive = importDefault(10745)(channel).isActive;
  }
...
export default function ChannelCallActionBar(arg0) {
  ...
  const tmp4 = importDefault(6049)();
  let obj = require(10531) /* useIsFiveButtonLayout */;
  ...
  if (shouldShowConnectingScreen) {
    ...
    obj1[0] = channel;
    let tmp13Result = tmp11(tmp9(10764).CallConnectingActionBar, obj1);
  } else {
    ...
    items[2] = tmp11(tmp9(10796).ChannelCallMicButton, obj5);
    if (tmp7.END_REMOTE === END_REMOTE) {
      const obj6 = { channel: null, isSmallSize: null };
      obj6[0] = channel;
      obj6[1] = isFiveButtonLayout;
      let tmp11Result2 = tmp11(tmp9(10806).DisconnectRemoteButton, obj6);
