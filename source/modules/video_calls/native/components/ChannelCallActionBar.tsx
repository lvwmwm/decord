...
// Function ID: 10821
// Name: VideoButton
// Dependencies: [19, 17, 1371, 4316, 4317, 4322, 1218, 4351, 10658, 4321, 21, 4303, 10667, 10821, 589, 9154, 5135, 10822, 9148, 10675, 10668, 1236, 10824, 10825, 9743, 10841, 10842, 4497, 4483, 4367, 10601, 10843, 5891, 10844, 5728, 5748, 10671, 10845, 10869, 10895, 2]
// Exports: default, useActionBarPrimaryButton, useActionBarSecondButtons

// Module 10820 (VideoButton)
...
function useActionBarSecondButton(channel) {
  ...
  let obj = require(9743) /* useIsConnectedToVoiceChannel */;
  ...
  if (isActive) {
    isActive = importDefault(10825)(channel).isActive;
  }
...
export default function ChannelCallActionBar(arg0) {
  ...
  const tmp4 = importDefault(5891)();
  let obj = require(10671) /* useIsFiveButtonLayout */;
  const isFiveButtonLayout = obj.useIsFiveButtonLayout(channel.id);
  obj = { value: importDefault(5728)(tmp2(5748).CHANNEL_CALL_ACTION_BAR).analyticsLocations, children: null };
  ...
  return closure_14(require(5728) /* context */.AnalyticsLocationProvider, obj);
};
export { VideoButton };
