...
// Dependencies: [19, 17, 16195, 21, 4302, 1236, 4730, 4298, 8638, 2]
// Exports: default

// Module 16196 (HideSelfStreamAndVideoConfirmDialog)
import "noop";
...
export default function HideSelfStreamAndVideoConfirmDialog(arg0) {
  ...
  const items = [closure_5(tmp6(4298).Text, obj), ];
  const obj1 = {
  ...
  items[1] = closure_5(tmp6(4298).Text, obj1);
  obj[1] = items;
