...
// Dependencies: [19, 17, 16281, 21, 4303, 1236, 4732, 4299, 8698, 2]
// Exports: default

// Module 16282 (HideSelfStreamAndVideoConfirmDialog)
import "noop";
...
export default function HideSelfStreamAndVideoConfirmDialog(arg0) {
  ...
  const items = [closure_5(tmp6(4299).Text, obj), ];
  const obj1 = {
  ...
  items[1] = closure_5(tmp6(4299).Text, obj1);
  obj[1] = items;
