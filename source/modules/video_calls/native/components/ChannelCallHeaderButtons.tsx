...
// Function ID: 10915
// Name: CameraButton
// Dependencies: [19, 4351, 21, 589, 10801, 1236, 10915, 9155, 9740, 9741, 10916, 4497, 2]
// Exports: CameraButton, GridButton

// Module 10914 (CameraButton)
import "noop";
...
export const CameraButton = function CameraButton() {
  ...
  if (stateFromStoresObject.isVideoEnabled) {
    ...
    tmp4 = jsx(importDefault(10801), { accessibilityLabel: null, source: null, onPress: null, disableBackground: true });
    const tmp7 = importDefault(10801);
  }
  return tmp4;
};
export const GridButton = function GridButton(channel) {
  ...
  let tmp4 = null;
  if (null != importDefault(9741)(channel)) {
    tmp4 = null;
    if (!tmp3) {
