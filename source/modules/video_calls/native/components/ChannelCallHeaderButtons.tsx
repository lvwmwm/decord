...
// Function ID: 10906
// Name: CameraButton
// Dependencies: [19, 4393, 21, 589, 10792, 1236, 10906, 9219, 9802, 9803, 10907, 4570, 2]
// Exports: CameraButton, GridButton

// Module 10905 (CameraButton)
import "noop";
...
export const CameraButton = function CameraButton() {
  ...
  if (stateFromStoresObject.isVideoEnabled) {
    ...
    tmp4 = jsx(importDefault(10792), { accessibilityLabel: null, source: null, onPress: null, disableBackground: true });
    const tmp7 = importDefault(10792);
  }
  return tmp4;
};
export const GridButton = function GridButton(channel) {
  ...
  let tmp4 = null;
  if (null != importDefault(9803)(channel)) {
    tmp4 = null;
    if (!tmp3) {
