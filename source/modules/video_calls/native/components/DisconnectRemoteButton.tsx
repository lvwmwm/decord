...
// Dependencies: [19, 4317, 21, 589, 10668, 8027, 10841, 1236, 10879, 9148, 2]
// Exports: DisconnectRemoteButton

// Module 10895 (DisconnectRemoteButton)
import "noop";
import set from "set";
...
export const DisconnectRemoteButton = function DisconnectRemoteButton(channel) {
  ...
  obj[0] = remoteSessionId(stateFromStoresObject.awaitingRemote ? 8027 : 10841);
  ...
  return jsx(importAll(10668).PrimaryActionButton, { source: null, accessibilityLabel: null, isSmallSize: null, onPress: null });
};
