...
// Dependencies: [19, 4317, 21, 589, 10667, 8027, 10840, 1236, 10878, 9148, 2]
// Exports: DisconnectRemoteButton

// Module 10894 (DisconnectRemoteButton)
import "noop";
import set from "set";
...
export const DisconnectRemoteButton = function DisconnectRemoteButton(channel) {
  ...
  obj[0] = remoteSessionId(stateFromStoresObject.awaitingRemote ? 8027 : 10840);
  ...
  return jsx(importAll(10667).PrimaryActionButton, { source: null, accessibilityLabel: null, isSmallSize: null, onPress: null });
};
