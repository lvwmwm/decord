...
// Dependencies: [19, 4359, 21, 589, 10640, 8072, 10813, 1236, 10851, 9198, 2]
// Exports: DisconnectRemoteButton

// Module 10867 (DisconnectRemoteButton)
import "noop";
import set from "set";
...
export const DisconnectRemoteButton = function DisconnectRemoteButton(channel) {
  ...
  obj[0] = remoteSessionId(stateFromStoresObject.awaitingRemote ? 8072 : 10813);
  ...
  return jsx(importAll(10640).PrimaryActionButton, { source: null, accessibilityLabel: null, isSmallSize: null, onPress: null });
};
