...
// Dependencies: [19, 17, 4364, 1218, 676, 4406, 21, 4342, 712, 4191, 4338, 1297, 589, 10674, 10676, 1236, 4534, 10683, 10696, 10686, 10671, 5488, 4909, 10698, 2]
// Exports: default

// Module 10673 (StreamTextOverlay)
...
let closure_15 = importAllResult.memo((participant) => {
  ...
  const tmp5 = importDefault(10674)(MediaEngineContextTypes.STREAM, participant.user.id);
