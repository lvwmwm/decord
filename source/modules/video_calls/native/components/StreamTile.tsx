...
// Dependencies: [19, 17, 4364, 1218, 676, 4406, 21, 4342, 712, 4191, 4338, 1297, 589, 10658, 10660, 1236, 4534, 10667, 10680, 10670, 10655, 5467, 4887, 10682, 2]
// Exports: default

// Module 10657 (StreamTextOverlay)
...
let closure_15 = importAllResult.memo((participant) => {
  ...
  const tmp5 = importDefault(10658)(MediaEngineContextTypes.STREAM, participant.user.id);
