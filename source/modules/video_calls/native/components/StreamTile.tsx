...
// Dependencies: [19, 17, 4652, 1218, 676, 4529, 21, 4661, 712, 4223, 4734, 1297, 589, 12439, 12441, 1236, 4796, 12445, 12456, 12448, 12436, 6377, 5433, 12458, 2]
// Exports: default
...
let closure_15 = importAllResult.memo((participant) => {
  ...
  const tmp5 = importDefault(12439)(MediaEngineContextTypes.STREAM, participant.user.id);
