...
// Dependencies: [19, 17, 4364, 1218, 676, 4406, 21, 4342, 712, 4191, 4338, 1297, 589, 10656, 10658, 1236, 4534, 10665, 10678, 10668, 10653, 5467, 4887, 10680, 2]
// Exports: default

// Module 10655 (StreamTextOverlay)
...
let closure_15 = importAllResult.memo((participant) => {
  ...
  const tmp5 = importDefault(10656)(MediaEngineContextTypes.STREAM, participant.user.id);
