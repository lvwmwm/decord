...
// Dependencies: [19, 17, 4363, 1218, 676, 4405, 21, 4344, 712, 4193, 4340, 1297, 589, 10742, 10744, 1236, 4533, 10751, 10764, 10754, 10739, 5466, 4886, 10766, 2]
// Exports: default

// Module 10741 (StreamTextOverlay)
...
let closure_15 = importAllResult.memo((participant) => {
  ...
  const tmp5 = importDefault(10742)(MediaEngineContextTypes.STREAM, participant.user.id);
