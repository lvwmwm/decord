...
// Function ID: 9535
// Name: ResizeMode
// Dependencies: [32, 19, 17, 21, 4448, 9535, 9536, 9538, 1493, 500, 8571, 9543, 9544, 9546, 4187, 2]

// Module 9534 (ResizeMode)
...
const memoResult = importAllResult.memo((gestureEnabled) => {
  ...
  first(9536)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = first(9538)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  ...
  if (tmp17) {
    ...
    obj[1] = tmp2.spinner;
    tmp35 = callback(tmp18(9543), obj);
  }
  const tmp37 = store === resizeMode(8571).OrientationType.PORTRAIT;
  ...
  if (tmp3Result.isAndroid()) {
    ...
    obj4[3] = callback1;
    obj4[4] = memo2;
    const items11 = [callback(tmp18(9546), obj4), tmp35];
    obj2[2] = items11;
    obj1[4] = callback2(first2, obj2);
    const items12 = [callback(tmp18(9544), obj1), ];
    ...
    obj10[3] = callback1;
    obj10[4] = memo1;
    obj9[0] = callback(tmp18(9546), obj10);
    const items13 = [callback(tmp18(4187).View, obj9), ];
    let tmp48 = null;
    if (tmp37) {
    ...
    obj13[3] = callback1;
    obj13[4] = memo1;
    const items17 = [callback(tmp18(9546), obj13), tmp35];
    obj12[2] = items17;
