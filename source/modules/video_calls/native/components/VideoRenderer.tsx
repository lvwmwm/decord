...
// Function ID: 10752
// Name: ResizeMode
// Dependencies: [32, 19, 17, 21, 4344, 10752, 10753, 10755, 1493, 500, 8940, 10759, 10760, 10762, 4083, 2]

// Module 10751 (ResizeMode)
...
const memoResult = importAllResult.memo((gestureEnabled) => {
  ...
  first(10753)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = first(10755)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  ...
  if (tmp17) {
    ...
    obj[1] = tmp2.spinner;
    tmp35 = callback(tmp18(10759), obj);
  }
  const tmp37 = store === resizeMode(8940).OrientationType.PORTRAIT;
  ...
  if (tmp3Result.isAndroid()) {
    ...
    obj4[3] = callback1;
    obj4[4] = memo2;
    const items11 = [callback(tmp18(10762), obj4), tmp35];
    obj2[2] = items11;
    obj1[4] = callback2(first2, obj2);
    const items12 = [callback(tmp18(10760), obj1), ];
    ...
    obj10[3] = callback1;
    obj10[4] = memo1;
    obj9[0] = callback(tmp18(10762), obj10);
    ...
    obj13[3] = callback1;
    obj13[4] = memo1;
    const items17 = [callback(tmp18(10762), obj13), tmp35];
    obj12[2] = items17;
