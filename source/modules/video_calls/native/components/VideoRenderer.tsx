...
// Function ID: 9574
// Name: ResizeMode
// Dependencies: [32, 19, 17, 21, 4478, 9574, 9575, 9577, 1493, 500, 8603, 9582, 9583, 9585, 4217, 2]

// Module 9573 (ResizeMode)
...
const memoResult = importAllResult.memo((gestureEnabled) => {
  ...
  first(9575)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = first(9577)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  ...
  if (tmp17) {
    ...
    obj[1] = tmp2.spinner;
    tmp35 = callback(tmp18(9582), obj);
  }
  const tmp37 = store === resizeMode(8603).OrientationType.PORTRAIT;
  ...
  if (tmp3Result.isAndroid()) {
    ...
    obj13[3] = callback1;
    obj13[4] = memo1;
    const items17 = [callback(tmp18(9585), obj13), tmp35];
    obj12[2] = items17;
