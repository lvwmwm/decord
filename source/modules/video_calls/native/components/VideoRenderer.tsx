...
// Function ID: 9587
// Name: ResizeMode
// Dependencies: [32, 19, 17, 21, 4478, 9587, 9588, 9590, 1492, 1234, 8618, 9595, 9596, 9598, 4217, 2]

// Module 9586 (ResizeMode)
...
const memoResult = importAllResult.memo((gestureEnabled) => {
  ...
  first(9588)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = first(9590)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  ...
  if (tmp17) {
    ...
    obj[1] = tmp2.spinner;
    tmp35 = callback(tmp18(9595), obj);
  }
  const tmp37 = store === resizeMode(8618).OrientationType.PORTRAIT;
  ...
  if (tmp3Result.isAndroid()) {
    ...
    obj4[3] = callback1;
    obj4[4] = memo2;
    const items11 = [callback(tmp18(9598), obj4), tmp35];
    obj2[2] = items11;
    obj1[4] = callback2(first2, obj2);
    const items12 = [callback(tmp18(9596), obj1), ];
    ...
    obj10[3] = callback1;
    obj10[4] = memo1;
    obj9[0] = callback(tmp18(9598), obj10);
    ...
    obj13[3] = callback1;
    obj13[4] = memo1;
    const items17 = [callback(tmp18(9598), obj13), tmp35];
    obj12[2] = items17;
