...
// Function ID: 10699
// Name: ResizeMode
// Dependencies: [32, 19, 17, 21, 4303, 10699, 10700, 10702, 1493, 500, 8901, 10706, 10707, 10709, 4042, 2]

// Module 10698 (ResizeMode)
...
const memoResult = importAllResult.memo((gestureEnabled) => {
  ...
  first(10700)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = first(10702)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  ...
  if (tmp17) {
    ...
    obj[1] = tmp2.spinner;
    tmp35 = callback(tmp18(10706), obj);
  }
  const tmp37 = store === resizeMode(8901).OrientationType.PORTRAIT;
  ...
  if (tmp3Result.isAndroid()) {
    ...
    obj4[3] = callback1;
    obj4[4] = memo2;
    const items11 = [callback(tmp18(10709), obj4), tmp35];
    obj2[2] = items11;
    obj1[4] = callback2(first2, obj2);
    const items12 = [callback(tmp18(10707), obj1), ];
    ...
    obj10[3] = callback1;
    obj10[4] = memo1;
    obj9[0] = callback(tmp18(10709), obj10);
    const items13 = [callback(tmp18(4042).View, obj9), ];
    let tmp48 = null;
    if (tmp37) {
    ...
    obj13[3] = callback1;
    obj13[4] = memo1;
    const items17 = [callback(tmp18(10709), obj13), tmp35];
    obj12[2] = items17;
