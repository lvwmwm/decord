...
// Dependencies: [57, 31, 27, 33, 4165, 10531, 10532, 10534, 1450, 477, 8143, 10538, 10539, 10541, 4026, 2]

// Module 10530 (resetIOSScrollZoom)
...
const memoResult = importAllResult.memo((gestureEnabled) => {
  ...
  onReady = first(10534)(obj).onReady;
  ...
  if (tmp15) {
    ...
    tmp32 = callback(first(10538), obj1);
  }
  const tmp36 = store === resizeMode(8143).OrientationType.PORTRAIT;
  ...
  if (obj5.isAndroid()) {
    ...
    const items11 = [callback(first(10541), obj6), tmp32];
    obj4.children = items11;
    obj3.children = callback2(first2, obj4);
    const items12 = [callback(first(10539), obj3), ];
    ...
    obj11.children = callback(first(10541), obj12);
    const items13 = [callback(first(4026).View, obj11), ];
    let tmp51 = null;
    if (tmp36) {
    ...
    const items17 = [callback(first(10541), obj15), tmp32];
