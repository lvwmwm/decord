...
// Dependencies: [19, 17, 9626, 676, 21, 4255, 712, 4797, 4101, 4655, 1297, 2]
// Exports: default

// Module 10668 (ChannelCallNavigatorIcon)
import "noop";
...
export default function ChannelCallNavigatorIcon(disableBackground) {
  ...
  if (tmp5Result.isThemeDark(theme)) {
    ...
    if (!flag) {
      ...
      tmp2Result = tmp2(importDefault(4655), obj1);
    }
  }
  ...
  obj[5] = items2;
  obj[1] = closure_7(require(4797) /* PressableBase */.PressableOpacity, obj);
