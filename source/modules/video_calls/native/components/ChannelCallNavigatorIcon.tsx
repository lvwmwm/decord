...
// Dependencies: [19, 17, 9785, 676, 21, 4344, 712, 4886, 1363, 4744, 1297, 2]
// Exports: default

// Module 10860 (ChannelCallNavigatorIcon)
import "noop";
...
export default function ChannelCallNavigatorIcon(disableBackground) {
  ...
  if (tmp5Result.isThemeDark(theme)) {
    ...
    if (!flag) {
      ...
      tmp2Result = tmp2(importDefault(4744), obj1);
    }
  }
  ...
  obj[5] = items2;
  obj[1] = closure_7(require(4886) /* PressableBase */.PressableOpacity, obj);
