...
// Dependencies: [19, 17, 9789, 676, 21, 4342, 712, 4887, 1363, 4745, 1297, 2]
// Exports: default

// Module 10774 (ChannelCallNavigatorIcon)
import "noop";
...
export default function ChannelCallNavigatorIcon(disableBackground) {
  ...
  if (tmp5Result.isThemeDark(theme)) {
    ...
    if (!flag) {
      ...
      tmp2Result = tmp2(importDefault(4745), obj1);
    }
  }
  ...
  obj[5] = items2;
  obj[1] = closure_7(require(4887) /* PressableBase */.PressableOpacity, obj);
