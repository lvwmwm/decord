...
// Dependencies: [17, 676, 21, 4448, 712, 9526, 9531, 4444, 1236, 4896, 9542, 4547, 9742, 2]
// Exports: default

// Module 16686 (UserVideoFailed)
...
export default function UserVideoFailed(arg0) {
  ...
  if (!removeSplashImage) {
    ...
    tmp9 = callback(tmp3(9531).StreamFailed, obj);
  }
  obj1 = { children: null };
  const items1 = [tmp9, ];
  ...
  if (!removeRetryButton) {
    ...
    tmp11Result = tmp11(tmp3(4896).Button, obj5);
  }
  obj4[1] = tmp11Result;
