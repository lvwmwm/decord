...
// Dependencies: [17, 676, 21, 4285, 712, 9092, 10626, 4281, 1236, 4695, 10636, 4381, 9078, 2]
// Exports: default

// Module 16106 (UserVideoFailed)
...
export default function UserVideoFailed(arg0) {
  ...
  if (!removeSplashImage) {
    ...
    tmp9 = callback(tmp3(10626).StreamFailed, obj);
  }
  ...
  if (!removeRetryButton) {
    ...
    tmp11Result = tmp11(tmp3(4695).Button, obj5);
  }
  obj4[1] = tmp11Result;
