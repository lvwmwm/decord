...
// Dependencies: [17, 676, 21, 4255, 712, 9038, 10749, 4251, 1236, 4666, 10759, 4352, 9024, 2]
// Exports: default

// Module 16053 (UserVideoFailed)
...
export default function UserVideoFailed(arg0) {
  ...
  if (!removeSplashImage) {
    ...
    tmp9 = callback(tmp3(10749).StreamFailed, obj);
  }
  ...
  if (!removeRetryButton) {
    ...
    tmp11Result = tmp11(tmp3(4666).Button, obj5);
  }
  obj4[1] = tmp11Result;
