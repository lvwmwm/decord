...
// Dependencies: [17, 676, 21, 4302, 712, 9109, 10623, 4298, 1236, 4712, 10633, 4398, 9095, 2]
// Exports: default

// Module 16132 (UserVideoFailed)
...
export default function UserVideoFailed(arg0) {
  ...
  if (!removeSplashImage) {
    ...
    tmp9 = callback(tmp3(10623).StreamFailed, obj);
  }
  ...
  if (!removeRetryButton) {
    ...
    tmp11Result = tmp11(tmp3(4712).Button, obj5);
  }
  obj4[1] = tmp11Result;
