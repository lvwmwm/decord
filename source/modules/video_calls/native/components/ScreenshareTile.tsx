...
// Dependencies: [19, 17, 676, 21, 4302, 712, 10614, 5426, 1297, 10615, 4298, 1236, 2]
// Exports: default

// Module 10613 (ScreenShareTile)
import "noop";
...
export default function ScreenShareTile(onSingleTap) {
  ...
  let obj = { gesture: importDefault(10614)({ onSingleTapStart: onSingleTap, onDoubleTapStart: onDoubleTap }), children: null };
  obj = { style: tmp.container, children: null };
  obj = { style: tmp.liveContainer, children: null };
  obj[1] = callback(require(1297) /* Button */.LiveTag, {});
  const items = [callback(closure_3, obj), , ];
  const tmp2 = importDefault(10614)({ onSingleTapStart: onSingleTap, onDoubleTapStart: onDoubleTap });
  items[1] = callback(closure_4, { source: importDefault(10615), style: tmp.image, resizeMode: "contain" });
  ...
  return callback(require(5426) /* Directions */.GestureDetector, obj);
};
