...
// Dependencies: [19, 17, 676, 21, 4342, 712, 10653, 5467, 1297, 10654, 4338, 1236, 2]
// Exports: default

// Module 10652 (ScreenShareTile)
import "noop";
...
export default function ScreenShareTile(onSingleTap) {
  ...
  let obj = { gesture: importDefault(10653)({ onSingleTapStart: onSingleTap, onDoubleTapStart: onDoubleTap }), children: null };
  obj = { style: tmp.container, children: null };
  obj = { style: tmp.liveContainer, children: null };
  obj[1] = callback(require(1297) /* Button */.LiveTag, {});
  const items = [callback(closure_3, obj), , ];
  const tmp2 = importDefault(10653)({ onSingleTapStart: onSingleTap, onDoubleTapStart: onDoubleTap });
  items[1] = callback(closure_4, { source: importDefault(10654), style: tmp.image, resizeMode: "contain" });
