...
// Dependencies: [19, 17, 676, 21, 4303, 712, 10680, 5427, 1297, 10681, 4299, 1236, 2]
// Exports: default

// Module 10679 (ScreenShareTile)
import "noop";
...
export default function ScreenShareTile(onSingleTap) {
  ...
  let obj = { gesture: importDefault(10680)({ onSingleTapStart: onSingleTap, onDoubleTapStart: onDoubleTap }), children: null };
  obj = { style: tmp.container, children: null };
  obj = { style: tmp.liveContainer, children: null };
  obj[1] = callback(require(1297) /* Button */.LiveTag, {});
  const items = [callback(closure_3, obj), , ];
  const tmp2 = importDefault(10680)({ onSingleTapStart: onSingleTap, onDoubleTapStart: onDoubleTap });
  items[1] = callback(closure_4, { source: importDefault(10681), style: tmp.image, resizeMode: "contain" });
