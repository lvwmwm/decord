...
// Dependencies: [19, 17, 4208, 1218, 4250, 21, 4189, 712, 1297, 10805, 10806, 7631, 589, 10807, 1236, 10768, 500, 8827, 8852, 10741, 10808, 10793, 10809, 10810, 2]
// Exports: AudioRouteButton, DeafenButton, ScreenshareButton, StreamVolumeItem

// Module 10804 (ExpandedControlItemIcon)
...
function ExpandedControlItem(iconSource) {
  ...
  if (tmp2) {
    ...
    trailing = callback(require(7631) /* Form */.FormSwitch, obj);
  }
  ...
  obj[2] = callback(require(7631) /* Form */.FormLabel, obj);
  obj[3] = onPress;
  obj[4] = trailing;
...
export const StreamVolumeItem = function StreamVolumeItem() {
  ...
  const tmp6 = importDefault(10807);
  ({ effectiveVolume, handleVolumeChange } = importDefault(10807)(ownerId, MediaEngineContextTypes.STREAM));
  ...
  obj[1] = items1;
  const items2 = [callback(require(7631) /* Form */.FormLabel, obj), ];
  const tmp6Result = importDefault(10807)(ownerId, MediaEngineContextTypes.STREAM);
  const tmp5Result = importDefault(10768);
  let fn;
  ...
  if (null != stateFromStores) {
    ...
    obj1[0] = tmp11;
    tmp9Result = tmp9(tmp2(7631).FormRow, obj1);
  }
  return tmp9Result;
};
...
export const ScreenshareButton = function ScreenshareButton(arg0) {
  ...
  const tmp = importDefault(10741)(channel);
...
export const DeafenButton = function DeafenButton(disabled) {
  ...
  let obj = require(10793) /* NOOP */;
  const deafHandler = obj.createDeafHandler(importDefault(10808)(disabled.channel));
  obj = { disabled: flag, onPress: deafHandler.onPress, iconSource: importDefault(deafHandler.deaf ? 10809 : 10810), label: null };
