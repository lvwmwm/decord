...
// Dependencies: [19, 17, 4274, 1218, 4315, 21, 4255, 712, 1297, 10764, 10765, 7749, 589, 10766, 1236, 10719, 500, 9042, 9067, 10691, 10767, 10736, 10768, 10769, 2]
// Exports: AudioRouteButton, DeafenButton, ScreenshareButton, StreamVolumeItem

// Module 10763 (ExpandedControlItemIcon)
...
function ExpandedControlItem(iconSource) {
  ...
  if (tmp2) {
    ...
    trailing = callback(require(7749) /* Form */.FormSwitch, obj);
  }
  ...
  obj[2] = callback(require(7749) /* Form */.FormLabel, obj);
  obj[3] = onPress;
  obj[4] = trailing;
...
export const StreamVolumeItem = function StreamVolumeItem() {
  ...
  const tmp6 = importDefault(10766);
  ({ effectiveVolume, handleVolumeChange } = importDefault(10766)(ownerId, MediaEngineContextTypes.STREAM));
  ...
  obj[1] = items1;
  const items2 = [callback(require(7749) /* Form */.FormLabel, obj), ];
  const tmp6Result = importDefault(10766)(ownerId, MediaEngineContextTypes.STREAM);
  const tmp5Result = importDefault(10719);
  let fn;
...
export const ScreenshareButton = function ScreenshareButton(arg0) {
  ...
  const tmp = importDefault(10691)(channel);
...
export const DeafenButton = function DeafenButton(disabled) {
  ...
  let obj = require(10736) /* NOOP */;
  const deafHandler = obj.createDeafHandler(importDefault(10767)(disabled.channel));
