...
// Dependencies: [1348, 1838, 566, 10218, 10508, 10510, 6031, 2]
// Exports: useIsFiveButtonLayout

// Module 10507 (useIsFiveButtonLayout)
...
export const useIsFiveButtonLayout = function useIsFiveButtonLayout(id) {
  ...
  let isConnectedToVoiceChannel = _require(10218).useIsConnectedToVoiceChannel(stateFromStores);
  let guild_id;
  ...
  const tmp4 = importDefault(10508);
  const tmp4Result = importDefault(10508)(tmp6, id);
  ...
  const tmp12 = importDefault(10510);
  const tmp12Result = importDefault(10510)(id1);
