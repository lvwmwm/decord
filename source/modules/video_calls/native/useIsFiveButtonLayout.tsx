...
// Dependencies: [1372, 1891, 589, 9677, 10605, 10606, 5831, 2]
// Exports: useIsFiveButtonLayout

// Module 10604 (useIsFiveButtonLayout)
...
export const useIsFiveButtonLayout = function useIsFiveButtonLayout(id) {
  ...
  const tmp = _require;
  let isConnectedToVoiceChannel = _require(9677).useIsConnectedToVoiceChannel(stateFromStores);
  let guild_id;
