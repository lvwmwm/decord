...
// Dependencies: [1372, 1891, 589, 9743, 10672, 10673, 5891, 2]
// Exports: useIsFiveButtonLayout

// Module 10671 (useIsFiveButtonLayout)
...
export const useIsFiveButtonLayout = function useIsFiveButtonLayout(id) {
  ...
  const tmp = _require;
  let isConnectedToVoiceChannel = _require(9743).useIsConnectedToVoiceChannel(stateFromStores);
  let guild_id;
