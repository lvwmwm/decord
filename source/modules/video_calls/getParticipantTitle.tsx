...
// Dependencies: [4321, 10935, 4493, 1236, 2]
// Exports: default

// Module 10934 (getParticipantTitle)
...
export default function getParticipantTitle(guild_id, type, name) {
  if (type.type === ParticipantTypes.ACTIVITY) {
    ...
    const result = require(10935) /* useIsGuestOrLurker */.isGuestOrLurkerInGuild(guild_id.guild_id, id);
    const obj2 = require(10935) /* useIsGuestOrLurker */;
    let str = "";
