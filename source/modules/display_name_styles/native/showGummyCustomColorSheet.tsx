...
// Dependencies: [4312, 14648, 2007, 2]
// Exports: default

// Module 14647 (showGummyCustomColorSheet)
...
export default function showGummyCustomColorSheet(arg0) {
  importDefault(4312).openLazy(require(2007) /* asyncRequireImpl */(14648, dependencyMap.paths), DisplayNameStylesGummyCustomColorSheet, arg0, "stack");
};
