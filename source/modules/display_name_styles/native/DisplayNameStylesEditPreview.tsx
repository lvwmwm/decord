...
// Function ID: 14664
// Name: ChatPreview
// Dependencies: [19, 17, 21, 4342, 712, 8315, 1946, 9497, 1236, 2661, 10204, 4031, 1297, 9520, 9521, 4338, 2]
// Exports: default

// Module 14663 (ChatPreview)
...
function ChatPreview(arg0) {
  ...
  obj2[4] = require(9521) /* DisplayNameStyleColorPreset */.EffectDisplayType.PLAIN;
  obj2[6] = displayNameStyles;
  obj2[7] = tmp.chatUsername;
  const items1 = [callback(importDefault(9520), obj2), callback(require(4338) /* Text */.Text, { variant: "text-xs/medium", color: "text-muted", style: tmp.chatTimestamp, children: memo })];
  obj1[1] = items1;
