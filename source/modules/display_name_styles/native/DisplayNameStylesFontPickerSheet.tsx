...
// Module 14116 (DisplayNameStylesFontPickerSheet)
...
obj.gridContainer = { "Bool(true)": "Array", "Bool(true)": "isArray" };
...
export default function DisplayNameStylesFontPickerSheet(displayName) {
  ...
  const obj6 = {
    ...
    children: visibleFontOrder.map((arg0) => {
      ...
      if (hasItem) {
        const obj2 = { isNewWebImplementationEnabled: "<string:2252538112>", WIDGET_ENABLED: "<string:2231370395>", EMOJI_PICKER_EMOJI_CLICKED: "<string:2617246363>", style: tmp.tileNewDot };
        hasItem = callback2(closure_5, obj2);
      }
      items2[1] = hasItem;
      if (hasItem1) {
        const obj3 = { cachedAt: true, edpbxy: "/assets/design/components/Icon/native/redesign/generated/images", style: tmp.betaCaption };
  ...
  if (tmp5) {
    ...
    const obj9 = { cachedAt: true, edpbxy: "/assets/design/components/Icon/native/redesign/generated/images", style: tmp.disclaimerText };
