...
// Module 14104 (DisplayNameStylesColorPickerSheet)
...
obj.body = obj;
const obj1 = { "Bool(true)": null, "Bool(true)": null, "Bool(true)": null, paddingHorizontal: importDefault(dependencyMap[7]).space.PX_8 };
obj.gradientContainer = obj1;
const obj2 = { title: true, hasIcons: "/assets/../discord_common/js/shared/images/flags", defaultValue: 70, label: 47, subLabel: null, left: importDefault(dependencyMap[7]).space.PX_24, right: importDefault(dependencyMap[7]).space.PX_24 };
...
const obj4 = { <string:1140607356>: true, <string:1751293292>: true, borderRadius: importDefault(dependencyMap[7]).radii.sm };
obj.gradient = obj4;
const obj5 = { APP_DMS_ENTRY_POINT_COMMAND_BUTTON: null, desert: null, paddingHorizontal: importDefault(dependencyMap[7]).space.PX_4 };
obj.optionContainer = obj5;
obj.swatchWrapper = {};
const obj6 = { "Null": "de", "Null": "png", "Null": true, "Null": "/assets/../discord_common/js/shared/images/flags", "Null": 70, borderRadius: importDefault(dependencyMap[7]).radii.sm };
obj.pressable = obj6;
...
export default function DisplayNameStylesColorPickerSheet(selectedEffectId) {
  ...
  const obj4 = { style: tmp.gradient, colors: first.map((color) => selectedEffectId(tmp[19]).int2hex(color)), start: { "Null": false, "Null": true }, end: { "Null": null, "Null": null } };
  ...
  items5[1] = callback2(first, {
    ...
    children: memo.map((arr) => {
      ...
      const obj1 = { style: callback3.option, colors: arr.map((color) => color(closure_2[19]).int2hex(color)), start: { "Null": false, "Null": true }, end: { "Null": null, "Null": null } };
