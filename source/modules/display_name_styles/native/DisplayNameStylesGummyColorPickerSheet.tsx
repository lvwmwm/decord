...
// Dependencies: [57, 31, 27, 1862, 653, 33, 1861, 4165, 689, 8361, 1863, 620, 4134, 14339, 675, 4133, 5221, 5220, 4578, 1212, 13695, 9078, 2]
// Exports: default

// Module 14338 (DisplayNameStylesGummyColorPickerSheet)
...
export default function DisplayNameStylesGummyColorPickerSheet(selectedColors) {
  ...
  let obj = selectedColors(8361);
  let tmp3 = selectedColors.length > 0;
  const displayNameStylesEffectConfig = obj.useDisplayNameStylesEffectConfig(selectedColors(1863).DisplayNameEffect.GUMMY);
  if (tmp3) {
  ...
  obj.trailing = callback2(selectedColors(4578).Button, obj1);
  obj.header = callback2(selectedColors(5220).BottomSheetTitleHeader, obj);
  ...
  if (findIndexResult >= 0) {
    ...
    tmp19Result = tmp19(onSelectColors(13695), obj7);
  }
  const items4 = [tmp19Result, ];
  const obj8 = { style: tmp.customIconOverlay, pointerEvents: "none", children: callback2(closure_5, { style: tmp.customIconScrim, children: callback2(selectedColors(9078).PencilIcon, { color: "white", size: "sm" }) }) };
  ...
  items6[1] = callback2(selectedColors(4578).Button, obj10);
  obj2.children = items6;
  obj.children = closure_10(closure_5, obj2);
  return callback2(selectedColors(5221).BottomSheet, obj);
};
