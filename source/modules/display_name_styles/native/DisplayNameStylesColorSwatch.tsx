...
// Dependencies: [17, 21, 4344, 712, 1935, 13992, 4765, 688, 2]
// Exports: default

// Module 13991 (DisplayNameStylesColorSwatch)
...
export default function DisplayNameStylesColorSwatch(colors) {
  ...
  if (colors.effectId === require(1935) /* DisplayNameEffect */.DisplayNameEffect.GUMMY) {
    if (colors.length > 0) {
      ...
      obj = { colors: null };
      obj[0] = colors;
      obj[1] = jsx(importDefault(13992), { colors: null });
  ...
  if (colors.length >= 2) {
    ...
    return jsx(importDefault(4765), { colors: null, start: null, end: null, style: null });
  } else {
    let str = "#000000";
    if (colors.length > 0) {
