...
function EffectTile(arg0) {
  ...
  if (hasItem) {
    ...
    hasItem = tmp8(tmp2(4185).Text, obj3);
  }
  items1[2] = hasItem;
  obj[1] = items1;
...
export default function DisplayNameStylesEffectPickerSheet(userId) {
  ...
  if (null != userId) {
    ...
    obj1[0] = intl.string(onSelectEffect(2581).RVtMxT);
    ...
    obj3[1] = tmp8;
    obj2[1] = callback2(tmp2(4600).Button, obj3);
    obj1[1] = callback2(closure_5, obj2);
    obj[1] = callback2(tmp2(5242).BottomSheetTitleHeader, obj1);
    ...
    obj5[1] = callback2(tmp2(4598).Stack, obj6);
    obj4[1] = callback2(closure_5, obj5);
    obj[2] = callback2(closure_5, obj4);
    tmp9 = callback2(tmp2(5243).BottomSheet, obj);
  }
  return tmp9;
};
