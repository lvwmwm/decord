...
// Function ID: 14645
// Name: EffectTile
// Dependencies: [32, 19, 17, 21, 4344, 712, 7445, 14639, 14640, 4313, 4312, 5436, 5435, 1236, 2661, 4754, 4752, 9519, 9516, 9517, 2]
// Exports: default
...
function EffectTile(arg0) {
  ...
  let OpWJ3f = require(9519) /* DISPLAY_NAME_STYLES_EFFECT_NAMES */.DISPLAY_NAME_STYLES_EFFECT_NAMES[effectId];
  if (OpWJ3f == null) {
  ...
  const displayNameStylesEffectConfig = require(9519) /* DISPLAY_NAME_STYLES_EFFECT_NAMES */.useDisplayNameStylesEffectConfig(effectId);
  if (selected) {
  ...
  const tmp2Result = require(9519) /* DISPLAY_NAME_STYLES_EFFECT_NAMES */;
  const tmp8 = closure_6;
  const tmp9 = closure_8;
  obj1[2] = require(9517) /* DisplayNameStyleColorPreset */.EffectDisplayType.STATIC;
  obj1[3] = displayNameStylesEffectConfig.previewStyles;
  obj1[4] = tmp.effectName;
  const items1 = [closure_7(importDefault(9516), obj1), ];
  if (showNewDot) {
