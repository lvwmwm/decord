...
// Function ID: 109960
// Name: EffectTile
// Dependencies: [57, 31, 27, 1862, 33, 4165, 689, 7928, 14332, 14333, 4134, 4133, 5221, 5220, 1212, 2557, 4578, 4576, 8361, 8356, 8357, 4161, 2]
// Exports: default

// Module 14337 (EffectTile)
...
function EffectTile(arg0) {
  ...
  let OpWJ3f = require(8361) /* DISPLAY_NAME_STYLES_EFFECT_NAMES */.DISPLAY_NAME_STYLES_EFFECT_NAMES[effectId];
  if (null == OpWJ3f) {
    OpWJ3f = importDefault(2557).OpWJ3f;
  }
  const stringResult = intl.string(OpWJ3f);
  let obj = require(8361) /* DISPLAY_NAME_STYLES_EFFECT_NAMES */;
  ...
  items[1] = selected;
  obj1.style = items;
  const obj2 = { userId, userName: stringResult, effectDisplayType: require(8357) /* DisplayNameStyleColorPreset */.EffectDisplayType.STATIC, pendingDisplayNameStyles: displayNameStylesEffectConfig.previewStyles, style: tmp.effectName, variant: "text-md/semibold" };
  const items1 = [callback2(importDefault(8356), obj2), , ];
  if (showNewDot) {
  ...
  if (hasItem) {
    ...
    hasItem = callback2(require(4161) /* Text */.Text, obj4);
  }
  items1[2] = hasItem;
...
export default function DisplayNameStylesEffectPickerSheet(userId) {
  ...
  if (null != userId) {
    ...
    obj1.title = intl.string(onSelectEffect(2557).RVtMxT);
    ...
    obj3.size = "sm";
    obj2.children = callback2(userId(4578).Button, obj3);
    obj1.trailing = callback2(closure_5, obj2);
    obj.children = callback2(userId(5220).BottomSheetTitleHeader, obj1);
    ...
    obj5.children = callback2(userId(4576).Stack, obj6);
    obj4.children = callback2(closure_5, obj5);
    obj.children = callback2(closure_5, obj4);
    tmp7 = callback2(userId(5221).BottomSheet, obj);
  }
  return tmp7;
};
