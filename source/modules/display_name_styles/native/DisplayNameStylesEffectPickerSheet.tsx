...
// Function ID: 14454
// Name: EffectTile
// Dependencies: [32, 19, 17, 1886, 21, 4255, 712, 7297, 14448, 14449, 4224, 4223, 5323, 5322, 1236, 2613, 4665, 4663, 9362, 9359, 9360, 4251, 2]
// Exports: default

// Module 14453 (EffectTile)
...
function EffectTile(arg0) {
  ...
  let OpWJ3f = require(9362) /* DISPLAY_NAME_STYLES_EFFECT_NAMES */.DISPLAY_NAME_STYLES_EFFECT_NAMES[effectId];
  if (OpWJ3f == null) {
    OpWJ3f = importDefault(2613).OpWJ3f;
  }
  const stringResult = intl.string(OpWJ3f);
  const displayNameStylesEffectConfig = require(9362) /* DISPLAY_NAME_STYLES_EFFECT_NAMES */.useDisplayNameStylesEffectConfig(effectId);
  ...
  const tmp2Result = require(9362) /* DISPLAY_NAME_STYLES_EFFECT_NAMES */;
  const tmp9 = closure_6;
  obj1[2] = require(9360) /* DisplayNameStyleColorPreset */.EffectDisplayType.STATIC;
  obj1[3] = displayNameStylesEffectConfig.previewStyles;
  obj1[4] = tmp.effectName;
  const items1 = [closure_8(importDefault(9359), obj1), , ];
  if (showNewDot) {
