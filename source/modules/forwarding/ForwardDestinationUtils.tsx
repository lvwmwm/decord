...
// Dependencies: [19, 5172, 1376, 1372, 3883, 3892, 1874, 676, 7200, 1351, 589, 692, 4589, 1906, 4468, 1236, 4587, 7041, 4094, 4445, 2]
...
// Module 7199 (useSelectedDestinationChannel)
...
export const isRatelimitedInChannel = function isRatelimitedInChannel(channel, outer1_6) {
  ...
  if (tmp) {
    tmp = !require(7041) /* canBypassSlowmodeHelper */.canBypassSlowmodeHelper(channel, outer1_6);
    const obj = require(7041) /* canBypassSlowmodeHelper */;
  }
  return tmp;
};
