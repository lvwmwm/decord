...
// Function ID: 10175
// Name: MessagePreview
// Dependencies: [19, 17, 21, 4285, 712, 4221, 8153, 7964, 8512, 10175, 1935, 10176, 12, 10177, 1236, 10179, 9724, 4796, 9708, 5251, 1473, 8216, 4281, 2770, 8168, 2]
// Exports: ForwardPreview

// Module 10174 (MessagePreview)
...
function MessagePreview(content) {
  ...
  obj[4] = memo;
  return callback(importDefault(8512), obj);
}
...
export const ForwardPreview = function ForwardPreview(message) {
  ...
  let obj = require(10175) /* useForwardPreviewContent */;
    ...
    if (num2 > 0) {
      ...
      if (num3 > 0) {
        if (length === num3) {
          ...
          const tmp28 = importDefault(5251);
        }
      }
      if (length > 0) {
        ...
        obj5[1] = c7;
        obj5[2] = c7;
        obj4[1] = callback(importDefault(5251), obj5);
        tmp7 = callback(View, obj4);
        tmp8 = AttachmentIcon;
        tmp9 = formatToPlainStringResult;
        const tmp22 = importDefault(5251);
      } else {
        ...
        if (null != proxyURL) {
          ...
          obj8[1] = c7;
          obj8[2] = c7;
          obj7[1] = callback(importDefault(5251), obj8);
          tmp7 = callback(View, obj7);
          tmp8 = AttachmentIcon;
          tmp9 = formatToPlainStringResult;
          const tmp17 = importDefault(5251);
        }
      }
    }
    if (num3 > 0) {
  ...
  if (attachments.length > 1) {
    ...
    if (null != tmp7) {
      ...
      obj15[0] = items2;
      obj15[1] = tmp7;
      const items3 = [callback(importDefault(8216), obj15), ];
  ...
  if (tmp36Result3) {
    ...
    obj26[3] = obj28;
    obj25[1] = tmp36(importDefault(5251), obj26);
    tmp36Result3 = tmp36(tmp35, obj25);
    const tmp46 = importDefault(5251);
  }
