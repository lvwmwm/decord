...
// Function ID: 10144
// Name: MessagePreview
// Dependencies: [19, 17, 21, 4255, 712, 4191, 8012, 7823, 8371, 10144, 1906, 10145, 12, 10146, 1236, 10148, 9693, 4766, 9677, 5221, 1473, 8075, 4251, 2741, 8027, 2]
// Exports: ForwardPreview

// Module 10143 (MessagePreview)
...
function MessagePreview(content) {
  ...
  obj[4] = memo;
  return callback(importDefault(8371), obj);
}
...
export const ForwardPreview = function ForwardPreview(message) {
  ...
  let obj = require(10144) /* useForwardPreviewContent */;
    ...
    if (num2 > 0) {
      ...
      if (num3 > 0) {
        if (length === num3) {
          ...
          const tmp28 = importDefault(5221);
        }
      }
      if (length > 0) {
        ...
        obj5[1] = c7;
        obj5[2] = c7;
        obj4[1] = callback(importDefault(5221), obj5);
        tmp7 = callback(View, obj4);
        tmp8 = AttachmentIcon;
        tmp9 = formatToPlainStringResult;
        const tmp22 = importDefault(5221);
      } else {
        ...
        if (null != proxyURL) {
          ...
          obj8[1] = c7;
          obj8[2] = c7;
          obj7[1] = callback(importDefault(5221), obj8);
          tmp7 = callback(View, obj7);
          tmp8 = AttachmentIcon;
          tmp9 = formatToPlainStringResult;
          const tmp17 = importDefault(5221);
        }
      }
    }
    if (num3 > 0) {
  ...
  if (attachments.length > 1) {
    ...
    if (null != tmp7) {
      ...
      obj15[0] = items2;
      obj15[1] = tmp7;
      const items3 = [callback(importDefault(8075), obj15), ];
  ...
  if (tmp36Result3) {
    ...
    obj26[3] = obj28;
    obj25[1] = tmp36(importDefault(5221), obj26);
    tmp36Result3 = tmp36(tmp35, obj25);
    const tmp46 = importDefault(5221);
  }
