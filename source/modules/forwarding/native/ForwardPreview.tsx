...
// Function ID: 10304
// Name: MessagePreview
// Dependencies: [19, 17, 21, 4344, 712, 4280, 8273, 8082, 8634, 10304, 1954, 10305, 12, 10306, 1236, 10308, 9853, 4855, 9837, 5307, 1492, 8337, 4340, 2789, 8288, 2]
// Exports: ForwardPreview

// Module 10303 (MessagePreview)
...
function MessagePreview(content) {
  ...
  const tmp4 = obj.createNativeStyleProperties({ seeMoreLabelColor: TEXT_SUBTLE })(importDefault(4280)());
  importDefault = tmp4;
  ...
  obj[4] = memo;
  return callback(importDefault(8634), obj);
}
...
export const ForwardPreview = function ForwardPreview(message) {
  ...
  let obj = require(10304) /* useForwardPreviewContent */;
    ...
    if (num2 > 0) {
      ...
      if (num3 > 0) {
        if (length === num3) {
          ...
          const tmp28 = importDefault(5307);
        }
      }
      if (length > 0) {
        ...
        if (null != proxyURL) {
          ...
          let obj9 = { uri: null };
          obj9 = importDefault(1492);
          obj9[0] = obj9.getMobileOptimizedSrc(embeds[0].thumbnail.proxyURL, c7, c7);
          obj8[0] = obj9;
          obj8[1] = c7;
          obj8[2] = c7;
          obj7[1] = callback(importDefault(5307), obj8);
          tmp7 = callback(View, obj7);
          tmp8 = AttachmentIcon;
          tmp9 = formatToPlainStringResult;
          const tmp17 = importDefault(5307);
        }
      }
    }
    if (num3 > 0) {
  ...
  if (attachments.length > 1) {
    ...
    if (null != tmp7) {
      ...
      obj15[0] = items2;
      obj15[1] = tmp7;
      const items3 = [callback(importDefault(8337), obj15), ];
  ...
  if (tmp36Result) {
    ...
    obj20[1] = intl5.string(importDefault(2789).goiR2u);
  ...
  if (tmp36Result3) {
    ...
    obj26[3] = obj28;
    obj25[1] = tmp36(importDefault(5307), obj26);
    tmp36Result3 = tmp36(tmp35, obj25);
    const tmp46 = importDefault(5307);
  }
