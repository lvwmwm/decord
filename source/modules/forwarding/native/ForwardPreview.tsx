...
// Function ID: 12040
// Name: MessagePreview
// Dependencies: [19, 17, 21, 4661, 712, 4310, 8340, 8157, 10066, 12040, 1954, 12041, 12, 12042, 1236, 11700, 10071, 6882, 10051, 5449, 1493, 8402, 4734, 2821, 8353, 2]
...
function MessagePreview(content) {
  ...
  const tmp4 = obj.createNativeStyleProperties({ seeMoreLabelColor: TEXT_SUBTLE })(importDefault(4310)());
  importDefault = tmp4;
  ...
  obj[4] = memo;
  return callback(importDefault(10066), obj);
}
...
export const ForwardPreview = function ForwardPreview(message) {
  ...
  let obj = require(12040) /* useForwardPreviewContent */;
    ...
    if (num2 > 0) {
      ...
      if (num3 > 0) {
        if (length === num3) {
          ...
          const tmp28 = importDefault(5449);
        }
      }
      if (length > 0) {
        ...
        if (null != proxyURL) {
          ...
          let obj9 = { uri: null };
          obj9 = importDefault(1493);
          obj9[0] = obj9.getMobileOptimizedSrc(embeds[0].thumbnail.proxyURL, c7, c7);
          obj8[0] = obj9;
          obj8[1] = c7;
          obj8[2] = c7;
          obj7[1] = callback(importDefault(5449), obj8);
          tmp7 = callback(View, obj7);
          tmp8 = AttachmentIcon;
          tmp9 = formatToPlainStringResult;
          const tmp17 = importDefault(5449);
        }
      }
    }
    if (num3 > 0) {
  ...
  if (attachments.length > 1) {
    ...
    if (null != tmp7) {
      ...
      obj15[0] = items2;
      obj15[1] = tmp7;
      const items3 = [callback(importDefault(8402), obj15), ];
  ...
  if (tmp36Result) {
    ...
    obj20[1] = intl5.string(importDefault(2821).goiR2u);
  ...
  if (tmp36Result3) {
    ...
    obj26[3] = obj28;
    obj25[1] = tmp36(importDefault(5449), obj26);
    tmp36Result3 = tmp36(tmp35, obj25);
    const tmp46 = importDefault(5449);
  }
