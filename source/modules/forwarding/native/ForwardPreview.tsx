...
// Function ID: 10263
// Name: MessagePreview
// Dependencies: [19, 17, 21, 4303, 712, 4239, 8234, 8043, 8595, 10263, 1954, 10264, 12, 10265, 1236, 10267, 9812, 4815, 9796, 5268, 1492, 8298, 4299, 2789, 8249, 2]
// Exports: ForwardPreview

// Module 10262 (MessagePreview)
...
function MessagePreview(content) {
  ...
  const tmp4 = obj.createNativeStyleProperties({ seeMoreLabelColor: TEXT_SUBTLE })(importDefault(4239)());
  importDefault = tmp4;
  ...
  obj[4] = memo;
  return callback(importDefault(8595), obj);
}
...
export const ForwardPreview = function ForwardPreview(message) {
  ...
  let obj = require(10263) /* useForwardPreviewContent */;
    ...
    if (num2 > 0) {
      ...
      if (num3 > 0) {
        if (length === num3) {
          ...
          const tmp28 = importDefault(5268);
        }
      }
      if (length > 0) {
        ...
        obj5[1] = c7;
        obj5[2] = c7;
        obj4[1] = callback(importDefault(5268), obj5);
        tmp7 = callback(View, obj4);
        tmp8 = AttachmentIcon;
        tmp9 = formatToPlainStringResult;
        const tmp22 = importDefault(5268);
      } else {
        ...
        if (null != proxyURL) {
          ...
          obj8[1] = c7;
          obj8[2] = c7;
          obj7[1] = callback(importDefault(5268), obj8);
          tmp7 = callback(View, obj7);
          tmp8 = AttachmentIcon;
          tmp9 = formatToPlainStringResult;
          const tmp17 = importDefault(5268);
        }
      }
    }
    if (num3 > 0) {
  ...
  if (attachments.length > 1) {
    ...
    if (null != tmp7) {
      ...
      obj15[0] = items2;
      obj15[1] = tmp7;
      const items3 = [callback(importDefault(8298), obj15), ];
  ...
  if (tmp36Result3) {
    ...
    obj26[3] = obj28;
    obj25[1] = tmp36(importDefault(5268), obj26);
    tmp36Result3 = tmp36(tmp35, obj25);
    const tmp46 = importDefault(5268);
  }
