...
// Dependencies: [21, 4688, 1236, 2]
// Exports: default

// Module 11125 (ForwardStaffToNonStaffWarningModal)
...
export default function ForwardStaffToNonStaffWarningModal(arg0) {
  ...
  obj[1] = onConfirm;
  const items = [callback(require(4688) /* getAlertModalItemKey */.AlertActionButton, obj, "confirm"), ];
  const obj1 = { variant: "secondary", text: null, onPress: null };
  const intl4 = require(1236) /* getSystemLocale */.intl;
  obj1[1] = intl4.string(require(1236) /* getSystemLocale */.t["13/7kX"]);
  obj1[2] = onBack;
  items[1] = callback(require(4688) /* getAlertModalItemKey */.AlertActionButton, obj1, "back");
  obj[0] = items;
