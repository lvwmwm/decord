// Module ID: 6137
// Function ID: 54695
// Dependencies: [57, 5, 1348, 3793, 653, 4158, 6138, 5948, 671, 5949, 1360, 5695, 6139, 4405, 2]
...
let obj = {
    ...
    return callback(async () => {
      ...
      if (null != outer1_2) {
        if (outer1_2.isICYMIGameContentForwarding) {
          let guild_id = callback(6138).GAME_CONTENT_GUILD_ID;
        }
        if (null == channel1) {
          if (null == guild_id) {
            const _Error2 = Error;
        ...
        if (null == channel) {
          ...
          const parsed = callback2(5948).parse(channel, "");
          let obj = { guild_id };
          ...
          if (null != withMessage) {
            ...
            tmp20 = outer2_3(callback2(5949)(withMessage), 2);
          }
          const obj3 = callback2(5695);
          obj = {};
          ...
          if (!result) {
            result = callback(6139).isRatelimitedInChannel(channel, outer2_6);
            const obj5 = callback(6139);
          }
          if (!result) {
            const obj6 = callback2(5695);
            const id = channel.id;
            obj1 = { location: outer2_8.FORWARDING, flags: num3 };
            return yield obj6.sendMessage(id, callback2(5948).parse(channel, tmp16), false, obj1);
          }
          const obj9 = callback2(5948);
        }
      }
      if (null != channel1) {
  ...
  sendForwards(outer2_8, found, arg2) {
    ...
    return importDefault(4405)(found.map((alsoForwardToChannelId) => outer1_9.sendForward(closure_0, alsoForwardToChannelId, closure_1)));
  }
};
