...
obj1 = { <string:2522248102>: "png", <string:1360617838>: null, <string:2942407836>: 20, <string:3697503314>: 4, borderRadius: importDefault(dependencyMap[3]).radii.sm, backgroundColor: importDefault(dependencyMap[3]).colors.BACKGROUND_MOD_STRONG };
...
const obj3 = { "Null": null, "Null": null, borderRadius: importDefault(dependencyMap[3]).radii.none };
