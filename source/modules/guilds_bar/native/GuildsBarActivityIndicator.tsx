...
obj1 = { <string:1204045508>: "png", <string:1122718148>: null, onFocusedInputTextChanged: 20, onFocusedInputSelectionChanged: 4, borderRadius: importDefault(dependencyMap[3]).radii.sm, backgroundColor: importDefault(dependencyMap[3]).colors.BACKGROUND_MOD_STRONG };
...
const obj3 = { "Null": "<string:2552889346>", "Null": "<string:2938503170>", borderRadius: importDefault(dependencyMap[3]).radii.none };
