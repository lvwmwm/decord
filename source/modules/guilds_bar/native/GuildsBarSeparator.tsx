// Module ID: 14920
// Function ID: 113742
// Dependencies: [31, 33, 4130, 689, 3834, 14849, 3991, 4542, 7678, 2]
...
const memoResult = importAllResult.memo(function GuildsBarSeparator() {
  ...
  panelX = importAllResult.useContext(token(14849).HomeDrawerStateContext).panelX;
  const tmp = callback();
  const fn = function l() {
    const obj = {};
  ...
  obj = { withSpring: token(4542).withSpring, guildItemSize: token, panelX, HOME_DRAWER_FLING_PHYSICS: token(14849).HOME_DRAWER_FLING_PHYSICS };
  fn.__closure = obj;
