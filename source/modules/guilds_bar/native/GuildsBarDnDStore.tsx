...
// Function ID: 15548
// Name: withEqualityFn
// Dependencies: [5078, 700, 4115, 705, 1208, 4006, 2]
...
const withEqualityFn = identity.createWithEqualityFn((arg0, arg1) => {
  const _require = arg0;
  let closure_1 = arg1;
  let obj = { dragSpecs: "Boolean", overSpecs: "disabled", dropSpecs: "isArray", dragRegion: null, gestureState: null, dragDropInProgress: null, listInsets: "sans-serif-medium", scrollPosition: "normal", windowSize: "<string:973079306>", setStateShallow: "<string:167772559>", dropStart: "<string:838861251>", dropComplete: "<string:2835350031>" };
  obj[3] = _require(4115).makeMutable({ min: 0, max: 0 });
  const obj2 = _require(4115);
  obj[4] = _require(4115).makeMutable(obj);
  const obj3 = _require(4115);
  obj[5] = _require(4115).makeMutable(false);
  let obj4 = _require(4115);
  obj[6] = _require(4115).makeMutable({ start: 0, end: 0 });
  const obj5 = _require(4115);
  obj[7] = _require(4115).makeMutable(0);
...
let result = require("module_4115").fileFinishedImporting("modules/guilds_bar/native/GuildsBarDnDStore.tsx");
