...
// Dependencies: [5, 5196, 676, 8597, 1236, 13375, 2007, 6054, 15492, 2]
// Exports: getGuildFolderMenuItems

// Module 15491 (getGuildFolderMenuItems)
...
export const getGuildFolderMenuItems = function getGuildFolderMenuItems(guildFolderMenuItems) {
  ...
  let obj = { IconComponent: _require(8597).EnvelopeIcon, label: null, action: null };
  ...
  const items = [obj, ];
  obj = { IconComponent: _require(6054).SettingsIcon, label: null, action: null };
