// Module ID: 15477
// Function ID: 15478
// Dependencies: [19, 21, 4344, 500, 9812, 15478, 15488, 15376, 11061, 5466, 5820, 8049, 15555, 2]
...
const memoResult = importAllResult.memo(function GuildsBar(enableHome) {
  ...
  const items2 = [closure_4(fastListRef(8049), obj1), closure_4(tmp2(15555), {})];
  obj[3] = items2;
  obj[1] = tmp11(tmp12, obj);
  obj[1] = closure_4(listProps(5466).GestureDetector, obj);
