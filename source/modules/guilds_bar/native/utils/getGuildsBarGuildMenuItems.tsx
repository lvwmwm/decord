...
// Dependencies: [5, 1908, 4709, 673, 10076, 7021, 1233, 13970, 2008, 9705, 7059, 7318, 13917, 12309, 4448, 10073, 12310, 7054, 2]
// Exports: default

// Module 16210 (getGuildsBarGuildMenuItems)
...
export default function getGuildsBarGuildMenuItems(arg0) {
  const _require = arg0;
  let obj = _require(10076);
  let result = obj.shouldShowUseNewNotificationSystem("GuildPopoutMenu");
  obj = { IconComponent: _require(7021).EnvelopeIcon, label: null, action: null };
  ...
  let items = [obj, , ];
  obj = { IconComponent: _require(9705).BellIcon, label: null, action: null };
  ...
  items[1] = obj;
  obj1 = { IconComponent: _require(7318).SettingsIcon, label: null, action: null };
