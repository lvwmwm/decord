...
export default function getGuildsBarGuildMenuItems(arg0) {
  ...
  let items = [obj, , ];
  obj = { IconComponent: _require(9186).BellIcon, label: null, action: null };
  ...
  items[1] = obj;
  let obj1 = { IconComponent: _require(6054).SettingsIcon, label: null, action: null };
