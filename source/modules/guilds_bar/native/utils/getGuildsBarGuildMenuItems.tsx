...
// Dependencies: [5, 1909, 4669, 676, 10191, 7772, 1236, 13666, 2009, 9707, 5455, 6208, 13613, 11913, 4415, 10186, 11914, 5450, 2]
// Exports: default

// Module 15841 (getGuildsBarGuildMenuItems)
...
export default function getGuildsBarGuildMenuItems(arg0) {
  ...
  obj = { IconComponent: _require(7772).EnvelopeIcon, label: null, action: null };
  ...
  let items = [obj, , ];
  obj = { IconComponent: _require(9707).BellIcon, label: null, action: null };
  ...
  items[1] = obj;
  obj1 = { IconComponent: _require(6208).SettingsIcon, label: null, action: null };
