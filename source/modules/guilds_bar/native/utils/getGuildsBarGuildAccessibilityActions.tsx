...
// Dependencies: [1910, 5217, 1236, 8761, 1363, 15552, 5293, 2]
// Exports: default

// Module 15551 (getGuildsBarGuildAccessibilityActions)
...
export default function getGuildsBarGuildAccessibilityActions(arg0) {
  ...
  let tmp3 = importDefault(15552)(arg0);
  if (null == tmp3) {
    return items;
  } else {
    ...
    if (null == containingFolder) {
      ...
      obj[2] = function action() {
        ...
        const guildFolderLocal = callback2(5293).createGuildFolderLocal(items, "");
        const obj = callback2(5293);
        const tmp3 = callback2;
        const tmp4 = callback;
        callback(8761).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
        if (null != callback2) {
      ...
      if (above.isFolder) {
        ...
        if (null == gBM0Vf.name) {
          ...
          obj1[2] = function action() {
            const tmp5 = callback2(15552)(callback);
            if (null != tmp5) {
              let node = null;
              if (null != tmp5.above) {
                node = null;
              ...
              if (null != node) {
                const tmp3Result = callback2(5293);
          ...
          obj3[2] = function action() {
            const tmp4 = callback2(15552)(callback);
            if (null != tmp4) {
              let node = null;
              if (null != tmp4.above) {
                node = null;
              ...
              if (null != node) {
                const tmp2Result = callback2(5293);
