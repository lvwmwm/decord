...
// Dependencies: [1909, 5381, 1236, 8213, 1363, 15930, 5457, 2]
// Exports: default

// Module 15929 (getGuildsBarGuildAccessibilityActions)
import getGuildBarNeighborsDefault from "getGuildBarNeighbors" /* 15930 */;
import closure_3 from "createGuildRecordFromRust" /* 1909 */;
import closure_4 from "insertUnsortedGuilds" /* 5381 */;
  ...
  if (null == tmp3) {
    ...
    if (null == containingFolder) {
      ...
      obj[2] = function action() {
        ...
        const guildFolderLocal = callback2(5457).createGuildFolderLocal(items, "");
        const obj = callback2(5457);
        const tmp3 = callback2;
        const tmp4 = callback;
        callback(8213).saveGuildFolders(closure_1_4.getCompatibleGuildFolders());
        if (null != callback2) {
      ...
      if (above.isFolder) {
        ...
        if (null == gBM0Vf.name) {
          ...
          obj1[2] = function action() {
            const tmp5 = callback2(15930)(callback);
            if (null != tmp5) {
              let node = null;
              if (null != tmp5.above) {
                node = null;
              ...
              if (null != node) {
                const tmp3Result = callback2(5457);
          ...
          obj3[2] = function action() {
            const tmp4 = callback2(15930)(callback);
            if (null != tmp4) {
              let node = null;
              if (null != tmp4.above) {
                node = null;
              ...
              if (null != node) {
                const tmp2Result = callback2(5457);
