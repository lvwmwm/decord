...
// Dependencies: [1910, 5328, 1236, 8913, 1363, 15779, 5404, 2]
// Exports: default

// Module 15778 (getGuildsBarGuildAccessibilityActions)
import getGuildBarNeighborsDefault from "getGuildBarNeighbors" /* 15779 */;
  ...
  if (null == tmp3) {
    ...
    if (null == containingFolder) {
      ...
      obj[2] = function action() {
        ...
        const guildFolderLocal = callback2(5404).createGuildFolderLocal(items, "");
        const obj = callback2(5404);
        const tmp3 = callback2;
        const tmp4 = callback;
        callback(8913).saveGuildFolders(closure_1_4.getCompatibleGuildFolders());
        if (null != callback2) {
      ...
      if (above.isFolder) {
        ...
        if (null == gBM0Vf.name) {
          ...
          obj1[2] = function action() {
            const tmp5 = callback2(15779)(callback);
            if (null != tmp5) {
              let node = null;
              if (null != tmp5.above) {
                node = null;
              ...
              if (null != node) {
                const tmp3Result = callback2(5404);
          ...
          obj3[2] = function action() {
            const tmp4 = callback2(15779)(callback);
            if (null != tmp4) {
              let node = null;
              if (null != tmp4.above) {
                node = null;
              ...
              if (null != node) {
                const tmp2Result = callback2(5404);
