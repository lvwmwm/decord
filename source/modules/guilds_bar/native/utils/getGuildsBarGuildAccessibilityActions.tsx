...
// Dependencies: [1862, 5093, 1236, 8175, 4101, 15304, 5171, 2]
// Exports: default

// Module 15303 (getGuildsBarGuildAccessibilityActions)
...
export default function getGuildsBarGuildAccessibilityActions(arg0) {
  ...
  let tmp3 = importDefault(15304)(arg0);
  if (null == tmp3) {
    return items;
  } else {
    ...
    if (null == containingFolder) {
      ...
      obj[2] = function action() {
        ...
        const guildFolderLocal = callback2(5171).createGuildFolderLocal(items, "");
        const obj = callback2(5171);
        const tmp3 = callback2;
        const tmp4 = callback;
        callback(8175).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
        if (null != callback2) {
      ...
      if (above.isFolder) {
        ...
        if (null == gBM0Vf.name) {
          ...
          obj1[2] = function action() {
            const tmp5 = callback2(15304)(callback);
            if (null != tmp5) {
              let node = null;
              if (null != tmp5.above) {
                node = null;
              ...
              if (null != node) {
                const tmp3Result = callback2(5171);
                tmp3Result.moveById(tmp, node.id, true, true);
                callback(8175).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
                if (null != tmp2) {
                  const AccessibilityAnnouncer = tmp10(4101).AccessibilityAnnouncer;
                  AccessibilityAnnouncer.announce(tmp2);
                }
                const obj2 = callback(8175);
                tmp10 = callback;
              }
            }
          };
          ...
          obj3[2] = function action() {
            const tmp4 = callback2(15304)(callback);
            if (null != tmp4) {
              let node = null;
              if (null != tmp4.above) {
                node = null;
              ...
              if (null != node) {
                const tmp2Result = callback2(5171);
        ...
        obj11[2] = function action() {
          ...
          if (null != tmp5) {
            ...
            if (null != containingFolder) {
              ...
              callback(8175).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
              if (null != tmp2) {
                const AccessibilityAnnouncer = tmp9(4101).AccessibilityAnnouncer;
                AccessibilityAnnouncer.announce(tmp2);
              }
              const obj2 = callback(8175);
              tmp9 = callback;
