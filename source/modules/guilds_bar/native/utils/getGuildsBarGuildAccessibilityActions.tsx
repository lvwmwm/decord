...
// Dependencies: [1891, 5155, 1236, 8698, 4153, 15452, 5232, 2]
// Exports: default

// Module 15451 (getGuildsBarGuildAccessibilityActions)
...
export default function getGuildsBarGuildAccessibilityActions(arg0) {
  ...
  let tmp3 = importDefault(15452)(arg0);
  if (null == tmp3) {
    return items;
  } else {
    ...
    if (null == containingFolder) {
      ...
      obj[2] = function action() {
        ...
        const tmp4 = callback;
        callback(8698).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
        if (null != callback2) {
      ...
      if (above.isFolder) {
        ...
        if (null == gBM0Vf.name) {
          ...
          obj1[2] = function action() {
            const tmp5 = callback2(15452)(callback);
            if (null != tmp5) {
              let node = null;
              if (null != tmp5.above) {
                node = null;
              ...
              if (null != node) {
                ...
                callback(8698).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
                if (null != tmp2) {
                  const AccessibilityAnnouncer = tmp10(4153).AccessibilityAnnouncer;
                  AccessibilityAnnouncer.announce(tmp2);
                }
                const obj2 = callback(8698);
                tmp10 = callback;
              }
            }
          };
          ...
          obj3[2] = function action() {
            const tmp4 = callback2(15452)(callback);
            if (null != tmp4) {
              let node = null;
              if (null != tmp4.above) {
                node = null;
        ...
        obj11[2] = function action() {
          ...
          if (null != tmp5) {
            ...
            if (null != containingFolder) {
              ...
              callback(8698).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
              if (null != tmp2) {
                const AccessibilityAnnouncer = tmp9(4153).AccessibilityAnnouncer;
                AccessibilityAnnouncer.announce(tmp2);
              }
              const obj2 = callback(8698);
              tmp9 = callback;
