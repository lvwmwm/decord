...
// Dependencies: [1862, 5122, 1236, 8620, 4131, 15335, 5200, 2]
// Exports: default

// Module 15334 (getGuildsBarGuildAccessibilityActions)
  ...
  if (null == tmp3) {
    ...
    if (null == containingFolder) {
      ...
      obj[2] = function action() {
        ...
        const guildFolderLocal = callback2(5200).createGuildFolderLocal(items, "");
        const obj = callback2(5200);
        const tmp3 = callback2;
        const tmp4 = callback;
        callback(8620).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
        if (null != callback2) {
        ...
        if (null == gBM0Vf.name) {
          ...
          obj1[2] = function action() {
            ...
            if (null != tmp5) {
              ...
              if (null != node) {
                const tmp3Result = callback2(5200);
                tmp3Result.moveById(tmp, node.id, true, true);
                callback(8620).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
                if (null != tmp2) {
                  const AccessibilityAnnouncer = tmp10(4131).AccessibilityAnnouncer;
                  AccessibilityAnnouncer.announce(tmp2);
                }
                const obj2 = callback(8620);
                tmp10 = callback;
              }
            }
          };
          ...
          obj3[2] = function action() {
            ...
            if (null != tmp4) {
              ...
              if (null != node) {
                const tmp2Result = callback2(5200);
        ...
        obj11[2] = function action() {
          ...
          if (null != tmp5) {
            ...
            if (null != containingFolder) {
              ...
              callback(8620).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
              if (null != tmp2) {
                const AccessibilityAnnouncer = tmp9(4131).AccessibilityAnnouncer;
                AccessibilityAnnouncer.announce(tmp2);
              }
              const obj2 = callback(8620);
              tmp9 = callback;
