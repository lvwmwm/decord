  ...
  if (null == tmp3) {
    ...
    if (null == containingFolder) {
      ...
      obj[2] = function action() {
        ...
        const guildFolderLocal = callback2(5272).createGuildFolderLocal(items, "");
        const obj = callback2(5272);
        const tmp3 = callback2;
        const tmp4 = callback;
        callback(8747).saveGuildFolders(outer1_4.getCompatibleGuildFolders());
        if (null != callback2) {
        ...
        if (null == gBM0Vf.name) {
          ...
          obj1[2] = function action() {
            ...
            if (null != tmp5) {
              ...
              if (null != node) {
                const tmp3Result = callback2(5272);
          ...
          obj3[2] = function action() {
            ...
            if (null != tmp4) {
              ...
              if (null != node) {
                const tmp2Result = callback2(5272);
