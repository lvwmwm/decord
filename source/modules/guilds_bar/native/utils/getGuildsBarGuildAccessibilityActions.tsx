...
// Dependencies: [1891, 5155, 1236, 8698, 4153, 15460, 5232, 2]
// Exports: default

// Module 15459 (getGuildsBarGuildAccessibilityActions)
...
export default function getGuildsBarGuildAccessibilityActions(arg0) {
  ...
  let tmp3 = importDefault(15460)(arg0);
  if (null == tmp3) {
    return items;
  } else {
      ...
      if (above.isFolder) {
        ...
        if (null == gBM0Vf.name) {
          ...
          obj1[2] = function action() {
            const tmp5 = callback2(15460)(callback);
            if (null != tmp5) {
              let node = null;
              if (null != tmp5.above) {
                node = null;
          ...
          obj3[2] = function action() {
            const tmp4 = callback2(15460)(callback);
            if (null != tmp4) {
              let node = null;
              if (null != tmp4.above) {
                node = null;
