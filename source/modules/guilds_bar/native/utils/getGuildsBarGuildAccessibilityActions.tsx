...
// Dependencies: [1908, 5389, 1233, 8222, 1362, 16161, 5465, 2]
// Exports: default

// Module 16160 (getGuildsBarGuildAccessibilityActions)
import getGuildBarNeighborsDefault from "getGuildBarNeighbors" /* 16161 */;
  ...
  if (null == tmp3) {
    ...
    if (null == containingFolder) {
      ...
      obj[2] = function action() {
        ...
        const guildFolderLocal = callback2(5465).createGuildFolderLocal(items, "");
        const obj = callback2(5465);
        const tmp3 = callback2;
        const tmp4 = callback;
        callback(8222).saveGuildFolders(closure_1_4.getCompatibleGuildFolders());
        if (null != callback2) {
      ...
      if (above.isFolder) {
        ...
        if (null == gBM0Vf.name) {
          ...
          obj1[2] = function action() {
            const tmp5 = callback2(16161)(callback);
            if (null != tmp5) {
              let node = null;
              if (null != tmp5.above) {
                node = null;
              ...
              if (null != node) {
                const tmp3Result = callback2(5465);
          ...
          obj3[2] = function action() {
            const tmp4 = callback2(16161)(callback);
            if (null != tmp4) {
              let node = null;
              if (null != tmp4.above) {
                node = null;
              ...
              if (null != node) {
                const tmp2Result = callback2(5465);
