...
// Dependencies: [5398, 5400, 2]
// Exports: default

// Module 16263 (getGuildBarNeighbors)
import GuildsNodeType from "GuildsNodeType" /* 5400 */;
import closure_2 from "insertUnsortedGuilds" /* 5398 */;
    ...
    if (node.type === GuildsNodeType.GuildsNodeType.GUILD) {
      ...
      if (null == root) {
        ...
        if (index < 0) {
          ...
          let tmp2 = null;
          if (root.type === tmp5(5400).GuildsNodeType.FOLDER) {
            tmp2 = root;
          }
          ...
          if (null != root.children[index - 1]) {
            ...
            obj[0] = tmp8;
            obj[1] = tmp8.type === tmp5(5400).GuildsNodeType.FOLDER;
            tmp3 = obj;
          }
          obj[1] = tmp3;
          let tmp4 = null;
          if (null != root.children[index + 1]) {
            ...
            obj1[0] = tmp9;
            obj1[1] = tmp9.type === tmp5(5400).GuildsNodeType.FOLDER;
            tmp4 = obj1;
          }
          obj[2] = tmp4;
          return obj;
