...
// Dependencies: [32, 19, 21, 4344, 1297, 4065, 712, 15493, 15494, 15498, 2]
// Exports: default

// Module 15492 (useGuildsBarBottomRightBadge)
...
export default function useGuildsBarBottomRightBadge(mentionCount) {
  ...
  return React.useMemo(() => {
    if (mentionCount > 0) {
      ...
      return { badge: null, cutout: "Array", cutouts: "accessibilityRole" };
    }
  }, items1);
};
