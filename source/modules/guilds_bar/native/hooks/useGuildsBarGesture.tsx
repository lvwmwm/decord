...
function triggerHapticsAndAnnouncementsIfNecessary(type) {
  ...
  if ("drag-start" === type) {
    ...
    lib(require(4158) /* HapticFeedbackTypes */.HapticFeedbackTypes.DRAG_AND_DROP_START);
    lib.flush();
    ...
    if (tmp7 !== tmp8Result) {
      ...
      lib(require(4158) /* HapticFeedbackTypes */.HapticFeedbackTypes.DRAG_AND_DROP_MOVE);
    ...
    lib(require(4158) /* HapticFeedbackTypes */.HapticFeedbackTypes.DRAG_AND_DROP_END);
    lib.flush();
    lib2.flush();
