...
// Function ID: 15261
// Name: getDropIndex
// Dependencies: [5, 19, 17, 1862, 5107, 15261, 15262, 4116, 636, 4224, 4101, 12, 1208, 1236, 7790, 15033, 3959, 712, 3868, 10138, 705, 5185, 8592, 8381, 500, 1581, 4651, 15263, 15264, 14218, 5353, 2]
// Exports: default

// Module 15260 (getDropIndex)
    ...
    if (null != item) {
      ...
      if (item.section >= GUILDS) {
        ...
        if (null != GUILDS) {
          ...
          if (require(7790) /* renderDefaultEmpty */.FastListItemTypes.SECTION !== type) {
