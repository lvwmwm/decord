...
// Dependencies: [32, 19, 17, 7037, 4118, 5154, 15324, 14268, 21, 4302, 7948, 1609, 14261, 14270, 636, 643, 589, 4162, 15393, 2]

// Module 15392 (checkNodeAndIterate)
...
function findFirstOrLastMentionedItem(scrollPosValue) {
  ...
  while (iter !== undefined) {
    ...
    if (nextResult.layoutStart >= layoutStart) {
      ...
      if (tmp4.type === require(7948) /* renderDefaultEmpty */.FastListItemTypes.ITEM) {
        let tmp6 = nextResult;
