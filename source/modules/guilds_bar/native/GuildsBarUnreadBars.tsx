...
// Dependencies: [32, 19, 17, 5919, 4006, 5027, 14936, 14121, 21, 4189, 7675, 1581, 14114, 14123, 636, 643, 589, 4050, 15007, 2]

// Module 15006 (checkNodeAndIterate)
...
function findFirstOrLastMentionedItem(scrollPosValue) {
  ...
  while (iter !== undefined) {
    ...
    if (nextResult.layoutStart >= layoutStart) {
      ...
      if (tmp4.type === require(7675) /* renderDefaultEmpty */.FastListItemTypes.ITEM) {
        let tmp6 = nextResult;
        if (tmp4.layoutStart > diff) {
          ...
          if (tmp4.section < constants.GUILDS) {
            ...
            if (0 !== tmp4.layoutSize) {
              ...
              let tmp8 = nextResult;
              let type = tmp4.type;
              if (tmp41(7675).FastListItemTypes.SECTION === type) {
                ...
                if (tmp41(7675).FastListItemTypes.ITEM === type) {
