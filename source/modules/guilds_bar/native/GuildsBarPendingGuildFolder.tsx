// Module ID: 15322
// Function ID: 15323
// Dependencies: [19, 4101, 676, 21, 15310, 11108, 589, 15302, 4145, 4254, 5215, 1236, 15309, 12197, 2]
...
const memoResult = importAllResult.memo(function GuildsBarPendingGuildFolder(id) {
  ...
  let obj = id(15310);
  importDefault = importDefault(11108)();
