// Module ID: 15425
// Function ID: 15426
// Dependencies: [19, 17, 1375, 676, 21, 15423, 4303, 712, 1348, 15409, 9711, 589, 15426, 15411, 15350, 9719, 1236, 15427, 8744, 15428, 2]
...
const memoResult = importAllResult.memo(function GuildsBarFavorites() {
  ...
  ({ badge, unread } = importDefault(15426)(stateFromStores));
  const tmp8 = importDefault(15426)(stateFromStores);
  ({ badge: badge2, cutouts } = importDefault(15411)({ mentionCount: badge }));
  const ref = importAllResult.useRef(null);
  const tmp9 = importDefault(15411)({ mentionCount: badge });
  const tmp11 = callback();
  const tmp12 = importDefault(15350)();
  const favoritesIntroPopoverDismissibleContent = require(9719) /* items1 */.useFavoritesIntroPopoverDismissibleContent(tmp12);
  ...
  let tmp18 = !tmp3;
  const obj4 = require(9719) /* items1 */;
  ...
  obj[8] = badge2;
  obj[9] = closure_7(require(15427) /* HomeDrawerFavoritesRowExpandedChildren */.HomeDrawerFavoritesRowExpandedChildren, {});
  ...
  const children = [closure_7(importDefault(15409), obj), , ];
