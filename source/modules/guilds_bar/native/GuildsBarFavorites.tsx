// Module ID: 15515
// Function ID: 15516
// Dependencies: [19, 17, 1394, 676, 21, 15513, 4342, 712, 1367, 15499, 9759, 589, 15516, 15501, 15517, 9769, 1236, 15518, 8793, 15519, 2]
...
const memoResult = importAllResult.memo(function GuildsBarFavorites() {
  ...
  let obj1 = require(9759) /* useFavoritesAccess */;
  ...
  ({ badge, unread } = importDefault(15516)(stateFromStores));
  const tmp8 = importDefault(15516)(stateFromStores);
  ({ badge: badge2, cutouts } = importDefault(15501)({ mentionCount: badge }));
  const ref = importAllResult.useRef(null);
  const tmp9 = importDefault(15501)({ mentionCount: badge });
  const tmp11 = callback();
  const tmp12 = importDefault(15517)("GuildsBarFavorites");
  const favoritesIntroPopoverDismissibleContent = require(9769) /* items1 */.useFavoritesIntroPopoverDismissibleContent(tmp12);
  ...
  let tmp18 = !tmp3;
  const obj4 = require(9769) /* items1 */;
  ...
  obj[8] = badge2;
  obj[9] = closure_7(require(15518) /* HomeDrawerFavoritesRowExpandedChildren */.HomeDrawerFavoritesRowExpandedChildren, {});
  const colors = tmp(712).colors;
  obj = { color: isFavoritesGuildSelected ? colors.WHITE : colors.MOBILE_GUILDBAR_ICON_DEFAULT };
  obj[10] = closure_7(require(8793) /* StarIcon */.StarIcon, obj);
  const children = [closure_7(importDefault(15499), obj), , ];
