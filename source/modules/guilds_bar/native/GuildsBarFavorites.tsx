// Module ID: 15350
// Function ID: 15351
// Dependencies: [19, 17, 1375, 676, 21, 15348, 4302, 712, 1348, 15334, 9645, 589, 15351, 15336, 15277, 9653, 1236, 15352, 8684, 15353, 2]
...
const memoResult = importAllResult.memo(function GuildsBarFavorites() {
  ...
  let obj1 = require(9645) /* useFavoritesAccess */;
  ...
  ({ badge, unread } = importDefault(15351)(stateFromStores));
  const tmp8 = importDefault(15351)(stateFromStores);
  ({ badge: badge2, cutouts } = importDefault(15336)({ mentionCount: badge }));
  const ref = importAllResult.useRef(null);
  const tmp9 = importDefault(15336)({ mentionCount: badge });
  const tmp11 = callback();
  const tmp12 = importDefault(15277)();
  const favoritesIntroPopoverDismissibleContent = require(9653) /* items1 */.useFavoritesIntroPopoverDismissibleContent(tmp12);
  ...
  let tmp18 = !tmp3;
  const obj4 = require(9653) /* items1 */;
  ...
  obj[8] = badge2;
  obj[9] = closure_7(require(15352) /* HomeDrawerFavoritesRowExpandedChildren */.HomeDrawerFavoritesRowExpandedChildren, {});
  const colors = tmp(712).colors;
  obj = { color: isFavoritesGuildSelected ? colors.WHITE : colors.MOBILE_GUILDBAR_ICON_DEFAULT };
  obj[10] = closure_7(require(8684) /* StarIcon */.StarIcon, obj);
  const children = [closure_7(importDefault(15334), obj), , ];
