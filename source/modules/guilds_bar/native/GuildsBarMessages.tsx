// Module ID: 15503
// Function ID: 15504
// Dependencies: [19, 4165, 676, 21, 15504, 1367, 15490, 589, 15492, 712, 1236, 15505, 4841, 2]
...
const memoResult = require("noop").memo(function GuildsBarMessages() {
  ...
  return jsx(importDefault(15490), { selected: stateFromStores, circle: null, unread: false, styles: null, cutouts: null, config: null, overState: "y", label: "Grant Channel Access", externalChildren: "Manage Channel Access", expandedChildren: "Guild Scheduled Event Invite Button Embed", children: "REMOVE_AUTOMOD_MESSAGE_NOTICE" });
});
