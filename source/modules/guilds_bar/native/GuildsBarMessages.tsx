// Module ID: 15347
// Function ID: 15348
// Dependencies: [19, 4118, 676, 21, 15348, 1348, 15334, 589, 15336, 712, 1236, 15349, 4798, 2]
...
const memoResult = require("noop").memo(function GuildsBarMessages() {
  ...
  let obj = require(15334) /* UnreadIndicator */;
  ...
  ({ badge, cutouts } = importDefault(15336)({ mentionCount: 0 }));
  ...
  let tmp11 = !tmp3;
  const tmp7 = importDefault(15336)({ mentionCount: 0 });
  ...
  obj[8] = badge;
  obj[9] = jsx(importDefault(15349), {});
  obj[10] = jsx(require(4798) /* ChatIcon */.ChatIcon, { color: tmp8 });
  return jsx(importDefault(15334), { selected: stateFromStores, circle: null, unread: false, styles: null, cutouts: null, config: null, overState: "y", label: "Grant Channel Access", externalChildren: "Manage Channel Access", expandedChildren: "Guild Scheduled Event Invite Button Embed", children: "REMOVE_AUTOMOD_MESSAGE_NOTICE" });
});
