...
// Dependencies: [32, 19, 5217, 15503, 21, 8761, 8033, 1236, 1297, 15504, 5331, 589, 15501, 5844, 2]
// Exports: default

// Module 15502 (GuildFolderSettingsScene)
...
function GuildFolderSettingsScene(arg0) {
  ...
  obj[1] = callback(require(8033) /* Form */.FormInput, obj);
  const items = [callback(require(8033) /* Form */.FormSection, obj), ];
  const obj1 = { title: null, children: null };
  const intl3 = require(1236) /* getSystemLocale */.intl;
  obj1[0] = intl3.string(require(1236) /* getSystemLocale */.t.xpurRF);
  obj1[1] = callback(importDefault(15504), { color, onChange: onColorChange });
  items[1] = callback(require(8033) /* Form */.FormSection, obj1);
  obj[0] = items;
  return callback2(require(8033) /* Form */.Form, obj);
}
