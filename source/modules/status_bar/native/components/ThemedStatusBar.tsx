...
// Dependencies: [19, 1302, 1218, 21, 589, 4152, 4147, 10699, 7688, 2]
// Exports: default

// Module 13767 (ThemedStatusBar)
import "noop";
...
export default function ThemedStatusBar() {
  ...
  const globalStatusIndicatorState = require(10699) /* useGlobalStatusIndicatorState */.useGlobalStatusIndicatorState();
  if (!stateFromStores) {
    obj = { barStyle: null };
    obj[0] = "light-content";
    return jsx(importDefault(7688), { barStyle: null });
  } else if (isModalOpen) {
