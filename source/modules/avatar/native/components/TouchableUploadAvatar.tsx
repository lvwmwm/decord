...
// Dependencies: [31, 27, 33, 4131, 689, 12932, 4661, 1212, 5085, 1273, 11807, 2]
// Exports: default

// Module 16184 (TouchableUploadAvatar)
import "result";
...
export default function TouchableUploadAvatar(onSelectAvatar) {
  ...
  if (showPendingAvatar) {
    ...
    const obj3 = { size: require(1273) /* Button */.Icon.Sizes.MEDIUM, source: importDefault(11807), style: tmp.uploadAvatarIcon };
