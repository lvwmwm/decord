...
// Dependencies: [19, 17, 21, 16362, 16363, 16364, 16365, 16366, 16367, 16368, 16369, 1236, 4255, 712, 4251, 4797, 5221, 2]
// Exports: default

// Module 16361 (DefaultAvatarButton)
import "noop";
...
function DefaultAvatarButton(selected) {
  ...
  obj[6] = closure_4(importDefault(5221), obj);
