...
// Dependencies: [5, 32, 19, 17, 8002, 676, 21, 4445, 712, 5444, 5413, 1629, 589, 14210, 16927, 8011, 8042, 5034, 8006, 8008, 4441, 1236, 16936, 1297, 4880, 16924, 503, 6189, 5447, 5960, 2]

// Module 16926 (AddAvatarScreen)
...
function AddAvatarScreen() {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              obj2[0] = closure_1_0(5034).openImagePicker(obj1);
              return obj2;
            }
          } else if (arg0 === 1) {
            c3 = 3;
  ...
  if (null != first) {
    let tmp9Result = tmp9(14210);
    obj = { imageUri: null, description: null };
    obj[0] = tmp9(16927).DEFAULT_AVATARS[first];
    tmp9Result = tmp9(8011);
  ...
  obj1[1] = items3;
  const items4 = [closure_10(View, obj1), callback(first(16927), { onAvatarSelect: tmp4[1], selectedAvatar: first }), ];
  ...
  constructor() {
    memo = closure_5.useMemo(() => {
      ...
      obj = {
        ...
        headerTitle: callback(5447).getHeaderNoTitle(),
        ignoreKeyboard: true,
        fullscreen: true,
        render() {
