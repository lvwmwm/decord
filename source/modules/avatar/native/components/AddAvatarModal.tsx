...
// Dependencies: [5, 32, 19, 17, 8016, 676, 21, 4446, 712, 5457, 5426, 1629, 589, 14180, 16945, 8025, 8056, 5047, 8020, 8022, 4442, 1236, 16954, 1297, 4893, 16942, 503, 6202, 5460, 5973, 2]

// Module 16944 (AddAvatarScreen)
...
function AddAvatarScreen() {
  ...
  if (null != first) {
    let tmp9Result = tmp9(14180);
    obj = { imageUri: null, description: null };
    obj[0] = tmp9(16945).DEFAULT_AVATARS[first];
    tmp9Result = tmp9(8025);
  ...
  obj1[1] = items3;
  const items4 = [closure_10(View, obj1), callback(first(16945), { onAvatarSelect: tmp4[1], selectedAvatar: first }), ];
  ...
  constructor() {
    memo = closure_5.useMemo(() => {
      ...
      obj = {
        ...
        headerTitle: callback(5460).getHeaderNoTitle(),
        ignoreKeyboard: true,
        fullscreen: true,
        render() {
