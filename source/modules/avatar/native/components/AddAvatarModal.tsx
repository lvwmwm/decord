...
// Dependencies: [5, 32, 19, 17, 8305, 676, 21, 4344, 712, 5306, 5275, 1628, 589, 13968, 16581, 8319, 8348, 4900, 8309, 8311, 4340, 1236, 16590, 1297, 4754, 16578, 503, 6049, 5309, 5822, 2]

// Module 16580 (AddAvatarScreen)
...
function AddAvatarScreen() {
  ...
  if (null != first) {
    let tmp9Result = tmp9(13968);
    obj = { imageUri: null, description: null };
    obj[0] = tmp9(16581).DEFAULT_AVATARS[first];
    tmp9Result = tmp9(8319);
  ...
  let num = 16;
  const tmp9Result1 = require(8348) /* useDominantRGBFromImage */;
  if (bottom > 0) {
    num = bottom;
  }
  ...
  const memoizedImageSourceResult = require(8348) /* useDominantRGBFromImage */.memoizedImageSource(imageUri);
  items3[1] = callback(first(16590), {
    avatarSource: require(8348) /* useDominantRGBFromImage */.memoizedImageSource(imageUri),
  ...
  obj1[1] = items3;
  const items4 = [closure_10(View, obj1), callback(first(16581), { onAvatarSelect: tmp4[1], selectedAvatar: first }), ];
  ...
  obj8[1] = callback(require(4754) /* Button */.Button, obj9);
    ...
    memo = useAvatarsWithGuilds.useMemo(() => {
      ...
      obj = {
        ...
        headerRight() {
          ...
          return callback2(callback(6049).HeaderActionButton, obj);
        },
        headerLeft() {
          return null;
        },
      ...
      obj[3] = callback(5309).getHeaderNoTitle();
