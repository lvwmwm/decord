...
const memoResult = importAllResult.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    obj9[0] = tmp4(4379).getName(stateFromStores1, channelId, stateFromStores);
    obj8[4] = intl.format(tmp7(1236).t["WrQD/Y"], obj9);
    items7[1] = closure_13(tmp7(4185).Text, obj8);
    ...
    items7[2] = closure_13(tmp7(4185).Text, obj10);
    obj2[1] = items7;
    ...
    obj14[3] = closure_13(tmp7(4185).Text, obj16);
    ...
    obj13[2] = closure_13(tmp7(5220).TableRow, obj14);
    obj12[1] = closure_13(tmp7(5554).TableRowGroup, obj13);
    ...
    obj18[3] = tmp3;
    obj18[4] = tmp3;
    const items9 = [closure_13(tmp7(4600).Button, obj18), ];
    ...
    items9[1] = closure_13(tmp7(4185).Text, obj19);
    obj17[1] = items9;
    items8[3] = closure_14(stateFromStores, obj17);
    obj4[0] = items8;
    obj[4] = closure_14(tmp7(5245).BottomSheetScrollView, obj4);
    obj[1] = closure_13(tmp7(5243).BottomSheet, obj);
    tmp12Result = tmp12(tmp7(5515).AnalyticsLocationProvider, obj);
    const tmp20 = stateFromStores1;
    const tmp4Result = tmp4(4379);
  }
  return tmp12Result;
});
