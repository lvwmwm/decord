...
// Function ID: 15450
// Name: items
// Dependencies: [1434, 1910, 1922, 676, 589, 5919, 2]
...
export const canSeeCreatorMonetizationOnboardingV2Upsell = function canSeeCreatorMonetizationOnboardingV2Upsell(arg0) {
  ...
  if (null == guild) {
    ...
    if (null == currentUser) {
      ...
      const guildRoleSubscriptionSettingsVisibility = guild(5919).getGuildRoleSubscriptionSettingsVisibility(guild);
      let tmp5 = guildRoleSubscriptionSettingsVisibility === guild(5919).GuildRoleSubscriptionSettingsVisibility.VISIBLE;
      const obj = guild(5919);
