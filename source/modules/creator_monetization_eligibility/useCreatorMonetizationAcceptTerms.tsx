...
// Dependencies: [5, 32, 19, 1415, 1891, 1903, 589, 5881, 16772, 4203, 2]
// Exports: default

// Module 16771 (useCreateCreatorMonetizationAcceptTermsRequest)
...
export default function useCreateCreatorMonetizationAcceptTermsRequest(arg0, arg1) {
  ...
  isExpeditedOnboardingGuild = _require(5881).useIsExpeditedOnboardingGuild(stateFromStores);
  obj = { canSubmitAcceptance: null, error: null, loading: null, submitAcceptTermsRequest: null };
  let obj2 = _require(5881);
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            if (null != outer1_0) {
              ...
              if (null != outer1_1) {
                ...
                obj1[0] = outer1_2(16772).acceptCreatorMonetizationTerms(tmp56, tmp42);
                return obj1;
              } else {
                let obj2 = outer1_2(16772);
                v0 = 3;
                c5 = 1;
          ...
          if (2 === tmp8) {
            dependencyMap = 1;
            closure_0 = closure_2;
            const tmp25 = new outer1_1(4203)(closure_0);
            dependencyMap(tmp25);
          } else {
            if (3 === tmp8) {
              if (arg0 === 1) {
