...
// Dependencies: [5, 32, 19, 1434, 1910, 1922, 589, 5988, 17031, 4279, 2]
// Exports: default

// Module 17030 (useCreateCreatorMonetizationAcceptTermsRequest)
...
export default function useCreateCreatorMonetizationAcceptTermsRequest(arg0, arg1) {
  ...
  isExpeditedOnboardingGuild = _require(5988).useIsExpeditedOnboardingGuild(stateFromStores);
  obj = { canSubmitAcceptance: null, error: null, loading: null, submitAcceptTermsRequest: null };
  let obj2 = _require(5988);
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            if (null != closure_1_0) {
              ...
              if (null != closure_1_1) {
                ...
                obj1[0] = closure_1_2(17031).acceptCreatorMonetizationTerms(tmp56, tmp42);
                return obj1;
              } else {
                let obj2 = closure_1_2(17031);
                v0 = 3;
                c5 = 1;
          ...
          if (2 === tmp8) {
            dependencyMap = 1;
            closure_0 = closure_2;
            const tmp25 = new closure_1_1(4279)(closure_0);
            dependencyMap(tmp25);
          } else {
            if (3 === tmp8) {
              if (arg0 === 1) {
