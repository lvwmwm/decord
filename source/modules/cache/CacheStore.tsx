...
// Dependencies: [32, 5, 4945, 1218, 1931, 4072, 676, 3, 595, 1928, 6830, 6841, 9, 10, 1927, 6842, 6843, 6844, 6845, 6846, 6999, 7020, 589, 709, 1926, 7005, 7011, 7009, 7003, 1866, 7021, 500, 1352, 7023, 1923, 2]

// Module 6829 (handleClearCaches)
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            const obj10 = callback2(6841);
            const result = obj10.recordChannelFetchedLocal(callback2, callback(6841).INITIAL_MESSAGE_FETCH_KEY, null, null, closure_9, getToken.messages);
            ...
            if (0 === guildId) {
              if (arg0 === 1) {
                ...
                if (null == verboseResult) {
                  ...
                  resolved = callback(10).timeAsync("\u{1F4BE}", "cache: user_settings", () => callback2(6842).getAll(closure_0));
                  const obj9 = callback(10);
                }
                if (null == verboseResult) {
                  let resolved1 = Promise.resolve([]);
                } else {
                  resolved1 = callback(10).timeAsync("\u{1F4BE}", "cache: read_states", () => callback2(6843).getAll(closure_0));
                ...
                if (null == verboseResult) {
                  ...
                  resolveResult = callback(10).timeAsync("\u{1F4BE}", "cache: user_guild_settings", () => callback2(6844).getAll(closure_0));
                  const obj11 = callback(10);
                }
                callback(6845)("AllCacheStores", () => callback(6846));
                callback(6845)("MobileAppDatabaseManager", () => callback(6999));
                let items = [
                  result,
                  measureAsyncResult,
              ...
              if (arg0 === 1) {
                ...
                verboseResult = null;
                if (null == closure_11) {
                  callback(7020)("database:history_cache_null");
            ...
            if (arg0 === 1) {
              ...
              if (null != table) {
                if ("@me" !== table) {
                  ...
                  obj7[0] = obj1.tryLoadAsync(() => callback(7005).getOneAsync(closure_0, dependencyMap));
                  return obj7;
                }
              }
              c7 = 3;
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            callback4(() => {
              if (false === c6) {
                callback2(7020)("database:not_ok");
                ...
                if (null != c7) {
                  if (null != closure_8) {
                    if (null != closure_9) {
                      if (null == c6) {
                        callback2(7020)("database:versionless");
                      ...
                      if (outer1_18) {
                        callback2(7020)("already_connected");
                ...
                callback2(7020)("database:load_failed");
            ...
            if (arg0 === 1) {
              ...
              if (c5) {
                ...
                obj7[0] = (function dontLoadLateLazyCache() {
                  const f118393 = () => lib(709).dispatch({ type: "CACHE_LOADED_LAZY_NO_CACHE" });
