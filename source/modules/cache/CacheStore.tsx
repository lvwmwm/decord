...
// Dependencies: [32, 5, 4869, 1218, 1931, 4010, 676, 3, 595, 1928, 5738, 5749, 9, 10, 1927, 5750, 5751, 5752, 5753, 5754, 5934, 5955, 589, 709, 1926, 5940, 5946, 5944, 5938, 1866, 5956, 500, 1352, 5958, 1923, 2]
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            const obj10 = callback2(5749);
            const result = obj10.recordChannelFetchedLocal(callback2, callback(5749).INITIAL_MESSAGE_FETCH_KEY, null, null, closure_9, getToken.messages);
            ...
            if (0 === guildId) {
              if (arg0 === 1) {
                ...
                if (null == verboseResult) {
                  ...
                  resolved = callback(10).timeAsync("\u{1F4BE}", "cache: user_settings", () => callback2(5750).getAll(closure_0));
                  const obj9 = callback(10);
                }
                if (null == verboseResult) {
                  let resolved1 = Promise.resolve([]);
                } else {
                  resolved1 = callback(10).timeAsync("\u{1F4BE}", "cache: read_states", () => callback2(5751).getAll(closure_0));
                ...
                if (null == verboseResult) {
                  ...
                  resolveResult = callback(10).timeAsync("\u{1F4BE}", "cache: user_guild_settings", () => callback2(5752).getAll(closure_0));
                  const obj11 = callback(10);
                }
                callback(5753)("AllCacheStores", () => callback(5754));
                callback(5753)("MobileAppDatabaseManager", () => callback(5934));
                let items = [
                  result,
                  measureAsyncResult,
              ...
              if (arg0 === 1) {
                ...
                verboseResult = null;
                if (null == closure_11) {
                  callback(5955)("database:history_cache_null");
            ...
            if (arg0 === 1) {
              ...
              if (null != table) {
                if ("@me" !== table) {
                  ...
                  obj7[0] = obj1.tryLoadAsync(() => callback(5940).getOneAsync(closure_0, dependencyMap));
                  return obj7;
                }
              }
              c7 = 3;
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            callback4(() => {
              if (false === c6) {
                callback2(5955)("database:not_ok");
                ...
                if (null != c7) {
                  if (null != closure_8) {
                    if (null != closure_9) {
                      if (null == c6) {
                        callback2(5955)("database:versionless");
                      ...
                      if (outer1_18) {
                        callback2(5955)("already_connected");
                ...
                callback2(5955)("database:load_failed");
            ...
            if (arg0 === 1) {
              ...
              if (c5) {
                ...
                obj7[0] = (function dontLoadLateLazyCache() {
                  const f118172 = () => lib(709).dispatch({ type: "CACHE_LOADED_LAZY_NO_CACHE" });
