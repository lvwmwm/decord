...
// Dependencies: [32, 5, 5035, 1218, 1979, 4165, 676, 3, 595, 1976, 6984, 6995, 9, 10, 1975, 6996, 6997, 6998, 6999, 7000, 7151, 7172, 589, 709, 1974, 7157, 7163, 7161, 7155, 1914, 7173, 500, 1371, 7175, 1971, 2]

// Module 6983 (handleClearCaches)
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            const obj10 = callback2(6995);
            const result = obj10.recordChannelFetchedLocal(callback2, callback(6995).INITIAL_MESSAGE_FETCH_KEY, null, null, closure_9, getToken.messages);
            ...
            if (0 === guildId) {
              if (arg0 === 1) {
                ...
                if (null == verboseResult) {
                  ...
                  resolved = callback(10).timeAsync("\u{1F4BE}", "cache: user_settings", () => callback2(6996).getAll(closure_0));
                  const obj9 = callback(10);
                }
                if (null == verboseResult) {
                  let resolved1 = Promise.resolve([]);
                } else {
                  resolved1 = callback(10).timeAsync("\u{1F4BE}", "cache: read_states", () => callback2(6997).getAll(closure_0));
                ...
                if (null == verboseResult) {
                  ...
                  resolveResult = callback(10).timeAsync("\u{1F4BE}", "cache: user_guild_settings", () => callback2(6998).getAll(closure_0));
                  const obj11 = callback(10);
                }
                callback(6999)("AllCacheStores", () => callback(7000));
                callback(6999)("MobileAppDatabaseManager", () => callback(7151));
                let items = [
                  result,
                  measureAsyncResult,
              ...
              if (arg0 === 1) {
                ...
                verboseResult = null;
                if (null == closure_11) {
                  callback(7172)("database:history_cache_null");
            ...
            if (arg0 === 1) {
              ...
              if (null != table) {
                if ("@me" !== table) {
                  ...
                  obj7[0] = obj1.tryLoadAsync(() => callback(7157).getOneAsync(closure_0, dependencyMap));
                  return obj7;
                }
              }
              c7 = 3;
          ...
          if (0 === c6) {
            if (arg0 === 1) {
              ...
              obj1[0] = fetchLazyCache.measureAsync(() => {
                ...
                let obj = callback(1974);
                items[1] = callback(1974).tryLoadAsync(() => {
                  if (null != closure_0) {
                    if (!outer1_22) {
                ...
                items[2] = callback(1974).tryLoadAsync(() => {
                  if (null != closure_0) {
                ...
                if (null != callback) {
                  if (null != closure_8) {
                    if (closure_8.stale.length > 0) {
                      let tryLoadAsyncResult = callback(1974).tryLoadAsync(() => {
                        stale = stale.stale;
            ...
            callback4(() => {
              if (false === c6) {
                callback2(7172)("database:not_ok");
                ...
                if (null != c7) {
                  if (null != closure_8) {
                    if (null != closure_9) {
                      if (null == c6) {
                        callback2(7172)("database:versionless");
                      ...
                      if (outer1_18) {
                        callback2(7172)("already_connected");
                ...
                callback2(7172)("database:load_failed");
            ...
            if (arg0 === 1) {
              ...
              if (c5) {
                ...
                obj7[0] = (function dontLoadLateLazyCache() {
                  const f119624 = () => lib(709).dispatch({ type: "CACHE_LOADED_LAZY_NO_CACHE" });
