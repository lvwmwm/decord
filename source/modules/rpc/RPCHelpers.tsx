...
// Dependencies: [5, 4322, 4308, 1376, 1911, 1372, 1891, 4332, 4502, 4371, 1903, 4301, 4188, 676, 1467, 4273, 687, 12, 6838, 4275, 4513, 10542, 4474, 1469, 8825, 530, 10536, 10511, 10543, 2]
...
// Module 10541 (recurseReplaceContentTree)
...
function transformInternalTextMessage(message) {
  ...
  let tmp13;
  if (null != tmp4) {
    tmp13 = importDefault(10542)(tmp4);
  }
  obj[15] = tmp13;
...
function transformVoiceState(closure_2, id, userId) {
  ...
  if (null == user) {
    ...
    obj[4] = suppress;
    obj[4] = obj;
    obj[5] = importDefault(10542)(user);
    return obj;
  }
}
...
export const transformBaseRelationship = function transformBaseRelationship(relationshipType, user) {
  let obj = { type: relationshipType, user: importDefault(10542)(user), presence: null };
...
export const hasMessageReadPermission = function hasMessageReadPermission(channel, id, scopes) {
  ...
  if (!tmp2) {
    tmp2 = scopes.indexOf(require(8825) /* set */.OAuth2Scopes.MESSAGES_READ) > -1;
  }
  return tmp2;
};
...
export const validateApplication = function validateApplication(application) {
  if (null == application.id) {
    const obj = { errorCode: null };
    obj[0] = constants4.INVALID_COMMAND;
    const tmp7 = new importDefault(10536)(obj, "Invalid application");
    throw tmp7;
  } else {
