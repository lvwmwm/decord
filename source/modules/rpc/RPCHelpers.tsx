...
// Dependencies: [5, 4522, 4507, 1390, 1934, 1386, 1908, 4532, 4743, 4572, 1921, 4500, 4383, 673, 1485, 4468, 684, 12, 7390, 4471, 4754, 9489, 4680, 1487, 8269, 527, 9483, 9441, 9490, 2]
...
// Module 9488 (recurseReplaceContentTree)
...
import importDefaultResult1 from "set" /* 4468 */;
          ...
          if (0 === name) {
            if (arg0 === 1) {
              ...
              if (typeof dependencyMap === "string") {
                if (tmp67.transport === closure_1_16.POST_MESSAGE) {
                  const tmp21 = callback(9441)(tmp68);
                  if (null != tmp21) {
                    const items = [tmp21];
                  }
                  obj1 = { closeCode: null };
                  obj1[0] = closure_1_21.INVALID_ORIGIN;
                  const tmp52 = new callback(9483)(obj1, "Invalid Origin");
                  throw tmp52;
                } else {
                  name = 1;
                  icon = 1;
            ...
            if (arg0 === 1) {
              ...
              if (!callback3(dependencyMap, rpc_origins.rpc_origins)) {
                ...
                const tmp16 = new callback(9483)(obj6, "Invalid Origin");
                throw tmp16;
              }
            }
          } else if (arg0 === 1) {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == obj2) {
                ...
                const tmp24 = new callback(9490)(num5, closure_1_25);
                tmp38[tmp35] = tmp24;
                obj2 = tmp24;
              }
              c6 = 1;
            ...
            const tmp16 = new callback(9483)(obj2, "Socket closed during throttle");
            throw tmp16;
          } else if (arg0 === 1) {
            c7 = 3;
            throw arg1;
