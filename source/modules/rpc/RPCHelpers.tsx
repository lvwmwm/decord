...
// Dependencies: [5, 4339, 4325, 1376, 1911, 1372, 1891, 4349, 4519, 4388, 1903, 4318, 4205, 676, 1467, 4290, 687, 12, 6857, 4292, 4530, 10676, 4491, 1469, 8842, 530, 10670, 10527, 10677, 2]
...
// Module 10675 (recurseReplaceContentTree)
...
function transformInternalTextMessage(message) {
  ...
  let userAuthor;
  if (null != message.author) {
    userAuthor = require(4530) /* useNullableMessageAuthor */.getUserAuthor(tmp4, channel);
    const obj3 = require(4530) /* useNullableMessageAuthor */;
  }
  ...
  let tmp13;
  if (null != tmp4) {
    tmp13 = importDefault(10676)(tmp4);
  }
  obj[15] = tmp13;
...
function transformVoiceState(closure_2, id, userId) {
  ...
  if (null == user) {
    ...
    obj[0] = importDefault(4491).getName(closure_2, id, user);
    ...
    obj[4] = suppress;
    obj[4] = obj;
    obj[5] = importDefault(10676)(user);
    return obj;
  }
}
...
export const transformBaseRelationship = function transformBaseRelationship(relationshipType, user) {
  let obj = { type: relationshipType, user: importDefault(10676)(user), presence: null };
...
export const hasMessageReadPermission = function hasMessageReadPermission(channel, id, scopes) {
  ...
  if (!tmp2) {
    tmp2 = scopes.indexOf(require(8842) /* set */.OAuth2Scopes.MESSAGES_READ) > -1;
  }
  return tmp2;
};
...
export const validateApplication = function validateApplication(application) {
  if (null == application.id) {
    const obj = { errorCode: null };
    obj[0] = constants4.INVALID_COMMAND;
    const tmp7 = new importDefault(10670)(obj, "Invalid application");
    throw tmp7;
  } else {
