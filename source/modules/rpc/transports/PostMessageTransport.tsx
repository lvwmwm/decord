...
// Function ID: 9482
// Name: map
// Dependencies: [5, 32, 1385, 4383, 673, 684, 9482, 649, 1228, 695, 4110, 9483, 9485, 2008, 9486, 2]

// Module 9481 (map)
import setDefault from "set" /* 684 */;
import HANDSHAKEDefault from "HANDSHAKE" /* 9482 */;
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "_slicedToArray" /* 32 */;
import closure_5 from "participantFromServer" /* 1385 */;
import { RPC_EMBEDDED_APP_SCOPE } from "RPC_SCOPE_CONFIG" /* 4383 */;
    ...
    tmp4.handleIFrameMount = function handleIFrameMount(id) {
      ...
      closure_0.handshakeFailureTimeoutId = setTimeout(() => {
        ...
        const item = Array.from(selfEmbeddedActivities.entries()).forEach((arg0) => {
          ...
          obj = { application_id: tmp, channel_id: callback(4110).getEmbeddedActivityLocationChannelId(tmp2.location), guild_id: null, timeout_ms: null };
          const obj3 = callback(4110);
          obj[2] = callback(4110).getEmbeddedActivityLocationGuildId(tmp2.location);
          obj[3] = closure_11;
  ...
  if (Array.isArray(arg2)) {
    ...
    if (HANDSHAKEDefault.HANDSHAKE === tmp5) {
      if (null != value) {
        ...
        const tmp35 = new tmp7(9483)(obj, "Already connected");
        throw tmp35;
      } else {
        return self.handleHandshake(iframeId, tmp6, arg3);
      }
    } else if (tmp7(9482).FRAME === tmp5) {
      if (null == value) {
        obj = { closeCode: null };
        obj[0] = constants2.CLOSE_UNSUPPORTED;
        const tmp27 = new tmp7(9483)(obj, "Not connected");
        throw tmp27;
      } else {
        return self.handleFrame(iframeId, value, tmp6);
      }
    } else if (tmp7(9482).CLOSE === tmp5) {
      if (null == value) {
        obj1 = { closeCode: null };
        obj1[0] = constants2.CLOSE_UNSUPPORTED;
        const tmp20 = new tmp7(9483)(obj1, "Not connected");
        throw tmp20;
      } else {
      ...
      obj = { closeCode: null };
      obj[0] = constants2.CLOSE_UNSUPPORTED;
      const tmp13 = new tmp7(9483)(obj, "Invalid opcode");
      throw tmp13;
    }
