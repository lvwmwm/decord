...
// Function ID: 10710
// Name: map
// Dependencies: [5, 32, 1390, 4245, 676, 687, 10710, 652, 1231, 698, 3979, 10711, 10713, 2007, 10714, 2]
...
function postClose(source, arg1, postMessageToRPCClient) {
  const items = [importDefault(10710).CLOSE, arg1];
...
class PostMessageTransport extends EventEmitter {
  constructor(arg0, arg1, arg2, arg3) {
    ...
    f108641 = undefined;
    closure_1 = tmp4;
    f108641 = closure_3((arg0, arg1, arg2) => {
      let closure_0 = arg0;
      let closure_1 = arg1;
      let closure_2 = arg2;
      let c8 = 0;
...
PostMessageTransport.prototype["routeEvent"] = function routeEvent(value, iframeId, arg2, arg3) {
  ...
  if (Array.isArray(arg2)) {
    ...
    if (importDefault(10710).HANDSHAKE === tmp5) {
      if (null != value) {
        let obj = { closeCode: null };
        obj[0] = constants2.CLOSE_UNSUPPORTED;
        const tmp35 = new tmp7(10711)(obj, "Already connected");
        throw tmp35;
      } else {
        return self.handleHandshake(iframeId, tmp6, arg3);
      }
    } else if (tmp7(10710).FRAME === tmp5) {
      if (null == value) {
        obj = { closeCode: null };
        obj[0] = constants2.CLOSE_UNSUPPORTED;
        const tmp27 = new tmp7(10711)(obj, "Not connected");
        throw tmp27;
      } else {
        return self.handleFrame(iframeId, value, tmp6);
      }
    } else if (tmp7(10710).CLOSE === tmp5) {
      if (null == value) {
        const obj1 = { closeCode: null };
        obj1[0] = constants2.CLOSE_UNSUPPORTED;
        const tmp20 = new tmp7(10711)(obj1, "Not connected");
        throw tmp20;
      } else {
      ...
      obj = { closeCode: null };
      obj[0] = constants2.CLOSE_UNSUPPORTED;
      const tmp13 = new tmp7(10711)(obj, "Invalid opcode");
      throw tmp13;
    }
