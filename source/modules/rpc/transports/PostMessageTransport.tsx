...
// Function ID: 10669
// Name: map
// Dependencies: [5, 32, 1371, 4205, 676, 687, 10669, 652, 1231, 698, 3919, 10670, 10672, 1988, 10673, 2]
...
function postClose(source, arg1, postMessageToRPCClient) {
  const items = [importDefault(10669).CLOSE, arg1];
...
PostMessageTransport.prototype["routeEvent"] = function routeEvent(value, iframeId, arg2, arg3) {
  ...
  if (Array.isArray(arg2)) {
    ...
    if (importDefault(10669).HANDSHAKE === tmp5) {
      if (null != value) {
        let obj = { closeCode: null };
