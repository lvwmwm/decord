...
// Dependencies: [9403, 1391, 1910, 4090, 4348, 676, 9404, 9442, 14055, 9682, 2]
// Exports: validateOpenInviteDialog

// Module 14067 (validateOpenInviteDialog)
  ...
  if (socket.source.type !== TransportTypes.POST_MESSAGE) {
    ...
    if (null != tmp46) {
      ...
      if (null == obj9) {
        ...
        const tmp21 = new tmp48(9442)(obj3, "Invalid channel");
        throw tmp21;
      } else {
