...
// Dependencies: [9439, 1386, 1908, 4120, 4383, 673, 9440, 9483, 14393, 9703, 2]
// Exports: validateOpenInviteDialog

// Module 14405 (validateOpenInviteDialog)
  ...
  if (socket.source.type !== TransportTypes.POST_MESSAGE) {
    ...
    if (null != tmp46) {
      ...
      if (constants.MAIN === type) {
        obj = { frame: null, channel: "Array", guild: "context" };
        obj[0] = tmp46;
        return obj;
      ...
      if (null == obj9) {
        ...
        const tmp21 = new tmp48(9483)(obj3, "Invalid channel");
        throw tmp21;
      } else {
