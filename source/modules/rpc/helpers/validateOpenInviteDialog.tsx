...
// Dependencies: [10592, 1372, 1891, 3929, 4206, 676, 10593, 10737, 13737, 8959, 2]
// Exports: validateOpenInviteDialog

// Module 13748 (validateOpenInviteDialog)
import map from "map";
  ...
  if (socket.source.type !== TransportTypes.POST_MESSAGE) {
    ...
    if (null != tmp46) {
      ...
      if (constants.MAIN === type) {
        obj = { frame: null, channel: "Array", guild: "call" };
        obj[0] = tmp46;
        return obj;
        ...
        const tmp30 = new importDefault(10737)(obj2, "Invalid channel");
        throw tmp30;
      }
    } else {
      const obj9 = importDefault(13737)();
      if (null == obj9) {
        const obj3 = { errorCode: null };
        obj3[0] = RPCErrors.INVALID_CHANNEL;
        const tmp21 = new tmp48(10737)(obj3, "Invalid channel");
        throw tmp21;
      } else {
        ...
        if (null == guild) {
          ...
          obj10 = require(8959) /* canViewInviteModal */;
        }
      }
    }
  }
