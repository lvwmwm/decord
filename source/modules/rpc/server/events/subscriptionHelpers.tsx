...
// Dependencies: [1385, 9477, 7458, 4380, 673, 4506, 9478, 9530, 5079, 14341, 7479, 2]
// Exports: getInitialSubscriptionPayload

// Module 14380 (getInitialSubscriptionPayload)
...
import useThermalState from "useThermalState" /* 9530 */;
