...
// Dependencies: [1390, 10582, 7228, 4245, 676, 4370, 10583, 10966, 4912, 13802, 7251, 2]
// Exports: getInitialSubscriptionPayload

// Module 13839 (getInitialSubscriptionPayload)
...
export const getInitialSubscriptionPayload = function getInitialSubscriptionPayload(closure_1, participantFromServer, c3) {
  if (RPCEvents.ACTIVITY_PIP_MODE_UPDATE === participantFromServer) {
    ...
    const thermalState = require(10966) /* useThermalState */.getThermalState();
    let tmp23 = null;
    if (thermalState !== require(10966) /* useThermalState */.ThermalStates.UNHANDLED) {
    ...
    let obj3 = require(4912) /* getIsScreenLandscape */;
    ...
    obj2 = require(13802) /* activityInstanceConnectedParticipants */;
    ...
    if (quest_id) {
      ...
      obj = require(7251) /* getApplicationIdsByTaskTypes */;
