...
// Dependencies: [4341, 4323, 1415, 4322, 1372, 1971, 1891, 4351, 4375, 1903, 4319, 4206, 676, 10739, 10741, 10736, 4517, 8902, 12, 13731, 506, 643, 10742, 13784, 13785, 2]

// Module 13783 (messageEventsValidation)
...
obj[RPCEvents.RELATIONSHIP_UPDATE] = {
  ...
  handler(socket) {
    ...
    if (obj.has(deserializeResult, tmpResult.deserialize(constants.DISABLE_RELATIONSHIPS_ACCESS))) {
      ...
      const tmp9 = new importDefault(10736)(obj, "Missing Permissions");
      throw tmp9;
    }
    tmpResult = tmp(506);
  }
