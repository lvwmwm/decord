...
// Dependencies: [4478, 4504, 1434, 4652, 1391, 1990, 1910, 4497, 4539, 1922, 4542, 4277, 676, 8755, 8757, 8752, 5252, 4375, 12, 13834, 506, 643, 8758, 13887, 13888, 2]

// Module 13886 (messageEventsValidation)
...
function messageEvents(args) {
  ...
  if (null != channel) {
    ...
    obj4 = require(8757) /* recurseReplaceContentTree */;
    tmp13 = require;
  }
  obj = { errorCode: constants2.INVALID_CHANNEL };
  let tmp11 = importDefault(8752);
...
obj[RPCEvents.RELATIONSHIP_UPDATE] = {
  ...
  handler(socket) {
    ...
    if (obj.has(deserializeResult, tmpResult.deserialize(constants.DISABLE_RELATIONSHIPS_ACCESS))) {
      ...
      const tmp9 = new importDefault(8752)(obj, "Missing Permissions");
      throw tmp9;
    }
    tmpResult = tmp(506);
  }
