...
// Dependencies: [4202, 4185, 1391, 4184, 1348, 1918, 1838, 4212, 4237, 1850, 4181, 4068, 653, 10595, 10597, 10592, 4380, 8150, 22, 13500, 483, 620, 10598, 13553, 13554, 2]

// Module 13552 (messageEventsValidation)
...
function messageEvents(args) {
  ...
  if (null != channel) {
    ...
    obj4 = require(10597) /* recurseReplaceContentTree */;
  }
