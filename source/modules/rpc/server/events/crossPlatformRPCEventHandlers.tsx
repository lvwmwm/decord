...
// Dependencies: [4226, 4209, 1415, 4208, 1372, 1942, 1862, 4236, 4261, 1874, 4205, 4092, 676, 10629, 10631, 10626, 4403, 8174, 12, 13523, 506, 643, 10632, 13576, 13577, 2]

// Module 13575 (messageEventsValidation)
...
function messageEvents(args) {
  ...
  if (null != channel) {
    ...
    obj4 = require(10631) /* recurseReplaceContentTree */;
    tmp13 = require;
  }
  obj = { errorCode: constants2.INVALID_CHANNEL };
  let tmp11 = importDefault(10626);
...
obj[RPCEvents.RELATIONSHIP_UPDATE] = {
  ...
  handler(socket) {
    ...
    if (obj.has(deserializeResult, tmpResult.deserialize(constants.DISABLE_RELATIONSHIPS_ACCESS))) {
      ...
      const tmp9 = new importDefault(10626)(obj, "Missing Permissions");
      throw tmp9;
    }
    tmpResult = tmp(506);
  }
...
obj38[1] = function handler() {
  return (prevState) => {
    ...
    if (!tmp) {
      prevState.dispatch(callback(10632)(obj.currentUser));
    }
    return obj;
  };
};
...
obj44[1] = function handler() {
  return (arg0) => {
    ...
    let tmp8 = null;
    if (null != application) {
      tmp8 = callback(13577)(application);
    }
    if (streamerActiveStreamMetadata != null) {
