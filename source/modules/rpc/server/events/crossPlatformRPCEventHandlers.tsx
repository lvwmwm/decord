...
// Dependencies: [4341, 4323, 1415, 4322, 1372, 1971, 1891, 4351, 4375, 1903, 4319, 4206, 676, 10740, 10742, 10737, 4517, 8902, 12, 13733, 506, 643, 10743, 13786, 13787, 2]

// Module 13785 (messageEventsValidation)
...
obj[RPCEvents.RELATIONSHIP_UPDATE] = {
  ...
  handler(socket) {
    ...
    if (obj.has(deserializeResult, tmpResult.deserialize(constants.DISABLE_RELATIONSHIPS_ACCESS))) {
      ...
      const tmp9 = new importDefault(10737)(obj, "Missing Permissions");
      throw tmp9;
    }
    tmpResult = tmp(506);
  }
