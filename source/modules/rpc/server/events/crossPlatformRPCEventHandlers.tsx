...
// Dependencies: [4382, 4364, 1434, 4363, 1391, 1990, 1910, 4392, 4415, 1922, 4360, 4247, 676, 10798, 10800, 10795, 4557, 8947, 12, 13798, 506, 643, 10801, 13851, 13852, 2]

// Module 13850 (messageEventsValidation)
...
function messageEvents(args) {
  ...
  if (null != channel) {
    ...
    obj4 = require(10800) /* recurseReplaceContentTree */;
    tmp13 = require;
  }
  obj = { errorCode: constants2.INVALID_CHANNEL };
  let tmp11 = importDefault(10795);
...
obj[RPCEvents.RELATIONSHIP_UPDATE] = {
  ...
  handler(socket) {
    ...
    if (obj.has(deserializeResult, tmpResult.deserialize(constants.DISABLE_RELATIONSHIPS_ACCESS))) {
      ...
      const tmp9 = new importDefault(10795)(obj, "Missing Permissions");
      throw tmp9;
    }
    tmpResult = tmp(506);
  }
