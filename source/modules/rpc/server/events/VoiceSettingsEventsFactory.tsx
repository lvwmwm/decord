...
// Dependencies: [4245, 676, 8951, 12, 2]
// Exports: default

// Module 13855 (createVoiceSettingsEventHandlers)
...
export default function createVoiceSettingsEventHandlers(arg0, arg1) {
  ...
  obj = {};
  const items = [_require(8951).OAuth2Scopes.RPC, _require(8951).OAuth2Scopes.RPC_VOICE_READ];
