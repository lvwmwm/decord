...
// Function ID: 13669
// Name: items
// Dependencies: [1376, 1372, 1891, 3929, 1960, 4318, 4205, 676, 8842, 10670, 10675, 12, 13665, 10673, 5128, 4484, 1222, 7698, 2]
...
obj[1] = function handler(args) {
  ...
  if (null == channel) {
    ...
    if (channel.isPrivate()) {
      ...
      if (!scopes.includes(require(8842) /* set */.OAuth2Scopes.RPC)) {
        if (!scopes.includes(tmp(8842).OAuth2Scopes.DM_CHANNELS_READ)) {
          obj = { errorCode: null };
          obj[0] = constants2.INVALID_PERMISSIONS;
          const tmp8 = new importDefault(10670)(obj, "Invalid scope");
          throw tmp8;
        }
      }
      tmp = require;
    }
    const obj3 = require(10675) /* recurseReplaceContentTree */;
    return obj3.transformChannel(channel, require(10675) /* recurseReplaceContentTree */.hasMessageReadPermission(channel, socket.application.id, socket.authorization.scopes));
  }
};
  ...
  handler(args) {
    ...
    if (guild_id) {
      ...
      if (null == guild) {
        ...
        const _HermesInternal = HermesInternal;
        let tmpResult = importDefault(10670);
...
obj2[1] = function handler() {
  const tmp3 = importDefault(13665)();
  if (null == tmp3) {
    let obj = { errorCode: null };
    obj[0] = constants2.INVALID_CHANNEL;
...
obj5[1] = function handler(socket) {
  ...
  if (null != channel) {
    const obj = require(10675) /* recurseReplaceContentTree */;
    transformChannelResult = obj.transformChannel(channel, require(10675) /* recurseReplaceContentTree */.hasMessageReadPermission(channel, socket.application.id, socket.authorization.scopes));
...
obj[RPCCommands.CREATE_CHANNEL_INVITE] = {
  ...
  handler(args) {
    ...
    const invite = importDefault(7698).createInvite(channel_id, merged, "RPC");
    return invite.catch(() => {
