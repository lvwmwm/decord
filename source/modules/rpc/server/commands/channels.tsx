...
// Function ID: 13655
// Name: items
// Dependencies: [1376, 1372, 1891, 3912, 1960, 4301, 4188, 676, 8825, 10536, 10541, 12, 13651, 10539, 5111, 4467, 1222, 7679, 2]
...
obj[1] = function handler(args) {
  ...
  if (null == channel) {
    ...
    if (channel.isPrivate()) {
      ...
      if (!scopes.includes(require(8825) /* set */.OAuth2Scopes.RPC)) {
        if (!scopes.includes(tmp(8825).OAuth2Scopes.DM_CHANNELS_READ)) {
          obj = { errorCode: null };
          obj[0] = constants2.INVALID_PERMISSIONS;
          const tmp8 = new importDefault(10536)(obj, "Invalid scope");
          throw tmp8;
        }
      }
      tmp = require;
    }
    const obj3 = require(10541) /* recurseReplaceContentTree */;
    return obj3.transformChannel(channel, require(10541) /* recurseReplaceContentTree */.hasMessageReadPermission(channel, socket.application.id, socket.authorization.scopes));
  }
};
  ...
  handler(args) {
    ...
    if (guild_id) {
      ...
      if (null == guild) {
        ...
        const _HermesInternal = HermesInternal;
        let tmpResult = importDefault(10536);
...
obj2[1] = function handler() {
  const tmp3 = importDefault(13651)();
  if (null == tmp3) {
    let obj = { errorCode: null };
    obj[0] = constants2.INVALID_CHANNEL;
...
obj5[1] = function handler(socket) {
  ...
  if (null != channel) {
    const obj = require(10541) /* recurseReplaceContentTree */;
    transformChannelResult = obj.transformChannel(channel, require(10541) /* recurseReplaceContentTree */.hasMessageReadPermission(channel, socket.application.id, socket.authorization.scopes));
