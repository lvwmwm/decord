...
// Function ID: 13810
// Name: items
// Dependencies: [1395, 1391, 1910, 3989, 1979, 4361, 4245, 676, 8965, 10727, 10732, 12, 13806, 10730, 5191, 4527, 1222, 7824, 2]
...
obj[1] = function handler(args) {
  ...
  if (null == channel) {
    ...
    if (channel.isPrivate()) {
      ...
      if (!scopes.includes(require(8965) /* set */.OAuth2Scopes.RPC)) {
        if (!scopes.includes(tmp(8965).OAuth2Scopes.DM_CHANNELS_READ)) {
          obj = { errorCode: null };
          obj[0] = constants2.INVALID_PERMISSIONS;
          const tmp8 = new importDefault(10727)(obj, "Invalid scope");
          throw tmp8;
        }
      }
      tmp = require;
    }
    const obj3 = require(10732) /* recurseReplaceContentTree */;
    return obj3.transformChannel(channel, require(10732) /* recurseReplaceContentTree */.hasMessageReadPermission(channel, socket.application.id, socket.authorization.scopes));
  }
};
  ...
  handler(args) {
    ...
    if (guild_id) {
      ...
      if (null == guild) {
        ...
        const _HermesInternal = HermesInternal;
        let tmpResult = importDefault(10727);
...
obj2[1] = function handler() {
  const tmp3 = importDefault(13806)();
  if (null == tmp3) {
    let obj = { errorCode: null };
    obj[0] = constants2.INVALID_CHANNEL;
...
obj5[1] = function handler(socket) {
  ...
  if (null != channel) {
    const obj = require(10732) /* recurseReplaceContentTree */;
    transformChannelResult = obj.transformChannel(channel, require(10732) /* recurseReplaceContentTree */.hasMessageReadPermission(channel, socket.application.id, socket.authorization.scopes));
...
obj[RPCCommands.CREATE_CHANNEL_INVITE] = {
  ...
  handler(args) {
    ...
    const invite = importDefault(7824).createInvite(channel_id, merged, "RPC");
    return invite.catch(() => {
