// Module ID: 13553
// Function ID: 13554
// Dependencies: [5, 676, 10622, 13554, 698, 13555, 2]
          ...
          if (0 === closure_2) {
            if (arg0 === 1) {
              ...
              if (null == outer1_0.events[dependencyMap]) {
                ...
                let tmp35 = outer1_1(10622);
                tmp35 = new tmp35(obj1, "Invalid event: " + dependencyMap);
                throw tmp35;
              } else if (outer1_1(13554)(outer1_1.authorization.scopes, tmp67.scope)) {
                ...
                const tmp10 = new tmp72(10622)(obj4, "Not authenticated or invalid scope");
                throw tmp10;
              }
              obj13 = outer1_0;
            }
            ...
            if (null != closure_1.validate(initialSubscriptionPayload, c0.validation(closure_1), { convert: false }).error) {
              ...
              const tmp64 = new outer1_1(10622)(obj5, "Invalid subscription parameters provided");
              throw tmp64;
            }
          }
