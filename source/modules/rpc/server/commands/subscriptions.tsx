// Module ID: 13558
// Function ID: 13559
// Dependencies: [5, 676, 10626, 13559, 698, 13560, 2]
          ...
          if (0 === closure_2) {
            if (arg0 === 1) {
              ...
              if (null == outer1_0.events[dependencyMap]) {
                ...
                let tmp35 = outer1_1(10626);
                tmp35 = new tmp35(obj1, "Invalid event: " + dependencyMap);
                throw tmp35;
              } else if (outer1_1(13559)(outer1_1.authorization.scopes, tmp67.scope)) {
                ...
                const tmp10 = new tmp72(10626)(obj4, "Not authenticated or invalid scope");
                throw tmp10;
              }
              obj13 = outer1_0;
            }
            ...
            if (null != closure_1.validate(initialSubscriptionPayload, c0.validation(closure_1), { convert: false }).error) {
              ...
              const tmp64 = new outer1_1(10626)(obj5, "Invalid subscription parameters provided");
              throw tmp64;
            }
          }
