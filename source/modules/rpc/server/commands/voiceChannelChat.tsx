// Module ID: 13705
// Function ID: 13706
// Dependencies: [4205, 676, 10673, 13706, 10670, 2]
...
let obj = {
  ...
  handler(args) {
    let obj = require(13706) /* toggleVoiceChannelChat */;
    const result = obj.toggleVoiceChannelChat(args.args.open);
    if (null == result) {
      obj = { errorCode: null };
      obj[0] = RPCErrors.INVALID_CHANNEL;
      const tmp8 = new importDefault(10670)(obj, "Not connected to a guild voice channel");
      throw tmp8;
    } else {
