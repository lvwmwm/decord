// Module ID: 13846
// Function ID: 13847
// Dependencies: [4245, 676, 10730, 13847, 10727, 2]
...
let obj = {
  ...
  handler(args) {
    let obj = require(13847) /* toggleVoiceChannelChat */;
    const result = obj.toggleVoiceChannelChat(args.args.open);
    if (null == result) {
      obj = { errorCode: null };
      obj[0] = RPCErrors.INVALID_CHANNEL;
      const tmp8 = new importDefault(10727)(obj, "Not connected to a guild voice channel");
      throw tmp8;
    } else {
