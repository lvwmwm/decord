// Module ID: 13807
// Function ID: 13808
// Dependencies: [4245, 676, 10712, 10709, 709, 2]
...
export default {
  [ME.RPCCommands.SET_CONFIG]: {
    ...
    validation(boolean) {
      let obj = importDefault(10712)(boolean);
