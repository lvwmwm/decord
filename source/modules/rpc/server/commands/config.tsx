// Module ID: 13798
// Function ID: 13799
// Dependencies: [4245, 676, 10714, 10711, 709, 2]
...
export default {
  [ME.RPCCommands.SET_CONFIG]: {
    ...
    validation(boolean) {
      let obj = importDefault(10714)(boolean);
