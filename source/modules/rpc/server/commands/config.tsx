// Module ID: 13810
// Function ID: 13811
// Dependencies: [4245, 676, 10730, 10727, 709, 2]
...
export default {
  [ME.RPCCommands.SET_CONFIG]: {
    ...
    validation(boolean) {
      let obj = importDefault(10730)(boolean);
