// Module ID: 13531
// Function ID: 13532
// Dependencies: [4092, 676, 10629, 10626, 709, 2]
...
export default {
  [ME.RPCCommands.SET_CONFIG]: {
    ...
    validation(boolean) {
      let obj = importDefault(10629)(boolean);
