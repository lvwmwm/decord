// Module ID: 13669
// Function ID: 13670
// Dependencies: [4205, 676, 10673, 10670, 709, 2]
...
export default {
  [ME.RPCCommands.SET_CONFIG]: {
    ...
    validation(boolean) {
      let obj = importDefault(10673)(boolean);
