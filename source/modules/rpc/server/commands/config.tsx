// Module ID: 13526
// Function ID: 13527
// Dependencies: [4092, 676, 10625, 10622, 709, 2]
...
export default {
  [ME.RPCCommands.SET_CONFIG]: {
    ...
    validation(boolean) {
      let obj = importDefault(10625)(boolean);
