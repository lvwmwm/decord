// Module ID: 13806
// Function ID: 13807
// Dependencies: [4247, 676, 10798, 10795, 709, 2]
...
export default {
  [ME.RPCCommands.SET_CONFIG]: {
    ...
    validation(boolean) {
      let obj = importDefault(10798)(boolean);
