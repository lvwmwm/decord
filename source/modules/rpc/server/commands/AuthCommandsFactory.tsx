...
// Dependencies: [32, 5, 4226, 4212, 1874, 4092, 676, 10633, 687, 595, 10626, 5692, 8028, 10644, 8956, 8952, 8958, 3822, 506, 530, 709, 13535, 8174, 1464, 2]
// Exports: default

// Module 13571 (authorizeWithPrompt)
              ...
              if (1 === tmp10) {
                if (arg0 === 1) {
                  ...
                  if (throwTypeErrorResult) {
                    ...
                    throwTypeErrorResult = new response_type(10626)(obj2, "Request aborted");
                    ...
                    if (null == callback) {
                      ...
                      throwTypeErrorResult = new response_type(10626)(obj3, "No Client ID provided");
                      throw throwTypeErrorResult;
                    } else {
                      throwTypeErrorResult = c7;
                      ...
                      if (!c16) {
                        ...
                        if (null != callback2) {
                          ...
                          throwTypeErrorResult = new response_type(10626)(obj4, "Redirect URI cannot be used in the RPC OAuth2 Authorization flow");
                          throw throwTypeErrorResult;
                        }
                      }
                      throwTypeErrorResult = c7;
                      ...
                      if (null == currentUser.getCurrentUser()) {
                        ...
                        throwTypeErrorResult = new response_type(10626)(obj5, "Client is not logged in");
                        throw throwTypeErrorResult;
                      } else {
                        throwTypeErrorResult = c7;
                        ...
                        obj7[8] = outer1_15;
                        const items = [callback(8956).fetchAuthorization(obj7), ];
                        throwTypeErrorResult = callback;
                        throwTypeErrorResult = dependencyMap;
                        const obj22 = callback(8956);
                        throwTypeErrorResult = closure_0;
                        items[1] = callback(8952).getDisclosures(closure_0);
                        throwTypeErrorResult = Promise.all(items);
                        c11 = 4;
                        c12 = 1;
                        const obj24 = callback(8952);
                      }
                    }
                  }
                }
                ...
                let str3;
                throwTypeErrorResult = response_type(10626);
                if (body != null) {
                  str3 = body.message;
                }
                if (!str3) {
                ...
                if (arg0 === 1) {
                  ...
                  if (!application(throwTypeErrorResult)) {
                    ...
                    throwTypeErrorResult = callback;
                    throwTypeErrorResult = dependencyMap;
                    USER_INSTALL = callback(8028).ApplicationIntegrationType.GUILD_INSTALL;
                  }
                  throwTypeErrorResult = c7;
                }
              } else {
                if (4 === tmp10) {
                  if (arg0 === 1) {
                    ...
                    throwTypeErrorResult = callback;
                    throwTypeErrorResult = dependencyMap;
                    if (c11 === callback(8958).OAuth2Prompts.NONE) {
                      if (null != closure_20) {
                  ...
                  if (7 === tmp10) {
                    ...
                    if (aborted) {
                      ...
                      const tmp20 = new response_type(10626)(obj, "Request aborted");
                      throw tmp20;
                    }
                  }
                ...
                if (hasItem) {
                  ...
                  const values = Object.values(callback(8028).ApplicationIntegrationType);
...
function authenticate(authorization) {
  ...
  if (authorization.authorization.accessToken) {
    ...
    const tmp19 = new importDefault(10626)(obj, "Already authenticated");
    throw tmp19;
  } else if (authorization.authorization.authing) {
    obj = { errorCode: null };
    obj[0] = constants2.INVALID_COMMAND;
    const tmp11 = new importDefault(10626)(obj, "Already authenticating");
    throw tmp11;
  } else {
...
export default function createAuthCommandHandlers(arg0, arg1) {
  ...
  obj[constants.AUTHENTICATE] = _require(13535).createRPCCommand(constants.AUTHENTICATE, obj);
