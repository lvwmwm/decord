...
// Dependencies: [32, 5, 4519, 4504, 1921, 4380, 673, 9523, 684, 592, 9516, 8445, 8442, 9493, 9307, 9303, 9309, 4125, 503, 527, 706, 14353, 8625, 1482, 2]
// Exports: default

// Module 14392 (authorizeWithPrompt)
...
import importDefaultResult from "_processQueue" /* 9523 */;
                    ...
                    if (null == callback) {
                      ...
                      if (!c16) {
                        ...
                        if (null != callback2) {
                          ...
                          throwTypeErrorResult = new response_type(9516)(obj4, "Redirect URI cannot be used in the RPC OAuth2 Authorization flow");
                          throw throwTypeErrorResult;
                        }
                      }
                      throwTypeErrorResult = c7;
...
export default function createAuthCommandHandlers(arg0, arg1) {
  ...
  obj[constants.AUTHENTICATE] = _require(14353).createRPCCommand(constants.AUTHENTICATE, obj);
