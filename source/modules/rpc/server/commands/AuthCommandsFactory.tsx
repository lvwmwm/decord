...
// Dependencies: [32, 5, 4383, 4368, 1922, 4245, 676, 10716, 687, 595, 10709, 7634, 9591, 10603, 10477, 10473, 10479, 3994, 506, 530, 709, 13811, 8951, 1483, 2]
// Exports: default

// Module 13847 (authorizeWithPrompt)
              ...
              if (1 === tmp10) {
                if (arg0 === 1) {
                  ...
                  if (throwTypeErrorResult) {
                    ...
                    throwTypeErrorResult = new response_type(10709)(obj2, "Request aborted");
                    ...
                    if (null == callback) {
                      ...
                      throwTypeErrorResult = new response_type(10709)(obj3, "No Client ID provided");
                      throw throwTypeErrorResult;
                    } else {
                      throwTypeErrorResult = c7;
                      ...
                      if (!c16) {
                        ...
                        if (null != callback2) {
                          ...
                          throwTypeErrorResult = new response_type(10709)(obj4, "Redirect URI cannot be used in the RPC OAuth2 Authorization flow");
                          throw throwTypeErrorResult;
                        }
                      }
                      throwTypeErrorResult = c7;
                      ...
                      if (null == currentUser.getCurrentUser()) {
                        ...
                        throwTypeErrorResult = new response_type(10709)(obj5, "Client is not logged in");
                        throw throwTypeErrorResult;
                      } else {
                        throwTypeErrorResult = c7;
                        ...
                        obj7[8] = outer1_15;
                        const items = [callback(10477).fetchAuthorization(obj7), ];
                        throwTypeErrorResult = callback;
                        throwTypeErrorResult = dependencyMap;
                        const obj22 = callback(10477);
                        throwTypeErrorResult = closure_0;
                        items[1] = callback(10473).getDisclosures(closure_0);
                        throwTypeErrorResult = Promise.all(items);
                        c11 = 4;
                        c12 = 1;
                        const obj24 = callback(10473);
                      }
                    }
                  }
                }
                ...
                let str3;
                throwTypeErrorResult = response_type(10709);
                if (body != null) {
                  str3 = body.message;
                }
                if (!str3) {
                ...
                if (arg0 === 1) {
                  ...
                  if (!application(throwTypeErrorResult)) {
                    ...
                    throwTypeErrorResult = callback;
                    throwTypeErrorResult = dependencyMap;
                    USER_INSTALL = callback(9591).ApplicationIntegrationType.GUILD_INSTALL;
                  }
                  throwTypeErrorResult = c7;
                }
              } else {
                if (4 === tmp10) {
                  if (arg0 === 1) {
                    ...
                    throwTypeErrorResult = callback;
                    throwTypeErrorResult = dependencyMap;
                    if (c11 === callback(10479).OAuth2Prompts.NONE) {
                      if (null != closure_20) {
                  ...
                  if (7 === tmp10) {
                    ...
                    if (aborted) {
                      ...
                      const tmp20 = new response_type(10709)(obj, "Request aborted");
                      throw tmp20;
                    }
                  }
                ...
                if (hasItem) {
                  ...
                  const values = Object.values(callback(9591).ApplicationIntegrationType);
...
function authenticate(authorization) {
  ...
  if (authorization.authorization.accessToken) {
    ...
    const tmp19 = new importDefault(10709)(obj, "Already authenticated");
    throw tmp19;
  } else if (authorization.authorization.authing) {
    obj = { errorCode: null };
    obj[0] = constants2.INVALID_COMMAND;
    const tmp11 = new importDefault(10709)(obj, "Already authenticating");
    throw tmp11;
  } else {
...
export default function createAuthCommandHandlers(arg0, arg1) {
  ...
  obj[constants.AUTHENTICATE] = _require(13811).createRPCCommand(constants.AUTHENTICATE, obj);
