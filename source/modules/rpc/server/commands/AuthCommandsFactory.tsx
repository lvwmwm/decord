...
// Dependencies: [32, 5, 4519, 4504, 1922, 4380, 676, 9510, 687, 595, 9503, 8436, 8433, 9480, 9294, 9290, 9296, 4126, 506, 530, 709, 14130, 8610, 1483, 2]
// Exports: default

// Module 14169 (authorizeWithPrompt)
...
import importDefaultResult from "_processQueue" /* 9510 */;
...
export default function createAuthCommandHandlers(arg0, arg1) {
  ...
  obj[constants.AUTHENTICATE] = _require(14130).createRPCCommand(constants.AUTHENTICATE, obj);
