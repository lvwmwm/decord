...
// Dependencies: [57, 5, 4202, 4188, 1850, 4068, 653, 10599, 664, 587, 10592, 5674, 8004, 10621, 8932, 8928, 8934, 3798, 483, 507, 686, 13512, 8150, 1440, 2]
// Exports: default

// Module 13548 (authorizeWithPrompt)
...
export default function createAuthCommandHandlers(arg0, arg1) {
  ...
  obj[constants.AUTHENTICATE] = _require(13512).createRPCCommand(constants.AUTHENTICATE, obj);
