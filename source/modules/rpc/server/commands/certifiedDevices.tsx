...
// Dependencies: [4245, 676, 4406, 8951, 10712, 10709, 13805, 2]

// Module 13804 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(array) {
  let obj = importDefault(10712)(array);
  obj = { devices: null };
  ...
  const obj5 = importDefault(10712)(array);
  ...
  const obj11 = importDefault(10712)(array);
  const obj1 = { name: null, url: null };
  const requiredResult3 = importDefault(10712)(array).required();
  ...
  const obj16 = importDefault(10712)(array);
  const obj2 = { name: null, url: null };
  const requiredResult4 = importDefault(10712)(array).required();
...
obj[2] = function handler(socket) {
  ...
  if (null == socket.application.id) {
    ...
    const tmp10 = new importDefault(10709)(obj, "No application.");
    throw tmp10;
  } else {
    obj = devices(13805);
