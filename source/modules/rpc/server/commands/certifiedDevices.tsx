...
// Dependencies: [4245, 676, 4406, 8951, 10714, 10711, 13796, 2]

// Module 13795 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(array) {
  let obj = importDefault(10714)(array);
  obj = { devices: null };
  ...
  const obj5 = importDefault(10714)(array);
  ...
  const obj11 = importDefault(10714)(array);
  const obj1 = { name: null, url: null };
  const requiredResult3 = importDefault(10714)(array).required();
  ...
  const obj16 = importDefault(10714)(array);
  const obj2 = { name: null, url: null };
  const requiredResult4 = importDefault(10714)(array).required();
