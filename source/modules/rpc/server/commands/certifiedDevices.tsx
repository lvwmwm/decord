...
// Dependencies: [4034, 653, 4192, 8112, 10556, 10553, 13461, 2]

// Module 13460 (RPC_LOCAL_SCOPE)
...
obj.validation = function validation(array) {
  let obj = importDefault(10556)(array);
  obj = {};
  let arrayResult = array.array();
  const requiredResult = obj.required();
  obj = {};
  const obj5 = importDefault(10556)(array);
  ...
  const obj11 = importDefault(10556)(array);
  const obj1 = {};
  const requiredResult3 = importDefault(10556)(array).required();
  ...
  const obj16 = importDefault(10556)(array);
  const obj2 = {};
  const requiredResult4 = importDefault(10556)(array).required();
