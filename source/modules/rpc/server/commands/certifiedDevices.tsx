...
// Dependencies: [4206, 676, 4364, 8908, 10745, 10742, 13747, 2]

// Module 13746 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(array) {
  let obj = importDefault(10745)(array);
  obj = { devices: null };
  ...
  const obj5 = importDefault(10745)(array);
  ...
  const obj11 = importDefault(10745)(array);
  const obj1 = { name: null, url: null };
  const requiredResult3 = importDefault(10745)(array).required();
  ...
  const obj16 = importDefault(10745)(array);
  const obj2 = { name: null, url: null };
  const requiredResult4 = importDefault(10745)(array).required();
...
obj[2] = function handler(socket) {
  ...
  if (null == socket.application.id) {
    ...
    const tmp10 = new importDefault(10742)(obj, "No application.");
    throw tmp10;
  } else {
    obj = devices(13747);
