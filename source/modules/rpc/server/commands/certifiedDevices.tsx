...
// Dependencies: [4247, 676, 4405, 8947, 10798, 10795, 13804, 2]

// Module 13803 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(array) {
  let obj = importDefault(10798)(array);
  obj = { devices: null };
  ...
  const obj5 = importDefault(10798)(array);
  ...
  const obj11 = importDefault(10798)(array);
  const obj1 = { name: null, url: null };
  const requiredResult3 = importDefault(10798)(array).required();
  ...
  const obj16 = importDefault(10798)(array);
  const obj2 = { name: null, url: null };
  const requiredResult4 = importDefault(10798)(array).required();
