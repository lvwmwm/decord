...
// Dependencies: [4245, 676, 4406, 8965, 10730, 10727, 13808, 2]

// Module 13807 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(array) {
  let obj = importDefault(10730)(array);
  obj = { devices: null };
  ...
  const obj5 = importDefault(10730)(array);
  ...
  const obj11 = importDefault(10730)(array);
  const obj1 = { name: null, url: null };
  const requiredResult3 = importDefault(10730)(array).required();
  ...
  const obj16 = importDefault(10730)(array);
  const obj2 = { name: null, url: null };
  const requiredResult4 = importDefault(10730)(array).required();
