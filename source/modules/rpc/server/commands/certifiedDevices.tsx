...
// Dependencies: [4188, 676, 4345, 8825, 10539, 10536, 13653, 2]

// Module 13652 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(array) {
  let obj = importDefault(10539)(array);
  obj = { devices: null };
  ...
  const obj5 = importDefault(10539)(array);
  ...
  const obj11 = importDefault(10539)(array);
  const obj1 = { name: null, url: null };
  const requiredResult3 = importDefault(10539)(array).required();
  ...
  const obj16 = importDefault(10539)(array);
  const obj2 = { name: null, url: null };
  const requiredResult4 = importDefault(10539)(array).required();
...
obj[2] = function handler(socket) {
  ...
  if (null == socket.application.id) {
    ...
    const tmp10 = new importDefault(10536)(obj, "No application.");
    throw tmp10;
  } else {
    obj = devices(13653);
