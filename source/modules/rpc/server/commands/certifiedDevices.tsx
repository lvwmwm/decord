...
// Dependencies: [4034, 653, 4192, 8112, 10557, 10554, 13462, 2]

// Module 13461 (RPC_LOCAL_SCOPE)
...
obj.validation = function validation(array) {
  let obj = importDefault(10557)(array);
  obj = {};
  let arrayResult = array.array();
  const requiredResult = obj.required();
  obj = {};
  const obj5 = importDefault(10557)(array);
  ...
  const obj11 = importDefault(10557)(array);
  const obj1 = {};
  const requiredResult3 = importDefault(10557)(array).required();
  ...
  const obj16 = importDefault(10557)(array);
  const obj2 = {};
  const requiredResult4 = importDefault(10557)(array).required();
