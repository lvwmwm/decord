...
// Dependencies: [4158, 676, 4315, 8796, 10518, 10515, 13616, 2]

// Module 13615 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(array) {
  let obj = importDefault(10518)(array);
  obj = { devices: null };
  ...
  const obj5 = importDefault(10518)(array);
  ...
  const obj11 = importDefault(10518)(array);
  const obj1 = { name: null, url: null };
  const requiredResult3 = importDefault(10518)(array).required();
  ...
  const obj16 = importDefault(10518)(array);
  const obj2 = { name: null, url: null };
  const requiredResult4 = importDefault(10518)(array).required();
...
obj[2] = function handler(socket) {
  ...
  if (null == socket.application.id) {
    ...
    const tmp10 = new importDefault(10515)(obj, "No application.");
    throw tmp10;
  } else {
    obj = devices(13616);
