// Module ID: 13760
// Function ID: 13761
// Dependencies: [10592, 4206, 4328, 505, 10740, 10737, 709, 2]
...
export default {
  [sum.RPCCommands.SET_ORIENTATION_LOCK_STATE]: {
    validation(number) {
      let obj = importDefault(10740)(number);
    ...
    handler(arg0) {
      ...
      if (socket.source.type !== TransportTypes.POST_MESSAGE) {
        ...
        if (null == id) {
          obj = { errorCode: null };
          obj[0] = RPCErrors.INVALID_COMMAND;
          const tmp14 = new importDefault(10737)(obj, "No application.");
          throw tmp14;
        } else {
