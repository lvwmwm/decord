// Module ID: 13734
// Function ID: 13735
// Dependencies: [4341, 4206, 676, 10739, 10741, 13735, 7589, 10736, 10603, 698, 530, 7587, 2]
...
let obj = {
  validation(string) {
    ...
    obj[1] = importDefault(10739)(string).required();
...
obj = {
  ...
  handler(socket) {
    ...
    if (null == id) {
      ...
      obj[1] = obj;
      const obj3 = require(7587) /* isTestModeForApplication */;
