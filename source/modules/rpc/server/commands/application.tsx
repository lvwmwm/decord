// Module ID: 13650
// Function ID: 13651
// Dependencies: [4322, 4188, 676, 10539, 10541, 13651, 7510, 10536, 10521, 698, 530, 7508, 2]
...
let obj = {
  validation(string) {
    ...
    obj[1] = importDefault(10539)(string).required();
  ...
  handler(arg0) {
    ...
    const obj3 = importDefault(13651)();
    if (obj3 != null) {
...
obj = {
  ...
  handler(socket) {
    ...
    if (null == id) {
      ...
      const tmp7 = new importDefault(10536)(obj, "No application.");
      throw tmp7;
    } else {
