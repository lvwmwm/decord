// Module ID: 13653
// Function ID: 13654
// Dependencies: [7054, 676, 8796, 10520, 7077, 10515, 698, 709, 10475, 2]
...
obj = {
  ...
  handler(socket) {
    ...
    const activityApplicationId = require(7077) /* getApplicationIdsByTaskTypes */.getActivityApplicationId(quest);
    if (null != quest) {
...
obj = {
  ...
  handler(socket) {
    ...
    let obj = require(10520) /* recurseReplaceContentTree */;
    const result = obj.validatePostMessageTransport(socket.transport);
    let obj1 = require(10520) /* recurseReplaceContentTree */;
      ...
      if (null != playActivityApplicationId) {
        if (playActivityApplicationId === validateApplicationResult) {
          ...
          if (null == enrolledAt) {
            ...
            const tmp16 = new importDefault(10515)(obj, "User is not enrolled in quest");
            throw tmp16;
          } else {
...
obj[RPCCommands.GET_QUEST] = {
  ...
  handler(socket) {
    ...
    const obj2 = require(10520) /* recurseReplaceContentTree */;
    const validateApplicationResult = require(10520) /* recurseReplaceContentTree */.validateApplication(socket.application);
    const eligibleQuestsForApplicationId = require(10475) /* questMatchesActivity */.getEligibleQuestsForApplicationId(store.quests, validateApplicationResult, true);
    if (0 === eligibleQuestsForApplicationId.length) {
      obj = { errorCode: null };
      obj[0] = constants.INVALID_COMMAND;
      const tmp9 = new importDefault(10515)(obj, "No eligible quests found");
      throw tmp9;
    } else {
    ...
    const obj3 = require(10475) /* questMatchesActivity */;
  }
};
let obj1 = {
  scope: require("set").OAuth2Scopes.IDENTIFY,
