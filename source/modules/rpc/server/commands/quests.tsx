// Module ID: 13784
// Function ID: 13785
// Dependencies: [7161, 676, 8908, 10747, 7184, 10742, 698, 709, 10594, 2]
...
obj = {
  ...
  handler(socket) {
    ...
    const activityApplicationId = require(7184) /* getApplicationIdsByTaskTypes */.getActivityApplicationId(quest);
    if (null != quest) {
      ...
      if (null != playActivityApplicationId) {
        if (playActivityApplicationId === validateApplicationResult) {
          ...
          if (null == enrolledAt) {
            ...
            const tmp16 = new importDefault(10742)(obj, "User is not enrolled in quest");
            throw tmp16;
          } else {
...
obj[RPCCommands.GET_QUEST] = {
  ...
  handler(socket) {
    ...
    const obj2 = require(10747) /* recurseReplaceContentTree */;
    const validateApplicationResult = require(10747) /* recurseReplaceContentTree */.validateApplication(socket.application);
    const eligibleQuestsForApplicationId = require(10594) /* questMatchesActivity */.getEligibleQuestsForApplicationId(store.quests, validateApplicationResult, true);
    if (0 === eligibleQuestsForApplicationId.length) {
      obj = { errorCode: null };
      obj[0] = constants.INVALID_COMMAND;
      const tmp9 = new importDefault(10742)(obj, "No eligible quests found");
      throw tmp9;
    } else {
    ...
    const obj3 = require(10594) /* questMatchesActivity */;
  }
};
let obj1 = {
  scope: require("set").OAuth2Scopes.IDENTIFY,
