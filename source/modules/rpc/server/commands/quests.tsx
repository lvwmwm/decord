// Module ID: 13561
// Function ID: 13562
// Dependencies: [5983, 676, 8171, 10627, 6006, 10622, 698, 709, 10498, 2]
...
obj = {
  ...
  handler(socket) {
    ...
    const activityApplicationId = require(6006) /* getApplicationIdsByTaskTypes */.getActivityApplicationId(quest);
    if (null != quest) {
      ...
      if (null != playActivityApplicationId) {
        if (playActivityApplicationId === validateApplicationResult) {
          ...
          if (null == enrolledAt) {
            ...
            const tmp16 = new importDefault(10622)(obj, "User is not enrolled in quest");
            throw tmp16;
          } else {
...
obj[RPCCommands.GET_QUEST] = {
  ...
  handler(socket) {
    ...
    const obj2 = require(10627) /* recurseReplaceContentTree */;
    const validateApplicationResult = require(10627) /* recurseReplaceContentTree */.validateApplication(socket.application);
    const eligibleQuestsForApplicationId = require(10498) /* questMatchesActivity */.getEligibleQuestsForApplicationId(store.quests, validateApplicationResult, true);
    if (0 === eligibleQuestsForApplicationId.length) {
      obj = { errorCode: null };
      obj[0] = constants.INVALID_COMMAND;
      const tmp9 = new importDefault(10622)(obj, "No eligible quests found");
      throw tmp9;
    } else {
    ...
    const obj3 = require(10498) /* questMatchesActivity */;
  }
};
let obj1 = {
  scope: require("set").OAuth2Scopes.IDENTIFY,
