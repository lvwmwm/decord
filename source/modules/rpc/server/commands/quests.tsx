// Module ID: 13690
// Function ID: 13691
// Dependencies: [7081, 676, 8825, 10541, 7104, 10536, 698, 709, 10506, 2]
...
obj = {
  ...
  handler(socket) {
    ...
    const activityApplicationId = require(7104) /* getApplicationIdsByTaskTypes */.getActivityApplicationId(quest);
    if (null != quest) {
...
obj = {
  ...
  handler(socket) {
    ...
    let obj = require(10541) /* recurseReplaceContentTree */;
    const result = obj.validatePostMessageTransport(socket.transport);
    let obj1 = require(10541) /* recurseReplaceContentTree */;
      ...
      if (null != playActivityApplicationId) {
        if (playActivityApplicationId === validateApplicationResult) {
          ...
          if (null == enrolledAt) {
            ...
            const tmp16 = new importDefault(10536)(obj, "User is not enrolled in quest");
            throw tmp16;
          } else {
...
obj[RPCCommands.GET_QUEST] = {
  ...
  handler(socket) {
    ...
    const obj2 = require(10541) /* recurseReplaceContentTree */;
    const validateApplicationResult = require(10541) /* recurseReplaceContentTree */.validateApplication(socket.application);
    const eligibleQuestsForApplicationId = require(10506) /* questMatchesActivity */.getEligibleQuestsForApplicationId(store.quests, validateApplicationResult, true);
    if (0 === eligibleQuestsForApplicationId.length) {
      obj = { errorCode: null };
      obj[0] = constants.INVALID_COMMAND;
      const tmp9 = new importDefault(10536)(obj, "No eligible quests found");
      throw tmp9;
    } else {
    ...
    const obj3 = require(10506) /* questMatchesActivity */;
  }
};
let obj1 = {
  scope: require("set").OAuth2Scopes.IDENTIFY,
