...
// Dependencies: [5, 4813, 4034, 653, 4156, 482, 10556, 10558, 4815, 10553, 686, 1207, 8897, 4939, 2]

// Module 13479 (AM_HARMONY_PRD_APPLICATION_ID)
...
obj = {
  ...
  handler(arg0) {
    ...
    let obj = provider(10558);
    const result = obj.validatePostMessageTransport(socket.transport);
    let obj1 = provider(10558);
    ...
    if (null == value) {
      let tmp29 = connection_redirect(10553);
      ...
      let tmp20 = connection_redirect(10553);
      ...
      let tmp6 = connection_redirect(10553);
