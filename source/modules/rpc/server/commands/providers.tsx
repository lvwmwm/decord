...
// Dependencies: [5, 5061, 4245, 676, 4370, 505, 10730, 10732, 5063, 10727, 709, 1231, 10470, 5186, 2]

// Module 13826 (AM_HARMONY_PRD_APPLICATION_ID)
...
obj = {
  ...
  handler(arg0) {
    ...
    let dependencyMap;
    let obj = _require(10732);
    const result = obj.validatePostMessageTransport(socket.transport);
    let obj1 = _require(10732);
