...
// Dependencies: [5, 5039, 4245, 676, 4370, 505, 10712, 10714, 5041, 10709, 709, 1231, 10452, 5164, 2]

// Module 13823 (AM_HARMONY_PRD_APPLICATION_ID)
...
obj = {
  ...
  handler(arg0) {
    ...
    let dependencyMap;
    let obj = _require(10714);
    const result = obj.validatePostMessageTransport(socket.transport);
    let obj1 = _require(10714);
