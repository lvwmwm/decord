...
// Dependencies: [5, 4949, 4158, 676, 4280, 505, 10518, 10520, 4951, 10515, 709, 1231, 10378, 5075, 2]

// Module 13634 (AM_HARMONY_PRD_APPLICATION_ID)
...
obj = {
  ...
  handler(arg0) {
    ...
    let dependencyMap;
    let obj = _require(10520);
    const result = obj.validatePostMessageTransport(socket.transport);
    let obj1 = _require(10520);
