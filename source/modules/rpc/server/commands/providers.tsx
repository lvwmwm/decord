...
// Dependencies: [5, 4996, 4205, 676, 4327, 505, 10673, 10675, 4998, 10670, 709, 1231, 10425, 5122, 2]

// Module 13685 (AM_HARMONY_PRD_APPLICATION_ID)
...
obj = {
  ...
  handler(arg0) {
    ...
    let dependencyMap;
    let obj = _require(10675);
    const result = obj.validatePostMessageTransport(socket.transport);
    let obj1 = _require(10675);
