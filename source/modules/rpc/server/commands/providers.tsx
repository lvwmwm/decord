...
// Dependencies: [5, 4979, 4188, 676, 4310, 505, 10539, 10541, 4981, 10536, 709, 1231, 10409, 5105, 2]

// Module 13671 (AM_HARMONY_PRD_APPLICATION_ID)
...
obj = {
  ...
  handler(arg0) {
    ...
    let dependencyMap;
    let obj = _require(10541);
    const result = obj.validatePostMessageTransport(socket.transport);
    let obj1 = _require(10541);
