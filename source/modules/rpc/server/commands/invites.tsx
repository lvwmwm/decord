...
// Function ID: 13535
// Name: items
// Dependencies: [5, 1371, 1372, 4092, 676, 505, 13535, 8174, 10627, 10648, 13538, 692, 5696, 2]
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null == id) {
              ...
              const rPCError = new outer1_0(10627).RPCError(obj1, "No application.");
              throw rPCError;
            } else {
              ...
              if (null == connectedActivityLocation) {
                ...
                const rPCError1 = new outer1_0(10627).RPCError(obj2, "No eligible activity for application. Ensure an activity was set using setActivity.");
                throw rPCError1;
              } else {
                const kind = connectedActivityLocation.kind;
                if (outer1_0(10648).EmbeddedActivityLocationKind.GUILD_CHANNEL !== kind) {
                  if (outer1_0(10648).EmbeddedActivityLocationKind.GUILD_CHANNEL_MESSAGE !== kind) {
                    if (outer1_0(10648).EmbeddedActivityLocationKind.PRIVATE_CHANNEL !== kind) {
                      if (outer1_0(10648).EmbeddedActivityLocationKind.PRIVATE_CHANNEL_MESSAGE !== kind) {
                        const obj3 = { errorCode: null };
                        obj3[0] = outer1_6.NO_ELIGIBLE_ACTIVITY;
                        const rPCError2 = new outer1_0(10627).RPCError(obj3, "Unsupported activity location");
                        throw rPCError2;
                      }
                    }
                    ...
                    if (null == channel) {
                      ...
                      const rPCError3 = new outer1_0(10627).RPCError(obj4, "Invalid channel");
                      throw rPCError3;
                    } else if (channel.type === outer1_0(692).ChannelTypes.DM) {
                      let obj5 = { errorCode: null };
                      obj5[0] = outer1_6.INVALID_CHANNEL;
                      const rPCError4 = new outer1_0(10627).RPCError(obj5, "Cannot send invite to a DM");
                      throw rPCError4;
                    }
                  }
                  let c2 = 1;
          ...
          const rPCError5 = new outer1_0(10627).RPCError(obj9, "Failed to invite user");
          throw rPCError5;
        } else if (arg0 === 1) {
          connectedActivityLocation = 3;
          throw arg1;
