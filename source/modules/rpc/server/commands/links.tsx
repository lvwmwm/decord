...
// Function ID: 13678
// Name: set
// Dependencies: [5, 1371, 4339, 4205, 676, 4327, 10673, 10675, 500, 10583, 4296, 3919, 13678, 3992, 698, 8872, 13679, 10670, 5956, 13673, 7529, 13680, 2]
...
obj = {
  ...
  validation(string) {
    let obj = importDefault(10673)(string);
    obj = { url: null };
...
obj = {
  validation(arg0) {
    return importDefault(10673)(arg0);
  },
  scope: { [RPC_SCOPE_CONFIG.ANY]: items2 },
  handler(socket) {
    socket = socket.socket;
    let obj = require(10675) /* recurseReplaceContentTree */;
    const result = obj.validatePostMessageTransport(socket.transport);
    if (set.has(obj2.validateApplication(socket.application))) {
      obj = { screen: null };
      obj[0] = constants3.CONNECTIONS;
      tmp(5956).openUserSettings(obj);
    } else {
      obj = { errorCode: null };
      obj[0] = constants2.UNAUTHORIZED_FOR_APPLICATION;
      const tmp9 = new importDefault(10670)(obj, "Command not available for this application");
      throw tmp9;
    }
    obj2 = require(10675) /* recurseReplaceContentTree */;
    tmp = require;
  }
};
...
obj[RPCCommands.SHARE_LINK] = createRPCCommand.createRPCCommand(RPCCommands.SHARE_LINK, {
  ...
  handler(arg0) {
    ...
    const validateApplicationResult = require(10675) /* recurseReplaceContentTree */.validateApplication(socket.application);
    c3 = validateApplicationResult;
    if (null == validateApplicationResult) {
      obj = { errorCode: null };
      obj[0] = constants2.INVALID_COMMAND;
      const tmp22 = new importDefault(10670)(obj, "No application.");
      throw tmp22;
    } else {
      if (tmpResult.hasApplicationFlag(socket.application, constants.EMBEDDED)) {
        ...
        obj = { errorCode: null };
        obj[0] = constants2.INVALID_COMMAND;
        const tmp10 = new importDefault(10670)(obj, "This application cannot access this API");
        throw tmp10;
      }
      tmpResult = tmp(7529);
    }
    const obj2 = require(10675) /* recurseReplaceContentTree */;
    tmp = require;
  }
});
