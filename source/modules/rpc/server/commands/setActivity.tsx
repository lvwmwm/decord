...
// Dependencies: [4339, 4205, 676, 8842, 10673, 9587, 10670, 709, 10374, 10528, 12, 687, 8181, 698, 2]

// Module 13687 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(number) {
  ...
  let obj4 = importDefault(10673)(number);
  ...
  const obj19 = importDefault(10673)(number);
  ...
  const obj23 = importDefault(10673)(number);
  ...
  const obj41 = importDefault(10673)(number);
  ...
  const obj49 = importDefault(10673)(number);
  ...
  const obj58 = importDefault(10673)(number);
  ...
  obj[13] = number.number().optional().valid(require(9587) /* StatusDisplayTypes */.StatusDisplayTypes.NAME, require(9587) /* StatusDisplayTypes */.StatusDisplayTypes.STATE, require(9587) /* StatusDisplayTypes */.StatusDisplayTypes.DETAILS);
