...
// Dependencies: [4383, 4245, 676, 8951, 10712, 9701, 10709, 709, 10401, 10567, 12, 687, 8288, 698, 2]

// Module 13825 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(number) {
  ...
  let obj4 = importDefault(10712)(number);
  ...
  const obj19 = importDefault(10712)(number);
  ...
  const obj23 = importDefault(10712)(number);
  ...
  const obj41 = importDefault(10712)(number);
  ...
  const obj49 = importDefault(10712)(number);
  ...
  const obj58 = importDefault(10712)(number);
