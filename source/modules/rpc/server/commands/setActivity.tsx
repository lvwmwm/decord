...
// Dependencies: [4341, 4206, 676, 8902, 10740, 9652, 10737, 709, 10441, 10595, 12, 687, 8241, 698, 2]

// Module 13759 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(number) {
  ...
  let obj4 = importDefault(10740)(number);
  ...
  const obj19 = importDefault(10740)(number);
  ...
  const obj23 = importDefault(10740)(number);
  ...
  const obj41 = importDefault(10740)(number);
  ...
  const obj49 = importDefault(10740)(number);
  ...
  const obj58 = importDefault(10740)(number);
  ...
  obj[13] = number.number().optional().valid(require(9652) /* StatusDisplayTypes */.StatusDisplayTypes.NAME, require(9652) /* StatusDisplayTypes */.StatusDisplayTypes.STATE, require(9652) /* StatusDisplayTypes */.StatusDisplayTypes.DETAILS);
