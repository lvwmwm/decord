...
// Dependencies: [4341, 4206, 676, 8908, 10745, 9657, 10742, 709, 10446, 10600, 12, 687, 8245, 698, 2]

// Module 13767 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(number) {
  ...
  let obj4 = importDefault(10745)(number);
  ...
  const obj19 = importDefault(10745)(number);
  ...
  const obj23 = importDefault(10745)(number);
  ...
  const obj41 = importDefault(10745)(number);
  ...
  const obj49 = importDefault(10745)(number);
  ...
  const obj58 = importDefault(10745)(number);
  ...
  obj[13] = number.number().optional().valid(require(9657) /* StatusDisplayTypes */.StatusDisplayTypes.NAME, require(9657) /* StatusDisplayTypes */.StatusDisplayTypes.STATE, require(9657) /* StatusDisplayTypes */.StatusDisplayTypes.DETAILS);
