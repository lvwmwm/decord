...
// Dependencies: [4322, 4188, 676, 8825, 10539, 9571, 10536, 709, 10358, 10512, 12, 687, 8164, 698, 2]

// Module 13673 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(number) {
  ...
  let obj4 = importDefault(10539)(number);
  ...
  const obj19 = importDefault(10539)(number);
  ...
  const obj23 = importDefault(10539)(number);
  ...
  const obj41 = importDefault(10539)(number);
  ...
  const obj49 = importDefault(10539)(number);
  ...
  const obj58 = importDefault(10539)(number);
  ...
  obj[13] = number.number().optional().valid(require(9571) /* StatusDisplayTypes */.StatusDisplayTypes.NAME, require(9571) /* StatusDisplayTypes */.StatusDisplayTypes.STATE, require(9571) /* StatusDisplayTypes */.StatusDisplayTypes.DETAILS);
