...
obj.validation = function validation(number) {
  ...
  obj.status_display_type = number.number().optional().valid(require(9009) /* StatusDisplayTypes */.StatusDisplayTypes.NAME, require(9009) /* StatusDisplayTypes */.StatusDisplayTypes.STATE, require(9009) /* StatusDisplayTypes */.StatusDisplayTypes.DETAILS);
