...
// Dependencies: [4341, 4206, 676, 8902, 10739, 9652, 10736, 709, 10440, 10594, 12, 687, 8241, 698, 2]

// Module 13757 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(number) {
  ...
  let obj4 = importDefault(10739)(number);
  ...
  const obj19 = importDefault(10739)(number);
  ...
  const obj23 = importDefault(10739)(number);
  ...
  const obj41 = importDefault(10739)(number);
  ...
  const obj49 = importDefault(10739)(number);
  ...
  const obj58 = importDefault(10739)(number);
