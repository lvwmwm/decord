...
obj[1] = function validation(number) {
  ...
  let obj4 = importDefault(10546)(number);
  ...
  const obj19 = importDefault(10546)(number);
  ...
  const obj23 = importDefault(10546)(number);
  ...
  const obj41 = importDefault(10546)(number);
  ...
  const obj49 = importDefault(10546)(number);
  ...
  const obj58 = importDefault(10546)(number);
