...
// Dependencies: [4292, 4158, 676, 8796, 10518, 9542, 10515, 709, 10327, 10481, 12, 687, 8023, 698, 2]

// Module 13636 (RPC_LOCAL_SCOPE)
...
obj[1] = function validation(number) {
  ...
  let obj4 = importDefault(10518)(number);
  ...
  const obj19 = importDefault(10518)(number);
  ...
  const obj23 = importDefault(10518)(number);
  ...
  const obj41 = importDefault(10518)(number);
  ...
  const obj49 = importDefault(10518)(number);
  ...
  const obj58 = importDefault(10518)(number);
  ...
  obj[13] = number.number().optional().valid(require(9542) /* StatusDisplayTypes */.StatusDisplayTypes.NAME, require(9542) /* StatusDisplayTypes */.StatusDisplayTypes.STATE, require(9542) /* StatusDisplayTypes */.StatusDisplayTypes.DETAILS);
