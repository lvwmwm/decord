...
// Dependencies: [5, 4247, 676, 4556, 8947, 13813, 10795, 9110, 13802, 4901, 4912, 10672, 4244, 2]

// Module 13844 (RPC_LOCAL_SCOPE)
...
obj[1] = function handler(socket) {
  ...
  let obj = require(13813) /* validateOpenInviteDialog */;
  const result = obj.validateOpenInviteDialog(socket);
  if (null != result.frame) {
    obj = { errorCode: null };
    obj[0] = constants2.UNKNOWN_ERROR;
    const tmp12 = new importDefault(10795)(obj, "Cannot support frames (yet)");
    throw tmp12;
  } else {
