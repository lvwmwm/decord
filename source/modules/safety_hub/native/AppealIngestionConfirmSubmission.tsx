...
// Dependencies: [31, 27, 11010, 653, 33, 4131, 566, 11015, 1212, 11025, 11034, 6698, 4127, 4099, 11032, 1935, 686, 11028, 11029, 2]
// Exports: default
...
export default function AppealIngestionConfirmSubmission(isDsaEligible) {
  ...
  obj = {};
  const items3 = [callback(require(11025) /* getHeader */.AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(require(1212) /* getSystemLocale */.t["G2g/g5"]) }), ];
  obj = { style: tmp.container };
  obj1 = {};
  const stringResult1 = intl2.string(require(1212) /* getSystemLocale */.t["G2g/g5"]);
  const tmp8 = View;
  const tmp9 = importDefault(11034);
  ...
  if (!isDsaEligible) {
    ...
    if (tmp19) {
      ...
      tmp19 = callback(importDefault(11028), obj2);
    }
    items5[2] = tmp19;
    obj3 = { classification: safetyHubClassification.classification };
    items5[3] = callback(importDefault(11029), obj3);
    obj.children = items5;
    items3[1] = tmp7(tmp8, obj);
    obj.children = items3;
    return tmp7(require(11025) /* getHeader */.AppealIngestionModalScreen, obj);
  } else {
    const obj4 = {
