...
// Dependencies: [19, 17, 11214, 676, 21, 4302, 589, 11219, 1236, 11234, 11243, 7744, 4298, 4270, 11241, 1988, 709, 11237, 11238, 2]
// Exports: default

// Module 11242 (AppealIngestionConfirmSubmission)
import "set";
...
export default function AppealIngestionConfirmSubmission(isDsaEligible) {
  ...
  const items3 = [callback(require(11234) /* AppealIngestionModal */.AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(require(1236) /* getSystemLocale */.t["G2g/g5"]) }), ];
  obj = { style: tmp.container, children: null };
  obj = { reasons: null };
  const stringResult1 = intl2.string(require(1236) /* getSystemLocale */.t["G2g/g5"]);
  const tmp12 = View;
  const tmp14 = importDefault(11243);
  const items4 = [require(7744) /* parseMessageEmbedForProps */.getAppealSignalDisplayText(stateFromStores1), stateFromStores2];
  ...
  if (!isDsaEligible) {
    ...
    tmp11Result = tmp11(tmp2(4298).Text, obj4);
  }
};
