...
// Dependencies: [19, 17, 11280, 676, 21, 4303, 589, 11285, 1236, 11300, 11309, 7804, 4299, 4271, 11307, 1988, 709, 11303, 11304, 2]
// Exports: default

// Module 11308 (AppealIngestionConfirmSubmission)
import "set";
...
export default function AppealIngestionConfirmSubmission(isDsaEligible) {
  ...
  const items3 = [callback(require(11300) /* AppealIngestionModal */.AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(require(1236) /* getSystemLocale */.t["G2g/g5"]) }), ];
  obj = { style: tmp.container, children: null };
  obj = { reasons: null };
  const stringResult1 = intl2.string(require(1236) /* getSystemLocale */.t["G2g/g5"]);
  const tmp12 = View;
  const tmp14 = importDefault(11309);
  const items4 = [require(7804) /* parseMessageEmbedForProps */.getAppealSignalDisplayText(stateFromStores1), stateFromStores2];
