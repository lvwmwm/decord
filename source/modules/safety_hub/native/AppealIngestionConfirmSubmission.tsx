...
// Dependencies: [19, 17, 11086, 676, 21, 4193, 589, 11091, 1236, 11101, 11110, 6758, 4189, 4161, 11108, 1959, 709, 11104, 11105, 2]
// Exports: default
...
export default function AppealIngestionConfirmSubmission(isDsaEligible) {
  ...
  const items3 = [callback(require(11101) /* AppealIngestionModal */.AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(require(1236) /* getSystemLocale */.t["G2g/g5"]) }), ];
  obj = { style: tmp.container, children: null };
  obj = { reasons: null };
  const stringResult1 = intl2.string(require(1236) /* getSystemLocale */.t["G2g/g5"]);
  const tmp12 = View;
  const tmp14 = importDefault(11110);
  const items4 = [require(6758) /* parseMessageEmbedForProps */.getAppealSignalDisplayText(stateFromStores1), stateFromStores2];
  ...
  if (!isDsaEligible) {
    ...
    tmp11Result = tmp11(tmp2(4189).Text, obj4);
  }
};
