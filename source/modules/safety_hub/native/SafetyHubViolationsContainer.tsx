...
// Dependencies: [32, 19, 17, 11061, 5438, 676, 21, 4661, 712, 8910, 8078, 4734, 1236, 13006, 9464, 5437, 11, 14113, 5439, 5260, 11058, 2007, 11068, 589, 698, 11066, 2]
...
function SafetyHubViolationsHeader(count) {
  ...
  obj[1] = closure_11(require(8078) /* WarningIcon */.WarningIcon, obj);
  ...
  const items4 = [closure_11(require(4734) /* Text */.Text, { variant: "heading-sm/semibold", children: formatToPlainStringResult }), ];
  ...
  items4[1] = closure_11(require(4734) /* Text */.Text, { variant: "text-xxs/normal", color: "text-muted", children: stringResult });
  obj1[1] = items4;
  ...
  obj[2] = items2;
  return closure_12(importDefault(8910), obj);
}
...
function RelativeIncidentTime(timestamp) {
  ...
  obj[1] = require(5437) /* parseMessageEmbedForProps */.getClassificationRelativeIncidentTime(timestamp.timestamp);
  obj[1] = callback(require(4734) /* Text */.Text, obj);
  return callback(closure_6, obj);
}
function NewBadge() {
...
export const ConnectedSafetyHubViolationsContainer = function ConnectedSafetyHubViolationsContainer() {
  let obj = require(11066) /* useSafetyHubClassifications */;
