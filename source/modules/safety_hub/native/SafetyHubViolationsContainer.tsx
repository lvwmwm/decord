...
// Dependencies: [32, 19, 17, 11165, 7700, 676, 21, 4255, 712, 8951, 7744, 4251, 1236, 12723, 9367, 7699, 11, 13880, 7701, 4460, 11162, 1959, 11172, 589, 698, 11170, 2]
// Exports: ConnectedSafetyHubViolationsContainer

// Module 13879 (SafetyHubViolationsHeader)
...
function SafetyHubViolationsHeader(count) {
  ...
  obj[1] = closure_11(require(7744) /* WarningIcon */.WarningIcon, obj);
  ...
  if (opened) {
    let ChevronSmallDownIcon = tmp7(12723).ChevronSmallUpIcon;
  } else {
    ChevronSmallDownIcon = tmp7(9367).ChevronSmallDownIcon;
  }
  const items5 = [tmp.chevron];
  items2[2] = closure_11(ChevronSmallDownIcon, { size: "md", style: items5 });
  obj[2] = items2;
  return closure_12(importDefault(8951), obj);
}
...
function RelativeIncidentTime(timestamp) {
  ...
  obj[1] = require(7699) /* parseMessageEmbedForProps */.getClassificationRelativeIncidentTime(timestamp.timestamp);
  obj[1] = callback(require(4251) /* Text */.Text, obj);
  return callback(closure_6, obj);
}
function NewBadge() {
...
export const ConnectedSafetyHubViolationsContainer = function ConnectedSafetyHubViolationsContainer() {
  let obj = require(11170) /* useSafetyHubClassifications */;
  const activeSafetyHubClassifications = obj.useActiveSafetyHubClassifications();
  let obj1 = require(11170) /* useSafetyHubClassifications */;
