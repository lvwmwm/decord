...
// Dependencies: [32, 19, 17, 11214, 7745, 676, 21, 4302, 712, 8997, 7902, 4298, 1236, 12775, 9413, 7744, 11, 13931, 7746, 4507, 11211, 1988, 11221, 589, 698, 11219, 2]
// Exports: ConnectedSafetyHubViolationsContainer

// Module 13930 (SafetyHubViolationsHeader)
...
function SafetyHubViolationsHeader(count) {
  ...
  obj[1] = closure_11(require(7902) /* WarningIcon */.WarningIcon, obj);
  ...
  const items4 = [closure_11(require(4298) /* Text */.Text, { variant: "heading-sm/semibold", children: formatToPlainStringResult }), ];
  ...
  items4[1] = closure_11(require(4298) /* Text */.Text, { variant: "text-xxs/normal", color: "text-muted", children: stringResult });
  obj1[1] = items4;
  ...
  obj[2] = items2;
  return closure_12(importDefault(8997), obj);
}
...
function RelativeIncidentTime(timestamp) {
  ...
  obj[1] = require(7744) /* parseMessageEmbedForProps */.getClassificationRelativeIncidentTime(timestamp.timestamp);
  obj[1] = callback(require(4298) /* Text */.Text, obj);
  return callback(closure_6, obj);
}
function NewBadge() {
...
export const ConnectedSafetyHubViolationsContainer = function ConnectedSafetyHubViolationsContainer() {
  let obj = require(11219) /* useSafetyHubClassifications */;
  const activeSafetyHubClassifications = obj.useActiveSafetyHubClassifications();
  let obj1 = require(11219) /* useSafetyHubClassifications */;
