...
function SafetyHubViolationsHeader(count) {
  ...
  const items4 = [closure_11(require(4338) /* Text */.Text, { variant: "heading-sm/semibold", children: formatToPlainStringResult }), ];
  ...
  items4[1] = closure_11(require(4338) /* Text */.Text, { variant: "text-xxs/normal", color: "text-muted", children: stringResult });
  obj1[1] = items4;
