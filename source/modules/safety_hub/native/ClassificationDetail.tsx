...
// Dependencies: [19, 17, 1975, 11199, 7728, 676, 21, 4285, 712, 4281, 7729, 1236, 589, 8980, 3981, 10150, 4695, 11204, 11206, 698, 5311, 11207, 7727, 11216, 6982, 6987, 11218, 2]
// Exports: default

// Module 11198 (ClassificationHeader)
...
function ClassificationHeader(classificationTypeText) {
  ...
  obj[1] = callback(classificationTypeText(4281).Text, obj);
...
function ClassificationActionsTaken(arg0) {
  ...
  if (0 !== found.length) {
    ...
    const items1 = [callback(tmp(4281).Text, obj), ];
    ...
    if (null != classificationExpiration) {
      ...
      obj3[1] = [" ", "\u2022"];
      const items4 = [tmp6(tmp(4281).Text, obj3), ];
      ...
      items4[1] = tmp8(tmp(4281).Text, obj4);
      obj2[1] = items4;
...
function ClassificationPolicyCard(classificationDescription) {
  ...
  obj[1] = callback(policyExplainerLink(10150).ShieldIcon, obj1);
  ...
  obj2[1] = callback(policyExplainerLink(4281).Text, obj3);
  items1[1] = callback(closure_4, obj2);
  obj[2] = items1;
  obj[0] = callback2(importDefault(8980), obj);
  return callback(closure_4, obj);
}
...
function LetUsKnow(arg0) {
  ...
  return callback(_require(4281).Text, obj);
}
