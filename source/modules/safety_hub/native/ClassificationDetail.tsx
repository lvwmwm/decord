...
// Dependencies: [19, 17, 1994, 11340, 7846, 676, 21, 4344, 712, 4340, 7847, 1236, 589, 9102, 4058, 10279, 4754, 11345, 11347, 698, 5367, 11348, 7845, 11357, 7103, 7108, 11359, 2]
// Exports: default

// Module 11339 (ClassificationHeader)
...
function ClassificationHeader(classificationTypeText) {
  ...
  obj[1] = callback(classificationTypeText(4340).Text, obj);
...
function ClassificationActionsTaken(arg0) {
  ...
  if (0 !== found.length) {
    ...
    const items1 = [callback(tmp(4340).Text, obj), ];
    ...
    if (null != classificationExpiration) {
      ...
      obj3[1] = [" ", "\u2022"];
      const items4 = [tmp6(tmp(4340).Text, obj3), ];
      ...
      items4[1] = tmp8(tmp(4340).Text, obj4);
      obj2[1] = items4;
...
function ClassificationPolicyCard(classificationDescription) {
  ...
  obj[1] = callback(policyExplainerLink(10279).ShieldIcon, obj1);
  ...
  obj2[1] = callback(policyExplainerLink(4340).Text, obj3);
  items1[1] = callback(closure_4, obj2);
  obj[2] = items1;
  obj[0] = callback2(importDefault(9102), obj);
  return callback(closure_4, obj);
}
...
function LetUsKnow(arg0) {
  ...
  return callback(_require(4340).Text, obj);
}
