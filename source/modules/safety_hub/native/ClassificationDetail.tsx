...
// Dependencies: [19, 17, 1946, 11202, 7716, 676, 21, 4255, 712, 4251, 7717, 1236, 589, 8649, 3952, 8350, 4666, 11207, 11209, 698, 5243, 11210, 7715, 11214, 6958, 6963, 11216, 2]
// Exports: default

// Module 11201 (ClassificationHeader)
...
function ClassificationPolicyCard(classificationDescription) {
  ...
  obj[1] = callback(policyExplainerLink(8350).ShieldIcon, obj1);
  ...
  obj[2] = items1;
  obj[0] = callback2(importDefault(8649), obj);
  return callback(closure_4, obj);
}
