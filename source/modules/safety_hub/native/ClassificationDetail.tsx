...
function ClassificationHeader(classificationTypeText) {
  ...
  obj[1] = callback(classificationTypeText(4338).Text, obj);
...
function ClassificationActionsTaken(arg0) {
  ...
  if (0 !== found.length) {
    ...
    const items1 = [callback(tmp(4338).Text, obj), ];
    ...
    if (null != classificationExpiration) {
      ...
      obj3[1] = [" ", "\u2022"];
      const items4 = [tmp6(tmp(4338).Text, obj3), ];
      ...
      items4[1] = tmp8(tmp(4338).Text, obj4);
      obj2[1] = items4;
...
function LetUsKnow(arg0) {
  ...
  return callback(_require(4338).Text, obj);
}
