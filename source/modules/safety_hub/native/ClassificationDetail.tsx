...
// Dependencies: [19, 17, 1994, 11286, 7807, 676, 21, 4303, 712, 4299, 7808, 1236, 589, 9063, 4017, 10238, 4714, 11291, 11293, 698, 5328, 11294, 7806, 11303, 7064, 7069, 11305, 2]
// Exports: default

// Module 11285 (ClassificationHeader)
...
function ClassificationHeader(classificationTypeText) {
  ...
  obj[1] = callback(classificationTypeText(4299).Text, obj);
...
function ClassificationActionsTaken(arg0) {
  ...
  if (0 !== found.length) {
    ...
    const items1 = [callback(tmp(4299).Text, obj), ];
    ...
    if (null != classificationExpiration) {
      ...
      obj3[1] = [" ", "\u2022"];
      const items4 = [tmp6(tmp(4299).Text, obj3), ];
      ...
      items4[1] = tmp8(tmp(4299).Text, obj4);
      obj2[1] = items4;
...
function ClassificationPolicyCard(classificationDescription) {
  ...
  obj[1] = callback(policyExplainerLink(10238).ShieldIcon, obj1);
  ...
  obj2[1] = callback(policyExplainerLink(4299).Text, obj3);
  items1[1] = callback(closure_4, obj2);
  obj[2] = items1;
  obj[0] = callback2(importDefault(9063), obj);
  return callback(closure_4, obj);
}
...
function LetUsKnow(arg0) {
  ...
  return callback(_require(4299).Text, obj);
}
