...
// Dependencies: [19, 17, 1946, 11193, 7728, 676, 21, 4285, 712, 4281, 7729, 1236, 589, 8979, 3982, 10148, 4695, 11198, 11200, 698, 5272, 11201, 7727, 11210, 6970, 6975, 11212, 2]
// Exports: default

// Module 11192 (ClassificationHeader)
...
function ClassificationPolicyCard(classificationDescription) {
  ...
  obj[1] = callback(policyExplainerLink(10148).ShieldIcon, obj1);
  ...
  obj[2] = items1;
  obj[0] = callback2(importDefault(8979), obj);
  return callback(closure_4, obj);
}
