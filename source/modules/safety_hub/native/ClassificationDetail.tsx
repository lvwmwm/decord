...
// Dependencies: [19, 17, 1975, 11214, 7745, 676, 21, 4302, 712, 4298, 7746, 1236, 589, 8997, 3998, 10166, 4712, 11219, 11221, 698, 5327, 11222, 7744, 11231, 7001, 7006, 11233, 2]
// Exports: default

// Module 11213 (ClassificationHeader)
...
function ClassificationHeader(classificationTypeText) {
  ...
  obj[1] = callback(classificationTypeText(4298).Text, obj);
...
function ClassificationActionsTaken(arg0) {
  ...
  if (0 !== found.length) {
    ...
    const items1 = [callback(tmp(4298).Text, obj), ];
    ...
    if (null != classificationExpiration) {
      ...
      obj3[1] = [" ", "\u2022"];
      const items4 = [tmp6(tmp(4298).Text, obj3), ];
      ...
      items4[1] = tmp8(tmp(4298).Text, obj4);
      obj2[1] = items4;
...
function ClassificationPolicyCard(classificationDescription) {
  ...
  obj[1] = callback(policyExplainerLink(10166).ShieldIcon, obj1);
  ...
  obj2[1] = callback(policyExplainerLink(4298).Text, obj3);
  items1[1] = callback(closure_4, obj2);
  obj[2] = items1;
  obj[0] = callback2(importDefault(8997), obj);
  return callback(closure_4, obj);
}
...
function LetUsKnow(arg0) {
  ...
  return callback(_require(4298).Text, obj);
}
