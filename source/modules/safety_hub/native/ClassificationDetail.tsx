...
// Dependencies: [19, 17, 1997, 11387, 8636, 676, 21, 4446, 712, 4442, 8637, 1236, 589, 9006, 4159, 8373, 4893, 11392, 11394, 698, 5518, 11395, 8635, 11404, 7294, 7299, 11406, 2]
// Exports: default

// Module 11386 (ClassificationHeader)
...
function ClassificationHeader(classificationTypeText) {
  ...
  obj[1] = callback(classificationTypeText(4442).Text, obj);
...
function ClassificationActionsTaken(arg0) {
  ...
  if (0 !== found.length) {
    ...
    const items1 = [callback(tmp(4442).Text, obj), ];
    ...
    if (null != classificationExpiration) {
      ...
      obj3[1] = [" ", "\u2022"];
      const items4 = [tmp6(tmp(4442).Text, obj3), ];
      ...
      items4[1] = tmp8(tmp(4442).Text, obj4);
      obj2[1] = items4;
...
function ClassificationPolicyCard(classificationDescription) {
  ...
  obj[1] = callback(policyExplainerLink(8373).ShieldIcon, { size: "sm", color: ThemesDefault.colors.TEXT_LINK });
  ...
  obj2[1] = callback(policyExplainerLink(4442).Text, obj3);
...
function LetUsKnow(arg0) {
  ...
  return callback(_require(4442).Text, obj);
}
