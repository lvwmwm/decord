...
// Function ID: 14179
// Name: items
// Dependencies: [32, 19, 17, 1922, 11100, 5443, 21, 5444, 14179, 4668, 712, 1236, 4339, 8113, 8953, 7379, 8617, 589, 1435, 9256, 1297, 4739, 2]
// Exports: default
...
let obj = { [arg1(5444).AccountStandingState.ALL_GOOD]: { left: "0%" } };
...
export default function SafetyHubAccountStanding() {
  ...
  memo = memo.useMemo(() => {
    ...
    obj[4] = accountStanding(4339).CircleCheckIcon;
    obj[accountStanding(5444).AccountStandingState.ALL_GOOD] = obj;
    ...
    obj1[4] = accountStanding(8113).CircleErrorIcon;
    obj1[5] = first(8953);
    obj[accountStanding(5444).AccountStandingState.LIMITED] = obj1;
    ...
    obj2[4] = accountStanding(8113).CircleErrorIcon;
    obj2[5] = first(8953);
    obj[accountStanding(5444).AccountStandingState.VERY_LIMITED] = obj2;
    ...
    obj3[4] = accountStanding(8113).CircleErrorIcon;
    obj3[5] = first(8953);
    obj[accountStanding(5444).AccountStandingState.AT_RISK] = obj3;
    ...
    obj4[4] = accountStanding(7379).CircleXIcon;
    obj4[5] = first(8617);
    obj[accountStanding(5444).AccountStandingState.SUSPENDED] = obj4;
    return obj;
  }, items);
  ...
  obj4[3] = intl.format(title, {
    hook(children) {
      return closure_1_9(accountStanding(4739).Text, { style, variant: "heading-lg/bold", children }, arg1);
    }
  });
  const items5 = [closure_9(accountStanding(4739).Text, obj4), closure_9(accountStanding(4739).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
  obj3[1] = items5;
