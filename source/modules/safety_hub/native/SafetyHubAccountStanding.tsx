...
// Function ID: 14079
// Name: items
// Dependencies: [32, 19, 17, 1922, 11348, 7871, 21, 7872, 14079, 4342, 712, 1236, 4303, 7859, 9126, 6060, 8539, 589, 1435, 9452, 1297, 4338, 2]
// Exports: default
...
let obj = { [arg1(7872).AccountStandingState.ALL_GOOD]: { left: "0%" } };
...
export default function SafetyHubAccountStanding() {
  ...
  memo = memo.useMemo(() => {
    ...
    obj[3] = tmp4.good;
    obj[4] = accountStanding(4303).CircleCheckIcon;
    obj[accountStanding(7872).AccountStandingState.ALL_GOOD] = obj;
    ...
    obj1[3] = tmp4.limited;
    obj1[4] = accountStanding(7859).CircleErrorIcon;
    obj1[5] = first(9126);
    obj[accountStanding(7872).AccountStandingState.LIMITED] = obj1;
    ...
    obj2[4] = accountStanding(7859).CircleErrorIcon;
    obj2[5] = first(9126);
    obj[accountStanding(7872).AccountStandingState.VERY_LIMITED] = obj2;
    ...
    obj3[3] = tmp4.atRisk;
    obj3[4] = accountStanding(7859).CircleErrorIcon;
    obj3[5] = first(9126);
    obj[accountStanding(7872).AccountStandingState.AT_RISK] = obj3;
    ...
    obj4[4] = accountStanding(6060).CircleXIcon;
    obj4[5] = first(8539);
    obj[accountStanding(7872).AccountStandingState.SUSPENDED] = obj4;
    return obj;
  }, items);
  ...
  obj4[3] = intl.format(title, {
    hook(children) {
      return outer1_9(accountStanding(4338).Text, { style, variant: "heading-lg/bold", children }, arg1);
    }
  });
  const items5 = [closure_9(accountStanding(4338).Text, obj4), closure_9(accountStanding(4338).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
  obj3[1] = items5;
