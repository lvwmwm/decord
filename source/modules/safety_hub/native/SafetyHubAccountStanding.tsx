...
// Function ID: 14111
// Name: items
// Dependencies: [32, 19, 17, 1922, 11061, 5438, 21, 5439, 14111, 4661, 712, 1236, 4335, 8074, 8916, 7341, 8578, 589, 1435, 9219, 1297, 4734, 2]
// Exports: default
...
let obj = { [arg1(5439).AccountStandingState.ALL_GOOD]: { left: "0%" } };
...
export default function SafetyHubAccountStanding() {
  ...
  memo = memo.useMemo(() => {
    ...
    obj[3] = tmp4.good;
    obj[4] = accountStanding(4335).CircleCheckIcon;
    obj[accountStanding(5439).AccountStandingState.ALL_GOOD] = obj;
    ...
    obj1[3] = tmp4.limited;
    obj1[4] = accountStanding(8074).CircleErrorIcon;
    obj1[5] = first(8916);
    obj[accountStanding(5439).AccountStandingState.LIMITED] = obj1;
    ...
    obj2[4] = accountStanding(8074).CircleErrorIcon;
    obj2[5] = first(8916);
    obj[accountStanding(5439).AccountStandingState.VERY_LIMITED] = obj2;
    ...
    obj3[3] = tmp4.atRisk;
    obj3[4] = accountStanding(8074).CircleErrorIcon;
    obj3[5] = first(8916);
    obj[accountStanding(5439).AccountStandingState.AT_RISK] = obj3;
    ...
    obj4[4] = accountStanding(7341).CircleXIcon;
    obj4[5] = first(8578);
    obj[accountStanding(5439).AccountStandingState.SUSPENDED] = obj4;
    return obj;
  }, items);
  ...
  obj4[3] = intl.format(title, {
    hook(children) {
      return outer1_9(accountStanding(4734).Text, { style, variant: "heading-lg/bold", children }, arg1);
    }
  });
  const items5 = [closure_9(accountStanding(4734).Text, obj4), closure_9(accountStanding(4734).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
  obj3[1] = items5;
