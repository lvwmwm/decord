...
// Function ID: 105497
// Name: items
// Dependencies: [57, 31, 27, 1850, 11048, 6735, 33, 6736, 13764, 4165, 689, 1212, 4126, 6709, 8322, 6715, 8974, 566, 1392, 8044, 1273, 4161, 2]
// Exports: default
...
let obj = { [arg1(6736).AccountStandingState.ALL_GOOD]: { left: "0%" } };
obj = { left: "25%" };
...
export default function SafetyHubAccountStanding() {
  ...
  memo = memo.useMemo(() => {
    ...
    obj.style = tmp4.good;
    obj.CustomIcon = accountStanding(4126).CircleCheckIcon;
    obj[accountStanding(6736).AccountStandingState.ALL_GOOD] = obj;
    ...
    obj1.CustomIcon = accountStanding(6709).CircleErrorIcon;
    obj1.iconSource = first(8322);
    obj[accountStanding(6736).AccountStandingState.LIMITED] = obj1;
    ...
    obj2.CustomIcon = accountStanding(6709).CircleErrorIcon;
    obj2.iconSource = first(8322);
    obj[accountStanding(6736).AccountStandingState.VERY_LIMITED] = obj2;
    ...
    obj3.CustomIcon = accountStanding(6709).CircleErrorIcon;
    obj3.iconSource = first(8322);
    obj[accountStanding(6736).AccountStandingState.AT_RISK] = obj3;
    ...
    obj4.CustomIcon = accountStanding(6715).CircleXIcon;
    obj4.iconSource = first(8974);
    obj[accountStanding(6736).AccountStandingState.SUSPENDED] = obj4;
    return obj;
  }, items);
  ...
  obj4.children = intl.format(title, {
    hook(children) {
      return outer1_9(accountStanding(4161).Text, { style, variant: "heading-lg/bold", children }, arg1);
    }
  });
  const items5 = [callback2(accountStanding(4161).Text, obj4), ];
  const obj6 = { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description };
  items5[1] = callback2(accountStanding(4161).Text, obj6);
