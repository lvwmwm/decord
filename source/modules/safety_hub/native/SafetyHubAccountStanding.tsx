...
let obj = { [arg1(7851).AccountStandingState.ALL_GOOD]: { left: "0%" } };
...
export default function SafetyHubAccountStanding() {
  ...
  memo = memo.useMemo(() => {
    ...
    obj[accountStanding(7851).AccountStandingState.ALL_GOOD] = obj;
    ...
    obj1[3] = tmp4.limited;
    obj1[4] = accountStanding(7838).CircleErrorIcon;
    obj1[5] = first(9112);
    obj[accountStanding(7851).AccountStandingState.LIMITED] = obj1;
    ...
    obj2[4] = accountStanding(7838).CircleErrorIcon;
    obj2[5] = first(9112);
    obj[accountStanding(7851).AccountStandingState.VERY_LIMITED] = obj2;
    ...
    obj3[3] = tmp4.atRisk;
    obj3[4] = accountStanding(7838).CircleErrorIcon;
    obj3[5] = first(9112);
    obj[accountStanding(7851).AccountStandingState.AT_RISK] = obj3;
    ...
    obj4[4] = accountStanding(6039).CircleXIcon;
    obj4[5] = first(8517);
    obj[accountStanding(7851).AccountStandingState.SUSPENDED] = obj4;
    return obj;
  }, items);
