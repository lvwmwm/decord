...
// Function ID: 14209
// Name: items
// Dependencies: [32, 19, 17, 1922, 11442, 7950, 21, 7951, 14209, 4380, 712, 1236, 4340, 7938, 9210, 6105, 8625, 589, 1435, 9535, 1297, 4376, 2]
// Exports: default
...
let obj = { [arg1(7951).AccountStandingState.ALL_GOOD]: { left: "0%" } };
...
export default function SafetyHubAccountStanding() {
  ...
  memo = memo.useMemo(() => {
    ...
    obj[4] = accountStanding(4340).CircleCheckIcon;
    obj[accountStanding(7951).AccountStandingState.ALL_GOOD] = obj;
    ...
    obj1[4] = accountStanding(7938).CircleErrorIcon;
    obj1[5] = first(9210);
    obj[accountStanding(7951).AccountStandingState.LIMITED] = obj1;
    ...
    obj2[4] = accountStanding(7938).CircleErrorIcon;
    obj2[5] = first(9210);
    obj[accountStanding(7951).AccountStandingState.VERY_LIMITED] = obj2;
    ...
    obj3[4] = accountStanding(7938).CircleErrorIcon;
    obj3[5] = first(9210);
    obj[accountStanding(7951).AccountStandingState.AT_RISK] = obj3;
    ...
    obj4[4] = accountStanding(6105).CircleXIcon;
    obj4[5] = first(8625);
    obj[accountStanding(7951).AccountStandingState.SUSPENDED] = obj4;
    return obj;
  }, items);
  ...
  obj4[3] = intl.format(title, {
    hook(children) {
      return closure_1_9(accountStanding(4376).Text, { style, variant: "heading-lg/bold", children }, arg1);
    }
  });
  const items5 = [closure_9(accountStanding(4376).Text, obj4), closure_9(accountStanding(4376).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
  obj3[1] = items5;
