...
// Function ID: 11082
// Name: items
// Dependencies: [19, 17, 11068, 6753, 21, 4189, 712, 1236, 589, 1581, 11080, 6744, 6746, 4157, 5243, 5245, 4185, 5554, 5220, 3886, 4600, 11074, 2]
// Exports: default
...
export default function AutomatedUnderageAppealActionSheet(onClose) {
  ...
  const items5 = [callback(onClose(4185).Text, obj4), ];
  ...
  items5[1] = callback(onClose(4185).Text, obj5);
  obj3[1] = items5;
  ...
  obj6[0] = callback(onClose(5554).TableRowGroup, obj7);
  ...
  obj9[2] = callback(onClose(5220).TableRow, obj10);
  obj8[1] = callback(onClose(5554).TableRowGroup, obj9);
  ...
  const items7 = [callback(onClose(4600).Button, obj12), ];
  ...
  items7[1] = callback(onClose(4185).Text, obj13);
  obj11[1] = items7;
  items6[3] = callback2(callback, obj11);
  obj1[1] = items6;
  obj[1] = callback2(callback, obj1);
  obj[2] = callback(onClose(5245).BottomSheetScrollView, obj);
  return callback(onClose(5243).BottomSheet, obj);
};
