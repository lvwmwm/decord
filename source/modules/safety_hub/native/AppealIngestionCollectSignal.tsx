...
// Dependencies: [31, 27, 6699, 33, 4131, 689, 3849, 7575, 6698, 11014, 686, 4099, 11031, 1935, 1212, 11024, 4127, 2]
// Exports: default

// Module 11030 (AppealSignalRadioRow)
import "result";
...
function AppealSignalRadioRow(signal) {
  ...
  obj = { text: signal(6698).getAppealSignalDisplayText(signal) };
  obj.label = callback(signal(7575).FormRow.Label, obj);
  obj.onPress = function onPress() {
    return callback(signal);
  };
  obj.trailing = callback(signal(7575).FormRow.Radio, { selected });
  obj.accessibilityRole = accessibilityRole;
  obj.accessibilityState = accessibilityState;
  return callback(signal(7575).FormRow, obj);
}
...
export default function AppealIngestionCollectSignal(isDsaEligible) {
    ...
    if (tmp2) {
      obj = {
        onSave(userInput) {
            ...
            obj.dispatch(obj);
            callback(4099).hideActionSheet("AppealIngestionFreeTextAppealReasonActionSheet");
          },
        onClose() {
            return callback(4099).hideActionSheet("AppealIngestionFreeTextAppealReasonActionSheet");
          }
      };
  ...
  obj = {};
  const items = [callback(isDsaEligible(11024).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(isDsaEligible(1212).t.VEcRhw) }), ];
  ...
  const items1 = [callback(isDsaEligible(7575).FormSection, obj2), ];
  ...
  obj3.children = callback(isDsaEligible(4127).Text, obj4);
  items1[1] = callback(handleAppealSignalSelect, obj3);
  obj1.children = items1;
  obj.children = callback2(isDsaEligible(7575).Form, obj1);
  items[1] = callback(handleAppealSignalSelect, obj);
  obj.children = items;
  return callback2(isDsaEligible(11024).AppealIngestionModalScreen, obj);
};
