...
// Dependencies: [19, 17, 21, 4344, 712, 7845, 4193, 4340, 1236, 2]
// Exports: default
...
export default function AppealIngestionPolicySummary(classification) {
  ...
  let obj = require(7845) /* parseMessageEmbedForProps */;
  let description;
  ...
  const tmp2Result = require(4193) /* hexToRgba */;
  ...
  const hexWithOpacityResult = require(4193) /* hexToRgba */.hexWithOpacity(tmp.borderColor.color, 0.08);
  const items1 = [tmp.userContainer, { borderColor: hexWithOpacityResult }];
  items[1] = callback(View, { style: items1, children: callback(require(4340) /* Text */.Text, { variant: "text-md/semibold", children: capitalizeTextResult }) });
  obj[1] = items;
