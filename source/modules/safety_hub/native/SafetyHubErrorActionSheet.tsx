...
// Dependencies: [19, 17, 21, 4255, 712, 13867, 5309, 5895, 4251, 1236, 4666, 11208, 2]
// Exports: default

// Module 13869 (SafetyHubErrorActionSheet)
import "noop";
...
export default function SafetyHubErrorActionSheet(arg0) {
  if (arg0 == null) {
    ...
    const tmp6 = importDefault(13867)();
    ...
    obj1[2] = items2;
    obj[1] = callback(require(5895) /* CircleXIcon */.CircleXIcon, obj1);
    ...
    obj3[2] = tmp6;
    obj3[3] = tmp6;
    items4[1] = callback(require(4666) /* Button */.Button, obj3);
    obj[0] = items4;
