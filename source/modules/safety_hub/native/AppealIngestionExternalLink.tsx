...
// Dependencies: [19, 17, 21, 4255, 712, 4797, 3952, 4251, 1297, 7813, 2]
// Exports: default

// Module 11190 (AppealIngestionExternalLink)
import "noop";
...
export default function AppealIngestionExternalLink(children) {
  ...
  obj1[0] = require(7813) /* registerAsset */;
  obj1[1] = tmp.chevron.color;
  items[1] = callback(require(1297) /* Button */.Icon, obj1);
  obj[1] = items;
  obj[3] = callback2(View, obj);
  return callback(require(4797) /* PressableBase */.PressableHighlight, obj);
};
