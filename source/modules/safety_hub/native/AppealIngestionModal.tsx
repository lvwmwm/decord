...
// Dependencies: [5, 32, 19, 17, 11214, 7745, 676, 21, 4302, 712, 4298, 589, 11219, 1480, 7746, 11233, 11220, 7744, 5327, 1236, 4712, 5269, 11235, 503, 11240, 11242, 11244, 11246, 11247, 5656, 5723, 2]
// Exports: AppealIngestionModalHeader, AppealIngestionModalScreen, default

// Module 11234 (AppealIngestionModal)
...
export default function AppealIngestionModal(classificationId) {
  ...
  obj = {
    ...
    screens: flag(5656)(() => {
      ...
      obj[1] = function headerTitle() {
        return callback3(callback(4298).Text, { variant: "text-md/normal", children: "accessible" });
      };
      ...
      obj2[2] = function render() {
        return callback3(callback2(11244), {});
      };
      ...
      obj3[2] = function render() {
        return callback3(callback2(11246), {});
      };
      ...
      obj4[2] = function render() {
        return callback3(callback2(11247), {});
      };
  ...
  return callback2(_require(5723).Navigator, obj);
};
export const AppealIngestionModalHeader = function AppealIngestionModalHeader(arg0) {
  ...
  if (null != subHeaderText) {
    ...
    if (subHeaderText.length > 0) {
      ...
      obj[0] = tmp.subheader;
      obj[3] = subHeaderText;
      tmp8 = callback2(require(4298) /* Text */.Text, obj);
    }
  }
  items[1] = tmp8;
  obj[1] = items;
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            if (null !== outer1_2) {
              ...
              obj1[0] = outer1_2(11220).requestReview(tmp36, outer1_0, outer1_1);
              return obj1;
            }
          }
        } else {
