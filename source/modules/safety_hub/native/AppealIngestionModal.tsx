...
// Dependencies: [5, 32, 19, 17, 11368, 8621, 676, 21, 4445, 712, 4441, 589, 11373, 1500, 8622, 11387, 11374, 8620, 5505, 1236, 4880, 5447, 11389, 503, 11394, 11396, 11398, 11400, 11401, 5893, 5960, 2]
// Exports: AppealIngestionModalHeader, AppealIngestionModalScreen, default

// Module 11388 (AppealIngestionModal)
  ...
  obj = {
    ...
    screens: flag(flag3[29])(() => {
      ...
      obj[1] = function headerTitle() {
        return callback3(callback(4441).Text, { variant: "text-md/normal", children: "accessibilityRole" });
      };
      obj[2] = function render() {
        return closure_1_12(callback2(11389), { isDsaEligible: closure_0, isSpam: callback2, isCoppa: closure_2, isDeveloperClassification: dependencyMap });
      };
      ...
      obj[2] = function render() {
        return closure_1_12(callback2(11394), { isDsaEligible: closure_0 });
      };
      ...
      obj1 = {
        ...
        render() {
          return closure_1_12(callback2(11396), { isDsaEligible: closure_0 });
        },
      ...
      obj2[2] = function render() {
        return callback3(callback2(11398), {});
      };
      ...
      obj3[2] = function render() {
        return callback3(callback2(11400), {});
      };
      ...
      obj4[2] = function render() {
        return callback3(callback2(11401), {});
      };
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            if (null !== closure_1_2) {
              ...
              obj1[0] = closure_1_2(11374).requestReview(tmp36, closure_1_0, closure_1_1);
              return obj1;
            }
          }
        } else {
