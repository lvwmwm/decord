...
// Dependencies: [5, 32, 19, 17, 11280, 7805, 676, 21, 4303, 712, 4299, 589, 11285, 1480, 7806, 11299, 11286, 7804, 5328, 1236, 4714, 5270, 11301, 503, 11306, 11308, 11310, 11312, 11313, 5716, 5783, 2]
// Exports: AppealIngestionModalHeader, AppealIngestionModalScreen, default

// Module 11300 (AppealIngestionModal)
...
export default function AppealIngestionModal(classificationId) {
  ...
  obj = {
    ...
    screens: flag(5716)(() => {
      ...
      obj2[2] = function render() {
        return callback3(callback2(11310), {});
      };
      ...
      obj3[2] = function render() {
        return callback3(callback2(11312), {});
      };
  ...
  return callback2(_require(5783).Navigator, obj);
};
export const AppealIngestionModalHeader = function AppealIngestionModalHeader(arg0) {
  ...
  if (null != subHeaderText) {
    ...
    if (subHeaderText.length > 0) {
      ...
      obj[0] = tmp.subheader;
      obj[3] = subHeaderText;
      tmp8 = callback2(require(4299) /* Text */.Text, obj);
    }
  }
  items[1] = tmp8;
  obj[1] = items;
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            if (null !== outer1_2) {
              ...
              obj1[0] = outer1_2(11286).requestReview(tmp36, outer1_0, outer1_1);
              return obj1;
            }
          }
        } else {
