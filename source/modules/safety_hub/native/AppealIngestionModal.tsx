...
// Dependencies: [5, 32, 19, 17, 11193, 7728, 676, 21, 4285, 712, 4281, 589, 11198, 1480, 7729, 11212, 11199, 7727, 5272, 1236, 4695, 5238, 11214, 503, 11219, 11221, 11223, 11225, 11226, 5598, 5665, 2]
// Exports: AppealIngestionModalHeader, AppealIngestionModalScreen, default

// Module 11213 (AppealIngestionModal)
  ...
  obj = {
    ...
    screens: flag(5598)(() => {
      ...
      obj[1] = function headerTitle() {
        return callback3(callback(4281).Text, { variant: "text-md/normal", children: "accessibilityRole" });
      };
      ...
      obj2[2] = function render() {
        return callback3(callback2(11223), {});
      };
      ...
      obj3[2] = function render() {
        return callback3(callback2(11225), {});
      };
      ...
      obj4[2] = function render() {
        return callback3(callback2(11226), {});
      };
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            if (null !== outer1_2) {
              ...
              obj1[0] = outer1_2(11199).requestReview(tmp36, outer1_0, outer1_1);
              return obj1;
            }
          }
        } else {
