...
// Dependencies: [32, 19, 17, 1302, 1874, 11193, 7728, 676, 21, 7851, 4285, 589, 4131, 11203, 11204, 7727, 4472, 8766, 8793, 11205, 8399, 4504, 11, 2]
// Exports: default

// Module 11202 (ClassificationEvidence)
...
export default function ClassificationEvidence(arg0) {
  ...
  if (obj2.useStateFromStores(items1, () => ref(4131).isThemeLight(id.theme))) {
    let assetSource = resolveAssetSource(tmp11(11203));
    let tmp13 = tmp11;
  } else {
    assetSource = resolveAssetSource(tmp11(11204));
    tmp13 = tmp11;
  }
  ...
  const callback = obj1.useCallback((nativeEvent) => {
    ...
    ref(8766).openMediaModal({ initialIndex: index, initialSources: mapped, disableDownload: true, disableMediaOverlayButton: true, shareable: false, originViewOrOriginLayout: layout });
  }, items4);
  ...
  if (first3 > 0) {
    ...
    obj[1] = first2.map((uri) => {
      ...
      obj = { uri: uri.url };
      return outer1_18(first(8793), obj, arg1);
    });
    ...
    obj1[0] = ref;
    obj1[1] = callback;
    const items9 = [callback(tmp13(11205), obj1), ];
    obj2 = { rowGenerator: null, message: null, modifyRow: null };
    obj2[0] = closure_20;
    let tmp13Result = tmp13(8399);
    tmpResult = tmp(4504);
