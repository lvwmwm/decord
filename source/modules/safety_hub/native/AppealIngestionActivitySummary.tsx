...
// Dependencies: [19, 17, 21, 4342, 11340, 2]
// Exports: default

// Module 11355 (AppealIngestionActivitySummary)
import "noop";
...
export default function AppealIngestionActivitySummary(flaggedContent) {
  return <View style={callback().activity}>{jsx(importDefault(11340), { flaggedContent: arg0.flaggedContent })}</View>;
};
