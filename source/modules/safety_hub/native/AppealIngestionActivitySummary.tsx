...
// Dependencies: [19, 17, 21, 4255, 11173, 2]
// Exports: default

// Module 11188 (AppealIngestionActivitySummary)
import "noop";
...
export default function AppealIngestionActivitySummary(flaggedContent) {
  return <View style={callback().activity}>{jsx(importDefault(11173), { flaggedContent: arg0.flaggedContent })}</View>;
};
