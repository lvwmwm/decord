...
// Dependencies: [19, 17, 7871, 21, 4342, 11370, 1236, 11368, 11379, 4338, 11373, 2]
// Exports: default

// Module 11378 (AppealIngestionRequestSent)
import "noop";
...
export default function AppealIngestionRequestSent() {
  ...
  obj1[0] = importDefault(11379);
  obj1[1] = tmp.checkboxPng;
  const items = [callback(closure_4, obj1), callback(_require(11368).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(_require(1236).t.Qdx8AP) }), , , ];
  ...
  items[2] = callback(_require(4338).Text, obj2);
  ...
  items[3] = callback(importDefault(11373), obj3);
  const obj4 = { text: null, url: null, onPress: null };
  const tmp4 = importDefault(11373);
  ...
  items[4] = callback(importDefault(11373), obj4);
  obj[1] = items;
  obj[0] = callback2(closure_3, obj);
  return callback(_require(11368).AppealIngestionModalScreen, obj);
};
