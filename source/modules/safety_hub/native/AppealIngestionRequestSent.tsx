...
// Dependencies: [19, 17, 7728, 21, 4285, 11221, 1236, 11219, 11230, 4281, 11224, 2]
// Exports: default

// Module 11229 (AppealIngestionRequestSent)
import "noop";
...
export default function AppealIngestionRequestSent() {
  ...
  obj1[0] = importDefault(11230);
  obj1[1] = tmp.checkboxPng;
  const items = [callback(closure_4, obj1), callback(_require(11219).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(_require(1236).t.Qdx8AP) }), , , ];
  ...
  items[3] = callback(importDefault(11224), obj3);
  const obj4 = { text: null, url: null, onPress: null };
  const tmp4 = importDefault(11224);
  ...
  items[4] = callback(importDefault(11224), obj4);
  obj[1] = items;
  obj[0] = callback2(closure_3, obj);
  return callback(_require(11219).AppealIngestionModalScreen, obj);
};
