...
// Dependencies: [19, 17, 6756, 21, 4189, 11089, 1236, 11087, 11098, 4185, 11092, 2]
// Exports: default

// Module 11097 (AppealIngestionRequestSent)
import "noop";
...
export default function AppealIngestionRequestSent() {
  ...
  obj1[0] = importDefault(11098);
  obj1[1] = tmp.checkboxPng;
  const items = [callback(closure_4, obj1), callback(_require(11087).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(_require(1236).t.Qdx8AP) }), , , ];
  ...
  items[3] = callback(importDefault(11092), obj3);
  const obj4 = { text: null, url: null, onPress: null };
  const tmp4 = importDefault(11092);
  ...
  items[4] = callback(importDefault(11092), obj4);
  obj[1] = items;
  obj[0] = callback2(closure_3, obj);
  return callback(_require(11087).AppealIngestionModalScreen, obj);
};
