...
// Dependencies: [31, 27, 6699, 33, 4131, 11026, 1212, 11024, 11035, 4127, 11029, 2]
// Exports: default

// Module 11034 (AppealIngestionRequestSent)
import "result";
...
export default function AppealIngestionRequestSent() {
  ...
  const obj1 = { source: importDefault(11035), style: tmp.checkboxPng };
  const items = [callback(closure_4, obj1), callback(_require(11024).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(_require(1212).t.Qdx8AP) }), , , ];
  ...
  items[3] = callback(importDefault(11029), obj3);
  const obj4 = {};
  const tmp4 = importDefault(11029);
  ...
  items[4] = callback(importDefault(11029), obj4);
  obj.children = items;
  obj.children = callback2(closure_3, obj);
  return callback(_require(11024).AppealIngestionModalScreen, obj);
};
