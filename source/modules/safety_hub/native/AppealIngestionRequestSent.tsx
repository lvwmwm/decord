...
// Dependencies: [19, 17, 7807, 21, 4303, 11308, 1236, 11306, 11317, 4299, 11311, 2]
// Exports: default

// Module 11316 (AppealIngestionRequestSent)
import "noop";
...
export default function AppealIngestionRequestSent() {
  ...
  obj1[0] = importDefault(11317);
  obj1[1] = tmp.checkboxPng;
  const items = [callback(closure_4, obj1), callback(_require(11306).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(_require(1236).t.Qdx8AP) }), , , ];
  ...
  items[3] = callback(importDefault(11311), obj3);
  const obj4 = { text: null, url: null, onPress: null };
  const tmp4 = importDefault(11311);
  ...
  items[4] = callback(importDefault(11311), obj4);
  obj[1] = items;
  obj[0] = callback2(closure_3, obj);
  return callback(_require(11306).AppealIngestionModalScreen, obj);
};
