...
// Dependencies: [19, 17, 7700, 21, 4255, 11187, 1236, 11185, 11196, 4251, 11190, 2]
// Exports: default

// Module 11195 (AppealIngestionRequestSent)
import "noop";
...
export default function AppealIngestionRequestSent() {
  ...
  obj1[0] = importDefault(11196);
  obj1[1] = tmp.checkboxPng;
  const items = [callback(closure_4, obj1), callback(_require(11185).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(_require(1236).t.Qdx8AP) }), , , ];
  ...
  items[3] = callback(importDefault(11190), obj3);
  const obj4 = { text: null, url: null, onPress: null };
  const tmp4 = importDefault(11190);
  ...
  items[4] = callback(importDefault(11190), obj4);
  obj[1] = items;
  obj[0] = callback2(closure_3, obj);
  return callback(_require(11185).AppealIngestionModalScreen, obj);
};
