...
// Dependencies: [19, 17, 11100, 5443, 676, 21, 4668, 589, 11105, 11122, 1236, 11120, 11123, 11124, 11125, 4739, 2]
// Exports: default

// Module 11121 (AppealIngestionSpeedBump)
import noopAll from "noop" /* 19 */;
import AppealIngestionActivitySummaryDefault from "AppealIngestionActivitySummary" /* 11123 */;
import AppealIngestionPolicySummaryDefault from "AppealIngestionPolicySummary" /* 11124 */;
...
export default function AppealIngestionSpeedBump(arg0) {
  ...
  const tmp = callback2();
  _require = _require(11122).useEmitAppealIngestionEvent();
  ...
  const tmp2Result = _require(11122);
  const intl2 = tmp2(1236).intl;
  const stringResult = intl.string(_require(1236).t["C5q+pW"]);
  const items1 = [callback(_require(11120).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(_require(1236).t.URt7VI) }), ];
  ...
  if (isDeveloperClassification) {
    ...
    isDeveloperClassification = tmp9(tmp13(11125), obj4);
    const tmp13Result1 = tmp13(11125);
  }
  ...
  if (!isCoppa) {
    ...
    tmp9Result1 = tmp9(tmp13(11125), obj5);
    const tmp13Result2 = tmp13(11125);
  }
  ...
  if (isDsaEligible) {
    ...
    isDsaEligible = tmp9(tmp2(4739).Text, obj6);
  }
  ...
  obj7[0] = items1;
  return closure_9(_require(11120).AppealIngestionModalScreen, obj7);
};
