...
// Dependencies: [19, 17, 11442, 7950, 676, 21, 4380, 589, 11447, 11464, 1236, 11462, 11465, 11466, 11467, 4376, 2]
// Exports: default

// Module 11463 (AppealIngestionSpeedBump)
import noopAll from "noop" /* 19 */;
import AppealIngestionActivitySummaryDefault from "AppealIngestionActivitySummary" /* 11465 */;
import AppealIngestionPolicySummaryDefault from "AppealIngestionPolicySummary" /* 11466 */;
...
export default function AppealIngestionSpeedBump(arg0) {
  ...
  const tmp = callback2();
  _require = _require(11464).useEmitAppealIngestionEvent();
  ...
  const tmp2Result = _require(11464);
  const intl2 = tmp2(1236).intl;
  const stringResult = intl.string(_require(1236).t["C5q+pW"]);
  const items1 = [callback(_require(11462).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(_require(1236).t.URt7VI) }), ];
  ...
  if (isDeveloperClassification) {
    ...
    isDeveloperClassification = tmp9(tmp13(11467), obj4);
    const tmp13Result1 = tmp13(11467);
  }
  ...
  if (!isCoppa) {
    ...
    tmp9Result1 = tmp9(tmp13(11467), obj5);
    const tmp13Result2 = tmp13(11467);
  }
  ...
  if (isDsaEligible) {
    ...
    isDsaEligible = tmp9(tmp2(4376).Text, obj6);
  }
  ...
  obj7[0] = items1;
  return closure_9(_require(11462).AppealIngestionModalScreen, obj7);
};
