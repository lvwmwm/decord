...
obj = {
  ...
  SAFETY_HUB_FETCH_CLASSIFICATION_START: function handleFetchClassificationStart(classificationId) {
    closure_7[classificationId.classificationId] = require(7851) /* ContentIdType */.ClassificationRequestState.PENDING;
    let c9 = true;
  },
  SAFETY_HUB_FETCH_CLASSIFICATION_SUCCESS: function handleFetchClassificationSuccess(classification) {
    ...
    closure_7[classification.id] = require(7851) /* ContentIdType */.ClassificationRequestState.SUCCESS;
    let c9 = false;
    let c11 = null;
    let c10 = true;
  },
  SAFETY_HUB_FETCH_CLASSIFICATION_FAILURE: function handleFetchClassificationFailure(error) {
    let c9 = false;
    error = error.error;
    closure_7[error.classificationId] = require(7851) /* ContentIdType */.ClassificationRequestState.FAILED;
    let c10 = false;
  },
  ...
  SAFETY_HUB_REQUEST_REVIEW_SUCCESS: function handleSafetyHubRequestReviewSuccess(arg0) {
    let c16 = false;
    let c17 = null;
    dependencyMap[arg0.classificationId].appeal_status = { status: require(7851) /* ContentIdType */.AppealStatusType.REVIEW_PENDING };
  },
    ...
    if (arg0 == null) {
      ...
      for (const key10007 in closure_6) {
        ...
        if (!dependencyMap[key10007].is_coppa) {
          ...
          obj[0] = require(7851) /* ContentIdType */.AppealStatusType.REVIEW_PENDING;
  ...
  LOGOUT: function reset() {
    let c9 = false;
    let closure_6 = {};
    const obj = { state: require(7851) /* ContentIdType */.AccountStandingState.ALL_GOOD };
    let c12 = null;
    const DIDNT_VIOLATE_POLICY = AppealIngestionSignal.DIDNT_VIOLATE_POLICY;
    let c19 = "";
    let closure_15 = [];
