...
// Dependencies: [1218, 7700, 676, 3837, 4442, 1236, 7701, 589, 2]
...
// Module 7699 (parseMessageEmbedForProps)
...
export const isFlaggedContentEmpty = function isFlaggedContentEmpty(first) {
  let tmp = first.type !== require(7701) /* ContentIdType */.ContentIdType.MESSAGE;
  if (!tmp) {
