// Module ID: 11357
// Function ID: 11358
// Dependencies: [5, 7846, 7839, 21, 709, 4312, 11358, 2007, 4549, 7992, 7840, 11346, 2]
...
let obj = {
  open(classificationId, onClose) {
    ...
    importDefault(4312).openLazy(require(2007) /* asyncRequireImpl */(11358, dependencyMap.paths), closure_4, obj);
  },
  openV2(arg0, onClose) {
    let closure_0 = arg0;
