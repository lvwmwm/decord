// Module ID: 11080
// Function ID: 11081
// Dependencies: [5, 6753, 6745, 21, 709, 4157, 11081, 1959, 4395, 7615, 6746, 11074, 2]
...
let obj = {
  open(classificationId, onClose) {
    ...
    importDefault(4157).openLazy(require(1959) /* asyncRequireImpl */(11081, dependencyMap.paths), closure_4, obj);
  },
  openV2(arg0, onClose) {
    let closure_0 = arg0;
