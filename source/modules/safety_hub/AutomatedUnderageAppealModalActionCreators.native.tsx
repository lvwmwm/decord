// Module ID: 11348
// Function ID: 11349
// Dependencies: [5, 7850, 7843, 21, 709, 4310, 11349, 2007, 4550, 7996, 7844, 11337, 2]
...
let obj = {
  open(classificationId, onClose) {
    ...
    importDefault(4310).openLazy(require(2007) /* asyncRequireImpl */(11349, dependencyMap.paths), closure_4, obj);
  },
  openV2(arg0, onClose) {
    let closure_0 = arg0;
