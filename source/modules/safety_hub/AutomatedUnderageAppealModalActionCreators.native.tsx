// Module ID: 11182
// Function ID: 11183
// Dependencies: [5, 7700, 7693, 21, 709, 4223, 11183, 1959, 4460, 7733, 7694, 11171, 2]
...
let obj = {
  open(classificationId, onClose) {
    ...
    importDefault(4223).openLazy(require(1959) /* asyncRequireImpl */(11183, dependencyMap.paths), closure_4, obj);
  },
  openV2(arg0, onClose) {
    let closure_0 = arg0;
