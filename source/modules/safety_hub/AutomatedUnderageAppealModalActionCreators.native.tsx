// Module ID: 11084
// Function ID: 11085
// Dependencies: [5, 6756, 6748, 21, 709, 4157, 11085, 1959, 4395, 7618, 6749, 11078, 2]
...
let obj = {
  open(classificationId, onClose) {
    ...
    importDefault(4157).openLazy(require(1959) /* asyncRequireImpl */(11085, dependencyMap.paths), closure_4, obj);
  },
  openV2(arg0, onClose) {
    let closure_0 = arg0;
