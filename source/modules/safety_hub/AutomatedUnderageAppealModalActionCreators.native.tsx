// Module ID: 11078
// Function ID: 11079
// Dependencies: [5, 5438, 5427, 21, 709, 4342, 11079, 2007, 5260, 6689, 5254, 11067, 2]
...
let obj = {
  open(classificationId, onClose) {
    ...
    importDefault(4342).openLazy(require(2007) /* asyncRequireImpl */(11079, dependencyMap.paths), closure_4, obj);
  },
  openV2(arg0, onClose) {
    let closure_0 = arg0;
