// Module ID: 11231
// Function ID: 11232
// Dependencies: [5, 7745, 7738, 21, 709, 4270, 11232, 1988, 4507, 7891, 7739, 11220, 2]
...
let obj = {
  open(classificationId, onClose) {
    ...
    importDefault(4270).openLazy(require(1988) /* asyncRequireImpl */(11232, dependencyMap.paths), closure_4, obj);
  },
  openV2(arg0, onClose) {
    let closure_0 = arg0;
