// Module ID: 11216
// Function ID: 11217
// Dependencies: [5, 7728, 7721, 21, 709, 4253, 11217, 1988, 4490, 7874, 7722, 11205, 2]
...
let obj = {
  open(classificationId, onClose) {
    ...
    importDefault(4253).openLazy(require(1988) /* asyncRequireImpl */(11217, dependencyMap.paths), closure_4, obj);
  },
  openV2(arg0, onClose) {
    let closure_0 = arg0;
