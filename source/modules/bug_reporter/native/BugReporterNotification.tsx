...
// Dependencies: [19, 17, 10344, 676, 21, 4189, 712, 10334, 10279, 10261, 4395, 10260, 10345, 1959, 6611, 2]
// Exports: BugReporterNotification

// Module 10343 (BugReporterNotification)
...
export const BugReporterNotification = function BugReporterNotification(notification) {
  ...
  obj[1] = jsx(notification(10279).SystemMessageText, { text: "Bzzz! Found a bug? Tap to submit." });
  ...
  obj[5] = notification;
  return jsx(notification(10334).NotificationPressable, { header: memo, children: null, rightAccessory: null, onPress: null, onSettingsPress: null, notification: null });
};
