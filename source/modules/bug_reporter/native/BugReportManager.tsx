...
// Dependencies: [6, 7, 15, 17, 18, 5, 27, 683, 4344, 477, 10235, 491, 10335, 5078, 2]

// Module 10334 (_isNativeReflectConstruct)
...
tmp4 = new tmp4();
let result = require("_possibleConstructorReturn").fileFinishedImporting("modules/bug_reporter/native/BugReportManager.tsx");
