...
// Function ID: 80022
// Name: items
// Dependencies: [31, 27, 33, 10381, 10382, 10383, 10384, 10385, 10386, 1212, 4165, 4101, 4011, 6215, 22, 4596, 4161, 2]
// Exports: default
...
export default function ChannelFollowSuccessAlert(arg0) {
  ...
  const tmp3 = obj.isThemeDark(importDefault(4101)()) ? items1 : items;
  require = tmp3;
  let obj1 = require(6215) /* useForceUpdate */;
  items = [tmp3];
  const stableMemo = obj1.useStableMemo(() => outer1_1(outer1_2[14]).sample(closure_0), items);
  let obj2 = require(6215) /* useForceUpdate */;
