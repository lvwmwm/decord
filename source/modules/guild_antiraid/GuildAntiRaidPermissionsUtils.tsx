...
export const useShowMentionRaidLimitUpsell = function useShowMentionRaidLimitUpsell(id) {
  ...
  const obj2 = _require(9824);
  return _require(9824).useIsMentionRaidExperimentEnabled(id, false) && stateFromStores;
};
