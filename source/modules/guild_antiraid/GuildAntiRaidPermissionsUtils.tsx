...
export const useShowMentionRaidLimitUpsell = function useShowMentionRaidLimitUpsell(id) {
  ...
  const obj2 = _require(9773);
  return _require(9773).useIsMentionRaidExperimentEnabled(id, false) && stateFromStores;
};
