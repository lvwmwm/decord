...
export const useShowMentionRaidLimitUpsell = function useShowMentionRaidLimitUpsell(id) {
  ...
  const obj2 = _require(9779);
  return _require(9779).useIsMentionRaidExperimentEnabled(id, false) && stateFromStores;
};
