...
export const useShowMentionRaidLimitUpsell = function useShowMentionRaidLimitUpsell(id) {
  ...
  const obj2 = _require(9691);
  return _require(9691).useIsMentionRaidExperimentEnabled(id, false) && stateFromStores;
};
