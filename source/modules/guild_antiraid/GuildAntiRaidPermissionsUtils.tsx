...
export const useShowMentionRaidLimitUpsell = function useShowMentionRaidLimitUpsell(id) {
  ...
  const obj2 = _require(9707);
  return _require(9707).useIsMentionRaidExperimentEnabled(id, false) && stateFromStores;
};
