...
export const useShowMentionRaidLimitUpsell = function useShowMentionRaidLimitUpsell(id) {
  ...
  const obj2 = _require(9774);
  return _require(9774).useIsMentionRaidExperimentEnabled(id, false) && stateFromStores;
};
