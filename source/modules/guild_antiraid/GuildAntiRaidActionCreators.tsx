...
export const trackReportRaidViewed = function trackReportRaidViewed(onChange, onSubmit) {
  ...
  if (0 !== items.length) {
    ...
    obj = {};
    const merged = Object.assign(require(4496) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(onChange));
