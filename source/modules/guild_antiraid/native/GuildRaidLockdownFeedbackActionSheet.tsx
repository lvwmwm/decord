...
// Dependencies: [32, 19, 676, 21, 4478, 1236, 7263, 4445, 5989, 5621, 6049, 5992, 7683, 7808, 4928, 4700, 2]
// Exports: default

// Module 11405 (GuildRaidLockdownFeedbackActionSheet)
...
export default function GuildRaidLockdownFeedbackActionSheet(guildId) {
  ...
  obj5[1] = callback(guildId(5621).BottomSheetTitleHeader, obj6);
  const obj7 = { style: callback2().container, children: null };
  const tmp = callback2();
  const tmp8 = closure_7;
  const tmp9 = first(6049);
  const items1 = [
    callback(guildId(5992).TableRowGroup, {
      hasIcons: false,
  ...
  if (hasItem) {
    ...
    hasItem = tmp7(tmp5(7808).TextArea, obj9);
  }
  items1[1] = hasItem;
  const obj10 = {
    onPress() {
