...
// Dependencies: [32, 19, 676, 21, 4255, 1236, 6874, 4223, 5617, 5308, 5704, 5620, 9272, 7774, 4666, 4450, 2]
// Exports: default

// Module 11153 (GuildRaidLockdownFeedbackActionSheet)
...
export default function GuildRaidLockdownFeedbackActionSheet(guildId) {
  ...
  obj5[1] = callback(guildId(5308).BottomSheetTitleHeader, obj6);
  ...
  obj8[1] = items.map((value) => {
    ...
    obj[2] = value.text;
    return outer1_6(guildId(9272).TableCheckboxRow, obj, value);
  });
  const items1 = [callback(guildId(5620).TableRowGroup, obj8), , ];
  let hasItem = first.includes(guildId(6874).RaidLockdownFeedbackType.OTHER);
  if (hasItem) {
    ...
    hasItem = tmp7(tmp5(7774).TextArea, obj9);
  }
  items1[1] = hasItem;
  const obj10 = {
    onPress() {
      let obj = guildId(4450);
  ...
  items1[2] = callback(guildId(4666).Button, obj10);
  obj7[1] = items1;
  obj5[2] = tmp8(first(5704), obj7);
  return callback(guildId(5617).ActionSheet, obj5);
};
