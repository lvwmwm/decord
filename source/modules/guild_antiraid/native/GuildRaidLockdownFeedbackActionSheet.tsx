...
// Dependencies: [32, 19, 676, 21, 4303, 1236, 6980, 4271, 5764, 5396, 5824, 5767, 8454, 7978, 4714, 4498, 2]
// Exports: default

// Module 11236 (GuildRaidLockdownFeedbackActionSheet)
...
export default function GuildRaidLockdownFeedbackActionSheet(guildId) {
  ...
  obj8[1] = items.map((value) => {
    ...
    obj[2] = value.text;
    return outer1_6(guildId(8454).TableCheckboxRow, obj, value);
  });
  const items1 = [callback(guildId(5767).TableRowGroup, obj8), , ];
  let hasItem = first.includes(guildId(6980).RaidLockdownFeedbackType.OTHER);
  if (hasItem) {
    ...
    hasItem = tmp7(tmp5(7978).TextArea, obj9);
  }
  items1[1] = hasItem;
  const obj10 = {
    onPress() {
