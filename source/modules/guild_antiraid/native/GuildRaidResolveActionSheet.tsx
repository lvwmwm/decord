...
// Dependencies: [32, 19, 17, 676, 7702, 21, 4285, 712, 1236, 6898, 4253, 5685, 5745, 4281, 7890, 1297, 4695, 4479, 11148, 7707, 2]
// Exports: default

// Module 11178 (GuildRaidResolveActionSheet)
...
export default function GuildRaidResolveActionSheet(arg0) {
  ...
  obj3[1] = items1;
  obj2[0] = callback3(importDefault(5745), obj3);
  return callback2(require(5685) /* ActionSheet */.ActionSheet, obj2);
};
