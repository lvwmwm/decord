...
// Dependencies: [32, 19, 17, 676, 7674, 21, 4255, 712, 1236, 6871, 4223, 5631, 5718, 4251, 7749, 1297, 4665, 4449, 11114, 7679, 2]
// Exports: default

// Module 11144 (GuildRaidResolveActionSheet)
import _slicedToArray from "_slicedToArray";
import module_7679 from "module_7679";
...
export default function GuildRaidResolveActionSheet(arg0) {
  ...
  items1[3] = callback2(require(4665) /* Button */.Button, obj6);
  const obj7 = {
  ...
  items1[4] = callback2(require(4665) /* Button */.Button, obj7);
  obj3[1] = items1;
  obj2[0] = callback3(importDefault(5718), obj3);
  return callback2(require(5631) /* ActionSheet */.ActionSheet, obj2);
};
