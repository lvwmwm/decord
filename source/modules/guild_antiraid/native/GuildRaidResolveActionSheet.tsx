...
export default function GuildRaidResolveActionSheet(arg0) {
  ...
  const items1 = [callback2(require(4299) /* Text */.Text, obj4), , , , ];
  ...
  items1[1] = callback2(require(4299) /* Text */.Text, obj5);
  ...
  items1[3] = callback2(require(4714) /* Button */.Button, obj6);
  const obj7 = {
  ...
  items1[4] = callback2(require(4714) /* Button */.Button, obj7);
  obj3[1] = items1;
  obj2[0] = callback3(importDefault(5824), obj3);
  return callback2(require(5764) /* ActionSheet */.ActionSheet, obj2);
};
