...
// Function ID: 13380
// Name: ReportModal
// Dependencies: [32, 19, 17, 13380, 21, 4342, 712, 1628, 4338, 4058, 1236, 5807, 8497, 4755, 5310, 11280, 5823, 2]
// Exports: default

// Module 13379 (ReportModal)
...
function ReportModal(onSubmit) {
  ...
  const items1 = [callback2(require(4338) /* Text */.Text, obj), , ];
