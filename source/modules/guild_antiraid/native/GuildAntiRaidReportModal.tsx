...
function ReportModal(onSubmit) {
  ...
  const items1 = [callback2(require(4185) /* Text */.Text, obj), , ];
  ...
  obj[1] = callback2(require(5554) /* TableRowGroupTitle */.TableRowGroup, obj1);
  ...
  obj2[1] = callback2(require(4600) /* Button */.Button, obj4);
