...
// Function ID: 13242
// Name: ReportModal
// Dependencies: [32, 19, 17, 13242, 21, 4302, 712, 1609, 4298, 3998, 1236, 5707, 8388, 4712, 5269, 11163, 5723, 2]
// Exports: default

// Module 13241 (ReportModal)
...
function ReportModal(onSubmit) {
  ...
  const items1 = [callback2(require(4298) /* Text */.Text, obj), , ];
  ...
  obj[1] = callback2(require(5707) /* TableRowGroupTitle */.TableRowGroup, obj1);
  ...
  obj2[1] = callback2(require(4712) /* Button */.Button, obj4);
