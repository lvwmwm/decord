...
// Dependencies: [1340, 1891, 3912, 4101, 1903, 9669, 8046, 676, 647, 11, 8045, 506, 3917, 9690, 2]
...
// Module 9689 (getFirstGuildIncidentId)
  ...
  while (iter !== undefined) {
    ...
    if (null != nextResult) {
      ...
      if (null != tmp15) {
        ...
        let obj8 = stateFromStores1(8045);
        let tmp21 = tmp15;
...
export const useGuildIncidentsState = function useGuildIncidentsState(id) {
  ...
  if (isUnderLockdownResult) {
    isUnderLockdownResult = _require(8045).isUnderLockdown(stateFromStores1);
    const tmpResult = _require(8045);
  }
...
export const shouldShowRaidInAppNotification = function shouldShowRaidInAppNotification() {
  ...
  if (isUnderLockdownResult) {
    isUnderLockdownResult = require(8045) /* DATE_CONFIG */.isUnderLockdown(guildIncident);
    const obj2 = require(8045) /* DATE_CONFIG */;
  }
