...
// Dependencies: [1340, 1862, 3913, 4102, 1874, 9667, 7933, 676, 647, 11, 7932, 506, 3918, 9688, 2]
...
// Module 9687 (getFirstGuildIncidentId)
  ...
  while (iter !== undefined) {
    ...
    if (null != nextResult) {
      ...
      if (null != tmp15) {
        ...
        let obj8 = stateFromStores1(7932);
        let tmp21 = tmp15;
