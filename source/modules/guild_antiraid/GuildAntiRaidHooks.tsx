...
// Dependencies: [1340, 1891, 3929, 4118, 1903, 9685, 8063, 676, 647, 11, 8062, 506, 3934, 9706, 2]
...
// Module 9705 (getFirstGuildIncidentId)
  ...
  while (iter !== undefined) {
    ...
    if (null != nextResult) {
      ...
      if (null != tmp17) {
        ...
        let obj7 = require(8062) /* DATE_CONFIG */;
        let tmp22 = tmp17;
        if (obj7.hasDetectedActivity(tmp18)) {
          let tmp8 = tmp20;
          let tmp19Result = tmp19(8062);
          let tmp9 = tmp17;
  ...
  while (iter !== undefined) {
    ...
    if (null != nextResult) {
      ...
      if (null != tmp15) {
        ...
        let obj8 = stateFromStores1(8062);
        let tmp21 = tmp15;
...
export const useGuildIncidentsState = function useGuildIncidentsState(id) {
  ...
  if (isUnderLockdownResult) {
    isUnderLockdownResult = _require(8062).isUnderLockdown(stateFromStores1);
    const tmpResult = _require(8062);
  }
...
export const shouldShowRaidInAppNotification = function shouldShowRaidInAppNotification() {
  ...
  if (isUnderLockdownResult) {
    isUnderLockdownResult = require(8062) /* DATE_CONFIG */.isUnderLockdown(guildIncident);
    const obj2 = require(8062) /* DATE_CONFIG */;
  }
