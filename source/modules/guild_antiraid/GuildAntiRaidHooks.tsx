...
// Dependencies: [1340, 1910, 3989, 4167, 1922, 9798, 8164, 676, 647, 11, 8163, 506, 3994, 9819, 2]
...
// Module 9818 (getFirstGuildIncidentId)
  ...
  while (iter !== undefined) {
    ...
    if (null != nextResult) {
      ...
      if (null != tmp17) {
        ...
        let obj7 = require(8163) /* DATE_CONFIG */;
        let tmp22 = tmp17;
...
export const useGuildIncidentsState = function useGuildIncidentsState(id) {
  ...
  if (isUnderLockdownResult) {
    isUnderLockdownResult = _require(8163).isUnderLockdown(stateFromStores1);
    const tmpResult = _require(8163);
  }
...
export const shouldShowRaidInAppNotification = function shouldShowRaidInAppNotification() {
  ...
  if (isUnderLockdownResult) {
    isUnderLockdownResult = require(8163) /* DATE_CONFIG */.isUnderLockdown(guildIncident);
    const obj2 = require(8163) /* DATE_CONFIG */;
  }
