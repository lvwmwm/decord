...
// Dependencies: [1340, 1862, 3883, 4072, 1874, 9638, 7905, 676, 647, 11, 7904, 506, 3888, 9659, 2]
...
// Module 9658 (getFirstGuildIncidentId)
  ...
  while (iter !== undefined) {
    ...
    if (null != nextResult) {
      ...
      if (null != tmp17) {
        ...
        let obj7 = require(7904) /* DATE_CONFIG */;
        let tmp22 = tmp17;
        if (obj7.hasDetectedActivity(tmp18)) {
          let tmp8 = tmp20;
          let tmp19Result = tmp19(7904);
          let tmp9 = tmp17;
  ...
  while (iter !== undefined) {
    ...
    if (null != nextResult) {
      ...
      if (null != tmp15) {
        ...
        let obj8 = stateFromStores1(7904);
        let tmp21 = tmp15;
...
export const useGuildIncidentsState = function useGuildIncidentsState(id) {
  ...
  if (isUnderLockdownResult) {
    isUnderLockdownResult = _require(7904).isUnderLockdown(stateFromStores1);
    const tmpResult = _require(7904);
  }
...
export const shouldShowRaidInAppNotification = function shouldShowRaidInAppNotification() {
  ...
  if (isUnderLockdownResult) {
    isUnderLockdownResult = require(7904) /* DATE_CONFIG */.isUnderLockdown(guildIncident);
