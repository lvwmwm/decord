...
// Dependencies: [19, 17, 1903, 16056, 21, 4162, 4302, 712, 500, 4844, 4711, 5359, 11275, 16063, 589, 16064, 5668, 5688, 5899, 3947, 8310, 8313, 4002, 10885, 1236, 16066, 4298, 4821, 2]

// Module 16062 (SoundButtonEmoji)
...
function SoundButtonEmoji(arg0) {
  ...
  obj4[2] = importDefault(11275)(sound, 24);
  let str = sound.emojiName;
  if (str == null) {
    str = "";
  }
  obj4[3] = str;
  obj3[1] = closure_6(importDefault(5359), obj4);
