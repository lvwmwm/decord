...
// Dependencies: [19, 17, 1903, 16030, 21, 4145, 4285, 712, 500, 4827, 4694, 5340, 11260, 16037, 589, 16038, 5649, 5669, 5880, 3930, 8293, 8296, 3985, 10873, 1236, 16040, 4281, 4804, 2]

// Module 16036 (SoundButtonEmoji)
...
function SoundButtonEmoji(arg0) {
  ...
  obj4[2] = importDefault(11260)(sound, 24);
  let str = sound.emojiName;
  if (str == null) {
    str = "";
  }
  obj4[3] = str;
  obj3[1] = closure_6(importDefault(5340), obj4);
