...
// Dependencies: [19, 17, 1922, 16284, 21, 4115, 4661, 712, 500, 5433, 4744, 6930, 11121, 16291, 589, 16292, 7139, 7159, 7304, 4039, 8479, 8482, 4094, 12626, 1236, 16294, 4734, 6890, 2]
...
function SoundButtonEmoji(arg0) {
  ...
  obj4[2] = importDefault(11121)(sound, 24);
  let str = sound.emojiName;
  if (str == null) {
    str = "";
  }
  obj4[3] = str;
  obj3[1] = closure_6(importDefault(6930), obj4);
