...
// Dependencies: [676, 1231, 4164, 1377, 4310, 16223, 2007, 2]
// Exports: showSoundboardSoundPickerActionSheet

// Module 16222 (showSoundboardSoundPickerActionSheet)
...
export const showSoundboardSoundPickerActionSheet = function showSoundboardSoundPickerActionSheet(arg0) {
  ...
  importDefault(4310).openLazy(require(2007) /* asyncRequireImpl */(16223, dependencyMap.paths), "SoundboardSoundPickerActionSheet", { channel, analyticsSource });
};
