...
// Dependencies: [19, 17, 16055, 1903, 676, 21, 4302, 712, 4754, 5719, 1236, 9894, 4266, 16068, 4844, 1297, 4821, 4271, 4272, 589, 3947, 8623, 1609, 4172, 8714, 2]

// Module 16070 (SoundCategoryItem)
...
function SoundCategoryItem(style) {
  ...
  return callback(require(4844) /* PressableBase */.PressableOpacity, obj, name);
}
