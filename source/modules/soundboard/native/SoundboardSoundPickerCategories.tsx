...
// Dependencies: [19, 17, 16029, 1903, 676, 21, 4285, 712, 4737, 5700, 1236, 9878, 4249, 16042, 4827, 1297, 4804, 4254, 4255, 589, 3930, 8606, 1609, 4155, 8697, 2]

// Module 16044 (SoundCategoryItem)
...
function SoundCategoryItem(style) {
  ...
  return callback(require(4827) /* PressableBase */.PressableOpacity, obj, name);
}
