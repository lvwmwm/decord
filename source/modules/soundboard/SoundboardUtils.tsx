...
// Dependencies: [5, 1340, 1376, 3883, 1874, 4700, 4701, 676, 1338, 3928, 3901, 5854, 5847, 4707, 5855, 709, 5882, 5883, 5884, 647, 4094, 1358, 1355, 698, 4449, 2]
...
// Module 5853 (hasPermissionToPlaySound)
...
function canMakeSound(channel) {
  let obj = require(5854) /* getMuteStates */;
  obj = { channel };
...
export const playSound = function playSound(soundId, channelId) {
  let obj = require(5847) /* _fetchDefaultSoundsFromApi2 */;
  obj.playSoundLocally(channelId, soundId, require(4707) /* SoundButtonOverlay */.LocalSoundTrigger.SOUNDBOARD);
  const result = require(5855) /* VoiceChannelEffectSentLocation */.sendVoiceChannelSoundboardEffect(channelId, soundId, false, arg2, arg3);
  const obj2 = require(5855) /* VoiceChannelEffectSentLocation */;
