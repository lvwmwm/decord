...
// Dependencies: [1391, 676, 698, 4549, 2]
// Exports: onTapCheckpointCard

// Module 11413 (onTapCheckpointCard)
...
export const onTapCheckpointCard = function onTapCheckpointCard(message) {
  ...
  const merged = Object.assign(require(4549) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(channel));
  const obj3 = require(4549) /* collectGuildAnalyticsMetadata */;
  let guild_id;
  if (channel != null) {
    guild_id = channel.guild_id;
  }
  const merged1 = Object.assign(require(4549) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(guild_id));
