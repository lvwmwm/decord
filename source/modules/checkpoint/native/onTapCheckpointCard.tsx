...
// Dependencies: [1372, 676, 698, 4449, 2]
// Exports: onTapCheckpointCard

// Module 11230 (onTapCheckpointCard)
...
export const onTapCheckpointCard = function onTapCheckpointCard(message) {
  ...
  const merged = Object.assign(require(4449) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(channel));
  const obj3 = require(4449) /* collectGuildAnalyticsMetadata */;
  let guild_id;
  if (channel != null) {
    guild_id = channel.guild_id;
  }
  const merged1 = Object.assign(require(4449) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(guild_id));
