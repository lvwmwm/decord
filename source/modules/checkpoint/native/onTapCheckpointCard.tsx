...
// Dependencies: [1372, 676, 698, 4496, 2]
// Exports: onTapCheckpointCard

// Module 11279 (onTapCheckpointCard)
...
export const onTapCheckpointCard = function onTapCheckpointCard(message) {
  ...
  const merged = Object.assign(require(4496) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(channel));
  const obj3 = require(4496) /* collectGuildAnalyticsMetadata */;
  let guild_id;
  if (channel != null) {
    guild_id = channel.guild_id;
  }
  const merged1 = Object.assign(require(4496) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(guild_id));
