...
// Dependencies: [5, 32, 19, 4518, 3981, 1218, 4519, 1903, 7770, 7738, 676, 1221, 7719, 7739, 5140, 3980, 1935, 589, 11268, 709, 7737, 7724, 7743, 8793, 1236, 2802, 12959, 2]
...
// Module 4517 (useAgeVerificationRunner)
...
function shouldCallReactiveCheck() {
  ...
  let tmp5 = prop !== require(1935) /* PermissionOverwriteType */.AgeVerificationStatusUkAndAusOnly.UNVERIFIED;
  if (tmp5) {
    let prop1;
    if (currentUser != null) {
...
export const shouldShowTiggerPawtect = function shouldShowTiggerPawtect() {
  ...
  let tmp5 = prop !== require(1935) /* PermissionOverwriteType */.AgeVerificationStatusUkAndAusOnly.VERIFIED_ADULT;
  if (tmp5) {
...
export const useShouldShowTiggerPawtect = function useShouldShowTiggerPawtect() {
  ...
  let isFeatureAgeGated = require(3980) /* isFeatureAgeGated */.useIsFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.REACTIVE_CHECK);
  if (isFeatureAgeGated) {
    let prop;
    if (stateFromStores != null) {
      prop = stateFromStores.ageVerificationStatus;
  ...
  return prop1 !== require(1935) /* PermissionOverwriteType */.AgeVerificationStatusUkAndAusOnly.VERIFIED_ADULT && !isFeatureAgeGated;
};
export const isVerifiedTeen = function isVerifiedTeen() {
  ...
  return prop === require(1935) /* PermissionOverwriteType */.AgeVerificationStatusUkAndAusOnly.VERIFIED_TEEN;
};
...
export const useIsExplicitlyVerifiedAdult = function useIsExplicitlyVerifiedAdult() {
  ...
  return prop === require(1935) /* PermissionOverwriteType */.AgeVerificationStatusUkAndAusOnly.VERIFIED_ADULT;
};
export const isAssignedByDiscord = function isAssignedByDiscord() {
  ...
  return prop === require(1935) /* PermissionOverwriteType */.AgeVerificationStatusUkAndAusOnly.INFERRED_ADULT;
};
...
export const useShowAssignedAgeGroupSettings = function useShowAssignedAgeGroupSettings() {
  ...
  const obj = require(589) /* initialize */;
  const obj2 = require(3980) /* isFeatureAgeGated */;
  return require(3980) /* isFeatureAgeGated */.useIsFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.REACTIVE_CHECK) && stateFromStores;
};
        ...
        if (0 !== message.embeds.length) {
          if (null != message.embeds[0].fields) {
            if (message.embeds[0].type === constants.AGE_VERIFICATION_SYSTEM_NOTIFICATION) {
              ...
              if (enabled) {
                const FamilyCenterConnectionPrereqExperiment = require(11268) /* apexExperiment */.FamilyCenterConnectionPrereqExperiment;
...
export const isAgeVerified = function isAgeVerified() {
  ...
  if (tmp5) {
    ...
    tmp5 = prop1 !== require(1935) /* PermissionOverwriteType */.AgeVerificationStatusUkAndAusOnly.CLIENT_ONLY_PENDING;
  }
  return tmp5;
};
...
export const getAgeVerificationGetStartedSubtitle = function getAgeVerificationGetStartedSubtitle(entryPoint, arg1, isSuspendedUser) {
  ...
  if (set.has(entryPoint)) {
    ...
    stringResult = intl3.string(importDefault(2802).h7qzoa);
  } else if (null != arg1) {
    const intl2 = require(1236) /* getSystemLocale */.intl;
    const obj = { handleOnHelpUrlHook: null };
    obj[0] = arg1;
    stringResult = intl2.format(importDefault(2802).RpMIT0, obj);
  } else {
    const intl = require(1236) /* getSystemLocale */.intl;
