...
// Dependencies: [5, 19, 17, 8342, 673, 8349, 21, 4481, 709, 1627, 4741, 8508, 5647, 4477, 5642, 8509, 1233, 8341, 1994, 8343, 4936, 8510, 2]
// Exports: default

// Module 8507 (GetStartedScreen)
import noopAll from "noop" /* 19 */;
import ThemesDefault from "Themes" /* 709 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1627 */;
import closure_3 from "asyncGeneratorStep" /* 5 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import { getAgeVerificationGetStartedSteps as closure_6 } from "set" /* 8342 */;
...
export default function GetStartedScreen(onComplete) {
  ...
  const obj4 = {
    ...
    children: callback2(modalSessionId).map((children) => {
      ...
      let obj = { index: arg1 + 1, tip: callback(modalSessionId(4477).Text, { variant: "text-md/medium", color: "mobile-text-heading-primary", children: children.title }), description: null };
      let tmpResult = null;
      if (null != description) {
        obj = { variant: "text-xs/medium", color: "text-subtle", children: null };
        obj[2] = description;
        tmpResult = tmp(modalSessionId(4477).Text, obj);
      }
      obj[2] = tmpResult;
      return callback(_undefined(8509), obj, arg1);
    })
  };
  items1[1] = callback3(modalSessionId(5642).TableRowGroup, obj4);
  ...
  obj5[1] = callback3(modalSessionId(4477).Text, obj6);
  ...
  if (!isManualAgeVerificationHidden) {
    ...
    obj9[1] = tmp9(tmp4(4477).Text, obj10);
  ...
  obj14[4] = callback3(modalSessionId(8510).LinkExternalSmallIcon, { color: ThemesDefault.colors.WHITE });
  obj14[5] = loading;
  obj13[1] = callback3(modalSessionId(4936).Button, obj14);
