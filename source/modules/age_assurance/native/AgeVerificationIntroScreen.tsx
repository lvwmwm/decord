...
export default function GetStartedScreen(onComplete) {
  ...
  const obj4 = { cachedAt: true, edpbxy: "/assets/modules/stage_channels/native/images", style: tmp.getStartedHeaderText };
  ...
  const obj5 = {
    ...
    children: callback2(modalSessionId).map((children) => {
      ...
      let tmp3 = null;
      if (null != description) {
        obj = { cachedAt: null, edpbxy: null, children: description };
  ...
  obj7 = { cachedAt: "center", edpbxy: "center" };
  ...
  if (tmp7) {
    ...
    const obj11 = { cachedAt: "center", edpbxy: "center", style: tmp.getStartedRequestText };
