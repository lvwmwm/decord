...
// Dependencies: [5, 19, 17, 7721, 676, 7728, 21, 4285, 712, 1609, 4500, 7876, 5948, 4281, 5688, 7877, 1236, 7720, 1974, 7722, 4695, 7878, 2]
// Exports: default

// Module 7875 (GetStartedScreen)
...
export default function GetStartedScreen(onComplete) {
  ...
  items3 = [tmp.getStartedFooterContainer, { paddingBottom: importDefault(1609)().bottom }];
