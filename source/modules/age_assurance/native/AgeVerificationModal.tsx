...
// Dependencies: [19, 7864, 21, 7870, 4197, 4582, 7876, 4342, 712, 4572, 6072, 1236, 5844, 2]
// Exports: default

// Module 7886 (AgeVerifyScreen)
    ...
    return {
      [outer1_6.VERIFY_AGE]: {
        ...
        headerLeft() {
          ...
          return outer1_5(callback(6072).HeaderActionButton, obj);
        },
        render() {
