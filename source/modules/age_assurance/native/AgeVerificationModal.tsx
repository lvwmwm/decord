...
// Dependencies: [19, 7839, 21, 7845, 4199, 4559, 7851, 4344, 712, 4549, 6049, 1236, 5822, 2]
// Exports: default

// Module 7861 (AgeVerifyScreen)
    ...
    return {
      [outer1_6.VERIFY_AGE]: {
        ...
        headerLeft() {
          ...
          return outer1_5(callback(6049).HeaderActionButton, obj);
        },
        render() {
