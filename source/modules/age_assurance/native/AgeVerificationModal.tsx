...
// Dependencies: [19, 7843, 21, 7849, 4197, 4560, 7855, 4342, 712, 4550, 6051, 1236, 5823, 2]
// Exports: default

// Module 7865 (AgeVerifyScreen)
    ...
    return {
      [outer1_6.VERIFY_AGE]: {
        ...
        headerLeft() {
          ...
          return outer1_5(callback(6051).HeaderActionButton, obj);
        },
        render() {
