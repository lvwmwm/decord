...
// Dependencies: [19, 6745, 21, 6752, 4040, 4405, 6756, 4189, 712, 4395, 6749, 1236, 5570, 2]
// Exports: default

// Module 6766 (AgeVerifyScreen)
    ...
    return {
      [outer1_6.VERIFY_AGE]: {
        ...
        headerLeft() {
          ...
          return outer1_5(callback(6749).HeaderActionButton, obj);
        },
        render() {
