...
// Dependencies: [19, 8614, 21, 8620, 4299, 4686, 8524, 4445, 712, 4676, 6189, 1236, 5960, 2]
// Exports: default

// Module 8630 (AgeVerifyScreen)
import ThemesDefault from "Themes" /* 712 */;
import closure_3 from "noop" /* 19 */;
import { AGE_VERIFICATION_MODAL_KEY as closure_4 } from "set" /* 8614 */;
    ...
    return {
      [closure_1_6.VERIFY_AGE]: {
        ...
        headerLeft() {
          ...
          return closure_1_5(callback(6189).HeaderActionButton, obj);
        },
        render() {
