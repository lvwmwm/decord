...
// Dependencies: [19, 7693, 21, 7699, 4106, 4470, 7703, 4255, 712, 4460, 5902, 1236, 5650, 2]
// Exports: default

// Module 7713 (AgeVerifyScreen)
    ...
    return {
      [outer1_6.VERIFY_AGE]: {
        ...
        headerLeft() {
          ...
          return outer1_5(callback(5902).HeaderActionButton, obj);
        },
        render() {
