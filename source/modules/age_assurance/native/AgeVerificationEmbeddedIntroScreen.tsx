...
// Dependencies: [19, 676, 21, 4255, 712, 7699, 7733, 7741, 7729, 7730, 4663, 5921, 4251, 4470, 7743, 1236, 2773, 7692, 1945, 2]
// Exports: default

// Module 7740 (AgeVerificationEmbeddedIntroScreen)
import set from "set";
...
export default function AgeVerificationEmbeddedIntroScreen(arg0) {
  ...
  const items1 = [callback(navigation(5921).ShieldSpotIllustration, { height: 100, width: 177 }), ];
  ...
  obj5[3] = navigation(4470).getAgeVerificationGetStartedSubtitle(entryPoint, undefined, isSuspendedUser);
  items2[1] = callback(navigation(4251).Text, obj5);
  obj3[3] = items2;
  items1[1] = callback2(navigation(4663).Stack, obj3);
  obj2[3] = items1;
  const items3 = [callback2(navigation(4663).Stack, obj2), callback(navigation(7743).AgeVerificationMethodsContainer, { ageVerificationMethods: importDefault(7741)({ onClose, classificationId, onGoogleWalletSelect: callback }).ageVerificationMethods, modalSessionId })];
  obj1[3] = items3;
  const items4 = [callback2(navigation(4663).Stack, obj1), ];
  ...
  obj[0] = items4;
  obj[0] = callback2(navigation(7730).ModalContent, obj);
  return callback(navigation(7729).ModalScreen, obj);
};
