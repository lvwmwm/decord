...
// Dependencies: [19, 676, 21, 4285, 712, 7727, 7874, 7882, 7730, 7731, 4693, 5948, 4281, 4500, 7884, 1236, 2802, 7720, 1974, 2]
// Exports: default

// Module 7881 (AgeVerificationEmbeddedIntroScreen)
import set from "set";
...
export default function AgeVerificationEmbeddedIntroScreen(arg0) {
  ...
  const items1 = [callback(navigation(5948).ShieldSpotIllustration, { height: 100, width: 177 }), ];
  ...
  obj2[3] = items1;
  const items3 = [callback2(navigation(4693).Stack, obj2), callback(navigation(7884).AgeVerificationMethodsContainer, { ageVerificationMethods: importDefault(7882)({ onClose, classificationId, onGoogleWalletSelect: callback }).ageVerificationMethods, modalSessionId })];
  obj1[3] = items3;
  ...
  obj[0] = items4;
  obj[0] = callback2(navigation(7731).ModalContent, obj);
  return callback(navigation(7730).ModalScreen, obj);
};
