...
export default function AgeVerificationEmbeddedIntroScreen(arg0) {
  ...
  obj = {};
  const obj1 = {};
  const obj2 = { <string:105986657>: null, <string:1446732804>: null, <string:2891080363>: null };
  ...
  const obj5 = { cachedAt: null, edpbxy: null, style: tmp.header, children: arg1(dependencyMap[13]).getAgeVerificationGetStartedSubtitle(entryPoint, undefined, isSuspendedUser) };
  ...
  const obj6 = { cachedAt: "center", edpbxy: "center", style: tmp.helpLink };
