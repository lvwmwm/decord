...
// Dependencies: [19, 7709, 7716, 21, 4255, 712, 7715, 6958, 6963, 4664, 1297, 1236, 5620, 4251, 2773, 5088, 4666, 7714, 5286, 7708, 2]
// Exports: AgeVerificationMethodsContainer

// Module 7759 (AgeVerificationMethodsContainer)
...
export const AgeVerificationMethodsContainer = function AgeVerificationMethodsContainer(ageVerificationMethods) {
  ...
  if (null != prop) {
    ...
    obj[2] = items1;
    const items2 = [tmp6(prop(4664).Stack, obj), ];
    ...
    if (isSuspendedUser) {
      ...
      obj2[1] = intl4.format(modalSessionId(2773).htWh1G, obj3);
      tmp7Result = tmp7(tmp2(4251).Text, obj2);
    }
    const obj4 = { spacing: 8, align: "center", children: null };
    items2[1] = tmp7Result;
    obj4[2] = items2;
    return tmp6(prop(4664).Stack, obj4);
  }
  ...
  obj6[3] = intl2.string(modalSessionId(2773).cR6336);
  const items3 = [callback(prop(4251).Text, obj6), ];
  const obj7 = { style: tmp.buttonGroup, children: null };
  const obj8 = { variant: "primary", size: "lg", text: null, onPress: null };
  const intl3 = tmp2(1236).intl;
  obj8[2] = intl3.string(modalSessionId(2773).hDvmYP);
  obj8[3] = prop(7714).getAgeVerificationMethods;
  obj7[1] = callback(prop(4666).Button, obj8);
  items3[1] = callback(prop(5088).ButtonGroup, obj7);
  obj5[4] = items3;
  mapped = tmp6(tmp2(4664).Stack, obj5);
};
