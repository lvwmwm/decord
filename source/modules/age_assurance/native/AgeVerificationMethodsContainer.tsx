...
// Dependencies: [19, 7800, 7807, 21, 4303, 712, 7806, 7064, 7069, 4712, 1297, 1236, 5767, 4299, 2821, 5150, 4714, 7805, 5374, 7799, 2]
// Exports: AgeVerificationMethodsContainer

// Module 7963 (AgeVerificationMethodsContainer)
...
export const AgeVerificationMethodsContainer = function AgeVerificationMethodsContainer(ageVerificationMethods) {
  ...
  if (null != prop) {
    ...
    obj[2] = items1;
    const items2 = [tmp6(prop(4712).Stack, obj), ];
    ...
    items2[1] = tmp7Result;
    obj4[2] = items2;
    return tmp6(prop(4712).Stack, obj4);
  }
  ...
  obj5[4] = items3;
  mapped = tmp6(tmp2(4712).Stack, obj5);
};
