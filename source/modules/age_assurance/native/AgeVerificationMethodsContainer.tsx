...
// Dependencies: [19, 7839, 7846, 21, 4344, 712, 7845, 7103, 7108, 4752, 1297, 1236, 5806, 4340, 2821, 5190, 4754, 7844, 5413, 7838, 2]
// Exports: AgeVerificationMethodsContainer

// Module 8002 (AgeVerificationMethodsContainer)
...
export const AgeVerificationMethodsContainer = function AgeVerificationMethodsContainer(ageVerificationMethods) {
  ...
  if (null != prop) {
    ...
    obj[2] = items1;
    const items2 = [tmp6(prop(4752).Stack, obj), ];
    ...
    items2[1] = tmp7Result;
    obj4[2] = items2;
    return tmp6(prop(4752).Stack, obj4);
  }
  ...
  const items3 = [callback(prop(4340).Text, obj6), ];
  ...
  obj8[3] = prop(7844).getAgeVerificationMethods;
  obj7[1] = callback(prop(4754).Button, obj8);
  items3[1] = callback(prop(5190).ButtonGroup, obj7);
  obj5[4] = items3;
  mapped = tmp6(tmp2(4752).Stack, obj5);
};
