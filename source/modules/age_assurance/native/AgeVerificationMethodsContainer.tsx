...
// Dependencies: [19, 7864, 7871, 21, 4342, 712, 7870, 7131, 7136, 4775, 1297, 1236, 5828, 4338, 2821, 5212, 4777, 7869, 5435, 7863, 2]
// Exports: AgeVerificationMethodsContainer

// Module 8027 (AgeVerificationMethodsContainer)
...
export const AgeVerificationMethodsContainer = function AgeVerificationMethodsContainer(ageVerificationMethods) {
  ...
  if (null != prop) {
    ...
    obj[2] = items1;
    const items2 = [tmp6(prop(4775).Stack, obj), ];
    ...
    items2[1] = tmp7Result;
    obj4[2] = items2;
    return tmp6(prop(4775).Stack, obj4);
  }
  ...
  obj8[3] = prop(7869).getAgeVerificationMethods;
  obj7[1] = callback(prop(4777).Button, obj8);
  items3[1] = callback(prop(5212).ButtonGroup, obj7);
  obj5[4] = items3;
  mapped = tmp6(tmp2(4775).Stack, obj5);
};
