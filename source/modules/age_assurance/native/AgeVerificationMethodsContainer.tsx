...
// Dependencies: [19, 7843, 7850, 21, 4342, 712, 7849, 7109, 7114, 4753, 1297, 1236, 5807, 4338, 2821, 5191, 4755, 7848, 5414, 7842, 2]
// Exports: AgeVerificationMethodsContainer

// Module 8006 (AgeVerificationMethodsContainer)
...
export const AgeVerificationMethodsContainer = function AgeVerificationMethodsContainer(ageVerificationMethods) {
  ...
  if (null != prop) {
    ...
    obj[2] = items1;
    const items2 = [tmp6(prop(4753).Stack, obj), ];
    ...
    items2[1] = tmp7Result;
    obj4[2] = items2;
    return tmp6(prop(4753).Stack, obj4);
  }
  ...
  const items3 = [callback(prop(4338).Text, obj6), ];
  ...
  obj8[3] = prop(7848).getAgeVerificationMethods;
  obj7[1] = callback(prop(4755).Button, obj8);
  items3[1] = callback(prop(5191).ButtonGroup, obj7);
  obj5[4] = items3;
  mapped = tmp6(tmp2(4753).Stack, obj5);
};
