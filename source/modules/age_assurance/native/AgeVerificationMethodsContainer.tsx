...
// Dependencies: [19, 5427, 5438, 21, 4661, 712, 5437, 5006, 5011, 4733, 1297, 1236, 6286, 4734, 2853, 6687, 4745, 5436, 6291, 5428, 2]
// Exports: AgeVerificationMethodsContainer

// Module 6699 (AgeVerificationMethodsContainer)
...
export const AgeVerificationMethodsContainer = function AgeVerificationMethodsContainer(ageVerificationMethods) {
  ...
  obj6[3] = intl2.string(modalSessionId(2853).cR6336);
  const items3 = [callback(prop(4734).Text, obj6), ];
  const obj7 = { style: tmp.buttonGroup, children: null };
  const obj8 = { variant: "primary", size: "lg", text: null, onPress: null };
  const intl3 = tmp2(1236).intl;
  obj8[2] = intl3.string(modalSessionId(2853).hDvmYP);
  obj8[3] = prop(5436).getAgeVerificationMethods;
