...
// Dependencies: [19, 21, 4189, 712, 4395, 5143, 7616, 7621, 7622, 7613, 514, 6746, 5570, 1236, 2]
// Exports: default

// Module 7615 (AgeVerificationGetStartedModal)
...
export default function AgeVerificationGetStartedModal(entryPoint) {
  ...
  const memo1 = classificationId.useMemo(() => {
    ...
    obj[3] = function render() {
      return closeModal(callback(7616), { onClose: closeModal, modalSessionId: closure_0, entryPoint: callback });
    };
    obj[memo.INTRO] = obj;
    obj = {
      headerStyle: closeModalWithOnComplete.headerStyle,
    ...
    obj[3] = function render() {
      return closeModal(callback(7621), { onClose: closeModal, modalSessionId: closure_0 });
    };
    obj[memo.RETRY] = obj;
    const obj1 = {
      headerStyle: closeModalWithOnComplete.headerStyle,
    ...
    obj1[3] = function render(arg0, navigation) {
      return closeModal(callback(7622), { onClose: closeModalWithOnComplete, modalSessionId: closure_0, classificationId: dependencyMap, entryPoint: callback, navigation });
    };
    ...
    obj2[3] = function render() {
      return closeModal(callback(7613), { onClose: closeModalWithOnComplete, modalSessionId: closure_0 });
    };
