...
// Dependencies: [19, 21, 4189, 712, 4395, 5143, 7619, 7624, 7625, 7616, 514, 6749, 5570, 1236, 2]
// Exports: default

// Module 7618 (AgeVerificationGetStartedModal)
...
export default function AgeVerificationGetStartedModal(entryPoint) {
  ...
  const memo1 = classificationId.useMemo(() => {
    ...
    obj[3] = function render() {
      return closeModal(callback(7619), { onClose: closeModal, modalSessionId: closure_0, entryPoint: callback });
    };
    obj[memo.INTRO] = obj;
    obj = {
      headerStyle: closeModalWithOnComplete.headerStyle,
    ...
    obj[3] = function render() {
      return closeModal(callback(7624), { onClose: closeModal, modalSessionId: closure_0 });
    };
    obj[memo.RETRY] = obj;
    const obj1 = {
      headerStyle: closeModalWithOnComplete.headerStyle,
    ...
    obj1[3] = function render(arg0, navigation) {
      return closeModal(callback(7625), { onClose: closeModalWithOnComplete, modalSessionId: closure_0, classificationId: dependencyMap, entryPoint: callback, navigation });
    };
    ...
    obj2[3] = function render() {
      return closeModal(callback(7616), { onClose: closeModalWithOnComplete, modalSessionId: closure_0 });
    };
