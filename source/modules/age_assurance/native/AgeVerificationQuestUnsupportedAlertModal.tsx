...
// Dependencies: [19, 21, 4645, 1236, 2802, 4645, 2]
// Exports: default

// Module 7758 (AgeVerificationQuestUnsupportedAlertModal)
import "noop";
...
export default function AgeVerificationQuestUnsupportedAlertModal() {
  ...
  obj[0] = intl.string(importDefault(2802).gUqXQN);
  const intl2 = require(1236) /* getSystemLocale */.intl;
  obj[1] = intl2.string(importDefault(2802).yBHwMy);
  obj = { children: null };
  obj = { text: null };
  const intl3 = require(1236) /* getSystemLocale */.intl;
  obj[0] = intl3.string(require(1236) /* getSystemLocale */.t["NX+WJN"]);
  obj[0] = jsx(require(4645) /* getAlertModalItemKey */.AlertActionButton, { text: null }, "got-it");
