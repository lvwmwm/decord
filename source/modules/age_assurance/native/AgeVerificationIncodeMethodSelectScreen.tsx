...
// Dependencies: [5, 32, 19, 17, 1302, 7693, 7695, 21, 4255, 712, 7698, 5717, 4663, 4251, 1236, 2773, 5634, 5300, 2]
// Exports: default

// Module 7697 (AgeVerificationIncodeMethodSelectScreen)
import set from "set";
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    ...
    obj[1] = tmp6(_require(5717).ActivityIndicator, {});
    let tmp12 = obj;
  } else {
    ...
    const items2 = [tmp6(_require(5300).TableRow, obj4), ];
    ...
    items2[1] = tmp6(_require(5300).TableRow, obj5);
    obj3[1] = items2;
    items1[3] = closure_11(_require(5634).TableRowGroup, obj3);
    obj[2] = items1;
    obj[1] = closure_11(_require(4663).Stack, obj);
    tmp12 = obj;
  }
