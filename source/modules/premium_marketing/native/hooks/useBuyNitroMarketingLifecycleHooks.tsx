...
// Dependencies: [19, 7355, 1383, 4481, 709, 13280, 10671, 4301, 1372, 1374, 13284, 13285, 2]
// Exports: useBuyNitroMarketingLifecycleHooks

// Module 13279 (useBuyNitroMarketingLifecycleHooks)
...
export const useBuyNitroMarketingLifecycleHooks = function useBuyNitroMarketingLifecycleHooks(nativeStackNavigation, initialLoadCompleted) {
  ...
  promotionMarketingComponent = _require(13280).usePromotionMarketingComponent(_require(10671).MarketingComponentType.PREMIUM_TAB);
  ...
  const effect1 = React.useEffect(() => {
    ...
    return () => {
      const BuyNitroPurchaseLock = callback(13284).BuyNitroPurchaseLock;
      BuyNitroPurchaseLock.end();
      const BuyNitroPurchaseLock2 = callback(13284).BuyNitroPurchaseLock;
      const result = BuyNitroPurchaseLock2.setInitialLoadComplete(false);
      const result1 = callback(13285).resetBuyNitroTrialAndPriceOverrides();
    };
  }, []);
