...
// Dependencies: [32, 19, 6932, 5756, 7640, 2]
// Exports: useBuyNitroExperiment

// Module 7639 (useBuyNitroExperiment)
...
export const useBuyNitroExperiment = function useBuyNitroExperiment(isNitroHomeSurface) {
  ...
  let canRenderRedesignUpsellEarly = importDefault(5756)(() => callback(table[4]).getMobileNitroMarketingRedesignExperiment({ location: "PremiumMarketingPage" }));
