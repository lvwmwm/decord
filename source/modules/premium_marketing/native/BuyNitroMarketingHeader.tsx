...
// Dependencies: [19, 17, 7124, 21, 712, 4446, 4186, 4449, 4447, 4381, 12990, 500, 9469, 12988, 691, 5458, 7126, 8307, 4905, 1236, 12991, 4442, 7952, 11789, 2]
// Exports: default

// Module 12989 (BuyNitroMarketingHeader)
...
let closure_11 = createCacheKey.createStyles((arg0, arg1, arg2) => {
  ...
  obj[2] = { position: "absolute", top: -ThemesDefault.space.PX_16, right: "container", left: "kind", alignSelf: 0. };
  obj1 = { position: "absolute", top: -ThemesDefault.space.PX_16, right: "container", left: "kind", alignSelf: 0. };
