...
export default function BuyNitroMarketingFooter(arg0) {
  ...
  obj[0] = importDefault(5748).PREMIUM_MARKETING_FOOTER;
  obj[1] = planSelection;
  obj[2] = applicationId;
  obj[3] = onPaymentSuccess;
  obj[4] = onPaymentDismiss;
  obj[2] = jsx(importDefault(7737), { location: null, planSelection: null, applicationId: null, onPaymentSuccess: null, onPaymentDismiss: null });
  obj[1] = <closure_4 location={null} planSelection={null} applicationId={null} onPaymentSuccess={null} onPaymentDismiss={null} />;
  return jsx(require(5427) /* LegacyBaseButton */.GestureDetector, { location: null, planSelection: null, applicationId: null, onPaymentSuccess: null, onPaymentDismiss: null });
};
