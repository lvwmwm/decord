...
// Dependencies: [19, 6953, 1924, 21, 1236, 4707, 4710, 2]
// Exports: presentBuyNitroPurchaseSuccess

// Module 7807 (presentBuyNitroPurchaseSuccess)
import "noop";
...
export const presentBuyNitroPurchaseSuccess = function presentBuyNitroPurchaseSuccess(premiumTier) {
  ...
  obj[2] = jsx(require(4710) /* getAlertModalItemKey */.AlertActionButton, { variant: "primary", text: null });
  obj.openAlert("BuyNitroPurchaseSuccess", jsx(require(4710) /* getAlertModalItemKey */.AlertModal, { variant: "primary", text: null }), reset);
};
