...
// Dependencies: [19, 6887, 1924, 21, 1236, 4644, 4647, 2]
// Exports: presentBuyNitroPurchaseSuccess

// Module 7743 (presentBuyNitroPurchaseSuccess)
import "noop";
...
export const presentBuyNitroPurchaseSuccess = function presentBuyNitroPurchaseSuccess(premiumTier) {
  ...
  obj[2] = jsx(require(4647) /* getAlertModalItemKey */.AlertActionButton, { variant: "primary", text: null });
  obj.openAlert("BuyNitroPurchaseSuccess", jsx(require(4647) /* getAlertModalItemKey */.AlertModal, { variant: "primary", text: null }), reset);
};
