...
export default function BuyNitroGradient(selectedTier) {
  ...
  obj = { withTiming: selectedTier(4190).withTiming, selectedTier, PremiumTypes, timingStandard: selectedTier(4193).timingStandard };
  fn.__closure = obj;
  fn.__workletHash = 14014615431537;
  fn.__initData = closure_8;
  obj = { children: null };
  const animatedStyle = obj.useAnimatedStyle(fn);
  const items = [callback(importDefault(4611), { style, colors: nitroColors, start, end }), ];
