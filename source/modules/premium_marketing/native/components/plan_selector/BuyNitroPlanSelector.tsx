...
// Dependencies: [19, 17, 5752, 4238, 505, 21, 4255, 712, 5110, 589, 7541, 12556, 12557, 7635, 1236, 12558, 7767, 7766, 7304, 5749, 500, 2]
// Exports: default

// Module 12555 (BuyNitroPlanSelector)
...
export default function BuyNitroPlanSelector(planSelection) {
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(7767).TableRadioGroup, obj2);
  }
  ...
  if (tmp8Result) {
    ...
    obj3[1] = tmp8(selection(7304), obj4);
    tmp8Result = tmp8(tmp7, obj3);
    const tmp9Result = selection(7304);
  }
