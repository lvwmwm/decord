...
// Dependencies: [19, 17, 6036, 4427, 505, 21, 4445, 712, 5336, 589, 12931, 12979, 12980, 12967, 1236, 12981, 7625, 7626, 12875, 6033, 500, 2]
// Exports: default

// Module 12978 (BuyNitroPlanSelector)
import noopAll from "noop" /* 19 */;
import ThemesDefault from "Themes" /* 712 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_4 from "updateProduct" /* 6036 */;
import { EUR_TO_HRK_CONVERSION_RATE as closure_5 } from "CustomCheckoutFlow" /* 4427 */;
...
export default function BuyNitroPlanSelector(planSelection) {
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(7625).TableRadioGroup, obj2);
  }
  ...
  if (tmp8Result) {
    ...
    obj3[1] = tmp8(selection(12875), obj4);
    tmp8Result = tmp8(tmp7, obj3);
    const tmp9Result = selection(12875);
  }
