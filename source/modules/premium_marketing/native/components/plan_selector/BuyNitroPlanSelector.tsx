...
// Dependencies: [19, 17, 6049, 4428, 505, 21, 4446, 712, 5349, 589, 12950, 12998, 12999, 12986, 1236, 13000, 7639, 7640, 12894, 6046, 500, 2]
// Exports: default

// Module 12997 (BuyNitroPlanSelector)
import noopAll from "noop" /* 19 */;
import ThemesDefault from "Themes" /* 712 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_4 from "updateProduct" /* 6049 */;
import { EUR_TO_HRK_CONVERSION_RATE as closure_5 } from "CustomCheckoutFlow" /* 4428 */;
...
export default function BuyNitroPlanSelector(planSelection) {
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(7639).TableRadioGroup, obj2);
  }
  ...
  if (tmp8Result) {
    ...
    obj3[1] = tmp8(selection(12894), obj4);
    tmp8Result = tmp8(tmp7, obj3);
    const tmp9Result = selection(12894);
  }
