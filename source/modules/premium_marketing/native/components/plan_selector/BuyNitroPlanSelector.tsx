...
// Dependencies: [19, 17, 5798, 4285, 505, 21, 4302, 712, 5157, 589, 7588, 12608, 12609, 7682, 1236, 12610, 7925, 7924, 7351, 5795, 500, 2]
// Exports: default

// Module 12607 (BuyNitroPlanSelector)
...
export default function BuyNitroPlanSelector(planSelection) {
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(7925).TableRadioGroup, obj2);
  }
  ...
  if (tmp8Result) {
    ...
    obj3[1] = tmp8(selection(7351), obj4);
    tmp8Result = tmp8(tmp7, obj3);
    const tmp9Result = selection(7351);
  }
