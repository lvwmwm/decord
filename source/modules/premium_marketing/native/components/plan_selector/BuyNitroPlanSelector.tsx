...
// Dependencies: [19, 17, 5858, 4286, 505, 21, 4303, 712, 5158, 589, 7648, 12678, 12679, 7742, 1236, 12680, 7985, 7984, 7411, 5855, 500, 2]
// Exports: default

// Module 12677 (BuyNitroPlanSelector)
...
export default function BuyNitroPlanSelector(planSelection) {
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(7985).TableRadioGroup, obj2);
  }
  ...
  if (tmp8Result) {
    ...
    obj3[1] = tmp8(selection(7411), obj4);
    tmp8Result = tmp8(tmp7, obj3);
    const tmp9Result = selection(7411);
  }
