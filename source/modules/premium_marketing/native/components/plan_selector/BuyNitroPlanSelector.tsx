...
// Dependencies: [19, 17, 5779, 4268, 505, 21, 4285, 712, 5140, 589, 7569, 12593, 12594, 7663, 1236, 12595, 7908, 7907, 7332, 5776, 500, 2]
// Exports: default

// Module 12592 (BuyNitroPlanSelector)
...
export default function BuyNitroPlanSelector(planSelection) {
  ...
  let obj2 = planSelection(12593);
  updateProduct = obj2.useBuyNitroPlanLabelRenderer();
  let obj3 = planSelection(12594);
  ...
  items1[1] = callback(selection(12595), obj1);
  obj[1] = items1;
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(7908).TableRadioGroup, obj2);
  }
  ...
  if (tmp8Result) {
    ...
    obj3[1] = tmp8(selection(7332), obj4);
    tmp8Result = tmp8(tmp7, obj3);
    const tmp9Result = selection(7332);
  }
