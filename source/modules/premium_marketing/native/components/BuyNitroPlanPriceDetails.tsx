...
// Dependencies: [19, 17, 5798, 1905, 505, 21, 4302, 712, 589, 5795, 4298, 1236, 2]
// Exports: default

// Module 7676 (BuyNitroPlanPriceDetails)
import "noop";
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      if (null != value) {
        formatRateResult1 = tmp2(5795).formatRate(value, item.interval, num);
      ...
      const items2 = [callback(tmp2(4298).Text, obj5), ];
      ...
      if (tmp11Result) {
        ...
        tmp11Result = callback(tmp2(4298).Text, obj7);
      }
