...
// Dependencies: [19, 17, 5319, 1924, 505, 21, 4661, 712, 589, 5316, 4734, 1236, 2]
// Exports: default
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      tmp2Result = tmp2(5316);
      let formatRateResult1 = null;
      if (null != value) {
        formatRateResult1 = tmp2(5316).formatRate(value, item.interval, num);
      ...
      if (tmp11Result) {
        ...
        tmp11Result = callback(tmp2(4734).Text, obj7);
      }
