...
// Dependencies: [19, 17, 5738, 1876, 505, 21, 4255, 712, 589, 5735, 4251, 1236, 2]
// Exports: default

// Module 7645 (BuyNitroPlanPriceDetails)
import "noop";
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      tmp2Result = tmp2(5735);
      let formatRateResult1 = null;
      if (null != value) {
        formatRateResult1 = tmp2(5735).formatRate(value, item.interval, num);
      ...
      const items2 = [callback(tmp2(4251).Text, obj5), ];
      ...
      if (tmp11Result) {
        ...
        tmp11Result = callback(tmp2(4251).Text, obj7);
      }
