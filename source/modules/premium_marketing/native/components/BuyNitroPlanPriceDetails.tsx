...
// Dependencies: [19, 17, 5779, 1905, 505, 21, 4285, 712, 589, 5776, 4281, 1236, 2]
// Exports: default

// Module 7657 (BuyNitroPlanPriceDetails)
import "noop";
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      tmp2Result = tmp2(5776);
      let formatRateResult1 = null;
      if (null != value) {
        formatRateResult1 = tmp2(5776).formatRate(value, item.interval, num);
      ...
      const items2 = [callback(tmp2(4281).Text, obj5), ];
      ...
      if (tmp11Result) {
        ...
        tmp11Result = callback(tmp2(4281).Text, obj7);
      }
