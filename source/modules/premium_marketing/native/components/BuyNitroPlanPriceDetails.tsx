...
// Dependencies: [19, 17, 5752, 1876, 505, 21, 4255, 712, 589, 5749, 4251, 1236, 2]
// Exports: default

// Module 7629 (BuyNitroPlanPriceDetails)
import "noop";
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      if (null != value) {
        formatRateResult1 = tmp2(5749).formatRate(value, item.interval, num);
