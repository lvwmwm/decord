...
// Dependencies: [19, 17, 5676, 1876, 505, 21, 4193, 712, 589, 5673, 4189, 1236, 2]
// Exports: default
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      tmp2Result = tmp2(5673);
      let formatRateResult1 = null;
      if (null != value) {
        formatRateResult1 = tmp2(5673).formatRate(value, item.interval, num);
      ...
      const items2 = [callback(tmp2(4189).Text, obj5), ];
      ...
      if (tmp11Result) {
        ...
        tmp11Result = callback(tmp2(4189).Text, obj7);
      }
