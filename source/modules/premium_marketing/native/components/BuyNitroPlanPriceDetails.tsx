...
// Dependencies: [19, 17, 6084, 1924, 505, 21, 4478, 712, 589, 6081, 4474, 1236, 2]
// Exports: default

// Module 13047 (BuyNitroPlanPriceDetails)
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      tmp2Result = tmp2(6081);
      let formatRateResult1 = null;
      if (null != value) {
        formatRateResult1 = tmp2(6081).formatRate(value, item.interval, num);
