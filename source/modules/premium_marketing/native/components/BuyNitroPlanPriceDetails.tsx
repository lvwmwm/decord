...
// Dependencies: [19, 17, 6031, 1924, 505, 21, 4444, 712, 589, 6028, 4440, 1236, 2]
// Exports: default

// Module 7948 (BuyNitroPlanPriceDetails)
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      tmp2Result = tmp2(6028);
      let formatRateResult1 = null;
      if (null != value) {
        formatRateResult1 = tmp2(6028).formatRate(value, item.interval, num);
      ...
      const items2 = [callback(tmp2(4440).Text, obj5), ];
      ...
      if (tmp11Result) {
        ...
        tmp11Result = callback(tmp2(4440).Text, obj7);
      }
