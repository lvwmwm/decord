...
// Dependencies: [19, 17, 5858, 1905, 505, 21, 4303, 712, 589, 5855, 4299, 1236, 2]
// Exports: default

// Module 7736 (BuyNitroPlanPriceDetails)
import "noop";
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      tmp2Result = tmp2(5855);
      let formatRateResult1 = null;
      if (null != value) {
        formatRateResult1 = tmp2(5855).formatRate(value, item.interval, num);
      ...
      const items2 = [callback(tmp2(4299).Text, obj5), ];
      ...
      if (tmp11Result) {
        ...
        tmp11Result = callback(tmp2(4299).Text, obj7);
      }
