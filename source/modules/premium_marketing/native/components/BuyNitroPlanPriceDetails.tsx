...
// Dependencies: [19, 17, 6036, 1924, 505, 21, 4445, 712, 589, 6033, 4441, 1236, 2]
// Exports: default

// Module 12961 (BuyNitroPlanPriceDetails)
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      tmp2Result = tmp2(6033);
      let formatRateResult1 = null;
      if (null != value) {
        formatRateResult1 = tmp2(6033).formatRate(value, item.interval, num);
      ...
      const items2 = [callback(tmp2(4441).Text, obj5), ];
      ...
      if (tmp11Result) {
        ...
        tmp11Result = callback(tmp2(4441).Text, obj7);
      }
