...
// Dependencies: [19, 17, 6049, 1925, 505, 21, 4446, 712, 589, 6046, 4442, 1236, 2]
// Exports: default

// Module 12980 (BuyNitroPlanPriceDetails)
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      tmp2Result = tmp2(6046);
      let formatRateResult1 = null;
      if (null != value) {
        formatRateResult1 = tmp2(6046).formatRate(value, item.interval, num);
      ...
      const items2 = [callback(tmp2(4442).Text, obj5), ];
      ...
      if (tmp11Result) {
        ...
        tmp11Result = callback(tmp2(4442).Text, obj7);
      }
