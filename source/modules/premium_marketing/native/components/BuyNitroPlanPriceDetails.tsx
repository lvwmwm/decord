...
// Dependencies: [19, 17, 5965, 1924, 505, 21, 4380, 712, 589, 5962, 4376, 1236, 2]
// Exports: default

// Module 7881 (BuyNitroPlanPriceDetails)
...
export default function BuyNitroPlanPriceDetails(centered) {
  ...
  if (item.productId === discounted.id) {
    if (null != discounted.priceString) {
      ...
      if (null != value) {
        formatRateResult1 = tmp2(5962).formatRate(value, item.interval, num);
      ...
      const items2 = [callback(tmp2(4376).Text, obj5), ];
      ...
      if (tmp11Result) {
        ...
        tmp11Result = callback(tmp2(4376).Text, obj7);
      }
