...
// Dependencies: [19, 17, 676, 21, 4255, 712, 5587, 9917, 1416, 8387, 4251, 2]
// Exports: default

// Module 9926 (SocialLayerStorefrontGiftProductDetails)
...
export default function SocialLayerStorefrontGiftProductDetails(sku) {
  ...
  let obj = getOrFetchApplication(5587);
  getOrFetchApplication = obj.useGetOrFetchApplication(sku.applicationId);
  let obj1 = getOrFetchApplication(9917);
  ...
  const items1 = [callback(importDefault(8387), { sku, size: 55 }), , ];
