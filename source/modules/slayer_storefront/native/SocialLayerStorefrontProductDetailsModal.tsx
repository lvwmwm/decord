...
// Function ID: 9915
// Name: HeroMedia
// Dependencies: [32, 19, 17, 6785, 4300, 5730, 9915, 676, 21, 689, 712, 4255, 5206, 9916, 8477, 5207, 4251, 1236, 9917, 1297, 1856, 4493, 1581, 7560, 589, 5587, 5584, 5728, 5601, 5569, 514, 4682, 698, 9913, 7666, 500, 9918, 5732, 5216, 5241, 4677, 8387, 9920, 3193, 4666, 7660, 7981, 9923, 7321, 7322, 8950, 2]
// Exports: default

// Module 9914 (HeroMedia)
...
function HeroMedia(mediaItem) {
  ...
  if ("video" === mediaItem.type) {
    ...
    obj[4] = tmp.heroImage;
    obj[1] = callback(require(8477) /* VideoComponent */.VideoComponent, obj);
    ...
    obj[1] = callback(importDefault(5207), obj7);
...
function ProductPriceSection(sku) {
  const tmp = callback3();
  let obj = require(9917) /* useFormattedSKUPrice */;
...
function ItemDetailsSection(selectedItem) {
  ...
  if (!isNullOrEmptyResult1) {
    ...
    if (tmp18) {
      ...
      tmp18 = callback(importDefault(5207), obj2);
    }
    const items1 = [tmp18, ];
...
function SocialLayerStorefrontProductDetailsModal(skuId) {
  ...
  let obj = analyticsLocations(7560);
  ...
  const tmp17 = analyticsLocations(5569)(() => skuId(_undefined[30]).v4());
  ...
  if (null == stateFromStores) {
    ...
    let result = tmp4(5732).isSlayerSkuAvailableOnThisPlatform(stateFromStores);
    const intl4 = tmp4(1236).intl;
    const stringResult = intl4.string(tmp4(1236).t.boqtTA);
    const items12 = [tmp.container, ];
    const tmp4Result1 = tmp4(5732);
    let num3 = 0;
    ...
    obj3[0] = tmp4(9913).closeSocialLayerStorefrontProductDetailsModal;
    ...
    const items13 = [callback1(tmp4(5216).HeaderBackButton, obj3), ];
    ...
    if (exclusive) {
      ...
      obj6[1] = items15;
      exclusive = tmp42(tmp2(4677), obj6);
    }
    ...
    if (null != tmp29) {
      ...
      if (tmp42Result) {
        ...
        tmp42Result = tmp42(tmp2(8387), obj9);
      }
    }
    ...
    if (exclusive2) {
      ...
      obj10[1] = tmp42(tmp4(9920).ExclusiveBadge, {});
    ...
    obj22[4] = tmp59;
    obj22[5] = callback2;
    obj21[1] = callback1(tmp4(4666).Button, obj22);
    ...
    obj23[5] = tmp41;
    items21[1] = callback1(tmp4(7660).IconButton, obj23);
    obj20[1] = items21;
    ...
    if (result) {
      ...
      const mobileFinePrintMessageForApplication = tmp4(9923).getMobileFinePrintMessageForApplication(getOrFetchApplication, stringResult, obj25);
...
function SocialLayerStorefrontProductDetailsModalWithOrderCTX(skuId) {
  ...
  const OTPACOMOrderExperiment = tmp(7321).OTPACOMOrderExperiment;
  ...
  obj[2] = items;
  obj[5] = require(9913) /* SOCIAL_LAYER_STOREFRONT_PRODUCT_DETAILS_MODAL_KEY */.closeSocialLayerStorefrontProductDetailsModal;
  obj = {};
  const merged = Object.assign(skuId);
  obj[6] = closure_15(SocialLayerStorefrontProductDetailsModal, obj);
  return closure_15(importDefault(7322), obj, skuId.skuId);
}
