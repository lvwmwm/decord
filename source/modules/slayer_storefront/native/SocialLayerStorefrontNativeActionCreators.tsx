...
// Dependencies: [4530, 21, 4866, 1233, 3370, 10729, 4731, 10730, 2008, 4152, 10734, 10755, 10936, 2]
...
// Module 10728 (SOCIAL_LAYER_STOREFRONT_PRODUCT_DETAILS_MODAL_KEY)
...
export const openSocialLayerStorefrontProductDetailsModal = function openSocialLayerStorefrontProductDetailsModal(closure_0) {
  ...
  _modDef4731.pushLazy(asyncRequireImpl(10730, dependencyMap.paths), closure_0, c5, { presentation: "modal" });
};
...
export const openSocialLayerStorefrontGiftModal = function openSocialLayerStorefrontGiftModal(skuId) {
  ...
  if (obj.isSocialLayerStorefrontGiftingSupported()) {
    let tmp3Result = tmp3(4731);
    tmp3Result.pushLazy(asyncRequireImpl(10755, dependencyMap.paths), skuId, c6);
  } else {
    tmp3Result = tmp3(10734);
