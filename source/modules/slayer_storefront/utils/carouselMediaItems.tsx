      ...
      while (iter !== undefined) {
        ...
        if (null != tmp5) {
          ...
          if (mime_type.startsWith("video/")) {
            ...
            let obj6 = require(4427) /* _httpGetWithCountryCodeQuery */;
            let tmp28 = tmp5;
            let tmp29 = obj6;
            ...
            let obj7 = require(4427) /* _httpGetWithCountryCodeQuery */;
            let tmp33 = obj7;
            ...
            if (null != tmp4.backgroundAssetId) {
              tmp26Result = tmp26(4427);
              let tmp44 = nextResult;
              let tmp45 = tmp26Result;
              let tmp46 = applicationId;
              let tmp47 = heroWidth;
              assetURL1 = tmp26Result.getAssetURL(applicationId, tmp4.backgroundAssetId, heroWidth, tmp26(5662).LARGE_ASSET_FORMAT);
            }
            obj[4] = assetURL1;
            arr = push(obj);
          } else {
            ...
            let obj2 = require(4427) /* _httpGetWithCountryCodeQuery */;
            let tmp10 = tmp5;
            let tmp11 = obj2;
            ...
            let assetURL3;
            if (null != tmp4.backgroundAssetId) {
              tmp8Result = tmp8(4427);
              let tmp21 = nextResult;
              let tmp22 = tmp8Result;
              let tmp23 = applicationId;
              let tmp24 = heroWidth;
              assetURL3 = tmp8Result.getAssetURL(applicationId, tmp4.backgroundAssetId, heroWidth, tmp8(5662).LARGE_ASSET_FORMAT);
            }
            obj[3] = assetURL3;
            let arr1 = push(obj);
          }
