        ...
        if (null != tmp5) {
          ...
          if (mime_type.startsWith("video/")) {
            ...
            if (null != tmp4.backgroundAssetId) {
              tmp26Result = tmp26(4763);
              let tmp44 = nextResult;
              let tmp45 = tmp26Result;
              let tmp46 = applicationId;
              let tmp47 = heroWidth;
              assetURL1 = tmp26Result.getAssetURL(applicationId, tmp4.backgroundAssetId, heroWidth, tmp26(7166).LARGE_ASSET_FORMAT);
            }
            obj[4] = assetURL1;
            arr = push(obj);
          } else {
            ...
            if (null != tmp4.backgroundAssetId) {
              ...
              let tmp24 = heroWidth;
              assetURL3 = tmp8Result.getAssetURL(applicationId, tmp4.backgroundAssetId, heroWidth, tmp8(7166).LARGE_ASSET_FORMAT);
            }
            obj[3] = assetURL3;
            let arr1 = push(obj);
          }
