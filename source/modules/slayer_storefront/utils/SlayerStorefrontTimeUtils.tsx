...
// Dependencies: [32, 19, 3883, 687, 1236, 3222, 6849, 2]
// Exports: useTickingFormattedLimitedOfferTimeLeft

// Module 15918 (getLimitedOfferTimeLeft)
...
function getLimitedOfferTimeLeft(arg0) {
  if (null == arg0) {
    ...
    const diffResult = importDefault(3883)(arg0).diff(importDefault(3883)(), "seconds");
    let tmp4 = null;
    if (diffResult > 0) {
...
function formatLimitedOfferTimeLeft(arg0) {
  ...
  if (null == tmp) {
    ...
    if (days > 0) {
      ...
      obj = { hours: null };
      obj[0] = hours;
      formatToPlainStringResult = intl2.formatToPlainString(importDefault(3222).PPaJSw, obj);
    } else {
      const intl = require(1236) /* getSystemLocale */.intl;
      obj = { minutes: null };
      const _Math = Math;
      obj[0] = Math.max(tmp12, 1);
      formatToPlainStringResult = intl.formatToPlainString(importDefault(3222)["7Z+aIf"], obj);
    }
