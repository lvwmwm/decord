...
// Function ID: 5758
// Name: getPrice
// Dependencies: [4322, 5758, 4308, 1862, 5759, 5760, 676, 678, 505, 4522, 12, 5761, 1467, 5140, 589, 5616, 2]
...
export const getPrimaryCarouselItemInfo = function getPrimaryCarouselItemInfo(tenantMetadata) {
  ...
  return { primaryIconAsset: "body", primaryIconLabel: "useStateFromStores" };
};
