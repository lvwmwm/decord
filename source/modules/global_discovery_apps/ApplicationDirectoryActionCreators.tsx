...
// Dependencies: [5, 4130, 1922, 683, 5464, 11183, 11184, 11179, 11185, 11186, 653, 686, 561, 507, 11180, 477, 11187, 11188, 11189, 2]
...
// Module 11182 (_getEmbedApplication)
...
let c18 = 600000;
const map = new Map();
const result = require("_isNativeReflectConstruct").fileFinishedImporting("modules/global_discovery_apps/ApplicationDirectoryActionCreators.tsx");
