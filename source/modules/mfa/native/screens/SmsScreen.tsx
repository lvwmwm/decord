...
// Function ID: 14796
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 676, 21, 9202, 14788, 1236, 530, 14792, 14787, 6730, 4604, 14790, 2]
// Exports: default
...
export default function SmsScreen(mfaChallenge) {
  ...
  let obj = finish(14788);
  const screenStyles = obj.useScreenStyles(finish(9202)());
  const tmp4 = first(React.useState(null), 2);
  dependencyMap = tmp4[1];
  const tmp2 = finish(9202)();
  ...
  obj1[2] = mfaChallenge(14792).SMS_CODE_LENGTH;
  obj1[6] = handleChange;
  ...
  obj1[10] = tmp4[0];
  const items1 = [handleChange(mfaChallenge(6730).TextInput, obj1), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(14792).SMS_CODE_LENGTH;
  }
  obj3[4] = tmp6;
  obj[3] = handleChange(finish(14790), obj3);
