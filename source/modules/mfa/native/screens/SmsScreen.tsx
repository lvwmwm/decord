...
// Function ID: 14863
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 676, 21, 9375, 14855, 1236, 530, 14859, 14854, 7701, 4666, 14857, 2]
// Exports: default

// Module 14862 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  let obj = finish(14855);
  const screenStyles = obj.useScreenStyles(finish(9375)());
  const tmp4 = first(React.useState(null), 2);
  dependencyMap = tmp4[1];
  const tmp2 = finish(9375)();
  ...
  obj1[2] = mfaChallenge(14859).SMS_CODE_LENGTH;
  obj1[6] = handleChange;
  ...
  obj1[10] = tmp4[0];
  const items1 = [handleChange(mfaChallenge(7701).TextInput, obj1), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(14859).SMS_CODE_LENGTH;
  }
  obj3[4] = tmp6;
  obj[3] = handleChange(finish(14857), obj3);
