...
// Function ID: 15507
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 673, 21, 7726, 15499, 1233, 527, 15503, 15498, 7714, 4928, 15501, 2]
// Exports: default

// Module 15506 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  let obj = finish(15499);
  const screenStyles = obj.useScreenStyles(finish(7726)());
  const tmp4 = first(React.useState(null), 2);
  dependencyMap = tmp4[1];
  const tmp2 = finish(7726)();
  ...
  obj1 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15503).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, accessibilityLabel: null, placeholder: null, errorMessage: null };
  ...
  obj1[10] = tmp4[0];
  const items1 = [handleChange(mfaChallenge(7714).TextInput, obj1), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(15503).SMS_CODE_LENGTH;
  }
  obj3[4] = tmp6;
  obj[3] = handleChange(finish(15501), obj3);
