...
// Function ID: 14914
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 676, 21, 8395, 14906, 1236, 530, 14910, 14905, 7713, 4695, 14908, 2]
// Exports: default

// Module 14913 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  let obj = finish(14906);
  const screenStyles = obj.useScreenStyles(finish(8395)());
  const tmp4 = first(React.useState(null), 2);
  dependencyMap = tmp4[1];
  const tmp2 = finish(8395)();
  ...
  obj1[2] = mfaChallenge(14910).SMS_CODE_LENGTH;
  obj1[6] = handleChange;
  ...
  obj1[10] = tmp4[0];
  const items1 = [handleChange(mfaChallenge(7713).TextInput, obj1), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(14910).SMS_CODE_LENGTH;
  }
  obj3[4] = tmp6;
  obj[3] = handleChange(finish(14908), obj3);
