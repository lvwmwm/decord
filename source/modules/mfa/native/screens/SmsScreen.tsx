...
// Function ID: 14780
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 676, 21, 9193, 14772, 1236, 530, 14776, 14771, 6727, 4600, 14774, 2]
// Exports: default

// Module 14779 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  let obj = finish(14772);
  const screenStyles = obj.useScreenStyles(finish(9193)());
  const tmp4 = first(React.useState(null), 2);
  dependencyMap = tmp4[1];
  const tmp2 = finish(9193)();
  ...
  obj1[2] = mfaChallenge(14776).SMS_CODE_LENGTH;
  obj1[6] = handleChange;
  ...
  obj1[10] = tmp4[0];
  const items1 = [handleChange(mfaChallenge(6727).TextInput, obj1), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(14776).SMS_CODE_LENGTH;
  }
  obj3[4] = tmp6;
  obj[3] = handleChange(finish(14774), obj3);
