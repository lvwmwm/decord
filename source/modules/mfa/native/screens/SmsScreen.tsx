...
export default function SmsScreen(mfaChallenge) {
  ...
  const obj1 = { placeholder: "<string:2326528002>", description: "<string:3661758465>", required: "<string:754975232>", label: "<string:16777643>", maxLength: arg1(closure_2[10]).SMS_CODE_LENGTH, placeholder: "<string:21737984>", onChange: handleChange };
  ...
  const obj2 = { numberOfLines: 44, expandable: null, seeMoreLabel: true };
