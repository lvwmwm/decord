...
// Function ID: 14773
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 676, 21, 9189, 14765, 1236, 530, 14769, 14764, 6724, 4600, 14767, 2]
// Exports: default

// Module 14772 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  let obj = finish(14765);
  const screenStyles = obj.useScreenStyles(finish(9189)());
  const tmp4 = first(React.useState(null), 2);
  dependencyMap = tmp4[1];
  const tmp2 = finish(9189)();
  ...
  obj1[2] = mfaChallenge(14769).SMS_CODE_LENGTH;
  obj1[6] = handleChange;
  ...
  obj1[10] = tmp4[0];
  const items1 = [handleChange(mfaChallenge(6724).TextInput, obj1), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(14769).SMS_CODE_LENGTH;
  }
  obj3[4] = tmp6;
  obj[3] = handleChange(finish(14767), obj3);
