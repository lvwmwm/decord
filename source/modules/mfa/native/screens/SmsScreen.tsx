...
// Function ID: 15070
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 676, 21, 8517, 15062, 1236, 530, 15066, 15061, 7831, 4754, 15064, 2]
// Exports: default
...
export default function SmsScreen(mfaChallenge) {
  ...
  const screenStyles = obj.useScreenStyles(finish(8517)());
  const tmp4 = first(React.useState(null), 2);
  dependencyMap = tmp4[1];
  const tmp2 = finish(8517)();
  ...
  obj1[10] = tmp4[0];
  const items1 = [handleChange(mfaChallenge(7831).TextInput, obj1), ];
  ...
  items1[1] = handleChange(mfaChallenge(4754).Button, obj2);
  obj[1] = items1;
