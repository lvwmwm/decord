...
// Function ID: 15079
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 676, 21, 8521, 15071, 1236, 530, 15075, 15070, 7835, 4755, 15073, 2]
// Exports: default

// Module 15078 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  let obj = finish(15071);
  const screenStyles = obj.useScreenStyles(finish(8521)());
  const tmp4 = first(React.useState(null), 2);
  dependencyMap = tmp4[1];
  const tmp2 = finish(8521)();
  ...
  obj1[2] = mfaChallenge(15075).SMS_CODE_LENGTH;
  obj1[6] = handleChange;
  ...
  obj1[10] = tmp4[0];
  const items1 = [handleChange(mfaChallenge(7835).TextInput, obj1), ];
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(15075).SMS_CODE_LENGTH;
  }
  obj3[4] = tmp6;
  obj[3] = handleChange(finish(15073), obj3);
