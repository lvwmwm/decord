...
// Function ID: 15070
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 676, 21, 8521, 15062, 1236, 530, 15066, 15061, 7835, 4755, 15064, 2]
// Exports: default

// Module 15069 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  obj1[2] = mfaChallenge(15066).SMS_CODE_LENGTH;
  obj1[6] = handleChange;
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(15066).SMS_CODE_LENGTH;
  }
  obj3[4] = tmp6;
  obj[3] = handleChange(finish(15064), obj3);
