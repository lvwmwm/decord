...
// Dependencies: [5, 32, 19, 21, 15080, 4338, 1236, 8543, 15075, 15081, 15078, 2]
// Exports: default

// Module 15082 (isValidClipboardCode)
...
function isValidClipboardCode(arg0) {
  let tmp3 = arg0.length >= require(15080) /* finishMFACheck */.BACKUP_CODE_MIN_LENGTH;
  if (tmp3) {
    tmp3 = arg0.length <= require(15080) /* finishMFACheck */.BACKUP_CODE_MAX_LENGTH;
  }
  return tmp3;
}
