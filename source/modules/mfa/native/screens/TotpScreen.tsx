...
// Dependencies: [5, 32, 19, 21, 14776, 14771, 1236, 14777, 14774, 2]
// Exports: default

// Module 14775 (isValidClipboardCode)
...
function isValidClipboardCode(arg0) {
  let isMatch = arg0.length === require(14776) /* finishMFACheck */.TOTP_CODE_LENGTH;
  if (isMatch) {
    isMatch = /^\d+$/.test(arg0);
    const obj = /^\d+$/;
  }
