...
// Dependencies: [5, 32, 19, 21, 14769, 14764, 1236, 14770, 14767, 2]
// Exports: default

// Module 14768 (isValidClipboardCode)
...
function isValidClipboardCode(arg0) {
  let isMatch = arg0.length === require(14769) /* finishMFACheck */.TOTP_CODE_LENGTH;
  if (isMatch) {
    isMatch = /^\d+$/.test(arg0);
    const obj = /^\d+$/;
  }
