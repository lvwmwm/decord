...
// Dependencies: [5, 32, 19, 21, 14996, 14991, 1236, 14997, 14994, 2]
// Exports: default

// Module 14995 (isValidClipboardCode)
...
function isValidClipboardCode(arg0) {
  let isMatch = arg0.length === require(14996) /* finishMFACheck */.TOTP_CODE_LENGTH;
  if (isMatch) {
    isMatch = /^\d+$/.test(arg0);
    const obj = /^\d+$/;
  }
