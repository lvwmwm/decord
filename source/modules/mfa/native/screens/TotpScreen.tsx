...
// Dependencies: [5, 32, 19, 21, 15066, 15061, 1236, 15067, 15064, 2]
// Exports: default

// Module 15065 (isValidClipboardCode)
...
function isValidClipboardCode(arg0) {
  let isMatch = arg0.length === require(15066) /* finishMFACheck */.TOTP_CODE_LENGTH;
  if (isMatch) {
    isMatch = /^\d+$/.test(arg0);
    const obj = /^\d+$/;
  }
