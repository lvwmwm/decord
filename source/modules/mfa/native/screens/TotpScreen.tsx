...
// Dependencies: [5, 57, 31, 33, 14705, 14700, 1212, 14706, 14703, 2]
// Exports: default

// Module 14704 (isValidClipboardCode)
...
function isValidClipboardCode(arg0) {
  let isMatch = arg0.length === require(14705) /* finishMFACheck */.TOTP_CODE_LENGTH;
  if (isMatch) {
    isMatch = /^\d+$/.test(arg0);
    const obj = /^\d+$/;
  }
