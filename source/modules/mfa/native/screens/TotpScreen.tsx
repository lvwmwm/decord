...
// Dependencies: [5, 32, 19, 21, 14926, 14921, 1236, 14927, 14924, 2]
// Exports: default

// Module 14925 (isValidClipboardCode)
...
function isValidClipboardCode(arg0) {
  let isMatch = arg0.length === require(14926) /* finishMFACheck */.TOTP_CODE_LENGTH;
  if (isMatch) {
    isMatch = /^\d+$/.test(arg0);
    const obj = /^\d+$/;
  }
