...
// Dependencies: [5, 32, 19, 21, 15080, 15075, 1236, 15081, 15078, 2]
// Exports: default

// Module 15079 (isValidClipboardCode)
...
function isValidClipboardCode(arg0) {
  let isMatch = arg0.length === require(15080) /* finishMFACheck */.TOTP_CODE_LENGTH;
  if (isMatch) {
    isMatch = /^\d+$/.test(arg0);
    const obj = /^\d+$/;
  }
