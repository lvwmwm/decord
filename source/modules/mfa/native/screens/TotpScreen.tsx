...
// Dependencies: [5, 32, 19, 21, 14910, 14905, 1236, 14911, 14908, 2]
// Exports: default

// Module 14909 (isValidClipboardCode)
...
function isValidClipboardCode(arg0) {
  let isMatch = arg0.length === require(14910) /* finishMFACheck */.TOTP_CODE_LENGTH;
  if (isMatch) {
    isMatch = /^\d+$/.test(arg0);
    const obj = /^\d+$/;
  }
