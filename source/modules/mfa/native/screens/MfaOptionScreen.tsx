...
// Dependencies: [17, 21, 8255, 14868, 5257, 4663, 4251, 14869, 8285, 2]
// Exports: default

// Module 14867 (MFAOptionScreen)
...
export default function MFAOptionScreen(arg0) {
  ...
  items[3] = tmp10Result;
  obj[2] = items;
  const items1 = [closure_5(require(4663) /* Stack */.Stack, obj), input];
  obj4[0] = items1;
  const items2 = [closure_5(require(4663) /* Stack */.Stack, obj4), content, ];
  ...
  obj5[1] = items3;
  items2[2] = closure_5(require(4663) /* Stack */.Stack, obj5);
  obj[3] = items2;
  const tmp7Result = closure_5(require(5257) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
  const children = [callback(importDefault(8285), { backgroundImageCover: false }), ];
