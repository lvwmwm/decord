...
// Dependencies: [17, 21, 8395, 14906, 5311, 4693, 4281, 14907, 8425, 2]
// Exports: default

// Module 14905 (MFAOptionScreen)
...
export default function MFAOptionScreen(arg0) {
  ...
  obj[3] = items2;
  const tmp7Result = closure_5(require(5311) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
  const children = [callback(importDefault(8425), { backgroundImageCover: false }), ];
