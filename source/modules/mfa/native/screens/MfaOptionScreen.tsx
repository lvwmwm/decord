...
// Dependencies: [17, 21, 8412, 14922, 5327, 4710, 4298, 14923, 8442, 2]
// Exports: default

// Module 14921 (MFAOptionScreen)
...
export default function MFAOptionScreen(arg0) {
  ...
  const items = [tmp9, callback(require(4298) /* Text */.Text, { variant: "heading-xl/extrabold", style: screenStyles.mfaContainerHeaderText, children: headerText }), , ];
  ...
  items[3] = tmp10Result;
  obj[2] = items;
  const items1 = [closure_5(require(4710) /* Stack */.Stack, obj), input];
  obj4[0] = items1;
  const items2 = [closure_5(require(4710) /* Stack */.Stack, obj4), content, ];
  ...
  obj5[1] = items3;
  items2[2] = closure_5(require(4710) /* Stack */.Stack, obj5);
  obj[3] = items2;
  const tmp7Result = closure_5(require(5327) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
  const children = [callback(importDefault(8442), { backgroundImageCover: false }), ];
