...
// Function ID: 14904
// Name: SelectScreen
// Dependencies: [19, 17, 14900, 21, 4285, 5250, 7893, 8395, 1480, 5311, 4281, 1236, 2]
// Exports: default

// Module 14903 (SelectScreen)
import "noop";
...
let closure_7 = createCacheKey.createStyles((arg0) => {
  ...
  const NAV_BAR_HEIGHT = require(5250) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT;
  if (arg0) {
    let diff = NAV_BAR_HEIGHT;
  } else {
    diff = NAV_BAR_HEIGHT - require(5250) /* NAV_BAR_HEIGHT */.STATUS_BAR_HEIGHT;
  }
...
export default function SelectScreen(mfaChallenge) {
  ...
  obj[2] = items1;
  return callback2(_require(5311).SafeAreaPaddingView, obj);
};
