...
// Function ID: 14920
// Name: SelectScreen
// Dependencies: [19, 17, 14916, 21, 4302, 5266, 7910, 8412, 1480, 5327, 4298, 1236, 2]
// Exports: default

// Module 14919 (SelectScreen)
import "noop";
...
let closure_7 = createCacheKey.createStyles((arg0) => {
  ...
  if (arg0) {
    ...
    diff = NAV_BAR_HEIGHT - require(5266) /* NAV_BAR_HEIGHT */.STATUS_BAR_HEIGHT;
  }
...
export default function SelectScreen(mfaChallenge) {
  ...
  obj[2] = items1;
  return callback2(_require(5327).SafeAreaPaddingView, obj);
};
