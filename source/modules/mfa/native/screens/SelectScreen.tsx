...
// Function ID: 14866
// Name: SelectScreen
// Dependencies: [19, 17, 14862, 21, 4255, 5220, 7752, 8255, 1480, 5257, 4251, 1236, 2]
// Exports: default

// Module 14865 (SelectScreen)
import "noop";
...
let closure_7 = createCacheKey.createStyles((arg0) => {
  ...
  const NAV_BAR_HEIGHT = require(5220) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT;
  if (arg0) {
    let diff = NAV_BAR_HEIGHT;
  } else {
    diff = NAV_BAR_HEIGHT - require(5220) /* NAV_BAR_HEIGHT */.STATUS_BAR_HEIGHT;
  }
...
export default function SelectScreen(mfaChallenge) {
  ...
  obj[2] = items1;
  return callback2(_require(5257).SafeAreaPaddingView, obj);
};
