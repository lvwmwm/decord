...
// Dependencies: [32, 19, 17, 21, 4189, 712, 1236, 1297, 500, 530, 9199, 14771, 13770, 9197, 14774, 2]
// Exports: default

// Module 14770 (AndroidAuthRadioGroup)
...
export default function WebAuthnScreen(arg0) {
  ...
  obj[2] = challenge(finish(13770).KeyImage, {});
  ...
  const tmp16 = importDefault(14771);
  ...
  obj1[3] = tmp3;
  obj1[4] = callback;
  obj[4] = challenge(tmp15(14774), obj1);
