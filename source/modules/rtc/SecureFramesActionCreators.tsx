...
// Dependencies: [5, 1218, 1372, 4318, 9151, 676, 709, 9149, 4201, 4640, 1236, 9153, 5128, 2]

// Module 9152 (savePersistentCodesEnabled)
import ME from "ME";
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (1 === tmp8) {
              ...
              aPIError = new callback(4201).APIError(dependencyMap);
              obj1 = aPIError(709);
