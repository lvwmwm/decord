...
// Dependencies: [5, 1218, 1391, 4360, 9257, 676, 709, 9255, 4243, 4682, 1236, 9259, 5169, 2]

// Module 9258 (savePersistentCodesEnabled)
import ME from "ME";
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (1 === tmp8) {
              ...
              aPIError = new callback(4243).APIError(dependencyMap);
              obj1 = aPIError(709);
