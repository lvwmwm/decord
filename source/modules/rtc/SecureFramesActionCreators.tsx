...
// Dependencies: [5, 1218, 1391, 4319, 9217, 676, 709, 9215, 4202, 4642, 1236, 9219, 5129, 2]

// Module 9218 (savePersistentCodesEnabled)
import ME from "ME";
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (1 === tmp8) {
              ...
              aPIError = new callback(4202).APIError(dependencyMap);
              obj1 = aPIError(709);
