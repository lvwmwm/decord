...
// Dependencies: [5, 1218, 1391, 4465, 9780, 676, 709, 9778, 4344, 4822, 1236, 9782, 5320, 2]

// Module 9781 (savePersistentCodesEnabled)
import dispatcherDefault from "dispatcher" /* 709 */;
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "fetchFingerprint" /* 1218 */;
import closure_5 from "ensureGuildLoaded" /* 1391 */;
import closure_6 from "updateVoiceState" /* 4465 */;
import { SECURE_FRAMES_PUBLIC_KEY_VERSION as closure_7 } from "SECURE_FRAMES_LINKING_BOTTOM_SHEET_KEY" /* 9780 */;
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (1 === tmp8) {
              ...
              aPIError = new callback(4344).APIError(dependencyMap);
              obj1 = aPIError(709);
