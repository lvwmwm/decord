...
// Dependencies: [32, 5, 1218, 4302, 4326, 4340, 1874, 9104, 9105, 676, 1945, 9106, 9113, 9088, 9107, 1236, 4094, 3837, 687, 38, 206, 530, 1208, 4593, 4444, 2]
...
// Module 9103 (getCurrentUserSigningKey)
...
export const addVerification = function addVerification(userId, userKey, isOtherUserKeyPersistent, channelId, DEEP_LINK) {
  ...
  const result = require(9113) /* trackRTCPanelViewed */.trackE2EEUserVerified(obj);
};
export const deleteVerification = function deleteVerification(userId, arg1, isOtherUserKeyPersistent) {
  if (isOtherUserKeyPersistent) {
    ...
    const obj2 = require(9088) /* set */;
    const serializeKeyResult = require(9088) /* set */.serializeKey(uint8Array);
    const result = importDefault(9106).deleteSecureFramesVerifiedKey(userId, serializeKeyResult);
    const obj3 = importDefault(9106);
  } else {
    const result1 = importDefault(9106).deleteSecureFramesTransientKey(userId);
    const obj = importDefault(9106);
  }
};
...
export const deleteUserPersistentVerifications = function deleteUserPersistentVerifications(userId) {
  ...
  let result = importDefault(9107).openSecureFramesUpdateConfirmation(obj);
};
...
export const showSecureFramesKeyInconsistentAlert = function showSecureFramesKeyInconsistentAlert(arg0) {
  ...
  let obj = require(9113) /* trackRTCPanelViewed */;
...
export const validateSecureFramesKeyConsistent = function validateSecureFramesKeyConsistent(guildId) {
  ...
  if (getIsSecureFramesKeyInconsistent(userId, items)) {
    ...
    let obj1 = require(9113) /* trackRTCPanelViewed */;
