...
// Dependencies: [32, 5, 1218, 4332, 4356, 4370, 1903, 9133, 9134, 676, 1974, 9135, 9142, 9117, 9136, 1236, 4123, 3866, 687, 38, 206, 530, 1208, 4623, 4474, 2]
...
// Module 9132 (getCurrentUserSigningKey)
...
export const addVerification = function addVerification(userId, userKey, isOtherUserKeyPersistent, channelId, DEEP_LINK) {
  ...
  const result = require(9142) /* trackRTCPanelViewed */.trackE2EEUserVerified(obj);
};
export const deleteVerification = function deleteVerification(userId, arg1, isOtherUserKeyPersistent) {
  if (isOtherUserKeyPersistent) {
    ...
    const obj2 = require(9117) /* set */;
    const serializeKeyResult = require(9117) /* set */.serializeKey(uint8Array);
    const result = importDefault(9135).deleteSecureFramesVerifiedKey(userId, serializeKeyResult);
    const obj3 = importDefault(9135);
  } else {
    const result1 = importDefault(9135).deleteSecureFramesTransientKey(userId);
    const obj = importDefault(9135);
  }
};
...
export const deleteUserPersistentVerifications = function deleteUserPersistentVerifications(userId) {
  ...
  let result = importDefault(9136).openSecureFramesUpdateConfirmation(obj);
};
export const getSecureFramesUserVerifiedTimestamp = function getSecureFramesUserVerifiedTimestamp(timestamp) {
  ...
  const diffResult = obj.diff(importDefault(3866)(timestamp), "s");
  ...
  const tmp3 = importDefault(3866)(timestamp);
};
...
export const showSecureFramesKeyInconsistentAlert = function showSecureFramesKeyInconsistentAlert(arg0) {
  ...
  let obj = require(9142) /* trackRTCPanelViewed */;
...
export const validateSecureFramesKeyConsistent = function validateSecureFramesKeyConsistent(guildId) {
  ...
  if (getIsSecureFramesKeyInconsistent(userId, items)) {
    ...
    let obj1 = require(9142) /* trackRTCPanelViewed */;
