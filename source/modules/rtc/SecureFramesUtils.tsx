...
// Dependencies: [32, 5, 1215, 4532, 4557, 4571, 1921, 9080, 9081, 673, 1994, 9082, 9090, 9064, 9083, 1233, 4325, 4074, 684, 38, 206, 527, 1205, 4865, 4680, 2]
...
// Module 9079 (getCurrentUserSigningKey)
...
import closure_8 from "initialize" /* 4571 */;
import closure_9 from "mergeGuildAvatar" /* 1921 */;
import closure_10 from "items" /* 9080 */;
...
export const deleteUserPersistentVerifications = function deleteUserPersistentVerifications(userId) {
  ...
  let result = _modDef9083.openSecureFramesUpdateConfirmation(obj);
};
