...
// Dependencies: [1372, 676, 4496, 8729, 698, 2]
...
// Module 9159 (trackRTCPanelViewed)
...
export const trackE2EEUserVerificationViewed = function trackE2EEUserVerificationViewed(userId) {
  ...
  obj[1] = guild_id;
  const merged = Object.assign(require(8729) /* getProfileProperties */.getTrackUserRelationshipProperties({ userId: userId.userId }));
...
export const trackE2EEUserVerified = function trackE2EEUserVerified(channelId) {
  ...
  const merged = Object.assign(require(8729) /* getProfileProperties */.getTrackUserRelationshipProperties({ userId }));
