...
// Dependencies: [1391, 676, 5042, 8935, 698, 2]
...
// Module 9717 (trackRTCPanelViewed)
...
export const trackE2EEUserVerificationViewed = function trackE2EEUserVerificationViewed(userId) {
  ...
  obj[1] = guild_id;
  const merged = Object.assign(require(8935) /* getProfileProperties */.getTrackUserRelationshipProperties({ userId: userId.userId }));
...
export const trackE2EEUserVerified = function trackE2EEUserVerified(channelId) {
  ...
  const merged = Object.assign(require(8935) /* getProfileProperties */.getTrackUserRelationshipProperties({ userId }));
