...
// Function ID: 70140
// Name: getGuildId
// Dependencies: [1348, 653, 4359, 8084, 675, 2]
...
export const trackE2EEUserVerificationViewed = function trackE2EEUserVerificationViewed(userId) {
  ...
  const merged = Object.assign(require(8084) /* getProfileProperties */.getTrackUserRelationshipProperties({ userId: userId.userId }));
...
export const trackE2EEUserVerified = function trackE2EEUserVerified(channelId) {
  ...
  const merged = Object.assign(require(8084) /* getProfileProperties */.getTrackUserRelationshipProperties({ userId }));
