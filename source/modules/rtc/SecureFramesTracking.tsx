...
// Function ID: 69988
// Name: getGuildId
// Dependencies: [1348, 653, 4325, 8046, 675, 2]
...
export const trackE2EEUserVerificationViewed = function trackE2EEUserVerificationViewed(userId) {
  ...
  const merged = Object.assign(require(8046) /* getProfileProperties */.getTrackUserRelationshipProperties({ userId: userId.userId }));
...
export const trackE2EEUserVerified = function trackE2EEUserVerified(channelId) {
  ...
  const merged = Object.assign(require(8046) /* getProfileProperties */.getTrackUserRelationshipProperties({ userId }));
