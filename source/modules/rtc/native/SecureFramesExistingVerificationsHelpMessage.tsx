...
// Dependencies: [17, 21, 4342, 9272, 1297, 1236, 2]
// Exports: default

// Module 9271 (SecureFramesExistingVerificationsHelpMessage)
...
export default function SecureFramesExistingVerificationsHelpMessage(arg0) {
  ...
  let obj = require(9272) /* useSecureFramesUserVerifiedKeysCount */;
