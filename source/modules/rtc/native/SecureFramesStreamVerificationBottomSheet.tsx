...
// Dependencies: [19, 4571, 673, 21, 586, 9090, 8291, 9096, 1233, 9079, 2]
// Exports: default

// Module 9095 (SecureFramesStreamVerificationBottomSheet)
...
export default function SecureFramesStreamVerificationBottomSheet(channelId) {
  ...
  const tmp3 = streamKey(9096);
  obj[0] = channelId(9079).getSecureFramesHelpdeskArticle();
