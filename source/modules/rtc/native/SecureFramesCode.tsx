...
// Dependencies: [19, 17, 505, 21, 4342, 712, 4338, 2]
// Exports: default

// Module 9273 (SecureFramesCodeGrid)
...
export default function SecureFramesCode(chunks) {
  ...
  const items = [callback(require(4338) /* Text */.Text, { color: "mobile-text-heading-primary", variant: "heading-md/semibold", children: title }), trailing];
  obj[1] = items;
