...
// Dependencies: [1905, 3, 13328, 8373, 8699, 13329, 1921, 13330, 1919, 2]
// Exports: canUserUse

// Module 13327 (ProductCatalogFeature)
...
export const canUserUse = function canUserUse(COLLECTIBLES, isPremiumWithFractionalPremiumOnly) {
  ...
  if (null != value) {
    ...
    if (null != perks) {
      const config = importDefault(13330).getConfig({ location: "product_catalog_can_user_use" });
