...
// Dependencies: [8712, 1874, 9496, 12750, 589, 4101, 1358, 2]
...
// Module 12749 (getGiftingBadgeProgressPercent)
...
export const useIsGiftingBadgesDesktopEnabled = function useIsGiftingBadgesDesktopEnabled(location) {
  ...
  const GiftingBadgeDesktopExperiment = require(12750) /* apexExperiment */.GiftingBadgeDesktopExperiment;
  let str = "-DISABLED";
  if (enabled) {
    str = "";
  }
