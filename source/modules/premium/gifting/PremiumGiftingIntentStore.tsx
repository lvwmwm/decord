...
// Function ID: 8220
// Name: getCurrentTime
// Dependencies: [4258, 1212, 7160, 1340, 5868, 3998, 676, 8220, 4034, 8221, 12, 589, 709, 2]

// Module 8219 (getCurrentTime)
...
function categorizeTopAffinityFriendAnniversaries() {
  ...
  let flag;
  flag = false;
  const result = require(8220) /* FRIEND_ANNIVERSARY_ELIGIBILITY_WINDOW_DAYS */.categorizeFriendAnniversariesByAffinity(closure_11, (userId) => {
    ...
    if (hasConsented.hasConsented(Consents.PERSONALIZATION)) {
      ...
      if (EnableFriendAnniversaryNotifications.getSetting()) {
            ...
            if (null != userAffinity) {
              ...
              if (userAffinity.dmProbability > 0) {
                ...
                if (null != since) {
                  ...
                  let tmp29 = date;
                  let tmp30 = date;
                  let obj = require(8220) /* FRIEND_ANNIVERSARY_ELIGIBILITY_WINDOW_DAYS */;
        ...
        if (0 !== arr.length) {
          ...
          obj4 = require(8221) /* getFriendAnniversaryGateConfig */;
        }
        obj3 = arr;
      }
    }
...
prototype["initialize"] = function initialize(friendsTabBadgeLastDismissedTime) {
  ...
  closure_10.messageGiftIntentLastShownMap = require(8220) /* FRIEND_ANNIVERSARY_ELIGIBILITY_WINDOW_DAYS */.pruneTimestampMap(closure_10.messageGiftIntentLastShownMap, timestamp, 1209600000);
};
...
prototype["getFriendAnniversaryYears"] = function getFriendAnniversaryYears(arg0) {
  let num = 0;
  if (null != table[arg0]) {
    num = require(8220) /* FRIEND_ANNIVERSARY_ELIGIBILITY_WINDOW_DAYS */.yearsSince(tmp.friendsSince);
    const obj = require(8220) /* FRIEND_ANNIVERSARY_ELIGIBILITY_WINDOW_DAYS */;
  }
  return num;
};
...
const premiumGiftingIntentStore = new PremiumGiftingIntentStore(require("dispatcher"), {
  ...
  GIFT_INTENT_DISMISSALS_FETCH_SUCCESS: function handleGiftIntentDismissalsFetchSuccess(settingsTimestampMs) {
    ...
    closure_10.messageGiftIntentLastShownMap = require(8220) /* FRIEND_ANNIVERSARY_ELIGIBILITY_WINDOW_DAYS */.pruneTimestampMap(obj, getCurrentTime(), 1296000000);
