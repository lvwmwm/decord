...
// Module 9804 (GiftingBadgeProgressBar)
import "result";
...
export default function GiftingBadgeProgress(title) {
  ...
  if (tmp8) {
    ...
    tmp8 = callback2(importDefault(9684), obj);
  }
  const items = [tmp8, , ];
  ...
  if (tmp14) {
    ...
    tmp14 = callback2(require(4161) /* Text */.Text, obj1);
  }
  const items1 = [tmp14, , ];
  ...
  if (tmp20) {
    ...
    tmp20 = callback2(require(4161) /* Text */.Text, obj4);
  }
  obj3.children = tmp20;
  ...
  if (tmp26) {
    ...
    tmp26 = callback2(importDefault(9684), obj6);
  }
  items[2] = tmp26;
  obj.children = items;
