...
// Module 10094 (GiftingBadgeProgressBar)
import "noop";
...
export default function GiftingBadgeProgress(title) {
  ...
  if (tmp8) {
    ...
    obj[1] = iconSize;
    tmp8 = callback2(importDefault(9974), obj);
  }
  const items = [tmp8, , ];
  ...
  if (tmp12) {
    ...
    obj1[1] = title;
    tmp12 = callback2(require(4298) /* Text */.Text, obj1);
  }
  ...
  if (tmp16Result) {
    ...
    tmp16Result = tmp16(require(4298) /* Text */.Text, obj3);
  }
  obj2[1] = tmp16Result;
  ...
  if (tmp16Result) {
    ...
    obj5[1] = iconSize;
    tmp16Result = tmp16(importDefault(9974), obj5);
  }
  items[2] = tmp16Result;
  obj[1] = items;
