...
// Module 10160 (GiftingBadgeProgressBar)
import "noop";
...
export default function GiftingBadgeProgress(title) {
  ...
  if (tmp8) {
    ...
    obj[1] = iconSize;
    tmp8 = callback2(importDefault(10040), obj);
  }
  const items = [tmp8, , ];
  ...
  if (tmp12) {
    ...
    obj1[1] = title;
    tmp12 = callback2(require(4299) /* Text */.Text, obj1);
  }
  ...
  if (tmp16Result) {
    ...
    obj5[1] = iconSize;
    tmp16Result = tmp16(importDefault(10040), obj5);
  }
  items[2] = tmp16Result;
  obj[1] = items;
