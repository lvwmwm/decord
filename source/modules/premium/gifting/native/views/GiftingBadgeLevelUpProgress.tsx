...
// Dependencies: [19, 17, 8835, 21, 4344, 712, 10087, 4340, 1236, 2399, 2]
// Exports: default
...
export default function GiftingBadgeLevelUpProgress(style) {
  ...
  if (tmp7) {
    ...
    tmp7 = callback2(importDefault(10087), obj);
  }
  const items1 = [tmp7, , ];
  ...
  if (tmp11Result) {
    ...
    tmp11Result = tmp11(importDefault(10087), obj4);
  }
  ...
  obj6[2] = intl.format(importDefault(2399).iIpfQe, { count: progress, threshold: tmp2 });
  obj5[1] = callback2(require(4340) /* Text */.Text, obj6);
