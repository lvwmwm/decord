...
// Dependencies: [19, 17, 21, 4344, 712, 5767, 9395, 503, 10087, 4340, 1236, 2399, 2]
// Exports: default

// Module 10094 (GiftingBadgeProgressBanner)
import "noop";
...
export default function GiftingBadgeProgressBanner(arg0) {
  ...
  importDefault(9395)(obj, { trackOnInitialLoad: true });
  ...
  items2[1] = closure_4(require(4340) /* Text */.Text, obj2);
  obj[1] = items2;
