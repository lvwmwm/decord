...
// Dependencies: [19, 17, 21, 4255, 712, 5581, 8741, 503, 9865, 4251, 1236, 2351, 2]
// Exports: default

// Module 9872 (GiftingBadgeProgressBanner)
import "noop";
...
export default function GiftingBadgeProgressBanner(arg0) {
  ...
  importDefault(8741)(obj, { trackOnInitialLoad: true });
  ...
  if (tmp10Result) {
    ...
    obj1[0] = nextTierIcon;
    tmp10Result = tmp10(tmp2(9865), obj1);
  }
  obj[1] = tmp10Result;
  const items2 = [closure_4(View, obj), ];
  const obj2 = { variant: "text-md/semibold", children: null };
  const intl = tmp6(1236).intl;
  obj2[1] = intl.formatToPlainString(importDefault(2351)["0+xfd9"], { giftsRemaining: giftsToNextTier, nextTier: nextTierName });
  items2[1] = closure_4(require(4251) /* Text */.Text, obj2);
  obj[1] = items2;
