...
// Dependencies: [19, 17, 8713, 1369, 21, 4285, 712, 4253, 4136, 5377, 9958, 4281, 1236, 2380, 4695, 9951, 5669, 15904, 9493, 589, 8709, 2]
// Exports: default

// Module 15903 (HasBadgeCoachmark)
...
function HasBadgeCoachmark(markAsDismissed) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(importDefault(9958), obj1);
  }
  obj[1] = tmp4Result;
  ...
  obj3[3] = intl.format(importDefault(2380)["a+jfuy"], { tierName: str });
  ...
  obj4[3] = intl2.formatToPlainString(importDefault(2380).QxRA6w, { giftCount });
...
function NewBadgeCoachmark(markAsDismissed) {
  ...
  obj4[3] = intl.string(importDefault(2380).Q2RQka);
  ...
  obj5[3] = intl2.string(importDefault(2380)["3EQnkg"]);
  ...
  obj7[1] = intl3.string(importDefault(2380).DZnomS);
