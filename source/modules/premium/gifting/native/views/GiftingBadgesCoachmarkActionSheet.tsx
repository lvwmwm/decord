...
// Dependencies: [19, 17, 8730, 1369, 21, 4302, 712, 4270, 4153, 5396, 9974, 4298, 1236, 2380, 4712, 9967, 5688, 15929, 9510, 589, 8726, 2]
// Exports: default

// Module 15928 (HasBadgeCoachmark)
...
function HasBadgeCoachmark(markAsDismissed) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(importDefault(9974), obj1);
  }
  obj[1] = tmp4Result;
