...
// Dependencies: [19, 17, 8684, 1369, 21, 4255, 712, 4223, 4107, 5323, 9927, 4251, 1236, 2351, 4665, 9920, 5615, 15864, 9464, 589, 8680, 2]
// Exports: default

// Module 15863 (HasBadgeCoachmark)
...
function HasBadgeCoachmark(markAsDismissed) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(importDefault(9927), obj1);
  }
  obj[1] = tmp4Result;
