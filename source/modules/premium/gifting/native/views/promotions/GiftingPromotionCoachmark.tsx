...
// Module 15486 (GiftingPromotionCoachmarkActionSheet)
...
const obj2 = { y: 1, isArray: 6, borderRadius: importDefault(dependencyMap[7]).radii.sm };
...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      const obj3 = { delete: null, dispatch: 1, raw: 1, style: tmp.text, children: coachmarkComponent.body };
