...
// Dependencies: [19, 17, 4334, 7410, 676, 1388, 21, 4342, 712, 589, 10099, 16095, 8916, 4310, 5789, 5809, 10090, 5458, 500, 9450, 5329, 4338, 4777, 1236, 2]
// Exports: default

// Module 16094 (GiftingPromotionCoachmarkActionSheet)
...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  const tmp11 = importDefault(8916)(null != stateFromStores1);
  dependencyMap = tmp11;
  React = tmp12;
  const tmp13 = importDefault(8916)(null != str);
  c4 = tmp13;
  ...
  analyticsLocations = importDefault(5789)(importDefault(5809).GIFTING_PROMOTION_COACHMARK).analyticsLocations;
