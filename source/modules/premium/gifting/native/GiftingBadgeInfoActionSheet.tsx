...
// Dependencies: [19, 17, 4336, 8835, 676, 21, 4344, 712, 1628, 589, 8831, 698, 5436, 4340, 1236, 2399, 10087, 2]
// Exports: default

// Module 10086 (GiftingBadgeInfoActionSheet)
...
export default function GiftingBadgeInfoActionSheet() {
  ...
  items3[1] = callback(require(4340) /* Text */.Text, obj3);
  obj1[1] = items3;
  ...
  return callback(require(5436) /* Background */.BottomSheet, obj5);
};
