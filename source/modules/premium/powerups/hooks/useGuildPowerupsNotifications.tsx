...
// Dependencies: [32, 19, 4193, 1891, 11771, 4172, 4173, 676, 1369, 4177, 11773, 11774, 4176, 11775, 1351, 1358, 4196, 4192, 11776, 1360, 647, 11772, 11780, 4215, 4214, 11782, 11783, 11784, 11785, 11787, 11788, 11789, 11767, 2]
...
// Module 11770 (maybeGetPerkPurchaseablePopoutDCF)
...
function useGuildPowerupsNotificationIndicator(arg0, arg1, lastBoostCount) {
  ...
  const tmp2 = importDefault(11776)(arg0, "useGuildPowerupsNotificationIndicator");
...
function useGuildPowerupsChannelListPopout(c0) {
  const _require = c0;
  const importDefault = arg1;
  let tmp4 = callback(_require(11780).usePerksCoachmarkDCF(null != arg1), 2);
  ...
  let tmp11 = importDefault(11782)(c0, arg1);
  ...
  let tmp16 = importDefault(11783)(c0);
  ...
  const tmp22 = importDefault(11785)(c0);
  let closure_14 = tmp22;
  tmp17 = importDefault(11784)();
  let tmp23 = null != arg1;
  if (tmp23) {
    tmp23 = !tmp6;
  }
  ...
  const tmp3Result1 = callback(_require(11780).useExpiringPowerupCoachmarkDCF(tmp23, c0), 2);
  ...
  const tmpResult1 = _require(11780);
  ...
  const isNewGamesCoachmarkEnabled = _require(11787).useIsNewGamesCoachmarkEnabled("useGuildPowerupsChannelListPopout");
  const tmpResult3 = _require(11787);
  let tmp29 = null != arg1;
  if (tmp29) {
  ...
  const tmp3Result2 = callback(_require(11780).useNewGamesCoachmarkDC(tmp29), 2);
  ...
  const tmpResult4 = _require(11780);
  const isGameServerPricingEnabled = _require(11788).useIsGameServerPricingEnabled(c0, "useGuildPowerupsChannelListPopout");
  const tmpResult5 = _require(11788);
  let tmp34 = null != arg1;
  if (tmp34) {
  ...
  const tmp3Result3 = callback(_require(11780).useGameServerPricingCoachmarkDCF(tmp34), 2);
  ...
  const tmpResult6 = _require(11780);
  const tmp3Result4 = callback(_require(11780).useGuildPowerupNotificationDCF(null != memo), 2);
