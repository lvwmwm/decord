...
// Dependencies: [57, 31, 1838, 4039, 11521, 4018, 4019, 653, 1345, 4023, 11523, 11524, 4022, 11525, 1327, 1334, 4042, 4038, 11526, 1336, 624, 11522, 11530, 4061, 4060, 11532, 11533, 11534, 11535, 11537, 11538, 11539, 11517, 2]
// Exports: useAutoDismissGuildPowerupsNotifications

// Module 11520 (maybeGetLevelUnlockedPopoutDCF)
  ...
  if (null != found) {
    ...
    if (null != table2[found]) {
      if (!obj2.isContentDismissed(tmp8, outer1_0)) {
        ...
        if (null != tmp4) {
          const obj = {
            type: _require(11524).GuildPowerupNotificationPopoutType.LEVEL_REACHED,
            powerup: tmp4,
  ...
  if (0 !== found.length) {
    if (1 === found.length) {
      if (!obj2.isContentDismissed(_require(1334).DismissibleGuildContent.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK, guildId)) {
        let obj = {
          type: _require(11524).GuildPowerupNotificationPopoutType.PERKS_PURCHASABLE,
          powerups: found,
          markAsDismissed(AUTO_DISMISS) {
                  const result = guildId(11523).markContentAsDismissed(guildId(1334).DismissibleGuildContent.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK, guildId, true, AUTO_DISMISS);
                }
        };
      }
      return obj;
    ...
    if (found.length > 1) {
      if (!obj4.isContentDismissed(_require(1334).DismissibleGuildContent.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, guildId)) {
        obj = {
          ...
          powerups: found,
          markAsDismissed(AUTO_DISMISS) {
                  const result = guildId(11523).markContentAsDismissed(guildId(1334).DismissibleGuildContent.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, guildId, true, AUTO_DISMISS);
                }
        };
        tmp8 = obj;
      }
      ...
      if (null != arg3) {
        if (arg2 >= arg3) {
          if (!obj2.isContentDismissed(_require(1334).DismissibleGuildContent.GAME_SERVER_HOSTING_GUILD_ELIGIBLE_COACHMARK, guildId)) {
            obj = {
              type: _require(11524).GuildPowerupNotificationPopoutType.GAME_SERVER_HOSTING_GUILD_ELIGIBLE,
              markAsDismissed(AUTO_DISMISS) {
...
function useGuildPowerupsNotificationIndicator(arg0, arg1, lastBoostCount) {
  ...
  const tmp = importDefault(11526)(arg0, "useGuildPowerupsNotificationIndicator");
...
function useGuildPowerupsChannelListPopout(guildId) {
  const _require = guildId;
  const importDefault = arg1;
  const tmp = callback(_require(11530).usePerksCoachmarkDCF(null != arg1), 2);
  ...
  const tmp7 = importDefault(11532)(guildId, arg1);
  let closure_8 = tmp7;
  obj5 = _require(4060);
  let tmp8 = null != arg1;
  if (tmp8) {
  ...
  let tmp9 = callback(_require(11530).useNewPerkAvailableCoachmarkDCF(tmp8, tmp7), 2);
  let closure_9 = tmp10;
  const tmp11 = tmp9[0] === _require(1334).DismissibleContent.GUILD_POWERUP_NEW_PERK_AVAILABLE_COACHMARK;
  let closure_10 = tmp11;
  let tmp12 = importDefault(11533)(guildId);
  let closure_11 = tmp12;
  const obj6 = _require(11530);
  const tmp13 = importDefault(11534)();
  let tmp14 = null != arg1;
  if (tmp14) {
    tmp14 = !tmp3;
  }
  ...
  let tmp15 = callback(_require(11530).useBoostToUnlockCoachmarkDCF(tmp14, guildId), 2);
  let closure_12 = tmp16;
  const tmp17 = tmp15[0] === _require(1334).DismissibleContent.BOOST_TO_UNLOCK_COACHMARK;
  let closure_13 = tmp17;
  const tmp18 = importDefault(11535)(guildId);
  let closure_14 = tmp18;
  const obj7 = _require(11530);
  let tmp19 = null != arg1;
  if (tmp19) {
    tmp19 = !tmp3;
  }
  ...
  const isNewGamesCoachmarkEnabled = _require(11537).useIsNewGamesCoachmarkEnabled("useGuildPowerupsChannelListPopout");
  const obj10 = _require(11537);
  let tmp25 = null != arg1;
  if (tmp25) {
  ...
  const tmp26 = callback(_require(11530).useNewGamesCoachmarkDC(tmp25), 2);
  ...
  const obj11 = _require(11530);
  const isGameServerPricingEnabled = _require(11538).useIsGameServerPricingEnabled(guildId, "useGuildPowerupsChannelListPopout");
  const obj12 = _require(11538);
  let tmp30 = null != arg1;
  if (tmp30) {
  ...
  const tmp31 = callback(_require(11530).useGameServerPricingCoachmarkDCF(tmp30), 2);
  ...
  const obj13 = _require(11530);
  const tmp35 = callback(_require(11530).useGuildPowerupNotificationDCF(null != memo), 2);
  const first = tmp35[0];
...
export const useAutoDismissGuildPowerupsNotifications = function useAutoDismissGuildPowerupsNotifications(guildId) {
  ...
  const dependencyMap = tmp2;
  let obj = _require(624);
  const autoDismissGuildPowerupsNewBadge = _require(11539).useAutoDismissGuildPowerupsNewBadge(guildId);
  const items1 = [guildId];
