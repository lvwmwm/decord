...
// Dependencies: [32, 19, 4388, 1908, 12424, 4367, 4368, 673, 1383, 4372, 12426, 12427, 4371, 12428, 1394, 1372, 4391, 4387, 12429, 1374, 644, 12425, 12433, 4410, 4409, 12435, 12436, 12437, 12438, 12440, 12441, 12442, 12420, 2]
...
// Module 12423 (maybeGetPerkPurchaseablePopoutDCF)
import useGuildAppliedBoostCountDefault from "useGuildAppliedBoostCount" /* 4387 */;
import useGuildPowerupRollbackNotificationConfigDefault from "useGuildPowerupRollbackNotificationConfig" /* 12429 */;
import useGuildPowerupNewPerkMarketingVersionDefault from "useGuildPowerupNewPerkMarketingVersion" /* 12435 */;
import itemsDefault from "items" /* 12436 */;
import useCanPurchaseBoostsDefault from "useCanPurchaseBoosts" /* 12437 */;
import useFeaturedExpiringPowerupDefault from "useFeaturedExpiringPowerup" /* 12438 */;
import closure_3 from "_slicedToArray" /* 32 */;
import closure_4 from "noop" /* 19 */;
import closure_5 from "handleGameServerInstanceCreated" /* 4388 */;
import closure_6 from "createGuildRecordFromRust" /* 1908 */;
import closure_7 from "getState" /* 12424 */;
import closure_8 from "calculateAppliedBoosts" /* 4367 */;
  ...
  if (0 !== found.length) {
    if (1 === found.length) {
      ...
      if (!tmp4Result.isContentDismissed(tmp4(1372).DismissibleGuildContent.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK, closure_1)) {
        ...
        obj[0] = tmp4(12427).GuildPowerupNotificationPopoutType.PERKS_PURCHASABLE;
        obj[1] = found;
        obj[2] = function markAsDismissed(AUTO_DISMISS) {
          const result = callback(12426).markContentAsDismissed(callback(1372).DismissibleGuildContent.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK, callback, true, AUTO_DISMISS);
        };
      }
      return obj;
    }
    ...
    if (found.length > 1) {
      ...
      if (!tmp4Result.isContentDismissed(tmp4(1372).DismissibleGuildContent.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, closure_1)) {
        ...
        obj[1] = found;
        obj[2] = function markAsDismissed(AUTO_DISMISS) {
          const result = callback(12426).markContentAsDismissed(callback(1372).DismissibleGuildContent.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK, callback, true, AUTO_DISMISS);
        };
        tmp6 = obj;
      }
    }
...
function useGuildPowerupsChannelListPopout(c0) {
  const _require = c0;
  importDefault = arg1;
  let tmp4 = callback(_require(12433).usePerksCoachmarkDCF(null != arg1), 2);
  dependencyMap = tmp5;
  ...
  let serverThemeEnabled = _require(4410).useServerThemeEnabled(c0, "useGuildPowerupsChannelListPopout");
  let obj4 = _require(4410);
  ...
  const tmp3Result1 = callback(_require(12433).useExpiringPowerupCoachmarkDCF(tmp23, c0), 2);
  closure_15 = tmp25;
  let tmp26 = tmp3Result1[0] === _require(1372).DismissibleContent.EXPIRING_POWERUP_COACHMARK;
  closure_16 = tmp26;
  const tmpResult1 = _require(12433);
  const gameServerEnabled = _require(4391).getGameServerEnabled(c0, "useGuildPowerupsChannelListPopout");
  const tmpResult2 = _require(4391);
  const isNewGamesCoachmarkEnabled = _require(12440).useIsNewGamesCoachmarkEnabled("useGuildPowerupsChannelListPopout");
  const tmpResult3 = _require(12440);
  let tmp29 = null != arg1;
  if (tmp29) {
  ...
  const tmp3Result2 = callback(_require(12433).useNewGamesCoachmarkDC(tmp29), 2);
  closure_17 = tmp31;
  const tmp32 = tmp3Result2[0] === _require(1372).DismissibleContent.GAME_SERVER_NEW_GAMES_COACHMARK;
  closure_18 = tmp32;
  const tmpResult4 = _require(12433);
  const isGameServerPricingEnabled = _require(12441).useIsGameServerPricingEnabled(c0, "useGuildPowerupsChannelListPopout");
  const tmpResult5 = _require(12441);
  let tmp34 = null != arg1;
  if (tmp34) {
  ...
  const tmp3Result3 = callback(_require(12433).useGameServerPricingCoachmarkDCF(tmp34), 2);
  closure_19 = tmp36;
          ...
          if (!closure_18) {
            if (!closure_20) {
              if (!closure_13) {
                if (!closure_16) {
                  closure_1 = tmp;
                  const ReverseOrderedTiers = c0(4372).ReverseOrderedTiers;
                    ...
                    if (null != table2[found]) {
                      ...
                      if (!tmp8Result.isContentDismissed(tmp13, tmp7)) {
                        ...
                        if (null != tmp16) {
                          ...
                          obj[0] = tmp8(12427).GuildPowerupNotificationPopoutType.LEVEL_REACHED;
                          obj[1] = tmp16;
                          obj[2] = function markAsDismissed(AUTO_DISMISS) {
                            const result = callback(12426).markContentAsDismissed(dependencyMap, callback, true, AUTO_DISMISS);
                          };
                          tmp11 = obj;
                        }
                      }
                          ...
                          if (null != tmp28) {
                            if (tmp21 >= tmp28) {
                              if (!tmp8Result1.isContentDismissed(tmp8(1372).DismissibleGuildContent.GAME_SERVER_HOSTING_GUILD_ELIGIBLE_COACHMARK, tmp7)) {
                                ...
                                obj[0] = tmp8(12427).GuildPowerupNotificationPopoutType.GAME_SERVER_HOSTING_GUILD_ELIGIBLE;
                                obj[1] = function markAsDismissed(AUTO_DISMISS) {
                                  const result = callback(12426).markContentAsDismissed(callback(1372).DismissibleGuildContent.GAME_SERVER_HOSTING_GUILD_ELIGIBLE_COACHMARK, callback, true, AUTO_DISMISS);
                                };
                                tmp17 = obj;
                              }
                              tmp8Result1 = tmp8(12426);
                            }
                          }
                        }
                      }
  ...
  const tmpResult6 = _require(12433);
  const tmp3Result4 = callback(_require(12433).useGuildPowerupNotificationDCF(null != memo), 2);
  ...
  return available.useMemo(() => {
    if (null != closure_1) {
      if (closure_3) {
        ...
        obj[0] = c0(12427).GuildPowerupNotificationPopoutType.PERKS_AVAILABLE;
        obj[1] = dependencyMap;
        return obj;
      } else if (closure_10) {
        if (closure_8 === constants.GAME_SERVER_HOSTING) {
          obj = { type: null, markAsDismissed: null };
          obj[0] = c0(12427).GuildPowerupNotificationPopoutType.GAME_SERVER_HOSTING_AVAILABLE;
          obj[1] = closure_9;
          return obj;
        } else {
          c0 = table3[tmp30];
          ...
          if (0 !== found.length) {
            ...
            obj1[0] = found;
            obj1[1] = c0(12427).GuildPowerupNotificationPopoutType.NEW_PERK_AVAILABLE;
            obj1[2] = closure_9;
            return obj1;
          }
        }
        ...
        if (constants) {
          if (null != closure_11) {
            ...
            obj2[0] = c0(12427).GuildPowerupNotificationPopoutType.BOOST_TO_UNLOCK;
            obj2[1] = tmp5;
            obj2[2] = closure_12;
            let tmp13 = obj2;
          }
        ...
        if (closure_16) {
          if (null != table3) {
            ...
            obj3[0] = c0(12427).GuildPowerupNotificationPopoutType.EXPIRING_PERK;
            obj3[1] = tmp7;
            obj3[2] = closure_15;
            tmp13 = obj3;
          }
        ...
        if (closure_18) {
          ...
          obj4[0] = c0(12427).GuildPowerupNotificationPopoutType.GAME_SERVER_NEW_GAMES;
          obj4[1] = closure_17;
          tmp13 = obj4;
        } else if (closure_20) {
          const obj5 = { type: null, markAsDismissed: null };
          obj5[0] = c0(12427).GuildPowerupNotificationPopoutType.GAME_SERVER_PRICING_CHANGE;
          obj5[1] = closure_19;
          tmp13 = obj5;
...
export const maybeGetLevelUnlockedPopoutDCF = function maybeGetLevelUnlockedPopoutDCF(closure_1) {
  const _require = closure_1;
  closure_1 = arg1;
  const ReverseOrderedTiers = _require(4372).ReverseOrderedTiers;
  const found = ReverseOrderedTiers.find((arg0) => {
    let tmp2;
    if (null != closure_1_9[arg0]) {
      tmp2 = unlockedPowerups.unlockedPowerups[tmp];
    ...
    if (null != table2[found]) {
      if (!tmpResult.isContentDismissed(tmp8, closure_1)) {
        ...
        if (null != tmp6) {
          ...
          obj[0] = tmp(12427).GuildPowerupNotificationPopoutType.LEVEL_REACHED;
          obj[1] = tmp6;
          obj[2] = function markAsDismissed(AUTO_DISMISS) {
            const result = callback(12426).markContentAsDismissed(dependencyMap, callback, true, AUTO_DISMISS);
          };
      ...
      if (null != arg3) {
        if (arg2 >= arg3) {
          if (!tmpResult.isContentDismissed(tmp(1372).DismissibleGuildContent.GAME_SERVER_HOSTING_GUILD_ELIGIBLE_COACHMARK, c0)) {
            obj = { type: null, markAsDismissed: null };
            obj[0] = tmp(12427).GuildPowerupNotificationPopoutType.GAME_SERVER_HOSTING_GUILD_ELIGIBLE;
            obj[1] = function markAsDismissed(AUTO_DISMISS) {
              const result = callback(12426).markContentAsDismissed(callback(1372).DismissibleGuildContent.GAME_SERVER_HOSTING_GUILD_ELIGIBLE_COACHMARK, callback, true, AUTO_DISMISS);
            };
            return obj;
