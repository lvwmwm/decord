...
// Dependencies: [32, 19, 4211, 1891, 11852, 4190, 4191, 676, 1369, 4195, 11854, 11855, 4194, 11856, 1351, 1358, 4214, 4210, 11857, 1360, 647, 11853, 11861, 4233, 4232, 11863, 11864, 11865, 11866, 11868, 11869, 11870, 11848, 2]
...
// Module 11851 (maybeGetPerkPurchaseablePopoutDCF)
...
function useGuildPowerupsNotificationIndicator(arg0, arg1, lastBoostCount) {
  ...
  const tmp2 = importDefault(11857)(arg0, "useGuildPowerupsNotificationIndicator");
...
function useGuildPowerupsChannelListPopout(c0) {
  const _require = c0;
  const importDefault = arg1;
  let tmp4 = callback(_require(11861).usePerksCoachmarkDCF(null != arg1), 2);
  ...
  let tmp11 = importDefault(11863)(c0, arg1);
  ...
  let tmp16 = importDefault(11864)(c0);
  ...
  const tmp22 = importDefault(11866)(c0);
  let closure_14 = tmp22;
  tmp17 = importDefault(11865)();
  let tmp23 = null != arg1;
  if (tmp23) {
    tmp23 = !tmp6;
  }
  ...
  const tmp3Result1 = callback(_require(11861).useExpiringPowerupCoachmarkDCF(tmp23, c0), 2);
  ...
  const tmpResult1 = _require(11861);
  ...
  const isNewGamesCoachmarkEnabled = _require(11868).useIsNewGamesCoachmarkEnabled("useGuildPowerupsChannelListPopout");
  const tmpResult3 = _require(11868);
  let tmp29 = null != arg1;
  if (tmp29) {
  ...
  const tmp3Result2 = callback(_require(11861).useNewGamesCoachmarkDC(tmp29), 2);
  ...
  const tmpResult4 = _require(11861);
  const isGameServerPricingEnabled = _require(11869).useIsGameServerPricingEnabled(c0, "useGuildPowerupsChannelListPopout");
  const tmpResult5 = _require(11869);
  let tmp34 = null != arg1;
  if (tmp34) {
  ...
  const tmp3Result3 = callback(_require(11861).useGameServerPricingCoachmarkDCF(tmp34), 2);
  ...
  const tmpResult6 = _require(11861);
  const tmp3Result4 = callback(_require(11861).useGuildPowerupNotificationDCF(null != memo), 2);
