...
// Dependencies: [32, 19, 4210, 1891, 11786, 4189, 4190, 676, 1369, 4194, 11788, 11789, 4193, 11790, 1351, 1358, 4213, 4209, 11791, 1360, 647, 11787, 11795, 4232, 4231, 11797, 11798, 11799, 11800, 11802, 11803, 11804, 11782, 2]
...
// Module 11785 (maybeGetPerkPurchaseablePopoutDCF)
...
function useGuildPowerupsNotificationIndicator(arg0, arg1, lastBoostCount) {
  ...
  const available = importDefault(4209)(arg0).available;
  const tmp2 = importDefault(11791)(arg0, "useGuildPowerupsNotificationIndicator");
...
function useGuildPowerupsChannelListPopout(c0) {
  const _require = c0;
  const importDefault = arg1;
  let tmp4 = callback(_require(11795).usePerksCoachmarkDCF(null != arg1), 2);
  const dependencyMap = tmp5;
  const tmp6 = tmp4[0] === _require(1358).DismissibleContent.GUILD_POWERUP_PERKS_COACHMARK;
  callback = tmp6;
  const available = importDefault(4209)(c0).available;
  let obj = _require(11795);
  ...
  let serverThemeEnabled = _require(4232).useServerThemeEnabled(c0, "useGuildPowerupsChannelListPopout");
  let obj4 = _require(4232);
  if (serverThemeEnabled) {
    serverThemeEnabled = obj5.useServerThemeUserEnabled("useGuildPowerupsChannelListPopout");
  }
  let tmp11 = importDefault(11797)(c0, arg1);
  ...
  let tmp16 = importDefault(11798)(c0);
  ...
  const tmp22 = importDefault(11800)(c0);
  let closure_14 = tmp22;
  tmp17 = importDefault(11799)();
  let tmp23 = null != arg1;
  if (tmp23) {
    tmp23 = !tmp6;
  }
  ...
  const tmp3Result1 = callback(_require(11795).useExpiringPowerupCoachmarkDCF(tmp23, c0), 2);
  ...
  const tmpResult1 = _require(11795);
  const gameServerEnabled = _require(4213).getGameServerEnabled(c0, "useGuildPowerupsChannelListPopout");
  const tmpResult2 = _require(4213);
  const isNewGamesCoachmarkEnabled = _require(11802).useIsNewGamesCoachmarkEnabled("useGuildPowerupsChannelListPopout");
  const tmpResult3 = _require(11802);
  let tmp29 = null != arg1;
  if (tmp29) {
  ...
  const tmp3Result2 = callback(_require(11795).useNewGamesCoachmarkDC(tmp29), 2);
  ...
  const tmpResult4 = _require(11795);
  const isGameServerPricingEnabled = _require(11803).useIsGameServerPricingEnabled(c0, "useGuildPowerupsChannelListPopout");
  const tmpResult5 = _require(11803);
  let tmp34 = null != arg1;
  if (tmp34) {
  ...
  const tmp3Result3 = callback(_require(11795).useGameServerPricingCoachmarkDCF(tmp34), 2);
  ...
  const tmpResult6 = _require(11795);
  const tmp3Result4 = callback(_require(11795).useGuildPowerupNotificationDCF(null != memo), 2);
...
export const maybeGetLevelUnlockedPopoutDCF = function maybeGetLevelUnlockedPopoutDCF(closure_1) {
  const _require = closure_1;
  closure_1 = arg1;
  const ReverseOrderedTiers = _require(4194).ReverseOrderedTiers;
  const found = ReverseOrderedTiers.find((arg0) => {
    let tmp2;
    if (null != outer1_9[arg0]) {
      tmp2 = tmp.unlockedPowerups[tmp];
