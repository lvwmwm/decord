...
// Dependencies: [32, 19, 4282, 1910, 11661, 4261, 4262, 676, 1388, 4266, 11663, 11664, 4265, 11665, 1370, 1377, 4285, 4281, 11666, 1379, 647, 11662, 11670, 4304, 4303, 11672, 11673, 11674, 11675, 11677, 11678, 11679, 11657, 2]
...
function useGuildPowerupsNotificationIndicator(arg0, arg1, lastBoostCount) {
  ...
  const available = importDefault(4281)(arg0).available;
  const tmp2 = importDefault(11666)(arg0, "useGuildPowerupsNotificationIndicator");
...
function useGuildPowerupsChannelListPopout(c0) {
  ...
  callback = tmp6;
  const available = importDefault(4281)(c0).available;
  ...
  let tmp11 = importDefault(11672)(c0, arg1);
  ...
  let tmp16 = importDefault(11673)(c0);
  ...
  const tmp22 = importDefault(11675)(c0);
  let closure_14 = tmp22;
  tmp17 = importDefault(11674)();
  let tmp23 = null != arg1;
  if (tmp23) {
    tmp23 = !tmp6;
  }
