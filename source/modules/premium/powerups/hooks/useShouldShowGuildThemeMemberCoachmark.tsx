...
// Dependencies: [4019, 11542, 4061, 4060, 15059, 4038, 2]
// Exports: default

// Module 15058 (useShouldShowGuildThemeMemberCoachmark)
...
export default function useShouldShowGuildThemeMemberCoachmark(guildId) {
  const tmp = importDefault(11542)(guildId);
  ...
  const tmp4 = importDefault(15059)(guildId);
