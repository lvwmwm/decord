...
// Dependencies: [4142, 589, 4146, 11743, 1358, 1236, 2287, 11745, 2]
// Exports: default

// Module 11742 (useGuildPowerupRollbackNotificationConfig)
    ...
    if (null != storeRemovalDate) {
      ...
      if (null != title) {
        ...
        if (null != cost) {
          ...
          obj = { dateString: null };
          obj[0] = importDefault(11745)(storeRemovalDate);
          ...
          obj1[0] = importDefault(11745)(storeRemovalDate);
          obj1[1] = importDefault(11745)(storeRemovalDate);
          let title1;
          if (tmp4 != null) {
            title1 = tmp4.title;
          }
