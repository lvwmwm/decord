...
// Dependencies: [4229, 589, 4233, 11938, 1377, 1236, 2335, 11940, 2]
// Exports: default

// Module 11937 (useGuildPowerupRollbackNotificationConfig)
    ...
    if (null != storeRemovalDate) {
      ...
      if (null != title) {
        ...
        if (null != cost) {
          ...
          obj = { dateString: null };
          obj[0] = importDefault(11940)(storeRemovalDate);
          ...
          obj1[0] = importDefault(11940)(storeRemovalDate);
          obj1[1] = importDefault(11940)(storeRemovalDate);
          let title1;
          if (tmp4 != null) {
            title1 = tmp4.title;
          }
