...
// Dependencies: [4172, 589, 4176, 11777, 1358, 1236, 2316, 11779, 2]
// Exports: default

// Module 11776 (useGuildPowerupRollbackNotificationConfig)
    ...
    if (null != storeRemovalDate) {
      ...
      if (null != title) {
        ...
        if (null != cost) {
          ...
          obj = { dateString: null };
          obj[0] = importDefault(11779)(storeRemovalDate);
          ...
          obj1[0] = importDefault(11779)(storeRemovalDate);
          obj1[1] = importDefault(11779)(storeRemovalDate);
          let title1;
          if (tmp4 != null) {
            title1 = tmp4.title;
          }
