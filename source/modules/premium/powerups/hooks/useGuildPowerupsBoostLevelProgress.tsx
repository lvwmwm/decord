...
// Dependencies: [1891, 676, 4209, 589, 2]
// Exports: default, getGuildPowerupBoostLevelProgress

// Module 4228 (useGuildPowerupBoostLevelProgress)
...
export default function useGuildPowerupBoostLevelProgress(arg0) {
  const _require = arg0;
  const tmp = importDefault(4209)(arg0);
...
export const getGuildPowerupBoostLevelProgress = function getGuildPowerupBoostLevelProgress(id) {
  const guildPowerupsBoostCount = require(4209) /* useGuildAppliedBoostCount */.getGuildPowerupsBoostCount(id);
