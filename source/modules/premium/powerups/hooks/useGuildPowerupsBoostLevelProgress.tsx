...
// Dependencies: [1891, 676, 4210, 589, 2]
// Exports: default, getGuildPowerupBoostLevelProgress

// Module 4229 (useGuildPowerupBoostLevelProgress)
...
export default function useGuildPowerupBoostLevelProgress(arg0) {
  const _require = arg0;
  const tmp = importDefault(4210)(arg0);
...
export const getGuildPowerupBoostLevelProgress = function getGuildPowerupBoostLevelProgress(id) {
  const guildPowerupsBoostCount = require(4210) /* useGuildAppliedBoostCount */.getGuildPowerupsBoostCount(id);
