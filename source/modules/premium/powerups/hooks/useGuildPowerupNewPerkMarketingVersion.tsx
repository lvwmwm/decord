...
// Dependencies: [19, 1910, 3989, 4232, 676, 4255, 589, 4274, 4273, 4235, 9069, 2]
// Exports: default

// Module 11924 (useGuildPowerupNewPerkMarketingVersion)
...
export default function useGuildPowerupNewPerkMarketingVersion(guildId) {
  ...
  const gameServerEnabled = _require(4255).useGameServerEnabled(guildId, "useGuildPowerupNewPerkMarketingVersion");
  ...
  let serverThemeEnabled = _require(4274).useServerThemeEnabled(guildId, "useGuildPowerupNewPerkMarketingVersion");
  const obj3 = _require(4274);
  ...
  return gameServerEnabled.useMemo(() => {
    ...
    if (dependencyMap != null) {
      ...
      if (allPowerups != null) {
        tmp2 = allPowerups[guildId(undefined, 4235).GUILD_POWERUP_TAG_SKU_ID];
      }
    }
    if (dependencyMap != null) {
      let unlockedPowerups = tmp.unlockedPowerups;
      if (unlockedPowerups != null) {
        const tmp6 = unlockedPowerups[guildId(undefined, 4235).GUILD_POWERUP_TAG_SKU_ID];
      }
    }
    if (tmp5) {
      if (null == tmp6) {
    ...
    if (dependencyMap != null) {
      ...
      if (allPowerups2 != null) {
        tmp14 = allPowerups2[guildId(undefined, 4235).GUILD_POWERUP_GUILD_THEME_SKU_ID];
      }
    }
    if (dependencyMap != null) {
      const unlockedPowerups2 = tmp.unlockedPowerups;
      if (unlockedPowerups2 != null) {
        const tmp18 = unlockedPowerups2[guildId(undefined, 4235).GUILD_POWERUP_GUILD_THEME_SKU_ID];
      }
    }
    if (serverThemeEnabled) {
      if (tmp17) {
    ...
    if (dependencyMap != null) {
      ...
      if (allPowerups3 != null) {
        tmp22 = allPowerups3[guildId(undefined, 4235).GUILD_POWERUP_MAX_FILE_SIZE_250_MB_SKU_ID];
      }
    }
    if (dependencyMap != null) {
      const unlockedPowerups3 = tmp.unlockedPowerups;
      if (unlockedPowerups3 != null) {
        const tmp26 = unlockedPowerups3[guildId(undefined, 4235).GUILD_POWERUP_MAX_FILE_SIZE_250_MB_SKU_ID];
      }
    }
    if (tmp25) {
      if (null == tmp26) {
