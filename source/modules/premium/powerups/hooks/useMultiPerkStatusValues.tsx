...
// Dependencies: [4173, 11778, 1236, 2316, 2]
// Exports: default

// Module 11850 (useMultiPerkStatusValues)
...
export default function useMultiPerkStatusValues(powerups) {
  ...
  let obj = require(11778) /* usePowerupActiveStatus */;
  ...
  if (powerups.length <= 0) {
    ...
    if (null != reduced) {
      ...
      obj[1] = intl.string(importDefault(2316).FFLkmx);
      tmp4 = obj;
    }
