...
// Dependencies: [1862, 4076, 4077, 676, 4078, 589, 2]
// Exports: default, isPowerupActiveStatusActive, usePowerupsActiveStatuses

// Module 11587 (usePowerupActiveStatus)
      ...
      if (null != skuId) {
        if (null != stateFromStores) {
          ...
          if (isActiveFromLevel) {
            ...
            const obj2 = { type: null, powerup: null, sourceEntitlement: "Array", sourcePowerup: "\u{1F9B9}\u{1F3FB}\u200D\u2642\uFE0F" };
