...
// Dependencies: [5943, 1358, 11774, 11781, 2]
...
// Module 11780 (usePerksCoachmarkDCF)
...
export const usePerksCoachmarkDCF = function usePerksCoachmarkDCF(arg0) {
  ...
  return require(5943) /* useSelectedDismissibleContent */.useSelectedDismissibleContent(items1);
};
export const useNewPerkAvailableCoachmarkDCF = function useNewPerkAvailableCoachmarkDCF(arg0, latestVersion) {
  ...
  return require(5943) /* useSelectedDismissibleContent */.useSelectedVersionedDismissibleContent(prop, latestVersion);
};
...
export const useBoostToUnlockCoachmarkDCF = function useBoostToUnlockCoachmarkDCF(arg0, id, GUILD_HEADER_TOOLTIPS) {
  ...
  return require(5943) /* useSelectedDismissibleContent */.useSelectedTimeRecurringGuildDismissibleContent(prop, id, obj, GUILD_HEADER_TOOLTIPS);
};
