...
// Dependencies: [5962, 1358, 11789, 11796, 2]
...
// Module 11795 (usePerksCoachmarkDCF)
...
export const usePerksCoachmarkDCF = function usePerksCoachmarkDCF(arg0) {
  ...
  return require(5962) /* useSelectedDismissibleContent */.useSelectedDismissibleContent(items1);
};
export const useNewPerkAvailableCoachmarkDCF = function useNewPerkAvailableCoachmarkDCF(arg0, latestVersion) {
  ...
  return require(5962) /* useSelectedDismissibleContent */.useSelectedVersionedDismissibleContent(prop, latestVersion);
};
...
export const useBoostToUnlockCoachmarkDCF = function useBoostToUnlockCoachmarkDCF(arg0, id, GUILD_HEADER_TOOLTIPS) {
  ...
  return require(5962) /* useSelectedDismissibleContent */.useSelectedTimeRecurringGuildDismissibleContent(prop, id, obj, GUILD_HEADER_TOOLTIPS);
};
