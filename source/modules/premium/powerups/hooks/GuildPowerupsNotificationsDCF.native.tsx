...
// Dependencies: [6086, 1377, 11935, 11942, 2]
...
// Module 11941 (usePerksCoachmarkDCF)
...
export const usePerksCoachmarkDCF = function usePerksCoachmarkDCF(arg0) {
  ...
  return require(6086) /* useSelectedDismissibleContent */.useSelectedDismissibleContent(items1);
};
export const useNewPerkAvailableCoachmarkDCF = function useNewPerkAvailableCoachmarkDCF(arg0, latestVersion) {
  ...
  return require(6086) /* useSelectedDismissibleContent */.useSelectedVersionedDismissibleContent(prop, latestVersion);
};
...
export const useBoostToUnlockCoachmarkDCF = function useBoostToUnlockCoachmarkDCF(arg0, id, GUILD_HEADER_TOOLTIPS) {
  ...
  return require(6086) /* useSelectedDismissibleContent */.useSelectedTimeRecurringGuildDismissibleContent(prop, id, obj, GUILD_HEADER_TOOLTIPS);
};
