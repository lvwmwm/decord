...
// Dependencies: [19, 17, 21, 4255, 712, 4191, 4101, 11811, 11768, 4676, 4251, 11769, 1297, 1236, 2]
// Exports: default

// Module 11814 (GuildPowerupsPerkCard)
import "noop";
...
export default function GuildPowerupsPerkCard(arg0) {
  ...
  items1[1] = callback(importDefault(4676), { colors: obj.isThemeDark(importDefault(4191)()) ? ["#0f101100", "#0f101166"] : ["#0f101100", "#0f10111a"], style: tmp2.gradient });
  obj[1] = items1;
  ...
  obj5.status = status;
  items4[1] = callback(require(11769) /* GuildPowerupCardFooterActive */.GuildPowerupsCardFooter, obj5);
  obj3[1] = items4;
