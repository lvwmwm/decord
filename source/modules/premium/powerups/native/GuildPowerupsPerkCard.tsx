...
// Dependencies: [19, 17, 21, 4285, 712, 4221, 4130, 11845, 11802, 4706, 4281, 11803, 1297, 1236, 2]
// Exports: default

// Module 11848 (GuildPowerupsPerkCard)
import "noop";
...
export default function GuildPowerupsPerkCard(arg0) {
  ...
  obj5.status = status;
  items4[1] = callback(require(11803) /* GuildPowerupCardFooterActive */.GuildPowerupsCardFooter, obj5);
  obj3[1] = items4;
