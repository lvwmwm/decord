...
// Dependencies: [4223, 11760, 1959, 2]
// Exports: default

// Module 11759 (openGuildPowerupRollbackSheet)
...
export default function openGuildPowerupRollbackSheet(arg0) {
  importDefault(4223).openLazy(require(1959) /* asyncRequireImpl */(11760, dependencyMap.paths), GUILD_POWERUP_ROLLBACK_SHEET_KEY, arg0);
};
