...
// Dependencies: [4445, 12318, 2008, 2]
// Exports: default

// Module 12317 (openGuildPowerupsBottomSheet)
...
export default function openGuildPowerupsBottomSheet(arg0) {
  ACTION_SHEET_HEIGHT_HALFDefault.openLazy(asyncRequireImpl(12318, dependencyMap.paths), GUILD_POWERUPS_BOTTOM_SHEET_KEY, arg0);
};
