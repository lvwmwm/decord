...
// Dependencies: [19, 1910, 1922, 4336, 676, 21, 589, 7069, 1938, 5324, 7073, 2]
// Exports: GuildPowerupsBoostButton

// Module 12218 (GuildPowerupsBoostButton)
...
export const GuildPowerupsBoostButton = function GuildPowerupsBoostButton(guildId) {
  ...
  const tmp6 = stateFromStores1(7069)({ forceFetch: true });
  ...
  if (null != stateFromStores) {
    ...
    obj[4] = tmp9;
    obj[5] = UNSPECIFIED;
    tmp10 = jsx(tmp5(7073), { guild: null, previousGuildSubscriptionSlot: null, analyticsSection: null, fractionalPremiumState: null, onAvailableSlotPress: null, premiumGroupRole: null });
  }
  return tmp10;
};
