...
// Dependencies: [19, 4334, 4229, 4230, 1388, 21, 4342, 712, 589, 4233, 11944, 15367, 4249, 5192, 1236, 2335, 11947, 8702, 2]
// Exports: default

// Module 15366 (GuildThemeMemberCoachmark)
...
export default function GuildThemeMemberCoachmark(guildId) {
  ...
  guildPowerupBannerImage = guildId(11944).getGuildPowerupBannerImage(stateFromStores, stateFromStores1, true);
  if (guildPowerupBannerImage == null) {
    guildPowerupBannerImage = markAsDismissed(15367);
  }
  const diff = callback - markAsDismissed(4249)(guildId).available;
  c5 = diff;
  ...
  const obj3 = guildId(11944);
  const coachmark = tmp2(8702).useCoachmark(guildId.targetRef, memo);
  return null;
};
