...
// Dependencies: [19, 17, 1388, 21, 4342, 9070, 1236, 2335, 4072, 8702, 2]
// Exports: default

// Module 15374 (BoostProgressBarCoachmark)
...
export default function BoostProgressBarCoachmark(guild) {
  ...
  const coachmark = guild(8702).useCoachmark(guild.targetRef, memo);
  return null;
};
