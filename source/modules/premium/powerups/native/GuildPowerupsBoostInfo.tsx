...
export default function GuildPowerupsBoostInfo(arg0) {
  ...
  items[1] = closure_5(require(4185) /* Text */.Text, { variant: "text-lg/medium", color: str, importantForAccessibility: "no-hide-descendants", children: count });
  obj[3] = items;
  const items1 = [closure_6(View, obj), closure_5(require(4185) /* Text */.Text, { variant: "text-md/normal", color: "text-subtle", importantForAccessibility: "no-hide-descendants", children: guildPowerupsBoostInfoText })];
  obj[3] = items1;
