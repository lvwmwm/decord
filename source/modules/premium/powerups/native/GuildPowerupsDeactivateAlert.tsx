...
// Dependencies: [17, 21, 4481, 709, 12473, 12474, 12475, 4871, 6550, 1233, 2400, 4871, 4477, 2]
// Exports: default

// Module 12472 (GuildPowerupsDeactivateAlert)
import set from "set" /* 2 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import ThemesDefault from "Themes" /* 709 */;
import messagesProxyDefault from "messagesProxy" /* 2400 */;
import useGuildPowerupOnDeactivateDefault from "useGuildPowerupOnDeactivate" /* 12473 */;
import useDeactivateWarningTextDefault from "useDeactivateWarningText" /* 12474 */;
...
export default function GuildPowerupsDeactivateAlert(arg0) {
  ...
  let obj = _require(12475);
  const logPowerupModalOpened = obj.useLogPowerupModalOpened(guildId, powerup, _require(12475).ModalType.DEACTIVATE);
  ...
  const tmp8 = View;
  obj[1] = callback(_require(6550).CircleErrorIcon, { color: ThemesDefault.colors.INTERACTIVE_ICON_DEFAULT, size: "custom", style: { width: 40, height: 40 } });
  ...
  if (tmp7Result) {
    ...
    obj4[3] = error;
    tmp7Result = tmp7(tmp5(4477).Text, obj4);
  }
  ...
  items[1] = callback(_require(4871).AlertActionButton, obj6, "deactivate");
  const obj7 = {
    onPress() {
  ...
  items[2] = callback(_require(4871).AlertActionButton, obj7, "cancel");
  obj5[0] = items;
  obj[3] = closure_5(_require(4871).AlertActions, obj5);
