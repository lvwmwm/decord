...
export default function GuildPowerupsDeactivateAlert(arg0) {
  ...
  obj[2] = intl2.formatToPlainString(importDefault(2255)["7o0K+2"], { perk: powerup.title });
  ...
  if (tmp7Result) {
    ...
    obj4[3] = error;
    tmp7Result = tmp7(tmp5(4185).Text, obj4);
  }
  ...
  obj6[2] = intl3.string(tmp2(2255).PYPdl4);
  items[1] = callback(_require(4533).AlertActionButton, obj6, "deactivate");
  const obj7 = {
    onPress() {
