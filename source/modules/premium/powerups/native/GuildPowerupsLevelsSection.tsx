...
// Function ID: 11983
// Name: PX_16
// Dependencies: [19, 17, 21, 712, 501, 4344, 11971, 1236, 2335, 11983, 11984, 2]
// Exports: default
...
export default function GuildPowerupsLevelsSection(arg0) {
  ...
  const items1 = [callback(listings(11971), obj), ];
  ...
  items1[1] = callback(require(11983) /* items */.MarketingCardsScroller, obj);
  obj[0] = items1;
