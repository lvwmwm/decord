...
// Function ID: 90084
// Name: PX_16
// Dependencies: [31, 27, 33, 689, 478, 4131, 11579, 1212, 2231, 11591, 11592, 2]
// Exports: default
...
export default function GuildPowerupsLevelsSection(arg0) {
  ...
  const items1 = [callback(listings(11579), obj), ];
  obj = {
  ...
  items1[1] = callback(require(11591) /* getClampedIndex */.MarketingCardsScroller, obj);
  obj.children = items1;
