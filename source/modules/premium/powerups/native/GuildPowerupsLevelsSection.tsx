...
// Function ID: 11926
// Name: PX_16
// Dependencies: [19, 17, 21, 712, 501, 4303, 11914, 1236, 2335, 11926, 11927, 2]
// Exports: default
...
export default function GuildPowerupsLevelsSection(arg0) {
  ...
  const items1 = [callback(listings(11914), obj), ];
  ...
  items1[1] = callback(require(11926) /* items */.MarketingCardsScroller, obj);
  obj[0] = items1;
