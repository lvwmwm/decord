...
// Function ID: 11923
// Name: PX_16
// Dependencies: [19, 17, 21, 712, 501, 4303, 11911, 1236, 2316, 11923, 11924, 2]
// Exports: default
...
export default function GuildPowerupsLevelsSection(arg0) {
  ...
  const items1 = [callback(listings(11911), obj), ];
  ...
  items1[1] = callback(require(11923) /* items */.MarketingCardsScroller, obj);
  obj[0] = items1;
