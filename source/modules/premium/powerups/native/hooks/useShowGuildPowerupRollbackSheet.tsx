...
// Dependencies: [32, 19, 1383, 12444, 7326, 12446, 4448, 2]
// Exports: default

// Module 12443 (useShowGuildPowerupRollbackSheet)
...
export default function useShowGuildPowerupRollbackSheet(arg0, arg1) {
  ...
  let callback;
  ({ shouldShow, modalConfig } = first(12444)(arg0, arg1));
  if (shouldShow) {
  ...
  const tmp2 = first(12444)(arg0, arg1);
  const tmp5 = callback(modalConfig(7326).useSelectedDismissibleContent(items), 2);
  first = tmp5[0];
  dependencyMap = tmp7;
