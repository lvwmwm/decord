...
// Dependencies: [17, 16709, 16711, 16708, 505, 21, 4303, 712, 4239, 4742, 16728, 1236, 8043, 5397, 5396, 4271, 8595, 1986, 8072, 12577, 4299, 2335, 4045, 2]
// Exports: default

// Module 16727 (EnhancedRoleColorsSelectStyleModal)
...
export default function EnhancedRoleColorsSelectStyleModal(arg0) {
  ...
  let c5;
  ({ guildId, role } = arg0);
  const tmp3 = callback2(importDefault(4239)());
  dependencyMap = tmp3;
  ...
  const tmp6 = new importDefault(8043)();
  let items = [
    callback(closure_4, {
