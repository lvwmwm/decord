...
// Dependencies: [17, 16767, 16769, 16766, 505, 21, 4344, 712, 4280, 4782, 16786, 1236, 8082, 5436, 5435, 4312, 8634, 1986, 8111, 12636, 4340, 2335, 4086, 2]
// Exports: default

// Module 16785 (EnhancedRoleColorsSelectStyleModal)
...
export default function EnhancedRoleColorsSelectStyleModal(arg0) {
  ...
  const tmp6 = new importDefault(8082)();
  let items = [
    callback(closure_4, {
