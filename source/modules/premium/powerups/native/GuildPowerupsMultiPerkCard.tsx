...
// Dependencies: [19, 4473, 21, 12481, 586, 12505, 12478, 12503, 2]
// Exports: default

// Module 12504 (GuildPowerupsMultiPerkCard)
...
export default function GuildPowerupsMultiPerkCard(guildId) {
  ...
  let badge = listing(12481)(guildId, listing);
  let obj = guildId(586);
  const items = [closure_4];
  const stateFromStores = obj.useStateFromStores(items, () => useReducedMotion.useReducedMotion);
  obj = { guildId, powerups: listing.powerups };
  costDecorator = listing(12505)(obj);
  ...
  if (null != costDecorator) {
    ...
    if (null != badge) {
      ...
      badge = badge.badge;
      obj[7] = badge;
      jsx(listing(12503), { title: null, description: null, cost: null, imageUrl: null, status: null, costDecorator: null, onPress: null, badge: null });
      const tmp6 = jsx;
    }
  }
  return tmp5;
