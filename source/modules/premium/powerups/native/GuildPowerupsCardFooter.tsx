...
class GuildPowerupCardFooterCost {
  constructor(arg0) {
    ...
    if (null != cost) {
      ...
      num3 = 5;
      tmp9 = jsx;
      obj1 = { hasMaxConnections: "accessibilityLabel", isBoostOnlySubscription: "r" };
      num4 = 7;
      intl = require("result").intl;
      obj2 = {};
      obj2.required = cost;
...
let closure_6 = result.createStyles({ container: { justifyContent: "space-between" }, inline: { "Null": false, "Null": false, "Bool(false)": false } });
