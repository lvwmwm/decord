...
// Dependencies: [19, 17, 21, 4285, 689, 712, 5317, 2]
// Exports: default

// Module 11839 (importDefaultResult1)
import "noop";
...
export default function GuildPowerupsCard(status) {
  ...
  obj[1] = jsx(require(5317) /* PressableCard */.Card, { border: "faint", radius: 16, shadow: "none" });
