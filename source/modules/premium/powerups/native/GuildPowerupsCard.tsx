...
// Dependencies: [19, 17, 21, 4303, 689, 712, 5376, 2]
// Exports: default

// Module 11926 (importDefaultResult1)
import "noop";
...
export default function GuildPowerupsCard(status) {
  ...
  obj[1] = jsx(require(5376) /* PressableCard */.Card, { border: "faint", radius: 16, shadow: "none" });
