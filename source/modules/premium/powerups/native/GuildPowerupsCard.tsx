...
// Dependencies: [19, 17, 21, 4255, 689, 712, 5302, 2]
// Exports: default

// Module 11811 (importDefaultResult1)
import "noop";
...
export default function GuildPowerupsCard(status) {
  ...
  obj[1] = jsx(require(5302) /* PressableCard */.Card, { border: "faint", radius: 16, shadow: "none" });
