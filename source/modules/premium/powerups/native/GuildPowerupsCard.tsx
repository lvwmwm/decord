...
// Dependencies: [19, 17, 21, 4285, 689, 712, 5356, 2]
// Exports: default

// Module 11845 (importDefaultResult1)
import "noop";
...
export default function GuildPowerupsCard(status) {
  ...
  obj[1] = jsx(require(5356) /* PressableCard */.Card, { border: "faint", radius: 16, shadow: "none" });
