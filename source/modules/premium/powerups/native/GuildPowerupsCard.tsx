...
// Dependencies: [19, 17, 21, 4302, 689, 712, 5375, 2]
// Exports: default

// Module 11860 (importDefaultResult1)
import "noop";
...
export default function GuildPowerupsCard(status) {
  ...
  obj[1] = jsx(require(5375) /* PressableCard */.Card, { border: "faint", radius: 16, shadow: "none" });
