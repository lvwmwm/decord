...
// Dependencies: [17, 21, 4255, 712, 4251, 11799, 11800, 1236, 2287, 11803, 2]
// Exports: default

// Module 11798 (Tier3OverrideNotice)
...
export default function GuildPowerupsNotificationContainer(guildId) {
  ...
  const tmp4 = importDefault(11799)(guildId);
  const tmp5 = importDefault(11800)(guildId);
  if (tmp4.shouldShow) {
