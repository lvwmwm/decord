...
// Dependencies: [17, 4277, 4173, 4174, 21, 4285, 712, 11772, 11769, 11792, 11793, 589, 11794, 3997, 11796, 4281, 11797, 11799, 11800, 4241, 1236, 2317, 11786, 11804, 4176, 8946, 11805, 11806, 11810, 11815, 11816, 4695, 11814, 5338, 2]
// Exports: default

// Module 11791 (GuildPowerupsBottomSheetHeader)
...
function GuildPowerupsBottomSheetHeader(arg0) {
  ...
  if (powerup.type === constants.LEVEL) {
    ...
    let tmp15 = callback(tmp2(11794), obj);
    let tmp14 = callback;
    ...
    obj1[1] = obj2;
    obj[1] = callback(tmp6(3997).GameServerHostingRive, obj1);
    ...
    obj3[1] = tmp.image;
    tmp14 = callback;
    tmp15 = callback(tmp2(11796), obj3);
  }
...
function GuildPowerupsBottomSheetFooter(arg0) {
  ...
  if (showConfigureButton) {
    ...
    if (!result) {
      result = tmp6(8946).canUseMobileServerTagSettings(guildId);
      const tmp6Result = tmp6(8946);
    }
  ...
  if (tmp4) {
    ...
    if (tmp14) {
      ...
      obj[2] = intl.string(tmp2(2317)["jo5++h"]);
