...
// Dependencies: [19, 17, 21, 4302, 712, 11853, 7733, 4298, 2]
// Exports: default

// Module 11852 (GuildPowerupsWarning)
import "noop";
...
export default function GuildPowerupsWarning(warnings) {
  ...
  if (tmp4.shouldShow) {
    ...
    let items = [callback(_require(7733).CircleErrorIcon, obj), , , ];
    const obj1 = { variant: "text-md/semibold", color: "text-feedback-warning", style: null, children: null };
    obj1[2] = tmp.text;
    obj1[3] = tmp5;
    items[1] = callback(_require(4298).Text, obj1);
