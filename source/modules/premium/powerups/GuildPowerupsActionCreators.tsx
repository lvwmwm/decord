...
// Dependencies: [4335, 676, 709, 12020, 4723, 530, 12021, 1471, 2]
...
// Module 12019 (guildPowerupsAckNotification)
...
export const fetchPowerupCatalogForGuild = function fetchPowerupCatalogForGuild(closure_0) {
  ...
  if (true === arg1) {
    const MOCK_LEVELS = _require(12020).MOCK_LEVELS;
    const combined = MOCK_LEVELS.concat(_require(12020).MOCK_PERKS);
    let obj = {};
    obj[constants.LEVEL] = _require(12020).MOCK_LEVELS;
    obj[constants.PERK] = _require(12020).MOCK_PERKS;
