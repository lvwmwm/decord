...
// Dependencies: [4332, 676, 709, 11968, 4708, 530, 11969, 1370, 2]
...
// Module 11967 (guildPowerupsAckNotification)
...
export const fetchPowerupCatalogForGuild = function fetchPowerupCatalogForGuild(closure_0) {
  ...
  if (true === arg1) {
    const MOCK_LEVELS = _require(11968).MOCK_LEVELS;
    const combined = MOCK_LEVELS.concat(_require(11968).MOCK_PERKS);
    let obj = {};
    obj[constants.LEVEL] = _require(11968).MOCK_LEVELS;
    obj[constants.PERK] = _require(11968).MOCK_PERKS;
