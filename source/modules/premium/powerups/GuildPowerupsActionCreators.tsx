...
// Dependencies: [4333, 676, 709, 11987, 4721, 530, 11988, 1370, 2]
...
// Module 11986 (guildPowerupsAckNotification)
...
export const fetchPowerupCatalogForGuild = function fetchPowerupCatalogForGuild(closure_0) {
  ...
  if (true === arg1) {
    const MOCK_LEVELS = _require(11987).MOCK_LEVELS;
    const combined = MOCK_LEVELS.concat(_require(11987).MOCK_PERKS);
    let obj = {};
    obj[constants.LEVEL] = _require(11987).MOCK_LEVELS;
    obj[constants.PERK] = _require(11987).MOCK_PERKS;
