...
// Dependencies: [4331, 676, 709, 12122, 4707, 530, 12123, 1370, 2]
...
// Module 12121 (guildPowerupsAckNotification)
...
export const fetchPowerupCatalogForGuild = function fetchPowerupCatalogForGuild(closure_0) {
  ...
  if (true === arg1) {
    const MOCK_LEVELS = _require(12122).MOCK_LEVELS;
    const combined = MOCK_LEVELS.concat(_require(12122).MOCK_PERKS);
    let obj = {};
    obj[constants.LEVEL] = _require(12122).MOCK_LEVELS;
    obj[constants.PERK] = _require(12122).MOCK_PERKS;
