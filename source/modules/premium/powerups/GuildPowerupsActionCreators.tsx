...
// Dependencies: [4190, 676, 709, 11783, 4539, 530, 11784, 1351, 2]
...
// Module 11782 (guildPowerupsAckNotification)
...
export const fetchPowerupCatalogForGuild = function fetchPowerupCatalogForGuild(closure_0) {
  ...
  if (true === arg1) {
    const MOCK_LEVELS = _require(11783).MOCK_LEVELS;
    const combined = MOCK_LEVELS.concat(_require(11783).MOCK_PERKS);
    let obj = {};
    obj[constants.LEVEL] = _require(11783).MOCK_LEVELS;
    obj[constants.PERK] = _require(11783).MOCK_PERKS;
