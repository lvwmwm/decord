...
// Dependencies: [1891, 3929, 4124, 4190, 5261, 1894, 4214, 4231, 4233, 4234, 11870, 11874, 15296, 4540, 4232, 11863, 11849, 4199, 2]

// Module 16442 (handleSelectedGuildChange)
    ...
    if (!obj12.isFavoritesGuildId(guildId)) {
      ...
      if (null != guild) {
        ...
        if (!tmp10Result.getHasAllocateBoostPermission(getUncachedChannelPermissions, guild)) {
          ...
          if (showCoachmark) {
            showCoachmark = importDefault(11863).getConfig({ location: "GuildPowerupsManager" }).showCoachmark;
            const obj8 = importDefault(11863);
          }
