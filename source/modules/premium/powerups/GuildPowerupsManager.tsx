...
// Dependencies: [1862, 3883, 4072, 4142, 5214, 1865, 4166, 4183, 4185, 4186, 11754, 11758, 15153, 4491, 4184, 11747, 11733, 4151, 2]

// Module 16290 (handleSelectedGuildChange)
    ...
    if (!obj12.isFavoritesGuildId(guildId)) {
      ...
      if (null != guild) {
        ...
        if (!tmp10Result.getHasAllocateBoostPermission(getUncachedChannelPermissions, guild)) {
          ...
          if (showCoachmark) {
            showCoachmark = importDefault(11747).getConfig({ location: "GuildPowerupsManager" }).showCoachmark;
            const obj8 = importDefault(11747);
          }
