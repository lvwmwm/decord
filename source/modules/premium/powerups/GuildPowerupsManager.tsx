...
// Dependencies: [1910, 3989, 4165, 4229, 5322, 1913, 4253, 4270, 4272, 4273, 11949, 11953, 15379, 4603, 4271, 11942, 11928, 4238, 2]

// Module 16535 (handleSelectedGuildChange)
    ...
    if (!obj12.isFavoritesGuildId(guildId)) {
      ...
      if (null != guild) {
        ...
        if (!tmp10Result.getHasAllocateBoostPermission(getUncachedChannelPermissions, guild)) {
          ...
          if (showCoachmark) {
            showCoachmark = importDefault(11942).getConfig({ location: "GuildPowerupsManager" }).showCoachmark;
            const obj8 = importDefault(11942);
          }
