...
// Dependencies: [1924, 676, 4233, 4235, 1377, 4236, 1236, 4271, 4272, 4273, 4274, 4255, 2]
// Exports: GUILD_FEATURE_TO_PERK

// Module 4232 (BoostedGuildTiers)
...
obj = { [require(4235).GUILD_POWERUP_LEVEL_1_SKU_ID]: BoostedGuildTiers.TIER_1, [require(4235).GUILD_POWERUP_LEVEL_2_SKU_ID]: BoostedGuildTiers.TIER_2, [require(4235).GUILD_POWERUP_LEVEL_3_SKU_ID]: BoostedGuildTiers.TIER_3 };
...
let obj2 = {
  boostPrice: 4,
  isEnabled(guildId) {
    const FileUploadPowerupHoldoutExperiment = require(4271) /* apexExperiment */.FileUploadPowerupHoldoutExperiment;
    ...
    if (!enabled) {
      fileUpload250MbPowerupEnabled = require(4272) /* experiment */.getFileUpload250MbPowerupEnabled(guildId, "GuildPowerupsConstants");
...
let obj3 = {
  boostPrice: 3,
  isEnabled(guildId) {
    let serverThemeUserEnabled = require(4273) /* apexExperiment */.getServerThemeUserEnabled("GuildPowerupsConstants");
    if (serverThemeUserEnabled) {
      serverThemeUserEnabled = require(4274) /* experiment */.getServerThemeEnabled(guildId, "GuildPowerupsConstants");
      const tmpResult = require(4274) /* experiment */;
    }
...
let obj4 = {
  boostPrice: 3,
  isEnabled(c0) {
    return require(4255) /* experiment */.getGameServerEnabled(c0, "GuildPowerupsConstants");
  }
};
...
const obj5 = { [require(4235).VANITY_URL_POWERUP_SKU_ID]: BoostedGuildTiers.TIER_3 };
...
export const PERK_SKU_BADGES = { [require(4233).GAME_SERVER_POWERUP_SKU_ID]: "beta", [require(4235).GUILD_POWERUP_MAX_FILE_SIZE_250_MB_SKU_ID]: "beta", [require(4235).GUILD_POWERUP_GUILD_THEME_SKU_ID]: "beta" };
...
export const GUILD_FEATURE_TO_PERK = () => {
  let obj = {};
  obj = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.STREAM, description: null };
  const intl = require(1236) /* getSystemLocale */.intl;
  obj[1] = intl.string(require(1236) /* getSystemLocale */.t.y4ft4D);
  obj[GuildFeatures.VIDEO_QUALITY_1080_60FPS] = obj;
  obj = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.AUDIO, description: null };
  ...
  const obj2 = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.CUSTOMIZATION, description: null };
  const intl3 = require(1236) /* getSystemLocale */.intl;
  obj2[1] = intl3.string(require(1236) /* getSystemLocale */.t.Qwlpov);
  obj[GuildFeatures.INVITE_SPLASH] = obj2;
  const obj3 = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.ANIMATED, description: null };
  const intl4 = require(1236) /* getSystemLocale */.intl;
  obj3[1] = intl4.string(require(1236) /* getSystemLocale */.t.PbAyub);
  obj[GuildFeatures.ANIMATED_ICON] = obj3;
  const obj4 = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.AUDIO, description: null };
  ...
  const obj6 = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.CUSTOM_ROLE_ICON, description: null };
  const intl6 = require(1236) /* getSystemLocale */.intl;
  obj6[1] = intl6.string(require(1236) /* getSystemLocale */.t["6PV6Qc"]);
  obj[GuildFeatures.ROLE_ICONS] = obj6;
  const obj7 = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.UPLOAD, description: null };
  ...
  const obj9 = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.CUSTOMIZATION, description: null };
  const intl9 = require(1236) /* getSystemLocale */.intl;
  obj9[1] = intl9.string(require(1236) /* getSystemLocale */.t["1a5rjl"]);
  obj[GuildFeatures.BANNER] = obj9;
  const obj10 = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.ANIMATED, description: null };
  ...
  const obj11 = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.AUDIO, description: null };
  ...
  const obj13 = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.VANITY, description: null };
  ...
  const obj14 = { perkIcon: require(4236) /* getGuildTierFromGuild */.PerkIcons.UPLOAD, description: null };
