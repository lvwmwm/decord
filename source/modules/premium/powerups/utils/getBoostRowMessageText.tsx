...
// Dependencies: [1236, 2335, 12002, 2]
// Exports: default

// Module 12007 (getBoostRowMessageText)
...
export default function getBoostRowMessageText(phase) {
  ...
  if ("gave" === phase) {
    ...
    if (endsAt == null) {
      const _Date = Date;
      endsAt = new Date(phase.sortKey + require(12002) /* BOOST_EXPIRING_DISPLAY_WINDOW_DAYS */.BOOST_EXPIRING_DISPLAY_WINDOW_MS);
    }
    const obj = { date: null };
    obj[0] = endsAt;
