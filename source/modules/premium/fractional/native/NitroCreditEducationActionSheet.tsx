...
// Dependencies: [17, 676, 21, 4344, 712, 5436, 7834, 4340, 1236, 1993, 2]
// Exports: default

// Module 12853 (NitroCreditEducationActionSheet)
...
export default function NitroCreditEducationActionSheet(children) {
  ...
  const obj2 = { style: tmp.aboutTextContainer, children: callback(require(4340) /* Text */.Text, { variant: "text-sm/medium", color: "text-overlay-light", children: children.aboutText }) };
