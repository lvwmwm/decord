...
// Dependencies: [17, 676, 21, 4342, 712, 5437, 7838, 4338, 1236, 1993, 2]
// Exports: default

// Module 12854 (NitroCreditEducationActionSheet)
...
export default function NitroCreditEducationActionSheet(children) {
  ...
  const obj2 = { style: tmp.aboutTextContainer, children: callback(require(4338) /* Text */.Text, { variant: "text-sm/medium", color: "text-overlay-light", children: children.aboutText }) };
