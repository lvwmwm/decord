...
export default function NitroCreditEducationActionSheet(children) {
  ...
  const obj2 = { style: tmp.aboutTextContainer, children: callback(require(4185) /* Text */.Text, { variant: "text-sm/medium", color: "text-overlay-light", children: children.aboutText }) };
