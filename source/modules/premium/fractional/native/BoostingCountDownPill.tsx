...
// Function ID: 12790
// Name: handlePress
// Dependencies: [17, 21, 4303, 712, 4271, 12790, 1988, 1236, 4299, 2]
// Exports: default

// Module 12789 (handlePress)
...
function handlePress() {
  ...
  obj.openLazy(require(1988) /* asyncRequireImpl */(12790, dependencyMap.paths), "NitroCreditEducationActionSheet", obj);
}
...
export default function BoostingCountDownPill(style) {
  ...
  if (!isInReverseTrial) {
    ...
    obj[1] = tmp2(require(4299) /* Text */.Text, obj1);
  ...
  obj2[1] = closure_5(require(4299) /* Text */.Text, obj3);
