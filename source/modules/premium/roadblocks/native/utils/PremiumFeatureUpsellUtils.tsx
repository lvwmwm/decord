...
// Dependencies: [4819, 8443, 691, 38, 2]
// Exports: getUpsellType, isSoundboardSectionNitroLocked

// Module 8746 (isSoundboardSectionNitroLocked)
...
export const isSoundboardSectionNitroLocked = function isSoundboardSectionNitroLocked(guild_id, categoryInfo) {
  let tmp = categoryInfo.type === require(4819) /* SoundButtonOverlay */.SoundboardSoundGridSectionType.GUILD;
  if (tmp) {
...
export const getUpsellType = function getUpsellType(featureName) {
  if (require(8443) /* EntitlementFeatureNames */.EntitlementFeatureNames.ANIMATED_EMOJIS === featureName) {
