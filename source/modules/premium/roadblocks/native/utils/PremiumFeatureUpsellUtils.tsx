...
// Dependencies: [4585, 8038, 668, 44, 2]
// Exports: getUpsellType, isSoundboardSectionNitroLocked

// Module 8044 (isSoundboardSectionNitroLocked)
...
export const getUpsellType = function getUpsellType(featureName) {
  if (require(8038) /* EntitlementFeatureNames */.EntitlementFeatureNames.ANIMATED_EMOJIS === featureName) {
    return require(668) /* keys */.UpsellTypes.ANIMATED_EMOJI;
  } else if (require(8038) /* EntitlementFeatureNames */.EntitlementFeatureNames.EMOJIS_EVERYWHERE === featureName) {
    return require(668) /* keys */.UpsellTypes.GLOBAL_EMOJI;
  } else if (require(8038) /* EntitlementFeatureNames */.EntitlementFeatureNames.INCREASED_FILE_UPLOAD_SIZE === featureName) {
    return require(668) /* keys */.UpsellTypes.UPLOAD;
  } else if (require(8038) /* EntitlementFeatureNames */.EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE === featureName) {
    return require(668) /* keys */.UpsellTypes.SOUNDBOARD;
  } else if (require(8038) /* EntitlementFeatureNames */.EntitlementFeatureNames.CLIENT_THEMES === featureName) {
    return require(668) /* keys */.UpsellTypes.CLIENT_THEMES;
  } else if (require(8038) /* EntitlementFeatureNames */.EntitlementFeatureNames.APP_ICONS === featureName) {
    return require(668) /* keys */.UpsellTypes.APP_ICONS;
  } else if (require(8038) /* EntitlementFeatureNames */.EntitlementFeatureNames.SAVED_MESSAGES === featureName) {
    return require(668) /* keys */.UpsellTypes.FOR_LATER;
  } else if (require(8038) /* EntitlementFeatureNames */.EntitlementFeatureNames.STREAM_HIGH_QUALITY === featureName) {
