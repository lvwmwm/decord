...
// Dependencies: [4756, 8373, 691, 38, 2]
// Exports: getUpsellType, isSoundboardSectionNitroLocked

// Module 8683 (isSoundboardSectionNitroLocked)
...
export const getUpsellType = function getUpsellType(featureName) {
  if (require(8373) /* EntitlementFeatureNames */.EntitlementFeatureNames.ANIMATED_EMOJIS === featureName) {
