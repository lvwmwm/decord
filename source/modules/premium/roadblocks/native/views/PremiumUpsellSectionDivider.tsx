...
// Dependencies: [19, 17, 7039, 21, 4380, 712, 8853, 4826, 691, 4925, 2]
// Exports: default

// Module 8852 (PremiumUpsellSectionDivider)
import noopAll from "noop" /* 19 */;
import keys from "keys" /* 691 */;
import ThemesDefault from "Themes" /* 712 */;
import LinearGradientDefault from "LinearGradient" /* 4826 */;
import LockIcon2 from "LockIcon" /* 4925 */;
...
export default function PremiumUpsellSectionDivider(arg0) {
  ...
  if (position !== createCacheKey.START) {
    ...
    obj2 = tmp3(tmp4(4826), obj2);
    obj1[1] = obj2;
    tmp3(tmp2, obj1);
    const tmp4Result = tmp4(4826);
  }
};
