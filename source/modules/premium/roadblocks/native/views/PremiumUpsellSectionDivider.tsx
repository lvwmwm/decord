...
// Dependencies: [19, 17, 6790, 21, 4255, 712, 8600, 4676, 691, 4774, 2]
// Exports: default

// Module 8599 (PremiumUpsellSectionDivider)
import "noop";
...
export default function PremiumUpsellSectionDivider(arg0) {
  ...
  obj = { style: lock.gradient, children: callback(require(8600) /* PremiumUpsellGradientBackground */.PremiumUpsellGradientBackground, { useTier0UpsellContent }) };
  ...
  items[1] = callback(importDefault(4676), obj);
  if (position !== createCacheKey.START) {
    ...
    LockIcon = LockIcon(4774).LockIcon;
    ...
    obj2 = tmp3(tmp4(4676), obj2);
    obj1[1] = obj2;
    tmp3(tmp2, obj1);
    const tmp4Result = tmp4(4676);
  }
};
