...
// Dependencies: [19, 17, 1876, 676, 6793, 21, 8171, 3901, 1236, 4255, 712, 8161, 8177, 8169, 8178, 1297, 9563, 9564, 4251, 4677, 691, 4665, 4669, 5581, 9565, 8453, 4116, 698, 8751, 2]
// Exports: default

// Module 9562 (PremiumFeatureUpsellPill)
...
function PremiumFeatureUpsellPill(featureName) {
  ...
  let dependencyMap;
  let loading;
  let obj = featureName(8161);
  let obj1 = featureName(8177);
  ...
  if (featureName(8171).EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE === featureName) {
  ...
  const tmp10 = useTier0UpsellContent(8178)(useTier0UpsellContent, premiumUpsellConfig.onViewAllPerks, constants.PREMIUM_UPSELL_FILE_UPLOAD);
  ...
  obj6[0] = useTier0UpsellContent(useTier0UpsellContent ? 9563 : 9564);
