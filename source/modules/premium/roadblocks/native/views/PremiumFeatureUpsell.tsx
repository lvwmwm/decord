...
// Dependencies: [19, 17, 1924, 676, 6943, 21, 8421, 4007, 1236, 4342, 712, 8410, 8732, 8418, 8777, 1297, 8778, 8779, 4338, 4766, 691, 4754, 4758, 5768, 8780, 8781, 4083, 698, 8708, 2]
// Exports: default

// Module 8776 (PremiumFeatureUpsellPill)
...
function PremiumFeatureUpsellPill(featureName) {
  ...
  let dependencyMap;
  let loading;
  let obj = featureName(8410);
  let obj1 = featureName(8732);
  ...
  if (featureName(8421).EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE === featureName) {
  ...
  const tmp10 = useTier0UpsellContent(8777)(useTier0UpsellContent, premiumUpsellConfig.onViewAllPerks, constants.PREMIUM_UPSELL_FILE_UPLOAD);
  ...
  obj6[0] = useTier0UpsellContent(useTier0UpsellContent ? 8778 : 8779);
