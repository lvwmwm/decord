...
// Dependencies: [19, 17, 21, 4303, 712, 1628, 691, 8733, 8378, 2]
// Exports: default

// Module 16170 (PremiumSoundboardFeatureUpsell)
import "noop";
...
export default function PremiumSoundboardFeatureUpsell(shouldShow) {
  ...
  obj[1] = require(8378) /* EntitlementFeatureNames */.EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE;
  obj[1] = jsx(importDefault(8733), { shouldShow: shouldShow.shouldShow, featureName: null });
