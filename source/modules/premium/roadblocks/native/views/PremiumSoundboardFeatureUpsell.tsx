...
// Dependencies: [19, 17, 21, 4344, 712, 1628, 691, 8772, 8417, 2]
// Exports: default

// Module 16227 (PremiumSoundboardFeatureUpsell)
import "noop";
...
export default function PremiumSoundboardFeatureUpsell(shouldShow) {
  ...
  obj[1] = require(8417) /* EntitlementFeatureNames */.EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE;
  obj[1] = jsx(importDefault(8772), { shouldShow: shouldShow.shouldShow, featureName: null });
