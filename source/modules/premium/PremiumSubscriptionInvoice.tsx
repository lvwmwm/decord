...
async function _getSubscriptionInvoice(arg0, arg1) {
  const fn = function*(arg0) {
    ...
    if (preventFetch) {
      ...
      const HTTP = callback(closure_2[7]).HTTP;
      const obj = { y: 1567300603, isArray: 221342020, accessible: 822948183, url: closure_12.BILLING_SUBSCRIPTION_INVOICE(subscriptionId) };
...
let closure_3 = [0.];
