        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              const result = callback(3835).coerceExistingItemsToNewItemInterval(callback);
              callback = result;
            ...
            c4 = 0;
            constants = c3;
            const billingError = new callback(4088).BillingError(constants);
            throw billingError;
          } else if (arg0 === 1) {
            c6 = 3;
            throw arg1;
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            c4 = 0;
            let closure_13 = c3;
            const billingError = new callback(4088).BillingError(closure_13);
            throw billingError;
          } else if (arg0 === 1) {
            c6 = 3;
            throw arg1;
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            c4 = 0;
            let closure_8 = c3;
            const billingError = new callback(4088).BillingError(closure_8);
            throw billingError;
          } else if (arg0 === 1) {
            c6 = 3;
            throw arg1;
