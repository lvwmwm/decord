...
export const useShouldShowInlineGuildCapUpsell = function useShouldShowInlineGuildCapUpsell() {
  ...
  const items1 = [require(5874) /* HotspotStore */.HotspotStore];
  const stateFromStores1 = require(589) /* initialize */.useStateFromStores(items1, () => {
    const HotspotStore = callback(5874).HotspotStore;
    return HotspotStore.hasHotspot(callback(5874).HotspotLocations.GUILD_CAP_INLINE_UPSELL);
  });
...
export const hideInlineGuildCapUpsell = function hideInlineGuildCapUpsell() {
  require(5874) /* HotspotStore */.hideHotspot(require(5874) /* HotspotStore */.HotspotLocations.GUILD_CAP_INLINE_UPSELL);
};
