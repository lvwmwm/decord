...
// Function ID: 96262
// Name: PillText
// Dependencies: [653, 33, 4131, 689, 12400, 4555, 4127, 2]
// Exports: default

// Module 12399 (PillText)
...
export default function PillText(arg0) {
  ...
  ({ pillText, style } = arg0);
  const tmp = callback();
  let obj = { style: items, start: HorizontalGradient.START, end: HorizontalGradient.END, colors: importDefault(12400)() };
  items = [tmp.pillTextContainer, style];
  const tmp2 = importDefault(12400)();
