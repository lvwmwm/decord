...
// Function ID: 6811
// Name: LinkButton
// Dependencies: [19, 21, 4302, 4844, 4298, 2]
// Exports: LinkButton

// Module 6810 (LinkButton)
import "noop";
...
export const LinkButton = function LinkButton(textColor) {
  ...
  const items1 = [callback(require(4298) /* Text */.Text, { style: textStyle, variant, color: str, children: text }), textColor.iconRight];
  obj[6] = items1;
  return closure_3(require(4844) /* PressableBase */.PressableOpacity, obj);
};
