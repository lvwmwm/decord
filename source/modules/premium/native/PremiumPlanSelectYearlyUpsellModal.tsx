...
// Dependencies: [32, 19, 17, 1995, 6092, 13422, 1923, 502, 21, 4478, 5469, 5392, 7161, 586, 1896, 4947, 13432, 1296, 1233, 4139, 4928, 2]
// Exports: default

// Module 13431 (PremiumPlanSelectYearlyUpsellModal)
import componentDidMountDefault from "componentDidMount" /* 4947 */;
import createTextStyleDefault from "createTextStyle" /* 5469 */;
import registerAssetDefault from "registerAsset" /* 13432 */;
import closure_3 from "_slicedToArray" /* 32 */;
import closure_4 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import closure_7 from "_getSystemLocale" /* 1995 */;
import closure_8 from "updateProduct" /* 6092 */;
import { usePremiumPlanSelectStore } from "usePremiumPlanSelectStore" /* 13422 */;
import { PREMIUM_YEARLY_DISCOUNT_PERCENT as closure_10 } from "GuildFeatures" /* 1923 */;
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj2[2] = intl.format(tmp5(1233).t.LQCVfK, obj3);
    items2[1] = callback2(tmp5(1296).LegacyText, obj2);
    const obj4 = { style: null, children: null };
    obj4[0] = tmp.description;
    const intl2 = tmp5(1233).intl;
    const obj5 = { discountPercentage: null };
    obj5[0] = formatPercentResult;
    obj4[1] = intl2.format(tmp5(1233).t["7chOVL"], obj5);
    items2[2] = callback2(tmp5(1296).LegacyText, obj4);
    ...
    obj7[1] = intl3.formatToPlainString(tmp5(1233).t.Qvq6GE, obj8);
    ...
    obj6[1] = callback2(tmp5(4928).Button, obj7);
    ...
    obj10[1] = intl4.string(tmp5(1233).t.YwEyQM);
    ...
    obj9[1] = callback2(tmp5(4928).Button, obj10);
    ...
    obj12[1] = intl5.string(tmp5(1233).t.cpT0Cq);
    obj12[2] = onClose;
    obj11[1] = callback2(tmp5(4928).Button, obj12);
