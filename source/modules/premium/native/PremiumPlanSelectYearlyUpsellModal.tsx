...
// Dependencies: [32, 19, 17, 1994, 5319, 12974, 1924, 505, 21, 4661, 6782, 6289, 7378, 589, 1898, 4763, 12984, 1297, 1236, 4039, 4745, 2]
// Exports: default

// Module 12983 (PremiumPlanSelectYearlyUpsellModal)
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj6[1] = callback2(tmp5(4745).Button, obj7);
    ...
    obj9[1] = callback2(tmp5(4745).Button, obj10);
    ...
    obj12[2] = onClose;
    obj11[1] = callback2(tmp5(4745).Button, obj12);
