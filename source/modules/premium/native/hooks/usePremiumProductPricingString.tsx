...
// Dependencies: [7177, 1923, 4139, 7180, 586, 2]
// Exports: default

// Module 10681 (usePremiumProductPricingString)
...
export default function usePremiumProductPricingString(closure_0, YEAR) {
  ...
  _require = _require(7180).getProductIdForGift(planIdForPremiumType);
  const obj2 = _require(7180);
