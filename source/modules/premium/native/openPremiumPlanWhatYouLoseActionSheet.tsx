...
export default function openPremiumPlanWhatYouLoseActionSheet(arg0) {
  ...
  importDefault(4253).openLazy(require(1988) /* asyncRequireImpl */(7542, dependencyMap.paths), "PremiumPlanWhatYouLoseActionSheet", arg0);
};
