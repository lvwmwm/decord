...
// Dependencies: [19, 17, 676, 21, 4342, 712, 12862, 12866, 12867, 12868, 4249, 4234, 12029, 4338, 2]
// Exports: default

// Module 12861 (BoostedGuildTierProgressCircle)
import "noop";
...
export default function BoostedGuildTierProgressCircle(arg0) {
  ...
  if (null == guild) {
    ...
    obj[0] = require(12862) /* getTier048PxSource */.getTier048PxSource(theme);
    ...
    if (null != guild) {
      if (guild.premiumTier !== constants.NONE) {
        ...
        if (tmp13.TIER_1 === premiumTier) {
          let tier048PxSource = tmp2(12866);
        } else if (tmp13.TIER_2 === premiumTier) {
          tier048PxSource = tmp2(12867);
        } else if (tmp13.TIER_3 === premiumTier) {
          tier048PxSource = tmp2(12868);
        }
      }
