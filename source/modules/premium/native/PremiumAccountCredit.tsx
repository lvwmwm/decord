...
// Dependencies: [19, 17, 5357, 676, 21, 4661, 712, 4039, 1236, 2917, 7149, 4734, 589, 12, 2]
// Exports: default
...
function AccountCreditTier(arg0) {
  ...
  obj2[0] = require(7149) /* GameIcon */.GameIconSizes.SMALL;
  obj2[1] = result;
  const items1 = [callback(importDefault(7149), obj2), , ];
  ...
  const items2 = [callback(require(4734) /* Text */.Text, obj4), ];
  ...
  items1[2] = callback(require(4734) /* Text */.Text, obj6);
  obj1[1] = items1;
