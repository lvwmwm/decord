...
// Dependencies: [19, 17, 7332, 673, 21, 4481, 709, 4139, 1233, 3016, 7112, 4477, 586, 12, 2]
// Exports: default

// Module 13276 (AccountCreditTier)
...
import closure_4 from "addEntitlement" /* 7332 */;
...
function AccountCreditTier(arg0) {
  ...
  if (!(null != currentSubscription && currentSubscription.isPurchasedExternally)) {
    ...
    obj5[0] = tmp.subText;
    obj5[3] = stringResult;
    tmp21Result = tmp21(tmp2(4477).Text, obj5);
  }
    ...
    if (obj8.hasAccountCredit(entitlements)) {
      ...
      if (null != currentSubscription) {
        ...
        if (currentSubscription.isPurchasedExternally) {
          ...
          tmp9Result = callback(tmp2(4477).Text, obj3);
        }
      }
      items1[3] = tmp9Result;
      obj[1] = items1;
