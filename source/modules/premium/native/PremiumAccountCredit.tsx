...
// Dependencies: [19, 17, 6755, 676, 21, 4255, 712, 3901, 1236, 2837, 5605, 4251, 589, 12, 2]
// Exports: default

// Module 7531 (AccountCreditTier)
import "noop";
...
function AccountCreditTier(arg0) {
  ...
  obj2[0] = require(5605) /* GameIcon */.GameIconSizes.SMALL;
  obj2[1] = result;
  const items1 = [callback(importDefault(5605), obj2), , ];
