...
// Dependencies: [19, 17, 6782, 676, 21, 4285, 712, 3930, 1236, 2866, 5659, 4281, 589, 12, 2]
// Exports: default
...
function AccountCreditTier(arg0) {
  ...
  obj2[0] = require(5659) /* GameIcon */.GameIconSizes.SMALL;
  obj2[1] = result;
  const items1 = [callback(importDefault(5659), obj2), , ];
