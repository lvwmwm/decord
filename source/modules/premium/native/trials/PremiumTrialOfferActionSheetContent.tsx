// Module ID: 15093
// Function ID: 15094
// Dependencies: [19, 17, 21, 4342, 712, 11291, 1236, 10505, 4866, 6091, 4338, 4007, 15094, 4777, 7770, 2]
...
const memoResult = require("noop").memo(function PremiumTrialOfferActionSheetContent(onConfirm) {
  ...
  let obj = { IconComponent: require(11291) /* UserIcon */.UserIcon, label: null, description: null };
  ...
  const items = [obj, , ];
  obj = { IconComponent: require(10505) /* ChatSmileIcon */.ChatSmileIcon, label: null, description: null };
  ...
  items[1] = obj;
  obj = { IconComponent: require(4866) /* FolderIcon */.FolderIcon, label: null, description: null };
  ...
  const items1 = [callback(View, { style: tmp.heroIllustrationContainer, children: callback(require(6091) /* AccountAgeTier10LargeBadge */.NitroWumpusFlightRight3dIllustration, { width: 180, height: 180 }) }), , , ];
  ...
  items1[2] = callback(importDefault(15094), { perks: items });
  ...
  obj5[4] = callback(require(7770) /* NitroWheelIcon */.NitroWheelIcon, obj6);
