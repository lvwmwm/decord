// Module ID: 14885
// Function ID: 14886
// Dependencies: [19, 17, 21, 4255, 712, 11108, 1236, 10413, 4754, 5921, 4251, 3901, 14886, 4665, 7597, 2]
...
const memoResult = require("noop").memo(function PremiumTrialOfferActionSheetContent(onConfirm) {
  ...
  let obj = { IconComponent: require(11108) /* UserIcon */.UserIcon, label: null, description: null };
  ...
  const items = [obj, , ];
  obj = { IconComponent: require(10413) /* ChatSmileIcon */.ChatSmileIcon, label: null, description: null };
  ...
  items[1] = obj;
  obj = { IconComponent: require(4754) /* FolderIcon */.FolderIcon, label: null, description: null };
  ...
  const items1 = [callback(View, { style: tmp.heroIllustrationContainer, children: callback(require(5921) /* AccountAgeTier10LargeBadge */.NitroWumpusFlightRight3dIllustration, { width: 180, height: 180 }) }), , , ];
  ...
  if (null != sku_id) {
    ...
    displayNameFromSku = tmp3(3901).getDisplayNameFromSku(sku_id1);
    const tmp3Result = tmp3(3901);
  }
  ...
  items1[2] = callback(importDefault(14886), { perks: items });
  ...
  obj5[4] = callback(require(7597) /* NitroWheelIcon */.NitroWheelIcon, obj6);
  obj4[1] = callback(require(4665) /* Button */.Button, obj5);
