...
const memoResult = require("noop").memo(function PremiumTrialOfferActionSheetContent(onConfirm) {
  ...
  items[1] = obj;
  obj = { IconComponent: require(4689) /* FolderIcon */.FolderIcon, label: null, description: null };
  ...
  if (null != sku_id) {
    ...
    displayNameFromSku = tmp3(3835).getDisplayNameFromSku(sku_id1);
    const tmp3Result = tmp3(3835);
  }
