...
// Dependencies: [32, 19, 17, 4349, 21, 4303, 712, 589, 10424, 5734, 10119, 7016, 1949, 9380, 10136, 5328, 5848, 9404, 5738, 9381, 4503, 1297, 9452, 9559, 10163, 10432, 4299, 1236, 4538, 4714, 4509, 2]
// Exports: default

// Module 10436 (GiftCodeRedeemSuccess)
...
export default function GiftCodeRedeemSuccess(giftCode) {
  ...
  let obj3 = giftCode(10119);
  let obj4 = giftCode(7016);
  let skuId = null;
  ...
  if (type === giftCode(1949).CollectiblesItemType.BUNDLE) {
    if (null != product) {
      ...
      if (tmp20Result) {
        ...
        obj8[6] = tmp15;
        tmp20Result = tmp20(user(9381), obj8);
      }
      obj7[2] = tmp20Result;
