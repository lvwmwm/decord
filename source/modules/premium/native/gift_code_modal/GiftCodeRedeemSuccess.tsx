...
// Dependencies: [32, 19, 17, 4330, 21, 4285, 712, 589, 10333, 5616, 10029, 6922, 1901, 9292, 10046, 5272, 5757, 9316, 5620, 9293, 4484, 1297, 9364, 9472, 10073, 10341, 4281, 1236, 4519, 4695, 4490, 2]
// Exports: default

// Module 10345 (GiftCodeRedeemSuccess)
  ...
  if (null == first) {
    if (null != getOrFetchApplication) {
      if (tmp2Result1.isGameItemSKU(stateFromStores)) {
        ...
        obj5[1] = tmp2(5620).GameIconSizes.LARGE;
        obj5[2] = giftCode.skuId;
        tmp24Result = tmp24(user(5620), obj5);
        const tmp26 = user(5620);
      }
      tmp2Result1 = tmp2(5757);
    }
  }
  if (type === giftCode(1901).CollectiblesItemType.BUNDLE) {
    ...
    if (tmp2Result3.isGameItemSKU(stateFromStores)) {
      ...
      if (null != first) {
        ...
        obj1[2] = items2;
        return tmp17(tmp2(5272).SafeAreaPaddingView, obj1);
      }
