...
// Dependencies: [19, 10411, 1903, 21, 5270, 4509, 10416, 10430, 10431, 589, 10417, 5783, 2]
// Exports: default

// Module 10415 (GiftCodeRedeemModal)
import "noop";
...
export default function GiftCodeRedeemModal(code) {
  ...
  const tmp6 = importDefault(10417)(code, stateFromStores1);
  if (null == stateFromStores1) {
    ...
    obj[1] = tmp2Result.getHeaderCloseButton(() => callback(4509).pop());
    ...
    obj1[1] = tmp2Result.getHeaderCloseButton(() => callback(4509).pop());
    ...
    obj2[2] = function render(arg0) {
      const merged = Object.assign(arg0);
      return callback2(callback(10431), {});
    };
    obj[obj.ERROR] = obj2;
    if (null == stateFromStores) {
      ...
      obj3[1] = items3;
      jsx(tmp2(5783).Navigator, { screens: null, initialRouteStack: null });
      const tmp7 = jsx;
    }
    const tmp2Result1 = tmp2(5270);
  }
};
