...
export default function GiftCodeRedeemModal(code) {
  ...
  if (null == stateFromStores1) {
    ...
    obj[1] = tmp2Result.getHeaderCloseButton(() => callback(4395).pop());
    ...
    obj1[1] = tmp2Result.getHeaderCloseButton(() => callback(4395).pop());
    ...
    if (null == stateFromStores) {
      ...
      obj3[1] = items3;
      jsx(tmp2(5570).Navigator, { screens: null, initialRouteStack: null });
      const tmp7 = jsx;
    }
    const tmp2Result1 = tmp2(5143);
  }
};
