...
// Dependencies: [19, 10298, 1874, 21, 5223, 4460, 10303, 10317, 10318, 589, 10304, 5650, 2]
// Exports: default

// Module 10302 (GiftCodeRedeemModal)
import "noop";
...
export default function GiftCodeRedeemModal(code) {
  ...
  const tmp6 = importDefault(10304)(code, stateFromStores1);
