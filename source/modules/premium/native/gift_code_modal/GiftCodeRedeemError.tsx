...
// Dependencies: [19, 17, 21, 4302, 712, 1481, 5327, 10366, 10367, 4298, 1236, 4712, 4507, 2]
// Exports: default

// Module 10365 (GiftCodeRedeemError)
import "noop";
...
export default function GiftCodeRedeemError(children) {
  ...
  items[1] = closure_6(require(4298) /* Text */.Text, obj1);
  items[2] = closure_6(require(4298) /* Text */.Text, { variant: "text-lg/medium", style: tmp.message, children: children.message });
  obj[2] = items;
  ...
  obj3[1] = closure_6(require(4712) /* Button */.Button, obj4);
  items1[1] = closure_6(closure_4, obj3);
  obj[2] = items1;
  return closure_7(require(5327) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
};
