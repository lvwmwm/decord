...
// Dependencies: [19, 17, 1923, 7366, 21, 4481, 7367, 7368, 4139, 4948, 688, 5542, 7369, 7370, 7371, 7372, 9314, 10644, 9319, 2]
// Exports: default

// Module 7365 (PremiumPlanActionSheetHeader)
...
export default function PremiumPlanActionSheetHeader(arg0) {
  ...
  if (!tmp13Result) {
    ...
    tmp13Result = tmp13(5542);
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result1 = tmp13(7369);
    } else if (tmp15.TIER_1 === premiumType) {
      tmp13Result1 = tmp13(7370);
    } else if (tmp15.TIER_2 === premiumType) {
      tmp13Result1 = tmp13(7371);
    }
    ...
    if (tmp2) {
      ...
      obj2[1] = trialOffer;
      obj2[2] = premiumType;
      tmp22Result = tmp22(tmp6(7372).PremiumPill, obj2);
    }
    ...
    if (tmp10) {
      ...
      obj3[2] = premiumType;
      tmp22Result = tmp22(tmp6(7372).PremiumPill, obj3);
    }
    items1[2] = tmp22Result;
    obj[1] = items1;
    items[1] = tmp12(View, obj);
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result3 = tmp13(9314);
    } else if (tmp15.TIER_1 === premiumType) {
      tmp13Result3 = tmp13(10644);
    } else if (tmp15.TIER_2 === premiumType) {
      tmp13Result3 = tmp13(9319);
    }
    ...
    tmp13Result2 = tmp13(5542);
    const tmp21 = View;
  } else {
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result5 = tmp13(7367);
    } else {
      tmp13Result5 = null;
      if (tmp15.TIER_1 !== premiumType) {
        if (tmp15.TIER_2 === premiumType) {
          tmp13Result5 = tmp13(7368);
        }
      }
    }
    const obj5 = { source: null };
    obj5[0] = tmp13Result5;
    closure_7(tmp13(5542), obj5);
    const tmp13Result4 = tmp13(5542);
