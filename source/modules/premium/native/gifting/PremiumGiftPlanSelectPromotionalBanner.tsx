// Module ID: 9963
// Function ID: 9964
// Dependencies: [19, 17, 21, 4285, 712, 7282, 9960, 4706, 5251, 4281, 1236, 9964, 2]
...
const memoResult = require("noop").memo(function PremiumGiftPlanSelectPromotionalBanner(giftPlanSelectionCardBannerComponent) {
  ...
  let obj1 = require(9960) /* useThemeAndReducedMotionAwareAssetUrl */;
  ...
  if (tmp12Result) {
    let logoLargeTilted = giftPlanSelectionCardBannerComponent.assetVariant === require(7282) /* create */.GiftPlanSelectionCardBanner_AssetVariant.LARGE_TILTED;
