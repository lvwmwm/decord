// Module ID: 9979
// Function ID: 9980
// Dependencies: [19, 17, 21, 4302, 712, 7301, 9976, 4723, 5267, 4298, 1236, 9980, 2]
...
const memoResult = require("noop").memo(function PremiumGiftPlanSelectPromotionalBanner(giftPlanSelectionCardBannerComponent) {
  ...
  let obj = require(9976) /* useThemeAndReducedMotionAwareAssetUrl */;
  ...
  let obj1 = require(9976) /* useThemeAndReducedMotionAwareAssetUrl */;
  ...
  if (tmp12Result) {
    let logoLargeTilted = giftPlanSelectionCardBannerComponent.assetVariant === require(7301) /* create */.GiftPlanSelectionCardBanner_AssetVariant.LARGE_TILTED;
  ...
  items[2] = tmp12Result;
  obj[6] = items;
  return closure_5(importDefault(4723), obj);
});
