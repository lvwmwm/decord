// Module ID: 10045
// Function ID: 10046
// Dependencies: [19, 17, 21, 4303, 712, 7361, 10042, 4725, 5268, 4299, 1236, 10046, 2]
...
const memoResult = require("noop").memo(function PremiumGiftPlanSelectPromotionalBanner(giftPlanSelectionCardBannerComponent) {
  ...
  let obj = require(10042) /* useThemeAndReducedMotionAwareAssetUrl */;
  ...
  let obj1 = require(10042) /* useThemeAndReducedMotionAwareAssetUrl */;
  ...
  items[2] = tmp12Result;
  obj[6] = items;
  return closure_5(importDefault(4725), obj);
});
