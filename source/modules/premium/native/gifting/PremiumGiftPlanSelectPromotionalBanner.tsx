// Module ID: 10683
// Function ID: 10684
// Dependencies: [19, 17, 21, 4481, 709, 10610, 10680, 4948, 5542, 4477, 1233, 10684, 2]
...
import create from "create" /* 10610 */;
...
const memoResult = importAllResult.memo(function PremiumGiftPlanSelectPromotionalBanner(giftPlanSelectionCardBannerComponent) {
  ...
  if (tmp12Result) {
    ...
    obj6[1] = tmp12(tmp7(10684), obj7);
    tmp12Result = tmp12(View, obj6);
    const tmp7Result = tmp7(10684);
  }
  items[2] = tmp12Result;
  obj[6] = items;
