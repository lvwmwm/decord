...
// Dependencies: [32, 19, 1903, 21, 7295, 4285, 712, 589, 9274, 1236, 5253, 9953, 10029, 10032, 10037, 2380, 10076, 9951, 5669, 5649, 5637, 514, 4490, 3943, 9497, 9529, 10080, 5704, 2]
// Exports: default

// Module 9952 (PremiumGiftModal)
...
export default function PremiumGiftModal(analyticsLocations) {
  ...
  const tmp3 = importDefault(5637)(() => recipientUserId(_undefined2[21]).v4());
  callback = tmp3;
  let obj = c4;
  ...
  if (initialRoute != null) {
    ...
    if (tmp11Result6.isPremiumGiftingSupported()) {
      ...
      obj7[0] = importDefault(5649)(analyticsLocations).analyticsLocations;
