...
// Function ID: 10165
// Name: RewardPreview
// Dependencies: [19, 17, 8839, 7054, 1947, 1922, 7388, 676, 21, 4342, 712, 5409, 9440, 1946, 1297, 4338, 1236, 4766, 10165, 1499, 9660, 589, 7466, 7692, 7406, 10089, 9627, 8835, 7419, 10079, 10160, 10087, 5308, 7796, 9721, 10094, 5788, 1993, 4755, 4205, 2]
// Exports: default
...
function RewardPreview(arg0) {
  ...
  const tmp3 = callback3(importDefault(5409)().insets.bottom);
...
export default function PremiumGiftPurchaseButton(defaultSelection) {
  ...
  let c9;
  let c10;
  let tmp3 = callback3(importDefault(5409)().insets.bottom);
  ...
  c9 = tmp10;
  const tmp11 = importDefault(10089)();
  let tmp12 = tmp11;
  if (tmp11) {
