...
// Function ID: 10165
// Name: RewardPreview
// Dependencies: [19, 17, 8835, 7048, 1947, 1922, 7384, 676, 21, 4344, 712, 5408, 9436, 1946, 1297, 4340, 1236, 4765, 10165, 1499, 9656, 589, 7462, 7688, 7402, 10091, 9623, 8831, 7415, 10081, 10160, 10089, 5307, 7792, 9717, 10094, 5787, 1993, 4754, 4207, 2]
// Exports: default

// Module 10164 (RewardPreview)
...
function RewardPreview(arg0) {
  ...
  const tmp3 = callback3(importDefault(5408)().insets.bottom);
  if (isNameplateRecord(collectiblesItem)) {
    ...
    if (isAvatarDecorationRecord(collectiblesItem)) {
      ...
      items1[2] = callback(require(4340) /* Text */.Text, obj8);
      obj5[0] = items1;
...
export default function PremiumGiftPurchaseButton(defaultSelection) {
  ...
  let c9;
  let c10;
  let tmp3 = callback3(importDefault(5408)().insets.bottom);
  ...
  c9 = tmp10;
  const tmp11 = importDefault(10091)();
  let tmp12 = tmp11;
  if (tmp11) {
