...
// Function ID: 10052
// Name: RewardPreview
// Dependencies: [19, 17, 8730, 6946, 1928, 1903, 7284, 676, 21, 4302, 712, 5368, 9325, 1927, 1297, 4298, 1236, 4723, 10052, 1480, 9546, 589, 7361, 7587, 7302, 9978, 9513, 8726, 7314, 9968, 10047, 9976, 5267, 7691, 9607, 9981, 5688, 1974, 4712, 4160, 2]
// Exports: default

// Module 10051 (RewardPreview)
...
function RewardPreview(arg0) {
  ...
  const tmp3 = callback3(importDefault(5368)().insets.bottom);
  if (isNameplateRecord(collectiblesItem)) {
    ...
    if (isAvatarDecorationRecord(collectiblesItem)) {
      ...
      items1[2] = callback(require(4298) /* Text */.Text, obj8);
      obj5[0] = items1;
...
export default function PremiumGiftPurchaseButton(defaultSelection) {
  ...
  let c9;
  let c10;
  let tmp3 = callback3(importDefault(5368)().insets.bottom);
  ...
  c9 = tmp10;
  const tmp11 = importDefault(9978)();
  let tmp12 = tmp11;
  if (tmp11) {
