...
// Module 9725 (PremiumGiftSuccessBody)
...
export default function PremiumGiftSuccessBody(giftCodeRecord) {
  ...
  obj1 = { giftStyle };
  obj.children = callback(giftCodeURL(8710), obj1);
  ...
  items1[1] = callback(giftCodeRecord(4127).Text, obj2);
  ...
  items1[2] = callback(giftCodeRecord(4127).Text, obj3);
  ...
  const items2 = [callback(giftCodeRecord(4127).Text, obj5), ];
  const obj6 = { text: giftCodeURL, icon: giftCodeURL(4080), iconPosition: "end", onPress: callback };
  items2[1] = callback(giftCodeRecord(8174).InputButton, obj6);
  ...
  items1[4] = callback(giftCodeRecord(4127).Text, obj7);
  obj.children = items1;
