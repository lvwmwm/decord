...
// Dependencies: [19, 17, 8684, 10046, 1369, 21, 4255, 712, 1581, 4460, 4107, 4665, 9464, 1236, 2351, 10047, 4251, 4224, 4225, 9927, 10048, 4071, 1358, 589, 8680, 2]
// Exports: default

// Module 10045 (PostPurchaseFooter)
...
function InProgressScreen(arg0) {
  ...
  obj = { style: tmp.progressWrapper, children: callback4(importDefault(10047), { progress, currentTier, nextTier, iconSize: 48, title: progressBarTitle }) };
...
function LevelUpScreen(arg0) {
  ...
  const items1 = [closure_10(importDefault(10048), { progress: simulatedProgress, currentTier, newTier, style: tmp3.levelUpProgress }), ];
