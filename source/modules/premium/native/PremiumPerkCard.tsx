...
// Function ID: 12757
// Name: frozen
// Dependencies: [19, 17, 1924, 676, 21, 4761, 12757, 4237, 6059, 5788, 1236, 12758, 12759, 12760, 12761, 12762, 12763, 12764, 12765, 12766, 12767, 12768, 12769, 12770, 12771, 12772, 12773, 12774, 4338, 1993, 4342, 712, 5308, 12775, 4755, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    ...
    if (tmp26) {
      ...
      tmp26 = callback(importDefault(12775), obj7);
    }
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[1] = { uri: importDefault(12774) };
  ...
  const obj17 = { uri: importDefault(12774) };
