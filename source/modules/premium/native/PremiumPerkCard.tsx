...
// Function ID: 12447
// Name: frozen
// Dependencies: [19, 17, 1876, 676, 21, 4606, 12447, 4084, 6611, 5535, 1236, 12448, 12449, 12450, 12451, 12452, 12453, 12454, 12455, 12456, 12457, 12458, 12459, 12460, 12461, 12462, 12463, 12464, 4185, 1945, 4189, 712, 5141, 12465, 4600, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    ...
    if (tmp26) {
      ...
      tmp26 = callback(importDefault(12465), obj7);
    }
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  let obj = subscriptionPlansLoaded(12447);
  ...
  const callback = React.useCallback(() => {
    let obj = subscriptionPlansLoaded(6611);
  ...
  obj16[1] = { uri: importDefault(12464) };
  ...
  const obj17 = { uri: importDefault(12464) };
