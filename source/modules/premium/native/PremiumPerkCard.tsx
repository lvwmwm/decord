...
// Function ID: 12853
// Name: frozen
// Dependencies: [19, 17, 1924, 676, 21, 4751, 12853, 4269, 7360, 7159, 1236, 12854, 12855, 12856, 12857, 12858, 12859, 12860, 12861, 12862, 12863, 12864, 12865, 12866, 12867, 12868, 12869, 12870, 4734, 1993, 4661, 712, 5449, 12871, 4745, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj3[0] = items2;
      obj3[1] = imageSrc;
      tmp15 = callback(importDefault(5449), obj3);
    }
  } else {
    let tmp10 = null;
    ...
    if (tmp26) {
      ...
      tmp26 = callback(importDefault(12871), obj7);
    }
...
export const usePerkCardHeight = function usePerkCardHeight(NARROW) {
  return require(4751) /* getFontScale */.useFontScale() > 1 ? frozen[NARROW].scaledFontHeight : frozen[NARROW].height;
};
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[1] = { uri: importDefault(12870) };
  ...
  const obj17 = { uri: importDefault(12870) };
