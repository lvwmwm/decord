...
// Dependencies: [31, 27, 1852, 653, 33, 4584, 12425, 4060, 6590, 5517, 1212, 12426, 12427, 12428, 12429, 12430, 12431, 12432, 12433, 12434, 12435, 12436, 12437, 12438, 12439, 12440, 12441, 12442, 4161, 1921, 4165, 689, 5119, 12443, 4578, 2]
// Exports: default, usePremiumPerkCard

// Module 12424 (usePerkCardHeight)
...
function usePerkCardHeight(NARROW) {
  return require(4584) /* getFontScale */.useFontScale() > 1 ? frozen[NARROW].scaledFontHeight : frozen[NARROW].height;
}
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      imageSrc = callback(require(4161) /* Text */.Text, obj2);
      ...
      tmp12 = callback(importDefault(5119), obj3);
    }
  } else {
    let tmp6 = null;
    ...
    if (null != description) {
      ...
      let tmp20 = callback(require(4161) /* Text */.Text, obj4);
    } else {
      tmp20 = null;
    ...
    if (tmp28) {
      ...
      tmp28 = callback(importDefault(12443), obj7);
    }
    ...
    obj8.style = items5;
    obj8.children = title;
    items4[2] = callback(require(4161) /* Text */.Text, obj8);
    ...
    if (tmp36) {
      ...
      obj10.children = callback(require(4578) /* Button */.Button, obj11);
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  let obj = subscriptionPlansLoaded(12425);
  subscriptionPlansLoaded = obj.useSubscriptionPlansLoaded();
  let obj1 = subscriptionPlansLoaded(4060);
  ...
  obj.imageSrc = importDefault(12426);
  ...
  obj1.imageSrc = importDefault(12427);
  ...
  obj2.imageSrc = importDefault(12428);
  ...
  obj3.imageSrc = importDefault(12429);
  ...
  obj4.imageSrc = importDefault(12430);
  ...
  obj5.imageSrc = importDefault(12431);
  obj.emoji = obj5;
  const obj6 = {};
  ...
  obj6.imageSrc = importDefault(12432);
  ...
  obj7.imageSrc = importDefault(12433);
  obj.sticker = obj7;
  const obj8 = {};
  ...
  obj8.imageSrc = importDefault(12434);
  ...
  obj9.imageSrc = importDefault(12435);
  ...
  obj10.imageSrc = importDefault(12436);
  ...
  obj11.imageSrc = importDefault(12437);
  obj.hdVideo = obj11;
  const obj12 = {};
  ...
  obj12.imageSrc = importDefault(12438);
  ...
  obj13.imageSrc = importDefault(12439);
  ...
  obj14.imageSrc = importDefault(12440);
  obj.badge = obj14;
  const obj15 = {};
  ...
  obj15.imageSrc = importDefault(12441);
  ...
  obj16.imageSrc = { uri: importDefault(12442) };
  ...
  const obj19 = {};
  const obj17 = { uri: importDefault(12442) };
  ...
  obj16.bodyComponent = callback(subscriptionPlansLoaded(4161).Text, obj18);
