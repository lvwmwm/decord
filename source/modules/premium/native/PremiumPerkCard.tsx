...
// Function ID: 12621
// Name: frozen
// Dependencies: [19, 17, 1905, 676, 21, 4718, 12621, 4197, 5956, 5688, 1236, 12622, 12623, 12624, 12625, 12626, 12627, 12628, 12629, 12630, 12631, 12632, 12633, 12634, 12635, 12636, 12637, 12638, 4298, 1974, 4302, 712, 5267, 12639, 4712, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj3[0] = items2;
      obj3[1] = imageSrc;
      tmp15 = callback(importDefault(5267), obj3);
    }
  } else {
    let tmp10 = null;
    ...
    if (tmp26) {
      ...
      tmp26 = callback(importDefault(12639), obj7);
    }
...
export const usePerkCardHeight = function usePerkCardHeight(NARROW) {
  return require(4718) /* getFontScale */.useFontScale() > 1 ? frozen[NARROW].scaledFontHeight : frozen[NARROW].height;
};
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[1] = { uri: importDefault(12638) };
  ...
  const obj17 = { uri: importDefault(12638) };
