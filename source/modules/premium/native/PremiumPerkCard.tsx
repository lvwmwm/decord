...
// Function ID: 12691
// Name: frozen
// Dependencies: [19, 17, 1905, 676, 21, 4720, 12691, 4198, 6016, 5748, 1236, 12692, 12693, 12694, 12695, 12696, 12697, 12698, 12699, 12700, 12701, 12702, 12703, 12704, 12705, 12706, 12707, 12708, 4299, 1974, 4303, 712, 5268, 12709, 4714, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj3[0] = items2;
      obj3[1] = imageSrc;
      tmp15 = callback(importDefault(5268), obj3);
    }
  } else {
    let tmp10 = null;
    ...
    if (tmp26) {
      ...
      tmp26 = callback(importDefault(12709), obj7);
    }
...
export const usePerkCardHeight = function usePerkCardHeight(NARROW) {
  return require(4720) /* getFontScale */.useFontScale() > 1 ? frozen[NARROW].scaledFontHeight : frozen[NARROW].height;
};
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[1] = { uri: importDefault(12708) };
  ...
  const obj17 = { uri: importDefault(12708) };
  obj19[0] = importDefault(1974).getArticleURL(NITRO_2_POINT_0.NITRO_2_POINT_0);
