...
// Function ID: 12441
// Name: frozen
// Dependencies: [19, 17, 1876, 676, 21, 4606, 12441, 4084, 6608, 5535, 1236, 12442, 12443, 12444, 12445, 12446, 12447, 12448, 12449, 12450, 12451, 12452, 12453, 12454, 12455, 12456, 12457, 12458, 4185, 1945, 4189, 712, 5141, 12459, 4600, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj2[2] = imageStyle;
      imageSrc = callback(tmp6(4185).Text, obj2);
      obj1[1] = imageSrc;
      ...
      obj3[0] = items2;
      obj3[1] = imageSrc;
      tmp15 = callback(importDefault(5141), obj3);
    }
  } else {
    let tmp10 = null;
    ...
    if (null != description) {
      ...
      obj4[1] = description;
      let tmp21 = callback(tmp6(4185).Text, obj4);
    } else {
      tmp21 = null;
    ...
    if (tmp26) {
      ...
      tmp26 = callback(importDefault(12459), obj7);
    }
    ...
    obj8[0] = items5;
    obj8[3] = title;
    items4[2] = callback(tmp6(4185).Text, obj8);
    ...
    if (tmp29Result) {
      ...
      obj10[1] = tmp29(tmp6(4600).Button, obj11);
...
export const usePerkCardHeight = function usePerkCardHeight(NARROW) {
  return require(4606) /* getFontScale */.useFontScale() > 1 ? frozen[NARROW].scaledFontHeight : frozen[NARROW].height;
};
export const usePremiumPerkCard = function usePremiumPerkCard() {
  let obj = subscriptionPlansLoaded(12441);
  subscriptionPlansLoaded = obj.useSubscriptionPlansLoaded();
  let obj1 = subscriptionPlansLoaded(4084);
  const formatSizeResult = obj1.formatSize(closure_6 / 1024, { useKibibytes: true });
  const callback = React.useCallback(() => {
    let obj = subscriptionPlansLoaded(6608);
    obj = { screen: constants.COLLECTIBLES_SHOP, params: null };
    obj = { analyticsSource: callback(5535).PREMIUM_MARKETING_PERK_CARD };
    obj[1] = obj;
  ...
  obj16[1] = { uri: importDefault(12458) };
  ...
  const obj17 = { uri: importDefault(12458) };
  ...
  obj16[3] = callback(subscriptionPlansLoaded(4185).Text, obj18);
  obj[16] = obj16;
  return obj;
};
