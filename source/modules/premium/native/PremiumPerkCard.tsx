...
// Function ID: 13345
// Name: frozen
// Dependencies: [19, 17, 1923, 673, 21, 4943, 13345, 4375, 7320, 7122, 1233, 13346, 13347, 13348, 13349, 13350, 13351, 13352, 13353, 13354, 13355, 13356, 13357, 13358, 13359, 13360, 13361, 13362, 4477, 1994, 4481, 709, 5542, 13363, 4936, 2]
...
import registerAssetDefault from "registerAsset" /* 13346 */;
import registerAssetDefault2 from "registerAsset" /* 13347 */;
import registerAssetDefault3 from "registerAsset" /* 13348 */;
import registerAssetDefault4 from "registerAsset" /* 13349 */;
import registerAssetDefault5 from "registerAsset" /* 13350 */;
import registerAssetDefault6 from "registerAsset" /* 13351 */;
import registerAssetDefault7 from "registerAsset" /* 13352 */;
import registerAssetDefault8 from "registerAsset" /* 13353 */;
import registerAssetDefault9 from "registerAsset" /* 13354 */;
import registerAssetDefault10 from "registerAsset" /* 13355 */;
import registerAssetDefault11 from "registerAsset" /* 13356 */;
import registerAssetDefault12 from "registerAsset" /* 13357 */;
import registerAssetDefault13 from "registerAsset" /* 13358 */;
import registerAssetDefault14 from "registerAsset" /* 13359 */;
import registerAssetDefault15 from "registerAsset" /* 13360 */;
import registerAssetDefault16 from "registerAsset" /* 13361 */;
import metadataDefault from "metadata" /* 13362 */;
import PillTextDefault from "PillText" /* 13363 */;
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj2[2] = imageStyle;
      imageSrc = callback(tmp6(4477).Text, obj2);
      obj1[1] = imageSrc;
    ...
    if (null != description) {
      ...
      obj4[1] = description;
      let tmp21 = callback(tmp6(4477).Text, obj4);
    } else {
      tmp21 = null;
    ...
    obj8[0] = items5;
    obj8[3] = title;
    items4[2] = callback(tmp6(4477).Text, obj8);
    ...
    if (tmp29Result) {
      ...
      obj10[1] = tmp29(tmp6(4936).Button, obj11);
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[3] = callback(subscriptionPlansLoaded(4477).Text, obj18);
  obj[16] = obj16;
  return obj;
};
