...
// Function ID: 12606
// Name: frozen
// Dependencies: [19, 17, 1905, 676, 21, 4701, 12606, 4180, 5937, 5669, 1236, 12607, 12608, 12609, 12610, 12611, 12612, 12613, 12614, 12615, 12616, 12617, 12618, 12619, 12620, 12621, 12622, 12623, 4281, 1974, 4285, 712, 5251, 12624, 4695, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj3[0] = items2;
      obj3[1] = imageSrc;
      tmp15 = callback(importDefault(5251), obj3);
    }
  } else {
    let tmp10 = null;
    ...
    if (tmp26) {
      ...
      tmp26 = callback(importDefault(12624), obj7);
    }
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[1] = { uri: importDefault(12623) };
  ...
  const obj17 = { uri: importDefault(12623) };
