...
const frozen = Object.freeze({ [obj.NARROW]: { containerWithoutSplash: "cd214b5502d42e0d86b5bf4c01260ed5", __callFunction: "grey_server_boosts", style: "png" }, [obj.WIDE]: { containerWithoutSplash: "/assets/modules/premium/native/images/perks", __callFunction: 300, style: 175 } });
...
let closure_13 = arg1(dependencyMap[30]).createStyles((arg0) => {
  ...
  obj.button = {};
  obj.imageContainer = { "Bool(false)": "Enable official messages", "Bool(false)": "NEUTRAL_79", "Bool(false)": 1 };
