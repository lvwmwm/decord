...
// Function ID: 12775
// Name: frozen
// Dependencies: [19, 17, 1924, 676, 21, 4783, 12775, 4237, 6080, 5809, 1236, 12776, 12777, 12778, 12779, 12780, 12781, 12782, 12783, 12784, 12785, 12786, 12787, 12788, 12789, 12790, 12791, 12792, 4338, 1993, 4342, 712, 5329, 12793, 4777, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj3[0] = items2;
      obj3[1] = imageSrc;
      tmp15 = callback(importDefault(5329), obj3);
    }
  } else {
    let tmp10 = null;
    ...
    if (tmp26) {
      ...
      tmp26 = callback(importDefault(12793), obj7);
    }
...
export const usePerkCardHeight = function usePerkCardHeight(NARROW) {
  return require(4783) /* getFontScale */.useFontScale() > 1 ? frozen[NARROW].scaledFontHeight : frozen[NARROW].height;
};
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[1] = { uri: importDefault(12792) };
  ...
  const obj17 = { uri: importDefault(12792) };
