...
// Dependencies: [19, 17, 1302, 1891, 4195, 3953, 676, 21, 4302, 712, 5235, 6843, 4298, 1236, 11, 4844, 5150, 5719, 12702, 589, 1416, 12703, 12707, 4621, 4198, 12, 2]
// Exports: default

// Module 12701 (GuildBoostSlotCooldown)
...
function GuildBoostSlotCooldown(cooldownEndsAt) {
  ...
  ({ days, hours, minutes } = importDefault(6843)(memo, 15000));
  const tmp3 = importDefault(6843)(memo, 15000);
  let tmp5 = null;
...
function GuildBoostSlotsInventoryRow(arg0) {
  ...
  const items = [callback(require(4298) /* Text */.Text, { style: tmp.subscriptionSlotInfoTitle, lineClamp: 1, variant: "text-md/semibold", color: "interactive-text-active", children: title }), subtitle];
  obj[1] = items;
...
function BoostedGuild(arg0) {
  ...
  let subscriptionPlaceholderPatternSource = require(12703) /* getSubscriptionPlaceholderPatternSource */.useSubscriptionPlaceholderPatternSource();
  ...
  const tmp2 = require;
  const tmp2Result = require(12703) /* getSubscriptionPlaceholderPatternSource */;
