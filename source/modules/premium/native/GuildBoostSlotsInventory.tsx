...
// Dependencies: [19, 17, 1302, 1891, 4178, 3936, 676, 21, 4285, 712, 5219, 6824, 4281, 1236, 11, 4827, 5133, 5700, 12687, 589, 1416, 12688, 12692, 4604, 4181, 12, 2]
// Exports: default

// Module 12686 (GuildBoostSlotCooldown)
...
function GuildBoostSlotCooldown(cooldownEndsAt) {
  ...
  ({ days, hours, minutes } = importDefault(6824)(memo, 15000));
  const tmp3 = importDefault(6824)(memo, 15000);
  let tmp5 = null;
...
function BoostedGuild(arg0) {
  ...
  let subscriptionPlaceholderPatternSource = require(12688) /* getSubscriptionPlaceholderPatternSource */.useSubscriptionPlaceholderPatternSource();
  ...
  const tmp2 = require;
  const tmp2Result = require(12688) /* getSubscriptionPlaceholderPatternSource */;
