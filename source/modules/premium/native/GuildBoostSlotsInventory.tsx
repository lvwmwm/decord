...
// Dependencies: [19, 17, 1302, 1862, 4148, 3907, 676, 21, 4255, 712, 5189, 6797, 4251, 1236, 11, 4797, 5103, 5646, 12650, 589, 1416, 12651, 12655, 4574, 4151, 12, 2]
// Exports: default

// Module 12649 (GuildBoostSlotCooldown)
...
function GuildBoostSlotCooldown(cooldownEndsAt) {
  ...
  ({ days, hours, minutes } = importDefault(6797)(memo, 15000));
  const tmp3 = importDefault(6797)(memo, 15000);
  let tmp5 = null;
...
function BoostedGuild(arg0) {
  ...
  let subscriptionPlaceholderPatternSource = require(12651) /* getSubscriptionPlaceholderPatternSource */.useSubscriptionPlaceholderPatternSource();
  ...
  const tmp2 = require;
  const tmp2Result = require(12651) /* getSubscriptionPlaceholderPatternSource */;
