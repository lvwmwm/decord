...
// Function ID: 14537
// Name: ThemedTabBadge
// Dependencies: [32, 19, 17, 4113, 1924, 7111, 21, 4445, 712, 1363, 4380, 4441, 8815, 503, 10437, 1297, 14537, 7126, 7901, 4107, 4266, 1377, 589, 6203, 7897, 7896, 12927, 1236, 4892, 691, 500, 2]
// Exports: default

// Module 14536 (ThemedTabBadge)
...
import usePremiumDiscountOffer from "usePremiumDiscountOffer" /* 7901 */;
import trackImpressionDefault from "trackImpression" /* 8815 */;
import MarketingComponentType from "MarketingComponentType" /* 10437 */;
import registerAssetDefault from "registerAsset" /* 14537 */;
...
function OfferBadge(componentId) {
  ...
  if (acked) {
    ...
    items[1] = callback2(tmp5(4441).Text, obj3);
    obj1[1] = items;
...
export default function PremiumTabBadge() {
  ...
  if (trialId === closure_6) {
    ...
    if (!tmp7) {
      ...
      const isEligibleSenderForReferralProgram = tmp2(7897).useIsEligibleSenderForReferralProgram();
      const tmp2Result2 = tmp2(7897);
      const isReferralProgramEntrypointBadgeAcknowledged = tmp2(7896).useIsReferralProgramEntrypointBadgeAcknowledged();
      const tmp2Result3 = tmp2(7896);
      const promotionMarketingComponent = tmp2(12927).usePromotionMarketingComponent(tmp2(10437).MarketingComponentType.PREMIUM_TAB);
      ...
      if (tmp7) {
        ...
        if (premiumDiscountOffer.hasAcknowledged()) {
          ...
          items5[1] = callback2(tmp2(4441).Text, obj6);
          obj4[1] = items5;
          ...
          obj7[4] = callback2(tmp2(4441).Text, obj8);
        ...
        if (null != stringResult) {
          ...
          obj9[4] = callback2(tmp2(4441).Text, obj10);
          tmp47Result = tmp32(tmp34, obj9);
          tmp2Result7 = tmp2(500);
        }
      }
      const tmp2Result4 = tmp2(12927);
    }
    items2 = [];
