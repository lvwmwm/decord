...
// Function ID: 14157
// Name: ThemedTabBadge
// Dependencies: [32, 19, 17, 3953, 1905, 6836, 21, 4302, 712, 4147, 4238, 4298, 9284, 503, 7587, 1297, 14157, 6851, 7281, 3947, 4117, 1358, 589, 5962, 8102, 8101, 7583, 1236, 4723, 691, 500, 2]
// Exports: default

// Module 14156 (ThemedTabBadge)
...
function ThemedTabBadge(children) {
  ...
  const isThemeDarkResult = obj.isThemeDark(importDefault(4238)());
  ...
  obj[1] = closure_8(require(4298) /* Text */.Text, { variant: "eyebrow", color: str, style: items1, children: children.label });
...
function OfferBadge(componentId) {
  ...
  obj = { component_type: require(7587) /* MarketingComponentType */.MarketingComponentType.PREMIUM_TAB, component_id: componentId };
  obj[2] = obj;
  obj = { disableTrack: null == componentId };
  importDefault(9284)(obj, obj);
  if (acked) {
    const obj1 = { style: null, children: null };
    obj1[0] = tmp.acked;
    const obj2 = { source: null, size: null, color: null, style: null };
    obj2[0] = importDefault(14157);
    ...
    items[1] = callback2(tmp5(4298).Text, obj3);
    obj1[1] = items;
...
export default function PremiumTabBadge() {
  ...
  let obj = require(6851) /* usePremiumTrialOffer */;
  const premiumTrialOffer = obj.usePremiumTrialOffer();
  let obj1 = require(7281) /* usePremiumDiscountOffer */;
  ...
  let obj4 = require(4117) /* UNSAFE_isDismissibleContentDismissed */;
  ...
  if (trialId === closure_6) {
    ...
    if (!tmp7) {
      ...
      const isEligibleSenderForReferralProgram = tmp2(8102).useIsEligibleSenderForReferralProgram();
      const tmp2Result2 = tmp2(8102);
      const isReferralProgramEntrypointBadgeAcknowledged = tmp2(8101).useIsReferralProgramEntrypointBadgeAcknowledged();
      const tmp2Result3 = tmp2(8101);
      const promotionMarketingComponent = tmp2(7583).usePromotionMarketingComponent(tmp2(7587).MarketingComponentType.PREMIUM_TAB);
      const tmp2Result5 = tmp2(5962);
      let prop = null;
      ...
      if (tmp7) {
        ...
        const tmp52 = importDefault(4723);
        let text;
        ...
        if (premiumDiscountOffer.hasAcknowledged()) {
          ...
          items5[1] = callback2(tmp2(4298).Text, obj6);
          obj4[1] = items5;
          ...
          obj7[4] = callback2(tmp2(4298).Text, obj8);
          tmp41 = callback2(importDefault(4723), obj7);
          const tmp40 = importDefault(4723);
        }
      } else {
        tmp47Result = null;
        if (null != stringResult) {
          ...
          const tmp34 = importDefault(4723);
          let text1;
          ...
          obj9[4] = callback2(tmp2(4298).Text, obj10);
          tmp47Result = tmp32(tmp34, obj9);
          tmp2Result7 = tmp2(500);
        }
      }
      const tmp2Result4 = tmp2(7583);
    }
    items2 = [];
