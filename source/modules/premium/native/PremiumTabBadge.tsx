...
// Function ID: 14106
// Name: ThemedTabBadge
// Dependencies: [32, 19, 17, 3907, 1876, 6790, 21, 4255, 712, 4101, 4191, 4251, 9238, 503, 7540, 1297, 14106, 6805, 7235, 3901, 4071, 1358, 589, 5916, 7944, 7943, 7536, 1236, 4676, 691, 500, 2]
// Exports: default

// Module 14105 (ThemedTabBadge)
...
function ThemedTabBadge(children) {
  ...
  obj[1] = closure_8(require(4251) /* Text */.Text, { variant: "eyebrow", color: str, style: items1, children: children.label });
...
function OfferBadge(componentId) {
  ...
  obj = { component_type: require(7540) /* MarketingComponentType */.MarketingComponentType.PREMIUM_TAB, component_id: componentId };
  obj[2] = obj;
  obj = { disableTrack: null == componentId };
  importDefault(9238)(obj, obj);
  if (acked) {
    const obj1 = { style: null, children: null };
    obj1[0] = tmp.acked;
    const obj2 = { source: null, size: null, color: null, style: null };
    obj2[0] = importDefault(14106);
    ...
    items[1] = callback2(tmp5(4251).Text, obj3);
    obj1[1] = items;
...
export default function PremiumTabBadge() {
  ...
  let obj1 = require(7235) /* usePremiumDiscountOffer */;
  const premiumDiscountOffer = obj1.usePremiumDiscountOffer();
  let obj3 = require(3901) /* getPremiumPlanItem */;
  const hasTier2Premium = obj3.useHasTier2Premium();
  let obj4 = require(4071) /* UNSAFE_isDismissibleContentDismissed */;
  ...
  if (trialId === closure_6) {
    ...
    if (!tmp7) {
      ...
      const isEligibleSenderForReferralProgram = tmp2(7944).useIsEligibleSenderForReferralProgram();
      const tmp2Result2 = tmp2(7944);
      const isReferralProgramEntrypointBadgeAcknowledged = tmp2(7943).useIsReferralProgramEntrypointBadgeAcknowledged();
      const tmp2Result3 = tmp2(7943);
      const promotionMarketingComponent = tmp2(7536).usePromotionMarketingComponent(tmp2(7540).MarketingComponentType.PREMIUM_TAB);
      const tmp2Result5 = tmp2(5916);
      let prop = null;
      ...
      if (tmp7) {
        ...
        const tmp52 = importDefault(4676);
        let text;
        ...
        if (premiumDiscountOffer.hasAcknowledged()) {
          ...
          items5[1] = callback2(tmp2(4251).Text, obj6);
          obj4[1] = items5;
          ...
          obj7[4] = callback2(tmp2(4251).Text, obj8);
          tmp41 = callback2(importDefault(4676), obj7);
          const tmp40 = importDefault(4676);
        }
      } else {
        tmp47Result = null;
        if (null != stringResult) {
          ...
          const tmp34 = importDefault(4676);
          let text1;
          ...
          obj9[4] = callback2(tmp2(4251).Text, obj10);
          tmp47Result = tmp32(tmp34, obj9);
          tmp2Result7 = tmp2(500);
        }
      }
      const tmp2Result4 = tmp2(7536);
    }
    items2 = [];
