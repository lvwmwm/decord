...
// Function ID: 14811
// Name: ThemedTabBadge
// Dependencies: [32, 19, 17, 4145, 1923, 7186, 21, 4478, 709, 1362, 4413, 4474, 8907, 500, 10736, 1296, 14811, 7201, 7978, 4139, 4298, 1372, 586, 6260, 7974, 7973, 13235, 1233, 4940, 688, 1234, 2]
// Exports: default

// Module 14810 (ThemedTabBadge)
...
import MarketingComponentType from "MarketingComponentType" /* 10736 */;
...
export default function PremiumTabBadge() {
  ...
  if (trialId === closure_6) {
    ...
    if (!tmp7) {
      ...
      const promotionMarketingComponent = tmp2(13235).usePromotionMarketingComponent(tmp2(10736).MarketingComponentType.PREMIUM_TAB);
