...
// Function ID: 14143
// Name: ThemedTabBadge
// Dependencies: [32, 19, 17, 3936, 1905, 6817, 21, 4285, 712, 4130, 4221, 4281, 9267, 503, 7568, 1297, 14143, 6832, 7262, 3930, 4100, 1358, 589, 5943, 8085, 8084, 7564, 1236, 4706, 691, 500, 2]
// Exports: default

// Module 14142 (ThemedTabBadge)
...
function ThemedTabBadge(children) {
  ...
  obj[1] = closure_8(require(4281) /* Text */.Text, { variant: "eyebrow", color: str, style: items1, children: children.label });
...
export default function PremiumTabBadge() {
  ...
  let obj = require(6832) /* usePremiumTrialOffer */;
  const premiumTrialOffer = obj.usePremiumTrialOffer();
  let obj1 = require(7262) /* usePremiumDiscountOffer */;
  const premiumDiscountOffer = obj1.usePremiumDiscountOffer();
  let obj3 = require(3930) /* getPremiumPlanItem */;
  const hasTier2Premium = obj3.useHasTier2Premium();
  let obj4 = require(4100) /* UNSAFE_isDismissibleContentDismissed */;
  ...
  if (trialId === closure_6) {
    ...
    if (!tmp7) {
      ...
      const isEligibleSenderForReferralProgram = tmp2(8085).useIsEligibleSenderForReferralProgram();
      const tmp2Result2 = tmp2(8085);
      const isReferralProgramEntrypointBadgeAcknowledged = tmp2(8084).useIsReferralProgramEntrypointBadgeAcknowledged();
      const tmp2Result3 = tmp2(8084);
      const promotionMarketingComponent = tmp2(7564).usePromotionMarketingComponent(tmp2(7568).MarketingComponentType.PREMIUM_TAB);
      const tmp2Result5 = tmp2(5943);
      let prop = null;
      ...
      if (tmp7) {
        ...
        if (premiumDiscountOffer.hasAcknowledged()) {
          ...
          items5[1] = callback2(tmp2(4281).Text, obj6);
          obj4[1] = items5;
