...
// Function ID: 14099
// Name: ThemedTabBadge
// Dependencies: [32, 19, 17, 3907, 1876, 6793, 21, 4255, 712, 4101, 4191, 4251, 8741, 503, 7556, 1297, 14099, 6808, 7251, 3901, 4071, 1358, 589, 5921, 7960, 7959, 7552, 1236, 4677, 691, 500, 2]
// Exports: default

// Module 14098 (ThemedTabBadge)
...
function ThemedTabBadge(children) {
  ...
  obj[1] = closure_8(require(4251) /* Text */.Text, obj);
...
function OfferBadge(componentId) {
  ...
  obj = { component_type: require(7556) /* MarketingComponentType */.MarketingComponentType.PREMIUM_TAB, component_id: componentId };
  obj[2] = obj;
  obj = { disableTrack: null == componentId };
  importDefault(8741)(obj, obj);
  if (acked) {
    const obj1 = { style: null, children: null };
    obj1[0] = tmp.acked;
    const obj2 = { source: null, size: null, color: null, style: null };
    obj2[0] = importDefault(14099);
...
export default function PremiumTabBadge() {
  ...
  let obj1 = require(7251) /* usePremiumDiscountOffer */;
  ...
  if (trialId === closure_6) {
    ...
    if (!tmp7) {
      ...
      const isEligibleSenderForReferralProgram = tmp2(7960).useIsEligibleSenderForReferralProgram();
      const tmp2Result2 = tmp2(7960);
      const isReferralProgramEntrypointBadgeAcknowledged = tmp2(7959).useIsReferralProgramEntrypointBadgeAcknowledged();
      const tmp2Result3 = tmp2(7959);
      const promotionMarketingComponent = tmp2(7552).usePromotionMarketingComponent(tmp2(7556).MarketingComponentType.PREMIUM_TAB);
      const tmp2Result5 = tmp2(5921);
      let prop = null;
      ...
      if (tmp7) {
        ...
        const tmp52 = importDefault(4677);
        let text;
        ...
        if (premiumDiscountOffer.hasAcknowledged()) {
          ...
          items4[1] = callback2(tmp2(4251).Text, obj6);
          obj4[1] = items4;
          ...
          tmp41 = callback2(importDefault(4677), obj7);
          const tmp40 = importDefault(4677);
        }
      } else {
        tmp47Result = null;
        if (null != stringResult) {
          ...
          const tmp34 = importDefault(4677);
          let text1;
