...
// Dependencies: [31, 27, 1852, 33, 4165, 689, 5119, 4161, 3811, 5497, 6516, 44, 6521, 1212, 6522, 6185, 6523, 6524, 4133, 5221, 6206, 4578, 6274, 2]
// Exports: default

// Module 6515 (WhatYouLoseItem)
...
function WhatYouLoseItem(arg0) {
  ...
  const items = [callback(importDefault(5119), { source: imageSource }), ];
