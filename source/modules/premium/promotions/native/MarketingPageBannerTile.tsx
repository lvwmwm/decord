...
// Dependencies: [19, 17, 21, 4446, 712, 5918, 12993, 8832, 503, 10453, 12996, 4442, 4159, 8910, 2]
// Exports: default

// Module 12992 (MarketingPageBannerTile)
...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  const tmp = callback();
  let obj = helpArticleLinkProps(12993);
  ...
  obj[2] = { component_type: helpArticleLinkProps(10453).MarketingComponentType.MARKETING_PAGE_BANNER, component_id: componentId, promotion_id: promotionId };
  tmp2Result(obj);
  let tmp4Result = tmp4(12996);
  const formatStringWithCommonPremiumParams = tmp4Result.useFormatStringWithCommonPremiumParams(bannerFields.body);
  tmp4Result = tmp4(12996);
  ...
  const items2 = [tmp12Result, closure_5(helpArticleLinkProps(4442).Text, { color: "mobile-text-heading-primary", variant: "text-lg/bold", children: bannerFields.header }), , ];
  ...
  if (tmp12Result) {
    ...
    tmp12Result = tmp12(tmp4(4442).Text, obj8);
  }
  items3[2] = tmp12Result;
  obj7[3] = items3;
  items2[2] = closure_6(helpArticleLinkProps(4442).Text, obj7);
