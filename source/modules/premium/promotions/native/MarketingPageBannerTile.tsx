...
// Dependencies: [19, 17, 21, 4478, 712, 5953, 13060, 8892, 503, 10515, 13063, 4474, 4190, 8970, 2]
// Exports: default

// Module 13059 (MarketingPageBannerTile)
...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  const tmp = callback();
  let obj = helpArticleLinkProps(13060);
