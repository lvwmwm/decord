...
// Dependencies: [19, 17, 21, 4448, 712, 5921, 13027, 8855, 503, 10477, 13030, 4444, 4160, 8933, 2]
// Exports: default

// Module 13026 (MarketingPageBannerTile)
...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  const tmp = callback();
  let obj = helpArticleLinkProps(13027);
  ...
  obj[2] = { component_type: helpArticleLinkProps(10477).MarketingComponentType.MARKETING_PAGE_BANNER, component_id: componentId, promotion_id: promotionId };
  tmp2Result(obj);
  let tmp4Result = tmp4(13030);
  const formatStringWithCommonPremiumParams = tmp4Result.useFormatStringWithCommonPremiumParams(bannerFields.body);
  tmp4Result = tmp4(13030);
  ...
  const items2 = [tmp12Result, closure_5(helpArticleLinkProps(4444).Text, { color: "mobile-text-heading-primary", variant: "text-lg/bold", children: bannerFields.header }), , ];
  ...
  if (tmp12Result) {
    ...
    tmp12Result = tmp12(tmp4(4444).Text, obj8);
  }
  items3[2] = tmp12Result;
  obj7[3] = items3;
  items2[2] = closure_6(helpArticleLinkProps(4444).Text, obj7);
