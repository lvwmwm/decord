...
// Dependencies: [19, 17, 21, 4481, 709, 7102, 13327, 8698, 500, 10671, 13330, 4477, 4190, 9899, 2]
// Exports: default

// Module 13326 (MarketingPageBannerTile)
...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  const tmp = callback();
  let obj = helpArticleLinkProps(13327);
  ...
  obj[2] = { component_type: helpArticleLinkProps(10671).MarketingComponentType.MARKETING_PAGE_BANNER, component_id: componentId, promotion_id: promotionId };
  tmp2Result(obj);
  let tmp4Result = tmp4(13330);
  const formatStringWithCommonPremiumParams = tmp4Result.useFormatStringWithCommonPremiumParams(bannerFields.body);
  tmp4Result = tmp4(13330);
  ...
  const items2 = [tmp12Result, closure_5(helpArticleLinkProps(4477).Text, { color: "mobile-text-heading-primary", variant: "text-lg/bold", children: bannerFields.header }), , ];
  ...
  if (tmp12Result) {
    ...
    tmp12Result = tmp12(tmp4(4477).Text, obj8);
  }
  items3[2] = tmp12Result;
  obj7[3] = items3;
  items2[2] = closure_6(helpArticleLinkProps(4477).Text, obj7);
