...
// Dependencies: [19, 17, 21, 4303, 712, 5728, 7757, 9355, 503, 7649, 12682, 4299, 4017, 9518, 2]
// Exports: default

// Module 7756 (MarketingPageBannerTile)
import "noop";
...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  let obj = helpArticleLinkProps(7757);
  ...
  obj[1] = value;
  obj[2] = importDefault(5728)().analyticsLocations;
  obj[3] = analyticsPage;
  ...
  const tmp2Result = importDefault(9355);
  obj[2] = { component_type: helpArticleLinkProps(7649).MarketingComponentType.MARKETING_PAGE_BANNER, component_id: componentId };
  tmp2Result(obj);
  let tmp4Result = tmp4(12682);
  const formatStringWithCommonPremiumParams = tmp4Result.useFormatStringWithCommonPremiumParams(bannerFields.body);
  tmp4Result = tmp4(12682);
  ...
  const items2 = [tmp12Result, closure_5(helpArticleLinkProps(4299).Text, { color: "mobile-text-heading-primary", variant: "text-lg/bold", children: bannerFields.header }), , ];
  ...
  if (tmp12Result) {
    ...
    tmp12Result = tmp12(tmp4(4299).Text, obj8);
  }
  items3[2] = tmp12Result;
  obj7[3] = items3;
  items2[2] = closure_6(helpArticleLinkProps(4299).Text, obj7);
