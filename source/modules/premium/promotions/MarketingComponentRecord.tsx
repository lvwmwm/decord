...
// Dependencies: [1912, 7288, 1307, 2]

// Module 7287 (createFromServer)
import "toJS";
...
MarketingComponentRecord["createFromServer"] = function createFromServer(start_date, start_date2) {
  ...
  const PremiumMarketingComponentProperties = textDecoder(7288).PremiumMarketingComponentProperties;
