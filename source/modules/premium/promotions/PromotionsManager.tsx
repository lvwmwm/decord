...
prototype["onLocaleChanged"] = function onLocaleChanged() {
  ...
  if (tmp) {
    const result = require(7689) /* fetchActivePromotions */.maybeFetchActivePromotions(false);
    const obj = require(7689) /* fetchActivePromotions */;
  }
};
  ...
  if (str !== this.lastSubscriptionStateSignature) {
    ...
    if (!tmp3) {
      if (createEmptyPromotionsByType.isFetchingActivePromotions) {
        ...
        const result = require(7689) /* fetchActivePromotions */.maybeFetchActivePromotions(false);
        const obj3 = require(7689) /* fetchActivePromotions */;
      }
    }
  }
};
