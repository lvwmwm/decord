...
// Function ID: 7126
// Name: emitChanges
// Dependencies: [1922, 676, 7126, 709, 686, 589, 2]

// Module 7125 (emitChanges)
import initializeDefault from "initialize" /* 589 */;
import dispatcherDefault from "dispatcher" /* 709 */;
import _fetchReferralEligibleUsers from "_fetchReferralEligibleUsers" /* 7126 */;
...
const referralTrialStore = new ReferralTrialStore(dispatcherDefault, {
  BILLING_REFERRAL_TRIAL_OFFER_UPDATE: function handleReferralTrialOfferUpdate(userTrialOfferId) {
    ...
    if (!c8) {
      const referralsRemaining = userTrialOfferId(7126).fetchReferralsRemaining();
      const obj = userTrialOfferId(7126);
    }
