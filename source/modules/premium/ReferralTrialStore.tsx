...
// Function ID: 6210
// Name: emitChanges
// Dependencies: [1874, 676, 6210, 709, 686, 589, 2]

// Module 6209 (emitChanges)
...
prototype["checkAndFetchReferralsRemaining"] = function checkAndFetchReferralsRemaining() {
  ...
  if (tmp) {
    const referralsRemaining = require(6210) /* _fetchReferralEligibleUsers */.fetchReferralsRemaining();
    const obj = require(6210) /* _fetchReferralEligibleUsers */;
  }
};
...
const referralTrialStore = new ReferralTrialStore(require("dispatcher"), {
  BILLING_REFERRAL_TRIAL_OFFER_UPDATE: function handleReferralTrialOfferUpdate(userTrialOfferId) {
    ...
    if (!c8) {
      const referralsRemaining = userTrialOfferId(6210).fetchReferralsRemaining();
      const obj = userTrialOfferId(6210);
    }
