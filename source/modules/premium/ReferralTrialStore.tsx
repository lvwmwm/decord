...
// Function ID: 6213
// Name: emitChanges
// Dependencies: [1874, 676, 6213, 709, 686, 589, 2]

// Module 6212 (emitChanges)
...
prototype["checkAndFetchReferralsRemaining"] = function checkAndFetchReferralsRemaining() {
  ...
  if (tmp) {
    const referralsRemaining = require(6213) /* _fetchReferralEligibleUsers */.fetchReferralsRemaining();
    const obj = require(6213) /* _fetchReferralEligibleUsers */;
  }
};
...
const referralTrialStore = new ReferralTrialStore(require("dispatcher"), {
  BILLING_REFERRAL_TRIAL_OFFER_UPDATE: function handleReferralTrialOfferUpdate(userTrialOfferId) {
    ...
    if (!c8) {
      const referralsRemaining = userTrialOfferId(6213).fetchReferralsRemaining();
      const obj = userTrialOfferId(6213);
    }
