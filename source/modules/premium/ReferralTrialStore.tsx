...
// Function ID: 6916
// Name: emitChanges
// Dependencies: [1903, 676, 6916, 709, 686, 589, 2]

// Module 6915 (emitChanges)
...
prototype["checkAndFetchReferralsRemaining"] = function checkAndFetchReferralsRemaining() {
  ...
  if (tmp) {
    const referralsRemaining = require(6916) /* _fetchReferralEligibleUsers */.fetchReferralsRemaining();
    const obj = require(6916) /* _fetchReferralEligibleUsers */;
  }
};
...
const referralTrialStore = new ReferralTrialStore(require("dispatcher"), {
  BILLING_REFERRAL_TRIAL_OFFER_UPDATE: function handleReferralTrialOfferUpdate(userTrialOfferId) {
    ...
    if (!c8) {
      const referralsRemaining = userTrialOfferId(6916).fetchReferralsRemaining();
      const obj = userTrialOfferId(6916);
    }
