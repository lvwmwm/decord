...
// Dependencies: [6, 7, 15, 17, 18, 1850, 653, 6193, 686, 663, 566, 2]

// Module 6192 (_isNativeReflectConstruct)
import ME from "ME";
...
tmp7 = new tmp7(require("dispatcher"), {
  BILLING_REFERRAL_TRIAL_OFFER_UPDATE: function handleReferralTrialOfferUpdate(userTrialOfferId) {
    ...
    if (!c13) {
      const referralsRemaining = userTrialOfferId(6193).fetchReferralsRemaining();
      const obj = userTrialOfferId(6193);
    }
  ...
  BILLING_CREATE_REFERRAL_SUCCESS: function handleCreateReferralSuccess(userTrialOffer) {
    ...
    const referralsRemaining = require(6193) /* _createForOfIteratorHelperLoose */.fetchReferralsRemaining();
