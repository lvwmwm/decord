...
// Function ID: 12686
// Name: BetaPill
// Dependencies: [17, 6836, 21, 4302, 712, 4298, 1236, 12686, 1297, 4723, 4145, 8566, 2]
// Exports: default

// Module 12685 (BetaPill)
...
export default function PremiumGroupFeaturesTableCard(arg0) {
  ...
  const tmp = callback3();
  const tmp4 = importDefault(12686)(premiumGroupRole, false);
  if (null == tmp4) {
    return null;
  } else {
    ...
    obj[0] = { x: 0, y: 0 };
    obj[1] = { x: 1, y: 0 };
    let obj2 = require(4145) /* hexToRgba */;
    const items = [obj2.hexWithOpacity("#8547C6", 0.15), , ];
    const tmp2Result = tmp2(4723);
    items[1] = require(4145) /* hexToRgba */.hexWithOpacity("#B845C1", 0.15);
    const obj4 = require(4145) /* hexToRgba */;
    items[2] = require(4145) /* hexToRgba */.hexWithOpacity("#AB5D8A", 0.15);
    obj[2] = items;
    obj[3] = [0, 0.4996, 0.9593];
    obj[4] = tmp.premiumGroupCard;
    obj = { style: null, children: null };
    obj[0] = tmp.headerContainer;
    const items1 = [callback(tmp2(8566), { width: 181, height: 16 }), callback(BetaPill, {})];
    obj[1] = items1;
    const items2 = [callback2(View, obj), , ];
    const obj1 = { variant: "text-sm/normal", style: null, children: null };
    obj1[1] = tmp.title;
    obj1[2] = subheaderString;
    items2[1] = callback(require(4298) /* Text */.Text, obj1);
    obj2 = { variant: "text-sm/normal", style: null, children: null };
    obj2[1] = tmp.description;
    obj2[2] = bodyString;
    items2[2] = callback(require(4298) /* Text */.Text, obj2);
    obj[5] = items2;
