...
// Function ID: 12671
// Name: BetaPill
// Dependencies: [17, 6817, 21, 4285, 712, 4281, 1236, 12671, 1297, 4706, 4128, 8549, 2]
// Exports: default

// Module 12670 (BetaPill)
...
export default function PremiumGroupFeaturesTableCard(arg0) {
  ...
  const tmp = callback3();
  const tmp4 = importDefault(12671)(premiumGroupRole, false);
  if (null == tmp4) {
    return null;
  } else {
    ...
    obj[0] = { x: 0, y: 0 };
    obj[1] = { x: 1, y: 0 };
    let obj2 = require(4128) /* hexToRgba */;
    const items = [obj2.hexWithOpacity("#8547C6", 0.15), , ];
    const tmp2Result = tmp2(4706);
    items[1] = require(4128) /* hexToRgba */.hexWithOpacity("#B845C1", 0.15);
    const obj4 = require(4128) /* hexToRgba */;
    items[2] = require(4128) /* hexToRgba */.hexWithOpacity("#AB5D8A", 0.15);
    obj[2] = items;
    obj[3] = [0, 0.4996, 0.9593];
    obj[4] = tmp.premiumGroupCard;
    obj = { style: null, children: null };
    obj[0] = tmp.headerContainer;
    const items1 = [callback(tmp2(8549), { width: 181, height: 16 }), callback(BetaPill, {})];
    obj[1] = items1;
