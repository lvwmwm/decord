...
// Function ID: 12634
// Name: BetaPill
// Dependencies: [17, 6790, 21, 4255, 712, 4251, 1236, 12634, 1297, 4676, 4099, 8408, 2]
// Exports: default

// Module 12633 (BetaPill)
...
export default function PremiumGroupFeaturesTableCard(arg0) {
  ...
  const tmp = callback3();
  const tmp4 = importDefault(12634)(premiumGroupRole, false);
  if (null == tmp4) {
    return null;
  } else {
    ...
    const items1 = [callback(tmp2(8408), { width: 181, height: 16 }), callback(BetaPill, {})];
    obj[1] = items1;
