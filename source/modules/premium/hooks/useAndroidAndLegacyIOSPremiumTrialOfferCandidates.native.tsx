...
// Dependencies: [5858, 1905, 6913, 5861, 647, 2]
// Exports: useAndroidAndLegacyIOSPremiumTrialOfferCandidates

// Module 6912 (useAndroidAndLegacyIOSPremiumTrialOfferCandidates)
...
export const useAndroidAndLegacyIOSPremiumTrialOfferCandidates = function useAndroidAndLegacyIOSPremiumTrialOfferCandidates(arg0) {
  ...
  const trialOffer = offerIds(6913).useTrialOffer(closure_6);
  ...
  const obj2 = offerIds(6913);
  const trialOffer3 = offerIds(6913).useTrialOffer(closure_5);
  const values2 = Object.values(tmp(5861).TrialIdToProductOfferId[closure_5]);
  let tmp10 = null;
  if (values2.every((arg0) => offerIds.has(arg0))) {
    tmp10 = trialOffer3;
  }
  const tmpResult1 = offerIds(6913);
  const trialOffer4 = offerIds(6913).useTrialOffer(closure_7);
  ...
  const tmpResult2 = offerIds(6913);
  const trialOffer5 = offerIds(6913).useTrialOffer(closure_8);
