...
// Dependencies: [5654, 1852, 6224, 5657, 624, 2]
// Exports: useAndroidAndLegacyIOSPremiumTrialOfferCandidates

// Module 6223 (useGetTrialOffer)
...
function useGetTrialOffer(closure_3, offerIds) {
  ...
  const trialOffer = _require(6224).useTrialOffer(closure_3);
  const values = Object.values(_require(5657).TrialIdToProductOfferId[closure_3]);
  let tmp2 = null;
