...
// Dependencies: [7554, 1921, 4145, 1923, 586, 11117, 1945, 7567, 11118, 2]
...
// Module 11116 (usePremiumSince)
import initialize from "initialize" /* 586 */;
import getTieredTenureBadgeData from "getTieredTenureBadgeData" /* 7567 */;
import useTieredTenureBadgeForUser from "useTieredTenureBadgeForUser" /* 11117 */;
...
export const useTieredTenureBadgeData = function useTieredTenureBadgeData() {
  ...
  if (null != tieredTenureBadgeForUser1) {
    ...
    if (null != stateFromStores2) {
      ...
      if (null != stateFromStores2.premiumSince) {
        earnedOnDate = tmp(7567).getEarnedOnDate(tieredTenureBadgeForUser1, stateFromStores2.premiumSince);
  ...
  if (null != tmp6) {
    ...
    if (!result) {
      const earnedTenureBadge = tmp(7567).getEarnedTenureBadge(tmp13);
      if (null != earnedTenureBadge) {
        if (tmpResult5.shouldShowWithheldTenureBadge("useTieredTenureBadgeData")) {
          ...
          obj.earnedOnDate = tmp(7567).getEarnedOnDate(earnedTenureBadge, tmp13);
          obj.status = obj.WITHHELD;
          return obj;
        }
        tmpResult5 = tmp(11118);
      }
