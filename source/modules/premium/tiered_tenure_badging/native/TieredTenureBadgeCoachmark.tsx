...
// Function ID: 9434
// Name: CoachmarkImg
// Dependencies: [32, 19, 17, 676, 1369, 21, 4285, 9402, 5251, 7016, 1358, 5943, 1236, 5937, 8576, 2]
// Exports: default

// Module 9433 (CoachmarkImg)
...
function CoachmarkImg(badge) {
  ...
  if (null != badge) {
    ...
    obj1[0] = medium;
    obj[2] = obj1;
    obj[1] = jsx(importDefault(5251), { resizeMode: "contain", style: null, source: null });
...
export default function TieredTenureBadgeCoachmark(arg0) {
  ...
  const tieredTenureBadge = tieredTenureBadgeData(7016).getTieredTenureBadge(badgeId);
  ...
  let obj = tieredTenureBadgeData(7016);
  const coachmark = tieredTenureBadgeData(8576).useCoachmark(targetRef, memo);
  return null;
};
