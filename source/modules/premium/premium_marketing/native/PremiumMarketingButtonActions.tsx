...
// Dependencies: [7344, 1905, 676, 7352, 7756, 6886, 5861, 12677, 6016, 2]
// Exports: getButtonActionHandler

// Module 7755 (getButtonActionHandler)
...
export const getButtonActionHandler = function getButtonActionHandler(arg0) {
  ...
  if (require(7352) /* create */.ButtonAction.OPEN_SOCIAL_LAYER_STOREFRONT === buttonAction) {
    return () => {
      if (null != closure_0) {
