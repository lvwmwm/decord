...
// Function ID: 89846
// Name: createMockGame
// Dependencies: [4055, 11553, 2]

// Module 11552 (createMockGame)
function createMockGame(_1, name) {
  const obj = { id: _1, name, provider: require(4055) /* GameServerProviderType */.GameServerProviderType.SHOCKBYTE, plans: items1 };
