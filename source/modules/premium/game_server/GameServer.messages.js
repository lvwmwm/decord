...
const loader = module_1250.createLoader({
  ...
  () => {
    const jsonAsset = require(1215) /* loadJsonAsset */.loadJsonAsset(require(2627) /* registerAsset */);
    return jsonAsset.then((arg0) => ({ default: arg0 }));
  },
  () => {
  ...
  () => {
    const jsonAsset = require(1215) /* loadJsonAsset */.loadJsonAsset(require(2650) /* registerAsset */);
    return jsonAsset.then((arg0) => ({ default: arg0 }));
  },
  () => {
