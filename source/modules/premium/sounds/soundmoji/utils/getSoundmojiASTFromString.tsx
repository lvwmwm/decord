...
// Dependencies: [4930, 4701, 676, 4935, 4936, 4937, 4939, 1435, 2]
// Exports: default, getSoundmojiFromMessage

// Module 4929 (getSoundmojiASTFromString)
import getAvatarURL from "getAvatarURL" /* 1435 */;
import getSoundmojiRenderingExperiment from "getSoundmojiRenderingExperiment" /* 4935 */;
import isSoundValidDefault from "isSoundValid" /* 4936 */;
import getSoundStringDefault from "getSoundString" /* 4939 */;
import closure_3 from "handleSoundCreateOrUpdate" /* 4930 */;
...
export default function getSoundmojiASTFromString(soundId, guildId) {
  ...
  if (obj.getSoundmojiRenderingExperiment({ location: "getSoundmojiASTFromString" })) {
    ...
    if (null != messageId) {
      if (null != channelId) {
        const tmp16 = tmp8(4937)(channelId, messageId, tmp2, soundboardSounds);
        tmp5 = tmp16;
        if (tmp9) {
          tmp5 = tmp16;
          if (null == tmp16) {
...
export const getSoundmojiFromMessage = function getSoundmojiFromMessage(guildId, channelId, messageId, soundId, arg4) {
  if (obj.getSoundmojiRenderingExperiment({ location: "getSoundmojiASTFromString" })) {
    ...
    if (null != messageId) {
      if (null != channelId) {
        const tmp16 = tmp8(4937)(channelId, messageId, soundId, arg4);
        if (tmp9) {
          if (null == tmp16) {
            const message = store2.getMessage(channelId, messageId);
            let state;
