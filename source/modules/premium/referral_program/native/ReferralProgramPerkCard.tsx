...
// Dependencies: [19, 17, 6915, 676, 21, 4303, 712, 1297, 4299, 12718, 1236, 1974, 589, 5728, 5748, 6916, 698, 4271, 12719, 1988, 12726, 4714, 2]
// Exports: ReferralProgramPerkCard

// Module 12717 (ReferredFriendAvatar)
...
function ProgressIndicator(referralSentUsers) {
  ...
  const items = [];
  let num = 0;
  if (0 < require(12718) /* MAX_REFERRALS_SENT */.MAX_REFERRALS_SENT) {
    do {
      let tmp2 = num;
    ...
    } while (num < require(12718) /* MAX_REFERRALS_SENT */.MAX_REFERRALS_SENT);
  }
