...
// Dependencies: [19, 17, 6915, 676, 21, 4303, 712, 1297, 4299, 12720, 1236, 1974, 589, 5728, 5748, 6916, 698, 4271, 12721, 1988, 12728, 4714, 2]
// Exports: ReferralProgramPerkCard

// Module 12719 (ReferredFriendAvatar)
...
function ProgressIndicator(referralSentUsers) {
  ...
  const items = [];
  let num = 0;
  if (0 < require(12720) /* MAX_REFERRALS_SENT */.MAX_REFERRALS_SENT) {
    do {
      let tmp2 = num;
    ...
    } while (num < require(12720) /* MAX_REFERRALS_SENT */.MAX_REFERRALS_SENT);
  }
