...
// Dependencies: [19, 17, 6963, 676, 21, 4342, 712, 1297, 4338, 12784, 1236, 1993, 589, 5768, 5788, 6964, 698, 4310, 12785, 2007, 12792, 4755, 2]
// Exports: ReferralProgramPerkCard

// Module 12783 (ReferredFriendAvatar)
...
function ProgressIndicator(referralSentUsers) {
  ...
  const items = [];
  let num = 0;
  if (0 < require(12784) /* MAX_REFERRALS_SENT */.MAX_REFERRALS_SENT) {
    do {
      let tmp2 = num;
    ...
    } while (num < require(12784) /* MAX_REFERRALS_SENT */.MAX_REFERRALS_SENT);
  }
