...
// Function ID: 12886
// Name: SharedUser
// Dependencies: [17, 676, 21, 4661, 712, 4219, 7424, 1297, 4734, 1236, 4745, 6867, 4342, 4770, 1993, 6950, 6949, 4733, 5447, 2]
// Exports: default
...
function SharedUser(user) {
  ...
  if (tmp6) {
    ...
    obj2[3] = name;
    const items2 = [tmp9(tmp5(4734).Text, obj2), ];
    ...
    items2[1] = tmp9(tmp5(4734).Text, obj3);
    obj1[0] = items2;
    ...
    obj5[3] = name;
    tmp9Result = tmp9(tmp5(4734).Text, obj5);
  }
  items1[1] = tmp9Result;
