...
// Function ID: 12631
// Name: SharedUser
// Dependencies: [17, 676, 21, 4285, 712, 4124, 6825, 1297, 4281, 1236, 4695, 4781, 4253, 4295, 1945, 5338, 5337, 4693, 5936, 2]
// Exports: default

// Module 12630 (SharedUser)
...
function SharedUser(user) {
  ...
  obj = { style: items, size: tmp5(1297).AvatarSizes.REFRESH_MEDIUM_32, user, guildId: "add" };
...
export default function ReferralProgramShareConfirmationActionSheet(trialCreationResult) {
  ...
  obj1[1] = callback(tmp5(5936).FistBumpSpotIllustration, {});
  ...
  return callback(tmp5(5338).BottomSheet, obj);
};
