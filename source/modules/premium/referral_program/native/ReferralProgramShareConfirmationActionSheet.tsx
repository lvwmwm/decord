...
// Function ID: 13381
// Name: SharedUser
// Dependencies: [17, 673, 21, 4481, 709, 4325, 7387, 1296, 4477, 1233, 4936, 5032, 4448, 4494, 1994, 7090, 7089, 4934, 5647, 2]
// Exports: default

// Module 13380 (SharedUser)
...
function SharedUser(user) {
  ...
  const tmp6 = user.trialCreationResult === user(7387).CreateReferralStatus.FAIL;
  ...
  if (tmp6) {
    ...
    obj2[3] = name;
    const items2 = [tmp9(tmp5(4477).Text, obj2), ];
    ...
    items2[1] = tmp9(tmp5(4477).Text, obj3);
    obj1[0] = items2;
    ...
    obj5[3] = name;
    tmp9Result = tmp9(tmp5(4477).Text, obj5);
  }
  items1[1] = tmp9Result;
  const obj6 = { variant: "secondary", size: "sm", text: null, icon: null, onPress: null };
  const intl2 = tmp5(1233).intl;
  obj6[2] = intl2.string(user(1233).t["g33r/P"]);
  obj6[3] = closure_5(user(5032).ChatIcon, { size: "xs", color: ThemesDefault.colors.CONTROL_SECONDARY_TEXT_DEFAULT });
  ...
  items1[2] = closure_5(user(4936).Button, obj6);
  obj[1] = items1;
...
export default function ReferralProgramShareConfirmationActionSheet(trialCreationResult) {
  ...
  obj = { startExpanded: true, contentStyles: tmp.content, header: callback(tmp5(7089).BottomSheetTitleHeader, { title: null }), children: null };
  obj = { children: null };
  obj1 = { style: tmp.headerAsset, children: callback(tmp5(5647).FistBumpSpotIllustration, {}) };
  const items = [callback(View, obj1), callback(tmp5(4477).Text, { variant: "heading-lg/bold", color: "mobile-text-heading-primary", style: tmp.header, children: stringResult }), , ];
  ...
  items[2] = callback(tmp5(4477).Text, { variant: "text-md/medium", color: "text-default", style: tmp.subheader, children: intl3.format(tmp5(1233).t.AwGSWl, obj) });
  ...
  obj[0] = items;
  obj[3] = callback2(tmp5(4934).Stack, obj);
  return callback(tmp5(7090).BottomSheet, obj);
};
