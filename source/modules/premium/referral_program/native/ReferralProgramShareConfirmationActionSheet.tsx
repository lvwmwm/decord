...
// Function ID: 12597
// Name: SharedUser
// Dependencies: [17, 676, 21, 4255, 712, 4094, 6813, 1297, 4251, 1236, 4666, 4752, 4223, 4265, 1945, 5309, 5308, 4664, 5926, 2]
// Exports: default

// Module 12596 (SharedUser)
...
function SharedUser(user) {
  ...
  const tmp6 = user.trialCreationResult === user(6813).CreateReferralStatus.FAIL;
  ...
  obj6[3] = closure_5(user(4752).ChatIcon, obj7);
  ...
  items1[2] = closure_5(user(4666).Button, obj6);
  obj[1] = items1;
...
export default function ReferralProgramShareConfirmationActionSheet(trialCreationResult) {
  ...
  obj[2] = callback(tmp5(5308).BottomSheetTitleHeader, { title: null });
  obj = { children: null };
  obj1 = { style: tmp.headerAsset, children: null };
  obj1[1] = callback(tmp5(5926).FistBumpSpotIllustration, {});
  ...
  obj[0] = items;
  obj[3] = callback2(tmp5(4664).Stack, obj);
  return callback(tmp5(5309).BottomSheet, obj);
};
