// Module ID: 9401
// Function ID: 9402
// Dependencies: [19, 4247, 21, 589, 4665, 7597, 712, 2]
...
const memoResult = require("noop").memo(function NitroUpsellButton(shiny) {
  ...
  obj[4] = jsx(require(7597) /* NitroWheelIcon */.NitroWheelIcon, { color: null, size: "sm" });
  if (flag) {
    flag = !stateFromStores;
  }
  obj[6] = flag;
  return jsx(require(4665) /* Button */.Button, { color: null, size: "sm" });
});
