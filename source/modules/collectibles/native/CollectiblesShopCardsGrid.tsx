...
// Dependencies: [19, 17, 5301, 21, 4661, 9172, 9175, 14967, 12, 2]
// Exports: default
...
function ShopCardGridItem(index) {
  ...
  obj[1] = jsx(importDefault(9172), { unpublishedAt, product, cardWidth, preferVCPrice, disableBundleStaticBackground, muteBundleStaticBackground });
  return jsx(index(9175).CollectiblesAnalyticsProvider, { newValue: memo, children: null });
}
