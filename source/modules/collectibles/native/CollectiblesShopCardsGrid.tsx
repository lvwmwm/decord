...
// Dependencies: [19, 17, 7043, 21, 4344, 9390, 9393, 14913, 12, 2]
// Exports: default
...
function ShopCardGridItem(index) {
  ...
  obj[1] = jsx(importDefault(9390), { unpublishedAt, product, cardWidth, preferVCPrice, disableBundleStaticBackground, muteBundleStaticBackground });
  return jsx(index(9393).CollectiblesAnalyticsProvider, { newValue: memo, children: null });
}
...
export default function CollectiblesShopCardsGrid(accessibilityLabel) {
  ...
  obj = { gap: products(9390).COLLECTIBLES_SHOP_CARD_GAP, paddingTop, paddingBottom };
  obj[5] = obj;
  obj[6] = memo.map((arr) => {
    let closure_0 = arg1;
