...
// Dependencies: [19, 17, 5798, 21, 4189, 8657, 8660, 14616, 12, 2]
// Exports: default

// Module 14617 (ShopCardGridItem)
...
function ShopCardGridItem(index) {
  ...
  obj[1] = jsx(importDefault(8657), { unpublishedAt, product, cardWidth, preferVCPrice, disableBundleStaticBackground, muteBundleStaticBackground });
  return jsx(index(8660).CollectiblesAnalyticsProvider, { newValue: memo, children: null });
}
...
export default function CollectiblesShopCardsGrid(accessibilityLabel) {
  ...
  obj = { gap: products(8657).COLLECTIBLES_SHOP_CARD_GAP, paddingTop, paddingBottom };
  obj[5] = obj;
  obj[6] = memo.map((arr) => {
    let closure_0 = arg1;
