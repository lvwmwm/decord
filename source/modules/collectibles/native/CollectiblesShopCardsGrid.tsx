...
// Dependencies: [19, 17, 6941, 21, 4302, 9279, 9282, 14773, 12, 2]
// Exports: default

// Module 14774 (ShopCardGridItem)
...
function ShopCardGridItem(index) {
  ...
  obj[1] = jsx(importDefault(9279), { unpublishedAt, product, cardWidth, preferVCPrice, disableBundleStaticBackground, muteBundleStaticBackground });
  return jsx(index(9282).CollectiblesAnalyticsProvider, { newValue: memo, children: null });
}
...
export default function CollectiblesShopCardsGrid(accessibilityLabel) {
  ...
  obj = { gap: products(9279).COLLECTIBLES_SHOP_CARD_GAP, paddingTop, paddingBottom };
  obj[5] = obj;
  obj[6] = memo.map((arr) => {
    let closure_0 = arg1;
