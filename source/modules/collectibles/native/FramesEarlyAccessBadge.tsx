...
// Dependencies: [32, 19, 17, 21, 4344, 712, 4280, 1236, 8699, 1363, 7745, 4340, 9449, 5754, 2]
// Exports: default

// Module 9485 (BadgeWithTooltip)
...
function StaticBadge() {
  ...
  const items1 = [callback2(require(7745) /* NitroWheelIcon */.NitroWheelIcon, { size: "xs", color: str }), ];
...
export default function _default(tooltipPosition) {
  ...
  if (!obj.useIsProfileFramesEarlyAccessPhase(tooltipPosition.location)) {
    ...
    tmp3Result = tmp3(require(5754) /* Layer */.LayerScope, obj);
  }
};
