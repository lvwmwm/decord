...
// Function ID: 13069
// Name: memo
// Dependencies: [32, 19, 17, 675, 21, 4481, 709, 13069, 6595, 1233, 7487, 13070, 4477, 2]
// Exports: default
...
export default function BundleProductDetailsActionSheetPreview(arg0) {
  ...
  let obj = onActiveItemChange(7487);
  ...
  const items2 = [
    callback6(onActiveItemChange(13070).IndividualProductPreview, {
      product: callback4(() => {
  ...
  const items3 = [callback6(onActiveItemChange(4477).Text, { variant: "heading-xl/bold", children: product.name }), ];
  ...
  items3[1] = callback6(onActiveItemChange(4477).Text, obj3);
  obj1[1] = items3;
  ...
  if (tmp18Result) {
    ...
    tmp18Result = callback6(tmp12(4477).Text, obj6);
  }
  items6[1] = tmp18Result;
  items5[1] = callback7(onActiveItemChange(4477).Text, { variant: "text-sm/medium", color: "text-default", children: items6 });
  obj5[1] = items5;
