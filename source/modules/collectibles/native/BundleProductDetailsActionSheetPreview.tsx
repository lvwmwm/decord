...
// Function ID: 8752
// Name: memo
// Dependencies: [32, 19, 17, 678, 21, 4193, 712, 8752, 5277, 1236, 5815, 8753, 4189, 2]
// Exports: default
...
let closure_16 = memo((arg0) => {
  ...
  return callback6(require(5277) /* Directions */.GestureDetector, obj);
});
...
export default function BundleProductDetailsActionSheetPreview(arg0) {
  ...
  let obj = onActiveItemChange(5815);
  ...
  const items2 = [
    callback6(onActiveItemChange(8753).IndividualProductPreview, {
      product: callback4(() => {
  ...
  const items3 = [callback6(onActiveItemChange(4189).Text, { variant: "heading-xl/bold", children: product.name }), ];
  ...
  items3[1] = callback6(onActiveItemChange(4189).Text, obj3);
  obj1[1] = items3;
  ...
  if (tmp18Result) {
    ...
    tmp18Result = callback6(tmp12(4189).Text, obj6);
  }
  items6[1] = tmp18Result;
  items5[1] = callback7(onActiveItemChange(4189).Text, { variant: "text-sm/medium", color: "text-default", children: items6 });
  obj5[1] = items5;
