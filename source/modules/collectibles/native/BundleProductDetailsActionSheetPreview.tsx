...
// Function ID: 12510
// Name: memo
// Dependencies: [32, 19, 17, 678, 21, 4448, 712, 12510, 5620, 1236, 7267, 12511, 4444, 2]
// Exports: default
...
export default function BundleProductDetailsActionSheetPreview(arg0) {
  ...
  let obj = onActiveItemChange(7267);
  ...
  const items2 = [
    callback6(onActiveItemChange(12511).IndividualProductPreview, {
      product: callback4(() => {
  ...
  const items3 = [callback6(onActiveItemChange(4444).Text, { variant: "heading-xl/bold", children: product.name }), ];
  ...
  items3[1] = callback6(onActiveItemChange(4444).Text, obj3);
  obj1[1] = items3;
  ...
  if (tmp18Result) {
    ...
    tmp18Result = callback6(tmp12(4444).Text, obj6);
  }
  items6[1] = tmp18Result;
  items5[1] = callback7(onActiveItemChange(4444).Text, { variant: "text-sm/medium", color: "text-default", children: items6 });
  obj5[1] = items5;
