...
// Function ID: 9379
// Name: memo
// Dependencies: [32, 19, 17, 678, 21, 4302, 712, 9379, 5426, 1236, 6953, 9380, 4298, 2]
// Exports: default
...
let closure_16 = memo((arg0) => {
  ...
  return callback6(require(5426) /* Directions */.GestureDetector, obj);
});
...
export default function BundleProductDetailsActionSheetPreview(arg0) {
  ...
  let obj = onActiveItemChange(6953);
  ...
  const items2 = [
    callback6(onActiveItemChange(9380).IndividualProductPreview, {
      product: callback4(() => {
  ...
  const items3 = [callback6(onActiveItemChange(4298).Text, { variant: "heading-xl/bold", children: product.name }), ];
  ...
  items3[1] = callback6(onActiveItemChange(4298).Text, obj3);
  obj1[1] = items3;
  ...
  if (tmp18Result) {
    ...
    tmp18Result = callback6(tmp12(4298).Text, obj6);
  }
  items6[1] = tmp18Result;
  items5[1] = callback7(onActiveItemChange(4298).Text, { variant: "text-sm/medium", color: "text-default", children: items6 });
  obj5[1] = items5;
