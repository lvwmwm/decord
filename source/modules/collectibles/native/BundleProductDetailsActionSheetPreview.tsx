...
// Function ID: 9362
// Name: memo
// Dependencies: [32, 19, 17, 678, 21, 4285, 712, 9362, 5368, 1236, 6922, 9363, 4281, 2]
// Exports: default
...
let closure_16 = memo((arg0) => {
  ...
  return callback6(require(5368) /* Directions */.GestureDetector, obj);
});
...
export default function BundleProductDetailsActionSheetPreview(arg0) {
  ...
  let obj = onActiveItemChange(6922);
  ...
  const items2 = [
    callback6(onActiveItemChange(9363).IndividualProductPreview, {
      product: callback4(() => {
  ...
  const items3 = [callback6(onActiveItemChange(4281).Text, { variant: "heading-xl/bold", children: product.name }), ];
  ...
  items3[1] = callback6(onActiveItemChange(4281).Text, obj3);
  obj1[1] = items3;
  ...
  if (tmp18Result) {
    ...
    tmp18Result = callback6(tmp12(4281).Text, obj6);
  }
  items6[1] = tmp18Result;
  items5[1] = callback7(onActiveItemChange(4281).Text, { variant: "text-sm/medium", color: "text-default", children: items6 });
  obj5[1] = items5;
