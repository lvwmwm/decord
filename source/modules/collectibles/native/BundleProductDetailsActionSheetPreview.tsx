...
// Function ID: 8929
// Name: memo
// Dependencies: [32, 19, 17, 678, 21, 4255, 712, 8929, 5339, 1236, 6910, 8930, 4251, 2]
// Exports: default
...
let closure_16 = memo((arg0) => {
  ...
  return callback6(require(5339) /* Directions */.GestureDetector, obj);
});
...
export default function BundleProductDetailsActionSheetPreview(arg0) {
  ...
  let obj = onActiveItemChange(6910);
  ...
  const items2 = [
    callback6(onActiveItemChange(8930).IndividualProductPreview, {
      product: callback4(() => {
