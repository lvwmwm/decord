...
// Function ID: 12456
// Name: memo
// Dependencies: [32, 19, 17, 678, 21, 4445, 712, 12456, 5604, 1236, 7232, 12457, 4441, 2]
// Exports: default
...
export default function BundleProductDetailsActionSheetPreview(arg0) {
  ...
  let obj = onActiveItemChange(7232);
  ...
  const items2 = [
    callback6(onActiveItemChange(12457).IndividualProductPreview, {
      product: callback4(() => {
  ...
  const items3 = [callback6(onActiveItemChange(4441).Text, { variant: "heading-xl/bold", children: product.name }), ];
  ...
  items3[1] = callback6(onActiveItemChange(4441).Text, obj3);
  obj1[1] = items3;
  ...
  if (tmp18Result) {
    ...
    tmp18Result = callback6(tmp12(4441).Text, obj6);
  }
  items6[1] = tmp18Result;
  items5[1] = callback7(onActiveItemChange(4441).Text, { variant: "text-sm/medium", color: "text-default", children: items6 });
  obj5[1] = items5;
