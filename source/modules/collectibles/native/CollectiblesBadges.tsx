...
export const LockBadge = function LockBadge(isNew) {
  ...
  if (flag) {
    ...
    obj[2] = items1;
    let tmp7 = callback2(importDefault(8214), obj);
    const tmp11 = importDefault(8214);
  } else {
