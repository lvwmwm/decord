...
// Dependencies: [19, 5798, 6957, 678, 21, 589, 5801, 9502, 1236, 4713, 4298, 7644, 2]
// Exports: UnlockWithNitroButton

// Module 12101 (UnlockWithNitroButton)
import "noop";
...
export const UnlockWithNitroButton = function UnlockWithNitroButton(shouldShrink) {
  ...
  importDefault = importDefault(9502)();
  if (text == null) {
  ...
  obj[4] = str;
  obj[6] = jsx(require(7644) /* NitroWheelIcon */.NitroWheelIcon, { size: "sm", color: "white" });
  ...
  return jsx(require(4713) /* CollapsingText */.BaseTextButton, { textElement: tmp4Result, text: null, accessibilityLabel: null, variant: "primary", size: null, grow: true, icon: null, onPress: null, disabled: null });
};
