...
// Dependencies: [19, 5858, 7017, 678, 21, 589, 5861, 9567, 1236, 4715, 4299, 7704, 2]
// Exports: UnlockWithNitroButton

// Module 12170 (UnlockWithNitroButton)
import "noop";
...
export const UnlockWithNitroButton = function UnlockWithNitroButton(shouldShrink) {
  ...
  importDefault = importDefault(9567)();
  if (text == null) {
  ...
  obj[4] = str;
  obj[6] = jsx(require(7704) /* NitroWheelIcon */.NitroWheelIcon, { size: "sm", color: "white" });
  ...
  return jsx(require(4715) /* CollapsingText */.BaseTextButton, { textElement: tmp4Result, text: null, accessibilityLabel: null, variant: "primary", size: null, grow: true, icon: null, onPress: null, disabled: null });
};
