...
// Dependencies: [32, 19, 7086, 1388, 21, 6063, 1377, 15944, 11586, 1236, 15946, 647, 13400, 7067, 10047, 2]
// Exports: default

// Module 15945 (CoachmarkVariant)
...
function CoachmarkVariant(shopButtonRef) {
  ...
  obj[4] = tmp3;
  const items = [callback2(importDefault(15944), obj), callback2(importDefault(15946), { marketing, shopButtonRef, navigateToShop, visible: tmp3, onDismiss: tmp[1] })];
  obj[0] = items;
