...
// Dependencies: [5, 32, 19, 676, 3, 11888, 5797, 4157, 9790, 1577, 11814, 3850, 3890, 1236, 2]
// Exports: default, useHandleBuyNow

// Module 11909 (useHandleBuyNow)
        ...
        try {
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              obj1[0] = outer1_0(5797).fetchCollectiblesPurchases();
              return obj1;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
