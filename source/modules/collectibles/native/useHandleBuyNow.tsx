...
// Dependencies: [5, 32, 19, 676, 3, 10720, 7254, 4415, 10786, 1624, 6129, 4124, 4164, 1236, 2]
// Exports: default, useHandleBuyNow

// Module 12542 (useHandleBuyNow)
        ...
        try {
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              obj1[0] = closure_1_0(7254).fetchCollectiblesPurchases();
              return obj1;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
