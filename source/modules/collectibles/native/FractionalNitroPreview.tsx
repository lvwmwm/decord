...
// Dependencies: [19, 17, 676, 21, 4342, 712, 1236, 4766, 5308, 9608, 9609, 5403, 4338, 2]
// Exports: FractionalNitroPreview

// Module 9607 (FractionalNitroPreview)
import "noop";
...
export const FractionalNitroPreview = function FractionalNitroPreview() {
  ...
  const obj1 = { uri: null };
  obj1[0] = importDefault(9608);
  obj[0] = obj1;
  obj[1] = tmp.headerImage;
  items1[1] = callback(importDefault(5308), obj);
  const tmp2 = importDefault(5308);
  items1[2] = callback(View, { style: tmp.nitroIconContainer, children: callback(importDefault(9609), {}) });
  const obj2 = { style: tmp.nitroIconContainer, children: callback(importDefault(9609), {}) };
