...
// Dependencies: [19, 17, 676, 21, 4255, 712, 1236, 4676, 5221, 9448, 9449, 5289, 4251, 2]
// Exports: FractionalNitroPreview

// Module 9447 (FractionalNitroPreview)
import "noop";
...
export const FractionalNitroPreview = function FractionalNitroPreview() {
  ...
  const items1 = [callback(importDefault(4676), obj), , , ];
  obj = { source: null, style: null };
  const obj1 = { uri: null };
  obj1[0] = importDefault(9448);
  obj[0] = obj1;
  obj[1] = tmp.headerImage;
  items1[1] = callback(importDefault(5221), obj);
  const tmp2 = importDefault(5221);
  items1[2] = callback(View, { style: tmp.nitroIconContainer, children: callback(importDefault(9449), {}) });
  const obj2 = { style: tmp.nitroIconContainer, children: callback(importDefault(9449), {}) };
