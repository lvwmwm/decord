...
// Dependencies: [19, 17, 676, 21, 4303, 712, 1236, 4725, 5268, 9559, 9560, 5363, 4299, 2]
// Exports: FractionalNitroPreview

// Module 9558 (FractionalNitroPreview)
import "noop";
...
export const FractionalNitroPreview = function FractionalNitroPreview() {
  ...
  const obj1 = { uri: null };
  obj1[0] = importDefault(9559);
  obj[0] = obj1;
  obj[1] = tmp.headerImage;
  items1[1] = callback(importDefault(5268), obj);
  const tmp2 = importDefault(5268);
  items1[2] = callback(View, { style: tmp.nitroIconContainer, children: callback(importDefault(9560), {}) });
  const obj2 = { style: tmp.nitroIconContainer, children: callback(importDefault(9560), {}) };
