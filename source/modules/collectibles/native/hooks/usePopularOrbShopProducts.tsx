...
// Dependencies: [5, 57, 31, 14074, 1850, 5780, 5782, 655, 664, 5791, 566, 3811, 14075, 658, 14076, 14077, 659, 11897, 14078, 8657, 14079, 14081, 2]
// Exports: usePopularOrbShopProducts

// Module 14073 (_createForOfIteratorHelperLoose)
...
export const usePopularOrbShopProducts = function usePopularOrbShopProducts(enabled) {
  ...
  const tmp8 = first;
  const canUseShopDiscountsResult = first(3811).canUseShopDiscounts(stateFromStores);
  if (enabled(14075).BountiesShopCarouselExperimentVariation.POPULARITY === variation) {
    POPULARITY = enabled(658).CollectibleSearchSortType.POPULARITY;
  } else if (enabled(14075).BountiesShopCarouselExperimentVariation.RECENCY === variation) {
    POPULARITY = enabled(658).CollectibleSearchSortType.RECENCY;
  } else {
    const BASE = enabled(14075).BountiesShopCarouselExperimentVariation.BASE;
    POPULARITY = enabled(658).CollectibleSearchSortType.POPULARITY;
  }
  ...
  const filteredAndSortedProducts = enabled(14081).useFilteredAndSortedProducts(obj);
