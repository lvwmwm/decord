...
// Function ID: 14621
// Name: feedBlock
// Dependencies: [19, 17, 4181, 1302, 5643, 678, 676, 21, 4189, 712, 589, 4035, 14097, 14621, 14099, 5797, 5535, 5515, 1236, 4185, 4717, 4157, 14622, 1959, 4145, 4600, 14615, 14623, 500, 6205, 14624, 5141, 14625, 14626, 2]
// Exports: default

// Module 14620 (feedBlock)
...
export default function _default(feedBlock) {
  ...
  let tmp6 = stateFromStores1(14097)();
  dependencyMap = tmp6;
  ...
  obj1[1] = items5;
  const items6 = [closure_12(closure_5, obj1), callback(stateFromStores1(14615), { products: filteredAndSortedProducts, loadingCardsNum: 36, preferVCPrice, accessibilityLabel: stringResult, disableBundleStaticBackground }), ];
