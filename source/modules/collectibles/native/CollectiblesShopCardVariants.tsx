...
// Function ID: 9320
// Name: VariantOption
// Dependencies: [19, 17, 21, 4255, 712, 9302, 9320, 5289, 9321, 9234, 6906, 2]

// Module 9319 (VariantOption)
...
function VariantCheckmark(variant) {
  ...
  return tmp2(require(5289) /* CheckmarkSmallIcon */.CheckmarkSmallIcon, { color: importDefault(9320)(variant.variant) ? colors.BLACK : colors.WHITE, size: "xxs" });
}
function VariantOverflowOption(isSelected) {
  ...
  obj[1] = callback(require(9321) /* PlusSmallIcon */.PlusSmallIcon, obj);
