...
// Function ID: 9349
// Name: VariantOption
// Dependencies: [19, 17, 21, 4285, 712, 9331, 9349, 5343, 9350, 9263, 6933, 2]

// Module 9348 (VariantOption)
...
function VariantCheckmark(variant) {
  ...
  return tmp2(require(5343) /* CheckmarkSmallIcon */.CheckmarkSmallIcon, { color: importDefault(9349)(variant.variant) ? colors.BLACK : colors.WHITE, size: "xxs" });
}
