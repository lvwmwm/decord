...
// Function ID: 9437
// Name: VariantOption
// Dependencies: [19, 17, 21, 4303, 712, 9419, 9437, 5363, 9438, 9351, 7015, 2]

// Module 9436 (VariantOption)
...
function VariantCheckmark(variant) {
  ...
  return tmp2(require(5363) /* CheckmarkSmallIcon */.CheckmarkSmallIcon, { color: importDefault(9437)(variant.variant) ? colors.BLACK : colors.WHITE, size: "xxs" });
}
function VariantOverflowOption(isSelected) {
  ...
  obj[1] = callback(require(9438) /* PlusSmallIcon */.PlusSmallIcon, obj);
