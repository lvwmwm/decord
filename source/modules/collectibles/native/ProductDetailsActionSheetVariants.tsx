...
// Function ID: 9506
// Name: VariantOption
// Dependencies: [19, 17, 21, 4302, 712, 9348, 4844, 1236, 9366, 5362, 6952, 4298, 2]
// Exports: default

// Module 9505 (VariantOption)
import "noop";
...
function VariantOption(onPress) {
  ...
  return closure_4(require(4844) /* PressableBase */.PressableOpacity, obj);
}
function VariantCheckmark(variant) {
  const colors = importDefault(712).colors;
  const tmp = importDefault(9366)(variant.variant);
  const tmp2 = closure_4;
  return tmp2(require(5362) /* CheckmarkSmallIcon */.CheckmarkSmallIcon, { color: importDefault(9366)(variant.variant) ? colors.BLACK : colors.WHITE, size: "md" });
}
