...
// Dependencies: [19, 17, 4473, 21, 4481, 709, 5579, 4731, 8780, 11022, 586, 5542, 11712, 8237, 11713, 7063, 8775, 4477, 1233, 4936, 8098, 8778, 6940, 2]
// Exports: default

// Module 13088 (OrbBadgeCollectedRootScreen)
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    obj1 = { uri: null };
    obj1[0] = onPressViewBadge(11712);
    obj[0] = obj1;
    obj[1] = tmp.background;
    let tmp9Result = tmp9(onPressViewBadge(5542), obj);
    let tmp12 = onPressViewBadge;
    let tmp13 = tmp9;
    const tmp15 = onPressViewBadge(5542);
  } else {
    const obj2 = { source: null, poster: null, style: null, resizeMode: "contain", muted: true, pauseWhileAppInactive: true, paused: false };
    const obj3 = { uri: null };
    obj3[0] = onPressViewBadge(11713);
    obj2[0] = obj3;
    obj2[1] = onPressViewBadge(11712);
    obj2[2] = tmp.background;
    tmp9Result = tmp9(tmp2(8237).VideoComponent, obj2);
  ...
  const obj7 = { uri: tmp12(8775) };
  obj6[0] = obj7;
  obj6[1] = tmp.orbBadge;
  const items4 = [tmp13(tmp12(5542), obj6), ];
  ...
  const items5 = [tmp13(modalKey(4477).Text, obj10), ];
  ...
  items5[1] = tmp13(modalKey(4477).Text, obj11);
  obj9[1] = items5;
  ...
  items3[1] = tmp13(modalKey(7063).SafeAreaPaddingView, obj4);
  obj[1] = items3;
