...
// Dependencies: [17, 9207, 21, 4661, 712, 5449, 9209, 9210, 2]
// Exports: default
...
export default function ProfileEffectSample(hideBackground) {
  ...
  items2[1] = tmp4Result;
  items2[2] = callback(importDefault(9210), { skuId: hideBackground.item.skuId, bannerAdjustment: 0, useThumbnail: true });
  obj[1] = items2;
