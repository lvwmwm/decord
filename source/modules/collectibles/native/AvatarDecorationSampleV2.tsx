...
// Dependencies: [19, 17, 21, 4193, 712, 38, 1901, 8072, 7973, 2]
// Exports: default
...
export default function AvatarDecorationSampleV2(arg0) {
  ...
  if (null == avatarSource) {
    avatarSource = tmp2(8072);
  }
  obj = { children: null };
  obj[2] = avatarSource;
  const items1 = [closure_5(closure_3, obj), ];
  obj = { style: tmp.avatarDecoration, accessibilityLabel: item.label, children: tmp8(tmp2(7973), { avatarDecoration: item, size, animate }) };
