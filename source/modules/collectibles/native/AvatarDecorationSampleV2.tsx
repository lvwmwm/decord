...
// Dependencies: [19, 17, 21, 4189, 712, 38, 1901, 8065, 7966, 2]
// Exports: default

// Module 8064 (AvatarDecorationSampleV2)
import "noop";
...
export default function AvatarDecorationSampleV2(arg0) {
  ...
  if (null == avatarSource) {
    avatarSource = tmp2(8065);
  }
  obj = { children: null };
  obj[2] = avatarSource;
  const items1 = [closure_5(closure_3, obj), ];
  obj = { style: tmp.avatarDecoration, accessibilityLabel: item.label, children: tmp8(tmp2(7966), { avatarDecoration: item, size, animate }) };
