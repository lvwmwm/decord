...
// Dependencies: [19, 17, 21, 4380, 712, 38, 1950, 9535, 8446, 2]
// Exports: default

// Module 9534 (AvatarDecorationSampleV2)
...
export default function AvatarDecorationSampleV2(arg0) {
  ...
  if (null == avatarSource) {
    avatarSource = tmp2(9535);
  }
  obj = { children: null };
  obj[2] = avatarSource;
  const items1 = [closure_5(closure_3, obj), ];
  obj = { style: tmp.avatarDecoration, accessibilityLabel: item.label, children: tmp8(tmp2(8446), { avatarDecoration: item, size, animate }) };
