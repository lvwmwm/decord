...
// Dependencies: [19, 17, 21, 4285, 712, 38, 1901, 9306, 8102, 2]
// Exports: default

// Module 9305 (AvatarDecorationSampleV2)
import "noop";
...
export default function AvatarDecorationSampleV2(arg0) {
  ...
  if (null == avatarSource) {
    avatarSource = tmp2(9306);
  }
  obj = { children: null };
  obj[2] = avatarSource;
  const items1 = [closure_5(closure_3, obj), ];
  obj = { style: tmp.avatarDecoration, accessibilityLabel: item.label, children: tmp8(tmp2(8102), { avatarDecoration: item, size, animate }) };
