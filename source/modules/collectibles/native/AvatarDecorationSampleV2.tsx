...
// Dependencies: [19, 17, 21, 4446, 712, 38, 1951, 8466, 8043, 2]
// Exports: default

// Module 8465 (AvatarDecorationSampleV2)
...
export default function AvatarDecorationSampleV2(arg0) {
  ...
  if (null == avatarSource) {
    avatarSource = tmp2(8466);
  }
  obj = { children: null };
  obj[2] = avatarSource;
  const items1 = [closure_5(closure_3, obj), ];
  obj = { style: tmp.avatarDecoration, accessibilityLabel: item.label, children: tmp8(tmp2(8043), { avatarDecoration: item, size, animate }) };
