...
// Dependencies: [19, 17, 21, 4303, 9348, 9447, 9419, 1236, 2]
// Exports: OrbBadgePreview

// Module 9561 (OrbBadgePreview)
import "noop";
...
export const OrbBadgePreview = function OrbBadgePreview() {
  ...
  const tmp = callback();
  const tmp3 = importDefault(9447);
  const items = [require(9419) /* hasAtLeastOneGPlaySynced */.createOrbProfileBadge()];
  obj[2] = items;
