...
// Dependencies: [19, 17, 21, 4255, 9237, 9336, 9308, 1236, 2]
// Exports: OrbBadgePreview

// Module 9450 (OrbBadgePreview)
import "noop";
...
export const OrbBadgePreview = function OrbBadgePreview() {
  ...
  const tmp = callback();
  const tmp3 = importDefault(9336);
  const items = [require(9308) /* hasAtLeastOneGPlaySynced */.createOrbProfileBadge()];
  obj[2] = items;
