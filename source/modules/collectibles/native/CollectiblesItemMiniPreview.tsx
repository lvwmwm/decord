...
// Function ID: 9334
// Name: PX_8
// Dependencies: [19, 17, 6900, 1899, 6901, 6902, 8712, 9265, 21, 712, 4255, 9276, 9284, 5221, 9285, 9268, 1898, 9279, 2]
...
const memoResult = require("noop").memo(function CollectiblesItemMiniPreview(arg0) {
  ...
  if (isAvatarDecorationRecord(item)) {
    ...
    obj[0] = item;
    obj[1] = 0.75 * size;
    obj[1] = callback(importDefault(9276), obj);
    ...
    obj2[1] = callback(importDefault(9284), obj3);
    ...
    const obj7 = { uri: null };
    obj7[0] = importDefault(9285);
    obj6[0] = obj7;
    obj6[1] = tmp.sampleProfile;
    const items1 = [callback(importDefault(5221), obj6), ];
    const obj8 = { skuId: null, bannerAdjustment: 0, useThumbnail: true };
    obj8[0] = item.skuId;
    items1[1] = callback(importDefault(9268), obj8);
    obj5[3] = items1;
    ...
    obj10[1] = callback(importDefault(9279), obj11);
