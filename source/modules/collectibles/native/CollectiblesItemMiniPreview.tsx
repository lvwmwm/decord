...
// Function ID: 9451
// Name: PX_8
// Dependencies: [19, 17, 7009, 1947, 7010, 7011, 8824, 9382, 21, 712, 4303, 9393, 9401, 5268, 9402, 9385, 1946, 9396, 2]
...
const memoResult = require("noop").memo(function CollectiblesItemMiniPreview(arg0) {
  ...
  if (isAvatarDecorationRecord(item)) {
    ...
    obj[0] = item;
    obj[1] = 0.75 * size;
    obj[1] = callback(importDefault(9393), obj);
    ...
    obj2[1] = callback(importDefault(9401), obj3);
    ...
    obj8[0] = item.skuId;
    items1[1] = callback(importDefault(9385), obj8);
    obj5[3] = items1;
    ...
    obj10[1] = callback(importDefault(9396), obj11);
