...
// Function ID: 14757
// Name: SkeletonGrid
// Dependencies: [19, 17, 21, 4285, 9262, 14757, 14238, 14758, 2]
// Exports: default

// Module 14756 (SkeletonGrid)
import "noop";
...
function SkeletonGrid(accessibilityLabel) {
  ...
  for (let num = 0; num < loadingCardsNum; num = num + columns) {
    ...
    obj[1] = arr.map((arg0, arg1) => {
      ...
      obj[1] = obj;
      return jsx(importDefault(14238), { marginBottom: null }, "" + num + "-" + arg1);
    });
...
export default function FeedProductList(arg0) {
  ...
  if (0 === products.length) {
    ...
    obj[3] = tmp3;
    tmp7 = jsx(importDefault(14758), { products: null, preferVCPrice: null, accessibilityLabel: null, disableBundleStaticBackground: null });
  }
  return tmp7;
};
