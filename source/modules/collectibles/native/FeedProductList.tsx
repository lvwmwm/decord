...
// Function ID: 14855
// Name: SkeletonGrid
// Dependencies: [19, 17, 21, 4303, 9350, 14855, 14332, 14856, 2]
// Exports: default

// Module 14854 (SkeletonGrid)
import "noop";
...
function SkeletonGrid(accessibilityLabel) {
  ...
  for (let num = 0; num < loadingCardsNum; num = num + columns) {
    ...
    obj[1] = arr.map((arg0, arg1) => {
      ...
      obj[0] = require(9350) /* CollectiblesShopCardInternalV2 */.COLLECTIBLES_SHOP_CARD_GAP;
      obj[1] = obj;
      return jsx(importDefault(14332), { marginBottom: null }, "" + num + "-" + arg1);
    });
...
export default function FeedProductList(arg0) {
  ...
  if (0 === products.length) {
    ...
    obj[3] = tmp3;
    tmp7 = jsx(importDefault(14856), { products: null, preferVCPrice: null, accessibilityLabel: null, disableBundleStaticBackground: null });
  }
  return tmp7;
};
