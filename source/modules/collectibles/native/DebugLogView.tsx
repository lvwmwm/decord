...
// Function ID: 14640
// Name: DebugLogView
// Dependencies: [19, 17, 4188, 5813, 21, 4189, 712, 589, 4185, 2]
// Exports: default

// Module 14639 (DebugLogView)
...
export default function DebugLogView() {
  ...
  if (stateFromStores) {
    if (0 !== arr.length) {
      ...
      obj1[2] = items2;
      const items3 = [callback2(tmp2(4185).Text, obj1), ];
      ...
      obj3[2] = callback3(tmp2(4185).Text, obj4);
      items3[1] = callback3(closure_5, obj3);
      obj[1] = items3;
      const items4 = [callback2(stateFromStores, obj), ];
      const obj5 = { children: null };
      obj5[0] = substr.map((children) => outer1_10(arr(4185).Text, { variant: "text-xs/normal", style: tmp.debugLogText, children }, arg1));
