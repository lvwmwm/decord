...
// Dependencies: [19, 678, 21, 5967, 2]
// Exports: FractionalNitroCoinIllustration

// Module 9352 (FRACTIONAL_NITRO_COIN_SIZE)
import "noop";
...
export const FractionalNitroCoinIllustration = function FractionalNitroCoinIllustration(resizeMode) {
  ...
  if (skuId === EXTERNAL_PRODUCT_SKU_IDS.FRACTIONAL_PREMIUM_1_DAY) {
    let NitroCoinStackSpotIllustration = require(5967) /* AccountAgeTier10LargeBadge */.NitroCoinSpotIllustration;
  } else {
    NitroCoinStackSpotIllustration = require(5967) /* AccountAgeTier10LargeBadge */.NitroCoinStackSpotIllustration;
  }
