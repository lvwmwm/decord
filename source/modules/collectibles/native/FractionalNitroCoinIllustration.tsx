...
// Dependencies: [19, 678, 21, 5447, 2]
// Exports: FractionalNitroCoinIllustration

// Module 9247 (FRACTIONAL_NITRO_COIN_SIZE)
import "noop";
...
export const FractionalNitroCoinIllustration = function FractionalNitroCoinIllustration(resizeMode) {
  ...
  if (skuId === EXTERNAL_PRODUCT_SKU_IDS.FRACTIONAL_PREMIUM_1_DAY) {
    let NitroCoinStackSpotIllustration = require(5447) /* AccountAgeTier10LargeBadge */.NitroCoinSpotIllustration;
  } else {
    NitroCoinStackSpotIllustration = require(5447) /* AccountAgeTier10LargeBadge */.NitroCoinStackSpotIllustration;
  }
