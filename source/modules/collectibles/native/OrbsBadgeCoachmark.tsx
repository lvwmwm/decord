...
// Dependencies: [19, 17, 21, 4255, 9403, 1236, 4107, 8547, 2]
// Exports: default, useOrbsBadgeCoachmark

// Module 9402 (OrbsBadgeCoachmarkImg)
...
function OrbsBadgeCoachmarkImg() {
  ...
  obj = { uri: importDefault(9403) };
  obj[0] = obj;
  obj[1] = tmp.coachmarkImage;
  obj[1] = <closure_5 uri={importDefault(9403)} />;
  return <closure_4 uri={importDefault(9403)} />;
}
...
export default function OrbsBadgeCoachmark(badgeRef) {
  ...
  const coachmark = require(8547) /* useCoachmark */.useCoachmark(badgeRef.badgeRef, merged);
  return null;
};
