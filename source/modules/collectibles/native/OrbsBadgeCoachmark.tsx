...
// Dependencies: [19, 17, 21, 4344, 9560, 1236, 4200, 8698, 2]
// Exports: default, useOrbsBadgeCoachmark

// Module 9559 (OrbsBadgeCoachmarkImg)
...
function OrbsBadgeCoachmarkImg() {
  ...
  obj = { uri: importDefault(9560) };
  obj[0] = obj;
  obj[1] = tmp.coachmarkImage;
  obj[1] = <closure_5 uri={importDefault(9560)} />;
  return <closure_4 uri={importDefault(9560)} />;
}
...
export default function OrbsBadgeCoachmark(badgeRef) {
  ...
  const coachmark = require(8698) /* useCoachmark */.useCoachmark(badgeRef.badgeRef, merged);
  return null;
};
