...
// Dependencies: [19, 17, 21, 4303, 9520, 1236, 4159, 8659, 2]
// Exports: default, useOrbsBadgeCoachmark

// Module 9519 (OrbsBadgeCoachmarkImg)
...
function OrbsBadgeCoachmarkImg() {
  ...
  obj = { uri: importDefault(9520) };
  obj[0] = obj;
  obj[1] = tmp.coachmarkImage;
  obj[1] = <closure_5 uri={importDefault(9520)} />;
  return <closure_4 uri={importDefault(9520)} />;
}
...
export default function OrbsBadgeCoachmark(badgeRef) {
  ...
  const coachmark = require(8659) /* useCoachmark */.useCoachmark(badgeRef.badgeRef, merged);
  return null;
};
