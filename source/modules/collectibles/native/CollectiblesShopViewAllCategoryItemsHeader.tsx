...
// Dependencies: [19, 17, 21, 4303, 1480, 7640, 8382, 8386, 1236, 2]
// Exports: default

// Module 14867 (CollectiblesShopViewAllCategoryItemsHeader)
import "noop";
...
export default function CollectiblesShopViewAllCategoryItemsHeader(arg0) {
  ...
  obj1[1] = callback(_require(8382).HeaderIconButton, obj2);
