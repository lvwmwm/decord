...
// Dependencies: [19, 17, 21, 4303, 1499, 7642, 8388, 8392, 1236, 2]
// Exports: default

// Module 14877 (CollectiblesShopViewAllCategoryItemsHeader)
import "noop";
...
export default function CollectiblesShopViewAllCategoryItemsHeader(arg0) {
  ...
  obj1[1] = callback(_require(8388).HeaderIconButton, obj2);
