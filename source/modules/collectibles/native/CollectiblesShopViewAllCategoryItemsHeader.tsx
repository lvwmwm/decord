...
// Dependencies: [19, 17, 21, 4302, 1480, 7580, 8322, 8326, 1236, 2]
// Exports: default

// Module 14795 (CollectiblesShopViewAllCategoryItemsHeader)
import "noop";
...
export default function CollectiblesShopViewAllCategoryItemsHeader(arg0) {
  ...
  obj1[1] = callback(_require(8322).HeaderIconButton, obj2);
