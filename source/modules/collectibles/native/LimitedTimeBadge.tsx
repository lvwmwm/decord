...
// Dependencies: [19, 17, 1946, 1302, 21, 4255, 712, 1236, 589, 4101, 6797, 4251, 2]
// Exports: default

// Module 9296 (LimitedTimeBadge)
import "noop";
...
export default function LimitedTimeBadge(unpublishedAt) {
  ...
  ({ days, hours } = importDefault(6797)(unpublishedAt.unpublishedAt, 1000, undefined, true));
  if (hasItem) {
    if (days > 1) {
