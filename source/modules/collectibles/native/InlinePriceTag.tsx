...
// Function ID: 9627
// Name: PriceTag
// Dependencies: [19, 17, 5920, 678, 676, 21, 4342, 712, 4338, 1949, 7082, 7083, 9471, 1236, 9412, 4007, 9627, 9628, 9482, 9629, 589, 9466, 9491, 500, 7796, 7770, 2]
// Exports: default

// Module 9626 (PriceTag)
...
function OrbsPriceTag(arg0) {
  ...
  if (null == vcData.price) {
    ...
    if (result) {
      result = discountPercentage >= tmp16(7083).DISCOUNT_DISPLAY_MINIMUM_THRESHOLD;
    }
    ...
    if (result) {
      ...
      obj1[2] = tmp.orbsIcon;
      obj[3] = callback(tmp16(9471).OrbsIcon, obj1);
    ...
    if (!result) {
      ...
      obj4[2] = tmp.orbsIcon;
      tmp10Result = tmp10(tmp16(9471).OrbsIcon, obj4);
    }
    obj3[2] = tmp10Result;
...
function BundleDiscountV2(discountPercentage) {
  ...
  let tmp4 = null;
  if (discountPercentage >= require(7083) /* getItemRecordsFromPurchases */.DISCOUNT_DISPLAY_MINIMUM_THRESHOLD) {
    let obj = { style: null, children: null };
    obj[0] = tmp.discount;
...
export default function InlinePriceTag(arg0) {
  ...
  let obj1 = require(7083) /* getItemRecordsFromPurchases */;
  ...
  dependencyMap = importDefault(9627)(constants.SHOP_PRODUCT_DETAILS);
  let obj3 = require(9628) /* useProductDisableState */;
  const isDisabled = obj3.useProductDisableState(product.skuId).isDisabled;
  let obj4 = require(9482) /* hasAtLeastOneGPlaySynced */;
  const formattedPriceForCollectiblesProduct = obj4.getFormattedPriceForCollectiblesProduct(product, false, true);
  let obj5 = require(9629) /* useVirtualCurrencyData */;
  ...
  let obj7 = require(9466) /* useCanPurchaseFrames */;
  ...
  if (stateFromStores) {
    if (null == formattedPriceForCollectiblesProduct) {
      return callback(tmp2(9491).CollectiblesShopPricePlaceholder, {});
    }
  }
  if (null == formattedPriceForCollectiblesProduct) {
    let tmp30 = null;
    ...
    if (!(null != formattedPriceForCollectiblesProduct1 && tmp13)) {
      ...
      if (tmp17Result) {
        ...
        obj8[1] = items3;
        const items4 = [tmp17(tmp2(7770).NitroWheelIcon, obj8), ];
      ...
      if (shopDiscountSource === tmp2(7083).ShopDiscountSource.THIRDPARTY) {
        const obj14 = { color: "interactive-text-active", style: null };
        obj14[1] = tmp.nitroIcon;
        let tmp17Result2 = tmp17(tmp2(7796).TagIcon, obj14);
      } else {
        const obj15 = { color: "interactive-text-active", style: null };
        obj15[1] = tmp.nitroIcon;
        tmp17Result2 = tmp17(tmp2(7770).NitroWheelIcon, obj15);
      }
