...
// Function ID: 9485
// Name: PriceTag
// Dependencies: [19, 17, 5779, 678, 676, 21, 4285, 712, 4281, 1930, 6933, 6934, 9326, 1236, 9266, 3930, 9485, 9486, 9337, 9487, 589, 9321, 9346, 500, 7651, 7625, 2]
// Exports: default
...
function OrbsPriceTag(arg0) {
  ...
  if (null == vcData.price) {
    ...
    if (result) {
      result = discountPercentage >= tmp16(6934).DISCOUNT_DISPLAY_MINIMUM_THRESHOLD;
    }
...
function BundleDiscountV2(discountPercentage) {
  ...
  let tmp4 = null;
  if (discountPercentage >= require(6934) /* getItemRecordsFromPurchases */.DISCOUNT_DISPLAY_MINIMUM_THRESHOLD) {
    let obj = { style: null, children: null };
    obj[0] = tmp.discount;
...
export default function InlinePriceTag(arg0) {
  ...
  let obj1 = require(6934) /* getItemRecordsFromPurchases */;
  ...
  if (null == formattedPriceForCollectiblesProduct) {
    ...
    if (product.type === tmp2(1930).CollectiblesItemType.BUNDLE) {
      tmp17Result = null;
      if (!canUseShopDiscountsResult) {
    ...
    if (!(null != formattedPriceForCollectiblesProduct1 && tmp13)) {
      ...
      if (shopDiscountSource === tmp2(6934).ShopDiscountSource.THIRDPARTY) {
