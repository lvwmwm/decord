...
// Dependencies: [32, 19, 17, 678, 21, 9492, 712, 4380, 9377, 4925, 7159, 1950, 9521, 9522, 5374, 9562, 679, 9563, 9534, 9524, 9541, 9543, 4228, 4101, 9493, 2]

// Module 9561 (PurchasedAssetOverlay)
...
import CheckmarkLargeBoldIcon from "CheckmarkLargeBoldIcon" /* 9377 */;
import useDefaultVariantIndex from "useDefaultVariantIndex" /* 9493 */;
...
import metadataDefault from "metadata" /* 9562 */;
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1950).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      ...
      obj2[1] = tmp2(9563).FRACTIONAL_NITRO_COIN_SIZE.CARD;
      obj2[2] = tmp2(9563).FRACTIONAL_NITRO_COIN_SIZE.CARD;
      return callback2(tmp2(9563).FractionalNitroCoinIllustration, obj2);
    } else {
      ...
      if (tmp2(1950).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        obj7[0] = first;
        obj7[1] = tmp2(9492).COLLECTIBLES_SHOP_CARD_WIDTH - ThemesDefault.space.PX_32;
        obj7[2] = closure_9;
