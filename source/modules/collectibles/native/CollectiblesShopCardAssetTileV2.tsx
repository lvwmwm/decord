...
// Dependencies: [32, 19, 17, 678, 21, 9233, 712, 4255, 9123, 4774, 6906, 1901, 9263, 9264, 5221, 9305, 679, 9306, 9276, 9266, 9284, 9286, 4099, 3959, 9234, 2]

// Module 9304 (PurchasedAssetOverlay)
...
function PurchasedAssetOverlay() {
  const tmp = callback3();
  obj = { style: tmp.overlayContainer, children: callback2(require(9123) /* CheckmarkLargeBoldIcon */.CheckmarkLargeBoldIcon, obj) };
  obj = { size: "lg", style: tmp.overlayIcon };
  return callback2(closure_5, obj);
}
function DisabledAssetOverlay() {
  const tmp = callback3();
  obj = { style: tmp.overlayContainer, children: callback2(require(4774) /* LockIcon */.LockIcon, obj) };
  obj = { size: "lg", style: tmp.overlayIcon };
  return callback2(closure_5, obj);
}
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1901).CollectiblesItemType.BUNDLE) {
    ...
    obj[7] = memo;
    return callback2(importDefault(9264), obj);
    ...
    return callback2(importDefault(5221), obj);
  } else {
    const ALL = tmp2(679).FractionalPremiumSKUsSets.ALL;
    if (ALL.has(product.skuId)) {
      const obj2 = { skuId: null, width: null, height: null };
      obj2[0] = product.skuId;
      obj2[1] = tmp2(9306).FRACTIONAL_NITRO_COIN_SIZE.CARD;
      obj2[2] = tmp2(9306).FRACTIONAL_NITRO_COIN_SIZE.CARD;
      return callback2(tmp2(9306).FractionalNitroCoinIllustration, obj2);
    } else {
      ...
      if (tmp2(1901).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        obj3[0] = first;
        return callback2(importDefault(9276), obj3);
        ...
        obj5[0] = first;
        obj4[1] = callback2(importDefault(9266), obj5);
        ...
        obj7[0] = first;
        obj7[1] = tmp2(9233).COLLECTIBLES_SHOP_CARD_WIDTH - importDefault(712).space.PX_32;
        obj7[2] = closure_9;
        obj7[3] = importDefault(712).colors.BACKGROUND_BASE_LOW;
        obj6[1] = callback2(importDefault(9284), obj7);
        return callback2(closure_5, obj6);
      } else if (tmp2(1901).CollectiblesItemType.NAMEPLATE === type) {
        const obj8 = { item: null };
        obj8[0] = first;
        return callback2(importDefault(9286), obj8);
      } else {
        return null;
      }
    }
...
const memoResult = importAllResult.memo(function AssetTileV2(arg0) {
  ...
  let obj = require(9234) /* useDefaultVariantIndex */;
  const defaultVariantIndex = obj.useDefaultVariantIndex(product);
  obj = { solidBackground, children: null };
  obj = { product: require(6906) /* getProductOrbPrice */.getSelectedProduct(product, defaultVariantIndex), isPurchased, isDisabled, disableBundleStaticBackground, muteBundleStaticBackground, cardWidth };
