...
// Dependencies: [32, 19, 17, 678, 21, 9350, 712, 4303, 9235, 4823, 7015, 1949, 9380, 9381, 5268, 9422, 679, 9423, 9393, 9383, 9401, 9403, 4152, 4024, 9351, 2]

// Module 9421 (PurchasedAssetOverlay)
...
function PurchasedAssetOverlay() {
  const tmp = callback3();
  obj = { style: tmp.overlayContainer, children: callback2(require(9235) /* CheckmarkLargeBoldIcon */.CheckmarkLargeBoldIcon, obj) };
...
function ProductPreview(arg0) {
  ...
  if (productType !== require(1949) /* CollectiblesItemType */.CollectiblesItemType.PROFILE_EFFECT) {
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1949).CollectiblesItemType.BUNDLE) {
    ...
    obj[7] = memo;
    return callback2(importDefault(9381), obj);
  } else if (product.skuId === EXTERNAL_PRODUCT_SKU_IDS.ORB_PROFILE_BADGE) {
    obj = { source: null, style: null };
    const obj1 = { uri: null };
    obj1[0] = importDefault(9422);
    obj[0] = obj1;
    ...
    if (ALL.has(product.skuId)) {
      ...
      obj2[1] = tmp2(9423).FRACTIONAL_NITRO_COIN_SIZE.CARD;
      obj2[2] = tmp2(9423).FRACTIONAL_NITRO_COIN_SIZE.CARD;
      return callback2(tmp2(9423).FractionalNitroCoinIllustration, obj2);
    } else {
      ...
      if (tmp2(1949).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        obj3[0] = first;
        return callback2(importDefault(9393), obj3);
        ...
        obj5[0] = first;
        obj4[1] = callback2(importDefault(9383), obj5);
        ...
        obj7[0] = first;
        obj7[1] = tmp2(9350).COLLECTIBLES_SHOP_CARD_WIDTH - importDefault(712).space.PX_32;
        obj7[2] = closure_9;
        obj7[3] = importDefault(712).colors.BACKGROUND_BASE_LOW;
        obj6[1] = callback2(importDefault(9401), obj7);
        return callback2(closure_5, obj6);
      } else if (tmp2(1949).CollectiblesItemType.NAMEPLATE === type) {
        const obj8 = { item: null };
        obj8[0] = first;
        return callback2(importDefault(9403), obj8);
      } else {
        return null;
      }
    }
...
function AssetTileInternal(solidBackground) {
  ...
  const tmp = callback3();
  const obj2 = require(4152) /* hexToRgba */;
  let num = 0.8;
  const token = require(4024) /* map */.useToken(importDefault(712).colors.BACKGROUND_BASE_LOW);
  if (flag) {
    num = 1;
  }
...
const memoResult = importAllResult.memo(function AssetTileV2(arg0) {
  ...
  let obj = require(9351) /* useDefaultVariantIndex */;
  const defaultVariantIndex = obj.useDefaultVariantIndex(product);
  obj = { solidBackground, children: null };
  obj = { product: require(7015) /* getProductOrbPrice */.getSelectedProduct(product, defaultVariantIndex), isPurchased, isDisabled, disableBundleStaticBackground, muteBundleStaticBackground, cardWidth };
