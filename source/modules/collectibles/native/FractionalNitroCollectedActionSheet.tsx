...
// Dependencies: [19, 17, 676, 1924, 21, 4342, 712, 9480, 5329, 12245, 4278, 7117, 1363, 7460, 7461, 4338, 1236, 1993, 4058, 5458, 6963, 4909, 10215, 4777, 4310, 5773, 2]
// Exports: default

// Module 12244 (NitroAcquiredHeader)
...
function NitroAcquiredHeader(skuId) {
  ...
  obj1[1] = require(9480) /* FRACTIONAL_NITRO_COIN_SIZE */.FRACTIONAL_NITRO_COIN_SIZE.COLLECTED_SHEET;
  obj1[2] = require(9480) /* FRACTIONAL_NITRO_COIN_SIZE */.FRACTIONAL_NITRO_COIN_SIZE.COLLECTED_SHEET;
  obj[1] = callback(require(9480) /* FRACTIONAL_NITRO_COIN_SIZE */.FractionalNitroCoinIllustration, obj1);
