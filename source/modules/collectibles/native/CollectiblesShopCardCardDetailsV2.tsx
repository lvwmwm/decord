...
// Function ID: 12591
// Name: memoResult1
// Dependencies: [19, 17, 6052, 676, 21, 4448, 712, 8851, 7266, 10706, 7267, 11314, 12524, 4444, 1236, 10716, 500, 10381, 8064, 8854, 12497, 1950, 4109, 4167, 4296, 10718, 589, 4908, 12591, 2]

// Module 12590 (memoResult1)
...
const memoResult1 = importAllResult.memo(function CardDetailsV2(arg0) {
  ...
  if (!hidePrice) {
    ...
    obj3 = { product: null };
    obj3[0] = product;
    items4[1] = tmp17(tmp7(12591), obj3);
    obj1[1] = items4;
