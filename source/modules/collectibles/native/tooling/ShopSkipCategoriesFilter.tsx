...
// Dependencies: [19, 17, 7255, 21, 4448, 712, 589, 4894, 4444, 7254, 2]
// Exports: ShopSkipCategoriesFilter

// Module 15285 (ShopSkipCategoriesFilter)
...
export const ShopSkipCategoriesFilter = function ShopSkipCategoriesFilter() {
  ...
  const items1 = [callback(stateFromStores(4444).Text, obj), ];
  ...
  const items3 = [
    callback(closure_3, {
      ...
      children: callback(stateFromStores(4444).Text, { variant: "text-lg/semibold", children: "\u2212" })
    }),
    callback(stateFromStores(4444).Text, { variant: "text-md/semibold", style: tmp.valueText, children: stateFromStores }),
  ...
  obj4[1] = items1;
  obj[1] = closure_6(stateFromStores(4894).Stack, obj4);
