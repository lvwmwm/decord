...
// Dependencies: [19, 17, 6922, 21, 4285, 712, 589, 4693, 4281, 6921, 2]
// Exports: ShopSkipCategoriesFilter

// Module 14954 (ShopSkipCategoriesFilter)
import "noop";
...
export const ShopSkipCategoriesFilter = function ShopSkipCategoriesFilter() {
  ...
  const items1 = [callback(stateFromStores(4281).Text, obj), ];
  ...
  const items3 = [
    callback(closure_3, {
      ...
      children: callback(stateFromStores(4281).Text, { variant: "text-lg/semibold", children: "\u2212" })
    }),
    callback(stateFromStores(4281).Text, { variant: "text-md/semibold", style: tmp.valueText, children: stateFromStores }),
  ...
  obj4[1] = items1;
  obj[1] = closure_6(stateFromStores(4693).Stack, obj4);
