...
// Dependencies: [19, 17, 7234, 21, 4446, 712, 589, 4891, 4442, 7233, 2]
// Exports: ShopSkipCategoriesFilter

// Module 15252 (ShopSkipCategoriesFilter)
...
export const ShopSkipCategoriesFilter = function ShopSkipCategoriesFilter() {
  ...
  const items1 = [callback(stateFromStores(4442).Text, obj), ];
  ...
  const items3 = [
    callback(closure_3, {
      ...
      children: callback(stateFromStores(4442).Text, { variant: "text-lg/semibold", children: "\u2212" })
    }),
    callback(stateFromStores(4442).Text, { variant: "text-md/semibold", style: tmp.valueText, children: stateFromStores }),
  ...
  obj4[1] = items1;
  obj[1] = closure_6(stateFromStores(4891).Stack, obj4);
