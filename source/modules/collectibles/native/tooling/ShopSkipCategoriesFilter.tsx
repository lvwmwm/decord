...
// Dependencies: [19, 17, 7049, 21, 4342, 712, 589, 4753, 4338, 7048, 2]
// Exports: ShopSkipCategoriesFilter

// Module 15110 (ShopSkipCategoriesFilter)
import "noop";
...
export const ShopSkipCategoriesFilter = function ShopSkipCategoriesFilter() {
  ...
  const items1 = [callback(stateFromStores(4338).Text, obj), ];
  ...
  const items3 = [
    callback(closure_3, {
      ...
      children: callback(stateFromStores(4338).Text, { variant: "text-lg/semibold", children: "\u2212" })
    }),
    callback(stateFromStores(4338).Text, { variant: "text-md/semibold", style: tmp.valueText, children: stateFromStores }),
  ...
  obj4[1] = items1;
  obj[1] = closure_6(stateFromStores(4753).Stack, obj4);
