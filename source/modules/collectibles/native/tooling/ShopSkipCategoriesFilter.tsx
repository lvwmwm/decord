...
// Dependencies: [19, 17, 7043, 21, 4344, 712, 589, 4752, 4340, 7042, 2]
...
export const ShopSkipCategoriesFilter = function ShopSkipCategoriesFilter() {
  ...
  const items1 = [callback(stateFromStores(4340).Text, obj), ];
  ...
  const items3 = [
    callback(closure_3, {
      ...
      children: callback(stateFromStores(4340).Text, { variant: "text-lg/semibold", children: "\u2212" })
    }),
    callback(stateFromStores(4340).Text, { variant: "text-md/semibold", style: tmp.valueText, children: stateFromStores }),
  ...
  obj4[1] = items1;
  obj[1] = closure_6(stateFromStores(4752).Stack, obj4);
