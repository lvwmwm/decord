...
// Dependencies: [32, 19, 17, 6941, 6957, 8739, 21, 4302, 712, 9279, 4298, 4713, 647, 8220, 14970, 1297, 10058, 2]
// Exports: default

// Module 14969 (FramePreviewOverrideSection)
...
function FramePreviewOverrideSection() {
  ...
  if ("loading" === tmp3) {
    ...
    obj[1] = callback3(_require(4298).Text, obj);
...
function UnpurchasedCollectiblesShopCardV2(arg0) {
  ...
  return callback3(importDefault(9279), obj, tmp2);
}
