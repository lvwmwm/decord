...
// Dependencies: [32, 19, 17, 7043, 7059, 8844, 21, 4344, 712, 9390, 4340, 4755, 647, 8324, 15110, 1297, 10171, 2]
// Exports: default
...
function FramePreviewOverrideSection() {
  ...
  if ("loading" === tmp3) {
    ...
    obj[1] = callback3(_require(4340).Text, obj);
...
function UnpurchasedCollectiblesShopCardV2(arg0) {
  ...
  return callback3(importDefault(9390), obj, tmp2);
}
