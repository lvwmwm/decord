...
// Dependencies: [32, 19, 17, 6898, 6914, 8419, 21, 4255, 712, 8847, 4251, 4667, 647, 8078, 14903, 1297, 9949, 2]
// Exports: default

// Module 14902 (FramePreviewOverrideSection)
...
function UnpurchasedCollectiblesShopCardV2(arg0) {
  ...
  return callback3(importDefault(8847), obj, tmp2);
}
