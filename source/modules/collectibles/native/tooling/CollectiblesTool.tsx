...
// Dependencies: [32, 19, 17, 7049, 7065, 8848, 21, 4342, 712, 9394, 4338, 4756, 647, 8328, 15119, 1297, 10171, 2]
// Exports: default

// Module 15118 (FramePreviewOverrideSection)
...
function FramePreviewOverrideSection() {
  ...
  if ("loading" === tmp3) {
    ...
    obj[1] = callback3(_require(4338).Text, obj);
    ...
    obj2[1] = items1;
    obj2[2] = "Loading\u2026";
    items[2] = callback3(_require(4338).Text, obj2);
