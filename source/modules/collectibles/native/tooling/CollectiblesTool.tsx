...
// Dependencies: [57, 31, 27, 5780, 5796, 8060, 33, 4165, 689, 8636, 4161, 4579, 624, 7932, 14794, 1273, 9768, 2]
// Exports: default

// Module 14793 (FramePreviewOverrideSection)
...
function FramePreviewOverrideSection() {
  ...
  if ("loading" === tmp3) {
    ...
    obj.children = callback3(_require(4161).Text, obj);
    ...
    items[2] = callback3(_require(4161).Text, obj2);
    const obj3 = {
    ...
    items[3] = callback3(_require(4579).BaseTextButton, obj3);
    let tmp24 = null != tmp2;
    if (tmp24) {
      const obj4 = { pillStyle: tmp.secondaryButton, text: "Clear override", onPress: tmp5 };
      tmp24 = callback3(_require(4579).BaseTextButton, obj4);
    }
    items[4] = tmp24;
    obj.children = items;
...
function UnpurchasedCollectiblesShopCardV2(arg0) {
  ...
  return callback3(importDefault(8636), obj, tmp2);
}
