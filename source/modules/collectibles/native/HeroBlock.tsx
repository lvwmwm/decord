...
// Dependencies: [19, 17, 6895, 678, 676, 21, 9233, 4255, 712, 14201, 14713, 1480, 9236, 589, 4191, 12054, 3959, 4099, 14193, 14195, 5595, 5615, 14714, 698, 4101, 14716, 14717, 12057, 4676, 4251, 4665, 1236, 11052, 5118, 4797, 5645, 5582, 14718, 7638, 2]
// Exports: default

// Module 14712 (SkeletonLoading)
...
function SkeletonLoading(accessibilityLabel) {
  ...
  obj[5] = Array.from({ length: 10 }).map((arg0, arg1) => {
    ...
    obj[0] = callback(9233).COLLECTIBLES_SHOP_CARD_WIDTH;
    return callback3(callback2(14201), obj, arg1);
  });
...
export default function _default(heroBlock) {
  ...
  const tmp11 = preferVCPrice(14193)();
  c5 = tmp11;
  ...
  const filteredAndSortedProducts = heroBlock(14195).useFilteredAndSortedProducts({ products: memo, bypassAndroidUnsyncedFilter: tmp4 });
  c6 = tmp13;
  const tmpResult5 = heroBlock(14195);
  let unpublishedAt;
  ...
  if (undefined === stateFromStores) {
    ...
    if (!tmp4) {
      ...
      obj[0] = tmp14(preferVCPrice(5615).COLLECTIBLES_SHOP_HERO).analyticsLocations;
      ...
      if (tmp23Result) {
        ...
        if (tmp4) {
          ...
          tmp21Result = tmp21(tmp5(4676), obj3);
        }
      ...
      if (tmp4) {
        ...
        items8[1] = tmp21(tmp(4665).Button, obj13);
        obj9[1] = items8;
        ...
        obj21[1] = tmp21(tmp(5645).ChevronSmallRightIcon, { size: "sm", color: "white" });
        items9[1] = tmp21(tmp24, obj21);
        obj17[1] = items9;
        obj14[7] = tmp23(tmp24, obj17);
        tmp23Result = tmp21(tmp(4797).PressableOpacity, obj14, stateFromStores.storeListingId);
      }
      obj8[1] = tmp23Result;
      ...
      if (tmp4) {
        ...
        if (0 === filteredAndSortedProducts.length) {
          ...
          obj27[5] = tmp16;
          obj27[7] = tmp(9233).COLLECTIBLES_SHOP_CARD_WIDTH + tmp5(712).space.PX_12;
          ...
          tmp21Result4 = tmp21(tmp(7638).FlashList, obj27);
        }
      ...
      obj22[1] = closure_11(tmp(5582).LayerScope, obj30);
      items6[2] = closure_11(c5, obj22);
      obj1[1] = items6;
      obj[2] = closure_13(c5, obj1);
      obj[1] = closure_11(tmp5Result, obj);
      return closure_11(tmp(5595).AnalyticsLocationProvider, obj);
    } else {
      if (tmpResult6.isThemeDark(tmp6)) {
        let tmp5Result1 = tmp5(14716);
      } else {
        tmp5Result1 = tmp5(14717);
      }
      tmpResult6 = tmp(4101);
    }
  }
