...
// Function ID: 107660
// Name: sharedValue
// Dependencies: [31, 33, 4165, 689, 8636, 4026, 4166, 2]
// Exports: default

// Module 14087 (sharedValue)
...
export default function _default(width) {
  ...
  if (COLLECTIBLES_SHOP_CARD_WIDTH === undefined) {
    COLLECTIBLES_SHOP_CARD_WIDTH = sharedValue(8636).COLLECTIBLES_SHOP_CARD_WIDTH;
  }
  let COLLECTIBLES_SHOP_CARD_HEIGHT = width.height;
  sharedValue = undefined;
  if (null == COLLECTIBLES_SHOP_CARD_HEIGHT) {
    COLLECTIBLES_SHOP_CARD_HEIGHT = sharedValue(8636).COLLECTIBLES_SHOP_CARD_HEIGHT;
  }
