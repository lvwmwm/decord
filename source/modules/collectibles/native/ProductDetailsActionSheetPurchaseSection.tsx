...
// Function ID: 9463
// Name: GiftButton
// Dependencies: [32, 19, 17, 6782, 6911, 678, 676, 9463, 1876, 21, 4255, 712, 7644, 9464, 4223, 9323, 9465, 1236, 9458, 9457, 9302, 1480, 5595, 4460, 12040, 1959, 6894, 12044, 679, 12045, 10011, 9297, 4251, 4666, 1901, 4191, 4101, 3959, 9237, 589, 9371, 3901, 6907, 6906, 9311, 10017, 12047, 12048, 12049, 7237, 12051, 1581, 501, 4676, 8409, 4665, 5615, 1945, 12052, 2]
// Exports: default

// Module 9462 (GiftButton)
...
export default function ProductDetailsActionSheetPurchaseSection(onBuy) {
  ...
  let obj2 = require(9237) /* useCurrentUser */;
  const currentUser = obj2.useCurrentUser();
  let obj3 = require(9302) /* getProductPurchaseState */;
  ...
  let obj5 = require(9371) /* useIsPremiumSubscriber */;
