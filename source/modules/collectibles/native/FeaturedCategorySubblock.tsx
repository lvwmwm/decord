...
// Function ID: 14917
// Name: subblock
// Dependencies: [19, 17, 7043, 678, 676, 21, 4344, 1499, 9393, 589, 12238, 12241, 4886, 1236, 712, 698, 7042, 5787, 7055, 8334, 2]
// Exports: default

// Module 14916 (subblock)
import "NewBadge";
...
export default function _default(subblock) {
  ...
  const tmp12 = importDefault(12241);
