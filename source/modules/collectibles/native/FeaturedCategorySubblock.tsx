...
// Function ID: 14777
// Name: subblock
// Dependencies: [19, 17, 6941, 678, 676, 21, 4302, 1480, 9282, 589, 12103, 12106, 4844, 1236, 712, 698, 6940, 5688, 6953, 8230, 2]
// Exports: default

// Module 14776 (subblock)
import "NewBadge";
...
export default function _default(subblock) {
  ...
  const tmp12 = importDefault(12106);
