...
// Function ID: 14926
// Name: subblock
// Dependencies: [19, 17, 7049, 678, 676, 21, 4342, 1499, 9397, 589, 12240, 12243, 4887, 1236, 712, 698, 7048, 5788, 7061, 8338, 2]
// Exports: default

// Module 14925 (subblock)
import "NewBadge";
...
export default function _default(subblock) {
  ...
  const tmp12 = importDefault(12243);
