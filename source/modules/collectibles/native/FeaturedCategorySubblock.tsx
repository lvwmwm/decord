...
// Function ID: 14859
// Name: subblock
// Dependencies: [19, 17, 7004, 678, 676, 21, 4303, 1499, 9353, 589, 12175, 12178, 4846, 1236, 712, 698, 7003, 5748, 7016, 8295, 2]
// Exports: default

// Module 14858 (subblock)
import "NewBadge";
...
export default function _default(subblock) {
  ...
  const tmp12 = importDefault(12178);
