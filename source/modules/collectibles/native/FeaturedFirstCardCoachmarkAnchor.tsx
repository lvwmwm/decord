...
// Module 14352 (FeaturedFirstCardCoachmarkAnchor)
...
export default function FeaturedFirstCardCoachmarkAnchor(children) {
  ...
  const items = [callback(View, { ref, style: { label: null, value: "Clear", description: "absolute", type: 0, customId: 0 }, collapsable: false }), children.children, callback(importDefault(dependencyMap[3]), { anchorRef: ref })];
  obj.children = items;
