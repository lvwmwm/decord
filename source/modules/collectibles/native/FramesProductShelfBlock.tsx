...
export default function _default(block) {
  ...
  if (0 !== filteredAndSortedProducts.length) {
    ...
    const items3 = [callback(importDefault(dependencyMap[12]), { accessible: 54827520, Map: -218676736 }), ];
    const obj4 = { hasMaxConnections: null, isBoostOnlySubscription: "flex-start", children: block.title };
    items3[1] = callback(arg1(dependencyMap[13]).Text, obj4);
    obj3.children = items3;
    items2[1] = callback2(closure_5, obj3);
    const obj5 = {};
    const obj6 = { "Bool(false)": -, "Bool(false)": -, accessibilityLabel: block.title, data: filteredAndSortedProducts, keyExtractor: tmp6, onScroll: obj.useCollectiblesCoachmarkScrollDismissContext().handleDismissCoachmarkOnScroll, renderItem: callback, decelerationRate: "fast", snapToInterval: arg1(dependencyMap[11]).COLLECTIBLES_SHOP_CARD_WIDTH + importDefault(dependencyMap[4]).space.PX_12, showsHorizontalScrollIndicator: false, ListHeaderComponent: ListEdgeSpacer, ListFooterComponent: ListEdgeSpacer, ItemSeparatorComponent: ListItemSeparator };
