...
// Dependencies: [5, 32, 19, 17, 1218, 1874, 678, 505, 21, 4116, 4669, 4255, 712, 3967, 5644, 4101, 3974, 3956, 1236, 4256, 4664, 4668, 9300, 8661, 589, 9241, 9291, 9302, 9239, 2]
// Exports: default

// Module 9299 (WishlistButtonBase)
...
let closure_17 = createCacheKey.createStyles((arg0) => {
  ...
  let obj3 = require(3967) /* ManaContext */;
  obj[0] = obj3.setColorOpacity("white", 0.72);
  obj[1] = obj;
  const obj1 = { backgroundColor: null };
  obj1[0] = require(3967) /* ManaContext */.setColorOpacity("white", 0.62);
  obj[2] = obj1;
  const obj6 = require(3967) /* ManaContext */;
...
export default function CollectiblesWishlistButton(selectedProduct) {
  ...
  let obj = require(9302) /* getProductPurchaseState */;
  require(9239) /* getProductNameAndTypeFromSku */;
