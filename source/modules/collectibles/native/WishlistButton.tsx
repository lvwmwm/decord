...
// Dependencies: [5, 32, 19, 17, 1218, 1874, 678, 505, 21, 4116, 4670, 4255, 712, 3967, 5630, 4101, 3974, 3956, 1236, 4256, 4665, 4669, 8894, 8858, 589, 8854, 8885, 8896, 8852, 2]
// Exports: default

// Module 8893 (WishlistButtonBase)
...
export default function CollectiblesWishlistButton(selectedProduct) {
  ...
  require(8852) /* getProductNameAndTypeFromSku */;
