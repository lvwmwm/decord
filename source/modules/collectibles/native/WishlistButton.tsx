...
// Dependencies: [5, 32, 19, 17, 1218, 1903, 678, 505, 21, 4145, 4699, 4285, 712, 3996, 5698, 4130, 4003, 3985, 1236, 4286, 4694, 4698, 9329, 8690, 589, 9270, 9320, 9331, 9268, 2]
// Exports: default
...
class WishlistButtonBase {
  constructor(arg0) {
    ...
    c13 = tmp9;
    tmp2Result = require("module_4145");
    num = 0;
    if (isWishlisted) {
      num = 1;
    }
    ...
    tmp2Result2 = require("module_4145");
    class Y {
      constructor() {
        value = c14.get();
        obj = {};
        ...
        obj = { scale: null };
        tmp3Result = require("module_4145");
        obj[0] = tmp3Result.interpolate(value, [0, 0.625, 1], [0, 1.35, 1], require("module_4145").Extrapolation.CLAMP);
        items = [];
        items[0] = obj;
        obj.transform = items;
        return obj;
    ...
    obj1 = { animationFillProgress: sharedValue, styles: tmp, withSpring: require("CONFIG_NEVER_ANIMATE").withSpring, showFilled: tmp9, SUBTLE_SPRING: require("SUBTLE_SPRING").SUBTLE_SPRING, interpolate: require("module_4145").interpolate, Extrapolation: require("module_4145").Extrapolation };
    Y.__closure = obj1;
    Y.__workletHash = 15039903885060;
    Y.__initData = f46448;
    animatedStyle1 = tmp2Result2.useAnimatedStyle(Y);
    tmp2Result3 = require("module_4145");
    class K {
      constructor() {
        value = c14.get();
        obj = {};
        ...
        if (c13) {
          ...
          tmp7 = obj2;
          tmp8 = value;
          num = obj2.interpolate(value, [0, 0.7], [1, 0], require("module_4145").Extrapolation.CLAMP);
        }
        obj.opacity = num;
        obj = { scale: null };
        obj4 = require("module_4145");
        obj[0] = obj4.interpolate(value, [0, 0.625, 1], [0, 1.35, 1], require("module_4145").Extrapolation.CLAMP);
        items = [];
        items[0] = obj;
        obj.transform = items;
        return obj;
    ...
    obj2 = { animationFillProgress: sharedValue, styles: tmp, showFilled: tmp9, interpolate: require("module_4145").interpolate, Extrapolation: require("module_4145").Extrapolation };
    K.__closure = obj2;
    ...
    items4 = [, , ];
    items4[0] = tmp17(require("module_4145").View, obj6);
    ...
    items4[1] = tmp17(require("module_4145").View, obj8);
    ...
    items4[2] = tmp17(require("module_4145").View, obj10);
    obj5[1] = items4;
    obj3[7] = c13(c7, obj5);
...
let closure_17 = createCacheKey.createStyles((arg0) => {
  ...
  let obj3 = require(3996) /* ManaContext */;
  obj[0] = obj3.setColorOpacity("white", 0.72);
  obj[1] = obj;
  const obj1 = { backgroundColor: null };
  obj1[0] = require(3996) /* ManaContext */.setColorOpacity("white", 0.62);
  obj[2] = obj1;
  const obj6 = require(3996) /* ManaContext */;
