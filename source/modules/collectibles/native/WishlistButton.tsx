...
// Module 8698 (WishlistButtonBase)
    ...
    class K {
      constructor() {
        ...
        if (closure_13) {
          ...
          tmp5 = obj2;
          tmp6 = value;
          num = obj2.interpolate(value, ["a", "isArray"], ["getViewManagerConfig", "hasViewManagerConfig"], isWishlisted(busy[9]).Extrapolation.CLAMP);
        }
        obj["opacity"] = num;
        obj = {};
        obj4 = isWishlisted(busy[9]);
...
class WishlistButton {
  constructor(arg0) {
    ...
    obj = { -9223372036854775808: "r", 9223372036854775807: "onRequireModeratorMFAClick", 9223372036854775807: "Array", 0: "isSpamMessageRequest" };
    tmp = null;
...
let closure_17 = arg1(dependencyMap[11]).createStyles((arg0) => {
  ...
  obj.iconContainer = { "Bool(false)": "Enable official messages", "Bool(false)": "NEUTRAL_79", "Bool(false)": 1 };
  obj.animationFill = { "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null };
  return obj;
});
