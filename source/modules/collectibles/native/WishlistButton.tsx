...
// Dependencies: [5, 32, 19, 17, 1218, 1874, 678, 505, 21, 4054, 4608, 4193, 712, 3905, 5568, 4039, 3912, 3894, 1236, 4194, 4603, 4607, 8717, 8681, 589, 8677, 8708, 8719, 8675, 2]
// Exports: default
...
class WishlistButtonBase {
  constructor(arg0) {
    ...
    c13 = tmp9;
    tmp2Result = require("module_4054");
    num = 0;
    if (isWishlisted) {
      num = 1;
    }
    ...
    tmp2Result2 = require("module_4054");
    class Y {
      constructor() {
        value = c14.get();
        obj = {};
        ...
        obj = { scale: null };
        tmp3Result = require("module_4054");
        obj[0] = tmp3Result.interpolate(value, [0, 0.625, 1], [0, 1.35, 1], require("module_4054").Extrapolation.CLAMP);
        items = [];
        items[0] = obj;
        obj.transform = items;
        return obj;
    ...
    obj1 = { animationFillProgress: sharedValue, styles: tmp, withSpring: require("CONFIG_NEVER_ANIMATE").withSpring, showFilled: tmp9, SUBTLE_SPRING: require("SUBTLE_SPRING").SUBTLE_SPRING, interpolate: require("module_4054").interpolate, Extrapolation: require("module_4054").Extrapolation };
    Y.__closure = obj1;
    Y.__workletHash = 15039903885060;
    Y.__initData = f45020;
    animatedStyle1 = tmp2Result2.useAnimatedStyle(Y);
    tmp2Result3 = require("module_4054");
    class K {
      constructor() {
        value = c14.get();
        obj = {};
        ...
        if (c13) {
          ...
          tmp7 = obj2;
          tmp8 = value;
          num = obj2.interpolate(value, [0, 0.7], [1, 0], require("module_4054").Extrapolation.CLAMP);
        }
        obj.opacity = num;
        obj = { scale: null };
        obj4 = require("module_4054");
        obj[0] = obj4.interpolate(value, [0, 0.625, 1], [0, 1.35, 1], require("module_4054").Extrapolation.CLAMP);
        items = [];
        items[0] = obj;
        obj.transform = items;
        return obj;
    ...
    obj2 = { animationFillProgress: sharedValue, styles: tmp, showFilled: tmp9, interpolate: require("module_4054").interpolate, Extrapolation: require("module_4054").Extrapolation };
    K.__closure = obj2;
    ...
    items4 = [, , ];
    items4[0] = tmp17(require("module_4054").View, obj6);
    ...
    items4[1] = tmp17(require("module_4054").View, obj8);
    ...
    items4[2] = tmp17(require("module_4054").View, obj10);
    obj5[1] = items4;
    obj3[7] = c13(c7, obj5);
...
let closure_17 = createCacheKey.createStyles((arg0) => {
  ...
  let obj3 = require(3905) /* ManaContext */;
  obj[0] = obj3.setColorOpacity("white", 0.72);
  obj[1] = obj;
  const obj1 = { backgroundColor: null };
  obj1[0] = require(3905) /* ManaContext */.setColorOpacity("white", 0.62);
  obj[2] = obj1;
  const obj6 = require(3905) /* ManaContext */;
...
export default function CollectiblesWishlistButton(selectedProduct) {
  ...
  require(8675) /* getProductNameAndTypeFromSku */;
