...
// Function ID: 8286
// Name: memoResult1
// Dependencies: [19, 17, 7006, 1417, 21, 4303, 8286, 8284, 8287, 5748, 8292, 2]

// Module 8285 (memoResult1)
...
const memoResult1 = importAllResult.memo((avatarDecoration) => {
  ...
  obj[6] = callback(setSelectedAvatarDecoration(8292), obj);
  return callback(avatarDecoration(8287).EditCollectiblesListItemProduct, obj);
});
