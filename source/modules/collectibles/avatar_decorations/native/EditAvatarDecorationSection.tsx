...
// Function ID: 7967
// Name: memoResult1
// Dependencies: [19, 17, 5808, 1417, 21, 4193, 7967, 7965, 7968, 5539, 7973, 2]
...
const memoResult1 = importAllResult.memo((avatarDecoration) => {
  ...
  obj[6] = callback(setSelectedAvatarDecoration(7973), obj);
  return callback(avatarDecoration(7968).EditCollectiblesListItemProduct, obj);
});
