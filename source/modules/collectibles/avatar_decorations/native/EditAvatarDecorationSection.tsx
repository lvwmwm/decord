...
// Function ID: 8036
// Name: memoResult1
// Dependencies: [19, 17, 7239, 1436, 21, 4446, 8036, 8034, 8037, 5938, 8043, 2]

// Module 8035 (memoResult1)
...
const memoResult1 = importAllResult.memo((avatarDecoration) => {
  ...
  obj[6] = callback(setSelectedAvatarDecoration(8043), obj);
  return callback(avatarDecoration(8037).EditCollectiblesListItemProduct, obj);
});
