...
// Function ID: 8096
// Name: memoResult1
// Dependencies: [19, 17, 6915, 1417, 21, 4285, 8096, 8094, 8097, 5630, 8102, 2]

// Module 8095 (memoResult1)
...
const memoResult1 = importAllResult.memo((avatarDecoration) => {
  ...
  obj[6] = callback(setSelectedAvatarDecoration(8102), obj);
  return callback(avatarDecoration(8097).EditCollectiblesListItemProduct, obj);
});
