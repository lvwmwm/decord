...
// Function ID: 8226
// Name: memoResult1
// Dependencies: [19, 17, 6946, 1417, 21, 4302, 8226, 8224, 8227, 5688, 8232, 2]

// Module 8225 (memoResult1)
...
const memoResult1 = importAllResult.memo((avatarDecoration) => {
  ...
  obj[6] = callback(setSelectedAvatarDecoration(8232), obj);
  return callback(avatarDecoration(8227).EditCollectiblesListItemProduct, obj);
});
