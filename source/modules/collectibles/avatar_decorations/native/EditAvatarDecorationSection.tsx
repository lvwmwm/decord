...
// Function ID: 8084
// Name: memoResult1
// Dependencies: [19, 17, 6903, 1417, 21, 4255, 8084, 8082, 8085, 5601, 8090, 2]

// Module 8083 (memoResult1)
...
const memoResult1 = importAllResult.memo((avatarDecoration) => {
  ...
  obj[6] = callback(setSelectedAvatarDecoration(8090), obj);
  return callback(avatarDecoration(8085).EditCollectiblesListItemProduct, obj);
});
