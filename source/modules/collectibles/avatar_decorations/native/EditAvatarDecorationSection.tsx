...
// Function ID: 8395
// Name: memoResult1
// Dependencies: [19, 17, 5306, 1436, 21, 4661, 8395, 8393, 8396, 7159, 8401, 2]

// Module 8394 (memoResult1)
...
const memoResult1 = importAllResult.memo((avatarDecoration) => {
  ...
  obj[6] = callback(setSelectedAvatarDecoration(8401), obj);
  return callback(avatarDecoration(8396).EditCollectiblesListItemProduct, obj);
});
