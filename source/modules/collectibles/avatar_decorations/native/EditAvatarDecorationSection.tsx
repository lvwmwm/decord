...
// Function ID: 8440
// Name: memoResult1
// Dependencies: [19, 17, 7153, 1436, 21, 4380, 8440, 8438, 8441, 5854, 8446, 2]

// Module 8439 (memoResult1)
...
const memoResult1 = importAllResult.memo((avatarDecoration) => {
  ...
  obj[6] = callback(setSelectedAvatarDecoration(8446), obj);
  return callback(avatarDecoration(8441).EditCollectiblesListItemProduct, obj);
});
