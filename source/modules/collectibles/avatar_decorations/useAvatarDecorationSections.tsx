...
// Dependencies: [32, 19, 7043, 7059, 647, 7055, 1236, 2]
// Exports: default

// Module 8328 (useAvatarDecorationSections)
...
obj = { skuId: "None" };
obj = { skuId: "Shop" };
let result = require("updateCategoriesAndProducts").fileFinishedImporting("modules/collectibles/avatar_decorations/useAvatarDecorationSections.tsx");
