...
// Dependencies: [57, 31, 5780, 5796, 624, 5792, 1212, 2]
// Exports: default

// Module 7936 (useAvatarDecorationSections)
...
obj = { skuId: "None" };
obj = { skuId: "Shop" };
let result = require("_isNativeReflectConstruct").fileFinishedImporting("modules/collectibles/avatar_decorations/useAvatarDecorationSections.tsx");
  ...
  return useMemo(() => {
    ...
    const reduced = avatarDecorations.reduce((premium_purchase, skuId) => {
      ...
      if (null != value) {
        ...
        result = stateFromStores(first[5]).isPremiumCollectiblesProduct(outer1_2.get(skuId.skuId));
    ...
    obj.header = intl.string(stateFromStores(first[6]).t.VqmVqE);
    const items1 = [obj, , ];
