...
// Module 7852 (useAvatarDecorationSections)
...
obj = { skuId: "None" };
obj = { skuId: "Shop" };
const result = arg1(dependencyMap[7]).fileFinishedImporting("modules/collectibles/avatar_decorations/useAvatarDecorationSections.tsx");
