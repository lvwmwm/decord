...
// Function ID: 13849
// Name: PX_8
// Dependencies: [19, 17, 6917, 8740, 21, 712, 4285, 8096, 13847, 8097, 5630, 9313, 2]
...
const memoResult1 = importAllResult.memo((isSelected) => {
  ...
  obj[1] = callback(setSelectedProfileFrame(9313), obj);
  obj[5] = callback(View, obj);
  return callback(profileFrame(8097).EditCollectiblesListItemProduct, obj);
});
