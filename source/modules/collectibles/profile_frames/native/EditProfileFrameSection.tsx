...
// Function ID: 13821
// Name: PX_8
// Dependencies: [19, 17, 6902, 8712, 21, 712, 4255, 8068, 13819, 8069, 5615, 9284, 2]
...
const memoResult1 = importAllResult.memo((isSelected) => {
  ...
  obj[1] = callback(setSelectedProfileFrame(9284), obj);
  obj[5] = callback(View, obj);
  return callback(profileFrame(8069).EditCollectiblesListItemProduct, obj);
});
