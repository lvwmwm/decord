...
// Function ID: 14123
// Name: PX_8
// Dependencies: [19, 17, 5313, 9002, 21, 712, 4668, 8434, 14121, 8435, 7197, 9262, 2]
...
import { PROFILE_FRAME_ASPECT_RATIO as closure_6 } from "PROFILE_FRAME_RESPONSIVE_RAIL_MIN_ASPECT_RATIO" /* 9002 */;
...
const memoResult1 = importAllResult.memo((isSelected) => {
  ...
  obj[1] = callback(setSelectedProfileFrame(9262), obj);
  obj[5] = callback(View, obj);
  return callback(profileFrame(8435).EditCollectiblesListItemProduct, obj);
});
