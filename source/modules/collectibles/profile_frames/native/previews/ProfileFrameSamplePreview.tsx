...
// Function ID: 9314
// Name: filterLayer
// Dependencies: [19, 17, 9294, 5697, 21, 4285, 712, 8743, 3988, 8740, 8726, 5293, 5251, 9314, 2]
// Exports: default

// Module 9313 (filterLayer)
import "noop";
...
export default function ProfileFrameSamplePreview(previewWidth) {
  ...
  ({ overflowTop, overflowBottom, overflowHorizontal } = importDefault(8743)(profileFrame, result));
  ...
  const tmp5 = importDefault(8743)(profileFrame, result);
  const tmp6 = require;
  obj[3] = require(8726) /* ProfileFrameLayerOrder */.ProfileFrameLayerOrder.BACK;
  obj[4] = result;
  obj[5] = previewHeight;
  let tmp12 = callback(importDefault(8740), obj);
  ...
  let tmp3Result = tmp3(5251);
  obj11[0] = importDefault(9314);
  obj10[0] = obj11;
  ...
  tmp3Result = tmp3(8740);
  obj12[3] = tmp6(8726).ProfileFrameLayerOrder.FRONT;
  obj12[4] = result;
