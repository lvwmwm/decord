...
// Function ID: 9285
// Name: filterLayer
// Dependencies: [19, 17, 9265, 5643, 21, 4255, 712, 8714, 3959, 8711, 8697, 5245, 5221, 9285, 2]
// Exports: default
...
export default function ProfileFrameSamplePreview(previewWidth) {
  ...
  ({ overflowTop, overflowBottom, overflowHorizontal } = importDefault(8714)(profileFrame, result));
  ...
  const tmp5 = importDefault(8714)(profileFrame, result);
  const tmp6 = require;
  obj[3] = require(8697) /* ProfileFrameLayerOrder */.ProfileFrameLayerOrder.BACK;
  obj[4] = result;
  obj[5] = previewHeight;
  let tmp12 = callback(importDefault(8711), obj);
  ...
  tmp3Result = tmp3(8711);
  obj12[3] = tmp6(8697).ProfileFrameLayerOrder.FRONT;
  obj12[4] = result;
