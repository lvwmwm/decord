...
// Function ID: 9331
// Name: filterLayer
// Dependencies: [19, 17, 9311, 5716, 21, 4302, 712, 8760, 4005, 8757, 8743, 5309, 5267, 9331, 2]
// Exports: default

// Module 9330 (filterLayer)
import "noop";
...
export default function ProfileFrameSamplePreview(previewWidth) {
  ...
  ({ overflowTop, overflowBottom, overflowHorizontal } = importDefault(8760)(profileFrame, result));
  ...
  const tmp5 = importDefault(8760)(profileFrame, result);
  const tmp6 = require;
  obj[3] = require(8743) /* ProfileFrameLayerOrder */.ProfileFrameLayerOrder.BACK;
  obj[4] = result;
  obj[5] = previewHeight;
  let tmp12 = callback(importDefault(8757), obj);
  ...
  let tmp3Result = tmp3(5267);
  obj11[0] = importDefault(9331);
  obj10[0] = obj11;
  ...
  tmp3Result = tmp3(8757);
  obj12[3] = tmp6(8743).ProfileFrameLayerOrder.FRONT;
  obj12[4] = result;
