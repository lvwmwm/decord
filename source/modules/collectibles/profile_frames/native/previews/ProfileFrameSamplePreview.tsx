...
// Function ID: 9314
// Name: filterLayer
// Dependencies: [19, 17, 9294, 5658, 21, 4285, 712, 8742, 3989, 8739, 8725, 5260, 5236, 9314, 2]
// Exports: default
...
export default function ProfileFrameSamplePreview(previewWidth) {
  ...
  ({ overflowTop, overflowBottom, overflowHorizontal } = importDefault(8742)(profileFrame, result));
  ...
  const tmp5 = importDefault(8742)(profileFrame, result);
  const tmp6 = require;
  obj[3] = require(8725) /* ProfileFrameLayerOrder */.ProfileFrameLayerOrder.BACK;
  obj[4] = result;
  obj[5] = previewHeight;
  let tmp12 = callback(importDefault(8739), obj);
  ...
  tmp3Result = tmp3(8739);
  obj12[3] = tmp6(8725).ProfileFrameLayerOrder.FRONT;
  obj12[4] = result;
