...
// Function ID: 9442
// Name: filterLayer
// Dependencies: [19, 17, 9422, 5815, 21, 4344, 712, 8865, 4065, 8862, 8848, 5349, 5307, 9442, 2]
// Exports: default

// Module 9441 (filterLayer)
import "noop";
...
export default function ProfileFrameSamplePreview(previewWidth) {
  ...
  ({ overflowTop, overflowBottom, overflowHorizontal } = importDefault(8865)(profileFrame, result));
  ...
  const tmp5 = importDefault(8865)(profileFrame, result);
  const tmp6 = require;
  obj[3] = require(8848) /* ProfileFrameLayerOrder */.ProfileFrameLayerOrder.BACK;
  obj[4] = result;
  obj[5] = previewHeight;
  let tmp12 = callback(importDefault(8862), obj);
  ...
  let tmp3Result = tmp3(5307);
  obj11[0] = importDefault(9442);
  obj10[0] = obj11;
  ...
  tmp3Result = tmp3(8862);
  obj12[3] = tmp6(8848).ProfileFrameLayerOrder.FRONT;
  obj12[4] = result;
