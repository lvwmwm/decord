...
// Function ID: 9402
// Name: filterLayer
// Dependencies: [19, 17, 9382, 5776, 21, 4303, 712, 8826, 4024, 8823, 8809, 5310, 5268, 9402, 2]
// Exports: default

// Module 9401 (filterLayer)
import "noop";
...
export default function ProfileFrameSamplePreview(previewWidth) {
  ...
  ({ overflowTop, overflowBottom, overflowHorizontal } = importDefault(8826)(profileFrame, result));
  ...
  const tmp5 = importDefault(8826)(profileFrame, result);
  const tmp6 = require;
  obj[3] = require(8809) /* ProfileFrameLayerOrder */.ProfileFrameLayerOrder.BACK;
  obj[4] = result;
  obj[5] = previewHeight;
  let tmp12 = callback(importDefault(8823), obj);
