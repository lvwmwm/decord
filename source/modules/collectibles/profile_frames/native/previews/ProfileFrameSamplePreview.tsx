...
// Function ID: 9396
// Name: filterLayer
// Dependencies: [19, 17, 9376, 5776, 21, 4303, 712, 8820, 4005, 8817, 8803, 5310, 5268, 9396, 2]
// Exports: default

// Module 9395 (filterLayer)
import "noop";
...
export default function ProfileFrameSamplePreview(previewWidth) {
  ...
  ({ overflowTop, overflowBottom, overflowHorizontal } = importDefault(8820)(profileFrame, result));
  ...
  const tmp5 = importDefault(8820)(profileFrame, result);
  const tmp6 = require;
  obj[3] = require(8803) /* ProfileFrameLayerOrder */.ProfileFrameLayerOrder.BACK;
  obj[4] = result;
  obj[5] = previewHeight;
  let tmp12 = callback(importDefault(8817), obj);
  ...
  let tmp3Result = tmp3(5268);
  obj11[0] = importDefault(9396);
  obj10[0] = obj11;
