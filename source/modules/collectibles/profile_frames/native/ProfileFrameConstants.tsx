...
// Module 8036 (PROFILE_FRAME_RESPONSIVE_RAIL_MIN_ASPECT_RATIO)
...
export const PROFILE_FRAME_Z_INDEX = { [require(8026).ProfileFrameLayerOrder.FRONT]: 3, [require(8026).ProfileFrameLayerOrder.BACK]: 2 };
