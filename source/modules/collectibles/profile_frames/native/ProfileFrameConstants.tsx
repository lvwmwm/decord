...
// Module 8740 (PROFILE_FRAME_RESPONSIVE_RAIL_MIN_ASPECT_RATIO)
...
export const PROFILE_FRAME_Z_INDEX = { [require(8725).ProfileFrameLayerOrder.FRONT]: 3, [require(8725).ProfileFrameLayerOrder.BACK]: 2 };
