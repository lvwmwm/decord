...
// Function ID: 8852
// Name: set
// Dependencies: [853, 8852, 8853, 8854, 2]
...
let closure_8 = { [arg1(8852).ProfileFrameLayerOrder.FRONT]: 0, [arg1(8852).ProfileFrameLayerOrder.BACK]: 1 };
...
export const parseLayerFilename = function parseLayerFilename(c7) {
  ...
  if (parts.length >= 2) {
    if (parts.length <= 4) {
      ...
      if (obj14.test(tmp19)) {
        if (set.has(tmp20)) {
          if (tmp20 === require(8853) /* ProfileFrameLayerType */.ProfileFrameLayerType.BORDER) {
            if (substr.length > 0) {
            ...
            if (substr.length > 1) {
              ...
              obj3[0] = Number(tmp19);
              obj3[1] = tmp20;
              obj3[2] = tmp4(8854).ProfileFrameLayerAnchor.CENTER;
            ...
            if (null != first) {
              if (set1.has(first)) {
                if (substr.length > 2) {
                  ...
                  obj7[1] = tmp20;
                  obj7[2] = first;
                  obj7[3] = 2 === substr.length || tmp20 === tmp4(8853).ProfileFrameLayerType.RAIL;
                  obj6[0] = obj7;
                  return obj6;
                }
              }
