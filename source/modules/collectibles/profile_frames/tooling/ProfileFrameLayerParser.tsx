...
// Function ID: 8866
// Name: set
// Dependencies: [853, 8866, 8867, 8868, 2]
...
let closure_8 = { [arg1(8866).ProfileFrameLayerOrder.FRONT]: 0, [arg1(8866).ProfileFrameLayerOrder.BACK]: 1 };
...
export const parseLayerFilename = function parseLayerFilename(c7) {
  ...
  if (parts.length >= 2) {
    if (parts.length <= 4) {
      ...
      if (obj14.test(tmp19)) {
        if (set.has(tmp20)) {
          if (tmp20 === require(8867) /* ProfileFrameLayerType */.ProfileFrameLayerType.BORDER) {
            if (substr.length > 0) {
            ...
            if (substr.length > 1) {
              ...
              obj3[0] = Number(tmp19);
              obj3[1] = tmp20;
              obj3[2] = tmp4(8868).ProfileFrameLayerAnchor.CENTER;
            ...
            if (null != first) {
              if (set1.has(first)) {
                if (substr.length > 2) {
                  ...
                  obj7[1] = tmp20;
                  obj7[2] = first;
                  obj7[3] = 2 === substr.length || tmp20 === tmp4(8867).ProfileFrameLayerType.RAIL;
                  obj6[0] = obj7;
                  return obj6;
                }
              }
