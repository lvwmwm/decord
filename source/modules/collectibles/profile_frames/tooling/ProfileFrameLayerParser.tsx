...
// Function ID: 8507
// Name: set
// Dependencies: [853, 8507, 8508, 8509, 2]
// Exports: compareLayerFiles, isPreviewFilename, parseLayerFilename

// Module 8506 (set)
import ProfileFrameLayerType from "ProfileFrameLayerType" /* 8508 */;
...
let closure_8 = { [arg1(8507).ProfileFrameLayerOrder.FRONT]: 0, [arg1(8507).ProfileFrameLayerOrder.BACK]: 1 };
        ...
        if (set.has(tmp20)) {
          if (tmp20 === ProfileFrameLayerType.ProfileFrameLayerType.BORDER) {
            ...
            if (substr.length > 1) {
              ...
              obj3[0] = Number(tmp19);
              obj3[1] = tmp20;
              obj3[2] = tmp4(8509).ProfileFrameLayerAnchor.CENTER;
            ...
            if (null != first) {
              if (set1.has(first)) {
                if (substr.length > 2) {
                  ...
                  obj7[1] = tmp20;
                  obj7[2] = first;
                  obj7[3] = 2 === substr.length || tmp20 === tmp4(8508).ProfileFrameLayerType.RAIL;
                  obj6[0] = obj7;
                  return obj6;
                }
              }
