...
// Function ID: 8138
// Name: set
// Dependencies: [850, 8138, 8139, 8140, 2]
// Exports: compareLayerFiles, isPreviewFilename, parseLayerFilename

// Module 8137 (set)
import ProfileFrameLayerType from "ProfileFrameLayerType" /* 8139 */;
...
let closure_8 = { [arg1(8138).ProfileFrameLayerOrder.FRONT]: 0, [arg1(8138).ProfileFrameLayerOrder.BACK]: 1 };
        ...
        if (set.has(tmp20)) {
          if (tmp20 === ProfileFrameLayerType.ProfileFrameLayerType.BORDER) {
            ...
            if (substr.length > 1) {
              ...
              obj3[0] = Number(tmp19);
              obj3[1] = tmp20;
              obj3[2] = tmp4(8140).ProfileFrameLayerAnchor.CENTER;
            ...
            if (null != first) {
              if (set1.has(first)) {
                if (substr.length > 2) {
                  ...
                  obj7[1] = tmp20;
                  obj7[2] = first;
                  obj7[3] = 2 === substr.length || tmp20 === tmp4(8139).ProfileFrameLayerType.RAIL;
                  obj6[0] = obj7;
                  return obj6;
                }
              }
