...
// Dependencies: [32, 19, 4394, 7475, 7519, 675, 586, 7522, 7474, 15734, 2]
// Exports: useMaybeFetchCollectiblesShopHome

// Module 15733 (useMaybeFetchCollectiblesShopHome)
import closure_2 from "_slicedToArray" /* 32 */;
import noop from "noop" /* 19 */;
import closure_6 from "getHash" /* 4394 */;
import closure_7 from "updateCategoriesAndProducts" /* 7475 */;
import closure_8 from "map" /* 7519 */;
...
export const useMaybeFetchCollectiblesShopHome = function useMaybeFetchCollectiblesShopHome(HOME, arg1, memo) {
  ...
  stateFromStores1 = _require(586).useStateFromStores(items1, () => skipNumCategories.skipNumCategories);
  const obj2 = _require(586);
  const items2 = [closure_8];
  const tmp3 = callback(_require(586).useStateFromStoresArray(items2, () => {
  ...
  const tmp13 = callback2(() => {
    ...
    obj.variantsReturnStyle = HOME(7522).ShopVariantsReturnStyle.VARIANTS_GROUP;
  ...
  const tmp14 = callback2(() => !HOME(7474).areRequestOptionsEqual(closure_7, closure_12), items4);
  closure_13 = tmp14;
  ...
  hasExpiredShopBlocks = _require(15734).useHasExpiredShopBlocks(tmp4, flag2, flag);
    ...
    if (stateFromStores) {
      if (!closure_9) {
        ...
        if (!tmp7) {
          ...
          if (tmp8) {
            const collectiblesShopHome = HOME(7474).fetchCollectiblesShopHome(HOME, closure_12, closure_2);
            const obj = HOME(7474);
          }
        }
