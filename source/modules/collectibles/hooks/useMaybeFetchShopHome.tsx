...
// Dependencies: [32, 19, 4217, 7004, 7048, 678, 589, 7051, 7003, 14842, 2]
// Exports: useMaybeFetchCollectiblesShopHome

// Module 14841 (useMaybeFetchCollectiblesShopHome)
...
export const useMaybeFetchCollectiblesShopHome = function useMaybeFetchCollectiblesShopHome(HOME, arg1, memo) {
  ...
  const tmp13 = callback2(() => {
    ...
    obj.variantsReturnStyle = HOME(7051).ShopVariantsReturnStyle.VARIANTS_GROUP;
  ...
  const tmp14 = callback2(() => !HOME(7003).areRequestOptionsEqual(c7, c12), items4);
  c13 = tmp14;
  ...
  hasExpiredShopBlocks = _require(14842).useHasExpiredShopBlocks(tmp4, flag2, flag);
    ...
    if (stateFromStores) {
      if (!c9) {
        ...
        if (!tmp7) {
          ...
          if (tmp8) {
            const collectiblesShopHome = HOME(7003).fetchCollectiblesShopHome(HOME, c12, _slicedToArray);
            const obj = HOME(7003);
          }
        }
