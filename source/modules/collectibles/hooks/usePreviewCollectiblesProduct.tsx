...
// Dependencies: [32, 19, 7239, 1949, 7240, 7241, 8439, 1951, 8020, 2]
// Exports: usePreviewCollectibleProduct

// Module 10776 (usePreviewCollectibleProduct)
...
export const usePreviewCollectibleProduct = function usePreviewCollectibleProduct(product, arg1, arg2) {
  ...
  dependencyMap = arg1;
  closure_2 = arg2;
  const shopProductItems = _require(8439).useShopProductItems(product);
