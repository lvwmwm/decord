...
// Dependencies: [19, 17, 8922, 5631, 6009, 21, 4478, 709, 11001, 4194, 1233, 12800, 586, 12824, 7307, 12826, 10997, 12759, 8918, 12746, 5961, 5981, 4445, 7295, 9232, 4474, 2]
// Exports: default

// Module 12823 (ShopThisLookCard)
...
export default function ShopThisLookActionSheet(arg0) {
  ...
  dependencyMap = React.useCallback((initialProductSkuId) => {
    ...
    obj.hideActionSheet();
    obj = { initialProductSkuId, analyticsLocations, analyticsSource: analyticsLocations(5981).USER_PROFILE_OVERFLOW_MENU };
  ...
  return callback(_require(5961).AnalyticsLocationProvider, obj);
};
