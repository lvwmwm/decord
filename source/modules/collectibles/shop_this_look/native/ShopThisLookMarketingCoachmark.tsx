...
// Dependencies: [19, 17, 1388, 5776, 21, 4303, 6144, 12514, 1236, 8659, 2]
// Exports: default

// Module 12516 (ShopThisLookMarketingCoachmarkImage)
...
function ShopThisLookMarketingCoachmarkImage() {
  return <View style={callback().imageContainer}>{jsx(require(6144) /* BumpingFistsSpotIllustration */.BumpingFistsSpotIllustration, { width: 100, height: 56, resizeMode: "contain" })}</View>;
}
