...
const memoResult1 = importAllResult.memo((isSelected) => {
  ...
  const obj2 = { <string:979172195>: 1000, <string:1377429346>: 600000, <string:3890416569>: "MESSAGE_CREATE", skuId: item.skuId, thumbnailUrlOverride: memo };
