...
// Module 6816 (RewardHeroBlockRecord)
...
const tmp2 = (() => {
  class RewardHeroBlockRecord {
    constructor(arg0) {
      self = this;
      tmp = outer1_2(this, RewardHeroBlockRecord);
      this.type = RewardHeroBlockRecord(outer1_1[2]).ShopBlockType.REWARD_HERO;
      ...
      obj = RewardHeroBlockRecord(outer1_1[3]);
      self.logoDisplayConfig = obj.getAssetDisplayConfig(arg0.logo_display_config);
      obj2 = RewardHeroBlockRecord(outer1_1[3]);
...
const result = require("ShopBlockType").fileFinishedImporting("modules/collectibles/records/RewardHeroBlockRecord.tsx");
