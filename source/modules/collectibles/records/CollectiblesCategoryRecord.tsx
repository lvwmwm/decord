...
// Function ID: 7051
// Name: fromServer
// Dependencies: [7051, 7058, 1949, 7060, 7061, 2]

// Module 7050 (fromServer)
...
prototype["fromServer"] = function fromServer(arg0) {
  ...
  obj.heroLogoDisplayConfig = require(7061) /* getItemRecordsFromPurchases */.getAssetDisplayConfig(hero_logo_display_config);
  const obj2 = require(7061) /* getItemRecordsFromPurchases */;
  const tmp2 = prototype;
  obj.heroBannerDisplayConfig = require(7061) /* getItemRecordsFromPurchases */.getAssetDisplayConfig(hero_banner_display_config);
  return new tmp2(obj);
};
