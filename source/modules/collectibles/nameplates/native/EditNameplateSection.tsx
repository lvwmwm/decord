...
// Function ID: 13729
// Name: memoResult1
// Dependencies: [19, 17, 1899, 21, 4189, 7960, 13727, 7961, 5535, 1898, 8067, 2]

// Module 13728 (memoResult1)
...
const memoResult = importAllResult.memo((arg0) => {
  ...
  const substr = items1.slice(0, require(7960) /* useCollectibleListLayout */.ROW_SIZE);
...
const memoResult1 = importAllResult.memo((nameplate) => {
  ...
  obj[5] = callback(setSelectedNameplate(8067), { nameplate: memo, fullOpacity: true, isSquarePreview: true, style: items2 });
  return callback(nameplate(7961).EditCollectiblesListItemProduct, obj);
});
