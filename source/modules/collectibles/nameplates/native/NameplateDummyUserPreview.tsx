...
// Dependencies: [19, 17, 1302, 21, 1297, 712, 4448, 589, 1364, 8490, 8492, 8493, 2]
// Exports: NameplateDummyUserPreview

// Module 8489 (NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG)
...
export const NameplateDummyUserPreview = function NameplateDummyUserPreview(hideAvatar) {
  ...
  obj1 = { style: tmp3.avatarContainer, children: callback(Button.Avatar, { source: importDefault(stateFromStores ? 8492 : 8493), size: NORMAL, "aria-hidden": true, style: tmp3.avatar }) };
