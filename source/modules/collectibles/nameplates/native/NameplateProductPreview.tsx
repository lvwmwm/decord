...
export default function NameplateProductPreview(product) {
  ...
  if (null != nameplateData) {
    ...
    obj3[5] = items1;
    items[1] = callback2(tmp2(4185).Text, obj3);
    ...
    obj7[5] = items2;
    items[5] = callback2(tmp2(4185).Text, obj7);
    ...
    obj9[3] = items4;
    items3[1] = callback(importDefault(4611), obj9);
    ...
    obj10[3] = items5;
    items3[2] = callback(importDefault(4611), obj10);
    obj[5] = items3;
    tmp7 = callback2(View, obj);
    const tmp16 = importDefault(4611);
  }
  return tmp7;
};
