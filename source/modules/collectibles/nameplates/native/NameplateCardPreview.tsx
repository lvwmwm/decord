...
// Dependencies: [17, 21, 4342, 712, 38, 1949, 1946, 9453, 1297, 2]
// Exports: default

// Module 9460 (NameplateCardPreview)
...
export default function NameplateCardPreview(arg0) {
  ...
  obj[3] = items;
  const items1 = [callback(require(9453) /* NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG */.NameplateDummyUserPreview, obj), , , , ];
  ...
  obj1[3] = items2;
  items1[1] = callback(require(9453) /* NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG */.NameplateDummyUserPreview, obj1);
  ...
  obj3[4] = animate;
  obj2[1] = callback(require(9453) /* NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG */.NameplateDummyUserPreview, obj3);
  ...
  obj4[3] = items3;
  items1[3] = callback(require(9453) /* NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG */.NameplateDummyUserPreview, obj4);
  ...
  obj5[3] = items4;
  items1[4] = callback(require(9453) /* NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG */.NameplateDummyUserPreview, obj5);
  obj[1] = items1;
