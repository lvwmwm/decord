...
// Module 8628 (NameplateCardPreview)
...
export default function NameplateCardPreview(arg0) {
  ...
  obj.style = items;
  const items1 = [callback(require(8007) /* NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG */.NameplateDummyUserPreview, obj), , , , ];
  const obj1 = { width: 44, avatarSize: require(1273) /* Button */.AvatarSizes.XSMALL, hideAvatar: true };
  const items2 = [{ opacity: 0.6 }];
  obj1.style = items2;
  items1[1] = callback(require(8007) /* NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG */.NameplateDummyUserPreview, obj1);
  ...
  obj2.children = callback(require(8007) /* NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG */.NameplateDummyUserPreview, obj3);
  ...
  obj4.style = items3;
  items1[3] = callback(require(8007) /* NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG */.NameplateDummyUserPreview, obj4);
  const obj5 = { width: 34, avatarSize: require(1273) /* Button */.AvatarSizes.XSMALL, hideAvatar: true };
  const items4 = [{ opacity: 0.6 }];
  obj5.style = items4;
  items1[4] = callback(require(8007) /* NAMEPLATE_DUMMY_USER_PREVIEW_CONFIG */.NameplateDummyUserPreview, obj5);
  obj.children = items1;
