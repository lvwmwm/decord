...
let obj = {};
obj = { name: require(dependencyMap[0]).PaletteKeys.Crimson };
obj[require(dependencyMap[0]).PaletteKeys.Crimson] = obj;
obj = { name: require(dependencyMap[0]).PaletteKeys.Berry };
obj[require(dependencyMap[0]).PaletteKeys.Berry] = obj;
const obj1 = { name: require(dependencyMap[0]).PaletteKeys.Sky };
obj[require(dependencyMap[0]).PaletteKeys.Sky] = obj1;
const obj2 = { name: require(dependencyMap[0]).PaletteKeys.Teal };
obj[require(dependencyMap[0]).PaletteKeys.Teal] = obj2;
const obj3 = { name: require(dependencyMap[0]).PaletteKeys.Forest };
obj[require(dependencyMap[0]).PaletteKeys.Forest] = obj3;
const obj4 = { name: require(dependencyMap[0]).PaletteKeys.BubbleGum };
obj[require(dependencyMap[0]).PaletteKeys.BubbleGum] = obj4;
const obj5 = { name: require(dependencyMap[0]).PaletteKeys.Violet };
...
const obj7 = { name: require(dependencyMap[0]).PaletteKeys.Clover };
obj[require(dependencyMap[0]).PaletteKeys.Clover] = obj7;
const obj8 = { name: require(dependencyMap[0]).PaletteKeys.Lemon };
...
export const INVALID_NAMEPLATE_PALETTE = {};
