...
// Module 13481 (useNameplateSections)
...
obj = { skuId: "None" };
obj = { skuId: "Shop" };
const result = arg1(dependencyMap[7]).fileFinishedImporting("modules/collectibles/nameplates/useNameplateSections.tsx");
