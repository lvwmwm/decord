...
// Dependencies: [57, 4157, 7964, 5790, 624, 2]
// Exports: default

// Module 9771 (getMidpointColor)
...
function getMidpointColor(toRgb, toRgb2) {
  ...
  const obj = require(7964) /* getProfileTheme */;
  [tmp4, tmp5, tmp6] = callback(require(7964) /* getProfileTheme */.getValueInColorGradientByPercentage(items, items1, 50), 3);
  return importDefault(5790)({ r, g, b });
}
...
function desaturate(toHsl) {
  ...
  let s;
  ({ h, s, l } = toHsl.toHsl());
  return importDefault(5790)({ h, s: s * arg1, l });
}
