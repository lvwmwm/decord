...
// Dependencies: [5, 1372, 676, 3, 17, 4154, 9038, 10502, 7, 10503, 10505, 1869, 4113, 10506, 10507, 10508, 530, 2]
// Exports: uploadDebugLogFiles

// Module 10501 (_uploadDebugLogFiles)
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            let obj4 = callback(9038);
            const obj2 = { type: null, underlyingError: null, errorMessage: null };
            obj2[0] = callback(9038).AVError.DEBUG_LOG_UPLOAD_FAILED;
            obj2[1] = closure_1;
