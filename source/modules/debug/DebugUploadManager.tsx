...
// Dependencies: [5, 1391, 676, 3, 17, 4243, 9215, 9917, 7, 9918, 9920, 1917, 4206, 9921, 9922, 9923, 530, 2]
// Exports: uploadDebugLogFiles

// Module 9916 (_uploadDebugLogFiles)
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            if (closure_2 instanceof callback(4243).UploadVoiceDebugLogsError) {
            ...
            let obj4 = callback(9215);
            const obj2 = { type: null, underlyingError: null, errorMessage: null };
            obj2[0] = callback(9215).AVError.DEBUG_LOG_UPLOAD_FAILED;
            obj2[1] = closure_1;
