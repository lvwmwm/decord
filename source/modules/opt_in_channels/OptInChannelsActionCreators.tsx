...
// Dependencies: [5, 1984, 1391, 4589, 676, 685, 5354, 1403, 5363, 5365, 709, 698, 4588, 12, 5368, 1374, 1306, 2]
...
// Module 5362 (_persistOptInChannelUpdates2)
...
export const updateOptInChannelsImmediate = function updateOptInChannelsImmediate(closure_0, id, arg2, location) {
  if (null != closure_0) {
    if (closure_4.isFullServerPreview(closure_0)) {
      ...
      obj3[3] = obj;
      dispatcherDefault.dispatch(obj3);
      tmp6Result = tmp6(5363);
      obj4 = { guildId: null, channelId: null, change: null, previous: null, label: null, location: null };
      obj4[0] = closure_0;
      obj4[1] = id;
      obj4[2] = obj;
      obj4[3] = currentChannelSettings;
      const NotificationLabel = tmp6(5363).NotificationLabel;
      obj4[4] = NotificationLabel.optedIn(arg2);
      obj4[5] = location;
...
export const bulkOptInChannels = function bulkOptInChannels(id, arr, arg2, location) {
  ...
  if (null != id) {
    if (closure_4.isFullServerPreview(id)) {
      const result = _require(5354).updateImpersonatedChannels(id, arr, []);
      if (flag) {
        const result1 = _require(5354).updateImpersonatedData(id, { optInEnabled: true });
        const tmp22Result = _require(5354);
      }
    } else {
      obj = {};
      ...
      if (flag) {
        ...
        obj[0] = setFlagResult;
        obj[1] = obj;
        const result2 = obj(5368).updateGuildAndChannelNotificationSettings(id, obj, _require(5363).NotificationLabels.OptedIn);
        const obj7 = obj(5368);
        obj = {};
        const obj9 = obj(698);
        const merged = Object.assign(_require(4588).collectGuildAnalyticsMetadata(id));
        obj.action_type = "add_many_and_enable_guild";
        obj.location = location;
        obj9.track(AnalyticEvents.CHANNEL_LIST_UPDATED, obj);
        const obj11 = _require(4588);
      } else {
        obj1 = obj(5368);
        const result3 = obj1.updateChannelOverrideSettingsBulk(id, obj, _require(5363).NotificationLabels.OptedIn);
        obj1 = {};
        const obj3 = obj(698);
        const merged1 = Object.assign(_require(4588).collectGuildAnalyticsMetadata(id));
        obj1.action_type = "add_many";
        obj1.location = location;
        obj3.track(AnalyticEvents.CHANNEL_LIST_UPDATED, obj1);
        const obj5 = _require(4588);
      }
    }
  }
};
export const bulkOptOutChannels = function bulkOptOutChannels(closure_0, arr, location) {
  ...
  if (null != closure_0) {
    if (closure_4.isFullServerPreview(closure_0)) {
      const result = _require(5354).updateImpersonatedChannels(closure_0, [], arr);
      const obj6 = _require(5354);
    } else {
      let obj = {};
      const item = arr.forEach((id) => {
        obj = { flags: null };
      ...
      const result1 = obj(5368).updateChannelOverrideSettingsBulk(closure_0, obj, _require(5363).NotificationLabels.OptedOut);
      const obj2 = obj(5368);
      obj = {};
      const obj3 = obj(698);
      const merged = Object.assign(_require(4588).collectGuildAnalyticsMetadata(closure_0));
...
export const clearGuildNotice = function clearGuildNotice(closure_0) {
  ...
  if (null != closure_0) {
    if (closure_4.isFullServerPreview(closure_0)) {
      const result = _require(5354).updateImpersonatedChannels(closure_0, [], items);
      const obj6 = _require(5354);
    } else {
      obj = {};
