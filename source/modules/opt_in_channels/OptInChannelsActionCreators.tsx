...
// Dependencies: [5, 1963, 1372, 4480, 676, 685, 5231, 1384, 5240, 5242, 709, 698, 4479, 12, 5245, 1355, 1306, 2]
...
// Module 5239 (_persistOptInChannelUpdates2)
...
export const setOptInChannel = function setOptInChannel(guildId1, id, arg2, location) {
  if (null != guildId1) {
    if (initialize.isFullServerPreview(guildId1)) {
      ...
      const result = require(5231) /* updateImpersonating */.updateImpersonatedChannels(guildId1, items1, items2);
      const obj18 = require(5231) /* updateImpersonating */;
    } else {
      ...
      let obj1 = require(5240) /* UserNotificationSettings */;
      obj = { flags: null };
      ...
      obj4[5] = location;
      const result2 = require(5240) /* UserNotificationSettings */.trackChannelNotificationSettingsUpdate(obj4);
      const obj11 = require(5240) /* UserNotificationSettings */;
      ...
      const merged = Object.assign(require(4479) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(guildId1));
      const obj16 = require(4479) /* collectGuildAnalyticsMetadata */;
      const merged1 = Object.assign(require(4479) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(store.getChannel(id)));
      let str = "remove";
      if (arg2) {
        str = "add";
      }
      ...
      const obj17 = require(4479) /* collectGuildAnalyticsMetadata */;
    }
  }
};
export const updateOptInChannelsImmediate = function updateOptInChannelsImmediate(closure_0, id, arg2, location) {
  if (null != closure_0) {
    if (initialize.isFullServerPreview(closure_0)) {
      ...
      const result = require(5231) /* updateImpersonating */.updateImpersonatedChannels(closure_0, items1, items2);
      const obj20 = require(5231) /* updateImpersonating */;
      const tmp26 = require;
      const result1 = require(5231) /* updateImpersonating */.updateImpersonatedData(closure_0, { optInEnabled: true });
    } else {
      let obj = store2;
      ...
      let obj2 = require(5240) /* UserNotificationSettings */;
      obj = { flags: null };
      ...
      if (!obj.isOptInEnabled(closure_0)) {
        ...
        obj[closure_0] = obj1;
        const result2 = importDefault(5242).saveUserGuildSettingsBulk(obj);
        const obj7 = importDefault(5242);
      }
      ...
      obj3[3] = obj;
      importDefault(709).dispatch(obj3);
      tmp6Result = tmp6(5240);
      obj4 = { guildId: null, channelId: null, change: null, previous: null, label: null, location: null };
      obj4[0] = closure_0;
      obj4[1] = id;
      obj4[2] = obj;
      obj4[3] = currentChannelSettings;
      const NotificationLabel = tmp6(5240).NotificationLabel;
      obj4[4] = NotificationLabel.optedIn(arg2);
      obj4[5] = location;
      ...
      const tmp6Result2 = require(4479) /* collectGuildAnalyticsMetadata */;
      const merged1 = Object.assign(require(4479) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(store.getChannel(id)));
      let str = "remove";
      if (arg2) {
        str = "add";
      ...
      const tmp6Result3 = require(4479) /* collectGuildAnalyticsMetadata */;
    }
  }
};
...
export const bulkOptInChannels = function bulkOptInChannels(id, arr, arg2, location) {
  ...
  if (null != id) {
    if (initialize.isFullServerPreview(id)) {
      const result = _require(5231).updateImpersonatedChannels(id, arr, []);
      if (flag) {
        const result1 = _require(5231).updateImpersonatedData(id, { optInEnabled: true });
        const tmp22Result = _require(5231);
      }
    } else {
      obj = {};
      ...
      if (flag) {
        ...
        obj[0] = setFlagResult;
        obj[1] = obj;
        const result2 = obj(5245).updateGuildAndChannelNotificationSettings(id, obj, _require(5240).NotificationLabels.OptedIn);
        const obj7 = obj(5245);
        obj = {};
        const obj9 = obj(698);
        const merged = Object.assign(_require(4479).collectGuildAnalyticsMetadata(id));
        obj.action_type = "add_many_and_enable_guild";
        obj.location = location;
        obj9.track(AnalyticEvents.CHANNEL_LIST_UPDATED, obj);
        const obj11 = _require(4479);
      } else {
        let obj1 = obj(5245);
        const result3 = obj1.updateChannelOverrideSettingsBulk(id, obj, _require(5240).NotificationLabels.OptedIn);
        obj1 = {};
        const obj3 = obj(698);
        const merged1 = Object.assign(_require(4479).collectGuildAnalyticsMetadata(id));
        obj1.action_type = "add_many";
        obj1.location = location;
        obj3.track(AnalyticEvents.CHANNEL_LIST_UPDATED, obj1);
        const obj5 = _require(4479);
      }
    }
  }
};
export const bulkOptOutChannels = function bulkOptOutChannels(closure_0, arr, location) {
  ...
  if (null != closure_0) {
    if (initialize.isFullServerPreview(closure_0)) {
      const result = _require(5231).updateImpersonatedChannels(closure_0, [], arr);
      const obj6 = _require(5231);
    } else {
      let obj = {};
      const item = arr.forEach((id) => {
        const obj = { flags: null };
      ...
      const result1 = obj(5245).updateChannelOverrideSettingsBulk(closure_0, obj, _require(5240).NotificationLabels.OptedOut);
      const obj2 = obj(5245);
      obj = {};
      const obj3 = obj(698);
      const merged = Object.assign(_require(4479).collectGuildAnalyticsMetadata(closure_0));
...
export const setGuildOptIn = function setGuildOptIn(id, arg1) {
  if (initialize.isFullServerPreview(id)) {
    ...
    obj[0] = arg1;
    const result = require(5231) /* updateImpersonating */.updateImpersonatedData(id, obj);
    const obj7 = require(5231) /* updateImpersonating */;
  } else {
    ...
    const merged = Object.assign(require(4479) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(id));
...
export const setIsFavorite = function setIsFavorite(guildId1, id, arg2, location) {
  if (null != guildId1) {
    if (!initialize.isFullServerPreview(guildId1)) {
      ...
      const tmp5Result1 = require(4479) /* collectGuildAnalyticsMetadata */;
    }
  }
};
...
export const clearGuildNotice = function clearGuildNotice(closure_0) {
  ...
  if (null != closure_0) {
    if (initialize.isFullServerPreview(closure_0)) {
      const result = _require(5231).updateImpersonatedChannels(closure_0, [], items);
      const obj6 = _require(5231);
    } else {
      obj = {};
