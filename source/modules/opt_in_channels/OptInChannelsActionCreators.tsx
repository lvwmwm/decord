...
// Dependencies: [5, 1934, 1372, 4480, 676, 685, 5216, 1384, 5225, 5227, 709, 698, 4479, 12, 5230, 1355, 1306, 2]
...
// Module 5224 (_persistOptInChannelUpdates2)
...
export const setOptInChannel = function setOptInChannel(guildId1, id, arg2, location) {
  if (null != guildId1) {
    if (initialize.isFullServerPreview(guildId1)) {
      ...
      const result = require(5216) /* updateImpersonating */.updateImpersonatedChannels(guildId1, items1, items2);
      const obj18 = require(5216) /* updateImpersonating */;
    } else {
      ...
      let obj1 = require(5225) /* UserNotificationSettings */;
      obj = { flags: null };
      ...
      obj4[5] = location;
      const result2 = require(5225) /* UserNotificationSettings */.trackChannelNotificationSettingsUpdate(obj4);
      const obj11 = require(5225) /* UserNotificationSettings */;
...
export const updateOptInChannelsImmediate = function updateOptInChannelsImmediate(closure_0, id, arg2, location) {
  if (null != closure_0) {
    if (initialize.isFullServerPreview(closure_0)) {
      ...
      const result = require(5216) /* updateImpersonating */.updateImpersonatedChannels(closure_0, items1, items2);
      const obj20 = require(5216) /* updateImpersonating */;
      const tmp26 = require;
      const result1 = require(5216) /* updateImpersonating */.updateImpersonatedData(closure_0, { optInEnabled: true });
    } else {
      let obj = store2;
      ...
      let obj2 = require(5225) /* UserNotificationSettings */;
      obj = { flags: null };
      ...
      if (!obj.isOptInEnabled(closure_0)) {
        ...
        obj[closure_0] = obj1;
        const result2 = importDefault(5227).saveUserGuildSettingsBulk(obj);
        const obj7 = importDefault(5227);
      }
      ...
      obj3[3] = obj;
      importDefault(709).dispatch(obj3);
      tmp6Result = tmp6(5225);
      obj4 = { guildId: null, channelId: null, change: null, previous: null, label: null, location: null };
      obj4[0] = closure_0;
      obj4[1] = id;
      obj4[2] = obj;
      obj4[3] = currentChannelSettings;
      const NotificationLabel = tmp6(5225).NotificationLabel;
      obj4[4] = NotificationLabel.optedIn(arg2);
      obj4[5] = location;
...
export const bulkOptInChannels = function bulkOptInChannels(id, arr, arg2, location) {
  ...
  if (null != id) {
    if (initialize.isFullServerPreview(id)) {
      const result = _require(5216).updateImpersonatedChannels(id, arr, []);
      if (flag) {
        const result1 = _require(5216).updateImpersonatedData(id, { optInEnabled: true });
        const tmp22Result = _require(5216);
      }
    } else {
      obj = {};
      ...
      if (flag) {
        ...
        obj[0] = setFlagResult;
        obj[1] = obj;
        const result2 = obj(5230).updateGuildAndChannelNotificationSettings(id, obj, _require(5225).NotificationLabels.OptedIn);
        const obj7 = obj(5230);
        obj = {};
        const obj9 = obj(698);
        ...
        let obj1 = obj(5230);
        const result3 = obj1.updateChannelOverrideSettingsBulk(id, obj, _require(5225).NotificationLabels.OptedIn);
        obj1 = {};
        const obj3 = obj(698);
...
export const bulkOptOutChannels = function bulkOptOutChannels(closure_0, arr, location) {
  ...
  if (null != closure_0) {
    if (initialize.isFullServerPreview(closure_0)) {
      const result = _require(5216).updateImpersonatedChannels(closure_0, [], arr);
      const obj6 = _require(5216);
    } else {
      let obj = {};
      const item = arr.forEach((id) => {
        const obj = { flags: null };
      ...
      const result1 = obj(5230).updateChannelOverrideSettingsBulk(closure_0, obj, _require(5225).NotificationLabels.OptedOut);
      const obj2 = obj(5230);
      obj = {};
      const obj3 = obj(698);
...
export const setGuildOptIn = function setGuildOptIn(id, arg1) {
  if (initialize.isFullServerPreview(id)) {
    ...
    obj[0] = arg1;
    const result = require(5216) /* updateImpersonating */.updateImpersonatedData(id, obj);
    const obj7 = require(5216) /* updateImpersonating */;
  } else {
...
export const setIsFavorite = function setIsFavorite(guildId1, id, arg2, location) {
  if (null != guildId1) {
    if (!initialize.isFullServerPreview(guildId1)) {
      ...
      const NotificationLabel = tmp5(5225).NotificationLabel;
...
export const clearGuildNotice = function clearGuildNotice(closure_0) {
  ...
  if (null != closure_0) {
    if (initialize.isFullServerPreview(closure_0)) {
      const result = _require(5216).updateImpersonatedChannels(closure_0, [], items);
      const obj6 = _require(5216);
    } else {
      obj = {};
