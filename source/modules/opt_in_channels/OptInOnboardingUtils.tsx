...
// Dependencies: [1340, 1980, 1990, 4540, 3977, 7042, 1403, 5296, 5287, 1306, 2]
// Exports: hasClearedGuildOnboardingNotice, hasNotSetUpChannelOptIn, toggleShowAllChannels

// Module 11001 (optIntoAllChannelsForExistingMember)
...
export const hasNotSetUpChannelOptIn = function hasNotSetUpChannelOptIn(guildId) {
  const result = require(7042) /* useOptInEnabledForGuild */.isOptInEnabledForGuild(guildId);
...
export const toggleShowAllChannels = function toggleShowAllChannels(id) {
  const result = require(7042) /* useOptInEnabledForGuild */.isOptInEnabledForGuild(id);
  ...
  if (tmp7) {
    ...
    tmp(5296).setGuildOptIn(id, !result1);
