...
// Dependencies: [1340, 1982, 1992, 4669, 4079, 7248, 1399, 5449, 5440, 1306, 2]
// Exports: hasClearedGuildOnboardingNotice, hasNotSetUpChannelOptIn, toggleShowAllChannels

// Module 11117 (optIntoAllChannelsForExistingMember)
...
export const toggleShowAllChannels = function toggleShowAllChannels(id) {
  ...
  if (tmp7) {
    ...
    tmp(5449).setGuildOptIn(id, !result1);
    const tmpResult1 = tmp(5449);
  }
};
