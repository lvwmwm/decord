...
// Dependencies: [1340, 1961, 1971, 4480, 3900, 6915, 1384, 5239, 5230, 1306, 2]
// Exports: hasClearedGuildOnboardingNotice, hasNotSetUpChannelOptIn, toggleShowAllChannels

// Module 10946 (optIntoAllChannelsForExistingMember)
...
export const hasNotSetUpChannelOptIn = function hasNotSetUpChannelOptIn(guildId) {
  const result = require(6915) /* useOptInEnabledForGuild */.isOptInEnabledForGuild(guildId);
...
export const toggleShowAllChannels = function toggleShowAllChannels(id) {
  const result = require(6915) /* useOptInEnabledForGuild */.isOptInEnabledForGuild(id);
  ...
  if (tmp7) {
    ...
    tmp(5239).setGuildOptIn(id, !result1);
    const tmpResult1 = tmp(5239);
  }
};
