...
// Dependencies: [1340, 1932, 1942, 4450, 3871, 6888, 1384, 5209, 5200, 1306, 2]
// Exports: hasClearedGuildOnboardingNotice, hasNotSetUpChannelOptIn, toggleShowAllChannels

// Module 10914 (optIntoAllChannelsForExistingMember)
...
export const hasNotSetUpChannelOptIn = function hasNotSetUpChannelOptIn(guildId) {
  const result = require(6888) /* useOptInEnabledForGuild */.isOptInEnabledForGuild(guildId);
...
export const toggleShowAllChannels = function toggleShowAllChannels(id) {
  const result = require(6888) /* useOptInEnabledForGuild */.isOptInEnabledForGuild(id);
  ...
  if (tmp7) {
    ...
    tmp(5209).setGuildOptIn(id, !result1);
    const tmpResult1 = tmp(5209);
  }
};
