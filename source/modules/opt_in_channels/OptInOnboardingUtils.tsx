...
// Dependencies: [1340, 1961, 1971, 4497, 3917, 6934, 1384, 5255, 5246, 1306, 2]
// Exports: hasClearedGuildOnboardingNotice, hasNotSetUpChannelOptIn, toggleShowAllChannels

// Module 10961 (optIntoAllChannelsForExistingMember)
...
export const hasNotSetUpChannelOptIn = function hasNotSetUpChannelOptIn(guildId) {
  const result = require(6934) /* useOptInEnabledForGuild */.isOptInEnabledForGuild(guildId);
...
export const toggleShowAllChannels = function toggleShowAllChannels(id) {
  const result = require(6934) /* useOptInEnabledForGuild */.isOptInEnabledForGuild(id);
  ...
  if (tmp7) {
    ...
    tmp(5255).setGuildOptIn(id, !result1);
    const tmpResult1 = tmp(5255);
  }
};
