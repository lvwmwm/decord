...
// Dependencies: [1340, 1983, 1993, 4667, 4078, 7227, 1403, 5446, 5437, 1306, 2]
// Exports: hasClearedGuildOnboardingNotice, hasNotSetUpChannelOptIn, toggleShowAllChannels

// Module 11088 (optIntoAllChannelsForExistingMember)
...
export const toggleShowAllChannels = function toggleShowAllChannels(id) {
  ...
  if (tmp7) {
    ...
    tmp(5446).setGuildOptIn(id, !result1);
    const tmpResult1 = tmp(5446);
  }
};
