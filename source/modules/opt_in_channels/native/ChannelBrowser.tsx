...
// Function ID: 10916
// Name: keyExtractor
// Dependencies: [32, 19, 17, 6885, 5207, 1932, 1862, 4450, 676, 1369, 21, 4255, 712, 5295, 10916, 589, 10918, 4071, 1358, 10914, 5886, 7638, 5302, 4797, 1236, 5890, 5221, 10920, 4251, 4445, 3973, 5634, 7751, 3959, 4715, 8231, 5306, 1297, 4245, 2]
// Exports: default

// Module 10915 (keyExtractor)
...
let closure_17 = importAllResult.memo((channel) => {
  ...
  obj = { style: tmp.categoryTitle, title: onChannelClick(4445)(channel), lineClamp: 1 };
  const items1 = [closure_12(channel(5634).TableRowGroupTitle, obj), ];
  ...
  if ("null" !== channel.id) {
    ...
    obj2[1] = tmp8(tmp4(7751).FormCheckbox, obj3);
  ...
  return closure_12(channel(4797).PressableOpacity, obj);
});
