...
// Function ID: 10004
// Name: setIndex
// Dependencies: [19, 1372, 5127, 4201, 3826, 1874, 676, 1379, 5788, 4386, 5658, 5102, 4380, 5128, 5781, 10004, 5126, 1222, 4005, 1358, 589, 1236, 3771, 11, 2]
...
export const getFirstRouteFor = function getFirstRouteFor(getSections) {
  ...
  if (sections[require(undefined, 5781) /* computeSubtitle */.SECTION_INDEX_GUILD_ACTIONS] > 0) {
  ...
  let SECTION_INDEX_UNCATEGORIZED_CHANNELS = require(5781) /* computeSubtitle */.SECTION_INDEX_UNCATEGORIZED_CHANNELS;
...
export const clearRecentChannels = function clearRecentChannels(closure_0, closure_1) {
  ...
  require(10004) /* _bulkClearRecents */.bulkClearRecents(closure_0, closure_1);
  const obj = require(10004) /* _bulkClearRecents */;
  const tmp2 = require;
  require(5126) /* ack */.bulkAck(closure_1.map((channelId) => ({ channelId, readStateType: constants.CHANNEL, messageId: generateOldThreadCutoff.lastMessageId(channelId) })));
  if (null != tmp) {
...
export const getActiveAgoTimestamp = function getActiveAgoTimestamp(id) {
  ...
  obj[0] = importDefault(3771)(obj.extractTimestamp(lastMessageIdResult)).fromNow();
