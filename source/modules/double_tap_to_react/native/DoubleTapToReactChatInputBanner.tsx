...
// Dependencies: [32, 19, 17, 4247, 1369, 1877, 21, 4255, 712, 500, 647, 5286, 1416, 4251, 1236, 11547, 4797, 5255, 9238, 503, 4116, 4256, 1297, 4223, 11639, 1959, 8747, 4682, 8557, 3928, 11031, 7858, 9887, 1358, 2]
// Exports: DoubleTapToReactChatInputBanner

// Module 11546 (DoubleTapToReactChatInputBannerInner)
...
function DoubleTapToReactChatInputBannerInner(emoji) {
  ...
  obj1[4] = url;
  const items1 = [closure_9(importDefault(5286), obj1), closure_9(require(4251) /* Text */.Text, { variant: "heading-xl/semibold", color: "interactive-text-default", children: "1" })];
  obj[1] = items1;
  ...
  const items3 = [closure_9(require(4251) /* Text */.Text, obj5), closure_9(require(11547) /* renderChannelBadge */.NewBadge, {})];
  obj4[1] = items3;
  ...
  obj8[5] = closure_9(require(5255) /* XSmallIcon */.XSmallIcon, { size: "sm", color: "icon-subtle" });
  items2[2] = closure_9(require(4797) /* PressableBase */.PressableOpacity, obj8);
  obj[1] = items2;
