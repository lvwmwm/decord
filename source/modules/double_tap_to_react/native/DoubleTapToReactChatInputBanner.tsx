...
// Dependencies: [32, 19, 17, 4662, 1388, 1925, 21, 4661, 712, 500, 647, 6930, 1435, 4734, 1236, 11458, 5433, 6368, 9177, 503, 4115, 4664, 1297, 4342, 11555, 2007, 6701, 4762, 8811, 4066, 10911, 8192, 10261, 1377, 2]
...
function DoubleTapToReactChatInputBannerInner(emoji) {
  ...
  obj1[4] = url;
  const items1 = [closure_9(importDefault(6930), obj1), closure_9(require(4734) /* Text */.Text, { variant: "heading-xl/semibold", color: "interactive-text-default", children: "1" })];
  obj[1] = items1;
  ...
  const items3 = [closure_9(require(4734) /* Text */.Text, obj5), closure_9(require(11458) /* renderChannelBadge */.NewBadge, {})];
  obj4[1] = items3;
  ...
  items4[1] = closure_9(require(4734) /* Text */.Text, obj6);
  obj3[1] = items4;
  ...
  obj8[5] = closure_9(require(6368) /* XSmallIcon */.XSmallIcon, { size: "sm", color: "icon-subtle" });
  items2[2] = closure_9(require(5433) /* PressableBase */.PressableOpacity, obj8);
  obj[1] = items2;
