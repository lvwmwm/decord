...
// Dependencies: [32, 19, 17, 4277, 1369, 1906, 21, 4285, 712, 500, 647, 5340, 1416, 4281, 1236, 11581, 4827, 5309, 9267, 503, 4145, 4286, 1297, 4253, 11673, 1988, 8776, 4712, 8586, 3957, 11063, 7999, 9918, 1358, 2]
// Exports: DoubleTapToReactChatInputBanner

// Module 11580 (DoubleTapToReactChatInputBannerInner)
...
function DoubleTapToReactChatInputBannerInner(emoji) {
  ...
  obj1[4] = url;
  const items1 = [closure_9(importDefault(5340), obj1), closure_9(require(4281) /* Text */.Text, { variant: "heading-xl/semibold", color: "interactive-text-default", children: "1" })];
  obj[1] = items1;
  ...
  const items3 = [closure_9(require(4281) /* Text */.Text, obj5), closure_9(require(11581) /* renderChannelBadge */.NewBadge, {})];
  obj4[1] = items3;
  ...
  obj8[5] = closure_9(require(5309) /* XSmallIcon */.XSmallIcon, { size: "sm", color: "icon-subtle" });
  items2[2] = closure_9(require(4827) /* PressableBase */.PressableOpacity, obj8);
  obj[1] = items2;
