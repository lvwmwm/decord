...
// Dependencies: [19, 17, 8143, 676, 8148, 21, 4342, 6080, 4707, 4710, 7859, 1236, 2]
// Exports: default

// Module 8147 (DoubleTapNitroAlert)
...
export default function DoubleTapNitroAlert(emojiName) {
  ...
  obj[1] = callback(require(7859) /* CircleErrorIcon */.CircleErrorIcon, { size: "custom", style: { width: 40, height: 40 } });
  ...
  const items = [callback(require(4710) /* getAlertModalItemKey */.AlertActionButton, obj1, "confirm"), ];
  const obj2 = { variant: "secondary", text: null };
  const intl4 = require(1236) /* getSystemLocale */.intl;
  obj2[1] = intl4.string(require(1236) /* getSystemLocale */.t["Nr6v2+"]);
  items[1] = callback(require(4710) /* getAlertModalItemKey */.AlertActionButton, obj2, "cancel");
  obj[0] = items;
