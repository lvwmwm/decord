...
// Dependencies: [5, 19, 17, 4372, 1495, 676, 1925, 21, 4380, 712, 4070, 8228, 1497, 589, 1435, 8784, 698, 8797, 4376, 1236, 5466, 4949, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 11292 (DoubleTapEmojiEditNudgeInner)
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  const items3 = [callback2(_location(4376).Text, obj), , ];
  ...
  obj1[4] = str;
  items3[1] = callback2(emoji(5466), obj1);
  ...
  obj2[4] = callback2(_location(4376).Text, obj3);
  items3[2] = callback2(_location(4949).PressableOpacity, obj2);
  obj[1] = items3;
...
export const DoubleTapEmojiEditNudge = function DoubleTapEmojiEditNudge(location) {
  const _location = location.location;
  let setting;
  const DoubleTapReactionEmoji = setting(4070).DoubleTapReactionEmoji;
