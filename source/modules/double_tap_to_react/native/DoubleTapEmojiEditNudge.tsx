...
// Dependencies: [5, 19, 17, 4277, 1475, 676, 1906, 21, 4285, 712, 3957, 7999, 1477, 589, 1416, 8560, 698, 8573, 4281, 1236, 5340, 4827, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 11049 (DoubleTapEmojiEditNudgeInner)
import ME from "ME";
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  const items3 = [callback2(_location(4281).Text, obj), , ];
  ...
  obj1[4] = str;
  items3[1] = callback2(emoji(5340), obj1);
  ...
  obj2[4] = callback2(_location(4281).Text, obj3);
  items3[2] = callback2(_location(4827).PressableOpacity, obj2);
  obj[1] = items3;
...
export const DoubleTapEmojiEditNudge = function DoubleTapEmojiEditNudge(location) {
  const _location = location.location;
  let setting;
  const DoubleTapReactionEmoji = setting(3957).DoubleTapReactionEmoji;
