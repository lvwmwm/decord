...
// Dependencies: [5, 19, 17, 4440, 1494, 676, 1925, 21, 4448, 712, 4136, 7845, 1496, 589, 1431, 9060, 698, 9073, 4444, 1236, 5553, 5036, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 11273 (DoubleTapEmojiEditNudgeInner)
import ThemesDefault from "Themes" /* 712 */;
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_6 from "maybeApplyNoTextColorForLightCustomTheme" /* 4440 */;
import closure_7 from "getDimensionsStoreStateForEntry" /* 1494 */;
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  const items3 = [callback2(_location(4444).Text, obj), , ];
  ...
  obj1[4] = str;
  items3[1] = callback2(emoji(5553), obj1);
  ...
  obj2[4] = callback2(_location(4444).Text, obj3);
  items3[2] = callback2(_location(5036).PressableOpacity, obj2);
  obj[1] = items3;
...
export const DoubleTapEmojiEditNudge = function DoubleTapEmojiEditNudge(location) {
  const _location = location.location;
  let setting;
  const DoubleTapReactionEmoji = setting(4136).DoubleTapReactionEmoji;
