...
// Dependencies: [5, 19, 17, 4294, 1475, 676, 1906, 21, 4302, 712, 3974, 8016, 1477, 589, 1416, 8577, 698, 8590, 4298, 1236, 5359, 4844, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 11064 (DoubleTapEmojiEditNudgeInner)
import ME from "ME";
