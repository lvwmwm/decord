...
// Dependencies: [5, 19, 17, 4277, 1475, 676, 1877, 21, 4285, 712, 3958, 7886, 1477, 589, 1416, 8559, 698, 8572, 4281, 1236, 5301, 4812, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 11045 (DoubleTapEmojiEditNudgeInner)
import ME from "ME";
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  obj1[4] = str;
  items3[1] = callback2(emoji(5301), obj1);
  ...
  items3[2] = callback2(_location(4812).PressableOpacity, obj2);
  obj[1] = items3;
...
export const DoubleTapEmojiEditNudge = function DoubleTapEmojiEditNudge(location) {
  const _location = location.location;
  let setting;
  const DoubleTapReactionEmoji = setting(3958).DoubleTapReactionEmoji;
