...
// Dependencies: [5, 19, 17, 4185, 1475, 676, 1877, 21, 4193, 712, 3866, 7755, 1477, 589, 1416, 9347, 698, 9360, 4189, 1236, 5210, 4721, 2]
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  const items3 = [callback2(_location(4189).Text, obj), , ];
  ...
  obj1[4] = str;
  items3[1] = callback2(emoji(5210), obj1);
  ...
  obj2[4] = callback2(_location(4189).Text, obj3);
  items3[2] = callback2(_location(4721).PressableOpacity, obj2);
  obj[1] = items3;
...
export const DoubleTapEmojiEditNudge = function DoubleTapEmojiEditNudge(location) {
  const _location = location.location;
  let setting;
  const DoubleTapReactionEmoji = setting(3866).DoubleTapReactionEmoji;
