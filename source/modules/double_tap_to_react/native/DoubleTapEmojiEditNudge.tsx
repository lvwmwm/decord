...
// Dependencies: [5, 19, 17, 4247, 1475, 676, 1877, 21, 4255, 712, 3928, 7874, 1477, 589, 1416, 9506, 698, 9519, 4251, 1236, 5272, 4783, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 10126 (DoubleTapEmojiEditNudgeInner)
import ME from "ME";
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  obj1[4] = str;
  items3[1] = callback2(emoji(5272), obj1);
  ...
  items3[2] = callback2(_location(4783).PressableOpacity, obj2);
  obj[1] = items3;
