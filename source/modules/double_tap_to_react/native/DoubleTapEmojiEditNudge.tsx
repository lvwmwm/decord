...
// Dependencies: [5, 19, 17, 4247, 1475, 676, 1877, 21, 4255, 712, 3928, 7858, 1477, 589, 1416, 8531, 698, 8544, 4251, 1236, 5286, 4797, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 11017 (DoubleTapEmojiEditNudgeInner)
import ME from "ME";
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  const items3 = [callback2(_location(4251).Text, obj), , ];
  ...
  obj1[4] = str;
  items3[1] = callback2(emoji(5286), obj1);
  ...
  obj2[4] = callback2(_location(4251).Text, obj3);
  items3[2] = callback2(_location(4797).PressableOpacity, obj2);
  obj[1] = items3;
...
export const DoubleTapEmojiEditNudge = function DoubleTapEmojiEditNudge(location) {
  const _location = location.location;
  let setting;
  const DoubleTapReactionEmoji = setting(3928).DoubleTapReactionEmoji;
