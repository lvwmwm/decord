...
// Dependencies: [5, 19, 17, 4473, 1493, 673, 1924, 21, 4481, 709, 4166, 7899, 1495, 586, 1431, 11053, 695, 11056, 4477, 1233, 7070, 5084, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 11665 (DoubleTapEmojiEditNudgeInner)
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  const items3 = [callback2(_location(4477).Text, obj), , ];
  ...
  obj1[4] = str;
  items3[1] = callback2(emoji(7070), obj1);
  ...
  obj2[4] = callback2(_location(4477).Text, obj3);
  items3[2] = callback2(_location(5084).PressableOpacity, obj2);
  obj[1] = items3;
