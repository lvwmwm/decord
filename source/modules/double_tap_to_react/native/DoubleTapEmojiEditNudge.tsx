...
// Dependencies: [5, 19, 17, 4470, 1494, 676, 1925, 21, 4478, 712, 4166, 7877, 1496, 589, 1431, 9098, 698, 9111, 4474, 1236, 5585, 5068, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 11310 (DoubleTapEmojiEditNudgeInner)
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  items3[2] = callback2(_location(5068).PressableOpacity, obj2);
  obj[1] = items3;
