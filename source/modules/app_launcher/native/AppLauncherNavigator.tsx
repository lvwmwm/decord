// Module ID: 11468
// Function ID: 11469
// Dependencies: [109, 19, 1479, 676, 21, 8570, 4303, 712, 5728, 5748, 4168, 1607, 5783, 4498, 1481, 11469, 11515, 11541, 11580, 9548, 2]
...
const memoResult = importAllResult.memo(function AppLauncherNavigator(arg0) {
  ...
  const obj2 = { name: AppLauncherRouteName.HOME, component: importDefault(11469), initialParams: null };
  ...
  const obj4 = { name: AppLauncherRouteName.APPLICATION_VIEW, component: importDefault(11515), initialParams: null };
  const obj5 = { context };
  let obj6 = obj12;
  ...
  const obj7 = { name: AppLauncherRouteName.COMMAND_VIEW, component: importDefault(11541), initialParams: null };
  let tmp15;
  ...
  const obj10 = { name: AppLauncherRouteName.APP_LIST_VIEW, component: importDefault(11580), initialParams: null };
