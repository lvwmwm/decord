// Module ID: 11471
// Function ID: 11472
// Dependencies: [109, 19, 1498, 676, 21, 8576, 4303, 712, 5728, 5748, 4168, 1626, 5783, 4498, 1500, 11472, 11518, 11544, 11583, 9554, 2]
...
const memoResult = importAllResult.memo(function AppLauncherNavigator(arg0) {
  ...
  const obj2 = { name: AppLauncherRouteName.HOME, component: importDefault(11472), initialParams: null };
  ...
  const obj4 = { name: AppLauncherRouteName.APPLICATION_VIEW, component: importDefault(11518), initialParams: null };
  const obj5 = { context };
  let obj6 = obj12;
  ...
  const obj7 = { name: AppLauncherRouteName.COMMAND_VIEW, component: importDefault(11544), initialParams: null };
  let tmp15;
  ...
  const obj10 = { name: AppLauncherRouteName.APP_LIST_VIEW, component: importDefault(11583), initialParams: null };
