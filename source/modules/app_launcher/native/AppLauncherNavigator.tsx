...
let obj = {};
obj = { "Null": "li", "Null": "applyChanges", "Null": "<string:3769892866>", "Null": "<string:1116405761>", backgroundColor: require("result").colors.MOBILE_KEYBOARD_PANEL_BACKGROUND };
obj.navigator = obj;
...
export default importAllResult.memo(function AppLauncherNavigator(arg0) {
  ...
  obj1.screenOptions = { contentStyle: items1 };
