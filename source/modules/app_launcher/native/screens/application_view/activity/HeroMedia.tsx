...
// Function ID: 11355
// Name: HeroMedia
// Dependencies: [19, 4247, 1479, 5324, 21, 4255, 9439, 10615, 589, 5601, 11329, 8764, 1236, 2]
// Exports: default, useHeroMediaDimensions

// Module 11354 (HeroMedia)
import "noop";
...
export default function HeroMedia(width) {
  ...
  require(9439) /* useDefaultAppLauncherWidth */;
  let bound = width;
  if (width == null) {
    let tmp8 = width;
    if (width == null) {
  ...
  const tmp13 = importDefault(10615)({ applicationId, size: diff, names: ["embedded_cover"] });
  ...
  let tmp18 = null;
  if (null != prop1) {
    tmp18 = importDefault(11329)(applicationId, prop.activity_preview_video_asset_id);
  }
