...
// Function ID: 11389
// Name: HeroMedia
// Dependencies: [19, 4277, 1479, 5378, 21, 4285, 9468, 10671, 589, 5655, 11363, 8793, 1236, 2]
// Exports: default, useHeroMediaDimensions

// Module 11388 (HeroMedia)
import "noop";
...
export default function HeroMedia(width) {
  ...
  const tmp13 = importDefault(10671)({ applicationId, size: diff, names: ["embedded_cover"] });
  ...
  let tmp18 = null;
  if (null != prop1) {
    tmp18 = importDefault(11363)(applicationId, prop.activity_preview_video_asset_id);
  }
