...
// Function ID: 11441
// Name: Tag
// Dependencies: [5, 32, 19, 17, 7509, 4308, 676, 21, 712, 4285, 4281, 9466, 11441, 11356, 11350, 6891, 8149, 1236, 698, 9467, 4695, 4295, 10882, 10885, 5610, 5630, 4815, 589, 5276, 5650, 10883, 7713, 5616, 11442, 11443, 11444, 1297, 11382, 10439, 4798, 11446, 2]
// Exports: default
...
export default function ActivityDetailContent(application) {
  ...
  if (tmp2Result.isRealApplication(application)) {
    ...
    if (isDeveloperOfThisApp) {
      ...
      obj[1] = num2;
      obj[0] = obj;
      const items1 = [callback3(tmp2(5276).TableRowDivider, {}), , ];
      ...
      obj1[2] = importAll(10883).toggleUseActivityUrlOverride;
      items1[1] = callback3(tmp2(5650).TableSwitchRow, obj1);
      ...
      if (useActivityUrlOverride) {
        ...
        obj3[2] = tmp20(10883).setActivityUrlOverride;
    ...
    const getOrFetchApplication = tmp2(5616).useGetOrFetchApplication(application.id);
    let bot;
    if (getOrFetchApplication != null) {
      bot = getOrFetchApplication.bot;
    }
    const tmp2Result1 = tmp2(5616);
    ...
    const delayedSwapToActivityActionLeave = tmp2(11442).useDelayedSwapToActivityActionLeave(activityAction);
    const obj5 = { context: null, application: null, activityAction: null };
    obj5[0] = context;
    obj5[1] = application;
    obj5[2] = delayedSwapToActivityActionLeave;
    const tmp2Result3 = tmp2(11442);
    ({ reason, disabled } = tmp5(11443)(obj5));
    const obj6 = { context: null, application: null, botUserId: null };
    obj6[0] = context;
    obj6[1] = application;
    let id;
    let tmp5Result = tmp5(11444);
    if (bot != null) {
      id = bot.id;
    }
    obj6[2] = id;
    if (null != getPrimaryAppCommand) {
      ...
      if (isDeveloperOfThisApp) {
        isDeveloperOfThisApp = tmp2(8149).isEmbeddedApp(application);
        const tmp2Result4 = tmp2(8149);
      }
      if (isDeveloperOfThisApp) {
    ...
    obj22[0] = application;
    const items7 = [callback3(tmp5(10439), obj22), , , , ];
    ...
    const tmp26 = tmp5(11443)(obj5);
    const tmp49 = Tag;
    let num5 = num;
    if (num == null) {
      num5 = 0;
    }
    obj24[1] = tmp2(11446).getItemSubtitleForMaxPlayersShort(num5);
    const tmp2Result5 = tmp2(11446);
    if (num == null) {
      num = 0;
    }
    obj24[2] = tmp5(11446)(num);
    ...
    return callback3(tmp2(5610).AnalyticsLocationProvider, obj15);
  } else {
    const _Error = Error;
