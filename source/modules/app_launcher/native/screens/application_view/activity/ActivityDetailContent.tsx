...
// Function ID: 11648
// Name: Tag
// Dependencies: [5, 32, 19, 17, 8444, 4472, 676, 21, 712, 4446, 4442, 8989, 11648, 11565, 11559, 7215, 8091, 1236, 698, 8381, 4893, 4459, 9454, 9415, 5918, 5938, 5036, 589, 5522, 5958, 9455, 7652, 5924, 11649, 11650, 11651, 1297, 11592, 9296, 5003, 11652, 2]
// Exports: default
...
import toggleUseActivityUrlOverrideAll from "toggleUseActivityUrlOverride" /* 9455 */;
import closure_4 from "asyncGeneratorStep" /* 5 */;
import closure_5 from "_slicedToArray" /* 32 */;
import closure_6 from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_8 from "initialize" /* 8444 */;
import closure_9 from "createExecutable" /* 4472 */;
...
function TryItOutButton(botUserId) {
  ...
  callback = React.useCallback(callback(function*() {
    ...
    obj1[0] = closure_1_1;
    obj1[1] = closure_1_0(8381).EntryPointCommandButtonActions.OPEN_APP_DM;
    ...
    obj2[0] = closure_1_0;
    yield closure_1_1(4459).openPrivateChannel(obj2);
    if (1 === tmp7) {
      dependencyMap = 0;
  ...
  obj[4] = callback;
  return callback3(botUserId(4893).Button, obj);
}
...
export default function ActivityDetailContent(application) {
  ...
  let obj2 = application(5036);
  const isScreenLandscape = obj2.useIsScreenLandscape();
  let detailsContainerLandscape = entrypoint !== application(8381).AppLauncherEntrypoint.VOICE && isScreenLandscape;
  ...
  if (tmp2Result.isRealApplication(application)) {
    ...
    if (isDeveloperOfThisApp) {
      ...
      obj[1] = num2;
      obj[0] = obj;
      const items1 = [callback3(tmp2(5522).TableRowDivider, {}), , ];
      ...
      items1[1] = callback3(tmp2(5958).TableSwitchRow, obj1);
      ...
      if (useActivityUrlOverride) {
        ...
        obj3[2] = tmp20(9455).setActivityUrlOverride;
        obj2[1] = tmp19(tmp2(7652).TextInput, obj3);
    ...
    const getOrFetchApplication = tmp2(5924).useGetOrFetchApplication(application.id);
    let bot;
    if (getOrFetchApplication != null) {
      bot = getOrFetchApplication.bot;
    }
    const tmp2Result1 = tmp2(5924);
    const obj4 = { context: null, applicationId: null };
    obj4[0] = context;
    obj4[1] = application.id;
    const activityAction = tmp2(11565).useActivityAction(obj4);
    const tmp2Result2 = tmp2(11565);
    const delayedSwapToActivityActionLeave = tmp2(11649).useDelayedSwapToActivityActionLeave(activityAction);
    const obj5 = { context: null, application: null, activityAction: null };
    obj5[0] = context;
    obj5[1] = application;
    obj5[2] = delayedSwapToActivityActionLeave;
    const tmp2Result3 = tmp2(11649);
    ({ reason, disabled } = tmp5(11650)(obj5));
    const obj6 = { context: null, application: null, botUserId: null };
    obj6[0] = context;
    obj6[1] = application;
    let id;
    let tmp5Result = tmp5(11651);
    if (bot != null) {
      id = bot.id;
    }
    obj6[2] = id;
    if (null != getPrimaryAppCommand) {
      ...
      if (tmp36Result) {
        ...
        obj12[2] = reason;
        tmp36Result = tmp36(tmp2(4442).Text, obj12);
      }
      ...
      if (isDeveloperOfThisApp) {
        isDeveloperOfThisApp = tmp2(8091).isEmbeddedApp(application);
        const tmp2Result4 = tmp2(8091);
      }
      if (isDeveloperOfThisApp) {
    ...
    obj22[0] = application;
    const items7 = [callback3(tmp5(9296), obj22), , , , ];
    ...
    obj25[0] = tmp.tagIcon;
    obj24[0] = callback3(tmp2(5003).GroupIcon, obj25);
    const tmp26 = tmp5(11650)(obj5);
    const tmp49 = Tag;
    let num5 = num;
    if (num == null) {
      num5 = 0;
    }
    obj24[1] = tmp2(11652).getItemSubtitleForMaxPlayersShort(num5);
    const tmp2Result5 = tmp2(11652);
    if (num == null) {
      num = 0;
    }
    obj24[2] = tmp5(11652)(num);
    ...
    return callback3(tmp2(5918).AnalyticsLocationProvider, obj15);
  } else {
    const _Error = Error;
