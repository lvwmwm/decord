...
// Function ID: 11679
// Name: Tag
// Dependencies: [5, 32, 19, 17, 8466, 4474, 676, 21, 712, 4448, 4444, 9012, 11679, 11596, 11590, 7236, 8113, 1236, 698, 8403, 4896, 4461, 9476, 9437, 5921, 5941, 5039, 589, 5525, 5961, 9477, 7673, 5927, 11680, 11681, 11682, 1297, 11623, 9318, 5006, 11683, 2]
// Exports: default
...
import toggleUseActivityUrlOverrideAll from "toggleUseActivityUrlOverride" /* 9477 */;
import closure_4 from "asyncGeneratorStep" /* 5 */;
import closure_5 from "_slicedToArray" /* 32 */;
import closure_6 from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_8 from "initialize" /* 8466 */;
import closure_9 from "createExecutable" /* 4474 */;
...
function TryItOutButton(botUserId) {
  ...
  callback = React.useCallback(callback(function*() {
    ...
    obj1[0] = closure_1_1;
    obj1[1] = closure_1_0(8403).EntryPointCommandButtonActions.OPEN_APP_DM;
    ...
    obj2[0] = closure_1_0;
    yield closure_1_1(4461).openPrivateChannel(obj2);
    if (1 === tmp7) {
      dependencyMap = 0;
  ...
  obj[4] = callback;
  return callback3(botUserId(4896).Button, obj);
}
...
export default function ActivityDetailContent(application) {
  ...
  let obj2 = application(5039);
  const isScreenLandscape = obj2.useIsScreenLandscape();
  let detailsContainerLandscape = entrypoint !== application(8403).AppLauncherEntrypoint.VOICE && isScreenLandscape;
  ...
  if (tmp2Result.isRealApplication(application)) {
    ...
    if (isDeveloperOfThisApp) {
      ...
      obj[1] = num2;
      obj[0] = obj;
      const items1 = [callback3(tmp2(5525).TableRowDivider, {}), , ];
      ...
      items1[1] = callback3(tmp2(5961).TableSwitchRow, obj1);
      ...
      if (useActivityUrlOverride) {
        ...
        obj3[2] = tmp20(9477).setActivityUrlOverride;
        obj2[1] = tmp19(tmp2(7673).TextInput, obj3);
    ...
    const getOrFetchApplication = tmp2(5927).useGetOrFetchApplication(application.id);
    let bot;
    if (getOrFetchApplication != null) {
      bot = getOrFetchApplication.bot;
    }
    const tmp2Result1 = tmp2(5927);
    const obj4 = { context: null, applicationId: null };
    obj4[0] = context;
    obj4[1] = application.id;
    const activityAction = tmp2(11596).useActivityAction(obj4);
    const tmp2Result2 = tmp2(11596);
    const delayedSwapToActivityActionLeave = tmp2(11680).useDelayedSwapToActivityActionLeave(activityAction);
    const obj5 = { context: null, application: null, activityAction: null };
    obj5[0] = context;
    obj5[1] = application;
    obj5[2] = delayedSwapToActivityActionLeave;
    const tmp2Result3 = tmp2(11680);
    ({ reason, disabled } = tmp5(11681)(obj5));
    const obj6 = { context: null, application: null, botUserId: null };
    obj6[0] = context;
    obj6[1] = application;
    let id;
    let tmp5Result = tmp5(11682);
    if (bot != null) {
      id = bot.id;
    }
    obj6[2] = id;
    if (null != getPrimaryAppCommand) {
      ...
      if (tmp36Result) {
        ...
        obj12[2] = reason;
        tmp36Result = tmp36(tmp2(4444).Text, obj12);
      }
      ...
      if (isDeveloperOfThisApp) {
        isDeveloperOfThisApp = tmp2(8113).isEmbeddedApp(application);
        const tmp2Result4 = tmp2(8113);
      }
      if (isDeveloperOfThisApp) {
    ...
    obj22[0] = application;
    const items7 = [callback3(tmp5(9318), obj22), , , , ];
    ...
    obj25[0] = tmp.tagIcon;
    obj24[0] = callback3(tmp2(5006).GroupIcon, obj25);
    const tmp26 = tmp5(11681)(obj5);
    const tmp49 = Tag;
    let num5 = num;
    if (num == null) {
      num5 = 0;
    }
    obj24[1] = tmp2(11683).getItemSubtitleForMaxPlayersShort(num5);
    const tmp2Result5 = tmp2(11683);
    if (num == null) {
      num = 0;
    }
    obj24[2] = tmp5(11683)(num);
    ...
    return callback3(tmp2(5921).AnalyticsLocationProvider, obj15);
  } else {
    const _Error = Error;
