...
// Function ID: 11452
// Name: xl
// Dependencies: [19, 17, 1903, 11407, 1479, 676, 21, 712, 4302, 4162, 589, 11371, 4005, 8175, 11376, 8278, 7529, 11452, 4298, 1297, 7691, 4247, 698, 5696, 11453, 4001, 1236, 11454, 2]
// Exports: default
...
export default function Header(application) {
  ...
  const tmp6Result = importDefault(8175)(tmp7, str);
  ...
  const items6 = [tmp13(importDefault(4162).View, { style: items5, pointerEvents: "none" }), tmp13(importDefault(11452), { onPress: onPressBack }), , ];
  ...
  items6[2] = tmp13(importDefault(4162).View, obj9);
  items6[3] = tmp13(scrollOffsetY(1297).Spacer, { size: 32, pointerEvents: "none" });
  obj8[2] = items6;
  items3[1] = callback2(importDefault(4162).View, obj8);
  ...
  obj5[2] = items3;
  return callback2(importDefault(4162).View, obj5);
};
