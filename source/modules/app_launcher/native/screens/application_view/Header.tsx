...
// Function ID: 12063
// Name: xl
// Dependencies: [19, 17, 1921, 9337, 1497, 673, 21, 709, 4481, 4218, 586, 11983, 4197, 8063, 11988, 9218, 8786, 12063, 4477, 1296, 8028, 4425, 695, 7130, 12064, 4193, 1233, 12065, 2]
// Exports: default
...
import AppLauncherBackButtonDefault from "AppLauncherBackButton" /* 12063 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_4 from "mergeGuildAvatar" /* 1921 */;
import closure_5 from "handleDismissWithDismissed" /* 9337 */;
...
export default function Header(application) {
  ...
  if (null != appLauncherIconSource) {
    ...
    obj[1] = xl;
    let tmp12 = callback(tmp5(11988), obj);
    let tmp13 = callback;
  } else {
    obj = { style: null };
  ...
  const tmpResult1 = scrollOffsetY(4218);
  fn.__closure = { interpolate: scrollOffsetY(4218).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  fn.__workletHash = 2572905048492;
  fn.__initData = closure_13;
  const animatedStyle = tmpResult1.useAnimatedStyle(fn);
  obj1 = { interpolate: scrollOffsetY(4218).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  ...
  const tmpResult2 = scrollOffsetY(4218);
  fn2.__closure = { interpolate: scrollOffsetY(4218).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  fn2.__workletHash = 8190094903650;
  fn2.__initData = closure_14;
  const animatedStyle1 = tmpResult2.useAnimatedStyle(fn2);
  const obj2 = { interpolate: scrollOffsetY(4218).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  ...
  const tmpResult3 = scrollOffsetY(4218);
  fn3.__closure = { interpolate: scrollOffsetY(4218).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  fn3.__workletHash = 14190901941859;
  fn3.__initData = closure_15;
  const animatedStyle2 = tmpResult3.useAnimatedStyle(fn3);
  let obj3 = { interpolate: scrollOffsetY(4218).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  const fn4 = function n() {
    const obj = { opacity: scrollOffsetY(_undefined[9]).interpolate(scrollOffsetY.get(), items, [0, 0.5], "clamp") };
    items = [52.5, closure_1_11];
    return obj;
  };
  const tmpResult4 = scrollOffsetY(4218);
  fn4.__closure = { interpolate: scrollOffsetY(4218).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  fn4.__workletHash = 9589752719246;
  fn4.__initData = closure_16;
  let str2 = "";
  const animatedStyle3 = tmpResult4.useAnimatedStyle(fn4);
  if (null != application) {
    str2 = tmp(9218).getSectionName(application);
    const tmpResult5 = tmp(9218);
  }
  ...
  if (hasApplicationFlagResult) {
    hasApplicationFlagResult = tmp(8786).hasApplicationFlag(application, constants.EMBEDDED);
    const tmpResult6 = tmp(8786);
  }
  ...
  let obj4 = { interpolate: scrollOffsetY(4218).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  ...
  const items6 = [tmp13(_modDef4218.View, { style: items5, pointerEvents: "none" }), tmp13(AppLauncherBackButtonDefault, { onPress: onPressBack }), , ];
  const obj6 = { style: items2, pointerEvents: "none", children: tmp13(currentUser2, obj7) };
  const tmp23 = currentUser2;
  items6[2] = tmp13(_modDef4218.View, { style: animatedStyle2, pointerEvents: "none", children: tmp13(scrollOffsetY(4477).Heading, { variant: "heading-lg/bold", color: "text-overlay-light", children: str2 }) });
  items6[3] = tmp13(scrollOffsetY(1296).Spacer, { size: 32, pointerEvents: "none" });
  obj8[2] = items6;
  items3[1] = callback2(_modDef4218.View, obj8);
  ...
  obj5[2] = items3;
  return callback2(_modDef4218.View, obj5);
};
