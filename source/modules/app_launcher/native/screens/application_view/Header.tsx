...
obj = { headerContainer: { <string:3972817578>: 24, <string:4254735698>: false, <string:1454007299>: null, <string:4249985275>: "heading-sm/medium", <string:1362845955>: "text-default" }, expandedHeaderBanner: { height: 105 } };
obj = { backgroundColor: SCREEN_BACKGROUND_COLOR, borderRadius: importDefault(dependencyMap[7]).radii.xl + 4 };
obj.appIconMask = obj;
const obj1 = { 1498502241: true, 1364484354: true, -1218182395: true, 1386888034: true, -1523142939: true, 1224934740: true, -47785302: true, -1808047101: true, 996518486: true, 979524694: true, paddingHorizontal: DEFAULT_CONTENT_PADDING, paddingBottom: importDefault(dependencyMap[7]).space.PX_12 };
obj.collapsedHeaderBanner = obj1;
obj.collapsedHeaderBannerOverlay = { 9223372036854775807: "r", 0: "isFLV", 9223372036854775807: "r", 0: "getVisibleLayouts", 0: "Array", -9223372036854775808: "num_chars" };
const obj2 = { <string:1140607356>: false, <string:1751293292>: false, borderRadius: xl, backgroundColor: importDefault(dependencyMap[7]).colors.BACKGROUND_MOD_MUTED };
...
export default function Header(application) {
  ...
  const tmp18 = function useCollapsedHeaderAnimation(scrollOffsetY) {
    ...
    const fn2 = function l() {
      ...
      obj.opacity = scrollOffsetY(closure_2[9]).interpolate(scrollOffsetY.get(), items2, [null, null], "clamp");
      return obj;
    };
    obj = { interpolate: application(hasApplicationFlagResult[9]).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: 105 };
    fn2.__closure = obj;
  ...
  const items5 = [
    ...
    function useCollapsedHeaderBannerOverlayAnimation(scrollOffsetY) {
      ...
      const fn = function n() {
        const obj = {};
        const items = ["keys", 105];
        obj.opacity = scrollOffsetY(closure_2[9]).interpolate(scrollOffsetY.get(), items, [false, false], "clamp");
        return obj;
      };
      obj = { interpolate: application(hasApplicationFlagResult[9]).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: 105 };
      fn.__closure = obj;
  ...
  obj6 = { INTEGRATION_CREATE: "BILLING_LOCATION", ConstraintReasonCode: "setLaunchPadPullTabPosition", children: str };
  obj5.children = callback(arg1(dependencyMap[18]).Heading, obj6);
  items6[2] = callback(importDefault(dependencyMap[9]).View, obj5);
  items6[3] = callback(arg1(dependencyMap[19]).Spacer, { "Null": 0., "Null": 0. });
