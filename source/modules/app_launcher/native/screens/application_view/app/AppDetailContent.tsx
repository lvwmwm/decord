...
__exportStarResult1.expandDescriptionCTAStyle = {};
...
__exportStarResult1.monetizationDisclosureContainerStyle = { marginBottom: require("__exportStarResult1").space.PX_24, gap: require("__exportStarResult1").space.PX_16 };
__exportStarResult1.monetizationDisclosureStyle = {};
const obj4 = { marginBottom: require("__exportStarResult1").space.PX_24, gap: require("__exportStarResult1").space.PX_16 };
...
export default function AppDetailContent(context) {
  ...
  const memo1 = React.useMemo(() => {
    ...
    if (result) {
      ...
      const items = [callback(context(sectionName[25]).BillIcon, { flex: "png", flexGrow: true }), ];
    ...
    if (isAndroidResult) {
      ...
      const items1 = [callback(context(sectionName[28]).ShopIcon, { flex: "png", flexGrow: true }), ];
