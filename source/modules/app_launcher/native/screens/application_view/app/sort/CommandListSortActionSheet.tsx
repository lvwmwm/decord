...
// Dependencies: [19, 11407, 21, 1236, 5323, 5322, 11423, 712, 7767, 7766, 2]
// Exports: default

// Module 11422 (CommandListSortActionSheet)
import "noop";
...
export default function CommandListSortActionSheet(sortOrder) {
  ...
  obj[0] = jsx(require(11423) /* ArrowsUpDownIcon */.ArrowsUpDownIcon, { size: "sm", color: null });
  const intl = require(1236) /* getSystemLocale */.intl;
  obj[1] = intl.string(require(1236) /* getSystemLocale */.t.yeYaHf);
  obj[1] = jsx(require(5322) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { size: "sm", color: null });
  const obj1 = {
    hasIcons: false,
  ...
  return jsx(require(5323) /* Background */.BottomSheet, { size: "sm", color: null });
};
