...
// Dependencies: [19, 11596, 21, 1236, 5458, 5457, 11612, 712, 8051, 8050, 2]
// Exports: default

// Module 11611 (CommandListSortActionSheet)
import "noop";
...
export default function CommandListSortActionSheet(sortOrder) {
  ...
  obj[0] = jsx(require(11612) /* ArrowsUpDownIcon */.ArrowsUpDownIcon, { size: "sm", color: null });
  const intl = require(1236) /* getSystemLocale */.intl;
  obj[1] = intl.string(require(1236) /* getSystemLocale */.t.yeYaHf);
  obj[1] = jsx(require(5457) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { size: "sm", color: null });
  const obj1 = {
    hasIcons: false,
  ...
  return jsx(require(5458) /* Background */.BottomSheet, { size: "sm", color: null });
};
