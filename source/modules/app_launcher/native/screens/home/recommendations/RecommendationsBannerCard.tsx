...
// Dependencies: [19, 17, 676, 21, 4285, 712, 8149, 8118, 1416, 11381, 4812, 11391, 1906, 11384, 4281, 1236, 11355, 5322, 2]
// Exports: default

// Module 11390 (RecommendationsBannerCard)
...
export default function RecommendationsBannerCard(application) {
  ...
  if (isLandscape) {
    ...
    obj[3] = isFirst;
    obj[4] = isLast;
    let tmp12Result = callback(tmp4(11381).BaseAppRow, obj);
  } else {
    ...
    const tmp10Result = tmp10(11391);
    obj4[1] = tmp4(8149).isEmbeddedApp(application);
    ...
    if (showsPromoted) {
      ...
      obj6[1] = tmp.badge;
      const items3 = [tmp14(tmp10(11384), obj6), ];
      if (showsPromoted) {
        ...
        obj7[1] = tmp14(tmp4(4281).Text, obj8);
    ...
    if (tmp14Result) {
      ...
      tmp14Result = tmp14(tmp10(11355), obj10);
    }
    ...
    const items6 = [callback(tmp4(4281).Text, obj12), ];
    const obj13 = { variant: "text-sm/normal", color: "text-subtle", lineClamp: 1, children: null };
    obj13[3] = application.description;
    items6[1] = callback(tmp4(4281).Text, obj13);
    obj11[1] = items6;
    items5[1] = closure_7(View, obj11);
    items5[2] = callback(tmp4(5322).TableRowArrow, {});
    obj9[1] = items5;
    items4[1] = closure_7(View, obj9);
    obj2[2] = items4;
    tmp12Result = tmp12(tmp4(4812).PressableOpacity, obj2);
    const tmp4Result = tmp4(8149);
  }
  return tmp12Result;
};
