...
// Dependencies: [19, 17, 676, 21, 4255, 712, 8137, 8106, 1416, 11381, 4783, 11390, 1906, 11384, 4251, 1236, 11355, 5293, 2]
// Exports: default

// Module 11389 (RecommendationsBannerCard)
...
export default function RecommendationsBannerCard(application) {
  ...
  if (isLandscape) {
    ...
    const tmp10Result = tmp10(11390);
    obj4[1] = tmp4(8137).isEmbeddedApp(application);
    ...
    items5[2] = callback(tmp4(5293).TableRowArrow, {});
    obj9[1] = items5;
    items4[1] = closure_7(View, obj9);
    obj2[2] = items4;
    tmp12Result = tmp12(tmp4(4783).PressableOpacity, obj2);
