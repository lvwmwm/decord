...
// Dependencies: [19, 17, 676, 21, 4302, 712, 8278, 8248, 1416, 11402, 4844, 11412, 1935, 11405, 4298, 1236, 11376, 5380, 2]
// Exports: default

// Module 11411 (RecommendationsBannerCard)
...
export default function RecommendationsBannerCard(application) {
  ...
  if (isLandscape) {
    ...
    obj[3] = isFirst;
    obj[4] = isLast;
    let tmp12Result = callback(tmp4(11402).BaseAppRow, obj);
  } else {
    ...
    const tmp10Result = tmp10(11412);
    obj4[1] = tmp4(8278).isEmbeddedApp(application);
    ...
    if (showsPromoted) {
      ...
      obj6[1] = tmp.badge;
      const items3 = [tmp14(tmp10(11405), obj6), ];
      if (showsPromoted) {
        ...
        obj7[1] = tmp14(tmp4(4298).Text, obj8);
    ...
    if (tmp14Result) {
      ...
      tmp14Result = tmp14(tmp10(11376), obj10);
    }
    ...
    const items6 = [callback(tmp4(4298).Text, obj12), ];
    const obj13 = { variant: "text-sm/normal", color: "text-subtle", lineClamp: 1, children: null };
    obj13[3] = application.description;
    items6[1] = callback(tmp4(4298).Text, obj13);
    obj11[1] = items6;
    items5[1] = closure_7(View, obj11);
    items5[2] = callback(tmp4(5380).TableRowArrow, {});
    obj9[1] = items5;
    items4[1] = closure_7(View, obj9);
    obj2[2] = items4;
    tmp12Result = tmp12(tmp4(4844).PressableOpacity, obj2);
    const tmp4Result = tmp4(8278);
  }
  return tmp12Result;
};
