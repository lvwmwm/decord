...
// Dependencies: [19, 17, 673, 21, 4481, 709, 9218, 8118, 1431, 12015, 5084, 12024, 1954, 12018, 4477, 1233, 11988, 5567, 2]
// Exports: default

// Module 12023 (RecommendationsBannerCard)
...
export default function RecommendationsBannerCard(application) {
  ...
  if (isLandscape) {
    ...
    obj[3] = isFirst;
    obj[4] = isLast;
    let tmp12Result = callback(tmp4(12015).BaseAppRow, obj);
  } else {
    ...
    const tmp10Result = tmp10(12024);
    obj4[1] = tmp4(9218).isEmbeddedApp(application);
    ...
    if (showsPromoted) {
      ...
      obj6[1] = tmp.badge;
      const items3 = [tmp14(tmp10(12018), obj6), ];
      if (showsPromoted) {
        ...
        obj7[1] = tmp14(tmp4(4477).Text, obj8);
    ...
    if (tmp14Result) {
      ...
      tmp14Result = tmp14(tmp10(11988), obj10);
    }
    ...
    const items6 = [callback(tmp4(4477).Text, obj12), ];
    const obj13 = { variant: "text-sm/normal", color: "text-subtle", lineClamp: 1, children: null };
    obj13[3] = application.description;
    items6[1] = callback(tmp4(4477).Text, obj13);
    obj11[1] = items6;
    items5[1] = closure_7(View, obj11);
    items5[2] = callback(tmp4(5567).TableRowArrow, {});
    obj9[1] = items5;
    items4[1] = closure_7(View, obj9);
    obj2[2] = items4;
    tmp12Result = tmp12(tmp4(5084).PressableOpacity, obj2);
    const tmp4Result = tmp4(9218);
  }
  return tmp12Result;
};
