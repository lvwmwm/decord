// Module ID: 11390
// Function ID: 11391
// Dependencies: [19, 17, 1882, 676, 21, 4255, 11060, 11382, 10792, 5207, 8105, 8436, 1416, 8033, 2]
...
let closure_10 = importAllResult.memo((applicationId) => {
  ...
  let importDefault;
  let obj = heroMediaDimensions(11060);
  ...
  const tmp4 = importDefault(10792)(obj);
  importDefault = tmp4;
  ...
  if (null != imageSource) {
    ...
    obj[0] = imageStyle;
    obj[1] = imageSource;
    let tmp8 = jsx(importDefault(5207), { style: null, source: null, resizeMode: "cover" });
  } else {
    obj1 = { style: null };
    obj1[0] = imageStyle;
...
let closure_11 = importAllResult.memo((applicationBot) => {
  ...
  const tmp3 = importDefault(8105);
  const obj = { displayProfile: importDefault(8105)(id), user: null };
  const tmp3Result = importDefault(8105)(id);
  const tmpResult = tmp(8436);
  obj[1] = new createdAt(applicationBot);
  return <tmpResult displayProfile={importDefault(8105)(id)} user={null} />;
});
const memoResult = importAllResult.memo(function RecommendationBanner(arg0) {
  ...
  if (null != overrideImageUrl) {
    ...
    obj[1] = obj1;
    obj[1] = jsx(importDefault(5207), { style: null, source: null, resizeMode: "cover" });
