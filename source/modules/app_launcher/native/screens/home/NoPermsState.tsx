...
// Function ID: 11385
// Name: EmptyState
// Dependencies: [19, 17, 21, 4255, 712, 4101, 4191, 11385, 11386, 11322, 9438, 4251, 1236, 2]
// Exports: default

// Module 11384 (EmptyState)
import "noop";
...
export default function EmptyState() {
  ...
  const tmp4Result = importDefault(obj.isThemeLight(importDefault(4191)()) ? 11385 : 11386);
  const logAppLauncherEmptyStateView = require(11322) /* handleApplicationSelected */.useLogAppLauncherEmptyStateView(tmp2(9438).AppLauncherEmptyStateType.HOME_NO_PERMISSIONS);
