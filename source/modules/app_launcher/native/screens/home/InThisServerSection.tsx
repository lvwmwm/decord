...
// Dependencies: [19, 17, 21, 4302, 712, 11408, 1351, 4298, 1236, 4844, 1348, 11371, 8603, 9484, 11376, 2]
// Exports: default

// Module 11430 (AppInThisServer)
import "noop";
...
function AppInThisServer(onAppSelected) {
  ...
  if (null != appLauncherIconSource) {
    ...
    tmp8 = callback(application(11376), obj);
  }
  const items1 = [tmp8, callback(onAppSelected(4298).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: application.name })];
  obj[5] = items1;
  return closure_6(onAppSelected(8603).PressableScale, obj, application.id);
}
...
export default function InThisServerSection(arg0) {
  ...
  if (0 === items.length) {
    ...
    if (tmp5Result) {
      ...
      obj1[3] = tmp5(tmp11(4298).Text, obj2);
      tmp5Result = tmp5(tmp11(4844).PressableOpacity, obj1);
    }
    items1[1] = tmp5Result;
    obj[1] = items1;
