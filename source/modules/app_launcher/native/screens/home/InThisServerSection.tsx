...
// Dependencies: [19, 17, 21, 4478, 712, 11660, 1471, 4474, 1236, 5068, 11623, 8984, 8435, 11628, 2]
// Exports: default

// Module 11682 (AppInThisServer)
...
export default function InThisServerSection(arg0) {
  ...
  if (0 === items.length) {
    ...
    if (tmp5Result) {
      ...
      tmp5Result = tmp5(tmp11(5068).PressableOpacity, obj1);
    }
    items1[1] = tmp5Result;
    obj[1] = items1;
