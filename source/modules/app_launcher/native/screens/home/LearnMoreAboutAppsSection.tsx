...
// Dependencies: [19, 17, 676, 21, 4661, 712, 4090, 1993, 1236, 11273, 9566, 4734, 5433, 2]
// Exports: default

// Module 11272 (LearnMoreAboutAppsSection)
...
export default function LearnMoreAboutAppsSection(visible) {
  ...
  obj[0] = require(9566) /* AppLauncherEntrypoint */.AppLauncherSectionName.NEW_TO_APPS;
  obj[3] = visible.visible;
  obj = { style: tmp.container, children: null };
  obj = { style: tmp.divider };
  const items = [callback(View, obj), callback(require(4734) /* Text */.Text, { accessibilityRole: "header", variant: "heading-lg/bold", color: "mobile-text-heading-primary", children: stringResult }), callback(require(4734) /* Text */.Text, { variant: "text-xs/normal", color: "text-default", style: tmp.body, children: stringResult1 }), callback(View, { style: tmp.divider }), , ];
  ...
  obj3[4] = callback(require(4734) /* Text */.Text, obj4);
  items[4] = callback(require(5433) /* PressableBase */.PressableHighlight, obj3);
  items[5] = callback(View, { style: tmp.divider });
  obj[1] = items;
  obj[4] = callback2(View, obj);
  return callback(importDefault(11273), obj);
};
