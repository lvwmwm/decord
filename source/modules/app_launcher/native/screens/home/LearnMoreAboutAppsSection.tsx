...
// Dependencies: [19, 17, 676, 21, 4255, 712, 3952, 1945, 1236, 11394, 8358, 4251, 4783, 2]
// Exports: default

// Module 11393 (LearnMoreAboutAppsSection)
...
export default function LearnMoreAboutAppsSection(visible) {
  ...
  obj[0] = require(8358) /* AppLauncherEntrypoint */.AppLauncherSectionName.NEW_TO_APPS;
  ...
  items[4] = callback(require(4783) /* PressableBase */.PressableHighlight, obj3);
  items[5] = callback(View, { style: tmp.divider });
  obj[1] = items;
  obj[4] = callback2(View, obj);
  return callback(importDefault(11394), obj);
};
