...
// Function ID: 11527
// Name: AppRowLabel
// Dependencies: [32, 19, 17, 1390, 8387, 4341, 11517, 3989, 11488, 1498, 676, 1388, 21, 712, 11521, 4342, 4338, 1236, 11500, 8386, 9842, 4039, 5414, 11495, 1435, 11136, 11527, 10724, 589, 7030, 11528, 5308, 8712, 11529, 11504, 1628, 11530, 8781, 8572, 9598, 1493, 9599, 10588, 11533, 11532, 11534, 11535, 11537, 11538, 11496, 7028, 11539, 12, 4539, 5861, 11541, 11542, 9399, 503, 4164, 1377, 11543, 11544, 11546, 6035, 11548, 1370, 11554, 11555, 11557, 11560, 11561, 11522, 11562, 11483, 11563, 11566, 8385, 11515, 11567, 11568, 11552, 11569, 1403, 11570, 11571, 2]
// Exports: default

// Module 11526 (AppRowLabel)
...
function getRecommendationItemsWithViewAll(arr) {
  ...
  if (arg3 === undefined) {
    COLLAPSED_LIST_ITEM_MAX = _require(11552).COLLAPSED_LIST_ITEM_MAX;
  }
  ...
  if (0 === arr.length) {
    ...
    obj[0] = _require(11532).AppLauncherHomeListItemType.RECOMMENDATION_SECTION_HEADER;
    obj[1] = arg2;
    obj[2] = arg1;
    obj[3] = length;
    obj[4] = bound;
    ...
    if (bound < length) {
      ...
      obj[0] = _require(11532).AppLauncherHomeListItemType.VIEW_ALL;
