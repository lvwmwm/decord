...
// Function ID: 11469
// Name: AppRowLabel
// Dependencies: [32, 19, 17, 1371, 8339, 4302, 11459, 3929, 11430, 1479, 676, 1369, 21, 712, 11463, 4303, 4299, 1236, 11442, 8338, 9792, 3979, 5374, 11437, 1416, 10251, 11469, 10749, 589, 6982, 11470, 5268, 8663, 11471, 11446, 1609, 11472, 8732, 8523, 9548, 1474, 9549, 10613, 11475, 11474, 11476, 11477, 11479, 11480, 11438, 6980, 11481, 12, 4498, 5821, 11483, 11484, 9349, 503, 4123, 1358, 11485, 11486, 11488, 5992, 11490, 1351, 11496, 11497, 11499, 11502, 11503, 11464, 11504, 11425, 11505, 11508, 8337, 11457, 11509, 11510, 11494, 11511, 1384, 11512, 11513, 2]
// Exports: default

// Module 11468 (AppRowLabel)
...
function getRecommendationItemsWithViewAll(arr) {
  ...
  if (arg3 === undefined) {
    COLLAPSED_LIST_ITEM_MAX = _require(11494).COLLAPSED_LIST_ITEM_MAX;
  }
  ...
  if (0 === arr.length) {
    ...
    obj[0] = _require(11474).AppLauncherHomeListItemType.RECOMMENDATION_SECTION_HEADER;
    obj[1] = arg2;
    obj[2] = arg1;
    obj[3] = length;
    obj[4] = bound;
    ...
    if (bound < length) {
      ...
      obj[0] = _require(11474).AppLauncherHomeListItemType.VIEW_ALL;
