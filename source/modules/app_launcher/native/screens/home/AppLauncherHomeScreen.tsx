...
// Function ID: 11526
// Name: AppRowLabel
// Dependencies: [32, 19, 17, 1390, 8387, 4341, 11516, 3989, 11487, 1498, 676, 1388, 21, 712, 11520, 4342, 4338, 1236, 11499, 8386, 9842, 4039, 5414, 11494, 1435, 11135, 11526, 10722, 589, 7030, 11527, 5308, 8712, 11528, 11503, 1628, 11529, 8781, 8572, 9598, 1493, 9599, 10586, 11532, 11531, 11533, 11534, 11536, 11537, 11495, 7028, 11538, 12, 4539, 5861, 11540, 11541, 9399, 503, 4164, 1377, 11542, 11543, 11545, 6035, 11547, 1370, 11553, 11554, 11556, 11559, 11560, 11521, 11561, 11482, 11562, 11565, 8385, 11514, 11566, 11567, 11551, 11568, 1403, 11569, 11570, 2]
// Exports: default

// Module 11525 (AppRowLabel)
...
function getRecommendationItemsWithViewAll(arr) {
  ...
  if (arg3 === undefined) {
    COLLAPSED_LIST_ITEM_MAX = _require(11551).COLLAPSED_LIST_ITEM_MAX;
  }
  ...
  if (0 === arr.length) {
    ...
    obj[0] = _require(11531).AppLauncherHomeListItemType.RECOMMENDATION_SECTION_HEADER;
    obj[1] = arg2;
    obj[2] = arg1;
    obj[3] = length;
    obj[4] = bound;
    ...
    if (bound < length) {
      ...
      obj[0] = _require(11531).AppLauncherHomeListItemType.VIEW_ALL;
