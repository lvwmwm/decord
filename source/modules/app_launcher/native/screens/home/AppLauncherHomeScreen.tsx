...
// Function ID: 11473
// Name: AppRowLabel
// Dependencies: [32, 19, 17, 1390, 8344, 4302, 11463, 3948, 11434, 1498, 676, 1388, 21, 712, 11467, 4303, 4299, 1236, 11446, 8343, 9798, 3998, 5374, 11441, 1435, 10257, 11473, 10755, 589, 6985, 11474, 5268, 8669, 11475, 11450, 1628, 11476, 8738, 8529, 9554, 1493, 9555, 10619, 11479, 11478, 11480, 11481, 11483, 11484, 11442, 6983, 11485, 12, 4498, 5821, 11487, 11488, 9355, 503, 4125, 1377, 11489, 11490, 11492, 5994, 11494, 1370, 11500, 11501, 11503, 11506, 11507, 11468, 11508, 11429, 11509, 11512, 8342, 11461, 11513, 11514, 11498, 11515, 1403, 11516, 11517, 2]
// Exports: default

// Module 11472 (AppRowLabel)
...
function getRecommendationItemsWithViewAll(arr) {
  ...
  if (arg3 === undefined) {
    COLLAPSED_LIST_ITEM_MAX = _require(11498).COLLAPSED_LIST_ITEM_MAX;
  }
  ...
  if (0 === arr.length) {
    ...
    obj[0] = _require(11478).AppLauncherHomeListItemType.RECOMMENDATION_SECTION_HEADER;
    obj[1] = arg2;
    obj[2] = arg1;
    obj[3] = length;
    obj[4] = bound;
    ...
    if (bound < length) {
      ...
      obj[0] = _require(11478).AppLauncherHomeListItemType.VIEW_ALL;
