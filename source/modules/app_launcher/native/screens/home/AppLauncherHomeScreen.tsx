...
// Function ID: 11530
// Name: AppRowLabel
// Dependencies: [32, 19, 17, 1390, 8383, 4343, 11520, 3989, 11491, 1498, 676, 1388, 21, 712, 11524, 4344, 4340, 1236, 11503, 8382, 9839, 4039, 5413, 11498, 1435, 10298, 11530, 10808, 589, 7024, 11531, 5307, 8708, 11532, 11507, 1628, 11533, 8777, 8568, 9594, 1493, 9595, 10672, 11536, 11535, 11537, 11538, 11540, 11541, 11499, 7022, 11542, 12, 4538, 5860, 11544, 11545, 9395, 503, 4166, 1377, 11546, 11547, 11549, 6033, 11551, 1370, 11557, 11558, 11560, 11563, 11564, 11525, 11565, 11486, 11566, 11569, 8381, 11518, 11570, 11571, 11555, 11572, 1403, 11573, 11574, 2]
// Exports: default

// Module 11529 (AppRowLabel)
...
function AppRowLabel(renderedName) {
  ...
  if (renderedName.showsPromoted) {
    ...
    obj1[1] = callback2(require(4340) /* Text */.Text, obj2);
...
function RecommendationSectionHeader(arg0) {
  ...
  style[1] = obj;
  return closure_19(require(4340) /* Text */.Text, { accessibilityRole: "header", variant: "heading-lg/bold", color: "mobile-text-heading-primary", style, children });
}
function getRecommendationItemsWithViewAll(arr) {
  const _require = arg1;
  let COLLAPSED_LIST_ITEM_MAX = arg3;
  if (arg3 === undefined) {
    COLLAPSED_LIST_ITEM_MAX = _require(11555).COLLAPSED_LIST_ITEM_MAX;
  }
  ...
  if (0 === arr.length) {
    ...
    obj[0] = _require(11535).AppLauncherHomeListItemType.RECOMMENDATION_SECTION_HEADER;
    obj[1] = arg2;
    obj[2] = arg1;
    obj[3] = length;
    obj[4] = bound;
    ...
    if (bound < length) {
      ...
      obj[0] = _require(11535).AppLauncherHomeListItemType.VIEW_ALL;
