...
// Function ID: 11470
// Name: AppRowLabel
// Dependencies: [32, 19, 17, 1371, 8339, 4302, 11460, 3929, 11431, 1479, 676, 1369, 21, 712, 11464, 4303, 4299, 1236, 11443, 8338, 9793, 3979, 5374, 11438, 1416, 10252, 11470, 10750, 589, 6982, 11471, 5268, 8663, 11472, 11447, 1609, 11473, 8732, 8523, 9548, 1474, 9549, 10614, 11476, 11475, 11477, 11478, 11480, 11481, 11439, 6980, 11482, 12, 4498, 5821, 11484, 11485, 9349, 503, 4123, 1358, 11486, 11487, 11489, 5992, 11491, 1351, 11497, 11498, 11500, 11503, 11504, 11465, 11505, 11426, 11506, 11509, 8337, 11458, 11510, 11511, 11495, 11512, 1384, 11513, 11514, 2]
// Exports: default

// Module 11469 (AppRowLabel)
...
function AppRowLabel(renderedName) {
  ...
  if (renderedName.showsPromoted) {
    ...
    obj1[1] = callback2(require(4299) /* Text */.Text, obj2);
...
function RecommendationSectionHeader(arg0) {
  ...
  style[1] = obj;
  return closure_19(require(4299) /* Text */.Text, { accessibilityRole: "header", variant: "heading-lg/bold", color: "mobile-text-heading-primary", style, children });
}
function getRecommendationItemsWithViewAll(arr) {
  const _require = arg1;
  let COLLAPSED_LIST_ITEM_MAX = arg3;
  if (arg3 === undefined) {
    COLLAPSED_LIST_ITEM_MAX = _require(11495).COLLAPSED_LIST_ITEM_MAX;
  }
  ...
  if (0 === arr.length) {
    ...
    obj[0] = _require(11475).AppLauncherHomeListItemType.RECOMMENDATION_SECTION_HEADER;
    obj[1] = arg2;
    obj[2] = arg1;
    obj[3] = length;
    obj[4] = bound;
    ...
    if (bound < length) {
      ...
      obj[0] = _require(11475).AppLauncherHomeListItemType.VIEW_ALL;
