...
// Function ID: 11543
// Name: AppRowLabel
// Dependencies: [32, 19, 17, 1390, 8409, 4341, 11533, 3989, 11504, 1498, 676, 1388, 21, 712, 11537, 4342, 4338, 1236, 11516, 8408, 9853, 4039, 5435, 11511, 1435, 11152, 11543, 10740, 589, 7052, 11544, 5329, 8726, 11545, 11520, 1628, 11546, 8795, 8594, 9611, 1493, 9612, 10604, 11549, 11548, 11550, 11551, 11553, 11554, 11512, 7050, 11555, 12, 4549, 5882, 11557, 11558, 9413, 503, 4164, 1377, 11559, 11560, 11562, 6056, 11564, 1370, 11570, 11571, 11573, 11576, 11577, 11538, 11578, 11499, 11579, 11582, 8407, 11531, 11583, 11584, 11568, 11585, 1403, 11586, 11587, 2]
// Exports: default

// Module 11542 (AppRowLabel)
...
function AppRowLabel(renderedName) {
  ...
  if (renderedName.showsPromoted) {
    ...
    obj1[1] = callback2(require(4338) /* Text */.Text, obj2);
...
function RecommendationSectionHeader(arg0) {
  ...
  style[1] = obj;
  return closure_19(require(4338) /* Text */.Text, { accessibilityRole: "header", variant: "heading-lg/bold", color: "mobile-text-heading-primary", style, children });
}
function getRecommendationItemsWithViewAll(arr) {
  const _require = arg1;
  let COLLAPSED_LIST_ITEM_MAX = arg3;
  if (arg3 === undefined) {
    COLLAPSED_LIST_ITEM_MAX = _require(11568).COLLAPSED_LIST_ITEM_MAX;
  }
  ...
  if (0 === arr.length) {
    ...
    obj[0] = _require(11548).AppLauncherHomeListItemType.RECOMMENDATION_SECTION_HEADER;
    obj[1] = arg2;
    obj[2] = arg1;
    obj[3] = length;
    obj[4] = bound;
    ...
    if (bound < length) {
      ...
      obj[0] = _require(11548).AppLauncherHomeListItemType.VIEW_ALL;
