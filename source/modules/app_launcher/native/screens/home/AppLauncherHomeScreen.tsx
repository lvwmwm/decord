...
// Function ID: 11388
// Name: AppRowLabel
// Dependencies: [32, 19, 17, 1371, 8262, 4284, 11378, 3912, 11349, 1479, 676, 1369, 21, 712, 11382, 4285, 4281, 1236, 11361, 8261, 9710, 3962, 5354, 11356, 1416, 10169, 11388, 10671, 589, 6903, 11389, 5251, 8586, 11390, 11365, 1609, 11391, 8655, 8446, 9466, 1474, 9467, 10550, 11394, 11393, 11395, 11396, 11398, 11399, 11357, 6901, 11400, 12, 4479, 5742, 11402, 11403, 9267, 503, 4100, 1358, 11404, 11405, 11407, 5913, 11409, 1351, 11415, 11416, 11418, 11421, 11422, 11383, 11423, 11344, 11424, 11427, 8260, 11376, 11428, 11429, 11413, 11430, 1384, 11431, 11432, 2]
// Exports: default

// Module 11387 (AppRowLabel)
...
function AppRow(isLastRow) {
  ...
  let obj = require(11356) /* handleApplicationSelected */;
...
function getRecommendationItemsWithViewAll(arr) {
  ...
  if (arg3 === undefined) {
    COLLAPSED_LIST_ITEM_MAX = _require(11413).COLLAPSED_LIST_ITEM_MAX;
  }
  ...
  if (0 === arr.length) {
    ...
    obj[0] = _require(11393).AppLauncherHomeListItemType.RECOMMENDATION_SECTION_HEADER;
    obj[1] = arg2;
    obj[2] = arg1;
    obj[3] = length;
    obj[4] = bound;
    ...
    if (bound < length) {
      ...
      obj[0] = _require(11393).AppLauncherHomeListItemType.VIEW_ALL;
