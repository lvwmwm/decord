...
// Function ID: 11354
// Name: AppRowLabel
// Dependencies: [32, 19, 17, 1371, 8122, 4254, 11344, 3883, 11315, 1479, 676, 1369, 21, 712, 11348, 4255, 4251, 1236, 11327, 8121, 9679, 3933, 5300, 11322, 1416, 10138, 11354, 10615, 589, 6876, 11355, 5221, 8557, 11356, 11331, 1581, 11357, 8626, 8306, 9437, 1474, 9438, 10485, 11360, 11359, 11361, 11362, 11364, 11365, 11323, 6874, 11366, 12, 4449, 5715, 11368, 11369, 9238, 503, 4071, 1358, 11370, 11371, 11373, 5886, 11375, 1351, 11381, 11382, 11384, 11387, 11388, 11349, 11389, 11310, 11390, 11393, 8120, 11342, 11394, 11395, 11379, 11396, 1384, 11397, 11398, 2]
// Exports: default

// Module 11353 (AppRowLabel)
...
function getRecommendationItemsWithViewAll(arr) {
  ...
  if (arg3 === undefined) {
    COLLAPSED_LIST_ITEM_MAX = _require(11379).COLLAPSED_LIST_ITEM_MAX;
  }
  ...
  if (0 === arr.length) {
    ...
    obj[0] = _require(11359).AppLauncherHomeListItemType.RECOMMENDATION_SECTION_HEADER;
    obj[1] = arg2;
    obj[2] = arg1;
    obj[3] = length;
    obj[4] = bound;
    ...
    if (bound < length) {
      ...
      obj[0] = _require(11359).AppLauncherHomeListItemType.VIEW_ALL;
