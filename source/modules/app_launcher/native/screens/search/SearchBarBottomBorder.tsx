...
// Dependencies: [19, 21, 4285, 712, 4146, 4694, 4698, 2]
// Exports: usePinnedSearchBarBottomBorder

// Module 11396 (usePinnedSearchBarBottomBorder)
...
export const usePinnedSearchBarBottomBorder = function usePinnedSearchBarBottomBorder(arg0) {
  ...
  let sharedValue;
  let obj = triggerScrollHeight(4146);
  ...
  const animatedStyle = triggerScrollHeight(4146).useAnimatedStyle(fn);
  const items2 = [tmp.border, animatedStyle];
  obj[1] = jsx(sharedValue(4146).View, { style: items2 }, key);
  return obj;
};
