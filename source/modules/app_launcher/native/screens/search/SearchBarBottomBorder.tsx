...
// Dependencies: [31, 33, 4165, 689, 4026, 4577, 4581, 2]
// Exports: usePinnedSearchBarBottomBorder

// Module 11246 (usePinnedSearchBarBottomBorder)
...
export const usePinnedSearchBarBottomBorder = function usePinnedSearchBarBottomBorder(arg0) {
  ...
  let sharedValue;
  let obj = triggerScrollHeight(4026);
  ...
  obj = { withSpring: triggerScrollHeight(4577).withSpring, scrollPosition: sharedValue, triggerScrollHeight, springStandard: triggerScrollHeight(4581).springStandard };
  fn.__closure = obj;
  fn.__workletHash = 5466161440826;
  fn.__initData = closure_6;
  obj = { scrollHandler: callback };
  const animatedStyle = triggerScrollHeight(4026).useAnimatedStyle(fn);
  const items2 = [tmp.border, animatedStyle];
  obj.bottomBorderComponent = jsx(sharedValue(4026).View, { style: items2 }, key);
  return obj;
};
