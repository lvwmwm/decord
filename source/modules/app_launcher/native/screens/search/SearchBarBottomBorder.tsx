...
// Dependencies: [19, 21, 4255, 712, 4116, 4665, 4669, 2]
// Exports: usePinnedSearchBarBottomBorder

// Module 11395 (usePinnedSearchBarBottomBorder)
...
export const usePinnedSearchBarBottomBorder = function usePinnedSearchBarBottomBorder(arg0) {
  ...
  obj = { withSpring: triggerScrollHeight(4665).withSpring, scrollPosition: sharedValue, triggerScrollHeight, springStandard: triggerScrollHeight(4669).springStandard };
  fn.__closure = obj;
