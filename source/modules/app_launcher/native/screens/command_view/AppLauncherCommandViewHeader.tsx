...
// Dependencies: [19, 17, 1479, 21, 11305, 4189, 712, 11225, 4050, 3893, 7911, 5141, 4185, 1297, 2]
// Exports: AppLauncherCommandViewHeader

// Module 11331 (DEFAULT_CONTENT_PADDING)
...
export const AppLauncherCommandViewHeader = function AppLauncherCommandViewHeader(onPress) {
  ...
  obj = { interpolate: scrollOffsetY(4050).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE: closure_8 };
  A.__closure = obj;
  A.__workletHash = 15596175827193;
  A.__initData = closure_10;
  const animatedStyle = obj.useAnimatedStyle(A);
  let obj2 = scrollOffsetY(4050);
  class E {
    constructor() {
  ...
  obj = { APP_ICON_SIZE: 72, APP_ICON_BORDER_WIDTH: 4, DEFAULT_CONTENT_PADDING, interpolate: scrollOffsetY(4050).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE: closure_8 };
  E.__closure = obj;
  E.__workletHash = 13563524587234;
  E.__initData = closure_11;
  const animatedStyle1 = obj2.useAnimatedStyle(E);
  let obj4 = scrollOffsetY(4050);
  class N {
    constructor() {
      obj = { opacity: null };
      obj2 = scrollOffsetY(outer1_2[8]);
  ...
  N.__closure = { interpolate: scrollOffsetY(4050).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE: closure_8 };
  N.__workletHash = 2637023147700;
  N.__initData = closure_12;
  const animatedStyle2 = obj4.useAnimatedStyle(N);
  let obj1 = { interpolate: scrollOffsetY(4050).interpolate, scrollOffsetY, TOTAL_SCROLL_RANGE: closure_8 };
  let str = scrollOffsetY(3893).useToken(section(712).colors.BACKGROUND_BASE_LOW);
  let tmp10 = memo;
  const obj7 = scrollOffsetY(3893);
  ...
  const tmp9 = section(7911);
  if (null != memo) {
    obj2 = { style: null, source: null };
    obj2[0] = tmp.appIcon;
    obj2[1] = memo;
    let tmp15 = callback(tmp8(5141), obj2);
    let tmp16 = callback;
  } else {
  ...
  const items4 = [tmp16(section(4050).View, { style: items3 }), tmp16(section(11305), { onPress: onPress.onPressBack }), , , ];
  ...
  obj5[5] = displayName;
  items4[2] = tmp16(scrollOffsetY(4185).Text, obj5);
  items4[3] = tmp16(scrollOffsetY(1297).Spacer, { size: 32 });
  const items6 = [tmp.appIconMask, animatedStyle1];
  items4[4] = tmp16(section(4050).View, { style: items6, children: tmp15 });
  obj4[1] = items4;
