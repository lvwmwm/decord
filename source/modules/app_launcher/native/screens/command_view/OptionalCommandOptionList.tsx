...
obj = {};
obj = { trackGameProfileClose: true, secureTextEntry: true, borderColor: importDefault(dependencyMap[4]).colors.BORDER_SUBTLE, backgroundColor: importDefault(dependencyMap[4]).colors.BACKGROUND_SURFACE_HIGH, borderRadius: importDefault(dependencyMap[4]).radii.lg };
