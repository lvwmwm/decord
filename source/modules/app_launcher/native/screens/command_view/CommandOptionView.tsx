...
// Function ID: 11467
// Name: set
// Dependencies: [19, 17, 4277, 21, 1935, 4285, 712, 589, 4145, 11467, 11468, 4281, 11469, 1297, 9902, 2]
// Exports: default
...
export default function CommandOptionView(option) {
  ...
  if (set.has(option.type)) {
    ...
    obj5[12] = hasItem;
    items2[1] = closure_5(importDefault(11469), obj5);
    ...
    obj1[1] = closure_5(importDefault(4145).View, obj2);
