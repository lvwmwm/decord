...
// Function ID: 11548
// Name: set
// Dependencies: [19, 17, 4295, 21, 1935, 4303, 712, 589, 4036, 11548, 11549, 4299, 11550, 1297, 9984, 2]
// Exports: default
...
export default function CommandOptionView(option) {
  ...
  if (set.has(option.type)) {
    ...
    obj5[12] = hasItem;
    items2[1] = closure_5(importDefault(11550), obj5);
    ...
    obj1[1] = closure_5(importDefault(4036).View, obj2);
