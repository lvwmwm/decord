...
// Function ID: 11482
// Name: set
// Dependencies: [19, 17, 4294, 21, 1935, 4302, 712, 589, 4162, 11482, 11483, 4298, 11484, 1297, 9918, 2]
// Exports: default
...
export default function CommandOptionView(option) {
  ...
  if (set.has(option.type)) {
    ...
    obj5[12] = hasItem;
    items2[1] = closure_5(importDefault(11484), obj5);
    ...
    obj1[1] = closure_5(importDefault(4162).View, obj2);
