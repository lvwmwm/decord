...
// Function ID: 11433
// Name: initialize
// Dependencies: [1903, 11, 11430, 6982, 589, 709, 2]

// Module 11432 (initialize)
...
const appLauncherOnboardingStore = new AppLauncherOnboardingStore(require("dispatcher"), {
  APPLICATION_COMMAND_USED: function handleApplicationCommandUsed(context) {
    ...
    let tmp = commandOrigin !== require(6982) /* ApplicationCommandSectionType */.CommandOrigin.APPLICATION_LAUNCHER;
    if (tmp) {
      ...
      if (null != currentUser.id) {
        if (null != message.author) {
          if (currentUser.id === message.author.id) {
            ...
            if (timestamp <= extractTimestampResult + require(11430) /* result */.RECENT_MESSAGE_MS) {
