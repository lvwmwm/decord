...
// Function ID: 11436
// Name: initialize
// Dependencies: [1922, 11, 11433, 6985, 589, 709, 2]

// Module 11435 (initialize)
...
const appLauncherOnboardingStore = new AppLauncherOnboardingStore(require("dispatcher"), {
  APPLICATION_COMMAND_USED: function handleApplicationCommandUsed(context) {
    ...
    let tmp = commandOrigin !== require(6985) /* ApplicationCommandSectionType */.CommandOrigin.APPLICATION_LAUNCHER;
    if (tmp) {
      ...
      if (null != currentUser.id) {
        if (null != message.author) {
          if (currentUser.id === message.author.id) {
            ...
            if (timestamp <= extractTimestampResult + require(11433) /* result */.RECENT_MESSAGE_MS) {
