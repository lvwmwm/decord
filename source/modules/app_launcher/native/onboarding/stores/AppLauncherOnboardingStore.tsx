...
// Function ID: 11317
// Name: initialize
// Dependencies: [1874, 11, 11314, 6876, 589, 709, 2]

// Module 11316 (initialize)
...
const appLauncherOnboardingStore = new AppLauncherOnboardingStore(require("dispatcher"), {
  APPLICATION_COMMAND_USED: function handleApplicationCommandUsed(context) {
    ...
    let tmp = commandOrigin !== require(6876) /* ApplicationCommandSectionType */.CommandOrigin.APPLICATION_LAUNCHER;
    if (tmp) {
      ...
      if (null != currentUser.id) {
        if (null != message.author) {
          if (currentUser.id === message.author.id) {
            ...
            if (timestamp <= extractTimestampResult + require(11314) /* result */.RECENT_MESSAGE_MS) {
