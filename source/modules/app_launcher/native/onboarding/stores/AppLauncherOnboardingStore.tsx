...
// Function ID: 11366
// Name: initialize
// Dependencies: [1903, 11, 11363, 6922, 589, 709, 2]

// Module 11365 (initialize)
...
const appLauncherOnboardingStore = new AppLauncherOnboardingStore(require("dispatcher"), {
  APPLICATION_COMMAND_USED: function handleApplicationCommandUsed(context) {
    ...
    let tmp = commandOrigin !== require(6922) /* ApplicationCommandSectionType */.CommandOrigin.APPLICATION_LAUNCHER;
    if (tmp) {
      ...
      if (null != currentUser.id) {
        if (null != message.author) {
          if (currentUser.id === message.author.id) {
            ...
            if (timestamp <= extractTimestampResult + require(11363) /* result */.RECENT_MESSAGE_MS) {
