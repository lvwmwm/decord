...
// Module 11338 (EnteringAnimation)
...
let closure_9 = __exportStarResult1.createStyles(() => {
  ...
  let obj = {};
  obj = { "Null": "environ 1 heure", "Null": "environ {{count}} heures", "Null": "1 heure", "Null": "{{count}} heures", "Null": "1 jour", "Null": "{{count}} jours", borderColor: importDefault(dependencyMap[6]).colors.BACKGROUND_BRAND, borderRadius: importDefault(dependencyMap[6]).radii.round, width: sum, height: sum, marginLeft: 4 };
  obj.fakeButton = obj;
