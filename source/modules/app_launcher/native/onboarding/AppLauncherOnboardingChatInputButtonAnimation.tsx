...
// Dependencies: [19, 17, 4277, 21, 4285, 4699, 712, 4286, 4289, 589, 8202, 11336, 4146, 5601, 11526, 11361, 2]
// Exports: AppLauncherOnboardingChatInputButtonAnimation

// Module 11525 (EnteringAnimation)
import "noop";
...
export const AppLauncherOnboardingChatInputButtonAnimation = function AppLauncherOnboardingChatInputButtonAnimation(channelId) {
  ...
  let obj1 = require(8202) /* useGradientBottom */;
  const gradientBottom = obj1.useGradientBottom();
  importDefault(11336)({ channelId: channelId.channelId });
  obj = { children: null };
  ...
  obj1[2] = require(11526);
  obj1[3] = !stateFromStores;
  const items2 = [callback(importDefault(5601), obj1), , ];
  ...
  obj[4] = items2;
  const items4 = [callback2(importDefault(4146).View, obj), ];
  ...
  const tmp5 = importDefault(5601);
  obj3[2] = require(11361);
  obj3[3] = !stateFromStores;
  items4[1] = callback(importDefault(5601), obj3);
  obj[0] = items4;
