...
// Dependencies: [19, 17, 4294, 21, 4302, 4716, 712, 4303, 4306, 589, 8331, 11357, 4162, 5659, 11547, 11382, 2]
// Exports: AppLauncherOnboardingChatInputButtonAnimation

// Module 11546 (EnteringAnimation)
import "noop";
...
let closure_9 = createCacheKey.createStyles(() => {
  const sum = require(4716) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_HEIGHT + require(4716) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_PADDING + 2;
...
export const AppLauncherOnboardingChatInputButtonAnimation = function AppLauncherOnboardingChatInputButtonAnimation(channelId) {
  ...
  let obj1 = require(8331) /* useGradientBottom */;
  const gradientBottom = obj1.useGradientBottom();
  importDefault(11357)({ channelId: channelId.channelId });
  obj = { children: null };
  ...
  obj1[2] = require(11547);
  obj1[3] = !stateFromStores;
  const items2 = [callback(importDefault(5659), obj1), , ];
  ...
  obj[4] = items2;
  const items4 = [callback2(importDefault(4162).View, obj), ];
  ...
  const tmp5 = importDefault(5659);
  obj3[2] = require(11382);
  obj3[3] = !stateFromStores;
  items4[1] = callback(importDefault(5659), obj3);
  obj[0] = items4;
