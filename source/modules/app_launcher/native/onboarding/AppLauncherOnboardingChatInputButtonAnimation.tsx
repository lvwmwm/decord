...
// Dependencies: [19, 17, 4247, 21, 4255, 4670, 712, 4256, 4259, 589, 9010, 11336, 4116, 5572, 11527, 11361, 2]
// Exports: AppLauncherOnboardingChatInputButtonAnimation

// Module 11526 (EnteringAnimation)
import "noop";
...
let closure_9 = createCacheKey.createStyles(() => {
  const sum = require(4670) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_HEIGHT + require(4670) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_PADDING + 2;
...
export const AppLauncherOnboardingChatInputButtonAnimation = function AppLauncherOnboardingChatInputButtonAnimation(channelId) {
  ...
  let obj1 = require(9010) /* useGradientBottom */;
  ...
  obj1[2] = require(11527);
  obj1[3] = !stateFromStores;
  const items2 = [callback(importDefault(5572), obj1), , ];
  ...
  items4[1] = callback(importDefault(5572), obj3);
  obj[0] = items4;
