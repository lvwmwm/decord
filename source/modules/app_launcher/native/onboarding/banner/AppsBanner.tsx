...
// Function ID: 86862
// Name: AppsBaner
// Dependencies: [31, 27, 33, 4131, 11176, 11173, 1212, 2]
// Exports: default

// Module 11175 (AppsBaner)
import "result";
...
export default function AppsBaner() {
  const tmp = callback();
  obj = { style: tmp.rocketIconContainer, children: jsx(importDefault(11176), obj) };
  ...
  return jsx(importDefault(11173), { image: <View style={tmp.rocketIcon} /> });
};
