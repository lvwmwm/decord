...
// Function ID: 11454
// Name: AppsBaner
// Dependencies: [19, 17, 21, 4303, 11454, 11451, 1236, 2]
// Exports: default

// Module 11453 (AppsBaner)
import "noop";
...
export default function AppsBaner() {
  const tmp = callback();
  obj = { style: tmp.rocketIconContainer, children: jsx(importDefault(11454), obj) };
  ...
  return jsx(importDefault(11451), { image: <View style={tmp.rocketIcon} />, text: null });
};
