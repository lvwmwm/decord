...
// Dependencies: [19, 17, 21, 4189, 712, 11225, 5141, 2]
// Exports: default

// Module 11224 (ApplicationsImage)
import "noop";
...
export default function ApplicationsImage(arg0) {
  ...
  if (null != secondApplication) {
    let obj1 = require(11225) /* handleApplicationSelected */;
  ...
  if (tmp8) {
    ...
    tmp8 = callback(importDefault(5141), obj);
  }
  ...
  if (tmp12) {
    ...
    tmp12 = callback(importDefault(5141), obj);
  }
  obj1 = { children: null };
  const items = [, ];
