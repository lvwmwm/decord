...
// Dependencies: [19, 17, 21, 4342, 712, 11495, 5308, 2]
// Exports: default

// Module 11494 (ApplicationsImage)
import "noop";
...
export default function ApplicationsImage(arg0) {
  ...
  if (null != secondApplication) {
    let obj1 = require(11495) /* handleApplicationSelected */;
  ...
  if (tmp8) {
    ...
    tmp8 = callback(importDefault(5308), obj);
  }
  ...
  if (tmp12) {
    ...
    tmp12 = callback(importDefault(5308), obj);
  }
  obj1 = { children: null };
  const items = [, ];
