...
// Function ID: 11236
// Name: BannerBase
// Dependencies: [32, 19, 17, 4181, 21, 712, 4189, 11224, 4050, 1474, 4033, 589, 4599, 4611, 5506, 11236, 4185, 2]
// Exports: default

// Module 11235 (BannerBase)
...
export default function BannerBase(arg0) {
  ...
  obj = { bannerMeasured: sharedValue, withDelay: _require(4050).withDelay, withSpring: _require(4599).withSpring, SPRING_CONFIG: closure_9 };
  fn.__closure = obj;
  ...
  const items4 = [callback2(sharedValue(4611), { start: { x: 0, y: 0 }, end: { x: 0, y: 1 }, colors: items, style: items3 }), , ];
  obj1 = { style: tmp.imageContainer, children: null };
  obj2 = { style: tmp.trinketsLottie, source: null, autoPlay: null };
  const tmp2 = callback(React.useState(0), 2);
  obj2[1] = _require(11236);
  obj2[2] = !stateFromStores;
  const items5 = [callback2(sharedValue(5506), obj2), image];
  obj1[1] = items5;
  items4[1] = closure_8(View, obj1);
  obj3 = { style: tmp.bannerTextContainer, children: callback2(tmp4(4185).Text, obj4) };
  obj4 = { variant: "text-md/semibold", color: "text-overlay-light", style: tmp.bannerText, children: text };
  items4[2] = callback2(View, obj3);
  obj[2] = items4;
  return closure_8(sharedValue(4050).View, obj);
};
