...
// Function ID: 11289
// Name: BannerBase
// Dependencies: [32, 19, 17, 4669, 21, 712, 4668, 11274, 4119, 1494, 4227, 589, 4749, 4761, 7168, 11289, 4739, 2]
// Exports: default

// Module 11288 (BannerBase)
...
export default function BannerBase(arg0) {
  ...
  obj = { bannerMeasured: sharedValue, withDelay: _require(4119).withDelay, withSpring: _require(4749).withSpring, SPRING_CONFIG: closure_9 };
  fn.__closure = obj;
