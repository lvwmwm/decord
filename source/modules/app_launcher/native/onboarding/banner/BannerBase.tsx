...
// Function ID: 11645
// Name: BannerBase
// Dependencies: [32, 19, 17, 4372, 21, 712, 4380, 11633, 4120, 1494, 4228, 589, 4814, 4826, 5825, 11645, 4376, 2]
// Exports: default

// Module 11644 (BannerBase)
...
export default function BannerBase(arg0) {
  ...
  obj = { bannerMeasured: sharedValue, withDelay: _require(4120).withDelay, withSpring: _require(4814).withSpring, SPRING_CONFIG: closure_9 };
  fn.__closure = obj;
  ...
  const items4 = [callback2(sharedValue(4826), { start: { x: 0, y: 0 }, end: { x: 0, y: 1 }, colors: items, style: items3 }), , ];
  obj1 = { style: tmp.imageContainer, children: null };
  obj2 = { style: tmp.trinketsLottie, source: null, autoPlay: null };
  const tmp2 = callback(React.useState(0), 2);
  obj2[1] = _require(11645);
  obj2[2] = !stateFromStores;
  const items5 = [callback2(sharedValue(5825), obj2), image];
  obj1[1] = items5;
  items4[1] = closure_8(View, obj1);
  obj3 = { style: tmp.bannerTextContainer, children: callback2(tmp4(4376).Text, obj4) };
  obj4 = { variant: "text-md/semibold", color: "text-overlay-light", style: tmp.bannerText, children: text };
  items4[2] = callback2(View, obj3);
  obj[2] = items4;
  return closure_8(sharedValue(4120).View, obj);
};
