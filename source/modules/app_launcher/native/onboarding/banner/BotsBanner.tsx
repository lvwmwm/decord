...
// Function ID: 11526
// Name: BotsBanner
// Dependencies: [19, 21, 11526, 11510, 11521, 1236, 2]
// Exports: default

// Module 11525 (BotsBanner)
import "noop";
...
export default function BotsBanner(context) {
  ...
  let obj = require(11526) /* useBannerBots */;
  ...
  if (null != firstBotApplication) {
    ...
    if (null != secondBotApplication) {
      ...
      tmp4Result = jsx(importDefault(11521), { firstApplicationName: null, secondApplicationName: null });
      const tmp5Result = importDefault(11521);
    }
  }
  return tmp4Result;
};
