...
// Dependencies: [32, 19, 21, 11485, 11497, 11508, 1236, 2]
// Exports: default

// Module 11496 (ActivitiesBanner)
...
export default function ActivitiesBanner(context) {
  let tmp4;
  let tmp5;
  let obj = require(11485) /* useActivityApplications */;
  ...
  if (null != tmp4) {
    ...
    if (null != tmp5) {
      ...
      tmp6Result = jsx(importDefault(11508), { image: null, text: null });
      const tmp7Result = importDefault(11508);
    }
  }
  return tmp6Result;
};
