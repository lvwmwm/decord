...
// Dependencies: [32, 19, 21, 11482, 11494, 11505, 1236, 2]
// Exports: default

// Module 11493 (ActivitiesBanner)
...
export default function ActivitiesBanner(context) {
  let tmp4;
  let tmp5;
  let obj = require(11482) /* useActivityApplications */;
  ...
  if (null != tmp4) {
    ...
    if (null != tmp5) {
      ...
      tmp6Result = jsx(importDefault(11505), { image: null, text: null });
      const tmp7Result = importDefault(11505);
    }
  }
  return tmp6Result;
};
