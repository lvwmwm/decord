...
// Dependencies: [32, 8079, 1391, 1388, 4266, 1377, 589, 11527, 11532, 6203, 2]
// Exports: default

// Module 11526 (useAppLauncherOnboardingContent)
import resultDefault from "result" /* 11532 */;
...
export default function useAppLauncherOnboardingContent(channelId) {
  ...
  if (tmp3.canShowAppsOrActivitiesBanner) {
    ...
    if ((function useHasUsedActivities(channel) {
      ...
      const result1 = channelId(4266).useIsDismissibleContentDismissed_UNSAFE(channelId(1377).DismissibleContent.APP_LAUNCHER_ONBOARDING_APPS_BANNER);
      const obj2 = channelId(4266);
      const tmp = channelId;
      ...
      obj[1] = !result;
      const activityApplications = tmp(11527).useActivityApplications(obj);
      let flag = false;
  ...
  let tmp7 = callback(channelId(6203).useSelectedDismissibleContent(items, constants.APP_LAUNCHER_ONBOARDING), 2);
