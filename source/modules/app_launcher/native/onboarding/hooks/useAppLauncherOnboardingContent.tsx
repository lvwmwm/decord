...
// Dependencies: [32, 8093, 1391, 1388, 4267, 1377, 589, 11546, 11551, 6216, 2]
// Exports: default

// Module 11545 (useAppLauncherOnboardingContent)
import resultDefault from "result" /* 11551 */;
...
export default function useAppLauncherOnboardingContent(channelId) {
  ...
  if (tmp3.canShowAppsOrActivitiesBanner) {
    ...
    if ((function useHasUsedActivities(channel) {
      ...
      const result1 = channelId(4267).useIsDismissibleContentDismissed_UNSAFE(channelId(1377).DismissibleContent.APP_LAUNCHER_ONBOARDING_APPS_BANNER);
      const obj2 = channelId(4267);
      const tmp = channelId;
      ...
      obj[1] = !result;
      const activityApplications = tmp(11546).useActivityApplications(obj);
      let flag = false;
  ...
  let tmp7 = callback(channelId(6216).useSelectedDismissibleContent(items, constants.APP_LAUNCHER_ONBOARDING), 2);
