...
// Dependencies: [32, 8562, 1391, 1388, 4265, 1377, 589, 11694, 11699, 6197, 2]
// Exports: default

// Module 11693 (useAppLauncherOnboardingContent)
import resultDefault from "result" /* 11699 */;
...
export default function useAppLauncherOnboardingContent(channelId) {
  ...
  if (tmp3.canShowAppsOrActivitiesBanner) {
    ...
    if ((function useHasUsedActivities(channel) {
      ...
      const result1 = channelId(4265).useIsDismissibleContentDismissed_UNSAFE(channelId(1377).DismissibleContent.APP_LAUNCHER_ONBOARDING_APPS_BANNER);
      const obj2 = channelId(4265);
      const tmp = channelId;
      ...
      obj[1] = !result;
      const activityApplications = tmp(11694).useActivityApplications(obj);
      let flag = false;
  ...
  let tmp7 = callback(channelId(6197).useSelectedDismissibleContent(items, constants.APP_LAUNCHER_ONBOARDING), 2);
