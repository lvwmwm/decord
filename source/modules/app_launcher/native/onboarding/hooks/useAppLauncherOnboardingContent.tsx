...
// Dependencies: [32, 8147, 1387, 1384, 4298, 1373, 589, 11610, 11615, 6251, 2]
// Exports: default

// Module 11609 (useAppLauncherOnboardingContent)
import resultDefault from "result" /* 11615 */;
...
export default function useAppLauncherOnboardingContent(channelId) {
  ...
  if (tmp3.canShowAppsOrActivitiesBanner) {
    ...
    if ((function useHasUsedActivities(channel) {
      ...
      const result1 = channelId(4298).useIsDismissibleContentDismissed_UNSAFE(channelId(1373).DismissibleContent.APP_LAUNCHER_ONBOARDING_APPS_BANNER);
      ...
      obj[1] = !result;
      const activityApplications = tmp(11610).useActivityApplications(obj);
      let flag = false;
  ...
  let tmp7 = callback(channelId(6251).useSelectedDismissibleContent(items, constants.APP_LAUNCHER_ONBOARDING), 2);
