...
// Dependencies: [19, 17, 21, 4055, 1579, 10207, 6610, 2]
// Exports: AppLauncherButtonIcon

// Module 11400 (AppLauncherButtonIcon)
import "noop";
...
export const AppLauncherButtonIcon = function AppLauncherButtonIcon(style) {
  ...
  if (tmp3 === require(1579) /* KeyboardTypes */.KeyboardTypes.APP_LAUNCHER) {
    ...
    items[1] = obj;
    obj.style = items;
    let tmp4Result = tmp4(tmp6(10207).PlusLargeIcon, obj);
  } else {
    const obj1 = { style: null };
    obj1[0] = style;
    const merged2 = Object.assign(merged);
    tmp4Result = tmp4(tmp6(6610).AppsIcon, obj1);
  }
  obj[1] = tmp4Result;
