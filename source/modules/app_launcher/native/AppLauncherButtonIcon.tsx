...
// Dependencies: [19, 17, 21, 4167, 1607, 9641, 7630, 2]
// Exports: AppLauncherButtonIcon

// Module 11548 (AppLauncherButtonIcon)
import "noop";
...
export const AppLauncherButtonIcon = function AppLauncherButtonIcon(style) {
  ...
  if (tmp3 === require(1607) /* KeyboardTypes */.KeyboardTypes.APP_LAUNCHER) {
    ...
    items[1] = obj;
    obj.style = items;
    let tmp4Result = tmp4(tmp6(9641).PlusLargeIcon, obj);
  } else {
    const obj1 = { style: null };
    obj1[0] = style;
    const merged2 = Object.assign(merged);
    tmp4Result = tmp4(tmp6(7630).AppsIcon, obj1);
  }
  obj[1] = tmp4Result;
