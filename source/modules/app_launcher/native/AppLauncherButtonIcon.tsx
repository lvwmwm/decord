...
// Dependencies: [19, 17, 21, 4121, 1579, 10363, 7599, 2]
// Exports: AppLauncherButtonIcon

// Module 11528 (AppLauncherButtonIcon)
import "noop";
...
export const AppLauncherButtonIcon = function AppLauncherButtonIcon(style) {
  ...
  if (tmp3 === require(1579) /* KeyboardTypes */.KeyboardTypes.APP_LAUNCHER) {
    ...
    items[1] = obj;
    obj.style = items;
    let tmp4Result = tmp4(tmp6(10363).PlusLargeIcon, obj);
  } else {
    const obj1 = { style: null };
    obj1[0] = style;
    const merged2 = Object.assign(merged);
    tmp4Result = tmp4(tmp6(7599).AppsIcon, obj1);
  }
  obj[1] = tmp4Result;
