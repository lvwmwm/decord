...
// Function ID: 11350
// Name: Item
// Dependencies: [32, 19, 17, 7526, 1910, 676, 5246, 21, 12, 10255, 4661, 712, 647, 4342, 11344, 11345, 1236, 38, 6291, 4486, 4734, 1297, 11346, 2]
// Exports: default
...
function Item(arg0) {
  ...
  const match = require(4486) /* t */.match(item);
