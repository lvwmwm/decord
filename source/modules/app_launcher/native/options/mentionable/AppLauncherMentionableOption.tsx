...
// Dependencies: [32, 19, 4334, 1983, 1922, 505, 21, 4342, 712, 589, 11640, 9730, 11641, 1297, 11642, 11643, 11637, 4310, 11641, 2007, 2]
// Exports: default

// Module 11639 (MentionableIcon)
...
function MentionableIcon(mentionable) {
  ...
  obj[0] = jsx(require(9730) /* UserCircleIcon */.UserCircleIcon, { size: "sm", color: "interactive-text-default" });
  obj[1] = tmp.iconWrapper;
  const tmp7 = jsx(importDefault(11640), { icon: null, wrapperStyle: null });
  if (null == mentionable) {
    return tmp7;
  } else {
  ...
  const tmp6 = importDefault(11640);
}
