...
// Dependencies: [32, 19, 4185, 21, 4193, 712, 589, 11367, 1844, 4161, 11376, 1959, 11376, 1297, 11370, 9109, 11373, 4189, 2]
// Exports: default
...
export default function AppLauncherUserOption(option) {
  ...
  if (null != tmp8) {
    ...
    obj1[0] = tmp9(tmp2(9109).UserCircleIcon, { size: "sm", color: "interactive-text-default" });
    obj1[1] = tmp.iconWrapper;
    tmp9Result = tmp9(tmp10(11370), obj1);
    const tmp10Result = tmp10(11370);
  }
  obj[5] = tmp9Result;
  if (null != tmp8) {
    ...
    obj2[0] = guild_id;
    obj2[1] = tmp8;
    tmp9Result = tmp9(tmp10(11373), obj2);
  } else {
    tmp9Result = null;
    if (null != tmp6) {
      const obj3 = { variant: "text-md/medium", color: "text-default", children: null };
      obj3[2] = tmp6;
      tmp9Result = tmp9(tmp2(4189).Text, obj3);
    }
  }
  obj[6] = tmp9Result;
  obj[7] = autoFocus;
  return c6(importDefault(11367), obj);
};
