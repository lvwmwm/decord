...
function AttachmentPreviewAppLauncher(arg0) {
  ...
  obj[6] = jsx(require(9861) /* FileIcon */.FileIcon, { size: "sm" });
  return jsx(importDefault(9923), { uri, isImage, isVideo, width, height, style: tmp.selectedImage, defaultPreview: null });
}
