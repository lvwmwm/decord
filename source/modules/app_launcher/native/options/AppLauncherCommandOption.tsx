...
// Dependencies: [19, 17, 1479, 21, 4189, 712, 1906, 11337, 11343, 11345, 11348, 11350, 11351, 11353, 5101, 11356, 11357, 11360, 4717, 6733, 2]
// Exports: default

// Module 11336 (AppLauncherCommandOption)
import "CircleXIcon";
...
export default function AppLauncherCommandOption(option) {
    ...
    if (tmp2(1906).ApplicationCommandOptionType.INTEGER !== type) {
      if (tmp2(1906).ApplicationCommandOptionType.NUMBER !== type) {
        if (tmp2(1906).ApplicationCommandOptionType.ATTACHMENT === type) {
          ...
          let tmp28Result = onDismiss(importDefault(11348), obj, name.name);
          let tmp13 = onDismiss;
          ...
          obj[4] = hasError;
          tmp28Result = tmp35(importDefault(11350), obj, name.name);
          tmp13 = tmp35;
          const tmp37 = importDefault(11350);
          ...
          obj1[6] = hasError;
          obj1[7] = onPress;
          tmp28Result = tmp28(importDefault(11351), obj1);
          tmp13 = tmp28;
          const tmp30 = importDefault(11351);
          ...
          obj2[7] = hasError;
          obj2[8] = onPress;
          tmp28Result = tmp21(importDefault(11356), obj2, name.name);
          tmp13 = tmp21;
          const tmp23 = importDefault(11356);
          ...
          obj3[7] = hasError;
          obj3[8] = onPress;
          tmp28Result = tmp14(importDefault(11357), obj3, name.name);
          tmp13 = tmp14;
          const tmp16 = importDefault(11357);
          ...
          obj[7] = hasError;
          obj[8] = onPress;
          tmp28Result = tmp5(importDefault(11360), obj, name.name);
          tmp13 = tmp5;
          const tmp7 = importDefault(11360);
        } else {
          return null;
        }
        ...
        if (null != onDismiss) {
          ...
          obj6[2] = tmp13(tmp2(6733).CircleXIcon, { size: "md" });
  ...
  if (null != name.choices) {
    ...
    obj7[7] = hasError;
    name = name.name;
    onDismiss(importDefault(11337), obj7, name);
    const tmp57 = importDefault(11337);
