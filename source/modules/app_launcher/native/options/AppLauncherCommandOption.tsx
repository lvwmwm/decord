...
// Dependencies: [19, 17, 1479, 21, 4302, 712, 1935, 11485, 11491, 11493, 11496, 11498, 11499, 11501, 5227, 11504, 11505, 11508, 4844, 5936, 2]
// Exports: default

// Module 11484 (AppLauncherCommandOption)
import "CircleXIcon";
...
export default function AppLauncherCommandOption(option) {
    ...
    if (tmp2(1935).ApplicationCommandOptionType.INTEGER !== type) {
      if (tmp2(1935).ApplicationCommandOptionType.NUMBER !== type) {
        if (tmp2(1935).ApplicationCommandOptionType.ATTACHMENT === type) {
          ...
          let tmp28Result = onDismiss(importDefault(11496), obj, name.name);
          let tmp13 = onDismiss;
          ...
          obj[4] = hasError;
          tmp28Result = tmp35(importDefault(11498), obj, name.name);
          tmp13 = tmp35;
          const tmp37 = importDefault(11498);
          ...
          obj1[6] = hasError;
          obj1[7] = onPress;
          tmp28Result = tmp28(importDefault(11499), obj1);
          tmp13 = tmp28;
          const tmp30 = importDefault(11499);
          ...
          obj2[7] = hasError;
          obj2[8] = onPress;
          tmp28Result = tmp21(importDefault(11504), obj2, name.name);
          tmp13 = tmp21;
          const tmp23 = importDefault(11504);
          ...
          obj3[7] = hasError;
          obj3[8] = onPress;
          tmp28Result = tmp14(importDefault(11505), obj3, name.name);
          tmp13 = tmp14;
          const tmp16 = importDefault(11505);
          ...
          obj[7] = hasError;
          obj[8] = onPress;
          tmp28Result = tmp5(importDefault(11508), obj, name.name);
          tmp13 = tmp5;
          const tmp7 = importDefault(11508);
        } else {
          return null;
        }
  ...
  if (null != name.choices) {
    ...
    obj7[7] = hasError;
    name = name.name;
    onDismiss(importDefault(11485), obj7, name);
    const tmp57 = importDefault(11485);
