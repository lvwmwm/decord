...
// Dependencies: [19, 21, 4255, 712, 11470, 7765, 4251, 1297, 5295, 2]
// Exports: default

// Module 11477 (AppLauncherSelectOptionFormRow)
import "noop";
...
export default function AppLauncherSelectOptionFormRow(arg0) {
  ...
  obj[3] = jsx(require(4251) /* Text */.Text, { variant: str, color: null, lineClamp: 1, children: null });
  if (selected) {
  ...
  obj1[0] = unselectedSubLabel(5295);
  obj1[1] = require(1297) /* Button */.IconSizes.SMALL_20;
  obj[5] = jsx(require(1297) /* Button */.Icon, { source: null, size: null });
  const merged1 = Object.assign(merged);
  return jsx(require(7765) /* Form */.FormRow, { variant: str, color: null, lineClamp: 1, children: null });
};
