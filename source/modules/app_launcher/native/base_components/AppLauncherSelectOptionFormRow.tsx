...
// Dependencies: [19, 21, 4661, 712, 11347, 8083, 4734, 1297, 6299, 2]
// Exports: default

// Module 11354 (AppLauncherSelectOptionFormRow)
import "noop";
...
export default function AppLauncherSelectOptionFormRow(arg0) {
  ...
  let obj = require(11347) /* useAnimationDelayedAutoFocus */;
  ...
  obj[3] = jsx(require(4734) /* Text */.Text, { variant: str, color: null, lineClamp: 1, children: null });
  if (selected) {
  ...
  obj1[0] = unselectedSubLabel(6299);
  obj1[1] = require(1297) /* Button */.IconSizes.SMALL_20;
  obj[5] = jsx(require(1297) /* Button */.Icon, { source: null, size: null });
  const merged1 = Object.assign(merged);
  return jsx(require(8083) /* Form */.FormRow, { variant: str, color: null, lineClamp: 1, children: null });
};
