...
// Dependencies: [19, 17, 21, 4342, 1628, 11562, 1297, 11629, 1236, 6056, 2]
// Exports: AppLauncherListEmptyState, AppLauncherListSearchBar

// Module 11628 (AppLauncherList)
...
const forwardRefResult = require("noop").forwardRef((contentContainerStyle) => {
  ...
  let obj = require(11562) /* useAppLauncherFlashListProps */;
  ...
  return jsx(importDefault(11562), { contentContainerStyle: items, scrollIndicatorInsets: { bottom }, ref: null });
});
...
export const AppLauncherListSearchBar = function AppLauncherListSearchBar(arg0) {
  ...
  obj[1] = jsx(require(6056) /* SearchField */.SearchField, { size: "md" });
  return <View size="md" />;
};
