...
// Dependencies: [19, 17, 21, 4344, 1628, 11549, 1297, 11616, 1236, 6033, 2]
// Exports: AppLauncherListEmptyState, AppLauncherListSearchBar

// Module 11615 (AppLauncherList)
...
const forwardRefResult = require("noop").forwardRef((contentContainerStyle) => {
  ...
  let obj = require(11549) /* useAppLauncherFlashListProps */;
  ...
  return jsx(importDefault(11549), { contentContainerStyle: items, scrollIndicatorInsets: { bottom }, ref: null });
});
...
export const AppLauncherListSearchBar = function AppLauncherListSearchBar(arg0) {
  ...
  obj[1] = jsx(require(6033) /* SearchField */.SearchField, { size: "md" });
  return <View size="md" />;
};
