...
// Dependencies: [19, 17, 21, 4193, 1581, 11289, 1297, 11359, 1236, 9248, 2]
...
const forwardRefResult = require("noop").forwardRef((contentContainerStyle) => {
  ...
  let obj = require(11289) /* useAppLauncherFlashListProps */;
  ...
  return jsx(importDefault(11289), { contentContainerStyle: items, scrollIndicatorInsets: { bottom }, ref: null });
});
...
export const AppLauncherListSearchBar = function AppLauncherListSearchBar(arg0) {
  ...
  obj[1] = jsx(require(9248) /* SearchField */.SearchField, { size: "md" });
  return <View size="md" />;
};
