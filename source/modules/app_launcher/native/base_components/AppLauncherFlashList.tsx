...
// Dependencies: [19, 17, 21, 5533, 11687, 9698, 9699, 7890, 2]
// Exports: useAppLauncherFlashListProps

// Module 11686 (useAppLauncherFlashListProps)
import context from "context" /* 11687 */;
...
let forwardRefResult = importAllResult.forwardRef((simultaneousHandlers) => {
  let obj = simultaneousHandlers(9698);
  ...
  if (obj.useAppLauncherContext().entrypoint === simultaneousHandlers(9699).AppLauncherEntrypoint.VOICE) {
    ...
    obj[16] = arg1;
    let tmp5 = jsx(tmp(7890).AnimatedFlashList, { renderScrollComponent: null, ListHeaderComponent: null, onScroll: null, contentContainerStyle: null, scrollIndicatorInsets: null, renderItem: null, getItemType: null, data: null, automaticallyAdjustsScrollIndicatorInsets: null, keyboardDismissMode: null, keyboardShouldPersistTaps: null, showsVerticalScrollIndicator: null, onViewableItemsChanged: null, viewabilityConfigCallbackPairs: null, animatedProps: null, overScrollMode: "never", ref: null });
  } else {
    ...
    obj[16] = arg1;
    tmp5 = jsx(tmp(7890).BottomSheetFlashList, { ListHeaderComponent: null, onScroll: null, contentContainerStyle: null, scrollIndicatorInsets: null, renderItem: null, getItemType: null, data: null, preserveScrollMomentum: null, automaticallyAdjustsScrollIndicatorInsets: null, keyboardDismissMode: null, keyboardShouldPersistTaps: null, showsVerticalScrollIndicator: null, lockableScrollableContentOffsetY: null, bottomViewabilityInsetRef: null, onViewableItemsChanged: null, viewabilityConfigCallbackPairs: null, ref: null });
  }
  return tmp5;
});
