...
// Dependencies: [19, 17, 21, 5599, 11760, 9766, 9767, 7957, 2]
// Exports: useAppLauncherFlashListProps

// Module 11759 (useAppLauncherFlashListProps)
import context from "context" /* 11760 */;
...
let forwardRefResult = importAllResult.forwardRef((simultaneousHandlers) => {
  let obj = simultaneousHandlers(9766);
  ...
  if (obj.useAppLauncherContext().entrypoint === simultaneousHandlers(9767).AppLauncherEntrypoint.VOICE) {
    ...
    obj[16] = arg1;
    let tmp5 = jsx(tmp(7957).AnimatedFlashList, { renderScrollComponent: null, ListHeaderComponent: null, onScroll: null, contentContainerStyle: null, scrollIndicatorInsets: null, renderItem: null, getItemType: null, data: null, automaticallyAdjustsScrollIndicatorInsets: null, keyboardDismissMode: null, keyboardShouldPersistTaps: null, showsVerticalScrollIndicator: null, onViewableItemsChanged: null, viewabilityConfigCallbackPairs: null, animatedProps: null, overScrollMode: "never", ref: null });
  } else {
