...
// Dependencies: [19, 17, 21, 6655, 12103, 11215, 9409, 8874, 2]
// Exports: useAppLauncherFlashListProps

// Module 12102 (useAppLauncherFlashListProps)
import context from "context" /* 12103 */;
...
let forwardRefResult = importAllResult.forwardRef((simultaneousHandlers) => {
  ...
  if (obj.useAppLauncherContext().entrypoint === simultaneousHandlers(9409).AppLauncherEntrypoint.VOICE) {
    ...
    obj[16] = arg1;
    let tmp5 = jsx(tmp(8874).AnimatedFlashList, { renderScrollComponent: null, ListHeaderComponent: null, onScroll: null, contentContainerStyle: null, scrollIndicatorInsets: null, renderItem: null, getItemType: null, data: null, automaticallyAdjustsScrollIndicatorInsets: null, keyboardDismissMode: null, keyboardShouldPersistTaps: null, showsVerticalScrollIndicator: null, onViewableItemsChanged: null, viewabilityConfigCallbackPairs: null, animatedProps: null, overScrollMode: "never", ref: null });
  } else {
