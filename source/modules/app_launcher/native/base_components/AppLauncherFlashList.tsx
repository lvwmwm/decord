...
// Dependencies: [31, 27, 33, 5217, 11252, 10911, 8226, 7527, 2]
...
let forwardRefResult = importAllResult.forwardRef((simultaneousHandlers, ref) => {
  let obj = require(10911) /* useAppLauncherChatInputRefDummy */;
  if (obj.useAppLauncherContext().entrypoint === require(8226) /* AppLauncherEntrypoint */.AppLauncherEntrypoint.VOICE) {
    ...
    obj.ref = ref;
    let tmp5 = jsx(require(7527) /* defaultMVCPConfig */.AnimatedFlashList, { renderScrollComponent: tmp });
  } else {
    obj = {};
    ...
    obj.ref = ref;
    tmp5 = jsx(require(7527) /* defaultMVCPConfig */.BottomSheetFlashList, {});
  }
  return tmp5;
});
