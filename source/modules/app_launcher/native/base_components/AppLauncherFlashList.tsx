...
// Dependencies: [19, 17, 21, 5661, 11904, 9067, 8448, 8116, 2]
// Exports: useAppLauncherFlashListProps

// Module 11903 (useAppLauncherFlashListProps)
import context from "context" /* 11904 */;
...
let forwardRefResult = importAllResult.forwardRef((simultaneousHandlers) => {
  ...
  if (obj.useAppLauncherContext().entrypoint === simultaneousHandlers(8448).AppLauncherEntrypoint.VOICE) {
    ...
    obj[16] = arg1;
    let tmp5 = jsx(tmp(8116).AnimatedFlashList, { renderScrollComponent: null, ListHeaderComponent: null, onScroll: null, contentContainerStyle: null, scrollIndicatorInsets: null, renderItem: null, getItemType: null, data: null, automaticallyAdjustsScrollIndicatorInsets: null, keyboardDismissMode: null, keyboardShouldPersistTaps: null, showsVerticalScrollIndicator: null, onViewableItemsChanged: null, viewabilityConfigCallbackPairs: null, animatedProps: null, overScrollMode: "never", ref: null });
  } else {
    ...
    obj[16] = arg1;
    tmp5 = jsx(tmp(8116).BottomSheetFlashList, { ListHeaderComponent: null, onScroll: null, contentContainerStyle: null, scrollIndicatorInsets: null, renderItem: null, getItemType: null, data: null, preserveScrollMomentum: null, automaticallyAdjustsScrollIndicatorInsets: null, keyboardDismissMode: null, keyboardShouldPersistTaps: null, showsVerticalScrollIndicator: null, lockableScrollableContentOffsetY: null, bottomViewabilityInsetRef: null, onViewableItemsChanged: null, viewabilityConfigCallbackPairs: null, ref: null });
  }
  return tmp5;
});
