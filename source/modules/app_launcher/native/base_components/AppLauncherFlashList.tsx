...
let forwardRefResult = importAllResult.forwardRef((simultaneousHandlers, ref) => {
  ...
  if (obj.useAppLauncherContext().entrypoint === require(7955) /* AppLauncherEntrypoint */.AppLauncherEntrypoint.VOICE) {
    ...
    obj.ref = ref;
    let tmp5 = jsx(require(6619) /* useModalDismissGuardRefreshControl */.AnimatedFlashList, { renderScrollComponent: tmp });
  } else {
    obj = {};
    ...
    obj.ref = ref;
    tmp5 = jsx(require(6619) /* useModalDismissGuardRefreshControl */.BottomSheetFlashList, {});
  }
  return tmp5;
});
