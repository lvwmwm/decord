...
// Function ID: 11366
// Name: ViewAllRow
// Dependencies: [19, 17, 21, 4255, 5300, 1236, 4251, 2]
// Exports: default

// Module 11365 (ViewAllRow)
import "noop";
...
export default function ViewAllRow(title) {
  ...
  obj[2] = title.onPress;
  return jsx(require(5300) /* TableRowInner */.TableRow, { style: callback().expandCTALabelContainer, children: null });
};
