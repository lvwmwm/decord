...
// Function ID: 11400
// Name: ViewAllRow
// Dependencies: [19, 17, 21, 4285, 5354, 1236, 4281, 2]
// Exports: default

// Module 11399 (ViewAllRow)
import "noop";
...
export default function ViewAllRow(title) {
  ...
  obj[2] = title.onPress;
  return jsx(require(5354) /* TableRowInner */.TableRow, { style: callback().expandCTALabelContainer, children: null });
};
