...
// Dependencies: [19, 1372, 1903, 1479, 676, 4735, 4496, 6922, 11372, 6920, 1935, 7177, 1883, 8278, 1416, 9483, 8671, 11377, 5674, 10534, 4271, 2]
...
// Module 11371 (handleApplicationSelected)
...
export const handleViewAllSelected = function handleViewAllSelected(arg0) {
  ...
  let obj = require(4496) /* collectGuildAnalyticsMetadata */;
  obj = { section_name: sectionName, num: sectionItemType === require(11372) /* Placeholder */.SectionItemType.APPS ? applications.length : commands.length };
...
export const getAppLauncherIconSource = function getAppLauncherIconSource(application) {
  if (null == application) {
    let applicationIconSource = importDefault(1883);
  } else {
    let obj = require(8278) /* getShelfBadgeTypeIfActive */;
...
export const useLogAppLauncherEmptyStateView = function useLogAppLauncherEmptyStateView(COMMAND_NOT_FOUND, query) {
  ...
  const entrypoint = _require(9483).useAppLauncherContext().entrypoint;
