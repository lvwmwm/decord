...
// Dependencies: [32, 19, 17, 1862, 9846, 676, 1338, 21, 4255, 712, 3928, 4589, 4936, 698, 4797, 1297, 1416, 5646, 9735, 4224, 4225, 8665, 8666, 8309, 1236, 9876, 2]
// Exports: default

// Module 9875 (CATEGORY_ICON_SIZE)
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(8665)();
  ...
  const items9 = [callback(categoryIndex(8309), obj), ];
  ...
  if (tmp22Result) {
    ...
    tmp22Result = tmp22(categories(4797).PressableOpacity, obj);
  }
  items9[1] = tmp22Result;
  obj[2] = items9;
  return tmp20(categoryIndex(8666), obj);
};
