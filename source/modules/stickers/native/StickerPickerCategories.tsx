...
// Dependencies: [32, 19, 17, 1909, 10343, 676, 1338, 21, 4448, 712, 4136, 4820, 5180, 698, 5036, 1297, 1431, 5972, 10222, 4416, 4417, 9167, 9168, 7746, 1236, 10373, 2]
// Exports: default

// Module 10372 (CATEGORY_ICON_SIZE)
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(9167)();
  ...
  const items9 = [callback(categoryIndex(7746), obj), ];
  ...
  if (tmp22Result) {
    ...
    tmp22Result = tmp22(categories(5036).PressableOpacity, obj);
  }
  items9[1] = tmp22Result;
  obj[2] = items9;
  return tmp20(categoryIndex(9168), obj);
};
