...
// Dependencies: [32, 19, 17, 1862, 9635, 676, 1338, 21, 4193, 712, 3866, 4528, 4860, 698, 4721, 1297, 1416, 5570, 9647, 4162, 4163, 9454, 9455, 9250, 1236, 9668, 2]
// Exports: default
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(9454)();
  ...
  const items9 = [callback(categoryIndex(9250), obj), ];
  ...
  if (tmp22Result) {
    ...
    tmp22Result = tmp22(categories(4721).PressableOpacity, obj);
  }
  items9[1] = tmp22Result;
  obj[2] = items9;
  return tmp20(categoryIndex(9455), obj);
};
