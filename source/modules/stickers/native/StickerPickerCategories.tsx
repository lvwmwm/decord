...
// Dependencies: [32, 19, 17, 1910, 10110, 676, 1338, 21, 4380, 712, 4070, 4740, 5093, 698, 4949, 1297, 1435, 5885, 10008, 4348, 4349, 8918, 8919, 8681, 1236, 10140, 2]
// Exports: default

// Module 10139 (CATEGORY_ICON_SIZE)
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(8918)();
  ...
  const items9 = [callback(categoryIndex(8681), obj), ];
  ...
  if (tmp22Result) {
    ...
    tmp22Result = tmp22(categories(4949).PressableOpacity, obj);
  }
  items9[1] = tmp22Result;
  obj[2] = items9;
  return tmp20(categoryIndex(8919), obj);
};
