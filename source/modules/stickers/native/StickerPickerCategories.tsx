...
// Dependencies: [57, 31, 27, 1838, 9601, 653, 1314, 33, 4165, 689, 3838, 4501, 4834, 675, 4695, 1273, 1392, 5548, 9613, 4134, 4135, 9419, 9420, 9217, 1212, 9634, 2]
// Exports: default

// Module 9633 (CATEGORY_ICON_SIZE)
...
export default function _default(categories) {
  ...
  const items9 = [callback(categoryIndex(9217), obj), ];
  ...
  if (tmp20) {
    ...
    obj1.style = items10;
    const obj2 = { style: tmp.guildIcon, source: categoryIndex(9634) };
    obj1.children = callback(categories(1273).Icon, obj2);
    obj.children = callback(closure_5, obj1);
    tmp20 = callback(categories(4695).PressableOpacity, obj);
  }
  items9[1] = tmp20;
  obj.children = items9;
