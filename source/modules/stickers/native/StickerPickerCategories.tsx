...
// Dependencies: [32, 19, 17, 1891, 9877, 676, 1338, 21, 4285, 712, 3957, 4619, 4966, 698, 4827, 1297, 1416, 5700, 9766, 4254, 4255, 8694, 8695, 8449, 1236, 9907, 2]
// Exports: default

// Module 9906 (CATEGORY_ICON_SIZE)
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(8694)();
  ...
  const items9 = [callback(categoryIndex(8449), obj), ];
  ...
  if (tmp22Result) {
    ...
    tmp22Result = tmp22(categories(4827).PressableOpacity, obj);
  }
  items9[1] = tmp22Result;
  obj[2] = items9;
  return tmp20(categoryIndex(8695), obj);
};
