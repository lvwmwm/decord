...
// Dependencies: [32, 19, 17, 1891, 9893, 676, 1338, 21, 4302, 712, 3974, 4636, 4983, 698, 4844, 1297, 1416, 5719, 9782, 4271, 4272, 8711, 8712, 8466, 1236, 9923, 2]
// Exports: default

// Module 9922 (CATEGORY_ICON_SIZE)
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(8711)();
  ...
  const items9 = [callback(categoryIndex(8466), obj), ];
  ...
  if (tmp22Result) {
    ...
    tmp22Result = tmp22(categories(4844).PressableOpacity, obj);
  }
  items9[1] = tmp22Result;
  obj[2] = items9;
  return tmp20(categoryIndex(8712), obj);
};
