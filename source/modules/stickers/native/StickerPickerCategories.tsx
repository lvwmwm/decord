...
// Dependencies: [32, 19, 17, 1910, 10177, 676, 1338, 21, 4444, 712, 4134, 4804, 5159, 698, 5015, 1297, 1435, 5951, 10075, 4412, 4413, 8986, 8987, 8749, 1236, 10207, 2]
// Exports: default

// Module 10206 (CATEGORY_ICON_SIZE)
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(8986)();
  ...
  const items9 = [callback(categoryIndex(8749), obj), ];
  ...
  if (tmp22Result) {
    ...
    tmp22Result = tmp22(categories(5015).PressableOpacity, obj);
  }
  items9[1] = tmp22Result;
  obj[2] = items9;
  return tmp20(categoryIndex(8987), obj);
};
