...
// Dependencies: [32, 19, 17, 1909, 10382, 676, 1338, 21, 4478, 712, 4166, 4852, 5212, 698, 5068, 1297, 1431, 6004, 10261, 4446, 4447, 9206, 9207, 7778, 1236, 10412, 2]
// Exports: default

// Module 10411 (CATEGORY_ICON_SIZE)
...
export default function _default(categories) {
  ...
  if (tmp22Result) {
    ...
    tmp22Result = tmp22(categories(5068).PressableOpacity, obj);
  }
