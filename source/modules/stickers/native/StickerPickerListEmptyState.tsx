// Module ID: 9902
// Function ID: 9903
// Dependencies: [19, 17, 676, 21, 4285, 712, 8642, 5340, 1297, 1236, 9903, 2]
...
const memoResult = importAllResult.memo(function StickerPickerListEmptyState(insetBottom) {
  ...
  let obj = insetTop(8642);
  const modalDismissGuardRefreshControl = obj.useModalDismissGuardRefreshControl();
  if (inActionSheet) {
    let BottomSheetScrollView = tmp3(5340).BottomSheetScrollView;
  } else {
