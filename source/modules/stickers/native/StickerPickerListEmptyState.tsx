// Module ID: 9812
// Function ID: 9813
// Dependencies: [19, 17, 676, 21, 4255, 712, 9555, 5311, 1297, 1236, 9813, 2]
...
const memoResult = importAllResult.memo(function StickerPickerListEmptyState(insetBottom) {
  ...
  let obj = insetTop(9555);
  const modalDismissGuardRefreshControl = obj.useModalDismissGuardRefreshControl();
  if (inActionSheet) {
    let BottomSheetScrollView = tmp3(5311).BottomSheetScrollView;
  } else {
