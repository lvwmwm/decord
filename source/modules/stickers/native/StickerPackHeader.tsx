// Module ID: 9629
// Function ID: 9630
// Dependencies: [19, 17, 9589, 21, 4189, 712, 4185, 4524, 1297, 9630, 9631, 1236, 9632, 4717, 2]
...
const memoResult = importAllResult.memo((withDescription) => {
  ...
  let obj3 = require(4524) /* getStickerExtensionFromFormatType */;
  ...
  items1[2] = callback(require(4185) /* Text */.Text, obj7);
  obj6[0] = items1;
  ...
  if (withBanner) {
    ...
    withBanner = tmp4(importDefault(9632), obj9);
  }
  ...
  if (null != onPress) {
    ...
    obj10[1] = onPress;
    obj10[3] = tmp2Result;
    let tmp4Result = tmp4(tmp6(4717).PressableOpacity, obj10);
  } else {
