// Module ID: 9899
// Function ID: 9900
// Dependencies: [19, 17, 9860, 21, 4302, 712, 4298, 4636, 1297, 9900, 9901, 1236, 9902, 4844, 2]
...
const memoResult = importAllResult.memo((withDescription) => {
  ...
  let obj3 = require(4636) /* getStickerExtensionFromFormatType */;
  ...
  items1[2] = callback(require(4298) /* Text */.Text, obj7);
  obj6[0] = items1;
  ...
  if (withBanner) {
    ...
    withBanner = tmp4(importDefault(9902), obj9);
  }
