// Module ID: 9852
// Function ID: 9853
// Dependencies: [19, 17, 9813, 21, 4255, 712, 4251, 4589, 1297, 9853, 9854, 1236, 9855, 4797, 2]
...
const memoResult = importAllResult.memo((withDescription) => {
  ...
  let obj3 = require(4589) /* getStickerExtensionFromFormatType */;
  ...
  if (withBanner) {
    ...
    withBanner = tmp4(importDefault(9855), obj9);
  }
