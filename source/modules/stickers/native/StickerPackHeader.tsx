// Module ID: 9883
// Function ID: 9884
// Dependencies: [19, 17, 9844, 21, 4285, 712, 4281, 4619, 1297, 9884, 9885, 1236, 9886, 4827, 2]
...
const memoResult = importAllResult.memo((withDescription) => {
  ...
  if (withBanner) {
    ...
    withBanner = tmp4(importDefault(9886), obj9);
  }
