// Module ID: 9965
// Function ID: 9966
// Dependencies: [19, 17, 9926, 21, 4303, 712, 4299, 4638, 1297, 9966, 9967, 1236, 9968, 4846, 2]
...
const memoResult = importAllResult.memo((withDescription) => {
  ...
  let obj3 = require(4638) /* getStickerExtensionFromFormatType */;
  ...
  items1[2] = callback(require(4299) /* Text */.Text, obj7);
  obj6[0] = items1;
  ...
  if (withBanner) {
    ...
    withBanner = tmp4(importDefault(9968), obj9);
  }
