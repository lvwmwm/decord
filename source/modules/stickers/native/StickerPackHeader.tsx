// Module ID: 9607
// Function ID: 74807
// Dependencies: [31, 27, 9565, 33, 4165, 689, 4161, 4501, 1273, 9608, 9609, 1212, 9610, 4695, 2]
...
const memoResult = importAllResult.memo((withDescription) => {
  ...
  if (result) {
    ...
    const obj3 = { source: importDefault(9608), style: tmp.animatedIcon, size: require(1273) /* Button */.Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color };
    obj2.children = callback(require(1273) /* Button */.Icon, obj3);
    result = callback(View, obj2);
  }
  items[1] = result;
  obj4 = { style: tmp.iconContainer };
  const obj5 = { source: importDefault(9609), style: tmp.premiumIcon, size: require(1273) /* Button */.Icon.Sizes.EXTRA_SMALL, color: tmp.icon.color };
  ...
  if (flag) {
    ...
    flag = callback(require(4161) /* Text */.Text, obj6);
  }
  items1[1] = flag;
  ...
  if (withBanner) {
    ...
    withBanner = callback(importDefault(9610), obj10);
  }
  ...
  if (null != onPress) {
    ...
    let tmp24 = callback(require(4695) /* PressableBase */.PressableOpacity, obj11);
  } else {
    const obj12 = {};
