...
// Dependencies: [19, 17, 21, 4448, 712, 4820, 1236, 4444, 5036, 2]
// Exports: default, doesStickerPackHavePopoutInformation

// Module 10353 (StickerPackInformationPopout)
...
export default function StickerPackInformationPopout(stickerPack) {
  ...
  const items2 = [callback(_require(4444).Text, obj2), ];
  ...
  obj4[3] = callback(_require(4444).Text, obj5);
  items2[1] = callback(_require(5036).PressableOpacity, obj4);
  obj1[1] = items2;
  const items3 = [
