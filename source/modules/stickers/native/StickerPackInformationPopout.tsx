...
// Dependencies: [19, 17, 21, 4661, 712, 4823, 1236, 4734, 5433, 2]
...
export default function StickerPackInformationPopout(stickerPack) {
  ...
  const items2 = [callback(_require(4734).Text, obj2), ];
  ...
  obj4[3] = callback(_require(4734).Text, obj5);
  items2[1] = callback(_require(5433).PressableOpacity, obj4);
  obj1[1] = items2;
  const items3 = [
