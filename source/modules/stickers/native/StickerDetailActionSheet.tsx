...
// Dependencies: [5, 32, 19, 17, 1891, 1903, 5202, 9844, 676, 5378, 21, 4285, 500, 712, 9874, 8667, 8669, 4253, 4281, 1236, 9875, 3985, 589, 1474, 698, 9888, 4695, 9890, 9876, 9881, 3930, 5676, 3957, 4619, 9892, 1988, 4479, 5215, 9893, 5937, 9766, 8527, 9430, 9894, 7890, 8673, 5377, 2]

// Module 9891 (StandardStickerDetail)
  ...
  if (null == stateFromStores) {
    ...
    if (stateFromStores1) {
      ...
      obj6[2] = function onPress() {
        let obj = require(9890) /* hideStickerDetailActionSheet */;
        ...
        obj[1] = require(9881) /* openStickerPackDetailActionSheet */.AnalyticsPopoutType.STICKER_PACK_UPSELL;
        obj[2] = stateFromStores;
        importDefault(9881)(obj);
      };
