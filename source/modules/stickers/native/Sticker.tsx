...
// Function ID: 9736
// Name: Sticker
// Dependencies: [19, 17, 1302, 21, 4936, 4589, 1236, 7888, 9736, 5221, 4101, 5287, 5288, 2]
...
export default function Sticker(opaque) {
  ...
  if (sticker.format_type === require(4936) /* StickerFormat */.StickerFormat.LOTTIE) {
  ...
  if (sticker.format_type === require(4936) /* StickerFormat */.StickerFormat.LOTTIE) {
    ...
    return jsx(importDefault(7888), { url: null, asset: null, width: null, height: null, opacity: null, renderMode: null, accessibilityLabel: null });
  } else {
