...
// Function ID: 9645
// Name: PerkRow
// Dependencies: [19, 17, 5672, 676, 1876, 21, 9645, 1236, 712, 9646, 9647, 4189, 1297, 4185, 709, 6331, 6571, 1474, 5515, 4618, 698, 9321, 4717, 7699, 9648, 2]
// Exports: default
...
export default function StickersPremiumUpsellAlert(arg0) {
  ...
  const tmp5 = analyticsLocations(6571)(PREMIUM_MONTH_TIER_2.PREMIUM_MONTH_TIER_2);
  let priceString;
  if (tmp5 != null) {
  ...
  obj1[0] = analyticsLocations(7699);
  ...
  const items2 = [callback(closure_5, { source: analyticsLocations(9648), style: tmp.imageHeader }), , ];
  ...
  const obj3 = { source: analyticsLocations(9648), style: tmp.imageHeader };
