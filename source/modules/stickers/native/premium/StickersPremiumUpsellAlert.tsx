...
// Function ID: 9642
// Name: PerkRow
// Dependencies: [19, 17, 5672, 676, 1876, 21, 9642, 1236, 712, 9643, 9644, 4189, 1297, 4185, 709, 6328, 6568, 1474, 5515, 4618, 698, 9317, 4717, 7696, 9645, 2]
// Exports: default
...
export default function StickersPremiumUpsellAlert(arg0) {
  ...
  const tmp5 = analyticsLocations(6568)(PREMIUM_MONTH_TIER_2.PREMIUM_MONTH_TIER_2);
  let priceString;
  if (tmp5 != null) {
    priceString = tmp5.priceString;
  }
  analyticsLocations = tmp3(5515)().analyticsLocations;
  ...
  obj1[0] = analyticsLocations(7696);
  ...
  const tmp3Result = analyticsLocations(4618);
  const items2 = [callback(closure_5, { source: analyticsLocations(9645), style: tmp.imageHeader }), , ];
  ...
  const obj3 = { source: analyticsLocations(9645), style: tmp.imageHeader };
