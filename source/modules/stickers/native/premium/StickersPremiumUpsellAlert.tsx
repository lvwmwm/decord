...
// Function ID: 10338
// Name: PerkRow
// Dependencies: [19, 17, 7177, 673, 1923, 21, 10338, 1233, 709, 10339, 10340, 4481, 1296, 4477, 706, 7353, 9293, 1492, 7102, 4955, 695, 9321, 5084, 6932, 10341, 2]
// Exports: default
...
export default function StickersPremiumUpsellAlert(arg0) {
  ...
  const tmp5 = analyticsLocations(9293)(PREMIUM_MONTH_TIER_2.PREMIUM_MONTH_TIER_2);
  let priceString;
  if (tmp5 != null) {
    priceString = tmp5.priceString;
  }
  analyticsLocations = tmp3(7102)().analyticsLocations;
  ...
  const tmp3Result = analyticsLocations(4955);
  obj[3] = callback(Button.Icon, { source: analyticsLocations(6932) });
  ...
  obj1 = { source: analyticsLocations(6932) };
