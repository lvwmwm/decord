...
// Function ID: 74963
// Name: PerkRow
// Dependencies: [31, 27, 5621, 653, 1851, 33, 9625, 1212, 689, 9626, 9627, 4130, 1273, 4126, 686, 6658, 8001, 1450, 5464, 4561, 675, 8139, 4660, 7607, 9628, 2]
// Exports: default
...
({ SubscriptionPlans: closure_11, NUM_FREE_GUILD_BOOSTS_WITH_PREMIUM: closure_12 } = GuildFeatures);
...
let closure_16 = _createForOfIteratorHelperLoose.createStyles(obj1);
...
export default function StickersPremiumUpsellAlert(arg0) {
  ...
  const tmp3 = analyticsLocations(8001)(PREMIUM_MONTH_TIER_2.PREMIUM_MONTH_TIER_2);
  let priceString;
  if (null != tmp3) {
  ...
  const obj1 = { source: analyticsLocations(7607) };
  ...
  const items2 = [callback(closure_5, { source: analyticsLocations(9628), style: tmp.imageHeader }), , ];
  ...
  const obj4 = { source: analyticsLocations(9628), style: tmp.imageHeader };
  const tmp10 = closure_14;
  const tmp11 = closure_4;
  const tmp12 = callback;
  const tmp8 = callback;
  const tmp9 = closure_6;
  items2[2] = callback(closure_4, { style: tmp.perks, children: items.map((perk) => outer1_13(outer1_17, { perk, isLastPerk: arg1 === outer1_15.length - 1 }, arg1)) });
