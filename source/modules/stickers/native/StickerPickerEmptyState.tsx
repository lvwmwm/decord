...
let closure_13 = arg1(dependencyMap[8]).createStyles({ header: { "Null": null, "Null": null }, blurb: {}, premiumButton: { "Bool(false)": "<string:1464991746>", "Bool(false)": "<string:1639437652>", "Bool(false)": "<string:2315796888>", "Bool(false)": "<string:3057713153>", "Bool(false)": "<string:16778327>" }, nitroWheel: { width: 32 }, stickersRow: {}, sticker: { paddingHorizontal: 2 } });
