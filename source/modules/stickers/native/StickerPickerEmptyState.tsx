...
// Dependencies: [32, 19, 17, 5202, 3960, 676, 1905, 21, 4285, 9874, 9766, 5649, 5669, 589, 698, 4281, 1236, 4827, 4254, 4255, 4695, 5251, 8623, 9894, 2]
// Exports: default

// Module 9900 (EmptyStateSticker)
...
function EmptyStateSticker(sticker) {
  ...
  const animated = require(9874) /* useStickerPackCategories */.useShouldAnimateSticker(sticker.isFocused);
  let id;
  const obj = require(9874) /* useStickerPackCategories */;
  const tmp2 = closure_11;
  if (sticker != null) {
    id = sticker.id;
  }
  return tmp2(importDefault(9766), { sticker, size: 60, animated }, id);
}
...
export default function _default() {
  ...
  const items2 = [callback2(require(4281) /* Text */.Text, obj), , , ];
  ...
  items2[1] = callback2(require(4281) /* Text */.Text, obj1);
