...
// Dependencies: [676, 698, 4310, 10009, 2007, 2]
// Exports: default

// Module 10008 (openStickerPackDetailActionSheet)
...
export default function openStickerPackDetailActionSheet(stickerPack) {
  ...
  importDefault(4310).openLazy(require(2007) /* asyncRequireImpl */(10009, dependencyMap.paths), "StickerPackDetailActionSheet", { stickerPack, analyticsPopoutType });
};
