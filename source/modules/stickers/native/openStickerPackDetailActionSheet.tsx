...
// Dependencies: [676, 698, 4271, 9964, 1988, 2]
// Exports: default

// Module 9963 (openStickerPackDetailActionSheet)
...
export default function openStickerPackDetailActionSheet(stickerPack) {
  ...
  importDefault(4271).openLazy(require(1988) /* asyncRequireImpl */(9964, dependencyMap.paths), "StickerPackDetailActionSheet", { stickerPack, analyticsPopoutType });
};
