...
// Dependencies: [653, 675, 4133, 9606, 1935, 2]
// Exports: default

// Module 9605 (openStickerPackDetailActionSheet)
...
export default function openStickerPackDetailActionSheet(stickerPack) {
  ...
  importDefault(4133).openLazy(require(1935) /* maybeLoadBundle */(9606, dependencyMap.paths), "StickerPackDetailActionSheet", { stickerPack, analyticsPopoutType });
};
