...
// Dependencies: [676, 698, 4253, 9882, 1988, 2]
// Exports: default

// Module 9881 (openStickerPackDetailActionSheet)
...
export default function openStickerPackDetailActionSheet(stickerPack) {
  ...
  importDefault(4253).openLazy(require(1988) /* asyncRequireImpl */(9882, dependencyMap.paths), "StickerPackDetailActionSheet", { stickerPack, analyticsPopoutType });
};
