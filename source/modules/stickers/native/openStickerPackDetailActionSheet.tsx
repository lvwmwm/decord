...
// Dependencies: [676, 698, 4445, 10387, 2009, 2]
// Exports: default

// Module 10386 (openStickerPackDetailActionSheet)
...
export default function openStickerPackDetailActionSheet(stickerPack) {
  ...
  ACTION_SHEET_HEIGHT_HALFDefault.openLazy(asyncRequireImpl(10387, dependencyMap.paths), "StickerPackDetailActionSheet", { stickerPack, analyticsPopoutType });
};
