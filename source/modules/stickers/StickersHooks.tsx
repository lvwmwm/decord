...
// Dependencies: [5, 32, 19, 1862, 4006, 5027, 1874, 5091, 5092, 676, 589, 9617, 3862, 4524, 8263, 4856, 4081, 1236, 3822, 9599, 9618, 2]
...
// Module 9616 (useStickerPackCategories)
...
export const useShouldAnimateSticker = function useShouldAnimateSticker(isFocused) {
  ...
  return require(4524) /* getStickerExtensionFromFormatType */.shouldAnimateSticker(setting, isFocused);
};
  ...
  return stickerNodeWidth.useMemo(() => {
    ...
    if (0 !== items2) {
      function addGridSection(sendable, SEARCH_RESULTS, arg2) {
        ...
        const findIndexResult = c6.findIndex((type) => type.type === SEARCH_RESULTS(4856).StickerCategoryTypes.FAVORITE);
...
export const useFavoriteStickerIds = function useFavoriteStickerIds() {
  const favoriteStickers = require(9599) /* useFrecencySettings */.useFrecencySettings().favoriteStickers;
  let stickerIds;
  if (favoriteStickers != null) {
    stickerIds = favoriteStickers.stickerIds;
  }
...
export const useFavoriteStickers = function useFavoriteStickers() {
  const favoriteStickers = stickerIds(9599).useFrecencySettings().favoriteStickers;
...
export const useLatestFrecentStickerIds = function useLatestFrecentStickerIds() {
  const frecencySettings = require(9599) /* useFrecencySettings */.useFrecencySettings();
  let keys = closure_13;
  let stickers;
...
export const useLatestFrecentStickers = function useLatestFrecentStickers() {
  const frecencySettings = keys(9599).useFrecencySettings();
  keys = closure_13;
  let stickers;
  if (frecencySettings != null) {
    const stickerFrecency = frecencySettings.stickerFrecency;
...
export const useStickerForRenderableSticker = function useStickerForRenderableSticker(renderableSticker, arg1) {
  ...
  let isGuildStickerResult = _require(4524).isGuildSticker(renderableSticker);
  if (!isGuildStickerResult) {
    isGuildStickerResult = tmp(4524).isStandardSticker(renderableSticker);
