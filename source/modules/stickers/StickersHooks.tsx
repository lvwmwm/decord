...
// Dependencies: [5, 32, 19, 1910, 4126, 5155, 1922, 5218, 5219, 676, 589, 9963, 3993, 4638, 8992, 4985, 4195, 1236, 3953, 9945, 5954, 2]
...
// Module 9962 (useStickerPackCategories)
...
export const useFavoriteStickerIds = function useFavoriteStickerIds() {
  const favoriteStickers = require(9945) /* useFrecencySettings */.useFrecencySettings().favoriteStickers;
  let stickerIds;
  if (favoriteStickers != null) {
    stickerIds = favoriteStickers.stickerIds;
  }
...
export const useLatestFrecentStickerIds = function useLatestFrecentStickerIds() {
  const frecencySettings = require(9945) /* useFrecencySettings */.useFrecencySettings();
  let keys = closure_13;
  let stickers;
