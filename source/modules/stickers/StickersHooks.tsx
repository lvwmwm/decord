...
// Dependencies: [5, 32, 19, 1891, 4101, 5137, 1903, 5201, 5202, 676, 589, 9875, 3957, 4619, 8909, 4966, 4177, 1236, 3917, 9857, 5873, 2]
...
// Module 9874 (useStickerPackCategories)
...
export const useFavoriteStickerIds = function useFavoriteStickerIds() {
  const favoriteStickers = require(9857) /* useFrecencySettings */.useFrecencySettings().favoriteStickers;
  let stickerIds;
  if (favoriteStickers != null) {
    stickerIds = favoriteStickers.stickerIds;
  }
...
export const useLatestFrecentStickerIds = function useLatestFrecentStickerIds() {
  const frecencySettings = require(9857) /* useFrecencySettings */.useFrecencySettings();
  let keys = closure_13;
  let stickers;
