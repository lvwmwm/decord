...
// Dependencies: [5, 32, 19, 1862, 4072, 5107, 1874, 5171, 5172, 676, 589, 9844, 3928, 4589, 8880, 4936, 4147, 1236, 3888, 9826, 5846, 2]
...
// Module 9843 (useStickerPackCategories)
...
export const useShouldAnimateSticker = function useShouldAnimateSticker(isFocused) {
  ...
  return require(4589) /* getStickerExtensionFromFormatType */.shouldAnimateSticker(setting, isFocused);
};
...
export const useFavoriteStickerIds = function useFavoriteStickerIds() {
  const favoriteStickers = require(9826) /* useFrecencySettings */.useFrecencySettings().favoriteStickers;
  let stickerIds;
  if (favoriteStickers != null) {
    stickerIds = favoriteStickers.stickerIds;
  }
...
export const useLatestFrecentStickerIds = function useLatestFrecentStickerIds() {
  const frecencySettings = require(9826) /* useFrecencySettings */.useFrecencySettings();
  let keys = closure_13;
  let stickers;
...
export const useStickerForRenderableSticker = function useStickerForRenderableSticker(renderableSticker, arg1) {
  ...
  let isGuildStickerResult = _require(4589).isGuildSticker(renderableSticker);
  if (!isGuildStickerResult) {
