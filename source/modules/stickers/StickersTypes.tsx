...
// Function ID: 4937
// Name: StickerFormat
// Dependencies: [1413, 4937, 2]
// Exports: isAnimatedSticker, isCustomSticker

// Module 4936 (StickerFormat)
...
export const isAnimatedSticker = function isAnimatedSticker(arg0) {
  return arg0 !== require(4937) /* MetaStickerType */.StickerFormat.PNG;
};
export const isCustomSticker = function isCustomSticker(arg0) {
  return arg0 !== require(4937) /* MetaStickerType */.MetaStickerType.STANDARD;
};
