...
export const searchAllStickers = function searchAllStickers(arg0) {
  ...
  return importDefault(4975).queryStickers(items, true).map((sticker) => sticker.sticker);
};
export const searchSendableStickers = function searchSendableStickers(arg0, arg1) {
  ...
  const obj = importDefault(4975);
  return importDefault(4975).queryStickers(items, true, items1).map((sticker) => sticker.sticker);
};
