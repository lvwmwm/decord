...
// Dependencies: [1990, 5261, 676, 4007, 4679, 3994, 2]
// Exports: isSendableSticker

// Module 5995 (getStickerSendability)
...
function getStickerSendability(stickerById, trackCommunicationDisabled, channel) {
  if (null == trackCommunicationDisabled) {
    ...
    const result = importDefault(4007).canUseCustomStickersEverywhere(trackCommunicationDisabled);
    ...
    obj5 = require(4679) /* getStickerExtensionFromFormatType */;
  }
}
