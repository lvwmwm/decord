...
// Dependencies: [19, 4036, 8851, 8847, 4713, 8491, 5427, 2]
// Exports: useMediaViewerPanGesture, useMediaViewerPanGestureConfig

// Module 12257 (useMediaViewerPanGestureConfig)
...
export const useMediaViewerPanGestureConfig = function useMediaViewerPanGestureConfig(arg0, swipeVelocityThreshold, onClose) {
  ...
  const sharedValue = _require(4036).useSharedValue(false);
  let obj = _require(4036);
  const sharedValue1 = _require(4036).useSharedValue(false);
  const obj2 = _require(4036);
  const sharedValue2 = _require(4036).useSharedValue(0);
  const obj3 = _require(4036);
  const sharedValue3 = _require(4036).useSharedValue(0);
  const obj4 = _require(4036);
  const sharedValue4 = _require(4036).useSharedValue({ y: 0, x: 0 });
  const obj5 = _require(4036);
  const sharedValue5 = _require(4036).useSharedValue(true);
  const items = [onClose];
