...
// Function ID: 12303
// Name: ObscuredView
// Dependencies: [32, 19, 17, 8136, 21, 12303, 3893, 712, 4050, 4590, 500, 4189, 5141, 8117, 4051, 7678, 2]
// Exports: default

// Module 12302 (ObscuredView)
...
function ObscuredView(source) {
  ...
  let obj = require(12303) /* useMediaItemSpoilerState */;
  ...
  if (tmp4) {
    if (source.spoiler) {
      ...
      tmp10Result = tmp10(tmp7(4050).View, obj);
...
let closure_12 = importAllResult.memo((onSelect) => {
  ...
  obj[1] = thumbnail;
  const items2 = [closure_8(onSelect(5141), obj), closure_8(ObscuredView, { source: first, index })];
  obj[7] = items2;
  obj[1] = closure_9(closure_5, obj);
  return closure_8(onSelect(4050).View, obj);
});
