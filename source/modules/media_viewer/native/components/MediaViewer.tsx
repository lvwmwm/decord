...
// Function ID: 12139
// Name: MediaViewer
// Dependencies: [32, 19, 17, 21, 500, 4116, 12139, 12140, 8626, 5353, 7790, 5595, 5615, 8759, 12144, 4256, 8745, 8789, 7641, 4117, 10537, 2]

// Module 12138 (MediaViewer)
...
function MediaViewer(arg0) {
  ...
  const orientationListener = _require(8789).useOrientationListener(callback2);
  obj4 = { style: c6.absoluteFill, onAccessibilityEscape: dismiss, onLayout: callback1, children: null };
  const obj15 = _require(8789);
...
export default importAllResult.memo((arg0) => {
  ...
  return callback(require(8759) /* MediaViewerDimensionsProvider */.MediaViewerDimensionsProvider, obj);
});
