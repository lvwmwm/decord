...
// Function ID: 12168
// Name: MediaViewer
// Dependencies: [32, 19, 17, 21, 500, 4146, 12168, 12169, 8654, 5368, 7818, 5610, 5630, 8787, 12173, 4286, 8773, 8817, 7669, 4147, 10565, 2]

// Module 12167 (MediaViewer)
...
function MediaViewer(arg0) {
  ...
  let value = [height(5630).MEDIA_VIEWER];
  let tmp = height;
  const tmp3 = height(5610);
  ...
  obj = { absoluteFillObject, windowHeight: height, entranceAnimationDriver: sharedValue, interpolate: _require(4146).interpolate, translatePos, closePosition: tmp9 };
  M.__closure = obj;
  ...
  obj1 = { isClosing, hideRelayoutSharedValue: sharedValue1, overlayEnabled, isInteracting, withTiming: _require(4286).withTiming, Easing: _require(4146).Easing, runOnJS: _require(4146).runOnJS, setShowHeader: tmp6 };
  P.__closure = obj1;
  P.__workletHash = 14874736878670;
  P.__initData = closure_14;
  const animatedStyle1 = _require(4146).useAnimatedStyle(P);
  const obj9 = _require(4146);
  let fn = function x() {
  ...
  obj2 = { overlayEnabled, isInteracting, runOnJS: _require(4146).runOnJS, setShowHeader: tmp6 };
  fn.__closure = obj2;
  fn.__workletHash = 2199049578465;
  fn.__initData = closure_16;
  const derivedValue = _require(4146).useDerivedValue(fn);
  const obj11 = _require(4146);
  function le() {
    let obj = {};
  ...
  obj3 = { absoluteFillObject, translatePos, hideRelayoutSharedValue: sharedValue1, withTiming: _require(4286).withTiming, Easing: _require(4146).Easing };
  le.__closure = obj3;
  le.__workletHash = 8244409104374;
  le.__initData = closure_17;
  const animatedStyle2 = _require(4146).useAnimatedStyle(le);
  ...
  items5[3] = translatePos(height(4147), obj6);
  items5[4] = translatePos(tmp(10565), {});
  obj4[3] = items5;
  const children = tmp28(tmp29, obj4);
  return translatePos(tmp7(5610).AnalyticsLocationProvider, { value: tmp3(value).analyticsLocations, children });
}
...
export default importAllResult.memo((arg0) => {
  ...
  return callback(require(8787) /* MediaViewerDimensionsProvider */.MediaViewerDimensionsProvider, obj);
});
