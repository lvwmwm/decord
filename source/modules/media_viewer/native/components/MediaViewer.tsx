...
// Function ID: 12188
// Name: MediaViewer
// Dependencies: [32, 19, 17, 21, 500, 4162, 12188, 12189, 8672, 5426, 7948, 5668, 5688, 8805, 12193, 4303, 8791, 8835, 7688, 4163, 10589, 2]

// Module 12187 (MediaViewer)
...
function MediaViewer(arg0) {
  ...
  obj = { absoluteFillObject, windowHeight: height, entranceAnimationDriver: sharedValue, interpolate: _require(4162).interpolate, translatePos, closePosition: tmp9 };
  M.__closure = obj;
  ...
  obj1 = { isClosing, hideRelayoutSharedValue: sharedValue1, overlayEnabled, isInteracting, withTiming: _require(4303).withTiming, Easing: _require(4162).Easing, runOnJS: _require(4162).runOnJS, setShowHeader: tmp6 };
  P.__closure = obj1;
  P.__workletHash = 14874736878670;
  P.__initData = closure_14;
  const animatedStyle1 = _require(4162).useAnimatedStyle(P);
  const obj9 = _require(4162);
  let fn = function x() {
  ...
  obj2 = { overlayEnabled, isInteracting, runOnJS: _require(4162).runOnJS, setShowHeader: tmp6 };
  fn.__closure = obj2;
  fn.__workletHash = 2199049578465;
  fn.__initData = closure_16;
  const derivedValue = _require(4162).useDerivedValue(fn);
  const obj11 = _require(4162);
  function le() {
    let obj = {};
  ...
  obj3 = { absoluteFillObject, translatePos, hideRelayoutSharedValue: sharedValue1, withTiming: _require(4303).withTiming, Easing: _require(4162).Easing };
  le.__closure = obj3;
  le.__workletHash = 8244409104374;
  le.__initData = closure_17;
  const animatedStyle2 = _require(4162).useAnimatedStyle(le);
  ...
  const obj13 = _require(4162);
  const orientationListener = _require(8835).useOrientationListener(callback2);
  obj4 = { style: c6.absoluteFill, onAccessibilityEscape: dismiss, onLayout: callback1, children: null };
  const obj15 = _require(8835);
  obj5 = { barStyle: "light-content", hidden: !tmp5 };
  const items5 = [translatePos(height(7688), obj5), translatePos(height(4162).View, { style: animatedStyle }), translatePos(height(4163), { ref: animatedRef, style: animatedStyle2, children: translatePos(closure_12, { entranceAnimationDriver: sharedValue, onContentSizeChange, onScroll, onLongPress, originLayout, panGestureConfig: mediaViewerPanGestureConfig, ref, renderMedia, sources, useItemVisible, windowHeight: height, windowWidth: width, index, zoomed }) }), , ];
  ...
  items5[3] = translatePos(height(4163), obj6);
  items5[4] = translatePos(tmp(10589), {});
  obj4[3] = items5;
  const children = tmp28(tmp29, obj4);
  return translatePos(tmp7(5668).AnalyticsLocationProvider, { value: tmp3(value).analyticsLocations, children });
}
...
export default importAllResult.memo((arg0) => {
  ...
  return callback(require(8805) /* MediaViewerDimensionsProvider */.MediaViewerDimensionsProvider, obj);
});
