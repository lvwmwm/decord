...
// Function ID: 12173
// Name: MediaViewer
// Dependencies: [32, 19, 17, 21, 500, 4145, 12173, 12174, 8655, 5407, 7931, 5649, 5669, 8788, 12178, 4286, 8774, 8818, 7669, 4146, 10592, 2]

// Module 12172 (MediaViewer)
...
function MediaViewer(arg0) {
  ...
  obj = { absoluteFillObject, windowHeight: height, entranceAnimationDriver: sharedValue, interpolate: _require(4145).interpolate, translatePos, closePosition: tmp9 };
  M.__closure = obj;
  ...
  obj1 = { isClosing, hideRelayoutSharedValue: sharedValue1, overlayEnabled, isInteracting, withTiming: _require(4286).withTiming, Easing: _require(4145).Easing, runOnJS: _require(4145).runOnJS, setShowHeader: tmp6 };
  P.__closure = obj1;
  P.__workletHash = 14874736878670;
  P.__initData = closure_14;
  const animatedStyle1 = _require(4145).useAnimatedStyle(P);
  const obj9 = _require(4145);
  let fn = function x() {
  ...
  obj2 = { overlayEnabled, isInteracting, runOnJS: _require(4145).runOnJS, setShowHeader: tmp6 };
  fn.__closure = obj2;
  fn.__workletHash = 2199049578465;
  fn.__initData = closure_16;
  const derivedValue = _require(4145).useDerivedValue(fn);
  const obj11 = _require(4145);
  function le() {
    let obj = {};
  ...
  obj3 = { absoluteFillObject, translatePos, hideRelayoutSharedValue: sharedValue1, withTiming: _require(4286).withTiming, Easing: _require(4145).Easing };
  le.__closure = obj3;
  le.__workletHash = 8244409104374;
  le.__initData = closure_17;
  const animatedStyle2 = _require(4145).useAnimatedStyle(le);
  ...
  const obj13 = _require(4145);
  const orientationListener = _require(8818).useOrientationListener(callback2);
  obj4 = { style: c6.absoluteFill, onAccessibilityEscape: dismiss, onLayout: callback1, children: null };
  const obj15 = _require(8818);
...
export default importAllResult.memo((arg0) => {
  ...
  return callback(require(8788) /* MediaViewerDimensionsProvider */.MediaViewerDimensionsProvider, obj);
});
