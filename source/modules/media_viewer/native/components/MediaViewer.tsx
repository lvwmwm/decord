...
// Function ID: 12438
// Name: MediaViewer
// Dependencies: [32, 19, 17, 21, 500, 4116, 12438, 12439, 8453, 5339, 7806, 5581, 5601, 8472, 12443, 4256, 8458, 8478, 7657, 4117, 10715, 2]

// Module 12437 (MediaViewer)
...
function MediaViewer(arg0) {
  ...
  obj = { absoluteFillObject, windowHeight: height, entranceAnimationDriver: sharedValue, interpolate: _require(4116).interpolate, translatePos, closePosition: tmp9 };
  M.__closure = obj;
  ...
  obj1 = { isClosing, hideRelayoutSharedValue: sharedValue1, overlayEnabled, isInteracting, withTiming: _require(4256).withTiming, Easing: _require(4116).Easing, runOnJS: _require(4116).runOnJS, setShowHeader: tmp6 };
  P.__closure = obj1;
  P.__workletHash = 14874736878670;
  P.__initData = closure_14;
  const animatedStyle1 = _require(4116).useAnimatedStyle(P);
  const obj9 = _require(4116);
  let fn = function x() {
  ...
  obj2 = { overlayEnabled, isInteracting, runOnJS: _require(4116).runOnJS, setShowHeader: tmp6 };
  fn.__closure = obj2;
  fn.__workletHash = 2199049578465;
  fn.__initData = closure_16;
  const derivedValue = _require(4116).useDerivedValue(fn);
  const obj11 = _require(4116);
  function le() {
    let obj = {};
  ...
  obj3 = { absoluteFillObject, translatePos, hideRelayoutSharedValue: sharedValue1, withTiming: _require(4256).withTiming, Easing: _require(4116).Easing };
  le.__closure = obj3;
  le.__workletHash = 8244409104374;
  le.__initData = closure_17;
  const animatedStyle2 = _require(4116).useAnimatedStyle(le);
  ...
  items5[4] = translatePos(tmp(10715), {});
  obj4[3] = items5;
  const children = tmp28(tmp29, obj4);
  return translatePos(tmp7(5581).AnalyticsLocationProvider, { value: tmp3(value).analyticsLocations, children });
}
...
export default importAllResult.memo((arg0) => {
  ...
  return callback(require(8472) /* MediaViewerDimensionsProvider */.MediaViewerDimensionsProvider, obj);
});
