...
// Function ID: 12260
// Name: MediaViewer
// Dependencies: [32, 19, 17, 21, 500, 4042, 12260, 12261, 8738, 5427, 8010, 5728, 5748, 8871, 12265, 4304, 8857, 8901, 7750, 4043, 10661, 2]

// Module 12259 (MediaViewer)
...
function MediaViewer(arg0) {
  ...
  obj = { absoluteFillObject, windowHeight: height, entranceAnimationDriver: sharedValue, interpolate: _require(4042).interpolate, translatePos, closePosition: tmp9 };
  M.__closure = obj;
  ...
  obj1 = { isClosing, hideRelayoutSharedValue: sharedValue1, overlayEnabled, isInteracting, withTiming: _require(4304).withTiming, Easing: _require(4042).Easing, runOnJS: _require(4042).runOnJS, setShowHeader: tmp6 };
  P.__closure = obj1;
  P.__workletHash = 14874736878670;
  P.__initData = closure_14;
  const animatedStyle1 = _require(4042).useAnimatedStyle(P);
  ...
  obj2 = { overlayEnabled, isInteracting, runOnJS: _require(4042).runOnJS, setShowHeader: tmp6 };
  fn.__closure = obj2;
  fn.__workletHash = 2199049578465;
  fn.__initData = closure_16;
  const derivedValue = _require(4042).useDerivedValue(fn);
  const obj11 = _require(4042);
  function le() {
    let obj = {};
  ...
  obj3 = { absoluteFillObject, translatePos, hideRelayoutSharedValue: sharedValue1, withTiming: _require(4304).withTiming, Easing: _require(4042).Easing };
  le.__closure = obj3;
  le.__workletHash = 8244409104374;
  le.__initData = closure_17;
  const animatedStyle2 = _require(4042).useAnimatedStyle(le);
  ...
  items5[3] = translatePos(height(4043), obj6);
  items5[4] = translatePos(tmp(10661), {});
  obj4[3] = items5;
...
export default importAllResult.memo((arg0) => {
  ...
  return callback(require(8871) /* MediaViewerDimensionsProvider */.MediaViewerDimensionsProvider, obj);
});
