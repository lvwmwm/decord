// Module ID: 12336
// Function ID: 12337
// Dependencies: [19, 17, 21, 4193, 712, 10565, 4189, 1236, 4604, 3890, 2]
...
const memoResult = require("noop").memo(function MediaModalYoutubeEmbedError(videoId) {
  ...
  const items = [callback(videoId(10565).StreamFailed, { resizeMode: "contain" }), , ];
  ...
  items[1] = callback(videoId(4189).Text, obj);
  ...
  items[2] = callback(videoId(4604).Button, obj);
  obj[1] = items;
