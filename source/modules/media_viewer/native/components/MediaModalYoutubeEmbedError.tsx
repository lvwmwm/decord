// Module ID: 12310
// Function ID: 12311
// Dependencies: [19, 17, 21, 4189, 712, 10547, 4185, 1236, 4600, 3886, 2]
...
const memoResult = require("noop").memo(function MediaModalYoutubeEmbedError(videoId) {
  ...
  const items = [callback(videoId(10547).StreamFailed, { resizeMode: "contain" }), , ];
  ...
  items[1] = callback(videoId(4185).Text, obj);
  ...
  items[2] = callback(videoId(4600).Button, obj);
  obj[1] = items;
