...
let obj = {};
obj = { backgroundColor: importDefault(dependencyMap[4]).colors.VOICE_VIDEO_VIDEO_TILE_BACKGROUND, padding: importDefault(dependencyMap[4]).space.PX_32 };
obj.container = obj;
...
const memoResult = importAllResult.memo(function MediaModalYoutubeEmbedError(videoId) {
  ...
  obj = { "Null": null, "Null": null, alignItems: null, style: tmp.text };
