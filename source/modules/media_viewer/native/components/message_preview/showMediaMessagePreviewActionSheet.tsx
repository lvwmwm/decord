...
// Dependencies: [1372, 1874, 4157, 12308, 1959, 2]
// Exports: default

// Module 12307 (showMediaMessagePreviewActionSheet)
  ...
  if (null != channel) {
    if (null != message) {
      ...
      if (null != user) {
        ...
        obj.openLazy(require(1959) /* asyncRequireImpl */(12308, dependencyMap.paths), "MediaMessagePreviewActionSheet", obj);
      }
    }
  }
};
