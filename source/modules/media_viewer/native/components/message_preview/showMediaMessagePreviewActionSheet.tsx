...
// Dependencies: [1391, 1922, 4310, 12320, 2007, 2]
// Exports: default

// Module 12319 (showMediaMessagePreviewActionSheet)
  ...
  if (null != channel) {
    if (null != message) {
      ...
      if (null != user) {
        ...
        obj.openLazy(require(2007) /* asyncRequireImpl */(12320, dependencyMap.paths), "MediaMessagePreviewActionSheet", obj);
      }
    }
  }
};
