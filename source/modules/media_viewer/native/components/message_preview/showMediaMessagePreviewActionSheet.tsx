...
// Dependencies: [1391, 1922, 4271, 12254, 2007, 2]
// Exports: default

// Module 12253 (showMediaMessagePreviewActionSheet)
  ...
  if (null != channel) {
    if (null != message) {
      ...
      if (null != user) {
        ...
        obj.openLazy(require(2007) /* asyncRequireImpl */(12254, dependencyMap.paths), "MediaMessagePreviewActionSheet", obj);
      }
    }
  }
};
