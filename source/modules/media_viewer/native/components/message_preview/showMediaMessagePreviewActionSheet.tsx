...
// Dependencies: [1391, 1922, 4312, 12317, 2007, 2]
// Exports: default

// Module 12316 (showMediaMessagePreviewActionSheet)
  ...
  if (null != channel) {
    if (null != message) {
      ...
      if (null != user) {
        ...
        obj.openLazy(require(2007) /* asyncRequireImpl */(12317, dependencyMap.paths), "MediaMessagePreviewActionSheet", obj);
      }
    }
  }
};
