...
// Function ID: 8578
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4478, 500, 5941, 12, 689, 5112, 5068, 1236, 8578, 8580, 4474, 8381, 8582, 712, 2]
// Exports: default

// Module 8577 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  if (paused) {
    let PauseIcon = tmp16(8578).PlayIcon;
  } else {
  ...
  obj5[8] = callback;
  obj5[9] = callback1;
  items7[1] = closure_6(paused(8381), obj5);
  obj1[1] = items7;
  items4[2] = c7(c5, obj1);
  obj6 = {
