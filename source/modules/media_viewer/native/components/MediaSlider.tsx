...
// Function ID: 8593
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4478, 1234, 5949, 12, 686, 5120, 5076, 1233, 8593, 8595, 4474, 8390, 8597, 709, 2]
// Exports: default

// Module 8592 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  closure_9 = tmp8[1];
  const tmp11 = paused(5949)(() => paused(closure_1_2[7]).throttle((arg0) => {
    callback(arg0);
  }, 100));
  closure_10 = tmp11;
  closure_11 = paused(5949)(() => paused(closure_1_2[7]).throttle((arg0) => {
    callback(arg0);
    let str = "transparent";
    if (1 === arg0) {
  ...
  if (paused) {
    let PauseIcon = tmp16(8593).PlayIcon;
  } else {
    PauseIcon = tmp16(8595).PauseIcon;
  }
  obj[5] = closure_6(PauseIcon, { size: "md", color: "white" });
  const items4 = [closure_6(controls(5076).PressableOpacity, obj), , , ];
  ...
  obj5[8] = callback;
  obj5[9] = callback1;
  items7[1] = closure_6(paused(8390), obj5);
  obj1[1] = items7;
  items4[2] = c7(c5, obj1);
  obj6 = {
  ...
  const tmp9Result1 = paused(8390);
  obj6[6] = controls(5120).getTimeFormat(ref.current);
