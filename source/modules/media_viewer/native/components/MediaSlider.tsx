...
// Function ID: 8855
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4303, 500, 5716, 12, 689, 4890, 4846, 1236, 8855, 8857, 4299, 7989, 8859, 712, 2]
// Exports: default

// Module 8854 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  if (paused) {
    let PauseIcon = tmp16(8855).PlayIcon;
  } else {
    PauseIcon = tmp16(8857).PauseIcon;
  }
  ...
  obj5[8] = callback;
  obj5[9] = callback1;
  items7[1] = closure_6(paused(7989), obj5);
  obj1[1] = items7;
  items4[2] = c7(c5, obj1);
  obj6 = {
