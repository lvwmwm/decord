...
// Dependencies: [19, 17, 8635, 21, 4478, 12826, 8605, 11245, 4332, 4217, 4479, 8639, 8640, 1236, 5551, 1297, 712, 4474, 12830, 8792, 500, 12831, 8798, 2]
// Exports: MediaModalOverlayHeader

// Module 12829 (MediaModalOverlayHeader)
import noopAll from "noop" /* 19 */;
import _modDef4217 from "module_4217" /* 4217 */;
import _modDef8640 from "module_8640" /* 8640 */;
import useShouldHideMediaOptionsDefault from "useShouldHideMediaOptions" /* 11245 */;
...
export const MediaModalOverlayHeader = function MediaModalOverlayHeader(arg0) {
  ...
  if (!tmp7) {
    ...
    if (!disableMediaOverlayButton) {
      ...
      obj13[1] = function children(ref) {
        ...
        const tmp4 = callback(8640);
        if (obj2.isAndroid()) {
          let tmp2Result = tmp2(tmp5(12831).MoreVerticalIcon, { size: "md", color: "interactive-text-active" });
        } else {
      ...
      tmp10Result1 = tmp10(tmp2(8792).ContextMenu, obj13);
    }
  ...
  obj3[1] = items3;
  obj2[2] = closure_7(isModalOpen(8639).MediaModalOverlayHeaderWrapper, obj3);
