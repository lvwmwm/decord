...
// Dependencies: [19, 17, 8932, 21, 4303, 12242, 8903, 11129, 4158, 4042, 4304, 8936, 8937, 1236, 5326, 1297, 712, 4299, 12246, 8604, 500, 12247, 8610, 2]
// Exports: MediaModalOverlayHeader

// Module 12245 (MediaModalOverlayHeader)
import "ContextMenu";
...
export const MediaModalOverlayHeader = function MediaModalOverlayHeader(arg0) {
  ...
  obj5[2] = onClose;
  const items1 = [closure_6(importDefault(8937), obj5), ];
  ...
  if (!tmp7) {
    ...
    obj12[0] = source;
    const items4 = [tmp10(tmp6(12246), obj12), ];
    ...
    if (!disableMediaOverlayButton) {
      ...
      obj13[1] = function children(ref) {
        ...
        const tmp4 = callback(8937);
        if (obj2.isAndroid()) {
          let tmp2Result = tmp2(tmp5(12247).MoreVerticalIcon, { size: "md", color: "interactive-text-active" });
        } else {
          tmp2Result = tmp2(tmp5(8610).MoreHorizontalIcon, { size: "md", color: "interactive-text-active" });
        }
        obj[1] = tmp2Result;
        obj[2] = ref.ref;
      ...
      tmp10Result1 = tmp10(tmp2(8604).ContextMenu, obj13);
    }
  ...
  obj3[1] = items3;
  obj2[2] = closure_7(isModalOpen(8936).MediaModalOverlayHeaderWrapper, obj3);
  obj[1] = closure_6(importDefault(4042).View, obj2);
