...
// Dependencies: [32, 19, 17, 21, 4478, 712, 5553, 9067, 1236, 12823, 10094, 12824, 12825, 12826, 8575, 500, 4918, 12827, 8588, 12829, 4217, 12833, 8574, 12834, 12828, 8567, 8568, 2]
// Exports: default

// Module 12822 (OverlayMuteButton)
...
import nativeEventEmitter from "nativeEventEmitter" /* 8575 */;
import renderDefault from "render" /* 9067 */;
import useOverlayLayoutDriver from "useOverlayLayoutDriver" /* 12826 */;
import ObscuredViewDefault from "ObscuredView" /* 12827 */;
import MediaModalOverlayHeader from "MediaModalOverlayHeader" /* 12829 */;
...
function OverlayMuteButton(arg0) {
  ...
  obj = { left: true, right: true, children: tmp4(isMuted ? 12823 : 10094) };
...
function OverlayObscureToggleButton(arg0) {
  ...
  obj = { left: true, right: true, children: tmp4(spoilerActive ? 12824 : 12825) };
  obj[3] = ThemesDefault.unsafe_rawColors.WHITE;
...
function MediaModalOverlay(getVideoControls) {
  ...
  obj.slider = videoControls(8574)(index, source, videoControls);
  obj.source = source;
...
let closure_13 = importAllResult.memo((arg0) => {
  ...
  if (null != slider) {
    ...
    items[2] = tmp16;
    obj[4] = items;
    let tmp21Result2 = closure_8(tmp2(5553).SafeAreaPaddingView, obj);
    const tmp11 = closure_8;
  } else {
    tmp21Result2 = null;
  }
  tmp2Result = tmp2(8588);
  ...
  if (!tmp7) {
    ...
    tmp21Result = tmp21(_modDef12833, obj4);
  }
  ...
  if (disableMediaOverlayFooter) {
    ...
    tmp21Result2 = tmp21(tmp2(5553).SafeAreaPaddingView, obj8);
    ...
    tmp21Result2 = tmp21(tmp2(12834).MediaModalOverlayFooter, obj9);
  }
