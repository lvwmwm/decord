...
// Dependencies: [32, 19, 17, 21, 4255, 712, 5243, 8649, 1236, 12416, 10919, 12417, 12418, 12419, 8459, 500, 4656, 12420, 8472, 12422, 4116, 12427, 8458, 12428, 12421, 8451, 8452, 2]
// Exports: default

// Module 12415 (OverlayMuteButton)
import _slicedToArray from "_slicedToArray";
import importAllResult from "MediaModalOverlayHeader";
import get_ActivityIndicator from "ObscuredView";
import jsxProd from "module_12427";
...
function OverlayObscureToggleButton(arg0) {
  ...
  obj = { left: true, right: true, children: null };
  obj[2] = importDefault(spoilerActive ? 12417 : 12418);
  obj[3] = importDefault(712).unsafe_rawColors.WHITE;
...
function MediaModalOverlay(getVideoControls) {
  ...
  obj.slider = videoControls(8458)(index, source, videoControls);
  obj.source = source;
...
let closure_13 = importAllResult.memo((arg0) => {
  ...
  let obj1 = require(12419) /* useOverlayLayoutDriver */;
  ...
  let obj2 = require(8459) /* nativeEventEmitter */;
  ...
  if (null != slider) {
    ...
    if (isIOSResult) {
      ...
      isIOSResult = callback2(importDefault(4656), obj);
    }
    ...
    if (syncer.sources.length > 1) {
      obj1 = { syncer: null };
      obj1[0] = syncer;
      tmp16 = callback2(importDefault(12420), obj1);
    }
    items[2] = tmp16;
    obj[4] = items;
    let tmp21Result2 = closure_8(tmp2(5243).SafeAreaPaddingView, obj);
    const tmp11 = closure_8;
  } else {
    tmp21Result2 = null;
  }
  tmp2Result = tmp2(8472);
  ...
  const items1 = [callback2(require(12422) /* MediaModalOverlayHeader */.MediaModalOverlayHeader, obj2), ];
  ...
  if (!tmp7) {
    ...
    tmp21Result = tmp21(importDefault(12427), obj4);
  }
  ...
  if (disableMediaOverlayFooter) {
    ...
    tmp21Result2 = tmp21(tmp2(5243).SafeAreaPaddingView, obj8);
    ...
    tmp21Result2 = tmp21(tmp2(12428).MediaModalOverlayFooter, obj9);
  }
