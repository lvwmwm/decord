...
// Dependencies: [32, 19, 17, 21, 4302, 712, 5327, 8997, 1236, 12167, 10827, 12168, 12169, 12170, 8792, 500, 4702, 12171, 8805, 12173, 4162, 12177, 8791, 12178, 12172, 8785, 8786, 2]
// Exports: default

// Module 12166 (OverlayMuteButton)
import _slicedToArray from "_slicedToArray";
import importAllResult from "MediaModalOverlayHeader";
import get_ActivityIndicator from "ObscuredView";
import jsxProd from "module_12177";
...
function OverlayObscureToggleButton(arg0) {
  ...
  obj = { left: true, right: true, children: null };
  obj[2] = importDefault(spoilerActive ? 12168 : 12169);
  obj[3] = importDefault(712).unsafe_rawColors.WHITE;
...
function MediaModalOverlay(getVideoControls) {
  ...
  obj.slider = videoControls(8791)(index, source, videoControls);
  obj.source = source;
...
let closure_13 = importAllResult.memo((arg0) => {
  ...
  const tmp = callback3();
  let obj = require(12170) /* useOverlayLayoutDriver */;
  const overlayLayoutDriver = obj.useOverlayLayoutDriver();
  let obj1 = require(12170) /* useOverlayLayoutDriver */;
  ...
  let obj2 = require(8792) /* nativeEventEmitter */;
  ...
  if (null != slider) {
    ...
    if (isIOSResult) {
      ...
      isIOSResult = callback2(importDefault(4702), obj);
    }
    ...
    if (syncer.sources.length > 1) {
      obj1 = { syncer: null };
      obj1[0] = syncer;
      tmp16 = callback2(importDefault(12171), obj1);
    }
    items[2] = tmp16;
    obj[4] = items;
    let tmp21Result2 = closure_8(tmp2(5327).SafeAreaPaddingView, obj);
    const tmp11 = closure_8;
  } else {
    tmp21Result2 = null;
  }
  tmp2Result = tmp2(8805);
  ...
  const items1 = [callback2(require(12173) /* MediaModalOverlayHeader */.MediaModalOverlayHeader, obj2), ];
  ...
  if (!tmp7) {
    ...
    tmp21Result = tmp21(importDefault(12177), obj4);
  }
  ...
  if (disableMediaOverlayFooter) {
    ...
    tmp21Result2 = tmp21(tmp2(5327).SafeAreaPaddingView, obj8);
    ...
    tmp21Result2 = tmp21(tmp2(12178).MediaModalOverlayFooter, obj9);
  }
  const obj10 = { children: null };
  items3[2] = tmp21Result2;
  obj3[1] = items3;
  items1[1] = closure_8(importDefault(4162).View, obj3);
  obj10[0] = items1;
