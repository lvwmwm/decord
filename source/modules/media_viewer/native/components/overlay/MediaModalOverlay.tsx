...
// Dependencies: [32, 19, 17, 21, 4446, 712, 5518, 9006, 1236, 12755, 10032, 12756, 12757, 12758, 8521, 500, 4883, 12759, 8534, 12761, 4186, 12765, 8520, 12766, 12760, 8513, 8514, 2]
// Exports: default

// Module 12754 (OverlayMuteButton)
...
import nativeEventEmitter from "nativeEventEmitter" /* 8521 */;
import renderDefault from "render" /* 9006 */;
import useOverlayLayoutDriver from "useOverlayLayoutDriver" /* 12758 */;
import ObscuredViewDefault from "ObscuredView" /* 12759 */;
import MediaModalOverlayHeader from "MediaModalOverlayHeader" /* 12761 */;
...
function OverlayMuteButton(arg0) {
  ...
  obj = { left: true, right: true, children: tmp4(isMuted ? 12755 : 10032) };
...
function OverlayObscureToggleButton(arg0) {
  ...
  obj = { left: true, right: true, children: tmp4(spoilerActive ? 12756 : 12757) };
  obj[3] = ThemesDefault.unsafe_rawColors.WHITE;
...
function MediaModalOverlay(getVideoControls) {
  ...
  obj.slider = videoControls(8520)(index, source, videoControls);
  obj.source = source;
...
let closure_13 = importAllResult.memo((arg0) => {
  ...
  if (null != slider) {
    ...
    items[2] = tmp16;
    obj[4] = items;
    let tmp21Result2 = closure_8(tmp2(5518).SafeAreaPaddingView, obj);
    const tmp11 = closure_8;
  } else {
    tmp21Result2 = null;
  }
  tmp2Result = tmp2(8534);
  ...
  if (!tmp7) {
    ...
    tmp21Result = tmp21(_modDef12765, obj4);
  }
  ...
  if (disableMediaOverlayFooter) {
    ...
    tmp21Result2 = tmp21(tmp2(5518).SafeAreaPaddingView, obj8);
    ...
    tmp21Result2 = tmp21(tmp2(12766).MediaModalOverlayFooter, obj9);
  }
  const obj10 = { children: null };
  items3[2] = tmp21Result2;
  obj3[1] = items3;
  items1[1] = closure_8(_modDef4186.View, obj3);
  obj10[0] = items1;
