...
// Dependencies: [32, 19, 17, 21, 4448, 712, 5521, 9029, 1236, 12790, 10055, 12791, 12792, 12793, 8543, 500, 4886, 12794, 8556, 12796, 4187, 12800, 8542, 12801, 12795, 8535, 8536, 2]
// Exports: default

// Module 12789 (OverlayMuteButton)
...
import nativeEventEmitter from "nativeEventEmitter" /* 8543 */;
import renderDefault from "render" /* 9029 */;
import useOverlayLayoutDriver from "useOverlayLayoutDriver" /* 12793 */;
import ObscuredViewDefault from "ObscuredView" /* 12794 */;
import MediaModalOverlayHeader from "MediaModalOverlayHeader" /* 12796 */;
import _modDef12800 from "module_12800" /* 12800 */;
...
function OverlayMuteButton(arg0) {
  ...
  obj = { left: true, right: true, children: tmp4(isMuted ? 12790 : 10055) };
...
function OverlayObscureToggleButton(arg0) {
  ...
  obj = { left: true, right: true, children: tmp4(spoilerActive ? 12791 : 12792) };
  obj[3] = ThemesDefault.unsafe_rawColors.WHITE;
...
function MediaModalOverlay(getVideoControls) {
  ...
  obj.slider = videoControls(8542)(index, source, videoControls);
  obj.source = source;
...
let closure_13 = importAllResult.memo((arg0) => {
  ...
  if (null != slider) {
    ...
    items[2] = tmp16;
    obj[4] = items;
    let tmp21Result2 = closure_8(tmp2(5521).SafeAreaPaddingView, obj);
    const tmp11 = closure_8;
  } else {
    tmp21Result2 = null;
  }
  tmp2Result = tmp2(8556);
  ...
  if (!tmp7) {
    ...
    tmp21Result = tmp21(_modDef12800, obj4);
  }
  ...
  if (disableMediaOverlayFooter) {
    ...
    tmp21Result2 = tmp21(tmp2(5521).SafeAreaPaddingView, obj8);
    ...
    tmp21Result2 = tmp21(tmp2(12801).MediaModalOverlayFooter, obj9);
  }
  const obj10 = { children: null };
  items3[2] = tmp21Result2;
  obj3[1] = items3;
  items1[1] = closure_8(_modDef4187.View, obj3);
  obj10[0] = items1;
