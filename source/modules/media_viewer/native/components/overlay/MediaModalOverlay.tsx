...
// Dependencies: [32, 19, 17, 21, 4193, 712, 5181, 8344, 1236, 12318, 10819, 12319, 12320, 12321, 8128, 500, 4594, 12322, 8141, 12324, 4054, 12329, 8127, 12330, 12323, 8120, 8121, 2]
// Exports: default
...
import jsxProd from "module_12329";
...
function OverlayObscureToggleButton(arg0) {
  ...
  obj = { left: true, right: true, children: null };
  obj[2] = importDefault(spoilerActive ? 12319 : 12320);
  obj[3] = importDefault(712).unsafe_rawColors.WHITE;
...
function MediaModalOverlay(getVideoControls) {
  ...
  obj.slider = videoControls(8127)(index, source, videoControls);
  obj.source = source;
...
let closure_13 = importAllResult.memo((arg0) => {
  ...
  let obj1 = require(12321) /* useOverlayLayoutDriver */;
  ...
  let obj2 = require(8128) /* nativeEventEmitter */;
  ...
  if (null != slider) {
    ...
    if (isIOSResult) {
      ...
      isIOSResult = callback2(importDefault(4594), obj);
    }
    ...
    if (syncer.sources.length > 1) {
      obj1 = { syncer: null };
      obj1[0] = syncer;
      tmp16 = callback2(importDefault(12322), obj1);
    }
    items[2] = tmp16;
    obj[4] = items;
    let tmp21Result2 = closure_8(tmp2(5181).SafeAreaPaddingView, obj);
  ...
  const items1 = [callback2(require(12324) /* MediaModalOverlayHeader */.MediaModalOverlayHeader, obj2), ];
  ...
  if (!tmp7) {
    ...
    tmp21Result = tmp21(importDefault(12329), obj4);
  }
  ...
  if (disableMediaOverlayFooter) {
    ...
    tmp21Result2 = tmp21(tmp2(5181).SafeAreaPaddingView, obj8);
    ...
    tmp21Result2 = tmp21(tmp2(12330).MediaModalOverlayFooter, obj9);
  }
  const obj10 = { children: null };
  items3[2] = tmp21Result2;
  obj3[1] = items3;
  items1[1] = closure_8(importDefault(4054).View, obj3);
  obj10[0] = items1;
