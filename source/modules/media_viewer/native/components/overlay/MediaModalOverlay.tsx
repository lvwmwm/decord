...
// Dependencies: [57, 31, 27, 33, 4130, 689, 5121, 8518, 1212, 12256, 10770, 12257, 12258, 12259, 8327, 477, 4533, 12260, 8340, 12262, 3991, 12267, 8326, 12268, 12261, 8319, 8320, 2]
// Exports: default

// Module 12255 (OverlayMuteButton)
...
function OverlayMuteButton(arg0) {
  ...
  obj.children = tmp3(importDefault(8518), obj);
...
function MediaModalOverlay(getVideoControls) {
  ...
  obj["slider"] = videoControls(8326)(index, source, videoControls);
  obj["source"] = source;
...
let closure_11 = importAllResult.memo((arg0) => {
  ...
  let obj1 = require(12259) /* useOverlayLayoutDriver */;
  ...
  let obj2 = require(8327) /* nativeEventEmitter */;
  ...
  if (null != slider) {
    ...
    if (syncer.sources.length > 1) {
      obj2 = { syncer };
      tmp17 = callback2(importDefault(12260), obj2);
    }
    items[2] = tmp17;
    obj.children = items;
  ...
  let obj8 = require(8340) /* MediaViewerDimensionsProvider */;
  const obj3 = {};
  const items1 = [callback2(require(12262) /* MediaModalOverlayHeader */.MediaModalOverlayHeader, { animationDriver: overlayLayoutDriver, disableDownload, disableMediaOverlayButton, source, shareable, contextName, contextIcon, onClose, channelId: source.channelId }), ];
  obj5 = { style: items2 };
  items2 = [tmp.portraitFooterButtons, footerLayoutAnimation];
  let tmp23 = !tmp5;
  if (tmp23) {
    const obj6 = { description: source.description };
    tmp23 = callback2(importDefault(12267), obj6);
  }
  const items3 = [tmp23, , ];
  if (null != slider) {
    ...
    if (tmp30) {
      obj8 = { isMuted: mediaPlayerMutedStore, onToggleMute: require(8326) /* useVideoControls */.toggleMuted };
  ...
  if (disableMediaOverlayFooter) {
    ...
    tmp9Result = callback2(require(12268) /* clamp */.MediaModalOverlayFooter, obj11);
  }
  items3[2] = tmp9Result;
