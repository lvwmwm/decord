...
// Dependencies: [32, 19, 17, 21, 4285, 712, 5311, 8980, 1236, 12152, 10815, 12153, 12154, 12155, 8775, 500, 4685, 12156, 8788, 12158, 4145, 12162, 8774, 12163, 12157, 8768, 8769, 2]
// Exports: default

// Module 12151 (OverlayMuteButton)
import _slicedToArray from "_slicedToArray";
import importAllResult from "MediaModalOverlayHeader";
import get_ActivityIndicator from "ObscuredView";
import jsxProd from "module_12162";
...
function OverlayObscureToggleButton(arg0) {
  ...
  obj = { left: true, right: true, children: null };
  obj[2] = importDefault(spoilerActive ? 12153 : 12154);
  obj[3] = importDefault(712).unsafe_rawColors.WHITE;
...
function MediaModalOverlay(getVideoControls) {
  ...
  obj.slider = videoControls(8774)(index, source, videoControls);
  obj.source = source;
...
let closure_13 = importAllResult.memo((arg0) => {
  ...
  const tmp = callback3();
  let obj = require(12155) /* useOverlayLayoutDriver */;
  const overlayLayoutDriver = obj.useOverlayLayoutDriver();
  let obj1 = require(12155) /* useOverlayLayoutDriver */;
  ...
  let obj2 = require(8775) /* nativeEventEmitter */;
  ...
  if (null != slider) {
    ...
    if (isIOSResult) {
      ...
      isIOSResult = callback2(importDefault(4685), obj);
    }
    ...
    if (syncer.sources.length > 1) {
      obj1 = { syncer: null };
      obj1[0] = syncer;
      tmp16 = callback2(importDefault(12156), obj1);
    }
    items[2] = tmp16;
    obj[4] = items;
    let tmp21Result2 = closure_8(tmp2(5311).SafeAreaPaddingView, obj);
    const tmp11 = closure_8;
  } else {
    tmp21Result2 = null;
  }
  tmp2Result = tmp2(8788);
  ...
  const items1 = [callback2(require(12158) /* MediaModalOverlayHeader */.MediaModalOverlayHeader, obj2), ];
  ...
  if (!tmp7) {
    ...
    tmp21Result = tmp21(importDefault(12162), obj4);
  }
  ...
  if (disableMediaOverlayFooter) {
    ...
    tmp21Result2 = tmp21(tmp2(5311).SafeAreaPaddingView, obj8);
    ...
    tmp21Result2 = tmp21(tmp2(12163).MediaModalOverlayFooter, obj9);
  }
  const obj10 = { children: null };
  items3[2] = tmp21Result2;
  obj3[1] = items3;
  items1[1] = closure_8(importDefault(4145).View, obj3);
  obj10[0] = items1;
