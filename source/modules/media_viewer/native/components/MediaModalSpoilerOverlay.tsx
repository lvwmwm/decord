...
export default require("result").memo(function MediaModalSpoilerOverlay(source) {
  ...
  if (!tmp3[0]) {
    ...
    const items1 = [callback2(importDefault(4534), obj), ];
    obj1 = { style: tmp.spoilerOverlayContainer };
    if (source.obscure) {
      const obj2 = { style: tmp.obscureContentContainer };
      const items2 = [callback2(require(4640) /* ImageWarningIcon */.ImageWarningIcon, { size: "lg", color: "white" }), ];
      ...
      tmp = callback2(require(4127) /* Text */.Text, obj3);
      items2[1] = tmp;
      ...
      obj4.children = callback2(require(4127) /* Text */.Text, obj5);
    ...
    items1[1] = obj1;
    obj.children = items1;
    callback3(importDefault(3992).View, obj);
    const tmp10 = importDefault(4534);
