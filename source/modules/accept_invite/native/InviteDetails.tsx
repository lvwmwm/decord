...
// Dependencies: [32, 19, 17, 11700, 1911, 1903, 676, 11992, 21, 4285, 712, 5140, 7116, 1297, 11934, 4123, 1236, 8361, 4281, 1416, 5251, 698, 589, 11993, 8880, 4695, 5132, 2]
// Exports: default

// Module 11991 (shouldShowInviter)
...
function InviteDestinationIcon(invite) {
  ...
  if (null != invite.guild) {
    ...
    obj[0] = tmp.avatar;
    obj[1] = invite.guild;
    obj[2] = importDefault(11934).Sizes.LARGE;
    tmp2Result = tmp2(importDefault(11934), obj);
    const tmp9 = importDefault(11934);
  }
}
function InviteHeader(invite) {
  invite = invite.invite;
  const tmp = createCacheKey();
  let obj = require(7116) /* InviteTypes */;
  ...
  if (tmp2Result.isFriendInvite(invite)) {
    ...
    obj = { username: null };
    obj[0] = importDefault(4123).getFormattedName(invite.inviter);
    name = intl.formatToPlainString(tmp2(1236).t["4aF92R"], obj);
    const obj5 = importDefault(4123);
  }
  let tmp9 = null;
  if (null != name) {
    ...
    const items = [callback2(importDefault(8361), obj1), ];
...
export default function InviteDetails(invite) {
  ...
  items2[4] = callback2(importDefault(11993), { invite, style: tmp.rolesList });
