...
// Dependencies: [32, 19, 17, 11666, 1882, 1874, 676, 11958, 21, 4255, 712, 5110, 7089, 1297, 11900, 4094, 1236, 8221, 4251, 1416, 5221, 698, 589, 11959, 8851, 4665, 5102, 2]
// Exports: default

// Module 11957 (shouldShowInviter)
...
function InviteDestinationIcon(invite) {
  ...
  if (null != invite.guild) {
    ...
    obj[0] = tmp.avatar;
    obj[1] = invite.guild;
    obj[2] = importDefault(11900).Sizes.LARGE;
    tmp2Result = tmp2(importDefault(11900), obj);
    const tmp9 = importDefault(11900);
  }
}
function InviteHeader(invite) {
  invite = invite.invite;
  const tmp = createCacheKey();
  let obj = require(7089) /* InviteTypes */;
  ...
  if (null != name) {
    ...
    const items = [callback2(importDefault(8221), obj1), ];
...
export default function InviteDetails(invite) {
  ...
  items2[4] = callback2(importDefault(11959), { invite, style: tmp.rolesList });
