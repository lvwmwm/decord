...
// Dependencies: [32, 19, 17, 11715, 1911, 1903, 676, 12007, 21, 4302, 712, 5157, 7135, 1297, 11949, 4140, 1236, 8378, 4298, 1416, 5267, 698, 589, 12008, 8897, 4712, 5149, 2]
// Exports: default

// Module 12006 (shouldShowInviter)
...
function InviteDestinationIcon(invite) {
  ...
  if (null != invite.guild) {
    ...
    obj[0] = tmp.avatar;
    obj[1] = invite.guild;
    obj[2] = importDefault(11949).Sizes.LARGE;
    tmp2Result = tmp2(importDefault(11949), obj);
    const tmp9 = importDefault(11949);
  }
}
function InviteHeader(invite) {
  invite = invite.invite;
  const tmp = createCacheKey();
  let obj = require(7135) /* InviteTypes */;
  ...
  if (tmp2Result.isFriendInvite(invite)) {
    ...
    obj = { username: null };
    obj[0] = importDefault(4140).getFormattedName(invite.inviter);
    name = intl.formatToPlainString(tmp2(1236).t["4aF92R"], obj);
    const obj5 = importDefault(4140);
  }
  let tmp9 = null;
  if (null != name) {
    ...
    const items = [callback2(importDefault(8378), obj1), ];
    ...
    if (!shouldShowInviter(invite, invite.isGuildMember)) {
      ...
      if (id !== closure_11) {
        ...
        if (null != tmp2.onlineCount) {
          ...
          items[1] = callback2(require(4298) /* Text */.Text, obj2);
          obj[0] = items;
        ...
        if (null != tmp2.memberCount) {
          ...
          items2[1] = callback2(require(4298) /* Text */.Text, obj6);
          obj4[0] = items2;
...
export default function InviteDetails(invite) {
  ...
  items2[4] = callback2(importDefault(12008), { invite, style: tmp.rolesList });
