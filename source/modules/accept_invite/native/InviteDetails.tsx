...
// Dependencies: [32, 19, 17, 11857, 1930, 1922, 676, 12155, 21, 4342, 712, 5220, 7262, 1297, 12097, 4187, 1236, 8509, 4338, 1435, 5329, 698, 589, 12156, 9020, 4777, 5212, 2]
// Exports: default

// Module 12154 (shouldShowInviter)
...
function InviteDestinationIcon(invite) {
  ...
  if (null != invite.guild) {
    ...
    obj[0] = tmp.avatar;
    obj[1] = invite.guild;
    obj[2] = importDefault(12097).Sizes.LARGE;
    tmp2Result = tmp2(importDefault(12097), obj);
    const tmp9 = importDefault(12097);
  }
}
function InviteHeader(invite) {
  invite = invite.invite;
  const tmp = createCacheKey();
  let obj = require(7262) /* InviteTypes */;
  ...
  if (tmp2Result.isFriendInvite(invite)) {
    ...
    obj = { username: null };
    obj[0] = importDefault(4187).getFormattedName(invite.inviter);
    name = intl.formatToPlainString(tmp2(1236).t["4aF92R"], obj);
    const obj5 = importDefault(4187);
  }
  let tmp9 = null;
  if (null != name) {
    ...
    const items = [callback2(importDefault(8509), obj1), ];
    ...
    if (!shouldShowInviter(invite, invite.isGuildMember)) {
      ...
      if (id !== closure_11) {
        ...
        if (null != tmp2.memberCount) {
          ...
          items2[1] = callback2(require(4338) /* Text */.Text, obj6);
          obj4[0] = items2;
...
export default function InviteDetails(invite) {
  ...
  items2[4] = callback2(importDefault(12156), { invite, style: tmp.rolesList });
