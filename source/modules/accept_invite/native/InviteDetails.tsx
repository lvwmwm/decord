...
// Dependencies: [32, 19, 17, 11781, 1911, 1903, 676, 12073, 21, 4303, 712, 5158, 7195, 1297, 12015, 4146, 1236, 8438, 4299, 1416, 5268, 698, 589, 12074, 8957, 4714, 5150, 2]
// Exports: default

// Module 12072 (shouldShowInviter)
...
function InviteDestinationIcon(invite) {
  ...
  if (null != invite.guild) {
    ...
    obj[0] = tmp.avatar;
    obj[1] = invite.guild;
    obj[2] = importDefault(12015).Sizes.LARGE;
    tmp2Result = tmp2(importDefault(12015), obj);
    const tmp9 = importDefault(12015);
  }
}
function InviteHeader(invite) {
  invite = invite.invite;
  const tmp = createCacheKey();
  let obj = require(7195) /* InviteTypes */;
  ...
  if (tmp2Result.isFriendInvite(invite)) {
    ...
    obj = { username: null };
    obj[0] = importDefault(4146).getFormattedName(invite.inviter);
    name = intl.formatToPlainString(tmp2(1236).t["4aF92R"], obj);
    const obj5 = importDefault(4146);
  }
  let tmp9 = null;
  if (null != name) {
    ...
    const items = [callback2(importDefault(8438), obj1), ];
...
export default function InviteDetails(invite) {
  ...
  items2[4] = callback2(importDefault(12074), { invite, style: tmp.rolesList });
