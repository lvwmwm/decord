...
// Module 15860 (AcceptInviteModal)
...
export default function AcceptInviteModal(arg0) {
  ...
  obj.screens = React.useMemo(() => function getScreens(deeplinkAttemptId) {
    let obj = {};
    obj = { type: "<string:1040334421>", text: "<string:1040334338>", impressionName: deeplinkAttemptId(closure_2[3]).ImpressionNames.INVITE_ACCEPT };
