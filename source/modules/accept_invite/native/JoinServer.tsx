...
// Function ID: 8617
// Name: OrSeparator
// Dependencies: [19, 17, 8617, 21, 4661, 712, 4734, 1236, 5441, 1500, 1494, 8575, 4745, 2]
// Exports: default

// Module 8616 (OrSeparator)
...
export default function JoinServer(arg0) {
  ...
  obj[1] = items1;
  let tmp7Result = null;
  if (importDefault(1494)().height > closure_6) {
  ...
  obj5[11] = onDone;
  items3[1] = callback(importDefault(8575), obj5);
  ...
  obj10[4] = submitting;
  obj10[5] = onDone;
  items5[1] = callback(navigation(4745).Button, obj10);
