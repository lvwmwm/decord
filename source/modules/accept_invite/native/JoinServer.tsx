...
// Function ID: 8318
// Name: OrSeparator
// Dependencies: [19, 17, 8318, 21, 4285, 712, 4281, 1236, 5310, 1480, 1474, 8276, 4695, 2]
// Exports: default

// Module 8317 (OrSeparator)
...
export default function JoinServer(arg0) {
  ...
  obj[0] = importDefault(5310)().insets.bottom + importDefault(712).space.PX_16;
  items1[1] = obj;
  obj[1] = items1;
  let tmp7Result = null;
  ...
  obj5[11] = onDone;
  items3[1] = callback(importDefault(8276), obj5);
  ...
  items3[2] = callback(navigation(4281).Text, obj6);
  obj4[0] = items3;
  ...
  obj10[4] = submitting;
  obj10[5] = onDone;
  items5[1] = callback(navigation(4695).Button, obj10);
  ...
  obj11[4] = callback;
  items5[3] = callback(navigation(4695).Button, obj11);
  obj8[0] = items5;
