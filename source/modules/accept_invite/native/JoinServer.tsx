...
// Function ID: 9232
// Name: OrSeparator
// Dependencies: [19, 17, 9232, 21, 4193, 712, 4189, 1236, 5219, 1480, 1474, 9004, 4604, 2]
// Exports: default
...
export default function JoinServer(arg0) {
  ...
  obj[0] = importDefault(5219)().insets.bottom + importDefault(712).space.PX_16;
  items1[1] = obj;
  obj[1] = items1;
  let tmp7Result = null;
  ...
  obj5[11] = onDone;
  items3[1] = callback(importDefault(9004), obj5);
  ...
  items3[2] = callback(navigation(4189).Text, obj6);
  obj4[0] = items3;
  ...
  obj10[4] = submitting;
  obj10[5] = onDone;
  items5[1] = callback(navigation(4604).Button, obj10);
  ...
  obj11[4] = callback;
  items5[3] = callback(navigation(4604).Button, obj11);
  obj8[0] = items5;
