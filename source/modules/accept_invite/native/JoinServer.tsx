...
// Function ID: 9405
// Name: OrSeparator
// Dependencies: [19, 17, 9405, 21, 4255, 712, 4251, 1236, 5281, 1480, 1474, 9181, 4666, 2]
// Exports: default

// Module 9404 (OrSeparator)
...
export default function JoinServer(arg0) {
  ...
  obj[0] = importDefault(5281)().insets.bottom + importDefault(712).space.PX_16;
  items1[1] = obj;
  obj[1] = items1;
  let tmp7Result = null;
  ...
  obj5[11] = onDone;
  items3[1] = callback(importDefault(9181), obj5);
  ...
  obj10[4] = submitting;
  obj10[5] = onDone;
  items5[1] = callback(navigation(4666).Button, obj10);
  ...
  obj11[4] = callback;
  items5[3] = callback(navigation(4666).Button, obj11);
  obj8[0] = items5;
