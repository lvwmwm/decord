...
// Function ID: 8730
// Name: OrSeparator
// Dependencies: [19, 17, 8730, 21, 4444, 712, 4440, 1236, 5541, 1500, 1494, 8690, 4879, 2]
// Exports: default

// Module 8729 (OrSeparator)
...
export default function JoinServer(arg0) {
  ...
  obj5[11] = onDone;
  items3[1] = callback(_modDef8690, obj5);
  ...
  items3[2] = callback(navigation(4440).Text, obj6);
  obj4[0] = items3;
  ...
  obj10[4] = submitting;
  obj10[5] = onDone;
  items5[1] = callback(navigation(4879).Button, obj10);
  ...
  obj11[4] = callback;
  items5[3] = callback(navigation(4879).Button, obj11);
  obj8[0] = items5;
