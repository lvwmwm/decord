...
// Function ID: 8290
// Name: OrSeparator
// Dependencies: [19, 17, 8290, 21, 4255, 712, 4251, 1236, 5295, 1480, 1474, 8248, 4665, 2]
// Exports: default

// Module 8289 (OrSeparator)
...
export default function JoinServer(arg0) {
  ...
  obj5[11] = onDone;
  items3[1] = callback(importDefault(8248), obj5);
  ...
  items3[2] = callback(navigation(4251).Text, obj6);
  obj4[0] = items3;
  ...
  obj10[4] = submitting;
  obj10[5] = onDone;
  items5[1] = callback(navigation(4665).Button, obj10);
  ...
  obj11[4] = callback;
  items5[3] = callback(navigation(4665).Button, obj11);
  obj8[0] = items5;
