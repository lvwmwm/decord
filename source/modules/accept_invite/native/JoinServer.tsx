...
// Function ID: 8447
// Name: OrSeparator
// Dependencies: [19, 17, 8447, 21, 4302, 712, 4298, 1236, 5368, 1480, 1474, 8405, 4712, 2]
// Exports: default

// Module 8446 (OrSeparator)
...
export default function JoinServer(arg0) {
  ...
  obj5[11] = onDone;
  items3[1] = callback(importDefault(8405), obj5);
  ...
  items3[2] = callback(navigation(4298).Text, obj6);
  obj4[0] = items3;
  ...
  obj10[4] = submitting;
  obj10[5] = onDone;
  items5[1] = callback(navigation(4712).Button, obj10);
  ...
  obj11[4] = callback;
  items5[3] = callback(navigation(4712).Button, obj11);
  obj8[0] = items5;
