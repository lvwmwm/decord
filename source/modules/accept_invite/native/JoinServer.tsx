...
// Function ID: 7686
// Name: OrSeparator
// Dependencies: [19, 17, 7686, 21, 4445, 712, 4441, 1236, 5546, 1500, 1494, 7637, 4880, 2]
// Exports: default

// Module 7685 (OrSeparator)
...
export default function JoinServer(arg0) {
  ...
  obj5[11] = onDone;
  items3[1] = callback(_modDef7637, obj5);
  ...
  items3[2] = callback(navigation(4441).Text, obj6);
  obj4[0] = items3;
  ...
  obj10[4] = submitting;
  obj10[5] = onDone;
  items5[1] = callback(navigation(4880).Button, obj10);
  ...
  obj11[4] = callback;
  items5[3] = callback(navigation(4880).Button, obj11);
  obj8[0] = items5;
