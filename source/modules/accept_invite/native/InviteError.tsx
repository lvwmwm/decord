...
// Dependencies: [19, 17, 676, 21, 4302, 712, 4147, 4238, 12010, 12011, 12012, 1236, 4298, 4712, 1416, 1297, 12013, 5719, 1974, 2]
// Exports: default

// Module 12009 (InviteErrorBase)
import "set";
...
function InviteErrorBase(invite) {
  ...
  const tmp4Result = importDefault(obj.isThemeDark(importDefault(4238)()) ? 12010 : 12011);
  let code;
  if (inviteError != null) {
    code = inviteError.code;
  }
  const descriptiveInviteError = require(12012) /* getDescriptiveInviteError */.getDescriptiveInviteError(code);
  ...
  items[2] = callback(require(4298) /* Text */.Text, { style: tmp.expiredBody, variant: "text-sm/medium", color: "text-default", children: stringResult });
...
function InviteDisabledError(onPressClose) {
  ...
  if (null == guild) {
    ...
    items[1] = callback(importDefault(5719), obj3);
    obj1[1] = items;
