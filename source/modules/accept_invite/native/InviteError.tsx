...
// Dependencies: [19, 17, 676, 21, 4344, 712, 1363, 4280, 12137, 12138, 12139, 1236, 4340, 4754, 1435, 1297, 12140, 5818, 1993, 2]
// Exports: default

// Module 12136 (InviteErrorBase)
import "set";
...
function InviteErrorBase(invite) {
  ...
  const tmp4Result = importDefault(obj.isThemeDark(importDefault(4280)()) ? 12137 : 12138);
  let code;
  if (inviteError != null) {
    code = inviteError.code;
  }
  const descriptiveInviteError = require(12139) /* getDescriptiveInviteError */.getDescriptiveInviteError(code);
  ...
  items[2] = callback(require(4340) /* Text */.Text, { style: tmp.expiredBody, variant: "text-sm/medium", color: "text-default", children: stringResult });
...
function InviteDisabledError(onPressClose) {
  ...
  if (null == guild) {
    ...
    items[1] = callback(importDefault(5818), obj3);
    obj1[1] = items;
