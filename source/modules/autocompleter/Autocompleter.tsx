...
// Dependencies: [6, 7, 6147, 6148, 1908, 3802, 1850, 5078, 5009, 22, 5081, 6149, 1331, 5082, 6151, 1832, 4149, 4154, 3864, 1443, 2]

// Module 6146 (_createForOfIteratorHelperLoose)
...
function getAutocompleterBoosterMap(USER, frecencyBoosters) {
  if (frecencyBoosters.frecencyBoosters) {
    let boosterMap = require(5009) /* _createForOfIteratorHelperLoose */.getBoosterMap(USER);
    const obj2 = require(5009) /* _createForOfIteratorHelperLoose */;
  } else {
    boosterMap = {};
  }
  return boosterMap;
