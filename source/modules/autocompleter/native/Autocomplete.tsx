...
// Dependencies: [19, 17, 1891, 3938, 1903, 676, 9850, 21, 4302, 712, 7907, 589, 4140, 1297, 9070, 5373, 5383, 1236, 8168, 4762, 4492, 4298, 5267, 11694, 9890, 4844, 9782, 12, 4332, 1884, 7887, 2]

// Module 11693 (AutocompleteLabel)
...
function AutocompleteLabel(text) {
  ...
  return callback(require(7907) /* Form */.FormRow.Label, { style: createCacheKey().leading, text: text.text });
}
...
const obj9 = {
  ...
  Global(arg0) {
    ...
    obj[2] = tmp2Result;
    obj[3] = closure_9(require(5383) /* TableRowTrailingText */.TableRowTrailingText, { text: description });
    return closure_9(require(5373) /* TableRowInner */.TableRow, obj);
  },
  Role(colorString) {
    let name;
    let onPress;
    ...
    items[1] = tmp5;
    obj[2] = closure_9(require(7907) /* Form */.FormRow.Label, obj);
    let str = "";
    if (showDescription) {
      const intl = tmp3(1236).intl;
      str = intl.string(tmp3(1236).t.HrUmDH);
    }
    obj[3] = closure_9(require(5383) /* TableRowTrailingText */.TableRowTrailingText, { text: str });
    return closure_9(require(5373) /* TableRowInner */.TableRow, obj);
  },
  Channel(onPress) {
    let category;
    ...
    if (channel.type === constants.GUILD_CATEGORY) {
      ...
      let obj = require(4762) /* getChannelIcon */;
    ...
    const channelName = require(4492) /* computeChannelName */.computeChannelName(channel, mergeGuildAvatar, upsertRelationship);
    ...
    obj1[3] = name;
    obj[4] = callback(require(4298) /* Text */.Text, obj1);
    return callback(require(7907) /* Form */.FormRow, obj);
  },
  Emoji(url) {
    let name;
    let onPress;
    ...
    return tmp2(require(7907) /* Form */.FormRow, obj1);
  },
  EmojiPremiumUpsell(arg0) {
    ...
    obj[2] = callback(importDefault(11694), { results });
    return callback(require(7907) /* Form */.FormRow, obj);
  },
  Choice(arg0) {
    let choice;
  ...
  Sticker(arg0) {
    ...
    let obj = require(9890) /* useStickerPackCategories */;
    ...
    obj[5] = callback(importDefault(9782), { sticker, size: 40, animated: shouldAnimateSticker });
  ...
  Game(game) {
    game = game.game;
    const tmp = createCacheKey();
    const tmp4 = importDefault(4332)(game.id, game.icon, { size: 32 });
    ...
    if (obj.isNullOrEmpty(tmp4)) {
      ...
      obj1[0] = tmp4;
      obj[1] = obj1;
      tmp6Result = tmp6(importDefault(5267), obj);
      tmp8 = tmp6;
    }
    ...
    return tmp8(require(7907) /* Form */.FormRow, obj2);
  }
};
