...
// Dependencies: [19, 17, 1862, 3892, 1874, 676, 9738, 21, 4255, 712, 7765, 589, 4094, 1297, 9612, 5286, 5296, 1236, 8026, 4716, 4446, 4251, 5207, 11610, 9779, 4783, 9794, 12, 4285, 1856, 7738, 2]

// Module 11609 (AutocompleteLabel)
...
function AutocompleteLabel(text) {
  ...
  return callback(require(7765) /* Form */.FormRow.Label, { style: createCacheKey().leading, text: text.text });
}
...
const obj9 = {
  User(user) {
    ...
    obj[5] = closure_9(guildId(9612), { user, usernameStyle: items1, discriminatorStyle: tmp.trailing });
    return closure_9(user(7765).FormRow, obj);
  },
  Global(arg0) {
    let badge;
    let description;
    ...
    obj[2] = tmp2Result;
    obj[3] = closure_9(require(5296) /* TableRowTrailingText */.TableRowTrailingText, { text: description });
    return closure_9(require(5286) /* TableRowInner */.TableRow, obj);
  },
  Role(colorString) {
    let name;
    let onPress;
    ...
    items[1] = tmp5;
    obj[2] = closure_9(require(7765) /* Form */.FormRow.Label, obj);
    let str = "";
    if (showDescription) {
      const intl = tmp3(1236).intl;
      str = intl.string(tmp3(1236).t.HrUmDH);
    }
    obj[3] = closure_9(require(5296) /* TableRowTrailingText */.TableRowTrailingText, { text: str });
    return closure_9(require(5286) /* TableRowInner */.TableRow, obj);
  },
  Channel(onPress) {
    let category;
    ...
    if (channel.type === constants.GUILD_CATEGORY) {
      ...
      let obj = require(4716) /* getChannelIcon */;
    ...
    const channelName = require(4446) /* computeChannelName */.computeChannelName(channel, mergeGuildAvatar, upsertRelationship);
  ...
  Emoji(url) {
    ...
    return tmp2(require(7765) /* Form */.FormRow, obj1);
  },
  EmojiPremiumUpsell(arg0) {
    ...
    obj[2] = callback(importDefault(11610), { results });
    return callback(require(7765) /* Form */.FormRow, obj);
  },
  Choice(arg0) {
    let choice;
  ...
  Sticker(arg0) {
    ...
    obj[5] = callback(importDefault(9794), { sticker, size: 40, animated: shouldAnimateSticker });
  ...
  Game(game) {
    ...
    if (obj.isNullOrEmpty(tmp4)) {
      ...
      obj[1] = tmp.gameIcon;
      let tmp6Result = tmp6(tmp5(7738).UnknownGameIcon, obj);
      let tmp8 = tmp6;
    } else {
      ...
      obj1[0] = tmp4;
      obj[1] = obj1;
      tmp6Result = tmp6(importDefault(5207), obj);
      tmp8 = tmp6;
    }
    ...
    return tmp8(require(7765) /* Form */.FormRow, obj2);
  }
};
