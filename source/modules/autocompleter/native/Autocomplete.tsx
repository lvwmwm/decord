...
// Dependencies: [19, 17, 1910, 4030, 1922, 676, 10177, 21, 4661, 712, 8083, 589, 4219, 1297, 9966, 6291, 6300, 1236, 8338, 6832, 4984, 4734, 5449, 11561, 10217, 5433, 10119, 12, 4507, 1903, 6683, 2]

// Module 11560 (AutocompleteLabel)
...
function AutocompleteLabel(text) {
  ...
  return callback(require(8083) /* Form */.FormRow.Label, { style: createCacheKey().leading, text: text.text });
}
...
const obj9 = {
  ...
  Global(arg0) {
    ...
    obj[2] = tmp2Result;
    obj[3] = closure_9(require(6300) /* TableRowTrailingText */.TableRowTrailingText, { text: description });
    return closure_9(require(6291) /* TableRowInner */.TableRow, obj);
  },
  Role(colorString) {
    let name;
    let onPress;
    ...
    items[1] = tmp5;
    obj[2] = closure_9(require(8083) /* Form */.FormRow.Label, obj);
    let str = "";
    if (showDescription) {
      const intl = tmp3(1236).intl;
      str = intl.string(tmp3(1236).t.HrUmDH);
    }
    obj[3] = closure_9(require(6300) /* TableRowTrailingText */.TableRowTrailingText, { text: str });
    return closure_9(require(6291) /* TableRowInner */.TableRow, obj);
  },
  Channel(onPress) {
    let category;
    ...
    if (channel.type === constants.GUILD_CATEGORY) {
      let channelIconWithGuild = importDefault(8338);
    } else {
    ...
    const channelName = require(4984) /* computeChannelName */.computeChannelName(channel, mergeGuildAvatar, markAllUserIdListsStale);
    ...
    obj1[3] = name;
    obj[4] = callback(require(4734) /* Text */.Text, obj1);
  ...
  Emoji(url) {
    ...
    if ("" !== url) {
      ...
      obj[0] = url;
      obj[1] = obj;
      let tmp5 = callback(importDefault(5449), obj);
      let tmp2 = callback;
    } else {
      tmp2 = callback;
    ...
    return tmp2(require(8083) /* Form */.FormRow, obj1);
  },
  EmojiPremiumUpsell(arg0) {
    ...
    obj[2] = callback(importDefault(11561), { results });
    return callback(require(8083) /* Form */.FormRow, obj);
  },
  Choice(arg0) {
    let choice;
  ...
  Sticker(arg0) {
    ...
    obj[5] = callback(importDefault(10119), { sticker, size: 40, animated: shouldAnimateSticker });
  ...
  Game(game) {
    game = game.game;
    const tmp = createCacheKey();
    const tmp4 = importDefault(4507)(game.id, game.icon, { size: 32 });
    ...
    if (obj.isNullOrEmpty(tmp4)) {
      ...
      obj1[0] = tmp4;
      obj[1] = obj1;
      tmp6Result = tmp6(importDefault(5449), obj);
      tmp8 = tmp6;
    }
    ...
    return tmp8(require(8083) /* Form */.FormRow, obj2);
  }
};
