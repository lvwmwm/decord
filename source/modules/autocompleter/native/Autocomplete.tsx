...
// Dependencies: [19, 17, 1891, 3921, 1903, 676, 9834, 21, 4285, 712, 7890, 589, 4123, 1297, 9053, 5354, 5364, 1236, 8151, 4745, 4475, 4281, 5251, 11679, 9874, 4827, 9766, 12, 4315, 1884, 7870, 2]

// Module 11678 (AutocompleteLabel)
...
function AutocompleteLabel(text) {
  ...
  return callback(require(7890) /* Form */.FormRow.Label, { style: createCacheKey().leading, text: text.text });
}
...
const obj9 = {
  ...
  Global(arg0) {
    ...
    obj[2] = tmp2Result;
    obj[3] = closure_9(require(5364) /* TableRowTrailingText */.TableRowTrailingText, { text: description });
    return closure_9(require(5354) /* TableRowInner */.TableRow, obj);
  },
  Role(colorString) {
    let name;
    let onPress;
    ...
    items[1] = tmp5;
    obj[2] = closure_9(require(7890) /* Form */.FormRow.Label, obj);
    let str = "";
    if (showDescription) {
      const intl = tmp3(1236).intl;
      str = intl.string(tmp3(1236).t.HrUmDH);
    }
    obj[3] = closure_9(require(5364) /* TableRowTrailingText */.TableRowTrailingText, { text: str });
    return closure_9(require(5354) /* TableRowInner */.TableRow, obj);
  },
  Channel(onPress) {
    let category;
    ...
    if (channel.type === constants.GUILD_CATEGORY) {
      let channelIconWithGuild = importDefault(8151);
    } else {
    ...
    return callback(require(7890) /* Form */.FormRow, obj);
  },
  Emoji(url) {
    let name;
    let onPress;
    ...
    if ("" !== url) {
      ...
      obj[0] = url;
      obj[1] = obj;
      let tmp5 = callback(importDefault(5251), obj);
      let tmp2 = callback;
    } else {
      tmp2 = callback;
    ...
    return tmp2(require(7890) /* Form */.FormRow, obj1);
  },
  EmojiPremiumUpsell(arg0) {
    ...
    obj[2] = callback(importDefault(11679), { results });
    return callback(require(7890) /* Form */.FormRow, obj);
  },
  Choice(arg0) {
    let choice;
  ...
  Sticker(arg0) {
    ...
    let obj = require(9874) /* useStickerPackCategories */;
    ...
    obj[5] = callback(importDefault(9766), { sticker, size: 40, animated: shouldAnimateSticker });
  ...
  Game(game) {
    ...
    if (obj.isNullOrEmpty(tmp4)) {
      ...
      obj1[0] = tmp4;
      obj[1] = obj1;
      tmp6Result = tmp6(importDefault(5251), obj);
      tmp8 = tmp6;
    }
    ...
    return tmp8(require(7890) /* Form */.FormRow, obj2);
  }
};
