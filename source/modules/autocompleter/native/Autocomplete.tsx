...
const obj9 = {
  ...
  Global(arg0) {
    ...
    obj[2] = tmp2Result;
    obj[3] = closure_9(require(5384) /* TableRowTrailingText */.TableRowTrailingText, { text: description });
    return closure_9(require(5374) /* TableRowInner */.TableRow, obj);
  },
  Role(colorString) {
    let name;
    let onPress;
    ...
    obj[3] = closure_9(require(5384) /* TableRowTrailingText */.TableRowTrailingText, { text: str });
    return closure_9(require(5374) /* TableRowInner */.TableRow, obj);
  },
  Channel(onPress) {
    let category;
  ...
  Game(game) {
    ...
    if (obj.isNullOrEmpty(tmp4)) {
      ...
      obj1[0] = tmp4;
      obj[1] = obj1;
      tmp6Result = tmp6(importDefault(5268), obj);
      tmp8 = tmp6;
    }
