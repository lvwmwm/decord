...
// Dependencies: [19, 17, 1862, 3826, 1874, 676, 9576, 21, 4189, 712, 7631, 589, 4028, 1297, 9450, 5220, 5230, 1236, 7900, 4650, 4380, 4185, 5141, 11482, 9616, 4717, 9632, 12, 4219, 1856, 11483, 2]

// Module 11481 (AutocompleteLabel)
...
function AutocompleteLabel(text) {
  ...
  return callback(require(7631) /* Form */.FormRow.Label, { style: createCacheKey().leading, text: text.text });
}
...
const obj9 = {
  User(user) {
    ...
    if (nick == null) {
      nick = guildId(4028).getName(user);
      const obj3 = guildId(4028);
    }
    ...
    obj[5] = closure_9(guildId(9450), { user, usernameStyle: items1, discriminatorStyle: tmp.trailing });
    return closure_9(user(7631).FormRow, obj);
  },
  Global(arg0) {
    let badge;
    let description;
    ...
    obj[2] = tmp2Result;
    obj[3] = closure_9(require(5230) /* TableRowTrailingText */.TableRowTrailingText, { text: description });
    return closure_9(require(5220) /* TableRowInner */.TableRow, obj);
  },
  Role(colorString) {
    let name;
    let onPress;
    ...
    items[1] = tmp5;
    obj[2] = closure_9(require(7631) /* Form */.FormRow.Label, obj);
    let str = "";
    if (showDescription) {
      const intl = tmp3(1236).intl;
      str = intl.string(tmp3(1236).t.HrUmDH);
    }
    obj[3] = closure_9(require(5230) /* TableRowTrailingText */.TableRowTrailingText, { text: str });
    return closure_9(require(5220) /* TableRowInner */.TableRow, obj);
  },
  Channel(onPress) {
    let category;
    ...
    if (channel.type === constants.GUILD_CATEGORY) {
      ...
      let obj = require(4650) /* getChannelIcon */;
    ...
    const channelName = require(4380) /* computeChannelName */.computeChannelName(channel, mergeGuildAvatar, upsertRelationship);
    ...
    return callback(require(7631) /* Form */.FormRow, obj);
  },
  Emoji(url) {
    let name;
    let onPress;
    ...
    if ("" !== url) {
      ...
      obj[0] = url;
      obj[1] = obj;
      let tmp5 = callback(importDefault(5141), obj);
      let tmp2 = callback;
    } else {
      tmp2 = callback;
    ...
    return tmp2(require(7631) /* Form */.FormRow, obj1);
  },
  EmojiPremiumUpsell(arg0) {
    ...
    obj[2] = callback(importDefault(11482), { results });
    return callback(require(7631) /* Form */.FormRow, obj);
  },
  Choice(arg0) {
    let choice;
  ...
  Sticker(arg0) {
    ...
    obj[5] = callback(importDefault(9632), { sticker, size: 40, animated: shouldAnimateSticker });
  ...
  Game(game) {
    game = game.game;
    const tmp = createCacheKey();
    const tmp4 = importDefault(4219)(game.id, game.icon, { size: 32 });
    let obj = require(1856) /* isNullOrEmpty */;
    if (obj.isNullOrEmpty(tmp4)) {
      obj = { size: "sm", style: null };
      obj[1] = tmp.gameIcon;
      let tmp6Result = tmp6(tmp5(11483).UnknownGameIcon, obj);
      let tmp8 = tmp6;
    } else {
      ...
      obj1[0] = tmp4;
      obj[1] = obj1;
      tmp6Result = tmp6(importDefault(5141), obj);
      tmp8 = tmp6;
    }
    ...
    return tmp8(require(7631) /* Form */.FormRow, obj2);
  }
};
