...
// Dependencies: [5, 1218, 1990, 1910, 5281, 5282, 676, 3977, 698, 4538, 709, 530, 1403, 2]
// Exports: loadOnboardingPrompts, maybeFetchOnboardingPrompts

// Module 5280 (fetchOnboardingPrompts)
...
function _trackOnboardingDirectJoin(guildId) {
  ...
  const merged1 = Object.assign(require(4538) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(guildId));
  obj.step = c16;
  obj.skipped = false;
