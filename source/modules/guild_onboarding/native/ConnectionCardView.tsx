...
// Dependencies: [19, 17, 21, 4302, 712, 4298, 1236, 4263, 4712, 2]
// Exports: default

// Module 5683 (ConnectionCardView)
import "noop";
...
export default function ConnectionCardView(description) {
  ...
  const items1 = [callback(require(4298) /* Text */.Text, { variant: "text-md/medium", color: "text-strong", children: displayName }), ];
