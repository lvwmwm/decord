...
// Dependencies: [19, 17, 5215, 1910, 4356, 4167, 5281, 5282, 676, 1925, 4540, 21, 4344, 712, 5275, 1364, 4280, 589, 11082, 11083, 1297, 1236, 4340, 5288, 5394, 5765, 5787, 1628, 11084, 5280, 5292, 5286, 5399, 1435, 1370, 4065, 4083, 4345, 11085, 4312, 5404, 2007, 4886, 5757, 5395, 2]
// Exports: default

// Module 11081 (EmptyCustomizeCommunity)
...
function EmptyCustomizeCommunity(setTab) {
  ...
  obj = { style: tmp.emptyContainerImage, source: importDefault(obj.isThemeDark(importDefault(4280)()) ? 11082 : 11083) };
...
function PromptTitle(item) {
  ...
  if (item.required) {
    ...
    obj[2] = [" ", "*"];
    tmp3Result = tmp3(require(4340) /* Text */.Text, obj);
  }
  items[1] = tmp3Result;
  obj[1] = closure_17(require(4340) /* Text */.Heading, { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: items });
...
function DropdownOption(option) {
  ...
  if (tmp10Result) {
    ...
    obj1[3] = str;
    obj[1] = callback(importDefault(5399), obj1);
    tmp10Result = tmp10(tmp9, obj);
    tmp11 = importDefault;
    const tmp12 = importDefault(5399);
  }
