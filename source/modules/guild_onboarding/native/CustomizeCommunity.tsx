...
// Dependencies: [19, 17, 5216, 1910, 4357, 4165, 5282, 5283, 676, 1925, 4541, 21, 4342, 712, 5276, 1364, 4278, 589, 10997, 10998, 1297, 1236, 4338, 5289, 5395, 5766, 5788, 1628, 10999, 5281, 5293, 5287, 5400, 1435, 1370, 4065, 4083, 4343, 11000, 4310, 5405, 2007, 4887, 5758, 5396, 2]
// Exports: default

// Module 10996 (EmptyCustomizeCommunity)
...
function EmptyCustomizeCommunity(setTab) {
  ...
  obj = { style: tmp.emptyContainerImage, source: importDefault(obj.isThemeDark(importDefault(4278)()) ? 10997 : 10998) };
...
function PromptTitle(item) {
  ...
  if (item.required) {
    ...
    obj[2] = [" ", "*"];
    tmp3Result = tmp3(require(4338) /* Text */.Text, obj);
  }
  items[1] = tmp3Result;
  obj[1] = closure_17(require(4338) /* Text */.Heading, { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: items });
