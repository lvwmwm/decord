...
// Dependencies: [32, 19, 17, 1910, 5286, 21, 4661, 712, 647, 7296, 8799, 1236, 10096, 10742, 10748, 9930, 2]
// Exports: default

// Module 10741 (ChannelsAndRolesScreen)
...
export default function ChannelsAndRolesModal(arg0) {
  ...
  const tmp2 = importDefault(7296)(stateFromStores);
  ...
  return tmp3(importDefault(9930), obj);
};
