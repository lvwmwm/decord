...
// Dependencies: [19, 17, 5114, 5181, 1877, 21, 4255, 647, 5272, 1416, 1297, 1236, 4251, 5278, 1581, 4223, 5308, 5309, 5311, 4666, 2]
// Exports: default

// Module 5277 (DropdownOptionRow)
...
export default function DropdownOptionsActionSheet(arg0) {
  ...
  if (null == stateFromStores) {
    ...
    obj[1] = callback(tmp3(5308).BottomSheetTitleHeader, obj);
    ...
    obj4[1] = callback(tmp3(4666).Button, obj5);
    items2[1] = callback(closure_4, obj4);
    obj1[1] = items2;
    obj[2] = callback2(tmp3(5311).BottomSheetScrollView, obj1);
    return callback(tmp3(5309).BottomSheet, obj);
  }
  tmp = callback3();
};
