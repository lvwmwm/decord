...
// Dependencies: [1372, 4949, 1932, 1862, 3883, 5196, 676, 3871, 589, 1384, 4745, 5197, 3888, 1351, 643, 1856, 5203, 2]
...
// Module 5202 (isChattableChannel)
...
function isChattableChannel(guild_id) {
  ...
  if (tmp) {
    const canChannelBeDefaultResult = require(5197) /* useCanChannelBeDefault */.canChannelBeDefault(guild_id.guild_id, guild_id.id);
    ...
    const obj = require(5197) /* useCanChannelBeDefault */;
  }
  return tmp;
}
function getFlattenedDefaultChannels(closure_0, arr, arg2, fn) {
  ...
  while (iter !== undefined) {
    ...
    let obj2 = require(5197) /* useCanChannelBeDefault */;
...
export const isChattableChannelId = function isChattableChannelId(arg0) {
  ...
  if (tmp) {
    const canChannelBeDefaultResult = require(5197) /* useCanChannelBeDefault */.canChannelBeDefault(channel.guild_id, channel.id);
    if (!canChannelBeDefaultResult) {
      tmp = canChannelBeDefaultResult;
    } else {
    ...
    const obj2 = require(5197) /* useCanChannelBeDefault */;
  }
  return tmp;
};
