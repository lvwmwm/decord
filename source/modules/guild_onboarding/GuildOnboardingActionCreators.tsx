...
// Dependencies: [5, 32, 1934, 1372, 1942, 1874, 5195, 676, 3871, 4451, 530, 709, 1208, 5201, 12, 5202, 1351, 5205, 698, 4449, 5206, 11, 1384, 5209, 5216, 2]

// Module 5200 (_updateOnboardingResponses)
...
obj[2] = function updateRolesLocal(guildId, items2, differenceResult1) {
  ...
  if (initialize.isViewingRoles(guildId)) {
    const obj5 = require(5201) /* updateImpersonating */;
