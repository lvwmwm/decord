...
// Dependencies: [5, 32, 1963, 1372, 1971, 1903, 5225, 676, 3900, 4481, 530, 709, 1208, 5231, 12, 5232, 1351, 5235, 698, 4479, 5236, 11, 1384, 5239, 5246, 2]

// Module 5230 (_updateOnboardingResponses)
...
obj[2] = function updateRolesLocal(guildId, items2, differenceResult1) {
  ...
  if (initialize.isViewingRoles(guildId)) {
    const obj5 = require(5231) /* updateImpersonating */;
