...
// Dependencies: [19, 17, 4402, 21, 4189, 712, 4185, 4600, 9007, 1236, 9694, 9688, 9695, 2]
// Exports: getMediaEmptyStateComponentOrNull

// Module 9693 (MediaKeyboardEmptyState)
import "noop";
...
export const getMediaEmptyStateComponentOrNull = function getMediaEmptyStateComponentOrNull(photosEmpty) {
    ...
    if (photoPermissionStatus !== tmp3.RESTRICTED) {
      if (photosEmpty.photosEmpty) {
        if (photoPermissionStatus === tmp3.LIMITED) {
          ...
          obj[0] = callback(require(9007) /* SettingsIcon */.SettingsIcon, { color: "white", size: "sm" });
          const intl3 = require(1236) /* getSystemLocale */.intl;
          obj[1] = intl3.string(require(1236) /* getSystemLocale */.t.JuXTi6);
          obj[2] = tmp2;
          obj[3] = importDefault(9694);
          ...
          obj[0] = callback(require(9688) /* CameraIcon */.CameraIcon, { color: "white", size: "sm" });
          const intl = require(1236) /* getSystemLocale */.intl;
          obj[1] = intl.string(require(1236) /* getSystemLocale */.t.tpoWUd);
          obj[2] = tmp;
          obj[3] = importDefault(9695);
  ...
  obj = { actionIcon: callback(require(9007) /* SettingsIcon */.SettingsIcon, { color: "white", size: "sm" }), actionLabel: null, actionPress: null, imageSource: null, label: null };
