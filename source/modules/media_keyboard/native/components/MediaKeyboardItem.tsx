...
// Function ID: 10022
// Name: NewCaption
// Dependencies: [19, 17, 4639, 10022, 21, 4036, 4303, 712, 4151, 1297, 9966, 4299, 589, 4858, 10023, 1236, 4890, 4860, 8841, 10024, 4304, 1474, 10025, 4815, 9790, 2]
// Exports: isAttachFilesNode, isMediaCameraNode, isSpecialMediaGridNode, isViewAllPhotosNode

// Module 10021 (NewCaption)
...
const memoResult = importAllResult.memo((arg0) => {
  ...
  obj = { text: require(1236) /* getSystemLocale */.t.uje3P9, onPress: handleCameraPress, Icon: require(10025) /* CameraIcon */.CameraIcon };
  obj[0] = obj;
  obj = { text: require(1236) /* getSystemLocale */.t.Zmm6dN, onPress: handleViewAllPhotosPress, Icon: require(4815) /* ImageIcon */.ImageIcon };
  obj[1] = obj;
  const tmp = obj();
  obj[2] = { text: require(1236) /* getSystemLocale */.t["8Hvr3+"], onPress: handleAttachPress, Icon: require(9790) /* AttachmentIcon */.AttachmentIcon };
  let obj1 = { text: require(1236) /* getSystemLocale */.t["8Hvr3+"], onPress: handleAttachPress, Icon: require(9790) /* AttachmentIcon */.AttachmentIcon };
