// Module ID: 10233
// Function ID: 10234
// Dependencies: [19, 17, 21, 4444, 712, 500, 4263, 689, 4165, 1629, 1367, 4891, 5015, 4440, 2]
...
const memoResult = importAllResult.memo(function MediaKeyboardBottomSheetActions(onHeightChange) {
  ...
  closure_4 = undefined;
  let obj = onHeightChange(4263);
  const gradientValue = obj.useGradientValue(onHeightChange(4263).GradientPercentage.END);
  let hexResult = null;
  ...
  obj1[1] = callback(closure_5, {
    ...
    children: overflowButtons.map((accessibilityLabel) => {
      ...
      items[1] = closure_1_6(onHeightChange(4440).Text, obj);
      obj[6] = items;
      return closure_1_7(onHeightChange(5015).PressableOpacity, obj, arg1);
    })
  });
