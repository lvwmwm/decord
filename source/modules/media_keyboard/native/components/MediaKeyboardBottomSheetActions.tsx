// Module ID: 10062
// Function ID: 10063
// Dependencies: [19, 17, 21, 4344, 712, 500, 4164, 689, 4065, 1628, 1367, 4765, 4886, 4340, 2]
...
const memoResult = importAllResult.memo(function MediaKeyboardBottomSheetActions(onHeightChange) {
  ...
  const items2 = [callback(importDefault(4765), obj), ];
  obj1 = { style: tmp9Result.container, children: null };
  const tmp6Result = importDefault(4765);
