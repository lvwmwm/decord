// Module ID: 10020
// Function ID: 10021
// Dependencies: [19, 17, 1623, 21, 4303, 712, 8397, 1367, 8738, 1236, 8669, 2]
...
const memoResult = require("noop").memo(function MediaKeyboardBottomSheetHandle(onPress) {
  ...
  if (tmp5) {
    ...
    obj[1] = stringResult;
    obj[2] = null == onPress;
    let tmp8Result = tmp8(require(8669) /* TwinButtons */.ActionSheetDragHandle, obj);
  } else {
