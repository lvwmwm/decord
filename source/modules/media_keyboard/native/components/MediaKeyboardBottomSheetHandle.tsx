// Module ID: 9932
// Function ID: 9933
// Dependencies: [19, 17, 1604, 21, 4285, 712, 8314, 1348, 8655, 1236, 8586, 2]
...
const memoResult = require("noop").memo(function MediaKeyboardBottomSheetHandle(onPress) {
  ...
  const tmp = callback();
  let obj = require(8314) /* useGradientBottom */;
  const gradientBottom = obj.useGradientBottom();
  let obj1 = require(8655) /* map */;
  ...
  if (tmp5) {
    ...
    obj[1] = stringResult;
    obj[2] = null == onPress;
    let tmp8Result = tmp8(require(8586) /* TwinButtons */.ActionSheetDragHandle, obj);
  } else {
