// Module ID: 10061
// Function ID: 10062
// Dependencies: [19, 17, 1623, 21, 4344, 712, 8436, 1367, 8777, 1236, 8708, 2]
...
const memoResult = require("noop").memo(function MediaKeyboardBottomSheetHandle(onPress) {
  ...
  const tmp = callback();
  let obj = require(8436) /* useGradientBottom */;
  const gradientBottom = obj.useGradientBottom();
  let obj1 = require(8777) /* map */;
  ...
  if (tmp5) {
    ...
    obj[1] = stringResult;
    obj[2] = null == onPress;
    let tmp8Result = tmp8(require(8708) /* TwinButtons */.ActionSheetDragHandle, obj);
  } else {
