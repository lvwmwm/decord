...
export const showMediaKeyboardActionSheet = function showMediaKeyboardActionSheet(arg0) {
  importDefault(4223).openLazy(require(1959) /* asyncRequireImpl */(9833, dependencyMap.paths), MEDIA_KEYBOARD_ACTION_SHEET, arg0);
};
