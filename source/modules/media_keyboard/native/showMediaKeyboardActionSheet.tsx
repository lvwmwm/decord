...
export const hideMediaKeyboardActionSheet = function hideMediaKeyboardActionSheet() {
  importDefault(4270).hideActionSheet(MEDIA_KEYBOARD_ACTION_SHEET);
};
export const showMediaKeyboardActionSheet = function showMediaKeyboardActionSheet(arg0) {
  importDefault(4270).openLazy(require(1988) /* asyncRequireImpl */(9944, dependencyMap.paths), MEDIA_KEYBOARD_ACTION_SHEET, arg0);
};
