...
export const showMediaKeyboardActionSheet = function showMediaKeyboardActionSheet(arg0) {
  importDefault(4271).openLazy(require(2007) /* asyncRequireImpl */(10016, dependencyMap.paths), MEDIA_KEYBOARD_ACTION_SHEET, arg0);
};
