...
// Dependencies: [16756, 2]
// Exports: installRNGHMountReactionsBridge

// Module 16755 (installRNGHMountReactionsBridge)
let c3 = false;
...
export const installRNGHMountReactionsBridge = function installRNGHMountReactionsBridge() {
  if (!c3) {
    const RNGHMountReactionsEffectExperiment = require(16756) /* RNGHMountReactionsEffectExperiment */.RNGHMountReactionsEffectExperiment;
