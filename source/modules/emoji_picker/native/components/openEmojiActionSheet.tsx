...
// Dependencies: [1877, 1416, 1844, 4157, 9409, 1959, 2]
// Exports: openEmojiActionSheet

// Module 9408 (openEmojiActionSheet)
...
export const openEmojiActionSheet = function openEmojiActionSheet(uniqueName) {
  if (null != uniqueName.uniqueName) {
    ...
    if (null == uniqueName.id) {
      ...
      obj = { emojiNode: null };
      obj[0] = obj;
      obj6.openLazy(require(1959) /* asyncRequireImpl */(9409, dependencyMap.paths), "MessageEmojiActionSheet", obj, "stack");
    }
