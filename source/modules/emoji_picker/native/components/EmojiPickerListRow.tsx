...
function EmojiItemLockedOverlay() {
  const tmp = callback2();
  obj = { style: tmp.lockContainer, children: callback(require(4709) /* LockIcon */.LockIcon, obj) };
  obj = { style: tmp.lock };
...
function EmojiItem(emoji) {
  ...
  if (null != emoji.id) {
    ...
    items1[1] = disabled;
    obj[5] = items1;
    return closure_8(emoji(4717).PressableOpacity, obj);
  }
}
