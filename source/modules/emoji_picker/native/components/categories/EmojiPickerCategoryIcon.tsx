// Module ID: 9408
// Function ID: 73253
// Dependencies: [31, 5030, 33, 6628, 9395, 4129, 6555, 9409, 9411, 8911, 9413, 9415, 8647, 9417, 6606, 2]
...
const memoResult = require("result").memo(function EmojiPickerCategoryIcon(id) {
  ...
  if (EmojiCategories.TOP_GUILD_EMOJI === id) {
    ...
    return jsx(require(8911) /* GameControllerIcon */.GameControllerIcon, {});
    ...
    return jsx(require(8647) /* HeartIcon */.HeartIcon, {});
    ...
    return jsx(require(6606) /* NitroWheelIcon */.NitroWheelIcon, {});
  }
});
