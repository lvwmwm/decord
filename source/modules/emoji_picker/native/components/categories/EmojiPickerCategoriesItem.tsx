...
const obj4 = { aze: null, azj: 1, tintColor: importDefault(dependencyMap[7]).colors.TEXT_DEFAULT };
obj.lock = obj4;
...
const obj3 = { backgroundColor: importDefault(dependencyMap[7]).colors.BACKGROUND_BASE_LOW, borderRadius: importDefault(dependencyMap[7]).radii.round };
