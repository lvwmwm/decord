...
// Function ID: 8649
// Name: NSFWRow
// Dependencies: [19, 17, 8580, 21, 4302, 712, 1297, 8198, 4298, 1236, 8646, 2]
...
const memoResult1 = importAllResult.memo((useTier0UpsellContent) => {
  ...
  if (isSectionNitroLocked) {
    ...
    isSectionNitroLocked = callback(require(8646) /* PremiumUpsellGradientBackground */.PremiumUpsellGradientBackground, obj);
  }
  ...
  if ("" !== label) {
    ...
    obj[3] = label;
    tmp6 = callback(require(4298) /* Text */.Text, obj);
  }
  items[1] = tmp6;
  obj[1] = items;
