...
// Function ID: 8709
// Name: NSFWRow
// Dependencies: [19, 17, 8640, 21, 4303, 712, 1297, 8258, 4299, 1236, 8706, 2]
...
const memoResult1 = importAllResult.memo((useTier0UpsellContent) => {
  ...
  if (isSectionNitroLocked) {
    ...
    isSectionNitroLocked = callback(require(8706) /* PremiumUpsellGradientBackground */.PremiumUpsellGradientBackground, obj);
  }
