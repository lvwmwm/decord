...
let obj = { container: { flex: 1 }, list: { "Bool(false)": null, "Bool(false)": null } };
obj = { marginLeft: false, marginRight: false, padding: false, paddingTop: importDefault(dependencyMap[6]).space.PX_8, gap: importDefault(dependencyMap[6]).space.PX_12 };
obj.header = obj;
