...
// Dependencies: [19, 5158, 1891, 5137, 1903, 5162, 676, 1906, 1338, 1905, 514, 8565, 4479, 8566, 8568, 8569, 589, 1926, 8570, 1236, 3929, 3925, 698, 12, 687, 1355, 2]
...
export const initializeSearch = function initializeSearch(location) {
  ...
  const EmojiPickerStore = require(8565) /* withEqualityFn */.EmojiPickerStore;
...
export const useEmojiCategories = function useEmojiCategories(CHAT, channel, guildId) {
  ...
  const result = _require(8566).maybeFetchTopEmojisByGuild(tmp);
  ...
  ({ topEmojis, newlyAddedEmojis } = importDefault(8568)(tmp, CHAT));
  allEmojis = importDefault(8569)({ topEmojis, newlyAddedEmojis }).allEmojis;
  let tmp12 = importDefault(8568)(tmp, CHAT);
  const items3 = [c4];
  const items4 = [tmp];
  ...
  soundmojiEmojiPickerSectionExperiment = _require(8570).useSoundmojiEmojiPickerSectionExperiment({ location: "useEmojiCategories" });
...
export const getUnicodeEmojiCategories = function getUnicodeEmojiCategories() {
  const categories = importDefault(3925).getCategories();
