...
// Dependencies: [19, 5128, 1862, 5107, 1874, 5132, 676, 1877, 1338, 1876, 514, 8536, 4449, 8537, 8539, 8540, 589, 1897, 8541, 1236, 3900, 3896, 698, 12, 687, 1355, 2]
...
export const initializeSearch = function initializeSearch(location) {
  ...
  const EmojiPickerStore = require(8536) /* withEqualityFn */.EmojiPickerStore;
  ...
  importDefault(4449).trackWithMetadata(constants4.SEARCH_OPENED, { search_type: EMOJI, load_id: replaced, location: location.location });
};
export const useEmojiCategories = function useEmojiCategories(CHAT, channel, guildId) {
  ...
  const result = _require(8537).maybeFetchTopEmojisByGuild(tmp);
  ...
  ({ topEmojis, newlyAddedEmojis } = importDefault(8539)(tmp, CHAT));
  allEmojis = importDefault(8540)({ topEmojis, newlyAddedEmojis }).allEmojis;
  let tmp12 = importDefault(8539)(tmp, CHAT);
  const items3 = [c4];
  const items4 = [tmp];
  ...
  soundmojiEmojiPickerSectionExperiment = _require(8541).useSoundmojiEmojiPickerSectionExperiment({ location: "useEmojiCategories" });
