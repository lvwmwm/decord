...
// Dependencies: [5, 19, 17, 8305, 1932, 11561, 676, 21, 4189, 712, 589, 11566, 3889, 698, 11569, 11570, 8348, 7265, 1236, 8304, 4731, 6895, 4197, 4157, 1231, 7387, 11571, 5535, 6885, 4185, 4600, 4717, 5551, 1297, 2]
// Exports: default

// Module 11568 (GuildProgressHeader)
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              let base64 = tmp2;
              base64 = undefined;
              outer1_1(8304).init(outer1_5);
              const obj6 = outer1_1(8304);
              outer1_0(11566).hideActionSheet(outer1_0.id);
              const obj7 = outer1_0(11566);
              const obj1 = { size: null };
              obj1[0] = outer1_10;
              dependencyMap = 1;
              c3 = 1;
              const obj2 = { value: null, done: false };
              obj2[0] = outer1_1(4731).openImagePicker(obj1);
              return obj2;
            }
          } else if (arg0 === 1) {
            c3 = 3;
