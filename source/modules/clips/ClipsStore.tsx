...
// Dependencies: [6, 7, 15, 17, 18, 5, 4185, 1194, 4219, 653, 4220, 3776, 4221, 4222, 44, 4223, 4229, 1360, 4232, 4233, 566, 4212, 686, 2]
...
let items = [
  ...
  (clipsSettings) => {
    ...
    const _default = require(4212) /* _isNativeReflectConstruct */.default;
    if (null != _default) {
...
obj = {
  ...
  CLIPS_SAVE_CLIP_NO_OP: function handleSaveClipNoOp(reason) {
    ...
    let tmp = reason !== require(4222) /* getClipCropAspectRatio */.ClipsSaveNoOpReason.BUFFER_WARMING_UP;
    if (tmp) {
      tmp = reason !== require(4222) /* getClipCropAspectRatio */.ClipsSaveNoOpReason.BRIDGE_SHUTDOWN;
    }
    if (!tmp) {
      const _Math = Math;
      closure_23 = Math.max(closure_23 - 1, 0);
  ...
  CLIPS_CLASSIFY_HARDWARE: function handleClassifyHardware(classification) {
    ...
    let tmp = hardwareClassification2 === require(4222) /* getClipCropAspectRatio */.ClipsHardwareClassification.MEETS_AUTO_ENABLE;
    if (tmp) {
      tmp = hardwareClassification !== require(4222) /* getClipCropAspectRatio */.ClipsHardwareClassification.MEETS_AUTO_ENABLE;
    }
    if (tmp) {
    ...
    let clipsEnabled = hardwareClassificationForDecoupled2 === require(4222) /* getClipCropAspectRatio */.ClipsHardwareClassification.MEETS_AUTO_ENABLE;
    if (clipsEnabled) {
      clipsEnabled = hardwareClassificationForDecoupled !== require(4222) /* getClipCropAspectRatio */.ClipsHardwareClassification.MEETS_AUTO_ENABLE;
    }
    if (clipsEnabled) {
