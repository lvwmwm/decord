...
const map = new Map();
let obj = { clipsQuality: obj, clipsLength: ClipsLengthSettings.SECONDS_30, viewerConnectivity: ClipsViewerConnectivitySettings.ALL, maxAutoClips: DEFAULT_MAX_AUTO_CLIPS, clipSignals: { image/avif: null, image/gif: null }, debugTooltipsEnabled: false, enableAutoclipping: undefined, showPovClipsInGallery: false };
obj = { resolution: ApplicationStreamResolutions.RESOLUTION_1080, frameRate: ApplicationStreamFPS.FPS_30 };
let closure_34 = { clipsSettings: obj, newClipIds: [], clipsEducationState: {} };
