...
// Dependencies: [19, 17, 13954, 21, 4344, 712, 1891, 6056, 6033, 2]
// Exports: default

// Module 15004 (SettingSearchBar)
...
export default function SettingSearchBar() {
  ...
  const callback1 = React.useCallback(() => {
    const result = callback(6056).trackSettingSearchInputFocused();
  ...
  obj[6] = callback3;
  obj[1] = jsx(require(6033) /* SearchField */.SearchField, { ref: React.useRef(null), size: "md", onFocus: callback1, onBlur: callback2, onClear: callback, defaultValue: null, onChange: null });
