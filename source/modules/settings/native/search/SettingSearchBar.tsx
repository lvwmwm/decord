...
// Dependencies: [19, 17, 13818, 21, 4302, 712, 1872, 5955, 5932, 2]
// Exports: default

// Module 14864 (SettingSearchBar)
...
export default function SettingSearchBar() {
  ...
  const callback1 = React.useCallback(() => {
    const result = callback(5955).trackSettingSearchInputFocused();
  ...
  obj[6] = callback3;
  obj[1] = jsx(require(5932) /* SearchField */.SearchField, { ref: React.useRef(null), size: "md", onFocus: callback1, onBlur: callback2, onClear: callback, defaultValue: null, onChange: null });
