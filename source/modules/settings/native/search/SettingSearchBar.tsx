...
// Dependencies: [19, 17, 13949, 21, 4342, 712, 1891, 6058, 6035, 2]
// Exports: default
...
export default function SettingSearchBar() {
  ...
  const callback1 = React.useCallback(() => {
    const result = callback(6058).trackSettingSearchInputFocused();
  ...
  obj[6] = callback3;
  obj[1] = jsx(require(6035) /* SearchField */.SearchField, { ref: React.useRef(null), size: "md", onFocus: callback1, onBlur: callback2, onClear: callback, defaultValue: null, onChange: null });
