...
// Dependencies: [32, 19, 17, 13897, 10453, 21, 4303, 712, 14938, 13902, 38, 13900, 8962, 9147, 9567, 2]
// Exports: default

// Module 14947 (SettingSegmentedControl)
...
export default function SettingSegmentedControl(node) {
  ...
  let obj = _require(8962);
  const segmentedControlState = obj.useSegmentedControlState({ items: memo, pageWidth: tmp3, defaultIndex: tmp5 });
  obj = { children: null };
  obj = { style: tmp.controlContainer, onLayout: callback, children: callback2(_require(9147).SegmentedControl, { state: segmentedControlState }) };
  ...
  items1[1] = callback2(View, { style: tmp.pageContainer, children: callback2(_require(9567).SegmentedControlPages, { state: segmentedControlState }) });
  obj[0] = items1;
