...
// Dependencies: [10381, 676, 7533, 5953, 5944, 500, 1872, 13822, 38, 13823, 14856, 12, 2]
...
// Module 13821 (onRouteSettingOnPress)
...
export const getSettingTitle = function getSettingTitle(closure_0) {
  const cachedSettingTitle = require(13822) /* map */.getCachedSettingTitle(closure_0);
  const obj = require(13822) /* map */;
