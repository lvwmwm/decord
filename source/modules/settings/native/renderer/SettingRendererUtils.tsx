...
// Dependencies: [10670, 676, 7877, 7357, 7349, 500, 1892, 13997, 38, 13998, 15059, 12, 2]
...
export const getSettingTitle = function getSettingTitle(closure_0) {
  const cachedSettingTitle = require(13997) /* map */.getCachedSettingTitle(closure_0);
  const obj = require(13997) /* map */;
