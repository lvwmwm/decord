...
// Dependencies: [31, 13614, 10060, 13619, 13617, 1456, 2]
// Exports: useAutoScrollToSearchResultSetting

// Module 14638 (useAutoScrollToSearchResultSetting)
...
export const useAutoScrollToSearchResultSetting = function useAutoScrollToSearchResultSetting(ref, memo, scrollTarget) {
  ...
  if (null != current) {
    flag = false;
    if (_require(13619).SETTING_RENDERER_CONFIG[current].type !== current.ROUTE) {
      let initialScrollIndex = _require(13617).getInitialScrollIndex(current, memo);
      let tmp9 = 0 !== initialScrollIndex;
      if (tmp9) {
        tmp9 = 1 !== initialScrollIndex;
      }
      flag = tmp9;
      let obj2 = _require(13617);
    }
  }
