...
// Dependencies: [32, 109, 19, 17, 1946, 13762, 1862, 10273, 21, 4255, 712, 1297, 5286, 1480, 13765, 589, 1236, 9921, 5632, 14790, 14791, 5621, 3974, 7783, 7782, 5609, 3955, 10894, 4224, 4225, 5288, 4664, 4251, 1851, 500, 13303, 4783, 4666, 3959, 5914, 1844, 2]
// Exports: renderSettingItem, renderSettingSearchResultItem, renderSettingSearchResultPlaceholderItem

// Module 13764 (GuildSelectDefaultIcon)
...
function SettingSearchResultBreadcrumbs(breadcrumbs) {
  ...
  if (0 !== breadcrumbs.length) {
    ...
    tmp = callback3(require(4251) /* Text */.Text, obj);
  }
  return tmp;
}
function SettingSearchResultIcon(IconComponent) {
  ...
  if (null == IconComponent) {
    ...
    obj[0] = IconComponent;
    tmp6 = callback3(require(5286) /* TableRowInner */.TableRow.Icon, obj);
  }
  return tmp6;
}
...
function SettingSearchResultPlaceholder(arg0) {
  ...
  return callback3(require(5286) /* TableRowInner */.TableRow, obj);
}
...
let closure_21 = importAllResult.memo((arg0) => {
  ...
  let obj = require(14790) /* useHighlightSettingItem */;
  ...
  if (null != IconComponent) {
    ...
    obj[0] = IconComponent;
    obj[1] = variant;
    tmp10Result = tmp10(tmp(5286).TableRow.Icon, obj);
  }
  obj[4] = tmp10Result;
  obj[5] = onPress;
  obj[6] = isDisabled;
  ...
  if (null != trailing) {
    ...
    if (typeof trailing !== "ge") {
      const obj1 = { text: null };
      obj1[0] = trailing;
      tmp10Result = tmp10(tmp(5286).TableRow.TrailingText, obj1);
    }
    tmp12 = tmp10Result;
  }
  obj[7] = tmp12;
  obj[8] = start;
  obj[9] = end;
  const children = [closure_14(require(5286) /* TableRowInner */.TableRow, obj), ];
  if (highlightSettingItem) {
    const obj2 = { start: null, end: null };
    obj2[0] = start;
    obj2[1] = end;
    highlightSettingItem = tmp10(importDefault(14791), obj2);
  }
...
let closure_22 = importAllResult.memo((arg0) => {
  ...
  if (null != IconComponent) {
    ...
    obj[0] = IconComponent;
    obj[1] = variant;
    tmp8Result = tmp8(tmp(5286).TableRow.Icon, obj);
  }
  obj[2] = tmp8Result;
  obj[3] = value;
  obj[4] = variant;
  ...
  obj[7] = start;
  obj[8] = end;
  tmp8Result = tmp8(tmp(5621).TableSwitchRow, obj);
  ...
  if (highlightSettingItem) {
    ...
    obj2[0] = start;
    obj2[1] = end;
    highlightSettingItem = tmp8(importDefault(14791), obj2);
  }
  children[1] = highlightSettingItem;
  return closure_16(closure_15, { children });
});
let closure_24 = importAllResult.memo((arg0) => {
  ...
  const children = [callback3(require(7783) /* context */.TableRadioGroup, obj, combined), ];
  if (highlightSettingItem) {
    obj = { start: true, end: true, style: null };
    obj[2] = tmp.radioSettingHighlight;
    highlightSettingItem = callback3(importDefault(14791), obj);
  }
  children[1] = highlightSettingItem;
  return closure_16(closure_15, { children });
});
let closure_25 = importAllResult.memo((arg0) => {
  ...
  if (null != IconComponent) {
    ...
    obj[0] = IconComponent;
    obj[1] = variant;
    tmp11Result = tmp11(tmp(5286).TableRow.Icon, obj);
  }
  obj[5] = tmp11Result;
  tmp11Result = null;
  if (null != trailing) {
    const obj1 = { text: null };
    obj1[0] = trailing;
    tmp11Result = tmp11(tmp(5286).TableRow.TrailingText, obj1);
  }
  obj[6] = tmp11Result;
  obj[7] = start;
  obj[8] = end;
  const children = [closure_14(trailing(5286).TableRow, obj), ];
  if (highlightSettingItem) {
    let obj2 = { start: null, end: null };
    obj2[0] = start;
    obj2[1] = end;
    highlightSettingItem = tmp11(importDefault(14791), obj2);
  }
  children[1] = highlightSettingItem;
  return closure_16(closure_15, { children });
});
let closure_26 = importAllResult.memo((arg0) => {
  ...
  obj[1] = callback3(importDefault(10894), { value, maxVolume: maximum, onValueChange });
  obj[3] = callback3(View, obj);
  const children = [callback3(require(5286) /* TableRowInner */.TableRow, obj), ];
  if (highlightSettingItem) {
    const obj1 = { start: null, end: null };
    obj1[0] = start;
    obj1[1] = end;
    highlightSettingItem = callback3(importDefault(14791), obj1);
  }
  children[1] = highlightSettingItem;
  return closure_16(closure_15, { children });
});
