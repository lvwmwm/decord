...
// Dependencies: [32, 109, 19, 17, 1946, 13767, 1862, 10334, 21, 4255, 712, 1297, 5300, 1480, 13770, 589, 1236, 9422, 5646, 14803, 14804, 5635, 3974, 7767, 7766, 5623, 3955, 10719, 4224, 4225, 5302, 4663, 4251, 1851, 500, 13308, 4797, 4665, 3959, 5909, 1844, 2]
// Exports: renderSettingItem, renderSettingSearchResultItem, renderSettingSearchResultPlaceholderItem

// Module 13769 (GuildSelectDefaultIcon)
...
function SettingSearchResultIcon(IconComponent) {
  ...
  if (null == IconComponent) {
    ...
    obj[0] = IconComponent;
    tmp6 = callback3(require(5300) /* TableRowInner */.TableRow.Icon, obj);
  }
  return tmp6;
}
...
function SettingSearchResultPlaceholder(arg0) {
  ...
  return callback3(require(5300) /* TableRowInner */.TableRow, obj);
}
...
let closure_21 = importAllResult.memo((arg0) => {
  ...
  let obj = require(14803) /* useHighlightSettingItem */;
  ...
  obj[8] = start;
  obj[9] = end;
  const children = [closure_14(require(5300) /* TableRowInner */.TableRow, obj), ];
  if (highlightSettingItem) {
    const obj2 = { start: null, end: null };
    obj2[0] = start;
    obj2[1] = end;
    highlightSettingItem = tmp10(importDefault(14804), obj2);
  }
...
let closure_22 = importAllResult.memo((arg0) => {
  ...
  if (highlightSettingItem) {
    ...
    obj2[0] = start;
    obj2[1] = end;
    highlightSettingItem = tmp8(importDefault(14804), obj2);
  }
  children[1] = highlightSettingItem;
  return closure_16(closure_15, { children });
});
let closure_24 = importAllResult.memo((arg0) => {
  ...
  const children = [callback3(require(7767) /* context */.TableRadioGroup, obj, combined), ];
  if (highlightSettingItem) {
    obj = { start: true, end: true, style: null };
    obj[2] = tmp.radioSettingHighlight;
    highlightSettingItem = callback3(importDefault(14804), obj);
  }
  children[1] = highlightSettingItem;
  return closure_16(closure_15, { children });
});
let closure_25 = importAllResult.memo((arg0) => {
  ...
  if (highlightSettingItem) {
    ...
    obj2[0] = start;
    obj2[1] = end;
    highlightSettingItem = tmp11(importDefault(14804), obj2);
  }
  children[1] = highlightSettingItem;
  return closure_16(closure_15, { children });
});
let closure_26 = importAllResult.memo((arg0) => {
  ...
  obj[1] = callback3(importDefault(10719), { value, maxVolume: maximum, onValueChange });
  obj[3] = callback3(View, obj);
  const children = [callback3(require(5300) /* TableRowInner */.TableRow, obj), ];
  if (highlightSettingItem) {
    const obj1 = { start: null, end: null };
    obj1[0] = start;
    obj1[1] = end;
    highlightSettingItem = callback3(importDefault(14804), obj1);
  }
  children[1] = highlightSettingItem;
  return closure_16(closure_15, { children });
});
