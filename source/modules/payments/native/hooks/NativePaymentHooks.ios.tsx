...
// Dependencies: [5, 32, 19, 5899, 4012, 4013, 5897, 676, 3, 589, 6924, 7456, 4022, 7457, 5755, 698, 7416, 5900, 38, 4663, 7459, 7460, 2]
// Exports: useCancelSubscription, useCreateSubscription, useGoogleSkuIds, useNativeIAPPayments, useResubscribeSubscription

// Module 7455 (useNativeIAPPayments)
...
function useCreateSubscription(planId) {
  ...
  const tmp11 = importDefault(7457)(stateFromStores, tmp3[2]);
  React = tmp11;
  const tmp12 = importDefault(5755)(() => first(_undefined[15]).getNewAnalyticsLoadId());
  c6 = tmp12;
