...
// Dependencies: [5, 32, 19, 6094, 4144, 4145, 6092, 673, 3, 586, 7173, 10750, 4154, 10801, 5949, 695, 10803, 6095, 38, 4837, 10805, 10806, 2]
// Exports: useCancelSubscription, useCreateSubscription, useGoogleSkuIds, useNativeIAPPayments, useResubscribeSubscription

// Module 10800 (useNativeIAPPayments)
import timestampDefault from "timestamp" /* 3 */;
import useInitialValueDefault from "useInitialValue" /* 5949 */;
import useTimeoutDefault from "useTimeout" /* 10750 */;
import useCreateSubscriptionParamsDefault from "useCreateSubscriptionParams" /* 10801 */;
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "_slicedToArray" /* 32 */;
import closure_5 from "noop" /* 19 */;
import closure_6 from "isGenericIapConnected" /* 6094 */;
import closure_7 from "addSubscriptionPlan" /* 4144 */;
import closure_8 from "reset" /* 4145 */;
import closure_9 from "updateProduct" /* 6092 */;
...
function useNativeIAPPayments() {
  ...
  const effect = React.useEffect(() => {
    if (!first) {
      const products = first(7173).loadProducts();
      const obj = first(7173);
    }
  }, items1);
...
function useCreateSubscription(planId) {
  ...
  callback = React.useCallback(() => {
    let obj = first(10803);
    obj = { load_id: closure_6, payment_type: closure_1_10[closure_1_11.SUBSCRIPTION], subscription_plan_gateway_plan_id: first(6095).ProductIds.GENERIC_SUBSCRIPTION, subscription_type: closure_1_12.GUILD, is_gift: false, location: closure_3, application_id: dependencyMap, subscription_plan_id: first, sku_id: closure_1 };
...
function useCancelSubscription(arg0, arg1) {
  ...
  obj = {
    cancelSubscription: memo.useCallback(callback(function*() {
      ...
      closure_0 = yield closure_1_0(7173).cancelGenericSubscription(closure_1_6.requestIdentifier, closure_1_6.subscriptionId, closure_1_1);
      const obj2 = closure_1_0(4837);
...
function useResubscribeSubscription(arg0) {
  ...
  obj = {
    resubscribeSubscription: React.useCallback(stateFromStores(function*() {
      ...
      closure_0 = yield closure_1_0(7173).resubscribeGenericSubscription(closure_1_5, isACOM.isACOM);
      const obj2 = closure_1_0(4837);
      yield obj2.fetchSubscriptions();
      return closure_0;
    }), items5),
