...
// Dependencies: [5, 32, 19, 5754, 3906, 3907, 5752, 676, 3, 589, 6777, 7308, 3916, 7309, 5583, 698, 7268, 5755, 38, 4574, 7311, 7312, 2]
// Exports: useCancelSubscription, useCreateSubscription, useGoogleSkuIds, useNativeIAPPayments, useResubscribeSubscription

// Module 7307 (useNativeIAPPayments)
...
function useCreateSubscription(planId) {
  ...
  const tmp11 = importDefault(7309)(stateFromStores, tmp3[2]);
  React = tmp11;
  const tmp12 = importDefault(5583)(() => first(_undefined[15]).getNewAnalyticsLoadId());
  c6 = tmp12;
...
function useCancelSubscription(arg0, arg1) {
  ...
  obj = {
    cancelSubscription: memo.useCallback(callback(function*() {
      ...
      closure_0 = yield outer1_0(6777).cancelGenericSubscription(outer1_6.requestIdentifier, outer1_6.subscriptionId, outer1_1);
      const obj2 = outer1_0(4574);
...
function useResubscribeSubscription(arg0) {
  ...
  obj = {
    resubscribeSubscription: React.useCallback(stateFromStores(function*() {
      ...
      closure_0 = yield outer1_0(6777).resubscribeGenericSubscription(outer1_5, isACOM.isACOM);
      const obj2 = outer1_0(4574);
      yield obj2.fetchSubscriptions();
      return closure_0;
    }), items5),
