...
// Dependencies: [32, 1931, 5896, 5894, 2]

// Module 6931 (createFromServer)
...
prototype["getPriceString"] = function getPriceString() {
  ...
  const obj2 = new importDefault(5896)(total.amount);
  return obj.formatPrice(new importDefault(5896)(total.amount).dividedBy(10 ** total.exponent).toNumber(), total.currency, { convertToMajorUnits: false });
};
prototype["getAddOnPrice"] = function getAddOnPrice() {
  ...
  if (0 === this.addOnPlans.length) {
    ...
    const obj2 = new importDefault(5896)(reduced);
