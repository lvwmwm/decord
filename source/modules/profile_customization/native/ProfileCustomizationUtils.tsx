...
export const useEditBannerSource = function useEditBannerSource(arg0) {
  ...
  if (null != pendingBanner) {
    return require(8304) /* useDominantRGBFromImage */.memoizedImageSource(pendingBanner);
  } else {
    if (null === pendingBanner) {
      let result;
...
export const useUserProfileBannerBackgroundColor = function useUserProfileBannerBackgroundColor(arg0) {
  ...
  if (null == user) {
    const obj3 = require(8304) /* useDominantRGBFromImage */;
    const memoizedImageSourceResult = require(8304) /* useDominantRGBFromImage */.memoizedImageSource(null);
    const obj4 = require(688) /* int2hslRaw */;
    let primaryColor;
    const obj5 = require(8304) /* useDominantRGBFromImage */;
    if (displayProfile != null) {
...
export const getAvatarSource = function getAvatarSource(getAvatarURL) {
  if (null == getAvatarURL) {
    ...
    if (undefined === arg2) {
      let memoizedImageSourceResult = require(8304) /* useDominantRGBFromImage */.memoizedImageSource(getAvatarURL.getAvatarURL(arg1, 80, !arg3));
      const obj4 = require(8304) /* useDominantRGBFromImage */;
      const tmp2 = !arg3;
    } else {
      let obj = require(8304) /* useDominantRGBFromImage */;
