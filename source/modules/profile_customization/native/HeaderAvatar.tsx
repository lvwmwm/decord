// Module ID: 7973
// Function ID: 7974
// Dependencies: [19, 17, 4181, 1942, 4276, 676, 21, 4189, 712, 1297, 589, 7974, 7940, 7975, 7976, 4717, 2]
...
const forwardRefResult = require("noop").forwardRef((animate) => {
  ...
  obj[4] = items4;
  obj[5] = tmp9(7975)(activities);
  if (flag) {
    flag = !stateFromStores;
  }
  obj[6] = flag;
  obj[7] = id(7974)(obj4.getProfilePreviewValue(obj));
  if (null != onPress) {
    ...
    jsx(obj(4717).PressableOpacity, { ref: null, onPress: null, onLongPress: null, style: null, activeOpacity: 0.8, accessibilityRole: "imagebutton" });
  } else {
