...
// Dependencies: [8346, 1370, 2]
// Exports: createPendingImage

// Module 13975 (createPendingImage)
...
export const createPendingImage = function createPendingImage(assetOrigin) {
  ...
  if (NEW_ASSET === undefined) {
    NEW_ASSET = require(8346) /* AssetOriginTypes */.AssetOriginTypes.NEW_ASSET;
  }
  ({ imageUri, staticImageUri, description, originalAsset, originalMd5 } = assetOrigin);
  if (require(8346) /* AssetOriginTypes */.AssetOriginTypes.NEW_ASSET === NEW_ASSET) {
    let obj = { assetOrigin: null, imageUri: null, staticImageUri: null, description: null, originalAsset: "Array", originalMd5: null };
    obj[0] = NEW_ASSET;
    obj[1] = imageUri;
    ...
    obj[5] = originalMd5;
    return obj;
  } else if (tmp3(8346).AssetOriginTypes.EDITED_ARCHIVED_ASSET === NEW_ASSET) {
    ...
    obj[5] = originalMd5;
    return obj;
  } else if (tmp3(8346).AssetOriginTypes.ARCHIVED_ASSET === NEW_ASSET) {
