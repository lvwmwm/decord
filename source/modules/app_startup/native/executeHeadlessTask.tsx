...
// Dependencies: [5, 17, 1218, 16041, 676, 3, 1208, 675, 15, 9, 12721, 698, 503, 4074, 2]
// Exports: default

// Module 16759 (_executeHeadlessTask)
            ...
            switch (c11) {
              case 0:
                if (arg0 === 1) {
                  ...
                  throwTypeErrorResult = callback2(outer1_3[5]);
                  ...
                  obj2[0] = callback;
                  obj1[1] = obj2;
                  throwTypeErrorResult = callback2(outer1_3[6]).addBreadcrumb(obj1);
                  throwTypeErrorResult = callback3;
                  throwTypeErrorResult = outer1_3;
                  const obj56 = callback2(outer1_3[6]);
                  throwTypeErrorResult = callback3(outer1_3[7]).recordStartHeadlessTask();
                  throwTypeErrorResult = callback;
                  throwTypeErrorResult = outer1_3;
                  const obj59 = callback3(outer1_3[7]);
                  throwTypeErrorResult = callback(outer1_3[8]).closeFastConnectSocket();
                  closure_5 = false;
                  let constants = 1;
                  throwTypeErrorResult = callback2;
                  throwTypeErrorResult = outer1_3;
                  if (!callback2(outer1_3[9]).wasEverActive) {
                    throwTypeErrorResult = callback2;
                    throwTypeErrorResult = outer1_3;
                    callback2(outer1_3[9]).extraProperties.headless_task_ran = true;
                  }
                  throwTypeErrorResult = outer1_5;
                  if ("active" !== outer1_5.currentState) {
                    throwTypeErrorResult = throwTypeErrorResult.log("Pausing socket in headless task because app state is not active");
                    throwTypeErrorResult = callback3;
                    throwTypeErrorResult = outer1_3;
                    throwTypeErrorResult = callback3(outer1_3[10]).setIsPaused(true);
                    const obj41 = callback3(outer1_3[10]);
                  }
                  throwTypeErrorResult = callback2;
                  throwTypeErrorResult = outer1_3;
                  const obj60 = callback(outer1_3[8]);
                  throwTypeErrorResult = constants;
                  let obj3 = { client_app_state: null, name: null };
                  throwTypeErrorResult = outer1_5;
                  obj3[0] = outer1_5.currentState;
                  obj3[1] = throwTypeErrorResult;
                  throwTypeErrorResult = callback2(outer1_3[11]).track(constants.HEADLESS_TASK_INVOKED, obj3);
              ...
              case 3:
                if (arg0 === 1) {
                  ...
                  if (arg0 === 2) {
                    ...
                    throwTypeErrorResult = closure_5;
                    obj11[0] = closure_5.currentState;
                    throwTypeErrorResult = callback;
                    obj11[1] = callback;
                    throwTypeErrorResult = closure_5;
                    obj11[2] = closure_5;
              ...
              case 4:
                if (arg0 === 1) {
                  ...
                  if (arg0 === 2) {
                    ...
                    obj16[0] = closure_5.currentState;
                    obj16[1] = callback;
                    obj16[2] = closure_5;
                    obj16[3] = authStore;
              ...
              case 9:
                if (arg0 === 1) {
                  ...
                  if (arg0 === 2) {
                    ...
                    obj24[0] = closure_5.currentState;
                    obj24[1] = callback;
                    obj24[2] = closure_5;
                    obj24[3] = authStore;
                    ...
                    throwTypeErrorResult = closure_5;
                    obj28[0] = closure_5.currentState;
                    throwTypeErrorResult = callback;
                    obj28[1] = callback;
                    throwTypeErrorResult = closure_5;
                    obj28[2] = closure_5;
