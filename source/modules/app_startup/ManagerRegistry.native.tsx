...
// Function ID: 123864
// Name: inlineRequire
// Dependencies: [16034, 16037, 16045, 16046, 16047, 10436, 16048, 16049, 16052, 16053, 16055, 10296, 16056, 16057, 16058, 16062, 16063, 16064, 16066, 11492, 11707, 16071, 16072, 16073, 16078, 16079, 5845, 16080, 16081, 16098, 9521, 6032, 10572, 16099, 16100, 16102, 16104, 16105, 16106, 16116, 8159, 16118, 16119, 16120, 16121, 16128, 16129, 16145, 16147, 16148, 16149, 16151, 16153, 16154, 9837, 16163, 14269, 16164, 16165, 16169, 16171, 16185, 16195, 12758, 16198, 16208, 16213, 16214, 16216, 16217, 16219, 16220, 16223, 16225, 16226, 16227, 16228, 16229, 16230, 12720, 16231, 16232, 10641, 16234, 16237, 16238, 16240, 16241, 16245, 5076, 6115, 16246, 16247, 16248, 7921, 16249, 16050, 16250, 16251, 16553, 16554, 16555, 16557, 16558, 16560, 16562, 16563, 16566, 16568, 16569, 16570, 16574, 16575, 16576, 13691, 16578, 16579, 16582, 16583, 16605, 16609, 16610, 16613, 16636, 16637, 16031, 16638, 16639, 16640, 16641, 2]

// Module 16033 (inlineRequire)
...
obj = {
  ...
  inlineRequire() {
    return require(16034) /* _isNativeReflectConstruct */.default;
  }
};
obj = {
  actions: ["POST_CONNECTION_OPEN", "CHANNEL_SELECT", "AGE_GATE_MODAL_OPEN", "AGE_GATE_MODAL_CLOSE", "GUILD_UPDATE"],
  inlineRequire() {
    return require(16037) /* _isNativeReflectConstruct */.default;
  },
...
set = {
  ...
  inlineRequire() {
    return require(16251) /* _isNativeReflectConstruct */.default;
  }
};
set = {
  actions: ["VOICE_CHANNEL_SELECT", "RTC_CONNECTION_STATE"],
  inlineRequire() {
    return require(16553) /* _isNativeReflectConstruct */.default;
  }
};
set = {
  ...
  inlineRequire() {
    return require(16554) /* _isNativeReflectConstruct */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
...
set = {
  ...
  inlineRequire() {
    return require(16557) /* _isNativeReflectConstruct */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(16558) /* _createForOfIteratorHelperLoose */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(16560) /* _isNativeReflectConstruct */.default;
  },
  loadRightBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(16562) /* _isNativeReflectConstruct */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
...
set = {
  ...
  inlineRequire() {
    return require(16568) /* _createForOfIteratorHelperLoose */.default;
  },
  hasStoreChangeListeners: true,
  neverLoadBeforeConnectionOpen: true
};
...
set = {
  ...
  inlineRequire() {
    return require(16570) /* _isNativeReflectConstruct */.default;
  }
};
set = {
...
set = {
  ...
  inlineRequire() {
    return require(16576) /* _isNativeReflectConstruct */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "LOGIN_SUCCESS", "LOGIN_RESET", "LOGOUT"],
  inlineRequire() {
    return require(13691) /* _isNativeReflectConstruct */.default;
  },
  neverLoadBeforeConnectionOpen: true,
  hasStoreChangeListeners: true
};
...
set = {
  ...
  inlineRequire() {
    return require(16583) /* _isNativeReflectConstruct */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(16605) /* _isNativeReflectConstruct */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  actions: [],
  inlineRequire() {
    return require(16609) /* _isNativeReflectConstruct */.default;
  },
  hasStoreChangeListeners: true
};
set = {
  ...
  inlineRequire() {
    return require(16610) /* _isNativeReflectConstruct */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(16613) /* _isNativeReflectConstruct */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(16636) /* _isNativeReflectConstruct */.default;
  }
};
set = {
  actions: ["APP_STATE_UPDATE"],
  inlineRequire() {
    return require(16637) /* _isNativeReflectConstruct */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "CURRENT_USER_UPDATE", "LOGOUT", "NOTIFICATIONS_SET_SCREEN_DOWNTIME_REMINDER"],
  inlineRequire() {
    return require(16031) /* _isNativeReflectConstruct */.default;
  },
  hasStoreChangeListeners: true,
  neverLoadBeforeConnectionOpen: true
};
set = {
  actions: [],
  inlineRequire() {
    return require(16638) /* _isNativeReflectConstruct */.default;
  },
  hasStoreChangeListeners: true,
  loadRightBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(16639) /* _isNativeReflectConstruct */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(16640) /* _isNativeReflectConstruct */.default;
  },
  loadRightBeforeConnectionOpen: true
};
