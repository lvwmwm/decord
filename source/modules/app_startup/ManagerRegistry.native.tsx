// Module ID: 17114
// Function ID: 17115
// Dependencies: [17115, 17118, 17126, 17127, 17128, 11317, 17129, 17130, 17133, 17134, 17136, 10319, 17137, 17138, 17139, 17143, 17144, 17145, 17147, 12251, 12443, 17152, 17153, 17154, 17159, 17160, 7362, 17161, 17163, 17180, 10368, 7527, 9510, 17181, 17182, 17184, 17186, 17187, 17188, 17189, 9773, 17191, 17192, 17193, 17194, 17201, 17202, 17218, 17220, 17221, 17222, 17224, 17226, 17228, 17229, 10054, 17238, 15144, 17239, 17240, 17244, 17246, 17260, 17270, 13644, 17273, 17281, 17286, 17287, 17289, 17290, 17292, 17293, 17296, 17298, 17300, 17301, 17302, 17303, 17304, 13610, 17305, 17306, 10014, 17308, 17311, 17312, 17314, 17315, 17319, 5492, 9950, 17320, 17321, 17322, 8120, 17323, 17131, 17324, 17325, 17620, 17621, 17622, 17624, 17625, 17627, 17629, 17630, 17633, 17635, 17636, 17637, 17641, 17642, 17643, 17644, 14539, 17646, 17647, 17650, 17651, 17673, 17677, 17678, 17681, 17705, 17706, 17112, 17707, 17708, 17709, 17710, 2]

// Module 17114
import set from "populateMap" /* 17710 */;
...
set = {
  ...
  inlineRequire() {
    return require(17324) /* prototype */.default;
  }
};
set = {
  ...
  inlineRequire() {
    return require(17325) /* handlePushedModal */.default;
  }
};
set = {
  actions: ["VOICE_CHANNEL_SELECT", "RTC_CONNECTION_STATE"],
  inlineRequire() {
    return require(17620) /* prototype */.default;
  }
};
set = {
  ...
  inlineRequire() {
    return require(17621) /* resolveMediaPostEmbeds */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17622) /* showClipsToast */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17624) /* handleChannelCreate */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17625) /* getDeliveredNotifications */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17627) /* _reportSessionMeaningfullyOnline */.default;
  },
...
set = {
  ...
  inlineRequire() {
    return require(17629) /* fadeIn */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17630) /* getBackoffJitter */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17633) /* _fetch */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17635) /* log */.default;
  },
...
set = {
  ...
  inlineRequire() {
    return require(17636) /* handleMessageSendFailure */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17637) /* syncYYTextReplacementExperiment */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN"],
  inlineRequire() {
    return require(17641) /* updateSocialRpcNetworkConfig */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "APP_STATE_UPDATE"],
  inlineRequire() {
    return require(17642) /* updateApiRequestConfig */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "USER_SETTINGS_PROTO_UPDATE"],
  inlineRequire() {
    return require(17643) /* prototype */.default;
  }
};
set = {
  ...
  inlineRequire() {
    return require(17644) /* fetchForwardReferencedGuilds */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "LOGIN_SUCCESS", "LOGIN_RESET", "LOGOUT"],
  inlineRequire() {
    return require(14539) /* handlePasskeyUpsellShow */.default;
  },
  neverLoadBeforeConnectionOpen: true,
  hasStoreChangeListeners: true
};
set = {
  ...
  inlineRequire() {
    return require(17646) /* handleAuthenticatorDelete */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN"],
  inlineRequire() {
    return require(17647) /* prototype */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "MESSAGE_UPDATE", "LOAD_MESSAGES_SUCCESS", "LOAD_MESSAGES_AROUND_SUCCESS", "LOAD_RECENT_MENTIONS_SUCCESS", "LOAD_PINNED_MESSAGES_SUCCESS", "SEARCH_MESSAGES_SUCCESS", "MOD_VIEW_SEARCH_MESSAGES_SUCCESS"],
  inlineRequire() {
    return require(17650) /* handleReferralMessages */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17651) /* setDifference */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17673) /* platformShowStreamFull */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  actions: [],
  inlineRequire() {
    return require(17677) /* experimentStoreUpdateHandler */.default;
  },
  hasStoreChangeListeners: true
};
set = {
  ...
  inlineRequire() {
    return require(17678) /* indexingEnabled */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17681) /* handleConnectionOpenSupplemental */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17705) /* handleUserApplicationIdentityGatewayEvent */.default;
  }
};
set = {
  actions: ["APP_STATE_UPDATE"],
  inlineRequire() {
    return require(17706) /* makeLogLine */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "CURRENT_USER_UPDATE", "LOGOUT", "NOTIFICATIONS_SET_SCREEN_DOWNTIME_REMINDER"],
  inlineRequire() {
    return require(17112) /* scheduleUpcomingWarning */.default;
  },
  hasStoreChangeListeners: true,
  neverLoadBeforeConnectionOpen: true
};
set = {
  actions: [],
  inlineRequire() {
    return require(17707) /* isLikelyControl */.default;
  },
  hasStoreChangeListeners: true,
  loadRightBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17708) /* isQuestProgressable */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17709) /* AccountLinkManagerNative */.default;
  },
  loadRightBeforeConnectionOpen: true
};
