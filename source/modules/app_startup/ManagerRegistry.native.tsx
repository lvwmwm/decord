// Module ID: 16842
// Function ID: 16843
// Dependencies: [16843, 16846, 16854, 16855, 16856, 11060, 16857, 16858, 16861, 16862, 16864, 10258, 16865, 16866, 16867, 16871, 16872, 16873, 16875, 11994, 12186, 16880, 16881, 16882, 16887, 16888, 7321, 16889, 16891, 16908, 10307, 7485, 9458, 16909, 16910, 16912, 16914, 16915, 16916, 16917, 9712, 16919, 16920, 16921, 16922, 16929, 16930, 16946, 16948, 16949, 16950, 16952, 16954, 16956, 16957, 9993, 16966, 14882, 16967, 16968, 16972, 16974, 16988, 16998, 13388, 17001, 17009, 17014, 17015, 17017, 17018, 17020, 17021, 17024, 17026, 17028, 17029, 17030, 17031, 17032, 13354, 17033, 17034, 9953, 17036, 17039, 17040, 17042, 17043, 17047, 5452, 9889, 17048, 17049, 17050, 8080, 17051, 16859, 17052, 17053, 17348, 17349, 17350, 17352, 17353, 17355, 17357, 17358, 17361, 17363, 17364, 17365, 17369, 17370, 17371, 17372, 14283, 17374, 17375, 17378, 17379, 17401, 17405, 17406, 17409, 17433, 17434, 16840, 17435, 17436, 17437, 17438, 2]

// Module 16842
import set from "populateMap" /* 17438 */;
...
set = {
  ...
  inlineRequire() {
    return require(17052) /* prototype */.default;
  }
};
set = {
  ...
  inlineRequire() {
    return require(17053) /* handlePushedModal */.default;
  }
};
set = {
  actions: ["VOICE_CHANNEL_SELECT", "RTC_CONNECTION_STATE"],
  inlineRequire() {
    return require(17348) /* prototype */.default;
  }
};
set = {
  ...
  inlineRequire() {
    return require(17349) /* resolveMediaPostEmbeds */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17350) /* showClipsToast */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17352) /* handleChannelCreate */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17353) /* getDeliveredNotifications */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17355) /* _reportSessionMeaningfullyOnline */.default;
  },
...
set = {
  ...
  inlineRequire() {
    return require(17357) /* fadeIn */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17358) /* getBackoffJitter */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17361) /* _fetch */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17363) /* log */.default;
  },
...
set = {
  ...
  inlineRequire() {
    return require(17364) /* handleMessageSendFailure */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17365) /* syncYYTextReplacementExperiment */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN"],
  inlineRequire() {
    return require(17369) /* updateSocialRpcNetworkConfig */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "APP_STATE_UPDATE"],
  inlineRequire() {
    return require(17370) /* updateApiRequestConfig */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "USER_SETTINGS_PROTO_UPDATE"],
  inlineRequire() {
    return require(17371) /* prototype */.default;
  }
};
set = {
  ...
  inlineRequire() {
    return require(17372) /* fetchForwardReferencedGuilds */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "LOGIN_SUCCESS", "LOGIN_RESET", "LOGOUT"],
  inlineRequire() {
    return require(14283) /* handlePasskeyUpsellShow */.default;
  },
  neverLoadBeforeConnectionOpen: true,
  hasStoreChangeListeners: true
};
set = {
  ...
  inlineRequire() {
    return require(17374) /* handleAuthenticatorDelete */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN"],
  inlineRequire() {
    return require(17375) /* prototype */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "MESSAGE_UPDATE", "LOAD_MESSAGES_SUCCESS", "LOAD_MESSAGES_AROUND_SUCCESS", "LOAD_RECENT_MENTIONS_SUCCESS", "LOAD_PINNED_MESSAGES_SUCCESS", "SEARCH_MESSAGES_SUCCESS", "MOD_VIEW_SEARCH_MESSAGES_SUCCESS"],
  inlineRequire() {
    return require(17378) /* handleReferralMessages */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17379) /* setDifference */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17401) /* platformShowStreamFull */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  actions: [],
  inlineRequire() {
    return require(17405) /* experimentStoreUpdateHandler */.default;
  },
  hasStoreChangeListeners: true
};
set = {
  ...
  inlineRequire() {
    return require(17406) /* indexingEnabled */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17409) /* handleConnectionOpenSupplemental */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17433) /* handleUserApplicationIdentityGatewayEvent */.default;
  }
};
set = {
  actions: ["APP_STATE_UPDATE"],
  inlineRequire() {
    return require(17434) /* makeLogLine */.default;
  }
};
set = {
  actions: ["POST_CONNECTION_OPEN", "CURRENT_USER_UPDATE", "LOGOUT", "NOTIFICATIONS_SET_SCREEN_DOWNTIME_REMINDER"],
  inlineRequire() {
    return require(16840) /* scheduleUpcomingWarning */.default;
  },
  hasStoreChangeListeners: true,
  neverLoadBeforeConnectionOpen: true
};
set = {
  actions: [],
  inlineRequire() {
    return require(17435) /* isLikelyControl */.default;
  },
  hasStoreChangeListeners: true,
  loadRightBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17436) /* isQuestProgressable */.default;
  },
  neverLoadBeforeConnectionOpen: true
};
set = {
  ...
  inlineRequire() {
    return require(17437) /* AccountLinkManagerNative */.default;
  },
  loadRightBeforeConnectionOpen: true
};
