...
// Function ID: 14630
// Name: addWant
// Dependencies: [32, 5, 5035, 1395, 1218, 1391, 13043, 676, 3, 5301, 12, 1955, 709, 530, 14630, 2]

// Module 14629 (addWant)
...
prototype["getOrCreate"] = function getOrCreate(arg0) {
  ...
  if (!remote.has(arg0)) {
    ...
    const remoteFetchData = new require(14630) /* FetchStatus */.RemoteFetchData();
