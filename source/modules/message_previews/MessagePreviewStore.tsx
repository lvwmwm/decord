...
// Function ID: 13304
// Name: initialize
// Dependencies: [32, 1391, 4701, 3, 589, 709, 13304, 5185, 2]

// Module 13303 (initialize)
...
prototype["data"] = function data(guildId, items, arg2) {
  ...
  if (!guilds.has(guildId)) {
    ...
    const previewData = new object(13304).PreviewData();
...
prototype["handleLoadMessagesSuccess"] = function handleLoadMessagesSuccess(channelId) {
  ...
  if (null == basicChannel) {
    ...
    const self = this;
    const result = object(5185).requireSortedDescending(channelId.messages);
