...
// Function ID: 13285
// Name: initialize
// Dependencies: [32, 1391, 4688, 3, 589, 709, 13285, 5172, 2]

// Module 13284 (initialize)
...
prototype["data"] = function data(guildId, items, arg2) {
  ...
  if (!guilds.has(guildId)) {
    ...
    const previewData = new object(13285).PreviewData();
...
prototype["handleLoadMessagesSuccess"] = function handleLoadMessagesSuccess(channelId) {
  ...
  if (null == basicChannel) {
    ...
    const self = this;
    const result = object(5172).requireSortedDescending(channelId.messages);
