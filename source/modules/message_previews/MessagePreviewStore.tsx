...
// Function ID: 13259
// Name: initialize
// Dependencies: [32, 1391, 4687, 3, 589, 709, 13259, 5167, 2]
...
prototype["data"] = function data(guildId, items, arg2) {
  ...
  if (!guilds.has(guildId)) {
    ...
    const previewData = new object(13259).PreviewData();
...
prototype["handleLoadMessagesSuccess"] = function handleLoadMessagesSuccess(channelId) {
  ...
  if (null == basicChannel) {
    ...
    const self = this;
    const result = object(5167).requireSortedDescending(channelId.messages);
