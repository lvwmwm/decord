...
// Function ID: 12789
// Name: initialize
// Dependencies: [32, 1372, 4411, 3, 589, 709, 12789, 4868, 2]
...
prototype["data"] = function data(guildId, items, arg2) {
  ...
  if (!guilds.has(guildId)) {
    ...
    const previewData = new object(12789).PreviewData();
...
prototype["handleLoadMessagesSuccess"] = function handleLoadMessagesSuccess(channelId) {
  ...
  if (null == basicChannel) {
    ...
    const self = this;
    const result = object(4868).requireSortedDescending(channelId.messages);
