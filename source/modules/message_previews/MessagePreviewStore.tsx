...
// Function ID: 12857
// Name: initialize
// Dependencies: [32, 1372, 4472, 3, 589, 709, 12857, 4944, 2]

// Module 12856 (initialize)
...
prototype["data"] = function data(guildId, items, arg2) {
  ...
  if (!guilds.has(guildId)) {
    ...
    const previewData = new object(12857).PreviewData();
...
prototype["handleLoadMessagesSuccess"] = function handleLoadMessagesSuccess(channelId) {
  ...
  if (null == basicChannel) {
    ...
    const self = this;
    const result = object(4944).requireSortedDescending(channelId.messages);
