...
// Function ID: 12885
// Name: initialize
// Dependencies: [32, 1372, 4502, 3, 589, 709, 12885, 4959, 2]

// Module 12884 (initialize)
...
prototype["data"] = function data(guildId, items, arg2) {
  ...
  if (!guilds.has(guildId)) {
    ...
    const previewData = new object(12885).PreviewData();
...
prototype["handleLoadMessagesSuccess"] = function handleLoadMessagesSuccess(channelId) {
  ...
  if (null == basicChannel) {
    ...
    const self = this;
    const result = object(4959).requireSortedDescending(channelId.messages);
