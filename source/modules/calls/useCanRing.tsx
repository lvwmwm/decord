...
// Dependencies: [1218, 5036, 1391, 1990, 5172, 3989, 4431, 3998, 4361, 676, 589, 9285, 5175, 4786, 2]
// Exports: canRingUsersInChannel, useCanRing

// Module 9284 (useCanRingToGuildVoiceChannel)
...
function useCanRingToGuildVoiceChannel(user, DisconnectedUserRow, stateFromStores) {
  ...
  const tmp5 = importDefault(4786);
  let guild_id;
  if (stateFromStores != null) {
    guild_id = stateFromStores.guild_id;
  }
  let enabled = tmp4(9285).useExperiment({ guildId: guild_id, location: str }).enabled;
  if (stateFromStores != null) {
