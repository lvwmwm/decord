...
// Dependencies: [32, 1390, 4358, 4363, 1218, 5035, 1391, 4430, 1979, 5177, 1922, 10700, 4360, 4362, 676, 3, 10699, 12, 38, 9281, 4407, 589, 709, 2]

// Module 4357 (getParticipants)
...
function getParticipants(arg0) {
  ...
  if (null == tmp2) {
    const tmp8 = new importDefault(10699)(arg0);
    tmp[arg0] = tmp8;
    tmp2 = tmp8;
  }
  return tmp2;
...
function updateParticipant(arg0, arr) {
  const f74824 = (updateParticipant) => updateParticipant.updateParticipant(f74824);
  return arr.reduce((arg0, arg1) => {
    let tmp4 = outer1_27[arg1];
    if (null == tmp4) {
      const tmp10 = new outer1_1(outer1_2[16])(arg1);
      tmp3[arg1] = tmp10;
      tmp4 = tmp10;
    }
    let flag = arg0;
    if (id(tmp4)) {
      let obj = tmp3[arg1];
      if (null == obj) {
        const tmp17 = new outer1_1(outer1_2[16])(arg1);
        tmp3[arg1] = tmp17;
        obj = tmp17;
      }
      if (0 !== obj.size()) {
        ...
        if (!Boolean(isGuildVocalOrThreadResult)) {
          let hasEmbeddedActivityResult = obj.size(f74824(outer1_2[16]).ChannelRTCParticipantsIndexes.STREAM) > 0;
      ...
      let obj2 = tmp3[arg1];
      if (null == obj2) {
        const tmp36 = new outer1_1(outer1_2[16])(arg1);
        tmp3[arg1] = tmp36;
        obj2 = tmp36;
      }
      if (0 !== obj2.size()) {
        if (outer1_11.getVoiceChannelId() === arg1) {
          ...
          const found = obj2.toArray(f74824(outer1_2[16]).ChannelRTCParticipantsIndexes.STREAM).find((type) => {
          ...
          if (null != found) {
            outer1_1(tmp66[18])(found.type === outer1_16.STREAM, "Impossible condition");
            id = found.id;
          } else if (1 !== obj2.size()) {
            if (1 === obj2.size(tmp65(tmp66[16]).ChannelRTCParticipantsIndexes.VIDEO)) {
              id = outer1_3(obj2.toArray(tmp65(tmp66[16]).ChannelRTCParticipantsIndexes.VIDEO), 1)[0].id;
            } else {
          ...
          let tmp49 = outer1_28[arg1];
          if (tmp49 == null) {
            const items = [tmp47, tmp64.NONE];
            tmp49 = items;
          }
          const first = outer1_3(tmp49, 1)[0];
          let NONE = first;
          if (first !== outer1_17.AUTO) {
            ...
            if (first !== tmp64.NONE) {
              ...
              if (!tmp53) {
                let tmp55 = participant.type === outer1_16.STREAM;
                if (tmp55) {
                  tmp55 = null == outer1_6.getActiveStreamForStreamKey(participant.id);
                }
                tmp53 = tmp55;
              }
              NONE = first;
          ...
          flag = true;
          const toArrayResult = obj2.toArray(f74824(outer1_2[16]).ChannelRTCParticipantsIndexes.STREAM);
        }
      }
      outer1_39(arg1, null);
      flag = true;
...
function hasVideo(size) {
  let hasEmbeddedActivityResult = size.size(require(10699) /* sortKey */.ChannelRTCParticipantsIndexes.STREAM) > 0;
  if (!hasEmbeddedActivityResult) {
    hasEmbeddedActivityResult = size.size(require(10699) /* sortKey */.ChannelRTCParticipantsIndexes.VIDEO) > 0;
  }
  if (!hasEmbeddedActivityResult) {
...
function handleEmbeddedActivityChange() {
  const f74826 = (updateEmbeddedActivities) => updateEmbeddedActivities.updateEmbeddedActivities();
...
function handleSpeaking(arg0) {
  const f74827 = (updateParticipantSpeaking) => updateParticipantSpeaking.updateParticipantSpeaking(f74827);
  return closure_25.reduce((arg0, arg1) => {
    let tmp4 = outer1_27[arg1];
    if (null == tmp4) {
      const tmp10 = new outer1_1(outer1_2[16])(arg1);
...
function handleUserUpdate(user) {
  let f74824 = user.user.id;
  f74824 = (updateParticipant) => updateParticipant.updateParticipant(f74824);
...
function handleCallUpdate(channelId) {
  ...
  const f74828 = (rebuild) => rebuild.rebuild();
...
function handleStreamClose(streamKey) {
  let f74824;
  const obj = f74824(4407);
  const items = [];
  ({ channelId: arr[0], ownerId: f74824 } = f74824(4407).decodeStreamKey(streamKey.streamKey));
  f74824 = (updateParticipant) => updateParticipant.updateParticipant(f74824);
  return items.reduce((arg0, arg1) => {
    let tmp4 = outer1_27[arg1];
    if (null == tmp4) {
...
prototype["getParticipants"] = function getParticipants(arg0) {
  ...
  if (null == obj) {
    const tmp7 = new importDefault(10699)(arg0);
    tmp[arg0] = tmp7;
    obj = tmp7;
  }
...
prototype["getSpeakingParticipants"] = function getSpeakingParticipants(id) {
  ...
  if (null == obj) {
    const tmp7 = new importDefault(10699)(id);
    tmp[id] = tmp7;
    obj = tmp7;
  }
  let toArrayResult = obj.toArray(require(10699) /* sortKey */.ChannelRTCParticipantsIndexes.SPEAKING);
  if (toArrayResult == null) {
    toArrayResult = frozen;
  }
  return toArrayResult;
...
prototype["getFilteredParticipants"] = function getFilteredParticipants(closure_0) {
  ...
  if (null == obj) {
    const tmp7 = new importDefault(10699)(closure_0);
    tmp[closure_0] = tmp7;
    obj = tmp7;
  }
  if (dependencyMap5[closure_0] != null) {
    if (tmp9) {
      let toArrayResult = obj.toArray(require(10699) /* sortKey */.ChannelRTCParticipantsIndexes.FILTERED);
    }
    return toArrayResult;
  }
  toArrayResult = obj.toArray(require(10699) /* sortKey */.ChannelRTCParticipantsIndexes.NOT_POPPED_OUT);
};
prototype["getVideoParticipants"] = function getVideoParticipants(channelId) {
  let obj = dependencyMap[channelId];
  if (null == obj) {
    const tmp7 = new importDefault(10699)(channelId);
    tmp[channelId] = tmp7;
    obj = tmp7;
  }
  let toArrayResult = obj.toArray(require(10699) /* sortKey */.ChannelRTCParticipantsIndexes.VIDEO);
  if (toArrayResult == null) {
    toArrayResult = frozen;
  }
  return toArrayResult;
...
prototype["getStreamParticipants"] = function getStreamParticipants(id) {
  ...
  let toArrayResult = obj.toArray(require(10699) /* sortKey */.ChannelRTCParticipantsIndexes.STREAM);
  if (toArrayResult == null) {
    toArrayResult = frozen;
  }
  return toArrayResult;
...
prototype["getActivityParticipants"] = function getActivityParticipants(channelId) {
  ...
  let toArrayResult = obj.toArray(require(10699) /* sortKey */.ChannelRTCParticipantsIndexes.ACTIVITY);
  if (toArrayResult == null) {
    toArrayResult = frozen;
  }
  return toArrayResult;
...
prototype["getUserParticipantCount"] = function getUserParticipantCount(id) {
  ...
  const diff = obj.size() - obj.size(require(10699) /* sortKey */.ChannelRTCParticipantsIndexes.STREAM);
  return diff - obj.size(require(10699) /* sortKey */.ChannelRTCParticipantsIndexes.ACTIVITY);
};
...
prototype["getSelectedParticipant"] = function getSelectedParticipant(id) {
  ...
  if (null != selectedParticipantId) {
    let obj = dependencyMap[id];
    if (null == obj) {
      const tmp9 = new importDefault(10699)(id);
      tmp3[id] = tmp9;
      obj = tmp9;
    }
...
prototype["getGuildRingingUsers"] = function getGuildRingingUsers(id) {
  ...
  if (null == tmp2) {
    const tmp8 = new importDefault(10699)(id);
    tmp[id] = tmp8;
    tmp2 = tmp8;
  }
...
obj = {
  ...
  VOICE_CHANNEL_SELECT: function handleVoiceChannelSelect(arg0) {
    ...
    if (channelId !== currentVoiceChannelId) {
      ...
      if (null != currentVoiceChannelId) {
        ...
        if (null == tmp14) {
          const tmp20 = new importDefault(10699)(currentVoiceChannelId);
          tmp13[currentVoiceChannelId] = tmp20;
          tmp14 = tmp20;
        }
        f74831 = tmp14;
        const guildRingingUsers = tmp14.guildRingingUsers;
        const item = guildRingingUsers.forEach((userId) => f74831.updateGuildRingingUsers(userId, false));
        const items = [currentVoiceChannelId];
        f74831 = (rebuild) => rebuild.rebuild();
  ...
  CHANNEL_RTC_SELECT_PARTICIPANT: function handleSelectParticipant(arg0) {
    ...
    if (null == id) {
      const item = obj.toArray(obj(10699).ChannelRTCParticipantsIndexes.STREAM).forEach((user) => {
        if (outer1_18(user)) {
          obj.updateParticipant(user.user.id);
        }
      });
      const toArrayResult = obj.toArray(obj(10699).ChannelRTCParticipantsIndexes.STREAM);
    }
    let NONE = id;
    if (id == null) {
    ...
    if (obj2.isStreamKey(id)) {
      try {
        const ownerId = obj(4407).decodeStreamKey(id).ownerId;
  ...
  CHANNEL_RTC_POPOUT_PARTICIPANT: function handlePopOutParticipant(arg0) {
    ...
    if (null == obj2) {
      const tmp13 = new importDefault(10699)(channelId);
    ...
    if (tmp16) {
      ...
      const items1 = [channelId];
      let f74824 = participant.user.id;
      f74824 = (updateParticipant) => updateParticipant.updateParticipant(f74824);
  ...
  CHANNEL_RTC_UPDATE_STAGE_VIDEO_LIMIT_BOOST_UPSELL_DISMISSED: function handleUpdateStageVideoLimitBoostUpsellDismissed(channelId) {
    closure_35[channelId.channelId] = channelId.dismissed;
  },
  STREAM_UPDATE_SELF_HIDDEN: function handleUpdateSelfStreamHidden(channelId) {
    ...
    if (channelId.selfStreamHidden) {
      ...
      const obj3 = f74824(4407);
      if (tmp12) {
        setSelectedParticipantId(channelId, null);
      }
      tmp12 = f74824(4407).isStreamKey(first) && first.includes(id);
    }
    const items1 = [channelId];
    f74824 = (updateParticipant) => updateParticipant.updateParticipant(f74824);
    const reduced = items1.reduce((arg0, arg1) => {
  ...
  RTC_CONNECTION_VIDEO: function handleRTCConnectionVideo(arg0) {
    let f74824;
    const items = [];
    ({ channelId: arr[0], userId: f74824 } = arg0);
    f74824 = (updateParticipant) => updateParticipant.updateParticipant(f74824);
    return items.reduce((arg0, arg1) => {
      let tmp4 = outer1_27[arg1];
      if (null == tmp4) {
  ...
  MEDIA_ENGINE_VIDEO_SOURCE_QUALITY_CHANGED: function handleVideoSourceQuality(channelId) {
    ...
    let f74834;
    let importDefault;
    ({ senderUserId: f74834, maxResolution: importDefault, maxFrameRate: dependencyMap } = channelId);
    const items = [channelId.channelId];
    f74834 = (updateParticipantQuality) => updateParticipantQuality.updateParticipantQuality(f74834, closure_1, closure_2);
    return items.reduce((arg0, arg1) => {
      let tmp4 = outer1_27[arg1];
      if (null == tmp4) {
        const tmp10 = new outer1_1(outer1_2[16])(arg1);
  ...
  PUSH_TO_TALK_STATE_CHANGE: function handlePushToTalkStateChange() {
    const f74835 = (updateParticipantSpeaking) => updateParticipantSpeaking.updateParticipantSpeaking(id.getId());
    return closure_25.reduce((arg0, arg1) => {
      let tmp4 = outer1_27[arg1];
      if (null == tmp4) {
        const tmp10 = new outer1_1(outer1_2[16])(arg1);
  ...
  GUILD_RING_START: function handleGuildRingStart(channelId) {
    ...
    if (obj.getCurrentConfig({ guildId, location: "guild_ring_start" }).enabled) {
      ...
      if (null == tmp4) {
        const tmp9 = new tmp(10699)(channelId);
        tmp3[channelId] = tmp9;
        tmp4 = tmp9;
      }
      f74837 = tmp4;
      ...
      const item = keys.forEach((userId) => f74837.updateGuildRingingUsers(userId, true));
      const items = [channelId];
      f74837 = (rebuild) => rebuild.rebuild();
      return items.reduce((arg0, arg1) => {
        let tmp4 = outer1_27[arg1];
        if (null == tmp4) {
          const tmp10 = new outer1_1(outer1_2[16])(arg1);
  ...
  GUILD_RING_STOP: function handleGuildRingStop(guildId) {
    ...
    if (obj.getCurrentConfig({ guildId: guildId.guildId, location: "guild_ring_start" }).enabled) {
      ...
      f74839 = tmp4;
      const item = ringing.forEach((userId) => f74839.updateGuildRingingUsers(userId, false));
      const items = [channelId];
      f74839 = (rebuild) => rebuild.rebuild();
      return items.reduce((arg0, arg1) => {
        let tmp4 = outer1_27[arg1];
        if (null == tmp4) {
          const tmp10 = new outer1_1(outer1_2[16])(arg1);
