...
// Dependencies: [32, 1371, 4269, 4274, 1218, 4946, 1372, 4341, 1931, 5089, 1874, 10533, 4271, 4273, 676, 3, 10532, 12, 38, 9129, 4318, 589, 709, 2]
...
function getParticipants(arg0) {
  ...
  if (null == tmp2) {
    const tmp8 = new importDefault(10532)(arg0);
    tmp[arg0] = tmp8;
    tmp2 = tmp8;
  }
  return tmp2;
...
function updateParticipant(arg0, arr) {
  const f74149 = (updateParticipant) => updateParticipant.updateParticipant(f74149);
    ...
    if (id(tmp5)) {
      ...
      if (0 !== obj.size()) {
        ...
        if (!Boolean(isGuildVocalOrThreadResult)) {
          let hasEmbeddedActivityResult = obj.size(f74149(outer1_2[16]).ChannelRTCParticipantsIndexes.STREAM) > 0;
      ...
      if (0 !== obj2.size()) {
        if (outer1_11.getVoiceChannelId() === arg1) {
          ...
          const found = obj2.toArray(f74149(outer1_2[16]).ChannelRTCParticipantsIndexes.STREAM).find((type) => {
          ...
          flag = true;
          const toArrayResult = obj2.toArray(f74149(outer1_2[16]).ChannelRTCParticipantsIndexes.STREAM);
        }
      }
      outer1_40(arg1, null);
      flag = true;
...
function hasVideo(size) {
  let hasEmbeddedActivityResult = size.size(require(10532) /* sortKey */.ChannelRTCParticipantsIndexes.STREAM) > 0;
  if (!hasEmbeddedActivityResult) {
    hasEmbeddedActivityResult = size.size(require(10532) /* sortKey */.ChannelRTCParticipantsIndexes.VIDEO) > 0;
  }
  if (!hasEmbeddedActivityResult) {
...
function handleEmbeddedActivityChange() {
  const f74151 = (updateEmbeddedActivities) => updateEmbeddedActivities.updateEmbeddedActivities();
...
function handleSpeaking(arg0) {
  const f74152 = (updateParticipantSpeaking) => updateParticipantSpeaking.updateParticipantSpeaking(f74152);
  return closure_25.reduce((arg0, arg1) => {
    let tmp5 = outer1_27[arg1];
    if (null == tmp5) {
      const tmp11 = new outer1_1(outer1_2[16])(arg1);
...
function handleUserUpdate(user) {
  let f74149 = user.user.id;
  f74149 = (updateParticipant) => updateParticipant.updateParticipant(f74149);
...
function handleCallUpdate(channelId) {
  ...
  const f74153 = (rebuild) => rebuild.rebuild();
...
function handleStreamClose(streamKey) {
  let f74149;
  const obj = f74149(4318);
  const items = [];
  ({ channelId: arr[0], ownerId: f74149 } = f74149(4318).decodeStreamKey(streamKey.streamKey));
  f74149 = (updateParticipant) => updateParticipant.updateParticipant(f74149);
  return items.reduce((arg0, arg1) => {
    let tmp5 = outer1_27[arg1];
    if (null == tmp5) {
...
prototype["getParticipants"] = function getParticipants(arg0) {
  ...
  if (null == obj) {
    const tmp7 = new importDefault(10532)(arg0);
    tmp[arg0] = tmp7;
    obj = tmp7;
  }
...
prototype["getSpeakingParticipants"] = function getSpeakingParticipants(id) {
  ...
  if (null == obj) {
    const tmp7 = new importDefault(10532)(id);
    tmp[id] = tmp7;
    obj = tmp7;
  }
  let toArrayResult = obj.toArray(require(10532) /* sortKey */.ChannelRTCParticipantsIndexes.SPEAKING);
  if (toArrayResult == null) {
    toArrayResult = frozen;
  }
  return toArrayResult;
...
prototype["getFilteredParticipants"] = function getFilteredParticipants(closure_0) {
  ...
  if (null == obj) {
    const tmp7 = new importDefault(10532)(closure_0);
    tmp[closure_0] = tmp7;
    obj = tmp7;
  }
  if (dependencyMap5[closure_0] != null) {
    if (tmp9) {
      let toArrayResult = obj.toArray(require(10532) /* sortKey */.ChannelRTCParticipantsIndexes.FILTERED);
    }
    return toArrayResult;
  }
  toArrayResult = obj.toArray(require(10532) /* sortKey */.ChannelRTCParticipantsIndexes.NOT_POPPED_OUT);
};
prototype["getVideoParticipants"] = function getVideoParticipants(channelId) {
  let obj = dependencyMap[channelId];
  if (null == obj) {
    const tmp7 = new importDefault(10532)(channelId);
    tmp[channelId] = tmp7;
    obj = tmp7;
  }
  let toArrayResult = obj.toArray(require(10532) /* sortKey */.ChannelRTCParticipantsIndexes.VIDEO);
  if (toArrayResult == null) {
    toArrayResult = frozen;
  }
  return toArrayResult;
...
prototype["getStreamParticipants"] = function getStreamParticipants(id) {
  ...
  let toArrayResult = obj.toArray(require(10532) /* sortKey */.ChannelRTCParticipantsIndexes.STREAM);
  if (toArrayResult == null) {
    toArrayResult = frozen;
  }
  return toArrayResult;
...
prototype["getActivityParticipants"] = function getActivityParticipants(channelId) {
  ...
  let toArrayResult = obj.toArray(require(10532) /* sortKey */.ChannelRTCParticipantsIndexes.ACTIVITY);
  if (toArrayResult == null) {
    toArrayResult = frozen;
  }
  return toArrayResult;
...
prototype["getUserParticipantCount"] = function getUserParticipantCount(id) {
  ...
  const diff = obj.size() - obj.size(require(10532) /* sortKey */.ChannelRTCParticipantsIndexes.STREAM);
  return diff - obj.size(require(10532) /* sortKey */.ChannelRTCParticipantsIndexes.ACTIVITY);
};
...
prototype["getSelectedParticipant"] = function getSelectedParticipant(id) {
  ...
  if (null != selectedParticipantId) {
    let obj = dependencyMap[id];
    if (null == obj) {
      const tmp9 = new importDefault(10532)(id);
      tmp3[id] = tmp9;
      obj = tmp9;
    }
...
prototype["getGuildRingingUsers"] = function getGuildRingingUsers(id) {
  ...
  if (null == tmp2) {
    const tmp8 = new importDefault(10532)(id);
    tmp[id] = tmp8;
    tmp2 = tmp8;
  }
...
obj = {
  ...
  VOICE_CHANNEL_SELECT: function handleVoiceChannelSelect(arg0) {
    ...
    if (channelId !== currentVoiceChannelId) {
      ...
      if (null != currentVoiceChannelId) {
        ...
        if (null == tmp14) {
          const tmp20 = new importDefault(10532)(currentVoiceChannelId);
          tmp13[currentVoiceChannelId] = tmp20;
          tmp14 = tmp20;
        }
        f74156 = tmp14;
        const guildRingingUsers = tmp14.guildRingingUsers;
        const item = guildRingingUsers.forEach((userId) => f74156.updateGuildRingingUsers(userId, false));
        const items = [currentVoiceChannelId];
        f74156 = (rebuild) => rebuild.rebuild();
  ...
  CHANNEL_RTC_SELECT_PARTICIPANT: function handleSelectParticipant(arg0) {
    ...
    if (null == id) {
      const item = obj.toArray(obj(10532).ChannelRTCParticipantsIndexes.STREAM).forEach((user) => {
        if (outer1_18(user)) {
          obj.updateParticipant(user.user.id);
        }
      });
      const toArrayResult = obj.toArray(obj(10532).ChannelRTCParticipantsIndexes.STREAM);
    }
    let NONE = id;
    if (id == null) {
    ...
    if (obj2.isStreamKey(id)) {
      try {
        const ownerId = obj(4318).decodeStreamKey(id).ownerId;
  ...
  CHANNEL_RTC_POPOUT_PARTICIPANT: function handlePopOutParticipant(arg0) {
    ...
    if (null == obj2) {
      const tmp13 = new importDefault(10532)(channelId);
    ...
    if (tmp16) {
      ...
      const items1 = [channelId];
      let f74149 = participant.user.id;
      f74149 = (updateParticipant) => updateParticipant.updateParticipant(f74149);
  ...
  STREAM_UPDATE_SELF_HIDDEN: function handleUpdateSelfStreamHidden(channelId) {
    ...
    if (channelId.selfStreamHidden) {
      ...
      const obj3 = f74149(4318);
      if (tmp12) {
        setSelectedParticipantId(channelId, null);
      }
      tmp12 = f74149(4318).isStreamKey(first) && first.includes(id);
    }
    const items1 = [channelId];
    f74149 = (updateParticipant) => updateParticipant.updateParticipant(f74149);
    const reduced = items1.reduce((arg0, arg1) => {
  ...
  RTC_CONNECTION_VIDEO: function handleRTCConnectionVideo(arg0) {
    let f74149;
    const items = [];
    ({ channelId: arr[0], userId: f74149 } = arg0);
    f74149 = (updateParticipant) => updateParticipant.updateParticipant(f74149);
    return items.reduce((arg0, arg1) => {
      let tmp5 = outer1_27[arg1];
      if (null == tmp5) {
  ...
  MEDIA_ENGINE_VIDEO_SOURCE_QUALITY_CHANGED: function handleVideoSourceQuality(channelId) {
    ...
    let f74159;
    let importDefault;
    ({ senderUserId: f74159, maxResolution: importDefault, maxFrameRate: dependencyMap } = channelId);
    const items = [channelId.channelId];
    f74159 = (updateParticipantQuality) => updateParticipantQuality.updateParticipantQuality(f74159, closure_1, closure_2);
    return items.reduce((arg0, arg1) => {
      let tmp5 = outer1_27[arg1];
      if (null == tmp5) {
        const tmp11 = new outer1_1(outer1_2[16])(arg1);
  ...
  PUSH_TO_TALK_STATE_CHANGE: function handlePushToTalkStateChange() {
    const f74160 = (updateParticipantSpeaking) => updateParticipantSpeaking.updateParticipantSpeaking(id.getId());
    return closure_25.reduce((arg0, arg1) => {
      let tmp5 = outer1_27[arg1];
      if (null == tmp5) {
        const tmp11 = new outer1_1(outer1_2[16])(arg1);
  ...
  GUILD_RING_START: function handleGuildRingStart(channelId) {
    ...
    if (obj.getCurrentConfig({ guildId, location: "guild_ring_start" }).enabled) {
      ...
      if (null == tmp4) {
        const tmp9 = new tmp(10532)(channelId);
        tmp3[channelId] = tmp9;
        tmp4 = tmp9;
      }
      f74162 = tmp4;
      ...
      const item = keys.forEach((userId) => f74162.updateGuildRingingUsers(userId, true));
      const items = [channelId];
      f74162 = (rebuild) => rebuild.rebuild();
      return items.reduce((arg0, arg1) => {
        let tmp5 = outer1_27[arg1];
        if (null == tmp5) {
          const tmp11 = new outer1_1(outer1_2[16])(arg1);
  ...
  GUILD_RING_STOP: function handleGuildRingStop(guildId) {
    ...
    if (obj.getCurrentConfig({ guildId: guildId.guildId, location: "guild_ring_start" }).enabled) {
      ...
      f74164 = tmp4;
      const item = ringing.forEach((userId) => f74164.updateGuildRingingUsers(userId, false));
      const items = [channelId];
      f74164 = (rebuild) => rebuild.rebuild();
      return items.reduce((arg0, arg1) => {
        let tmp5 = outer1_27[arg1];
        if (null == tmp5) {
          const tmp11 = new outer1_1(outer1_2[16])(arg1);
