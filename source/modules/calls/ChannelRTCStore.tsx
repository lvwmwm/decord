...
function updateParticipant(arg0, arr) {
  const f74215 = (updateParticipant) => updateParticipant.updateParticipant(f74215);
    ...
    if (id(tmp5)) {
      ...
      if (0 !== obj.size()) {
        ...
        if (!Boolean(isGuildVocalOrThreadResult)) {
          let hasEmbeddedActivityResult = obj.size(f74215(outer1_2[16]).ChannelRTCParticipantsIndexes.STREAM) > 0;
      ...
      if (0 !== obj2.size()) {
        if (outer1_11.getVoiceChannelId() === arg1) {
          ...
          const found = obj2.toArray(f74215(outer1_2[16]).ChannelRTCParticipantsIndexes.STREAM).find((type) => {
          ...
          flag = true;
          const toArrayResult = obj2.toArray(f74215(outer1_2[16]).ChannelRTCParticipantsIndexes.STREAM);
        }
      }
      outer1_40(arg1, null);
      flag = true;
...
function handleEmbeddedActivityChange() {
  const f74217 = (updateEmbeddedActivities) => updateEmbeddedActivities.updateEmbeddedActivities();
...
function handleSpeaking(arg0) {
  const f74218 = (updateParticipantSpeaking) => updateParticipantSpeaking.updateParticipantSpeaking(f74218);
  return closure_25.reduce((arg0, arg1) => {
    let tmp5 = outer1_27[arg1];
    if (null == tmp5) {
      const tmp11 = new outer1_1(outer1_2[16])(arg1);
...
function handleUserUpdate(user) {
  let f74215 = user.user.id;
  f74215 = (updateParticipant) => updateParticipant.updateParticipant(f74215);
...
function handleCallUpdate(channelId) {
  ...
  const f74219 = (rebuild) => rebuild.rebuild();
...
function handleStreamClose(streamKey) {
  let f74215;
  const obj = f74215(4348);
  const items = [];
  ({ channelId: arr[0], ownerId: f74215 } = f74215(4348).decodeStreamKey(streamKey.streamKey));
  f74215 = (updateParticipant) => updateParticipant.updateParticipant(f74215);
  return items.reduce((arg0, arg1) => {
    let tmp5 = outer1_27[arg1];
    if (null == tmp5) {
...
obj = {
  ...
  VOICE_CHANNEL_SELECT: function handleVoiceChannelSelect(arg0) {
    ...
    if (channelId !== currentVoiceChannelId) {
      ...
      if (null != currentVoiceChannelId) {
        ...
        const item = guildRingingUsers.forEach((userId) => f74222.updateGuildRingingUsers(userId, false));
        const items = [currentVoiceChannelId];
        f74222 = (rebuild) => rebuild.rebuild();
  ...
  CHANNEL_RTC_POPOUT_PARTICIPANT: function handlePopOutParticipant(arg0) {
    ...
    if (tmp16) {
      ...
      const items1 = [channelId];
      let f74215 = participant.user.id;
      f74215 = (updateParticipant) => updateParticipant.updateParticipant(f74215);
  ...
  STREAM_UPDATE_SELF_HIDDEN: function handleUpdateSelfStreamHidden(channelId) {
    ...
    if (channelId.selfStreamHidden) {
      ...
      const obj3 = f74215(4348);
      if (tmp12) {
        setSelectedParticipantId(channelId, null);
      }
      tmp12 = f74215(4348).isStreamKey(first) && first.includes(id);
    }
    const items1 = [channelId];
    f74215 = (updateParticipant) => updateParticipant.updateParticipant(f74215);
    const reduced = items1.reduce((arg0, arg1) => {
  ...
  RTC_CONNECTION_VIDEO: function handleRTCConnectionVideo(arg0) {
    let f74215;
    const items = [];
    ({ channelId: arr[0], userId: f74215 } = arg0);
    f74215 = (updateParticipant) => updateParticipant.updateParticipant(f74215);
    return items.reduce((arg0, arg1) => {
      let tmp5 = outer1_27[arg1];
      if (null == tmp5) {
  ...
  MEDIA_ENGINE_VIDEO_SOURCE_QUALITY_CHANGED: function handleVideoSourceQuality(channelId) {
    ...
    let f74225;
    let importDefault;
    ({ senderUserId: f74225, maxResolution: importDefault, maxFrameRate: dependencyMap } = channelId);
    const items = [channelId.channelId];
    f74225 = (updateParticipantQuality) => updateParticipantQuality.updateParticipantQuality(f74225, closure_1, closure_2);
    return items.reduce((arg0, arg1) => {
      let tmp5 = outer1_27[arg1];
      if (null == tmp5) {
        const tmp11 = new outer1_1(outer1_2[16])(arg1);
  ...
  PUSH_TO_TALK_STATE_CHANGE: function handlePushToTalkStateChange() {
    const f74226 = (updateParticipantSpeaking) => updateParticipantSpeaking.updateParticipantSpeaking(id.getId());
    return closure_25.reduce((arg0, arg1) => {
      let tmp5 = outer1_27[arg1];
      if (null == tmp5) {
        const tmp11 = new outer1_1(outer1_2[16])(arg1);
  ...
  GUILD_RING_START: function handleGuildRingStart(channelId) {
    ...
    if (obj.getCurrentConfig({ guildId, location: "guild_ring_start" }).enabled) {
      ...
      const item = keys.forEach((userId) => f74228.updateGuildRingingUsers(userId, true));
      const items = [channelId];
      f74228 = (rebuild) => rebuild.rebuild();
      return items.reduce((arg0, arg1) => {
        let tmp5 = outer1_27[arg1];
        if (null == tmp5) {
          const tmp11 = new outer1_1(outer1_2[16])(arg1);
  ...
  GUILD_RING_STOP: function handleGuildRingStop(guildId) {
    ...
    if (obj.getCurrentConfig({ guildId: guildId.guildId, location: "guild_ring_start" }).enabled) {
      ...
      f74230 = tmp4;
      const item = ringing.forEach((userId) => f74230.updateGuildRingingUsers(userId, false));
      const items = [channelId];
      f74230 = (rebuild) => rebuild.rebuild();
      return items.reduce((arg0, arg1) => {
        let tmp5 = outer1_27[arg1];
        if (null == tmp5) {
          const tmp11 = new outer1_1(outer1_2[16])(arg1);
