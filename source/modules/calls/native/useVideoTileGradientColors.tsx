...
// Function ID: 8318
// Name: rgbToHex
// Dependencies: [19, 676, 8318, 688, 2]
// Exports: useVideoTileGradientColors

// Module 8317 (rgbToHex)
...
function computeVideoTileGradientStops(modalV2BackgroundColor, modalV2BackgroundColor) {
  if (null != modalV2BackgroundColor) {
    if (null != modalV2BackgroundColor) {
      let DARK = require(8318) /* getProfileTheme */.getProfileTheme(modalV2BackgroundColor);
      if (DARK == null) {
      ...
      const obj7 = require(8318) /* getProfileTheme */;
      ...
      let valueInColorGradientByPercentage = require(8318) /* getProfileTheme */.getValueInColorGradientByPercentage(items, items1, 20);
      const tmp9Result3 = require(8318) /* getProfileTheme */;
      const items2 = [, , ];
      [arr3[0], arr3[1], arr3[2]] = int2rgbArrayResult;
      const items3 = [, , ];
      [arr4[0], arr4[1], arr4[2]] = int2rgbArrayResult2;
      valueInColorGradientByPercentage = require(8318) /* getProfileTheme */.getValueInColorGradientByPercentage(items2, items3, 60);
