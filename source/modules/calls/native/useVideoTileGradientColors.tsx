...
// Function ID: 7989
// Name: rgbToHex
// Dependencies: [19, 676, 7989, 688, 2]
// Exports: useVideoTileGradientColors

// Module 7988 (rgbToHex)
...
function computeVideoTileGradientStops(modalV2BackgroundColor, modalV2BackgroundColor) {
  if (null != modalV2BackgroundColor) {
    if (null != modalV2BackgroundColor) {
      let DARK = require(7989) /* getProfileTheme */.getProfileTheme(modalV2BackgroundColor);
      if (DARK == null) {
        DARK = ThemeTypes.DARK;
      }
      let tmp9Result = tmp9(688);
      tmp9Result = tmp9(7989);
      ...
      const obj7 = require(7989) /* getProfileTheme */;
      ...
      let valueInColorGradientByPercentage = require(7989) /* getProfileTheme */.getValueInColorGradientByPercentage(items, items1, 20);
      const tmp9Result3 = require(7989) /* getProfileTheme */;
      const items2 = [, , ];
      [arr3[0], arr3[1], arr3[2]] = int2rgbArrayResult;
      const items3 = [, , ];
      [arr4[0], arr4[1], arr4[2]] = int2rgbArrayResult2;
      valueInColorGradientByPercentage = require(7989) /* getProfileTheme */.getValueInColorGradientByPercentage(items2, items3, 60);
