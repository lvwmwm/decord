...
// Function ID: 63215
// Name: rgbToHex
// Dependencies: [31, 653, 7964, 665, 2]
// Exports: useVideoTileGradientColors

// Module 7963 (rgbToHex)
...
function computeVideoTileGradientStops(modalV2BackgroundColor, modalV2BackgroundColor) {
  if (null != modalV2BackgroundColor) {
    if (null != modalV2BackgroundColor) {
      let DARK = require(7964) /* getProfileTheme */.getProfileTheme(modalV2BackgroundColor);
      if (null == DARK) {
        DARK = ThemeTypes.DARK;
      }
      const obj7 = require(7964) /* getProfileTheme */;
      const obj = require(665) /* pad2 */;
      const int2rgbArrayResult = obj.int2rgbArray(require(7964) /* getProfileTheme */.calculateModalV2BackgroundColor(modalV2BackgroundColor, modalV2BackgroundColor, DARK));
      const obj2 = require(7964) /* getProfileTheme */;
      ...
      let valueInColorGradientByPercentage = require(7964) /* getProfileTheme */.getValueInColorGradientByPercentage(items, items1, 20);
      const obj5 = require(7964) /* getProfileTheme */;
      const items2 = [, , ];
      [arr3[0], arr3[1], arr3[2]] = int2rgbArrayResult;
      const items3 = [, , ];
      [arr4[0], arr4[1], arr4[2]] = int2rgbArrayResult2;
      valueInColorGradientByPercentage = require(7964) /* getProfileTheme */.getValueInColorGradientByPercentage(items2, items3, 60);
