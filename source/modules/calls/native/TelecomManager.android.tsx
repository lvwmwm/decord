...
// Dependencies: [5, 17, 9994, 4500, 1218, 5222, 1387, 4529, 10164, 4554, 4130, 4323, 1922, 676, 4542, 3, 9454, 5486, 17077, 5355, 9871, 4727, 9781, 10037, 10042, 1624, 4674, 9993, 2]
...
prototype["reportIncomingCall"] = function reportIncomingCall(channelId, channelName, arg2) {
  ...
  if (null != channel) {
    ...
    channelName = _require(4674).computeChannelName(channel, closure_15, closure_13);
