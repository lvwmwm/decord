...
// Dependencies: [5, 6, 7, 15, 17, 18, 27, 10277, 4149, 1194, 4809, 1348, 4177, 10250, 4202, 3767, 3970, 1849, 653, 4191, 3, 10519, 4944, 8961, 4341, 8882, 10714, 10718, 1553, 16228, 4320, 10276, 5078, 2]

// Module 16227 (_createForOfIteratorHelperLoose)
...
import ME from "ME";
import get_ActivityIndicator from "handleCloseScreenshare";
...
({ DeviceEventEmitter: closure_9, NativeEventEmitter } = get_ActivityIndicator);
...
tmp6 = new tmp6();
let result = require("_defineProperties").fileFinishedImporting("modules/calls/native/TelecomManager.android.tsx");
