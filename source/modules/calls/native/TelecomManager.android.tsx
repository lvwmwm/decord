...
// Dependencies: [5, 17, 9779, 4322, 1218, 4995, 1372, 4351, 9752, 4375, 3938, 4147, 1903, 676, 4364, 3, 10601, 5261, 16571, 5129, 9242, 4513, 9155, 10820, 10824, 1605, 4494, 9778, 2]

// Module 16570 (nativeEventEmitter)
...
prototype["setIncomingCallActive"] = function setIncomingCallActive(arg0, arg1) {
  ...
  if (channelId === arg0) {
    ...
    const result = importDefault(16571).setIncomingCallActive(arg0, tmp7);
    self.lastMuteState = tmp7;
    self.lastScreenShareActive = false;
    const obj3 = importDefault(16571);
  } else {
...
prototype["startRingtone"] = function startRingtone() {
  ...
  if (isMetaQuestResult) {
    ...
    if (!disableSounds) {
      self.ringtone = require(9778) /* createSoundForPack */.createSoundForPack("call_ringing", soundpack.getSoundpack());
      const ringtone = self.ringtone;
      ringtone.loop();
      const tmpResult = require(9778) /* createSoundForPack */;
    }
  }
};
