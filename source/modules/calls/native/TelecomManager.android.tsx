...
// Dependencies: [5, 17, 9830, 4364, 1218, 5036, 1391, 4393, 9803, 4416, 3998, 4188, 1922, 676, 4406, 3, 10576, 5301, 16652, 5170, 9292, 4554, 9205, 10795, 10799, 1624, 4535, 9829, 2]

// Module 16651 (nativeEventEmitter)
...
prototype["reportIncomingCall"] = function reportIncomingCall(channelId, channelName, arg2) {
  ...
  if (null != channel) {
    ...
    const obj4 = self(16652);
    const reportIncomingCallResult = self(16652).reportIncomingCall(channelId, channelName, tmp19);
    self(16652).reportIncomingCall(channelId, channelName, tmp19).then((arg0) => {
      if (!arg0) {
    ...
    const nextPromise = self(16652).reportIncomingCall(channelId, channelName, tmp19).then((arg0) => {
      if (!arg0) {
        outer1_25.warn("Failed to report incoming call: resolved false");
        self.clearCall(closure_0);
      }
...
prototype["setIncomingCallActive"] = function setIncomingCallActive(arg0, arg1) {
  ...
  if (channelId === arg0) {
    ...
    const result = importDefault(16652).setIncomingCallActive(arg0, tmp7);
    self.lastMuteState = tmp7;
    self.lastScreenShareActive = false;
    const obj3 = importDefault(16652);
  } else {
