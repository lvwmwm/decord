...
// Function ID: 11069
// Name: apiRequest
// Dependencies: [11067, 8826, 676, 4170, 530, 709, 687, 500, 9199, 2]
...
export const fetchIsSpotifyProtocolRegistered = function fetchIsSpotifyProtocolRegistered() {
  if (!protocolRegistered.isProtocolRegistered()) {
    if (obj.isDesktop()) {
      ...
      importDefault(9199).isProtocolRegistered(closure_4).then((isRegistered) => {
        let obj = callback(table[5]);
        obj = { type: "SPOTIFY_SET_PROTOCOL_REGISTERED", isRegistered };
        obj.dispatch(obj);
      });
      const isProtocolRegisteredResult = importDefault(9199).isProtocolRegistered(closure_4);
    }
    obj = require(500) /* set */;
  }
};
