...
// Function ID: 11084
// Name: apiRequest
// Dependencies: [11082, 8843, 676, 4187, 530, 709, 687, 500, 9216, 2]
...
export const fetchIsSpotifyProtocolRegistered = function fetchIsSpotifyProtocolRegistered() {
  if (!protocolRegistered.isProtocolRegistered()) {
    if (obj.isDesktop()) {
      const obj2 = importDefault(9216);
      importDefault(9216).isProtocolRegistered(closure_4).then((isRegistered) => {
        let obj = callback(table[5]);
        obj = { type: "SPOTIFY_SET_PROTOCOL_REGISTERED", isRegistered };
        obj.dispatch(obj);
      });
      const isProtocolRegisteredResult = importDefault(9216).isProtocolRegistered(closure_4);
    }
    obj = require(500) /* set */;
  }
};
