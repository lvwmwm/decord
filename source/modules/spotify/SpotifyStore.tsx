...
// Function ID: 4869
// Name: upsertAccount
// Dependencies: [4209, 1218, 4869, 5000, 4276, 5009, 4205, 8175, 676, 4871, 687, 3, 4074, 709, 584, 10943, 12, 698, 643, 12690, 10513, 1351, 589, 7917, 2]

// Module 4868 (upsertAccount)
...
function upsertAccount(accountId, accessToken) {
  if (accountId in closure_40) {
    ...
    const interval = new obj(4074).Interval();
        ...
        if (null != party.id) {
          if (callback(party.id)) {
            if (null != timestamps) {
              ...
              if (null != tmp14Result) {
                const obj4 = require(10943) /* apiRequest */;
...
function handleUserActivitySyncStop() {
  ...
  if (null != tmp11) {
    ...
    if (tmp18) {
      require(10943) /* apiRequest */.pause(socket.accountId, socket.accessToken);
      const obj4 = require(10943) /* apiRequest */;
    }
    ...
    for (const item10030 of found) {
      ...
      if (!keys.includes(tmp10.id)) {
        ...
        if (null == tmp10.accessToken) {
          ...
          let obj2 = require(10943) /* apiRequest */;
          let tmp24 = item10030;
...
function autoPause() {
  if (null != closure_3) {
    ...
    if (null != tmp2) {
      ...
      let c43 = true;
      require(10943) /* apiRequest */.pause(socket.accountId, socket.accessToken);
      const obj2 = require(10943) /* apiRequest */;
    ...
    if (null != context) {
      ...
      if (items.includes(context.type)) {
        ...
        if (context.type === tmp12.ALBUM) {
          ...
          const SpotifyAPI = _require(10943).SpotifyAPI;
          const obj2 = { url: null };
          obj2[0] = context.href;
...
prototype["connect"] = function connect() {
  ...
  if (!tmp) {
    ...
    const SpotifyAPI = accountId(10943).SpotifyAPI;
...
prototype["handleOpen"] = function handleOpen() {
  ...
  const profile = self(10943).getProfile(this.accountId, this.accessToken);
  const obj = self(10943);
  const devices = self(10943).getDevices(this.accountId, this.accessToken);
};
    ...
    if (parsed.type === message) {
      ...
      if (typeof uri !== "init") {
        if (uri.startsWith(c22)) {
          ...
          const result = require(10943) /* apiRequest */.subscribePlayerStateNotifications(self.accountId, self.accessToken, self.connectionId);
          const obj = require(10943) /* apiRequest */;
        }
        tmp15 = c22;
      }
      const _Array = Array;
...
prototype2["initialize"] = function initialize() {
  ...
  const isSpotifyProtocolRegistered = require(10943) /* apiRequest */.fetchIsSpotifyProtocolRegistered();
};
...
prototype2["getActivity"] = function getActivity() {
  ...
  if (null == closure_3) {
    ...
    if (null != album.image) {
      let obj1 = require(7917) /* updateAssets */;
...
const spotifyStore = new SpotifyStore(require("dispatcher"), {
  ...
  SPEAKING: function handleSpeaking(userId) {
    ...
    if (userId === store.getId()) {
      const result = updateVoiceState.isCurrentClientInVoiceChannel();
      let obj = require(10513) /* useIsSpeaking */;
      obj = { userId: null, checkSoundSharing: true, checkSoundboardSounds: false };
      obj[0] = userId;
      if (result) {
    ...
    if (null != desktopSettings) {
      ...
      if (null != sourceId) {
        if (observedAppNameForWindow.getObservedAppNameForWindow(sourceId) === user.name) {
          if (tmp5) {
            const interval = new require(4074) /* start */.Interval();
            c44 = interval;
