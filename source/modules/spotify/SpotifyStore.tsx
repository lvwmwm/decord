...
// Function ID: 4869
// Name: upsertAccount
// Dependencies: [4209, 1218, 4869, 5000, 4276, 5009, 4205, 8172, 676, 4871, 687, 3, 4074, 709, 584, 10939, 12, 698, 643, 12684, 10509, 1351, 589, 7914, 2]
        ...
        if (null != party.id) {
          if (callback(party.id)) {
            if (null != timestamps) {
              ...
              if (null != tmp14Result) {
                const obj4 = require(10939) /* apiRequest */;
...
function handleUserActivitySyncStop() {
  ...
  if (null != tmp11) {
    ...
    if (tmp18) {
      require(10939) /* apiRequest */.pause(socket.accountId, socket.accessToken);
      const obj4 = require(10939) /* apiRequest */;
    }
    ...
    for (const item10030 of found) {
      ...
      if (!keys.includes(tmp10.id)) {
        ...
        if (null == tmp10.accessToken) {
          ...
          let obj2 = require(10939) /* apiRequest */;
          let tmp24 = item10030;
...
function autoPause() {
  if (null != closure_3) {
    ...
    if (null != tmp2) {
      ...
      let c43 = true;
      require(10939) /* apiRequest */.pause(socket.accountId, socket.accessToken);
      const obj2 = require(10939) /* apiRequest */;
    ...
    if (null != context) {
      ...
      if (items.includes(context.type)) {
        ...
        if (context.type === tmp12.ALBUM) {
          ...
          const SpotifyAPI = _require(10939).SpotifyAPI;
          const obj2 = { url: null };
          obj2[0] = context.href;
...
prototype["connect"] = function connect() {
  ...
  if (!tmp) {
    ...
    const SpotifyAPI = accountId(10939).SpotifyAPI;
...
prototype["handleOpen"] = function handleOpen() {
  ...
  const profile = self(10939).getProfile(this.accountId, this.accessToken);
  const obj = self(10939);
  const devices = self(10939).getDevices(this.accountId, this.accessToken);
};
    ...
    if (parsed.type === message) {
      ...
      if (typeof uri !== "tee") {
        if (uri.startsWith(c22)) {
          ...
          const result = require(10939) /* apiRequest */.subscribePlayerStateNotifications(self.accountId, self.accessToken, self.connectionId);
          const obj = require(10939) /* apiRequest */;
        }
        tmp15 = c22;
      }
      const _Array = Array;
...
prototype2["initialize"] = function initialize() {
  ...
  const isSpotifyProtocolRegistered = require(10939) /* apiRequest */.fetchIsSpotifyProtocolRegistered();
};
...
prototype2["getActivity"] = function getActivity() {
  ...
  if (null == closure_3) {
    ...
    if (null != album.image) {
      let obj1 = require(7914) /* updateAssets */;
...
const spotifyStore = new SpotifyStore(require("dispatcher"), {
  ...
  SPEAKING: function handleSpeaking(userId) {
    ...
    if (userId === store.getId()) {
      const result = updateVoiceState.isCurrentClientInVoiceChannel();
      let obj = require(10509) /* useIsSpeaking */;
      obj = { userId: null, checkSoundSharing: true, checkSoundboardSounds: false };
      obj[0] = userId;
      if (result) {
