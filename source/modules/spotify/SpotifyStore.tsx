...
// Dependencies: [15, 17, 18, 6, 7, 4151, 1194, 4813, 4944, 4218, 4953, 4147, 8113, 653, 4815, 664, 3, 4016, 686, 22, 10880, 561, 675, 620, 12624, 10450, 1327, 7856, 566, 2]
        ...
        if (null != party.id) {
          if (callback3(party.id)) {
            if (null != timestamps) {
              ...
              if (null != tmp9Result) {
                const obj3 = require(10880) /* apiRequest */;
...
function handleUserActivitySyncStop() {
  ...
  if (null != tmp9) {
    ...
    if (tmp12) {
      require(10880) /* apiRequest */.pause(socket.accountId, socket.accessToken);
      const obj3 = require(10880) /* apiRequest */;
    }
      ...
      do {
        ...
        if (!keys.includes(value.id)) {
          if (null == value.accessToken) {
            ...
            let obj = require(10880) /* apiRequest */;
...
function autoPause() {
  if (null != closure_23) {
    ...
    if (null != tmp10) {
      ...
      let c47 = true;
      require(10880) /* apiRequest */.pause(socket.accountId, socket.accessToken);
      const obj = require(10880) /* apiRequest */;
...
function setSpeaking(id, arg1) {
  if (id === store.getId()) {
    ...
    let obj = require(10450) /* _checkIsSpeaking */;
    ...
    if (null != context) {
      ...
      if (items.includes(context.type)) {
        ...
        if (context.type === constants2.ALBUM) {
          ...
          const SpotifyAPI = _require(10880).SpotifyAPI;
