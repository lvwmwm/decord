...
// Function ID: 6729
// Name: SafetyTipsRow
// Dependencies: [19, 17, 21, 4668, 712, 6322, 4739, 2]
// Exports: default

// Module 6728 (SafetyTipsRow)
...
export default function SafetyTipsRow(arg0) {
  ...
  _require = callback();
  return jsx(_require(6322).TableRow, { icon: jsx((children) => closure_1_3(closure_1_2, { style: lib.indexContainer, children: closure_1_3(lib(closure_1_1[6]).Text, { variant: "heading-md/semibold", color: "text-brand", children: children.index }) }), { index }), label: tip, subLabel: description, end });
};
