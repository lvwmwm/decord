...
// Function ID: 8105
// Name: SafetyTipsRow
// Dependencies: [19, 17, 21, 4380, 712, 5480, 4376, 2]
// Exports: default

// Module 8104 (SafetyTipsRow)
...
export default function SafetyTipsRow(arg0) {
  ...
  _require = callback();
  return jsx(_require(5480).TableRow, { icon: jsx((children) => closure_1_3(closure_1_2, { style: lib.indexContainer, children: closure_1_3(lib(closure_1_1[6]).Text, { variant: "heading-md/semibold", color: "text-brand", children: children.index }) }), { index }), label: tip, subLabel: description, end });
};
