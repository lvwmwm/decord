...
// Dependencies: [31, 27, 10138, 33, 4165, 689, 10145, 1212, 4161, 4578, 3862, 10135, 2]
// Exports: default

// Module 10144 (SafetyToolsCrisisTextLineActionSheet)
import "result";
...
export default function SafetyToolsCrisisTextLineActionSheet(trackAnalyticsEvent) {
  ...
  const items = [callback(trackAnalyticsEvent(4161).Text, obj), , ];
  ...
  items[1] = callback(trackAnalyticsEvent(4578).Button, obj1);
  ...
  items[2] = callback(trackAnalyticsEvent(4578).Button, obj2);
  obj.children = items;
  obj.children = callback2(View, obj);
  return callback(importDefault(10145), obj);
};
