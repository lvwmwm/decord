...
// Dependencies: [19, 17, 10474, 21, 4444, 712, 10518, 1236, 4440, 4879, 4158, 10487, 2]
// Exports: default

// Module 10517 (SafetyToolsCrisisTextLineActionSheet)
...
export default function SafetyToolsCrisisTextLineActionSheet(trackAnalyticsEvent) {
  ...
  const items = [callback(trackAnalyticsEvent(4440).Text, obj), , ];
  ...
  items[1] = callback(trackAnalyticsEvent(4879).Button, obj1);
  ...
  items[2] = callback(trackAnalyticsEvent(4879).Button, obj2);
  obj[1] = items;
