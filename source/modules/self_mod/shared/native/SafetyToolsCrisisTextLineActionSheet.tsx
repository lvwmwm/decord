...
// Dependencies: [19, 17, 10569, 21, 4661, 712, 10612, 1236, 4734, 4745, 4090, 10582, 2]
// Exports: default

// Module 10611 (SafetyToolsCrisisTextLineActionSheet)
import "noop";
...
export default function SafetyToolsCrisisTextLineActionSheet(trackAnalyticsEvent) {
  ...
  return callback(importDefault(10612), obj);
};
