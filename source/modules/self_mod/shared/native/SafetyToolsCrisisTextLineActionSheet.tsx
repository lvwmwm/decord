...
// Dependencies: [19, 17, 10225, 21, 4255, 712, 10267, 1236, 4251, 4665, 3952, 10238, 2]
// Exports: default

// Module 10266 (SafetyToolsCrisisTextLineActionSheet)
import "noop";
...
export default function SafetyToolsCrisisTextLineActionSheet(trackAnalyticsEvent) {
  ...
  const items = [callback(trackAnalyticsEvent(4251).Text, obj), , ];
  ...
  items[1] = callback(trackAnalyticsEvent(4665).Button, obj1);
  ...
  items[2] = callback(trackAnalyticsEvent(4665).Button, obj2);
  obj[1] = items;
  obj[7] = callback2(View, obj);
  return callback(importDefault(10267), obj);
};
