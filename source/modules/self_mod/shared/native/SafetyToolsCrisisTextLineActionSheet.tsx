...
// Module 10132 (SafetyToolsCrisisTextLineActionSheet)
...
obj = {};
obj = { "Bool(true)": -1202585599, "Bool(true)": 300807724, "Bool(true)": 30228033, "Bool(true)": 1602048, "Bool(true)": 1572864, gap: importDefault(dependencyMap[5]).space.PX_16, padding: importDefault(dependencyMap[5]).space.PX_16 };
obj.container = obj;
...
export default function SafetyToolsCrisisTextLineActionSheet(trackAnalyticsEvent) {
  ...
  const obj1 = { left: "row", startAndEndHeight: 8, transform: 16, topOffset: "center" };
  ...
  const obj2 = { left: "row", startAndEndHeight: 8, transform: 16, topOffset: "center" };
