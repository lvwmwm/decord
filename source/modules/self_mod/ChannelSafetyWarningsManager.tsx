...
// Dependencies: [1372, 1931, 10126, 10151, 16145, 5134, 2]

// Module 16144 (handleChannelSelect)
        ...
        if (null != channel) {
          if (channel.isDM()) {
            ...
            if (flag3) {
              ...
              obj[3] = channelId;
              tmp4(16145).showTakeoverModal(obj);
              flag3 = true;
              const tmp4Result1 = tmp4(16145);
            }
            return flag3;
          }
        }
      ...
      if (null == currentlySelectedChannelId) {
        ...
        if (null == found) {
          ...
          if (!tmp6) {
            ...
            obj[3] = found.id;
            tmp(16145).showTakeoverModal(obj);
            flag3 = true;
            const tmpResult1 = tmp(16145);
          }
          return flag3;
        }
      }
