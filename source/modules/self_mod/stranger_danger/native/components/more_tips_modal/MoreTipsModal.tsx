...
// Dependencies: [19, 17, 9603, 676, 21, 4302, 712, 10291, 4298, 1236, 10292, 5948, 4507, 7967, 1297, 1609, 647, 10285, 7001, 7006, 5723, 2]
// Exports: default

// Module 10290 (MoreTipsModalScreen)
import set from "set";
...
function MoreTipsModalScreen(learnMore) {
  ...
  const items = [callback(importDefault(10291), { description, safetyTips, showHeader: true }), ];
  let tmp2Result = null;
  if (null != learnMore) {
  ...
  const items2 = [callback(require(4298) /* Text */.Text, obj3), actionItems];
  obj2[0] = items2;
  items1[1] = closure_9(closure_4, obj2);
  items1[2] = callback(importDefault(10292), { channelId, warningId, senderId });
  obj[1] = items1;
...
export default function MoreTipsModal(channelId) {
  ...
  return callback(_require(5723).Navigator, { screens: { MORE_TIPS }, initialRouteName: "MORE_TIPS", headerStatusBarHeight: importDefault(1609)().top });
};
