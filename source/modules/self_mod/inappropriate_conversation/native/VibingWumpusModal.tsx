...
obj = {};
obj = { transform: -951910397, topOffset: -570424460, marginLeft: -1056963724, marginRight: 1124074356, marginVertical: "a", messageTypeIconSize: "NoResults", padding: require("__exportStarResult1").space.PX_32, gap: require("__exportStarResult1").space.PX_16 };
obj.container = obj;
obj.warningText = { marginBottom: require("__exportStarResult1").space.PX_16, gap: require("__exportStarResult1").space.PX_4 };
const obj2 = { -1861163602: "application/vnd.sentry.items.trace-metric+json", -738052821: "first-input", 1560505897: true, gap: require("__exportStarResult1").space.PX_16 };
