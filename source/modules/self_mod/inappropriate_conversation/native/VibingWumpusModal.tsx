...
// Dependencies: [32, 19, 17, 4336, 10385, 10431, 676, 21, 4344, 712, 647, 9772, 698, 10432, 5758, 10433, 4340, 1236, 4754, 4549, 8900, 8902, 5822, 2]
// Exports: default

// Module 10430 (VibingWumpusScreen)
...
export default function VibingWumpusModal() {
  ...
  return callback(require(5822) /* NavigationStack */.Navigator, { screens: { VIBING_WUMPUS }, initialRouteName: "VIBING_WUMPUS" });
};
