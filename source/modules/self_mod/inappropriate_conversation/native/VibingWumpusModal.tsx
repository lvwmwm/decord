...
// Dependencies: [32, 19, 17, 4277, 10256, 10302, 676, 21, 4285, 712, 647, 9644, 698, 10303, 5640, 10304, 4281, 1236, 4695, 4490, 8778, 8780, 5704, 2]
// Exports: default

// Module 10301 (VibingWumpusScreen)
...
export default function VibingWumpusModal() {
  ...
  return callback(require(5704) /* NavigationStack */.Navigator, { screens: { VIBING_WUMPUS }, initialRouteName: "VIBING_WUMPUS" });
};
