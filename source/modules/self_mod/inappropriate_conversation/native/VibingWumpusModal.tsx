...
// Dependencies: [32, 19, 17, 4181, 10155, 10168, 676, 21, 4189, 712, 647, 10169, 698, 10170, 5506, 10171, 4185, 1236, 4600, 4395, 8124, 8126, 5570, 2]
// Exports: default

// Module 10167 (VibingWumpusScreen)
...
class VibingWumpusScreen {
  constructor() {
    tmp = Fragment();
    tmp2 = _slicedToArray(module_4395.useState(false), 2);
    first = tmp2[0];
    useState = first;
    closure_1 = tmp2[1];
    ref = module_4395.useRef(null);
    closure_2 = ref;
    tmp5 = useState;
    tmp6 = closure_2;
...
export default function VibingWumpusModal() {
  ...
  return callback(require(5570) /* NavigationStack */.Navigator, { screens: { VIBING_WUMPUS }, initialRouteName: "VIBING_WUMPUS" });
};
