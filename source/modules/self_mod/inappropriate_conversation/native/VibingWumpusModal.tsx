...
// Dependencies: [32, 19, 17, 4295, 10344, 10390, 676, 21, 4303, 712, 647, 9731, 698, 10391, 5719, 10392, 4299, 1236, 4714, 4509, 8861, 8863, 5783, 2]
// Exports: default

// Module 10389 (VibingWumpusScreen)
...
export default function VibingWumpusModal() {
  ...
  return callback(require(5783) /* NavigationStack */.Navigator, { screens: { VIBING_WUMPUS }, initialRouteName: "VIBING_WUMPUS" });
};
