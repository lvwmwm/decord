...
// Dependencies: [5, 32, 19, 17, 3892, 1874, 10311, 21, 4255, 712, 589, 10313, 10314, 1480, 9104, 7695, 10308, 7818, 3956, 1236, 4216, 3955, 4666, 10320, 9600, 4735, 7754, 3952, 4251, 2]
// Exports: default

// Module 14906 (TakeActionButtons)
    ...
    if (dependencyMap === 2) {
      ...
      try {
        ...
        if (0 === v0) {
          ...
          callback(outer1_0(10308).CtaEventTypes.USER_TAKEOVER_MODAL_REPORT);
        }
        dependencyMap = 3;
