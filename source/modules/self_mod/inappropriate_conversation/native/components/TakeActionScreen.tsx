...
// Dependencies: [5, 32, 19, 17, 3826, 1874, 10159, 21, 4189, 712, 589, 10161, 10162, 1480, 8918, 6721, 10156, 7692, 3890, 1236, 4150, 3889, 4600, 10168, 9442, 4669, 7623, 3886, 4185, 2]
// Exports: default

// Module 14823 (TakeActionButtons)
    ...
    if (dependencyMap === 2) {
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            if (null != outer1_9.getUser(outer1_0)) {
              ...
              obj1[0] = obj2.submitReportForInappropriateConversationSafetyAlert(outer1_5, () => {
                ...
                obj[2] = tmp4(4150).CircleCheckIcon;
                obj[3] = outer1_14;
                obj[4] = toastContainer.toastContainer;
                obj.open(obj);
              }, () => {
                const intl = tmp4(1236).intl;
                tmp4(3889).presentFailedToast(intl.string(tmp4(1236).t["0YV04/"]));
              });
              return obj1;
            } else {
              dependencyMap = 3;
          ...
          callback(outer1_0(10156).CtaEventTypes.USER_TAKEOVER_MODAL_REPORT);
        }
        dependencyMap = 3;
