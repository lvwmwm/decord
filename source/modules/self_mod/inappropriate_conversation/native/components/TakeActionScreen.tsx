...
// Dependencies: [5, 32, 19, 17, 4100, 1922, 10963, 21, 4448, 712, 589, 10987, 10990, 1499, 9021, 8643, 10970, 8719, 4164, 1236, 4408, 4163, 4896, 10998, 8754, 4968, 8692, 4160, 4444, 2]
// Exports: default

// Module 15289 (TakeActionButtons)
    ...
    if (dependencyMap === 2) {
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            if (null != closure_1_9.getUser(closure_1_0)) {
              ...
              obj1[0] = obj2.submitReportForInappropriateConversationSafetyAlert(closure_1_5, () => {
                ...
                obj[2] = tmp4(4408).CircleCheckIcon;
                obj[3] = closure_1_14;
                obj[4] = toastContainer.toastContainer;
                obj.open(obj);
              }, () => {
                const intl = tmp4(1236).intl;
                tmp4(4163).presentFailedToast(intl.string(tmp4(1236).t["0YV04/"]));
              });
              return obj1;
            } else {
              dependencyMap = 3;
          ...
          callback(closure_1_0(10970).CtaEventTypes.USER_TAKEOVER_MODAL_REPORT);
        }
        dependencyMap = 3;
