...
// Function ID: 14919
// Name: IntroScreen
// Dependencies: [32, 19, 17, 1874, 10225, 21, 4255, 712, 589, 4094, 1480, 5921, 4251, 1236, 4665, 10238, 14919, 10244, 5223, 10262, 4460, 10239, 5650, 2]
// Exports: default

// Module 14918 (IntroScreen)
...
function IntroScreen(arg0) {
  ...
  const items1 = [callback2(require(5921) /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  const items3 = [callback2(require(4665) /* Button */.Button, obj4), ];
  ...
  items3[1] = callback2(require(4665) /* Button */.Button, obj5);
  obj3[1] = items3;
...
function TakeActionScreen(arg0) {
  ...
  obj[1] = items;
  const items1 = [callback3(closure_7, obj), callback2(importDefault(14919), { senderId, channelId, isReported, setReported, trackAnalyticsEvent })];
  obj[1] = items1;
  return callback3(closure_7, obj);
}
function SafetyTipsScreen() {
  ...
  const tmp2 = importDefault(10244);
