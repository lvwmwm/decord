...
// Function ID: 15113
// Name: IntroScreen
// Dependencies: [32, 19, 17, 1922, 10385, 21, 4344, 712, 589, 4189, 1499, 6068, 4340, 1236, 4754, 10398, 15113, 10404, 5309, 10422, 4549, 10399, 5822, 2]
// Exports: default
...
function IntroScreen(arg0) {
  ...
  const items1 = [callback2(require(6068) /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  const items2 = [callback2(require(4340) /* Text */.Text, obj1), ];
  ...
  items2[1] = callback2(require(4340) /* Text */.Text, obj2);
  obj[1] = items2;
  ...
  const items3 = [callback2(require(4754) /* Button */.Button, obj4), ];
  ...
  items3[1] = callback2(require(4754) /* Button */.Button, obj5);
  obj3[1] = items3;
...
function TakeActionScreen(arg0) {
  ...
  items[1] = callback2(require(4340) /* Text */.Text, obj1);
  obj[1] = items;
...
function SafetyTipsScreen() {
  ...
  const tmp2 = importDefault(10404);
