...
// Function ID: 14957
// Name: IntroScreen
// Dependencies: [32, 19, 17, 1903, 10256, 21, 4285, 712, 589, 4123, 1480, 5948, 4281, 1236, 4695, 10269, 14957, 10275, 5253, 10293, 4490, 10270, 5704, 2]
// Exports: default

// Module 14956 (IntroScreen)
...
function IntroScreen(arg0) {
  ...
  const items1 = [callback2(require(5948) /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
...
function TakeActionScreen(arg0) {
  ...
  obj[1] = items;
  const items1 = [callback3(closure_7, obj), callback2(importDefault(14957), { senderId, channelId, isReported, setReported, trackAnalyticsEvent })];
  obj[1] = items1;
  return callback3(closure_7, obj);
}
function SafetyTipsScreen() {
  ...
  const tmp2 = importDefault(10275);
