...
// Function ID: 14973
// Name: IntroScreen
// Dependencies: [32, 19, 17, 1903, 10272, 21, 4302, 712, 589, 4140, 1480, 5967, 4298, 1236, 4712, 10285, 14973, 10291, 5269, 10309, 4507, 10286, 5723, 2]
// Exports: default

// Module 14972 (IntroScreen)
...
function IntroScreen(arg0) {
  ...
  const items1 = [callback2(require(5967) /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  const items2 = [callback2(require(4298) /* Text */.Text, obj1), ];
  ...
  items2[1] = callback2(require(4298) /* Text */.Text, obj2);
  obj[1] = items2;
  ...
  const items3 = [callback2(require(4712) /* Button */.Button, obj4), ];
  ...
  items3[1] = callback2(require(4712) /* Button */.Button, obj5);
  obj3[1] = items3;
...
function TakeActionScreen(arg0) {
  ...
  items[1] = callback2(require(4298) /* Text */.Text, obj1);
  obj[1] = items;
  const items1 = [callback3(closure_7, obj), callback2(importDefault(14973), { senderId, channelId, isReported, setReported, trackAnalyticsEvent })];
  obj[1] = items1;
  return callback3(closure_7, obj);
}
function SafetyTipsScreen() {
  ...
  const tmp2 = importDefault(10291);
