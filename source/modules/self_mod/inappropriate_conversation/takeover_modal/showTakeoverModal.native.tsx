...
// Dependencies: [10344, 10351, 4509, 15054, 2007, 2]
// Exports: showTakeoverModal

// Module 16418 (showTakeoverModal)
...
export const showTakeoverModal = function showTakeoverModal(arg0) {
  ...
  if (obj.isEligibleForInappropriateConversationWarning({ location: "takeover-modal" })) {
    ...
    obj[2] = senderId;
    obj[3] = channelId;
    importDefault(4509).pushLazy(require(2007) /* asyncRequireImpl */(15054, dependencyMap.paths), obj, TAKEOVER_MODAL_KEY);
