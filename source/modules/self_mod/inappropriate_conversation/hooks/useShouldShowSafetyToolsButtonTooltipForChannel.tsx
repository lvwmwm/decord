...
// Dependencies: [9587, 687, 10294, 10261, 10295, 10296, 2]
// Exports: useSafetyToolsButtonTooltipForChannel

// Module 10293 (useSafetyToolsButtonTooltipForChannel)
...
export const useSafetyToolsButtonTooltipForChannel = function useSafetyToolsButtonTooltipForChannel(channelId) {
  const inappropriateConversationSafetyToolsWarningForChannel = require(10294) /* useInappropriateConversationSafetyToolsWarningForChannel */.useInappropriateConversationSafetyToolsWarningForChannel(channelId);
  const obj = require(10294) /* useInappropriateConversationSafetyToolsWarningForChannel */;
  const tmp = require;
  ...
  const obj2 = require(10261) /* useInappropriateConversationWarningsForChannel */;
