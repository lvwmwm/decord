...
// Dependencies: [9587, 10294, 589, 2]
// Exports: useShouldShowInitialSafetyToolsButtonTooltip

// Module 10295 (useShouldShowInitialSafetyToolsButtonTooltip)
...
export const useShouldShowInitialSafetyToolsButtonTooltip = function useShouldShowInitialSafetyToolsButtonTooltip(channelId) {
  ...
  const inappropriateConversationSafetyToolsWarningForChannel = _require(10294).useInappropriateConversationSafetyToolsWarningForChannel(channelId);
  const obj = _require(10294);
