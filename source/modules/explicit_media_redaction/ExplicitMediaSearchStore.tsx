...
// Dependencies: [4474, 6953, 589, 709, 2]

// Module 6962 (handleSearchMessagesSuccess)
...
const explicitMediaSearchStore = new ExplicitMediaSearchStore(require("dispatcher"), {
  ...
  MESSAGE_EXPLICIT_CONTENT_SCAN_TIMEOUT: function handleScanTimeout(channelId) {
    ...
    if (null != dependencyMap[combined]) {
      dependencyMap[combined] = require(6953) /* redactionSettingToRenderedString */.handleExplicitMediaScanTimeoutForMessage(tmp2);
      const obj = require(6953) /* redactionSettingToRenderedString */;
    }
  }
});
