...
// Dependencies: [4504, 6980, 589, 709, 2]

// Module 6989 (handleSearchMessagesSuccess)
...
const explicitMediaSearchStore = new ExplicitMediaSearchStore(require("dispatcher"), {
  ...
  MESSAGE_EXPLICIT_CONTENT_SCAN_TIMEOUT: function handleScanTimeout(channelId) {
    ...
    if (null != dependencyMap[combined]) {
      dependencyMap[combined] = require(6980) /* redactionSettingToRenderedString */.handleExplicitMediaScanTimeoutForMessage(tmp2);
      const obj = require(6980) /* redactionSettingToRenderedString */;
    }
  }
});
