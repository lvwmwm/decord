...
obj[obj.EXPLICIT] = {
  ...
  getProtoUserSettings(textAndImages) {
    ...
    const obj = {};
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = prop1;
    let prop2;
    if (prop != null) {
      prop2 = prop.explicitContentFriendDm;
    }
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = prop2;
    let prop3;
    if (prop != null) {
      prop3 = prop.explicitContentNonFriendDm;
    }
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = prop3;
    return obj;
  },
  getUserSettingsWithDefaults(arg0) {
    ...
    if (arg0 == null) {
      ...
      obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = prop2;
      tmp = obj;
    }
    let tmp9;
    if (tmp != null) {
    ...
    obj = { [closure_0(closure_1[3]).ContentHarmTypeChannel.GUILD]: require(5915) /* resolveExplicitContentSettingWithDefaults */.resolveExplicitContentSettingWithDefaults({ setting: tmp9 }) };
    let tmp7Result = tmp7(5915);
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 5914).ContentHarmTypeChannel.FRIEND_DM];
    }
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = tmp7Result.resolveExplicitContentSettingWithDefaults({ setting: tmp10, isDm: true, isFriend: true });
    tmp7Result = tmp7(5915);
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 5914).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = tmp7Result.resolveExplicitContentSettingWithDefaults({ setting: tmp11, isDm: true });
    return obj;
  }
};
const obj1 = {
...
obj[obj.GORE] = {
  ...
  getProtoUserSettings(textAndImages) {
    ...
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = prop;
    return obj;
  },
  getUserSettingsWithDefaults(arg0) {
    let tmp = arg0;
    ...
    obj = { [closure_0(closure_1[3]).ContentHarmTypeChannel.GUILD]: require(5917) /* resolveGoreSettingWithDefaults */.resolveGoreSettingWithDefaults({ setting: tmp9 }) };
    let tmp7Result = tmp7(5917);
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 5914).ContentHarmTypeChannel.FRIEND_DM];
    }
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = tmp7Result.resolveGoreSettingWithDefaults({ setting: tmp10, isDm: true, isFriend: true });
    tmp7Result = tmp7(5917);
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 5914).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = tmp7Result.resolveGoreSettingWithDefaults({ setting: tmp11, isDm: true });
    return obj;
  }
};
const obj2 = {
...
obj[obj.SELF_HARM] = {
  ...
  getUserSettingsWithDefaults() {
    const obj = {};
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = require(1306) /* create */.ExplicitContentRedaction.UNSET_EXPLICIT_CONTENT_REDACTION;
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = require(1306) /* create */.ExplicitContentRedaction.UNSET_EXPLICIT_CONTENT_REDACTION;
    obj[require(5914) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = require(1306) /* create */.ExplicitContentRedaction.UNSET_EXPLICIT_CONTENT_REDACTION;
    return obj;
  }
};
const obj3 = {
