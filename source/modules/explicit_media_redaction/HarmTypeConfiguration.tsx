...
// Dependencies: [676, 5853, 4528, 5854, 3974, 5855, 5857, 1306, 2]

// Module 5852 (ContentHarmType)
import ME from "ME";
...
obj[obj.EXPLICIT] = {
  ...
  getProtoUserSettings(textAndImages) {
    ...
    const obj = {};
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = prop1;
    let prop2;
    if (prop != null) {
      prop2 = prop.explicitContentFriendDm;
    }
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = prop2;
    let prop3;
    if (prop != null) {
      prop3 = prop.explicitContentNonFriendDm;
    }
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = prop3;
    return obj;
  },
  getUserSettingsWithDefaults(arg0) {
    ...
    if (arg0 == null) {
      ...
      let obj = {};
      obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = prop;
      ...
      obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = prop1;
      ...
      obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = prop2;
      tmp = obj;
    }
    let tmp9;
    if (tmp != null) {
    ...
    obj = { [closure_0(closure_1[3]).ContentHarmTypeChannel.GUILD]: require(5855) /* resolveExplicitContentSettingWithDefaults */.resolveExplicitContentSettingWithDefaults({ setting: tmp9 }) };
    let tmp7Result = tmp7(5855);
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 5854).ContentHarmTypeChannel.FRIEND_DM];
    }
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = tmp7Result.resolveExplicitContentSettingWithDefaults({ setting: tmp10, isDm: true, isFriend: true });
    tmp7Result = tmp7(5855);
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 5854).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = tmp7Result.resolveExplicitContentSettingWithDefaults({ setting: tmp11, isDm: true });
    return obj;
  }
};
const obj1 = {
...
obj[obj.GORE] = {
  ...
  getProtoUserSettings(textAndImages) {
    ...
    const obj = {};
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = goreContentGuilds;
    let goreContentFriendDm;
    if (goreContentSettings != null) {
      goreContentFriendDm = goreContentSettings.goreContentFriendDm;
    }
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = goreContentFriendDm;
    let prop;
    if (goreContentSettings != null) {
      prop = goreContentSettings.goreContentNonFriendDm;
    }
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = prop;
    return obj;
  },
  getUserSettingsWithDefaults(arg0) {
    let tmp = arg0;
    ...
    obj = { [closure_0(closure_1[3]).ContentHarmTypeChannel.GUILD]: require(5857) /* resolveGoreSettingWithDefaults */.resolveGoreSettingWithDefaults({ setting: tmp9 }) };
    let tmp7Result = tmp7(5857);
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 5854).ContentHarmTypeChannel.FRIEND_DM];
    }
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = tmp7Result.resolveGoreSettingWithDefaults({ setting: tmp10, isDm: true, isFriend: true });
    tmp7Result = tmp7(5857);
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 5854).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = tmp7Result.resolveGoreSettingWithDefaults({ setting: tmp11, isDm: true });
    return obj;
  }
};
const obj2 = {
...
obj[obj.SELF_HARM] = {
  ...
  getUserSettingsWithDefaults() {
    const obj = {};
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = require(1306) /* create */.ExplicitContentRedaction.UNSET_EXPLICIT_CONTENT_REDACTION;
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = require(1306) /* create */.ExplicitContentRedaction.UNSET_EXPLICIT_CONTENT_REDACTION;
    obj[require(5854) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = require(1306) /* create */.ExplicitContentRedaction.UNSET_EXPLICIT_CONTENT_REDACTION;
    return obj;
  }
};
const obj3 = {
