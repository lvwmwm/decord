...
// Dependencies: [1874, 3864, 1306, 3868, 3875, 3862, 5880, 2]
...
// Module 5879 (resolveExplicitContentSettingWithDefaults)
...
function resolveExplicitContentSettingWithDefaults(isFriend) {
  ...
  if (obj.isSettingTeenByDefault(require(3875) /* SettingsDefaultFeature */.SettingsDefaultFeature.SENSITIVE_CONTENT)) {
    ...
    if (false === nsfwAllowed) {
      ...
      const ExplicitContentFilter2 = tmp4(3862).ExplicitContentFilter;
      ...
      if (flag3) {
        const ExplicitContentFilter = tmp4(3862).ExplicitContentFilter;
...
export const resolveSettingWithDefaultsForTeen = function resolveSettingWithDefaultsForTeen(isDm) {
  ...
  if (flag) {
    const ExplicitContentFilter = tmp(3862).ExplicitContentFilter;
...
export const getExplicitContentSettingOrDefault = function getExplicitContentSettingOrDefault(arg0) {
  let setting = arg0;
  if (arg0 == null) {
    const ExplicitContentSettings = require(3862) /* explicitContentFromProto */.ExplicitContentSettings;
...
export const updateExplicitContentSetting = function updateExplicitContentSetting(arg0) {
  ...
  obj[2] = resolveExplicitContentSettingWithDefaults({ setting: prop2, isDm: true, isFriend: true });
  const ExplicitContentSettings2 = require(3862) /* explicitContentFromProto */.ExplicitContentSettings;
  obj = {};
...
export const shouldRedactMessageMediaForForum = function shouldRedactMessageMediaForForum() {
  if (null == authStore.getCurrentUser()) {
    ...
    return require(5880) /* getShouldObscureForSetting */.getShouldObscureForSetting(tmp10Result);
  }
};
