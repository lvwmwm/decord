...
// Dependencies: [19, 1922, 676, 1306, 3999, 4006, 3993, 2]
...
function resolveGoreSettingWithDefaults(isFriend) {
  ...
  if (obj.isSettingTeenByDefault(require(4006) /* SettingsDefaultFeature */.SettingsDefaultFeature.SENSITIVE_CONTENT)) {
    if (isDm === undefined) {
      isDm = false;
    }
    if (flag === undefined) {
...
export const getGoreContentSettingOrDefault = function getGoreContentSettingOrDefault(arg0) {
  let setting = arg0;
  if (arg0 == null) {
    const GoreContentSettings = require(3993) /* explicitContentFromProto */.GoreContentSettings;
...
export const updateGoreContentSetting = function updateGoreContentSetting(arg0) {
  ...
  obj[2] = resolveGoreSettingWithDefaults({ setting: goreContentFriendDm, isDm: true, isFriend: true });
  const GoreContentSettings2 = require(3993) /* explicitContentFromProto */.GoreContentSettings;
  obj = {};
