...
// Dependencies: [5835, 5837, 5834, 4472, 1212, 11043, 4099, 11044, 1935, 2]
// Exports: handleSenderFalsePositiveFlow

// Module 11042 (handleSenderFalsePositiveFlow)
...
export const handleSenderFalsePositiveFlow = function handleSenderFalsePositiveFlow(channelId, closure_1) {
  ...
  obj = { action: require(5834) /* timeoutAttachmentsAndEmbedsForMessage */.TrackMediaRedactionActionType.EXPLICIT_MEDIA_SENDER_FALSE_POSITIVE_BUTTON_CLICKED, messageId: closure_1, channelId };
  ...
  if (_isNativeReflectConstruct.canSubmitFpReport(closure_1)) {
    ...
    tmp2Result.openLazy(require(1935) /* maybeLoadBundle */(11044, tmp3.paths), closure_4, obj);
  } else {
    tmp2Result = tmp2(4472);
    const obj1 = {};
    ...
    const result1 = tmp2(11043).disableFalsePositiveButton(channelId, closure_1);
  }
  tmp3 = dependencyMap;
};
