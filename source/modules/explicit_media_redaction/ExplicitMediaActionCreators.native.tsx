...
// Dependencies: [5835, 5837, 5834, 4472, 1212, 11042, 4099, 11043, 1935, 2]
// Exports: handleSenderFalsePositiveFlow

// Module 11041 (handleSenderFalsePositiveFlow)
...
export const handleSenderFalsePositiveFlow = function handleSenderFalsePositiveFlow(channelId, closure_1) {
  ...
  if (_isNativeReflectConstruct.canSubmitFpReport(closure_1)) {
    ...
    tmp2Result.openLazy(require(1935) /* maybeLoadBundle */(11043, tmp3.paths), closure_4, obj);
  } else {
    ...
    const result1 = tmp2(11042).disableFalsePositiveButton(channelId, closure_1);
  }
  tmp3 = dependencyMap;
};
