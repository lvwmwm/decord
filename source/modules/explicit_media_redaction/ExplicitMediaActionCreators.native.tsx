...
// Dependencies: [5671, 6835, 6834, 4471, 1212, 8188, 4098, 8189, 1934, 2]
// Exports: handleSenderFalsePositiveFlow

// Module 8187 (handleSenderFalsePositiveFlow)
...
export const handleSenderFalsePositiveFlow = function handleSenderFalsePositiveFlow(channelId, closure_1) {
  ...
  obj = { action: require(6834) /* timeoutAttachmentsAndEmbedsForMessage */.TrackMediaRedactionActionType.EXPLICIT_MEDIA_SENDER_FALSE_POSITIVE_BUTTON_CLICKED, messageId: closure_1, channelId };
  ...
  if (_isNativeReflectConstruct.canSubmitFpReport(closure_1)) {
    ...
    tmp2Result.openLazy(require(1934) /* maybeLoadBundle */(8189, tmp3.paths), closure_4, obj);
  } else {
    ...
    const result1 = tmp2(8188).disableFalsePositiveButton(channelId, closure_1);
  }
  tmp3 = dependencyMap;
};
