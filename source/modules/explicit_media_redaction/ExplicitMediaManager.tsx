...
// Function ID: 6962
// Name: resetManager
// Dependencies: [6948, 1218, 5792, 1372, 4472, 1931, 4072, 6962, 676, 685, 6953, 5803, 5806, 5808, 709, 6963, 6955, 6960, 6964, 6965, 11, 4474, 4404, 5214, 2]

// Module 6961 (resetManager)
  ...
  if (null != message.id) {
    if (null != message.channel_id) {
      ...
      if (null != dependencyMap[combined]) {
        ...
        if (UPDATE === require(6953) /* redactionSettingToRenderedString */.TimeoutCancelSource.UPDATE) {
...
function handleMessageUpdate(message) {
  ...
  if (null != message.channel_id) {
    if (null != message.id) {
      ...
      obj6 = require(5803) /* getEligibleHarmTypesConfigsForContext */;
    }
  }
  return false;
}
  ...
  if (!optimistic.optimistic) {
    if (!optimistic.isPushNotification) {
      if (null != channelId) {
        ...
        obj2 = require(5803) /* getEligibleHarmTypesConfigsForContext */;
      }
    }
  }
  return false;
