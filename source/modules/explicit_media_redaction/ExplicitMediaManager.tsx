...
// Function ID: 7116
// Name: resetManager
// Dependencies: [7102, 1218, 5939, 1391, 4562, 1979, 4165, 7116, 676, 685, 7107, 5950, 5953, 5955, 709, 7117, 7109, 7114, 7118, 7119, 11, 4564, 4494, 5301, 2]

// Module 7115 (resetManager)
  ...
  if (null != message.id) {
    if (null != message.channel_id) {
      ...
      if (null != dependencyMap[combined]) {
        ...
        if (UPDATE === require(7107) /* redactionSettingToRenderedString */.TimeoutCancelSource.UPDATE) {
...
function handleMessageUpdate(message) {
  ...
  if (null != message.channel_id) {
    if (null != message.id) {
      ...
      obj6 = require(5950) /* getEligibleHarmTypesConfigsForContext */;
    }
  }
  return false;
}
  ...
  if (!optimistic.optimistic) {
    if (!optimistic.isPushNotification) {
      if (null != channelId) {
        ...
        obj2 = require(5950) /* getEligibleHarmTypesConfigsForContext */;
      }
    }
  }
  return false;
