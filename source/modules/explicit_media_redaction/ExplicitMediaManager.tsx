...
// Function ID: 6989
// Name: resetManager
// Dependencies: [6975, 1218, 5819, 1372, 4502, 1960, 4101, 6989, 676, 685, 6980, 5830, 5833, 5835, 709, 6990, 6982, 6987, 6991, 6992, 11, 4504, 4434, 5244, 2]

// Module 6988 (resetManager)
  ...
  if (null != message.id) {
    if (null != message.channel_id) {
      ...
      if (null != dependencyMap[combined]) {
        ...
        if (UPDATE === require(6980) /* redactionSettingToRenderedString */.TimeoutCancelSource.UPDATE) {
...
function handleMessageUpdate(message) {
  ...
  if (null != message.channel_id) {
    if (null != message.id) {
      ...
      obj6 = require(5830) /* getEligibleHarmTypesConfigsForContext */;
    }
  }
  return false;
}
  ...
  if (!optimistic.optimistic) {
    if (!optimistic.isPushNotification) {
      if (null != channelId) {
        ...
        obj2 = require(5830) /* getEligibleHarmTypesConfigsForContext */;
      }
    }
  }
  return false;
