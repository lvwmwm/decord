...
// Function ID: 7008
// Name: resetManager
// Dependencies: [6994, 1218, 5838, 1372, 4519, 1960, 4118, 7008, 676, 685, 6999, 5849, 5852, 5854, 709, 7009, 7001, 7006, 7010, 7011, 11, 4521, 4451, 5260, 2]

// Module 7007 (resetManager)
  ...
  if (null != message.id) {
    if (null != message.channel_id) {
      ...
      if (null != dependencyMap[combined]) {
        ...
        if (UPDATE === require(6999) /* redactionSettingToRenderedString */.TimeoutCancelSource.UPDATE) {
...
function handleMessageUpdate(message) {
  ...
  if (null != message.channel_id) {
    if (null != message.id) {
      ...
      obj6 = require(5849) /* getEligibleHarmTypesConfigsForContext */;
    }
  }
  return false;
}
  ...
  if (!optimistic.optimistic) {
    if (!optimistic.isPushNotification) {
      if (null != channelId) {
        ...
        obj2 = require(5849) /* getEligibleHarmTypesConfigsForContext */;
      }
    }
  }
  return false;
