...
// Function ID: 7138
// Name: resetManager
// Dependencies: [7124, 1218, 5960, 1391, 4584, 1979, 4165, 7138, 676, 685, 7129, 5971, 5974, 5976, 709, 7139, 7131, 7136, 7140, 7141, 11, 4586, 4494, 5322, 2]

// Module 7137 (resetManager)
  ...
  if (null != message.id) {
    if (null != message.channel_id) {
      ...
      if (null != dependencyMap[combined]) {
        ...
        if (UPDATE === require(7129) /* redactionSettingToRenderedString */.TimeoutCancelSource.UPDATE) {
...
function handleMessageUpdate(message) {
  ...
  if (null != message.channel_id) {
    if (null != message.id) {
      ...
      obj6 = require(5971) /* getEligibleHarmTypesConfigsForContext */;
    }
  }
  return false;
}
  ...
  if (!optimistic.optimistic) {
    if (!optimistic.isPushNotification) {
      if (null != channelId) {
        ...
        obj2 = require(5971) /* getEligibleHarmTypesConfigsForContext */;
      }
    }
  }
  return false;
