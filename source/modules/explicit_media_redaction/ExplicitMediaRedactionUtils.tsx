...
// Dependencies: [4341, 1391, 5972, 7130, 676, 1306, 1236, 698, 5970, 7131, 7136, 7137, 4040, 5203, 4582, 5975, 2]
...
// Module 7129 (redactionSettingToRenderedString)
...
export const trackMediaRedactionAction = function trackMediaRedactionAction(arg0) {
  ...
  if (null != channelId) {
    if (null != messageId) {
      ...
      obj[2] = channelId;
      obj[3] = messageId;
      obj = require(5970) /* isCurrentUserTeen */;
...
export const trackScanTiming = function trackScanTiming(setAt, UPDATE) {
  ...
  let obj = importDefault(7131);
  obj = { name: require(7136) /* set */.MetricEvents.EXPLICIT_MEDIA_SCAN_CLIENT_TIMING, tags: null };
  ...
  if (null != channelId) {
    if (null != messageId) {
      ...
      if (0 !== num) {
        ...
        obj[2] = messageId;
        obj[3] = embedIds;
        obj[4] = require(5970) /* isCurrentUserTeen */.isCurrentUserTeen();
        obj[5] = require(7137) /* resetManager */.MESSAGE_SCAN_TIMEOUT;
        obj[6] = attachmentIds;
        obj.track(AnalyticEvents.EXPLICIT_MEDIA_SCAN_CLIENT_TIMED_OUT, obj);
        let tmp3Result = tmp3(7131);
        obj = { name: null, tags: null };
        obj[0] = require(7136) /* set */.MetricEvents.EXPLICIT_MEDIA_SCAN_CLIENT_TIMED_OUT;
        obj[1] = ["metricVersion:1"];
        tmp3Result.increment(obj);
        tmp3Result = tmp3(7131);
        const obj1 = { name: null };
        obj1[0] = require(7136) /* set */.MetricEvents.EXPLICIT_MEDIA_SCAN_CLIENT_TIMED_OUT_DISTRIBUTION;
        let num4;
        if (attachmentIds != null) {
        ...
        const obj3 = require(5970) /* isCurrentUserTeen */;
      } else {
        let num3;
        if (embedIds != null) {
...
export const trackExplicitMediaRedactableMessagedLoaded = function trackExplicitMediaRedactableMessagedLoaded(arg0) {
  ...
  if (null != channelId) {
    ...
    if (sum > 0) {
      obj = { name: null };
      obj[0] = require(7136) /* set */.MetricEvents.EXPLICIT_MEDIA_PENDING_MESSAGE_LOADED_V2;
      tmp10(7131).distribution(obj, sum);
      const tmp10Result = tmp10(7131);
    }
...
export const shouldAgeVerifyForExplicitMedia = function shouldAgeVerifyForExplicitMedia() {
  let isFeatureAgeGatedResult = require(4040) /* isFeatureAgeGated */.isFeatureAgeGated(require(5203) /* AgeGatedFeature */.AgeGatedFeature.SENSITIVE_CONTENT_SHOW_SETTING);
...
export const useShouldAgeVerifyForExplicitMedia = function useShouldAgeVerifyForExplicitMedia() {
  let isFeatureAgeGated = require(4040) /* isFeatureAgeGated */.useIsFeatureAgeGated(require(5203) /* AgeGatedFeature */.AgeGatedFeature.SENSITIVE_CONTENT_SHOW_SETTING);
  const obj = require(4040) /* isFeatureAgeGated */;
...
export const useShouldAgeVerifyForReason = function useShouldAgeVerifyForReason(obscureReason) {
  ...
  let hasItem = !tmp4;
  if (!tmp4) {
    const AGE_VERIFICATION_OBSCURABLE_REASONS = tmp(5975).AGE_VERIFICATION_OBSCURABLE_REASONS;
