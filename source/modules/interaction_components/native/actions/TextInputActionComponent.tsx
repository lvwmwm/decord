// Module ID: 16884
// Function ID: 16885
// Dependencies: [32, 19, 21, 7953, 16881, 1955, 6174, 7742, 7639, 2]
...
const memoResult = importAllResult.memo((type) => {
  ...
  const isFirstTextInputInModal = type(16881).useIsFirstTextInputInModal(type.id);
  ...
  if (type(1955).TextInputComponentStyle.SMALL === style) {
    ...
    let tmp7 = jsx(tmp(6174).TextField, {});
  } else if (tmp(1955).TextInputComponentStyle.PARAGRAPH === style) {
    const obj2 = {};
    const merged1 = Object.assign(obj);
    tmp7 = jsx(tmp(7742).TextAreaField, {});
  }
  let tmp16 = tmp7;
  if (null != label) {
    ...
    obj3[2] = error;
    obj3[3] = tmp7;
    tmp16 = jsx(tmp(7639).Input, { label: null, required: null, errorMessage: null, children: null });
  }
  return tmp16;
});
