...
// Dependencies: [5, 19, 17, 1391, 4825, 676, 21, 4661, 4269, 6291, 13987, 1236, 4805, 4335, 10139, 8035, 6368, 8326, 38, 589, 11336, 4876, 4834, 16608, 1954, 4827, 4838, 11168, 8466, 10270, 1892, 10269, 4836, 4733, 712, 6286, 2]
// Exports: default

// Module 16607 (MainAreaCanUpload)
import ME from "ME";
...
function MainAreaCanUpload(arg0) {
  ...
  let obj = require(4269) /* formatSize */;
  obj = { onPress: openFilePicker, icon: null, label: null, subLabel: null, start: true, end: true, arrow: true };
  obj = { IconComponent: null };
  obj[0] = require(13987) /* FileUpIcon */.FileUpIcon;
  obj[1] = callback(require(6291) /* TableRowInner */.TableRow.Icon, obj);
  const intl = require(1236) /* getSystemLocale */.intl;
  obj[2] = intl.format(require(1236) /* getSystemLocale */.t["/2JwTv"], { maxValues });
  const formatSizeResult = obj.formatSize(maxSizeBytes / require(4269) /* formatSize */.BYTE_IN_KB, { useKibibytes: true, useSpace: true });
  obj[3] = require(4805) /* flattenComponents */.getFileUploadComponentSubtitle(minValues, maxValues, types, formatSizeResult);
...
function MainAreaLimitReached() {
  ...
  obj = { IconComponent: null };
  obj[0] = require(4335) /* CircleCheckIcon */.CircleCheckIcon;
  obj[0] = callback(require(6291) /* TableRowInner */.TableRow.Icon, obj);
  const intl = require(1236) /* getSystemLocale */.intl;
...
function File(upload) {
  ...
  obj2[2] = callback(upload(6368).XSmallIcon, { size: "sm" });
        ...
        while (true) {
          ...
          if (closure_1 === undefined) {
            ...
            if (outer1_4.length > 0) {
              ...
              let tmp30 = outer1_5;
              let tmp31 = lib;
              if (!outer1_5(lib.map((result1) => callback(4838).getFileFromUploadItem(result1).filename))) {
  ...
  const callback2 = allowedExtensions.useCallback(() => {
    ...
    if (mediaFilesAllowed) {
      ...
      obj[10] = function onManageLimited() {
        let obj = InteractionModal(10269);
