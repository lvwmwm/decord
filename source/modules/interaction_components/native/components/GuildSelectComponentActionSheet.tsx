...
// Dependencies: [32, 19, 17, 1910, 5196, 21, 4342, 4572, 1236, 4310, 11272, 5819, 4534, 1297, 4338, 5200, 2]
// Exports: default

// Module 14026 (GuildSelectComponentActionSheet)
...
export default function GuildSelectComponentActionSheet(arg0) {
  ...
  first = tmp2[0];
  obj = { type: require(4572) /* ActionComponentState */.SelectOptionType.GUILD, value: selectedGuild.id, label: selectedGuild.name, guild: selectedGuild };
  ...
  return callback(importDefault(11272), {
