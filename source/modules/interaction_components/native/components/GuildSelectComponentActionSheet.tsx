...
// Dependencies: [32, 19, 17, 1891, 5137, 21, 4285, 4512, 1236, 4253, 11139, 5700, 4474, 1297, 4281, 5141, 2]
// Exports: default

// Module 13875 (GuildSelectComponentActionSheet)
...
export default function GuildSelectComponentActionSheet(arg0) {
  ...
  return callback(importDefault(11139), {
