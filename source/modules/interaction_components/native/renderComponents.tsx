...
// Dependencies: [19, 21, 1954, 16482, 15044, 16483, 15047, 15048, 16484, 16485, 16487, 16488, 16489, 2]

// Module 16481 (renderComponents)
import "noop";
...
function renderComponent(component, arg1) {
  ...
  if (require(1954) /* PermissionOverwriteType */.ComponentType.ACTION_ROW === type) {
    ...
    return jsx(importDefault(15047), {}, arg1);
  }
}
