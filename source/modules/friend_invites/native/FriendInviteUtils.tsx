...
// Dependencies: [1372, 3826, 6693, 3890, 1236, 10356, 709, 10926, 2]
// Exports: acceptFriendInvite, revokeAllFriendInvites

// Module 16122 (DEFAULT_EXPIRATION_DAYS)
...
export const revokeAllFriendInvites = function revokeAllFriendInvites() {
  let obj = importDefault(6693);
  importDefault(6693).revokeFriendInvites().then(() => {
...
export const acceptFriendInvite = function acceptFriendInvite(invite, arg1) {
  ...
  if (tmp) {
    ...
    if (null != dMFromUserId) {
      importDefault(6693).transitionToInvite(invite, { forceTransition: true });
