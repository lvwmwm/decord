...
// Function ID: 6958
// Name: getSearchIndex
// Dependencies: [32, 1990, 1922, 687, 6958, 6981, 6986, 6960, 12, 6962, 2]

// Module 6957 (getSearchIndex)
...
prototype["getSearchIndex"] = function getSearchIndex() {
  if (null != this._search) {
    if (!this._search.hasDefaultQuery) {
      let CURRENT_GUILD_MEMBER = require(6958) /* getGuildMemberSecondaryIndexes */.MemberSafetySecondaryIndex.INCLUDED_IN_SEARCH_RESULTS;
    }
    return CURRENT_GUILD_MEMBER;
  }
  CURRENT_GUILD_MEMBER = require(6958) /* getGuildMemberSecondaryIndexes */.MemberSafetySecondaryIndex.CURRENT_GUILD_MEMBER;
};
prototype["initialize"] = function initialize() {
  ...
  if (this._initialized) {
    ...
    const guildMemberSafetySearch = new require(6981) /* hasStringMatch */.GuildMemberSafetySearch(self.guildId);
    self._search = guildMemberSafetySearch;
    const guildMemberSafetyMembers = new require(6958) /* getGuildMemberSecondaryIndexes */.GuildMemberSafetyMembers(self.guildId);
    self._members = guildMemberSafetyMembers;
    ({ guildId, _members } = self);
    const guildMemberSafetyPagination = new require(6986) /* items */.GuildMemberSafetyPagination(guildId, _members.values(self.getSearchIndex()));
  ...
  get: function searchChunkSize() {
    ...
    if (null != this._pagination) {
      ...
      if (self._initialized) {
        const _pagination = self._pagination;
        num = require(6986) /* items */.getSearchChunkLimit(_pagination.getPaginationState());
        const obj = require(6986) /* items */;
      }
    }
    return num;
  },
      ...
      while (iter !== undefined) {
        ...
        if (null != nextResult.joinedAt) {
          ...
          if (flag2) {
            ...
            let obj2 = require(6960) /* getJoinedAtDateFormatter */;
  ...
  if (null != this._search) {
    if (null != self._members) {
      if (self._initialized) {
        ...
        const _members = self._members;
        const cloneDeepResult = obj.cloneDeep(_members.values(require(6958) /* getGuildMemberSecondaryIndexes */.MemberSafetySecondaryIndex.NEW_GUILD_MEMBER));
        let flag2 = false;
  ...
  if (null != this._members) {
    if (null != self._search) {
      if (self._initialized) {
        ...
        let obj = require(12) /* apply */;
        const _members = self._members;
        const cloneDeepResult = obj.cloneDeep(_members.values(require(6958) /* getGuildMemberSecondaryIndexes */.MemberSafetySecondaryIndex.CURRENT_GUILD_MEMBER));
...
prototype["getSearchState"] = function getSearchState() {
  ...
  searchState = require(6981) /* hasStringMatch */.getDefaultSearchState();
};
...
prototype["getPaginationState"] = function getPaginationState() {
  ...
  paginationState = require(6986) /* items */.createDefaultMemberSafetyPaginationState();
};
