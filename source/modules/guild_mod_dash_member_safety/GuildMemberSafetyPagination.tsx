...
prototype["reset"] = function reset() {
  this._paginationState = { pageSize: items[0], currentPage: 1, continuationToken: null, sort: require(6956) /* result */.OrderBy.ORDER_BY_UNSPECIFIED, elasticSearchCursor: null };
...
export const createDefaultMemberSafetyPaginationState = function createDefaultMemberSafetyPaginationState() {
  return { pageSize: items[0], currentPage: 1, continuationToken: null, sort: require(6956) /* result */.OrderBy.ORDER_BY_UNSPECIFIED, elasticSearchCursor: null };
};
