...
// Dependencies: [1874, 3879, 6850, 6851, 6853, 6854, 6860, 4414, 2]
// Exports: hasUnusualDmActivity

// Module 6849 (getGuildMemberSecondaryIndexes)
...
prototype["enhanceNewMember"] = function enhanceNewMember(trueMember, searchState, isIncludedInSearchResults) {
  ...
  const joinedAtTimestamp = require(6851) /* getJoinedAtDateFormatter */.getJoinedAtTimestamp(trueMember.joinedAt);
  ...
  obj.user = user;
  const obj2 = require(6851) /* getJoinedAtDateFormatter */;
  const tmp = require;
  ...
  obj.sort = require(6853) /* getSortValueForMember */.getSortValueForMember(trueMember, ORDER_BY_UNSPECIFIED);
...
prototype["_computeMemberSupplementals"] = function _computeMemberSupplementals(userId, unusualDMActivityUntil) {
  let obj = require(6854) /* hasMemberSupplemental */;
  ...
  obj[6] = tmp9;
  obj[7] = require(6860) /* isSpamSupported */.isSpammer(userId);
  return obj;
};
  ...
  if (null == arg1) {
    ...
    if (keys !== undefined) {
      ...
      while (keys[tmp] !== undefined) {
        ...
        if (importDefault(4414)(tmp15, obj[tmp6])) {
          continue;
        } else {
          obj[tmp6] = tmp15;
          flag = true;
...
export const hasUnusualDmActivity = function hasUnusualDmActivity(arg0) {
  ...
  if (tmp) {
    ...
    const time = date.getTime();
    tmp = time >= closure_4 - require(6850) /* result */.UNUSUAL_DM_COMPARISON_DELTA;
  }
  return tmp;
};
