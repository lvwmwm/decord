...
// Dependencies: [1874, 3909, 6865, 6866, 6868, 6869, 6875, 4444, 2]
// Exports: hasUnusualDmActivity

// Module 6864 (getGuildMemberSecondaryIndexes)
...
prototype["reset"] = function reset() {
  ...
  _membersMap.clear();
  const secondaryIndexMap = new require(3909) /* version */.SecondaryIndexMap(getGuildMemberSecondaryIndexes, getGuildMemberSecondarySortBy);
...
prototype["enhanceNewMember"] = function enhanceNewMember(trueMember, searchState, isIncludedInSearchResults) {
  ...
  const joinedAtTimestamp = require(6866) /* getJoinedAtDateFormatter */.getJoinedAtTimestamp(trueMember.joinedAt);
  ...
  obj.user = user;
  const obj2 = require(6866) /* getJoinedAtDateFormatter */;
  const tmp = require;
  ...
  obj.sort = require(6868) /* getSortValueForMember */.getSortValueForMember(trueMember, ORDER_BY_UNSPECIFIED);
...
prototype["_computeMemberSupplementals"] = function _computeMemberSupplementals(userId, unusualDMActivityUntil) {
  let obj = require(6869) /* hasMemberSupplemental */;
  ...
  obj[6] = tmp9;
  obj[7] = require(6875) /* isSpamSupported */.isSpammer(userId);
  return obj;
};
...
export const hasUnusualDmActivity = function hasUnusualDmActivity(arg0) {
  ...
  if (tmp) {
    ...
    const time = date.getTime();
    tmp = time >= closure_4 - require(6865) /* result */.UNUSUAL_DM_COMPARISON_DELTA;
  }
  return tmp;
};
