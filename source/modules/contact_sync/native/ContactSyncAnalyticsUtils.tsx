...
// Function ID: 90915
// Name: Steps
// Dependencies: [1850, 11703, 11704, 653, 11706, 675, 11709, 2]
...
export const trackFlowStep = function trackFlowStep(ADD_PHONE_NUMBER, skip, arg2, location) {
  ...
  if (tmp) {
    obj = { skip };
    require(11709) /* trackNUFStep */.trackNUFStep(closure_8, ADD_PHONE_NUMBER, obj);
    const obj3 = require(11709) /* trackNUFStep */;
  }
