...
// Dependencies: [5, 5039, 1922, 12095, 12097, 12096, 676, 4557, 12098, 12100, 698, 12102, 1236, 4684, 4062, 9922, 8568, 4241, 4550, 12103, 2007, 9114, 691, 12122, 2]
...
// Module 12094 (handleNameInputScreenOrSuggestions)
          ...
          if (0 === trackResult1) {
            ...
            if (arg0 === 1) {
              ...
              if (set === constants.NOT_DETERMINED) {
                callback(12100).trackFlowStep(callback(12100).Steps.PERMISSION_REQUESTED, false, false);
                const obj16 = callback(12100);
              }
              v0 = 1;
              trackResult1 = 3;
              v02 = 1;
              const obj3 = { value: null, done: false };
              obj3[0] = callback(12098).getContacts(callback);
              return obj3;
            }
          } else {
            if (2 === tmp8) {
              ...
              if (closure_13 === callback(12098).ContactSyncPermissionDenied) {
                const obj15 = callback(12100);
                obj15.trackFlowStep(callback(12100).Steps.LANDING, true, false, { mobile_contacts_permission: "denied" });
              ...
              if (3 === tmp8) {
                if (arg0 === 1) {
                  ...
                  if (null == name) {
                    obj5 = callback(12100);
                    obj5.trackFlowStep(callback(12100).Steps.NAME_INPUT, false, false);
                ...
                SUGGESTIONS_RESULTS = callback(12100).Steps.SUGGESTIONS_RESULTS;
                obj2 = callback(12098);
                trackResult1 = 5;
                v02 = 1;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (null == phone) {
                let obj2 = callback(12100);
                obj2.trackFlowStep(callback(12100).Steps.ADD_PHONE_NUMBER, false, false);
                outer1_9(null);
...
function closeContactSyncModal(skip) {
  ...
  if (null != onComplete) {
    ...
    obj[0] = friendsFound;
    obj[1] = friendsAdded;
    flag2(12100).trackFlowEnd(flag, obj);
    if (tmp16) {
      onComplete(flag);
    } else {
    ...
    if (tmp2) {
      let updateAnimation = back(4550).updateAnimation;
...
export const goBackToLanding = function goBackToLanding(closure_1) {
  require(12100) /* Steps */.trackFlowStep(require(12100) /* Steps */.Steps.LANDING, false, true);
  closure_1.pop(closure_1.getState().routes.length - 1);
};
export const submitPhone = function submitPhone(arg0, closure_0) {
  callback2(arg0);
  require(12100) /* Steps */.trackFlowStep(require(12100) /* Steps */.Steps.VERIFY_PHONE_NUMBER, false, false);
...
export const openContactSyncModal = function openContactSyncModal(initialRoutes, FRIENDS_ADD_FRIENDS_MODAL) {
  ...
  if (FRIENDS_ADD_FRIENDS_MODAL) {
    ...
    tmp(12100).trackFlowStart(obj);
    const tmpResult = tmp(12100);
  }
  ...
  importDefault(4550).pushLazy(require(2007) /* asyncRequireImpl */(12103, dependencyMap.paths), obj, closure_20).then(arg2);
};
export const openContactSyncModalOnboarding = function openContactSyncModalOnboarding() {
  ...
  if (!flag) {
    ...
    obj = { page: null };
    obj[0] = require(12100) /* Steps */.CONTACT_SYNC_ONBOARDING_LOCATION;
    obj[0] = obj;
    require(12100) /* Steps */.trackFlowStart(obj);
    const obj2 = require(12100) /* Steps */;
    ...
    obj = require(9114) /* showInstantInviteActionSheet */;
...
export const openContactSyncModalDeeplink = function openContactSyncModalDeeplink() {
  let obj = {};
  const result = require(12098) /* _uploadContacts */.checkContactPermissions();
  result.then((arg0) => {
    callback(arg0);
  });
  ...
  const obj2 = require(12098) /* _uploadContacts */;
  const tmp2 = dependencyMap;
  require(12100) /* Steps */.trackFlowStart({ location: { page: "Deep Link" } });
  const tmpResult = require(12100) /* Steps */;
  obj = { initialRoutes: obj.initialRoutes, openSettingsSheet: obj.openSettings, customLandingPage: obj.customLandingPage };
  const obj4 = importDefault(4550);
  importDefault(4550).pushLazy(require(2007) /* asyncRequireImpl */(12103, tmp2.paths), obj, closure_20).then(undefined);
};
