...
// Dependencies: [5, 4998, 1903, 12032, 12034, 12033, 676, 4516, 12035, 12037, 698, 12039, 1236, 4643, 4002, 9878, 8519, 4202, 4509, 12040, 1988, 9065, 691, 12059, 2]
...
// Module 12031 (handleNameInputScreenOrSuggestions)
          ...
          if (0 === trackResult1) {
            ...
            if (arg0 === 1) {
              ...
              if (set === constants.NOT_DETERMINED) {
                callback(12037).trackFlowStep(callback(12037).Steps.PERMISSION_REQUESTED, false, false);
                const obj16 = callback(12037);
              }
              v0 = 1;
              trackResult1 = 3;
              v02 = 1;
              const obj3 = { value: null, done: false };
              obj3[0] = callback(12035).getContacts(callback);
              return obj3;
            }
          } else {
            if (2 === tmp8) {
              ...
              if (closure_13 === callback(12035).ContactSyncPermissionDenied) {
                const obj15 = callback(12037);
                obj15.trackFlowStep(callback(12037).Steps.LANDING, true, false, { mobile_contacts_permission: "denied" });
              ...
              if (3 === tmp8) {
                if (arg0 === 1) {
                  ...
                  if (null == name) {
                    obj5 = callback(12037);
                    obj5.trackFlowStep(callback(12037).Steps.NAME_INPUT, false, false);
                ...
                SUGGESTIONS_RESULTS = callback(12037).Steps.SUGGESTIONS_RESULTS;
                obj2 = callback(12035);
                trackResult1 = 5;
                v02 = 1;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (null == phone) {
                let obj2 = callback(12037);
                obj2.trackFlowStep(callback(12037).Steps.ADD_PHONE_NUMBER, false, false);
                outer1_9(null);
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            if (301 !== lib.status) {
              if (404 !== lib.status) {
                const aPIError = new lib(4202).APIError(lib);
...
function closeContactSyncModal(skip) {
  ...
  if (null != onComplete) {
    ...
    obj[0] = friendsFound;
    obj[1] = friendsAdded;
    flag2(12037).trackFlowEnd(flag, obj);
    if (tmp16) {
      onComplete(flag);
    } else {
    ...
    if (tmp2) {
      let updateAnimation = back(4509).updateAnimation;
...
export const goBackToLanding = function goBackToLanding(closure_1) {
  require(12037) /* Steps */.trackFlowStep(require(12037) /* Steps */.Steps.LANDING, false, true);
  closure_1.pop(closure_1.getState().routes.length - 1);
};
export const submitPhone = function submitPhone(arg0, closure_0) {
  callback2(arg0);
  require(12037) /* Steps */.trackFlowStep(require(12037) /* Steps */.Steps.VERIFY_PHONE_NUMBER, false, false);
...
export const openContactSyncModal = function openContactSyncModal(initialRoutes, FRIENDS_ADD_FRIENDS_MODAL) {
  ...
  if (FRIENDS_ADD_FRIENDS_MODAL) {
    ...
    tmp(12037).trackFlowStart(obj);
    const tmpResult = tmp(12037);
  }
  ...
  const obj4 = importDefault(4509);
  const tmp2 = dependencyMap;
  importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(12040, dependencyMap.paths), obj, closure_20).then(arg2);
};
export const openContactSyncModalOnboarding = function openContactSyncModalOnboarding() {
  ...
  if (!flag) {
    ...
    obj = { page: null };
    obj[0] = require(12037) /* Steps */.CONTACT_SYNC_ONBOARDING_LOCATION;
    obj[0] = obj;
    require(12037) /* Steps */.trackFlowStart(obj);
    const obj2 = require(12037) /* Steps */;
    ...
    obj = require(9065) /* showInstantInviteActionSheet */;
...
export const openContactSyncModalDeeplink = function openContactSyncModalDeeplink() {
  let obj = {};
  const result = require(12035) /* _uploadContacts */.checkContactPermissions();
  result.then((arg0) => {
    callback(arg0);
  });
  ...
  const obj2 = require(12035) /* _uploadContacts */;
  const tmp2 = dependencyMap;
  require(12037) /* Steps */.trackFlowStart({ location: { page: "Deep Link" } });
  const tmpResult = require(12037) /* Steps */;
  obj = { initialRoutes: obj.initialRoutes, openSettingsSheet: obj.openSettings, customLandingPage: obj.customLandingPage };
  const obj4 = importDefault(4509);
  importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(12040, tmp2.paths), obj, closure_20).then(undefined);
};
