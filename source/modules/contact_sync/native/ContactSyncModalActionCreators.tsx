...
// Dependencies: [5, 4998, 1903, 12031, 12033, 12032, 676, 4516, 12034, 12036, 698, 12038, 1236, 4643, 4002, 9877, 8519, 4202, 4509, 12039, 1988, 9065, 691, 12058, 2]
...
// Module 12030 (handleNameInputScreenOrSuggestions)
          ...
          if (0 === trackResult1) {
            ...
            if (arg0 === 1) {
              ...
              if (set === constants.NOT_DETERMINED) {
                callback(12036).trackFlowStep(callback(12036).Steps.PERMISSION_REQUESTED, false, false);
                const obj16 = callback(12036);
              }
              v0 = 1;
              trackResult1 = 3;
              v02 = 1;
              const obj3 = { value: null, done: false };
              obj3[0] = callback(12034).getContacts(callback);
              return obj3;
            }
          } else {
            if (2 === tmp8) {
              ...
              if (closure_13 === callback(12034).ContactSyncPermissionDenied) {
                const obj15 = callback(12036);
                obj15.trackFlowStep(callback(12036).Steps.LANDING, true, false, { mobile_contacts_permission: "denied" });
              ...
              if (3 === tmp8) {
                if (arg0 === 1) {
                  ...
                  if (null == name) {
                    obj5 = callback(12036);
                    obj5.trackFlowStep(callback(12036).Steps.NAME_INPUT, false, false);
                ...
                SUGGESTIONS_RESULTS = callback(12036).Steps.SUGGESTIONS_RESULTS;
                obj2 = callback(12034);
                trackResult1 = 5;
                v02 = 1;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (null == phone) {
                let obj2 = callback(12036);
                obj2.trackFlowStep(callback(12036).Steps.ADD_PHONE_NUMBER, false, false);
                outer1_9(null);
...
function closeContactSyncModal(skip) {
  ...
  if (null != onComplete) {
    ...
    obj[0] = friendsFound;
    obj[1] = friendsAdded;
    flag2(12036).trackFlowEnd(flag, obj);
    if (tmp16) {
      onComplete(flag);
    } else {
...
export const goBackToLanding = function goBackToLanding(closure_1) {
  require(12036) /* Steps */.trackFlowStep(require(12036) /* Steps */.Steps.LANDING, false, true);
  closure_1.pop(closure_1.getState().routes.length - 1);
};
export const submitPhone = function submitPhone(arg0, closure_0) {
  callback2(arg0);
  require(12036) /* Steps */.trackFlowStep(require(12036) /* Steps */.Steps.VERIFY_PHONE_NUMBER, false, false);
...
export const openContactSyncModal = function openContactSyncModal(initialRoutes, FRIENDS_ADD_FRIENDS_MODAL) {
  ...
  importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(12039, dependencyMap.paths), obj, closure_20).then(arg2);
};
export const openContactSyncModalOnboarding = function openContactSyncModalOnboarding() {
  ...
  if (!flag) {
    ...
    obj = { page: null };
    obj[0] = require(12036) /* Steps */.CONTACT_SYNC_ONBOARDING_LOCATION;
    obj[0] = obj;
    require(12036) /* Steps */.trackFlowStart(obj);
    const obj2 = require(12036) /* Steps */;
...
export const openContactSyncModalDeeplink = function openContactSyncModalDeeplink() {
  let obj = {};
  const result = require(12034) /* _uploadContacts */.checkContactPermissions();
  result.then((arg0) => {
    callback(arg0);
  });
  ...
  const obj2 = require(12034) /* _uploadContacts */;
  const tmp2 = dependencyMap;
  require(12036) /* Steps */.trackFlowStart({ location: { page: "Deep Link" } });
  const tmpResult = require(12036) /* Steps */;
  obj = { initialRoutes: obj.initialRoutes, openSettingsSheet: obj.openSettings, customLandingPage: obj.customLandingPage };
  const obj4 = importDefault(4509);
  importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(12039, tmp2.paths), obj, closure_20).then(undefined);
};
