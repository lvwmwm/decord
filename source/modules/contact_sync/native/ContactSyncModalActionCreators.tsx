...
// Dependencies: [5, 5190, 1923, 12148, 12150, 12149, 676, 4696, 12151, 12153, 698, 12155, 1236, 4823, 4163, 9457, 7718, 4344, 4689, 12156, 2010, 9847, 691, 12175, 2]
...
// Module 12147 (handleNameInputScreenOrSuggestions)
import asyncRequireImpl from "asyncRequireImpl" /* 2010 */;
import _modDef4689 from "module_4689" /* 4689 */;
import showInstantInviteActionSheet from "showInstantInviteActionSheet" /* 9847 */;
import _uploadContacts from "_uploadContacts" /* 12151 */;
import Steps from "Steps" /* 12153 */;
          ...
          if (0 === trackResult1) {
            ...
            if (arg0 === 1) {
              ...
              if (closure_4 === constants.NOT_DETERMINED) {
                callback(12153).trackFlowStep(callback(12153).Steps.PERMISSION_REQUESTED, false, false);
                const obj16 = callback(12153);
              }
              v0 = 1;
              trackResult1 = 3;
              v02 = 1;
              const obj3 = { value: null, done: false };
              obj3[0] = callback(12151).getContacts(callback);
              return obj3;
            }
          } else {
            if (2 === tmp8) {
              ...
              if (closure_13 === callback(12151).ContactSyncPermissionDenied) {
                const obj15 = callback(12153);
                obj15.trackFlowStep(callback(12153).Steps.LANDING, true, false, { mobile_contacts_permission: "denied" });
              ...
              if (3 === tmp8) {
                if (arg0 === 1) {
                  ...
                  if (null == name) {
                    obj5 = callback(12153);
                    obj5.trackFlowStep(callback(12153).Steps.NAME_INPUT, false, false);
                ...
                SUGGESTIONS_RESULTS = callback(12153).Steps.SUGGESTIONS_RESULTS;
                obj2 = callback(12151);
                trackResult1 = 5;
                v02 = 1;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (null == phone) {
                let obj2 = callback(12153);
                obj2.trackFlowStep(callback(12153).Steps.ADD_PHONE_NUMBER, false, false);
                closure_1_9(null);
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            if (301 !== lib.status) {
              if (404 !== lib.status) {
                const aPIError = new lib(4344).APIError(lib);
...
function closeContactSyncModal(skip) {
  ...
  if (null != onComplete) {
    ...
    obj[0] = friendsFound;
    obj[1] = friendsAdded;
    flag2(12153).trackFlowEnd(flag, obj);
    if (tmp16) {
      onComplete(flag);
    } else {
      const _setTimeout2 = setTimeout;
      const timerId = setTimeout(() => {
        back(4689).popWithKey(closure_20);
      }, 0);
    }
    const obj3 = flag2(12153);
  } else {
    flag2 = flag;
    if (flag === undefined) {
      flag2 = true;
    ...
    if (tmp2) {
      let updateAnimation = back(4689).updateAnimation;
...
export const openContactSyncModal = function openContactSyncModal(initialRoutes, FRIENDS_ADD_FRIENDS_MODAL) {
  ...
  if (FRIENDS_ADD_FRIENDS_MODAL) {
    ...
    tmp(12153).trackFlowStart(obj);
    const tmpResult = tmp(12153);
  }
  ...
  _modDef4689.pushLazy(asyncRequireImpl(12156, dependencyMap.paths), obj, closure_20).then(arg2);
};
...
export const openContactSyncModalDeeplink = function openContactSyncModalDeeplink() {
  ...
  const obj4 = _modDef4689;
  _modDef4689.pushLazy(asyncRequireImpl(12156, tmp2.paths), obj, closure_20).then(undefined);
};
