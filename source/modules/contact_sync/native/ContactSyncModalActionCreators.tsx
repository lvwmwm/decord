...
// Dependencies: [5, 5038, 1922, 12092, 12094, 12093, 676, 4556, 12095, 12097, 698, 12099, 1236, 4683, 4062, 9924, 8564, 4243, 4549, 12100, 2007, 9110, 691, 12119, 2]
...
// Module 12091 (handleNameInputScreenOrSuggestions)
          ...
          if (0 === trackResult1) {
            ...
            if (arg0 === 1) {
              ...
              if (set === constants.NOT_DETERMINED) {
                callback(12097).trackFlowStep(callback(12097).Steps.PERMISSION_REQUESTED, false, false);
                const obj16 = callback(12097);
              }
              v0 = 1;
              trackResult1 = 3;
              v02 = 1;
              const obj3 = { value: null, done: false };
              obj3[0] = callback(12095).getContacts(callback);
              return obj3;
            }
          } else {
            if (2 === tmp8) {
              ...
              if (closure_13 === callback(12095).ContactSyncPermissionDenied) {
                const obj15 = callback(12097);
                obj15.trackFlowStep(callback(12097).Steps.LANDING, true, false, { mobile_contacts_permission: "denied" });
              ...
              if (3 === tmp8) {
                if (arg0 === 1) {
                  ...
                  if (null == name) {
                    obj5 = callback(12097);
                    obj5.trackFlowStep(callback(12097).Steps.NAME_INPUT, false, false);
                ...
                SUGGESTIONS_RESULTS = callback(12097).Steps.SUGGESTIONS_RESULTS;
                obj2 = callback(12095);
                trackResult1 = 5;
                v02 = 1;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (null == phone) {
                let obj2 = callback(12097);
                obj2.trackFlowStep(callback(12097).Steps.ADD_PHONE_NUMBER, false, false);
                outer1_9(null);
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            if (301 !== lib.status) {
              if (404 !== lib.status) {
                const aPIError = new lib(4243).APIError(lib);
...
function closeContactSyncModal(skip) {
  ...
  if (null != onComplete) {
    ...
    obj[0] = friendsFound;
    obj[1] = friendsAdded;
    flag2(12097).trackFlowEnd(flag, obj);
    if (tmp16) {
      onComplete(flag);
    } else {
    ...
    if (tmp2) {
      let updateAnimation = back(4549).updateAnimation;
...
export const goBackToLanding = function goBackToLanding(closure_1) {
  require(12097) /* Steps */.trackFlowStep(require(12097) /* Steps */.Steps.LANDING, false, true);
  closure_1.pop(closure_1.getState().routes.length - 1);
};
export const submitPhone = function submitPhone(arg0, closure_0) {
  callback2(arg0);
  require(12097) /* Steps */.trackFlowStep(require(12097) /* Steps */.Steps.VERIFY_PHONE_NUMBER, false, false);
...
export const openContactSyncModal = function openContactSyncModal(initialRoutes, FRIENDS_ADD_FRIENDS_MODAL) {
  ...
  const obj4 = importDefault(4549);
  const tmp2 = dependencyMap;
  importDefault(4549).pushLazy(require(2007) /* asyncRequireImpl */(12100, dependencyMap.paths), obj, closure_20).then(arg2);
};
export const openContactSyncModalOnboarding = function openContactSyncModalOnboarding() {
  ...
  if (!flag) {
    ...
    obj = { page: null };
    obj[0] = require(12097) /* Steps */.CONTACT_SYNC_ONBOARDING_LOCATION;
    obj[0] = obj;
    require(12097) /* Steps */.trackFlowStart(obj);
    const obj2 = require(12097) /* Steps */;
    ...
    obj = require(9110) /* showInstantInviteActionSheet */;
...
export const openContactSyncModalDeeplink = function openContactSyncModalDeeplink() {
  let obj = {};
  const result = require(12095) /* _uploadContacts */.checkContactPermissions();
  result.then((arg0) => {
    callback(arg0);
  });
  ...
  const obj2 = require(12095) /* _uploadContacts */;
  const tmp2 = dependencyMap;
  require(12097) /* Steps */.trackFlowStart({ location: { page: "Deep Link" } });
  const tmpResult = require(12097) /* Steps */;
  obj = { initialRoutes: obj.initialRoutes, openSettingsSheet: obj.openSettings, customLandingPage: obj.customLandingPage };
  const obj4 = importDefault(4549);
  importDefault(4549).pushLazy(require(2007) /* asyncRequireImpl */(12100, tmp2.paths), obj, closure_20).then(undefined);
};
