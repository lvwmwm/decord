...
// Dependencies: [5, 4996, 1903, 11965, 11967, 11966, 676, 4514, 11968, 11970, 698, 11972, 1236, 4641, 4002, 9811, 8459, 4201, 4507, 11973, 1988, 9005, 691, 11992, 2]
...
// Module 11964 (handleNameInputScreenOrSuggestions)
          ...
          if (0 === trackResult1) {
            ...
            if (arg0 === 1) {
              ...
              if (set === constants.NOT_DETERMINED) {
                callback(11970).trackFlowStep(callback(11970).Steps.PERMISSION_REQUESTED, false, false);
                const obj16 = callback(11970);
              }
              v0 = 1;
              trackResult1 = 3;
              v02 = 1;
              const obj3 = { value: null, done: false };
              obj3[0] = callback(11968).getContacts(callback);
              return obj3;
            }
          } else {
            if (2 === tmp8) {
              ...
              if (closure_13 === callback(11968).ContactSyncPermissionDenied) {
                const obj15 = callback(11970);
                obj15.trackFlowStep(callback(11970).Steps.LANDING, true, false, { mobile_contacts_permission: "denied" });
              ...
              if (3 === tmp8) {
                if (arg0 === 1) {
                  ...
                  if (null == name) {
                    obj5 = callback(11970);
                    obj5.trackFlowStep(callback(11970).Steps.NAME_INPUT, false, false);
                ...
                SUGGESTIONS_RESULTS = callback(11970).Steps.SUGGESTIONS_RESULTS;
                obj2 = callback(11968);
                trackResult1 = 5;
                v02 = 1;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (null == phone) {
                let obj2 = callback(11970);
                obj2.trackFlowStep(callback(11970).Steps.ADD_PHONE_NUMBER, false, false);
                outer1_9(null);
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            if (301 !== lib.status) {
              if (404 !== lib.status) {
                const aPIError = new lib(4201).APIError(lib);
...
function closeContactSyncModal(skip) {
  ...
  if (null != onComplete) {
    ...
    obj[0] = friendsFound;
    obj[1] = friendsAdded;
    flag2(11970).trackFlowEnd(flag, obj);
    if (tmp16) {
      onComplete(flag);
    } else {
    ...
    if (tmp2) {
      let updateAnimation = back(4507).updateAnimation;
...
export const goBackToLanding = function goBackToLanding(closure_1) {
  require(11970) /* Steps */.trackFlowStep(require(11970) /* Steps */.Steps.LANDING, false, true);
  closure_1.pop(closure_1.getState().routes.length - 1);
};
export const submitPhone = function submitPhone(arg0, closure_0) {
  callback2(arg0);
  require(11970) /* Steps */.trackFlowStep(require(11970) /* Steps */.Steps.VERIFY_PHONE_NUMBER, false, false);
...
export const openContactSyncModal = function openContactSyncModal(initialRoutes, FRIENDS_ADD_FRIENDS_MODAL) {
  ...
  const obj4 = importDefault(4507);
  const tmp2 = dependencyMap;
  importDefault(4507).pushLazy(require(1988) /* asyncRequireImpl */(11973, dependencyMap.paths), obj, closure_20).then(arg2);
};
export const openContactSyncModalOnboarding = function openContactSyncModalOnboarding() {
  ...
  if (!flag) {
    ...
    obj = { page: null };
    obj[0] = require(11970) /* Steps */.CONTACT_SYNC_ONBOARDING_LOCATION;
    obj[0] = obj;
    require(11970) /* Steps */.trackFlowStart(obj);
    const obj2 = require(11970) /* Steps */;
    ...
    obj = require(9005) /* showInstantInviteActionSheet */;
...
export const openContactSyncModalDeeplink = function openContactSyncModalDeeplink() {
  let obj = {};
  const result = require(11968) /* _uploadContacts */.checkContactPermissions();
  result.then((arg0) => {
    callback(arg0);
  });
  ...
  const obj2 = require(11968) /* _uploadContacts */;
  const tmp2 = dependencyMap;
  require(11970) /* Steps */.trackFlowStart({ location: { page: "Deep Link" } });
  const tmpResult = require(11970) /* Steps */;
  obj = { initialRoutes: obj.initialRoutes, openSettingsSheet: obj.openSettings, customLandingPage: obj.customLandingPage };
  const obj4 = importDefault(4507);
  importDefault(4507).pushLazy(require(1988) /* asyncRequireImpl */(11973, tmp2.paths), obj, closure_20).then(undefined);
};
