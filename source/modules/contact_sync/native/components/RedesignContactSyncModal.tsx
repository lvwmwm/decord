...
// Function ID: 12224
// Name: headerTitle
// Dependencies: [5, 32, 19, 17, 1922, 7157, 12215, 12216, 676, 4730, 21, 4478, 712, 5492, 12214, 4474, 1236, 12218, 12224, 1628, 1499, 589, 12222, 500, 691, 698, 4445, 12225, 2009, 5083, 5070, 12226, 12227, 12230, 12233, 12234, 12235, 12236, 12238, 503, 5495, 12240, 12241, 6008, 2]
// Exports: ContactSyncOnboardingModal

// Module 12223 (headerTitle)
    ...
    let timerId = setTimeout(navigation(function*() {
      if (c3 === 2) {
        ...
        try {
          ...
          obj4[0] = closure_1_0(12214).startContactSync(c3);
          return obj4;
        } catch (tmp22) {
          c3 = tmp;
          throw tmp22;
...
function ContactSyncNameInputScreen(navigateToLandingPage) {
  ...
  first(12233)(navigation, navigateToLandingPage.navigateToLandingPage);
  _require = undefined;
  ...
  obj[4] = tmp12;
  obj[1] = closure_16(first(12235), obj);
  ...
  constructor(arg0) {
    ...
    memo1 = closure_5.useMemo(() => {
      ...
      obj6[5] = function render() {
        return callback2(callback(12241).AddPhoneScreen, {});
      };
      ...
      obj8[5] = function render() {
        return callback2(callback(12241).VerifyPhoneScreen, {});
      };
      ...
      obj10[5] = function render() {
        return callback2(callback(12241).VerifyPasswordScreen, {});
      };
