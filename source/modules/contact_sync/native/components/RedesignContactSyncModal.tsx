...
// Function ID: 11791
// Name: headerTitle
// Dependencies: [5, 32, 19, 17, 1874, 6331, 11782, 11783, 676, 4406, 21, 4193, 712, 5144, 11781, 4189, 1236, 11785, 11791, 1581, 1480, 589, 11789, 500, 691, 698, 4161, 11792, 1959, 4736, 4723, 11793, 11794, 11797, 11800, 11801, 11802, 11803, 11805, 503, 5147, 11807, 11808, 5574, 2]
...
function OnboardingTrailingLanding() {
  ...
  obj[0] = require(11785) /* _uploadContacts */.getOpenLearnMoreUrl();
  obj[3] = intl.format(require(1236) /* getSystemLocale */.t["84S6+Z"], obj);
  return callback4(require(4189) /* Text */.Text, obj);
}
function OnboardingTrailing(isOnboarding) {
  if (isOnboarding.isOnboarding) {
    ...
    obj[0] = tmp;
    obj[1] = tmp2;
    tmp3Result = tmp3(importDefault(11791), obj);
  }
  return tmp3Result;
}
    ...
    let timerId = setTimeout(navigation(function*() {
      if (c3 === 2) {
        ...
        try {
          ...
          obj4[0] = outer1_0(11781).startContactSync(c3);
          return obj4;
        } catch (tmp22) {
          c3 = tmp;
          throw tmp22;
...
function ContactSyncNameInputScreen(navigateToLandingPage) {
  ...
  first(11800)(navigation, navigateToLandingPage.navigateToLandingPage);
  _require = undefined;
  ...
  obj[4] = tmp12;
  obj[1] = closure_16(first(11802), obj);
...
class ContactSyncModal {
  constructor(arg0) {
    ...
    c4 = undefined;
    f88259 = undefined;
    tmp = c4(f88259.useState(false), 2);
    first = tmp[0];
    c2 = first;
    useState = tmp[1];
    ...
    memo1 = f88259.useMemo(() => {
      ...
      obj6[5] = function render() {
        return callback2(callback(11808).AddPhoneScreen, {});
      };
      ...
      obj8[5] = function render() {
        return callback2(callback(11808).VerifyPhoneScreen, {});
      };
      ...
      obj10[5] = function render() {
        return callback2(callback(11808).VerifyPasswordScreen, {});
      };
      obj1[outer1_13.VERIFY_PASSWORD] = obj10;
      return obj1;
    }, items2);
    effect1 = f88259.useEffect(() => () => {
