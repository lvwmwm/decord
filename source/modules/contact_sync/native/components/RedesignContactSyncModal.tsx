...
// Function ID: 12041
// Name: headerTitle
// Dependencies: [5, 32, 19, 17, 1903, 6876, 12032, 12033, 676, 4516, 21, 4303, 712, 5267, 12031, 4299, 1236, 12035, 12041, 1609, 1480, 589, 12039, 500, 691, 698, 4271, 12042, 1988, 4861, 4848, 12043, 12044, 12047, 12050, 12051, 12052, 12053, 12055, 503, 5270, 12057, 12058, 5783, 2]
// Exports: ContactSyncOnboardingModal

// Module 12040 (headerTitle)
...
function OnboardingTrailingLanding() {
  ...
  obj[0] = require(12035) /* _uploadContacts */.getOpenLearnMoreUrl();
...
function OnboardingTrailing(isOnboarding) {
  if (isOnboarding.isOnboarding) {
    ...
    obj[0] = tmp;
    obj[1] = tmp2;
    tmp3Result = tmp3(importDefault(12041), obj);
  }
  return tmp3Result;
}
    ...
    let timerId = setTimeout(navigation(function*() {
      if (c3 === 2) {
        ...
        try {
          ...
          obj4[0] = outer1_0(12031).startContactSync(c3);
          return obj4;
        } catch (tmp22) {
          c3 = tmp;
          throw tmp22;
...
function ContactSyncNameInputScreen(navigateToLandingPage) {
  ...
  first(12050)(navigation, navigateToLandingPage.navigateToLandingPage);
  _require = undefined;
  ...
  obj[4] = tmp12;
  obj[1] = closure_16(first(12052), obj);
...
class ContactSyncModal {
  constructor(arg0) {
    ...
    c4 = undefined;
    f89198 = undefined;
    tmp = c4(f89198.useState(false), 2);
    first = tmp[0];
    c2 = first;
    useState = tmp[1];
    ...
    memo1 = f89198.useMemo(() => {
      ...
      obj6[5] = function render() {
        return callback2(callback(12058).AddPhoneScreen, {});
      };
      ...
      obj8[5] = function render() {
        return callback2(callback(12058).VerifyPhoneScreen, {});
      };
      ...
      obj10[5] = function render() {
        return callback2(callback(12058).VerifyPasswordScreen, {});
      };
      obj1[outer1_13.VERIFY_PASSWORD] = obj10;
      return obj1;
    }, items2);
    effect1 = f89198.useEffect(() => () => {
