...
// Function ID: 11893
// Name: headerTitle
// Dependencies: [5, 32, 19, 17, 1874, 6773, 11884, 11885, 676, 4468, 21, 4255, 712, 5206, 11883, 4251, 1236, 11887, 11893, 1581, 1480, 589, 11891, 500, 691, 698, 4223, 11894, 1959, 4798, 4785, 11895, 11896, 11899, 11902, 11903, 11904, 11905, 11907, 503, 5209, 11909, 11910, 5636, 2]
// Exports: ContactSyncOnboardingModal

// Module 11892 (headerTitle)
...
function OnboardingTrailingLanding() {
  ...
  obj[0] = require(11887) /* _uploadContacts */.getOpenLearnMoreUrl();
  obj[3] = intl.format(require(1236) /* getSystemLocale */.t["84S6+Z"], obj);
  return callback4(require(4251) /* Text */.Text, obj);
}
function OnboardingTrailing(isOnboarding) {
  if (isOnboarding.isOnboarding) {
    ...
    obj[0] = tmp;
    obj[1] = tmp2;
    tmp3Result = tmp3(importDefault(11893), obj);
  }
  return tmp3Result;
}
    ...
    let timerId = setTimeout(navigation(function*() {
      if (c3 === 2) {
        ...
        try {
          ...
          obj4[0] = outer1_0(11883).startContactSync(c3);
          return obj4;
        } catch (tmp22) {
          c3 = tmp;
          throw tmp22;
...
function ContactSyncNameInputScreen(navigateToLandingPage) {
  ...
  first(11902)(navigation, navigateToLandingPage.navigateToLandingPage);
  _require = undefined;
  ...
  obj[4] = tmp12;
  obj[1] = closure_16(first(11904), obj);
...
class ContactSyncModal {
  constructor(arg0) {
    ...
    c4 = undefined;
    f88544 = undefined;
    tmp = c4(f88544.useState(false), 2);
    first = tmp[0];
    c2 = first;
    useState = tmp[1];
    ...
    memo1 = f88544.useMemo(() => {
      ...
      obj6[5] = function render() {
        return callback2(callback(11910).AddPhoneScreen, {});
      };
      ...
      obj8[5] = function render() {
        return callback2(callback(11910).VerifyPhoneScreen, {});
      };
      ...
      obj10[5] = function render() {
        return callback2(callback(11910).VerifyPasswordScreen, {});
      };
      obj1[outer1_13.VERIFY_PASSWORD] = obj10;
      return obj1;
    }, items2);
    effect1 = f88544.useEffect(() => () => {
