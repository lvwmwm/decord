...
// Function ID: 11773
// Name: headerTitle
// Dependencies: [5, 32, 19, 17, 1874, 6325, 11764, 11765, 676, 4402, 21, 4189, 712, 5140, 11763, 4185, 1236, 11767, 11773, 1581, 1480, 589, 11771, 500, 691, 698, 4157, 11774, 1959, 4732, 4719, 11775, 11776, 11779, 11782, 11783, 11784, 11785, 11787, 503, 5143, 11789, 11790, 5570, 2]
// Exports: ContactSyncOnboardingModal

// Module 11772 (headerTitle)
...
function OnboardingTrailingLanding() {
  ...
  obj[0] = require(11767) /* _uploadContacts */.getOpenLearnMoreUrl();
  obj[3] = intl.format(require(1236) /* getSystemLocale */.t["84S6+Z"], obj);
  return callback4(require(4185) /* Text */.Text, obj);
}
function OnboardingTrailing(isOnboarding) {
  if (isOnboarding.isOnboarding) {
    ...
    obj[0] = tmp;
    obj[1] = tmp2;
    tmp3Result = tmp3(importDefault(11773), obj);
  }
  return tmp3Result;
}
    ...
    let timerId = setTimeout(navigation(function*() {
      if (c3 === 2) {
        ...
        try {
          ...
          obj4[0] = outer1_0(11763).startContactSync(c3);
          return obj4;
        } catch (tmp22) {
          c3 = tmp;
          throw tmp22;
...
function ContactSyncNameInputScreen(navigateToLandingPage) {
  ...
  first(11782)(navigation, navigateToLandingPage.navigateToLandingPage);
  _require = undefined;
  ...
  obj[4] = tmp12;
  obj[1] = closure_16(first(11784), obj);
...
class ContactSyncModal {
  constructor(arg0) {
    ...
    c4 = undefined;
    f88101 = undefined;
    tmp = c4(f88101.useState(false), 2);
    first = tmp[0];
    c2 = first;
    useState = tmp[1];
    ...
    memo1 = f88101.useMemo(() => {
      ...
      obj6[5] = function render() {
        return callback2(callback(11790).AddPhoneScreen, {});
      };
      ...
      obj8[5] = function render() {
        return callback2(callback(11790).VerifyPhoneScreen, {});
      };
      ...
      obj10[5] = function render() {
        return callback2(callback(11790).VerifyPasswordScreen, {});
      };
      obj1[outer1_13.VERIFY_PASSWORD] = obj10;
      return obj1;
    }, items2);
    effect1 = f88101.useEffect(() => () => {
