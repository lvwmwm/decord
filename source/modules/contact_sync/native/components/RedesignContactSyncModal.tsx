...
// Function ID: 11777
// Name: headerTitle
// Dependencies: [5, 32, 19, 17, 1874, 6328, 11768, 11769, 676, 4402, 21, 4189, 712, 5140, 11767, 4185, 1236, 11771, 11777, 1581, 1480, 589, 11775, 500, 691, 698, 4157, 11778, 1959, 4732, 4719, 11779, 11780, 11783, 11786, 11787, 11788, 11789, 11791, 503, 5143, 11793, 11794, 5570, 2]
// Exports: ContactSyncOnboardingModal

// Module 11776 (headerTitle)
...
function OnboardingTrailingLanding() {
  ...
  obj[0] = require(11771) /* _uploadContacts */.getOpenLearnMoreUrl();
...
function OnboardingTrailing(isOnboarding) {
  if (isOnboarding.isOnboarding) {
    ...
    obj[0] = tmp;
    obj[1] = tmp2;
    tmp3Result = tmp3(importDefault(11777), obj);
  }
  return tmp3Result;
}
    ...
    let timerId = setTimeout(navigation(function*() {
      if (c3 === 2) {
        ...
        try {
          ...
          obj4[0] = outer1_0(11767).startContactSync(c3);
          return obj4;
        } catch (tmp22) {
          c3 = tmp;
          throw tmp22;
...
function ContactSyncNameInputScreen(navigateToLandingPage) {
  ...
  first(11786)(navigation, navigateToLandingPage.navigateToLandingPage);
  _require = undefined;
  ...
  obj[4] = tmp12;
  obj[1] = closure_16(first(11788), obj);
...
class ContactSyncModal {
  constructor(arg0) {
    ...
    c4 = undefined;
    f88077 = undefined;
    tmp = c4(f88077.useState(false), 2);
    first = tmp[0];
    c2 = first;
    useState = tmp[1];
    ...
    memo1 = f88077.useMemo(() => {
      ...
      obj6[5] = function render() {
        return callback2(callback(11794).AddPhoneScreen, {});
      };
      ...
      obj8[5] = function render() {
        return callback2(callback(11794).VerifyPhoneScreen, {});
      };
      ...
      obj10[5] = function render() {
        return callback2(callback(11794).VerifyPasswordScreen, {});
      };
      obj1[outer1_13.VERIFY_PASSWORD] = obj10;
      return obj1;
    }, items2);
    effect1 = f88077.useEffect(() => () => {
