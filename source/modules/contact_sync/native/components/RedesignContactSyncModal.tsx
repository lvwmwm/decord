...
// Function ID: 12044
// Name: headerTitle
// Dependencies: [5, 32, 19, 17, 1922, 6878, 12035, 12036, 676, 4516, 21, 4303, 712, 5267, 12034, 4299, 1236, 12038, 12044, 1628, 1499, 589, 12042, 500, 691, 698, 4271, 12045, 2007, 4861, 4848, 12046, 12047, 12050, 12053, 12054, 12055, 12056, 12058, 503, 5270, 12060, 12061, 5783, 2]
// Exports: ContactSyncOnboardingModal

// Module 12043 (headerTitle)
...
function OnboardingTrailingLanding() {
  ...
  obj[0] = require(12038) /* _uploadContacts */.getOpenLearnMoreUrl();
...
function OnboardingTrailing(isOnboarding) {
  if (isOnboarding.isOnboarding) {
    ...
    obj[0] = tmp;
    obj[1] = tmp2;
    tmp3Result = tmp3(importDefault(12044), obj);
  }
  return tmp3Result;
}
    ...
    let timerId = setTimeout(navigation(function*() {
      if (c3 === 2) {
        ...
        try {
          ...
          obj4[0] = outer1_0(12034).startContactSync(c3);
          return obj4;
        } catch (tmp22) {
          c3 = tmp;
          throw tmp22;
...
function ContactSyncNameInputScreen(navigateToLandingPage) {
  ...
  first(12053)(navigation, navigateToLandingPage.navigateToLandingPage);
  _require = undefined;
  ...
  obj[4] = tmp12;
  obj[1] = closure_16(first(12055), obj);
...
class ContactSyncModal {
  constructor(arg0) {
    ...
    c4 = undefined;
    f89254 = undefined;
    tmp = c4(f89254.useState(false), 2);
    first = tmp[0];
    c2 = first;
    useState = tmp[1];
    ...
    memo1 = f89254.useMemo(() => {
      ...
      obj6[5] = function render() {
        return callback2(callback(12061).AddPhoneScreen, {});
      };
      ...
      obj8[5] = function render() {
        return callback2(callback(12061).VerifyPhoneScreen, {});
      };
      ...
      obj10[5] = function render() {
        return callback2(callback(12061).VerifyPasswordScreen, {});
      };
      obj1[outer1_13.VERIFY_PASSWORD] = obj10;
      return obj1;
    }, items2);
    effect1 = f89254.useEffect(() => () => {
