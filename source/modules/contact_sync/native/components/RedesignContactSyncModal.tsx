...
// Function ID: 11954
// Name: headerTitle
// Dependencies: [5, 32, 19, 17, 1874, 6785, 11945, 11946, 676, 4497, 21, 4285, 712, 5235, 11944, 4281, 1236, 11948, 11954, 1581, 1480, 589, 11952, 500, 691, 698, 4253, 11955, 1959, 4827, 4814, 11956, 11957, 11960, 11963, 11964, 11965, 11966, 11968, 503, 5238, 11970, 11971, 5665, 2]
// Exports: ContactSyncOnboardingModal

// Module 11953 (headerTitle)
...
function OnboardingTrailingLanding() {
  ...
  obj[0] = require(11948) /* _uploadContacts */.getOpenLearnMoreUrl();
...
function OnboardingTrailing(isOnboarding) {
  if (isOnboarding.isOnboarding) {
    ...
    obj[0] = tmp;
    obj[1] = tmp2;
    tmp3Result = tmp3(importDefault(11954), obj);
  }
  return tmp3Result;
}
    ...
    let timerId = setTimeout(navigation(function*() {
      if (c3 === 2) {
        ...
        try {
          ...
          obj4[0] = outer1_0(11944).startContactSync(c3);
          return obj4;
        } catch (tmp22) {
          c3 = tmp;
          throw tmp22;
...
function ContactSyncNameInputScreen(navigateToLandingPage) {
  ...
  first(11963)(navigation, navigateToLandingPage.navigateToLandingPage);
  _require = undefined;
  ...
  obj[4] = tmp12;
  obj[1] = closure_16(first(11965), obj);
...
class ContactSyncModal {
  constructor(arg0) {
    ...
    c4 = undefined;
    f88647 = undefined;
    tmp = c4(f88647.useState(false), 2);
    first = tmp[0];
    c2 = first;
    useState = tmp[1];
    ...
    memo1 = f88647.useMemo(() => {
      ...
      obj6[5] = function render() {
        return callback2(callback(11971).AddPhoneScreen, {});
      };
      ...
      obj8[5] = function render() {
        return callback2(callback(11971).VerifyPhoneScreen, {});
      };
      ...
      obj10[5] = function render() {
        return callback2(callback(11971).VerifyPasswordScreen, {});
      };
      obj1[outer1_13.VERIFY_PASSWORD] = obj10;
      return obj1;
    }, items2);
    effect1 = f88647.useEffect(() => () => {
