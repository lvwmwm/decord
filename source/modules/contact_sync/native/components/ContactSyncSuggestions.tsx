...
function SuggestedFriendsSectionHeader(children) {
  return callback(View, { style: createCacheKey().sectionHeader, children: callback(require(4338) /* Text */.Text, { color: "text-muted", variant: "text-sm/semibold", children: children.label }) });
}
