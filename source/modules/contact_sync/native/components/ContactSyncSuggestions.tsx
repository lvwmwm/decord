...
// Dependencies: [32, 19, 17, 676, 12114, 21, 4344, 712, 5306, 4760, 4340, 4189, 1435, 8493, 1297, 1236, 4065, 4193, 11, 8008, 7786, 4765, 691, 4754, 698, 2]
// Exports: default

// Module 12113 (SuggestedFriendsSectionHeader)
...
function SuggestedFriendsSectionHeader(children) {
  return callback(View, { style: createCacheKey().sectionHeader, children: callback(require(4340) /* Text */.Text, { color: "text-muted", variant: "text-sm/semibold", children: children.label }) });
}
