...
// Dependencies: [19, 21, 4302, 4162, 4303, 4298, 2]
// Exports: default

// Module 11982 (ContactSyncError)
import "noop";
...
export default function ContactSyncError(error) {
  ...
  obj = { withTiming: _require(4303).withTiming, hasError: tmp2, ERROR_HEIGHT: 44 };
  fn.__closure = obj;
  ...
  obj[1] = jsx(_require(4298).Text, { variant: "text-sm/medium", color: "text-feedback-critical", style: tmp.error, children: error });
