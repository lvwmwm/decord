// Module ID: 13563
// Function ID: 13564
// Dependencies: [19, 12184, 676, 21, 4448, 712, 8331, 698, 12181, 5954, 1236, 13564, 2]

// Module 13563
import ThemesDefault from "Themes" /* 712 */;
import registerAssetDefault from "registerAsset" /* 13564 */;
import { dismissUpsellCTA } from "setStoredContacts" /* 12184 */;
...
const memoResult = importAllResult.memo(function ContactSyncUpsellCTA(location) {
  ...
  return jsx(location(8331).FormCTA, {
    onPress() {
      let obj = closure_1_1(closure_1_2[7]);
      obj = { type: closure_1_5.CONTACT_SYNC_MODAL, location: null };
      let str = location;
