...
// Function ID: 13871
// Name: syncContacts
// Dependencies: [5, 19, 1874, 11766, 676, 21, 11767, 3890, 1236, 9168, 11771, 698, 11763, 589, 3862, 1384, 7631, 4395, 13871, 1959, 2]
// Exports: default, handleSyncContacts

// Module 13870 (syncContacts)
...
export default function ContactSyncSettings() {
  let obj = contactSyncAccount(11767);
  ...
  const FriendDiscoverySettings = tmp(3862).FriendDiscoverySettings;
  ...
  if (isStaffResult) {
    ...
    obj1[2] = tmp(11767).adminDeleteContactSync;
    const items1 = [callback2(tmp(7631).FormSwitchRow, obj1), callback2(tmp(7631).FormDivider, {})];
    obj[0] = items1;
  ...
  items2[1] = callback2(contactSyncAccount(7631).FormSwitchRow, obj2);
  tmp10Result = null;
  if (null != contactSyncAccount) {
    let obj3 = { children: null };
    const items3 = [tmp14(tmp(7631).FormDivider, {}), ];
    ...
    obj4[1] = tmp14(tmp(7631).FormRow.Arrow, obj5);
    ...
    items3[1] = tmp14(tmp(7631).FormRow, obj4);
    obj3[0] = items3;
  ...
  obj[1] = items2;
  const items4 = [closure_12(contactSyncAccount(7631).FormSection, obj), , , ];
  const obj7 = { children: null };
  const intl4 = tmp(1236).intl;
  const obj8 = { onClick: null };
  obj8[0] = contactSyncAccount(11767).handleOpenLearnMoreLink;
  obj7[0] = intl4.format(contactSyncAccount(1236).t.BoR0dO, obj8);
  items4[1] = callback2(contactSyncAccount(7631).FormHint, obj7);
  const obj9 = { children: null };
  const intl5 = tmp(1236).intl;
  obj9[0] = intl5.string(contactSyncAccount(1236).t.cW1nr9);
  items4[2] = callback2(contactSyncAccount(7631).FormHint, obj9);
  ...
  const items5 = [callback2(contactSyncAccount(7631).FormSwitchRow, obj11), callback2(contactSyncAccount(7631).FormDivider, {}), ];
  ...
  items5[2] = callback2(contactSyncAccount(7631).FormSwitchRow, obj12);
  obj10[1] = items5;
  items4[3] = closure_12(contactSyncAccount(7631).FormSection, obj10);
  obj6[0] = items4;
...
export const handleSyncContacts = function handleSyncContacts(localAccount, phone, arg2) {
  if (null == localAccount) {
    ...
    require(11763) /* handleNameInputScreenOrSuggestions */.openContactSyncModal({}, { page: "User Settings" });
    const obj3 = require(11763) /* handleNameInputScreenOrSuggestions */;
  } else {
