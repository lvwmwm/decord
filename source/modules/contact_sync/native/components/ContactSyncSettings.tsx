...
// Function ID: 14418
// Name: syncContacts
// Dependencies: [5, 19, 1922, 12184, 676, 21, 12185, 4164, 1236, 7648, 12189, 698, 12181, 589, 4136, 1399, 8331, 4691, 14418, 2009, 2]
// Exports: default, handleSyncContacts

// Module 14417 (syncContacts)
...
export default function ContactSyncSettings() {
  let obj = contactSyncAccount(12185);
  contactSyncAccount = obj.useContactSyncAccount();
  obj1 = contactSyncAccount(589);
  ...
  let tmpResult = tmp(12185);
  const FriendDiscoverySettings = tmp(4136).FriendDiscoverySettings;
  ...
  const hasFlagResult1 = contactSyncAccount(1399).hasFlag(setting, constants2.FIND_BY_EMAIL);
  ...
  if (isStaffResult) {
    ...
    obj1[2] = tmp(12185).adminDeleteContactSync;
    const items1 = [callback2(tmp(8331).FormSwitchRow, obj1), callback2(tmp(8331).FormDivider, {})];
    obj[0] = items1;
  ...
  items2[1] = callback2(contactSyncAccount(8331).FormSwitchRow, obj2);
  tmp10Result = null;
  if (null != contactSyncAccount) {
    let obj3 = { children: null };
    const items3 = [tmp14(tmp(8331).FormDivider, {}), ];
    ...
    obj4[1] = tmp14(tmp(8331).FormRow.Arrow, obj5);
    ...
    items3[1] = tmp14(tmp(8331).FormRow, obj4);
    obj3[0] = items3;
  ...
  obj[1] = items2;
  const items4 = [closure_12(contactSyncAccount(8331).FormSection, obj), , , ];
  const obj7 = { children: null };
  const intl4 = tmp(1236).intl;
  const tmpResult1 = contactSyncAccount(1399);
  obj7[0] = intl4.format(contactSyncAccount(1236).t.BoR0dO, { onClick: contactSyncAccount(12185).handleOpenLearnMoreLink });
  items4[1] = callback2(contactSyncAccount(8331).FormHint, obj7);
  const obj9 = { children: null };
  const intl5 = tmp(1236).intl;
  obj9[0] = intl5.string(contactSyncAccount(1236).t.cW1nr9);
  items4[2] = callback2(contactSyncAccount(8331).FormHint, obj9);
  ...
  const items5 = [callback2(contactSyncAccount(8331).FormSwitchRow, obj11), callback2(contactSyncAccount(8331).FormDivider, {}), ];
  ...
  items5[2] = callback2(contactSyncAccount(8331).FormSwitchRow, obj12);
  obj10[1] = items5;
  items4[3] = closure_12(contactSyncAccount(8331).FormSection, obj10);
  obj6[0] = items4;
