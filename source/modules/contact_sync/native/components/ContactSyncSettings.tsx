...
export default function ContactSyncSettings() {
  ...
  items2[1] = callback2(contactSyncAccount(7575).FormSwitchRow, obj3);
  let tmp16 = null;
  if (null != contactSyncAccount) {
    obj4 = {};
    const items3 = [callback2(contactSyncAccount(7575).FormDivider, {}), ];
    obj5 = {};
    ...
    obj5.trailing = callback2(contactSyncAccount(7575).FormRow.Arrow, obj6);
    ...
    items3[1] = callback2(contactSyncAccount(7575).FormRow, obj5);
  ...
  items4[2] = callback2(contactSyncAccount(7575).FormHint, obj9);
  const obj10 = {};
  ...
  const items5 = [callback2(contactSyncAccount(7575).FormSwitchRow, obj11), callback2(contactSyncAccount(7575).FormDivider, {}), ];
  const obj12 = {};
  ...
  items5[2] = callback2(contactSyncAccount(7575).FormSwitchRow, obj12);
  obj10.children = items5;
  items4[3] = callback3(contactSyncAccount(7575).FormSection, obj10);
  obj.children = items4;
