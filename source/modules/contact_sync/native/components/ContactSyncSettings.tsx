...
// Function ID: 14770
// Name: syncContacts
// Dependencies: [5, 19, 1921, 12611, 673, 21, 12612, 4194, 1233, 5552, 12616, 695, 12608, 586, 4166, 1399, 8523, 4731, 14770, 2008, 2]
// Exports: default, handleSyncContacts

// Module 14769 (syncContacts)
...
export default function ContactSyncSettings() {
  let obj = contactSyncAccount(12612);
  ...
  if (isStaffResult) {
    ...
    obj1[2] = tmp(12612).adminDeleteContactSync;
    const items1 = [callback2(tmp(8523).FormSwitchRow, obj1), callback2(tmp(8523).FormDivider, {})];
    obj[0] = items1;
  ...
  items2[1] = callback2(contactSyncAccount(8523).FormSwitchRow, obj2);
  tmp10Result = null;
  if (null != contactSyncAccount) {
    let obj3 = { children: null };
    const items3 = [tmp14(tmp(8523).FormDivider, {}), ];
    ...
    obj4[1] = tmp14(tmp(8523).FormRow.Arrow, obj5);
    ...
    items3[1] = tmp14(tmp(8523).FormRow, obj4);
    obj3[0] = items3;
  ...
  obj[1] = items2;
  const items4 = [closure_12(contactSyncAccount(8523).FormSection, obj), , , ];
  const obj7 = { children: null };
  const intl4 = tmp(1233).intl;
  const tmpResult1 = contactSyncAccount(1399);
  obj7[0] = intl4.format(contactSyncAccount(1233).t.BoR0dO, { onClick: contactSyncAccount(12612).handleOpenLearnMoreLink });
  items4[1] = callback2(contactSyncAccount(8523).FormHint, obj7);
  const obj9 = { children: null };
  const intl5 = tmp(1233).intl;
  obj9[0] = intl5.string(contactSyncAccount(1233).t.cW1nr9);
  items4[2] = callback2(contactSyncAccount(8523).FormHint, obj9);
  ...
  const items5 = [callback2(contactSyncAccount(8523).FormSwitchRow, obj11), callback2(contactSyncAccount(8523).FormDivider, {}), ];
  ...
  items5[2] = callback2(contactSyncAccount(8523).FormSwitchRow, obj12);
  obj10[1] = items5;
  items4[3] = closure_12(contactSyncAccount(8523).FormSection, obj10);
  obj6[0] = items4;
