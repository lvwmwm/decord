...
// Function ID: 14170
// Name: syncContacts
// Dependencies: [5, 19, 1922, 12115, 676, 21, 12116, 4062, 1236, 8516, 12120, 698, 12112, 589, 4034, 1403, 8033, 4572, 14170, 2007, 2]
// Exports: default, handleSyncContacts

// Module 14169 (syncContacts)
...
export default function ContactSyncSettings() {
  let obj = contactSyncAccount(12116);
  ...
  if (isStaffResult) {
    ...
    obj1[2] = tmp(12116).adminDeleteContactSync;
    const items1 = [callback2(tmp(8033).FormSwitchRow, obj1), callback2(tmp(8033).FormDivider, {})];
    obj[0] = items1;
  ...
  items2[1] = callback2(contactSyncAccount(8033).FormSwitchRow, obj2);
  tmp10Result = null;
  if (null != contactSyncAccount) {
    let obj3 = { children: null };
    const items3 = [tmp14(tmp(8033).FormDivider, {}), ];
    ...
    obj4[1] = tmp14(tmp(8033).FormRow.Arrow, obj5);
    ...
    items3[1] = tmp14(tmp(8033).FormRow, obj4);
    obj3[0] = items3;
  ...
  obj[1] = items2;
  const items4 = [closure_12(contactSyncAccount(8033).FormSection, obj), , , ];
  const obj7 = { children: null };
  const intl4 = tmp(1236).intl;
  const obj8 = { onClick: null };
  obj8[0] = contactSyncAccount(12116).handleOpenLearnMoreLink;
  obj7[0] = intl4.format(contactSyncAccount(1236).t.BoR0dO, obj8);
  items4[1] = callback2(contactSyncAccount(8033).FormHint, obj7);
  const obj9 = { children: null };
  const intl5 = tmp(1236).intl;
  obj9[0] = intl5.string(contactSyncAccount(1236).t.cW1nr9);
  items4[2] = callback2(contactSyncAccount(8033).FormHint, obj9);
  ...
  const items5 = [callback2(contactSyncAccount(8033).FormSwitchRow, obj11), callback2(contactSyncAccount(8033).FormDivider, {}), ];
  ...
  items5[2] = callback2(contactSyncAccount(8033).FormSwitchRow, obj12);
  obj10[1] = items5;
  items4[3] = closure_12(contactSyncAccount(8033).FormSection, obj10);
  obj6[0] = items4;
...
export const handleSyncContacts = function handleSyncContacts(localAccount, phone, arg2) {
  if (null == localAccount) {
    ...
    require(12112) /* handleNameInputScreenOrSuggestions */.openContactSyncModal({}, { page: "User Settings" });
    const obj3 = require(12112) /* handleNameInputScreenOrSuggestions */;
  } else {
