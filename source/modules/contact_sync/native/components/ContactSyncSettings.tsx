...
// Function ID: 14451
// Name: syncContacts
// Dependencies: [5, 19, 1922, 12217, 676, 21, 12218, 4194, 1236, 7680, 12222, 698, 12214, 589, 4166, 1399, 8363, 4723, 14451, 2009, 2]
// Exports: default, handleSyncContacts

// Module 14450 (syncContacts)
...
export default function ContactSyncSettings() {
  let obj = contactSyncAccount(12218);
  ...
  if (isStaffResult) {
    ...
    obj1[2] = tmp(12218).adminDeleteContactSync;
    const items1 = [callback2(tmp(8363).FormSwitchRow, obj1), callback2(tmp(8363).FormDivider, {})];
    obj[0] = items1;
  ...
  items2[1] = callback2(contactSyncAccount(8363).FormSwitchRow, obj2);
  tmp10Result = null;
  if (null != contactSyncAccount) {
  ...
  items4[2] = callback2(contactSyncAccount(8363).FormHint, obj9);
  ...
  items5[2] = callback2(contactSyncAccount(8363).FormSwitchRow, obj12);
  obj10[1] = items5;
