...
// Function ID: 14384
// Name: syncContacts
// Dependencies: [5, 19, 1923, 12150, 676, 21, 12151, 4163, 1236, 7627, 12155, 698, 12147, 589, 4135, 1403, 8309, 4689, 14384, 2010, 2]
// Exports: default, handleSyncContacts

// Module 14383 (syncContacts)
...
export default function ContactSyncSettings() {
  let obj = contactSyncAccount(12151);
  ...
  let tmpResult = tmp(12151);
  const FriendDiscoverySettings = tmp(4135).FriendDiscoverySettings;
  ...
  if (isStaffResult) {
    ...
    obj1[2] = tmp(12151).adminDeleteContactSync;
    const items1 = [callback2(tmp(8309).FormSwitchRow, obj1), callback2(tmp(8309).FormDivider, {})];
    obj[0] = items1;
  ...
  items2[1] = callback2(contactSyncAccount(8309).FormSwitchRow, obj2);
  tmp10Result = null;
  if (null != contactSyncAccount) {
    let obj3 = { children: null };
    const items3 = [tmp14(tmp(8309).FormDivider, {}), ];
    ...
    obj4[1] = tmp14(tmp(8309).FormRow.Arrow, obj5);
    ...
    items3[1] = tmp14(tmp(8309).FormRow, obj4);
    obj3[0] = items3;
  ...
  obj[1] = items2;
  const items4 = [closure_12(contactSyncAccount(8309).FormSection, obj), , , ];
  const obj7 = { children: null };
  const intl4 = tmp(1236).intl;
  const tmpResult1 = contactSyncAccount(1403);
  obj7[0] = intl4.format(contactSyncAccount(1236).t.BoR0dO, { onClick: contactSyncAccount(12151).handleOpenLearnMoreLink });
  items4[1] = callback2(contactSyncAccount(8309).FormHint, obj7);
  const obj9 = { children: null };
  const intl5 = tmp(1236).intl;
  obj9[0] = intl5.string(contactSyncAccount(1236).t.cW1nr9);
  items4[2] = callback2(contactSyncAccount(8309).FormHint, obj9);
  ...
  const items5 = [callback2(contactSyncAccount(8309).FormSwitchRow, obj11), callback2(contactSyncAccount(8309).FormDivider, {}), ];
  ...
  items5[2] = callback2(contactSyncAccount(8309).FormSwitchRow, obj12);
  obj10[1] = items5;
  items4[3] = closure_12(contactSyncAccount(8309).FormSection, obj10);
  obj6[0] = items4;
