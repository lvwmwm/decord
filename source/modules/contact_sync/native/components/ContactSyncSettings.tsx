...
// Function ID: 14020
// Name: syncContacts
// Dependencies: [5, 19, 1903, 11967, 676, 21, 11968, 4002, 1236, 8385, 11972, 698, 11964, 589, 3974, 1384, 7907, 4507, 14020, 1988, 2]
// Exports: default, handleSyncContacts

// Module 14019 (syncContacts)
...
export default function ContactSyncSettings() {
  let obj = contactSyncAccount(11968);
  ...
  if (isStaffResult) {
    ...
    obj1[2] = tmp(11968).adminDeleteContactSync;
    const items1 = [callback2(tmp(7907).FormSwitchRow, obj1), callback2(tmp(7907).FormDivider, {})];
    obj[0] = items1;
  ...
  items2[1] = callback2(contactSyncAccount(7907).FormSwitchRow, obj2);
  tmp10Result = null;
  if (null != contactSyncAccount) {
    let obj3 = { children: null };
    const items3 = [tmp14(tmp(7907).FormDivider, {}), ];
    ...
    obj4[1] = tmp14(tmp(7907).FormRow.Arrow, obj5);
    ...
    items3[1] = tmp14(tmp(7907).FormRow, obj4);
    obj3[0] = items3;
  ...
  obj[1] = items2;
  const items4 = [closure_12(contactSyncAccount(7907).FormSection, obj), , , ];
  const obj7 = { children: null };
  const intl4 = tmp(1236).intl;
  const obj8 = { onClick: null };
  obj8[0] = contactSyncAccount(11968).handleOpenLearnMoreLink;
  obj7[0] = intl4.format(contactSyncAccount(1236).t.BoR0dO, obj8);
  items4[1] = callback2(contactSyncAccount(7907).FormHint, obj7);
  const obj9 = { children: null };
  const intl5 = tmp(1236).intl;
  obj9[0] = intl5.string(contactSyncAccount(1236).t.cW1nr9);
  items4[2] = callback2(contactSyncAccount(7907).FormHint, obj9);
  ...
  const items5 = [callback2(contactSyncAccount(7907).FormSwitchRow, obj11), callback2(contactSyncAccount(7907).FormDivider, {}), ];
  ...
  items5[2] = callback2(contactSyncAccount(7907).FormSwitchRow, obj12);
  obj10[1] = items5;
  items4[3] = closure_12(contactSyncAccount(7907).FormSection, obj10);
  obj6[0] = items4;
...
export const handleSyncContacts = function handleSyncContacts(localAccount, phone, arg2) {
  if (null == localAccount) {
    ...
    require(11964) /* handleNameInputScreenOrSuggestions */.openContactSyncModal({}, { page: "User Settings" });
    const obj3 = require(11964) /* handleNameInputScreenOrSuggestions */;
  } else {
