...
// Function ID: 106052
// Name: syncContacts
// Dependencies: [5, 31, 1850, 11745, 653, 33, 11746, 3866, 1212, 9148, 11750, 675, 11742, 566, 3838, 1360, 7611, 4372, 13855, 1935, 2]
// Exports: default

// Module 13854 (syncContacts)
...
function handleSyncContacts(localAccount, phone, arg2) {
  if (null == localAccount) {
    ...
    require(11742) /* handleNameInputScreenOrSuggestions */.openContactSyncModal({}, obj1);
    const obj4 = require(11742) /* handleNameInputScreenOrSuggestions */;
  } else {
...
export default function ContactSyncSettings() {
  let obj = contactSyncAccount(11746);
  ...
  let obj3 = contactSyncAccount(11746);
  const FriendDiscoverySettings = contactSyncAccount(3838).FriendDiscoverySettings;
  ...
  if (isStaffResult) {
    obj1 = {};
    const obj2 = { label: "STAFF ONLY - Find your friends deletion", value: true, onValueChange: contactSyncAccount(11746).adminDeleteContactSync };
    const items1 = [callback2(contactSyncAccount(7611).FormSwitchRow, obj2), callback2(contactSyncAccount(7611).FormDivider, {})];
  ...
  items2[1] = callback2(contactSyncAccount(7611).FormSwitchRow, obj3);
  let tmp16 = null;
  if (null != contactSyncAccount) {
    obj4 = {};
    const items3 = [callback2(contactSyncAccount(7611).FormDivider, {}), ];
    obj5 = {};
    ...
    obj5.trailing = callback2(contactSyncAccount(7611).FormRow.Arrow, obj6);
    ...
    items3[1] = callback2(contactSyncAccount(7611).FormRow, obj5);
    obj4.children = items3;
    tmp16 = callback3(closure_11, obj4);
  }
  items2[2] = tmp16;
  obj.children = items2;
  const items4 = [callback3(contactSyncAccount(7611).FormSection, obj), , , ];
  const obj7 = {};
  const intl4 = contactSyncAccount(1212).intl;
  const obj8 = { onClick: contactSyncAccount(11746).handleOpenLearnMoreLink };
  obj7.children = intl4.format(contactSyncAccount(1212).t.BoR0dO, obj8);
  items4[1] = callback2(contactSyncAccount(7611).FormHint, obj7);
  const obj9 = {};
  const intl5 = contactSyncAccount(1212).intl;
  obj9.children = intl5.string(contactSyncAccount(1212).t.cW1nr9);
  items4[2] = callback2(contactSyncAccount(7611).FormHint, obj9);
  const obj10 = {};
  ...
  const items5 = [callback2(contactSyncAccount(7611).FormSwitchRow, obj11), callback2(contactSyncAccount(7611).FormDivider, {}), ];
  const obj12 = {};
  ...
  items5[2] = callback2(contactSyncAccount(7611).FormSwitchRow, obj12);
  obj10.children = items5;
  items4[3] = callback3(contactSyncAccount(7611).FormSection, obj10);
  obj.children = items4;
