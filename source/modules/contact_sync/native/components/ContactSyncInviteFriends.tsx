...
// Dependencies: [19, 17, 1923, 676, 21, 4446, 712, 589, 5458, 12172, 4442, 1236, 4893, 698, 4290, 8578, 2]
// Exports: default

// Module 12171 (ContactSyncInviteFriends)
...
export default function ContactSyncInviteFriends() {
  ...
  items1[1] = callback(_require(4442).Text, obj2);
  ...
  items1[2] = callback(_require(4442).Text, obj3);
  obj[1] = items1;
  ...
  obj4[1] = callback(_require(4893).Button, obj5);
