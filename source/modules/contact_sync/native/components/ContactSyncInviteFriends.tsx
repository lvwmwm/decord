...
// Dependencies: [19, 17, 1922, 676, 21, 4444, 712, 589, 5440, 12329, 4440, 1236, 4879, 698, 4288, 9138, 2]
// Exports: default

// Module 12328 (ContactSyncInviteFriends)
import noopAll from "noop" /* 19 */;
import ThemesDefault from "Themes" /* 712 */;
import preloadDefault from "preload" /* 5440 */;
import registerAssetDefault from "registerAsset" /* 12329 */;
...
export default function ContactSyncInviteFriends() {
  ...
  items1[1] = callback(_require(4440).Text, obj2);
  ...
  items1[2] = callback(_require(4440).Text, obj3);
  obj[1] = items1;
  ...
  obj4[1] = callback(_require(4879).Button, obj5);
