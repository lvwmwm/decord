...
// Dependencies: [19, 17, 1874, 676, 21, 4255, 712, 589, 5221, 11940, 4251, 1236, 4665, 698, 4094, 8817, 2]
// Exports: default

// Module 11939 (ContactSyncInviteFriends)
import "noop";
...
export default function ContactSyncInviteFriends() {
  ...
  items1[1] = callback(_require(4251).Text, obj2);
  ...
  items1[2] = callback(_require(4251).Text, obj3);
  obj[1] = items1;
  ...
  obj4[1] = callback(_require(4665).Button, obj5);
