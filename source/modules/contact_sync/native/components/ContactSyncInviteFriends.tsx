...
// Dependencies: [19, 17, 1922, 676, 21, 4445, 712, 589, 5445, 12153, 4441, 1236, 4880, 698, 4289, 8563, 2]
// Exports: default

// Module 12152 (ContactSyncInviteFriends)
import noopAll from "noop" /* 19 */;
import ThemesDefault from "Themes" /* 712 */;
import preloadDefault from "preload" /* 5445 */;
import registerAssetDefault from "registerAsset" /* 12153 */;
...
export default function ContactSyncInviteFriends() {
  ...
  items1[1] = callback(_require(4441).Text, obj2);
  ...
  items1[2] = callback(_require(4441).Text, obj3);
  obj[1] = items1;
  ...
  obj4[1] = callback(_require(4880).Button, obj5);
