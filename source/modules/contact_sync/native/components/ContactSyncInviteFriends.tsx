...
// Dependencies: [19, 17, 1903, 676, 21, 4303, 712, 589, 5268, 12056, 4299, 1236, 4714, 698, 4146, 8923, 2]
// Exports: default

// Module 12055 (ContactSyncInviteFriends)
import "noop";
...
export default function ContactSyncInviteFriends() {
  ...
  items1[1] = callback(_require(4299).Text, obj2);
  ...
  items1[2] = callback(_require(4299).Text, obj3);
  obj[1] = items1;
  ...
  obj4[1] = callback(_require(4714).Button, obj5);
