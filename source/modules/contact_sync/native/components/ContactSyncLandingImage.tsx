...
// Dependencies: [19, 17, 21, 4661, 11863, 11864, 2]
// Exports: default
...
export default function ContactSyncLandingImage() {
  ...
  obj = { resizeMode: "contain", style: tmp.landingImageLeft, source: importDefault(11863) };
  obj[1] = callback(closure_2, obj);
  const items = [callback(closure_3, obj), ];
  const obj1 = { style: tmp.rightContainer, children: null };
  obj1[1] = callback(closure_2, { resizeMode: "contain", style: tmp.landingImageRight, source: importDefault(11864) });
