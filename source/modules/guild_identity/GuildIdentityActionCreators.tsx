...
// Dependencies: [5, 676, 709, 530, 7946, 7943, 2]
...
// Module 9800 (_saveGuildIdentityChanges)
          ...
          if (0 === c7) {
            ...
            if (arg0 === 1) {
              ...
              if (null == callback) {
                ...
                obj6[1] = obj3;
                let obj9 = callback2(7946);
                const obj7 = {};
                obj7[callback(7943).SafetyScannedUploadSurface.USER_GUILD_PROFILE_AVATAR] = c8;
