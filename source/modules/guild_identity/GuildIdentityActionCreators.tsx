...
// Dependencies: [5, 673, 706, 527, 5122, 7769, 2]
...
// Module 9052 (_saveGuildIdentityChanges)
          ...
          if (0 === c7) {
            ...
            if (arg0 === 1) {
              ...
              if (null == callback) {
                ...
                obj6[1] = obj3;
                let obj9 = callback2(5122);
                const obj7 = {};
                obj7[callback(7769).SafetyScannedUploadSurface.USER_GUILD_PROFILE_AVATAR] = c8;
