...
// Dependencies: [5, 676, 709, 530, 8196, 8193, 2]
...
// Module 10055 (_saveGuildIdentityChanges)
          ...
          if (0 === c7) {
            ...
            if (arg0 === 1) {
              ...
              if (null == callback) {
                ...
                obj6[1] = obj3;
                let obj9 = callback2(8196);
                const obj7 = {};
                obj7[callback(8193).SafetyScannedUploadSurface.USER_GUILD_PROFILE_AVATAR] = c8;
