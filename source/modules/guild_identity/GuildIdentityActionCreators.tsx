...
// Dependencies: [5, 676, 709, 530, 8343, 8340, 2]
...
// Module 10198 (_saveGuildIdentityChanges)
          ...
          if (0 === c7) {
            ...
            if (arg0 === 1) {
              ...
              if (null == callback) {
                ...
                obj6[1] = obj3;
                let obj9 = callback2(8343);
                const obj7 = {};
                obj7[callback(8340).SafetyScannedUploadSurface.USER_GUILD_PROFILE_AVATAR] = c8;
