...
// Function ID: 10809
// Name: TransferFooter
// Dependencies: [5, 32, 19, 17, 4299, 676, 21, 4285, 712, 5311, 4695, 1236, 10809, 4281, 10810, 589, 10800, 38, 10807, 4253, 1231, 1297, 10343, 5377, 5376, 5379, 2]
// Exports: default

// Module 10808 (TransferFooter)
import ME from "ME";
...
function TransferFooter(arg0) {
  ...
  return closure_12(require(5311) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
}
function DeviceOption(children) {
  const tmp = createCacheKey();
  let obj = { style: tmp.deviceOption, children: null };
  obj = { style: tmp.deviceIcon, source: importDefault(10809) };
...
function EmptyState() {
  ...
  obj = { source: importDefault(10810), style: tmp.emptyArt };
  const items = [callback(closure_8, obj), , ];
        ...
        try {
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              obj1[0] = outer1_0(10807).transferToPlaystationWithAlert(outer1_0, dependencyMap[outer1_4], v0);
              return obj1;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
