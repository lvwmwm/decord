...
// Dependencies: [5, 19, 17, 676, 21, 9042, 9039, 9051, 4529, 9052, 1959, 9045, 4369, 2]
// Exports: default

// Module 9050 (_transferToXbox)
import set from "set";
import "noop";
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              obj1[0] = outer1_1(9042).maybeShowPTTAlert(outer1_6.XBOX);
              return obj1;
            }
          } else if (1 === tmp5) {
            if (arg0 === 1) {
              ...
              obj3[0] = callback2(9039).disconnectRemote();
              return obj3;
            }
          } else if (2 === tmp5) {
            if (arg0 === 1) {
            ...
            if (arg0 === 1) {
              ...
              obj7[0] = callback;
              callback2 = callback(9051)(user, obj7);
              dependencyMap = 4;
              c4 = 1;
            ...
            tmp47(9045)(user.id, constants.XBOX);
            obj3 = callback2(9039);
            ...
            obj11[0] = tmp47(4529).openLazy(obj10);
            return obj11;
          }
        } catch (tmp39) {
          c4 = tmp;
