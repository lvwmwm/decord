...
// Dependencies: [5, 19, 17, 673, 21, 9380, 9377, 9390, 4866, 9391, 2008, 9383, 4670, 2]
// Exports: default

// Module 9389 (_transferToXbox)
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              obj1[0] = closure_1_1(9380).maybeShowPTTAlert(closure_1_6.XBOX);
              return obj1;
            }
          } else if (1 === tmp5) {
            if (arg0 === 1) {
              ...
              obj3[0] = callback2(9377).disconnectRemote();
              return obj3;
            }
          } else if (2 === tmp5) {
            if (arg0 === 1) {
            ...
            if (arg0 === 1) {
              ...
              obj7[0] = callback;
              callback2 = callback(9390)(user, obj7);
              dependencyMap = 4;
              c4 = 1;
            ...
            tmp47(9383)(user.id, constants.XBOX);
            obj3 = callback2(9377);
            ...
            obj11[0] = tmp47(4866).openLazy(obj10);
            return obj11;
          }
        } catch (tmp39) {
          c4 = tmp;
