...
function normal(border) {
  ...
  const match = _require(4330).match(arg1);
  const str = _require(4330);
  obj.label = match.with(_require(7940).PollLayoutTypes.IMAGE_ONLY_ANSWERS, () => border.colors.WHITE).otherwise(() => border.colors.TEXT_DEFAULT);
  obj.opacity = 1;
  obj.answerBackground = border.colors.BACKGROUND_MOD_MUTED;
  obj.answerFill = border.colors.BACKGROUND_MOD_SUBTLE;
  obj.radioStyle = _require(7941).PollRadioStyle.HOLLOW;
...
function notVoted(colors, arg1) {
  ...
  obj["radioStyle"] = require(7941) /* NativeShadowType */.PollRadioStyle.NONE;
  return obj;
}
...
export const pollStyleSets = {
  loserSelected(colors) {
    ...
    obj["radioStyle"] = require(7941) /* NativeShadowType */.PollRadioStyle.CHECKMARK;
  ...
  selected(colors) {
    ...
    obj["borderWidth"] = 1;
    obj["radioStyle"] = require(7941) /* NativeShadowType */.PollRadioStyle.FILLED;
