...
function normal(border) {
  ...
  obj[3] = match.with(_require(8002).PollLayoutTypes.IMAGE_ONLY_ANSWERS, () => border.colors.WHITE).otherwise(() => border.colors.TEXT_DEFAULT);
  obj[5] = border.colors.BACKGROUND_MOD_MUTED;
  obj[6] = border.colors.BACKGROUND_MOD_SUBTLE;
  obj[7] = _require(8003).PollRadioStyle.HOLLOW;
...
function notVoted(colors) {
  ...
  obj.radioStyle = require(8003) /* NativeShadowType */.PollRadioStyle.NONE;
  return obj;
}
...
export const pollStyleSets = {
  loserSelected(colors) {
    ...
    obj.radioStyle = require(8003) /* NativeShadowType */.PollRadioStyle.CHECKMARK;
  ...
  selected(colors) {
    ...
    obj.borderWidth = 1;
    obj.radioStyle = require(8003) /* NativeShadowType */.PollRadioStyle.FILLED;
