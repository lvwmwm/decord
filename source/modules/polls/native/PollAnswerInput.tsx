...
result = { defaultContainer: { -9223372036854775808: true, filter: true } };
...
result.pollAnswerTextInput = { GuildBadgeGem: null, useApplicationIdentityLinkedRolesEnabled: null };
const obj1 = { "Bool(false)": "p\u00E4iv\u00E4", "Bool(false)": "{{count}} p\u00E4iv\u00E4\u00E4", "Bool(false)": "noin viikko", color: require("result").colors.TEXT_MUTED };
