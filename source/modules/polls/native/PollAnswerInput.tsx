...
__exportStarResult1 = { defaultContainer: {} };
...
__exportStarResult1.defaultImageContainer = {};
__exportStarResult1.pollAnswerTextInput = {};
__exportStarResult1.defaultRemoveButtonContainer = { color: require("__exportStarResult1").colors.TEXT_MUTED };
__exportStarResult1.uploadContainer = { alignItems: "flex-start" };
const obj1 = { color: require("__exportStarResult1").colors.TEXT_MUTED };
...
export default function PollAnswerInput(answer) {
  ...
  const obj2 = { "Null": 1107296879, "Null": 68744, "Null": 159677, "Null": 21264706, ref: inputRef };
