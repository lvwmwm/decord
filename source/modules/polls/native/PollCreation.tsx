...
// Dependencies: [19, 17, 7355, 21, 4342, 712, 500, 4710, 1236, 7856, 1297, 11657, 4338, 11658, 4310, 11659, 2007, 5435, 4205, 9413, 503, 5430, 11655, 4062, 10067, 1351, 11660, 11665, 5337, 7287, 4707, 11666, 6072, 5388, 11667, 8033, 11669, 8519, 2]
// Exports: default

// Module 11656 (UnsavedChangesAlertModal)
...
function UnsavedChangesAlertModal(onConfirm) {
  ...
  const items = [callback(require(4710) /* getAlertModalItemKey */.AlertActionButton, obj, "confirm"), ];
  const obj1 = { variant: "secondary", text: null };
  const intl4 = require(1236) /* getSystemLocale */.intl;
  obj1[1] = intl4.string(require(1236) /* getSystemLocale */.t["2BR5R2"]);
  items[1] = callback(require(4710) /* getAlertModalItemKey */.AlertActionButton, obj1, "back");
  obj[0] = items;
  obj[2] = callback2(closure_10, obj);
  return callback(require(4710) /* getAlertModalItemKey */.AlertModal, obj);
}
function AddAnswerButton(onPress) {
  const tmp = callback3();
  let obj = { source: null, size: null, color: null };
  obj[0] = importDefault(11657);
...
let closure_14 = importAllResult.forwardRef((error, ref) => {
  ...
  return closure_9(require(7856) /* TextInput */.TextInput, obj);
});
