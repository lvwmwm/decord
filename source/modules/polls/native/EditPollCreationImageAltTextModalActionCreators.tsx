...
export const openEditPollCreationImageAltTextModal = function openEditPollCreationImageAltTextModal(merged) {
  importDefault(4337).pushLazy(require(1934) /* maybeLoadBundle */(11335, dependencyMap.paths), merged, "edit-poll-creation-image-alt-text-modal");
};
