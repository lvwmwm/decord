...
// Dependencies: [32, 19, 17, 7196, 21, 4255, 712, 11510, 11512, 5243, 1236, 1297, 7825, 4251, 5704, 8652, 7765, 2]
// Exports: default

// Module 11513 (EditPollCreationImageAltTextModal)
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = first(11510)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  obj1[0] = onSave(11512).closeEditPollCreationImageAltTextModal;
  ...
  items1[1] = callback2(onSave(4251).Text, obj3);
  ...
  obj4[2] = callback2(onSave(4251).Text, obj5);
  ...
  items4[2] = callback2(onSave(7765).FormInput, obj11);
  ...
  obj[2] = items2;
  return callback3(onSave(5243).SafeAreaPaddingView, obj);
};
