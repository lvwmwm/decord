...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  items1[1] = callback2(onSave(4127).Text, obj2);
  ...
  obj3.children = callback2(onSave(4127).Text, obj4);
  ...
  items4[1] = callback2(first(8281), obj9);
  ...
  items4[2] = callback2(onSave(7575).FormInput, obj10);
