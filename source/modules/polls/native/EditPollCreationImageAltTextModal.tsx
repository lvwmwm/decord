...
// Dependencies: [32, 19, 17, 7182, 21, 4255, 712, 11481, 11483, 5257, 1236, 1297, 7809, 4251, 5718, 8954, 7749, 2]
// Exports: default

// Module 11484 (EditPollCreationImageAltTextModal)
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = first(11481)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  obj1[0] = onSave(11483).closeEditPollCreationImageAltTextModal;
  ...
  items4[2] = callback2(onSave(7749).FormInput, obj11);
  ...
  obj[2] = items2;
  return callback3(onSave(5257).SafeAreaPaddingView, obj);
};
