...
// Dependencies: [32, 19, 17, 7333, 21, 4342, 712, 11653, 11655, 5368, 1236, 1297, 8072, 4338, 5864, 9109, 8012, 2]
// Exports: default

// Module 11656 (EditPollCreationImageAltTextModal)
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  items4[2] = callback2(onSave(8012).FormInput, obj11);
  ...
  obj[2] = items2;
  return callback3(onSave(5368).SafeAreaPaddingView, obj);
};
