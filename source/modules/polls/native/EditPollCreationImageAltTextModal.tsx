...
// Dependencies: [32, 19, 17, 7208, 21, 4285, 712, 11509, 11511, 5272, 1236, 1297, 7837, 4281, 5733, 8982, 7777, 2]
// Exports: default

// Module 11512 (EditPollCreationImageAltTextModal)
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = first(11509)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  obj1[0] = onSave(11511).closeEditPollCreationImageAltTextModal;
  ...
  items4[2] = callback2(onSave(7777).FormInput, obj11);
  ...
  obj[2] = items2;
  return callback3(onSave(5272).SafeAreaPaddingView, obj);
};
