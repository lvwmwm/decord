...
// Dependencies: [32, 19, 17, 7355, 21, 4342, 712, 11670, 11672, 5389, 1236, 1297, 8093, 4338, 5885, 9123, 8033, 2]
// Exports: default

// Module 11673 (EditPollCreationImageAltTextModal)
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = first(11670)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  obj1[0] = onSave(11672).closeEditPollCreationImageAltTextModal;
  ...
  items1[1] = callback2(onSave(4338).Text, obj3);
  ...
  obj4[2] = callback2(onSave(4338).Text, obj5);
  ...
  items4[2] = callback2(onSave(8033).FormInput, obj11);
  ...
  obj[2] = items2;
  return callback3(onSave(5389).SafeAreaPaddingView, obj);
};
