...
// Dependencies: [32, 19, 17, 7209, 21, 4285, 712, 11515, 11517, 5311, 1236, 1297, 7950, 4281, 5745, 8983, 7890, 2]
// Exports: default

// Module 11518 (EditPollCreationImageAltTextModal)
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = first(11515)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  obj1[0] = onSave(11517).closeEditPollCreationImageAltTextModal;
  ...
  items1[1] = callback2(onSave(4281).Text, obj3);
  ...
  obj4[2] = callback2(onSave(4281).Text, obj5);
  ...
  items4[2] = callback2(onSave(7890).FormInput, obj11);
  ...
  obj[2] = items2;
  return callback3(onSave(5311).SafeAreaPaddingView, obj);
};
