...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  items1[1] = callback2(onSave(4185).Text, obj3);
  ...
  obj4[2] = callback2(onSave(4185).Text, obj5);
  ...
  obj[2] = items2;
  return callback3(onSave(5177).SafeAreaPaddingView, obj);
};
