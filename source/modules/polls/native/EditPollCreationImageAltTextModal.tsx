...
// Dependencies: [57, 31, 27, 6122, 33, 4165, 689, 11362, 11364, 5155, 1212, 1273, 7676, 4161, 5620, 8319, 7611, 2]
// Exports: default

// Module 11365 (EditPollCreationImageAltTextModal)
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp2 = first(11362)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  obj = { onPress: onSave(11364).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button" };
  const intl = onSave(1212).intl;
  obj.accessibilityLabel = intl.string(onSave(1212).t.cpT0Cq);
  const obj1 = { source: first(7676) };
  ...
  items1[1] = callback2(onSave(4161).Text, obj2);
  ...
  obj3.children = callback2(onSave(4161).Text, obj4);
  ...
  items4[2] = callback2(onSave(7611).FormInput, obj10);
  ...
  obj.children = items2;
  return callback3(onSave(5155).SafeAreaPaddingView, obj);
};
