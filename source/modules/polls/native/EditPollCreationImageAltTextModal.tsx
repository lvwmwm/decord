...
// Dependencies: [32, 19, 17, 6144, 21, 4193, 712, 11400, 11402, 5181, 1236, 1297, 7704, 4189, 5642, 8347, 7639, 2]
// Exports: default

// Module 11403 (EditPollCreationImageAltTextModal)
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = first(11400)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  obj1[0] = onSave(11402).closeEditPollCreationImageAltTextModal;
  ...
  items1[1] = callback2(onSave(4189).Text, obj3);
  ...
  obj4[2] = callback2(onSave(4189).Text, obj5);
  ...
  items4[2] = callback2(onSave(7639).FormInput, obj11);
  ...
  obj[2] = items2;
  return callback3(onSave(5181).SafeAreaPaddingView, obj);
};
