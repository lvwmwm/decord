...
// Dependencies: [19, 21, 12132, 1350, 4448, 5640, 1233, 5643, 7138, 2]
// Exports: default

// Module 12133 (PollDurationRadioGroup)
import ActionSheet from "ActionSheet" /* 7138 */;
import usePollDurationOptionsDefault from "usePollDurationOptions" /* 12132 */;
...
function PollDurationRadioGroup(onChange) {
  ...
  return jsx(onChange(5640).TableRadioGroup, { title: null, hasIcons: false, onChange: null, defaultValue: null, children: null });
}
