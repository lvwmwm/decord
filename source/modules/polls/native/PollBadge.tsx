...
// Function ID: 117790
// Name: PollBadge
// Dependencies: [31, 27, 33, 4131, 689, 1273, 15436, 4127, 1212, 2]
// Exports: default

// Module 15435 (PollBadge)
import "result";
...
export default function PollBadge(style) {
  ...
  obj = { size: require(1273) /* Button */.IconSizes.EXTRA_SMALL_10, source: importDefault(15436) };
