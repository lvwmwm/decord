...
// Dependencies: [5, 4825, 7576, 11380, 8949, 4838, 4829, 8466, 2]
      ...
      if (c8 === 2) {
        ...
        try {
          ...
          if (0 === obj7) {
            ...
            obj7[0] = callback2;
            obj7[1] = callback(4829).UploadOrigin.IMAGE_PICKER;
            obj7[2] = closure_5;
            obj7[3] = closure_5;
            ...
            obj7[7] = height;
            obj7[8] = callback(4829).UploadPlatform.REACT_NATIVE;
            obj = callback2(8466);
