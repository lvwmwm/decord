...
// Dependencies: [5, 4854, 7573, 11772, 8537, 5082, 5073, 8163, 2]
...
// Module 11771 (_handlePollGifAttachmentAdd)
        ...
        try {
          ...
          if (0 === obj7) {
            if (arg0 === 1) {
              ...
              let styles;
              obj7 = undefined;
              dependencyMap = callback(11772).getFileNameFromGifUrl(callback2, dependencyMap);
              styles = 1;
              const obj16 = callback(11772);
              obj7 = 2;
              c8 = 1;
              obj1 = { value: null, done: false };
              obj1[0] = callback(11772).downloadPollGif(dependencyMap);
              return obj1;
            }
          } else if (1 === tmp8) {
            styles = 0;
            ...
            obj7[7] = height;
            obj7[8] = callback(5073).UploadPlatform.REACT_NATIVE;
            obj = callback2(8163);
...
function _removePollUploadAttachment() {
  ...
  const tmp = callback((arg0, arg1, arg2) => {
    ...
    return (function*(arg0, arg1, arg2) {
      ...
      const obj6 = callback(8537);
      yield obj6.removeFile("cache", callback(11772).getFilePathForGif(dependencyMap));
      if (1 === tmp6) {
        c6 = 0;
        c3 = 3;
      } else if (arg0 === 1) {
...
function _removeAllPollUploadAttachments() {
  ...
  const tmp = callback((arg0) => {
    ...
    return (function*(arg0) {
      ...
      yield callback(8537).clearFolder("cache", closure_1_5);
      if (1 === tmp6) {
        Poll = 0;
        v0 = 3;
      } else if (arg0 === 1) {
