...
// Dependencies: [5, 4640, 7289, 11593, 8807, 4860, 4851, 8362, 2]
...
// Module 11592 (_handlePollGifAttachmentAdd)
        ...
        try {
          ...
          if (0 === obj7) {
            if (arg0 === 1) {
              ...
              let styles;
              obj7 = undefined;
              dependencyMap = callback(11593).getFileNameFromGifUrl(callback2, dependencyMap);
              styles = 1;
              const obj16 = callback(11593);
              obj7 = 2;
              c8 = 1;
              const obj1 = { value: null, done: false };
              obj1[0] = callback(11593).downloadPollGif(dependencyMap);
              return obj1;
            }
          } else if (1 === tmp8) {
            styles = 0;
...
function _removePollUploadAttachment() {
  ...
  const tmp = callback((arg0, arg1, arg2) => {
    ...
    return (function*(arg0, arg1, arg2) {
      let c6 = 1;
      callback2(8362).remove(callback, callback2, Poll.Poll);
      const obj5 = callback2(8362);
      const obj6 = callback(8807);
      yield obj6.removeFile("cache", callback(11593).getFilePathForGif(dependencyMap));
      if (1 === tmp6) {
        c6 = 0;
        let c3 = 3;
      } else if (arg0 === 1) {
...
function _removeAllPollUploadAttachments() {
  ...
  const tmp = callback((arg0) => {
    ...
    return (function*(arg0) {
      ...
      yield callback(8807).clearFolder("cache", outer1_5);
      if (1 === tmp6) {
        Poll = 0;
        v0 = 3;
      } else if (arg0 === 1) {
