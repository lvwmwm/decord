...
// Dependencies: [4253, 10202, 1988, 2]
// Exports: showVotesForAnswer

// Module 10201 (showVotesForAnswer)
...
export const showVotesForAnswer = function showVotesForAnswer(initialAnswerId) {
  ...
  obj.openLazy(require(1988) /* asyncRequireImpl */(10202, dependencyMap.paths), "PollVotesActionSheet", obj);
};
