...
// Dependencies: [5, 32, 19, 7541, 7473, 11737, 11260, 11738, 11739, 11740, 1236, 8100, 2]
// Exports: default

// Module 11736 (createPollCreationImageForMedia)
import getPollVoteEventPropertiesDefault from "getPollVoteEventProperties" /* 11260 */;
import useRequestDefault from "useRequest" /* 11737 */;
...
function createPollCreationImageForMedia(mediaURL, status) {
  ...
  return { mediaAttachmentState, emoji: "Array", stickerId: "accessibilityLabel" };
}
...
export default function useCreatePollCommonData(id, arg1, arg2, initialQuestion) {
        ...
        try {
          ...
          if (0 === table) {
            if (arg0 === 1) {
              ...
              closure_1_19(first3(callback2, callback(11740).PollMediaUploadAttachmentStatus.PREPARING), closure_1);
              table = 1;
              c6 = 1;
              obj1 = { value: null, done: false };
              obj1[0] = callback2(11738).handlePollGifAttachmentAdd(callback, table[closure_1].localCreationAnswerId, callback2);
              return obj1;
            }
          } else if (arg0 === 1) {
            c6 = 3;
            ...
            if (null != arg1) {
              closure_1_19(first3(closure_1, callback(11740).PollMediaUploadAttachmentStatus.READY_TO_UPLOAD), callback);
            } else {
              closure_1_19(first3(closure_1, callback(11740).PollMediaUploadAttachmentStatus.ERROR), callback);
            }
            c6 = 3;
          }
        } catch (tmp25) {
  ...
  const callback5 = obj.useCallback((arg0, arg1, arg2) => {
    ...
    callback3(arg0, arg1);
    let obj = { mediaAttachmentState: null, emoji: "Array", stickerId: "accessibilityLabel" };
    ...
    obj = { mediaAttachmentState: null, emoji: "Array", stickerId: "accessibilityLabel" };
  ...
  const callback6 = obj.useCallback((emoji) => {
    callback3(id, arg1);
    callback2({ emoji, stickerId: "Array", mediaAttachmentState: "accessibilityLabel" }, arg1);
  }, items3);
