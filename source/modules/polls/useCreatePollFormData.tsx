...
// Dependencies: [5, 32, 19, 6144, 6076, 11391, 9970, 11392, 11393, 11394, 1236, 8006, 2]
// Exports: default
...
function createPollCreationImageForMedia(mediaURL, status) {
  ...
  return { mediaAttachmentState, emoji: "Array", stickerId: "padding" };
}
...
export default function useCreatePollCommonData(id, arg1, arg2, initialQuestion) {
  ...
  const tmpResult4 = first(importDefault(11391)(importDefault(9970).createPoll), 2);
        ...
        try {
          ...
          if (0 === table) {
            if (arg0 === 1) {
              ...
              outer1_18(first3(callback2, callback(11394).PollMediaUploadAttachmentStatus.PREPARING), closure_1);
              table = 1;
              c6 = 1;
              const obj1 = { value: null, done: false };
              obj1[0] = callback2(11392).handlePollGifAttachmentAdd(callback, table[closure_1].localCreationAnswerId, callback2);
              return obj1;
            }
          } else if (arg0 === 1) {
            c6 = 3;
            ...
            if (null != arg1) {
              outer1_18(first3(closure_1, callback(11394).PollMediaUploadAttachmentStatus.READY_TO_UPLOAD), callback);
            } else {
              outer1_18(first3(closure_1, callback(11394).PollMediaUploadAttachmentStatus.ERROR), callback);
            }
            c6 = 3;
          }
        } catch (tmp25) {
  ...
  const callback5 = obj.useCallback((arg0, arg1, arg2) => {
    ...
    callback3(arg0, arg1);
    let obj = { mediaAttachmentState: null, emoji: "Array", stickerId: "padding" };
    ...
    obj = { mediaAttachmentState: null, emoji: "Array", stickerId: "padding" };
  ...
  const callback6 = obj.useCallback((emoji) => {
    callback3(id, arg1);
    callback2({ emoji, stickerId: "Array", mediaAttachmentState: "padding" }, arg1);
  }, items3);
