...
// Dependencies: [5, 32, 19, 7209, 7141, 11506, 10200, 11507, 11508, 11509, 1236, 8248, 2]
// Exports: default

// Module 11505 (createPollCreationImageForMedia)
...
function createPollCreationImageForMedia(mediaURL, status) {
  ...
  return { mediaAttachmentState, emoji: "r", stickerId: "channelId" };
}
...
export default function useCreatePollCommonData(id, arg1, arg2, initialQuestion) {
  ...
  const tmpResult4 = first(importDefault(11506)(importDefault(10200).createPoll), 2);
        ...
        try {
          ...
          if (0 === table) {
            if (arg0 === 1) {
              ...
              outer1_18(first3(callback2, callback(11509).PollMediaUploadAttachmentStatus.PREPARING), closure_1);
              table = 1;
              c6 = 1;
              const obj1 = { value: null, done: false };
              obj1[0] = callback2(11507).handlePollGifAttachmentAdd(callback, table[closure_1].localCreationAnswerId, callback2);
              return obj1;
            }
          } else if (arg0 === 1) {
            c6 = 3;
            ...
            if (null != arg1) {
              outer1_18(first3(closure_1, callback(11509).PollMediaUploadAttachmentStatus.READY_TO_UPLOAD), callback);
            } else {
              outer1_18(first3(closure_1, callback(11509).PollMediaUploadAttachmentStatus.ERROR), callback);
            }
            c6 = 3;
          }
        } catch (tmp25) {
  ...
  const callback5 = obj.useCallback((arg0, arg1, arg2) => {
    ...
    callback3(arg0, arg1);
    let obj = { mediaAttachmentState: null, emoji: "r", stickerId: "channelId" };
    ...
    obj = { mediaAttachmentState: null, emoji: "r", stickerId: "channelId" };
  ...
  const callback6 = obj.useCallback((emoji) => {
    callback3(id, arg1);
    callback2({ emoji, stickerId: "r", mediaAttachmentState: "channelId" }, arg1);
  }, items3);
