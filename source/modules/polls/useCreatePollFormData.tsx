...
// Dependencies: [5, 32, 19, 7328, 7260, 11648, 10329, 11649, 11650, 11651, 1236, 8369, 2]
// Exports: default

// Module 11647 (createPollCreationImageForMedia)
...
function createPollCreationImageForMedia(mediaURL, status) {
  ...
  return { mediaAttachmentState, emoji: "Array", stickerId: "accessibilityRole" };
}
({ MAX_NUMBER_OF_ANSWERS_PER_POLL: error, MIN_NUMBER_OF_ANSWERS_PER_POLL: metroImportAll, PollDurations: c9 } = POLL_ATTACHMENT_FOLDER);
let result = require("noop").fileFinishedImporting("modules/polls/useCreatePollFormData.tsx");
...
export default function useCreatePollCommonData(id, arg1, arg2, initialQuestion) {
  ...
  let closure_2 = arg2;
  let dependencyMap = initialQuestion;
  id = id.id;
  let obj = React;
  ...
  const tmpResult4 = first(importDefault(11648)(importDefault(10329).createPoll), 2);
        ...
        try {
          ...
          if (0 === table) {
            if (arg0 === 1) {
              ...
              outer1_18(first3(callback2, callback(11651).PollMediaUploadAttachmentStatus.PREPARING), closure_1);
              table = 1;
              c6 = 1;
              const obj1 = { value: null, done: false };
              obj1[0] = callback2(11649).handlePollGifAttachmentAdd(callback, table[closure_1].localCreationAnswerId, callback2);
              return obj1;
            }
          } else if (arg0 === 1) {
            c6 = 3;
            ...
            if (null != arg1) {
              outer1_18(first3(closure_1, callback(11651).PollMediaUploadAttachmentStatus.READY_TO_UPLOAD), callback);
            } else {
              outer1_18(first3(closure_1, callback(11651).PollMediaUploadAttachmentStatus.ERROR), callback);
            }
            c6 = 3;
          }
        } catch (tmp25) {
  ...
  const callback5 = obj.useCallback((arg0, arg1, arg2) => {
    ...
    callback3(arg0, arg1);
    let obj = { mediaAttachmentState: null, emoji: "Array", stickerId: "accessibilityRole" };
    ...
    obj = { mediaAttachmentState: null, emoji: "Array", stickerId: "accessibilityRole" };
  ...
  const callback6 = obj.useCallback((emoji) => {
    callback3(id, arg1);
    callback2({ emoji, stickerId: "Array", mediaAttachmentState: "accessibilityRole" }, arg1);
  }, items3);
  ...
  const effect = obj.useEffect(() => () => {
    const result = outer1_2(outer1_3[7]).removeAllPollUploadAttachments(useRequest);
  }, items6);
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            const obj1 = { channel: null, question: null, answers: null, allowMultiSelect: null, duration: null, layout: null, onClose: null };
            obj1[0] = v0;
            obj1[1] = outer1_7;
            obj1[2] = outer1_13;
            obj1[3] = outer1_9;
            obj1[4] = outer1_10;
            obj1[5] = v0(outer1_3[11]).PollLayoutTypes.DEFAULT;
            obj1[6] = c1;
            c1 = 1;
            v0 = 1;
            const obj2 = { value: null, done: false };
            obj2[0] = outer1_14(obj1);
            return obj2;
          }
        } else if (arg0 === 1) {
          v0 = 3;
  ...
  obj = {
    ...
    canPost: tmp15,
    canAddMoreAnswers: tmp21,
    canRemoveMoreAnswers: tmp22,
    ...
    submitting: loading,
    createPollError: tmp20.error,
    shouldFocusOnInvalidField: tmpResult3[0],
    setShouldFocusOnInvalidField: tmp14
  };
  return obj;
};
