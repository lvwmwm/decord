...
// Dependencies: [5, 32, 19, 7573, 7505, 11770, 11297, 11771, 11772, 11773, 1236, 8132, 2]
// Exports: default

// Module 11769 (createPollCreationImageForMedia)
import getPollVoteEventPropertiesDefault from "getPollVoteEventProperties" /* 11297 */;
        ...
        try {
          ...
          if (0 === table) {
            if (arg0 === 1) {
              ...
              closure_1_19(first3(callback2, callback(11773).PollMediaUploadAttachmentStatus.PREPARING), closure_1);
              table = 1;
              c6 = 1;
              obj1 = { value: null, done: false };
              obj1[0] = callback2(11771).handlePollGifAttachmentAdd(callback, table[closure_1].localCreationAnswerId, callback2);
              return obj1;
            }
          } else if (arg0 === 1) {
            c6 = 3;
            ...
            if (null != arg1) {
              closure_1_19(first3(closure_1, callback(11773).PollMediaUploadAttachmentStatus.READY_TO_UPLOAD), callback);
            } else {
              closure_1_19(first3(closure_1, callback(11773).PollMediaUploadAttachmentStatus.ERROR), callback);
            }
            c6 = 3;
          }
        } catch (tmp25) {
