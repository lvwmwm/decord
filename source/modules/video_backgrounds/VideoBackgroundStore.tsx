...
// Dependencies: [6, 7, 15, 17, 18, 1316, 4212, 1907, 1850, 8821, 4262, 566, 686, 2]

// Module 8820 (_isNativeReflectConstruct)
...
function hasVideoBackgroundLive(backgroundOption) {
  ...
  if (null == currentUser) {
    ...
    if (null == videoBackgroundOptionFromProto) {
      ...
      videoBackgroundOptionFromProto = require(8821) /* isCustomBackgroundOption */.getVideoBackgroundOptionFromProto(prop, currentUser.id);
...
tmp2 = new tmp2(require("dispatcher"), {
  ...
  MEDIA_ENGINE_APPLY_MEDIA_FILTER_SETTINGS: function handleApplyMediaFilterSettings(settings) {
    ...
    if (require(4262) /* getMediaEngineImpl */.FilterSettingsKey.CAMERA_BACKGROUND_LIVE in settings) {
      let c11 = true;
      let c15 = false;
    }
    if (require(4262) /* getMediaEngineImpl */.FilterSettingsKey.CAMERA_BACKGROUND_PREVIEW in settings) {
      let c16 = false;
    }
  },
