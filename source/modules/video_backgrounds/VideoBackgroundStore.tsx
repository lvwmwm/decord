...
// Dependencies: [1340, 4332, 1960, 1903, 9085, 4381, 589, 709, 2]

// Module 9084 (handleSyncedStoresUpdate)
...
function handleSyncedStoresUpdate() {
  ...
  if (null != currentUser) {
    ...
    const obj2 = require(9085) /* isAnimatedBackgroundOption */;
  }
  if (flag2) {
    c8 = true;
  }
  ...
  VIDEO_SAVE_LAST_USED_BACKGROUND_OPTION: function handleSaveLastUsedBackgroundOption(backgroundOption) {
    ...
    if (null != currentUser) {
      if (backgroundOption == null) {
        ...
        backgroundOption = require(9085) /* isAnimatedBackgroundOption */.getVideoBackgroundOptionFromProto(prop, currentUser.id);
