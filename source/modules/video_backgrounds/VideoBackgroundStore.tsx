...
// Dependencies: [1340, 4302, 1931, 1874, 9056, 4351, 589, 709, 2]

// Module 9055 (handleSyncedStoresUpdate)
...
function handleSyncedStoresUpdate() {
  ...
  if (null != currentUser) {
    ...
    const obj2 = require(9056) /* isAnimatedBackgroundOption */;
  }
  if (flag2) {
    c8 = true;
  }
...
const videoBackgroundStore = new VideoBackgroundStore(require("dispatcher"), {
  ...
  VIDEO_SAVE_LAST_USED_BACKGROUND_OPTION: function handleSaveLastUsedBackgroundOption(backgroundOption) {
    ...
    if (null != currentUser) {
      if (backgroundOption == null) {
        ...
        backgroundOption = require(9056) /* isAnimatedBackgroundOption */.getVideoBackgroundOptionFromProto(prop, currentUser.id);
  ...
  MEDIA_ENGINE_APPLY_MEDIA_FILTER_SETTINGS: function handleApplyMediaFilterSettings(settings) {
    ...
    if (require(4351) /* BaseConnectionEvent */.FilterSettingsKey.CAMERA_BACKGROUND_LIVE in settings) {
      let c6 = true;
      let c10 = false;
    }
    if (require(4351) /* BaseConnectionEvent */.FilterSettingsKey.CAMERA_BACKGROUND_PREVIEW in settings) {
      let c11 = false;
    }
  },
