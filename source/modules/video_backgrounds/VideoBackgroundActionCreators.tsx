...
// Dependencies: [5, 4302, 1874, 676, 530, 709, 9058, 9059, 9056, 1355, 2]
...
// Module 9057 (_fetchVideoFilterAssets)
      ...
      if (c8 === 2) {
        ...
        try {
          ...
          if (0 === c7) {
            ...
            const tmp24 = new callback(9058)(callback);
            throw tmp24;
          } else if (arg0 === 1) {
            c8 = 3;
            throw arg1;
      ...
      if (c4 === 2) {
        ...
        try {
          ...
          if (0 === c3) {
            ...
            lib2 = lib(9059).getLastUsedVideoBackgroundOption(currentUser.getCurrentUser());
            const obj7 = lib(9059);
            let result = lib(9056).isCustomBackgroundOption(lib2);
            if (result) {
