...
// Dependencies: [1391, 4415, 8316, 676, 1435, 4538, 698, 2]
...
// Module 9208 (isAnimatedBackgroundOption)
...
export const trackBackgroundOptionUpdated = function trackBackgroundOptionUpdated(closure_0, location, Enabled) {
  ...
  const voiceStateMetadata = require(4538) /* collectGuildAnalyticsMetadata */.getVoiceStateMetadata(guildId, channelId, true);
