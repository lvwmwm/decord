...
// Dependencies: [1391, 4416, 8320, 676, 1435, 4539, 698, 2]
...
// Module 9212 (isAnimatedBackgroundOption)
...
export const trackBackgroundOptionUpdated = function trackBackgroundOptionUpdated(closure_0, location, Enabled) {
  ...
  const voiceStateMetadata = require(4539) /* collectGuildAnalyticsMetadata */.getVoiceStateMetadata(guildId, channelId, true);
