      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            obj1[0] = outer1_0(11246).clearBuildOverride();
            return obj1;
          }
        } else if (arg0 === 1) {
          c3 = 3;
...
export const refreshBuildOverride = function refreshBuildOverride() {
  const result = importDefault(11247).checkForUpdateAndReload();
};
