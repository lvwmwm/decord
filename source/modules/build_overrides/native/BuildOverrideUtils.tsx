      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            obj1[0] = closure_1_0(11275).clearBuildOverride();
            return obj1;
          }
        } else if (arg0 === 1) {
          c3 = 3;
