...
export const getPublicBuildOverrideLink = function getPublicBuildOverrideLink(arg0) {
  ...
  let obj = { url: callback(4396).getAPIEndpoint("/__development/create_build_override_link"), body: arg0, headers: null, oldFormErrors: true, rejectWithError: false };
  let str = token.getToken();
  if (str == null) {
    str = "";
  }
  obj[2] = { Authorization: str };
  const obj2 = callback(4396);
