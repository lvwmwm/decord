...
// Dependencies: [19, 3892, 1874, 676, 21, 1480, 5601, 5634, 5300, 4445, 4715, 3959, 712, 16460, 12, 7749, 4663, 5581, 2]
// Exports: default

// Module 16537 (SyncingToGamesItem)
import "noop";
...
export default function GuildSettingsModalLobbiesLinked(arg0) {
  ...
  obj[1] = callback(_require(4663).Stack, obj2);
  const items1 = [callback(_require(7749).Form, obj), callback(_require(5581).NavScrim, {})];
  obj[0] = items1;
