...
// Function ID: 8917
// Name: handleFormInit
// Dependencies: [1412, 8895, 1376, 1415, 7655, 1882, 1862, 1874, 676, 8917, 7924, 11, 8918, 530, 709, 8920, 1411, 8921, 3837, 8922, 589, 12, 595, 2]

// Module 8916 (handleFormInit)
...
function handleFormInit(location) {
  ...
  if (null == guild) {
    ...
    if (section === constants.TAG) {
      obj = require(8918) /* canUseMobileServerTagSettings */;
...
function handleIntegrationsUpdate(type) {
  ...
  if (tmp) {
    ...
    if (tmp5) {
      const guildIntegrationsApplications = require(8922) /* _fetchGuildIntegrationsApplications */.fetchGuildIntegrationsApplications(user.id);
      const obj = require(8922) /* _fetchGuildIntegrationsApplications */;
    }
    tmp = tmp5;
  }
  return tmp;
...
obj = {
  ...
  GUILD_SETTINGS_SUBMIT_FAILURE: function handleFormSubmitFailure(errors) {
    ...
    if (defaultGuildSettingsSection == null) {
      defaultGuildSettingsSection = require(8921) /* getDefaultGuildSettingsSection */.getDefaultGuildSettingsSection();
      const obj = require(8921) /* getDefaultGuildSettingsSection */;
    }
    let c4 = null;
        ...
        if (closure_3 !== tmp27.INVITES) {
          if (closure_3 !== tmp27.INTEGRATIONS) {
            if (closure_3 !== tmp27.ROLES) {
              if (closure_3 === tmp27.MEMBERS) {
                ...
                const vanityUrl = require(8920) /* fetchVanityUrl */.fetchVanityUrl(user.id);
                const obj2 = require(8920) /* fetchVanityUrl */;
          ...
          if (tmp25 !== section.section) {
            ...
            if (tmp12) {
              ...
              if (tmp13) {
                const guildIntegrationsApplications = require(8922) /* _fetchGuildIntegrationsApplications */.fetchGuildIntegrationsApplications(user.id);
                const obj3 = require(8922) /* _fetchGuildIntegrationsApplications */;
              }
              tmp12 = tmp13;
            }
            return tmp12;
  ...
  GUILD_PROFILE_FETCH_SUCCESS: function handleProfileFetch(profile) {
    ...
    if (tmp2) {
      const result = require(8918) /* canUseMobileServerTagSettings */.isServerTagDraftDirty(profile, profile);
      tmp2 = !result;
      const obj = require(8918) /* canUseMobileServerTagSettings */;
      const tmp8 = !result;
    }
    return tmp2;
  },
