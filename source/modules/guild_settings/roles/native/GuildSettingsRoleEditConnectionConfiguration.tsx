...
// Function ID: 16618
// Name: Header
// Dependencies: [32, 19, 17, 676, 5107, 21, 4285, 712, 4221, 10954, 1297, 1416, 4130, 5354, 1236, 4827, 5309, 5689, 16618, 500, 4281, 4981, 5688, 2]
// Exports: default
...
function Header(arg0) {
  ...
  obj3[1] = onRemove;
  obj3[2] = locked;
  obj3[3] = callback2(require(5309) /* XSmallIcon */.XSmallIcon, {});
  obj2[2] = callback2(require(4827) /* PressableBase */.PressableOpacity, obj3);
  return callback2(require(5354) /* TableRowInner */.TableRow, obj2);
}
