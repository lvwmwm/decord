...
// Function ID: 16447
// Name: width
// Dependencies: [32, 19, 17, 4181, 1862, 16442, 676, 21, 4189, 712, 6558, 698, 4384, 7656, 4717, 4185, 13219, 1297, 10004, 4600, 1236, 2]
// Exports: default
...
export default function GuildSettingsRoleTemplate(arg0) {
  ...
  obj = { accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: callback2(importDefault(7656), obj1) };
  ...
  obj3[12] = !tmp10;
  items1[1] = tmp14(importDefault(13219), obj3);
  obj[2] = items1;
