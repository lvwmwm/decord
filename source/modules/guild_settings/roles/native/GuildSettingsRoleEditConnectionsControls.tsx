...
// Function ID: 16714
// Name: HeaderSection
// Dependencies: [19, 17, 5358, 16688, 676, 5125, 21, 4303, 712, 5124, 12, 7793, 4299, 1236, 4712, 4846, 1974, 7985, 7984, 16714, 4714, 9527, 4271, 16716, 1988, 16717, 16719, 589, 7967, 16702, 2]
// Exports: default

// Module 16713 (HeaderSection)
...
function HeaderSection(arg0) {
  ...
  if (hasMembers) {
    ...
    const items = [callback(require(7793) /* CircleErrorIcon */.CircleErrorIcon, obj), ];
  ...
  const items2 = [callback(require(4299) /* Text */.Text, obj2), ];
  let tmp13Result;
  if (hasConnections) {
  ...
  obj6[0] = items3;
  items1[1] = closure_11(require(4712) /* Stack */.Stack, obj6);
  obj5[0] = items1;
...
function renderRoleConnectionConfigurations(memo, arg1, locked, arg3, integrations) {
  ...
  return callback(_require(4712).Stack, obj1);
}
function AddConnectionButton(locked) {
  ...
  obj[2] = callback(require(9527) /* CirclePlusIcon */.CirclePlusIcon, { size: "sm" });
  obj[3] = locked.locked;
...
export default function GuildSettingsRolesEditConnectionsControls(guild) {
  ...
  obj3 = {
    handleConnectionTapped(connectionType) {
      const items = [...memo];
      const obj = { connectionType, connectionMetadataField: "Array", applicationId: "accessible", operator: "getGuild", value: 17047296 };
      obj[2] = arg1;
      items.push(obj);
      if (AND === guild(stateFromStoresArray[9]).ConnectionConfigurationRuleOperator.AND) {
        if (0 === items.length) {
