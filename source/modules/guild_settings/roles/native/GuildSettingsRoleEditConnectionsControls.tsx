...
// Function ID: 16577
// Name: HeaderSection
// Dependencies: [19, 17, 5284, 16551, 676, 5077, 21, 4255, 712, 5076, 12, 7688, 4251, 1236, 4663, 4797, 1945, 7767, 7766, 16577, 4665, 9416, 4223, 16579, 1959, 16580, 16582, 589, 7749, 16565, 2]
// Exports: default

// Module 16576 (HeaderSection)
...
function HeaderSection(arg0) {
  ...
  if (hasMembers) {
    ...
    const items = [callback(require(7688) /* CircleErrorIcon */.CircleErrorIcon, obj), ];
  ...
  if (hasConnections) {
    ...
    tmp13Result = tmp13(tmp10(4797).PressableOpacity, obj3);
  }
  ...
  obj6[0] = items3;
  items1[1] = closure_11(require(4663) /* Stack */.Stack, obj6);
  obj5[0] = items1;
...
function AndOrRadios(setPendingRoleConfigurations) {
  ...
  if (roleConnectionConfigurations(5076).ConnectionConfigurationRuleOperator.OR === roleConnectionConfigurations(5076).ConnectionConfigurationRuleOperator.AND) {
    ...
    obj[0] = tmp(5076).ConnectionConfigurationRuleOperator.OR;
    ...
    obj[2] = tmp11;
    const items2 = [closure_10(tmp(7766).TableRadioRow, obj), ];
    const obj1 = { value: null, label: null, disabled: null };
    obj1[0] = tmp(5076).ConnectionConfigurationRuleOperator.AND;
    const intl3 = tmp(1236).intl;
    obj1[1] = intl3.string(tmp(1236).t.gHXS9A);
    obj1[2] = locked;
    items2[1] = closure_10(tmp(7766).TableRadioRow, obj1);
    obj[4] = items2;
    return closure_11(tmp(7767).TableRadioGroup, obj);
  }
}
function renderRoleConnectionConfigurations(memo, arg1, locked, arg3, integrations) {
  ...
  return callback(_require(4663).Stack, obj1);
}
function AddConnectionButton(locked) {
  ...
  obj[2] = callback(require(9416) /* CirclePlusIcon */.CirclePlusIcon, { size: "sm" });
  obj[3] = locked.locked;
  ...
  return callback(require(4665) /* Button */.Button, obj);
}
...
export default function GuildSettingsRolesEditConnectionsControls(guild) {
  ...
  obj3 = {
    handleConnectionTapped(connectionType) {
      const items = [...memo];
      const obj = { connectionType, connectionMetadataField: "Array", applicationId: "padding", operator: "split", value: "r" };
      obj[2] = arg1;
      items.push(obj);
      if (AND === guild(stateFromStoresArray[9]).ConnectionConfigurationRuleOperator.AND) {
        if (0 === items.length) {
