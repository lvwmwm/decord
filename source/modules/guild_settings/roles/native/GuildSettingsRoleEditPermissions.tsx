...
// Dependencies: [57, 31, 27, 1391, 3793, 1850, 653, 33, 4165, 689, 3798, 44, 4161, 1212, 4133, 16438, 1935, 15622, 16435, 9215, 675, 483, 15626, 5537, 5536, 1273, 8272, 2]
// Exports: default

// Module 16437 (GuildSettingsRoleEditPermission)
...
export default function GuildSettingsRoleEditPermission(guild) {
  ...
  if (tmp12) {
    ...
    tmp12 = callback2(guild(4161).Text, obj1);
  }
  obj.children = tmp12;
  ...
  if (tmp21) {
    ...
    obj7 = { Illustration: guild(8272).NoResultsAlt };
