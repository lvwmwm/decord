...
// Dependencies: [5, 32, 19, 17, 1415, 1935, 1874, 8302, 16442, 676, 21, 4189, 5140, 712, 698, 4384, 4185, 1236, 16440, 589, 38, 3822, 1480, 6741, 5143, 5105, 3889, 16439, 4157, 14943, 1959, 4598, 6724, 5554, 5220, 13692, 688, 4600, 16446, 16447, 8301, 16448, 5215, 4586, 4596, 5636, 4616, 5570, 2]
// Exports: default

// Module 16441 (RoleCreateScene)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            obj1[0] = outer1_1(5105).createRole(outer1_1.id, c2, num5);
            return obj1;
          }
        } else {
          if (1 === tmp7) {
            ...
            const result1 = outer1_12.addConditionalChangeListener(() => {
              ...
              if (null != selectedRoleId) {
                if (null != role) {
                  if (null != guild) {
                    tmp3(3889).roleCreatedToast();
                    const obj5 = tmp3(3889);
                    const tmp13 = tmp3;
                    tmp3(16439).setRoleJustCreated(true);
                    ...
                    const merged = Object.assign(tmp13(4384).collectGuildAnalyticsMetadata(guild.id));
...
export default function GuildSettingsRoleCreateModal() {
  ...
  return callback3(stateFromStores(5570).Navigator, obj);
};
