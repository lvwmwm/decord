...
// Dependencies: [19, 17, 676, 21, 4303, 712, 698, 4271, 4001, 5396, 1236, 5764, 16691, 4642, 2]
// Exports: default

// Module 16711 (RolePermissionTemplatesActionSheet)
...
export default function RolePermissionTemplatesActionSheet(guildId) {
  ...
  return jsx(require(5764) /* ActionSheet */.ActionSheet, { style: tmp.templateContainer, children: null });
};
