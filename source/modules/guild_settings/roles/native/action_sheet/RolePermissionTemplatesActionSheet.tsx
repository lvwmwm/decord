...
// Module 16196 (RolePermissionTemplatesActionSheet)
...
obj = {};
obj = { DEFAULT_CHANNEL_ICON: "Group 11", DISPLAY_NAME_STYLES_COLOR_SELECTED: 2, backgroundColor: importDefault(dependencyMap[5]).colors.BACKGROUND_BASE_LOWER };
