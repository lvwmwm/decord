...
// Dependencies: [32, 19, 17, 21, 10954, 5354, 1297, 4221, 5376, 1236, 6883, 1416, 4130, 4253, 8879, 5685, 9064, 5379, 5311, 5688, 2]
// Exports: default

// Module 16619 (IdentityApplicationRow)
...
export default function SelectConnectionActionSheet(arg0) {
  ...
  obj = { scrollable: true, header: callback2(require(5376) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj), startExpanded: true, children: null };
  if (num > 0) {
  ...
  obj4[1] = callback2(require(5688) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: true, children: tmp15 });
  obj3[0] = callback2(require(5311) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj4);
  items1[1] = callback2(require(5379) /* BottomSheetModal */.BottomSheetScrollView, obj3);
  obj[3] = items1;
  return closure_7(require(5685) /* ActionSheet */.ActionSheet, obj);
};
