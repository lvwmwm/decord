...
// Dependencies: [32, 19, 17, 21, 10922, 5300, 1297, 4191, 5322, 1236, 6856, 1416, 4101, 4223, 8850, 5631, 9035, 5325, 5257, 5634, 2]
// Exports: default

// Module 16579 (IdentityApplicationRow)
...
export default function SelectConnectionActionSheet(arg0) {
  ...
  obj = { scrollable: true, header: callback2(require(5322) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj), startExpanded: true, children: null };
  if (num > 0) {
  ...
  obj4[1] = callback2(require(5634) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: true, children: tmp15 });
  obj3[0] = callback2(require(5257) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj4);
  items1[1] = callback2(require(5325) /* BottomSheetModal */.BottomSheetScrollView, obj3);
  obj[3] = items1;
  return closure_7(require(5631) /* ActionSheet */.ActionSheet, obj);
};
