...
// Dependencies: [32, 19, 17, 21, 10969, 5373, 1297, 4238, 5395, 1236, 6902, 1416, 4147, 4270, 8896, 5704, 9081, 5398, 5327, 5707, 2]
// Exports: default

// Module 16639 (IdentityApplicationRow)
...
export default function SelectConnectionActionSheet(arg0) {
  ...
  obj = { scrollable: true, header: callback2(require(5395) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj), startExpanded: true, children: null };
  if (num > 0) {
  ...
  obj4[1] = callback2(require(5707) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: true, children: tmp15 });
  obj3[0] = callback2(require(5327) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj4);
  items1[1] = callback2(require(5398) /* BottomSheetModal */.BottomSheetScrollView, obj3);
  obj[3] = items1;
  return closure_7(require(5704) /* ActionSheet */.ActionSheet, obj);
};
