...
// Module 16165 (_isNativeReflectConstruct)
let FormStates;
...
function initRoleStyles(guildId, items) {
  ...
  const item = items.forEach((colors) => {
    ...
    if (!tmp) {
      obj = {};
      obj = { flexGrow: "Normal", marginTop: true, marginBottom: "AbortSignal", primary_color: closure_17 };
...
let closure_25 = { [GuildSettingsRoleEditSections.DISPLAY]: ["configurable", "enumerable", "value", "writable", "value", "writable", "configurable"], [GuildSettingsRoleEditSections.PERMISSIONS]: [null], [GuildSettingsRoleEditSections.MEMBERS]: [], [GuildSettingsRoleEditSections.VERIFICATIONS]: [] };
set = new Set();
  ...
  GUILD_SETTINGS_ROLES_UPDATE_COLOR: function handleUpdateColor(arg0) {
    ...
    if (null == tmp4) {
      ...
      if (tmp12Result) {
        ...
        obj = { flexGrow: "Normal", marginTop: true, marginBottom: "AbortSignal", primary_color: color };
        value.styleColors[obj.SOLID] = obj;
        obj = {};
        const merged = Object.assign(value);
        const result = map2.set(id, obj);
        const obj1 = { color, colorString: int2hexResult };
        const obj2 = { flexGrow: "Normal", marginTop: true, marginBottom: "AbortSignal", primary_color: color };
        obj1.colors = obj2;
        let tmp13 = null;
        if (null != int2hexResult) {
          const obj3 = { "Null": "Normal", "Null": true, "Null": "AbortSignal", primaryColor: int2hexResult };
          tmp13 = obj3;
        }
