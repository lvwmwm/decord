...
// Dependencies: [1983, 1910, 676, 11860, 1363, 1236, 506, 589, 709, 2]

// Module 16779 (handleGuildRoleCreateOrUpdate)
...
const guildSettingsModalRolesStore = new GuildSettingsModalRolesStore(require("dispatcher"), {
  ...
  GUILD_SETTINGS_MODAL_ROLES_EDIT_ORDER: function handleUpdateOrder(arg0) {
    ...
    if (null == _null) {
      ...
      const moveItemFromToResult = importDefault(11860).moveItemFromTo(_null, from, to);
