...
// Dependencies: [1964, 1891, 676, 11718, 4147, 1236, 506, 589, 709, 2]

// Module 16605 (handleGuildRoleCreateOrUpdate)
...
const guildSettingsModalRolesStore = new GuildSettingsModalRolesStore(require("dispatcher"), {
  ...
  GUILD_SETTINGS_MODAL_ROLES_EDIT_ORDER: function handleUpdateOrder(arg0) {
    ...
    if (null == _null) {
      ...
      const moveItemFromToResult = importDefault(11718).moveItemFromTo(_null, from, to);
