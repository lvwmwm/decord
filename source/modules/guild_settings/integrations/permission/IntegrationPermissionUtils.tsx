...
export const commandPermissionChannels = function commandPermissionChannels(arg0) {
  const items = [require(7030) /* ApplicationCommandSectionType */.ApplicationCommandPermissionType.CHANNEL];
...
export const commandPermissionMembersRoles = function commandPermissionMembersRoles(arg0) {
  const items = [require(7030) /* ApplicationCommandSectionType */.ApplicationCommandPermissionType.ROLE, require(7030) /* ApplicationCommandSectionType */.ApplicationCommandPermissionType.USER];
  return commandPermissions(arg0, items);
};
