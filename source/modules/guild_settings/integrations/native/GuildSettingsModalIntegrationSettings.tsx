...
// Function ID: 16572
// Name: GraceOption
// Dependencies: [19, 17, 1964, 8945, 21, 16572, 1236, 4285, 712, 7907, 4827, 5354, 16573, 5688, 5689, 3996, 4281, 4981, 1416, 4130, 7890, 4693, 3866, 7908, 16574, 5635, 8944, 589, 4221, 16536, 2]
// Exports: default

// Module 16571 (GraceOption)
...
function ForceSyncIcon(isSyncing) {
  if (isSyncing.isSyncing) {
    ...
    obj[2] = tmp;
    obj = { source: null };
    obj[0] = importDefault(16573);
    obj[3] = tmp2(require(5354) /* TableRowInner */.TableRow.Icon, obj);
    tmp2Result = tmp2(require(4827) /* PressableBase */.PressableOpacity, obj);
  }
  return tmp2Result;
}
