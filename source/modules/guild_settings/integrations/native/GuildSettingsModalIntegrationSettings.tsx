...
GuildSettingsModalIntegrationSettings.prototype["render"] = function render() {
  ...
  if (null != tmp) {
    ...
    obj[0] = iter.value;
    obj[3] = tmp.name;
    obj[1] = callback(integration(4185).Text, obj);
    const tmp2 = callback(integration(5220).TableRow, obj);
  }
  ...
  if (null == value) {
    ...
    obj4[1] = combined;
    obj4[2] = null;
    obj3[1] = callback(tmp15(5220).TableRow, obj4);
    const items1 = [callback(tmp15(5554).TableRowGroup, obj3), , , , ];
    ...
    let obj14 = tmp16(3771)(integration.synced_at);
    ...
    const items2 = [callback(tmp15(5220).TableRow, obj6), tmp2];
    obj5[2] = items2;
    items1[1] = closure_8(tmp15(5554).TableRowGroup, obj5);
    ...
    items1[3] = callback(tmp15(5554).TableRowGroup, obj14);
    items1[4] = tmp13;
    obj2[2] = items1;
