...
// Function ID: 16532
// Name: GraceOption
// Dependencies: [19, 17, 1935, 8916, 21, 16532, 1236, 4255, 712, 7766, 4797, 5300, 16533, 5634, 5635, 3967, 4251, 4951, 1416, 4101, 7749, 4663, 3837, 7767, 16534, 5581, 8915, 589, 4191, 16496, 2]
// Exports: default

// Module 16531 (GraceOption)
...
function ForceSyncIcon(isSyncing) {
  if (isSyncing.isSyncing) {
    ...
    obj[2] = tmp;
    obj = { source: null };
    obj[0] = importDefault(16533);
    obj[3] = tmp2(require(5300) /* TableRowInner */.TableRow.Icon, obj);
    tmp2Result = tmp2(require(4797) /* PressableBase */.PressableOpacity, obj);
  }
  return tmp2Result;
}
function TwitchEmoticonsRow(integration) {
  ...
  return callback(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj);
}
