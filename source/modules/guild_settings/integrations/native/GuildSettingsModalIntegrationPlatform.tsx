...
// Dependencies: [19, 17, 8916, 676, 21, 4255, 712, 16496, 16536, 4951, 1416, 4101, 5634, 5300, 5635, 1236, 8915, 4594, 4683, 3959, 1480, 589, 4191, 5223, 5902, 5910, 1945, 7749, 4663, 4251, 5581, 2]
// Exports: default

// Module 16535 (getDerivedStateFromProps)
import get_ActivityIndicator from "module_4594";
...
IntegrationItem.prototype["render"] = function render() {
  ...
  const SUPPORTED_SETTINGS_INTEGRATION_PLATFORMS = integration(16496).SUPPORTED_SETTINGS_INTEGRATION_PLATFORMS;
  if (SUPPORTED_SETTINGS_INTEGRATION_PLATFORMS.includes(integration.type)) {
    const type = integration.type;
    if (tmp(16536).IntegrationTypes.YOUTUBE === type) {
      ...
      let combined = name;
    } else if (tmp(16536).IntegrationTypes.TWITCH === type) {
    ...
    if (null == value) {
      ...
      const items = [closure_11(tmp(5300).TableRow, obj), ];
      ...
      items[1] = closure_11(tmp(5635).TableSwitchRow, obj2);
      obj1[1] = items;
      return closure_12(tmp(5634).TableRowGroup, obj1);
    } else {
...
export default function GuildSettingsModalIntegrationPlatform(platformType) {
  ...
  closure_7 = closeGuildSettings(4191)();
  ...
  if (null == guild) {
    ...
    obj6[2] = formatResult;
    items2[1] = closure_11(tmp(4251).Text, obj6);
    obj3[2] = items2;
    obj2[2] = closure_12(tmp(4663).Stack, obj3);
    const items3 = [closure_11(tmp(7749).Form, obj2), closure_11(tmp(5581).NavScrim, {})];
    obj5[0] = items3;
