...
// Function ID: 16008
// Name: items
// Dependencies: [32, 19, 17, 1218, 4364, 1992, 1985, 1910, 4089, 1922, 9237, 676, 21, 7518, 4444, 712, 1500, 9917, 4637, 4288, 1236, 9912, 1629, 589, 6058, 9212, 8813, 16008, 6183, 9266, 5404, 9236, 11, 1351, 6167, 7957, 1297, 9042, 5886, 2]
...
import closure_13 from "handleFormInit" /* 9237 */;
...
let closure_20 = importAllResult.memo((guild) => {
  ...
  if (null == guild) {
    ...
    if (found.length > 0) {
      ...
      obj1 = guildMember(4637);
      let str = obj1.getNickname(guild.id, undefined, user);
      if (str == null) {
        str = tmp9(4288).getGlobalName(user);
        const tmp9Result = tmp9(4288);
      }
      if (str == null) {
        let username;
        if (user != null) {
    ...
    obj[7] = start;
    obj[8] = end;
    return closure_15(guildMember(9912), obj);
  }
  tmp = callback();
});
