...
// Function ID: 15562
// Name: items
// Dependencies: [32, 19, 17, 1218, 4206, 1942, 1935, 1862, 3913, 1874, 8944, 676, 21, 7230, 4285, 712, 1480, 9619, 4474, 4124, 1236, 9614, 1581, 589, 5794, 8919, 8408, 15562, 5917, 8973, 5200, 8943, 11, 3998, 5901, 7666, 1297, 8749, 5596, 2]
...
let closure_20 = importAllResult.memo((guild) => {
  ...
  if (null == guild) {
    ...
    if (found.length > 0) {
      ...
      if (str == null) {
        str = tmp9(4124).getGlobalName(user);
        const tmp9Result = tmp9(4124);
      }
      if (str == null) {
        let username;
        if (user != null) {
