...
// Dependencies: [5, 32, 19, 17, 1874, 7721, 21, 4189, 712, 589, 4379, 1416, 13047, 4185, 1236, 4598, 10318, 8449, 13048, 13092, 4600, 5222, 2]
// Exports: default

// Module 13046 (GuildSettingsServerTagPreview)
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  obj2 = { source: tmp4(10318), style: tmp.avatar, importantForAccessibility: "no" };
  ...
  if (tmp15Result) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(13048).GuildBadge, obj10);
    }
    obj9[1] = tmp15Result;
    tmp15Result = tmp15(tmp2(8449).BaseGuildTagChiplet, obj9);
  }
  ...
  const items11 = [closure_10(tmp18, { source: onAdopted(13092), style: tmp.avatar, importantForAccessibility: "no" }), ];
