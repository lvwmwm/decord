...
// Dependencies: [5, 32, 19, 17, 1903, 8052, 21, 4303, 712, 589, 4493, 1416, 13261, 4299, 1236, 4712, 9835, 9252, 13262, 13306, 4714, 5376, 2]
// Exports: default

// Module 13260 (GuildSettingsServerTagPreview)
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  obj2 = { source: tmp4(9835), style: tmp.avatar, importantForAccessibility: "no" };
  ...
  if (tmp15Result) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(13262).GuildBadge, obj10);
    }
    obj9[1] = tmp15Result;
  ...
  const items11 = [closure_10(tmp18, { source: onAdopted(13306), style: tmp.avatar, importantForAccessibility: "no" }), ];
