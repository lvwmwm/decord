...
// Dependencies: [5, 32, 19, 17, 1922, 8054, 21, 4303, 712, 589, 4493, 1435, 13271, 4299, 1236, 4712, 9841, 9258, 13272, 13316, 4714, 5376, 2]
// Exports: default

// Module 13270 (GuildSettingsServerTagPreview)
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  obj[3] = stringResult;
  const items2 = [closure_10(guildId(4299).Text, obj), ];
  ...
  obj2 = { source: tmp4(9841), style: tmp.avatar, importantForAccessibility: "no" };
  const items4 = [closure_10(closure_6, obj2), ];
  obj3 = { style: tmp.messageBody, children: null };
  const items5 = [closure_10(guildId(4299).Text, { variant: "text-md/semibold", color: "text-default", children: "Locke" }), ];
  const obj4 = { variant: "text-md/normal", color: "text-default", children: null };
  const intl2 = tmp2(1236).intl;
  obj4[2] = intl2.string(guildId(1236).t.KZQ4mF);
  items5[1] = closure_10(guildId(4299).Text, obj4);
  obj3[1] = items5;
  ...
  const items8 = [closure_10(guildId(4299).Text, { variant: "text-md/semibold", color: "text-default", children: name }), ];
  ...
  if (tmp15Result) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(13272).GuildBadge, obj10);
    }
    obj9[1] = tmp15Result;
    tmp15Result = tmp15(tmp2(9258).BaseGuildTagChiplet, obj9);
  }
  ...
  items9[1] = closure_10(guildId(4299).Text, obj11);
  obj7[1] = items9;
  ...
  const items11 = [closure_10(tmp18, { source: onAdopted(13316), style: tmp.avatar, importantForAccessibility: "no" }), ];
  const obj14 = { style: tmp.messageBody, children: null };
  const items12 = [closure_10(guildId(4299).Text, { variant: "text-md/semibold", color: "text-default", children: "Phibi" }), ];
  const obj15 = { variant: "text-md/normal", color: "text-default", children: null };
  const intl4 = tmp2(1236).intl;
  obj15[2] = intl4.string(guildId(1236).t.vtCg11);
  items12[1] = closure_10(guildId(4299).Text, obj15);
  obj14[1] = items12;
  ...
  obj16[3] = isDirty;
  obj16[4] = callback;
  items6[3] = closure_10(guildId(4714).Button, obj16);
  obj[1] = items6;
  items2[1] = closure_11(guildId(4712).Stack, obj);
  obj17[0] = items2;
  ...
  if ("plain" !== variant) {
    ...
    obj18[2] = tmp.card;
    obj18[3] = tmp13Result;
    tmp15Result1 = tmp15(tmp2(5376).Card, obj18);
  }
  return tmp15Result1;
};
