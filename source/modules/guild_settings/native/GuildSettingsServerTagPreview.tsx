...
// Dependencies: [5, 32, 19, 17, 1903, 8052, 21, 4303, 712, 589, 4493, 1416, 13263, 4299, 1236, 4712, 9836, 9252, 13264, 13308, 4714, 5376, 2]
// Exports: default

// Module 13262 (GuildSettingsServerTagPreview)
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  obj2 = { source: tmp4(9836), style: tmp.avatar, importantForAccessibility: "no" };
  ...
  if (tmp15Result) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(13264).GuildBadge, obj10);
    }
    obj9[1] = tmp15Result;
    tmp15Result = tmp15(tmp2(9252).BaseGuildTagChiplet, obj9);
  }
  ...
  const items11 = [closure_10(tmp18, { source: onAdopted(13308), style: tmp.avatar, importantForAccessibility: "no" }), ];
