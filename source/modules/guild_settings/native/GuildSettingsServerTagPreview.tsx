...
// Dependencies: [5, 32, 19, 17, 1874, 7834, 21, 4255, 712, 589, 4444, 1416, 13140, 4251, 1236, 4663, 9722, 9141, 13141, 13185, 4665, 5302, 2]
// Exports: default

// Module 13139 (GuildSettingsServerTagPreview)
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  obj2 = { source: tmp4(9722), style: tmp.avatar, importantForAccessibility: "no" };
  ...
  if (tmp15Result) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(13141).GuildBadge, obj10);
    }
    obj9[1] = tmp15Result;
    tmp15Result = tmp15(tmp2(9141).BaseGuildTagChiplet, obj9);
  }
  ...
  const items11 = [closure_10(tmp18, { source: onAdopted(13185), style: tmp.avatar, importantForAccessibility: "no" }), ];
  ...
  obj16[3] = isDirty;
  obj16[4] = callback;
  items6[3] = closure_10(guildId(4665).Button, obj16);
  obj[1] = items6;
  items2[1] = closure_11(guildId(4663).Stack, obj);
  obj17[0] = items2;
  ...
  if ("plain" !== variant) {
    ...
    obj18[2] = tmp.card;
    obj18[3] = tmp13Result;
    tmp15Result1 = tmp15(tmp2(5302).Card, obj18);
  }
  return tmp15Result1;
};
