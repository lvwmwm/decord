...
// Dependencies: [5, 32, 19, 17, 1922, 7821, 21, 4448, 712, 589, 4641, 1431, 13620, 4444, 1236, 4894, 10205, 8970, 13621, 13665, 4896, 5569, 2]
// Exports: default

// Module 13619 (GuildSettingsServerTagPreview)
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  const items8 = [closure_10(guildId(4444).Text, { variant: "text-md/semibold", color: "text-default", children: name }), ];
  ...
  if (tmp15Result) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(13621).GuildBadge, obj10);
    }
    obj9[1] = tmp15Result;
    tmp15Result = tmp15(tmp2(8970).BaseGuildTagChiplet, obj9);
  }
  ...
  items9[1] = closure_10(guildId(4444).Text, obj11);
  obj7[1] = items9;
  ...
  const items11 = [closure_10(tmp18, { source: onAdopted(13665), style: tmp.avatar, importantForAccessibility: "no" }), ];
  const obj14 = { style: tmp.messageBody, children: null };
  const items12 = [closure_10(guildId(4444).Text, { variant: "text-md/semibold", color: "text-default", children: "Phibi" }), ];
  const obj15 = { variant: "text-md/normal", color: "text-default", children: null };
  const intl4 = tmp2(1236).intl;
  obj15[2] = intl4.string(guildId(1236).t.vtCg11);
  items12[1] = closure_10(guildId(4444).Text, obj15);
  obj14[1] = items12;
  ...
  obj16[3] = isDirty;
  obj16[4] = callback;
  items6[3] = closure_10(guildId(4896).Button, obj16);
  obj[1] = items6;
  items2[1] = closure_11(guildId(4894).Stack, obj);
  obj17[0] = items2;
  ...
  if ("plain" !== variant) {
    ...
    obj18[2] = tmp.card;
    obj18[3] = tmp13Result;
    tmp15Result1 = tmp15(tmp2(5569).Card, obj18);
  }
  return tmp15Result1;
};
