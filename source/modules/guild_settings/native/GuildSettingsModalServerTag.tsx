...
// Dependencies: [5, 32, 19, 17, 8949, 1910, 9668, 676, 7800, 21, 4446, 712, 1500, 9670, 589, 8951, 8021, 8952, 9667, 4162, 1236, 11977, 4336, 5460, 6202, 1501, 4823, 1297, 6012, 8967, 4442, 5957, 5958, 5564, 4891, 13587, 8309, 13585, 17101, 2]
// Exports: default

// Module 17100 (GuildSettingsModalServerTag)
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return callback(navigation(8967), obj);
      } else if (null == stateFromStores1) {
        return callback(tmp2(6012).SceneLoadingIndicator, {});
      } else {
        let tmp29;
        if (tmp14) {
          if (null != stateFromStores1.tag) {
            if ("" !== stateFromStores1.tag) {
              ...
              tmp29 = callback(tmp2(4442).Text, obj);
            }
          }
        }
        ...
        const items11 = [callback(tmp2(5958).TableSwitchRow, obj2), ];
        ...
        if (null != tmp29) {
          ...
          if (tmp32Result) {
            ...
            tmp32Result = tmp32(tmp2(13587).GuildBadge, obj5);
          }
          const items12 = [tmp32Result, tmp29];
          obj4[3] = items12;
          tmp31Result = tmp31(tmp2(4891).Stack, obj4);
        }
        obj3[4] = tmp31Result;
        items11[1] = callback(tmp2(5564).TableRow, obj3);
        obj1[2] = items11;
        tmp31Result = tmp31(tmp2(5957).TableRowGroup, obj1);
        ...
        if (guildSupportsTagsResult) {
          ...
          const items14 = [tmp32(tmp2(4442).Text, obj8), tmp31Result, , ];
          ...
          items14[2] = tmp32(tmp2(4442).Text, obj9);
          ...
          obj10[5] = result1;
          items14[3] = tmp32(tmp39(13585), obj10);
          obj7[1] = items14;
          let tmp40 = obj7;
        } else {
          ...
          obj11[0] = guildId;
          obj11[1] = callback2;
          const items15 = [tmp32(tmp39(17101), obj11), tmp31Result];
          obj7[1] = items15;
          tmp40 = obj7;
        }
        obj6[2] = closure_14(tmp2(4891).Stack, tmp40);
        return callback(tmp2(8309).Form, obj6);
      }
    } else {
      return callback(tmp2(6012).SceneLoadingIndicator, {});
    }
