...
// Dependencies: [5, 32, 19, 17, 9148, 1910, 9169, 676, 8203, 21, 4380, 712, 1500, 9171, 589, 9149, 8422, 9150, 9168, 4097, 1236, 12039, 4270, 5376, 6117, 1501, 4745, 1297, 5928, 12416, 4376, 5873, 5874, 5480, 4813, 13468, 8118, 13466, 16932, 2]
// Exports: default

// Module 16931 (GuildSettingsModalServerTag)
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return callback(navigation(12416), obj);
      } else if (null == stateFromStores1) {
        return callback(tmp2(5928).SceneLoadingIndicator, {});
      } else {
        let tmp29;
        if (tmp14) {
          if (null != stateFromStores1.tag) {
            if ("" !== stateFromStores1.tag) {
              ...
              tmp29 = callback(tmp2(4376).Text, obj);
            }
          }
        }
        ...
        const items11 = [callback(tmp2(5874).TableSwitchRow, obj2), ];
        ...
        if (null != tmp29) {
          ...
          if (tmp32Result) {
            ...
            tmp32Result = tmp32(tmp2(13468).GuildBadge, obj5);
          }
          const items12 = [tmp32Result, tmp29];
          obj4[3] = items12;
          tmp31Result = tmp31(tmp2(4813).Stack, obj4);
        }
        obj3[4] = tmp31Result;
        items11[1] = callback(tmp2(5480).TableRow, obj3);
        obj1[2] = items11;
        tmp31Result = tmp31(tmp2(5873).TableRowGroup, obj1);
        ...
        if (guildSupportsTagsResult) {
          ...
          const items14 = [tmp32(tmp2(4376).Text, obj8), tmp31Result, , ];
          ...
          items14[2] = tmp32(tmp2(4376).Text, obj9);
          ...
          obj10[5] = result1;
          items14[3] = tmp32(tmp39(13466), obj10);
          obj7[1] = items14;
          let tmp40 = obj7;
        } else {
          ...
          obj11[0] = guildId;
          obj11[1] = callback2;
          const items15 = [tmp32(tmp39(16932), obj11), tmp31Result];
          obj7[1] = items15;
          tmp40 = obj7;
        }
        obj6[2] = closure_14(tmp2(4813).Stack, tmp40);
        return callback(tmp2(8118).Form, obj6);
      }
    } else {
      return callback(tmp2(5928).SceneLoadingIndicator, {});
    }
