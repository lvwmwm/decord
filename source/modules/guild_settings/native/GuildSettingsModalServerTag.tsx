...
// Dependencies: [5, 32, 19, 17, 8891, 1910, 8912, 676, 8207, 21, 4668, 712, 1500, 8914, 589, 8892, 8414, 8893, 8911, 4096, 1236, 11697, 4269, 6345, 5437, 1501, 4662, 1297, 6580, 9569, 4739, 6317, 7216, 6322, 4738, 13433, 8122, 13431, 16900, 2]
// Exports: default

// Module 16899 (GuildSettingsModalServerTag)
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return callback(navigation(9569), obj);
      } else if (null == stateFromStores1) {
        return callback(tmp2(6580).SceneLoadingIndicator, {});
      } else {
        let tmp29;
        if (tmp14) {
          if (null != stateFromStores1.tag) {
            if ("" !== stateFromStores1.tag) {
              ...
              tmp29 = callback(tmp2(4739).Text, obj);
            }
          }
        }
        ...
        const items11 = [callback(tmp2(7216).TableSwitchRow, obj2), ];
        ...
        if (null != tmp29) {
          ...
          if (tmp32Result) {
            ...
            tmp32Result = tmp32(tmp2(13433).GuildBadge, obj5);
          }
          const items12 = [tmp32Result, tmp29];
          obj4[3] = items12;
          tmp31Result = tmp31(tmp2(4738).Stack, obj4);
        }
        obj3[4] = tmp31Result;
        items11[1] = callback(tmp2(6322).TableRow, obj3);
        obj1[2] = items11;
        tmp31Result = tmp31(tmp2(6317).TableRowGroup, obj1);
        ...
        if (guildSupportsTagsResult) {
          ...
          const items14 = [tmp32(tmp2(4739).Text, obj8), tmp31Result, , ];
          ...
          items14[2] = tmp32(tmp2(4739).Text, obj9);
          ...
          obj10[5] = result1;
          items14[3] = tmp32(tmp39(13431), obj10);
          obj7[1] = items14;
          let tmp40 = obj7;
        } else {
          ...
          obj11[0] = guildId;
          obj11[1] = callback2;
          const items15 = [tmp32(tmp39(16900), obj11), tmp31Result];
          obj7[1] = items15;
          tmp40 = obj7;
        }
        obj6[2] = closure_14(tmp2(4738).Stack, tmp40);
        return callback(tmp2(8122).Form, obj6);
      }
    } else {
      return callback(tmp2(6580).SceneLoadingIndicator, {});
    }
