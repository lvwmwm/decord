...
// Module 16135 (GuildSettingsModalServerTag)
  ...
  if (result) {
    if (tmp25) {
      if (null == stateFromStores) {
        ...
        let tmp43Result;
        if (null != tmp33) {
          obj4 = { header: null, icon: 8, spacing: importDefault(dependencyMap[11]).space.PX_4 };
        ...
        if (guildSupportsTagsResult) {
          const obj8 = { INTEGRATION_CREATE: true, ConstraintReasonCode: true, style: tmp.description };
