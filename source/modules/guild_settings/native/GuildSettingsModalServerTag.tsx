...
// Dependencies: [5, 32, 19, 17, 8278, 1862, 8302, 676, 7721, 21, 4189, 712, 1480, 8304, 589, 8279, 7939, 8280, 8301, 3889, 1236, 11567, 4080, 5143, 6749, 1553, 4529, 1297, 5636, 11949, 4185, 5554, 5555, 5220, 4598, 13048, 7631, 13046, 16414, 2]
// Exports: default

// Module 16413 (GuildSettingsModalServerTag)
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return callback(tmp26(11949), obj);
        ...
        if (null != tmp31) {
          ...
          if (tmp34Result) {
            ...
            tmp34Result = tmp34(tmp2(13048).GuildBadge, obj5);
          }
        ...
        if (guildSupportsTagsResult) {
          ...
          obj10[5] = result1;
          items14[3] = tmp34(tmp26(13046), obj10);
          obj7[1] = items14;
          let tmp40 = obj7;
        } else {
          ...
          obj11[0] = guildId;
          obj11[1] = callback2;
          const items15 = [tmp34(tmp26(16414), obj11), tmp33Result];
          obj7[1] = items15;
          tmp40 = obj7;
        }
        obj6[2] = closure_14(tmp2(4598).Stack, tmp40);
        return callback(tmp2(7631).Form, obj6);
      }
    } else {
      return callback(tmp2(5636).SceneLoadingIndicator, {});
    }
