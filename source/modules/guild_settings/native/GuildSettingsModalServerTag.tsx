...
// Dependencies: [5, 32, 19, 17, 9216, 1910, 9237, 676, 8270, 21, 4444, 712, 1500, 9239, 589, 9217, 8489, 9218, 9236, 4161, 1236, 12112, 4334, 5442, 6183, 1501, 4809, 1297, 5994, 12487, 4440, 5939, 5940, 5546, 4877, 13541, 8185, 13539, 17017, 2]
// Exports: default

// Module 17016 (GuildSettingsModalServerTag)
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return callback(navigation(12487), obj);
      } else if (null == stateFromStores1) {
        return callback(tmp2(5994).SceneLoadingIndicator, {});
      } else {
        let tmp29;
        if (tmp14) {
          if (null != stateFromStores1.tag) {
            if ("" !== stateFromStores1.tag) {
              ...
              tmp29 = callback(tmp2(4440).Text, obj);
            }
          }
        }
        ...
        const items11 = [callback(tmp2(5940).TableSwitchRow, obj2), ];
        ...
        if (null != tmp29) {
          ...
          if (tmp32Result) {
            ...
            tmp32Result = tmp32(tmp2(13541).GuildBadge, obj5);
          }
          const items12 = [tmp32Result, tmp29];
          obj4[3] = items12;
          tmp31Result = tmp31(tmp2(4877).Stack, obj4);
        }
        obj3[4] = tmp31Result;
        items11[1] = callback(tmp2(5546).TableRow, obj3);
        obj1[2] = items11;
        tmp31Result = tmp31(tmp2(5939).TableRowGroup, obj1);
        ...
        if (guildSupportsTagsResult) {
          ...
          const items14 = [tmp32(tmp2(4440).Text, obj8), tmp31Result, , ];
          ...
          items14[2] = tmp32(tmp2(4440).Text, obj9);
          ...
          obj10[5] = result1;
          items14[3] = tmp32(tmp39(13539), obj10);
          obj7[1] = items14;
          let tmp40 = obj7;
        } else {
          ...
          obj11[0] = guildId;
          obj11[1] = callback2;
          const items15 = [tmp32(tmp39(17017), obj11), tmp31Result];
          obj7[1] = items15;
          tmp40 = obj7;
        }
        obj6[2] = closure_14(tmp2(4877).Stack, tmp40);
        return callback(tmp2(8185).Form, obj6);
      }
    } else {
      return callback(tmp2(5994).SceneLoadingIndicator, {});
    }
