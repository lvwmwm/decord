...
// Dependencies: [5, 32, 19, 17, 8972, 1909, 9690, 676, 7821, 21, 4448, 712, 1499, 9692, 589, 8974, 8043, 8975, 9689, 4163, 1236, 12010, 4338, 5463, 6205, 1500, 4826, 1297, 6015, 8990, 4444, 5960, 5961, 5567, 4894, 13621, 8331, 13619, 17134, 2]
// Exports: default

// Module 17133 (GuildSettingsModalServerTag)
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return callback(navigation(8990), obj);
      } else if (null == stateFromStores1) {
        return callback(tmp2(6015).SceneLoadingIndicator, {});
      } else {
        let tmp29;
        if (tmp14) {
          if (null != stateFromStores1.tag) {
            if ("" !== stateFromStores1.tag) {
              ...
              tmp29 = callback(tmp2(4444).Text, obj);
            }
          }
        }
        ...
        const items11 = [callback(tmp2(5961).TableSwitchRow, obj2), ];
        ...
        if (null != tmp29) {
          ...
          if (tmp32Result) {
            ...
            tmp32Result = tmp32(tmp2(13621).GuildBadge, obj5);
          }
          const items12 = [tmp32Result, tmp29];
          obj4[3] = items12;
          tmp31Result = tmp31(tmp2(4894).Stack, obj4);
        }
        obj3[4] = tmp31Result;
        items11[1] = callback(tmp2(5567).TableRow, obj3);
        obj1[2] = items11;
        tmp31Result = tmp31(tmp2(5960).TableRowGroup, obj1);
        ...
        if (guildSupportsTagsResult) {
          ...
          const items14 = [tmp32(tmp2(4444).Text, obj8), tmp31Result, , ];
          ...
          items14[2] = tmp32(tmp2(4444).Text, obj9);
          ...
          obj10[5] = result1;
          items14[3] = tmp32(tmp39(13619), obj10);
          obj7[1] = items14;
          let tmp40 = obj7;
        } else {
          ...
          obj11[0] = guildId;
          obj11[1] = callback2;
          const items15 = [tmp32(tmp39(17134), obj11), tmp31Result];
          obj7[1] = items15;
          tmp40 = obj7;
        }
        obj6[2] = closure_14(tmp2(4894).Stack, tmp40);
        return callback(tmp2(8331).Form, obj6);
      }
    } else {
      return callback(tmp2(6015).SceneLoadingIndicator, {});
    }
