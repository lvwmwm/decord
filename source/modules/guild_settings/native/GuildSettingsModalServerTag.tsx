...
// Dependencies: [5, 32, 19, 17, 8931, 1910, 9650, 676, 7786, 21, 4445, 712, 1500, 9652, 589, 8933, 8007, 8934, 9649, 4161, 1236, 11958, 4335, 5447, 6189, 1501, 4810, 1297, 5999, 8949, 4441, 5944, 5945, 5551, 4878, 13568, 8295, 13566, 17083, 2]
// Exports: default

// Module 17082 (GuildSettingsModalServerTag)
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return callback(navigation(8949), obj);
      } else if (null == stateFromStores1) {
        return callback(tmp2(5999).SceneLoadingIndicator, {});
      } else {
        let tmp29;
        if (tmp14) {
          if (null != stateFromStores1.tag) {
            if ("" !== stateFromStores1.tag) {
              ...
              tmp29 = callback(tmp2(4441).Text, obj);
            }
          }
        }
        ...
        const items11 = [callback(tmp2(5945).TableSwitchRow, obj2), ];
        ...
        if (null != tmp29) {
          ...
          if (tmp32Result) {
            ...
            tmp32Result = tmp32(tmp2(13568).GuildBadge, obj5);
          }
          const items12 = [tmp32Result, tmp29];
          obj4[3] = items12;
          tmp31Result = tmp31(tmp2(4878).Stack, obj4);
        }
        obj3[4] = tmp31Result;
        items11[1] = callback(tmp2(5551).TableRow, obj3);
        obj1[2] = items11;
        tmp31Result = tmp31(tmp2(5944).TableRowGroup, obj1);
        ...
        if (guildSupportsTagsResult) {
          ...
          const items14 = [tmp32(tmp2(4441).Text, obj8), tmp31Result, , ];
          ...
          items14[2] = tmp32(tmp2(4441).Text, obj9);
          ...
          obj10[5] = result1;
          items14[3] = tmp32(tmp39(13566), obj10);
          obj7[1] = items14;
          let tmp40 = obj7;
        } else {
          ...
          obj11[0] = guildId;
          obj11[1] = callback2;
          const items15 = [tmp32(tmp39(17083), obj11), tmp31Result];
          obj7[1] = items15;
          tmp40 = obj7;
        }
        obj6[2] = closure_14(tmp2(4878).Stack, tmp40);
        return callback(tmp2(8295).Form, obj6);
      }
    } else {
      return callback(tmp2(5999).SceneLoadingIndicator, {});
    }
