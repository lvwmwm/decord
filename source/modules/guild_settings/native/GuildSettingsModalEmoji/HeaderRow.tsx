...
// Function ID: 16545
// Name: HeaderRow
// Dependencies: [5, 32, 19, 17, 16538, 676, 1906, 21, 4285, 712, 8909, 8663, 698, 1236, 514, 4841, 4695, 4281, 589, 2]
// Exports: ConnectedHeaderRow

// Module 16544 (HeaderRow)
...
function HeaderRow(guild) {
  ...
  if (canCreateExpressions) {
    ...
    canCreateExpressions = tmp13(tmp7(4695).Button, obj5);
  }
  ...
  if (tmp13Result) {
    ...
    obj6[3] = tmp5;
    tmp13Result = tmp13(tmp7(4281).Text, obj6);
  }
  let obj7 = { children: null };
  items1[1] = tmp13Result;
  let obj8 = { style: tmp.uploadInstructionsContainer, children: null };
  const items2 = [closure_14(guild(4281).Text, { variant: "text-sm/medium", color: "text-muted", children: description }), , ];
  ...
  items2[1] = closure_14(guild(4281).Text, obj9);
