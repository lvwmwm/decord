...
// Function ID: 17489
// Name: HeaderRow
// Dependencies: [5, 32, 19, 17, 17482, 673, 1924, 21, 4481, 709, 9600, 10265, 695, 1233, 511, 5099, 4936, 4477, 586, 2]
// Exports: ConnectedHeaderRow

// Module 17488 (HeaderRow)
...
import closure_8 from "initialize" /* 17482 */;
...
function HeaderRow(guild) {
  ...
  if (canCreateExpressions) {
    ...
    canCreateExpressions = tmp13(tmp7(4936).Button, obj5);
  }
  ...
  if (tmp13Result) {
    ...
    obj6[3] = tmp5;
    tmp13Result = tmp13(tmp7(4477).Text, obj6);
  }
  let obj7 = { children: null };
  items1[1] = tmp13Result;
  let obj8 = { style: tmp.uploadInstructionsContainer, children: null };
  const items2 = [closure_14(guild(4477).Text, { variant: "text-sm/medium", color: "text-muted", children: description }), , ];
  ...
  items2[1] = closure_14(guild(4477).Text, obj9);
