...
// Function ID: 16492
// Name: HeaderRow
// Dependencies: [5, 32, 19, 17, 16485, 676, 1877, 21, 4255, 712, 8577, 9573, 698, 1236, 514, 4797, 4666, 4251, 589, 2]
// Exports: ConnectedHeaderRow

// Module 16491 (HeaderRow)
...
function HeaderRow(guild) {
  ...
  if (canCreateExpressions) {
    ...
    canCreateExpressions = tmp13(tmp7(4666).Button, obj5);
  }
