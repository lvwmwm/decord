...
// Dependencies: [19, 1415, 1372, 1961, 4223, 3929, 3938, 1903, 8962, 676, 21, 4302, 712, 1236, 4013, 4001, 5269, 5948, 8961, 10237, 1384, 5701, 4641, 4730, 7730, 4492, 5707, 5373, 8039, 16320, 5708, 7925, 7924, 15205, 1974, 16532, 1416, 10256, 1297, 7916, 5335, 7907, 4710, 5654, 1480, 589, 2]
// Exports: default

// Module 16531 (componentDidMount)
...
prototype["componentDidUpdate"] = function componentDidUpdate(errors) {
  ...
  if (tmp2) {
    require(4001) /* presentAddedFriendToast */.presentError(errors.message);
...
prototype["componentWillUnmount"] = function componentWillUnmount() {
  importDefault(8961).cancelChanges(this.props.guild.id);
};
...
prototype["handleSystemChannelFlagsChange"] = function handleSystemChannelFlagsChange(SUPPRESS_GUILD_REMINDER_NOTIFICATIONS, arg1) {
  ...
  importDefault(8961).updateGuild({ systemChannelFlags: setFlagResult });
};
...
prototype["renderGuildName"] = function renderGuildName() {
  ...
  return callback2(require(7730) /* TextInput */.TextInput, obj);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  let guild;
  ({ guild, canManage } = this.props);
  let obj = require(15205) /* apexExperiment */;
  let tmp3 = null;
...
prototype["renderSplash"] = function renderSplash() {
  ...
  if (features.has(constants2.INVITE_SPLASH)) {
    ...
    obj[5] = closure_19(importDefault(16532), obj);
    tmp = tmp2(require(5707) /* TableRowGroupTitle */.TableRowGroup, obj);
...
prototype["renderSummaries"] = function renderSummaries() {
  const props = this.props;
  const guild = props.guild;
  let obj = require(10256) /* canSeeChannelSummaries */;
...
prototype["renderDescription"] = function renderDescription() {
  ...
  obj[2] = require(5335) /* MAX_TRAITS */.MAX_DESCRIPTION_LENGTH;
  ...
  return closure_19(require(7916) /* TextArea */.TextArea, obj);
};
prototype["renderBanner"] = function renderBanner() {
  ...
  if (features.has(constants2.BANNER)) {
    ...
    obj[5] = closure_19(importDefault(16532), obj);
    return closure_19(require(5707) /* TableRowGroupTitle */.TableRowGroup, obj);
  } else {
    return null;
  }
};
prototype["renderDeleteGuild"] = function renderDeleteGuild() {
  ...
  if (null != currentUser) {
    ...
    if (callback(this.props.guild, currentUser)) {
      ...
      obj[1] = callback2(require(5373) /* TableRowInner */.TableRow, obj);
...
prototype["render"] = function render() {
  ...
  const items2 = [callback2(require(7907) /* Form */.Form, obj), callback2(require(5654) /* NavScrim */.NavScrim, {})];
  obj[0] = items2;
