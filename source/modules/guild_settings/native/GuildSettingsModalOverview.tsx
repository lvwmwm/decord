...
// Dependencies: [19, 1415, 1372, 1932, 4176, 3883, 3892, 1874, 8916, 676, 21, 4255, 712, 1236, 3967, 3955, 5223, 5902, 8915, 10190, 1384, 5628, 4594, 4683, 7685, 4445, 5634, 5300, 7881, 16254, 5635, 7767, 7766, 15143, 1945, 16467, 1416, 10209, 1297, 7758, 5265, 7749, 4663, 5581, 1480, 589, 2]
// Exports: default

// Module 16466 (componentDidMount)
...
prototype["componentWillUnmount"] = function componentWillUnmount() {
  importDefault(8915).cancelChanges(this.props.guild.id);
};
...
prototype["renderGuildName"] = function renderGuildName() {
  ...
  return callback2(require(7685) /* TextInput */.TextInput, obj);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  let guild;
  ({ guild, canManage } = this.props);
  let obj = require(15143) /* apexExperiment */;
  let tmp3 = null;
...
prototype["renderSplash"] = function renderSplash() {
  ...
  if (features.has(constants2.INVITE_SPLASH)) {
    ...
    obj[5] = closure_19(importDefault(16467), obj);
    tmp = tmp2(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj);
...
prototype["renderSummaries"] = function renderSummaries() {
  const props = this.props;
  const guild = props.guild;
  let obj = require(10209) /* canSeeChannelSummaries */;
...
prototype["renderDescription"] = function renderDescription() {
  ...
  obj[2] = require(5265) /* MAX_TRAITS */.MAX_DESCRIPTION_LENGTH;
  ...
  return closure_19(require(7758) /* TextArea */.TextArea, obj);
};
prototype["renderBanner"] = function renderBanner() {
  ...
  if (features.has(constants2.BANNER)) {
    ...
    obj[5] = closure_19(importDefault(16467), obj);
    return closure_19(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj);
  } else {
    return null;
  }
};
prototype["renderDeleteGuild"] = function renderDeleteGuild() {
  ...
  if (null != currentUser) {
    ...
    if (callback(this.props.guild, currentUser)) {
      ...
      obj[1] = callback2(require(5300) /* TableRowInner */.TableRow, obj);
...
prototype["render"] = function render() {
  ...
  const items2 = [callback2(require(7749) /* Form */.Form, obj), callback2(require(5581) /* NavScrim */.NavScrim, {})];
  obj[0] = items2;
