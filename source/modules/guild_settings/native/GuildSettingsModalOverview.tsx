...
// Dependencies: [19, 1434, 1391, 1980, 4265, 3989, 3998, 1922, 9067, 676, 21, 4344, 712, 1236, 4072, 4061, 5309, 6049, 9066, 10350, 1403, 5800, 4683, 4772, 7831, 4534, 5806, 5413, 8140, 16479, 5807, 8026, 8025, 15354, 1993, 16688, 1435, 10369, 1297, 8017, 5375, 8008, 4752, 5753, 1499, 589, 2]
// Exports: default

// Module 16687 (componentDidMount)
...
prototype["componentWillUnmount"] = function componentWillUnmount() {
  importDefault(9066).cancelChanges(this.props.guild.id);
};
...
prototype["renderGuildName"] = function renderGuildName() {
  ...
  return callback2(require(7831) /* TextInput */.TextInput, obj);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  let guild;
  ({ guild, canManage } = this.props);
  let obj = require(15354) /* apexExperiment */;
  let tmp3 = null;
...
prototype["renderSplash"] = function renderSplash() {
  ...
  if (features.has(constants2.INVITE_SPLASH)) {
    ...
    obj[5] = closure_19(importDefault(16688), obj);
    tmp = tmp2(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj);
...
prototype["renderSummaries"] = function renderSummaries() {
  const props = this.props;
  const guild = props.guild;
  let obj = require(10369) /* canSeeChannelSummaries */;
...
prototype["renderDescription"] = function renderDescription() {
  ...
  obj[2] = require(5375) /* MAX_TRAITS */.MAX_DESCRIPTION_LENGTH;
  ...
  return closure_19(require(8017) /* TextArea */.TextArea, obj);
};
prototype["renderBanner"] = function renderBanner() {
  ...
  if (features.has(constants2.BANNER)) {
    ...
    obj[5] = closure_19(importDefault(16688), obj);
    return closure_19(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj);
  } else {
    return null;
  }
};
...
prototype["render"] = function render() {
  ...
  const items2 = [callback2(require(8008) /* Form */.Form, obj), callback2(require(5753) /* NavScrim */.NavScrim, {})];
  obj[0] = items2;
