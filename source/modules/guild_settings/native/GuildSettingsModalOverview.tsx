...
// Dependencies: [19, 1434, 1391, 1980, 4263, 3989, 3998, 1922, 9071, 676, 21, 4342, 712, 1236, 4072, 4061, 5310, 6051, 9070, 10261, 1403, 5801, 4684, 4773, 7835, 4535, 5807, 5414, 8144, 16490, 5808, 8030, 8029, 15363, 1993, 16699, 1435, 10281, 1297, 8021, 5376, 8012, 4753, 5754, 1499, 589, 2]
// Exports: default

// Module 16698 (componentDidMount)
...
prototype["componentWillUnmount"] = function componentWillUnmount() {
  importDefault(9070).cancelChanges(this.props.guild.id);
};
...
prototype["handleSystemChannelFlagsChange"] = function handleSystemChannelFlagsChange(SUPPRESS_GUILD_REMINDER_NOTIFICATIONS, arg1) {
  ...
  importDefault(9070).updateGuild({ systemChannelFlags: setFlagResult });
};
...
prototype["renderGuildName"] = function renderGuildName() {
  ...
  return callback2(require(7835) /* TextInput */.TextInput, obj);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  let guild;
  ({ guild, canManage } = this.props);
  let obj = require(15363) /* apexExperiment */;
  let tmp3 = null;
...
prototype["renderSplash"] = function renderSplash() {
  ...
  if (features.has(constants2.INVITE_SPLASH)) {
    ...
    obj[5] = closure_19(importDefault(16699), obj);
    tmp = tmp2(require(5807) /* TableRowGroupTitle */.TableRowGroup, obj);
...
prototype["renderSummaries"] = function renderSummaries() {
  const props = this.props;
  const guild = props.guild;
  let obj = require(10281) /* canSeeChannelSummaries */;
...
prototype["renderDescription"] = function renderDescription() {
  ...
  obj[2] = require(5376) /* MAX_TRAITS */.MAX_DESCRIPTION_LENGTH;
  ...
  return closure_19(require(8021) /* TextArea */.TextArea, obj);
};
prototype["renderBanner"] = function renderBanner() {
  ...
  if (features.has(constants2.BANNER)) {
    ...
    obj[5] = closure_19(importDefault(16699), obj);
    return closure_19(require(5807) /* TableRowGroupTitle */.TableRowGroup, obj);
  } else {
    return null;
  }
};
...
prototype["render"] = function render() {
  ...
  const items2 = [callback2(require(8012) /* Form */.Form, obj), callback2(require(5754) /* NavScrim */.NavScrim, {})];
  obj[0] = items2;
