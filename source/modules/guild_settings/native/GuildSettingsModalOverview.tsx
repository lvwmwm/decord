...
// Dependencies: [19, 1415, 1372, 1932, 4110, 3817, 3826, 1874, 8302, 676, 21, 4189, 712, 1236, 3901, 3889, 5143, 6749, 8301, 10397, 1384, 5548, 4529, 4618, 6724, 4380, 5554, 5220, 7770, 16149, 5555, 7652, 7651, 15124, 1945, 16359, 1416, 9503, 1297, 7641, 5185, 7631, 4598, 5501, 1480, 589, 2]
// Exports: default

// Module 16358 (componentDidMount)
...
class GuildSettingsModalOverview extends PureComponent {
  constructor() {
    ...
    applyArgumentsResult.handleAFKTimeoutChange = function handleAFKTimeoutChange() {
      let obj = applyArgumentsResult(5548);
      obj = {
        key: "AFKTimeout",
...
prototype["componentDidUpdate"] = function componentDidUpdate(errors) {
  ...
  if (tmp2) {
    require(3889) /* presentAddedFriendToast */.presentError(errors.message);
...
prototype["componentWillUnmount"] = function componentWillUnmount() {
  importDefault(8301).cancelChanges(this.props.guild.id);
};
...
prototype["handleSystemChannelFlagsChange"] = function handleSystemChannelFlagsChange(SUPPRESS_GUILD_REMINDER_NOTIFICATIONS, arg1) {
  ...
  importDefault(8301).updateGuild({ systemChannelFlags: setFlagResult });
};
...
prototype["renderGuildName"] = function renderGuildName() {
  ...
  return callback2(require(6724) /* TextInput */.TextInput, obj);
};
prototype["renderAFKSettings"] = function renderAFKSettings() {
  ...
  obj[1] = !canManage;
  obj[2] = callback2(tmp4(5220).TableRow.TrailingText, { text: channelName });
  obj[4] = self.handleAfkChannelChange;
  const items = [callback2(tmp4(5220).TableRow, obj), ];
  ...
  obj1[1] = tmp15;
  obj1[2] = callback2(tmp4(5220).TableRow.TrailingText, { text: labelResult });
  obj1[4] = self.handleAFKTimeoutChange;
  items[1] = callback2(tmp4(5220).TableRow, obj1);
  obj[3] = items;
  return closure_20(tmp4(5554).TableRowGroup, obj);
};
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  let result1 = tmp(16149).isPastVcActivityMessagesEnabled(guild.id, "GuildSettingsModalOverview");
  if (!result1) {
  ...
  obj[1] = !canManage;
  obj[2] = callback2(tmp(5220).TableRow.TrailingText, { text: channelName });
  obj[4] = self.handleSystemChannelChange;
  const items = [callback2(tmp(5220).TableRow, obj), , , , , , , ];
  ...
  items[1] = callback2(tmp(5555).TableSwitchRow, obj1);
  ...
  items[2] = callback2(tmp(5555).TableSwitchRow, obj2);
  ...
  items[3] = callback2(tmp(5555).TableSwitchRow, obj3);
  ...
  items[4] = callback2(tmp(5555).TableSwitchRow, obj4);
  if (hasFlagResult) {
    ...
    hasFlagResult = tmp16(tmp(5555).TableSwitchRow, obj5);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = tmp16(tmp(5555).TableSwitchRow, obj6);
  ...
  if (result1) {
    ...
    result1 = tmp16(tmp(5555).TableSwitchRow, obj7);
    const tmpResult10 = tmp(1384);
  }
  items[7] = result1;
  obj[3] = items;
  return tmp15(tmp(5554).TableRowGroup, obj);
};
prototype["renderDefaultNotificationSettings"] = function renderDefaultNotificationSettings() {
  ...
  obj[2] = stringResult;
  obj[3] = !canManage;
  const items = [closure_19(self(7651).TableRadioRow, obj), ];
  obj = { value: constants.ONLY_MENTIONS, label: null, disabled: null };
  const intl5 = tmp2(1236).intl;
  obj[1] = intl5.format(self(1236).t.L2hmYy, {});
  obj[2] = !canManage;
  items[1] = closure_19(self(7651).TableRadioRow, obj);
  obj[5] = items;
  return closure_20(self(7652).TableRadioGroup, obj);
};
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  let canManage;
  let guild;
  ({ guild, canManage } = this.props);
  let obj = require(15124) /* apexExperiment */;
  let tmp3 = null;
  if (obj.getMobileBoostProgressBarEnabled("GuildSettingsModalOverview")) {
    ...
    obj[3] = callback2(tmp(5555).TableSwitchRow, obj);
    tmp3 = callback2(tmp(5554).TableRowGroup, obj);
  }
  return tmp3;
};
prototype["renderSplash"] = function renderSplash() {
  ...
  if (features.has(constants2.INVITE_SPLASH)) {
    ...
    obj[5] = closure_19(importDefault(16359), obj);
    tmp = tmp2(require(5554) /* TableRowGroupTitle */.TableRowGroup, obj);
...
prototype["renderSummaries"] = function renderSummaries() {
  const props = this.props;
  const guild = props.guild;
  let obj = require(9503) /* canSeeChannelSummaries */;
  if (obj.canGuildUseConversationSummaries(guild, false)) {
    ...
    obj[3] = callback2(tmp(5555).TableSwitchRow, obj1);
    return callback2(tmp(5554).TableRowGroup, obj);
  } else {
    return null;
  }
};
prototype["renderDescription"] = function renderDescription() {
  ...
  obj[2] = require(5185) /* MAX_TRAITS */.MAX_DESCRIPTION_LENGTH;
  ...
  return closure_19(require(7641) /* TextArea */.TextArea, obj);
};
prototype["renderBanner"] = function renderBanner() {
  ...
  if (features.has(constants2.BANNER)) {
    ...
    obj[5] = closure_19(importDefault(16359), obj);
    return closure_19(require(5554) /* TableRowGroupTitle */.TableRowGroup, obj);
  } else {
    return null;
  }
};
prototype["renderDeleteGuild"] = function renderDeleteGuild() {
  ...
  if (null != currentUser) {
    ...
    if (callback(this.props.guild, currentUser)) {
      ...
      obj[1] = callback2(require(5220) /* TableRowInner */.TableRow, obj);
...
prototype["render"] = function render() {
  ...
  const items2 = [callback2(require(7631) /* Form */.Form, obj), callback2(require(5501) /* NavScrim */.NavScrim, {})];
  obj[0] = items2;
