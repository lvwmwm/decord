...
// Dependencies: [19, 17, 4294, 1415, 1965, 1971, 1964, 1891, 3929, 1903, 11170, 676, 21, 4302, 712, 3934, 12, 8388, 1297, 4298, 5373, 1236, 5707, 4013, 5948, 5269, 4140, 9071, 3918, 7907, 4710, 7730, 11171, 11172, 4001, 11177, 1480, 589, 38, 11168, 5866, 5654, 11182, 11184, 5656, 5723, 2]
// Exports: default

// Module 11169 (GuildSettingsModalMemberEditScene)
...
prototype["render"] = function render() {
  ...
  if (null == member) {
    ...
    obj[1] = importDefault(4140).getUserTag(user);
    ...
    const obj28 = importDefault(4140);
    tmp16 = closure_20;
  }
};
