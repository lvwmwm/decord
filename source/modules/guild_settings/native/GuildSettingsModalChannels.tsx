...
// Function ID: 16539
// Name: ChannelItem
// Dependencies: [19, 17, 1372, 1862, 3883, 3892, 1874, 16454, 676, 21, 4255, 5189, 712, 3967, 1236, 4101, 688, 7749, 1297, 16539, 589, 4715, 4445, 4797, 1581, 4665, 5628, 8890, 9321, 5902, 3888, 16540, 16541, 5581, 7798, 16542, 16452, 11087, 14408, 5185, 4593, 1480, 38, 4671, 2]
// Exports: default

// Module 16538 (ChannelItem)
...
prototype["handleChannelPress"] = function handleChannelPress(arg0) {
  require(7798) /* init */.open(arg0);
};
prototype["handleSortStop"] = function handleSortStop() {
  importDefault(16452).stopReordering();
};
