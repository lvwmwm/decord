...
// Function ID: 15610
// Name: memoResult1
// Dependencies: [19, 17, 6858, 21, 4302, 712, 4140, 4298, 15610, 1416, 5373, 1297, 1609, 15615, 4121, 15616, 589, 1236, 7685, 8767, 5654, 2]

// Module 15609 (memoResult1)
...
const memoResult = importAllResult.memo((user) => {
  ...
  const children = [closure_7(require(4298) /* Text */.Text, { variant: "text-md/semibold", children: username }), ];
  let tmp5Result = null != globalName;
  if (tmp5Result) {
    obj = { variant: "text-xs/medium", children: null };
    obj[1] = user.username;
    tmp5Result = tmp5(require(4298) /* Text */.Text, obj);
  }
