...
// Dependencies: [19, 17, 4231, 21, 4344, 712, 589, 4235, 11941, 11909, 4765, 4752, 11944, 4340, 1236, 4754, 15413, 2]
// Exports: default

// Module 16743 (GuildSettingsServerTagUpsellCard)
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  const tmp6 = importDefault(11941)(stateFromStores, true);
  ...
  const items4 = [callback(importDefault(4765), obj), callback(importDefault(4765), { style: tmp.backgroundLayer, colors: closure_10, start: closure_8, end: closure_9, pointerEvents: "none" }), callback(importDefault(4765), { style: tmp.backgroundLayer, colors: closure_11, start: closure_8, end: closure_9, pointerEvents: "none" }), ];
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(11944), obj5);
  }
  obj4[3] = tmp10Result;
  ...
  const items6 = [callback(guildId(4340).Text, obj7), ];
  ...
  items6[1] = callback(guildId(4340).Text, obj8);
  obj6[2] = items6;
  items5[1] = closure_7(guildId(4752).Stack, obj6);
  ...
  obj9[3] = callback(guildId(15413).BoostTier2Icon, { color: "white" });
  obj9[5] = guildId.onUnlockPress;
  items5[2] = callback(guildId(4754).Button, obj9);
  obj3[1] = items5;
  items4[3] = closure_7(guildId(4752).Stack, obj3);
  obj[1] = items4;
