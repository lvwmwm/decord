...
// Dependencies: [19, 17, 4142, 21, 4255, 712, 589, 4146, 11732, 11700, 4677, 4664, 11735, 4251, 1236, 4666, 15185, 2]
// Exports: default

// Module 16509 (GuildSettingsServerTagUpsellCard)
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  const tmp6 = importDefault(11732)(stateFromStores, true);
  ...
  const items4 = [callback(importDefault(4677), obj), callback(importDefault(4677), { style: tmp.backgroundLayer, colors: closure_10, start: closure_8, end: closure_9, pointerEvents: "none" }), callback(importDefault(4677), { style: tmp.backgroundLayer, colors: closure_11, start: closure_8, end: closure_9, pointerEvents: "none" }), ];
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(11735), obj5);
  }
  obj4[3] = tmp10Result;
  ...
  obj6[2] = items6;
  items5[1] = closure_7(guildId(4664).Stack, obj6);
  ...
  obj9[3] = callback(guildId(15185).BoostTier2Icon, { color: "white" });
  obj9[5] = guildId.onUnlockPress;
  items5[2] = callback(guildId(4666).Button, obj9);
  obj3[1] = items5;
  items4[3] = closure_7(guildId(4664).Stack, obj3);
  obj[1] = items4;
