...
// Dependencies: [19, 17, 4265, 21, 4668, 712, 589, 4269, 11738, 11706, 4761, 4738, 11741, 4739, 1236, 4750, 15544, 2]
// Exports: default

// Module 16900 (GuildSettingsServerTagUpsellCard)
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(11741), obj5);
  }
  obj4[3] = tmp10Result;
  ...
  const items6 = [callback(guildId(4739).Text, obj7), ];
  ...
  items6[1] = callback(guildId(4739).Text, obj8);
  obj6[2] = items6;
  items5[1] = closure_7(guildId(4738).Stack, obj6);
  ...
  obj9[3] = callback(guildId(15544).BoostTier2Icon, { color: "white" });
  obj9[5] = guildId.onUnlockPress;
  items5[2] = callback(guildId(4750).Button, obj9);
  obj3[1] = items5;
  items4[3] = closure_7(guildId(4738).Stack, obj3);
  obj[1] = items4;
