...
// Dependencies: [19, 17, 4334, 21, 4448, 712, 589, 4338, 12051, 12019, 4908, 4894, 12054, 4444, 1236, 4896, 15771, 2]
// Exports: default

// Module 17134 (GuildSettingsServerTagUpsellCard)
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(12054), obj5);
  }
  obj4[3] = tmp10Result;
  ...
  const items6 = [callback(guildId(4444).Text, obj7), ];
  ...
  items6[1] = callback(guildId(4444).Text, obj8);
  obj6[2] = items6;
  items5[1] = closure_7(guildId(4894).Stack, obj6);
  ...
  obj9[3] = callback(guildId(15771).BoostTier2Icon, { color: "white" });
  obj9[5] = guildId.onUnlockPress;
  items5[2] = callback(guildId(4896).Button, obj9);
  obj3[1] = items5;
  items4[3] = closure_7(guildId(4894).Stack, obj3);
  obj[1] = items4;
