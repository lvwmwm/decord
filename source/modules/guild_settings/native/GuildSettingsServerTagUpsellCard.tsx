...
// Dependencies: [19, 17, 4332, 21, 4446, 712, 589, 4336, 12018, 11986, 4905, 4891, 12021, 4442, 1236, 4893, 15737, 2]
// Exports: default

// Module 17101 (GuildSettingsServerTagUpsellCard)
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(12021), obj5);
  }
  obj4[3] = tmp10Result;
  ...
  const items6 = [callback(guildId(4442).Text, obj7), ];
  ...
  items6[1] = callback(guildId(4442).Text, obj8);
  obj6[2] = items6;
  items5[1] = closure_7(guildId(4891).Stack, obj6);
  ...
  obj9[3] = callback(guildId(15737).BoostTier2Icon, { color: "white" });
  obj9[5] = guildId.onUnlockPress;
  items5[2] = callback(guildId(4893).Button, obj9);
  obj3[1] = items5;
  items4[3] = closure_7(guildId(4891).Stack, obj3);
  obj[1] = items4;
