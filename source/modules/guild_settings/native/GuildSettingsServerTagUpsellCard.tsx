...
// Dependencies: [19, 17, 4229, 21, 4342, 712, 589, 4233, 11944, 11912, 4766, 4753, 11947, 4338, 1236, 4755, 15413, 2]
// Exports: default

// Module 16745 (GuildSettingsServerTagUpsellCard)
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  const tmp6 = importDefault(11944)(stateFromStores, true);
  ...
  const items4 = [callback(importDefault(4766), obj), callback(importDefault(4766), { style: tmp.backgroundLayer, colors: closure_10, start: closure_8, end: closure_9, pointerEvents: "none" }), callback(importDefault(4766), { style: tmp.backgroundLayer, colors: closure_11, start: closure_8, end: closure_9, pointerEvents: "none" }), ];
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(11947), obj5);
  }
  obj4[3] = tmp10Result;
  ...
  const items6 = [callback(guildId(4338).Text, obj7), ];
  ...
  items6[1] = callback(guildId(4338).Text, obj8);
  obj6[2] = items6;
  items5[1] = closure_7(guildId(4753).Stack, obj6);
  ...
  items5[2] = callback(guildId(4755).Button, obj9);
  obj3[1] = items5;
  items4[3] = closure_7(guildId(4753).Stack, obj3);
  obj[1] = items4;
