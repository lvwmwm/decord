...
// Dependencies: [19, 17, 4080, 21, 4193, 712, 589, 4084, 11625, 11593, 4615, 4602, 11628, 4189, 1236, 4604, 15204, 2]
// Exports: default
...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  const tmp6 = importDefault(11625)(stateFromStores, true);
  ...
  const items4 = [callback(importDefault(4615), obj), callback(importDefault(4615), { style: tmp.backgroundLayer, colors: closure_10, start: closure_8, end: closure_9, pointerEvents: "none" }), callback(importDefault(4615), { style: tmp.backgroundLayer, colors: closure_11, start: closure_8, end: closure_9, pointerEvents: "none" }), ];
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp5(11628), obj5);
  }
  obj4[3] = tmp10Result;
  ...
  const items6 = [callback(guildId(4189).Text, obj7), ];
  ...
  items6[1] = callback(guildId(4189).Text, obj8);
  obj6[2] = items6;
  items5[1] = closure_7(guildId(4602).Stack, obj6);
  ...
  obj9[3] = callback(guildId(15204).BoostTier2Icon, { color: "white" });
  obj9[5] = guildId.onUnlockPress;
  items5[2] = callback(guildId(4604).Button, obj9);
  obj3[1] = items5;
  items4[3] = closure_7(guildId(4602).Stack, obj3);
  obj[1] = items4;
