...
// Dependencies: [19, 17, 7721, 21, 712, 4189, 16418, 11567, 4598, 4185, 1236, 16419, 16420, 13048, 5565, 2]
// Exports: default

// Module 16417 (GuildSettingsServerTagBadgeGrid)
...
export default function GuildSettingsServerTagBadgeGrid(guildId) {
  ...
  ({ unlockedBadges, lockedBadges } = importDefault(16418)());
  const items = [guildId];
  ...
  const items1 = [callback(guildId(4185).Text, obj), , ];
  obj = {
  ...
  if (tmp6Result) {
    ...
    items2[1] = tmp8(tmp7(4185).Text, obj3);
    const obj4 = { size: "md", color: null };
    obj4[1] = importDefault(712).colors.ICON_SUBTLE;
    items2[2] = tmp8(tmp7(5565).ChevronSmallRightIcon, obj4);
    obj1[4] = items2;
    tmp6Result = tmp6(closure_4, obj1);
  }
  items1[2] = tmp6Result;
  obj[1] = items1;
  return closure_8(guildId(4598).Stack, obj);
};
