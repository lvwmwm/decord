...
// Dependencies: [19, 17, 7975, 21, 712, 4285, 16566, 11758, 4693, 4281, 1236, 16567, 16568, 13178, 5699, 2]
// Exports: default

// Module 16565 (GuildSettingsServerTagBadgeGrid)
...
export default function GuildSettingsServerTagBadgeGrid(guildId) {
  ...
  ({ unlockedBadges, lockedBadges } = importDefault(16566)());
  const items = [guildId];
