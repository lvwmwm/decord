...
// Dependencies: [19, 17, 7834, 21, 712, 4255, 16526, 11724, 4663, 4251, 1236, 16527, 16528, 13141, 5645, 2]
// Exports: default

// Module 16525 (GuildSettingsServerTagBadgeGrid)
...
export default function GuildSettingsServerTagBadgeGrid(guildId) {
  ...
  ({ unlockedBadges, lockedBadges } = importDefault(16526)());
  const items = [guildId];
