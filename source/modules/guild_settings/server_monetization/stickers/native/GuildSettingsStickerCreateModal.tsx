...
// Dependencies: [19, 21, 10579, 10581, 1236, 17076, 2]
// Exports: default

// Module 17075 (GuildSettingsStickerCreateModal)
...
export default function GuildSettingsStickerCreateModal(arg0) {
  ...
  c3 = undefined;
  ({ onGoBack: c2, ref: c3 } = stickerId(10579)());
  const tmp2 = stickerId(10579)();
  const tmp3 = c3;
  const intl = getSystemLocale.intl;
  if (null != stickerId) {
  } else {
  }
  const tmp4 = stickerId(10581);
  return tmp3(tmp4, {
