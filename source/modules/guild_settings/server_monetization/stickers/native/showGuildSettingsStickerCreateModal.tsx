...
// Dependencies: [4271, 4509, 16665, 1988, 2]
// Exports: default

// Module 16664 (showGuildSettingsStickerCreateModal)
...
export default function showGuildSettingsStickerCreateModal(closure_0) {
  ...
  importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(16665, dependencyMap.paths), closure_0, "guild-settings-sticker-create", { presentation: "modal" });
};
