...
export const showGuildSettingsStickerError = function showGuildSettingsStickerError() {
  ...
  obj = { key: "GUILD_SETTINGS_STICKER_ERROR", IconComponent: require(6673) /* CircleErrorIcon */.CircleErrorIcon };
...
export const showGuildSettingsStickerSuccess = function showGuildSettingsStickerSuccess() {
  let obj = importDefault(3832);
  obj = { key: "GUILD_SETTINGS_STICKER_SUCCESS", IconComponent: require(4087) /* CircleInformationIcon */.CircleInformationIcon };
  const intl = require(1212) /* getSystemLocale */.intl;
