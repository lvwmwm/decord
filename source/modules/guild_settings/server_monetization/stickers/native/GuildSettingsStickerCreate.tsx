...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  const tmp16Result = importDefault(5503)(stickerById);
  c16 = tmp16Result;
  const tmp20 = importDefault(5503)(() => {
    let tags = c16;
    if (null != c16) {
  ...
  if (null == stickerId) {
    ...
    const items2 = [callback(stickerId(4185).Text, obj1), , , ];
    ...
    items2[2] = callback(stickerId(4185).Text, obj4);
    ...
    obj6[2] = str;
    items2[3] = callback(stickerId(4600).Button, obj6);
    obj7[0] = items2;
  ...
  const items4 = [callback(stickerId(4185).Text, obj9), , , , , , ];
  ...
  items4[2] = callback(stickerId(4185).Text, obj14);
  const obj15 = {
  ...
  items5[1] = callback(stickerId(4185).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj15[2] = items5;
  items4[3] = c17(stickerId(4717).PressableHighlight, obj15);
  ...
  items4[6] = callback(stickerId(4600).Button, obj20);
  obj8[1] = items4;
  items3[1] = c17(stickerId(4598).Stack, obj8);
  obj[4] = items3;
  return c17(c7, obj);
});
