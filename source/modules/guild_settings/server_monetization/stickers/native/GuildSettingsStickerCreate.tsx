// Module ID: 16754
// Function ID: 16755
// Dependencies: [5, 32, 19, 17, 5237, 5280, 676, 1925, 4037, 21, 4342, 712, 5430, 9525, 5777, 4002, 4923, 16755, 10013, 4701, 4338, 1236, 4237, 1993, 4777, 4775, 4909, 9913, 16756, 8700, 5421, 1435, 7721, 7856, 8042, 2]
...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  first1 = tmp12[0];
  callback = tmp12[1];
  const insets = importDefault(5430)({ includeKeyboardHeight: true }).insets;
  const items = [{ ref: ref1, offset: { type: "toRef", ref: ref2 } }, { ref: ref2, offset: { type: "toBottom" } }];
  const onFocus = importDefault(9525)({ insets, inputs: items, scrollViewRef: ref }).onFocus;
  ...
  const tmp16Result = importDefault(5777)(stickerById);
  c16 = tmp16Result;
  const tmp20 = importDefault(5777)(() => {
    let tags = c16;
    if (null != c16) {
  ...
  if (null == stickerId) {
    ...
    obj6[2] = str;
    items2[3] = callback(stickerId(4777).Button, obj6);
    obj7[0] = items2;
  ...
  if (null != tmp16Result) {
    ...
    tmp32Result = tmp32(tmp31(16756).StickerPlusIcon, { size: "lg" });
  }
  obj10[5] = tmp32Result;
  items4[1] = callback(stickerId(4909).PressableHighlight, obj10);
  ...
  if (null != first1) {
    ...
    obj16[2] = emojiURL;
    tmp32Result = tmp32(tmp14(5421), obj16);
    const tmp14Result1 = tmp14(5421);
  } else {
    tmp32Result = tmp32(tmp31(7721).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  obj15[2] = items5;
  items4[3] = c17(stickerId(4909).PressableHighlight, obj15);
  ...
  items4[4] = callback(stickerId(7856).TextInput, obj18);
  ...
  obj19[4] = tmp8;
  obj19[5] = onFocus;
  items4[5] = callback(stickerId(8042).TextArea, obj19);
  const obj20 = {
  ...
  items4[6] = callback(stickerId(4777).Button, obj20);
  obj8[1] = items4;
  items3[1] = c17(stickerId(4775).Stack, obj8);
  obj[4] = items3;
  return c17(c7, obj);
});
