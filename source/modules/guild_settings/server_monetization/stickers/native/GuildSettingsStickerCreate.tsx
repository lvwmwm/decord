// Module ID: 17010
// Function ID: 17011
// Dependencies: [5, 32, 19, 17, 5348, 5391, 676, 1925, 4137, 21, 4444, 712, 5541, 9676, 5888, 4102, 5029, 17011, 10175, 4804, 4440, 1236, 4338, 1995, 4879, 4877, 5015, 10075, 17012, 8852, 5532, 1435, 7867, 8002, 8194, 2]
...
import closure_9 from "loadSavedGuildStickers" /* 5391 */;
...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    const items2 = [callback(stickerId(4440).Text, obj1), , , ];
    ...
    obj6[2] = str;
    items2[3] = callback(stickerId(4879).Button, obj6);
    obj7[0] = items2;
  ...
  const items4 = [callback(stickerId(4440).Text, obj9), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    tmp32Result = tmp32(tmp31(17012).StickerPlusIcon, { size: "lg" });
  }
  obj10[5] = tmp32Result;
  items4[1] = callback(stickerId(5015).PressableHighlight, obj10);
  ...
  items4[2] = callback(stickerId(4440).Text, obj14);
  const obj15 = {
  ...
  if (null != first1) {
    ...
    obj16[2] = emojiURL;
    tmp32Result = tmp32(tmp14(5532), obj16);
    const tmp14Result1 = tmp14(5532);
  } else {
    tmp32Result = tmp32(tmp31(7867).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = callback(stickerId(4440).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj15[2] = items5;
  items4[3] = closure_17(stickerId(5015).PressableHighlight, obj15);
  ...
  items4[4] = callback(stickerId(8002).TextInput, obj18);
  ...
  obj19[4] = tmp8;
  obj19[5] = onFocus;
  items4[5] = callback(stickerId(8194).TextArea, obj19);
  const obj20 = {
  ...
  items4[6] = callback(stickerId(4879).Button, obj20);
  obj8[1] = items4;
  items3[1] = closure_17(stickerId(4877).Stack, obj8);
  obj[4] = items3;
