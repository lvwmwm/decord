// Module ID: 17076
// Function ID: 17077
// Dependencies: [5, 32, 19, 17, 5353, 5396, 676, 1925, 4137, 21, 4445, 712, 5546, 9134, 5893, 4102, 5034, 17077, 10299, 4805, 4441, 1236, 4339, 1995, 4880, 4878, 5020, 10181, 17078, 9019, 5537, 1435, 8160, 7638, 7741, 2]
...
import closure_9 from "loadSavedGuildStickers" /* 5396 */;
...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    const items2 = [callback(stickerId(4441).Text, obj1), , , ];
    ...
    items2[2] = callback(stickerId(4441).Text, obj4);
    ...
    obj6[2] = str;
    items2[3] = callback(stickerId(4880).Button, obj6);
    obj7[0] = items2;
  ...
  const items4 = [callback(stickerId(4441).Text, obj9), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    tmp32Result = tmp32(tmp31(17078).StickerPlusIcon, { size: "lg" });
  }
  obj10[5] = tmp32Result;
  items4[1] = callback(stickerId(5020).PressableHighlight, obj10);
  ...
  items4[2] = callback(stickerId(4441).Text, obj14);
  const obj15 = {
  ...
  if (null != first1) {
    ...
    obj16[2] = emojiURL;
    tmp32Result = tmp32(tmp14(5537), obj16);
    const tmp14Result1 = tmp14(5537);
  } else {
    tmp32Result = tmp32(tmp31(8160).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = callback(stickerId(4441).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj15[2] = items5;
  items4[3] = closure_17(stickerId(5020).PressableHighlight, obj15);
  ...
  items4[4] = callback(stickerId(7638).TextInput, obj18);
  ...
  obj19[4] = tmp8;
  obj19[5] = onFocus;
  items4[5] = callback(stickerId(7741).TextArea, obj19);
  const obj20 = {
  ...
  items4[6] = callback(stickerId(4880).Button, obj20);
  obj8[1] = items4;
  items3[1] = closure_17(stickerId(4878).Stack, obj8);
  obj[4] = items3;
