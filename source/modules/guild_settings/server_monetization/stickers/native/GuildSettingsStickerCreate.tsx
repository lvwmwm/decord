// Module ID: 16800
// Function ID: 16801
// Dependencies: [5, 32, 19, 17, 6727, 6769, 676, 1925, 4069, 21, 4661, 712, 5441, 9444, 7127, 4034, 4838, 16801, 10218, 4823, 4734, 1236, 4269, 1993, 4745, 4733, 5433, 10119, 16802, 9298, 6930, 1435, 7939, 8071, 8092, 2]
...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  first1 = tmp12[0];
  callback = tmp12[1];
  const insets = importDefault(5441)({ includeKeyboardHeight: true }).insets;
  const items = [{ ref: ref1, offset: { type: "toRef", ref: ref2 } }, { ref: ref2, offset: { type: "toBottom" } }];
  const onFocus = importDefault(9444)({ insets, inputs: items, scrollViewRef: ref }).onFocus;
  ...
  const tmp16Result = importDefault(7127)(stickerById);
  c16 = tmp16Result;
  const tmp20 = importDefault(7127)(() => {
    let tags = c16;
    if (null != c16) {
  ...
  if (null == stickerId) {
    ...
    const items2 = [callback(stickerId(4734).Text, obj1), , , ];
  ...
  const items4 = [callback(stickerId(4734).Text, obj9), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    tmp32Result = tmp32(tmp31(16802).StickerPlusIcon, { size: "lg" });
  }
  obj10[5] = tmp32Result;
  items4[1] = callback(stickerId(5433).PressableHighlight, obj10);
  ...
  items4[2] = callback(stickerId(4734).Text, obj14);
  const obj15 = {
  ...
  items5[1] = callback(stickerId(4734).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj15[2] = items5;
  items4[3] = c17(stickerId(5433).PressableHighlight, obj15);
  ...
  items4[4] = callback(stickerId(8071).TextInput, obj18);
  ...
  obj19[4] = tmp8;
  obj19[5] = onFocus;
  items4[5] = callback(stickerId(8092).TextArea, obj19);
  const obj20 = {
  ...
  items4[6] = callback(stickerId(4745).Button, obj20);
  obj8[1] = items4;
  items3[1] = c17(stickerId(4733).Stack, obj8);
  obj[4] = items3;
  return c17(c7, obj);
});
