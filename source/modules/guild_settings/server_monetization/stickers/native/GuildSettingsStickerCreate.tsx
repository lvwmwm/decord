// Module ID: 16893
// Function ID: 16894
// Dependencies: [5, 32, 19, 17, 6764, 6806, 676, 1925, 4072, 21, 4668, 712, 5446, 9481, 7165, 4037, 4843, 16894, 10257, 4828, 4739, 1236, 4273, 1994, 4750, 4738, 5438, 10158, 16895, 9335, 6968, 1435, 7978, 8110, 8131, 2]
...
import closure_9 from "loadSavedGuildStickers" /* 6806 */;
...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    const items2 = [callback(stickerId(4739).Text, obj1), , , ];
    ...
    items2[2] = callback(stickerId(4739).Text, obj4);
    ...
    obj6[2] = str;
    items2[3] = callback(stickerId(4750).Button, obj6);
    obj7[0] = items2;
  ...
  const items4 = [callback(stickerId(4739).Text, obj9), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    tmp32Result = tmp32(tmp31(16895).StickerPlusIcon, { size: "lg" });
  }
  obj10[5] = tmp32Result;
  items4[1] = callback(stickerId(5438).PressableHighlight, obj10);
  ...
  items4[2] = callback(stickerId(4739).Text, obj14);
  const obj15 = {
  ...
  if (null != first1) {
    ...
    obj16[2] = emojiURL;
    tmp32Result = tmp32(tmp14(6968), obj16);
    const tmp14Result1 = tmp14(6968);
  } else {
    tmp32Result = tmp32(tmp31(7978).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = callback(stickerId(4739).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj15[2] = items5;
  items4[3] = closure_17(stickerId(5438).PressableHighlight, obj15);
  ...
  items4[4] = callback(stickerId(8110).TextInput, obj18);
  ...
  obj19[4] = tmp8;
  obj19[5] = onFocus;
  items4[5] = callback(stickerId(8131).TextArea, obj19);
  const obj20 = {
  ...
  items4[6] = callback(stickerId(4750).Button, obj20);
  obj8[1] = items4;
  items3[1] = closure_17(stickerId(4738).Stack, obj8);
  obj[4] = items3;
