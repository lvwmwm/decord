// Module ID: 16736
// Function ID: 16737
// Dependencies: [5, 32, 19, 17, 5215, 5258, 676, 1925, 4037, 21, 4344, 712, 5408, 9508, 5755, 4002, 4900, 16737, 10004, 4678, 4340, 1236, 4239, 1993, 4754, 4752, 4886, 9895, 16738, 8682, 5399, 1435, 7696, 7831, 8017, 2]
...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  const onFocus = importDefault(9508)({ insets, inputs: items, scrollViewRef: ref }).onFocus;
  ...
  const tmp16Result = importDefault(5755)(stickerById);
  c16 = tmp16Result;
  const tmp20 = importDefault(5755)(() => {
    let tags = c16;
    if (null != c16) {
  ...
  if (null == stickerId) {
    ...
    const items2 = [callback(stickerId(4340).Text, obj1), , , ];
    ...
    items2[2] = callback(stickerId(4340).Text, obj4);
    ...
    obj6[2] = str;
    items2[3] = callback(stickerId(4754).Button, obj6);
    obj7[0] = items2;
  ...
  const items4 = [callback(stickerId(4340).Text, obj9), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    tmp32Result = tmp32(tmp31(16738).StickerPlusIcon, { size: "lg" });
  }
  obj10[5] = tmp32Result;
  items4[1] = callback(stickerId(4886).PressableHighlight, obj10);
  ...
  items4[2] = callback(stickerId(4340).Text, obj14);
  const obj15 = {
  ...
  if (null != first1) {
    ...
    obj16[2] = emojiURL;
    tmp32Result = tmp32(tmp14(5399), obj16);
    const tmp14Result1 = tmp14(5399);
  } else {
    tmp32Result = tmp32(tmp31(7696).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = callback(stickerId(4340).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj15[2] = items5;
  items4[3] = c17(stickerId(4886).PressableHighlight, obj15);
  ...
  items4[4] = callback(stickerId(7831).TextInput, obj18);
  ...
  obj19[4] = tmp8;
  obj19[5] = onFocus;
  items4[5] = callback(stickerId(8017).TextArea, obj19);
  const obj20 = {
  ...
  items4[6] = callback(stickerId(4754).Button, obj20);
  obj8[1] = items4;
  items3[1] = c17(stickerId(4752).Stack, obj8);
  obj[4] = items3;
  return c17(c7, obj);
});
