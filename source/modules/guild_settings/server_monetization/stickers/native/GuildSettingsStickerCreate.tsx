// Module ID: 17163
// Function ID: 17164
// Dependencies: [5, 32, 19, 17, 5401, 5444, 676, 1925, 4169, 21, 4478, 712, 5594, 9213, 5941, 4134, 5082, 17164, 10380, 4852, 4474, 1236, 4372, 1995, 4928, 4926, 5068, 10261, 17165, 9098, 5585, 1431, 8228, 7705, 7808, 2]
...
import closure_9 from "loadSavedGuildStickers" /* 5444 */;
...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  if (null != tmp16Result) {
    ...
    tmp32Result = tmp32(tmp31(17165).StickerPlusIcon, { size: "lg" });
  }
  obj10[5] = tmp32Result;
  items4[1] = callback(stickerId(5068).PressableHighlight, obj10);
  ...
  if (null != first1) {
    ...
    obj16[2] = emojiURL;
    tmp32Result = tmp32(tmp14(5585), obj16);
    const tmp14Result1 = tmp14(5585);
  } else {
  ...
  items4[4] = callback(stickerId(7705).TextInput, obj18);
  ...
  obj19[4] = tmp8;
  obj19[5] = onFocus;
  items4[5] = callback(stickerId(7808).TextArea, obj19);
  const obj20 = {
