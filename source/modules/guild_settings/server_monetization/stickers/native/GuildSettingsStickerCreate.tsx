// Module ID: 16436
// Function ID: 16437
// Dependencies: [5, 32, 19, 17, 5052, 5096, 676, 1877, 3869, 21, 4193, 712, 5219, 9862, 5507, 3834, 4735, 16437, 9632, 4528, 4189, 1236, 4088, 1945, 4604, 4602, 4721, 9647, 16438, 9347, 5210, 1416, 6579, 6730, 7649, 2]
...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  const tmp16Result = importDefault(5507)(stickerById);
  c16 = tmp16Result;
  const tmp20 = importDefault(5507)(() => {
    let tags = c16;
    if (null != c16) {
  ...
  if (null == stickerId) {
    ...
    const items2 = [callback(stickerId(4189).Text, obj1), , , ];
    ...
    items2[2] = callback(stickerId(4189).Text, obj4);
    ...
    obj6[2] = str;
    items2[3] = callback(stickerId(4604).Button, obj6);
    obj7[0] = items2;
  ...
  const items4 = [callback(stickerId(4189).Text, obj9), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    tmp32Result = tmp32(tmp31(16438).StickerPlusIcon, { size: "lg" });
  }
  obj10[5] = tmp32Result;
  items4[1] = callback(stickerId(4721).PressableHighlight, obj10);
  ...
  items4[2] = callback(stickerId(4189).Text, obj14);
  const obj15 = {
  ...
  if (null != first1) {
    ...
    obj16[2] = emojiURL;
    tmp32Result = tmp32(tmp14(5210), obj16);
    const tmp14Result1 = tmp14(5210);
  } else {
    tmp32Result = tmp32(tmp31(6579).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = callback(stickerId(4189).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj15[2] = items5;
  items4[3] = c17(stickerId(4721).PressableHighlight, obj15);
  ...
  items4[4] = callback(stickerId(6730).TextInput, obj18);
  ...
  obj19[4] = tmp8;
  obj19[5] = onFocus;
  items4[5] = callback(stickerId(7649).TextArea, obj19);
  const obj20 = {
  ...
  items4[6] = callback(stickerId(4604).Button, obj20);
  obj8[1] = items4;
  items3[1] = c17(stickerId(4602).Stack, obj8);
  obj[4] = items3;
  return c17(c7, obj);
});
