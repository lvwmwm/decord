// Module ID: 17399
// Function ID: 17400
// Dependencies: [5, 32, 19, 17, 5409, 5452, 673, 1924, 4169, 21, 4478, 709, 5602, 9227, 5949, 4134, 5090, 17400, 10402, 4852, 4474, 1233, 4372, 1994, 4928, 4926, 5076, 10283, 17401, 9112, 5593, 1430, 8237, 7714, 7817, 2]
...
import closure_9 from "loadSavedGuildStickers" /* 5452 */;
...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    items2[2] = callback(stickerId(4474).Text, obj4);
    ...
    obj6[2] = str;
    items2[3] = callback(stickerId(4928).Button, obj6);
    obj7[0] = items2;
  ...
  if (null != tmp16Result) {
    ...
    tmp32Result = tmp32(tmp31(17401).StickerPlusIcon, { size: "lg" });
  }
  obj10[5] = tmp32Result;
  items4[1] = callback(stickerId(5076).PressableHighlight, obj10);
  ...
  items4[2] = callback(stickerId(4474).Text, obj14);
  const obj15 = {
  ...
  if (null != first1) {
    ...
    if (null != first1.id) {
      ...
      obj17[2] = c12;
      emojiURL = tmp14(1430).getEmojiURL(obj17);
      const tmp14Result2 = tmp14(1430);
    }
    obj16[2] = emojiURL;
    tmp32Result = tmp32(tmp14(5593), obj16);
    const tmp14Result1 = tmp14(5593);
  } else {
    tmp32Result = tmp32(tmp31(8237).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  obj15[2] = items5;
  items4[3] = closure_17(stickerId(5076).PressableHighlight, obj15);
  ...
  items4[4] = callback(stickerId(7714).TextInput, obj18);
  ...
  obj19[4] = tmp8;
  obj19[5] = onFocus;
  items4[5] = callback(stickerId(7817).TextArea, obj19);
  const obj20 = {
  ...
  items4[6] = callback(stickerId(4928).Button, obj20);
  obj8[1] = items4;
  items3[1] = closure_17(stickerId(4926).Stack, obj8);
  obj[4] = items3;
