// Module ID: 16925
// Function ID: 16926
// Dependencies: [5, 32, 19, 17, 5282, 5325, 676, 1925, 4073, 21, 4380, 712, 5475, 9608, 5822, 4038, 4963, 16926, 10108, 4740, 4376, 1236, 4274, 1995, 4815, 4813, 4949, 10008, 16927, 8784, 5466, 1435, 7800, 7935, 8127, 2]
...
import closure_9 from "loadSavedGuildStickers" /* 5325 */;
...
export default importAllResult.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    const items2 = [callback(stickerId(4376).Text, obj1), , , ];
    ...
    items2[2] = callback(stickerId(4376).Text, obj4);
    ...
    obj6[2] = str;
    items2[3] = callback(stickerId(4815).Button, obj6);
    obj7[0] = items2;
  ...
  const items4 = [callback(stickerId(4376).Text, obj9), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    tmp32Result = tmp32(tmp31(16927).StickerPlusIcon, { size: "lg" });
  }
  obj10[5] = tmp32Result;
  items4[1] = callback(stickerId(4949).PressableHighlight, obj10);
  ...
  items4[2] = callback(stickerId(4376).Text, obj14);
  const obj15 = {
  ...
  if (null != first1) {
    ...
    obj16[2] = emojiURL;
    tmp32Result = tmp32(tmp14(5466), obj16);
    const tmp14Result1 = tmp14(5466);
  } else {
    tmp32Result = tmp32(tmp31(7800).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = callback(stickerId(4376).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj15[2] = items5;
  items4[3] = closure_17(stickerId(4949).PressableHighlight, obj15);
  ...
  items4[4] = callback(stickerId(7935).TextInput, obj18);
  ...
  obj19[4] = tmp8;
  obj19[5] = onFocus;
  items4[5] = callback(stickerId(8127).TextArea, obj19);
  const obj20 = {
  ...
  items4[6] = callback(stickerId(4815).Button, obj20);
  obj8[1] = items4;
  items3[1] = closure_17(stickerId(4813).Stack, obj8);
  obj[4] = items3;
