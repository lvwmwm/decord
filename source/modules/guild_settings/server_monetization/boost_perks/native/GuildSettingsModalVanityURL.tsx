...
// Dependencies: [19, 17, 16644, 1891, 8962, 676, 21, 4302, 712, 5269, 5948, 1236, 16645, 7158, 4298, 16524, 7730, 16646, 1480, 589, 5654, 2]
// Exports: default

// Module 16643 (componentDidMount)
...
prototype["componentWillUnmount"] = function componentWillUnmount() {
  importDefault(16645).closeModal();
};
prototype["render"] = function render() {
  ...
  if (null != vanityURLCode) {
    if ("" !== vanityURLCode) {
      ...
      obj = { url: null };
      obj[0] = importDefault(7158)(vanityURLCode);
      obj[2] = intl6.format(require(1236) /* getSystemLocale */.t.FcGpNU, obj);
      const tmp24 = importDefault(7158)(vanityURLCode);
      const tmp = callback(require(4298) /* Text */.Text, obj);
    }
  }
  if (isEditing) {
    let errorMessageFromErrorCode;
    if (null != errorDetails) {
      obj = require(16524) /* getErrorMessageFromErrorCode */;
    ...
    const items1 = [callback(require(7730) /* TextInput */.TextInput, obj3), ];
    ...
    items2[2] = callback(require(4298) /* Text */.Text, obj7);
    if (tmp17Result) {
