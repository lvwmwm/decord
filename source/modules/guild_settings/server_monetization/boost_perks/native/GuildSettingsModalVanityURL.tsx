...
obj = {};
obj = { "Null": 0.129, "Null": 1, paddingTop: importDefault(dependencyMap[13]).space.PX_32 };
obj.wrapper = obj;
  ...
  items[4] = {
    ...
    value() {
      ...
      if (isEditing) {
        ...
        const obj6 = { cachedAt: "y", edpbxy: "isArray" };
        ...
        const obj7 = { cachedAt: "y", edpbxy: "isArray" };
        ...
        if (tmp12) {
          const obj8 = { cachedAt: "y", edpbxy: "isArray" };
