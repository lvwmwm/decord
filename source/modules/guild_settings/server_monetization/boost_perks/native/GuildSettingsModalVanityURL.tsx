...
// Dependencies: [19, 17, 16800, 1910, 9067, 676, 21, 4344, 712, 5309, 6049, 1236, 16801, 7258, 4340, 16680, 7831, 16802, 1499, 589, 5753, 2]
// Exports: default

// Module 16799 (componentDidMount)
...
prototype["componentWillUnmount"] = function componentWillUnmount() {
  importDefault(16801).closeModal();
};
prototype["render"] = function render() {
  ...
  if (null != vanityURLCode) {
    if ("" !== vanityURLCode) {
      ...
      obj = { url: null };
      obj[0] = importDefault(7258)(vanityURLCode);
      obj[2] = intl6.format(require(1236) /* getSystemLocale */.t.FcGpNU, obj);
      const tmp24 = importDefault(7258)(vanityURLCode);
      const tmp = callback(require(4340) /* Text */.Text, obj);
    }
  }
  if (isEditing) {
    let errorMessageFromErrorCode;
    if (null != errorDetails) {
      obj = require(16680) /* getErrorMessageFromErrorCode */;
    ...
    const items1 = [callback(require(7831) /* TextInput */.TextInput, obj3), ];
    ...
    items2[2] = callback(require(4340) /* Text */.Text, obj7);
    if (tmp17Result) {
