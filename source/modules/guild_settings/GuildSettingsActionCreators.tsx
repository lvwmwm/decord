// Module ID: 8304
// Function ID: 8305
// Dependencies: [5, 1934, 3818, 1218, 1942, 1862, 8305, 676, 3, 709, 530, 7688, 8312, 7949, 7946, 4999, 503, 4004, 1236, 1222, 5121, 2]
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              obj3[0] = HTTP.del(obj1).then(() => {
                const AccessibilityAnnouncer = _undefined(4004).AccessibilityAnnouncer;
            ...
            if (arg0 === 1) {
              ...
              if (outer1_4.isFullServerPreview(outer1_0)) {
                if (outer1_1 === outer1_6.getId()) {
                  const result = outer1_0(5121).updateImpersonatedRoles(tmp29, dependencyMap);
                  c3 = 3;
                  const obj6 = outer1_0(5121);
                }
              }
              const HTTP = outer1_0(530).HTTP;
              const obj1 = { url: null, body: null, oldFormErrors: true, rejectWithError: null };
