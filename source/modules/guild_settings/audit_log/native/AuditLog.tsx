      ...
      if (log.action !== tmp21.AUTO_MODERATION_USER_COMMUNICATION_DISABLED) {
        if (log.action !== tmp21.AUTO_MODERATION_QUARANTINE_USER) {
          if (null != log.options.integration_type) {
            const value = tmp18(4871).get(log.options.integration_type);
            if (null != value) {
              let tmp9Result = tmp9(4035);
        ...
        items2[1] = tmp17(tmp10(4717).PressableOpacity, obj4);
        ...
        obj6[5] = items3;
        items2[2] = tmp15(tmp10(4717).PressableOpacity, obj6);
        ...
        obj1[5] = items5;
        return tmp15(tmp10(5222).Card, obj1);
      }
    }
  }
