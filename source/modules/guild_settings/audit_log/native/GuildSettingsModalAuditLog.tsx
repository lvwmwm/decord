...
obj = { "Bool(false)": null, "Bool(false)": "center", "Bool(false)": "center", borderRadius: importDefault(dependencyMap[11]).radii.md, backgroundColor: importDefault(dependencyMap[11]).colors.INPUT_BACKGROUND_DEFAULT };
