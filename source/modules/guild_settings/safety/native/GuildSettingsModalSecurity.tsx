...
// Dependencies: [19, 17, 1415, 1891, 1903, 8945, 676, 21, 4285, 712, 589, 8944, 4281, 1236, 4695, 13953, 5635, 2]
// Exports: default

// Module 16583 (GuildSettingsModalSecurity)
...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items6 = [callback2(closure_5, { source: stateFromStores(13953), style: tmp.image, resizeMode: "contain" }), ];
  ...
  obj[1] = items5;
  const items7 = [closure_13(closure_4, obj), callback2(guildId(5635).NavScrim, {})];
  obj5[0] = items7;
