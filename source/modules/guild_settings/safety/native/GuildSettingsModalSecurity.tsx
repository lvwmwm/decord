...
// Dependencies: [19, 17, 1434, 1910, 1923, 9668, 676, 21, 4446, 712, 589, 9667, 4442, 1236, 4893, 14331, 5904, 2]
// Exports: default

// Module 17117 (GuildSettingsModalSecurity)
...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items4 = [callback2(guildId(4442).Text, obj1), , ];
  ...
  obj3[2] = str;
  obj3[3] = callback;
  obj2[1] = callback2(guildId(4893).Button, obj3);
  ...
  const items6 = [callback2(closure_5, { source: stateFromStores(14331), style: tmp.image, resizeMode: "contain" }), ];
  ...
  obj8[1] = callback2(guildId(4442).Text, obj9);
  items6[1] = callback2(closure_4, obj8);
  obj6[1] = items6;
  items5[1] = closure_13(closure_4, obj6);
  obj[1] = items5;
  const items7 = [closure_13(closure_4, obj), callback2(guildId(5904).NavScrim, {})];
  obj5[0] = items7;
