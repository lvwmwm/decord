...
// Dependencies: [19, 17, 1415, 1862, 1874, 8944, 676, 21, 4285, 712, 589, 8943, 4281, 1236, 4695, 13943, 5596, 2]
// Exports: default

// Module 16563 (GuildSettingsModalSecurity)
...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items4 = [callback2(guildId(4281).Text, obj1), , ];
  ...
  obj3[2] = str;
  obj3[3] = callback;
  obj2[1] = callback2(guildId(4695).Button, obj3);
  ...
  const items6 = [callback2(closure_5, { source: stateFromStores(13943), style: tmp.image, resizeMode: "contain" }), ];
  ...
  obj8[1] = callback2(guildId(4281).Text, obj9);
  items6[1] = callback2(closure_4, obj8);
  obj6[1] = items6;
  items5[1] = closure_13(closure_4, obj6);
  obj[1] = items5;
  const items7 = [closure_13(closure_4, obj), callback2(guildId(5596).NavScrim, {})];
  obj5[0] = items7;
