...
// Dependencies: [19, 17, 1434, 1910, 1922, 8875, 676, 21, 4661, 712, 589, 8874, 4734, 1236, 4745, 14149, 6550, 2]
// Exports: default
...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items4 = [callback2(guildId(4734).Text, obj1), , ];
  ...
  obj3[2] = str;
  obj3[3] = callback;
  obj2[1] = callback2(guildId(4745).Button, obj3);
