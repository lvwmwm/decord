...
// Dependencies: [19, 17, 1434, 1910, 1922, 9067, 676, 21, 4344, 712, 589, 9066, 4340, 1236, 4754, 14104, 5753, 2]
// Exports: default

// Module 16759 (GuildSettingsModalSecurity)
...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items4 = [callback2(guildId(4340).Text, obj1), , ];
  ...
  obj3[2] = str;
  obj3[3] = callback;
  obj2[1] = callback2(guildId(4754).Button, obj3);
  ...
  obj8[1] = callback2(guildId(4340).Text, obj9);
  items6[1] = callback2(closure_4, obj8);
  obj6[1] = items6;
  items5[1] = closure_13(closure_4, obj6);
  obj[1] = items5;
  const items7 = [closure_13(closure_4, obj), callback2(guildId(5753).NavScrim, {})];
  obj5[0] = items7;
