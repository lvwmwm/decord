...
// Dependencies: [19, 17, 1430, 1909, 1922, 9690, 676, 21, 4448, 712, 589, 9689, 4444, 1236, 4896, 14365, 5907, 2]
// Exports: default

// Module 17150 (GuildSettingsModalSecurity)
...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items4 = [callback2(guildId(4444).Text, obj1), , ];
  ...
  obj3[2] = str;
  obj3[3] = callback;
  obj2[1] = callback2(guildId(4896).Button, obj3);
  ...
  const items6 = [callback2(closure_5, { source: stateFromStores(14365), style: tmp.image, resizeMode: "contain" }), ];
  ...
  obj8[1] = callback2(guildId(4444).Text, obj9);
  items6[1] = callback2(closure_4, obj8);
  obj6[1] = items6;
  items5[1] = closure_13(closure_4, obj6);
  obj[1] = items5;
  const items7 = [closure_13(closure_4, obj), callback2(guildId(5907).NavScrim, {})];
  obj5[0] = items7;
