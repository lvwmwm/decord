...
// Dependencies: [5, 57, 31, 27, 1850, 11013, 653, 33, 4165, 689, 3869, 1456, 566, 44, 8280, 11011, 3865, 4354, 5548, 4161, 11015, 1273, 1212, 4004, 5536, 9068, 4578, 2]
// Exports: default

// Module 11014 (TransferOwnership)
...
export default function TransferOwnership(guild) {
  ...
  obj3 = { source: toUser(11015), style: tmp2.arrow };
  ...
  items1[2] = callback2(guild(4161).Text, obj8);
  ...
  if (null == nickname) {
    if (!hasAvatarForGuildResult) {
      ...
      obj10.user = toUser(4004).getUserTag(toUser);
      let formatResult = intl.format(tmp15, obj10);
      const obj17 = toUser(4004);
    }
    ...
    const obj13 = { username: toUser(4004).getUserTag(toUser) };
    obj12.label = intl4.format(guild(1212).t.xm6ACJ, obj13);
    obj12.onPress = function handleConfirmToggle(arg0) {
      callback(arg0);
    };
    obj11.children = callback2(guild(9068).TableCheckboxRow, obj12);
    items3[1] = callback2(guild(5536).TableRowGroup, obj11);
    const obj14 = {
    ...
    items3[2] = callback2(guild(4578).Button, obj14);
    obj.children = items3;
  ...
  const obj15 = {
    ...
    AKAHook: function NicknameAKA() {
      ...
      obj1.children = str;
      items[2] = outer1_13(guild(4161).Text, obj1);
      obj.children = items;
