...
// Dependencies: [5, 32, 19, 17, 1921, 11778, 673, 21, 4481, 709, 4197, 1498, 586, 38, 8993, 11776, 4193, 4680, 5539, 4477, 11780, 1296, 1233, 4325, 5642, 5559, 4936, 2]
// Exports: default

// Module 11779 (TransferOwnership)
...
export default function TransferOwnership(guild) {
  ...
  obj3 = { source: toUser(11780), style: tmp5.arrow };
  ...
  items1[2] = callback2(guild(4477).Text, { variant: "text-xs/medium", color: "text-default", children: guild.name });
  if (null == nickname) {
    if (!hasAvatarForGuildResult) {
      const intl = tmp(1233).intl;
      const obj9 = { GuildHook: null, user: null };
      obj9[0] = GuildWithSmallIcon;
      let tmp3Result = tmp3(4325);
    ...
    obj11[2] = tmp11(tmp(5559).TableCheckboxRow, obj12);
    items3[1] = tmp11(tmp(5642).TableRowGroup, obj11);
    ...
    obj14[2] = !tmp8;
    items3[2] = tmp11(tmp(4936).Button, obj14);
    obj[1] = items3;
  ...
  obj15[1] = toUser(4325).getUserTag(toUser);
  obj15[2] = function NicknameAKA() {
    ...
    const items = [closure_1_15(guild(4477).Text, obj), , ];
    let tmp6 = null;
    if (c7) {
    ...
    obj = { children: null };
    items[2] = closure_1_13(guild(4477).Text, { variant: "text-md/medium", children: str });
    obj[0] = items;
