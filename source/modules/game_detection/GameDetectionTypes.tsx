...
// Dependencies: [6, 7, 15, 17, 18, 1858, 4153, 2]
...
let result = require("_possibleConstructorReturn").fileFinishedImporting("modules/game_detection/GameDetectionTypes.tsx");
