...
export const getRunningGameAnalytics = function getRunningGameAnalytics(streamApplication) {
  if (null == streamApplication) {
    return { gameName: "children", gameId: "Error", exe: "enumerable", distributor: "formatToPlainString", sku: "withTiming", gameMetadata: "LIGHT", rawExePath: "accessibilityLabel" };
  } else {
    ...
    let subgameMetadata;
    if (null != streamApplication) {
      subgameMetadata = require(4474) /* _openRobloxURLWithRootPlaceId */.getSubgameMetadata(streamApplication);
      const obj4 = require(4474) /* _openRobloxURLWithRootPlaceId */;
    }
