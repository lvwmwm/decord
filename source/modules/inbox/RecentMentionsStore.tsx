...
// Dependencies: [3999, 1218, 1391, 4584, 4357, 3998, 4165, 4550, 1922, 676, 595, 4586, 4580, 4600, 12, 4420, 5952, 7167, 589, 709, 2]

// Module 7166 (findOrCreateMessageRecord)
...
function findOrCreateMessageRecord(channel_id) {
  if (channel_id instanceof hasFlag) {
    ...
    if (null == message) {
      message = require(4586) /* createMinimalMessageRecord */.createMessageRecord(channel_id);
  ...
  if (null != basicChannel) {
    ...
    if (GUILD_TEXTUAL.has(basicChannel.type)) {
      ...
      if (updateUserGuildSettingsInternal.isGuildOrCategoryOrChannelMuted(basicChannel.guild_id, basicChannel.id)) {
        ...
        obj2 = require(4580) /* shouldShowAgeGateForVoiceChannel */;
      }
    }
  }
  return false;
  ...
  if (null != channel) {
    if (channel.type !== constants.DM) {
      ...
      if (!blockedOrIgnoredForMessage.isBlockedOrIgnoredForMessage(message)) {
        if (!tmp2(7167)(message, id)) {
          let tmp12 = message;
          if (!(message instanceof hasFlag)) {
            message = store2.getMessage(message.channel_id, message.id);
            if (null == message) {
              message = require(4586) /* createMinimalMessageRecord */.createMessageRecord(message);
              const obj2 = require(4586) /* createMinimalMessageRecord */;
            }
            tmp12 = message;
          }
          ...
          if (tmp2(4600)(obj)) {
            ...
            if (tmp2ResultResult) {
              ...
              tmp2ResultResult = tmp2(4600)(obj);
    ...
    if (null != id) {
      if (null != dependencyMap[id]) {
        ...
        if (null != substr[findIndexResult]) {
          substr[findIndexResult] = id(4586).updateMessageRecord(tmp7, message.message);
          const obj2 = id(4586);
        }
      }
    }
