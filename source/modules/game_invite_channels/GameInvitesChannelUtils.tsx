...
// Dependencies: [109, 19, 1386, 673, 7213, 7214, 586, 7215, 7242, 38, 7247, 7103, 7249, 7251, 5468, 2]
...
// Module 7212 (GAME_INVITES_CHANNEL_NO_MIC_TAG_NAME)
...
export const useIsGameInvitePostVoiceEnabled = function useIsGameInvitePostVoiceEnabled(channel) {
  const appliedTags = _require(7215).useAppliedTags(channel);
  _require = channel;
  const obj = _require(7215);
  const items = [closure_6];
...
export const useSubscribeToGameInvitePostAuthors = function useSubscribeToGameInvitePostAuthors(isGameInvitesChannel) {
  ...
  const subscribeGuildMembers = _require(7249).useSubscribeGuildMembers(tmp3, "GameInvitesChannelPostAuthors");
};
