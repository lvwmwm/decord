...
export const tryUpdateSubscriptionForHereMention = function tryUpdateSubscriptionForHereMention(arr, maxMessageLength, guild_id, id) {
  ...
  if (!tmp3) {
    ...
    if (!tmp5) {
      ...
      if (flag) {
        require(5970) /* subscribeMembers */.subscribeChannel(guild_id, id, require(5944) /* reset */.DEFAULT_RANGES);
        flag = true;
        const obj = require(5970) /* subscribeMembers */;
      }
      tmp7 = flag;
    }
    tmp3 = tmp7;
