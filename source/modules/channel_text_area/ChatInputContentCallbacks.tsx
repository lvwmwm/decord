...
// Dependencies: [32, 19, 5897, 5929, 5903, 8358, 12, 2]
// Exports: tryUpdateSubscriptionForHereMention, useHereMentionCallback

// Module 11389 (tryUpdateSubscriptionForHereMention)
...
export const tryUpdateSubscriptionForHereMention = function tryUpdateSubscriptionForHereMention(arr, maxMessageLength, guild_id, id) {
  ...
  if (!tmp3) {
    ...
    if (!tmp5) {
      ...
      if (flag) {
        require(5929) /* subscribeMembers */.subscribeChannel(guild_id, id, require(5903) /* reset */.DEFAULT_RANGES);
        flag = true;
        const obj = require(5929) /* subscribeMembers */;
      }
      tmp7 = flag;
    }
    tmp3 = tmp7;
