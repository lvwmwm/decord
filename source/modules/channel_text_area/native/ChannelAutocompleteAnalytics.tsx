...
// Dependencies: [676, 698, 4496, 2]
// Exports: iOSTrackAutocompleteOpen, iOSTrackAutocompleteSelect

// Module 11697 (iOSTrackAutocompleteOpen)
...
export const iOSTrackAutocompleteOpen = function iOSTrackAutocompleteOpen(autocomplete_type, guild_id, arg2) {
  ...
  obj = {};
  const merged = Object.assign(require(4496) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(guild_id));
  const obj3 = require(4496) /* collectGuildAnalyticsMetadata */;
  const merged1 = Object.assign(require(4496) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(guild_id.guild_id));
