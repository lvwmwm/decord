...
// Dependencies: [687, 514, 5063, 709, 1208, 2]
...
export const getOrRefreshAdSession = function getOrRefreshAdSession(shouldExtendSession) {
  ...
  if (null != obj) {
    ...
    if (timestamp1 < obj.createdAtTimestamp) {
      ...
      flag2 = diff > require(5063) /* result */.SESSION_IDLE_TIMEOUT_MILLIS || timestamp1 - tmp11.createdAtTimestamp > closure_3;
    }
    if (!flag2) {
      if (flag) {
...
export const isAdSessionExpired = function isAdSessionExpired(createdAtTimestamp) {
  ...
  if (timestamp < createdAtTimestamp.createdAtTimestamp) {
    ...
    return diff > require(5063) /* result */.SESSION_IDLE_TIMEOUT_MILLIS || timestamp - createdAtTimestamp.createdAtTimestamp > closure_3;
  }
};
