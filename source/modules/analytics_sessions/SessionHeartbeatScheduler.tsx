...
// Function ID: 6845
// Name: trackHeartbeat
// Dependencies: [5, 4975, 1218, 5110, 4356, 676, 687, 3, 6845, 6846, 1208, 6847, 6850, 698, 6851, 595, 6852, 668, 709, 589, 514, 2]
// Exports: getActiveSessionUnsafe, initSessionHeartbeatScheduler

// Module 6844 (trackHeartbeat)
...
function validateClientSession(version) {
  ...
  if (null != version) {
    let tmp4 = version;
    if (version.version !== require(6852) /* result */.CLIENT_SESSION_STORAGE_VERSION) {
      const _HermesInternal = HermesInternal;
...
function handleLocationChange() {
  const isActiveUserRouteResult = require(6846) /* isActiveUserRoute */.isActiveUserRoute();
...
function handleFluxInitialized() {
  const state = importDefaultResult1.getState();
  let closure_22 = require(6845) /* isForegrounded */.isForegrounded();
  const obj = require(6845) /* isForegrounded */;
  let closure_23 = require(6846) /* isActiveUserRoute */.isActiveUserRoute();
...
export const initSessionHeartbeatScheduler = function initSessionHeartbeatScheduler() {
  ...
  let result = require(6846) /* isActiveUserRoute */.subscribeToLocationChanges(handleLocationChange);
  scheduleHeartbeatTracking();
  if (null == obj) {
