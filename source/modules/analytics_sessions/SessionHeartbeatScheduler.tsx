...
// Function ID: 6818
// Name: trackHeartbeat
// Dependencies: [5, 4945, 1218, 5080, 4326, 676, 687, 3, 6818, 6819, 1208, 6820, 6823, 698, 6824, 595, 6825, 668, 709, 589, 514, 2]
// Exports: getActiveSessionUnsafe, initSessionHeartbeatScheduler

// Module 6817 (trackHeartbeat)
...
function validateClientSession(version) {
  ...
  if (null != version) {
    let tmp4 = version;
    if (version.version !== require(6825) /* result */.CLIENT_SESSION_STORAGE_VERSION) {
      const _HermesInternal = HermesInternal;
...
function handleLocationChange() {
  const isActiveUserRouteResult = require(6819) /* isActiveUserRoute */.isActiveUserRoute();
...
function handleFluxInitialized() {
  const state = importDefaultResult1.getState();
  let closure_22 = require(6818) /* isForegrounded */.isForegrounded();
  const obj = require(6818) /* isForegrounded */;
  let closure_23 = require(6819) /* isActiveUserRoute */.isActiveUserRoute();
...
export const initSessionHeartbeatScheduler = function initSessionHeartbeatScheduler() {
  ...
  let result = require(6819) /* isActiveUserRoute */.subscribeToLocationChanges(handleLocationChange);
  scheduleHeartbeatTracking();
  if (null == obj) {
