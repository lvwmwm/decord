...
export const shouldSkipAccessibilityLabels = function shouldSkipAccessibilityLabels() {
  ...
  if (enabled) {
    enabled = !require(4529) /* SCREEN_READER_ENABLED_GETTER */.getIsScreenReaderEnabled();
    const obj = require(4529) /* SCREEN_READER_ENABLED_GETTER */;
  }
  return enabled;
};
