...
// Dependencies: [17, 3, 4482, 4700, 500, 4701, 2]

// Module 4699 (_updateAccessibilityFocusLock)
...
prototype["_updateAccessibilityFocusLock"] = function _updateAccessibilityFocusLock(arg0) {
  ...
  if (self._focusLockEnabled) {
    if (obj.isAndroid()) {
      importDefault(4701).disableFocusLock();
      let obj2 = importDefault(4701);
    } else {
...
prototype["_initialize"] = function _initialize() {
  const self = this;
  this._screenReaderEnabledListener = self(4700).addScreenReaderEnabledListener((_screenReaderEnabled) => {
