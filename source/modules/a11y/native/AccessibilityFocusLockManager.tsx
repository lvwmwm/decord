...
// Dependencies: [17, 3, 4480, 4698, 500, 4699, 2]

// Module 4697 (_updateAccessibilityFocusLock)
...
prototype["_updateAccessibilityFocusLock"] = function _updateAccessibilityFocusLock(arg0) {
  ...
  if (self._focusLockEnabled) {
    if (obj.isAndroid()) {
      importDefault(4699).disableFocusLock();
      let obj2 = importDefault(4699);
    } else {
...
prototype["_initialize"] = function _initialize() {
  const self = this;
  this._screenReaderEnabledListener = self(4698).addScreenReaderEnabledListener((_screenReaderEnabled) => {
