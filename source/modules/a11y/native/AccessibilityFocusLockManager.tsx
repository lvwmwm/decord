...
// Dependencies: [17, 3, 4522, 4740, 500, 4741, 2]

// Module 4739 (_updateAccessibilityFocusLock)
...
prototype["_updateAccessibilityFocusLock"] = function _updateAccessibilityFocusLock(arg0) {
  ...
  if (self._focusLockEnabled) {
    if (obj.isAndroid()) {
      importDefault(4741).disableFocusLock();
      let obj2 = importDefault(4741);
    } else {
...
prototype["_initialize"] = function _initialize() {
  const self = this;
  this._screenReaderEnabledListener = self(4740).addScreenReaderEnabledListener((_screenReaderEnabled) => {
