...
// Dependencies: [109, 1302, 1340, 676, 4182, 4183, 3862, 589, 595, 4035, 709, 2]

// Module 4181 (maybeApplyNoTextColorForLightCustomTheme)
...
Object.defineProperty(prototype, "messageGroupSpacing", {
  get: function messageGroupSpacing() {
    if (null != obj.messageGroupSpacing) {
      ...
      const MessageDisplayCompact = require(3862) /* explicitContentFromProto */.MessageDisplayCompact;
...
let items = [
  ...
  (saturation) => {
    ...
    obj.alwaysShowLinkDecorations = saturation.saturation <= require(4035) /* AccessibilityAnnouncer */.LOW_SATURATION_THRESHOLD;
    return obj;
  },
  (arg0) => {
    const obj = {};
    ...
    if (zoom.zoom >= Accessibility.ZOOM_MIN) {
      if (zoom.zoom <= tmp.ZOOM_MAX) {
        if (obj.zoom !== zoom.zoom) {
          ...
          const merged = Object.assign(obj);
          obj.zoom = zoom.zoom;
          importDefault(4183).setZoomFactor(obj.zoom);
        }
      }
    }
    return false;
