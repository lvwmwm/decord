...
// Dependencies: [19, 21, 4302, 712, 5396, 4710, 5967, 4298, 1236, 12157, 4712, 4270, 2]
// Exports: default

// Module 12156 (BlockedDomainActionSheet)
import "noop";
...
export default function BlockedDomainActionSheet(url) {
  ...
  const items = [callback(require(5967) /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  obj[3] = items;
  const items1 = [callback2(require(4710) /* Stack */.Stack, obj), callback(require(12157) /* URLCallout */.URLCallout, { url: url.url }), ];
