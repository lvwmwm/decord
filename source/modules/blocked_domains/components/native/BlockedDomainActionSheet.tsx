...
// Dependencies: [19, 21, 4285, 712, 5377, 4693, 5948, 4281, 1236, 12142, 4695, 4253, 2]
// Exports: default

// Module 12141 (BlockedDomainActionSheet)
import "noop";
...
export default function BlockedDomainActionSheet(url) {
  ...
  const items = [callback(require(5948) /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  obj[3] = items;
  const items1 = [callback2(require(4693) /* Stack */.Stack, obj), callback(require(12142) /* URLCallout */.URLCallout, { url: url.url }), ];
