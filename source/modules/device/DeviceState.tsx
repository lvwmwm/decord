...
// Function ID: 7104
// Name: DeviceState
// Dependencies: [7104, 2, 7105]
// Exports: logDeviceState

// Module 7103 (DeviceState)
...
export const logDeviceState = function logDeviceState(thermalState) {
  if (null !== thermalState) {
    const logger2 = require(7104) /* _getDeviceState */.logger;
    logger2.info("Device State Information:");
    const logger3 = require(7104) /* _getDeviceState */.logger;
    const _HermesInternal = HermesInternal;
    logger3.info("- Thermal State: " + thermalState.thermalState);
    const logger4 = require(7104) /* _getDeviceState */.logger;
    const _HermesInternal2 = HermesInternal;
    logger4.info("- Battery Level: " + 100 * thermalState.batteryLevel + "%");
    const logger5 = require(7104) /* _getDeviceState */.logger;
    let str6 = "Disabled";
    ...
    const logger = require(7104) /* _getDeviceState */.logger;
