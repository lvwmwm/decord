...
// Function ID: 7277
// Name: DeviceState
// Dependencies: [7277, 2, 7278]
// Exports: logDeviceState

// Module 7276 (DeviceState)
...
export const logDeviceState = function logDeviceState(thermalState) {
  if (null !== thermalState) {
    const logger2 = require(7277) /* _getDeviceState */.logger;
    logger2.info("Device State Information:");
    const logger3 = require(7277) /* _getDeviceState */.logger;
    const _HermesInternal = HermesInternal;
    logger3.info("- Thermal State: " + thermalState.thermalState);
    const logger4 = require(7277) /* _getDeviceState */.logger;
    const _HermesInternal2 = HermesInternal;
    logger4.info("- Battery Level: " + 100 * thermalState.batteryLevel + "%");
    const logger5 = require(7277) /* _getDeviceState */.logger;
    let str6 = "Disabled";
    ...
    const logger = require(7277) /* _getDeviceState */.logger;
