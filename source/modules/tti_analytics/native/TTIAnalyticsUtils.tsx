...
// Dependencies: [5, 6983, 4256, 1302, 1218, 1391, 706, 676, 7176, 1398, 21, 4322, 7177, 514, 1625, 4198, 4197, 10, 1208, 698, 7178, 4204, 7180, 9, 687, 7181, 4684, 4773, 2007, 2]
// Exports: currentLoadId, getLastTrackedAppUiViewed2Properties, trackAppLaunchCompleted, trackAppOpened, trackAppUIViewed

// Module 6982 (getDeviceMetadata)
...
function getDeviceMetadata() {
  if (null == obj) {
    ...
    obj[0] = require(4322) /* DCDDeviceManager */.getDeviceModel();
    const obj2 = require(4322) /* DCDDeviceManager */;
    obj[1] = require(4322) /* DCDDeviceManager */.getDeviceBrand();
    const obj3 = require(4322) /* DCDDeviceManager */;
    obj[2] = require(4322) /* DCDDeviceManager */.getDeviceProduct();
    const obj4 = require(4322) /* DCDDeviceManager */;
    obj[3] = require(4322) /* DCDDeviceManager */.getDeviceManufacturer();
    const obj5 = require(4322) /* DCDDeviceManager */;
    obj[4] = require(4322) /* DCDDeviceManager */.getSmallestScreenWidthDp();
    obj[5] = importDefault(7177)();
    const obj6 = require(4322) /* DCDDeviceManager */;
    obj[6] = require(4322) /* DCDDeviceManager */.getSocName();
    const obj7 = require(4322) /* DCDDeviceManager */;
    obj[7] = require(4322) /* DCDDeviceManager */.getRamSize();
    const obj8 = require(4322) /* DCDDeviceManager */;
    obj[8] = require(4322) /* DCDDeviceManager */.getMaxCpuFreq();
    const obj9 = require(4322) /* DCDDeviceManager */;
  }
  return obj;
}
...
export const trackAppUIViewed = function trackAppUIViewed(ModalScreen, arg1, hasCacheResult) {
  ...
  const AppStartInfo = require(7178) /* AppStartInfo */.AppStartInfo;
