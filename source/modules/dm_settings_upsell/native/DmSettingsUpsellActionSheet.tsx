...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    obj8[1] = tmp2(5661).GuildIconSizes.SMALL_32;
    const items4 = [callback(stateFromStores(5661), obj8), ];
    ...
    obj10[1] = function onPress() {
      ...
      RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
        ...
        obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: callback2(9793), content: null };
    ...
    tmp6 = callback(tmp2(5646).ActionSheet, obj);
    const tmp12 = stateFromStores(5661);
  }
  return tmp6;
};
