...
// Dependencies: [19, 17, 1910, 21, 4445, 712, 589, 16831, 16835, 5941, 10931, 4441, 1236, 5956, 4880, 6194, 4134, 4162, 9439, 4412, 13560, 2]
// Exports: default

// Module 16834 (DmSettingsUpsellActionSheet)
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    items2[1] = callback(tmp2(4441).Text, obj2);
    ...
    items2[2] = callback(tmp2(4441).Text, obj3);
    ...
    obj10[1] = function onPress() {
      ...
      RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
        ...
        obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: callback2(9439), content: null };
    ...
    items2[4] = callback(tmp2(4880).Button, obj10);
    ...
    items2[5] = callback(tmp2(4880).Button, obj11);
    ...
    items2[6] = callback(tmp2(4441).Text, obj12);
    obj[1] = items2;
    obj[1] = callback2(closure_4, obj);
    tmp6 = callback(tmp2(5941).ActionSheet, obj);
    const tmp12 = stateFromStores(5956);
  }
  return tmp6;
};
