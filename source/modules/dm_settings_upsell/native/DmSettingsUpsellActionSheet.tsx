...
// Dependencies: [19, 17, 1910, 21, 4446, 712, 589, 16849, 16853, 5954, 10949, 4442, 1236, 5969, 4893, 6207, 4135, 4163, 9457, 4413, 13579, 2]
// Exports: default

// Module 16852 (DmSettingsUpsellActionSheet)
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    items2[1] = callback(tmp2(4442).Text, obj2);
    ...
    items2[2] = callback(tmp2(4442).Text, obj3);
    ...
    obj10[1] = function onPress() {
      ...
      RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
        ...
        obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: callback2(9457), content: null };
    ...
    items2[4] = callback(tmp2(4893).Button, obj10);
    ...
    items2[5] = callback(tmp2(4893).Button, obj11);
    ...
    items2[6] = callback(tmp2(4442).Text, obj12);
    obj[1] = items2;
    obj[1] = callback2(closure_4, obj);
    tmp6 = callback(tmp2(5954).ActionSheet, obj);
    const tmp12 = stateFromStores(5969);
  }
  return tmp6;
};
