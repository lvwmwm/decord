...
// Dependencies: [19, 17, 1910, 21, 4444, 712, 589, 16765, 16769, 5936, 10491, 4440, 1236, 5951, 4879, 6188, 4134, 4162, 10095, 4411, 13533, 2]
// Exports: default

// Module 16768 (DmSettingsUpsellActionSheet)
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    items2[1] = callback(tmp2(4440).Text, obj2);
    ...
    items2[2] = callback(tmp2(4440).Text, obj3);
    ...
    obj10[1] = function onPress() {
      ...
      RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
        ...
        obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: callback2(10095), content: null };
    ...
    items2[4] = callback(tmp2(4879).Button, obj10);
    ...
    items2[5] = callback(tmp2(4879).Button, obj11);
    ...
    items2[6] = callback(tmp2(4440).Text, obj12);
    obj[1] = items2;
    obj[1] = callback2(closure_4, obj);
    tmp6 = callback(tmp2(5936).ActionSheet, obj);
    const tmp12 = stateFromStores(5951);
  }
  return tmp6;
};
