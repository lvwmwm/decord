...
// Dependencies: [19, 17, 1910, 21, 4342, 712, 589, 16503, 16507, 5825, 10328, 4338, 1236, 5840, 4777, 6077, 4034, 4062, 9933, 4310, 13335, 2]
// Exports: default

// Module 16506 (DmSettingsUpsellActionSheet)
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    obj8[1] = tmp2(5840).GuildIconSizes.SMALL_32;
    const items4 = [callback(stateFromStores(5840), obj8), ];
    ...
    obj10[1] = function onPress() {
      ...
      RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
        ...
        obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: callback2(9933), content: null };
    ...
    items2[4] = callback(tmp2(4777).Button, obj10);
    ...
    items2[5] = callback(tmp2(4777).Button, obj11);
    ...
    tmp6 = callback(tmp2(5825).ActionSheet, obj);
    const tmp12 = stateFromStores(5840);
  }
  return tmp6;
};
