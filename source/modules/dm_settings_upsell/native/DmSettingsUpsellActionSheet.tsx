...
// Dependencies: [19, 17, 1891, 21, 4302, 712, 589, 16324, 16328, 5704, 10289, 4298, 1236, 5719, 4712, 5953, 3974, 4002, 9811, 4270, 13184, 2]
// Exports: default

// Module 16327 (DmSettingsUpsellActionSheet)
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    items2[1] = callback(tmp2(4298).Text, obj2);
    ...
    items2[2] = callback(tmp2(4298).Text, obj3);
    ...
    obj10[1] = function onPress() {
      ...
      RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
        ...
        obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: callback2(9811), content: null };
    ...
    items2[4] = callback(tmp2(4712).Button, obj10);
    ...
    items2[5] = callback(tmp2(4712).Button, obj11);
    ...
    items2[6] = callback(tmp2(4298).Text, obj12);
    obj[1] = items2;
    obj[1] = callback2(closure_4, obj);
    tmp6 = callback(tmp2(5704).ActionSheet, obj);
    const tmp12 = stateFromStores(5719);
  }
  return tmp6;
};
