...
// Dependencies: [19, 17, 1910, 21, 4342, 712, 589, 16485, 16489, 5804, 10314, 4338, 1236, 5819, 4755, 6056, 4034, 4062, 9922, 4310, 13323, 2]
// Exports: default

// Module 16488 (DmSettingsUpsellActionSheet)
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    items2[1] = callback(tmp2(4338).Text, obj2);
    ...
    items2[2] = callback(tmp2(4338).Text, obj3);
    ...
    obj10[1] = function onPress() {
      ...
      RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
        ...
        obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: callback2(9922), content: null };
    ...
    items2[4] = callback(tmp2(4755).Button, obj10);
    ...
    items2[5] = callback(tmp2(4755).Button, obj11);
    ...
    items2[6] = callback(tmp2(4338).Text, obj12);
    obj[1] = items2;
    obj[1] = callback2(closure_4, obj);
    tmp6 = callback(tmp2(5804).ActionSheet, obj);
    const tmp12 = stateFromStores(5819);
  }
  return tmp6;
};
