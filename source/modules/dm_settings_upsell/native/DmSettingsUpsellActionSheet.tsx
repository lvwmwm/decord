...
// Dependencies: [19, 17, 1910, 21, 4668, 712, 589, 16648, 16652, 7213, 10625, 4739, 1236, 7226, 4750, 7395, 4069, 4097, 8801, 4346, 13425, 2]
// Exports: default

// Module 16651 (DmSettingsUpsellActionSheet)
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    items2[1] = callback(tmp2(4739).Text, obj2);
    ...
    items2[2] = callback(tmp2(4739).Text, obj3);
    ...
    obj10[1] = function onPress() {
      ...
      RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
        ...
        obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: callback2(8801), content: null };
    ...
    items2[4] = callback(tmp2(4750).Button, obj10);
    ...
    items2[5] = callback(tmp2(4750).Button, obj11);
    ...
    items2[6] = callback(tmp2(4739).Text, obj12);
    obj[1] = items2;
    obj[1] = callback2(closure_4, obj);
    tmp6 = callback(tmp2(7213).ActionSheet, obj);
    const tmp12 = stateFromStores(7226);
  }
  return tmp6;
};
