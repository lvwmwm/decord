...
// Module 15901 (DmSettingsUpsellActionSheet)
...
obj.container = obj;
obj.headerImage = {};
obj.title = { "Bool(false)": "\u{1F9D1}\u200D\u{1F52C}", "Bool(false)": true, "Bool(false)": 12.1 };
obj.body = { textAlign: "center" };
const tmp3 = arg1(dependencyMap[3]);
obj.guildContainer = { paddingVertical: importDefault(dependencyMap[5]).space.PX_16 };
const obj2 = { getMentionIconType: "<string:1912603085>", scoreMethod: true, popoutData: true, marginTop: importDefault(dependencyMap[5]).space.PX_4, gap: importDefault(dependencyMap[5]).space.PX_12, padding: importDefault(dependencyMap[5]).space.PX_12, backgroundColor: importDefault(dependencyMap[5]).colors.BACKGROUND_SURFACE_HIGH, borderRadius: importDefault(dependencyMap[5]).radii.md };
obj.guildInfo = obj2;
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj6 = { cachedAt: "/assets/images/native/premium/illustrations", edpbxy: 51 };
