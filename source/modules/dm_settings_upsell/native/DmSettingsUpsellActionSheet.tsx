...
// Dependencies: [19, 17, 1909, 21, 4478, 712, 589, 16918, 16922, 5989, 11011, 4474, 1236, 6004, 4928, 6242, 4166, 4194, 9518, 4445, 13646, 2]
// Exports: default

// Module 16921 (DmSettingsUpsellActionSheet)
  ...
  if (null != stateFromStores) {
    ...
    obj10[1] = function onPress() {
      ...
      RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
        ...
        obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: callback2(9518), content: null };
    ...
    tmp6 = callback(tmp2(5989).ActionSheet, obj);
