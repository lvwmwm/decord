...
// Dependencies: [19, 17, 1910, 21, 4380, 712, 589, 16680, 16684, 5870, 10423, 4376, 1236, 5885, 4815, 6122, 4070, 4098, 10028, 4347, 13460, 2]
// Exports: default

// Module 16683 (DmSettingsUpsellActionSheet)
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    items2[1] = callback(tmp2(4376).Text, obj2);
    ...
    items2[2] = callback(tmp2(4376).Text, obj3);
    ...
    obj10[1] = function onPress() {
      ...
      RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
        ...
        obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: callback2(10028), content: null };
    ...
    items2[4] = callback(tmp2(4815).Button, obj10);
    ...
    items2[5] = callback(tmp2(4815).Button, obj11);
    ...
    items2[6] = callback(tmp2(4376).Text, obj12);
    obj[1] = items2;
    obj[1] = callback2(closure_4, obj);
    tmp6 = callback(tmp2(5870).ActionSheet, obj);
    const tmp12 = stateFromStores(5885);
  }
  return tmp6;
};
