...
// Dependencies: [5, 32, 19, 673, 4474, 12197, 1219, 7390, 4194, 1233, 12196, 15962, 2]
// Exports: default

// Module 15961 (usePrivateChannelWave)
...
export default function usePrivateChannelWave(id) {
  ...
  obj[0] = _require(15962).usePrivateChannelWaveEligible(id, arg1);
  obj[1] = callback;
  return obj;
};
