...
export const getMuteSettings = function getMuteSettings(selected_time_window) {
  ...
  if (selected_time_window > 0) {
    ...
    toISOStringResult = importDefault(3902)().add(selected_time_window, "second").toISOString();
    const addResult = importDefault(3902)().add(selected_time_window, "second");
  }
