...
// Dependencies: [32, 4199, 3921, 1903, 676, 1351, 4123, 1236, 589, 2]
...
// Module 4475 (computeChannelName)
    ...
    if (constants.DM === type) {
      if ("" !== str) {
        ...
        if (null == first) {
          ...
          if (!first.isProvisional) {
            ...
            if (str17 == null) {
              str17 = importDefault(4123).getName(first);
      ...
      if ("" !== str) {
        ...
        if (mapped2.length > 0) {
          ...
          const obj = { name: null };
          obj[0] = importDefault(4123).getName(closure_9.getCurrentUser());
...
export const computeDefaultGroupDmNameFromUserIds = function computeDefaultGroupDmNameFromUserIds(arr, getUser) {
  ...
  if (mapped1.length > 0) {
    ...
    const obj = { name: null };
    obj[0] = importDefault(4123).getName(getUser.getCurrentUser());
