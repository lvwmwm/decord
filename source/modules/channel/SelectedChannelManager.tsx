...
// Module 16030 (_isNativeReflectConstruct)
...
let tmp3 = (arg0) => {
  ...
  obj = {
    key: "handleLogout",
    value() {
      callback(closure_2[12]).dispatch({ "Bool(true)": 0, "Bool(true)": 0, "Bool(true)": "100%", "Bool(true)": null, "Bool(true)": 1.4883720930232558, "Bool(true)": 35 });
    }
  };
  items[2] = obj;
