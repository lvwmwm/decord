...
// Dependencies: [676, 4380, 1236, 2]
// Exports: default

// Module 11161 (useTextareaPlaceholderAndLabels)
import ME from "ME";
...
export default function useTextareaPlaceholderAndLabels(isCreatingThread) {
  ...
  const tmp2 = importDefault(4380)(channel, true);
  const tmp3 = importDefault(4380)(channel, false);
  if (null != channel) {
    if (null != tmp2) {
      if (flag) {
