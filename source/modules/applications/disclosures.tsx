...
// Dependencies: [5, 676, 530, 8949, 1236, 2]
// Exports: ackDisclosures, getDisclosures, getTextForDisclosure

// Module 8948 (_getDisclosures)
import set from "set";
...
export const getTextForDisclosure = function getTextForDisclosure(toFixed) {
  if (require(8949) /* create */.ApplicationDisclosureType.IP_LOCATION === toFixed) {
    const intl2 = tmp(1236).intl;
    return intl2.string(tmp(1236).t["6wPmjo"]);
  } else if (tmp(8949).ApplicationDisclosureType.DISPLAYS_ADVERTISEMENTS === toFixed) {
