...
// Dependencies: [32, 1874, 7922, 4230, 1479, 9511, 5520, 11148, 7730, 1236, 11149, 8019, 7921, 10519, 11150, 11152, 1416, 1467, 11153, 5539, 10894, 5709, 5698, 4052, 1579, 11014, 5547, 3893, 1351, 2]
...
export const getAppLinkGateResult = function getAppLinkGateResult(arg0) {
  ...
  if (null == application) {
    if (false === obj.isFetchingApplication(appId)) {
      const application1 = require(5520) /* fetchApplication */.fetchApplication(appId);
      const obj6 = require(5520) /* fetchApplication */;
    }
    ...
    let obj1 = require(11148) /* ContentClassificationVisibility */;
    ...
    if (contentClassificationVisibility !== require(11148) /* ContentClassificationVisibility */.ContentClassificationVisibility.DISPLAY) {
      let intl = importDefault(7730)(theme).baseColors;
      if (contentClassificationVisibility === tmp3(11148).ContentClassificationVisibility.BLOCK_UNDERAGE) {
      ...
      obj.displayType = tmp3(11149).AppMessageEmbedDisplayType.BLOCKED;
      obj.appId = "";
...
export const createAppMessageEmbed = function createAppMessageEmbed(arg0) {
  ...
  ({ message, app } = arg0);
  ({ theme, embedUrl } = arg0);
  const baseColors = importDefault(7730)(theme).baseColors;
  ...
  if (null != maxParticipants) {
    ...
    if (isEmbeddedAppResult) {
      ...
      if (tmp2Result.canLaunchFrame(app)) {
        ...
        const playInContext = tmp2(11150).getPlayInContext(id, message.channel_id);
        ...
        const tmp2Result1 = tmp2(11150);
      }
    }
    ({ id: id2, bot: bot2 } = app);
    const joined = tags.join(" \u2219 ");
    if (tmp2Result2.isEmbeddedApp(app)) {
      let assetIds1 = tmp2(7921).getAssetIds(id2, closure_10);
      if (assetIds1 == null) {
        assetIds1 = [];
      }
      ...
      let assetImage = null;
      if (null != first) {
        assetImage = tmp2(7921).getAssetImage(id2, first, c11);
        const tmp2Result4 = tmp2(7921);
      }
      if (null != assetImage) {
      ...
      let appIconSrc = null;
      if (null != icon) {
        appIconSrc = tmp2(11152).getAppIconSrc(id, icon, bot);
        const tmp2Result5 = tmp2(11152);
      }
      let staticBannerSrc = appIconSrc;
      if (appIconSrc == null) {
        staticBannerSrc = obj7.staticBannerSrc;
      }
      const tmp2Result3 = tmp2(7921);
      const obj4 = {};
      const appGradientColors = tmp2(11152).getAppGradientColors(staticBannerSrc);
      const merged = Object.assign(baseColors);
      const merged1 = Object.assign(obj7);
      obj4.displayType = tmp2(11149).AppMessageEmbedDisplayType.DISPLAY;
      obj4.appId = app.id;
...
export const handleTapAppMessageEmbed = function handleTapAppMessageEmbed(appId) {
  ...
  if ("play_in_channel" === actionId) {
    ...
    const items = [tmp2(5539).APP_MESSAGE_EMBED];
    obj[2] = items;
    obj[3] = id;
    obj[4] = value;
    const result = require(11153) /* _joinOrStartActivityInChannel */.joinOrStartActivityInChannel(obj);
    const obj11 = require(11153) /* _joinOrStartActivityInChannel */;
    ...
    if (null != bot) {
      ...
      const items1 = [tmp2(5539).APP_MESSAGE_EMBED];
      obj[2] = items1;
      obj[3] = require(5709) /* ApplicationCommandSectionType */.CommandOrigin.APP_MESSAGE_EMBED;
      obj[4] = id;
      obj[5] = value;
      const result1 = require(10894) /* _launchActivityInBotDM */.launchActivityInBotDM(obj);
      const obj15 = require(10894) /* _launchActivityInBotDM */;
    }
  } else if ("play_frame" === actionId) {
    let obj1 = { applicationId: null };
    obj1[0] = appId.appId;
    tmp2(5698).launchFrame(obj1);
    const tmp2Result = tmp2(5698);
  } else if ("view_in_app_launcher" === actionId) {
    const bestActiveInput = require(4052) /* getBestActiveInput */.getBestActiveInput();
    ...
    const obj7 = require(4052) /* getBestActiveInput */;
    tmp14 = require;
  } else if ("add_app" === actionId) {
    if (null != application) {
      let obj4 = require(11014) /* installApplication */;
    ...
    obj2 = require(5547) /* _copy */;
    obj2.copy(appId.embedUrl);
    obj3 = require(3893) /* presentAddedFriendToast */;
