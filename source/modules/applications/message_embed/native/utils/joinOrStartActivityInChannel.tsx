...
// Dependencies: [5, 1371, 1372, 1960, 10584, 10547, 10533, 2]
// Exports: joinOrStartActivityInChannel

// Module 11285 (_joinOrStartActivityInChannel)
    ...
    const iter = (function*(arg0) {
      ...
      if (applicationId === callback) {
        if (voiceChannelId === callback2) {
          ...
          callback2(10584)(closure_8, channel.location);
          channel = 3;
