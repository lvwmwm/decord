...
export const useTrackAppEmbedViewed = function useTrackAppEmbedViewed(id) {
  _require = _require(7485).trackingConfigWithDefaults(id);
  closure_1 = React.useRef(false);
  let obj = _require(7485);
  return _require(7486).useIsVisible((arg0) => {
