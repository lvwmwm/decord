...
export const useTrackAppEmbedViewed = function useTrackAppEmbedViewed(id) {
  _require = _require(7299).trackingConfigWithDefaults(id);
  closure_1 = React.useRef(false);
  let obj = _require(7299);
  return _require(7300).useIsVisible((arg0) => {
