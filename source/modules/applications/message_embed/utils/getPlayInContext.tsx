...
// Dependencies: [1385, 1980, 586, 9511, 2]
// Exports: getPlayInContext, usePlayInContext

// Module 11875 (usePlayInContext)
...
export const getPlayInContext = function getPlayInContext(id, channel_id) {
  ...
  if (null == channelId) {
    ...
    if (null != channelId) {
      let obj = _require(9511);
      let NO_CHANNEL = obj.getEmbeddedActivityLaunchabilityForChannel(channelId);
      let tmp3 = _require;
    } else {
      tmp3 = _require;
      NO_CHANNEL = _require(9511).EmbeddedActivityLaunchability.NO_CHANNEL;
    }
    ...
    obj[3] = tmp11;
    obj[4] = NO_CHANNEL === tmp3(9511).EmbeddedActivityLaunchability.CAN_LAUNCH;
    return obj;
  }
};
