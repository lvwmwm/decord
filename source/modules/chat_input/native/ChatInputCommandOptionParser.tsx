...
// Dependencies: [17, 4334, 5216, 1983, 3989, 676, 4779, 1925, 11435, 4006, 11436, 4376, 1903, 7993, 5992, 4034, 9960, 712, 4535, 2]
...
// Module 11434 (findGameMentionTokens)
          ...
          if (0 < options.length) {
            do {
              ...
              if (!hasItem) {
                ...
                obj1[0] = require(11435) /* addRule */.ChatInputParseResultDataType.COMMAND_OPTION;
                obj1[1] = options[num];
                obj[2] = obj1;
          ...
          if (match[0].length > 1) {
            ...
            for (let num = 0; num < options.length; num = num + 1) {
              ...
              if (!hasItem) {
                ...
                obj[0] = require(11435) /* addRule */.ChatInputParseResultDataType.COMMAND_OPTION;
                obj[1] = options[num];
                obj[2] = obj;
                let arr = items.push(obj);
                let addResult = set.add(num);
...
export const getChannelHighlightNodes = function getChannelHighlightNodes(channel, arg1) {
  ...
  const _require = arg1;
  let items = [];
  const dependencyMap = _require(11436).getChannels(channel);
  let c3 = 0;
  function _loop4() {
    let arr = lib;
