...
// Dependencies: [17, 4662, 6727, 1983, 4021, 676, 6810, 1925, 11164, 4038, 11165, 4507, 1903, 6684, 7295, 4066, 10176, 712, 4984, 2]
...
function buildGameMentionResult(id) {
  let uri = importDefault(4507)(id.id, id.icon, { size: 32 });
          ...
          if (0 < options.length) {
            do {
              ...
              if (!hasItem) {
                ...
                obj1[0] = require(11164) /* addRule */.ChatInputParseResultDataType.COMMAND_OPTION;
                obj1[1] = options[num];
                obj[2] = obj1;
          ...
          if (match[0].length > 1) {
            ...
            for (let num = 0; num < options.length; num = num + 1) {
              ...
              if (!hasItem) {
                ...
                obj[0] = require(11164) /* addRule */.ChatInputParseResultDataType.COMMAND_OPTION;
                obj[1] = options[num];
                obj[2] = obj;
                let arr = items.push(obj);
                let addResult = set.add(num);
...
export const getChannelHighlightNodes = function getChannelHighlightNodes(channel, arg1) {
  ...
  const _require = arg1;
  let items = [];
  const dependencyMap = _require(11165).getChannels(channel);
  let c3 = 0;
  function _loop4() {
    let arr = lib;
