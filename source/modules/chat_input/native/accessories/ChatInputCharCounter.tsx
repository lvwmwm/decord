...
// Dependencies: [32, 19, 1874, 676, 1876, 21, 4285, 589, 3931, 8164, 8173, 3986, 1236, 4812, 4281, 7625, 2]

// Module 11704 (ChatInputCharCounter)
...
const forwardRefResult = importAllResult.forwardRef((analyticsLocations, ref) => {
  ...
  const tmp7 = stateFromStores(8164)();
  callback = tmp7;
  ...
  if (tmp6 > 0) {
    ...
    obj[3] = "-" + tmp6;
    const items2 = [callback2(tmp2(4281).Text, obj), callback2(tmp2(7625).NitroWheelIcon, { size: "sm" })];
    obj[2] = items2;
    tmp10 = callback3(tmp2(4812).PressableOpacity, obj);
  }
  return tmp10;
});
