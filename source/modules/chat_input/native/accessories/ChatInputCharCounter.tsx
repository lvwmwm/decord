...
// Dependencies: [32, 19, 1922, 676, 1924, 21, 4448, 589, 4109, 8128, 8137, 4164, 1236, 5036, 4444, 8064, 2]

// Module 11961 (ChatInputCharCounter)
...
const forwardRefResult = importAllResult.forwardRef((analyticsLocations, ref) => {
  ...
  const tmp7 = stateFromStores(8128)();
  callback = tmp7;
  ...
  if (tmp6 > 0) {
    ...
    obj[3] = "-" + tmp6;
    const items2 = [callback2(tmp2(4444).Text, obj), callback2(tmp2(8064).NitroWheelIcon, { size: "sm" })];
    obj[2] = items2;
    tmp10 = callback3(tmp2(5036).PressableOpacity, obj);
  }
  return tmp10;
});
