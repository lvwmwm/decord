...
// Dependencies: [32, 19, 17, 4277, 7067, 11287, 21, 4285, 712, 3988, 11535, 11544, 11528, 4231, 1236, 1348, 589, 4629, 11548, 4145, 2]

// Module 11543 (renderChatInputSendButton)
...
function FloatingSlot(arg0) {
  ...
  const style = [{ height: buttonHeight }, importDefault(11548)({ expanded: !sendVoiceMessageEnabled, collapsedWidth: buttonHeight + 2 * buttonMargin, expandedWidth: buttonWidth + 2 * buttonMargin }).animatedStyle];
  return jsx(importDefault(4145).View, { style, children });
}
