...
// Dependencies: [32, 19, 17, 3914, 4480, 11696, 676, 1369, 11697, 21, 4285, 712, 1348, 698, 9649, 4281, 4827, 11698, 1236, 11699, 5309, 589, 11451, 11707, 5943, 1358, 2]
// Exports: default

// Module 11695 (ChatInputNotificationNudgeImpl)
...
export default function ChatInputNotificationNudge(channel) {
  ...
  if (!stateFromStores) {
    tmp5 = !importDefault(11451)(channel);
  }
  ...
  const tmp4Result = importDefault(11707);
  let prop = null;
  if (tmp5) {
    prop = null;
