...
// Dependencies: [32, 19, 17, 3991, 4550, 11853, 676, 1388, 11854, 21, 4342, 712, 1367, 698, 9792, 4338, 4909, 11855, 1236, 11856, 5387, 589, 11606, 11864, 6086, 1377, 2]
// Exports: default

// Module 11852 (ChatInputNotificationNudgeImpl)
...
export default function ChatInputNotificationNudge(channel) {
  ...
  if (!stateFromStores) {
    tmp5 = !importDefault(11606)(channel);
  }
  ...
  const tmp4Result = importDefault(11864);
  let prop = null;
  if (tmp5) {
    prop = null;
