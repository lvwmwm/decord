...
// Dependencies: [32, 19, 17, 4067, 21, 4255, 712, 1236, 4191, 4101, 4099, 500, 11257, 11263, 11265, 2]

// Module 11506 (ChatInputNativeComponent)
...
const forwardRefResult = importAllResult.forwardRef((markAsSpoilerTitle, ref) => {
  ...
  _require = _require(11263).useShouldUseFabricChatInput();
