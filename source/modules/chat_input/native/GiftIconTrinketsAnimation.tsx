...
// Dependencies: [19, 17, 4277, 21, 4285, 4699, 1348, 3988, 712, 589, 1884, 500, 9304, 5251, 2]

// Module 11539 (GiftIconTrinketsAnimation)
...
const memoResult = require("noop").memo((trinketsAnimationUrl) => {
  ...
  const tmp2 = callback(require(3988) /* map */.useToken(importDefault(712).modules.mobile.CHAT_INPUT_ACTION_BUTTON_SIZE));
