...
// Dependencies: [19, 17, 4294, 1903, 676, 21, 1297, 4302, 712, 1348, 4005, 4298, 1236, 4844, 8408, 589, 4019, 4531, 9176, 8010, 4165, 10148, 4112, 4162, 4303, 10149, 698, 10150, 1222, 4530, 10225, 2]

// Module 10147 (ChatInputReplyBarNoAuthor)
...
function ChatInputEditBar(onCancelEditing) {
  ...
  let tmp7Result = tmp7(require(4298) /* Text */.Text, obj);
