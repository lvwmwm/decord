...
export default {
  backspace(arg0) {
    if (null != arg0) {
      const Commands = require(11448) /* __INTERNAL_VIEW_CONFIG */.Commands;
  ...
  getText(arg0, set) {
    ...
    if (null == arg0) {
      ...
      const nonce = _require(7280).createNonce();
      const result = set.set(nonce, (arg0) => {
        set.delete(nonce);
        callback(arg0);
      });
      const Commands = _require(11448).Commands;
