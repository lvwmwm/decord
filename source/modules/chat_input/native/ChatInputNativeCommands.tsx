// Module ID: 11296
// Function ID: 11297
// Dependencies: [17, 11297, 11299, 7134, 1208, 2]
...
export default {
  backspace(arg0) {
    if (null != arg0) {
      if (obj.shouldUseFabricChatInput()) {
        const Commands = tmp(11299).Commands;
      ...
      obj = require(11297) /* useShouldUseFabricChatInput */;
      tmp = require;
    }
  },
  blur(arg0) {
  ...
  setText(arg0, arg1) {
    if (null != arg0) {
      if (obj.shouldUseFabricChatInput()) {
        const Commands = tmp2(11299).Commands;
  ...
  setSelectedRange(arg0, arg1, arg2) {
    if (null != arg0) {
      if (obj.shouldUseFabricChatInput()) {
        const Commands = tmp3(11299).Commands;
  ...
  updateTextBlocks(arg0, arg1, arg2) {
    if (null != arg0) {
      if (obj.shouldUseFabricChatInput()) {
        const Commands = tmp9(11299).Commands;
        const _JSON = JSON;
  ...
  replaceRange(arg0, keepCursorPosition) {
    ...
    if (null != arg0) {
      if (obj.shouldUseFabricChatInput()) {
        const Commands = tmp20(11299).Commands;
        const _JSON = JSON;
