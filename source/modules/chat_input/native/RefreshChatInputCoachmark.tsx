  ...
  if (tmp) {
    ...
    if (tmp11) {
      memo = React.useMemo(() => {
        ...
        obj = { 1851991148: "dividerText", -1048942105: "decorationStyle", -2112074014: "SAFETY_SEND_FRIEND_REQUESTS_MUTUAL_FRIENDS", rive: tmp8(closure_2[7]).OmnibuttonCoachmarkRive };
        obj.graphic = obj;
        return obj;
      }, items1);
    }
