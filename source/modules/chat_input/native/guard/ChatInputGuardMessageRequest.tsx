// Module ID: 11544
// Function ID: 11545
// Dependencies: [5, 19, 1874, 21, 1480, 11545, 589, 11547, 3894, 1236, 9181, 4201, 11553, 2]
...
const memoResult = require("noop").memo(function ChatInputGuardMessageRequest(channel) {
  ...
  const isMessageRequestRestrictedViewer = channel(11545).useIsMessageRequestRestrictedViewer("ChatInputGuardMessageRequest");
  let obj2 = channel(11545);
  ...
  return tmp7(importDefault(11553), obj);
});
