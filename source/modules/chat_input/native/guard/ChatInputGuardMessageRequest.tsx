// Module ID: 11718
// Function ID: 11719
// Dependencies: [5, 19, 1903, 21, 1480, 11719, 589, 11721, 3985, 1236, 8368, 4293, 11727, 2]
...
const memoResult = require("noop").memo(function ChatInputGuardMessageRequest(channel) {
  ...
  const isMessageRequestRestrictedViewer = channel(11719).useIsMessageRequestRestrictedViewer("ChatInputGuardMessageRequest");
  let obj2 = channel(11719);
  ...
  return tmp7(importDefault(11727), obj);
});
