// Module ID: 11862
// Function ID: 11863
// Dependencies: [5, 19, 1922, 21, 1499, 11863, 589, 11865, 4062, 1236, 8494, 4353, 11871, 2]
...
const memoResult = require("noop").memo(function ChatInputGuardMessageRequest(channel) {
  ...
  const isMessageRequestRestrictedViewer = channel(11863).useIsMessageRequestRestrictedViewer("ChatInputGuardMessageRequest");
  let obj2 = channel(11863);
  ...
  return tmp7(importDefault(11871), obj);
});
