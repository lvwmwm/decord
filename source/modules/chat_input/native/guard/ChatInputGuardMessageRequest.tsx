// Module ID: 11860
// Function ID: 11861
// Dependencies: [5, 19, 1922, 21, 1499, 11861, 589, 11863, 4062, 1236, 8490, 4352, 11869, 2]
...
const memoResult = require("noop").memo(function ChatInputGuardMessageRequest(channel) {
  ...
  const isMessageRequestRestrictedViewer = channel(11861).useIsMessageRequestRestrictedViewer("ChatInputGuardMessageRequest");
  let obj2 = channel(11861);
  ...
  return tmp7(importDefault(11869), obj);
});
