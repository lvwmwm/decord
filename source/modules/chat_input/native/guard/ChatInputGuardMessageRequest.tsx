// Module ID: 11527
// Function ID: 11528
// Dependencies: [5, 19, 1874, 21, 1480, 11528, 589, 11530, 3890, 1236, 9168, 4197, 11536, 2]
...
const memoResult = require("noop").memo(function ChatInputGuardMessageRequest(channel) {
  ...
  const isMessageRequestRestrictedViewer = channel(11528).useIsMessageRequestRestrictedViewer("ChatInputGuardMessageRequest");
  let obj2 = channel(11528);
  ...
  return tmp7(importDefault(11536), obj);
});
