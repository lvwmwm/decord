// Module ID: 12381
// Function ID: 12382
// Dependencies: [19, 1921, 21, 1498, 586, 12382, 12374, 4194, 1233, 5552, 12380, 4492, 2]
...
const memoResult = importAllResult.memo(function ChatInputGuardSpamMessageRequest(channel) {
  ...
  dependencyMap = channel(12382).useLongestChannelMessageBeforeReply(channel.id, channel.getRecipientId());
  const items1 = [navigation];
  const callback = importAllResult.useCallback(() => {
    navigation.pop();
  }, items1);
  const obj3 = channel(12382);
  obj = {
    ...
    onError() {
      ...
      obj[2] = navigation(5552);
      obj.open(obj);
    },
    onRejectSuccess: callback
  };
  const messageRequestActions = channel(12374).useMessageRequestActions(obj);
  ...
  return tmp8(navigation(12380), obj);
});
