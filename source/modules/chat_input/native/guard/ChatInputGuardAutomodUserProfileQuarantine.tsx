// Module ID: 11888
// Function ID: 11889
// Dependencies: [19, 1218, 1990, 3977, 21, 589, 3995, 11312, 1236, 11872, 11889, 2]
...
const memoResult = importAllResult.memo(function ChatInputGuardAutomodUserProfileQuarantine(guildId) {
  ...
  obj[4] = stringResult1;
  return jsx(importDefault(11872), { type: "simple-action", actionOnPress: callback, actionLabel: stringResult, icon: null, message: null });
});
