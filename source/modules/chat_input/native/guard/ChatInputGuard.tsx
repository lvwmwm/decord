...
// Function ID: 11810
// Name: ChatInputGuard
// Dependencies: [19, 17, 8611, 21, 4303, 712, 806, 8392, 1348, 11632, 11631, 4848, 500, 11640, 5374, 7751, 9688, 9683, 4299, 4714, 5150, 8663, 2]
// Exports: ChatInputGuardContainer, default

// Module 11809 (ChatInputGuard)
...
export default function ChatInputGuard(type) {
  ...
  let subtext;
  let subtext2;
  const tmp3 = callback2(importDefault(8392)());
  if ("simple-action" === type.type) {
    ...
    const tmp15 = callback(require(4714) /* Button */.Button, obj5);
    const obj6 = { style: null, children: null };
    obj6[0] = tmp3.wrapper;
    const obj7 = { style: null, variant: "text-sm/semibold", children: null };
    obj7[0] = tmp3.text;
    obj7[2] = message2;
    const items1 = [callback(require(4299) /* Text */.Text, obj7), , , ];
    ...
    obj10[0] = tmp16Result;
    items1[2] = callback(require(5150) /* ButtonGroup */.ButtonGroup, obj10);
    tmp13Result = null;
    if (null != countdown2) {
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  const items1 = [importDefault(11631)({ isCreatingThread: false }), ];
