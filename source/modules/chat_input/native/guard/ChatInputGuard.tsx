...
// Function ID: 11743
// Name: ChatInputGuard
// Dependencies: [19, 17, 8551, 21, 4302, 712, 806, 8332, 1348, 11565, 11564, 4846, 500, 11573, 5373, 7691, 9623, 9618, 4298, 4712, 5149, 8603, 2]
// Exports: ChatInputGuardContainer, default

// Module 11742 (ChatInputGuard)
...
export default function ChatInputGuard(type) {
  ...
  let subtext;
  let subtext2;
  const tmp3 = callback2(importDefault(8332)());
  if ("simple-action" === type.type) {
    ...
    const tmp15 = callback(require(4712) /* Button */.Button, obj5);
    const obj6 = { style: null, children: null };
    obj6[0] = tmp3.wrapper;
    const obj7 = { style: null, variant: "text-sm/semibold", children: null };
    obj7[0] = tmp3.text;
    obj7[2] = message2;
    const items1 = [callback(require(4298) /* Text */.Text, obj7), , , ];
    ...
    obj10[0] = tmp16Result;
    items1[2] = callback(require(5149) /* ButtonGroup */.ButtonGroup, obj10);
    tmp13Result = null;
    if (null != countdown2) {
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  const items1 = [importDefault(11564)({ isCreatingThread: false }), ];
