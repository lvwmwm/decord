...
// Function ID: 11694
// Name: ChatInputGuard
// Dependencies: [19, 17, 8393, 21, 4255, 712, 806, 8175, 1348, 11516, 11515, 4799, 500, 11524, 5300, 7644, 9578, 9573, 4251, 4665, 5102, 8557, 2]
// Exports: ChatInputGuardContainer, default

// Module 11693 (ChatInputGuard)
...
export default function ChatInputGuard(type) {
  ...
  let subtext;
  let subtext2;
  const tmp3 = callback2(importDefault(8175)());
  if ("simple-action" === type.type) {
    ...
    const tmp15 = callback(require(4665) /* Button */.Button, obj5);
    ...
    obj10[0] = tmp16Result;
    items1[2] = callback(require(5102) /* ButtonGroup */.ButtonGroup, obj10);
    tmp13Result = null;
    if (null != countdown2) {
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  const items1 = [importDefault(11515)({ isCreatingThread: false }), ];
