...
// Function ID: 11728
// Name: ChatInputGuard
// Dependencies: [19, 17, 8534, 21, 4285, 712, 806, 8315, 1348, 11550, 11549, 4829, 500, 11558, 5354, 7672, 9607, 9602, 4281, 4695, 5132, 8586, 2]
// Exports: ChatInputGuardContainer, default

// Module 11727 (ChatInputGuard)
...
export default function ChatInputGuard(type) {
  ...
  let subtext;
  let subtext2;
  const tmp3 = callback2(importDefault(8315)());
  if ("simple-action" === type.type) {
    ...
    obj10[0] = tmp16Result;
    items1[2] = callback(require(5132) /* ButtonGroup */.ButtonGroup, obj10);
    tmp13Result = null;
    if (null != countdown2) {
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  const items1 = [importDefault(11549)({ isCreatingThread: false }), ];
