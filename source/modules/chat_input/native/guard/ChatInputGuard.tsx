...
// Function ID: 11889
// Name: ChatInputGuard
// Dependencies: [19, 17, 8674, 21, 4342, 712, 806, 8463, 1367, 11707, 11706, 4911, 500, 11715, 5435, 7817, 9748, 9743, 4338, 4777, 5212, 8726, 2]
// Exports: ChatInputGuardContainer, default

// Module 11888 (ChatInputGuard)
...
export default function ChatInputGuard(type) {
  ...
  let subtext;
  let subtext2;
  const tmp3 = callback2(importDefault(8463)());
  if ("simple-action" === type.type) {
    ...
    const tmp15 = callback(require(4777) /* Button */.Button, obj5);
    ...
    obj10[0] = tmp16Result;
    items1[2] = callback(require(5212) /* ButtonGroup */.ButtonGroup, obj10);
    tmp13Result = null;
    if (null != countdown2) {
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  const items1 = [importDefault(11706)({ isCreatingThread: false }), ];
