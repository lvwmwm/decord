// Module ID: 11812
// Function ID: 11813
// Dependencies: [19, 11813, 21, 11809, 11814, 1236, 2]
...
const memoResult = require("noop").memo(function ChatInputGuardQuarantineDM() {
  ...
  obj[1] = jsx(require(11814) /* ChatWarningIcon */.ChatWarningIcon, {});
  ...
  return jsx(importDefault(11809), { appealLink: QUARANTINE_APPEAL_LINK });
});
