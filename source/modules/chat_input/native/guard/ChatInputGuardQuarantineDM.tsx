// Module ID: 11696
// Function ID: 11697
// Dependencies: [19, 11697, 21, 11693, 11698, 1236, 2]
...
const memoResult = require("noop").memo(function ChatInputGuardQuarantineDM() {
  ...
  obj[1] = jsx(require(11698) /* ChatWarningIcon */.ChatWarningIcon, {});
  ...
  return jsx(importDefault(11693), { appealLink: QUARANTINE_APPEAL_LINK });
});
