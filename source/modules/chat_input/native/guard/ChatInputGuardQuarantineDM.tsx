// Module ID: 11480
// Function ID: 89398
// Dependencies: [31, 11481, 33, 11477, 11482, 1212, 2]
...
const memoResult = require("result").memo(function ChatInputGuardQuarantineDM() {
  let obj = { type: "simple-action", icon: jsx(require(11482) /* ChatWarningIcon */.ChatWarningIcon, {}) };
  ...
  return jsx(importDefault(11477), { appealLink: QUARANTINE_APPEAL_LINK });
});
