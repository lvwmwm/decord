// Module ID: 11484
// Function ID: 89436
// Dependencies: [31, 11485, 33, 11481, 11486, 1212, 2]
...
const memoResult = require("result").memo(function ChatInputGuardQuarantineDM() {
  let obj = { type: "simple-action", icon: jsx(require(11486) /* ChatWarningIcon */.ChatWarningIcon, {}) };
  ...
  return jsx(importDefault(11481), { appealLink: QUARANTINE_APPEAL_LINK });
});
