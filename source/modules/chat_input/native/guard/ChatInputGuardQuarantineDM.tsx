// Module ID: 11519
// Function ID: 89527
// Dependencies: [31, 11520, 33, 11516, 11521, 1212, 2]
...
const memoResult = require("result").memo(function ChatInputGuardQuarantineDM() {
  let obj = { type: "simple-action", icon: jsx(require(11521) /* ChatWarningIcon */.ChatWarningIcon, {}) };
  ...
  return jsx(importDefault(11516), { appealLink: QUARANTINE_APPEAL_LINK });
});
