// Module ID: 11811
// Function ID: 11812
// Dependencies: [19, 11812, 21, 11808, 11813, 1236, 2]
...
const memoResult = require("noop").memo(function ChatInputGuardQuarantineDM() {
  ...
  obj[1] = jsx(require(11813) /* ChatWarningIcon */.ChatWarningIcon, {});
  ...
  return jsx(importDefault(11808), { appealLink: QUARANTINE_APPEAL_LINK });
});
