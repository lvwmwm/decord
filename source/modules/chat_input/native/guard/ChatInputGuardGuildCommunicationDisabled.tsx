// Module ID: 11566
// Function ID: 11567
// Dependencies: [19, 1944, 21, 11567, 11553, 11058, 1236, 2]
...
const memoResult = require("noop").memo(function CommunicationDisabledNoticeForGuild(guildMember) {
  ...
  let obj = require(11567) /* useCommunicationDisabledCountdownCleanup */;
  ...
  obj[1] = jsx(require(11058) /* ClockWarningIcon */.ClockWarningIcon, {});
  ...
  obj[4] = date;
  return jsx(importDefault(11553), { link: closure_3 });
});
