// Module ID: 11822
// Function ID: 11823
// Dependencies: [19, 1973, 21, 11823, 11809, 11253, 1236, 2]
...
const memoResult = require("noop").memo(function CommunicationDisabledNoticeForGuild(guildMember) {
  ...
  let obj = require(11823) /* useCommunicationDisabledCountdownCleanup */;
  ...
  obj[1] = jsx(require(11253) /* ClockWarningIcon */.ClockWarningIcon, {});
  ...
  obj[4] = date;
  return jsx(importDefault(11809), { link: closure_3 });
});
