// Module ID: 11884
// Function ID: 11885
// Dependencies: [19, 1992, 21, 11885, 11871, 11303, 1236, 2]
...
const memoResult = require("noop").memo(function CommunicationDisabledNoticeForGuild(guildMember) {
  ...
  let obj = require(11885) /* useCommunicationDisabledCountdownCleanup */;
  ...
  obj[1] = jsx(require(11303) /* ClockWarningIcon */.ClockWarningIcon, {});
  ...
  obj[4] = date;
  return jsx(importDefault(11871), { link: closure_3 });
});
