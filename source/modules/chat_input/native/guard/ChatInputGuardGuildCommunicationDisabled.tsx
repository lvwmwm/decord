// Module ID: 11706
// Function ID: 11707
// Dependencies: [19, 1944, 21, 11707, 11693, 11137, 1236, 2]
...
const memoResult = require("noop").memo(function CommunicationDisabledNoticeForGuild(guildMember) {
  ...
  let obj = require(11707) /* useCommunicationDisabledCountdownCleanup */;
  ...
  obj[1] = jsx(require(11137) /* ClockWarningIcon */.ClockWarningIcon, {});
  ...
  obj[4] = date;
  return jsx(importDefault(11693), { link: closure_3 });
});
