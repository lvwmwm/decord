// Module ID: 11553
// Function ID: 11554
// Dependencies: [19, 1944, 21, 11554, 11540, 11044, 1236, 2]
...
const memoResult = require("noop").memo(function CommunicationDisabledNoticeForGuild(guildMember) {
  ...
  let obj = require(11554) /* useCommunicationDisabledCountdownCleanup */;
  ...
  obj[1] = jsx(require(11044) /* ClockWarningIcon */.ClockWarningIcon, {});
  ...
  obj[4] = date;
  return jsx(importDefault(11540), { link: closure_3 });
});
