// Module ID: 11755
// Function ID: 11756
// Dependencies: [19, 1973, 21, 11756, 11742, 11186, 1236, 2]
...
const memoResult = require("noop").memo(function CommunicationDisabledNoticeForGuild(guildMember) {
  ...
  let obj = require(11756) /* useCommunicationDisabledCountdownCleanup */;
  ...
  obj[1] = jsx(require(11186) /* ClockWarningIcon */.ClockWarningIcon, {});
  ...
  obj[4] = date;
  return jsx(importDefault(11742), { link: closure_3 });
});
