...
// Dependencies: [19, 5092, 4526, 5966, 5971, 1874, 9310, 676, 4624, 4182, 5503, 4048, 12, 11164, 11168, 11169, 11172, 6182, 6088, 4055, 1579, 1478, 500, 4056, 1844, 698, 9563, 5713, 9565, 11173, 5967, 11174, 4524, 11207, 6744, 2]
// Exports: default

// Module 11163 (useChatInputRefs)
...
export default function useChatInputRefs(chatInputProps) {
  ...
  const tmp2 = chatInputTextFieldHeight(5503)(() => chatInputProps(4048).createInputRefTracker(chatInputProps.channel.id, chatInputProps.screenIndex));
  c11 = tmp2;
  ...
  closure_14 = React.useRef(chatInputTextFieldHeight(5503)(() => ({ editId: null, focused: false, selectionStart: 0, selectionEnd: 0, text: chatInputProps.defaultValue, textPrev: chatInputProps.defaultValue, textFieldContentSize: 0, textFieldHeight: chatInputTextFieldHeight })));
          ...
          if (null != threadCreationCallback) {
            const text = chatInputTextFieldHeight(ref[13]).getText(outer1_8.current, outer1_10.current, (text) => {
              ...
              if (null != result) {
                ...
                const result1 = chatInputProps(11174).chatInputCreateThread(obj1);
                const tmpResult = chatInputProps(11174);
              }
            });
            ...
            if (!sendCommandResult) {
              const text1 = chatInputTextFieldHeight(ref[13]).getText(outer1_8.current, outer1_10.current, (arg0) => {
                if (null != outer1_13.current.pendingEdit) {
                  ...
                  closure_1.cancel();
                  let obj = threadCreationCallback(11174);
                ...
                const keyboardType = threadCreationCallback(4055).getKeyboardType();
