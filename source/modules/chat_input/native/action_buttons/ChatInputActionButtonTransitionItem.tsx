...
// Dependencies: [19, 17, 11602, 21, 4172, 4184, 4445, 11888, 2]
// Exports: default, interactivityProps

// Module 11887 (FadeTransitionItem)
...
import { CHAT_INPUT_TIMING_CONFIG } from "TextAreaCta" /* 11602 */;
...
function BounceTransitionItem(state) {
  ...
  return jsx(_modDef4184.View, { pointerEvents: str, accessibilityElementsHidden: !isInteractive, importantForAccessibility: null });
}
