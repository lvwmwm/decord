...
// Dependencies: [19, 17, 11287, 21, 4629, 4145, 4286, 11536, 2]
// Exports: default, interactivityProps

// Module 11535 (FadeTransitionItem)
...
function BounceTransitionItem(state) {
  ...
  obj[0] = state !== require(4629) /* wrapChildrenDefault */.TransitionStates.YEETED;
  obj[1] = state !== require(4629) /* wrapChildrenDefault */.TransitionStates.ENTERED;
  obj[2] = bounceEnterDelayMs;
  obj[3] = cleanup;
  const tmp = importDefault(11536);
  ({ isInteractive, animatedStyle } = importDefault(11536)(obj));
  obj = { style: items };
  ...
  return jsx(importDefault(4145).View, { pointerEvents: str, accessibilityElementsHidden: !isInteractive, importantForAccessibility: null });
}
