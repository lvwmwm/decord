...
// Dependencies: [19, 17, 11253, 21, 4599, 4116, 4256, 11502, 2]
// Exports: default, interactivityProps

// Module 11501 (FadeTransitionItem)
...
function BounceTransitionItem(state) {
  ...
  obj[0] = state !== require(4599) /* wrapChildrenDefault */.TransitionStates.YEETED;
  obj[1] = state !== require(4599) /* wrapChildrenDefault */.TransitionStates.ENTERED;
  obj[2] = bounceEnterDelayMs;
  obj[3] = cleanup;
  const tmp = importDefault(11502);
  ({ isInteractive, animatedStyle } = importDefault(11502)(obj));
  obj = { style: items };
