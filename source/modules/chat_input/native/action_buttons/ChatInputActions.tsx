...
let obj = { actions: { -9223372036854775808: true, filter: true } };
...
const forwardRefResult = importAllResult.forwardRef((canStartThreads) => {
  ...
  function it() {
    if (chatInputFloating) {
      ...
      obj = { "Bool(false)": null, "Bool(false)": null, width: canStartThreads(isAppLauncherEnabled[26]).withTiming(tmp27 ? sum : sum1, enabled) };
