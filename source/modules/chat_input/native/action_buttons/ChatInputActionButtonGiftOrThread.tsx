...
// Dependencies: [19, 17, 11149, 21, 4661, 11409, 11402, 1236, 11398, 11411, 4097, 712, 4668, 2]
...
function renderChatInputActionButtonGiftAndThread(arg0, styleButton, state, cleanup) {
  ...
  obj[2] = tmpResult;
  return jsx(importDefault(11409), { cleanup, state, children: null }, arg0);
}
...
const memoResult = importAllResult.memo(function ChatInputActionButtonGiftOrThread(arg0) {
  ...
  obj = { style: callback(token, _require(4097).useToken(importDefault(712).modules.mobile.CHAT_INPUT_ACTION_BUTTON_MARGIN)).container, children: null };
