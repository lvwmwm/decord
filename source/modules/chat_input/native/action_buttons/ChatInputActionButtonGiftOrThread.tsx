...
// Dependencies: [19, 17, 11436, 21, 4342, 11692, 11685, 1236, 11681, 11694, 4065, 712, 4711, 2]

// Module 11691 (renderChatInputActionButtonGiftAndThread)
...
function renderChatInputActionButtonGiftAndThread(arg0, styleButton, state, cleanup) {
  ...
  obj[2] = tmpResult;
  return jsx(importDefault(11692), { cleanup, state, children: null }, arg0);
}
...
const memoResult = importAllResult.memo(function ChatInputActionButtonGiftOrThread(arg0) {
  ...
  obj[1] = jsx(_require(4711).TransitionGroup, { items: memo, renderItem: renderChatInputActionButtonGiftAndThread, getItemKey: getChatInputActionButtonGiftAndThreadKey });
