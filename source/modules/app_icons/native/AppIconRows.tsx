...
// Dependencies: [32, 19, 17, 1903, 21, 4303, 7663, 5767, 1236, 14712, 7661, 589, 1926, 2]
// Exports: default

// Module 14711 (BackwardsCompatibleAppIconRows)
...
export default function AppIconRows(onSelect) {
  ...
  let obj = require(7661) /* fetchCurrentAppIcon */;
