...
// Dependencies: [32, 19, 17, 1922, 21, 4342, 7708, 5807, 1236, 14791, 7706, 589, 1945, 2]
// Exports: default

// Module 14790 (BackwardsCompatibleAppIconRows)
...
function BackwardsCompatibleAppIconRows(arg0) {
  ...
  if (arg0 == null) {
    ...
    obj[1] = callback(merged(5807).TableRowGroup, obj);
