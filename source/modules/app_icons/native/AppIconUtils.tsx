...
// Dependencies: [32, 5, 19, 17, 7555, 676, 1876, 3, 500, 7582, 7556, 4681, 709, 698, 3956, 1236, 5910, 1577, 2]
// Exports: isAppIconsSupported, navigateToAppIconSettings, setAppIcon, useAppIcons, useCurrentAppIcon

// Module 7554 (fetchCurrentAppIcon)
...
function useCurrentAppIcon() {
  const tmp = callback(React.useState(_require(7556).FreemiumAppIconIds.DEFAULT), 2);
  _require = tmp[1];
...
export const useAppIcons = function useAppIcons() {
  ...
  let tmp4;
  let tmp6;
  const currentAppIcon = callback(React.useState(_require(7556).FreemiumAppIconIds.DEFAULT), 2);
