...
// Function ID: 6581
// Name: items
// Dependencies: [6581, 6582, 1236, 6583, 6584, 6585, 6586, 6587, 6588, 6589, 6590, 6591, 6592, 6593, 6594, 6595, 6596, 6597, 6598, 6599, 6600, 6601, 6602, 6603, 6604, 6605, 6606, 2]
...
export const getDefaultIcon = function getDefaultIcon() {
  const obj = { id: require(6581) /* FreemiumAppIconIds */.FreemiumAppIconIds.DEFAULT, iconSource: importDefault(6582), name: null, isPremium: false };
...
export const getIconById = function getIconById(currentAppIcon) {
  ...
  let obj = { id: _require(6581).FreemiumAppIconIds.DEFAULT, iconSource: importDefault(6582), name: null, isPremium: false };
  ...
  if (null == found) {
    ...
    obj[0] = tmp(6581).FreemiumAppIconIds.DEFAULT;
    obj[1] = importDefault(6582);
