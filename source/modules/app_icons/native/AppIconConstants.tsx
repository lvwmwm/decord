...
// Function ID: 7704
// Name: items
// Dependencies: [7704, 7705, 1236, 7706, 7707, 7708, 7709, 7710, 7711, 7712, 7713, 7714, 7715, 7716, 7717, 7718, 7719, 7720, 7721, 7722, 7723, 7724, 7725, 7726, 7727, 7728, 7729, 2]
...
export const getDefaultIcon = function getDefaultIcon() {
  const obj = { id: require(7704) /* FreemiumAppIconIds */.FreemiumAppIconIds.DEFAULT, iconSource: importDefault(7705), name: null, isPremium: false };
...
export const getIconById = function getIconById(currentAppIcon) {
  ...
  let obj = { id: _require(7704).FreemiumAppIconIds.DEFAULT, iconSource: importDefault(7705), name: null, isPremium: false };
