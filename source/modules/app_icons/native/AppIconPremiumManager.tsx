...
// Dependencies: [5, 1874, 6583, 676, 3, 6584, 5134, 500, 6582, 3835, 698, 2]

// Module 16133 (handleAppStateUpdate)
...
prototype["resetIcon"] = function resetIcon(arg0, c0, ORPHANED) {
  ...
  let obj = _require(6582);
  const setAppIconResult = _require(6582).setAppIcon(DEFAULT, c0);
  _require(6582).setAppIcon(DEFAULT, c0).then(() => {
