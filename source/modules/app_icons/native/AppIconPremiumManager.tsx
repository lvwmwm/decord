...
// Dependencies: [5, 6, 7, 15, 17, 18, 1850, 6562, 653, 3, 6563, 477, 6561, 3811, 675, 5112, 2]

// Module 16098 (_isNativeReflectConstruct)
...
tmp4 = new tmp4();
let result = require("_defineProperties").fileFinishedImporting("modules/app_icons/native/AppIconPremiumManager.tsx");
