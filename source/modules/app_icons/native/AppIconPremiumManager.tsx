...
// Dependencies: [5, 1921, 9252, 673, 3, 9253, 7058, 1234, 13291, 4139, 695, 2]

// Module 17234 (handleAppStateUpdate)
...
prototype["resetIcon"] = function resetIcon(arg0, c0, ORPHANED) {
  ...
  const setAppIconResult = _require(13291).setAppIcon(DEFAULT, c0);
  _require(13291).setAppIcon(DEFAULT, c0).then(() => {
