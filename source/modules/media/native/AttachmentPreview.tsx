...
// Function ID: 9926
// Name: AttachmentIcon
// Dependencies: [19, 17, 21, 4344, 712, 9926, 9927, 9928, 9929, 9930, 9931, 9932, 9933, 9934, 9935, 9936, 9937, 9938, 9939, 4896, 4340, 500, 5307, 1297, 9853, 8915, 2]
// Exports: default

// Module 9925 (AttachmentIcon)
...
let closure_13 = importAllResult.memo((borderRadius) => {
  ...
  if (isMatch) {
    ...
    obj1[0] = items1;
    obj1[1] = obj;
    obj[1] = tmp6(importDefault(5307), obj1);
    let tmp10 = obj;
  } else {
...
export default function AttachmentPreview(height) {
  ...
  if (height.isImage) {
    ...
    if (!isVideo) {
      ...
      if (isVideo) {
        ...
        if (tmp7Result.isIOS()) {
          ...
          obj3[0] = uri;
          obj1[1] = obj3;
          obj[1] = callback(tmp7(8915).VideoComponent, obj1);
    ...
    if (flag) {
      ...
      obj6[0] = videoIcon;
      CirclePlayIcon = CirclePlayIcon(9853).CirclePlayIcon;
