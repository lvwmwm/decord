...
// Function ID: 9766
// Name: AttachmentIcon
// Dependencies: [19, 17, 21, 4255, 712, 9766, 9767, 9768, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777, 9778, 9779, 4807, 4251, 500, 5221, 1297, 9693, 8764, 2]
// Exports: default

// Module 9765 (AttachmentIcon)
...
let closure_13 = importAllResult.memo((borderRadius) => {
  ...
  if (isMatch) {
    ...
    obj1[0] = items1;
    obj1[1] = obj;
    obj[1] = tmp6(importDefault(5221), obj1);
    let tmp10 = obj;
  } else {
...
export default function AttachmentPreview(height) {
  ...
  if (height.isImage) {
    ...
    if (!isVideo) {
      ...
      if (isVideo) {
        ...
        if (tmp7Result.isIOS()) {
          ...
          obj3[0] = uri;
          obj1[1] = obj3;
          obj[1] = callback(tmp7(8764).VideoComponent, obj1);
    ...
    if (flag) {
      ...
      obj6[0] = videoIcon;
      CirclePlayIcon = CirclePlayIcon(9693).CirclePlayIcon;
