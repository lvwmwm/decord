...
// Function ID: 9935
// Name: AttachmentIcon
// Dependencies: [19, 17, 21, 4342, 712, 9935, 9936, 9937, 9938, 9939, 9940, 9941, 9942, 9943, 9944, 9945, 9946, 9947, 9948, 4919, 4338, 500, 5329, 1297, 9867, 8933, 2]
// Exports: default

// Module 9934 (AttachmentIcon)
...
let closure_13 = importAllResult.memo((borderRadius) => {
  ...
  if (isMatch) {
    ...
    obj1[0] = items1;
    obj1[1] = obj;
    obj[1] = tmp6(importDefault(5329), obj1);
    let tmp10 = obj;
  } else {
...
export default function AttachmentPreview(height) {
  ...
  if (height.isImage) {
    ...
    if (!isVideo) {
      ...
      if (isVideo) {
        ...
        if (tmp7Result.isIOS()) {
          ...
          obj3[0] = uri;
          obj1[1] = obj3;
          obj[1] = callback(tmp7(8933).VideoComponent, obj1);
    ...
    if (flag) {
      ...
      obj6[0] = videoIcon;
      CirclePlayIcon = CirclePlayIcon(9867).CirclePlayIcon;
