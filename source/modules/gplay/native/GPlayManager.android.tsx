...
// Dependencies: [109, 5, 19, 17, 6778, 6779, 1218, 3907, 5752, 7228, 5753, 676, 4238, 1876, 21, 3, 709, 7271, 1217, 5755, 3837, 6787, 3916, 4574, 698, 4594, 1236, 7272, 1959, 4460, 6768, 2]

// Module 7270 (handleConnectionStateUpdated)
...
function handleConnectionStateUpdated(connectionState) {
  ...
  if (connectionState === constants.CONNECTED) {
    const userCountry = require(7271) /* getPlanIdForProduct */.loadUserCountry();
    userCountry.finally(() => callback(table[17]).loadSkus());
    const obj2 = require(7271) /* getPlanIdForProduct */;
  }
}
