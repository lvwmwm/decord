...
// Dependencies: [109, 5, 19, 17, 7027, 7028, 1218, 4049, 5965, 7477, 5966, 676, 4362, 1924, 21, 3, 709, 7521, 1217, 5968, 3979, 7036, 4058, 4725, 698, 4745, 1236, 7522, 2009, 4611, 7017, 2]

// Module 7520 (handleConnectionStateUpdated)
import timestampDefault from "timestamp" /* 3 */;
import noopAll from "noop" /* 19 */;
import dispatcherDefault from "dispatcher" /* 709 */;
import getPlanIdForProduct from "getPlanIdForProduct" /* 7521 */;
import closure_4 from "_objectWithoutProperties" /* 109 */;
import closure_5 from "asyncGeneratorStep" /* 5 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import closure_6 from "initialize" /* 7027 */;
...
import { useGPlayAnalyticsStore } from "setGPlayAnalytics" /* 7477 */;
              ...
              case 1:
                if (arg0 === 1) {
                  ...
                  if (purchasingProduct.isPurchasingProduct(purchase.productId)) {
                    ...
                    throwTypeErrorResult = purchase;
                    throwTypeErrorResult = dependencyMap;
                    const IAPProductIds = purchase(5968).IAPProductIds;
                    throwTypeErrorResult = purchase;
                    if (IAPProductIds.includes(purchase.productId)) {
                      ...
                      throwTypeErrorResult = purchase;
                      throwTypeErrorResult = dependencyMap;
                      const obj48 = callback(3979)();
                      callback2 = callback(3979)().subtract(purchase(7036).DRAFT_ORDER_LOOKBACK_DAYS, "days").toISOString();
                      throwTypeErrorResult = purchase;
                      throwTypeErrorResult = dependencyMap;
                      const subtractResult = callback(3979)().subtract(purchase(7036).DRAFT_ORDER_LOOKBACK_DAYS, "days");
                      throwTypeErrorResult = purchase;
                      planIdForGift = purchase(5968).getPlanIdForGift(purchase.productId);
                      ...
                      obj6[0] = purchase(7036).getOrders(obj5);
                      return obj6;
                    } else {
                      throwTypeErrorResult = dependencyMap;
                      throwTypeErrorResult = closure_3;
                      ...
                      if (purchase.purchaseState === constants.PENDING) {
                        ...
                        obj8[0] = purchase(7521).verifyPurchase(purchase, dependencyMap);
                        return obj8;
                      }
                    }
              ...
              case 7:
                if (arg0 === 1) {
                  ...
                  if (null != closure_9) {
                    ...
                    throwTypeErrorResult = purchase;
                    throwTypeErrorResult = dependencyMap;
                    const SubscriptionProductIds = purchase(5968).SubscriptionProductIds;
                    throwTypeErrorResult = purchase;
      ...
      try {
        ...
        if (0 === c4) {
          ...
          if (2 === tmp8) {
            c3 = 1;
            lib = dependencyMap;
            let obj5 = pendingDowngrade(4058);
