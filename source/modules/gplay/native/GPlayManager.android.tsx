...
// Dependencies: [109, 5, 19, 17, 6793, 6794, 1218, 3937, 5767, 7256, 5768, 676, 4268, 1876, 21, 3, 709, 7299, 1217, 5770, 3867, 6802, 3946, 4604, 698, 4624, 1236, 7300, 1959, 4490, 6783, 2]

// Module 7298 (handleConnectionStateUpdated)
      ...
      try {
        ...
        if (0 === c4) {
          ...
          if (2 === tmp8) {
            c3 = 1;
            lib = dependencyMap;
            let obj5 = pendingDowngrade(3946);
