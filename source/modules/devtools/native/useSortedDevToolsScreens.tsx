...
// Dependencies: [32, 6001, 13631, 13633, 589, 2]
// Exports: default, updateSortOrder

// Module 13630 (getSortedDevToolsScreens)
...
function getSortedDevToolsScreens() {
  ...
  const entries = Object.entries(sortedScreenKeys(13631).DevToolsScreens);
...
export const updateSortOrder = function updateSortOrder(closure_0, down) {
  ...
  const result = require(13633) /* updateDevToolsSettings */.updateDevToolsSettings({ sortedScreenKeys: items });
};
