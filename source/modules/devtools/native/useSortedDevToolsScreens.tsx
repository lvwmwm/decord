...
// Dependencies: [32, 6003, 13636, 13638, 589, 2]
// Exports: default, updateSortOrder

// Module 13635 (getSortedDevToolsScreens)
...
function getSortedDevToolsScreens() {
  ...
  const entries = Object.entries(sortedScreenKeys(13636).DevToolsScreens);
...
export const updateSortOrder = function updateSortOrder(closure_0, down) {
  ...
  const result = require(13638) /* updateDevToolsSettings */.updateDevToolsSettings({ sortedScreenKeys: items });
};
