...
// Dependencies: [32, 7118, 13774, 13776, 589, 2]
// Exports: default, updateSortOrder

// Module 13773 (getSortedDevToolsScreens)
...
export const updateSortOrder = function updateSortOrder(closure_0, down) {
  ...
  const result = require(13776) /* updateDevToolsSettings */.updateDevToolsSettings({ sortedScreenKeys: items });
};
