...
// Dependencies: [32, 7072, 13723, 13725, 589, 2]
// Exports: default, updateSortOrder

// Module 13722 (getSortedDevToolsScreens)
...
export const updateSortOrder = function updateSortOrder(closure_0, down) {
  ...
  const result = require(13725) /* updateDevToolsSettings */.updateDevToolsSettings({ sortedScreenKeys: items });
};
