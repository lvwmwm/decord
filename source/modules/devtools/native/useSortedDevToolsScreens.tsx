...
// Dependencies: [32, 7099, 13760, 13762, 589, 2]
// Exports: default, updateSortOrder

// Module 13759 (getSortedDevToolsScreens)
...
export const updateSortOrder = function updateSortOrder(closure_0, down) {
  ...
  const result = require(13762) /* updateDevToolsSettings */.updateDevToolsSettings({ sortedScreenKeys: items });
};
