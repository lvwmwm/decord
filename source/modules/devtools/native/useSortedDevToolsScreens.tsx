...
// Dependencies: [32, 7224, 13905, 13907, 589, 2]
// Exports: default, updateSortOrder

// Module 13904 (getSortedDevToolsScreens)
...
export const updateSortOrder = function updateSortOrder(closure_0, down) {
  ...
  const result = require(13907) /* updateDevToolsSettings */.updateDevToolsSettings({ sortedScreenKeys: items });
};
