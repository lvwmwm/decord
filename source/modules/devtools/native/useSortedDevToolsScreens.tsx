...
// Dependencies: [32, 7179, 13853, 13855, 589, 2]
// Exports: default, updateSortOrder

// Module 13852 (getSortedDevToolsScreens)
...
export const updateSortOrder = function updateSortOrder(closure_0, down) {
  ...
  const result = require(13855) /* updateDevToolsSettings */.updateDevToolsSettings({ sortedScreenKeys: items });
};
