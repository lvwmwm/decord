...
// Module 14576 (DraggableContainer)
...
obj = { ONE_DAY: false, maxWidth: false, useInappropriateConversationBannerForChannel: false, backgroundColor: require("result").colors.BACKGROUND_BRAND, height: DEV_WIDGET_SIZE, width: DEV_WIDGET_SIZE, borderRadius: require("result").radii.xl };
...
let closure_15 = importAllResult.memo(() => {
  const obj = {
    ...
    activeOpacity: 0.5,
    children: callback(arg1(dependencyMap[14]).StaffBadgeIcon, {})
  };
