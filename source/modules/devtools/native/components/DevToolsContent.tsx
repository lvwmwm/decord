...
// Dependencies: [32, 19, 17, 10325, 4199, 1212, 21, 4285, 712, 589, 11104, 13759, 4281, 4827, 4254, 14213, 14971, 1480, 1609, 5688, 5354, 3985, 13757, 2]

// Module 13758 (DevToolsContentSortButtons)
...
function DevToolsContentSortButtons(arg0) {
  ...
  items[1] = start;
  obj[2] = items;
  obj[5] = closure_10(require(14213) /* ArrowSmallUpIcon */.ArrowSmallUpIcon, {});
  const items1 = [closure_10(require(4827) /* PressableBase */.PressableOpacity, obj), ];
  obj = {
    onPress() {
      const result = outer1_0(outer1_2[14]).triggerHapticFeedback(outer1_0(outer1_2[14]).HapticFeedbackTypes.IMPACT_MEDIUM);
      const obj = outer1_0(outer1_2[14]);
  ...
  items2[1] = end;
  obj[2] = items2;
  obj[5] = closure_10(require(14971) /* ArrowSmallDownIcon */.ArrowSmallDownIcon, {});
  items1[1] = closure_10(require(4827) /* PressableBase */.PressableOpacity, obj);
  obj[1] = items1;
...
const memoResult1 = importAllResult.memo(function DevToolsContent(arg0) {
  ...
  importDefault = importDefault(13759)().map((arg0) => {
    let tmp;
    [tmp] = arg0;
  ...
  const arr4 = importDefault(13759)();
  [c2, c3] = callback(arr5.useState(false), 2);
  arr5 = importDefault(13759)();
  ...
  const tmp8 = callback2(_require(5688).TableRowGroup, obj);
  let tmp7Result = tmp8;
  if (!embedded) {
