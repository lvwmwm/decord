...
// Dependencies: [32, 19, 17, 10294, 4169, 1212, 21, 4255, 712, 589, 11072, 13722, 4251, 4797, 4224, 14176, 14933, 1480, 1581, 5634, 5300, 3956, 13720, 2]

// Module 13721 (DevToolsContentSortButtons)
...
function DevToolsContentSortButtons(arg0) {
  ...
  items[1] = start;
  obj[2] = items;
  obj[5] = closure_10(require(14176) /* ArrowSmallUpIcon */.ArrowSmallUpIcon, {});
  const items1 = [closure_10(require(4797) /* PressableBase */.PressableOpacity, obj), ];
  obj = {
    onPress() {
      const result = outer1_0(outer1_2[14]).triggerHapticFeedback(outer1_0(outer1_2[14]).HapticFeedbackTypes.IMPACT_MEDIUM);
      const obj = outer1_0(outer1_2[14]);
  ...
  items2[1] = end;
  obj[2] = items2;
  obj[5] = closure_10(require(14933) /* ArrowSmallDownIcon */.ArrowSmallDownIcon, {});
  items1[1] = closure_10(require(4797) /* PressableBase */.PressableOpacity, obj);
  obj[1] = items1;
...
const memoResult1 = importAllResult.memo(function DevToolsContent(arg0) {
  ...
  importDefault = importDefault(13722)().map((arg0) => {
    let tmp;
    [tmp] = arg0;
  ...
  const arr4 = importDefault(13722)();
  [c2, c3] = callback(arr5.useState(false), 2);
  arr5 = importDefault(13722)();
  ...
  const tmp8 = callback2(_require(5634).TableRowGroup, obj);
  let tmp7Result = tmp8;
  if (!embedded) {
