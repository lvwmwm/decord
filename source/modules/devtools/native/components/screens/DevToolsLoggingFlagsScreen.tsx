...
// Dependencies: [17, 706, 21, 4255, 712, 589, 5634, 5635, 708, 2]
// Exports: default

// Module 13733 (DevToolsLoggingFlagsScreen)
...
export default function DevToolsLoggingFlagsScreen() {
  ...
  const items1 = [
    callback(require(5635) /* TableSwitchRow */.TableSwitchRow, {
  ...
  obj[2] = items1;
  obj[2] = callback2(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj);
