...
// Dependencies: [17, 706, 21, 4344, 712, 589, 5806, 5807, 708, 2]
// Exports: default

// Module 13920 (DevToolsLoggingFlagsScreen)
...
export default function DevToolsLoggingFlagsScreen() {
  ...
  const items1 = [
    callback(require(5807) /* TableSwitchRow */.TableSwitchRow, {
  ...
  obj[2] = items1;
  obj[2] = callback2(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj);
