...
// Dependencies: [17, 706, 21, 4342, 712, 589, 5828, 5829, 708, 2]
// Exports: default

// Module 13927 (DevToolsLoggingFlagsScreen)
...
export default function DevToolsLoggingFlagsScreen() {
  ...
  const items1 = [
    callback(require(5829) /* TableSwitchRow */.TableSwitchRow, {
  ...
  obj[2] = items1;
  obj[2] = callback2(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj);
