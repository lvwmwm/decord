...
// Dependencies: [5, 19, 17, 21, 4255, 712, 7698, 7692, 3956, 7694, 1581, 5634, 5300, 8268, 5307, 2]
// Exports: default

// Module 14906 (showAgeVerificationTestModal)
...
function _showAgeVerificationTestModal() {
  ...
  const tmp = callback(function*() {
    ...
    if (1 === tmp7) {
      ...
      obj2[5] = lib(7694).AgeVerificationModalEntryPoint.DEV_TOOLS_QUICK_ACTIONS;
      callback(7692).showAgeVerification(obj2);
      c3 = 0;
      const obj7 = callback(7692);
    }
    c3 = 0;
    return arg1;
  });
...
export default function DevToolsAgeVerificationScreen() {
  ...
  obj1[2] = callback2(require(8268) /* KeyIcon */.KeyIcon, {});
  obj1[3] = callback2(require(5307) /* TableRowArrow */.TableRowArrow, {});
  const items1 = [callback2(require(5300) /* TableRowInner */.TableRow, obj1), ];
  const obj2 = {
    label: "Launch Age Verification Modal",
    onPress() {
      let obj = callback2(7692);
      obj = { entryPoint: callback(7694).AgeVerificationModalEntryPoint.DEV_TOOLS_QUICK_ACTIONS };
      return obj.showAgeVerificationGetStartedModal(obj);
    },
    icon: null,
    trailing: null
  };
  obj2[2] = callback2(require(8268) /* KeyIcon */.KeyIcon, {});
  obj2[3] = callback2(require(5307) /* TableRowArrow */.TableRowArrow, {});
  items1[1] = callback2(require(5300) /* TableRowInner */.TableRow, obj2);
  obj[2] = items1;
  obj[2] = callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj);
