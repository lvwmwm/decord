...
// Dependencies: [5, 19, 17, 21, 4445, 712, 8619, 8613, 4162, 8615, 1629, 5944, 5551, 7664, 5558, 2]
// Exports: default

// Module 15400 (showAgeVerificationTestModal)
...
function _showAgeVerificationTestModal() {
  ...
  const tmp = callback(function*() {
    ...
    if (1 === tmp7) {
      ...
      obj2[5] = lib(8615).AgeVerificationModalEntryPoint.DEV_TOOLS_QUICK_ACTIONS;
      callback(8613).showAgeVerification(obj2);
      c3 = 0;
      const obj7 = callback(8613);
    }
    c3 = 0;
    return arg1;
  });
...
export default function DevToolsAgeVerificationScreen() {
  ...
  items1[1] = callback2(TableRowInner.TableRow, {
    ...
    onPress() {
      ...
      obj = { entryPoint: callback(8615).AgeVerificationModalEntryPoint.DEV_TOOLS_QUICK_ACTIONS };
