...
// Dependencies: [32, 19, 17, 1381, 21, 4344, 712, 1377, 15007, 5807, 5806, 9764, 5413, 1374, 4303, 5420, 15008, 6033, 4340, 8761, 5268, 1628, 10867, 589, 14322, 14323, 7786, 2]
// Exports: default
...
function DismissableContentsEmpty() {
  ...
  obj[0] = obj;
  const items = [callback2(require(4340) /* Text */.Text, obj), callback2(require(8761) /* getSearchEmptySource */.SearchEmpty, {})];
  obj[1] = items;
...
let closure_11 = importAllResult.memo((content) => {
  ...
  return callback2(require(5807) /* TableSwitchRow */.TableSwitchRow, { start, end, onValueChange, value, label });
});
let closure_12 = importAllResult.memo((arg0) => {
  ...
  obj1[0] = require(9764) /* handleDCShownToUser */.overrideDismissibleContentFramework;
  obj1[1] = dailyCapOverridden;
  const items = [callback2(require(5807) /* TableSwitchRow */.TableSwitchRow, obj1), , ];
  ...
  obj2[0] = require(9764) /* handleDCShownToUser */.overrideNewUserMinAgeRequired;
  obj2[1] = newUserMinAgeRequiredOverridden;
  items[1] = callback2(require(5807) /* TableSwitchRow */.TableSwitchRow, obj2);
  items[2] = callback2(require(5807) /* TableSwitchRow */.TableSwitchRow, { onValueChange: onForceBountiesSwipeUpNuxChange, value: forceBountiesSwipeUpNux, label: "Force bounties swipe-up NUX", subLabel: "When enabled, treat bounties swipe-up NUX as shown so scroll affordances always appear. Reopen the bounties modal after toggling." });
  obj[2] = items;
  obj[1] = callback3(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj);
  ...
  obj5[2] = callback2(require(4303) /* TrashIcon */.TrashIcon, {});
  obj5[3] = callback2(require(5420) /* TableRowArrow */.TableRowArrow, {});
  const items2 = [callback2(require(5413) /* TableRowInner */.TableRow, obj5), , ];
  ...
  obj6[2] = callback2(require(4303) /* TrashIcon */.TrashIcon, {});
  obj6[3] = callback2(require(5420) /* TableRowArrow */.TableRowArrow, {});
  items2[1] = callback2(require(5413) /* TableRowInner */.TableRow, obj6);
  ...
  obj7[3] = callback2(require(5420) /* TableRowArrow */.TableRowArrow, {});
  items2[2] = callback2(require(5413) /* TableRowInner */.TableRow, obj7);
  obj4[2] = items2;
  obj3[1] = callback3(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj4);
  items1[1] = callback2(View, obj3);
  items1[2] = callback2(View, { style: tmp.search, children: callback2(require(6033) /* SearchField */.SearchField, { size: "md", defaultValue: initialSearchQuery, onChange: onSearchChange }) });
  items1[3] = callback2(require(4340) /* Text */.Text, { style: tmp.sectionHeader, variant: "text-sm/semibold", color: "text-default", children: "Dismissible Contents" });
  obj[0] = items1;
