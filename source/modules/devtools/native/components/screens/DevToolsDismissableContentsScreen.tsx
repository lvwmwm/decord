...
// Dependencies: [32, 19, 17, 1362, 21, 4255, 712, 1358, 14813, 5635, 5634, 9605, 5300, 1355, 4214, 5307, 14814, 5886, 4251, 8610, 5182, 1581, 10675, 589, 14134, 14135, 7638, 2]
// Exports: default

// Module 14812 (DismissableContentsEmpty)
...
function DismissableContentsEmpty() {
  ...
  obj[0] = obj;
  const items = [callback2(require(4251) /* Text */.Text, obj), callback2(require(8610) /* getSearchEmptySource */.SearchEmpty, {})];
  obj[1] = items;
...
let closure_11 = importAllResult.memo((content) => {
  ...
  ({ start, end } = content);
  ({ isDismissed, handleToggleDismissState } = importDefault(14813)(require(1358) /* DismissibleContent */.DismissibleContent[label]));
  return callback2(require(5635) /* TableSwitchRow */.TableSwitchRow, { start, end, onValueChange, value, label });
});
let closure_12 = importAllResult.memo((arg0) => {
  ...
  obj1[0] = require(9605) /* handleDCShownToUser */.overrideDismissibleContentFramework;
  obj1[1] = dailyCapOverridden;
  const items = [callback2(require(5635) /* TableSwitchRow */.TableSwitchRow, obj1), , ];
  ...
  obj2[0] = require(9605) /* handleDCShownToUser */.overrideNewUserMinAgeRequired;
  obj2[1] = newUserMinAgeRequiredOverridden;
  items[1] = callback2(require(5635) /* TableSwitchRow */.TableSwitchRow, obj2);
  items[2] = callback2(require(5635) /* TableSwitchRow */.TableSwitchRow, { onValueChange: onForceBountiesSwipeUpNuxChange, value: forceBountiesSwipeUpNux, label: "Force bounties swipe-up NUX", subLabel: "When enabled, treat bounties swipe-up NUX as shown so scroll affordances always appear. Reopen the bounties modal after toggling." });
  obj[2] = items;
  obj[1] = callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj);
  ...
  obj5[3] = callback2(require(5307) /* TableRowArrow */.TableRowArrow, {});
  const items2 = [callback2(require(5300) /* TableRowInner */.TableRow, obj5), , ];
  ...
  obj6[3] = callback2(require(5307) /* TableRowArrow */.TableRowArrow, {});
  items2[1] = callback2(require(5300) /* TableRowInner */.TableRow, obj6);
  ...
  obj7[2] = callback2(require(14814) /* DoubleCheckmarkIcon */.DoubleCheckmarkIcon, {});
  obj7[3] = callback2(require(5307) /* TableRowArrow */.TableRowArrow, {});
  items2[2] = callback2(require(5300) /* TableRowInner */.TableRow, obj7);
  obj4[2] = items2;
  obj3[1] = callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj4);
  items1[1] = callback2(View, obj3);
  items1[2] = callback2(View, { style: tmp.search, children: callback2(require(5886) /* SearchField */.SearchField, { size: "md", defaultValue: initialSearchQuery, onChange: onSearchChange }) });
