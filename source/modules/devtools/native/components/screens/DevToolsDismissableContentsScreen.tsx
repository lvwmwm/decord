...
function DismissableContentsEmpty() {
  ...
  obj[0] = obj;
  const items = [callback2(require(4338) /* Text */.Text, obj), callback2(require(8765) /* getSearchEmptySource */.SearchEmpty, {})];
  obj[1] = items;
...
let closure_12 = importAllResult.memo((arg0) => {
  ...
  obj1[0] = require(9768) /* handleDCShownToUser */.overrideDismissibleContentFramework;
  obj1[1] = dailyCapOverridden;
  const items = [callback2(require(5808) /* TableSwitchRow */.TableSwitchRow, obj1), , ];
  ...
  obj2[0] = require(9768) /* handleDCShownToUser */.overrideNewUserMinAgeRequired;
  obj2[1] = newUserMinAgeRequiredOverridden;
  items[1] = callback2(require(5808) /* TableSwitchRow */.TableSwitchRow, obj2);
  items[2] = callback2(require(5808) /* TableSwitchRow */.TableSwitchRow, { onValueChange: onForceBountiesSwipeUpNuxChange, value: forceBountiesSwipeUpNux, label: "Force bounties swipe-up NUX", subLabel: "When enabled, treat bounties swipe-up NUX as shown so scroll affordances always appear. Reopen the bounties modal after toggling." });
  obj[2] = items;
  obj[1] = callback3(require(5807) /* TableRowGroupTitle */.TableRowGroup, obj);
  ...
  obj5[3] = callback2(require(5421) /* TableRowArrow */.TableRowArrow, {});
  const items2 = [callback2(require(5414) /* TableRowInner */.TableRow, obj5), , ];
  ...
  obj6[3] = callback2(require(5421) /* TableRowArrow */.TableRowArrow, {});
  ...
  obj4[2] = items2;
  obj3[1] = callback3(require(5807) /* TableRowGroupTitle */.TableRowGroup, obj4);
  items1[1] = callback2(View, obj3);
  items1[2] = callback2(View, { style: tmp.search, children: callback2(require(6035) /* SearchField */.SearchField, { size: "md", defaultValue: initialSearchQuery, onChange: onSearchChange }) });
