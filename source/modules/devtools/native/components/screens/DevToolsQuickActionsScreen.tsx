...
// Dependencies: [32, 5, 19, 17, 4295, 4994, 1923, 1994, 1302, 1304, 1922, 7179, 676, 12063, 1924, 10344, 1305, 21, 4303, 712, 12104, 709, 12062, 8704, 13720, 1374, 1377, 4125, 4509, 14997, 2007, 10389, 14036, 14038, 12966, 4021, 14758, 1628, 589, 3993, 15013, 5767, 5768, 13855, 1297, 14511, 1363, 14571, 15014, 9677, 1236, 5374, 14617, 5381, 8491, 15015, 8501, 1208, 1917, 500, 2]
// Exports: default

// Module 14996 (handleNewUserOnboarding)
import module_14036 from "module_14036";
...
function handleNewUserOnboarding() {
  require(12104) /* setNewUser */.setNewUser(NewUserTypes.ORGANIC_REGISTERED);
  const obj = require(12104) /* setNewUser */;
  importDefault(709).wait(require(12062) /* _startContactSyncForDiscoverability */.startOnboarding);
}
function handleThemeChange(arg0) {
  importDefault(8704).updateTheme(arg0 ? ThemeTypes.LIGHT : ThemeTypes.DARK);
}
...
function handleLaunchWelcomeReset() {
  ...
  const result1 = require(4125) /* UNSAFE_isDismissibleContentDismissed */.UNSAFE_markDismissibleContentAsDismissed(require(1377) /* DismissibleContent */.DismissibleContent.SEEN_OLD_DESIGN);
}
function showVibingWumpus() {
  ...
  obj.pushLazy(require(2007) /* asyncRequireImpl */(10389, dependencyMap.paths), obj, VIBING_WUMPUS_MODAL_KEY);
}
...
function launchTotpSetupSuccess() {
  ...
  arr = arr.pop();
  const items = [require(2007) /* asyncRequireImpl */(14036, dependencyMap.paths), require(2007) /* asyncRequireImpl */(14038, dependencyMap.paths)];
...
function launchMFA() {
  let arr = importDefault(4509);
  arr = arr.pop();
  require(2007) /* asyncRequireImpl */(14997, dependencyMap.paths).then((openMFAModal) => {
