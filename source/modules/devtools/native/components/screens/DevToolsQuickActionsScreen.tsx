...
// Dependencies: [32, 5, 19, 17, 4334, 5035, 1923, 1994, 1302, 1304, 1922, 7223, 676, 12122, 1924, 10297, 1305, 21, 4342, 712, 12163, 709, 12121, 8747, 13778, 1374, 1377, 4164, 4550, 15064, 2007, 10344, 14102, 14104, 13025, 4062, 14825, 1628, 589, 4034, 15080, 5807, 5808, 13916, 1297, 14577, 1363, 14637, 15081, 9721, 1236, 5414, 14684, 5421, 8534, 15082, 8544, 1208, 1917, 500, 2]
// Exports: default

// Module 15063 (handleNewUserOnboarding)
import module_14102 from "module_14102";
...
function handleNewUserOnboarding() {
  require(12163) /* setNewUser */.setNewUser(NewUserTypes.ORGANIC_REGISTERED);
  const obj = require(12163) /* setNewUser */;
  importDefault(709).wait(require(12121) /* _startContactSyncForDiscoverability */.startOnboarding);
}
...
function launchTotpSetupSuccess() {
  ...
  arr = arr.pop();
  const items = [require(2007) /* asyncRequireImpl */(14102, dependencyMap.paths), require(2007) /* asyncRequireImpl */(14104, dependencyMap.paths)];
...
function launchMFA() {
  let arr = importDefault(4550);
  arr = arr.pop();
  require(2007) /* asyncRequireImpl */(15064, dependencyMap.paths).then((openMFAModal) => {
