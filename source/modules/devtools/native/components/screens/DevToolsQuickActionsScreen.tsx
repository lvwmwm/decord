...
// Dependencies: [32, 5, 19, 17, 4662, 4495, 1923, 1994, 1302, 1304, 1922, 7471, 676, 11878, 1924, 10569, 1305, 21, 4661, 712, 11925, 709, 11877, 9365, 13813, 1374, 1377, 4196, 5260, 15118, 2007, 10615, 14138, 14140, 13247, 4094, 14870, 1629, 589, 4066, 15134, 6286, 7178, 13951, 1297, 14613, 1363, 14674, 15135, 9925, 1236, 6291, 14729, 6297, 8595, 15136, 8605, 1208, 1917, 500, 2]
// Exports: default

// Module 15117 (handleNewUserOnboarding)
import module_14138 from "module_14138";
...
function handleNewUserOnboarding() {
  require(11925) /* setNewUser */.setNewUser(NewUserTypes.ORGANIC_REGISTERED);
  const obj = require(11925) /* setNewUser */;
  importDefault(709).wait(require(11877) /* _startContactSyncForDiscoverability */.startOnboarding);
}
function handleThemeChange(arg0) {
  importDefault(9365).updateTheme(arg0 ? ThemeTypes.LIGHT : ThemeTypes.DARK);
}
function handleReducedMotionChange(arg0) {
  ...
  const result = require(13813) /* setFontSize */.setPrefersReducedMotion(str);
}
function handleLaunchWelcomeReset() {
  ...
  const result1 = require(4196) /* UNSAFE_isDismissibleContentDismissed */.UNSAFE_markDismissibleContentAsDismissed(require(1377) /* DismissibleContent */.DismissibleContent.SEEN_OLD_DESIGN);
}
function showVibingWumpus() {
  ...
  obj.pushLazy(require(2007) /* asyncRequireImpl */(10615, dependencyMap.paths), obj, VIBING_WUMPUS_MODAL_KEY);
}
...
function launchTotpSetupSuccess() {
  ...
  arr = arr.pop();
  const items = [require(2007) /* asyncRequireImpl */(14138, dependencyMap.paths), require(2007) /* asyncRequireImpl */(14140, dependencyMap.paths)];
...
function launchMFA() {
  let arr = importDefault(5260);
  arr = arr.pop();
  require(2007) /* asyncRequireImpl */(15118, dependencyMap.paths).then((openMFAModal) => {
