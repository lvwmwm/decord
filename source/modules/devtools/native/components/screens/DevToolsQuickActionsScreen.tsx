...
// Dependencies: [32, 5, 19, 17, 4294, 4992, 1904, 1975, 1302, 1304, 1903, 7118, 676, 11993, 1905, 10272, 1305, 21, 4302, 712, 12034, 709, 11992, 8638, 13640, 1355, 1358, 4117, 4507, 14915, 1988, 10317, 13956, 13958, 12890, 4002, 14676, 1609, 589, 3974, 14931, 5707, 5708, 13776, 1297, 14431, 4147, 14491, 14932, 9607, 1236, 5373, 14535, 5380, 8425, 14933, 8435, 1208, 1898, 500, 2]
// Exports: default

// Module 14914 (handleNewUserOnboarding)
...
function handleNewUserOnboarding() {
  require(12034) /* setNewUser */.setNewUser(NewUserTypes.ORGANIC_REGISTERED);
  const obj = require(12034) /* setNewUser */;
  importDefault(709).wait(require(11992) /* _startContactSyncForDiscoverability */.startOnboarding);
}
function handleThemeChange(arg0) {
  importDefault(8638).updateTheme(arg0 ? ThemeTypes.LIGHT : ThemeTypes.DARK);
}
function handleReducedMotionChange(arg0) {
  ...
  const result = require(13640) /* setFontSize */.setPrefersReducedMotion(str);
}
function handleLaunchWelcomeReset() {
  ...
  const result1 = require(4117) /* UNSAFE_isDismissibleContentDismissed */.UNSAFE_markDismissibleContentAsDismissed(require(1358) /* DismissibleContent */.DismissibleContent.SEEN_OLD_DESIGN);
}
function showVibingWumpus() {
  ...
  obj.pushLazy(require(1988) /* asyncRequireImpl */(10317, dependencyMap.paths), obj, VIBING_WUMPUS_MODAL_KEY);
}
...
function launchTotpSetupSuccess() {
  ...
  arr = arr.pop();
  const items = [require(1988) /* asyncRequireImpl */(13956, dependencyMap.paths), require(1988) /* asyncRequireImpl */(13958, dependencyMap.paths)];
...
function launchMFA() {
  let arr = importDefault(4507);
  arr = arr.pop();
  require(1988) /* asyncRequireImpl */(14915, dependencyMap.paths).then((openMFAModal) => {
