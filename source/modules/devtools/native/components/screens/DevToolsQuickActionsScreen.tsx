...
// Dependencies: [32, 5, 19, 17, 4277, 4975, 1904, 1975, 1302, 1304, 1903, 7099, 676, 11978, 1905, 10256, 1305, 21, 4285, 712, 12019, 709, 11977, 8621, 13626, 1355, 1358, 4100, 4490, 14899, 1988, 10301, 13942, 13944, 12875, 3985, 14660, 1609, 589, 3957, 14915, 5688, 5689, 13762, 1297, 14415, 4130, 14475, 14916, 9591, 1236, 5354, 14519, 5361, 8408, 14917, 8418, 1208, 1898, 500, 2]
// Exports: default

// Module 14898 (handleNewUserOnboarding)
import module_13942 from "module_13942";
...
function handleNewUserOnboarding() {
  require(12019) /* setNewUser */.setNewUser(NewUserTypes.ORGANIC_REGISTERED);
  const obj = require(12019) /* setNewUser */;
  importDefault(709).wait(require(11977) /* _startContactSyncForDiscoverability */.startOnboarding);
}
function handleThemeChange(arg0) {
  importDefault(8621).updateTheme(arg0 ? ThemeTypes.LIGHT : ThemeTypes.DARK);
}
function handleReducedMotionChange(arg0) {
  ...
  const result = require(13626) /* setFontSize */.setPrefersReducedMotion(str);
}
function handleLaunchWelcomeReset() {
  ...
  const result1 = require(4100) /* UNSAFE_isDismissibleContentDismissed */.UNSAFE_markDismissibleContentAsDismissed(require(1358) /* DismissibleContent */.DismissibleContent.SEEN_OLD_DESIGN);
}
function showVibingWumpus() {
  ...
  obj.pushLazy(require(1988) /* asyncRequireImpl */(10301, dependencyMap.paths), obj, VIBING_WUMPUS_MODAL_KEY);
}
...
function launchTotpSetupSuccess() {
  ...
  arr = arr.pop();
  const items = [require(1988) /* asyncRequireImpl */(13942, dependencyMap.paths), require(1988) /* asyncRequireImpl */(13944, dependencyMap.paths)];
...
function launchMFA() {
  let arr = importDefault(4490);
  arr = arr.pop();
  require(1988) /* asyncRequireImpl */(14899, dependencyMap.paths).then((openMFAModal) => {
