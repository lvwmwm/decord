...
// Dependencies: [19, 17, 5092, 1376, 3827, 1372, 1862, 1931, 1874, 676, 21, 4189, 712, 3890, 7626, 10256, 10258, 1355, 1358, 10332, 4856, 11, 1581, 5554, 5220, 13639, 5227, 1297, 2]
// Exports: default

// Module 14819 (handleResetInAppNotificationExpandNux)
...
function handleResetInAppNotificationExpandNux() {
  ...
  require(10332) /* MAX_TIMES_SHOWN */.resetExpandNUXState();
}
    ...
    if (null != currentUser) {
      if ("media-only" === arg0) {
        ...
        if (null != name) {
          ...
          obj3[0] = tmp20;
          obj3[1] = require(4856) /* StickerFormat */.StickerFormat.APNG;
        }
        const items1 = [obj3];
        obj1[2] = items1;
        tmp20 = c18;
...
function buildReactionNotification(arg0, items) {
  ...
  if (null == tmp3) {
    ...
    obj[0] = message.id;
    obj[1] = require(10256) /* extractMetadataFromNotification */.getNotificationDuration(InAppNotificationTypes.REACTION);
    obj[2] = function onDismiss() {
      return callback(table[16]).clearNotification();
    };
    const obj2 = require(10256) /* extractMetadataFromNotification */;
    const tmp12 = InAppNotificationTypes;
    obj[3] = require(10256) /* extractMetadataFromNotification */.generateInAppNotificationId();
...
let items2 = [
  {
    ...
    build: function buildMessageNotification(arg0) {
      ...
      if (null == tmp) {
        ...
        obj = { key: null, duration: null, onDismiss: null, inAppNotificationId: null };
        obj[0] = message.id;
        obj[1] = require(10256) /* extractMetadataFromNotification */.getNotificationDuration(InAppNotificationTypes.MESSAGE);
        obj[2] = function onDismiss() {
          return callback(table[16]).clearNotification();
        };
        const obj2 = require(10256) /* extractMetadataFromNotification */;
  ...
  },
  {
    ...
    build: function buildMessageReminderNotification(arg0) {
      ...
      if (null == tmp) {
        ...
        obj1[0] = message.id;
        obj1[1] = require(10256) /* extractMetadataFromNotification */.getNotificationDuration(InAppNotificationTypes.MESSAGE_REMINDER);
        obj1[2] = function onDismiss() {
          return callback(table[16]).clearNotification();
        };
        const obj5 = require(10256) /* extractMetadataFromNotification */;
        obj1[3] = require(10256) /* extractMetadataFromNotification */.generateInAppNotificationId();
...
const items3 = [
  {
    ...
    build: function buildMessageFailedToSendNotification() {
      ...
      if (null == obj) {
        ...
        obj1[1] = require(10256) /* extractMetadataFromNotification */.getNotificationDuration(InAppNotificationTypes.MESSAGE_FAILED_TO_SEND);
        obj1[2] = function onDismiss() {
          return callback(table[16]).clearNotification();
        };
        const obj8 = require(10256) /* extractMetadataFromNotification */;
        obj1[3] = require(10256) /* extractMetadataFromNotification */.generateInAppNotificationId();
        const merged = Object.assign(obj1);
        return obj;
      }
    ...
    build: function buildForumThreadCreatedNotification() {
      ...
      if (null != tmp) {
        if (null != currentUser) {
          ...
          obj2[0] = tmp11.id;
          const obj5 = importDefault(11);
          obj2[1] = require(10256) /* extractMetadataFromNotification */.getNotificationDuration(InAppNotificationTypes.FORUM_THREAD_CREATED);
          obj2[2] = function onDismiss() {
            return callback(table[16]).clearNotification();
          };
          const obj8 = require(10256) /* extractMetadataFromNotification */;
          obj2[3] = require(10256) /* extractMetadataFromNotification */.generateInAppNotificationId();
  ...
  },
  {
    ...
    build: function buildBugReporterNotification() {
      ...
      obj[1] = require(10256) /* extractMetadataFromNotification */.getNotificationDuration(InAppNotificationTypes.BUG_REPORTER);
      obj[2] = function onDismiss() {
        return callback(table[16]).clearNotification();
      };
      const obj3 = require(10256) /* extractMetadataFromNotification */;
      obj[3] = require(10256) /* extractMetadataFromNotification */.generateInAppNotificationId();
      const merged = Object.assign(obj);
      return obj;
    }
  },
  {
    ...
    build: function buildAlertNotification() {
      ...
      if (null != tmp) {
        ...
        obj = { key: null, duration: null, onDismiss: null, inAppNotificationId: null };
        obj[0] = tmp.guild.id;
        obj[1] = require(10256) /* extractMetadataFromNotification */.getNotificationDuration(InAppNotificationTypes.ALERT);
        obj[2] = function onDismiss() {
          return callback(table[16]).clearNotification();
        };
        const obj3 = require(10256) /* extractMetadataFromNotification */;
  ...
  },
  {
    ...
    build: function buildMessageRequestNotification() {
      ...
      if (null != currentUser) {
        ...
        obj1[1] = require(10256) /* extractMetadataFromNotification */.getNotificationDuration(InAppNotificationTypes.MESSAGE_REQUEST);
        obj1[2] = function onDismiss() {
          return callback(table[16]).clearNotification();
        };
        const obj5 = require(10256) /* extractMetadataFromNotification */;
        ...
        const merged = Object.assign(obj1);
        tmp5 = obj;
        const obj6 = require(10256) /* extractMetadataFromNotification */;
      }
      return tmp5;
    }
  },
  {
    ...
    build: function buildRestrictedHoursWarningNotification() {
      ...
      obj[1] = require(10256) /* extractMetadataFromNotification */.getNotificationDuration(InAppNotificationTypes.RESTRICTED_HOURS_WARNING);
      obj[2] = function onDismiss() {
        return callback(table[16]).clearNotification();
      };
      const obj3 = require(10256) /* extractMetadataFromNotification */;
  ...
  },
  {
    ...
    build: function buildRestrictedScheduleUpdatedNotification() {
      ...
      obj[1] = require(10256) /* extractMetadataFromNotification */.getNotificationDuration(InAppNotificationTypes.RESTRICTED_SCHEDULE_UPDATED);
      obj[2] = function onDismiss() {
        return callback(table[16]).clearNotification();
      };
      const obj3 = require(10256) /* extractMetadataFromNotification */;
...
export default function DevToolsInAppNotificationTestingScreen() {
  ...
  obj[3] = callback(_require(13639).BeakerIcon, {});
  obj[4] = callback(_require(5227).TableRowArrow, {});
  obj[2] = callback(_require(5220).TableRow, obj);
  const items1 = [callback(_require(5554).TableRowGroup, obj), , , ];
  ...
  items1[3] = callback(_require(5554).TableRowGroup, obj2);
  obj[2] = items1;
