...
// Dependencies: [5, 32, 19, 17, 8101, 7041, 1340, 1372, 1960, 1903, 4284, 1905, 21, 709, 647, 530, 3985, 5354, 5361, 5688, 5683, 6838, 1297, 712, 7245, 4285, 6832, 4253, 14922, 1988, 5689, 14925, 7342, 11106, 4490, 14926, 14929, 14933, 14935, 14938, 2]
// Exports: default

// Module 14921 (describeServerError)
...
function PremiumToggles() {
  ...
  return callback2(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj);
}
function ForceMockIAP() {
  let obj = require(647) /* defaultAreStatesEqual */;
  const items = [getUserAgnosticState];
  const stateFromStores = obj.useStateFromStores(items, () => getUserAgnosticState.get("force_mock_iap"));
  let result = require(7342) /* serializePurchaseResponse */.shouldMockIAPForceEnable();
  ...
  obj = { title: "iOS IAP Mock", hasIcons: false, children: tmp3(require(5689) /* TableSwitchRow */.TableSwitchRow, obj) };
  obj[2] = tmp4;
  obj[3] = result;
  ...
  return closure_17(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj);
}
function PaymentFlowTest() {
  ...
  obj[2] = callback2(require(5361) /* TableRowArrow */.TableRowArrow, {});
  obj[2] = callback2(require(5354) /* TableRowInner */.TableRow, obj);
  return callback2(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj);
}
function Orbs() {
...
function GuildTagBadges() {
  ...
  obj[3] = callback2(require(5361) /* TableRowArrow */.TableRowArrow, {});
  obj[2] = callback2(require(5354) /* TableRowInner */.TableRow, obj);
  return callback2(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj);
}
