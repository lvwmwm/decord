// Module ID: 14818
// Function ID: 14819
// Dependencies: [19, 17, 21, 4189, 712, 1480, 1581, 5554, 13631, 5220, 13628, 2]
...
const memoResult = require("noop").memo(function DevToolsPerformanceTestingScreen() {
  ...
  const entries = Object.entries(_require(13631).PerformanceTestingScreens);
  ...
  obj[2] = jsx(_require(5554).TableRowGroup, { hasIcons: true, children: null });
