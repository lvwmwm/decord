// Module ID: 14841
// Function ID: 14842
// Dependencies: [19, 17, 21, 4193, 712, 1480, 1581, 5558, 13655, 5224, 13652, 2]
...
const memoResult = require("noop").memo(function DevToolsPerformanceTestingScreen() {
  ...
  const entries = Object.entries(_require(13655).PerformanceTestingScreens);
  ...
  obj[2] = jsx(_require(5558).TableRowGroup, { hasIcons: true, children: null });
