...
// Dependencies: [19, 21, 5634, 5300, 14926, 2]
// Exports: default

// Module 14930 (BenchmarkResultsList)
import "noop";
...
export default function BenchmarkResultsList(results) {
  ...
  if (0 !== results.length) {
    ...
    obj[3] = tmp;
    items[1] = callback(require(5300) /* TableRowInner */.TableRow, obj);
    obj[2] = items;
    tmp2 = callback2(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj);
  }
  return tmp2;
};
