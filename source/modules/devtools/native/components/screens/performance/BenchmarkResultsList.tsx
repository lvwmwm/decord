...
// Dependencies: [19, 21, 5828, 5435, 15134, 2]
// Exports: default

// Module 15138 (BenchmarkResultsList)
import "noop";
...
export default function BenchmarkResultsList(results) {
  ...
  if (0 !== results.length) {
    ...
    obj[3] = tmp;
    items[1] = callback(require(5435) /* TableRowInner */.TableRow, obj);
    obj[2] = items;
    tmp2 = callback2(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj);
  }
  return tmp2;
};
