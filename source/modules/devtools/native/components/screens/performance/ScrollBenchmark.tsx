...
// Dependencies: [19, 21, 15136, 5435, 2]
// Exports: default

// Module 15139 (ScrollBenchmark)
import "noop";
...
export default function ScrollBenchmark(subLabel) {
  ...
  const tmp = importDefault(15136)(subLabel.onResult);
  ...
  obj[4] = start;
  return jsx(require(5435) /* TableRowInner */.TableRow, { label: str2, subLabel: str, variant: null, arrow: true, onPress: null });
};
