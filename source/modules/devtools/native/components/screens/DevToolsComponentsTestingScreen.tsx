...
// Function ID: 15116
// Name: Select
// Dependencies: [32, 19, 17, 1979, 21, 4342, 712, 4588, 1954, 8285, 5437, 4338, 15116, 15119, 4777, 4775, 15120, 709, 2]
// Exports: default
...
function Select(children) {
  ...
  obj.type = type;
  obj.id = String(type);
  let obj1 = _require(8285);
  let state = obj1.useComponentState(obj).state;
  obj = { style: { gap: 8 }, children: null };
  const items = [callback(_require(4338).Text, { variant: "heading-lg/medium", children: children.title }), , , ];
  if (obj.type === _require(1954).ComponentType.STRING_SELECT) {
    obj = {};
    const merged1 = Object.assign(obj);
    let tmp7Result = tmp7(importDefault(15116), obj);
    const tmp15 = importDefault(15116);
  } else {
    obj1 = {};
    const merged2 = Object.assign(obj);
    obj1.type = obj.type;
    tmp7Result = tmp7(importDefault(15119), obj1);
    const tmp9 = importDefault(15119);
  }
  items[1] = tmp7Result;
  type = undefined;
  if (state != null) {
  ...
  if (type === obj.type) {
    ...
    state[1] = items1;
    tmp6(tmp4(4338).Text, state);
  } else {
    items[2] = tmp7(tmp4(4338).Text, { variant: "text-md/normal", children: "Nothing selected" });
    let str3 = "off";
    if (tmp2) {
      str3 = "on";
    }
    ...
    obj[1] = items;
    return tmp6(_require(5437).Card, obj);
  }
}
...
export default function DevToolsComponentsTestingScreen() {
  ...
  const items = [callback(require(4338) /* Text */.Text, { variant: "text-md/normal", children: "Test screen for embedding native components in RN" }), , ];
  ...
  const items1 = [callback(importDefault(15120), {}), , , , , ];
  const obj2 = {};
  const tmp2 = importDefault(15120);
  ...
  const obj4 = { title: "User Select", type: require(1954) /* PermissionOverwriteType */.ComponentType.USER_SELECT };
  items1[3] = callback(Select, { title: "Role Select", type: require(1954) /* PermissionOverwriteType */.ComponentType.ROLE_SELECT });
  const obj5 = { title: "Role Select", type: require(1954) /* PermissionOverwriteType */.ComponentType.ROLE_SELECT };
  items1[4] = callback(Select, { title: "Mentionable Select", type: require(1954) /* PermissionOverwriteType */.ComponentType.MENTIONABLE_SELECT });
  ...
  obj[1] = items1;
  items[1] = callback2(require(8285) /* isInteractionComponent */.ComponentStateContextProvider, obj);
  items[2] = callback(require(4777) /* Button */.Button, {
    onPress() {
  ...
  obj[1] = items;
  obj[2] = callback2(require(4775) /* Stack */.Stack, obj);
