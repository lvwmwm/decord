...
// Function ID: 14962
// Name: Select
// Dependencies: [32, 19, 17, 1960, 21, 4302, 712, 4523, 1935, 8156, 5375, 4298, 14962, 14965, 4712, 4710, 14966, 709, 2]
// Exports: default
...
function Select(children) {
  ...
  obj.type = type;
  obj.id = String(type);
  let obj1 = _require(8156);
  let state = obj1.useComponentState(obj).state;
  obj = { style: { gap: 8 }, children: null };
  const items = [callback(_require(4298).Text, { variant: "heading-lg/medium", children: children.title }), , , ];
  if (obj.type === _require(1935).ComponentType.STRING_SELECT) {
    obj = {};
    const merged1 = Object.assign(obj);
    let tmp7Result = tmp7(importDefault(14962), obj);
    const tmp15 = importDefault(14962);
  } else {
    obj1 = {};
    const merged2 = Object.assign(obj);
    obj1.type = obj.type;
    tmp7Result = tmp7(importDefault(14965), obj1);
    const tmp9 = importDefault(14965);
  }
  items[1] = tmp7Result;
  type = undefined;
  if (state != null) {
  ...
  if (type === obj.type) {
    ...
    obj[1] = items;
    return tmp6(_require(5375).Card, obj);
  }
}
...
export default function DevToolsComponentsTestingScreen() {
  ...
  const items = [callback(require(4298) /* Text */.Text, { variant: "text-md/normal", children: "Test screen for embedding native components in RN" }), , ];
  ...
  const items1 = [callback(importDefault(14966), {}), , , , , ];
  const obj2 = {};
  const tmp2 = importDefault(14966);
  ...
  obj[1] = items1;
  items[1] = callback2(require(8156) /* isInteractionComponent */.ComponentStateContextProvider, obj);
  items[2] = callback(require(4712) /* Button */.Button, {
    onPress() {
