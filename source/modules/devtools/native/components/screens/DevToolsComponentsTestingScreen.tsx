...
// Function ID: 14946
// Name: Select
// Dependencies: [32, 19, 17, 1960, 21, 4285, 712, 4506, 1935, 8139, 5356, 4281, 14946, 14949, 4695, 4693, 14950, 709, 2]
// Exports: default
...
function Select(children) {
  ...
  if (obj.type === _require(1935).ComponentType.STRING_SELECT) {
    ...
    let tmp7Result = tmp7(importDefault(14946), obj);
    const tmp15 = importDefault(14946);
  } else {
    obj1 = {};
    const merged2 = Object.assign(obj);
    obj1.type = obj.type;
    tmp7Result = tmp7(importDefault(14949), obj1);
    const tmp9 = importDefault(14949);
  }
  items[1] = tmp7Result;
  type = undefined;
  if (state != null) {
  ...
  if (type === obj.type) {
    ...
    state[1] = items1;
    tmp6(tmp4(4281).Text, state);
  } else {
    items[2] = tmp7(tmp4(4281).Text, { variant: "text-md/normal", children: "Nothing selected" });
    let str3 = "off";
    if (tmp2) {
      str3 = "on";
    }
    ...
    obj[1] = items;
    return tmp6(_require(5356).Card, obj);
  }
}
...
export default function DevToolsComponentsTestingScreen() {
  ...
  const items1 = [callback(importDefault(14950), {}), , , , , ];
  const obj2 = {};
  const tmp2 = importDefault(14950);
  ...
  obj[1] = items1;
  items[1] = callback2(require(8139) /* isInteractionComponent */.ComponentStateContextProvider, obj);
