...
// Function ID: 15165
// Name: Select
// Dependencies: [32, 19, 17, 1979, 21, 4661, 712, 4805, 1954, 8326, 6292, 4734, 15165, 15168, 4745, 4733, 15169, 709, 2]
// Exports: default
...
function Select(children) {
  ...
  obj.type = type;
  obj.id = String(type);
  let obj1 = _require(8326);
  let state = obj1.useComponentState(obj).state;
  obj = { style: { gap: 8 }, children: null };
  const items = [callback(_require(4734).Text, { variant: "heading-lg/medium", children: children.title }), , , ];
  if (obj.type === _require(1954).ComponentType.STRING_SELECT) {
    obj = {};
    const merged1 = Object.assign(obj);
    let tmp7Result = tmp7(importDefault(15165), obj);
    const tmp15 = importDefault(15165);
  } else {
    obj1 = {};
    const merged2 = Object.assign(obj);
    obj1.type = obj.type;
    tmp7Result = tmp7(importDefault(15168), obj1);
    const tmp9 = importDefault(15168);
  }
  items[1] = tmp7Result;
  type = undefined;
  if (state != null) {
  ...
  if (type === obj.type) {
    ...
    obj[1] = items;
    return tmp6(_require(6292).Card, obj);
  }
}
...
export default function DevToolsComponentsTestingScreen() {
  ...
  const items = [callback(require(4734) /* Text */.Text, { variant: "text-md/normal", children: "Test screen for embedding native components in RN" }), , ];
  ...
  const items1 = [callback(importDefault(15169), {}), , , , , ];
  const obj2 = {};
  const tmp2 = importDefault(15169);
  ...
  obj[1] = items1;
  items[1] = callback2(require(8326) /* isInteractionComponent */.ComponentStateContextProvider, obj);
  items[2] = callback(require(4745) /* Button */.Button, {
    onPress() {
