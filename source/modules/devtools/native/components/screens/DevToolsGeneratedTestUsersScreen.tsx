...
// Function ID: 13866
// Name: PoolIdInput
// Dependencies: [5, 32, 19, 17, 13866, 1218, 21, 11229, 10238, 9580, 13867, 11337, 13869, 10838, 13871, 13200, 13873, 13875, 13877, 13879, 8766, 13881, 13883, 13885, 13887, 6013, 4303, 712, 4712, 7792, 4714, 4271, 13889, 5397, 5396, 5767, 5374, 4255, 589, 5369, 2]
// Exports: default

// Module 13865 (PoolIdInput)
...
export default function DevToolsGeneratedTestUsersScreen() {
  ...
  obj1[0] = importDefault(712).space.PX_16 + importDefault(5369)({ includeKeyboardHeight: true }).insets.bottom;
  items1[1] = obj1;
  obj[0] = items1;
  const items2 = [callback3(PoolIdInput, { onSubmit: callback }), ];
  let tmp5Result = 0 === stateFromStoresArray.length;
  if (tmp5Result) {
    tmp5Result = tmp5(_require(5374).TableRow, { label: "No pools available." });
  }
  ...
  obj3[2] = items3;
  items2[1] = closure_11(_require(5767).TableRowGroup, obj3);
  obj2[1] = items2;
  obj[1] = closure_11(_require(4712).Stack, obj2);
