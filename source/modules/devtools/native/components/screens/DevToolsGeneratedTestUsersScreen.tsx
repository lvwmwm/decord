...
// Function ID: 13736
// Name: PoolIdInput
// Dependencies: [5, 32, 19, 17, 13736, 1218, 21, 11108, 10119, 9464, 13737, 11216, 13739, 10699, 13741, 13069, 13743, 13745, 13747, 13749, 8654, 13751, 13753, 13755, 13757, 5905, 4255, 712, 4663, 7685, 4665, 4223, 13759, 5323, 5322, 5634, 5300, 4207, 589, 5295, 2]
// Exports: default

// Module 13735 (PoolIdInput)
...
export default function DevToolsGeneratedTestUsersScreen() {
  ...
  obj1[0] = importDefault(712).space.PX_16 + importDefault(5295)({ includeKeyboardHeight: true }).insets.bottom;
  items1[1] = obj1;
  obj[0] = items1;
  const items2 = [callback3(PoolIdInput, { onSubmit: callback }), ];
  let tmp5Result = 0 === stateFromStoresArray.length;
  if (tmp5Result) {
    tmp5Result = tmp5(_require(5300).TableRow, { label: "No pools available." });
  }
  ...
  obj3[2] = items3;
  items2[1] = closure_11(_require(5634).TableRowGroup, obj3);
  obj2[1] = items2;
  obj[1] = closure_11(_require(4663).Stack, obj2);
