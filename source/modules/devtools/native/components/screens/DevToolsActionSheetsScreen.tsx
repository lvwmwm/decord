...
// Dependencies: [32, 19, 17, 21, 4255, 712, 12406, 12404, 4461, 14905, 1959, 4223, 5309, 5308, 5620, 5286, 7760, 4207, 4664, 5288, 4251, 2]
// Exports: default

// Module 14904 (ActionSheetSelector)
...
function ActionSheetSelector(arg0) {
  ...
  obj2[1] = items.map((type) => {
    ...
    obj[0] = outer1_7(outer1_0(7760).WarningIcon, { size: "md" });
    ...
    return outer1_7(outer1_0(5286).TableRow, obj, type.type);
  });
  obj[1] = callback2(require(5620) /* TableRowGroupTitle */.TableRowGroup, obj2);
...
let items = [
  {
    ...
    show() {
      return importDefault(12406).show("https://example-phishing-site.com/malicious-page");
    }
  },
  {
    ...
    show() {
      return importDefault(12404).show("https://suspicious-file.com/dangerous-file.exe");
    }
  },
  {
    ...
    show() {
      return importDefault(4461).pushLazy(require(1959) /* asyncRequireImpl */(14905, dependencyMap.paths), { warningId: "test-warning-123", warningType: "inappropriate_conversation", senderId: "123456789", channelId: "987654321" }, "INAPPROPRIATE_CONVERSATION_TAKEOVER_MODAL");
    }
  }
];
...
export default function DevToolsActionSheetsScreen() {
  ...
  obj1[2] = callback2(first(5286).TableRow, { label: found.label, subLabel: found.description, arrow: true, onPress: callback });
  items1[1] = callback2(first(5620).TableRowGroup, obj1);
  obj[0] = items1;
  obj[1] = callback3(first(5288).Card, obj);
  obj[2] = callback2(first(4664).Stack, obj);
