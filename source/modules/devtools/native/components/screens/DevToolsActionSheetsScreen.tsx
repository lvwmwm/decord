...
// Dependencies: [32, 19, 17, 21, 4303, 712, 12222, 12220, 4509, 15042, 1988, 4271, 5397, 5396, 5767, 5374, 7962, 4255, 4712, 5376, 4299, 2]
// Exports: default

// Module 15041 (ActionSheetSelector)
...
function ActionSheetSelector(arg0) {
  ...
  dependencyMap = React.useCallback((type) => {
    onSelect(4271).hideActionSheet("action-sheet-selector");
    onSelect(type.type);
    type.show();
  }, items);
  ...
  obj2[1] = items.map((type) => {
    ...
    if (closure_0 === type.type) {
      tmpResult = tmp(outer1_0(4255).CheckmarkLargeIcon, { size: "md", color: "text-feedback-positive" });
    }
    obj[4] = tmpResult;
    obj[5] = 0 === arg1;
    obj[6] = arg1 === outer1_10.length - 1;
    return outer1_7(outer1_0(5374).TableRow, obj, type.type);
  });
  obj[1] = callback2(require(5767) /* TableRowGroupTitle */.TableRowGroup, obj2);
...
let items = [
  ...
  },
  {
    ...
    show() {
      return importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(15042, dependencyMap.paths), { warningId: "test-warning-123", warningType: "inappropriate_conversation", senderId: "123456789", channelId: "987654321" }, "INAPPROPRIATE_CONVERSATION_TAKEOVER_MODAL");
    }
  }
];
...
export default function DevToolsActionSheetsScreen() {
  ...
  obj = { children: null };
  const items1 = [callback2(first(4299).Text, { variant: "heading-lg/medium", children: "Action Sheets" }), ];
  const obj1 = { description: "Tap an option to launch the action sheet immediately", hasIcons: false, children: null };
  obj1[2] = callback2(first(5374).TableRow, { label: found.label, subLabel: found.description, arrow: true, onPress: callback });
  items1[1] = callback2(first(5767).TableRowGroup, obj1);
  obj[0] = items1;
  obj[1] = callback3(first(5376).Card, obj);
  obj[2] = callback2(first(4712).Stack, obj);
