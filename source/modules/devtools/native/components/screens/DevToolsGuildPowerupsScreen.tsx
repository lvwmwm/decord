...
// Dependencies: [5, 19, 17, 1340, 11653, 1862, 4006, 14803, 676, 21, 4189, 712, 530, 3771, 4085, 11580, 14716, 5555, 11586, 1355, 1358, 1581, 589, 4185, 5554, 5220, 2]
// Exports: default

// Module 14802 (setWarningBoosts)
...
function UserDCSwitchRow(dc) {
  ...
  let isDismissed;
  dc = dc.dc;
  ({ isDismissed, handleToggleDismissState } = importDefault(14716)(dc));
  const obj = { label: null, value: null, onValueChange: null };
  obj[0] = callback3(dc);
  obj[1] = isDismissed;
  obj[2] = handleToggleDismissState;
  return callback4(require(5555) /* TableSwitchRow */.TableSwitchRow, obj);
}
function GuildDCSwitchRow(dc) {
  ...
  obj[2] = callback;
  return callback4(dc(5555).TableSwitchRow, obj);
}
...
export default function DevToolsGuildPowerupsScreen() {
  ...
  if (null == stateFromStores) {
    ...
    obj[0] = items4;
    obj[1] = callback4(tmp5(4185).Text, { variant: "heading-md/semibold", color: "text-muted", children: "No guild selected" });
    ...
    obj2[2] = callback4(tmp5(5220).TableRow, obj3);
    const items6 = [callback4(tmp5(5554).TableRowGroup, obj2), , , , , , ];
    ...
    items6[3] = callback4(tmp5(5554).TableRowGroup, obj8);
    ...
    obj11[2] = callback4(tmp5(5220).TableRow, obj12);
    items6[6] = callback4(tmp5(5554).TableRowGroup, obj11);
    obj[2] = items6;
