...
// Dependencies: [5, 19, 17, 1340, 12000, 1910, 4165, 15107, 676, 21, 4342, 712, 530, 3943, 4238, 11928, 15021, 5829, 11934, 1374, 1377, 1628, 589, 4338, 5828, 5435, 2]
// Exports: default

// Module 15106 (setWarningBoosts)
...
function UserDCSwitchRow(dc) {
  ...
  let isDismissed;
  dc = dc.dc;
  ({ isDismissed, handleToggleDismissState } = importDefault(15021)(dc));
  const obj = { label: null, value: null, onValueChange: null };
  obj[0] = callback3(dc);
  obj[1] = isDismissed;
  obj[2] = handleToggleDismissState;
  return callback4(require(5829) /* TableSwitchRow */.TableSwitchRow, obj);
}
