...
// Dependencies: [5, 19, 17, 1340, 11731, 1910, 4197, 15156, 676, 21, 4661, 712, 530, 3975, 4270, 11657, 15070, 7178, 11663, 1374, 1377, 1629, 589, 4734, 6286, 6291, 2]
// Exports: default
...
function UserDCSwitchRow(dc) {
  ...
  let isDismissed;
  dc = dc.dc;
  ({ isDismissed, handleToggleDismissState } = importDefault(15070)(dc));
  const obj = { label: null, value: null, onValueChange: null };
  obj[0] = callback3(dc);
  obj[1] = isDismissed;
  obj[2] = handleToggleDismissState;
  return callback4(require(7178) /* TableSwitchRow */.TableSwitchRow, obj);
}
