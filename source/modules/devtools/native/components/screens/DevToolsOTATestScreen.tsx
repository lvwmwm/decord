...
// Dependencies: [5, 32, 19, 17, 505, 21, 4303, 712, 5397, 5396, 4299, 11193, 4271, 4712, 5767, 5374, 14758, 5756, 8573, 4253, 14991, 2]
// Exports: default

// Module 14990 (OtaVerificationActionSheet)
...
export default function DevToolsOTATestScreen() {
  ...
  obj[2] = callback2(first(14758).WrenchIcon, {});
  const items = [
  ...
  const items2 = [callback2(first(5374).TableRow, { label: "Manifest Source", subLabel: str, icon: callback2(first(14758).WrenchIcon, {}) }), ];
  let obj3 = { icon: null, label: null };
  obj3[0] = callback2(first(8573).PaperIcon, {});
  let str2 = "{}";
  if (null != tmp5) {
  ...
  obj5[0] = callback2(first(14758).WrenchIcon, {});
  let str3 = "Yes";
  if (null == tmp7) {
    str3 = "No";
  }
  ...
  if (tmp12Result) {
    ...
    obj6[0] = tmp12(tmp15(14758).WrenchIcon, {});
    const _JSON = JSON;
  ...
  obj7[2] = importDefault(11193).checkForUpdateAndReload;
  ...
  let obj2 = { label: "Manifest Source", subLabel: str, icon: callback2(first(14758).WrenchIcon, {}) };
  items4[1] = callback2(first(5374).TableRow, {
    label: "Verify OTA Files",
    subLabel: str4,
    icon: callback2(first(14991).ClipboardCheckIcon, {}),
