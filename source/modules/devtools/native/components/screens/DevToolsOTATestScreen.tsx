...
// Dependencies: [5, 32, 19, 17, 505, 21, 4342, 712, 5458, 5457, 4338, 11255, 4310, 4775, 5828, 5435, 14830, 5817, 8630, 4292, 15063, 2]
// Exports: default

// Module 15062 (OtaVerificationActionSheet)
...
function OtaVerificationActionSheet(result) {
  ...
  obj[0] = callback2(_require(5457).BottomSheetTitleHeader, { title: "OTA Verification Result" });
  obj = { style: tmp.verificationLine, children: null };
  const items = [callback2(_require(4338).Text, { variant: "heading-md/bold", children: "Has OTA Applied" }), ];
  let str = "No";
  let str2 = "No";
  if (result.hasOtaApplied) {
    str2 = "Yes";
  }
  items[1] = callback2(_require(4338).Text, { variant: "text-md/normal", children: str2 });
  obj[1] = items;
  const items1 = [closure_9(closure_7, obj), , , , ];
  obj = { style: tmp.verificationLine, children: null };
  const items2 = [callback2(_require(4338).Text, { variant: "heading-md/bold", children: "Has Local Copy" }), ];
  let str3 = "--";
  ...
  items2[1] = callback2(_require(4338).Text, { variant: "text-md/normal", children: str3 });
  obj[1] = items2;
  items1[1] = closure_9(closure_7, obj);
  const obj1 = { style: tmp.verificationLine, children: null };
  const items3 = [callback2(_require(4338).Text, { variant: "heading-md/bold", children: "OTA is Valid" }), ];
  if (result.isValid) {
    str = "Yes";
  }
  items3[1] = callback2(_require(4338).Text, { variant: "text-md/normal", children: str });
  obj1[1] = items3;
  ...
  if (null !== result.totalFileCount) {
    ...
    const items4 = [tmp5(tmp3(4338).Text, { variant: "heading-md/bold", children: "File Counts" }), ];
    ...
    items5[5] = " failures.";
    obj3[1] = items5;
    items4[1] = tmp2(tmp3(4338).Text, obj3);
    obj2[1] = items4;
  ...
  if (result.failures.length > 0) {
    ...
    const items6 = [tmp5(tmp3(4338).Text, { variant: "heading-md/bold", children: "Failures" }), ];
  ...
  items1[4] = tmp2Result;
  obj[1] = items1;
  return closure_9(_require(5458).BottomSheet, obj);
}
...
export default function DevToolsOTATestScreen() {
      ...
      if (c3 === 2) {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            ...
            obj3[0] = closure_0;
            outer1_1(4310).openLazy(Promise.resolve(obj2), "OtaVerificationActionSheet", obj3);
            c3 = 3;
            return { value: "HermesInternal", done: null };
          }
        } catch (tmp10) {
  ...
  obj7[2] = importDefault(11255).checkForUpdateAndReload;
