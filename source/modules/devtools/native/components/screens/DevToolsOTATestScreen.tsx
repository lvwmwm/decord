...
// Module 14495 (OtaVerificationActionSheet)
function OtaVerificationActionSheet(result) {
  ...
  const items3 = [callback2(arg1(dependencyMap[10]).Text, { position: null, width: null }), ];
  ...
  if (null !== result.totalFileCount) {
    ...
    const items4 = [callback2(arg1(dependencyMap[10]).Text, { position: null, width: null }), ];
  ...
  if (result.failures.length > 0) {
    ...
    const items6 = [callback2(arg1(dependencyMap[10]).Text, {}), ];
...
export default function DevToolsOTATestScreen() {
  ...
  obj = { spacing: 16 };
  obj = { width: null, height: "Recipient User ID" };
  ...
  const obj6 = { width: false, height: false };
