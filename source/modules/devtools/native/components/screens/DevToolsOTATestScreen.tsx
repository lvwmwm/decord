...
// Dependencies: [5, 32, 19, 17, 505, 21, 4444, 712, 5569, 5568, 4440, 11421, 4411, 4877, 5939, 5546, 15043, 5928, 8782, 4393, 15285, 2]
// Exports: default

// Module 15284 (OtaVerificationActionSheet)
...
function OtaVerificationActionSheet(result) {
  ...
  const tmp = callback4();
  _require = tmp;
  let obj = { header: callback2(_require(5568).BottomSheetTitleHeader, { title: "OTA Verification Result" }), children: null };
  obj = { style: tmp.verificationLine, children: null };
  const items = [callback2(_require(4440).Text, { variant: "heading-md/bold", children: "Has OTA Applied" }), ];
  let str = "No";
  let str2 = "No";
  if (result.hasOtaApplied) {
    str2 = "Yes";
  }
  items[1] = callback2(_require(4440).Text, { variant: "text-md/normal", children: str2 });
  obj[1] = items;
  const items1 = [closure_9(closure_7, obj), , , , ];
  obj = { style: tmp.verificationLine, children: null };
  const items2 = [callback2(_require(4440).Text, { variant: "heading-md/bold", children: "Has Local Copy" }), ];
  let str3 = "--";
  ...
  items2[1] = callback2(_require(4440).Text, { variant: "text-md/normal", children: str3 });
  obj[1] = items2;
  items1[1] = closure_9(closure_7, obj);
  obj1 = { style: tmp.verificationLine, children: null };
  const items3 = [callback2(_require(4440).Text, { variant: "heading-md/bold", children: "OTA is Valid" }), ];
  if (result.isValid) {
    str = "Yes";
  }
  items3[1] = callback2(_require(4440).Text, { variant: "text-md/normal", children: str });
  obj1[1] = items3;
  ...
  if (null !== result.totalFileCount) {
    ...
    const items4 = [tmp5(tmp3(4440).Text, { variant: "heading-md/bold", children: "File Counts" }), ];
    ...
    items5[5] = " failures.";
    obj3[1] = items5;
    items4[1] = tmp2(tmp3(4440).Text, obj3);
    obj2[1] = items4;
  ...
  if (result.failures.length > 0) {
    ...
    const items6 = [tmp5(tmp3(4440).Text, { variant: "heading-md/bold", children: "Failures" }), ];
  ...
  items1[4] = tmp2Result;
  obj[1] = items1;
  return closure_9(_require(5569).BottomSheet, obj);
}
...
export default function DevToolsOTATestScreen() {
      ...
      if (c3 === 2) {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            ...
            obj3[0] = closure_0;
            closure_1_1(4411).openLazy(Promise.resolve(obj2), "OtaVerificationActionSheet", obj3);
            c3 = 3;
            return { value: "HermesInternal", done: null };
          }
        } catch (tmp10) {
  ...
  obj = { label: "Status", subLabel: tmp8[0], icon: callback2(first(15043).WrenchIcon, {}) };
  const items = [
    callback2(first(5546).TableRow, obj),
    callback2(first(5546).TableRow, {
  ...
  obj[2] = items;
  const items1 = [callback3(first(5939).TableRowGroup, obj), , , ];
  let str;
  if (tmp5 != null) {
    str = tmp5.source;
  }
  ...
  const items2 = [callback2(first(5546).TableRow, { label: "Manifest Source", subLabel: str, icon: callback2(first(15043).WrenchIcon, {}) }), ];
  let obj3 = { icon: callback2(first(8782).PaperIcon, {}), label: null };
  let str2 = "{}";
  if (null != tmp5) {
  ...
  obj3[1] = str2;
  items2[1] = callback2(first(5546).TableRow, obj3);
  obj4[2] = items2;
  items1[1] = callback3(first(5939).TableRowGroup, obj4);
  const obj5 = { icon: callback2(first(15043).WrenchIcon, {}), label: "Is cookie set?", subLabel: null };
  let str3 = "Yes";
  if (null == tmp7) {
    str3 = "No";
  }
  obj5[2] = str3;
  const items3 = [callback2(first(5546).TableRow, obj5), ];
  let tmp12Result = null != tmp7;
  if (tmp12Result) {
    const obj6 = { icon: null, label: null };
    obj6[0] = tmp12(tmp15(15043).WrenchIcon, {});
    const _JSON = JSON;
    obj6[1] = JSON.stringify(tmp7, null, 2);
    tmp12Result = tmp12(tmp15(5546).TableRow, obj6);
  }
  items3[1] = tmp12Result;
  items1[2] = callback3(first(5939).TableRowGroup, { title: "Build Override Cookie", hasIcons: true, children: items3 });
  let obj2 = { label: "Manifest Source", subLabel: str, icon: callback2(first(15043).WrenchIcon, {}) };
  const items4 = [callback2(first(5546).TableRow, { label: "Check for Update & Reload", icon: callback2(first(4393).DownloadIcon, {}), onPress: BundleUpdaterManagerDefault.checkForUpdateAndReload }), ];
  ...
  const obj7 = { label: "Check for Update & Reload", icon: callback2(first(4393).DownloadIcon, {}), onPress: BundleUpdaterManagerDefault.checkForUpdateAndReload };
  items4[1] = callback2(first(5546).TableRow, {
    label: "Verify OTA Files",
    subLabel: str4,
    icon: callback2(first(15285).ClipboardCheckIcon, {}),
  ...
  obj9[2] = items4;
  items1[3] = callback3(first(5939).TableRowGroup, obj9);
  obj8[1] = items1;
  obj[2] = callback3(first(4877).Stack, obj8);
