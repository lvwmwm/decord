...
// Dependencies: [5, 32, 19, 17, 502, 21, 4478, 709, 5630, 5629, 4474, 11585, 4445, 4926, 6000, 5607, 15390, 5989, 7828, 4427, 15486, 2]
// Exports: default

// Module 15485 (OtaVerificationActionSheet)
...
function OtaVerificationActionSheet(result) {
  ...
  const tmp = callback4();
  _require = tmp;
  let obj = { header: callback2(_require(5629).BottomSheetTitleHeader, { title: "OTA Verification Result" }), children: null };
  ...
  items1[4] = tmp2Result;
  obj[1] = items1;
  return closure_9(_require(5630).BottomSheet, obj);
}
...
export default function DevToolsOTATestScreen() {
  ...
  obj = { label: "Status", subLabel: tmp8[0], icon: callback2(first(15390).WrenchIcon, {}) };
  const items = [
    callback2(first(5607).TableRow, obj),
  ...
  obj[2] = items;
  const items1 = [callback3(first(6000).TableRowGroup, obj), , , ];
  let str;
  if (tmp5 != null) {
    str = tmp5.source;
  }
  ...
  const items2 = [callback2(first(5607).TableRow, { label: "Manifest Source", subLabel: str, icon: callback2(first(15390).WrenchIcon, {}) }), ];
  let obj3 = { icon: callback2(first(7828).PaperIcon, {}), label: null };
  let str2 = "{}";
  if (null != tmp5) {
  ...
  obj3[1] = str2;
  items2[1] = callback2(first(5607).TableRow, obj3);
  obj4[2] = items2;
  items1[1] = callback3(first(6000).TableRowGroup, obj4);
  const obj5 = { icon: callback2(first(15390).WrenchIcon, {}), label: "Is cookie set?", subLabel: null };
  let str3 = "Yes";
  if (null == tmp7) {
    str3 = "No";
  }
  obj5[2] = str3;
  const items3 = [callback2(first(5607).TableRow, obj5), ];
  let tmp12Result = null != tmp7;
  if (tmp12Result) {
    const obj6 = { icon: null, label: null };
    obj6[0] = tmp12(tmp15(15390).WrenchIcon, {});
    const _JSON = JSON;
    obj6[1] = JSON.stringify(tmp7, null, 2);
    tmp12Result = tmp12(tmp15(5607).TableRow, obj6);
  }
  items3[1] = tmp12Result;
  items1[2] = callback3(first(6000).TableRowGroup, { title: "Build Override Cookie", hasIcons: true, children: items3 });
  let obj2 = { label: "Manifest Source", subLabel: str, icon: callback2(first(15390).WrenchIcon, {}) };
  const items4 = [callback2(first(5607).TableRow, { label: "Check for Update & Reload", icon: callback2(first(4427).DownloadIcon, {}), onPress: BundleUpdaterManagerDefault.checkForUpdateAndReload }), ];
  ...
  items4[1] = callback2(first(5607).TableRow, {
    label: "Verify OTA Files",
    subLabel: str4,
    icon: callback2(first(15486).ClipboardCheckIcon, {}),
  ...
  obj9[2] = items4;
  items1[3] = callback3(first(6000).TableRowGroup, obj9);
  obj8[1] = items1;
