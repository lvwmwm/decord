...
// Dependencies: [5, 32, 19, 17, 505, 21, 4303, 712, 5397, 5396, 4299, 11188, 4271, 4712, 5767, 5374, 14748, 5756, 8567, 4253, 14981, 2]
// Exports: default

// Module 14980 (OtaVerificationActionSheet)
...
function OtaVerificationActionSheet(result) {
  ...
  obj[0] = callback2(_require(5396).BottomSheetTitleHeader, { title: "OTA Verification Result" });
  obj = { style: tmp.verificationLine, children: null };
  const items = [callback2(_require(4299).Text, { variant: "heading-md/bold", children: "Has OTA Applied" }), ];
  let str = "No";
  let str2 = "No";
  if (result.hasOtaApplied) {
    str2 = "Yes";
  }
  items[1] = callback2(_require(4299).Text, { variant: "text-md/normal", children: str2 });
  obj[1] = items;
  const items1 = [closure_9(closure_7, obj), , , , ];
  obj = { style: tmp.verificationLine, children: null };
  const items2 = [callback2(_require(4299).Text, { variant: "heading-md/bold", children: "Has Local Copy" }), ];
  let str3 = "--";
  ...
  items2[1] = callback2(_require(4299).Text, { variant: "text-md/normal", children: str3 });
  obj[1] = items2;
  items1[1] = closure_9(closure_7, obj);
  const obj1 = { style: tmp.verificationLine, children: null };
  const items3 = [callback2(_require(4299).Text, { variant: "heading-md/bold", children: "OTA is Valid" }), ];
  if (result.isValid) {
    str = "Yes";
  }
  items3[1] = callback2(_require(4299).Text, { variant: "text-md/normal", children: str });
  obj1[1] = items3;
  ...
  if (null !== result.totalFileCount) {
    ...
    const items4 = [tmp5(tmp3(4299).Text, { variant: "heading-md/bold", children: "File Counts" }), ];
    ...
    items5[5] = " failures.";
    obj3[1] = items5;
    items4[1] = tmp2(tmp3(4299).Text, obj3);
    obj2[1] = items4;
  ...
  if (result.failures.length > 0) {
    ...
    const items6 = [tmp5(tmp3(4299).Text, { variant: "heading-md/bold", children: "Failures" }), ];
  ...
  items1[4] = tmp2Result;
  obj[1] = items1;
  return closure_9(_require(5397).BottomSheet, obj);
}
...
export default function DevToolsOTATestScreen() {
      ...
      if (c3 === 2) {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            ...
            obj3[0] = closure_0;
            outer1_1(4271).openLazy(Promise.resolve(obj2), "OtaVerificationActionSheet", obj3);
            c3 = 3;
            return { value: "HermesInternal", done: null };
          }
        } catch (tmp10) {
  ...
  obj[2] = callback2(first(14748).WrenchIcon, {});
  const items = [
    callback2(first(5374).TableRow, obj),
    callback2(first(5374).TableRow, {
  ...
  obj[2] = items;
  const items1 = [callback3(first(5767).TableRowGroup, obj), , , ];
  let str;
  if (tmp5 != null) {
    str = tmp5.source;
  }
  ...
  const items2 = [callback2(first(5374).TableRow, { label: "Manifest Source", subLabel: str, icon: callback2(first(14748).WrenchIcon, {}) }), ];
  let obj3 = { icon: null, label: null };
  obj3[0] = callback2(first(8567).PaperIcon, {});
  let str2 = "{}";
  if (null != tmp5) {
  ...
  obj3[1] = str2;
  items2[1] = callback2(first(5374).TableRow, obj3);
  obj4[2] = items2;
  items1[1] = callback3(first(5767).TableRowGroup, obj4);
  const obj5 = { icon: null, label: "Is cookie set?", subLabel: null };
  obj5[0] = callback2(first(14748).WrenchIcon, {});
  let str3 = "Yes";
  if (null == tmp7) {
    str3 = "No";
  }
  obj5[2] = str3;
  const items3 = [callback2(first(5374).TableRow, obj5), ];
  let tmp12Result = null != tmp7;
  if (tmp12Result) {
    const obj6 = { icon: null, label: null };
    obj6[0] = tmp12(tmp15(14748).WrenchIcon, {});
    const _JSON = JSON;
    obj6[1] = JSON.stringify(tmp7, null, 2);
    tmp12Result = tmp12(tmp15(5374).TableRow, obj6);
  }
  items3[1] = tmp12Result;
  items1[2] = callback3(first(5767).TableRowGroup, { title: "Build Override Cookie", hasIcons: true, children: items3 });
  const obj7 = { label: "Check for Update & Reload", icon: null, onPress: null };
  obj7[1] = callback2(first(4253).DownloadIcon, {});
  obj7[2] = importDefault(11188).checkForUpdateAndReload;
  const items4 = [callback2(first(5374).TableRow, obj7), ];
  ...
  let obj2 = { label: "Manifest Source", subLabel: str, icon: callback2(first(14748).WrenchIcon, {}) };
  items4[1] = callback2(first(5374).TableRow, {
    label: "Verify OTA Files",
    subLabel: str4,
    icon: callback2(first(14981).ClipboardCheckIcon, {}),
  ...
  obj9[2] = items4;
  items1[3] = callback3(first(5767).TableRowGroup, obj9);
  obj8[1] = items1;
  obj[2] = callback3(first(4712).Stack, obj8);
