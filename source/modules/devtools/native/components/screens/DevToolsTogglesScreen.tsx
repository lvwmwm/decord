...
function fuzzySearchToggle(str, str2, str3) {
  ...
  if (!tmp) {
    ...
    let tmp3ResultResult = importDefault(5269)(formatted, str2.toLowerCase());
    if (!tmp3ResultResult) {
...
export default function DevToolsTogglesScreen() {
  ...
  obj = { paddingBottom: importDefault(712).space.PX_16 + importDefault(5409)({ includeKeyboardHeight: true }).insets.bottom };
  items2[1] = obj;
  obj[1] = items2;
