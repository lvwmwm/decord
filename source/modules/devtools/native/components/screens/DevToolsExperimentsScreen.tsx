...
// Dependencies: [32, 19, 17, 4199, 1218, 1891, 4200, 21, 4285, 712, 10374, 10375, 5349, 8446, 11130, 12, 1297, 8750, 5913, 8449, 8128, 4207, 4253, 5354, 4281, 513, 11127, 5688, 8126, 5677, 3985, 4246, 5377, 5376, 2]

// Module 11129 (UserExperimentDebugView)
...
function UserExperimentDebugView(id) {
  ...
  let obj1 = require(11127) /* useExperimentAssignment */;
  const experimentAssignment = obj1.useExperimentAssignment(experiment, tmp7);
  let obj2 = require(11127) /* useExperimentAssignment */;
  ...
  obj[1] = str4;
  const items = [closure_11(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj1), closure_11(require(1297) /* Button */.Spacer, { size: 16 }), , , , , ];
  let str5 = "None";
  let str6 = "None";
  if (null != experimentServerAssignment) {
    const _JSON = JSON;
  ...
  items[2] = closure_11(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj2);
  ...
  items[4] = closure_11(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj3);
  ...
  const tmp16 = View;
  items[6] = closure_11(require(5688) /* TableRowGroupTitle */.TableRowGroup, { title: "Recent Exposures", hasIcons: false, children: closure_11(require(5354) /* TableRowInner */.TableRow, { label: str5 }) });
  obj[1] = items;
