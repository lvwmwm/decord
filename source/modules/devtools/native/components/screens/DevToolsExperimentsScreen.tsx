...
// Dependencies: [32, 19, 17, 4256, 1218, 1910, 4257, 21, 4342, 712, 10433, 10434, 5430, 8594, 11279, 12, 1297, 8890, 6056, 8597, 8273, 4264, 4310, 5435, 4338, 513, 11276, 5828, 8271, 5817, 4062, 4303, 5458, 5457, 2]

// Module 11278 (UserExperimentDebugView)
...
function UserExperimentDebugView(id) {
  ...
  let obj1 = require(11276) /* useExperimentAssignment */;
  const experimentAssignment = obj1.useExperimentAssignment(experiment, tmp7);
  let obj2 = require(11276) /* useExperimentAssignment */;
  ...
  obj[1] = str4;
  const items = [closure_11(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj1), closure_11(require(1297) /* Button */.Spacer, { size: 16 }), , , , , ];
  let str5 = "None";
  let str6 = "None";
  if (null != experimentServerAssignment) {
    const _JSON = JSON;
  ...
  items[2] = closure_11(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj2);
  ...
  items[4] = closure_11(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj3);
  ...
  const tmp16 = View;
  items[6] = closure_11(require(5828) /* TableRowGroupTitle */.TableRowGroup, { title: "Recent Exposures", hasIcons: false, children: closure_11(require(5435) /* TableRowInner */.TableRow, { label: str5 }) });
  obj[1] = items;
