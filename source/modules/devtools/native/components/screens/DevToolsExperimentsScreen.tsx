...
// Dependencies: [32, 19, 17, 4169, 1218, 1862, 4170, 21, 4255, 712, 10343, 10344, 5295, 8306, 11096, 12, 1297, 8721, 5886, 8309, 7987, 4177, 4223, 5300, 4251, 513, 11093, 5634, 7985, 5623, 3956, 4216, 5323, 5322, 2]

// Module 11095 (UserExperimentDebugView)
...
function UserExperimentDebugView(id) {
  ...
  let obj1 = require(11093) /* useExperimentAssignment */;
  const experimentAssignment = obj1.useExperimentAssignment(experiment, tmp7);
  let obj2 = require(11093) /* useExperimentAssignment */;
  ...
  obj[1] = str4;
  const items = [closure_11(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj1), closure_11(require(1297) /* Button */.Spacer, { size: 16 }), , , , , ];
  let str5 = "None";
  let str6 = "None";
  if (null != experimentServerAssignment) {
    const _JSON = JSON;
  ...
  items[2] = closure_11(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj2);
  ...
  items[4] = closure_11(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj3);
  ...
  const tmp16 = View;
  items[6] = closure_11(require(5634) /* TableRowGroupTitle */.TableRowGroup, { title: "Recent Exposures", hasIcons: false, children: closure_11(require(5300) /* TableRowInner */.TableRow, { label: str5 }) });
  obj[1] = items;
