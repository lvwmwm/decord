...
// Function ID: 13912
// Name: CommonProperty
// Dependencies: [32, 19, 17, 1922, 13738, 676, 21, 4344, 712, 4340, 5413, 10000, 3943, 9176, 4886, 5795, 4292, 589, 7786, 4752, 5806, 5807, 11599, 4303, 13912, 6033, 2]
// Exports: default

// Module 13911 (CommonProperty)
...
function CommonProperty(arg0) {
  ...
  const items = [callback2(require(4340) /* Text */.Text, { variant: "text-sm/semibold", color: "text-default", children: name }), children];
  obj[1] = items;
