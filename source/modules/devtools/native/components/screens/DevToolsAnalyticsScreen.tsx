...
// Function ID: 13919
// Name: CommonProperty
// Dependencies: [32, 19, 17, 1922, 13742, 676, 21, 4342, 712, 4338, 5435, 10009, 3943, 9194, 4909, 5817, 4290, 589, 7811, 4775, 5828, 5829, 11612, 4301, 13919, 6056, 2]
// Exports: default

// Module 13918 (CommonProperty)
...
function CommonProperty(arg0) {
  ...
  const items = [callback2(require(4338) /* Text */.Text, { variant: "text-sm/semibold", color: "text-default", children: name }), children];
  obj[1] = items;
