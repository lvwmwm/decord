...
// Function ID: 13776
// Name: CommonProperty
// Dependencies: [32, 19, 17, 1903, 13601, 676, 21, 4302, 712, 4298, 5373, 9887, 3883, 9070, 4844, 5696, 4250, 589, 7685, 4710, 5707, 5708, 11472, 4261, 13776, 5932, 2]
// Exports: default

// Module 13775 (CommonProperty)
...
function CommonProperty(arg0) {
  ...
  const items = [callback2(require(4298) /* Text */.Text, { variant: "text-sm/semibold", color: "text-default", children: name }), children];
  obj[1] = items;
