...
// Dependencies: [32, 19, 17, 676, 21, 4189, 712, 10350, 4598, 5554, 5220, 4185, 14755, 2]
// Exports: default

// Module 14754 (DevToolsProfilingScreen)
...
export default function DevToolsProfilingScreen() {
  ...
  let obj = require(10350) /* addValue */;
  ...
  if (tmp7) {
    ...
    obj2[3] = callback;
    obj1[2] = tmp8(tmp4(5220).TableRow, obj2);
    let items = [tmp8(tmp4(5554).TableRowGroup, obj1), ];
    ...
    const items1 = ["Make sure you wrap your component in ", tmp8(tmp4(4185).Text, obj6), " to enable measurements."];
    obj5[2] = items1;
    obj4[1] = tmp10(tmp4(4185).Text, obj5);
    obj3[2] = tmp8(tmp4(5220).TableRow, obj4);
    tmp8Result = tmp8(tmp4(5554).TableRowGroup, obj3);
  }
  const obj7 = { spacing: 16, children: null };
  const items2 = [tmp8Result, closure_5(require(14755) /* DevToolsProfilingUseStateFromStores */.DevToolsProfilingUseStateFromStores, {})];
  obj7[1] = items2;
  obj[1] = closure_7(require(4598) /* Stack */.Stack, obj7);
