...
// Dependencies: [32, 19, 17, 676, 21, 4444, 712, 10093, 4877, 5939, 5546, 4440, 15288, 2]
// Exports: default

// Module 15287 (DevToolsProfilingScreen)
import ThemesDefault from "Themes" /* 712 */;
import Stack from "Stack" /* 4877 */;
import addValue from "addValue" /* 10093 */;
import DevToolsProfilingUseStateFromStores from "DevToolsProfilingUseStateFromStores" /* 15288 */;
...
export default function DevToolsProfilingScreen() {
  ...
  const callback = React.useCallback(() => {
    const result = closure_1_0(10093).clearComponentRenderStats();
    callback(true);
  }, []);
  const tmp3 = callback();
  dependencyMap = tmp3;
  ...
  if (tmp7) {
    ...
    obj2[3] = callback;
    obj1[2] = tmp8(tmp4(5546).TableRow, obj2);
    let items = [tmp8(tmp4(5939).TableRowGroup, obj1), ];
    ...
    items[1] = keys.map((arg0) => {
      ...
      return closure_1_5(closure_1_0(5939).TableRowGroup, {
    ...
    const items1 = ["Make sure you wrap your component in ", tmp8(tmp4(4440).Text, obj6), " to enable measurements."];
    obj5[2] = items1;
    obj4[1] = tmp10(tmp4(4440).Text, obj5);
    obj3[2] = tmp8(tmp4(5546).TableRow, obj4);
    tmp8Result = tmp8(tmp4(5939).TableRowGroup, obj3);
  }
