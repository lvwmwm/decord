...
// Dependencies: [32, 19, 17, 676, 21, 4445, 712, 10196, 4878, 5944, 5551, 4441, 15352, 2]
// Exports: default

// Module 15351 (DevToolsProfilingScreen)
import ThemesDefault from "Themes" /* 712 */;
import Stack from "Stack" /* 4878 */;
import addValue from "addValue" /* 10196 */;
import DevToolsProfilingUseStateFromStores from "DevToolsProfilingUseStateFromStores" /* 15352 */;
...
export default function DevToolsProfilingScreen() {
  ...
  const callback = React.useCallback(() => {
    const result = closure_1_0(10196).clearComponentRenderStats();
    callback(true);
  }, []);
  const tmp3 = callback();
  dependencyMap = tmp3;
  ...
  if (tmp7) {
    ...
    obj2[3] = callback;
    obj1[2] = tmp8(tmp4(5551).TableRow, obj2);
    let items = [tmp8(tmp4(5944).TableRowGroup, obj1), ];
    ...
    items[1] = keys.map((arg0) => {
      ...
      return closure_1_5(closure_1_0(5944).TableRowGroup, {
    ...
    const items1 = ["Make sure you wrap your component in ", tmp8(tmp4(4441).Text, obj6), " to enable measurements."];
    obj5[2] = items1;
    obj4[1] = tmp10(tmp4(4441).Text, obj5);
    obj3[2] = tmp8(tmp4(5551).TableRow, obj4);
    tmp8Result = tmp8(tmp4(5944).TableRowGroup, obj3);
  }
