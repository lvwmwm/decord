...
// Dependencies: [32, 19, 17, 676, 21, 4255, 712, 10507, 4664, 5620, 5286, 4251, 14845, 2]
// Exports: default

// Module 14844 (DevToolsProfilingScreen)
...
export default function DevToolsProfilingScreen() {
  ...
  let obj = require(10507) /* addValue */;
  ...
  if (tmp7) {
    ...
    obj2[3] = callback;
    obj1[2] = tmp8(tmp4(5286).TableRow, obj2);
    let items = [tmp8(tmp4(5620).TableRowGroup, obj1), ];
    ...
    obj3[2] = tmp8(tmp4(5286).TableRow, obj4);
    tmp8Result = tmp8(tmp4(5620).TableRowGroup, obj3);
  }
  const obj7 = { spacing: 16, children: null };
  const items2 = [tmp8Result, closure_5(require(14845) /* DevToolsProfilingUseStateFromStores */.DevToolsProfilingUseStateFromStores, {})];
  obj7[1] = items2;
  obj[1] = closure_7(require(4664) /* Stack */.Stack, obj7);
