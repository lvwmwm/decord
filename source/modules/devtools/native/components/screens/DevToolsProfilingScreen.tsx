...
// Dependencies: [32, 19, 17, 676, 21, 4285, 712, 9791, 4693, 5649, 5315, 4281, 14879, 2]
// Exports: default

// Module 14878 (DevToolsProfilingScreen)
...
export default function DevToolsProfilingScreen() {
  ...
  if (tmp7) {
    ...
    obj2[3] = callback;
    obj1[2] = tmp8(tmp4(5315).TableRow, obj2);
    let items = [tmp8(tmp4(5649).TableRowGroup, obj1), ];
    ...
    obj3[2] = tmp8(tmp4(5315).TableRow, obj4);
