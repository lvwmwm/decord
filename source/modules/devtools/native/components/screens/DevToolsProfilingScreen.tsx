...
// Dependencies: [32, 19, 17, 676, 21, 4446, 712, 10214, 4891, 5957, 5564, 4442, 15194, 2]
// Exports: default

// Module 15193 (DevToolsProfilingScreen)
import ThemesDefault from "Themes" /* 712 */;
import Stack from "Stack" /* 4891 */;
import addValue from "addValue" /* 10214 */;
import DevToolsProfilingUseStateFromStores from "DevToolsProfilingUseStateFromStores" /* 15194 */;
...
export default function DevToolsProfilingScreen() {
  ...
  const callback = React.useCallback(() => {
    const result = closure_1_0(10214).clearComponentRenderStats();
    callback(true);
  }, []);
  const tmp3 = callback();
  dependencyMap = tmp3;
  ...
  if (tmp7) {
    ...
    obj2[3] = callback;
    obj1[2] = tmp8(tmp4(5564).TableRow, obj2);
    let items = [tmp8(tmp4(5957).TableRowGroup, obj1), ];
    ...
    items[1] = keys.map((arg0) => {
      ...
      return closure_1_5(closure_1_0(5957).TableRowGroup, {
    ...
    const items1 = ["Make sure you wrap your component in ", tmp8(tmp4(4442).Text, obj6), " to enable measurements."];
    obj5[2] = items1;
    obj4[1] = tmp10(tmp4(4442).Text, obj5);
    obj3[2] = tmp8(tmp4(5564).TableRow, obj4);
    tmp8Result = tmp8(tmp4(5957).TableRowGroup, obj3);
  }
