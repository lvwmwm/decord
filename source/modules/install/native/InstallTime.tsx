...
// Dependencies: [1218, 595, 12963, 4379, 2]
// Exports: getFirstInstallTimeElapsed

// Module 12962 (getFirstInstallTimeMillis)
import fetchFingerprint from "fetchFingerprint";

const require = arg1;
function getFirstInstallTimeMillis(arg0) {
  const firstInstallTimeMillis = importDefault(12963).getFirstInstallTimeMillis();
...
export const getFirstInstallTimeElapsed = function getFirstInstallTimeElapsed(unit) {
  ...
  if (0 === tmp) {
    ...
    let result = diff;
    if (null != unit) {
      result = require(4379) /* sleep */.convertMinutesToGivenTimeUnit(diff / require(4379) /* sleep */.MS_PER_MINUTE, unit);
