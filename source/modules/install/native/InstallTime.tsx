...
// Dependencies: [1218, 595, 12754, 4265, 2]
// Exports: getFirstInstallTimeElapsed

// Module 12753 (getFirstInstallTimeMillis)
import fetchFingerprint from "fetchFingerprint";

const require = arg1;
function getFirstInstallTimeMillis(arg0) {
  const firstInstallTimeMillis = importDefault(12754).getFirstInstallTimeMillis();
...
export const getFirstInstallTimeElapsed = function getFirstInstallTimeElapsed(unit) {
  ...
  if (0 === tmp) {
    ...
    let result = diff;
    if (null != unit) {
      result = require(4265) /* sleep */.convertMinutesToGivenTimeUnit(diff / require(4265) /* sleep */.MS_PER_MINUTE, unit);
