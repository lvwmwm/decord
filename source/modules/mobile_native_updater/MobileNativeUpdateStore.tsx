...
// Dependencies: [4171, 3, 589, 709, 13044, 2]

// Module 13459 (checkForNewerBuild)
...
prototype["checkForNewerBuild"] = function checkForNewerBuild() {
  if (true !== checking.checking) {
    ...
    const obj2 = require(13044) /* _checkForNewerBuild */;
    require(13044) /* _checkForNewerBuild */.checkForNewerBuild().then((newBuild) => {
    ...
    const checkForNewerBuildResult = require(13044) /* _checkForNewerBuild */.checkForNewerBuild();
  }
};
