          ...
          if (0 === body) {
            ...
            if (1 === tmp7) {
              ...
              if (2 === tmp7) {
                ...
                obj6[0] = callback(5870).MetricEvents.BADGE_DIRECTORY_CATALOG_FETCH;
                ...
                obj8[0] = callback(5870).MetricEvents.BADGE_DIRECTORY_CATALOG_FETCH;
                obj8[1] = c8;
                const _Date = Date;
