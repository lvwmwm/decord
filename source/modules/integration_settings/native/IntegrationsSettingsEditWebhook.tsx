...
// Dependencies: [19, 1961, 3912, 3921, 1903, 676, 21, 4285, 712, 3996, 500, 8312, 5253, 8305, 1236, 15808, 10221, 530, 5677, 4624, 4713, 4281, 7890, 4693, 15816, 1416, 7713, 5688, 5354, 4475, 1297, 4745, 1480, 5635, 2]
// Exports: default

// Module 15815 (componentDidMount)
...
prototype["render"] = function render() {
  ...
  let tmp2Result = tmp2(webhookId(4281).Text, { variant: "text-sm/medium", color: "text-link", children: stringResult });
  ...
  if (props.webhookType !== constants.CHANNEL_FOLLOWER) {
    ...
    tmp2Result = tmp2(importDefault(15816), obj);
    const tmp8Result = importDefault(15816);
  }
  ...
  obj2[3] = first;
  items1[1] = closure_11(webhookId(7713).TextInput, obj2);
  ...
  obj3[2] = closure_11(webhookId(5354).TableRow, obj4);
  items1[2] = closure_11(webhookId(5688).TableRowGroup, obj3);
  ...
  if (null != token) {
    ...
    obj7[2] = tmp2Result;
    obj6[2] = tmp2(tmp3(5354).TableRow, obj7);
    tmp2Result1 = tmp2(tmp3(5688).TableRowGroup, obj6);
  ...
  obj8[1] = closure_11(webhookId(5354).TableRow, obj9);
  items1[4] = closure_11(webhookId(5688).TableRowGroup, obj8);
  obj[2] = items1;
  obj[2] = closure_12(webhookId(4693).Stack, obj);
  return closure_11(webhookId(7890).Form, obj);
};
...
export default function ConnectedEditWebhook(arg0) {
  ...
  const items = [callback(EditWebhook, obj), callback(require(5635) /* NavScrim */.NavScrim, {})];
  obj[0] = items;
