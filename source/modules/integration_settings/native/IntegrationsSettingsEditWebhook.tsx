...
// Dependencies: [19, 1961, 3929, 3938, 1903, 676, 21, 4303, 712, 4013, 500, 8389, 5270, 8382, 1236, 15907, 10303, 530, 5756, 4643, 4732, 4299, 7967, 4712, 15915, 1416, 7790, 5767, 5374, 4494, 1297, 4764, 1480, 5714, 2]
// Exports: default

// Module 15914 (componentDidMount)
...
import importAllResult from "module_4643";
...
prototype["render"] = function render() {
  ...
  let tmp2Result = tmp2(webhookId(4299).Text, { variant: "text-sm/medium", color: "text-link", children: stringResult });
  ...
  if (props.webhookType !== constants.CHANNEL_FOLLOWER) {
    ...
    tmp2Result = tmp2(importDefault(15915), obj);
    const tmp8Result = importDefault(15915);
  }
  ...
  tmp3Result = tmp3(4764);
  obj5[1] = tmp3Result.getChannelIcon(channel);
  obj5[2] = tmp.channelIcon;
  obj4[3] = closure_11(webhookId(1297).Icon, obj5);
  obj3[2] = closure_11(webhookId(5374).TableRow, obj4);
  items1[2] = closure_11(webhookId(5767).TableRowGroup, obj3);
  ...
  if (null != token) {
    ...
    obj7[2] = tmp2Result;
    obj6[2] = tmp2(tmp3(5374).TableRow, obj7);
    tmp2Result1 = tmp2(tmp3(5767).TableRowGroup, obj6);
  ...
  obj8[1] = closure_11(webhookId(5374).TableRow, obj9);
...
export default function ConnectedEditWebhook(arg0) {
  ...
  const items = [callback(EditWebhook, obj), callback(require(5714) /* NavScrim */.NavScrim, {})];
  obj[0] = items;
