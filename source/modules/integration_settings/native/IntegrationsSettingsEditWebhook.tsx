...
// Dependencies: [19, 1961, 3929, 3938, 1903, 676, 21, 4302, 712, 4013, 500, 8329, 5269, 8322, 1236, 15832, 10237, 530, 5696, 4641, 4730, 4298, 7907, 4710, 15840, 1416, 7730, 5707, 5373, 4492, 1297, 4762, 1480, 5654, 2]
// Exports: default

// Module 15839 (componentDidMount)
...
import importAllResult from "module_4641";
...
prototype["render"] = function render() {
  ...
  let tmp2Result = tmp2(webhookId(4298).Text, { variant: "text-sm/medium", color: "text-link", children: stringResult });
  ...
  if (props.webhookType !== constants.CHANNEL_FOLLOWER) {
    ...
    tmp2Result = tmp2(importDefault(15840), obj);
    const tmp8Result = importDefault(15840);
  }
  ...
  obj2[3] = first;
  items1[1] = closure_11(webhookId(7730).TextInput, obj2);
  ...
  tmp3Result = tmp3(4762);
  obj5[1] = tmp3Result.getChannelIcon(channel);
  obj5[2] = tmp.channelIcon;
  obj4[3] = closure_11(webhookId(1297).Icon, obj5);
  obj3[2] = closure_11(webhookId(5373).TableRow, obj4);
  items1[2] = closure_11(webhookId(5707).TableRowGroup, obj3);
  ...
  if (null != token) {
    ...
    obj7[2] = tmp2Result;
    obj6[2] = tmp2(tmp3(5373).TableRow, obj7);
    tmp2Result1 = tmp2(tmp3(5707).TableRowGroup, obj6);
  ...
  obj8[1] = closure_11(webhookId(5373).TableRow, obj9);
  items1[4] = closure_11(webhookId(5707).TableRowGroup, obj8);
  obj[2] = items1;
  obj[2] = closure_12(webhookId(4710).Stack, obj);
  return closure_11(webhookId(7907).Form, obj);
};
...
export default function ConnectedEditWebhook(arg0) {
  ...
  const items = [callback(EditWebhook, obj), callback(require(5654) /* NavScrim */.NavScrim, {})];
  obj[0] = items;
