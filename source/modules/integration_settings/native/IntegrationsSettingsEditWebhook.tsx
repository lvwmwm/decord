...
import importAllResult from "module_4529";
...
prototype["render"] = function render() {
  ...
  let tmp2Result = tmp2(webhookId(4185).Text, { variant: "text-sm/medium", color: "text-link", children: stringResult });
  ...
  tmp3Result = tmp3(4650);
  obj5[1] = tmp3Result.getChannelIcon(channel);
  obj5[2] = tmp.channelIcon;
  obj4[3] = closure_11(webhookId(1297).Icon, obj5);
  obj3[2] = closure_11(webhookId(5220).TableRow, obj4);
  items1[2] = closure_11(webhookId(5554).TableRowGroup, obj3);
  ...
  if (null != token) {
    ...
    obj7[2] = tmp2Result;
    obj6[2] = tmp2(tmp3(5220).TableRow, obj7);
    tmp2Result1 = tmp2(tmp3(5554).TableRowGroup, obj6);
  ...
  obj8[1] = closure_11(webhookId(5220).TableRow, obj9);
...
export default function ConnectedEditWebhook(arg0) {
  ...
  const items = [callback(EditWebhook, obj), callback(require(5501) /* NavScrim */.NavScrim, {})];
  obj[0] = items;
