...
// Dependencies: [19, 1932, 3883, 3892, 1874, 676, 21, 4255, 712, 3967, 500, 8172, 5223, 8165, 1236, 15768, 10190, 530, 5623, 4594, 4683, 4251, 7749, 4663, 15776, 1416, 7685, 5634, 5300, 4445, 1297, 4715, 1480, 5581, 2]
// Exports: default

// Module 15775 (componentDidMount)
...
import importAllResult from "module_4594";
...
prototype["render"] = function render() {
  ...
  if (props.webhookType !== constants.CHANNEL_FOLLOWER) {
    ...
    tmp2Result = tmp2(importDefault(15776), obj);
    const tmp8Result = importDefault(15776);
  }
  ...
  obj2[3] = first;
  items1[1] = closure_11(webhookId(7685).TextInput, obj2);
  ...
  tmp3Result = tmp3(4715);
  obj5[1] = tmp3Result.getChannelIcon(channel);
  obj5[2] = tmp.channelIcon;
  obj4[3] = closure_11(webhookId(1297).Icon, obj5);
  obj3[2] = closure_11(webhookId(5300).TableRow, obj4);
  items1[2] = closure_11(webhookId(5634).TableRowGroup, obj3);
  ...
  if (null != token) {
    ...
    obj7[2] = tmp2Result;
    obj6[2] = tmp2(tmp3(5300).TableRow, obj7);
    tmp2Result1 = tmp2(tmp3(5634).TableRowGroup, obj6);
  ...
  obj8[1] = closure_11(webhookId(5300).TableRow, obj9);
  items1[4] = closure_11(webhookId(5634).TableRowGroup, obj8);
  obj[2] = items1;
  obj[2] = closure_12(webhookId(4663).Stack, obj);
  return closure_11(webhookId(7749).Form, obj);
};
...
export default function ConnectedEditWebhook(arg0) {
  ...
  const items = [callback(EditWebhook, obj), callback(require(5581) /* NavScrim */.NavScrim, {})];
  obj[0] = items;
