...
prototype["render"] = function render() {
  ...
  obj3[2] = closure_11(webhookId(5315).TableRow, obj4);
  items1[2] = closure_11(webhookId(5649).TableRowGroup, obj3);
  ...
  if (null != token) {
    ...
    obj7[2] = tmp2Result;
    obj6[2] = tmp2(tmp3(5315).TableRow, obj7);
    tmp2Result1 = tmp2(tmp3(5649).TableRowGroup, obj6);
  ...
  obj8[1] = closure_11(webhookId(5315).TableRow, obj9);
  items1[4] = closure_11(webhookId(5649).TableRowGroup, obj8);
  obj[2] = items1;
  obj[2] = closure_12(webhookId(4693).Stack, obj);
  return closure_11(webhookId(7777).Form, obj);
};
