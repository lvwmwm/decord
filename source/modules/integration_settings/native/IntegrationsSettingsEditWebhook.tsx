...
// Dependencies: [19, 1981, 4024, 4033, 1922, 676, 21, 4668, 712, 4107, 500, 8538, 6345, 8531, 1236, 16157, 10572, 530, 7205, 4662, 4768, 4739, 8122, 4738, 16165, 1435, 8110, 6317, 6322, 4989, 1297, 6870, 1500, 6581, 2]
// Exports: default

// Module 16164 (componentDidMount)
import ThemesDefault from "Themes" /* 712 */;
import useNavigation from "useNavigation" /* 1500 */;
import NavScrim from "NavScrim" /* 6581 */;
import renderLabelDefault from "renderLabel" /* 16165 */;
...
prototype["render"] = function render() {
  ...
  let tmp2Result = tmp2(webhookId(4739).Text, { variant: "text-sm/medium", color: "text-link", children: stringResult });
  ...
  obj2[3] = first;
  items1[1] = closure_11(webhookId(8110).TextInput, obj2);
  ...
  tmp3Result = tmp3(6870);
  obj5[1] = tmp3Result.getChannelIcon(channel);
  obj5[2] = tmp.channelIcon;
  obj4[3] = closure_11(webhookId(1297).Icon, obj5);
  obj3[2] = closure_11(webhookId(6322).TableRow, obj4);
  items1[2] = closure_11(webhookId(6317).TableRowGroup, obj3);
  ...
  if (null != token) {
    ...
    obj7[2] = tmp2Result;
    obj6[2] = tmp2(tmp3(6322).TableRow, obj7);
    tmp2Result1 = tmp2(tmp3(6317).TableRowGroup, obj6);
  ...
  obj8[1] = closure_11(webhookId(6322).TableRow, obj9);
  items1[4] = closure_11(webhookId(6317).TableRowGroup, obj8);
  obj[2] = items1;
  obj[2] = closure_12(webhookId(4738).Stack, obj);
  return closure_11(webhookId(8122).Form, obj);
};
