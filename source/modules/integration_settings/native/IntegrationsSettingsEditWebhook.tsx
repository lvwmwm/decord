...
// Dependencies: [19, 1980, 3989, 3998, 1922, 676, 21, 4344, 712, 4072, 500, 8434, 5309, 8427, 1236, 15990, 10350, 530, 5795, 4683, 4772, 4340, 8008, 4752, 15998, 1435, 7831, 5806, 5413, 4534, 1297, 4804, 1499, 5753, 2]
// Exports: default

// Module 15997 (componentDidMount)
...
import importAllResult from "module_4683";
...
prototype["render"] = function render() {
  ...
  let tmp2Result = tmp2(webhookId(4340).Text, { variant: "text-sm/medium", color: "text-link", children: stringResult });
  ...
  if (props.webhookType !== constants.CHANNEL_FOLLOWER) {
    ...
    tmp2Result = tmp2(importDefault(15998), obj);
    const tmp8Result = importDefault(15998);
  }
  ...
  obj2[3] = first;
  items1[1] = closure_11(webhookId(7831).TextInput, obj2);
  ...
  tmp3Result = tmp3(4804);
  obj5[1] = tmp3Result.getChannelIcon(channel);
  obj5[2] = tmp.channelIcon;
  obj4[3] = closure_11(webhookId(1297).Icon, obj5);
  obj3[2] = closure_11(webhookId(5413).TableRow, obj4);
  items1[2] = closure_11(webhookId(5806).TableRowGroup, obj3);
  ...
  if (null != token) {
    ...
    obj7[2] = tmp2Result;
    obj6[2] = tmp2(tmp3(5413).TableRow, obj7);
    tmp2Result1 = tmp2(tmp3(5806).TableRowGroup, obj6);
  ...
  obj8[1] = closure_11(webhookId(5413).TableRow, obj9);
  items1[4] = closure_11(webhookId(5806).TableRowGroup, obj8);
  obj[2] = items1;
  obj[2] = closure_12(webhookId(4752).Stack, obj);
  return closure_11(webhookId(8008).Form, obj);
};
...
export default function ConnectedEditWebhook(arg0) {
  ...
  const items = [callback(EditWebhook, obj), callback(require(5753) /* NavScrim */.NavScrim, {})];
  obj[0] = items;
