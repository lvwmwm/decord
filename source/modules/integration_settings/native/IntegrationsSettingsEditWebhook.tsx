...
// Dependencies: [19, 1982, 4089, 4098, 1922, 676, 21, 4445, 712, 4172, 500, 7547, 5447, 7540, 1236, 16335, 10886, 530, 5933, 4810, 4899, 4441, 8295, 4878, 16343, 1435, 7638, 5944, 5551, 4639, 1297, 4933, 1500, 5891, 2]
// Exports: default

// Module 16342 (componentDidMount)
import ThemesDefault from "Themes" /* 712 */;
import useNavigation from "useNavigation" /* 1500 */;
import NavScrim from "NavScrim" /* 5891 */;
import renderLabelDefault from "renderLabel" /* 16343 */;
...
prototype["render"] = function render() {
  ...
  let tmp2Result = tmp2(webhookId(4441).Text, { variant: "text-sm/medium", color: "text-link", children: stringResult });
  ...
  obj2[3] = first;
  items1[1] = closure_11(webhookId(7638).TextInput, obj2);
  ...
  tmp3Result = tmp3(4933);
  obj5[1] = tmp3Result.getChannelIcon(channel);
  obj5[2] = tmp.channelIcon;
  obj4[3] = closure_11(webhookId(1297).Icon, obj5);
  obj3[2] = closure_11(webhookId(5551).TableRow, obj4);
  items1[2] = closure_11(webhookId(5944).TableRowGroup, obj3);
  ...
  if (null != token) {
    ...
    obj7[2] = tmp2Result;
    obj6[2] = tmp2(tmp3(5551).TableRow, obj7);
    tmp2Result1 = tmp2(tmp3(5944).TableRowGroup, obj6);
  ...
  obj8[1] = closure_11(webhookId(5551).TableRow, obj9);
  items1[4] = closure_11(webhookId(5944).TableRowGroup, obj8);
  obj[2] = items1;
  obj[2] = closure_12(webhookId(4878).Stack, obj);
  return closure_11(webhookId(8295).Form, obj);
};
