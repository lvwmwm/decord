...
function CodeFieldInner(loading) {
  ...
  const items1 = [callback2(require(4338) /* Text */.Text, obj), callback2(require(4338) /* Text */.Text, { style: tmp2.subtitle, variant: "text-sm/medium", color: "text-default", children: description }), , ];
