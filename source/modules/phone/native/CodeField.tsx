...
// Dependencies: [32, 19, 17, 21, 4445, 712, 1297, 7638, 1236, 4880, 4441, 6001, 2]
// Exports: CodeBlocks, default

// Module 7736 (SingleCodeInput)
...
function CodeFieldInner(loading) {
  ...
  items1[3] = actions;
  obj[1] = items1;
  const items2 = [callback3(closure_5, obj), callback2(_modDef6001, { children: footer })];
  obj[4] = items2;
...
export default function CodeField(disableKeyboardAvoidingView) {
  if (disableKeyboardAvoidingView.disableKeyboardAvoidingView) {
    ...
    tmp2Result = tmp2(_modDef6001, obj);
    const tmp5 = _modDef6001;
  }
  return tmp2Result;
};
