...
// Dependencies: [676, 698, 4310, 9067, 2007, 11063, 2]
// Exports: openAddMembersActionSheet, openChannelMembersActionSheet

// Module 11062 (openAddMembersActionSheet)
...
export const openAddMembersActionSheet = function openAddMembersActionSheet(closure_0) {
  ...
  obj2.openLazy(require(2007) /* asyncRequireImpl */(9067, dependencyMap.paths), "channel-add-members-" + closure_0.id, obj);
};
export const openChannelMembersActionSheet = function openChannelMembersActionSheet(id, guild_id) {
  ...
  obj2.openLazy(require(2007) /* asyncRequireImpl */(11063, dependencyMap.paths), "channel-members-" + id, obj);
};
