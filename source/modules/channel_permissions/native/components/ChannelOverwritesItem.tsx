...
// Function ID: 8290
// Name: RemoveIcon
// Dependencies: [19, 17, 1874, 6721, 21, 4193, 4537, 1236, 4203, 3893, 4721, 6739, 5224, 8290, 8281, 4189, 1297, 8291, 8292, 3911, 7641, 2]
...
function RemoveIcon(item) {
  ...
  if (null != channelId) {
    ...
    obj = { style: null };
    obj[0] = prop;
    obj[4] = closure_7(item(6739).CircleXIcon, obj);
    tmp3Result = tmp3(item(4721).PressableOpacity, obj);
  }
  return tmp3Result;
}
function RoleItem(arg0) {
  ...
  obj[0] = callback(require(8290) /* ShieldUserIcon */.ShieldUserIcon, obj);
  obj[1] = item.name;
  if (showType) {
    subLabel = importAll(8281).getRowTypeLabel(item.rowType);
    const obj3 = importAll(8281);
  }
  obj[2] = subLabel;
  obj[3] = start;
  obj[4] = end;
...
export const ChannelOverwritesCheckboxItem = function ChannelOverwritesCheckboxItem(checked) {
  ...
  obj.trailing = callback(require(7641) /* FormCheckbox */.FormCheckbox, { checked });
