...
// Function ID: 8859
// Name: RemoveIcon
// Dependencies: [19, 17, 1922, 8064, 21, 4661, 4660, 1236, 4770, 4093, 5433, 7341, 6291, 8859, 8850, 4734, 1297, 8860, 8861, 4105, 8085, 2]
...
function RoleItem(arg0) {
  ...
  obj[0] = callback(require(8859) /* ShieldUserIcon */.ShieldUserIcon, obj);
  obj[1] = item.name;
  if (showType) {
...
export const ChannelOverwritesCheckboxItem = function ChannelOverwritesCheckboxItem(checked) {
  ...
  obj.trailing = callback(require(8085) /* FormCheckbox */.FormCheckbox, { checked });
