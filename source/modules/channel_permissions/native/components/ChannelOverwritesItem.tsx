...
// Function ID: 8900
// Name: RemoveIcon
// Dependencies: [19, 17, 1874, 7676, 21, 4255, 4598, 1236, 4265, 3955, 4797, 5890, 5300, 8900, 8891, 4251, 1297, 8901, 8902, 3973, 7751, 2]
// Exports: ChannelOverwritesCheckboxItem

// Module 8899 (RemoveIcon)
...
function RemoveIcon(item) {
  ...
  if (null != channelId) {
    ...
    obj = { style: null };
    obj[0] = prop;
    obj[4] = closure_7(item(5890).CircleXIcon, obj);
    tmp3Result = tmp3(item(4797).PressableOpacity, obj);
  }
  return tmp3Result;
}
function RoleItem(arg0) {
  ...
  obj[0] = callback(require(8900) /* ShieldUserIcon */.ShieldUserIcon, obj);
  obj[1] = item.name;
  if (showType) {
    subLabel = importAll(8891).getRowTypeLabel(item.rowType);
    const obj3 = importAll(8891);
  }
  obj[2] = subLabel;
  obj[3] = start;
  obj[4] = end;
...
export const ChannelOverwritesCheckboxItem = function ChannelOverwritesCheckboxItem(checked) {
  ...
  obj.trailing = callback(require(7751) /* FormCheckbox */.FormCheckbox, { checked });
