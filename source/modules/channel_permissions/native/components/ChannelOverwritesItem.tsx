...
let closure_9 = arg1(dependencyMap[5]).createStyles({ nameWrapper: {}, name: { paddingRight: 4 }, memberName: { flexShrink: 1 }, ownerIcon: { alignSelf: "center" }, roleIcon: { y: 1, isArray: 1 }, rowRemoveIconDisabled: { opacity: 0.3 } });
