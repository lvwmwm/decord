...
// Function ID: 8929
// Name: RemoveIcon
// Dependencies: [19, 17, 1903, 7704, 21, 4285, 4628, 1236, 4295, 3984, 4827, 5917, 5354, 8929, 8920, 4281, 1297, 8930, 8931, 4002, 7892, 2]
// Exports: ChannelOverwritesCheckboxItem

// Module 8928 (RemoveIcon)
...
function RemoveIcon(item) {
  ...
  if (null != channelId) {
    ...
    obj = { style: null };
    obj[0] = prop;
    obj[4] = closure_7(item(5917).CircleXIcon, obj);
    tmp3Result = tmp3(item(4827).PressableOpacity, obj);
  }
  return tmp3Result;
}
function RoleItem(arg0) {
  ...
  obj[0] = callback(require(8929) /* ShieldUserIcon */.ShieldUserIcon, obj);
  obj[1] = item.name;
  if (showType) {
    subLabel = importAll(8920).getRowTypeLabel(item.rowType);
    const obj3 = importAll(8920);
  }
  obj[2] = subLabel;
  obj[3] = start;
  obj[4] = end;
...
export const ChannelOverwritesCheckboxItem = function ChannelOverwritesCheckboxItem(checked) {
  ...
  obj.trailing = callback(require(7892) /* FormCheckbox */.FormCheckbox, { checked });
