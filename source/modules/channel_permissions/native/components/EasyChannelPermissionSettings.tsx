...
// Module 15372 (ChannelPermissionSettingsBasicView)
...
obj = {};
obj = { end: null, y: null, backgroundColor: importDefault(dependencyMap[16]).colors.BACKGROUND_BASE_LOWER };
obj.container = obj;
obj.content = { pos: "Group 11", borderRadius: 2 };
