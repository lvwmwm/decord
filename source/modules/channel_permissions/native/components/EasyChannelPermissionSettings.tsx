...
// Dependencies: [32, 5, 19, 17, 15673, 1372, 1942, 1935, 1862, 3821, 3830, 1874, 6721, 676, 21, 4193, 712, 1480, 589, 8281, 8282, 8283, 1236, 4384, 4532, 8289, 3826, 4602, 5558, 5559, 1297, 5224, 11322, 10932, 5153, 4388, 8228, 8764, 15674, 15676, 2]
// Exports: default
        ...
        try {
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              const result = v0(8281).isPrivateGuildChannel(outer1_0);
              const obj9 = v0(8281);
              const tmp22 = v0;
              closure_0 = v0(8281).flipEveryonePermission(outer1_0, accessPermissions, result);
              ...
              if (!tmp7) {
                ...
                obj1[0] = tmp22(8281).grantUserChannelAccess(outer1_0, accessPermissions);
                return obj1;
              }
          ...
          obj3[0] = outer1_0(8282).savePermissionUpdates(outer1_0.id, items);
          return obj3;
        } catch (tmp16) {
          dependencyMap = tmp;
          throw tmp16;
