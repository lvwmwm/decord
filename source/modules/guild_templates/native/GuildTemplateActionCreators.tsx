...
// Function ID: 11078
// Name: showModal
// Dependencies: [5833, 4460, 11078, 1959, 709, 2]

// Module 11077 (showModal)
...
obj.showModal = function showModal(code) {
  ...
  obj = { code };
  obj.pushLazy(require(1959) /* asyncRequireImpl */(11078, dependencyMap.paths), obj, GUILD_TEMPLATE_MODAL_KEY);
  obj = { type: "GUILD_TEMPLATE_MODAL_SHOW", code };
  importDefault(709).dispatch(obj);
  const obj3 = importDefault(709);
  const guildTemplate = importDefault(5833).resolveGuildTemplate(code);
};
obj.hideModal = function hideModal() {
  importDefault(4460).popWithKey(GUILD_TEMPLATE_MODAL_KEY);
