// Module ID: 11730
// Function ID: 11731
// Dependencies: [19, 17, 4181, 4055, 1847, 6744, 1579, 4616, 4056, 4048, 4059, 11210, 2]
...
const memoResult = importAllResult.memo(function InlinePortalKeyboard(messagesRef) {
  ...
  const tmp2 = id(4055)();
  dependencyMap = tmp2;
  let tmp4 = id(6744)({ includeCustomKeyboard: false });
  importAllResult = tmp4;
  let tmp3 = id(1847)();
  keyboardContextForType = messagesRef(4055).useKeyboardContextForType(messagesRef(1579).KeyboardTypes.SYSTEM);
  id(4616)(() => () => {
  ...
  let PortalKeyboardUIStore = messagesRef(4056).PortalKeyboardUIStore;
  field = PortalKeyboardUIStore.useField("keyboard");
  const PortalKeyboardUIStore2 = messagesRef(4056).PortalKeyboardUIStore;
