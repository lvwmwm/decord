...
// Module 4168 (zustandStore)
const zustandStore = require("defaultStatesAreEqual").createZustandStore(() => ({ keyboard: null, state: require(4171) /* PortalKeyboardState */.PortalKeyboardState.EMPTY, renderers: [] }));
...
export const isPortalKeyboardOpenForChannel = function isPortalKeyboardOpenForChannel(arg0) {
  ...
  if (tmp3) {
    tmp3 = state === require(4171) /* PortalKeyboardState */.PortalKeyboardState.REQUEST_OPEN || state === require(4171) /* PortalKeyboardState */.PortalKeyboardState.OPENING || state === require(4171) /* PortalKeyboardState */.PortalKeyboardState.OPEN;
    const tmp6 = state === require(4171) /* PortalKeyboardState */.PortalKeyboardState.REQUEST_OPEN || state === require(4171) /* PortalKeyboardState */.PortalKeyboardState.OPENING || state === require(4171) /* PortalKeyboardState */.PortalKeyboardState.OPEN;
  }
  return tmp3;
};
...
export const closePortalKeyboard = function closePortalKeyboard() {
  zustandStore.setState({ state: require(4171) /* PortalKeyboardState */.PortalKeyboardState.CLOSED, keyboard: null });
};
export const closePortalKeyboardIfUnhandled = function closePortalKeyboardIfUnhandled() {
  ...
  if (tmp3) {
    tmp3 = tmp2 === require(4171) /* PortalKeyboardState */.PortalKeyboardState.CLOSED;
  }
  if (!tmp3) {
    let handlerId;
    if (keyboard != null) {
    ...
    if (null == handlerId) {
      ...
      obj[0] = require(4171) /* PortalKeyboardState */.PortalKeyboardState.CLOSED;
      obj.setState(obj);
    }
  }
};
