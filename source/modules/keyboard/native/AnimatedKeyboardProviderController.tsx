...
// Function ID: 10258
// Name: mutable
// Dependencies: [19, 21, 4083, 1642, 2]

// Module 10257 (mutable)
...
let closure_9 = require("noop").memo(() => {
  ...
  obj = { animatedKeyboardState: mutable1, KeyboardState: require(4083).KeyboardState };
  fn.__closure = obj;
  ...
  fn3.__closure = { animatedKeyboardState: mutable1, KeyboardState: require(4083).KeyboardState, animatedKeyboardHeight: mutable };
