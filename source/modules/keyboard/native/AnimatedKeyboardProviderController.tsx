...
// Function ID: 10212
// Name: mutable
// Dependencies: [19, 21, 4036, 1623, 2]

// Module 10211 (mutable)
...
let closure_9 = require("noop").memo(() => {
  ...
  obj = { animatedKeyboardState: mutable1, KeyboardState: require(4036).KeyboardState };
  fn.__closure = obj;
  ...
  fn3.__closure = { animatedKeyboardState: mutable1, KeyboardState: require(4036).KeyboardState, animatedKeyboardHeight: mutable };
