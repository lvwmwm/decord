...
// Function ID: 14500
// Name: mutable
// Dependencies: [19, 21, 4218, 1641, 2]

// Module 14499 (mutable)
...
const mutable1 = module_4218.makeMutable(require("module_4218").KeyboardState.UNKNOWN);
...
let closure_9 = importAllResult.memo(() => {
  ...
  const fn = function o(height) {
    if (0 === height.height) {
      let OPEN = callback(4218).KeyboardState.CLOSED;
    } else {
      OPEN = callback(4218).KeyboardState.OPEN;
    }
    const result = store2.set(OPEN);
  };
  obj = { animatedKeyboardState: mutable1, KeyboardState: _mod4218.KeyboardState };
  fn.__closure = obj;
  ...
  fn3.__closure = { animatedKeyboardState: mutable1, KeyboardState: _mod4218.KeyboardState, animatedKeyboardHeight: mutable };
