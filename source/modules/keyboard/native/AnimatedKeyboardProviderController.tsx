...
// Function ID: 10217
// Name: mutable
// Dependencies: [19, 21, 4042, 1642, 2]

// Module 10216 (mutable)
...
let closure_9 = require("noop").memo(() => {
  let obj = require(1642) /* KeyboardChatScrollView */;
  ...
  obj = { animatedKeyboardState: mutable1, KeyboardState: require(4042).KeyboardState };
  fn.__closure = obj;
  ...
  fn3.__closure = { animatedKeyboardState: mutable1, KeyboardState: require(4042).KeyboardState, animatedKeyboardHeight: mutable };
...
let obj = {
  Component(children) {
    ...
    obj[4] = items;
    return callback2(require(1642) /* KeyboardChatScrollView */.KeyboardProvider, obj);
  },
