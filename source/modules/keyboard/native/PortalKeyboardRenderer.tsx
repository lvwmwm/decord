...
// Dependencies: [19, 1476, 21, 4599, 4121, 1579, 500, 15687, 4122, 4107, 5737, 9648, 1478, 4125, 8615, 2]
// Exports: PortalKeyboardRenderer

// Module 15686 (transitionGroupGetItemKey)
...
function transitionGroupRenderItem(arg0, arg1, arg2, arg3) {
  let isAndroidResult = arg2 === require(4599) /* wrapChildrenDefault */.TransitionStates.YEETED;
  if (isAndroidResult) {
  ...
  if (!isAndroidResult) {
    ...
    obj[1] = arg2;
    obj[2] = arg3;
    tmp5 = jsx(importDefault(15687), { item: null, state: null, cleanUp: null }, arg0);
  }
  return tmp5;
}
...
export const PortalKeyboardRenderer = function PortalKeyboardRenderer(portal) {
  ...
  const tmp11 = jsx(id(4599).TransitionGroup, { items: memo, getItemKey: transitionGroupGetItemKey, renderItem: transitionGroupRenderItem });
  if (flag) {
    obj = { children: null };
    obj[0] = tmp11;
    ...
    obj1[1] = tmp11;
    tmp10Result = tmp10(tmp5(8615).PortalKeyboardInModalContext.Provider, obj1);
  }
  return tmp10Result;
};
