// Module ID: 11773
// Function ID: 11774
// Dependencies: [19, 17, 21, 4303, 712, 11761, 8762, 4299, 1236, 7967, 2]
...
const memoResult = importAllResult.memo(function GameMentionSearchBar() {
  ...
  const items = [callback(require(8762) /* GameControllerIcon */.GameControllerIcon, { size: "sm", style: tmp.icon }), ];
  const obj2 = { variant: null, color: "mobile-text-heading-primary", children: "@game" };
  obj2[0] = require(11761) /* useGameMentionSearchBarHeight */.GAME_MENTION_SEARCH_BAR_TITLE_VARIANT;
  ...
  obj3[1] = require(11761) /* useGameMentionSearchBarHeight */.GAME_MENTION_SEARCH_BAR_DESCRIPTION_VARIANT;
  const intl = require(1236) /* getSystemLocale */.intl;
  obj3[3] = intl.string(require(1236) /* getSystemLocale */.t["1kR88y"]);
  items1[1] = callback(require(4299) /* Text */.Text, obj3);
  obj[2] = items1;
  const items2 = [callback2(View, obj), callback(require(7967) /* Form */.FormDivider, { style: tmp.divider })];
  obj[1] = items2;
