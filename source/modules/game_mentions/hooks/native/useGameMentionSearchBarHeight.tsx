...
// Dependencies: [17, 9908, 2]
// Exports: default

// Module 11484 (useGameMentionSearchBarHeight)
...
export default function useGameMentionSearchBarHeight() {
  const sum = 24 + require(9908) /* map */.useScaledTextLineHeight(c3);
  const obj = require(9908) /* map */;
  return sum + require(9908) /* map */.useScaledTextLineHeight(c4) + 12 + StyleSheet.hairlineWidth;
};
