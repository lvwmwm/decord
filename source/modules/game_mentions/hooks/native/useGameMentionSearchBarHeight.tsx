...
export default function useGameMentionSearchBarHeight() {
  const sum = 24 + require(9288) /* map */.useScaledTextLineHeight(c3);
  const obj = require(9288) /* map */;
  return sum + require(9288) /* map */.useScaledTextLineHeight(c4) + 12 + StyleSheet.hairlineWidth;
};
