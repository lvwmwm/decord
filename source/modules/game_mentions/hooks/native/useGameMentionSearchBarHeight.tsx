...
// Dependencies: [17, 9341, 2]
// Exports: default

// Module 11646 (useGameMentionSearchBarHeight)
...
export default function useGameMentionSearchBarHeight() {
  const sum = 24 + require(9341) /* map */.useScaledTextLineHeight(c3);
  const obj = require(9341) /* map */;
  return sum + require(9341) /* map */.useScaledTextLineHeight(c4) + 12 + StyleSheet.hairlineWidth;
};
