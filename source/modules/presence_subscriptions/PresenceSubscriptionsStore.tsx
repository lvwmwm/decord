...
// Dependencies: [32, 4371, 4310, 10368, 4170, 589, 709, 2]

// Module 10367 (handleConnectionOpenOrResumed)
...
const delayedCall = new require("start").DelayedCall(3000, function flush() {
  ...
  if (0 !== items.length) {
    importDefault(10368).subscribeActivities(items);
    const obj = importDefault(10368);
  }
});
