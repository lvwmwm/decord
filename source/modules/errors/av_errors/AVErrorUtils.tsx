...
export const getReportInboundErrors = function getReportInboundErrors() {
  ...
  if (result) {
    ...
    const WindowVisibilityVideoManager2 = require(10672) /* isIncomingVideoEnabled */.WindowVisibilityVideoManager;
