...
export const getReportInboundErrors = function getReportInboundErrors() {
  ...
  if (result) {
    ...
    const WindowVisibilityVideoManager2 = require(10670) /* isIncomingVideoEnabled */.WindowVisibilityVideoManager;
