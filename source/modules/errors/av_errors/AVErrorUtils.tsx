...
export const getReportInboundErrors = function getReportInboundErrors() {
  ...
  if (result) {
    ...
    const WindowVisibilityVideoManager2 = require(10634) /* isIncomingVideoEnabled */.WindowVisibilityVideoManager;
