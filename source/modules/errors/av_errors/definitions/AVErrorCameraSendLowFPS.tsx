...
// Dependencies: [1218, 4351, 4375, 687, 16924, 9169, 16921, 2]

// Module 16938 (AVErrorCameraSendLowFPSDefinition)
    ...
    if (null == rTCConnection) {
      ...
      if (null == mediaEngineConnectionId) {
        ...
        if (rTCConnection.hasActiveRemoteWants()) {
          const accumulatedStatsWithMinDatapoints = require(16924) /* getReportInboundErrors */.getAccumulatedStatsWithMinDatapoints(mediaEngineConnectionId, id.getId());
          let tmp7 = null;
