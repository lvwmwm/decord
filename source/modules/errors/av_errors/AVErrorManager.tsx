...
// Function ID: 17007
// Name: setDifference
// Dependencies: [109, 4364, 1979, 4361, 10675, 3, 17007, 5322, 9233, 709, 17027, 2]

// Module 17006 (setDifference)
...
function makeErrorKey(item10044) {
  const obj = require(17007) /* ErrorDefinitions */.ErrorDefinitions[item10044.type];
  let errorContextKey;
  if (obj != null) {
...
prototype["updateActiveErrors"] = function updateActiveErrors() {
  ...
  const map = new Map();
  const values = Object.values(require(17007) /* ErrorDefinitions */.ErrorDefinitions);
...
prototype["handleReportAVError"] = function handleReportAVError(arg0) {
  ...
  let error;
  ({ error, context } = arg0);
  const result = require(17027) /* getCurrentScreenshareCaptureMethod */.sendAVErrorAnalyticsEvent(error, context);
};
