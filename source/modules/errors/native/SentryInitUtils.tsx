...
// Dependencies: [5, 27, 653, 482, 787, 3, 1186, 1198, 675, 13188, 5839, 5844, 13189, 1184, 1554, 5840, 477, 4111, 1553, 5907, 650, 3995, 2]
// Exports: initSentry
...
function trackCrash(event, extra, arg2) {
  ...
  markCrashHandled(event.event_id);
  const AppCrashedReasons = require(13188) /* set */.AppCrashedReasons;
  ...
  obj1 = { name: require(5844) /* set */.MetricEvents.APP_CRASHED };
  ...
  items[1] = "level:" + str7;
  obj1.tags = items;
  importDefault(5839).increment(obj1, true);
}
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          obj.release = "discord_android@340.6.0-2+340206";
          ...
          outer1_0(outer1_3[4]).setTag("buildNumber", "6075");
