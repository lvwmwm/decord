...
// Dependencies: [5, 27, 653, 482, 787, 3, 1186, 1198, 675, 13189, 5839, 5844, 13190, 1184, 1554, 5840, 477, 4111, 1553, 5907, 650, 3995, 2]
// Exports: initSentry
...
function trackCrash(event, extra, arg2) {
  ...
  markCrashHandled(event.event_id);
  const AppCrashedReasons = require(13189) /* set */.AppCrashedReasons;
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          obj.release = "discord_android@341.0.0-2+341200";
          ...
          outer1_0(outer1_3[4]).setTag("buildNumber", "6081");
