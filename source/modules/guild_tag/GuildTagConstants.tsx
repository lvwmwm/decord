...
const obj2 = { [GUILD_TAGS_BADGE_PACK_PETS]: require("VANITY_URL_POWERUP_SKU_ID").GUILD_TAGS_BADGE_PACK_PETS_POWERUP_SKU_ID, [GUILD_TAGS_BADGE_PACK_FLEX]: require("VANITY_URL_POWERUP_SKU_ID").GUILD_TAGS_BADGE_PACK_FLEX_POWERUP_SKU_ID, [GUILD_TAGS_BADGE_PACK_PLANT]: require("VANITY_URL_POWERUP_SKU_ID").GUILD_TAGS_BADGE_PACK_PLANT_POWERUP_SKU_ID, [GUILD_TAGS_BADGE_PACK_CREEPY_CRAWLIES]: require("VANITY_URL_POWERUP_SKU_ID").GUILD_TAGS_BADGE_PACK_CREEPY_CRAWLIES_POWERUP_SKU_ID };
const result = require("set").fileFinishedImporting("modules/guild_tag/GuildTagConstants.tsx");
