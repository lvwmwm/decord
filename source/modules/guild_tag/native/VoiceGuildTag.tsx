...
// Dependencies: [19, 17, 1922, 8207, 21, 500, 4668, 712, 589, 8414, 9546, 4739, 2]
// Exports: default

// Module 15451 (VoiceGuildTagChiplet)
...
export default function VoiceGuildTagChiplet(userId) {
  ...
  if (null != guildId) {
    if (null != tag) {
      ...
      const guildTagBadgeUrl = tmp2(8414).getGuildTagBadgeUrl(guildId, tmp7, GuildTagBadgeSize.SIZE_12);
      obj1 = { source: null, size: null };
      const obj2 = { uri: null };
      obj2[0] = guildTagBadgeUrl;
      obj1[0] = obj2;
      obj1[1] = GuildTagBadgeSize.SIZE_12;
      const items2 = [callback(tmp2(9546).GuildTagBadge, obj1), ];
      const obj3 = { variant: "text-xs/semibold", color: "text-default", style: null, children: null };
      obj3[2] = tmp.tag;
      obj3[3] = tag;
      items2[1] = callback(tmp2(4739).Text, obj3);
      obj[1] = items2;
