...
// Dependencies: [19, 17, 1922, 8118, 21, 500, 4342, 712, 589, 8336, 9316, 4338, 2]
// Exports: default

// Module 15337 (VoiceGuildTagChiplet)
import "noop";
...
export default function VoiceGuildTagChiplet(userId) {
  ...
  if (null != guildId) {
    if (null != tag) {
      ...
      const guildTagBadgeUrl = tmp2(8336).getGuildTagBadgeUrl(guildId, tmp7, GuildTagBadgeSize.SIZE_12);
      obj1 = { source: null, size: null };
      const obj2 = { uri: null };
      obj2[0] = guildTagBadgeUrl;
      obj1[0] = obj2;
      obj1[1] = GuildTagBadgeSize.SIZE_12;
      const items2 = [callback(tmp2(9316).GuildTagBadge, obj1), ];
