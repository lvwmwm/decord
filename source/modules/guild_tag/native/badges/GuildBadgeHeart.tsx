...
let closure_5 = [];
const items = [{ accessibilityRole: "Array", s: "isArray" }, { accessibilityRole: "\u{1F4A0}", s: 6 }, {}];
...
export const GuildBadgeHeart = function GuildBadgeHeart(primaryTintColor) {
  ...
  obj["fill"] = "none";
  const items = [callback(arg1(dependencyMap[3]).Path, { "Bool(true)": null, "Bool(true)": null }), , , , , , ];
