...
let closure_4 = ["Array", "isArray", "transform"];
let closure_5 = [false, false, false];
const items = [{}, {}, { GameplayAbstractUI: "y", cwd: "getTimestampAccessibilityLabel" }];
