...
let closure_5 = ["<string:1215823874>", "<string:1205010434>", "<string:2586968066>"];
const items = [{ GameplayAbstractUI: "y", cwd: "getTimestampAccessibilityLabel" }, { GameplayAbstractUI: "<string:16777735>", cwd: "<string:37775937>" }, {}];
