...
const items = [{ "Null": "r", "Null": "NATIVE_REQUIRED_ASSETS_ICONS" }, { "Null": "\u{1F4A0}", "Null": 6 }, { "Null": "Array", "Null": "isArray" }];
let closure_8 = [];
const items1 = [{ "Null": "r", "Null": "NATIVE_REQUIRED_ASSETS_ICONS" }, { "Null": "\u{1F4A0}", "Null": 6 }, { "Null": "Array", "Null": "isArray" }];
