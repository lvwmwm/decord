...
export const GuildBadgePottedPlant = function GuildBadgePottedPlant(width) {
  ...
  items = [callback(require(8507) /* inlineStyles */.Path, obj1), callback(require(8507) /* inlineStyles */.Path, { d: "M8 9h-1V4h1v5Z", fill: primaryColorsTransformed[2] }), , , , , , , , ];
  const obj3 = { d: "M6 3h1v1h-1v1h-1v-1h-1v1H2V2h4v1Zm-3 1h1v-1h-1v1Z", fill: primaryColorsTransformed[2], fillRule: "evenodd" };
  items[2] = callback(require(8507) /* inlineStyles */.Path, obj3);
  items[3] = callback(require(8507) /* inlineStyles */.Path, { d: "M14 3h-2v1h-1v1h-1v-2h1V2h3v1Z", fill: primaryColorsTransformed[2] });
  items[4] = callback(require(8507) /* inlineStyles */.Path, { d: "M9 9h-1V4h1v5ZM5 6h-2v-1h2v1ZM15 4h-1v1h-1v1h-2v-1h1v-1h1v-1h1V2h1v2Z", fill: primaryColorsTransformed[1] });
  ...
  obj6.fill = str;
  items[5] = callback(require(8507) /* inlineStyles */.Path, obj6);
  items[6] = callback(require(8507) /* inlineStyles */.Path, { d: "M4 14h-1v-2h1v2ZM5 11h-2v-1h2v1ZM2 4H1V2h1v2ZM10 4h-1v-1h1v1ZM11 3h-1V2h1v1ZM5 2H2V1h3v1ZM14 2H11V1h3v1Z", fill: "white" });
  ...
  obj7.fill = str2;
  items[7] = callback(require(8507) /* inlineStyles */.Path, obj7);
