...
// Function ID: 13142
// Name: GuildBadge
// Dependencies: [19, 7834, 21, 13142, 13145, 13146, 13147, 13148, 13149, 13150, 13151, 13152, 13153, 13154, 13155, 13156, 13157, 13158, 13159, 13160, 13161, 13162, 13163, 13164, 13165, 13166, 13167, 13168, 13169, 13170, 13171, 13172, 13173, 13174, 13175, 13176, 13177, 13178, 13179, 13180, 13181, 13182, 13183, 13184, 2]
// Exports: GuildBadge

// Module 13141 (GuildBadge)
import "items";
...
export const GuildBadge = function GuildBadge(arg0) {
  ...
  if (GuildTagBadgeKind.SWORD === badge) {
    ...
    return jsx(require(13142) /* items */.GuildBadgeSword, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj;
    merged = Object.assign(merged);
    return jsx(require(13145) /* items */.GuildBadgeWaterDrop, { primaryTintColor: null });
    ...
    merged = obj1;
    merged = Object.assign(merged);
    return jsx(require(13146) /* items */.GuildBadgeSkull, { primaryTintColor: null });
    ...
    merged = obj2;
    merged = Object.assign(merged);
    return jsx(require(13147) /* items */.GuildBadgeToadstool, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj3;
    merged = Object.assign(merged);
    return jsx(require(13148) /* items */.GuildBadgeMoon, { primaryTintColor: null });
    ...
    merged = obj4;
    merged = Object.assign(merged);
    return jsx(require(13149) /* items */.GuildBadgeLightning, { primaryTintColor: null });
    ...
    merged = obj5;
    merged = Object.assign(merged);
    return jsx(require(13150) /* items */.GuildBadgeLeaf, { primaryTintColor: null });
    ...
    merged = obj6;
    merged = Object.assign(merged);
    return jsx(require(13151) /* items */.GuildBadgeHeart, { primaryTintColor: null });
    ...
    merged = obj7;
    merged = Object.assign(merged);
    return jsx(require(13152) /* items */.GuildBadgeFire, { primaryTintColor: null });
    ...
    merged = obj8;
    merged = Object.assign(merged);
    return jsx(require(13153) /* items */.GuildBadgeCompass, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj9;
    merged = Object.assign(merged);
    return jsx(require(13154) /* items */.GuildBadgeCrosshairs, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj10;
    merged = Object.assign(merged);
    return jsx(require(13155) /* items */.GuildBadgeFlower, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj11;
    merged = Object.assign(merged);
    return jsx(require(13156) /* items */.GuildBadgeForce, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj12;
    merged = Object.assign(merged);
    return jsx(require(13157) /* items */.GuildBadgeGem, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj13;
    merged = Object.assign(merged);
    return jsx(require(13158) /* items */.GuildBadgeLava, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj14;
    merged = Object.assign(merged);
    return jsx(require(13159) /* items */.GuildBadgePsychic, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj15;
    merged = Object.assign(merged);
    return jsx(require(13160) /* items */.GuildBadgeSmoke, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj16;
    merged = Object.assign(merged);
    return jsx(require(13161) /* items */.GuildBadgeSnow, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj17;
    merged = Object.assign(merged);
    return jsx(require(13162) /* items */.GuildBadgeSound, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj18;
    merged = Object.assign(merged);
    return jsx(require(13163) /* items */.GuildBadgeSun, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj19;
    merged = Object.assign(merged);
    return jsx(require(13164) /* items */.GuildBadgeWind, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj20;
    merged = Object.assign(merged);
    return jsx(require(13165) /* items */.GuildBadgeBunny, { primaryTintColor: null });
    ...
    merged = obj21;
    merged = Object.assign(merged);
    return jsx(require(13166) /* items */.GuildBadgeDog, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj22;
    merged = Object.assign(merged);
    return jsx(require(13167) /* items */.GuildBadgeFrog, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj23;
    merged = Object.assign(merged);
    return jsx(require(13168) /* items */.GuildBadgeGoat, { primaryTintColor: null });
  } else if (tmp2.CAT === badge) {
    const obj24 = { primaryTintColor: null };
    obj24[0] = primaryTintColor;
    const merged1 = Object.assign(merged);
    return jsx(require(13169) /* items */.GuildBadgeCat, { primaryTintColor: null });
  } else if (tmp2.DIAMOND === badge) {
    const obj25 = { primaryTintColor: null };
    obj25[0] = primaryTintColor;
    const merged2 = Object.assign(merged);
    return jsx(require(13170) /* items */.GuildBadgeDiamond, { primaryTintColor: null });
    ...
    return jsx(require(13177) /* items */.GuildBadgePottedPlant, { primaryTintColor: null, secondaryTintColor: null });
  } else if (tmp2.MAPLE === badge) {
    const obj33 = { primaryTintColor: null };
    obj33[0] = primaryTintColor;
    const merged10 = Object.assign(merged);
    return jsx(require(13178) /* items */.GuildBadgeMaple, { primaryTintColor: null });
    ...
    return jsx(require(13179) /* items */.GuildBadgeWiltedFlower, { primaryTintColor: null, secondaryTintColor: null });
    ...
    return jsx(require(13180) /* items */.GuildBadgeButterfly, { primaryTintColor: null, secondaryTintColor: null });
    ...
    return jsx(require(13181) /* items */.GuildBadgeSnail, { primaryTintColor: null, secondaryTintColor: null });
    ...
    return jsx(require(13182) /* items */.GuildBadgeCaterpillar, { primaryTintColor: null, secondaryTintColor: null });
    ...
    return jsx(require(13183) /* items */.GuildBadgeSpider, { primaryTintColor: null, secondaryTintColor: null });
  } else if (tmp2.BEE === badge) {
    obj = { primaryTintColor: null };
    obj[0] = primaryTintColor;
    const merged16 = Object.assign(merged);
    return jsx(require(13184) /* items */.GuildBadgeBee, { primaryTintColor: null });
  } else {
    return null;
  }
};
