...
// Function ID: 100742
// Name: GuildBadge
// Dependencies: [31, 7665, 33, 12986, 12989, 12990, 12991, 12992, 12993, 12994, 12995, 12996, 12997, 12998, 12999, 13000, 13001, 13002, 13003, 13004, 13005, 13006, 13007, 13008, 13009, 13010, 13011, 13012, 13013, 13014, 13015, 13016, 13017, 13018, 13019, 13020, 13021, 13022, 13023, 13024, 13025, 13026, 13027, 13028, 2]
// Exports: GuildBadge

// Module 12985 (GuildBadge)
import "items";
...
export const GuildBadge = function GuildBadge(arg0) {
  ...
  if (GuildTagBadgeKind.SWORD === badge) {
    ...
    return jsx(require(13021) /* items */.GuildBadgePottedPlant, { primaryTintColor, secondaryTintColor });
  } else if (GuildTagBadgeKind.MAPLE === badge) {
    const obj33 = { primaryTintColor };
    const merged10 = Object.assign(merged);
    return jsx(require(13022) /* items */.GuildBadgeMaple, { primaryTintColor });
    ...
    return jsx(require(13023) /* items */.GuildBadgeWiltedFlower, { primaryTintColor, secondaryTintColor });
    ...
    return jsx(require(13024) /* items */.GuildBadgeButterfly, { primaryTintColor, secondaryTintColor });
  } else if (GuildTagBadgeKind.SNAIL === badge) {
    const obj36 = { primaryTintColor, secondaryTintColor };
    const merged13 = Object.assign(merged);
    return jsx(require(13025) /* items */.GuildBadgeSnail, { primaryTintColor, secondaryTintColor });
    ...
    return jsx(require(13026) /* items */.GuildBadgeCaterpillar, { primaryTintColor, secondaryTintColor });
  } else if (GuildTagBadgeKind.SPIDER === badge) {
    const obj38 = { primaryTintColor, secondaryTintColor };
    const merged15 = Object.assign(merged);
    return jsx(require(13027) /* items */.GuildBadgeSpider, { primaryTintColor, secondaryTintColor });
  } else if (GuildTagBadgeKind.BEE === badge) {
    const obj39 = { primaryTintColor };
    const merged16 = Object.assign(merged);
    return jsx(require(13028) /* items */.GuildBadgeBee, { primaryTintColor });
  } else {
    return null;
  }
};
