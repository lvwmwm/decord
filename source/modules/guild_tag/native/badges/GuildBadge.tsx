...
// Function ID: 13331
// Name: GuildBadge
// Dependencies: [19, 8097, 21, 13331, 13334, 13335, 13336, 13337, 13338, 13339, 13340, 13341, 13342, 13343, 13344, 13345, 13346, 13347, 13348, 13349, 13350, 13351, 13352, 13353, 13354, 13355, 13356, 13357, 13358, 13359, 13360, 13361, 13362, 13363, 13364, 13365, 13366, 13367, 13368, 13369, 13370, 13371, 13372, 13373, 2]
// Exports: GuildBadge

// Module 13330 (GuildBadge)
import "items";
...
export const GuildBadge = function GuildBadge(arg0) {
  ...
  if (GuildTagBadgeKind.SWORD === badge) {
    ...
    return jsx(require(13331) /* items */.GuildBadgeSword, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj;
    merged = Object.assign(merged);
    return jsx(require(13334) /* items */.GuildBadgeWaterDrop, { primaryTintColor: null });
    ...
    merged = obj1;
    merged = Object.assign(merged);
    return jsx(require(13335) /* items */.GuildBadgeSkull, { primaryTintColor: null });
    ...
    merged = obj2;
    merged = Object.assign(merged);
    return jsx(require(13336) /* items */.GuildBadgeToadstool, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj3;
    merged = Object.assign(merged);
    return jsx(require(13337) /* items */.GuildBadgeMoon, { primaryTintColor: null });
    ...
    merged = obj4;
    merged = Object.assign(merged);
    return jsx(require(13338) /* items */.GuildBadgeLightning, { primaryTintColor: null });
    ...
    merged = obj5;
    merged = Object.assign(merged);
    return jsx(require(13339) /* items */.GuildBadgeLeaf, { primaryTintColor: null });
    ...
    merged = obj6;
    merged = Object.assign(merged);
    return jsx(require(13340) /* items */.GuildBadgeHeart, { primaryTintColor: null });
    ...
    merged = obj7;
    merged = Object.assign(merged);
    return jsx(require(13341) /* items */.GuildBadgeFire, { primaryTintColor: null });
    ...
    merged = obj8;
    merged = Object.assign(merged);
    return jsx(require(13342) /* items */.GuildBadgeCompass, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj9;
    merged = Object.assign(merged);
    return jsx(require(13343) /* items */.GuildBadgeCrosshairs, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj10;
    merged = Object.assign(merged);
    return jsx(require(13344) /* items */.GuildBadgeFlower, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj11;
    merged = Object.assign(merged);
    return jsx(require(13345) /* items */.GuildBadgeForce, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj12;
    merged = Object.assign(merged);
    return jsx(require(13346) /* items */.GuildBadgeGem, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj13;
    merged = Object.assign(merged);
    return jsx(require(13347) /* items */.GuildBadgeLava, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj14;
    merged = Object.assign(merged);
    return jsx(require(13348) /* items */.GuildBadgePsychic, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj15;
    merged = Object.assign(merged);
    return jsx(require(13349) /* items */.GuildBadgeSmoke, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj16;
    merged = Object.assign(merged);
    return jsx(require(13350) /* items */.GuildBadgeSnow, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj17;
    merged = Object.assign(merged);
    return jsx(require(13351) /* items */.GuildBadgeSound, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj18;
    merged = Object.assign(merged);
    return jsx(require(13352) /* items */.GuildBadgeSun, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj19;
    merged = Object.assign(merged);
    return jsx(require(13353) /* items */.GuildBadgeWind, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj20;
    merged = Object.assign(merged);
    return jsx(require(13354) /* items */.GuildBadgeBunny, { primaryTintColor: null });
    ...
    merged = obj21;
    merged = Object.assign(merged);
    return jsx(require(13355) /* items */.GuildBadgeDog, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj22;
    merged = Object.assign(merged);
    return jsx(require(13356) /* items */.GuildBadgeFrog, { primaryTintColor: null, secondaryTintColor: null });
    ...
    merged = obj23;
    merged = Object.assign(merged);
    return jsx(require(13357) /* items */.GuildBadgeGoat, { primaryTintColor: null });
  } else if (tmp2.CAT === badge) {
    const obj24 = { primaryTintColor: null };
    obj24[0] = primaryTintColor;
    const merged1 = Object.assign(merged);
    return jsx(require(13358) /* items */.GuildBadgeCat, { primaryTintColor: null });
  } else if (tmp2.DIAMOND === badge) {
    const obj25 = { primaryTintColor: null };
    obj25[0] = primaryTintColor;
    const merged2 = Object.assign(merged);
    return jsx(require(13359) /* items */.GuildBadgeDiamond, { primaryTintColor: null });
    ...
    return jsx(require(13366) /* items */.GuildBadgePottedPlant, { primaryTintColor: null, secondaryTintColor: null });
  } else if (tmp2.MAPLE === badge) {
    const obj33 = { primaryTintColor: null };
    obj33[0] = primaryTintColor;
    const merged10 = Object.assign(merged);
    return jsx(require(13367) /* items */.GuildBadgeMaple, { primaryTintColor: null });
    ...
    return jsx(require(13368) /* items */.GuildBadgeWiltedFlower, { primaryTintColor: null, secondaryTintColor: null });
    ...
    return jsx(require(13369) /* items */.GuildBadgeButterfly, { primaryTintColor: null, secondaryTintColor: null });
    ...
    return jsx(require(13370) /* items */.GuildBadgeSnail, { primaryTintColor: null, secondaryTintColor: null });
    ...
    return jsx(require(13371) /* items */.GuildBadgeCaterpillar, { primaryTintColor: null, secondaryTintColor: null });
    ...
    return jsx(require(13372) /* items */.GuildBadgeSpider, { primaryTintColor: null, secondaryTintColor: null });
  } else if (tmp2.BEE === badge) {
    obj = { primaryTintColor: null };
    obj[0] = primaryTintColor;
    const merged16 = Object.assign(merged);
    return jsx(require(13373) /* items */.GuildBadgeBee, { primaryTintColor: null });
  } else {
    return null;
  }
};
