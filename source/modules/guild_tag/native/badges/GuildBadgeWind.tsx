...
const items = [{ "Null": "r", "Null": "NATIVE_REQUIRED_ASSETS_ICONS" }, { "Null": null, "Null": null }, { "Null": null, "Null": null }, {}];
let closure_8 = ["eligibleToReceivePremiumRewards", "DOCUMENT_POSITION_PRECEDING", "uniqueDwelledCount"];
const items1 = [{ "Null": "\u{1F4A0}", "Null": 6 }, { "Null": null, "Null": null }, {}];
