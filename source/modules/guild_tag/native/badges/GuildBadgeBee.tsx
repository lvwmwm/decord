...
let closure_4 = [];
let closure_5 = ["%StringIteratorPrototype%", "flattenSource"];
const items = [{}, {}];
...
export const GuildBadgeBee = function GuildBadgeBee(primaryTintColor) {
  ...
  obj["fill"] = "none";
  const items = [callback(arg1(dependencyMap[3]).Path, { "Bool(false)": "Array", "Bool(false)": "isArray" }), callback(arg1(dependencyMap[3]).Path, {}), callback(arg1(dependencyMap[3]).Path, {}), , , , , ];
  ...
  items[5] = callback(arg1(dependencyMap[3]).Path, { "Bool(false)": 3, "Bool(false)": 8 });
  items[6] = callback(arg1(dependencyMap[3]).Path, {});
  items[7] = callback(arg1(dependencyMap[3]).Path, { "Bool(false)": 10, "Bool(false)": true });
  obj["children"] = items;
