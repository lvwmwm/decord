...
let closure_5 = [];
const items = [{}, {}];
let closure_7 = ["container"];
let closure_8 = ["swipeUp"];
const items1 = [{}];
...
export const GuildBadgeCaterpillar = function GuildBadgeCaterpillar(width) {
  ...
  const items = [callback(arg1(dependencyMap[3]).Path, obj1), callback(arg1(dependencyMap[3]).Path, { "Bool(false)": "rgba(255,255,255,0.1)", "Bool(false)": "-100%" }), callback(arg1(dependencyMap[3]).Path, { d: "M4 14h-1v-1h1v1ZM3 13H2v-1h1v1ZM5 10h1v2h-1v-1h-1v-2h1v1ZM12 9h-1v1h-1V7h1v-1h1v3ZM6 5h1v2h-2V4h1v1ZM9 4h-2V2h2v2Z", fill: primaryColorsTransformed[0] }), , ];
