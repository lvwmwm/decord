...
const items = [{ accessibilityRole: null, s: null }, { accessibilityRole: null, s: null }, { accessibilityRole: null, s: null }];
let closure_8 = [];
