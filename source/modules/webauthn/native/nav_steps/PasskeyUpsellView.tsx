...
// Dependencies: [32, 19, 17, 13752, 676, 1369, 21, 4189, 712, 1480, 1236, 13757, 13758, 5143, 1945, 5177, 13761, 4185, 500, 4600, 9197, 2]
// Exports: default

// Module 13756 (PasskeyUpsellView)
...
export default function PasskeyUpsellView() {
  ...
  function onCancel() {
    callback(13757).markDismissed(constants.USER_DISMISS);
    const obj = callback(13757);
    const result = callback(13758).closePasskeyUpsellModal();
  }
  ...
  items1[1] = callback(navigation(4185).Text, obj3);
  ...
  obj4[3] = stringResult;
  items1[2] = callback(navigation(4185).Text, obj4);
  obj1[1] = items1;
  ...
  items3[1] = callback(navigation(4185).Text, obj8);
  obj6[1] = items3;
  ...
  items5[1] = callback(navigation(4185).Text, obj11);
  obj9[1] = items5;
  ...
  const items6 = [callback(navigation(4185).Text, obj13), , ];
  ...
  items6[1] = callback(navigation(4600).Button, {
    text: string3Result,
    onPress() {
  ...
  items6[2] = callback(navigation(4600).Button, { text: string4Result, onPress: onCancel, size: "lg", variant: "secondary", grow: true });
  obj12[1] = items6;
  items2[2] = closure_12(closure_5, obj12);
  obj[1] = items2;
  obj[2] = closure_12(tmp12, obj);
  return callback(navigation(5177).SafeAreaPaddingView, obj);
};
