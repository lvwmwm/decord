...
// Dependencies: [57, 31, 27, 13731, 653, 1345, 33, 4165, 689, 1456, 1212, 13736, 13737, 5121, 1921, 5155, 13740, 4161, 477, 4578, 9173, 2]
// Exports: default

// Module 13735 (PasskeyUpsellView)
...
export default function PasskeyUpsellView() {
  ...
  const obj2 = { source: importDefault(13740), style: tmp2.headerImage };
  ...
  items1[1] = callback(navigation(4161).Text, obj3);
  ...
  items1[2] = callback(navigation(4161).Text, obj4);
  ...
  items3[1] = callback(navigation(4161).Text, obj8);
  ...
  items5[1] = tmp16(navigation(4161).Text, obj11);
  ...
  const items6 = [callback(navigation(4161).Text, obj13), , ];
  const obj14 = {};
  ...
  obj14.loading = tmp5;
  obj14.grow = true;
  items6[1] = callback(navigation(4578).Button, obj14);
  ...
  items6[2] = callback(navigation(4578).Button, obj15);
  obj12.children = items6;
  items2[2] = callback2(closure_5, obj12);
  obj.children = items2;
  obj.children = callback2(tmp10, obj);
  return callback(navigation(5155).SafeAreaPaddingView, obj);
};
