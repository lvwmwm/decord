...
// Dependencies: [32, 19, 17, 13747, 21, 4189, 712, 9193, 1236, 1297, 1480, 500, 5177, 13765, 4185, 5022, 4600, 2]
// Exports: default

// Module 13764 (AndroidPasskeyRadioGroup)
...
export default function WebAuthnRegisterStep() {
  ...
  const items3 = [callback(navigation(13765).KeyImage, {}), , ];
  ...
  obj1[2] = stringResult;
  items3[1] = callback(navigation(4185).Text, obj1);
  let tmp18Result = null != tmp10;
  if (tmp18Result) {
    obj2 = { variant: "text-md/normal", color: "text-feedback-critical", children: null };
    obj2[2] = tmp10;
    tmp18Result = tmp18(tmp(4185).Text, obj2);
  }
  items3[2] = tmp18Result;
  obj[1] = items3;
  const items4 = [closure_8(closure_5, obj), , ];
  let shouldDisplayAndroidFidoSelector = importDefault(9193).shouldDisplayAndroidFidoSelector;
  ...
  items4[2] = callback(navigation(5022).ButtonGroup, { children: callback(navigation(4600).Button, obj5) });
  obj[4] = items4;
  return closure_8(navigation(5177).SafeAreaPaddingView, obj);
};
