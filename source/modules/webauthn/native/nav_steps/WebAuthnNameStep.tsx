...
// Dependencies: [5, 32, 19, 17, 14033, 21, 4344, 1499, 5870, 4062, 1236, 10071, 4305, 8008, 1297, 4754, 2]
// Exports: default

// Module 14053 (WebAuthnNameStep)
...
export default function WebAuthnNameStep(arg0) {
  ...
  const items = [callback2(require(8008) /* Form */.FormInput, obj), callback2(require(8008) /* Form */.FormDivider, {}), ];
