// Module ID: 13972
// Function ID: 13973
// Dependencies: [4123, 1358, 1360, 4509, 13973, 1988, 4271, 13974, 13976, 2]
...
export default {
  ...
  openPasskeyUpsellModal() {
    importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(13973, dependencyMap.paths), undefined, PASSKEY_UPSELL_KEY);
  },
  closePasskeyUpsellModal() {
    importDefault(4509).popWithKey(PASSKEY_UPSELL_KEY);
  },
  openPasskeyUpsellPromoSheet() {
    importDefault(4271).openLazy(require(1988) /* asyncRequireImpl */(13974, dependencyMap.paths), PASSKEY_UPSELL_KEY);
  },
  closePasskeyUpsellPromoSheet() {
    importDefault(4271).hideActionSheet(PASSKEY_UPSELL_KEY);
  },
  openPasskeyUpsellPromoModal(closure_0) {
    importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(13976, dependencyMap.paths), closure_0, PASSKEY_UPSELL_KEY);
  }
};
