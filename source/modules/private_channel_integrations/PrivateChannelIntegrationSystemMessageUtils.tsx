...
// Module 8103 (getPrivateChannelIntegrationAddedSystemMessageContent)
import ME from "ME";
...
export const getPrivateChannelIntegrationAddedSystemMessageContent = function getPrivateChannelIntegrationAddedSystemMessageContent(applicationNameHook) {
  ...
  if (null != application) {
    ...
    obj[4] = importDefault(1974).getArticleURL(constants.PRIVATE_CHANNEL_INTEGRATIONS);
    ...
    obj[0] = username;
    obj[1] = usernameHook;
    obj[2] = importDefault(1974).getArticleURL(constants.PRIVATE_CHANNEL_INTEGRATIONS);
...
export const getPrivateChannelIntegrationAddedSystemMessageASTContent = function getPrivateChannelIntegrationAddedSystemMessageASTContent(arg0) {
  ...
  if (null != application) {
    ...
    obj[4] = medium;
    obj = { url: null };
    obj[0] = importDefault(1974).getArticleURL(constants.PRIVATE_CHANNEL_INTEGRATIONS);
    obj[5] = obj;
    ...
    obj[2] = medium;
    const obj1 = { url: null };
    obj1[0] = importDefault(1974).getArticleURL(constants.PRIVATE_CHANNEL_INTEGRATIONS);
    obj[3] = obj1;
