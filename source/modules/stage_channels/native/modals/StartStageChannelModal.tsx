...
const forwardRefResult = importAllResult.forwardRef((channel) => {
  ...
  obj.children = items3;
  obj3 = { -1636630524: true, -1976696828: true, -1610678268: true, style: tmp.container };
  ...
  if (null == guild) {
    const obj13 = { "Bool(false)": null, "Bool(false)": null, style: tmp.container };
