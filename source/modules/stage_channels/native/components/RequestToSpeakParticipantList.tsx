...
// Dependencies: [31, 33, 689, 3831, 10666, 2, 31, 33, 689, 3831, 10668, 2, 1838, 3756, 4142, 482, 566, 4308, 2, 31, 33, 4960, 4954]
// Exports: default

// Module 10654 (RequestToSpeakParticipant)
import "module_31";
import { View } from "module_33";
import BaseIconImage from "BaseIconImage";
import module_10666 from "module_10666";
...
function RequestToSpeakParticipant(participant) {
  ...
  const obj5 = { cachedAt: true, edpbxy: true, children: arg1(dependencyMap[9]).participantMemberInfo(participant) };
...
module_10666 = { container: {}, listContainer: { 0: false, -9223372036854775808: false, 0: false }, participantItemContainer: {}, touchableContainer: {}, participantAvatarContainer: { paddingLeft: 4 }, participantNameplateContainer: { lastDismissedObjectId: null, isNewWebImplementationEnabled: "Group 11" } };
module_10666 = { fontFamily: require("_createForOfIteratorHelperLoose").Fonts.PRIMARY_SEMIBOLD, color: require("result2").colors.MOBILE_TEXT_HEADING_PRIMARY };
module_10666.participantNameplateText = module_10666;
module_10666.participantActionContainer = {};
module_10666.participantActionIcon = { backgroundColor: require("result2").colors.BACKGROUND_BASE_LOW };
module_10666.emptyContainer = {};
module_10666.emptyParticipant = {};
module_10666.emptyTitle = { <string:787648700>: null, justifyContent: "\u{1F450}\u{1F3FE}", alignItems: true };
module_10666.emptyBody = { textAlign: "center" };
module_10666 = module_10666.createStyles(module_10666);
...
export default function RequestToSpeakParticipantList(channel) {
  ...
  if (0 === sortedRequestToSpeakParticipants.length) {
    ...
    const obj2 = { style: tmp.emptyTitle };
    const intl = arg1(dependencyMap[13]).intl;
