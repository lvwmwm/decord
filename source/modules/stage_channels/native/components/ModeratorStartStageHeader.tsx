// Module ID: 10821
// Function ID: 10822
// Dependencies: [19, 17, 21, 4255, 5220, 10780, 10776, 2]
...
const memoResult = require("noop").memo((channel) => {
  ...
  const items = [callback(require(10776) /* HideStageChannelCallIcon */.HideStageChannelCallIcon, { channel }), callback(require(10776) /* HideStageChannelCallIcon */.StageChannelCallHeader, { channel }), , ];
  if (speaker) {
    obj = { channelId: null };
    obj[0] = channel.id;
  ...
  items[3] = callback(require(10776) /* HideStageChannelCallIcon */.StageInviteButton, obj);
  obj[2] = items;
