// Module ID: 10002
// Function ID: 10003
// Dependencies: [19, 17, 21, 4481, 5637, 9962, 9956, 2]

// Module 10002
import HideStageChannelCallIcon from "HideStageChannelCallIcon" /* 9956 */;
...
const memoResult = importAllResult.memo((channel) => {
  ...
  if (speaker) {
    obj = { channelId: null };
    obj[0] = channel.id;
    speaker = tmp7(tmp8(9956).MusicMuteButton, obj);
  }
  items[2] = speaker;
