...
// Function ID: 8072
// Name: RestrictedUser
// Dependencies: [32, 19, 17, 3998, 5201, 5194, 21, 4342, 712, 589, 1236, 1297, 8072, 4338, 4310, 8073, 5389, 4777, 5458, 8074, 2]
// Exports: default

// Module 8071 (RestrictedUser)
...
function RestrictedUser(guildId) {
  ...
  const items5 = [callback(require(4338) /* Text */.Text, obj5), ];
  ...
  items8[1] = closure_10(require(4338) /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", children: items9 });
  obj7[1] = items8;
...
function StageBlockedUsersActionSheetHeader(arg0) {
  ...
  if (ignoredUserCount > 0) {
    ...
    const items2 = [callback(require(4338) /* Text */.Text, obj7), ];
