...
// Function ID: 8122
// Name: RestrictedUser
// Dependencies: [32, 19, 17, 4030, 4990, 4978, 21, 4661, 712, 589, 1236, 1297, 8122, 4734, 4342, 8123, 6803, 4745, 6950, 8124, 2]
// Exports: default
...
function RestrictedUser(guildId) {
  ...
  const items5 = [callback(require(4734) /* Text */.Text, obj5), ];
  ...
  items8[1] = closure_10(require(4734) /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", children: items9 });
  obj7[1] = items8;
...
function StageBlockedUsersActionSheetHeader(arg0) {
  ...
  if (ignoredUserCount > 0) {
    ...
    const items2 = [callback(require(4734) /* Text */.Text, obj7), ];
