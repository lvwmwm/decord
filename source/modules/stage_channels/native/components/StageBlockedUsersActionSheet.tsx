...
// Function ID: 8006
// Name: RestrictedUser
// Dependencies: [32, 19, 17, 3938, 5139, 5132, 21, 4303, 712, 589, 1236, 1297, 8006, 4299, 4271, 8007, 5328, 4714, 5397, 8008, 2]
// Exports: default

// Module 8005 (RestrictedUser)
...
function RestrictedUser(guildId) {
  ...
  const items5 = [callback(require(4299) /* Text */.Text, obj5), ];
  ...
  items8[1] = closure_10(require(4299) /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", children: items9 });
  obj7[1] = items8;
...
function StageBlockedUsersActionSheetHeader(arg0) {
  ...
  if (ignoredUserCount > 0) {
    ...
    const items2 = [callback(require(4299) /* Text */.Text, obj7), ];
