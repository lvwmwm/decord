...
// Function ID: 7946
// Name: RestrictedUser
// Dependencies: [32, 19, 17, 3938, 5138, 5131, 21, 4302, 712, 589, 1236, 1297, 7946, 4298, 4270, 7947, 5327, 4712, 5396, 7948, 2]
// Exports: default

// Module 7945 (RestrictedUser)
...
function RestrictedUser(guildId) {
  ...
  const items5 = [callback(require(4298) /* Text */.Text, obj5), ];
  ...
  items8[1] = closure_10(require(4298) /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", children: items9 });
  obj7[1] = items8;
...
function StageBlockedUsersActionSheetHeader(arg0) {
  ...
  if (ignoredUserCount > 0) {
    ...
    const items2 = [callback(require(4298) /* Text */.Text, obj7), ];
