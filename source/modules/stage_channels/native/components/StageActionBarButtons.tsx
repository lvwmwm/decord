...
// Dependencies: [32, 19, 17, 4181, 4201, 10702, 5004, 676, 21, 4189, 712, 10528, 1236, 10703, 6715, 589, 10704, 10705, 10706, 10707, 9074, 10709, 7672, 10710, 10712, 6711, 8831, 5515, 5020, 5014, 4157, 10713, 1959, 10725, 10726, 1581, 5551, 6785, 4185, 4600, 6747, 6749, 10728, 10729, 5012, 10730, 7673, 10731, 10733, 10735, 10240, 4686, 10736, 4050, 4599, 10682, 7634, 6725, 6710, 4717, 1297, 10737, 2]
...
// Module 10701 (AgeVerificationSpeakerActionSheet)
...
export const MusicMuteButton = function MusicMuteButton(arg0) {
  ...
  if (!obj2.useShowStageMusicMuteButton(channel.id)) {
    ...
    obj[0] = stringResult;
    obj[1] = importDefault(stateFromStores ? 10705 : 10706);
    if (stateFromStores) {
      tmpResult = tmp(10707);
      let MusicIcon = tmpResult.MusicSlashIcon;
    } else {
      MusicIcon = tmp(9074).MusicIcon;
    }
    obj[2] = MusicIcon;
    ...
    obj[5] = isSmallSize;
    closure_12(importAll(10528).ActionButton, obj);
...
export const DisconnectStageButton = function DisconnectStageButton(channel) {
  ...
  obj[1] = importDefault(7672);
  obj[2] = channel(10710).DoorExitIcon;
  ...
  return callback2(importAll(10528).PrimaryActionButton, obj);
};
export const RequestToSpeakListButton = function RequestToSpeakListButton(channel) {
  ...
  if (stageParticipantsCount > 0) {
    ...
    obj[2] = obj1;
    obj[3] = tmp3(10726).HandRequestSpeakListIcon;
    obj[4] = handleOpenAudienceList;
    obj[5] = stageParticipantsCount;
    obj[6] = isSmallSize;
    let tmp7 = callback2(importAll(10528).NotifiedActionButton, obj);
  } else {
    ...
    obj2[2] = obj3;
    obj2[3] = tmp3(10726).HandRequestSpeakListIcon;
    obj2[4] = handleOpenAudienceList;
    obj2[5] = isSmallSize;
    tmp7 = callback2(importAll(10528).ActionButton, obj2);
  }
  return tmp7;
};
...
export const ChatButton = function ChatButton(channel) {
  ...
  if (mentionCount <= 0) {
    if (unreadCount <= 0) {
      ...
      obj[3] = isVoiceChannelLocked(10736);
      obj[4] = onPress;
      obj[5] = isVoiceChannelLocked;
      obj[6] = isSmallSize;
      let tmp7Result = callback2(openChat(10528).ActionButton, obj);
    }
    return tmp7Result;
  }
  if (mentionCount > 0) {
  ...
  obj1[5] = isVoiceChannelLocked(10736);
  obj1[6] = onPress;
  obj1[7] = isVoiceChannelLocked;
  obj1[8] = isSmallSize;
  tmp7Result = callback2(openChat(10528).NotifiedActionButton, obj1);
};
...
export const JoinStagePrompt = function JoinStagePrompt(channel) {
  ...
  return callback2(channel(7634).FormCTA, obj);
};
