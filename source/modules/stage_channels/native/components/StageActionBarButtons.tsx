...
// Dependencies: [32, 19, 17, 4277, 4297, 10703, 5114, 676, 21, 4285, 712, 10604, 1236, 10704, 7701, 589, 10705, 10706, 10707, 10708, 9568, 10710, 7925, 10711, 10713, 7697, 9071, 5649, 5130, 5124, 4253, 10714, 1988, 10726, 10727, 1609, 5685, 5948, 4281, 4695, 7720, 7722, 10729, 10730, 5122, 10731, 7926, 10732, 10734, 10736, 9665, 4781, 10737, 4145, 4694, 10682, 7890, 7711, 7696, 4827, 1297, 10738, 2]
...
// Module 10702 (AgeVerificationSpeakerActionSheet)
...
class AnimatedPrompt {
  constructor(arg0) {
    ...
    items1[2] = tmp5;
    return tmp4(require("module_4145").View, { style: items1, children });
  }
}
...
export const MusicMuteButton = function MusicMuteButton(arg0) {
  ...
  if (!obj2.useShowStageMusicMuteButton(channel.id)) {
    ...
    obj[0] = stringResult;
    obj[1] = importDefault(stateFromStores ? 10706 : 10707);
    if (stateFromStores) {
      tmpResult = tmp(10708);
      let MusicIcon = tmpResult.MusicSlashIcon;
    } else {
      MusicIcon = tmp(9568).MusicIcon;
    }
    obj[2] = MusicIcon;
    ...
    obj[5] = isSmallSize;
    closure_12(importAll(10604).ActionButton, obj);
...
export const DisconnectStageButton = function DisconnectStageButton(channel) {
  ...
  obj[1] = importDefault(7925);
  obj[2] = channel(10711).DoorExitIcon;
  ...
  return callback2(importAll(10604).PrimaryActionButton, obj);
};
export const RequestToSpeakListButton = function RequestToSpeakListButton(channel) {
  ...
  const stageParticipantsCount = obj.useStageParticipantsCount(channel.id, channel(5124).StageChannelParticipantNamedIndex.REQUESTED_TO_SPEAK_ONLY);
  if (stageParticipantsCount > 0) {
    ...
    obj[2] = obj1;
    obj[3] = tmp3(10727).HandRequestSpeakListIcon;
    obj[4] = handleOpenAudienceList;
    obj[5] = stageParticipantsCount;
    obj[6] = isSmallSize;
    let tmp7 = callback2(importAll(10604).NotifiedActionButton, obj);
  } else {
    ...
    obj2[2] = obj3;
    obj2[3] = tmp3(10727).HandRequestSpeakListIcon;
    obj2[4] = handleOpenAudienceList;
    obj2[5] = isSmallSize;
    tmp7 = callback2(importAll(10604).ActionButton, obj2);
  }
  return tmp7;
};
...
export const ChatButton = function ChatButton(channel) {
  ...
  if (mentionCount <= 0) {
    if (unreadCount <= 0) {
      ...
      obj[2] = tmp(4781).ChatIcon;
      obj[3] = isVoiceChannelLocked(10737);
      obj[4] = onPress;
      obj[5] = isVoiceChannelLocked;
      obj[6] = isSmallSize;
      let tmp7Result = callback2(openChat(10604).ActionButton, obj);
    }
    return tmp7Result;
  }
  if (mentionCount > 0) {
  ...
  obj1[4] = channel(4781).ChatIcon;
  obj1[5] = isVoiceChannelLocked(10737);
  obj1[6] = onPress;
  obj1[7] = isVoiceChannelLocked;
  obj1[8] = isSmallSize;
  tmp7Result = callback2(openChat(10604).NotifiedActionButton, obj1);
};
...
export const JoinStagePrompt = function JoinStagePrompt(channel) {
  ...
  return callback2(channel(7890).FormCTA, obj);
};
