...
// Dependencies: [32, 19, 17, 4247, 4267, 10648, 5084, 676, 21, 4255, 712, 10549, 1236, 10649, 7673, 589, 10650, 10651, 10652, 10653, 9539, 10655, 7784, 10656, 10658, 7669, 9042, 5595, 5100, 5094, 4223, 10659, 1959, 10671, 10672, 1581, 5631, 5921, 4251, 4665, 7692, 7694, 10674, 10675, 5092, 10676, 7785, 10677, 10679, 10681, 9634, 4751, 10682, 4116, 4664, 10627, 7749, 7683, 7668, 4797, 1297, 10683, 2]
...
// Module 10647 (AgeVerificationSpeakerActionSheet)
...
export const MusicMuteButton = function MusicMuteButton(arg0) {
  ...
  if (!obj2.useShowStageMusicMuteButton(channel.id)) {
    ...
    obj[0] = stringResult;
    obj[1] = importDefault(stateFromStores ? 10651 : 10652);
    if (stateFromStores) {
      tmpResult = tmp(10653);
      let MusicIcon = tmpResult.MusicSlashIcon;
    } else {
      MusicIcon = tmp(9539).MusicIcon;
    }
    obj[2] = MusicIcon;
...
export const DisconnectStageButton = function DisconnectStageButton(channel) {
  ...
  obj[1] = importDefault(7784);
  obj[2] = channel(10656).DoorExitIcon;
...
export const RequestToSpeakListButton = function RequestToSpeakListButton(channel) {
  ...
  const stageParticipantsCount = obj.useStageParticipantsCount(channel.id, channel(5094).StageChannelParticipantNamedIndex.REQUESTED_TO_SPEAK_ONLY);
  if (stageParticipantsCount > 0) {
    ...
    obj[2] = obj1;
    obj[3] = tmp3(10672).HandRequestSpeakListIcon;
    ...
    obj2[2] = obj3;
    obj2[3] = tmp3(10672).HandRequestSpeakListIcon;
...
export const ChatButton = function ChatButton(channel) {
  ...
  if (mentionCount <= 0) {
    if (unreadCount <= 0) {
      ...
      obj[2] = tmp(4751).ChatIcon;
      obj[3] = isVoiceChannelLocked(10682);
      obj[4] = onPress;
      obj[5] = isVoiceChannelLocked;
      obj[6] = isSmallSize;
      let tmp7Result = callback2(openChat(10549).ActionButton, obj);
    }
    return tmp7Result;
  }
  if (mentionCount > 0) {
  ...
  obj1[4] = channel(4751).ChatIcon;
  obj1[5] = isVoiceChannelLocked(10682);
  obj1[6] = onPress;
  obj1[7] = isVoiceChannelLocked;
  obj1[8] = isSmallSize;
  tmp7Result = callback2(openChat(10549).NotifiedActionButton, obj1);
};
...
export const JoinStagePrompt = function JoinStagePrompt(channel) {
  ...
  return callback2(channel(7749).FormCTA, obj);
};
export const ContinueToStagePrompt = function ContinueToStagePrompt(onContinue) {
  ...
  return callback2(require(4797) /* PressableBase */.PressableOpacity, obj);
};
