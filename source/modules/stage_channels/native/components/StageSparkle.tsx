...
// Dependencies: [19, 17, 21, 4481, 709, 8338, 5542, 8339, 4205, 2]
// Exports: default

// Module 8337 (StageSparkleInner)
...
function StageSparkleInner(style) {
  ...
  const obj2 = { style: tmp3.sparkles, source: tmp10(8339) };
  items1[1] = closure_4(tmp10(5542), obj2);
  obj[1] = items1;
