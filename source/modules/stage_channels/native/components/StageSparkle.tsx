...
// Dependencies: [19, 17, 21, 4302, 712, 7728, 5267, 7729, 4013, 2]
// Exports: default

// Module 7727 (StageSparkleInner)
import "noop";
...
function StageSparkleInner(style) {
  ...
  if (null != IconComponent) {
    ...
    tmp6Result = tmp6(importDefault(5267), obj1);
    tmp10 = importDefault;
  }
  obj[1] = tmp6Result;
...
export default function StageSparkle(theme) {
  ...
  if (null != theme) {
    ...
    let tmp7 = callback(require(4013) /* ManaContext */.ThemeContextProvider, obj);
  } else {
    obj = {};
