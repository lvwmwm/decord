...
// Dependencies: [19, 17, 21, 4668, 712, 8108, 5454, 8109, 4107, 2]
// Exports: default

// Module 8107 (StageSparkleInner)
...
function StageSparkleInner(style) {
  ...
  const obj2 = { style: tmp3.sparkles, source: tmp10(8109) };
  items1[1] = closure_4(tmp10(5454), obj2);
  obj[1] = items1;
