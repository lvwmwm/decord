...
// Dependencies: [19, 17, 21, 4446, 712, 8625, 5458, 8626, 4173, 2]
// Exports: default

// Module 8624 (StageSparkleInner)
...
function StageSparkleInner(style) {
  ...
  const obj2 = { style: tmp3.sparkles, source: tmp10(8626) };
  items1[1] = closure_4(tmp10(5458), obj2);
  obj[1] = items1;
