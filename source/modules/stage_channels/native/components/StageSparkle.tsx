...
// Dependencies: [19, 17, 21, 4448, 712, 8647, 5461, 8648, 4174, 2]
// Exports: default

// Module 8646 (StageSparkleInner)
...
function StageSparkleInner(style) {
  ...
  const obj2 = { style: tmp3.sparkles, source: tmp10(8648) };
  items1[1] = closure_4(tmp10(5461), obj2);
  obj[1] = items1;
