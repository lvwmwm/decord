...
// Dependencies: [19, 17, 21, 4445, 712, 8610, 5445, 8611, 4172, 2]
// Exports: default

// Module 8609 (StageSparkleInner)
...
function StageSparkleInner(style) {
  ...
  const obj2 = { style: tmp3.sparkles, source: tmp10(8611) };
  items1[1] = closure_4(tmp10(5445), obj2);
  obj[1] = items1;
