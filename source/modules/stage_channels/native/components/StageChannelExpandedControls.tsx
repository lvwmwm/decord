// Module ID: 10744
// Function ID: 83435
// Dependencies: [31, 27, 4150, 1194, 1838, 33, 4131, 3975, 689, 10329, 10177, 566, 4951, 8769, 10745, 2]
...
const memoResult = require("result").memo((channel) => {
  ...
  const tmp2 = importDefault(10329)(channel.id);
  ...
  const items5 = [];
  items5.push(jsx(channel(10745).StreamVolumeItem, {}));
  if (tmp8) {
    obj = { channel };
    ...
    obj.disabled = tmp12;
    items5.push(jsx(channel(10745).ScreenshareButton, { channel }));
    const tmp9 = jsx;
  }
  obj = { channelId: channel.id, isConnectedToVoiceChannel };
  items5.push(jsx(channel(10745).AudioRouteButton, { channelId: channel.id, isConnectedToVoiceChannel }));
  items5.push(jsx(channel(10745).DeafenButton, { channel }));
