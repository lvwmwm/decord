...
// Function ID: 10818
// Name: RaisedHandIcon
// Dependencies: [19, 17, 1942, 21, 4255, 712, 4439, 1297, 7785, 1474, 589, 5094, 4444, 5353, 1236, 7668, 10797, 4101, 10818, 2]
// Exports: getTileWidthStyle

// Module 10817 (RaisedHandIcon)
...
function RaisedHandIcon(rtsState) {
  const tmp = styles();
  let activeBackground = rtsState.rtsState === require(4439) /* useAudienceRequestToSpeakState */.RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK;
