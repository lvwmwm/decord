// Module ID: 11096
// Function ID: 11097
// Dependencies: [19, 17, 4460, 4465, 21, 4444, 712, 11086, 1494, 5018, 589, 11097, 1297, 2]
...
const memoResult = importAllResult.memo((channel) => {
  ...
  const tmp = callback();
  let obj = channel(11086);
  const speakerTileStyles = obj.useSpeakerTileStyles();
  const isScreenLandscape = channel(5018).useIsScreenLandscape();
  const obj2 = channel(5018);
  ...
  if (null != stateFromStores) {
    ...
    if (stateFromStores.type !== ParticipantTypes.ACTIVITY) {
      ...
      obj[6] = channel;
      obj[8] = tmp.media;
      obj[1] = jsx(tmp5(11097), { hasBottomSafeArea: false, hasLeftSafeArea: false, hasRightSafeArea: false, hasTopSafeArea: false, participant: null, avatarSize: null, channel: null, shrinkStreamEmptyState: false, contentStyle: null });
