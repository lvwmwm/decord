// Module ID: 10858
// Function ID: 10859
// Dependencies: [19, 17, 4298, 4303, 21, 4285, 712, 10848, 1474, 4830, 589, 10859, 1297, 2]
...
const memoResult = require("noop").memo((channel) => {
  ...
  const tmp = callback();
  let obj = channel(10848);
  const speakerTileStyles = obj.useSpeakerTileStyles();
  const isScreenLandscape = channel(4830).useIsScreenLandscape();
  const obj2 = channel(4830);
  ...
  if (null != stateFromStores) {
    ...
    if (stateFromStores.type !== ParticipantTypes.ACTIVITY) {
      ...
      obj[6] = channel;
      obj[8] = tmp.media;
      obj[1] = jsx(tmp5(10859), { hasBottomSafeArea: false, hasLeftSafeArea: false, hasRightSafeArea: false, hasTopSafeArea: false, participant: null, avatarSize: null, channel: null, shrinkStreamEmptyState: false, contentStyle: null });
