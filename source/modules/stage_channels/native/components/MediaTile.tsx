// Module ID: 10861
// Function ID: 10862
// Dependencies: [19, 17, 4206, 4211, 21, 4193, 712, 10852, 1474, 4724, 589, 10862, 1297, 2]
...
const memoResult = require("noop").memo((channel) => {
  ...
  const isScreenLandscape = channel(4724).useIsScreenLandscape();
  ...
  if (null != stateFromStores) {
    ...
    if (stateFromStores.type !== ParticipantTypes.ACTIVITY) {
      ...
      obj[6] = channel;
      obj[8] = tmp.media;
      obj[1] = jsx(tmp5(10862), { hasBottomSafeArea: false, hasLeftSafeArea: false, hasRightSafeArea: false, hasTopSafeArea: false, participant: null, avatarSize: null, channel: null, shrinkStreamEmptyState: false, contentStyle: null });
