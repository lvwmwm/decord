...
// Dependencies: [32, 19, 17, 505, 21, 10679, 4145, 4694, 712, 10680, 10739, 10682, 9661, 9660, 9662, 10645, 4478, 10740, 10817, 3996, 10590, 10825, 10826, 10685, 10831, 10839, 10843, 10876, 10877, 4285, 10878, 10702, 2]
// Exports: default
...
function JoinStageOverlay(channel) {
  ...
  obj[0] = items;
  obj[1] = callback2(importDefault(10739), { channel: channel.channel });
...
function StagePromptWrapper(channel) {
  ...
  return callback2(require(10878) /* RootThemeContextProvider */.DisableCustomTheme, obj);
}
function StagePromptInner(channel) {
  const tmp = createCacheKey();
  return callback2(require(10702) /* AgeVerificationSpeakerActionSheet */.AnimatedStartStagePrompt, { channel: channel.channel, style: createCacheKey().startStagePrompt });
}
