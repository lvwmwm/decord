...
// Dependencies: [19, 17, 21, 4302, 712, 4162, 4303, 4298, 1297, 5658, 2]
// Exports: default

// Module 10867 (StageSectionHeader)
import "noop";
...
export default function StageSectionHeader(collapsed) {
  ...
  obj5[0] = importDefault(5658);
  obj5[1] = tmp.collapseIcon;
  obj4[1] = closure_6(collapsed(1297).Icon, obj5);
  obj3[1] = closure_6(importDefault(4162).View, obj4);
