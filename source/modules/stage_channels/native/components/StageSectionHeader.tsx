...
// Dependencies: [19, 17, 21, 4189, 712, 4050, 4190, 4185, 1297, 5505, 2]
// Exports: default

// Module 10841 (StageSectionHeader)
import "noop";
...
export default function StageSectionHeader(collapsed) {
  ...
  obj = { withTiming: collapsed(4190).withTiming, collapsed };
  fn.__closure = obj;
  ...
  const items1 = [callback(collapsed(4185).Text, { variant: "text-md/semibold", color: "text-overlay-light", accessibilityRole: "header", children: items }), , ];
  ...
  obj5[0] = importDefault(5505);
  obj5[1] = tmp.collapseIcon;
  obj4[1] = closure_6(collapsed(1297).Icon, obj5);
  obj3[1] = closure_6(importDefault(4050).View, obj4);
