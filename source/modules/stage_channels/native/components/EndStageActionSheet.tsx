...
// Dependencies: [19, 17, 5008, 676, 21, 4193, 712, 4161, 8840, 7637, 1297, 1236, 4189, 4604, 6718, 2]
// Exports: default
...
export default function EndStageActionSheet(channel) {
  ...
  items[1] = callback(channel(4189).Text, obj1);
  ...
  obj2[1] = callback(channel(4604).Button, obj3);
  ...
  obj4[1] = callback(channel(4604).Button, obj5);
  items[3] = callback(View, obj4);
  obj[1] = items;
  obj[0] = callback2(View, obj);
  return callback(importDefault(7637), obj);
};
