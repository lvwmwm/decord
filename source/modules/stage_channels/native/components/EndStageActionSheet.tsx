...
// Dependencies: [19, 17, 5084, 676, 21, 4255, 712, 4223, 9042, 7747, 1297, 1236, 4251, 4665, 7673, 2]
// Exports: default

// Module 12539 (EndStageActionSheet)
import "noop";
...
export default function EndStageActionSheet(channel) {
  ...
  obj2[1] = callback(channel(4665).Button, obj3);
  ...
  obj4[1] = callback(channel(4665).Button, obj5);
  items[3] = callback(View, obj4);
  obj[1] = items;
  obj[0] = callback2(View, obj);
  return callback(importDefault(7747), obj);
};
