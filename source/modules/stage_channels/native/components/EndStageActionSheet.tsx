...
// Dependencies: [19, 17, 5323, 676, 21, 4446, 712, 4413, 9713, 8680, 1297, 1236, 4442, 4893, 8615, 2]
// Exports: default

// Module 12722 (EndStageActionSheet)
import noopAll from "noop" /* 19 */;
import ThemesDefault from "Themes" /* 712 */;
import ScrollHandlingActionSheetDefault from "ScrollHandlingActionSheet" /* 8680 */;
import { View } from "get ActivityIndicator" /* 17 */;
import { EXPLICIT_END_STAGE_SHEET_KEY as closure_4 } from "MAX_STAGE_TOPIC_LENGTH" /* 5323 */;
...
export default function EndStageActionSheet(channel) {
  ...
  items[1] = callback(channel(4442).Text, obj1);
  ...
  obj2[1] = callback(channel(4893).Button, obj3);
  ...
  obj4[1] = callback(channel(4893).Button, obj5);
