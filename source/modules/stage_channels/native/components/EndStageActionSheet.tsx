...
// Dependencies: [19, 17, 5114, 676, 21, 4285, 712, 4253, 9071, 7888, 1297, 1236, 4281, 4695, 7701, 2]
// Exports: default

// Module 12576 (EndStageActionSheet)
import "noop";
...
export default function EndStageActionSheet(channel) {
  ...
  return callback(importDefault(7888), obj);
};
