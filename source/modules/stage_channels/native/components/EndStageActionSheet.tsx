...
// Dependencies: [19, 17, 5131, 676, 21, 4302, 712, 4270, 9088, 7905, 1297, 1236, 4298, 4712, 7718, 2]
// Exports: default

// Module 12591 (EndStageActionSheet)
import "noop";
...
export default function EndStageActionSheet(channel) {
  ...
  items[1] = callback(channel(4298).Text, obj1);
  ...
  obj2[1] = callback(channel(4712).Button, obj3);
  ...
  obj4[1] = callback(channel(4712).Button, obj5);
  items[3] = callback(View, obj4);
  obj[1] = items;
  obj[0] = callback2(View, obj);
  return callback(importDefault(7905), obj);
};
