...
// Function ID: 8664
// Name: handleDismiss
// Dependencies: [19, 17, 1396, 5310, 1397, 21, 4445, 712, 4412, 1297, 589, 8664, 5445, 8665, 4441, 1236, 8295, 8666, 8667, 8668, 8669, 4880, 2]
// Exports: default

// Module 8663 (handleDismiss)
...
import registerAssetDefault from "registerAsset" /* 8665 */;
import registerAssetDefault2 from "registerAsset" /* 8666 */;
import registerAssetDefault3 from "registerAsset" /* 8667 */;
import registerAssetDefault4 from "registerAsset" /* 8668 */;
import registerAssetDefault5 from "registerAsset" /* 8669 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_4 from "handleStageInstanceCreateOrUpdate" /* 1396 */;
import { STAGE_AUDIENCE_NOTICE_SHEET_KEY as closure_5 } from "MAX_STAGE_TOPIC_LENGTH" /* 5310 */;
...
export default function StageAudienceNotificationSheet(channelId) {
  ...
  items1[1] = callback(channelId(4441).Text, obj2);
  ...
  obj4[1] = callback(channelId(4441).Text, obj6);
  const items2 = [callback(channelId(8295).FormRow, obj4), , , ];
  ...
  obj7[1] = callback(channelId(4441).Text, obj9);
  items2[1] = callback(channelId(8295).FormRow, obj7);
  ...
  obj10[1] = callback(channelId(4441).Text, obj12);
  items2[2] = callback(channelId(8295).FormRow, obj10);
  let tmp6Result = null;
  if (privacy_level === constants.PUBLIC) {
    ...
    obj13[1] = tmp6(tmp2(4441).Text, obj15);
    tmp6Result = tmp6(tmp2(8295).FormRow, obj13);
  }
  ...
  obj17[1] = callback(channelId(4880).Button, obj18);
