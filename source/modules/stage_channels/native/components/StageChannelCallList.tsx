...
// Dependencies: [32, 19, 10931, 5132, 21, 1297, 10932, 5142, 4730, 5148, 38, 10939, 1236, 10940, 10941, 10954, 8010, 10958, 1493, 4849, 2]
// Exports: default

// Module 10930 (StageChannelCallList)
...
export default function StageChannelCallList(channel) {
  ...
  const tmp4 = callback(width(10958).useStageChannelParticipantsListThrottled(channel.id, memo, throttleDurationForChannel, true), 2);
