...
// Dependencies: [32, 19, 10984, 5172, 21, 1297, 10985, 5182, 4770, 5188, 38, 10992, 1236, 10993, 10994, 11007, 8049, 11011, 1493, 4889, 2]
// Exports: default

// Module 10983 (StageChannelCallList)
...
export default function StageChannelCallList(channel) {
  ...
  isScreenLandscape = width(4889).useIsScreenLandscape();
  ...
  const obj2 = width(4889);
  const tmp4 = callback(width(11011).useStageChannelParticipantsListThrottled(channel.id, memo, throttleDurationForChannel, true), 2);
