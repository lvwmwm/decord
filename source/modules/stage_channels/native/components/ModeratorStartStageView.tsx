...
// Dependencies: [32, 19, 1908, 21, 586, 9591, 9599, 9600, 9602, 9603, 9594, 9604, 1233, 9626, 9827, 2]
// Exports: default

// Module 9590 (ModeratorStartStageView)
  ...
  if (null != stateFromStores) {
    ...
    if (canManageGuildEventResult) {
      ...
      if (null != first) {
        ...
        tmp10Result = tmp10(tmp(9626).StartEventPrompt, obj);
      }
    }
    ...
    if (useCurrentUserStageRolesDefault(channel.id, true).moderator) {
      ...
      obj1[0] = channel;
      obj1[1] = isLive;
      tmp10Result = tmp10(tmp(9827).StartStagePrompt, obj1);
    }
    ...
    if (tmp7) {
      ...
      tmp10Result1 = tmp10(tmp(9626).ScheduleEventPrompt, obj2);
    }
    obj3 = { children: null };
    items2[2] = tmp10Result1;
    obj4 = { onContinue: null };
    obj4[0] = channel.onSkip;
    items2[3] = closure_5(tmp(9827).ContinueToStagePrompt, obj4);
    obj3[0] = items2;
