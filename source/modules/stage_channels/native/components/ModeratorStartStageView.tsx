...
// Dependencies: [32, 19, 1909, 21, 589, 9631, 9639, 9640, 9642, 9643, 9634, 9644, 1236, 9667, 9989, 2]
// Exports: default

// Module 9630 (ModeratorStartStageView)
...
export default function ModeratorStartStageView(channel) {
  ...
  if (null != stateFromStores) {
    ...
    if (useCurrentUserStageRolesDefault(channel.id, true).moderator) {
      ...
      obj1[0] = channel;
      obj1[1] = isLive;
      tmp10Result = tmp10(tmp(9989).StartStagePrompt, obj1);
    }
    ...
    if (tmp7) {
      ...
      tmp10Result1 = tmp10(tmp(9667).ScheduleEventPrompt, obj2);
    }
    obj3 = { children: null };
