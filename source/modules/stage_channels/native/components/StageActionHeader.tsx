...
// Dependencies: [19, 17, 4202, 1372, 5921, 1862, 1377, 10702, 676, 21, 4189, 5140, 4033, 712, 698, 4384, 6679, 4395, 4399, 589, 10722, 10822, 1236, 4383, 1297, 4380, 5020, 5014, 4611, 4185, 7683, 7676, 10823, 10824, 6711, 8321, 10223, 10222, 8348, 10704, 10705, 10706, 10709, 10825, 10826, 2]
// Exports: HideChannelCallButton, closeStageModal

// Module 10821 (HideStageChannelCallIcon)
...
const memoResult = importAllResult.memo((onOpenRTCDebugOverlay) => {
  ...
  if (fullscreenStream) {
    obj = { channel: null };
    obj[0] = channel;
    fullscreenStream = tmp7(require(10826) /* CameraButton */.GridButton, obj);
  }
  items[3] = fullscreenStream;
  items[4] = callback(require(10826) /* CameraButton */.CameraButton, {});
...
export const closeStageModal = function closeStageModal(id) {
  ...
  importDefault(6679).setHidden(false);
  const obj4 = importDefault(6679);
...
export const HideChannelCallButton = function HideChannelCallButton(channel) {
  ...
  return callback(importDefault(10722), obj);
};
