...
// Function ID: 10821
// Name: styles
// Dependencies: [19, 17, 505, 21, 10821, 4344, 1628, 10822, 7828, 4340, 2]
// Exports: default
...
export default function StageViewWithPrompts(arg0) {
  ...
  obj = { paddingTop: top + require(10822) /* FocusedControlsHeader */.FOCUSED_CONTROLS_HEADER_HEIGHT, paddingBottom: bottom + closure_8 };
  ({ top, bottom } = importDefault(1628)());
  items[1] = obj;
  obj[1] = items;
  obj = { style: tmp.sparkle, theme: ThemeTypes.DARK };
  const items1 = [callback(importDefault(7828), obj), callback(require(4340) /* Text */.Text, { style: tmp.title, accessibilityRole: "header", variant: "heading-xl/extrabold", color: "text-overlay-light", children: title }), callback(require(4340) /* Text */.Text, { style: tmp.body, variant: "text-sm/medium", color: "text-overlay-light", children: body }), callback(closure_4, { style: tmp.prompts, children })];
  obj[3] = items1;
