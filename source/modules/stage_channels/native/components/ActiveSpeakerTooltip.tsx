// Module ID: 10946
// Function ID: 10947
// Dependencies: [32, 19, 17, 4358, 10916, 676, 21, 4342, 712, 589, 5211, 4909, 10925, 4338, 1236, 2]
...
const memoResult = importAllResult.memo((channel) => {
  ...
  if (0 !== first.length) {
    ...
    if (callback(callback2(), 1)[0]) {
      ...
      obj1[1] = callback3(importDefault(10925), obj2);
