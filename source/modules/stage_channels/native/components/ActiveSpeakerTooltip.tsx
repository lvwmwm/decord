// Module ID: 12684
// Function ID: 12685
// Dependencies: [32, 19, 17, 4778, 12657, 676, 21, 4668, 712, 589, 6746, 5438, 10804, 4739, 1236, 2]
...
const memoResult = importAllResult.memo((channel) => {
  ...
  const first = callback(obj.useStateFromStores(items, () => {
    ...
    return items;
  }, items1, channel(6746).isVersionEqual), 1)[0];
  let tmp5 = null;
  if (0 !== first.length) {
    tmp5 = null;
    if (callback(callback2(), 1)[0]) {
      ...
      obj3[1] = callback3(tmp2(4739).Text, obj4);
      items2[1] = callback3(View, obj3);
      obj[1] = items2;
      obj[3] = callback4(View, obj);
      tmp5 = callback3(tmp2(5438).PressableOpacity, obj);
