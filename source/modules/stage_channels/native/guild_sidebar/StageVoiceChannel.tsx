// Module ID: 15755
// Function ID: 15756
// Dependencies: [19, 17, 7219, 4090, 4461, 4667, 4521, 1396, 676, 10139, 21, 1236, 4446, 712, 589, 5326, 15756, 5339, 5333, 4972, 7593, 1892, 8610, 10589, 4640, 9463, 15635, 15745, 15640, 2]

// Module 15755
import ThemesDefault from "Themes" /* 712 */;
import computeChannelNameDefault from "computeChannelName" /* 4640 */;
import transformParticipantToSortedVoiceStateDefault from "transformParticipantToSortedVoiceState" /* 15756 */;
...
const memoResult = importAllResult.memo((channel) => {
  ...
  let tmp2Result = tmp2(5339);
  const stageParticipantsCount = tmp2Result.useStageParticipantsCount(channel.id, tmp2(5333).StageChannelParticipantNamedIndex.AUDIENCE);
