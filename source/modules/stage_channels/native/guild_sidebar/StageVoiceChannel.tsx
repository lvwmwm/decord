// Module ID: 15447
// Function ID: 15448
// Dependencies: [19, 17, 7056, 3989, 4357, 4550, 4417, 1396, 676, 9855, 21, 1236, 4342, 712, 589, 5197, 15448, 5210, 5204, 4853, 8483, 1891, 7839, 9726, 4535, 9804, 15328, 15437, 15333, 2]
...
const memoResult = importAllResult.memo((channel) => {
  ...
  let arr3 = importDefault(15448)(channel.guild_id)[channel.id];
  if (arr3 == null) {
    arr3 = NO_VOICE_STATES;
  }
  let tmp2Result = tmp2(5210);
  const stageParticipantsCount = tmp2Result.useStageParticipantsCount(channel.id, tmp2(5204).StageChannelParticipantNamedIndex.AUDIENCE);
