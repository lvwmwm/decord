// Module ID: 15218
// Function ID: 15219
// Dependencies: [19, 17, 6880, 3883, 4267, 4450, 4327, 1377, 676, 9681, 21, 1236, 4255, 712, 589, 5087, 15219, 5100, 5094, 4741, 8195, 1844, 7668, 9556, 4445, 9630, 15117, 15206, 15122, 2]
...
const memoResult = importAllResult.memo((channel) => {
  ...
  let arr3 = importDefault(15219)(channel.guild_id)[channel.id];
  if (arr3 == null) {
    arr3 = NO_VOICE_STATES;
  }
  let tmp2Result = tmp2(5100);
  const stageParticipantsCount = tmp2Result.useStageParticipantsCount(channel.id, tmp2(5094).StageChannelParticipantNamedIndex.AUDIENCE);
