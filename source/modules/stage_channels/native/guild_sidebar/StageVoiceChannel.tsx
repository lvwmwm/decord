// Module ID: 15432
// Function ID: 15433
// Dependencies: [19, 17, 7028, 3989, 4356, 4539, 4416, 1396, 676, 9841, 21, 1236, 4344, 712, 589, 5175, 15433, 5188, 5182, 4830, 8457, 1891, 7814, 9711, 4534, 9789, 15314, 15421, 15319, 2]
...
const memoResult = importAllResult.memo((channel) => {
  ...
  let arr3 = importDefault(15433)(channel.guild_id)[channel.id];
  if (arr3 == null) {
    arr3 = NO_VOICE_STATES;
  }
  let tmp2Result = tmp2(5188);
  const stageParticipantsCount = tmp2Result.useStageParticipantsCount(channel.id, tmp2(5182).StageChannelParticipantNamedIndex.AUDIENCE);
  ...
  const tmp10 = importDefault(4534)(channel, false);
  tmp2Result = tmp2(9789);
