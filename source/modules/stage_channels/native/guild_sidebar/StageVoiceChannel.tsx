// Module ID: 15432
// Function ID: 15433
// Dependencies: [19, 17, 7034, 3989, 4357, 4540, 4417, 1396, 676, 9844, 21, 1236, 4342, 712, 589, 5176, 15433, 5189, 5183, 4831, 8461, 1891, 7818, 9715, 4535, 9793, 15314, 15421, 15319, 2]
...
const memoResult = importAllResult.memo((channel) => {
  ...
  let tmp2Result = tmp2(5189);
  const stageParticipantsCount = tmp2Result.useStageParticipantsCount(channel.id, tmp2(5183).StageChannelParticipantNamedIndex.AUDIENCE);
