...
// Function ID: 9694
// Name: _toPropertyKey
// Dependencies: [109, 32, 19, 17, 1991, 1984, 1921, 8331, 502, 21, 4481, 709, 4125, 6921, 586, 4468, 9667, 1296, 1233, 9680, 1350, 6567, 9684, 5474, 4477, 9689, 2]
// Exports: default

// Module 9693 (_toPropertyKey)
...
export default function AddMembersBody(pendingAdditions) {
  ...
  obj[0] = intl.string(guild(1233).t["LPJmL/"]);
  obj[1] = items2;
  items3.push(obj);
  obj1 = { title: null, data: null };
  let intl2 = tmp6(1233).intl;
  obj1[0] = intl2.string(guild(1233).t["9Oq93m"]);
  obj1[1] = membersRows;
  items3.push(obj1);
  ...
  if (inActionSheet) {
    let BottomSheetScrollView = tmp6(6567).BottomSheetScrollView;
  } else {
    BottomSheetScrollView = c8;
  }
  if (inActionSheet) {
    let BottomSheetSectionList = tmp6(6567).BottomSheetSectionList;
  } else {
  ...
  obj3[0] = intl3.string(guild(1233).t.TVZdKh);
  obj3[1] = mapped;
  ...
  obj2[1] = callback2(pendingAdditions(9684), obj3);
  ...
  if (null != inputDesc) {
    ...
    obj5[3] = inputDesc;
    obj4[1] = tmp27(tmp6(4477).Text, obj5);
  ...
  if (canEveryoneRoleResult) {
    ...
    obj7[0] = tmp6(1296).HelpMessageTypes.WARNING;
    const intl4 = tmp6(1233).intl;
    obj7[1] = intl4.string(tmp6(1233).t["5f3HIC"]);
    obj6[1] = tmp27(tmp6(1296).HelpMessage, obj7);
  ...
  if ("" !== str) {
    if (0 === items2.length) {
      if (0 === membersRows.length) {
        ...
        obj9[0] = tmp6(9689).NoResultsAlt;
        ({ emptyState: obj21[1], emptyStateText: obj21[2] } = tmp3);
        const intl5 = tmp6(1233).intl;
        const obj10 = { query: null };
        obj10[0] = str;
        obj9[3] = intl5.format(tmp6(1233).t.ErpIY3, obj10);
        obj8[0] = tmp27(tmp6(1296).EmptyState, obj9);
  ...
  const tmp4Result = pendingAdditions(9684);
  obj12[0] = { paddingHorizontal: pendingAdditions(709).space.PX_16, paddingBottom: pendingAdditions(709).space.PX_16 + pendingAdditions(6921)(obj).insets.bottom };
