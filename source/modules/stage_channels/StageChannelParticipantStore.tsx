...
// Dependencies: [4321, 1218, 1372, 1891, 3929, 3938, 5136, 1903, 4318, 4374, 5138, 1377, 3925, 12, 5141, 4365, 659, 589, 709, 2]

// Module 5135 (getActiveStageChannelIds)
    ...
    if (null != channel) {
      ...
      if (channel.isGuildStageVoice()) {
        ...
        if (tmp8) {
          ...
          if (null == tmp12) {
            const obj3 = new importDefault(5141)(id);
...
function getOrCreateParticipants(item10010) {
  ...
  if (null == tmp) {
    const obj = new importDefault(5141)(item10010);
