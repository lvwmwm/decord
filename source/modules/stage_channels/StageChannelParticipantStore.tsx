...
// Dependencies: [4322, 1218, 1372, 1891, 3929, 3938, 5137, 1903, 4319, 4376, 5139, 1377, 3925, 12, 5142, 4367, 659, 589, 709, 2]

// Module 5136 (getActiveStageChannelIds)
    ...
    if (null != channel) {
      ...
      if (channel.isGuildStageVoice()) {
        ...
        if (tmp8) {
          ...
          if (null == tmp12) {
            const obj3 = new importDefault(5142)(id);
...
function getOrCreateParticipants(item10010) {
  ...
  if (null == tmp) {
    const obj = new importDefault(5142)(item10010);
