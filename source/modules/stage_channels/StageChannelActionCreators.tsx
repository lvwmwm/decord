...
// Dependencies: [5, 1931, 4271, 676, 7674, 38, 4449, 7675, 530, 7679, 4439, 5092, 5185, 1906, 3888, 506, 4265, 7668, 7681, 2]
...
// Module 7673 (audienceAckRequestToSpeak)
...
function audienceAckRequestToSpeak(channel, suppress) {
  ...
  let obj1 = require(4439) /* useAudienceRequestToSpeakState */;
...
export const toggleRequestToSpeak = function toggleRequestToSpeak(channel_id, arg1) {
  ...
  if (arg1) {
    ...
    obj = {};
    const merged = Object.assign(require(7675) /* fillChunk */.getStageChannelMetadata(channel_id));
    obj.trackWithMetadata(constants.REQUEST_TO_SPEAK_INITIATED, obj);
    const obj3 = require(7675) /* fillChunk */;
  }
...
export const removeUserFromChannel = function removeUserFromChannel(id, getGuildId) {
  ...
  if (tmp2) {
    importDefault(5185).setChannel(guildId, id.id, null);
