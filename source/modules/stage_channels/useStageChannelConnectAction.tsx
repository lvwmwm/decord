...
// Dependencies: [6656, 10619, 2]
// Exports: default, useStageChannelStartEvent

// Module 10620 (useStageChannelConnectAction)
...
export default function useStageChannelConnectAction(arg0) {
  if (!tmp) {
    if (importDefault(10619)(arg0, true).moderator) {
...
export const useStageChannelStartEvent = function useStageChannelStartEvent(id) {
  return { isLive: importDefault(6656)(id), isModerator: importDefault(10619)(id, true).moderator };
};
