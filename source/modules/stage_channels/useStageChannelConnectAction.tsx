...
// Dependencies: [7778, 10765, 2]
// Exports: default, useStageChannelStartEvent

// Module 10766 (useStageChannelConnectAction)
...
export default function useStageChannelConnectAction(arg0) {
  if (!tmp) {
    if (importDefault(10765)(arg0, true).moderator) {
...
export const useStageChannelStartEvent = function useStageChannelStartEvent(id) {
  return { isLive: importDefault(7778)(id), isModerator: importDefault(10765)(id, true).moderator };
};
