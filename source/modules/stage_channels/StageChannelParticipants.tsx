...
// Function ID: 5125
// Name: sortKey
// Dependencies: [4304, 1372, 5125, 1971, 3921, 1903, 4301, 4357, 5121, 1377, 5127, 4469, 3908, 4474, 5128, 4348, 2]
...
function sortKey(speaker) {
  ...
  const combined = "" + num;
  return "" + str2 + str3 + str4 + str + combined.padStart(3, "0") + connectedOn + importDefault(5127)(userNick, user);
}
...
prototype["_getParticipantsForUser"] = function _getParticipantsForUser(userId) {
  ...
  if (null == voiceStateForChannel) {
    ...
    if (null == user) {
      ...
      obj[5] = require(5128) /* getHighestHoistedRole */.getHighestHoistedRole(self.guildId, userId);
