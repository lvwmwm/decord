...
// Function ID: 5095
// Name: sortKey
// Dependencies: [4274, 1372, 5095, 1942, 3892, 1874, 4271, 4327, 5091, 1377, 5097, 4439, 3879, 4444, 5098, 4318, 2]
...
function sortKey(speaker) {
  ...
  const combined = "" + num;
  return "" + str2 + str3 + str4 + str + combined.padStart(3, "0") + connectedOn + importDefault(5097)(userNick, user);
}
...
function getParticipantIndex(arg0) {
  ...
  if (rtsState === require(4439) /* useAudienceRequestToSpeakState */.RequestToSpeakStates.REQUESTED_TO_SPEAK) {
...
prototype["_getParticipantsForUser"] = function _getParticipantsForUser(userId) {
  ...
  if (null == voiceStateForChannel) {
    ...
    if (null == user) {
      ...
      obj[0] = user;
      obj[1] = importDefault(4444).getName(self.guildId, self.channelId, user);
      obj[2] = nick;
      obj[3] = getComparator(voiceStateForChannel, nick);
      obj[4] = voiceStateForChannel;
      const obj3 = importDefault(4444);
      obj[5] = require(5098) /* getHighestHoistedRole */.getHighestHoistedRole(self.guildId, userId);
...
export const isRequestedToSpeakAll = function isRequestedToSpeakAll(rtsState) {
  return rtsState === require(4439) /* useAudienceRequestToSpeakState */.RequestToSpeakStates.REQUESTED_TO_SPEAK || rtsState === require(4439) /* useAudienceRequestToSpeakState */.RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK;
};
