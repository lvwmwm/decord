...
export const useGetStageRTCPanelHeight = function useGetStageRTCPanelHeight(stateFromStores) {
  const stageBlockedUsersCount = require(7677) /* useStageBlockedUsersCount */.useStageBlockedUsersCount(stateFromStores);
  require(7677) /* useStageBlockedUsersCount */;
...
export const useGetActionBarHeight = function useGetActionBarHeight(id) {
  const stageBlockedUsersCount = require(7677) /* useStageBlockedUsersCount */.useStageBlockedUsersCount(id);
  require(7677) /* useStageBlockedUsersCount */;
  if (stageBlockedUsersCount > 0) {
    let num = 132;
  } else {
