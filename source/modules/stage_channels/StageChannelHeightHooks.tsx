...
// Module 10621 (CALL_ACTION_BAR_HEIGHT)
...
export const useGetStageRTCPanelHeight = function useGetStageRTCPanelHeight(stateFromStores) {
  const stageBlockedUsersCount = require(7618) /* useStageBlockedUsersCount */.useStageBlockedUsersCount(stateFromStores);
  require(7618) /* useStageBlockedUsersCount */;
...
export const useGetActionBarHeight = function useGetActionBarHeight(id) {
  const stageBlockedUsersCount = require(7618) /* useStageBlockedUsersCount */.useStageBlockedUsersCount(id);
  require(7618) /* useStageBlockedUsersCount */;
  if (stageBlockedUsersCount > 0) {
    let num = 132;
  } else {
