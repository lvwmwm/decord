...
// Dependencies: [1218, 1931, 589, 4439, 2]
// Exports: default

// Module 10631 (useIsInvitedToSpeak)
...
export default function useIsInvitedToSpeak() {
  ...
  return importDefault(4439)(stateFromStores1, stateFromStores) === require(4439) /* useAudienceRequestToSpeakState */.RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK;
};
