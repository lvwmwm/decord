...
// Dependencies: [1372, 4302, 1931, 4271, 5088, 1377, 10648, 9665, 589, 5100, 5094, 5214, 2]
// Exports: shouldShowStageMusicMuteButton, useShowStageMusicMuteButton

// Module 10650 (checkVoiceStates)
...
export const useShowStageMusicMuteButton = function useShowStageMusicMuteButton(channelId) {
  ...
  const stageParticipants = _require(5100).useStageParticipants(channelId, _require(5094).StageChannelParticipantNamedIndex.SPEAKER);
  const obj2 = _require(5100);
...
export const shouldShowStageMusicMuteButton = function shouldShowStageMusicMuteButton(id) {
  ...
  mutableParticipants = mutableParticipants.getMutableParticipants(id, require(5094) /* sortKey */.StageChannelParticipantNamedIndex.SPEAKER);
  if (tmp) {
