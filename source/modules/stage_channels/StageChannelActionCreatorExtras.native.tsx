...
// Dependencies: [7816, 5172, 4312, 7818, 2007, 8005, 8046, 8053, 12726, 4555, 4553, 4549, 10710, 8828, 8048, 2]
...
// Module 7815 (openStageChannelSettings)
...
export const openStageChannelSettings = function openStageChannelSettings(closure_0) {
  ...
  obj.openLazy(require(2007) /* asyncRequireImpl */(7818, dependencyMap.paths), closure_5, obj);
};
...
export const openStageChannelAudienceNoticeModal = function openStageChannelAudienceNoticeModal(channelId) {
  let obj = importDefault(4312);
  obj = { channelId };
  obj.openLazy(require(2007) /* asyncRequireImpl */(8005, dependencyMap.paths), closure_4, obj);
};
export const openStageBlockedUsersSheet = function openStageBlockedUsersSheet(channel, onAccept) {
  let obj = importDefault(4312);
  obj = { channel, onAccept };
  obj.openLazy(require(2007) /* asyncRequireImpl */(8046, dependencyMap.paths), closure_6, obj);
};
export const openStageSettingsSheet = function openStageSettingsSheet(closure_0, closure_1) {
  ...
  obj.openLazy(require(2007) /* asyncRequireImpl */(8053, dependencyMap.paths), closure_7, obj);
};
...
export const openStageChannel = function openStageChannel(outer1_0) {
  if (outer1_0.isGuildStageVoice()) {
    let obj = require(4555) /* useIsStageVoicePanelEnabled */;
    if (obj.isStageVoicePanelEnabled("stage_channel_action_creator_extras")) {
      ...
      tmpResult = tmp(4553);
      obj2.pushLazy(tmp(2007)(10710, tmp2.paths), obj, tmpResult.getVoiceChannelKey(outer1_0.id));
      const tmp4 = tmp(2007)(10710, tmp2.paths);
    }
    tmp2 = dependencyMap;
  }
};
export const showPlatformUserProfile = function showPlatformUserProfile(arg0) {
  ...
  importDefault(8828)(obj);
};
export const shouldShowBlockedUsers = function shouldShowBlockedUsers(id) {
  const stageBlockedUsersCount = require(8048) /* useStageBlockedUsersCount */.getStageBlockedUsersCount(id);
  const obj = require(8048) /* useStageBlockedUsersCount */;
  const obj2 = require(8048) /* useStageBlockedUsersCount */;
  return stageBlockedUsersCount > 0 || require(8048) /* useStageBlockedUsersCount */.getStageIgnoredUsersCount(id) > 0;
};
export const navigateToStage = function navigateToStage(id) {
  ...
  if (id.isGuildStageVoice()) {
    let obj = require(4555) /* useIsStageVoicePanelEnabled */;
    if (obj.isStageVoicePanelEnabled("stage_channel_action_creator_extras")) {
      let tmp3Result = tmp3(4553);
      tmp3Result.openGuildVoiceModal(id);
    } else {
      obj = { channel: null };
      obj[0] = id;
      const obj2 = importDefault(4549);
      tmp3Result = tmp3(4553);
      obj2.pushLazy(tmp3(2007)(10710, tmp4.paths), obj, tmp3Result.getVoiceChannelKey(id.id));
      const tmp6 = tmp3(2007)(10710, tmp4.paths);
    }
    tmp4 = dependencyMap;
  }
};
