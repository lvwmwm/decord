...
// Dependencies: [7777, 5132, 4271, 7779, 2007, 7966, 8007, 8014, 12667, 4515, 4513, 4509, 10657, 8789, 8009, 2]
...
// Module 7776 (openStageChannelSettings)
...
export const openStageChannelSettings = function openStageChannelSettings(closure_0) {
  ...
  obj.openLazy(require(2007) /* asyncRequireImpl */(7779, dependencyMap.paths), closure_5, obj);
};
...
export const openStageChannelAudienceNoticeModal = function openStageChannelAudienceNoticeModal(channelId) {
  let obj = importDefault(4271);
  obj = { channelId };
  obj.openLazy(require(2007) /* asyncRequireImpl */(7966, dependencyMap.paths), closure_4, obj);
};
export const openStageBlockedUsersSheet = function openStageBlockedUsersSheet(channel, onAccept) {
  let obj = importDefault(4271);
  obj = { channel, onAccept };
  obj.openLazy(require(2007) /* asyncRequireImpl */(8007, dependencyMap.paths), closure_6, obj);
};
export const openStageSettingsSheet = function openStageSettingsSheet(closure_0, closure_1) {
  ...
  obj.openLazy(require(2007) /* asyncRequireImpl */(8014, dependencyMap.paths), closure_7, obj);
};
export const openEndStageModal = function openEndStageModal(closure_0) {
  let obj = importDefault(4271);
  obj = { channel: closure_0 };
  obj.openLazy(require(2007) /* asyncRequireImpl */(12667, dependencyMap.paths), closure_8, obj);
};
...
export const showPlatformUserProfile = function showPlatformUserProfile(arg0) {
  ...
  importDefault(8789)(obj);
};
export const shouldShowBlockedUsers = function shouldShowBlockedUsers(id) {
  const stageBlockedUsersCount = require(8009) /* useStageBlockedUsersCount */.getStageBlockedUsersCount(id);
  const obj = require(8009) /* useStageBlockedUsersCount */;
  const obj2 = require(8009) /* useStageBlockedUsersCount */;
  return stageBlockedUsersCount > 0 || require(8009) /* useStageBlockedUsersCount */.getStageIgnoredUsersCount(id) > 0;
};
