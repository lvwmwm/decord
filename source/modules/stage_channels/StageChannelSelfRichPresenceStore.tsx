...
// Dependencies: [1391, 1910, 4518, 4098, 1981, 1922, 5309, 1396, 5305, 676, 4094, 9872, 5315, 4638, 5308, 659, 589, 709, 2]

// Module 10575 (handleUpdateActivity)
...
import closure_10 from "getActiveStageChannelIds" /* 5309 */;
        ...
        if (obj1.canEveryone(constants2.VIEW_CHANNEL, channel)) {
          ...
          if (null != guild) {
            ...
            if (features.has(constants.DISCOVERABLE)) {
              ...
              const mutableParticipants = store.getMutableParticipants(channel.id, tmp12(5315).StageChannelParticipantNamedIndex.SPEAKER);
...
const stageChannelSelfRichPresenceStore = new StageChannelSelfRichPresenceStore(dispatcherDefault, {
  ...
  VOICE_STATE_UPDATES: function handleVoiceStateUpdates(voiceStates) {
    ...
    let _require;
    if (null != c17) {
      const result = _require(9872).unpackStageChannelParty(c17);
      _require = result;
      const obj = _require(9872);
      if (tmp5) {
