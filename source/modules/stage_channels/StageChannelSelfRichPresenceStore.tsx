...
// Dependencies: [1391, 1910, 4454, 4034, 1981, 1922, 5243, 1396, 5239, 676, 4030, 9805, 5249, 4574, 5242, 659, 589, 709, 2]

// Module 10507 (handleUpdateActivity)
...
import closure_10 from "getActiveStageChannelIds" /* 5243 */;
        ...
        if (obj1.canEveryone(constants2.VIEW_CHANNEL, channel)) {
          ...
          if (null != guild) {
            ...
            if (features.has(constants.DISCOVERABLE)) {
              ...
              const mutableParticipants = store.getMutableParticipants(channel.id, tmp12(5249).StageChannelParticipantNamedIndex.SPEAKER);
...
const stageChannelSelfRichPresenceStore = new StageChannelSelfRichPresenceStore(dispatcherDefault, {
  ...
  VOICE_STATE_UPDATES: function handleVoiceStateUpdates(voiceStates) {
    ...
    let _require;
    if (null != c17) {
      const result = _require(9805).unpackStageChannelParty(c17);
      _require = result;
      const obj = _require(9805);
      if (tmp5) {
