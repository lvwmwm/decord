...
// Dependencies: [32, 19, 1218, 589, 4634, 5331, 8628, 8630, 8615, 2]
// Exports: default

// Module 9959 (useToggleRequestToSpeak)
...
export default function useToggleRequestToSpeak(id) {
  ...
  importDefault = tmp4;
  const tmp5 = tmp4 === _require(4634).RequestToSpeakStates.REQUESTED_TO_SPEAK || tmp4 === _require(4634).RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK;
  dependencyMap = tmp5;
