...
// Dependencies: [32, 19, 1218, 589, 4632, 5313, 8009, 8011, 7990, 2]
// Exports: default

// Module 10967 (useToggleRequestToSpeak)
...
export default function useToggleRequestToSpeak(id) {
  ...
  importDefault = tmp4;
  const tmp5 = tmp4 === _require(4632).RequestToSpeakStates.REQUESTED_TO_SPEAK || tmp4 === _require(4632).RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK;
  dependencyMap = tmp5;
