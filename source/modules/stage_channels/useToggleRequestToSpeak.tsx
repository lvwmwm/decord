...
// Dependencies: [32, 19, 1218, 589, 4636, 5334, 8650, 8652, 8637, 2]
// Exports: default

// Module 9982 (useToggleRequestToSpeak)
...
export default function useToggleRequestToSpeak(id) {
  ...
  importDefault = tmp4;
  const tmp5 = tmp4 === _require(4636).RequestToSpeakStates.REQUESTED_TO_SPEAK || tmp4 === _require(4636).RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK;
  dependencyMap = tmp5;
