...
// Dependencies: [5, 32, 3827, 1218, 1372, 4407, 676, 13605, 3, 687, 595, 3771, 3859, 6038, 5713, 709, 10939, 9884, 1959, 4368, 4860, 9899, 2]

// Module 13604 (_getKeyForFileId)
...
function messageTimestampIsInInterval(arg0, arg1) {
  if (null != arg0) {
    ...
    const tmp5 = importDefault(3771)(arg0);
    return require(3859) /* resetCache */.isWithinInterval(tmp4, tmp5, arg1);
  } else {
    return false;
  }
}
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == channel) {
                ...
                obj1[0] = lib(outer1_2[18])(outer1_2[17], outer1_2.paths);
                return obj1;
              }
            }
          } else if (arg0 === 1) {
...
class LocalMessageCacheManager extends tmp3 {
  constructor() {
    ...
    if (tmp) {
      ...
      f109394 = _rehydrateFailedMessages((arg0) => {
        let closure_0 = arg0;
        let c2 = 0;
        let c1 = 0;
        return (function*(arg0) {
