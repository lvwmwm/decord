...
export default function GuildActionSheetTabItems(guild) {
  ...
  obj1[2] = closure_12(guild(7695).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(7751).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = tmp7(tmp(7751).IconButton, obj3);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = tmp7(tmp(7751).IconButton, obj5);
  }
