...
// Dependencies: [19, 1372, 1932, 1931, 676, 21, 13216, 4192, 589, 8990, 8987, 5117, 7672, 1236, 7616, 712, 4479, 4253, 5118, 9638, 7868, 5230, 5921, 8943, 2]
// Exports: default

// Module 13228 (GuildActionSheetTabItems)
...
export default function GuildActionSheetTabItems(guild) {
  ...
  obj1[2] = closure_12(guild(7616).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(7672).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = tmp7(tmp(7672).IconButton, obj3);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = tmp7(tmp(7672).IconButton, obj5);
  }
  items2[3] = canAccessSettings;
  obj[2] = items2;
  return closure_13(guild(5117).ButtonGroup, obj);
};
