...
// Dependencies: [31, 1348, 1908, 1907, 653, 33, 13076, 4072, 566, 8327, 8324, 5000, 6661, 1212, 6597, 689, 4359, 4133, 5001, 10202, 7709, 5113, 8988, 8280, 2]
// Exports: default

// Module 13088 (GuildActionSheetTabItems)
...
export default function GuildActionSheetTabItems(guild) {
  ...
  const total = stateFromStores(4072)(guild.id).total;
  let obj1 = guild(566);
  ...
  obj.icon = callback(guild(6597).BoostGemIcon, obj2);
  obj.grow = true;
  ...
  const items2 = [callback(guild(6661).IconButton, obj), , , ];
  if (shouldRenderInviteResult) {
    ...
    obj3.icon = stateFromStores(10202);
    obj3.grow = true;
    obj3.onPress = function onPress() {
      stateFromStores(outer1_3[17]).hideActionSheet();
      callback();
    };
    shouldRenderInviteResult = callback(guild(6661).IconButton, obj3);
  }
  ...
  obj4.icon = stateFromStores(7709);
  obj4.grow = true;
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = callback(guild(6661).IconButton, obj5);
  }
  items2[3] = canAccessSettings;
  obj.children = items2;
  return closure_13(guild(5000).ButtonGroup, obj);
};
