...
// Dependencies: [19, 1372, 1932, 1931, 676, 21, 13099, 4096, 589, 8351, 8348, 5022, 6682, 1236, 6618, 712, 4384, 4157, 5023, 10223, 7732, 5135, 9012, 8304, 2]
// Exports: default

// Module 13111 (GuildActionSheetTabItems)
...
export default function GuildActionSheetTabItems(guild) {
  ...
  obj1[2] = closure_12(guild(6618).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(6682).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = tmp7(tmp(6682).IconButton, obj3);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = tmp7(tmp(6682).IconButton, obj5);
  }
