...
// Dependencies: [19, 1372, 1961, 1960, 676, 21, 13238, 4209, 589, 9008, 9005, 5149, 7691, 1236, 7635, 712, 4496, 4270, 5150, 9656, 7998, 5261, 5952, 8961, 2]
// Exports: default

// Module 13250 (GuildActionSheetTabItems)
...
export default function GuildActionSheetTabItems(guild) {
  ...
  const total = stateFromStores(4209)(guild.id).total;
  let obj1 = guild(589);
  ...
  obj1[2] = closure_12(guild(7635).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(7691).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = tmp7(tmp(7691).IconButton, obj3);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = tmp7(tmp(7691).IconButton, obj5);
  }
  items2[3] = canAccessSettings;
  obj[2] = items2;
  return closure_13(guild(5149).ButtonGroup, obj);
};
