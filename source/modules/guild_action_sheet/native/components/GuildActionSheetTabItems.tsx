...
// Dependencies: [19, 1391, 1982, 1981, 676, 21, 13614, 4351, 589, 9832, 9829, 5328, 7938, 1236, 8166, 712, 4653, 4412, 5329, 10034, 7791, 5439, 6193, 9649, 2]
// Exports: default

// Module 13626 (GuildActionSheetTabItems)
...
export default function GuildActionSheetTabItems(guild) {
  ...
  const total = stateFromStores(4351)(guild.id).total;
  obj1 = guild(589);
  ...
  obj1[2] = closure_12(guild(8166).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(7938).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = tmp7(tmp(7938).IconButton, obj3);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = tmp7(tmp(7938).IconButton, obj5);
  }
  items2[3] = canAccessSettings;
  obj[2] = items2;
  return closure_13(guild(5328).ButtonGroup, obj);
};
