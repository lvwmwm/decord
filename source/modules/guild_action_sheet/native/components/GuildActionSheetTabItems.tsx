...
// Dependencies: [19, 1372, 1932, 1931, 676, 21, 13187, 4162, 589, 8962, 8959, 5102, 7644, 1236, 7588, 712, 4449, 4223, 5103, 9609, 7840, 5215, 5906, 8915, 2]
// Exports: default

// Module 13199 (GuildActionSheetTabItems)
...
export default function GuildActionSheetTabItems(guild) {
  ...
  obj1[2] = closure_12(guild(7588).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(7644).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = tmp7(tmp(7644).IconButton, obj3);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = tmp7(tmp(7644).IconButton, obj5);
  }
  items2[3] = canAccessSettings;
  obj[2] = items2;
  return closure_13(guild(5102).ButtonGroup, obj);
};
