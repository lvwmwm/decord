...
// Dependencies: [19, 1391, 1982, 1981, 676, 21, 13587, 4350, 589, 9283, 9280, 5323, 7963, 1236, 7907, 712, 4652, 4411, 5324, 9940, 8276, 5434, 6187, 9236, 2]
// Exports: default

// Module 13599 (GuildActionSheetTabItems)
...
export default function GuildActionSheetTabItems(guild) {
  ...
  const total = stateFromStores(4350)(guild.id).total;
  obj1 = guild(589);
  ...
  obj1[2] = closure_12(guild(7907).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(7963).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = tmp7(tmp(7963).IconButton, obj3);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = tmp7(tmp(7963).IconButton, obj5);
  }
  items2[3] = canAccessSettings;
  obj[2] = items2;
  return closure_13(guild(5323).ButtonGroup, obj);
};
