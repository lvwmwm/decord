...
// Dependencies: [19, 1387, 1982, 1981, 676, 21, 13667, 4354, 589, 9873, 9870, 5344, 7974, 1236, 8202, 712, 4668, 4415, 5345, 10075, 7826, 5455, 6209, 9689, 2]
// Exports: default

// Module 13679 (GuildActionSheetTabItems)
...
export default function GuildActionSheetTabItems(guild) {
  ...
  const total = stateFromStores(4354)(guild.id).total;
  obj1 = guild(589);
  ...
  obj1[2] = closure_12(guild(8202).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(7974).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = tmp7(tmp(7974).IconButton, obj3);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = tmp7(tmp(7974).IconButton, obj5);
  }
  items2[3] = canAccessSettings;
  obj[2] = items2;
  return closure_13(guild(5344).ButtonGroup, obj);
};
