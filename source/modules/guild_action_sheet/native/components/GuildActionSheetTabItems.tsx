...
export default function GuildActionSheetTabItems(guild) {
  ...
  obj1[2] = closure_12(guild(7740).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(7796).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = tmp7(tmp(7796).IconButton, obj3);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = tmp7(tmp(7796).IconButton, obj5);
  }
  items2[3] = canAccessSettings;
  obj[2] = items2;
  return closure_13(guild(5191).ButtonGroup, obj);
};
