...
// Dependencies: [19, 1372, 1961, 1960, 676, 21, 13224, 4192, 589, 8991, 8988, 5132, 7672, 1236, 7616, 712, 4479, 4253, 5133, 9640, 7981, 5245, 5933, 8944, 2]
// Exports: default

// Module 13236 (GuildActionSheetTabItems)
...
export default function GuildActionSheetTabItems(guild) {
  ...
  obj[2] = items2;
  return closure_13(guild(5132).ButtonGroup, obj);
};
