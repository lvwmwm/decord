...
// Dependencies: [19, 1391, 1980, 1979, 676, 21, 13375, 4251, 589, 9113, 9110, 5190, 7792, 1236, 7736, 712, 4538, 4312, 5191, 9768, 8099, 5301, 6053, 9066, 2]
// Exports: default

// Module 13387 (GuildActionSheetTabItems)
...
export default function GuildActionSheetTabItems(guild) {
  ...
  const total = stateFromStores(4251)(guild.id).total;
  let obj1 = guild(589);
  ...
  obj1[2] = closure_12(guild(7736).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(7792).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = tmp7(tmp(7792).IconButton, obj3);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = tmp7(tmp(7792).IconButton, obj5);
  }
  items2[3] = canAccessSettings;
  obj[2] = items2;
  return closure_13(guild(5190).ButtonGroup, obj);
};
