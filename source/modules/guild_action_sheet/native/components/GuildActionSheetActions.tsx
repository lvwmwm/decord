...
// Dependencies: [19, 17, 7210, 1340, 1434, 7314, 1985, 4460, 4654, 1922, 676, 5416, 7786, 4655, 21, 4445, 712, 589, 5943, 1236, 10621, 6131, 4266, 1377, 7206, 4412, 4676, 11064, 2009, 11775, 4638, 5905, 5925, 8953, 1297, 9692, 13564, 1306, 1374, 9652, 13565, 8007, 8929, 4441, 4134, 6194, 5439, 10150, 5434, 13613, 10145, 13614, 9563, 5303, 9627, 9589, 11084, 13615, 4811, 38, 13562, 10102, 10101, 7213, 11070, 13616, 8681, 7858, 11316, 5932, 5933, 4161, 1435, 2]
...
// Module 13563 (HideMutedChannelsOption)
...
import experimentDefault from "experiment" /* 5932 */;
...
import closure_12 from "updateUserGuildSettingsInternal" /* 4654 */;
...
function HideMutedChannelsOption(guild) {
  ...
  return callback2(guild(5943).ActionSheetSwitchRow, obj);
}
function BrowseChannelsOption(guild) {
  ...
  if (!features.has(constants.COMMUNITY)) {
    ...
    tmp8Result = tmp8(tmp3(11775).NewBadge, {});
  }
}
function ChangeIdentityOption(arg0) {
  ...
  return closure_21(_require(5943).ActionSheetRow, obj);
}
function GuildThemePreferenceOption(guild) {
  ...
  if (tmp2) {
    ...
    obj[2] = tmp5;
    tmp6 = callback2(tmp3(5943).ActionSheetSwitchRow, obj);
  }
  return tmp6;
}
function ServerTagOption(guild) {
  ...
  if (result) {
    ...
    const guildTagBadgeUrl = tmp2(8007).getGuildTagBadgeUrl(guild.id, badge, GuildTagBadgeSize.SIZE_16);
    obj = { style: null, children: null };
    ...
    obj1[2] = closure_21(tmp2(8929).BaseGuildTagChiplet, obj2);
    ...
    items[1] = closure_21(tmp2(4441).Text, obj3);
    obj[1] = items;
    obj[0] = closure_22(View, obj);
    obj[1] = tmp5;
    return closure_21(tmp2(5943).ActionSheetRow, obj);
  } else {
    return null;
  }
  tmp = callback4();
...
export const GuildActionSheetPrimaryActions = function GuildActionSheetPrimaryActions(guild) {
  ...
  if (obj.useGuildActionSheetPermissions(guild).canManageChannels) {
    ...
    items1.push(callback2(tmp(5943).ActionSheetRow, obj));
    obj = { label: null, onPress: null };
  ...
  if (tmp3) {
    ...
    items1.push(callback2(tmp(5943).ActionSheetRow, obj1));
  }
  if (stateFromStores) {
...
export const GuildActionSheetDirectoryActions = function GuildActionSheetDirectoryActions(guild) {
  ...
  if (tmp4) {
    ...
    if (0 !== items.length) {
      ...
      tmp5Result = tmp5(tmp9(5943).ActionSheetRow.Group, obj);
    }
    return tmp5Result;
  } else {
    const features = guild.features;
    ...
    t = items.push(tmp5(tmp9(5943).ActionSheetRow, obj));
  }
};
export const GuildActionSheetSecondaryActions = function GuildActionSheetSecondaryActions(guild) {
  ...
  if (features.has(constants.COMMUNITY)) {
    ...
    items.push(tmp8(tmp3(5943).ActionSheetSwitchRow, obj));
  }
  items.push(callback2(HideMutedChannelsOption, { guild }));
  items.push(callback2(RestrictedGuildPrivacyOption, { guild }));
  const tmp12 = constants;
  const tmp2 = callback(guild, currentUser);
  const messageRequestPrivacyOption = guild(13562).useMessageRequestPrivacyOption({ guild });
  if (null != messageRequestPrivacyOption) {
    items.push(messageRequestPrivacyOption);
  }
  if (canReportRaid) {
    ...
    items.push(tmp8(tmp3(5943).ActionSheetRow, obj));
  }
  obj1 = { label: null, onPress: null };
  ...
  items.push(callback2(guild(5943).ActionSheetRow, obj1));
  if (!shouldShowIncidentActions) {
    if (tmp2) {
      ...
      if (0 !== items.length) {
        ...
        tmp8Result = tmp8(tmp3(5943).ActionSheetRow.Group, obj2);
      }
      return tmp8Result;
    } else {
      ...
      t2 = items.push(tmp8(tmp3(5943).ActionSheetRow, obj3));
    }
  } else {
    ...
    t = items.push(tmp8(tmp3(5943).ActionSheetRow, obj4));
  }
};
export const GuildDeveloperOptionAction = function GuildDeveloperOptionAction(guild) {
  guild = guild.guild;
  const DeveloperMode = guild(4134).DeveloperMode;
  ...
  if (setting) {
    ...
    items.push(callback2(tmp(5943).ActionSheetRow, obj));
    if (tmp5) {
      if (null != guild.icon) {
        obj = { label: null, onPress: null };
        const intl2 = tmp(1236).intl;
        ...
        items.push(tmp7(tmp(5943).ActionSheetRow, obj));
      }
    ...
    return callback2(tmp(5943).ActionSheetRow.Group, obj1);
  } else {
    return null;
  }
};
