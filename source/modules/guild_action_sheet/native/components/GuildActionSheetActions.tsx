...
// Dependencies: [19, 17, 7286, 1339, 1429, 7390, 1984, 4493, 4701, 1921, 673, 5472, 7862, 4702, 21, 4478, 709, 586, 5999, 1233, 10922, 6188, 4298, 1372, 7282, 4445, 4723, 11369, 2008, 12081, 4673, 5961, 5981, 9045, 1296, 9793, 13873, 1305, 1369, 9753, 13874, 8083, 9021, 4474, 4166, 6251, 5495, 10252, 5490, 13922, 10247, 13923, 9655, 5359, 9720, 9681, 11389, 13924, 4859, 38, 13871, 10204, 10203, 7289, 11375, 13925, 8771, 7935, 11625, 5988, 5989, 4193, 1430, 2]
...
// Module 13872 (HideMutedChannelsOption)
...
import experimentDefault from "experiment" /* 5988 */;
...
function HideMutedChannelsOption(guild) {
  ...
  return callback2(guild(5999).ActionSheetSwitchRow, obj);
}
function BrowseChannelsOption(guild) {
  ...
  if (!features.has(constants.COMMUNITY)) {
    ...
    tmp8Result = tmp8(tmp3(12081).NewBadge, {});
  }
}
function ChangeIdentityOption(arg0) {
  ...
  return closure_21(_require(5999).ActionSheetRow, obj);
}
function GuildThemePreferenceOption(guild) {
  ...
  if (tmp2) {
    ...
    obj[2] = tmp5;
    tmp6 = callback2(tmp3(5999).ActionSheetSwitchRow, obj);
  }
  return tmp6;
}
function ServerTagOption(guild) {
  ...
  if (result) {
    ...
    const guildTagBadgeUrl = tmp2(8083).getGuildTagBadgeUrl(guild.id, badge, GuildTagBadgeSize.SIZE_16);
    obj = { style: null, children: null };
    ...
    obj1[2] = closure_21(tmp2(9021).BaseGuildTagChiplet, obj2);
    ...
    obj[1] = tmp5;
    return closure_21(tmp2(5999).ActionSheetRow, obj);
  } else {
    return null;
  }
  tmp = callback4();
...
export const GuildActionSheetPrimaryActions = function GuildActionSheetPrimaryActions(guild) {
  ...
  if (obj.useGuildActionSheetPermissions(guild).canManageChannels) {
    ...
    items1.push(callback2(tmp(5999).ActionSheetRow, obj));
    obj = { label: null, onPress: null };
  ...
  if (tmp3) {
    ...
    items1.push(callback2(tmp(5999).ActionSheetRow, obj1));
  }
  if (stateFromStores) {
...
export const GuildActionSheetDirectoryActions = function GuildActionSheetDirectoryActions(guild) {
  ...
  if (tmp4) {
    ...
    if (0 !== items.length) {
      ...
      tmp5Result = tmp5(tmp9(5999).ActionSheetRow.Group, obj);
    }
    return tmp5Result;
  } else {
    const features = guild.features;
    ...
    t = items.push(tmp5(tmp9(5999).ActionSheetRow, obj));
  }
};
export const GuildActionSheetSecondaryActions = function GuildActionSheetSecondaryActions(guild) {
  ...
  if (features.has(constants.COMMUNITY)) {
    ...
    items.push(tmp8(tmp3(5999).ActionSheetSwitchRow, obj));
  }
  items.push(callback2(HideMutedChannelsOption, { guild }));
  items.push(callback2(RestrictedGuildPrivacyOption, { guild }));
  const messageRequestPrivacyOption = guild(13871).useMessageRequestPrivacyOption({ guild });
  if (null != messageRequestPrivacyOption) {
    items.push(messageRequestPrivacyOption);
  }
  if (canReportRaid) {
    ...
    items.push(tmp8(tmp3(5999).ActionSheetRow, obj));
  }
  if (!tmp2) {
    obj1 = { label: null, onPress: null };
    ...
    items.push(tmp8(tmp3(5999).ActionSheetRow, obj1));
  }
  if (!shouldShowIncidentActions) {
    if (tmp2) {
      ...
      if (0 !== items.length) {
        ...
        tmp8Result = tmp8(tmp3(5999).ActionSheetRow.Group, obj2);
      }
      return tmp8Result;
    } else {
      ...
      t2 = items.push(tmp8(tmp3(5999).ActionSheetRow, obj3));
    }
  } else {
    ...
    t = items.push(tmp8(tmp3(5999).ActionSheetRow, obj4));
  }
};
export const GuildDeveloperOptionAction = function GuildDeveloperOptionAction(guild) {
  ...
  if (setting) {
    ...
    items.push(callback2(tmp(5999).ActionSheetRow, obj));
    if (tmp5) {
      if (null != guild.icon) {
        obj = { label: null, onPress: null };
        const intl2 = tmp(1233).intl;
        ...
        items.push(tmp7(tmp(5999).ActionSheetRow, obj));
      }
    ...
    return callback2(tmp(5999).ActionSheetRow.Group, obj1);
  } else {
    return null;
  }
};
