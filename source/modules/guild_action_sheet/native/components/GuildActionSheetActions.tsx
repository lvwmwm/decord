...
// Dependencies: [19, 17, 6994, 1340, 1434, 7098, 1983, 4315, 4499, 1922, 676, 5239, 8054, 4500, 21, 4303, 712, 589, 5766, 1236, 9741, 5952, 4125, 1377, 6990, 4271, 4509, 11027, 2007, 11666, 4493, 5728, 5748, 10140, 1297, 9136, 13268, 1306, 1374, 9030, 13269, 8271, 9258, 4299, 3993, 6015, 5262, 9829, 5257, 13317, 9824, 13318, 9043, 5124, 9002, 8967, 11047, 13319, 4644, 38, 13266, 9778, 9777, 6997, 11033, 13320, 8022, 8126, 11233, 5755, 5756, 4020, 1435, 2]
...
// Module 13267 (HideMutedChannelsOption)
...
function HideMutedChannelsOption(guild) {
  ...
  return callback2(guild(5766).ActionSheetSwitchRow, obj);
}
function BrowseChannelsOption(guild) {
  ...
  const tmp2 = importDefault(5952)(guild);
...
function ChangeIdentityOption(arg0) {
  ...
  _require = importDefault(10140)({ guild, analyticsLocations: importDefault(5728)(importDefault(5748).GUILD_SETTINGS).analyticsLocations });
  ...
  if (null != user) {
    ...
    if (user.hasAvatarForGuild(guild.id)) {
      ...
      items[1] = tmp6(importDefault(9136), obj2);
      obj[1] = items;
  ...
  return closure_21(_require(5766).ActionSheetRow, obj);
}
function GuildThemePreferenceOption(guild) {
  ...
  if (tmp2) {
    ...
    obj[2] = tmp5;
    tmp6 = callback2(tmp3(5766).ActionSheetSwitchRow, obj);
  }
  return tmp6;
}
function ServerTagOption(guild) {
  ...
  if (result) {
    ...
    items[1] = closure_21(tmp2(4299).Text, obj3);
    obj[1] = items;
    obj[0] = closure_22(View, obj);
    obj[1] = tmp5;
    return closure_21(tmp2(5766).ActionSheetRow, obj);
  } else {
    return null;
  }
  tmp = createCacheKey();
...
export const GuildActionSheetPrimaryActions = function GuildActionSheetPrimaryActions(guild) {
  ...
  if (obj.useGuildActionSheetPermissions(guild).canManageChannels) {
    ...
    items1.push(callback2(tmp(5766).ActionSheetRow, obj));
    obj = { label: null, onPress: null };
  ...
  if (tmp3) {
    ...
    items1.push(callback2(tmp(5766).ActionSheetRow, obj1));
  }
  if (stateFromStores) {
...
export const handleLeaveServer = function handleLeaveServer(guild) {
  ...
  obj = { guild };
  require(4644) /* useAlertStore */.openAlert("guild-action-sheet-leave-server", callback2(lazyResult, obj));
};
export const GuildActionSheetDirectoryActions = function GuildActionSheetDirectoryActions(guild) {
  ...
  if (tmp4) {
    ...
    if (0 !== items.length) {
      ...
      tmp5Result = tmp5(tmp9(5766).ActionSheetRow.Group, obj);
    }
    return tmp5Result;
  } else {
    const features = guild.features;
    ...
    t = items.push(tmp5(tmp9(5766).ActionSheetRow, obj));
  }
};
export const GuildActionSheetSecondaryActions = function GuildActionSheetSecondaryActions(guild) {
  ...
  if (features.has(constants.COMMUNITY)) {
    ...
    items.push(tmp8(tmp3(5766).ActionSheetSwitchRow, obj));
  }
  ...
  if (canReportRaid) {
    ...
    items.push(tmp8(tmp3(5766).ActionSheetRow, obj));
  }
  obj1 = { label: null, onPress: null };
  ...
  items.push(callback2(guild(5766).ActionSheetRow, obj1));
  if (!shouldShowIncidentActions) {
    if (tmp2) {
      ...
      if (0 !== items.length) {
        ...
        tmp8Result = tmp8(tmp3(5766).ActionSheetRow.Group, obj2);
      }
      return tmp8Result;
    } else {
      ...
      t2 = items.push(tmp8(tmp3(5766).ActionSheetRow, obj3));
    }
  } else {
    ...
    t = items.push(tmp8(tmp3(5766).ActionSheetRow, obj4));
  }
};
export const GuildDeveloperOptionAction = function GuildDeveloperOptionAction(guild) {
  ...
  if (setting) {
    ...
    items.push(callback2(tmp(5766).ActionSheetRow, obj));
    if (tmp5) {
      if (null != guild.icon) {
        obj = { label: null, onPress: null };
        const intl2 = tmp(1236).intl;
        ...
        items.push(tmp7(tmp(5766).ActionSheetRow, obj));
      }
    ...
    return callback2(tmp(5766).ActionSheetRow.Group, obj1);
  } else {
    return null;
  }
};
