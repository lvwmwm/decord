...
// Dependencies: [19, 17, 7277, 1340, 1430, 7381, 1985, 4493, 4701, 1922, 676, 5464, 7853, 4702, 21, 4478, 712, 589, 5991, 1236, 10701, 6179, 4298, 1373, 7273, 4445, 4723, 11148, 2009, 11858, 4673, 5953, 5973, 9031, 1297, 9771, 13650, 1306, 1370, 9731, 13651, 8075, 9007, 4474, 4166, 6242, 5487, 10230, 5482, 13699, 10225, 13700, 9642, 5351, 9706, 9668, 11168, 13701, 4859, 38, 13648, 10182, 10181, 7280, 11154, 13702, 8756, 7926, 11402, 5980, 5981, 4193, 1431, 2]
...
// Module 13649 (HideMutedChannelsOption)
...
import experimentDefault from "experiment" /* 5980 */;
...
import closure_12 from "updateUserGuildSettingsInternal" /* 4701 */;
...
function HideMutedChannelsOption(guild) {
  ...
  return callback2(guild(5991).ActionSheetSwitchRow, obj);
}
...
function ChangeIdentityOption(arg0) {
  ...
  return closure_21(_require(5991).ActionSheetRow, obj);
}
function GuildThemePreferenceOption(guild) {
  ...
  if (tmp2) {
    ...
    obj[2] = tmp5;
    tmp6 = callback2(tmp3(5991).ActionSheetSwitchRow, obj);
  }
  return tmp6;
}
function ServerTagOption(guild) {
  ...
  if (result) {
    ...
    const guildTagBadgeUrl = tmp2(8075).getGuildTagBadgeUrl(guild.id, badge, GuildTagBadgeSize.SIZE_16);
    obj = { style: null, children: null };
    ...
    obj1[2] = closure_21(tmp2(9007).BaseGuildTagChiplet, obj2);
    ...
    items[1] = closure_21(tmp2(4474).Text, obj3);
    obj[1] = items;
    obj[0] = closure_22(View, obj);
    obj[1] = tmp5;
    return closure_21(tmp2(5991).ActionSheetRow, obj);
  } else {
    return null;
  }
  tmp = callback4();
...
export const GuildActionSheetPrimaryActions = function GuildActionSheetPrimaryActions(guild) {
  ...
  if (obj.useGuildActionSheetPermissions(guild).canManageChannels) {
    ...
    items1.push(callback2(tmp(5991).ActionSheetRow, obj));
    obj = { label: null, onPress: null };
  ...
  if (tmp3) {
    ...
    items1.push(callback2(tmp(5991).ActionSheetRow, obj1));
  }
  if (stateFromStores) {
...
export const GuildActionSheetDirectoryActions = function GuildActionSheetDirectoryActions(guild) {
  ...
  if (tmp4) {
    ...
    if (0 !== items.length) {
      ...
      tmp5Result = tmp5(tmp9(5991).ActionSheetRow.Group, obj);
    }
    return tmp5Result;
  } else {
    const features = guild.features;
    ...
    t = items.push(tmp5(tmp9(5991).ActionSheetRow, obj));
  }
};
export const GuildActionSheetSecondaryActions = function GuildActionSheetSecondaryActions(guild) {
  ...
  if (features.has(constants.COMMUNITY)) {
    ...
    items.push(tmp8(tmp3(5991).ActionSheetSwitchRow, obj));
  }
  items.push(callback2(HideMutedChannelsOption, { guild }));
  items.push(callback2(RestrictedGuildPrivacyOption, { guild }));
  const messageRequestPrivacyOption = guild(13648).useMessageRequestPrivacyOption({ guild });
  if (null != messageRequestPrivacyOption) {
    items.push(messageRequestPrivacyOption);
  }
  if (canReportRaid) {
    ...
    items.push(tmp8(tmp3(5991).ActionSheetRow, obj));
  }
  if (!tmp2) {
    obj1 = { label: null, onPress: null };
    ...
    items.push(tmp8(tmp3(5991).ActionSheetRow, obj1));
  }
  if (!shouldShowIncidentActions) {
    if (tmp2) {
      ...
      if (0 !== items.length) {
        ...
        tmp8Result = tmp8(tmp3(5991).ActionSheetRow.Group, obj2);
      }
      return tmp8Result;
    } else {
      ...
      t2 = items.push(tmp8(tmp3(5991).ActionSheetRow, obj3));
    }
  } else {
    ...
    t = items.push(tmp8(tmp3(5991).ActionSheetRow, obj4));
  }
};
export const GuildDeveloperOptionAction = function GuildDeveloperOptionAction(guild) {
  ...
  if (setting) {
    ...
    items.push(callback2(tmp(5991).ActionSheetRow, obj));
    if (tmp5) {
      if (null != guild.icon) {
        obj = { label: null, onPress: null };
        const intl2 = tmp(1236).intl;
        ...
        items.push(tmp7(tmp(5991).ActionSheetRow, obj));
      }
    ...
    return callback2(tmp(5991).ActionSheetRow.Group, obj1);
  } else {
    return null;
  }
};
