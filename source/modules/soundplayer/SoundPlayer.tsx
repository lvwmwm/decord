...
// Function ID: 16846
// Name: MuteDeafen
// Dependencies: [19, 1385, 9439, 4498, 16511, 1390, 4503, 1215, 1386, 1908, 4532, 10010, 4557, 1980, 5380, 4500, 4558, 673, 9440, 21, 586, 9831, 4675, 4547, 4110, 1394, 7187, 2]
// Exports: default

// Module 16845 (MuteDeafen)
...
import closure_7 from "isProjectOwner" /* 16511 */;
import { SILENT_JOIN_LEAVE_CHANNEL_TYPES as closure_8 } from "createChannelRecord" /* 1390 */;
...
import closure_14 from "DesktopNotificationTypes" /* 10010 */;
import closure_15 from "createRTCConnection" /* 4557 */;
import closure_16 from "handleConnectionOpen" /* 1980 */;
import closure_17 from "anyoneHasFlagInContext" /* 5380 */;
import closure_18 from "updateVoiceState" /* 4500 */;
import closure_19 from "getVoiceStatesForGuild" /* 4558 */;
...
function MuteDeafen() {
  ...
  const f103722 = () => ({ inVoiceChannel: null != voiceChannelId.getVoiceChannelId(), selfMute: closure_13.isSelfMute(), selfDeaf: closure_13.isSelfDeaf(), audioPermissionReady: closure_13.isNativeAudioPermissionReady(), shouldSkipMuteUnmuteSound: closure_13.shouldSkipMuteUnmuteSound() });
  const f103723 = (selfDeaf) => {
  ...
  const effect = f103723.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f103740[20]).BatchedStoreListener(closure_0, () => {
      ...
      if (!isSoundDisabledResult) {
        items(f103740[21]).playSound(tmp2, 0.4);
        const obj = items(f103740[21]);
      }
      closure_0 = tmp;
    });
...
function Camera() {
  const items = [closure_13, closure_16];
  const f103724 = () => ({ videoEnabled: videoEnabled.isVideoEnabled(), inVoiceChannel: null != voiceChannelId.getVoiceChannelId() });
  const f103725 = (videoEnabled, videoEnabled2) => {
  ...
  const effect = f103725.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f103740[20]).BatchedStoreListener(closure_0, () => {
      const tmp = batchedStoreListener();
      const tmp2 = closure_1_2(closure_0, tmp);
...
function RTCConnect() {
  ...
  const effect = f103727.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f103740[20]).BatchedStoreListener(closure_0, () => {
      const tmp = batchedStoreListener();
      const tmp2 = closure_1_2(closure_0, tmp);
...
function Speaking() {
  ...
  const f103728 = () => currentUserPTTActive.isCurrentUserPTTActive();
  const f103729 = (arg0, arg1) => {
    if (arg0 !== arg1) {
  ...
  const effect = f103729.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f103740[20]).BatchedStoreListener(closure_0, () => {
      const tmp = batchedStoreListener();
      const tmp2 = closure_1_2(closure_0, tmp);
...
function SelfMutedTemporarily() {
  ...
  const f103730 = () => closure_13.isSelfMutedTemporarily();
  const f103731 = (arg0, arg1) => {
    if (arg0 !== arg1) {
  ...
  const effect = f103731.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f103740[20]).BatchedStoreListener(closure_0, () => {
      const tmp = batchedStoreListener();
      const tmp2 = closure_1_2(closure_0, tmp);
...
function PriorityVAD() {
  const items = [closure_17];
  const f103732 = () => currentUserPrioritySpeaker.isCurrentUserPrioritySpeaker();
  const f103733 = (arg0, arg1) => {
    if (arg0 !== arg1) {
      if (closure_13.getMode() === constants.VOICE_ACTIVITY) {
        if (!isSelfMuteResult) {
          let str = "ptt_stop";
  ...
  const effect = f103733.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f103740[20]).BatchedStoreListener(closure_0, () => {
      const tmp = batchedStoreListener();
      const tmp2 = closure_1_2(closure_0, tmp);
...
function UserHasBeenMoved() {
  ...
  const f103734 = () => obj.userHasBeenMovedVersion;
  const f103735 = (arg0, arg1) => {
    if (arg0 !== arg1) {
      return "user_moved";
    }
  };
  const effect = f103735.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f103740[20]).BatchedStoreListener(closure_0, () => {
      const tmp = batchedStoreListener();
      const tmp2 = closure_1_2(closure_0, tmp);
...
function UserInvitedToSpeak() {
  ...
  const f103736 = () => {
    ...
    if (null == voiceChannelId) {
      return items(f103736[22]).RequestToSpeakStates.NONE;
    } else {
      voiceStateForChannel = voiceStateForChannel.getVoiceStateForChannel(voiceChannelId);
      return items(f103736[22]).getAudienceRequestToSpeakState(voiceStateForChannel);
    }
  };
  const f103737 = (arg0, arg1) => {
    if (arg0 !== arg1) {
      if (arg1 === items(f103736[22]).RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK) {
        return "reconnect";
      }
    }
  };
  const effect = f103737.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f103740[20]).BatchedStoreListener(closure_0, () => {
      const tmp = batchedStoreListener();
      const tmp2 = closure_1_2(closure_0, tmp);
...
function VoiceChannel() {
  ...
  const f103738 = () => {
    ...
    if (null != first) {
      const encodeStreamKeyResult = currentUserId(f103738[23]).encodeStreamKey(first);
      ...
      const obj2 = currentUserId(f103738[23]);
    }
  ...
  const f103739 = (voiceChannelId) => {
    closure_0 = voiceChannelId;
    ({ channelType, voiceChannelId, voiceChannelUserCount, streamingUserIds } = arg1);
    ({ singleActiveStreamKey, singleActiveStreamViewerCount, currentUserId: f103739 } = arg1);
    closure_3 = undefined;
  ...
  const effect = f103739.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f103740[20]).BatchedStoreListener(closure_0, () => {
      const tmp = batchedStoreListener();
      const tmp2 = closure_1_2(closure_0, tmp);
...
function ActivitySounds() {
  ...
  const f103740 = () => {
    ...
    const embeddedActivityLocationChannelId = items(f103740[24]).getEmbeddedActivityLocationChannelId(connectedActivityLocation);
    id = id.getId();
    const obj2 = items(f103740[24]);
  ...
  const f103741 = (voiceChannelActivities) => {
  ...
  const effect = f103741.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f103740[20]).BatchedStoreListener(closure_0, () => {
      const tmp = batchedStoreListener();
      const tmp2 = closure_1_2(closure_0, tmp);
