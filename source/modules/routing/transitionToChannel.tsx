...
// Dependencies: [1372, 676, 4264, 4265, 1222, 4449, 38, 2]
...
export const transitionToChannel = function transitionToChannel(id, openTextInVoiceIfVoiceChannel) {
  ...
  if (null != channel) {
    ...
    if (prop) {
      tmp7(4449).updateChatOpen(channel.id, true);
      const tmp7Result = tmp7(4449);
    }
...
export const tryTransitionToThreadMessage = function tryTransitionToThreadMessage(parentChannelId, threadId, messageId) {
  ...
  if (null != channel) {
    ...
    if (null != channel1) {
      ...
      if (prop) {
        tmp20(4449).updateChatOpen(channel1.id, true);
        const tmp20Result = tmp20(4449);
      }
