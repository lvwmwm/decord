...
// Dependencies: [653, 5600, 5161, 1198, 2]
// Exports: transitionToGuild

// Module 6633 (transitionToGuild)
...
export const transitionToGuild = function transitionToGuild(guildId) {
  ...
  const result = require(5161) /* DeprecatedLayoutAnimation */.DeprecatedLayoutAnimation({ duration: 0, create: undefined, update: undefined, delete: undefined });
  const obj2 = require(5161) /* DeprecatedLayoutAnimation */;
