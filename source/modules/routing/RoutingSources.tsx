...
// Module 1210 (set)
const items = [, ];
({ EMBED: arr[0], FORUM: arr[1] } = require(dependencyMap[0]).OpenThreadAnalyticsLocations);
const _module = require(dependencyMap[1]);
const result = _module.fileFinishedImporting("modules/routing/RoutingSources.tsx");
