...
// Dependencies: [653, 3985, 3982, 3983, 3953, 3966, 2]
// Exports: convertRouteToNavigation

// Module 10814 (convertRouteToNavigation)
  ...
  if (null != rootNavigationRef) {
    if (rootNavigationRef.isReady()) {
      if (pathname.startsWith("/channels/")) {
        let obj2 = require(3953) /* matchPath */;
        obj = {};
        ...
        if (null != obj2.matchPath(pathname, obj)) {
          ...
          const obj3 = {};
          const RouteParam6 = require(3966) /* isPseudoGuildId */.RouteParam;
          const obj28 = require(3953) /* matchPath */;
          const RouteParam7 = require(3966) /* isPseudoGuildId */.RouteParam;
          ...
          if (null != matchPathResult) {
            ...
            let obj12 = require(3985) /* useChatLayout */;
            if (obj12.getChatLayout().isChatLockedOpen) {
              if (null != channelId) {
                if (false === navigationReplace) {
                  const obj31 = require(3982) /* _createForOfIteratorHelperLoose */;
                  const rootNavigationRef1 = require(3983) /* getRootNavigationRef */.getRootNavigationRef();
                  let currentRoute;
                  ...
                  if (channelId === channelId) {
                    ...
                    require(3982) /* _createForOfIteratorHelperLoose */.navigateToRootTab(obj5);
                    const obj24 = require(3982) /* _createForOfIteratorHelperLoose */;
                  } else {
                    const obj6 = { channelId, guildId, messageId, replaceChannelAndFixRoot: navigationReplace };
                    require(3982) /* _createForOfIteratorHelperLoose */.navigateToChannel(obj6);
                    const obj22 = require(3982) /* _createForOfIteratorHelperLoose */;
                  }
                  const obj32 = require(3983) /* getRootNavigationRef */;
                }
              }
              const obj7 = { screen: "guilds", guildId, channelId, resetRoot: navigationReplace };
              require(3982) /* _createForOfIteratorHelperLoose */.navigateToRootTab(obj7);
              const obj26 = require(3982) /* _createForOfIteratorHelperLoose */;
              ...
              if (true === navigationReplace) {
                if (pathname.openChannel) {
                  ...
                  require(3982) /* _createForOfIteratorHelperLoose */.navigateToChannel(obj8);
                  const obj20 = require(3982) /* _createForOfIteratorHelperLoose */;
                }
              }
              if (false !== navigationReplace) {
                let obj9 = { screen: "guilds", guildId, channelId, resetRoot: navigationReplace };
                require(3982) /* _createForOfIteratorHelperLoose */.navigateToRootTab(obj9);
                const obj16 = require(3982) /* _createForOfIteratorHelperLoose */;
              }
              if (tmp31) {
                const obj10 = { channelId, guildId, messageId, replaceChannelAndFixRoot: undefined };
                require(3982) /* _createForOfIteratorHelperLoose */.navigateToChannel(obj10);
                const obj18 = require(3982) /* _createForOfIteratorHelperLoose */;
              }
              tmp31 = null != channelId && true !== navigationReplace;
            } else {
              let obj13 = require(3982) /* _createForOfIteratorHelperLoose */;
      ...
      if (pathname.startsWith("/member-verification/")) {
        obj9 = require(3953) /* matchPath */;
        obj12 = {};
        const RouteParam5 = require(3966) /* isPseudoGuildId */.RouteParam;
        ...
        if (null != matchPathResult1) {
          obj11 = require(3982) /* _createForOfIteratorHelperLoose */;
        ...
        obj8 = require(3982) /* _createForOfIteratorHelperLoose */;
