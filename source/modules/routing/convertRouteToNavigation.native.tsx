...
// Dependencies: [676, 4301, 4298, 4299, 4271, 4284, 2]
// Exports: convertRouteToNavigation

// Module 11129 (convertRouteToNavigation)
    ...
    if (rootNavigationRef.isReady()) {
      if (pathname.startsWith("/channels/")) {
        ...
        if (null != tmpResult.matchPath(pathname, obj)) {
          ...
          tmpResult = tmp(4271);
          obj = { path: null };
          const RouteParam6 = tmp(4284).RouteParam;
          const RouteParam7 = tmp(4284).RouteParam;
            ...
            if (tmpResult1.getChatLayout().isChatLockedOpen) {
              if (null != channelId) {
                if (false === navigationReplace) {
                  ...
                  const rootNavigationRef1 = tmp(4299).getRootNavigationRef();
                  let currentRoute;
                  ...
                  if (channelId === channelId) {
                    ...
                    tmp(4298).navigateToRootTab(obj1);
                    const tmpResult4 = tmp(4298);
                  } else {
                    ...
                    tmp(4298).navigateToChannel(obj2);
                    const tmpResult5 = tmp(4298);
                  }
                  const tmpResult3 = tmp(4299);
                }
              }
              ...
              tmp(4298).navigateToRootTab(obj3);
              ...
              if (true === navigationReplace) {
                if (openChannel) {
                  ...
                  tmp(4298).navigateToChannel(obj4);
              ...
              if (false !== navigationReplace) {
                ...
                tmp(4298).navigateToRootTab(obj5);
                const tmpResult8 = tmp(4298);
              }
              if (tmp15) {
                ...
                obj6[1] = guildId;
                obj6[2] = messageId;
                tmp(4298).navigateToChannel(obj6);
              ...
              tmp(4298).navigateToRootTab(obj7);
      ...
      if (pathname.startsWith("/member-verification/")) {
        ...
        const RouteParam5 = tmp(4284).RouteParam;
        obj8[0] = Routes.GUILD_MEMBER_VERIFICATION(RouteParam5.guildId());
        const matchPathResult1 = tmp(4271).matchPath(pathname, obj8);
        if (null != matchPathResult1) {
          const result = tmp(4298).navigateToMemberVerification(matchPathResult1.params.guildId, matchPathResult1.params.inviteCode);
          const tmpResult12 = tmp(4298);
        }
        return true;
      } else {
        ...
        tmp(4298).resetToAuthRoute();
        flag = true;
        const tmpResult13 = tmp(4298);
      }
    }
  }
  return true;
