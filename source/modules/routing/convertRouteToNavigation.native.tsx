...
// Dependencies: [673, 4338, 4335, 4336, 4307, 4320, 2]
// Exports: convertRouteToNavigation

// Module 12723 (convertRouteToNavigation)
  ...
  if (null != rootNavigationRef) {
    if (rootNavigationRef.isReady()) {
      if (pathname.startsWith("/channels/")) {
        ...
        const RouteParam4 = tmp(4320).RouteParam;
        ...
        if (null != tmpResult.matchPath(pathname, obj)) {
          ...
          tmpResult = tmp(4307);
          obj = { path: null };
          const RouteParam6 = tmp(4320).RouteParam;
          const RouteParam7 = tmp(4320).RouteParam;
            ...
            if (tmpResult1.getChatLayout().isChatLockedOpen) {
              if (null != channelId) {
                if (false === navigationReplace) {
                  ...
                  const rootNavigationRef1 = tmp(4336).getRootNavigationRef();
                  let currentRoute;
                  ...
                  if (channelId === channelId) {
                    ...
                    tmp(4335).navigateToRootTab(obj1);
                    const tmpResult4 = tmp(4335);
                  } else {
                    ...
                    tmp(4335).navigateToChannel(obj2);
                    const tmpResult5 = tmp(4335);
                  }
                  const tmpResult3 = tmp(4336);
                }
              }
              ...
              tmp(4335).navigateToRootTab(obj3);
              const tmpResult6 = tmp(4335);
              ...
              if (true === navigationReplace) {
                if (openChannel) {
                  ...
                  tmp(4335).navigateToChannel(obj4);
                  const tmpResult7 = tmp(4335);
                }
              }
              if (false !== navigationReplace) {
                ...
                tmp(4335).navigateToRootTab(obj5);
                const tmpResult8 = tmp(4335);
              }
              if (tmp15) {
                ...
                obj6[1] = guildId;
                obj6[2] = messageId;
                tmp(4335).navigateToChannel(obj6);
                const tmpResult9 = tmp(4335);
              }
              ...
              tmp(4335).navigateToRootTab(obj7);
              const tmpResult10 = tmp(4335);
            }
            return true;
          }
      ...
      if (pathname.startsWith("/member-verification/")) {
        ...
        const RouteParam5 = tmp(4320).RouteParam;
        obj8[0] = Routes.GUILD_MEMBER_VERIFICATION(RouteParam5.guildId());
        const matchPathResult1 = tmp(4307).matchPath(pathname, obj8);
        if (null != matchPathResult1) {
          const result = tmp(4335).navigateToMemberVerification(matchPathResult1.params.guildId, matchPathResult1.params.inviteCode);
          const tmpResult12 = tmp(4335);
        }
        return true;
      } else {
        ...
        tmp(4335).resetToAuthRoute();
        flag = true;
        const tmpResult13 = tmp(4335);
      }
    }
  }
  return true;
