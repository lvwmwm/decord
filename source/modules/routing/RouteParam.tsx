...
// Function ID: 4138
// Name: RouteParam
// Dependencies: [677, 1379, 507, 4138, 2]

// Module 4137 (RouteParam)
...
export const RouteParam = {
  guildId() {
    ...
    const mapped = PSEUDO_GUILD_IDS.map(importDefault(4138));
    ...
    const unescapedPathParam = new require(507) /* getAuthenticationPath */.UnescapedPathParam(":" + importDefault(4138)(str) + "(" + combined + ")" + str2);
  ...
  channelId() {
    ...
    const mapped = items.map(importDefault(4138));
    const combined = "" + mapped.join("|") + "|\\d+";
    let flag2 = { optional: flag }.optional;
    if (flag2 === undefined) {
      flag2 = false;
