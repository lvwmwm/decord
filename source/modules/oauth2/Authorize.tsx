...
// Function ID: 10584
// Name: filterScopes
// Dependencies: [1391, 4202, 676, 10584, 9049, 5279, 4030, 506, 2]
// Exports: filterScopes, parseOAuth2AuthorizeProps

// Module 10583 (filterScopes)
...
export const filterScopes = function filterScopes(items) {
  ...
  if (hasItem) {
    hasItem = !found.includes(tmp(9049).OAuth2Scopes.APPLICATIONS_COMMANDS);
  }
  if (hasItem) {
    found.push(tmp(9049).OAuth2Scopes.APPLICATIONS_COMMANDS);
  }
  return found;
};
