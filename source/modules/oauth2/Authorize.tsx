...
// Function ID: 10397
// Name: filterScopes
// Dependencies: [1372, 4072, 676, 10397, 8796, 5125, 3888, 506, 2]
// Exports: filterScopes, parseOAuth2AuthorizeProps

// Module 10396 (filterScopes)
...
export const filterScopes = function filterScopes(items) {
  ...
  let hasItem = found.includes(require(8796) /* set */.OAuth2Scopes.BOT);
  if (hasItem) {
    hasItem = !found.includes(tmp(8796).OAuth2Scopes.APPLICATIONS_COMMANDS);
  }
  if (hasItem) {
    found.push(tmp(8796).OAuth2Scopes.APPLICATIONS_COMMANDS);
  }
  return found;
};
