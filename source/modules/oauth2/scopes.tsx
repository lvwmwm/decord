...
export const getScopeNames = function getScopeNames(value, closure_0) {
  if (require(8150) /* set */.OAuth2Scopes.IDENTIFY === value) {
    ...
    if (!closure_0.includes(require(8150) /* set */.OAuth2Scopes.APPLICATION_IDENTITIES_WRITE)) {
      const intl11 = require(1212) /* getSystemLocale */.intl;
      items45.push(intl11.string(require(1212) /* getSystemLocale */.t["1zioRF"]));
    }
    return items45;
  } else if (require(8150) /* set */.OAuth2Scopes.SDK_SOCIAL_LAYER === value) {
    const intl = require(1212) /* getSystemLocale */.intl;
...
export const isSocialLayerUmbrellaScope = function isSocialLayerUmbrellaScope(arg0) {
  let tmp = arg0 === require(8150) /* set */.OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE;
  if (!tmp) {
    tmp = arg0 === require(8150) /* set */.OAuth2Scopes.SDK_SOCIAL_LAYER;
  }
  return tmp;
};
export const getSecurityMessage = function getSecurityMessage(scopes) {
  if (!scopes.includes(require(8150) /* set */.OAuth2Scopes.DM_CHANNELS_MESSAGES_WRITE)) {
    if (!scopes.includes(require(8150) /* set */.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
      if (!scopes.includes(require(8150) /* set */.OAuth2Scopes.MESSAGES_READ)) {
        if (!scopes.includes(require(8150) /* set */.OAuth2Scopes.DM_CHANNELS_MESSAGES_READ)) {
          const intl = require(1212) /* getSystemLocale */.intl;
