...
// Dependencies: [19, 17, 676, 21, 4285, 712, 10433, 8825, 1236, 3986, 10444, 8685, 5932, 4281, 10446, 2]
// Exports: default

// Module 10443 (ApplicationEducationEntry)
import "noop";
...
export default function ApplicationEducation(arg0) {
  ...
  const items = [];
  const tmp3 = importDefault(10433)(application);
  if (accountScopes.includes(require(8825) /* set */.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
