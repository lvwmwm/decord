...
// Dependencies: [19, 17, 676, 21, 4189, 712, 8951, 8171, 1236, 3891, 9005, 8931, 9007, 4185, 9009, 2]
// Exports: default

// Module 9004 (ApplicationEducationEntry)
import "noop";
...
export default function ApplicationEducation(arg0) {
  ...
  const items = [];
  const tmp3 = importDefault(8951)(application);
  if (accountScopes.includes(require(8171) /* set */.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    obj3[0] = tmp4(9005).ChatSmileIcon;
    ...
    obj4[0] = tmp4(8931).GameControllerIcon;
    ...
    if (accountScopes.includes(tmp4(8171).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      obj9[0] = tmp4(8931).GameControllerIcon;
      ...
      obj10[0] = tmp4(9007).SettingsIcon;
    ...
    if (0 !== items.length) {
      ...
      obj11[1] = items1;
      const items2 = [closure_6(View, obj11), callback(tmp4(9009).AuthorizeFormSeparator, {})];
      obj13[0] = items2;
