...
// Dependencies: [19, 17, 676, 21, 4661, 712, 9771, 4375, 1236, 4095, 9817, 9430, 7355, 4734, 9819, 2]
// Exports: default
...
export default function ApplicationEducation(arg0) {
  ...
  const items = [];
  const tmp3 = importDefault(9771)(application);
  if (accountScopes.includes(require(4375) /* set */.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
