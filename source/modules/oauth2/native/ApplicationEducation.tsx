...
// Dependencies: [19, 17, 673, 21, 4481, 709, 9172, 8269, 1233, 4195, 9350, 9152, 7318, 4477, 9352, 2]
// Exports: default

// Module 9349 (ApplicationEducationEntry)
import noopAll from "noop" /* 19 */;
import ThemesDefault from "Themes" /* 709 */;
import Text from "Text" /* 4477 */;
import set from "set" /* 8269 */;
import useIsSocialLayerParentApplicationDefault from "useIsSocialLayerParentApplication" /* 9172 */;
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(set.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    obj3[0] = tmp4(9350).ChatSmileIcon;
    ...
    obj4[0] = tmp4(9152).GameControllerIcon;
    ...
    if (accountScopes.includes(tmp4(8269).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      obj9[0] = tmp4(9152).GameControllerIcon;
      ...
      obj10[0] = tmp4(7318).SettingsIcon;
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          obj12[2] = arr2;
          tmp27 = callback(tmp4(4477).Text, obj12);
        }
      }
      ...
      obj11[1] = items1;
      const items2 = [closure_6(View, obj11), callback(tmp4(9352).AuthorizeFormSeparator, {})];
      obj13[0] = items2;
