...
// Dependencies: [19, 17, 676, 21, 4255, 712, 10402, 8796, 1236, 3957, 10413, 8656, 5905, 4251, 10415, 2]
// Exports: default

// Module 10412 (ApplicationEducationEntry)
import "noop";
...
export default function ApplicationEducation(arg0) {
  ...
  const items = [];
  const tmp3 = importDefault(10402)(application);
  if (accountScopes.includes(require(8796) /* set */.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
