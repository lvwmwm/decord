...
// Dependencies: [19, 17, 676, 21, 4342, 712, 10494, 8965, 1236, 4063, 10505, 8825, 6075, 4338, 10507, 2]
// Exports: default

// Module 10504 (ApplicationEducationEntry)
import "noop";
...
export default function ApplicationEducation(arg0) {
  ...
  const items = [];
  const tmp3 = importDefault(10494)(application);
  if (accountScopes.includes(require(8965) /* set */.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
