...
// Function ID: 10419
// Name: styles
// Dependencies: [5, 32, 19, 17, 1376, 3892, 1874, 21, 4255, 712, 4223, 8862, 1959, 1236, 4445, 10403, 4251, 1297, 7749, 2]
// Exports: default
  ...
  callback = React.useCallback(() => {
    ...
    if (tmp2) {
      ...
      obj[1] = channels.map((id) => {
        ...
        obj[0] = callback(4445).computeChannelName(callback2(id), mergeGuildAvatar, closure_8);
        obj[1] = id.id;
        return obj;
      });
