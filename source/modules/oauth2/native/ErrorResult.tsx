...
// Function ID: 10439
// Name: error
// Dependencies: [19, 17, 21, 4285, 712, 5311, 10439, 4281, 1236, 4695, 4490, 2]
// Exports: default
...
export default function ErrorResult(error) {
  ...
  items1[1] = tmp6Result;
  obj[2] = items1;
  return closure_6(require(5311) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
};
