...
// Function ID: 10417
// Name: Scope
// Dependencies: [19, 17, 21, 4255, 1236, 5890, 712, 4216, 4251, 5583, 10397, 9430, 8796, 2]
// Exports: default
...
function Scope(arg0) {
  ...
  if (isFake) {
    ...
    let tmp10Result = tmp10(tmp6(5890).CircleXIcon, obj);
  } else {
...
export default function AuthorizeScopes(accountScopes) {
  ...
  if (0 === accountScopes.length) {
    ...
    let hasItem = integrationType === tmp4(9430).ApplicationIntegrationType.USER_INSTALL;
    if (hasItem) {
      hasItem = requestedScopes.includes(tmp4(8796).OAuth2Scopes.APPLICATIONS_COMMANDS);
    }
