...
// Dependencies: [19, 17, 21, 4285, 712, 10427, 10450, 10452, 11, 10425, 4229, 1236, 4804, 10429, 10454, 4249, 8824, 10456, 10148, 4281, 2]
// Exports: default

// Module 10449 (ApplicationDetailsEntry)
import "Text";
...
export default function ApplicationDetails(arg0) {
  ...
  const tmp14 = View;
  obj2[1] = require(10429) /* getApplicationDetailsText */.getApplicationDetailsText(application);
  items[1] = callback(ApplicationDetailsEntry, obj2);
  let tmp18Result = null;
  if (null != connectedAccount) {
    const obj3 = { iconComponent: null, text: null };
    obj3[0] = tmp5(10454).HammerIcon;
  ...
  tmp18Result = null;
  if (scopes.includes(require(8824) /* set */.OAuth2Scopes.BOT)) {
    tmp18Result = null;
    if (null != approximateGuildCount) {
      const obj5 = { iconComponent: null, text: null };
      obj5[0] = tmp5(10456).RobotIcon;
  ...
  items[4] = tmp18Result;
  const tmp5Result = require(10429) /* getApplicationDetailsText */;
  items[5] = callback(ApplicationDetailsEntry, { iconComponent: require(10148) /* ShieldIcon */.ShieldIcon, text: securityMessage });
  let mapped = null;
  if (null != disclosures) {
    mapped = disclosures.map((toFixed) => {
      let obj = callback(10427);
      const textForDisclosure = obj.getTextForDisclosure(toFixed);
      if (callback(10427).ApplicationDisclosure.IP_LOCATION === toFixed) {
        obj = { iconComponent: null };
        obj[0] = tmp(10450).GlobeEarthIcon;
        let tmp4 = obj;
      } else {
        tmp4 = null;
        if (tmp(10427).ApplicationDisclosure.DISPLAYS_ADVERTISEMENTS === toFixed) {
          obj = { iconComponent: null };
          obj[0] = tmp(10452).EmbedIcon;
          tmp4 = obj;
        }
      }
      let tmp5 = null;
