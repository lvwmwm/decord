...
// Function ID: 70845
// Name: Header
// Dependencies: [31, 27, 653, 33, 4165, 689, 1392, 1273, 4161, 8366, 1360, 1212, 2]
// Exports: default
...
export default function Header(accountScopes) {
  ...
  if (null != bot) {
    ...
    tmp9Result = callback(importDefault(8366), obj10);
    const tmp12 = importDefault(8366);
    const tmp9 = callback;
  }
  items3[1] = tmp9Result;
  ...
  items2[2] = callback(require(4161) /* Text */.Text, obj11);
  obj.children = items2;
