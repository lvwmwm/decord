...
// Dependencies: [19, 17, 21, 4302, 712, 10441, 1609, 4162, 4711, 4844, 1236, 10559, 5325, 4298, 5327, 10561, 2]
// Exports: default

// Module 10558 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  ...
  const tmp4 = sharedValue(10441)(arg0);
  const require = tmp4;
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(10559).ArrowSmallLeftIcon, obj3);
  } else {
    const obj4 = { color: null };
    obj4[0] = tmp2(712).colors.INTERACTIVE_TEXT_DEFAULT;
    tmp11Result = tmp11(tmp5(5325).XSmallIcon, obj4);
  }
  obj2[3] = tmp11Result;
  const items2 = [closure_5(require(4844) /* PressableBase */.PressableOpacity, obj2), , ];
  ...
  obj5[1] = closure_5(require(4298) /* Text */.Text, obj6);
  items2[1] = closure_5(View, obj5);
  const items3 = [tmp.titleContainerBorder, animatedStyle];
  items2[2] = closure_5(sharedValue(4162).View, { style: items3 });
  obj[1] = items2;
  ...
  obj7[2] = closure_5(sharedValue(10561), obj8);
  items4[1] = closure_5(require(5327) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj7);
  obj[1] = items4;
