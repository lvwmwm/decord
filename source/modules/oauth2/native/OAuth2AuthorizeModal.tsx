...
// Dependencies: [19, 17, 21, 4446, 712, 9224, 1629, 4186, 4892, 5033, 1236, 9317, 5516, 4442, 5518, 9319, 2]
// Exports: default

// Module 9223 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  const tmp = callback();
  const tmp4 = sharedValue(9224)(arg0);
  const _require = tmp4;
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(9317).ArrowSmallLeftIcon, obj3);
  } else {
    const obj4 = { color: null };
    obj4[0] = tmp2(712).colors.INTERACTIVE_TEXT_DEFAULT;
    tmp11Result = tmp11(tmp5(5516).XSmallIcon, obj4);
  }
  obj2[3] = tmp11Result;
  const items2 = [closure_5(_require(5033).PressableOpacity, obj2), , ];
  ...
  obj5[1] = closure_5(_require(4442).Text, obj6);
  items2[1] = closure_5(View, obj5);
  const items3 = [tmp.titleContainerBorder, animatedStyle];
  items2[2] = closure_5(sharedValue(4186).View, { style: items3 });
  obj[1] = items2;
  ...
  obj7[2] = closure_5(sharedValue(9319), obj8);
  items4[1] = closure_5(_require(5518).SafeAreaPaddingView, obj7);
  obj[1] = items4;
