...
// Module 9980 (OAuth2AuthorizeModal)
...
obj.titleContainer = { variant: null, color: 11, accessibilityRole: "modal_top_pill" };
const tmp2 = arg1(dependencyMap[2]);
obj.titleContainerBorder = { backgroundColor: importDefault(dependencyMap[4]).colors.BORDER_SUBTLE };
const obj2 = { onValueChange: true, value: true, start: true, end: true, label: true, backgroundColor: importDefault(dependencyMap[4]).colors.BACKGROUND_BASE_LOWER };
obj.title = obj2;
...
export default function OAuth2AuthorizeModal(arg0) {
  ...
  const obj6 = { "Bool(true)": "isArray", "Bool(true)": "accessibilityRole" };
