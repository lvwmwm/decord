...
// Dependencies: [19, 17, 21, 4342, 712, 10486, 1628, 4083, 4776, 4909, 1236, 10616, 5387, 4338, 5389, 10618, 2]
// Exports: default

// Module 10615 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  ...
  const tmp4 = sharedValue(10486)(arg0);
  const require = tmp4;
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(10616).ArrowSmallLeftIcon, obj3);
  } else {
    const obj4 = { color: null };
    obj4[0] = tmp2(712).colors.INTERACTIVE_TEXT_DEFAULT;
    tmp11Result = tmp11(tmp5(5387).XSmallIcon, obj4);
  }
  obj2[3] = tmp11Result;
  const items2 = [closure_5(require(4909) /* PressableBase */.PressableOpacity, obj2), , ];
  ...
  obj5[1] = closure_5(require(4338) /* Text */.Text, obj6);
  items2[1] = closure_5(View, obj5);
  const items3 = [tmp.titleContainerBorder, animatedStyle];
  items2[2] = closure_5(sharedValue(4083).View, { style: items3 });
  obj[1] = items2;
  ...
  obj7[2] = closure_5(sharedValue(10618), obj8);
  items4[1] = closure_5(require(5389) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj7);
  obj[1] = items4;
