...
// Dependencies: [19, 17, 21, 4380, 712, 10581, 1629, 4120, 4814, 4949, 1236, 10711, 5432, 4376, 5434, 10713, 2]
// Exports: default

// Module 10710 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  ...
  obj2[3] = tmp11Result;
  const items2 = [closure_5(_require(4949).PressableOpacity, obj2), , ];
  ...
  obj5[1] = closure_5(_require(4376).Text, obj6);
  ...
  items4[1] = closure_5(_require(5434).SafeAreaPaddingView, obj7);
  obj[1] = items4;
