...
// Dependencies: [19, 17, 4322, 1218, 1874, 21, 4285, 712, 4221, 589, 4966, 1416, 4131, 5611, 1297, 8414, 4281, 1236, 4695, 10406, 4241, 4237, 2]
// Exports: ConnectedAccountCard, default

// Module 10437 (ConnectAccountStep)
...
export default function ConnectAccountStep(clientId) {
  ...
  if (null == value) {
    ...
    items4[1] = callback(tmp5(8414).MoreHorizontalIcon, obj4);
...
export const ConnectedAccountCard = function ConnectedAccountCard(arg0) {
  ...
  if (null == value) {
    ...
    items1[2] = callback(require(4237) /* CheckmarkLargeIcon */.CheckmarkLargeIcon, obj8);
    obj2[1] = items1;
    ...
    items[2] = callback(require(4281) /* Text */.Text, obj9);
    ...
    obj2 = require(4131) /* AccessibilityAnnouncer */;
    const icon = value.icon;
