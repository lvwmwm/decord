...
// Dependencies: [19, 17, 4292, 1218, 1874, 21, 4255, 712, 4191, 589, 4937, 1416, 4101, 5582, 1297, 9149, 4251, 1236, 4666, 9151, 4211, 4207, 2]
// Exports: ConnectedAccountCard, default

// Module 9148 (ConnectAccountStep)
...
export default function ConnectAccountStep(clientId) {
  ...
  if (null == value) {
    ...
    items4[1] = callback(tmp5(9149).MoreHorizontalIcon, obj4);
    ...
    items7[2] = callback(tmp5(4666).Button, obj13);
    obj10[1] = items7;
