...
export default function ConnectAccountStep(clientId) {
  ...
  if (null == value) {
    ...
    items6[1] = callback(tmp5(4299).Text, obj8);
    ...
    items7[1] = callback(tmp5(4299).Text, obj12);
    ...
    items7[2] = callback(tmp5(4714).Button, obj13);
    obj10[1] = items7;
    ...
    const items8 = [callback(tmp5(4259).CircleInformationIcon, obj15), ];
    ...
    items8[1] = callback(tmp5(4299).Text, obj16);
    obj14[1] = items8;
...
export const ConnectedAccountCard = function ConnectedAccountCard(arg0) {
  ...
  if (null == value) {
    ...
    const items2 = [callback(require(4299) /* Text */.Text, obj5), ];
    ...
    items2[1] = callback(require(4299) /* Text */.Text, obj6);
    obj4[1] = items2;
    items1[1] = closure_9(View, obj4);
    const obj8 = { color: null, size: "sm" };
    obj8[0] = importDefault(712).colors.TEXT_FEEDBACK_POSITIVE;
    items1[2] = callback(require(4255) /* CheckmarkLargeIcon */.CheckmarkLargeIcon, obj8);
    obj2[1] = items1;
    ...
    items[2] = callback(require(4299) /* Text */.Text, obj9);
