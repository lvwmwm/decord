...
// Dependencies: [19, 17, 4478, 1218, 1922, 21, 4661, 712, 4310, 589, 5097, 1435, 1363, 7140, 1297, 9415, 4734, 1236, 4745, 9779, 4330, 4326, 2]
...
export default function ConnectAccountStep(clientId) {
  ...
  if (null == value) {
    ...
    items4[1] = callback(tmp5(9415).MoreHorizontalIcon, obj4);
    ...
    items6[1] = callback(tmp5(4734).Text, obj8);
    ...
    items7[2] = callback(tmp5(4745).Button, obj13);
    obj10[1] = items7;
    ...
    const items8 = [callback(tmp5(4330).CircleInformationIcon, obj15), ];
    ...
    items8[1] = callback(tmp5(4734).Text, obj16);
    obj14[1] = items8;
...
export const ConnectedAccountCard = function ConnectedAccountCard(arg0) {
  ...
  if (null == value) {
    ...
    items1[2] = callback(require(4326) /* CheckmarkLargeIcon */.CheckmarkLargeIcon, obj8);
    obj2[1] = items1;
    ...
    items[2] = callback(require(4734) /* Text */.Text, obj9);
