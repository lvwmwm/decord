...
// Dependencies: [19, 17, 4487, 1218, 1923, 21, 4446, 712, 4381, 589, 5192, 1435, 1363, 5919, 1297, 8739, 4442, 1236, 4893, 9238, 4401, 4397, 2]
// Exports: ConnectedAccountCard, default

// Module 9237 (ConnectAccountStep)
...
export default function ConnectAccountStep(clientId) {
  ...
  if (null == value) {
    ...
    items4[1] = callback(tmp5(8739).MoreHorizontalIcon, obj4);
    ...
    items6[1] = callback(tmp5(4442).Text, obj8);
    ...
    items7[1] = callback(tmp5(4442).Text, obj12);
    ...
    items7[2] = callback(tmp5(4893).Button, obj13);
    obj10[1] = items7;
    ...
    const items8 = [callback(tmp5(4401).CircleInformationIcon, obj15), ];
    ...
    items8[1] = callback(tmp5(4442).Text, obj16);
    obj14[1] = items8;
