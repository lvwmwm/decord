...
// Dependencies: [4128, 12, 2]
// Exports: replaceAnimationColors

// Module 7202 (replaceAnimationColors)
...
export const replaceAnimationColors = function replaceAnimationColors(c5, arg1) {
  ...
  const complimentaryPaletteForColor = require(4128) /* hexToRgba */.getComplimentaryPaletteForColor(items, 2);
  const obj = require(4128) /* hexToRgba */;
