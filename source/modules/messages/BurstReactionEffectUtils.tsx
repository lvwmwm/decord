...
// Dependencies: [4191, 12, 2]
// Exports: replaceAnimationColors

// Module 7348 (replaceAnimationColors)
...
export const replaceAnimationColors = function replaceAnimationColors(c5, arg1) {
  ...
  const complimentaryPaletteForColor = require(4191) /* hexToRgba */.getComplimentaryPaletteForColor(items, 2);
  const obj = require(4191) /* hexToRgba */;
