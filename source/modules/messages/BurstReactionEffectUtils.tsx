...
// Dependencies: [4145, 12, 2]
// Exports: replaceAnimationColors

// Module 7221 (replaceAnimationColors)
...
export const replaceAnimationColors = function replaceAnimationColors(c5, arg1) {
  ...
  const complimentaryPaletteForColor = require(4145) /* hexToRgba */.getComplimentaryPaletteForColor(items, 2);
  const obj = require(4145) /* hexToRgba */;
