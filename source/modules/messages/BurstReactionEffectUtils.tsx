...
export const replaceAnimationColors = function replaceAnimationColors(c5, arg1) {
  ...
  const complimentaryPaletteForColor = require(4037) /* hexToRgba */.getComplimentaryPaletteForColor(items, 2);
  const obj = require(4037) /* hexToRgba */;
