...
// Dependencies: [1372, 3883, 3892, 676, 4593, 1236, 6860, 2]
// Exports: default

// Module 12440 (validateJumpWithAlert)
...
export default function validateJumpWithAlert(author) {
  ...
  if (blockedForMessage.isBlockedForMessage(author)) {
    ...
    importDefault(4593).show(obj1);
    return false;
  } else {
    obj1 = require(6860) /* isSpamSupported */;
