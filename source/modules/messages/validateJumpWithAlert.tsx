...
// Dependencies: [1391, 3989, 3998, 676, 4682, 1236, 7008, 2]
// Exports: default
...
export default function validateJumpWithAlert(author) {
  ...
  if (blockedForMessage.isBlockedForMessage(author)) {
    ...
    importDefault(4682).show(obj1);
    return false;
  } else {
    obj1 = require(7008) /* isSpamSupported */;
