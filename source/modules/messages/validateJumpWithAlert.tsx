...
// Dependencies: [1372, 3929, 3938, 676, 4640, 1236, 6906, 2]
// Exports: default

// Module 12492 (validateJumpWithAlert)
...
export default function validateJumpWithAlert(author) {
  ...
  if (blockedForMessage.isBlockedForMessage(author)) {
    ...
    importDefault(4640).show(obj1);
    return false;
  } else {
    obj1 = require(6906) /* isSpamSupported */;
