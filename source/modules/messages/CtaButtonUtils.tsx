...
// Function ID: 11384
// Name: CtaButtonType
// Dependencies: [4583, 11384, 4582, 589, 2]
// Exports: getCtaButtonType, useCtaButtonType

// Module 11383 (CtaButtonType)
...
export const getCtaButtonType = function getCtaButtonType(id, channel_id) {
  const obj = require(11384) /* shouldRenderReportFalsePositiveButton */;
...
export const useCtaButtonType = function useCtaButtonType(id, channel_id) {
  ...
  const result = require(4582) /* useAgeVerificationRunner */.isAgeVerificationMessageWithRetryCta(channel_id, id);
