...
// Function ID: 11201
// Name: CtaButtonType
// Dependencies: [4471, 11201, 4470, 589, 2]
// Exports: getCtaButtonType, useCtaButtonType

// Module 11200 (CtaButtonType)
...
export const getCtaButtonType = function getCtaButtonType(id, channel_id) {
  const obj = require(11201) /* shouldRenderReportFalsePositiveButton */;
...
export const useCtaButtonType = function useCtaButtonType(id, channel_id) {
  ...
  const result = require(4470) /* useAgeVerificationRunner */.isAgeVerificationMessageWithRetryCta(channel_id, id);
  ...
  if (result1) {
    result1 = tmp(4470).isAgeVerificationMessageWithConnectToTeenCta(channel_id, id);
