...
// Function ID: 11233
// Name: CtaButtonType
// Dependencies: [4472, 11233, 4471, 589, 2]
// Exports: getCtaButtonType, useCtaButtonType

// Module 11232 (CtaButtonType)
...
export const getCtaButtonType = function getCtaButtonType(id, channel_id) {
  const obj = require(11233) /* shouldRenderReportFalsePositiveButton */;
...
export const useCtaButtonType = function useCtaButtonType(id, channel_id) {
  ...
  const result = require(4471) /* useAgeVerificationRunner */.isAgeVerificationMessageWithRetryCta(channel_id, id);
  ...
  if (result1) {
    result1 = tmp(4471).isAgeVerificationMessageWithConnectToTeenCta(channel_id, id);
