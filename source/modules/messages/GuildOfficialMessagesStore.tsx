...
// Dependencies: [1386, 1991, 1908, 4130, 1921, 673, 4738, 1398, 586, 706, 2]

// Module 13611 (updateGuildState)
          ...
          if (obj6.hasFlag(num, MessageFlags.IS_GUILD_OFFICIAL)) {
            ...
            if (tmp5) {
              if (null == tmp4.messages[message.id]) {
                const messageRecord = tmp23(4738).createMessageRecord(message);
                if (null != obj[guildId]) {
                  obj = {};
                  const merged = Object.assign(obj);
                  obj = {};
