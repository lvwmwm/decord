...
// Dependencies: [1386, 1991, 1908, 4130, 1921, 673, 4745, 1399, 586, 706, 2]

// Module 13644 (updateGuildState)
          ...
          if (obj6.hasFlag(num, MessageFlags.IS_GUILD_OFFICIAL)) {
            ...
            if (tmp5) {
              if (null == tmp4.messages[message.id]) {
                const messageRecord = tmp23(4745).createMessageRecord(message);
                if (null != obj[guildId]) {
                  obj = {};
                  const merged = Object.assign(obj);
                  obj = {};
