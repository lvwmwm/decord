...
// Dependencies: [5, 32, 19, 8660, 1990, 3989, 4357, 4391, 8087, 676, 21, 9, 10978, 8659, 10960, 8657, 8086, 10981, 10413, 12, 11, 10985, 10422, 10961, 10987, 10988, 6965, 10989, 11407, 4274, 1208, 10983, 10959, 643, 4331, 7240, 11413, 11343, 10993, 500, 1626, 5205, 11414, 2]

// Module 10977 (handleTapShowAltText)
...
function handleTapShowAltText(description) {
  importDefault(10978)({ description: description.nativeEvent.description });
}
...
const forwardRefResult = importAllResult.forwardRef((messages, ref) => {
  ...
  const items4 = [
    ...
    findMessageIndex(_require(11414).ChatTTITracker, { messages: messages.messages })
  ];
  obj3[0] = items4;
