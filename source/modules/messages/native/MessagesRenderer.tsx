...
// Dependencies: [5, 32, 19, 8660, 1990, 3989, 4357, 4391, 8087, 676, 21, 9, 10979, 8659, 10961, 8657, 8086, 10982, 10413, 12, 11, 10986, 10422, 10962, 10988, 10989, 6965, 10990, 11408, 4274, 1208, 10984, 10960, 643, 4331, 7240, 11414, 11344, 10994, 500, 1626, 5205, 11415, 2]

// Module 10978 (handleTapShowAltText)
...
function handleTapShowAltText(description) {
  importDefault(10979)({ description: description.nativeEvent.description });
}
function handleMediaPlayFinishedAnalytics(nativeEvent) {
  const result = require(8659) /* getVisibleMessages */.handleMediaPlayFinishedAnalytics(nativeEvent.nativeEvent);
}
...
const forwardRefResult = importAllResult.forwardRef((messages, ref) => {
  ...
  const items4 = [
    ...
    findMessageIndex(_require(11415).ChatTTITracker, { messages: messages.messages })
  ];
  obj3[0] = items4;
