...
// Dependencies: [5, 32, 19, 8551, 1971, 3929, 4314, 4347, 7982, 676, 21, 9, 10938, 8550, 10182, 8548, 7981, 10941, 10386, 12, 11, 10945, 10395, 10921, 10947, 10948, 6857, 10949, 11290, 4234, 1208, 10943, 10920, 643, 4291, 7135, 11296, 11226, 10953, 500, 1607, 5163, 11297, 2]

// Module 10937 (handleTapShowAltText)
...
function handleTapShowAltText(description) {
  importDefault(10938)({ description: description.nativeEvent.description });
}
function handleMediaPlayFinishedAnalytics(nativeEvent) {
  const result = require(8550) /* getVisibleMessages */.handleMediaPlayFinishedAnalytics(nativeEvent.nativeEvent);
}
...
const forwardRefResult = importAllResult.forwardRef((messages, ref) => {
  ...
  const items4 = [
    ...
    findMessageIndex(_require(11297).ChatTTITracker, { messages: messages.messages })
  ];
  obj3[0] = items4;
