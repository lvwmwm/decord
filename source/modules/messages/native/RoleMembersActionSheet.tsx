...
// Dependencies: [19, 17, 4372, 6004, 1985, 21, 4380, 712, 11, 5465, 589, 5463, 1297, 4376, 5503, 11148, 2]
// Exports: default

// Module 11147 (RoleMembersActionSheet)
...
export default function RoleMembersActionSheet(guildId) {
  ...
  const tmp11 = roleId(5463)(guildId);
  let tmp12 = null;
  if (roleId !== result) {
    let tmp13;
    if (tmp11 != null) {
  ...
  if (null != stateFromStores) {
    ...
    obj[1] = channelId;
    obj[2] = roleId;
    obj[2] = closure_8(tmp9(11148), obj);
    tmp16Result = tmp16(tmp3(5503).BottomSheet, obj);
    let tmp9Result = tmp9(11148);
  }
  return tmp16Result;
};
