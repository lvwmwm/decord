...
// Dependencies: [4341, 4997, 12617, 1911, 1218, 12618, 10435, 4521, 4390, 4996, 1903, 10434, 676, 8903, 5729, 12619, 1236, 11347, 12620, 11152, 11157, 8241, 12621, 11153, 12310, 11159, 11156, 12622, 10594, 8338, 11151, 8238, 11350, 12623, 12624, 11160, 11161, 12625, 12626, 12629, 2738, 2]
// Exports: createActivityRichPresenceInviteEmbed

// Module 12616 (EmbedDisplayType)
            ...
            if (null != application) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != message.application) {
                  ...
                  id2 = importDefault;
                  id2 = importDefault(11152)(id2, message, application.id);
                  id2 = intl(12621).getRequestToStreamText(message, channel, obj4.getId());
                  id2 = importDefault(12629)(message);
                ...
                id2 = importDefault;
                id2 = importDefault(11152)(findActivityResult, message, application.id);
                id2 = !id2;
