...
// Dependencies: [4383, 5038, 12683, 1930, 1218, 12684, 10396, 4562, 4431, 5037, 1922, 10395, 676, 8952, 5769, 12685, 1236, 11399, 12686, 11203, 11208, 8288, 12687, 11204, 12379, 11210, 11207, 12688, 10569, 8386, 11202, 8285, 11402, 12689, 12690, 11211, 11212, 12691, 12692, 12695, 2757, 2]
// Exports: createActivityRichPresenceInviteEmbed

// Module 12682 (EmbedDisplayType)
            ...
            if (null != application) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != message.application) {
                  ...
                  id2 = importDefault;
                  id2 = importDefault(11203)(id2, message, application.id);
                  id2 = intl(12687).getRequestToStreamText(message, channel, obj4.getId());
                  id2 = importDefault(12695)(message);
                ...
                id2 = importDefault;
                id2 = importDefault(11203)(findActivityResult, message, application.id);
                id2 = !id2;
