...
// Dependencies: [4341, 4997, 12619, 1911, 1218, 12620, 10436, 4521, 4390, 4996, 1903, 10435, 676, 8903, 5729, 12621, 1236, 11348, 12622, 11153, 11158, 8241, 12623, 11154, 12312, 11160, 11157, 12624, 10595, 8338, 11152, 8238, 11351, 12625, 12626, 11161, 11162, 12627, 12628, 12631, 2738, 2]
// Exports: createActivityRichPresenceInviteEmbed

// Module 12618 (EmbedDisplayType)
            ...
            if (null != application) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != message.application) {
                  ...
                  id2 = importDefault;
                  id2 = importDefault(11153)(id2, message, application.id);
                  id2 = intl(12623).getRequestToStreamText(message, channel, obj4.getId());
                  id2 = importDefault(12631)(message);
                ...
                id2 = importDefault;
                id2 = importDefault(11153)(findActivityResult, message, application.id);
                id2 = !id2;
