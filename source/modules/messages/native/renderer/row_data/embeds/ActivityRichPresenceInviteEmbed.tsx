...
// Dependencies: [4339, 4995, 12547, 1911, 1218, 12548, 10369, 4519, 4388, 4994, 1903, 10368, 676, 8843, 5669, 12549, 1236, 11281, 12550, 11086, 11091, 8181, 12551, 11087, 12243, 11093, 11090, 12552, 10528, 8278, 11085, 8178, 11284, 12553, 12554, 11094, 11095, 12555, 12556, 12559, 2738, 2]
// Exports: createActivityRichPresenceInviteEmbed

// Module 12546 (EmbedDisplayType)
            ...
            if (null != application) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != message.application) {
                  ...
                  id2 = importDefault;
                  id2 = importDefault(11086)(id2, message, application.id);
                  id2 = intl(12551).getRequestToStreamText(message, channel, obj4.getId());
                  id2 = importDefault(12559)(message);
                ...
                id2 = importDefault;
                id2 = importDefault(11086)(findActivityResult, message, application.id);
                id2 = !id2;
