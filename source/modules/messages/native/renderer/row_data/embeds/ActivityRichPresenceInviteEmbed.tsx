...
// Dependencies: [4226, 4868, 12366, 1882, 1218, 12367, 10468, 4407, 4276, 4867, 1874, 10467, 676, 8172, 5516, 12368, 1236, 11130, 12369, 10942, 10947, 7914, 12370, 10943, 12022, 10949, 10946, 12371, 10501, 8012, 10941, 7911, 11134, 12372, 12373, 10950, 10951, 12374, 12375, 12378, 2677, 2]
// Exports: createActivityRichPresenceInviteEmbed

// Module 12365 (EmbedDisplayType)
  ...
  if (null != message.author) {
    if (null != message.activity) {
      ...
      if (null != channel) {
        ...
        if (intl(11130).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          _require = channel;
          const application2 = message.application;
          let id;
          const applicationFromMessage = intl(12369).getApplicationFromMessage(message);
            ...
            if (null != application) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != application.icon) {
                  appIconSrc = intl(11134).getAppIconSrc(application.id, application.icon, application.bot);
                  const intlResult2 = intl(11134);
                }
                id2 = appIconSrc;
                let string2 = intl(11134).getAppGradientColors(id2);
                id2 = obj4.getId();
                if (null != message.application) {
                  ...
                  id2 = importDefault;
                  id2 = importDefault(10942)(id2, message, application.id);
                  id2 = intl(12370).getRequestToStreamText(message, channel, obj4.getId());
                  id2 = importDefault(12378)(message);
                  ...
                  obj[17] = application;
                  id2 = obj;
                  const intlResult4 = intl(12370);
                }
                const intlResult3 = intl(11134);
              } else {
                id2 = importDefault;
                id2 = importDefault(10942)(findActivityResult, message, application.id);
                id2 = !id2;
                const activity9 = message.activity;
                let name_override;
                id2 = intl(10947).getIsAskToJoin(message);
                if (activity9 != null) {
                ...
                if (null != icon_override) {
                  assetImage = intl(7914).getAssetImage(application.id, message.activity.icon_override);
                  const intlResult6 = intl(7914);
                }
                const intlResult5 = intl(10947);
                const activity5 = message.activity;
                let type3;
                if (activity5 != null) {
                  type3 = activity5.type;
                }
                const headerText = intl(12370).getHeaderText(name_override, type3, id2);
                if (null != findActivityResult) {
                  ...
                  let length = intl(10943).getPartySize(findActivityResult).maxPartySize;
                  const intlResult8 = intl(10943);
                  const currentActivityGamePlatform = intl(12022).getCurrentActivityGamePlatform();
                  const tmp40 = id2(10949)(updateActivities, filterPlayingActivities, application.id);
                  const intlResult9 = intl(12022);
                  const isInParty = intl(10946).getIsInParty(tmp40, findActivityResult);
                  const intlResult11 = intl(12371);
                  ...
                  const intlResult10 = intl(10946);
                  const intlResult12 = intl(10501);
                  const canLaunchFrameResult = intl(10501).canLaunchFrame(application);
                  const intlResult13 = intl(8012);
                  const isEmbeddedAppResult = intl(8012).isEmbeddedApp(application);
                  ...
                  obj[7] = hasItem;
                  const canJoin = intl(10941).getCanJoin(obj);
                  ...
                  if (null != start) {
                    ...
                    obj1[1] = end;
                    const _Date = Date;
                    str2 = intl(7911).formatActiveTimestamp(obj1, Date.now());
                    const intlResult15 = intl(7911);
                  }
                  if (assetImage == null) {
                    let appIconSrc1 = null;
                    if (null != application.icon) {
                      appIconSrc1 = intl(11134).getAppIconSrc(application.id, application.icon, application.bot);
                      const intlResult16 = intl(11134);
                    }
                  ...
                  if (tmp57Result) {
                    if (null != findActivityResult) {
                      if (null != findActivityResult.details) {
                        ...
                        if (id2) {
                          const tmp95 = id2(12372)(findActivityResult, application.id);
                    ...
                    obj4[2] = type4;
                    let details;
                    const partyText = intl(12370).getPartyText(obj4);
                    if (findActivityResult != null) {
                    ...
                    const intlResult17 = intl(12370);
                    tmp84 = null != details && "" !== details;
                    const supportsRemoteJoin = intl(10950).getSupportsRemoteJoin(findActivityResult);
                    intl(10951);
                    if (canJoin.canJoin) {
                      let remoteJoinFooterLabel;
                      if (null != remoteJoinPlatform) {
                        remoteJoinFooterLabel = intl(12368).getRemoteJoinFooterLabel(remoteJoinPlatform);
                        const intlResult20 = intl(12368);
                      }
                  ...
                  if (null != remoteJoinPlatform) {
                    items = [];
                    id2 = intl(12374).ACTIVITY_GAME_PLATFORM_TO_ICON_KEY[remoteJoinPlatform];
                    id2 = items;
                    if (null != id2) {
                      id2 = items.push(id2);
                      id2 = items;
                    ...
                    obj12[2] = hasItem;
                    id2 = intl(12374).getJoinFromSupportedPlatformsIconKeys(obj12);
                    const intlResult23 = intl(12374);
                  }
                  id2 = tmp72;
                  const intlResult14 = intl(10941);
                  const tmp57 = closure_18;
                  id2 = intl(11134).getAppGradientColors(id2);
                  const intlResult24 = intl(11134);
                  const obj13 = { messageId: null, presenceActivity: null, application: null };
                  obj13[0] = message.id;
                  obj13[1] = findActivityResult;
                  obj13[2] = application;
                  id2 = obj;
                  id2 = intl(12375).getPresenceActivityInviteCoverImageURL(obj13);
                  if (flag4) {
                  ...
                  obj14[17] = name;
                  tmp27 = obj14;
                  const intlResult25 = intl(12375);
                }
                items = [];
                const intlResult7 = intl(12370);
              }
            }
            return tmp27;
          }
          const intlResult = intl(12369);
        } else {
          if (intl(11130).ContentClassificationVisibility.BLOCK_UNDERAGE !== contentClassificationVisibility) {
            if (intl(11130).ContentClassificationVisibility.BLOCK_CHANNEL_RESTRICTION !== contentClassificationVisibility) {
              return null;
            }
          }
          const obj15 = { displayType: null, headerText: null, subtitle: null, ctaButtonEnabled: false, ctaButtonText: "ct", ctaButtonIsLoading: "Array", footerLabel: "PX_16", gradientColors: 0, iconSrc: null, isPlatformSupported: "Array", isSpotifyParty: "accessibilityRole", maxPartySize: "spriteIndex", partyMemberAvatarURIs: "isArray", partySizeText: null, platformIconKeys: "lu", coverImageUrl: "ma", detailsText: "me", title: "je" };
          obj15[0] = obj.BLOCKED;
          const intl2 = intl(1236).intl;
          obj15[1] = intl2.string(intl(1236).t.pkq6Vq);
          if (contentClassificationVisibility === intl(11130).ContentClassificationVisibility.BLOCK_UNDERAGE) {
