...
// Dependencies: [19, 4303, 1363, 712, 4152, 2]
// Exports: default, useEmbedThemeColors

// Module 8055 (getEmbedThemeColors)
...
const result1 = createCacheKey.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    ...
    PRIMARY_600 = require(4152) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.PRIMARY_500, 0.3);
...
const result6 = createCacheKey.experimental_createToken((theme) => {
  const obj = require(1363) /* AccessibilityAnnouncer */;
  const unsafe_rawColors = importDefault(712).unsafe_rawColors;
  return require(1363) /* AccessibilityAnnouncer */.isThemeDark(theme.theme) ? unsafe_rawColors.PRIMARY_600 : unsafe_rawColors.PRIMARY_100;
});
...
const result8 = createCacheKey.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    ...
    PRIMARY_600 = require(4152) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.PRIMARY_200, 0.3);
    const tmpResult = require(4152) /* hexToRgba */;
  }
  return PRIMARY_600;
});
