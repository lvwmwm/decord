...
// Dependencies: [19, 4344, 1363, 712, 4193, 2]
// Exports: default, useEmbedThemeColors

// Module 8094 (getEmbedThemeColors)
...
const result1 = createCacheKey.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    ...
    PRIMARY_600 = require(4193) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.PRIMARY_500, 0.3);
...
const result8 = createCacheKey.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    ...
    PRIMARY_600 = require(4193) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.PRIMARY_200, 0.3);
    const tmpResult = require(4193) /* hexToRgba */;
  }
  return PRIMARY_600;
});
