...
// Dependencies: [31, 4165, 4011, 689, 4009, 2]
// Exports: useEmbedThemeColors

// Module 7702 (getEmbedThemeColors)
...
const result1 = _createForOfIteratorHelperLoose.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    ...
    PRIMARY_600 = require(4009) /* hexToRgb */.hexWithOpacity(importDefault(689).unsafe_rawColors.PRIMARY_500, 0.3);
...
const result6 = _createForOfIteratorHelperLoose.experimental_createToken((theme) => {
  const obj = require(4011) /* AccessibilityAnnouncer */;
  const unsafe_rawColors = importDefault(689).unsafe_rawColors;
  return require(4011) /* AccessibilityAnnouncer */.isThemeDark(theme.theme) ? unsafe_rawColors.PRIMARY_600 : unsafe_rawColors.PRIMARY_100;
});
...
const result8 = _createForOfIteratorHelperLoose.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    ...
    PRIMARY_600 = require(4009) /* hexToRgb */.hexWithOpacity(importDefault(689).unsafe_rawColors.PRIMARY_200, 0.3);
    const obj2 = require(4009) /* hexToRgb */;
  }
  return PRIMARY_600;
});
