...
// Dependencies: [19, 4285, 4130, 712, 4128, 2]
// Exports: default, useEmbedThemeColors

// Module 7976 (getEmbedThemeColors)
...
const result = createCacheKey.experimental_createToken((theme) => {
  ...
  return require(4130) /* AccessibilityAnnouncer */.isThemeDark(theme.theme) ? unsafe_rawColors.PRIMARY_500 : unsafe_rawColors.PRIMARY_400;
});
const result1 = createCacheKey.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    ...
    PRIMARY_600 = require(4128) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.PRIMARY_500, 0.3);
...
const result4 = createCacheKey.experimental_createToken((theme) => {
  const obj = require(4130) /* AccessibilityAnnouncer */;
  const unsafe_rawColors = importDefault(712).unsafe_rawColors;
  return require(4130) /* AccessibilityAnnouncer */.isThemeDark(theme.theme) ? unsafe_rawColors.PRIMARY_500 : unsafe_rawColors.PRIMARY_100;
});
const result5 = createCacheKey.experimental_createToken((theme) => {
  const obj = require(4130) /* AccessibilityAnnouncer */;
  const isThemeDarkResult = require(4130) /* AccessibilityAnnouncer */.isThemeDark(theme.theme);
  const hexWithOpacity = require(4128) /* hexToRgba */.hexWithOpacity;
  const unsafe_rawColors = importDefault(712).unsafe_rawColors;
...
const result6 = createCacheKey.experimental_createToken((theme) => {
  const obj = require(4130) /* AccessibilityAnnouncer */;
  const unsafe_rawColors = importDefault(712).unsafe_rawColors;
  return require(4130) /* AccessibilityAnnouncer */.isThemeDark(theme.theme) ? unsafe_rawColors.PRIMARY_600 : unsafe_rawColors.PRIMARY_100;
});
...
const result8 = createCacheKey.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    ...
    PRIMARY_600 = require(4128) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.PRIMARY_200, 0.3);
    const tmpResult = require(4128) /* hexToRgba */;
  }
  return PRIMARY_600;
});
