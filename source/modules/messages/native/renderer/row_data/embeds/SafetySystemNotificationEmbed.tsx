...
// Dependencies: [17, 676, 3866, 7886, 4752, 7727, 7978, 1236, 2]
// Exports: createSafetySystemNotificationEmbed

// Module 12550 (createSafetySystemNotificationEmbed)
      ...
      if (null != fields) {
        ...
        if (type === MessageEmbedTypes.SAFETY_SYSTEM_NOTIFICATION) {
          ...
          if (null != parseMessageForPropsResult) {
            ...
            obj[0] = str;
            obj[1] = tmp6(7978).getAssetUriForEmbed(Image.resolveAssetSource(importDefault("danger" === parseMessageForPropsResult.icon ? 7886 : 4752)));
            ...
            obj = { daysAgo: null };
            const tmp6Result1 = tmp6(7978);
            const obj7 = importDefault(3866)();
            obj[0] = obj7.diff(importDefault(3866).unix(num), "days");
