...
// Dependencies: [17, 676, 3943, 8029, 4834, 7870, 8121, 1236, 2]
// Exports: createSafetySystemNotificationEmbed

// Module 12719 (createSafetySystemNotificationEmbed)
      ...
      if (null != fields) {
        ...
        if (type === MessageEmbedTypes.SAFETY_SYSTEM_NOTIFICATION) {
          ...
          if (null != parseMessageForPropsResult) {
            ...
            obj[0] = str;
            obj[1] = tmp6(8121).getAssetUriForEmbed(Image.resolveAssetSource(importDefault("danger" === parseMessageForPropsResult.icon ? 8029 : 4834)));
            ...
            obj = { daysAgo: null };
            const tmp6Result1 = tmp6(8121);
            const obj7 = importDefault(3943)();
            obj[0] = obj7.diff(importDefault(3943).unix(num), "days");
