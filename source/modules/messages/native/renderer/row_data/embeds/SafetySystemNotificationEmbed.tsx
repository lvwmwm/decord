...
// Dependencies: [17, 673, 4074, 8756, 4990, 8708, 7867, 1233, 2]
// Exports: createSafetySystemNotificationEmbed

// Module 13146 (createSafetySystemNotificationEmbed)
      ...
      if (null != fields) {
        ...
        if (type === MessageEmbedTypes.SAFETY_SYSTEM_NOTIFICATION) {
          ...
          if (null != parseMessageForPropsResult) {
            ...
            obj[0] = str;
            obj[1] = tmp6(7867).getAssetUriForEmbed(Image.resolveAssetSource(importDefault("danger" === parseMessageForPropsResult.icon ? 8756 : 4990)));
