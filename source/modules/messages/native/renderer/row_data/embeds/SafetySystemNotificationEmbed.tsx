...
// Dependencies: [17, 676, 3771, 7627, 4657, 6752, 7726, 1236, 2]
// Exports: createSafetySystemNotificationEmbed

// Module 12384 (createSafetySystemNotificationEmbed)
    ...
    if (null != message.embeds) {
      ...
      if (null != fields) {
        ...
        if (type === MessageEmbedTypes.SAFETY_SYSTEM_NOTIFICATION) {
          let obj = require(6752) /* parseMessageEmbedForProps */;
          ...
          if (null != parseMessageForPropsResult) {
            ...
            obj[0] = str;
            obj[1] = tmp6(7726).getAssetUriForEmbed(Image.resolveAssetSource(importDefault("danger" === parseMessageForPropsResult.icon ? 7627 : 4657)));
