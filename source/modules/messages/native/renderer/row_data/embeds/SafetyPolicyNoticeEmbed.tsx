...
// Dependencies: [17, 676, 7716, 3837, 1236, 7853, 7761, 2]
// Exports: createSafetyPolicyNoticeEmbed

// Module 12507 (createSafetyPolicyNoticeEmbed)
      ...
      if (type === MessageEmbedTypes.SAFETY_POLICY_NOTICE) {
        ...
        if (null != rawValue) {
          if (null != parsed) {
            ...
            obj[1] = require(7853) /* frozen */.getAssetUriForEmbed(Image.resolveAssetSource(importDefault(7761)));
            const intl2 = require(1236) /* getSystemLocale */.intl;
            obj = { daysAgo: null };
            const obj2 = require(7853) /* frozen */;
