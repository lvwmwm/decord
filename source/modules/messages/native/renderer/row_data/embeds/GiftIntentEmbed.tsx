...
// Dependencies: [7794, 1850, 1852, 4131, 689, 1212, 7798, 3970, 7670, 4068, 7799, 7800, 2]
// Exports: createGiftIntentEmbed

// Module 7793 (createGiftIntentEmbed)
...
export const createGiftIntentEmbed = function createGiftIntentEmbed(message, theme) {
  ...
  if (null == giftingPrompt) {
    ...
    if (null == user) {
      ...
      const name = importDefault(3970).getName(user);
      if (GiftIntentType.FRIEND_ANNIVERSARY === giftIntentType) {
        ...
        if (GiftIntentType.UNSPECIFIED !== giftIntentType) {
          require(7798) /* _sendGiftMessage */.unhandledGiftIntent(giftIntentType);
          tmp2 = null;
          const obj10 = require(7798) /* _sendGiftMessage */;
        }
      }
      if (null == tmp2) {
        return null;
        ...
        obj1.subHeaderIconUrl = require(7670) /* frozen */.getAssetUriForEmbed(importDefault(4068));
        const intl3 = require(1212) /* getSystemLocale */.intl;
        obj1.primaryCtaLabel = intl3.string(require(1212) /* getSystemLocale */.t.ilhtIa);
        const obj5 = require(7670) /* frozen */;
        obj1.primaryCtaIconUrl = require(7670) /* frozen */.getAssetUriForEmbed(importDefault(7799));
        const obj6 = require(7670) /* frozen */;
        obj1.secondaryCtaIconUrl = require(7670) /* frozen */.getAssetUriForEmbed(importDefault(7800));
