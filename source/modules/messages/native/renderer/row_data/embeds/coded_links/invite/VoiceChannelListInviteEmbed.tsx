...
// Dependencies: [17, 4470, 11165, 1429, 1386, 1991, 1908, 4120, 4130, 1921, 4497, 4555, 11166, 673, 7491, 11167, 7863, 7864, 1430, 4322, 4296, 4674, 1233, 11168, 2]
// Exports: canShowVoiceChannelListInviteEmbed, createVoiceChannelListInviteEmbed

// Module 11164 (canShowVoiceChannelListInviteEmbed)
...
export const createVoiceChannelListInviteEmbed = function createVoiceChannelListInviteEmbed(invite, closure_2) {
  ...
  if (null != invite.guild) {
    ...
    tmp = null;
    if (null != guild) {
      let channel = displayNameStylesEnabled(11167)(invite).channel;
      tmp = null;
      if (null != channel) {
        tmp = null;
        if (channel.isGuildVocal()) {
  ...
  if (null == tmp) {
    ...
    if (null != guild.icon) {
      assetUriForEmbed = guild(7864).getAssetUriForEmbed(getGuildIconSource(guild, 128, false));
      let obj2 = guild(7864);
    }
    ...
    obj.canBeAccepted = tmp39(11168).canAcceptInvite(items1, invite);
