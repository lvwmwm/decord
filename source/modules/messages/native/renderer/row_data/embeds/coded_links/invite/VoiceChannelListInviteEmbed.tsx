...
// Dependencies: [17, 4473, 11240, 1430, 1386, 1991, 1908, 4120, 4130, 1921, 4500, 4558, 11241, 673, 7669, 11242, 7876, 7877, 1431, 4325, 4299, 4681, 1233, 11243, 2]
// Exports: canShowVoiceChannelListInviteEmbed, createVoiceChannelListInviteEmbed

// Module 11239 (canShowVoiceChannelListInviteEmbed)
...
export const createVoiceChannelListInviteEmbed = function createVoiceChannelListInviteEmbed(invite, closure_2) {
  ...
  if (null != invite.guild) {
    ...
    tmp = null;
    if (null != guild) {
      let channel = displayNameStylesEnabled(11242)(invite).channel;
      tmp = null;
      if (null != channel) {
        tmp = null;
        if (channel.isGuildVocal()) {
  ...
  if (null == tmp) {
    ...
    ({ colors, baseColors } = displayNameStylesEnabled(7876)(closure_2));
    let assetUriForEmbed;
    if (null != guild.icon) {
      assetUriForEmbed = guild(7877).getAssetUriForEmbed(getGuildIconSource(guild, 128, false));
      let obj2 = guild(7877);
    }
    ...
    const tmp41 = displayNameStylesEnabled(7876)(closure_2);
    const embedScrollGradientBackground = guild(4299).getEmbedScrollGradientBackground();
    ...
    obj.headerText = "";
    const obj4 = guild(4299);
    obj.titleText = guild(4681).computeChannelName(channel2, closure_12, closure_11);
    ...
    const tmp30Result = guild(4681);
    const tmp35 = currentClientVoiceChannelId === channel2.id;
    const items1 = [closure_8];
    obj.canBeAccepted = tmp39(11243).canAcceptInvite(items1, invite);
