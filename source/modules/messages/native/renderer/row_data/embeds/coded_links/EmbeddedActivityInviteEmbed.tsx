...
// Dependencies: [32, 17, 1390, 8397, 4421, 1218, 1391, 4364, 4034, 1922, 11079, 7340, 709, 8396, 8204, 4866, 1236, 4574, 12809, 2]
// Exports: createEmbeddedActivityInviteEmbed

// Module 12808 (createEmbeddedActivityInviteEmbed)
...
import closure_6 from "handleFetchEmbeddedActivityShelfSuccess" /* 8397 */;
import { FetchState } from "handleFetchEmbeddedActivityShelfSuccess" /* 8397 */;
...
import closure_11 from "updateInvite" /* 4364 */;
      ...
      if (null != target_application) {
        ...
        if (null != channel) {
          ...
          if (null != id) {
            ...
            let assetIds1 = tmp25(8396).getAssetIds(id, closure_16);
            if (assetIds1 == null) {
              assetIds1 = [];
            }
            ...
            let assetImage;
            if (null != first) {
              assetImage = tmp25(8396).getAssetImage(id, first, 1024);
              const tmp25Result2 = tmp25(8396);
            }
            obj2 = {};
