...
// Dependencies: [32, 17, 1390, 7982, 4486, 1218, 1391, 4429, 4098, 1922, 10866, 7414, 709, 7981, 7787, 4933, 1236, 4639, 12795, 2]
// Exports: createEmbeddedActivityInviteEmbed

// Module 12794 (createEmbeddedActivityInviteEmbed)
...
import closure_6 from "handleFetchEmbeddedActivityShelfSuccess" /* 7982 */;
import { FetchState } from "handleFetchEmbeddedActivityShelfSuccess" /* 7982 */;
...
import closure_11 from "updateInvite" /* 4429 */;
      ...
      if (null != target_application) {
        ...
        if (null != channel) {
          ...
          if (null != id) {
            ...
            let assetIds1 = tmp25(7981).getAssetIds(id, closure_16);
            if (assetIds1 == null) {
              assetIds1 = [];
            }
            ...
            let assetImage;
            if (null != first) {
              assetImage = tmp25(7981).getAssetImage(id, first, 1024);
              const tmp25Result2 = tmp25(7981);
            }
            obj2 = {};
