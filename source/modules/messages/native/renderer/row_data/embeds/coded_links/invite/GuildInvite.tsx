...
// Dependencies: [17, 1415, 4274, 1372, 1942, 1862, 4240, 3892, 1874, 10878, 676, 7090, 7835, 1236, 7827, 712, 4094, 4101, 11091, 11092, 1411, 1945, 7837, 11964, 11963, 10880, 10879, 12477, 1384, 7667, 1416, 1849, 4715, 9153, 4445, 2]
...
// Module 12476 (createResolvingGuildInvite)
...
export const createResolvingGuildInvite = function createResolvingGuildInvite(closure_2) {
  const tmp = importDefault(7835)(closure_2);
...
export const createDisabledGuildInvite = function createDisabledGuildInvite(invite, closure_2) {
  ...
  obj.titleColor = require(7827) /* processColorOrThrow */.processColorOrThrow(importDefault(712).unsafe_rawColors.RED_345);
  let name;
  ...
  const obj3 = require(7827) /* processColorOrThrow */;
  obj.helpCenterArticleURL = importDefault(1945).getArticleURL(constants.INVITE_DISABLED);
  obj.guildIcon = tmp11;
  const tmp16 = tmp11;
  const tmpResult = importDefault(1945);
  obj.thumbnailUrl = require(7837) /* frozen */.getAssetUriForEmbed(importDefault(11964));
  let tmp17;
  if (null == tmp11) {
    let tmp18;
    if (null != fromInviteGuildResult) {
...
export const createErroredGuildInvite = function createErroredGuildInvite(code, arg1, closure_2) {
  ...
  let obj = require(11963) /* getDescriptiveInviteError */;
  code = undefined;
  if (inviteError != null) {
...
export const createGuildInvite = function createGuildInvite(invite, isOwnInvite, closure_2) {
  ...
  let obj2 = require(12477) /* getHeaderTextForInvite */;
  ...
  obj[5] = tmp10Result.hasFlag(num, require(7667) /* set */.GuildInviteFlags.IS_GUEST_INVITE);
