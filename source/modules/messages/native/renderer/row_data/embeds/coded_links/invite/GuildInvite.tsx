...
// Dependencies: [17, 1434, 4363, 1391, 1990, 1910, 4329, 3998, 1922, 11050, 676, 7236, 8094, 1236, 8086, 712, 4189, 1363, 11266, 11267, 1430, 1993, 8096, 12140, 12139, 11052, 11051, 12664, 1403, 7813, 1435, 1896, 4804, 9310, 4534, 2]
...
export const createResolvingGuildInvite = function createResolvingGuildInvite(closure_2) {
  const tmp = importDefault(8094)(closure_2);
...
export const createDisabledGuildInvite = function createDisabledGuildInvite(invite, closure_2) {
  ...
  obj.titleColor = require(8086) /* processColorOrThrow */.processColorOrThrow(importDefault(712).unsafe_rawColors.RED_345);
  let name;
  ...
  const obj3 = require(8086) /* processColorOrThrow */;
  obj.helpCenterArticleURL = importDefault(1993).getArticleURL(constants.INVITE_DISABLED);
  obj.guildIcon = tmp11;
  const tmp16 = tmp11;
  const tmpResult = importDefault(1993);
  obj.thumbnailUrl = require(8096) /* frozen */.getAssetUriForEmbed(importDefault(12140));
  let tmp17;
  if (null == tmp11) {
    let tmp18;
    if (null != fromInviteGuildResult) {
...
export const createErroredGuildInvite = function createErroredGuildInvite(code, arg1, closure_2) {
  ...
  let obj = require(12139) /* getDescriptiveInviteError */;
  code = undefined;
  if (inviteError != null) {
...
export const createGuildInvite = function createGuildInvite(invite, isOwnInvite, closure_2) {
  ...
  obj[5] = tmp10Result.hasFlag(num, require(7813) /* set */.GuildInviteFlags.IS_GUEST_INVITE);
