...
// Dependencies: [4116, 1850, 653, 5969, 12287, 5968, 12289, 12290, 12291, 12293, 12295, 9433, 9434, 2]
// Exports: createInviteEmbed

// Module 12286 (createInviteEmbed)
...
export const createInviteEmbed = function createInviteEmbed(closure_0, code, _isNativeReflectConstruct) {
  ...
  if (null == invite) {
    ...
    if (invite.state === constants.RESOLVING) {
      return require(12287) /* createResolvingGuildInvite */.createResolvingGuildInvite(_isNativeReflectConstruct);
    } else {
      if (invite.state !== constants.EXPIRED) {
        if (invite.state !== constants.BANNED) {
          if (invite.state === constants.ERROR) {
            ...
            if (null == inviteError) {
              let erroredGuildInvite = require(12287) /* createResolvingGuildInvite */.createErroredGuildInvite(code, tmp3, _isNativeReflectConstruct);
              const obj14 = require(12287) /* createResolvingGuildInvite */;
            } else if (inviteError.code === constants2.INVITES_DISABLED) {
              erroredGuildInvite = require(12287) /* createResolvingGuildInvite */.createDisabledGuildInvite(invite, _isNativeReflectConstruct);
              const obj13 = require(12287) /* createResolvingGuildInvite */;
            } else {
              erroredGuildInvite = require(12287) /* createResolvingGuildInvite */.createErroredGuildInvite(code, tmp3, _isNativeReflectConstruct);
              const obj12 = require(12287) /* createResolvingGuildInvite */;
            }
            ...
            if (InviteTypes.GROUP_DM === inviteType) {
              return require(12289) /* createGroupDMInvite */.createGroupDMInvite(invite, tmp3, _isNativeReflectConstruct);
            } else if (InviteTypes.FRIEND === inviteType) {
              const obj10 = require(12290) /* createFriendInvite */;
              ...
              if (require(5968) /* isGroupDMInvite */.GuildInviteExtendedType.EVENT === guildInviteExtendedType) {
                return require(12291) /* createGuildScheduledEventEmbed */.createGuildScheduledEventInviteEmbed(invite, _isNativeReflectConstruct);
                ...
                return require(12293) /* createEmbeddedActivityInviteEmbed */.createEmbeddedActivityInviteEmbed(obj);
              } else if (require(5968) /* isGroupDMInvite */.GuildInviteExtendedType.PROFILE === guildInviteExtendedType) {
                return require(12295) /* createGuildProfileInvite */.createGuildProfileInvite(invite, _isNativeReflectConstruct);
                ...
                return require(12287) /* createResolvingGuildInvite */.createGuildInvite(invite, tmp3, _isNativeReflectConstruct);
              } else {
                obj = require(12287) /* createResolvingGuildInvite */;
      ...
      return require(12287) /* createResolvingGuildInvite */.createExpiredGuildInvite(closure_0, tmp3, _isNativeReflectConstruct);
    }
  }
};
