...
// Dependencies: [4288, 1903, 676, 7196, 12600, 7195, 12602, 12603, 12604, 12606, 12608, 10990, 10991, 2]
// Exports: createInviteEmbed

// Module 12599 (createInviteEmbed)
...
export const createInviteEmbed = function createInviteEmbed(closure_0, code, updateInvite) {
  ...
  if (null == invite) {
    ...
    if (invite.state === constants.RESOLVING) {
      return require(12600) /* createResolvingGuildInvite */.createResolvingGuildInvite(updateInvite);
    } else {
      if (invite.state !== tmp5.EXPIRED) {
        if (invite.state !== tmp5.BANNED) {
          if (invite.state === tmp5.ERROR) {
            ...
            if (null == inviteError) {
              let erroredGuildInvite = require(12600) /* createResolvingGuildInvite */.createErroredGuildInvite(code, tmp28, updateInvite);
              const obj15 = require(12600) /* createResolvingGuildInvite */;
            } else if (inviteError.code === constants2.INVITES_DISABLED) {
              erroredGuildInvite = require(12600) /* createResolvingGuildInvite */.createDisabledGuildInvite(invite, updateInvite);
              const obj14 = require(12600) /* createResolvingGuildInvite */;
            } else {
              erroredGuildInvite = require(12600) /* createResolvingGuildInvite */.createErroredGuildInvite(code, tmp28, updateInvite);
              const obj13 = require(12600) /* createResolvingGuildInvite */;
            }
      ...
      return require(12600) /* createResolvingGuildInvite */.createExpiredGuildInvite(closure_0, id === tmp4, updateInvite);
    }
  }
};
