...
// Dependencies: [17, 6840, 5862, 7117, 7976, 1236, 7968, 712, 4130, 11125, 11126, 12523, 2]
// Exports: createGuildTemplateEmbed

// Module 12522 (createGuildTemplateEmbed)
...
export const createGuildTemplateEmbed = function createGuildTemplateEmbed(code, closure_2) {
  ...
  if (null == guildTemplate) {
    ...
    let obj1 = require(7968) /* processColorOrThrow */;
    ...
    obj1.thumbnailUrl = Image.resolveAssetSource(tmp(12523)).uri;
