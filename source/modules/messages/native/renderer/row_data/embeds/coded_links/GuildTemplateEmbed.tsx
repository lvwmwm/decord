...
// Dependencies: [17, 7150, 6136, 7428, 7801, 1236, 7792, 712, 1363, 11314, 11315, 12817, 2]
// Exports: createGuildTemplateEmbed

// Module 12816 (createGuildTemplateEmbed)
...
export const createGuildTemplateEmbed = function createGuildTemplateEmbed(code, closure_2) {
  ...
  if (null == guildTemplate) {
    ...
    obj1.thumbnailUrl = Image.resolveAssetSource(tmp(12817)).uri;
