...
// Dependencies: [17, 5715, 5716, 6019, 7722, 1236, 7714, 712, 4035, 10990, 10991, 12357, 2]
// Exports: createGuildTemplateEmbed

// Module 12356 (createGuildTemplateEmbed)
...
export const createGuildTemplateEmbed = function createGuildTemplateEmbed(code, closure_2) {
  ...
  if (null == guildTemplate) {
    ...
    obj1.thumbnailUrl = Image.resolveAssetSource(tmp(12357)).uri;
