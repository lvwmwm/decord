...
// Dependencies: [17, 10413, 7197, 8055, 11191, 12616, 1625, 1236, 8047, 712, 1363, 11212, 11213, 12614, 2]
// Exports: createBuildOverrideEmbed

// Module 12615 (createBuildOverrideEmbed)
...
export const createBuildOverrideEmbed = function createBuildOverrideEmbed(code, closure_2) {
  ...
  if (buildOverride.state === State.Resolving) {
    ...
    obj1.titleColor = require(8047) /* processColorOrThrow */.processColorOrThrow(tmp(712).unsafe_rawColors.RED_400);
    if (tmpResultResult.valid) {
    ...
    const obj4 = require(8047) /* processColorOrThrow */;
