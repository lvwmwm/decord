...
// Dependencies: [17, 10638, 4371, 8169, 10968, 12772, 1626, 1236, 8161, 712, 1363, 10987, 10988, 12770, 2]
...
export const createBuildOverrideEmbed = function createBuildOverrideEmbed(code, closure_2) {
  ...
  if (buildOverride.state === State.Resolving) {
    ...
    obj1.titleColor = require(8161) /* processColorOrThrow */.processColorOrThrow(tmp(712).unsafe_rawColors.RED_400);
    if (tmpResultResult.valid) {
    ...
    const obj4 = require(8161) /* processColorOrThrow */;
