...
// Dependencies: [17, 10325, 7117, 7976, 11104, 12525, 1606, 1236, 7968, 712, 4130, 11125, 11126, 12523, 2]
// Exports: createBuildOverrideEmbed

// Module 12524 (createBuildOverrideEmbed)
...
export const createBuildOverrideEmbed = function createBuildOverrideEmbed(code, closure_2) {
  ...
  if (buildOverride.state === State.Resolving) {
    ...
    obj1.titleColor = require(7968) /* processColorOrThrow */.processColorOrThrow(tmp(712).unsafe_rawColors.RED_400);
    if (tmpResultResult.valid) {
    ...
    const obj4 = require(7968) /* processColorOrThrow */;
