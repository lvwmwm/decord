...
// Dependencies: [17, 10464, 6019, 7722, 10976, 12359, 1578, 1236, 7714, 712, 4035, 10990, 10991, 12357, 2]
// Exports: createBuildOverrideEmbed

// Module 12358 (createBuildOverrideEmbed)
  ...
  if (buildOverride.state === State.Resolving) {
    ...
    if (override2 != null) {
      ...
      if (targetBuildOverride != null) {
        const tmp9 = targetBuildOverride[require(undefined, 10976) /* setBuildOverrideForBranch */.DEVICE_FIELD];
        if (tmp9 != null) {
          id = tmp9.id;
        }
      }
    ...
    if (tmp10) {
      ...
      let id1;
      if (overrides != null) {
        const tmp13 = overrides[require(undefined, 10976) /* setBuildOverrideForBranch */.DEVICE_FIELD];
        if (tmp13 != null) {
          id1 = tmp13.id;
        }
      }
            ...
            if (tmpResultResult.valid) {
              ...
              if (override != null) {
                ...
                if (targetBuildOverride2 != null) {
                  const tmp30 = targetBuildOverride2[tmp28(undefined, 10976).DEVICE_FIELD];
                  if (tmp30 != null) {
                    type = tmp30.type;
                  }
                }
              ...
              obj.thumbnailUrl = Image.resolveAssetSource(tmp(12357)).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
    ...
    obj1.titleColor = require(7714) /* processColorOrThrow */.processColorOrThrow(tmp(712).unsafe_rawColors.RED_400);
    if (tmpResultResult.valid) {
