...
// Dependencies: [17, 10294, 7090, 7835, 11072, 12488, 1578, 1236, 7827, 712, 4101, 11091, 11092, 12486, 2]
// Exports: createBuildOverrideEmbed

// Module 12487 (createBuildOverrideEmbed)
...
export const createBuildOverrideEmbed = function createBuildOverrideEmbed(code, closure_2) {
  ...
  if (buildOverride.state === State.Resolving) {
    ...
    obj1.titleColor = require(7827) /* processColorOrThrow */.processColorOrThrow(tmp(712).unsafe_rawColors.RED_400);
    if (tmpResultResult.valid) {
    ...
    const obj4 = require(7827) /* processColorOrThrow */;
