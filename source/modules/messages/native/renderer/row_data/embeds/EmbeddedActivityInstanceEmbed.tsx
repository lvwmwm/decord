...
// Dependencies: [1386, 4489, 1218, 1387, 4537, 1922, 10908, 11481, 1236, 11482, 12849, 12859, 11483, 11484, 5922, 9046, 2]
// Exports: createActivityInstanceEmbed

// Module 12858 (createActivityInstanceEmbed)
  ...
  if (null != application) {
    ...
    if (null != id) {
      if (null != channel) {
        ...
        if (id(11481).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          id = application;
          ...
          const playInContext = tmp5(11483).getPlayInContext(application.id, channel_id);
          ...
          if (null != application.icon) {
            appIconSrc = tmp5(11484).getAppIconSrc(application.id, application.icon, application.bot);
            const tmp5Result2 = tmp5(11484);
          }
          if (null == instanceId) {
          ...
          if (tmp24) {
            application = tmp5(5922).fetchApplication(application.id);
            const tmp5Result3 = tmp5(5922);
          }
          ...
          obj2[0] = tmp5(11482).AppMessageEmbedDisplayType.DISPLAY;
          ...
          obj13 = application;
          obj8 = closure_6;
          const tmp5Result1 = tmp5(11483);
          const obj3 = { applicationId: null, referrerId: null };
          obj3[0] = application.id;
          obj3[1] = id.getId();
          obj2[9] = tmp5(9046).getActivityLaunchURL(obj3);
          obj2[11] = items;
          obj2[12] = CodedLinkExtendedType.APP_MESSAGE_EMBED;
          const tmp5Result4 = tmp5(9046);
          obj2[13] = tmp5(11484).getAppGradientColors(appIconSrc);
          ...
          id = application.id;
          if (contentClassificationVisibility === tmp5(11481).ContentClassificationVisibility.BLOCK_UNDERAGE) {
          ...
          obj6[0] = tmp5(11482).AppMessageEmbedDisplayType.BLOCKED;
          obj6[1] = id;
          obj6[2] = message.id;
