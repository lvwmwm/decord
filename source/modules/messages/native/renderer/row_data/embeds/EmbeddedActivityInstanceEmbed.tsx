...
// Dependencies: [1390, 4421, 1218, 1391, 4469, 1922, 11079, 11509, 1236, 11510, 12809, 12819, 11511, 11512, 5835, 11717, 2]
// Exports: createActivityInstanceEmbed

// Module 12818 (createActivityInstanceEmbed)
  ...
  if (null != application) {
    ...
    if (null != id) {
      if (null != channel) {
        ...
        if (id(11509).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          id = application;
          ...
          const playInContext = tmp5(11511).getPlayInContext(application.id, channel_id);
          ...
          if (null != application.icon) {
            appIconSrc = tmp5(11512).getAppIconSrc(application.id, application.icon, application.bot);
            const tmp5Result2 = tmp5(11512);
          }
          if (null == instanceId) {
          ...
          if (tmp24) {
            application = tmp5(5835).fetchApplication(application.id);
            const tmp5Result3 = tmp5(5835);
          }
          ...
          obj2[0] = tmp5(11510).AppMessageEmbedDisplayType.DISPLAY;
          ...
          obj3[1] = id.getId();
          obj2[9] = tmp5(11717).getActivityLaunchURL(obj3);
          obj2[11] = items;
          obj2[12] = CodedLinkExtendedType.APP_MESSAGE_EMBED;
          const tmp5Result4 = tmp5(11717);
          obj2[13] = tmp5(11512).getAppGradientColors(appIconSrc);
          ...
          id = application.id;
          if (contentClassificationVisibility === tmp5(11509).ContentClassificationVisibility.BLOCK_UNDERAGE) {
          ...
          obj6[0] = tmp5(11510).AppMessageEmbedDisplayType.BLOCKED;
          obj6[1] = id;
          obj6[2] = message.id;
