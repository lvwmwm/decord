...
// Dependencies: [1347, 4168, 1194, 1348, 4218, 1850, 9436, 11071, 1212, 11072, 12294, 12304, 11073, 11075, 5463, 11243, 2]
// Exports: createActivityInstanceEmbed

// Module 12303 (createActivityInstanceEmbed)
  ...
  if (null != application) {
    ...
    if (null != id) {
      if (null != channel) {
        ...
        let obj = require(11071) /* getContentClassificationVisibility */;
        ...
        if (require(11071) /* getContentClassificationVisibility */.ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          ...
          id = application.id;
          if (contentClassificationVisibility === require(11071) /* getContentClassificationVisibility */.ContentClassificationVisibility.BLOCK_UNDERAGE) {
          ...
          obj = { displayType: require(11072) /* AppMessageEmbedDisplayType */.AppMessageEmbedDisplayType.BLOCKED, appId: id, messageId: message.id, title: null };
