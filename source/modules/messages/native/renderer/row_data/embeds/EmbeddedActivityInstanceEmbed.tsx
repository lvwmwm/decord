...
// Dependencies: [1371, 4292, 1218, 1372, 4342, 1874, 9658, 11261, 1236, 11262, 12478, 12488, 11263, 11264, 5582, 11430, 2]
// Exports: createActivityInstanceEmbed

// Module 12487 (createActivityInstanceEmbed)
  ...
  if (null != application) {
    ...
    if (null != id) {
      if (null != channel) {
        ...
        if (id(11261).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          id = application;
          ...
          const playInContext = tmp5(11263).getPlayInContext(application.id, channel_id);
          ...
          if (null != application.icon) {
            appIconSrc = tmp5(11264).getAppIconSrc(application.id, application.icon, application.bot);
            const tmp5Result2 = tmp5(11264);
          }
          if (null == instanceId) {
          ...
          if (tmp24) {
            application = tmp5(5582).fetchApplication(application.id);
            const tmp5Result3 = tmp5(5582);
          }
          ...
          obj2[0] = tmp5(11262).AppMessageEmbedDisplayType.DISPLAY;
          ...
          obj13 = application;
          obj8 = sortActivity;
          const tmp5Result1 = tmp5(11263);
          const obj3 = { applicationId: null, referrerId: null };
          obj3[0] = application.id;
          obj3[1] = id.getId();
          obj2[9] = tmp5(11430).getActivityLaunchURL(obj3);
          obj2[11] = items;
          obj2[12] = CodedLinkExtendedType.APP_MESSAGE_EMBED;
          const tmp5Result4 = tmp5(11430);
          obj2[13] = tmp5(11264).getAppGradientColors(appIconSrc);
          ...
          id = application.id;
          if (contentClassificationVisibility === tmp5(11261).ContentClassificationVisibility.BLOCK_UNDERAGE) {
          ...
          obj6[0] = tmp5(11262).AppMessageEmbedDisplayType.BLOCKED;
          obj6[1] = id;
          obj6[2] = message.id;
