...
// Dependencies: [1390, 4383, 1218, 1391, 4431, 1922, 10966, 11399, 1236, 11400, 12671, 12681, 11401, 11402, 5769, 11577, 2]
// Exports: createActivityInstanceEmbed

// Module 12680 (createActivityInstanceEmbed)
  ...
  if (null != application) {
    ...
    if (null != id) {
      if (null != channel) {
        ...
        if (id(11399).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          id = application;
          ...
          const playInContext = tmp5(11401).getPlayInContext(application.id, channel_id);
          ...
          if (null != application.icon) {
            appIconSrc = tmp5(11402).getAppIconSrc(application.id, application.icon, application.bot);
            const tmp5Result2 = tmp5(11402);
          }
          if (null == instanceId) {
          ...
          if (tmp24) {
            application = tmp5(5769).fetchApplication(application.id);
            const tmp5Result3 = tmp5(5769);
          }
          ...
          obj2[0] = tmp5(11400).AppMessageEmbedDisplayType.DISPLAY;
          ...
          obj13 = application;
          obj8 = sortActivity;
          const tmp5Result1 = tmp5(11401);
          const obj3 = { applicationId: null, referrerId: null };
          obj3[0] = application.id;
          obj3[1] = id.getId();
          obj2[9] = tmp5(11577).getActivityLaunchURL(obj3);
          obj2[11] = items;
          obj2[12] = CodedLinkExtendedType.APP_MESSAGE_EMBED;
          const tmp5Result4 = tmp5(11577);
          obj2[13] = tmp5(11402).getAppGradientColors(appIconSrc);
          ...
          id = application.id;
          if (contentClassificationVisibility === tmp5(11399).ContentClassificationVisibility.BLOCK_UNDERAGE) {
          ...
          obj6[0] = tmp5(11400).AppMessageEmbedDisplayType.BLOCKED;
          obj6[1] = id;
          obj6[2] = message.id;
