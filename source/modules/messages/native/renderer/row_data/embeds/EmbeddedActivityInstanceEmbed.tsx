...
// Dependencies: [1371, 4292, 1218, 1372, 4341, 1874, 10878, 11232, 1236, 11233, 12483, 12493, 11234, 11235, 5596, 11404, 2]
// Exports: createActivityInstanceEmbed

// Module 12492 (createActivityInstanceEmbed)
  ...
  if (null != application) {
    ...
    if (null != id) {
      if (null != channel) {
        ...
        if (id(11232).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          id = application;
          ...
          const playInContext = tmp5(11234).getPlayInContext(application.id, channel_id);
          ...
          if (null != application.icon) {
            appIconSrc = tmp5(11235).getAppIconSrc(application.id, application.icon, application.bot);
            const tmp5Result2 = tmp5(11235);
          }
          if (null == instanceId) {
          ...
          if (tmp24) {
            application = tmp5(5596).fetchApplication(application.id);
            const tmp5Result3 = tmp5(5596);
          }
          ...
          obj2[0] = tmp5(11233).AppMessageEmbedDisplayType.DISPLAY;
          ...
          obj13 = application;
          obj8 = sortActivity;
          const tmp5Result1 = tmp5(11234);
          const obj3 = { applicationId: null, referrerId: null };
          obj3[0] = application.id;
          obj3[1] = id.getId();
          obj2[9] = tmp5(11404).getActivityLaunchURL(obj3);
          obj2[11] = items;
          obj2[12] = CodedLinkExtendedType.APP_MESSAGE_EMBED;
          const tmp5Result4 = tmp5(11404);
          obj2[13] = tmp5(11235).getAppGradientColors(appIconSrc);
          ...
          id = application.id;
          if (contentClassificationVisibility === tmp5(11232).ContentClassificationVisibility.BLOCK_UNDERAGE) {
          ...
          obj6[0] = tmp5(11233).AppMessageEmbedDisplayType.BLOCKED;
          obj6[1] = id;
          obj6[2] = message.id;
