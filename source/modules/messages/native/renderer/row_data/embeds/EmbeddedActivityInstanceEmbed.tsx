...
// Dependencies: [1385, 4522, 1215, 1386, 4572, 1921, 11241, 11873, 1233, 11874, 13148, 13158, 11875, 11876, 7103, 12064, 2]
// Exports: createActivityInstanceEmbed

// Module 13157 (createActivityInstanceEmbed)
  ...
  if (null != application) {
    ...
    if (null != id) {
      if (null != channel) {
        ...
        if (id(11873).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          id = application;
          ...
          const playInContext = tmp5(11875).getPlayInContext(application.id, channel_id);
          ...
          if (null != application.icon) {
            appIconSrc = tmp5(11876).getAppIconSrc(application.id, application.icon, application.bot);
            const tmp5Result2 = tmp5(11876);
          }
          if (null == instanceId) {
          ...
          if (tmp24) {
            application = tmp5(7103).fetchApplication(application.id);
            const tmp5Result3 = tmp5(7103);
          }
          ...
          obj2[0] = tmp5(11874).AppMessageEmbedDisplayType.DISPLAY;
          ...
          obj13 = application;
          obj8 = closure_6;
          const tmp5Result1 = tmp5(11875);
          const obj3 = { applicationId: null, referrerId: null };
          obj3[0] = application.id;
          obj3[1] = id.getId();
          obj2[9] = tmp5(12064).getActivityLaunchURL(obj3);
          obj2[11] = items;
          obj2[12] = CodedLinkExtendedType.APP_MESSAGE_EMBED;
          const tmp5Result4 = tmp5(12064);
          obj2[13] = tmp5(11876).getAppGradientColors(appIconSrc);
          ...
          id = application.id;
          if (contentClassificationVisibility === tmp5(11873).ContentClassificationVisibility.BLOCK_UNDERAGE) {
          ...
          obj6[0] = tmp5(11874).AppMessageEmbedDisplayType.BLOCKED;
          obj6[1] = id;
          obj6[2] = message.id;
