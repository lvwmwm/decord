...
// Dependencies: [1390, 4487, 1218, 1391, 4535, 1923, 10884, 11451, 1236, 11452, 12814, 12824, 11453, 11454, 5919, 9023, 2]
// Exports: createActivityInstanceEmbed

// Module 12823 (createActivityInstanceEmbed)
  ...
  if (null != application) {
    ...
    if (null != id) {
      if (null != channel) {
        ...
        if (id(11451).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          id = application;
          ...
          const playInContext = tmp5(11453).getPlayInContext(application.id, channel_id);
          ...
          if (null != application.icon) {
            appIconSrc = tmp5(11454).getAppIconSrc(application.id, application.icon, application.bot);
            const tmp5Result2 = tmp5(11454);
          }
          if (null == instanceId) {
          ...
          if (tmp24) {
            application = tmp5(5919).fetchApplication(application.id);
            const tmp5Result3 = tmp5(5919);
          }
          ...
          obj2[0] = tmp5(11452).AppMessageEmbedDisplayType.DISPLAY;
          ...
          obj13 = application;
          obj8 = closure_6;
          const tmp5Result1 = tmp5(11453);
          const obj3 = { applicationId: null, referrerId: null };
          obj3[0] = application.id;
          obj3[1] = id.getId();
          obj2[9] = tmp5(9023).getActivityLaunchURL(obj3);
          obj2[11] = items;
          obj2[12] = CodedLinkExtendedType.APP_MESSAGE_EMBED;
          const tmp5Result4 = tmp5(9023);
          obj2[13] = tmp5(11454).getAppGradientColors(appIconSrc);
          ...
          id = application.id;
          if (contentClassificationVisibility === tmp5(11451).ContentClassificationVisibility.BLOCK_UNDERAGE) {
          ...
          obj6[0] = tmp5(11452).AppMessageEmbedDisplayType.BLOCKED;
          obj6[1] = id;
          obj6[2] = message.id;
