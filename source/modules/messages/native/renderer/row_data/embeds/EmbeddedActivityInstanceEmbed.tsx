...
// Dependencies: [1371, 4322, 1218, 1372, 4371, 1903, 10910, 11266, 1236, 11267, 12520, 12530, 11268, 11269, 5650, 11438, 2]
// Exports: createActivityInstanceEmbed

// Module 12529 (createActivityInstanceEmbed)
  ...
  if (null != application) {
    ...
    if (null != id) {
      if (null != channel) {
        ...
        if (id(11266).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          id = application;
          ...
          const playInContext = tmp5(11268).getPlayInContext(application.id, channel_id);
          ...
          if (null != application.icon) {
            appIconSrc = tmp5(11269).getAppIconSrc(application.id, application.icon, application.bot);
            const tmp5Result2 = tmp5(11269);
          }
          if (null == instanceId) {
          ...
          if (tmp24) {
            application = tmp5(5650).fetchApplication(application.id);
            const tmp5Result3 = tmp5(5650);
          }
          ...
          obj2[0] = tmp5(11267).AppMessageEmbedDisplayType.DISPLAY;
          ...
          obj13 = application;
          obj8 = sortActivity;
          const tmp5Result1 = tmp5(11268);
          const obj3 = { applicationId: null, referrerId: null };
          obj3[0] = application.id;
          obj3[1] = id.getId();
          obj2[9] = tmp5(11438).getActivityLaunchURL(obj3);
          obj2[11] = items;
          obj2[12] = CodedLinkExtendedType.APP_MESSAGE_EMBED;
          const tmp5Result4 = tmp5(11438);
          obj2[13] = tmp5(11269).getAppGradientColors(appIconSrc);
          ...
          id = application.id;
          if (contentClassificationVisibility === tmp5(11266).ContentClassificationVisibility.BLOCK_UNDERAGE) {
          ...
          obj6[0] = tmp5(11267).AppMessageEmbedDisplayType.BLOCKED;
          obj6[1] = id;
          obj6[2] = message.id;
