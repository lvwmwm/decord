...
// Module 7944 (createVoiceChannelBadge)
      ...
      if (null != discoverableVoiceState) {
        ...
        if (null != channel) {
          ...
          if (null != uri) {
            ...
            if (result) {
              result = require(4346) /* shouldAgeVerifyForAgeGate */.shouldShowAgeGateForChannelId(channel.id);
            ...
            const obj7 = require(4346) /* shouldAgeVerifyForAgeGate */;
          }
