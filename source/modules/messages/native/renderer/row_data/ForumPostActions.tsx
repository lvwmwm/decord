...
// Dependencies: [676, 7726, 4142, 7729, 1208, 4134, 1236, 1945, 7730, 7731, 7732, 1416, 3828, 3834, 2]
// Exports: createDefaultReaction, createForumPostActions

// Module 7728 (createDefaultReaction)
  ...
  if (null != defaultReactionEmoji) {
    ...
    if (null != emojiId) {
      if (null != customGuildEmoji) {
        ...
        obj = { id: null, name: "a", animated: 0, src: 0, displayName: null };
        obj[0] = emojiId;
...
export const createForumPostActions = function createForumPostActions(arg0) {
  ...
  const getAssetUriForEmbed = require(7726) /* frozen */.getAssetUriForEmbed;
  if (isFollowing) {
    let assetUriForEmbed = getAssetUriForEmbed(tmp4(4142));
    let tmp6 = tmp4;
    let tmp8 = tmp;
  } else {
    assetUriForEmbed = getAssetUriForEmbed(tmp4(7729));
    tmp6 = tmp4;
    tmp8 = tmp;
  }
  if (null != assetUriForEmbed) {
    let tmp8Result = tmp8(7726);
    let stringResult;
    ...
    if (showMediaPostSharePrompt) {
      ...
      tmp8Result = tmp8(7726);
      obj[3] = tmp8Result.getAssetUriForEmbed(tmp6(7730));
      obj[4] = tmp8(7726).getAssetUriForEmbed(tmp6(7731));
      tmp14 = obj;
      const tmp8Result1 = tmp8(7726);
    }
    ...
    tmp6Result.captureMessage("Forum follow is null. isFollowing: " + isFollowing + " icon: " + tmp6(isFollowing ? 4142 : 7729));
  }
};
