...
// Dependencies: [676, 7837, 4208, 7840, 1208, 4200, 1236, 1945, 7841, 7842, 7843, 1416, 3894, 3900, 2]
// Exports: createDefaultReaction, createForumPostActions

// Module 7839 (createDefaultReaction)
...
export const createDefaultReaction = function createDefaultReaction(arg0) {
  ...
  let obj = require(7843) /* apexExperiment */;
  ...
  if (null != defaultReactionEmoji) {
    ...
    if (null != emojiId) {
      if (null != customGuildEmoji) {
        ...
        obj = { id: null, name: "a", animated: true, src: true, displayName: true };
        obj[0] = emojiId;
...
export const createForumPostActions = function createForumPostActions(arg0) {
  ...
  const getAssetUriForEmbed = require(7837) /* frozen */.getAssetUriForEmbed;
  if (isFollowing) {
    let assetUriForEmbed = getAssetUriForEmbed(tmp4(4208));
    let tmp6 = tmp4;
    let tmp8 = tmp;
  } else {
    assetUriForEmbed = getAssetUriForEmbed(tmp4(7840));
    tmp6 = tmp4;
    tmp8 = tmp;
  }
  if (null != assetUriForEmbed) {
    let tmp8Result = tmp8(7837);
    let stringResult;
    ...
    if (showMediaPostSharePrompt) {
      ...
      tmp8Result = tmp8(7837);
      obj[3] = tmp8Result.getAssetUriForEmbed(tmp6(7841));
      obj[4] = tmp8(7837).getAssetUriForEmbed(tmp6(7842));
      tmp14 = obj;
      const tmp8Result1 = tmp8(7837);
    }
    ...
    tmp6Result.captureMessage("Forum follow is null. isFollowing: " + isFollowing + " icon: " + tmp6(isFollowing ? 4208 : 7840));
  }
};
