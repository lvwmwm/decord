...
// Dependencies: [676, 7865, 4238, 7868, 1208, 4230, 1236, 1945, 7869, 7870, 7871, 1416, 3924, 3930, 2]
// Exports: createDefaultReaction, createForumPostActions

// Module 7867 (createDefaultReaction)
  ...
  if (null != defaultReactionEmoji) {
    ...
    if (null != emojiId) {
      if (null != customGuildEmoji) {
        ...
        obj = { id: null, name: "a", animated: "t", src: "a", displayName: "isArray" };
        obj[0] = emojiId;
