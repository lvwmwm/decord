...
// Dependencies: [676, 7978, 4238, 7981, 1208, 4230, 1236, 1974, 7982, 7983, 7984, 1416, 3923, 3929, 2]
// Exports: createDefaultReaction, createForumPostActions

// Module 7980 (createDefaultReaction)
...
export const createDefaultReaction = function createDefaultReaction(arg0) {
  ...
  let obj = require(7984) /* apexExperiment */;
...
export const createForumPostActions = function createForumPostActions(arg0) {
  ...
  const getAssetUriForEmbed = require(7978) /* frozen */.getAssetUriForEmbed;
  if (isFollowing) {
    let assetUriForEmbed = getAssetUriForEmbed(tmp4(4238));
    let tmp6 = tmp4;
    let tmp8 = tmp;
  } else {
    assetUriForEmbed = getAssetUriForEmbed(tmp4(7981));
    tmp6 = tmp4;
    tmp8 = tmp;
  }
  if (null != assetUriForEmbed) {
    let tmp8Result = tmp8(7978);
    let stringResult;
    ...
    if (showMediaPostSharePrompt) {
      ...
      tmp8Result = tmp8(7978);
      obj[3] = tmp8Result.getAssetUriForEmbed(tmp6(7982));
      obj[4] = tmp8(7978).getAssetUriForEmbed(tmp6(7983));
      tmp14 = obj;
      const tmp8Result1 = tmp8(7978);
    }
    ...
    tmp6Result.captureMessage("Forum follow is null. isFollowing: " + isFollowing + " icon: " + tmp6(isFollowing ? 4238 : 7981));
  }
};
