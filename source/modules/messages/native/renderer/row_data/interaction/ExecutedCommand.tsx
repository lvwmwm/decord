...
// Dependencies: [17, 1911, 1372, 1903, 676, 1419, 1416, 4530, 8276, 712, 6920, 1935, 8010, 8277, 1236, 8278, 2]
// Exports: createExecutedCommand

// Module 8275 (createExecutedCommand)
...
export const createExecutedCommand = function createExecutedCommand(message, channel, roleStyle, theme, defaultUsernameColor) {
  ...
  if (null != message.interaction) {
    ...
    if (null == user1) {
      let obj4 = require(8276) /* canViewInteractionInfo */;
      const result = obj4.isPrimaryEntryPointCommandMessage(message);
      let obj5 = require(4530) /* useNullableMessageAuthor */;
      ...
      let obj6 = require(6920) /* buildCommand */;
      ...
      const result2 = require(8010) /* processColorStrings */.isNativeMessageEligibleForEnhancedRoleColors(guildId, id1);
      if (result1) {
        processColorStringsResult = tmp17(8010).processColorStrings(userAuthor.colorStrings);
        const tmp17Result2 = tmp17(8010);
      }
      let processColorStringsResult1 = null;
      if (result2) {
        processColorStringsResult1 = tmp17(8010).processColorStrings(userAuthor1.colorStrings);
        const tmp17Result3 = tmp17(8010);
      }
      ...
      const tmp17Result1 = require(8010) /* processColorStrings */;
      obj[0] = require(4530) /* useNullableMessageAuthor */.getUserAuthor(message.interaction.user, channel).nick;
      ...
      if (tmp) {
        if (!result) {
          const result3 = tmp17(8277).isActivitiesInTextEnabled(channel);
      ...
      if (result) {
        result4 = tmp17(8278).formatPrimaryEntryPointCommandName(displayName);
        const tmp17Result6 = tmp17(8278);
      }
      ...
      if (null != tmp25) {
        ...
        obj9.targetUsername = tmp17(4530).getUserAuthor(tmp25, channel).nick;
        let id2;
        if (tmp25 != null) {
          id2 = tmp25.id;
        }
        ...
        const tmp17Result7 = tmp17(4530);
        const tmp67 = colorString2;
      }
      const tmp17Result4 = require(4530) /* useNullableMessageAuthor */;
      ...
      obj2 = require(4530) /* useNullableMessageAuthor */;
