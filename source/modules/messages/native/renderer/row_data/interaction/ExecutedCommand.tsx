...
// Dependencies: [17, 1930, 1391, 1922, 676, 1438, 1435, 4573, 8384, 712, 7028, 1954, 8115, 8385, 1236, 8386, 2]
// Exports: createExecutedCommand

// Module 8383 (createExecutedCommand)
...
export const createExecutedCommand = function createExecutedCommand(message, channel, roleStyle, theme, defaultUsernameColor) {
  ...
  if (null != message.interaction) {
    ...
    if (null == user1) {
      let obj4 = require(8384) /* canViewInteractionInfo */;
      const result = obj4.isPrimaryEntryPointCommandMessage(message);
      let obj5 = require(4573) /* useNullableMessageAuthor */;
      ...
      let obj6 = require(7028) /* buildCommand */;
      ...
      const result2 = require(8115) /* processColorStrings */.isNativeMessageEligibleForEnhancedRoleColors(guildId, id1);
      if (result1) {
        processColorStringsResult = tmp17(8115).processColorStrings(userAuthor.colorStrings);
        const tmp17Result2 = tmp17(8115);
      }
      let processColorStringsResult1 = null;
      if (result2) {
        processColorStringsResult1 = tmp17(8115).processColorStrings(userAuthor1.colorStrings);
        const tmp17Result3 = tmp17(8115);
      }
      ...
      const tmp17Result1 = require(8115) /* processColorStrings */;
      obj[0] = require(4573) /* useNullableMessageAuthor */.getUserAuthor(message.interaction.user, channel).nick;
      ...
      if (tmp) {
        if (!result) {
          const result3 = tmp17(8385).isActivitiesInTextEnabled(channel);
      ...
      if (result) {
        result4 = tmp17(8386).formatPrimaryEntryPointCommandName(displayName);
        const tmp17Result6 = tmp17(8386);
      }
      ...
      if (null != tmp25) {
        ...
        obj9.targetUsername = tmp17(4573).getUserAuthor(tmp25, channel).nick;
        let id2;
        if (tmp25 != null) {
          id2 = tmp25.id;
        }
        ...
        const tmp17Result7 = tmp17(4573);
        const tmp67 = colorString2;
      }
      const tmp17Result4 = require(4573) /* useNullableMessageAuthor */;
      ...
      obj2 = require(4573) /* useNullableMessageAuthor */;
