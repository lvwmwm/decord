...
// Dependencies: [17, 1882, 1372, 1874, 676, 1419, 1416, 4484, 8135, 712, 6877, 1906, 7868, 8136, 1236, 8137, 2]
// Exports: createExecutedCommand

// Module 8134 (createExecutedCommand)
...
export const createExecutedCommand = function createExecutedCommand(message, channel, roleStyle, theme, defaultUsernameColor) {
  ...
  if (null != message.interaction) {
    ...
    if (null == user1) {
      let obj4 = require(8135) /* canViewInteractionInfo */;
      const result = obj4.isPrimaryEntryPointCommandMessage(message);
      let obj5 = require(4484) /* useNullableMessageAuthor */;
      ...
      let obj6 = require(6877) /* buildCommand */;
      ...
      const result2 = require(7868) /* processColorStrings */.isNativeMessageEligibleForEnhancedRoleColors(guildId, id1);
      if (result1) {
        processColorStringsResult = tmp17(7868).processColorStrings(userAuthor.colorStrings);
        const tmp17Result2 = tmp17(7868);
      }
      let processColorStringsResult1 = null;
      if (result2) {
        processColorStringsResult1 = tmp17(7868).processColorStrings(userAuthor1.colorStrings);
        const tmp17Result3 = tmp17(7868);
      }
      ...
      const tmp17Result1 = require(7868) /* processColorStrings */;
      obj[0] = require(4484) /* useNullableMessageAuthor */.getUserAuthor(message.interaction.user, channel).nick;
      ...
      if (tmp) {
        if (!result) {
          const result3 = tmp17(8136).isActivitiesInTextEnabled(channel);
      ...
      if (result) {
        result4 = tmp17(8137).formatPrimaryEntryPointCommandName(displayName);
        const tmp17Result6 = tmp17(8137);
      }
      ...
      if (null != tmp25) {
        ...
        obj9.targetUsername = tmp17(4484).getUserAuthor(tmp25, channel).nick;
        let id2;
        if (tmp25 != null) {
          id2 = tmp25.id;
        }
        ...
        const tmp17Result7 = tmp17(4484);
        const tmp67 = colorString2;
      }
      const tmp17Result4 = require(4484) /* useNullableMessageAuthor */;
      ...
      obj2 = require(4484) /* useNullableMessageAuthor */;
