...
// Dependencies: [17, 1882, 1372, 1874, 676, 1419, 1416, 4513, 8147, 712, 6889, 1906, 7880, 8148, 1236, 8149, 2]
// Exports: createExecutedCommand

// Module 8146 (createExecutedCommand)
...
export const createExecutedCommand = function createExecutedCommand(message, channel, roleStyle, theme, defaultUsernameColor) {
  ...
  if (null != message.interaction) {
    ...
    if (null == user1) {
      let obj4 = require(8147) /* canViewInteractionInfo */;
      ...
      let obj6 = require(6889) /* buildCommand */;
      ...
      const result2 = require(7880) /* processColorStrings */.isNativeMessageEligibleForEnhancedRoleColors(guildId, id1);
      if (result1) {
      ...
      if (result2) {
        processColorStringsResult1 = tmp17(7880).processColorStrings(userAuthor1.colorStrings);
        const tmp17Result3 = tmp17(7880);
      }
      ...
      const tmp17Result1 = require(7880) /* processColorStrings */;
      ...
      if (tmp) {
        if (!result) {
          const result3 = tmp17(8148).isActivitiesInTextEnabled(channel);
      ...
      if (result) {
        result4 = tmp17(8149).formatPrimaryEntryPointCommandName(displayName);
        const tmp17Result6 = tmp17(8149);
      }
