...
// Dependencies: [8263, 1236, 2]
// Exports: createInteractionStatus

// Module 8360 (createInteractionStatus)
...
export const createInteractionStatus = function createInteractionStatus(message, interaction) {
  let obj = require(8263) /* _executeMessageComponentInteraction */;
  const interactionStatusViewState = obj.getInteractionStatusViewState(message, interaction);
  if (require(8263) /* _executeMessageComponentInteraction */.InteractionStatusViewState.SENDING === interactionStatusViewState) {
