...
// Dependencies: [7836, 1212, 2]
// Exports: createInteractionStatus

// Module 7930 (createInteractionStatus)
...
export const createInteractionStatus = function createInteractionStatus(message, interaction) {
  let obj = require(7836) /* _createForOfIteratorHelperLoose */;
  const interactionStatusViewState = obj.getInteractionStatusViewState(message, interaction);
  if (require(7836) /* _createForOfIteratorHelperLoose */.InteractionStatusViewState.SENDING === interactionStatusViewState) {
    obj = {};
    const intl4 = require(1212) /* getSystemLocale */.intl;
    obj.text = intl4.string(require(1212) /* getSystemLocale */.t.RiLfBY);
    obj.state = constants.LOADING;
    return obj;
  } else if (require(7836) /* _createForOfIteratorHelperLoose */.InteractionStatusViewState.CREATED === interactionStatusViewState) {
    obj = {};
    ...
    obj.state = constants.LOADING;
    return obj;
  } else if (require(7836) /* _createForOfIteratorHelperLoose */.InteractionStatusViewState.TIMED_OUT === interactionStatusViewState) {
    const obj2 = {};
    const intl2 = require(1212) /* getSystemLocale */.intl;
    obj2.text = intl2.string(require(1212) /* getSystemLocale */.t.h8hzPd);
    obj2.state = constants.FAILED;
    return obj2;
  } else if (require(7836) /* _createForOfIteratorHelperLoose */.InteractionStatusViewState.FAILED === interactionStatusViewState) {
    const obj3 = {};
    ...
    return obj3;
  } else if (require(7836) /* _createForOfIteratorHelperLoose */.InteractionStatusViewState.EPHEMERAL_SUCCESS === interactionStatusViewState) {
