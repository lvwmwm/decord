...
// Dependencies: [5835, 11040, 4348, 1212, 2]
// Exports: createCtaButton

// Module 12326 (createCtaButton)
...
export const createCtaButton = function createCtaButton(id, channel_id, arg2) {
  let obj = require(11040) /* CtaButtonType */;
  ...
  const result = require(4348) /* isReactiveCheckEnabled */.shouldShowTiggerPawtect();
  if (require(11040) /* CtaButtonType */.CtaButtonType.MARK_AS_FALSE_POSITIVE === ctaButtonType) {
    obj = {};
    ...
    if (_isNativeReflectConstruct.canSubmitFpReport(id)) {
      prop = require(11040) /* CtaButtonType */.CtaButtonType.MARK_AS_FALSE_POSITIVE;
    }
    obj.callback = prop;
    return obj;
  } else if (require(11040) /* CtaButtonType */.CtaButtonType.AGE_VERIFICATION_RETRY === ctaButtonType) {
    obj = {};
    ...
    let prop1;
    if (result) {
      prop1 = require(11040) /* CtaButtonType */.CtaButtonType.AGE_VERIFICATION_RETRY;
    }
    obj.callback = prop1;
    return obj;
  } else if (require(11040) /* CtaButtonType */.CtaButtonType.CONNECT_TO_TEEN === ctaButtonType) {
    obj1 = {};
    ...
    obj1.callback = require(11040) /* CtaButtonType */.CtaButtonType.CONNECT_TO_TEEN;
    return obj1;
  }
  const obj3 = require(4348) /* isReactiveCheckEnabled */;
};
