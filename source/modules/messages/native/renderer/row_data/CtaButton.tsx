...
// Dependencies: [5671, 11083, 4347, 1212, 2]
// Exports: createCtaButton

// Module 12349 (createCtaButton)
...
export const createCtaButton = function createCtaButton(id, channel_id, arg2) {
  let obj = require(11083) /* CtaButtonType */;
  ...
  if (require(11083) /* CtaButtonType */.CtaButtonType.MARK_AS_FALSE_POSITIVE === ctaButtonType) {
    obj = {};
    ...
    if (_isNativeReflectConstruct.canSubmitFpReport(id)) {
      prop = require(11083) /* CtaButtonType */.CtaButtonType.MARK_AS_FALSE_POSITIVE;
    }
    obj.callback = prop;
    return obj;
  } else if (require(11083) /* CtaButtonType */.CtaButtonType.AGE_VERIFICATION_RETRY === ctaButtonType) {
    obj = {};
    ...
    let prop1;
    if (result) {
      prop1 = require(11083) /* CtaButtonType */.CtaButtonType.AGE_VERIFICATION_RETRY;
    }
    obj.callback = prop1;
    return obj;
  } else if (require(11083) /* CtaButtonType */.CtaButtonType.CONNECT_TO_TEEN === ctaButtonType) {
    obj1 = {};
    ...
    obj1.callback = require(11083) /* CtaButtonType */.CtaButtonType.CONNECT_TO_TEEN;
    return obj1;
  }
