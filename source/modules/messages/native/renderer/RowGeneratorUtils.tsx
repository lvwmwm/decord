...
// Dependencies: [17, 4336, 1391, 1910, 4337, 8083, 676, 4344, 4193, 712, 5926, 4563, 1492, 2]

// Module 8254 (nativeStyleProperties)
...
const result = createCacheKey.experimental_createToken(() => require(4193) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.BRAND_500, 0.1));
  ...
  createBackgroundHighlight(message) {
    ...
    if (isEditing) {
      ...
      if (message.hasFlag(constants.IS_GUILD_OFFICIAL)) {
        obj = require(5926) /* useCanManageGuildOfficialMessages */;
      ...
      if (message.mentioned) {
        ...
        obj2 = require(4563) /* createMinimalMessageRecord */;
