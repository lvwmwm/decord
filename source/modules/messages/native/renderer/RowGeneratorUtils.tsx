...
// Dependencies: [17, 4277, 1372, 1891, 4278, 7965, 676, 4285, 4128, 712, 5808, 4504, 1473, 2]

// Module 8134 (nativeStyleProperties)
...
const result = createCacheKey.experimental_createToken(() => require(4128) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.BRAND_500, 0.1));
  ...
  createBackgroundHighlight(message) {
    ...
    if (isEditing) {
      ...
      if (message.hasFlag(constants.IS_GUILD_OFFICIAL)) {
        obj = require(5808) /* useCanManageGuildOfficialMessages */;
      ...
      if (message.mentioned) {
        ...
        obj2 = require(4504) /* createMinimalMessageRecord */;
