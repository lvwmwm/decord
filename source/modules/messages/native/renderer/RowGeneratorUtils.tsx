...
// Dependencies: [17, 4247, 1372, 1862, 4248, 7824, 676, 4255, 4099, 712, 5781, 4474, 1473, 2]

// Module 7993 (nativeStyleProperties)
  ...
  createBackgroundHighlight(message) {
    ...
    if (isEditing) {
      ...
      if (message.hasFlag(constants.IS_GUILD_OFFICIAL)) {
        obj = require(5781) /* useCanManageGuildOfficialMessages */;
      ...
      if (message.mentioned) {
        ...
        obj2 = require(4474) /* createMinimalMessageRecord */;
