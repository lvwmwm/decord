...
// Dependencies: [17, 4247, 1372, 1862, 4248, 7840, 676, 4255, 4099, 712, 5767, 4475, 1473, 2]

// Module 8009 (nativeStyleProperties)
...
const result = createCacheKey.experimental_createToken(() => require(4099) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.BRAND_500, 0.1));
  ...
  createBackgroundHighlight(message) {
    ...
    if (isEditing) {
      ...
      if (message.hasFlag(constants.IS_GUILD_OFFICIAL)) {
        obj = require(5767) /* useCanManageGuildOfficialMessages */;
      ...
      if (message.mentioned) {
        ...
        obj2 = require(4475) /* createMinimalMessageRecord */;
