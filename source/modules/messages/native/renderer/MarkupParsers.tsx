...
export const parseEmbedTitleMarkup = function parseEmbedTitleMarkup(rawName, closure_0) {
  ...
  if (null == value) {
    obj = { channelId: null };
    obj[0] = closure_0;
    const parseEmbedTitleToASTResult = importDefault(4293).parseEmbedTitleToAST(rawName, true, obj);
    const result = obj.set(combined, parseEmbedTitleToASTResult);
    value = parseEmbedTitleToASTResult;
    const obj2 = importDefault(4293);
  }
  return value;
};
export const parseEmbedTitleMarkupWithoutLinks = function parseEmbedTitleMarkupWithoutLinks(arg0, arg1) {
  ...
  if (null == value) {
    obj = { channelId: null };
    obj[0] = arg1;
    const result = importDefault(4293).parseEmbedTitleWithoutLinksToAST(arg0, true, obj);
...
export const parseEmbedDescriptionMarkup = function parseEmbedDescriptionMarkup(arg0) {
  ...
  const parseToASTResult = importDefault(4293).parseToAST(tmp4, true, obj);
...
export const parseMessageMarkup = function parseMessageMarkup(message, message2, forceHideSimpleEmbedContent, isInlineReplyPreview, arg4, result, result2) {
  ...
  if (message.type !== MessageTypes.CHANGELOG) {
    ...
    obj[6] = flag3;
    obj[7] = flag3;
    const merged = Object.assign(require(8205) /* getInitialParserState */.renderMessageMarkupToAST(message, obj));
    obj.isInlineReplyPreview = flag;
    result = obj1.set(message, obj);
    const obj3 = require(8205) /* getInitialParserState */;
  }
  const obj6 = importDefault(4293);
  ...
  flag = flag2;
  const obj7 = require(8192) /* LHeading */;
  if (!flag2) {
    flag = obj;
  }
  obj1[2] = flag;
  ...
  obj = { content: obj6.astParserFor(require(8192) /* LHeading */.changelogRules(message.changelogId, true))(message.content, false, obj1), isInlineReplyPreview: false, hasSpoilerEmbeds: false, hasBailedAst: false };
  obj1[3] = flag2;
  obj1[4] = flag3;
  obj1[5] = flag3;
