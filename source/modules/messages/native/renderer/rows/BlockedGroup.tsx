...
// Dependencies: [7840, 505, 12, 4101, 712, 4099, 7843, 2]
// Exports: generateBlockedGroupRowData

// Module 7842 (generateBlockedGroupRowData)
...
let closure_5 = apply.memoize((arg0) => {
  ...
  obj[0] = require(7843) /* processColorOrThrow */.processColorOrThrow(str);
  const tmpResult2 = require(7843) /* processColorOrThrow */;
  obj[1] = require(7843) /* processColorOrThrow */.processColorOrThrow(str2);
  const tmpResult3 = require(7843) /* processColorOrThrow */;
  obj[2] = require(7843) /* processColorOrThrow */.processColorOrThrow(GREY1);
  return obj;
});
