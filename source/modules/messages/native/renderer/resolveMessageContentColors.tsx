...
const result = createCacheKey.experimental_createToken((theme) => {
  ...
  return require(4153) /* AccessibilityAnnouncer */.isThemeDark(theme.theme) ? unsafe_rawColors.PRIMARY_300 : unsafe_rawColors.PRIMARY_630;
});
