...
// Dependencies: [1372, 1903, 8069, 8071, 4303, 712, 1236, 8055, 8175, 8072, 2]
// Exports: createFriendRequestAcceptedSystemMessage

// Module 8174 (createFriendRequestAcceptedSystemMessage)
...
export const createFriendRequestAcceptedSystemMessage = function createFriendRequestAcceptedSystemMessage(message) {
  ...
  if (null != channel) {
    if (channel.isDM()) {
      ...
      if (null != user) {
        if (null != currentUser) {
          let colorString = require(8069) /* getMessageAuthorWithProcessedColor */.getUserAuthorWithProcessedColor(user, channel);
          ...
          obj4[1] = tmp15Result.getAssetUriForEmbed(importDefault(8175));
          obj4[2] = undefined;
