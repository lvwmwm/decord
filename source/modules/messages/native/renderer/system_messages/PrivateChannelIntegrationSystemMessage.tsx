...
// Dependencies: [676, 7992, 7994, 8026, 7995, 2]
// Exports: createPrivateChannelIntegrationSystemMessage

// Module 8061 (createPrivateChannelIntegrationSystemMessage)
...
export const createPrivateChannelIntegrationSystemMessage = function createPrivateChannelIntegrationSystemMessage(roleStyle, type) {
  ...
  const tmp5 = importDefault(7994)({ message, author: messageAuthorWithProcessedColor, roleStyle: roleStyle.roleStyle });
