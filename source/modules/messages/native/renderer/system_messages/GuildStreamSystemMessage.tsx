...
// Dependencies: [4409, 8153, 8135, 8137, 1236, 8138, 2]
// Exports: createGuildStreamSystemMessage

// Module 8180 (createGuildStreamSystemMessage)
...
export const createGuildStreamSystemMessage = function createGuildStreamSystemMessage(roleStyle) {
  ...
  let obj = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: importDefault(8137)({ message, author: messageAuthorWithProcessedColor, roleStyle: roleStyle.roleStyle }) };
  ...
  const merged2 = Object.assign(importDefault(8138)(roleStyle));
  return obj1;
};
