...
// Dependencies: [1348, 1838, 653, 7720, 7744, 7756, 7757, 7760, 1212, 7722, 7723, 2]
// Exports: createUserJoinSystemMessage

// Module 7743 (createUserJoinSystemMessage)
...
export const createUserJoinSystemMessage = function createUserJoinSystemMessage(roleStyle) {
  ...
  let guildId;
  const systemMessageUserJoinMobile = importDefault(7744).getSystemMessageUserJoinMobile(message.id);
  if (null != channel) {
  ...
  if (null != guildId) {
    if (null != channel) {
      ...
      const obj4 = require(7756) /* computeIsStickerReplyEnabled */;
      if (obj4.computeIsStickerReplyEnabled(guildId, channel, message, tmp7)) {
        const obj5 = require(7757) /* transform */;
        transformStickerResult = obj5.transformSticker(require(7760) /* pickHelloSticker */.pickWelcomeSticker(message.id));
        const obj6 = require(7760) /* pickHelloSticker */;
      }
    }
  }
  obj = {};
