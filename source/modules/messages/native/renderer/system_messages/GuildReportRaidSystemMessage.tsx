...
// Dependencies: [1372, 1862, 7733, 7740, 7811, 7742, 7812, 7743, 1236, 1419, 1416, 2]
// Exports: createGuildReportRaidSystemMessage

// Module 7818 (createGuildReportRaidSystemMessage)
...
export const createGuildReportRaidSystemMessage = function createGuildReportRaidSystemMessage(roleStyle) {
  ...
  let automodUsernameColor = require(7811) /* nativeStyleProperties */.resolveAlertModeColors(theme).automodUsernameColor;
  obj = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: tmp(7742)({ message, author: messageAuthorWithProcessedColor, roleStyle: roleStyle.roleStyle }), guildName: null };
  let str;
  if (guild != null) {
    str = guild.name;
  }
  ...
  obj[2] = str;
  const obj2 = require(7811) /* nativeStyleProperties */;
  obj = {};
  ...
  const tmp11 = importDefault(7812)({ message, channel, isSystemDM: true, colors: tmp3 });
