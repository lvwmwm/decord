...
// Dependencies: [1391, 1910, 8103, 8110, 8180, 8112, 8181, 8113, 1236, 1438, 1435, 2]
// Exports: createGuildReportRaidSystemMessage

// Module 8187 (createGuildReportRaidSystemMessage)
...
export const createGuildReportRaidSystemMessage = function createGuildReportRaidSystemMessage(roleStyle) {
  ...
  const tmp11 = importDefault(8181)({ message, channel, isSystemDM: true, colors: tmp3 });
