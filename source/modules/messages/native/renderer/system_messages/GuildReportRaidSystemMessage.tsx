...
// Dependencies: [1348, 1838, 7713, 7720, 7791, 7722, 7792, 7723, 1212, 1395, 1392, 2]
// Exports: createGuildReportRaidSystemMessage

// Module 7798 (createGuildReportRaidSystemMessage)
...
export const createGuildReportRaidSystemMessage = function createGuildReportRaidSystemMessage(roleStyle) {
  ...
  const tmp8 = importDefault(7792)({ message, channel, isSystemDM: true, colors: tmp });
