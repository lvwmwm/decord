...
// Dependencies: [1372, 1862, 7736, 7743, 7814, 7745, 7815, 7746, 1236, 1419, 1416, 2]
// Exports: createGuildReportRaidSystemMessage

// Module 7821 (createGuildReportRaidSystemMessage)
...
export const createGuildReportRaidSystemMessage = function createGuildReportRaidSystemMessage(roleStyle) {
  ...
  let automodUsernameColor = require(7814) /* nativeStyleProperties */.resolveAlertModeColors(theme).automodUsernameColor;
  obj = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: tmp(7745)({ message, author: messageAuthorWithProcessedColor, roleStyle: roleStyle.roleStyle }), guildName: null };
  let str;
  if (guild != null) {
    str = guild.name;
  }
  ...
  obj[2] = str;
  const obj2 = require(7814) /* nativeStyleProperties */;
  obj = {};
  ...
  const tmp11 = importDefault(7815)({ message, channel, isSystemDM: true, colors: tmp3 });
