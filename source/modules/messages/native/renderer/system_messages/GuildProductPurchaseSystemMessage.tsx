...
// Dependencies: [3999, 1391, 676, 4573, 8114, 1438, 1435, 8146, 8116, 1236, 8117, 2]
// Exports: createGuildProductPurchaseSystemMessage

// Module 8176 (createGuildProductPurchaseSystemMessage)
...
export const createGuildProductPurchaseSystemMessage = function createGuildProductPurchaseSystemMessage(message) {
  ...
  if (null == product_name) {
    ...
    let obj1 = require(4573) /* useNullableMessageAuthor */;
    const guildMemberAvatar = obj1.getMessageAuthor(message).guildMemberAvatar;
    let obj2 = require(8114) /* getMessageAuthorWithProcessedColor */;
    ...
    if (null != guildMemberAvatar) {
      ...
      obj1[1] = importDefault(8116)(obj2);
      obj1[2] = product_name;
      ...
      const merged1 = Object.assign(importDefault(8117)(obj));
      return obj;
    }
