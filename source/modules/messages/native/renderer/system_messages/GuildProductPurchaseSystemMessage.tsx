...
// Dependencies: [3803, 1348, 653, 4395, 7720, 1395, 1392, 7753, 7722, 1212, 7723, 2]
// Exports: createGuildProductPurchaseSystemMessage

// Module 7783 (createGuildProductPurchaseSystemMessage)
...
export const createGuildProductPurchaseSystemMessage = function createGuildProductPurchaseSystemMessage(message) {
  ...
  if (null == product_name) {
    ...
    let obj2 = require(7720) /* getMessageAuthorWithProcessedColor */;
    ...
    if (null != guildMemberAvatar) {
      ...
      obj1.usernameOnClickHandler = importDefault(7722)(obj2);
      obj1.productName = product_name;
      obj.content = require(7753) /* getGuildProductPurchaseSystemMessageContentMobile */.getGuildProductPurchaseSystemMessageContentMobile(obj1);
      ...
      const merged1 = Object.assign(importDefault(7723)(obj));
      return obj;
    }
