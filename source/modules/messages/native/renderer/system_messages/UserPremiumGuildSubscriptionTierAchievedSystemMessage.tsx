...
// Dependencies: [1348, 1838, 7762, 7763, 7720, 7722, 1212, 4057, 7723, 2]
// Exports: createUserPremiumGuildSubscriptionTierAchievedSystemMessage

// Module 7764 (createUserPremiumGuildSubscriptionTierAchievedSystemMessage)
...
export const createUserPremiumGuildSubscriptionTierAchievedSystemMessage = function createUserPremiumGuildSubscriptionTierAchievedSystemMessage(message, TIER_1) {
  ...
  if (null == channel) {
    ...
    if (null == guild) {
      ...
      const tmp18 = importDefault(7763)(message);
      ...
      const tmp21 = importDefault(7722)(obj);
      obj = {};
      if (tmp18 > 1) {
        const intl2 = require(1212) /* getSystemLocale */.intl;
        const obj1 = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: tmp21, guildName: guild.name, newTierName: require(4057) /* _createForOfIteratorHelperLoose */.getTierName(TIER_1), numSubscriptions: tmp18 };
        let formatToPartsResult = intl2.formatToParts(require(1212) /* getSystemLocale */.t.GjNvr7, obj1);
        const obj5 = require(4057) /* _createForOfIteratorHelperLoose */;
      } else {
        const intl = require(1212) /* getSystemLocale */.intl;
        let obj2 = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: tmp21, guildName: guild.name };
        obj2 = require(4057) /* _createForOfIteratorHelperLoose */;
