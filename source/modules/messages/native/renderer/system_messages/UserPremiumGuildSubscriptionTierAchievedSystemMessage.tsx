...
// Dependencies: [1391, 1910, 8151, 8152, 8110, 8112, 1236, 4236, 8113, 2]
// Exports: createUserPremiumGuildSubscriptionTierAchievedSystemMessage

// Module 8153 (createUserPremiumGuildSubscriptionTierAchievedSystemMessage)
...
export const createUserPremiumGuildSubscriptionTierAchievedSystemMessage = function createUserPremiumGuildSubscriptionTierAchievedSystemMessage(message, TIER_1) {
  ...
  if (null == channel) {
    ...
    if (null == guild) {
      ...
      const tmp13 = importDefault(8152)(message);
      const messageAuthorWithProcessedColor = require(8110) /* getMessageAuthorWithProcessedColor */.getMessageAuthorWithProcessedColor(message);
      let obj = { message: null, author: null, roleStyle: null };
      obj[0] = message;
      obj[1] = messageAuthorWithProcessedColor;
      obj[2] = message.roleStyle;
      const tmp16 = importDefault(8112)(obj);
      if (tmp13 > 1) {
