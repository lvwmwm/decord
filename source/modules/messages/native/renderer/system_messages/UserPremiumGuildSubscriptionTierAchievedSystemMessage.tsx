...
// Dependencies: [1372, 1891, 8050, 8051, 8009, 8011, 1236, 4194, 8012, 2]
// Exports: createUserPremiumGuildSubscriptionTierAchievedSystemMessage

// Module 8052 (createUserPremiumGuildSubscriptionTierAchievedSystemMessage)
...
export const createUserPremiumGuildSubscriptionTierAchievedSystemMessage = function createUserPremiumGuildSubscriptionTierAchievedSystemMessage(message, TIER_1) {
  ...
  if (null == channel) {
    ...
    if (null == guild) {
      ...
      const tmp13 = importDefault(8051)(message);
      const messageAuthorWithProcessedColor = require(8009) /* getMessageAuthorWithProcessedColor */.getMessageAuthorWithProcessedColor(message);
      let obj = { message: null, author: null, roleStyle: null };
      obj[0] = message;
      obj[1] = messageAuthorWithProcessedColor;
      obj[2] = message.roleStyle;
      const tmp16 = importDefault(8011)(obj);
      if (tmp13 > 1) {
