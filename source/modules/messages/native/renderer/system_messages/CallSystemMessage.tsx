...
// Dependencies: [4268, 1218, 4271, 676, 4273, 7869, 7870, 1236, 1419, 3925, 7854, 2]
// Exports: createCallSystemMessage

// Module 7868 (createCallSystemMessage)
...
export const createCallSystemMessage = function createCallSystemMessage(message) {
  ...
  const tmp6 = importDefault(7869)(message);
  participants = participants.getParticipants(channelId);
  let obj = require(7870) /* useIsCallActive */;
