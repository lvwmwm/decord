...
// Dependencies: [7992, 7994, 1236, 7995, 7998, 2]
// Exports: createChannelPinnedMessageSystemMessage

// Module 8014 (createChannelPinnedMessageSystemMessage)
...
export const createChannelPinnedMessageSystemMessage = function createChannelPinnedMessageSystemMessage(roleStyle) {
  ...
  obj = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: importDefault(7994)({ message, author: messageAuthorWithProcessedColor, roleStyle: roleStyle.roleStyle }), pinsOnClick: obj };
  ...
  const tmp9 = importDefault(7995)(roleStyle);
  ...
  obj3[1] = require(7998) /* MessageAccessibilityAction */.MessageAccessibilityAction.OPEN_PINS;
  items.push(obj3);
  if (null != messageReference) {
    const obj4 = { label: null, name: null };
    const intl4 = tmp(1236).intl;
    obj4[0] = intl4.string(tmp(1236).t["+TSRGD"]);
    obj4[1] = tmp(7998).MessageAccessibilityAction.JUMP_TO_MESSAGE;
    items.push(obj4);
  }
