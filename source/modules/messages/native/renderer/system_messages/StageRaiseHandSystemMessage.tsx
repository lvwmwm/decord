...
// Dependencies: [5118, 1372, 3912, 676, 1236, 1974, 7992, 11, 4469, 7994, 7995, 2]
// Exports: createStageRaiseHandSystemMessage

// Module 8059 (createStageRaiseHandSystemMessage)
...
export const createStageRaiseHandSystemMessage = function createStageRaiseHandSystemMessage(roleStyle) {
  ...
  if (canResult) {
    ...
    canResult = rtsState === tmp(4469).RequestToSpeakStates.REQUESTED_TO_SPEAK;
  }
  if (canResult) {
  ...
  obj[3] = tmp10;
  const merged = Object.assign(tmp6(7995)(roleStyle));
  return obj;
};
