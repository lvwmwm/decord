...
// Dependencies: [1925, 8221, 8223, 1236, 1435, 4038, 8302, 8224, 2]
// Exports: createPollResultSystemMessage

// Module 8301 (createPollResultSystemMessage)
import set from "set" /* 2 */;
import set2 from "set" /* 1925 */;
import parsePollResultSystemMessageEmbedDefault from "parsePollResultSystemMessageEmbed" /* 8302 */;
...
export const createPollResultSystemMessage = function createPollResultSystemMessage(message) {
  ...
  if (null == tmp3) {
    ...
    const messageAuthorWithProcessedColor = obj6(8221).getMessageAuthorWithProcessedColor(message);
      ...
      if (null == tmp3.victorAnswerId) {
        ...
        if (null == id) {
          ...
          if (null != id.id) {
            ...
            obj[1] = tmp(4038).convertSurrogateToName(id.name, false);
            obj[2] = id.name;
            items.push(obj);
            const tmpResult1 = tmp(4038);
          }
    ...
    const obj10 = {};
    const merged3 = Object.assign(tmp(8224)(message));
