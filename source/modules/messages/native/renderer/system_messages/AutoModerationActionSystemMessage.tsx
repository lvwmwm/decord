...
// Module 7736 (createAutoModerationActionSystemMessage)
...
let closure_11 = apply.memoize((arg0) => {
  ...
  obj.defaultUsernameColor = require(7658) /* processColorOrThrow */.processColorOrThrow(tmp2);
  return obj;
});
...
export const createAutoModerationActionSystemMessage = function createAutoModerationActionSystemMessage(message) {
  ...
  let obj = require(5736) /* getEmbedFieldFromMessage */;
  if (obj.isAutomodMessageRecord(message)) {
    let obj1 = require(5736) /* getEmbedFieldFromMessage */;
    ...
    let obj5 = require(5736) /* getEmbedFieldFromMessage */;
    const result1 = obj5.isAutomodNotification(message);
    let tmp16 = stringResult;
    let tmp17 = null;
    if (result1) {
      let obj6 = require(5736) /* getEmbedFieldFromMessage */;
      let resolvedReason = obj6.extractAutomodNotificationFields(message);
      const notificationType = resolvedReason.notificationType;
      if (require(5736) /* getEmbedFieldFromMessage */.IS_BACKWARDS_COMPAT_RAID_TYPE !== notificationType) {
        let id = require;
        id = dependencyMap;
        if (require(7713) /* AutomodNotificationEmbedTypeKeys */.AutomodNotificationEmbedTypeKeys.RAID !== notificationType) {
          id = require;
          id = dependencyMap;
          if (require(7713) /* AutomodNotificationEmbedTypeKeys */.AutomodNotificationEmbedTypeKeys.MENTION_RAID === notificationType) {
            obj = {};
            let fromNowResult;
            if (null != resolvedReason.raidDatetime) {
              fromNowResult = importDefault(3713)(resolvedReason.raidDatetime).fromNow();
              const obj18 = importDefault(3713)(resolvedReason.raidDatetime);
            }
            ...
            obj.headerColor = require(7658) /* processColorOrThrow */.processColorOrThrow(internal3.resolveSemanticColor(theme, importDefault(689).colors.TEXT_FEEDBACK_CRITICAL));
            const obj19 = require(7658) /* processColorOrThrow */;
            obj.headerIconURL = closure_4.resolveAssetSource(require(1392) /* getAvatarURL */.makeSource(importDefault(6675))).uri;
            const obj20 = require(1392) /* getAvatarURL */;
            const internal4 = importDefault(689).internal;
            obj.headerIconColor = require(7658) /* processColorOrThrow */.processColorOrThrow(internal4.resolveSemanticColor(theme, importDefault(689).colors.TEXT_FEEDBACK_CRITICAL));
            ...
            tmp16 = stringResult;
            tmp17 = obj;
            const obj21 = require(7658) /* processColorOrThrow */;
          } else {
            id = require;
            id = dependencyMap;
            if (require(7713) /* AutomodNotificationEmbedTypeKeys */.AutomodNotificationEmbedTypeKeys.ACTIVITY_ALERTS_ENABLED === notificationType) {
              let obj7 = require(5736) /* getEmbedFieldFromMessage */;
              ...
              if (null != avatar) {
                ...
                let obj12 = require(7658) /* processColorOrThrow */;
                ...
                obj1.headerIconURL = closure_4.resolveAssetSource(obj13.makeSource(importDefault(7742))).uri;
                let obj14 = require(7658) /* processColorOrThrow */;
                ...
                obj1.subtitleRight = importDefault(3713)(message.timestamp).fromNow();
                ...
                tmp16 = stringResult;
                tmp17 = obj1;
                const obj16 = importDefault(3713)(message.timestamp);
              }
              ...
              obj2.headerColor = require(7658) /* processColorOrThrow */.processColorOrThrow(internal7.resolveSemanticColor(theme, importDefault(689).colors.TEXT_SUBTLE));
              id = closure_4;
              const obj49 = require(7658) /* processColorOrThrow */;
              obj2.headerIconURL = closure_4.resolveAssetSource(require(1392) /* getAvatarURL */.makeSource(importDefault(6675))).uri;
              const obj50 = require(1392) /* getAvatarURL */;
              const internal8 = importDefault(689).internal;
              obj2.headerIconColor = require(7658) /* processColorOrThrow */.processColorOrThrow(internal8.resolveSemanticColor(theme, importDefault(689).colors.TEXT_SUBTLE));
              ...
              tmp16 = stringResult;
              tmp17 = obj2;
              const obj51 = require(7658) /* processColorOrThrow */;
            }
          }
        }
      }
      let fromNowResult1;
      if (null != resolvedReason.raidDatetime) {
        fromNowResult1 = importDefault(3713)(resolvedReason.raidDatetime).fromNow();
        const obj22 = importDefault(3713)(resolvedReason.raidDatetime);
      }
      const tmp56 = resolvedReason.raidType === require(7737) /* AutomodRaidAlertTypes */.AutomodRaidAlertTypes.DM_RAID;
      let str2 = "";
      if (null != resolvedReason.raidDatetime) {
        const _Date = Date;
        const date = new Date(resolvedReason.raidDatetime);
        str2 = date.toLocaleString(require(1212) /* getSystemLocale */.intl.currentLocale, require(7738) /* hasDetectedRaid */.DATE_CONFIG);
      }
      ...
      obj5.headerColor = require(7658) /* processColorOrThrow */.processColorOrThrow(internal5.resolveSemanticColor(theme, importDefault(689).colors.TEXT_FEEDBACK_CRITICAL));
      let intl9 = closure_4;
      ...
      const obj27 = require(7658) /* processColorOrThrow */;
      tmp71 = importDefault;
      ...
      num19(num20);
      resolveAssetSource = require(5736) /* getEmbedFieldFromMessage */;
    ...
    if (null == guildId) {
      ...
      if (canResult) {
        if (null == quarantineType) {
          if (null != embedChannel) {
            ...
            id = user;
            id = closure_8;
            id = require(4321) /* computeDefaultGroupDmNameFromUserIds */.computeChannelName(embedChannel, user, closure_8);
            const obj41 = require(4321) /* computeDefaultGroupDmNameFromUserIds */;
          }
        }
      }
      ...
      obj11.communicationDisabled = require(3748) /* isCommunicationDisabled */.isMemberCommunicationDisabled(member1);
      const obj42 = require(3748) /* isCommunicationDisabled */;
      obj11.timestamp = require(3801) /* resetCache */.accessibilityLabelCalendarFormat(message.timestamp);
      obj9.message = obj11;
      ...
      if (null != quarantineType) {
        ...
        obj13 = { reason: require(5736) /* getEmbedFieldFromMessage */.getQuarantineReasonString(quarantineType) };
        id = intl15.formatToPlainString(require(1212) /* getSystemLocale */.t["26bB2M"], obj13);
        const obj46 = require(5736) /* getEmbedFieldFromMessage */;
      }
      obj9.reasonDisplayText = id;
      id = require;
      id = dependencyMap;
      id = closure_4;
      const obj43 = require(3801) /* resetCache */;
      id = dependencyMap;
      id = importDefault;
      if (result1) {
        id = 7743;
