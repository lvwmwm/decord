...
// Module 7644 (formatUsernameOnClick)
const result = require("__exportStarResult1").fileFinishedImporting("modules/messages/native/renderer/system_messages/formatUsernameOnClick.tsx");
