...
// Dependencies: [1390, 1386, 1921, 7891, 7893, 1233, 7895, 2]
// Exports: createRemoveRecipientSystemMessage

// Module 7909 (createRemoveRecipientSystemMessage)
...
export const createRemoveRecipientSystemMessage = function createRemoveRecipientSystemMessage(message) {
  ...
  if (message.author.id === first) {
    ...
    const merged = Object.assign(tmp8(7895)(message));
    return obj;
  } else {
    user = user.getUser(first);
    const userAuthorWithProcessedColor = tmp5(7891).getUserAuthorWithProcessedColor(user, channel);
    obj1 = {};
    ...
    obj2[3] = roleStyle;
    obj1.otherUsernameOnClick = tmp8(7893)(obj2);
    ...
    const merged2 = Object.assign(tmp8(7895)(message));
    return obj3;
  }
};
