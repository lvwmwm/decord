...
// Dependencies: [1395, 1391, 1922, 8114, 8116, 1236, 8117, 2]
// Exports: createRemoveRecipientSystemMessage

// Module 8130 (createRemoveRecipientSystemMessage)
...
export const createRemoveRecipientSystemMessage = function createRemoveRecipientSystemMessage(message) {
  ...
  obj = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: importDefault(8116)({ message, author: messageAuthorWithProcessedColor, roleStyle }) };
