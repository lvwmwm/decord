...
// Module 8113 (createAddRecipientSystemMessage)
...
export const createAddRecipientSystemMessage = function createAddRecipientSystemMessage(message) {
  ...
  const userAuthorWithProcessedColor = require(8114) /* getMessageAuthorWithProcessedColor */.getUserAuthorWithProcessedColor(user, channel);
  obj = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: importDefault(8116)({ message, author: messageAuthorWithProcessedColor, roleStyle }), otherUsername: userAuthorWithProcessedColor.nick, otherUsernameOnClick: importDefault(8116)({ userId: first, message, author: userAuthorWithProcessedColor, roleStyle }) };
