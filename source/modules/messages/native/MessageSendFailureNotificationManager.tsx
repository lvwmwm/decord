...
// Dependencies: [1960, 4124, 1903, 6876, 676, 12976, 9767, 9769, 10773, 1236, 5261, 2]

// Module 16894 (handleMessageSendFailure)
...
function handleMessageSendFailure(shouldNotify) {
  ...
  if (shouldNotify.shouldNotify) {
    if ("active" !== state.getState()) {
      ...
      const notificationDuration = require(9767) /* extractMetadataFromNotification */.getNotificationDuration(MESSAGE_FAILED_TO_SEND);
      ...
      const obj5 = importDefault(9769);
      obj1[6] = require(9767) /* extractMetadataFromNotification */.generateInAppNotificationId();
      obj5.enqueueNotification(obj1);
      const obj7 = require(9767) /* extractMetadataFromNotification */;
    }
  }
}
