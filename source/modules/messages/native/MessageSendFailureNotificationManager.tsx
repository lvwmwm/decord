...
// Dependencies: [1979, 4167, 1922, 6917, 676, 13041, 9814, 9816, 10832, 1236, 5300, 2]

// Module 16973 (handleMessageSendFailure)
...
function handleMessageSendFailure(shouldNotify) {
  ...
  if (shouldNotify.shouldNotify) {
    if ("active" !== state.getState()) {
      ...
      const notificationDuration = require(9814) /* extractMetadataFromNotification */.getNotificationDuration(MESSAGE_FAILED_TO_SEND);
      ...
      const obj5 = importDefault(9816);
      obj1[6] = require(9814) /* extractMetadataFromNotification */.generateInAppNotificationId();
      obj5.enqueueNotification(obj1);
      const obj7 = require(9814) /* extractMetadataFromNotification */;
    }
  }
}
