...
// Function ID: 8630
// Name: Emoji
// Dependencies: [19, 17, 4072, 21, 4255, 712, 8630, 3900, 5221, 4251, 8631, 3896, 8535, 8632, 1236, 7749, 4665, 8634, 2]
// Exports: default
...
function Emoji(surrogate) {
  ...
  if ("" !== uRL) {
    ...
    obj1[0] = uRL;
    obj[2] = obj1;
    let tmp7Result = tmp7(importDefault(5221), obj);
  } else {
