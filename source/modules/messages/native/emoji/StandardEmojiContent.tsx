...
// Function ID: 8799
// Name: Emoji
// Dependencies: [19, 17, 4165, 21, 4342, 712, 8799, 4006, 5329, 4338, 8800, 4002, 8704, 8801, 1236, 8033, 4777, 8803, 2]
// Exports: default
...
function Emoji(surrogate) {
  ...
  if ("" !== uRL) {
    ...
    obj1[0] = uRL;
    obj[2] = obj1;
    let tmp7Result = tmp7(importDefault(5329), obj);
  } else {
