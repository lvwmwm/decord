...
// Dependencies: [19, 17, 676, 21, 4445, 500, 514, 5574, 698, 9092, 9098, 9099, 2]
// Exports: default

// Module 9091 (MessageStandardEmojiActionSheet)
import noopAll from "noop" /* 19 */;
import EmojiDefault from "Emoji" /* 9092 */;
import CustomEmojiContentDefault from "CustomEmojiContent" /* 9099 */;
...
function MessageStandardEmojiActionSheet(emojiNode) {
  ...
  return jsx(_require(5574).BottomSheet, { style: callback().contentWrapper, children: jsx(EmojiDefault, { emojiNode: emojiNode.emojiNode, nonce: v4Result }) });
}
function MessageCustomEmojiActionSheet(emojiNode) {
  emojiNode = emojiNode.emojiNode;
  let _require;
  let obj = _require(9098);
  ...
  if (emojiAndSource.isFetching) {
    ...
    return jsx(tmp2(5574).BottomSheet, { startExpanded: true, onDismiss: null, children: null });
  }
  tmp = callback();
}
noopAll;
