...
// Dependencies: [19, 17, 676, 21, 4446, 500, 514, 5587, 698, 9110, 9116, 9117, 2]
// Exports: default

// Module 9109 (MessageStandardEmojiActionSheet)
import noopAll from "noop" /* 19 */;
import EmojiDefault from "Emoji" /* 9110 */;
import CustomEmojiContentDefault from "CustomEmojiContent" /* 9117 */;
...
function MessageStandardEmojiActionSheet(emojiNode) {
  ...
  return jsx(_require(5587).BottomSheet, { style: callback().contentWrapper, children: jsx(EmojiDefault, { emojiNode: emojiNode.emojiNode, nonce: v4Result }) });
}
function MessageCustomEmojiActionSheet(emojiNode) {
  ...
  if (emojiAndSource.isFetching) {
    ...
    return jsx(tmp2(5587).BottomSheet, { startExpanded: true, onDismiss: null, children: null });
  }
  tmp = callback();
}
noopAll;
