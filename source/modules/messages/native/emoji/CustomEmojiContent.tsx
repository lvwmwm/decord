...
// Module 9381 (CustomEmojiContent)
...
obj = { nitroWheel: { <string:1140607356>: "boolean", <string:1751293292>: "string" } };
obj = { tintColor: importDefault(dependencyMap[8]).colors.CONTROL_BRAND_FOREGROUND_NEW };
obj.nitroWheelPurple = obj;
obj.emojiDescriptionWrapperOuter = { colors: "24c4788690396bae9cc4c1af395a6a87", concat: "BicycleIcon", y: "png", isArray: true };
obj.starIcon = {};
...
obj.moreMenuIcon = { color: importDefault(dependencyMap[8]).colors.INTERACTIVE_ICON_DEFAULT };
obj.bottomCtaButton = { marginTop: 24 };
obj.ctaDescriptionWrapper = {};
const obj3 = { color: importDefault(dependencyMap[8]).colors.INTERACTIVE_ICON_DEFAULT };
...
const result = arg1(dependencyMap[42]).fileFinishedImporting("modules/messages/native/emoji/CustomEmojiContent.tsx");
...
export default function CustomEmojiContent(emojiNode) {
  ...
  function closeActionSheet() {
    let obj = expressionSourceGuild(nonce[14]);
  ...
  function renderStarIcon(Button, arg1) {
    ...
    if (Button.isSelected) {
      ...
      obj = {};
      obj.style = obj;
      return renderStarIcon(emojiNode(nonce[27]).StarIcon, obj);
    } else {
      const merged2 = Object.assign(tmp2.starIconUnselected);
      obj = {};
      obj.style = obj;
      return renderStarIcon(emojiNode(nonce[28]).StarOutlineIcon, obj);
    }
  }
  function handleAddRemoveFavorite() {
    function content() {
      ...
      return closure_14(callback(closure_3[29]).Text, obj);
    }
    closeActionSheet();
    let obj = emojiNode(nonce[31]);
    if (isFavoriteEmoji) {
      ...
      expressionSourceGuild(tmp2[32]).open(obj);
      const obj4 = expressionSourceGuild(tmp2[32]);
    } else {
      ...
      expressionSourceGuild(tmp2[32]).open(obj);
      const obj2 = expressionSourceGuild(tmp2[32]);
    }
  }
  function renderNitroWheel() {
    ...
    obj = { style: tmp2 };
    return renderStarIcon(emojiNode(nonce[35]).NitroWheel, obj);
  }
  let obj = {};
  ...
  analyticsLocations = importDefault(dependencyMap[17])().analyticsLocations;
  const items2 = [customEmojiFromJoinedGuild, stateFromStores1];
  const memo = React.useMemo(() => {
    if (null == customEmojiFromJoinedGuild) {
      let obj = { 0: true, 9223372036854775807: false, 0: false };
    } else {
      obj = {};
      let tmp;
      obj.isRoleSubscriptionEmoji = customEmojiFromJoinedGuild(nonce[18]).isPurchasableRoleSubscriptionEmoji(customEmojiFromJoinedGuild);
      const obj2 = customEmojiFromJoinedGuild(nonce[18]);
      const tmp6 = customEmojiFromJoinedGuild;
      if (null != stateFromStores1) {
        tmp = stateFromStores1;
      }
      obj.isUnusableRoleSubscriptionEmoji = customEmojiFromJoinedGuild(nonce[18]).isUnusableRoleSubscriptionEmoji(tmp6, tmp);
      obj.userIsRoleSubscriber = analyticsLocations.getUserSubscriptionRoles(customEmojiFromJoinedGuild.guildId).size > 0;
      const obj3 = customEmojiFromJoinedGuild(nonce[18]);
    }
    return obj;
  }, items2);
  ...
  if (!tmp9) {
    ...
    tmp9 = type !== arg1(dependencyMap[19]).EmojiTypes.GUILD;
  }
  let result = !tmp9;
  if (!tmp9) {
  ...
  const DeveloperMode = arg1(dependencyMap[23]).DeveloperMode;
  ...
  obj = {
    ...
    onOpenPremiumSettings() {
      ...
      emojiNode(nonce[25]).openUserSettings(obj);
    }
  };
  ...
  const tmp28 = type === arg1(dependencyMap[24]).EmojiPopoutType.JOIN_GUILD;
  obj2 = {};
  const items3 = [arg1(dependencyMap[24]).EmojiPopoutType.GET_PREMIUM, arg1(dependencyMap[24]).EmojiPopoutType.JOIN_GUILD];
  ...
  const obj10 = { INTEGRATION_CREATE: -833552028, ConstraintReasonCode: -314949303, children: ":" + emojiNode.alt + ":" };
  ...
  if (tmp35) {
    ...
    tmp35 = renderStarIcon(arg1(dependencyMap[29]).Text, obj11);
  }
  items5[1] = tmp35;
  ...
  if (!isUnusableRoleSubscriptionEmoji && hasJoinedEmojiSourceGuild) {
    ...
    if (!tidaWebformEnabled) {
      ...
      const t2 = arg1(dependencyMap[30]).t;
      if (isFavoriteEmoji) {
      ...
      if (isFavoriteEmoji) {
        StarIcon = StarIcon(obj14[27]).StarIcon;
        const obj13 = {};
        obj14 = {};
        ...
        obj15.style = obj16;
        tmp45Result = tmp45(StarIcon(obj14[28]).StarOutlineIcon, obj15);
      }
  ...
  if (tidaWebformEnabled) {
    ...
    if (setting) {
      ...
      obj17.accessibilityLabel = intl3.string(arg1(dependencyMap[30]).t.PdRCRg);
      obj17.style = obj.moreMenuIcon;
      obj17.onPress = function handleOpenEmojiOptionsMenu() {
        let obj = expressionSourceGuild(nonce[14]);
        obj = { emojiSrc: emojiNode.src };
        obj.openLazy(emojiNode(nonce[13])(nonce[33], nonce.paths), "EmojiOptionsActionSheet", obj, "stack");
      };
      const obj18 = { color: importDefault(dependencyMap[8]).colors.INTERACTIVE_TEXT_DEFAULT };
      obj17.children = renderStarIcon(arg1(dependencyMap[34]).MoreHorizontalIcon, obj18);
  ...
  if (type === arg1(dependencyMap[24]).EmojiPopoutType.GET_PREMIUM) {
    let tmp66 = function renderPremiumUpsellButton() {
      ...
      if (type === emojiNode(nonce[24]).EmojiPopoutType.GET_PREMIUM) {
        ...
        obj = {
          borderWidth: true,
          height: "/assets/.cache/intl/bW9kdWxlcy9jaGVja291dC9tZXNzYWdlcw==",
          textAlign: null,
          textAlignVertical: "f97d64312921f5ef7b3340956e698c3b",
          flexDirection: "el.messages.f97d64312921f5ef7b3340956e698c3b.compiled.messages",
          icon: renderNitroWheel(),
          text: emojiPopoutData.text,
          onPress() {
              let result = null == closure_5;
              if (!result) {
                let obj = callback2(paths[9]);
              ...
              if (!result) {
                ...
                callback2(paths[10]).track(constants.PREMIUM_PROMOTION_OPENED, obj);
                const obj2 = callback2(paths[10]);
                obj = { analyticsLocation: tmp2, analyticsLocations: closure_7 };
                callback2(paths[11]).pushLazy(callback(paths[13])(paths[12], paths.paths), obj);
                const obj4 = callback2(paths[11]);
              }
            }
        };
        obj.children = renderStarIcon(emojiNode(nonce[36]).Button, obj);
    ...
    if (tmp28) {
      ...
      const obj20 = { h: 40, g: true, z: "/assets/.cache/intl/bW9kdWxlcy9nb19saXZlL3dlYi9tb2RhbA==" };
      ...
      obj20.onPress = function onPress() {
        ...
        emojiNode(nonce[38]).handleJoinGuild(id);
      };
      obj19.children = renderStarIcon(arg1(dependencyMap[36]).Button, obj20);
  ...
  if (hasJoinedEmojiSourceGuild) {
    ...
    if (null != expressionSourceGuild) {
      ...
      const items8 = [renderStarIcon(arg1(dependencyMap[39]).FormDivider, obj22), , ];
      ...
      items8[1] = renderStarIcon(importDefault(dependencyMap[40]), obj23);
      ...
      if (tmp74) {
        ...
        tmp74 = renderStarIcon(arg1(dependencyMap[41]).EmojiGrid, obj24);
      }
      items8[2] = tmp74;
  ...
  if (!isUnusableRoleSubscriptionEmoji && hasJoinedEmojiSourceGuild) {
    ...
    if (tidaWebformEnabled) {
      ...
      const items10 = [renderStarIcon(arg1(dependencyMap[39]).FormDivider, obj26), ];
      const obj27 = { style: obj.favoriteButtonContainer };
      const obj28 = {};
      const intl5 = arg1(dependencyMap[30]).intl;
      const string3 = intl5.string;
      const t3 = arg1(dependencyMap[30]).t;
      if (isFavoriteEmoji) {
      ...
      obj27.children = renderStarIcon(arg1(dependencyMap[36]).Button, obj28);
