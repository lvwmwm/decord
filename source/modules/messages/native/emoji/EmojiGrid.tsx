...
// Function ID: 8815
// Name: Emoji
// Dependencies: [19, 17, 21, 4342, 712, 4006, 1435, 5421, 8799, 8815, 8817, 2]
// Exports: EmojiGrid
...
function Emoji(guildEmoji) {
  ...
  return jsx(importDefault(5421), { src: uRL, fastImageStyle: tmp.gridEmojiFastImage, textEmojiStyle: tmp.gridEmojiText, name: guildEmoji.name }, guildEmoji.id);
}
...
export const EmojiGrid = function EmojiGrid(numberToShow) {
  ...
  let obj;
  obj = {};
  const merged = Object.assign(doNotDisplayEmojiIds(8799).useSharedMessageEmojiStyles());
  ...
  obj[1] = jsx(tmp(8817).GappedList, { gap: 8, children: null });
