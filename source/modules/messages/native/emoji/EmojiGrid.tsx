...
// Function ID: 8646
// Name: Emoji
// Dependencies: [19, 17, 21, 4255, 712, 3900, 1416, 5286, 8630, 8646, 8648, 2]
// Exports: EmojiGrid
...
function Emoji(guildEmoji) {
  ...
  return jsx(importDefault(5286), { src: uRL, fastImageStyle: tmp.gridEmojiFastImage, textEmojiStyle: tmp.gridEmojiText, name: guildEmoji.name }, guildEmoji.id);
}
...
export const EmojiGrid = function EmojiGrid(numberToShow) {
  ...
  let obj;
  obj = {};
  const merged = Object.assign(doNotDisplayEmojiIds(8630).useSharedMessageEmojiStyles());
  ...
  obj[1] = jsx(tmp(8648).GappedList, { gap: 8, children: null });
