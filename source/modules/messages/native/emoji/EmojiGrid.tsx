...
// Function ID: 8675
// Name: Emoji
// Dependencies: [19, 17, 21, 4285, 712, 3929, 1416, 5340, 8659, 8675, 8677, 2]
// Exports: EmojiGrid
...
function Emoji(guildEmoji) {
  ...
  return jsx(importDefault(5340), { src: uRL, fastImageStyle: tmp.gridEmojiFastImage, textEmojiStyle: tmp.gridEmojiText, name: guildEmoji.name }, guildEmoji.id);
}
...
export const EmojiGrid = function EmojiGrid(numberToShow) {
  ...
  let obj;
  obj = {};
  const merged = Object.assign(doNotDisplayEmojiIds(8659).useSharedMessageEmojiStyles());
  ...
  obj[1] = jsx(tmp(8677).GappedList, { gap: 8, children: null });
