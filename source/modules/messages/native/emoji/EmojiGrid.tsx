...
// Function ID: 8692
// Name: Emoji
// Dependencies: [19, 17, 21, 4302, 712, 3946, 1416, 5359, 8676, 8692, 8694, 2]
// Exports: EmojiGrid
...
function Emoji(guildEmoji) {
  ...
  return jsx(importDefault(5359), { src: uRL, fastImageStyle: tmp.gridEmojiFastImage, textEmojiStyle: tmp.gridEmojiText, name: guildEmoji.name }, guildEmoji.id);
}
...
export const EmojiGrid = function EmojiGrid(numberToShow) {
  ...
  let obj;
  obj = {};
  const merged = Object.assign(doNotDisplayEmojiIds(8676).useSharedMessageEmojiStyles());
  ...
  obj[1] = jsx(tmp(8694).GappedList, { gap: 8, children: null });
