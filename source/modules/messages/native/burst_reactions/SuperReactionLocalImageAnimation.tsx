...
// Dependencies: [19, 21, 7164, 7207, 2]
// Exports: default

// Module 8558 (SuperReactionLocalImageAnimation)
import "noop";
...
export default function SuperReactionLocalImageAnimation(arg0) {
  ...
  let obj = require(7164) /* _generateAnimationSource */;
  ...
  if (null != superReactionAnimationSourceFromLocalImage) {
    ...
    tmp = jsx(importDefault(7207), { loop: true, source: null });
    const tmp7 = importDefault(7207);
  }
  return tmp;
};
