...
// Dependencies: [19, 21, 6093, 6136, 2]
// Exports: default

// Module 9330 (SuperReactionLocalImageAnimation)
import "noop";
...
export default function SuperReactionLocalImageAnimation(arg0) {
  ...
  if (null != superReactionAnimationSourceFromLocalImage) {
    ...
    tmp = jsx(importDefault(6136), { loop: true, source: null });
    const tmp7 = importDefault(6136);
  }
  return tmp;
};
