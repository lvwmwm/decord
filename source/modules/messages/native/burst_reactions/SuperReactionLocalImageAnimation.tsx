...
// Dependencies: [19, 21, 7244, 7287, 2]
// Exports: default

// Module 8641 (SuperReactionLocalImageAnimation)
import "noop";
...
export default function SuperReactionLocalImageAnimation(arg0) {
  ...
  let obj = require(7244) /* _generateAnimationSource */;
  ...
  if (null != superReactionAnimationSourceFromLocalImage) {
    ...
    tmp = jsx(importDefault(7287), { loop: true, source: null });
    const tmp7 = importDefault(7287);
  }
  return tmp;
};
