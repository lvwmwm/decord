...
// Dependencies: [32, 19, 17, 1369, 21, 4255, 712, 7151, 4224, 4225, 709, 4116, 4256, 9821, 1358, 1297, 7193, 4251, 1236, 3967, 2]
// Exports: default

// Module 15826 (BurstReactionAnimationContainerInner)
...
function BurstReactionAnimationContainerInner() {
  ...
  if (null != first) {
    ...
    obj[1] = function children(markAsDismissed) {
      ...
      obj[0] = callback(7151).BACKDROP_OPACITY;
    ...
    tmp8 = callback(first(9821), obj);
    let tmp11 = first(9821);
  }
  return tmp8;
}
