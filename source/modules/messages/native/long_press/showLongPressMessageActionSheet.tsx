...
// Dependencies: [4099, 9487, 1935, 2]
// Exports: showLongPressMessageActionSheet

// Module 9486 (showLongPressMessageActionSheet)
...
export const showLongPressMessageActionSheet = function showLongPressMessageActionSheet(closure_0) {
  importDefault(4099).openLazy(require(1935) /* maybeLoadBundle */(9487, dependencyMap.paths), "MessageLongPressActionSheet", closure_0);
};
