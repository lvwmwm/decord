...
// Dependencies: [4412, 11157, 2009, 2]
// Exports: showLongPressMessageActionSheet

// Module 11156 (showLongPressMessageActionSheet)
...
export const showLongPressMessageActionSheet = function showLongPressMessageActionSheet(closure_0) {
  ACTION_SHEET_HEIGHT_HALFDefault.openLazy(asyncRequireImpl(11157, dependencyMap.paths), "MessageLongPressActionSheet", closure_0);
};
