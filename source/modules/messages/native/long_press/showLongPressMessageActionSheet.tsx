...
// Dependencies: [4271, 11120, 1988, 2]
// Exports: showLongPressMessageActionSheet

// Module 11119 (showLongPressMessageActionSheet)
...
export const showLongPressMessageActionSheet = function showLongPressMessageActionSheet(closure_0) {
  importDefault(4271).openLazy(require(1988) /* asyncRequireImpl */(11120, dependencyMap.paths), "MessageLongPressActionSheet", closure_0);
};
