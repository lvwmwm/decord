...
// Function ID: 7133
// Name: createMessage
// Dependencies: [6963, 1882, 1874, 676, 38, 7133, 2]
// Exports: createBotMessage, default, userRecordToServer

// Module 7132 (createMessage)
...
export default function createMessage(tts) {
  ...
  if (nonce == null) {
    nonce = require(7133) /* snowflakeSequence */.createNonce();
    const obj3 = require(7133) /* snowflakeSequence */;
  }
...
export const createBotMessage = function createBotMessage(arg0) {
  ...
  if (messageId == null) {
    let obj = require(7133) /* snowflakeSequence */;
