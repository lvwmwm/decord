...
// Function ID: 7153
// Name: createMessage
// Dependencies: [6994, 1911, 1903, 676, 38, 7153, 2]
// Exports: createBotMessage, default, userRecordToServer

// Module 7152 (createMessage)
...
export default function createMessage(tts) {
  ...
  if (nonce == null) {
    nonce = require(7153) /* snowflakeSequence */.createNonce();
    const obj3 = require(7153) /* snowflakeSequence */;
  }
...
export const createBotMessage = function createBotMessage(arg0) {
  ...
  if (messageId == null) {
    let obj = require(7153) /* snowflakeSequence */;
