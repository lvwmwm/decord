...
// Function ID: 7121
// Name: createMessage
// Dependencies: [6951, 1882, 1874, 676, 38, 7121, 2]
// Exports: createBotMessage, default, userRecordToServer

// Module 7120 (createMessage)
...
export default function createMessage(tts) {
  ...
  if (nonce == null) {
    nonce = require(7121) /* snowflakeSequence */.createNonce();
    const obj3 = require(7121) /* snowflakeSequence */;
  }
...
export const createBotMessage = function createBotMessage(arg0) {
  ...
  if (messageId == null) {
    let obj = require(7121) /* snowflakeSequence */;
