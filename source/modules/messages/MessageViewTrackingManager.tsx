...
// Dependencies: [676, 503, 5688, 1351, 5260, 1386, 698, 2]

// Module 10922 (getAnalyticsConfig)
...
function getAnalyticsConfig(type) {
  ...
  if (obj.ANNOUNCEMENT === type) {
    ...
    const INVITE_EMBED = importDefault(5688).INVITE_EMBED;
    if (treatmentRendered) {
      const items = [INVITE_EMBED, importDefault(5688).VOICE_CHANNEL_LIST_INVITE_EMBED];
      let items1 = items;
    } else {
      items1 = [INVITE_EMBED];
    }
