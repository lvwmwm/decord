...
// Dependencies: [676, 503, 5535, 1351, 5134, 1386, 698, 2]

// Module 9496 (getAnalyticsConfig)
...
function getAnalyticsConfig(type) {
  ...
  if (obj.ANNOUNCEMENT === type) {
    ...
    const INVITE_EMBED = importDefault(5535).INVITE_EMBED;
    if (treatmentRendered) {
      const items = [INVITE_EMBED, importDefault(5535).VOICE_CHANNEL_LIST_INVITE_EMBED];
      let items1 = items;
    } else {
      items1 = [INVITE_EMBED];
    }
