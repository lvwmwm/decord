...
// Dependencies: [6, 7, 15, 17, 18, 653, 480, 5517, 1327, 1362, 675, 5112, 2]

// Module 9472 (_createForOfIteratorHelperLoose)
...
function getAnalyticsConfig(type) {
  ...
  if (obj.ANNOUNCEMENT === type) {
    ...
    const INVITE_EMBED = importDefault(5517).INVITE_EMBED;
    if (type.treatmentRendered) {
      const items = [INVITE_EMBED, importDefault(5517).VOICE_CHANNEL_LIST_INVITE_EMBED];
      let items1 = items;
    } else {
      items1 = [INVITE_EMBED];
    }
