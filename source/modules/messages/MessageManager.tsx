...
// Function ID: 9871
// Name: fetchMessages
// Dependencies: [32, 4497, 5238, 1390, 7220, 1386, 1908, 4496, 1980, 4302, 673, 1393, 684, 3, 5233, 9871, 4412, 8304, 7390, 9872, 592, 4307, 1219, 7222, 4865, 1233, 706, 7058, 2]

// Module 9870 (fetchMessages)
...
import mergeMessageDefault from "mergeMessage" /* 5233 */;
...
import getMessageLimit from "getMessageLimit" /* 9872 */;
...
import closure_8 from "handlePermissionsChange" /* 7220 */;
      ...
      if (type !== constants.GUILD_STORE) {
        ...
        if (null == type1) {
          ...
          if (orCreate.some(isRefreshableAttachmentUrlAll.messageHasExpiredAttachmentUrl)) {
            ...
            let tmp9Result = tmp9(5233);
            tmp9Result.clear(channelId);
            tmp9Result = tmp9(5233);
          ...
          if (tmp15) {
            ...
            tmp9(5233).commit(mutation);
            obj7 = mutation;
            const tmp9Result1 = tmp9(5233);
          }
          let obj10 = obj7;
          if (tmp19) {
            const mutation1 = obj7.mutate({ focusTargetId: null });
            tmp9(5233).commit(mutation1);
            obj10 = mutation1;
            const tmp9Result2 = tmp9(5233);
          }
          if (isPreload) {
            if (!closure_6.isConnected()) {
              let flag = true;
            }
            let hasUnreadResult = tmp9(8304)(channelId);
            if (hasUnreadResult) {
            ...
            if (flag) {
              tmp9(5233).commit(obj10.mutate({ loadingMore: true }));
              if (null == messageId) {
                let isThreadResult;
                if (channel != null) {
                ...
                tmp9(7390).jumpToMessage(obj7);
                const tmp9Result7 = tmp9(7390);
              }
              const tmp9Result3 = tmp9(5233);
            }
          }
