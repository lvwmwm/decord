...
// Function ID: 9792
// Name: fetchMessages
// Dependencies: [32, 4357, 5034, 1395, 5937, 1391, 1910, 4356, 1979, 4167, 676, 1398, 687, 3, 5029, 9792, 4276, 8981, 6959, 9793, 595, 4172, 1222, 5939, 4682, 1236, 709, 5300, 2]

// Module 9791 (fetchMessages)
  ...
  if (null != channelId) {
    if (!isStaticChannelRoute(channelId)) {
      ...
      if (type !== constants.GUILD_STORE) {
        ...
        if (null == type1) {
          let obj2 = importDefault(5029);
          const orCreate = obj2.getOrCreate(channelId);
          let orCreate1 = orCreate;
          if (orCreate.some(require(9792) /* shouldRefreshAttachmentUrl */.messageHasExpiredAttachmentUrl)) {
...
function handleConnectionOpen() {
  ...
  if (null != channelId) {
    ...
    if (null != channel1) {
      ...
      const obj7 = require(4172) /* matchPath */;
...
function handleChannelSectionStoreChange() {
  ...
  if (null != guildId) {
    if (null != channelId) {
      ...
      if (type !== require(5939) /* SidebarType */.SidebarType.VIEW_CHANNEL) {
  ...
  if (!isPreview) {
    ...
    if (Date.now() - num >= closure_20) {
      ...
      if (isStale) {
        ...
        obj[0] = channelId;
        obj[1] = require(9793) /* getMessageLimit */.getMessageLimit("MessageManager.staleFetch");
        obj[2] = jump.jump;
        const messages = obj.fetchMessages(obj);
        const obj3 = require(9793) /* getMessageLimit */;
      }
    }
    tmp = table;
  }
...
function handleAppWillBecomeActive() {
  ...
  if (null == channelId) {
    ...
    const newLocalMessages = importDefault(6959).fetchNewLocalMessages(channelId, closure_13);
  }
}
