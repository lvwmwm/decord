...
// Module 4531 (urlMatchesFileExtension)
...
function isWebPlayerVideoUrl(mediaUrl) {
  let isIOSWithWebMResult = require(4532) /* isIOSWithWebM */.isIOSWithWebM();
...
function isWebPlayerVideoFile(filename) {
  ...
  if (isIOSWithWebMResult) {
    isIOSWithWebMResult = require(4532) /* isIOSWithWebM */.isIOSWithWebM();
    const obj = require(4532) /* isIOSWithWebM */;
  }
  if (isIOSWithWebMResult) {
...
export const isVideoUrl = function isVideoUrl(url) {
  ...
  if (!flag) {
    ...
    const obj2 = require(4532) /* isIOSWithWebM */;
  }
  return flag;
};
