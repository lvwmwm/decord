...
const ephemeralMessageStore = new EphemeralMessageStore(require("dispatcher"), {
  MESSAGE_CREATE: function handleMessageCreate(arg0) {
    ...
    if (obj.hasFlag(num, MessageFlags.EPHEMERAL)) {
      ...
      const result1 = value.set(message.id, tmp(4523).createMessageRecord(message));
      if (value.size > 50) {
      ...
      if (null != id) {
        ...
        if (null == value) {
          ...
          if (null == value) {
            ...
            const result = value.set(id, require(4523) /* createMinimalMessageRecord */.updateMessageRecord(value, message));
          }
        }
      }
    }
