...
// Module 7876 (getInitialParserState)
...
export const renderAutomodMessageMarkup = function renderAutomodMessageMarkup(arg0, arg1, arg2) {
  ...
  obj[12] = arg1;
  obj[14] = arg2;
  return importDefault(4179).parseAutoModerationSystemMessage(arg0, true, obj, (arg0) => {
    let tmp = arg0;
    if (!Array.isArray(arg0)) {
      const items = [arg0];
      tmp = items;
...
export const renderAutomodMessageMarkupToAST = function renderAutomodMessageMarkupToAST(arg0, arg1, arg2) {
  ...
  obj[12] = arg1;
  obj[14] = arg2;
  return importDefault(4179).parseAutoModerationSystemMessageToAST(arg0, true, obj, (arg0) => {
    let tmp = arg0;
    if (!Array.isArray(arg0)) {
      const items = [arg0];
      tmp = items;
