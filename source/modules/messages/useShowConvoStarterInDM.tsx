...
// Dependencies: [19, 5735, 4472, 3892, 1874, 676, 1379, 10226, 589, 2]
// Exports: useShowConvoStarterInDM

// Module 11521 (MAX_MESSAGES_ALLOWED_FOR_GREETING)
...
export const useShowConvoStarterInDM = function useShowConvoStarterInDM(channel) {
  ...
  const strangerDangerWarning = _require(10226).useStrangerDangerWarning(channel.id);
