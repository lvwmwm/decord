...
// Dependencies: [19, 5841, 4521, 3938, 1903, 676, 1379, 10339, 589, 2]
// Exports: useShowConvoStarterInDM

// Module 11636 (MAX_MESSAGES_ALLOWED_FOR_GREETING)
...
export const useShowConvoStarterInDM = function useShowConvoStarterInDM(channel) {
  ...
  const strangerDangerWarning = _require(10339).useStrangerDangerWarning(channel.id);
  const hasFlagResult = channel.hasFlag(ChannelFlags.HAS_ONLY_SYSTEM_MESSAGES);
  const obj = _require(10339);
