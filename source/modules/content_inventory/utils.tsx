...
// Module 7853 (calculateTimestampDurations)
...
function formatEndedTimestamp(entry, arg1, timestamp, arg3) {
  ...
  const obj2 = importDefault(3713)(timestamp);
...
function isEntryActive(entry) {
  let is_live;
  const tmp2 = getTrait(entry, require(7854) /* ContentInventoryTraitType */.ContentInventoryTraitType.IS_LIVE);
  if (null != tmp2) {
...
function getEntryDuration(contentInventoryEntry) {
  ...
  const tmp2 = getTrait(contentInventoryEntry, require(7854) /* ContentInventoryTraitType */.ContentInventoryTraitType.DURATION_SECONDS);
  if (null != tmp2) {
...
function getStreakCount(entry) {
  ...
  const tmp2 = getTrait(entry, require(7854) /* ContentInventoryTraitType */.ContentInventoryTraitType.STREAK_DAYS);
  if (null != tmp2) {
...
export const isEntryNew = function isEntryNew(entry) {
  let first_time;
  const tmp2 = getTrait(entry, require(7854) /* ContentInventoryTraitType */.ContentInventoryTraitType.FIRST_TIME);
  if (null != tmp2) {
...
export const getAggregateRange = function getAggregateRange(contentInventoryEntry) {
  let range;
  const tmp2 = getTrait(contentInventoryEntry, require(7854) /* ContentInventoryTraitType */.ContentInventoryTraitType.AGGREGATE_RANGE);
  if (null != tmp2) {
    range = tmp2.range;
  }
  return range;
...
export const isEntryMarathon = function isEntryMarathon(entry) {
  let marathon;
  const tmp2 = getTrait(entry, require(7854) /* ContentInventoryTraitType */.ContentInventoryTraitType.MARATHON);
  if (null != tmp2) {
...
export const getResurrectedEntryLastPlayTime = function getResurrectedEntryLastPlayTime(entry) {
  const tmp = getTrait(entry, require(7854) /* ContentInventoryTraitType */.ContentInventoryTraitType.RESURRECTED);
  let prop;
  if (null != tmp) {
...
export const isEntryTopGame = function isEntryTopGame(contentInventoryEntry) {
  return contentInventoryEntry.content_type === require(7848) /* ContentInventoryEntryType */.ContentInventoryEntryType.TOP_GAME;
};
...
export const getTrendingType = function getTrendingType(entry) {
  let trending;
  const tmp2 = getTrait(entry, require(7854) /* ContentInventoryTraitType */.ContentInventoryTraitType.TRENDING_CONTENT);
  if (null != tmp2) {
