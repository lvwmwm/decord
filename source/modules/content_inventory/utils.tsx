...
// Dependencies: [687, 11, 1236, 3975, 8349, 3618, 8344, 2]
...
function formatEndedTimestamp(entry, arg1, timestamp, arg3) {
  ...
  const obj2 = importDefault(3975)(timestamp);
  const tmp3 = importDefault(3975);
...
export const isEntryTopGame = function isEntryTopGame(contentInventoryEntry) {
  return contentInventoryEntry.content_type === require(8344) /* ContentInventoryEntryType */.ContentInventoryEntryType.TOP_GAME;
};
