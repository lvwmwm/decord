...
export const sendMessageWithEmbed = function sendMessageWithEmbed(channel) {
  ...
  return importDefault(6920).sendMessage(channel.id, parsed, whenReady, obj);
};
