...
// Dependencies: [19, 4322, 676, 4310, 8827, 8164, 1236, 12191, 7013, 9574, 1416, 12193, 4981, 12194, 5655, 589, 698, 8830, 2]
// Exports: getApplicationImage, useImageForActivity, useImageForContentEntry

// Module 12190 (useComputedImagesForActivity)
...
function useComputedImagesForActivity(activity, getIconURL) {
  ...
  if (null != largeImage) {
    ...
    } else if (importDefault(12193)(activity)) {
...
function useRichImageForActivity(activity, activityApplication) {
  require(5655) /* useGetOrFetchApplications */;
  if (activity != null) {
  ...
  if (null == activity) {
    ...
    let tmp10;
    if (!importDefault(8830)(activity)) {
      let small_image;
      if (activity != null) {
...
export const useImageForContentEntry = function useImageForContentEntry(trackingSource) {
  ...
  ({ activity, activityApplication, fallbackApplication } = importDefault(12191)(entry));
  ...
  let obj1 = require(7013) /* importDefaultResult1 */;
