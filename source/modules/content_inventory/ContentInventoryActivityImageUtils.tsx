...
// Dependencies: [19, 4339, 676, 4327, 8844, 8181, 1236, 12206, 7032, 9590, 1416, 12208, 4998, 12209, 5674, 589, 698, 8847, 2]
// Exports: getApplicationImage, useImageForActivity, useImageForContentEntry

// Module 12205 (useComputedImagesForActivity)
...
function useComputedImagesForActivity(activity, getIconURL) {
  ...
  if (null != largeImage) {
    ...
    } else if (importDefault(12208)(activity)) {
    ...
    obj17 = require(9590) /* unpackStageChannelParty */;
  }
  return obj8;
}
...
function useRichImageForActivity(activity, activityApplication) {
  require(5674) /* useGetOrFetchApplications */;
  if (activity != null) {
  ...
  if (null == activity) {
    ...
    let tmp10;
    if (!importDefault(8847)(activity)) {
      let small_image;
      if (activity != null) {
...
export const useImageForContentEntry = function useImageForContentEntry(trackingSource) {
  ...
  ({ activity, activityApplication, fallbackApplication } = importDefault(12206)(entry));
  ...
  let obj1 = require(7032) /* importDefaultResult1 */;
