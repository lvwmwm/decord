...
// Function ID: 7910
// Name: useHeroColors
// Dependencies: [32, 19, 4181, 1302, 7908, 5808, 7910, 688, 689, 589, 2]
// Exports: default, getHeroColors

// Module 7909 (useHeroColors)
...
export default function useHeroColors(pendingAvatarSrc) {
  ...
  let obj2 = first(589);
  const fallbackHeroColor = first(7910).getFallbackHeroColor(stateFromStores1, stateFromStores);
  let obj3 = first(7910);
  let tmp4 = callback(first(7908).useAvatarColors(pendingAvatarSrc, fallbackHeroColor), 2);
  first = tmp4[0];
...
export const getHeroColors = function getHeroColors(game_name) {
  ...
  const useColorStore = tmp2(7908).useColorStore;
