...
// Function ID: 7913
// Name: useHeroColors
// Dependencies: [32, 19, 4181, 1302, 7911, 5808, 7913, 688, 689, 589, 2]
// Exports: default, getHeroColors

// Module 7912 (useHeroColors)
...
export default function useHeroColors(pendingAvatarSrc) {
  ...
  let obj2 = first(589);
  const fallbackHeroColor = first(7913).getFallbackHeroColor(stateFromStores1, stateFromStores);
  let obj3 = first(7913);
  let tmp4 = callback(first(7911).useAvatarColors(pendingAvatarSrc, fallbackHeroColor), 2);
  first = tmp4[0];
...
export const getHeroColors = function getHeroColors(game_name) {
  ...
  const useColorStore = tmp2(7911).useColorStore;
