      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === date) {
            ...
            constants = 0;
            c6 = body;
            const aPIError = new callback(4202).APIError(c6);
            throw aPIError;
          } else if (arg0 === 1) {
            c6 = 3;
            throw body;
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            obj4[1] = callback;
            obj4.dispatch(obj4);
            const aPIError = new callback(4202).APIError(dependencyMap);
            throw aPIError;
          } else if (arg0 === 1) {
            c7 = 3;
            throw body;
