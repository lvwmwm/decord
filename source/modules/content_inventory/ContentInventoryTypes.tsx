...
export const isPlayedGameEntry = function isPlayedGameEntry(content_type) {
  ...
  return content_type === require(8303) /* ContentInventoryEntryType */.ContentInventoryEntryType.PLAYED_GAME;
};
export const isTopGameEntry = function isTopGameEntry(content_type) {
  ...
  return content_type === require(8303) /* ContentInventoryEntryType */.ContentInventoryEntryType.TOP_GAME;
};
export const isGamingLikeEntry = function isGamingLikeEntry(content) {
  ...
  let tmp4 = content_type === require(8303) /* ContentInventoryEntryType */.ContentInventoryEntryType.PLAYED_GAME;
  if (!tmp4) {
    let content_type1;
    if (content != null) {
      content_type1 = content.content_type;
    }
    tmp4 = content_type1 === require(8303) /* ContentInventoryEntryType */.ContentInventoryEntryType.TOP_GAME;
  }
  return tmp4;
};
...
export const isListenedSessionEntry = function isListenedSessionEntry(closure_0) {
  ...
  return content_type === require(8303) /* ContentInventoryEntryType */.ContentInventoryEntryType.LISTENED_SESSION;
};
export const isTopArtistEntry = function isTopArtistEntry(entry) {
  ...
  return content_type === require(8303) /* ContentInventoryEntryType */.ContentInventoryEntryType.TOP_ARTIST;
};
export const isListeningLikeEntry = function isListeningLikeEntry(content_type) {
  ...
  let tmp4 = content_type === require(8303) /* ContentInventoryEntryType */.ContentInventoryEntryType.LISTENED_SESSION;
  if (!tmp4) {
    let content_type1;
    if (content_type != null) {
      content_type1 = content_type.content_type;
    }
    tmp4 = content_type1 === require(8303) /* ContentInventoryEntryType */.ContentInventoryEntryType.TOP_ARTIST;
  }
  return tmp4;
};
export const isWatchedMediaEntry = function isWatchedMediaEntry(entry) {
  ...
  return content_type === require(8303) /* ContentInventoryEntryType */.ContentInventoryEntryType.WATCHED_MEDIA;
};
...
export const isLaunchedActivityEntry = function isLaunchedActivityEntry(content_type) {
  ...
  return content_type === require(8303) /* ContentInventoryEntryType */.ContentInventoryEntryType.LAUNCHED_ACTIVITY;
};
