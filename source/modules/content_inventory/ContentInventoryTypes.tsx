...
// Dependencies: [7884, 8153, 2]
// Exports: isConsoleEntry, isLaunchedActivityEntry, isListeningLikeEntry, isRecentActivityEntry

// Module 8152 (isPlayedGameEntry)
function isPlayedGameEntry(content_type) {
  content_type = undefined;
  if (null != content_type) {
    content_type = content_type.content_type;
  }
  return content_type === require(7884) /* ContentInventoryEntryType */.ContentInventoryEntryType.PLAYED_GAME;
}
function isTopGameEntry(content_type) {
  ...
  return content_type === require(7884) /* ContentInventoryEntryType */.ContentInventoryEntryType.TOP_GAME;
}
...
function isListenedSessionEntry(closure_0) {
  ...
  return content_type === require(7884) /* ContentInventoryEntryType */.ContentInventoryEntryType.LISTENED_SESSION;
}
function isTopArtistEntry(entry) {
  ...
  return content_type === require(7884) /* ContentInventoryEntryType */.ContentInventoryEntryType.TOP_ARTIST;
}
function isWatchedMediaEntry(entry) {
  ...
  return content_type === require(7884) /* ContentInventoryEntryType */.ContentInventoryEntryType.WATCHED_MEDIA;
}
function isXboxEntry(extra) {
  const tmp = isGamingLikeEntry(extra);
  let tmp2 = tmp;
  if (tmp) {
    tmp2 = extra.extra.platform === require(8153) /* PlatformType */.PlatformType.XBOX;
  }
  return tmp2;
}
function isPlaystationEntry(extra) {
  ...
  let tmp2 = tmp;
  if (tmp) {
    tmp2 = extra.extra.platform === require(8153) /* PlatformType */.PlatformType.PLAYSTATION;
  }
  return tmp2;
}
...
export const isLaunchedActivityEntry = function isLaunchedActivityEntry(content_type) {
  ...
  return content_type === require(7884) /* ContentInventoryEntryType */.ContentInventoryEntryType.LAUNCHED_ACTIVITY;
};
