...
// Module 13716 (_addRestrictedScheduleRule)
...
export const updateRestrictedScheduleRule = function updateRestrictedScheduleRule(arg0, ruleId, arg2) {
  return _updateRestrictedScheduleRule(...arguments);
};
export const deleteRestrictedScheduleRule = function deleteRestrictedScheduleRule(arg0, ruleId) {
  return _deleteRestrictedScheduleRule(...arguments);
};
