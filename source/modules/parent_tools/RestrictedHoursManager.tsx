...
// Dependencies: [9758, 1922, 6999, 1236, 2303, 1943, 9760, 709, 7056, 16379, 5261, 2]
// Exports: getCurrentRestrictedHoursState

// Module 16384 (scheduleUpcomingWarning)
...
function scheduleUpcomingWarning() {
  ...
  const date = new Date();
  let obj = require(7056) /* apexExperiment */;
  let tmp7 = null;
...
function checkAndUpdateModal() {
  ...
  if (result !== c6) {
    ...
    obj[1] = c6;
    obj.dispatch(obj);
    const obj3 = require(16379) /* closeRestrictedHoursModal */;
    if (c6) {
...
prototype["_initialize"] = function _initialize() {
  ...
  obj.dispatch(obj);
  if (closure_6) {
    const result = require(16379) /* closeRestrictedHoursModal */.openRestrictedHoursModal();
    const obj3 = require(16379) /* closeRestrictedHoursModal */;
  }
...
prototype["_terminate"] = function _terminate() {
  ...
  let c9 = null;
  const result = require(16379) /* closeRestrictedHoursModal */.closeRestrictedHoursModal();
  let c6 = false;
};
