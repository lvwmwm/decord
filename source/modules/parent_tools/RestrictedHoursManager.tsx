...
// Dependencies: [10241, 1874, 5793, 1236, 2223, 1895, 10243, 709, 5854, 16106, 5134, 2]
// Exports: getCurrentRestrictedHoursState

// Module 16111 (scheduleUpcomingWarning)
...
function scheduleUpcomingWarning() {
  ...
  const date = new Date();
  let obj = require(5854) /* apexExperiment */;
  let tmp7 = null;
  ...
  if (null != tmp7) {
    if (tmp7.minutesUntil <= 16) {
      ...
      if (combined !== combined) {
        ...
        let tmp5Result = tmp5(10243);
        const items = [tmp5(1895).JS_DAY_TO_DAY_OF_WEEK[date2.getDay(date2)]];
        const stringResult = intl.string(importDefault(2223)["0JlDg0"]);
        tmp5Result = tmp5(10243);
...
function checkAndUpdateModal() {
  ...
  if (result !== c6) {
    ...
    obj[1] = c6;
    obj.dispatch(obj);
    const obj3 = require(16106) /* closeRestrictedHoursModal */;
    if (c6) {
...
prototype["_initialize"] = function _initialize() {
  ...
  obj.dispatch(obj);
  if (closure_6) {
    const result = require(16106) /* closeRestrictedHoursModal */.openRestrictedHoursModal();
    const obj3 = require(16106) /* closeRestrictedHoursModal */;
  }
...
prototype["_terminate"] = function _terminate() {
  ...
  let c9 = null;
  const result = require(16106) /* closeRestrictedHoursModal */.closeRestrictedHoursModal();
  let c6 = false;
};
