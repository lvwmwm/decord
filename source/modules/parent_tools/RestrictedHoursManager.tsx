...
// Dependencies: [9814, 1922, 7066, 1236, 2303, 1943, 9816, 709, 7123, 16456, 5322, 2]
// Exports: getCurrentRestrictedHoursState

// Module 16461 (scheduleUpcomingWarning)
...
function scheduleUpcomingWarning() {
  ...
  const date = new Date();
  let obj = require(7123) /* apexExperiment */;
  let tmp7 = null;
...
function checkAndUpdateModal() {
  ...
  if (result !== c6) {
    ...
    obj[1] = c6;
    obj.dispatch(obj);
    const obj3 = require(16456) /* closeRestrictedHoursModal */;
    if (c6) {
...
prototype["_initialize"] = function _initialize() {
  ...
  obj.dispatch(obj);
  if (closure_6) {
    const result = require(16456) /* closeRestrictedHoursModal */.openRestrictedHoursModal();
    const obj3 = require(16456) /* closeRestrictedHoursModal */;
  }
...
prototype["_terminate"] = function _terminate() {
  ...
  let c9 = null;
  const result = require(16456) /* closeRestrictedHoursModal */.closeRestrictedHoursModal();
  let c6 = false;
};
