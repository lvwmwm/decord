...
// Dependencies: [5, 32, 19, 7470, 14750, 586, 7175, 14752, 2]
// Exports: useChangeSpendingLimitFormState

// Module 14833 (useChangeSpendingLimitFormState)
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (closure_1_6) {
              ...
              c3 = 1;
              if (closure_1_5) {
                const ParentalControlledSpendingLimit2 = closure_1_0(14750).ParentalControlledSpendingLimit;
                dependencyMap = 2;
                c4 = 1;
                ...
                const ParentalControlledSpendingLimit = closure_1_0(14750).ParentalControlledSpendingLimit;
