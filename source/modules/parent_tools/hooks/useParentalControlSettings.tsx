...
// Dependencies: [5, 19, 7232, 8616, 8715, 14364, 14367, 1306, 6111, 6207, 8713, 589, 7231, 8621, 2]
...
// Module 14363 (useParentalControlledExplicitContentSettings)
...
import closure_5 from "getSettings" /* 7232 */;
...
export const useParentalControlledGoreContentSettings = function useParentalControlledGoreContentSettings() {
  ...
  if (null == selectedTeen) {
    ...
    if (!tmpResult1.isSetAndNotDefault(goreContentFriendDm)) {
      goreContentFriendDm = tmp(6111).resolveGoreSettingWithDefaultsForTeen({ isDm: true, isFriend: true });
      const tmpResult2 = tmp(6111);
    }
...
export const useAllowFriendsFromMutualGuildsOnlyForTeen = function useAllowFriendsFromMutualGuildsOnlyForTeen() {
  const selectedTeen = controlledSetting(8715).useSelectedTeen();
...
export const useParentalControlledConsent = function useParentalControlledConsent(PERSONALIZATION) {
  ...
  selectedTeenId = _require(8715).useSelectedTeenId();
  _require = undefined;
