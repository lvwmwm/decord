...
// Dependencies: [5, 19, 7253, 8638, 8737, 14398, 14401, 1306, 6114, 6210, 8735, 589, 7252, 8643, 2]
...
// Module 14397 (useParentalControlledExplicitContentSettings)
...
import closure_5 from "getSettings" /* 7253 */;
...
export const useParentalControlledGoreContentSettings = function useParentalControlledGoreContentSettings() {
  ...
  if (null == selectedTeen) {
    ...
    if (!tmpResult1.isSetAndNotDefault(goreContentFriendDm)) {
      goreContentFriendDm = tmp(6114).resolveGoreSettingWithDefaultsForTeen({ isDm: true, isFriend: true });
      const tmpResult2 = tmp(6114);
    }
...
export const useAllowFriendsFromMutualGuildsOnlyForTeen = function useAllowFriendsFromMutualGuildsOnlyForTeen() {
  const selectedTeen = controlledSetting(8737).useSelectedTeen();
...
export const useParentalControlledConsent = function useParentalControlledConsent(PERSONALIZATION) {
  ...
  selectedTeenId = _require(8737).useSelectedTeenId();
  _require = undefined;
