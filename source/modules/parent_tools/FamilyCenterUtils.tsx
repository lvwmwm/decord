...
// Dependencies: [7229, 7230, 1236, 2370, 4044, 7231, 2]
...
// Module 7285 (getEmptyActivityFormatter)
...
export const getActivityWindowTimestampFormatter = function getActivityWindowTimestampFormatter(arg0) {
  ...
  if (arg0) {
    ...
    obj[1] = intl3.string(tmp3(2370).stOECr);
    obj[2] = tmp3(2370).n8n5Ba;
    let tmp5 = obj;
  } else {
    obj[0] = string(tmp4.g1ZX6m);
    const intl2 = tmp(1236).intl;
    obj[1] = intl2.string(tmp3(2370).s3qSVt);
    obj[2] = tmp3(2370).f1UJiC;
    tmp5 = obj;
  }
  return tmp5;
};
