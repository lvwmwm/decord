...
// Dependencies: [1236, 3586, 5917, 2303, 2]
// Exports: formatGiftDate, getGiftRowDisplayInfo, getGiftSubtext

// Module 14229 (getGiftRowDisplayInfo)
...
export const formatGiftDate = function formatGiftDate(claimedAt) {
  ...
  return dateTimeFormat.format(require(3586).parseISO(claimedAt));
};
export const getGiftSubtext = function getGiftSubtext(claimed) {
  ...
  if (null != formatPriceResult) {
    if (null != gifterName) {
      ...
      obj[1] = gifterName;
      let formatToPlainStringResult = intl.formatToPlainString(importDefault(2303)["o44n/1"], obj);
    }
