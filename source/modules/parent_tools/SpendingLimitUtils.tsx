...
// Module 13607 (spendingLimitEqual)
...
export const getNextRenewalDateLabel = function getNextRenewalDateLabel() {
  ...
  const dateTimeFormat = new Intl.DateTimeFormat(undefined, { metadataRefreshing: 0., metadataAlreadyRefreshed: 0. });
