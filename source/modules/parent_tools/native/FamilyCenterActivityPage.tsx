...
// Dependencies: [19, 17, 21, 4342, 712, 7403, 5389, 14198, 14200, 14210, 11393, 14214, 2]
// Exports: default

// Module 14197 (FamilyCenterActivityPage)
import "noop";
...
export default function FamilyCenterActivityPage() {
  ...
  const items = [callback(importDefault(14198), {}), ];
  ...
  items[1] = tmp3Result;
  obj[1] = items;
  obj[1] = callback(require(5389) /* SafeAreaPaddingView */.SafeAreaPaddingView, { bottom: true, children: closure_7(closure_3, obj) });
