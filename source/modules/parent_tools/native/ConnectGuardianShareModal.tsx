...
// Dependencies: [19, 17, 7038, 21, 4344, 712, 1236, 2303, 4061, 4549, 11383, 647, 14192, 7848, 7849, 4752, 4340, 14193, 5862, 5309, 11395, 2]
// Exports: default

// Module 16620 (ConnectGuardianShareScreen)
...
function ConnectGuardianShareScreen() {
  ...
  importDefault(14192)(importDefault(4549).pop);
  ...
  obj1[4] = intl.string(importDefault(2303).ITlV6p);
  ...
  obj2[3] = intl2.format(importDefault(2303).F4GT2S, { link: "https://support.discord.com/hc/articles/14155060633623" });
  ...
  obj4[3] = intl3.string(importDefault(2303).pojgfk);
  ...
  const tmp9 = importDefault(14192);
