...
// Dependencies: [19, 17, 21, 4255, 712, 8076, 14010, 14019, 14021, 4094, 14020, 4251, 2]
// Exports: default

// Module 14022 (FamilyCenterActivityGiftRow)
import "noop";
...
export default function FamilyCenterActivityGiftRow(arg0) {
  ...
  let product = importDefault(8076)(skuId).product;
  let obj = require(14010) /* useSelectedTeenUser */;
  const teenUserForId = obj.useTeenUserForId(gifterUserId);
  let obj1 = require(14019) /* getCollectibleTypeName */;
  let tmp7 = product;
  if (product == null) {
    tmp7 = null;
  }
  ...
  if (null == displayName) {
    ...
    obj[0] = tmp.container;
    const giftSubtext = tmp5(14021).getGiftSubtext(obj);
    ...
    obj3[4] = displayName;
    const items1 = [closure_4(tmp5(4251).Text, obj3), ];
    const obj4 = { variant: "text-xs/medium", color: "text-muted", children: null };
    obj4[2] = giftSubtext;
    items1[1] = closure_4(tmp5(4251).Text, obj4);
    obj2[1] = items1;
