...
// Dependencies: [19, 17, 21, 4285, 712, 8201, 14054, 14063, 14065, 4123, 14064, 4281, 2]
// Exports: default

// Module 14066 (FamilyCenterActivityGiftRow)
import "noop";
...
export default function FamilyCenterActivityGiftRow(arg0) {
  ...
  let product = importDefault(8201)(skuId).product;
  let obj = require(14054) /* useSelectedTeenUser */;
  const teenUserForId = obj.useTeenUserForId(gifterUserId);
  let obj1 = require(14063) /* getCollectibleTypeName */;
  let tmp7 = product;
  if (product == null) {
    tmp7 = null;
  }
  ...
  if (null == displayName) {
    ...
    obj3[4] = displayName;
    const items1 = [closure_4(tmp5(4281).Text, obj3), ];
    const obj4 = { variant: "text-xs/medium", color: "text-muted", children: null };
    obj4[2] = giftSubtext;
    items1[1] = closure_4(tmp5(4281).Text, obj4);
    obj2[1] = items1;
