...
// Dependencies: [19, 17, 21, 4255, 712, 8060, 14017, 14026, 14028, 4094, 14027, 4251, 2]
// Exports: default

// Module 14029 (FamilyCenterActivityGiftRow)
import "noop";
...
export default function FamilyCenterActivityGiftRow(arg0) {
  ...
  let obj = require(14017) /* useSelectedTeenUser */;
  const teenUserForId = obj.useTeenUserForId(gifterUserId);
  let obj1 = require(14026) /* getCollectibleTypeName */;
  let tmp7 = product;
  if (product == null) {
    tmp7 = null;
  }
