...
// Dependencies: [19, 17, 6891, 21, 4255, 712, 7231, 11211, 1236, 2255, 4251, 7232, 4797, 4460, 14049, 1959, 1297, 9764, 14050, 14047, 14051, 14042, 2]
// Exports: default

// Module 14048 (FamilyCenterPendingLinkRow)
...
function FamilyCenterPendingLinkRow(otherUser) {
  ...
  if (undefined === str) {
    ...
    if (tmp4) {
      ...
      let tmp8Result = tmp17(tmp5(4797).PressableOpacity, obj);
      let tmp14 = tmp17;
    } else {
      ...
      if (!tmp7) {
        ...
        tmp12Result = tmp12(tmp5(4797).PressableOpacity, obj);
      }
      ...
      items1[1] = tmp14(tmp5(4797).PressableOpacity, obj5);
      obj4[0] = items1;
    ...
    obj8[0] = str;
    obj8[1] = tmp8Result;
    return tmp14(tmp2(14042), obj8);
  }
  tmp4 = importDefault(7232)();
}
