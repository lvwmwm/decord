...
// Dependencies: [19, 17, 6918, 21, 4285, 712, 7258, 11245, 1236, 2284, 4281, 7259, 4827, 4490, 14086, 1988, 1297, 9795, 14087, 14084, 14088, 14079, 2]
// Exports: default

// Module 14085 (FamilyCenterPendingLinkRow)
...
function FamilyCenterPendingLinkRow(otherUser) {
  ...
  if (undefined === str) {
    ...
    if (tmp4) {
      ...
      obj = { name: null };
      obj[0] = str;
      obj[1] = intl3.formatToPlainString(tmp2(2284).oUpA6X, obj);
      ...
      let tmp8Result = tmp17(tmp5(4827).PressableOpacity, obj);
      let tmp14 = tmp17;
    } else {
      ...
      if (!tmp7) {
        ...
        obj2[0] = str1;
        obj[1] = intl.formatToPlainString(tmp2(2284).jc1Ip7, obj2);
        obj[2] = function onPress() {
          let obj = outer1_1(outer1_2[13]);
          obj = { otherUser: str };
        ...
        tmp12Result = tmp12(tmp5(4827).PressableOpacity, obj);
      }
      ...
      obj6[0] = str2;
      obj5[1] = intl2.formatToPlainString(tmp2(2284)["4GtllP"], obj6);
      ...
      items1[1] = tmp14(tmp5(4827).PressableOpacity, obj5);
      obj4[0] = items1;
    ...
    obj8[0] = str;
    obj8[1] = tmp8Result;
    return tmp14(tmp2(14079), obj8);
  }
  tmp4 = importDefault(7259)();
}
