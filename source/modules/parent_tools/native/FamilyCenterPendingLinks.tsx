...
// Dependencies: [19, 17, 7230, 21, 4446, 712, 8713, 11430, 1236, 2370, 4442, 8714, 5033, 4689, 14464, 2010, 1297, 9457, 14465, 14462, 14466, 14457, 2]
// Exports: default

// Module 14463 (FamilyCenterPendingLinkRow)
...
function FamilyCenterPendingLinkRow(otherUser) {
  ...
  if (undefined === str) {
    ...
    if (tmp4) {
      ...
      obj = { name: null };
      obj[0] = str;
      obj[1] = intl3.formatToPlainString(tmp2(2370).oUpA6X, obj);
      ...
      let tmp8Result = tmp17(tmp5(5033).PressableOpacity, obj);
      let tmp14 = tmp17;
    } else {
      ...
      if (!tmp7) {
        ...
        obj2[0] = str1;
        obj[1] = intl.formatToPlainString(tmp2(2370).jc1Ip7, obj2);
        obj[2] = function onPress() {
          let obj = closure_1_1(closure_1_2[13]);
          obj = { otherUser: str };
        ...
        tmp12Result = tmp12(tmp5(5033).PressableOpacity, obj);
      }
      ...
      obj6[0] = str2;
      obj5[1] = intl2.formatToPlainString(tmp2(2370)["4GtllP"], obj6);
      ...
      items1[1] = tmp14(tmp5(5033).PressableOpacity, obj5);
      obj4[0] = items1;
