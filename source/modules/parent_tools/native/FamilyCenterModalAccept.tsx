...
// Dependencies: [19, 17, 21, 4302, 712, 4507, 4001, 1236, 11257, 7747, 7748, 14097, 4247, 4298, 2284, 14067, 11259, 11267, 5149, 4712, 5269, 11269, 2]
// Exports: default

// Module 14100 (FamilyCenterModalAcceptScreen)
...
function FamilyCenterModalAcceptScreen(otherUser) {
  ...
  const callback = React.useCallback(() => {
    let arr = acceptLinkRequest(4507);
    arr = arr.pop();
  }, []);
  ...
  obj2[1] = acceptLinkRequest(4247);
  obj2[2] = tmp.icon;
  const items1 = [callback(acceptLinkRequest(14097), obj2), , ];
  ...
  items1[2] = callback(acceptLinkRequest(14067), { user: otherUser });
  obj1[1] = items1;
  const items2 = [callback2(View, obj1), callback(acceptLinkRequest(11259), {}), ];
  ...
  items2[2] = callback(otherUser(4298).Text, obj4);
  obj[0] = items2;
  const items3 = [callback2(otherUser(7748).ModalContent, obj), ];
  ...
  obj8[4] = callback2;
  const items4 = [callback(otherUser(4712).Button, obj8), ];
  ...
  obj9[2] = acceptLinkRequest(4507).pop;
  items4[1] = callback(otherUser(4712).Button, obj9);
  obj7[0] = items4;
  obj6[0] = callback2(otherUser(5149).ButtonGroup, obj7);
  items3[1] = callback(otherUser(11267).ModalFooter, obj6);
  obj[0] = items3;
