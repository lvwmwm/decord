...
// Dependencies: [19, 17, 21, 4481, 709, 4731, 4193, 1233, 11848, 8351, 8352, 14847, 4425, 4477, 2368, 14817, 11850, 11858, 5393, 4936, 5579, 11860, 2]
// Exports: default

// Module 14850 (FamilyCenterModalAcceptScreen)
...
function FamilyCenterModalAcceptScreen(otherUser) {
  ...
  const callback = React.useCallback(() => {
    let arr = acceptLinkRequest(4731);
    arr = arr.pop();
  }, []);
  ...
  const obj2 = { otherUser, iconSrc: acceptLinkRequest(4425), iconStyles: tmp.icon };
  const items1 = [callback(acceptLinkRequest(14847), obj2), , ];
  ...
  items1[2] = callback(acceptLinkRequest(14817), { user: otherUser });
  obj1[1] = items1;
  const items2 = [callback2(View, obj1), callback(acceptLinkRequest(11850), {}), ];
  ...
  items2[2] = callback(otherUser(4477).Text, obj4);
  obj[0] = items2;
  const items3 = [callback2(otherUser(8352).ModalContent, obj), ];
  ...
  obj8[4] = callback2;
  const items4 = [callback(otherUser(4936).Button, obj8), ];
  ...
  obj9[2] = acceptLinkRequest(4731).pop;
  items4[1] = callback(otherUser(4936).Button, obj9);
  obj7[0] = items4;
  obj6[0] = callback2(otherUser(5393).ButtonGroup, obj7);
  items3[1] = callback(otherUser(11858).ModalFooter, obj6);
  obj[0] = items3;
