...
// Dependencies: [19, 17, 21, 4344, 712, 4549, 4061, 1236, 11383, 7848, 7849, 14234, 4289, 4340, 2303, 14204, 11385, 11393, 5190, 4754, 5309, 11395, 2]
// Exports: default
...
function FamilyCenterModalAcceptScreen(otherUser) {
  ...
  const callback = React.useCallback(() => {
    let arr = acceptLinkRequest(4549);
    arr = arr.pop();
  }, []);
  ...
  obj1[1] = items1;
  const items2 = [callback2(View, obj1), callback(acceptLinkRequest(11385), {}), ];
  ...
  items2[2] = callback(otherUser(4340).Text, obj4);
  obj[0] = items2;
  const items3 = [callback2(otherUser(7849).ModalContent, obj), ];
  ...
  obj8[4] = callback2;
  const items4 = [callback(otherUser(4754).Button, obj8), ];
  ...
  obj9[2] = acceptLinkRequest(4549).pop;
  items4[1] = callback(otherUser(4754).Button, obj9);
  obj7[0] = items4;
  obj6[0] = callback2(otherUser(5190).ButtonGroup, obj7);
  items3[1] = callback(otherUser(11393).ModalFooter, obj6);
  obj[0] = items3;
