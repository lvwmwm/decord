...
// Dependencies: [19, 17, 21, 4285, 712, 4490, 3984, 1236, 11242, 7730, 7731, 14083, 4230, 4281, 2284, 14053, 11244, 11252, 5132, 4695, 5253, 11254, 2]
// Exports: default

// Module 14086 (FamilyCenterModalAcceptScreen)
...
function FamilyCenterModalAcceptScreen(otherUser) {
  ...
  const callback = React.useCallback(() => {
    let arr = acceptLinkRequest(4490);
    arr = arr.pop();
  }, []);
  ...
  obj2[2] = tmp.icon;
  const items1 = [callback(acceptLinkRequest(14083), obj2), , ];
  ...
  items1[2] = callback(acceptLinkRequest(14053), { user: otherUser });
  obj1[1] = items1;
  const items2 = [callback2(View, obj1), callback(acceptLinkRequest(11244), {}), ];
  ...
  items2[2] = callback(otherUser(4281).Text, obj4);
  obj[0] = items2;
  const items3 = [callback2(otherUser(7731).ModalContent, obj), ];
  ...
  obj8[4] = callback2;
  const items4 = [callback(otherUser(4695).Button, obj8), ];
  ...
  obj9[2] = acceptLinkRequest(4490).pop;
  items4[1] = callback(otherUser(4695).Button, obj9);
  obj7[0] = items4;
  obj6[0] = callback2(otherUser(5132).ButtonGroup, obj7);
  items3[1] = callback(otherUser(11252).ModalFooter, obj6);
  obj[0] = items3;
