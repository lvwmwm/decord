...
// Dependencies: [5, 19, 17, 1903, 6918, 21, 4285, 712, 1480, 647, 6919, 11241, 6973, 11242, 7730, 7731, 1297, 1416, 1236, 2284, 4281, 11243, 11244, 11252, 5132, 4695, 4490, 5948, 7259, 38, 10955, 7950, 5744, 8776, 1935, 7720, 7722, 4500, 5253, 11253, 11254, 2]
// Exports: default

// Module 11240 (FamilyCenterModalRequestConfirm)
...
function FamilyCenterPrereqLoading(arg0) {
  ...
  obj[1] = callback(require(5744) /* ActivityIndicator */.ActivityIndicator, {});
  obj[0] = callback(closure_6, obj);
  return callback(require(7730) /* ModalScreen */.ModalScreen, obj);
}
function FamilyCenterPrereqScreen(primaryButton) {
  ...
  items1[1] = callback(require(11252) /* ModalFooter */.ModalFooter, obj2);
  obj[0] = items1;
