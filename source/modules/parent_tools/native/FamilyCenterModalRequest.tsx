...
// Dependencies: [5, 19, 17, 1874, 6891, 21, 4255, 712, 1480, 647, 6892, 11207, 6946, 11208, 7729, 7730, 1297, 1416, 1236, 2255, 4251, 11209, 11210, 11218, 5102, 4665, 4460, 5921, 7232, 38, 10923, 7809, 5717, 8747, 1906, 7692, 7694, 4470, 5223, 11219, 11220, 2]
// Exports: default

// Module 11206 (FamilyCenterModalRequestConfirm)
...
function FamilyCenterPrereqLoading(arg0) {
  ...
  obj[1] = callback(require(5717) /* ActivityIndicator */.ActivityIndicator, {});
  obj[0] = callback(closure_6, obj);
  return callback(require(7729) /* ModalScreen */.ModalScreen, obj);
}
function FamilyCenterPrereqScreen(primaryButton) {
  ...
  obj2[0] = callback(require(4665) /* Button */.Button, { text: primaryButton.text, onPress: primaryButton.onPress });
  items1[1] = callback(require(11218) /* ModalFooter */.ModalFooter, obj2);
  obj[0] = items1;
