...
// Dependencies: [5, 19, 17, 1903, 6937, 21, 4302, 712, 1480, 647, 6938, 11256, 6992, 11257, 7747, 7748, 1297, 1416, 1236, 2284, 4298, 11258, 11259, 11267, 5149, 4712, 4507, 5967, 7278, 38, 10970, 7967, 5763, 8793, 1935, 7737, 7739, 4517, 5269, 11268, 11269, 2]
// Exports: default

// Module 11255 (FamilyCenterModalRequestConfirm)
...
function FamilyCenterPrereqLoading(arg0) {
  ...
  obj[1] = callback(require(5763) /* ActivityIndicator */.ActivityIndicator, {});
  obj[0] = callback(closure_6, obj);
  return callback(require(7747) /* ModalScreen */.ModalScreen, obj);
}
function FamilyCenterPrereqScreen(primaryButton) {
  ...
  const items = [callback(require(4298) /* Text */.Text, obj), callback(require(4298) /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", style: tmp.description, children: description })];
  obj[1] = items;
  const items1 = [callback2(closure_6, obj), ];
  const obj2 = { children: null };
  obj2[0] = callback(require(4712) /* Button */.Button, { text: primaryButton.text, onPress: primaryButton.onPress });
  items1[1] = callback(require(11267) /* ModalFooter */.ModalFooter, obj2);
  obj[0] = items1;
  return callback2(require(7747) /* ModalScreen */.ModalScreen, obj);
}
