...
// Dependencies: [32, 19, 17, 6906, 21, 4285, 712, 7260, 6961, 14044, 4281, 11236, 1236, 2285, 14050, 4812, 2]
// Exports: default

// Module 14049 (FamilyCenterActivitySectionHeader)
...
export default function FamilyCenterActivitySection(displayType) {
  ...
  if (0 === actionsForDisplayType.length) {
    ...
    const formatToPlainStringResult = intl.formatToPlainString(loadMore(2285)["7dMmJY"], obj);
    ...
    if (substr.length >= actionTotalsForDisplayType) {
      ...
      if (familyCenterActions.isMoreLoading) {
        ...
        tmp17Result = tmp17(tmp(4812).PressableOpacity, obj5);
      }
      obj2[1] = tmp17Result;
