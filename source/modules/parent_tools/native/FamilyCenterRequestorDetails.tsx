...
// Dependencies: [19, 17, 21, 4302, 1297, 712, 7277, 14067, 4298, 2]
// Exports: default

// Module 14095 (FamilyCenterRequestorDetails)
import "noop";
...
export default function FamilyCenterRequestorDetails(otherUser) {
  ...
  const items1 = [callback(importDefault(14067), { user: otherUser }), callback(require(4298) /* Text */.Text, { variant: "text-xs/semibold", color: "text-muted", children: linkTimestampText })];
  obj1[1] = items1;
