...
// Module 13700 (FamilyCenterRequestorDetails)
importAll(dependencyMap[0]);
const View = arg1(dependencyMap[1]).View;
({ jsx: closure_4, jsxs: closure_5 } = arg1(dependencyMap[2]));
let obj = arg1(dependencyMap[3]);
obj = { container: { "Null": "<string:48410368>", "Null": "<string:48410880>", "Null": "<string:24556288>", "Null": "<string:35324672>" } };
...
export default function FamilyCenterRequestorDetails(otherUser) {
  ...
  const items1 = [callback(importDefault(dependencyMap[7]), { user: otherUser }), callback(arg1(dependencyMap[8]).Text, { children: linkTimestampText })];
