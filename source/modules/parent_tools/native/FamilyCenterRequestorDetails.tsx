...
// Dependencies: [19, 17, 21, 4285, 1297, 712, 7258, 14053, 4281, 2]
// Exports: default

// Module 14081 (FamilyCenterRequestorDetails)
import "noop";
...
export default function FamilyCenterRequestorDetails(otherUser) {
  ...
  const items1 = [callback(importDefault(14053), { user: otherUser }), callback(require(4281) /* Text */.Text, { variant: "text-xs/semibold", color: "text-muted", children: linkTimestampText })];
  obj1[1] = items1;
