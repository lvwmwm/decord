...
// Dependencies: [19, 21, 4342, 712, 5789, 4909, 8846, 2]
// Exports: default

// Module 14244 (FamilyCenterLinkRowWrapper)
import "noop";
...
export default function FamilyCenterLinkRowWrapper(userId) {
  ...
  if (undefined !== userId) {
    ...
    tmp3 = jsx(userId(4909).PressableOpacity, { style: null, onPress: null, children: null });
  }
  return tmp3;
};
