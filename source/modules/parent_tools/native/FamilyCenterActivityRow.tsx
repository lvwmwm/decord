...
// Function ID: 14507
// Name: memoResult1
// Dependencies: [19, 17, 1922, 7282, 7283, 676, 21, 4478, 712, 1297, 38, 647, 11, 4474, 4322, 7338, 6004, 7673, 1236, 2369, 14507, 14510, 14511, 2]
// Exports: default
...
import FamilyCenterActivityPurchaseRowDefault from "FamilyCenterActivityPurchaseRow" /* 14507 */;
import FamilyCenterActivityGiftRowDefault from "FamilyCenterActivityGiftRow" /* 14511 */;
import importAllResult from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_4 from "mergeGuildAvatar" /* 1922 */;
import closure_5 from "freshTeenActivityWithMap" /* 7282 */;
import { ACTION_TO_TEXT } from "items" /* 7283 */;
...
const memoResult = importAllResult.memo((action) => {
  ...
  if (null == stateFromStores) {
    ...
    obj1 = { avatarStyle: null, user: null, guildId: "HermesInternal", disablePlaceholder: null, avatarDecoration: -1 };
    obj1[0] = tmp.avatar;
    ...
    obj4[2] = tmp6(7338).formatUserActivityTimestamp(date.getTime(), value.timestampFormatter);
