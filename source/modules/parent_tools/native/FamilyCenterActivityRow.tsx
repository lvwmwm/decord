...
// Function ID: 14018
// Name: memoResult1
// Dependencies: [19, 17, 1874, 6893, 6894, 676, 21, 4255, 712, 1297, 38, 647, 11, 4251, 4094, 6949, 5632, 9349, 1236, 2255, 14018, 14021, 14022, 2]
// Exports: default

// Module 14017 (memoResult1)
...
const memoResult = importAllResult.memo((action) => {
  ...
  if (null == stateFromStores) {
    ...
    obj4[2] = tmp6(6949).formatUserActivityTimestamp(date.getTime(), value.timestampFormatter);
...
const memoResult1 = importAllResult.memo((action) => {
  ...
  if (undefined === stateFromStores) {
    ...
    let tmp6Result = tmp6(5632);
    obj[3] = tmp2(5632).GuildIconSizes.NORMAL;
...
export default function FamilyCenterActivityRow(action) {
  ...
  if (tmpResult2.isPurchase(action)) {
    ...
    if (null != purchaseInfo) {
      ...
      tmp14 = callback(importDefault(14018), obj);
    }
    return tmp14;
  } else {
    if (tmpResult3.isGift(action)) {
      ...
      if (null == giftInfo) {
        ...
        const giftRowDisplayInfo = tmp(14021).getGiftRowDisplayInfo(giftInfo);
  ...
  tmpResult2 = require(6949) /* getEmptyActivityFormatter */;
};
