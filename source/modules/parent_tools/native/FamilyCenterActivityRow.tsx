...
// Function ID: 14148
// Name: memoResult1
// Dependencies: [19, 17, 1903, 6996, 6997, 676, 21, 4303, 712, 1297, 38, 647, 11, 4299, 4146, 7052, 5779, 8438, 1236, 2284, 14148, 14151, 14152, 2]
// Exports: default

// Module 14147 (memoResult1)
...
const memoResult = importAllResult.memo((action) => {
  ...
  if (null == stateFromStores) {
    ...
    obj4[2] = tmp6(7052).formatUserActivityTimestamp(date.getTime(), value.timestampFormatter);
...
const memoResult1 = importAllResult.memo((action) => {
  ...
  if (undefined === stateFromStores) {
    ...
    if (hasItem) {
      ...
      tmp6Result = tmp6(8438);
      obj4[2] = tmp6(8438).Sizes.SMALL;
...
export default function FamilyCenterActivityRow(action) {
  ...
  if (tmpResult2.isPurchase(action)) {
    ...
    if (null != purchaseInfo) {
      ...
      tmp14 = callback(importDefault(14148), obj);
    }
    return tmp14;
  } else {
    if (tmpResult3.isGift(action)) {
      ...
      if (null == giftInfo) {
        ...
        const giftRowDisplayInfo = tmp(14151).getGiftRowDisplayInfo(giftInfo);
        ...
        obj[5] = offeredAt;
        obj[6] = claimedAt;
        return callback(importDefault(14152), obj);
      }
    } else {
  ...
  tmpResult2 = require(7052) /* getEmptyActivityFormatter */;
};
