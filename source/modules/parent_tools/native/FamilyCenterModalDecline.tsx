...
// Module 13891 (FamilyCenterModalDeclineScreen)
...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  declineLinkRequest(44)(!declineLinkRequest(6201)(), "FamilyCenterDeclineLinkModal should only be rendered for teens.");
  obj = {};
  obj = {};
  const obj1 = { style: tmp.header };
  const obj2 = { otherUser };
  const tmp2 = declineLinkRequest(6201)();
  obj2.iconSrc = declineLinkRequest(7640);
  const items1 = [callback(declineLinkRequest(13887), obj2), , ];
  ...
  items1[2] = callback(declineLinkRequest(13857), { user: otherUser });
  ...
  const items3 = [callback(otherUser(4127).Text, obj5), ];
  ...
  items3[1] = callback(otherUser(4127).Text, obj6);
  obj4.children = items3;
  items2[1] = callback2(View, obj4);
  obj.children = items2;
  const items4 = [callback2(otherUser(6726).ModalContent, obj), ];
  const obj7 = {};
  const obj8 = {};
  ...
  const items5 = [callback(otherUser(4544).Button, obj9), ];
  const obj10 = { variant: "tertiary" };
  const intl5 = otherUser(1212).intl;
  obj10.text = intl5.string(otherUser(1212).t["ETE/oC"]);
  obj10.onPress = declineLinkRequest(4338).pop;
  items5[1] = callback(otherUser(4544).Button, obj10);
  obj8.children = items5;
  obj7.children = callback2(otherUser(4966).ButtonGroup, obj8);
  items4[1] = callback(otherUser(11057).ModalFooter, obj7);
  obj.children = items4;
