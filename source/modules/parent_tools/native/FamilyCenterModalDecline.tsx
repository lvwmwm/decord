...
// Module 14851 (FamilyCenterModalDeclineScreen)
...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  const callback = React.useCallback(() => {
    let arr = declineLinkRequest(4731);
    arr = arr.pop();
  }, []);
  ...
  declineLinkRequest(38)(!declineLinkRequest(8576)(), "FamilyCenterDeclineLinkModal should only be rendered for teens.");
  obj = { children: null };
  obj = { children: null };
  obj1 = { style: tmp.header, children: null };
  const obj2 = { otherUser, iconSrc: null };
  const tmp2 = declineLinkRequest(8576)();
  obj2[1] = declineLinkRequest(6932);
  const items1 = [callback(declineLinkRequest(14847), obj2), , ];
  ...
  items1[2] = callback(declineLinkRequest(14817), { user: otherUser });
  obj1[1] = items1;
  ...
  const items3 = [callback(otherUser(4477).Text, obj5), ];
  ...
  items3[1] = callback(otherUser(4477).Text, obj6);
  obj4[1] = items3;
  items2[1] = callback2(View, obj4);
  obj[0] = items2;
  const items4 = [callback2(otherUser(8352).ModalContent, obj), ];
  ...
  obj9[4] = callback2;
  const items5 = [callback(otherUser(4936).Button, obj9), ];
  ...
  obj10[2] = declineLinkRequest(4731).pop;
  items5[1] = callback(otherUser(4936).Button, obj10);
  obj8[0] = items5;
  obj7[0] = callback2(otherUser(5393).ButtonGroup, obj8);
  items4[1] = callback(otherUser(11858).ModalFooter, obj7);
  obj[0] = items4;
