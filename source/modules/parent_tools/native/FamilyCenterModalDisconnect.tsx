...
// Dependencies: [32, 19, 17, 21, 4446, 712, 4689, 4290, 8713, 4162, 1236, 11427, 11430, 2370, 8638, 8639, 14461, 7711, 4442, 14413, 4891, 9306, 11437, 5341, 4893, 5460, 11439, 2]
// Exports: default

// Module 14460 (FamilyCenterModalDisconnectScreen)
...
import FamilyCenterAvatarPairDefault from "FamilyCenterAvatarPair" /* 14461 */;
...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  if (requiresParentalConsent) {
    ...
    tmp28Result = tmp28(tmp3(14413), obj3);
  }
  obj4 = { children: null };
  items4[1] = tmp28Result;
  obj5 = { style: tmp.body, variant: "text-md/normal", color: "text-default", children: ageSpecificText2 };
  items4[2] = callback(otherUser(4442).Text, obj5);
  obj6 = { spacing: tmp3(712).space.PX_12, children: null };
  const items5 = [callback(otherUser(9306).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }), callback(otherUser(9306).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 })];
  obj6[1] = items5;
  items4[3] = callback2(otherUser(4891).Stack, obj6);
  obj4[0] = items4;
  const items6 = [callback2(otherUser(8639).ModalContent, obj4), ];
  let tmp31 = !tmp9;
  if (tmp9) {
    tmp31 = !tmp11;
  }
  ...
  obj10[4] = callback2;
  const items7 = [callback(otherUser(4893).Button, obj10), ];
  ...
  obj11[2] = _modDef4689.pop;
  items7[1] = callback(otherUser(4893).Button, obj11);
  obj9[0] = items7;
  obj8[0] = callback2(otherUser(5341).ButtonGroup, obj9);
  items6[1] = callback(otherUser(11437).ModalFooter, obj8);
  obj7[0] = items6;
  return callback2(otherUser(8638).ModalScreen, obj7);
}
