...
// Dependencies: [32, 19, 17, 21, 4445, 712, 4676, 4289, 8697, 4161, 1236, 11408, 11411, 2369, 8623, 8624, 14477, 7697, 4441, 14429, 4878, 9288, 11418, 5328, 4880, 5447, 11420, 2]
// Exports: default

// Module 14476 (FamilyCenterModalDisconnectScreen)
...
import FamilyCenterAvatarPairDefault from "FamilyCenterAvatarPair" /* 14477 */;
...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  if (requiresParentalConsent) {
    ...
    tmp28Result = tmp28(tmp3(14429), obj3);
  }
  obj4 = { children: null };
  items4[1] = tmp28Result;
  obj5 = { style: tmp.body, variant: "text-md/normal", color: "text-default", children: ageSpecificText2 };
  items4[2] = callback(otherUser(4441).Text, obj5);
  obj6 = { spacing: tmp3(712).space.PX_12, children: null };
  const items5 = [callback(otherUser(9288).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }), callback(otherUser(9288).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 })];
  obj6[1] = items5;
  items4[3] = callback2(otherUser(4878).Stack, obj6);
  obj4[0] = items4;
  const items6 = [callback2(otherUser(8624).ModalContent, obj4), ];
  let tmp31 = !tmp9;
  if (tmp9) {
    tmp31 = !tmp11;
  }
  ...
  obj10[4] = callback2;
  const items7 = [callback(otherUser(4880).Button, obj10), ];
  ...
  obj11[2] = _modDef4676.pop;
  items7[1] = callback(otherUser(4880).Button, obj11);
  obj9[0] = items7;
  obj8[0] = callback2(otherUser(5328).ButtonGroup, obj9);
  items6[1] = callback(otherUser(11418).ModalFooter, obj8);
  obj7[0] = items6;
  return callback2(otherUser(8623).ModalScreen, obj7);
}
