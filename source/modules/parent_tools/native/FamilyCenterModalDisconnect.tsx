...
// Dependencies: [32, 19, 17, 21, 4255, 712, 4461, 4094, 7247, 3955, 1236, 11237, 11240, 2255, 7745, 7746, 14039, 7825, 4251, 13991, 4664, 9202, 11247, 5088, 4666, 5209, 11249, 2]
// Exports: default

// Module 14038 (FamilyCenterModalDisconnectScreen)
...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  obj[1] = importDefault(7825);
  const items3 = [callback(importDefault(14039), obj), , ];
  ...
  if (requiresParentalConsent) {
    ...
    tmp28Result = tmp28(tmp3(13991), obj3);
  }
  obj4 = { children: null };
  ...
  const items5 = [callback(otherUser(9202).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }), callback(otherUser(9202).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 })];
  obj6[1] = items5;
  items4[3] = callback2(otherUser(4664).Stack, obj6);
  obj4[0] = items4;
  const items6 = [callback2(otherUser(7746).ModalContent, obj4), ];
  let tmp31 = !tmp9;
  if (tmp9) {
    tmp31 = !tmp11;
  }
  ...
  obj10[4] = callback2;
  const items7 = [callback(otherUser(4666).Button, obj10), ];
  ...
  obj11[2] = importDefault(4461).pop;
  items7[1] = callback(otherUser(4666).Button, obj11);
  obj9[0] = items7;
  obj8[0] = callback2(otherUser(5088).ButtonGroup, obj9);
  items6[1] = callback(otherUser(11247).ModalFooter, obj8);
  obj7[0] = items6;
  return callback2(otherUser(7745).ModalScreen, obj7);
}
