...
// Dependencies: [32, 19, 17, 21, 4342, 712, 4572, 4187, 7403, 4061, 1236, 11391, 11394, 2303, 7873, 7874, 14247, 8093, 4338, 14199, 4775, 10512, 11401, 5212, 4777, 5331, 11403, 2]
// Exports: default

// Module 14246 (FamilyCenterModalDisconnectScreen)
...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  obj[1] = importDefault(8093);
  const items3 = [callback(importDefault(14247), obj), , ];
  ...
  if (requiresParentalConsent) {
    ...
    tmp28Result = tmp28(tmp3(14199), obj3);
  }
  obj4 = { children: null };
  ...
  const items5 = [callback(otherUser(10512).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }), callback(otherUser(10512).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 })];
  obj6[1] = items5;
  items4[3] = callback2(otherUser(4775).Stack, obj6);
  obj4[0] = items4;
  const items6 = [callback2(otherUser(7874).ModalContent, obj4), ];
  let tmp31 = !tmp9;
  if (tmp9) {
    tmp31 = !tmp11;
  }
  ...
  obj10[4] = callback2;
  const items7 = [callback(otherUser(4777).Button, obj10), ];
  ...
  obj11[2] = importDefault(4572).pop;
  items7[1] = callback(otherUser(4777).Button, obj11);
  obj9[0] = items7;
  obj8[0] = callback2(otherUser(5212).ButtonGroup, obj9);
  items6[1] = callback(otherUser(11401).ModalFooter, obj8);
  obj7[0] = items6;
  return callback2(otherUser(7873).ModalScreen, obj7);
}
