...
// Dependencies: [32, 19, 17, 21, 4448, 712, 4691, 4292, 8735, 4163, 1236, 11456, 11459, 2369, 8660, 8661, 14495, 7732, 4444, 14447, 4894, 9328, 11466, 5344, 4896, 5463, 11468, 2]
// Exports: default

// Module 14494 (FamilyCenterModalDisconnectScreen)
...
import FamilyCenterAvatarPairDefault from "FamilyCenterAvatarPair" /* 14495 */;
...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  if (requiresParentalConsent) {
    ...
    tmp28Result = tmp28(tmp3(14447), obj3);
  }
  obj4 = { children: null };
  items4[1] = tmp28Result;
  obj5 = { style: tmp.body, variant: "text-md/normal", color: "text-default", children: ageSpecificText2 };
  items4[2] = callback(otherUser(4444).Text, obj5);
  obj6 = { spacing: tmp3(712).space.PX_12, children: null };
  const items5 = [callback(otherUser(9328).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }), callback(otherUser(9328).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 })];
  obj6[1] = items5;
  items4[3] = callback2(otherUser(4894).Stack, obj6);
  obj4[0] = items4;
  const items6 = [callback2(otherUser(8661).ModalContent, obj4), ];
  let tmp31 = !tmp9;
  if (tmp9) {
    tmp31 = !tmp11;
  }
  ...
  obj10[4] = callback2;
  const items7 = [callback(otherUser(4896).Button, obj10), ];
  ...
  obj11[2] = _modDef4691.pop;
  items7[1] = callback(otherUser(4896).Button, obj11);
  obj9[0] = items7;
  obj8[0] = callback2(otherUser(5344).ButtonGroup, obj9);
  items6[1] = callback(otherUser(11466).ModalFooter, obj8);
  obj7[0] = items6;
  return callback2(otherUser(8660).ModalScreen, obj7);
}
