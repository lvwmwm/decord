...
// Module 13701 (FamilyCenterModalDisconnectScreen)
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  obj6 = { "Null": "absolute", "Null": 0, "Null": "center", style: tmp.body, children: ageSpecificText2 };
...
obj = {};
obj = { cix: 0, y: 0, isArray: 0, marginBottom: importDefault(dependencyMap[5]).space.PX_16 };
obj.header = obj;
