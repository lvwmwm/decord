...
// Dependencies: [19, 17, 6890, 6891, 21, 4255, 712, 647, 4223, 14004, 5323, 4251, 1236, 2255, 14005, 4665, 2]
// Exports: default

// Module 14003 (ConnectGuardianBottomSheet)
...
export default function ConnectGuardianBottomSheet(arg0) {
  ...
  obj4[2] = onRefresh;
  obj3[1] = closure_7(require(14005) /* ConnectGuardianCard */.ConnectGuardianCard, obj4);
  ...
  obj6[3] = callback;
  items3[2] = closure_7(require(4665) /* Button */.Button, obj6);
  obj[1] = items3;
  obj5[1] = closure_8(View, obj);
  return closure_7(require(5323) /* Background */.BottomSheet, obj5);
};
