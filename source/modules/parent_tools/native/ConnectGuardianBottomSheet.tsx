...
// Dependencies: [19, 17, 5296, 5297, 21, 4661, 712, 647, 4342, 14237, 6950, 4734, 1236, 2335, 14238, 4745, 2]
// Exports: default
...
export default function ConnectGuardianBottomSheet(arg0) {
  ...
  obj1[4] = title;
  const items2 = [closure_7(require(4734) /* Text */.Text, obj1), ];
  ...
  obj2[3] = body;
  items2[1] = closure_7(require(4734) /* Text */.Text, obj2);
  obj[1] = items2;
  ...
  obj4[2] = onRefresh;
  obj3[1] = closure_7(require(14238) /* ConnectGuardianCard */.ConnectGuardianCard, obj4);
  items3[1] = closure_7(View, obj3);
  const obj6 = { variant: "secondary", size: "md", text: null, onPress: null };
  const intl3 = tmp2(1236).intl;
  obj6[2] = intl3.string(importDefault(2335).Hsm5IF);
  obj6[3] = callback;
  items3[2] = closure_7(require(4745) /* Button */.Button, obj6);
  obj[1] = items3;
  obj5[1] = closure_8(View, obj);
  return closure_7(require(6950) /* Background */.BottomSheet, obj5);
};
