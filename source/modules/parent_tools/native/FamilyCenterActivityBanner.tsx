...
// Module 13648 (FamilyCenterActivityBannerButton)
...
obj = {};
obj = { position: false, zIndex: false, overflow: false, stateMachine: false, fit: false, alignment: false, backgroundColor: importDefault(dependencyMap[7]).colors.BACKGROUND_BASE_LOW, borderRadius: importDefault(dependencyMap[7]).radii.md };
obj.container = obj;
...
export default function FamilyCenterActivityBanner() {
  ...
  obj2 = { Promise: null, marginTop: null, flags: null, style: tmp3.description, children: ageSpecificText1 };
