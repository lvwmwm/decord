...
// Dependencies: [19, 17, 21, 4344, 7377, 7378, 14188, 712, 11386, 1236, 2303, 14195, 14196, 4340, 2]
// Exports: default
...
export default function FamilyCenterActivityBanner() {
  ...
  items[2] = closure_5(require(4340) /* Text */.Text, obj2);
