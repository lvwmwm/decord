...
// Dependencies: [19, 17, 21, 4344, 4189, 4340, 2]
// Exports: default

// Module 14204 (FamilyCenterUsernameHeader)
import "noop";
...
export default function FamilyCenterUsernameHeader(user) {
  ...
  const combined = " (@" + importDefault(4189).getUserTag(user, { decoration: "never" }) + ")";
  obj = { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: null };
  const items = [name, callback(require(4340) /* Text */.Text, { variant: "text-md/medium", color: "text-muted", lineClamp: 1, children: combined })];
  obj[3] = items;
