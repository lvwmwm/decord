...
// Dependencies: [19, 17, 21, 4661, 712, 7622, 11107, 1236, 2335, 14271, 4734, 14233, 2]
// Exports: default

// Module 14270 (FamilyCenterLinkingBannerParentContent)
import "noop";
...
function FamilyCenterLinkingBannerParentContent() {
  ...
  obj[1] = intl.string(importDefault(2335)["7xxAni"]);
  const intl2 = require(1236) /* getSystemLocale */.intl;
  obj[2] = intl2.string(importDefault(2335)["1M9So2"]);
  const items = [callback(FamilyCenterLinkingInstructionsRow, obj), , , ];
  obj = { index: 2, header: null, description: null };
  const intl3 = require(1236) /* getSystemLocale */.intl;
  obj[1] = intl3.string(importDefault(2335)["AXgx+a"]);
  const intl4 = require(1236) /* getSystemLocale */.intl;
  obj[2] = intl4.string(importDefault(2335).GzMFnb);
  ...
  obj1[1] = intl5.string(importDefault(2335).MZn1tG);
  const intl6 = require(1236) /* getSystemLocale */.intl;
  obj1[2] = intl6.string(importDefault(2335)["8rLBxD"]);
  items[2] = callback(FamilyCenterLinkingInstructionsRow, obj1);
  items[3] = callback(require(14233) /* FamilyCenterTeenQRCodeButtonInner */.FamilyCenterParentQRCodeButton, {});
  obj[1] = items;
  return callback2(closure_3, obj);
}
function FamilyCenterLinkingBannerTeenContent() {
  return callback(closure_3, { style: createCacheKey().container, children: callback(require(14233) /* FamilyCenterTeenQRCodeButtonInner */.FamilyCenterTeenQRCodeButton, {}) });
}
function FamilyCenterLinkingInstructionsRow(arg0) {
  ...
  obj = { style: tmp.circle, children: callback(require(4734) /* Text */.Text, { variant: "heading-md/semibold", color: "text-brand", children: index }) };
  ...
  items1[1] = gap;
  const items2 = [callback(require(4734) /* Text */.Text, { variant: "heading-sm/bold", children: header }), callback(require(4734) /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", children: description })];
  obj[1] = items2;
...
export default function FamilyCenterLinkingBanner() {
  ...
  const intl2 = require(1236) /* getSystemLocale */.intl;
  const ageSpecificText = obj.useAgeSpecificText(intl.string(importDefault(2335).zUCWEL), intl2.string(importDefault(2335).B0NPbp));
  let obj1 = require(11107) /* useAgeSpecificText */;
  const intl3 = require(1236) /* getSystemLocale */.intl;
  const stringResult = intl.string(importDefault(2335).zUCWEL);
  const intl4 = require(1236) /* getSystemLocale */.intl;
  obj = { style: tmp.container, children: null };
  obj = { source: null, style: null, resizeMethod: "resize" };
  const ageSpecificText1 = obj1.useAgeSpecificText(intl3.format(importDefault(2335).yMnoDl, { link: "https://support.discord.com/hc/articles/14155060633623" }), intl4.string(importDefault(2335).JsAEDi));
  obj[0] = importDefault(14271);
  obj[1] = tmp.art;
  const items = [callback(closure_4, obj), , ];
  obj1 = { style: tmp.content, children: null };
  const items1 = [callback(require(4734) /* Text */.Text, { style: tmp.header, variant: "heading-lg/semibold", children: ageSpecificText }), callback(require(4734) /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", children: ageSpecificText1 })];
  obj1[1] = items1;
