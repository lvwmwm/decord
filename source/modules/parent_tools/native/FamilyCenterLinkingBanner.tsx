...
// Dependencies: [19, 17, 21, 4342, 712, 7404, 11394, 1236, 2303, 14239, 4338, 14201, 2]
// Exports: default

// Module 14238 (FamilyCenterLinkingBannerParentContent)
import "noop";
...
function FamilyCenterLinkingBannerParentContent() {
  ...
  items[3] = callback(require(14201) /* FamilyCenterTeenQRCodeButtonInner */.FamilyCenterParentQRCodeButton, {});
  obj[1] = items;
  return callback2(closure_3, obj);
}
function FamilyCenterLinkingBannerTeenContent() {
  return callback(closure_3, { style: createCacheKey().container, children: callback(require(14201) /* FamilyCenterTeenQRCodeButtonInner */.FamilyCenterTeenQRCodeButton, {}) });
}
function FamilyCenterLinkingInstructionsRow(arg0) {
  ...
  obj = { style: tmp.circle, children: callback(require(4338) /* Text */.Text, { variant: "heading-md/semibold", color: "text-brand", children: index }) };
  ...
  items1[1] = gap;
  const items2 = [callback(require(4338) /* Text */.Text, { variant: "heading-sm/bold", children: header }), callback(require(4338) /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", children: description })];
  obj[1] = items2;
...
export default function FamilyCenterLinkingBanner() {
  ...
  const items1 = [callback(require(4338) /* Text */.Text, { style: tmp.header, variant: "heading-lg/semibold", children: ageSpecificText }), callback(require(4338) /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", children: ageSpecificText1 })];
  obj1[1] = items1;
