...
// Dependencies: [19, 17, 676, 7753, 21, 10116, 1236, 1945, 13673, 2]
// Exports: default

// Module 13956 (FamilyCenterParentalControlsContentAndSocial)
import "noop";
...
export default function FamilyCenterParentalControlsContentAndSocial() {
  let obj = require(10116) /* createToggle */;
  obj = { sections: null };
  ...
  obj4[0] = jsx(importDefault(13673), { node: list });
