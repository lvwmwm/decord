...
// Dependencies: [19, 17, 676, 7756, 21, 10120, 1236, 1945, 13678, 2]
// Exports: default

// Module 13961 (FamilyCenterParentalControlsContentAndSocial)
import "noop";
...
export default function FamilyCenterParentalControlsContentAndSocial() {
  let obj = require(10120) /* createToggle */;
  obj = { sections: null };
  ...
  obj4[0] = jsx(importDefault(13678), { node: list });
