...
// Dependencies: [19, 17, 21, 4342, 712, 7382, 4550, 4061, 1236, 11374, 38, 7852, 7853, 14243, 8072, 4338, 2303, 14213, 11384, 5191, 4755, 5310, 11386, 2]
// Exports: default

// Module 14248 (FamilyCenterModalCancelScreen)
...
function FamilyCenterModalCancelScreen(otherUser) {
  ...
  const callback = React.useCallback(() => {
    let arr = cancelLinkRequest(4550);
    arr = arr.pop();
  }, []);
  ...
  cancelLinkRequest(38)(cancelLinkRequest(7382)(), "FamilyCenterCancelModal should only be rendered for parents.");
  obj = { children: null };
  obj = { children: null };
  ...
  obj6[4] = callback2;
  const items3 = [callback(otherUser(4755).Button, obj6), ];
  ...
  obj7[2] = cancelLinkRequest(4550).pop;
