...
// Module 13649 (FamilyCenterTeenQRCodeButtonInner)
function FamilyCenterTeenQRCodeButtonInner() {
  ...
  obj1.icon = callback(arg1(dependencyMap[25]).QrCodeIcon, {});
...
class FamilyCenterBannerButton {
  constructor(arg0) {
    ...
    obj1 = { "Bool(true)": "text-sm/bold", "Bool(true)": "text-muted", "Bool(true)": "BUG_REPORTER" };
    obj1.style = tmp.art;
...
let closure_15 = arg1(dependencyMap[8]).createStyles({ button: { flexGrow: true, justifyContent: true, marginBottom: true }, art: { useTrackPdpClick: 0, GameDetectionDebugLevel: 1, presenceCount: 3 } });
