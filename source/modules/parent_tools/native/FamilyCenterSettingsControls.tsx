...
// Dependencies: [19, 17, 6918, 676, 21, 4285, 712, 4281, 1236, 2284, 4490, 14068, 1988, 14070, 5354, 7258, 14054, 6974, 1480, 14071, 4693, 5688, 4695, 6967, 4295, 13986, 6919, 14072, 2]
// Exports: default

// Module 14067 (SpendingLimitRow)
...
function SpendingLimitRow(teenId) {
  ...
  if ("off" === kind) {
    ...
    obj[2] = intl2.string(importDefault(2284).YEnpaj);
    obj[0] = callback(tmp2(4281).Text, obj);
    let tmp8 = obj;
    const stringResult = intl2.string(importDefault(2284).YEnpaj);
  } else if ("on" === kind) {
    ...
    obj8[2] = intl.string(importDefault(2284).Q2msVQ);
    obj6[1] = callback(tmp2(4281).Text, obj8);
    tmp8 = obj6;
    const stringResult1 = intl.string(importDefault(2284).Q2msVQ);
