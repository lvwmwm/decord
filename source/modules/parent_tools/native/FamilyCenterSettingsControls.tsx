...
// Dependencies: [19, 17, 7471, 673, 21, 4481, 709, 4477, 1233, 2368, 4731, 14832, 2008, 14834, 5560, 8575, 14818, 7527, 1498, 14835, 4934, 5642, 4936, 7520, 4494, 14750, 7472, 14836, 2]
// Exports: default

// Module 14831 (SpendingLimitRow)
...
function SpendingLimitRow(teenId) {
  ...
  if ("off" === kind) {
    ...
    obj[0] = callback(tmp2(4477).Text, obj);
    let tmp8 = obj;
    ...
    obj1[0] = callback(tmp2(4477).Text, obj2);
    tmp8 = obj1;
    ...
    obj3[0] = callback(tmp2(4477).Text, obj4);
    ...
    obj6[0] = callback(tmp2(4477).Text, obj7);
    ...
    obj6[1] = callback(tmp2(4477).Text, obj8);
    tmp8 = obj6;
    ...
    obj9[0] = callback(tmp2(4477).Text, obj10);
    ...
    obj9[1] = callback(tmp2(4477).Text, obj11);
    tmp8 = obj9;
  ...
  obj12[4] = null != teenId;
  obj12[5] = null == teenId;
  return callback(teenId(5560).TableRow, obj12);
}
...
function FamilyCenterSettingsParentalControls() {
  ...
  const ParentalControlledSpendingLimit = tmp2(14750).ParentalControlledSpendingLimit;
  let id;
  if (selectedTeenUser != null) {
  ...
  ({ subLabel, trailing } = shouldLoadSettingsForSelectedTeenUser(14835)(rules));
  ...
  const items1 = [callback(selectedTeenUser(4477).Text, obj), , ];
  ...
  items1[1] = callback(selectedTeenUser(4477).Text, obj1);
  ...
  const items2 = [callback(selectedTeenUser(5560).TableRow, obj3), , , ];
  ...
  items2[1] = callback(selectedTeenUser(5560).TableRow, obj4);
  ...
  if (tmp15Result) {
    ...
    tmp15Result = tmp15(tmp2(5560).TableRow, obj6);
  }
  items2[3] = tmp15Result;
  obj2[1] = closure_8(selectedTeenUser(5642).TableRowGroup, { hasIcons: false, children: items2 });
  items1[2] = callback(View, obj2);
  obj[1] = items1;
  return closure_8(selectedTeenUser(4934).Stack, obj);
}
