...
// Dependencies: [19, 17, 7067, 676, 21, 4342, 712, 4338, 1236, 2303, 4572, 14232, 2007, 14234, 5435, 7403, 14218, 7123, 1499, 14235, 4775, 5828, 4777, 7116, 4355, 14150, 7068, 14236, 2]
// Exports: default

// Module 14231 (SpendingLimitRow)
...
function SpendingLimitRow(teenId) {
  ...
  if ("off" === kind) {
    ...
    obj[2] = intl2.string(importDefault(2303).YEnpaj);
    obj[0] = callback(tmp2(4338).Text, obj);
    let tmp8 = obj;
    const stringResult = intl2.string(importDefault(2303).YEnpaj);
  } else if ("on" === kind) {
    ...
    obj8[2] = intl.string(importDefault(2303).Q2msVQ);
    obj6[1] = callback(tmp2(4338).Text, obj8);
    tmp8 = obj6;
    const stringResult1 = intl.string(importDefault(2303).Q2msVQ);
