...
// Function ID: 14016
// Name: Row
// Dependencies: [19, 17, 6891, 21, 4751, 11212, 3957, 7611, 4753, 11214, 4219, 9464, 4255, 712, 4251, 11211, 1236, 2255, 7232, 6946, 7729, 7730, 11218, 4665, 4460, 5223, 11220, 2]
// Exports: default
...
function FamilyCenterModalDataTooltipScreen() {
  ...
  _require = importDefault(7232)();
  let obj1 = _require(6946);
  ...
  const items1 = [callback(_require(7730).ModalContent, obj), ];
  const obj3 = { children: null };
  const obj4 = { variant: "primary", text: null, onPress: null };
  const intl3 = _require(1236).intl;
  obj4[1] = intl3.string(_require(1236).t["NX+WJN"]);
  obj4[2] = importDefault(4460).pop;
  obj3[0] = callback(_require(4665).Button, obj4);
  items1[1] = callback(_require(11218).ModalFooter, obj3);
  obj[0] = items1;
  return callback2(_require(7729).ModalScreen, obj);
}
...
export default function FamilyCenterModalDataTooltip() {
  ...
  return callback(require(11220) /* Modal */.Modal, obj);
};
