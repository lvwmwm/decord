...
// Function ID: 14204
// Name: Row
// Dependencies: [19, 17, 7039, 21, 4840, 11387, 4063, 7759, 4842, 11389, 4308, 9620, 4344, 712, 4340, 11386, 1236, 2303, 7378, 7094, 7848, 7849, 11393, 4754, 4549, 5309, 11395, 2]
// Exports: default
...
function Row(arg0) {
  ...
  const items1 = [callback(require(4340) /* Text */.Text, { style: tmp.header, variant: "text-sm/bold", color: "mobile-text-heading-primary", children: header }), callback(require(4340) /* Text */.Text, { variant: "text-xs/medium", color: "text-default", children: description })];
  obj1[1] = items1;
...
function FamilyCenterModalDataTooltipScreen() {
  ...
  _require = importDefault(7378)();
  let obj1 = _require(7094);
  const sortedActivityTypeConfigs = obj1.getSortedActivityTypeConfigs();
  obj = { children: null };
  obj = { children: null };
  obj1 = { style: tmp.container, children: null };
  const items = [
    callback(_require(4340).Text, { style: tmp.groupHeader, variant: "text-lg/bold", color: "mobile-text-heading-primary", children: ageSpecificText }),
  ...
  const items1 = [callback(_require(7849).ModalContent, obj), ];
  const obj3 = { children: null };
  const obj4 = { variant: "primary", text: null, onPress: null };
  const intl3 = _require(1236).intl;
  obj4[1] = intl3.string(_require(1236).t["NX+WJN"]);
  obj4[2] = importDefault(4549).pop;
  obj3[0] = callback(_require(4754).Button, obj4);
  items1[1] = callback(_require(11393).ModalFooter, obj3);
  obj[0] = items1;
  return callback2(_require(7848).ModalScreen, obj);
}
...
export default function FamilyCenterModalDataTooltip() {
  ...
  return callback(require(11395) /* Modal */.Modal, obj);
};
