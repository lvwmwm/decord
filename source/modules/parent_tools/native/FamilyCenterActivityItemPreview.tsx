...
// Dependencies: [19, 17, 8818, 21, 4303, 14147, 712, 9391, 8797, 9395, 11525, 7695, 7704, 1930, 1927, 2]
// Exports: default

// Module 14148 (AvatarDecorationPreviewImage)
import "noop";
...
function ProfileFramePreviewImage(arg0) {
  ...
  if (null != tmp3) {
    ...
    obj[0] = tmp3;
    obj[1] = require(14147) /* getCollectibleTypeName */.PREVIEW_SIZE * closure_5;
    obj[2] = require(14147) /* getCollectibleTypeName */.PREVIEW_SIZE;
...
function SubscriptionPreview(arg0) {
  ...
  if (null == subscriptionPlanId) {
    ...
    obj[1] = jsx(require(11525) /* ShopIcon */.ShopIcon, { size: "custom", style: null });
