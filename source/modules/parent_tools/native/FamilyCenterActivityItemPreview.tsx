...
// Dependencies: [19, 17, 8758, 21, 4302, 14077, 712, 9326, 8737, 9330, 11459, 7635, 7644, 1930, 1927, 2]
// Exports: default

// Module 14078 (AvatarDecorationPreviewImage)
import "noop";
...
function AvatarDecorationPreviewImage(arg0) {
  ...
  let styles;
  ({ product, styles } = arg0);
  let obj = require(14077) /* getCollectibleTypeName */;
...
function NameplatePreviewImage(styles) {
  ...
  let obj = require(9326) /* getNameplateAssets */;
...
function ProfileFramePreviewImage(arg0) {
  ...
  let styles;
  ({ product, styles } = arg0);
  const tmp3 = importDefault(8737)(product.skuId, "FamilyCenterActivityItemPreview");
  let tmp4 = null;
  if (null != tmp3) {
    ...
    obj[0] = tmp3;
    obj[1] = require(14077) /* getCollectibleTypeName */.PREVIEW_SIZE * closure_5;
    obj[2] = require(14077) /* getCollectibleTypeName */.PREVIEW_SIZE;
...
function SubscriptionPreview(arg0) {
  ...
  if (null == subscriptionPlanId) {
    ...
    obj[1] = jsx(require(11459) /* ShopIcon */.ShopIcon, { size: "custom", style: null });
