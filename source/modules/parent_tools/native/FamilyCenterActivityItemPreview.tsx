...
// Module 13676 (AvatarDecorationPreviewImage)
...
function SubscriptionPreview(arg0) {
  ...
  if (null == subscriptionPlanId) {
    ...
    obj = { size: "custom", style: { aze: false, azj: false } };
...
function CollectiblePreview(arg0) {
  ...
  if (null == product) {
    ...
    if (arg1(dependencyMap[13]).CollectiblesItemType.AVATAR_DECORATION === type) {
      ...
      const obj5 = { size: "custom", style: { aze: false, azj: false } };
...
const obj3 = { <string:2423925279>: null, <string:2596769915>: null, width: arg1(dependencyMap[5]).PREVIEW_SIZE * arg1(dependencyMap[5]).NAMEPLATE_ASPECT_RATIO, height: arg1(dependencyMap[5]).PREVIEW_SIZE };
