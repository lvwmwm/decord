...
// Dependencies: [19, 17, 8881, 21, 4342, 14227, 712, 9455, 8860, 9458, 11599, 7761, 7770, 1949, 1946, 2]
// Exports: default

// Module 14228 (AvatarDecorationPreviewImage)
import "noop";
...
function NameplatePreviewImage(styles) {
  ...
  let obj = require(9455) /* getNameplateAssets */;
...
function ProfileFramePreviewImage(arg0) {
  ...
  let styles;
  ({ product, styles } = arg0);
  const tmp3 = importDefault(8860)(product.skuId, "FamilyCenterActivityItemPreview");
  let tmp4 = null;
  if (null != tmp3) {
    ...
    obj[0] = tmp3;
    obj[1] = require(14227) /* getCollectibleTypeName */.PREVIEW_SIZE * closure_5;
    obj[2] = require(14227) /* getCollectibleTypeName */.PREVIEW_SIZE;
...
function SubscriptionPreview(arg0) {
  ...
  if (null == subscriptionPlanId) {
    ...
    obj[1] = jsx(require(11599) /* ShopIcon */.ShopIcon, { size: "custom", style: null });
