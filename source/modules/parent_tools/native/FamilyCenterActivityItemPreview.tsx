...
// Dependencies: [19, 17, 8863, 21, 4344, 14214, 712, 9437, 8842, 9441, 11586, 7736, 7745, 1949, 1946, 2]
// Exports: default

// Module 14215 (AvatarDecorationPreviewImage)
import "noop";
...
function NameplatePreviewImage(styles) {
  ...
  let obj = require(9437) /* getNameplateAssets */;
...
function ProfileFramePreviewImage(arg0) {
  ...
  let styles;
  ({ product, styles } = arg0);
  const tmp3 = importDefault(8842)(product.skuId, "FamilyCenterActivityItemPreview");
  let tmp4 = null;
  if (null != tmp3) {
    ...
    obj[0] = tmp3;
    obj[1] = require(14214) /* getCollectibleTypeName */.PREVIEW_SIZE * closure_5;
    obj[2] = require(14214) /* getCollectibleTypeName */.PREVIEW_SIZE;
...
function SubscriptionPreview(arg0) {
  ...
  if (null == subscriptionPlanId) {
    ...
    obj[1] = jsx(require(11586) /* ShopIcon */.ShopIcon, { size: "custom", style: null });
