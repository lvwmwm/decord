...
// Dependencies: [19, 17, 8153, 21, 4481, 14827, 709, 8749, 8132, 8752, 12070, 9304, 8592, 1949, 1946, 2]
// Exports: default

// Module 14828 (AvatarDecorationPreviewImage)
import noopAll from "noop" /* 19 */;
import ThemesDefault from "Themes" /* 709 */;
import CollectiblesItemType from "CollectiblesItemType" /* 1949 */;
import useMaybeFetchProfileFrameDefault from "useMaybeFetchProfileFrame" /* 8132 */;
import getNameplateAssets from "getNameplateAssets" /* 8749 */;
import ShopIcon from "ShopIcon" /* 12070 */;
import getCollectibleTypeName from "getCollectibleTypeName" /* 14827 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import { PROFILE_FRAME_ASPECT_RATIO as closure_5 } from "PROFILE_FRAME_RESPONSIVE_RAIL_MIN_ASPECT_RATIO" /* 8153 */;
...
function ProfileFramePreviewImage(arg0) {
  ...
  if (null != tmp3) {
    ...
    obj[1] = jsx(tmp(8752), { profileFrame: null, previewWidth: null, previewHeight: null, profileBackgroundColor: null });
...
function SubscriptionPreview(arg0) {
  ...
  if (null == subscriptionPlanId) {
    ...
    if (obj4.isGuildBoostSubscription(subscriptionPlanId)) {
      let NitroWheelIcon = tmp5(9304).BoostGemIcon;
    } else {
      NitroWheelIcon = tmp5(8592).NitroWheelIcon;
    }
    obj = { size: "custom", style: null };
    obj[1] = { width: 20, height: 20 };
...
function CollectiblePreview(arg0) {
  ...
  if (null == product) {
    ...
    if (CollectiblesItemType.CollectiblesItemType.AVATAR_DECORATION === type) {
      ...
      obj[1] = jsx(tmp17(12070).ShopIcon, { size: "custom", style: null });
      return <closure_3 style={null}>{null}</closure_3>;
    }
  }
}
