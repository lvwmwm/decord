...
// Module 13695 (FamilyCenterAcceptedLinkRow)
...
__exportStarResult1 = { "Null": true, "Null": true, backgroundColor: require("__exportStarResult1").colors.BACKGROUND_BASE_LOW, borderRadius: require("__exportStarResult1").radii.md };
__exportStarResult1.content = __exportStarResult1;
__exportStarResult1.empty = { "Bool(false)": "<string:1464991746>", "Bool(false)": "<string:1639437652>" };
