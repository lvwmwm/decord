...
// Module 13688 (FamilyCenterAcceptedLinkRow)
import "result";
...
result = { "Null": true, "Null": true, backgroundColor: require("result").colors.BACKGROUND_BASE_LOW, borderRadius: require("result").radii.md };
