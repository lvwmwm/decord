...
// Dependencies: [17, 676, 21, 4444, 712, 9978, 5546, 4440, 1236, 2369, 14421, 1500, 5939, 2]
// Exports: default

// Module 14460 (ScheduleRuleRow)
...
function ScheduleRuleRow(rule) {
  ...
  const obj2 = rule(9978);
  obj = { label: scheduleRuleDateRange, subLabel: rule(9978).formatDays(rule.days), trailing: null, arrow: null, onPress: null };
  ...
  obj[2] = closure_5(rule(4440).Text, { variant: "text-sm/medium", color: "text-subtle", children: stringResult });
  obj[3] = !readOnly;
  let fn;
  if (!readOnly) {
    fn = () => {
  ...
  obj[4] = fn;
  return closure_5(rule(5546).TableRow, obj);
}
