...
export default function FamilyCenterFeatureRows() {
  let obj = require(11239) /* useAgeSpecificText */;
  const intl = require(1236) /* getSystemLocale */.intl;
  const tmp = createCacheKey();
  const intl2 = require(1236) /* getSystemLocale */.intl;
  const ageSpecificText = obj.useAgeSpecificText(intl.string(importDefault(2285).qITXhY), intl2.string(importDefault(2285).bmhCnL));
  let obj1 = require(11239) /* useAgeSpecificText */;
  const intl3 = require(1236) /* getSystemLocale */.intl;
  const stringResult = intl.string(importDefault(2285).qITXhY);
  const intl4 = require(1236) /* getSystemLocale */.intl;
  const ageSpecificText1 = obj1.useAgeSpecificText(intl3.string(importDefault(2285).t7SkFy), intl4.string(importDefault(2285)["68zfxD"]));
  let obj2 = require(11239) /* useAgeSpecificText */;
  const intl5 = require(1236) /* getSystemLocale */.intl;
  const stringResult1 = intl3.string(importDefault(2285).t7SkFy);
  ...
  const items = [obj, , ];
  obj = { icon: importDefault(11662), IconComponent: require(8308) /* EyeIcon */.EyeIcon, header: null, description: null };
  ...
  obj4[3] = intl10.string(importDefault(2285)["6JkHSg"]);
  const items1 = [callback(require(4281) /* Text */.Text, obj4), ];
  ...
  items1[1] = callback(require(5649) /* TableRowGroupTitle */.TableRowGroup, obj5);
  obj3[1] = items1;
  obj2[1] = callback2(require(4693) /* Stack */.Stack, obj3);
