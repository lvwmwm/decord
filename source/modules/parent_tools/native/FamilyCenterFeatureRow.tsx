...
// Dependencies: [19, 17, 21, 4255, 712, 11240, 1236, 2255, 14003, 14004, 11599, 8919, 12357, 13999, 4664, 4251, 5620, 5286, 2]
// Exports: default

// Module 14002 (FamilyCenterFeatureRows)
import "noop";
...
export default function FamilyCenterFeatureRows() {
  let obj = require(11240) /* useAgeSpecificText */;
  ...
  let obj1 = require(11240) /* useAgeSpecificText */;
  ...
  let obj2 = require(11240) /* useAgeSpecificText */;
  ...
  obj[0] = importDefault(14003);
  obj[1] = require(14004) /* ChatCheckIcon */.ChatCheckIcon;
  const intl7 = require(1236) /* getSystemLocale */.intl;
  obj[2] = intl7.string(importDefault(2255)["001l3m"]);
  obj[3] = ageSpecificText;
  const items = [obj, , ];
  obj = { icon: importDefault(11599), IconComponent: require(8919) /* EyeIcon */.EyeIcon, header: null, description: null };
  const intl8 = require(1236) /* getSystemLocale */.intl;
  obj[2] = intl8.string(importDefault(2255).yipAeP);
  obj[3] = ageSpecificText1;
  items[1] = obj;
  obj1 = { icon: importDefault(12357), IconComponent: require(13999) /* QrCodeIcon */.QrCodeIcon, header: null, description: null };
  ...
  obj5[1] = items.map((header) => {
    ...
    obj[2] = callback2(callback(5286).TableRow.Icon, { source: icon, IconComponent });
    return callback2(callback(5286).TableRow, obj, header);
  });
  items1[1] = callback(require(5620) /* TableRowGroupTitle */.TableRowGroup, obj5);
  obj3[1] = items1;
