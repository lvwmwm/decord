...
// Dependencies: [5, 19, 17, 21, 4342, 712, 8007, 4338, 1236, 2303, 14220, 4062, 4303, 4550, 4061, 5896, 7852, 7853, 4753, 7835, 11385, 5191, 4755, 5310, 11387, 2]
// Exports: default

// Module 14219 (ChangeSpendingLimitScreen)
...
function ChangeSpendingLimitScreen(teenId) {
  ...
  const items1 = [callback(_require(4338).Text, obj2), , ];
  ...
  obj3[5] = str;
  const items2 = [callback(_require(7835).TextInput, obj3), ];
  let tmp9Result = null;
  if (isOverspending) {
