...
// Dependencies: [1340, 6905, 1876, 589, 13977, 5764, 5765, 1236, 2285, 2]
// Exports: useSpendingLimitDisplayState, useSpendingLimitFromUserSettings

// Module 14059 (getSpendingLimitDisplayState)
...
function getSpendingLimitDisplayState(amount) {
  if (null == amount) {
    ...
    if (arg1 >= amount.amount) {
      ...
      let num = tmp5(5765).CurrencyExponents[amount.currency];
      if (num == null) {
        num = 2;
      }
