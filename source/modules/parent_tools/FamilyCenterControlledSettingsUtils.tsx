...
// Dependencies: [1306, 14080, 5917, 5915, 2]
...
// Module 14083 (getGoreContentSettingOrDefault)
...
function getExplicitContentSettingOrDefault(teenId) {
  ...
  if (tmp5) {
    ...
    if (!tmp10) {
      const ParentalControlledLegacyExplicitContent2 = tmp(14080).ParentalControlledLegacyExplicitContent;
    ...
    const ParentalControlledLegacyExplicitContent = tmp(14080).ParentalControlledLegacyExplicitContent;
...
export const resolveExplicitContentSettingWithDefaultsForTeen = function resolveExplicitContentSettingWithDefaultsForTeen(teenId) {
  ...
  if (tmp) {
    ...
    const ParentalControlledLegacyExplicitContent = require(14080) /* result */.ParentalControlledLegacyExplicitContent;
    const controlledSetting = ParentalControlledLegacyExplicitContent.getControlledSetting(teenId.teenId);
    const tmp7 = require(5915) /* resolveExplicitContentSettingWithDefaults */;
    if (isFriend) {
