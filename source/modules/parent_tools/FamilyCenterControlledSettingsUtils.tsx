...
// Dependencies: [1306, 14070, 5917, 5915, 2]
...
// Module 14073 (getGoreContentSettingOrDefault)
...
export const resolveExplicitContentSettingWithDefaultsForTeen = function resolveExplicitContentSettingWithDefaultsForTeen(teenId) {
  ...
  if (tmp) {
    ...
    const ParentalControlledLegacyExplicitContent = require(14070) /* result */.ParentalControlledLegacyExplicitContent;
