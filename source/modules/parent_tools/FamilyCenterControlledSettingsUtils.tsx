...
// Dependencies: [1306, 14072, 5917, 5915, 2]
...
// Module 14075 (getGoreContentSettingOrDefault)
...
function getExplicitContentSettingOrDefault(teenId) {
  ...
  if (tmp5) {
    ...
    if (!tmp10) {
      const ParentalControlledLegacyExplicitContent2 = tmp(14072).ParentalControlledLegacyExplicitContent;
    ...
    const ParentalControlledLegacyExplicitContent = tmp(14072).ParentalControlledLegacyExplicitContent;
...
export const resolveExplicitContentSettingWithDefaultsForTeen = function resolveExplicitContentSettingWithDefaultsForTeen(teenId) {
  ...
  if (tmp) {
    ...
    const ParentalControlledLegacyExplicitContent = require(14072) /* result */.ParentalControlledLegacyExplicitContent;
