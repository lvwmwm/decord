...
// Dependencies: [5, 1946, 8482, 676, 8657, 709, 4427, 530, 589, 584, 687, 8651, 2]
// Exports: getGameAnnouncements, getShopCollection

// Module 8656 (_getShopCollection)
        ...
        try {
          ...
          if (0 === c8) {
            ...
            if (1 === tmp8) {
              ...
              obj6[1] = callback;
              const obj9 = body(709);
              obj6[2] = callback(8651).toAnnouncementMessages(body.messages);
