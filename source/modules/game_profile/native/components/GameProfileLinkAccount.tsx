...
// Dependencies: [19, 17, 1874, 21, 4285, 712, 5613, 589, 9200, 4281, 1236, 5236, 1297, 4695, 9247, 2]
// Exports: default

// Module 9246 (GameProfileLinkAccount)
        ...
        if (!hasAlreadyLinked) {
          if (null != stateFromStores) {
            ...
            if (null != iconSource) {
              ...
              const obj8 = { size: null, user: null, guildId: "disabled" };
