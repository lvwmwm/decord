...
// Dependencies: [19, 17, 21, 4344, 712, 7767, 4340, 1236, 2]
// Exports: default

// Module 9360 (GameProfileRankPill)
import "noop";
...
export default function GameProfileRankPill(arg0) {
  ...
  const items = [callback(require(7767) /* TrophyIcon */.TrophyIcon, obj), ];
  ...
  items[1] = callback(require(4340) /* Text */.Text, { variant: "text-xs/bold", color: "text-overlay-dark", children: str.toUpperCase() });
  obj[1] = items;
