...
// Dependencies: [19, 17, 21, 4303, 712, 7728, 4299, 1236, 2]
// Exports: default

// Module 9320 (GameProfileRankPill)
import "noop";
...
export default function GameProfileRankPill(arg0) {
  ...
  const items = [callback(require(7728) /* TrophyIcon */.TrophyIcon, obj), ];
  ...
  items[1] = callback(require(4299) /* Text */.Text, { variant: "text-xs/bold", color: "text-overlay-dark", children: str.toUpperCase() });
  obj[1] = items;
