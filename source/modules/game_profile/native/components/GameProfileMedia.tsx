...
obj.container = obj;
obj.scrollView = { "Bool(false)": 0., "Bool(false)": 0. };
...
export default function GameProfileMedia(game) {
  ...
  let closure_18 = React.useCallback((arg0) => {
    ...
    if (null != current) {
      const obj = { 0: "_desired", 0: "hash", 9223372036854775807: "constructor", x: memo2[arg0] };
