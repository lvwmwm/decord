...
// Dependencies: [19, 17, 8860, 21, 4302, 712, 3998, 9248, 1236, 1935, 3971, 12112, 12121, 4298, 2]
// Exports: default

// Module 12111 (GameProfileWebsiteButton)
          ...
          if (!tmp34) {
            ...
            if (!tmp61) {
              ...
              if (obj != null) {
                ...
                if (websites != null) {
                  const mapped3 = websites.map((arg0) => callback2(12121)(arg0, callback2(712).colors.ICON_SUBTLE));
              ...
              obj5[1] = platforms.map((platform) => {
                ...
                return callback3(callback(12112).GameUpdatePlatformIcon, obj, platform);
              });
