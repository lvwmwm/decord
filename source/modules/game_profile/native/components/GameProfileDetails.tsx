...
// Dependencies: [19, 17, 8843, 21, 4285, 712, 3981, 9231, 1236, 1935, 3954, 12097, 12106, 4281, 2]
// Exports: default

// Module 12096 (GameProfileWebsiteButton)
          ...
          if (!tmp34) {
            ...
            if (!tmp61) {
              ...
              if (obj != null) {
                ...
                if (websites != null) {
                  const mapped3 = websites.map((arg0) => callback2(12106)(arg0, callback2(712).colors.ICON_SUBTLE));
              ...
              obj5[1] = platforms.map((platform) => {
                ...
                return callback3(callback(12097).GameUpdatePlatformIcon, obj, platform);
              });
