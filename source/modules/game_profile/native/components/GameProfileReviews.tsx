...
// Function ID: 9207
// Name: SteamReviewRow
// Dependencies: [19, 17, 21, 4255, 712, 9169, 3952, 9207, 9208, 9172, 1236, 9180, 4251, 4289, 9209, 9215, 9176, 9177, 2]
// Exports: default

// Module 9206 (SteamReviewRow)
...
export default function GameProfileReviews(arg0) {
  ...
  const tmp = createCacheKey();
  let obj = require(9176) /* buildSteamStoreUrl */;
  let id;
  if (game != null) {
    id = game.id;
  }
