...
// Function ID: 9368
// Name: SteamReviewRow
// Dependencies: [19, 17, 21, 4342, 712, 9330, 4058, 9368, 9369, 9333, 1236, 9341, 4338, 4380, 9370, 9376, 9337, 9338, 2]
// Exports: default

// Module 9367 (SteamReviewRow)
...
export default function GameProfileReviews(arg0) {
  ...
  const tmp = createCacheKey();
  let obj = require(9337) /* buildSteamStoreUrl */;
  let id;
  if (game != null) {
    id = game.id;
  }
