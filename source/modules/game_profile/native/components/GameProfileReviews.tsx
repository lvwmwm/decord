...
// Function ID: 9382
// Name: SteamReviewRow
// Dependencies: [19, 17, 21, 4342, 712, 9344, 4058, 9382, 9383, 9347, 1236, 9355, 4338, 4380, 9384, 9390, 9351, 9352, 2]
// Exports: default

// Module 9381 (SteamReviewRow)
...
export default function GameProfileReviews(arg0) {
  ...
  const tmp = createCacheKey();
  let obj = require(9351) /* buildSteamStoreUrl */;
  let id;
  if (game != null) {
    id = game.id;
  }
