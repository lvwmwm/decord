...
// Function ID: 9364
// Name: SteamReviewRow
// Dependencies: [19, 17, 21, 4344, 712, 9326, 4058, 9364, 9365, 9329, 1236, 9337, 4340, 4379, 9366, 9372, 9333, 9334, 2]
// Exports: default

// Module 9363 (SteamReviewRow)
...
export default function GameProfileReviews(arg0) {
  ...
  const tmp = createCacheKey();
  let obj = require(9333) /* buildSteamStoreUrl */;
  let id;
  if (game != null) {
    id = game.id;
  }
