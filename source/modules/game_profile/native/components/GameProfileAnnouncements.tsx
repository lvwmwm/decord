...
// Dependencies: [19, 17, 21, 4685, 1236, 4255, 712, 8838, 4251, 8840, 3925, 7564, 5581, 8842, 8785, 8779, 8845, 4666, 5631, 2]
// Exports: default

// Module 8837 (EmbedAnnouncementCard)
...
function EmbedAnnouncementCard(message) {
  ...
  if (null == embedSource) {
    ...
    if (tmp12Result1) {
      ...
      obj8[1] = tmp12(message(8840).ImageWithPlaceholder, obj9);
    ...
    if (tmp14Result) {
      ...
      const items6 = [tmp12(tmp35(7564).ReactionIcon, obj19), ];
...
function MessageAnnouncementCard(message) {
  ...
  if (tmp13) {
    ...
    obj[1] = callback(message(8840).ImageWithPlaceholder, obj1);
  ...
  if (tmp11Result) {
    ...
    const items3 = [tmp27(tmp28(7564).ReactionIcon, obj10), ];
...
function PollAnnouncementCard(message) {
  ...
  if (null == poll) {
    ...
    const date = new Date(message.timestamp);
    obj6[0] = date;
    obj6[1] = message(8838).getPollExpiryLabel(poll);
