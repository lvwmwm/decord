...
// Dependencies: [19, 17, 9550, 21, 4899, 1236, 4444, 712, 9551, 4440, 9553, 4131, 7867, 5900, 9555, 9499, 9493, 9558, 4879, 5950, 2]
// Exports: default

// Module 9549 (EmbedAnnouncementCard)
import ThemesDefault from "Themes" /* 712 */;
import createRulesAll from "createRules" /* 4899 */;
import importAllResult from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import { MAX_VISIBLE_ANNOUNCEMENTS } from "MAX_VISIBLE_ANNOUNCEMENTS" /* 9550 */;
...
function EmbedAnnouncementCard(message) {
  ...
  if (null == embedSource) {
    ...
    if (tmp12Result) {
      ...
      tmp12Result = tmp12(message(4440).Text, obj2);
    }
    ...
    if (tmp14Result) {
      ...
      items2[1] = tmp12(message(4440).Text, obj7);
      obj4[1] = items2;
    ...
    if (tmp12Result1) {
      ...
      obj8[1] = tmp12(message(9553).ImageWithPlaceholder, obj9);
    ...
    if (tmp12Result2) {
      ...
      tmp12Result2 = tmp12(message(4440).Text, obj10);
    }
    ...
    if (tmp12Result3) {
      ...
      tmp12Result3 = tmp12(message(4440).Text, obj12);
    }
    ...
    obj17[2] = items5;
    items4[1] = closure_12(message(4440).Text, obj17);
    ...
    if (tmp14Result) {
      ...
      const items6 = [tmp12(tmp35(7867).ReactionIcon, obj19), ];
      ...
      items6[1] = tmp12(tmp35(4440).Text, obj21);
      obj18[1] = items6;
...
function MessageAnnouncementCard(message) {
  ...
  if (tmp13) {
    ...
    obj[1] = callback(message(9553).ImageWithPlaceholder, obj1);
  ...
  if (tmp19) {
    ...
    tmp19 = callback(message(4440).Text, obj3);
  }
  const items1 = [tmp19, , ];
  ...
  if (tmp23) {
    ...
    tmp23 = callback(message(4440).Text, obj5);
  }
  items1[1] = tmp23;
  ...
  const items2 = [callback(message(4440).Text, obj8), ];
  ...
  if (tmp11Result) {
    ...
    const items3 = [tmp27(tmp28(7867).ReactionIcon, obj10), ];
    ...
    items3[1] = tmp27(tmp28(4440).Text, obj12);
    obj9[1] = items3;
...
function PollAnnouncementCard(message) {
  ...
  if (null == poll) {
    ...
    const items = [callback(message(4440).Text, obj1), , ];
    ...
    if (tmp9Result) {
      ...
      tmp9Result = tmp9(tmp13(4440).Text, obj);
    }
    items1[1] = tmp9Result;
    obj2[1] = items1;
    items[1] = closure_12(closure_7, obj2);
    ...
    const date = new Date(message.timestamp);
    obj6[0] = date;
    obj6[1] = message(9551).getPollExpiryLabel(poll);
    obj5[2] = intl2.format(message(1236).t.t0FTsH, obj6);
    obj4[1] = callback(message(4440).Text, obj5);
