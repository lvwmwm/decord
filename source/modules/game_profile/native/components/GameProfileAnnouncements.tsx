...
// Dependencies: [19, 17, 21, 4623, 1236, 4193, 712, 8661, 4189, 8663, 3863, 6579, 5519, 8665, 8496, 8490, 8668, 4604, 5569, 2]
// Exports: default
...
function EmbedAnnouncementCard(message) {
  ...
  if (null == embedSource) {
    ...
    if (tmp12Result) {
      ...
      tmp12Result = tmp12(message(4189).Text, obj2);
    }
    ...
    if (tmp14Result) {
      ...
      items2[1] = tmp12(message(4189).Text, obj7);
      obj4[1] = items2;
    ...
    if (tmp12Result1) {
      ...
      obj8[1] = tmp12(message(8663).ImageWithPlaceholder, obj9);
    ...
    if (tmp12Result2) {
      ...
      tmp12Result2 = tmp12(message(4189).Text, obj10);
    }
    ...
    if (tmp12Result3) {
      ...
      tmp12Result3 = tmp12(message(4189).Text, obj12);
    }
    ...
    items5[1] = message(3863).dateFormat(date, "LL");
    obj17[2] = items5;
    items4[1] = closure_11(message(4189).Text, obj17);
    ...
    if (tmp14Result) {
      ...
      const items6 = [tmp12(tmp35(6579).ReactionIcon, obj19), ];
      ...
      items6[1] = tmp12(tmp35(4189).Text, obj21);
      obj18[1] = items6;
...
function MessageAnnouncementCard(message) {
  ...
  if (tmp13) {
    ...
    obj[1] = callback(message(8663).ImageWithPlaceholder, obj1);
  ...
  if (tmp19) {
    ...
    tmp19 = callback(message(4189).Text, obj3);
  }
  const items1 = [tmp19, , ];
  ...
  if (tmp11Result) {
    ...
    const items3 = [tmp27(tmp28(6579).ReactionIcon, obj10), ];
    ...
    items3[1] = tmp27(tmp28(4189).Text, obj12);
    obj9[1] = items3;
...
function PollAnnouncementCard(message) {
  ...
  if (null == poll) {
    ...
    const items = [callback(message(4189).Text, obj1), , ];
    ...
    if (tmp9Result) {
      ...
      tmp9Result = tmp9(tmp13(4189).Text, obj);
    }
    items1[1] = tmp9Result;
    obj2[1] = items1;
    items[1] = closure_11(closure_7, obj2);
    ...
    const date = new Date(message.timestamp);
    obj6[0] = date;
    obj6[1] = message(8661).getPollExpiryLabel(poll);
    obj5[2] = intl2.format(message(1236).t.t0FTsH, obj6);
    obj4[1] = callback(message(4189).Text, obj5);
