...
// Dependencies: [19, 17, 21, 4714, 1236, 4285, 712, 9253, 4281, 9255, 3955, 7576, 5610, 9257, 9200, 9194, 9260, 4695, 5660, 2]
// Exports: default
...
function EmbedAnnouncementCard(message) {
  ...
  if (null == embedSource) {
    ...
    items5[1] = message(3955).dateFormat(date, "LL");
    obj17[2] = items5;
