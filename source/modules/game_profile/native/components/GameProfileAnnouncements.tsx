...
function EmbedAnnouncementCard(message) {
  ...
  if (null == embedSource) {
    ...
    if (tmp12Result) {
      ...
      tmp12Result = tmp12(message(4338).Text, obj2);
    }
    ...
    if (tmp14Result) {
      ...
      items2[1] = tmp12(message(4338).Text, obj7);
      obj4[1] = items2;
    ...
    if (tmp12Result2) {
      ...
      tmp12Result2 = tmp12(message(4338).Text, obj10);
    }
    ...
    if (tmp12Result3) {
      ...
      tmp12Result3 = tmp12(message(4338).Text, obj12);
    }
    ...
    obj17[2] = items5;
    items4[1] = closure_11(message(4338).Text, obj17);
    ...
    if (tmp14Result) {
      ...
      items6[1] = tmp12(tmp35(4338).Text, obj21);
      obj18[1] = items6;
...
function MessageAnnouncementCard(message) {
  ...
  if (tmp19) {
    ...
    tmp19 = callback(message(4338).Text, obj3);
  }
  const items1 = [tmp19, , ];
  ...
  if (tmp23) {
    ...
    tmp23 = callback(message(4338).Text, obj5);
  }
  items1[1] = tmp23;
  ...
  const items2 = [callback(message(4338).Text, obj8), ];
  ...
  if (tmp11Result) {
    ...
    items3[1] = tmp27(tmp28(4338).Text, obj12);
    obj9[1] = items3;
...
function PollAnnouncementCard(message) {
  ...
  if (null == poll) {
    ...
    const items = [callback(message(4338).Text, obj1), , ];
    ...
    if (tmp9Result) {
      ...
      tmp9Result = tmp9(tmp13(4338).Text, obj);
    }
    items1[1] = tmp9Result;
    obj2[1] = items1;
    items[1] = closure_11(closure_7, obj2);
