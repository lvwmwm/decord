...
// Dependencies: [19, 17, 21, 4773, 1236, 4344, 712, 9381, 4340, 9383, 4031, 7696, 5767, 9385, 9329, 9323, 9388, 4754, 5817, 2]
// Exports: default

// Module 9380 (EmbedAnnouncementCard)
...
function EmbedAnnouncementCard(message) {
  ...
  if (null == embedSource) {
    ...
    if (tmp12Result) {
      ...
      tmp12Result = tmp12(message(4340).Text, obj2);
    }
    ...
    if (tmp14Result) {
      ...
      items2[1] = tmp12(message(4340).Text, obj7);
      obj4[1] = items2;
    ...
    if (tmp12Result1) {
      ...
      obj8[1] = tmp12(message(9383).ImageWithPlaceholder, obj9);
    ...
    if (tmp12Result2) {
      ...
      tmp12Result2 = tmp12(message(4340).Text, obj10);
    }
    ...
    if (tmp12Result3) {
      ...
      tmp12Result3 = tmp12(message(4340).Text, obj12);
    }
    ...
    items5[1] = message(4031).dateFormat(date, "LL");
    obj17[2] = items5;
    items4[1] = closure_11(message(4340).Text, obj17);
    ...
    if (tmp14Result) {
      ...
      const items6 = [tmp12(tmp35(7696).ReactionIcon, obj19), ];
      ...
      items6[1] = tmp12(tmp35(4340).Text, obj21);
      obj18[1] = items6;
...
function MessageAnnouncementCard(message) {
  ...
  if (tmp13) {
    ...
    obj[1] = callback(message(9383).ImageWithPlaceholder, obj1);
  ...
  if (tmp19) {
    ...
    tmp19 = callback(message(4340).Text, obj3);
  }
  const items1 = [tmp19, , ];
  ...
  if (tmp11Result) {
    ...
    const items3 = [tmp27(tmp28(7696).ReactionIcon, obj10), ];
    ...
    items3[1] = tmp27(tmp28(4340).Text, obj12);
    obj9[1] = items3;
...
function PollAnnouncementCard(message) {
  ...
  if (null == poll) {
    ...
    const items = [callback(message(4340).Text, obj1), , ];
    ...
    if (tmp9Result) {
      ...
      tmp9Result = tmp9(tmp13(4340).Text, obj);
    }
    items1[1] = tmp9Result;
    obj2[1] = items1;
    items[1] = closure_11(closure_7, obj2);
    ...
    const date = new Date(message.timestamp);
    obj6[0] = date;
    obj6[1] = message(9381).getPollExpiryLabel(poll);
    obj5[2] = intl2.format(message(1236).t.t0FTsH, obj6);
    obj4[1] = callback(message(4340).Text, obj5);
