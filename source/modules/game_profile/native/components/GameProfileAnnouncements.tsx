...
// Dependencies: [19, 17, 9482, 21, 4834, 1236, 4380, 712, 9483, 4376, 9485, 4067, 7800, 5834, 9487, 9431, 9425, 9490, 4815, 5884, 2]
// Exports: default

// Module 9481 (EmbedAnnouncementCard)
import ThemesDefault from "Themes" /* 712 */;
import createRulesAll from "createRules" /* 4834 */;
import importAllResult from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import { MAX_VISIBLE_ANNOUNCEMENTS } from "MAX_VISIBLE_ANNOUNCEMENTS" /* 9482 */;
