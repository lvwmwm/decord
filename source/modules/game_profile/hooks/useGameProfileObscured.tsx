...
// Dependencies: [1903, 4817, 589, 2]
// Exports: default, isGameProfileObscured

// Module 4816 (useGameProfileObscured)
...
export default function useGameProfileObscured(contentClassification) {
  ...
  if (result) {
    result = require(4817) /* isAgeRestrictedContentClassification */.isAgeRestrictedContentClassification(contentClassification.contentClassification);
    const tmpResult = require(4817) /* isAgeRestrictedContentClassification */;
  }
  return result;
};
export const isGameProfileObscured = function isGameProfileObscured(game, nsfwAllowed) {
  ...
  if (result) {
    result = require(4817) /* isAgeRestrictedContentClassification */.isAgeRestrictedContentClassification(game.contentClassification);
