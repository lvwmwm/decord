...
export const getOpenCriticTierText = function getOpenCriticTierText(tier) {
  if (require(9256) /* OpenCriticTier */.OpenCriticTier.MIGHTY === tier) {
...
export const getOpenCriticTierImage = function getOpenCriticTierImage(tier) {
  if (require(9256) /* OpenCriticTier */.OpenCriticTier.MIGHTY === tier) {
    return importDefault(9257);
  } else if (tmp(9256).OpenCriticTier.STRONG === tier) {
    return importDefault(9258);
  } else if (tmp(9256).OpenCriticTier.FAIR === tier) {
    return importDefault(9259);
  } else if (tmp(9256).OpenCriticTier.WEAK === tier) {
    return importDefault(9260);
  }
};
