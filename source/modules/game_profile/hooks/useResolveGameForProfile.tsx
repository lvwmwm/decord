...
// Dependencies: [5911, 4619, 8730, 4620, 6106, 2]
// Exports: default

// Module 8729 (useResolveGameForProfile)
...
import useResolveGameDefault from "useResolveGame" /* 8730 */;
...
export default function useResolveGameForProfile(arg0) {
  ...
  if (result) {
    gameId = tmp(4620).ROBLOX_GAME_ID;
  }
  obj[1] = gameId;
