...
// Dependencies: [7145, 4643, 9523, 4644, 5378, 2]
// Exports: default
...
export default function useResolveGameForProfile(arg0) {
  ...
  obj[1] = gameId;
  let tmp6Result = importDefault(9523)(obj);
  ...
  const tmp6 = importDefault(9523);
  let ROBLOX_GAME_ID;
  if (isRobloxSubgameGameResult) {
    ROBLOX_GAME_ID = tmp(4644).ROBLOX_GAME_ID;
  }
  const game = require(5378) /* importDefaultResult1 */.useGame(ROBLOX_GAME_ID);
  let data = game.data;
  if (isRobloxSubgameGameResult) {
