...
// Dependencies: [5, 1838, 653, 44, 5736, 7460, 1198, 2]
// Exports: default

// Module 8661 (_navigateToGameAnnouncement)
...
({ GuildFeatures: closure_5, JoinGuildSources: closure_6, Routes: closure_7 } = ME);
