// Module ID: 8610
// Function ID: 8611
// Dependencies: [38, 4448, 8611, 2008, 706, 2]
...
export default {
  openGameProfileModal(arg0) {
    ...
    obj.openLazy(asyncRequireImpl(8611, dependencyMap.paths), "game-profile-" + gameId, obj, stackingBehavior);
  },
  returnToGameProfile(gameId) {
    ...
    obj2.openLazy(asyncRequireImpl(8611, dependencyMap.paths), "game-profile-" + gameId, { gameId, source, initialScrollOffset });
  },
