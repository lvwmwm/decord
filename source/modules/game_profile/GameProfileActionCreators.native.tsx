// Module ID: 9212
// Function ID: 9213
// Dependencies: [38, 4270, 9213, 1988, 709, 2]
...
export default {
  openGameProfileModal(arg0) {
    ...
    obj.openLazy(require(1988) /* asyncRequireImpl */(9213, dependencyMap.paths), "game-profile-" + gameId, obj, stackingBehavior);
  },
  returnToGameProfile(gameId) {
    ...
    obj2.openLazy(require(1988) /* asyncRequireImpl */(9213, dependencyMap.paths), "game-profile-" + gameId, { gameId, source, initialScrollOffset });
  },
