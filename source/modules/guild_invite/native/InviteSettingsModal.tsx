...
function AdvancedInstantInviteScreen() {
  ...
  obj[5] = channel(9116).getMaxUsesOptions;
...
export default function InviteSettingsModal() {
  const memo = React.useMemo(() => {
    ...
    obj[2] = callback(5310).getHeaderCloseButton(callback2(9121).close);
  ...
  return jsx(require(5823) /* NavigationStack */.Navigator, { screens: memo, initialRouteName: constants.ADVANCED });
};
