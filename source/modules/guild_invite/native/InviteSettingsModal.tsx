...
// Dependencies: [32, 19, 1391, 9072, 1910, 3948, 676, 21, 4303, 712, 1499, 589, 38, 12, 16893, 9078, 4642, 1236, 4730, 709, 6010, 7969, 16894, 9073, 503, 5270, 5783, 2]
// Exports: default

// Module 16892 (AdvancedInstantInviteScreen)
...
function AdvancedInstantInviteScreen() {
  ...
  obj[5] = channel(9073).getMaxUsesOptions;
  ...
  obj[12] = callback4;
  obj[13] = callback5;
  obj[1] = jsx(channel(16894), { style: tmp.formContent, channel: first, guild, maxAge: settings.maxAge, maxUses: settings.maxUses, maxUsesOptions: null, temporary: null, flags: null, roleIds: null, onChangeMaxAge: null, onChangeMaxUses: null, onChangeTemporary: null, onChangeFlags: null, onChangeRoleIds: null });
  return jsx(navigation(7969).Form, { style: tmp.formContent, channel: first, guild, maxAge: settings.maxAge, maxUses: settings.maxUses, maxUsesOptions: null, temporary: null, flags: null, roleIds: null, onChangeMaxAge: null, onChangeMaxUses: null, onChangeTemporary: null, onChangeFlags: null, onChangeRoleIds: null });
}
...
export default function InviteSettingsModal() {
  const memo = React.useMemo(() => {
    ...
    obj[2] = callback(5270).getHeaderCloseButton(callback2(9078).close);
  ...
  return jsx(require(5783) /* NavigationStack */.Navigator, { screens: memo, initialRouteName: constants.ADVANCED });
};
