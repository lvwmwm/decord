...
// Dependencies: [19, 21, 4255, 712, 5309, 5308, 7783, 4223, 7782, 2]
// Exports: default

// Module 16728 (InviteSelectActionSheet)
import "noop";
...
export default function InviteSelectActionSheet(arg0) {
  ...
  obj[1] = jsx(require(5308) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title });
  obj = {
    value,
    onChange(arg0) {
      callback(arg0);
  ...
  return jsx(require(5309) /* Background */.BottomSheet, {
    value,
    onChange(arg0) {
      callback(arg0);
      outer1_1(outer1_2[7]).hideActionSheet();
