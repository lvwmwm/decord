...
// Dependencies: [19, 17, 1922, 21, 1297, 4342, 8363, 589, 1370, 2]
// Exports: default

// Module 9723 (FacepileGroupDMAvatar)
...
class FacepileGroupDMAvatar {
  constructor(arg0) {
    ...
    tmp9 = jsxs;
    tmp10 = View;
    obj1 = { style: tmp.firstFace, size: pileSizeOverride, guildId: "r", cutout: "baby", animate: "dier" };
    obj1[3] = memo1;
    obj1[4] = animate;
    if (null == users) {
      obj2 = { source: null };
