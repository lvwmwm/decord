...
// Dependencies: [19, 17, 21, 4303, 712, 1609, 4123, 1358, 4271, 5397, 5268, 11068, 4714, 1236, 5399, 4299, 11069, 4247, 2]
// Exports: default

// Module 11067 (ChatGDMUpsellActionSheet)
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  const items4 = [callback(View, { style: tmp.item, children: callback(onClick(11069).TimerIcon, { size: "sm" }) }), ];
  ...
  const obj11 = { style: tmp.item, children: callback(onClick(11069).TimerIcon, { size: "sm" }) };
