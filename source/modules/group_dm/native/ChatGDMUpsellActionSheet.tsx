...
// Dependencies: [19, 17, 21, 4668, 712, 1629, 4200, 1377, 4346, 6988, 5454, 10831, 4750, 1236, 6990, 4739, 10832, 4322, 2]
// Exports: default

// Module 10830 (ChatGDMUpsellActionSheet)
import ThemesDefault from "Themes" /* 712 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1629 */;
import preloadDefault from "preload" /* 5454 */;
import registerAssetDefault from "registerAsset" /* 10831 */;
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  obj3[1] = callback;
  const items2 = [callback(onClick(4750).Button, obj3), ];
  ...
  obj4[1] = callback(onClick(4750).Button, obj5);
  ...
  const items3 = [callback(onClick(4739).Text, obj7), , ];
  ...
  items3[1] = callback(onClick(4739).Text, obj8);
  ...
  const items4 = [callback(View, { style: tmp.item, children: callback(onClick(10832).TimerIcon, { size: "sm" }) }), ];
  ...
  items4[1] = callback(onClick(4739).Text, obj12);
  obj10[1] = items4;
  const items5 = [callback2(View, obj10), ];
  const obj13 = { style: tmp.secondInnerContainer, children: null };
  const obj11 = { style: tmp.item, children: callback(onClick(10832).TimerIcon, { size: "sm" }) };
  const items6 = [callback(View, { style: tmp.item, children: callback(onClick(4322).LinkIcon, { size: "sm" }) }), ];
  ...
  items6[1] = callback(onClick(4739).Text, obj15);
  obj13[1] = items6;
  items5[1] = callback2(View, obj13);
  obj9[1] = items5;
  items3[2] = callback2(View, obj9);
  obj6[0] = items3;
  obj[5] = callback2(onClick(6990).BottomSheetScrollView, obj6);
  return callback(onClick(6988).BottomSheet, obj);
};
