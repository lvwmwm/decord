...
// Dependencies: [19, 17, 21, 4380, 712, 1629, 4201, 1377, 4347, 5503, 5374, 11155, 4815, 1236, 5505, 4376, 11156, 4323, 2]
// Exports: default

// Module 11154 (ChatGDMUpsellActionSheet)
import ThemesDefault from "Themes" /* 712 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1629 */;
import preloadDefault from "preload" /* 5374 */;
import registerAssetDefault from "registerAsset" /* 11155 */;
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  obj3[1] = callback;
  const items2 = [callback(onClick(4815).Button, obj3), ];
  ...
  obj4[1] = callback(onClick(4815).Button, obj5);
  ...
  const items3 = [callback(onClick(4376).Text, obj7), , ];
  ...
  items3[1] = callback(onClick(4376).Text, obj8);
  ...
  const items4 = [callback(View, { style: tmp.item, children: callback(onClick(11156).TimerIcon, { size: "sm" }) }), ];
  ...
  items4[1] = callback(onClick(4376).Text, obj12);
  obj10[1] = items4;
  const items5 = [callback2(View, obj10), ];
  const obj13 = { style: tmp.secondInnerContainer, children: null };
  const obj11 = { style: tmp.item, children: callback(onClick(11156).TimerIcon, { size: "sm" }) };
  const items6 = [callback(View, { style: tmp.item, children: callback(onClick(4323).LinkIcon, { size: "sm" }) }), ];
  ...
  items6[1] = callback(onClick(4376).Text, obj15);
  obj13[1] = items6;
  items5[1] = callback2(View, obj13);
  obj9[1] = items5;
  items3[2] = callback2(View, obj9);
  obj6[0] = items3;
  obj[5] = callback2(onClick(5505).BottomSheetScrollView, obj6);
  return callback(onClick(5503).BottomSheet, obj);
};
