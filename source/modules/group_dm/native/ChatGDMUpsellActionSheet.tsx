...
// Dependencies: [19, 17, 21, 4285, 712, 1581, 4101, 1358, 4253, 5338, 5236, 10982, 4695, 1236, 5340, 4281, 10983, 4229, 2]
// Exports: default

// Module 10981 (ChatGDMUpsellActionSheet)
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  const obj11 = { style: tmp.item, children: callback(onClick(10983).TimerIcon, { size: "sm" }) };
  ...
  obj6[0] = items3;
  obj[5] = callback2(onClick(5340).BottomSheetScrollView, obj6);
  return callback(onClick(5338).BottomSheet, obj);
};
