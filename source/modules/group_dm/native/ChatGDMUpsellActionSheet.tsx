...
// Dependencies: [19, 17, 21, 4445, 712, 1629, 4266, 1377, 4412, 5574, 5445, 11110, 4880, 1236, 5576, 4441, 9322, 4388, 2]
// Exports: default

// Module 11109 (ChatGDMUpsellActionSheet)
import ThemesDefault from "Themes" /* 712 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1629 */;
import preloadDefault from "preload" /* 5445 */;
import registerAssetDefault from "registerAsset" /* 11110 */;
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  obj3[1] = callback;
  const items2 = [callback(onClick(4880).Button, obj3), ];
  ...
  obj4[1] = callback(onClick(4880).Button, obj5);
  ...
  const items3 = [callback(onClick(4441).Text, obj7), , ];
  ...
  items3[1] = callback(onClick(4441).Text, obj8);
  ...
  const items4 = [callback(View, { style: tmp.item, children: callback(onClick(9322).TimerIcon, { size: "sm" }) }), ];
  ...
  items4[1] = callback(onClick(4441).Text, obj12);
  obj10[1] = items4;
  const items5 = [callback2(View, obj10), ];
  const obj13 = { style: tmp.secondInnerContainer, children: null };
  const obj11 = { style: tmp.item, children: callback(onClick(9322).TimerIcon, { size: "sm" }) };
  const items6 = [callback(View, { style: tmp.item, children: callback(onClick(4388).LinkIcon, { size: "sm" }) }), ];
  ...
  items6[1] = callback(onClick(4441).Text, obj15);
  obj13[1] = items6;
  items5[1] = callback2(View, obj13);
  obj9[1] = items5;
  items3[2] = callback2(View, obj9);
  obj6[0] = items3;
  obj[5] = callback2(onClick(5576).BottomSheetScrollView, obj6);
  return callback(onClick(5574).BottomSheet, obj);
};
