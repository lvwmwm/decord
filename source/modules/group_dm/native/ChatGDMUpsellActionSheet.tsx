...
// Dependencies: [19, 17, 21, 4255, 712, 1581, 4071, 1358, 4223, 5309, 5207, 11050, 4666, 1236, 5311, 4251, 11051, 4199, 2]
// Exports: default

// Module 11049 (ChatGDMUpsellActionSheet)
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  obj3[1] = callback;
  const items2 = [callback(onClick(4666).Button, obj3), ];
  ...
  obj4[1] = callback(onClick(4666).Button, obj5);
  ...
  const items4 = [callback(View, { style: tmp.item, children: callback(onClick(11051).TimerIcon, { size: "sm" }) }), ];
  ...
  const obj11 = { style: tmp.item, children: callback(onClick(11051).TimerIcon, { size: "sm" }) };
  ...
  obj6[0] = items3;
  obj[5] = callback2(onClick(5311).BottomSheetScrollView, obj6);
  return callback(onClick(5309).BottomSheet, obj);
};
