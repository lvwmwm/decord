...
// Dependencies: [19, 17, 21, 4193, 712, 1581, 4009, 1358, 4161, 5247, 5145, 10928, 4604, 1236, 5249, 4189, 10929, 4137, 2]
// Exports: default
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  obj3[1] = callback;
  const items2 = [callback(onClick(4604).Button, obj3), ];
  ...
  obj4[1] = callback(onClick(4604).Button, obj5);
  ...
  const items3 = [callback(onClick(4189).Text, obj7), , ];
  ...
  items3[1] = callback(onClick(4189).Text, obj8);
  ...
  const items4 = [callback(View, { style: tmp.item, children: callback(onClick(10929).TimerIcon, { size: "sm" }) }), ];
  ...
  items4[1] = callback(onClick(4189).Text, obj12);
  obj10[1] = items4;
  const items5 = [callback2(View, obj10), ];
  const obj13 = { style: tmp.secondInnerContainer, children: null };
  const obj11 = { style: tmp.item, children: callback(onClick(10929).TimerIcon, { size: "sm" }) };
  const items6 = [callback(View, { style: tmp.item, children: callback(onClick(4137).LinkIcon, { size: "sm" }) }), ];
  ...
  items6[1] = callback(onClick(4189).Text, obj15);
  obj13[1] = items6;
  items5[1] = callback2(View, obj13);
  obj9[1] = items5;
  items3[2] = callback2(View, obj9);
  obj6[0] = items3;
  obj[5] = callback2(onClick(5249).BottomSheetScrollView, obj6);
  return callback(onClick(5247).BottomSheet, obj);
};
