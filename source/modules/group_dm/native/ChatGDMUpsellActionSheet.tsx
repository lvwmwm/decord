...
// Dependencies: [19, 17, 21, 4255, 712, 1581, 4071, 1358, 4223, 5323, 5221, 10954, 4665, 1236, 5325, 4251, 10955, 4199, 2]
// Exports: default

// Module 10953 (ChatGDMUpsellActionSheet)
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  obj[0] = importDefault(10954);
  obj[1] = callback(importDefault(5221), obj);
  obj[3] = callback(View, obj);
  const obj1 = { style: items1, children: null };
  items1 = [tmp.footer, ];
  const tmp3 = importDefault(5221);
  ...
  obj3[1] = callback;
  const items2 = [callback(onClick(4665).Button, obj3), ];
  ...
  obj4[1] = callback(onClick(4665).Button, obj5);
  ...
  const items3 = [callback(onClick(4251).Text, obj7), , ];
  ...
  items3[1] = callback(onClick(4251).Text, obj8);
  ...
  const items4 = [callback(View, { style: tmp.item, children: callback(onClick(10955).TimerIcon, { size: "sm" }) }), ];
  ...
  items4[1] = callback(onClick(4251).Text, obj12);
  obj10[1] = items4;
  const items5 = [callback2(View, obj10), ];
  const obj13 = { style: tmp.secondInnerContainer, children: null };
  const obj11 = { style: tmp.item, children: callback(onClick(10955).TimerIcon, { size: "sm" }) };
  const items6 = [callback(View, { style: tmp.item, children: callback(onClick(4199).LinkIcon, { size: "sm" }) }), ];
  ...
  items6[1] = callback(onClick(4251).Text, obj15);
  obj13[1] = items6;
  items5[1] = callback2(View, obj13);
  obj9[1] = items5;
  items3[2] = callback2(View, obj9);
  obj6[0] = items3;
  obj[5] = callback2(onClick(5325).BottomSheetScrollView, obj6);
  return callback(onClick(5323).BottomSheet, obj);
};
