...
// Dependencies: [19, 17, 21, 4189, 712, 1581, 4005, 1358, 4157, 5243, 5141, 10910, 4600, 1236, 5245, 4185, 10911, 4133, 2]
// Exports: default

// Module 10909 (ChatGDMUpsellActionSheet)
...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  obj3[1] = callback;
  const items2 = [callback(onClick(4600).Button, obj3), ];
  ...
  obj4[1] = callback(onClick(4600).Button, obj5);
  ...
  const items3 = [callback(onClick(4185).Text, obj7), , ];
  ...
  items3[1] = callback(onClick(4185).Text, obj8);
  ...
  const items4 = [callback(View, { style: tmp.item, children: callback(onClick(10911).TimerIcon, { size: "sm" }) }), ];
  ...
  items4[1] = callback(onClick(4185).Text, obj12);
  obj10[1] = items4;
  const items5 = [callback2(View, obj10), ];
  const obj13 = { style: tmp.secondInnerContainer, children: null };
  const obj11 = { style: tmp.item, children: callback(onClick(10911).TimerIcon, { size: "sm" }) };
  const items6 = [callback(View, { style: tmp.item, children: callback(onClick(4133).LinkIcon, { size: "sm" }) }), ];
  ...
  items6[1] = callback(onClick(4185).Text, obj15);
  obj13[1] = items6;
  items5[1] = callback2(View, obj13);
  obj9[1] = items5;
  items3[2] = callback2(View, obj9);
  obj6[0] = items3;
  obj[5] = callback2(onClick(5245).BottomSheetScrollView, obj6);
  return callback(onClick(5243).BottomSheet, obj);
};
