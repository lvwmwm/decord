...
// Dependencies: [19, 21, 9565, 9567, 1236, 9569, 2]
// Exports: default

// Module 9564 (ChatGDMCustomizeActionSheet)
import "noop";
...
export default function ChatGDMCustomizeActionSheet(channelId) {
  ...
  let importDefault;
  let dependencyMap;
  ({ onGoBack: c1, ref: c2 } = importDefault(9565)());
  const obj = { screenKey: "kick", title: null, render: null };
  const tmp = importDefault(9565)();
  ...
  return jsx(importDefault(9567), { screenKey: "kick", title: null, render: null });
};
