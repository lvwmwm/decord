...
// Dependencies: [19, 21, 11155, 11156, 4777, 11164, 2]
// Exports: default

// Module 13333 (ShareScreenFooter)
import "noop";
...
export default function ShareScreenFooter(arg0) {
  ...
  let obj = require(11155) /* useShareChatInputActions */;
  ...
  obj[4] = tmp7;
  obj[5] = isSending;
  obj[1] = jsx(require(4777) /* Button */.Button, { variant: "primary", size: "md", text: sendLabel, disabled: null, onPress: null, loading: null });
  obj[2] = jsx(importDefault(11164), { inputRef: textInputRef, text, onChange: setText, onSelectionChange: handleSelectionChange, onFocus: handleMessageFocus, onBlur: handleMessageBlur, onPressEmoji: handlePressEmoji, onSend, disabled });
  obj[3] = isInputFocused;
  return jsx(importDefault(11156), { variant: "primary", size: "md", text: sendLabel, disabled: null, onPress: null, loading: null });
};
