...
// Function ID: 11201
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4445, 712, 500, 8092, 8303, 1236, 5020, 8160, 2]
// Exports: default

// Module 11200 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(8303), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(8160).ReactionIcon, { size: "md" });
  items3[1] = callback2(onFocus(5020).PressableOpacity, obj);
  obj[1] = items3;
