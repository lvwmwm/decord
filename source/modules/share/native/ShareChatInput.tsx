...
// Function ID: 10182
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4285, 712, 500, 8276, 7898, 1236, 4827, 7576, 2]
// Exports: default

// Module 10181 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(7898), obj), ];
  ...
  items3[1] = callback2(onFocus(4827).PressableOpacity, obj);
  obj[1] = items3;
