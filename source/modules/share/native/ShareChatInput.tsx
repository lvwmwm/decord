...
// Function ID: 10311
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4344, 712, 500, 8397, 8016, 1236, 4886, 7696, 2]
// Exports: default

// Module 10310 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(8016), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(7696).ReactionIcon, { size: "md" });
  items3[1] = callback2(onFocus(4886).PressableOpacity, obj);
  obj[1] = items3;
