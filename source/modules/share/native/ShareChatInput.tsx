...
// Function ID: 11219
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4446, 712, 500, 8106, 8317, 1236, 5033, 8174, 2]
// Exports: default

// Module 11218 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(8317), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(8174).ReactionIcon, { size: "md" });
  items3[1] = callback2(onFocus(5033).PressableOpacity, obj);
  obj[1] = items3;
