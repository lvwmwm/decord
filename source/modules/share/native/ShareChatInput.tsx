...
// Function ID: 11334
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4444, 712, 500, 8575, 8193, 1236, 5015, 7867, 2]
// Exports: default

// Module 11333 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(8193), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(7867).ReactionIcon, { size: "md" });
  items3[1] = callback2(onFocus(5015).PressableOpacity, obj);
  obj[1] = items3;
