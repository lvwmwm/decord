...
// Function ID: 10270
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4303, 712, 500, 8358, 7977, 1236, 4846, 7657, 2]
// Exports: default

// Module 10269 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(7977), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(7657).ReactionIcon, { size: "md" });
  items3[1] = callback2(onFocus(4846).PressableOpacity, obj);
  obj[1] = items3;
