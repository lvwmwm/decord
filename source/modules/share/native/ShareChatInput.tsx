...
// Function ID: 10083
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4255, 712, 500, 8152, 7773, 1236, 4783, 7564, 2]
// Exports: default

// Module 10082 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(7773), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(7564).ReactionIcon, { size: "md" });
  items3[1] = callback2(onFocus(4783).PressableOpacity, obj);
  obj[1] = items3;
