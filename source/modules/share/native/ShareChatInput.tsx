...
// Function ID: 10151
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4255, 712, 500, 8136, 7757, 1236, 4797, 7548, 2]
// Exports: default

// Module 10150 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(7757), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(7548).ReactionIcon, { size: "md" });
  items3[1] = callback2(onFocus(4797).PressableOpacity, obj);
  obj[1] = items3;
