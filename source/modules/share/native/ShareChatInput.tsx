...
// Function ID: 11248
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4448, 712, 500, 8128, 8339, 1236, 5036, 8196, 2]
// Exports: default

// Module 11247 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(8339), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(8196).ReactionIcon, { size: "md" });
  items3[1] = callback2(onFocus(5036).PressableOpacity, obj);
  obj[1] = items3;
