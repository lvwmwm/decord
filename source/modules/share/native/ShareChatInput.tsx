...
// Function ID: 9940
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4193, 712, 500, 6185, 7648, 1236, 4721, 6579, 2]
// Exports: default

// Module 9939 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(7648), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(6579).ReactionIcon, { size: "md" });
  items3[1] = callback2(onFocus(4721).PressableOpacity, obj);
  obj[1] = items3;
