...
// Function ID: 11262
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4380, 712, 500, 8508, 8126, 1236, 4949, 7800, 2]
// Exports: default

// Module 11261 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(8126), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(7800).ReactionIcon, { size: "md" });
  items3[1] = callback2(onFocus(4949).PressableOpacity, obj);
  obj[1] = items3;
