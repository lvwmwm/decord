...
// Function ID: 9923
// Name: ShareChatInput
// Dependencies: [32, 19, 17, 676, 21, 4189, 712, 500, 6179, 7640, 1236, 4717, 6573, 2]
// Exports: default

// Module 9922 (ShareChatInput)
...
export default function ShareChatInput(onFocus) {
  ...
  obj[16] = tmp.chatText;
  obj[17] = !flag;
  const items3 = [callback2(tmp2(7640), obj), ];
  ...
  obj[4] = flag;
  obj[5] = callback2(onFocus(6573).ReactionIcon, { size: "md" });
