...
obj.attachmentPreview = { backgroundColor: importDefault(dependencyMap[7]).colors.BACKGROUND_BASE_LOW, borderRadius: importDefault(dependencyMap[7]).radii.sm };
obj.leftGradient = {};
obj.rightGradient = {};
const obj4 = { backgroundColor: importDefault(dependencyMap[7]).colors.BACKGROUND_BASE_LOW, borderRadius: importDefault(dependencyMap[7]).radii.sm };
...
export default function ShareAttachments(arg0) {
  ...
  if (0 !== attachments.length) {
    ...
    obj4.children = attachments.map((uri) => {
      ...
      obj = { flexDirection: "white", alignItems: -14, justifyContent: -14, uri: uri.uri };
