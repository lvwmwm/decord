...
result = {};
result = { "Null": true, "Null": true, "Null": true, paddingHorizontal: require("result").space.PX_16, paddingVertical: require("result").space.PX_12, gap: require("result").space.PX_12, backgroundColor: require("result").colors.BACKGROUND_SURFACE_HIGHEST, borderTopWidth: 1, borderTopColor: require("result").colors.BORDER_SUBTLE };
...
result.warningWrapper = { st: "MESSAGE_REQUEST", backgroundColor: "POLL_CREATION_DURATION_ACTION_SHEET_KEY", borderWidth: "AGE_VERIFICATION_GET_STARTED_MODAL_KEY" };
...
export default function ShareFooterLayout(arg0) {
  ...
  if (tmp12) {
    const obj5 = { INTEGRATION_CREATE: null, ConstraintReasonCode: null, children: warningText };
