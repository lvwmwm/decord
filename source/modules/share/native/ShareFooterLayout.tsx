...
// Dependencies: [19, 17, 21, 4255, 712, 5295, 4116, 4664, 4668, 4251, 2]
// Exports: default

// Module 10142 (ShareFooterLayout)
import "noop";
...
export default function ShareFooterLayout(arg0) {
  ...
  const sum = tmp.footer.paddingVertical + importDefault(5295)({ includeKeyboardHeight: avoidKeyboard, includeCustomKeyboardHeight: false }).insets.bottom;
  _require = sum;
  ...
  obj = { withSpring: _require(4664).withSpring, footerPaddingBottom: sum, ON_PRESS_SPRING: _require(4668).ON_PRESS_SPRING };
  fn.__closure = obj;
