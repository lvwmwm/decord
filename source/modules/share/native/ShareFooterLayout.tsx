...
// Dependencies: [19, 17, 21, 4444, 712, 5541, 4184, 4878, 4882, 4440, 2]
// Exports: default

// Module 11325 (ShareFooterLayout)
...
export default function ShareFooterLayout(arg0) {
  ...
  obj = { withSpring: _require(4878).withSpring, footerPaddingBottom: sum, ON_PRESS_SPRING: _require(4882).ON_PRESS_SPRING };
  fn.__closure = obj;
  ...
  if (tmp12) {
    ...
    obj5[2] = warningText;
    tmp12 = callback(_require(4440).Text, obj5);
  }
  items4[1] = tmp12;
  obj3[1] = items4;
