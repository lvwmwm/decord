...
// Dependencies: [19, 17, 1372, 1891, 4371, 3921, 1903, 505, 21, 4285, 712, 4475, 9582, 1297, 4281, 589, 4123, 10186, 4628, 4628, 1236, 2]
// Exports: default

// Module 10185 (FailedGroupDMRow)
...
function FailedUserRow(user) {
  ...
  if (null != user) {
    ...
    if (stateFromStores == null) {
      stateFromStores = importDefault(4123).getName(user);
...
function FailedChannelRow(channel) {
  ...
  obj[3] = channel(10186).GuildIconWithChannelTypeSizes.SMALL_32;
  const items1 = [callback(channel(10186).GuildIconWithChannelType, obj), ];
