...
// Function ID: 13070
// Name: updateTtl
// Dependencies: [32, 1922, 13070, 3605, 3633, 3588, 589, 687, 13071, 13072, 709, 2]

// Module 13069 (updateTtl)
...
prototype["isReady"] = function isReady() {
  ...
  if (!isFetchingResult) {
    ...
    if (!hasCachedValueResult) {
      hasCachedValueResult = !require(13071) /* canFetchNitroProgramReward */.canFetchAnyProgramReward("ProgramRewardsStore");
      const obj = require(13071) /* canFetchNitroProgramReward */;
    }
    if (!hasCachedValueResult) {
...
prototype["shouldFetch"] = function shouldFetch() {
  let obj = require(13071) /* canFetchNitroProgramReward */;
