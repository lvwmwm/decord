...
let obj = { runOnUI: require("module_4050").runOnUI, updateSharedValueIfChanged: "a" };
fn.__closure = obj;
...
obj = { runOnUI: require("module_4050").runOnUI };
fn.__closure = obj;
...
fn2 = function u(get) {
  if (globalThis._WORKLET) {
    ...
    fn2(4050).runOnUI(fn2)(get, arg1);
    const obj = fn2(4050);
  }
};
obj = { runOnUI: require("module_4050").runOnUI, updateSharedValueArrayIfChanged: "a" };
fn2.__closure = obj;
...
fn2.__closure = { runOnUI: require("module_4050").runOnUI };
...
const obj1 = { runOnUI: require("module_4050").runOnUI };
