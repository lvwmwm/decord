...
let obj = { runOnUI: _mod4218.runOnUI, updateSharedValueIfChanged: "Array" };
fn.__closure = obj;
...
fn2 = function u(get) {
  if (globalThis._WORKLET) {
    ...
    fn2(4218).runOnUI(fn2)(get, arg1);
    const obj = fn2(4218);
  }
};
obj = { runOnUI: _mod4218.runOnUI, updateSharedValueArrayIfChanged: "Array" };
fn2.__closure = obj;
...
fn2.__closure = { runOnUI: _mod4218.runOnUI };
...
const obj1 = { runOnUI: _mod4218.runOnUI };
