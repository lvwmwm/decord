...
let obj = { runOnUI: require(dependencyMap[0]).runOnUI, updateSharedValueIfChanged: undefined };
fn.__closure = obj;
...
obj = { runOnUI: require(dependencyMap[0]).runOnUI };
fn.__closure = obj;
...
const result = _module.fileFinishedImporting("modules/reanimated/utils/updateSharedValueIfChanged.native.tsx");

export default fn;
export const updateSharedValueArrayIfChanged = () => {
  const fn = function u(get) {
    if (globalThis._WORKLET) {
      const value = get.get();
      ...
      fn(closure_1[0]).runOnUI(fn)(get, arg1);
      const obj = fn(closure_1[0]);
    }
  };
  let obj = { runOnUI: require(dependencyMap[0]).runOnUI, updateSharedValueArrayIfChanged: undefined };
  fn.__closure = obj;
