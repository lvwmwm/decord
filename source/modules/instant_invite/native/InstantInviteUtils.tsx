...
// Dependencies: [6828, 1376, 1372, 8988, 1932, 4270, 4371, 1874, 8992, 7116, 8993, 676, 698, 7118, 8994, 8995, 4271, 4253, 8845, 3985, 7138, 5638, 4458, 38, 8990, 2]
...
// Module 8987 (showInstantInviteActionSheet)
...
export const handleOpenShareSheet = function handleOpenShareSheet(code, channel, intl, ADD_FRIENDS_WIDGET) {
  ...
  if (null != code) {
    ...
    tmp21(8845).showShareActionSheet(obj, ADD_FRIENDS_WIDGET);
    const tmp21Result = tmp21(8845);
  }
};
