// Module ID: 9304
// Function ID: 9305
// Dependencies: [32, 19, 17, 9305, 21, 4444, 712, 4886, 5599, 9340, 7963, 9309, 2]
...
import SHARE_APPS_KEY from "SHARE_APPS_KEY" /* 9305 */;
...
const memoResult = importAllResult.memo(function InstantInviteShareApps(onItemPressed) {
  ...
  const gesture = onItemPressed(5599).useNativeGesture({ disallowInterruption: true });
  ...
  return jsx(onItemPressed(5599).GestureDetector, { gesture, children });
});
