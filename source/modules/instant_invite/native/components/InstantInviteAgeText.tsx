...
// Dependencies: [19, 17, 9213, 21, 4380, 8348, 589, 4376, 9214, 4949, 9212, 1236, 2]
// Exports: default

// Module 9273 (InstantInviteAgeText)
...
export default function InstantInviteAgeText(style) {
  ...
  if (null != stateFromStores) {
    ...
    obj[0] = str2;
    const items2 = [tmp2(9214).maxAgeString(stateFromStores.maxAge, stateFromStores.maxUses), " "];
    obj[1] = items2;
    const items3 = [closure_4(tmp2(4376).Text, obj), ];
    if (canEditInvite) {
      ...
      obj1[4] = closure_5(tmp2(4376).Text, obj2);
      canEditInvite = tmp9(tmp2(4949).PressableOpacity, obj1);
    }
    items3[1] = canEditInvite;
    obj[1] = items3;
    tmp7Result = tmp7(View, obj);
    const tmp2Result = tmp2(9214);
    const tmp8 = View;
  }
  return tmp7Result;
};
