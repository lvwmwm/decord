...
// Dependencies: [19, 17, 1910, 1922, 676, 21, 4661, 712, 7188, 589, 1236, 709, 4093, 7175, 6949, 12373, 4734, 2]
// Exports: default
  ...
  if (null != channel) {
    ...
    if (null != channel2) {
      ...
      if (null != store.getGuild(channel2.guild_id)) {
        ...
        tmp13 = callback(importDefault(7188), obj2);
        const tmp16 = importDefault(7188);
      }
    }
    ...
    obj6[3] = plainText;
    const items2 = [callback(importDefault(12373), obj6), ];
