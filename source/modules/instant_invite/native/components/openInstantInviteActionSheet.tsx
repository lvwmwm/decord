...
// Dependencies: [4411, 9289, 2009, 503, 2]
// Exports: default

// Module 9288 (openInstantInviteActionSheet)
...
export default function openInstantInviteActionSheet(invite_channel_id) {
  ...
  obj.openLazy(asyncRequireImpl(9289, dependencyMap.paths), combined, obj, invite_channel_id.stackingBehavior);
};
