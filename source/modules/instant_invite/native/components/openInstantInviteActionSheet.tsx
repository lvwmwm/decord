...
// Dependencies: [4347, 9221, 2009, 503, 2]
// Exports: default

// Module 9220 (openInstantInviteActionSheet)
...
export default function openInstantInviteActionSheet(invite_channel_id) {
  ...
  obj.openLazy(asyncRequireImpl(9221, dependencyMap.paths), combined, obj, invite_channel_id.stackingBehavior);
};
