...
// Dependencies: [4098, 8535, 1934, 480, 2]
// Exports: default

// Module 8534 (openInstantInviteActionSheet)
...
export default function openInstantInviteActionSheet(invite_channel_id) {
  ...
  obj.openLazy(require(1934) /* maybeLoadBundle */(8535, dependencyMap.paths), combined, obj, invite_channel_id.stackingBehavior);
};
