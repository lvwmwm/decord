...
// Dependencies: [4312, 9119, 2007, 503, 2]
// Exports: default

// Module 9118 (openInstantInviteActionSheet)
...
export default function openInstantInviteActionSheet(invite_channel_id) {
  ...
  obj.openLazy(require(2007) /* asyncRequireImpl */(9119, dependencyMap.paths), combined, obj, invite_channel_id.stackingBehavior);
};
