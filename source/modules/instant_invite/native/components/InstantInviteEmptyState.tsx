...
// Dependencies: [19, 17, 8989, 21, 4285, 712, 589, 1297, 9010, 1236, 8390, 4827, 5932, 4281, 8990, 4695, 2]
// Exports: default

// Module 9009 (stateFromStores)
import "noop";
...
export default function _default(link) {
  ...
  const items2 = [callback(importDefault(8390), obj2), ];
  ...
  obj3[4] = callback(stateFromStores(5932).SettingsIcon, {});
  items2[1] = callback(stateFromStores(4827).PressableOpacity, obj3);
  obj1[1] = items2;
  ...
  if (null == stateFromStores) {
    ...
    obj5[1] = onShare;
    items1[3] = tmp7(tmp2(4695).Button, obj5);
    obj[1] = items1;
    return tmp5(tmp6, obj);
  } else {
    const maxAgeOptionByValue = tmp8(8990).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(8990).getMaxUsesOptions;
