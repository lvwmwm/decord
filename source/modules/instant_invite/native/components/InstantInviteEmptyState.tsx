...
// Dependencies: [19, 17, 8353, 21, 4193, 712, 589, 1297, 12255, 1236, 9006, 4721, 9020, 4189, 8354, 4604, 2]
// Exports: default
...
export default function _default(link) {
  ...
  const items2 = [callback(importDefault(9006), obj2), ];
  ...
  obj3[4] = callback(stateFromStores(9020).SettingsIcon, {});
  items2[1] = callback(stateFromStores(4721).PressableOpacity, obj3);
  obj1[1] = items2;
  ...
  if (null == stateFromStores) {
    ...
    obj5[1] = onShare;
    items1[3] = tmp7(tmp2(4604).Button, obj5);
    obj[1] = items1;
    return tmp5(tmp6, obj);
  } else {
    const maxAgeOptionByValue = tmp8(8354).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(8354).getMaxUsesOptions;
