...
// Dependencies: [19, 17, 9115, 21, 4342, 712, 589, 1297, 9137, 1236, 8516, 4887, 6054, 4338, 9116, 4755, 2]
// Exports: default

// Module 9136 (stateFromStores)
import "noop";
...
export default function _default(link) {
  ...
  const items2 = [callback(importDefault(8516), obj2), ];
  ...
  obj3[4] = callback(stateFromStores(6054).SettingsIcon, {});
  items2[1] = callback(stateFromStores(4887).PressableOpacity, obj3);
  obj1[1] = items2;
  ...
  if (null == stateFromStores) {
    ...
    obj5[1] = onShare;
    items1[3] = tmp7(tmp2(4755).Button, obj5);
    obj[1] = items1;
    return tmp5(tmp6, obj);
  } else {
    const maxAgeOptionByValue = tmp8(9116).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(9116).getMaxUsesOptions;
