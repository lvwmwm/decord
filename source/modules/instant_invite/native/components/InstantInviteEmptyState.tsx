...
// Dependencies: [19, 17, 8960, 21, 4255, 712, 589, 1297, 8981, 1236, 8250, 4797, 5905, 4251, 8961, 4665, 2]
// Exports: default

// Module 8980 (stateFromStores)
import "noop";
...
export default function _default(link) {
  ...
  const items2 = [callback(importDefault(8250), obj2), ];
  ...
  obj3[4] = callback(stateFromStores(5905).SettingsIcon, {});
  items2[1] = callback(stateFromStores(4797).PressableOpacity, obj3);
  obj1[1] = items2;
  ...
  if (null == stateFromStores) {
    ...
    obj5[1] = onShare;
    items1[3] = tmp7(tmp2(4665).Button, obj5);
    obj[1] = items1;
    return tmp5(tmp6, obj);
  } else {
    const maxAgeOptionByValue = tmp8(8961).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(8961).getMaxUsesOptions;
