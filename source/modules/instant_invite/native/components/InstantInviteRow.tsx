...
let obj = {};
obj = { borderRadius: importDefault(dependencyMap[11]).radii.lg, backgroundColor: importDefault(dependencyMap[11]).colors.BACKGROUND_BASE_LOW, borderColor: importDefault(dependencyMap[11]).colors.BORDER_MUTED };
obj.acronym = obj;
