// Module ID: 9073
// Function ID: 9074
// Dependencies: [19, 17, 7136, 21, 4302, 1236, 4712, 2]
...
const memoResult = require("noop").memo(function InviteButton(onPress) {
  ...
  obj[5] = disabled;
  obj[1] = jsx(require(4712) /* Button */.Button, { accessibilityRole: "none", size: "sm", variant: "secondary", text: stringResult1, onPress: onPress.onPressSend, disabled: null, grow: true });
