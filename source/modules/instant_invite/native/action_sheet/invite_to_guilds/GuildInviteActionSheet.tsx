...
// Function ID: 12501
// Name: EmptyGuildList
// Dependencies: [32, 19, 17, 21, 4303, 712, 1297, 1236, 12501, 12502, 12498, 4299, 5369, 9474, 12503, 5396, 5397, 5994, 9073, 2]
// Exports: default

// Module 12500 (EmptyGuildList)
...
function EmptyGuildList() {
  ...
  obj[3] = importDefault(12501);
  obj[4] = importDefault(12502);
...
export default function GuildInviteActionSheet(arg0) {
  ...
  obj = { scrollable: true, startExpanded: true, header: callback2(_require(5396).BottomSheetTitleHeader, obj), contentStyles: tmp.content, children: null };
