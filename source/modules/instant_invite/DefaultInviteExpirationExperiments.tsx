...
// Dependencies: [1910, 676, 9112, 4256, 647, 2]
// Exports: useDefaultInviteExpiration, useMaxAgeOptions

// Module 9114 (getDefaultInviteExpiration)
...
function getDefaultInviteExpiration(arg0) {
  ...
  if (hasItem) {
    return importDefault(9112).INVITE_OPTIONS_FOREVER.value;
...
export const useMaxAgeOptions = function useMaxAgeOptions(arg0) {
  ...
  return importDefault(9112).getMaxAgeOptions({ includeExperimentalValues });
};
