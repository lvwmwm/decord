...
// Dependencies: [1891, 676, 8990, 4197, 647, 2]
// Exports: useDefaultInviteExpiration, useMaxAgeOptions

// Module 8992 (getDefaultInviteExpiration)
...
function getDefaultInviteExpiration(arg0) {
  ...
  if (hasItem) {
    return importDefault(8990).INVITE_OPTIONS_FOREVER.value;
...
export const useMaxAgeOptions = function useMaxAgeOptions(arg0) {
  ...
  return importDefault(8990).getMaxAgeOptions({ includeExperimentalValues });
};
