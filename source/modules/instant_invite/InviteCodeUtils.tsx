...
export const generateInviteKeyFromUrlParams = function generateInviteKeyFromUrlParams(inviteHostRemainingPath, search) {
  if (null == search) {
    ...
    try {
      ...
      const tmp6 = require;
      const tmp12 = readSnowflake(require(4290) /* getFirstQueryStringValue */.getFirstQueryStringValue(parsed[channel]));
...
export const parseExtraDataFromInviteKey = function parseExtraDataFromInviteKey(inviteKey) {
  ...
  if (null == tmp3) {
    ...
    const firstQueryStringValue1 = require(4290) /* getFirstQueryStringValue */.getFirstQueryStringValue(parsed[channel]);
    let tmp4;
