...
// Dependencies: [11280, 644, 4146, 705, 4694, 2]
...
let obj = keys.create(() => {
  ...
  obj[0] = require(4146).makeMutable(items);
  obj[6] = [];
  return obj;
});
let result = require("module_4146").fileFinishedImporting("modules/voice_messages/native/VoiceMessagesUIStore.tsx");
