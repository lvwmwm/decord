...
let result = require("module_4050").fileFinishedImporting("modules/voice_messages/native/VoiceMessagesUIStore.tsx");
...
export const resetVoiceMessageState = function resetVoiceMessageState() {
  ...
  const currWaveHeight = obj.getState().currWaveHeight;
  if (null != currWaveHeight) {
    const result = currWaveHeight.set(require(4599) /* CONFIG_NEVER_ANIMATE */.withSpring(0));
    const tmpResult = require(4599) /* CONFIG_NEVER_ANIMATE */;
  }
};
