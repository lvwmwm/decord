...
function resetAudioRecording() {
  ...
  mediaEngine.removeListener(require(4352) /* BaseConnectionEvent */.MediaEngineEvent.VoiceActivity, closure_21);
  callback3();
}
function stopAndGetAudioRecording() {
  ...
  if (mapped.length > closure_16) {
    arr3 = importDefault(11541)(mapped, tmp3);
  }
...
export const generateBase64EncodedWaveform = function generateBase64EncodedWaveform(arg0) {
  ...
  if (arg0.length > closure_16) {
    arr = importDefault(11541)(arg0, tmp);
  }
