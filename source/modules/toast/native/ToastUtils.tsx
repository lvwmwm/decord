...
// Dependencies: [676, 4062, 1236, 4063, 4280, 4282, 4284, 4286, 4288, 4290, 4292, 4294, 1435, 4296, 4298, 4301, 514, 4303, 4306, 2]
...
export const presentGameFriendRequestAcceptedToast = function presentGameFriendRequestAcceptedToast() {
  ...
  obj[2] = require(4282) /* UserPlatformIcon */.UserPlatformIcon;
  obj.open(obj);
};
export const presentFriendRequestIgnoredToast = function presentFriendRequestIgnoredToast() {
  ...
  obj[2] = require(4284) /* UserMinusIcon */.UserMinusIcon;
  obj.open(obj);
};
...
export const presentLinkCopied = function presentLinkCopied() {
  ...
  obj[2] = require(4286) /* LinkIcon */.LinkIcon;
  obj.open(obj);
};
export const presentInviteSent = function presentInviteSent() {
  ...
  obj[2] = require(4288) /* SendMessageIcon */.SendMessageIcon;
  obj.open(obj);
};
export const presentIdCopied = function presentIdCopied() {
  ...
  obj[2] = require(4290) /* CopyIcon */.CopyIcon;
  obj.open(obj);
};
export const presentImageSaved = function presentImageSaved() {
  ...
  obj[2] = require(4292) /* DownloadIcon */.DownloadIcon;
  obj.open(obj);
};
...
export const presentFeedbackSent = function presentFeedbackSent() {
  ...
  obj[2] = require(4294) /* CheckmarkLargeIcon */.CheckmarkLargeIcon;
  obj.open(obj);
};
...
export const presentNoiseCancellationError = function presentNoiseCancellationError() {
  ...
  obj[2] = require(4296) /* XLargeIcon */.XLargeIcon;
  obj.open(obj);
};
export const presentError = function presentError(intl) {
  let obj = importDefault(4062);
  obj = { key: "ERROR", content: intl, IconComponent: require(4296) /* XLargeIcon */.XLargeIcon, iconColor: "icon-feedback-critical" };
  obj.open(obj);
};
...
export const communityAdminOnly = function communityAdminOnly() {
  ...
  obj[2] = require(4298) /* CircleInformationIcon */.CircleInformationIcon;
  obj.open(obj);
};
export const unverifiedVoiceGate = function unverifiedVoiceGate(check) {
  ...
  if (null != stringResult) {
    ...
    obj1[1] = stringResult;
    obj1[2] = require(4298) /* CircleInformationIcon */.CircleInformationIcon;
...
export const memberOrRoleRemovedToast = function memberOrRoleRemovedToast(closure_1) {
  ...
  obj[2] = require(4301) /* TrashIcon */.TrashIcon;
  obj.open(obj);
};
...
export const presentFailedToast = function presentFailedToast(intl) {
  let obj = importDefault(4062);
  obj = { key: "FAILED", content: intl, IconComponent: require(4296) /* XLargeIcon */.XLargeIcon, iconColor: "icon-feedback-critical" };
  obj.open(obj);
};
...
export const showSafetySuccess = function showSafetySuccess(BLOCK_SUCCESS, safetyToastTypeContent) {
  let obj = importDefault(4062);
  obj = { key: BLOCK_SUCCESS, content: safetyToastTypeContent, IconComponent: require(4303) /* CircleCheckIcon */.CircleCheckIcon, iconColor: "status-positive" };
  obj.open(obj);
};
...
export const presentTimestamp = function presentTimestamp(full) {
  let obj = importDefault(4062);
  obj = { key: "MESSAGE_TIMESTAMP", content: full, IconComponent: require(4306) /* ClockIcon */.ClockIcon };
  obj.open(obj);
};
