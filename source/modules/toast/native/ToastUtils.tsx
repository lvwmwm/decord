...
// Dependencies: [676, 3985, 1236, 3986, 4223, 4225, 4227, 4229, 4231, 4233, 4235, 4237, 1416, 4239, 4241, 4244, 514, 4246, 4249, 2]
...
// Module 3984 (presentAddedFriendToast)
...
export const presentAddedFriendToast = function presentAddedFriendToast() {
  ...
  obj[3] = require(3986) /* FriendsIcon */.FriendsIcon;
  obj.open(obj);
};
