...
// Function ID: 4919
// Name: isBlurDisabled
// Dependencies: [19, 17, 4919, 21, 1234, 4920, 4197, 709, 4923, 2]
...
export default importAllResult.forwardRef(function VisualEffectView(blurAmount) {
  ...
  if (closure_6) {
    ...
    if (!tmp13) {
      if (android_softwareBlurDisabled) {
        android_softwareBlurDisabled = !tmp3(4923).MODERN_ANDROID_BLURRING_AVAILABLE;
      }
  ...
  if (tmp12) {
    ...
    tmp14Result = tmp14(tmp5(4923), obj1);
    const tmp5Result = tmp5(4923);
  } else {
    ...
    if (blurEffectNameOverride != null) {
      ...
      if (!tmp3(4920).MODERN_IOS_BLURS_EFFECTS_AVAILABLE) {
