...
// Function ID: 4884
// Name: isBlurDisabled
// Dependencies: [19, 17, 4884, 21, 500, 4885, 4166, 712, 4888, 2]
// Exports: isBlurDisabled

// Module 4883 (isBlurDisabled)
import ThemesDefault from "Themes" /* 712 */;
import map from "map" /* 4166 */;
import MODERN_ANDROID_BLURRING_AVAILABLE from "MODERN_ANDROID_BLURRING_AVAILABLE" /* 4888 */;
import { View } from "get ActivityIndicator" /* 17 */;
import { useVisualEffectViewOverrides as closure_4 } from "useVisualEffectViewOverrides" /* 4884 */;
...
export default importAllResult.forwardRef(function VisualEffectView(blurAmount) {
  ...
  if (closure_6) {
    ...
    if (!tmp13) {
      if (android_softwareBlurDisabled) {
        android_softwareBlurDisabled = !tmp3(4888).MODERN_ANDROID_BLURRING_AVAILABLE;
      }
  ...
  if (tmp12) {
    ...
    tmp14Result = tmp14(tmp5(4888), obj1);
    const tmp5Result = tmp5(4888);
  } else {
    ...
    if (blurEffectNameOverride != null) {
      ...
      if (!tmp3(4885).MODERN_IOS_BLURS_EFFECTS_AVAILABLE) {
