...
// Function ID: 4871
// Name: isBlurDisabled
// Dependencies: [19, 17, 4871, 21, 500, 4872, 4165, 712, 4875, 2]
// Exports: isBlurDisabled

// Module 4870 (isBlurDisabled)
import ThemesDefault from "Themes" /* 712 */;
import map from "map" /* 4165 */;
import MODERN_ANDROID_BLURRING_AVAILABLE from "MODERN_ANDROID_BLURRING_AVAILABLE" /* 4875 */;
import { View } from "get ActivityIndicator" /* 17 */;
import { useVisualEffectViewOverrides as closure_4 } from "useVisualEffectViewOverrides" /* 4871 */;
...
export default importAllResult.forwardRef(function VisualEffectView(blurAmount) {
  ...
  if (closure_6) {
    ...
    if (!tmp13) {
      if (android_softwareBlurDisabled) {
        android_softwareBlurDisabled = !tmp3(4875).MODERN_ANDROID_BLURRING_AVAILABLE;
      }
  ...
  if (tmp12) {
    ...
    tmp14Result = tmp14(tmp5(4875), obj1);
    ...
    if (blurEffectNameOverride != null) {
      ...
      if (!tmp3(4872).MODERN_IOS_BLURS_EFFECTS_AVAILABLE) {
