// Module ID: 14927
// Function ID: 14928
// Dependencies: [32, 19, 17, 4657, 21, 4255, 712, 14924, 4099, 7765, 5622, 14926, 13777, 688, 2]
...
const memoResult = importAllResult.memo(function VEVOOPropBlurTintRgba() {
  let require;
  let tmp7;
  let obj = require(14924) /* VisualEffectViewOverrideOverlay_ */;
  ...
  obj[3] = callback2(require(5622) /* FormSwitch */.FormSwitch, obj);
  ...
  const items2 = [callback2(require(7765) /* Form */.FormRow, obj1), ];
  ...
  items2[1] = callback2(require(7765) /* Form */.FormRow, obj2);
  obj3[0] = items2;
  obj[4] = tmp14(tmp15, obj3);
  obj[5] = !tmp7;
  obj[6] = function onPress() {
    const obj = { color: null, onSelect: null };
    const tmp = first(13777);
  ...
  return callback2(require(7765) /* Form */.FormRow, obj);
});
