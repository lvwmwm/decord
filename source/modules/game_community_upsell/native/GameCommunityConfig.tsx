...
// Module 14466 (DETECTABLE_GAME_TO_APPLICATION_ID_MAP)
...
const result = require("__exportStarResult1").fileFinishedImporting("modules/game_community_upsell/native/GameCommunityConfig.tsx");
