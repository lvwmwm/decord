...
// Function ID: 15149
// Name: headerTitle
// Dependencies: [5, 19, 14074, 5867, 15149, 15150, 676, 21, 503, 15151, 15157, 15158, 15170, 15171, 15177, 8515, 15179, 15180, 8567, 8564, 15184, 15185, 15189, 15190, 1500, 1903, 15160, 4243, 8520, 15197, 2]
  ...
  const tmp = callback((arg0, arg1, arg2) => {
    ...
    return (function*(arg0, arg1, arg2) {
      ...
      if (1 === tmp7) {
        ...
        v0 = closure_5;
        v02(false);
        if (v0 instanceof callback(4243).APIError) {
          obj1 = callback(8520);
...
export const getAllAuthScreens = function getAllAuthScreens() {
  ...
  obj8[5] = function render() {
    return callback4(callback2(8515), {});
  };
  ...
  obj[AuthStates.COUNTRY_SELECT] = {
    ...
    render(arg0, arg1) {
      let closure_0 = arg1;
      return callback4(callback2(8567), {
        onClose() {
          return arr.pop();
        },
