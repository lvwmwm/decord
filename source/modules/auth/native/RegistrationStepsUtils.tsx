...
// Function ID: 15537
// Name: headerTitle
// Dependencies: [5, 19, 14368, 6053, 15537, 15538, 676, 21, 503, 15539, 15545, 15546, 15558, 15559, 15565, 7715, 15567, 15568, 7774, 7771, 15572, 15573, 15577, 15578, 1500, 1902, 15548, 4376, 7721, 15585, 2]
...
// Module 15536 (headerTitle)
import noopAll from "noop" /* 19 */;
import encodeProperties from "encodeProperties" /* 503 */;
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "isRateLimited" /* 14368 */;
import { usePromoEmailConsentStore } from "setPromoEmailConsentState" /* 6053 */;
    ...
    return (function*(arg0, arg1, arg2) {
      ...
      if (1 === tmp7) {
        ...
        if (v0 instanceof callback(4376).APIError) {
          ...
          if (null != closure_5) {
            callback2(15585)(callback2, dependencyMap, authenticationErrorsFromAPIError, closure_5);
          }
          state = 3;
        } else {
          state = 3;
...
export const getAllAuthScreens = function getAllAuthScreens() {
  ...
  obj = {
    ...
    headerLeft(arg0) {
      ...
      return closure_15(callback(15545).BackButtonWithTracking, obj);
    },
    render() {
  ...
  obj6[4] = function headerLeft(arg0) {
    ...
    return callback4(callback(15545).BackButtonWithTracking, obj);
  };
  ...
  obj8[5] = function render() {
    return callback4(callback2(7715), {});
  };
  ...
  obj[AuthStates.COUNTRY_SELECT] = {
    ...
    render(arg0, arg1) {
      closure_0 = arg1;
      return callback4(callback2(7774), {
        onClose() {
          return arr.pop();
        },
