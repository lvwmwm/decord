...
// Function ID: 15870
// Name: headerTitle
// Dependencies: [5, 19, 14634, 6535, 15870, 15871, 673, 21, 500, 15872, 15878, 15879, 15891, 15892, 15898, 6882, 15900, 15901, 6988, 6985, 15905, 15906, 15910, 15911, 1499, 1901, 15881, 4379, 6888, 15918, 2]
...
// Module 15869 (headerTitle)
import noopAll from "noop" /* 19 */;
import encodeProperties from "encodeProperties" /* 500 */;
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "isRateLimited" /* 14634 */;
import { usePromoEmailConsentStore } from "setPromoEmailConsentState" /* 6535 */;
...
function _handleRegistrationSubmit() {
  ...
  const tmp = callback((arg0, arg1, arg2) => {
    ...
    return (function*(arg0, arg1, arg2) {
      ...
      v0({});
      v0 = 1;
      let obj3 = callback(15881);
      yield obj3.registerFull(obj1);
      if (1 === tmp7) {
        v0 = 0;
        v0 = closure_5;
        v02(false);
        if (v0 instanceof callback(4379).APIError) {
          obj1 = callback(6888);
          ...
          if (null != closure_5) {
            callback2(15918)(callback2, dependencyMap, authenticationErrorsFromAPIError, closure_5);
          }
          state = 3;
        } else {
          state = 3;
...
export const getAllAuthScreens = function getAllAuthScreens() {
  ...
  obj = {
    ...
    headerShown: false,
    render() {
      return callback4(callback2(15872), {});
    }
  };
  ...
  obj = {
    ...
    headerLeft(arg0) {
      ...
      return closure_15(callback(15878).BackButtonWithTracking, obj);
    },
    render() {
      return callback4(callback(15879).RegisterIdentity, {});
    }
  };
  ...
  obj2[6] = function render() {
    return callback4(callback2(15891), {});
  };
  ...
  obj4[6] = function render() {
    return callback4(callback2(15892), {});
  };
  ...
  obj6[4] = function headerLeft(arg0) {
    ...
    return callback4(callback(15878).BackButtonWithTracking, obj);
  };
  obj6[5] = function render(arg0) {
    const merged = Object.assign(arg0);
    return callback4(callback2(15898), {});
  };
  ...
  obj8[5] = function render() {
    return callback4(callback2(6882), {});
  };
  ...
  obj[AuthStates.MFA] = {
    ...
    headerShown: false,
    render() {
      return callback4(callback2(15900), { inContainer: true });
    }
  };
  obj[AuthStates.ACCOUNT_DISABLED_OR_DELETION_SCHEDULED] = {
    ...
    render(arg0) {
      const merged = Object.assign(arg0);
      return callback4(callback2(15901), {});
    }
  };
  obj[AuthStates.COUNTRY_SELECT] = {
    ...
    render(arg0, arg1) {
      closure_0 = arg1;
      return callback4(callback2(6988), {
        onClose() {
          return arr.pop();
        },
  ...
  obj[AuthStates.EXTERNAL_LINK] = {
    ...
    render(arg0) {
      const merged = Object.assign(arg0);
      return callback4(callback2(15905), {});
    }
  };
  ...
  obj[AuthStates.AGE_GATE] = {
    ...
    render() {
      return callback4(callback2(15906), {});
    }
  };
  const obj10 = {
    ignoreKeyboard: true,
  ...
  obj[AuthStates.AGE_GATE_UNDERAGE] = {
    ...
    impressionProperties(existingUser) {
      return { impression_group: callback(500).ImpressionGroups.USER_REGISTRATION_FLOW, existing_user: existingUser.existingUser };
    },
    headerTitle,
    render(arg0, arg1) {
      closure_0 = arg1;
      const merged = Object.assign(arg0);
      return callback4(callback2(15910), {
        onClose() {
  ...
  obj[AuthStates.COMPANION_REMOTE_AUTH] = {
    ...
    headerTitle,
    render() {
      return callback4(callback(15911).CompanionRemoteAuth, {});
    }
  };
  return obj;
};
