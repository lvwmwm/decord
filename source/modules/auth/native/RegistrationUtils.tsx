...
export const BackButtonWithTracking = function BackButtonWithTracking(arg0) {
  let dependencyMap;
  let importDefault;
  _require = React.useContext(_require(15009).TrackRegistrationContext);
  ...
  return jsx(_require(5276).HeaderBackButton, {});
};
