...
export const BackButtonWithTracking = function BackButtonWithTracking(arg0) {
  let dependencyMap;
  let importDefault;
  _require = React.useContext(_require(14858).TrackRegistrationContext);
