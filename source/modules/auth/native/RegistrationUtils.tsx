...
export const BackButtonWithTracking = function BackButtonWithTracking(arg0) {
  let dependencyMap;
  let importDefault;
  _require = React.useContext(_require(15147).TrackRegistrationContext);
  ...
  return jsx(_require(5317).HeaderBackButton, {});
};
