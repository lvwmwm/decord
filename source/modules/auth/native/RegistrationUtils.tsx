...
export const BackButtonWithTracking = function BackButtonWithTracking(arg0) {
  let dependencyMap;
  let importDefault;
  _require = React.useContext(_require(15161).TrackRegistrationContext);
  ...
  return jsx(_require(5338).HeaderBackButton, {});
};
