...
// Dependencies: [1903, 1365, 676, 5244, 5937, 5748, 2]

// Module 16379 (handleConnectionOpen)
  ...
  if (null != currentUser) {
    ...
    if (result) {
      if (result1) {
        ...
        currentUser(5937).openUserSettings(obj);
        const obj2 = currentUser(5937);
      }
    }
    if (result1) {
      obj = importDefault(5748);
