...
// Dependencies: [1922, 1384, 676, 5301, 6059, 5867, 2]

// Module 16561 (handleConnectionOpen)
  ...
  if (null != currentUser) {
    ...
    if (result) {
      if (result1) {
        ...
        currentUser(6059).openUserSettings(obj);
        const obj2 = currentUser(6059);
      }
    }
    if (result1) {
      obj = importDefault(5867);
