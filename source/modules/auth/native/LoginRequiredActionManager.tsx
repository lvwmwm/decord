...
// Dependencies: [1922, 1384, 676, 5300, 6057, 5866, 2]

// Module 16559 (handleConnectionOpen)
  ...
  if (null != currentUser) {
    ...
    if (result) {
      if (result1) {
        ...
        currentUser(6057).openUserSettings(obj);
        const obj2 = currentUser(6057);
      }
    }
    if (result1) {
      obj = importDefault(5866);
