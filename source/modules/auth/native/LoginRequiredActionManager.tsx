...
// Dependencies: [1874, 1365, 676, 5214, 5910, 5721, 2]

// Module 16339 (handleConnectionOpen)
  ...
  if (null != currentUser) {
    ...
    if (result) {
      if (result1) {
        ...
        currentUser(5910).openUserSettings(obj);
        const obj2 = currentUser(5910);
      }
    }
    if (result1) {
      obj = importDefault(5721);
