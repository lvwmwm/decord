...
// Dependencies: [14855, 676, 691, 9201, 14853, 14862, 2]
// Exports: default

// Module 14902 (getRedirectStepForErrorKey)
...
export default function handleRegisterErrorRedirection(navigate, arg1, code) {
  if (null == importDefault(9201)("date_of_birth", code)) {
    const _Number = Number;
    if (Number(code.code) !== AbortCodes.UNDER_MINIMUM_AGE) {
      const registrationSteps = require(14853) /* headerTitle */.getRegistrationSteps();
      ...
      while (obj8 !== undefined) {
        ...
        for (const item10023 of items) {
          ...
          let tmp13 = importDefault(9201)(item10023, arg2);
          if (null != tmp13) {
            ...
            if (null != tmp17) {
              ...
              let tmp23 = require;
              let tmp24 = tmp11;
              let obj3 = require(14862) /* trackRegTransition */;
      ...
      if (tmp29) {
        ...
        obj[0] = arg3;
        obj[1] = constants2.RESPONSE_ERROR;
        const items2 = [require(14862) /* trackRegTransition */.getCommonErrorDetails(code.error_code)];
        obj[2] = items2;
        arg1(obj);
        const obj5 = require(14862) /* trackRegTransition */;
      }
    }
  }
