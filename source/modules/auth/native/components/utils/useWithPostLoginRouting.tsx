...
// Dependencies: [5, 32, 19, 1218, 676, 589, 1236, 9204, 5641, 2]
// Exports: default

// Module 9203 (useWithPostLoginRouting)
  ...
  const effect = React.useEffect(() => {
    ...
    if (outer1_7.PASSWORD_RECOVERY_PHONE_VERIFICATION === loginStatus) {
      ...
      obj[3] = function onPhoneTokenReceived(arg0) {
        const replaced = closure_0.replace(outer1_8.EXTERNAL_LINK, { externalURL: outer1_1(9204)(arg0) });
      };
