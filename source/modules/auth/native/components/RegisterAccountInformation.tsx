...
// Dependencies: [5, 32, 19, 17, 6019, 4430, 8805, 15468, 15469, 676, 21, 4446, 712, 4186, 7664, 15466, 589, 15491, 15493, 15476, 1236, 15484, 15467, 15483, 7692, 15494, 15495, 4893, 7661, 6014, 2]
// Exports: default

// Module 15490 (RegisterAccountInformation)
import ThemesDefault from "Themes" /* 712 */;
import _modDef4186 from "module_4186" /* 4186 */;
import useWideAuthViewDefault from "useWideAuthView" /* 7664 */;
import useInitialRegistrationStepDefault from "useInitialRegistrationStep" /* 15483 */;
...
import closure_10 from "getDisplayedInviteCode" /* 8805 */;
...
import { LinearTransition, Easing } from "module_4186" /* 4186 */;
...
export default function RegisterAccountInformation() {
  ...
  let obj = React;
  context = React.useContext(context(15466).TrackRegistrationContext);
  ...
  let tmpResult = tmp(15484);
  const tmp9 = callback(React.useState(false), 2);
  tmpResult(context(15467).getPreviousRegistrationTransitionStep(AuthStates.REGISTER_ACCOUNT_INFORMATION));
  ...
  obj3 = { style: tmp4.container, children: callback3(tmp5(15494).RegisterUsernameInput, { username, setUsername, onSubmitEditing: callback, usernameStatus, submitBehavior: "submit", autoFocus: true }) };
  ...
  obj5[5] = str;
  obj4.children = callback3(context(15495).RegisterPasswordInput, obj5);
  items4[1] = callback3(_modDef4186.View, obj4);
  ...
  const items5 = [callback3(context(4893).Button, obj7), ];
  ...
  if (null != tmp11.message) {
    ...
    if ("" !== tmp11.message) {
      ...
      tmp27Result = tmp27(tmp(7661), obj8);
    }
  }
  items5[1] = tmp27Result;
  obj6.children = items5;
  items4[2] = closure_18(_modDef4186.View, obj6);
  obj2[2] = items4;
  ...
  if (!tmp3) {
    ...
    obj9[0] = tmp4.page;
    obj9[1] = tmp27Result;
    tmp27Result1 = tmp27(tmp(6014), obj9);
  }
  return tmp27Result1;
};
