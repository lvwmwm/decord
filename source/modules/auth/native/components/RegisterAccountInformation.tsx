...
// Dependencies: [5, 32, 19, 17, 6006, 4429, 8788, 15450, 15451, 676, 21, 4445, 712, 4185, 7650, 15448, 589, 15473, 15475, 15458, 1236, 15466, 15449, 15465, 7678, 15476, 15477, 4880, 7647, 6001, 2]
// Exports: default

// Module 15472 (RegisterAccountInformation)
import ThemesDefault from "Themes" /* 712 */;
import _modDef4185 from "module_4185" /* 4185 */;
import useWideAuthViewDefault from "useWideAuthView" /* 7650 */;
import useInitialRegistrationStepDefault from "useInitialRegistrationStep" /* 15465 */;
...
import closure_10 from "getDisplayedInviteCode" /* 8788 */;
...
import { LinearTransition, Easing } from "module_4185" /* 4185 */;
...
export default function RegisterAccountInformation() {
  ...
  let tmpResult = tmp(15466);
  const tmp9 = callback(React.useState(false), 2);
  tmpResult(context(15449).getPreviousRegistrationTransitionStep(AuthStates.REGISTER_ACCOUNT_INFORMATION));
  ...
  obj3 = { style: tmp4.container, children: callback3(tmp5(15476).RegisterUsernameInput, { username, setUsername, onSubmitEditing: callback, usernameStatus, submitBehavior: "submit", autoFocus: true }) };
  ...
  obj5[5] = str;
  obj4.children = callback3(context(15477).RegisterPasswordInput, obj5);
  items4[1] = callback3(_modDef4185.View, obj4);
  ...
  const items5 = [callback3(context(4880).Button, obj7), ];
  ...
  if (null != tmp11.message) {
    ...
    if ("" !== tmp11.message) {
      ...
      tmp27Result = tmp27(tmp(7647), obj8);
    }
  }
  items5[1] = tmp27Result;
  obj6.children = items5;
  items4[2] = closure_18(_modDef4185.View, obj6);
  obj2[2] = items4;
  ...
  if (!tmp3) {
    ...
    obj9[0] = tmp4.page;
    obj9[1] = tmp27Result;
    tmp27Result1 = tmp27(tmp(6001), obj9);
  }
  return tmp27Result1;
};
