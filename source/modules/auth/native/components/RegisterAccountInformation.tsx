...
// Dependencies: [5, 32, 19, 17, 5829, 4288, 9076, 15092, 15093, 676, 21, 4303, 712, 4042, 8478, 15090, 589, 15115, 15117, 15100, 1236, 15108, 15091, 15107, 8505, 15118, 15119, 4714, 8475, 5824, 2]
// Exports: default

// Module 15114 (RegisterAccountInformation)
...
export default function RegisterAccountInformation() {
  ...
  const tmp3 = importDefault(8478)();
  const tmp4 = callback4(tmp3);
  let obj = React;
  context = React.useContext(context(15090).TrackRegistrationContext);
  ...
  let tmpResult = tmp(15108);
  const tmp9 = callback(React.useState(false), 2);
  tmpResult(context(15091).getPreviousRegistrationTransitionStep(AuthStates.REGISTER_ACCOUNT_INFORMATION));
  importDefault(15107)(AuthStates.REGISTER_ACCOUNT_INFORMATION);
  ...
  obj3 = { style: tmp4.container, children: callback3(tmp5(15118).RegisterUsernameInput, { username, setUsername, onSubmitEditing: callback, usernameStatus, submitBehavior: "submit", autoFocus: true }) };
  ...
  obj5[5] = str;
  obj4.children = callback3(context(15119).RegisterPasswordInput, obj5);
  items4[1] = callback3(importDefault(4042).View, obj4);
  ...
  const items5 = [callback3(context(4714).Button, obj7), ];
  ...
  if (null != tmp11.message) {
    ...
    if ("" !== tmp11.message) {
      ...
      tmp27Result = tmp27(tmp(8475), obj8);
    }
  }
  items5[1] = tmp27Result;
  obj6.children = items5;
  items4[2] = closure_18(importDefault(4042).View, obj6);
  obj2[2] = items4;
  ...
  if (!tmp3) {
    ...
    obj9[0] = tmp4.page;
    obj9[1] = tmp27Result;
    tmp27Result1 = tmp27(tmp(5824), obj9);
  }
  return tmp27Result1;
};
