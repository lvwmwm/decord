...
// Dependencies: [5, 32, 19, 17, 5709, 4240, 8662, 14944, 14945, 676, 21, 4255, 712, 4116, 9375, 14942, 589, 14967, 14969, 14952, 1236, 14960, 14943, 14959, 9397, 14970, 14971, 4666, 9185, 5704, 2]
// Exports: default

// Module 14966 (RegisterAccountInformation)
...
export default function RegisterAccountInformation() {
  ...
  let obj = React;
  context = React.useContext(context(14942).TrackRegistrationContext);
  ...
  let tmpResult = tmp(14960);
  const tmp9 = callback(React.useState(false), 2);
  tmpResult(context(14943).getPreviousRegistrationTransitionStep(AuthStates.REGISTER_ACCOUNT_INFORMATION));
  importDefault(14959)(AuthStates.REGISTER_ACCOUNT_INFORMATION);
  ...
  obj3 = { style: tmp4.container, children: callback3(tmp5(14970).RegisterUsernameInput, { username, setUsername, onSubmitEditing: callback, usernameStatus, submitBehavior: "submit", autoFocus: true }) };
  ...
  obj5[5] = str;
  obj4.children = callback3(context(14971).RegisterPasswordInput, obj5);
  items4[1] = callback3(importDefault(4116).View, obj4);
  ...
  const items5 = [callback3(context(4666).Button, obj7), ];
  ...
  if (null != tmp11.message) {
    ...
    if ("" !== tmp11.message) {
      ...
      tmp27Result = tmp27(tmp(9185), obj8);
    }
  }
  items5[1] = tmp27Result;
  obj6.children = items5;
  items4[2] = closure_18(importDefault(4116).View, obj6);
  obj2[2] = items4;
  ...
  if (!tmp3) {
    ...
    obj9[0] = tmp4.page;
    obj9[1] = tmp27Result;
    tmp27Result1 = tmp27(tmp(5704), obj9);
  }
  return tmp27Result1;
};
