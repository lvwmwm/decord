...
// Dependencies: [29, 57, 31, 14834, 33, 4165, 4026, 13769, 4576, 6709, 689, 4161, 1212, 14852, 6706, 477, 2]
// Exports: RegisterUsernameInput

// Module 14860 (UsernameStatusMessage)
...
import { FadeIn } from "module_4026";
import { FadeOut } from "module_4026";
...
function UsernameStatusMessage(arg0) {
  ...
  if (type === require(13769) /* NameValidationState */.NameValidationState.ERROR) {
    let obj = { direction: "horizontal", spacing: 4, align: "flex-start" };
    obj = { size: "xs", color: importDefault(689).colors.TEXT_FEEDBACK_CRITICAL };
    const items = [callback3(require(6709) /* CircleErrorIcon */.CircleErrorIcon, obj), ];
    ...
    items[1] = callback3(require(4161) /* Text */.Text, obj1);
    obj.children = items;
    let tmp6 = callback4(require(4576) /* Stack */.Stack, obj);
  } else {
    if (isUsernameFocused) {
      ...
      if (type1 === require(13769) /* NameValidationState */.NameValidationState.AVAILABLE) {
        const obj2 = {};
        ...
        obj2["children"] = callback3(require(4161) /* Text */.Text, obj3);
        tmp6 = callback3(require(4161) /* Text */.Text, obj2);
      }
    }
    tmp6 = null;
    if (isUsernameFocused) {
      ...
      tmp6 = callback3(require(4161) /* Text */.Text, obj);
    }
  }
  return tmp6;
}
...
export const RegisterUsernameInput = function RegisterUsernameInput(setUsername) {
  ...
  const tmp2 = importDefault(14852);
  ...
  let str2;
  if (type === setUsername(13769).NameValidationState.ERROR) {
    str2 = "error";
  }
  obj.status = str2;
  obj.submitBehavior = submitBehavior;
  const items3 = [tmp13(setUsername(6706).TextInput, obj), callback3(UsernameStatusMessage, { usernameStatus, isUsernameFocused: tmp5[0] })];
  obj.children = items3;
