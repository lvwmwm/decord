...
import { FadeIn } from "module_3992";
import { FadeOut } from "module_3992";
...
function UsernameStatusMessage(arg0) {
  ...
  if (type === require(13725) /* NameValidationState */.NameValidationState.ERROR) {
    ...
    obj.children = items;
    let tmp6 = callback4(require(4542) /* Stack */.Stack, obj);
  } else {
    if (isUsernameFocused) {
      ...
      if (type1 === require(13725) /* NameValidationState */.NameValidationState.AVAILABLE) {
        ...
        obj2["children"] = callback3(require(4127) /* Text */.Text, obj3);
        tmp6 = callback3(require(4127) /* Text */.Text, obj2);
      }
    }
    tmp6 = null;
    if (isUsernameFocused) {
      ...
      tmp6 = callback3(require(4127) /* Text */.Text, obj);
    }
  }
  return tmp6;
}
...
export const RegisterUsernameInput = function RegisterUsernameInput(setUsername) {
  ...
  const items3 = [tmp13(setUsername(6670).TextInput, obj), callback3(UsernameStatusMessage, { usernameStatus, isUsernameFocused: tmp5[0] })];
  obj.children = items3;
