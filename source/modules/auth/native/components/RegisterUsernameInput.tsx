...
// Dependencies: [109, 32, 19, 15011, 21, 4302, 4162, 13934, 4710, 7733, 712, 4298, 1236, 15029, 7730, 500, 2]
// Exports: RegisterUsernameInput

// Module 15037 (UsernameStatusMessage)
...
function UsernameStatusMessage(arg0) {
  ...
  if (type === require(13934) /* NameValidationState */.NameValidationState.ERROR) {
...
export const RegisterUsernameInput = function RegisterUsernameInput(setUsername) {
  ...
  const tmp3 = importDefault(15029);
