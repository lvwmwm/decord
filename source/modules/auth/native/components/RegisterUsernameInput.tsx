...
// Dependencies: [109, 32, 19, 14995, 21, 4285, 4145, 13920, 4693, 7716, 712, 4281, 1236, 15013, 7713, 500, 2]
// Exports: RegisterUsernameInput

// Module 15021 (UsernameStatusMessage)
...
function UsernameStatusMessage(arg0) {
  ...
  if (type === require(13920) /* NameValidationState */.NameValidationState.ERROR) {
...
export const RegisterUsernameInput = function RegisterUsernameInput(setUsername) {
  ...
  const tmp3 = importDefault(15013);
