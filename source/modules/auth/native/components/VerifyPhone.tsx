...
// Function ID: 15531
// Name: VerifyPhone
// Dependencies: [5, 32, 19, 15502, 15503, 676, 21, 15499, 15518, 4913, 7739, 1236, 7770, 15531, 7771, 2]
// Exports: default

// Module 15530 (VerifyPhone)
...
export default function VerifyPhone(phone) {
  ...
  context = React.useContext(_require(15499).TrackRegistrationContext);
  const tmp4 = callback(React.useState(false), 2);
  onPhoneTokenReceived(15518)(callback2(sourceState));
  const items = [context];
  ...
  onPhoneTokenReceived(7770)(callback1);
  const items3 = [onBail];
  ...
  const tmp7 = onPhoneTokenReceived(15518);
  obj[4] = _require(7771).CodeType.NUMERIC;
  obj[5] = memo;
  obj[6] = tmp5;
  obj[7] = tmp[0];
  return jsx(onPhoneTokenReceived(7771), { title, description, error: tmp3, onCodeEntered: callback, codeType: null, footer: null, disabled: null, loading: null, disableKeyboardAvoidingView: true });
};
