...
// Dependencies: [5, 32, 19, 17, 14860, 14861, 21, 4189, 4606, 9193, 1480, 14870, 691, 14858, 14875, 14876, 14859, 4616, 9211, 9215, 14877, 4600, 1236, 8999, 5638, 14879, 14880, 8224, 8755, 2]
// Exports: RegisterIdentity

// Module 14869 (RegisterIdentityBase)
...
function RegisterIdentityBase(inputMode) {
  ...
  const tmp4 = setInputMode(9193)();
  [tmp8, c8] = loginEmail(identityErrorMessage.useState(false), 2);
  closure_9 = identityErrorMessage.useContext(inputMode(14858).TrackRegistrationContext);
  ...
  setInputMode(14875)(inputMode(691).AuthStates.REGISTER_IDENTITY);
  const tmp10 = setInputMode(14875);
  let obj3 = inputMode(14859);
  setInputMode(14876)(obj3.getPreviousRegistrationTransitionStep(inputMode(691).AuthStates.REGISTER_IDENTITY));
  setInputMode(4616)(() => {
  ...
  const tmp12 = setInputMode(14876);
  items1[1] = callback3(inputMode(14877).RegisterPhoneOrEmailInput, { loginPhone, loginEmail, setLoginPhone: updateLoginPhone, setLoginEmail, inputMode, onSubmit: handleSubmit, inputError: identityError, autoFocus: true });
  ...
  obj1[1] = callback3(inputMode(4600).Button, obj2);
  ...
  if (null != memo) {
    ...
    if ("" !== memo) {
      ...
      obj3[0] = tmp2.errors;
      obj3[1] = memo;
      tmp15Result = tmp15(tmp3(8999), obj3);
    }
  }
  items1[3] = tmp15Result;
  obj[3] = items1;
  obj[2] = closure_15(c7, obj);
  tmp15Result = tmp15(setInputMode(9215), obj);
  let tmp15Result1 = tmp15Result;
  if (!tmp4) {
    let obj4 = { style: null, children: null };
    obj4[0] = tmp2.page;
    obj4[1] = tmp15Result;
    tmp15Result1 = tmp15(tmp3(5638), obj4);
  }
  return tmp15Result1;
}
...
export const RegisterIdentity = function RegisterIdentity() {
  let obj = hasItem(4606);
  let obj1 = hasItem(14879);
  const deviceCountry = obj1.getDeviceCountry();
  hasItem = null != deviceCountry;
  if (hasItem) {
    const EMAIL_FIRST_COUNTRIES = tmp(14880).EMAIL_FIRST_COUNTRIES;
  ...
  const segmentedControlState = hasItem(8224).useSegmentedControlState(obj);
  ...
  obj1 = { style: tmp3.segmentedControl, children: callback3(tmp(8755).SegmentedControl, { state: segmentedControlState, keyboardShouldPersistTaps: "handled" }) };
