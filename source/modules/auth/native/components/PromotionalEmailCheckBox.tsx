...
// Dependencies: [19, 17, 5889, 21, 4342, 4073, 1236, 8035, 4338, 2]
// Exports: default

// Module 15202 (PromotionalEmailCheckBox)
import "noop";
...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    obj1[0] = tmp3;
    const items = [callback2(tmp4(8035).FormCheckbox, obj1), ];
    ...
    items[1] = callback2(tmp4(4338).Text, obj2);
    obj[5] = items;
