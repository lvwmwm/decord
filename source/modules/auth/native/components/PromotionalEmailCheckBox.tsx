...
// Dependencies: [19, 17, 5722, 21, 4255, 3973, 1236, 7751, 4251, 2]
// Exports: default

// Module 14996 (PromotionalEmailCheckBox)
import "noop";
...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    obj1[0] = tmp3;
    const items = [callback2(tmp4(7751).FormCheckbox, obj1), ];
    ...
    items[1] = callback2(tmp4(4251).Text, obj2);
    obj[5] = items;
