...
// Dependencies: [19, 17, 6018, 21, 4446, 4174, 1236, 7631, 4442, 2]
// Exports: default

// Module 15507 (PromotionalEmailCheckBox)
...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    obj1 = { checked: null };
    obj1[0] = tmp3;
    const items = [callback2(tmp4(7631).FormCheckbox, obj1), ];
    ...
    items[1] = callback2(tmp4(4442).Text, obj2);
    obj[5] = items;
