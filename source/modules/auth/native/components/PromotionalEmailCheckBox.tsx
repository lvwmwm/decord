...
// Dependencies: [19, 17, 5749, 21, 4285, 4002, 1236, 7892, 4281, 2]
// Exports: default

// Module 15034 (PromotionalEmailCheckBox)
import "noop";
...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    obj1[0] = tmp3;
    const items = [callback2(tmp4(7892).FormCheckbox, obj1), ];
