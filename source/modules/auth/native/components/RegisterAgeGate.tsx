...
obj = { inputGroup: { visible: false, transparent: false }, flexGrow: { flexGrow: 1 }, button: { GameMention: false, onboarding_responses: false, GIFT_CODE_REDEEM: false, addMount: false } };
