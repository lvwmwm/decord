...
// Function ID: 113060
// Name: statesAreEqual
// Dependencies: [31, 1194, 33, 22, 1456, 9125, 566, 5588, 14696, 478, 689, 2]
// Exports: default

// Module 14819 (statesAreEqual)
...
export default function ConnectedMFA() {
  ...
  if (!inContainer) {
    ...
    return jsx(isMultiAccount(14696).MFAModal, obj);
  } else {
    obj1 = {};
