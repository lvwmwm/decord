...
// Function ID: 6913
// Name: AuthFormView
// Dependencies: [19, 17, 21, 4481, 709, 6884, 6913, 6914, 6915, 6918, 2]
// Exports: default

// Module 6912 (AuthFormView)
...
export default function AuthFormView(arg0) {
  ...
  _require = React.useContext(_require(6913).WideAuthScrollContext);
  if (tmp3) {
    ...
    const items3 = [callback(tmp(6915), obj2), callback(tmp(6918), {}), ];
