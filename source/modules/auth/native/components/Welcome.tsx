...
// Function ID: 112824
// Name: InviteCard
// Dependencies: [31, 27, 14793, 4045, 5687, 11446, 1858, 4116, 8291, 653, 5688, 5969, 33, 4131, 689, 11689, 1212, 44, 1273, 3970, 4127, 12298, 6504, 12933, 1456, 1557, 566, 4560, 5703, 675, 587, 5588, 5450, 14794, 14789, 4966, 4544, 3843, 5084, 9986, 2]
// Exports: default

// Module 14792 (InviteCard)
...
function InviteCard(invite) {
  ...
  if (invite.state !== constants.RESOLVED) {
    ...
    if (null != guild) {
      let obj = { guild };
      let tmp14 = callback(importDefault(11689), obj);
...
function GuildTemplateCard(arg0) {
  ...
  obj = { source: importDefault(12298) };
...
function Centerpiece(inlineButtons) {
  ...
  obj = { style: tmp2.logo, source: require(12933) /* registerAsset */ };
  const items1 = [callback(closure_5, obj), , ];
  const obj1 = {};
