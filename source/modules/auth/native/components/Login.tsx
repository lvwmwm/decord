...
let closure_12 = arg1(dependencyMap[8]).createStyles((arg0) => {
  let obj = { password: { marginTop: 24 }, button: { 0: true, 1777606122355621: true }, hint: { marginTop: 4 }, link: {}, separator: { color: "5f3HIC", backgroundColor: "mi" } };
  obj = { marginTop: 32 };
  let num = 0;
  if (arg0) {
    num = 12;
...
export default function Login(isMultiAccount) {
  ...
  const obj3 = {
    y: null,
    SetNumberFormatUnitOptions: false,
    y: "box-none",
