...
// Dependencies: [19, 17, 5737, 14977, 676, 21, 4285, 4281, 1236, 4003, 7779, 7777, 15016, 2]
// Exports: default

// Module 15015 (PrivacyPolicyDescription)
import "noop";
...
function PrivacyPolicyCheckbox(onToggleConsent) {
  ...
  if (asCheckbox) {
    obj = { checked: null };
    obj[0] = consent;
    let tmp7Result = tmp7(tmp2(7779).FormCheckbox, obj);
    let tmp9 = tmp7;
  } else {
    const obj1 = { selected: null };
    obj1[0] = consent;
    tmp7Result = tmp7(tmp2(7777).FormRow.Radio, obj1);
    tmp9 = tmp7;
  }
