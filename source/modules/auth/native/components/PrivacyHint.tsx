...
// Dependencies: [19, 17, 6005, 15450, 676, 21, 4445, 4441, 1236, 4173, 7617, 8295, 15489, 2]
// Exports: default

// Module 15488 (PrivacyPolicyDescription)
import noopAll from "noop" /* 19 */;
import getSystemLocale from "getSystemLocale" /* 1236 */;
import useCheckboxA11yNative from "useCheckboxA11yNative" /* 4173 */;
import Text from "Text" /* 4441 */;
import PromotionalEmailCheckBoxDefault from "PromotionalEmailCheckBox" /* 15489 */;
...
function PrivacyPolicyCheckbox(onToggleConsent) {
  ...
  if (asCheckbox) {
    obj = { checked: null };
    obj[0] = consent;
    let tmp7Result = tmp7(tmp2(7617).FormCheckbox, obj);
    let tmp9 = tmp7;
  } else {
    obj1 = { selected: null };
    obj1[0] = consent;
    tmp7Result = tmp7(tmp2(8295).FormRow.Radio, obj1);
    tmp9 = tmp7;
  }
