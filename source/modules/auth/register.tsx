...
// Function ID: 14889
// Name: _scorePassword
// Dependencies: [5, 14889, 1218, 676, 1221, 3775, 698, 5003, 503, 4093, 9481, 709, 14890, 14891, 2]
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (callback instanceof phone(9481).CaptchaCancelError) {
              throw callback;
            } else {
              const tmp23 = new callback(4093)(callback);
              throw tmp23;
            }
          } else if (arg0 === 1) {
            c6 = 3;
...
function registerFull(giftCodeSKUId) {
  ...
  if (null != birthday) {
    tmp4(14890)(birthday, constants2.REGISTER);
    ...
    const diffResult = tmp4(3775)().diff(birthday, "years");
    if (diffResult >= 13) {
      if (diffResult < 13) {
        let str3 = "23+";
        if (diffResult >= 18) {
  ...
  obj3[1] = obj4;
  obj1[2] = obj3;
  const tmp4Result1 = importDefault(5003);
  return importDefault(5003).post(obj1).then((body) => {
    ...
    if (arg0 instanceof callback(9481).CaptchaCancelError) {
      throw arg0;
    } else {
      let obj = new callback2(4093)(arg0);
      if (null != obj.getFieldErrors("date_of_birth")) {
        const result = callback3(14891).preventUnderageRegistration(constants3.REGISTER);
        const obj2 = callback3(14891);
      }
