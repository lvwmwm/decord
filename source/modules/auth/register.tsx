...
// Function ID: 14956
// Name: _scorePassword
// Dependencies: [5, 14956, 1218, 676, 1221, 3837, 698, 5065, 503, 4155, 9628, 709, 14957, 14958, 2]
// Exports: default, registerPhone, scorePassword

// Module 14955 (_scorePassword)
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (callback instanceof phone(9628).CaptchaCancelError) {
              throw callback;
            } else {
...
function registerFull(giftCodeSKUId) {
  ...
  if (null != birthday) {
    tmp4(14957)(birthday, constants2.REGISTER);
  ...
  obj3[1] = obj4;
  obj1[2] = obj3;
  const tmp4Result1 = importDefault(5065);
  return importDefault(5065).post(obj1).then((body) => {
    ...
    if (arg0 instanceof callback(9628).CaptchaCancelError) {
      throw arg0;
    } else {
      let obj = new callback2(4155)(arg0);
      if (null != obj.getFieldErrors("date_of_birth")) {
        const result = callback3(14958).preventUnderageRegistration(constants3.REGISTER);
        const obj2 = callback3(14958);
      }
