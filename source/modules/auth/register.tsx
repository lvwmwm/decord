...
// Function ID: 15796
// Name: _scorePassword
// Dependencies: [5, 15796, 1215, 673, 1218, 4074, 695, 4714, 500, 4377, 11138, 706, 15797, 15798, 2]
// Exports: default, registerPhone, scorePassword

// Module 15795 (_scorePassword)
import encodeProperties from "encodeProperties" /* 500 */;
import dispatcherDefault from "dispatcher" /* 706 */;
import _modDef4714 from "module_4714" /* 4714 */;
import closure_4 from "asyncGeneratorStep" /* 5 */;
import initialize from "initialize" /* 15796 */;
...
function registerFull(giftCodeSKUId) {
  ...
  return _modDef4714.post(obj1).then((body) => {
