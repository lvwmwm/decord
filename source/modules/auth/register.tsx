...
// Function ID: 15170
// Name: _scorePassword
// Dependencies: [5, 15170, 1218, 676, 1221, 3943, 698, 5168, 503, 4242, 10423, 709, 15171, 15172, 2]
// Exports: default, registerPhone, scorePassword

// Module 15169 (_scorePassword)
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (callback instanceof phone(10423).CaptchaCancelError) {
              throw callback;
            } else {
...
function registerFull(giftCodeSKUId) {
  ...
  obj3[1] = obj4;
  obj1[2] = obj3;
  const tmp4Result1 = importDefault(5168);
  return importDefault(5168).post(obj1).then((body) => {
    ...
    if (arg0 instanceof callback(10423).CaptchaCancelError) {
      throw arg0;
    } else {
