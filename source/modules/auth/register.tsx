...
// Function ID: 15161
// Name: _scorePassword
// Dependencies: [5, 15161, 1218, 676, 1221, 3943, 698, 5167, 503, 4244, 10509, 709, 15162, 15163, 2]
// Exports: default, registerPhone, scorePassword

// Module 15160 (_scorePassword)
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (callback instanceof phone(10509).CaptchaCancelError) {
              throw callback;
            } else {
              const tmp23 = new callback(4244)(callback);
              throw tmp23;
            }
          } else if (arg0 === 1) {
            c6 = 3;
...
function registerFull(giftCodeSKUId) {
  ...
  obj3[1] = obj4;
  obj1[2] = obj3;
  const tmp4Result1 = importDefault(5167);
  return importDefault(5167).post(obj1).then((body) => {
    ...
    if (arg0 instanceof callback(10509).CaptchaCancelError) {
      throw arg0;
    } else {
      let obj = new callback2(4244)(arg0);
