...
// Function ID: 15175
// Name: _scorePassword
// Dependencies: [5, 15175, 1218, 676, 1221, 3943, 698, 4562, 503, 4242, 10439, 709, 15176, 15177, 2]
// Exports: default, registerPhone, scorePassword

// Module 15174 (_scorePassword)
...
function registerFull(giftCodeSKUId) {
  ...
  obj3[1] = obj4;
  obj1[2] = obj3;
  const tmp4Result1 = importDefault(4562);
  return importDefault(4562).post(obj1).then((body) => {
