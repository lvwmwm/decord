...
// Dependencies: [11886, 7031, 7027, 4935, 3892, 676, 3928, 1384, 15670, 11887, 2]
// Exports: default

// Module 15669 (getTrackFriendsListViewedData)
...
export default function getTrackFriendsListViewedData() {
  ...
  const merged = Object.assign(importDefault(15670)());
  ...
  obj.contact_sync_is_enabled = require(11887) /* _uploadContacts */.isContactSyncEnabled(localAccount);
