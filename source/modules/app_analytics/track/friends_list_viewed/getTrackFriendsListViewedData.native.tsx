...
// Dependencies: [11967, 7063, 7059, 4996, 3938, 676, 3974, 1384, 15745, 11968, 2]
// Exports: default

// Module 15744 (getTrackFriendsListViewedData)
...
export default function getTrackFriendsListViewedData() {
  ...
  const merged = Object.assign(importDefault(15745)());
  ...
  obj.contact_sync_is_enabled = require(11968) /* _uploadContacts */.isContactSyncEnabled(localAccount);
