...
// Dependencies: [1376, 1218, 1372, 1961, 4223, 1971, 1964, 1891, 4349, 3929, 4388, 4373, 4314, 3938, 1960, 4118, 4497, 1903, 4318, 676, 1379, 3934, 506, 4499, 698, 687, 4500, 4502, 12, 2]
...
// Module 4496 (collectGuildAnalyticsMetadata)
...
export const collectVoiceAnalyticsMetadata = function collectVoiceAnalyticsMetadata(id) {
  if (null == id) {
    ...
    if (null == channel) {
      ...
      const merged1 = Object.assign(id(4499).getVoiceAnalyticsMetadataAdditional());
      return obj;
    }
  }
};
  ...
  if (isStaticChannelRoute(selectedChannelId)) {
    ...
    if (null == channel) {
      ...
      if (null == guild) {
        ...
        obj3[7] = require(4500) /* Presets */.presetFromSettings(unreadSetting, updateUserGuildSettingsInternal.resolvedMessageNotifications(channel));
        ...
        const obj7 = require(4500) /* Presets */;
        const guildUnreadSetting = updateUserGuildSettingsInternal.resolveGuildUnreadSetting(guild);
        obj3[13] = require(4500) /* Presets */.presetFromSettings(guildUnreadSetting, updateUserGuildSettingsInternal.getMessageNotifications(channel.guild_id));
        ({ parent_id: obj6[14], parentChannelThreadType: obj6[15] } = channel);
        const obj8 = require(4500) /* Presets */;
        obj3[16] = require(4502) /* hasPendingMemberAction */.hasPendingMemberAction(channel.guild_id, selectedChannelId);
