...
// Dependencies: [1376, 1218, 1372, 1932, 4206, 1942, 1935, 1862, 4332, 3913, 4371, 4356, 4297, 3922, 1931, 4102, 4480, 1874, 4301, 676, 1379, 3918, 506, 4482, 698, 687, 4483, 4485, 12, 2]
...
// Module 4479 (collectGuildAnalyticsMetadata)
...
export const collectVoiceAnalyticsMetadata = function collectVoiceAnalyticsMetadata(id) {
  if (null == id) {
    ...
    if (null == channel) {
      ...
      const merged1 = Object.assign(id(4482).getVoiceAnalyticsMetadataAdditional());
      return obj;
    }
  }
};
