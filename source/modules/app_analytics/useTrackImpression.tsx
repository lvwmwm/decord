...
function trackImpression(type, arg1, arg2) {
  ...
  const merged1 = Object.assign(require(4384) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(channel.getChannel(channel_id)));
  ...
  obj(4616)(() => {
    if (obj.trackOnInitialLoad) {
      ...
      if (!tmp6) {
        ...
        obj.sequenceId = tmp2(4396)("impression_");
