...
// Dependencies: [19, 1372, 1960, 4118, 699, 503, 698, 709, 4496, 659, 4508, 4728, 2]
// Exports: default

// Module 9284 (trackImpression)
...
function trackImpression(type, arg1, arg2) {
  ...
  const merged1 = Object.assign(require(4496) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(channel.getChannel(channel_id)));
  ...
  obj(4728)(() => {
    if (obj.trackOnInitialLoad) {
      ...
      if (!tmp6) {
        ...
        obj.sequenceId = tmp2(4508)("impression_");
