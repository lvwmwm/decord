...
// Dependencies: [5, 1946, 12845, 8917, 676, 1236, 1351, 5850, 698, 16768, 514, 2]
...
export const handleTabPressPrefetch = function handleTabPressPrefetch() {
  ...
  if (!isInitialFetchComplete) {
    if (!isFetching) {
      const featuredGuilds = importDefault(16768).fetchFeaturedGuilds();
      const obj = importDefault(16768);
    }
  }
  if (isInitialFetchComplete) {
  ...
  if (isInitialFetchComplete) {
    const featuredGuilds1 = importDefault(16768).fetchFeaturedGuilds({ forceRefresh: true });
    const obj2 = importDefault(16768);
  }
};
