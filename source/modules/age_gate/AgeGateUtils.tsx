...
// Dependencies: [1415, 1372, 4499, 1891, 1903, 1221, 676, 1236, 11, 4500, 3963, 5123, 589, 7722, 1974, 5747, 5865, 2]
...
// Module 4498 (shouldShowAgeGateForVoiceChannel)
...
function shouldShowAgeGateForVoiceChannel(channelId) {
  ...
  let tmp4 = require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
  if (tmp4) {
...
function isChannelContentGated(channel, arg1) {
  if (null == channel) {
    ...
    const isFeatureAgeGatedResult = require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES);
...
function useIsChannelContentGated(channel) {
  ...
  let isFeatureAgeGated = _require(3963).useIsFeatureAgeGated(_require(5123).AgeGatedFeature.AGE_GATED_SPACES);
  const obj4 = _require(3963);
...
export const shouldAgeVerifyForAgeGate = function shouldAgeVerifyForAgeGate() {
  ...
  return require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
};
export const useShouldAgeVerifyForAgeGate = function useShouldAgeVerifyForAgeGate() {
  let isFeatureAgeGated = require(3963) /* isFeatureAgeGated */.useIsFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES);
  const obj = require(3963) /* isFeatureAgeGated */;
  if (isFeatureAgeGated) {
...
export const useAgeGateVerifyContentForGuild = function useAgeGateVerifyContentForGuild(stateFromStores) {
  ...
  const isFeatureAgeGated = require(3963) /* isFeatureAgeGated */.useIsFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES);
...
export const useAgeGateVerifyContent = function useAgeGateVerifyContent(source) {
  let obj = require(4500) /* useAgeVerificationRunner */;
  const isAgeVerified = obj.useIsAgeVerified();
  let obj1 = require(3963) /* isFeatureAgeGated */;
  const isFeatureAgeGated = obj1.useIsFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES);
...
export const shouldShowAgeGateForCurrentUser = function shouldShowAgeGateForCurrentUser() {
  ...
  if (null == currentUser) {
    ...
    const obj = require(4500) /* useAgeVerificationRunner */;
    const obj2 = require(3963) /* isFeatureAgeGated */;
    const tmp5 = require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
    return true !== currentUser.nsfwAllowed || require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
  }
};
export const shouldShowAgeGateForGuildContentLevel = function shouldShowAgeGateForGuildContentLevel(arg0) {
  ...
  if (null != currentUser) {
    ...
    const obj2 = require(3963) /* isFeatureAgeGated */;
    const tmp5 = require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
    flag = true !== currentUser.nsfwAllowed || require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
    const tmp6 = true !== currentUser.nsfwAllowed || require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
  }
  if (flag) {
    if (null != arg0) {
...
export const maybeOpenAgeGateForVoiceChannel = function maybeOpenAgeGateForVoiceChannel(id) {
  ...
  if (flag) {
    require(5747) /* openAgeGateModal */.openAgeGateModal(AgeGateSource.NSFW_VOICE_CHANNEL);
    flag = true;
    const obj = require(5747) /* openAgeGateModal */;
  }
  return flag;
};
export const maybeShowAgeGate = function maybeShowAgeGate(guildId, channelId, JOIN_LARGE_GUILD_UNDERAGE) {
  ...
  if (flag3) {
    ...
    require(5747) /* openAgeGateModal */.openAgeGateModal(NSFW_SERVER);
    const obj7 = require(5747) /* openAgeGateModal */;
  } else {
    ...
    if (tmp13) {
      ...
      if (null != currentUser2) {
        ...
        const obj5 = require(3963) /* isFeatureAgeGated */;
        const tmp18 = require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result1;
        flag4 = true !== currentUser2.nsfwAllowed || require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result1;
        const tmp19 = true !== currentUser2.nsfwAllowed || require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result1;
      }
      let tmp21 = !flag4;
      if (flag4) {
    ...
    if (tmp13) {
      ...
      require(5747) /* openAgeGateModal */.openAgeGateModal(NSFW_CHANNEL);
      const obj6 = require(5747) /* openAgeGateModal */;
    }
  }
};
...
export const shouldAgeVerifyForSettingsToggles = function shouldAgeVerifyForSettingsToggles() {
  let isFeatureAgeGatedResult = require(3963) /* isFeatureAgeGated */.isFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.COMMANDS_TOGGLE);
  const obj = require(3963) /* isFeatureAgeGated */;
...
export const useShouldAgeVerifyForSettingsToggles = function useShouldAgeVerifyForSettingsToggles() {
  let isFeatureAgeGated = require(3963) /* isFeatureAgeGated */.useIsFeatureAgeGated(require(5123) /* AgeGatedFeature */.AgeGatedFeature.COMMANDS_TOGGLE);
  const obj = require(3963) /* isFeatureAgeGated */;
  if (isFeatureAgeGated) {
    isFeatureAgeGated = obj2.useShouldShowTiggerPawtect();
  }
