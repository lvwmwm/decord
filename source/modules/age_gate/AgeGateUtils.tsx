...
// Dependencies: [1415, 1372, 4516, 1891, 1903, 1221, 676, 1236, 11, 4517, 3980, 5140, 589, 7739, 1974, 5766, 5884, 2]
...
// Module 4515 (shouldShowAgeGateForVoiceChannel)
...
function shouldShowAgeGateForVoiceChannel(channelId) {
  ...
  let tmp4 = require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
  if (tmp4) {
...
function isChannelContentGated(channel, arg1) {
  if (null == channel) {
    ...
    const isFeatureAgeGatedResult = require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES);
    let result = require(4517) /* useAgeVerificationRunner */.shouldShowTiggerPawtect();
    if (didAgreeResult) {
...
function useIsChannelContentGated(channel) {
  ...
  const shouldShowTiggerPawtect = _require(4517).useShouldShowTiggerPawtect();
  const obj = _require(4517);
  ...
  let isFeatureAgeGated = _require(3980).useIsFeatureAgeGated(_require(5140).AgeGatedFeature.AGE_GATED_SPACES);
...
export const shouldAgeVerifyForAgeGate = function shouldAgeVerifyForAgeGate() {
  ...
  return require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
};
export const useShouldAgeVerifyForAgeGate = function useShouldAgeVerifyForAgeGate() {
  let isFeatureAgeGated = require(3980) /* isFeatureAgeGated */.useIsFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES);
  const obj = require(3980) /* isFeatureAgeGated */;
  if (isFeatureAgeGated) {
...
export const useAgeGateVerifyContentForGuild = function useAgeGateVerifyContentForGuild(stateFromStores) {
  ...
  const isFeatureAgeGated = require(3980) /* isFeatureAgeGated */.useIsFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES);
...
export const useAgeGateVerifyContent = function useAgeGateVerifyContent(source) {
  ...
  const isFeatureAgeGated = obj1.useIsFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES);
  let obj2 = require(4517) /* useAgeVerificationRunner */;
  let shouldShowTiggerPawtect = isFeatureAgeGated;
  if (isFeatureAgeGated) {
...
export const shouldShowAgeGateForCurrentUser = function shouldShowAgeGateForCurrentUser() {
  ...
  if (null == currentUser) {
    ...
    const obj = require(4517) /* useAgeVerificationRunner */;
    const obj2 = require(3980) /* isFeatureAgeGated */;
    const tmp5 = require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
    return true !== currentUser.nsfwAllowed || require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
  }
};
export const shouldShowAgeGateForGuildContentLevel = function shouldShowAgeGateForGuildContentLevel(arg0) {
  ...
  if (null != currentUser) {
    ...
    const obj2 = require(3980) /* isFeatureAgeGated */;
    const tmp5 = require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
    flag = true !== currentUser.nsfwAllowed || require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
    const tmp6 = true !== currentUser.nsfwAllowed || require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result;
  }
  if (flag) {
    if (null != arg0) {
...
export const maybeOpenAgeGateForVoiceChannel = function maybeOpenAgeGateForVoiceChannel(id) {
  ...
  if (flag) {
    require(5766) /* openAgeGateModal */.openAgeGateModal(AgeGateSource.NSFW_VOICE_CHANNEL);
    flag = true;
    const obj = require(5766) /* openAgeGateModal */;
  }
  return flag;
};
export const maybeShowAgeGate = function maybeShowAgeGate(guildId, channelId, JOIN_LARGE_GUILD_UNDERAGE) {
  ...
  if (flag3) {
    ...
    require(5766) /* openAgeGateModal */.openAgeGateModal(NSFW_SERVER);
    const obj7 = require(5766) /* openAgeGateModal */;
  } else {
    ...
    if (tmp13) {
      ...
      if (null != currentUser2) {
        const result1 = require(4517) /* useAgeVerificationRunner */.shouldShowTiggerPawtect();
        const obj4 = require(4517) /* useAgeVerificationRunner */;
        const obj5 = require(3980) /* isFeatureAgeGated */;
        const tmp18 = require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result1;
        flag4 = true !== currentUser2.nsfwAllowed || require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result1;
        const tmp19 = true !== currentUser2.nsfwAllowed || require(3980) /* isFeatureAgeGated */.isFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.AGE_GATED_SPACES) && result1;
      }
      let tmp21 = !flag4;
      if (flag4) {
    ...
    if (tmp13) {
      ...
      require(5766) /* openAgeGateModal */.openAgeGateModal(NSFW_CHANNEL);
      const obj6 = require(5766) /* openAgeGateModal */;
    }
  }
};
...
export const useShouldAgeVerifyForSettingsToggles = function useShouldAgeVerifyForSettingsToggles() {
  let isFeatureAgeGated = require(3980) /* isFeatureAgeGated */.useIsFeatureAgeGated(require(5140) /* AgeGatedFeature */.AgeGatedFeature.COMMANDS_TOGGLE);
  const obj = require(3980) /* isFeatureAgeGated */;
  if (isFeatureAgeGated) {
    isFeatureAgeGated = obj2.useShouldShowTiggerPawtect();
  }
