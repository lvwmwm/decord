...
// Dependencies: [5, 1372, 1960, 4118, 1221, 676, 5260, 4515, 4507, 16289, 1988, 691, 2]

// Module 16288 (handlePostConnectionOpen)
...
prototype["handlePostConnectionOpen"] = function handlePostConnectionOpen() {
  ...
  require(4515) /* shouldShowAgeGateForVoiceChannel */.maybeShowAgeGate(guildId, channelId);
};
...
prototype["handleAgeGateModalClose"] = function handleAgeGateModalClose() {
  importDefault(4507).popWithKey(closure_7);
};
prototype["handleGuildUpdate"] = function handleGuildUpdate(guild) {
  ...
  if (tmp2) {
    require(4515) /* shouldShowAgeGateForVoiceChannel */.maybeShowAgeGate(guild.id, null);
    const obj = require(4515) /* shouldShowAgeGateForVoiceChannel */;
  }
};
