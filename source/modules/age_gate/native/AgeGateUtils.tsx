...
// Dependencies: [1862, 3883, 1874, 676, 500, 4460, 8574, 1959, 8128, 2]
// Exports: handleNSFWGuildInvite, isNSFWInvite, shouldNSFWGateGuild

// Module 8573 (GuildNSFWContentLevel)
...
export const handleNSFWGuildInvite = function handleNSFWGuildInvite(invite) {
  ...
  if (obj.isIOS()) {
    ...
    if (!tmp10) {
      ...
      obj = { guildId: null };
      obj[0] = id;
      obj2.pushLazy(tmp(1959)(8574, tmp2.paths), obj);
      flag2 = true;
      const tmp12 = tmp(1959)(8574, tmp2.paths);
    }
    return flag2;
  } else {
    return false;
  ...
  if (obj.isIOS()) {
    ...
    if (null != guild) {
      if (null != currentUser) {
        ...
        if (nsfwAllowed) {
          nsfwAllowed = tmp(8128).getViewNsfwGuildsOrDefault();
