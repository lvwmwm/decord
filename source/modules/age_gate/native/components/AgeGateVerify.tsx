...
// Function ID: 16296
// Name: AgeGateVerify
// Dependencies: [19, 17, 21, 4302, 712, 4515, 4517, 5327, 5967, 4298, 4712, 7737, 7739, 2]
// Exports: default

// Module 16295 (AgeGateVerify)
import "noop";
...
export default function AgeGateVerify(source) {
  ...
  const items = [callback(require(5967) /* AccountAgeTier10LargeBadge */.ShieldSpotIllustration, {}), , , ];
  ...
  if (tmp7Result) {
    ...
    obj3[1] = function onPress() {
      ...
      obj = { entryPoint: callback(7739).AgeVerificationModalEntryPoint.NSFW_AGE_GATE };
      const result = obj.showAgeVerificationGetStartedModal(obj);
    };
    obj2[1] = tmp7(require(4712) /* Button */.Button, obj3);
    tmp7Result = tmp7(View, obj2);
  }
  items[3] = tmp7Result;
  obj[2] = items;
  return closure_5(require(5327) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
};
