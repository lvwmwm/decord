...
// Module 15849 (ExistingUserAgeGateConfirm)
...
let closure_10 = arg1(dependencyMap[6]).createStyles({ container: {}, header: { person_pouting: -0.0014069081515246523, cv: -0.0001058445630777106 }, body: {}, buttonWrapper: { width: "100%" } });
...
export default function ExistingUserAgeGateConfirm(age) {
  ...
  const obj1 = { Promise: 0, marginTop: 1929379840, flags: 0, style: tmp.body };
