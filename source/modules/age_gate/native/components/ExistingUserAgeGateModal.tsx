...
// Function ID: 16519
// Name: onClose
// Dependencies: [19, 4197, 1221, 16519, 676, 21, 500, 4094, 16520, 1236, 5255, 6778, 5260, 698, 503, 6314, 16521, 16523, 16524, 15252, 9347, 5252, 4992, 6312, 2]
// Exports: default
...
const require = arg1;
function onClose() {
  require(5255) /* openAgeGateModal */.closeAgeGateModal();
}
