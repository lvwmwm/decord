...
// Function ID: 16367
// Name: onClose
// Dependencies: [19, 4124, 1221, 16367, 676, 21, 500, 4002, 16368, 1236, 5826, 5232, 4509, 698, 503, 5270, 16369, 16371, 16372, 15121, 8680, 4517, 4519, 5783, 2]
// Exports: default

// Module 16366 (onClose)
...
const require = arg1;
function onClose() {
  require(5826) /* openAgeGateModal */.closeAgeGateModal();
}
