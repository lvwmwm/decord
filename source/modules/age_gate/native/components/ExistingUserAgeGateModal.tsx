...
// Function ID: 16290
// Name: onClose
// Dependencies: [19, 4118, 1221, 16290, 676, 21, 500, 4002, 16291, 1236, 5766, 5231, 4507, 698, 503, 5269, 16292, 16294, 16295, 15051, 8620, 4515, 4517, 5723, 2]
// Exports: default

// Module 16289 (onClose)
...
const require = arg1;
function onClose() {
  require(5766) /* openAgeGateModal */.closeAgeGateModal();
}
