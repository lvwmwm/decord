...
// Function ID: 16224
// Name: onClose
// Dependencies: [19, 4072, 1221, 16224, 676, 21, 500, 3956, 16225, 1236, 5720, 5185, 4460, 698, 503, 5223, 16226, 16228, 16229, 14997, 8574, 4468, 4470, 5650, 2]
// Exports: default

// Module 16223 (onClose)
...
const require = arg1;
function onClose() {
  require(5720) /* openAgeGateModal */.closeAgeGateModal();
}
