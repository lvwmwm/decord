...
// Function ID: 16264
// Name: onClose
// Dependencies: [19, 4101, 1221, 16264, 676, 21, 500, 3985, 16265, 1236, 5747, 5215, 4490, 698, 503, 5253, 16266, 16268, 16269, 15035, 8603, 4498, 4500, 5704, 2]
// Exports: default

// Module 16263 (onClose)
...
const require = arg1;
function onClose() {
  require(5747) /* openAgeGateModal */.closeAgeGateModal();
}
