...
// Function ID: 8621
// Name: NsfwGateGuild
// Dependencies: [19, 17, 1971, 1903, 8621, 676, 21, 4302, 712, 1236, 1974, 698, 8285, 8442, 8622, 4298, 4712, 2]
// Exports: default

// Module 8620 (NsfwGateGuild)
...
export default function NsfwGateGuild(guildId) {
  ...
  const items1 = [callback(currentUser(8442), {}), , , , , ];
  obj = { source: currentUser(8622), style: tmp.image };
  ...
  items1[2] = callback(guildId(4298).Text, obj1);
  items1[3] = callback(guildId(4298).Text, { style: tmp.description, variant: "text-md/normal", color: "text-default", children: stringResult1 });
  ...
  items1[4] = callback(guildId(4298).Text, { style: tmp.description, variant: "text-md/normal", color: "text-default", children: intl3.format(guildId(1236).t.Z12LNW, obj) });
  ...
  items1[5] = callback(guildId(4712).Button, obj4);
  obj[1] = items1;
