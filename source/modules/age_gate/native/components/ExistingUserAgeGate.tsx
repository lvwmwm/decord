...
// Module 15847 (ExistingUserAgeGate)
...
let closure_16 = arg1(dependencyMap[10]).createStyles({ container: { body: "center", type: "row", accessible: 8, mode: 8 }, header: { bounces: null, keyboardShouldPersistTaps: null }, body: {}, inputGroup: { "Bool(false)": false, "Bool(false)": false }, buttonWrapper: { width: "100%" } });
...
export default function ExistingUserAgeGate(onSuccess) {
  ...
  if (source !== NSFW_CHANNEL) {
    if (source !== NSFW_VOICE_CHANNEL) {
      ...
      obj2 = { Promise: 0, marginTop: 1929379840, flags: 0, style: tmp.body, children: stringResult };
