...
// Function ID: 4397
// Name: start
// Dependencies: [4391, 676, 4187, 4377, 2]
...
prototype["start"] = function start() {
  ...
  this._lastLayoutChanged = require(4377) /* sleep */.now();
};
prototype["stop"] = function stop() {
  const _statInterval = this._statInterval;
  _statInterval.stop();
  this._streamEnd = require(4377) /* sleep */.now();
...
prototype["layoutChange"] = function layoutChange(_lastLayout) {
  ...
  if (_lastLayout !== this._lastLayout) {
    if (null == self._streamEnd) {
      const nowResult = require(4377) /* sleep */.now();
