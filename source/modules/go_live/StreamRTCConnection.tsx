...
prototype["initializeEvents"] = function initializeEvents() {
  ...
  this.on(_require(4440).RTCConnectionEvent.State, (state) => {
  ...
  this.on(_require(4440).RTCConnectionEvent.Video, (arg0, arg1, arg2, arg3, arg4) => {
  ...
  this.on(_require(4440).RTCConnectionEvent.VideoSourceQualityChanged, (guildId, channelId, senderUserId, maxResolution, maxFrameRate, context) => {
    let obj = self(709);
    obj = { type: "MEDIA_ENGINE_VIDEO_SOURCE_QUALITY_CHANGED", guildId, channelId, senderUserId, maxResolution, maxFrameRate, context };
    obj.dispatch(obj);
  });
  this.on(_require(4440).RTCConnectionEvent.SecureFramesUpdate, () => {
    self(709).dispatch({ type: "RTC_CONNECTION_SECURE_FRAMES_UPDATE" });
  });
  this.on(_require(4440).RTCConnectionEvent.RosterMapUpdate, (userIds) => {
    let obj = self(709);
...
prototype["reportSoundshareFailure"] = function reportSoundshareFailure(desktopSource, code, failureReason, retry) {
  ...
  if (tmp8) {
    ...
    obj[1] = failureReason;
    obj[2] = retry;
    const merged = Object.assign(importDefault(4520)(desktopSource));
...
prototype["getStreamAnalyticsProperties"] = function getStreamAnalyticsProperties() {
  ...
  let obj = require(4514) /* removeExecutablePathPrefix */;
...
prototype["getExtraConnectionOptions"] = function getExtraConnectionOptions() {
  ...
  obj[0] = require(4408) /* isStreamKey */.decodeStreamKey(this.streamKey).ownerId;
  return obj;
};
