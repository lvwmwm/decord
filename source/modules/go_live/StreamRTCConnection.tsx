...
// Function ID: 4562
// Name: isOwner
// Dependencies: [4503, 4536, 4562, 1218, 1391, 4563, 4497, 4564, 4539, 4565, 676, 4529, 687, 4546, 4566, 4259, 4531, 4567, 12, 709, 4568, 4569, 4642, 698, 4648, 4649, 4548, 4650, 4651, 4526, 5418, 2]
...
prototype["reportSoundshareFailure"] = function reportSoundshareFailure(desktopSource, code, failureReason, retry) {
  ...
  if (tmp8) {
    ...
    obj[1] = failureReason;
    obj[2] = retry;
    const merged = Object.assign(importDefault(4649)(desktopSource));
...
prototype["getStreamAnalyticsProperties"] = function getStreamAnalyticsProperties() {
  ...
  let obj = require(4642) /* removeExecutablePathPrefix */;
...
prototype["getExtraConnectionOptions"] = function getExtraConnectionOptions() {
  ...
  obj[0] = require(4531) /* isStreamKey */.decodeStreamKey(this.streamKey).ownerId;
  return obj;
};
