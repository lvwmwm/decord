...
export const isStreamKey = function isStreamKey(closure_28) {
  let tmp = null != closure_28;
  if (tmp) {
    let startsWithResult = closure_28.startsWith(StreamTypes.GUILD);
    if (!startsWithResult) {
      startsWithResult = closure_28.startsWith(StreamTypes.CALL);
    }
