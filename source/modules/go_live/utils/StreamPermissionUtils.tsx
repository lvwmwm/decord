...
// Dependencies: [4179, 1352, 1908, 1838, 3793, 4181, 653, 4984, 1212, 4347, 4380, 566, 2]
// Exports: getStreamCTAAriaLabel, getStreamCTAString, getStreamEligibleChannels, useCanWatchStream

// Module 5991 (_createForOfIteratorHelperLoose)
...
function canStreamInChannel(channel, closure_2, _isNativeReflectConstruct, arg3) {
  ...
  if (channel.isPrivate()) {
    ...
    if (tmp5) {
      if (flag) {
        flag = !importDefault(4984)(channel, _isNativeReflectConstruct);
      }
      let tmp8 = !flag;
      if (tmp8) {
...
function canWatchStream(basicChannel, closure_21, closure_16, closure_18, closure_12) {
  if (null == basicChannel) {
    ...
    if (isChannelFullResult) {
      obj = require(4347) /* _createForOfIteratorHelperLoose */;
      isChannelFullResult = obj.isChannelFull(basicChannel, closure_21, closure_16);
    }
    let tmp8 = importDefault(4984)(basicChannel, closure_18);
    ...
    if (result) {
      result = require(4380) /* shouldAgeVerifyForAgeGate */.shouldShowAgeGateForChannelId(basicChannel.id);
      const obj3 = require(4380) /* shouldAgeVerifyForAgeGate */;
    }
    if (tmp9) {
