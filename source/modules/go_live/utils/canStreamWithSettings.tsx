...
// Dependencies: [4400, 10888, 10889, 2]
// Exports: default

// Module 10887 (canStreamWithSettings)
...
export default function canStreamWithSettings(arg0, arg1, arg2, arg3, arg4, arg5) {
  if (arg0 === constants.PRESET_AUTO) {
    return require(10888) /* getGoLiveAutoQualityExperimentConfig */.getGoLiveAutoQualityExperimentConfig({ location: "canStreamWithSettings" }).allowAutoQuality;
  } else {
      ...
      if (null == nextResult.preset) {
        ...
        if (arg1 === tmp4.resolution) {
          ...
          if (arg2 === tmp4.fps) {
            ...
            let tmp12 = arg4;
            let tmp13 = arg5;
            if (importDefault(10889)(tmp4, arg3, arg4, arg5)) {
              let tmp14 = iter;
              iter.return();
              let flag = true;
              return true;
