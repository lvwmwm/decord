...
// Dependencies: [4195, 1212, 2]
// Exports: default

// Module 15941 (getStreamIssueReportOptions)
...
export default function getStreamIssueReportOptions(isEndStream) {
  ...
  obj4.label = intl7.string(require(1212) /* getSystemLocale */.t.uEoqQp);
  items[6] = obj4;
  const obj5 = { id: "vibes-off", value: StreamIssueReportReasons.VIBES_OFF };
  const intl8 = require(1212) /* getSystemLocale */.intl;
  obj5.label = intl8.string(require(1212) /* getSystemLocale */.t["++JLL0"]);
  items[7] = obj5;
  const obj6 = { id: "other", value: StreamIssueReportReasons.OTHER };
  const intl9 = require(1212) /* getSystemLocale */.intl;
  obj6.label = intl9.string(require(1212) /* getSystemLocale */.t.emlT91);
  items[8] = obj6;
  return items;
};
