...
// Dependencies: [5, 17, 4364, 1391, 1979, 676, 4370, 3, 4227, 4034, 709, 530, 4523, 4395, 38, 4524, 4538, 4408, 1493, 10797, 10746, 1236, 2]
...
prototype["_initialize"] = function _initialize() {
  ...
  let result = voiceEngine.setBroadcastRequestCallback(() => {
    ...
    if (null != channel) {
      ...
      if (null != currentUserActiveStream) {
        const tmp2Result = callback2(4538);
  ...
  const result1 = voiceEngine.setBroadcastFinishedCallback(() => {
    ...
    closure_14.stop();
    closure_15.stop();
    const result = callback(10797).handleCloseScreenshare();
  });
