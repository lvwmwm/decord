...
// Dependencies: [1975, 1903, 11762, 4174, 676, 709, 11763, 4522, 530, 11765, 4195, 698, 11766, 11764, 2]
...
// Module 11761 (fetchGameServerCatalog)
...
export const optimisticallyMarkGameServerResizing = function optimisticallyMarkGameServerResizing(arg0) {
  ...
  if (null != found) {
    ...
    obj.status = _require(11764).GameServerStatus.STARTING;
    obj[2] = obj;
    obj.dispatch(obj);
  }
};
