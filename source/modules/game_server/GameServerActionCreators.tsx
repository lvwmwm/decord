...
// Dependencies: [1946, 1874, 11728, 4144, 676, 709, 11729, 4492, 530, 11731, 4165, 698, 11732, 11730, 2]
...
// Module 11727 (fetchGameServerCatalog)
...
export const fetchGameServerGlobalCatalog = function fetchGameServerGlobalCatalog() {
  ...
  const obj2 = require(4492) /* _httpGetWithCountryCodeQuery */;
...
export const optimisticallyMarkGameServerResizing = function optimisticallyMarkGameServerResizing(arg0) {
  ...
  if (null != found) {
    ...
    obj.status = _require(11730).GameServerStatus.STARTING;
    obj[2] = obj;
    obj.dispatch(obj);
  }
};
