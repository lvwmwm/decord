...
// Dependencies: [1975, 1903, 11777, 4191, 676, 709, 11778, 4539, 530, 11780, 4212, 698, 11781, 11779, 2]
...
// Module 11776 (fetchGameServerCatalog)
...
export const fetchGameServerGlobalCatalog = function fetchGameServerGlobalCatalog() {
  ...
  const obj2 = require(4539) /* _httpGetWithCountryCodeQuery */;
...
export const optimisticallyMarkGameServerResizing = function optimisticallyMarkGameServerResizing(arg0) {
  ...
  if (null != found) {
    ...
    obj.status = _require(11779).GameServerStatus.STARTING;
    obj[2] = obj;
    obj.dispatch(obj);
  }
};
