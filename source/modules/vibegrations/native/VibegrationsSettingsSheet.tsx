...
// Dependencies: [5, 32, 19, 17, 16087, 16090, 16088, 21, 4445, 712, 5546, 589, 1236, 3469, 9181, 12834, 4412, 7625, 7626, 7616, 7638, 4441, 4880, 5941, 5573, 9683, 2]
// Exports: default

// Module 16109 (VibegrationsSettingsSheet)
...
import closure_11 from "rejectPendingPublish" /* 16090 */;
import closure_12 from "isProjectOwner" /* 16088 */;
...
export default function VibegrationsSettingsSheet(projectId) {
  ...
  let tmp3 = map(notifyAgent(5546)({ includeKeyboardHeight: true }).insets.bottom);
  dependencyMap = tmp3;
  ...
  const segmentedControlState = projectId(9181).useSegmentedControlState({ items: memo3, pageWidth: tmp24, defaultIndex: num, onSetActiveIndex: tmp22 });
  if (tmp19) {
    let tmp28 = 1 === tmp21;
  } else {
  ...
  obj[0] = intl.string(notifyAgent(3469).gTMvzD);
  obj[1] = memo(projectId(5573).BottomSheetTitleHeader, obj);
  ...
  if (null != note) {
    ...
    if ("" !== note) {
      ...
      obj2[2] = note;
      tmp32Result = tmp32(tmp4(4441).Text, obj2);
    }
  }
  ...
  if (0 === found.length) {
    ...
    if (0 === memo2.length) {
      ...
      obj3[2] = intl2.string(tmp(3469).URnN4B);
      tmp32Result = tmp32(tmp4(4441).Text, obj3);
    }
  }
  ...
  if (found1.length > 0) {
    ...
    if (someResult) {
      ...
      obj5[2] = intl4.string(tmp(3469)["Hl+eu7"]);
      tmp32Result1 = tmp32(tmp4(4441).Text, obj5);
    }
    const items8 = [
      tmp32Result1,
    ...
    if (tmp19) {
      ...
      obj6[1] = tmp32(tmp4(9683).SegmentedControl, obj7);
    ...
    if (tmp28) {
      ...
      obj9[2] = intl3.string(tmp(3469)["Hl+eu7"]);
      const items10 = [tmp32(tmp4(4441).Text, obj9), memo2.map(renderSecret)];
      obj8[1] = items10;
  ...
  if (tmp14[0]) {
    ...
    obj11[2] = intl5.string(tmp(3469).n02OEo);
    tmp32Result3 = tmp32(tmp4(4441).Text, obj11);
  }
  ...
  obj12[0] = intl6.string(notifyAgent(3469).Tuz9vw);
  obj12[2] = first2;
  obj12[3] = !(null != memo4.values || null != memo4.secrets);
  obj12[4] = callback1;
  items7[4] = memo(projectId(4880).Button, obj12);
  obj1[1] = items7;
  obj[2] = memo1(first1, obj1);
  return memo(projectId(5941).ActionSheet, obj);
};
