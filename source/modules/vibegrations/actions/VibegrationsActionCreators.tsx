...
// Dependencies: [5, 8745, 15912, 676, 8746, 709, 15915, 8742, 530, 15917, 7178, 2]
// Exports: createProject, deleteProject, refreshPublishedProject, reloadVibegrationsProjectFrames, renameProject, setBuilderPreviewApplicationId, setBuilderPreviewMobile, setChatSidebarWidth, setGuildHints, setProjectVisibility, setSelectedProjectForGuild, trackPublishFailed
