...
// Dependencies: [5, 15208, 2]

// Module 15207 (generateRsaKeyPair)
...
prototype["serializePublicKey"] = function serializePublicKey(c3) {
  return importDefault(15208).getEncodedPublicKey();
};
prototype["publicKeyFingerprint"] = function publicKeyFingerprint(c3) {
  return importDefault(15208).getPublicKeyFingerprint();
};
...
prototype["release"] = function release() {
  importDefault(15208).releaseKeyPair();
};
