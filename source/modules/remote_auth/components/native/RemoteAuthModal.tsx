...
// Function ID: 13090
// Name: RemoteAuthBody
// Dependencies: [32, 19, 17, 676, 21, 4255, 712, 1581, 13090, 13088, 5297, 530, 12, 13091, 4251, 1236, 1297, 5102, 4665, 4460, 13092, 13093, 5717, 2]
// Exports: default

// Module 13089 (RemoteAuthBody)
...
function RemoteAuthLogin(arg0) {
  ...
  obj4[2] = tmp10;
  const items1 = [callback2(require(4665) /* Button */.Button, obj4, "" + tmp10), ];
  ...
  items1[1] = callback2(require(4665) /* Button */.Button, obj5);
  obj3[1] = items1;
  items[3] = callback3(require(5102) /* ButtonGroup */.ButtonGroup, obj3);
  obj[0] = items;
...
function RemoteAuthLoginSucceeded() {
  ...
  obj = { source: importDefault(13092), style: tmp.mainImage };
  const items = [callback2(closure_6, obj), , , ];
  ...
  obj3[1] = importDefault(4460).pop;
  obj2[1] = callback2(require(4665) /* Button */.Button, obj3);
  items[3] = callback2(require(5102) /* ButtonGroup */.ButtonGroup, obj2);
  obj[0] = items;
  return callback3(closure_11, obj);
}
function RemoteAuthNotFound() {
  const tmp = createCacheKey();
  let obj = { children: null };
  obj = { source: importDefault(13093), style: tmp.mainImage };
  const items = [callback2(closure_6, obj), , , ];
  obj = { variant: "heading-xl/extrabold", children: null };
  const intl = require(1236) /* getSystemLocale */.intl;
...
function RemoteAuthLoading() {
  return callback2(closure_7, { style: createCacheKey().loadingContainer, children: callback2(require(5717) /* ActivityIndicator */.ActivityIndicator, {}) });
}
...
export default function RemoteAuth(arg0) {
  ...
  obj[0] = importDefault(13090);
  ({ imageStyle: obj[1], background: obj[2] } = tmp);
  obj = { style: items, source: importDefault(13088) };
