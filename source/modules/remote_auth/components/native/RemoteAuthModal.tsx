...
// Function ID: 13127
// Name: RemoteAuthBody
// Dependencies: [32, 19, 17, 676, 21, 4285, 712, 1609, 13127, 13125, 5351, 530, 12, 13128, 4281, 1236, 1297, 5132, 4695, 4490, 13129, 13130, 5744, 2]
// Exports: default

// Module 13126 (RemoteAuthBody)
...
function RemoteAuthLogin(arg0) {
  ...
  obj3[1] = items1;
  items[3] = callback3(require(5132) /* ButtonGroup */.ButtonGroup, obj3);
  obj[0] = items;
...
function RemoteAuthLoginSucceeded() {
  ...
  obj = { source: importDefault(13129), style: tmp.mainImage };
  const items = [callback2(closure_6, obj), , , ];
  ...
  items[3] = callback2(require(5132) /* ButtonGroup */.ButtonGroup, obj2);
  obj[0] = items;
  return callback3(closure_11, obj);
}
function RemoteAuthNotFound() {
  const tmp = createCacheKey();
  let obj = { children: null };
  obj = { source: importDefault(13130), style: tmp.mainImage };
  const items = [callback2(closure_6, obj), , , ];
  obj = { variant: "heading-xl/extrabold", children: null };
  const intl = require(1236) /* getSystemLocale */.intl;
...
function RemoteAuthLoading() {
  return callback2(closure_7, { style: createCacheKey().loadingContainer, children: callback2(require(5744) /* ActivityIndicator */.ActivityIndicator, {}) });
}
...
export default function RemoteAuth(arg0) {
  ...
  obj[0] = importDefault(13127);
  ({ imageStyle: obj[1], background: obj[2] } = tmp);
  obj = { style: items, source: importDefault(13125) };
