...
// Function ID: 13002
// Name: RemoteAuthBody
// Dependencies: [32, 19, 17, 676, 21, 4189, 712, 1581, 13002, 13000, 5217, 530, 12, 13003, 4185, 1236, 1297, 5022, 4600, 4395, 13004, 13005, 5637, 2]
// Exports: default

// Module 13001 (RemoteAuthBody)
...
function RemoteAuthLogin(arg0) {
  ...
  obj = { children: null };
  obj = { source: tmp7(13003), style: tmp.mainImage };
  ...
  items[1] = callback2(require(4185) /* Text */.Heading, obj1);
  ...
  obj4[2] = tmp10;
  const items1 = [callback2(require(4600) /* Button */.Button, obj4, "" + tmp10), ];
  ...
  items1[1] = callback2(require(4600) /* Button */.Button, obj5);
  obj3[1] = items1;
  items[3] = callback3(require(5022) /* ButtonGroup */.ButtonGroup, obj3);
  obj[0] = items;
...
function RemoteAuthLoginSucceeded() {
  ...
  obj3[1] = importDefault(4395).pop;
  obj2[1] = callback2(require(4600) /* Button */.Button, obj3);
  items[3] = callback2(require(5022) /* ButtonGroup */.ButtonGroup, obj2);
  obj[0] = items;
  return callback3(closure_11, obj);
}
function RemoteAuthNotFound() {
  const tmp = createCacheKey();
  let obj = { children: null };
  obj = { source: importDefault(13005), style: tmp.mainImage };
  const items = [callback2(closure_6, obj), , , ];
  obj = { variant: "heading-xl/extrabold", children: null };
  const intl = require(1236) /* getSystemLocale */.intl;
...
function RemoteAuthLoading() {
  return callback2(closure_7, { style: createCacheKey().loadingContainer, children: callback2(require(5637) /* ActivityIndicator */.ActivityIndicator, {}) });
}
...
export default function RemoteAuth(arg0) {
  ...
  obj[0] = importDefault(13002);
  ({ imageStyle: obj[1], background: obj[2] } = tmp);
  obj = { style: items, source: importDefault(13000) };
  items = [tmp.logo, { marginTop: importDefault(1581)().top }];
