...
// Dependencies: [19, 17, 676, 21, 4344, 15191, 5862, 4340, 1236, 4754, 1297, 4189, 1499, 4576, 698, 15192, 15196, 8544, 2]
...
export const CompanionRemoteAuth = function CompanionRemoteAuth() {
  ...
  let obj1 = React;
  const context = React.useContext(fingerprint(4576));
  ...
  if (navigation(15191).RemoteAuthStep.INITIALIZING !== step) {
    if (tmp2(15191).RemoteAuthStep.PENDING_REMOTE_INIT !== step) {
      if (tmp2(15191).RemoteAuthStep.PENDING_TICKET === step) {
        ...
        items2[1] = tmp11(tmp2(4340).Text, obj3);
        ...
        items2[2] = tmp11(tmp2(4340).Text, obj4);
  ...
  const items3 = [closure_7(navigation(5862).ActivityIndicator, {}), , ];
  ...
  items3[1] = closure_7(navigation(4340).Text, obj9);
  ...
  obj11[3] = callback1;
  obj10[1] = closure_7(navigation(4754).Button, obj11);
