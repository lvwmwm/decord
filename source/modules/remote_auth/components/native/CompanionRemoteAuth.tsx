...
// Dependencies: [19, 17, 676, 21, 4342, 15200, 5863, 4338, 1236, 4755, 1297, 4187, 1499, 4577, 698, 15201, 15205, 8548, 2]
// Exports: CompanionRemoteAuth

// Module 15199 (CompanionRemoteAuth)
...
export const CompanionRemoteAuth = function CompanionRemoteAuth() {
  ...
  fingerprint = null;
  if (state.step === navigation(15200).RemoteAuthStep.PENDING_REMOTE_INIT) {
  ...
  if (navigation(15200).RemoteAuthStep.INITIALIZING !== step) {
    if (tmp2(15200).RemoteAuthStep.PENDING_REMOTE_INIT !== step) {
      if (tmp2(15200).RemoteAuthStep.PENDING_TICKET === step) {
      ...
      } else if (tmp2(15200).RemoteAuthStep.PENDING_LOGIN === step) {
