...
let closure_10 = arg1(dependencyMap[4]).createStyles({ statusContainer: { 2130673151: null, -2097184513: null }, avatar: { marginBottom: 16 }, statusText: { originX: true, originY: true, width: true, height: true }, buttonContainer: {} });
...
export const CompanionRemoteAuth = function CompanionRemoteAuth() {
  ...
  const callback = React.useCallback((arg0) => {
    ...
    obj = { <string:2709124931>: null, <string:3429211421>: -4, <string:4221622371>: 8, <string:3568086098>: 8, source: constants2.QR_CODE };
    let tmp = null;
    if (null != arg0) {
      tmp = arg0;
    }
