...
// Dependencies: [5, 673, 502, 3, 527, 1233, 4846, 4849, 706, 38, 4850, 4851, 4161, 4379, 2]
...
function _confirmEPS() {
  ...
  const tmp = callback((arg0, arg1, arg2, arg3) => {
    ...
    return (function*(arg0, arg1, arg2, arg3) {
      ...
      c4 = tmp2;
      if (null == lib) {
        throw lib(4846).dispatchConfirmationError("Stripe not loaded");
      }
      if (null == tmp62) {
        throw lib(4846).dispatchConfirmationError("Bank required for EPS");
      }
      ({ email: c4, name } = tmp63);
        ...
        try {
          ...
          if (0 === setupIntent) {
            if (arg0 === 1) {
              ...
              throw lib(4846).dispatchConfirmationError("Stripe or token not loaded");
            }
          } else if (1 === tmp7) {
            closure_7 = 0;
            c9 = constants;
            ...
            if (arg0 === 1) {
              ...
              constants = callback2(4851).parseBillingAddressInfoToStripeBillingDetails(callback2);
