...
// Dependencies: [5, 676, 505, 3, 530, 1236, 4575, 4578, 709, 38, 4579, 4580, 3923, 4154, 2]
...
function dispatchPaymentElementsConfirmationError(error, flag, stringResult) {
  ...
  let obj = require(4575) /* _validatePaymentSourceBillingAddress */;
...
export const createPaymentRequestPaymentSource = function createPaymentRequestPaymentSource(billing_details, closure_2, analyticsLocation) {
  ...
  return require(4575) /* _validatePaymentSourceBillingAddress */.createPaymentSource(constants.STRIPE, result.token, billingAddressInfo, obj);
};
