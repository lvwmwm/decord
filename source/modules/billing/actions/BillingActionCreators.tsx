...
// Dependencies: [109, 5, 4011, 4009, 4013, 676, 4018, 505, 709, 530, 4241, 4029, 3943, 4007, 4665, 4667, 4022, 4673, 4674, 698, 2]
...
// Module 4664 (_deletePaymentSource)
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            billingError = new callback(4241).BillingError(dependencyMap);
      ...
      try {
        ...
        if (0 === c4) {
          ...
          if (null == lib.body) {
            ...
            const billingError = new callback(4241).BillingError("response body is null, response: " + JSON.stringify(lib), lib.status);
            throw billingError;
          } else {
            obj = lib(709);
...
function handlePaymentConfirmation(body, paymentSource) {
  if (null != paymentSource) {
    if (set.has(paymentSource.type)) {
      const adyenPaymentConfirmationHandler = new require(4674) /* performRedirect */.AdyenPaymentConfirmationHandler(paymentSource, body);
      let confirmPaymentResult = adyenPaymentConfirmationHandler.confirmPayment();
    }
    return confirmPaymentResult;
  }
  confirmPaymentResult = new require(4674) /* performRedirect */.StripePaymentConfirmationHandler(paymentSource, body).confirmPayment();
}
            ...
            if (0 === c13) {
              if (arg0 === 1) {
                ...
                if (null != throwTypeErrorResult.paymentSource) {
                  ...
                  c14 = 1;
                  const obj2 = { value: null, done: false };
                  obj2[0] = lib(4667).createPaymentSourceToken(throwTypeErrorResult.paymentSource);
                  return obj2;
                }
              ...
              c11 = 0;
              c11 = closure_12;
              if (c11 instanceof lib(4241).BillingError) {
                billingError = c11;
              } else {
                billingError = new lib(4241).BillingError(c11);
              }
              let obj15 = lib2(709);
              ...
              if (billingError.code !== lib(4029).ErrorCodes.CONFIRMATION_REQUIRED) {
                ...
                throw lib(4665).dispatchConfirmationError("payment id cannot be null on redirected confirmations.");
              }
            } else if (2 === tmp8) {
              if (arg0 === 1) {
                c14 = 3;
              ...
              if (3 === tmp8) {
                if (arg0 === 1) {
                  ...
                  throwTypeErrorResult = lib;
                  throwTypeErrorResult = dependencyMap;
                  reset.purchase_token = lib(4673).getPurchaseToken();
                  throwTypeErrorResult = dependencyMap;
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            c4 = 0;
            callback = closure_3;
            if (callback instanceof lib(4241).BillingError) {
              let billingError = callback;
            } else {
              billingError = new lib(4241).BillingError(callback);
            }
            throw billingError;
          } else if (arg0 === 1) {
            c6 = 3;
