...
async function _deletePaymentSource(id, arg1) {
  ...
  obj = { y: 1567300603, isArray: 221342020, accessible: 822948183, url: closure_10.BILLING_PAYMENT_SOURCE(id) };
  yield HTTP.del(obj);
...
async function _fetchPaymentSources() {
  ...
  if (!obj.isPaymentSourceFetching) {
    ...
    let obj = { y: 1567300603, isArray: 221342020, accessible: 822948183, url: constants.BILLING_PAYMENT_SOURCES };
    value = HTTP.get(obj);
...
async function _fetchPaymentSource(id, arg1) {
  const HTTP = callback(closure_2[9]).HTTP;
  const obj = { y: 1567300603, isArray: 221342020, accessible: 822948183, url: closure_10.BILLING_PAYMENT_SOURCE(id) };
...
async function _fetchSubscriptions() {
  ...
  const HTTP = callback(closure_2[9]).HTTP;
  obj = { y: 1567300603, isArray: 221342020, accessible: 822948183, url: constants.BILLING_SUBSCRIPTIONS };
...
async function _voidPendingPayment(arg0, arg1) {
  const HTTP = callback(closure_2[9]).HTTP;
  const obj = { y: 1567300603, isArray: 221342020, accessible: 822948183, url: closure_10.BILLING_PAYMENTS_VOID(arg0) };
  yield HTTP.post(obj);
}
...
function fetchPaymentSourceCreationContext() {
  ...
  const obj = { y: 1567300603, isArray: 221342020, accessible: 822948183, url: closure_10.BILLING_PAYMENT_SOURCE_CREATION_CONTEXT };
  return HTTP.get(obj);
}
