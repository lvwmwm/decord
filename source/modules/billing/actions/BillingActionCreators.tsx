...
// Dependencies: [109, 5, 4143, 4141, 4145, 676, 4150, 505, 709, 530, 4376, 4161, 4075, 4139, 4838, 4840, 4154, 4846, 4847, 698, 2]
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            billingError = new callback(4376).BillingError(dependencyMap);
        ...
        if (tmp7 === 3) {
          ...
          try {
            ...
            if (0 === c13) {
              ...
              c11 = 0;
              c11 = closure_12;
              if (c11 instanceof lib(4376).BillingError) {
                billingError = c11;
              } else {
                billingError = new lib(4376).BillingError(c11);
              }
              let obj15 = lib2(709);
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            c4 = 0;
            callback = closure_3;
            if (callback instanceof lib(4376).BillingError) {
              let billingError = callback;
            } else {
              billingError = new lib(4376).BillingError(callback);
            }
            throw billingError;
          } else if (arg0 === 1) {
            c6 = 3;
