...
// Dependencies: [109, 5, 3951, 3949, 3953, 676, 3958, 505, 709, 530, 4201, 3969, 3883, 3947, 4622, 4624, 3962, 4630, 4631, 698, 2]
...
// Module 4621 (_deletePaymentSource)
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            billingError = new callback(4201).BillingError(dependencyMap);
      ...
      try {
        ...
        if (0 === c4) {
          ...
          if (null == lib.body) {
            ...
            const billingError = new callback(4201).BillingError("response body is null, response: " + JSON.stringify(lib), lib.status);
            throw billingError;
          } else {
            obj = lib(709);
...
function handlePaymentConfirmation(body, paymentSource) {
  if (null != paymentSource) {
    if (set.has(paymentSource.type)) {
      const adyenPaymentConfirmationHandler = new require(4631) /* performRedirect */.AdyenPaymentConfirmationHandler(paymentSource, body);
      let confirmPaymentResult = adyenPaymentConfirmationHandler.confirmPayment();
    }
    return confirmPaymentResult;
  }
  confirmPaymentResult = new require(4631) /* performRedirect */.StripePaymentConfirmationHandler(paymentSource, body).confirmPayment();
}
            ...
            if (0 === c13) {
              if (arg0 === 1) {
                ...
                if (null != throwTypeErrorResult.paymentSource) {
                  ...
                  c14 = 1;
                  const obj2 = { value: null, done: false };
                  obj2[0] = lib(4624).createPaymentSourceToken(throwTypeErrorResult.paymentSource);
                  return obj2;
                }
              ...
              c11 = 0;
              c11 = closure_12;
              if (c11 instanceof lib(4201).BillingError) {
                billingError = c11;
              } else {
                billingError = new lib(4201).BillingError(c11);
              }
              let obj15 = lib2(709);
              ...
              if (billingError.code !== lib(3969).ErrorCodes.CONFIRMATION_REQUIRED) {
                ...
                throw lib(4622).dispatchConfirmationError("payment id cannot be null on redirected confirmations.");
              }
            } else if (2 === tmp8) {
              if (arg0 === 1) {
                c14 = 3;
              ...
              if (3 === tmp8) {
                if (arg0 === 1) {
                  ...
                  throwTypeErrorResult = lib;
                  throwTypeErrorResult = dependencyMap;
                  reset.purchase_token = lib(4630).getPurchaseToken();
                  throwTypeErrorResult = dependencyMap;
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            c4 = 0;
            callback = closure_3;
            if (callback instanceof lib(4201).BillingError) {
              let billingError = callback;
            } else {
              billingError = new lib(4201).BillingError(callback);
            }
            throw billingError;
          } else if (arg0 === 1) {
            c6 = 3;
