...
// Dependencies: [109, 5, 4011, 4009, 4013, 676, 4018, 505, 709, 530, 4243, 4029, 3943, 4007, 4664, 4666, 4022, 4672, 4673, 698, 2]
...
// Module 4663 (_deletePaymentSource)
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            billingError = new callback(4243).BillingError(dependencyMap);
      ...
      try {
        ...
        if (0 === c4) {
          ...
          if (null == lib.body) {
            ...
            const billingError = new callback(4243).BillingError("response body is null, response: " + JSON.stringify(lib), lib.status);
            throw billingError;
          } else {
            obj = lib(709);
...
function handlePaymentConfirmation(body, paymentSource) {
  if (null != paymentSource) {
    if (set.has(paymentSource.type)) {
      const adyenPaymentConfirmationHandler = new require(4673) /* performRedirect */.AdyenPaymentConfirmationHandler(paymentSource, body);
      let confirmPaymentResult = adyenPaymentConfirmationHandler.confirmPayment();
    }
    return confirmPaymentResult;
  }
  confirmPaymentResult = new require(4673) /* performRedirect */.StripePaymentConfirmationHandler(paymentSource, body).confirmPayment();
}
      ...
      if (c14 === 2) {
        ...
        if (tmp7 === 3) {
          ...
          try {
            ...
            if (0 === c13) {
              if (arg0 === 1) {
                ...
                if (null != throwTypeErrorResult.paymentSource) {
                  ...
                  c14 = 1;
                  const obj2 = { value: null, done: false };
                  obj2[0] = lib(4666).createPaymentSourceToken(throwTypeErrorResult.paymentSource);
                  return obj2;
                }
              ...
              c11 = 0;
              c11 = closure_12;
              if (c11 instanceof lib(4243).BillingError) {
                billingError = c11;
              } else {
                billingError = new lib(4243).BillingError(c11);
              }
              let obj15 = lib2(709);
              const obj3 = { type: "BILLING_SUBSCRIPTION_UPDATE_FAIL", error: null };
              obj3[1] = billingError;
              obj15.dispatch(obj3);
              if (billingError.code !== lib(4029).ErrorCodes.CONFIRMATION_REQUIRED) {
                throw billingError;
                ...
                throw lib(4664).dispatchConfirmationError("payment id cannot be null on redirected confirmations.");
              }
            } else if (2 === tmp8) {
              if (arg0 === 1) {
                c14 = 3;
              ...
              if (3 === tmp8) {
                if (arg0 === 1) {
                  ...
                  throwTypeErrorResult = lib;
                  throwTypeErrorResult = dependencyMap;
                  reset.purchase_token = lib(4672).getPurchaseToken();
                  throwTypeErrorResult = dependencyMap;
            ...
            obj16[0] = lib(4022).createGatewayCheckoutContext(lib2.paymentSource);
            return obj16;
          } catch (tmp99) {
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            c4 = 0;
            callback = closure_3;
            if (callback instanceof lib(4243).BillingError) {
              let billingError = callback;
            } else {
              billingError = new lib(4243).BillingError(callback);
            }
            throw billingError;
          } else if (arg0 === 1) {
            c6 = 3;
...
export const deleteRenewalMutation = function deleteRenewalMutation(items) {
  ...
  return updateSubscription(items, obj, obj, require(4007) /* getPremiumPlanItem */.getItemPlansTotalServerPrice(items.items, items.currency, items.paymentSourceId), arg1);
};
...
export const resubscribeToSubscription = function resubscribeToSubscription(currency, outer1_6, id) {
  ...
  return updateSubscription(currency, obj, obj, require(4007) /* getPremiumPlanItem */.getItemPlansTotalServerPrice(items, currency, id), outer1_6, arg4);
};
