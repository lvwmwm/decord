...
// Dependencies: [19, 676, 3930, 2]
// Exports: default

// Module 7573 (useStoreFrontPrice)
  ...
  return React.useMemo(() => {
    if (null == callback) {
      ...
      if (null == tmp3) {
        ...
        const experimentalGetPriceResult = callback(3930).experimentalGetPrice(tmp.id, obj);
