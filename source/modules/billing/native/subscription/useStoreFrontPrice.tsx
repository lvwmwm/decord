...
// Dependencies: [19, 676, 3947, 2]
// Exports: default

// Module 7592 (useStoreFrontPrice)
  ...
  return React.useMemo(() => {
    if (null == callback) {
      ...
      if (null == tmp3) {
        ...
        const experimentalGetPriceResult = callback(3947).experimentalGetPrice(tmp.id, obj);
