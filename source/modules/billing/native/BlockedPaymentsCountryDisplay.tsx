...
// Dependencies: [19, 17, 676, 21, 4255, 712, 4191, 1297, 1236, 1945, 4101, 7315, 7316, 2]
// Exports: default

// Module 7314 (BlockedPaymentsCountryDisplay)
import "noop";
...
export default function BlockedPaymentsCountryDisplay() {
  ...
  if (obj7.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(7315);
  } else {
    tmp2Result = tmp2(7316);
  }
  obj2[1] = tmp2Result;
