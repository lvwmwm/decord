...
// Dependencies: [19, 17, 21, 5570, 5143, 4395, 4185, 1236, 2]
// Exports: default

// Module 8768 (UnsupportedFeatureModal)
import "noop";
...
export default function UnsupportedFeatureModal(onDismiss) {
  ...
  obj[1] = onDismiss(5143).getHeaderCloseButton(() => {
  ...
  obj[2] = function render() {
    ...
    obj[1] = callback(onDismiss(4185).Text, obj);
    return callback(closure_3, obj);
  };
  obj[0] = obj;
  obj[1] = obj;
  return jsx(onDismiss(5570).Navigator, { title: onDismiss.title, headerLeft: null, render: null });
};
