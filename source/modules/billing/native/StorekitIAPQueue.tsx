...
// Dependencies: [5, 17, 4042, 5897, 7467, 2]

// Module 7486 (productSK2ToIAPProduct)
...
function productSK2ToIAPProduct(subscription) {
  ...
  if (null == subscription.subscription.introductoryOffer) {
    ...
    const NumberResult = Number(price.toFixed(require(5897) /* CurrencyCodes */.CurrencyExponents[subscription.currency.toLowerCase(subscription.currency)]));
