...
// Dependencies: [5, 17, 4042, 5895, 7463, 2]

// Module 7482 (productSK2ToIAPProduct)
...
function productSK2ToIAPProduct(subscription) {
  ...
  if (null == subscription.subscription.introductoryOffer) {
    ...
    const NumberResult = Number(price.toFixed(require(5895) /* CurrencyCodes */.CurrencyExponents[subscription.currency.toLowerCase(subscription.currency)]));
