...
// Dependencies: [5, 17, 3965, 5777, 7343, 2]

// Module 7362 (productSK2ToIAPProduct)
...
function productSK2ToIAPProduct(subscription) {
  ...
  if (null == subscription.subscription.introductoryOffer) {
    ...
    const NumberResult = Number(price.toFixed(require(5777) /* CurrencyCodes */.CurrencyExponents[subscription.currency.toLowerCase(subscription.currency)]));
