...
// Dependencies: [32, 19, 1874, 3937, 6770, 676, 1876, 3867, 38, 3946, 3931, 589, 4711, 6771, 12, 2]
// Exports: default

// Module 6769 (calculateFractionalPremiumInfo)
  ...
  if (flag) {
    ...
    if (null != isFetching.currentUser) {
      ...
      if (null == first) {
        ...
        obj2[1] = tmp7;
        if (null != first) {
          let tmp11 = tmp2(3867)(first.startsAt);
        } else {
          tmp11 = tmp2(3867)(0);
        }
        obj2[2] = tmp11;
        ...
        obj2[4] = str;
        if (null != first) {
          let tmp18 = tmp2(3867)(first.endsAt);
        } else {
          tmp18 = tmp2(3867)(0);
        }
        obj2[5] = tmp18;
