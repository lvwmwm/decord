...
const set = new Set([0., 0., 0., 0., 0.]);
  ...
  items[3] = {
    ...
    value() {
      ...
      if (this._metrics.length > 0) {
        ...
        obj = { metrics: items, client_info: { nextOffset: 32, serverUrl: false } };
        obj.body = obj;
        obj.retries = 1;
