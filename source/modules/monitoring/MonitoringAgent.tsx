...
// Function ID: 7209
// Name: set
// Dependencies: [676, 500, 7209, 7210, 17, 7211, 7212, 530, 2]

// Module 7208 (set)
import ME from "ME" /* 676 */;
import enforcing from "enforcing" /* 7211 */;
...
prototype["_getMetricWithDefaults"] = function _getMetricWithDefaults(name, COUNT) {
  let tags = name.tags;
  obj = { name: name.name, type: COUNT, tags: obj(7212).getGlobalTagsArray() };
  if (null != tags) {
  ...
  const CurrentReleaseChannel = tmp(7209).CurrentReleaseChannel;
  let tmp9 = null;
  if (null != CurrentReleaseChannel) {
    const ALL = tmp(7210).ReleaseChannelsSets.ALL;
    tmp9 = null;
...
prototype["_flush"] = function _flush() {
  ...
  if (this._metrics.length > 0) {
    ...
    obj[0] = items;
    obj[1] = { built_at: "1787635183312", build_number: "6275" };
    obj[1] = obj;
    HTTP.post(obj).catch(() => {
