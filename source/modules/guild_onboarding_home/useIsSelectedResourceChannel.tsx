...
// Dependencies: [5898, 1372, 1960, 676, 1379, 647, 1384, 10318, 5844, 2]
// Exports: default

// Module 10317 (useIsSelectedResourceChannel)
...
export default function useIsSelectedResourceChannel(arg0) {
  ...
  const obj2 = _require(5844);
  return null != stateFromStores && _require(5844).useCanSeeOnboardingHome(tmp2);
};
