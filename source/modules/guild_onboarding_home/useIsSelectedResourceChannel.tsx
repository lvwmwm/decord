...
// Dependencies: [5939, 1391, 1979, 676, 1398, 647, 1403, 10277, 5884, 2]
// Exports: default

// Module 10276 (useIsSelectedResourceChannel)
...
export default function useIsSelectedResourceChannel(arg0) {
  ...
  const obj2 = _require(5884);
  return null != stateFromStores && _require(5884).useCanSeeOnboardingHome(tmp2);
};
