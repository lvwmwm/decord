...
// Dependencies: [5819, 1960, 1379, 4136, 4135, 2]
// Exports: default

// Module 10236 (isSelectedFromHomeChannel)
  ...
  if (null != rootNavigationRef) {
    if (rootNavigationRef.isReady()) {
      ...
      if (null == rootState) {
        ...
        const coerceMainRouteResult = require(4135) /* navigationToRootTabHelper */.coerceMainRoute(rootState.routes[rootState.index]);
        ...
        const tmpResult = require(4135) /* navigationToRootTabHelper */;
      }
    }
  }
  return false;
