...
// Dependencies: [5838, 1960, 1379, 4153, 4152, 2]
// Exports: default

// Module 10252 (isSelectedFromHomeChannel)
  ...
  if (null != rootNavigationRef) {
    if (rootNavigationRef.isReady()) {
      ...
      if (null == rootState) {
        ...
        const coerceMainRouteResult = require(4152) /* navigationToRootTabHelper */.coerceMainRoute(rootState.routes[rootState.index]);
        ...
        const tmpResult = require(4152) /* navigationToRootTabHelper */;
      }
    }
  }
  return false;
