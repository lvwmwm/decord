...
// Dependencies: [5, 1982, 1391, 4546, 4547, 676, 709, 530, 11717, 698, 4353, 11, 2]
...
// Module 11716 (_fetchGuildHomeSettings)
...
export const selectHomeResourceChannel = function selectHomeResourceChannel(closure_0, channelId) {
  ...
  if (null != channelId) {
    ...
    if (flag) {
      require(4353) /* transitionToChannel */.transitionToChannel(channelId, { navigationReplace: false });
      const obj3 = require(4353) /* transitionToChannel */;
    }
  }
};
export const selectNewMemberActionChannel = function selectNewMemberActionChannel(guild_id, id) {
  ...
  require(4353) /* transitionToChannel */.transitionToChannel(id);
};
