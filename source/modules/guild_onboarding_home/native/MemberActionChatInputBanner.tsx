...
function ActionChannelInfo(action) {
  ...
  return closure_12(action(4185).Text, obj1);
}
  ...
  if (null != stateFromStores) {
    ...
    if (null != name) {
      ...
      if (null != tmp5Result1.getByName(tmp5Result2.convertSurrogateToName(name, false))) {
        ...
        obj3[2] = name;
        tmp2Result = tmp2(tmp3(4185).Text, obj3);
      }
      tmp5Result2 = tmp5(3830);
    }
  }
  return tmp2Result;
}
