...
// Function ID: 15517
// Name: ResourcesRow
// Dependencies: [19, 17, 15517, 21, 4255, 712, 15518, 11562, 4223, 15519, 1959, 4783, 4251, 1236, 2]
// Exports: default

// Module 15516 (ResourcesRow)
import "noop";
...
export default function ResourcesRow(guildId) {
  ...
  if (tmp3) {
    ...
    tmp6 = callback(guildId(4783).PressableOpacity, obj);
  }
  items[1] = tmp6;
  obj[2] = items;
