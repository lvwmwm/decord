...
// Function ID: 15566
// Name: ResourcesRow
// Dependencies: [19, 17, 15566, 21, 4285, 712, 15567, 11575, 4253, 15568, 1988, 4827, 4281, 1236, 2]
// Exports: default

// Module 15565 (ResourcesRow)
import "noop";
...
export default function ResourcesRow(guildId) {
  ...
  if (tmp3) {
    ...
    tmp6 = callback(guildId(4827).PressableOpacity, obj);
  }
  items[1] = tmp6;
  obj[2] = items;
