...
obj = { container: {} };
obj = { flexShrink: 141317.775, marginStart: 0.00000000000000000000000000000000000000000000000000000000000004133483696510432, flex: 0., padding: "\u{1F469}\u{1F3FF}\u200D\u{1F9BD}\u200D\u27A1\uFE0F", backgroundColor: importDefault(dependencyMap[5]).colors.BACKGROUND_BASE_LOWEST, overflow: null, flexDirection: 15.1, borderRadius: importDefault(dependencyMap[5]).radii.round };
obj.channelItem = obj;
