...
obj = { container: { padding: 16 }, horizontal: { <string:3814666730>: null, <string:1280564396>: "\u{1F43F}\uFE0F" }, spaceBetween: { justifyContent: "space-between" }, spaceBelow: { marginBottom: 8 } };
  ...
  if (!obj3.hasFlag(num2, GuildMemberFlags.COMPLETED_HOME_ACTIONS)) {
    ...
    if (0 !== num) {
      ...
      if (memo + num !== 0) {
        ...
        obj.style = items5;
        obj1 = { cachedAt: "<string:100663661>", edpbxy: "<string:822084007>" };
        ...
        obj3 = { cachedAt: "<string:100663661>", edpbxy: "<string:822084007>", children: memo };
        const items7 = [callback(arg1(dependencyMap[15]).Text, obj3), callback(arg1(dependencyMap[15]).Text, {}), , ];
        const obj4 = { cachedAt: "<string:100663661>", edpbxy: "<string:822084007>", children: num };
