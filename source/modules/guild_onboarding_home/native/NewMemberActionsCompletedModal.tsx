...
// Dependencies: [19, 17, 21, 4303, 712, 4036, 4304, 4509, 11658, 4299, 1236, 2]
// Exports: default

// Module 16440 (NewMemberActionsCompleted)
...
export default function NewMemberActionsCompleted(arg0) {
  ...
  items1[1] = callback(View, { style: tmp.progressBackground, children: callback(importDefault(4036).View, { style: items2 }) });
  obj[1] = items1;
