...
// Dependencies: [31, 27, 33, 4165, 689, 4026, 4166, 4372, 11415, 4161, 1212, 2]
// Exports: default

// Module 16154 (NewMemberActionsCompleted)
...
export default function NewMemberActionsCompleted(arg0) {
  ...
  obj = { withDelay: sharedValue(4026).withDelay, withTiming: sharedValue(4166).withTiming, barWidth: sharedValue };
  fn.__closure = obj;
  ...
  const items1 = [callback(sharedValue(4161).Text, obj1), ];
  const items2 = [tmp.progressForeground, animatedStyle];
  items1[1] = callback(View, { style: tmp.progressBackground, children: callback(importDefault(4026).View, { style: items2 }) });
  obj.children = items1;
