...
// Dependencies: [19, 17, 21, 4303, 712, 4042, 4304, 4509, 11661, 4299, 1236, 2]
// Exports: default

// Module 16456 (NewMemberActionsCompleted)
...
export default function NewMemberActionsCompleted(arg0) {
  ...
  items1[1] = callback(View, { style: tmp.progressBackground, children: callback(importDefault(4042).View, { style: items2 }) });
  obj[1] = items1;
