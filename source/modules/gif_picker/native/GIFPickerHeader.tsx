// Module ID: 9544
// Function ID: 74487
// Dependencies: [31, 27, 653, 33, 4131, 689, 6684, 9534, 9545, 9171, 4661, 1212, 9546, 4127, 2]
...
const memoResult = require("result").memo(function GIFPickerHeader(arg0) {
  ...
  const tmp = callback2();
  let obj = require(9534) /* getGifProviderConfig */;
  const providerForAPIRequest = obj.getProviderForAPIRequest();
  require(9545) /* getSearchPlaceholder */;
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp18Result = callback(require(9171) /* SearchField */.SearchField, obj);
  } else {
    ...
    const items = [callback(require(9546) /* ChevronLargeLeftIcon */.ChevronLargeLeftIcon, obj3), ];
    ...
    obj1.children = items;
    tmp18Result = closure_6(require(4661) /* PressableBase */.PressableOpacity, obj1);
