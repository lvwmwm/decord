...
// Dependencies: [32, 19, 17, 676, 21, 4255, 712, 9760, 5900, 4116, 4256, 4259, 7660, 5906, 1236, 5891, 9757, 4783, 9767, 4251, 2]

// Module 9766 (FavoritesSearch)
...
const memoResult = importAllResult.memo(function GIFPickerHeader(arg0) {
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp13Result = tmp6(tmp2(5891).SearchField, obj);
  } else {
    ...
    const items = [tmp6(tmp2(9767).ChevronLargeLeftIcon, obj3), ];
    ...
    obj4[3] = stringResult;
    items[1] = tmp6(tmp2(4251).Text, obj4);
    obj1[4] = items;
    const items1 = [closure_9(tmp2(4783).PressableOpacity, obj1), ];
