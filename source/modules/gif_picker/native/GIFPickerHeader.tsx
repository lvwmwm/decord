...
// Dependencies: [32, 19, 17, 676, 21, 4446, 712, 10298, 6195, 4186, 4447, 4450, 7952, 6201, 1236, 6186, 10296, 5033, 10304, 4442, 2]
...
const memoResult = importAllResult.memo(function GIFPickerHeader(arg0) {
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp13Result = tmp6(tmp2(6186).SearchField, obj);
  } else {
    ...
    obj4[3] = stringResult;
    items[1] = tmp6(tmp2(4442).Text, obj4);
    obj1[4] = items;
    const items1 = [closure_9(tmp2(5033).PressableOpacity, obj1), ];
