// Module ID: 9584
// Function ID: 74617
// Dependencies: [31, 27, 653, 33, 4165, 689, 6720, 9574, 9585, 9215, 4695, 1212, 9586, 4161, 2]
...
const memoResult = require("result").memo(function GIFPickerHeader(arg0) {
  ...
  const tmp = callback2();
  let obj = require(9574) /* getGifProviderConfig */;
  const providerForAPIRequest = obj.getProviderForAPIRequest();
  require(9585) /* getSearchPlaceholder */;
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp18Result = callback(require(9215) /* SearchField */.SearchField, obj);
  } else {
    ...
    const items = [callback(require(9586) /* ChevronLargeLeftIcon */.ChevronLargeLeftIcon, obj3), ];
    ...
    obj1.children = items;
    tmp18Result = closure_6(require(4695) /* PressableBase */.PressableOpacity, obj1);
