...
// Dependencies: [12751, 1212, 2911, 2]
// Exports: getHavenSoundControlName, parseRoom

// Module 12750 (parseParticipant)
...
export const getHavenSoundControlName = function getHavenSoundControlName(arg0) {
  if (require(12751) /* HavenGenres */.HavenSoundKeys.RADIO === arg0) {
    const intl3 = require(1212) /* getSystemLocale */.intl;
    return intl3.string(importDefault(2911).AjiGKB);
  } else if (require(12751) /* HavenGenres */.HavenSoundKeys.ENVIRONMENT === arg0) {
    const intl2 = require(1212) /* getSystemLocale */.intl;
    return intl2.string(importDefault(2911).YEYIbI);
  } else if (require(12751) /* HavenGenres */.HavenSoundKeys.CAMPFIRE === arg0) {
