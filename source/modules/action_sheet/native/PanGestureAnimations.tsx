...
// Dependencies: [1297, 4711, 4303, 4162, 5426, 2]
// Exports: default

// Module 10893 (getNearestValue)
...
function withPanGestureSpring(value, velocity) {
  let tmp = arg2;
  let obj = require(4711) /* CONFIG_NEVER_ANIMATE */;
  if (arg2 == null) {
    tmp = obj;
  }
  obj = {};
...
function withPanGestureTiming(value, timingStandard) {
  ...
  const obj = require(4303) /* CONFIG_NEVER_ANIMATE_TIMING */;
