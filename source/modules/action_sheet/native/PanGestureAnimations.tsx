...
// Dependencies: [1297, 4713, 4304, 4042, 5427, 2]
// Exports: default

// Module 10965 (getNearestValue)
...
function withPanGestureSpring(value, velocity) {
  let tmp = arg2;
  let obj = require(4713) /* CONFIG_NEVER_ANIMATE */;
  if (arg2 == null) {
    tmp = obj;
  }
  obj = {};
...
function withPanGestureTiming(value, timingStandard) {
  ...
  const obj = require(4304) /* CONFIG_NEVER_ANIMATE_TIMING */;
