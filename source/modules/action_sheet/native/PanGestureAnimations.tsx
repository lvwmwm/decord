...
// Dependencies: [1297, 4665, 4256, 4116, 5339, 2]
// Exports: default

// Module 10981 (getNearestValue)
...
function withPanGestureTiming(value, timingStandard) {
  ...
  const obj = require(4256) /* CONFIG_NEVER_ANIMATE_TIMING */;
