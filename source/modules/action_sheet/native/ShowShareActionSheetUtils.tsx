...
// Dependencies: [673, 8294, 695, 8295, 1485, 1234, 5523, 2]
// Exports: getMediaShareParams, resolveShareFileExtension, trackAppClickInNativeShareSheet

// Module 8293 (trackAppClickInNativeShareSheet)
...
import apexExperiment from "apexExperiment" /* 8295 */;
      ...
      if (null != source.shareURI) {
        if (obj11.isDiscordDirectAssetUrl(source.shareURI)) {
          ...
          if (null != videoURI) {
            ...
            const decideFileExtensionResult1 = tmp(5523).decideFileExtension(source.uri, contentType, true);
