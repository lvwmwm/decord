...
// Dependencies: [17, 501, 8924, 8925, 8928, 1208, 2]
// Exports: showShareActionSheet

// Module 8923 (showShareActionSheet)
...
if (PlatformTypes.isAndroid()) {
  ...
  nativeEventEmitter.addListener("share-broadcast-receiver-app-clicked", (arg0) => {
    ...
    const result = require(8925) /* trackAppClickInNativeShareSheet */.trackAppClickInNativeShareSheet(app, _location);
  });
}
