...
// Dependencies: [5267, 1628, 1493, 5372, 2]
// Exports: default, getKeyboardActionSheetHeight

// Module 11426 (useKeyboardActionSheetHeight)
...
export default function useKeyboardActionSheetHeight() {
  ...
  let maximum = importDefault(1493)({ ignoreKeyboard: true }).height - require(5267) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT_MULTILINE - tmp.top;
  if (minimum >= maximum) {
    maximum = minimum;
  }
