...
// Function ID: 11064
// Name: EmojiRow
// Dependencies: [19, 17, 5397, 21, 4302, 4270, 4271, 7163, 3940, 6857, 8589, 4005, 712, 9791, 9793, 8553, 11064, 5688, 2]
// Exports: default

// Module 11063 (EmojiRow)
import "noop";
...
export default function EmojiRow(arg0) {
  ...
  token = require(4005) /* map */.useToken(channel(712).modules.mobile.EMOJI_ROW_EMOJI_CONTAINER_SIZE);
  ...
  const emojisForReactionRow = require(9791) /* useEmojisForReactionRow */.useEmojisForReactionRow(channel, closure_4, token + token1);
  ...
  items[1] = token(require(9793) /* EmojiPickerRowButton */.EmojiPickerRowButton, obj1);
  obj[1] = items;
  const items1 = [callback(closure_3, obj), ];
  obj2 = { location: null };
  obj2[0] = channel(5688).MESSAGE_LONG_PRESS_MENU;
  items1[1] = token(require(11064) /* DoubleTapEmojiEditNudgeInner */.DoubleTapEmojiEditNudge, obj2);
  obj[1] = items1;
