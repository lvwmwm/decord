...
// Function ID: 11189
// Name: EmojiRow
// Dependencies: [19, 17, 5437, 21, 4344, 4312, 4313, 7263, 4000, 6959, 8694, 4065, 712, 9904, 9906, 8658, 11189, 5787, 2]
// Exports: default

// Module 11188 (EmojiRow)
import "noop";
...
export default function EmojiRow(arg0) {
  ...
  const emojisForReactionRow = require(9904) /* useEmojisForReactionRow */.useEmojisForReactionRow(channel, closure_4, token + token1);
  ...
  const items = [
    emojisForReactionRow.map((emoji) => {
      let closure_0 = emoji;
      return token(outer1_0(9906).EmojiReactionRowButton, {
        emoji,
        onPress() {
          let channel_id;
          let id;
      ...
      }, outer1_0(9906).getEmojiKey(emoji, arg1));
    }),
  ...
  obj1 = {
    emojiContainerSize: token,
    onPress() {
      return outer1_0(8658).handleAddNewReactions(channel, id.id, outer1_0(7263).ReactionLocations.MESSAGE);
    }
  };
  items[1] = token(require(9906) /* EmojiPickerRowButton */.EmojiPickerRowButton, obj1);
  obj[1] = items;
  const items1 = [callback(closure_3, obj), ];
  obj2 = { location: null };
  obj2[0] = channel(5787).MESSAGE_LONG_PRESS_MENU;
  items1[1] = token(require(11189) /* DoubleTapEmojiEditNudgeInner */.DoubleTapEmojiEditNudge, obj2);
  obj[1] = items1;
