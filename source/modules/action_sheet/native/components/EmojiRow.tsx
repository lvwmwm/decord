...
// Function ID: 9964
// Name: EmojiRow
// Dependencies: [19, 17, 5244, 21, 4189, 4157, 4158, 6073, 3828, 5713, 9344, 3893, 712, 9964, 9965, 9308, 9966, 5535, 2]
// Exports: default

// Module 9963 (EmojiRow)
import "noop";
...
export default function EmojiRow(arg0) {
  ...
  const emojisForReactionRow = require(9964) /* useEmojisForReactionRow */.useEmojisForReactionRow(channel, closure_4, token + token1);
  ...
  const items = [
    emojisForReactionRow.map((emoji) => {
      let closure_0 = emoji;
      return token(outer1_0(9965).EmojiReactionRowButton, {
        emoji,
        onPress() {
          let channel_id;
          let id;
      ...
      }, outer1_0(9965).getEmojiKey(emoji, arg1));
    }),
  ...
  obj1 = {
    emojiContainerSize: token,
    onPress() {
      return outer1_0(9308).handleAddNewReactions(channel, id.id, outer1_0(6073).ReactionLocations.MESSAGE);
    }
  };
  items[1] = token(require(9965) /* EmojiPickerRowButton */.EmojiPickerRowButton, obj1);
  obj[1] = items;
  const items1 = [callback(closure_3, obj), ];
  obj2 = { location: null };
  obj2[0] = channel(5535).MESSAGE_LONG_PRESS_MENU;
  items1[1] = token(require(9966) /* DoubleTapEmojiEditNudgeInner */.DoubleTapEmojiEditNudge, obj2);
  obj[1] = items1;
