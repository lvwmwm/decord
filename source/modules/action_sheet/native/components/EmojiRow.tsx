...
// Function ID: 10894
// Name: EmojiRow
// Dependencies: [19, 17, 6951, 21, 4661, 4342, 4343, 7511, 4032, 7427, 9310, 4097, 712, 10894, 10895, 10456, 10896, 7159, 2]
// Exports: default
...
export default function EmojiRow(arg0) {
  ...
  token = require(4097) /* map */.useToken(channel(712).modules.mobile.EMOJI_ROW_EMOJI_CONTAINER_SIZE);
  let obj4 = require(4097) /* map */;
  const token1 = require(4097) /* map */.useToken(channel(712).modules.mobile.EMOJI_ROW_EMOJI_MIN_SPACING);
  const obj5 = require(4097) /* map */;
  const emojisForReactionRow = require(10894) /* useEmojisForReactionRow */.useEmojisForReactionRow(channel, closure_4, token + token1);
  ...
  const items = [
    emojisForReactionRow.map((emoji) => {
      let closure_0 = emoji;
      return token(outer1_0(10895).EmojiReactionRowButton, {
        emoji,
        onPress() {
          let channel_id;
          let id;
      ...
      }, outer1_0(10895).getEmojiKey(emoji, arg1));
    }),
  ...
  obj1 = {
    emojiContainerSize: token,
    onPress() {
      return outer1_0(10456).handleAddNewReactions(channel, id.id, outer1_0(7511).ReactionLocations.MESSAGE);
    }
  };
  items[1] = token(require(10895) /* EmojiPickerRowButton */.EmojiPickerRowButton, obj1);
  obj[1] = items;
  const items1 = [callback(closure_3, obj), ];
  obj2 = { location: null };
  obj2[0] = channel(7159).MESSAGE_LONG_PRESS_MENU;
  items1[1] = token(require(10896) /* DoubleTapEmojiEditNudgeInner */.DoubleTapEmojiEditNudge, obj2);
  obj[1] = items1;
