...
// Function ID: 10933
// Name: EmojiRow
// Dependencies: [19, 17, 6989, 21, 4668, 4346, 4347, 7549, 4035, 7465, 9347, 4100, 712, 10933, 10934, 10495, 10935, 7197, 2]
// Exports: default

// Module 10932 (EmojiRow)
import noopAll from "noop" /* 19 */;
import map from "map" /* 4100 */;
import useEmojisForReactionRow from "useEmojisForReactionRow" /* 10933 */;
import EmojiPickerRowButton from "EmojiPickerRowButton" /* 10934 */;
import DoubleTapEmojiEditNudgeInner from "DoubleTapEmojiEditNudgeInner" /* 10935 */;
...
export default function EmojiRow(arg0) {
  ...
  const items = [
    emojisForReactionRow.map((emoji) => {
      closure_0 = emoji;
      return token(closure_1_0(10934).EmojiReactionRowButton, {
        emoji,
        onPress() {
      ...
      }, closure_1_0(10934).getEmojiKey(emoji, arg1));
    }),
  ...
  obj1 = {
    emojiContainerSize: token,
    onPress() {
      return closure_1_0(10495).handleAddNewReactions(channel, id.id, closure_1_0(7549).ReactionLocations.MESSAGE);
    }
  };
  items[1] = token(EmojiPickerRowButton.EmojiPickerRowButton, obj1);
  obj[1] = items;
  const items1 = [callback(closure_3, obj), ];
  obj2 = { location: channel(7197).MESSAGE_LONG_PRESS_MENU };
