...
// Dependencies: [19, 17, 21, 4303, 8976, 1236, 2]
// Exports: default

// Module 10290 (ContextMenuSubmenuActionSheetHeader)
import "noop";
...
export default function ContextMenuSubmenuActionSheetHeader(onBack) {
  ...
  obj[1] = fn;
  obj[1] = jsx(require(8976) /* ActionSheetHeaderPressableText */.ActionSheetHeaderPressableText, { label: null, onPress: null });
