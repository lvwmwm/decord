...
// Dependencies: [19, 17, 1391, 9774, 21, 4303, 501, 712, 9794, 9795, 9773, 4299, 5268, 9811, 4532, 9819, 9820, 693, 5918, 1236, 3998, 2]
// Exports: default

// Module 9793 (NativeMessagePreviewContent)
...
function NativeMessagePreviewContent(arg0) {
  ...
  const tmp = importDefault(9794)();
  ({ gradientColors, gradientStyles } = tmp);
  return callback(View, { children: callback(require(9795) /* PreviewIcon */.NativeChannelRowPreview, { message, lineClamp, maxHeight, gradientStyles, gradientColors }) });
}
...
function EmbedMediaThumbnail(media) {
  ...
  obj = { style: items, children: callback(importDefault(5268), obj) };
...
function EmbedCard(embed) {
  ...
  if (tmp9) {
    ...
    obj2[3] = name;
    tmp9 = callback(require(4299) /* Text */.Text, obj2);
  }
  const items2 = [tmp9, , , ];
  ...
  if (tmp13) {
    ...
    obj3[3] = name1;
    tmp13 = callback(require(4299) /* Text */.Text, obj3);
  }
  items2[1] = tmp13;
  ...
  if (tmp18Result) {
    ...
    obj4[2] = num2;
    obj4[3] = rawTitle;
    tmp18Result = callback(require(4299) /* Text */.Text, obj4);
  ...
  if (tmp21) {
    ...
    tmp21 = callback(require(4299) /* Text */.Text, obj5);
  }
  items2[3] = tmp21;
  obj1[1] = items2;
