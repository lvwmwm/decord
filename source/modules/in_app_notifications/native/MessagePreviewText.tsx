...
// Dependencies: [19, 17, 1372, 9686, 21, 4285, 501, 712, 9706, 9707, 9685, 4281, 5251, 9723, 4513, 9731, 9732, 693, 5839, 1236, 3962, 2]
// Exports: default

// Module 9705 (NativeMessagePreviewContent)
...
function NativeMessagePreviewContent(arg0) {
  ...
  const tmp = importDefault(9706)();
  ({ gradientColors, gradientStyles } = tmp);
  return callback(View, { children: callback(require(9707) /* PreviewIcon */.NativeChannelRowPreview, { message, lineClamp, maxHeight, gradientStyles, gradientColors }) });
}
...
function EmbedMediaThumbnail(media) {
  ...
  obj = { style: items, children: callback(importDefault(5251), obj) };
...
export default function MessagePreviewText(message) {
  ...
  } else if (importDefault(5839)(message)) {
