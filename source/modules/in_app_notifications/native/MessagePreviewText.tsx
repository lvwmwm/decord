...
// Dependencies: [19, 17, 1372, 9655, 21, 4255, 501, 712, 9675, 9676, 9654, 4251, 5221, 9692, 4483, 9700, 9701, 693, 5812, 1236, 3933, 2]
// Exports: default

// Module 9674 (NativeMessagePreviewContent)
...
function NativeMessagePreviewContent(arg0) {
  ...
  return callback(View, { children: callback(require(9676) /* PreviewIcon */.NativeChannelRowPreview, { message, lineClamp, maxHeight, gradientStyles, gradientColors }) });
}
...
function EmbedMediaThumbnail(media) {
  ...
  obj = { style: items, children: callback(importDefault(5221), obj) };
...
export default function MessagePreviewText(message) {
  ...
  } else if (importDefault(5812)(message)) {
