// Module ID: 10161
// Function ID: 10162
// Dependencies: [19, 17, 21, 4668, 712, 1236, 4773, 4310, 10152, 10162, 10087, 2]
...
const memoResult = importAllResult.memo(function MessageFailedToSendNotification(notification) {
  ...
  const tmp = callback();
  obj[1] = jsx(channelId(10162).RetryIcon, { size: "md", color: messageId(712).colors.ICON_SUBTLE });
  ...
  obj[1] = jsx(channelId(10087).SystemMessageText, { text: null });
  obj[2] = obj;
  obj[3] = callback;
  obj[4] = notification;
  return jsx(channelId(10152).NotificationPressable, { style: callback().iconContainer, children: null });
});
