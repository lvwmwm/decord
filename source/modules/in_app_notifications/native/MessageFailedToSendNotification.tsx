// Module ID: 10286
// Function ID: 10287
// Dependencies: [19, 17, 21, 4478, 709, 1233, 4489, 4409, 10277, 9421, 10212, 2]
...
const memoResult = importAllResult.memo(function MessageFailedToSendNotification(notification) {
  ...
  const tmp = callback();
  obj[1] = jsx(channelId(9421).RetryIcon, { size: "md", color: messageId(709).colors.ICON_SUBTLE });
  ...
  obj[1] = jsx(channelId(10212).SystemMessageText, { text: null });
  obj[2] = obj;
  obj[3] = callback;
  obj[4] = notification;
  return jsx(channelId(10277).NotificationPressable, { style: callback().iconContainer, children: null });
});
