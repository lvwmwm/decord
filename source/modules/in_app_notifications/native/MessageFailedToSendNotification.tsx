// Module ID: 10184
// Function ID: 10185
// Dependencies: [19, 17, 21, 4445, 712, 1236, 4456, 4376, 10175, 9329, 10110, 2]
...
const memoResult = importAllResult.memo(function MessageFailedToSendNotification(notification) {
  ...
  const tmp = callback();
  obj[1] = jsx(channelId(9329).RetryIcon, { size: "md", color: messageId(712).colors.ICON_SUBTLE });
  ...
  obj[1] = jsx(channelId(10110).SystemMessageText, { text: null });
  obj[2] = obj;
  obj[3] = callback;
  obj[4] = notification;
