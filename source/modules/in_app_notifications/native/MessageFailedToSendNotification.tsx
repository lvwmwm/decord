// Module ID: 9916
// Function ID: 9917
// Dependencies: [19, 17, 21, 4342, 712, 1236, 4353, 4274, 9907, 9917, 9848, 2]
...
const memoResult = importAllResult.memo(function MessageFailedToSendNotification(notification) {
  ...
  obj[1] = jsx(channelId(9917).RetryIcon, { size: "md", color: null });
  ...
  obj[1] = jsx(channelId(9848).SystemMessageText, { text: null });
  obj[2] = obj;
  obj[3] = callback;
  obj[4] = notification;
  return jsx(channelId(9907).NotificationPressable, { style: callback().iconContainer, children: null });
});
