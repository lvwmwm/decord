...
// Dependencies: [19, 17, 676, 21, 4285, 3988, 712, 7758, 9724, 9727, 4472, 9729, 5839, 2]
// Exports: usePreviewableMedia

// Module 9723 (VoiceMessageIcon)
...
function VoiceMessageIcon() {
  ...
  const tmp = callback3();
  obj[4] = callback(require(7758) /* inlineStyles */.Path, { d: "M22.2188 59.8545C19.5607 61.6263 16.0003 59.7208 16 56.5264V48C7.16344 48 2.5772e-07 40.8366 0 32V16C0 7.16344 7.16344 0 16 0H48C56.8366 0 64 7.16344 64 16V32C64 40.8366 56.8366 48 48 48H40L22.2188 59.8545Z", fill: token, stroke: token1 });
  const items = [callback(importDefault(7758), obj), ];
  obj1 = { style: tmp.voiceMessageIconOverlay, children: null };
  const items1 = [callback(require(9724) /* CirclePlayIcon */.CirclePlayIcon, { size: "md", color: "background-brand", secondaryColor: "white" }), callback(require(9727) /* WaveformIcon */.WaveformIcon, { size: "md", color: "background-brand" })];
  obj1[1] = items1;
