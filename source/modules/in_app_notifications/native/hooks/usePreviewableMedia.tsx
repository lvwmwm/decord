...
// Dependencies: [19, 17, 676, 21, 4189, 3893, 712, 8531, 9869, 10296, 4377, 10298, 5884, 2]
// Exports: usePreviewableMedia

// Module 10295 (VoiceMessageIcon)
...
function VoiceMessageIcon() {
  ...
  const tmp = callback3();
  obj[4] = callback(require(8531) /* inlineStyles */.Path, { d: "M22.2188 59.8545C19.5607 61.6263 16.0003 59.7208 16 56.5264V48C7.16344 48 2.5772e-07 40.8366 0 32V16C0 7.16344 7.16344 0 16 0H48C56.8366 0 64 7.16344 64 16V32C64 40.8366 56.8366 48 48 48H40L22.2188 59.8545Z", fill: token, stroke: token1 });
  const items = [callback(importDefault(8531), obj), ];
  obj1 = { style: tmp.voiceMessageIconOverlay, children: null };
  const items1 = [callback(require(9869) /* CirclePlayIcon */.CirclePlayIcon, { size: "md", color: "background-brand", secondaryColor: "white" }), callback(require(10296) /* WaveformIcon */.WaveformIcon, { size: "md", color: "background-brand" })];
  obj1[1] = items1;
        ...
        if (obj.isImageFile(filename)) {
          ...
          if (tmp8Result.isVideoFile(tmp7)) {
            ...
            if (tmp8Result.isAudioFile(tmp7)) {
              ...
              obj2[2] = tmp6;
              let tmp17 = callback;
              obj2[3] = callback(tmp8(9869).CirclePlayIcon, { size: "lg", color: "background-brand", secondaryColor: "white" });
              let str5 = null;
              if (isForward) {
                str5 = "forward";
              }
              ...
              obj2[3] = callback(tmp8(10298).FileIcon, obj3);
              let str4 = null;
              if (isForward) {
                str4 = "forward";
              }
