...
// Dependencies: [19, 17, 676, 21, 4344, 4065, 712, 7876, 9853, 9856, 4531, 9858, 5957, 2]
// Exports: usePreviewableMedia

// Module 9852 (VoiceMessageIcon)
...
function VoiceMessageIcon() {
  ...
  const tmp = callback3();
  obj[4] = callback(require(7876) /* inlineStyles */.Path, { d: "M22.2188 59.8545C19.5607 61.6263 16.0003 59.7208 16 56.5264V48C7.16344 48 2.5772e-07 40.8366 0 32V16C0 7.16344 7.16344 0 16 0H48C56.8366 0 64 7.16344 64 16V32C64 40.8366 56.8366 48 48 48H40L22.2188 59.8545Z", fill: token, stroke: token1 });
  const items = [callback(importDefault(7876), obj), ];
  obj1 = { style: tmp.voiceMessageIconOverlay, children: null };
  const items1 = [callback(require(9853) /* CirclePlayIcon */.CirclePlayIcon, { size: "md", color: "background-brand", secondaryColor: "white" }), callback(require(9856) /* WaveformIcon */.WaveformIcon, { size: "md", color: "background-brand" })];
  obj1[1] = items1;
  ...
  if (message.attachments.length > 0) {
    ...
    if (message.hasFlag(constants2.IS_VOICE_MESSAGE)) {
      ...
      while (iter !== undefined) {
        ...
        obj = require(4531) /* urlMatchesFileExtension */;
