// Module ID: 9720
// Function ID: 9721
// Dependencies: [19, 17, 4294, 9702, 676, 21, 500, 712, 4302, 9721, 9722, 589, 9701, 1474, 4162, 9723, 1297, 9749, 4271, 7163, 3940, 1236, 4530, 4698, 7082, 4014, 4507, 4310, 9750, 1988, 9780, 4303, 9785, 9790, 2]
...
let closure_18 = importAllResult.memo((message) => callback(importDefault(9721), { message: message.message, lineClamp: closure_8, maxHeight: closure_7 }));
