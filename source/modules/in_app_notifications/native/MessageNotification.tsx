// Module ID: 9786
// Function ID: 9787
// Dependencies: [19, 17, 4295, 9768, 676, 21, 500, 712, 4303, 9787, 9788, 589, 9767, 1474, 4036, 9789, 1297, 9815, 4272, 7223, 3940, 1236, 4532, 4700, 7142, 4014, 4509, 4311, 9816, 1988, 9846, 4304, 9851, 9856, 2]
...
let closure_18 = importAllResult.memo((message) => callback(importDefault(9787), { message: message.message, lineClamp: closure_8, maxHeight: closure_7 }));
