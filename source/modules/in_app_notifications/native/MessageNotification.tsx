// Module ID: 10274
// Function ID: 10275
// Dependencies: [19, 17, 4181, 10257, 676, 21, 500, 712, 4189, 10275, 10276, 589, 10256, 1474, 4050, 10277, 1297, 10298, 4158, 6073, 3828, 1236, 4418, 4586, 5965, 3902, 4395, 4197, 10299, 1959, 10329, 4190, 10330, 10335, 2]
...
let closure_18 = importAllResult.memo((message) => callback(importDefault(10275), { message: message.message, lineClamp: closure_8, maxHeight: closure_7 }));
