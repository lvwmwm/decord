// Module ID: 9787
// Function ID: 9788
// Dependencies: [19, 17, 4295, 9769, 676, 21, 500, 712, 4303, 9788, 9789, 589, 9768, 1474, 4036, 9790, 1297, 9816, 4272, 7223, 3940, 1236, 4532, 4700, 7142, 4014, 4509, 4311, 9817, 1988, 9847, 4304, 9852, 9857, 2]
...
let closure_18 = importAllResult.memo((message) => callback(importDefault(9788), { message: message.message, lineClamp: closure_8, maxHeight: closure_7 }));
