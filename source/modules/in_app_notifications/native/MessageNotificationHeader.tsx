...
// Function ID: 10219
// Name: LocationText
// Dependencies: [19, 17, 4440, 4100, 1922, 21, 4448, 712, 4444, 4642, 692, 4988, 4990, 4949, 589, 2]
// Exports: SimpleNotificationHeader, default

// Module 10218 (LocationText)
...
export default function MessageNotificationHeader(locationTextColor) {
  ...
  if (tmp17Result) {
    ...
    obj2[3] = items1;
    obj2[4] = author.nick;
    tmp17Result = tmp17(tmp2(4444).Text, obj2);
  }
...
export const SimpleNotificationHeader = function SimpleNotificationHeader(secondaryText) {
  ...
  if (tmp2Result) {
    ...
    obj[3] = tmp.separator;
    const items2 = [tmp4(tmp5(4444).Text, obj), ];
    ...
    items2[1] = tmp4(tmp5(4444).Text, obj1);
    obj[1] = items2;
