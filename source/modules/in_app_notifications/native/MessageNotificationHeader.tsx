...
// Function ID: 9742
// Name: LocationText
// Dependencies: [19, 17, 4247, 3892, 1874, 21, 4255, 712, 4251, 4445, 692, 4751, 4753, 4715, 589, 4797, 1236, 5255, 2]
// Exports: SimpleNotificationHeader, default

// Module 9741 (LocationText)
...
export default function MessageNotificationHeader(locationTextColor) {
  ...
  if (expanded) {
    ...
    obj4[5] = callback(tmp2(5255).XSmallIcon, obj5);
    expanded = callback(tmp2(4797).PressableOpacity, obj4);
  }
  items3[1] = expanded;
  obj[1] = items3;
