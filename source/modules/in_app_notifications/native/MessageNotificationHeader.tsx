...
// Function ID: 9789
// Name: LocationText
// Dependencies: [19, 17, 4294, 3938, 1903, 21, 4302, 712, 4298, 4492, 692, 4798, 4800, 4762, 589, 4844, 1236, 5325, 2]
// Exports: SimpleNotificationHeader, default

// Module 9788 (LocationText)
...
export const SimpleNotificationHeader = function SimpleNotificationHeader(secondaryText) {
  ...
  const items1 = [callback(require(4298) /* Text */.Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, style: items, children: text }), ];
