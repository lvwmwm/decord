...
// Function ID: 9773
// Name: LocationText
// Dependencies: [19, 17, 4277, 3921, 1903, 21, 4285, 712, 4281, 4475, 692, 4781, 4783, 4745, 589, 4827, 1236, 5309, 2]
// Exports: SimpleNotificationHeader, default

// Module 9772 (LocationText)
...
export default function MessageNotificationHeader(locationTextColor) {
  ...
  if (expanded) {
    ...
    obj4[5] = callback(tmp2(5309).XSmallIcon, obj5);
    expanded = callback(tmp2(4827).PressableOpacity, obj4);
  }
  items3[1] = expanded;
  obj[1] = items3;
