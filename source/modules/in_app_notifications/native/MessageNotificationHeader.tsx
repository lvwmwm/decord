...
// Function ID: 10178
// Name: LocationText
// Dependencies: [19, 17, 4437, 4098, 1922, 21, 4445, 712, 4441, 4639, 692, 4972, 4974, 4933, 589, 2]
...
export default function MessageNotificationHeader(locationTextColor) {
  ...
  if (tmp17Result) {
    ...
    obj2[3] = items1;
    obj2[4] = author.nick;
    tmp17Result = tmp17(tmp2(4441).Text, obj2);
  }
...
export const SimpleNotificationHeader = function SimpleNotificationHeader(secondaryText) {
  ...
  if (tmp2Result) {
    ...
    obj[3] = tmp.separator;
    const items2 = [tmp4(tmp5(4441).Text, obj), ];
    ...
    items2[1] = tmp4(tmp5(4441).Text, obj1);
    obj[1] = items2;
