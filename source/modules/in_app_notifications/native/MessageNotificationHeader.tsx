...
// Function ID: 10196
// Name: LocationText
// Dependencies: [19, 17, 4438, 4099, 1923, 21, 4446, 712, 4442, 4640, 692, 4985, 4987, 4946, 589, 2]
// Exports: SimpleNotificationHeader, default

// Module 10195 (LocationText)
...
export default function MessageNotificationHeader(locationTextColor) {
  ...
  if (tmp17Result) {
    ...
    obj2[3] = items1;
    obj2[4] = author.nick;
    tmp17Result = tmp17(tmp2(4442).Text, obj2);
  }
...
export const SimpleNotificationHeader = function SimpleNotificationHeader(secondaryText) {
  ...
  if (tmp2Result) {
    ...
    obj[3] = tmp.separator;
    const items2 = [tmp4(tmp5(4442).Text, obj), ];
    ...
    items2[1] = tmp4(tmp5(4442).Text, obj1);
    obj[1] = items2;
