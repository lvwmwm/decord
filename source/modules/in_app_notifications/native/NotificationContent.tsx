...
// Function ID: 9900
// Name: DragHandle
// Dependencies: [32, 19, 17, 21, 4344, 712, 4740, 4083, 9900, 6063, 1377, 4345, 4340, 1236, 9901, 2]
// Exports: default

// Module 9899 (DragHandle)
...
export default function NotificationContent(arg0) {
  ...
  if ("message" === header.type) {
    ...
    let tmp10Result = tmp10(importDefault(9901), obj3);
    const tmp7Result = importDefault(9901);
  } else {
    const obj4 = {};
    const merged1 = Object.assign(header);
    tmp10Result = tmp10(require(9901) /* LocationText */.SimpleNotificationHeader, obj4);
  }
  obj2[1] = tmp10Result;
  ...
  obj[1] = items3;
  items[1] = closure_9(importDefault(4083).View, obj);
