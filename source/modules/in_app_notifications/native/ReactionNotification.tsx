...
// Dependencies: [19, 17, 4277, 9684, 676, 21, 4285, 501, 712, 3958, 9721, 4281, 1416, 9814, 5301, 1236, 5827, 9683, 9704, 9705, 9730, 9582, 1297, 5661, 12, 4513, 589, 4490, 4293, 9685, 9732, 1959, 9767, 9762, 2]
// Exports: default

// Module 9813 (ReactionNotificationBody)
...
function ReactionNotificationBody(arg0) {
  ...
  if (hasMessageContent) {
    ...
    if (null != messagePreview) {
      ...
      tmp8Result = tmp8(tmp2(9705).NativeChannelRowPreview, obj1);
    }
  }
...
function ReactionNotificationBodyWrapper(arg0) {
  ...
  const React = tmp4;
  const AnimateEmoji = message(3958).AnimateEmoji;
  const setting = AnimateEmoji.useSetting();
  let obj = message(9721);
