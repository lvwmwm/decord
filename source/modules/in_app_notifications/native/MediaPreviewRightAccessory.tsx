...
// Function ID: 9912
// Name: VideoBadge
// Dependencies: [19, 17, 4334, 9830, 21, 4342, 712, 8918, 4338, 4065, 500, 4767, 4873, 8568, 647, 7129, 9912, 9866, 8298, 8909, 1492, 5329, 5971, 5976, 8933, 9913, 1297, 8363, 2]
// Exports: MediaPreviewRightAccessory

// Module 9911 (VideoBadge)
...
function VideoBadge() {
  ...
  obj = { style: tmp.badge, children: callback(require(8918) /* PlayIcon */.PlayIcon, obj) };
...
function ObscuredMediaOverlay(isSpoiler) {
  ...
  if (!isObscured) {
    ...
    tmp11 = callback(importDefault(4767), obj);
  }
  items[2] = tmp11;
...
function SinglePreviewableMedia(arg0) {
  ...
  let obj1 = require(7129) /* redactionSettingToRenderedString */;
  const shouldAgeVerifyForExplicitMedia = obj1.useShouldAgeVerifyForExplicitMedia();
  let obj2 = require(9912) /* useEnabledHarmTypesBitmaskForChannelAndAuthorId */;
  const enabledHarmTypesBitmaskForMessage = obj2.useEnabledHarmTypesBitmaskForMessage(message);
  if (require(9866) /* VoiceMessageIcon */.PreviewableMediaTypes.VOICE_MESSAGE === type) {
            ...
            if (tmp2(9866).PreviewableMediaTypes.GIF === type) {
              ...
              if (null == thumbnail) {
                ...
                if (null != thumbnail.proxyURL) {
                  ...
                  if (null != url) {
                    if ("" !== url) {
                      if (!stateFromStores) {
                        ...
                        obj5[4] = obj6;
                        obj5[5] = url2;
                        let tmp16Result = tmp16(importDefault(8933), obj5);
                      }
                      obj4[2] = tmp16Result;
                  ...
                  tmp16Result = tmp16(importDefault(5329), obj7);
                }
                url2 = thumbnail.url;
              }
              ...
              obj9[1] = callback(importDefault(9913), obj11);
          ...
          if (width > 0) {
            if (null != height) {
              if (height > 0) {
                ...
                const items4 = [callback(importDefault(5329), obj17), ];
...
function MultiplePreviewableMedia(arg0) {
  ...
  const items1 = [callback(importDefault(8363), obj), callback(CountBadge, { total: totalMediaCount })];
  obj[1] = items1;
...
export const MediaPreviewRightAccessory = function MediaPreviewRightAccessory(message) {
  ...
  let obj = require(9866) /* VoiceMessageIcon */;
