...
// Function ID: 9765
// Name: VideoBadge
// Dependencies: [19, 17, 4277, 9686, 21, 4285, 712, 8778, 4281, 3988, 500, 4685, 4791, 8420, 647, 6980, 9765, 9723, 8152, 8769, 1473, 5251, 5830, 5835, 8793, 9766, 1297, 8216, 4145, 2]
// Exports: MediaPreviewRightAccessory

// Module 9764 (VideoBadge)
...
function VideoBadge() {
  ...
  obj = { style: tmp.badge, children: callback(require(8778) /* PlayIcon */.PlayIcon, obj) };
...
function SinglePreviewableMedia(arg0) {
  ...
  let obj1 = require(6980) /* redactionSettingToRenderedString */;
  const shouldAgeVerifyForExplicitMedia = obj1.useShouldAgeVerifyForExplicitMedia();
  let obj2 = require(9765) /* useEnabledHarmTypesBitmaskForChannelAndAuthorId */;
  const enabledHarmTypesBitmaskForMessage = obj2.useEnabledHarmTypesBitmaskForMessage(message);
  if (require(9723) /* VoiceMessageIcon */.PreviewableMediaTypes.VOICE_MESSAGE === type) {
            ...
            if (tmp2(9723).PreviewableMediaTypes.GIF === type) {
              ...
              if (null == thumbnail) {
                ...
                if (null != thumbnail.proxyURL) {
                  ...
                  if (null != url) {
                    if ("" !== url) {
                      if (!stateFromStores) {
                        ...
                        obj5[4] = obj6;
                        obj5[5] = url2;
                        let tmp16Result = tmp16(importDefault(8793), obj5);
                      }
                      obj4[2] = tmp16Result;
                  ...
                  tmp16Result = tmp16(importDefault(5251), obj7);
                }
                url2 = thumbnail.url;
              }
              ...
              obj9[1] = callback(importDefault(9766), obj11);
          ...
          if (width > 0) {
            if (null != height) {
              if (height > 0) {
                ...
                const items4 = [callback(importDefault(5251), obj17), ];
...
function MultiplePreviewableMedia(arg0) {
  ...
  const items1 = [callback(importDefault(8216), obj), callback(CountBadge, { total: totalMediaCount })];
  obj[1] = items1;
...
export const MediaPreviewRightAccessory = function MediaPreviewRightAccessory(arg0) {
  ...
  let obj = require(9723) /* VoiceMessageIcon */;
