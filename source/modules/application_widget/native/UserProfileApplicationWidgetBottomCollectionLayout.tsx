...
function CollectionItem(arg0) {
  ...
  if (null != fieldValue) {
    ...
    tmp11 = callback(require(12091) /* ImageSkeleton */.ImageSkeleton, obj2);
  }
  const items1 = [tmp11, ];
  ...
  if ("value" === singleStringOrSkeleton.status) {
    ...
    tmp19 = callback(require(12091) /* ImageSkeleton */.TextSkeleton, { variant: "text-xs/medium", widthChars: 6 });
  }
  const items2 = [tmp19, ];
  if ("value" === singleStringOrSkeleton1.status) {
    ...
    tmp26 = callback(require(12091) /* ImageSkeleton */.TextSkeleton, { variant: "text-xxs/medium", widthChars: 10 });
  }
  items2[1] = tmp26;
