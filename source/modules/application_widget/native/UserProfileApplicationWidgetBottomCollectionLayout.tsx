...
function CollectionItem(arg0) {
  ...
  if (null != fieldValue) {
    ...
    tmp11 = callback(require(12134) /* ImageSkeleton */.ImageSkeleton, obj2);
  }
  const items1 = [tmp11, ];
  ...
  if ("value" === singleStringOrSkeleton.status) {
    ...
    let tmp19 = callback(require(4161) /* Text */.Text, obj4);
  } else {
    tmp19 = callback(require(12134) /* ImageSkeleton */.TextSkeleton, { variant: "text-xs/medium", widthChars: 6 });
  }
  const items2 = [tmp19, ];
  if ("value" === singleStringOrSkeleton1.status) {
    ...
    let tmp26 = callback(require(4161) /* Text */.Text, obj5);
  } else {
    tmp26 = callback(require(12134) /* ImageSkeleton */.TextSkeleton, { variant: "text-xxs/medium", widthChars: 10 });
  }
  items2[1] = tmp26;
