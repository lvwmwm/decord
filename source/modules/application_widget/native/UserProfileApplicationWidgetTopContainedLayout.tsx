...
// Dependencies: [19, 17, 21, 4255, 712, 12236, 12323, 12324, 2]
// Exports: default

// Module 12325 (UserProfileApplicationWidgetTopContainedLayout)
import "noop";
...
export default function UserProfileApplicationWidgetTopContainedLayout(header) {
  ...
  let obj2 = require(12236) /* resolvedValuesFromUserApplicationIdentityProfile */;
  ...
  let obj3 = require(12236) /* resolvedValuesFromUserApplicationIdentityProfile */;
  ...
  const items2 = [callback(require(12323) /* formatDurationNarrow */.FieldText, { field: textComponentValues, variant: "text-lg/medium", color: "text-default" }), callback(require(12323) /* formatDurationNarrow */.FieldText, { field: textComponentValues1, variant: "text-sm/normal", color: "text-muted" }), callback(require(12323) /* formatDurationNarrow */.FieldText, { field: textComponentValues2, variant: "text-sm/normal", color: "text-muted" }), callback(require(12323) /* formatDurationNarrow */.FieldText, { field: textComponentValues3, variant: "text-sm/normal", color: "text-muted" })];
  obj[1] = items2;
  ...
  if (null != fieldValue) {
    ...
    tmp12Result = tmp12(tmp2(12324).ImageSkeleton, obj4);
  }
