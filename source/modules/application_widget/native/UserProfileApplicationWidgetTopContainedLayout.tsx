...
// Dependencies: [19, 17, 21, 4303, 712, 12357, 12444, 12445, 2]
// Exports: default

// Module 12446 (UserProfileApplicationWidgetTopContainedLayout)
import "noop";
...
export default function UserProfileApplicationWidgetTopContainedLayout(header) {
  ...
  let obj = require(12357) /* resolvedValuesFromUserApplicationIdentityProfile */;
  const textComponentValues = obj.resolveTextComponentValues(topConfig.components.title, resolveFieldValue, numberFormat, true);
  let obj1 = require(12357) /* resolvedValuesFromUserApplicationIdentityProfile */;
  ...
  let obj2 = require(12357) /* resolvedValuesFromUserApplicationIdentityProfile */;
  ...
  let obj3 = require(12357) /* resolvedValuesFromUserApplicationIdentityProfile */;
  ...
  const items = [require(12357) /* resolvedValuesFromUserApplicationIdentityProfile */.ResolvedValueType.MEDIA];
  const fieldValue = resolveFieldValue(image, items);
  const items1 = [header.header, ];
  obj = { style: tmp.contentRow, children: null };
  obj = { style: tmp.text, children: null };
  const items2 = [callback(require(12444) /* formatDurationNarrow */.FieldText, { field: textComponentValues, variant: "text-lg/medium", color: "text-default" }), callback(require(12444) /* formatDurationNarrow */.FieldText, { field: textComponentValues1, variant: "text-sm/normal", color: "text-muted" }), callback(require(12444) /* formatDurationNarrow */.FieldText, { field: textComponentValues2, variant: "text-sm/normal", color: "text-muted" }), callback(require(12444) /* formatDurationNarrow */.FieldText, { field: textComponentValues3, variant: "text-sm/normal", color: "text-muted" })];
  obj[1] = items2;
  ...
  if (null != fieldValue) {
    ...
    tmp12Result = tmp12(tmp2(12445).ImageSkeleton, obj4);
  }
