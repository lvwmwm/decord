...
// Dependencies: [19, 17, 21, 4342, 712, 12421, 12508, 12509, 2]
// Exports: default

// Module 12510 (UserProfileApplicationWidgetTopContainedLayout)
import "noop";
...
export default function UserProfileApplicationWidgetTopContainedLayout(header) {
  ...
  let obj = require(12421) /* resolvedValuesFromUserApplicationIdentityProfile */;
  const textComponentValues = obj.resolveTextComponentValues(topConfig.components.title, resolveFieldValue, numberFormat, true);
  let obj1 = require(12421) /* resolvedValuesFromUserApplicationIdentityProfile */;
  ...
  let obj2 = require(12421) /* resolvedValuesFromUserApplicationIdentityProfile */;
  ...
  let obj3 = require(12421) /* resolvedValuesFromUserApplicationIdentityProfile */;
  ...
  const items = [require(12421) /* resolvedValuesFromUserApplicationIdentityProfile */.ResolvedValueType.MEDIA];
  const fieldValue = resolveFieldValue(image, items);
  const items1 = [header.header, ];
  obj = { style: tmp.contentRow, children: null };
  obj = { style: tmp.text, children: null };
  const items2 = [callback(require(12508) /* formatDurationNarrow */.FieldText, { field: textComponentValues, variant: "text-lg/medium", color: "text-default" }), callback(require(12508) /* formatDurationNarrow */.FieldText, { field: textComponentValues1, variant: "text-sm/normal", color: "text-muted" }), callback(require(12508) /* formatDurationNarrow */.FieldText, { field: textComponentValues2, variant: "text-sm/normal", color: "text-muted" }), callback(require(12508) /* formatDurationNarrow */.FieldText, { field: textComponentValues3, variant: "text-sm/normal", color: "text-muted" })];
  obj[1] = items2;
  ...
  if (null != fieldValue) {
    ...
    tmp12Result = tmp12(tmp2(12509).ImageSkeleton, obj4);
  }
