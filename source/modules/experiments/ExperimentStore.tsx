...
// Function ID: 4289
// Name: getHash
// Dependencies: [32, 1218, 1220, 4289, 676, 3, 4290, 1217, 698, 4293, 595, 12, 709, 2]
...
function _loadGuildFilter(arg0) {
  ...
  [tmp, tmp2] = arg0;
  let tmp5 = null;
  if (null != require(4293) /* isInRange */.GUILD_FILTERS[tmp]) {
    const GUILD_FILTERS = require(4293) /* isInRange */.GUILD_FILTERS;
...
prototype["getSerializedState"] = function getSerializedState() {
  ...
  obj[6] = require(4290) /* Version */.getBuildOverrideExperiments();
