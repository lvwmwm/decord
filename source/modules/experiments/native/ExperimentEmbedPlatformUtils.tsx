...
// Function ID: 11739
// Name: regExp
// Dependencies: [4448, 11739, 2008, 11412, 11413, 7821, 4402, 2]
...
export const handleCodedLinkExperimentEmbedTap = function handleCodedLinkExperimentEmbedTap(experimentFromEmbedURL, experimentTreatmentFromEmbedURL) {
  ...
  if (null != experimentTreatmentFromEmbedURL) {
    ...
    if (!Number.isNaN(experimentTreatmentFromEmbedURL)) {
      let obj = _require(11412);
      const legacyExperiments = obj.getLegacyExperiments();
      ({ experiments, overridesInfo } = legacyExperiments);
      const apexExperiments = _require(11413).getApexExperiments();
      ...
      if (null != tmp5) {
        ...
        if (null != iter) {
          ...
          tmp(4402).overrideBucket(tmp5.system, experimentFromEmbedURL, iter.value);
          const tmpResult1 = tmp(4402);
        }
      }
      const obj2 = _require(11413);
    }
  }
  obj = { id: experimentFromEmbedURL };
  ACTION_SHEET_HEIGHT_HALFDefault.openLazy(_require(2008)(11739, dependencyMap.paths), "ExperimentOverrideSheet", obj);
};
