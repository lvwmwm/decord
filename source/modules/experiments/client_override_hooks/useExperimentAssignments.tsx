...
export const getExperimentServerAssignment = function getExperimentServerAssignment(name, id) {
  ...
  if (null == name) {
    return null;
  } else if (name.system === require(4225) /* trackExposureToExperiment */.ExperimentSystem.LEGACY) {
    name = name.name;
