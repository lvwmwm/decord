...
// Dependencies: [32, 19, 1212, 4367, 4296, 1473, 10683, 589, 2]
...
function makeClientVariant(id) {
  return { id, label: "Variant " + id, shortLabel: "Variant " + id, type: require(4367) /* create */.Variation_Type.UNSPECIFIED };
}
