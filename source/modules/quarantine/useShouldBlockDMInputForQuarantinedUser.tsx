...
// Dependencies: [4521, 676, 11640, 589, 2]
// Exports: default

// Module 11798 (useShouldBlockDMInputForQuarantinedUser)
...
export default function useShouldBlockDMInputForQuarantinedUser(hasFlag, channel) {
  ...
  const showConvoStarterInDM = _require(11640).useShowConvoStarterInDM(channel);
  _require(589);
  [][0] = channel;
