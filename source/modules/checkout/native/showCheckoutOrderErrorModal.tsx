...
// Dependencies: [5, 32, 19, 21, 4667, 1236, 4663, 2]
// Exports: showCheckoutOrderErrorModal, showRetryConfirmModal

// Module 7439 (SyncedLoadingAlertModal)
...
function SyncedLoadingAlertModal(onConfirm) {
  ...
  const items = [callback3(onConfirm(4667).AlertActionButton, obj), ];
  ...
  obj1[2] = onCancel;
  obj1[3] = tmp2;
  items[1] = callback3(onConfirm(4667).AlertActionButton, obj1);
  obj[0] = items;
  obj[2] = callback4(closure_6, obj);
  return callback3(onConfirm(4667).AlertModal, obj);
}
...
export const showCheckoutOrderErrorModal = function showCheckoutOrderErrorModal(arg0, c5) {
  ...
  return new Promise((arg0) => {
    ...
    callback(4663).openAlert(key, closure_1_5(closure_1_8, obj), onCloseCallback, obj);
  });
};
