...
// Dependencies: [19, 17, 1388, 21, 4444, 712, 1629, 4411, 5569, 4877, 6202, 4440, 1236, 2141, 4879, 2]
// Exports: default

// Module 6201 (GiftCardMobileConsumptionActionSheet)
...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [callback(View, { style: tmp.illustration, children: callback(markAsDismissed(6202).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }) }), , ];
  ...
  items3[1] = callback(markAsDismissed(4440).Text, obj2);
  ...
  items3[2] = callback(markAsDismissed(4879).Button, obj3);
  obj[1] = items3;
  obj[1] = callback2(markAsDismissed(4877).Stack, obj);
