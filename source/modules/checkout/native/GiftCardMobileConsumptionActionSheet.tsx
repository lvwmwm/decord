...
// Dependencies: [19, 17, 1388, 21, 4380, 712, 1629, 4347, 5503, 4813, 6136, 4376, 1236, 2109, 4815, 2]
// Exports: default

// Module 6135 (GiftCardMobileConsumptionActionSheet)
import ThemesDefault from "Themes" /* 712 */;
import useSafeAreaInsetsDefault from "useSafeAreaInsets" /* 1629 */;
import messagesProxyDefault from "messagesProxy" /* 2109 */;
...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [callback(View, { style: tmp.illustration, children: callback(markAsDismissed(6136).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }) }), , ];
  ...
  items3[1] = callback(markAsDismissed(4376).Text, obj2);
  ...
  items3[2] = callback(markAsDismissed(4815).Button, obj3);
  obj[1] = items3;
  obj[1] = callback2(markAsDismissed(4813).Stack, obj);
