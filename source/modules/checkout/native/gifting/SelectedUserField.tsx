...
// Dependencies: [19, 17, 21, 4661, 712, 7345, 1236, 4219, 7351, 1297, 4734, 7341, 2]
// Exports: default
...
export default function SelectedUserField(onPress) {
  ...
  obj[3] = combined;
  const items1 = [closure_5(require(7351) /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { style: tmp.searchIcon, size: "xs", color: "interactive-text-default" }), ];
  if (null != selectedUser) {
    ...
    obj4[2] = importDefault(4219).getName(selectedUser);
    ...
    tmp2Result = tmp2(tmp4(4734).Text, obj5);
  }
  items1[1] = tmp2Result;
  obj[4] = items1;
  ...
  if (null != selectedUser) {
    ...
    obj7[0] = importDefault(4219).getName(selectedUser);
    ...
    const obj13 = importDefault(4219);
  }
  items3[1] = tmp2Result;
  obj[1] = items3;
  obj[1] = closure_5(require(7345) /* useInputStyles */.InputFieldContainer, { children: closure_6(closure_4, obj) });
