...
// Dependencies: [19, 17, 21, 4380, 712, 6109, 1236, 4224, 6115, 1297, 4376, 6105, 2]
// Exports: default

// Module 9767 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    obj2[0] = tmp.userPill;
    obj3 = { user: null, guildId: "Array", size: "b" };
    obj3[0] = selectedUser;
    ...
    items2[1] = tmp2(tmp4(4376).Text, obj4);
    obj2[1] = items2;
    ...
    tmp2Result = tmp2(tmp4(4376).Text, obj5);
  }
  items1[1] = tmp2Result;
  obj[4] = items1;
  ...
  if (null != selectedUser) {
    ...
    obj6[4] = tmp2(tmp4(6105).CircleXIcon, { size: "xs" });
