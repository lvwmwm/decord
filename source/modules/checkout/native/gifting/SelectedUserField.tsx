...
// Dependencies: [19, 17, 21, 4344, 712, 6041, 1236, 4189, 6047, 1297, 4340, 6037, 2]
// Exports: default

// Module 9662 (SelectedUserField)
import "noop";
...
export default function SelectedUserField(onPress) {
  ...
  obj[3] = combined;
  const items1 = [closure_5(require(6047) /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { style: tmp.searchIcon, size: "xs", color: "interactive-text-default" }), ];
  if (null != selectedUser) {
    ...
    obj4[2] = importDefault(4189).getName(selectedUser);
    items2[1] = tmp2(tmp4(4340).Text, obj4);
    obj2[1] = items2;
    ...
    tmp2Result = tmp2(tmp4(4340).Text, obj5);
  }
  items1[1] = tmp2Result;
  obj[4] = items1;
  ...
  if (null != selectedUser) {
    ...
    obj7[0] = importDefault(4189).getName(selectedUser);
    obj6[3] = intl5.formatToPlainString(tmp4(1236).t["0Vb9FQ"], obj7);
    obj6[4] = tmp2(tmp4(6037).CircleXIcon, { size: "xs" });
    tmp2Result = tmp2(tmp7, obj6);
    const obj13 = importDefault(4189);
  }
  items3[1] = tmp2Result;
  obj[1] = items3;
  obj[1] = closure_5(require(6041) /* useInputStyles */.InputFieldContainer, { children: closure_6(closure_4, obj) });
