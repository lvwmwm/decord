...
// Dependencies: [19, 17, 21, 4668, 712, 7383, 1236, 4223, 7389, 1297, 4739, 7379, 2]
// Exports: default

// Module 9671 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    items2[1] = tmp2(tmp4(4739).Text, obj4);
    obj2[1] = items2;
    ...
    tmp2Result = tmp2(tmp4(4739).Text, obj5);
  }
  items1[1] = tmp2Result;
  obj[4] = items1;
  ...
  if (null != selectedUser) {
    ...
    obj6[4] = tmp2(tmp4(7379).CircleXIcon, { size: "xs" });
