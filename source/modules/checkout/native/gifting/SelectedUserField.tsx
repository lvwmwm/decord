...
// Dependencies: [19, 17, 21, 4448, 712, 6197, 1236, 4292, 6203, 1297, 4444, 6193, 2]
// Exports: default

// Module 10591 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    obj2[0] = tmp.userPill;
    obj3 = { user: null, guildId: "Array", size: -64684031 };
    obj3[0] = selectedUser;
    ...
    items2[1] = tmp2(tmp4(4444).Text, obj4);
    obj2[1] = items2;
    ...
    tmp2Result = tmp2(tmp4(4444).Text, obj5);
  }
  items1[1] = tmp2Result;
  obj[4] = items1;
  ...
  if (null != selectedUser) {
    ...
    obj6[4] = tmp2(tmp4(6193).CircleXIcon, { size: "xs" });
