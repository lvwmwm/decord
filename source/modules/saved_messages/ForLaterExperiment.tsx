...
// Dependencies: [8155, 1452, 38, 8159, 2]
...
// Module 8158 (ForLaterFreemiumConfig)
...
export const useForLaterLimit = function useForLaterLimit(ForLaterScreen, arg1) {
  ...
  const hasForLaterPremiumType = require(8159) /* hasForLaterPremiumType */.useHasForLaterPremiumType();
  if (!config.enabled) {
    let num = 0;
    if (tmp4) {
      num = 0;
