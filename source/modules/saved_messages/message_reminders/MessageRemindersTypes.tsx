...
const items = [
  {
    getDueAt() {
      ...
      return importDefault(3747)().add(30, "minutes").toDate();
    },
    getLabel() {
  ...
  },
  {
    getDueAt() {
      const obj = importDefault(3747)();
      return importDefault(3747)().add(1, "hour").toDate();
    },
    getLabel() {
      const intl = require(1212) /* getSystemLocale */.intl;
  ...
  },
  {
    getDueAt() {
      const obj = importDefault(3747)();
      return importDefault(3747)().add(4, "hour").toDate();
    },
    getLabel() {
      const intl = require(1212) /* getSystemLocale */.intl;
  ...
  },
  {
    getDueAt() {
      const obj = importDefault(3747)();
      const addResult = importDefault(3747)().startOf("day").add(9, "hours");
      const startOfResult = importDefault(3747)().startOf("day");
      if (obj4.hour() >= 9) {
  ...
  {
    getDueAt() {
      const dayResult = importDefault(3747)().day();
      if (0 === dayResult) {
        let num3 = 1;
      } else {
        num3 = 8;
      ...
      const dayResult1 = importDefault(3747)().day(num3);
      const startOfResult1 = importDefault(3747)().day(num3).startOf("day");
      return importDefault(3747)().day(num3).startOf("day").add(9, "hours").toDate();
    },
    getLabel() {
      const intl = require(1212) /* getSystemLocale */.intl;
