...
// Dependencies: [32, 19, 11243, 21, 4478, 712, 589, 687, 11294, 5621, 1236, 5068, 5499, 11295, 5599, 4445, 4723, 11296, 2009, 4075, 5622, 5992, 4429, 2]
// Exports: default

// Module 11293 (MessageReminderDurationActionSheet)
...
export default function MessageReminderDurationActionSheet(createReminder) {
  ...
  obj = { dueAt, now: tmp7, type: tmp2(11294).DueInStringTypes.SHORT };
  const dueInString = createReminder(11294).useDueInString(obj);
  ...
  if (tmp14Result) {
    ...
    tmp14Result = tmp14(tmp2(5599).TableRow, obj1, "remove-reminder");
  }
