// Module ID: 10196
// Function ID: 10197
// Dependencies: [32, 19, 17, 21, 4285, 712, 3867, 1844, 1236, 4253, 8897, 1959, 5245, 8193, 500, 5238, 4812, 4281, 2]
...
const memoResult = importAllResult.memo((onClose) => {
  ...
  function handleOpenDatePicker(closure_5, arg1) {
    ...
    obj[1] = first.toDate();
    const tmp6 = tmp3(1959)(8897, dependencyMap.paths);
    obj[2] = createReminder(3867)().toDate();
    obj[3] = closure_5;
    obj[4] = dependencyMap;
    obj2.openLazy(tmp6, "DatePicker", obj);
  }
  let tmp = callback();
  const tmp2 = handleOpenDatePicker(importAllResult.useState(() => createReminder(3867)()), 2);
  first = tmp2[0];
  ...
  obj1[1] = function headerTitle() {
    ...
    return callback(onClose(8193).GenericHeaderTitle, obj);
  };
  ...
  obj1[3] = num;
  obj1[4] = onClose(5238).getHeaderCloseButton(onClose);
  obj1[5] = function headerRight() {
    ...
    return outer1_7(onClose(4812).PressableOpacity, obj);
  };
  obj[1] = closure_7(onClose(5245).Header, obj1);
  ...
  const items2 = [closure_7(onClose(4281).Text, obj4), ];
  ...
  obj5[5] = closure_7(onClose(4281).Text, { variant: "text-md/medium", children: formatResult });
  items2[1] = closure_7(onClose(4812).PressableOpacity, obj5);
  obj3[0] = items2;
  ...
  const items4 = [closure_7(onClose(4281).Text, obj7), ];
  ...
  obj8[5] = closure_7(onClose(4281).Text, { variant: "text-md/medium", children: formatResult1 });
  items4[1] = closure_7(onClose(4812).PressableOpacity, obj8);
  obj6[0] = items4;
