// Module ID: 10199
// Function ID: 10200
// Dependencies: [32, 19, 17, 21, 4285, 712, 1609, 3866, 1872, 1236, 4253, 8898, 1988, 5260, 8305, 500, 5253, 4827, 4281, 2]
...
const memoResult = importAllResult.memo((onClose) => {
  ...
  function handleOpenDatePicker(closure_5, arg1) {
    ...
    const obj2 = createReminder(4253);
    const tmp = dependencyMap;
    obj[1] = first.toDate();
    const tmp6 = tmp3(1988)(8898, dependencyMap.paths);
    obj[2] = createReminder(3866)().toDate();
    obj[3] = closure_5;
    obj[4] = dependencyMap;
    obj2.openLazy(tmp6, "DatePicker", obj);
  }
  let tmp = callback();
  const tmp4 = handleOpenDatePicker(importAllResult.useState(() => createReminder(3866)()), 2);
  first = tmp4[0];
  ...
  obj[1] = function headerTitle() {
    ...
    const intl = onClose(1236).intl;
    obj[0] = intl.string(onClose(1236).t.VKsXpY);
    return callback(onClose(8305).GenericHeaderTitle, obj);
  };
  ...
  obj[4] = onClose(5253).getHeaderCloseButton(onClose);
  ...
  obj[7] = function headerRight() {
    ...
    obj[2] = outer1_7(onClose(4281).Text, obj);
    return outer1_7(onClose(4827).PressableOpacity, obj);
  };
  const items1 = [closure_7(onClose(5260).Header, obj), ];
  ...
  const items2 = [closure_7(onClose(4281).Text, obj3), ];
  ...
  obj4[5] = closure_7(onClose(4281).Text, { variant: "text-md/medium", children: formatResult });
  items2[1] = closure_7(onClose(4827).PressableOpacity, obj4);
  obj2[0] = items2;
  ...
  const items4 = [closure_7(onClose(4281).Text, obj6), ];
  ...
  obj7[5] = closure_7(onClose(4281).Text, { variant: "text-md/medium", children: formatResult1 });
  items4[1] = closure_7(onClose(4827).PressableOpacity, obj7);
  obj5[0] = items4;
