// Module ID: 10328
// Function ID: 10329
// Dependencies: [32, 19, 17, 21, 4344, 712, 1628, 3943, 1891, 1236, 4312, 9020, 2007, 5316, 8427, 500, 5309, 4886, 4340, 2]
...
const memoResult = importAllResult.memo((onClose) => {
  ...
  function handleOpenDatePicker(closure_5, arg1) {
    ...
    const obj2 = createReminder(4312);
    const tmp = dependencyMap;
    obj[1] = first.toDate();
    const tmp6 = tmp3(2007)(9020, dependencyMap.paths);
  ...
  obj[1] = function headerTitle() {
    ...
    const intl = onClose(1236).intl;
    obj[0] = intl.string(onClose(1236).t.VKsXpY);
    return callback(onClose(8427).GenericHeaderTitle, obj);
  };
  ...
  obj[4] = onClose(5309).getHeaderCloseButton(onClose);
  ...
  obj[7] = function headerRight() {
    ...
    obj[2] = outer1_7(onClose(4340).Text, obj);
    return outer1_7(onClose(4886).PressableOpacity, obj);
  };
  const items1 = [closure_7(onClose(5316).Header, obj), ];
  ...
  const items2 = [closure_7(onClose(4340).Text, obj3), ];
  ...
  obj4[5] = closure_7(onClose(4340).Text, { variant: "text-md/medium", children: formatResult });
  items2[1] = closure_7(onClose(4886).PressableOpacity, obj4);
  obj2[0] = items2;
  ...
  const items4 = [closure_7(onClose(4340).Text, obj6), ];
  ...
  obj7[5] = closure_7(onClose(4340).Text, { variant: "text-md/medium", children: formatResult1 });
  items4[1] = closure_7(onClose(4886).PressableOpacity, obj7);
  obj5[0] = items4;
