// Module ID: 11350
// Function ID: 11351
// Dependencies: [32, 19, 17, 21, 4444, 712, 1629, 4043, 1892, 1236, 4411, 9190, 2009, 5449, 8607, 500, 5442, 5015, 4440, 2]
...
const memoResult = importAllResult.memo((onClose) => {
  ...
  function handleOpenDatePicker(closure_5, arg1) {
    ...
    const obj2 = createReminder(4411);
    const tmp = dependencyMap;
    obj[1] = first.toDate();
    const tmp6 = tmp3(2009)(9190, dependencyMap.paths);
  ...
  obj[1] = function headerTitle() {
    ...
    const intl = onClose(1236).intl;
    obj[0] = intl.string(onClose(1236).t.VKsXpY);
    return callback(onClose(8607).GenericHeaderTitle, obj);
  };
  ...
  obj[4] = onClose(5442).getHeaderCloseButton(onClose);
  ...
  obj[7] = function headerRight() {
    ...
    obj[2] = closure_1_7(onClose(4440).Text, obj);
    return closure_1_7(onClose(5015).PressableOpacity, obj);
  };
  const items1 = [closure_7(onClose(5449).Header, obj), ];
  ...
  const items2 = [closure_7(onClose(4440).Text, obj3), ];
  ...
  obj4[5] = closure_7(onClose(4440).Text, { variant: "text-md/medium", children: formatResult });
  items2[1] = closure_7(onClose(5015).PressableOpacity, obj4);
  obj2[0] = items2;
  ...
  const items4 = [closure_7(onClose(4440).Text, obj6), ];
  ...
  obj7[5] = closure_7(onClose(4440).Text, { variant: "text-md/medium", children: formatResult1 });
  items4[1] = closure_7(onClose(5015).PressableOpacity, obj7);
  obj5[0] = items4;
