// Module ID: 10882
// Function ID: 10883
// Dependencies: [32, 19, 17, 21, 4661, 712, 1629, 3975, 1892, 1236, 4342, 8828, 2007, 6319, 8492, 500, 6314, 5433, 4734, 2]
...
const memoResult = importAllResult.memo((onClose) => {
  ...
  function handleOpenDatePicker(closure_5, arg1) {
    ...
    const obj2 = createReminder(4342);
    const tmp = dependencyMap;
    obj[1] = first.toDate();
    const tmp6 = tmp3(2007)(8828, dependencyMap.paths);
    obj[2] = createReminder(3975)().toDate();
    obj[3] = closure_5;
    obj[4] = dependencyMap;
    obj2.openLazy(tmp6, "DatePicker", obj);
  }
  let tmp = callback();
  const tmp4 = handleOpenDatePicker(importAllResult.useState(() => createReminder(3975)()), 2);
  first = tmp4[0];
  ...
  obj[1] = function headerTitle() {
    ...
    const intl = onClose(1236).intl;
    obj[0] = intl.string(onClose(1236).t.VKsXpY);
    return callback(onClose(8492).GenericHeaderTitle, obj);
  };
  ...
  obj[4] = onClose(6314).getHeaderCloseButton(onClose);
  ...
  const items2 = [closure_7(onClose(4734).Text, obj3), ];
  ...
  obj4[5] = closure_7(onClose(4734).Text, { variant: "text-md/medium", children: formatResult });
  items2[1] = closure_7(onClose(5433).PressableOpacity, obj4);
  obj2[0] = items2;
  ...
  const items4 = [closure_7(onClose(4734).Text, obj6), ];
  ...
  obj7[5] = closure_7(onClose(4734).Text, { variant: "text-md/medium", children: formatResult1 });
  items4[1] = closure_7(onClose(5433).PressableOpacity, obj7);
  obj5[0] = items4;
