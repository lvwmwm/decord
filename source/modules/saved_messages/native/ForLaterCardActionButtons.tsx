...
// Dependencies: [19, 17, 21, 4448, 4415, 11256, 2009, 11250, 11255, 1236, 11276, 5519, 12915, 10288, 8755, 7974, 8762, 2]
// Exports: default

// Module 12914 (ForLaterCardActionButtons)
...
export default function ForLaterCardActionButtons(savedMessage) {
  ...
  obj[1] = savedMessage(11276).ChatArrowRightIcon;
  ...
  obj = {
    ...
    IconComponent: tmp3(5519).XSmallIcon,
    action() {
  ...
  if (null == savedMessage.saveData.dueAt) {
    ...
    obj1[3] = function children(ref) {
      ...
      obj.size = "sm";
      obj.icon = jumpToMessage(8762);
      return callback(savedMessage(7974).IconButton, obj);
    };
    obj[1] = jsx(tmp3(8755).ContextMenu, { items: null, keyboardShouldPersistTaps: "handled", triggerOnTap: true, children: null });
    ...
    if (savedMessage.throttledNow > savedMessage.saveData.dueAt) {
      let PencilIcon = tmp3(12915).BellZIcon;
    } else {
      PencilIcon = tmp3(10288).PencilIcon;
    }
    obj2[1] = PencilIcon;
    obj2[2] = callback;
