...
// Dependencies: [5, 19, 17, 3929, 676, 21, 4303, 712, 5376, 7793, 4299, 1236, 7751, 4263, 10272, 10280, 4509, 698, 8381, 3883, 12564, 589, 12565, 12568, 12569, 12570, 2]

// Module 12563 (ForLaterDeletedMessageCard)
  ...
  if (null != savedMessage.message) {
    if (null != savedMessageChannel) {
      if (obj1.useStateFromStores(items1, () => {
        ...
        obj[1] = callback;
        obj[2] = throttledNow;
        const tmp8 = callback2(savedMessageChannel(12565), obj);
        ...
        if (null != savedMessage.saveData.dueAt) {
          ...
          obj1[1] = throttledNow;
          obj1[2] = tmp8;
          tmp6Result = tmp6(tmp2(12568).ForLaterCardReminderHeader, obj1);
        }
        ...
        obj2[1] = tmp12;
        items2[1] = callback2(tmp2(12569).ForLaterCardHeader, obj2);
        let obj3 = { style: null };
        ...
        obj4[1] = callback2(tmp2(12570).ForLaterMessageRow, obj5);
