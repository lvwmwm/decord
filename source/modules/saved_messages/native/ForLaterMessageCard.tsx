...
// Dependencies: [5, 19, 17, 3912, 676, 21, 4285, 712, 5356, 7716, 4281, 1236, 7672, 4245, 10189, 10197, 4490, 698, 8304, 3866, 12477, 589, 12478, 12481, 12482, 12483, 2]

// Module 12476 (ForLaterDeletedMessageCard)
  ...
  if (null != savedMessage.message) {
    if (null != savedMessageChannel) {
      if (obj1.useStateFromStores(items1, () => {
        ...
        obj[1] = callback;
        obj[2] = throttledNow;
        const tmp8 = callback2(savedMessageChannel(12478), obj);
        ...
        if (null != savedMessage.saveData.dueAt) {
          ...
          obj1[1] = throttledNow;
          obj1[2] = tmp8;
          tmp6Result = tmp6(tmp2(12481).ForLaterCardReminderHeader, obj1);
        }
        ...
        obj2[1] = tmp12;
        items2[1] = callback2(tmp2(12482).ForLaterCardHeader, obj2);
        let obj3 = { style: null };
        ...
        obj4[1] = callback2(tmp2(12483).ForLaterMessageRow, obj5);
        items2[3] = callback2(View, obj4);
        obj[5] = items2;
        return closure_11(tmp2(5356).Card, obj);
      }
    }
  }
