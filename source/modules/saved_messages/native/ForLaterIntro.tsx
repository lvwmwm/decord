...
// Function ID: 12500
// Name: IntroDemo
// Dependencies: [17, 5397, 21, 4302, 712, 8321, 12500, 4298, 1236, 12501, 10209, 4266, 5718, 2]
// Exports: default

// Module 12499 (IntroDemo)
...
function IntroDemo(isReminder) {
  ...
  const items1 = [callback(require(4298) /* Text */.Text, obj3), , , ];
  ...
  items1[2] = callback(require(4298) /* Text */.Text, obj5);
  ...
  items1[3] = callback(require(4298) /* Text */.Text, obj6);
  obj2[1] = items1;
  ...
  const obj9 = { icon: require(10209) /* BookmarkIcon */.BookmarkIcon, label: null, highlighted: null };
  const intl5 = require(1236) /* getSystemLocale */.intl;
  obj9[1] = intl5.string(require(1236) /* getSystemLocale */.t.tpxJto);
  obj9[2] = !isReminder;
  items3[1] = callback(SheetRow, obj9);
  const obj10 = { icon: require(4266) /* ClockIcon */.ClockIcon, label: null, highlighted: null, hasArrow: true };
...
function SheetRow(hasArrow) {
  ...
  if (flag) {
    ...
    tmp5Result = callback(require(5718) /* ChevronSmallRightIcon */.ChevronSmallRightIcon, obj1);
  }
  items1[2] = tmp5Result;
  obj[1] = items1;
...
export default function ForLaterIntro(type) {
  const tmp = callback3();
  const tmp4 = type.type === require(8321) /* SavedMessageSortTypes */.SavedMessageSortTypes.REMINDER;
  let obj = { style: tmp.scrollView, contentContainerStyle: tmp.pageContainer, children: null };
  obj = { style: tmp.container, children: null };
  obj = { source: importDefault(12500), style: tmp.upsellImage };
  const items = [callback(closure_3, obj), , ];
  ...
  const items1 = [callback(require(4298) /* Text */.Heading, obj2), ];
