...
// Function ID: 12635
// Name: IntroDemo
// Dependencies: [17, 5438, 21, 4342, 712, 8428, 12635, 4338, 1236, 12636, 11158, 4306, 5818, 2]
// Exports: default

// Module 12634 (IntroDemo)
...
function IntroDemo(isReminder) {
  ...
  items1[2] = callback(require(4338) /* Text */.Text, obj5);
  ...
  items1[3] = callback(require(4338) /* Text */.Text, obj6);
  obj2[1] = items1;
  ...
  const obj9 = { icon: require(11158) /* BookmarkIcon */.BookmarkIcon, label: null, highlighted: null };
  const intl5 = require(1236) /* getSystemLocale */.intl;
  obj9[1] = intl5.string(require(1236) /* getSystemLocale */.t.tpxJto);
  obj9[2] = !isReminder;
  items3[1] = callback(SheetRow, obj9);
  const obj10 = { icon: require(4306) /* ClockIcon */.ClockIcon, label: null, highlighted: null, hasArrow: true };
...
function SheetRow(hasArrow) {
  ...
  if (flag) {
    ...
    tmp5Result = callback(require(5818) /* ChevronSmallRightIcon */.ChevronSmallRightIcon, obj1);
  }
  items1[2] = tmp5Result;
  obj[1] = items1;
...
export default function ForLaterIntro(type) {
  const tmp = callback3();
  const tmp4 = type.type === require(8428) /* SavedMessageSortTypes */.SavedMessageSortTypes.REMINDER;
  let obj = { style: tmp.scrollView, contentContainerStyle: tmp.pageContainer, children: null };
  obj = { style: tmp.container, children: null };
  obj = { source: importDefault(12635), style: tmp.upsellImage };
  const items = [callback(closure_3, obj), , ];
  ...
  const items1 = [callback(require(4338) /* Text */.Heading, obj2), ];
