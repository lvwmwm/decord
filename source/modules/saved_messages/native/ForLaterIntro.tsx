...
// Function ID: 12485
// Name: IntroDemo
// Dependencies: [17, 5378, 21, 4285, 712, 8304, 12485, 4281, 1236, 12486, 10193, 4249, 5699, 2]
// Exports: default

// Module 12484 (IntroDemo)
...
function IntroDemo(isReminder) {
  ...
  const obj9 = { icon: require(10193) /* BookmarkIcon */.BookmarkIcon, label: null, highlighted: null };
...
function SheetRow(hasArrow) {
  ...
  if (flag) {
    ...
    tmp5Result = callback(require(5699) /* ChevronSmallRightIcon */.ChevronSmallRightIcon, obj1);
  }
  items1[2] = tmp5Result;
  obj[1] = items1;
...
export default function ForLaterIntro(type) {
  const tmp = callback3();
  const tmp4 = type.type === require(8304) /* SavedMessageSortTypes */.SavedMessageSortTypes.REMINDER;
  let obj = { style: tmp.scrollView, contentContainerStyle: tmp.pageContainer, children: null };
  obj = { style: tmp.container, children: null };
  obj = { source: importDefault(12485), style: tmp.upsellImage };
  const items = [callback(closure_3, obj), , ];
