...
// Function ID: 11097
// Name: getTimeSafe
// Dependencies: [1922, 3985, 8428, 4564, 589, 709, 2]
// Exports: getComparator

// Module 11096 (getTimeSafe)
...
const secondaryIndexMap = new require("version").SecondaryIndexMap((saveData) => {
  const items = [require(8428) /* SavedMessageSortTypes */.SavedMessageSortTypes.ALL, ];
  if (null != saveData.saveData.dueAt) {
    let BOOKMARK = tmp(8428).SavedMessageSortTypes.REMINDER;
  } else {
    BOOKMARK = tmp(8428).SavedMessageSortTypes.BOOKMARK;
  }
  items[1] = BOOKMARK;
  return items;
}, (saveData) => {
...
prototype["getSavedMessages"] = function getSavedMessages() {
  return secondaryIndexMap.values(require(8428) /* SavedMessageSortTypes */.SavedMessageSortTypes.ALL);
};
...
prototype["getMessageBookmarks"] = function getMessageBookmarks() {
  return secondaryIndexMap.values(require(8428) /* SavedMessageSortTypes */.SavedMessageSortTypes.BOOKMARK);
};
prototype["getMessageReminders"] = function getMessageReminders() {
  return secondaryIndexMap.values(require(8428) /* SavedMessageSortTypes */.SavedMessageSortTypes.REMINDER);
};
...
prototype["getMostRecentOverdueDueAt"] = function getMostRecentOverdueDueAt() {
  ...
  const values = secondaryIndexMap.values(require(8428) /* SavedMessageSortTypes */.SavedMessageSortTypes.REMINDER);
    ...
    if (null != message.id) {
      if (null != message.channel_id) {
        ...
        if (null == message) {
          ...
          const obj = {};
          const merged = Object.assign(value);
          obj.message = require(4564) /* createMinimalMessageRecord */.updateMessageRecord(value.message, message);
