...
// Dependencies: [9936, 4225, 9304, 3, 9938, 9939, 2]
// Exports: createSound, createSoundForPack, playSound

// Module 9935 (createSoundForPack)
import timestampDefault from "timestamp" /* 3 */;
import getSoundPackDefault from "getSoundPack" /* 9938 */;
import _createSound from "_createSound" /* 9939 */;
import closure_3 from "Soundpacks" /* 9936 */;
import closure_4 from "initialize" /* 4225 */;
import { SoundOutputChannel } from "SoundOutputChannel" /* 9304 */;
...
export const playSound = function playSound(arg0, arg1, arg2, arg3, outputChannel) {
  ...
  if (!disableSounds.disableSounds) {
    ...
    const mobileAudioSound = new _require(9939).MobileAudioSound(tmp13, arg0, num, outputChannel, flag);
    if (null != arg2) {
