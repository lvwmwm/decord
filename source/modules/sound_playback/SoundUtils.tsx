...
// Function ID: 78986
// Name: createSound
// Dependencies: [10210, 3971, 8771, 3, 10212, 10213, 2]
// Exports: createSoundForPack, playSound

// Module 10209 (createSound)
...
function createSound(stage_waiting, soundboard_sound, _volume, DEFAULT, flag) {
  ...
  const mobileAudioSound = new require(10213) /* RNSound */.MobileAudioSound(stage_waiting, soundboard_sound, num, DEFAULT, flag);
...
export const createSoundForPack = function createSoundForPack(call_calling, soundpack) {
  ...
  const tmp3 = importDefault(10212)(soundpack)[call_calling];
...
export const playSound = function playSound(arg0, arg1, arg2, arg3, outputChannel) {
  ...
  if (!disableSounds.disableSounds) {
    ...
    const tmp3Result = importDefault(10212)(soundpack);
    if (null == tmp3Result) {
