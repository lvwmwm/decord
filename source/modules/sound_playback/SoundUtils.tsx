...
// Dependencies: [10268, 4029, 8835, 3, 10270, 10271, 2]
// Exports: createSound, createSoundForPack, playSound

// Module 10267 (createSoundForPack)
...
export const createSoundForPack = function createSoundForPack(call_calling, soundpack) {
  ...
  let tmp3 = importDefault(10270)(soundpack)[call_calling];
  if (tmp3 == null) {
    tmp3 = call_calling;
  }
  if (num === undefined) {
  ...
  const mobileAudioSound = new require(10271) /* _createSound */.MobileAudioSound(tmp3, call_calling, num, DEFAULT, false);
...
export const createSound = function createSound(stage_waiting, soundboard_sound, arg2) {
  ...
  const mobileAudioSound = new require(10271) /* _createSound */.MobileAudioSound(stage_waiting, soundboard_sound, num, DEFAULT, flag);
  return mobileAudioSound;
};
export const playSound = function playSound(arg0, arg1, arg2, arg3, outputChannel) {
  ...
  if (!disableSounds.disableSounds) {
    ...
    const tmp4Result = importDefault(10270)(soundpack);
    if (null == tmp4Result) {
    ...
    const mobileAudioSound = new _require(10271).MobileAudioSound(tmp13, arg0, num, outputChannel, flag);
    if (null != arg2) {
