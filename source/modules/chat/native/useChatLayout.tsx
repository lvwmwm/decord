...
export const getChatLayout = function getChatLayout() {
  let obj = require(4162) /* useWindowSizeClassifier */;
  const windowSizeClassifier = obj.getWindowSizeClassifier();
  obj = { isChatBesideChannelList: windowSizeClassifier >= require(4162) /* useWindowSizeClassifier */.WindowSizeClassifier.LARGE, isChatLockedOpen: windowSizeClassifier >= require(4162) /* useWindowSizeClassifier */.WindowSizeClassifier.XLARGE };
  return obj;
};
