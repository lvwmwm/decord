...
// Function ID: 11432
// Name: ChatTTITracker
// Dependencies: [21, 11363, 9, 2]
// Exports: ChatTTITracker

// Module 11431 (ChatTTITracker)
...
export const ChatTTITracker = function ChatTTITracker(messages) {
  ...
  if (messages.length > 0) {
    ...
    tmp3 = callback(require(11363) /* TTIMeasurementView */.TTIMeasurementView, obj, "cached_messages_tti");
  }
  const children = [tmp3, ];
  if (messages.hasFetched) {
    ...
    let tmp7 = callback(require(11363) /* TTIMeasurementView */.TTIMeasurementView, obj, "latest_messages_tti");
  } else {
    tmp7 = null;
    if (messages.ready) {
      tmp7 = null;
