...
// Function ID: 11361
// Name: DCDChatList
// Dependencies: [19, 4334, 21, 4342, 1367, 5488, 11361, 11362, 589, 10999, 2]

// Module 11360 (DCDChatList)
...
function DCDChatList() {
  ...
  const tmp = callback3();
  obj[2] = callback(require(11362) /* TTIFirstContentfulPaint */.TTIFirstContentfulPaint, { label: "chat_list_android" });
  obj[1] = callback(importDefault(11361), obj);
...
const forwardRefResult = importAllResult.forwardRef((children, ref) => {
  ...
  obj.children = items1;
  return callback2(importDefault(10999), obj);
});
