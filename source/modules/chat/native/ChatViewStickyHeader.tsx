...
// Dependencies: [57, 31, 10138, 33, 10407, 10411, 10412, 10413, 10423, 10430, 10431, 10433, 10435, 10438, 2]

// Module 10406 (ChatViewStickyHeaderAccountSafetyWarnings)
...
function ChatViewStickyHeaderAccountSafetyWarnings(arg0) {
  ...
  let obj = require(10407) /* useStrangerDangerWarning */;
  const strangerDangerWarning = obj.useStrangerDangerWarning(channelId);
  let obj1 = require(10411) /* useInappropriateConversationBannerForChannel */;
  ...
  if (null != likelyAtoWarning) {
    ...
    if (null != inappropriateConversationBannerForChannel) {
      ...
      tmp4 = callback2(importDefault(10430), obj1);
    }
  }
  return tmp4;
}
...
const memoResult = importAllResult.memo(importAllResult.forwardRef((handleScrollToNewMessages) => {
  ...
  ({ showUnreadsNotice, clearUnreadsNotice } = importDefault(10431)(channel));
  ...
  if (channel.isForumPost()) {
    ...
    if (tmp[0]) {
      obj = { channel };
      tmp6 = callback2(importDefault(10433), obj);
    }
  }
  const items = [tmp6, , , ];
  let tmp10 = null;
  ...
  if (showUnreadsNotice) {
    ...
    tmp13 = callback2(importDefault(10435), obj1);
  }
  items[2] = tmp13;
  items[3] = callback2(importDefault(10438), { channel, handleScrollToNewMessages: handleScrollToNewMessages.scrollToNewMessages });
  obj.children = items;
