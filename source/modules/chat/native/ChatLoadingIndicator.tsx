...
// Module 10109 (openLoadingIndicatorDebugBody)
...
let obj = { container: { "Bool(false)": "safety_user_sentiment_notice_dismissed_at", "Bool(false)": "message", "Bool(false)": null } };
obj = { hideWhenScrolling: 800, autoCapitalize: 16, borderRadius: importDefault(dependencyMap[12]).radii.round, backgroundColor: importDefault(dependencyMap[12]).colors.BACKGROUND_BRAND };
obj.pulse = obj;
...
let closure_17 = importAllResult.memo(() => {
  ...
  const stateFromStoresObject = obj.useStateFromStoresObject(items, () => {
    ...
    if (null == channelId) {
      let obj = { GUILD_EMOJIS: true, recentApplicationCommandMetadata: true, connected: isConnectedResult };
      return obj;
    } else {
...
export const ChannelHeaderLoadingIndicator = function ChannelHeaderLoadingIndicator() {
  ...
  obj1 = { cachedAt: "center", edpbxy: "center" };
