...
// Dependencies: [32, 19, 17, 4336, 5034, 4561, 1979, 1922, 6917, 676, 21, 4344, 712, 4683, 4772, 2007, 589, 4340, 12613, 4083, 4345, 1236, 4886, 2]
// Exports: ChannelHeaderLoadingIndicator, useShouldChannelShowLoadingIndicator

// Module 12612 (openLoadingIndicatorDebugBody)
...
let closure_18 = importAllResult.memo(() => {
  ...
  obj[2] = str4;
  items1[3] = closure_13(require(4340) /* Text */.Text, obj);
  let tmp4Result = null;
  ...
  obj1[2] = str7;
  items4[3] = closure_13(require(4340) /* Text */.Text, obj1);
  tmp4Result = null;
  ...
  obj3[2] = str11;
  items6[3] = closure_13(require(4340) /* Text */.Text, obj3);
