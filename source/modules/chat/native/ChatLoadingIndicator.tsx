...
// Dependencies: [32, 19, 17, 4277, 4975, 4502, 1960, 1903, 6797, 676, 21, 4285, 712, 4624, 4713, 1988, 589, 4281, 12463, 4145, 4286, 1236, 4827, 2]
// Exports: ChannelHeaderLoadingIndicator, useShouldChannelShowLoadingIndicator

// Module 12462 (openLoadingIndicatorDebugBody)
...
export const ChannelHeaderLoadingIndicator = function ChannelHeaderLoadingIndicator() {
  ...
  const items3 = [callback2(importDefault(4145).View, { style: items2 }), ];
