...
// Dependencies: [19, 676, 21, 4255, 4598, 7688, 1236, 1945, 4598, 2]
// Exports: default

// Module 12944 (ProvisionalAccountNoCallAllowed)
import "noop";
...
export default function ProvisionalAccountNoCallAllowed() {
  ...
  obj[0] = jsx(require(7688) /* CircleErrorIcon */.CircleErrorIcon, { size: "lg", style: callback().header });
  ...
  obj1[0] = jsx(require(4598) /* getAlertModalItemKey */.AlertActionButton, { variant: "secondary", text: null }, "got-it");
  obj[3] = jsx(require(4598) /* getAlertModalItemKey */.AlertActions, { children: null });
  return jsx(require(4598) /* getAlertModalItemKey */.AlertModal, { helpdeskArticle: null });
};
