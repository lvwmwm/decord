...
// Dependencies: [19, 676, 21, 4342, 4710, 7859, 1236, 1993, 4710, 2]
// Exports: default

// Module 13145 (ProvisionalAccountNoCallAllowed)
import "noop";
...
export default function ProvisionalAccountNoCallAllowed() {
  ...
  obj[0] = jsx(require(7859) /* CircleErrorIcon */.CircleErrorIcon, { size: "lg", style: callback().header });
  ...
  obj1[0] = jsx(require(4710) /* getAlertModalItemKey */.AlertActionButton, { variant: "secondary", text: null }, "got-it");
  obj[3] = jsx(require(4710) /* getAlertModalItemKey */.AlertActions, { children: null });
  return jsx(require(4710) /* getAlertModalItemKey */.AlertModal, { helpdeskArticle: null });
};
