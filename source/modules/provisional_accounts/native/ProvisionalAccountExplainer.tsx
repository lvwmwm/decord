...
// Dependencies: [19, 17, 21, 4342, 712, 12047, 12048, 5416, 4338, 1236, 7838, 5815, 2]
// Exports: ChatProvisionalAccountExplainerCard, UserProfileProvisionalAccountExplainerCard

// Module 12046 (ChatProvisionalAccountExplainerCard)
...
export const ChatProvisionalAccountExplainerCard = function ChatProvisionalAccountExplainerCard(iconSize) {
  ...
  const items2 = [callback(iconSize(4338).Text, obj1), callback(iconSize(7838).CircleErrorIcon, { size: "xs", color: "text-default" })];
  obj[1] = items2;
  ...
  obj[1] = items3;
  return callback2(iconSize(5416).Card, obj);
};
