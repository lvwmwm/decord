...
// Dependencies: [32, 19, 4773, 7291, 8664, 4231, 4229, 4230, 4232, 2]
// Exports: isChannelFocused, isChannelFocusedForReadStateAck, useIsChannelFocused

// Module 10023 (getFocusedChannelId)
...
function getFocusedChannelId() {
  ...
  const isChatLockedOpen = require(4232) /* useChatLayout */.getChatLayout().isChatLockedOpen;
  let tmp2 = null;
  ...
  if (tmp2 !== c9) {
    ...
    const tmp19 = importDefault(4231)();
...
export const useIsChannelFocused = function useIsChannelFocused() {
  ...
  let closure_0 = tmp[1];
  const items = [importDefault(4232)()];
