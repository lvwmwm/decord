...
// Module 5604 (_isNativeReflectConstruct)
...
function handleOverlayInitialize(messageRequestChannelIds) {
  ...
  const item = prop.forEach((arg0) => outer1_6.add(arg0));
}
let set = new Set();
const set1 = new Set();
let c8 = false;
...
tmp5 = new tmp5();
let result = set.fileFinishedImporting("modules/message_request/MessageRequestStore.tsx");
