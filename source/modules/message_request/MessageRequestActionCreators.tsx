...
// Dependencies: [5, 676, 530, 9664, 709, 5767, 2]
...
// Module 9663 (_acceptMessageRequest)
...
export const clearMessageRequestState = function clearMessageRequestState(id) {
  ...
  obj = { consent_status: require(9664) /* MessageRequestConsentStatusTypes */.MessageRequestConsentStatusTypes.UNSPECIFIED };
  obj[1] = obj;
...
export const markAsMessageRequest = function markAsMessageRequest(id) {
  const HTTP = require(530) /* sendRequest */.HTTP;
  let obj = { url: Endpoints.CHANNEL_RECIPIENT_ME(id), body: null, rejectWithError: null };
  obj = { consent_status: require(9664) /* MessageRequestConsentStatusTypes */.MessageRequestConsentStatusTypes.PENDING };
  obj[1] = obj;
  obj[2] = require(530) /* sendRequest */.rejectWithMigratedError();
  return HTTP.put(obj);
};
...
export const fetchUserCountryCode = function fetchUserCountryCode() {
  const locationMetadata = importDefault(5767).getLocationMetadata();
};
