...
// Dependencies: [32, 19, 17, 1372, 4472, 1874, 21, 4255, 712, 1581, 589, 15821, 15823, 11684, 2]
// Exports: default

// Module 15820 (RestrictedMessageRequestPreview)
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [callback(tmp2(15821), obj1), ];
      obj2 = { channelId: null };
      obj2[0] = channelId;
      items8[1] = callback(tmp2(15823), obj2);
      obj[5] = items8;
      ...
      obj3[1] = callback(tmp2(11684), obj5);
