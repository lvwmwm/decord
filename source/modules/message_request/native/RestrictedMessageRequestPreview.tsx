...
// Dependencies: [32, 19, 17, 1391, 4623, 1922, 21, 4380, 712, 1629, 589, 16242, 16244, 11999, 2]
// Exports: default

// Module 16241 (RestrictedMessageRequestPreview)
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [callback(tmp2(16242), obj1), ];
      obj2 = { channelId: null };
      obj2[0] = channelId;
      items8[1] = callback(tmp2(16244), obj2);
      obj[5] = items8;
      ...
      obj3[1] = callback(tmp2(11999), obj5);
