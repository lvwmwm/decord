...
// Dependencies: [57, 31, 27, 1348, 4350, 1850, 33, 4131, 689, 1557, 566, 15637, 15639, 11468, 2]
// Exports: default

// Module 15636 (RestrictedMessageRequestPreview)
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [callback(ref(15637), obj1), ];
      obj2 = { channelId };
      items8[1] = callback(ref(15639), obj2);
      obj.children = items8;
      ...
      obj3.children = callback(ref(11468), obj5);
