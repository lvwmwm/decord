...
// Dependencies: [32, 19, 17, 1372, 4521, 1903, 21, 4303, 712, 1609, 589, 15960, 15962, 11799, 2]
// Exports: default

// Module 15959 (RestrictedMessageRequestPreview)
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [callback(tmp2(15960), obj1), ];
      obj2 = { channelId: null };
      obj2[0] = channelId;
      items8[1] = callback(tmp2(15962), obj2);
      obj[5] = items8;
      ...
      obj3[1] = callback(tmp2(11799), obj5);
