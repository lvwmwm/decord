...
// Dependencies: [32, 19, 17, 1372, 4502, 1903, 21, 4285, 712, 1609, 589, 15861, 15863, 11718, 2]
// Exports: default

// Module 15860 (RestrictedMessageRequestPreview)
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [callback(tmp2(15861), obj1), ];
      obj2 = { channelId: null };
      obj2[0] = channelId;
      items8[1] = callback(tmp2(15863), obj2);
      obj[5] = items8;
      const items9 = [closure_11(closure_5, obj), ];
      const obj3 = { style: null, children: null };
      const items10 = [tmp.footer, ];
      const obj4 = { paddingBottom: null };
      obj4[0] = tmp2(712).space.PX_8 + ref(1609)().bottom;
      items10[1] = obj4;
      obj3[0] = items10;
      const obj5 = { channel: null };
      obj5[0] = stateFromStores;
      obj3[1] = callback(tmp2(11718), obj5);
