...
// Dependencies: [32, 19, 17, 1372, 4519, 1903, 21, 4302, 712, 1609, 589, 15885, 15887, 11733, 2]
// Exports: default

// Module 15884 (RestrictedMessageRequestPreview)
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [callback(tmp2(15885), obj1), ];
      obj2 = { channelId: null };
      obj2[0] = channelId;
      items8[1] = callback(tmp2(15887), obj2);
      obj[5] = items8;
      ...
      obj3[1] = callback(tmp2(11733), obj5);
