...
// Dependencies: [57, 31, 27, 1348, 4350, 1850, 33, 4131, 689, 1557, 566, 15649, 15651, 11469, 2]
// Exports: default

// Module 15648 (RestrictedMessageRequestPreview)
...
export default function RestrictedMessageRequestPreview(channelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != stateFromStores1) {
      ...
      const items8 = [callback(ref(15649), obj1), ];
      obj2 = { channelId };
      items8[1] = callback(ref(15651), obj2);
      obj.children = items8;
      ...
      obj3.children = callback(ref(11469), obj5);
