...
// Dependencies: [32, 19, 17, 1922, 21, 4342, 712, 589, 11865, 4062, 1236, 8494, 4310, 5437, 5436, 5805, 8012, 4755, 2]
// Exports: default

// Module 11870 (SpamMessageRequestHamActionSheet)
...
export default function SpamMessageRequestHamActionSheet(arg0) {
  ...
  let obj1 = require(11865) /* useMessageRequestActions */;
  obj = {
  ...
  obj1[1] = callback(require(5805) /* ActionSheetCloseButton */.ActionSheetCloseButton, {
    onPress() {
  ...
  obj1[2] = tmp.header;
  const items1 = [callback(require(5436) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj1), ];
  ...
  const items2 = [callback(require(8012) /* Form */.FormSwitchRow, obj4), ];
  ...
  obj[1] = items1;
  return closure_8(require(5437) /* Background */.BottomSheet, obj);
};
