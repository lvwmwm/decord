...
// Dependencies: [32, 19, 17, 1903, 21, 4302, 712, 589, 11736, 4002, 1236, 8385, 4270, 5396, 5395, 5705, 7907, 4712, 2]
// Exports: default

// Module 11741 (SpamMessageRequestHamActionSheet)
...
export default function SpamMessageRequestHamActionSheet(arg0) {
  ...
  let obj1 = require(11736) /* useMessageRequestActions */;
  obj = {
  ...
  obj1[1] = callback(require(5705) /* ActionSheetCloseButton */.ActionSheetCloseButton, {
    onPress() {
  ...
  obj1[2] = tmp.header;
  const items1 = [callback(require(5395) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj1), ];
  ...
  const items2 = [callback(require(7907) /* Form */.FormSwitchRow, obj4), ];
  ...
  obj[1] = items1;
  return closure_8(require(5396) /* Background */.BottomSheet, obj);
};
