...
// Dependencies: [32, 19, 17, 21, 4342, 16056, 712, 4887, 4338, 1236, 2]
// Exports: default

// Module 16058 (RestrictedBlockedMessageGroup)
...
export default function RestrictedBlockedMessageGroup(arg0) {
  ...
  const children = [callback2(require(4887) /* PressableBase */.PressableOpacity, obj), ];
  if (mapped) {
