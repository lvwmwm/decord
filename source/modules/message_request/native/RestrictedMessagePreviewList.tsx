...
// Function ID: 16047
// Name: HiddenMedia
// Dependencies: [19, 17, 4562, 21, 4342, 16047, 712, 4851, 4338, 1236, 4298, 4031, 5768, 589, 8832, 8086, 16048, 8638, 4887, 16049, 2]
// Exports: default

// Module 16046 (HiddenMedia)
...
function HiddenMedia(length) {
  ...
  const items1 = [callback(_require(4298).CircleInformationIcon, { size: "sm", color: "text-muted" }), ];
  ...
  items1[1] = callback(_require(4338).Text, obj);
  obj[1] = items1;
