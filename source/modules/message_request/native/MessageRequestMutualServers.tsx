...
// Dependencies: [19, 17, 21, 4255, 5632, 15794, 1236, 11828, 4251, 4783, 2]
// Exports: default

// Module 15793 (MessageRequestMutualServers)
import "noop";
...
export default function MessageRequestMutualServers(textVariant) {
  ...
  if (iconSize === undefined) {
    iconSize = iconSize(5632).GuildIconSizes.XXSMALL_12;
  }
  ...
  if (tmp9) {
    ...
    tmp9 = callback(tmp4(11828).GuildIconPile, obj1);
  }
  const items1 = [tmp9, ];
  ...
  if (null != onPress) {
    ...
    if (length > 0) {
      ...
      obj3[1] = onPress;
      obj3[2] = tmp7Result;
      tmp11Result = tmp11(tmp4(4783).PressableOpacity, obj3);
    }
  }
  return tmp11Result;
};
