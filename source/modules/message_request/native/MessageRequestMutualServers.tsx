...
// Dependencies: [19, 17, 21, 4303, 5779, 15953, 1236, 11975, 4299, 4846, 2]
// Exports: default

// Module 15952 (MessageRequestMutualServers)
import "noop";
...
export default function MessageRequestMutualServers(textVariant) {
  ...
  if (iconSize === undefined) {
    iconSize = iconSize(5779).GuildIconSizes.XXSMALL_12;
  }
  ...
  if (tmp9) {
    ...
    tmp9 = callback(tmp4(11975).GuildIconPile, obj1);
  }
  const items1 = [tmp9, ];
  ...
  obj2[4] = combined;
  items1[1] = callback(iconSize(4299).Text, obj2);
  obj[1] = items1;
  ...
  if (null != onPress) {
    ...
    if (length > 0) {
      ...
      obj3[1] = onPress;
      obj3[2] = tmp7Result;
      tmp11Result = tmp11(tmp4(4846).PressableOpacity, obj3);
    }
  }
  return tmp11Result;
};
