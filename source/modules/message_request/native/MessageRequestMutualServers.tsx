...
// Dependencies: [19, 17, 21, 4285, 5661, 15824, 1236, 11887, 4281, 4812, 2]
// Exports: default

// Module 15823 (MessageRequestMutualServers)
import "noop";
...
export default function MessageRequestMutualServers(textVariant) {
  ...
  if (iconSize === undefined) {
    iconSize = iconSize(5661).GuildIconSizes.XXSMALL_12;
  }
  ...
  if (tmp9) {
    ...
    tmp9 = callback(tmp4(11887).GuildIconPile, obj1);
  }
  const items1 = [tmp9, ];
  ...
  if (null != onPress) {
    ...
    if (length > 0) {
      ...
      obj3[1] = onPress;
      obj3[2] = tmp7Result;
      tmp11Result = tmp11(tmp4(4812).PressableOpacity, obj3);
    }
  }
  return tmp11Result;
};
