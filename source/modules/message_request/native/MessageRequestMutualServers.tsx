...
// Dependencies: [19, 17, 21, 4342, 5819, 16037, 1236, 12037, 4338, 4887, 2]
// Exports: default

// Module 16036 (MessageRequestMutualServers)
import "noop";
...
export default function MessageRequestMutualServers(textVariant) {
  ...
  if (tmp9) {
    ...
    tmp9 = callback(tmp4(12037).GuildIconPile, obj1);
  }
  const items1 = [tmp9, ];
  ...
  obj2[4] = combined;
  items1[1] = callback(iconSize(4338).Text, obj2);
  obj[1] = items1;
