...
// Dependencies: [19, 17, 21, 4303, 5779, 15944, 1236, 11974, 4299, 4846, 2]
// Exports: default

// Module 15943 (MessageRequestMutualServers)
import "noop";
...
export default function MessageRequestMutualServers(textVariant) {
  ...
  if (tmp9) {
    ...
    tmp9 = callback(tmp4(11974).GuildIconPile, obj1);
  }
  const items1 = [tmp9, ];
