...
// Dependencies: [19, 17, 21, 4302, 5719, 15869, 1236, 11908, 4298, 4844, 2]
// Exports: default

// Module 15868 (MessageRequestMutualServers)
import "noop";
...
export default function MessageRequestMutualServers(textVariant) {
  ...
  if (iconSize === undefined) {
    iconSize = iconSize(5719).GuildIconSizes.XXSMALL_12;
  }
  ...
  if (tmp9) {
    ...
    tmp9 = callback(tmp4(11908).GuildIconPile, obj1);
  }
  const items1 = [tmp9, ];
  ...
  obj2[4] = combined;
  items1[1] = callback(iconSize(4298).Text, obj2);
  obj[1] = items1;
  ...
  if (null != onPress) {
    ...
    if (length > 0) {
      ...
      obj3[1] = onPress;
      obj3[2] = tmp7Result;
      tmp11Result = tmp11(tmp4(4844).PressableOpacity, obj3);
    }
  }
  return tmp11Result;
};
