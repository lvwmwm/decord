...
// Module 16378 (getGuildPermissionSpec)
...
export const generateGuildPermissionSpec = function generateGuildPermissionSpec(showCreatorMonetizationAnalyticsPermission) {
  ...
  obj[0] = intl.string(_require(1236).t["mYck+B"]);
  _require = tmp;
  ...
  obj[0] = intl2.string(_require(1236).t.Ny49TN);
  _require = tmp;
  ...
  obj[0] = intl3.string(_require(1236).t.cKobO5);
  _require = tmp;
  ...
  obj1[0] = intl4.string(_require(1236).t["46Ra1b"]);
  _require = tmp;
  ...
  obj2[0] = intl5.string(_require(1236).t["rrh/W6"]);
  _require = tmp;
  ...
  obj4[0] = intl7.string(_require(1236).t.b8lplT);
  const items7 = [, ];
  ...
  obj5[0] = intl8.string(_require(1236).t["3uI5CX"]);
...
export const generateChannelAppsSection = function generateChannelAppsSection(arg0, intl15, arg2) {
  ...
  const found = items.filter(_require(1471).isNotNullish);
  _require = arg0;
  obj[1] = found.map((arg0) => table[arg0.toString(arg0)]);
  return obj;
};
