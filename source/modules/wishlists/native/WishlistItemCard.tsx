...
// Dependencies: [19, 676, 21, 8136, 10023, 10025, 10026, 2]
// Exports: default

// Module 10022 (WishlistItemCard)
import "noop";
...
export default function WishlistItemCard(arg0) {
  ...
  if (SKUProductLines.COLLECTIBLES === productLine) {
    ...
    return jsx(importDefault(10023), { sku: null, isOwned: null, source: null, wishlistOwnerId: null });
  } else if (tmp5.PREMIUM === productLine) {
    obj = { sku: null, source: null };
    obj[0] = sku;
    obj[1] = source;
    const merged2 = Object.assign(merged);
    return jsx(importDefault(10025), { sku: null, source: null });
    ...
    if (tmp4) {
      ...
      tmp6 = jsx(importDefault(10026), { sku: null, isOwned: null, source: null, wishlistOwnerId: null });
      const tmp9 = importDefault(10026);
    }
    return tmp6;
  } else {
    return null;
