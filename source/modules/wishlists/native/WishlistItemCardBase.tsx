...
// Function ID: 68466
// Name: SourceIcon
// Dependencies: [31, 27, 33, 4165, 689, 3866, 8647, 3877, 8057, 3869, 8649, 1212, 1327, 8667, 2]
// Exports: default

// Module 8646 (SourceIcon)
import "result";
...
function SourceIcon(toastText) {
  ...
  obj.children = callback(toastText(8647).HeartIcon, obj);
...
export default function WishlistItemCardBase(username) {
  ...
  let obj1 = require(8057) /* useUserProfileColors */;
  ...
  items[2] = obj1;
  let tmp3 = source === require(8649) /* _createForOfIteratorHelperLoose */.WishlistItemSource.WISHLIST;
  ...
  obj2.children = callback(require(8667) /* CheckmarkLargeBoldIcon */.CheckmarkLargeBoldIcon, obj3);
  const obj4 = {};
  const obj5 = {};
