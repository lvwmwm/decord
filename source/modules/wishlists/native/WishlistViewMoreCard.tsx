...
// Dependencies: [19, 17, 21, 4255, 712, 1236, 9991, 4251, 2]
// Exports: default

// Module 9996 (WishlistViewMoreCard)
import "noop";
...
export default function WishlistViewMoreCard(recipientName) {
  ...
  const items = [callback(importDefault(9991), { accessibilityHidden: true, sku, size, recipientName }), ];
