...
// Dependencies: [19, 17, 21, 4302, 712, 1236, 10038, 4298, 2]
// Exports: default

// Module 10043 (WishlistViewMoreCard)
import "noop";
...
export default function WishlistViewMoreCard(recipientName) {
  ...
  const items = [callback(importDefault(10038), { accessibilityHidden: true, sku, size, recipientName }), ];
