...
// Dependencies: [19, 17, 21, 4285, 712, 1236, 10020, 4281, 2]
// Exports: default

// Module 10025 (WishlistViewMoreCard)
import "noop";
...
export default function WishlistViewMoreCard(recipientName) {
  ...
  const items = [callback(importDefault(10020), { accessibilityHidden: true, sku, size, recipientName }), ];
