...
// Dependencies: [19, 17, 21, 4285, 712, 1236, 10022, 4281, 2]
// Exports: default

// Module 10027 (WishlistViewMoreCard)
import "noop";
...
export default function WishlistViewMoreCard(recipientName) {
  ...
  const items = [callback(importDefault(10022), { accessibilityHidden: true, sku, size, recipientName }), ];
