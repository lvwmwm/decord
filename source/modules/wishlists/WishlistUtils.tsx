...
// Dependencies: [32, 4343, 9360, 9361, 9362, 676, 1905, 1236, 5852, 3947, 2]
...
// Module 12461 (createNitroSuggestedSku)
...
export const isEligibleWishlistItemOnMobile = function isEligibleWishlistItemOnMobile(sku, isWishlistOwner) {
  ...
  if (isSKUWishlistItemRecord(sku)) {
    if (sku.sku.productLine === SKUProductLines.SOCIAL_LAYER_GAME_ITEM) {
      ...
      if (prop) {
        if (!isWishlistOwner) {
          isWishlistOwner = require(5852) /* useSKUPrice */.isSlayerSkuAvailableOnThisPlatform(sku.sku);
          const obj = require(5852) /* useSKUPrice */;
        }
