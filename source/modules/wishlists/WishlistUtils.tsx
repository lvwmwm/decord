...
// Dependencies: [32, 4384, 9406, 9407, 9408, 676, 1924, 1236, 5891, 4007, 2]
...
// Module 12529 (createNitroSuggestedSku)
...
export const isEligibleWishlistItemOnMobile = function isEligibleWishlistItemOnMobile(sku, isWishlistOwner) {
  ...
  if (isSKUWishlistItemRecord(sku)) {
    if (sku.sku.productLine === SKUProductLines.SOCIAL_LAYER_GAME_ITEM) {
      ...
      if (prop) {
        if (!isWishlistOwner) {
          isWishlistOwner = require(5891) /* useSKUPrice */.isSlayerSkuAvailableOnThisPlatform(sku.sku);
          const obj = require(5891) /* useSKUPrice */;
        }
