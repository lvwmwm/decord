...
// Dependencies: [32, 4385, 9410, 9411, 9412, 676, 1924, 1236, 5893, 4007, 2]
...
// Module 12530 (createNitroSuggestedSku)
...
export const isEligibleWishlistItemOnMobile = function isEligibleWishlistItemOnMobile(sku, isWishlistOwner) {
  ...
  if (isSKUWishlistItemRecord(sku)) {
    if (sku.sku.productLine === SKUProductLines.SOCIAL_LAYER_GAME_ITEM) {
      ...
      if (prop) {
        if (!isWishlistOwner) {
          isWishlistOwner = require(5893) /* useSKUPrice */.isSlayerSkuAvailableOnThisPlatform(sku.sku);
          const obj = require(5893) /* useSKUPrice */;
        }
