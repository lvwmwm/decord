...
// Dependencies: [32, 4294, 9249, 9250, 9251, 676, 1876, 1236, 5746, 3901, 2]
...
// Module 12342 (createNitroSuggestedSku)
...
export const isEligibleWishlistItemOnMobile = function isEligibleWishlistItemOnMobile(sku, isWishlistOwner) {
  ...
  if (isSKUWishlistItemRecord(sku)) {
    if (sku.sku.productLine === SKUProductLines.SOCIAL_LAYER_GAME_ITEM) {
      ...
      if (prop) {
        if (!isWishlistOwner) {
          isWishlistOwner = require(5746) /* useSKUPrice */.isSlayerSkuAvailableOnThisPlatform(sku.sku);
          const obj = require(5746) /* useSKUPrice */;
        }
