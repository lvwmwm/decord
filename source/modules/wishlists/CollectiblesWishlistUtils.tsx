...
// Dependencies: [1949, 1236, 7061, 9401, 2]
// Exports: getProductNameAndTypeFromSku, isWishlistableCollectiblesProduct

// Module 9400 (getProductNameAndTypeFromSku)
...
export const isWishlistableCollectiblesProduct = function isWishlistableCollectiblesProduct(selectedProduct) {
  const result = require(7061) /* getItemRecordsFromPurchases */.isPremiumCollectiblesProduct(selectedProduct);
  let tmp4 = !result;
  if (!result) {
    ...
    if (tmp5) {
      ...
      if (tmp6) {
        tmp6 = !tmp(9401).getIsProfileFrameGiftingEnabled("isWishlistableCollectiblesProduct");
