...
// Dependencies: [19, 21, 4285, 712, 1609, 5377, 4693, 5948, 4281, 1236, 4695, 4253, 3975, 2]
// Exports: default

// Module 12139 (SuspiciousDownloadActionSheet)
import "noop";
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  const items1 = [callback(href(5948).TrafficConeSpotIllustration, {}), , ];
  ...
  return callback(href(5377).BottomSheet, obj);
};
