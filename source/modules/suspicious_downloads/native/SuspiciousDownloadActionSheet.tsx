...
// Dependencies: [19, 21, 4193, 712, 1581, 5247, 4602, 6790, 4189, 1236, 4604, 4161, 3884, 2]
// Exports: default

// Module 12307 (SuspiciousDownloadActionSheet)
import "noop";
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  const items1 = [callback(href(6790).TrafficConeSpotIllustration, {}), , ];
  ...
  items1[1] = callback(href(4189).Text, obj1);
  ...
  items1[2] = callback(href(4189).Text, obj2);
  obj[3] = items1;
  const items2 = [callback2(href(4602).Stack, obj), ];
  ...
  const items3 = [callback(href(4604).Button, obj4), ];
  ...
  items3[1] = callback(href(4604).Button, obj5);
  obj3[1] = items3;
  items2[1] = callback2(href(4602).Stack, obj3);
  obj[4] = items2;
  obj[1] = callback2(href(4602).Stack, obj);
  return callback(href(5247).BottomSheet, obj);
};
