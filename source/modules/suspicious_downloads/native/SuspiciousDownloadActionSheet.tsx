...
// Dependencies: [19, 21, 4303, 712, 1609, 5397, 4712, 6027, 4299, 1236, 4714, 4271, 3992, 2]
// Exports: default

// Module 12221 (SuspiciousDownloadActionSheet)
import "noop";
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  items1[1] = callback(href(4299).Text, obj1);
  ...
  items1[2] = callback(href(4299).Text, obj2);
  obj[3] = items1;
  const items2 = [callback2(href(4712).Stack, obj), ];
  ...
  const items3 = [callback(href(4714).Button, obj4), ];
  ...
  items3[1] = callback(href(4714).Button, obj5);
  obj3[1] = items3;
  items2[1] = callback2(href(4712).Stack, obj3);
  obj[4] = items2;
  obj[1] = callback2(href(4712).Stack, obj);
  return callback(href(5397).BottomSheet, obj);
};
