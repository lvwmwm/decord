...
// Dependencies: [19, 21, 4255, 712, 1581, 5323, 4663, 5921, 4251, 1236, 4665, 4223, 3946, 2]
// Exports: default

// Module 12105 (SuspiciousDownloadActionSheet)
import "noop";
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  const items1 = [callback(href(5921).TrafficConeSpotIllustration, {}), , ];
  ...
  obj[3] = items1;
  const items2 = [callback2(href(4663).Stack, obj), ];
  ...
  const items3 = [callback(href(4665).Button, obj4), ];
  ...
  items3[1] = callback(href(4665).Button, obj5);
  obj3[1] = items3;
  items2[1] = callback2(href(4663).Stack, obj3);
  obj[4] = items2;
  obj[1] = callback2(href(4663).Stack, obj);
  return callback(href(5323).BottomSheet, obj);
};
