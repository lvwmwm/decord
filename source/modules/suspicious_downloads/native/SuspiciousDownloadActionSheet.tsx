...
// Dependencies: [19, 21, 4302, 712, 1609, 5396, 4710, 5967, 4298, 1236, 4712, 4270, 3992, 2]
// Exports: default

// Module 12154 (SuspiciousDownloadActionSheet)
import "noop";
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  items = [tmp.container, { paddingBottom: importDefault(1609)().bottom }];
  obj = { spacing: 8, justify: "center", align: "center", children: null };
  const items1 = [callback(href(5967).TrafficConeSpotIllustration, {}), , ];
  ...
  items1[1] = callback(href(4298).Text, obj1);
  ...
  items1[2] = callback(href(4298).Text, obj2);
  obj[3] = items1;
  const items2 = [callback2(href(4710).Stack, obj), ];
  ...
  const items3 = [callback(href(4712).Button, obj4), ];
  ...
  items3[1] = callback(href(4712).Button, obj5);
  obj3[1] = items3;
  items2[1] = callback2(href(4710).Stack, obj3);
  obj[4] = items2;
  obj[1] = callback2(href(4710).Stack, obj);
  return callback(href(5396).BottomSheet, obj);
};
