...
// Dependencies: [19, 21, 4344, 712, 1628, 5436, 4752, 6068, 4340, 1236, 4754, 4312, 4052, 2]
// Exports: default

// Module 12289 (SuspiciousDownloadActionSheet)
import "noop";
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  const items1 = [callback(href(6068).TrafficConeSpotIllustration, {}), , ];
  ...
  items1[1] = callback(href(4340).Text, obj1);
  ...
  items1[2] = callback(href(4340).Text, obj2);
  obj[3] = items1;
  const items2 = [callback2(href(4752).Stack, obj), ];
  ...
  const items3 = [callback(href(4754).Button, obj4), ];
  ...
  items3[1] = callback(href(4754).Button, obj5);
  obj3[1] = items3;
  items2[1] = callback2(href(4752).Stack, obj3);
  obj[4] = items2;
  obj[1] = callback2(href(4752).Stack, obj);
  return callback(href(5436).BottomSheet, obj);
};
