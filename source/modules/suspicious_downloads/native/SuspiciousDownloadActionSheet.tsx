...
// Dependencies: [19, 21, 4668, 712, 1629, 6988, 4738, 5452, 4739, 1236, 4750, 4346, 4087, 2]
// Exports: default

// Module 12469 (SuspiciousDownloadActionSheet)
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  const items1 = [callback(href(5452).TrafficConeSpotIllustration, {}), , ];
  ...
  items1[1] = callback(href(4739).Text, obj1);
  ...
  items1[2] = callback(href(4739).Text, obj2);
  obj[3] = items1;
  const items2 = [callback2(href(4738).Stack, obj), ];
  ...
  const items3 = [callback(href(4750).Button, obj4), ];
  ...
  items3[1] = callback(href(4750).Button, obj5);
  obj3[1] = items3;
  items2[1] = callback2(href(4738).Stack, obj3);
  obj[4] = items2;
  obj[1] = callback2(href(4738).Stack, obj);
  return callback(href(6988).BottomSheet, obj);
};
