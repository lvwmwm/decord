...
// Dependencies: [32, 19, 10690, 13610, 10052, 10051, 21, 4193, 712, 1581, 1474, 16064, 4054, 9458, 10055, 15867, 4194, 4197, 4603, 15869, 5506, 5277, 16066, 2]
// Exports: default
...
let result = require("module_10690").fileFinishedImporting("modules/media_panel/native/MediaPlaybackPanelUI.tsx");
...
export default function MediaPlaybackPanelUI() {
  ...
  wrapperOffset = tmp4;
  ({ wrapperDimensions, wrapperOffset } = mode(wrapperOffset(16064)));
  let obj = wrapperDimensions(4054);
  const fn = function p() {
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(9458).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, updateSharedValueIfChanged: wrapperOffset(10055), wrapperDimensions, wrapperOffset };
  fn3.__closure = obj;
  fn3.__workletHash = 5458787116551;
  fn3.__initData = maskEmptyElevation;
  const animatedReaction = obj2.useAnimatedReaction(fn2, fn3);
  let obj4 = wrapperDimensions(4054);
  sharedValue = obj4.useSharedValue(0);
  let obj5 = wrapperDimensions(4054);
  sharedValue1 = obj5.useSharedValue(0);
  let obj6 = wrapperDimensions(4054);
  sharedValue2 = obj6.useSharedValue(0);
  let obj7 = wrapperDimensions(4054);
  ...
  c13 = tmp18;
  let obj8 = wrapperDimensions(4054);
  class R {
    constructor() {
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(9458).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, getClampedPIPPosition: wrapperDimensions(15867).getClampedPIPPosition, safeArea: tmp9, disableHorizontalSafeAreas: tmp18, wrapperOpacity: sharedValue2, animateWrapperTranslation: sharedValue3, wrapperTranslationX: sharedValue, wrapperTranslationY: sharedValue1 };
  C.__closure = obj;
  ...
  if (mode.get() === canShowPIP.PIP) {
    ...
    if (mode.get() === canShowPIP.PIP) {
      ...
      obj1[0] = tmp6(4194).withTiming;
      obj1[1] = sharedValue2;
      obj1[2] = tmp6(4197).timingFast;
      obj1[3] = sharedValue3;
      obj1[4] = tmp6(4603).withSpring;
      obj1[5] = sharedValue;
      ...
      const animatedStyle3 = tmp6(4054).useAnimatedStyle(fn4);
      const context1 = obj1.useContext(tmp2(16064));
      ...
      const tmp6Result1 = tmp6(4054);
      obj4[1] = tmp6(15869).MorphablePanelModes.PIP;
      obj4[2] = pipState2;
      obj4[3] = wrapperOffset2;
      const tmp2Result = tmp2(15869);
      obj5 = { children: null };
      obj6 = { style: null, pointerEvents: "box-none", children: null };
      obj6[0] = animatedStyle;
      obj7 = { style: null, children: null };
      obj7[0] = tmp30;
      const View = tmp2(4054).View;
      obj8 = { style: null, children: null };
      obj8[0] = tmp31;
      const obj9 = { gesture: null, children: null };
      obj9[0] = tmp2(15869)(obj4);
      const obj10 = { style: null, children: null };
      const items3 = [tmp.content, animatedStyle3];
      obj10[0] = items3;
      obj10[1] = sharedValue2(tmp2(16066), {});
      obj9[1] = sharedValue2(tmp2(4054).View, obj10);
      obj8[1] = sharedValue2(tmp6(5277).GestureDetector, obj9);
      obj7[1] = sharedValue2(tmp2(4054).View, obj8);
      class R {
        constructor() {
          obj = { mode: mode.get(), wrapperDimensions: wrapperDimensions.get(), pipAvoidanceSpecs: pipAvoidanceSpecs.get(), wrapperOffset: wrapperOffset.get(), windowDimensions: c4, safeArea: c3, pipState: pipState.get() };
          return obj;
      ...
      obj5[0] = sharedValue2(tmp2(4054).View, obj6);
      return sharedValue2(tmp6(5506).LayerScope, obj5);
    }
  }
