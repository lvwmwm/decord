...
// Dependencies: [32, 19, 9548, 14105, 11758, 11757, 21, 4445, 712, 1629, 1494, 16714, 4185, 9130, 10911, 16512, 4446, 4449, 4879, 16514, 5892, 5604, 16716, 2]
// Exports: default

// Module 16715 (MediaPlaybackPanelUI)
import ThemesDefault from "Themes" /* 712 */;
import closure_3 from "_slicedToArray" /* 32 */;
import closure_4 from "noop" /* 19 */;
import { useContext } from "noop" /* 19 */;
import closure_6 from "module_9548" /* 9548 */;
import MediaPlaybackPanelModes from "MediaPlaybackPanelModes" /* 14105 */;
import { IS_IOS } from "MIN_PAN_GESTURE_MOVE" /* 11758 */;
import { BORDER_RADIUS_PHYSICS } from "VoicePanelModes" /* 11757 */;
...
export default function MediaPlaybackPanelUI() {
  ...
  wrapperOffset = tmp4;
  ({ wrapperDimensions, wrapperOffset } = mode(wrapperOffset(16714)));
  let obj = wrapperDimensions(4185);
  const fn = function p() {
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(9130).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, updateSharedValueIfChanged: wrapperOffset(10911), wrapperDimensions, wrapperOffset };
  fn3.__closure = obj;
  fn3.__workletHash = 5458787116551;
  fn3.__initData = maskEmptyElevation;
  const animatedReaction = obj2.useAnimatedReaction(fn2, fn3);
  let obj4 = wrapperDimensions(4185);
  sharedValue = obj4.useSharedValue(0);
  let obj5 = wrapperDimensions(4185);
  sharedValue1 = obj5.useSharedValue(0);
  let obj6 = wrapperDimensions(4185);
  sharedValue2 = obj6.useSharedValue(0);
  let obj7 = wrapperDimensions(4185);
  ...
  closure_13 = tmp18;
  let obj8 = wrapperDimensions(4185);
  class R {
    constructor() {
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(9130).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, getClampedPIPPosition: wrapperDimensions(16512).getClampedPIPPosition, safeArea: tmp9, disableHorizontalSafeAreas: tmp18, wrapperOpacity: sharedValue2, animateWrapperTranslation: sharedValue3, wrapperTranslationX: sharedValue, wrapperTranslationY: sharedValue1 };
  C.__closure = obj;
  ...
  if (mode.get() === canShowPIP.PIP) {
    ...
    if (mode.get() === canShowPIP.PIP) {
      ...
      obj1[0] = tmp6(4446).withTiming;
      obj1[1] = sharedValue2;
      obj1[2] = tmp6(4449).timingFast;
      obj1[3] = sharedValue3;
      obj1[4] = tmp6(4879).withSpring;
      obj1[5] = sharedValue;
      ...
      const animatedStyle3 = tmp6(4185).useAnimatedStyle(fn4);
      const context1 = obj1.useContext(tmp2(16714));
      ...
      const tmp6Result1 = tmp6(4185);
      obj4[1] = tmp6(16514).MorphablePanelModes.PIP;
      obj4[2] = pipState2;
      ...
      obj7[0] = tmp30;
      const View = tmp2(4185).View;
      obj8 = { style: null, children: null };
      obj8[0] = tmp31;
      const obj9 = { gesture: null, children: null };
      obj9[0] = tmp2(16514)(obj4);
      const obj10 = { style: null, children: null };
      const items3 = [tmp.content, animatedStyle3];
      obj10[0] = items3;
      obj10[1] = sharedValue2(tmp2(16716), {});
      obj9[1] = sharedValue2(tmp2(4185).View, obj10);
      obj8[1] = sharedValue2(tmp6(5604).GestureDetector, obj9);
      obj7[1] = sharedValue2(tmp2(4185).View, obj8);
      class R {
        constructor() {
          obj = { mode: mode.get(), wrapperDimensions: wrapperDimensions.get(), pipAvoidanceSpecs: pipAvoidanceSpecs.get(), wrapperOffset: wrapperOffset.get(), windowDimensions: closure_4, safeArea: closure_3, pipState: pipState.get() };
          return obj;
      ...
      obj5[0] = sharedValue2(tmp2(4185).View, obj6);
      return sharedValue2(tmp6(5892).LayerScope, obj5);
    }
  }
