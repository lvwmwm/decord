...
// Dependencies: [32, 19, 10728, 13867, 11705, 11704, 21, 4342, 712, 1628, 1493, 16377, 4083, 8825, 10289, 16179, 4343, 4346, 4754, 16181, 5755, 5467, 16379, 2]
// Exports: default

// Module 16378 (MediaPlaybackPanelUI)
...
let result = require("module_10728").fileFinishedImporting("modules/media_panel/native/MediaPlaybackPanelUI.tsx");
...
export default function MediaPlaybackPanelUI() {
  ...
  wrapperOffset = tmp4;
  ({ wrapperDimensions, wrapperOffset } = mode(wrapperOffset(16377)));
  ...
  React = tmp10;
  let obj1 = React;
  const context = React.useContext(wrapperOffset(16377));
  mode = context.mode;
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(8825).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, updateSharedValueIfChanged: wrapperOffset(10289), wrapperDimensions, wrapperOffset };
  fn3.__closure = obj;
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(8825).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, getClampedPIPPosition: wrapperDimensions(16179).getClampedPIPPosition, safeArea: tmp9, disableHorizontalSafeAreas: tmp18, wrapperOpacity: sharedValue2, animateWrapperTranslation: sharedValue3, wrapperTranslationX: sharedValue, wrapperTranslationY: sharedValue1 };
  C.__closure = obj;
  ...
  if (mode.get() === canShowPIP.PIP) {
    ...
    if (mode.get() === canShowPIP.PIP) {
      ...
      const context1 = obj1.useContext(tmp2(16377));
      ...
      obj4[1] = tmp6(16181).MorphablePanelModes.PIP;
      obj4[2] = pipState2;
      obj4[3] = wrapperOffset2;
      const tmp2Result = tmp2(16181);
      obj5 = { children: null };
      ...
      obj9[0] = tmp2(16181)(obj4);
      const obj10 = { style: null, children: null };
      const items3 = [tmp.content, animatedStyle3];
      obj10[0] = items3;
      obj10[1] = sharedValue2(tmp2(16379), {});
      obj9[1] = sharedValue2(tmp2(4083).View, obj10);
      obj8[1] = sharedValue2(tmp6(5467).GestureDetector, obj9);
      ...
      return sharedValue2(tmp6(5755).LayerScope, obj5);
    }
  }
