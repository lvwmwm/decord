...
// Dependencies: [32, 19, 9566, 14124, 11777, 11776, 21, 4446, 712, 1629, 1494, 16732, 4186, 9148, 10929, 16530, 4447, 4450, 4892, 16532, 5905, 5617, 16734, 2]
// Exports: default

// Module 16733 (MediaPlaybackPanelUI)
import ThemesDefault from "Themes" /* 712 */;
import closure_3 from "_slicedToArray" /* 32 */;
import closure_4 from "noop" /* 19 */;
import { useContext } from "noop" /* 19 */;
import closure_6 from "module_9566" /* 9566 */;
import MediaPlaybackPanelModes from "MediaPlaybackPanelModes" /* 14124 */;
import { IS_IOS } from "MIN_PAN_GESTURE_MOVE" /* 11777 */;
import { BORDER_RADIUS_PHYSICS } from "VoicePanelModes" /* 11776 */;
...
export default function MediaPlaybackPanelUI() {
  ...
  wrapperOffset = tmp4;
  ({ wrapperDimensions, wrapperOffset } = mode(wrapperOffset(16732)));
  let obj = wrapperDimensions(4186);
  const fn = function p() {
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(9148).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, updateSharedValueIfChanged: wrapperOffset(10929), wrapperDimensions, wrapperOffset };
  fn3.__closure = obj;
  fn3.__workletHash = 5458787116551;
  fn3.__initData = maskEmptyElevation;
  const animatedReaction = obj2.useAnimatedReaction(fn2, fn3);
  let obj4 = wrapperDimensions(4186);
  sharedValue = obj4.useSharedValue(0);
  let obj5 = wrapperDimensions(4186);
  sharedValue1 = obj5.useSharedValue(0);
  let obj6 = wrapperDimensions(4186);
  sharedValue2 = obj6.useSharedValue(0);
  let obj7 = wrapperDimensions(4186);
  ...
  closure_13 = tmp18;
  let obj8 = wrapperDimensions(4186);
  class R {
    constructor() {
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(9148).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, getClampedPIPPosition: wrapperDimensions(16530).getClampedPIPPosition, safeArea: tmp9, disableHorizontalSafeAreas: tmp18, wrapperOpacity: sharedValue2, animateWrapperTranslation: sharedValue3, wrapperTranslationX: sharedValue, wrapperTranslationY: sharedValue1 };
  C.__closure = obj;
  ...
  if (mode.get() === canShowPIP.PIP) {
    ...
    if (mode.get() === canShowPIP.PIP) {
      ...
      obj1[0] = tmp6(4447).withTiming;
      obj1[1] = sharedValue2;
      obj1[2] = tmp6(4450).timingFast;
      obj1[3] = sharedValue3;
      obj1[4] = tmp6(4892).withSpring;
      obj1[5] = sharedValue;
      ...
      const animatedStyle3 = tmp6(4186).useAnimatedStyle(fn4);
      const context1 = obj1.useContext(tmp2(16732));
      ...
      const tmp6Result1 = tmp6(4186);
      obj4[1] = tmp6(16532).MorphablePanelModes.PIP;
      obj4[2] = pipState2;
      ...
      obj7[0] = tmp30;
      const View = tmp2(4186).View;
      obj8 = { style: null, children: null };
      obj8[0] = tmp31;
      const obj9 = { gesture: null, children: null };
      obj9[0] = tmp2(16532)(obj4);
      const obj10 = { style: null, children: null };
      const items3 = [tmp.content, animatedStyle3];
      obj10[0] = items3;
      obj10[1] = sharedValue2(tmp2(16734), {});
      obj9[1] = sharedValue2(tmp2(4186).View, obj10);
      obj8[1] = sharedValue2(tmp6(5617).GestureDetector, obj9);
      obj7[1] = sharedValue2(tmp2(4186).View, obj8);
      class R {
        constructor() {
          obj = { mode: mode.get(), wrapperDimensions: wrapperDimensions.get(), pipAvoidanceSpecs: pipAvoidanceSpecs.get(), wrapperOffset: wrapperOffset.get(), windowDimensions: closure_4, safeArea: closure_3, pipState: pipState.get() };
          return obj;
      ...
      obj5[0] = sharedValue2(tmp2(4186).View, obj6);
      return sharedValue2(tmp6(5905).LayerScope, obj5);
    }
  }
