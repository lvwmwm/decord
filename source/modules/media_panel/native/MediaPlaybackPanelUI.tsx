...
// Dependencies: [32, 19, 9588, 14158, 11808, 11807, 21, 4448, 712, 1628, 1493, 16765, 4187, 9170, 10953, 16564, 4449, 4452, 4895, 16566, 5908, 5620, 16767, 2]
// Exports: default

// Module 16766 (MediaPlaybackPanelUI)
...
import { IS_IOS } from "MIN_PAN_GESTURE_MOVE" /* 11808 */;
import { BORDER_RADIUS_PHYSICS } from "VoicePanelModes" /* 11807 */;
...
export default function MediaPlaybackPanelUI() {
  ...
  wrapperOffset = tmp4;
  ({ wrapperDimensions, wrapperOffset } = mode(wrapperOffset(16765)));
  let obj = wrapperDimensions(4187);
  const fn = function p() {
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(9170).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, updateSharedValueIfChanged: wrapperOffset(10953), wrapperDimensions, wrapperOffset };
  fn3.__closure = obj;
  fn3.__workletHash = 5458787116551;
  fn3.__initData = maskEmptyElevation;
  const animatedReaction = obj2.useAnimatedReaction(fn2, fn3);
  let obj4 = wrapperDimensions(4187);
  sharedValue = obj4.useSharedValue(0);
  let obj5 = wrapperDimensions(4187);
  sharedValue1 = obj5.useSharedValue(0);
  let obj6 = wrapperDimensions(4187);
  sharedValue2 = obj6.useSharedValue(0);
  let obj7 = wrapperDimensions(4187);
  ...
  closure_13 = tmp18;
  let obj8 = wrapperDimensions(4187);
  class R {
    constructor() {
  ...
  if (mode.get() === canShowPIP.PIP) {
    ...
    if (mode.get() === canShowPIP.PIP) {
      ...
      obj1[0] = tmp6(4449).withTiming;
      obj1[1] = sharedValue2;
      obj1[2] = tmp6(4452).timingFast;
      obj1[3] = sharedValue3;
      obj1[4] = tmp6(4895).withSpring;
      obj1[5] = sharedValue;
      ...
      const animatedStyle3 = tmp6(4187).useAnimatedStyle(fn4);
      const context1 = obj1.useContext(tmp2(16765));
      ...
      const tmp6Result1 = tmp6(4187);
      obj4[1] = tmp6(16566).MorphablePanelModes.PIP;
      obj4[2] = pipState2;
      obj4[3] = wrapperOffset2;
      const tmp2Result = tmp2(16566);
      obj5 = { children: null };
      obj6 = { style: null, pointerEvents: "box-none", children: null };
      obj6[0] = animatedStyle;
      obj7 = { style: null, children: null };
      obj7[0] = tmp30;
      const View = tmp2(4187).View;
      obj8 = { style: null, children: null };
      obj8[0] = tmp31;
      const obj9 = { gesture: null, children: null };
      obj9[0] = tmp2(16566)(obj4);
      const obj10 = { style: null, children: null };
      const items3 = [tmp.content, animatedStyle3];
      obj10[0] = items3;
      obj10[1] = sharedValue2(tmp2(16767), {});
      obj9[1] = sharedValue2(tmp2(4187).View, obj10);
      obj8[1] = sharedValue2(tmp6(5620).GestureDetector, obj9);
      obj7[1] = sharedValue2(tmp2(4187).View, obj8);
      class R {
        constructor() {
          obj = { mode: mode.get(), wrapperDimensions: wrapperDimensions.get(), pipAvoidanceSpecs: pipAvoidanceSpecs.get(), wrapperOffset: wrapperOffset.get(), windowDimensions: closure_4, safeArea: closure_3, pipState: pipState.get() };
          return obj;
      ...
      obj5[0] = sharedValue2(tmp2(4187).View, obj6);
      return sharedValue2(tmp6(5908).LayerScope, obj5);
    }
  }
