...
// Dependencies: [32, 19, 10677, 13715, 11565, 11564, 21, 4285, 712, 1609, 1474, 16181, 4145, 8699, 10248, 15984, 4286, 4289, 4694, 15986, 5636, 5407, 16183, 2]
// Exports: default

// Module 16182 (MediaPlaybackPanelUI)
import _slicedToArray from "_slicedToArray";
import MorphablePanelModes from "MorphablePanelModes";
import { useContext } from "MorphablePanelModes";
import module_10677 from "module_10677";
...
let result = require("module_10677").fileFinishedImporting("modules/media_panel/native/MediaPlaybackPanelUI.tsx");
...
export default function MediaPlaybackPanelUI() {
  ...
  wrapperOffset = tmp4;
  ({ wrapperDimensions, wrapperOffset } = mode(wrapperOffset(16181)));
  let obj = wrapperDimensions(4145);
  const fn = function p() {
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(8699).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, updateSharedValueIfChanged: wrapperOffset(10248), wrapperDimensions, wrapperOffset };
  fn3.__closure = obj;
  fn3.__workletHash = 5458787116551;
  fn3.__initData = maskEmptyElevation;
  const animatedReaction = obj2.useAnimatedReaction(fn2, fn3);
  let obj4 = wrapperDimensions(4145);
  sharedValue = obj4.useSharedValue(0);
  let obj5 = wrapperDimensions(4145);
  sharedValue1 = obj5.useSharedValue(0);
  let obj6 = wrapperDimensions(4145);
  sharedValue2 = obj6.useSharedValue(0);
  let obj7 = wrapperDimensions(4145);
  ...
  c13 = tmp18;
  let obj8 = wrapperDimensions(4145);
  class R {
    constructor() {
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(8699).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, getClampedPIPPosition: wrapperDimensions(15984).getClampedPIPPosition, safeArea: tmp9, disableHorizontalSafeAreas: tmp18, wrapperOpacity: sharedValue2, animateWrapperTranslation: sharedValue3, wrapperTranslationX: sharedValue, wrapperTranslationY: sharedValue1 };
  C.__closure = obj;
  ...
  if (mode.get() === canShowPIP.PIP) {
    ...
    if (mode.get() === canShowPIP.PIP) {
      ...
      obj1[0] = tmp6(4286).withTiming;
      obj1[1] = sharedValue2;
      obj1[2] = tmp6(4289).timingFast;
      obj1[3] = sharedValue3;
      obj1[4] = tmp6(4694).withSpring;
      obj1[5] = sharedValue;
      ...
      const animatedStyle3 = tmp6(4145).useAnimatedStyle(fn4);
      const context1 = obj1.useContext(tmp2(16181));
      ...
      obj4[1] = tmp6(15986).MorphablePanelModes.PIP;
      obj4[2] = pipState2;
      obj4[3] = wrapperOffset2;
      const tmp2Result = tmp2(15986);
      obj5 = { children: null };
      obj6 = { style: null, pointerEvents: "box-none", children: null };
      obj6[0] = animatedStyle;
      obj7 = { style: null, children: null };
      obj7[0] = tmp30;
      const View = tmp2(4145).View;
      obj8 = { style: null, children: null };
      obj8[0] = tmp31;
      const obj9 = { gesture: null, children: null };
      obj9[0] = tmp2(15986)(obj4);
      const obj10 = { style: null, children: null };
      const items3 = [tmp.content, animatedStyle3];
      obj10[0] = items3;
      obj10[1] = sharedValue2(tmp2(16183), {});
      obj9[1] = sharedValue2(tmp2(4145).View, obj10);
      obj8[1] = sharedValue2(tmp6(5407).GestureDetector, obj9);
      obj7[1] = sharedValue2(tmp2(4145).View, obj8);
      class R {
        constructor() {
          obj = { mode: mode.get(), wrapperDimensions: wrapperDimensions.get(), pipAvoidanceSpecs: pipAvoidanceSpecs.get(), wrapperOffset: wrapperOffset.get(), windowDimensions: c4, safeArea: c3, pipState: pipState.get() };
          return obj;
      ...
      obj5[0] = sharedValue2(tmp2(4145).View, obj6);
      return sharedValue2(tmp6(5636).LayerScope, obj5);
    }
  }
