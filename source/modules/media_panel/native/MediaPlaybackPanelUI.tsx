...
// Dependencies: [32, 19, 9627, 14191, 11841, 11840, 21, 4478, 712, 1628, 1493, 16801, 4217, 9209, 10991, 16600, 4479, 4482, 4927, 16602, 5940, 5652, 16803, 2]
// Exports: default

// Module 16802 (MediaPlaybackPanelUI)
...
import { IS_IOS } from "MIN_PAN_GESTURE_MOVE" /* 11841 */;
import { BORDER_RADIUS_PHYSICS } from "VoicePanelModes" /* 11840 */;
...
export default function MediaPlaybackPanelUI() {
  ...
  wrapperOffset = tmp4;
  ({ wrapperDimensions, wrapperOffset } = mode(wrapperOffset(16801)));
  ...
  React = tmp10;
  obj1 = React;
  const context = React.useContext(wrapperOffset(16801));
  mode = context.mode;
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(9209).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, updateSharedValueIfChanged: wrapperOffset(10991), wrapperDimensions, wrapperOffset };
  fn3.__closure = obj;
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(9209).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, getClampedPIPPosition: wrapperDimensions(16600).getClampedPIPPosition, safeArea: tmp9, disableHorizontalSafeAreas: tmp18, wrapperOpacity: sharedValue2, animateWrapperTranslation: sharedValue3, wrapperTranslationX: sharedValue, wrapperTranslationY: sharedValue1 };
  C.__closure = obj;
  ...
  if (mode.get() === canShowPIP.PIP) {
    ...
    if (mode.get() === canShowPIP.PIP) {
      ...
      const context1 = obj1.useContext(tmp2(16801));
      ...
      obj4[1] = tmp6(16602).MorphablePanelModes.PIP;
      obj4[2] = pipState2;
      ...
      obj9[0] = tmp2(16602)(obj4);
      const obj10 = { style: null, children: null };
      const items3 = [tmp.content, animatedStyle3];
      obj10[0] = items3;
      obj10[1] = sharedValue2(tmp2(16803), {});
      obj9[1] = sharedValue2(tmp2(4217).View, obj10);
      obj8[1] = sharedValue2(tmp6(5652).GestureDetector, obj9);
      ...
      return sharedValue2(tmp6(5940).LayerScope, obj5);
    }
  }
