...
// Dependencies: [32, 19, 10814, 13866, 11707, 11706, 21, 4344, 712, 1628, 1493, 16366, 4083, 8821, 10377, 16168, 4345, 4348, 4753, 16170, 5754, 5466, 16368, 2]
// Exports: default

// Module 16367 (MediaPlaybackPanelUI)
import _slicedToArray from "_slicedToArray";
import MorphablePanelModes from "MorphablePanelModes";
import { useContext } from "MorphablePanelModes";
import module_10814 from "module_10814";
...
let result = require("module_10814").fileFinishedImporting("modules/media_panel/native/MediaPlaybackPanelUI.tsx");
...
export default function MediaPlaybackPanelUI() {
  ...
  wrapperOffset = tmp4;
  ({ wrapperDimensions, wrapperOffset } = mode(wrapperOffset(16366)));
  ...
  React = tmp10;
  let obj1 = React;
  const context = React.useContext(wrapperOffset(16366));
  mode = context.mode;
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(8821).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, updateSharedValueIfChanged: wrapperOffset(10377), wrapperDimensions, wrapperOffset };
  fn3.__closure = obj;
  ...
  obj = { cheapWorkletShallowEqual: wrapperDimensions(8821).cheapWorkletShallowEqual, MediaPlaybackPanelModes: canShowPIP, getClampedPIPPosition: wrapperDimensions(16168).getClampedPIPPosition, safeArea: tmp9, disableHorizontalSafeAreas: tmp18, wrapperOpacity: sharedValue2, animateWrapperTranslation: sharedValue3, wrapperTranslationX: sharedValue, wrapperTranslationY: sharedValue1 };
  C.__closure = obj;
  ...
  if (mode.get() === canShowPIP.PIP) {
    ...
    if (mode.get() === canShowPIP.PIP) {
      ...
      obj1[0] = tmp6(4345).withTiming;
      obj1[1] = sharedValue2;
      obj1[2] = tmp6(4348).timingFast;
      obj1[3] = sharedValue3;
      obj1[4] = tmp6(4753).withSpring;
      obj1[5] = sharedValue;
      ...
      const context1 = obj1.useContext(tmp2(16366));
      ...
      obj4[1] = tmp6(16170).MorphablePanelModes.PIP;
      obj4[2] = pipState2;
      obj4[3] = wrapperOffset2;
      const tmp2Result = tmp2(16170);
      obj5 = { children: null };
      ...
      obj9[0] = tmp2(16170)(obj4);
      const obj10 = { style: null, children: null };
      const items3 = [tmp.content, animatedStyle3];
      obj10[0] = items3;
      obj10[1] = sharedValue2(tmp2(16368), {});
      obj9[1] = sharedValue2(tmp2(4083).View, obj10);
      obj8[1] = sharedValue2(tmp6(5466).GestureDetector, obj9);
      ...
      return sharedValue2(tmp6(5754).LayerScope, obj5);
    }
  }
