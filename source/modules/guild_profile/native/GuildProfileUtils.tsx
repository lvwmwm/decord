...
// Dependencies: [32, 4470, 1431, 8041, 7297, 2]
// Exports: getProfilePrimaryColor, useProfilePrimaryColor

// Module 9016 (useProfilePrimaryColor)
  ...
  if (null == guildProfileFromInvite) {
    ...
    if (null == guildIconURL) {
      ...
      if (null != first) {
        ...
        const obj2 = tmp8(7297)(obj);
        let num2 = 1;
        ({ h, s, l } = tmp8(7297)(obj).toHsl());
        ...
        obj[1] = s * num2;
        obj[2] = l;
        const toHslResult = tmp8(7297)(obj).toHsl();
        return tmp8(7297)(obj).toHexString();
      } else {
        return null;
      }
