...
// Dependencies: [32, 4247, 1416, 8017, 6905, 2]
// Exports: getProfilePrimaryColor, useProfilePrimaryColor

// Module 9147 (useProfilePrimaryColor)
...
export const useProfilePrimaryColor = function useProfilePrimaryColor(guildProfile, token) {
  ...
  let brandColorPrimary = importDefault(8017)(guildIconURL, token);
...
export const getProfilePrimaryColor = function getProfilePrimaryColor(guildProfileFromInvite) {
  ...
  if (null == guildProfileFromInvite) {
    ...
    if (null == guildIconURL) {
      ...
      require(8017) /* hasFetchedColors */.maybeFetchColors(guildIconURL);
      const useColorStore = require(8017) /* hasFetchedColors */.useColorStore;
      ...
      if (null != first) {
        ...
        const obj2 = tmp8(6905)(obj);
        let num2 = 1;
        ({ h, s, l } = tmp8(6905)(obj).toHsl());
        ...
        obj[1] = s * num2;
        obj[2] = l;
        const toHslResult = tmp8(6905)(obj).toHsl();
        return tmp8(6905)(obj).toHexString();
      } else {
        return null;
      }
      const obj7 = require(8017) /* hasFetchedColors */;
    }
