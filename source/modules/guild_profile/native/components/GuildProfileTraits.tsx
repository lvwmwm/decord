...
// Function ID: 12125
// Name: TraitEmoji
// Dependencies: [19, 17, 21, 4285, 712, 1416, 3929, 5340, 4281, 2]
// Exports: default

// Module 12124 (TraitEmoji)
...
function TraitEmoji(emoji) {
  ...
  if (null == emoji) {
    ...
    const obj3 = importDefault(3929);
    const tmp5 = importDefault;
    obj = { src: null, name: null, fastImageStyle: null };
    obj[0] = emojiURL;
    obj[1] = importDefault(3929).isCustomEmoji(emoji) ? emoji.name : emoji.surrogates;
