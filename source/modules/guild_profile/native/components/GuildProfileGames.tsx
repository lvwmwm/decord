...
// Dependencies: [19, 17, 21, 4285, 712, 9189, 9200, 12112, 4281, 12116, 12117, 3986, 4253, 12118, 1959, 4812, 2]
// Exports: default

// Module 9188 (ClickableGameIcon)
...
function ClickableGameIcon(game) {
  ...
  obj[1] = game(9200).GameProfileSources.GuildProfileGames;
  obj[2] = enabled;
  const tmp3Result = onPressFallback(9189)(obj);
