...
// Dependencies: [19, 17, 21, 9174, 4221, 3988, 712, 4706, 7885, 4281, 1236, 4827, 2]
// Exports: default

// Module 12125 (GuildProfileLoadingError)
import "noop";
...
export default function GuildProfileLoadingError(onPress) {
  let obj = require(9174) /* GuildProfileBackground */;
  ...
  obj[1] = require(9174) /* GuildProfileBackground */.DiagonalGradient.START;
  obj[2] = require(9174) /* GuildProfileBackground */.DiagonalGradient.END;
  let obj4 = require(9174) /* GuildProfileBackground */;
  ...
  obj3[1] = callback(require(7885) /* WarningIcon */.WarningIcon, obj4);
  ...
  const items2 = [callback(require(7885) /* WarningIcon */.WarningIcon, obj8), ];
  ...
  obj7[4] = items2;
  items1[1] = callback2(require(4827) /* PressableBase */.PressableOpacity, obj7);
  obj5[1] = items1;
