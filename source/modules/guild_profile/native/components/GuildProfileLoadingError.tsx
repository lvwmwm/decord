...
// Dependencies: [31, 27, 33, 8581, 4066, 3834, 689, 4554, 7576, 4126, 1212, 4660, 2]
// Exports: default

// Module 11884 (GuildProfileLoadingError)
import "result";
...
export default function GuildProfileLoadingError(onPress) {
  ...
  obj3.children = callback(require(7576) /* WarningIcon */.WarningIcon, obj4);
  ...
  const items2 = [callback(require(7576) /* WarningIcon */.WarningIcon, obj8), ];
