...
// Dependencies: [19, 17, 21, 9302, 4280, 4065, 712, 4765, 8003, 4340, 1236, 4886, 2]
// Exports: default

// Module 12275 (GuildProfileLoadingError)
import "noop";
...
export default function GuildProfileLoadingError(onPress) {
  let obj = require(9302) /* GuildProfileBackground */;
  ...
  obj[1] = require(9302) /* GuildProfileBackground */.DiagonalGradient.START;
  obj[2] = require(9302) /* GuildProfileBackground */.DiagonalGradient.END;
  let obj4 = require(9302) /* GuildProfileBackground */;
  obj[3] = obj4.getBackgroundForProfile(tmp2, token);
  const items = [callback(importDefault(4765), obj), , ];
  ...
  obj3[1] = callback(require(8003) /* WarningIcon */.WarningIcon, obj4);
  ...
  const items1 = [callback(require(4340) /* Text */.Text, obj6), ];
  ...
  const items2 = [callback(require(8003) /* WarningIcon */.WarningIcon, obj8), ];
  ...
  items2[1] = callback(require(4340) /* Text */.Text, obj9);
  obj7[4] = items2;
  items1[1] = callback2(require(4886) /* PressableBase */.PressableOpacity, obj7);
  obj5[1] = items1;
