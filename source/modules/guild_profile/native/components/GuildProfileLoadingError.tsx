...
// Dependencies: [31, 27, 33, 8432, 4101, 3869, 689, 4589, 7606, 4161, 1212, 4695, 2]
// Exports: default

// Module 11931 (GuildProfileLoadingError)
import "result";
...
export default function GuildProfileLoadingError(onPress) {
  ...
  obj3.children = callback(require(7606) /* WarningIcon */.WarningIcon, obj4);
  ...
  const items1 = [callback(require(4161) /* Text */.Text, obj6), ];
  ...
  const items2 = [callback(require(7606) /* WarningIcon */.WarningIcon, obj8), ];
  ...
  items1[1] = callback2(require(4695) /* PressableBase */.PressableOpacity, obj7);
