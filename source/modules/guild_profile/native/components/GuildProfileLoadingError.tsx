...
// Dependencies: [19, 17, 21, 9191, 4238, 4005, 712, 4723, 7902, 4298, 1236, 4844, 2]
// Exports: default

// Module 12140 (GuildProfileLoadingError)
import "noop";
...
export default function GuildProfileLoadingError(onPress) {
  let obj = require(9191) /* GuildProfileBackground */;
  ...
  obj[1] = require(9191) /* GuildProfileBackground */.DiagonalGradient.START;
  obj[2] = require(9191) /* GuildProfileBackground */.DiagonalGradient.END;
  let obj4 = require(9191) /* GuildProfileBackground */;
  ...
  obj3[1] = callback(require(7902) /* WarningIcon */.WarningIcon, obj4);
  ...
  const items1 = [callback(require(4298) /* Text */.Text, obj6), ];
  ...
  const items2 = [callback(require(7902) /* WarningIcon */.WarningIcon, obj8), ];
  ...
  items2[1] = callback(require(4298) /* Text */.Text, obj9);
  obj7[4] = items2;
  items1[1] = callback2(require(4844) /* PressableBase */.PressableOpacity, obj7);
  obj5[1] = items1;
