...
// Dependencies: [19, 17, 21, 9145, 4191, 3959, 712, 4676, 7744, 4251, 1236, 4797, 2]
// Exports: default

// Module 12091 (GuildProfileLoadingError)
import "noop";
...
export default function GuildProfileLoadingError(onPress) {
  let obj = require(9145) /* GuildProfileBackground */;
  ...
  obj[1] = require(9145) /* GuildProfileBackground */.DiagonalGradient.START;
  obj[2] = require(9145) /* GuildProfileBackground */.DiagonalGradient.END;
  let obj4 = require(9145) /* GuildProfileBackground */;
  obj[3] = obj4.getBackgroundForProfile(tmp2, token);
  const items = [callback(importDefault(4676), obj), , ];
  ...
  obj3[1] = callback(require(7744) /* WarningIcon */.WarningIcon, obj4);
  ...
  const items2 = [callback(require(7744) /* WarningIcon */.WarningIcon, obj8), ];
  ...
  obj7[4] = items2;
  items1[1] = callback2(require(4797) /* PressableBase */.PressableOpacity, obj7);
  obj5[1] = items1;
