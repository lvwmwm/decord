...
// Dependencies: [19, 17, 21, 9174, 4221, 3988, 712, 4706, 5700, 4281, 1236, 2]
// Exports: default

// Module 9173 (RestrictedGuildProfileView)
import "noop";
...
export default function RestrictedGuildProfileView() {
  ...
  obj3[0] = require(5700) /* GuildIconSizes */.GuildIconSizes.XXLARGE;
  obj3[3] = styles.restrictedAcronym;
  obj2[1] = callback(importDefault(5700), obj3);
