...
// Dependencies: [19, 17, 21, 9302, 4280, 4065, 712, 4765, 5818, 4340, 1236, 2]
// Exports: default

// Module 9301 (RestrictedGuildProfileView)
import "noop";
...
export default function RestrictedGuildProfileView() {
  ...
  obj3[0] = require(5818) /* GuildIconSizes */.GuildIconSizes.XXLARGE;
  obj3[3] = styles.restrictedAcronym;
  obj2[1] = callback(importDefault(5818), obj3);
  ...
  const items1 = [callback(require(4340) /* Text */.Text, obj5), ];
  ...
  items1[1] = callback(require(4340) /* Text */.Text, obj6);
  obj4[1] = items1;
