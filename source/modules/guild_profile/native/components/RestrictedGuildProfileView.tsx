...
// Dependencies: [19, 17, 21, 9191, 4238, 4005, 712, 4723, 5719, 4298, 1236, 2]
// Exports: default

// Module 9190 (RestrictedGuildProfileView)
import "noop";
...
export default function RestrictedGuildProfileView() {
  ...
  obj3[0] = require(5719) /* GuildIconSizes */.GuildIconSizes.XXLARGE;
  obj3[3] = styles.restrictedAcronym;
  obj2[1] = callback(importDefault(5719), obj3);
  ...
  const items1 = [callback(require(4298) /* Text */.Text, obj5), ];
  ...
  items1[1] = callback(require(4298) /* Text */.Text, obj6);
  obj4[1] = items1;
