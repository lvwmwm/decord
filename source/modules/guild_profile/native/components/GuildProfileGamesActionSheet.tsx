...
// Dependencies: [19, 17, 21, 9272, 9283, 5374, 12199, 4303, 12203, 12204, 7404, 1236, 4271, 9253, 1988, 5397, 5399, 5767, 2]
// Exports: default

// Module 12205 (GuildProfileGameRow)
...
function GuildProfileGameRow(activityLevel) {
  ...
  obj[1] = _require(9283).GameProfileSources.GuildProfileGames;
  obj[2] = clickable;
  const tmp3Result = importDefault(9272)(obj);
  _require = tmp3Result;
  if (clickable) {
    clickable = null != tmp3Result;
  }
  obj = { icon: null, label: null, arrow: null, onPress: null };
  obj[0] = jsx(importDefault(12199), { game, activityLevel: activityLevel.activityLevel });
  obj[1] = game.name;
  obj[2] = clickable;
  let fn;
  if (clickable) {
  ...
  obj[3] = fn;
  return jsx(_require(5374).TableRow, { icon: null, label: null, arrow: null, onPress: null });
}
