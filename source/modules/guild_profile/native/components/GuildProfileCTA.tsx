...
export default function GuildProfileCTA(profile) {
  ...
  const memo = React.useMemo(() => ({ <string:2812997771>: 0., <string:1672384813>: 0.000000000000000015616123804679256, <string:1362501123>: 131072.029296875 }), []);
  if (flag) {
