    ...
    if (null != invite) {
      if (invite.state !== validInviteKey.BANNED) {
        if (invite.state !== validInviteKey.EXPIRED) {
          ...
          obj.isBypassInvite = id(1360).hasFlag(num2, id(6652).GuildInviteFlags.IS_APPLICATION_BYPASS);
  ...
  if (null != invite) {
    ...
    if (invite.state !== constants.BANNED) {
      ...
      if (invite.state !== constants.EXPIRED) {
        ...
        flag = obj.hasFlag(num2, _Set(6652).GuildInviteFlags.IS_APPLICATION_BYPASS);
