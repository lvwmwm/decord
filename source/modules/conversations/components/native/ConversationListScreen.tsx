...
// Function ID: 8365
// Name: renderItem
// Dependencies: [5, 32, 19, 17, 6949, 6951, 21, 4255, 712, 8365, 4251, 1236, 1483, 1581, 8338, 589, 11, 8339, 8341, 7638, 2]
// Exports: default

// Module 8364 (renderItem)
...
function renderItem(item) {
  item = item.item;
  return jsx(importDefault(8365), { channelId: item.channelId, conversationId: item.conversationId });
}
