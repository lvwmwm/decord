...
// Dependencies: [19, 21, 4663, 712, 8368, 8278, 4251, 1236, 2]
// Exports: default

// Module 8367 (ConversationPreviewBlockedMessage)
import "noop";
...
export default function ConversationPreviewBlockedMessage(reason) {
  ...
  if ("blocked" === reason.reason) {
    let EyeSlashIcon = tmp2(8368).DenyIcon;
  } else {
    EyeSlashIcon = tmp2(8278).EyeSlashIcon;
  }
  ...
  obj[3] = items;
  return closure_4(require(4663) /* Stack */.Stack, obj);
};
