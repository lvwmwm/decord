...
// Dependencies: [19, 17, 1372, 21, 4255, 712, 589, 4445, 8165, 2]
// Exports: default

// Module 8363 (ConversationNavigatorHeader)
import "noop";
...
export default function ConversationNavigatorHeader(channelId) {
  ...
  const tmp3 = importDefault(4445)(stateFromStores, true);
  ...
  obj[1] = tmp3;
  obj[1] = jsx(channelId(8165).GenericHeaderTitle, { title: channelId.title, subtitle: null, variant: "heading-lg/semibold", subtitleColor: "text-muted" });
