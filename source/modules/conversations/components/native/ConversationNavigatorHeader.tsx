...
// Dependencies: [19, 17, 1372, 21, 4285, 712, 589, 4475, 8305, 2]
// Exports: default

// Module 8504 (ConversationNavigatorHeader)
import "noop";
...
export default function ConversationNavigatorHeader(channelId) {
  ...
  const tmp3 = importDefault(4475)(stateFromStores, true);
  ...
  obj[1] = tmp3;
  obj[1] = jsx(channelId(8305).GenericHeaderTitle, { title: channelId.title, subtitle: null, variant: "heading-lg/semibold", subtitleColor: "text-muted" });
