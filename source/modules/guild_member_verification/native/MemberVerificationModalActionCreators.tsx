// Module ID: 8484
// Function ID: 8485
// Dependencies: [4855, 676, 698, 5395, 4572, 8485, 2007, 2]
...
export default {
  openMemberVerificationModal(guildId, connect) {
    ...
    importDefault(4572).pushLazy(require(2007) /* asyncRequireImpl */(8485, dependencyMap.paths), obj, closure_4);
  },
