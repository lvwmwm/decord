// Module ID: 8353
// Function ID: 8354
// Dependencies: [4790, 676, 698, 5333, 4507, 8354, 1988, 2]
...
export default {
  openMemberVerificationModal(guildId, connect) {
    ...
    importDefault(4507).pushLazy(require(1988) /* asyncRequireImpl */(8354, dependencyMap.paths), obj, closure_4);
  },
