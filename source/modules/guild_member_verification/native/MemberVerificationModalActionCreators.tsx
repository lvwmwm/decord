// Module ID: 8336
// Function ID: 8337
// Dependencies: [4773, 676, 698, 5317, 4490, 8337, 1988, 2]
...
export default {
  openMemberVerificationModal(guildId, connect) {
    ...
    importDefault(4490).pushLazy(require(1988) /* asyncRequireImpl */(8337, dependencyMap.paths), obj, closure_4);
  },
