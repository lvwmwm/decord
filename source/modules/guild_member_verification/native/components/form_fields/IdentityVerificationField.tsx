...
// Dependencies: [19, 17, 21, 4255, 712, 4251, 4207, 4666, 1236, 4075, 9359, 4461, 9414, 1959, 9417, 9443, 9390, 2]
// Exports: default

// Module 9358 (BaseIdentityVerificationField)
import "noop";
...
function BaseIdentityVerificationField(icon) {
  ...
  if (passesVerification) {
    ...
    obj1[4] = onPress;
    obj[1] = tmp6(tmp7(4666).Button, obj1);
    tmp9 = obj;
  }
...
export default function IdentityVerificationField(arg0) {
  ...
  if (require(4075) /* MAX_RESULTS_PER_PAGE */.UserVerificationFieldPlatforms.EMAIL === platform) {
    ...
    if (tmp(4075).UserVerificationFieldPlatforms.EMAIL === platform) {
      let EnvelopeIcon = tmp(9443).EnvelopeIcon;
    } else if (tmp(4075).UserVerificationFieldPlatforms.PHONE === platform) {
      EnvelopeIcon = tmp(9390).MobilePhoneIcon;
    } else {
      EnvelopeIcon = tmp(9443).EnvelopeIcon;
    }
    if (tmp(4075).UserVerificationFieldPlatforms.EMAIL === platform) {
      let fn = () => {
