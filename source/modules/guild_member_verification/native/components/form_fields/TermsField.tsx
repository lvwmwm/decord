...
// Function ID: 8497
// Name: TermsField
// Dependencies: [19, 17, 21, 4342, 5371, 8497, 1236, 2]
// Exports: default

// Module 8496 (TermsField)
import "noop";
...
export default function TermsField(field) {
  ...
  const items = [callback(importDefault(5371), { rules: field.values, rulesChannelId }), ];
  if (flag == null) {
    flag = false;
  }
  ...
  obj[4] = onChange;
  items[1] = callback(require(8497) /* TableCheckboxRow */.TableCheckboxRow, obj);
  obj[1] = items;
