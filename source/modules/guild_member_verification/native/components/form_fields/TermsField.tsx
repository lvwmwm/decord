...
// Function ID: 8371
// Name: TermsField
// Dependencies: [19, 17, 21, 4285, 5314, 8371, 1236, 2]
// Exports: default

// Module 8370 (TermsField)
import "noop";
...
export default function TermsField(field) {
  ...
  const items = [callback(importDefault(5314), { rules: field.values, rulesChannelId }), ];
  if (flag == null) {
    flag = false;
  }
  ...
  obj[4] = onChange;
  items[1] = callback(require(8371) /* TableCheckboxRow */.TableCheckboxRow, obj);
  obj[1] = items;
