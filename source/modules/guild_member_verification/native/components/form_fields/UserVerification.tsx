...
// Dependencies: [19, 21, 4255, 4075, 8233, 4251, 1236, 2]
// Exports: default

// Module 8232 (UserVerification)
import "noop";
...
export default function UserVerification(arg0) {
  ...
  if (null == field.platform) {
    ...
    if (tmp5) {
      ...
      tmp5 = callback(importDefault(8233), obj);
      const tmp4 = importDefault(8233);
    }
    const items = [tmp5, , ];
    ...
    items[1] = callback(importDefault(8233), obj);
