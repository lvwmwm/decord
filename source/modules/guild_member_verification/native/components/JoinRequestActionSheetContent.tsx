...
// Dependencies: [19, 17, 1372, 5397, 5716, 21, 4302, 712, 8775, 8765, 8763, 8772, 8723, 15610, 8779, 8782, 9384, 12268, 12444, 589, 11923, 4120, 4712, 4798, 1236, 4121, 12212, 4298, 5936, 3971, 11, 4263, 5149, 7691, 4254, 4256, 1609, 15613, 2]

// Module 15612 (OpenInterviewButton)
...
let closure_14 = importAllResult.memo((joinRequest) => {
  ...
  const tmp = callback3();
  if (applicationStatus === require(4121) /* MAX_RESULTS_PER_PAGE */.GuildJoinRequestApplicationStatuses.SUBMITTED) {
  ...
  if (require(4121) /* MAX_RESULTS_PER_PAGE */.GuildJoinRequestApplicationStatuses.REJECTED === applicationStatus) {
...
let closure_16 = importAllResult.memo((arg0) => {
  ...
  if (require(4121) /* MAX_RESULTS_PER_PAGE */.VerificationFormFieldTypes.TERMS === field_type) {
    const items = [, , ];
...
let closure_17 = importAllResult.memo((arg0) => {
  ...
  const items1 = [callback(require(4298) /* Text */.Text, obj2), ];
  const obj3 = { variant: "text-sm/normal", color: "text-subtle", children: null };
  let obj6 = require(3971) /* resetCache */;
  ...
  const items3 = [callback(require(4298) /* Text */.Text, obj6), ];
  ...
  const obj13 = require(3971) /* resetCache */;
