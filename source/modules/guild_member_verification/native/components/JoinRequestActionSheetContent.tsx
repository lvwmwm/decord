...
// Dependencies: [19, 17, 1372, 5398, 5776, 21, 4303, 712, 8835, 8825, 8823, 8832, 8783, 15685, 8839, 8842, 9449, 12335, 12511, 589, 11989, 4126, 4714, 4800, 1236, 4127, 12279, 4299, 5996, 3971, 11, 4264, 5150, 7751, 4255, 4257, 1609, 15688, 2]

// Module 15687 (OpenInterviewButton)
...
let closure_14 = importAllResult.memo((joinRequest) => {
  ...
  const tmp = callback3();
  if (applicationStatus === require(4127) /* MAX_RESULTS_PER_PAGE */.GuildJoinRequestApplicationStatuses.SUBMITTED) {
  ...
  if (require(4127) /* MAX_RESULTS_PER_PAGE */.GuildJoinRequestApplicationStatuses.REJECTED === applicationStatus) {
