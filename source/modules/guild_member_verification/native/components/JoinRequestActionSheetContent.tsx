...
function OpenInterviewButton(arg0) {
  ...
  if (!obj3.isActionedApplicationStatus(joinRequest.applicationStatus)) {
    ...
    obj.icon = callback(interviewChannelId(4630).ChatIcon, obj);
    if (null == label) {
    ...
    let tmp4Result = callback(interviewChannelId(4544).Button, obj);
    const tmp4 = callback;
  } else {
    tmp4Result = null;
  }
...
let closure_12 = importAllResult.memo((user) => {
  ...
  const tmp = joinRequest(8017)();
  const tmp3 = joinRequest(8015)({ user, displayProfile });
  ...
  if (null != user) {
    ...
    const items1 = [callback(joinRequest(8039), obj), ];
    const obj1 = {};
    ...
    obj2.onPress = tmp5;
    const items2 = [callback(joinRequest(8042), obj2), ];
...
let closure_13 = importAllResult.memo((joinRequest) => {
  ...
  if (require(3951) /* isTermsFormField */.GuildJoinRequestApplicationStatuses.REJECTED === applicationStatus) {
    ...
    const items2 = [callback(require(6679) /* CircleXIcon */.CircleXIcon, obj7), ];
    const obj8 = {};
    ...
    if (tmp56) {
      ...
      tmp56 = callback(require(4127) /* Text */.Text, obj15);
    }
    items3[2] = tmp56;
  ...
  } else if (require(3951) /* isTermsFormField */.GuildJoinRequestApplicationStatuses.APPROVED === applicationStatus) {
    ...
    const items6 = [callback(require(4092) /* CircleCheckIcon */.CircleCheckIcon, obj19), ];
    const obj20 = {};
    ...
    const items7 = [callback(require(4127) /* Text */.Text, obj21), ];
...
let closure_14 = importAllResult.memo((joinRequest) => {
  ...
  items1[1] = callback(joinRequest(6625).IconButton, obj2);
  ...
  if (tmp4) {
    ...
    obj4.icon = callback(joinRequest(4630).ChatIcon, obj5);
    ...
    tmp4 = callback(joinRequest(6625).IconButton, obj4);
  }
  items1[2] = tmp4;
  obj.children = items1;
  return closure_9(joinRequest(4966).ButtonGroup, obj);
});
let closure_15 = importAllResult.memo((arg0) => {
  ...
  if (require(3951) /* isTermsFormField */.VerificationFormFieldTypes.TERMS === field_type) {
    ...
    items1[1] = callback(require(4092) /* CircleCheckIcon */.CircleCheckIcon, obj1);
    obj.children = items1;
    return closure_9(View, obj);
  } else if (require(3951) /* isTermsFormField */.VerificationFormFieldTypes.MULTIPLE_CHOICE === field_type) {
    const obj2 = {};
    ...
    const items4 = [callback(require(4127) /* Text */.Text, obj7), ];
    const obj8 = {};
    ...
    obj8.children = callback(require(4127) /* Text */.Text, obj);
...
let closure_16 = importAllResult.memo((arg0) => {
  ...
  let obj6 = require(3801) /* resetCache */;
  ...
  const items3 = [callback(require(4127) /* Text */.Text, obj6), ];
  ...
  const obj13 = require(3801) /* resetCache */;
  obj7.children = obj13.dateFormat(new Date(joinRequest.createdAt), "LL");
  items3[1] = callback(require(4127) /* Text */.Text, obj7);
...
const memoResult = importAllResult.memo(function JoinRequestActionSheetContent(displayProfile) {
  ...
  if (joinRequest.applicationStatus === joinRequest(3951).GuildJoinRequestApplicationStatuses.SUBMITTED) {
    obj = {};
