...
// Dependencies: [19, 17, 1391, 6951, 7186, 21, 4661, 712, 8982, 8972, 8970, 8979, 8929, 15834, 8987, 8990, 9285, 12169, 12346, 589, 11804, 4199, 4745, 6867, 1236, 4200, 11400, 4734, 7341, 4063, 11, 4335, 6687, 8035, 4326, 4328, 1629, 15837, 2]
...
let closure_14 = importAllResult.memo((joinRequest) => {
  ...
  const tmp = callback3();
  if (applicationStatus === require(4200) /* MAX_RESULTS_PER_PAGE */.GuildJoinRequestApplicationStatuses.SUBMITTED) {
  ...
  if (require(4200) /* MAX_RESULTS_PER_PAGE */.GuildJoinRequestApplicationStatuses.REJECTED === applicationStatus) {
...
let closure_17 = importAllResult.memo((arg0) => {
  ...
  let obj6 = require(4063) /* resetCache */;
  ...
  const items3 = [callback(require(4734) /* Text */.Text, obj6), ];
  ...
  const obj13 = require(4063) /* resetCache */;
