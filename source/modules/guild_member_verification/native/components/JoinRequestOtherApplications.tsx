...
// Dependencies: [19, 17, 21, 4342, 712, 4168, 4303, 6039, 15779, 4338, 1236, 15775, 4031, 2]

// Module 15778 (ApplicationStatusIcon)
...
function ApplicationStatusIcon(status) {
  ...
  if (require(4168) /* MAX_RESULTS_PER_PAGE */.GuildJoinRequestApplicationStatuses.APPROVED === status) {
