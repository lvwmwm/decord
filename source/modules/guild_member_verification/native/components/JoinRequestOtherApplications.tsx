...
// Dependencies: [19, 17, 21, 4661, 712, 4200, 4335, 7341, 15838, 4734, 1236, 15834, 4063, 2]
...
function ApplicationStatusIcon(status) {
  ...
  if (require(4200) /* MAX_RESULTS_PER_PAGE */.GuildJoinRequestApplicationStatuses.APPROVED === status) {
