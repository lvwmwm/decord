...
// Dependencies: [19, 17, 21, 4344, 712, 4170, 4305, 6037, 15770, 4340, 1236, 15766, 4031, 2]
...
function ApplicationStatusIcon(status) {
  ...
  if (require(4170) /* MAX_RESULTS_PER_PAGE */.GuildJoinRequestApplicationStatuses.APPROVED === status) {
