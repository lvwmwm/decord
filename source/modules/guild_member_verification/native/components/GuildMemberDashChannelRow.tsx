...
// Dependencies: [19, 676, 1379, 10280, 21, 4189, 712, 15176, 9152, 4009, 1222, 11474, 1236, 4703, 1297, 2]
// Exports: default

// Module 15175 (GuildMemberDashChannelRow)
...
export default function GuildMemberDashChannelRow(arg0) {
  ...
  const ChannelModes = tmp2(11474).ChannelModes;
  ...
  obj[1] = tmp7;
  obj[6] = jsx(id(11474).BaseChannelName, { name: null, mode: null });
  const obj1 = { mode: tmp7, IconComponent: null };
  obj1[1] = id(4703).GroupIcon;
  obj[7] = jsx(id(11474).BaseChannelIcon, { mode: tmp7, IconComponent: null });
  let tmp8Result = null;
  if (num > 0) {
  ...
  obj[8] = tmp8Result;
  return jsx(hasItem(11474), { name: null, mode: null });
};
