...
// Dependencies: [19, 676, 1398, 10121, 21, 4445, 712, 15716, 7594, 4270, 1222, 11865, 1236, 4990, 1297, 2]
// Exports: default

// Module 15715 (GuildMemberDashChannelRow)
...
export default function GuildMemberDashChannelRow(arg0) {
  ...
  const ChannelModes = tmp2(11865).ChannelModes;
  ...
  obj[1] = tmp7;
  obj[6] = jsx(id(11865).BaseChannelName, { name: null, mode: null });
  const tmp9 = hasItem(11865);
  obj[7] = jsx(id(11865).BaseChannelIcon, { mode: tmp7, IconComponent: id(4990).GroupIcon });
  let tmp8Result = null;
  if (num > 0) {
