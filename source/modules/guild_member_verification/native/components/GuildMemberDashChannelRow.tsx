...
// Dependencies: [19, 676, 1398, 9844, 21, 4342, 712, 15420, 8476, 4168, 1222, 11811, 1236, 4858, 1297, 2]
// Exports: default

// Module 15419 (GuildMemberDashChannelRow)
...
export default function GuildMemberDashChannelRow(arg0) {
  ...
  const ChannelModes = tmp2(11811).ChannelModes;
  ...
  obj[1] = tmp7;
  obj[6] = jsx(id(11811).BaseChannelName, { name: null, mode: null });
  const obj1 = { mode: tmp7, IconComponent: null };
  obj1[1] = id(4858).GroupIcon;
  obj[7] = jsx(id(11811).BaseChannelIcon, { mode: tmp7, IconComponent: null });
  let tmp8Result = null;
  if (num > 0) {
  ...
  obj[8] = tmp8Result;
  return jsx(hasItem(11811), { name: null, mode: null });
};
