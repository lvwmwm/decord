...
// Dependencies: [19, 676, 1379, 10284, 21, 4189, 712, 15182, 9156, 4009, 1222, 11478, 1236, 4703, 1297, 2]
// Exports: default

// Module 15181 (GuildMemberDashChannelRow)
...
export default function GuildMemberDashChannelRow(arg0) {
  ...
  const ChannelModes = tmp2(11478).ChannelModes;
  ...
  obj[1] = tmp7;
  obj[6] = jsx(id(11478).BaseChannelName, { name: null, mode: null });
  const obj1 = { mode: tmp7, IconComponent: null };
  obj1[1] = id(4703).GroupIcon;
  obj[7] = jsx(id(11478).BaseChannelIcon, { mode: tmp7, IconComponent: null });
  let tmp8Result = null;
  if (num > 0) {
  ...
  obj[8] = tmp8Result;
  return jsx(hasItem(11478), { name: null, mode: null });
};
