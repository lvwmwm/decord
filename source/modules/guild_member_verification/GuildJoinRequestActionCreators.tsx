...
// Dependencies: [5, 1376, 6812, 4073, 676, 4075, 709, 530, 7216, 4593, 1236, 5081, 2]

// Module 8210 (_fetchGuildJoinRequests)
...
export default {
  ...
  setSelectedGuildJoinRequest(guildId, request) {
    if (null != request) {
      let obj = require(7216) /* trackMemberApplicationViewed */;
