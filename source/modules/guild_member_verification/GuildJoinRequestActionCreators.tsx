...
// Dependencies: [5, 1352, 5696, 3983, 653, 3985, 686, 507, 6159, 4505, 1212, 4979, 2]

// Module 9132 (_fetchGuildJoinRequests)
...
export default {
  ...
  setSelectedGuildJoinRequest(guildId, request) {
    if (null != request) {
      let obj = require(6159) /* trackMemberApplicationViewed */;
      obj = { guildId };
