...
// Dependencies: [5, 1395, 7428, 4198, 676, 4200, 709, 530, 7607, 4827, 1236, 4975, 2]
          ...
          if (0 === c7) {
            if (arg0 === 1) {
              ...
              if (APPROVED === undefined) {
                APPROVED = callback(4200).GuildJoinRequestApplicationStatuses.APPROVED;
              }
...
export default {
  ...
  setSelectedGuildJoinRequest(guildId, request) {
    if (null != request) {
      let obj = require(7607) /* trackMemberApplicationViewed */;
