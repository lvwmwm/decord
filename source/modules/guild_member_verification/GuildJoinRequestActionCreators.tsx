...
// Dependencies: [5, 1376, 6839, 4102, 676, 4104, 709, 530, 7243, 4623, 1236, 5111, 2]

// Module 8350 (_fetchGuildJoinRequests)
          ...
          if (0 === c7) {
            if (arg0 === 1) {
              ...
              if (APPROVED === undefined) {
                APPROVED = callback(4104).GuildJoinRequestApplicationStatuses.APPROVED;
              }
...
export default {
  ...
  setSelectedGuildJoinRequest(guildId, request) {
    if (null != request) {
      let obj = require(7243) /* trackMemberApplicationViewed */;
