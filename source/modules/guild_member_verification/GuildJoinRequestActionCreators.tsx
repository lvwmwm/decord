...
// Dependencies: [5, 1376, 6858, 4119, 676, 4121, 709, 530, 7262, 4640, 1236, 5128, 2]

// Module 8367 (_fetchGuildJoinRequests)
          ...
          if (0 === c7) {
            if (arg0 === 1) {
              ...
              if (APPROVED === undefined) {
                APPROVED = callback(4121).GuildJoinRequestApplicationStatuses.APPROVED;
              }
...
export default {
  ...
  setSelectedGuildJoinRequest(guildId, request) {
    if (null != request) {
      let obj = require(7262) /* trackMemberApplicationViewed */;
