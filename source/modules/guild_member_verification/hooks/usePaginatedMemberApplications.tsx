...
// Function ID: 16509
// Name: result
// Dependencies: [5, 32, 19, 4305, 11, 5496, 4379, 2]
              ...
              if (!ref.current) {
                ...
                if (!ref3.current) {
                  ...
                  const merged = Object.assign((function getRequestPaginationParams(closure_0, aPIError, arg2, arg3, flag) {
                    const tmp2 = arg3 === callback(4305).GuildJoinRequestApplicationStatuses.SUBMITTED;
                    if (arg2 === callback(4305).GuildJoinRequestSortOrders.TIMESTAMP_DESC) {
                      if (!flag) {
