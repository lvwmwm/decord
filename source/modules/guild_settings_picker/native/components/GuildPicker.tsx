...
// Function ID: 13150
// Name: GuildPicker
// Dependencies: [19, 21, 13150, 13151, 4253, 8890, 1959, 1236, 2]
// Exports: default

// Module 13149 (GuildPicker)
import "noop";
...
export default function GuildPicker(isGuildIncluded) {
  ...
  let dependencyMap;
  ({ options: c2, selectedGuild } = onChange(13150)({ isGuildIncluded: isGuildIncluded.isGuildIncluded, selectedGuildId: guildId }));
  let name;
  const tmp2 = onChange(13150)({ isGuildIncluded: isGuildIncluded.isGuildIncluded, selectedGuildId: guildId });
  const tmp3 = jsx;
  ...
  return tmp3(onChange(13151), obj);
};
