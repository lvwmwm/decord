...
// Function ID: 13873
// Name: GuildPicker
// Dependencies: [19, 21, 13873, 13874, 4445, 9381, 2008, 1233, 2]
// Exports: default

// Module 13872 (GuildPicker)
...
export default function GuildPicker(isGuildIncluded) {
  ...
  ({ options: c2, selectedGuild } = onChange(13873)({ isGuildIncluded: isGuildIncluded.isGuildIncluded, selectedGuildId: guildId }));
  let name;
