...
// Function ID: 13309
// Name: GuildPicker
// Dependencies: [19, 21, 13309, 13310, 4312, 9013, 2007, 1236, 2]
// Exports: default

// Module 13308 (GuildPicker)
import "noop";
...
export default function GuildPicker(isGuildIncluded) {
  ...
  let dependencyMap;
  ({ options: c2, selectedGuild } = onChange(13309)({ isGuildIncluded: isGuildIncluded.isGuildIncluded, selectedGuildId: guildId }));
  let name;
  const tmp2 = onChange(13309)({ isGuildIncluded: isGuildIncluded.isGuildIncluded, selectedGuildId: guildId });
  const tmp3 = jsx;
  ...
  return tmp3(onChange(13310), obj);
};
