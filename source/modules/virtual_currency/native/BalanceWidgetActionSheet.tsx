...
let closure_12 = arg1(dependencyMap[26]).createStyles((color) => {
  let obj = {};
  obj = { gap: importDefault(dependencyMap[13]).space.PX_12, paddingTop: importDefault(dependencyMap[13]).space.PX_12, paddingHorizontal: importDefault(dependencyMap[13]).space.PX_16 };
  obj.actions = obj;
