...
// Function ID: 14893
// Name: BalanceWidget
// Dependencies: [19, 17, 676, 678, 1369, 5113, 21, 1348, 4797, 4251, 1236, 9887, 1358, 698, 11052, 5116, 14893, 9311, 4223, 10037, 1959, 5615, 6894, 10036, 4071, 4680, 4255, 712, 2]
// Exports: default

// Module 14892 (BalanceWidget)
import ref from "ref";
import { View } from "module_9311";
...
function BalanceWidgetMenu(style) {
  ...
  obj[3] = closure_10(importDefault(10036), { balance: str, onPress: callback, accessible: false });
...
export default function BalanceWidgetMenuWrapper(style) {
  let obj = require(9311);
  const balance = obj.useFetchVirtualCurrencyBalance().balance;
  require(4071) /* UNSAFE_isDismissibleContentDismissed */;
  if (null == balance) {
    ...
    obj[1] = callback(tmp3(4680).Ellipsis, { variant: "primary", size: "sm" });
