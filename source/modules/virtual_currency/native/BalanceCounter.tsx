...
class BalanceCounter {
  constructor(arg0) {
    ...
    obj = { isAnimating: first, animatedValue: sharedValue, runOnJS: require("module_4050").runOnJS, setDisplayValue: tmp5, setMaxDigits: tmp7 };
    F.__closure = obj;
    ...
    if (null !== value) {
      ...
      tmp14 = c9(require("module_4050").View, obj1);
    }
    return tmp14;
  }
}
