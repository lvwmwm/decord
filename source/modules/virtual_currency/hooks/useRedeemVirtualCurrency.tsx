...
// Dependencies: [5, 32, 19, 4172, 8724, 3857, 5678, 3850, 8722, 1236, 2]
// Exports: useRedeemVirtualCurrency

// Module 8723 (useRedeemVirtualCurrency)
import set from "set";
...
export const useRedeemVirtualCurrency = function useRedeemVirtualCurrency(order) {
  ...
  const enabled = entitlements(8724).useConfig({ location: "orb_checkout_modal" }).enabled;
  order = undefined;
  if (order != null) {
    order = order.order;
  }
            ...
            if (0 === c13) {
              if (arg0 === 1) {
                ...
                if (null == outer1_7) {
                  ...
                  throwTypeErrorResult = new.target;
                  throwTypeErrorResult = new entitlements(3857)("Order not created yet");
                  ...
                  obj3[0] = callback(5678).signOrder(obj2);
                  return obj3;
                }
              }
            } else {
              if (1 === tmp10) {
                ...
                if (onSignFailure instanceof callback(5678).OrderSigningFailedWithConstraintsError) {
                  ...
                  if (onSignFailure instanceof entitlements(3857)) {
                    throwTypeErrorResult = onSignFailure;
                  } else {
                    throwTypeErrorResult = onSignFailure;
                    throwTypeErrorResult = new.target;
                    throwTypeErrorResult = new.target;
                    throwTypeErrorResult = new entitlements(3857)(onSignFailure);
                  }
                  throwTypeErrorResult = closure_9;
                  throwTypeErrorResult = closure_10;
              ...
              const orderProcessingPendingError = new callback(5678).OrderProcessingPendingError();
