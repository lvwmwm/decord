...
// Dependencies: [19, 17, 21, 4342, 712, 4753, 7838, 4338, 12202, 1236, 12204, 12221, 5903, 4278, 12223, 4755, 1363, 9458, 2]
...
// Module 12222 (OrbCheckoutErrorCard)
...
export const OrbCheckoutErrorCard = function OrbCheckoutErrorCard(children) {
  ...
  const items = [callback(require(7838) /* CircleErrorIcon */.CircleErrorIcon, { size: "sm", color: "mobile-text-heading-primary" }), callback(require(4338) /* Text */.Text, { variant: "text-sm/medium", color: "mobile-text-heading-primary", children: children.error })];
  obj[3] = items;
...
export const OrbCheckoutOrderSummary = function OrbCheckoutOrderSummary(product) {
  ...
  if (null == product) {
    ...
    obj[0] = product;
    tmp5 = callback(importDefault(12202), obj);
    tmp6 = callback;
  }
...
export const OrbCheckoutPaymentSourceDetails = function OrbCheckoutPaymentSourceDetails(orbAmount) {
  ...
  const items2 = [callback(require(4338) /* Text */.Text, obj1), callback(importDefault(12204), { orbAmount: orbAmount.orbBalance })];
  obj[1] = items2;
...
export const OrbCheckoutPurchaseButton = function OrbCheckoutPurchaseButton(onPress) {
  ...
  const virtualCurrencyBalance = require(12223) /* useVirtualCurrencyBalance */.useVirtualCurrencyBalance();
  ...
  obj[3] = closure_6(require(9458) /* OrbsIcon */.OrbsIcon, { size: "md", color: str2 });
  obj[5] = isRedeeming;
  ...
  obj[7] = isRedeeming;
  return closure_6(require(4755) /* Button */.Button, obj);
};
