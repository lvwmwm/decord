...
// Dependencies: [19, 17, 21, 4344, 712, 4752, 7834, 4340, 12200, 1236, 12202, 12219, 5901, 4280, 12221, 4754, 1363, 9454, 2]
...
// Module 12220 (OrbCheckoutErrorCard)
...
export const OrbCheckoutErrorCard = function OrbCheckoutErrorCard(children) {
  ...
  const items = [callback(require(7834) /* CircleErrorIcon */.CircleErrorIcon, { size: "sm", color: "mobile-text-heading-primary" }), callback(require(4340) /* Text */.Text, { variant: "text-sm/medium", color: "mobile-text-heading-primary", children: children.error })];
  obj[3] = items;
...
export const OrbCheckoutOrderSummary = function OrbCheckoutOrderSummary(product) {
  ...
  if (null == product) {
    ...
    obj[0] = product;
    tmp5 = callback(importDefault(12200), obj);
    tmp6 = callback;
  }
  ...
  const items1 = [tmp6(require(4340) /* Text */.Text, obj1), tmp5];
  obj[1] = items1;
...
export const OrbCheckoutPaymentSourceDetails = function OrbCheckoutPaymentSourceDetails(orbAmount) {
  ...
  const items2 = [callback(require(4340) /* Text */.Text, obj1), callback(importDefault(12202), { orbAmount: orbAmount.orbBalance })];
  obj[1] = items2;
...
export const OrbCheckoutPurchaseButton = function OrbCheckoutPurchaseButton(onPress) {
  ...
  const virtualCurrencyBalance = require(12221) /* useVirtualCurrencyBalance */.useVirtualCurrencyBalance();
  ...
  obj[3] = closure_6(require(9454) /* OrbsIcon */.OrbsIcon, { size: "md", color: str2 });
  obj[5] = isRedeeming;
  ...
  obj[7] = isRedeeming;
  return closure_6(require(4754) /* Button */.Button, obj);
};
