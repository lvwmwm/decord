...
// Dependencies: [19, 676, 505, 21, 12162, 10119, 4712, 12163, 10471, 7377, 698, 12164, 4509, 7809, 7810, 11339, 38, 514, 1236, 5270, 11341, 2]
// Exports: default

// Module 12161 (OrbCheckoutModalContent)
...
function OrbCheckoutModalContent(orbBalance) {
  ...
  let skuId;
  let obj = require(12162) /* useOrbCheckoutModalContextProvider */;
  const orbCheckoutModalContext = obj.useOrbCheckoutModalContext();
  ({ orbRedemptionError, skuId } = orbCheckoutModalContext);
  let product = require(10119) /* useFetchCollectiblesProduct */.useFetchCollectiblesProduct(skuId).product;
  ...
  obj = { children: null };
  items[1] = callback4(require(12163) /* OrbCheckoutErrorCard */.OrbCheckoutOrderSummary, { product });
  items[2] = callback4(require(12163) /* OrbCheckoutErrorCard */.OrbCheckoutPaymentSourceDetails, { orbBalance: orbBalance.orbBalance });
  obj[0] = items;
  return closure_12(require(4712) /* Stack */.Stack, obj);
}
function OrbCheckoutModalFooter(onPress) {
  const obj = { children: null };
  const items = [callback4(require(12163) /* OrbCheckoutErrorCard */.OrbCheckoutLegalFinePrint, {}), callback4(require(12163) /* OrbCheckoutErrorCard */.OrbCheckoutPurchaseButton, { onPress: onPress.onPress })];
  obj[0] = items;
  return callback5(require(4712) /* Stack */.Stack, obj);
}
