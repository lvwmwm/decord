...
// Function ID: 13824
// Name: HSVColorPicker
// Dependencies: [19, 17, 21, 4285, 4145, 13824, 13825, 2]
// Exports: default

// Module 13823 (HSVColorPicker)
import "noop";
...
export default function HSVColorPicker(arg0) {
  ...
  const tmp = callback();
  const sharedValue1 = require(4145).useSharedValue(1);
  const obj2 = require(4145);
  obj = { style: tmp.hsvColorPicker, children: null };
  const sharedValue2 = require(4145).useSharedValue(1);
  let tmp11 = hue;
  ...
  obj[7] = onPanUpdate;
  obj[8] = onPanFinalize;
  const items = [closure_4(importDefault(13824), obj), ];
  const tmp10 = importDefault(13824);
  if (hue == null) {
    hue = sharedValue;
  }
  items[1] = closure_4(tmp9(13825), { hue, style: huePickerStyle, colorBarInnerStyle: hueColorBarInnerStyle, sliderStyle: hueSliderStyle, onPanUpdate, onPanFinalize });
  obj[1] = items;
