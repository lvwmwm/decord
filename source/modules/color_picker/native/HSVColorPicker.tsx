...
// Function ID: 13695
// Name: HSVColorPicker
// Dependencies: [19, 17, 21, 4189, 4050, 13695, 13696, 2]
// Exports: default

// Module 13694 (HSVColorPicker)
import "noop";
...
export default function HSVColorPicker(arg0) {
  ...
  const tmp = callback();
  const sharedValue1 = require(4050).useSharedValue(1);
  const obj2 = require(4050);
  obj = { style: tmp.hsvColorPicker, children: null };
  const sharedValue2 = require(4050).useSharedValue(1);
  let tmp11 = hue;
  const obj3 = require(4050);
  ...
  obj[7] = onPanUpdate;
  obj[8] = onPanFinalize;
  const items = [closure_4(importDefault(13695), obj), ];
  const tmp10 = importDefault(13695);
  if (hue == null) {
    hue = sharedValue;
  }
  items[1] = closure_4(tmp9(13696), { hue, style: huePickerStyle, colorBarInnerStyle: hueColorBarInnerStyle, sliderStyle: hueSliderStyle, onPanUpdate, onPanFinalize });
  obj[1] = items;
