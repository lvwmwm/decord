...
// Function ID: 13918
// Name: HSVColorPicker
// Dependencies: [19, 17, 21, 4303, 4042, 13918, 13919, 2]
// Exports: default

// Module 13917 (HSVColorPicker)
import "noop";
...
export default function HSVColorPicker(arg0) {
  ...
  const tmp = callback();
  const sharedValue1 = require(4042).useSharedValue(1);
  const obj2 = require(4042);
  obj = { style: tmp.hsvColorPicker, children: null };
  const sharedValue2 = require(4042).useSharedValue(1);
  let tmp11 = hue;
  ...
  obj[7] = onPanUpdate;
  obj[8] = onPanFinalize;
  const items = [closure_4(importDefault(13918), obj), ];
  const tmp10 = importDefault(13918);
  if (hue == null) {
    hue = sharedValue;
  }
  items[1] = closure_4(tmp9(13919), { hue, style: huePickerStyle, colorBarInnerStyle: hueColorBarInnerStyle, sliderStyle: hueSliderStyle, onPanUpdate, onPanFinalize });
  obj[1] = items;
