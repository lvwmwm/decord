...
// Dependencies: [32, 19, 17, 21, 4285, 712, 13821, 688, 4145, 13822, 4128, 689, 4253, 5377, 5376, 1236, 4695, 7713, 12, 13823, 2]
// Exports: default

// Module 13820 (SuggestedColors)
...
export default function CustomColorPickerActionSheet(arg0) {
  ...
  function updateInputHexValueFromHsv(h) {
    const hsvToRgbWorkletResult = onSelect(13822).hsvToRgbWorklet(h);
    const obj = onSelect(13822);
    dependencyMap(onSelect(4128).rgbToHex(hsvToRgbWorkletResult[0], hsvToRgbWorkletResult[1], hsvToRgbWorkletResult[2]));
  }
  ...
  obj[2] = sharedValue2(onSelect(5376).BottomSheetTitleHeader, obj);
  ...
  obj3[2] = function onChange(first4) {
    ...
    const hex2rgb2hsvResult = onSelect(4128).hex2rgb2hsv(text);
    dependencyMap(text);
  ...
  items3[2] = sharedValue2(tmp16(13823), obj5);
  obj2[1] = items3;
  obj[3] = tmp13(tmp14, obj2);
  return sharedValue2(onSelect(5377).BottomSheet, obj);
};
