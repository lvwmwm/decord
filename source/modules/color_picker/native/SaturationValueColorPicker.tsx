...
// Function ID: 13919
// Name: ColorBox
// Dependencies: [32, 19, 17, 21, 4303, 712, 4042, 13916, 4725, 5427, 2]
// Exports: default

// Module 13918 (ColorBox)
...
function ColorBox(hue) {
  ...
  obj = { hslToRgbWorklet: hue(13916).hslToRgbWorklet, hue };
  S.__closure = obj;
  ...
  obj = { runOnJS: hue(4042).runOnJS, setColor: tmp3 };
  fn.__closure = obj;
