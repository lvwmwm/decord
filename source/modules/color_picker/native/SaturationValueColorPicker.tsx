...
// Function ID: 13825
// Name: ColorBox
// Dependencies: [32, 19, 17, 21, 4285, 712, 4145, 13822, 4706, 5407, 2]
// Exports: default

// Module 13824 (ColorBox)
...
function ColorBox(hue) {
  ...
  obj = { hslToRgbWorklet: hue(13822).hslToRgbWorklet, hue };
  S.__closure = obj;
  ...
  obj = { runOnJS: hue(4145).runOnJS, setColor: tmp3 };
  fn.__closure = obj;
  ...
  const tmp5 = importDefault(4706);
  obj2[1] = callback2(View, { style: items2 });
  obj1[4] = callback2(importDefault(4706), obj2);
