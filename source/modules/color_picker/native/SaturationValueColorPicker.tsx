...
// Function ID: 13911
// Name: ColorBox
// Dependencies: [32, 19, 17, 21, 4303, 712, 4036, 13908, 4725, 5427, 2]
// Exports: default

// Module 13910 (ColorBox)
...
function ColorBox(hue) {
  ...
  obj = { hslToRgbWorklet: hue(13908).hslToRgbWorklet, hue };
  S.__closure = obj;
  ...
  obj = { runOnJS: hue(4036).runOnJS, setColor: tmp3 };
  fn.__closure = obj;
  ...
  const tmp5 = importDefault(4725);
  obj2[1] = callback2(View, { style: items2 });
  obj1[4] = callback2(importDefault(4725), obj2);
