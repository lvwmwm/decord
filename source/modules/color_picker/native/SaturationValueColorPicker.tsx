...
// Function ID: 14526
// Name: ColorBox
// Dependencies: [32, 19, 17, 21, 4481, 709, 4218, 14523, 4948, 6595, 2]
// Exports: default

// Module 14525 (ColorBox)
...
function ColorBox(hue) {
  ...
  obj = { hslToRgbWorklet: hue(14523).hslToRgbWorklet, hue };
  S.__closure = obj;
  ...
  obj = { runOnJS: hue(4218).runOnJS, setColor: tmp3 };
  fn.__closure = obj;
