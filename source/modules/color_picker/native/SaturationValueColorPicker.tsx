...
// Function ID: 14191
// Name: ColorBox
// Dependencies: [32, 19, 17, 21, 4444, 712, 4184, 14188, 4891, 5599, 2]
// Exports: default

// Module 14190 (ColorBox)
...
function ColorBox(hue) {
  ...
  obj = { hslToRgbWorklet: hue(14188).hslToRgbWorklet, hue };
  S.__closure = obj;
  ...
  obj = { runOnJS: hue(4184).runOnJS, setColor: tmp3 };
  fn.__closure = obj;
