...
// Dependencies: [6, 7, 15, 17, 18, 6142, 5074, 1278, 1194, 1348, 4503, 1908, 1918, 1838, 3793, 4177, 1907, 3982, 4360, 653, 6144, 6145, 22, 6156, 5009, 1212, 6157, 1327, 587, 566, 686, 2]

// Module 6141 (_isNativeReflectConstruct)
...
function getGeneralQueryResultTypes() {
  ...
  const items = [require(6145) /* sortByMatchScore */.AutocompleterResultTypes.USER, require(6145) /* sortByMatchScore */.AutocompleterResultTypes.GROUP_DM, require(6145) /* sortByMatchScore */.AutocompleterResultTypes.TEXT_CHANNEL, require(6145) /* sortByMatchScore */.AutocompleterResultTypes.GUILD, require(6145) /* sortByMatchScore */.AutocompleterResultTypes.APPLICATION, , ];
  if (GameProfileInQuickswitcherExperiment.getConfig({ location: "QuickSwitcherStore.handleQuickSwitcherShow" }).enabled) {
    const items1 = [require(6145) /* sortByMatchScore */.AutocompleterResultTypes.GAME_PROFILE];
    let items2 = items1;
  } else {
    items2 = [];
  }
  const arraySpreadResult = HermesBuiltin.arraySpread(items2, 5);
  items[arraySpreadResult] = require(6145) /* sortByMatchScore */.AutocompleterResultTypes.LINK;
  const sum = arraySpreadResult + 1;
  items[sum] = require(6145) /* sortByMatchScore */.AutocompleterResultTypes.IN_APP_NAVIGATION;
  return items;
}
...
function generateResultFromId(arg0) {
  const tmp = importDefault(6156)(arg0);
  let tmp2 = null;
  if (null != tmp) {
    if (null == c30) {
      tmp2 = tmp;
...
function updateResults(arr, arg1) {
  if (require(6145) /* sortByMatchScore */.AutocompleterResultTypes.USER === c30) {
    ...
    arr.unshift(require(6145) /* sortByMatchScore */.createHeaderResult(formatToPlainStringResult));
    let table = arr;
    const obj6 = require(6145) /* sortByMatchScore */;
  } else {
    if (require(6145) /* sortByMatchScore */.AutocompleterResultTypes.TEXT_CHANNEL === tmp) {
      const intl5 = require(1212) /* getSystemLocale */.intl;
      arr.unshift(require(6145) /* sortByMatchScore */.createHeaderResult(intl5.string(require(1212) /* getSystemLocale */.t.W26k4V)));
      table = arr;
      const obj5 = require(6145) /* sortByMatchScore */;
    } else if (require(6145) /* sortByMatchScore */.AutocompleterResultTypes.VOICE_CHANNEL === tmp) {
      const intl4 = require(1212) /* getSystemLocale */.intl;
      arr.unshift(require(6145) /* sortByMatchScore */.createHeaderResult(intl4.string(require(1212) /* getSystemLocale */.t.zUoI5C)));
      table = arr;
      const obj4 = require(6145) /* sortByMatchScore */;
    } else if (require(6145) /* sortByMatchScore */.AutocompleterResultTypes.GUILD === tmp) {
      const intl3 = require(1212) /* getSystemLocale */.intl;
      arr.unshift(require(6145) /* sortByMatchScore */.createHeaderResult(intl3.string(require(1212) /* getSystemLocale */.t.olADPs)));
      table = arr;
      const obj3 = require(6145) /* sortByMatchScore */;
    } else if (require(6145) /* sortByMatchScore */.AutocompleterResultTypes.APPLICATION === tmp) {
      const intl2 = require(1212) /* getSystemLocale */.intl;
      arr.unshift(require(6145) /* sortByMatchScore */.createHeaderResult(intl2.string(require(1212) /* getSystemLocale */.t.VwK1ld)));
      table = arr;
      const obj2 = require(6145) /* sortByMatchScore */;
    } else if (require(6145) /* sortByMatchScore */.AutocompleterResultTypes.GAME_PROFILE === tmp) {
      obj = require(6145) /* sortByMatchScore */;
    ...
    if (arg1 !== closure_32) {
      ...
      let closure_27 = require(6145) /* sortByMatchScore */.findNextSelectedResult(require(6145) /* sortByMatchScore */.FindResultDirections.DOWN, -1, table);
      const obj9 = require(6145) /* sortByMatchScore */;
    } else {
      let tmp36 = null != tmp62;
      if (tmp36) {
        tmp36 = tmp62.type === require(6145) /* sortByMatchScore */.AutocompleterResultTypes.HEADER;
      }
      if (tmp36) {
        closure_27 = require(6145) /* sortByMatchScore */.findNextSelectedResult(require(6145) /* sortByMatchScore */.FindResultDirections.DOWN, closure_27, table);
        const obj8 = require(6145) /* sortByMatchScore */;
      }
    }
    tmp3.emitChange();
  }
  ...
  QUICKSWITCHER_SEARCH: function handleQuickSwitcherSearch(arg0) {
    ...
    if (null == store4) {
      ...
      if (queryMode !== queryMode) {
        ...
        store4.setLimit(num);
        const guildId = store3.getGuildId();
        if (queryMode === require(6145) /* sortByMatchScore */.AutocompleterResultTypes.USER) {
          if (null != tmp9) {
            let obj = {};
        ...
        if (queryMode === require(6145) /* sortByMatchScore */.AutocompleterResultTypes.VOICE_CHANNEL) {
