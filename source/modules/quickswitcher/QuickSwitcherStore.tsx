...
// Dependencies: [4872, 5262, 1302, 1218, 1391, 4680, 1980, 1990, 1910, 3989, 4356, 1979, 4167, 4539, 676, 7348, 12, 7359, 5199, 1236, 7360, 1370, 595, 589, 709, 2]

// Module 7347 (handleConnectionOpen)
import set from "set";
...
function generateResultFromId(arg0) {
  const tmp = importDefault(7359)(arg0);
  let tmp2 = null;
  if (null != tmp) {
    if (null == c26) {
      tmp2 = tmp;
...
function handleQuickSwitcherShow(arg0) {
  ...
  let tmp13 = store;
  if (store == null) {
    tmp13 = importDefault(7348);
    const items1 = [require(7348) /* sortByMatchScore */.AutocompleterResultTypes.USER, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.GROUP_DM, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.TEXT_CHANNEL, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.GUILD, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.APPLICATION, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.GAME_PROFILE, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.LINK, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.IN_APP_NAVIGATION];
    let num = 5;
    if (null != queryMode) {
      num = 100;
    }
...
function handleUserSearchUpdate(arg0, str) {
  ...
  if (!flag) {
    let DOWN = require;
    if (require(7348) /* sortByMatchScore */.AutocompleterResultTypes.USER === c26) {
    ...
    if (null == store) {
      ...
      if (queryMode !== queryMode) {
        if (null != queryMode) {
          ...
          items1 = [require(7348) /* sortByMatchScore */.AutocompleterResultTypes.USER, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.GROUP_DM, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.TEXT_CHANNEL, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.GUILD, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.APPLICATION, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.GAME_PROFILE, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.LINK, require(7348) /* sortByMatchScore */.AutocompleterResultTypes.IN_APP_NAVIGATION];
        }
        ...
        store.setLimit(num);
        const guildId = store4.getGuildId();
        if (queryMode === require(7348) /* sortByMatchScore */.AutocompleterResultTypes.USER) {
          if (null != guildId) {
