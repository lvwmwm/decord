...
// Dependencies: [19, 17, 21, 5840, 4342, 712, 4827, 11170, 8363, 1297, 2]
// Exports: GuildIconWithChannelType

// Module 11169 (GuildIconWithChannelTypeSizes)
...
export const GuildIconWithChannelType = function GuildIconWithChannelType(arg0) {
  ...
  const gap = tmp4.gap;
  const tmp5 = typeIconSize(5840).ImageSizes[guildIconSize];
  dependencyMap = tmp5;
  ...
  obj[1] = typeIconSize(8363).CutoutShape.Circle;
  obj[2] = memo;
  obj[3] = gap;
  obj[4] = sum1;
  obj[5] = sum1;
  ...
  const items3 = [callback(typeIconPadding(5840), obj), ];
  const tmp12 = typeIconPadding(5840);
  ...
  obj[6] = items3;
  return callback2(typeIconSize(11170).Pile, obj);
};
