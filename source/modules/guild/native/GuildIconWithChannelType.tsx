...
// Dependencies: [19, 17, 21, 5719, 4302, 712, 4762, 10203, 8233, 1297, 2]
// Exports: GuildIconWithChannelType

// Module 10202 (GuildIconWithChannelTypeSizes)
...
export const GuildIconWithChannelType = function GuildIconWithChannelType(arg0) {
  ...
  const gap = tmp4.gap;
  const tmp5 = typeIconSize(5719).ImageSizes[guildIconSize];
  dependencyMap = tmp5;
  ...
  obj[1] = typeIconSize(8233).CutoutShape.Circle;
  obj[2] = memo;
  obj[3] = gap;
  obj[4] = sum1;
  obj[5] = sum1;
  ...
  const items3 = [callback(typeIconPadding(5719), obj), ];
  const tmp12 = typeIconPadding(5719);
  ...
  obj[6] = items3;
  return callback2(typeIconSize(10203).Pile, obj);
};
