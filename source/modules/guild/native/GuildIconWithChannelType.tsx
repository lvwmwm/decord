...
// Dependencies: [19, 17, 21, 5646, 4255, 712, 4715, 10156, 8075, 1297, 2]
// Exports: GuildIconWithChannelType

// Module 10155 (GuildIconWithChannelTypeSizes)
...
export const GuildIconWithChannelType = function GuildIconWithChannelType(arg0) {
  ...
  const gap = tmp4.gap;
  const tmp5 = typeIconSize(5646).ImageSizes[guildIconSize];
  dependencyMap = tmp5;
  ...
  obj[1] = typeIconSize(8075).CutoutShape.Circle;
  obj[2] = memo;
  obj[3] = gap;
  obj[4] = sum1;
  obj[5] = sum1;
  ...
  const items3 = [callback(typeIconPadding(5646), obj), ];
  const tmp12 = typeIconPadding(5646);
  ...
  obj[6] = items3;
  return callback2(typeIconSize(10156).Pile, obj);
};
