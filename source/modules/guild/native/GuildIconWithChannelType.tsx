...
// Dependencies: [19, 17, 21, 5700, 4285, 712, 4745, 10187, 8216, 1297, 2]
// Exports: GuildIconWithChannelType

// Module 10186 (GuildIconWithChannelTypeSizes)
...
export const GuildIconWithChannelType = function GuildIconWithChannelType(arg0) {
  ...
  const gap = tmp4.gap;
  const tmp5 = typeIconSize(5700).ImageSizes[guildIconSize];
  dependencyMap = tmp5;
  ...
  obj[1] = typeIconSize(8216).CutoutShape.Circle;
  obj[2] = memo;
  obj[3] = gap;
  obj[4] = sum1;
  obj[5] = sum1;
  ...
  const items3 = [callback(typeIconPadding(5700), obj), ];
  const tmp12 = typeIconPadding(5700);
  ...
  obj[6] = items3;
  return callback2(typeIconSize(10187).Pile, obj);
};
