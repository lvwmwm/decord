...
// Dependencies: [19, 17, 21, 7188, 4661, 712, 6832, 11788, 8402, 1297, 2]
// Exports: GuildIconWithChannelType

// Module 11966 (GuildIconWithChannelTypeSizes)
...
export const GuildIconWithChannelType = function GuildIconWithChannelType(arg0) {
  ...
  const gap = tmp4.gap;
  const tmp5 = typeIconSize(7188).ImageSizes[guildIconSize];
  dependencyMap = tmp5;
  ...
  obj[1] = typeIconSize(8402).CutoutShape.Circle;
  obj[2] = memo;
  obj[3] = gap;
  obj[4] = sum1;
  obj[5] = sum1;
  ...
  const items3 = [callback(typeIconPadding(7188), obj), ];
  const tmp12 = typeIconPadding(7188);
  ...
  obj[6] = items3;
  return callback2(typeIconSize(11788).Pile, obj);
};
