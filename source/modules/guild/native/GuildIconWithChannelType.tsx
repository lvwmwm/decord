...
// Dependencies: [19, 17, 21, 5819, 4342, 712, 4805, 11154, 8341, 1297, 2]
// Exports: GuildIconWithChannelType

// Module 11153 (GuildIconWithChannelTypeSizes)
...
export const GuildIconWithChannelType = function GuildIconWithChannelType(arg0) {
  ...
  const gap = tmp4.gap;
  const tmp5 = typeIconSize(5819).ImageSizes[guildIconSize];
  dependencyMap = tmp5;
  ...
  obj[1] = typeIconSize(8341).CutoutShape.Circle;
  obj[2] = memo;
  obj[3] = gap;
  obj[4] = sum1;
  obj[5] = sum1;
  ...
  const items3 = [callback(typeIconPadding(5819), obj), ];
  const tmp12 = typeIconPadding(5819);
