...
// Function ID: 10245
// Name: renderIcon
// Dependencies: [19, 17, 1302, 21, 4255, 712, 3967, 4101, 10245, 10246, 4251, 1236, 10247, 10248, 4783, 2]

// Module 10244 (renderIcon)
...
prototype["renderIcon"] = function renderIcon() {
  ...
  if (null != icon) {
    ...
    if (obj6.isThemeDark(theme.theme)) {
      let tmp13Result = tmp13(10245);
    } else {
      tmp13Result = tmp13(10246);
    }
    obj = { source: null };
    obj[0] = tmp13Result;
