...
// Function ID: 11116
// Name: renderIcon
// Dependencies: [19, 17, 1302, 21, 4285, 712, 3996, 4130, 11116, 11117, 4281, 1236, 11118, 11119, 4827, 2]

// Module 11115 (renderIcon)
...
prototype["renderIcon"] = function renderIcon() {
  ...
  if (null != icon) {
    ...
    obj6 = require(4130) /* AccessibilityAnnouncer */;
