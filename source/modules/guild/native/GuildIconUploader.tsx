...
// Function ID: 11110
// Name: renderIcon
// Dependencies: [19, 17, 1302, 21, 4285, 712, 3997, 4131, 11110, 11111, 4281, 1236, 11112, 11113, 4812, 2]

// Module 11109 (renderIcon)
...
prototype["renderIcon"] = function renderIcon() {
  ...
  if (null != icon) {
    ...
    if (obj6.isThemeDark(theme.theme)) {
      let tmp13Result = tmp13(11110);
    } else {
      tmp13Result = tmp13(11111);
    }
    obj = { source: null };
    obj[0] = tmp13Result;
