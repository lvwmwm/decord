...
// Function ID: 11082
// Name: renderIcon
// Dependencies: [19, 17, 1302, 21, 4255, 712, 3967, 4101, 11082, 11083, 4251, 1236, 11084, 11085, 4797, 2]

// Module 11081 (renderIcon)
...
prototype["renderIcon"] = function renderIcon() {
  ...
  if (null != icon) {
    ...
    if (obj6.isThemeDark(theme.theme)) {
      let tmp13Result = tmp13(11082);
    } else {
      tmp13Result = tmp13(11083);
    }
    obj = { source: null };
    obj[0] = tmp13Result;
