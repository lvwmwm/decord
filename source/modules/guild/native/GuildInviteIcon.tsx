...
// Function ID: 11754
// Name: render
// Dependencies: [19, 17, 21, 4189, 712, 3901, 11754, 1236, 1416, 5141, 1856, 1297, 2]
...
GuildInviteIcon.prototype["render"] = function render() {
  ...
  let obj = require(11754) /* getClass */;
  ...
  if (null != guild.icon) {
    ...
    return jsx(importDefault(5141), { accessibilityRole: "image", accessibilityLabel: null, style: null, source: null });
  } else {
