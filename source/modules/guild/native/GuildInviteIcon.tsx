...
// Module 11681 (_isNativeReflectConstruct)
...
let closure_10 = [false, false, false, false, false];
let obj1 = arg1(dependencyMap[8]);
obj = { icon: { <string:3847312555>: "<string:29705451>", <string:2488558706>: "UM", <string:1817335355>: "ButtonLooks" }, iconSmall: {}, iconMedium: { "Bool(false)": "337f717407aa04f32bdedf504de7310b", "Bool(false)": "emoji", "Bool(false)": "png" } };
  ...
  const items = [
    {
      ...
      value() {
        ...
        if (null != guild.icon) {
          ...
          const obj2 = { marginBottom: "interaction_failure", borderWidth: 20, accessibilityLabel: formatToPlainStringResult };
          const items1 = [, , , ];
