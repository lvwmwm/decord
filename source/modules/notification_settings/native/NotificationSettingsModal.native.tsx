...
obj = {};
obj = { TimeStampProducer: "\u{1F468}\u{1F3FB}\u200D\u{1F9BC}\u200D\u27A1\uFE0F", GlobalDiscoveryServerTab: true, serializeHost: null, color: importDefault(dependencyMap[20]).unsafe_rawColors.BLUE_345 };
...
const tmp5 = (PureComponent) => {
  ...
  obj = {
    ...
    value() {
      ...
      const obj4 = { hasMaxConnections: "<string:3086024708>", isBoostOnlySubscription: "<string:625475588>", style: { marginTop: 8 } };
      const intl4 = NotificationSettings(closure_2[31]).intl;
