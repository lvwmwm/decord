...
// Dependencies: [109, 19, 17, 1376, 1372, 5207, 4176, 1862, 16440, 3892, 4450, 1874, 676, 21, 4255, 712, 3967, 4449, 4223, 9705, 1959, 5215, 5210, 9715, 9719, 9726, 7767, 1236, 7766, 5634, 5635, 4251, 1297, 3952, 1945, 9714, 5300, 9709, 5306, 11992, 3886, 4453, 4715, 4445, 7749, 4663, 9710, 1480, 589, 5208, 5581, 5223, 16733, 9704, 5650, 2]
// Exports: default

// Module 16732 (ConnectedNotificationSettings)
...
prototype["renderServerSettings"] = function renderServerSettings() {
  ...
  if (shouldUseNewNotificationSystem) {
    ...
    const items = [callback2(require(9715) /* NotificationSettingsPresets */.NotificationSettingsGuildPresets, obj1), , ];
    const obj2 = { style: null, guildId: null };
    obj2[0] = { marginTop: 24 };
    obj2[1] = self.props.guildId;
    items[1] = callback2(require(9719) /* NotificationSettingsMessageNotification */.NotificationSettingsGuildMessageNotification, obj2);
    const obj3 = { style: null, guildId: null };
    obj3[0] = { marginTop: 24 };
    obj3[1] = self.props.guildId;
    items[2] = callback2(require(9726) /* NotificationSettingsMessageUnread */.NotificationSettingsGuildMessageUnread, obj3);
    obj[0] = items;
    ...
    obj5[3] = stringResult;
    const items2 = [callback2(require(7766) /* TableRadioRow */.TableRadioRow, obj5), , ];
    ...
    obj6[2] = muted;
    items2[1] = callback2(require(7766) /* TableRadioRow */.TableRadioRow, obj6);
    ...
    obj7[2] = muted;
    items2[2] = callback2(require(7766) /* TableRadioRow */.TableRadioRow, obj7);
    obj[4] = items2;
    tmp2Result = tmp2(require(7767) /* context */.TableRadioGroup, obj);
  }
  return tmp2Result;
};
prototype["renderNotificationOptions"] = function renderNotificationOptions() {
  ...
  const items = [closure_26(require(5635) /* TableSwitchRow */.TableSwitchRow, obj), , ];
  ...
  items[1] = closure_26(require(5635) /* TableSwitchRow */.TableSwitchRow, obj);
  ...
  items[2] = closure_26(require(5635) /* TableSwitchRow */.TableSwitchRow, obj);
  obj2[1] = items;
  const items1 = [closure_27(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj2), , ];
  ...
  const items3 = [closure_26(require(5635) /* TableSwitchRow */.TableSwitchRow, obj5), ];
  ...
  items3[1] = closure_26(require(5635) /* TableSwitchRow */.TableSwitchRow, obj6);
  obj8[1] = items3;
  items2[1] = closure_27(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj8);
  obj7[0] = items2;
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (props.shouldUseNewNotificationSystem) {
    ...
    if (muted) {
      ...
      obj[1] = require(9714) /* NotificationSettingsMuteBanner */.getMuteBannerSubtitleFromConfig(muteConfig);
      obj[2] = { marginBottom: 16 };
      obj[3] = self.handleMutePress;
      tmp15 = callback2(require(9714) /* NotificationSettingsMuteBanner */.NotificationSettingsMuteBanner, obj);
      const obj7 = require(9714) /* NotificationSettingsMuteBanner */;
    }
    return tmp15;
  } else {
    const intl = require(1236) /* getSystemLocale */.intl;
    ...
    if (muted) {
      ...
      tmp10Result = callback2(importDefault(9709), obj3, "muted-until");
      const tmp14 = importDefault(9709);
    }
    items[1] = tmp10Result;
    return items;
  }
...
prototype["renderChannel"] = function renderChannel(parent_id) {
  ...
  if (null != parent_id) {
    ...
    obj = { IconComponent: null };
    obj[0] = _require(4715).getChannelIconComponent(parent_id);
    obj[0] = callback2(_require(5306).TableRowIcon, obj);
    const tmp4Result1 = _require(4715);
    obj[1] = _require(4445).computeChannelName(parent_id, mergeGuildAvatar, upsertRelationship);
    ...
    obj[4] = tmp10Result;
    return callback2(_require(5300).TableRow, obj, parent_id.id);
  }
};
prototype["render"] = function render() {
  ...
  const Form = require(7749) /* Form */.Form;
...
export default function NotificationSettingsModal() {
  ...
  const items1 = [obj];
  obj[1] = items1;
  return closure_26(require(5650) /* NavigationStack */.Navigator, obj);
};
