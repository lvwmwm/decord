...
obj = {};
obj = { <string:1426063616>: 15.1, 16958465: null, 16843009: "\u{1F468}\u{1F3FB}\u200D\u{1F9BC}\u200D\u27A1\uFE0F", color: importDefault(dependencyMap[20]).unsafe_rawColors.BLUE_345 };
...
const tmp5 = (PureComponent) => {
  ...
  obj = {
    ...
    value() {
      ...
      const obj4 = { cachedAt: "y", edpbxy: "isArray", style: { marginTop: 8 } };
      const intl4 = NotificationSettings(closure_2[31]).intl;
