...
// Dependencies: [109, 19, 17, 1376, 1372, 5237, 4206, 1891, 16480, 3921, 4480, 1903, 676, 21, 4285, 712, 3996, 4479, 4253, 9736, 1988, 5245, 5240, 9746, 9750, 9757, 7908, 1236, 7907, 5688, 5689, 4281, 1297, 3981, 1974, 9745, 5354, 9740, 5360, 12026, 3915, 4483, 4745, 4475, 7890, 4693, 9741, 1480, 589, 5238, 5635, 5253, 16773, 9735, 5704, 2]
// Exports: default

// Module 16772 (ConnectedNotificationSettings)
...
prototype["renderServerSettings"] = function renderServerSettings() {
  ...
  if (shouldUseNewNotificationSystem) {
    ...
    const items = [callback2(require(9746) /* NotificationSettingsPresets */.NotificationSettingsGuildPresets, obj1), , ];
    const obj2 = { style: null, guildId: null };
    obj2[0] = { marginTop: 24 };
    obj2[1] = self.props.guildId;
    items[1] = callback2(require(9750) /* NotificationSettingsMessageNotification */.NotificationSettingsGuildMessageNotification, obj2);
    const obj3 = { style: null, guildId: null };
    obj3[0] = { marginTop: 24 };
    obj3[1] = self.props.guildId;
    items[2] = callback2(require(9757) /* NotificationSettingsMessageUnread */.NotificationSettingsGuildMessageUnread, obj3);
    obj[0] = items;
    ...
    obj5[3] = stringResult;
    const items2 = [callback2(require(7907) /* TableRadioRow */.TableRadioRow, obj5), , ];
    ...
    obj6[2] = muted;
    items2[1] = callback2(require(7907) /* TableRadioRow */.TableRadioRow, obj6);
    ...
    obj7[2] = muted;
    items2[2] = callback2(require(7907) /* TableRadioRow */.TableRadioRow, obj7);
    obj[4] = items2;
    tmp2Result = tmp2(require(7908) /* context */.TableRadioGroup, obj);
  }
  return tmp2Result;
};
prototype["renderNotificationOptions"] = function renderNotificationOptions() {
  ...
  const items = [closure_26(require(5689) /* TableSwitchRow */.TableSwitchRow, obj), , ];
  ...
  items[1] = closure_26(require(5689) /* TableSwitchRow */.TableSwitchRow, obj);
  ...
  items[2] = closure_26(require(5689) /* TableSwitchRow */.TableSwitchRow, obj);
  obj2[1] = items;
  const items1 = [closure_27(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj2), , ];
  ...
  const items3 = [closure_26(require(5689) /* TableSwitchRow */.TableSwitchRow, obj5), ];
  ...
  items3[1] = closure_26(require(5689) /* TableSwitchRow */.TableSwitchRow, obj6);
  obj8[1] = items3;
  items2[1] = closure_27(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj8);
  obj7[0] = items2;
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (props.shouldUseNewNotificationSystem) {
    ...
    if (muted) {
      ...
      obj[1] = require(9745) /* NotificationSettingsMuteBanner */.getMuteBannerSubtitleFromConfig(muteConfig);
      obj[2] = { marginBottom: 16 };
      obj[3] = self.handleMutePress;
      tmp15 = callback2(require(9745) /* NotificationSettingsMuteBanner */.NotificationSettingsMuteBanner, obj);
      const obj7 = require(9745) /* NotificationSettingsMuteBanner */;
    }
    return tmp15;
  } else {
    const intl = require(1236) /* getSystemLocale */.intl;
    ...
    if (muted) {
      ...
      tmp10Result = callback2(importDefault(9740), obj3, "muted-until");
...
prototype["renderChannel"] = function renderChannel(parent_id) {
  ...
  if (null != parent_id) {
    ...
    obj[0] = callback2(_require(5360).TableRowIcon, obj);
    ...
    obj[4] = tmp10Result;
    return callback2(_require(5354).TableRow, obj, parent_id.id);
  }
};
prototype["render"] = function render() {
  ...
  const Form = require(7890) /* Form */.Form;
...
export default function NotificationSettingsModal() {
  ...
  const items1 = [obj];
  obj[1] = items1;
  return closure_26(require(5704) /* NavigationStack */.Navigator, obj);
};
