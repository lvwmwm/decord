...
// Dependencies: [109, 19, 17, 1376, 1372, 5127, 4110, 1862, 16338, 3826, 4385, 1874, 676, 21, 4189, 712, 3901, 4384, 4157, 10305, 1959, 5135, 5130, 10315, 10319, 10326, 7655, 1236, 7654, 5554, 5555, 4185, 1297, 3886, 1945, 10314, 5220, 10309, 5226, 11856, 3820, 4388, 4650, 4380, 7634, 4598, 10310, 1480, 589, 5128, 5501, 5143, 16632, 10304, 5570, 2]
// Exports: default

// Module 16631 (ConnectedNotificationSettings)
...
function ConnectedNotificationSettings(guildId) {
  ...
  obj = { children: null };
  obj = { guildId, channels: memo, navigation, shouldUseNewNotificationSystem: guildId(10310).useShouldUseNewNotificationSystem("NotificationSettingsModalNative") };
  const merged = Object.assign(tmp3);
  const items2 = [callback2(NotificationSettings, obj), callback2(guildId(5501).NavScrim, {})];
  obj[0] = items2;
...
prototype["renderServerSettings"] = function renderServerSettings() {
  ...
  if (shouldUseNewNotificationSystem) {
    ...
    const items = [callback2(require(10315) /* NotificationSettingsPresets */.NotificationSettingsGuildPresets, obj1), , ];
    const obj2 = { style: null, guildId: null };
    obj2[0] = { marginTop: 24 };
    obj2[1] = self.props.guildId;
    items[1] = callback2(require(10319) /* NotificationSettingsMessageNotification */.NotificationSettingsGuildMessageNotification, obj2);
    const obj3 = { style: null, guildId: null };
    obj3[0] = { marginTop: 24 };
    obj3[1] = self.props.guildId;
    items[2] = callback2(require(10326) /* NotificationSettingsMessageUnread */.NotificationSettingsGuildMessageUnread, obj3);
    obj[0] = items;
    ...
    obj5[3] = stringResult;
    const items2 = [callback2(require(7654) /* TableRadioRow */.TableRadioRow, obj5), , ];
    ...
    obj6[2] = muted;
    items2[1] = callback2(require(7654) /* TableRadioRow */.TableRadioRow, obj6);
    ...
    obj7[2] = muted;
    items2[2] = callback2(require(7654) /* TableRadioRow */.TableRadioRow, obj7);
    obj[4] = items2;
    tmp2Result = tmp2(require(7655) /* context */.TableRadioGroup, obj);
  }
  return tmp2Result;
};
prototype["renderNotificationOptions"] = function renderNotificationOptions() {
  ...
  const items = [closure_26(require(5555) /* TableSwitchRow */.TableSwitchRow, obj), , ];
  ...
  items[1] = closure_26(require(5555) /* TableSwitchRow */.TableSwitchRow, obj);
  ...
  items[2] = closure_26(require(5555) /* TableSwitchRow */.TableSwitchRow, obj);
  obj2[1] = items;
  const items1 = [closure_27(require(5554) /* TableRowGroupTitle */.TableRowGroup, obj2), , ];
  ...
  items1[1] = closure_26(require(4185) /* Text */.Text, obj3);
  const obj4 = {
  ...
  const items3 = [closure_26(require(5555) /* TableSwitchRow */.TableSwitchRow, obj5), ];
  ...
  items3[1] = closure_26(require(5555) /* TableSwitchRow */.TableSwitchRow, obj6);
  obj8[1] = items3;
  items2[1] = closure_27(require(5554) /* TableRowGroupTitle */.TableRowGroup, obj8);
  obj7[0] = items2;
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (props.shouldUseNewNotificationSystem) {
    ...
    if (muted) {
      ...
      obj[1] = require(10314) /* NotificationSettingsMuteBanner */.getMuteBannerSubtitleFromConfig(muteConfig);
      obj[2] = { marginBottom: 16 };
      obj[3] = self.handleMutePress;
      tmp15 = callback2(require(10314) /* NotificationSettingsMuteBanner */.NotificationSettingsMuteBanner, obj);
      const obj7 = require(10314) /* NotificationSettingsMuteBanner */;
    }
    return tmp15;
  } else {
    const intl = require(1236) /* getSystemLocale */.intl;
    ...
    obj2[2] = !muted;
    obj1[2] = callback2(tmp7(5220).TableRow, obj2);
    const items = [callback2(tmp7(5554).TableRowGroup, obj1, "mute"), ];
    let tmp10Result = null;
    if (muted) {
      const obj3 = { muteConfig: null, type: null };
      obj3[0] = muteConfig;
      obj3[1] = tmp7(10309).MuteSettingType.SERVER;
      tmp10Result = callback2(importDefault(10309), obj3, "muted-until");
      const tmp14 = importDefault(10309);
    }
    items[1] = tmp10Result;
    return items;
  }
...
prototype["renderChannels"] = function renderChannels() {
  ...
  obj[0] = self(11856).PlusMediumIcon;
  obj[0] = callback2(self(5226).TableRowIcon, obj);
  const intl2 = self(1236).intl;
  obj[1] = intl2.string(self(1236).t.quib7R);
  obj[2] = this.handleAddOverride;
  obj[2] = callback2(self(5220).TableRow, obj);
  const items = [callback2(self(5554).TableRowGroup, obj, "override-header"), ];
  ...
  items[1] = callback2(self(5554).TableRowGroup, obj1, "override-channels");
  return items;
};
prototype["renderChannel"] = function renderChannel(parent_id) {
  ...
  if (null != parent_id) {
    ...
    obj = { IconComponent: null };
    obj[0] = _require(4650).getChannelIconComponent(parent_id);
    obj[0] = callback2(_require(5226).TableRowIcon, obj);
    const tmp4Result1 = _require(4650);
    obj[1] = _require(4380).computeChannelName(parent_id, mergeGuildAvatar, upsertRelationship);
    obj[2] = function onPress() {
      return self.handleChannelSelect(parent_id.id);
    };
    let channelName = null;
    if (null != channel) {
      channelName = tmp4(4380).computeChannelName(channel, mergeGuildAvatar, upsertRelationship);
      const tmp4Result3 = tmp4(4380);
    }
    obj[3] = channelName;
    let tmp10Result;
    if (null != stringResult) {
      ...
      obj1[0] = stringResult;
      tmp10Result = tmp10(tmp4(5220).TableRow.TrailingText, obj1);
    }
    obj[4] = tmp10Result;
    return callback2(_require(5220).TableRow, obj, parent_id.id);
  }
};
prototype["render"] = function render() {
  ...
  const Form = require(7634) /* Form */.Form;
  ...
  if (hasItem) {
    ...
    obj[1] = tmp4(tmp5(4598).Stack, obj);
    ...
    obj[2] = items;
    obj[1] = callback3(tmp5(4598).Stack, obj);
...
export default function NotificationSettingsModal() {
  ...
  const memo = importAllResult.useMemo(() => {
    ...
    obj[0] = callback(5143).getHeaderCloseButton(callback2(5135).close);
    ...
    const obj3 = callback(5143);
    obj[1] = callback(5143).getHeaderBackButton();
    obj[2] = function render(guildId, navigation) {
      return callback2(callback(16632), { guildId: guildId.guildId, navigation });
    };
    obj[constants.ADD_OVERRIDE] = obj;
    const obj1 = { headerLeft: null, title: null, render: null };
    const obj5 = callback(5143);
    obj1[0] = callback(5143).getHeaderBackButton();
    const intl3 = callback(1236).intl;
    obj1[1] = intl3.string(callback(1236).t.h850Ss);
    obj1[2] = function render(channelId) {
      return callback2(callback(10304), { channelId: channelId.channelId, inGuildContext: true });
    };
  ...
  const items1 = [obj];
  obj[1] = items1;
  return closure_26(require(5570) /* NavigationStack */.Navigator, obj);
};
