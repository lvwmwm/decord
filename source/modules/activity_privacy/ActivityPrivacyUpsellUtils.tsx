...
// Dependencies: [5099, 4110, 1862, 5027, 1306, 6503, 1236, 3862, 2]
...
// Module 13877 (computeAffectedGuilds)
  ...
  if (setting === ACTIVITY_STATUS_OFF) {
    ...
    if (num >= 0) {
      if (num2 >= 0) {
        ...
        const dependencyMap = tmp8(6503).getSanitizedActivityRestrictedGuilds();
