...
// Dependencies: [19, 17, 1862, 21, 4216, 712, 4255, 589, 5646, 13975, 1236, 4251, 11859, 11626, 4223, 3956, 5323, 4665, 2]
// Exports: default

// Module 13977 (renderSuccessIcon)
...
function StoreGuildIcon(guildId) {
  ...
  return callback(importDefault(5646), obj);
}
