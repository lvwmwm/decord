...
// Dependencies: [19, 17, 1891, 21, 4246, 712, 4285, 589, 5700, 14012, 1236, 4281, 11893, 11660, 4253, 3985, 5377, 4695, 2]
// Exports: default

// Module 14014 (renderSuccessIcon)
...
function StoreGuildIcon(guildId) {
  ...
  return callback(importDefault(5700), obj);
}
