// Module ID: 9860
// Function ID: 76425
// Dependencies: [4098, 4337, 9861, 1934, 2]
...
export default {
  open(merged) {
    ...
    importDefault(4337).pushLazy(require(1934) /* maybeLoadBundle */(9861, dependencyMap.paths), merged, "ADD_IMAGE_DESCRIPTION_MODAL_KEY");
  },
  close() {
