...
// Function ID: 15842
// Name: VoiceUsers
// Dependencies: [19, 17, 1983, 4099, 4667, 4521, 676, 21, 4446, 712, 9366, 1297, 4442, 1236, 10083, 5458, 4905, 15840, 589, 12, 13294, 2]
// Exports: GuildVoiceState, useVoiceUsers

// Module 15841 (VoiceUsers)
...
export const GuildVoiceState = function GuildVoiceState(arg0) {
  ...
  if (!tmp2) {
    ...
    if (null == previewUrl) {
      ...
      obj4[0] = previewUrl;
      obj3[1] = obj4;
      const items1 = [tmp7(tmp3(5458), obj3), , , , ];
