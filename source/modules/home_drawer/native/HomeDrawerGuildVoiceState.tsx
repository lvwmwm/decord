...
// Function ID: 15681
// Name: VoiceUsers
// Dependencies: [19, 17, 1982, 4034, 4589, 4455, 676, 21, 4380, 712, 12509, 1297, 4376, 1236, 11030, 5374, 4826, 15679, 589, 12, 13176, 2]
// Exports: GuildVoiceState, useVoiceUsers

// Module 15680 (VoiceUsers)
...
export const GuildVoiceState = function GuildVoiceState(arg0) {
  ...
  if (!tmp2) {
    ...
    if (null == previewUrl) {
      ...
      obj4[0] = previewUrl;
      obj3[1] = obj4;
      const items1 = [tmp7(tmp3(5374), obj3), , , , ];
