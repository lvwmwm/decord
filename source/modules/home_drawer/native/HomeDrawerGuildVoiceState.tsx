...
// Function ID: 15876
// Name: VoiceUsers
// Dependencies: [19, 17, 1982, 4100, 4669, 4523, 676, 21, 4448, 712, 9388, 1297, 4444, 1236, 10106, 5461, 4908, 15874, 589, 12, 13328, 2]
// Exports: GuildVoiceState, useVoiceUsers

// Module 15875 (VoiceUsers)
...
export const GuildVoiceState = function GuildVoiceState(arg0) {
  ...
  if (!tmp2) {
    ...
    if (null == previewUrl) {
      ...
      obj4[0] = previewUrl;
      obj3[1] = obj4;
      const items1 = [tmp7(tmp3(5461), obj3), , , , ];
