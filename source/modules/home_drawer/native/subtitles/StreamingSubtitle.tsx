...
// Dependencies: [19, 21, 4338, 1236, 4534, 2]
// Exports: default

// Module 15527 (StreamingSubtitle)
import "noop";
...
export default function StreamingSubtitle(arg0) {
  ...
  obj = { username: null };
  obj[0] = importDefault(4534).getName(guildId, null, streamingUser);
  obj[3] = intl.format(require(1236) /* getSystemLocale */.t.k5IKep, obj);
  return jsx(require(4338) /* Text */.Text, { username: null });
};
