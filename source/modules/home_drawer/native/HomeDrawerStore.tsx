...
// Function ID: 15073
// Name: withEqualityFn
// Dependencies: [676, 700, 4145, 3897, 2]
// Exports: computeMaxX

// Module 15072 (withEqualityFn)
...
const withEqualityFn = identity.createWithEqualityFn((arg0, arg1) => {
  ...
  obj[0] = _require(4145).makeMutable(0);
  const obj2 = _require(4145);
  obj[1] = _require(4145).makeMutable({ active: false, initialX: 0, initialY: 0, panelX: 0 });
  obj[3] = { current: 0 };
  const obj3 = _require(4145);
  obj[4] = _require(4145).makeMutable(false);
...
let result = require("module_4145").fileFinishedImporting("modules/home_drawer/native/HomeDrawerStore.tsx");
