...
// Function ID: 15089
// Name: withEqualityFn
// Dependencies: [676, 700, 4162, 3914, 2]
// Exports: computeMaxX

// Module 15088 (withEqualityFn)
...
const withEqualityFn = identity.createWithEqualityFn((arg0, arg1) => {
  ...
  obj[0] = _require(4162).makeMutable(0);
  const obj2 = _require(4162);
  obj[1] = _require(4162).makeMutable({ active: false, initialX: 0, initialY: 0, panelX: 0 });
  obj[3] = { current: 0 };
  const obj3 = _require(4162);
  obj[4] = _require(4162).makeMutable(false);
