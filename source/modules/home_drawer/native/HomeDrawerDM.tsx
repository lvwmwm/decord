...
// Module 14755 (HomeDrawerDMExpandedChildren)
function HomeDrawerDMExpandedChildren(channel) {
  ...
  const title = React.useMemo(() => {
    ...
    obj = { guild_id: "_desired", exports: "hash", body: "content", type: "withSpring", style: tmp.titleText, children: stateFromStores };
...
let closure_12 = arg1(dependencyMap[8]).createStyles({ title: { "Bool(false)": "safety_user_sentiment_notice_dismissed_at", "Bool(false)": "message", "Bool(false)": null }, titleText: { flexShrink: 1 } });
