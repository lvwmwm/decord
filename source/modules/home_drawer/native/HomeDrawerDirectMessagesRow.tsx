...
// Dependencies: [19, 17, 4388, 3938, 676, 21, 4302, 712, 589, 4298, 1236, 15345, 4158, 4155, 2]
// Exports: default

// Module 15349 (HomeDrawerDMsRow)
import "noop";
...
function HomeDrawerDMsRow() {
  ...
  obj3[0] = callback(require(4298) /* Text */.Text, obj4);
  obj3[1] = tmp5;
  return callback(require(15345) /* HomeDrawerSharedItem */.HomeDrawerSharedItem, obj3);
}
