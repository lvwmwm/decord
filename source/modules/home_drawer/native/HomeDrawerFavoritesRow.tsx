...
// Module 15508 (HomeDrawerFavoritesRowExpandedChildren)
import "noop";
...
export const HomeDrawerFavoritesRowExpandedChildren = function HomeDrawerFavoritesRowExpandedChildren() {
  ...
  obj[0] = jsx(require(4340) /* Text */.Text, { variant: "text-md/medium", color: "text-default", lineClamp: 1, children: null });
