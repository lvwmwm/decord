...
// Function ID: 4873
// Name: set
// Dependencies: [1405, 589, 4873, 709, 2]
...
prototype["getResults"] = function getResults(c0) {
  const result = require(4873) /* GAME_AUTOCOMPLETE_MAX_QUERY_LENGTH */.normalizeGameAutocompleteQuery(c0);
  let peekResult;
  if (null != result) {
...
prototype["getClosestResults"] = function getClosestResults(result) {
  result = require(4873) /* GAME_AUTOCOMPLETE_MAX_QUERY_LENGTH */.normalizeGameAutocompleteQuery(result);
  if (null != result) {
...
prototype["shouldSuppressFetch"] = function shouldSuppressFetch(result) {
  ...
  if (tmp4) {
    ...
    if (result1) {
      result1 = require(4873) /* GAME_AUTOCOMPLETE_MAX_QUERY_LENGTH */.shouldSuppressAutocompleteFetch(result, (arg0) => closure_2.peek(arg0));
      const tmpResult = require(4873) /* GAME_AUTOCOMPLETE_MAX_QUERY_LENGTH */;
    }
    tmp4 = result1;
  }
  return tmp4;
