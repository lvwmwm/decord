...
initialize = {
  getQueryId(c0) {
    return QueryIds.GAME_AUTOCOMPLETE(require(4833) /* GAME_AUTOCOMPLETE_MAX_QUERY_LENGTH */.normalizeGameAutocompleteQuery(c0));
  },
  get(arg0) {
...
export const useDebouncedGameAutocomplete = function useDebouncedGameAutocomplete(c0) {
  ...
  let tmp7;
  let tmp8;
  let obj = require(4833) /* GAME_AUTOCOMPLETE_MAX_QUERY_LENGTH */;
