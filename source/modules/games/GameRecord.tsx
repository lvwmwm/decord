...
// Dependencies: [6, 7, 15, 17, 18, 1858, 4153, 1881, 4160, 1392, 1327, 2]

// Module 4152 (_isNativeReflectConstruct)
...
let result = require("_possibleConstructorReturn").fileFinishedImporting("modules/games/GameRecord.tsx");
