...
// Dependencies: [1931, 4367, 1954, 4375, 1435, 1370, 2]

// Module 4366 (getOfficialApplicationId)
import "toJS";
...
prototype["getIconURL"] = function getIconURL(size, format) {
  ...
  return importDefault(4375)(this.id, icon, { size, format });
};
prototype["getBannerURL"] = function getBannerURL(size) {
  ...
  return importDefault(4375)(this.id, banner, { keepAspectRatio: true, size });
};
prototype["getCoverURL"] = function getCoverURL(size) {
  ...
  return importDefault(4375)(this.id, cover, { keepAspectRatio: true, format: str, size });
};
