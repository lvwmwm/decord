// Module ID: 9301
// Function ID: 9302
// Dependencies: [19, 17, 21, 4342, 712, 4072, 7992, 1363, 5308, 1435, 2]
...
const memoResult = importAllResult.memo(function GameActivityIcon(style) {
  ...
  if (null == iconURL) {
    if ("none" === style.fallback) {
      ...
      jsx(tmp2(7992).UnknownGameIcon, { size: "custom", style: null, color: null });
    ...
    obj1[1] = items2;
    const tmp9 = jsx(iconURL(5308), { source: null, style: null });
    let tmp6Result = tmp9;
    if (null != style) {
