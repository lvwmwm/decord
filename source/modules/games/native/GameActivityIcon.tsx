// Module ID: 9297
// Function ID: 9298
// Dependencies: [19, 17, 21, 4344, 712, 4072, 7988, 1363, 5307, 1435, 2]
...
const memoResult = importAllResult.memo(function GameActivityIcon(style) {
  ...
  if (null == iconURL) {
    if ("none" === style.fallback) {
      ...
      jsx(tmp2(7988).UnknownGameIcon, { size: "custom", style: null, color: null });
    ...
    obj1[1] = items2;
    const tmp9 = jsx(iconURL(5307), { source: null, style: null });
    let tmp6Result = tmp9;
    if (null != style) {
