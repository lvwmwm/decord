// Module ID: 9399
// Function ID: 9400
// Dependencies: [19, 17, 21, 4380, 712, 4108, 8097, 1363, 5374, 1435, 2]
...
const memoResult = importAllResult.memo(function GameActivityIcon(style) {
  ...
  if (null == iconURL) {
    if ("none" === style.fallback) {
      ...
      jsx(tmp2(8097).UnknownGameIcon, { size: "custom", style: null, color: null });
    ...
    obj1[1] = items2;
    const tmp9 = jsx(iconURL(5374), { source: null, style: null });
    let tmp6Result = tmp9;
    if (null != style) {
