// Module ID: 9872
// Function ID: 9873
// Dependencies: [19, 17, 21, 4478, 712, 4204, 8721, 1363, 5493, 1431, 2]
...
const memoResult = importAllResult.memo(function GameActivityIcon(style) {
  ...
  if (null == iconURL) {
    if ("none" === style.fallback) {
      ...
      jsx(tmp2(8721).UnknownGameIcon, { size: "custom", style: null, color: null });
    ...
    obj1[1] = items2;
    const tmp9 = jsx(iconURL(5493), { source: null, style: null });
    let tmp6Result = tmp9;
    if (null != style) {
