...
// Dependencies: [9101, 1372, 4349, 4373, 1960, 1903, 9089, 4496, 9105, 9102, 709, 2]
// Exports: default

// Module 12828 (collectCallFeedback)
  ...
  if (null == arg1) {
    if (null != voiceChannelId) {
      if (null != channel) {
        ...
        const merged = Object.assign(require(4496) /* collectGuildAnalyticsMetadata */.getVoiceStateMetadata(guildId, obj1.getChannelId(), videoEnabled));
