...
// Dependencies: [9377, 1391, 4495, 4518, 1981, 1922, 9365, 4652, 9381, 9378, 709, 2]
// Exports: default

// Module 13175 (collectCallFeedback)
import dispatcherDefault from "dispatcher" /* 709 */;
import collectGuildAnalyticsMetadata from "collectGuildAnalyticsMetadata" /* 4652 */;
import closure_3 from "handleSyncedStoresUpdate" /* 9377 */;
...
import closure_9 from "handleAudioRouteChanged" /* 9365 */;
    ...
    if (null != voiceChannelId) {
      if (null != channel) {
        ...
        if (obj.hasUsedBackgroundInCall) {
          ...
          tmp5Result = tmp5(9378);
          obj1[2] = tmp5Result.getEffectAnalyticsType(lastUsedVideoBackgroundOption);
          obj1[3] = tmp5(9378).getEffectDetailAnalyticsName(lastUsedVideoBackgroundOption);
          const merged2 = Object.assign(obj1);
          const obj10 = store;
          const tmp5Result1 = tmp5(9378);
