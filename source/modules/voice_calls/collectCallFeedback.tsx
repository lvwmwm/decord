...
// Dependencies: [9225, 1391, 4393, 4416, 1979, 1922, 9213, 4549, 9229, 9226, 709, 2]
// Exports: default

// Module 12982 (collectCallFeedback)
  ...
  if (null == arg1) {
    if (null != voiceChannelId) {
      if (null != channel) {
        ...
        const merged = Object.assign(require(4549) /* collectGuildAnalyticsMetadata */.getVoiceStateMetadata(guildId, obj1.getChannelId(), videoEnabled));
        ...
        if (obj.hasUsedBackgroundInCall) {
          ...
          tmp5Result = tmp5(9226);
          obj1[2] = tmp5Result.getEffectAnalyticsType(lastUsedVideoBackgroundOption);
          obj1[3] = tmp5(9226).getEffectDetailAnalyticsName(lastUsedVideoBackgroundOption);
          const merged2 = Object.assign(obj1);
          const obj10 = store;
          const tmp5Result1 = tmp5(9226);
