...
// Dependencies: [9309, 1391, 4431, 4454, 1981, 1922, 9297, 4588, 9313, 9310, 709, 2]
// Exports: default

// Module 13102 (collectCallFeedback)
import dispatcherDefault from "dispatcher" /* 709 */;
import collectGuildAnalyticsMetadata from "collectGuildAnalyticsMetadata" /* 4588 */;
import closure_3 from "handleSyncedStoresUpdate" /* 9309 */;
...
import closure_9 from "handleAudioRouteChanged" /* 9297 */;
    ...
    if (null != voiceChannelId) {
      if (null != channel) {
        ...
        if (obj.hasUsedBackgroundInCall) {
          ...
          tmp5Result = tmp5(9310);
          obj1[2] = tmp5Result.getEffectAnalyticsType(lastUsedVideoBackgroundOption);
          obj1[3] = tmp5(9310).getEffectDetailAnalyticsName(lastUsedVideoBackgroundOption);
          const merged2 = Object.assign(obj1);
          const obj10 = store;
          const tmp5Result1 = tmp5(9310);
