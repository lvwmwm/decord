...
// Dependencies: [9084, 1372, 4332, 4356, 1960, 1903, 9072, 4479, 9088, 9085, 709, 2]
// Exports: default

// Module 12813 (collectCallFeedback)
  ...
  if (null == arg1) {
    if (null != voiceChannelId) {
      if (null != channel) {
        ...
        const merged = Object.assign(require(4479) /* collectGuildAnalyticsMetadata */.getVoiceStateMetadata(guildId, obj1.getChannelId(), videoEnabled));
        ...
        if (obj.hasUsedBackgroundInCall) {
          ...
          obj1[3] = tmp5(9085).getEffectDetailAnalyticsName(lastUsedVideoBackgroundOption);
          const merged2 = Object.assign(obj1);
          const obj10 = store;
          const tmp5Result1 = tmp5(9085);
