...
// Dependencies: [7, 6, 15, 17, 18, 27, 1347, 4955, 4150, 1194, 1348, 4178, 1907, 4147, 6271, 653, 477, 16050, 5078, 2]
  ...
  if (null == channel) {
    ...
    if (!hasVideoResult) {
      if (null == currentEmbeddedActivity.getCurrentEmbeddedActivity()) {
        ...
        VIDEO = require(16050) /* _isNativeReflectConstruct */.shouldImmediatelyRequestVoicePermissions(id.getId(), channel.id) ? AVAudioSessionMode.VOICE : AVAudioSessionMode.LISTEN;
        const obj = require(16050) /* _isNativeReflectConstruct */;
      }
    }
