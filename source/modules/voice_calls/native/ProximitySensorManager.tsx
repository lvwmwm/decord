...
// Function ID: 16570
// Name: handleChange
// Dependencies: [17, 1390, 4322, 4375, 9155, 500, 16570, 9156, 5261, 2]

// Module 16569 (handleChange)
...
function handleChange() {
  ...
  let tmp8 = currentRouteType === require(9156) /* RouteTypes */.RouteTypes.RECEIVER && isConnectedResult;
  if (tmp8) {
