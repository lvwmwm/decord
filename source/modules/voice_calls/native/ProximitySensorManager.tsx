...
// Function ID: 16406
// Name: handleChange
// Dependencies: [17, 1371, 4274, 4326, 9043, 500, 16406, 9044, 5214, 2]

// Module 16405 (handleChange)
...
function handleChange() {
  ...
  let tmp8 = currentRouteType === require(9044) /* RouteTypes */.RouteTypes.RECEIVER && isConnectedResult;
  if (tmp8) {
