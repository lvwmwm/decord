...
// Function ID: 16446
// Name: handleChange
// Dependencies: [17, 1371, 4304, 4356, 9072, 500, 16446, 9073, 5244, 2]

// Module 16445 (handleChange)
...
function handleChange() {
  ...
  let tmp8 = currentRouteType === require(9073) /* RouteTypes */.RouteTypes.RECEIVER && isConnectedResult;
  if (tmp8) {
