...
// Function ID: 16559
// Name: handleChange
// Dependencies: [17, 1371, 4322, 4375, 9149, 500, 16559, 9150, 5261, 2]

// Module 16558 (handleChange)
...
function handleChange() {
  ...
  let tmp8 = currentRouteType === require(9150) /* RouteTypes */.RouteTypes.RECEIVER && isConnectedResult;
  if (tmp8) {
