...
// Function ID: 16643
// Name: handleChange
// Dependencies: [17, 1390, 4364, 4416, 9213, 500, 16643, 9214, 5322, 2]

// Module 16642 (handleChange)
...
function handleChange() {
  ...
  let tmp8 = currentRouteType === require(9214) /* RouteTypes */.RouteTypes.RECEIVER && isConnectedResult;
  if (tmp8) {
