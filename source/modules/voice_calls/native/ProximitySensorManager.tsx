...
// Function ID: 16473
// Name: handleChange
// Dependencies: [17, 1371, 4321, 4373, 9089, 500, 16473, 9090, 5260, 2]

// Module 16472 (handleChange)
...
function handleChange() {
  ...
  let tmp8 = currentRouteType === require(9090) /* RouteTypes */.RouteTypes.RECEIVER && isConnectedResult;
  if (tmp8) {
