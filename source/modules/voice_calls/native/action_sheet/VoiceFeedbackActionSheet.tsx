...
// Function ID: 16505
// Name: trackOpen
// Dependencies: [19, 676, 11061, 21, 698, 1236, 2533, 11064, 16498, 16505, 16499, 4310, 16500, 2007, 4061, 2]
// Exports: default

// Module 16504 (trackOpen)
import "noop";
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[3] = analyticsData(11064).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11064);
  obj4[3] = analyticsData(11064).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11064);
  ...
  return jsx(importDefault(16498), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1, categoriesHeader: null, optionsTree: null, trackOpen: null, trackReport: null });
};
