...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj[1] = intl3.string(importDefault(2515).FVhMw6);
  ...
  obj[1] = intl6.string(importDefault(2515).PL2l6A);
  ...
  obj2[1] = intl9.string(importDefault(2515)["0WFzPh"]);
  ...
  obj2[3] = analyticsData(11004).getVideoFeedbackOptions();
  ...
  obj6[3] = intl15.string(importDefault(2515).tq8598);
