...
// Function ID: 16278
// Name: trackOpen
// Dependencies: [19, 676, 10973, 21, 698, 1236, 2485, 10976, 16271, 16278, 16272, 4223, 16273, 1959, 3955, 2]
// Exports: default

// Module 16277 (trackOpen)
import "noop";
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[1] = intl9.string(importDefault(2485)["0WFzPh"]);
  ...
  obj2[3] = analyticsData(10976).getVideoFeedbackOptions();
  ...
  obj4[1] = intl12.string(importDefault(2485).Moa3W9);
  const intl13 = analyticsData(1236).intl;
  obj4[2] = intl13.string(analyticsData(1236).t.FJmoxF);
  const obj8 = analyticsData(10976);
  obj4[3] = analyticsData(10976).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(10976);
  const intl15 = analyticsData(1236).intl;
  obj6[3] = intl15.string(importDefault(2485).tq8598);
  ...
  return jsx(importDefault(16271), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1, categoriesHeader: null, optionsTree: null, trackOpen: null, trackReport: null });
};
