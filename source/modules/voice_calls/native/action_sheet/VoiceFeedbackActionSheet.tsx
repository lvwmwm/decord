...
// Function ID: 17281
// Name: trackOpen
// Dependencies: [19, 673, 11558, 21, 695, 1233, 2630, 11561, 17274, 17281, 17275, 4448, 17276, 2008, 4193, 2]
// Exports: default

// Module 17280 (trackOpen)
import noopAll from "noop" /* 19 */;
import expandEventPropertiesDefault from "expandEventProperties" /* 695 */;
import messagesProxyDefault from "messagesProxy" /* 2630 */;
import closeActionSheetDefault from "closeActionSheet" /* 17274 */;
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[3] = analyticsData(11561).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11561);
  obj4[3] = analyticsData(11561).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11561);
