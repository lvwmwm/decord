...
// Function ID: 16201
// Name: trackOpen
// Dependencies: [19, 676, 9532, 21, 698, 1236, 2455, 9535, 16194, 16201, 16195, 4161, 16196, 1959, 3893, 2]
// Exports: default
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[1] = intl9.string(importDefault(2455)["0WFzPh"]);
  ...
  obj2[3] = analyticsData(9535).getVideoFeedbackOptions();
  ...
  obj4[1] = intl12.string(importDefault(2455).Moa3W9);
  const intl13 = analyticsData(1236).intl;
  obj4[2] = intl13.string(analyticsData(1236).t.FJmoxF);
  const obj8 = analyticsData(9535);
  obj4[3] = analyticsData(9535).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(9535);
  const intl15 = analyticsData(1236).intl;
  obj6[3] = intl15.string(importDefault(2455).tq8598);
  ...
  return jsx(importDefault(16194), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1, categoriesHeader: null, optionsTree: null, trackOpen: null, trackReport: null });
};
