...
// Function ID: 16573
// Name: trackOpen
// Dependencies: [19, 676, 10811, 21, 698, 1236, 2565, 10814, 16566, 16573, 16567, 4342, 16568, 2007, 4093, 2]
// Exports: default

// Module 16572 (trackOpen)
import "noop";
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj[1] = intl3.string(importDefault(2565).FVhMw6);
  ...
  obj[1] = intl6.string(importDefault(2565).PL2l6A);
  ...
  obj2[1] = intl9.string(importDefault(2565)["0WFzPh"]);
  ...
  obj2[3] = analyticsData(10814).getVideoFeedbackOptions();
  ...
  obj6[3] = intl15.string(importDefault(2565).tq8598);
  ...
  return jsx(importDefault(16566), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1, categoriesHeader: null, optionsTree: null, trackOpen: null, trackReport: null });
};
