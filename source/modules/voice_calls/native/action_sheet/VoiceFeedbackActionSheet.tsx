...
// Function ID: 16173
// Name: trackOpen
// Dependencies: [19, 676, 9517, 21, 698, 1236, 2453, 9520, 16166, 16173, 16167, 4157, 16168, 1959, 3889, 2]
// Exports: default

// Module 16172 (trackOpen)
import "noop";
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[3] = analyticsData(9520).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(9520);
  obj4[3] = analyticsData(9520).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(9520);
  ...
  return jsx(importDefault(16166), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1, categoriesHeader: null, optionsTree: null, trackOpen: null, trackReport: null });
};
