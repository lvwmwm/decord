...
// Function ID: 124580
// Name: trackOpen
// Dependencies: [31, 653, 9457, 33, 675, 1212, 2429, 9460, 16083, 16090, 16084, 4099, 16085, 1935, 3831, 2]
// Exports: default

// Module 16089 (trackOpen)
import "result";
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2.problemOptions = analyticsData(9460).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(9460);
  obj4.problemOptions = analyticsData(9460).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(9460);
  ...
  return jsx(importDefault(16083), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1 });
};
