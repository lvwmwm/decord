...
// Function ID: 16669
// Name: trackOpen
// Dependencies: [19, 676, 10850, 21, 698, 1236, 2566, 10853, 16662, 16669, 16663, 4346, 16664, 2008, 4096, 2]
// Exports: default

// Module 16668 (trackOpen)
import noopAll from "noop" /* 19 */;
import expandEventPropertiesDefault from "expandEventProperties" /* 698 */;
import messagesProxyDefault from "messagesProxy" /* 2566 */;
import closeActionSheetDefault from "closeActionSheet" /* 16662 */;
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[3] = analyticsData(10853).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(10853);
  obj4[3] = analyticsData(10853).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(10853);
