...
// Function ID: 16430
// Name: trackOpen
// Dependencies: [19, 676, 11087, 21, 698, 1236, 2514, 11090, 16423, 16430, 16424, 4271, 16425, 1988, 4001, 2]
// Exports: default

// Module 16429 (trackOpen)
import "noop";
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[3] = analyticsData(11090).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11090);
  obj4[3] = analyticsData(11090).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11090);
  ...
  return jsx(importDefault(16423), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1, categoriesHeader: null, optionsTree: null, trackOpen: null, trackReport: null });
};
