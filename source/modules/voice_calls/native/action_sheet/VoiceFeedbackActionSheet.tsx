...
// Function ID: 16421
// Name: trackOpen
// Dependencies: [19, 676, 11086, 21, 698, 1236, 2514, 11089, 16414, 16421, 16415, 4271, 16416, 1988, 4001, 2]
// Exports: default

// Module 16420 (trackOpen)
import "noop";
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[1] = intl9.string(importDefault(2514)["0WFzPh"]);
  ...
  obj2[3] = analyticsData(11089).getVideoFeedbackOptions();
  ...
  obj4[1] = intl12.string(importDefault(2514).Moa3W9);
  const intl13 = analyticsData(1236).intl;
  obj4[2] = intl13.string(analyticsData(1236).t.FJmoxF);
  const obj8 = analyticsData(11089);
  obj4[3] = analyticsData(11089).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11089);
  const intl15 = analyticsData(1236).intl;
  obj6[3] = intl15.string(importDefault(2514).tq8598);
  ...
  return jsx(importDefault(16414), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1, categoriesHeader: null, optionsTree: null, trackOpen: null, trackReport: null });
};
