...
// Function ID: 16852
// Name: trackOpen
// Dependencies: [19, 676, 11127, 21, 698, 1236, 2599, 11130, 16845, 16852, 16846, 4412, 16847, 2009, 4161, 2]
// Exports: default

// Module 16851 (trackOpen)
import noopAll from "noop" /* 19 */;
import expandEventPropertiesDefault from "expandEventProperties" /* 698 */;
import messagesProxyDefault from "messagesProxy" /* 2599 */;
import closeActionSheetDefault from "closeActionSheet" /* 16845 */;
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[3] = analyticsData(11130).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11130);
  obj4[3] = analyticsData(11130).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11130);
