...
// Function ID: 16514
// Name: trackOpen
// Dependencies: [19, 676, 11060, 21, 698, 1236, 2533, 11063, 16507, 16514, 16508, 4310, 16509, 2007, 4061, 2]
// Exports: default

// Module 16513 (trackOpen)
import "noop";
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[3] = analyticsData(11063).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11063);
  obj4[3] = analyticsData(11063).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11063);
  ...
  return jsx(importDefault(16507), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1, categoriesHeader: null, optionsTree: null, trackOpen: null, trackReport: null });
};
