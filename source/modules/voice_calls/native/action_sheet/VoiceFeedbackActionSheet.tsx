...
// Function ID: 16523
// Name: trackOpen
// Dependencies: [19, 676, 11077, 21, 698, 1236, 2533, 11080, 16516, 16523, 16517, 4310, 16518, 2007, 4061, 2]
// Exports: default

// Module 16522 (trackOpen)
import "noop";
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[3] = analyticsData(11080).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11080);
  obj4[3] = analyticsData(11080).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11080);
  ...
  return jsx(importDefault(16516), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1, categoriesHeader: null, optionsTree: null, trackOpen: null, trackReport: null });
};
