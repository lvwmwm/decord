...
// Function ID: 16265
// Name: trackOpen
// Dependencies: [19, 676, 9679, 21, 698, 1236, 2485, 9682, 16258, 16265, 16259, 4223, 16260, 1959, 3955, 2]
// Exports: default

// Module 16264 (trackOpen)
import "noop";
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2[3] = analyticsData(9682).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(9682);
  obj4[3] = analyticsData(9682).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(9682);
  ...
  return jsx(importDefault(16258), { headerLabel: stringResult, showHeaderCloseButton: true, ratingBody: stringResult1, categoriesHeader: null, optionsTree: null, trackOpen: null, trackReport: null });
};
