...
// Function ID: 99617
// Name: ItemSeparator
// Dependencies: [57, 5, 31, 27, 1347, 1858, 4184, 3793, 1850, 4238, 653, 1277, 5222, 482, 33, 4165, 12815, 10711, 566, 7611, 12474, 1212, 10202, 4016, 8324, 4161, 9383, 5497, 1820, 4979, 10582, 4376, 12820, 12821, 1450, 12828, 22, 4133, 8335, 3877, 12829, 7655, 2]

// Module 12819 (ItemSeparator)
...
function ItemSeparator() {
  const tmp = callback4();
  return callback2(require(7611) /* Form */.FormDivider, { style: callback4().rowFormDivider });
}
...
let closure_25 = importAllResult.memo((channel) => callback2(importDefault(12815), { channel: channel.channel }));
let closure_26 = importAllResult.memo((channel) => {
  ...
  if (!tmp) {
    ...
    if (tmp3) {
      ...
      obj.source = importDefault(10202);
      obj.size = channel(12474).CircularIconButton.Sizes.MEDIUM_32;
      obj.leading = callback2(channel(12474).CircularIconButton, obj);
      ...
      items[1] = callback2(channel(7611).FormRow, obj);
      obj.children = items;
