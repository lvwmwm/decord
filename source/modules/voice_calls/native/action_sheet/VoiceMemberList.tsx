...
// Function ID: 12842
// Name: ItemSeparator
// Dependencies: [32, 5, 19, 17, 1371, 1882, 4208, 3817, 1874, 4262, 676, 1301, 5244, 505, 21, 4189, 12837, 10735, 589, 7634, 12496, 1236, 10223, 4040, 8348, 4185, 9407, 5515, 1844, 5001, 10606, 4399, 12842, 12843, 1474, 12850, 12, 4157, 8359, 3901, 12851, 7678, 2]

// Module 12841 (ItemSeparator)
...
function ItemSeparator() {
  const tmp = callback4();
  return callback2(require(7634) /* Form */.FormDivider, { style: callback4().rowFormDivider });
}
...
let closure_25 = importAllResult.memo((channel) => callback2(importDefault(12837), { channel: channel.channel }));
let closure_26 = importAllResult.memo((channel) => {
  ...
  if (!tmp3) {
    ...
    if (tmp6) {
      ...
      obj[2] = importDefault(10223);
      obj[3] = tmp4(12496).CircularIconButton.Sizes.MEDIUM_32;
      obj[0] = callback2(tmp4(12496).CircularIconButton, obj);
      ...
      items[1] = callback2(tmp4(7634).FormRow, obj);
      obj[0] = items;
