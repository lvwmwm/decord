...
// Dependencies: [19, 17, 676, 21, 4342, 5276, 712, 1628, 1297, 1236, 13116, 13117, 2]
// Exports: default

// Module 13115 (VoiceEmptyState)
import "noop";
...
export default function VoiceEmptyState(channel) {
  ...
  obj[2] = importDefault(13116);
  obj[3] = importDefault(13116);
  ({ emptyTitle: obj3[4], emptyBody: obj3[5] } = tmp);
  obj[6] = { marginBottom: 16, marginTop: 20 };
  const items1 = [callback(require(1297) /* Button */.ThemedEmptyState, obj), callback(importDefault(13117), { channel: channel.channel, style: tmp.button })];
  obj[1] = items1;
