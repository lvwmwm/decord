...
export default function VoiceEmptyState(channel) {
  ...
  obj[2] = importDefault(13115);
  obj[3] = importDefault(13115);
  ({ emptyTitle: obj3[4], emptyBody: obj3[5] } = tmp);
  obj[6] = { marginBottom: 16, marginTop: 20 };
  const items1 = [callback(require(1297) /* Button */.ThemedEmptyState, obj), callback(importDefault(13116), { channel: channel.channel, style: tmp.button })];
  obj[1] = items1;
