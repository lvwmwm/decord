...
// Dependencies: [17, 4326, 9044, 500, 9045, 589, 709, 2]

// Module 9043 (handleAudioRouteChanged)
  ...
  if (null != arr) {
    if ("" !== arr) {
      if (arr.includes("Bluetooth")) {
        let UNKNOWN = require(9044) /* RouteTypes */.RouteTypes.BLUETOOTH;
      } else if (arr.includes("Speaker")) {
        UNKNOWN = require(9044) /* RouteTypes */.RouteTypes.SPEAKER;
      } else if (arr.includes("Receiver")) {
        UNKNOWN = require(9044) /* RouteTypes */.RouteTypes.RECEIVER;
      } else {
        const hasItem = arr.includes("Headphones");
        const RouteTypes = require(9044) /* RouteTypes */.RouteTypes;
        UNKNOWN = hasItem ? RouteTypes.WIRED : RouteTypes.UNKNOWN;
      }
    }
    c6 = tmp;
  }
  UNKNOWN = require(9044) /* RouteTypes */.RouteTypes.UNKNOWN;
}
  ...
  RTC_CONNECTION_STATE: function handleConnectionStatusChanged() {
    ...
    if (null === _null) {
      if (isConnectedResult) {
        ...
        let UNKNOWN = require(9044) /* RouteTypes */.RouteTypes.UNKNOWN;
