...
// Function ID: 15172
// Name: getChannelMode
// Dependencies: [109, 19, 17, 4388, 3938, 1903, 676, 1379, 4498, 21, 4302, 712, 5157, 11686, 1416, 5267, 15172, 4802, 4762, 589, 1297, 4743, 15173, 4492, 1222, 2]

// Module 15171 (getChannelMode)
...
function getChannelMode(selected) {
  ...
  if (selected.selected) {
    ...
    if (tmp2) {
      let DEFAULT = require(11686) /* BaseChannelSubtitle */.ChannelModes.LOCKED;
    } else if (tmp) {
      DEFAULT = require(11686) /* BaseChannelSubtitle */.ChannelModes.MUTED;
    } else if (unread) {
      if (selected.resolvedUnreadSetting === UnreadSetting.ALL_MESSAGES) {
        let UNREAD_LESS_IMPORTANT = require(11686) /* BaseChannelSubtitle */.ChannelModes.UNREAD_IMPORTANT;
      } else {
        UNREAD_LESS_IMPORTANT = require(11686) /* BaseChannelSubtitle */.ChannelModes.UNREAD_LESS_IMPORTANT;
      }
    } else {
      DEFAULT = require(11686) /* BaseChannelSubtitle */.ChannelModes.DEFAULT;
    }
    return DEFAULT;
  }
}
function ChannelIcon(arg0) {
  ...
  if (channel.type === ChannelTypes.DM) {
    ...
    if (tmp2) {
      let tmp12 = importDefault(15172);
      let BookCheckIcon = require(4802) /* BookCheckIcon */.BookCheckIcon;
      let tmp9 = require;
    } else {
      tmp9 = require;
      let obj2 = require(4762) /* getChannelIcon */;
      obj2 = { isRulesChannel: false, locked: null };
      obj2[1] = locked;
      const channelIcon = obj2.getChannelIcon(channel, obj2);
      let obj4 = require(4762) /* getChannelIcon */;
