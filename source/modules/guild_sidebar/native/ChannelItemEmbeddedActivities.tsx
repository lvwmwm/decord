...
// Dependencies: [19, 17, 21, 4285, 712, 5659, 4281, 2]
// Exports: default

// Module 15250 (ChannelItemEmbeddedActivities)
import "noop";
...
export default function ChannelItemEmbeddedActivities(muted) {
  ...
  if (size === undefined) {
    size = require(5659) /* GameIcon */.GameIconSizes.SIZE_24;
  }
  ...
  if (embeddedApps.length <= 0) {
    ...
    const tmp13 = require(5659) /* GameIcon */.GameIconImageSize[size];
    ...
    const items = [callback(importDefault(5659), obj1), ];
    if (2 === embeddedApps.length) {
      obj = { game: null, size: null };
      obj[0] = embeddedApps[1].application;
      obj[1] = size;
      let tmp16Result = tmp16(importDefault(5659), obj);
    } else {
