...
// Dependencies: [19, 6912, 1891, 3912, 4297, 4301, 676, 21, 4285, 589, 11364, 8326, 15246, 15247, 4468, 1297, 15249, 15250, 15157, 5117, 11584, 15158, 15251, 12201, 2]
// Exports: default

// Module 15245 (LimitAndDurationInfo)
...
function DurationInfo(channel) {
  let obj = require(15251) /* useStartTime */;
  ...
  if (null != startTime) {
    ...
    tmp5 = jsx(require(12201) /* ActiveTimestamp */.ActiveTimestamp, { start: null });
  }
  return tmp5;
}
...
export default function ChannelInfo(channel) {
  ...
  const tmp5 = importDefault(11364)(channel);
  let obj1 = channel(8326);
  const postsWithUnreadsCount = obj1.useUnreadThreadsCountForParent(channel.guild_id, channel.id);
  if (importDefault(15246)({ mentionsCount, isNewChannel, postsWithUnreadsCount, muted })) {
