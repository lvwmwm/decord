...
// Dependencies: [19, 7039, 1910, 3989, 4357, 4361, 676, 21, 4342, 589, 11502, 8452, 15431, 15432, 4528, 1297, 15434, 15435, 15325, 5176, 11724, 15326, 15436, 12351, 2]
// Exports: default

// Module 15430 (LimitAndDurationInfo)
...
function DurationInfo(channel) {
  let obj = require(15436) /* useStartTime */;
  ...
  if (null != startTime) {
    ...
    tmp5 = jsx(require(12351) /* ActiveTimestamp */.ActiveTimestamp, { start: null });
  }
  return tmp5;
}
...
export default function ChannelInfo(channel) {
  ...
  const tmp5 = importDefault(11502)(channel);
  let obj1 = channel(8452);
  const postsWithUnreadsCount = obj1.useUnreadThreadsCountForParent(channel.guild_id, channel.id);
  if (importDefault(15431)({ mentionsCount, isNewChannel, postsWithUnreadsCount, muted })) {
