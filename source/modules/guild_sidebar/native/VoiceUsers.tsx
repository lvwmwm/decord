...
// Function ID: 15161
// Name: AudienceItem
// Dependencies: [19, 17, 1971, 21, 4285, 712, 9713, 8315, 589, 15161, 9370, 1236, 11807, 4281, 15165, 2]
// Exports: default, getAudienceItemHeight

// Module 15160 (AudienceItem)
...
function AudienceItem(arg0) {
  ...
  const tmp2 = callback2(importDefault(8315)());
  ...
  obj = { style: tmp2.listenersIconWrapper, children: callback(require(11807) /* HeadphonesIcon */.HeadphonesIcon, obj1) };
...
let closure_8 = createCacheKey.createStyles((arg0) => {
  ...
  const merged = Object.assign(require(9713) /* getLayoutStyles */.makeSizeStyle(20));
  obj[2] = obj;
  obj[3] = { marginRight: 4 };
  obj[4] = { marginLeft: -20 };
  const obj3 = require(9713) /* getLayoutStyles */;
  obj[5] = require(9713) /* getLayoutStyles */.makeSizeStyle(14);
  return obj;
});
let closure_9 = require("noop").memo((voiceState) => {
  ...
  obj[10] = channel;
  obj[11] = isGuest;
  obj[1] = closure_5(channel(15161), obj, user.id);
...
export default function VoiceUsers(collapsed) {
  ...
  if (0 !== voiceStates.length) {
    ...
    items[1] = tmp2;
    obj[1] = items;
    tmp = closure_6(importDefault(15165), obj);
    const tmp5 = closure_6;
    const tmp8 = importDefault(15165);
  }
  return tmp;
};
