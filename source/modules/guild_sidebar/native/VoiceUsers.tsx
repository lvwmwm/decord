...
// Function ID: 15104
// Name: AudienceItem
// Dependencies: [19, 17, 1942, 21, 4189, 712, 10281, 8821, 589, 15104, 9908, 1236, 11616, 4185, 15108, 2]
// Exports: default, getAudienceItemHeight

// Module 15103 (AudienceItem)
...
function AudienceItem(arg0) {
  ...
  const tmp2 = callback2(importDefault(8821)());
  ...
  obj = { style: tmp2.listenersIconWrapper, children: callback(require(11616) /* HeadphonesIcon */.HeadphonesIcon, obj1) };
...
let closure_8 = createCacheKey.createStyles((arg0) => {
  ...
  const merged = Object.assign(require(10281) /* getLayoutStyles */.makeSizeStyle(20));
  obj[2] = obj;
  obj[3] = { marginRight: 4 };
  obj[4] = { marginLeft: -20 };
  const obj3 = require(10281) /* getLayoutStyles */;
  obj[5] = require(10281) /* getLayoutStyles */.makeSizeStyle(14);
  return obj;
});
let closure_9 = require("noop").memo((voiceState) => {
  ...
  obj[10] = channel;
  obj[11] = isGuest;
  obj[1] = closure_5(channel(15104), obj, user.id);
...
export default function VoiceUsers(collapsed) {
  ...
  if (0 !== voiceStates.length) {
    ...
    items[1] = tmp2;
    obj[1] = items;
    tmp = closure_6(importDefault(15108), obj);
    const tmp5 = closure_6;
    const tmp8 = importDefault(15108);
  }
  return tmp;
};
export const getAudienceItemHeight = function getAudienceItemHeight(fontScale) {
  return 8 + Math.max(20, require(9908) /* map */.scaleTextLineHeight(c7, fontScale));
};
