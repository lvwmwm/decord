...
// Function ID: 15334
// Name: AudienceItem
// Dependencies: [19, 17, 1990, 21, 4342, 712, 9856, 8463, 589, 15334, 9515, 1236, 11968, 4338, 9302, 15338, 5990, 15341, 2]
// Exports: default, getAudienceItemHeight

// Module 15333 (AudienceItem)
...
function AudienceItem(arg0) {
  ...
  const tmp2 = callback2(importDefault(8463)());
  ...
  obj = { style: tmp2.listenersIconWrapper, children: callback(require(11968) /* HeadphonesIcon */.HeadphonesIcon, obj1) };
...
let closure_11 = createCacheKey.createStyles((arg0) => {
  ...
  const merged = Object.assign(require(9856) /* getLayoutStyles */.makeSizeStyle(20));
  obj[2] = obj;
  obj[3] = { marginRight: 4 };
  obj[4] = { marginLeft: -20 };
  const obj3 = require(9856) /* getLayoutStyles */;
  obj[5] = require(9856) /* getLayoutStyles */.makeSizeStyle(14);
  return obj;
});
let closure_12 = importAllResult.memo((voiceState) => {
  ...
  obj[10] = channel;
  obj[11] = isGuest;
  obj[1] = closure_6(channel(15334), obj, user.id);
...
export const getAudienceItemHeight = function getAudienceItemHeight(fontScale) {
  return 8 + Math.max(20, require(9515) /* map */.scaleTextLineHeight(c10, fontScale));
};
