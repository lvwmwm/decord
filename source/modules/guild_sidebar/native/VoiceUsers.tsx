...
// Function ID: 15177
// Name: AudienceItem
// Dependencies: [19, 17, 1971, 21, 4302, 712, 9729, 8332, 589, 15177, 9387, 1236, 11822, 4298, 15181, 2]
// Exports: default, getAudienceItemHeight

// Module 15176 (AudienceItem)
...
function AudienceItem(arg0) {
  ...
  const tmp2 = callback2(importDefault(8332)());
  ...
  obj = { style: tmp2.listenersIconWrapper, children: callback(require(11822) /* HeadphonesIcon */.HeadphonesIcon, obj1) };
  const items = [callback(View, obj), callback(require(4298) /* Text */.Text, { style: tmp2.listenersText, variant: c7, color: "redesign-channel-name-muted-text", children: formatToPlainStringResult })];
  obj[1] = items;
...
let closure_8 = createCacheKey.createStyles((arg0) => {
  ...
  const merged = Object.assign(require(9729) /* getLayoutStyles */.makeSizeStyle(20));
  obj[2] = obj;
  obj[3] = { marginRight: 4 };
  obj[4] = { marginLeft: -20 };
  const obj3 = require(9729) /* getLayoutStyles */;
  obj[5] = require(9729) /* getLayoutStyles */.makeSizeStyle(14);
  return obj;
});
let closure_9 = require("noop").memo((voiceState) => {
  ...
  obj[10] = channel;
  obj[11] = isGuest;
  obj[1] = closure_5(channel(15177), obj, user.id);
...
export default function VoiceUsers(collapsed) {
  ...
  if (0 !== voiceStates.length) {
    ...
    items[1] = tmp2;
    obj[1] = items;
    tmp = closure_6(importDefault(15181), obj);
    const tmp5 = closure_6;
    const tmp8 = importDefault(15181);
  }
  return tmp;
};
export const getAudienceItemHeight = function getAudienceItemHeight(fontScale) {
  return 8 + Math.max(20, require(9387) /* map */.scaleTextLineHeight(c7, fontScale));
};
