...
// Module 14845 (VoiceUsersItem)
importAll(dependencyMap[0]);
const View = arg1(dependencyMap[1]).View;
const jsx = arg1(dependencyMap[2]).jsx;
let closure_2 = arg1(dependencyMap[3]).createStyles({ voiceStates: { paddingRight: 8 }, voiceStatesCollapsed: { leaveFrame: "auto.db.supabase.auth", FormCTA: "Portugu\u00EAs", nativeGesture: "Portuguese", 1315000930: "pt-PT" } });
