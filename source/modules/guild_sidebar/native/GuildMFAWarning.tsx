...
obj.MFAWarning = obj;
obj.MFAWarningIcon = { FAILED: null, width: "0068bea3a7b26b1d06c599bf3096c534", backgroundColor: "channels-empty" };
...
export default function GuildMFAWarning() {
  ...
  const items2 = [, intl2.string(arg1(dependencyMap[14]).t.hvVgAZ)];
