...
// Dependencies: [19, 17, 4247, 21, 1297, 9341, 4255, 712, 9682, 589, 4116, 4256, 1416, 15125, 9078, 9080, 9074, 9076, 7607, 7584, 12097, 2]
// Exports: getVoiceUserHeight

// Module 15124 (getVoiceUserHeight)
...
export const getVoiceUserHeight = function getVoiceUserHeight(fontScale) {
  ...
  return Math.max(require(9341) /* map */.scaleTextLineHeight(c7, fontScale), require(1297) /* Button */.AVATAR_SIZE_MAP[XSMALL_20]) + 10;
};
