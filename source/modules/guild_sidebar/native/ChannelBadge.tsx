...
// Function ID: 15424
// Name: ChannelBadge
// Dependencies: [19, 17, 1994, 21, 4342, 647, 15424, 11727, 4338, 1898, 2]
// Exports: default

// Module 15423 (ChannelBadge)
import "noop";
...
export default function ChannelBadge(arg0) {
  ...
  if (null != mentionCount) {
    if (mentionCount > 0) {
      ...
      obj[1] = jsx(importDefault(15424), { mentionsCount: null, isMentionLowImportance: null });
  ...
  if (isNewChannel) {
    ...
    obj1[1] = jsx(importDefault(11727), {});
      ...
      if (!muted) {
        ...
        if (null != postsWithUnreadsCount) {
          ...
          if (postsWithUnreadsCount > 0) {
            ...
            obj2[1] = jsx(tmp2(4338).Text, { variant: "text-xs/semibold", color: "text-muted", children: null });
            tmp5 = <View style={null}>{null}</View>;
