...
// Function ID: 15424
// Name: ChannelBadge
// Dependencies: [19, 17, 1994, 21, 4344, 647, 15424, 11728, 4340, 1898, 2]
// Exports: default
...
export default function ChannelBadge(arg0) {
  ...
  if (isNewChannel) {
    ...
    obj1[1] = jsx(importDefault(11728), {});
      ...
      if (!muted) {
        ...
        if (null != postsWithUnreadsCount) {
          ...
          if (postsWithUnreadsCount > 0) {
            ...
            obj2[1] = jsx(tmp2(4340).Text, { variant: "text-xs/semibold", color: "text-muted", children: null });
            tmp5 = <View style={null}>{null}</View>;
