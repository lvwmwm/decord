...
// Dependencies: [19, 17, 6900, 4297, 9710, 5207, 4481, 21, 4285, 712, 5859, 4101, 1358, 647, 6896, 4490, 10936, 1959, 11665, 11575, 1236, 13099, 2]
// Exports: GuildRolesAndChannelsRow

// Module 15209 (GuildRolesAndChannelsRow)
...
export const GuildRolesAndChannelsRow = function GuildRolesAndChannelsRow(guild) {
  ...
  let SELECTED = guild(11665).ChannelModes.DEFAULT;
  if (selected) {
    SELECTED = tmp5(11665).ChannelModes.SELECTED;
  }
  let tmp10 = !result;
  if (result) {
