...
// Dependencies: [19, 17, 21, 1297, 4255, 8175, 8174, 4776, 4780, 2]

// Module 15128 (VOICE_USER_SUMMARY_HEIGHT)
...
const memoResult = importAllResult.memo((guildId) => {
  ...
  VoiceNormalIcon = tmp4(4780).VoiceNormalIcon;
});
