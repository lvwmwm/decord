...
// Dependencies: [19, 17, 21, 1296, 4478, 7628, 7627, 5051, 5055, 2]

// Module 15966 (VOICE_USER_SUMMARY_HEIGHT)
...
const memoResult = importAllResult.memo((guildId) => {
  ...
  VoiceNormalIcon = tmp4(5055).VoiceNormalIcon;
});
