...
// Dependencies: [19, 17, 21, 1297, 4445, 7550, 7549, 4998, 5002, 2]

// Module 15631 (VOICE_USER_SUMMARY_HEIGHT)
...
const memoResult = importAllResult.memo((guildId) => {
  ...
  VoiceNormalIcon = tmp4(5002).VoiceNormalIcon;
});
