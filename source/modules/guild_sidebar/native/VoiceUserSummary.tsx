...
// Dependencies: [19, 17, 21, 1297, 4302, 8332, 8331, 4823, 4827, 2]

// Module 15182 (VOICE_USER_SUMMARY_HEIGHT)
...
const memoResult = importAllResult.memo((guildId) => {
  ...
  VoiceNormalIcon = tmp4(4827).VoiceNormalIcon;
});
