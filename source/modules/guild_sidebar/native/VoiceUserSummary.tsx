...
// Dependencies: [19, 17, 21, 1297, 4444, 8617, 8616, 4993, 4997, 2]

// Module 15566 (VOICE_USER_SUMMARY_HEIGHT)
...
const memoResult = importAllResult.memo((guildId) => {
  ...
  VoiceNormalIcon = tmp4(4997).VoiceNormalIcon;
});
