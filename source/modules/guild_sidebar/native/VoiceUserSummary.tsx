...
// Dependencies: [19, 17, 21, 1297, 4285, 8315, 8314, 4806, 4810, 2]

// Module 15166 (VOICE_USER_SUMMARY_HEIGHT)
...
const memoResult = importAllResult.memo((guildId) => {
  ...
  VoiceNormalIcon = tmp4(4810).VoiceNormalIcon;
});
