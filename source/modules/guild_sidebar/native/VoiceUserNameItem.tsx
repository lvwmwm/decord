...
// Dependencies: [32, 19, 17, 21, 4302, 4531, 9176, 4298, 4140, 1236, 15180, 2]
// Exports: default

// Module 15179 (VoiceUserNameItem)
...
export default function VoiceUserNameItem(arg0) {
  ...
  let obj1 = _require(9176);
  const displayNameStylesFont = obj1.useDisplayNameStylesFont({ displayNameStyles: importDefault(4531)(obj) });
  const tmp4 = importDefault(4531)(obj);
  ...
  items1[1] = isGuest;
  obj[5] = items1;
  const items3 = [closure_6(_require(4298).Text, obj), ];
  if (!tmp12) {
