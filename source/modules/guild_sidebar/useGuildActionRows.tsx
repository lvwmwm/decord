...
// Dependencies: [32, 4457, 6890, 676, 11595, 5764, 5750, 5762, 5728, 5724, 647, 5748, 5725, 11565, 5765, 5726, 11725, 15130, 15189, 5767, 4166, 15229, 5921, 1358, 2]
// Exports: default

// Module 15228 (useGuildActionRows)
...
export default function useGuildActionRows(id) {
  ...
  let features3;
  const _require = id;
  const tmp2 = importDefault(11595)(id.id);
  const tmp3 = _require;
  let canReviewGuildMemberApplications = _require(5764).useCanReviewGuildMemberApplications(id.id);
  const obj = _require(5764);
  const showRoleSubscriptionsInChannelList = _require(5750).useShowRoleSubscriptionsInChannelList(id.id);
  const obj2 = _require(5750);
  const guildShopVisibleInGuild = _require(5762).useGuildShopVisibleInGuild(id);
  const obj3 = _require(5762);
  const result = _require(5728).hasSocialLayerStorefront(id);
  const obj4 = _require(5728);
  const canSeeOnboardingHome = _require(5724).useCanSeeOnboardingHome(id.id);
  const obj5 = _require(5724);
  ...
  const canManageVibegrations = _require(5748).useCanManageVibegrations(id, "useGuildActionRows");
  const obj7 = _require(5748);
  const tmp10 = importDefault(5725)(id.id);
  const allActionsCompleted = _require(11565).useAllActionsCompleted(id.id);
  const obj8 = _require(11565);
  const canAccessMemberSafetyPage = _require(5765).useCanAccessMemberSafetyPage(id.id);
  const obj9 = _require(5765);
  const features = id.features;
  const canUseGuildSpace = _require(5726).useCanUseGuildSpace(id, "useGuildActionRows");
  ...
  const obj10 = _require(5726);
  const tmp14 = GuildFeatures;
  const tmp18 = importDefault(11725)(id.id);
  ...
  const tmp20 = importDefault(15189)(id);
  const isGuildOfficialMessagesEnabled = _require(5767).useIsGuildOfficialMessagesEnabled(id.id, "useGuildActionRows");
  const obj12 = _require(5767);
  ...
  const isGameServerTabAlwaysOnEnabled = _require(15229).useIsGameServerTabAlwaysOnEnabled("useGuildActionRows");
  _require(5921);
