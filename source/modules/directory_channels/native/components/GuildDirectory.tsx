...
// Function ID: 12084
// Name: keyExtractor
// Dependencies: [19, 17, 1910, 4356, 11744, 11737, 11742, 676, 21, 4344, 712, 12084, 12085, 11767, 11768, 4340, 12086, 1236, 4754, 6047, 11354, 12087, 11739, 4886, 11740, 12168, 589, 1628, 6976, 9, 5292, 4178, 11748, 698, 12169, 11732, 12173, 2]
// Exports: default
...
function keyExtractor(type) {
  ...
  if (type === require(12085) /* RowType */.RowType.ENTRY) {
...
function renderItem(item) {
  ...
  if (require(12085) /* RowType */.RowType.HEADER === type) {
    let obj = { children: null };
    obj[0] = item.header;
    return callback(GuildDirectoryHeaderRowItem, obj);
  } else if (tmp2(12085).RowType.ENTRY === type) {
    obj = { entry: null };
    obj[0] = item.entry;
    return callback(importDefault(11767), obj);
  } else {
    return callback(importDefault(11768), {});
  }
  tmp2 = require;
}
function GuildDirectoryHeaderRowItem(children) {
  const tmp = callback3();
  return callback(require(4340) /* Text */.Text, { style: callback3().categorySectionText, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: children.children });
}
function GuildDirectoryHeader(guild) {
  ...
  const items1 = [callback(require(4340) /* Text */.Text, obj1), , , ];
  ...
  obj3[1] = callback(require(6047) /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { size: "sm", color: "text-strong" });
  ...
  items1[3] = callback(require(11354) /* TTIFirstContentfulPaint */.TTIFirstContentfulPaint, { label: "hub_directory" });
  obj[1] = items1;
  ...
  if (hasItem) {
    ...
    obj4[0] = guild;
    tmp5Result = callback(importDefault(12087), obj4);
  }
...
function GuildDirectoryFooter(hideFooter) {
  ...
  const tmp = callback3();
  let obj = require(11739) /* useCanManageGuildDirectoryEntry */;
  let tmp4 = null;
  if (obj.useCanCreateOrAddGuildInDirectory(channel)) {
    ...
    if (!hideFooter.hideFooter) {
      ...
      obj1[0] = tmp.addIcon;
      obj1[1] = callback(tmp2(12168).PlusMediumIcon, {});
      ...
      tmp4 = callback(tmp2(4886).PressableOpacity, obj);
    }
  }
  return tmp4;
}
...
export default function GuildDirectory(channel) {
  ...
  tmp2Result = tmp2(4178);
  _location = tmp2Result.useLocation();
  history = channel(4178).useHistory();
  ...
  if (null == onPressSearch) {
    ...
    if (!directoryIsFetching) {
      if (0 === allEntriesCount) {
        ...
        obj2[1] = channel;
        items9[1] = callback(guildId(12169), obj2);
        items9[2] = callback(tmp2(11354).TTIFirstContentfulPaint, { label: "guild_directory_empty" });
        obj[1] = items9;
