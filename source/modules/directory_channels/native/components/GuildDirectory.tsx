...
// Function ID: 12027
// Name: keyExtractor
// Dependencies: [19, 17, 1910, 4315, 11687, 11680, 11685, 676, 21, 4303, 712, 12027, 12028, 11710, 11711, 4299, 12029, 1236, 4714, 6008, 11300, 12030, 11682, 4846, 11683, 12111, 589, 1628, 6937, 9, 5253, 4137, 11691, 698, 12112, 11675, 12116, 2]
// Exports: default

// Module 12026 (keyExtractor)
...
function keyExtractor(type) {
  ...
  if (type === require(12028) /* RowType */.RowType.ENTRY) {
...
function renderItem(item) {
  ...
  if (require(12028) /* RowType */.RowType.HEADER === type) {
    let obj = { children: null };
    obj[0] = item.header;
    return callback(GuildDirectoryHeaderRowItem, obj);
  } else if (tmp2(12028).RowType.ENTRY === type) {
    obj = { entry: null };
    obj[0] = item.entry;
    return callback(importDefault(11710), obj);
  } else {
    return callback(importDefault(11711), {});
  }
  tmp2 = require;
}
function GuildDirectoryHeaderRowItem(children) {
  const tmp = callback3();
  return callback(require(4299) /* Text */.Text, { style: callback3().categorySectionText, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: children.children });
}
function GuildDirectoryHeader(guild) {
  ...
  obj[0] = require(12029) /* registerAsset */;
  ...
  obj3[1] = callback(require(6008) /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { size: "sm", color: "text-strong" });
  ...
  items1[3] = callback(require(11300) /* TTIFirstContentfulPaint */.TTIFirstContentfulPaint, { label: "hub_directory" });
  obj[1] = items1;
  ...
  if (hasItem) {
    ...
    obj4[0] = guild;
    tmp5Result = callback(importDefault(12030), obj4);
  }
...
function GuildDirectoryFooter(hideFooter) {
  ...
  const tmp = callback3();
  let obj = require(11682) /* useCanManageGuildDirectoryEntry */;
  let tmp4 = null;
  if (obj.useCanCreateOrAddGuildInDirectory(channel)) {
    ...
    if (!hideFooter.hideFooter) {
      ...
      obj1[0] = tmp.addIcon;
      obj1[1] = callback(tmp2(12111).PlusMediumIcon, {});
      ...
      tmp4 = callback(tmp2(4846).PressableOpacity, obj);
    }
  }
  return tmp4;
}
...
export default function GuildDirectory(channel) {
  ...
  tmp2Result = tmp2(4137);
  _location = tmp2Result.useLocation();
  history = channel(4137).useHistory();
  ...
  if (null == onPressSearch) {
    ...
    if (!directoryIsFetching) {
      if (0 === allEntriesCount) {
        ...
        obj2[1] = channel;
        items9[1] = callback(guildId(12112), obj2);
        items9[2] = callback(tmp2(11300).TTIFirstContentfulPaint, { label: "guild_directory_empty" });
        obj[1] = items9;
