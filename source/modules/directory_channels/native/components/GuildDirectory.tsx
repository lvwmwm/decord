...
// Function ID: 11942
// Name: keyExtractor
// Dependencies: [19, 17, 1891, 4297, 11602, 11595, 11600, 676, 21, 4285, 712, 11942, 11943, 11625, 11626, 4281, 11944, 1236, 4695, 5927, 11213, 11945, 11597, 4827, 11598, 12026, 589, 1609, 6855, 9, 5236, 4112, 11606, 698, 12027, 11590, 12031, 2]
// Exports: default

// Module 11941 (keyExtractor)
...
function keyExtractor(type) {
  ...
  if (type === require(11943) /* RowType */.RowType.ENTRY) {
...
function renderItem(item) {
  ...
  if (require(11943) /* RowType */.RowType.HEADER === type) {
    let obj = { children: null };
    obj[0] = item.header;
    return callback(GuildDirectoryHeaderRowItem, obj);
  } else if (tmp2(11943).RowType.ENTRY === type) {
    obj = { entry: null };
    obj[0] = item.entry;
    return callback(importDefault(11625), obj);
  } else {
    return callback(importDefault(11626), {});
  }
  tmp2 = require;
}
...
function GuildDirectoryHeader(guild) {
  ...
  obj[0] = require(11944) /* registerAsset */;
  ...
  obj3[1] = callback(require(5927) /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { size: "sm", color: "text-strong" });
  ...
  items1[3] = callback(require(11213) /* TTIFirstContentfulPaint */.TTIFirstContentfulPaint, { label: "hub_directory" });
  obj[1] = items1;
  ...
  if (hasItem) {
    ...
    obj4[0] = guild;
    tmp5Result = callback(importDefault(11945), obj4);
  }
...
function GuildDirectoryFooter(hideFooter) {
  ...
  const tmp = callback3();
  let obj = require(11597) /* useCanManageGuildDirectoryEntry */;
  let tmp4 = null;
  if (obj.useCanCreateOrAddGuildInDirectory(channel)) {
    ...
    if (!hideFooter.hideFooter) {
      ...
      obj1[0] = tmp.addIcon;
      obj1[1] = callback(tmp2(12026).PlusMediumIcon, {});
      ...
      tmp4 = callback(tmp2(4827).PressableOpacity, obj);
    }
  }
  return tmp4;
}
...
export default function GuildDirectory(channel) {
  ...
  tmp2Result = tmp2(4112);
  _location = tmp2Result.useLocation();
  history = channel(4112).useHistory();
  ...
  if (null == onPressSearch) {
    ...
    if (!directoryIsFetching) {
      if (0 === allEntriesCount) {
        ...
        obj2[1] = channel;
        items9[1] = callback(guildId(12027), obj2);
        items9[2] = callback(tmp2(11213).TTIFirstContentfulPaint, { label: "guild_directory_empty" });
        obj[1] = items9;
