...
function renderItem(item) {
  ...
  if (require(11696) /* RowType */.RowType.HEADER === type) {
    ...
    return callback(importDefault(10036), {});
  }
}
...
function GuildDirectoryHeader(guild) {
  ...
  const obj4 = { variant: "primary-overlay", icon: callback(require(8232) /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { size: "sm", color: "text-strong" }) };
  const intl3 = require(1212) /* getSystemLocale */.intl;
  obj4.text = intl3.string(require(1212) /* getSystemLocale */.t.nL2wKD);
  obj4.onPress = guild.onPressSearch;
  items1[2] = callback(require(4544) /* Button */.Button, obj4);
  items1[3] = callback(require(9986) /* TTIFirstContentfulPaint */.TTIFirstContentfulPaint, { label: "hub_directory" });
...
function GuildDirectoryFooter(hideFooter) {
  ...
  const tmp = callback3();
  let obj = require(9998) /* useCanManageGuildDirectoryEntry */;
  let tmp2 = null;
  if (obj.useCanCreateOrAddGuildInDirectory(channel)) {
    ...
    if (!hideFooter.hideFooter) {
      ...
      tmp2 = callback(require(4661) /* PressableBase */.PressableOpacity, obj);
    }
  }
  return tmp2;
}
...
export default function GuildDirectory(channel) {
  ...
  history = channel(3959).useHistory();
