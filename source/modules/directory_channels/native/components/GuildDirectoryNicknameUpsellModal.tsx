...
// Dependencies: [5, 32, 19, 17, 1891, 11926, 21, 4285, 5250, 712, 589, 5349, 5246, 4184, 5700, 4281, 1236, 8388, 1297, 4695, 11927, 11936, 5253, 5704, 5637, 2]
// Exports: default

// Module 11937 (GuildDirectoryNicknameUpsell)
...
import { GuildPrompts } from "GuildPrompts";
import jsxProd from "module_11936";
...
function GuildDirectoryNicknameUpsell(arg0) {
  ...
  const insets = importDefault(5349)().insets;
  ...
  obj1[2] = require(5700) /* GuildIconSizes */.GuildIconSizes.XLARGE;
  const items2 = [callback(importDefault(5700), obj1), , , , ];
  ...
  const tmp13 = importDefault(5700);
  ...
  items2[2] = callback(tmp5(8388), obj5);
...
export default function GuildDirectoryNicknameUpsellModal(arg0) {
  ...
  return callback(_require(5704).Navigator, obj);
};
