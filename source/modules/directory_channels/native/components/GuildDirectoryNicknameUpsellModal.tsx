...
// Dependencies: [5, 32, 19, 17, 1910, 12068, 21, 4344, 5306, 712, 589, 5408, 5302, 4243, 5818, 4340, 1236, 8510, 1297, 4754, 12069, 12078, 5309, 5822, 5755, 2]
// Exports: default

// Module 12079 (GuildDirectoryNicknameUpsell)
...
import { GuildPrompts } from "GuildPrompts";
import jsxProd from "module_12078";
...
function GuildDirectoryNicknameUpsell(arg0) {
  ...
  obj1[2] = require(5818) /* GuildIconSizes */.GuildIconSizes.XLARGE;
  const items2 = [callback(importDefault(5818), obj1), , , , ];
  ...
  const items3 = [callback(require(4340) /* Text */.Text, obj3), ];
  ...
  items3[1] = callback(require(4340) /* Text */.Text, obj4);
  obj2[1] = items3;
  ...
  items2[2] = callback(tmp5(8510), obj5);
  ...
  obj7[1] = callback(require(4754) /* Button */.Button, obj8);
...
export default function GuildDirectoryNicknameUpsellModal(arg0) {
  ...
  return callback(_require(5822).Navigator, obj);
};
