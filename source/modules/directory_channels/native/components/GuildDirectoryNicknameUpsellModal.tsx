...
// Dependencies: [5, 32, 19, 17, 1862, 11892, 21, 4255, 5220, 712, 589, 5295, 5216, 4154, 5646, 4251, 1236, 8248, 1297, 4665, 11893, 11902, 5223, 5650, 5583, 2]
// Exports: default

// Module 11903 (GuildDirectoryNicknameUpsell)
...
import { GuildPrompts } from "GuildPrompts";
import jsxProd from "module_11902";
...
function GuildDirectoryNicknameUpsell(arg0) {
  ...
  obj1[2] = require(5646) /* GuildIconSizes */.GuildIconSizes.XLARGE;
  const items2 = [callback(importDefault(5646), obj1), , , , ];
  ...
  const items3 = [callback(require(4251) /* Text */.Text, obj3), ];
  ...
  items3[1] = callback(require(4251) /* Text */.Text, obj4);
  obj2[1] = items3;
  ...
  const tmp13 = importDefault(5646);
  ...
  items2[2] = callback(tmp5(8248), obj5);
  ...
  obj7[1] = callback(require(4665) /* Button */.Button, obj8);
...
export default function GuildDirectoryNicknameUpsellModal(arg0) {
  ...
  return callback(_require(5650).Navigator, obj);
};
