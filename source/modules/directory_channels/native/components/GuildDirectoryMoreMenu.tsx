...
// Dependencies: [19, 21, 11754, 11761, 4706, 1236, 11763, 1297, 8086, 9732, 4301, 8832, 8661, 7817, 8667, 712, 2]
// Exports: default

// Module 11760 (GuildDirectoryMoreMenu)
import "noop";
...
export default function GuildDirectoryMoreMenu(entry) {
  ...
  let isEntryAdmin;
  entry = entry.entry;
  const tmp2 = importDefault(11754)(entry);
  const items = [];
