...
// Dependencies: [19, 21, 11597, 11604, 4624, 1236, 11606, 1297, 7943, 9591, 4244, 8692, 8521, 7672, 8527, 712, 2]
// Exports: default

// Module 11603 (GuildDirectoryMoreMenu)
import "noop";
...
export default function GuildDirectoryMoreMenu(entry) {
  ...
  let isEntryAdmin;
  entry = entry.entry;
  const tmp2 = importDefault(11597)(entry);
  const items = [];
