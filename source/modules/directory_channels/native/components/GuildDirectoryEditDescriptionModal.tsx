...
// Dependencies: [5, 19, 17, 21, 4342, 5307, 11746, 11744, 5368, 4338, 1236, 11747, 5310, 5823, 2]
// Exports: default

// Module 11745 (GuildDirectoryEditDescription)
...
export default function GuildDirectoryEditDescriptionModal(arg0) {
  ...
  obj[1] = _require(5310).getHeaderCloseButton(importDefault(11744).close);
