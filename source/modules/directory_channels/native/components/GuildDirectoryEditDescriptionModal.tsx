...
// Dependencies: [5, 19, 17, 21, 4344, 5306, 11748, 11746, 5367, 4340, 1236, 11749, 5309, 5822, 2]
// Exports: default

// Module 11747 (GuildDirectoryEditDescription)
...
export default function GuildDirectoryEditDescriptionModal(arg0) {
  ...
  obj[1] = _require(5309).getHeaderCloseButton(importDefault(11746).close);
