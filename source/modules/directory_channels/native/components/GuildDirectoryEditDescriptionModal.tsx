...
// Dependencies: [5, 19, 17, 21, 4255, 5220, 11572, 11570, 5257, 4251, 1236, 11573, 5223, 5650, 2]
// Exports: default

// Module 11571 (GuildDirectoryEditDescription)
...
export default function GuildDirectoryEditDescriptionModal(arg0) {
  ...
  obj[1] = _require(5223).getHeaderCloseButton(importDefault(11570).close);
