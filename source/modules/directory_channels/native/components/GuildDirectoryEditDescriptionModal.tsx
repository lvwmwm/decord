...
// Dependencies: [5, 19, 17, 21, 4285, 5250, 11606, 11604, 5311, 4281, 1236, 11607, 5253, 5704, 2]
// Exports: default

// Module 11605 (GuildDirectoryEditDescription)
...
export default function GuildDirectoryEditDescriptionModal(arg0) {
  ...
  obj[1] = _require(5253).getHeaderCloseButton(importDefault(11604).close);
