...
// Dependencies: [32, 19, 17, 11617, 11615, 21, 4302, 712, 589, 5373, 5719, 11618, 8896, 1236, 4298, 9081, 1609, 4712, 1480, 5328, 11623, 11614, 2]
// Exports: default

// Module 11616 (GuildDirectoryCreateOrAddHeader)
...
function GuildDirectoryCreateOrAddHeader(arg0) {
  ...
  const tmp = callback3();
  let obj = require(8896) /* useSegmentedControlState */;
  ...
  items1[2] = callback(closure_5, { style: tmp.segmentedControl, children: callback(require(9081) /* SegmentedControl */.SegmentedControl, { state: segmentedControlState }) });
  obj[1] = items1;
...
function GuildDirectoryCreateOrAddFooter(handleFooterPress) {
  ...
  items1[1] = callback(require(4712) /* Button */.Button, obj2);
  obj[1] = items1;
