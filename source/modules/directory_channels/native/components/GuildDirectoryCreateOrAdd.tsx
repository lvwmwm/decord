...
// Dependencies: [32, 19, 17, 11602, 11600, 21, 4285, 712, 589, 5354, 5700, 11603, 8879, 1236, 4281, 9064, 1609, 4695, 1480, 5312, 11608, 11599, 2]
// Exports: default

// Module 11601 (GuildDirectoryCreateOrAddHeader)
...
function GuildDirectoryCreateOrAddHeader(arg0) {
  ...
  const tmp = callback3();
  let obj = require(8879) /* useSegmentedControlState */;
  ...
  items1[2] = callback(closure_5, { style: tmp.segmentedControl, children: callback(require(9064) /* SegmentedControl */.SegmentedControl, { state: segmentedControlState }) });
  obj[1] = items1;
