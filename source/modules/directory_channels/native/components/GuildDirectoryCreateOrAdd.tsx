...
// Dependencies: [32, 19, 17, 11744, 11742, 21, 4344, 712, 589, 5413, 5818, 11745, 9001, 1236, 4340, 9187, 1628, 4754, 1499, 5368, 11750, 11741, 2]
// Exports: default

// Module 11743 (GuildDirectoryCreateOrAddHeader)
...
function GuildDirectoryCreateOrAddHeader(arg0) {
  ...
  const tmp = callback3();
  let obj = require(9001) /* useSegmentedControlState */;
  ...
  items1[2] = callback(closure_5, { style: tmp.segmentedControl, children: callback(require(9187) /* SegmentedControl */.SegmentedControl, { state: segmentedControlState }) });
  obj[1] = items1;
...
function GuildDirectoryCreateOrAddFooter(handleFooterPress) {
  ...
  items1[1] = callback(require(4754) /* Button */.Button, obj2);
  obj[1] = items1;
