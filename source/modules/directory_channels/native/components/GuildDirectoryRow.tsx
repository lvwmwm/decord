...
const memoResult = importAllResult.memo(function GuildDirectoryRow(entry) {
  ...
  const items2 = [callback2(arg1(closure_2[20]).Text, { children: entry.name }), ];
  const obj6 = { style: tmp.memberInfo };
  let tmp18 = null;
  if (null != approximatePresenceCount) {
    ...
    items3[1] = callback2(arg1(closure_2[20]).Text, obj9);
    obj7.children = items3;
    tmp18 = callback3(closure_11, obj7);
  }
  const items4 = [tmp18, ];
  let tmp25 = null;
  if (null != approximateMemberCount) {
    ...
    items5[1] = callback2(arg1(closure_2[20]).Text, obj13);
    obj11.children = items5;
    tmp25 = callback3(closure_11, obj11);
  }
  items4[1] = tmp25;
  obj6.children = items4;
  items2[1] = callback3(View, obj6);
  ...
  items7[3] = callback2(arg1(closure_2[22]).Button, obj18);
