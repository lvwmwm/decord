...
// Dependencies: [19, 17, 1982, 676, 21, 4478, 712, 1628, 589, 11874, 12293, 1297, 1236, 4474, 8363, 11875, 12294, 9909, 12295, 2]
// Exports: default

// Module 12292 (GuildDirectoryEmpty)
...
export default function GuildDirectoryEmpty(guild) {
  ...
  if (canCreateOrAddGuildInDirectory) {
    ...
    tmp8Result = tmp8(tmp4(8363).FormCTA, obj5);
  }
  items2[3] = tmp8Result;
  const obj6 = {
