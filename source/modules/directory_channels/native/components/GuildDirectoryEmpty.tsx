...
// Dependencies: [19, 17, 1980, 676, 21, 4342, 712, 1628, 589, 11754, 12191, 1297, 1236, 4338, 8033, 11755, 12192, 9128, 12193, 2]
// Exports: default

// Module 12190 (GuildDirectoryEmpty)
import "set";
...
export default function GuildDirectoryEmpty(guild) {
  ...
  if (canCreateOrAddGuildInDirectory) {
    ...
    tmp8Result = tmp8(tmp4(8033).FormCTA, obj5);
  }
  items2[3] = tmp8Result;
  const obj6 = {
    style: tmp.ctaContainer,
    onPress() {
      return guild(9128).handleOpenInviteActionsheet(guild, channel.id, dependencyMap, outer1_6.HUB_EMPTY_STATE);
    },
    iconSource: null,
    title: null
  };
  obj6[2] = channel(12193);
  const intl4 = tmp4(1236).intl;
  obj6[3] = intl4.string(guild(1236).t.L4bwJ9);
  items2[4] = callback(guild(8033).FormCTA, obj6);
  obj[1] = items2;
