...
// Dependencies: [5, 19, 17, 21, 4255, 11576, 1411, 11577, 11564, 11565, 4251, 1236, 11573, 2]
// Exports: default

// Module 11575 (GuildDirectoryCreateOrAddDescription)
...
export default function GuildDirectoryCreateOrAddDescription(directoryChannelId) {
  ...
  items1[1] = callback(importDefault(11573), obj3);
  obj[2] = items1;
