...
// Dependencies: [5, 31, 27, 33, 4165, 10051, 1387, 10052, 10039, 10040, 4161, 1212, 10048, 2]
// Exports: default

// Module 10050 (GuildDirectoryCreateOrAddDescription)
...
export default function GuildDirectoryCreateOrAddDescription(directoryChannelId) {
  ...
  const items = [callback(directoryChannelId(4161).Text, obj1), ];
  ...
  items[1] = callback(directoryChannelId(4161).Text, obj2);
  obj.children = items;
  ...
  items1[1] = callback(importDefault(10048), obj3);
  obj.children = items1;
  obj.children = callback2(closure_5, obj);
  return callback(directoryChannelId(10040).GuildDirectoryAddModalScreen, obj);
};
