...
// Dependencies: [19, 17, 21, 4302, 712, 4730, 1236, 5719, 4298, 2]
// Exports: default

// Module 11627 (GuildDirectoryAddAlert)
import "noop";
...
export default function GuildDirectoryAddAlert(arg0) {
  ...
  const tmp2 = importDefault(4730);
  obj[2] = require(5719) /* GuildIconSizes */.GuildIconSizes.XLARGE;
