...
// Function ID: 11878
// Name: RowType
// Dependencies: [10212, 10211, 1236, 2]
// Exports: generateDirectoryRows

// Module 11877 (RowType)
...
export const generateDirectoryRows = function generateDirectoryRows(arg0, arr, currentCategoryId) {
  ...
  if (0 === arr.length) {
    ...
    const obj4 = set(10211);
    return set(10211).rankGuildEntries(arr).map((entry) => ({ type: constants.ENTRY, entry }));
  } else {
    const items = [];
    const rankByDateAddedResult = set(10211).rankByDateAdded(arr);
    const _Set = Set;
    ...
    const obj5 = set(10211);
    const result = set(10211).orderByTotalMemberCount(found);
