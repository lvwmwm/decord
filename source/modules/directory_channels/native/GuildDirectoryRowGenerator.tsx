...
// Function ID: 12123
// Name: RowType
// Dependencies: [11789, 11788, 1236, 2]
// Exports: generateDirectoryRows

// Module 12122 (RowType)
...
export const generateDirectoryRows = function generateDirectoryRows(arg0, arr, currentCategoryId) {
  ...
  if (0 === arr.length) {
    ...
    const obj4 = set(11788);
    return set(11788).rankGuildEntries(arr).map((entry) => ({ type: constants.ENTRY, entry }));
  } else {
    const items = [];
    const rankByDateAddedResult = set(11788).rankByDateAdded(arr);
    const _Set = Set;
    ...
    const obj5 = set(11788);
    const result = set(11788).orderByTotalMemberCount(found);
