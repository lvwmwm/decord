...
// Function ID: 11944
// Name: RowType
// Dependencies: [11595, 11594, 1236, 2]
// Exports: generateDirectoryRows

// Module 11943 (RowType)
...
export const generateDirectoryRows = function generateDirectoryRows(arg0, arr, currentCategoryId) {
  ...
  if (0 === arr.length) {
    ...
    const obj4 = set(11594);
    return set(11594).rankGuildEntries(arr).map((entry) => ({ type: constants.ENTRY, entry }));
  } else {
    const items = [];
    const rankByDateAddedResult = set(11594).rankByDateAdded(arr);
    const _Set = Set;
    ...
    const obj5 = set(11594);
    const result = set(11594).orderByTotalMemberCount(found);
