...
// Function ID: 12107
// Name: RowType
// Dependencies: [11752, 11751, 1236, 2]
// Exports: generateDirectoryRows

// Module 12106 (RowType)
...
export const generateDirectoryRows = function generateDirectoryRows(arg0, arr, currentCategoryId) {
  ...
  if (0 === arr.length) {
    ...
    const obj4 = set(11751);
    return set(11751).rankGuildEntries(arr).map((entry) => ({ type: constants.ENTRY, entry }));
  } else {
    const items = [];
    const rankByDateAddedResult = set(11751).rankByDateAdded(arr);
    const _Set = Set;
    ...
    const obj5 = set(11751);
    const result = set(11751).orderByTotalMemberCount(found);
