...
// Dependencies: [5, 6941, 653, 6969, 6958, 6939, 6968, 6975, 675, 491, 9487, 2]
// Exports: captureAdUserAction

// Module 9486 (emitClickEventWithCreative)
...
export const captureAdUserAction = function captureAdUserAction(type) {
  type = type.type;
  if (require(9487) /* AdUserActionType */.AdUserActionType.END_CONTENT_LOAD === type) {
    if (type.adCreativeType === require(6969) /* AdCreativeType */.AdCreativeType.QUEST) {
      const adCreativeId = type.adCreativeId;
      let obj = require(6958) /* assignBillingSessionId */;
      ...
      const adMetadataSealed = require(6939) /* _createForOfIteratorHelperLoose */.getAdMetadataSealed(type.sourceQuestContent, adCreativeId);
      let tmp15 = null;
      ...
      const adTrafficMetadataSealed = require(6939) /* _createForOfIteratorHelperLoose */.getAdTrafficMetadataSealed(type.sourceQuestContent, adCreativeId);
      let tmp19 = null;
      ...
      obj.content_name = require(6968) /* getQuestContentName */.getQuestContentName(type.surfaceId);
      ...
      const obj7 = require(6958) /* assignBillingSessionId */;
      obj2.content_name = require(6968) /* getQuestContentName */.getQuestContentName(type.surfaceId);
      ...
      const obj10 = require(6968) /* getQuestContentName */;
    }
  } else if (require(9487) /* AdUserActionType */.AdUserActionType.CLICK_INTERNAL === type) {
    !(function handleClickInternalAction(type) {
      return outer1_8(...arguments);
    })(type);
  } else if (require(9487) /* AdUserActionType */.AdUserActionType.CLICK_EXTERNAL_ADVERTISER_CTA === type) {
