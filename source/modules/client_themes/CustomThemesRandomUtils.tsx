...
// Module 3977 (items)
const items = ["Text", "height", "colors", "y", "isArray", "accessibilityRole", "T", "a", "Text", "LengthDelimited", "TypeError", "r", "isArray", "accessibilityRole"];
let closure_3 = [];
let closure_4 = [false, false, false, false];
