...
// Dependencies: [19, 1302, 4264, 1236, 1349, 4295, 4297, 647, 4376, 2]
// Exports: default

// Module 4294 (getGuildThemeName)
...
export default function useColorThemeBackground() {
  const tmp = stateFromStores(4297)();
  const _require = tmp;
  let items = [closure_4];
  ...
  const customBackgroundGradient = _require(4376).useCustomBackgroundGradient();
