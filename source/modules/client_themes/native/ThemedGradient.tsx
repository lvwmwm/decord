...
// Dependencies: [19, 17, 4067, 21, 4255, 4101, 4100, 4099, 1474, 4676, 4191, 712, 4103, 4066, 689, 1208, 647, 4105, 4190, 4069, 2]
// Exports: CustomThemedGradient, default, validateColors

// Module 4799 (getMixedGradientColor)
...
function GradientBase(angleCenter) {
  ...
  obj[5] = items;
  return tmp3(importDefault(4676), obj);
}
class Gradient {
  constructor(arg0) {
