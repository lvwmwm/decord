...
// Dependencies: [32, 19, 1302, 4267, 1346, 712, 689, 4296, 4297, 1349, 1363, 4298, 4383, 4380, 2]
...
// Module 4266 (getGradientColorByPercentage)
...
function getGradientColorByPercentage(type, END) {
  if (type.type === colors(1349).ClientThemeType.BACKGROUND_GRADIENT_PRESET) {
    ...
    if (1 === colors.length) {
      return tmp(4296).hexToRgb(colors[0]);
    } else {
...
function calculateGradientValueWithOpacity(customBackgroundGradient, END, theme) {
  ...
  if (tmp10 === obj.START) {
    ...
    const mixColorsResult = tmp(4296).mixColors(tmp35, tmp38);
