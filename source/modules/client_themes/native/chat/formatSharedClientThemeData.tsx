...
// Dependencies: [17, 7705, 1236, 2482, 2]
// Exports: formatSharedClientThemeData

// Module 8328 (formatSharedClientThemeData)
...
export const formatSharedClientThemeData = function formatSharedClientThemeData(message, ensureAvatarSourceResult, nick) {
  ...
  if (undefined !== sharedClientTheme) {
    ...
    obj[3] = str2;
    obj[4] = Image.resolveAssetSource(importDefault(7705)).uri;
    const intl = require(1236) /* getSystemLocale */.intl;
    obj[5] = intl.string(require(1236) /* getSystemLocale */.t.SKNnqq);
    const intl2 = require(1236) /* getSystemLocale */.intl;
    obj[6] = intl2.string(importDefault(2482).yl1iMm);
    const intl3 = require(1236) /* getSystemLocale */.intl;
    const _HermesInternal = HermesInternal;
    obj[7] = "" + intl3.format(importDefault(2482).fQPSEf, { username: "__USERNAME__" });
    return obj;
  }
};
