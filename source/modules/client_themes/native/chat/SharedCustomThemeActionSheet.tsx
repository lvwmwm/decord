...
// Dependencies: [32, 19, 17, 3953, 676, 1905, 21, 4303, 712, 698, 11355, 4149, 5397, 5396, 1236, 2482, 4299, 8698, 4714, 589, 3947, 6886, 5748, 1297, 4150, 2]
// Exports: default

// Module 11354 (PrimaryActionButton)
...
function PrimaryActionButton(onPressApply) {
  ...
  if (obj2.getPremiumTypeFromSubscription(stateFromStores) !== PremiumTypes.TIER_2) {
    ...
    tmp6 = callback4(tmp2(4714).Button, obj);
  }
  return tmp6;
}
