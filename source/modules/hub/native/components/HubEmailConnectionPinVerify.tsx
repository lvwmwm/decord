...
// Dependencies: [32, 5, 19, 17, 1910, 21, 4661, 4094, 11917, 11918, 9568, 12, 11910, 1236, 4273, 7302, 11905, 11919, 4734, 8657, 2]
// Exports: default
...
function presentResendToast(content) {
  ...
  obj = { key: "HUB_EMAIL_RESET", content, icon: importDefault(11917) };
  obj.open(obj);
}
