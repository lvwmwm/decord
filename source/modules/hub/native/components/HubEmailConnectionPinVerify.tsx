...
let closure_11 = arg1(dependencyMap[6]).createStyles({ container: { alignItems: "center" }, title: { "Null": null, "Null": null }, description: { value: 24, marginTop: "recent_games_enabled" }, label: { value: "isArrayBufferToString", marginTop: "sync" }, error: {} });
...
export default function HubEmailConnectionPinVerify(email) {
  ...
  const obj4 = { delete: 1404174337, dispatch: null, raw: null, style: tmp.label };
  ...
  let tmp9 = null != first;
  if (tmp9) {
    const obj6 = { hasMaxConnections: 1, isBoostOnlySubscription: "center", style: tmp.error, children: first.getAnyErrorMessage() };
