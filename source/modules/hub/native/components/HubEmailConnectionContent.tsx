...
// Dependencies: [5, 32, 19, 17, 1391, 12134, 676, 21, 4344, 712, 1499, 5408, 12147, 4243, 1236, 12142, 6068, 4340, 4312, 12148, 2007, 8510, 1297, 4754, 2]
// Exports: default

// Module 12146 (HubEmailConnectionContent)
...
export default function HubEmailConnectionContent(arg0) {
  ...
  const items1 = [callback2(ref, { style: tmp.header, children: callback2(require(6068) /* AccountAgeTier10LargeBadge */.StudyGroupsSpotIllustration, { scale: 0.75 }) }), callback2(require(4340) /* Text */.Text, { variant: "heading-xl/bold", color: "mobile-text-heading-primary", style: tmp.title, accessibilityRole: "header", children: formatToPlainStringResult }), , ];
  ...
  items1[2] = callback2(require(4340) /* Text */.Text, obj5);
  ...
  let obj3 = { style: tmp.header, children: callback2(require(6068) /* AccountAgeTier10LargeBadge */.StudyGroupsSpotIllustration, { scale: 0.75 }) };
  ...
  obj12[3] = tmp6[0];
  obj11[1] = callback2(require(4754) /* Button */.Button, obj12);
  items2[2] = callback2(ref, obj11);
  obj[2] = items2;
  obj9[0] = closure_13(tmp16, obj);
  return callback2(require(12142) /* HubEmailConnectionModal */.HubEmailConnectionScreen, obj9);
};
