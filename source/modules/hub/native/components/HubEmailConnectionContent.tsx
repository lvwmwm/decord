...
// Dependencies: [5, 32, 19, 17, 1372, 11958, 676, 21, 4255, 712, 1480, 5295, 11971, 4154, 1236, 11966, 5921, 4251, 4223, 11972, 1959, 8248, 1297, 4665, 2]
// Exports: default

// Module 11970 (HubEmailConnectionContent)
...
export default function HubEmailConnectionContent(arg0) {
  ...
  let obj3 = { style: tmp.header, children: callback2(require(5921) /* AccountAgeTier10LargeBadge */.StudyGroupsSpotIllustration, { scale: 0.75 }) };
  ...
  obj12[3] = tmp6[0];
  obj11[1] = callback2(require(4665) /* Button */.Button, obj12);
  items2[2] = callback2(ref, obj11);
  obj[2] = items2;
  obj9[0] = closure_13(tmp16, obj);
  return callback2(require(11966) /* HubEmailConnectionModal */.HubEmailConnectionScreen, obj9);
};
