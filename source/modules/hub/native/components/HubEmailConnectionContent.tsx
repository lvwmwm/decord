...
export default function HubEmailConnectionContent(arg0) {
  ...
  let obj3 = { style: tmp.header, children: callback2(require(6070) /* AccountAgeTier10LargeBadge */.StudyGroupsSpotIllustration, { scale: 0.75 }) };
  ...
  obj12[3] = tmp6[0];
  obj11[1] = callback2(require(4755) /* Button */.Button, obj12);
