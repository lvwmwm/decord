...
// Dependencies: [31, 10035, 33, 11695, 1212, 11503, 13045, 4099, 11699, 1935, 2]
// Exports: default

// Module 15095 (HubSidebarProgressOverview)
import "result";
...
export default function HubSidebarProgressOverview(guild) {
  ...
  const nextHubProgressStep = guild(11695).getNextHubProgressStep(hubProgressBarCompletedSteps);
  if (null == nextHubProgressStep) {
    return null;
  } else {
    const size = hubProgressBarCompletedSteps.size;
    const hubProgressTitleForStep = guild(11695).getHubProgressTitleForStep(nextHubProgressStep);
    if (size < closure_4) {
    ...
    const _Math = Math;
    const bound = Math.max(guild(11503).MIN_PROGRESS_PERCENT, 100 * size / closure_4);
    obj = {
      onPress() {
    ...
    return jsx(guild(13045).GuildProgressOverviewView, {
      onPress() {
          let obj = outer1_1(outer1_2[7]);
          obj = { guild, analyticsSource: "Channels Sidebar" };
          obj.openLazy(guild(outer1_2[9])(outer1_2[8], outer1_2.paths), outer1_3, obj);
