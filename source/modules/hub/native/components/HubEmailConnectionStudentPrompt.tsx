...
// Dependencies: [31, 27, 11796, 653, 33, 4165, 5087, 689, 1456, 11804, 1273, 1212, 5191, 11806, 675, 11807, 2]
// Exports: default

// Module 11805 (HubEmailConnectionStudentPrompt)
import "result";
...
export default function HubEmailConnectionStudentPrompt(onClose) {
  ...
  const obj3 = { source: invite(11806) };
  obj2.leading = callback(closure_4, obj3);
  obj2.trailing = invite(5191).Arrow;
  ...
  items[1] = callback(invite(5191), obj2);
  const obj4 = { DEPRECATED_style: tmp.row };
  const obj5 = {};
  const tmp2 = invite(5191);
  obj5.source = invite(11807);
  obj4.leading = callback(closure_4, obj5);
  obj4.trailing = invite(5191).Arrow;
  const intl4 = onClose(1212).intl;
  obj4.label = intl4.string(onClose(1212).t.GLG9n4);
  obj4.onPress = onClose;
  items[2] = callback(invite(5191), obj4);
  obj.children = items;
  obj.children = callback2(closure_3, obj);
  return callback(onClose(11804).HubEmailConnectionScreen, obj);
};
