...
// Dependencies: [5, 32, 19, 17, 11931, 676, 21, 4255, 712, 1480, 5281, 11944, 4154, 11939, 1297, 1236, 4251, 9181, 4666, 2]
// Exports: default

// Module 11948 (HubEmailConnectionSubmitSchool)
import ME from "ME";
...
export default function HubEmailConnectionSubmitSchool(arg0) {
  ...
  items1[2] = callback2(importDefault(9181), obj4);
  obj1[1] = items1;
  ...
  return callback2(require(11939) /* HubEmailConnectionModal */.HubEmailConnectionScreen, obj5);
};
