...
// Dependencies: [5, 32, 19, 17, 11835, 676, 21, 4193, 712, 1480, 5219, 11848, 4092, 11843, 1297, 1236, 4189, 9004, 4604, 2]
// Exports: default
...
export default function HubEmailConnectionSubmitSchool(arg0) {
  ...
  items1[2] = callback2(importDefault(9004), obj4);
  obj1[1] = items1;
  ...
  return callback2(require(11843) /* HubEmailConnectionModal */.HubEmailConnectionScreen, obj5);
};
