...
// Function ID: 12159
// Name: EmptyState
// Dependencies: [5, 32, 19, 17, 12136, 21, 4342, 712, 12159, 4338, 1236, 1499, 5269, 1628, 12149, 4241, 5310, 6034, 1297, 12154, 2]
// Exports: default

// Module 12158 (EmptyState)
...
function EmptyState() {
  ...
  obj = { style: tmp.emptyStateImage, source: importDefault(12159) };
