...
// Function ID: 11981
// Name: EmptyState
// Dependencies: [5, 32, 19, 17, 11958, 21, 4255, 712, 11981, 4251, 1236, 1480, 5182, 1581, 11971, 4154, 5223, 5885, 1297, 11976, 2]
// Exports: default

// Module 11980 (EmptyState)
...
function EmptyState() {
  ...
  obj = { style: tmp.emptyStateImage, source: importDefault(11981) };
...
export default function HubEmailConnectionGuildSelectSearch(arg0) {
  ...
  obj[1] = callback2(importDefault(5885), obj1);
  const items = [callback2(require(5223) /* HeaderBackImage */.FauxHeader, obj), ];
  obj2 = {
  ...
  const tmp8Result = importDefault(5885);
