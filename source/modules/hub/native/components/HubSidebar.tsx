...
// Function ID: 15731
// Name: HubItem
// Dependencies: [19, 17, 1983, 1982, 676, 10139, 21, 4446, 712, 11884, 1297, 589, 15731, 15732, 15126, 1236, 4457, 12224, 11811, 4383, 9847, 2]
// Exports: default

// Module 15730 (HubItem)
...
function HubItem(arg0) {
  ...
  const tmp = callback2();
  obj[6] = callback(tmp5(11884).BaseChannelName, { name: label, mode: DEFAULT });
  obj[7] = callback(tmp5(11884).BaseChannelIcon, { mode: DEFAULT, IconComponent });
  let tmp6Result = null;
  if (null != unreadCount) {
    obj = { value: null };
    obj[0] = unreadCount;
...
export default function HubSidebar(guild) {
  ...
  if (null != stateFromStores) {
    ...
    obj3[0] = tmp(4383).UserPlusIcon;
    const intl3 = tmp(1236).intl;
    obj3[1] = intl3.string(tmp(1236).t.MJQOuJ);
    obj3[2] = function handleItemClick() {
      const result = guild(9847).handleOpenInviteActionsheet(guild, stateFromStores.id, dependencyMap, closure_1_6.GUILD_HEADER);
    };
