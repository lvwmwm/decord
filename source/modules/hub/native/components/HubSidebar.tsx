...
// Function ID: 15351
// Name: HubItem
// Dependencies: [19, 17, 1980, 1979, 676, 9800, 21, 4303, 712, 11756, 1297, 589, 15351, 15352, 13871, 1236, 4311, 12111, 11683, 4241, 9071, 2]
// Exports: default

// Module 15350 (HubItem)
import "UserPlusIcon";
...
function HubItem(arg0) {
  ...
  const ChannelModes = require(11756) /* BaseChannelSubtitle */.ChannelModes;
  if (active) {
  ...
  obj[6] = callback(tmp5(11756).BaseChannelName, { name: label, mode: DEFAULT });
  obj[7] = callback(tmp5(11756).BaseChannelIcon, { mode: DEFAULT, IconComponent });
  let tmp6Result = null;
  if (null != unreadCount) {
    obj = { value: null };
    obj[0] = unreadCount;
  ...
  obj[8] = tmp6Result;
  return callback(importDefault(11756), obj);
}
...
export default function HubSidebar(guild) {
  ...
  if (null != stateFromStores) {
    ...
    obj3[0] = tmp(4241).UserPlusIcon;
    const intl3 = tmp(1236).intl;
    obj3[1] = intl3.string(tmp(1236).t.MJQOuJ);
    obj3[2] = function handleItemClick() {
      const result = guild(9071).handleOpenInviteActionsheet(guild, stateFromStores.id, dependencyMap, outer1_6.GUILD_HEADER);
    };
