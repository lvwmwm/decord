...
// Function ID: 15801
// Name: HubItem
// Dependencies: [19, 17, 1982, 1981, 676, 10201, 21, 4478, 712, 11948, 1297, 589, 15801, 15802, 15192, 1236, 4489, 12291, 11875, 4415, 9909, 2]
// Exports: default

// Module 15800 (HubItem)
...
export default function HubSidebar(guild) {
  ...
  if (null != stateFromStores) {
    ...
    obj2[0] = tmp(12291).PlusMediumIcon;
