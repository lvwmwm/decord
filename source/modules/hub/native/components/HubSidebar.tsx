...
// Function ID: 15337
// Name: HubItem
// Dependencies: [19, 17, 1961, 1960, 676, 9795, 21, 4303, 712, 11753, 1297, 589, 15337, 15338, 13864, 1236, 4311, 12108, 11680, 4241, 9065, 2]
// Exports: default

// Module 15336 (HubItem)
import "UserPlusIcon";
...
function HubItem(arg0) {
  ...
  obj[6] = callback(tmp5(11753).BaseChannelName, { name: label, mode: DEFAULT });
  obj[7] = callback(tmp5(11753).BaseChannelIcon, { mode: DEFAULT, IconComponent });
  let tmp6Result = null;
  if (null != unreadCount) {
    obj = { value: null };
    obj[0] = unreadCount;
  ...
  obj[8] = tmp6Result;
  return callback(importDefault(11753), obj);
}
...
export default function HubSidebar(guild) {
  ...
  if (null != stateFromStores) {
    ...
    obj3[2] = function handleItemClick() {
      const result = guild(9065).handleOpenInviteActionsheet(guild, stateFromStores.id, dependencyMap, outer1_6.GUILD_HEADER);
    };
