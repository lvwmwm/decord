...
// Function ID: 15713
// Name: HubItem
// Dependencies: [19, 17, 1982, 1981, 676, 10121, 21, 4445, 712, 11865, 1297, 589, 15713, 15714, 14170, 1236, 4456, 12205, 11792, 4382, 9829, 2]
// Exports: default

// Module 15712 (HubItem)
...
function HubItem(arg0) {
  ...
  const tmp = callback2();
  obj[6] = callback(tmp5(11865).BaseChannelName, { name: label, mode: DEFAULT });
  obj[7] = callback(tmp5(11865).BaseChannelIcon, { mode: DEFAULT, IconComponent });
  let tmp6Result = null;
  if (null != unreadCount) {
    obj = { value: null };
    obj[0] = unreadCount;
...
export default function HubSidebar(guild) {
  ...
  if (null != stateFromStores) {
    ...
    obj3[0] = tmp(4382).UserPlusIcon;
    const intl3 = tmp(1236).intl;
    obj3[1] = intl3.string(tmp(1236).t.MJQOuJ);
    obj3[2] = function handleItemClick() {
      const result = guild(9829).handleOpenInviteActionsheet(guild, stateFromStores.id, dependencyMap, closure_1_6.GUILD_HEADER);
    };
