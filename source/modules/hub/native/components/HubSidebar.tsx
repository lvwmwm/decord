...
// Function ID: 15649
// Name: HubItem
// Dependencies: [19, 17, 1982, 1981, 676, 10017, 21, 4444, 712, 12021, 1297, 589, 15649, 15650, 14143, 1236, 4455, 12381, 11948, 4381, 9280, 2]
// Exports: default

// Module 15648 (HubItem)
...
function HubItem(arg0) {
  ...
  const tmp = callback2();
  obj[6] = callback(tmp5(12021).BaseChannelName, { name: label, mode: DEFAULT });
  obj[7] = callback(tmp5(12021).BaseChannelIcon, { mode: DEFAULT, IconComponent });
  let tmp6Result = null;
  if (null != unreadCount) {
    obj = { value: null };
    obj[0] = unreadCount;
...
export default function HubSidebar(guild) {
  ...
  if (null != stateFromStores) {
    ...
    obj3[0] = tmp(4381).UserPlusIcon;
    const intl3 = tmp(1236).intl;
    obj3[1] = intl3.string(tmp(1236).t.MJQOuJ);
    obj3[2] = function handleItemClick() {
      const result = guild(9280).handleOpenInviteActionsheet(guild, stateFromStores.id, dependencyMap, closure_1_6.GUILD_HEADER);
    };
