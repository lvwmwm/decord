...
// Function ID: 15570
// Name: HubItem
// Dependencies: [19, 17, 1982, 1981, 676, 9950, 21, 4380, 712, 11948, 1297, 589, 15570, 15571, 14070, 1236, 4391, 12309, 11875, 4317, 9212, 2]
// Exports: default

// Module 15569 (HubItem)
...
export default function HubSidebar(guild) {
  ...
  if (null != stateFromStores) {
    ...
    obj3[0] = tmp(4317).UserPlusIcon;
    const intl3 = tmp(1236).intl;
    obj3[1] = intl3.string(tmp(1236).t.MJQOuJ);
    obj3[2] = function handleItemClick() {
      const result = guild(9212).handleOpenInviteActionsheet(guild, stateFromStores.id, dependencyMap, closure_1_6.GUILD_HEADER);
    };
