...
// Function ID: 15232
// Name: HubItem
// Dependencies: [19, 17, 1961, 1960, 676, 9712, 21, 4285, 712, 11671, 1297, 589, 15232, 15233, 13778, 1236, 4293, 12026, 11598, 4223, 8988, 2]
// Exports: default

// Module 15231 (HubItem)
import "UserPlusIcon";
...
function HubItem(arg0) {
  ...
  const ChannelModes = require(11671) /* BaseChannelSubtitle */.ChannelModes;
  if (active) {
  ...
  obj[6] = callback(tmp5(11671).BaseChannelName, { name: label, mode: DEFAULT });
  obj[7] = callback(tmp5(11671).BaseChannelIcon, { mode: DEFAULT, IconComponent });
  let tmp6Result = null;
  if (null != unreadCount) {
    obj = { value: null };
    obj[0] = unreadCount;
  ...
  obj[8] = tmp6Result;
  return callback(importDefault(11671), obj);
}
...
export default function HubSidebar(guild) {
  ...
  if (null != stateFromStores) {
    ...
    obj3[0] = tmp(4223).UserPlusIcon;
    const intl3 = tmp(1236).intl;
    obj3[1] = intl3.string(tmp(1236).t.MJQOuJ);
    obj3[2] = function handleItemClick() {
      const result = guild(8988).handleOpenInviteActionsheet(guild, stateFromStores.id, dependencyMap, outer1_6.GUILD_HEADER);
    };
