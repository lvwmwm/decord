...
// Dependencies: [19, 17, 676, 21, 4189, 712, 1480, 6752, 1236, 11837, 1297, 4185, 4600, 2]
// Exports: default

// Module 11836 (HubEmailConnectionWaitlist)
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  obj = { source: navigation(11837), style: tmp.header };
  ...
  items1[2] = callback(onClose(4185).Text, obj2);
  ...
  obj4[2] = onClose;
  obj3[1] = callback(onClose(4600).Button, obj4);
