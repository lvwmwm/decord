...
// Dependencies: [32, 19, 17, 1372, 1874, 4273, 21, 4255, 712, 10568, 4211, 4251, 1236, 589, 1297, 10575, 3959, 15929, 10585, 15930, 9652, 2]

// Module 15928 (ExternalPipViewVideoUnavailable)
...
const memoResult = importAllResult.memo(function ExternalPipViewVideo(onLayout) {
  ...
  const tmp2 = importDefault(15930)();
