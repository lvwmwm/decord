...
// Dependencies: [1963, 676, 5231, 709, 530, 2]
// Exports: updateGuildSelfMember

// Module 5246 (updateGuildSelfMember)
...
export const updateGuildSelfMember = function updateGuildSelfMember(outer1_0, arg1) {
  ...
  if (fullServerPreview.isFullServerPreview(outer1_0)) {
    ...
    obj[0] = arg1;
    const result = require(5231) /* updateImpersonating */.updateImpersonatedData(outer1_0, obj);
  } else {
