...
// Function ID: 16682
// Name: useTapGestures
// Dependencies: [19, 11806, 5620, 4187, 4416, 2]
// Exports: default

// Module 16681 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = React.useContext(isFocusedVideoZoomed(11806)).isFocusedVideoZoomed;
  ...
  return React.useMemo(() => {
    ...
    const Gesture = onSingleTap(5620).Gesture;
    const Gesture2 = onSingleTap(5620).Gesture;
    ...
    obj = { runOnJS: tmp(4187).runOnJS, handleEvent };
    fn.__closure = obj;
    ...
    const Gesture3 = tmp(5620).Gesture;
    ...
    fn2.__closure = { runOnJS: onSingleTap(4187).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    obj1 = { runOnJS: onSingleTap(4187).runOnJS, handleEvent };
    const Gesture4 = tmp(5620).Gesture;
    ...
    fn3.__closure = { runOnJS: onSingleTap(4187).runOnJS, triggerHapticFeedback: onSingleTap(4416).triggerHapticFeedback, HapticFeedbackTypes: onSingleTap(4416).HapticFeedbackTypes, handleEvent };
