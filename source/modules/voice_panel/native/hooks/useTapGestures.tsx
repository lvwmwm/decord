...
// Function ID: 16482
// Name: useTapGestures
// Dependencies: [19, 11840, 5533, 4120, 4348, 2]
// Exports: default

// Module 16481 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = React.useContext(isFocusedVideoZoomed(11840)).isFocusedVideoZoomed;
  ...
  return React.useMemo(() => {
    ...
    const Gesture = onSingleTap(5533).Gesture;
    const Gesture2 = onSingleTap(5533).Gesture;
    ...
    obj = { runOnJS: tmp(4120).runOnJS, handleEvent };
    fn.__closure = obj;
    ...
    const Gesture3 = tmp(5533).Gesture;
    ...
    fn2.__closure = { runOnJS: onSingleTap(4120).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    obj1 = { runOnJS: onSingleTap(4120).runOnJS, handleEvent };
    const Gesture4 = tmp(5533).Gesture;
    ...
    fn3.__closure = { runOnJS: onSingleTap(4120).runOnJS, triggerHapticFeedback: onSingleTap(4348).triggerHapticFeedback, HapticFeedbackTypes: onSingleTap(4348).HapticFeedbackTypes, handleEvent };
