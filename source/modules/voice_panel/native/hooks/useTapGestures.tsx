...
// Function ID: 16283
// Name: useTapGestures
// Dependencies: [19, 11705, 5466, 4083, 4313, 2]
// Exports: default

// Module 16282 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = React.useContext(isFocusedVideoZoomed(11705)).isFocusedVideoZoomed;
  ...
  return React.useMemo(() => {
    ...
    const Gesture = onSingleTap(5466).Gesture;
    const Gesture2 = onSingleTap(5466).Gesture;
    ...
    obj = { runOnJS: tmp(4083).runOnJS, handleEvent };
    fn.__closure = obj;
    ...
    const Gesture3 = tmp(5466).Gesture;
    ...
    fn3.__closure = { runOnJS: onSingleTap(4083).runOnJS, triggerHapticFeedback: onSingleTap(4313).triggerHapticFeedback, HapticFeedbackTypes: onSingleTap(4313).HapticFeedbackTypes, handleEvent };
