...
// Function ID: 16102
// Name: useTapGestures
// Dependencies: [19, 11563, 5407, 4145, 4254, 2]
// Exports: default

// Module 16101 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = React.useContext(isFocusedVideoZoomed(11563)).isFocusedVideoZoomed;
  ...
  return React.useMemo(() => {
    ...
    const Gesture = onSingleTap(5407).Gesture;
    const Gesture2 = onSingleTap(5407).Gesture;
    ...
    obj = { runOnJS: tmp(4145).runOnJS, handleEvent };
    fn.__closure = obj;
    ...
    const Gesture3 = tmp(5407).Gesture;
    ...
    fn2.__closure = { runOnJS: onSingleTap(4145).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    const obj1 = { runOnJS: onSingleTap(4145).runOnJS, handleEvent };
    const Gesture4 = tmp(5407).Gesture;
    ...
    fn3.__closure = { runOnJS: onSingleTap(4145).runOnJS, triggerHapticFeedback: onSingleTap(4254).triggerHapticFeedback, HapticFeedbackTypes: onSingleTap(4254).HapticFeedbackTypes, handleEvent };
