...
// Function ID: 16565
// Name: useTapGestures
// Dependencies: [19, 11913, 5599, 4184, 4412, 2]
// Exports: default

// Module 16564 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = React.useContext(isFocusedVideoZoomed(11913)).isFocusedVideoZoomed;
  ...
  return React.useMemo(() => {
    ...
    const Gesture = onSingleTap(5599).Gesture;
    const Gesture2 = onSingleTap(5599).Gesture;
    ...
    obj = { runOnJS: tmp(4184).runOnJS, handleEvent };
    fn.__closure = obj;
    ...
    const Gesture3 = tmp(5599).Gesture;
    ...
    fn2.__closure = { runOnJS: onSingleTap(4184).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    obj1 = { runOnJS: onSingleTap(4184).runOnJS, handleEvent };
    const Gesture4 = tmp(5599).Gesture;
    ...
    fn3.__closure = { runOnJS: onSingleTap(4184).runOnJS, triggerHapticFeedback: onSingleTap(4412).triggerHapticFeedback, HapticFeedbackTypes: onSingleTap(4412).HapticFeedbackTypes, handleEvent };
