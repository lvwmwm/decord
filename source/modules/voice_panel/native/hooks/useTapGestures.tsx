...
// Function ID: 16294
// Name: useTapGestures
// Dependencies: [19, 11703, 5467, 4083, 4311, 2]
// Exports: default

// Module 16293 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = React.useContext(isFocusedVideoZoomed(11703)).isFocusedVideoZoomed;
  ...
  return React.useMemo(() => {
    ...
    fn3.__closure = { runOnJS: onSingleTap(4083).runOnJS, triggerHapticFeedback: onSingleTap(4311).triggerHapticFeedback, HapticFeedbackTypes: onSingleTap(4311).HapticFeedbackTypes, handleEvent };
