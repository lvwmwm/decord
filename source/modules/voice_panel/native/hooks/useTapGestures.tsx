...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = React.useContext(isFocusedVideoZoomed(11557)).isFocusedVideoZoomed;
  ...
  return React.useMemo(() => {
    ...
    const Gesture = onSingleTap(5368).Gesture;
    const Gesture2 = onSingleTap(5368).Gesture;
    ...
    obj = { runOnJS: tmp(4146).runOnJS, handleEvent };
    fn.__closure = obj;
    ...
    const Gesture3 = tmp(5368).Gesture;
    ...
    fn2.__closure = { runOnJS: onSingleTap(4146).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    const obj1 = { runOnJS: onSingleTap(4146).runOnJS, handleEvent };
    const Gesture4 = tmp(5368).Gesture;
    ...
    fn3.__closure = { runOnJS: onSingleTap(4146).runOnJS, triggerHapticFeedback: onSingleTap(4254).triggerHapticFeedback, HapticFeedbackTypes: onSingleTap(4254).HapticFeedbackTypes, handleEvent };
