...
// Function ID: 16128
// Name: useTapGestures
// Dependencies: [19, 11578, 5426, 4162, 4271, 2]
// Exports: default

// Module 16127 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = React.useContext(isFocusedVideoZoomed(11578)).isFocusedVideoZoomed;
  ...
  return React.useMemo(() => {
    ...
    const Gesture = onSingleTap(5426).Gesture;
    const Gesture2 = onSingleTap(5426).Gesture;
    ...
    obj = { runOnJS: tmp(4162).runOnJS, handleEvent };
    fn.__closure = obj;
    ...
    const Gesture3 = tmp(5426).Gesture;
    ...
    fn2.__closure = { runOnJS: onSingleTap(4162).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    const obj1 = { runOnJS: onSingleTap(4162).runOnJS, handleEvent };
    const Gesture4 = tmp(5426).Gesture;
    ...
    fn3.__closure = { runOnJS: onSingleTap(4162).runOnJS, triggerHapticFeedback: onSingleTap(4271).triggerHapticFeedback, HapticFeedbackTypes: onSingleTap(4271).HapticFeedbackTypes, handleEvent };
