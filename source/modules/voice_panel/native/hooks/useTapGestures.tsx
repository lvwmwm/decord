...
// Function ID: 16062
// Name: useTapGestures
// Dependencies: [19, 11529, 5353, 4116, 4224, 2]
// Exports: default

// Module 16061 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = React.useContext(isFocusedVideoZoomed(11529)).isFocusedVideoZoomed;
  ...
  return React.useMemo(() => {
    ...
    const Gesture = onSingleTap(5353).Gesture;
    const Gesture2 = onSingleTap(5353).Gesture;
    ...
    const Gesture3 = tmp(5353).Gesture;
    ...
    const Gesture4 = tmp(5353).Gesture;
