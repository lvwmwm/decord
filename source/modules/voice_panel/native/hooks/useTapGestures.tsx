...
// Function ID: 16649
// Name: useTapGestures
// Dependencies: [19, 11775, 5617, 4186, 4414, 2]
// Exports: default

// Module 16648 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = React.useContext(isFocusedVideoZoomed(11775)).isFocusedVideoZoomed;
  ...
  return React.useMemo(() => {
    ...
    const Gesture = onSingleTap(5617).Gesture;
    const Gesture2 = onSingleTap(5617).Gesture;
    ...
    obj = { runOnJS: tmp(4186).runOnJS, handleEvent };
    fn.__closure = obj;
    ...
    const Gesture3 = tmp(5617).Gesture;
    ...
    fn2.__closure = { runOnJS: onSingleTap(4186).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    obj1 = { runOnJS: onSingleTap(4186).runOnJS, handleEvent };
    const Gesture4 = tmp(5617).Gesture;
    ...
    fn3.__closure = { runOnJS: onSingleTap(4186).runOnJS, triggerHapticFeedback: onSingleTap(4414).triggerHapticFeedback, HapticFeedbackTypes: onSingleTap(4414).HapticFeedbackTypes, handleEvent };
