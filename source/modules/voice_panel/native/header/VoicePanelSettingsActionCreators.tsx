...
// Dependencies: [4270, 16101, 1988, 2]
// Exports: closeVoicePanelSettingsActionSheet, openVoicePanelSettingsActionSheet

// Module 16100 (VOICE_PANEL_SETTINGS_ACTION_SHEET_KEY)
...
export const closeVoicePanelSettingsActionSheet = function closeVoicePanelSettingsActionSheet() {
  importDefault(4270).hideActionSheet(VoicePanelSettingsActionSheet);
};
export const openVoicePanelSettingsActionSheet = function openVoicePanelSettingsActionSheet(guildId, channelId) {
  let obj = importDefault(4270);
  obj = { guildId, channelId };
  obj.openLazy(require(1988) /* asyncRequireImpl */(16101, dependencyMap.paths), VoicePanelSettingsActionSheet, obj);
};
