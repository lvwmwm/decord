...
// Dependencies: [31, 653, 33, 4130, 689, 1207, 15812, 5517, 15717, 4629, 1212, 2]
// Exports: default

// Module 15811 (VoicePanelHeaderChatButton)
...
export default function VoicePanelHeaderChatButton(channelId) {
  ...
  const tmp3 = importDefault(15812)(channelId.channelId);
  let obj = {};
  obj = {};
  ...
  const items = [callback(importDefault(15717), obj), ];
  let tmp8 = null != tmp3;
  if (tmp8) {
    ...
    obj2.style = items1;
    obj1.children = callback(importDefault(5517), obj2);
    tmp8 = callback(importDefault(5517), obj1);
