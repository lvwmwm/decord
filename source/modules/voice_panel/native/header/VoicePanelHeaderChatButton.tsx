...
// Dependencies: [19, 676, 21, 4444, 712, 1231, 16558, 5953, 16464, 4968, 1236, 2]
// Exports: default

// Module 16557 (VoicePanelHeaderChatButton)
...
import useChatBadgeDefault from "useChatBadge" /* 16558 */;
...
export default function VoicePanelHeaderChatButton(channelId) {
  ...
  obj[2] = callback;
  const children = [callback(_modDef16464, obj), ];
  ...
  if (tmp8Result) {
    ...
    obj1[0] = items1;
    obj[1] = tmp8(tmp3(5953), obj1);
    tmp8Result = tmp8(tmp3(5953), obj);
    const tmp3Result = tmp3(5953);
  }
