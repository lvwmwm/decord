...
// Function ID: 16294
// Name: getConsoleInfo
// Dependencies: [19, 676, 21, 4342, 712, 12302, 1236, 10866, 1370, 5842, 1297, 2]
// Exports: default

// Module 16293 (getConsoleInfo)
...
function getConsoleInfo(type) {
  ...
  if (PlatformTypes.XBOX === type) {
    ...
    obj[0] = importDefault(12302)(type.type);
...
export default function VoicePanelConsoleFacepile() {
  ...
  const require = tmp;
  const tmp2 = importDefault(10866)();
  importDefault = tmp2;
  let items = [tmp2];
  const items1 = [tmp];
  items = React.useMemo(() => {
