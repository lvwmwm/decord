...
// Function ID: 16201
// Name: getConsoleInfo
// Dependencies: [19, 676, 21, 4303, 712, 12215, 1236, 10876, 1351, 5781, 1297, 2]
// Exports: default

// Module 16200 (getConsoleInfo)
...
function getConsoleInfo(type) {
  ...
  if (PlatformTypes.XBOX === type) {
    ...
    obj[0] = importDefault(12215)(type.type);
...
export default function VoicePanelConsoleFacepile() {
  ...
  const require = tmp;
  const tmp2 = importDefault(10876)();
  importDefault = tmp2;
  let items = [tmp2];
  const items1 = [tmp];
  items = React.useMemo(() => {
