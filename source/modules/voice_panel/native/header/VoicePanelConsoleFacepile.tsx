...
// Function ID: 16117
// Name: getConsoleInfo
// Dependencies: [19, 676, 21, 4302, 712, 12146, 1236, 10809, 1351, 5721, 1297, 2]
// Exports: default

// Module 16116 (getConsoleInfo)
...
function getConsoleInfo(type) {
  ...
  if (PlatformTypes.XBOX === type) {
    ...
    obj[0] = importDefault(12146)(type.type);
...
export default function VoicePanelConsoleFacepile() {
  ...
  const require = tmp;
  const tmp2 = importDefault(10809)();
  importDefault = tmp2;
  let items = [tmp2];
  const items1 = [tmp];
  items = React.useMemo(() => {
