...
// Function ID: 16217
// Name: getConsoleInfo
// Dependencies: [19, 676, 21, 4303, 712, 12218, 1236, 10881, 1370, 5781, 1297, 2]
// Exports: default

// Module 16216 (getConsoleInfo)
...
function getConsoleInfo(type) {
  ...
  if (PlatformTypes.XBOX === type) {
    ...
    obj[0] = importDefault(12218)(type.type);
...
export default function VoicePanelConsoleFacepile() {
  ...
  const require = tmp;
  const tmp2 = importDefault(10881)();
  importDefault = tmp2;
  let items = [tmp2];
  const items1 = [tmp];
  items = React.useMemo(() => {
