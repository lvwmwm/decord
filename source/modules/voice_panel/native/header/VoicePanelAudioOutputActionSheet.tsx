...
// Dependencies: [19, 17, 4358, 9198, 1391, 4359, 9220, 676, 21, 4344, 4312, 647, 9222, 9223, 1236, 8026, 8025, 5419, 9194, 10934, 10826, 12280, 4166, 1377, 12281, 5436, 5435, 5820, 2]

// Module 9221 (VoicePanelAudioPhoneOutputSection)
...
const memoResult = importAllResult.memo(function VoicePanelAudioOutputActionSheet(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    obj2[0] = items1;
    obj1[0] = closure_12(importDefault(5820), obj2);
