...
// Function ID: 121982
// Name: VoicePanel
// Dependencies: [31, 1348, 4377, 33, 566, 15843, 15884, 3778, 4511, 2]

// Module 15842 (VoicePanel)
...
function VoicePanel(arg0) {
  ...
  return jsx(importDefault(15843), {});
}
...
const memoResult = importAllResult.memo(function VoicePanelContainer() {
  const tmp = callback((channels) => Array.from(channels.channels), require(3778) /* isIterable */.shallow);
  return jsx(require(4511) /* _createForOfIteratorHelperLoose */.TransitionGroup, { items: callback((channels) => Array.from(channels.channels), require(3778) /* isIterable */.shallow), getItemKey: getChannelKey, renderItem: renderVoicePanel });
});
