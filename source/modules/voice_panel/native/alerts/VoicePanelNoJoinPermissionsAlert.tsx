...
// Dependencies: [19, 21, 4537, 4537, 16031, 1236, 2]
// Exports: default
...
export default function VoicePanelNoJoinPermissionsAlert() {
  let obj = require(4537) /* getAlertModalItemKey */;
  obj = { header: null, title: null, content: null, actions: null };
  obj[0] = jsx(importDefault(16031), {});
  ...
  obj[3] = jsx(require(4537) /* getAlertModalItemKey */.AlertActionButton, { variant: "secondary", text: null, onPress: null });
  return jsx(require(4537) /* getAlertModalItemKey */.AlertModal, { variant: "secondary", text: null, onPress: null });
};
