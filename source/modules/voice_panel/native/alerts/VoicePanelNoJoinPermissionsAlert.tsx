...
// Dependencies: [19, 21, 4710, 4710, 16351, 1236, 2]
// Exports: default

// Module 16350 (VoicePanelNoJoinPermissionsAlert)
import "noop";
...
export default function VoicePanelNoJoinPermissionsAlert() {
  let obj = require(4710) /* getAlertModalItemKey */;
  obj = { header: null, title: null, content: null, actions: null };
  obj[0] = jsx(importDefault(16351), {});
  ...
  obj[3] = jsx(require(4710) /* getAlertModalItemKey */.AlertActionButton, { variant: "secondary", text: null, onPress: null });
  return jsx(require(4710) /* getAlertModalItemKey */.AlertModal, { variant: "secondary", text: null, onPress: null });
};
