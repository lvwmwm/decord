...
// Dependencies: [19, 21, 4598, 4598, 16108, 1236, 2]
// Exports: default

// Module 16107 (VoicePanelNoJoinPermissionsAlert)
import "noop";
...
export default function VoicePanelNoJoinPermissionsAlert() {
  ...
  obj[3] = jsx(require(4598) /* getAlertModalItemKey */.AlertActionButton, { variant: "secondary", text: null, onPress: null });
