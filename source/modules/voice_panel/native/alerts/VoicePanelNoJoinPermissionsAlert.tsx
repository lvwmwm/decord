...
// Dependencies: [19, 21, 4687, 4687, 16331, 1236, 2]
// Exports: default

// Module 16330 (VoicePanelNoJoinPermissionsAlert)
import "noop";
...
export default function VoicePanelNoJoinPermissionsAlert() {
  let obj = require(4687) /* getAlertModalItemKey */;
  obj = { header: null, title: null, content: null, actions: null };
  obj[0] = jsx(importDefault(16331), {});
  ...
  obj[3] = jsx(require(4687) /* getAlertModalItemKey */.AlertActionButton, { variant: "secondary", text: null, onPress: null });
  return jsx(require(4687) /* getAlertModalItemKey */.AlertModal, { variant: "secondary", text: null, onPress: null });
};
