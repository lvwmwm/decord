...
// Dependencies: [19, 21, 4645, 4645, 16174, 1236, 2]
// Exports: default

// Module 16173 (VoicePanelNoJoinPermissionsAlert)
import "noop";
...
export default function VoicePanelNoJoinPermissionsAlert() {
  let obj = require(4645) /* getAlertModalItemKey */;
  obj = { header: null, title: null, content: null, actions: null };
  obj[0] = jsx(importDefault(16174), {});
  ...
  obj[3] = jsx(require(4645) /* getAlertModalItemKey */.AlertActionButton, { variant: "secondary", text: null, onPress: null });
  return jsx(require(4645) /* getAlertModalItemKey */.AlertModal, { variant: "secondary", text: null, onPress: null });
};
