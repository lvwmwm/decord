...
// Dependencies: [19, 21, 4688, 4688, 16342, 1236, 2]
// Exports: default

// Module 16341 (VoicePanelNoJoinPermissionsAlert)
import "noop";
...
export default function VoicePanelNoJoinPermissionsAlert() {
  let obj = require(4688) /* getAlertModalItemKey */;
  ...
  obj[3] = jsx(require(4688) /* getAlertModalItemKey */.AlertActionButton, { variant: "secondary", text: null, onPress: null });
  return jsx(require(4688) /* getAlertModalItemKey */.AlertModal, { variant: "secondary", text: null, onPress: null });
};
