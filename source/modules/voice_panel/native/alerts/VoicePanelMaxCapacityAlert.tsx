...
// Dependencies: [31, 1348, 33, 624, 4476, 4476, 15923, 1212, 2]
// Exports: default

// Module 15925 (VoicePanelMaxCapacityAlert)
import "result";
...
export default function VoicePanelMaxCapacityAlert(channelId) {
  ...
  const obj2 = channelId(4476);
  obj = { header: jsx(importDefault(15923), {}) };
  ...
  obj.onPress = channelId(4476).useDismissModalCallback();
  obj.actions = jsx(channelId(4476).AlertActionButton, { variant: "secondary" });
  return jsx(channelId(4476).AlertModal, { variant: "secondary" });
};
