...
// Dependencies: [19, 1386, 21, 644, 4871, 4871, 17110, 1233, 2]
// Exports: default

// Module 17112 (VoicePanelMaxCapacityAlert)
...
export default function VoicePanelMaxCapacityAlert(channelId) {
  ...
  obj[2] = channelId(4871).useDismissModalCallback();
  obj[3] = jsx(channelId(4871).AlertActionButton, { variant: "secondary", text: null, onPress: null });
  return jsx(channelId(4871).AlertModal, { variant: "secondary", text: null, onPress: null });
};
