...
// Dependencies: [19, 1372, 21, 647, 4537, 4537, 16031, 1236, 2]
// Exports: default
...
export default function VoicePanelMaxCapacityAlert(channelId) {
  ...
  obj[2] = channelId(4537).useDismissModalCallback();
  obj[3] = jsx(channelId(4537).AlertActionButton, { variant: "secondary", text: null, onPress: null });
  return jsx(channelId(4537).AlertModal, { variant: "secondary", text: null, onPress: null });
};
