...
// Dependencies: [19, 1415, 1891, 21, 4628, 4628, 1236, 5215, 5111, 2]
// Exports: default

// Module 16151 (VoicePanelNsfwAlert)
import "noop";
...
export default function VoicePanelNsfwAlert(guildId) {
  ...
  const obj1 = {
    variant: "primary",
    onPress() {
      channelId(5215).nsfwAgree(guildId);
      const obj = channelId(5215);
      const voiceChannel = channelId(5111).selectVoiceChannel(channelId);
      dependencyMap();
    },
    text: null
  };
  ...
  const obj2 = {
    variant: "secondary",
    onPress() {
      channelId(5215).nsfwReturnToSafety(guildId);
      dependencyMap();
    },
    text: null
  };
