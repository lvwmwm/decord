// Module ID: 16090
// Function ID: 16091
// Dependencies: [32, 19, 17, 4268, 11530, 11533, 11528, 676, 21, 4255, 712, 1577, 16091, 8557, 11529, 4116, 11374, 16020, 3959, 5353, 16092, 11534, 11536, 4224, 4651, 14936, 8670, 16093, 15982, 16094, 4599, 16098, 16099, 5258, 16102, 4664, 7791, 1348, 15962, 15997, 705, 16124, 1231, 1581, 1474, 10138, 16125, 16022, 3967, 16101, 500, 16126, 2]
...
let closure_25 = importAllResult.memo((openTab) => {
  ...
  let handlePress;
  const tmp = callback2();
  const tmp2 = importDefault(16091)(openTab.openTab);
  ({ handlePress, accessibilityLabel, ariaHidden } = tmp2);
  return callback(closure_5, { style: tmp.actionSheetDragHandleWrapper, children: callback(require(8557) /* TwinButtons */.ActionSheetDragHandle, { onPress: handlePress, overlay: true, accessibilityLabel, "aria-hidden": ariaHidden }) });
});
