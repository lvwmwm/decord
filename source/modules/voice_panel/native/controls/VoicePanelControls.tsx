// Module ID: 16130
// Function ID: 16131
// Dependencies: [32, 19, 17, 4298, 11564, 11567, 11562, 676, 21, 4285, 712, 1605, 16131, 8586, 11563, 4145, 11408, 16060, 3988, 5407, 16132, 11568, 11570, 4254, 4681, 14974, 8699, 16133, 16022, 16134, 4629, 16138, 16139, 5312, 16142, 4694, 7932, 1348, 16002, 16037, 705, 16164, 1231, 1609, 1474, 10169, 16165, 16062, 3996, 16141, 500, 16166, 2]
...
let closure_25 = importAllResult.memo((openTab) => {
  ...
  let handlePress;
  const tmp = callback2();
  const tmp2 = importDefault(16131)(openTab.openTab);
  ({ handlePress, accessibilityLabel, ariaHidden } = tmp2);
  return callback(closure_5, { style: tmp.actionSheetDragHandleWrapper, children: callback(require(8586) /* TwinButtons */.ActionSheetDragHandle, { onPress: handlePress, overlay: true, accessibilityLabel, "aria-hidden": ariaHidden }) });
});
