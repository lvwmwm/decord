// Module ID: 16315
// Function ID: 16316
// Dependencies: [32, 19, 17, 4358, 11705, 11708, 11703, 676, 21, 4342, 712, 1624, 16316, 8712, 11704, 4083, 11547, 16246, 4065, 5467, 16317, 11709, 11711, 4311, 4741, 11426, 8825, 16318, 16208, 16319, 4689, 16323, 16324, 5369, 16327, 4754, 8054, 1367, 16188, 16223, 705, 16351, 1231, 1628, 1493, 11136, 16352, 16248, 4072, 16326, 500, 16353, 2]
...
let closure_25 = importAllResult.memo((openTab) => {
  ...
  let handlePress;
  const tmp = callback2();
  const tmp2 = importDefault(16316)(openTab.openTab);
