// Module ID: 16256
// Function ID: 16257
// Dependencies: [32, 19, 17, 4316, 11649, 11652, 11647, 676, 21, 4303, 712, 1624, 16257, 8669, 11648, 4042, 11493, 16187, 4024, 5427, 16258, 11653, 11655, 4272, 4700, 15072, 8782, 16259, 16149, 16260, 4648, 16264, 16265, 5329, 16268, 4713, 8011, 1367, 16129, 16164, 705, 16292, 1231, 1628, 1493, 10257, 16293, 16189, 4031, 16267, 500, 16294, 2]
...
let closure_25 = importAllResult.memo((openTab) => {
  ...
  let handlePress;
  const tmp = callback2();
  const tmp2 = importDefault(16257)(openTab.openTab);
  ({ handlePress, accessibilityLabel, ariaHidden } = tmp2);
  return callback(closure_5, { style: tmp.actionSheetDragHandleWrapper, children: callback(require(8669) /* TwinButtons */.ActionSheetDragHandle, { onPress: handlePress, overlay: true, accessibilityLabel, "aria-hidden": ariaHidden }) });
});
