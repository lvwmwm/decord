// Module ID: 16156
// Function ID: 16157
// Dependencies: [32, 19, 17, 4315, 11579, 11582, 11577, 676, 21, 4302, 712, 1605, 16157, 8603, 11578, 4162, 11423, 16086, 4005, 5426, 16158, 11583, 11585, 4271, 4698, 14990, 8716, 16159, 16048, 16160, 4646, 16164, 16165, 5328, 16168, 4711, 7949, 1348, 16028, 16063, 705, 16190, 1231, 1609, 1474, 10185, 16191, 16088, 4013, 16167, 500, 16192, 2]
...
let closure_25 = importAllResult.memo((openTab) => {
  ...
  let handlePress;
  const tmp = callback2();
  const tmp2 = importDefault(16157)(openTab.openTab);
  ({ handlePress, accessibilityLabel, ariaHidden } = tmp2);
  return callback(closure_5, { style: tmp.actionSheetDragHandleWrapper, children: callback(require(8603) /* TwinButtons */.ActionSheetDragHandle, { onPress: handlePress, overlay: true, accessibilityLabel, "aria-hidden": ariaHidden }) });
});
