...
// Function ID: 16271
// Name: NOOP
// Dependencies: [19, 17, 1372, 11643, 21, 4303, 712, 4036, 11644, 16103, 10636, 3974, 16167, 10848, 13058, 4712, 5767, 16271, 1236, 10858, 589, 11489, 4700, 5427, 1605, 5781, 5328, 11653, 2]
...
let closure_10 = importAllResult.memo((arg0) => {
  ...
  const tmp2 = importDefault(16103)(channelId);
  let obj = require(10636) /* getEmbeddedActivityLaunchability */;
