...
// Function ID: 16353
// Name: NOOP
// Dependencies: [19, 17, 1391, 11704, 21, 4344, 712, 4083, 11705, 16186, 10695, 4034, 16348, 10907, 13126, 4752, 5806, 16353, 1236, 10917, 589, 11550, 4740, 5466, 1624, 5820, 5367, 11714, 2]
...
let closure_10 = importAllResult.memo((arg0) => {
  ...
  const tmp2 = importDefault(16186)(channelId);
  let obj = require(10695) /* getEmbeddedActivityLaunchability */;
