...
// Function ID: 16322
// Name: FloatingCTA
// Dependencies: [32, 19, 1391, 11706, 11709, 505, 21, 1367, 712, 4344, 4752, 8011, 4072, 11705, 16210, 6064, 647, 16206, 4083, 11712, 4688, 10298, 4753, 8050, 10047, 2]
// Exports: getFloatingCTATotalViewHeight, renderVoicePanelFloatingCTA

// Module 16321 (FloatingCTA)
...
function FloatingCTA(trailing) {
  ...
  obj[0] = jsx(require(8011) /* RowButtonWrapper */.RowButton, { experimental_withBlurBackground: true, arrow: null == trailing, trailing });
  return jsx(require(4752) /* Stack */.Stack, { experimental_withBlurBackground: true, arrow: null == trailing, trailing });
}
  ...
  constructor(arg0) {
    ...
    class A {
      constructor() {
        ...
        obj1 = { state: tmp4, TransitionStates: require("wrapChildrenDefault").TransitionStates, runOnJS: require("module_4083").runOnJS, cleanUp };
        fn.__closure = obj1;
...
export const getFloatingCTATotalViewHeight = function getFloatingCTATotalViewHeight(chatInputFloating) {
  return require(1367) /* useIsMobileVisualRefreshExperimentEnabled */.resolveRefreshToken(importDefault(712).modules.mobile.TABLE_ROW_HEIGHT, chatInputFloating) + 16;
};
export const renderVoicePanelFloatingCTA = function renderVoicePanelFloatingCTA(arg0, arg1, state, cleanUp) {
  ...
  return jsx(require(4072) /* ManaContext */.ThemeContextProvider, {}, arg0);
};
