...
// Function ID: 16759
// Name: FloatingCTA
// Dependencies: [32, 19, 1387, 11840, 11843, 505, 21, 15613, 712, 4478, 4926, 8365, 4204, 11839, 16639, 6252, 647, 16635, 4217, 11846, 10730, 4927, 7796, 10418, 2]
// Exports: getFloatingCTATotalViewHeight, renderVoicePanelFloatingCTA

// Module 16758 (FloatingCTA)
...
import { CALL_TILE_GUTTER } from "CARD_SIZE" /* 11843 */;
  ...
  constructor(arg0) {
    ...
    class A {
      constructor() {
        ...
        obj1 = { state: tmp4, TransitionStates: require("ManaContext").TransitionStates, runOnJS: require("module_4217").runOnJS, cleanUp };
        fn.__closure = obj1;
