// Module ID: 16130
// Function ID: 16131
// Dependencies: [19, 17, 21, 4302, 712, 11578, 4495, 5721, 4298, 1236, 2]
...
const memoResult = importAllResult.memo(function VoicePanelNoVideoParticipantsCard() {
  ...
  const items1 = [callback(channelId(4298).Text, obj), ];
  ...
  obj[4] = callback(channelId(4298).Text, obj1);
  items1[1] = callback(Pressable, obj);
  obj[1] = items1;
  return callback2(importDefault(5721), obj);
});
