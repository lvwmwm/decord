// Module ID: 16228
// Function ID: 16229
// Dependencies: [19, 17, 21, 4303, 712, 11648, 4497, 5781, 4299, 1236, 2]
...
const memoResult = importAllResult.memo(function VoicePanelNoVideoParticipantsCard() {
  const channelId = importAllResult.useContext(importDefault(11648)).channelId;
  const tmp = callback3();
  ...
  const items1 = [callback(channelId(4299).Text, obj), ];
  ...
  obj[4] = callback(channelId(4299).Text, obj1);
  items1[1] = callback(Pressable, obj);
  obj[1] = items1;
  return callback2(importDefault(5781), obj);
});
