...
let closure_20 = require("module_4050").createAnimatedComponent(Pressable);
let c21 = 28;
...
let closure_27 = importAllResult.memo((participant) => {
  ...
  obj = { controlsHidden, FLOATING_BAR_HEIGHT: c21, VOICE_PANEL_CARD_INNER_PADDING: closure_12, withSpring: controlsHidden(4599).withSpring, MODE_CHANGE_PHYSICS: closure_9 };
  fn.__closure = obj;
