...
export const useDominantRGBFromImage = function useDominantRGBFromImage(arg0) {
  ...
  if (hexToRgbResult == null) {
    hexToRgbResult = _require(4151).hexToRgb(importDefault(712).unsafe_rawColors.PRIMARY_800);
