...
// Function ID: 16230
// Name: VideoStream
// Dependencies: [32, 19, 17, 1371, 4316, 10657, 4322, 1218, 1372, 1903, 11645, 16154, 676, 4328, 4321, 21, 4303, 712, 11644, 16148, 10704, 1231, 4648, 16158, 5781, 16153, 647, 1474, 4036, 10720, 9399, 10693, 10708, 1297, 9063, 11647, 8009, 16070, 9765, 10686, 10689, 2]

// Module 16229 (VideoStream)
...
function AnimatedVideoWrapper(arg0) {
  ...
  targetDimensionsSubscription = targetDimensionsSubscription(11647).useTargetDimensionsSubscription(participantId, importAllResult.useContext(importDefault(11644)).layoutManager);
  ...
  return callback(importDefault(8009), { style, children });
}
