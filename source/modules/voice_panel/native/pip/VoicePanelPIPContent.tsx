...
// Function ID: 16321
// Name: VideoStream
// Dependencies: [32, 19, 17, 1390, 4358, 10630, 4364, 1218, 1391, 1922, 11704, 16248, 676, 4370, 4363, 21, 4342, 712, 11703, 16242, 10677, 1231, 4689, 16252, 5821, 16247, 647, 1493, 4083, 10693, 9449, 10666, 10681, 1297, 9112, 11706, 8054, 16164, 9816, 10659, 10662, 2]

// Module 16320 (VideoStream)
...
function AnimatedVideoWrapper(arg0) {
  ...
  targetDimensionsSubscription = targetDimensionsSubscription(11706).useTargetDimensionsSubscription(participantId, importAllResult.useContext(importDefault(11703)).layoutManager);
