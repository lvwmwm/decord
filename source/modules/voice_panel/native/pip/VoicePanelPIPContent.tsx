...
// Function ID: 16310
// Name: VideoStream
// Dependencies: [32, 19, 17, 1390, 4357, 10716, 4363, 1218, 1391, 1922, 11706, 16237, 676, 4369, 4362, 21, 4344, 712, 11705, 16231, 10763, 1231, 4688, 16241, 5820, 16236, 647, 1493, 4083, 10779, 9445, 10752, 10767, 1297, 9108, 11708, 8050, 16153, 9812, 10745, 10748, 2]

// Module 16309 (VideoStream)
...
function AnimatedVideoWrapper(arg0) {
  ...
  targetDimensionsSubscription = targetDimensionsSubscription(11708).useTargetDimensionsSubscription(participantId, importAllResult.useContext(importDefault(11705)).layoutManager);
  ...
  return callback(importDefault(8050), { style, children });
}
