...
// Function ID: 16087
// Name: VideoStream
// Dependencies: [32, 19, 17, 1371, 4268, 10539, 4274, 1218, 1372, 1874, 11530, 16013, 676, 4280, 4273, 21, 4255, 712, 11529, 16007, 10586, 1231, 4599, 16017, 5648, 16012, 647, 1474, 4116, 10602, 9288, 10575, 10590, 1297, 8957, 11532, 7791, 15929, 9652, 10568, 10571, 2]

// Module 16086 (VideoStream)
...
function AnimatedVideoWrapper(arg0) {
  ...
  targetDimensionsSubscription = targetDimensionsSubscription(11532).useTargetDimensionsSubscription(participantId, importAllResult.useContext(importDefault(11529)).layoutManager);
  ...
  return callback(importDefault(7791), { style, children });
}
