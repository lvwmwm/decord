...
// Dependencies: [32, 19, 17, 10038, 21, 4050, 5568, 1297, 4189, 712, 10412, 15918, 4599, 15913, 5273, 15989, 2]
// Exports: default

// Module 15988 (VoicePanelPIPPushToTalkOverlay)
...
export default function VoicePanelPIPPushToTalkOverlay() {
  ...
  obj = { isPushingToTalk: first, EXPANDED_ICON_SIZE: 48, BASE_ICON_SIZE: 32, withSpring: sharedValue(4599).withSpring, PUSH_TO_TALK_PIP_PHYSICS, white: WHITE };
  fn.__closure = obj;
  fn.__workletHash = 3936373516983;
  fn.__initData = closure_13;
  const animatedStyle = obj2.useAnimatedStyle(fn);
  let obj4 = sharedValue(4050);
  class P {
    constructor() {
      obj = c0(outer1_2[12]);
  ...
  obj = { withSpring: sharedValue(4599).withSpring, isPushingToTalk: first, black: BLACK, white: WHITE, PUSH_TO_TALK_PIP_PHYSICS };
  P.__closure = obj;
  ...
  obj1 = { withSpring: sharedValue(4599).withSpring, isPushingToTalk: first, PUSH_TO_TALK_PIP_PHYSICS, getVoicePanelPIPBorderRadius: sharedValue(15913).getVoicePanelPIPBorderRadius, pipState: pIPState };
  H.__closure = obj1;
  H.__workletHash = 450590017248;
  H.__initData = closure_15;
  const items2 = [tmp4[1]];
  const animatedStyle2 = sharedValue(4050).useAnimatedStyle(H);
  obj2 = { children: null };
  ...
  items4[1] = callback(sharedValue(5273).GestureDetector, obj3);
  obj2[0] = items4;
