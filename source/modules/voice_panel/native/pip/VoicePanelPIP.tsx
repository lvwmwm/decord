...
function VoicePanelPIP() {
  ...
  ({ multiPIPWrapperStyles, mainPIPWrapperStyles, secondaryPIPWrapperStyles, mainPIPGesture, secondaryPIPGesture } = function usePIPGesture(mode) {
    ...
    const sharedValue = obj1.useSharedValue({ "Bool(false)": "<string:3628173623>", "Bool(false)": "<string:240518207>", "Bool(false)": "<string:3818762797>", "Bool(false)": "<string:3848286783>", "Bool(false)": "<string:4191888080>", "Bool(false)": "<string:3332915134>" });
    ...
    const callback = safeArea.useCallback(() => {
      ...
      const fn3 = function u(state, activate) {
        ...
        if (state.state === callback(closure_3[17]).State.BEGAN) {
          if (!store.get().active) {
            ...
            if (tmp3) {
              const obj = { <string:1157629044>: true, <string:1962935412>: true, <string:1677722658>: true, <string:1694499906>: true, <string:943783940>: true, <string:458293252>: true, absoluteX, absoluteY };
              const result = store.set(obj);
              callback2(closure_3[18])(closure_11, { users: true, max: true, guildId: true });
              activate.activate();
      ...
      const fn5 = function s(arg0) {
        ...
        callback2(closure_3[18])(closure_14, { x: null, y: null });
...
let closure_17 = { <string:1634937736>: "ILLO_GREEN_10", <string:1733120470>: 0.9, <string:1453996748>: "ILLO_GREEN_50" };
...
obj["overflow"] = "hidden";
obj.pipMask = obj;
obj1 = { "Bool(false)": 0.2, "Bool(false)": null, "Bool(false)": 48, "Bool(false)": 2, gap: tmp3.SECONDARY_PIP_TOP_MARGIN };
