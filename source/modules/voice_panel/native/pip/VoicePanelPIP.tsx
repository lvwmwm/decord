...
// Function ID: 16238
// Name: VoicePanelPIP
// Dependencies: [32, 19, 17, 1371, 10592, 4514, 11646, 11644, 16163, 9759, 10593, 21, 4713, 4303, 11645, 16167, 4036, 16162, 5427, 10331, 16169, 9766, 589, 3919, 10596, 10614, 8732, 1236, 8009, 16238, 16239, 5781, 16241, 4648, 2]

// Module 16237 (VoicePanelPIP)
...
function VoicePanelPIP() {
  const tmp = callback2();
  let obj = callback2;
  const context = callback2.useContext(importDefault(11645));
  ...
  importDefault = tmp7;
  const context1 = callback2.useContext(importDefault(11645));
  ...
  let fn = function j() {
    ...
    obj[4] = mode(16162).getVoicePanelPIPBorderRadius(width, tmp2);
    return obj;
  };
  obj = { pipState: pIPState1, getClampedPIPPosition: mode(16162).getClampedPIPPosition, wrapperDimensions, windowDimensions, safeArea, pipAvoidanceSpecs, initialGestureOffset: sharedValue, opacity: sharedValue1, withSpring: mode(4713).withSpring, DRAWER_SPRING_PHYSICS: wrapperDimensions, LAYOUT_PHYSICS: stateFromStores1, getVoicePanelPIPBorderRadius: mode(16162).getVoicePanelPIPBorderRadius };
  fn.__closure = obj;
  ...
  let fn2 = function z() {
    ...
    obj[2] = mode(16162).getVoicePanelPIPBorderRadius(width, height);
    return obj;
  };
  obj = { pipState: pIPState1, getVoicePanelPIPBorderRadius: mode(16162).getVoicePanelPIPBorderRadius };
  fn2.__closure = obj;
  ...
  const memo = callback2.useMemo(() => {
    ...
    obj[2] = mode(16162).getVoicePanelPIPBorderRadius(pIPState1.width, pIPState1.height);
    items[1] = obj;
  ...
  callback = callback2.useCallback(() => {
    ...
    obj = { updateSharedValueIfChanged: _undefined(10331), initialGestureOffset: sharedValue };
    fn2.__closure = obj;
    ...
    fn3.__closure = { State: mode(5427).State, initialGestureOffset: sharedValue, MIN_GESTURE_START: 10, updateSharedValueIfChanged: _undefined(10331), wrapperOffset, runOnJS: mode(4036).runOnJS, triggerIOSHaptic: _undefined(16169) };
    fn3.__workletHash = 16714994610987;
    fn3.__initData = outer1_27;
    const obj1 = { State: mode(5427).State, initialGestureOffset: sharedValue, MIN_GESTURE_START: 10, updateSharedValueIfChanged: _undefined(10331), wrapperOffset, runOnJS: mode(4036).runOnJS, triggerIOSHaptic: _undefined(16169) };
    ...
    fn4.__closure = { updateSharedValueIfChanged: _undefined(10331), initialGestureOffset: sharedValue };
    fn4.__workletHash = 7822444262980;
    fn4.__initData = outer1_26;
    const obj2 = { updateSharedValueIfChanged: _undefined(10331), initialGestureOffset: sharedValue };
    ...
    fn5.__closure = { calculatePIPPositionFromVelocity: mode(16162).calculatePIPPositionFromVelocity, windowDimensions, safeArea: callback2, updateSharedValueIfChanged: _undefined(10331), wrapperDimensions, wrapperOffset, initialGestureOffset: sharedValue, runOnJS: mode(4036).runOnJS, updateSourceTrackingView: _undefined(9766).updateSourceTrackingView };
    fn5.__workletHash = 1502716164658;
    fn5.__initData = outer1_25;
    const obj3 = { calculatePIPPositionFromVelocity: mode(16162).calculatePIPPositionFromVelocity, windowDimensions, safeArea: callback2, updateSharedValueIfChanged: _undefined(10331), wrapperDimensions, wrapperOffset, initialGestureOffset: sharedValue, runOnJS: mode(4036).runOnJS, updateSourceTrackingView: _undefined(9766).updateSourceTrackingView };
    const fn6 = function n() {
      outer1_1(outer1_3[19])(closure_14, { active: false, pressed: false });
    };
    const onEndResult = onChangeResult.onEnd(fn5);
    fn6.__closure = { updateSharedValueIfChanged: _undefined(10331), initialGestureOffset: sharedValue };
    fn6.__workletHash = 4606005866023;
    fn6.__initData = outer1_24;
    const obj4 = { updateSharedValueIfChanged: _undefined(10331), initialGestureOffset: sharedValue };
    const fn7 = function t() {
      outer1_1(outer1_3[19])(closure_14, { active: false, pressed: false });
    };
    const onTouchesCancelledResult = onEndResult.onTouchesCancelled(fn6);
    fn7.__closure = { updateSharedValueIfChanged: _undefined(10331), initialGestureOffset: sharedValue };
  ...
  callback1 = callback2.useCallback(() => {
    ...
    if (null != stateFromStores1) {
      _undefined(10596).updateFramePanelMode(tmp7, sharedValue.PANEL);
      const obj2 = _undefined(10596);
    } else {
      const result = first(10614).updateActivityPanelMode(sharedValue.PANEL);
      const obj = first(10614);
    }
  }, items6);
  ...
  let fn3 = function $() {
    ...
    obj[0] = mode(16162).getVoicePanelPIPBorderRadius(_undefined.width, _undefined.height);
    return obj;
  };
  obj1 = { getVoicePanelPIPBorderRadius: tmp5(16162).getVoicePanelPIPBorderRadius, pipState: pIPState };
  fn3.__closure = obj1;
  ...
  callback2 = obj.useCallback(() => {
    if (null != stateFromStores2) {
      _undefined(10596).updateFramePanelMode(tmp, sharedValue.PANEL);
      const obj2 = _undefined(10596);
    } else {
      const result = first(10614).updateActivityPanelMode(sharedValue.PANEL);
      const obj = first(10614);
...
let closure_37 = importAllResult.memo((transitionState) => {
  ...
  panelCardStillInPIP = obj.useContext(transitionCleanUp(11645)).panelCardStillInPIP;
