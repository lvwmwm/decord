...
// Dependencies: [32, 19, 1371, 4202, 5686, 1372, 5009, 10034, 5688, 15857, 589, 3807, 8011, 9443, 15905, 635, 15906, 15907, 15909, 2]
// Exports: useControllerPIPState

// Module 15904 (useControllerPIPState)
...
export const useControllerPIPState = function useControllerPIPState(channelId) {
  ...
  c7 = undefined;
  obj = React;
  ref = React.useRef({ id: "dispatch", mode: "isArray", width: false, height: 20, containerHeight: 300, showSecondaryPIP: 1.5 });
  ...
  const tmp7 = ref(15857)(channelId);
  dependencyMap = tmp7;
  ...
  const tmp10 = ref(15905)(channelId);
  ...
  ({ participant, dimensions } = ref(15906)(channelId, layoutManager, focusedId, first, obj));
  obj = {};
  ...
  tmp5(15909)(channelId, layoutManager, focusedId);
  return obj;
};
