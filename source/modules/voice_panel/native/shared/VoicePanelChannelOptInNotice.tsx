// Module ID: 17037
// Function ID: 17038
// Dependencies: [19, 21, 7053, 5544, 5560, 1233, 5566, 13853, 2]
...
const memoResult = importAllResult.memo(function VoicePanelChannelOptInNotice(channel) {
  ...
  obj = { IconComponent: channel(13853).ChannelListMagnifyingGlassIcon };
  obj[2] = jsx(channel(5566).TableRowIcon, { IconComponent: channel(13853).ChannelListMagnifyingGlassIcon });
  obj[3] = callback;
  obj[1] = jsx(channel(5560).TableRow, { IconComponent: channel(13853).ChannelListMagnifyingGlassIcon });
  return jsx(analyticsSection(5544), { IconComponent: channel(13853).ChannelListMagnifyingGlassIcon });
});
