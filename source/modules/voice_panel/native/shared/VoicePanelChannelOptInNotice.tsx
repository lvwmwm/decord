// Module ID: 15867
// Function ID: 122500
// Dependencies: [31, 33, 5073, 5515, 5164, 1212, 5170, 12916, 2]
...
const memoResult = importAllResult.memo(function VoicePanelChannelOptInNotice(channel) {
  ...
  obj = { IconComponent: channel(12916).ChannelListMagnifyingGlassIcon };
  obj.icon = jsx(channel(5170).TableRowIcon, { IconComponent: channel(12916).ChannelListMagnifyingGlassIcon });
  obj.onPress = callback;
  obj.start = true;
  obj.end = true;
  obj.arrow = true;
  obj.children = jsx(channel(5164).TableRow, { IconComponent: channel(12916).ChannelListMagnifyingGlassIcon });
  return jsx(analyticsSection(5515), { IconComponent: channel(12916).ChannelListMagnifyingGlassIcon });
});
