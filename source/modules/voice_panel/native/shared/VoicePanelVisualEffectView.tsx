...
// Dependencies: [19, 17, 21, 4255, 712, 3959, 1348, 8557, 2]

// Module 16101 (VoicePanelVisualEffectView)
...
const memoResult = require("noop").memo(function VoicePanelVisualEffectViewInner(matchAppTheme) {
  ...
  obj[1] = tmp5;
  const tmp4Result = closure_4(require(8557) /* TwinButtons */.BackgroundBlurFill, obj);
  let tmp7 = tmp4Result;
  if (tmp3) {
