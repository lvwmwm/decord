...
// Dependencies: [19, 17, 21, 4285, 712, 3988, 1348, 8586, 2]

// Module 16141 (VoicePanelVisualEffectView)
...
const memoResult = require("noop").memo(function VoicePanelVisualEffectViewInner(matchAppTheme) {
  ...
  obj[1] = tmp5;
  const tmp4Result = closure_4(require(8586) /* TwinButtons */.BackgroundBlurFill, obj);
  let tmp7 = tmp4Result;
  if (tmp3) {
