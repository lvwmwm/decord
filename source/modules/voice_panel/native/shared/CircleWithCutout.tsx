...
// Function ID: 16266
// Name: getBadgeLeft
// Dependencies: [19, 17, 21, 10670, 7835, 2]

// Module 16265 (getBadgeLeft)
...
const memoResult = require("noop").memo(function CircleWithCutout(arg0) {
  ...
  let obj = require(10670) /* CircleWithCutout */;
  const cutoutCenterX = obj.getCutoutCenterX(result, cutoutPositionInDegrees);
  let obj1 = require(10670) /* CircleWithCutout */;
  ...
  const items1 = [callback(require(7835) /* inlineStyles */.Rect, { width: result2, height: result2, fill: "white" }), callback(require(7835) /* inlineStyles */.Circle, { cx: diff, cy: tmp8, r: cutoutRadius * num, fill: "black" })];
  obj2[1] = items1;
  obj1[0] = callback2(require(7835) /* inlineStyles */.Mask, obj2);
  const items2 = [callback(require(7835) /* inlineStyles */.Defs, obj1), ];
  ...
  obj4[4] = str;
  items2[1] = callback(require(7835) /* inlineStyles */.Circle, obj4);
  obj[3] = items2;
