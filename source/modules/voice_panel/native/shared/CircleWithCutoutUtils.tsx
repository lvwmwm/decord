...
export default function CircleWithCutout(arg0) {
  ...
  const items = [callback(require(7901) /* inlineStyles */.Rect, { width: result, height: result, fill: "white" }), callback(require(7901) /* inlineStyles */.Circle, { cx: sum, cy: diff, r: cutoutRadius, fill: "black" })];
  obj[1] = items;
  obj[0] = callback2(require(7901) /* inlineStyles */.Mask, obj);
  const items1 = [callback(require(7901) /* inlineStyles */.Defs, obj), ];
  ...
  obj1[4] = str;
  items1[1] = callback(require(7901) /* inlineStyles */.Circle, obj1);
  obj[2] = items1;
