...
// Function ID: 11573
// Name: StyleSheet
// Dependencies: [19, 17, 21, 4285, 500, 4145, 4694, 4221, 7932, 4684, 4130, 5702, 2]

// Module 11572 (StyleSheet)
...
export default require("noop").memo(function HeaderGlassBlur(shown) {
  ...
  const items3 = [closure_4(importDefault(5702), { style: tmp.stroke }), ];
