...
// Dependencies: [19, 17, 4500, 1218, 21, 4217, 4928, 4478, 712, 10145, 589, 4544, 4479, 7796, 4474, 1236, 2]
// Exports: VoicePanelStreamPreview

// Module 12469 (VoicePanelStreamPreview)
...
export const VoicePanelStreamPreview = function VoicePanelStreamPreview(mode) {
  ...
  obj = { mode, withTiming: mode(4479).withTiming, OPACITY_TIMING: closure_10 };
  T.__closure = obj;
