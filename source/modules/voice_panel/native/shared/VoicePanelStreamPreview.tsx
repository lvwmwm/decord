...
// Dependencies: [19, 17, 4468, 1218, 21, 4186, 4893, 4446, 712, 10083, 589, 4512, 4447, 7743, 4442, 1236, 2]
// Exports: VoicePanelStreamPreview

// Module 12402 (VoicePanelStreamPreview)
...
export const VoicePanelStreamPreview = function VoicePanelStreamPreview(mode) {
  ...
  const previewUrl = stream(10083)(guildId, channelId, ownerId).previewUrl;
  let obj = mode(589);
  ...
  obj = { mode, withTiming: mode(4447).withTiming, OPACITY_TIMING: closure_10 };
  T.__closure = obj;
  ...
  if (stateFromStores) {
    ...
    obj4[1] = tmp16(tmp8(4442).Text, obj5);
  ...
  obj3[2] = tmp16Result;
  items2[1] = callback(stream(7743), obj3);
  obj[5] = items2;
