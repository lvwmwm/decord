...
// Dependencies: [19, 17, 4321, 1218, 21, 4162, 4712, 4302, 712, 10876, 589, 4365, 4303, 7949, 4298, 1236, 2]
// Exports: VoicePanelStreamPreview

// Module 12246 (VoicePanelStreamPreview)
import "noop";
...
let closure_9 = require("module_4162").createAnimatedComponent(require("Button").Button);
...
export const VoicePanelStreamPreview = function VoicePanelStreamPreview(mode) {
  ...
  const previewUrl = stream(10876)(guildId, channelId, ownerId).previewUrl;
  let obj = mode(589);
  ...
  obj = { mode, withTiming: mode(4303).withTiming, OPACITY_TIMING: closure_10 };
  T.__closure = obj;
  ...
  if (stateFromStores) {
    ...
    obj4[1] = tmp16(tmp8(4298).Text, obj5);
  ...
  obj3[2] = tmp16Result;
  items2[1] = callback(stream(7949), obj3);
  obj[5] = items2;
