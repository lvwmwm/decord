...
// Dependencies: [19, 17, 4274, 1218, 21, 4116, 4665, 4255, 712, 10809, 589, 4318, 4256, 7791, 4251, 1236, 2]
// Exports: VoicePanelStreamPreview

// Module 12197 (VoicePanelStreamPreview)
import "noop";
...
export const VoicePanelStreamPreview = function VoicePanelStreamPreview(mode) {
  ...
  const previewUrl = stream(10809)(guildId, channelId, ownerId).previewUrl;
  let obj = mode(589);
  ...
  obj3[2] = tmp16Result;
  items2[1] = callback(stream(7791), obj3);
  obj[5] = items2;
