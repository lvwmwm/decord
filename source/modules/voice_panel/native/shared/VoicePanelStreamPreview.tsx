...
// Dependencies: [19, 17, 4304, 1218, 21, 4145, 4695, 4285, 712, 10864, 589, 4348, 4286, 7932, 4281, 1236, 2]
// Exports: VoicePanelStreamPreview

// Module 12231 (VoicePanelStreamPreview)
import "noop";
...
let closure_8 = require("module_4145").createAnimatedComponent(Pressable);
let closure_9 = require("module_4145").createAnimatedComponent(require("Button").Button);
...
export const VoicePanelStreamPreview = function VoicePanelStreamPreview(mode) {
  ...
  const previewUrl = stream(10864)(guildId, channelId, ownerId).previewUrl;
  let obj = mode(589);
  ...
  obj = { mode, withTiming: mode(4286).withTiming, OPACITY_TIMING: closure_10 };
  T.__closure = obj;
  ...
  if (stateFromStores) {
    ...
    obj4[1] = tmp16(tmp8(4281).Text, obj5);
  ...
  obj3[2] = tmp16Result;
  items2[1] = callback(stream(7932), obj3);
  obj[5] = items2;
