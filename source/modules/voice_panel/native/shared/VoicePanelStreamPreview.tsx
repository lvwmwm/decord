...
// Dependencies: [19, 17, 4274, 1218, 21, 4116, 4666, 4255, 712, 10967, 589, 4319, 4256, 7807, 4251, 1236, 2]
// Exports: VoicePanelStreamPreview

// Module 12139 (VoicePanelStreamPreview)
import "noop";
...
let closure_9 = require("module_4116").createAnimatedComponent(require("Button").Button);
...
export const VoicePanelStreamPreview = function VoicePanelStreamPreview(mode) {
  ...
  const previewUrl = stream(10967)(guildId, channelId, ownerId).previewUrl;
  let obj = mode(589);
  ...
  obj = { mode, withTiming: mode(4256).withTiming, OPACITY_TIMING: closure_10 };
  T.__closure = obj;
  ...
  if (stateFromStores) {
    ...
    obj4[1] = tmp16(tmp8(4251).Text, obj5);
  ...
  obj3[2] = tmp16Result;
  items2[1] = callback(stream(7807), obj3);
  obj[5] = items2;
