...
// Dependencies: [32, 19, 4514, 11646, 676, 4036, 1231, 10968, 4129, 4142, 10961, 10597, 2]
// Exports: default

// Module 16166 (usePanelOpenState)
...
export default function usePanelOpenState(arg0, arg1, arg2, connected) {
  ...
  obj = { runOnJS: _require(4036).runOnJS, doCloseChannel };
  O.__closure = obj;
