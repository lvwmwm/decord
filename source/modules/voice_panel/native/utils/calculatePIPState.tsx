...
// Dependencies: [4268, 4274, 10193, 4273, 4319, 15999, 2]
// Exports: default

// Module 15998 (calculatePIPState)
...
export default function calculatePIPState(channelId, getTargetDimensions, lastParticipantId, speakingUserId, focusedId) {
  ...
  if (null != currentUserActiveStream) {
    set.add(require(4319) /* isStreamKey */.encodeStreamKey(currentUserActiveStream));
  ...
  const pIPParticipantToShow = require(15999) /* PIPReferenceDimensions */.computePIPParticipantToShow(obj);
  let type1;
  ...
  const obj3 = require(15999) /* PIPReferenceDimensions */;
  ...
  if (SquarePIPReferenceDimensions == null) {
    SquarePIPReferenceDimensions = tmp13(15999).SquarePIPReferenceDimensions;
  }
  if (tmp10) {
    tmp10 = tmp;
  }
  obj = { participant: pIPParticipantToShow, dimensions: require(15999) /* PIPReferenceDimensions */.computePIPSize(SquarePIPReferenceDimensions, tmp18, tmp10, focusedId.showSecondaryPIP) };
  return obj;
};
