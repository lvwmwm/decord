...
// Function ID: 15942
// Name: NOOP
// Dependencies: [32, 19, 17, 4206, 8138, 4404, 10051, 10049, 4211, 10052, 21, 3, 4603, 4193, 712, 4054, 1577, 10050, 1581, 5277, 9458, 10055, 15942, 4162, 15935, 3897, 10057, 10701, 15940, 15928, 9927, 10272, 5871, 7684, 5519, 5539, 705, 15943, 5506, 15944, 15945, 5699, 15946, 15948, 15979, 16006, 16008, 16013, 2]
...
function AnimatedWrapper(children) {
  ...
  let animatedStyle;
  let animatedStyle1;
  let obj = wrapperOffset(10701);
  height = obj.useGlobalStatusIndicatorState().height;
  const tmp3 = callback2();
  dependencyMap = tmp3;
  let obj1 = connected;
  const context = connected.useContext(height(10050));
  ...
  let obj3 = wrapperOffset(15940);
  pIPState = obj3.usePIPState();
  let obj4 = wrapperOffset(4054);
  ...
  obj = { cheapWorkletShallowEqual: wrapperOffset(9458).cheapWorkletShallowEqual, VoicePanelModes: animatedStyle1, wrapperDimensions, updateSharedValueIfChanged: height(10055), wrapperOffset, getMaxPanelWidth: wrapperOffset(15928).getMaxPanelWidth, getPanelX: wrapperOffset(15928).getPanelX, roundToNearestPixel: height(9927), windowDimensions };
  fn3.__closure = obj;
  fn3.__workletHash = 3683279660781;
  fn3.__initData = closure_57;
  const animatedReaction = obj4.useAnimatedReaction(fn2, fn3);
  let obj6 = wrapperOffset(4054);
  class C {
    constructor() {
  ...
  obj = { useReducedMotion, wrapperDimensions, wrapperOffset, connected, mode, VoicePanelModes: animatedStyle1, runOnJS: wrapperOffset(4054).runOnJS, updateSourceTrackingView: height(10272).updateSourceTrackingView, withSpring: wrapperOffset(4603).withSpring, DRAWER_SPRING_PHYSICS_GESTURE_ACTIVE: closure_17, DRAWER_SIZE_PHYSICS: obj2 };
  C.__closure = obj;
  C.__workletHash = 16361132737159;
  C.__initData = closure_58;
  animatedStyle = obj6.useAnimatedStyle(C);
  let obj8 = wrapperOffset(4054);
  class M {
    constructor() {
      obj = mode;
      obj2 = connected;
  ...
  obj1 = { computeBorderRadii, mode, connected, wrapperDimensions, withSpring: wrapperOffset(4603).withSpring, BORDER_RADIUS_PHYSICS: windowDimensions, VoicePanelModes: animatedStyle1, styles: tmp3 };
  M.__closure = obj1;
  M.__workletHash = 1768699814221;
  M.__initData = closure_60;
  animatedStyle1 = obj8.useAnimatedStyle(M);
  if (!wrapperOffset(5871).isStable) {
  ...
  obj7[2] = callback(height(7684), obj8);
...
function layoutTransition(originX) {
  ...
  obj[0] = require(4603) /* CONFIG_NEVER_ANIMATE */.withSpring(originX.targetOriginX, LAYOUT_PHYSICS, "animate-always");
  const obj3 = require(4603) /* CONFIG_NEVER_ANIMATE */;
  obj[1] = require(4603) /* CONFIG_NEVER_ANIMATE */.withSpring(originX.targetOriginY, LAYOUT_PHYSICS, "animate-always");
  const obj4 = require(4603) /* CONFIG_NEVER_ANIMATE */;
  obj[2] = require(4603) /* CONFIG_NEVER_ANIMATE */.withSpring(originX.targetWidth, LAYOUT_PHYSICS, "animate-always");
  const obj5 = require(4603) /* CONFIG_NEVER_ANIMATE */;
  obj[3] = require(4603) /* CONFIG_NEVER_ANIMATE */.withSpring(originX.targetHeight, LAYOUT_PHYSICS, "animate-always");
  obj[0] = obj;
...
function scrollViewLayoutTransition(originX) {
  ...
  obj[1] = require(4603) /* CONFIG_NEVER_ANIMATE */.withSpring(originX.targetOriginY, LAYOUT_PHYSICS, "animate-always");
  const obj4 = require(4603) /* CONFIG_NEVER_ANIMATE */;
  obj[2] = require(4603) /* CONFIG_NEVER_ANIMATE */.withSpring(originX.targetWidth, obj, "animate-always");
  const obj5 = require(4603) /* CONFIG_NEVER_ANIMATE */;
  obj[3] = require(4603) /* CONFIG_NEVER_ANIMATE */.withSpring(originX.targetHeight, obj, "animate-always");
  obj[0] = obj;
  obj[1] = { originX: originX.currentOriginX, originY: originX.currentOriginY, width: originX.currentWidth, height: originX.currentHeight };
  return obj;
}
...
let closure_32 = require("module_4054").createAnimatedComponent(ScrollView);
...
let closure_68 = importAllResult.memo((onPress) => {
  ...
  obj = { withSpring: opacity(4603).withSpring, opacity, DrawerShadeOpacityPhysics: closure_66 };
  fn.__closure = obj;
          ...
          if (velocityY > 0) {
            if (store2.get()) {
              ...
              if (closure_19.get().y > 0.2 * diff) {
                ...
                outer1_0(outer1_2[15]).runOnJS(module_8138)();
    ...
    constructor(arg0) {
      if (c22.get()) {
        ...
        if (scrollPosition.get() !== arg0.contentOffset.y) {
          ...
          if (typeof c30 !== "fileFinishedImporting") {
