...
// Function ID: 16639
// Name: NOOP
// Dependencies: [32, 19, 17, 4464, 8553, 4696, 11807, 11805, 4469, 11808, 21, 3, 4895, 4448, 712, 4187, 1624, 11806, 1628, 5620, 9170, 10953, 16639, 4416, 16632, 4167, 11811, 9609, 16637, 16625, 10692, 9540, 7316, 7764, 5921, 5941, 705, 16640, 5908, 16641, 16642, 9423, 16643, 16645, 16676, 16705, 16709, 16714, 2]
...
import closure_8 from "module_8553" /* 8553 */;
import closure_9 from "withEqualityFn" /* 4696 */;
...
import { POP_RESISTANCE } from "MIN_PAN_GESTURE_MOVE" /* 11808 */;
...
function AnimatedWrapper(children) {
  ...
  let animatedStyle;
  let animatedStyle1;
  obj = wrapperOffset(9609);
  height = obj.useGlobalStatusIndicatorState().height;
  const tmp3 = callback3();
  dependencyMap = tmp3;
  obj1 = connected;
  const context = connected.useContext(height(11806));
  ...
  let obj3 = wrapperOffset(16637);
  pIPState = obj3.usePIPState();
  let obj4 = wrapperOffset(4187);
  ...
  obj = { cheapWorkletShallowEqual: wrapperOffset(9170).cheapWorkletShallowEqual, VoicePanelModes: animatedStyle1, wrapperDimensions, updateSharedValueIfChanged: height(10953), wrapperOffset, getMaxPanelWidth: wrapperOffset(16625).getMaxPanelWidth, getPanelX: wrapperOffset(16625).getPanelX, roundToNearestPixel: height(10692), windowDimensions };
  fn3.__closure = obj;
  fn3.__workletHash = 3683279660781;
  fn3.__initData = closure_57;
  const animatedReaction = obj4.useAnimatedReaction(fn2, fn3);
  let obj6 = wrapperOffset(4187);
  class C {
    constructor() {
      ...
      obj = { mode, VoicePanelModes: closure_15, runOnJS: wrapperOffset(closure_2[15]).runOnJS, updateSourceTrackingView: height(closure_2[31]).updateSourceTrackingView };
      tmp9 = wrapperOffset;
      tmp10 = closure_2;
      VoicePanelUITsx29.__closure = obj;
      VoicePanelUITsx29.__workletHash = 10394717541764;
      VoicePanelUITsx29.__initData = closure_1_59;
      obj3 = wrapperOffset(closure_2[12]);
      tmp11 = obj.get().gestureActive ? closure_1_17 : closure_1_29;
      str = "animate-never";
      str2 = "animate-never";
      if (gestureActive) {
        str2 = "animate-always";
      ...
      tmp12 = obj.get().gestureActive ? closure_1_17 : closure_1_29;
      if (gestureActive) {
        str = "animate-always";
      }
      obj2 = { transform: null };
  ...
  obj = { useReducedMotion, wrapperDimensions, wrapperOffset, connected, mode, VoicePanelModes: animatedStyle1, runOnJS: wrapperOffset(4187).runOnJS, updateSourceTrackingView: height(9540).updateSourceTrackingView, withSpring: wrapperOffset(4895).withSpring, DRAWER_SPRING_PHYSICS_GESTURE_ACTIVE: closure_17, DRAWER_SIZE_PHYSICS: obj2 };
  C.__closure = obj;
  C.__workletHash = 16361132737159;
  C.__initData = closure_58;
  animatedStyle = obj6.useAnimatedStyle(C);
  let obj8 = wrapperOffset(4187);
  class M {
    constructor() {
      obj = mode;
      obj2 = connected;
  ...
  obj1 = { computeBorderRadii, mode, connected, wrapperDimensions, withSpring: wrapperOffset(4895).withSpring, BORDER_RADIUS_PHYSICS: windowDimensions, VoicePanelModes: animatedStyle1, styles: tmp3 };
  M.__closure = obj1;
  M.__workletHash = 1768699814221;
  M.__initData = closure_60;
  animatedStyle1 = obj8.useAnimatedStyle(M);
  if (!wrapperOffset(7316).isStable) {
  ...
  obj7[2] = callback2(height(7764), obj8);
...
let closure_68 = importAllResult.memo((onPress) => {
  ...
  obj = { withSpring: opacity(4895).withSpring, opacity, DrawerShadeOpacityPhysics: closure_66 };
  fn.__closure = obj;
...
const memoResult = importAllResult.memo(function VoicePanelUI() {
  ...
  const memo1 = callback2.useMemo(() => {
    ...
    const fn5 = function s() {
      ...
      closure_1_1(closure_1_2[21])(closure_19, { gestureActive: false });
    };
