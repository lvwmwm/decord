...
// Dependencies: [19, 9095, 10434, 676, 685, 21, 4189, 712, 10152, 10153, 4395, 10302, 6718, 3886, 10435, 1236, 10438, 1959, 4185, 10442, 2]

// Module 10433 (LikelyAtoWarningBanner)
...
class LikelyAtoWarningBanner {
  constructor(arg0) {
    ...
    items2[2] = warningId;
    items2[3] = callback;
    f84661 = handleLearnMore.useCallback((cta) => {
    ...
    obj[2] = function onpress() {
      ...
      obj[6] = callback().map((children) => {
        ...
        const items = [callback3(callback(4185).Text, obj, arg1), ];
        obj = { variant: "text-xs/medium", color: "text-subtle", children: children.description };
        items[1] = callback3(callback(4185).Text, obj, arg1);
        obj[0] = items;
