...
// Dependencies: [5, 6694, 5779, 1218, 1372, 1874, 5644, 676, 4254, 1378, 11509, 3, 3890, 1236, 9311, 4041, 1231, 6710, 4197, 6690, 8217, 4040, 15286, 5926, 8359, 5535, 4199, 8917, 698, 4384, 500, 10879, 11, 15284, 5731, 10, 5732, 4865, 12772, 11512, 589, 10868, 9899, 4170, 691, 9522, 8185, 6156, 709, 4395, 1222, 4394, 12988, 2]
// Exports: default

// Module 16736 (onStageConnectionError)
              ...
              if (outer1_16.STAGE_INSTANCE === NumberResult) {
                ...
                if (null == channel_id) {
                  (function onVoiceConnectionError() {
                    let obj = guild_scheduled_event_id(3890);
                    ...
                    obj[2] = guild_scheduled_event_id(9311);
                    obj.open(obj);
                  })();
                  c4 = 3;
                  c4 = 3;
          ...
          if (0 === dependencyMap) {
            ...
            if (arg0 === 1) {
              ...
              if (callback === constants2.PENDING_INCOMING) {
                user_id = lib.user_id;
                lib(4040).navigateToRootTab({ screen: "notifications" });
                const obj8 = lib(4040);
                user_id(15286).setTab(lib(5926).NotificationCenterTabs.ForYou);
                dependencyMap = 2;
                c4 = 1;
            ...
            obj[0] = user_id;
            const items = [callback(5535).PUSH_NOTIFICATION];
            obj[1] = items;
            callback(8359)(obj);
            c4 = 3;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            ...
            if (arg0 === 1) {
              ...
              lib(4197).transitionToChannel(lib.channel_id);
              dependencyMap = 2;
              c4 = 1;
              let obj3 = { value: null, done: false };
              obj3[0] = callback2();
            ...
            obj5[0] = callback(5535).PUSH_NOTIFICATION;
            obj5[1] = lib.guild_id;
            obj5[2] = lib.user_id;
            obj2 = lib(4384);
        ...
        try {
          ...
          if (0 === dependencyMap) {
            ...
            if (arg0 === 1) {
              ...
              navigation = lib(4041).getRootNavigationRef();
              if (null != navigation) {
            ...
            obj = { userId: null, sourceAnalyticsLocations: null };
            obj[0] = user_id;
            const items = [navigation(5535).PUSH_NOTIFICATION];
            obj[1] = items;
            navigation(8359)(obj);
            c4 = 3;
            return { value: "HermesInternal", done: null };
        ...
        try {
          ...
          if (0 === dependencyMap) {
            ...
            if (arg0 === 1) {
              ...
              const result = lib(15284).markNotificationCenterLocalItemsAcked(items);
              const obj10 = lib(15284);
            }
          } else if (arg0 === 1) {
            c4 = 3;
            throw arg1;
...
function receiveNotification_(notif_type) {
  ...
  if ("MESSAGE_CREATE" === notif_type.type) {
    ...
    const messages = importDefault(9899).fetchMessages(obj);
    let flag = true;
    const obj9 = importDefault(9899);
  } else {
    flag = false;
    if ("GENERIC_PUSH_NOTIFICATION_SENT" === notif_type.type) {
      ...
      if (null != notif_type.deeplink) {
        ...
        if ("" !== notif_type.deeplink) {
          const payload = importDefault(4170)(notif_type.deeplink).payload;
          if (payload.type === tmp(691).LinkingTypes.MESSAGE) {
            ...
            if (tmp8) {
              tmp(9522).receivedNotification(payload.messageId, payload.channelId, tracking_type);
              const tmpResult = tmp(9522);
            }
            let tmp37Result = tmp37(9899);
            obj = { guildId: null, channelId: null, messageId: null, isPreload: true };
            ...
            if (payload.type === tmp(691).LinkingTypes.ICYMI) {
              ...
              if (null != notif_type.user_id) {
                ...
                if (null != notif_type.notification_center_id) {
                  ...
                  obj1[1] = tmp(6156).ICYMIItemTypes.CUSTOM_STATUS;
                  ...
                  obj1[3] = obj2;
                  const forStatusNotification = tmp37(8185).fetchForStatusNotification(obj1);
                  flag = false;
                  const tmp37Result1 = tmp37(8185);
                }
              }
            }
          }
  ...
  if (null != notif_type.deeplink) {
    if ("" !== notif_type.deeplink) {
      ...
      obj4[0] = tmp19(4170)(notif_type.deeplink).payload;
      obj4[2] = flag;
      tmp19(12988)(obj4);
    }
  }
    ...
    if (null != data.receiving_user_id) {
      if (null != id.getId()) {
        if (data.receiving_user_id !== obj.getId()) {
          ...
          receiving_user_id = tmp7(11512).switchAccount(receiving_user_id, false, arg1 ? tmp5.PUSH_NOTIFICATION_INITIAL : tmp5.PUSH_NOTIFICATION);
          receiving_user_id.then(() => {
            const Emitter = outer1_1(outer1_3[40]).Emitter;
            Emitter.batched(() => outer1_34(closure_0));
          });
          const tmp7Result2 = tmp7(11512);
        }
      }
      obj = id;
    }
