...
// Module 16457 (onStageConnectionError)
...
function receiveNotification_(type) {
  ...
  function dispatch(self) {
    ...
    if ("MESSAGE_CREATE" === type) {
      ...
      obj1 = { GIFT_CODE_EMBED: null, flexShrink: null, skipMessageFetch: _true };
      ...
      callback().then(() => {
        lib(closure_3[50]).transitionTo(closure_14.CHANNEL(lib.guild_id, lib.channel_id), { GIFT_CODE_EMBED: null, flexShrink: null });
      });
