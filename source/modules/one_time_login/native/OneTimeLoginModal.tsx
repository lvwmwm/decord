...
// Dependencies: [5, 19, 17, 1218, 1923, 676, 1348, 21, 4446, 712, 1629, 1494, 501, 698, 4689, 4300, 1222, 4824, 4828, 7655, 1236, 4828, 6017, 5035, 4265, 13534, 4442, 7662, 2]
// Exports: default

// Module 13533 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  obj = { dark: token(4265).OverlayOpacity.LEVEL_1 };
  obj[6] = obj;
  ...
  const items7 = [callback(callback3, { source: token(13534), style: tmp.logo }), ];
  ...
  items8[1] = callback(token(4442).Text, obj5);
  obj4[1] = items8;
  ...
  const items10 = [callback(token(4442).Text, obj7), ];
  ...
  obj8[3] = callback;
  obj8[4] = tmp.link;
  items10[1] = callback(token(7662).LinkButton, obj8);
  obj6[1] = items10;
