...
// Dependencies: [5, 19, 17, 1218, 1922, 676, 1348, 21, 4668, 712, 1629, 1494, 501, 698, 5265, 4233, 1222, 4663, 4667, 8113, 1236, 4667, 5261, 9128, 4198, 13380, 4739, 8619, 2]
// Exports: default

// Module 13379 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  obj = { dark: token(4198).OverlayOpacity.LEVEL_1 };
  obj[6] = obj;
  ...
  const items7 = [callback(callback3, { source: token(13380), style: tmp.logo }), ];
  ...
  items8[1] = callback(token(4739).Text, obj5);
  obj4[1] = items8;
  ...
  const items10 = [callback(token(4739).Text, obj7), ];
  ...
  obj8[3] = callback;
  obj8[4] = tmp.link;
  items10[1] = callback(token(8619).LinkButton, obj8);
  obj6[1] = items10;
