...
// Dependencies: [5, 19, 17, 1218, 1922, 676, 1348, 21, 4448, 712, 1628, 1493, 501, 698, 4691, 4302, 1222, 4827, 4831, 7676, 1236, 4831, 6020, 5038, 4266, 13568, 4444, 7683, 2]
// Exports: default

// Module 13567 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  obj = { dark: token(4266).OverlayOpacity.LEVEL_1 };
  obj[6] = obj;
  ...
  const items7 = [callback(callback3, { source: token(13568), style: tmp.logo }), ];
  ...
  items8[1] = callback(token(4444).Text, obj5);
  obj4[1] = items8;
  ...
  const items10 = [callback(token(4444).Text, obj7), ];
  ...
  obj8[3] = callback;
  obj8[4] = tmp.link;
  items10[1] = callback(token(7683).LinkButton, obj8);
  obj6[1] = items10;
