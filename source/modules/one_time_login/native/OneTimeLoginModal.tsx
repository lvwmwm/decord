...
// Dependencies: [5, 19, 17, 1218, 1903, 676, 4114, 21, 4302, 712, 1609, 1474, 501, 698, 4507, 4152, 1222, 4642, 4645, 7733, 1236, 4645, 5767, 4846, 4112, 13139, 4298, 8410, 2]
// Exports: default

// Module 13138 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  obj = { dark: null };
  obj[0] = token(4112).OverlayOpacity.LEVEL_1;
  obj[6] = obj;
  const items6 = [callback(importDefault(4846), obj), ];
  let obj1 = { style: tmp.container, children: null };
  let obj2 = { style: tmp.centerContent, children: null };
  const tmp11 = importDefault(4846);
  const items7 = [callback(callback3, { source: token(13139), style: tmp.logo }), ];
  ...
  items8[1] = callback(token(4298).Text, obj5);
  obj4[1] = items8;
  ...
  const items10 = [callback(token(4298).Text, obj7), ];
  ...
  obj8[3] = callback;
  obj8[4] = tmp.link;
  items10[1] = callback(token(8410).LinkButton, obj8);
  obj6[1] = items10;
