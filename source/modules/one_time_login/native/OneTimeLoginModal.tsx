...
// Dependencies: [5, 19, 17, 1218, 1922, 676, 1348, 21, 4445, 712, 1629, 1494, 501, 698, 4676, 4299, 1222, 4811, 4815, 7641, 1236, 4815, 6004, 5022, 4264, 13515, 4441, 7648, 2]
// Exports: default

// Module 13514 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  obj = { dark: token(4264).OverlayOpacity.LEVEL_1 };
  obj[6] = obj;
  ...
  const items7 = [callback(callback3, { source: token(13515), style: tmp.logo }), ];
  ...
  items8[1] = callback(token(4441).Text, obj5);
  obj4[1] = items8;
  ...
  const items10 = [callback(token(4441).Text, obj7), ];
  ...
  obj8[3] = callback;
  obj8[4] = tmp.link;
  items10[1] = callback(token(7648).LinkButton, obj8);
  obj6[1] = items10;
