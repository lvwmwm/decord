...
// Dependencies: [32, 1372, 1932, 4499, 3922, 1931, 1874, 8208, 676, 3867, 1236, 11625, 11, 11630, 12, 11631, 4475, 4124, 2]
...
export const getAutocompleteMode = function getAutocompleteMode(cursorScope, tokens) {
  ...
  if (0 === tokens.length) {
    ...
    let tmp4;
    if (currentToken.type === tmp3(11630).NON_TOKEN_TYPE) {
      tmp4 = currentToken;
    }
