...
// Function ID: 5794
// Name: handleReaction
// Dependencies: [1218, 3892, 4154, 4474, 3894, 589, 709, 2]

// Module 5793 (handleReaction)
  ...
  MESSAGE_UPDATE: function handleMessageUpdate(message) {
    ...
    if (null == id) {
      ...
      if (null == value) {
        ...
        const result = map1.set(id, require(4474) /* createMinimalMessageRecord */.updateMessageRecord(value, message.message));
      }
    }
  },
