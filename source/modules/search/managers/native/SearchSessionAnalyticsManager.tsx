...
// Function ID: 11733
// Name: _initialize
// Dependencies: [8396, 11733, 11711, 2]

// Module 11732 (_initialize)
...
prototype["_initialize"] = function _initialize(searchContext) {
  ...
  const result = locations.set(require(11711) /* SearchTokenTypes */.getSearchContextId(searchContext), arg1);
};
...
prototype["getLocation"] = function getLocation(searchContext) {
  const locations = this.locations;
  return locations.get(require(11711) /* SearchTokenTypes */.getSearchContextId(searchContext));
};
prototype["getSelectedTab"] = function getSelectedTab(searchContext) {
  const selectedTabs = this.selectedTabs;
  return selectedTabs.get(require(11711) /* SearchTokenTypes */.getSearchContextId(searchContext));
};
prototype["setSelectedTab"] = function setSelectedTab(visibleTabs, arg1) {
  const selectedTabs = this.selectedTabs;
  const result = selectedTabs.set(require(11711) /* SearchTokenTypes */.getSearchContextId(visibleTabs), table[arg1]);
};
