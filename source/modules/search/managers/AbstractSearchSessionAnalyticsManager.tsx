...
// Function ID: 11668
// Name: getSession
// Dependencies: [514, 11645, 2]

// Module 11667 (getSession)
...
prototype["getSession"] = function getSession(searchContext) {
  ...
  let value = sessions.get(require(11645) /* SearchTokenTypes */.getSearchContextId(searchContext));
  if (value == null) {
    value = null;
  }
  return value;
...
prototype["deleteSession"] = function deleteSession(searchContext) {
  const sessions = this.sessions;
  sessions.delete(require(11645) /* SearchTokenTypes */.getSearchContextId(searchContext));
};
