...
// Function ID: 11619
// Name: getSession
// Dependencies: [514, 11596, 2]

// Module 11618 (getSession)
...
prototype["getSession"] = function getSession(searchContext) {
  ...
  let value = sessions.get(require(11596) /* SearchTokenTypes */.getSearchContextId(searchContext));
  if (value == null) {
    value = null;
  }
  return value;
...
prototype["deleteSession"] = function deleteSession(searchContext) {
  const sessions = this.sessions;
  sessions.delete(require(11596) /* SearchTokenTypes */.getSearchContextId(searchContext));
};
