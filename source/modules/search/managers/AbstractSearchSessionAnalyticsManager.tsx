...
// Function ID: 11795
// Name: getSession
// Dependencies: [514, 11772, 2]

// Module 11794 (getSession)
...
prototype["getSession"] = function getSession(searchContext) {
  ...
  let value = sessions.get(require(11772) /* SearchTokenTypes */.getSearchContextId(searchContext));
  if (value == null) {
    value = null;
  }
  return value;
...
prototype["deleteSession"] = function deleteSession(searchContext) {
  const sessions = this.sessions;
  sessions.delete(require(11772) /* SearchTokenTypes */.getSearchContextId(searchContext));
};
