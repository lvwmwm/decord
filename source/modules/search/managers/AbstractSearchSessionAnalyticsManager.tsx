...
// Function ID: 11734
// Name: getSession
// Dependencies: [514, 11711, 2]

// Module 11733 (getSession)
...
prototype["getSession"] = function getSession(searchContext) {
  ...
  let value = sessions.get(require(11711) /* SearchTokenTypes */.getSearchContextId(searchContext));
  if (value == null) {
    value = null;
  }
  return value;
...
prototype["deleteSession"] = function deleteSession(searchContext) {
  const sessions = this.sessions;
  sessions.delete(require(11711) /* SearchTokenTypes */.getSearchContextId(searchContext));
};
