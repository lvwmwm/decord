...
// Function ID: 11653
// Name: getSession
// Dependencies: [514, 11630, 2]

// Module 11652 (getSession)
...
prototype["getSession"] = function getSession(searchContext) {
  ...
  let value = sessions.get(require(11630) /* SearchTokenTypes */.getSearchContextId(searchContext));
  if (value == null) {
    value = null;
  }
  return value;
...
prototype["deleteSession"] = function deleteSession(searchContext) {
  const sessions = this.sessions;
  sessions.delete(require(11630) /* SearchTokenTypes */.getSearchContextId(searchContext));
};
