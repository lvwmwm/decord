...
// Function ID: 10114
// Name: getSession
// Dependencies: [514, 10099, 2]

// Module 10113 (getSession)
...
prototype["getSession"] = function getSession(searchContext) {
  ...
  let value = sessions.get(require(10099) /* SearchTokenTypes */.getSearchContextId(searchContext));
  if (value == null) {
    value = null;
  }
  return value;
...
prototype["deleteSession"] = function deleteSession(searchContext) {
  const sessions = this.sessions;
  sessions.delete(require(10099) /* SearchTokenTypes */.getSearchContextId(searchContext));
};
