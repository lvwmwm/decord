// Module ID: 11735
// Function ID: 11736
// Dependencies: [676, 11736, 11711, 11712, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11712) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11712) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11712) /* SearchTokenTypes */;
