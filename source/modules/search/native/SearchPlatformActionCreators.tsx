// Module ID: 11810
// Function ID: 11811
// Dependencies: [676, 11811, 11786, 11787, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11787) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11787) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11787) /* SearchTokenTypes */;
