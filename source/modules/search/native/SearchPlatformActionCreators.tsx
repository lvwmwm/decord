// Module ID: 11794
// Function ID: 11795
// Dependencies: [676, 11795, 11770, 11771, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11771) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11771) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11771) /* SearchTokenTypes */;
