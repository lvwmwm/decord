// Module ID: 11795
// Function ID: 11796
// Dependencies: [676, 11796, 11771, 11772, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11772) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11772) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11772) /* SearchTokenTypes */;
