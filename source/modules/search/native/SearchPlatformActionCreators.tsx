// Module ID: 11668
// Function ID: 11669
// Dependencies: [676, 11669, 11644, 11645, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11645) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11645) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11645) /* SearchTokenTypes */;
