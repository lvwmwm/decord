// Module ID: 11647
// Function ID: 11648
// Dependencies: [676, 11648, 11623, 11624, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11624) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11624) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11624) /* SearchTokenTypes */;
