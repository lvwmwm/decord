// Module ID: 11738
// Function ID: 11739
// Dependencies: [676, 11739, 11714, 11715, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11715) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11715) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11715) /* SearchTokenTypes */;
