// Module ID: 11534
// Function ID: 11535
// Dependencies: [676, 11535, 11510, 11511, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11511) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11511) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11511) /* SearchTokenTypes */;
