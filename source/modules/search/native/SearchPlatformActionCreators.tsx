// Module ID: 11619
// Function ID: 11620
// Dependencies: [676, 11620, 11595, 11596, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11596) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11596) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11596) /* SearchTokenTypes */;
