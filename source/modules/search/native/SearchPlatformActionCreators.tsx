// Module ID: 11584
// Function ID: 11585
// Dependencies: [676, 11585, 10254, 10255, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(10255) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(10255) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(10255) /* SearchTokenTypes */;
