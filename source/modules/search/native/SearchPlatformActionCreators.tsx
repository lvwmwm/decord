// Module ID: 11653
// Function ID: 11654
// Dependencies: [676, 11654, 11629, 11630, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11630) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11630) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11630) /* SearchTokenTypes */;
