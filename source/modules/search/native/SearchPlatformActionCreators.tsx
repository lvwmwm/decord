// Module ID: 11793
// Function ID: 11794
// Dependencies: [676, 11794, 11769, 11770, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(11770) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(11770) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(11770) /* SearchTokenTypes */;
