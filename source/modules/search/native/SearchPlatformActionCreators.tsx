// Module ID: 11456
// Function ID: 11457
// Dependencies: [676, 11457, 10098, 10099, 709, 2]
...
export default {
  ...
  cleanupPeopleTab(closure_0) {
    const searchContextId = require(10099) /* SearchTokenTypes */.getSearchContextId(closure_0);
  ...
  deleteSearchQuery(closure_5) {
    const searchContextId = require(10099) /* SearchTokenTypes */.getSearchContextId(closure_5);
    const obj = require(10099) /* SearchTokenTypes */;
