// Module ID: 15803
// Function ID: 15804
// Dependencies: [19, 17, 21, 4342, 5409, 1351, 4338, 2]
...
const memoResult = importAllResult.memo((text) => {
  ...
  obj = { style: items1, children: jsx(require(4338) /* Text */.Text, obj) };
  items1 = [tmp.container, { paddingBottom: importDefault(5409)({ includeKeyboardHeight: true }).insets.bottom }];
