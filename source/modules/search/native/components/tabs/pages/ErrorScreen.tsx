// Module ID: 15794
// Function ID: 15795
// Dependencies: [19, 17, 21, 4344, 5408, 1351, 4340, 2]
...
const memoResult = importAllResult.memo((text) => {
  ...
  obj = { style: items1, children: jsx(require(4340) /* Text */.Text, obj) };
  items1 = [tmp.container, { paddingBottom: importDefault(5408)({ includeKeyboardHeight: true }).insets.bottom }];
