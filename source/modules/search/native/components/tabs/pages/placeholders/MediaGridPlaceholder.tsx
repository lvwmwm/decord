...
// Dependencies: [19, 17, 8180, 21, 4255, 712, 15584, 4116, 15586, 12, 4251, 1236, 11594, 15587, 2]
// Exports: RecentsMediaGridPlaceholder, default

// Module 15585 (MediaGridPlaceholderItem)
...
export default function MediaGridPlaceholderItem(arg0) {
  ...
  obj[2] = callback(importDefault(15586), { height: size, width: size, style: containerStyle });
