...
// Dependencies: [19, 17, 8403, 21, 4303, 712, 15746, 4042, 15748, 12, 4299, 1236, 11713, 15749, 2]
// Exports: RecentsMediaGridPlaceholder, default

// Module 15747 (MediaGridPlaceholderItem)
...
export default function MediaGridPlaceholderItem(arg0) {
  ...
  obj[2] = callback(importDefault(15748), { height: size, width: size, style: containerStyle });
...
export const RecentsMediaGridPlaceholder = function RecentsMediaGridPlaceholder(visible) {
  ...
  obj3[1] = callback(require(4299) /* Text */.Text, obj4);
