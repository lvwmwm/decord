...
// Dependencies: [31, 27, 9077, 33, 4165, 689, 15450, 4026, 15452, 22, 4161, 1212, 11428, 15453, 2]
// Exports: RecentsMediaGridPlaceholder, default

// Module 15451 (SEARCH_LIST_SECTION_TOP_PADDING)
...
export default function MediaGridPlaceholderItem(arg0) {
  ...
  obj.children = callback(importDefault(15452), { height: size, width: size, style: containerStyle });
...
export const RecentsMediaGridPlaceholder = function RecentsMediaGridPlaceholder(visible) {
  ...
  obj.children = items4;
  return callback2(numRows(4026).View, obj);
};
