...
// Dependencies: [19, 17, 9097, 21, 4189, 712, 15478, 4050, 15480, 12, 4185, 1236, 11448, 15481, 2]
// Exports: RecentsMediaGridPlaceholder, default

// Module 15479 (MediaGridPlaceholderItem)
...
let metroImportAll;
const require = arg1;
({ MEDIA_NUM_COLUMNS: c5, MEDIA_ITEM_GAP_WIDTH: closure_6, SEARCH_LIST_SECTION_TOP_PADDING, SEARCH_LIST_HORIZONTAL_PADDING } = SearchAutocompleteSelectAnalyticsActions);
...
export default function MediaGridPlaceholderItem(arg0) {
  ...
  obj[2] = callback(importDefault(15480), { height: size, width: size, style: containerStyle });
...
export const RecentsMediaGridPlaceholder = function RecentsMediaGridPlaceholder(visible) {
  ...
  obj3[1] = callback(require(4185) /* Text */.Text, obj4);
  ...
  obj[2] = items4;
  return callback2(numRows(4050).View, obj);
};
