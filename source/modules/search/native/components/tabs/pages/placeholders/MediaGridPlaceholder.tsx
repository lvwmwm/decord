...
// Dependencies: [19, 17, 8337, 21, 4302, 712, 15646, 4162, 15648, 12, 4298, 1236, 11643, 15649, 2]
// Exports: RecentsMediaGridPlaceholder, default

// Module 15647 (MediaGridPlaceholderItem)
...
export default function MediaGridPlaceholderItem(arg0) {
  ...
  obj[2] = callback(importDefault(15648), { height: size, width: size, style: containerStyle });
...
export const RecentsMediaGridPlaceholder = function RecentsMediaGridPlaceholder(visible) {
  ...
  obj3[1] = callback(require(4298) /* Text */.Text, obj4);
