...
// Dependencies: [19, 17, 8320, 21, 4285, 712, 15622, 4145, 15624, 12, 4281, 1236, 11628, 15625, 2]
// Exports: RecentsMediaGridPlaceholder, default

// Module 15623 (MediaGridPlaceholderItem)
...
export default function MediaGridPlaceholderItem(arg0) {
  ...
  obj[2] = callback(importDefault(15624), { height: size, width: size, style: containerStyle });
