...
// Dependencies: [19, 17, 11510, 21, 4661, 15778, 589, 15861, 15945, 2]
...
function SearchFreezeContainer(visible) {
  ...
  return closure_5(importDefault(15778), obj);
}
...
const memoResult = require("noop").memo((width) => {
  ...
  obj = { children: null };
  obj = { visible: !stateFromStores, containerStyle, children: callback(importDefault(15861), { searchContext, width: width.width }) };
  const items2 = [callback(SearchFreezeContainer, obj), callback(SearchFreezeContainer, { visible: stateFromStores, containerStyle, children: callback(importDefault(15945), { searchContext }) })];
  obj[0] = items2;
