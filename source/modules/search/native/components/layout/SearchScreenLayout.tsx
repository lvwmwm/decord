...
// Dependencies: [31, 27, 10041, 33, 4131, 15306, 566, 15389, 15473, 2]

// Module 15388 (SearchFreezeContainer)
...
function SearchFreezeContainer(visible) {
  ...
  return callback(importDefault(15306), obj);
}
...
const memoResult = require("result").memo((width) => {
  ...
  obj = {};
  obj = { visible: !stateFromStores, containerStyle, children: callback(importDefault(15389), { searchContext, width: width.width }) };
  const items2 = [callback(SearchFreezeContainer, obj), callback(SearchFreezeContainer, { visible: stateFromStores, containerStyle, children: callback(importDefault(15473), { searchContext }) })];
  obj.children = items2;
