// Module ID: 15946
// Function ID: 15947
// Dependencies: [19, 17, 21, 4668, 15947, 15949, 15956, 2]

// Module 15946
import _modDef15947 from "module_15947" /* 15947 */;
import SearchFilterPrefixRowDefault from "SearchFilterPrefixRow" /* 15949 */;
...
const memoResult = importAllResult.memo(importAllResult.forwardRef((arg0, ref) => {
  ...
  const items2 = [callback(_modDef15947, obj), ];
  ...
  items1[2] = callback(View, { style: tmp.headerControlsRight, children: callback(_modDef15956, { searchContext }) });
  obj[1] = items1;
