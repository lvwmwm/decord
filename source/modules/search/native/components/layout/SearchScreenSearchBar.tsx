// Module ID: 15790
// Function ID: 15791
// Dependencies: [19, 17, 21, 4342, 15791, 15793, 15800, 2]
...
const memoResult = importAllResult.memo(importAllResult.forwardRef((arg0, ref) => {
  ...
  const items2 = [callback(importDefault(15791), obj), ];
  ...
  obj2[3] = items3;
  obj1[1] = callback(importDefault(15793), obj2);
  items2[1] = callback(View, obj1);
  obj[1] = items2;
  items1[1] = closure_4(View, obj);
  const tmp4 = null != backButton && tmp.headerWithBackButton;
  const tmp6 = importDefault;
  const tmp8 = importDefault(15793);
  items1[2] = callback(View, { style: tmp.headerControlsRight, children: callback(importDefault(15800), { searchContext }) });
  obj[1] = items1;
