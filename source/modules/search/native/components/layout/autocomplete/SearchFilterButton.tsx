// Module ID: 15791
// Function ID: 15792
// Dependencies: [19, 8441, 21, 15790, 15785, 1367, 8643, 1236, 7792, 14311, 2]
...
const memoResult = importAllResult.memo((searchContext) => {
  ...
  obj[4] = function children(ref) {
    ...
    obj.size = str;
    obj.icon = outer1_5(searchContext(14311).FiltersHorizontalIcon, { size: "sm", color: "redesign-button-tertiary-text" });
    return outer1_5(searchContext(7792).IconButton, obj);
  };
  return jsx(searchContext(8643).ContextMenu, { items: memo, align: "below", title: null, keyboardShouldPersistTaps: "handled", children: null });
});
