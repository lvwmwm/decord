...
// Dependencies: [19, 17, 21, 4302, 712, 15623, 4157, 15855, 4844, 1236, 5273, 4846, 15400, 15625, 15636, 2]
// Exports: default

// Module 15854 (SearchNavigatorScreen)
...
export default function SearchNavigatorScreen(navigation) {
  ...
  const items1 = [callback(importDefault(4846), { absolute: true, wide: true, tall: true }), ];
  obj = { gesture, children: null };
  const obj1 = { style: items2, children: null };
  items2 = [tmp.wrapper, { paddingTop: importDefault(15855)() }];
  const items3 = [callback(importDefault(15625), { searchContext, suggestionsDismissed: dismissed, setSuggestionsDismissed: setDismissed, onSuggestionsLayoutMesure: onLayoutMeasure, backButton: memo }), ];
  const tmp3 = importDefault(15855)();
  items3[1] = callback(View, { style: tmp.tabs, children: callback(importDefault(15636), { searchContext, width: importDefault(4157)().width }) });
  obj1[1] = items3;
  obj[1] = callback2(View, obj1);
  items1[1] = callback(navigation(15400).NonCollapsableGestureDetector, obj);
  obj[0] = items1;
