...
// Function ID: 15807
// Name: keyExtractor
// Dependencies: [19, 17, 8442, 21, 4344, 15807, 15809, 15810, 15820, 15803, 15822, 15824, 15819, 15811, 15825, 15829, 15830, 15833, 15834, 15835, 15836, 15837, 1628, 15794, 1236, 7786, 2]
...
const memoResult = importAllResult.memo(function SearchList(arg0) {
  ...
  obj1[15] = numColumns;
  items[1] = tmp13(require(7786) /* noop */.AnimatedFlashList, obj1);
  obj[1] = items;
