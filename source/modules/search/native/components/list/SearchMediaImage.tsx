...
// Dependencies: [32, 19, 17, 1387, 6128, 676, 21, 4478, 4413, 1363, 6142, 10879, 5030, 4918, 1492, 11584, 500, 1236, 8880, 10260, 1399, 6174, 8568, 589, 10213, 10279, 2]
...
// Module 16249 (SearchMediaObscurityIcon)
import closure_3 from "_slicedToArray" /* 32 */;
import importAllResult from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import closure_8 from "ensureGuildLoaded" /* 1387 */;
import closure_9 from "handleReaction" /* 6128 */;
  ...
  if (null != mediaUrl) {
    if (null != mediaHeight) {
      if (null != mediaWidth) {
        ...
        let obj2 = containerHeight(11584);
        ...
        obj5[4] = stringResult;
        const items4 = [callback2(containerHeight(8880).ImageWithPlaceholder, obj5), tmp12];
        obj4[1] = items4;
...
export const SearchEmbedMediaImage = function SearchEmbedMediaImage(embed) {
  ...
  closure_4 = embed(6174).useIsChannelSpoilerGated(store.getChannel(channelId));
  const obj2 = embed(6174);
  const tmp2 = embed;
...
export const SearchSoundMediaImage = function SearchSoundMediaImage(height) {
  ...
  obj[0] = items1;
  obj[1] = callback2(height(10213).CirclePlayIcon, { size: "lg", color: "interactive-text-default" });
...
export const SearchFileMediaImage = function SearchFileMediaImage(height) {
  ...
  obj[0] = items1;
  obj[1] = callback2(height(10279).AttachmentIcon, { fileName });
  return callback2(closure_7, obj);
};
