...
// Dependencies: [19, 17, 4295, 1375, 1372, 1891, 4499, 676, 21, 4303, 712, 589, 4764, 4494, 1297, 4299, 9821, 9960, 9131, 4146, 8309, 15745, 12564, 15746, 4532, 8070, 5944, 15727, 1236, 9789, 3979, 2]

// Module 15744 (GuildChannelMessageRowHeader)
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  if ("username" === stateFromStores) {
    ...
    if (message.isPoll()) {
      ...
      tmp21Result = tmp21(importDefault(15746), obj6);
    }
