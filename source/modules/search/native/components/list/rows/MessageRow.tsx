...
// Dependencies: [19, 17, 4336, 1394, 1391, 1910, 4539, 676, 21, 4344, 712, 589, 4804, 4534, 1297, 4340, 9868, 10007, 9177, 4189, 8353, 15826, 12629, 15827, 4572, 8111, 5985, 15808, 1236, 9836, 4039, 2]

// Module 15825 (GuildChannelMessageRowHeader)
...
function GuildChannelMessageRowHeader(channel) {
  ...
  const items1 = [callback(channel(1297).Icon, obj1), callback(channel(4340).Text, { lineClamp: 1, variant: "text-sm/semibold", color: "interactive-text-default", children: importDefault(4534)(channel) }), , , ];
  if (muted) {
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  ({ colorString, colorStrings } = importDefault(4572)(message));
  if ("username" === stateFromStores) {
    ...
    if (message.isPoll()) {
      ...
      tmp21Result = tmp21(importDefault(15827), obj6);
    }
