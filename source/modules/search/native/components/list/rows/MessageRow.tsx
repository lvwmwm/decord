...
// Dependencies: [19, 17, 4277, 1375, 1372, 1891, 4480, 676, 21, 4285, 712, 589, 4745, 4475, 1297, 4281, 9739, 9878, 9054, 4123, 8232, 15646, 12479, 15647, 4513, 7993, 5865, 15628, 1236, 9707, 3962, 2]

// Module 15645 (GuildChannelMessageRowHeader)
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  if ("username" === stateFromStores) {
    ...
    if (message.isPoll()) {
      ...
      tmp21Result = tmp21(importDefault(15647), obj6);
    }
