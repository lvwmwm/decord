...
// Dependencies: [19, 17, 4295, 1375, 1372, 1891, 4499, 676, 21, 4303, 712, 589, 4764, 4494, 1297, 4299, 9822, 9961, 9131, 4146, 8309, 15753, 12566, 15754, 4532, 8070, 5944, 15735, 1236, 9790, 3979, 2]

// Module 15752 (GuildChannelMessageRowHeader)
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  if ("username" === stateFromStores) {
    ...
    if (message.isPoll()) {
      ...
      tmp21Result = tmp21(importDefault(15754), obj6);
    }
