...
// Dependencies: [19, 17, 4295, 1394, 1391, 1910, 4499, 676, 21, 4303, 712, 589, 4764, 4494, 1297, 4299, 9827, 9966, 9137, 4148, 8314, 15770, 12570, 15771, 4532, 8072, 5946, 15752, 1236, 9795, 3998, 2]

// Module 15769 (GuildChannelMessageRowHeader)
...
function GuildChannelMessageRowHeader(channel) {
  ...
  const items1 = [callback(channel(1297).Icon, obj1), callback(channel(4299).Text, { lineClamp: 1, variant: "text-sm/semibold", color: "interactive-text-default", children: importDefault(4494)(channel) }), , , ];
  if (muted) {
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  ({ colorString, colorStrings } = importDefault(4532)(message));
  if ("username" === stateFromStores) {
    ...
    if (message.isPoll()) {
      ...
      tmp21Result = tmp21(importDefault(15771), obj6);
    }
