...
// Dependencies: [19, 17, 4247, 1375, 1372, 1862, 4450, 676, 21, 4255, 712, 589, 4715, 4445, 1297, 4251, 9708, 9847, 9025, 4094, 8091, 15608, 12442, 15609, 4483, 7852, 5838, 15590, 1236, 9676, 3933, 2]

// Module 15607 (GuildChannelMessageRowHeader)
...
function GuildChannelMessageRowHeader(channel) {
  ...
  const items1 = [callback(channel(1297).Icon, obj1), callback(channel(4251).Text, { lineClamp: 1, variant: "text-sm/semibold", color: "interactive-text-default", children: importDefault(4445)(channel) }), , , ];
  if (muted) {
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  ({ colorString, colorStrings } = importDefault(4483)(message));
  if ("username" === stateFromStores) {
    ...
    if (message.isPoll()) {
      ...
      tmp21Result = tmp21(importDefault(15609), obj6);
    }
