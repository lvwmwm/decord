...
// Dependencies: [19, 17, 4334, 1394, 1391, 1910, 4550, 676, 21, 4342, 712, 589, 4827, 4535, 1297, 4338, 9882, 10016, 9195, 4187, 8379, 15844, 12648, 15845, 4595, 8136, 6008, 15826, 1236, 9850, 4039, 2]

// Module 15843 (GuildChannelMessageRowHeader)
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  ({ colorString, colorStrings } = importDefault(4595)(message));
  if ("username" === stateFromStores) {
    ...
    if (message.isPoll()) {
      ...
      tmp21Result = tmp21(importDefault(15845), obj6);
    }
