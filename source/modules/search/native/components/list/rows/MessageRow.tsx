...
// Dependencies: [19, 17, 4294, 1375, 1372, 1891, 4497, 676, 21, 4302, 712, 589, 4762, 4492, 1297, 4298, 9755, 9894, 9071, 4140, 8249, 15670, 12494, 15671, 4530, 8010, 5884, 15652, 1236, 9723, 3979, 2]

// Module 15669 (GuildChannelMessageRowHeader)
...
function GuildChannelMessageRowHeader(channel) {
  ...
  const items1 = [callback(channel(1297).Icon, obj1), callback(channel(4298).Text, { lineClamp: 1, variant: "text-sm/semibold", color: "interactive-text-default", children: importDefault(4492)(channel) }), , , ];
  if (muted) {
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  ({ colorString, colorStrings } = importDefault(4530)(message));
  if ("username" === stateFromStores) {
    ...
    if (message.isPoll()) {
      ...
      tmp21Result = tmp21(importDefault(15671), obj6);
    }
