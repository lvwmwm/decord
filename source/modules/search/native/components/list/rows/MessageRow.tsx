...
// Dependencies: [19, 17, 4334, 1394, 1391, 1910, 4540, 676, 21, 4342, 712, 589, 4805, 4535, 1297, 4338, 9871, 10005, 9181, 4187, 8357, 15835, 12629, 15836, 4573, 8115, 5987, 15817, 1236, 9839, 4039, 2]

// Module 15834 (GuildChannelMessageRowHeader)
...
function GuildChannelMessageRowHeader(channel) {
  ...
  const items1 = [callback(channel(1297).Icon, obj1), callback(channel(4338).Text, { lineClamp: 1, variant: "text-sm/semibold", color: "interactive-text-default", children: importDefault(4535)(channel) }), , , ];
  if (muted) {
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  ({ colorString, colorStrings } = importDefault(4573)(message));
  if ("username" === stateFromStores) {
    ...
    if (message.isPoll()) {
      ...
      tmp21Result = tmp21(importDefault(15836), obj6);
    }
