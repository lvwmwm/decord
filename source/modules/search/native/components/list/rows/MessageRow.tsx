...
// Dependencies: [19, 17, 4662, 1394, 1391, 1910, 5043, 676, 21, 4661, 712, 589, 6832, 4984, 1297, 4734, 10086, 10221, 9462, 4219, 8418, 15894, 12726, 15895, 4814, 8186, 5267, 15876, 1236, 10050, 4071, 2]
...
function GuildChannelMessageRowHeader(channel) {
  ...
  const items1 = [callback(channel(1297).Icon, obj1), callback(channel(4734).Text, { lineClamp: 1, variant: "text-sm/semibold", color: "interactive-text-default", children: importDefault(4984)(channel) }), , , ];
  if (muted) {
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  ({ colorString, colorStrings } = importDefault(4814)(message));
  if ("username" === stateFromStores) {
    ...
    if (message.isPoll()) {
      ...
      tmp21Result = tmp21(importDefault(15895), obj6);
    }
