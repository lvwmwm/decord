...
// Dependencies: [19, 17, 1396, 8442, 21, 9842, 4189, 1236, 4344, 589, 15812, 5188, 5182, 15813, 15815, 11723, 2]

// Module 15811 (GuildVoiceChannelSubtitle)
...
function GuildVoiceChannelExtras(arg0) {
  ...
  ({ channel, users } = arg0);
  const tmp = callback();
  require(5188) /* useStageParticipants */;
  ...
  if (tmp5Result) {
    ...
    obj[3] = closure_6;
    obj[4] = tmp4;
    obj[1] = tmp5(importDefault(15813), obj);
...
const memoResult = importAllResult.memo(function GuildVoiceChannelRow(channel) {
  ...
  if (null == trailing) {
    ...
    obj[0] = channel;
    obj[1] = voiceStates;
    obj[1] = tmp4(channel(11723).VocalChannelJoinButton, obj);
    trailing = tmp4(View, obj);
  }
  obj[4] = trailing;
  obj[5] = <GuildVoiceChannelExtras channel={channel} voiceStates={voiceStates} users={mapped} />;
  return jsx(onPress(15815), { onPress: callback, voiceStates, channel, subtitle: null, trailing: null, extras: null });
});
