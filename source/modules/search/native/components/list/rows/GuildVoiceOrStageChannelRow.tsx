...
// Dependencies: [19, 17, 1396, 8446, 21, 9845, 4187, 1236, 4342, 589, 15812, 5189, 5183, 15813, 15815, 11722, 2]
...
function GuildVoiceChannelExtras(arg0) {
  ...
  ({ channel, users } = arg0);
  const tmp = callback();
  require(5189) /* useStageParticipants */;
...
const memoResult = importAllResult.memo(function GuildVoiceChannelRow(channel) {
  ...
  if (null == trailing) {
    ...
    obj[0] = channel;
    obj[1] = voiceStates;
    obj[1] = tmp4(channel(11722).VocalChannelJoinButton, obj);
