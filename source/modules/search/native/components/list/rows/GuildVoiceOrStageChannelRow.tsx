...
// Module 15215 (GuildVoiceChannelSubtitle)
...
let closure_8 = arg1(dependencyMap[8]).createStyles({ users: { marginTop: 4 }, subtitle: { marginEnd: 16 }, trailing: { "Bool(true)": "<string:1124139010>", "Bool(true)": "f14c54685496e4b330372e883666fa1c", "Bool(true)": "ko.messages.f14c54685496e4b330372e883666fa1c.compiled.messages" } });
