...
// Dependencies: [19, 17, 9281, 21, 4255, 712, 4446, 15587, 4716, 15589, 15579, 2]

// Module 15586 (GuildChannelLabel)
...
function GuildChannelLabel(channel) {
  ...
  obj[1] = require(15587) /* ChannelContentComponent */.renderChannelContent(obj);
...
const memoResult = require("noop").memo(function GuildChannelRow(channel) {
  ...
  const tmp2 = callback();
  let obj = require(15589) /* LaunchpadChannelIcon */;
  ...
  obj[1] = require(4716) /* getChannelIcon */.getSimpleChannelIcon(channel);
  const obj3 = require(4716) /* getChannelIcon */;
  obj = {};
  ...
  obj.extras = extras;
  return jsx(require(15579) /* SearchListRow */.SearchListRow, {});
});
