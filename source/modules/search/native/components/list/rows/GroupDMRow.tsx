...
// Function ID: 16151
// Name: GroupDMRow
// Dependencies: [19, 21, 4639, 10568, 1297, 10569, 4441, 16149, 2]
// Exports: default

// Module 16150 (GroupDMRow)
...
export default function GroupDMRow(channel) {
  ...
  const tmp4 = onPress(10568);
  const tmp6 = jsx(onPress(10568), { size: channel(1297).AvatarSizes.LARGE_48, channel });
  const recipientsLabel = channel(10569).useRecipientsLabel(channel);
  let tmp3Result;
  if (null != recipientsLabel) {
    obj = { variant: "text-xs/medium", color: "text-muted", lineClamp: 1, children: null };
    obj[3] = recipientsLabel;
    tmp3Result = tmp3(tmp5(4441).Text, obj);
  }
  let str2 = str;
  if (str == null) {
    str2 = "";
  ...
  return jsx(channel(16149).SearchListRow, { label: str2, icon: tmp6, onPress: callback, accessibilityLabel: null, subLabel: null, trailing: null, accessibilityActions: null, onAccessibilityAction: null });
};
