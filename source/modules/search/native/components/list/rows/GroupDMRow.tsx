...
// Function ID: 16203
// Name: GroupDMRow
// Dependencies: [19, 21, 4642, 10610, 1297, 10611, 4444, 16201, 2]
// Exports: default

// Module 16202 (GroupDMRow)
...
export default function GroupDMRow(channel) {
  ...
  const tmp4 = onPress(10610);
  const tmp6 = jsx(onPress(10610), { size: channel(1297).AvatarSizes.LARGE_48, channel });
  const recipientsLabel = channel(10611).useRecipientsLabel(channel);
  let tmp3Result;
  if (null != recipientsLabel) {
    obj = { variant: "text-xs/medium", color: "text-muted", lineClamp: 1, children: null };
    obj[3] = recipientsLabel;
    tmp3Result = tmp3(tmp5(4444).Text, obj);
  }
  let str2 = str;
  if (str == null) {
    str2 = "";
  ...
  return jsx(channel(16201).SearchListRow, { label: str2, icon: tmp6, onPress: callback, accessibilityLabel: null, subLabel: null, trailing: null, accessibilityActions: null, onAccessibilityAction: null });
};
