...
// Function ID: 15514
// Name: GroupDMRow
// Dependencies: [19, 21, 4384, 9101, 1297, 9102, 4189, 15512, 2]
// Exports: default
...
export default function GroupDMRow(channel) {
  ...
  obj[1] = channel;
  const tmp4 = onPress(9101);
  const tmp6 = jsx(onPress(9101), { size: null, channel: null });
  const recipientsLabel = channel(9102).useRecipientsLabel(channel);
  let tmp3Result;
  if (null != recipientsLabel) {
    obj = { variant: "text-xs/medium", color: "text-muted", lineClamp: 1, children: null };
    obj[3] = recipientsLabel;
    tmp3Result = tmp3(tmp5(4189).Text, obj);
  }
  let str2 = str;
  if (str == null) {
    str2 = "";
  ...
  return jsx(channel(15512).SearchListRow, { label: str2, icon: tmp6, onPress: callback, accessibilityLabel: null, subLabel: null, trailing: null, accessibilityActions: null, onAccessibilityAction: null });
};
