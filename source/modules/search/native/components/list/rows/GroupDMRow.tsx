...
// Function ID: 15654
// Name: GroupDMRow
// Dependencies: [19, 21, 4492, 9598, 1297, 9599, 4298, 15652, 2]
// Exports: default

// Module 15653 (GroupDMRow)
...
export default function GroupDMRow(channel) {
  ...
  obj[1] = channel;
  const tmp4 = onPress(9598);
  const tmp6 = jsx(onPress(9598), { size: null, channel: null });
  const recipientsLabel = channel(9599).useRecipientsLabel(channel);
  let tmp3Result;
  if (null != recipientsLabel) {
    obj = { variant: "text-xs/medium", color: "text-muted", lineClamp: 1, children: null };
    obj[3] = recipientsLabel;
    tmp3Result = tmp3(tmp5(4298).Text, obj);
  }
  let str2 = str;
  if (str == null) {
    str2 = "";
  ...
  return jsx(channel(15652).SearchListRow, { label: str2, icon: tmp6, onPress: callback, accessibilityLabel: null, subLabel: null, trailing: null, accessibilityActions: null, onAccessibilityAction: null });
};
