...
// Function ID: 15630
// Name: GroupDMRow
// Dependencies: [19, 21, 4475, 9582, 1297, 9583, 4281, 15628, 2]
// Exports: default

// Module 15629 (GroupDMRow)
...
export default function GroupDMRow(channel) {
  ...
  return jsx(channel(15628).SearchListRow, { label: str2, icon: tmp6, onPress: callback, accessibilityLabel: null, subLabel: null, trailing: null, accessibilityActions: null, onAccessibilityAction: null });
};
