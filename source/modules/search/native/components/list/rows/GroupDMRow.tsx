...
// Function ID: 15810
// Name: GroupDMRow
// Dependencies: [19, 21, 4535, 9712, 1297, 9713, 4338, 15808, 2]
// Exports: default
...
export default function GroupDMRow(channel) {
  ...
  obj[1] = channel;
  const tmp4 = onPress(9712);
  const tmp6 = jsx(onPress(9712), { size: null, channel: null });
  const recipientsLabel = channel(9713).useRecipientsLabel(channel);
  let tmp3Result;
