...
// Dependencies: [19, 17, 21, 4302, 712, 1297, 4298, 4140, 4492, 9598, 4814, 1236, 4762, 5375, 2]
// Exports: SearchListCardContainer, SearchListCardContent, SearchListCardFooter, SearchListCardThumbnail

// Module 15667 (SearchListContentAuthor)
...
function SearchListPrivateChannel(channel) {
  ...
  if (channel.isGroupDM()) {
    ...
    obj[1] = callback(importDefault(9598), obj);
    ...
    const tmp2Result = importDefault(9598);
  } else {
    obj[0] = tmp.privateChannelIcon;
    const obj2 = { style: null, size: "xs", color: "interactive-text-default" };
    obj2[0] = tmp.icon;
    const items1 = [callback(require(4814) /* ForumIcon */.ForumIcon, obj2), ];
...
export const SearchListCardContainer = function SearchListCardContainer(arg0) {
  ...
  return callback(require(5375) /* PressableCard */.Card, { shadow: "low", border: "subtle", onPress, style, children });
};
...
export const SearchListCardContent = function SearchListCardContent(arg0) {
  ...
  if (typeof subLabel === "string") {
    ...
    obj[3] = subLabel;
    tmp4 = callback(require(4298) /* Text */.Text, obj);
  }
  items[1] = tmp4;
  obj[1] = items;
