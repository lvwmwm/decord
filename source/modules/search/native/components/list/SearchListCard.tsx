...
// Dependencies: [19, 17, 21, 4285, 712, 1297, 4281, 4123, 4475, 9582, 4797, 1236, 4745, 5356, 2]
// Exports: SearchListCardContainer, SearchListCardContent, SearchListCardFooter, SearchListCardThumbnail

// Module 15643 (SearchListContentAuthor)
...
function SearchListPrivateChannel(channel) {
  ...
  if (channel.isGroupDM()) {
    ...
    obj[1] = callback(importDefault(9582), obj);
    ...
    const tmp2Result = importDefault(9582);
  } else {
    obj[0] = tmp.privateChannelIcon;
    const obj2 = { style: null, size: "xs", color: "interactive-text-default" };
    obj2[0] = tmp.icon;
    const items1 = [callback(require(4797) /* ForumIcon */.ForumIcon, obj2), ];
...
export const SearchListCardContainer = function SearchListCardContainer(arg0) {
  ...
  return callback(require(5356) /* PressableCard */.Card, { shadow: "low", border: "subtle", onPress, style, children });
};
