...
// Dependencies: [19, 17, 21, 4255, 712, 1297, 4251, 4094, 4445, 9553, 4767, 1236, 4715, 5302, 2]
// Exports: SearchListCardContainer, SearchListCardContent, SearchListCardFooter, SearchListCardThumbnail

// Module 15605 (SearchListContentAuthor)
...
function SearchListPrivateChannel(channel) {
  ...
  if (channel.isGroupDM()) {
    ...
    obj[1] = callback(importDefault(9553), obj);
    ...
    const tmp2Result = importDefault(9553);
  } else {
    obj[0] = tmp.privateChannelIcon;
    const obj2 = { style: null, size: "xs", color: "interactive-text-default" };
    obj2[0] = tmp.icon;
    const items1 = [callback(require(4767) /* ForumIcon */.ForumIcon, obj2), ];
...
export const SearchListCardContainer = function SearchListCardContainer(arg0) {
  ...
  return callback(require(5302) /* PressableCard */.Card, { shadow: "low", border: "subtle", onPress, style, children });
};
