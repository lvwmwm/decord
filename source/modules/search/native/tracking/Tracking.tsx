// Module ID: 11650
// Function ID: 11651
// Dependencies: [1372, 11629, 8319, 676, 11651, 11630, 4479, 514, 3957, 2]
...
export default {
  trackSearchOpened(arg0) {
    ...
    let obj = importDefault(11651);
    obj.initialize(searchContext, searchLocation);
    const channelIdFromSearchContext = require(11630) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
    const channel = store.getChannel(channelIdFromSearchContext);
    const obj2 = require(11630) /* SearchTokenTypes */;
    ...
    obj[0] = importDefault(11651).getSessionId(searchContext);
    obj[1] = searchLocation;
    const obj5 = importDefault(11651);
    obj[2] = require(11630) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
  ...
  trackSearchStarted(searchContext) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      importDefault(11651).refreshQueryId(searchContext);
      const obj2 = importDefault(11651);
      const channelIdFromSearchContext = require(11630) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
      const channel = store.getChannel(channelIdFromSearchContext);
      const obj3 = require(11630) /* SearchTokenTypes */;
      ...
      obj[0] = importDefault(11651).getSessionId(searchContext);
      const obj6 = importDefault(11651);
      obj[1] = importDefault(11651).getQueryId(searchContext);
      const obj7 = importDefault(11651);
      obj[2] = importDefault(11651).getLocation(searchContext);
      const obj8 = importDefault(11651);
      obj[3] = require(11630) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
      ...
      const obj9 = require(11630) /* SearchTokenTypes */;
    }
  },
  trackSearchResultClicked(arg0) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      const guildIdFromSearchContext = require(11630) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
      const obj2 = require(11630) /* SearchTokenTypes */;
      const channelIdFromSearchContext = require(11630) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
      const channel = store.getChannel(channelIdFromSearchContext);
      ...
      obj[0] = importDefault(11651).getSessionId(searchContext);
      const obj6 = importDefault(11651);
      obj[1] = importDefault(11651).getLocation(searchContext);
      const obj7 = importDefault(11651);
      obj[2] = importDefault(11651).getQueryId(searchContext);
      obj[3] = str.trim().length;
      obj[4] = str2.trim().length;
      const obj8 = importDefault(11651);
      obj[5] = importDefault(11651).getSelectedTab(searchContext);
      obj[6] = index;
      const obj9 = importDefault(11651);
  ...
  trackSearchResultReturned(searchContext) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      ...
      const obj8 = importDefault(11651);
      obj[13] = require(3957) /* explicitContentFromProto */.SearchResultExactCountEnabled.getSetting();
      obj[14] = guildIdFromSearchContext;
      obj[15] = channelIdFromSearchContext;
      let type;
      if (channel != null) {
      ...
      const SearchResultExactCountEnabled = require(3957) /* explicitContentFromProto */.SearchResultExactCountEnabled;
    }
  },
  ...
  trackSearchClosed(searchContext) {
    importDefault(11651).terminate(searchContext.searchContext);
  },
  trackSearchIndexing(searchContext) {
    ...
    obj[2] = importDefault(11651).getSelectedTab(searchContext);
    const obj3 = importDefault(11651);
    obj[3] = importDefault(11651).getLocation(searchContext);
    const obj4 = importDefault(11651);
    obj[4] = importDefault(11651).getSessionId(searchContext);
    const obj5 = importDefault(11651);
    obj[5] = importDefault(11651).getQueryId(searchContext);
  ...
  trackSearchHistoryClicked(searchContext) {
    ...
    obj[0] = importDefault(11651).getSelectedTab(searchContext);
    const obj3 = importDefault(11651);
    obj[1] = importDefault(11651).getLocation(searchContext);
    const obj4 = importDefault(11651);
    obj[2] = importDefault(11651).getSessionId(searchContext);
    let type;
    if (channel != null) {
      type = channel.type;
    }
  ...
  trackSearchFilterAdd(location) {
    ...
    obj[2] = importDefault(11651).getSessionId(searchContext);
    const obj5 = importDefault(11651);
    obj[3] = importDefault(11651).getQueryId(searchContext);
    let str = "filter_from";
