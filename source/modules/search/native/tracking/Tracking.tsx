// Module ID: 11731
// Function ID: 11732
// Dependencies: [1372, 11710, 8396, 676, 11732, 11711, 4498, 514, 3974, 2]
...
export default {
  trackSearchOpened(arg0) {
    ...
    const channelIdFromSearchContext = require(11711) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
    const channel = store.getChannel(channelIdFromSearchContext);
    const obj2 = require(11711) /* SearchTokenTypes */;
    ...
    obj[0] = importDefault(11732).getSessionId(searchContext);
    obj[1] = searchLocation;
    const obj5 = importDefault(11732);
    obj[2] = require(11711) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
  ...
  trackSearchStarted(searchContext) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      importDefault(11732).refreshQueryId(searchContext);
      const obj2 = importDefault(11732);
      const channelIdFromSearchContext = require(11711) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
      const channel = store.getChannel(channelIdFromSearchContext);
      const obj3 = require(11711) /* SearchTokenTypes */;
      ...
      obj[0] = importDefault(11732).getSessionId(searchContext);
      const obj6 = importDefault(11732);
      obj[1] = importDefault(11732).getQueryId(searchContext);
      const obj7 = importDefault(11732);
      obj[2] = importDefault(11732).getLocation(searchContext);
      const obj8 = importDefault(11732);
      obj[3] = require(11711) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
      ...
      const obj9 = require(11711) /* SearchTokenTypes */;
    }
  },
  trackSearchResultClicked(arg0) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      const guildIdFromSearchContext = require(11711) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
      const obj2 = require(11711) /* SearchTokenTypes */;
      const channelIdFromSearchContext = require(11711) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
      const channel = store.getChannel(channelIdFromSearchContext);
      ...
      obj[0] = importDefault(11732).getSessionId(searchContext);
      const obj6 = importDefault(11732);
      obj[1] = importDefault(11732).getLocation(searchContext);
      const obj7 = importDefault(11732);
      obj[2] = importDefault(11732).getQueryId(searchContext);
      obj[3] = str.trim().length;
      obj[4] = str2.trim().length;
      const obj8 = importDefault(11732);
      obj[5] = importDefault(11732).getSelectedTab(searchContext);
      obj[6] = index;
      const obj9 = importDefault(11732);
  ...
  trackSearchClosed(searchContext) {
    importDefault(11732).terminate(searchContext.searchContext);
  },
  trackSearchIndexing(searchContext) {
    ...
    obj[2] = importDefault(11732).getSelectedTab(searchContext);
    const obj3 = importDefault(11732);
    obj[3] = importDefault(11732).getLocation(searchContext);
    const obj4 = importDefault(11732);
    obj[4] = importDefault(11732).getSessionId(searchContext);
    const obj5 = importDefault(11732);
    obj[5] = importDefault(11732).getQueryId(searchContext);
  ...
  trackSearchHistoryClicked(searchContext) {
    ...
    obj[0] = importDefault(11732).getSelectedTab(searchContext);
    const obj3 = importDefault(11732);
    obj[1] = importDefault(11732).getLocation(searchContext);
    const obj4 = importDefault(11732);
    obj[2] = importDefault(11732).getSessionId(searchContext);
    let type;
    if (channel != null) {
      type = channel.type;
    }
  ...
  trackSearchFilterAdd(location) {
    ...
    obj[2] = importDefault(11732).getSessionId(searchContext);
    const obj5 = importDefault(11732);
    obj[3] = importDefault(11732).getQueryId(searchContext);
    let str = "filter_from";
