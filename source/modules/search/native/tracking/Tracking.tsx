// Module ID: 11616
// Function ID: 11617
// Dependencies: [1372, 11595, 8179, 676, 11617, 11596, 4449, 514, 3928, 2]
...
export default {
  trackSearchOpened(arg0) {
    ...
    let obj = importDefault(11617);
    obj.initialize(searchContext, searchLocation);
    const channelIdFromSearchContext = require(11596) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
    const channel = store.getChannel(channelIdFromSearchContext);
    const obj2 = require(11596) /* SearchTokenTypes */;
    ...
    obj[0] = importDefault(11617).getSessionId(searchContext);
    obj[1] = searchLocation;
    const obj5 = importDefault(11617);
    obj[2] = require(11596) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
  ...
  trackSearchStarted(searchContext) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      importDefault(11617).refreshQueryId(searchContext);
      const obj2 = importDefault(11617);
      const channelIdFromSearchContext = require(11596) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
      const channel = store.getChannel(channelIdFromSearchContext);
      const obj3 = require(11596) /* SearchTokenTypes */;
      ...
      const obj4 = importDefault(4449);
      obj[0] = importDefault(11617).getSessionId(searchContext);
      const obj6 = importDefault(11617);
      obj[1] = importDefault(11617).getQueryId(searchContext);
      const obj7 = importDefault(11617);
      obj[2] = importDefault(11617).getLocation(searchContext);
      const obj8 = importDefault(11617);
      obj[3] = require(11596) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
      ...
      const obj9 = require(11596) /* SearchTokenTypes */;
    }
  },
  trackSearchResultClicked(arg0) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      const guildIdFromSearchContext = require(11596) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
      const obj2 = require(11596) /* SearchTokenTypes */;
      const channelIdFromSearchContext = require(11596) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
      const channel = store.getChannel(channelIdFromSearchContext);
      ...
      obj[0] = importDefault(11617).getSessionId(searchContext);
      const obj6 = importDefault(11617);
      obj[1] = importDefault(11617).getLocation(searchContext);
      const obj7 = importDefault(11617);
      obj[2] = importDefault(11617).getQueryId(searchContext);
      obj[3] = str.trim().length;
      obj[4] = str2.trim().length;
      const obj8 = importDefault(11617);
      obj[5] = importDefault(11617).getSelectedTab(searchContext);
      obj[6] = index;
      const obj9 = importDefault(11617);
  ...
  trackSearchClosed(searchContext) {
    importDefault(11617).terminate(searchContext.searchContext);
  },
  trackSearchIndexing(searchContext) {
    ...
    obj[2] = importDefault(11617).getSelectedTab(searchContext);
    const obj3 = importDefault(11617);
    obj[3] = importDefault(11617).getLocation(searchContext);
    const obj4 = importDefault(11617);
    obj[4] = importDefault(11617).getSessionId(searchContext);
    const obj5 = importDefault(11617);
    obj[5] = importDefault(11617).getQueryId(searchContext);
  ...
  trackSearchHistoryClicked(searchContext) {
    ...
    obj[0] = importDefault(11617).getSelectedTab(searchContext);
    const obj3 = importDefault(11617);
    obj[1] = importDefault(11617).getLocation(searchContext);
    const obj4 = importDefault(11617);
    obj[2] = importDefault(11617).getSessionId(searchContext);
    let type;
    if (channel != null) {
      type = channel.type;
    }
  ...
  trackSearchFilterAdd(location) {
    ...
    obj[2] = importDefault(11617).getSessionId(searchContext);
    const obj5 = importDefault(11617);
    obj[3] = importDefault(11617).getQueryId(searchContext);
    let str = "filter_from";
