// Module ID: 11665
// Function ID: 11666
// Dependencies: [1372, 11644, 8336, 676, 11666, 11645, 4496, 514, 3974, 2]
...
export default {
  trackSearchOpened(arg0) {
    ...
    let obj = importDefault(11666);
    obj.initialize(searchContext, searchLocation);
    const channelIdFromSearchContext = require(11645) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
    ...
    obj[0] = importDefault(11666).getSessionId(searchContext);
    obj[1] = searchLocation;
    const obj5 = importDefault(11666);
    obj[2] = require(11645) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
  ...
  trackSearchStarted(searchContext) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      importDefault(11666).refreshQueryId(searchContext);
      const obj2 = importDefault(11666);
      const channelIdFromSearchContext = require(11645) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
      const channel = store.getChannel(channelIdFromSearchContext);
      const obj3 = require(11645) /* SearchTokenTypes */;
      ...
      const obj4 = importDefault(4496);
      obj[0] = importDefault(11666).getSessionId(searchContext);
      const obj6 = importDefault(11666);
      obj[1] = importDefault(11666).getQueryId(searchContext);
      const obj7 = importDefault(11666);
      obj[2] = importDefault(11666).getLocation(searchContext);
      const obj8 = importDefault(11666);
      obj[3] = require(11645) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
      ...
      const obj9 = require(11645) /* SearchTokenTypes */;
    }
  },
  trackSearchResultClicked(arg0) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      const guildIdFromSearchContext = require(11645) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
      const obj2 = require(11645) /* SearchTokenTypes */;
      const channelIdFromSearchContext = require(11645) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
      const channel = store.getChannel(channelIdFromSearchContext);
      ...
      obj[0] = importDefault(11666).getSessionId(searchContext);
      const obj6 = importDefault(11666);
      obj[1] = importDefault(11666).getLocation(searchContext);
      const obj7 = importDefault(11666);
      obj[2] = importDefault(11666).getQueryId(searchContext);
      obj[3] = str.trim().length;
      obj[4] = str2.trim().length;
      const obj8 = importDefault(11666);
      obj[5] = importDefault(11666).getSelectedTab(searchContext);
      obj[6] = index;
      const obj9 = importDefault(11666);
  ...
  trackSearchClosed(searchContext) {
    importDefault(11666).terminate(searchContext.searchContext);
  },
  trackSearchIndexing(searchContext) {
    ...
    obj[2] = importDefault(11666).getSelectedTab(searchContext);
    const obj3 = importDefault(11666);
    obj[3] = importDefault(11666).getLocation(searchContext);
    const obj4 = importDefault(11666);
    obj[4] = importDefault(11666).getSessionId(searchContext);
    const obj5 = importDefault(11666);
    obj[5] = importDefault(11666).getQueryId(searchContext);
  ...
  trackSearchHistoryClicked(searchContext) {
    ...
    obj[0] = importDefault(11666).getSelectedTab(searchContext);
    const obj3 = importDefault(11666);
    obj[1] = importDefault(11666).getLocation(searchContext);
    const obj4 = importDefault(11666);
    obj[2] = importDefault(11666).getSessionId(searchContext);
    let type;
    if (channel != null) {
      type = channel.type;
    }
  ...
  trackSearchFilterAdd(location) {
    ...
    obj[2] = importDefault(11666).getSessionId(searchContext);
    const obj5 = importDefault(11666);
    obj[3] = importDefault(11666).getQueryId(searchContext);
    let str = "filter_from";
