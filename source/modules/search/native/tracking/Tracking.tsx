// Module ID: 11735
// Function ID: 11736
// Dependencies: [1391, 11714, 8402, 676, 11736, 11715, 4498, 514, 3993, 2]
...
export default {
  trackSearchOpened(arg0) {
    ...
    let obj = importDefault(11736);
    obj.initialize(searchContext, searchLocation);
    const channelIdFromSearchContext = require(11715) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
    ...
    obj[0] = importDefault(11736).getSessionId(searchContext);
    obj[1] = searchLocation;
    const obj5 = importDefault(11736);
    obj[2] = require(11715) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
  ...
  trackSearchStarted(searchContext) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      importDefault(11736).refreshQueryId(searchContext);
      const obj2 = importDefault(11736);
      const channelIdFromSearchContext = require(11715) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
      const channel = store.getChannel(channelIdFromSearchContext);
      const obj3 = require(11715) /* SearchTokenTypes */;
      ...
      obj[0] = importDefault(11736).getSessionId(searchContext);
      const obj6 = importDefault(11736);
      obj[1] = importDefault(11736).getQueryId(searchContext);
      const obj7 = importDefault(11736);
      obj[2] = importDefault(11736).getLocation(searchContext);
      const obj8 = importDefault(11736);
      obj[3] = require(11715) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
      ...
      const obj9 = require(11715) /* SearchTokenTypes */;
    }
  },
  trackSearchResultClicked(arg0) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      const guildIdFromSearchContext = require(11715) /* SearchTokenTypes */.getGuildIdFromSearchContext(searchContext);
      const obj2 = require(11715) /* SearchTokenTypes */;
      const channelIdFromSearchContext = require(11715) /* SearchTokenTypes */.getChannelIdFromSearchContext(searchContext);
      const channel = store.getChannel(channelIdFromSearchContext);
      ...
      obj[0] = importDefault(11736).getSessionId(searchContext);
      const obj6 = importDefault(11736);
      obj[1] = importDefault(11736).getLocation(searchContext);
      const obj7 = importDefault(11736);
      obj[2] = importDefault(11736).getQueryId(searchContext);
      obj[3] = str.trim().length;
      obj[4] = str2.trim().length;
      const obj8 = importDefault(11736);
      obj[5] = importDefault(11736).getSelectedTab(searchContext);
      obj[6] = index;
      const obj9 = importDefault(11736);
  ...
  trackSearchResultReturned(searchContext) {
    ...
    if (!prototype.isInitialSearchQuery(searchContext)) {
      ...
      const obj8 = importDefault(11736);
      obj[13] = require(3993) /* explicitContentFromProto */.SearchResultExactCountEnabled.getSetting();
      obj[14] = guildIdFromSearchContext;
      obj[15] = channelIdFromSearchContext;
      let type;
      if (channel != null) {
      ...
      const SearchResultExactCountEnabled = require(3993) /* explicitContentFromProto */.SearchResultExactCountEnabled;
    }
  },
  ...
  trackSearchClosed(searchContext) {
    importDefault(11736).terminate(searchContext.searchContext);
  },
  trackSearchIndexing(searchContext) {
    ...
    obj[2] = importDefault(11736).getSelectedTab(searchContext);
    const obj3 = importDefault(11736);
    obj[3] = importDefault(11736).getLocation(searchContext);
    const obj4 = importDefault(11736);
    obj[4] = importDefault(11736).getSessionId(searchContext);
    const obj5 = importDefault(11736);
    obj[5] = importDefault(11736).getQueryId(searchContext);
  ...
  trackSearchHistoryClicked(searchContext) {
    ...
    obj[0] = importDefault(11736).getSelectedTab(searchContext);
    const obj3 = importDefault(11736);
    obj[1] = importDefault(11736).getLocation(searchContext);
    const obj4 = importDefault(11736);
    obj[2] = importDefault(11736).getSessionId(searchContext);
    let type;
    if (channel != null) {
      type = channel.type;
    }
  ...
  trackSearchFilterAdd(location) {
    ...
    obj[2] = importDefault(11736).getSessionId(searchContext);
    const obj5 = importDefault(11736);
    obj[3] = importDefault(11736).getQueryId(searchContext);
    let str = "filter_from";
