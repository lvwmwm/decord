...
// Dependencies: [1372, 5820, 11655, 11656, 11657, 11629, 8320, 643, 11630, 589, 709, 2]

// Module 11654 (handleSearchQuery)
...
function computeLayoutForState(value) {
  ...
  if (autocompleteVisible.isAutocompleteVisible(searchContext)) {
    ...
    channel = channel.getChannel(_require(11630).getChannelIdFromSearchContext(searchContext));
    let flag;
    if (channel != null) {
