...
// Dependencies: [1372, 5899, 11736, 11737, 11738, 11710, 8397, 643, 11711, 589, 709, 2]

// Module 11735 (handleSearchQuery)
...
function computeLayoutForState(value) {
  ...
  if (autocompleteVisible.isAutocompleteVisible(searchContext)) {
    ...
    channel = channel.getChannel(_require(11711).getChannelIdFromSearchContext(searchContext));
    let flag;
    if (channel != null) {
