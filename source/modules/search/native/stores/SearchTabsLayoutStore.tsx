...
// Dependencies: [1372, 5793, 11621, 11622, 11623, 11595, 8180, 643, 11596, 589, 709, 2]

// Module 11620 (handleSearchQuery)
...
function computeLayoutForState(value) {
  ...
  if (autocompleteVisible.isAutocompleteVisible(searchContext)) {
    ...
    channel = channel.getChannel(_require(11596).getChannelIdFromSearchContext(searchContext));
    let flag;
    if (channel != null) {
