...
// Dependencies: [6, 7, 15, 17, 18, 1348, 5847, 11400, 11401, 11402, 10041, 9033, 620, 10042, 566, 686, 2]
...
function computeLayoutForState(value) {
  ...
  if (uiStore.isAutocompleteVisible(searchContext)) {
    ...
    channel = channel.getChannel(_require(10042).getChannelIdFromSearchContext(searchContext));
    ...
    channel = _require(10042).getSearchContextId(searchContext);
