...
// Function ID: 11787
// Name: prototype
// Dependencies: [1391, 3998, 1922, 8468, 8467, 676, 4535, 1236, 11787, 11799, 1989, 589, 709, 2]

// Module 11786 (prototype)
...
const prototype = function SearchQueryStateManager(type) {
  ...
  if (constants3.THREAD !== type) {
    ...
    const tmp12 = new importDefault(11799)();
  ...
  if (isObfuscatedResult) {
    ...
    if (null == channelName) {
      ...
      obj[2] = "" + stringResult + ": " + obj(11787).quoteChannelName(channelName);
      obj[3] = type.channelId;
      obj[4] = SearchFilterAddLocations.CLIENT_AUTO_ADD;
      items1 = [obj];
      const obj4 = obj(11787);
    }
    items = items1;
  }
}.prototype;
...
prototype2["getManager"] = function getManager(closure_0) {
  let value = map.get(require(11787) /* SearchTokenTypes */.getSearchContextId(closure_0));
  if (value == null) {
...
prototype2["getQueryString"] = function getQueryString(searchContext) {
  ...
  let value = map.get(require(11787) /* SearchTokenTypes */.getSearchContextId(searchContext));
  if (value == null) {
