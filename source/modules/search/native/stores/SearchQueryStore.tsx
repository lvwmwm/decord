...
// Function ID: 11630
// Name: prototype
// Dependencies: [1372, 3921, 1903, 8320, 8319, 676, 4475, 1236, 11630, 11642, 1970, 589, 709, 2]

// Module 11629 (prototype)
...
const prototype = function SearchQueryStateManager(type) {
  ...
  if (constants3.THREAD !== type) {
    ...
    const tmp12 = new importDefault(11642)();
  ...
  if (isObfuscatedResult) {
    ...
    if (null == channelName) {
      ...
      obj[2] = "" + stringResult + ": " + obj(11630).quoteChannelName(channelName);
      obj[3] = type.channelId;
      obj[4] = SearchFilterAddLocations.CLIENT_AUTO_ADD;
      items1 = [obj];
      const obj4 = obj(11630);
    }
    items = items1;
  }
}.prototype;
...
prototype2["getManager"] = function getManager(closure_0) {
  let value = map.get(require(11630) /* SearchTokenTypes */.getSearchContextId(closure_0));
  if (value == null) {
...
prototype2["getQueryString"] = function getQueryString(searchContext) {
  ...
  let value = map.get(require(11630) /* SearchTokenTypes */.getSearchContextId(searchContext));
  if (value == null) {
...
areArraysShallowlyEqual = {
  SEARCH_QUERY_NATIVE_UPDATE: function handleSearchQueryNativeUpdate(searchContext) {
    ...
    const searchContextId = require(11630) /* SearchTokenTypes */.getSearchContextId(searchContext);
