...
// Function ID: 11771
// Name: prototype
// Dependencies: [1391, 3998, 1922, 8446, 8445, 676, 4535, 1236, 11771, 11783, 1989, 589, 709, 2]

// Module 11770 (prototype)
...
const prototype = function SearchQueryStateManager(type) {
  ...
  if (constants3.THREAD !== type) {
    ...
    const tmp12 = new importDefault(11783)();
  ...
  if (isObfuscatedResult) {
    ...
    let channelName;
    if (null != channel) {
      channelName = obj(4535).computeChannelName(channel, mergeGuildAvatar, markAllUserIdListsStale);
      const obj2 = obj(4535);
    }
    if (null == channelName) {
      let items1 = [];
      ...
      obj[2] = "" + stringResult + ": " + obj(11771).quoteChannelName(channelName);
      obj[3] = type.channelId;
      obj[4] = SearchFilterAddLocations.CLIENT_AUTO_ADD;
      items1 = [obj];
      const obj4 = obj(11771);
    }
    items = items1;
  }
}.prototype;
...
prototype2["getManager"] = function getManager(closure_0) {
  let value = map.get(require(11771) /* SearchTokenTypes */.getSearchContextId(closure_0));
  if (value == null) {
...
prototype2["getQueryString"] = function getQueryString(searchContext) {
  ...
  let value = map.get(require(11771) /* SearchTokenTypes */.getSearchContextId(searchContext));
  if (value == null) {
...
areArraysShallowlyEqual = {
  SEARCH_QUERY_NATIVE_UPDATE: function handleSearchQueryNativeUpdate(searchContext) {
    ...
    const searchContextId = require(11771) /* SearchTokenTypes */.getSearchContextId(searchContext);
