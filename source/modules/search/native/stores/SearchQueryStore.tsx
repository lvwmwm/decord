...
// Function ID: 11596
// Name: prototype
// Dependencies: [1372, 3892, 1874, 8180, 8179, 676, 4445, 1236, 11596, 11608, 1941, 589, 709, 2]

// Module 11595 (prototype)
...
const prototype = function SearchQueryStateManager(type) {
  ...
  if (constants3.THREAD !== type) {
    ...
    const tmp12 = new importDefault(11608)();
  ...
  if (isObfuscatedResult) {
    ...
    let channelName;
    if (null != channel) {
      channelName = obj(4445).computeChannelName(channel, mergeGuildAvatar, upsertRelationship);
      const obj2 = obj(4445);
    }
    if (null == channelName) {
      let items1 = [];
      ...
      obj[2] = "" + stringResult + ": " + obj(11596).quoteChannelName(channelName);
      obj[3] = type.channelId;
      obj[4] = SearchFilterAddLocations.CLIENT_AUTO_ADD;
      items1 = [obj];
      const obj4 = obj(11596);
    }
    items = items1;
  }
}.prototype;
...
prototype2["getManager"] = function getManager(closure_0) {
  let value = map.get(require(11596) /* SearchTokenTypes */.getSearchContextId(closure_0));
  if (value == null) {
...
prototype2["getQueryString"] = function getQueryString(searchContext) {
  ...
  let value = map.get(require(11596) /* SearchTokenTypes */.getSearchContextId(searchContext));
  if (value == null) {
...
areArraysShallowlyEqual = {
  SEARCH_QUERY_NATIVE_UPDATE: function handleSearchQueryNativeUpdate(searchContext) {
    ...
    const searchContextId = require(11596) /* SearchTokenTypes */.getSearchContextId(searchContext);
