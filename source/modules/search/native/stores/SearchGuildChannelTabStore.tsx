...
// Function ID: 11622
// Name: search
// Dependencies: [1932, 4267, 5180, 5111, 12, 11, 589, 709, 2]
...
prototype["search"] = function search(query, guildId) {
  ...
  const obj6 = importDefault(5111);
  this.voiceChannels = importDefault(5111).queryChannels(obj1).map((channel) => ({ channel: channel.record }));
  const queryChannelsResult1 = importDefault(5111).queryChannels(obj1);
