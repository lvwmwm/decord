// Module ID: 11719
// Function ID: 11720
// Dependencies: [11712, 11720, 709, 12, 7241, 11723, 1355, 2]
...
export default {
  fetchTabMessages(searchContext) {
    ...
    let obj = searchContext(11712);
    let obj1 = searchContext(11712);
    ...
    if (null != guildIdFromSearchContext) {
      tmp(11712).setIncludeNSFW(obj, guildIdFromSearchContext);
      const tmpResult1 = tmp(11712);
    }
    ...
    const obj7 = importDefault(11720);
    obj[0] = searchContext(11712).getSearchContextId(searchContext);
    obj[1] = searchContext;
    obj[2] = obj;
    obj[3] = searchTabs;
    obj[4] = getLimit;
    ...
    const tmpResult2 = searchContext(11712);
  ...
  fetchMessages(arg0) {
    ...
    let obj = guildIdFromSearchContext(11712);
    obj = {};
    let obj2 = guildIdFromSearchContext(11712);
    const merged = Object.assign(obj2.getSearchQueryFromTokens(obj.tokenizeQuery(searchQueryString)));
    const tokenizeQueryResult = obj.tokenizeQuery(searchQueryString);
    const merged1 = Object.assign(guildIdFromSearchContext(11712).searchModeToSearchQueryParams(searchMode));
    obj.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(11712);
    guildIdFromSearchContext = guildIdFromSearchContext(11712).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      let tmpResult = tmp(11712);
    ...
    const obj1 = searchContextId(11723).create(obj);
