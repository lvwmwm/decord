// Module ID: 12347
// Function ID: 12348
// Dependencies: [12340, 12348, 573, 12, 7782, 12351, 1940, 2]

// Module 12347
import set from "set" /* 2 */;
import dispatcherDefault from "dispatcher" /* 573 */;
import updateUserGuildSettings from "updateUserGuildSettings" /* 1940 */;
import createRequestPayloadDefault from "createRequestPayload" /* 12348 */;
...
export default {
  fetchTabMessages(searchContext) {
    ...
    obj[0] = searchContext(12340).getSearchContextId(searchContext);
    obj[1] = searchContext;
    obj[2] = obj;
    obj[3] = searchTabs;
    obj[4] = getLimit;
  ...
  fetchMessages(arg0) {
    ...
    let obj = guildIdFromSearchContext(12340);
    obj = {};
    ...
    const tokenizeQueryResult = obj.tokenizeQuery(searchQueryString);
    const merged1 = Object.assign(guildIdFromSearchContext(12340).searchModeToSearchQueryParams(searchMode));
    obj.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(12340);
    ...
    obj1 = searchContextId(12351).create(obj);
