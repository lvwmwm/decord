// Module ID: 11631
// Function ID: 11632
// Dependencies: [11624, 11632, 709, 12, 7161, 11635, 1355, 2]
...
export default {
  fetchTabMessages(searchContext) {
    ...
    let obj = searchContext(11624);
    let obj1 = searchContext(11624);
    ...
    if (null != guildIdFromSearchContext) {
      tmp(11624).setIncludeNSFW(obj, guildIdFromSearchContext);
      const tmpResult1 = tmp(11624);
    }
    ...
    const tmpResult2 = searchContext(11624);
  ...
  fetchMessages(arg0) {
    ...
    let obj = guildIdFromSearchContext(11624);
    obj = {};
    let obj2 = guildIdFromSearchContext(11624);
    const merged = Object.assign(obj2.getSearchQueryFromTokens(obj.tokenizeQuery(searchQueryString)));
    const tokenizeQueryResult = obj.tokenizeQuery(searchQueryString);
    const merged1 = Object.assign(guildIdFromSearchContext(11624).searchModeToSearchQueryParams(searchMode));
    obj.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(11624);
    guildIdFromSearchContext = guildIdFromSearchContext(11624).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      let tmpResult = tmp(11624);
    ...
    const obj1 = searchContextId(11635).create(obj);
