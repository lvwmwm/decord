// Module ID: 11778
// Function ID: 11779
// Dependencies: [11771, 11779, 709, 12, 7286, 11782, 1374, 2]
...
export default {
  fetchTabMessages(searchContext) {
    ...
    let obj = searchContext(11771);
    let obj1 = searchContext(11771);
    ...
    if (null != guildIdFromSearchContext) {
      tmp(11771).setIncludeNSFW(obj, guildIdFromSearchContext);
      const tmpResult1 = tmp(11771);
    }
    ...
    const obj7 = importDefault(11779);
    obj[0] = searchContext(11771).getSearchContextId(searchContext);
    obj[1] = searchContext;
    obj[2] = obj;
    obj[3] = searchTabs;
    obj[4] = getLimit;
    ...
    const tmpResult2 = searchContext(11771);
  ...
  fetchMessages(arg0) {
    ...
    let obj = guildIdFromSearchContext(11771);
    obj = {};
    let obj2 = guildIdFromSearchContext(11771);
    const merged = Object.assign(obj2.getSearchQueryFromTokens(obj.tokenizeQuery(searchQueryString)));
    const tokenizeQueryResult = obj.tokenizeQuery(searchQueryString);
    const merged1 = Object.assign(guildIdFromSearchContext(11771).searchModeToSearchQueryParams(searchMode));
    obj.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(11771);
    guildIdFromSearchContext = guildIdFromSearchContext(11771).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      let tmpResult = tmp(11771);
    ...
    const obj1 = searchContextId(11782).create(obj);
