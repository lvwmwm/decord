// Module ID: 11652
// Function ID: 11653
// Dependencies: [11645, 11653, 709, 12, 7181, 11656, 1355, 2]
...
export default {
  fetchTabMessages(searchContext) {
    ...
    let obj = searchContext(11645);
    let obj1 = searchContext(11645);
    ...
    if (null != guildIdFromSearchContext) {
      tmp(11645).setIncludeNSFW(obj, guildIdFromSearchContext);
      const tmpResult1 = tmp(11645);
    }
    ...
    const obj7 = importDefault(11653);
    obj[0] = searchContext(11645).getSearchContextId(searchContext);
    obj[1] = searchContext;
    obj[2] = obj;
    obj[3] = searchTabs;
    obj[4] = getLimit;
    ...
    const tmpResult2 = searchContext(11645);
  ...
  fetchMessages(arg0) {
    ...
    let obj = guildIdFromSearchContext(11645);
    obj = {};
    let obj2 = guildIdFromSearchContext(11645);
    const merged = Object.assign(obj2.getSearchQueryFromTokens(obj.tokenizeQuery(searchQueryString)));
    const tokenizeQueryResult = obj.tokenizeQuery(searchQueryString);
    const merged1 = Object.assign(guildIdFromSearchContext(11645).searchModeToSearchQueryParams(searchMode));
    obj.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(11645);
    guildIdFromSearchContext = guildIdFromSearchContext(11645).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      let tmpResult = tmp(11645);
    ...
    const obj1 = searchContextId(11656).create(obj);
