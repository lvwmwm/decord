// Module ID: 11718
// Function ID: 11719
// Dependencies: [11711, 11719, 709, 12, 7241, 11722, 1355, 2]
...
export default {
  fetchTabMessages(searchContext) {
    ...
    let obj = searchContext(11711);
    let obj1 = searchContext(11711);
    ...
    if (null != guildIdFromSearchContext) {
      tmp(11711).setIncludeNSFW(obj, guildIdFromSearchContext);
      const tmpResult1 = tmp(11711);
    }
    ...
    const obj7 = importDefault(11719);
    obj[0] = searchContext(11711).getSearchContextId(searchContext);
    obj[1] = searchContext;
    obj[2] = obj;
    obj[3] = searchTabs;
    obj[4] = getLimit;
    ...
    const tmpResult2 = searchContext(11711);
  ...
  fetchMessages(arg0) {
    ...
    let obj = guildIdFromSearchContext(11711);
    obj = {};
    let obj2 = guildIdFromSearchContext(11711);
    const merged = Object.assign(obj2.getSearchQueryFromTokens(obj.tokenizeQuery(searchQueryString)));
    const tokenizeQueryResult = obj.tokenizeQuery(searchQueryString);
    const merged1 = Object.assign(guildIdFromSearchContext(11711).searchModeToSearchQueryParams(searchMode));
    obj.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(11711);
    guildIdFromSearchContext = guildIdFromSearchContext(11711).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      let tmpResult = tmp(11711);
    ...
    const obj1 = searchContextId(11722).create(obj);
