// Module ID: 11637
// Function ID: 11638
// Dependencies: [11630, 11638, 709, 12, 7162, 11641, 1355, 2]
...
export default {
  fetchTabMessages(searchContext) {
    ...
    let obj = searchContext(11630);
    let obj1 = searchContext(11630);
    ...
    if (null != guildIdFromSearchContext) {
      tmp(11630).setIncludeNSFW(obj, guildIdFromSearchContext);
      const tmpResult1 = tmp(11630);
    }
    ...
    const obj7 = importDefault(11638);
    obj[0] = searchContext(11630).getSearchContextId(searchContext);
    obj[1] = searchContext;
    obj[2] = obj;
    obj[3] = searchTabs;
    obj[4] = getLimit;
    ...
    const tmpResult2 = searchContext(11630);
  ...
  fetchMessages(arg0) {
    ...
    let obj = guildIdFromSearchContext(11630);
    obj = {};
    let obj2 = guildIdFromSearchContext(11630);
    const merged = Object.assign(obj2.getSearchQueryFromTokens(obj.tokenizeQuery(searchQueryString)));
    const tokenizeQueryResult = obj.tokenizeQuery(searchQueryString);
    const merged1 = Object.assign(guildIdFromSearchContext(11630).searchModeToSearchQueryParams(searchMode));
    obj.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(11630);
    guildIdFromSearchContext = guildIdFromSearchContext(11630).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      let tmpResult = tmp(11630);
    ...
    const obj1 = searchContextId(11641).create(obj);
