// Module ID: 11794
// Function ID: 11795
// Dependencies: [11787, 11795, 709, 12, 7308, 11798, 1374, 2]
...
export default {
  fetchTabMessages(searchContext) {
    ...
    if (null != guildIdFromSearchContext) {
      tmp(11787).setIncludeNSFW(obj, guildIdFromSearchContext);
      const tmpResult1 = tmp(11787);
    }
    ...
    const obj7 = importDefault(11795);
    obj[0] = searchContext(11787).getSearchContextId(searchContext);
    obj[1] = searchContext;
    obj[2] = obj;
    obj[3] = searchTabs;
    obj[4] = getLimit;
    ...
    const tmpResult2 = searchContext(11787);
  ...
  fetchMessages(arg0) {
    ...
    let obj = guildIdFromSearchContext(11787);
    obj = {};
    let obj2 = guildIdFromSearchContext(11787);
    const merged = Object.assign(obj2.getSearchQueryFromTokens(obj.tokenizeQuery(searchQueryString)));
    const tokenizeQueryResult = obj.tokenizeQuery(searchQueryString);
    const merged1 = Object.assign(guildIdFromSearchContext(11787).searchModeToSearchQueryParams(searchMode));
    obj.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(11787);
    guildIdFromSearchContext = guildIdFromSearchContext(11787).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      let tmpResult = tmp(11787);
    ...
    const obj1 = searchContextId(11798).create(obj);
