// Module ID: 11603
// Function ID: 11604
// Dependencies: [11596, 11604, 709, 12, 7135, 11607, 1355, 2]
...
export default {
  fetchTabMessages(searchContext) {
    ...
    let obj = searchContext(11596);
    let obj1 = searchContext(11596);
    ...
    if (null != guildIdFromSearchContext) {
      tmp(11596).setIncludeNSFW(obj, guildIdFromSearchContext);
      const tmpResult1 = tmp(11596);
    }
    ...
    const obj7 = importDefault(11604);
    obj[0] = searchContext(11596).getSearchContextId(searchContext);
    obj[1] = searchContext;
    obj[2] = obj;
    obj[3] = searchTabs;
    obj[4] = getLimit;
    ...
    const tmpResult2 = searchContext(11596);
  ...
  fetchMessages(arg0) {
    ...
    let obj = guildIdFromSearchContext(11596);
    obj = {};
    let obj2 = guildIdFromSearchContext(11596);
    const merged = Object.assign(obj2.getSearchQueryFromTokens(obj.tokenizeQuery(searchQueryString)));
    const tokenizeQueryResult = obj.tokenizeQuery(searchQueryString);
    const merged1 = Object.assign(guildIdFromSearchContext(11596).searchModeToSearchQueryParams(searchMode));
    obj.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(11596);
    guildIdFromSearchContext = guildIdFromSearchContext(11596).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      let tmpResult = tmp(11596);
    ...
    const obj1 = searchContextId(11607).create(obj);
