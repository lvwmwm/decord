// Module ID: 11777
// Function ID: 11778
// Dependencies: [11770, 11778, 709, 12, 7286, 11781, 1374, 2]
...
export default {
  fetchTabMessages(searchContext) {
    ...
    let obj = searchContext(11770);
    let obj1 = searchContext(11770);
    ...
    if (null != guildIdFromSearchContext) {
      tmp(11770).setIncludeNSFW(obj, guildIdFromSearchContext);
      const tmpResult1 = tmp(11770);
    }
    ...
    const obj7 = importDefault(11778);
    obj[0] = searchContext(11770).getSearchContextId(searchContext);
    obj[1] = searchContext;
    obj[2] = obj;
    obj[3] = searchTabs;
    obj[4] = getLimit;
    ...
    const tmpResult2 = searchContext(11770);
  ...
  fetchMessages(arg0) {
    ...
    let obj = guildIdFromSearchContext(11770);
    obj = {};
    let obj2 = guildIdFromSearchContext(11770);
    const merged = Object.assign(obj2.getSearchQueryFromTokens(obj.tokenizeQuery(searchQueryString)));
    const tokenizeQueryResult = obj.tokenizeQuery(searchQueryString);
    const merged1 = Object.assign(guildIdFromSearchContext(11770).searchModeToSearchQueryParams(searchMode));
    obj.offset = pagination.offset;
    const obj4 = guildIdFromSearchContext(11770);
    guildIdFromSearchContext = guildIdFromSearchContext(11770).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      let tmpResult = tmp(11770);
    ...
    const obj1 = searchContextId(11781).create(obj);
