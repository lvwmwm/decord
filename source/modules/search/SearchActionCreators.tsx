// Module ID: 11518
// Function ID: 11519
// Dependencies: [11511, 11519, 709, 12, 7529, 11522, 1374, 2]
...
export default {
  fetchTabMessages(searchContext) {
    ...
    const obj7 = importDefault(11519);
  ...
  fetchMessages(arg0) {
    ...
    const obj1 = searchContextId(11522).create(obj);
