  ...
  if (str.startsWith("\"")) {
    ...
    if (obj3.isGuildLikeSearchContext(searchContext)) {
      let items = function getGuildChannelAutocompletions(substr1, guildId, maxResults) {
        ...
        obj = { query: substr1, type: closure_5, guildId, boosters: callback(closure_2[18]).getBoosterMap(callback(closure_2[19]).AutocompleterResultTypes.TEXT_CHANNEL) };
        const obj3 = callback(closure_2[18]);
        const queryChannelsResult = obj.queryChannels(obj);
        obj = { <string:4021218137>: 0., <string:1052628910>: 0., <string:1988643825>: 0., <string:3384819177>: 0., <string:1407531648>: 0.0000000000000000000000000000000000000000015305682574256125, <string:3010274437>: 0., query: substr1, type: closure_6, guildId };
