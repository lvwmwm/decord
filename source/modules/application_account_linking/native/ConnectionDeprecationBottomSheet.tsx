...
// Function ID: 16099
// Name: ConnectionIcon
// Dependencies: [19, 17, 4383, 5039, 1388, 21, 4342, 712, 4072, 1628, 589, 5041, 5771, 5768, 5788, 16099, 4310, 16101, 2007, 5436, 5437, 4753, 16087, 4338, 1236, 2853, 9458, 4755, 12301, 1364, 1435, 4757, 5778, 5774, 2]
// Exports: default, useShouldShowConnectionDeprecationBottomSheet

// Module 16098 (ConnectionIcon)
...
function ConnectionIcon(arg0) {
  ...
  obj[1] = callback(importDefault(4757), obj);
...
function ApplicationIcon(application) {
  ...
  if (null != application) {
    ...
    obj[0] = application;
    obj[1] = require(5778) /* GameIcon */.GameIconSizes.NORMAL;
    tmpResult = tmp(importDefault(5778), obj);
    const tmp6 = importDefault(5778);
  }
  obj[1] = tmpResult;
...
export const useShouldShowConnectionDeprecationBottomSheet = function useShouldShowConnectionDeprecationBottomSheet(deprecatedPlatformTypes) {
  ...
  const tmp5 = importDefault(5771)(getOrFetchApplication);
