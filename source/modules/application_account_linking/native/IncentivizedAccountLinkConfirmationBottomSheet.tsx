...
// Dependencies: [19, 17, 4295, 676, 21, 589, 14862, 500, 8302, 14863, 5268, 4714, 1236, 12236, 712, 4271, 4017, 1993, 7735, 2949, 2]
// Exports: default

// Module 16034 (IncentivizedAccountLinkConfirmationBottomSheet)
...
export default function IncentivizedAccountLinkConfirmationBottomSheet() {
  ...
  obj7[1] = tmp9(require(12236) /* WindowLaunchIcon */.WindowLaunchIcon, obj8);
  ...
  obj9[2] = tmp9(require(4714) /* Button */.Button, obj7);
  obj9[3] = tmp3Result;
  obj9[4] = function onDismiss() {
    callback(4271).hideActionSheet();
  };
  return tmp9(require(7735) /* PromoSheet */.PromoSheet, obj9);
};
