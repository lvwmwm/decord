...
// Dependencies: [19, 17, 4185, 676, 21, 589, 14646, 500, 6211, 14647, 5145, 4604, 1236, 10195, 712, 4161, 3890, 1945, 6659, 2871, 2]
// Exports: default
...
export default function IncentivizedAccountLinkConfirmationBottomSheet() {
  ...
  obj7[1] = tmp9(require(10195) /* WindowLaunchIcon */.WindowLaunchIcon, obj8);
  obj7[4] = function onPress() {
    callback(4161).hideActionSheet();
    const obj = callback(4161);
    const obj2 = callback(3890);
  ...
  obj9[0] = intl2.string(tmp8(2871).ublzTG);
  const intl3 = tmp(1236).intl;
  obj9[1] = intl3.string(tmp8(2871).JgM2xu);
  obj9[2] = tmp9(require(4604) /* Button */.Button, obj7);
  obj9[3] = tmp3Result;
  obj9[4] = function onDismiss() {
    callback(4161).hideActionSheet();
  };
  return tmp9(require(6659) /* PromoSheet */.PromoSheet, obj9);
};
