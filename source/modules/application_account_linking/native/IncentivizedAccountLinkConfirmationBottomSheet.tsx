...
// Dependencies: [19, 17, 4440, 676, 21, 589, 15396, 500, 8070, 15397, 5461, 4896, 1236, 12787, 712, 4415, 4160, 1995, 10274, 3051, 2]
// Exports: default

// Module 16487 (IncentivizedAccountLinkConfirmationBottomSheet)
import noopAll from "noop" /* 19 */;
import initialize from "initialize" /* 589 */;
import getSystemLocale from "getSystemLocale" /* 1236 */;
import Button from "Button" /* 4896 */;
import PromoSheet from "PromoSheet" /* 10274 */;
import WindowLaunchIcon from "WindowLaunchIcon" /* 12787 */;
import metadataDefault from "metadata" /* 15396 */;
...
export default function IncentivizedAccountLinkConfirmationBottomSheet() {
  ...
  obj9[0] = intl2.string(tmp8(3051).ublzTG);
  const intl3 = tmp(1236).intl;
  obj9[1] = intl3.string(tmp8(3051).JgM2xu);
