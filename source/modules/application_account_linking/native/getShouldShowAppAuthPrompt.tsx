...
// Dependencies: [5203, 5600, 5603, 2]
// Exports: getShouldShowAppAuthPrompt

// Module 11048 (getShouldShowAppAuthPrompt)
...
export const getShouldShowAppAuthPrompt = function getShouldShowAppAuthPrompt(application) {
  if (null == application) {
    ...
    const authorizationApp = require(5600) /* getAuthorizationApp */.getAuthorizationApp(application);
    if (null == authorizationApp) {
      ...
      if (null != prop) {
        ...
        if (null == parentId) {
          ...
          response = importDefault(5603).fetch(items);
          let flag2 = false;
          const obj2 = importDefault(5603);
        } else {
    ...
    const obj3 = require(5600) /* getAuthorizationApp */;
  }
};
