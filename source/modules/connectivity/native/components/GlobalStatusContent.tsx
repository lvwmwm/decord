...
// Dependencies: [19, 17, 1372, 1891, 4373, 4317, 10700, 676, 21, 4302, 712, 10701, 589, 10230, 10698, 4147, 4238, 4847, 4152, 10585, 500, 1609, 7688, 10706, 2]
// Exports: default

// Module 10705 (ConnectivityGlobalStatusContent)
...
export default function ConnectivityGlobalStatusContent() {
  ...
  const tmp4 = importDefault(10701)();
  const require = tmp4;
  ...
  let tmp2ResultResult = importDefault(10230)(id);
  const tmp2Result = importDefault(10230);
  let tmp5Result = tmp5(4147);
  let tmp14 = tmp12;
  const tmp11 = importDefault(10698)();
  ...
  tmp5Result = tmp5(4847);
  let isScreenLandscape = tmp5Result.useIsScreenLandscape();
  if (isScreenLandscape) {
    isScreenLandscape = tmp5(4152).isModalOpen(tmp2(10585));
  ...
  items2[2] = obj;
  if (isScreenLandscape) {
    isScreenLandscape = callback(tmp2(7688), { hidden: true });
  }
  ...
  if (isGuildStageVoiceResult) {
    ...
    tmp19 = callback(tmp2(10706), obj1);
  }
  items3[1] = tmp19;
  obj[1] = items3;
