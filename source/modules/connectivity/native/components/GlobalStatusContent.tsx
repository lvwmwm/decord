...
// Dependencies: [19, 17, 1391, 1910, 4518, 4462, 10926, 676, 21, 4444, 712, 10927, 589, 10430, 10924, 1363, 4379, 5018, 4298, 10809, 500, 1629, 7960, 10932, 2]
// Exports: default

// Module 10931 (ConnectivityGlobalStatusContent)
...
export default function ConnectivityGlobalStatusContent() {
  ...
  tmp5Result = tmp5(5018);
  let isScreenLandscape = tmp5Result.useIsScreenLandscape();
  if (isScreenLandscape) {
    isScreenLandscape = tmp5(4298).isModalOpen(tmp2(10809));
  ...
  items2[2] = obj;
  if (isScreenLandscape) {
    isScreenLandscape = callback(tmp2(7960), { hidden: true });
  }
  ...
  if (isGuildStageVoiceResult) {
    ...
    tmp19 = callback(tmp2(10932), obj1);
  }
  items3[1] = tmp19;
  obj[1] = items3;
