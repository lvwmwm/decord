...
// Dependencies: [5, 32, 19, 17, 1921, 1993, 673, 21, 4481, 7908, 4953, 695, 11774, 4194, 1233, 9495, 4955, 4477, 4680, 10861, 2]
// Exports: default

// Module 11775 (GuildEnableCommunicationAlert)
...
export default function GuildEnableCommunicationAlert(guildId) {
  ...
  const tmp2 = callback();
  dependencyMap = tmp2;
  closure_3 = _handleConfirmRemoveTimeout(userId(7908)(userId, guildId), 1)[0];
  userId(4953)(() => {
  ...
  const tmp12 = View;
  const tmp3 = userId;
  const tmp7 = userId(4955);
  let str = userId(4680).getName(guildId, null, user);
  if (str == null) {
    str = "";
  }
  ...
  const items = [closure_10(guildId(4477).Text, obj), ];
  ...
  items[1] = closure_10(guildId(4477).Text, obj2);
  obj[1] = items;
