...
// Function ID: 85313
// Name: items
// Dependencies: [5, 57, 31, 27, 1920, 653, 33, 1212, 4131, 689, 5159, 9786, 4560, 675, 10970, 3832, 4320, 10294, 4127, 7596, 7595, 7585, 4544, 2]
...
const memoResult = importAllResult.memo(function GuildDisableCommunication(arg0) {
  ...
  importDefault(9786)({ insets, inputs: items, scrollViewRef: ref });
  importDefault(4560)(() => {
  ...
  items1[1] = callback2(require(7596) /* context */.TableRadioGroup, obj4);
  ...
  items1[2] = callback2(require(7585) /* TextArea */.TextArea, obj5);
  ...
  obj6.children = callback2(require(4544) /* Button */.Button, obj7);
