...
// Function ID: 11126
// Name: items
// Dependencies: [5, 32, 19, 17, 1944, 676, 21, 1236, 4255, 712, 5295, 9351, 4681, 698, 11126, 3956, 4444, 9764, 4251, 7767, 7766, 7758, 4665, 2]
...
const memoResult = importAllResult.memo(function GuildDisableCommunication(arg0) {
  ...
  importDefault(9351)({ insets, inputs: items, scrollViewRef: ref });
  importDefault(4681)(() => {
  ...
  items1[1] = callback2(require(7767) /* context */.TableRadioGroup, obj4);
  ...
  items1[2] = callback2(require(7758) /* TextArea */.TextArea, obj5);
  ...
  obj6[1] = callback2(require(4665) /* Button */.Button, obj7);
