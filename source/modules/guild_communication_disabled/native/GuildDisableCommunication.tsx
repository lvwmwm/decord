...
// Function ID: 11301
// Name: items
// Dependencies: [5, 32, 19, 17, 1992, 676, 21, 1236, 4344, 712, 5408, 9508, 4770, 698, 11301, 4062, 4533, 9924, 4340, 8026, 8025, 8017, 4754, 2]
...
const memoResult = importAllResult.memo(function GuildDisableCommunication(arg0) {
  ...
  importDefault(9508)({ insets, inputs: items, scrollViewRef: ref });
  importDefault(4770)(() => {
  ...
  const items1 = [callback2(require(4340) /* Text */.Text, obj1), , , ];
  ...
  items1[1] = callback2(require(8026) /* context */.TableRadioGroup, obj4);
  ...
  items1[2] = callback2(require(8017) /* TextArea */.TextArea, obj5);
  ...
  obj6[1] = callback2(require(4754) /* Button */.Button, obj7);
