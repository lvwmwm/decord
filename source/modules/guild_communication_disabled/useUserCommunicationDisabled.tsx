...
function isCommunicationDisabled(communicationDisabledUntil) {
  ...
  const items = [tmp2, require(3782) /* isCommunicationDisabled */.isMemberCommunicationDisabled(communicationDisabledUntil)];
  return items;
}
