...
export default function useUserCommunicationDisabled(arg0, arg1) {
  ...
  const tmp = _require;
  items2[1] = _require(3918).isMemberCommunicationDisabled(stateFromStores);
  return items2;
};
...
export const userCommunicationDisabled = function userCommunicationDisabled(id, guildId) {
  ...
  const items = [prop, require(3918) /* isCommunicationDisabled */.isMemberCommunicationDisabled(member)];
  return items;
};
