...
// Function ID: 7029
// Name: buildCommand
// Dependencies: [1395, 4681, 4778, 676, 505, 7029, 1954, 7030, 506, 12, 38, 14, 4539, 2]
...
function hasAccessGivenPerms(selfMember, id, commandLevelPermissions) {
  ...
  if (null != tmp) {
    ...
    while (obj4 !== undefined) {
      ...
      let obj2 = require(7029) /* commandPermissions */;
    ...
    if (flag) {
      ...
      const obj3 = require(7029) /* commandPermissions */;
...
export const getCommandAttachmentDraftType = function getCommandAttachmentDraftType(closure_10) {
  if (require(7030) /* ApplicationCommandSectionType */.CommandOrigin.CHAT === closure_10) {
...
export const getCommandTriggerSection = function getCommandTriggerSection(closure_3) {
  if (null != closure_3) {
    if (closure_3.id === constants.BUILT_IN) {
      let APP = require(7030) /* ApplicationCommandSectionType */.ApplicationCommandTriggerSections.BUILT_IN;
    } else if (closure_3.id === tmp.FRECENCY) {
      APP = require(7030) /* ApplicationCommandSectionType */.ApplicationCommandTriggerSections.FRECENCY;
    } else {
      APP = require(7030) /* ApplicationCommandSectionType */.ApplicationCommandTriggerSections.APP;
    }
    return APP;
  }
};
export const getApplicationCommandSection = function getApplicationCommandSection(application, arg1, arg2) {
  let name = arg2;
  const obj = { type: require(7030) /* ApplicationCommandSectionType */.ApplicationCommandSectionType.APPLICATION, id: application.id, name: null, icon: null, application: null, isUserApp: null };
  if (arg2 == null) {
    let username;
    if (application != null) {
