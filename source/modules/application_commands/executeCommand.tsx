...
// Dependencies: [5, 5026, 1922, 1838, 4502, 1850, 6073, 653, 4158, 5686, 686, 6058, 5684, 1882, 7995, 7997, 44, 7998, 4359, 6071, 6168, 3806, 1327, 6021, 7873, 6127, 7872, 7999, 7960, 6020, 5695, 4705, 1212, 4701, 6134, 2]
// Exports: default, retryCommandMessage

// Module 7994 (_createForOfIteratorHelperLoose)
...
function enqueueCommandInteraction(interactionLifecycleOptions) {
  ...
  if (null != context.channel) {
    ...
    if (null == nonce) {
      nonce = onMessageSuccess(6021).createNonce();
      const obj2 = onMessageSuccess(6021);
    }
    obj.nonce = nonce;
    ...
    obj.data = obj;
    importAll(7873).addQueued(obj.nonce, obj);
    if (null != attachments) {
    ...
    const obj3 = importAll(7873);
  }
}
function queueCommand(message, onMessageSuccess) {
  const _require = message;
  const importDefault = onMessageSuccess;
  let obj = importDefault(6127);
  obj = { type: _require(6127).MessageDataType.COMMAND, message };
  obj.enqueue(obj, (ok) => {
    let applicationId;
    let channelId;
    let guildId;
...
function getAnalyticsLocationFromCommandOrigin(arg0) {
  if (require(5686) /* ApplicationCommandSectionType */.CommandOrigin.APPLICATION_LAUNCHER === arg0) {
    return require(5686) /* ApplicationCommandSectionType */.ApplicationCommandTriggerLocations.APP_LAUNCHER;
  } else if (require(5686) /* ApplicationCommandSectionType */.CommandOrigin.APP_LAUNCHER_APPLICATION_VIEW === arg0) {
    return require(5686) /* ApplicationCommandSectionType */.ApplicationCommandTriggerLocations.APP_LAUNCHER_APPLICATION_VIEW;
  } else if (require(5686) /* ApplicationCommandSectionType */.CommandOrigin.IMAGE_RECS_MENU === arg0) {
    return require(5686) /* ApplicationCommandSectionType */.ApplicationCommandTriggerLocations.IMAGE_RECS_MENU;
  } else if (require(5686) /* ApplicationCommandSectionType */.CommandOrigin.IMAGE_RECS_SUBMENU === arg0) {
    return require(5686) /* ApplicationCommandSectionType */.ApplicationCommandTriggerLocations.IMAGE_RECS_SUBMENU;
  } else if (require(5686) /* ApplicationCommandSectionType */.CommandOrigin.ACTIVITY_INSTANCE_EMBED === arg0) {
    return require(5686) /* ApplicationCommandSectionType */.ApplicationCommandTriggerLocations.ACTIVITY_INSTANCE_EMBED;
  } else if (require(5686) /* ApplicationCommandSectionType */.CommandOrigin.ACTIVITY_BOOKMARK_EMBED === arg0) {
    return require(5686) /* ApplicationCommandSectionType */.ApplicationCommandTriggerLocations.ACTIVITY_BOOKMARK_EMBED;
  } else if (require(5686) /* ApplicationCommandSectionType */.CommandOrigin.MINI_SHELF === arg0) {
    return require(5686) /* ApplicationCommandSectionType */.ApplicationCommandTriggerLocations.ACTIVITIES_MINI_SHELF;
  } else if (require(5686) /* ApplicationCommandSectionType */.CommandOrigin.VOICE_TILE_ACTIVITY_SUGGESTIONS === arg0) {
    return require(5686) /* ApplicationCommandSectionType */.ApplicationCommandTriggerLocations.VC_TILE_ACTIVITY_SUGGESTION;
  } else if (require(5686) /* ApplicationCommandSectionType */.CommandOrigin.APP_DMS_ENTRY_POINT_COMMAND_BUTTON === arg0) {
    return require(5686) /* ApplicationCommandSectionType */.ApplicationCommandTriggerLocations.APP_DMS_ENTRY_POINT_COMMAND_BUTTON;
  } else {
    return require(5686) /* ApplicationCommandSectionType */.ApplicationCommandTriggerLocations.SLASH_UI;
  }
}
