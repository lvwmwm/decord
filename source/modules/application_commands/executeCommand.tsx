...
// Dependencies: [5, 5401, 1996, 1909, 4853, 1922, 7524, 676, 4471, 7268, 709, 7509, 7266, 1955, 8439, 8441, 38, 8442, 4700, 7522, 8163, 4134, 1471, 7498, 8026, 7578, 8025, 8443, 8116, 7497, 7201, 5078, 1236, 5074, 7586, 2]
// Exports: default, retryCommandMessage

// Module 8438 (_executeCommand)
import ApplicationCommandSectionType from "ApplicationCommandSectionType" /* 7268 */;
import _fetchMessageInteractionDataAll from "_fetchMessageInteractionData" /* 8026 */;
...
import closure_10 from "handleInit" /* 7524 */;
...
function enqueueCommandInteraction(interactionLifecycleOptions) {
  ...
  if (null != context.channel) {
    ...
    obj1[0] = tmp10(7578).MessageDataType.COMMAND;
    obj1[1] = obj;
    onMessageSuccess(7578).enqueue(obj1, (ok) => {
      ({ nonce, applicationId, channelId, guildId } = callback);
      if (guildId == null) {
        guildId = null;
      }
    ...
    const obj6 = onMessageSuccess(7578);
  }
}
...
function getAnalyticsLocationFromCommandOrigin(arg0) {
  if (ApplicationCommandSectionType.CommandOrigin.APPLICATION_LAUNCHER === arg0) {
    return tmp(7268).ApplicationCommandTriggerLocations.APP_LAUNCHER;
  } else if (tmp(7268).CommandOrigin.APP_LAUNCHER_APPLICATION_VIEW === arg0) {
    return tmp(7268).ApplicationCommandTriggerLocations.APP_LAUNCHER_APPLICATION_VIEW;
  } else if (tmp(7268).CommandOrigin.IMAGE_RECS_MENU === arg0) {
    return tmp(7268).ApplicationCommandTriggerLocations.IMAGE_RECS_MENU;
  } else if (tmp(7268).CommandOrigin.IMAGE_RECS_SUBMENU === arg0) {
    return tmp(7268).ApplicationCommandTriggerLocations.IMAGE_RECS_SUBMENU;
  } else if (tmp(7268).CommandOrigin.ACTIVITY_INSTANCE_EMBED === arg0) {
    return tmp(7268).ApplicationCommandTriggerLocations.ACTIVITY_INSTANCE_EMBED;
  } else if (tmp(7268).CommandOrigin.ACTIVITY_BOOKMARK_EMBED === arg0) {
    return tmp(7268).ApplicationCommandTriggerLocations.ACTIVITY_BOOKMARK_EMBED;
  } else if (tmp(7268).CommandOrigin.MINI_SHELF === arg0) {
    return tmp(7268).ApplicationCommandTriggerLocations.ACTIVITIES_MINI_SHELF;
  } else if (tmp(7268).CommandOrigin.VOICE_TILE_ACTIVITY_SUGGESTIONS === arg0) {
    return tmp(7268).ApplicationCommandTriggerLocations.VC_TILE_ACTIVITY_SUGGESTION;
  } else if (tmp(7268).CommandOrigin.APP_DMS_ENTRY_POINT_COMMAND_BUTTON === arg0) {
    return tmp(7268).ApplicationCommandTriggerLocations.APP_DMS_ENTRY_POINT_COMMAND_BUTTON;
  } else {
    return tmp(7268).ApplicationCommandTriggerLocations.SLASH_UI;
  }
}
          ...
          if (0 === largestUploadedFileSize) {
            if (arg0 === 1) {
              ...
              handleUploadsTooLarge = function handleUploadsTooLarge(arg0) {
                ...
                let obj = callback2(8026);
                const intl = callback(1236).intl;
                obj = { maxSize: callback(5078).sizeString(dependencyMap) };
                obj.setFailed(closure_1, closure_1_11.ENTITY_TOO_LARGE, intl.formatToPlainString(callback(1236).t.fxEKdS, obj));
              };
              dependencyMap = lib(5078).maxFileSize(callback2);
            ...
            if (arg0 === 1) {
              ...
              if (largestUploadedFileSize <= Math.max(dependencyMap, closure_1_15)) {
                if (totalSize <= lib(5074).MAX_TOTAL_ATTACHMENT_SIZE) {
                  totalSize = 1;
            ...
            if (2 === tmp8) {
              ...
              if (arg0 === 1) {
                ...
                if (!someResult) {
                  someResult = totalSize > lib(5074).MAX_TOTAL_ATTACHMENT_SIZE;
                }
                let flag = !someResult;
                if (someResult) {
                  closure_1_4(c7);
