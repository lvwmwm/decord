...
// Dependencies: [19, 1934, 1376, 1415, 1218, 1372, 1942, 1862, 3883, 1874, 676, 8144, 589, 506, 1906, 2]
// Exports: buildPermissionContext, computeCommandContextType, getContextGuildId, usePermissionContext

// Module 8143 (computePermissions)
...
export const buildPermissionContext = function buildPermissionContext(channel, items) {
  ...
  if (null == obj) {
    let viewNsfwCommandsOrDefault = require(8144) /* resolveNsfwTogglesWithDefaults */.getViewNsfwCommandsOrDefault();
    id = id.getId();
    ...
    const obj2 = require(8144) /* resolveNsfwTogglesWithDefaults */;
    if (isThreadResult) {
