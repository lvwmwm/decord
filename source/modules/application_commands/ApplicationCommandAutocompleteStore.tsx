...
// Function ID: 7284
// Name: handleInit
// Dependencies: [7284, 676, 500, 1954, 4539, 589, 709, 2]

// Module 7283 (handleInit)
...
set = {
  ...
  APPLICATION_COMMAND_AUTOCOMPLETE_RESPONSE: function handleApplicationCommandAutocompleteResponse(arg0) {
    ...
    if (null == value) {
      ...
      obj[0] = num;
      obj[2] = mapped.length;
      _require(4539).trackWithMetadata(AnalyticEvents.APPLICATION_COMMAND_OPTION_STRING_AUTOCOMPLETE_PERFORMANCE, obj);
      map2.delete(nonce);
  ...
  INTERACTION_FAILURE: function handleInteractionFailure(nonce) {
    ...
    if (null == nonce) {
      ...
      if (null == value) {
        ...
        obj[0] = num;
        require(4539) /* collectGuildAnalyticsMetadata */.trackWithMetadata(AnalyticEvents.APPLICATION_COMMAND_OPTION_STRING_AUTOCOMPLETE_PERFORMANCE, obj);
        map2.delete(nonce);
        const channelId = value.channelId;
        if (!map1.has(channelId)) {
          const activeCommand = store.getActiveCommand(channelId);
