...
// Dependencies: [4130, 1921, 4960, 1954, 7456, 1233, 4681, 4865, 4494, 7390, 2]

// Module 9231 (get untranslatedDescription)
...
obj.execute = function execute(arg0, channel) {
  channel = channel.channel;
  if (null != channel) {
    const channelName = channel(4681).computeChannelName(channel, closure_4, closure_3);
    const intl5 = channel(1233).intl;
    let obj = { name: null };
    obj[0] = channelName;
    const obj5 = channel(4681);
