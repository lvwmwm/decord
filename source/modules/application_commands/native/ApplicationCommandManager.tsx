...
// Function ID: 11852
// Name: addGameMention
// Dependencies: [32, 4680, 7279, 676, 4778, 1623, 11443, 11442, 7277, 7022, 9583, 7024, 10042, 1954, 8401, 4209, 1626, 11603, 12, 11478, 4332, 11605, 11444, 4313, 4538, 9962, 2]

// Module 11851 (addGameMention)
...
prototype["buildGameMentionNode"] = function buildGameMentionNode(game) {
  ...
  const obj = { type: require(11443) /* addRule */.ChatInputNodeType.GAME_HIGHLIGHT, style: styles.gameMention(), deleteNodeOnBackspace: true, editDisabled: true };
  const merged = Object.assign(require(11442) /* findGameMentionTokens */.buildGameMentionResult(game));
  return obj;
};
...
prototype["mergePropsAndUpdate"] = function mergePropsAndUpdate(editId) {
  ...
  if (text === editId.text) {
    ...
    if (tmp91) {
      importDefault(8401).clearAll(channel.id, DraftType.SlashCommand);
      const obj7 = importDefault(8401);
    }
    let name;
    if (activeOption != null) {
      name = activeOption.name;
