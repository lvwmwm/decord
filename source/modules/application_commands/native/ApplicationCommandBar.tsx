...
// Dependencies: [32, 19, 17, 1942, 21, 4189, 712, 5030, 4717, 1236, 1297, 589, 11387, 5141, 4185, 7631, 8122, 11498, 2]
// Exports: default

// Module 11497 (ApplicationCommandOptionItem)
...
function ApplicationCommandOptionItem(arg0) {
  ...
  return closure_8(require(4717) /* PressableBase */.PressableOpacity, obj);
}
...
export default function _default(command) {
  ...
  if (tmp22) {
    ...
    obj1[1] = memo;
    tmp22 = callback2(section(5141), obj1);
  }
  const items5 = [tmp22, callback2(command(4185).Text, { style: tmp.applicationName, lineClamp: 1, variant: "text-sm/semibold", color: "mobile-text-heading-primary", children: `/ ${command.displayName}` }), , ];
  ...
  if (tmp4) {
    ...
    items7[1] = tmp25(tmp12(4185).Text, obj4);
  ...
  obj[5] = items5;
  const items8 = [c10(c6, obj), callback2(command(7631).FormDivider, { style: tmp.applicationDescriptionDivider }), callback2(stateFromStores, { command, option: currentOption, optionState: tmp17 }), callback2(command(7631).FormDivider, { style: tmp.applicationDescriptionDivider })];
  obj[1] = items8;
