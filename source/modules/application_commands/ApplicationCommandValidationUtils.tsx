...
// Dependencies: [4623, 5704, 8017, 1236, 11329, 2]
// Exports: getValidationResults

// Module 11328 (validateOptionContent)
...
function validateOptionContent(allowEmptyValues) {
  ...
  if (commandOrigin === undefined) {
    commandOrigin = require(5704) /* ApplicationCommandSectionType */.CommandOrigin.CHAT;
  }
  let str = "";
  if (null != content) {
    let obj = require(8017) /* getString */;
    obj = { content: null };
    obj[0] = content;
  ...
  if (null == content) {
    ...
    const tmp8 = importDefault(11329);
