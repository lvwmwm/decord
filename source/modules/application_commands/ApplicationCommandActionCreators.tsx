...
// Dependencies: [1218, 7305, 676, 38, 7052, 709, 530, 11, 1954, 2]
...
export const setActiveCommand = function setActiveCommand(command) {
  ...
  if (null != command) {
    importDefault(38)(command.inputType !== require(7052) /* ApplicationCommandSectionType */.ApplicationCommandInputType.PLACEHOLDER, "command should not be placeholder");
