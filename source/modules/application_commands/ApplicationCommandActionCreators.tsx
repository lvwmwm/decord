...
export const setActiveCommand = function setActiveCommand(command) {
  ...
  if (null != command) {
    importDefault(38)(command.inputType !== require(5704) /* ApplicationCommandSectionType */.ApplicationCommandInputType.PLACEHOLDER, "command should not be placeholder");
