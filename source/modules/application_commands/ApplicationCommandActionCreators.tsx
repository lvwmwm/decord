...
// Dependencies: [1194, 6072, 653, 44, 5686, 686, 507, 21, 1882, 2]
...
// Module 6071 (updateOptionStates)
...
export const setActiveCommand = function setActiveCommand(command) {
  ...
  if (null != command) {
    importDefault(44)(command.inputType !== require(5686) /* ApplicationCommandSectionType */.ApplicationCommandInputType.PLACEHOLDER, "command should not be placeholder");
