...
// Module 7914 (_isNativeReflectConstruct)
...
let closure_31 = { 562587111: "<string:1124139009>", 1422536617: "'ieri alle' p" };
    ...
    value() {
      ...
      this.syncWith(items, () => {
        ...
        if (locale !== oldLocale.oldLocale) {
          ...
          const collator = new Collator(locale, { 562587111: "<string:1124139009>", 1422536617: "'ieri alle' p" });
...
let closure_35 = Object.freeze({ applications: { "Bool(false)": null, "Bool(false)": null }, commands: { "Bool(false)": null, "Bool(false)": null } });
