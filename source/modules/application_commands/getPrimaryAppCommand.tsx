...
// Dependencies: [5, 19, 1391, 8387, 1954, 8395, 8391, 9591, 2]
...
// Module 10591 (_getPrimaryAppCommand)
...
function queryForPrimaryAppCommand(closure_0, id) {
  ...
  obj[0] = items;
  obj = { placeholderCount: 1, scoreMethod: require(8395) /* ScoreMethod */.ScoreMethod.COMMAND_ONLY, applicationId: id, allowFetch: false, allowApplicationState: true };
...
export const useQueryForPrimaryAppCommand = function useQueryForPrimaryAppCommand(arg0, applicationId) {
  let obj = { commandTypes: items };
  obj = { placeholderCount: 1, scoreMethod: require(8395) /* ScoreMethod */.ScoreMethod.COMMAND_ONLY, applicationId, allowFetch: false, allowApplicationState: true };
