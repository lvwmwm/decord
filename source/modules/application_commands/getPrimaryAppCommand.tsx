...
// Dependencies: [5, 19, 1391, 8383, 1954, 8391, 8387, 9587, 2]
...
// Module 10675 (_getPrimaryAppCommand)
...
function queryForPrimaryAppCommand(closure_0, id) {
  ...
  obj[0] = items;
  obj = { placeholderCount: 1, scoreMethod: require(8391) /* ScoreMethod */.ScoreMethod.COMMAND_ONLY, applicationId: id, allowFetch: false, allowApplicationState: true };
...
export const useQueryForPrimaryAppCommand = function useQueryForPrimaryAppCommand(arg0, applicationId) {
  let obj = { commandTypes: items };
  obj = { placeholderCount: 1, scoreMethod: require(8391) /* ScoreMethod */.ScoreMethod.COMMAND_ONLY, applicationId, allowFetch: false, allowApplicationState: true };
