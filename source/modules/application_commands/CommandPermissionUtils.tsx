...
// Dependencies: [1395, 1910, 4777, 676, 9585, 8388, 7024, 1954, 506, 9587, 38, 7022, 7023, 2]
// Exports: computeAllowedForChannel, hasAccess

// Module 9584 (computeAllowedForUser)
...
function computeAllowedForUser(permissions, guild_id, userId, roleIds, isImpersonating) {
  if (null == permissions) {
    ...
    if (!isImpersonating) {
      ...
      const tmp4 = permissions[obj.toPermissionKey(obj, userId, require(undefined, 7024) /* ApplicationCommandSectionType */.ApplicationCommandPermissionType.USER)];
      if (null != tmp4) {
    ...
    while (obj2 !== undefined) {
      ...
      let obj3 = require(7023) /* commandPermissions */;
      let tmp12 = permissions[obj3.toPermissionKey(obj3, tmp8, require(undefined, 7024) /* ApplicationCommandSectionType */.ApplicationCommandPermissionType.ROLE)];
      if (null != tmp12) {
        let tmp14 = tmp12;
        if (tmp13.permission) {
          let tmp15 = obj2;
    ...
    if (flag2) {
      ...
      let tmp17 = null;
      if (null != guild_id) {
        const obj4 = require(7023) /* commandPermissions */;
        tmp17 = permissions[obj4.toPermissionKey(obj4, guild_id, require(undefined, 7024) /* ApplicationCommandSectionType */.ApplicationCommandPermissionType.ROLE)];
      }
      let permission = null;
      if (null != tmp17) {
...
export const hasAccess = function hasAccess(type, arg1, applicationAllowedForChannel) {
  ...
  if (commandTypes.includes(type.type)) {
    ...
    if (null != context) {
      obj = require(8388) /* computePermissions */;
    ...
    } else if (type.inputType === require(7024) /* ApplicationCommandSectionType */.ApplicationCommandInputType.BOT) {
    ...
    if (type.applicationId === BuiltInSectionId.BUILT_IN) {
      ...
      let contextGuildId;
      if (null != context) {
        contextGuildId = require(8388) /* computePermissions */.getContextGuildId(context);
        const obj3 = require(8388) /* computePermissions */;
      }
        ...
        if (obj9.has(computedPermissions, Permissions.ADMINISTRATOR)) {
          ...
          if (isUserInstalled) {
            ...
            if (integration_types != null) {
              hasItem = integration_types.includes(require(9587) /* ApplicationIntegrationType */.ApplicationIntegrationType.USER_INSTALL);
            }
            if (hasItem) {
              return obj.ALLOWED;
            }
          ...
          if (context instanceof ChannelRecordBase) {
            ...
            if (null != permissions) {
              ...
              const obj4 = require(7023) /* commandPermissions */;
              const tmp28 = permissions[obj4.toPermissionKey(obj4, id, require(undefined, 7024) /* ApplicationCommandSectionType */.ApplicationCommandPermissionType.CHANNEL)];
              if (null != tmp28) {
                permission = tmp28.permission;
              } else {
                let tmp27Result = tmp27(7023);
                tmp27Result = tmp27(7022);
                const tmp30 = permissions[tmp27Result.toPermissionKey(tmp27Result, tmp27Result.allChannelsSentinel(contextGuildId), tmp27(undefined, 7024).ApplicationCommandPermissionType.CHANNEL)];
            ...
            if (false !== tmp38) {
              if (false !== applicationAllowedForUser) {
                if (null != type.defaultMemberPermissions) {
                  ...
                  if (!tmp53Result.equals(type.defaultMemberPermissions, require(7022) /* buildCommand */.DISABLED_BY_DEFAULT_PERMISSION_FLAG)) {
...
export const computeAllowedForChannel = function computeAllowedForChannel(permissions, context, guild_id) {
  if (null == permissions) {
    ...
    const obj = require(7023) /* commandPermissions */;
    const tmp3 = permissions[obj.toPermissionKey(obj, id2, require(undefined, 7024) /* ApplicationCommandSectionType */.ApplicationCommandPermissionType.CHANNEL)];
    if (null != tmp3) {
      return tmp3.permission;
    } else {
      let tmpResult = tmp(7023);
      tmpResult = tmp(7022);
      const tmp6 = permissions[tmpResult.toPermissionKey(tmpResult, tmpResult.allChannelsSentinel(guild_id), tmp(undefined, 7024).ApplicationCommandPermissionType.CHANNEL)];
      let permission = null;
      if (null != tmp6) {
