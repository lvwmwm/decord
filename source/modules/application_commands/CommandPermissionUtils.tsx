...
// Dependencies: [1390, 1908, 4960, 673, 9335, 9224, 7456, 1954, 503, 9174, 38, 7454, 7455, 2]
// Exports: computeAllowedForChannel, hasAccess

// Module 9334 (computeAllowedForUser)
...
import commandPermissions from "commandPermissions" /* 7455 */;
          ...
          if (context instanceof ChannelRecordBase) {
            ...
            if (null != permissions) {
              ...
              if (null != tmp28) {
                ...
                let tmp27Result = tmp27(7455);
                tmp27Result = tmp27(7454);
                const tmp30 = permissions[tmp27Result.toPermissionKey(tmp27Result, tmp27Result.allChannelsSentinel(contextGuildId), tmp27(undefined, 7456).ApplicationCommandPermissionType.CHANNEL)];
...
export const computeAllowedForChannel = function computeAllowedForChannel(permissions, context, guild_id) {
  if (null == permissions) {
    ...
    if (null != tmp3) {
      ...
      tmpResult = tmp(7454);
      const tmp6 = permissions[tmpResult.toPermissionKey(tmpResult, tmpResult.allChannelsSentinel(guild_id), tmp(undefined, 7456).ApplicationCommandPermissionType.CHANNEL)];
      let permission = null;
      if (null != tmp6) {
