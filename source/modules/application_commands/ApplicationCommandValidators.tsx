...
// Dependencies: [1994, 4702, 1954, 10053, 38, 1236, 10051, 7050, 10054, 2]

// Module 11617 (validateNumericOptionRange)
...
let obj = {
  ...
  [arg1(1954).ApplicationCommandOptionType.BOOLEAN]: (type) => {
    if ("text" !== type.type) {
      ...
      obj[0] = null != require(10053) /* toChoiceBooleanValue */.toChoiceBooleanValue(trimmed);
      return obj;
    }
  },
  ...
  [arg1(1954).ApplicationCommandOptionType.USER]: (type, arg1, id, throwTypeErrorResult) => {
    if ("text" === type.type) {
      ...
      obj2 = require(7050) /* buildCommand */;
      tmp = require;
    } else {
      obj = { success: null };
  ...
  [arg1(1954).ApplicationCommandOptionType.ATTACHMENT]: (type, name, channelId, arg3, closure_10) => {
    if ("text" !== type.type) {
      ...
      let obj = require(7050) /* buildCommand */;
