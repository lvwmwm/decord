...
// Dependencies: [32, 19, 1891, 8339, 4737, 676, 6980, 8347, 589, 8349, 1351, 1935, 8344, 9538, 6982, 2]
...
// Module 9537 (findCommandInSection)
...
export const getCachedResults = function getCachedResults(type, CHAT, query) {
  ...
  items = [CHAT];
  obj = { scoreMethod: require(8347) /* ScoreMethod */.ScoreMethod.COMMAND_OR_APPLICATION, allowFetch: false };
...
export const executeQuery = function executeQuery(type, commandTypes, placeholderCount) {
  ...
  for (let num3 = 0; num3 < num; num3 = num3 + 1) {
    ...
    obj[1] = require(6982) /* ApplicationCommandSectionType */.ApplicationCommandInputType.PLACEHOLDER;
    let _HermesInternal = HermesInternal;
  ...
  if (loading) {
    ...
    if (0 === descriptors.length) {
      const items2 = [require(8349) /* getOptionValue */.BUILT_IN_SECTIONS[BuiltInSectionId.BUILT_IN]];
      tmp14 = items2;
    }
  }
  obj[1] = tmp14;
