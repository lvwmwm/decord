...
// Dependencies: [32, 19, 1910, 8409, 4800, 676, 7050, 8417, 589, 8419, 1370, 1954, 8414, 9601, 7052, 2]
...
// Module 9600 (findCommandInSection)
...
export const getCachedResults = function getCachedResults(type, CHAT, query) {
  ...
  items = [CHAT];
  obj = { scoreMethod: require(8417) /* ScoreMethod */.ScoreMethod.COMMAND_OR_APPLICATION, allowFetch: false };
...
export const executeQuery = function executeQuery(type, commandTypes, placeholderCount) {
  ...
  for (let num3 = 0; num3 < num; num3 = num3 + 1) {
    ...
    obj[1] = require(7052) /* ApplicationCommandSectionType */.ApplicationCommandInputType.PLACEHOLDER;
    let _HermesInternal = HermesInternal;
  ...
  if (loading) {
    ...
    if (0 === descriptors.length) {
      const items2 = [require(8419) /* getOptionValue */.BUILT_IN_SECTIONS[BuiltInSectionId.BUILT_IN]];
      tmp14 = items2;
    }
  }
  obj[1] = tmp14;
