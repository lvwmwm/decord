...
// Dependencies: [32, 19, 1910, 8448, 5246, 676, 5245, 8456, 589, 8458, 1370, 1954, 8453, 9556, 5248, 2]
...
export const getCachedResults = function getCachedResults(type, CHAT, query) {
  ...
  items = [CHAT];
  obj = { scoreMethod: require(8456) /* ScoreMethod */.ScoreMethod.COMMAND_OR_APPLICATION, allowFetch: false };
...
export const executeQuery = function executeQuery(type, commandTypes, placeholderCount) {
  ...
  for (let num3 = 0; num3 < num; num3 = num3 + 1) {
    ...
    obj[1] = require(5248) /* ApplicationCommandSectionType */.ApplicationCommandInputType.PLACEHOLDER;
    let _HermesInternal = HermesInternal;
  ...
  if (loading) {
    ...
    if (0 === descriptors.length) {
      const items2 = [require(8458) /* getOptionValue */.BUILT_IN_SECTIONS[BuiltInSectionId.BUILT_IN]];
      tmp14 = items2;
    }
  }
  obj[1] = tmp14;
