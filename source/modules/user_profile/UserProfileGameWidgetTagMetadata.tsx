...
// Dependencies: [7031, 1236, 2]
// Exports: buildWidgetGameTagMetadata

// Module 12275 (WidgetGameTagIconRole)
...
let closure_2 = {
  [require(7031).WidgetGameTag.BETTER_THAN_YOU]: obj,
  [require(7031).WidgetGameTag.CASUAL]: obj,
  [require(7031).WidgetGameTag.INTERMEDIATE]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.EXPERT]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.OBSESSED]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.LOVE_IT]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.KIND_OF_LOVE_IT]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.KIND_OF_HATE_IT]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.RAGE_QUITTING]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.OPEN_TO_PLAY]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.LOOKING_FOR_GROUP]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.LOOKING_FOR_TIPS]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.OPEN_TO_TEACH]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
  ...
  [require(7031).WidgetGameTag.LOOKING_TO_DISCUSS]: {
    getText() {
      const intl = require(1236) /* getSystemLocale */.intl;
