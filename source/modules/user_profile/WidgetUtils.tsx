...
// Function ID: 7558
// Name: findGameWidget
// Dependencies: [32, 1921, 7554, 7558, 7559, 1383, 7560, 5071, 1233, 7556, 7555, 4301, 1372, 7561, 7562, 7563, 7565, 7247, 5073, 2]
...
import items3 from "items" /* 7556 */;
import _modDef7561 from "module_7561" /* 7561 */;
import convertClip from "convertClip" /* 7562 */;
...
import closure_6 from "initialize" /* 7558 */;
import items from "items" /* 7559 */;
import { ContentDismissActionType } from "ContentDismissActionType" /* 1383 */;
import { USER_WIDGET_CLIPS_GALLERY_MAX_LENGTH as closure_11 } from "USER_WIDGET_CLIPS_GALLERY_MAX_LENGTH" /* 7560 */;
...
function findGameWidget(widgetType) {
  ...
  const found = widgets.filter(_require(7556).isGameWidget);
  ...
  if (showEditingControls.showEditingControls) {
    if (games.games.length > 0) {
      if (1 === GAME_WIDGET_LIMITS_BY_TYPE.GAME_WIDGET_LIMITS_BY_TYPE[games.type]) {
        ...
        obj[0] = tmp(5071).GAME_WIDGET_LIMITS_BY_TYPE[games.type];
...
export const addWidgetToPending = function addWidgetToPending(type) {
  ...
  if (null == widgets.find((getUniqueKey) => {
    ...
    if (type.type === _require(7555).WidgetType.PERSONAL) {
      let tmp16Result = tmp16(4301);
    ...
    _modDef7561.setPendingWidgets(items);
    const obj6 = _modDef7561;
  }
};
export const removeWidgetFromPending = function removeWidgetFromPending(arg0) {
  ...
  _modDef7561.setPendingWidgets(found);
};
export const addPendingClipToClipsGalleryWidget = function addPendingClipToClipsGalleryWidget(arg0) {
  ...
  if (clips.length < closure_11) {
    ...
    _modDef7561.setPendingWidgets(replaceWidgetInList(clipsGalleryWidget));
    const obj3 = _modDef7561;
  }
};
export const updateClipTitleInClipsGalleryWidget = function updateClipTitleInClipsGalleryWidget(arg0, str) {
  ...
  if (null != found) {
    ...
    const clipsGalleryWidget = new _require(7562).ClipsGalleryWidget(obj);
    _modDef7561.setPendingWidgets(replaceWidgetInList(clipsGalleryWidget));
    const obj3 = _modDef7561;
  }
};
...
export const updateClipTagsInClipsGalleryWidget = function updateClipTagsInClipsGalleryWidget(arg0, arg1) {
  const _require = arg0;
  importDefault = arg1;
  if (arg1.length <= _require(5071).USER_WIDGET_GAME_TAGS_MAX_LENGTH) {
    if (closure_6.hasPendingChanges()) {
...
export const removeTagFromClip = function removeTagFromClip(arg0, arg1) {
  ...
  if (null != found) {
    ...
    if (tmp9) {
      ...
      _require = arg0;
      if (found2.length <= _require(5071).USER_WIDGET_GAME_TAGS_MAX_LENGTH) {
        ...
        if (null != found3) {
          ...
          const clipsGalleryWidget = new tmp10(7562).ClipsGalleryWidget(obj);
          found2(7561).setPendingWidgets(replaceWidgetInList(clipsGalleryWidget));
          const obj3 = found2(7561);
        }
      }
      tmp10 = _require;
    }
...
export const updatePersonalWidget = function updatePersonalWidget(arg0) {
  ...
  _modDef7561.setPendingWidgets(tmpResult);
};
export const updatePendingGameTags = function updatePendingGameTags(widgetType, arg1, tags) {
  const _require = arg1;
  if (tags.length <= Object.values(_require(7565).WidgetGameTag).length) {
    ...
    if (null != tmp5) {
      ...
      if (null != found) {
        ...
        obj.games = mapped;
        const baseGameWidget = new _require(7556).BaseGameWidget(obj);
        const tmp21 = replaceWidgetInList(baseGameWidget);
        obj(7561).setPendingWidgets(tmp21);
        const obj3 = obj(7561);
      }
    }
  }
    ...
    if (null != found) {
      if (null != found.tags) {
        if (0 !== found.tags.length) {
          ...
          if (found1.length <= Object.values(_require(7565).WidgetGameTag).length) {
            ...
            if (null != tmpResult) {
              ...
              if (null != found2) {
                ...
                obj.games = mapped;
                const baseGameWidget = new tmp4(7556).BaseGameWidget(obj);
                const tmp22 = replaceWidgetInList(baseGameWidget);
                obj(7561).setPendingWidgets(tmp22);
                const obj3 = obj(7561);
              }
            }
          }
  ...
  if (null != tmp) {
    ...
    if (null != found) {
      if (comment !== found.comment) {
        ...
        obj(7561).setPendingWidgets(tmp19);
        const obj3 = obj(7561);
      }
    }
  }
...
export const addPendingGameToWidget = function addPendingGameToWidget(ignoreMaxGames) {
  ...
  let num = 0;
  if (widgetType in game(5071).GAME_WIDGET_LIMITS_BY_TYPE) {
    num = tmp2(5071).GAME_WIDGET_LIMITS_BY_TYPE[widgetType];
  }
  if (null != tmp) {
    const games = tmp.games;
    let num2;
  ...
  obj.games = items1;
  const baseGameWidget = new tmp2(7556).BaseGameWidget(obj);
  const tmp7 = replaceWidgetInList;
  const tmp7Result = replaceWidgetInList(baseGameWidget);
  _modDef7561.setPendingWidgets(tmp7Result);
  const useGame = tmp2(7247).useGame;
          ...
          if (arg1 < items.length) {
            if (arg2 >= 0) {
              if (arg2 < items.length) {
                ...
                const tmp19 = replaceWidgetInList(baseGameWidget);
                _modDef7561.setPendingWidgets(tmp19);
                const obj2 = _modDef7561;
              }
            }
          }
...
export const removePendingGameFromWidget = function removePendingGameFromWidget(widgetType) {
  ...
  if (null != merged) {
    ...
    _modDef7561.setPendingWidgets(tmp13);
    const obj2 = _modDef7561;
  }
};
