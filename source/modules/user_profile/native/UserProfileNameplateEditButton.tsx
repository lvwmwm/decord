...
// Dependencies: [31, 27, 1918, 5510, 482, 33, 4131, 689, 566, 7882, 13664, 4099, 13665, 1935, 13651, 1212, 8008, 1273, 7904, 2]
// Exports: default

// Module 13663 (UserProfileNameplateEditButton)
...
export default function UserProfileNameplateEditButton(user) {
  ...
  if (isFetching) {
    ...
    obj.disabled = true;
    obj.hideArrow = true;
    return jsx(user(13651).UserProfileEditFormButton, {});
  } else {
    let name;
    ...
    if (null != nameplateData) {
      if (null != nameplateRecord) {
        if (null != nameplateProduct) {
          ...
          obj4.children = jsx(guildId(8008), { nameplate: nameplateData, fullOpacity: true, isSquarePreview: true });
          let tmp24 = <closure_5 style={tmp.previewContainer} />;
        }
        obj2.leading = tmp24;
        return tmp17(user(13651).UserProfileEditFormButton, obj2);
      }
    }
    const obj6 = { source: guildId(7904), style: tmp.noneIcon };
    tmp24 = jsx(user(1273).Icon, { source: guildId(7904), style: tmp.noneIcon });
    tmp17 = jsx;
  }
};
