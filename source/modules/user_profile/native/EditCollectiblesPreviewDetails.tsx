...
// Dependencies: [19, 17, 1946, 21, 4255, 589, 3901, 6907, 3925, 4251, 1236, 8060, 2]
// Exports: default

// Module 8080 (EditCollectiblesPreviewDescription)
import "noop";
...
function EditCollectiblesPreviewDescription(arg0) {
  ...
  let obj2 = require(6907) /* getItemRecordsFromPurchases */;
...
export default function EditCollectiblesPreviewDetails(previewSkuId) {
  ...
  const tmp = callback2();
  ({ product, purchase } = importDefault(8060)(previewSkuId));
  let tmp5Result = null;
