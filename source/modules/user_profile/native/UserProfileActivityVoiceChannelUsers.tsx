...
// Function ID: 12186
// Name: UserRow
// Dependencies: [19, 4341, 21, 8707, 589, 5300, 4444, 1297, 9357, 1236, 2]
// Exports: default

// Module 12185 (UserRow)
import "noop";
...
function UserRow(user) {
  ...
  const obj2 = user(589);
  obj[1] = importDefault(4444).getName(channel.guild_id, channel.id, user);
...
export default function UserProfileActivityVoiceChannelUsers(arg0) {
  ...
  obj[3] = jsx(require(9357) /* UserProfileStackedActionSheet */.UserProfileStackedActionSheetList, {
    data: users,
    keyExtractor(id) {
      return id.id;
    },
