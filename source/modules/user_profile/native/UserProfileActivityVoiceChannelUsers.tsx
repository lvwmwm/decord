...
// Function ID: 12370
// Name: UserRow
// Dependencies: [19, 4430, 21, 8858, 589, 5413, 4533, 1297, 9514, 1236, 2]
// Exports: default

// Module 12369 (UserRow)
import "noop";
...
function UserRow(user) {
  ...
  const obj2 = user(589);
  obj[1] = importDefault(4533).getName(channel.guild_id, channel.id, user);
...
export default function UserProfileActivityVoiceChannelUsers(arg0) {
  ...
  obj[3] = jsx(require(9514) /* UserProfileStackedActionSheet */.UserProfileStackedActionSheetList, {
    data: users,
    keyExtractor(id) {
      return id.id;
    },
