...
// Dependencies: [19, 21, 4460, 5650, 501, 1236, 4251, 5223, 12217, 2]
// Exports: default

// Module 12216 (UserProfileEditNoteModal)
import "noop";
...
export default function UserProfileEditNoteModal(arg0) {
  ...
  obj1[0] = obj2;
  obj[3] = obj1;
  return handleClose(require(5650) /* NavigationStack */.Navigator, obj);
};
