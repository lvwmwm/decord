...
// Dependencies: [19, 21, 4490, 5704, 501, 1236, 4281, 5253, 12251, 2]
// Exports: default

// Module 12250 (UserProfileEditNoteModal)
import "noop";
...
export default function UserProfileEditNoteModal(arg0) {
  ...
  obj1[0] = obj2;
  obj[3] = obj1;
  return handleClose(require(5704) /* NavigationStack */.Navigator, obj);
};
