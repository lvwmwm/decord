...
// Dependencies: [19, 21, 4507, 5723, 501, 1236, 4298, 5269, 12266, 2]
// Exports: default

// Module 12265 (UserProfileEditNoteModal)
import "noop";
...
export default function UserProfileEditNoteModal(arg0) {
  ...
  obj1[0] = obj2;
  obj[3] = obj1;
  return handleClose(require(5723) /* NavigationStack */.Navigator, obj);
};
