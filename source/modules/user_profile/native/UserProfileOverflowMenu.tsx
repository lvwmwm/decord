...
// Dependencies: [126746624, 330432512, 37093376, 251723776, 79429632, 488570880, 555548672, 769064960, 131072, 351272960, 57, 31, 27, 33, 4126, 689, 1273, 1212, 12026, 12027, 12023, 4124, 5157, 11627, 12028, 5183, 5184, 5767, 8477, 2, 8060, 6912, 3078144, 1785344, 8448, 3077888, 3004416, 1411072, 1055744, 310272, 1321472, 512, 451966976, 246218752, 78249984, 125632512, 246743040, 249102336, 37093376, 131072, 334495744]
// Exports: default

// Module 12022 (UserProfileOverflowMenu)
  ...
  if (!canRing) {
    ...
    if (!tmp73) {
      ...
      obj14.action = function action() {
        ...
        obj2.copy(displayProfile(channel[42]).getUserTag(user, { y: true, getEventLocationIconSource: true }));
      ...
      if (tidaWebformEnabled) {
        ...
        obj15.action = function action() {
          ...
          obj.onPress = function onPress() {
            ...
            obj2.copy(lib(closure_2[42]).getUserTag(bannerURL, { y: true, getEventLocationIconSource: true }));
          ...
          const obj3 = { -974029071: 705839377, 1943095332: 410124290, 1892736980: 402653184, -1646639375: 16777216, -694668313: 38014785, options: items };
          obj4 = {};
