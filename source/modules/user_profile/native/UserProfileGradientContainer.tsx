// Module ID: 11980
// Function ID: 11981
// Dependencies: [19, 21, 8374, 4611, 2]
...
const memoResult = require("noop").memo((arg0) => {
  ...
  const colors = require(8374) /* useUserProfileGradientColors */.useUserProfileGradientColors(primaryColor, secondaryColor, fallbackBackground);
