...
// Function ID: 12167
// Name: WidgetRenderer
// Dependencies: [32, 19, 17, 1218, 8440, 21, 4255, 712, 8774, 8785, 8442, 12167, 4251, 12171, 1856, 12172, 589, 1348, 12, 6978, 1236, 5628, 6981, 12174, 7002, 12175, 12279, 2]
// Exports: default

// Module 12166 (WidgetRenderer)
...
function WidgetRenderer(isFirstWidget) {
  ...
  if (widget instanceof require(7002) /* toSubmission */.ApplicationWidget) {
    let obj = { userId: null, widget: null, cardStyle: null, isFirstWidget: null };
    obj[0] = userId;
    obj[1] = widget;
    obj[2] = cardStyle;
    obj[3] = isFirstWidget.isFirstWidget;
    let tmp2Result = tmp2(importDefault(12175), obj);
  } else {
...
let closure_17 = importAllResult.memo((game) => {
  ...
  let tmp = callback4();
  ({ gameName, coverImageUrl } = importDefault(12171)(game.applicationId));
  ...
  const tmp4 = importDefault(12171)(game.applicationId);
  obj[2] = _require(8785).GameProfileSources.UserProfile;
  obj[3] = userId;
  let tmp5Result;
  ...
  if (!isNullOrEmptyResult) {
    ...
    const items3 = [tmp10(tmp6(12172).QuoteIcon, obj4), ];
...
let closure_18 = importAllResult.memo((game) => {
  ...
  ({ gameName, coverImageUrl } = importDefault(12171)(game.applicationId));
  let obj = { location: "UserProfileWidgetsBoard", applicationId: game.applicationId, source: null, sourceUserId: null, trackEntryPointImpression: true, stackingBehavior: "stack" };
  const tmp3 = importDefault(12171)(game.applicationId);
  obj[2] = _require(8785).GameProfileSources.UserProfile;
  obj[3] = userId;
  let tmp4Result;
  if (!disableInteraction) {
...
let closure_19 = importAllResult.memo((game) => {
  ...
  ({ userId, coverWidth, disableInteraction } = game);
  let tmp = callback4();
  ({ coverImageUrl, gameName } = importDefault(12171)(game.applicationId));
  let obj = { location: "UserProfileWidgetsBoard", applicationId: game.applicationId, source: null, sourceUserId: null, trackEntryPointImpression: true, stackingBehavior: "stack" };
  const tmp2 = importDefault(12171)(game.applicationId);
  obj[2] = _require(8785).GameProfileSources.UserProfile;
  obj[3] = userId;
  let tmp3Result;
  if (!disableInteraction) {
