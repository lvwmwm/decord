...
// Dependencies: [19, 21, 4187, 4688, 1236, 4688, 2]
// Exports: default

// Module 12045 (UserProfileConfirmThreadRemove)
import "noop";
...
export default function UserProfileConfirmThreadRemove(isForumPost) {
  ...
  obj1[2] = onConfirm;
  const items = [closure_3(require(4688) /* getAlertModalItemKey */.AlertActionButton, obj1, "remove-user-from-thread"), ];
  const obj2 = { variant: "secondary", text: null };
  const intl4 = tmp4(1236).intl;
  obj2[1] = intl4.string(require(1236) /* getSystemLocale */.t.yNbnce);
  items[1] = closure_3(require(4688) /* getAlertModalItemKey */.AlertActionButton, obj2, "cancel-remove-user-from-thread");
  obj[0] = items;
  obj[2] = callback(require(4688) /* getAlertModalItemKey */.AlertActions, obj);
  return closure_3(require(4688) /* getAlertModalItemKey */.AlertModal, obj);
};
