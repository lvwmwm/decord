...
// Dependencies: [32, 19, 17, 6938, 1928, 1971, 676, 21, 4285, 712, 7325, 5649, 5669, 698, 8188, 5377, 4281, 1236, 8200, 8203, 589, 13861, 8190, 13862, 8221, 8222, 8201, 9307, 4706, 10075, 2]
// Exports: default

// Module 13860 (EditNameplateInner)
...
function NameplateActionSheetPreview(arg0) {
  ...
  const tmp4 = purchase(8201)(previewSkuId);
  ...
  const items1 = [callback2(tmp10(9307).NameplateDummyUserPreview, { width: 100 }), callback2(tmp10(9307).NameplateDummyUserPreview, { width: 140 }), ];
  ...
  obj[1] = items1;
  const items3 = [closure_11(View, obj), callback2(tmp10(10075).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
  const obj2 = { style: tmp.nameplateGradientContainer, children: null };
  const items4 = [callback2(tmp10(9307).NameplateDummyUserPreview, { width: 140 }), callback2(tmp10(9307).NameplateDummyUserPreview, { width: 100 }), ];
  const obj3 = { style: tmp.nameplatePreviewGradient, start: { x: 0, y: 0.2 }, end: { x: 0, y: 0.9 }, colors: null };
  tmp2Result = tmp2(4706);
...
export default function EditNameplateActionSheet(arg0) {
  ...
  const analyticsLocations = first(5649)(first(5669).EDIT_NAMEPLATE_SHEET).analyticsLocations;
  const items = [first, guildId];
  callback = obj1.useCallback(() => {
    let obj = first(698);
    obj = { type: first(5669).EDIT_NAMEPLATE_SHEET, is_fullscreen: true };
  ...
  items1[1] = callback2(guildId(4281).Text, obj3);
  ...
  obj4[5] = tmp7(5669).EDIT_NAMEPLATE_SHEET;
  items2[1] = callback2(first(8200), obj4);
  obj[4] = items2;
  obj[1] = tmp12(guildId(5377).BottomSheet, obj);
  return callback2(guildId(5649).AnalyticsLocationProvider, obj);
};
