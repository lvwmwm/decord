...
// Dependencies: [32, 19, 17, 7164, 1948, 1992, 676, 21, 4380, 712, 7547, 5834, 5854, 698, 8421, 5503, 4376, 1236, 8431, 8434, 589, 14156, 8423, 14157, 8452, 8453, 8432, 9536, 4826, 10312, 2]
// Exports: default

// Module 14155 (EditNameplateInner)
...
function NameplateActionSheetPreview(arg0) {
  ...
  const tmp = callback4();
  const tmp4 = purchase(8432)(previewSkuId);
  ...
  const items1 = [callback2(tmp10(9536).NameplateDummyUserPreview, { width: 100 }), callback2(tmp10(9536).NameplateDummyUserPreview, { width: 140 }), ];
  ...
  obj[1] = items1;
  const items3 = [closure_11(View, obj), callback2(tmp10(10312).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
  const obj2 = { style: tmp.nameplateGradientContainer, children: null };
  const items4 = [callback2(tmp10(9536).NameplateDummyUserPreview, { width: 140 }), callback2(tmp10(9536).NameplateDummyUserPreview, { width: 100 }), ];
  const obj3 = { style: tmp.nameplatePreviewGradient, start: { x: 0, y: 0.2 }, end: { x: 0, y: 0.9 }, colors: null };
  tmp2Result = tmp2(4826);
...
export default function EditNameplateActionSheet(arg0) {
  ...
  const analyticsLocations = first(5834)(first(5854).EDIT_NAMEPLATE_SHEET).analyticsLocations;
  const items = [first, guildId];
  callback = obj1.useCallback(() => {
    let obj = first(698);
    obj = { type: first(5854).EDIT_NAMEPLATE_SHEET, is_fullscreen: true };
  ...
  items1[1] = callback2(guildId(4376).Text, obj3);
  ...
  obj4[5] = tmp7(5854).EDIT_NAMEPLATE_SHEET;
  items2[1] = callback2(first(8431), obj4);
  obj[4] = items2;
  obj[1] = tmp12(guildId(5503).BottomSheet, obj);
  return callback2(guildId(5834).AnalyticsLocationProvider, obj);
};
