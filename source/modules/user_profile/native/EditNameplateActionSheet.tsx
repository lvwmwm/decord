...
// Dependencies: [32, 19, 17, 7271, 1948, 1992, 676, 21, 4448, 712, 8048, 5921, 5941, 698, 8042, 5590, 4444, 1236, 8049, 8052, 589, 14258, 8044, 14259, 8071, 8072, 8050, 8489, 4908, 10820, 2]
// Exports: default

// Module 14257 (EditNameplateInner)
...
function NameplateActionSheetPreview(arg0) {
  ...
  const tmp = callback4();
  const tmp4 = purchase(8050)(previewSkuId);
  ...
  const items1 = [callback2(tmp10(8489).NameplateDummyUserPreview, { width: 100 }), callback2(tmp10(8489).NameplateDummyUserPreview, { width: 140 }), ];
  ...
  obj[1] = items1;
  const items3 = [closure_11(View, obj), callback2(tmp10(10820).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
  const obj2 = { style: tmp.nameplateGradientContainer, children: null };
  const items4 = [callback2(tmp10(8489).NameplateDummyUserPreview, { width: 140 }), callback2(tmp10(8489).NameplateDummyUserPreview, { width: 100 }), ];
...
export default function EditNameplateActionSheet(arg0) {
  ...
  const analyticsLocations = first(5921)(first(5941).EDIT_NAMEPLATE_SHEET).analyticsLocations;
  const items = [first, guildId];
  callback = obj1.useCallback(() => {
    let obj = first(698);
    obj = { type: first(5941).EDIT_NAMEPLATE_SHEET, is_fullscreen: true };
  ...
  items1[1] = callback2(guildId(4444).Text, obj3);
  ...
  obj4[5] = tmp7(5941).EDIT_NAMEPLATE_SHEET;
  items2[1] = callback2(first(8049), obj4);
  obj[4] = items2;
  obj[1] = tmp12(guildId(5590).BottomSheet, obj);
  return callback2(guildId(5921).AnalyticsLocationProvider, obj);
};
