...
// Dependencies: [32, 19, 17, 7087, 1947, 1990, 676, 21, 4342, 712, 7470, 5789, 5809, 698, 8335, 5458, 4338, 1236, 8347, 8350, 589, 14026, 8337, 14027, 8368, 8369, 8348, 9453, 4788, 10218, 2]
// Exports: default

// Module 14025 (EditNameplateInner)
...
function NameplateActionSheetPreview(arg0) {
  ...
  const tmp4 = purchase(8348)(previewSkuId);
  ...
  const items1 = [callback2(tmp10(9453).NameplateDummyUserPreview, { width: 100 }), callback2(tmp10(9453).NameplateDummyUserPreview, { width: 140 }), ];
  ...
  obj[1] = items1;
  const items3 = [closure_11(View, obj), callback2(tmp10(10218).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
  const obj2 = { style: tmp.nameplateGradientContainer, children: null };
  const items4 = [callback2(tmp10(9453).NameplateDummyUserPreview, { width: 140 }), callback2(tmp10(9453).NameplateDummyUserPreview, { width: 100 }), ];
...
export default function EditNameplateActionSheet(arg0) {
  ...
  const analyticsLocations = first(5789)(first(5809).EDIT_NAMEPLATE_SHEET).analyticsLocations;
  const items = [first, guildId];
  callback = obj1.useCallback(() => {
    let obj = first(698);
    obj = { type: first(5809).EDIT_NAMEPLATE_SHEET, is_fullscreen: true };
  ...
  obj4[5] = tmp7(5809).EDIT_NAMEPLATE_SHEET;
  items2[1] = callback2(first(8347), obj4);
  obj[4] = items2;
  obj[1] = tmp12(guildId(5458).BottomSheet, obj);
  return callback2(guildId(5789).AnalyticsLocationProvider, obj);
};
