...
// Dependencies: [19, 676, 21, 4189, 1581, 1480, 6241, 5515, 5535, 6505, 9321, 9322, 13739, 1236, 4185, 2]
// Exports: UserProfilePremiumUpsellCard

// Module 13738 (UserProfilePremiumUpsellCard)
...
export const UserProfilePremiumUpsellCard = function UserProfilePremiumUpsellCard(isTryItOut) {
  ...
  let nitroTrialCtaOverride = navigation(6241).useNitroTrialCtaOverride("user_profile_premium_upsell_card");
  const obj2 = navigation(6241);
  ...
  return jsx(tmp(13739), { style: tmp3.container, ctaText: null, showLinearGradient: true, onPress: null, children: null });
};
