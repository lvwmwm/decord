...
// Function ID: 12681
// Name: VerifiedIcon
// Dependencies: [19, 17, 1996, 4225, 5882, 676, 5233, 21, 1297, 4380, 712, 11135, 4101, 1363, 11140, 11141, 8935, 1367, 5232, 5108, 1435, 9079, 4588, 4094, 4348, 5862, 4097, 1236, 4376, 5480, 4100, 8105, 4949, 4108, 589, 12681, 5881, 5873, 12684, 2]
// Exports: UserProfileAccountConnectionsCard, UserProfileApplicationRoleConnectionsCard

// Module 12680 (VerifiedIcon)
...
import useUserProfileApplicationRoleConnectionsDefault from "useUserProfileApplicationRoleConnections" /* 12684 */;
...
const memoResult = importAllResult.memo((applicationRoleConnection) => {
  ...
  const tmp = callback3();
  let obj = applicationRoleConnection(11135);
  ...
  if (tmp3) {
    ...
    if (null != applicationRoleConnection.platform_name) {
      ...
      if (null != applicationRoleConnection.platform_username) {
        ...
        tmp15 = callback(tmp4(4376).Text, obj);
      }
    }
    const items = [tmp15, , ];
    let tmp17 = null;
    ...
    obj3[1] = callback(tmp4(4376).Text, obj4);
    ...
    return callback(tmp4(5480).TableRow, obj6);
  } else {
    ...
    if (null != applicationRoleConnection.platform_name) {
      ...
      tmp8Result = tmp8(tmp4(4376).Text, obj11);
    }
    ...
    if (null != applicationRoleConnection.platform_username) {
      ...
      tmp8Result = tmp8(tmp4(4376).Text, obj12);
    }
    items2[1] = tmp8Result;
    ...
    obj14[1] = callback(tmp4(4376).Text, obj15);
...
export const UserProfileAccountConnectionsCard = function UserProfileAccountConnectionsCard(userId) {
  ...
  const tmp2 = theme;
  ({ connections, appIdentities } = theme(12681)(userId));
  if (!stateFromStores) {
    const items2 = [];
    ...
    if (tmp4) {
      ...
      obj[2] = items2;
      let tmp12Result = tmp12(tmp5(5873).TableRowGroup, obj);
    } else {
      obj1 = { children: null };
      obj1[0] = items2;
      tmp12Result = tmp12(tmp5(5881).UserProfileCardRows, obj1);
    }
    obj[3] = tmp12Result;
    return closure_13(tmp2(5881), obj);
  }
  return null;
};
  ...
  if (!obj.useStateFromStores(items, () => obj.hidePersonalInformation)) {
    if (0 !== arr.length) {
      ...
      if (tmp4) {
        ...
        obj[2] = mapped;
        let tmp9Result = tmp9(tmp5(5873).TableRowGroup, obj);
      } else {
        obj1 = { children: null };
        obj1[0] = mapped;
        tmp9Result = tmp9(tmp5(5881).UserProfileCardRows, obj1);
      }
      obj[3] = tmp9Result;
