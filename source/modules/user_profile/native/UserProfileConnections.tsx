...
// Function ID: 12481
// Name: VerifiedIcon
// Dependencies: [19, 17, 1996, 4293, 5969, 676, 5320, 21, 1297, 4448, 712, 11137, 4167, 1363, 11142, 11143, 8526, 5319, 5195, 1431, 8609, 4668, 4160, 4416, 5949, 4163, 1236, 4444, 5567, 4166, 8691, 4174, 589, 12481, 5968, 5960, 12486, 2]
// Exports: UserProfileAccountConnectionsCard, UserProfileApplicationRoleConnectionsCard

// Module 12480 (VerifiedIcon)
import initialize from "initialize" /* 589 */;
import ThemesDefault from "Themes" /* 712 */;
import getAvatarURLDefault from "getAvatarURL" /* 1431 */;
import map from "map" /* 4167 */;
import UserProfileCardDefault from "UserProfileCard" /* 5968 */;
import useUserProfileApplicationRoleConnectionsDefault from "useUserProfileApplicationRoleConnections" /* 12486 */;
...
const memoResult = importAllResult.memo((applicationRoleConnection) => {
  ...
  const tmp = callback3();
  let obj = applicationRoleConnection(11137);
  ...
  if (null != applicationRoleConnection.platform_name) {
    ...
    if (null != applicationRoleConnection.platform_username) {
      ...
      tmp7 = callback(tmp2(4444).Text, obj);
    }
  }
  const items = [tmp7, , ];
  let tmp9 = null;
  ...
  obj3[1] = callback(applicationRoleConnection(4444).Text, obj4);
  ...
  return callback(applicationRoleConnection(5567).TableRow, obj6);
});
...
export const UserProfileAccountConnectionsCard = function UserProfileAccountConnectionsCard(userId) {
  ...
  const tmp5 = theme;
  ({ connections, appIdentities } = theme(12481)(userId));
  if (!stateFromStores) {
    const items2 = [];
    ...
    obj[1] = items2;
    obj[3] = callback(tmp2(5960).TableRowGroup, obj);
    return callback(tmp5(5968), obj);
  }
  return null;
};
export const UserProfileApplicationRoleConnectionsCard = function UserProfileApplicationRoleConnectionsCard(arg0) {
  ...
  if (!obj.useStateFromStores(items, () => obj.hidePersonalInformation)) {
    if (0 !== arr.length) {
      ...
      obj = { hasIcons: true, children: null };
      obj[1] = mapped;
      obj[3] = callback(tmp4(5960).TableRowGroup, obj);
