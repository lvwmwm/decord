...
// Function ID: 12182
// Name: VerifiedIcon
// Dependencies: [19, 17, 1946, 4029, 5563, 676, 4997, 21, 1297, 4189, 712, 10020, 3893, 4035, 10025, 10026, 8104, 1348, 4996, 4871, 1416, 8197, 4384, 3886, 4158, 5543, 3889, 1236, 4185, 5220, 3892, 7619, 4717, 3901, 589, 12182, 5562, 5554, 12185, 2]
// Exports: UserProfileAccountConnectionsCard, UserProfileApplicationRoleConnectionsCard

// Module 12181 (VerifiedIcon)
...
const memoResult = importAllResult.memo((applicationRoleConnection) => {
  ...
  const tmp = callback3();
  let obj = applicationRoleConnection(10020);
  ...
  if (tmp3) {
    ...
    if (null != applicationRoleConnection.platform_name) {
      ...
      if (null != applicationRoleConnection.platform_username) {
        ...
        tmp15 = callback(tmp4(4185).Text, obj);
      }
    }
    const items = [tmp15, , ];
    let tmp17 = null;
    ...
    obj3[1] = callback(tmp4(4185).Text, obj4);
    ...
    return callback(tmp4(5220).TableRow, obj6);
  } else {
    ...
    if (null != applicationRoleConnection.platform_name) {
      ...
      tmp8Result = tmp8(tmp4(4185).Text, obj11);
    }
    ...
    if (null != applicationRoleConnection.platform_username) {
      ...
      tmp8Result = tmp8(tmp4(4185).Text, obj12);
    }
    items2[1] = tmp8Result;
    ...
    obj14[1] = callback(tmp4(4185).Text, obj15);
...
export const UserProfileAccountConnectionsCard = function UserProfileAccountConnectionsCard(userId) {
  ...
  const tmp2 = theme;
  ({ connections, appIdentities } = theme(12182)(userId));
  if (!stateFromStores) {
    const items2 = [];
    ...
    if (tmp4) {
      ...
      obj[2] = items2;
      let tmp12Result = tmp12(tmp5(5554).TableRowGroup, obj);
    } else {
      obj1 = { children: null };
      obj1[0] = items2;
      tmp12Result = tmp12(tmp5(5562).UserProfileCardRows, obj1);
    }
    obj[3] = tmp12Result;
    return closure_13(tmp2(5562), obj);
  }
  return null;
};
export const UserProfileApplicationRoleConnectionsCard = function UserProfileApplicationRoleConnectionsCard(arg0) {
  ...
  const arr = importDefault(12185)(userId);
  ...
  if (!obj.useStateFromStores(items, () => obj.hidePersonalInformation)) {
    if (0 !== arr.length) {
      ...
      if (tmp4) {
        ...
        obj[2] = mapped;
        let tmp9Result = tmp9(tmp5(5554).TableRowGroup, obj);
      } else {
        const obj1 = { children: null };
        obj1[0] = mapped;
        tmp9Result = tmp9(tmp5(5562).UserProfileCardRows, obj1);
      }
      obj[3] = tmp9Result;
      return closure_13(importDefault(5562), obj);
    }
  }
  return null;
};
