...
// Function ID: 12406
// Name: VerifiedIcon
// Dependencies: [19, 17, 1975, 4141, 5716, 676, 5124, 21, 1297, 4302, 712, 10981, 4005, 4147, 10986, 10987, 8728, 1348, 5123, 4998, 1416, 8872, 4496, 3998, 4271, 5696, 4001, 1236, 4298, 5373, 4004, 7895, 4844, 4013, 589, 12406, 5715, 5707, 12409, 2]
// Exports: UserProfileAccountConnectionsCard, UserProfileApplicationRoleConnectionsCard

// Module 12405 (VerifiedIcon)
...
const memoResult = importAllResult.memo((applicationRoleConnection) => {
  ...
  const tmp = callback3();
  let obj = applicationRoleConnection(10981);
  ...
  if (tmp3) {
    ...
    if (null != applicationRoleConnection.platform_name) {
      ...
      if (null != applicationRoleConnection.platform_username) {
        ...
        tmp15 = callback(tmp4(4298).Text, obj);
      }
    }
    const items = [tmp15, , ];
    let tmp17 = null;
    ...
    obj3[1] = callback(tmp4(4298).Text, obj4);
    ...
    return callback(tmp4(5373).TableRow, obj6);
  } else {
    ...
    if (null != applicationRoleConnection.platform_name) {
      ...
      tmp8Result = tmp8(tmp4(4298).Text, obj11);
    }
    ...
    if (null != applicationRoleConnection.platform_username) {
      ...
      tmp8Result = tmp8(tmp4(4298).Text, obj12);
    }
    items2[1] = tmp8Result;
    ...
    obj14[1] = callback(tmp4(4298).Text, obj15);
...
export const UserProfileAccountConnectionsCard = function UserProfileAccountConnectionsCard(userId) {
  ...
  const tmp2 = theme;
  ({ connections, appIdentities } = theme(12406)(userId));
  if (!stateFromStores) {
    const items2 = [];
    ...
    if (tmp4) {
      ...
      obj[2] = items2;
      let tmp12Result = tmp12(tmp5(5707).TableRowGroup, obj);
    } else {
      obj1 = { children: null };
      obj1[0] = items2;
      tmp12Result = tmp12(tmp5(5715).UserProfileCardRows, obj1);
    }
    obj[3] = tmp12Result;
    return closure_13(tmp2(5715), obj);
  }
  return null;
};
export const UserProfileApplicationRoleConnectionsCard = function UserProfileApplicationRoleConnectionsCard(arg0) {
  ...
  const arr = importDefault(12409)(userId);
  ...
  if (!obj.useStateFromStores(items, () => obj.hidePersonalInformation)) {
    if (0 !== arr.length) {
      ...
      if (tmp4) {
        ...
        obj[2] = mapped;
        let tmp9Result = tmp9(tmp5(5707).TableRowGroup, obj);
      } else {
        const obj1 = { children: null };
        obj1[0] = mapped;
        tmp9Result = tmp9(tmp5(5715).UserProfileCardRows, obj1);
      }
      obj[3] = tmp9Result;
      return closure_13(importDefault(5715), obj);
    }
  }
  return null;
};
