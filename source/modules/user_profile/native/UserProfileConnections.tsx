...
// Function ID: 12754
// Name: VerifiedIcon
// Dependencies: [19, 17, 1996, 4289, 5948, 676, 5299, 21, 1297, 4444, 712, 11207, 4165, 1363, 11212, 11213, 9003, 1367, 5298, 5174, 1435, 9147, 4652, 4158, 4412, 5928, 4161, 1236, 4440, 5546, 4164, 8172, 5015, 4172, 589, 12754, 5947, 5939, 12757, 2]
// Exports: UserProfileAccountConnectionsCard, UserProfileApplicationRoleConnectionsCard

// Module 12753 (VerifiedIcon)
...
import useUserProfileApplicationRoleConnectionsDefault from "useUserProfileApplicationRoleConnections" /* 12757 */;
...
obj = { cardContainer: obj, cardTitle: { marginBottom: 0 }, refreshCardTitle: null, connectionRow: null, connectionInfoContainer: null, connectedAccountName: null, connectedAccountNameText: null, verifiedIconContainer: null, verifiedIcon: null, connectionMetadata: null, metadataItem: null, poweredByContainer: null, applicationIcon: null };
obj = { paddingBottom: CARD_PADDING - 12 };
Button = { marginBottom: ThemesDefault.space.PX_8 };
obj[2] = Button;
obj[3] = { flexDirection: "row", alignItems: "center", columnGap: CARD_ROWS_COLUMN_GAP, paddingVertical: 12, minHeight: 60 };
obj[4] = { flex: 1 };
obj[5] = { flexDirection: "row", alignItems: "center", columnGap: 4 };
obj[6] = { flexShrink: 1 };
obj[7] = { height: iconSize, width: iconSize };
obj[8] = { position: "absolute", left: 0, top: 0 };
obj[9] = { flexDirection: "row", flexWrap: "wrap", alignItems: "center", overflow: "hidden" };
createCacheKey = { color: ThemesDefault.colors.INTERACTIVE_TEXT_ACTIVE };
obj[10] = createCacheKey;
obj[11] = { flexDirection: "row", alignItems: "center", marginTop: 6 };
...
const memoResult = importAllResult.memo((applicationRoleConnection) => {
  ...
  const tmp = callback3();
  let obj = applicationRoleConnection(11207);
  ...
  if (tmp3) {
    ...
    if (null != applicationRoleConnection.platform_name) {
      ...
      if (null != applicationRoleConnection.platform_username) {
        ...
        tmp15 = callback(tmp4(4440).Text, obj);
      }
    }
    const items = [tmp15, , ];
    let tmp17 = null;
    ...
    obj3[1] = callback(tmp4(4440).Text, obj4);
    ...
    return callback(tmp4(5546).TableRow, obj6);
  } else {
    ...
    if (null != applicationRoleConnection.platform_name) {
      ...
      tmp8Result = tmp8(tmp4(4440).Text, obj11);
    }
    ...
    if (null != applicationRoleConnection.platform_username) {
      ...
      tmp8Result = tmp8(tmp4(4440).Text, obj12);
    }
    items2[1] = tmp8Result;
    ...
    obj14[1] = callback(tmp4(4440).Text, obj15);
...
export const UserProfileAccountConnectionsCard = function UserProfileAccountConnectionsCard(userId) {
  ...
  const tmp2 = theme;
  ({ connections, appIdentities } = theme(12754)(userId));
  if (!stateFromStores) {
    const items2 = [];
    ...
    obj[1] = intl.string(tmp5(1236).t["3fe7U5"]);
    obj[2] = tmp4 ? tmp.refreshCardTitle : tmp.cardTitle;
    if (tmp4) {
      obj = { hasIcons: true, children: null };
      obj[1] = items2;
      let tmp12Result = tmp12(tmp5(5939).TableRowGroup, obj);
    } else {
      obj1 = { children: null };
      obj1[0] = items2;
      tmp12Result = tmp12(tmp5(5947).UserProfileCardRows, obj1);
    }
    obj[3] = tmp12Result;
    return closure_13(tmp2(5947), obj);
  }
  return null;
};
export const UserProfileApplicationRoleConnectionsCard = function UserProfileApplicationRoleConnectionsCard(arg0) {
  ...
  if (!obj.useStateFromStores(items, () => obj.hidePersonalInformation)) {
    if (0 !== arr.length) {
      ...
      obj[0] = items1;
      const intl = tmp5(1236).intl;
      obj[1] = intl.string(tmp5(1236).t.PHjkRE);
      obj[2] = tmp4 ? tmp.refreshCardTitle : tmp.cardTitle;
      if (tmp4) {
        obj = { hasIcons: true, children: null };
        obj[1] = mapped;
        let tmp8Result = tmp8(tmp5(5939).TableRowGroup, obj);
      } else {
        obj1 = { children: null };
        obj1[0] = mapped;
        tmp8Result = tmp8(tmp5(5947).UserProfileCardRows, obj1);
      }
      obj[3] = tmp8Result;
