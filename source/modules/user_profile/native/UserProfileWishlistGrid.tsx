...
// Dependencies: [5, 19, 17, 7148, 10260, 9504, 9507, 9505, 1922, 4429, 7227, 8932, 676, 678, 1924, 21, 3, 4380, 712, 12686, 4108, 1363, 8935, 4347, 7147, 5854, 4376, 1236, 4815, 12309, 12687, 5834, 7796, 10189, 589, 12688, 12377, 12669, 12689, 4235, 4098, 12690, 4043, 5968, 4745, 10185, 501, 7902, 5959, 10241, 8930, 4056, 9723, 6040, 4058, 9580, 12691, 2009, 4335, 7896, 9822, 10258, 2]
// Exports: default

// Module 12685 (WishlistEmptyState)
...
import closure_7 from "initialize" /* 10260 */;
import closure_8 from "get" /* 9504 */;
import { isCollectiblesWishlistItemRecord as closure_9 } from "createCollectiblesItemFromServerResponse" /* 9507 */;
import { getWishlistProductLines } from "fromServer" /* 9505 */;
import closure_11 from "mergeGuildAvatar" /* 1922 */;
import closure_12 from "addSku" /* 4429 */;
import closure_13 from "createUserWidgetFromServer" /* 7227 */;
                              ...
                              if (!closure_1_13.has(throwTypeErrorResult.skuId)) {
                                ...
                                if (obj25.isCollectibleGiftingSupported()) {
                                  ...
                                  obj2[3] = function onNavigateAway(arg0) {
                                    callback(8930)({ userId: user.id, initialSection: closure_1_15.WISHLIST });
                                  };
