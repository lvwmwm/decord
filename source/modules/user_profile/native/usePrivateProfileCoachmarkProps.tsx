...
function PrivateProfileCoachmarkImage() {
  return <View style={callback().imageContainer}>{jsx(require(6691) /* PrivateProfileAbstractUI */.PrivateProfileAbstractUI, { width: 100, height: 67, resizeMode: "contain" })}</View>;
}
