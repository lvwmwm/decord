...
// Dependencies: [19, 17, 10069, 5716, 676, 685, 13828, 21, 13829, 3947, 5668, 5688, 13830, 4270, 13831, 1988, 8208, 8205, 8207, 1236, 8775, 13841, 5944, 5368, 712, 9397, 13842, 8220, 11204, 8247, 9383, 13844, 8215, 8776, 8763, 8772, 13845, 4298, 4013, 9384, 13846, 9385, 9404, 13851, 13852, 13857, 13859, 13863, 13864, 13868, 13872, 13877, 13878, 13881, 13882, 2]
// Exports: default

// Module 13827 (EditUserProfileBanner)
...
export default function UserProfileEditForm(arg0) {
  ...
  let _require;
  const tmp3 = importDefault(8775)();
  const tmp4 = importDefault(13841)();
  const tmp5 = importDefault(5944)();
  ...
  const tmp13Result1 = _require(8215);
  ({ theme, primaryColor, secondaryColor } = tmpResult(obj2));
  const tmpResult1Result = tmpResult(obj2);
  const userProfileColors = _require(8772).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  const tmp13Result2 = _require(8772);
  ...
  const tmpResult1 = importDefault(9384);
  const items4 = [, , , ];
  ({ avatarBackground: arr5[0], avatarPosition: arr5[1] } = tmp3);
  items4[2] = tmp4.avatarContainer;
  items4[3] = obj3;
  const items5 = [callback(closure_5, { style: items4, children: callback(importDefault(13846), obj10) }), ];
  ...
  const obj9 = { style: items4, children: callback(importDefault(13846), obj10) };
  const tmp39 = constants;
  const items7 = [callback(importDefault(9385), { customStatusActivity, hasCustomProfileTheme: null != primaryColor, style: tmp3.customStatusBubble, emojiOnlyStyle: tmp3.emojiOnlyCustomStatusBubble, editEnabled: true }), , ];
  ...
  const tmpResult2 = importDefault(9384);
  ...
  items7[1] = callback(importDefault(9404), obj13);
  ...
  const tmpResult3 = importDefault(9404);
  ...
  items9[1] = callback(importDefault(13851), obj17);
  tmp34Result = result;
  if (!result) {
  ...
  const tmpResult4 = importDefault(13851);
  ...
  items9[3] = callback(importDefault(13851), obj19);
  ...
  const tmpResult5 = importDefault(13851);
  ...
  items9[4] = callback(importDefault(13851), obj20);
  ...
  const tmpResult6 = importDefault(13851);
  if (isTryItOut) {
  ...
  obj21[4] = isTryItOut;
  items9[5] = callback(importDefault(13857), obj21);
  ...
  obj24[2] = tmp15Result;
  obj24[3] = isTryItOut;
  items9[8] = callback(importDefault(13864), obj24);
  items9[9] = callback(importDefault(13868), { user: currentUser, pendingProfileFrame, displayProfile: tmp15Result });
  items9[10] = callback(importDefault(13872), { user: currentUser, pendingNameplate });
  if (tmp34Result2) {
    let tmp53 = result;
    if (!result) {
      tmp53 = isTryItOut;
  ...
  const tmpResult9 = importDefault(13864);
  items9[12] = callback(closure_5, {
    ...
    children: callback(importDefault(13878), { user: currentUser, disabled: isSubmitting, tagStyle: { backgroundColor: containerBackground }, pendingPrimaryGuildId })
  });
