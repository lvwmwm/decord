...
// Dependencies: [19, 17, 10053, 5697, 676, 685, 13814, 21, 13815, 3930, 5649, 5669, 13816, 4253, 13817, 1988, 8191, 8188, 8190, 1236, 8758, 13827, 5925, 5349, 712, 9380, 13828, 8203, 11189, 8230, 9366, 13830, 8198, 8759, 8746, 8755, 13831, 4281, 3996, 9367, 13832, 9368, 9387, 13837, 13838, 13843, 13845, 13849, 13850, 13854, 13858, 13863, 13864, 13867, 13868, 2]
// Exports: default

// Module 13813 (EditUserProfileBanner)
...
export default function UserProfileEditForm(arg0) {
  ...
  let _require;
  const tmp3 = importDefault(8758)();
  const tmp4 = importDefault(13827)();
  const tmp5 = importDefault(5925)();
  ...
  const tmp13Result1 = _require(8198);
  ({ theme, primaryColor, secondaryColor } = tmpResult(obj2));
  const tmpResult1Result = tmpResult(obj2);
  const userProfileColors = _require(8755).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  const tmp13Result2 = _require(8755);
  ...
  items4[3] = obj3;
  const items5 = [callback(closure_5, { style: items4, children: callback(importDefault(13832), obj10) }), ];
  ...
  const obj9 = { style: items4, children: callback(importDefault(13832), obj10) };
  ...
  items9[1] = callback(importDefault(13837), obj17);
  tmp34Result = result;
  if (!result) {
  ...
  const tmpResult4 = importDefault(13837);
  ...
  items9[3] = callback(importDefault(13837), obj19);
  ...
  const tmpResult5 = importDefault(13837);
  ...
  items9[4] = callback(importDefault(13837), obj20);
  ...
  const tmpResult6 = importDefault(13837);
  if (isTryItOut) {
  ...
  obj21[4] = isTryItOut;
  items9[5] = callback(importDefault(13843), obj21);
  ...
  obj24[2] = tmp15Result;
  obj24[3] = isTryItOut;
  items9[8] = callback(importDefault(13850), obj24);
  items9[9] = callback(importDefault(13854), { user: currentUser, pendingProfileFrame, displayProfile: tmp15Result });
  items9[10] = callback(importDefault(13858), { user: currentUser, pendingNameplate });
  if (tmp34Result2) {
    let tmp53 = result;
    if (!result) {
      tmp53 = isTryItOut;
  ...
  const tmpResult9 = importDefault(13850);
  items9[12] = callback(closure_5, {
    ...
    children: callback(importDefault(13864), { user: currentUser, disabled: isSubmitting, tagStyle: { backgroundColor: containerBackground }, pendingPrimaryGuildId })
  });
  ...
  return callback(_require(3996).ThemeContextProvider, obj4);
};
