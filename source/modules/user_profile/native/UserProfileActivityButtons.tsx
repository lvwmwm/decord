...
// Dependencies: [5, 19, 1371, 1372, 4998, 4224, 1891, 10435, 3929, 3938, 1960, 4996, 4319, 676, 8903, 21, 4303, 712, 5728, 3919, 647, 12308, 12309, 7199, 4714, 1236, 7690, 10648, 4271, 11163, 9654, 1297, 8244, 11146, 3998, 12311, 8302, 4509, 4159, 7773, 4513, 5000, 1416, 10491, 6016, 8907, 11150, 1467, 8932, 2]
...
// Module 12307 (JoinActivityButton)
...
export const PlayOnSpotifyButton = function PlayOnSpotifyButton(arg0) {
  ...
  if (sync_id(9654)(activity)) {
    ...
    if (null != sync_id) {
      ...
      tmp4 = jsx(require(4714) /* Button */.Button, { size: null, source: null, disableColor: true, style: null });
    }
  }
  return tmp4;
};
export const WatchActivityButton = function WatchActivityButton(arg0) {
  ...
  ({ activity, onAction: require } = arg0);
  let importDefault;
  const tmp2 = importDefault(12311)(activity);
  importDefault = tmp2;
  let tmp3 = null;
  if (importDefault(8302)(activity)) {
    ...
    if (null != tmp2) {
      ...
      tmp3 = jsx(require(4714) /* Button */.Button, { text: null, variant: "secondary", onPress: null });
    }
  }
  return tmp3;
};
