...
let closure_11 = arg1(dependencyMap[6]).createStyles((arg0, arg1, arg2) => {
  let obj = {};
  obj = { useFramePreviewOverrideStore: true, explicitContentGuilds: true };
  let num = 263;
  if (null != arg2) {
    num = arg2;
  }
...
export default function UserProfilePreview(hideFrame) {
  ...
  const tmp22 = callback(React.useState({ "Null": "%FunctionPrototype%", "Null": "paddingStart" }), 2);
  const first = tmp22[0];
  callback = first;
  React = tmp22[1];
