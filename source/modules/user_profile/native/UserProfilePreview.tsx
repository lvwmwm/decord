...
let closure_11 = arg1(dependencyMap[6]).createStyles((arg0, arg1, arg2) => {
  let obj = {};
  obj = { "Bool(true)": "Array", "Bool(true)": "DragIcon" };
  let num = 263;
  if (null != arg2) {
    num = arg2;
  }
...
export default function UserProfilePreview(hideFrame) {
  ...
  const tmp22 = callback(React.useState({ aze: false, azj: true }), 2);
  const first = tmp22[0];
  callback = first;
  React = tmp22[1];
  ...
  const obj4 = { display: 0, flexDirection: 0, style: { flexShrink: 1 } };
