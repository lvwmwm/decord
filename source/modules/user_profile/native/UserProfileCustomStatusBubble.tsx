...
// Function ID: 9340
// Name: EmojiImage
// Dependencies: [32, 19, 17, 5643, 1877, 21, 4255, 712, 3928, 5221, 1416, 500, 4251, 5286, 8682, 9340, 9341, 4223, 9343, 5615, 1236, 4797, 9416, 2]

// Module 9339 (EmojiImage)
...
function EmojiOnlyStatusContent(arg0) {
  ...
  obj1[3] = str;
  obj[1] = closure_8(importDefault(5286), obj1);
...
let closure_13 = { [arg1(5643).UserProfileThemeTypes.PREVIEW]: { textVariant: "text-sm/normal", emojiOnlyEmojiSize: 26, textMinWidth: 53, statusBubblePaddingHorizontal: 10, statusBubblePaddingVertical: 6 } };
