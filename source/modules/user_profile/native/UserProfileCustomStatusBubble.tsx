...
// Function ID: 9369
// Name: EmojiImage
// Dependencies: [32, 19, 17, 5697, 1906, 21, 4285, 712, 3957, 5251, 1416, 500, 4281, 5340, 8711, 9369, 9370, 4253, 9372, 5669, 1236, 4827, 9445, 2]

// Module 9368 (EmojiImage)
...
function EmojiOnlyStatusContent(arg0) {
  ...
  obj1[3] = str;
  obj[1] = closure_8(importDefault(5340), obj1);
...
let closure_13 = { [arg1(5697).UserProfileThemeTypes.PREVIEW]: { textVariant: "text-sm/normal", emojiOnlyEmojiSize: 26, textMinWidth: 53, statusBubblePaddingHorizontal: 10, statusBubblePaddingVertical: 6 } };
