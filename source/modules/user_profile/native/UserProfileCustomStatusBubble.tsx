...
// Function ID: 11982
// Name: EmojiImage
// Dependencies: [32, 19, 17, 5567, 1877, 21, 4193, 712, 3866, 5145, 1416, 500, 4189, 5210, 8111, 9075, 9925, 4161, 11982, 5539, 1236, 4721, 11322, 2]
...
function TextStatusContent(arg0) {
  ...
  if (!isPlaceholderText) {
    ...
    obj[5] = items2;
    return closure_10(require(4189) /* Text */.Text, obj);
  } else {
...
function EmojiOnlyStatusContent(arg0) {
  ...
  obj1[3] = str;
  obj[1] = closure_8(importDefault(5210), obj1);
...
let closure_13 = { [arg1(5567).UserProfileThemeTypes.PREVIEW]: { textVariant: "text-sm/normal", emojiOnlyEmojiSize: 26, textMinWidth: 53, statusBubblePaddingHorizontal: 10, statusBubblePaddingVertical: 6 } };
