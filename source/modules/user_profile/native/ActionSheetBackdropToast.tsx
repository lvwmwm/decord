...
// Dependencies: [19, 17, 5324, 21, 500, 4255, 712, 1581, 1474, 5220, 4116, 4256, 4251, 2]
// Exports: ActionSheetBackdropToast

// Module 12405 (ActionSheetBackdropToast)
...
export const ActionSheetBackdropToast = function ActionSheetBackdropToast(children) {
  ...
  const diff = height - isExpanded(5220).NAV_BAR_HEIGHT_MULTILINE - importDefault(1581)().top;
  dependencyMap = diff;
