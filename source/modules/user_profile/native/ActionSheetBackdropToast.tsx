...
// Module 12032 (ActionSheetBackdropToast)
...
obj.container = obj;
obj1 = { size: "user", color: "flex", secondaryColor: "row", flex: "space-between", position: "wrap", overflow: 10, width: 12, backgroundColor: importDefault(dependencyMap[6]).colors.MOBILE_TOAST_BACKGROUND_DEFAULT, borderRadius: importDefault(dependencyMap[6]).radii.round };
obj.toast = obj1;
