...
// Dependencies: [19, 17, 4277, 9275, 8708, 5697, 676, 678, 21, 712, 4285, 12396, 589, 12403, 1348, 8711, 12397, 5649, 5637, 514, 12404, 9274, 4253, 6921, 5669, 4695, 11444, 1236, 12406, 4145, 4281, 7672, 5309, 12407, 2]
// Exports: default

// Module 12402 (UserProfileWishlistSuggestionsGridContent)
import v1 from "v1";
...
function UserProfileWishlistSuggestionsGridContent(arg0) {
  ...
  obj[2] = tmp4;
  const tmp3 = importDefault(12403);
  let tmp8 = null;
...
function WishlistSuggestionsGridContents(arg0) {
  ...
  if (0 === items2.length) {
    ...
    obj11[3] = importDefault(12397)(obj).cardWidth;
...
export default function UserProfileWishlistSuggestionsGrid(arg0) {
  let obj = require(12396) /* useIsMobileWishlistSuggestionsEnabled */;
  let tmp = null;
