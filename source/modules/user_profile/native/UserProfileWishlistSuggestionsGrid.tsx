...
// Dependencies: [19, 17, 4295, 9363, 8791, 5776, 676, 678, 21, 712, 4303, 12483, 589, 12490, 1367, 8794, 12484, 5728, 5716, 514, 12491, 9362, 4271, 7003, 5748, 4714, 11529, 1236, 12493, 4042, 4299, 7753, 5326, 12494, 2]
// Exports: default

// Module 12489 (UserProfileWishlistSuggestionsGridContent)
import v1 from "v1";
...
function UserProfileWishlistSuggestionsGridContent(arg0) {
  ...
  obj[2] = tmp4;
  const tmp3 = importDefault(12490);
  let tmp8 = null;
...
function WishlistSuggestionsGridContents(arg0) {
  ...
  if (0 === items2.length) {
    ...
    obj11[3] = importDefault(12484)(obj).cardWidth;
...
export default function UserProfileWishlistSuggestionsGrid(arg0) {
  let obj = require(12483) /* useIsMobileWishlistSuggestionsEnabled */;
  let tmp = null;
