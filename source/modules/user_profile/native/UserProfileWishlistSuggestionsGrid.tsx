...
// Dependencies: [19, 17, 4247, 9246, 8679, 5643, 676, 678, 21, 712, 4255, 12359, 589, 12366, 1348, 8682, 12360, 5595, 5583, 514, 12367, 9245, 4223, 6894, 5615, 4665, 11410, 1236, 12369, 4116, 4251, 7644, 5255, 12370, 2]
// Exports: default

// Module 12365 (UserProfileWishlistSuggestionsGridContent)
import v1 from "v1";
...
function UserProfileWishlistSuggestionsGridContent(arg0) {
  ...
  obj[2] = tmp4;
  const tmp3 = importDefault(12366);
  let tmp8 = null;
...
function WishlistSuggestionsGridContents(arg0) {
  ...
  if (0 === items2.length) {
    ...
    obj11[3] = importDefault(12360)(obj).cardWidth;
...
export default function UserProfileWishlistSuggestionsGrid(arg0) {
  let obj = require(12359) /* useIsMobileWishlistSuggestionsEnabled */;
  let tmp = null;
