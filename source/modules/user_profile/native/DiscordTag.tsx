...
// Function ID: 9025
// Name: DiscordTag
// Dependencies: [19, 17, 21, 4255, 712, 4251, 9025, 2]
// Exports: default

// Module 9024 (DiscordTag)
import "noop";
...
export default function DiscordTag(arg0) {
  ...
  if (null != nick) {
    ...
    obj[2] = nicknameStyle;
    obj[4] = nick;
    let tmp2Result = callback(require(4251) /* Text */.Text, obj);
  } else {
    tmp2Result = null;
    if (null != user) {
      ...
      items[1] = tmp2Result;
      obj[4] = items;
      tmp2Result = tmp2(require(4251) /* Text */.Text, obj);
      tmp4 = require;
    }
  }
  ...
  if (true === bot) {
    ...
    if (!hideBotTag) {
      ...
      tmp13 = callback(importDefault(9025), obj2);
      const tmp17 = importDefault(9025);
    }
  }
  items2[1] = tmp13;
  obj[1] = items2;
