...
// Dependencies: [5, 19, 17, 8266, 676, 21, 4303, 712, 5728, 3966, 4271, 4860, 13911, 8281, 5764, 5396, 1236, 7706, 5767, 5374, 7969, 13912, 589, 8280, 8312, 8309, 688, 8270, 13913, 13915, 4299, 1297, 13920, 2]
// Exports: default

// Module 13910 (ChangeBannerColorRow)
...
function ChangeBannerColorRow(user) {
  ...
  const rgb2intResult = tmp2Result.rgb2int(_require(8309).useDominantColorFromImage(pendingAvatarSrc, memoizedImageSourceResult));
  ...
  obj[0] = callback(_require(7969).FormLabel, obj1);
  ...
  const tmp2Result1 = _require(8309);
...
export default function ChangeBannerActionSheet(isTryItOut) {
  ...
  const items2 = [closure_9(require(7969) /* Form */.FormLabel, { text: stringResult }), ];
  ...
  const items3 = [closure_9(require(7969) /* Form */.FormSubLabel, obj5), ];
