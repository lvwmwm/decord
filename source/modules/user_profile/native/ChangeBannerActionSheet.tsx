...
function ChangeBannerColorRow(user) {
  ...
  const rgb2intResult = tmp2Result.rgb2int(_require(8352).useDominantColorFromImage(pendingAvatarSrc, memoizedImageSourceResult));
...
export default function ChangeBannerActionSheet(isTryItOut) {
  ...
  const items = [closure_9(require(5436) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj), ];
  tmp4Result = null;
  if (!flag) {
    let obj1 = { user: null };
    obj1[0] = user;
  ...
  const items2 = [closure_9(require(8012) /* Form */.FormLabel, { text: stringResult }), ];
  ...
  const items3 = [closure_9(require(8012) /* Form */.FormSubLabel, obj5), ];
  ...
  items1[1] = closure_9(require(5414) /* TableRowInner */.TableRow, obj4);
  if (showRemoveBanner) {
  ...
  items[1] = closure_10(require(5807) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items1 });
  obj10[0] = items;
  obj[1] = closure_10(require(5804) /* ActionSheet */.ActionSheet, obj10);
  return closure_9(require(5768) /* context */.AnalyticsLocationProvider, obj);
};
