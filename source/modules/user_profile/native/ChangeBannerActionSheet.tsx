...
// Dependencies: [5, 19, 17, 8185, 676, 21, 4285, 712, 5649, 3930, 4253, 4841, 5685, 5376, 1236, 7625, 5688, 5354, 7890, 13818, 589, 8198, 8230, 8227, 688, 8188, 13819, 13821, 4281, 1297, 13826, 2]
// Exports: default

// Module 13817 (ChangeBannerColorRow)
...
function ChangeBannerColorRow(user) {
  ...
  const rgb2intResult = tmp2Result.rgb2int(_require(8227).useDominantColorFromImage(pendingAvatarSrc, memoizedImageSourceResult));
  ...
  obj[0] = callback(_require(7890).FormLabel, obj1);
  ...
  const tmp2Result1 = _require(8227);
  ...
  return callback(_require(5354).TableRow, obj);
}
...
export default function ChangeBannerActionSheet(isTryItOut) {
  ...
  const items = [closure_9(require(5376) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj), ];
  tmp4Result = null;
  if (!flag) {
    let obj1 = { user: null };
    obj1[0] = user;
  ...
  const items2 = [closure_9(require(7890) /* Form */.FormLabel, { text: stringResult }), ];
  ...
  const items3 = [closure_9(require(7890) /* Form */.FormSubLabel, obj5), ];
  ...
  items1[1] = closure_9(require(5354) /* TableRowInner */.TableRow, obj4);
  if (showRemoveBanner) {
  ...
  items[1] = closure_10(require(5688) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items1 });
  obj10[0] = items;
  obj[1] = closure_10(require(5685) /* ActionSheet */.ActionSheet, obj10);
  return closure_9(require(5649) /* context */.AnalyticsLocationProvider, obj);
};
