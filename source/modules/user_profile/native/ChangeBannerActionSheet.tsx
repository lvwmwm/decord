...
// Dependencies: [5, 19, 17, 8044, 676, 21, 4255, 712, 5595, 3901, 4223, 4811, 5631, 5322, 1236, 7597, 5634, 5300, 7749, 13781, 589, 8057, 8089, 8086, 688, 8047, 13782, 13784, 4251, 1297, 13789, 2]
// Exports: default

// Module 13780 (ChangeBannerColorRow)
...
function ChangeBannerColorRow(user) {
  ...
  const rgb2intResult = tmp2Result.rgb2int(_require(8086).useDominantColorFromImage(pendingAvatarSrc, memoizedImageSourceResult));
  ...
  obj[0] = callback(_require(7749).FormLabel, obj1);
  ...
  const tmp2Result1 = _require(8086);
  ...
  return callback(_require(5300).TableRow, obj);
}
...
export default function ChangeBannerActionSheet(isTryItOut) {
  ...
  const items = [closure_9(require(5322) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj), ];
  tmp4Result = null;
  if (!flag) {
    let obj1 = { user: null };
    obj1[0] = user;
  ...
  const items2 = [closure_9(require(7749) /* Form */.FormLabel, { text: stringResult }), ];
  ...
  const items3 = [closure_9(require(7749) /* Form */.FormSubLabel, obj5), ];
  ...
  items1[1] = closure_9(require(5300) /* TableRowInner */.TableRow, obj4);
  if (showRemoveBanner) {
  ...
  items[1] = closure_10(require(5634) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items1 });
  obj10[0] = items;
  obj[1] = closure_10(require(5631) /* ActionSheet */.ActionSheet, obj10);
  return closure_9(require(5595) /* context */.AnalyticsLocationProvider, obj);
};
