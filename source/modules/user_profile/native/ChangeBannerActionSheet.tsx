...
// Dependencies: [5, 19, 17, 8305, 676, 21, 4344, 712, 5767, 4007, 4312, 4900, 13968, 8320, 5803, 5435, 1236, 7745, 5806, 5413, 8008, 13969, 589, 8319, 8351, 8348, 688, 8309, 13970, 13972, 4340, 1297, 13977, 2]
// Exports: default

// Module 13967 (ChangeBannerColorRow)
...
function ChangeBannerColorRow(user) {
  ...
  const rgb2intResult = tmp2Result.rgb2int(_require(8348).useDominantColorFromImage(pendingAvatarSrc, memoizedImageSourceResult));
  ...
  obj[0] = callback(_require(8008).FormLabel, obj1);
  ...
  const tmp2Result1 = _require(8348);
  obj4[3] = _require(688).int2hex(pendingAccentColor);
  items2[1] = callback(_require(4340).Text, obj4);
  ...
  return callback(_require(5413).TableRow, obj);
}
...
export default function ChangeBannerActionSheet(isTryItOut) {
  ...
  const items = [closure_9(require(5435) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj), ];
  tmp4Result = null;
  if (!flag) {
    let obj1 = { user: null };
    obj1[0] = user;
  ...
  const items2 = [closure_9(require(8008) /* Form */.FormLabel, { text: stringResult }), ];
  ...
  const items3 = [closure_9(require(8008) /* Form */.FormSubLabel, obj5), ];
  ...
  items1[1] = closure_9(require(5413) /* TableRowInner */.TableRow, obj4);
  if (showRemoveBanner) {
  ...
  items[1] = closure_10(require(5806) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items1 });
  obj10[0] = items;
  obj[1] = closure_10(require(5803) /* ActionSheet */.ActionSheet, obj10);
  return closure_9(require(5767) /* context */.AnalyticsLocationProvider, obj);
};
