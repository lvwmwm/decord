...
// Dependencies: [5, 19, 17, 8202, 676, 21, 4302, 712, 5668, 3947, 4270, 4858, 5704, 5395, 1236, 7644, 5707, 5373, 7907, 13832, 589, 8215, 8247, 8244, 688, 8205, 13833, 13835, 4298, 1297, 13840, 2]
// Exports: default

// Module 13831 (ChangeBannerColorRow)
...
function ChangeBannerColorRow(user) {
  ...
  const rgb2intResult = tmp2Result.rgb2int(_require(8244).useDominantColorFromImage(pendingAvatarSrc, memoizedImageSourceResult));
  ...
  obj[0] = callback(_require(7907).FormLabel, obj1);
  ...
  const tmp2Result1 = _require(8244);
  obj4[3] = _require(688).int2hex(pendingAccentColor);
  items2[1] = callback(_require(4298).Text, obj4);
  ...
  return callback(_require(5373).TableRow, obj);
}
...
export default function ChangeBannerActionSheet(isTryItOut) {
  ...
  const items = [closure_9(require(5395) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj), ];
  tmp4Result = null;
  if (!flag) {
    let obj1 = { user: null };
    obj1[0] = user;
  ...
  const items2 = [closure_9(require(7907) /* Form */.FormLabel, { text: stringResult }), ];
  ...
  const items3 = [closure_9(require(7907) /* Form */.FormSubLabel, obj5), ];
  ...
  items1[1] = closure_9(require(5373) /* TableRowInner */.TableRow, obj4);
  if (showRemoveBanner) {
  ...
  items[1] = closure_10(require(5707) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items1 });
  obj10[0] = items;
  obj[1] = closure_10(require(5704) /* ActionSheet */.ActionSheet, obj10);
  return closure_9(require(5668) /* context */.AnalyticsLocationProvider, obj);
};
