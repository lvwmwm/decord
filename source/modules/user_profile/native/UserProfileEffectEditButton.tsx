...
// Module 13479 (UserProfileEffectEditButton)
...
export default function UserProfileEffectEditButton(isTryItOut) {
  ...
  if (fetchCollectiblesProduct.isFetching) {
    ...
    if (null != profilePreviewValue) {
      ...
      const obj7 = { style: "<string:4149346306>", value: "<string:295619838>", minimumValue: "<string:20046913>", skuId: profilePreviewValue.skuId };
