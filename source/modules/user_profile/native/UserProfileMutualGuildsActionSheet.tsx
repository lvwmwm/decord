...
// Dependencies: [19, 17, 21, 4189, 712, 11692, 11693, 11694, 11695, 11699, 2]
// Exports: default

// Module 11691 (UserProfileMutualGuildsActionSheet)
import "noop";
...
export default function UserProfileMutualGuildsActionSheet(user) {
  ...
  const mutualGuilds = onPressMutualGuild(11692)(user).mutualGuilds;
  let length;
  const tmp4 = onPressMutualGuild(11693);
  if (mutualGuilds != null) {
    length = mutualGuilds.length;
  }
  let obj = { scrollable: true, title: onPressMutualGuild(11694)(length), children: null };
  ...
  if (null == mutualGuilds) {
    ...
    obj1[1] = tmp3(user(11695).NoMutualServers, {});
    ...
    tmp3Result = tmp3(user(11693).UserProfileStackedActionSheetList, obj2);
  }
  obj[1] = tmp3Result;
