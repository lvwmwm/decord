...
// Dependencies: [19, 17, 5776, 6896, 21, 4303, 712, 1297, 7704, 4299, 4725, 691, 2]
// Exports: default

// Module 13955 (UserProfileUpsellCard)
import "noop";
...
export default function UserProfileUpsellCard(headerText) {
  ...
  if (null != headerText) {
    ...
    const items1 = [tmp2(tmp3(7704).NitroWheelIcon, obj1), ];
    const obj2 = { variant: "heading-sm/bold", children: null };
    obj2[1] = headerText;
    items1[1] = tmp2(tmp3(4299).Text, obj2);
    obj[1] = items1;
