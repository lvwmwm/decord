...
let closure_9 = _module1.createStyles((arg0) => {
  let obj = { avatarPosition: obj, avatarBackground: obj, avatar: obj1, profileContentWrapper: obj2, profileContent: obj3, customStatusBubble: obj4, customStatusBubbleInset: obj5, emojiOnlyCustomStatusBubble: { marginBottom: 4 }, primaryInfo: { accessibilityRole: "version=$(node -p \"require('./package.json').version\") && sed -i '' \"s/#define NITRO_VERSION \\\".*\\\"/#define NITRO_VERSION \\\"$version\\\"/\" ./cpp/utils/NitroDefines.hpp", TypeError: "bun run write-native-version" }, primaryButtons: { paddingVertical: 12 }, bannerButtons: obj6, bannerButtonsWithPrivateBanner: { top: 54 } };
  ...
  const obj4 = { visible: null, transparent: "\u{1F9D0}", marginLeft: closure_2 - closure_4 + closure_3 };
  const obj6 = { 0: 759239012, 9223372036854775807: 1912603216, 0: 24, 0: 24, 9223372036854775807: -653573887, zIndex: closure_8 };
