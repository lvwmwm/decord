...
// Dependencies: [19, 17, 21, 4302, 712, 1609, 5398, 7907, 500, 5396, 4844, 1236, 5273, 4298, 2]
// Exports: UserProfileStackedActionSheetList, UserProfileStackedActionSheetSectionList, default

// Module 9403 (UserProfileStackedActionSheet)
import "noop";
...
export default function UserProfileStackedActionSheet(onBack) {
  ...
  if (tmp4Result) {
    ...
    obj[2] = onBack;
    obj[3] = tmp4(tmp5(5273).ArrowLargeLeftIcon, { size: "md" });
    tmp4Result = tmp4(tmp5(4844).PressableOpacity, obj);
  }
  const items1 = [tmp4Result, closure_4(require(4298) /* Text */.Text, { variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", children: title }), ];
  if (tmp4Result) {
...
export const UserProfileStackedActionSheetList = function UserProfileStackedActionSheetList(data) {
  ...
  return closure_4(data(5398).BottomSheetFlatList, obj);
};
export const UserProfileStackedActionSheetSectionList = function UserProfileStackedActionSheetSectionList(renderItem) {
  ...
  return callback(renderItem(5398).BottomSheetSectionList, obj);
};
