...
export default function UserProfileCard(arg0) {
  ...
  if (tmp5Result) {
    ...
    if (tmp5Result) {
      ...
      obj1[3] = str2;
      obj1[5] = title;
      items1[1] = closure_6(require(4338) /* Text */.Text, obj1);
      items1[2] = titleIcon;
      obj[1] = items1;
...
export const UserProfileFormRow = function UserProfileFormRow(arg0) {
  ...
  items[1] = callback(require(4338) /* Text */.Text, { variant: "text-md/semibold", color: labelColor, style: tmp.rowLabelText, children: label });
