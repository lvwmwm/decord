...
// Function ID: 9466
// Name: Heading
// Dependencies: [19, 17, 1975, 1971, 1891, 5716, 676, 1479, 21, 4302, 4005, 712, 4298, 1236, 9466, 589, 5123, 11, 9468, 5719, 9470, 1297, 8872, 5668, 8728, 9471, 8723, 4270, 4153, 1222, 5761, 4160, 1607, 9477, 4712, 5715, 2]
// Exports: default
...
function Heading(children) {
  ...
  return closure_11(require(4298) /* Text */.Text, { accessibilityRole: "header", variant, color: "user-profile-about-me-heading-text", style: { marginBottom }, children: children.children });
}
function TextWithIcon(themeType) {
  ...
  const items1 = [icon, callback(require(4298) /* Text */.Text, { variant: tmp2.textVariant, color: "text-default", children })];
  obj[3] = items1;
...
function Bio(arg0) {
  ...
  if (null != previewBio) {
    ...
    if ("" !== previewBio) {
      ...
      obj[3] = lineClamp;
      items[1] = callback(importDefault(9466), obj);
      obj[0] = items;
...
function MemberJoinDates(userId) {
  ...
  if (tmp13Result) {
    ...
    obj4[1] = tmp15(importDefault(5719), obj5);
    ...
    const tmp9Result = importDefault(5719);
  }
...
function FriendsSinceDate(themeType) {
  ...
  let obj = require(9470) /* useFriendsSinceDate */;
...
function PolicyLink(children) {
  ...
  obj[2] = callback(require(4298) /* Text */.Text, { variant: tmp.textVariant, color: "text-link", children: children.label });
...
export default function UserProfileAboutMeCard(arg0) {
  ...
  items1[4] = tmp7Result;
  obj[1] = items1;
  return tmp5(importDefault(5715), obj);
};
