...
// Function ID: 9420
// Name: Heading
// Dependencies: [19, 17, 1946, 1942, 1862, 5643, 676, 1479, 21, 4255, 3959, 712, 4251, 1236, 9420, 589, 5076, 11, 9422, 5646, 9424, 1297, 8826, 5595, 8682, 9425, 8677, 4223, 4107, 1222, 5715, 4114, 1579, 9431, 4665, 5642, 2]
// Exports: default
...
function Bio(arg0) {
  ...
  if (null != previewBio) {
    ...
    if ("" !== previewBio) {
      ...
      obj[3] = lineClamp;
      items[1] = callback(importDefault(9420), obj);
      obj[0] = items;
...
function MemberJoinDates(userId) {
  ...
  if (tmp13Result) {
    ...
    obj4[1] = tmp15(importDefault(5646), obj5);
    ...
    const tmp9Result = importDefault(5646);
  }
...
function FriendsSinceDate(themeType) {
  ...
  let obj = require(9424) /* useFriendsSinceDate */;
...
export default function UserProfileAboutMeCard(arg0) {
  ...
  items1[4] = tmp7Result;
  obj[1] = items1;
  return tmp5(importDefault(5642), obj);
};
