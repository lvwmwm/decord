...
function Heading(children) {
  ...
  return closure_11(require(4299) /* Text */.Text, { accessibilityRole: "header", variant, color: "user-profile-about-me-heading-text", style: { marginBottom }, children: children.children });
}
function TextWithIcon(themeType) {
  ...
  const items1 = [icon, callback(require(4299) /* Text */.Text, { variant: tmp2.textVariant, color: "text-default", children })];
  obj[3] = items1;
...
function MemberJoinDates(userId) {
  ...
  if (tmp13Result) {
    ...
    obj4[1] = tmp15(importDefault(5779), obj5);
    ...
    const tmp9Result = importDefault(5779);
  }
...
function PolicyLink(children) {
  ...
  obj[2] = callback(require(4299) /* Text */.Text, { variant: tmp.textVariant, color: "text-link", children: children.label });
...
export default function UserProfileAboutMeCard(arg0) {
  ...
  items1[4] = tmp7Result;
  obj[1] = items1;
  return tmp5(importDefault(5775), obj);
};
