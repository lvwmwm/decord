...
// Function ID: 9449
// Name: Heading
// Dependencies: [19, 17, 1975, 1971, 1891, 5697, 676, 1479, 21, 4285, 3988, 712, 4281, 1236, 9449, 589, 5106, 11, 9451, 5700, 9453, 1297, 8855, 5649, 8711, 9454, 8706, 4253, 4136, 1222, 5742, 4143, 1607, 9460, 4695, 5696, 2]
// Exports: default
...
function Heading(children) {
  ...
  let variant = require(3988) /* map */.useToken(importDefault(712).modules.mobile.USER_PROFILE_ABOUT_ME_HEADING_TEXT_STYLE);
  if (variant == null) {
...
function MemberJoinDates(userId) {
  ...
  if (tmp13Result) {
    ...
    obj4[1] = tmp15(importDefault(5700), obj5);
    ...
    const tmp9Result = importDefault(5700);
  }
...
export default function UserProfileAboutMeCard(arg0) {
  ...
  items1[4] = tmp7Result;
  obj[1] = items1;
  return tmp5(importDefault(5696), obj);
};
