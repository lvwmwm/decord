...
// Dependencies: [31, 27, 653, 33, 4131, 689, 1324, 11949, 4127, 2]
// Exports: default

// Module 11948 (UserProfileActivityTimebar)
import "result";
...
export default function UserProfileActivityTimebar(arg0) {
  ...
  let tmp4;
  ({ elapsed, duration, percentage } = importDefault(11949)({ start, end }));
  if (!tmp) {
  ...
  const tmp3 = importDefault(11949)({ start, end });
  const tmp8 = callback;
  const tmp9 = tmp;
  obj3.children = require(11949) /* extractTimeComponents */.formatTime(elapsed);
  ...
  obj4.color = str2;
  const obj7 = require(11949) /* extractTimeComponents */;
  const tmp10 = callback;
  const tmp11 = tmp;
  obj4.children = require(11949) /* extractTimeComponents */.formatTime(duration);
