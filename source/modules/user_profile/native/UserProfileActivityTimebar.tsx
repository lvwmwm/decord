...
// Dependencies: [19, 17, 676, 21, 4189, 712, 1348, 12010, 4185, 2]
// Exports: default

// Module 12009 (UserProfileActivityTimebar)
import "noop";
...
export default function UserProfileActivityTimebar(arg0) {
  ...
  let tmp5;
  ({ elapsed, duration, percentage } = importDefault(12010)({ start, end }));
  if (!tmp2) {
