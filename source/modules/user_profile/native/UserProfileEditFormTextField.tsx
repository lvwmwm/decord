...
// Dependencies: [19, 21, 7758, 7685, 2]
// Exports: default

// Module 13800 (UserProfileEditFormTextField)
import "noop";
...
export default function UserProfileEditFormTextField(inputRef) {
  ...
  if (numberOfLines > 1) {
    ...
    let tmp9 = jsx(require(7758) /* TextArea */.TextArea, { ref: null });
  } else {
    obj = { ref: null };
    obj[0] = inputRef;
    const merged3 = Object.assign(obj);
    obj.isClearable = true;
    tmp9 = jsx(require(7685) /* TextInput */.TextInput, { ref: null });
  }
  return tmp9;
};
