...
const result = arg1(dependencyMap[6]).fileFinishedImporting("modules/user_profile/native/useUserProfileOverscrollStyles.tsx");
...
export default function useUserProfileOverscrollStyles(arg0) {
  ...
  let sharedValue = obj1.useSharedValue(0);
  ...
  obj1 = { interpolate: arg1(dependencyMap[5]).interpolate, position: sharedValue, minScrollPosition: -bannerHeight, SCALE_FACTOR: 1.5, translateOnScale: result, isNegativeScrollPosition: derivedValue };
  O.__closure = obj1;
  O.__workletHash = 5375176079092;
  O.__initData = closure_8;
  const bannerImageAnimatedStyle = arg1(dependencyMap[5]).useAnimatedStyle(O);
  ...
  const obj2 = { isNegativeScrollPosition: derivedValue, position: sharedValue, coefficient: stateFromStores };
  fn2.__closure = obj2;
  fn2.__workletHash = 16539417859130;
  fn2.__initData = closure_9;
  const contentAnimatedStyle = arg1(dependencyMap[5]).useAnimatedStyle(fn2);
  ...
  obj3 = { clamp: arg1(dependencyMap[5]).clamp, interpolate: arg1(dependencyMap[5]).interpolate, position: sharedValue, windowHeight: height, coefficient: stateFromStores };
  A.__closure = obj3;
  A.__workletHash = 849678936428;
  A.__initData = closure_10;
  const blurAnimatedProps = arg1(dependencyMap[5]).useAnimatedProps(A);
  ...
  const fn3 = function y(arg0, arg1) {
    let tmp = arg0 !== arg1;
    if (tmp) {
      tmp = height(sharedValue[5]).runOnJS(tmp10)(arg0);
      const obj = height(sharedValue[5]);
    }
    return tmp;
  };
  obj5 = { runOnJS: arg1(dependencyMap[5]).runOnJS, setShowBlur: tmp10 };
  fn3.__closure = obj5;
  fn3.__workletHash = 6548835412849;
  fn3.__initData = closure_12;
  const animatedReaction = arg1(dependencyMap[5]).useAnimatedReaction(H, fn3);
