...
// Dependencies: [32, 19, 17, 5953, 1388, 505, 21, 712, 4445, 12443, 6203, 1377, 8008, 8424, 1950, 4412, 14249, 2009, 1236, 14236, 6000, 10669, 1297, 8024, 2]
// Exports: default

// Module 14248 (COLLECTIBLES_PREVIEW_SIZE)
...
export default function UserProfileFrameEditButton(arg0) {
  ...
  if (canViewProfileFramesInCollectiblesShop) {
    ...
    if (fetchCollectiblesProduct.isFetching) {
      ...
      obj1[2] = NOOP;
      obj1[3] = tmp19(tmp2(6000).ActivityIndicator, { animating: true, size: "large" });
      obj2 = obj1;
    } else {
      ...
      obj2[1] = tmp19(tmp2(14236).UserProfileEditFormLabelBadges, obj3);
      ...
      if (null != first1) {
        ...
        obj5[1] = tmp19(guildId(10669), obj6);
        let tmp19Result = tmp19(View, obj5);
        const tmp24 = guildId(10669);
      } else {
    ...
    return jsx(tmp2(14236).UserProfileEditFormButton, obj2);
  } else {
    return null;
  }
};
