...
// Dependencies: [32, 19, 17, 5948, 1388, 505, 21, 712, 4444, 9617, 6197, 1377, 8490, 10335, 1950, 4411, 14222, 2009, 1236, 14209, 5995, 9609, 1297, 8509, 2]
// Exports: default

// Module 14221 (COLLECTIBLES_PREVIEW_SIZE)
...
export default function UserProfileFrameEditButton(arg0) {
  ...
  if (canViewProfileFramesInCollectiblesShop) {
    ...
    if (fetchCollectiblesProduct.isFetching) {
      ...
      obj1[2] = NOOP;
      obj1[3] = tmp19(tmp2(5995).ActivityIndicator, { animating: true, size: "large" });
      obj2 = obj1;
    } else {
      ...
      obj2[1] = tmp19(tmp2(14209).UserProfileEditFormLabelBadges, obj3);
      ...
      if (null != first1) {
        ...
        obj5[1] = tmp19(guildId(9609), obj6);
        let tmp19Result = tmp19(View, obj5);
        const tmp24 = guildId(9609);
      } else {
    ...
    return jsx(tmp2(14209).UserProfileEditFormButton, obj2);
  } else {
    return null;
  }
};
