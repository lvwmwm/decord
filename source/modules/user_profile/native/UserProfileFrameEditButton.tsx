...
// Dependencies: [32, 19, 17, 7224, 1388, 505, 21, 712, 4668, 9270, 7404, 1377, 8415, 10416, 1949, 4346, 14120, 2008, 1236, 14104, 5451, 9262, 1297, 8436, 2]
// Exports: default

// Module 14119 (COLLECTIBLES_PREVIEW_SIZE)
...
export default function UserProfileFrameEditButton(arg0) {
  ...
  if (canViewProfileFramesInCollectiblesShop) {
    ...
    if (fetchCollectiblesProduct.isFetching) {
      ...
      obj1[2] = NOOP;
      obj1[3] = tmp19(tmp2(5451).ActivityIndicator, { animating: true, size: "large" });
      obj2 = obj1;
    } else {
      ...
      obj2[1] = tmp19(tmp2(14104).UserProfileEditFormLabelBadges, obj3);
      ...
      if (null != first1) {
        ...
        obj5[1] = tmp19(guildId(9262), obj6);
        let tmp19Result = tmp19(View, obj5);
        const tmp24 = guildId(9262);
      } else {
    ...
    return jsx(tmp2(14104).UserProfileEditFormButton, obj2);
  } else {
    return null;
  }
};
