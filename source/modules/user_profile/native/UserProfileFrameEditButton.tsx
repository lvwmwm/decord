...
// Dependencies: [32, 19, 17, 5882, 1388, 505, 21, 712, 4380, 9549, 6131, 1377, 8423, 10267, 1950, 4347, 14150, 2009, 1236, 14136, 5929, 9541, 1297, 8442, 2]
// Exports: default

// Module 14149 (COLLECTIBLES_PREVIEW_SIZE)
...
export default function UserProfileFrameEditButton(arg0) {
  ...
  if (canViewProfileFramesInCollectiblesShop) {
    ...
    if (fetchCollectiblesProduct.isFetching) {
      ...
      obj1[2] = NOOP;
      obj1[3] = tmp19(tmp2(5929).ActivityIndicator, { animating: true, size: "large" });
      obj2 = obj1;
    } else {
      ...
      obj2[1] = tmp19(tmp2(14136).UserProfileEditFormLabelBadges, obj3);
      ...
      if (null != first1) {
        ...
        obj5[1] = tmp19(guildId(9541), obj6);
        let tmp19Result = tmp19(View, obj5);
        const tmp24 = guildId(9541);
      } else {
    ...
    return jsx(tmp2(14136).UserProfileEditFormButton, obj2);
  } else {
    return null;
  }
};
