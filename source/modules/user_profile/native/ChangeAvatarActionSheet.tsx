...
// Dependencies: [19, 17, 1874, 676, 21, 4285, 712, 589, 3931, 5646, 5337, 1236, 7625, 5649, 5315, 7777, 13810, 2]
// Exports: default

// Module 13825 (ChangeAvatarActionSheet)
import "noop";
...
export default function ChangeAvatarActionSheet(showRemoveAvatar) {
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(5315).TableRow, obj1);
  }
  items2[1] = tmp8Result;
  if (showAnimatedAvatarUpsell) {
    ...
    const items3 = [tmp8(tmp2(7777).FormLabel, obj4), ];
    ...
    const items4 = [tmp8(tmp2(7777).FormSubLabel, obj7), ];
  ...
  if (tmp8Result) {
    ...
    obj11[1] = tmp8(tmp2(7777).FormLabel, obj12);
    obj10[0] = tmp8(View, obj11);
    obj10[1] = handleEditAvatarDecorationSelect;
    tmp8Result = tmp8(tmp2(5315).TableRow, obj10);
  }
  items2[3] = tmp8Result;
  if (flag) {
    ...
    obj13[0] = tmp8(tmp2(7777).FormLabel, obj14);
    obj13[1] = handleRemoveAvatarSelect;
    flag = tmp8(tmp2(5315).TableRow, obj13);
  }
