...
// Dependencies: [19, 17, 1874, 676, 21, 4255, 712, 589, 3901, 5617, 5308, 1236, 7613, 5620, 5286, 7765, 13776, 2]
// Exports: default

// Module 13791 (ChangeAvatarActionSheet)
import "noop";
...
export default function ChangeAvatarActionSheet(showRemoveAvatar) {
  ...
  if (isPremiumResult) {
    isPremiumResult = tmp8(tmp2(7613).NitroWheelIcon, {});
  }
  obj[1] = isPremiumResult;
  ({ titleWrapper: obj3[2], titleContainer: obj3[3] } = tmp);
  const items1 = [closure_6(require(5308) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj), ];
  ...
  const items2 = [closure_6(require(5286) /* TableRowInner */.TableRow, obj), , , , ];
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(5286).TableRow, obj1);
  }
  items2[1] = tmp8Result;
  if (showAnimatedAvatarUpsell) {
    ...
    const items3 = [tmp8(tmp2(7765).FormLabel, obj4), ];
    const obj5 = { style: null, size: "sm" };
    obj5[0] = tmp.nitroWheel;
    items3[1] = tmp8(tmp2(7613).NitroWheelIcon, obj5);
    obj3[1] = items3;
    ...
    const items4 = [tmp8(tmp2(7765).FormSubLabel, obj7), ];
    ...
    obj8[1] = tmp8(importDefault(13776), obj9);
    items4[1] = tmp8(View, obj8);
    obj6[0] = items4;
    obj2[1] = tmp7(closure_8, obj6);
    showAnimatedAvatarUpsell = tmp8(tmp2(5286).TableRow, obj2);
    const tmp5Result = importDefault(13776);
  }
  ...
  if (tmp8Result) {
    ...
    obj11[1] = tmp8(tmp2(7765).FormLabel, obj12);
    obj10[0] = tmp8(View, obj11);
    obj10[1] = handleEditAvatarDecorationSelect;
    tmp8Result = tmp8(tmp2(5286).TableRow, obj10);
  }
  items2[3] = tmp8Result;
  if (flag) {
    ...
    obj13[0] = tmp8(tmp2(7765).FormLabel, obj14);
    obj13[1] = handleRemoveAvatarSelect;
    flag = tmp8(tmp2(5286).TableRow, obj13);
  }
  const obj15 = { children: null };
  items2[4] = flag;
  items1[1] = closure_7(require(5620) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items2 });
  obj15[0] = items1;
  return closure_7(require(5617) /* ActionSheet */.ActionSheet, obj15);
};
