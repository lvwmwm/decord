...
// Dependencies: [19, 17, 8834, 5816, 21, 4342, 8837, 12023, 12337, 4310, 12029, 2007, 8832, 6000, 4887, 12370, 1297, 4338, 12030, 12037, 5819, 12024, 2]
// Exports: default

// Module 12576 (UserProfileMutuals)
...
export default function UserProfileMutuals(user) {
  ...
  ({ mutualFriends, mutualGuilds } = guildId(12023)(user));
  if (guildId(12337)(user)) {
    ...
    if (tmp8) {
      ...
      if (!tmp7) {
        ...
        obj5[0] = tmp2(5819).GuildIconSizes.XXSMALL;
        ...
        tmp21 = callback(tmp2(12037).GuildIconPile, obj5);
      }
      const items2 = [tmp21, ];
      const obj6 = { variant: null, color: null, children: null };
      obj6[0] = c8;
      obj6[1] = c9;
      obj6[2] = tmp5(12024)(mutualGuilds.length);
      items2[1] = callback(tmp2(4338).Text, obj6);
      obj4[3] = items2;
      tmp9Result = tmp9(tmp2(4887).PressableOpacity, obj4);
    }
    items1[2] = tmp9Result;
    obj[1] = items1;
