...
// Dependencies: [19, 17, 4100, 676, 21, 4448, 712, 8498, 647, 4444, 1236, 9021, 2]
// Exports: default

// Module 12578 (RemediatedUserNotice)
...
export default function RemediatedUserNotice(user) {
  ...
  if (isBlocked) {
    ...
    if (isBlocked) {
      ...
      isBlocked = callback(tmp4(4444).Text, obj);
    }
    ...
    if (isIgnored) {
      ...
      const items3 = [callback(tmp4(4444).Text, obj2), callback(tmp4(4444).Text, { variant: "text-sm/semibold", color: "text-default", accessibilityElementsHidden: true, importantForAccessibility: "no", children: "\u2022" }), ];
