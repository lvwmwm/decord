...
// Dependencies: [19, 21, 4342, 5795, 1236, 12066, 5836, 4338, 2]
// Exports: default

// Module 12558 (UserProfileGameFriendsCard)
import "noop";
...
export default function UserProfileGameFriendsCard(arg0) {
  ...
  found = importDefault(5795)(applicationIds).filter((arg0) => null != arg0);
  if (0 === found.length) {
    return null;
  } else {
  ...
  const arr = importDefault(5795)(applicationIds);
};
