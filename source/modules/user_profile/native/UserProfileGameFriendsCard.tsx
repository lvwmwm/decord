...
// Dependencies: [19, 21, 4255, 5601, 1236, 11869, 5642, 4251, 2]
// Exports: default

// Module 12352 (UserProfileGameFriendsCard)
import "noop";
...
export default function UserProfileGameFriendsCard(arg0) {
  ...
  found = importDefault(5601)(applicationIds).filter((arg0) => null != arg0);
  if (0 === found.length) {
    return null;
  } else {
  ...
  const arr = importDefault(5601)(applicationIds);
};
