...
// Dependencies: [19, 21, 4342, 5774, 1236, 12048, 5815, 4338, 2]
// Exports: default

// Module 12540 (UserProfileGameFriendsCard)
import "noop";
...
export default function UserProfileGameFriendsCard(arg0) {
  ...
  found = importDefault(5774)(applicationIds).filter((arg0) => null != arg0);
  if (0 === found.length) {
    return null;
  } else {
  ...
  const arr = importDefault(5774)(applicationIds);
};
