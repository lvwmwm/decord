...
// Dependencies: [19, 21, 4344, 5773, 1236, 12045, 5814, 4340, 2]
// Exports: default
...
export default function UserProfileGameFriendsCard(arg0) {
  ...
  found = importDefault(5773)(applicationIds).filter((arg0) => null != arg0);
  if (0 === found.length) {
    return null;
  } else {
  ...
  const arr = importDefault(5773)(applicationIds);
};
