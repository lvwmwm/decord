...
// Dependencies: [19, 21, 4303, 5734, 1236, 11988, 5775, 4299, 2]
// Exports: default

// Module 12476 (UserProfileGameFriendsCard)
import "noop";
...
export default function UserProfileGameFriendsCard(arg0) {
  ...
  found = importDefault(5734)(applicationIds).filter((arg0) => null != arg0);
  if (0 === found.length) {
    return null;
  } else {
  ...
  const arr = importDefault(5734)(applicationIds);
};
