...
// Dependencies: [19, 17, 8830, 21, 4344, 712, 13997, 4312, 13998, 2007, 13999, 1236, 13993, 4340, 2]
// Exports: default

// Module 13996 (UserProfileBadgesEditButton)
...
export default function UserProfileBadgesEditButton(badges) {
  ...
  if (isBadgeManagementEnabled) {
    if (0 !== badges.length) {
      ...
      obj[1] = callback(tmp2(4340).Text, obj1);
      ...
      if (tmp11Result) {
        ...
        obj3[1] = "+" + diff;
        tmp11Result = tmp11(tmp2(4340).Text, obj3);
      }
      items[1] = tmp11Result;
      obj2[2] = items;
      ...
      obj[3] = obj4;
      obj[4] = tmp6;
      return callback(tmp2(13993).UserProfileEditFormButton, obj);
    }
  }
  return null;
};
