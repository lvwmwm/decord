// Module ID: 9049
// Function ID: 9050
// Dependencies: [19, 17, 5948, 5570, 21, 9050, 9003, 4637, 4288, 9051, 9040, 9052, 1629, 9038, 9047, 5928, 4161, 9053, 4184, 9057, 9683, 1236, 9748, 2]

// Module 9049
import getNicknameDefault from "getNickname" /* 4637 */;
import useProfileThemeDefault from "useProfileTheme" /* 9038 */;
...
import useBadgesDefault from "useBadges" /* 9051 */;
import useUserProfileOverscrollStylesDefault from "useUserProfileOverscrollStyles" /* 9052 */;
...
const memoResult = importAllResult.memo(function NonUserBotProfileContent(scrollPosition) {
  ...
  let obj = trackUserProfileAction(9003);
  ...
  const userProfileColors = trackUserProfileAction(9047).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null == user) {
    ...
    obj[6] = showBlur;
    const items = [callback(tmp(9053), obj), ];
    ...
    obj1[1] = guildId;
    obj1[2] = tmp13;
    const items1 = [callback(tmp4(9057).OpenableUserProfileAvatar, obj1), ];
    ...
    items4[1] = obj9;
    obj8[3] = items4;
    obj7[1] = callback(tmp(9748), obj8);
    items3[1] = callback(View, obj7);
    obj2[1] = items3;
    items1[1] = closure_8(View, obj2);
    obj[1] = items1;
    items[1] = closure_8(tmp(4184).View, obj);
    obj6[0] = items;
    return closure_8(closure_9, obj6);
  }
  const tmp4Result = trackUserProfileAction(9047);
});
