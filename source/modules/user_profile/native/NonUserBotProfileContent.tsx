// Module ID: 8936
// Function ID: 8937
// Dependencies: [19, 17, 6010, 5632, 21, 8547, 8575, 4673, 4322, 8563, 8927, 8937, 1627, 8545, 8549, 5990, 4193, 8938, 4217, 8572, 8940, 1233, 9054, 2]

// Module 8936
import getNicknameDefault from "getNickname" /* 4673 */;
import useProfileThemeDefault from "useProfileTheme" /* 8545 */;
import useSharedStylesDefault from "useSharedStyles" /* 8547 */;
import useBadgesDefault from "useBadges" /* 8563 */;
import useUserProfileBannerHeightDefault from "useUserProfileBannerHeight" /* 8927 */;
import useUserProfileOverscrollStylesDefault from "useUserProfileOverscrollStyles" /* 8937 */;
...
const memoResult = importAllResult.memo(function NonUserBotProfileContent(scrollPosition) {
  ...
  let obj = trackUserProfileAction(8575);
  ...
  const userProfileColors = trackUserProfileAction(8549).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null == user) {
    ...
    obj[6] = showBlur;
    const items = [callback(tmp(8938), obj), ];
    ...
    obj1[1] = guildId;
    obj1[2] = tmp13;
    const items1 = [callback(tmp4(8572).OpenableUserProfileAvatar, obj1), ];
    ...
    items4[1] = obj9;
    obj8[3] = items4;
    obj7[1] = callback(tmp(9054), obj8);
    items3[1] = callback(View, obj7);
    obj2[1] = items3;
    items1[1] = closure_8(View, obj2);
    obj[1] = items1;
    items[1] = closure_8(tmp(4217).View, obj);
    obj6[0] = items;
    return closure_8(closure_9, obj6);
  }
  const tmp4Result = trackUserProfileAction(8549);
});
