...
// Dependencies: [32, 19, 17, 7041, 3921, 1903, 676, 21, 1297, 4285, 712, 589, 12256, 9004, 12, 1351, 4827, 1236, 4281, 5699, 2]
// Exports: default

// Module 15774 (UserProfileYourFriendsCard)
...
export default function UserProfileYourFriendsCard(arg0) {
  ...
  gameRelationshipsByType = _require(12256).useGameRelationshipsByType(RelationshipTypes.FRIEND);
  const effect = stateFromStoresArray1.useEffect(() => {
    const userAffinitiesV2 = _undefined(9004).fetchUserAffinitiesV2();
  }, []);
  ...
  const items5 = [callback(_require(4281).Text, obj), memo, callback(_require(5699).ChevronSmallRightIcon, { size: "sm" })];
  obj[5] = items5;
  return callback2(_require(4827).PressableOpacity, obj);
};
