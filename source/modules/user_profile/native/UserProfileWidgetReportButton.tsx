...
// Dependencies: [19, 17, 21, 1236, 8775, 8022, 8604, 8610, 712, 2]
// Exports: default

// Module 12353 (UserProfileWidgetReportButton)
import "noop";
...
export default function UserProfileWidgetReportButton(arg0) {
  ...
  obj[2] = require(8775) /* FlagIcon */.FlagIcon;
  ...
  return jsx(require(8604) /* ContextMenu */.ContextMenu, {
    items,
    children(ref) {
      let obj = { ref: ref.ref };
      const merged = Object.assign(Object.assign(ref, Object.create(null)));
