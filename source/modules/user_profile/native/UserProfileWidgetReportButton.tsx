...
// Dependencies: [19, 17, 21, 1236, 8692, 7943, 8521, 8527, 712, 2]
// Exports: default

// Module 12266 (UserProfileWidgetReportButton)
import "noop";
...
export default function UserProfileWidgetReportButton(arg0) {
  ...
  obj[2] = require(8692) /* FlagIcon */.FlagIcon;
  ...
  return jsx(require(8521) /* ContextMenu */.ContextMenu, {
    items,
    children(ref) {
      let obj = { ref: ref.ref };
      const merged = Object.assign(Object.assign(ref, Object.create(null)));
