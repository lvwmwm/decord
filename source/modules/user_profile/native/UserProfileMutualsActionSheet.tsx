...
// Dependencies: [32, 19, 17, 4431, 8848, 21, 4342, 712, 8876, 589, 5435, 1297, 4534, 9698, 5840, 4338, 12040, 9019, 12047, 12048, 9531, 12041, 12042, 1236, 12052, 12054, 2]
// Exports: default

// Module 12046 (MutualFriendRow)
...
function MutualFriendRow(mutualFriend) {
  ...
  obj[2] = importDefault(4534).getName(guildId, undefined, user);
  obj1 = { userId: user.id, guildId, textStyle: tmp.activityStatusText };
  obj[3] = callback2(importDefault(9698), obj1);
  obj[4] = start;
  obj[5] = end;
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  React = tmp2[1];
  ({ mutualFriends, mutualGuilds } = importDefault(12040)(user));
  let obj1 = user(9019);
