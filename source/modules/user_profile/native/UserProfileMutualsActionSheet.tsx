...
// Dependencies: [32, 19, 17, 4341, 8679, 21, 4255, 712, 8707, 589, 5300, 1297, 4444, 9528, 5646, 4251, 11845, 8850, 11852, 11853, 9357, 11846, 11847, 1236, 11857, 9451, 2]
// Exports: default

// Module 11851 (MutualFriendRow)
...
function MutualFriendRow(mutualFriend) {
  ...
  obj[2] = importDefault(4444).getName(guildId, undefined, user);
  obj1 = { userId: user.id, guildId, textStyle: tmp.activityStatusText };
  obj[3] = callback2(importDefault(9528), obj1);
  obj[4] = start;
  obj[5] = end;
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  React = tmp2[1];
  ({ mutualFriends, mutualGuilds } = importDefault(11845)(user));
  let obj1 = user(8850);
