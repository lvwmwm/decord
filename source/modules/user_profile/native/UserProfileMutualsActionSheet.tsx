...
// Dependencies: [32, 19, 17, 4390, 8785, 21, 4303, 712, 8813, 589, 5374, 1297, 4493, 9638, 5779, 4299, 11961, 8956, 11968, 11969, 9468, 11962, 11963, 1236, 11973, 9562, 2]
// Exports: default

// Module 11967 (MutualFriendRow)
...
function MutualFriendRow(mutualFriend) {
  ...
  obj[2] = importDefault(4493).getName(guildId, undefined, user);
  obj1 = { userId: user.id, guildId, textStyle: tmp.activityStatusText };
  obj[3] = callback2(importDefault(9638), obj1);
  obj[4] = start;
  obj[5] = end;
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  React = tmp2[1];
  ({ mutualFriends, mutualGuilds } = importDefault(11961)(user));
  let obj1 = user(8956);
