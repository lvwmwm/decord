...
// Dependencies: [32, 19, 17, 4431, 8834, 21, 4342, 712, 8862, 589, 5414, 1297, 4534, 9687, 5819, 4338, 12024, 9005, 12031, 12032, 9518, 12025, 12026, 1236, 12036, 9611, 2]
// Exports: default

// Module 12030 (MutualFriendRow)
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  React = tmp2[1];
  ({ mutualFriends, mutualGuilds } = importDefault(12024)(user));
  let obj1 = user(9005);
  ...
  const tmp5 = importDefault(12024)(user);
