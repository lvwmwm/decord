...
// Dependencies: [32, 19, 17, 4431, 8834, 21, 4342, 712, 8862, 589, 5414, 1297, 4534, 9687, 5819, 4338, 12023, 9005, 12030, 12031, 9518, 12024, 12025, 1236, 12035, 9611, 2]
// Exports: default

// Module 12029 (MutualFriendRow)
...
function MutualFriendRow(mutualFriend) {
  ...
  obj[3] = callback2(importDefault(9687), obj1);
  obj[4] = start;
  obj[5] = end;
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  React = tmp2[1];
  ({ mutualFriends, mutualGuilds } = importDefault(12023)(user));
  let obj1 = user(9005);
