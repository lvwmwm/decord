...
// Dependencies: [32, 19, 17, 4371, 8708, 21, 4285, 712, 8736, 589, 5354, 1297, 4474, 9557, 5700, 4281, 11879, 8879, 11886, 11887, 9386, 11880, 11881, 1236, 11891, 9480, 2]
// Exports: default

// Module 11885 (MutualFriendRow)
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  React = tmp2[1];
  ({ mutualFriends, mutualGuilds } = importDefault(11879)(user));
  let obj1 = user(8879);
  ...
  const tmp5 = importDefault(11879)(user);
