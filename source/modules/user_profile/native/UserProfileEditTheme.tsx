...
// Function ID: 13994
// Name: ColorSwatch
// Dependencies: [19, 17, 21, 4342, 712, 688, 5813, 4887, 1236, 9721, 4338, 8355, 8872, 8282, 4504, 4164, 1377, 13965, 4310, 13994, 2007, 8653, 2]
// Exports: default

// Module 13993 (ColorSwatch)
...
export default function UserProfileEditTheme(pendingThemeColors) {
  ...
  let callback;
  const tmp = createCacheKey();
  let tmp4 = f93151(primaryColor[11])(user.id, guildId);
  f93151 = tmp4;
  const tmp5 = f93151(primaryColor[12])({ user, displayProfile: tmp4, pendingThemeColors: pendingThemeColors.pendingThemeColors, isPreview: flag });
  ...
  callback = obj.useAvatarColors(pendingAvatarSrc, f93151(tmp3[4]).unsafe_rawColors.PRIMARY_530, false);
    ...
    if (null != secondaryColor) {
      ...
      if (showResetMenu) {
        ...
        obj2[2] = function onPress() {
          let obj = f93151(primaryColor[18]);
          obj = {
            onResetTheme(arg0) {
              let themeColors;
              if (themeColors != null) {
      ...
      f93151 = (arg0) => {
        if (arg0 !== primaryColor) {
          ...
          let themeColors;
          if (f93151 != null) {
            themeColors = f93151.themeColors;
          }
          let tmp8;
      ...
      obj5[0] = () => {
        ...
        obj = { color: secondaryColor, onSelect: f93151, suggestedColors: closure_4 };
        importDefault(13965)(obj);
      };
      obj5[1] = primaryColor;
