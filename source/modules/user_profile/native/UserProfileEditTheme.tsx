...
// Function ID: 14278
// Name: ColorSwatch
// Dependencies: [19, 17, 21, 4478, 712, 688, 5998, 5068, 1236, 10327, 4474, 8114, 8528, 8041, 4643, 4298, 1373, 14249, 4445, 14278, 2009, 8798, 2]
// Exports: default

// Module 14277 (ColorSwatch)
...
import showCustomColorPickerActionSheetDefault from "showCustomColorPickerActionSheet" /* 14249 */;
...
export default function UserProfileEditTheme(pendingThemeColors) {
  ...
  let callback;
  const tmp = callback3();
  let tmp4 = f95144(primaryColor[11])(user.id, guildId);
  f95144 = tmp4;
  const tmp5 = f95144(primaryColor[12])({ user, displayProfile: tmp4, pendingThemeColors: pendingThemeColors.pendingThemeColors, isPreview: flag });
  ...
  callback = obj.useAvatarColors(pendingAvatarSrc, f95144(tmp3[4]).unsafe_rawColors.PRIMARY_530, false);
    ...
    if (null != secondaryColor) {
      ...
      if (showResetMenu) {
        ...
        obj2[2] = function onPress() {
          let obj = f95144(primaryColor[18]);
          obj = {
            onResetTheme(arg0) {
              let themeColors;
              if (themeColors != null) {
      ...
      f95144 = (arg0) => {
        if (arg0 !== primaryColor) {
          ...
          let themeColors;
          if (f95144 != null) {
            themeColors = f95144.themeColors;
          }
          let tmp8;
      ...
      obj5[0] = () => {
        ...
        obj = { color: secondaryColor, onSelect: f95144, suggestedColors: closure_4 };
