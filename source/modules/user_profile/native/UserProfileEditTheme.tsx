...
// Function ID: 13858
// Name: ColorSwatch
// Dependencies: [19, 17, 21, 4302, 712, 688, 5713, 4844, 1236, 9607, 4298, 8247, 8763, 8175, 4461, 4117, 1358, 13833, 4270, 13858, 1988, 8544, 2]
// Exports: default

// Module 13857 (ColorSwatch)
...
function ColorSwatch(color) {
  ...
  let obj1 = require(5713) /* getHigherContrastColor */;
  ...
  obj[5] = callback(require(9607) /* PencilIcon */.PencilIcon, obj1);
  const items2 = [callback(require(4844) /* PressableBase */.PressableOpacity, obj, color), callback(require(4298) /* Text */.Text, { variant: "text-sm/normal", color: "text-default", accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: label })];
  obj[1] = items2;
...
export default function UserProfileEditTheme(pendingThemeColors) {
  ...
  let callback;
  const tmp = createCacheKey();
  let tmp4 = f92632(primaryColor[11])(user.id, guildId);
  f92632 = tmp4;
  const tmp5 = f92632(primaryColor[12])({ user, displayProfile: tmp4, pendingThemeColors: pendingThemeColors.pendingThemeColors, isPreview: flag });
  ...
  callback = obj.useAvatarColors(pendingAvatarSrc, f92632(tmp3[4]).unsafe_rawColors.PRIMARY_530, false);
    ...
    if (null != secondaryColor) {
      ...
      if (showResetMenu) {
        ...
        obj2[2] = function onPress() {
          let obj = f92632(primaryColor[18]);
          obj = {
            onResetTheme(arg0) {
              let themeColors;
              if (themeColors != null) {
      ...
      f92632 = (arg0) => {
        if (arg0 !== primaryColor) {
          ...
          let themeColors;
          if (f92632 != null) {
            themeColors = f92632.themeColors;
          }
          let tmp8;
      ...
      obj5[0] = () => {
        ...
        obj = { color: secondaryColor, onSelect: f92632, suggestedColors: closure_4 };
        importDefault(13833)(obj);
      };
      obj5[1] = primaryColor;
