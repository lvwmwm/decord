...
// Function ID: 14245
// Name: ColorSwatch
// Dependencies: [19, 17, 21, 4448, 712, 688, 5966, 5036, 1236, 10288, 4444, 8082, 8496, 8009, 4611, 4268, 1373, 14216, 4415, 14245, 2009, 8761, 2]
// Exports: default

// Module 14244 (ColorSwatch)
...
import showCustomColorPickerActionSheetDefault from "showCustomColorPickerActionSheet" /* 14216 */;
...
export default function UserProfileEditTheme(pendingThemeColors) {
  ...
  let callback;
  const tmp = callback3();
  let tmp4 = f94982(primaryColor[11])(user.id, guildId);
  f94982 = tmp4;
  const tmp5 = f94982(primaryColor[12])({ user, displayProfile: tmp4, pendingThemeColors: pendingThemeColors.pendingThemeColors, isPreview: flag });
  ...
  callback = obj.useAvatarColors(pendingAvatarSrc, f94982(tmp3[4]).unsafe_rawColors.PRIMARY_530, false);
    ...
    if (null != secondaryColor) {
      ...
      if (showResetMenu) {
        ...
        obj2[2] = function onPress() {
          let obj = f94982(primaryColor[18]);
          obj = {
            onResetTheme(arg0) {
              let themeColors;
              if (themeColors != null) {
      ...
      f94982 = (arg0) => {
        if (arg0 !== primaryColor) {
          ...
          let themeColors;
          if (f94982 != null) {
            themeColors = f94982.themeColors;
          }
          let tmp8;
      ...
      obj5[0] = () => {
        ...
        obj = { color: secondaryColor, onSelect: f94982, suggestedColors: closure_4 };
