...
// Function ID: 14003
// Name: ColorSwatch
// Dependencies: [19, 17, 21, 4342, 712, 688, 5813, 4887, 1236, 9721, 4338, 8355, 8872, 8282, 4504, 4164, 1377, 13974, 4310, 14003, 2007, 8653, 2]
// Exports: default

// Module 14002 (ColorSwatch)
...
function ColorSwatch(color) {
  ...
  let obj1 = require(5813) /* getHigherContrastColor */;
  ...
  obj[5] = callback(require(9721) /* PencilIcon */.PencilIcon, obj1);
  const items2 = [callback(require(4887) /* PressableBase */.PressableOpacity, obj, color), callback(require(4338) /* Text */.Text, { variant: "text-sm/normal", color: "text-default", accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: label })];
  obj[1] = items2;
...
export default function UserProfileEditTheme(pendingThemeColors) {
  ...
  let callback;
  const tmp = createCacheKey();
  let tmp4 = f93266(primaryColor[11])(user.id, guildId);
  f93266 = tmp4;
  const tmp5 = f93266(primaryColor[12])({ user, displayProfile: tmp4, pendingThemeColors: pendingThemeColors.pendingThemeColors, isPreview: flag });
  ...
  callback = obj.useAvatarColors(pendingAvatarSrc, f93266(tmp3[4]).unsafe_rawColors.PRIMARY_530, false);
    ...
    if (null != secondaryColor) {
      ...
      if (showResetMenu) {
        ...
        obj2[2] = function onPress() {
          let obj = f93266(primaryColor[18]);
          obj = {
            onResetTheme(arg0) {
              let themeColors;
              if (themeColors != null) {
      ...
      f93266 = (arg0) => {
        if (arg0 !== primaryColor) {
          ...
          let themeColors;
          if (f93266 != null) {
            themeColors = f93266.themeColors;
          }
          let tmp8;
      ...
      obj5[0] = () => {
        ...
        obj = { color: secondaryColor, onSelect: f93266, suggestedColors: closure_4 };
        importDefault(13974)(obj);
      };
      obj5[1] = primaryColor;
