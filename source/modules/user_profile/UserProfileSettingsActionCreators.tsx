...
export const setPendingChanges = function setPendingChanges(guildId) {
  ...
  if (null != currentUser) {
    ...
    if ("displayNameStyles" in merged) {
      ...
      obj.pendingDisplayNameStyles = importDefault(4504)(tmp13, displayNameStyles1) ? undefined : displayNameStyles;
      const tmp12 = importDefault(4504);
    }
    ...
    if ("themeColors" in merged) {
      if (null != guildId) {
        if (null != merged.themeColors) {
          ...
          if (importDefault(4504)(tmp37, themeColors)) {
