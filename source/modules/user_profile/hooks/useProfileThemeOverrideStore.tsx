  ...
  if (null == tmp) {
    ...
    if ("nitro" === tmp.mode) {
      ...
      if (null != first) {
        tmp8 = tmp3;
        if (null != tmp7) {
          let obj = require(8313) /* getProfileTheme */;
    ...
    if (themeType !== ThemeTypes.DARK) {
      ...
      if (isThemeLightResult) {
        isThemeLightResult = require(4153) /* AccessibilityAnnouncer */.isThemeLight(tmp3);
