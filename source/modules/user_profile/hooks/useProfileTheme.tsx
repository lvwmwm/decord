...
// Dependencies: [32, 4437, 8461, 676, 4380, 589, 711, 7973, 688, 8052, 1363, 2]
// Exports: default

// Module 8460 (useProfileTheme)
...
import { useEffectiveThemeOverride } from "useProfileThemeOverrideStore" /* 8461 */;
...
export default function useProfileTheme(arg0) {
  ...
  if (null != tmp3) {
    ...
    if (!stateFromStores) {
      tmp16 = tmp2;
      if (!forceUserTheme) {
        let profileTheme = tmp4(8052).getProfileTheme(first);
