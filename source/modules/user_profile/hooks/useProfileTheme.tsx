...
// Dependencies: [32, 4334, 8887, 676, 4278, 589, 711, 8304, 688, 8383, 1363, 2]
// Exports: default

// Module 8886 (useProfileTheme)
...
export default function useProfileTheme(arg0) {
  ...
  if (null != tmp3) {
    ...
    if (!stateFromStores) {
      tmp16 = tmp2;
      if (!forceUserTheme) {
        let profileTheme = tmp4(8383).getProfileTheme(first);
