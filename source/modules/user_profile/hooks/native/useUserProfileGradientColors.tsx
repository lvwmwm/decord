...
// Dependencies: [19, 4247, 589, 3967, 5617, 8095, 2]
// Exports: useUserProfileGradientColors

// Module 8727 (useUserProfileGradientColors)
...
export const useUserProfileGradientColors = function useUserProfileGradientColors(primaryColor, secondaryColor, fallbackBackground) {
  ...
  const profileThemeValues = _require(5617).useProfileThemeValues(obj2.useThemeContext().theme);
  if (stateFromStores) {
    let prop;
    if (!tmp3) {
