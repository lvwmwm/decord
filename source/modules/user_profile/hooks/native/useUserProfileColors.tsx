...
// Dependencies: [4295, 505, 4239, 5750, 589, 1367, 4024, 712, 8318, 688, 2]
// Exports: useUserProfileColors

// Module 8838 (useUserProfileColors)
...
export const useUserProfileColors = function useUserProfileColors(arg0) {
  ...
  let obj = require(5750) /* useProfileThemeValues */;
  ...
  obj[0] = require(4024) /* map */.useToken(importDefault(712).colors.USER_PROFILE_GRADIENT_BACKGROUND, tmp3);
  const obj4 = require(4024) /* map */;
  obj[1] = require(4024) /* map */.useToken(importDefault(712).colors.USER_PROFILE_GRADIENT_BACKGROUND, tmp3);
  const obj5 = require(4024) /* map */;
  const colors = importDefault(712).colors;
  obj[2] = require(4024) /* map */.useToken(tmp7 ? colors.CARD_MUTED_BG : colors.USER_PROFILE_CONTAINER_BACKGROUND, tmp3);
  ...
  const obj6 = require(4024) /* map */;
  obj[5] = require(4024) /* map */.useToken(importDefault(712).colors.BACKGROUND_SURFACE_HIGH, tmp3);
  const tmp4Result1 = require(4024) /* map */;
  let containerBackground = require(4024) /* map */.useToken(tmp(712).colors.BACKGROUND_MOD_NORMAL, theme);
