...
// Dependencies: [4277, 505, 4221, 5671, 589, 1348, 3988, 712, 8236, 688, 2]
// Exports: useUserProfileColors

// Module 8755 (useUserProfileColors)
...
export const useUserProfileColors = function useUserProfileColors(arg0) {
  ...
  let obj = require(5671) /* useProfileThemeValues */;
  ...
  obj[0] = require(3988) /* map */.useToken(importDefault(712).colors.USER_PROFILE_GRADIENT_BACKGROUND, tmp3);
  const obj4 = require(3988) /* map */;
  obj[1] = require(3988) /* map */.useToken(importDefault(712).colors.USER_PROFILE_GRADIENT_BACKGROUND, tmp3);
  const obj5 = require(3988) /* map */;
  const colors = importDefault(712).colors;
  obj[2] = require(3988) /* map */.useToken(tmp7 ? colors.CARD_MUTED_BG : colors.USER_PROFILE_CONTAINER_BACKGROUND, tmp3);
  ...
  const obj6 = require(3988) /* map */;
  obj[5] = require(3988) /* map */.useToken(importDefault(712).colors.BACKGROUND_SURFACE_HIGH, tmp3);
  const tmp4Result1 = require(3988) /* map */;
  let containerBackground = require(3988) /* map */.useToken(tmp(712).colors.BACKGROUND_MOD_NORMAL, theme);
