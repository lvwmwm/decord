...
// Dependencies: [4294, 505, 4238, 5690, 589, 1348, 4005, 712, 8253, 688, 2]
// Exports: useUserProfileColors

// Module 8772 (useUserProfileColors)
...
export const useUserProfileColors = function useUserProfileColors(arg0) {
  ...
  let obj = require(5690) /* useProfileThemeValues */;
  ...
  obj[0] = require(4005) /* map */.useToken(importDefault(712).colors.USER_PROFILE_GRADIENT_BACKGROUND, tmp3);
  const obj4 = require(4005) /* map */;
  obj[1] = require(4005) /* map */.useToken(importDefault(712).colors.USER_PROFILE_GRADIENT_BACKGROUND, tmp3);
  const obj5 = require(4005) /* map */;
  const colors = importDefault(712).colors;
  obj[2] = require(4005) /* map */.useToken(tmp7 ? colors.CARD_MUTED_BG : colors.USER_PROFILE_CONTAINER_BACKGROUND, tmp3);
  ...
  const obj6 = require(4005) /* map */;
  obj[5] = require(4005) /* map */.useToken(importDefault(712).colors.BACKGROUND_SURFACE_HIGH, tmp3);
  const tmp4Result1 = require(4005) /* map */;
  let containerBackground = require(4005) /* map */.useToken(tmp(712).colors.BACKGROUND_MOD_NORMAL, theme);
