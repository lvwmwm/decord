...
// Dependencies: [32, 19, 687, 8161, 4170, 2]
// Exports: default, formatTime, formatTimeForA11yLabel

// Module 12216 (useActivityTimer)
...
export const formatTimeForA11yLabel = function formatTimeForA11yLabel(arg0) {
  ...
  return require(8161) /* calculateTimestampDurations */.formatTimestampToA11yLabel({ hours, minutes, seconds });
};
