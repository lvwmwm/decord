...
// Dependencies: [32, 676, 688, 4146, 12, 4147, 689, 2]
...
const memoizeResult = apply.memoize((arg0) => {
  ...
  obj = { base: "#ffffff", contrastRatio: require(4147) /* AccessibilityAnnouncer */.WCAGContrastRatios.HighContrastText };
