...
// Dependencies: [32, 676, 688, 4152, 12, 4153, 689, 2]
...
const memoizeResult = apply.memoize((arg0) => {
  ...
  obj = { base: "#ffffff", contrastRatio: require(4153) /* AccessibilityAnnouncer */.WCAGContrastRatios.HighContrastText };
