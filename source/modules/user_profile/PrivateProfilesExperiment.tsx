...
// Function ID: 12471
// Name: apexExperiment
// Dependencies: [1452, 12471, 12472, 2]
...
export const useIsInPrivateProfilesExperiment = function useIsInPrivateProfilesExperiment(UserProfilePrivacyNotice) {
  ...
  const isInPrivateProfilesStrictExperiment = require(12471) /* apexExperiment */.useIsInPrivateProfilesStrictExperiment(UserProfilePrivacyNotice);
  const obj = { location: UserProfilePrivacyNotice };
  const obj2 = require(12471) /* apexExperiment */;
  const isInPrivateProfilesStrictGbExperiment = require(12472) /* apexExperiment */.useIsInPrivateProfilesStrictGbExperiment(UserProfilePrivacyNotice);
  if (!enabled) {
...
export const getIsInPrivateProfilesExperiment = function getIsInPrivateProfilesExperiment(ProfilePrivacySetting) {
  ...
  if (!enabled) {
    enabled = require(12471) /* apexExperiment */.getIsInPrivateProfilesStrictExperiment(ProfilePrivacySetting);
    const obj2 = require(12471) /* apexExperiment */;
  }
  if (!enabled) {
    enabled = require(12472) /* apexExperiment */.getIsInPrivateProfilesStrictGbExperiment(ProfilePrivacySetting);
    const obj3 = require(12472) /* apexExperiment */;
  }
  return enabled;
};
