...
// Function ID: 12474
// Name: apexExperiment
// Dependencies: [1471, 12474, 12475, 2]
...
export const useIsInPrivateProfilesExperiment = function useIsInPrivateProfilesExperiment(UserProfilePrivacyNotice) {
  ...
  const isInPrivateProfilesStrictExperiment = require(12474) /* apexExperiment */.useIsInPrivateProfilesStrictExperiment(UserProfilePrivacyNotice);
  const obj = { location: UserProfilePrivacyNotice };
  const obj2 = require(12474) /* apexExperiment */;
  const isInPrivateProfilesStrictGbExperiment = require(12475) /* apexExperiment */.useIsInPrivateProfilesStrictGbExperiment(UserProfilePrivacyNotice);
  if (!enabled) {
...
export const getIsInPrivateProfilesExperiment = function getIsInPrivateProfilesExperiment(ProfilePrivacySetting) {
  ...
  if (!enabled) {
    enabled = require(12474) /* apexExperiment */.getIsInPrivateProfilesStrictExperiment(ProfilePrivacySetting);
    const obj2 = require(12474) /* apexExperiment */;
  }
  if (!enabled) {
    enabled = require(12475) /* apexExperiment */.getIsInPrivateProfilesStrictGbExperiment(ProfilePrivacySetting);
    const obj3 = require(12475) /* apexExperiment */;
  }
  return enabled;
};
