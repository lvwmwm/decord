...
// Dependencies: [4550, 12400, 2007, 2]
// Exports: default

// Module 12399 (openEditNoteModal)
...
export default function openEditNoteModal(closure_0) {
  importDefault(4550).pushLazy(require(2007) /* asyncRequireImpl */(12400, dependencyMap.paths), closure_0, undefined, { presentation: "modal" });
};
