...
// Dependencies: [676, 8058, 698, 1416, 2]
// Exports: trackUserAvatarUpdated

// Module 8294 (trackUserAvatarUpdated)
...
export const trackUserAvatarUpdated = function trackUserAvatarUpdated(isGuildProfile) {
  ...
  obj[1] = flag;
  let NumberResult;
  if (NEW_ASSET === require(8058) /* AssetOriginTypes */.AssetOriginTypes.ARCHIVED_ASSET) {
    const _Number = Number;
    NumberResult = Number(avatarId);
  }
  obj[2] = NumberResult;
  obj[3] = NEW_ASSET === require(8058) /* AssetOriginTypes */.AssetOriginTypes.EDITED_ARCHIVED_ASSET;
