...
// Dependencies: [676, 8276, 698, 1416, 2]
// Exports: trackUserAvatarUpdated

// Module 8511 (trackUserAvatarUpdated)
...
export const trackUserAvatarUpdated = function trackUserAvatarUpdated(isGuildProfile) {
  ...
  obj[1] = flag;
  let NumberResult;
  if (NEW_ASSET === require(8276) /* AssetOriginTypes */.AssetOriginTypes.ARCHIVED_ASSET) {
    const _Number = Number;
    NumberResult = Number(avatarId);
  }
  obj[2] = NumberResult;
  obj[3] = NEW_ASSET === require(8276) /* AssetOriginTypes */.AssetOriginTypes.EDITED_ARCHIVED_ASSET;
