...
// Dependencies: [8835, 5289, 7160, 4363, 1990, 4430, 3998, 1922, 7122, 8830, 676, 505, 1435, 8351, 698, 4538, 8839, 2]
...
// Module 8834 (getProfileProperties)
import map from "map";
...
function getTrackUserProfileProperties(userId) {
  ...
  if (null == user) {
    ...
    const displayProfile = require(8351) /* useDisplayProfile */.getDisplayProfile(id, tmp3);
    let member = null;
    if (showGuildProfile) {
      member = null;
      if (null != guildId) {
    ...
    const obj6 = require(8351) /* useDisplayProfile */;
    tmp14 = StatusTypes;
  }
}
function trackUserProfileAction(applicationId) {
  ...
  const merged1 = Object.assign(require(4538) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadataFromId(channelId));
...
export const maybeTrackUserProfileUiViewed = function maybeTrackUserProfileUiViewed(userId) {
  ...
  let timeToLoadMs;
  let viewStartedAt;
  let trackResult = require(8839) /* isUserProfilePerformanceAnalyticsEnabled */;
...
export const trackUserProfileEditAction = function trackUserProfileEditAction(userId) {
  ...
  const merged2 = Object.assign(require(4538) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadataFromId(channelId));
