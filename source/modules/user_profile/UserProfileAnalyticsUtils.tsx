...
// Dependencies: [8713, 5233, 7041, 4304, 1971, 4371, 3921, 1903, 7001, 8708, 676, 505, 1416, 8230, 698, 4479, 8717, 2]
...
// Module 8712 (getProfileProperties)
import map from "map";
...
function getTrackUserProfileProperties(userId) {
  ...
  if (null == user) {
    ...
    const displayProfile = require(8230) /* useDisplayProfile */.getDisplayProfile(id, tmp3);
    let member = null;
    if (showGuildProfile) {
      member = null;
      if (null != guildId) {
    ...
    const obj6 = require(8230) /* useDisplayProfile */;
    tmp14 = StatusTypes;
  }
}
...
export const maybeTrackUserProfileUiViewed = function maybeTrackUserProfileUiViewed(userId) {
  ...
  let timeToLoadMs;
  let viewStartedAt;
  let trackResult = require(8717) /* isUserProfilePerformanceAnalyticsEnabled */;
