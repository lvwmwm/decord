...
// Dependencies: [1352, 1348, 3759, 1351, 1386, 482, 1282, 1313, 10152, 22, 4471, 1212, 1331, 10156, 21, 2]
...
function showLimitReachedAlert() {
  ...
  obj = { count: require(10152) /* computeFavoritesAccess */.getFavoritesAccess().favoriteLimit };
