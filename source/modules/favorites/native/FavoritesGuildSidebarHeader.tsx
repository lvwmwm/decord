...
// Function ID: 15418
// Name: EmptyBody
// Dependencies: [19, 17, 15342, 21, 4303, 712, 9716, 12138, 4271, 9720, 2007, 9719, 4299, 1236, 3049, 4809, 4829, 4800, 4712, 2]
// Exports: default

// Module 15417 (EmptyBody)
import set from "set";
...
function EmptyBody() {
  ...
  obj[2] = intl.format(importDefault(3049).Z3Hdr5, { onClick: callback });
...
function PlaceholderRows() {
  ...
  const items = [callback2(require(4809) /* TextIcon */.TextIcon, obj), ];
  const items1 = [, ];
  ...
  const items3 = [callback2(require(4829) /* VoiceNormalIcon */.VoiceNormalIcon, obj2), ];
  const items4 = [, ];
  ...
  const items5 = [callback2(require(4800) /* ChatIcon */.ChatIcon, obj4), ];
  const items6 = [, ];
...
export default function FavoritesGuildSidebarHeader() {
  ...
  const intl = require(1236) /* getSystemLocale */.intl;
  obj[2] = intl.string(importDefault(3049)["1n0TGE"]);
  const items = [callback2(require(4299) /* Text */.Heading, obj), callback2(EmptyBody, {})];
  obj[2] = items;
  const items1 = [callback3(require(4712) /* Stack */.Stack, obj), callback2(View, { style: tmp.divider }), ];
  let tmp4Result = null;
  if (!tmp2) {
  ...
  items1[2] = tmp4Result;
  obj[1] = items1;
  return callback3(require(4712) /* Stack */.Stack, obj);
};
