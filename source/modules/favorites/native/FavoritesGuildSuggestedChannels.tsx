...
// Function ID: 16124
// Name: PX_8
// Dependencies: [19, 17, 16124, 673, 10047, 21, 709, 4481, 16028, 1233, 3178, 5635, 6989, 16125, 16126, 4936, 10912, 2]
...
import items from "items" /* 16124 */;
import { NOOP } from "ME" /* 673 */;
import { getScaledCategoryRowHeight as closure_8 } from "hairlineWidth" /* 10047 */;
...
export default function FavoritesGuildSuggestedChannels() {
  ...
  if (0 !== arr.length) {
    ...
    obj[3] = memo;
    const items2 = [tmp2(16028).renderCategoryItem(obj), ];
    obj1 = { style: null, children: null };
    obj1[0] = tmp.rows;
    obj1[1] = arr.map((result) => {
      let obj = { style: closure_3, children: null };
      obj = { result, onPressDestination: callback(16126), onLongPress: closure_1_7, start: 0 === arg1, end: arg1 === result.length - 1, trailing: null };
      ...
      obj[5] = closure_1_9(result(4936).Button, obj);
      obj[1] = closure_1_9(callback(16125), obj);
