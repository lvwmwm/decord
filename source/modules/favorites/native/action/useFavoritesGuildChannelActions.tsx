...
// Dependencies: [1218, 1990, 1394, 9770, 1913, 589, 9781, 2]
// Exports: default

// Module 10256 (useFavoritesGuildChannelActions)
...
export default function useFavoritesGuildChannelActions(channelId, FavoritesGuildActionSheet) {
  ...
  const isFavoritesGuildSelected = _require(9770).useIsFavoritesGuildSelected();
  const obj4 = _require(9770);
