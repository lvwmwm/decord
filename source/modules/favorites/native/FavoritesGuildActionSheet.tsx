...
// Dependencies: [19, 21, 15122, 15123, 5617, 5308, 1236, 5619, 5241, 9396, 4223, 4214, 2]
...
function FavoritesGuildActionSheet() {
  ...
  if (tmp2.isPreview) {
    let EyeSlashIcon = tmp5(5241).XSmallIcon;
  } else {
    EyeSlashIcon = tmp5(9396).EyeSlashIcon;
  }
  obj[2] = callback(require(5619) /* ActionSheetRowIcon */.ActionSheetRow.Icon, { IconComponent: EyeSlashIcon });
  let str = "danger";
  if (tmp2.isPreview) {
    str = "default";
  }
  ...
  if (tmp3.isAvailable) {
    ...
    obj1[2] = tmp4(tmp5(5619).ActionSheetRow.Icon, obj2);
    obj1[4] = function onPress() {
      tmp3(outer1_2[10]).hideActionSheet(outer1_5);
      tmp3.perform();
    };
    tmp4Result = tmp4(tmp5(5619).ActionSheetRow, obj1);
  }
  items[1] = tmp4Result;
  obj[1] = closure_4(require(5619) /* ActionSheetRowIcon */.ActionSheetRow.Group, { hasIcons: true, children: items });
