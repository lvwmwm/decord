...
// Dependencies: [32, 19, 1410, 21, 4285, 712, 1894, 9628, 4253, 5377, 5376, 1236, 7713, 4695, 2]
// Exports: openAddFavoriteCategoryActionSheet

// Module 15178 (AddFavoriteCategoryActionSheet)
...
function AddFavoriteCategoryActionSheet() {
  ...
  obj[3] = callback2(first(5376).BottomSheetTitleHeader, obj);
  ...
  obj1[4] = closure_5;
  obj1[8] = callback;
  const items1 = [callback2(first(7713).TextInput, obj1), ];
  let obj2 = { text: null, onPress: null, disabled: null };
  const intl4 = first(1236).intl;
  obj2[0] = intl4.string(first(1236).t.CumH4u);
  obj2[1] = callback;
  obj2[2] = !result;
  items1[1] = callback2(first(4695).Button, obj2);
  obj[4] = items1;
  return callback3(first(5377).BottomSheet, obj);
}
