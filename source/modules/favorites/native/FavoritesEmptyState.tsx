...
export default function FavoritesEmptyState() {
  ...
  const items = [callback(require(6070) /* AccountAgeTier10LargeBadge */.FavoritesSpotIllustration, { width: 192, height: 108 }), , ];
  ...
  items[2] = callback(require(4755) /* Button */.Button, obj4);
  obj[1] = items;
