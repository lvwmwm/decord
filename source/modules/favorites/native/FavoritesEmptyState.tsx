...
// Dependencies: [19, 17, 21, 4302, 712, 5967, 4710, 4298, 1236, 3030, 2]
// Exports: default

// Module 15731 (FavoritesEmptyState)
import "noop";
...
export default function FavoritesEmptyState() {
  ...
  const items = [callback(require(5967) /* AccountAgeTier10LargeBadge */.FavoritesSpotIllustration, { width: 192, height: 108 }), ];
  ...
  const items1 = [callback(require(4298) /* Text */.Heading, obj), ];
