...
// Dependencies: [19, 17, 21, 4344, 712, 9755, 12195, 4312, 9759, 2007, 9758, 6068, 4752, 4340, 1236, 3047, 4754, 12168, 2]
// Exports: default
...
export default function FavoritesEmptyState() {
  ...
  const items = [callback(require(6068) /* AccountAgeTier10LargeBadge */.FavoritesSpotIllustration, { width: 192, height: 108 }), , ];
  ...
  const items1 = [callback(require(4340) /* Text */.Heading, obj1), ];
  ...
  if (obj.useFavoritesAccess("favorites_empty_state").hasAccess) {
    ...
    obj3[2] = tmp8(tmp2(12168).PlusMediumIcon, {});
    obj3[3] = callback;
    let obj4 = obj3;
  } else {
  ...
  items[2] = callback(require(4754) /* Button */.Button, obj4);
  obj[1] = items;
