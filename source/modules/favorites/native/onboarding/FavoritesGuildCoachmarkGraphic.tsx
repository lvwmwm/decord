...
// Dependencies: [17, 21, 4303, 712, 6029, 1297, 2]
// Exports: default

// Module 15373 (FavoritesGuildCoachmarkGraphic)
...
export default function FavoritesGuildCoachmarkGraphic() {
  ...
  const items = [callback(require(6029) /* AccountAgeTier10LargeBadge */.FavoritesSpotIllustration, { width: 160, height: 90 }), ];
