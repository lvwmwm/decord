...
// Dependencies: [17, 21, 4255, 712, 5926, 1297, 2]
// Exports: default

// Module 15202 (FavoritesGuildCoachmarkGraphic)
...
export default function FavoritesGuildCoachmarkGraphic() {
  ...
  const items = [callback(require(5926) /* AccountAgeTier10LargeBadge */.FavoritesSpotIllustration, { width: 160, height: 90 }), ];
