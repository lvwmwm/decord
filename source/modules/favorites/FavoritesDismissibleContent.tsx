...
// Function ID: 9638
// Name: items1
// Dependencies: [32, 1364, 1369, 1358, 5944, 9632, 5943, 2]
...
export const useIsFavoritesMenuItemPopoverPending = function useIsFavoritesMenuItemPopoverPending() {
  return callback(require(5944) /* canShowTimeRecurringContent */.useDangerouslyPeekDismissibleContents(items2), 1)[0] === require(1358) /* DismissibleContent */.DismissibleContent.FAVORITES_SERVER_ONBOARDING_MENU_ITEM;
};
