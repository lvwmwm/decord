...
// Function ID: 9654
// Name: items1
// Dependencies: [32, 1364, 1369, 1358, 5963, 9648, 5962, 2]
...
export const useIsFavoritesMenuItemPopoverPending = function useIsFavoritesMenuItemPopoverPending() {
  return callback(require(5963) /* canShowTimeRecurringContent */.useDangerouslyPeekDismissibleContents(items2), 1)[0] === require(1358) /* DismissibleContent */.DismissibleContent.FAVORITES_SERVER_ONBOARDING_MENU_ITEM;
};
