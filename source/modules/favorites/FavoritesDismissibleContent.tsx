...
// Function ID: 9726
// Name: items1
// Dependencies: [32, 1383, 1388, 1377, 6025, 9718, 6024, 2]
...
export const useIsFavoritesMenuItemPopoverPending = function useIsFavoritesMenuItemPopoverPending() {
  return callback(require(6025) /* canShowTimeRecurringContent */.useDangerouslyPeekDismissibleContents(items2), 1)[0] === require(1377) /* DismissibleContent */.DismissibleContent.FAVORITES_SERVER_ONBOARDING_MENU_ITEM;
};
...
export const useFavoritesBetaTagDismissibleContent = function useFavoritesBetaTagDismissibleContent(arg0) {
  ...
  let obj = require(9718) /* useFavoritesGuildConfig */;
  const isFreemium = obj.useFavoritesGuildConfig({ location: "FavoritesDismissibleContent" }).isFreemium;
  require(6024) /* useSelectedDismissibleContent */;
  if (tmp3) {
    if (arg0) {
