...
// Dependencies: [1922, 1394, 676, 1924, 9770, 1945, 698, 9776, 2]
// Exports: default

// Module 15908 (trackFavoritesGuildViewed)
...
export default function trackFavoritesGuildViewed() {
  ...
  obj[0] = require(9776) /* setNextFavoritesGuildViewSource */.consumeNextFavoritesGuildViewSource();
