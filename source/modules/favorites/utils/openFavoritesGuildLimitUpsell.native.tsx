...
// Dependencies: [4310, 9763, 2007, 2]
// Exports: default

// Module 9762 (openFavoritesGuildLimitUpsell)
...
export default function openFavoritesGuildLimitUpsell(limit) {
  ...
  obj.openLazy(require(2007) /* asyncRequireImpl */(9763, dependencyMap.paths), FavoritesGuildUpsellSheet, obj);
};
