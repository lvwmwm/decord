...
// Dependencies: [19, 1369, 21, 4223, 5323, 12913, 12914, 1236, 2]
// Exports: default

// Module 12912 (NUFChannelsActionSheet)
...
export default function NUFChannelsActionSheet(markAsDismissed) {
  ...
  obj[4] = callback;
  obj[2] = jsx(importDefault(12913), { illustration: null, title: null, description: null, CTALabel: null, onCTAPress: null });
  return jsx(markAsDismissed(5323).BottomSheet, { illustration: null, title: null, description: null, CTALabel: null, onCTAPress: null });
};
