...
// Dependencies: [32, 19, 17, 21, 4285, 712, 1236, 12952, 12953, 4145, 4286, 12954, 12955, 12956, 12957, 5356, 4790, 4281, 2]
// Exports: default

// Module 12951 (NUFChannelIllustration)
...
export default function NUFChannelIllustration() {
  ...
  obj = { interpolate: require(4145).interpolate, messageListAnimation: sharedValue };
  fn.__closure = obj;
  ...
  obj6[3] = items9;
  items3[5] = callback2(require(5356) /* PressableCard */.Card, obj6);
  obj[1] = items3;
