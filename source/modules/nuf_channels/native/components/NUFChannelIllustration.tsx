...
// Dependencies: [32, 19, 17, 21, 4255, 712, 1236, 12915, 12916, 4116, 4256, 12917, 12918, 12919, 12920, 5302, 4760, 4251, 2]
// Exports: default

// Module 12914 (NUFChannelIllustration)
...
export default function NUFChannelIllustration() {
  ...
  const items7 = [callback(require(4760) /* TextIcon */.TextIcon, { size: "sm" }), ];
  ...
  obj6[3] = items9;
  items3[5] = callback2(require(5302) /* PressableCard */.Card, obj6);
  obj[1] = items3;
