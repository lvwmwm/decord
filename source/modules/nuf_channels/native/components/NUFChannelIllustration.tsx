...
// Dependencies: [32, 19, 17, 21, 4303, 712, 1236, 13036, 13037, 4036, 4304, 13038, 13039, 13040, 13041, 5376, 4809, 4299, 2]
// Exports: default

// Module 13035 (NUFChannelIllustration)
...
export default function NUFChannelIllustration() {
  ...
  obj = { interpolate: require(4036).interpolate, messageListAnimation: sharedValue };
  fn.__closure = obj;
  ...
  const items7 = [callback(require(4809) /* TextIcon */.TextIcon, { size: "sm" }), ];
  ...
  obj8[2] = items8;
  items7[1] = callback2(require(4299) /* Text */.Text, obj8);
  obj7[1] = items7;
  ...
  obj6[3] = items9;
  items3[5] = callback2(require(5376) /* PressableCard */.Card, obj6);
  obj[1] = items3;
