...
// Dependencies: [32, 19, 17, 21, 4302, 712, 1236, 12966, 12967, 4162, 4303, 12968, 12969, 12970, 12971, 5375, 4807, 4298, 2]
// Exports: default

// Module 12965 (NUFChannelIllustration)
...
export default function NUFChannelIllustration() {
  ...
  obj = { interpolate: require(4162).interpolate, messageListAnimation: sharedValue };
  fn.__closure = obj;
  ...
  const items7 = [callback(require(4807) /* TextIcon */.TextIcon, { size: "sm" }), ];
  ...
  obj8[2] = items8;
  items7[1] = callback2(require(4298) /* Text */.Text, obj8);
  obj7[1] = items7;
  ...
  obj6[3] = items9;
  items3[5] = callback2(require(5375) /* PressableCard */.Card, obj6);
  obj[1] = items3;
