...
// Dependencies: [19, 21, 12950, 1236, 12951, 12939, 1844, 5096, 2]
// Exports: default

// Module 12949 (NUFVoiceChannelsTemplate)
import "noop";
...
export default function NUFVoiceChannelsTemplate(channel) {
  ...
  return jsx(importDefault(12950), { title: null, description: null, imageSrc: null, CTALabel: null, onCTAPress: null });
};
