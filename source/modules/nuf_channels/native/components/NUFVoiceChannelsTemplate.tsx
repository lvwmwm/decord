...
// Dependencies: [31, 33, 12769, 1212, 12770, 12758, 1820, 4945, 2]
// Exports: default

// Module 12768 (NUFVoiceChannelsTemplate)
import "result";
...
export default function NUFVoiceChannelsTemplate(channel) {
  ...
  obj.imageSrc = importDefault(12770);
  ...
  return jsx(importDefault(12769), {});
};
