...
// Dependencies: [19, 21, 12973, 1236, 12974, 12962, 1872, 5128, 2]
// Exports: default

// Module 12972 (NUFVoiceChannelsTemplate)
import "noop";
...
export default function NUFVoiceChannelsTemplate(channel) {
  ...
  return jsx(importDefault(12973), { title: null, description: null, imageSrc: null, CTALabel: null, onCTAPress: null });
};
