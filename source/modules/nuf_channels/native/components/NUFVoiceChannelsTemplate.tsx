...
// Dependencies: [19, 21, 12829, 1236, 12830, 12818, 1844, 5001, 2]
// Exports: default

// Module 12828 (NUFVoiceChannelsTemplate)
import "noop";
...
export default function NUFVoiceChannelsTemplate(channel) {
  ...
  return jsx(importDefault(12829), { title: null, description: null, imageSrc: null, CTALabel: null, onCTAPress: null });
};
