...
// Dependencies: [19, 21, 13112, 1236, 13113, 13101, 1891, 5170, 2]
// Exports: default

// Module 13111 (NUFVoiceChannelsTemplate)
import "noop";
...
export default function NUFVoiceChannelsTemplate(channel) {
  ...
  return jsx(importDefault(13112), { title: null, description: null, imageSrc: null, CTALabel: null, onCTAPress: null });
};
