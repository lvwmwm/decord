...
// Dependencies: [19, 17, 21, 4303, 712, 4299, 4714, 2]
// Exports: default

// Module 13054 (NUFActionSheetTemplate)
import "noop";
...
export default function NUFActionSheetTemplate(arg0) {
  ...
  items[3] = callback(require(4714) /* Button */.Button, { text: CTALabel, size: "md", onPress: onCTAPress, grow: true });
  obj[1] = items;
