...
// Dependencies: [19, 17, 21, 4285, 712, 4281, 4695, 2]
// Exports: default

// Module 12950 (NUFActionSheetTemplate)
import "noop";
...
export default function NUFActionSheetTemplate(arg0) {
  ...
  items[3] = callback(require(4695) /* Button */.Button, { text: CTALabel, size: "md", onPress: onCTAPress, grow: true });
  obj[1] = items;
