...
// Dependencies: [19, 17, 21, 4302, 712, 4298, 4712, 2]
// Exports: default

// Module 12973 (NUFActionSheetTemplate)
import "noop";
...
export default function NUFActionSheetTemplate(arg0) {
  ...
  items[3] = callback(require(4712) /* Button */.Button, { text: CTALabel, size: "md", onPress: onCTAPress, grow: true });
  obj[1] = items;
