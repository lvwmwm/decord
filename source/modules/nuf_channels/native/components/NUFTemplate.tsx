...
// Dependencies: [19, 17, 21, 4255, 712, 4251, 4666, 2]
// Exports: default

// Module 12917 (NUFActionSheetTemplate)
import "noop";
...
export default function NUFActionSheetTemplate(arg0) {
  ...
  items[3] = callback(require(4666) /* Button */.Button, { text: CTALabel, size: "md", onPress: onCTAPress, grow: true });
  obj[1] = items;
