...
// Dependencies: [7035, 1874, 7034, 676, 698, 10103, 6811, 10102, 4449, 2]
// Exports: default

// Module 10120 (longPressMessageHandleReply)
...
export default function longPressMessageHandleReply(arg0) {
  ...
  if (null != editingMessage) {
    ...
    obj[4] = require(10103) /* handleEdit */.getContextBarCancelReason("edit", actionSource);
    ...
    const obj12 = require(10103) /* handleEdit */;
  }
    ...
    if ("message_swipe" === actionSource) {
      if (null != pendingReply) {
        if (pendingReply.message.id === message.id) {
          ...
          require(10102) /* createPendingReply */.deletePendingReply(channel.id);
          let text;
          ...
          const obj9 = require(10102) /* createPendingReply */;
        }
      }
    }
  }
  tmp3Result = tmp3(698);
  const merged = Object.assign(require(4449) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(channel.guild_id));
  const obj1 = { source: actionSource };
  const obj4 = require(4449) /* collectGuildAnalyticsMetadata */;
  const tmp7 = require;
  const merged1 = Object.assign(require(4449) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(channel));
  ...
  const pendingReply1 = tmp7(10102).createPendingReply({ message, channel, shouldMention: tmp13, source: actionSource });
  if (chatInputRef != null) {
