...
export default function longPressMessageHandleReply(arg0) {
  ...
  tmp3Result = tmp3(698);
  const merged = Object.assign(require(4539) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(channel.guild_id));
  const obj1 = { source: actionSource };
  const obj4 = require(4539) /* collectGuildAnalyticsMetadata */;
  const tmp7 = require;
  const merged1 = Object.assign(require(4539) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(channel));
