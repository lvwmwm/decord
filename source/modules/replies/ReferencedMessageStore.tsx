...
// Function ID: 6949
// Name: processMessage
// Dependencies: [32, 6949, 1372, 4472, 676, 1386, 4474, 6953, 589, 709, 2]

// Module 6948 (processMessage)
    ...
    if (null == message_reference) {
      ...
      if (null == message_id) {
        ...
        if (null != referenced_message) {
          ...
          obj[1] = require(4474) /* createMinimalMessageRecord */.createMessageRecord(referenced_message);
          ...
          const obj5 = require(4474) /* createMinimalMessageRecord */;
        } else {
          obj = { state: null };
          obj[0] = obj.DELETED;
...
prototype2["updateExistingMessageIfCached"] = function updateExistingMessageIfCached(channel_id) {
  ...
  if (tmp) {
    ...
    if (flag) {
      ...
      obj[0] = obj.LOADED;
      obj[1] = require(4474) /* createMinimalMessageRecord */.createMessageRecord(channel_id);
    ...
    if (obj.has(channelId, messageId)) {
      ...
      if (null != value) {
        if (value.state === obj.LOADED) {
          obj = { state: null, message: null };
          obj[0] = tmp3.LOADED;
          obj[1] = require(6953) /* redactionSettingToRenderedString */.handleExplicitMediaScanTimeoutForMessage(value.message);
    ...
    if (obj.has(channel_id, id)) {
      ...
      if (null != value) {
        if (value.state === obj.LOADED) {
          obj = { state: null, message: null };
          obj[0] = tmp3.LOADED;
          obj[1] = require(4474) /* createMinimalMessageRecord */.updateMessageRecord(value.message, message);
          const result = obj.set(channel_id, id, obj);
        }
      }
      return false;
