...
// Dependencies: [0, 0, 4294967295, 0, 0, 0, 0, 0, 0, 4294967295, 4294967295, 0, 0, 0, 0, 0]
...
tmp6 = new tmp6(require("result"), obj);
result = result.fileFinishedImporting("modules/replies/ReferencedMessageStore.tsx");
