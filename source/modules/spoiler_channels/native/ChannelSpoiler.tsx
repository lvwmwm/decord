...
// Function ID: 11941
// Name: ChannelSpoiler
// Dependencies: [32, 19, 17, 4298, 1372, 1891, 11562, 21, 4285, 712, 589, 4475, 11563, 4478, 5215, 4136, 4745, 4281, 1236, 4693, 4275, 4827, 10880, 7722, 2]
// Exports: default

// Module 11940 (ChannelSpoiler)
...
export default function ChannelSpoiler(channelId) {
  ...
  return tmp20(importDefault(10880), obj10);
};
