...
// Function ID: 11907
// Name: ChannelSpoiler
// Dependencies: [32, 19, 17, 4268, 1372, 1862, 11528, 21, 4255, 712, 589, 4445, 11529, 4448, 5185, 4107, 4715, 4251, 1236, 4663, 4245, 4797, 10829, 7694, 2]
// Exports: default

// Module 11906 (ChannelSpoiler)
...
export default function ChannelSpoiler(channelId) {
  ...
  tmp7 = importDefault(4445)(stateFromStores1);
  obj10[0] = _require(7694).NsfwSpaceWarningModalType.SPOILER_CHANNEL;
  ...
  return tmp20(importDefault(10829), obj10);
};
