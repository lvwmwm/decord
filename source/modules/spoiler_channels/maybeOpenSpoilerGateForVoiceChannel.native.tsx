...
// Dependencies: [1372, 21, 5944, 4644, 12668, 2]
// Exports: maybeOpenSpoilerGateForVoiceChannel

// Module 12667 (maybeOpenSpoilerGateForVoiceChannel)
...
export const maybeOpenSpoilerGateForVoiceChannel = function maybeOpenSpoilerGateForVoiceChannel(id) {
  ...
  if (!tmp2) {
    let obj = require(5944) /* isChannelSpoilerGated */;
  ...
  if (!tmp2) {
    obj = { channelId: null };
    obj[0] = channel.id;
    require(4644) /* useAlertStore */.openAlert(require(12668) /* VoicePanelSpoilerAlert */.VOICE_PANEL_SPOILER_KEY, jsx(importDefault(12668), { channelId: null }));
    flag = true;
