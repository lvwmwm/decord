...
// Dependencies: [1372, 21, 7727, 4530, 12423, 2]
// Exports: maybeOpenSpoilerGateForVoiceChannel

// Module 12422 (maybeOpenSpoilerGateForVoiceChannel)
...
export const maybeOpenSpoilerGateForVoiceChannel = function maybeOpenSpoilerGateForVoiceChannel(id) {
  ...
  if (!tmp2) {
    let obj = require(7727) /* isChannelSpoilerGated */;
  ...
  if (!tmp2) {
    obj = { channelId: null };
    obj[0] = channel.id;
    require(4530) /* useAlertStore */.openAlert(require(12423) /* VoicePanelSpoilerAlert */.VOICE_PANEL_SPOILER_KEY, jsx(importDefault(12423), { channelId: null }));
    flag = true;
