...
// Dependencies: [1372, 21, 5944, 4644, 12670, 2]
// Exports: maybeOpenSpoilerGateForVoiceChannel

// Module 12669 (maybeOpenSpoilerGateForVoiceChannel)
...
export const maybeOpenSpoilerGateForVoiceChannel = function maybeOpenSpoilerGateForVoiceChannel(id) {
  ...
  if (!tmp2) {
    obj = { channelId: null };
    obj[0] = channel.id;
    require(4644) /* useAlertStore */.openAlert(require(12670) /* VoicePanelSpoilerAlert */.VOICE_PANEL_SPOILER_KEY, jsx(importDefault(12670), { channelId: null }));
    flag = true;
