...
// Function ID: 15362
// Name: PreviewOverlay
// Dependencies: [19, 17, 21, 4344, 712, 4196, 15362, 4280, 4765, 2]
// Exports: default
...
export default function GuildThemePreviewArt(themeSettings) {
  ...
  if (null == memo) {
    ...
    tmp9 = jsx(importDefault(4765), { colors: null, locations: null, useAngle: true, angle: null, style: null, children: null });
    const tmp2Result = importDefault(4765);
  }
  return tmp9;
};
