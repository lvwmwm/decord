...
// Function ID: 15371
// Name: PreviewOverlay
// Dependencies: [19, 17, 21, 4342, 712, 4194, 15371, 4278, 4766, 2]
// Exports: default

// Module 15370 (PreviewOverlay)
...
function PreviewOverlay() {
  return <View pointerEvents="none" style={createCacheKey().previewOverlay}>{jsx(importDefault(15371), {})}</View>;
}
