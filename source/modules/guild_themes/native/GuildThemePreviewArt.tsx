...
// Function ID: 15305
// Name: PreviewOverlay
// Dependencies: [19, 17, 21, 4303, 712, 4155, 15305, 4239, 4725, 2]
// Exports: default

// Module 15304 (PreviewOverlay)
...
function PreviewOverlay() {
  return <View pointerEvents="none" style={createCacheKey().previewOverlay}>{jsx(importDefault(15305), {})}</View>;
}
