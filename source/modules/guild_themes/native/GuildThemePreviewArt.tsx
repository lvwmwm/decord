...
// Function ID: 15132
// Name: PreviewOverlay
// Dependencies: [19, 17, 21, 4189, 712, 4037, 15132, 4125, 4611, 2]
// Exports: default

// Module 15131 (PreviewOverlay)
...
function PreviewOverlay() {
  return <View pointerEvents="none" style={createCacheKey().previewOverlay}>{jsx(importDefault(15132), {})}</View>;
}
