...
// Dependencies: [5, 32, 19, 17, 4102, 4171, 1369, 21, 3, 4285, 712, 15169, 4217, 589, 4253, 1236, 5338, 15170, 4281, 7795, 7794, 1297, 4695, 2]
// Exports: default

// Module 15168 (GuildThemeNuxActionSheet)
...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  [tmp5, c2] = callback2(React.useState(guildId(15169).getInitialGuildThemeNuxSelection), 2);
  const tmp4 = callback2(React.useState(guildId(15169).getInitialGuildThemeNuxSelection), 2);
  ...
  obj[2] = callback3;
  obj[3] = tmp.container;
  const items7 = [callback3(markAsDismissed(15170), { themeSettings: stateFromStores1, isPersonal: tmp10 }), , , , , , ];
  ...
  const items8 = [callback3(guildId(7794).TableRadioRow, obj4), ];
  ...
  items8[1] = callback3(guildId(7794).TableRadioRow, obj5);
  obj3[3] = items8;
  obj2[1] = callback4(guildId(7795).TableRadioGroup, obj3);
  ...
  obj[4] = items7;
  return callback4(guildId(5338).BottomSheet, obj);
};
