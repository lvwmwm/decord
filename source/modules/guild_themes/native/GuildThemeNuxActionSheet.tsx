...
// Dependencies: [5, 32, 19, 17, 4101, 4171, 1369, 21, 3, 4285, 712, 15186, 4217, 589, 4253, 1236, 5377, 15187, 4281, 7908, 7907, 1297, 4695, 2]
// Exports: default

// Module 15185 (GuildThemeNuxActionSheet)
...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  [tmp5, c2] = callback2(React.useState(guildId(15186).getInitialGuildThemeNuxSelection), 2);
  const tmp4 = callback2(React.useState(guildId(15186).getInitialGuildThemeNuxSelection), 2);
  ...
  const tmp10 = tmp5 === guildId(4217).GuildThemeSourcePreference.PERSONAL;
  c6 = tmp10;
  let obj = guildId(589);
  ...
  obj[2] = callback3;
  obj[3] = tmp.container;
  const items7 = [callback3(markAsDismissed(15187), { themeSettings: stateFromStores1, isPersonal: tmp10 }), , , , , , ];
  ...
  items7[1] = callback3(guildId(4281).Text, obj);
  ...
  items7[2] = callback3(guildId(4281).Text, obj1);
  ...
  obj4[1] = guildId(4217).GuildThemeSourcePreference.GUILD;
  const items8 = [callback3(guildId(7907).TableRadioRow, obj4), ];
  const obj5 = { label: null, value: null };
  const intl6 = tmp2(1236).intl;
  obj5[0] = intl6.string(guildId(1236).t.js8y7t);
  obj5[1] = guildId(4217).GuildThemeSourcePreference.PERSONAL;
  items8[1] = callback3(guildId(7907).TableRadioRow, obj5);
  obj3[3] = items8;
  obj2[1] = callback4(guildId(7908).TableRadioGroup, obj3);
  ...
  obj11[3] = tmp9;
  obj11[4] = callback2;
  obj10[1] = callback3(guildId(4695).Button, obj11);
  items7[6] = callback3(c6, obj10);
  obj[4] = items7;
  return callback4(guildId(5377).BottomSheet, obj);
};
