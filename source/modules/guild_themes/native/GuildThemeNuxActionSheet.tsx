...
// Dependencies: [5, 32, 19, 17, 4072, 4141, 1369, 21, 3, 4255, 712, 15148, 4187, 589, 4223, 1236, 5323, 15149, 4251, 7767, 7766, 1297, 4665, 2]
// Exports: default

// Module 15147 (GuildThemeNuxActionSheet)
...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  [tmp5, c2] = callback2(React.useState(guildId(15148).getInitialGuildThemeNuxSelection), 2);
  const tmp4 = callback2(React.useState(guildId(15148).getInitialGuildThemeNuxSelection), 2);
  ...
  obj[2] = callback3;
  obj[3] = tmp.container;
  const items7 = [callback3(markAsDismissed(15149), { themeSettings: stateFromStores1, isPersonal: tmp10 }), , , , , , ];
  ...
  const items8 = [callback3(guildId(7766).TableRadioRow, obj4), ];
  ...
  items8[1] = callback3(guildId(7766).TableRadioRow, obj5);
  obj3[3] = items8;
  obj2[1] = callback4(guildId(7767).TableRadioGroup, obj3);
  ...
  obj11[3] = tmp9;
  obj11[4] = callback2;
  obj10[1] = callback3(guildId(4665).Button, obj11);
  items7[6] = callback3(c6, obj10);
  obj[4] = items7;
  return callback4(guildId(5323).BottomSheet, obj);
};
