...
// Dependencies: [5, 32, 19, 17, 4299, 4363, 1384, 21, 3, 4478, 712, 15751, 4409, 589, 4445, 1236, 5622, 15752, 4474, 7692, 7693, 1297, 4928, 2]
// Exports: default

// Module 15750 (GuildThemeNuxActionSheet)
...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  let callback1;
  const tmp = callback5();
  [tmp5, c2] = callback2(React.useState(guildId(15751).getInitialGuildThemeNuxSelection), 2);
  const tmp4 = callback2(React.useState(guildId(15751).getInitialGuildThemeNuxSelection), 2);
  ...
  items8[1] = callback3(guildId(7693).TableRadioRow, obj5);
  obj3[3] = items8;
  obj2[1] = callback4(guildId(7692).TableRadioGroup, obj3);
