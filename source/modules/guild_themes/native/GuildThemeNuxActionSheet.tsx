...
// Dependencies: [5, 32, 19, 17, 4266, 4329, 1388, 21, 3, 4444, 712, 15598, 4375, 589, 4411, 1236, 5569, 15599, 4440, 8203, 8202, 1297, 4879, 2]
// Exports: default

// Module 15597 (GuildThemeNuxActionSheet)
...
import closure_8 from "snapshotSelectedGuildId" /* 4329 */;
...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  let callback1;
  const tmp = callback5();
  [tmp5, c2] = callback2(React.useState(guildId(15598).getInitialGuildThemeNuxSelection), 2);
  const tmp4 = callback2(React.useState(guildId(15598).getInitialGuildThemeNuxSelection), 2);
  ...
  const tmp10 = tmp5 === guildId(4375).GuildThemeSourcePreference.PERSONAL;
  closure_6 = tmp10;
  let obj = guildId(589);
  ...
  obj[2] = callback3;
  obj[3] = tmp.container;
  const items7 = [callback3(markAsDismissed(15599), { themeSettings: stateFromStores1, isPersonal: tmp10 }), , , , , , ];
  ...
  items7[1] = callback3(guildId(4440).Text, obj);
  ...
  items7[2] = callback3(guildId(4440).Text, obj1);
  ...
  obj4[1] = guildId(4375).GuildThemeSourcePreference.GUILD;
  const items8 = [callback3(guildId(8202).TableRadioRow, obj4), ];
  const obj5 = { label: null, value: null };
  const intl6 = tmp2(1236).intl;
  obj5[0] = intl6.string(guildId(1236).t.js8y7t);
  obj5[1] = guildId(4375).GuildThemeSourcePreference.PERSONAL;
  items8[1] = callback3(guildId(8202).TableRadioRow, obj5);
  obj3[3] = items8;
  obj2[1] = callback4(guildId(8203).TableRadioGroup, obj3);
  ...
  obj11[3] = tmp9;
  obj11[4] = callback2;
  obj10[1] = callback3(guildId(4879).Button, obj11);
  items7[6] = callback3(closure_6, obj10);
  obj[4] = items7;
  return callback4(guildId(5569).BottomSheet, obj);
};
