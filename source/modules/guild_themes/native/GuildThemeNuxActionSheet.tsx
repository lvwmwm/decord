...
// Dependencies: [5, 32, 19, 17, 4072, 4141, 1369, 21, 3, 4255, 712, 15135, 4187, 589, 4223, 1236, 5309, 15136, 4251, 7783, 7782, 1297, 4666, 2]
// Exports: default
...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  const tmp10 = tmp5 === guildId(4187).GuildThemeSourcePreference.PERSONAL;
  c6 = tmp10;
  let obj = guildId(589);
  ...
  items7[1] = callback3(guildId(4251).Text, obj);
  ...
  items7[2] = callback3(guildId(4251).Text, obj1);
  ...
  obj4[1] = guildId(4187).GuildThemeSourcePreference.GUILD;
  const items8 = [callback3(guildId(7782).TableRadioRow, obj4), ];
  const obj5 = { label: null, value: null };
  const intl6 = tmp2(1236).intl;
  obj5[0] = intl6.string(guildId(1236).t.js8y7t);
  obj5[1] = guildId(4187).GuildThemeSourcePreference.PERSONAL;
  items8[1] = callback3(guildId(7782).TableRadioRow, obj5);
  obj3[3] = items8;
  obj2[1] = callback4(guildId(7783).TableRadioGroup, obj3);
  ...
  obj11[3] = tmp9;
  obj11[4] = callback2;
  obj10[1] = callback3(guildId(4666).Button, obj11);
  items7[6] = callback3(c6, obj10);
  obj[4] = items7;
  return callback4(guildId(5309).BottomSheet, obj);
};
