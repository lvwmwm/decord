...
// Dependencies: [32, 19, 676, 4135, 4136, 4166, 4167, 2]
// Exports: default

// Module 4134 (getGuildIdFromNavigationState)
    ...
    if (rootNavigationRef.isReady()) {
      ...
      if (null == tmp4) {
        ...
        if (rootState != null) {
          ...
          if (routes != null) {
            const mapped = routes.map(require(4135) /* navigationToRootTabHelper */.coerceMainRoute);
