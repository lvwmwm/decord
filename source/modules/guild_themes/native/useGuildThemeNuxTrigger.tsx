...
// Dependencies: [19, 4054, 589, 15358, 15358, 2007, 4312, 15363, 2]
// Exports: default

// Module 15357 (useGuildThemeNuxTrigger)
...
export default function useGuildThemeNuxTrigger(arg0) {
  ...
  importDefault(15363)(arg0, { isNuxOpen: stateFromStores, openNux: callback });
};
