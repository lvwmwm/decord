...
export const getRandomSingleColorGuildTheme = function getRandomSingleColorGuildTheme() {
  const diff = require(4038) /* items */.COLOR_PALETTE.length - 1;
  const tmp2 = require(4038) /* items */.COLOR_PALETTE[Math.floor(Math, Math.random(Math) * (diff + 1))];
