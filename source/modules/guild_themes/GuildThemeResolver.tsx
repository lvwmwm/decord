...
// Dependencies: [19, 1340, 1910, 4165, 4225, 4228, 676, 4194, 589, 4271, 4274, 2]
...
// Module 4224 (resolveSavedActiveGuildTheme)
...
function resolveSavedActiveGuildTheme(enabled) {
  ...
  if (true === enabled) {
    ...
    if (null != themeSettings) {
      ...
      tmp5 = tmp4;
      if (null == tmp4) {
        const guildThemePreset = require(4194) /* set */.getGuildThemePreset(themeSettings.presetId);
        let tmp9 = null;
...
export const resolveRenderableGuildThemeSettings = function resolveRenderableGuildThemeSettings(customUserThemeSettings) {
  if (null == customUserThemeSettings) {
    ...
    if (null != tmp2) {
      ...
      const guildThemePreset = require(4194) /* set */.getGuildThemePreset(customUserThemeSettings.presetId);
      let tmp6 = null;
      if (null != guildThemePreset) {
        obj = { type: "preset", preset: null };
        obj[1] = guildThemePreset;
...
export const getActiveGuildThemeForGuildId = function getActiveGuildThemeForGuildId(guildId, GuildPowerupsConstants) {
  ...
  if (null != guildId) {
    ...
    obj = require(4271) /* apexExperiment */;
    tmp8 = require;
  }
  return null;
};
