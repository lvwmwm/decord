...
// Dependencies: [19, 1340, 1910, 4167, 4227, 4230, 676, 4196, 589, 4273, 4276, 2]
...
// Module 4226 (resolveSavedActiveGuildTheme)
...
function resolveSavedActiveGuildTheme(enabled) {
  ...
  if (true === enabled) {
    ...
    if (null != themeSettings) {
      ...
      tmp5 = tmp4;
      if (null == tmp4) {
        const guildThemePreset = require(4196) /* set */.getGuildThemePreset(themeSettings.presetId);
        let tmp9 = null;
...
export const resolveRenderableGuildThemeSettings = function resolveRenderableGuildThemeSettings(customUserThemeSettings) {
  if (null == customUserThemeSettings) {
    ...
    if (null != tmp2) {
      ...
      const guildThemePreset = require(4196) /* set */.getGuildThemePreset(customUserThemeSettings.presetId);
      let tmp6 = null;
      if (null != guildThemePreset) {
        obj = { type: "preset", preset: null };
        obj[1] = guildThemePreset;
...
export const getActiveGuildThemeForGuildId = function getActiveGuildThemeForGuildId(guildId, GuildPowerupsConstants) {
  ...
  if (null != guildId) {
    ...
    obj = require(4273) /* apexExperiment */;
    tmp8 = require;
  }
  return null;
};
