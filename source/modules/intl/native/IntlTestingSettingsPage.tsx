...
// Dependencies: [32, 5, 19, 17, 1995, 1994, 21, 4344, 712, 8026, 1236, 8743, 8025, 589, 3943, 5806, 5413, 1274, 4752, 4340, 15014, 15046, 2]
// Exports: default
...
function TestLocaleSelector() {
  ...
  const items = [callback3(_require(8025).TableRadioRow, { label: "English", value: "en-US" }), callback3(_require(8025).TableRadioRow, { label: "French", value: "fr" })];
  obj[4] = items;
  return callback4(_require(8026).TableRadioGroup, obj);
}
function LocaleInfo() {
  let require;
  let tmp4;
  ...
  const first = tmp[0];
  [tmp4, require] = callback(React.useState(importDefault(3943).locale), 2);
  const items1 = [first];
  ...
  obj[1] = callback3(require(5413) /* TableRowInner */.TableRow.TrailingText, { text: "@discord/intl" });
  const items2 = [callback3(require(5413) /* TableRowInner */.TableRow, obj), , , , ];
  obj = { label: "App locale", trailing: null };
  obj[1] = callback3(require(5413) /* TableRowInner */.TableRow.TrailingText, { text: first });
  items2[1] = callback3(require(5413) /* TableRowInner */.TableRow, obj);
  obj1 = { label: "System locale", trailing: null };
  obj1[1] = callback3(require(5413) /* TableRowInner */.TableRow.TrailingText, { text: tmp[1] });
  items2[2] = callback3(require(5413) /* TableRowInner */.TableRow, obj1);
  const obj2 = { label: "@discord/intl locale", trailing: null };
  const obj3 = { text: null };
  obj3[0] = require(1236) /* getSystemLocale */.intl.currentLocale;
  obj2[1] = callback3(require(5413) /* TableRowInner */.TableRow.TrailingText, obj3);
  items2[3] = callback3(require(5413) /* TableRowInner */.TableRow, obj2);
  const obj4 = { label: "Moment locale", trailing: null, subLabel: null };
  obj4[1] = callback3(require(5413) /* TableRowInner */.TableRow.TrailingText, { text: tmp4 });
  ...
  obj4[2] = str;
  items2[4] = callback3(require(5413) /* TableRowInner */.TableRow, obj4);
  obj5[1] = items2;
  return closure_11(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj5);
}
...
export default function IntlTestingSettingsPage() {
  ...
  items[5] = callback3(_require(4340).Text, obj3);
  ...
  items[6] = callback3(_require(4340).Text, obj5);
  ...
  items[7] = callback3(_require(4340).Text, obj6);
  obj[2] = items;
  obj[1] = callback4(_require(4752).Stack, obj);
