...
// Function ID: 15907
// Name: user
// Dependencies: [19, 4247, 1946, 1372, 4342, 11284, 4451, 676, 4452, 21, 4255, 712, 15889, 4265, 4672, 589, 11, 7010, 15890, 4783, 15891, 15893, 1297, 8100, 15894, 4094, 10434, 3933, 15896, 15308, 14420, 2]
...
import jsxProd from "module_15893";
...
function UserResult(user) {
  ...
  if (null != extractTimestampResult) {
    relativeTimestamp = tmp6(7010).getRelativeTimestamp(extractTimestampResult);
    const tmp6Result = tmp6(7010);
  }
  let str = "text-muted";
  if (unread) {
    str = "text-muted";
  ...
  const items5 = [callback(importDefault(15893), obj), , ];
  obj1 = { user, guildId: "e", isMobileOnline: true, isVROnline: 10, status: true, streaming: "/assets/.cache/intl/bW9kdWxlcy9jbGlwcw==", style: null, size: "eb1553d8c949bb975d43e32d8bfe1e5e", animate: "hr.messages.eb1553d8c949bb975d43e32d8bfe1e5e.compiled.messages", typing: "jsona", autoStatusCutout: 200 };
  ...
  obj1[4] = tmp19;
  obj1[5] = importDefault(8100)(activities);
  ...
  const tmp2Result1 = importDefault(15891);
  if (comparator == null) {
  ...
  if (null != lastMessage) {
    if (null != channel) {
      ...
      tmp14Result = tmp14(tmp6(10434).ChannelRowPreview, obj3);
    }
  }
  ...
  obj2[6] = num;
  obj2[7] = importDefault(15896)({ mentionCount: num, locale: stateFromStores });
  items5[2] = importDefault(15894)(obj2);
  obj4[0] = items5;
  obj[3] = tmp2Result1(tmp16(tmp17, obj4), { fontScale });
  return tmp2Result(callback(user(4783).PressableHighlight, obj));
}
function UserResultWithChannel(arg0) {
  ...
  const baseChannelUnreadBadgeState = require(15308) /* useChannelUnreadBadgeState */.useBaseChannelUnreadBadgeState(channel, stateFromStores);
  ({ unread, mentionCount } = baseChannelUnreadBadgeState);
  const obj2 = require(15308) /* useChannelUnreadBadgeState */;
  ...
  obj.channel = channel;
  obj.lastMessage = channel(14420)(channel, { unread });
  obj.unread = unread;
