...
// Function ID: 16214
// Name: user
// Dependencies: [19, 4662, 1994, 1391, 4559, 11152, 5043, 676, 5044, 21, 4661, 712, 16196, 4770, 4751, 589, 11, 4967, 16197, 5433, 16198, 16200, 1297, 8411, 16201, 4219, 10050, 4071, 16203, 15606, 14663, 2]
...
import jsxProd from "module_16200";
...
function UserResult(user) {
  ...
  if (null != extractTimestampResult) {
    relativeTimestamp = tmp6(4967).getRelativeTimestamp(extractTimestampResult);
    const tmp6Result = tmp6(4967);
  }
  let str = "text-muted";
  if (unread) {
    str = "text-muted";
  ...
  const items5 = [callback(importDefault(16200), obj), , ];
  ...
  obj1[4] = tmp19;
  obj1[5] = importDefault(8411)(activities);
  ...
  const tmp2Result1 = importDefault(16198);
  if (comparator == null) {
  ...
  if (null != lastMessage) {
    if (null != channel) {
      ...
      obj3[2] = str;
      obj3[3] = flag;
      obj3[4] = tmp6(4071).ChannelListLayoutTypes.COMPACT;
      tmp14Result = tmp14(tmp6(10050).ChannelRowPreview, obj3);
    }
  }
  ...
  obj2[6] = num;
  obj2[7] = importDefault(16203)({ mentionCount: num, locale: stateFromStores });
  items5[2] = importDefault(16201)(obj2);
  obj4[0] = items5;
...
function UserResultWithChannel(arg0) {
  ...
  const baseChannelUnreadBadgeState = require(15606) /* useChannelUnreadBadgeState */.useBaseChannelUnreadBadgeState(channel, stateFromStores);
  ({ unread, mentionCount } = baseChannelUnreadBadgeState);
  const obj2 = require(15606) /* useChannelUnreadBadgeState */;
