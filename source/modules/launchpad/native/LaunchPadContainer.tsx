...
// Dependencies: [19, 17, 11064, 21, 4478, 11065, 16541, 16543, 11605, 4217, 4927, 4338, 15599, 5652, 16544, 2]
// Exports: default

// Module 16540 (LaunchPadContainer)
...
export default function LaunchPadContainer(children) {
  ...
  const MobileHomeDrawerExperiment = launchPadSharedState(4338).MobileHomeDrawerExperiment;
