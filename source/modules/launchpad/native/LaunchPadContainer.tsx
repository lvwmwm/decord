...
// Dependencies: [19, 17, 10417, 21, 4342, 10418, 16129, 16131, 11442, 4083, 4776, 4203, 15225, 5488, 16132, 2]
// Exports: default

// Module 16128 (LaunchPadContainer)
import "noop";
...
export default function LaunchPadContainer(children) {
  ...
  const MobileHomeDrawerExperiment = launchPadSharedState(4203).MobileHomeDrawerExperiment;
