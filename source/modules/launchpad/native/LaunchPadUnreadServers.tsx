...
// Dependencies: [19, 17, 1391, 4357, 1922, 676, 21, 4342, 712, 6000, 16121, 589, 1297, 9712, 5308, 12374, 4355, 4353, 8436, 15305, 1367, 1493, 16126, 1236, 8053, 2]

// Module 16120 (HistorySeparator)
...
let closure_13 = importAllResult.memo(function GuildItemInner(guildId) {
  ...
  obj[1] = callback(onGuildSelect(16121), obj);
  return callback(closure_5, obj);
});
let closure_14 = importAllResult.memo(function PrivateChannelItemInner(channelId) {
  ...
  if (type === ChannelTypes.DM) {
    if (null != stateFromStores1) {
      obj = { style: null, user: null, guildId: "Array", size: "r" };
