...
// Dependencies: [19, 17, 21, 4342, 8436, 15537, 712, 16131, 4065, 16133, 4083, 4754, 2]
// Exports: SimpleGuildContainer, SimpleGuildContainerAnimated

// Module 16132 (SimpleGuildContainer)
...
let closure_12 = importAllResult.memo((backgroundColor) => {
  ...
  if (badge > 0) {
    ...
    obj[1] = callback(importDefault(8436), obj);
...
let closure_13 = importAllResult.memo((arg0) => {
  ...
  if (null != source) {
    ...
    let tmp2 = callback(require(15537) /* getMediaIcon */.GuildsBarActivityIndicatorBase, obj);
  } else {
    tmp2 = null;
    if (null != guildId) {
      ...
      obj[1] = obj1;
      tmp2 = callback(importDefault(15537), obj);
    }
  }
  return tmp2;
});
