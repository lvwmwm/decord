...
// Dependencies: [19, 17, 21, 4189, 9119, 14985, 712, 15791, 3893, 15793, 4050, 4599, 2]
// Exports: SimpleGuildContainer, SimpleGuildContainerAnimated

// Module 15792 (SimpleGuildContainer)
...
let closure_12 = importAllResult.memo((backgroundColor) => {
  ...
  if (badge > 0) {
    ...
    obj[1] = callback(importDefault(9119), obj);
...
let closure_13 = importAllResult.memo((arg0) => {
  ...
  if (null != source) {
    ...
    let tmp2 = callback(require(14985) /* getMediaIcon */.GuildsBarActivityIndicatorBase, obj);
  } else {
    tmp2 = null;
    if (null != guildId) {
      ...
      obj[1] = obj1;
      tmp2 = callback(importDefault(14985), obj);
    }
  }
  return tmp2;
});
