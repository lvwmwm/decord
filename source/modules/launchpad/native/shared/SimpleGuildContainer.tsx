...
// Dependencies: [19, 17, 21, 4344, 8432, 15527, 712, 16120, 4065, 16122, 4083, 4753, 2]
// Exports: SimpleGuildContainer, SimpleGuildContainerAnimated

// Module 16121 (SimpleGuildContainer)
...
let closure_12 = importAllResult.memo((backgroundColor) => {
  ...
  if (badge > 0) {
    ...
    obj[1] = callback(importDefault(8432), obj);
...
let closure_13 = importAllResult.memo((arg0) => {
  ...
  if (null != source) {
    ...
    let tmp2 = callback(require(15527) /* getMediaIcon */.GuildsBarActivityIndicatorBase, obj);
  } else {
    tmp2 = null;
    if (null != guildId) {
      ...
      obj[1] = obj1;
      tmp2 = callback(importDefault(15527), obj);
    }
  }
  return tmp2;
});
