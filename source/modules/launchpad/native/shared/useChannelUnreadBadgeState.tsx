...
// Dependencies: [7039, 4357, 4540, 589, 7042, 2]
// Exports: useBaseChannelUnreadBadgeState, useChannelUnreadBadgeState

// Module 15538 (useChannelUnreadBadgeState)
...
export const useChannelUnreadBadgeState = function useChannelUnreadBadgeState(channel, flag) {
  ...
  const optInEnabledForGuild = _require(7042).useOptInEnabledForGuild(channel.guild_id);
