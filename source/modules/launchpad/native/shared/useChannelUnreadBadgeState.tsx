...
// Dependencies: [7138, 4395, 4589, 589, 7141, 2]
// Exports: useBaseChannelUnreadBadgeState, useChannelUnreadBadgeState

// Module 15704 (useChannelUnreadBadgeState)
import closure_2 from "guildHasCommunity" /* 7138 */;
...
export const useChannelUnreadBadgeState = function useChannelUnreadBadgeState(channel, flag) {
  ...
  const optInEnabledForGuild = _require(7141).useOptInEnabledForGuild(channel.guild_id);
  const obj3 = _require(7141);
