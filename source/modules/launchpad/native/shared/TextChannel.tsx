// Module ID: 16478
// Function ID: 16479
// Dependencies: [19, 17, 5400, 1996, 1391, 1301, 4655, 21, 4445, 16470, 712, 15847, 6068, 589, 4639, 7561, 14861, 6126, 4887, 16479, 4912, 11548, 10112, 4139, 16481, 8076, 15732, 16471, 5020, 16482, 16483, 16474, 16477, 2]
...
const memoResult = importAllResult.memo(function TextChannel(subtitle) {
  ...
  if (null != tmp8ResultResult) {
    if (!isChannelSpoilerGated) {
      ...
      let result = callback(tmp2(10112).ChannelRowPreview, obj);
    }
    dependencyMap = tmp22;
    const items3 = [arr4.length > 0, arr4];
    const isActivitiesInTextEnabled = tmp2(8076).useIsActivitiesInTextEnabled(channel.id);
    ...
    const tmp2Result3 = tmp2(8076);
    const merged = Object.assign(tmp2(16482).useTextChannelPressEvents(channel, flag2));
    const tmp2Result4 = tmp2(16482);
    obj2 = { channel: null, unread: null, mentionCount: null };
    obj2[0] = channel;
    obj2[1] = unread;
    obj2[2] = mentionCount;
    const merged1 = Object.assign(tmp2(16483).getChannelAccessibilityProps(obj2));
    if (selected) {
    ...
    obj4[5] = tmp8(16477)(obj6);
    obj4[6] = unread;
    obj4[7] = resolvedUnreadSetting;
    obj4[8] = mentionCount;
    obj4[9] = flag;
    obj4[10] = tmp8(4639)(channel);
    obj4[11] = fontScale;
    ...
    obj.children = items5;
    return tmp8Result(tmp26(tmp2(5020).PressableHighlight, obj));
  }
  const tmp18 = arr4(4912)(channel.id);
  result = channel(16481).renderChannelSubtitle({ subtitle: subtitle.subtitle, muted: flag, channelId: channel.id, guildId: channel.guild_id });
});
