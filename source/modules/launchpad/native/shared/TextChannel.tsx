// Module ID: 15897
// Function ID: 15898
// Dependencies: [19, 17, 5162, 1946, 1372, 1301, 4452, 21, 4255, 15889, 712, 15308, 5769, 589, 4446, 9315, 14420, 5842, 4672, 15898, 4697, 11358, 10434, 3933, 15900, 8136, 15198, 15890, 4783, 15901, 15902, 15893, 15896, 2]
...
let closure_12 = createCacheKey.createStyles(() => {
  ...
  obj = { flex: 1, borderRadius: importDefault(15889)().container.borderRadius, marginBottom: 1 };
  obj[0] = obj;
...
const memoResult = importAllResult.memo(function TextChannel(subtitle) {
  ...
  if (null != tmp8ResultResult) {
    if (!isChannelSpoilerGated) {
      ...
      obj[3] = flag;
      obj[4] = tmp2(3933).ChannelListLayoutTypes.COMPACT;
      let result = callback(tmp2(10434).ChannelRowPreview, obj);
    }
    dependencyMap = tmp22;
    const items3 = [arr4.length > 0, arr4];
    const isActivitiesInTextEnabled = tmp2(8136).useIsActivitiesInTextEnabled(channel.id);
    ...
    const tmp2Result3 = tmp2(8136);
    const merged = Object.assign(tmp2(15901).useTextChannelPressEvents(channel, flag2));
    const tmp2Result4 = tmp2(15901);
    obj2 = { channel: null, unread: null, mentionCount: null };
    obj2[0] = channel;
    obj2[1] = unread;
    obj2[2] = mentionCount;
    const merged1 = Object.assign(tmp2(15902).getChannelAccessibilityProps(obj2));
    if (selected) {
    ...
    obj4[5] = tmp8(15896)(obj6);
    obj4[6] = unread;
    obj4[7] = resolvedUnreadSetting;
    obj4[8] = mentionCount;
    obj4[9] = flag;
    obj4[10] = tmp8(4446)(channel);
    obj4[11] = fontScale;
    ...
    obj.children = items5;
    return tmp8Result(tmp26(tmp2(4783).PressableHighlight, obj));
  }
  const tmp18 = arr4(4697)(channel.id);
  result = channel(15900).renderChannelSubtitle({ subtitle: subtitle.subtitle, muted: flag, channelId: channel.id, guildId: channel.guild_id });
});
