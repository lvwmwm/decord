// Module ID: 15950
// Function ID: 15951
// Dependencies: [19, 17, 5206, 1975, 1372, 1301, 4481, 21, 4285, 15942, 712, 15357, 5810, 589, 4475, 8326, 14465, 5865, 4701, 15951, 4726, 11364, 9707, 3962, 15953, 8260, 15250, 15943, 4827, 15954, 15955, 15946, 15949, 2]
...
let closure_12 = createCacheKey.createStyles(() => {
  ...
  obj = { flex: 1, borderRadius: importDefault(15942)().container.borderRadius, marginBottom: 1 };
  obj[0] = obj;
...
const memoResult = importAllResult.memo(function TextChannel(subtitle) {
  ...
  if (null != tmp8ResultResult) {
    if (!isChannelSpoilerGated) {
      ...
      obj[3] = flag;
      obj[4] = tmp2(3962).ChannelListLayoutTypes.COMPACT;
      let result = callback(tmp2(9707).ChannelRowPreview, obj);
    }
    dependencyMap = tmp22;
    const items3 = [arr4.length > 0, arr4];
    const isActivitiesInTextEnabled = tmp2(8260).useIsActivitiesInTextEnabled(channel.id);
    ...
    const tmp2Result3 = tmp2(8260);
    const merged = Object.assign(tmp2(15954).useTextChannelPressEvents(channel, flag2));
    const tmp2Result4 = tmp2(15954);
    obj2 = { channel: null, unread: null, mentionCount: null };
    obj2[0] = channel;
    obj2[1] = unread;
    obj2[2] = mentionCount;
    const merged1 = Object.assign(tmp2(15955).getChannelAccessibilityProps(obj2));
    if (selected) {
    ...
    obj4[5] = tmp8(15949)(obj6);
    obj4[6] = unread;
    obj4[7] = resolvedUnreadSetting;
    obj4[8] = mentionCount;
    obj4[9] = flag;
    obj4[10] = tmp8(4475)(channel);
    obj4[11] = fontScale;
    ...
    obj.children = items5;
    return tmp8Result(tmp26(tmp2(4827).PressableHighlight, obj));
  }
  const tmp18 = arr4(4726)(channel.id);
  result = channel(15953).renderChannelSubtitle({ subtitle: subtitle.subtitle, muted: flag, channelId: channel.id, guildId: channel.guild_id });
});
