// Module ID: 15910
// Function ID: 15911
// Dependencies: [19, 17, 5176, 1946, 1372, 1301, 4451, 21, 4255, 15902, 712, 15319, 5783, 589, 4445, 8186, 14428, 5838, 4671, 15911, 4696, 11330, 9676, 3933, 15913, 8120, 15211, 15903, 4797, 15914, 15915, 15906, 15909, 2]
...
let closure_12 = createCacheKey.createStyles(() => {
  ...
  obj = { flex: 1, borderRadius: importDefault(15902)().container.borderRadius, marginBottom: 1 };
  obj[0] = obj;
...
const memoResult = importAllResult.memo(function TextChannel(subtitle) {
  ...
  const tmp9 = arr4(4445)(stateFromStores1);
  ...
  if (null != tmp8ResultResult) {
    if (!isChannelSpoilerGated) {
      ...
      let result = callback(tmp2(9676).ChannelRowPreview, obj);
    }
    dependencyMap = tmp22;
    const items3 = [arr4.length > 0, arr4];
    const isActivitiesInTextEnabled = tmp2(8120).useIsActivitiesInTextEnabled(channel.id);
    ...
    const tmp2Result3 = tmp2(8120);
    const merged = Object.assign(tmp2(15914).useTextChannelPressEvents(channel, flag2));
    const tmp2Result4 = tmp2(15914);
    obj2 = { channel: null, unread: null, mentionCount: null };
    obj2[0] = channel;
    obj2[1] = unread;
    obj2[2] = mentionCount;
    const merged1 = Object.assign(tmp2(15915).getChannelAccessibilityProps(obj2));
    if (selected) {
    ...
    obj4[5] = tmp8(15909)(obj6);
    obj4[6] = unread;
    obj4[7] = resolvedUnreadSetting;
    obj4[8] = mentionCount;
    obj4[9] = flag;
    obj4[10] = tmp8(4445)(channel);
    obj4[11] = fontScale;
    ...
    obj.children = items5;
    return tmp8Result(tmp26(tmp2(4797).PressableHighlight, obj));
  }
  const tmp18 = arr4(4696)(channel.id);
  result = channel(15913).renderChannelSubtitle({ subtitle: subtitle.subtitle, muted: flag, channelId: channel.id, guildId: channel.guild_id });
});
