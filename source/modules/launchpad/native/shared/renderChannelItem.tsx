...
// Dependencies: [19, 17, 1910, 3998, 1922, 4541, 21, 9082, 4342, 712, 16137, 589, 5819, 11632, 7148, 16139, 9712, 16142, 4535, 2]
// Exports: default, getChannelAccessibilityProps

// Module 16150 (LaunchpadChannelIcon)
import "set";
...
function LaunchpadChannelIcon(channel) {
  ...
  obj[1] = callback(importDefault(5819), { guild: stateFromStores, size: importDefault(16137)().icon.guildBadgeIconSize });
  const items1 = [callback(View, obj), callback(channel(11632).ChannelIcon, { channel, size: "sm", wrapperSize: 32 })];
  obj[0] = items1;
...
export default function renderChannelItem(unread) {
  ...
  const tmp7 = importDefault(16137)();
  ...
  children[2] = importDefault(16142)({ name: channelName, subtitle, unread: flag, resolvedUnreadSetting: ONLY_MENTIONS, muted: flag3, lastMessageTimestampString: relativeTimestamp, channel, channelCategoryName, locked, connected, live: flag2, mentionCount, mentionBadge, isSubscriptionGated, needSubscriptionToAccess: flag4 });
  tmp11Result = null;
  if (null != end) {
