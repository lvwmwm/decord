...
// Dependencies: [19, 17, 21, 16052, 16055, 2]
// Exports: default

// Module 16054 (renderChannelWrapper)
import "noop";
...
export default function renderChannelWrapper(arg0, fontScale) {
  ...
  obj = { minHeight: importDefault(16055)(fontScale.fontScale) - 2 * closure_4.layout.margin.marginVertical };
  items[1] = obj;
  items[2] = closure_4.container.padding;
  obj[0] = items;
  obj[1] = arg0;
  return <View minHeight={importDefault(16055)(arg1.fontScale) - 2 * closure_4.layout.margin.marginVertical} />;
};
