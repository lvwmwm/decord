...
const memoResult = importAllResult.memo(function CutoutImage(cutoutTopLeftSize) {
  ...
  if (imageBorderRadius === imageSize / 2) {
    ...
    let tmp17 = callback2(imageTintColor(8463).Circle, obj2);
  } else {
    const obj3 = { x: 0, y: 0, width: imageSize, height: imageSize, rx: imageBorderRadius, ry: imageBorderRadius, fill: "white" };
    tmp17 = callback2(imageTintColor(8463).Rect, obj3);
  }
  const items1 = [tmp17, , , , , ];
  let tmp21 = null;
  if (num > 0) {
    const obj4 = { cx: num2, cy: num3, r: num, fill: "black" };
    tmp21 = callback2(imageTintColor(8463).Circle, obj4);
  }
  items1[1] = tmp21;
  let tmp25 = null;
  if (num4 > 0) {
    const obj5 = { cx: imageSize - num5, cy: num6, r: num4, fill: "black" };
    tmp25 = callback2(imageTintColor(8463).Circle, obj5);
  }
  items1[2] = tmp25;
  let tmp29 = null;
  if (num7 > 0) {
    const obj6 = { cx: num8, cy: imageSize - num9, r: num7, fill: "black" };
    tmp29 = callback2(imageTintColor(8463).Circle, obj6);
  }
  items1[3] = tmp29;
  let tmp33 = null;
  if (num10 > 0) {
    const obj7 = { cx: imageSize - num11, cy: imageSize - num12, r: num10, fill: "black" };
    tmp33 = callback2(imageTintColor(8463).Circle, obj7);
  }
  items1[4] = tmp33;
  if (str <= 0) {
    items1[5] = null;
    obj1.children = items1;
    const items2 = [tmp12(imageTintColor(8463).Mask, obj1), ];
    if (null == v4Result) {
      items2[1] = null;
      obj.children = items2;
      const items3 = [tmp12(imageTintColor(8463).Defs, obj), , , ];
      let tmp57 = null;
      if (null != imageBackgroundColor) {
        ...
        tmp57 = callback2(imageTintColor(8463).Rect, obj8);
      }
      items3[1] = tmp57;
      if (null == imageSource) {
        items3[2] = null;
        ...
        if (null != borderStroke) {
          ...
          tmp72 = callback2(imageTintColor(8463).Rect, obj9);
        }
        items3[3] = tmp72;
        obj.children = items3;
        ...
        tmp66 = callback2(imageTintColor(8463).ForeignObject, obj11);
      }
    } else {
      ...
      if (imageBorderRadius === imageSize / 2) {
        ...
        str2 = "white";
        obj15.fill = "white";
        let tmp52 = callback2(imageTintColor(8463).Circle, obj15);
      } else {
        ...
        tmp52 = callback2(imageTintColor(8463).Rect, obj16);
      }
      obj14.children = tmp52;
      callback2(imageTintColor(8463).ClipPath, obj14);
    ...
    str = "black";
    obj17.fill = "black";
    let tmp40 = callback2(imageTintColor(8463).Circle, obj17);
  } else {
    ...
    tmp40 = callback2(imageTintColor(8463).Rect, obj18);
  }
});
