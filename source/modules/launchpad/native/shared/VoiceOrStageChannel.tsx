...
// Dependencies: [5, 19, 17, 5136, 1377, 1975, 4499, 4376, 676, 1301, 1379, 21, 1236, 7773, 1988, 4513, 4745, 4790, 8412, 1222, 5957, 12131, 9666, 4303, 4239, 8392, 4153, 16043, 9742, 15456, 589, 5148, 5142, 11445, 16056, 4494, 16052, 4720, 9792, 16044, 4846, 16054, 16050, 15347, 11662, 16059, 15355, 2]

// Module 16058 (handleVoiceOrStageChannelConnectPress)
...
let closure_20 = importAllResult.memo(function UnmemoedVoiceOrStageChannelBase(channel) {
  ...
  let obj4 = _require(5148);
  const stageParticipantsCount = obj4.useStageParticipantsCount(channel.id, _require(5142).StageChannelParticipantNamedIndex.AUDIENCE);
