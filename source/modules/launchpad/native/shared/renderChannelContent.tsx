...
// Function ID: 16132
// Name: ChannelContent
// Dependencies: [19, 17, 9841, 4540, 21, 4344, 500, 16126, 4834, 16132, 4340, 4863, 8003, 15316, 2]
// Exports: default

// Module 16131 (ChannelContent)
...
function ChannelContent(arg0) {
  ...
  obj3[4] = connected;
  const items1 = [closure_7(importDefault(16132), obj3), , ];
  tmp9Result = null;
  if (null != channelCategoryName) {
    ...
    tmp9Result = tmp9(require(4340) /* Text */.Text, obj4);
  }
  items1[1] = tmp9Result;
  ...
  if (tmp11Result) {
    ...
    if (tmp9Result) {
      ...
      tmp9Result = tmp9(require(4863) /* LockIcon */.LockIcon, obj7);
    }
    const items3 = [tmp9Result, , ];
    if (isNSFWResult) {
      const obj8 = { size: "xxs", color: "icon-muted", style: null };
      obj8[2] = tmp.channelTraitIcon;
      isNSFWResult = tmp9(require(8003) /* WarningIcon */.WarningIcon, obj8);
    }
  ...
  if (obj) {
    ...
    tmp9Result2 = tmp9(require(4340) /* Text */.Text, obj14);
  }
