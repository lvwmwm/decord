...
// Function ID: 15908
// Name: ChannelContent
// Dependencies: [19, 17, 9681, 4451, 21, 4255, 500, 15902, 4745, 15908, 4251, 4774, 7744, 15119, 2]
// Exports: default

// Module 15907 (ChannelContent)
...
function ChannelContent(arg0) {
  ...
  obj3[4] = connected;
  const items1 = [closure_7(importDefault(15908), obj3), , ];
  tmp9Result = null;
