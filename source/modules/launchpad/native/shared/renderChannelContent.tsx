...
// Function ID: 15948
// Name: ChannelContent
// Dependencies: [19, 17, 9712, 4481, 21, 4285, 500, 15942, 4775, 15948, 4281, 4804, 7885, 15157, 2]
// Exports: default

// Module 15947 (ChannelContent)
...
function ChannelContent(arg0) {
  ...
  obj3[4] = connected;
  const items1 = [closure_7(importDefault(15948), obj3), , ];
  tmp9Result = null;
  ...
  if (tmp11Result) {
    ...
    if (isNSFWResult) {
      ...
      isNSFWResult = tmp9(require(7885) /* WarningIcon */.WarningIcon, obj8);
    }
    items3[1] = isNSFWResult;
    if (isSubscriptionGated) {
      const obj9 = { locked: null, isInMainTabsExperiment: true };
      obj9[0] = needSubscriptionToAccess;
      isSubscriptionGated = tmp9(tmp2(15157), obj9);
    }
