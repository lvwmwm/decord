...
// Function ID: 15974
// Name: ChannelContent
// Dependencies: [19, 17, 9728, 4498, 21, 4302, 500, 15968, 4792, 15974, 4298, 4821, 7902, 15173, 2]
// Exports: default

// Module 15973 (ChannelContent)
...
function ChannelContent(arg0) {
  ...
  obj3[4] = connected;
  const items1 = [closure_7(importDefault(15974), obj3), , ];
  tmp9Result = null;
  if (null != channelCategoryName) {
    ...
    tmp9Result = tmp9(require(4298) /* Text */.Text, obj4);
  }
  items1[1] = tmp9Result;
  ...
  if (obj) {
    ...
    tmp9Result2 = tmp9(require(4298) /* Text */.Text, obj14);
  }
