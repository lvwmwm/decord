...
// Function ID: 16049
// Name: ChannelContent
// Dependencies: [19, 17, 9794, 4500, 21, 4303, 500, 16043, 4794, 16049, 4299, 4823, 7962, 15243, 2]
// Exports: default

// Module 16048 (ChannelContent)
...
function ChannelContent(arg0) {
  ...
  obj3[4] = connected;
  const items1 = [closure_7(importDefault(16049), obj3), , ];
  tmp9Result = null;
  if (null != channelCategoryName) {
    ...
    tmp9Result = tmp9(require(4299) /* Text */.Text, obj4);
  }
  items1[1] = tmp9Result;
  ...
  if (tmp11Result) {
    ...
    if (tmp9Result) {
      ...
      tmp9Result = tmp9(require(4823) /* LockIcon */.LockIcon, obj7);
    }
    ...
    if (isSubscriptionGated) {
      ...
      isSubscriptionGated = tmp9(tmp2(15243), obj9);
    }
  ...
  if (obj) {
    ...
    tmp9Result2 = tmp9(require(4299) /* Text */.Text, obj14);
  }
