// Module ID: 15982
// Function ID: 15983
// Dependencies: [19, 4498, 21, 4310, 9601, 4302, 712, 15968, 15381, 14481, 11, 4718, 15969, 4844, 15981, 15972, 9723, 3979, 4492, 2]
...
const memoResult = importAllResult.memo(function DMChannel(navigationReplace) {
  ...
  const tmp4 = flag(15968)();
  const fontScale = channel(4718).useFontScale();
  ...
  const tmp5Result = channel(4718);
  obj1[5] = jsx(flag(15972), { unread, resolvedUnreadSetting: UnreadSetting.ALL_MESSAGES, muted });
  ...
  if (tmp11Result) {
    ...
    obj3[2] = str;
    obj3[3] = muted;
    obj3[4] = tmp5(3979).ChannelListLayoutTypes.COMPACT;
    tmp11Result = tmp11(tmp5(9723).ChannelRowPreview, obj3);
  }
  obj1[6] = tmp11Result;
  obj1[7] = extractTimestampResult;
  obj1[8] = flag(4492)(channel);
  obj1[9] = fontScale;
  obj.children = flag(15981)(obj1);
  return tmp2Result(jsx(channel(4844).PressableHighlight, { onPress: null, onLongPress: null }));
});
