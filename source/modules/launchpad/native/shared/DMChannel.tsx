// Module ID: 15903
// Function ID: 15904
// Dependencies: [19, 4452, 21, 4263, 9277, 4255, 712, 15889, 15308, 14420, 11, 4672, 15890, 4783, 15902, 15893, 10434, 3933, 4446, 2]
...
const memoResult = importAllResult.memo(function DMChannel(navigationReplace) {
  ...
  const tmp4 = flag(15889)();
  const fontScale = channel(4672).useFontScale();
  ...
  const tmp5Result = channel(4672);
  obj1[5] = jsx(flag(15893), { unread, resolvedUnreadSetting: UnreadSetting.ALL_MESSAGES, muted });
  ...
  if (tmp11Result) {
    ...
    obj3[2] = str;
    obj3[3] = muted;
    obj3[4] = tmp5(3933).ChannelListLayoutTypes.COMPACT;
    tmp11Result = tmp11(tmp5(10434).ChannelRowPreview, obj3);
  }
  obj1[6] = tmp11Result;
  obj1[7] = extractTimestampResult;
  obj1[8] = flag(4446)(channel);
  obj1[9] = fontScale;
  obj.children = flag(15902)(obj1);
  return tmp2Result(jsx(channel(4783).PressableHighlight, { onPress: null, onLongPress: null }));
});
