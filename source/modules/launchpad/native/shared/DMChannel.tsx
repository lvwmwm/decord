// Module ID: 15956
// Function ID: 15957
// Dependencies: [19, 4481, 21, 4293, 9585, 4285, 712, 15942, 15357, 14465, 11, 4701, 15943, 4827, 15955, 15946, 9707, 3962, 4475, 2]
...
const memoResult = importAllResult.memo(function DMChannel(navigationReplace) {
  ...
  obj1[5] = jsx(flag(15946), { unread, resolvedUnreadSetting: UnreadSetting.ALL_MESSAGES, muted });
  ...
  if (tmp11Result) {
    ...
    obj3[2] = str;
    obj3[3] = muted;
    obj3[4] = tmp5(3962).ChannelListLayoutTypes.COMPACT;
    tmp11Result = tmp11(tmp5(9707).ChannelRowPreview, obj3);
  }
  obj1[6] = tmp11Result;
  obj1[7] = extractTimestampResult;
  obj1[8] = flag(4475)(channel);
  obj1[9] = fontScale;
  obj.children = flag(15955)(obj1);
  return tmp2Result(jsx(channel(4827).PressableHighlight, { onPress: null, onLongPress: null }));
});
