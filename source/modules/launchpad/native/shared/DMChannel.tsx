// Module ID: 16083
// Function ID: 16084
// Dependencies: [19, 4500, 21, 4311, 9671, 4303, 712, 16069, 15481, 14561, 11, 4720, 16070, 4846, 16082, 16073, 9795, 3998, 4494, 2]
...
const memoResult = importAllResult.memo(function DMChannel(navigationReplace) {
  ...
  const tmp7 = flag(14561)(channel, { unread });
  ...
  obj1[5] = jsx(flag(16073), { unread, resolvedUnreadSetting: UnreadSetting.ALL_MESSAGES, muted });
  ...
  if (tmp11Result) {
    ...
    obj3[2] = str;
    obj3[3] = muted;
    obj3[4] = tmp5(3998).ChannelListLayoutTypes.COMPACT;
    tmp11Result = tmp11(tmp5(9795).ChannelRowPreview, obj3);
  }
  obj1[6] = tmp11Result;
  obj1[7] = extractTimestampResult;
  obj1[8] = flag(4494)(channel);
  obj1[9] = fontScale;
  obj.children = flag(16082)(obj1);
