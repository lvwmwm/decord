// Module ID: 15916
// Function ID: 15917
// Dependencies: [19, 4451, 21, 4263, 9556, 4255, 712, 15902, 15319, 14428, 11, 4671, 15903, 4797, 15915, 15906, 9676, 3933, 4445, 2]
...
const memoResult = importAllResult.memo(function DMChannel(navigationReplace) {
  ...
  const tmp4 = flag(15902)();
  const fontScale = channel(4671).useFontScale();
  ...
  const tmp5Result = channel(4671);
  obj1[5] = jsx(flag(15906), { unread, resolvedUnreadSetting: UnreadSetting.ALL_MESSAGES, muted });
  ...
  if (tmp11Result) {
    ...
    tmp11Result = tmp11(tmp5(9676).ChannelRowPreview, obj3);
  }
  obj1[6] = tmp11Result;
  obj1[7] = extractTimestampResult;
  obj1[8] = flag(4445)(channel);
  obj1[9] = fontScale;
  obj.children = flag(15915)(obj1);
  return tmp2Result(jsx(channel(4797).PressableHighlight, { onPress: null, onLongPress: null }));
});
