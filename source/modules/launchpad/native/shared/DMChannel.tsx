// Module ID: 16420
// Function ID: 16421
// Dependencies: [19, 4654, 21, 4455, 9883, 4444, 712, 16406, 15783, 14834, 11, 4886, 16407, 5015, 16419, 16410, 10012, 4139, 4638, 2]
...
const memoResult = importAllResult.memo(function DMChannel(navigationReplace) {
  ...
  const tmp7 = flag(14834)(channel, { unread });
  ...
  const tmp5Result = channel(4886);
  obj1[5] = jsx(flag(16410), { unread, resolvedUnreadSetting: UnreadSetting.ALL_MESSAGES, muted });
  ...
  if (tmp11Result) {
    ...
    tmp11Result = tmp11(tmp5(10012).ChannelRowPreview, obj3);
  }
  obj1[6] = tmp11Result;
  obj1[7] = extractTimestampResult;
  obj1[8] = flag(4638)(channel);
  obj1[9] = fontScale;
  obj.children = flag(16419)(obj1);
  return tmp2Result(jsx(channel(5015).PressableHighlight, {
    onPress: importAllResult.useCallback(() => {
      let obj = channel(closure_1_2[3]);
      obj = { navigationReplace: flag };
      obj.transitionToChannel(channel.id, obj);
