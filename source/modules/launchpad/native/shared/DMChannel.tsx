// Module ID: 16066
// Function ID: 16067
// Dependencies: [19, 4500, 21, 4311, 9666, 4303, 712, 16052, 15464, 14553, 11, 4720, 16053, 4846, 16065, 16056, 9790, 3979, 4494, 2]
...
const memoResult = importAllResult.memo(function DMChannel(navigationReplace) {
  ...
  obj1[5] = jsx(flag(16056), { unread, resolvedUnreadSetting: UnreadSetting.ALL_MESSAGES, muted });
  ...
  if (tmp11Result) {
    ...
    tmp11Result = tmp11(tmp5(9790).ChannelRowPreview, obj3);
  }
  obj1[6] = tmp11Result;
  obj1[7] = extractTimestampResult;
  obj1[8] = flag(4494)(channel);
  obj1[9] = fontScale;
  obj.children = flag(16065)(obj1);
