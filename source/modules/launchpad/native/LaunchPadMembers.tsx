// Module ID: 15986
// Function ID: 15987
// Dependencies: [19, 17, 1372, 1960, 21, 4302, 647, 11507, 15686, 10994, 4298, 1236, 2]
...
const memoResult = require("noop").memo(function LaunchPadMembers() {
  ...
  const stateFromStoresObject = obj.useStateFromStoresObject(items, () => {
    ...
    return { channelId: "channel", type: 95857 };
  });
  if ("private" === stateFromStoresObject.type) {
    ...
    obj[1] = tmp.listStyle;
    obj[1] = jsx(importDefault(11507), { channelId: null, listStyleOverride: null, disableBottomSafeZone: true, insetEnd: 20 }, stateFromStoresObject.channelId);
    ...
    obj1[1] = jsx(importDefault(15686), { channelId: null, guildId: null, listStyleOverride: null, disableBottomSafeZone: true, insetEnd: 20 }, stateFromStoresObject.channelId);
    ...
    obj3[1] = jsx(importDefault(10994), { channelId: null, guildId: null, listStyleOverride: null, disableBottomSafeZone: true, insetEnd: 20 }, stateFromStoresObject.channelId);
    tmp8 = <View style={null}>{null}</View>;
  } else {
    ...
    obj5[1] = jsx(tmp2(4298).Text, { style: null, variant: "text-md/semibold", children: null });
    tmp8 = <View style={null}>{null}</View>;
  }
  return tmp8;
});
