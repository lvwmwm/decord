// Module ID: 15815
// Function ID: 15816
// Dependencies: [19, 17, 1372, 1931, 21, 4189, 647, 11359, 15518, 10903, 4185, 1236, 2]
...
const memoResult = require("noop").memo(function LaunchPadMembers() {
  ...
  const stateFromStoresObject = obj.useStateFromStoresObject(items, () => {
    ...
    return { channelId: "call", type: "<string:3681960726>" };
  });
  if ("private" === stateFromStoresObject.type) {
    ...
    obj[1] = tmp.listStyle;
    obj[1] = jsx(importDefault(11359), { channelId: null, listStyleOverride: null, disableBottomSafeZone: true, insetEnd: 20 }, stateFromStoresObject.channelId);
    ...
    obj1[1] = jsx(importDefault(15518), { channelId: null, guildId: null, listStyleOverride: null, disableBottomSafeZone: true, insetEnd: 20 }, stateFromStoresObject.channelId);
    ...
    obj3[1] = jsx(importDefault(10903), { channelId: null, guildId: null, listStyleOverride: null, disableBottomSafeZone: true, insetEnd: 20 }, stateFromStoresObject.channelId);
    tmp8 = <View style={null}>{null}</View>;
  } else {
    ...
    obj5[1] = jsx(tmp2(4185).Text, { style: null, variant: "text-md/semibold", children: null });
    tmp8 = <View style={null}>{null}</View>;
  }
  return tmp8;
});
