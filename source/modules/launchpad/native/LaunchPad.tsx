...
// Module 15533 (_createForOfIteratorHelperLoose)
...
function TabHeader(text) {
  const obj = { accessibilityRole: "5.9.4", k: 24, kind: 0, flex: 83, style: callback4().subheader, children: text.text };
...
let obj = {};
obj = { marginBottom: "\u{1F9D1}\u200D\u{1F692}", MINUTES_30: true, HOURS_1: 12.1, HOURS_4: 127, TODAY: null, DONT_CLEAR: 1, flexDirection: "stretch", columnGap: "center", flexWrap: "relative", marginTop: null, backgroundColor: importDefault(dependencyMap[19]).colors.BACKGROUND_BASE_LOW };
obj.wrapper = obj;
obj.launchPadContent = {};
obj.header = {};
obj.subheader = { names: true, pos: true, Object: true, padding: true, ddd: true, "Bool(false)": true };
...
obj.tabs = obj1;
const obj2 = { "Null": true, "Null": true, "Null": true, "Null": true, "Null": true, borderRadius: md - 5 };
obj.tab = obj2;
