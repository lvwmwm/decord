...
// Function ID: 16325
// Name: renderItemJSX
// Dependencies: [19, 17, 1996, 7242, 1910, 4590, 21, 4380, 712, 16325, 6066, 589, 4821, 16326, 4949, 16327, 16329, 5885, 16330, 16332, 7452, 16333, 16339, 16340, 16342, 15463, 4376, 1367, 1236, 1494, 16328, 8159, 2]

// Module 16324 (renderItemJSX)
...
import itemsDefault from "items" /* 16326 */;
...
import handleVoiceOrStageChannelConnectPressDefault from "handleVoiceOrStageChannelConnectPress" /* 16340 */;
import userDefault from "user" /* 16342 */;
...
let closure_14 = importAllResult.memo((guild) => {
  ...
  const items4 = [callback(_modDef16329, obj1), , ];
  ...
  return tmp7(callback(guild(4949).PressableHighlight, obj));
});
...
const memoResult1 = importAllResult.memo(function SearchResultsInner(results) {
  ...
  const tmp9 = categoryStyles(16325)();
  closure_4 = tmp9;
  fontScale = results(4821).useFontScale();
  ...
  if (results.length > 0) {
    ...
    tmp12Result = tmp12(categoryStyles(8159), obj);
  }
  obj[1] = tmp12Result;
