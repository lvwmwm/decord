...
// Function ID: 15921
// Name: renderItemJSX
// Dependencies: [19, 17, 1946, 7017, 1862, 4481, 21, 4285, 712, 15921, 5866, 589, 4701, 15922, 4812, 15923, 15925, 5661, 15926, 15928, 7230, 15929, 15935, 15936, 15938, 15133, 4281, 1348, 1236, 1474, 15924, 7818, 2]

// Module 15920 (renderItemJSX)
...
function renderItemJSX(result) {
  ...
  if (null == result) {
    ...
    if (require(7230) /* sortByMatchScore */.AutocompleterResultTypes.GUILD === type) {
      ...
      obj4[1] = tmp;
      obj4[2] = tmp2;
      return tmp14(15133).renderCategoryItem(obj4);
    } else {
...
const memoResult1 = importAllResult.memo(function SearchResultsInner(results) {
  ...
  const tmp9 = categoryStyles(15921)();
  c4 = tmp9;
