...
// Function ID: 9059
// Name: ActivityStatus
// Dependencies: [19, 17, 4276, 3826, 1874, 9059, 676, 21, 4189, 589, 9060, 9061, 9062, 9063, 9068, 9069, 9077, 9081, 9067, 2]
// Exports: default

// Module 9058 (ActivityStatus)
import set from "set";
...
export default function ActivityStatus(guildId) {
  ...
  const voiceChannel = stateFromStores1(9061)({ userId, guildId: guildId.guildId }).voiceChannel;
  ...
  const tmp2 = userId;
  const tmp6 = stateFromStores1(9060)(userId);
  ...
  if (tmp2Result.useStateFromStores(items3, () => outer1_6.isBlockedOrIgnored(userId))) {
    ...
    if (null != tmp6) {
      let found;
      if (stateFromStores1 != null) {
        found = stateFromStores1.find(tmp5(9068));
      }
      ...
      obj[4] = tmp12;
      obj[5] = tmp13;
      let tmp18Result = callback(tmp5(9063), obj);
      const tmp18 = callback;
      const tmp5Result = tmp5(9063);
    } else {
      let found1;
      if (stateFromStores1 != null) {
      ...
      if (null != found1) {
        ...
        obj[4] = tmp12;
        obj[5] = tmp13;
        tmp18Result = callback(tmp5(9069), obj);
      } else {
        tmp18Result = null;
        if (null != voiceChannel) {
          ...
          obj1[4] = tmp12;
          obj1[5] = tmp13;
          tmp18Result = callback(tmp5(9077), obj1);
        }
      }
    }
    let tmp21 = null;
