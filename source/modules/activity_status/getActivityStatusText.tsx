...
// Dependencies: [676, 9587, 7139, 9588, 1236, 9589, 9590, 8847, 2]
// Exports: default

// Module 9586 (getActivityStatusText)
...
export default function getActivityStatusText(name) {
  ...
  if (status_display_type !== require(9587) /* StatusDisplayTypes */.StatusDisplayTypes.NAME) {
