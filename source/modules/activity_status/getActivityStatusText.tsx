...
// Dependencies: [676, 9701, 7244, 9702, 1236, 9703, 9704, 8956, 2]
// Exports: default

// Module 9700 (getActivityStatusText)
...
export default function getActivityStatusText(name) {
  ...
  if (status_display_type !== require(9701) /* StatusDisplayTypes */.StatusDisplayTypes.NAME) {
