...
// Dependencies: [5, 1911, 13773, 676, 7702, 5748, 7707, 5109, 503, 709, 13797, 2]
// Exports: getGeneratedPoolById, loginAsGeneratedUser, removeGeneratedPoolFromList

// Module 13796 (_getGeneratedPoolById)
...
function _getGeneratedPoolById() {
  ...
  const tmp = callback((arg0, arg1) => {
    ...
    return (function*(arg0, arg1) {
      ...
      obj1[1] = obj2;
      const value = callback2(5109).get(obj1);
      const obj6 = callback2(5109);
      yield value.then((body) => {
        body = body.body;
        if (body.ok) {
          const users = body.users;
          let obj = { type: "GENERATED_POOL_BY_ID_FETCH_SUCCESS", pool: null, users: null };
          const GeneratedTestPoolRecord = callback(13797).GeneratedTestPoolRecord;
        ...
        callback2(7707).showFailedToast(constants.GENERIC_ERROR);
        return null;
      });
      return arg1;
    })();
...
export const loginAsGeneratedUser = function loginAsGeneratedUser(id, arg1) {
  ...
  if (null == user) {
    ...
    if (null == password) {
      ...
      obj[0] = user.email;
      obj[1] = password;
      const obj2 = importDefault(5748);
      return importDefault(5748).login(obj).catch(() => {
