...
// Function ID: 12910
// Name: init
// Dependencies: [3921, 4301, 12910, 589, 709, 2]
    ...
    if (0 === set.size) {
      ...
      if (isIgnoredResult) {
        ...
        if (0 === set1.size) {
          ...
          if (flag3) {
            const result = importDefault(12910).handleBlockedOrIgnoredUserVoiceChannelJoin(channelId, id);
            const obj4 = importDefault(12910);
          }
          return flag4;
        }
        if (flag4) {
