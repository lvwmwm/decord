...
// Function ID: 12925
// Name: init
// Dependencies: [3938, 4318, 12925, 589, 709, 2]
    ...
    if (0 === set.size) {
      ...
      if (isIgnoredResult) {
        ...
        if (0 === set1.size) {
          ...
          if (flag3) {
            const result = importDefault(12925).handleBlockedOrIgnoredUserVoiceChannelJoin(channelId, id);
            const obj4 = importDefault(12925);
          }
          return flag4;
        }
        if (flag4) {
