...
// Dependencies: [19, 17, 1372, 1903, 12914, 676, 21, 4285, 712, 4281, 4474, 1236, 589, 1351, 1297, 11142, 9582, 4246, 4241, 698, 5685, 10273, 5688, 5354, 4695, 4253, 12915, 4295, 2]
// Exports: default

// Module 12913 (getUserCalloutRowText)
...
function UserCalloutAvatars(userIds) {
  ...
  if (1 === userIds.length) {
    if (null != mergeGuildAvatar.getUser(userIds[0])) {
      ...
      tmp6 = callback(tmp(11142).UserIcon, {});
    }
  } else {
    obj = { users: null, size: null };
    obj[0] = found;
    obj[1] = tmp(1297).AvatarSizes.REFRESH_MEDIUM_32;
    return callback(tmp(9582).FacepileGroupDMAvatar, obj);
  }
}
