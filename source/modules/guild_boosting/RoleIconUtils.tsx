...
export const getRoleIconData = function getRoleIconData(role, arg1) {
  ...
  if (null == role) {
    ...
    if (null != role.unicodeEmoji) {
      ...
      byName = obj.getByName(importDefault(3925).convertSurrogateToName(role.unicodeEmoji, false));
