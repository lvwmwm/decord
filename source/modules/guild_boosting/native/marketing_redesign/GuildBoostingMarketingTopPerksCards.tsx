...
// Function ID: 12664
// Name: items
// Dependencies: [19, 17, 4181, 21, 4189, 712, 1236, 12664, 5506, 12665, 12666, 4185, 11655, 2]
// Exports: default
...
let items = [
  {
    ...
    getGraphic(style) {
      return callback(closure_3, { style, source: importDefault(12664) });
    }
  },
  {
    getHeadingCopy() {
  ...
  },
  {
    ...
    getGraphic(style) {
      return callback(closure_3, { style, source: importDefault(12666) });
    }
  }
];
...
export default function GuildBoostingMarketingTopPerksCards() {
  ...
  let items = [callback(require(4185) /* Text */.Text, obj), ];
  ...
  items[1] = callback(require(11655) /* items */.MarketingCardsScroller, obj);
  obj[1] = items;
