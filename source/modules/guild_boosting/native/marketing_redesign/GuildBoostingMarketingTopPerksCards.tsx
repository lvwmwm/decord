...
// Function ID: 12658
// Name: items
// Dependencies: [19, 17, 4181, 21, 4189, 712, 1236, 12658, 5506, 12659, 12660, 4185, 11651, 2]
// Exports: default
...
let items = [
  {
    ...
    getGraphic(style) {
      return callback(closure_3, { style, source: importDefault(12658) });
    }
  },
  {
    getHeadingCopy() {
    ...
    getGraphic(arg0) {
      ...
      obj[2] = arg0;
      return callback(importDefault(5506), obj);
    }
  },
  {
    getHeadingCopy() {
    ...
    getGraphic(style) {
      return callback(closure_3, { style, source: importDefault(12660) });
    }
  }
];
...
export default function GuildBoostingMarketingTopPerksCards() {
  ...
  let items = [callback(require(4185) /* Text */.Heading, obj), ];
  ...
  items[1] = callback(require(11651) /* items */.MarketingCardsScroller, obj);
  obj[1] = items;
