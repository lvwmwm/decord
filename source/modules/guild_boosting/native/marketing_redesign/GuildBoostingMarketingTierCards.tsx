...
// Function ID: 12944
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1924, 21, 7721, 1236, 7772, 11970, 4892, 4888, 10006, 7784, 7724, 4286, 12944, 4342, 712, 12938, 5220, 4083, 4343, 4338, 4278, 1363, 4788, 4909, 4234, 12945, 12947, 4191, 1297, 12949, 12950, 5432, 12002, 2]
// Exports: default

// Module 12943 (TierFeatures)
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12944) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(12945).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(12947).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(4909).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    obj18[6] = obj19;
    tmp13(tmp2(4788), obj18);
    const tmp2Result2 = tmp2(4788);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(12002).MarketingCardsScroller, obj);
};
