...
// Function ID: 97570
// Name: TierFeatures
// Dependencies: [57, 31, 27, 653, 1852, 33, 6555, 1212, 6608, 11598, 4693, 4689, 9591, 6620, 6558, 4109, 12629, 4165, 689, 12623, 5008, 4026, 4166, 4161, 4101, 4011, 4589, 4695, 4057, 12630, 12632, 4009, 1273, 12634, 12635, 5195, 11631, 2]
// Exports: default

// Module 12628 (TierFeatures)
...
let obj14 = {
  ...
  getCopy() {
    const intl = require(1212) /* getSystemLocale */.intl;
    const obj = { resolution: require(12629) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards") };
...
let closure_15 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let obj = features(4011);
  const tmp2 = importDefault(4101)();
  const unsafe_rawColors = importDefault(689).unsafe_rawColors;
  const tmp7 = obj.isThemeDark(importDefault(4101)()) ? unsafe_rawColors.WHITE : unsafe_rawColors.GUILD_BOOSTING_PINK;
  ...
  let obj7 = features(4057);
  obj4.children = obj7.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4161).Text, obj4), ];
  ...
  items2[1] = callback2(features(4161).Text, obj5);
  ...
  const items5 = [callback2(features(4161).Text, obj10), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp19(12630).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp19(12632).ChevronLargeDownIcon;
  }
  ...
  obj1.children = tmp15(features(4695).PressableHighlight, obj2);
  ...
  if (!tmp21) {
    ...
    if (tmp34) {
      const obj12 = {};
      const obj13 = {};
      let obj19 = features(4009);
      const items7 = [obj19.hexWithOpacity(tmp7, 0), , ];
      let obj20 = features(4009);
      items7[1] = obj20.hexWithOpacity(tmp7, 1);
      const tmp40 = importDefault(4589);
      items7[2] = features(4009).hexWithOpacity(tmp7, 0);
      obj13.colors = items7;
      obj13.start = { x: 0, y: 0 };
      obj13.end = { x: 1, y: 0 };
      ...
      const obj14 = {};
      const obj22 = features(4009);
      const tmp43 = importDefault(4589);
      const items10 = [features(4009).hexWithOpacity(tmp7, 0), , ];
      const obj24 = features(4009);
      items10[1] = features(4009).hexWithOpacity(tmp7, 1);
      const obj25 = features(4009);
      items10[2] = features(4009).hexWithOpacity(tmp7, 0);
      ...
      const obj15 = { source: importDefault(12634) };
      const items12 = [, , ];
      ...
      const obj16 = { source: importDefault(12634) };
      const items13 = [, , ];
      ...
      const obj17 = { source: importDefault(12634) };
      const items14 = [, , ];
      ...
      const obj18 = { source: importDefault(12635) };
      const items15 = [, , ];
    ...
    obj20 = callback2(features(4161).Text, obj20);
    obj19.children = obj20;
    callback2(importDefault(4589), obj19);
    const tmp23 = callback2;
    const tmp26 = importDefault(4589);
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return callback2(guild(11631).MarketingCardsScroller, obj);
};
