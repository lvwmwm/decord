...
// Function ID: 12738
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1876, 21, 7548, 1236, 7599, 11775, 4780, 4776, 9837, 7611, 7551, 4199, 12738, 4255, 712, 12732, 5110, 4116, 4256, 4251, 4191, 4101, 4676, 4797, 4147, 12739, 12741, 4099, 1297, 12743, 12744, 5297, 11807, 2]
// Exports: default

// Module 12737 (TierFeatures)
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12738) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(12739).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(12741).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(4797).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    obj18[6] = obj19;
    tmp13(tmp2(4676), obj18);
    const tmp2Result2 = tmp2(4676);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11807).MarketingCardsScroller, obj);
};
