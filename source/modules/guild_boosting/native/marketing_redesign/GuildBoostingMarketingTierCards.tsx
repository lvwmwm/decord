...
// Function ID: 12670
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1876, 21, 6579, 1236, 6632, 11635, 4719, 4715, 9625, 6644, 6582, 4137, 12670, 4193, 712, 12664, 5034, 4054, 4194, 4189, 4129, 4039, 4615, 4721, 4085, 12671, 12673, 4037, 1297, 12675, 12676, 5221, 11669, 2]
// Exports: default
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12670) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let obj = features(4039);
  const tmp4 = importDefault(4129)();
  const unsafe_rawColors = importDefault(712).unsafe_rawColors;
  const tmp9 = obj.isThemeDark(importDefault(4129)()) ? unsafe_rawColors.WHITE : unsafe_rawColors.GUILD_BOOSTING_PINK;
  ...
  let tmp7Result = tmp7(4085);
  obj4[3] = tmp7Result.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4189).Text, obj4), ];
  ...
  items2[1] = callback2(features(4189).Text, obj5);
  obj3[1] = items2;
  ...
  const items5 = [callback2(features(4189).Text, { color: "text-overlay-light", variant: "text-md/semibold", children: stringResult }), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(12671).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(12673).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(4721).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4037);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4037).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4037);
      items7[2] = tmp7(4037).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4037);
      const tmp2Result1 = tmp2(4615);
      const items10 = [tmp7(4037).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4037);
      items10[1] = tmp7(4037).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4037);
      items10[2] = tmp7(4037).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4189).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4615), obj18);
    const tmp2Result2 = tmp2(4615);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11669).MarketingCardsScroller, obj);
};
