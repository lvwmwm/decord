...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(4812).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4129);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4129).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4129);
      items7[2] = tmp7(4129).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4129);
      const tmp2Result1 = tmp2(4706);
      const items10 = [tmp7(4129).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4129);
      items10[1] = tmp7(4129).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4129);
      items10[2] = tmp7(4129).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
