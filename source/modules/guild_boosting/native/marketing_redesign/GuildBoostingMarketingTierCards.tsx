...
// Function ID: 13515
// Name: TierFeatures
// Dependencies: [32, 19, 17, 673, 1923, 21, 8687, 1233, 10043, 12464, 5062, 5058, 10310, 13303, 9300, 4424, 13515, 4481, 709, 13509, 5401, 4218, 4482, 4477, 4416, 1362, 4948, 5084, 4372, 13516, 13518, 4329, 1296, 13520, 13521, 5536, 12496, 2]
// Exports: default

// Module 13514 (TierFeatures)
import ThemesDefault from "Themes" /* 709 */;
import getSystemLocale from "getSystemLocale" /* 1233 */;
import useThemeDefault from "useTheme" /* 4416 */;
import CONTROL_RESOLUTION from "CONTROL_RESOLUTION" /* 13515 */;
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let tmp7Result = tmp7(4372);
  obj4[3] = tmp7Result.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4477).Text, obj4), ];
  ...
  items2[1] = callback2(features(4477).Text, obj5);
  obj3[1] = items2;
  ...
  const items5 = [callback2(features(4477).Text, { color: "text-overlay-light", variant: "text-md/semibold", children: stringResult }), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13516).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13518).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(5084).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4329);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4329).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4329);
      items7[2] = tmp7(4329).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4329);
      const tmp2Result1 = tmp2(4948);
      const items10 = [tmp7(4329).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4329);
      items10[1] = tmp7(4329).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4329);
      items10[2] = tmp7(4329).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4477).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4948), obj18);
    const tmp2Result2 = tmp2(4948);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(12496).MarketingCardsScroller, obj);
};
