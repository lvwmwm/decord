...
// Function ID: 12860
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1905, 21, 7655, 1236, 7706, 11890, 4829, 4825, 9950, 7718, 7658, 4247, 12860, 4303, 712, 12854, 5158, 4036, 4304, 4299, 4239, 4153, 4725, 4846, 4195, 12861, 12863, 4151, 1297, 12865, 12866, 5371, 11922, 2]
// Exports: default

// Module 12859 (TierFeatures)
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12860) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let obj = features(4153);
  const tmp4 = importDefault(4239)();
  const unsafe_rawColors = importDefault(712).unsafe_rawColors;
  const tmp9 = obj.isThemeDark(importDefault(4239)()) ? unsafe_rawColors.WHITE : unsafe_rawColors.GUILD_BOOSTING_PINK;
  ...
  let tmp7Result = tmp7(4195);
  obj4[3] = tmp7Result.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4299).Text, obj4), ];
  ...
  items2[1] = callback2(features(4299).Text, obj5);
  obj3[1] = items2;
  ...
  const items5 = [callback2(features(4299).Text, { color: "text-overlay-light", variant: "text-md/semibold", children: stringResult }), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(12861).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(12863).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(4846).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4151);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4151).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4151);
      items7[2] = tmp7(4151).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4151);
      const tmp2Result1 = tmp2(4725);
      const items10 = [tmp7(4151).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4151);
      items10[1] = tmp7(4151).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4151);
      items10[2] = tmp7(4151).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4299).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4725), obj18);
    const tmp2Result2 = tmp2(4725);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11922).MarketingCardsScroller, obj);
};
