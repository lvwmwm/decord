...
// Function ID: 12733
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1876, 21, 7564, 1236, 7615, 11742, 4781, 4777, 9773, 7627, 7567, 4199, 12733, 4255, 712, 12727, 5096, 4116, 4256, 4251, 4191, 4101, 4677, 4783, 4147, 12734, 12736, 4099, 1297, 12738, 12739, 5283, 11774, 2]
// Exports: default

// Module 12732 (TierFeatures)
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12733) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let obj = features(4101);
  const tmp4 = importDefault(4191)();
  const unsafe_rawColors = importDefault(712).unsafe_rawColors;
  const tmp9 = obj.isThemeDark(importDefault(4191)()) ? unsafe_rawColors.WHITE : unsafe_rawColors.GUILD_BOOSTING_PINK;
  ...
  const items2 = [callback2(features(4251).Text, obj4), ];
  ...
  items2[1] = callback2(features(4251).Text, obj5);
  obj3[1] = items2;
  ...
  const items5 = [callback2(features(4251).Text, { color: "text-overlay-light", variant: "text-md/semibold", children: stringResult }), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(12734).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(12736).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(4783).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4099);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4099).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4099);
      items7[2] = tmp7(4099).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4099);
      const tmp2Result1 = tmp2(4677);
      const items10 = [tmp7(4099).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4099);
      items10[1] = tmp7(4099).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4099);
      items10[2] = tmp7(4099).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4251).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4677), obj18);
    const tmp2Result2 = tmp2(4677);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11774).MarketingCardsScroller, obj);
};
