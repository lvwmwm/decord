...
// Function ID: 12651
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1876, 21, 6576, 1236, 6629, 11622, 4715, 4711, 9613, 6641, 6579, 4133, 12651, 4189, 712, 12645, 5030, 4050, 4190, 4185, 4125, 4035, 4611, 4717, 4081, 12652, 12654, 4033, 1297, 12656, 12657, 5217, 11655, 2]
// Exports: default

// Module 12650 (TierFeatures)
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12651) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let obj = features(4035);
  const tmp4 = importDefault(4125)();
  const unsafe_rawColors = importDefault(712).unsafe_rawColors;
  const tmp9 = obj.isThemeDark(importDefault(4125)()) ? unsafe_rawColors.WHITE : unsafe_rawColors.GUILD_BOOSTING_PINK;
  ...
  let tmp7Result = tmp7(4081);
  obj4[3] = tmp7Result.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4185).Text, obj4), ];
  ...
  items2[1] = callback2(features(4185).Text, obj5);
  obj3[1] = items2;
  ...
  const items5 = [callback2(features(4185).Text, { color: "text-overlay-light", variant: "text-md/semibold", children: stringResult }), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(12652).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(12654).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(4717).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4033);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4033).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4033);
      items7[2] = tmp7(4033).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4033);
      const tmp2Result1 = tmp2(4611);
      const items10 = [tmp7(4033).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4033);
      items10[1] = tmp7(4033).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4033);
      items10[2] = tmp7(4033).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4185).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4611), obj18);
    const tmp2Result2 = tmp2(4611);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11655).MarketingCardsScroller, obj);
};
