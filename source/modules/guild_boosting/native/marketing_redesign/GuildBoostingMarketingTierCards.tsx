...
// Function ID: 12866
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1924, 21, 7657, 1236, 7708, 11894, 4829, 4825, 9956, 7720, 7660, 4247, 12866, 4303, 712, 12860, 5158, 4042, 4304, 4299, 4239, 1363, 4725, 4846, 4195, 12867, 12869, 4152, 1297, 12871, 12872, 5371, 11926, 2]
// Exports: default

// Module 12865 (TierFeatures)
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12866) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(12867).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(12869).ChevronLargeDownIcon;
  }
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4152);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4152).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4152);
      items7[2] = tmp7(4152).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4152);
      const tmp2Result1 = tmp2(4725);
      const items10 = [tmp7(4152).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4152);
      items10[1] = tmp7(4152).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4152);
      items10[2] = tmp7(4152).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11926).MarketingCardsScroller, obj);
};
