...
// Function ID: 13179
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1925, 21, 8174, 1236, 10135, 12030, 5015, 5011, 10310, 12969, 8172, 4389, 13179, 4446, 712, 13173, 5349, 4186, 4447, 4442, 4381, 1363, 4905, 5033, 4337, 13180, 13182, 4294, 1297, 13184, 13185, 5561, 12062, 2]
// Exports: default

// Module 13178 (TierFeatures)
import ThemesDefault from "Themes" /* 712 */;
import getSystemLocale from "getSystemLocale" /* 1236 */;
import useThemeDefault from "useTheme" /* 4381 */;
import CONTROL_RESOLUTION from "CONTROL_RESOLUTION" /* 13179 */;
import closure_3 from "_slicedToArray" /* 32 */;
import importAllResult from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import ME from "ME" /* 676 */;
import { BoostedGuildFeatures } from "GuildFeatures" /* 1925 */;
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let tmp7Result = tmp7(4337);
  obj4[3] = tmp7Result.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4442).Text, obj4), ];
  ...
  items2[1] = callback2(features(4442).Text, obj5);
  obj3[1] = items2;
  ...
  const items5 = [callback2(features(4442).Text, { color: "text-overlay-light", variant: "text-md/semibold", children: stringResult }), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13180).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13182).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(5033).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4294);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4294).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4294);
      items7[2] = tmp7(4294).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4294);
      const tmp2Result1 = tmp2(4905);
      const items10 = [tmp7(4294).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4294);
      items10[1] = tmp7(4294).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4294);
      items10[2] = tmp7(4294).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4442).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4905), obj18);
    const tmp2Result2 = tmp2(4905);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(12062).MarketingCardsScroller, obj);
};
