...
// Function ID: 12862
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1905, 21, 7655, 1236, 7706, 11891, 4829, 4825, 9951, 7718, 7658, 4247, 12862, 4303, 712, 12856, 5158, 4036, 4304, 4299, 4239, 4153, 4725, 4846, 4195, 12863, 12865, 4151, 1297, 12867, 12868, 5371, 11923, 2]
// Exports: default

// Module 12861 (TierFeatures)
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12862) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(12863).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(12865).ChevronLargeDownIcon;
  }
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11923).MarketingCardsScroller, obj);
};
