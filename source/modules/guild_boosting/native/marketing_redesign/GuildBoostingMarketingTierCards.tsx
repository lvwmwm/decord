...
// Function ID: 12775
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1905, 21, 7576, 1236, 7627, 11809, 4810, 4806, 9868, 7639, 7579, 4229, 12775, 4285, 712, 12769, 5140, 4145, 4286, 4281, 4221, 4130, 4706, 4827, 4177, 12776, 12778, 4128, 1297, 12780, 12781, 5351, 11841, 2]
// Exports: default

// Module 12774 (TierFeatures)
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12775) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let tmp7Result = tmp7(4177);
  obj4[3] = tmp7Result.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4281).Text, obj4), ];
  ...
  items2[1] = callback2(features(4281).Text, obj5);
  obj3[1] = items2;
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(12776).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(12778).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(4827).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4128);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4128).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4128);
      items7[2] = tmp7(4128).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4128);
      const tmp2Result1 = tmp2(4706);
      const items10 = [tmp7(4128).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4128);
      items10[1] = tmp7(4128).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4128);
      items10[2] = tmp7(4128).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4281).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4706), obj18);
    const tmp2Result2 = tmp2(4706);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11841).MarketingCardsScroller, obj);
};
