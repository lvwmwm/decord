...
// Function ID: 13076
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1924, 21, 7978, 1236, 8029, 11748, 6934, 6930, 10250, 8041, 7981, 4322, 13076, 4668, 712, 13070, 6320, 4119, 4671, 4739, 4314, 1363, 4761, 5438, 4270, 13077, 13079, 4227, 1297, 13081, 13082, 5448, 11782, 2]
// Exports: default

// Module 13075 (TierFeatures)
import ThemesDefault from "Themes" /* 712 */;
import getSystemLocale from "getSystemLocale" /* 1236 */;
import useThemeDefault from "useTheme" /* 4314 */;
import CONTROL_RESOLUTION from "CONTROL_RESOLUTION" /* 13076 */;
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let tmp7Result = tmp7(4270);
  obj4[3] = tmp7Result.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4739).Text, obj4), ];
  ...
  items2[1] = callback2(features(4739).Text, obj5);
  obj3[1] = items2;
  ...
  const items5 = [callback2(features(4739).Text, { color: "text-overlay-light", variant: "text-md/semibold", children: stringResult }), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13077).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13079).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(5438).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4227);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4227).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4227);
      items7[2] = tmp7(4227).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4227);
      const tmp2Result1 = tmp2(4761);
      const items10 = [tmp7(4227).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4227);
      items10[1] = tmp7(4227).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4227);
      items10[2] = tmp7(4227).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4739).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4761), obj18);
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11782).MarketingCardsScroller, obj);
};
