...
// Function ID: 12790
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1905, 21, 7595, 1236, 7646, 11824, 4827, 4823, 9884, 7658, 7598, 4246, 12790, 4302, 712, 12784, 5157, 4162, 4303, 4298, 4238, 4147, 4723, 4844, 4194, 12791, 12793, 4145, 1297, 12795, 12796, 5370, 11856, 2]
// Exports: default

// Module 12789 (TierFeatures)
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12790) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let obj = features(4147);
  const tmp4 = importDefault(4238)();
  const unsafe_rawColors = importDefault(712).unsafe_rawColors;
  const tmp9 = obj.isThemeDark(importDefault(4238)()) ? unsafe_rawColors.WHITE : unsafe_rawColors.GUILD_BOOSTING_PINK;
  ...
  let tmp7Result = tmp7(4194);
  obj4[3] = tmp7Result.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4298).Text, obj4), ];
  ...
  items2[1] = callback2(features(4298).Text, obj5);
  obj3[1] = items2;
  ...
  const items5 = [callback2(features(4298).Text, { color: "text-overlay-light", variant: "text-md/semibold", children: stringResult }), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(12791).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(12793).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(4844).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4145);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4145).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4145);
      items7[2] = tmp7(4145).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4145);
      const tmp2Result1 = tmp2(4723);
      const items10 = [tmp7(4145).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4145);
      items10[1] = tmp7(4145).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4145);
      items10[2] = tmp7(4145).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4298).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4723), obj18);
    const tmp2Result2 = tmp2(4723);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11856).MarketingCardsScroller, obj);
};
