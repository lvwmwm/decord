...
// Function ID: 13212
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1924, 21, 8196, 1236, 10158, 12063, 5018, 5014, 10334, 13003, 8194, 4391, 13212, 4448, 712, 13206, 5352, 4187, 4449, 4444, 4383, 1363, 4908, 5036, 4339, 13213, 13215, 4296, 1297, 13217, 13218, 5564, 12095, 2]
// Exports: default

// Module 13211 (TierFeatures)
import ThemesDefault from "Themes" /* 712 */;
import getSystemLocale from "getSystemLocale" /* 1236 */;
import useThemeDefault from "useTheme" /* 4383 */;
import CONTROL_RESOLUTION from "CONTROL_RESOLUTION" /* 13212 */;
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let tmp7Result = tmp7(4339);
  obj4[3] = tmp7Result.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4444).Text, obj4), ];
  ...
  items2[1] = callback2(features(4444).Text, obj5);
  obj3[1] = items2;
  ...
  const items5 = [callback2(features(4444).Text, { color: "text-overlay-light", variant: "text-md/semibold", children: stringResult }), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13213).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13215).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(5036).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4296);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4296).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4296);
      items7[2] = tmp7(4296).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4296);
      const tmp2Result1 = tmp2(4908);
      const items10 = [tmp7(4296).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4296);
      items10[1] = tmp7(4296).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4296);
      items10[2] = tmp7(4296).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4444).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4908), obj18);
    const tmp2Result2 = tmp2(4908);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(12095).MarketingCardsScroller, obj);
};
