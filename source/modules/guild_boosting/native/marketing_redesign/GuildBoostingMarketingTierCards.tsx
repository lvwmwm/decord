...
// Function ID: 12926
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1924, 21, 7700, 1236, 7751, 11954, 4870, 4866, 9995, 7763, 7703, 4286, 12926, 4342, 712, 12920, 5199, 4083, 4343, 4338, 4278, 1363, 4766, 4887, 4234, 12927, 12929, 4191, 1297, 12931, 12932, 5411, 11986, 2]
// Exports: default

// Module 12925 (TierFeatures)
...
items2[2] = {
  ...
  getCopy() {
    ...
    obj[0] = require(12926) /* CONTROL_RESOLUTION */.getServerBoostStreamQualityMarketingResolution("GuildBoostingMarketingTierCards");
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(11986).MarketingCardsScroller, obj);
};
