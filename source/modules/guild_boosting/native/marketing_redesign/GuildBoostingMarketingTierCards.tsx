...
// Function ID: 13160
// Name: TierFeatures
// Dependencies: [32, 19, 17, 676, 1924, 21, 8160, 1236, 10117, 12011, 5002, 4998, 10292, 12950, 8158, 4388, 13160, 4445, 712, 13154, 5336, 4185, 4446, 4441, 4380, 1363, 4892, 5020, 4336, 13161, 13163, 4293, 1297, 13165, 13166, 5548, 12043, 2]
// Exports: default

// Module 13159 (TierFeatures)
import ThemesDefault from "Themes" /* 712 */;
import getSystemLocale from "getSystemLocale" /* 1236 */;
import useThemeDefault from "useTheme" /* 4380 */;
import CONTROL_RESOLUTION from "CONTROL_RESOLUTION" /* 13160 */;
...
let closure_16 = importAllResult.forwardRef((onCardPress, ref) => {
  ...
  let tmp7Result = tmp7(4336);
  obj4[3] = tmp7Result.getTierName(tier, { useLevels: false });
  const items2 = [callback2(features(4441).Text, obj4), ];
  ...
  items2[1] = callback2(features(4441).Text, obj5);
  obj3[1] = items2;
  ...
  const items5 = [callback2(features(4441).Text, { color: "text-overlay-light", variant: "text-md/semibold", children: stringResult }), ];
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13161).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13163).ChevronLargeDownIcon;
  }
  ...
  obj2[5] = items3;
  obj1[1] = callback3(features(5020).PressableHighlight, obj2);
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      tmp7Result = tmp7(4293);
      const items7 = [tmp7Result.hexWithOpacity(tmp9, 0), tmp7(4293).hexWithOpacity(tmp9, 1), ];
      const tmp7Result1 = tmp7(4293);
      items7[2] = tmp7(4293).hexWithOpacity(tmp9, 0);
      obj12[0] = items7;
      obj12[1] = { x: 0, y: 0 };
      obj12[2] = { x: 1, y: 0 };
      obj12[3] = [0, 0.5, 1];
      ...
      const tmp7Result2 = tmp7(4293);
      const tmp2Result1 = tmp2(4892);
      const items10 = [tmp7(4293).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result3 = tmp7(4293);
      items10[1] = tmp7(4293).hexWithOpacity(tmp9, 1);
      const tmp7Result4 = tmp7(4293);
      items10[2] = tmp7(4293).hexWithOpacity(tmp9, 0);
      obj13[0] = items10;
      obj13[1] = { x: 0, y: 0 };
      obj13[2] = { x: 1, y: 0 };
      obj13[3] = [0, 0.5, 1];
    ...
    obj19 = tmp13(tmp7(4441).Text, obj19);
    obj18[6] = obj19;
    tmp13(tmp2(4892), obj18);
    const tmp2Result2 = tmp2(4892);
  }
});
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return closure_9(_require(12043).MarketingCardsScroller, obj);
};
