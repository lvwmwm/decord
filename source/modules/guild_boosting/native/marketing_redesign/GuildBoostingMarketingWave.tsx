...
// Dependencies: [19, 21, 4024, 712, 7837, 2]
// Exports: default

// Module 12858 (GuildBoostingMarketingWave)
import "noop";
...
export default function GuildBoostingMarketingWave(arg0) {
  ...
  obj.children = jsx(require(7837) /* inlineStyles */.Path, { d: "M1512,25.1c-294.3-135.3-565.2,319.2-855,322.2c-232,2.4-279-101.8-415.5-100.5C149.9,247.7,49.8,311.3,0,355.4 v154.4h1512V25.1z", fill: token });
  return jsx(importDefault(7837), { fill: "none", viewBox: "0 0 1512 510", preserveAspectRatio: "none" });
};
