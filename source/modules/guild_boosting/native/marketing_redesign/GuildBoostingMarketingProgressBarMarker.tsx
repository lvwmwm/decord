...
// Dependencies: [19, 17, 676, 21, 13017, 13018, 13019, 4661, 712, 4310, 4115, 4744, 11753, 4223, 1363, 10756, 4734, 4266, 2]
// Exports: default
...
export default function ProgressBarMarker(arg0) {
  ...
  const isThemeDarkResult = tmp5Result.isThemeDark(importDefault(4310)());
