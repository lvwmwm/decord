...
// Dependencies: [31, 27, 653, 33, 12582, 12583, 12584, 4131, 689, 4067, 3992, 4543, 11613, 3975, 3977, 9946, 4127, 4023, 2]
// Exports: default

// Module 12581 (ProgressBarMarkerInnerContent)
...
function ProgressBarMarkerInnerContent(arg0) {
  ...
  if (tier === BoostedGuildTiers.NONE) {
    ...
    obj.style = items1;
    let View = isTierUnlocked(3992).View;
    obj = {};
    ...
    let tmp27Result = tmp27(sharedValue(11613).BoostGemSlashIcon, { size: "xxs", color: "currentColor" });
  } else {
...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    items2[2] = obj2;
    obj1.style = items2;
    const items3 = [tmp12(importDefault(3992).View, obj1), , ];
    ...
    if (tmp7) {
      const obj5 = { source: importDefault(9946), style: tmp.progressBarMarkerUnlockedIcon };
    ...
    obj6.children = sharedValue(4023).getTierName(tier, obj7);
    items5[1] = callback(sharedValue(4127).Text, obj6);
    obj4.children = items5;
    items3[2] = closure_8(closure_4, obj4);
    obj.children = items3;
    return tmp10(tmp11, obj);
  }
  obj6 = sharedValue(3977);
  tmp10 = closure_8;
  tmp11 = closure_4;
  tmp12 = callback;
  const tmp2 = importDefault(4067)();
  const isThemeDarkResult = obj6.isThemeDark(importDefault(4067)());
  const hexWithOpacity = sharedValue(3975).hexWithOpacity;
