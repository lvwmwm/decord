...
// Dependencies: [32, 19, 17, 1922, 4336, 676, 1924, 21, 687, 4444, 712, 1297, 4184, 4445, 5900, 5920, 647, 13009, 8386, 4350, 4107, 1938, 13063, 13065, 4891, 13125, 4440, 1236, 5951, 5015, 13050, 7073, 13128, 13129, 4879, 5324, 10252, 13130, 8837, 2]
// Exports: default

// Module 13124 (GuildBoostingMarketingCtaBar)
...
import closure_7 from "handleGuildBoostsUpdate" /* 4336 */;
...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  obj = { withTiming: _require(4445).withTiming, isVisible: first };
  fn.__closure = obj;
  ...
  obj = { withTiming: _require(4445).withTiming, isVisible: tmp12 };
  fn2.__closure = obj;
  ...
  let obj7 = first(4107);
  const tmp14Result = first(13009)(fractionalPremiumInfo.endsAt, _require(13009).CountDownMessageTypes.LONG_TIME_LEFT);
  ...
  const items6 = [callback(_require(4440).Heading, obj6), , , , ];
  ...
  obj7[3] = _require(5951).GuildIconSizes.LARGE;
  ...
  const items7 = [callback(_require(4440).Text, { style: tmp.guildName, color: "text-overlay-light", variant: "text-md/bold", children: guild.name }), ];
  ...
  const items9 = [callback(_require(1297).Icon, { style: tmp.guildBoostCountIcon, source: first(13050), color: first(712).unsafe_rawColors.GUILD_BOOSTING_PINK, size: _require(1297).Icon.Sizes.SMALL }), ];
  ...
  obj13[4] = intl2.format(_require(1236).t["pob/cL"], { subscriptions: first(4350)(premiumGroupRole.guild.id).total });
  items9[1] = callback(_require(4440).Text, obj13);
  obj11[1] = items9;
  ...
  obj14[1] = callback(_require(4440).Text, obj15);
  items10[1] = callback(first(4184).View, obj14);
  obj10[1] = items10;
  items7[1] = callback2(memo, obj10);
  obj8[1] = items7;
  items6[2] = callback2(_require(5015).PressableOpacity, obj8);
  items6[3] = tmp20;
  const items13 = [, ];
  ...
  obj19[1] = callback(_require(4879).Button, obj22);
