...
// Dependencies: [5, 19, 17, 4178, 676, 5120, 1876, 21, 6774, 4490, 5118, 12752, 1480, 5610, 647, 1892, 11809, 4695, 1236, 4804, 2]
// Exports: default

// Module 6773 (_handleBoostPress)
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              obj3[0] = callback(6774).launchGuildBoostFlowOrAlert(obj1);
              return obj3;
            }
          } else if (arg0 === 1) {
            c5 = 3;
