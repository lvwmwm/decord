...
// Dependencies: [5, 19, 17, 4235, 676, 5194, 1924, 21, 6912, 4550, 5192, 12911, 1499, 5768, 647, 1940, 11959, 4755, 1236, 4864, 2]
// Exports: default

// Module 6911 (_handleBoostPress)
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              obj3[0] = callback(6912).launchGuildBoostFlowOrAlert(obj1);
              return obj3;
            }
          } else if (arg0 === 1) {
            c5 = 3;
