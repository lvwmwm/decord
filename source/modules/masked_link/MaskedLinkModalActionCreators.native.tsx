// Module ID: 12316
// Function ID: 12317
// Dependencies: [19, 21, 12317, 2007, 4707, 2]
...
export default {
  show(onCancel) {
    ...
    require(4707) /* useAlertStore */.openAlert("masked-link", <lazyResult url={url} trustUrl={trustUrl} onConfirm={onConfirm} onCancel={onCancel} isProtocol={isProtocol} />, onCancel);
  }
};
