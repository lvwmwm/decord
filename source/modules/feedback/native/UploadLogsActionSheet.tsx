...
// Dependencies: [19, 17, 676, 21, 4344, 712, 5436, 5435, 1236, 4340, 4754, 9916, 698, 4312, 2]
// Exports: default

// Module 16498 (UploadLogsActionSheet)
import "noop";
...
export default function UploadLogsActionSheet(arg0) {
  ...
  items[1] = callback(require(4754) /* Button */.Button, obj2);
