...
// Dependencies: [19, 17, 676, 21, 4303, 712, 5397, 5396, 1236, 4299, 4714, 9875, 698, 4271, 2]
// Exports: default

// Module 16441 (UploadLogsActionSheet)
import "noop";
...
export default function UploadLogsActionSheet(arg0) {
  ...
  items[1] = callback(require(4714) /* Button */.Button, obj2);
