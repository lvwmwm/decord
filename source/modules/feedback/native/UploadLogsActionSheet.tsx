...
// Dependencies: [19, 17, 676, 21, 4255, 712, 5323, 5322, 1236, 4251, 4665, 9756, 698, 4223, 2]
// Exports: default

// Module 16273 (UploadLogsActionSheet)
import "noop";
...
export default function UploadLogsActionSheet(arg0) {
  ...
  items[1] = callback(require(4665) /* Button */.Button, obj2);
