...
// Dependencies: [32, 19, 17, 11020, 21, 4302, 712, 4270, 12, 8793, 4728, 4507, 11042, 1988, 1236, 4298, 11024, 8388, 5707, 5373, 4712, 1609, 5396, 5395, 5705, 5398, 2]
// Exports: default

// Module 16337 (closeActionSheet)
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  let obj = ref;
  ref = ref.useRef(null);
  const tmp5 = importDefault(8793)(optionsTree);
  c5 = tmp5;
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      obj[3] = ratingBody;
      tmp35 = callback2(tmp20(4298).Text, obj);
    }
    const items2 = [tmp35, , ];
    ...
    obj[1] = first2;
    obj[2] = callback;
    items2[1] = callback2(tmp3(11024), obj);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(8388).TableCheckboxRow, obj1);
    }
    obj2 = { children: null };
    ...
    if (first2 !== first.GOOD) {
      if (null == first4) {
        ...
        obj4[1] = callback2(tmp20(5707).TableRowGroup, obj5);
        ...
        items3[1] = callback2(tmp20(4712).Button, obj6);
        obj3[0] = items3;
    ...
    if (tmp23) {
      ...
      obj8[1] = callback2(tmp20(5707).TableRowGroup, obj9);
      ...
      items4[1] = callback2(tmp20(4712).Button, obj10);
      obj7[0] = items4;
  ...
  if (showHeaderCloseButton) {
    ...
    obj13[0] = closure_11;
    tmp40Result = tmp40(tmp20(5705).ActionSheetCloseButton, obj13);
  }
  obj12[1] = tmp40Result;
  obj11[4] = callback2(optionsTree(5395).BottomSheetTitleHeader, obj12);
  const items5 = [tmp.container, { paddingBottom: tmp.container.padding + bottom }];
  obj11[5] = callback2(optionsTree(5398).BottomSheetScrollView, { contentContainerStyle: items5, children: tmp33Result });
  return callback2(optionsTree(5396).BottomSheet, obj11);
};
