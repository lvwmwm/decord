...
// Dependencies: [32, 19, 17, 11127, 21, 4445, 712, 4412, 12, 8508, 4897, 4676, 11149, 2009, 1236, 4441, 11131, 7616, 5944, 5551, 4880, 1629, 5574, 5573, 5942, 5576, 2]
// Exports: default

// Module 16845 (closeActionSheet)
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      obj[3] = ratingBody;
      tmp35 = callback2(tmp20(4441).Text, obj);
    }
    const items2 = [tmp35, , ];
    ...
    obj[1] = first2;
    obj[2] = callback;
    items2[1] = callback2(tmp3(11131), obj);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(7616).TableCheckboxRow, obj1);
    }
    obj2 = { children: null };
    ...
    if (first2 !== first.GOOD) {
      if (null == first4) {
        ...
        obj4[1] = callback2(tmp20(5944).TableRowGroup, obj5);
        ...
        items3[1] = callback2(tmp20(4880).Button, obj6);
        obj3[0] = items3;
    ...
    if (tmp23) {
      ...
      obj8[1] = callback2(tmp20(5944).TableRowGroup, obj9);
      ...
      items4[1] = callback2(tmp20(4880).Button, obj10);
      obj7[0] = items4;
  ...
  if (showHeaderCloseButton) {
    ...
    obj13[0] = closure_11;
    tmp40Result = tmp40(tmp20(5942).ActionSheetCloseButton, obj13);
  }
  obj12[1] = tmp40Result;
  obj11[4] = callback2(optionsTree(5573).BottomSheetTitleHeader, obj12);
  const items5 = [tmp.container, { paddingBottom: tmp.container.padding + bottom }];
  obj11[5] = callback2(optionsTree(5576).BottomSheetScrollView, { contentContainerStyle: items5, children: tmp33Result });
  return callback2(optionsTree(5574).BottomSheet, obj11);
};
