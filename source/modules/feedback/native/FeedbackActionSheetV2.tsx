...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      obj[3] = ratingBody;
      tmp35 = callback2(tmp20(4299).Text, obj);
    }
    const items2 = [tmp35, , ];
    ...
    if (first2 !== first.GOOD) {
      if (null == first4) {
        ...
        obj4[1] = callback2(tmp20(5767).TableRowGroup, obj5);
        ...
        items3[1] = callback2(tmp20(4714).Button, obj6);
        obj3[0] = items3;
    ...
    if (tmp23) {
      ...
      obj8[1] = callback2(tmp20(5767).TableRowGroup, obj9);
      ...
      items4[1] = callback2(tmp20(4714).Button, obj10);
      obj7[0] = items4;
  ...
  if (showHeaderCloseButton) {
    ...
    obj13[0] = closure_11;
    tmp40Result = tmp40(tmp20(5765).ActionSheetCloseButton, obj13);
  }
  obj12[1] = tmp40Result;
  obj11[4] = callback2(optionsTree(5396).BottomSheetTitleHeader, obj12);
  const items5 = [tmp.container, { paddingBottom: tmp.container.padding + bottom }];
  obj11[5] = callback2(optionsTree(5399).BottomSheetScrollView, { contentContainerStyle: items5, children: tmp33Result });
  return callback2(optionsTree(5397).BottomSheet, obj11);
};
