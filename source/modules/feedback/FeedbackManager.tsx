...
// Dependencies: [5757, 4356, 16308, 11005, 5756, 3957, 595, 12, 16309, 5244, 2]

// Module 16307 (optOutEligibilityCheck)
import set from "set";
...
function optOutEligibilityCheck(hotspot) {
  ...
  const InAppFeedbackStates = _require(3957).InAppFeedbackStates;
  ...
  if (tmp10) {
    const InAppFeedbackStates2 = _require(3957).InAppFeedbackStates;
...
const items1 = [
  function searchResultsEligibilityCheck() {
    return require(16309) /* useIsSearchResultsFeedbackExperimentEnabled */.getIsSearchResultsFeedbackExperimentEnabled({ location: "FeedbackManager" });
  }
];
