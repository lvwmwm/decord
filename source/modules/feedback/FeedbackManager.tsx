...
// Dependencies: [5836, 4375, 16436, 11092, 5835, 3993, 595, 12, 16437, 5261, 2]

// Module 16435 (optOutEligibilityCheck)
import set from "set";
...
function optOutEligibilityCheck(hotspot) {
  ...
  const InAppFeedbackStates = _require(3993).InAppFeedbackStates;
  ...
  if (tmp10) {
    const InAppFeedbackStates2 = _require(3993).InAppFeedbackStates;
...
const items1 = [
  function searchResultsEligibilityCheck() {
    return require(16437) /* useIsSearchResultsFeedbackExperimentEnabled */.getIsSearchResultsFeedbackExperimentEnabled({ location: "FeedbackManager" });
  }
];
