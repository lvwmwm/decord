...
// Dependencies: [5224, 3931, 7229, 5922, 1372, 4640, 3929, 4639, 5895, 676, 1379, 1235, 7230, 1381, 7231, 11, 7232, 2]
...
// Module 7228 (collectForumAnalyticsMetadata)
...
function collectForumAnalyticsMetadata(sessionId) {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      obj[6] = importDefault(7231).getFilterTagIdsAnalytics();
      const obj3 = importDefault(7231);
      obj[7] = importDefault(7231).getSortOrderAnalytics(channel.id);
      if (sessionId == null) {
      ...
      const obj4 = importDefault(7231);
      obj[11] = importDefault(7231).getTagSettingAnalytics(channel.id);
      obj[12] = channel.defaultForumLayout;
      obj[13] = channel.isModeratorReportChannel();
      tmp = obj;
      const tmp8Result1 = importDefault(7231);
    }
  }
  return tmp;
}
...
export const getForumChannelSessionId = function getForumChannelSessionId(arg0) {
  return importDefault(7230).getForumChannelSessionId(arg0);
};
