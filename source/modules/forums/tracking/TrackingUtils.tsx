...
// Dependencies: [5223, 3931, 7169, 5862, 1372, 4638, 3929, 4637, 5835, 676, 1379, 1235, 7170, 1381, 7171, 11, 7172, 2]
...
// Module 7168 (collectForumAnalyticsMetadata)
...
function collectForumAnalyticsMetadata(sessionId) {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      obj[6] = importDefault(7171).getFilterTagIdsAnalytics();
      const obj3 = importDefault(7171);
      obj[7] = importDefault(7171).getSortOrderAnalytics(channel.id);
      if (sessionId == null) {
      ...
      const obj4 = importDefault(7171);
      obj[11] = importDefault(7171).getTagSettingAnalytics(channel.id);
      obj[12] = channel.defaultForumLayout;
      obj[13] = channel.isModeratorReportChannel();
      tmp = obj;
      const tmp8Result1 = importDefault(7171);
    }
  }
  return tmp;
}
...
export const getForumChannelSessionId = function getForumChannelSessionId(arg0) {
  return importDefault(7170).getForumChannelSessionId(arg0);
};
