...
// Dependencies: [1348, 4469, 6001, 6027, 653, 4325, 6028, 675, 6033, 477, 6034, 2]
...
// Module 6026 (trackForumChannelSeenBatch)
...
export const trackForumChannelSeenBatch = function trackForumChannelSeenBatch(channelId) {
  ...
  obj = {};
  const merged = Object.assign(require(6028) /* getForumChannelSessionId */.collectForumAnalyticsMetadata({ channelId, sessionId }));
...
export const trackForumSearched = function trackForumSearched(channelId) {
  ...
  let obj = importDefault(4325);
  obj = {};
  const merged = Object.assign(require(6028) /* getForumChannelSessionId */.collectForumAnalyticsMetadata({ channelId }));
  obj["guild_id"] = guildId;
  obj["channel_id"] = channelId;
...
export const maybeTrackForumNewPostDraftCreated = function maybeTrackForumNewPostDraftCreated(channelId) {
  ...
  if (null != channel) {
    ...
    if (!tmp5) {
      ...
      obj = {};
      obj = { channelId };
      const merged = Object.assign(require(6028) /* getForumChannelSessionId */.collectForumAnalyticsMetadata(obj));
      obj["guild_id"] = channelId.guildId;
      obj["channel_id"] = channelId;
      const obj3 = require(6028) /* getForumChannelSessionId */;
      obj["applied_tag_ids"] = require(6028) /* getForumChannelSessionId */.getForumPostDraftAppliedTagIds(channelId);
      const obj5 = require(6028) /* getForumChannelSessionId */;
      obj["num_attachments"] = require(6028) /* getForumChannelSessionId */.getForumPostDraftNumAttachments(channelId);
      obj.trackWithMetadata(constants.FORUM_CHANNEL_NEW_POST_DRAFT_CREATED, obj);
      const obj6 = require(6028) /* getForumChannelSessionId */;
    }
  }
};
...
export const trackForumMorePostsLoaded = function trackForumMorePostsLoaded(arg0) {
  ...
  const merged1 = Object.assign(require(4325) /* _createForOfIteratorHelperLoose */.collectChannelAnalyticsMetadata(store.getChannel(channelId)));
  const obj4 = require(4325) /* _createForOfIteratorHelperLoose */;
  const merged2 = Object.assign(require(6028) /* getForumChannelSessionId */.collectForumAnalyticsMetadata({ channelId }));
  obj["guild_id"] = guildId;
  obj["channel_id"] = channelId;
  obj["num_archived_threads"] = numArchivedThreads;
  const obj5 = require(6028) /* getForumChannelSessionId */;
  obj["num_active_threads"] = require(6028) /* getForumChannelSessionId */.getNumActiveThreads(guildId, channelId);
...
export const trackForumPostClicked = function trackForumPostClicked(channelId) {
  ...
  let obj = importDefault(4325);
  obj = {};
  const merged = Object.assign(require(6028) /* getForumChannelSessionId */.collectForumPostAnalyticsMetadata({ channelId: postId }));
  obj["guild_id"] = guildId;
  obj["channel_id"] = channelId;
...
export const trackForumSortOrderUpdated = function trackForumSortOrderUpdated(guildId) {
  ...
  obj["channel_id"] = channelId;
  const obj3 = require(6028) /* getForumChannelSessionId */;
  obj["sort_type"] = require(6028) /* getForumChannelSessionId */.convertSortOrderToReadableString(sortOrder);
  obj["sort_order"] = sortOrder;
...
export const trackForumPostLinkCopied = function trackForumPostLinkCopied(arg0) {
  ...
  importDefault(4325).trackWithMetadata(constants.FORUM_POST_LINK_COPIED, { forum_post_id: postId, location: _location });
};
export const trackForumOnboardingClicked = function trackForumOnboardingClicked(onboarding_cta_type) {
  importDefault(4325).trackWithMetadata(constants.FORUM_CHANNEL_ONBOARDING_CLICKED, { onboarding_cta_type: onboarding_cta_type.onboardingCTA });
};
export const trackForumUpsellModalClicked = function trackForumUpsellModalClicked(forum_demo_id) {
  importDefault(4325).trackWithMetadata(constants.FORUM_UPSELL_MODAL_CLICKED, { forum_demo_id: forum_demo_id.forumDemoId });
};
export const trackForumAddMediaToOriginalPostClicked = function trackForumAddMediaToOriginalPostClicked(added) {
  importDefault(4325).trackWithMetadata(constants.FORUM_ADD_MEDIA_TO_ORIGINAL_POST_CLICKED, { added: added.added });
};
export const trackForumChannelMediaUploaderClicked = function trackForumChannelMediaUploaderClicked(is_mobile) {
  importDefault(4325).trackWithMetadata(constants.FORUM_CHANNEL_MEDIA_UPLOADER_CLICKED, { is_mobile: is_mobile.isMobile });
};
export const trackForumEnableAutomodClicked = function trackForumEnableAutomodClicked() {
  importDefault(4325).trackWithMetadata(constants.FORUM_CHANNEL_ENABLE_AUTOMOD_CLICKED);
};
export const trackForumPreviewPostClicked = function trackForumPreviewPostClicked() {
  importDefault(4325).trackWithMetadata(constants.FORUM_CHANNEL_ENABLE_PREVIEW_CLICKED);
};
export const trackForumPostSidebarViewed = function trackForumPostSidebarViewed(channelId) {
  let obj = importDefault(4325);
  obj = {};
  const merged = Object.assign(require(4325) /* _createForOfIteratorHelperLoose */.collectGuildAnalyticsMetadata(channelId.guild_id));
  const obj3 = require(4325) /* _createForOfIteratorHelperLoose */;
  const merged1 = Object.assign(require(4325) /* _createForOfIteratorHelperLoose */.collectChannelAnalyticsMetadata(channelId));
  const obj4 = require(4325) /* _createForOfIteratorHelperLoose */;
  const merged2 = Object.assign(require(6033) /* collectThreadMetadata */.collectThreadMetadata(channelId, true));
  const obj5 = require(6033) /* collectThreadMetadata */;
  const merged3 = Object.assign(require(4325) /* _createForOfIteratorHelperLoose */.getChannelOpenedMetadata(channelId.id));
  obj["channel_view"] = "Split View";
  const obj6 = require(4325) /* _createForOfIteratorHelperLoose */;
  obj["platform"] = require(477) /* set */.getPlatform();
  obj.trackWithMetadata(constants.CHANNEL_OPENED, obj);
  obj = { channelId: channelId.id };
  importDefault(6034)(obj);
};
...
export const trackForumCreateNewPostStarted = function trackForumCreateNewPostStarted(channelId) {
  ...
  let obj = importDefault(4325);
  obj = {};
  const merged = Object.assign(require(6033) /* collectThreadMetadata */.collectThreadMetadata(store.getChannel(channelId)));
  obj["channel_id"] = channelId;
  obj["guild_id"] = channelId.guildId;
