...
// Dependencies: [1372, 4640, 5895, 7227, 676, 4498, 7228, 698, 7233, 500, 7234, 2]
...
// Module 7226 (trackForumChannelSeenBatch)
...
export const trackForumChannelSeenBatch = function trackForumChannelSeenBatch(channelId) {
  ...
  obj = {};
  const merged = Object.assign(require(7228) /* collectForumAnalyticsMetadata */.collectForumAnalyticsMetadata({ channelId, sessionId }));
...
export const trackForumSearched = function trackForumSearched(channelId) {
  ...
  let obj = importDefault(4498);
  obj = {};
  const merged = Object.assign(require(7228) /* collectForumAnalyticsMetadata */.collectForumAnalyticsMetadata({ channelId }));
  obj.guild_id = guildId;
  obj.channel_id = channelId;
...
export const maybeTrackForumNewPostDraftCreated = function maybeTrackForumNewPostDraftCreated(channelId) {
  ...
  if (null != channel) {
    ...
    if (!tmp4) {
      ...
      obj = { channelId: null };
      obj[0] = channelId;
      const merged = Object.assign(require(7228) /* collectForumAnalyticsMetadata */.collectForumAnalyticsMetadata(obj));
      obj.guild_id = channelId.guildId;
      obj.channel_id = channelId;
      const obj3 = require(7228) /* collectForumAnalyticsMetadata */;
      obj.applied_tag_ids = require(7228) /* collectForumAnalyticsMetadata */.getForumPostDraftAppliedTagIds(channelId);
      const obj5 = require(7228) /* collectForumAnalyticsMetadata */;
      obj.num_attachments = require(7228) /* collectForumAnalyticsMetadata */.getForumPostDraftNumAttachments(channelId);
      obj.trackWithMetadata(constants.FORUM_CHANNEL_NEW_POST_DRAFT_CREATED, obj);
      const obj6 = require(7228) /* collectForumAnalyticsMetadata */;
    }
...
export const trackForumMorePostsLoaded = function trackForumMorePostsLoaded(arg0) {
  ...
  const merged1 = Object.assign(require(4498) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(store.getChannel(channelId)));
  const obj4 = require(4498) /* collectGuildAnalyticsMetadata */;
  const merged2 = Object.assign(require(7228) /* collectForumAnalyticsMetadata */.collectForumAnalyticsMetadata({ channelId }));
  obj.guild_id = guildId;
  obj.channel_id = channelId;
  obj.num_archived_threads = numArchivedThreads;
  const obj5 = require(7228) /* collectForumAnalyticsMetadata */;
  obj.num_active_threads = require(7228) /* collectForumAnalyticsMetadata */.getNumActiveThreads(guildId, channelId);
...
export const trackForumPostClicked = function trackForumPostClicked(channelId) {
  ...
  let obj = importDefault(4498);
  obj = {};
  const merged = Object.assign(require(7228) /* collectForumAnalyticsMetadata */.collectForumPostAnalyticsMetadata({ channelId: postId }));
  obj.guild_id = guildId;
  obj.channel_id = channelId;
...
export const trackForumSortOrderUpdated = function trackForumSortOrderUpdated(guildId) {
  ...
  obj.channel_id = channelId;
  const obj3 = require(7228) /* collectForumAnalyticsMetadata */;
  obj.sort_type = require(7228) /* collectForumAnalyticsMetadata */.convertSortOrderToReadableString(sortOrder);
  obj.sort_order = sortOrder;
...
export const trackForumPostLinkCopied = function trackForumPostLinkCopied(arg0) {
  ...
  importDefault(4498).trackWithMetadata(constants.FORUM_POST_LINK_COPIED, { forum_post_id: postId, location: _location });
};
export const trackForumOnboardingClicked = function trackForumOnboardingClicked(onboarding_cta_type) {
  importDefault(4498).trackWithMetadata(constants.FORUM_CHANNEL_ONBOARDING_CLICKED, { onboarding_cta_type: onboarding_cta_type.onboardingCTA });
};
export const trackForumUpsellModalClicked = function trackForumUpsellModalClicked(forum_demo_id) {
  importDefault(4498).trackWithMetadata(constants.FORUM_UPSELL_MODAL_CLICKED, { forum_demo_id: forum_demo_id.forumDemoId });
};
export const trackForumAddMediaToOriginalPostClicked = function trackForumAddMediaToOriginalPostClicked(added) {
  importDefault(4498).trackWithMetadata(constants.FORUM_ADD_MEDIA_TO_ORIGINAL_POST_CLICKED, { added: added.added });
};
export const trackForumChannelMediaUploaderClicked = function trackForumChannelMediaUploaderClicked(is_mobile) {
  importDefault(4498).trackWithMetadata(constants.FORUM_CHANNEL_MEDIA_UPLOADER_CLICKED, { is_mobile: is_mobile.isMobile });
};
export const trackForumEnableAutomodClicked = function trackForumEnableAutomodClicked() {
  importDefault(4498).trackWithMetadata(constants.FORUM_CHANNEL_ENABLE_AUTOMOD_CLICKED);
};
export const trackForumPreviewPostClicked = function trackForumPreviewPostClicked() {
  importDefault(4498).trackWithMetadata(constants.FORUM_CHANNEL_ENABLE_PREVIEW_CLICKED);
};
export const trackForumPostSidebarViewed = function trackForumPostSidebarViewed(channelId) {
  let obj = importDefault(4498);
  obj = {};
  const merged = Object.assign(require(4498) /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(channelId.guild_id));
  const obj3 = require(4498) /* collectGuildAnalyticsMetadata */;
  const merged1 = Object.assign(require(4498) /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(channelId));
  const obj4 = require(4498) /* collectGuildAnalyticsMetadata */;
  const merged2 = Object.assign(require(7233) /* collectThreadMetadata */.collectThreadMetadata(channelId, true));
  const obj5 = require(7233) /* collectThreadMetadata */;
  const merged3 = Object.assign(require(4498) /* collectGuildAnalyticsMetadata */.getChannelOpenedMetadata(channelId.id));
...
export const trackForumCreateNewPostStarted = function trackForumCreateNewPostStarted(channelId) {
  ...
  let obj = importDefault(4498);
  obj = {};
  const merged = Object.assign(require(7233) /* collectThreadMetadata */.collectThreadMetadata(store.getChannel(channelId)));
  obj.channel_id = channelId;
  obj.guild_id = channelId.guildId;
