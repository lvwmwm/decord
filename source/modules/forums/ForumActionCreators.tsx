...
// Dependencies: [5, 676, 4528, 1236, 709, 530, 6074, 9132, 9133, 9134, 6076, 2]
...
export default {
  ...
  markPostAsSeen(arg0, feedItemId, timestampMillis) {
    const obj = require(9132) /* markAnalyticsFeedItemSeen */;
    const result = obj.markAnalyticsFeedItemSeen(require(9133) /* prototype */.getForumPostSeenManagerId(arg0), feedItemId, timestampMillis);
  },
  markPostAsUnseen(arg0, feedItemId, timestampMillis) {
    const obj = require(9132) /* markAnalyticsFeedItemSeen */;
    const result = obj.markAnalyticsFeedItemUnseen(require(9133) /* prototype */.getForumPostSeenManagerId(arg0), feedItemId, timestampMillis);
  },
  flushSeenItems(arg0, IMMEDIATE_WITH_COOLDOWN) {
    if (IMMEDIATE_WITH_COOLDOWN === undefined) {
      IMMEDIATE_WITH_COOLDOWN = require(9134) /* maybeMarkSeen */.ForceFlushType.IMMEDIATE_WITH_COOLDOWN;
    }
    const obj = require(9132) /* markAnalyticsFeedItemSeen */;
    const result = obj.flushAnalyticsFeedItems(require(9133) /* prototype */.getForumPostSeenManagerId(arg0), IMMEDIATE_WITH_COOLDOWN);
  },
        ...
        try {
          ...
          if (0 === c3) {
            ...
            if (1 === tmp7) {
              ...
              outer1_0(6076).trackForumSearched(obj4);
              const obj7 = outer1_0(6076);
