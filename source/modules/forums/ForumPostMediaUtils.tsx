...
// Dependencies: [19, 5816, 1372, 4472, 1874, 676, 4442, 3928, 1384, 1467, 1351, 4476, 1906, 4481, 11, 2]
...
function isMediaAttachment(filename) {
  ...
  if (null != filename) {
    ...
    let tmp3 = require(4442) /* urlMatchesFileExtension */.isImageFile(filename.filename) && null != height;
    if (tmp3) {
      tmp3 = height > 0;
    }
    if (tmp3) {
  ...
  if (!flag) {
    ...
    if (tmp4) {
      ...
      if (isVideoFileResult) {
        ...
        const obj2 = require(4442) /* urlMatchesFileExtension */;
      }
      if (isVideoFileResult) {
