...
// Dependencies: [5790, 1874, 11, 4474, 589, 709, 2]

// Module 5789 (handleLoadThreadsSuccess)
...
function storeFirstMessage(channel_id, nextResult) {
  ...
  if (null != nextResult) {
    messageRecord = require(4474) /* createMinimalMessageRecord */.createMessageRecord(nextResult);
...
const forumPostMessagesStore = new ForumPostMessagesStore(require("dispatcher"), {
  ...
  MESSAGE_CREATE: function handleMessageCreate(isPushNotification) {
    ...
    if (!isPushNotification) {
      ...
      if (tmp4) {
        ...
        let messageRecord = null;
        if (null != message) {
          messageRecord = require(4474) /* createMinimalMessageRecord */.createMessageRecord(message);
    ...
    if (message.message.id !== message.message.channel_id) {
      ...
      if (tmp8) {
        if (null != tmp12.firstMessage) {
          ...
          obj.firstMessage = require(4474) /* createMinimalMessageRecord */.updateMessageRecord(tmp12.firstMessage, message.message);
          dependencyMap[result] = obj;
          const obj3 = require(4474) /* createMinimalMessageRecord */;
        }
        tmp8 = tmp;
      }
      return tmp8;
  ...
  LOAD_FORUM_POSTS: function handlePostChannelLoadData(threads) {
    ...
    for (const key10006 in threads) {
      ...
      if (null != first_message) {
        ...
        let obj = require(4474) /* createMinimalMessageRecord */;
  ...
  LOAD_MESSAGES_SUCCESS: function handleLoadMessagesSuccess(arg0) {
    ...
    if (tmp2) {
      obj = { loaded: true, firstMessage: null };
      obj[1] = require(4474) /* createMinimalMessageRecord */.createMessageRecord(tmp);
