...
// Dependencies: [33, 3838, 1212, 6755, 5525, 3865, 9275, 2]
// Exports: default
...
export default function ForumTagContextMenu(children) {
  ...
  const DeveloperMode = tagId(3838).DeveloperMode;
  let obj = {};
  const enabled = DeveloperMode.useSetting();
  const intl = tagId(1212).intl;
  obj.label = intl.string(tagId(1212).t["8VG6IY"]);
  obj.IconComponent = tagId(6755).IdIcon;
  ...
  const items = [obj];
  return jsx(tagId(9275).ContextMenu, { triggerOnLongPress: true, items, enabled, children: children.children });
};
