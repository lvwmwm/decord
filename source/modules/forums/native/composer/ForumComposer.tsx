...
// Function ID: 10059
// Name: Tags
// Dependencies: [5, 32, 19, 17, 4372, 1302, 4742, 1992, 4025, 1981, 7291, 4741, 1922, 676, 1398, 1388, 1338, 1235, 505, 21, 4380, 712, 5834, 589, 1363, 4244, 8508, 4574, 8560, 7287, 6000, 4224, 5475, 4120, 7380, 4391, 7063, 12, 8563, 8167, 10059, 10060, 4745, 1236, 10061, 10063, 500, 10064, 10065, 10068, 1377, 10069, 2009, 10070, 10071, 8118, 1297, 8510, 1627, 1498, 8626, 8930, 10074, 4376, 10075, 10141, 10151, 10152, 7875, 10153, 10155, 6117, 10342, 4917, 10159, 7370, 4347, 10344, 7800, 4815, 4902, 2]
// Exports: default
...
import TagIcon from "TagIcon" /* 7875 */;
...
import closure_12 from "handleChanged" /* 4742 */;
...
import closure_17 from "setCooldown" /* 7291 */;
import { SlowmodeType } from "setCooldown" /* 7291 */;
import closure_19 from "map" /* 4741 */;
...
function ActionBar(channel) {
  ...
  if (isMediaChannelResult) {
    ...
    obj[1] = channel.id;
    isMediaChannelResult = callback(tmp5(10155), obj);
  }
  ...
  if (!stateFromStores1) {
    ...
    if (tmp10) {
      ...
      tmp10 = callback(tmp2(6117).HeaderActionButton, obj2);
    }
    items4[1] = tmp10;
    let tmp18 = lastInput === tmp2(10063).PostComposerInputs.CONTENT;
    if (tmp18) {
      ...
      obj3[2] = tmp2(7800).ReactionIcon;
      obj3[3] = onShowExpressionPicker;
      tmp18 = callback(tmp2(6117).HeaderActionButton, obj3);
    }
    items4[2] = tmp18;
    ...
    obj5[3] = callback(tmp2(4902).ChatIcon, obj6);
    obj5[4] = function onPress() {
      if (canPost) {
        callback({});
      }
    };
    obj4[1] = callback(tmp2(4815).Button, obj5);
    ...
    obj7[1] = items6;
    if (tmp8) {
      let ImageIcon = tmp2(10342).KeyboardIcon;
    } else {
      ImageIcon = tmp2(4917).ImageIcon;
    }
    obj7[2] = ImageIcon;
    ...
    callback(tmp2(6117).HeaderActionButton, obj7);
