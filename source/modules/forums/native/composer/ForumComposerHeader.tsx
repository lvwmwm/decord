...
// Dependencies: [31, 27, 33, 4165, 689, 4355, 4695, 1212, 5153, 4680, 4161, 4668, 2]
// Exports: default

// Module 9558 (ForumComposerHeader)
import "result";
...
export default function ForumComposerHeader(height) {
  ...
  obj.children = callback(require(5153) /* XSmallIcon */.XSmallIcon, {});
  const items = [callback(require(4695) /* PressableBase */.PressableOpacity, obj), , , ];
  obj = { style: tmp.headerBarContent };
  const items1 = [callback(require(4680) /* ForumIcon */.ForumIcon, { size: "sm" }), ];
  ...
  const obj3 = { variant: "text-xs/medium", color: "text-default", children: importDefault(4355)(channel) };
  ...
  if (length > 0) {
    ...
    obj4.children = callback(require(4668) /* BookCheckIcon */.BookCheckIcon, {});
    tmp9 = callback(require(4695) /* PressableBase */.PressableOpacity, obj4);
  }
  items[2] = tmp9;
