...
// Function ID: 11469
// Name: num2
// Dependencies: [19, 17, 21, 4344, 712, 500, 8448, 1236, 4840, 4340, 10247, 2]
// Exports: default
...
export default function ForumPostMessageCount(hasUnreads) {
  ...
  if (tmp5Result) {
    ...
    obj3[3] = items2;
    tmp5Result = tmp5(tmp2(4340).Text, obj3);
  }
  items1[2] = tmp5Result;
  obj[2] = items1;
