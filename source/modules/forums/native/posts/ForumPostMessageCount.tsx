...
// Function ID: 11413
// Name: num2
// Dependencies: [19, 17, 21, 4303, 712, 500, 8409, 1236, 4800, 4299, 10206, 2]
// Exports: default
...
export default function ForumPostMessageCount(hasUnreads) {
  ...
  if (tmp5Result) {
    ...
    obj3[3] = items2;
    tmp5Result = tmp5(tmp2(4299).Text, obj3);
  }
  items1[2] = tmp5Result;
  obj[2] = items1;
