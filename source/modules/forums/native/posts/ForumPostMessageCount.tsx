...
// Function ID: 11343
// Name: num2
// Dependencies: [19, 17, 21, 4302, 712, 500, 8343, 1236, 4798, 4298, 10134, 2]
// Exports: default
...
export default function ForumPostMessageCount(hasUnreads) {
  ...
  if (tmp5Result) {
    ...
    obj3[3] = items2;
    tmp5Result = tmp5(tmp2(4298).Text, obj3);
  }
  items1[2] = tmp5Result;
  obj[2] = items1;
