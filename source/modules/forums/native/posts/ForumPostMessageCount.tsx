...
// Function ID: 11294
// Name: num2
// Dependencies: [19, 17, 21, 4255, 712, 500, 8186, 1236, 4751, 4251, 10087, 2]
// Exports: default
...
export default function ForumPostMessageCount(hasUnreads) {
  ...
  obj[2] = str2;
  const items1 = [closure_4(require(4751) /* ChatIcon */.ChatIcon, obj), , ];
  if (isMaxMessageCount) {
    ...
    obj2[0] = messageCount;
    obj2[2] = str;
    tmp7Result = tmp7(importDefault(10087), obj2);
  }
  items1[1] = tmp7Result;
