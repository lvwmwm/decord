...
// Function ID: 10119
// Name: AnimatedCount
// Dependencies: [32, 19, 17, 21, 4285, 38, 4145, 4629, 4694, 4281, 4698, 10119, 2]

// Module 10118 (AnimatedCount)
...
const memoResult = importAllResult.memo((textColor) => {
  ...
  if (defaultFormatter === undefined) {
    defaultFormatter = require(10119) /* defaultFormatter */.defaultFormatter;
  }
  if (animate) {
