...
// Dependencies: [19, 17, 21, 4342, 712, 9944, 4887, 1236, 4338, 7267, 8662, 10244, 4034, 10246, 688, 1435, 4000, 5400, 10247, 2]
// Exports: AddReactionButton, AdditionalReactionCount, ForumPostReactionButton

// Module 9943 (BurstReactionButton)
import set from "set";
...
export const AdditionalReactionCount = function AdditionalReactionCount(arg0) {
  ...
  obj[2] = items;
  obj[3] = importDefault(9944)({ threadId }).onTapReactionCount;
  const items1 = ["+", count];
...
export const AddReactionButton = function AddReactionButton(reactionType) {
  ...
  obj[3] = importDefault(9944)({ threadId, reactionType: NORMAL }).onTapAddReaction;
  obj[4] = callback2(require(8662) /* handleOutOfSuperReactions */.ADD_REACTION_ICON_COMPONENTS[NORMAL], { size: "xs" });
  return callback2(require(4887) /* PressableBase */.PressableOpacity, obj);
};
