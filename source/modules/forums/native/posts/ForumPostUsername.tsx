...
function ForumPostUsername(arg0) {
  ...
  if ("username" === stateFromStores) {
    ...
    if (null != authorName) {
      ...
      const items3 = [tmp23, ];
      const obj5 = { 0: 0., 0: 0., 0: 0., -9223372036854775808: 1727825.00390625 };
      let tmp32;
      if (tmp17) {
...
let closure_8 = arg1(dependencyMap[5]).createStyles({ authorContainer: { "Null": -1924071423, "Null": 95301, "Null": 1572864, "Null": 1048576 }, roleDotContainer: {}, authorName: {} });
