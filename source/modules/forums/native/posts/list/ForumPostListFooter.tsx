...
// Dependencies: [19, 17, 676, 21, 4344, 712, 11430, 11468, 11469, 10442, 2]
// Exports: default

// Module 11476 (ForumPostListFooter)
import "noop";
...
export default function ForumPostListFooter(parentChannel) {
  ...
  let obj = require(11430) /* useTypingUserIds */;
  ...
  const items = [callback(importDefault(11468), { thread, hasUnreads }), , ];
  if (tmp5Result) {
    obj = { children: null };
    ...
    obj2[2] = hasUnreads;
    items1[1] = tmp7(importDefault(11469), obj2);
    obj[0] = items1;
  ...
  if (tmp7Result) {
    ...
    tmp7Result = tmp7(require(10442) /* MaxForumPostReactions */.MostCommonForumPostReaction, obj3);
  }
  items[2] = tmp7Result;
  obj[1] = items;
