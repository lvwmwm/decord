...
// Dependencies: [19, 17, 676, 21, 4303, 712, 11376, 11412, 11413, 10401, 2]
// Exports: default

// Module 11420 (ForumPostListFooter)
import "noop";
...
export default function ForumPostListFooter(parentChannel) {
  ...
  let obj = require(11376) /* useTypingUserIds */;
  ...
  const items = [callback(importDefault(11412), { thread, hasUnreads }), , ];
  if (tmp5Result) {
    obj = { children: null };
    ...
    obj2[2] = hasUnreads;
    items1[1] = tmp7(importDefault(11413), obj2);
    obj[0] = items1;
  ...
  if (tmp7Result) {
    ...
    tmp7Result = tmp7(require(10401) /* MaxForumPostReactions */.MostCommonForumPostReaction, obj3);
  }
  items[2] = tmp7Result;
  obj[1] = items;
