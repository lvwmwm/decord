...
// Function ID: 11199
// Name: ForumPostList
// Dependencies: [32, 19, 17, 1398, 21, 4661, 7237, 11179, 11189, 11199, 11202, 2]
// Exports: default
...
export default function ForumPostList(arg0) {
  ...
  const tmp = callback3();
  let obj = require(7237) /* useAvailableTags */;
  ...
  if (tmp6Result) {
    ...
    if (hasFlagResult) {
      tmp10 = callback2(importDefault(11179), {});
    }
    const items = [tmp10, ];
    ...
    if (tmp13) {
      ...
      obj1[1] = tmp4[1];
      obj1[2] = hasUnreads;
      tmp13 = callback2(require(11189) /* ForumPostAppliedTagPills */.ForumPostAppliedTagPills, obj1);
    }
    items[1] = tmp13;
    obj[1] = items;
  ...
  const items1 = [tmp6Result, callback2(importDefault(11199), { thread, firstMessage, hasUnreads, isNew, messageContent, media, isEmbed, isLocalDeviceMedia, firstMessageLoaded, senderModifier })];
  obj[1] = items1;
  const items2 = [closure_7(View, obj), callback2(importDefault(11202), { thread, firstMessage, hasUnreads, parentChannel })];
  obj2[0] = items2;
