...
// Function ID: 11470
// Name: GIFIcon
// Dependencies: [32, 19, 17, 21, 4342, 712, 1297, 11470, 11471, 10247, 4338, 1493, 1370, 11472, 5955, 8476, 11476, 2]
// Exports: default

// Module 11469 (GIFIcon)
...
function MediaGridColumn(arg0) {
  ...
  const tmp = createCacheKey();
  c1 = tmp;
  const found = column.filter(require(1370) /* isDiscordFrontendDevelopment */.isNotNullish);
