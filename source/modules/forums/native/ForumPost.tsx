...
// Function ID: 11933
// Name: ForumPostGrid
// Dependencies: [19, 1386, 4130, 11933, 21, 11934, 11938, 11949, 586, 38, 7242, 7816, 11952, 11953, 7828, 11959, 1397, 2]
// Exports: ForumPostListDisabled

// Module 11932 (ForumPostGrid)
import ForumPostGridHeaderDefault from "ForumPostGridHeader" /* 11934 */;
import GIFIconDefault from "GIFIcon" /* 11938 */;
import ForumPostGridFooterDefault from "ForumPostGridFooter" /* 11949 */;
...
export const ForumPostListDisabled = function ForumPostListDisabled(threadId) {
  ...
  const firstForumPostMessage = threadId(7242).useFirstForumPostMessage(stateFromStores);
  ...
  if (loaded) {
    ...
    obj[7] = loaded;
    obj[1] = callback(tmp4(11953), obj);
    tmp5 = callback(tmp(11952).ForumPostDisabledContainer, obj);
  }
  return tmp5;
};
