...
// Function ID: 11178
// Name: ForumPostGrid
// Dependencies: [19, 1372, 3826, 11178, 21, 11179, 11183, 11194, 589, 38, 6064, 9133, 11198, 11199, 8192, 11204, 1382, 2]
// Exports: ForumPostListDisabled

// Module 11177 (ForumPostGrid)
...
function ForumPostGrid(arg0) {
  ...
  const items = [callback(importDefault(11179), { thread, hasUnreads, isNew }), callback(importDefault(11183), { thread, hasUnreads, media }), callback(importDefault(11194), { thread, firstMessage, hasUnreads, parentChannel })];
  obj[0] = items;
...
export const ForumPostListDisabled = function ForumPostListDisabled(threadId) {
  ...
  const firstForumPostMessage = threadId(6064).useFirstForumPostMessage(stateFromStores);
  ...
  if (loaded) {
    ...
    obj[7] = loaded;
    obj[1] = callback(tmp4(11199), obj);
    tmp5 = callback(tmp(11198).ForumPostDisabledContainer, obj);
  }
  return tmp5;
};
