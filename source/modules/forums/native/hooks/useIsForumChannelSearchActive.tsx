...
// Dependencies: [6079, 10127, 589, 2]
// Exports: useIsForumChannelSearchActive

// Module 10148 (useIsForumChannelSearchActive)
...
export const useIsForumChannelSearchActive = function useIsForumChannelSearchActive(channelId) {
  ...
  let canSearchForumPostsByChannelId = _require(10127).useCanSearchForumPostsByChannelId(channelId);
  _require(589);
  [][0] = channelId;
