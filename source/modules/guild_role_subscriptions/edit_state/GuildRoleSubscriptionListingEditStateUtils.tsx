...
// Function ID: 14757
// Name: getRoleEmojis
// Dependencies: [5, 32, 19, 5366, 4084, 14757, 14734, 676, 1925, 589, 5906, 4721, 14758, 14759, 688, 4082, 14760, 14741, 14761, 705, 38, 5422, 6067, 12, 9115, 14762, 514, 2]
...
// Module 14756 (getRoleEmojis)
import useSubscriptionRoleDefault from "useSubscriptionRole" /* 14758 */;
...
import { GuildRoleSubscriptionBenefitTypes as closure_11 } from "MAX_SUBSCRIPTION_TIERS" /* 14734 */;
...
export const useTrialInterval = function useTrialInterval(editStateId) {
  const subscriptionTrial = _require(14741).useSubscriptionTrial(editStateId);
  let active_trial;
  const obj = _require(14741);
...
export const useEditStateIds = function useEditStateIds(groupListingId, guildId, arg2) {
  ...
  dependencyMap = undefined;
  closure_4 = undefined;
  subscriptionListingsForGroup = _require(14741).useSubscriptionListingsForGroup(groupListingId, obj);
