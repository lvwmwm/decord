...
// Dependencies: [5, 57, 31, 5026, 3787, 14223, 14200, 653, 1852, 566, 5485, 4404, 14224, 14225, 665, 3785, 14226, 14207, 14227, 682, 44, 5083, 12596, 22, 9391, 14228, 491, 2]
...
// Module 14222 (_createForOfIteratorHelperLoose)
...
function useListingValue(listingId, arg1) {
  ...
  const tmp2 = importDefault(5485)(() => closure_1);
  const dependencyMap = tmp2;
...
export const useRoleIcon = function useRoleIcon(listingId) {
  const tmp = importDefault(14224)(arg1, listingId);
  const require = tmp;
  const items = [tmp];
...
export const useRole = function useRole(listingId, guildId) {
  let closure_0 = listingId;
  const tmp = importDefault(14224)(guildId, listingId);
  importDefault = tmp;
...
export const useRoleColor = function useRoleColor(editStateId, guildId) {
  const tmp = importDefault(14224)(guildId, editStateId);
  const require = tmp;
  const items = [tmp];
...
export const useTrialInterval = function useTrialInterval(editStateId) {
  const subscriptionTrial = require(14207) /* _createForOfIteratorHelperLoose */.useSubscriptionTrial(editStateId);
  let active_trial;
  const obj = require(14207) /* _createForOfIteratorHelperLoose */;
  ...
  const selectedOption = importDefault(14227)(tmp4).selectedOption;
  let tmp6 = null;
...
export const useEditStateIds = function useEditStateIds(groupListingId, guildId, arg2) {
  ...
  let dependencyMap;
  let c4;
  subscriptionListingsForGroup = _require(14207).useSubscriptionListingsForGroup(groupListingId, tmp);
