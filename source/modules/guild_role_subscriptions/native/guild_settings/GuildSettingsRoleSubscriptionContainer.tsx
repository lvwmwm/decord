...
// Dependencies: [19, 17, 1910, 676, 21, 4342, 589, 16869, 11651, 16842, 1236, 14514, 16883, 2]
// Exports: default

// Module 16893 (ApplicationRejectedNotice)
import "noop";
...
function ApplicationRejectedNotice(guildId) {
  ...
  const tmp = callback3();
  ({ resubmissionError, requestRejectedNoticeText, reapplyNoticeText } = importDefault(16869)(stateFromStores));
...
export default function GuildSettingsRoleSubscriptionContainer(guildId) {
  ...
  obj[2] = callback(require(16883) /* useRoleSubscriptionSettingsDisabled */.RoleSubscriptionSettingsDisabledContextProvider, obj);
