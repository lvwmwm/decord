...
// Dependencies: [19, 17, 1862, 676, 21, 4189, 589, 16550, 11383, 16523, 1236, 14230, 16564, 2]
// Exports: default

// Module 16574 (ApplicationRejectedNotice)
import "noop";
...
function ApplicationRejectedNotice(guildId) {
  ...
  const tmp = callback3();
  ({ resubmissionError, requestRejectedNoticeText, reapplyNoticeText } = importDefault(16550)(stateFromStores));
  if (null != resubmissionError) {
    obj = { children: null };
    let tmp9Result = tmp9(11383);
    ...
    tmp14 = callback(tmp9(16523), obj);
  } else if (tmp13) {
    const obj1 = { notice: null };
    tmp9Result = tmp9(16523);
    ...
    obj2[2] = tmp12;
    obj2[3] = tmp11;
    tmp14 = callback(tmp9(16523), obj2);
    const tmp9Result1 = tmp9(16523);
  } else if (true === hasItem1) {
    const obj3 = { notice: null };
    const intl = tmp2(1236).intl;
    obj3[0] = intl.string(tmp2(1236).t.e2g9sW);
    tmp14 = callback(tmp9(16523), obj3);
    const tmp9Result2 = tmp9(16523);
  } else {
    tmp14 = null;
    if (true === hasItem) {
      ...
      tmp14 = callback(tmp9(16523), obj4);
      const tmp9Result3 = tmp9(16523);
    }
  }
  let tmp24 = null;
  if (null != tmp14) {
...
function GuildSettingsRoleSubscription(arg0) {
  ...
  const tmp = callback3();
  let obj = require(14230) /* useGroupListingsFetchContext */;
...
export default function GuildSettingsRoleSubscriptionContainer(guildId) {
  ...
  obj[2] = callback(require(16564) /* useRoleSubscriptionSettingsDisabled */.RoleSubscriptionSettingsDisabledContextProvider, obj);
