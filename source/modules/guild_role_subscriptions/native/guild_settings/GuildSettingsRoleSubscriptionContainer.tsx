...
// Dependencies: [19, 17, 1891, 676, 21, 4302, 589, 16711, 11527, 16684, 1236, 14377, 16725, 2]
// Exports: default

// Module 16735 (ApplicationRejectedNotice)
import "noop";
...
function ApplicationRejectedNotice(guildId) {
  ...
  const tmp = callback3();
  ({ resubmissionError, requestRejectedNoticeText, reapplyNoticeText } = importDefault(16711)(stateFromStores));
  if (null != resubmissionError) {
    obj = { children: null };
    let tmp9Result = tmp9(11527);
    ...
    tmp14 = callback(tmp9(16684), obj);
  } else if (tmp13) {
    const obj1 = { notice: null };
    tmp9Result = tmp9(16684);
    ...
    obj2[2] = tmp12;
    obj2[3] = tmp11;
    tmp14 = callback(tmp9(16684), obj2);
    const tmp9Result1 = tmp9(16684);
  } else if (true === hasItem1) {
    const obj3 = { notice: null };
    const intl = tmp2(1236).intl;
    obj3[0] = intl.string(tmp2(1236).t.e2g9sW);
    tmp14 = callback(tmp9(16684), obj3);
    const tmp9Result2 = tmp9(16684);
  } else {
    tmp14 = null;
    if (true === hasItem) {
      ...
      tmp14 = callback(tmp9(16684), obj4);
      const tmp9Result3 = tmp9(16684);
    }
  }
  let tmp24 = null;
  if (null != tmp14) {
...
function GuildSettingsRoleSubscription(arg0) {
  ...
  const tmp = callback3();
  let obj = require(14377) /* useGroupListingsFetchContext */;
...
export default function GuildSettingsRoleSubscriptionContainer(guildId) {
  ...
  obj[2] = callback(require(16725) /* useRoleSubscriptionSettingsDisabled */.RoleSubscriptionSettingsDisabledContextProvider, obj);
