...
obj.container = obj;
const obj1 = { "Null": 994134378, "Null": 1107296778, "Null": 69651, "Null": 100930, "Null": 35920209, "Null": 306254098, "Null": false, "Null": false, backgroundColor: importDefault(dependencyMap[7]).colors.BACKGROUND_SURFACE_HIGH, borderRadius: importDefault(dependencyMap[7]).radii.sm, borderColor: importDefault(dependencyMap[7]).colors.BORDER_MUTED };
obj.rowContainer = obj1;
const tmp3 = arg1(dependencyMap[5]);
obj.containerSelected = { backgroundColor: importDefault(dependencyMap[7]).colors.BORDER_SUBTLE };
obj.rowStatusIcon = { "Null": true, "Null": true, -9223372036854775808: false };
