...
// Function ID: 16790
// Name: PriceOptionRow
// Dependencies: [32, 19, 17, 1905, 505, 21, 4302, 712, 4019, 8997, 5267, 16693, 15595, 4298, 1236, 5795, 14395, 1609, 5396, 5398, 1297, 4713, 4270, 2]
// Exports: default

// Module 16789 (PriceOptionRow)
...
function PriceOptionRow(selected) {
  ...
  const tmp7 = importDefault(8997);
  obj[1] = importDefault(selected ? 16693 : 15595);
  const items1 = [closure_9(importDefault(5267), obj), ];
  ...
  items1[1] = closure_9(require(4298) /* Text */.Text, obj1);
  obj[4] = items1;
