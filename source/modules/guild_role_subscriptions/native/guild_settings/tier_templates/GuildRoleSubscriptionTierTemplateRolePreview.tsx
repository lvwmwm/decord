...
// Dependencies: [19, 17, 1874, 21, 4255, 712, 1236, 647, 4444, 5221, 4251, 688, 1297, 5621, 2]
// Exports: GuildRoleSubscriptionRolePreview

// Module 16727 (GuildRoleSubscriptionRolePreview)
import "noop";
...
export const GuildRoleSubscriptionRolePreview = function GuildRoleSubscriptionRolePreview(content) {
  ...
  obj3[2] = obj4;
  obj3[3] = name;
  const items3 = [callback(require(4251) /* Text */.Text, obj3), callback(require(1297) /* Button */.Spacer, { size: 4 }), callback(importDefault(5621), { name: roleName, source: { uri: roleImage }, size: 16 }), callback(require(1297) /* Button */.Spacer, { size: 8 }), callback(require(4251) /* Text */.Text, { variant: "text-xs/medium", color: "text-muted", children: "4:20 PM" })];
  obj2[1] = items3;
