...
// Dependencies: [19, 17, 1903, 21, 4285, 712, 1236, 647, 4474, 5251, 4281, 688, 1297, 5675, 2]
// Exports: GuildRoleSubscriptionRolePreview

// Module 16767 (GuildRoleSubscriptionRolePreview)
import "noop";
...
export const GuildRoleSubscriptionRolePreview = function GuildRoleSubscriptionRolePreview(content) {
  ...
  obj3[2] = obj4;
  obj3[3] = name;
  const items3 = [callback(require(4281) /* Text */.Text, obj3), callback(require(1297) /* Button */.Spacer, { size: 4 }), callback(importDefault(5675), { name: roleName, source: { uri: roleImage }, size: 16 }), callback(require(1297) /* Button */.Spacer, { size: 8 }), callback(require(4281) /* Text */.Text, { variant: "text-xs/medium", color: "text-muted", children: "4:20 PM" })];
  obj2[1] = items3;
