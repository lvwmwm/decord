...
// Dependencies: [19, 17, 21, 4303, 712, 1297, 15243, 4299, 14471, 1609, 5397, 16863, 5399, 1236, 16864, 8754, 16865, 2]
// Exports: default

// Module 16862 (SectionSeparator)
import "noop";
...
function BenefitRow(description) {
  ...
  obj = { children: callback(importDefault(15243), {}) };
...
function BenefitSection(arg0) {
  ...
  const items = [callback(require(14471) /* SectionTitle */.SectionTitle, { children: sectionTitle }), callback(require(1297) /* Button */.Spacer, { size: 14 }), children];
  obj[0] = items;
  return callback2(closure_5, obj);
}
...
export default function GuildRoleSubscriptionTierTemplateFullCard(template) {
  ...
  let items = [callback(_require(16863).GuildRoleSubscriptionTierTemplateBasicInfo, obj), callback(View, { style: tmp.separator }), ];
  ...
  items1[6] = callback(_require(16864).GuildRoleSubscriptionRolePreview, { roleColor: role_color, roleImage: image, roleName: name, guildId });
