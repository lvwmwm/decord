...
// Dependencies: [19, 17, 21, 4445, 712, 1297, 15619, 4441, 14781, 1629, 5574, 17282, 5576, 1236, 17283, 9111, 17284, 2]
// Exports: default

// Module 17281 (SectionSeparator)
...
export default function GuildRoleSubscriptionTierTemplateFullCard(template) {
  ...
  let items = [callback(_require(17282).GuildRoleSubscriptionTierTemplateBasicInfo, obj), callback(View, { style: tmp.separator }), ];
  ...
  const items1 = [callback(_require(4441).Text, obj4), callback(_require(1297).Spacer, { size: 4 }), , , , , , , , , ];
  const obj5 = { variant: "text-sm/normal", color: "text-muted", children: null };
  const intl2 = _require(1236).intl;
  obj5[2] = intl2.string(_require(1236).t.bCb3c8);
  items1[2] = callback(_require(4441).Text, obj5);
  ...
  items1[4] = callback(_require(4441).Text, obj6);
  items1[5] = callback(_require(1297).Spacer, { size: 8 });
  items1[6] = callback(_require(17283).GuildRoleSubscriptionRolePreview, { roleColor: role_color, roleImage: image, roleName: name, guildId });
  ...
  obj7[1] = callback(_require(9111).GappedList, {
    gap: 14,
  ...
  obj9[1] = callback(_require(9111).GappedList, {
    gap: 14,
  ...
  obj2[3] = items1;
  items[2] = callback2(_require(5576).BottomSheetScrollView, obj2);
  obj[1] = items;
