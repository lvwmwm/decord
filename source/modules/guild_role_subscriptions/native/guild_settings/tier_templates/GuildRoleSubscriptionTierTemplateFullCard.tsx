...
// Dependencies: [19, 17, 21, 4302, 712, 1297, 15173, 4298, 14401, 1609, 5396, 16786, 5398, 1236, 16787, 8694, 16788, 2]
// Exports: default

// Module 16785 (SectionSeparator)
import "noop";
...
function BenefitRow(description) {
  ...
  obj = { children: callback(importDefault(15173), {}) };
  ...
  if (null != description) {
    ...
    obj1[3] = description;
    tmp4Result = callback(require(4298) /* Text */.Text, obj1);
  }
  items1[1] = tmp4Result;
  obj[1] = items1;
...
function BenefitSection(arg0) {
  ...
  const items = [callback(require(14401) /* SectionTitle */.SectionTitle, { children: sectionTitle }), callback(require(1297) /* Button */.Spacer, { size: 14 }), children];
  obj[0] = items;
  return callback2(closure_5, obj);
}
...
export default function GuildRoleSubscriptionTierTemplateFullCard(template) {
  ...
  let items = [callback(_require(16786).GuildRoleSubscriptionTierTemplateBasicInfo, obj), callback(View, { style: tmp.separator }), ];
  ...
  const items1 = [callback(_require(4298).Text, obj4), callback(_require(1297).Spacer, { size: 4 }), , , , , , , , , ];
  const obj5 = { variant: "text-sm/normal", color: "text-muted", children: null };
  const intl2 = _require(1236).intl;
  obj5[2] = intl2.string(_require(1236).t.bCb3c8);
  items1[2] = callback(_require(4298).Text, obj5);
  ...
  items1[4] = callback(_require(4298).Text, obj6);
  items1[5] = callback(_require(1297).Spacer, { size: 8 });
  items1[6] = callback(_require(16787).GuildRoleSubscriptionRolePreview, { roleColor: role_color, roleImage: image, roleName: name, guildId });
  ...
  obj7[1] = callback(_require(8694).GappedList, obj8);
  ...
  obj9[1] = callback(_require(8694).GappedList, obj10);
  items1[10] = callback(BenefitSection, obj9);
  obj2[3] = items1;
  items[2] = callback2(_require(5398).BottomSheetScrollView, obj2);
  obj[1] = items;
  obj[2] = callback2(View, obj);
  return callback(_require(5396).BottomSheet, obj);
};
