...
// Dependencies: [19, 17, 21, 4285, 712, 1297, 15157, 4281, 14385, 1609, 5377, 16766, 5379, 1236, 16767, 8677, 16768, 2]
// Exports: default

// Module 16765 (SectionSeparator)
import "noop";
...
function BenefitRow(description) {
  ...
  obj = { children: callback(importDefault(15157), {}) };
...
function BenefitSection(arg0) {
  ...
  const items = [callback(require(14385) /* SectionTitle */.SectionTitle, { children: sectionTitle }), callback(require(1297) /* Button */.Spacer, { size: 14 }), children];
  obj[0] = items;
  return callback2(closure_5, obj);
}
...
export default function GuildRoleSubscriptionTierTemplateFullCard(template) {
  ...
  let items = [callback(_require(16766).GuildRoleSubscriptionTierTemplateBasicInfo, obj), callback(View, { style: tmp.separator }), ];
  ...
  items1[6] = callback(_require(16767).GuildRoleSubscriptionRolePreview, { roleColor: role_color, roleImage: image, roleName: name, guildId });
  ...
  obj7[1] = callback(_require(8677).GappedList, obj8);
  ...
  obj9[1] = callback(_require(8677).GappedList, obj10);
  items1[10] = callback(BenefitSection, obj9);
  obj2[3] = items1;
  items[2] = callback2(_require(5379).BottomSheetScrollView, obj2);
  obj[1] = items;
  obj[2] = callback2(View, obj);
  return callback(_require(5377).BottomSheet, obj);
};
