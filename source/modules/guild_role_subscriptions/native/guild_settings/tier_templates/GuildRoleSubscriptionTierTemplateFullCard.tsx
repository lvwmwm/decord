...
// Dependencies: [19, 17, 21, 4478, 712, 1297, 15707, 4474, 14833, 1628, 5622, 17369, 5624, 1236, 17370, 9191, 17371, 2]
// Exports: default

// Module 17368 (SectionSeparator)
...
export default function GuildRoleSubscriptionTierTemplateFullCard(template) {
  ...
  let items = [callback(_require(17369).GuildRoleSubscriptionTierTemplateBasicInfo, obj), callback(View, { style: tmp.separator }), ];
  ...
  const items1 = [callback(_require(4474).Text, obj4), callback(_require(1297).Spacer, { size: 4 }), , , , , , , , , ];
  ...
  items1[6] = callback(_require(17370).GuildRoleSubscriptionRolePreview, { roleColor: role_color, roleImage: image, roleName: name, guildId });
  ...
  obj7[1] = callback(_require(9191).GappedList, {
    gap: 14,
  ...
  obj9[1] = callback(_require(9191).GappedList, {
    gap: 14,
  ...
  obj2[3] = items1;
  items[2] = callback2(_require(5624).BottomSheetScrollView, obj2);
  obj[1] = items;
