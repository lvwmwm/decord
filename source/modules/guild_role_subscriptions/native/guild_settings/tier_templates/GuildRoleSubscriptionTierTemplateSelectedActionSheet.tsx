...
// Dependencies: [19, 17, 1388, 21, 4342, 712, 1628, 5458, 5460, 4338, 1236, 1297, 4778, 2]
// Exports: default

// Module 16952 (GuildRoleSubscriptionTierTemplateSelectedActionSheet)
import "noop";
...
export default function GuildRoleSubscriptionTierTemplateSelectedActionSheet(markAsDismissed) {
  ...
  const items = [callback(markAsDismissed(4338).Text, obj1), callback(markAsDismissed(1297).Spacer, { size: 12 }), , , ];
  ...
  items[2] = callback(markAsDismissed(4338).Text, obj2);
