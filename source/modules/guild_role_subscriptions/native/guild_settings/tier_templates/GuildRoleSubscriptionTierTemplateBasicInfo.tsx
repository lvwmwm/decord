...
// Dependencies: [19, 17, 1905, 505, 21, 4285, 712, 5251, 1297, 4281, 1236, 5776, 14379, 4696, 2]
// Exports: GuildRoleSubscriptionTierTemplateBasicInfo

// Module 16766 (GuildRoleSubscriptionTierTemplateBasicInfo)
import "noop";
...
export const GuildRoleSubscriptionTierTemplateBasicInfo = function GuildRoleSubscriptionTierTemplateBasicInfo(template) {
  ...
  const items = [callback(importDefault(5251), obj), callback(template(1297).Spacer, { size: 16 }), ];
  ...
  let obj6 = template(5776);
  obj3[0] = obj6.formatPrice(price_tier, CurrencyCodes.USD);
  obj3[1] = template(14379).formatPlanInterval({ interval: SubscriptionIntervalTypes.MONTH, interval_count: 1 });
