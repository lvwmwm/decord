...
// Dependencies: [19, 17, 1876, 505, 21, 4255, 712, 5207, 1297, 4251, 1236, 5735, 14334, 4667, 2]
// Exports: GuildRoleSubscriptionTierTemplateBasicInfo

// Module 16714 (GuildRoleSubscriptionTierTemplateBasicInfo)
import "noop";
...
export const GuildRoleSubscriptionTierTemplateBasicInfo = function GuildRoleSubscriptionTierTemplateBasicInfo(template) {
  ...
  const items = [callback(importDefault(5207), obj), callback(template(1297).Spacer, { size: 16 }), ];
  ...
  let obj6 = template(5735);
  obj3[0] = obj6.formatPrice(price_tier, CurrencyCodes.USD);
  obj3[1] = template(14334).formatPlanInterval({ interval: SubscriptionIntervalTypes.MONTH, interval_count: 1 });
  ...
  items2[2] = callback(template(4667).BaseTextButton, obj6);
  obj[1] = items2;
