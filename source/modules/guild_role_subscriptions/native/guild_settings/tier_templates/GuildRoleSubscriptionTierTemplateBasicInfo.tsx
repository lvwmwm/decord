...
// Module 16355 (GuildRoleSubscriptionTierTemplateBasicInfo)
...
obj = { "Null": "row", "Null": "center", borderRadius: importDefault(dependencyMap[6]).radii.sm };
obj.image = obj;
...
export const GuildRoleSubscriptionTierTemplateBasicInfo = function GuildRoleSubscriptionTierTemplateBasicInfo(template) {
  ...
  const obj2 = { hasMaxConnections: -0.00000000003092285168288388, isBoostOnlySubscription: -1020848100503384400000000000000000000000, style: { flexWrap: "wrap" }, children: name };
