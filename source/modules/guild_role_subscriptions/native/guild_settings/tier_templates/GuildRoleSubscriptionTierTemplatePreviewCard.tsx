...
// Function ID: 16725
// Name: ContentHeader
// Dependencies: [19, 17, 676, 21, 4255, 712, 4251, 4223, 16725, 1959, 16729, 1297, 16728, 1236, 5585, 1480, 14338, 16730, 698, 4449, 14344, 16726, 8648, 2]
// Exports: default

// Module 16724 (ContentHeader)
...
function ChannelBenefitShowCase(channel) {
  ...
  let obj = require(16728) /* getPrivateChannelIconComponent */;
