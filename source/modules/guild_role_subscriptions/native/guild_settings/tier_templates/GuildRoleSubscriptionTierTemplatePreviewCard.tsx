...
// Function ID: 16765
// Name: ContentHeader
// Dependencies: [19, 17, 676, 21, 4285, 712, 4281, 4253, 16765, 1988, 16769, 1297, 16768, 1236, 5639, 1480, 14375, 16770, 698, 4479, 14381, 16766, 8677, 2]
// Exports: default

// Module 16764 (ContentHeader)
...
function ChannelBenefitShowCase(channel) {
  ...
  let obj = require(16768) /* getPrivateChannelIconComponent */;
