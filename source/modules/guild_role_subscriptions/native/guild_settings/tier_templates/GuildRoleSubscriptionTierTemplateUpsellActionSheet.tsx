...
// Dependencies: [32, 19, 17, 4334, 676, 1388, 21, 4342, 712, 4890, 647, 5437, 1236, 8919, 4338, 4755, 9070, 4310, 2]
// Exports: default

// Module 15456 (GuildRoleSubscriptionTierTemplateUpsellActionSheet)
...
export default function GuildRoleSubscriptionTierTemplateUpsellActionSheet(arg0) {
  ...
  let obj = require(4890) /* getIsScreenLandscape */;
  ...
  const items3 = [callback2(require(4338) /* Text */.Text, obj4), ];
  ...
  items3[1] = callback2(require(4338) /* Text */.Text, obj5);
  obj3[1] = items3;
  ...
  obj9[1] = callback2(require(4755) /* Button */.Button, obj10);
