...
// Dependencies: [32, 19, 17, 4662, 676, 1388, 21, 4661, 712, 8944, 647, 6950, 1236, 9018, 4734, 4745, 8874, 4342, 2]
// Exports: default
...
export default function GuildRoleSubscriptionTierTemplateUpsellActionSheet(arg0) {
  ...
  const items3 = [callback2(require(4734) /* Text */.Text, obj4), ];
  ...
  items3[1] = callback2(require(4734) /* Text */.Text, obj5);
  obj3[1] = items3;
