...
// Dependencies: [32, 19, 17, 4247, 676, 1369, 21, 4255, 712, 4800, 647, 5323, 1236, 8764, 4251, 4665, 8915, 4223, 2]
// Exports: default

// Module 15233 (GuildRoleSubscriptionTierTemplateUpsellActionSheet)
...
export default function GuildRoleSubscriptionTierTemplateUpsellActionSheet(arg0) {
  ...
  let obj = require(4800) /* getIsScreenLandscape */;
  ...
  obj9[1] = callback2(require(4665) /* Button */.Button, obj10);
