...
// Dependencies: [19, 17, 21, 4189, 712, 4185, 1297, 9366, 1236, 16548, 3886, 16520, 5141, 14257, 4601, 2]
// Exports: default

// Module 16547 (GuildServerSubscriberCount)
...
function GuildServerSubscriberCount(arg0) {
  ...
  items1[2] = callback(require(4185) /* Text */.Text, obj1);
  obj[1] = items1;
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  const tmp4 = guild_id(16548)(guild_id, 3, 60);
  dependencyMap = tmp4;
  ...
  if (tmp4.isLoading) {
    ...
    obj1[1] = obj2;
    const items1 = [callback(tmp2(5141), obj1), ];
    ...
    obj4[4] = guildName;
    const items2 = [callback(_require(4185).Text, obj4), ];
    ...
    obj6[3] = quote;
    items3[1] = callback(_require(4185).Text, obj6);
    ...
    items3[2] = callback(_require(4185).Text, obj7);
    ...
    if (tmp7Result) {
      ...
      const items4 = [tmp9(tmp10(4185).Text, obj10), ];
      ...
      if (tmp9Result) {
        ...
        tmp9Result = tmp9(tmp10(4185).Text, obj12);
      }
      items6[1] = tmp9Result;
      obj11[1] = items6;
    ...
    obj14[2] = tmp5;
    obj13[1] = callback(_require(4601).BaseTextButton, obj14);
