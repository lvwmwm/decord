...
// Dependencies: [19, 17, 21, 4189, 712, 4185, 1297, 9362, 1236, 16542, 3886, 16514, 5141, 14253, 4601, 2]
// Exports: default

// Module 16541 (GuildServerSubscriberCount)
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  const tmp4 = guild_id(16542)(guild_id, 3, 60);
  dependencyMap = tmp4;
