...
// Dependencies: [19, 17, 21, 4344, 712, 4340, 1297, 8733, 1236, 16865, 4058, 16837, 5307, 14541, 4755, 2]
// Exports: default

// Module 16864 (GuildServerSubscriberCount)
...
function GuildServerSubscriberCount(arg0) {
  ...
  items1[2] = callback(require(4340) /* Text */.Text, obj1);
  obj[1] = items1;
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp4.isLoading) {
    ...
    obj4[4] = guildName;
    const items2 = [callback(_require(4340).Text, obj4), ];
    ...
    obj6[3] = quote;
    items3[1] = callback(_require(4340).Text, obj6);
    ...
    items3[2] = callback(_require(4340).Text, obj7);
    ...
    obj14[2] = tmp5;
    obj13[1] = callback(_require(4755).BaseTextButton, obj14);
