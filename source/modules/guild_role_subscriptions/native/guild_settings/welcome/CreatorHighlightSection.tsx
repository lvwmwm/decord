...
// Dependencies: [19, 17, 21, 4342, 712, 4338, 1297, 8737, 1236, 16876, 4058, 16848, 5308, 14550, 4756, 2]
// Exports: default

// Module 16875 (GuildServerSubscriberCount)
...
function GuildServerSubscriberCount(arg0) {
  ...
  items1[2] = callback(require(4338) /* Text */.Text, obj1);
  obj[1] = items1;
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp4.isLoading) {
    ...
    obj4[4] = guildName;
    const items2 = [callback(_require(4338).Text, obj4), ];
    ...
    obj6[3] = quote;
    items3[1] = callback(_require(4338).Text, obj6);
    ...
    items3[2] = callback(_require(4338).Text, obj7);
