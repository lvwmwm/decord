...
// Dependencies: [31, 27, 33, 4165, 689, 4161, 1273, 9342, 1212, 16513, 3862, 16485, 5119, 14235, 4579, 2]
// Exports: default

// Module 16512 (GuildServerSubscriberCount)
...
function GuildServerSubscriberCount(arg0) {
  ...
  obj = { size: require(1273) /* Button */.Icon.Sizes.SMALL, color: importDefault(689).unsafe_rawColors.WHITE, style: tmp.subscriberCountIcon, source: importDefault(9342) };
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  const tmp2 = guild_id(16513)(guild_id, 3, 60);
  const dependencyMap = tmp2;
  const hasAllImperativeDetails = tmp2.hasAllImperativeDetails;
  let items = [hasAllImperativeDetails, tmp2];
  if (tmp2.isLoading) {
    let obj = { style: tmp.cardContainer, children: callback(guild_id(16485), {}) };
    ...
    obj1.source = obj2;
    const items1 = [callback(guild_id(5119), obj1), ];
    ...
    items3[1] = callback(require(4161) /* Text */.Text, obj6);
    ...
    items3[2] = callback(require(4161) /* Text */.Text, obj7);
    ...
    if (tmp27Result) {
      ...
      const items4 = [callback(require(4161) /* Text */.Text, obj10), ];
      const obj11 = {};
      const items5 = [, ];
      ...
      if (tmp34) {
        ...
        tmp34 = callback(require(4161) /* Text */.Text, obj12);
      }
      items6[1] = tmp34;
    ...
    obj14.onPress = tmp3;
    obj14.shrink = true;
    obj13.children = callback(require(4579) /* CollapsingText */.BaseTextButton, obj14);
