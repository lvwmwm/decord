...
// Module 16253 (getGreenTextStyle)
import "result";
...
function RevenueShareBenefit() {
  ...
  obj = { Promise: null, marginTop: "676cd159b1913e0ab2a481c3bd4a0b5c", flags: "role_subscription_earning_illo" };
...
result = { horizontalContainer: { "Bool(false)": "<string:1783693314>", "Bool(false)": "<string:618889>" } };
...
result.benefitAvatar = { DISCOVER_POPULAR: true, canConnect: "/assets/modules/guild_role_subscriptions/native/guild_settings/welcome/images", GuildRoleSubscriptionMemberPreview: 40, RowButtonIconProps: 40.5, TABLE_ROW_LABEL_COLOR: null };
result.benefitAvatars = { onPress: null, onTrackPress: "e3602af71cc76e8c04bf027b54c9843f", position: "role_subscription_benefit_nelly_avatar" };
result.benefitCardTitle = { 0: "/assets/modules/guild_role_subscriptions/native/guild_settings/welcome/images", 0: 138, 0: 92.5 };
...
result.earningMetricsShadowContainer = { shadowColor: require("result").colors.BLACK, shadowOffset: {} };
result.earningMetricsShadowContainerDarkMode = { shadowOpacity: 0.24 };
const obj2 = { shadowColor: require("result").colors.BLACK, shadowOffset: {} };
...
result.earningMetricsAvatar = { "Bool(false)": true, "Bool(false)": "/assets/modules/guild_role_subscriptions/native/guild_settings/welcome/images", "Bool(false)": 159, "Bool(false)": 105.5 };
result.socialIllo = {};
result.lanyardIllo = {};
result.revenueShare = {};
result.revenueShareContainer = { padding: 24 };
result.revenueShareIllo = { "Null": "String", "Null": "isArray" };
