...
function EarningPreview() {
  ...
  const items2 = [closure_5(require(4185) /* Text */.Text, obj1), ];
  ...
  items2[1] = closure_5(require(4185) /* Text */.Text, obj3);
  obj2[0] = items2;
...
function ConsistentEarningBenefit() {
  ...
  const items = [callback(require(4185) /* Text */.Text, obj), callback(EarningPreview, {}), ];
...
function RevenueShareBenefit() {
  ...
  items1[1] = obj1.isThemeDark(importDefault(4125)()) ? tmp4.greenTextDarkMode : tmp4.greenTextLightMode;
  obj[0] = items1;
  obj[3] = `${closure_4}%`;
  const items2 = [closure_5(require(4185) /* Text */.Text, obj), , ];
  ...
  items2[1] = closure_5(require(4185) /* Text */.Text, obj);
...
function BenefitAvatar(avatarSource) {
  const tmp = createCacheKey();
  obj = { style: tmp.benefitAvatarContainer, children: callback(importDefault(5141), obj) };
