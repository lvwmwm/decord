...
// Module 16241 (EligibilityActionSheet)
...
let closure_7 = result.createStyles({ container: { label: null, gap: null }, title: {} });
...
export default function EligibilityActionSheet(onRequireModeratorMFAClick) {
  ...
  obj = { Promise: "done", marginTop: "construct", flags: "apply", style: tmp.title };
