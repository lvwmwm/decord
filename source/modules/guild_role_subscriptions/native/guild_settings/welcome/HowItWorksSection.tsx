...
// Function ID: 16794
// Name: HowItWorksCard
// Dependencies: [19, 17, 21, 4303, 712, 4299, 5268, 1236, 16794, 1297, 16795, 16796, 2]
// Exports: default

// Module 16793 (HowItWorksCard)
import "noop";
...
function HowItWorksCard(iconSource) {
  ...
  obj = { style: tmp.container, children: callback(importDefault(5268), obj1) };
  items[1] = callback(View, obj);
  items[2] = callback(require(4299) /* Text */.Text, { style: tmp.howItWorksCardDescription, variant: "text-sm/normal", color: "mobile-text-heading-primary", children: description });
  obj[3] = items;
