...
// Function ID: 16852
// Name: HowItWorksCard
// Dependencies: [19, 17, 21, 4344, 712, 4340, 5307, 1236, 16852, 1297, 16853, 16854, 2]
// Exports: default

// Module 16851 (HowItWorksCard)
import "noop";
...
function HowItWorksCard(iconSource) {
  ...
  obj = { style: tmp.container, children: callback(importDefault(5307), obj1) };
  items[1] = callback(View, obj);
  items[2] = callback(require(4340) /* Text */.Text, { style: tmp.howItWorksCardDescription, variant: "text-sm/normal", color: "mobile-text-heading-primary", children: description });
  obj[3] = items;
