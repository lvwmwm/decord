...
// Dependencies: [19, 17, 21, 4303, 712, 1609, 38, 16815, 5397, 5399, 4299, 1297, 4714, 4271, 1236, 2]
// Exports: default

// Module 16814 (GuildRoleSubscriptionTierArchiveOrDeleteActionSheet)
import "noop";
...
export default function GuildRoleSubscriptionTierArchiveOrDeleteActionSheet(groupListingId) {
  ...
  const tmp4 = importDefault(16815)(guildId, groupListingId, editStateId);
  ...
  obj[4] = deleting;
  items[4] = callback(require(4714) /* Button */.Button, obj);
  ...
  obj2[3] = callback(require(4299) /* Text */.Text, obj3);
  items[6] = callback(closure_3, obj2);
  obj[1] = items;
  obj[1] = closure_6(require(5399) /* BottomSheetModal */.BottomSheetScrollView, obj);
