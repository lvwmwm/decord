...
// Dependencies: [19, 17, 21, 4302, 712, 1609, 38, 16738, 5396, 5398, 4298, 1297, 4712, 4270, 1236, 2]
// Exports: default

// Module 16737 (GuildRoleSubscriptionTierArchiveOrDeleteActionSheet)
import "noop";
...
export default function GuildRoleSubscriptionTierArchiveOrDeleteActionSheet(groupListingId) {
  ...
  const tmp4 = importDefault(16738)(guildId, groupListingId, editStateId);
  ...
  const items = [callback(require(4298) /* Text */.Text, { variant: "heading-lg/semibold", color: "mobile-text-heading-primary", children: headerText }), callback(require(1297) /* Button */.Spacer, { size: 12 }), callback(require(4298) /* Text */.Text, { variant: "text-sm/normal", color: "text-default", children: descriptionText }), callback(require(1297) /* Button */.Spacer, { size: 24 }), , , ];
  ...
  obj[4] = deleting;
  items[4] = callback(require(4712) /* Button */.Button, obj);
  ...
  obj2[3] = callback(require(4298) /* Text */.Text, obj3);
  items[6] = callback(closure_3, obj2);
  obj[1] = items;
  obj[1] = closure_6(require(5398) /* BottomSheetModal */.BottomSheetScrollView, obj);
