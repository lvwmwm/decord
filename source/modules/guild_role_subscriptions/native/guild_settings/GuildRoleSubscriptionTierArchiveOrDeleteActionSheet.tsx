...
// Dependencies: [19, 17, 21, 4285, 712, 1609, 38, 16718, 5377, 5379, 4281, 1297, 4695, 4253, 1236, 2]
// Exports: default

// Module 16717 (GuildRoleSubscriptionTierArchiveOrDeleteActionSheet)
import "noop";
...
export default function GuildRoleSubscriptionTierArchiveOrDeleteActionSheet(groupListingId) {
  ...
  const tmp4 = importDefault(16718)(guildId, groupListingId, editStateId);
  ...
  obj[1] = items;
  obj[1] = closure_6(require(5379) /* BottomSheetModal */.BottomSheetScrollView, obj);
  obj1[1] = callback(closure_4, obj);
  return callback(require(5377) /* Background */.BottomSheet, obj1);
};
