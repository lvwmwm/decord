...
// Dependencies: [19, 1862, 676, 4281, 21, 1480, 16620, 16621, 16622, 589, 2]
// Exports: default

// Module 16619 (GuildSettingsRoleSubscriptionsEmptyContent)
import "noop";
  ...
  if (tmp3.loading) {
    ...
    if (!features.has(constants.CREATOR_MONETIZABLE)) {
      ...
      if (!features2.has(tmp5.CREATOR_MONETIZABLE_PROVISIONAL)) {
        obj = { guild: null };
        obj[0] = guild;
        tmp7 = jsx(tmp2(16622), { guild: null });
      }
    }
    if (null == tmp4) {
