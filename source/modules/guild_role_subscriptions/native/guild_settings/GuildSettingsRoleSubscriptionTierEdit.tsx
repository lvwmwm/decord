...
// Dependencies: [32, 19, 17, 3983, 16886, 14506, 676, 1388, 21, 4344, 712, 1499, 16898, 16894, 5912, 9105, 4340, 4754, 1297, 16932, 5367, 16926, 16924, 16901, 14513, 16881, 11654, 16933, 1236, 14528, 4061, 5309, 6049, 9001, 1377, 16934, 2007, 10047, 10048, 9187, 2]
// Exports: default

// Module 16931 (ArchiveOrDeleteTierSection)
...
function ArchiveOrDeleteTierSection() {
  ...
  let obj1 = require(16898) /* useEditStateContext */;
  ...
  ({ buttonText, descriptionText, handleArchiveOrDelete, deleting, archiving } = importDefault(16894)(guildId, groupListingId, editStateId, navigation));
  let obj2 = require(5912) /* useShouldHideGuildPurchaseEntryPoints */;
  ...
  const items = [callback2(importDefault(9105), obj), , ];
  ...
  obj2[4] = tmp9;
  obj2[5] = buttonText;
  obj1[1] = callback2(require(4754) /* Button */.Button, obj2);
...
function TabContent(selectedTab) {
  ...
  if (GuildRoleSubscriptionsTierScenes.DETAILS === selectedTab) {
    ...
    const items = [callback2(require(16926) /* Content */.GuildRoleSubscriptionTierDetailsTab, {}), callback2(ArchiveOrDeleteTierSection, {})];
    obj[1] = items;
    obj[1] = callback3(require(5367) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
    return callback2(closure_7, obj);
  } else if (tmp2.DESIGN === selectedTab) {
    obj = { style: null, children: null };
    obj[0] = tmp.tabContent;
    const obj1 = { bottom: true, children: null };
    obj1[1] = callback2(require(16924) /* MemberPreviews */.GuildRoleSubscriptionTierDesignTab, {});
    obj[1] = callback2(require(5367) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj1);
    return callback2(closure_7, obj);
  } else if (tmp2.BENEFITS === selectedTab) {
    return callback2(require(16901) /* AddBenefitButton */.GuildRoleSubscriptionTierBenefitsTab, {});
  } else {
    const _Error = Error;
...
let closure_22 = require("registerAsset").forwardRef((arg0, ref) => {
  ...
  let obj = require(16898) /* useEditStateContext */;
  const editStateContext = obj.useEditStateContext();
  ({ guildId: require, groupListingId } = editStateContext);
  let obj1 = require(14513) /* useFetchListingsForGuild */;
  ...
  const subscriptionListing = require(14513) /* useFetchListingsForGuild */.useSubscriptionListing(editStateContext.editStateId);
  const obj3 = require(14513) /* useFetchListingsForGuild */;
  const roleSubscriptionSettingsDisabled = require(16881) /* useRoleSubscriptionSettingsDisabled */.useRoleSubscriptionSettingsDisabled();
