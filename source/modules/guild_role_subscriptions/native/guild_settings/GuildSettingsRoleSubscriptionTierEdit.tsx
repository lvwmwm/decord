...
// Dependencies: [32, 19, 17, 3983, 16888, 14506, 676, 1388, 21, 4342, 712, 1499, 16900, 16896, 5914, 9109, 4338, 4755, 1297, 16934, 5368, 16928, 16926, 16903, 14513, 16883, 11651, 16935, 1236, 14528, 4061, 5310, 6051, 9005, 1377, 16936, 2007, 10045, 10046, 9191, 2]
// Exports: default

// Module 16933 (ArchiveOrDeleteTierSection)
...
function ArchiveOrDeleteTierSection() {
  ...
  let obj1 = require(16900) /* useEditStateContext */;
  ...
  ({ buttonText, descriptionText, handleArchiveOrDelete, deleting, archiving } = importDefault(16896)(guildId, groupListingId, editStateId, navigation));
...
function TabContent(selectedTab) {
  ...
  if (GuildRoleSubscriptionsTierScenes.DETAILS === selectedTab) {
    ...
    const items = [callback2(require(16928) /* Content */.GuildRoleSubscriptionTierDetailsTab, {}), callback2(ArchiveOrDeleteTierSection, {})];
    obj[1] = items;
    ...
    obj1[1] = callback2(require(16926) /* MemberPreviews */.GuildRoleSubscriptionTierDesignTab, {});
    obj[1] = callback2(require(5368) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj1);
    return callback2(closure_7, obj);
  } else if (tmp2.BENEFITS === selectedTab) {
    return callback2(require(16903) /* AddBenefitButton */.GuildRoleSubscriptionTierBenefitsTab, {});
  } else {
    const _Error = Error;
...
let closure_22 = require("registerAsset").forwardRef((arg0, ref) => {
  ...
  let obj = require(16900) /* useEditStateContext */;
  ...
  const roleSubscriptionSettingsDisabled = require(16883) /* useRoleSubscriptionSettingsDisabled */.useRoleSubscriptionSettingsDisabled();
