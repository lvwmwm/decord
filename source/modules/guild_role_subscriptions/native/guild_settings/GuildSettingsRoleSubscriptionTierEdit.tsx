...
// Dependencies: [32, 19, 17, 3983, 16897, 14515, 676, 1388, 21, 4342, 712, 1499, 16909, 16905, 5914, 9109, 4338, 4755, 1297, 16943, 5368, 16937, 16935, 16912, 14522, 16892, 11650, 16944, 1236, 14537, 4061, 5310, 6051, 9005, 1377, 16945, 2007, 10045, 10046, 9191, 2]
// Exports: default

// Module 16942 (ArchiveOrDeleteTierSection)
...
function ArchiveOrDeleteTierSection() {
  ...
  let obj1 = require(16909) /* useEditStateContext */;
  ...
  ({ buttonText, descriptionText, handleArchiveOrDelete, deleting, archiving } = importDefault(16905)(guildId, groupListingId, editStateId, navigation));
  let obj2 = require(5914) /* useShouldHideGuildPurchaseEntryPoints */;
  ...
  const items = [callback2(importDefault(9109), obj), , ];
...
function TabContent(selectedTab) {
  ...
  if (GuildRoleSubscriptionsTierScenes.DETAILS === selectedTab) {
    ...
    const items = [callback2(require(16937) /* Content */.GuildRoleSubscriptionTierDetailsTab, {}), callback2(ArchiveOrDeleteTierSection, {})];
    obj[1] = items;
    obj[1] = callback3(require(5368) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
    return callback2(closure_7, obj);
  } else if (tmp2.DESIGN === selectedTab) {
    obj = { style: null, children: null };
    obj[0] = tmp.tabContent;
    const obj1 = { bottom: true, children: null };
    obj1[1] = callback2(require(16935) /* MemberPreviews */.GuildRoleSubscriptionTierDesignTab, {});
    obj[1] = callback2(require(5368) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj1);
    return callback2(closure_7, obj);
  } else if (tmp2.BENEFITS === selectedTab) {
    return callback2(require(16912) /* AddBenefitButton */.GuildRoleSubscriptionTierBenefitsTab, {});
  } else {
    const _Error = Error;
...
let closure_22 = require("registerAsset").forwardRef((arg0, ref) => {
  ...
  let obj = require(16909) /* useEditStateContext */;
  const editStateContext = obj.useEditStateContext();
  ({ guildId: require, groupListingId } = editStateContext);
  let obj1 = require(14522) /* useFetchListingsForGuild */;
  ...
  const subscriptionListing = require(14522) /* useFetchListingsForGuild */.useSubscriptionListing(editStateContext.editStateId);
  const obj3 = require(14522) /* useFetchListingsForGuild */;
  const roleSubscriptionSettingsDisabled = require(16892) /* useRoleSubscriptionSettingsDisabled */.useRoleSubscriptionSettingsDisabled();
