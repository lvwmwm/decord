...
// Dependencies: [32, 19, 17, 3923, 16730, 14369, 676, 1369, 21, 4302, 712, 1480, 16742, 16738, 5813, 9000, 4298, 4712, 1297, 16776, 5327, 16770, 16768, 16745, 14376, 16725, 11527, 16777, 1236, 14391, 4001, 5269, 5948, 8896, 1358, 16778, 1988, 9934, 9935, 9081, 2]
// Exports: default

// Module 16775 (ArchiveOrDeleteTierSection)
...
function ArchiveOrDeleteTierSection() {
  ...
  let obj1 = require(16742) /* useEditStateContext */;
  ...
  ({ buttonText, descriptionText, handleArchiveOrDelete, deleting, archiving } = importDefault(16738)(guildId, groupListingId, editStateId, navigation));
  let obj2 = require(5813) /* useShouldHideGuildPurchaseEntryPoints */;
...
function TabContent(selectedTab) {
  ...
  if (GuildRoleSubscriptionsTierScenes.DETAILS === selectedTab) {
    ...
    const items = [callback2(require(16770) /* Content */.GuildRoleSubscriptionTierDetailsTab, {}), callback2(ArchiveOrDeleteTierSection, {})];
    obj[1] = items;
    obj[1] = callback3(require(5327) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
    return callback2(closure_7, obj);
  } else if (tmp2.DESIGN === selectedTab) {
    obj = { style: null, children: null };
    obj[0] = tmp.tabContent;
    const obj1 = { bottom: true, children: null };
    obj1[1] = callback2(require(16768) /* MemberPreviews */.GuildRoleSubscriptionTierDesignTab, {});
    obj[1] = callback2(require(5327) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj1);
    return callback2(closure_7, obj);
  } else if (tmp2.BENEFITS === selectedTab) {
    return callback2(require(16745) /* AddBenefitButton */.GuildRoleSubscriptionTierBenefitsTab, {});
  } else {
    const _Error = Error;
...
let closure_22 = require("registerAsset").forwardRef((arg0, ref) => {
  ...
  let obj = require(16742) /* useEditStateContext */;
  const editStateContext = obj.useEditStateContext();
  ({ guildId: require, groupListingId } = editStateContext);
  let obj1 = require(14376) /* useFetchListingsForGuild */;
  ...
  const subscriptionListing = require(14376) /* useFetchListingsForGuild */.useSubscriptionListing(editStateContext.editStateId);
  const obj3 = require(14376) /* useFetchListingsForGuild */;
  const roleSubscriptionSettingsDisabled = require(16725) /* useRoleSubscriptionSettingsDisabled */.useRoleSubscriptionSettingsDisabled();
