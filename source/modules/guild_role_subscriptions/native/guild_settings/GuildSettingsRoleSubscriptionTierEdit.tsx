...
// Dependencies: [32, 19, 17, 3983, 16904, 14519, 676, 1388, 21, 4342, 712, 1499, 16916, 16912, 5935, 9123, 4338, 4777, 1297, 16950, 5389, 16944, 16942, 16919, 14526, 16899, 11667, 16951, 1236, 14541, 4061, 5331, 6072, 9019, 1377, 16952, 2007, 10056, 10057, 9205, 2]
// Exports: default

// Module 16949 (ArchiveOrDeleteTierSection)
...
function ArchiveOrDeleteTierSection() {
  ...
  let obj1 = require(16916) /* useEditStateContext */;
  ...
  ({ buttonText, descriptionText, handleArchiveOrDelete, deleting, archiving } = importDefault(16912)(guildId, groupListingId, editStateId, navigation));
  let obj2 = require(5935) /* useShouldHideGuildPurchaseEntryPoints */;
  ...
  const items = [callback2(importDefault(9123), obj), , ];
  ...
  obj2[4] = tmp9;
  obj2[5] = buttonText;
  obj1[1] = callback2(require(4777) /* Button */.Button, obj2);
...
function TabContent(selectedTab) {
  ...
  if (GuildRoleSubscriptionsTierScenes.DETAILS === selectedTab) {
    ...
    const items = [callback2(require(16944) /* Content */.GuildRoleSubscriptionTierDetailsTab, {}), callback2(ArchiveOrDeleteTierSection, {})];
    obj[1] = items;
    obj[1] = callback3(require(5389) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
    return callback2(closure_7, obj);
  } else if (tmp2.DESIGN === selectedTab) {
    obj = { style: null, children: null };
    obj[0] = tmp.tabContent;
    const obj1 = { bottom: true, children: null };
    obj1[1] = callback2(require(16942) /* MemberPreviews */.GuildRoleSubscriptionTierDesignTab, {});
    obj[1] = callback2(require(5389) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj1);
    return callback2(closure_7, obj);
  } else if (tmp2.BENEFITS === selectedTab) {
    return callback2(require(16919) /* AddBenefitButton */.GuildRoleSubscriptionTierBenefitsTab, {});
  } else {
    const _Error = Error;
...
let closure_22 = require("registerAsset").forwardRef((arg0, ref) => {
  ...
  let obj1 = require(14526) /* useFetchListingsForGuild */;
  ...
  const subscriptionListing = require(14526) /* useFetchListingsForGuild */.useSubscriptionListing(editStateContext.editStateId);
  const obj3 = require(14526) /* useFetchListingsForGuild */;
  const roleSubscriptionSettingsDisabled = require(16899) /* useRoleSubscriptionSettingsDisabled */.useRoleSubscriptionSettingsDisabled();
