...
// Dependencies: [31, 1838, 33, 566, 16433, 15318, 1212, 2]
// Exports: default

// Module 16471 (GuildSubscriptionEnableMonetization)
import "result";
...
export default function GuildSubscriptionEnableMonetization(guildId) {
  ...
  if (null == obj.useStateFromStores(items, () => outer1_3.getGuild(guildId))) {
    let tmp4 = jsx(importDefault(16433), {});
  } else {
    ...
    tmp4 = jsx(importDefault(15318), { brightTitle: true });
    const tmp8 = importDefault(15318);
  }
  return tmp4;
};
