...
// Dependencies: [19, 1910, 21, 589, 16855, 15740, 1236, 2]
// Exports: default

// Module 16893 (GuildSubscriptionEnableMonetization)
import "noop";
...
export default function GuildSubscriptionEnableMonetization(guildId) {
  ...
  if (null == obj.useStateFromStores(items, () => outer1_3.getGuild(guildId))) {
    let tmp5 = jsx(importDefault(16855), {});
  } else {
    ...
    tmp5 = jsx(importDefault(15740), { brightTitle: true, title: null, description: null });
    const tmp8 = importDefault(15740);
  }
  return tmp5;
};
