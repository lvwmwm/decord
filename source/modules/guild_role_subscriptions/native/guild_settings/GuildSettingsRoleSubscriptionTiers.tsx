...
// Function ID: 16665
// Name: DraftBadge
// Dependencies: [32, 19, 17, 8614, 1862, 3877, 14308, 676, 1876, 21, 4255, 712, 4223, 16665, 1959, 1236, 5735, 14334, 4251, 8649, 647, 14330, 5207, 9284, 1581, 13119, 1480, 14316, 16653, 13114, 14315, 12, 5209, 16667, 16668, 38, 8652, 16702, 16663, 2]
// Exports: default

// Module 16664 (DraftBadge)
...
function Row(disabled) {
  ...
  style[1] = disabled;
  return closure_17(importDefault(8649), { style, accessibilityRole: "button", onPress, onLongPress, disabled, children });
}
function EditListingButton(editStateId) {
  ...
  if (undefined === first) {
    ...
    if (tmp11Result) {
      ...
      obj1[0] = first1;
      obj[2] = obj1;
      tmp11Result = tmp11(importDefault(5207), obj);
    }
    ...
    const items2 = [closure_17(tmp2(4251).Text, obj3), ];
    ...
    obj6[3] = "";
    items3[3] = closure_17(tmp2(4251).Text, obj6);
    obj4[1] = items3;
    items2[1] = closure_18(closure_7, obj4);
    obj2[1] = items2;
    items1[1] = closure_18(closure_7, obj2);
    items1[2] = closure_17(tmp2(9284).PencilIcon, {});
    obj[2] = items1;
  ...
  const layoutEffect = editStateIds.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return callback2(callback(5209).NavigatorHeader, obj);
      }
    });
  });
