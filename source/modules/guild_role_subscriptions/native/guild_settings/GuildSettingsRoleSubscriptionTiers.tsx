...
// Function ID: 16904
// Name: DraftBadge
// Dependencies: [32, 19, 17, 9071, 1910, 3983, 14515, 676, 1924, 21, 4342, 712, 4310, 16904, 2007, 1236, 5896, 14541, 4338, 9106, 647, 14537, 5308, 9721, 1628, 13313, 1499, 14523, 16892, 13308, 14522, 12, 5310, 16906, 16907, 38, 9109, 16941, 16902, 2]
// Exports: default

// Module 16903 (DraftBadge)
...
function Row(disabled) {
  ...
  style[1] = disabled;
  return closure_17(importDefault(9106), { style, accessibilityRole: "button", onPress, onLongPress, disabled, children });
}
function EditListingButton(editStateId) {
  ...
  if (undefined === first) {
    ...
    if (tmp11Result) {
      ...
      obj1[0] = first1;
      obj[2] = obj1;
      tmp11Result = tmp11(importDefault(5308), obj);
    }
    ...
    items1[2] = closure_17(tmp2(9721).PencilIcon, {});
    obj[2] = items1;
  ...
  const layoutEffect = editStateIds.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return callback2(callback(5310).NavigatorHeader, obj);
      }
    });
  });
...
export default function GuildSettingsRoleSubscriptionsTiers(guildId) {
  ...
  return callback2(importDefault(16902), obj);
};
