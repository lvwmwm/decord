...
// Function ID: 16697
// Name: DraftBadge
// Dependencies: [32, 19, 17, 8944, 1862, 3907, 14342, 676, 1876, 21, 4285, 712, 4253, 16697, 1959, 1236, 5764, 14368, 4281, 8979, 647, 14364, 5236, 9591, 1581, 13153, 1480, 14350, 16685, 13148, 14349, 12, 5238, 16699, 16700, 38, 8982, 16734, 16695, 2]
// Exports: default

// Module 16696 (DraftBadge)
...
function EditListingButton(editStateId) {
  ...
  if (undefined === first) {
    ...
    obj8[0] = tmp2(5764).formatPrice(first, constants.USD);
  ...
  const layoutEffect = editStateIds.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return callback2(callback(5238).NavigatorHeader, obj);
      }
    });
  });
