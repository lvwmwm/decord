...
// Function ID: 16599
// Name: DraftBadge
// Dependencies: [32, 19, 17, 8309, 1862, 3815, 14241, 676, 1876, 21, 4193, 712, 4161, 16599, 1959, 1236, 5673, 14267, 4189, 8344, 647, 14263, 5145, 9111, 1581, 13056, 1480, 14249, 16587, 13051, 14248, 12, 5147, 16601, 16602, 38, 8347, 16636, 16597, 2]
// Exports: default
...
function Row(disabled) {
  ...
  style[1] = disabled;
  return closure_17(importDefault(8344), { style, accessibilityRole: "button", onPress, onLongPress, disabled, children });
}
function EditListingButton(editStateId) {
  ...
  if (undefined === first) {
    ...
    if (tmp11Result) {
      ...
      obj1[0] = first1;
      obj[2] = obj1;
      tmp11Result = tmp11(importDefault(5145), obj);
    }
    ...
    const items2 = [closure_17(tmp2(4189).Text, obj3), ];
    ...
    obj6[3] = "";
    items3[3] = closure_17(tmp2(4189).Text, obj6);
    obj4[1] = items3;
    items2[1] = closure_18(closure_7, obj4);
    obj2[1] = items2;
    items1[1] = closure_18(closure_7, obj2);
    items1[2] = closure_17(tmp2(9111).PencilIcon, {});
    obj[2] = items1;
  ...
  const layoutEffect = editStateIds.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return callback2(callback(5147).NavigatorHeader, obj);
      }
    });
  });
