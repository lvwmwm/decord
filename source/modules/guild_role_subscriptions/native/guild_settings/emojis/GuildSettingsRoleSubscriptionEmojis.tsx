...
// Dependencies: [19, 1910, 21, 12, 5181, 16660, 16879, 1236, 16823, 589, 4271, 16880, 2007, 16833, 2]
// Exports: default

// Module 16878 (GuildSettingsRoleSubscriptionEmojisInner)
import "noop";
...
let closure_5 = require("asyncRequireImpl").memoize((arr) => {
  ...
  if (0 === found.length) {
    ...
    const mapped = found.map(_require(16660).computeEmojiItem);
    const reversed = mapped.reverse();
    const tmp4 = importDefault(16879)(arg1);
    const intl = _require(1236).intl;
    const items = [_require(16660).computeSectionItem(intl.string(_require(1236).t.sMOuuS), reversed.length, tmp4)];
...
export default function GuildSettingsRoleSubscriptionEmojis(guildId) {
  ...
  return jsx(importDefault(16833), { guildId, children: null });
};
