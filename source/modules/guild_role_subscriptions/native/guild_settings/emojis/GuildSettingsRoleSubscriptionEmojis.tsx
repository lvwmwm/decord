...
// Dependencies: [31, 1838, 33, 22, 4997, 16309, 16533, 1212, 16477, 566, 4099, 16534, 1935, 16487, 2]
// Exports: default

// Module 16532 (GuildSettingsRoleSubscriptionEmojisInner)
import "result";
...
function GuildSettingsRoleSubscriptionEmojisInner(guildId) {
  ...
  if (null == stateFromStores) {
    ...
    obj = { maxSlots: stateFromStores(16533)(stateFromStores) };
    ...
    return jsx(guildId(16309).ManageEmojisModal, { guild: stateFromStores });
  }
...
let closure_5 = require("apply").memoize((arr) => {
  ...
  if (0 === found.length) {
    ...
    const mapped = found.map(_require(16309).computeEmojiItem);
    const reversed = mapped.reverse();
    const tmp4 = importDefault(16533)(arg1);
    const intl = _require(1212).intl;
    const items = [_require(16309).computeSectionItem(intl.string(_require(1212).t.sMOuuS), reversed.length, tmp4)];
...
export default function GuildSettingsRoleSubscriptionEmojis(guildId) {
  ...
  return jsx(importDefault(16487), { guildId, children: <GuildSettingsRoleSubscriptionEmojisInner guildId={guildId} /> });
};
