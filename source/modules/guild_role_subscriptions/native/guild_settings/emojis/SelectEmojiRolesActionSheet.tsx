...
// Dependencies: [32, 19, 17, 1301, 505, 21, 4342, 712, 5276, 14513, 4887, 1297, 1236, 5436, 5804, 8053, 8012, 4338, 2]
// Exports: default

// Module 16940 (SelectEmojiRolesActionSheet)
...
export default function SelectEmojiRolesActionSheet(arg0) {
  ...
  let tmp7Result = tmp7(require(4887) /* PressableBase */.PressableOpacity, obj);
  ...
  return closure_6(require(5804) /* ActionSheet */.ActionSheet, obj2);
};
