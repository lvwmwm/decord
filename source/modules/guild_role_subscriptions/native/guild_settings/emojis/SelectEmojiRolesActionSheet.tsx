...
// Dependencies: [32, 19, 17, 1301, 505, 21, 4285, 712, 5219, 14360, 4827, 1297, 1236, 5376, 5685, 7931, 7890, 4281, 2]
// Exports: default

// Module 16762 (SelectEmojiRolesActionSheet)
...
export default function SelectEmojiRolesActionSheet(arg0) {
  ...
  let tmp7Result = tmp7(require(4827) /* PressableBase */.PressableOpacity, obj);
  ...
  return closure_6(require(5685) /* ActionSheet */.ActionSheet, obj2);
};
