...
// Dependencies: [19, 1434, 1922, 676, 21, 589, 5767, 1236, 5374, 16625, 16626, 16627, 16628, 5880, 2]
// Exports: default

// Module 16624 (HasCreatedListingsSection)
import "noop";
...
function HasCreatedListingsSection(arg0) {
  ...
  obj1[0] = importDefault(16625);
  obj[2] = callback(require(5374) /* TableRowInner */.TableRow.Icon, obj1);
  obj[3] = function onPress() {
    return callback(outer1_6.ROLE_SUBSCRIPTIONS_BASIC);
  };
  const items1 = [callback(require(5374) /* TableRowInner */.TableRow, obj, "guild-role-subscriptions-basic"), , , ];
  ...
  obj3[0] = importDefault(16626);
  obj2[2] = callback(require(5374) /* TableRowInner */.TableRow.Icon, obj3);
  obj2[3] = function onPress() {
    return callback(outer1_6.ROLE_SUBSCRIPTIONS_TIERS);
  };
  items1[1] = callback(require(5374) /* TableRowInner */.TableRow, obj2, "guild-role-subscriptions-tiers");
  if (stateFromStores) {
  ...
  obj7[0] = importDefault(16628);
  obj6[2] = callback(require(5374) /* TableRowInner */.TableRow.Icon, obj7);
  obj6[3] = function onPress() {
    return callback(outer1_6.ROLE_SUBSCRIPTIONS_EMOJIS);
  };
  items1[3] = callback(require(5374) /* TableRowInner */.TableRow, obj6, "guild-role-subscriptions-emojis");
  obj[2] = items1;
  return closure_8(require(5767) /* TableRowGroupTitle */.TableRowGroup, obj);
}
