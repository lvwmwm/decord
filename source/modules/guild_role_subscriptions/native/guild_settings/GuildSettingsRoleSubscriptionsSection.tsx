...
// Dependencies: [19, 1434, 1922, 676, 21, 589, 6286, 1236, 6291, 16747, 16748, 16749, 16750, 7226, 2]
// Exports: default
...
function HasCreatedListingsSection(arg0) {
  ...
  obj1[0] = importDefault(16747);
  obj[2] = callback(require(6291) /* TableRowInner */.TableRow.Icon, obj1);
  obj[3] = function onPress() {
    return callback(outer1_6.ROLE_SUBSCRIPTIONS_BASIC);
  };
  const items1 = [callback(require(6291) /* TableRowInner */.TableRow, obj, "guild-role-subscriptions-basic"), , , ];
  ...
  obj3[0] = importDefault(16748);
  obj2[2] = callback(require(6291) /* TableRowInner */.TableRow.Icon, obj3);
  obj2[3] = function onPress() {
    return callback(outer1_6.ROLE_SUBSCRIPTIONS_TIERS);
  };
  items1[1] = callback(require(6291) /* TableRowInner */.TableRow, obj2, "guild-role-subscriptions-tiers");
  if (stateFromStores) {
  ...
  obj7[0] = importDefault(16750);
  obj6[2] = callback(require(6291) /* TableRowInner */.TableRow.Icon, obj7);
  obj6[3] = function onPress() {
    return callback(outer1_6.ROLE_SUBSCRIPTIONS_EMOJIS);
  };
  items1[3] = callback(require(6291) /* TableRowInner */.TableRow, obj6, "guild-role-subscriptions-emojis");
  obj[2] = items1;
  return closure_8(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj);
}
