...
let obj = {};
obj = { marginBottom: null, borderRadius: "\u{1F469}\u{1F3FC}\u200D\u{1F9B1}", backgroundColor: true, gap: importDefault(dependencyMap[4]).space.PX_8 };
obj.header = obj;
...
const memoResult = importAllResult.memo(function GuildRoleSubscriptionsChannelHeader() {
  ...
  obj = { INTEGRATION_CREATE: 1, ConstraintReasonCode: null };
