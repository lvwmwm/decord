...
// Dependencies: [31, 653, 1355, 10223, 33, 4131, 689, 1198, 4099, 15100, 1935, 11416, 1212, 10077, 2]
// Exports: default

// Module 15099 (GuildRoleSubscriptionsRow)
...
export default function GuildRoleSubscriptionsRow(selected) {
  ...
  const ChannelModes = id(11416).ChannelModes;
  ...
  obj.mode = tmp4;
  obj.name = jsx(id(11416).BaseChannelName, {});
  obj = { disableColor: true, mode: tmp4, source: importDefault(10077) };
  obj.icon = jsx(id(11416).BaseChannelIcon, { disableColor: true, mode: tmp4, source: importDefault(10077) });
  return jsx(importDefault(11416), { disableColor: true, mode: tmp4, source: importDefault(10077) });
};
