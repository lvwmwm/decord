...
// Dependencies: [31, 653, 1355, 10222, 33, 4131, 689, 1198, 4099, 15088, 1935, 11415, 1212, 10077, 2]
// Exports: default

// Module 15087 (GuildRoleSubscriptionsRow)
...
export default function GuildRoleSubscriptionsRow(selected) {
  ...
  const ChannelModes = id(11415).ChannelModes;
  ...
  obj.mode = tmp4;
  obj.name = jsx(id(11415).BaseChannelName, {});
  obj = { disableColor: true, mode: tmp4, source: importDefault(10077) };
  obj.icon = jsx(id(11415).BaseChannelIcon, { disableColor: true, mode: tmp4, source: importDefault(10077) });
  return jsx(importDefault(11415), { disableColor: true, mode: tmp4, source: importDefault(10077) });
};
