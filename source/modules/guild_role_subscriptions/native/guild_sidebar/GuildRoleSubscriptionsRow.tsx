...
// Dependencies: [31, 653, 1355, 10260, 33, 4130, 689, 1198, 4098, 15031, 1934, 11424, 1212, 10113, 2]
// Exports: default

// Module 15030 (GuildRoleSubscriptionsRow)
...
export default function GuildRoleSubscriptionsRow(selected) {
  ...
  obj = { disableColor: true, mode: tmp4, source: importDefault(10113) };
  obj.icon = jsx(id(11424).BaseChannelIcon, { disableColor: true, mode: tmp4, source: importDefault(10113) });
  return jsx(importDefault(11424), { disableColor: true, mode: tmp4, source: importDefault(10113) });
};
