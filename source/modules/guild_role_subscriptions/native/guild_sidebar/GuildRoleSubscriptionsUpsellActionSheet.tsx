...
// Dependencies: [31, 27, 653, 1345, 33, 4131, 5187, 5085, 15137, 4127, 1212, 4544, 8242, 2]
// Exports: default

// Module 15136 (GuildRoleSubscriptionsUpsellActionSheet)
import "result";
...
export default function GuildRoleSubscriptionsUpsellActionSheet(arg0) {
  ...
  items[3] = callback(require(4544) /* Button */.Button, obj2);
