...
// Dependencies: [19, 17, 676, 1369, 21, 4255, 5309, 5207, 15214, 4251, 1236, 4666, 8613, 2]
// Exports: default

// Module 15213 (GuildRoleSubscriptionsUpsellActionSheet)
import "noop";
...
export default function GuildRoleSubscriptionsUpsellActionSheet(arg0) {
  ...
  items[3] = callback(require(4666) /* Button */.Button, obj2);
  ...
  obj3[1] = callback(require(4666) /* Button */.Button, obj4);
