...
// Dependencies: [16828, 676, 9027, 2]
// Exports: pushTierEditScene, pushTierTemplateSelectionScene

// Module 16837 (pushTierEditScene)
import usePriceTiers from "usePriceTiers";
import { GuildSettingsSections } from "ME";

const result = require("module_9027").fileFinishedImporting("modules/guild_role_subscriptions/native/GuildRoleSettingsActionCreators.tsx");
...
export const pushTierEditScene = function pushTierEditScene(arr, arg1) {
  ...
  importDefault(9027).setSection(GuildSettingsSections.ROLE_SUBSCRIPTIONS_TIER_EDIT);
};
export const pushTierTemplateSelectionScene = function pushTierTemplateSelectionScene(arr, arg1) {
  ...
  importDefault(9027).setSection(GuildSettingsSections.ROLE_SUBSCRIPTIONS_TIER_TEMPLATE_SELECTION);
};
