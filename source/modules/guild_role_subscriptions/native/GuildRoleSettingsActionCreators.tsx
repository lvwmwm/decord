...
// Dependencies: [16563, 676, 8301, 2]
// Exports: pushTierEditScene, pushTierTemplateSelectionScene

// Module 16572 (pushTierEditScene)
import usePriceTiers from "usePriceTiers";
import { GuildSettingsSections } from "ME";

const result = require("module_8301").fileFinishedImporting("modules/guild_role_subscriptions/native/GuildRoleSettingsActionCreators.tsx");
...
export const pushTierEditScene = function pushTierEditScene(arr, arg1) {
  ...
  importDefault(8301).setSection(GuildSettingsSections.ROLE_SUBSCRIPTIONS_TIER_EDIT);
};
export const pushTierTemplateSelectionScene = function pushTierTemplateSelectionScene(arr, arg1) {
  ...
  importDefault(8301).setSection(GuildSettingsSections.ROLE_SUBSCRIPTIONS_TIER_TEMPLATE_SELECTION);
};
