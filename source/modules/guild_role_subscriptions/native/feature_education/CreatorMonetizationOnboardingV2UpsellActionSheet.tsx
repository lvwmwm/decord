...
// Dependencies: [19, 17, 676, 1369, 21, 4285, 5377, 4281, 1236, 5251, 15271, 4695, 8944, 2]
// Exports: default

// Module 15270 (CreatorMonetizationOnboardingV2UpsellActionSheet)
import "noop";
...
export default function CreatorMonetizationOnboardingV2UpsellActionSheet(arg0) {
  ...
  obj2[2] = importDefault(15271);
  items[2] = callback(importDefault(5251), obj2);
  const obj3 = {
    onPress() {
