...
// Dependencies: [19, 17, 676, 1369, 21, 4255, 5309, 4251, 1236, 5207, 15219, 4666, 8613, 2]
// Exports: default

// Module 15218 (CreatorMonetizationOnboardingV2UpsellActionSheet)
import "noop";
...
export default function CreatorMonetizationOnboardingV2UpsellActionSheet(arg0) {
  ...
  obj2[2] = importDefault(15219);
  items[2] = callback(importDefault(5207), obj2);
  const obj3 = {
    onPress() {
