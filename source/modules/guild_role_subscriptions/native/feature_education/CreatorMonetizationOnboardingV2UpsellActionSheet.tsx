...
// Dependencies: [19, 17, 676, 1369, 21, 4255, 5323, 4251, 1236, 5221, 15232, 4665, 8915, 2]
// Exports: default

// Module 15231 (CreatorMonetizationOnboardingV2UpsellActionSheet)
import "noop";
...
export default function CreatorMonetizationOnboardingV2UpsellActionSheet(arg0) {
  ...
  obj2[2] = importDefault(15232);
  items[2] = callback(importDefault(5221), obj2);
  const obj3 = {
    onPress() {
