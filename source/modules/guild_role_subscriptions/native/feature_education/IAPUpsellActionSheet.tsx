...
// Dependencies: [19, 676, 1379, 1369, 21, 15206, 15207, 1236, 1222, 2]
// Exports: default

// Module 15205 (IAPUpsellActionSheet)
import "noop";
...
export default function IAPUpsellActionSheet(arg0) {
  ...
  return jsx(markAsDismissed(15206), { imageSource: null, header: null, body: null, cta: null, onCTAPress: null, markAsDismissed: null });
};
