...
// Function ID: 14541
// Name: WhatYouLose
// Dependencies: [5, 32, 19, 17, 4013, 21, 4342, 712, 14541, 3943, 1236, 5840, 1297, 4338, 14531, 5329, 14549, 5789, 5809, 7717, 4706, 4686, 4061, 4029, 4777, 14537, 14526, 14550, 14551, 589, 2]
// Exports: default

// Module 14540 (WhatYouLose)
...
function WhatYouLose(subscription) {
  ...
  const items = [callback2(importDefault(5840), { guild }), callback2(require(1297) /* Button */.Spacer, { size: 16 }), ];
  obj2 = { children: null };
  ...
  obj1[1] = items;
  const items2 = [callback3(closure_7, obj1), callback2(importDefault(14531), { style: { marginVertical: 16 } }), , , , , ];
  ...
  obj5[0] = importDefault(14549);
  obj5[1] = tmp.cactus;
  items2[6] = callback2(importDefault(5329), obj5);
  obj[1] = items2;
...
function CancelSubscriptionButtonFooter(guild) {
  ...
  analyticsLocations = subscription(5789)(subscription(5809).GUILD_ROLE_SUBSCRIPTION_CANCELLATION_MODAL).analyticsLocations;
  ...
  obj[3] = callback;
  obj[1] = closure_10(guild(4777).Button, obj);
...
function Content(subscription) {
  ...
  const tmp = createCacheKey();
  ({ listing, guild } = importDefault(14537)(subscription));
  let obj = require(14526) /* useFetchListingsForGuild */;
  let id;
  if (guild != null) {
    id = guild.id;
  }
  ...
  if (null != listing) {
    ...
    if (null != guild) {
      ...
      const items = [callback2(importDefault(14550), obj1), ];
      ...
      obj5[0] = listing.id;
      obj5[1] = guild.id;
      items1[4] = callback2(importAll(14551).Content, obj5);
      obj2[1] = items1;
