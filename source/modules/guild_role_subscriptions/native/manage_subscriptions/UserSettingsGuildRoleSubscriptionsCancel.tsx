...
// Function ID: 14537
// Name: WhatYouLose
// Dependencies: [5, 32, 19, 17, 4013, 21, 4342, 712, 14537, 3943, 1236, 5819, 1297, 4338, 14527, 5308, 14545, 5768, 5788, 7696, 4684, 4664, 4061, 4029, 4755, 14533, 14522, 14546, 14547, 589, 2]
// Exports: default

// Module 14536 (WhatYouLose)
...
function WhatYouLose(subscription) {
  ...
  const items = [callback2(importDefault(5819), { guild }), callback2(require(1297) /* Button */.Spacer, { size: 16 }), ];
  obj2 = { children: null };
  const items1 = [callback2(require(4338) /* Text */.Text, { variant: "text-md/semibold", color: "interactive-text-active", children: callback(obj3.useName(listingId), 1)[0] }), callback2(require(1297) /* Button */.Spacer, { size: 2 }), ];
  obj3 = { variant: "text-sm/medium", color: "interactive-text-default", children: guild.name };
  items1[2] = callback2(require(4338) /* Text */.Text, obj3);
  obj2[0] = items1;
  items[2] = callback3(closure_7, obj2);
  obj1[1] = items;
  const items2 = [callback3(closure_7, obj1), callback2(importDefault(14527), { style: { marginVertical: 16 } }), , , , , ];
  ...
  items2[2] = callback2(require(4338) /* Text */.Text, obj4);
  items2[3] = callback2(require(1297) /* Button */.Spacer, { size: 12 });
  const items3 = [formatResult1, "\n"];
  items2[4] = callback3(require(4338) /* Text */.Text, { variant: "text-sm/normal", color: "text-default", children: items3 });
  items2[5] = callback2(require(4338) /* Text */.Text, { variant: "text-sm/medium", color: "text-default", children: intl2.formatToPlainString(require(1236) /* getSystemLocale */.t.OVlNGT, obj) });
  const obj5 = { source: null, style: null };
  const formatToPlainStringResult = intl2.formatToPlainString(require(1236) /* getSystemLocale */.t.OVlNGT, obj);
  obj5[0] = importDefault(14545);
  obj5[1] = tmp.cactus;
  items2[6] = callback2(importDefault(5308), obj5);
  obj[1] = items2;
...
function CancelSubscriptionButtonFooter(guild) {
  ...
  analyticsLocations = subscription(5768)(subscription(5788).GUILD_ROLE_SUBSCRIPTION_CANCELLATION_MODAL).analyticsLocations;
  ...
  obj[3] = callback;
  obj[1] = closure_10(guild(4755).Button, obj);
...
function Content(subscription) {
  ...
  const tmp = createCacheKey();
  ({ listing, guild } = importDefault(14533)(subscription));
  let obj = require(14522) /* useFetchListingsForGuild */;
  let id;
  if (guild != null) {
    id = guild.id;
  }
  ...
  if (null != listing) {
    ...
    if (null != guild) {
      ...
      const items = [callback2(importDefault(14546), obj1), ];
      ...
      items1[2] = callback2(tmp5(4338).Text, obj4);
      items1[3] = callback2(tmp5(1297).Spacer, { size: 16 });
      const obj5 = { listingId: null, guildId: null };
      obj5[0] = listing.id;
      obj5[1] = guild.id;
      items1[4] = callback2(importAll(14547).Content, obj5);
      obj2[1] = items1;
