...
// Dependencies: [19, 17, 21, 4342, 4338, 1236, 1297, 14520, 14521, 14522, 14525, 14526, 2]
// Exports: default

// Module 14519 (GuildRoleSubscriptionsSectionHeader)
import "noop";
...
export default function UserSettingsGuildRoleSubscriptions() {
  const tmp = callback3();
  importDefault(14520)({ forceRestore: true });
  const tmp5 = importDefault(14521)({ ensureFresh: true });
  let obj = require(14522) /* useFetchListingsForGuild */;
  if (obj.useFetchListingsForSubscriptions(tmp5).loading) {
    let tmp6Result = tmp6(importDefault(14525), {});
  } else {
