...
// Module 13986 (ResubscribedAlert)
import "result";
...
result.body = { videoQualityMeasurement: null, GlobalStateProvider: null };
result.centerText = { textAlign: "center" };
result.headerImage = { "Null": null, "Null": null };
...
export default function ResubscribedAlert(onClose) {
  ...
  const obj1 = { hasMaxConnections: "<string:1091687288>", isBoostOnlySubscription: "/assets/design/components/Icon/native/redesign/generated/images", style: tmp.centerText };
