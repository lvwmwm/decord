...
// Dependencies: [19, 17, 21, 4255, 712, 4683, 1236, 14330, 1297, 4251, 2]
// Exports: default

// Module 14329 (ResubscribedAlert)
import "noop";
...
export default function ResubscribedAlert(onClose) {
  ...
  obj = { source: importDefault(14330), style: tmp.headerImage };
  ...
  items[4] = callback(require(4251) /* Text */.Text, obj2);
  obj[1] = items;
  obj[3] = callback2(closure_3, obj);
  return callback(importDefault(4683), obj);
};
