...
// Function ID: 14328
// Name: HeaderStatus
// Dependencies: [5, 32, 19, 17, 676, 1379, 21, 4255, 712, 1236, 4251, 4797, 5646, 1297, 8863, 14328, 4594, 14329, 1959, 7544, 5595, 4574, 14331, 7528, 3955, 7749, 8648, 14332, 3952, 3901, 1222, 8581, 14334, 1480, 2]
// Exports: default

// Module 14327 (HeaderStatus)
import set from "set";
...
function Header(arg0) {
  ...
  const items1 = [callback2(importDefault(5646), { guild }), , ];
  ...
  items3[1] = expanded;
  items1[2] = callback2(require(1297) /* Button */.Icon, { style: items3, size: require(1297) /* Button */.Icon.Sizes.MEDIUM, source: importDefault(8863) });
  obj[1] = items1;
  items[1] = closure_12(View, obj);
  obj[2] = items;
  return closure_12(require(4797) /* PressableBase */.PressableHighlight, obj);
}
function Separator() {
  const tmp = createCacheKey();
  return callback2(importDefault(14328), { style: createCacheKey().separator, withoutMargins: true });
}
function CardBody(isTrial) {
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              if (outer1_0) {
                ...
                outer1_1(4594).show(obj1);
                v02 = 3;
                const obj6 = outer1_1(4594);
              } else {
                let dependencyMap = 1;
                v02(true);
                closure_0 = false;
  ...
  analyticsLocations = subscription(5595)().analyticsLocations;
  ...
  const items3 = [callback2(subscription(14331), { title: nextRenewalLabel, children: nextRenewalDate }), callback2(isTrial(1297).Spacer, { size: 8 }), ];
  ...
  obj6[1] = memberSince;
  items3[2] = callback2(subscription(14331), obj6);
  obj5[1] = items3;
  ...
  const tmp2Result1 = subscription(14331);
  ...
  const items4 = [callback2(subscription(14332), obj10), , ];
  const obj11 = { text: null, onPress: null };
  const tmp2Result2 = subscription(14332);
  ...
  items4[1] = callback2(subscription(14332), obj11);
  if (isCancelled) {
    ...
    obj13[2] = tmp6;
    obj12[1] = tmp13(tmp2(8581), obj13);
    let tmp13Result = tmp13(tmp8, obj12);
    const tmp2Result4 = tmp2(8581);
  } else {
    ...
    tmp13Result = tmp13(tmp2(14332), obj14);
    const tmp2Result5 = tmp2(14332);
  }
  items4[2] = tmp13Result;
  obj9[1] = items4;
  obj8[1] = closure_12(isTrial(8648).GappedList, obj9);
  obj7[3] = callback2(_handleResubscribe, obj8);
  items2[4] = callback2(isTrial(7749).FormSection, obj7);
  obj[1] = items2;
...
export default function ManageSubscriptionCard(subscription) {
  ...
  let importDefault;
  const tmp2 = importDefault(14334)(subscription);
