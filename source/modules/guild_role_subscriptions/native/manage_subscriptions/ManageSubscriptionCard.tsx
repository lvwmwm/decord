...
// Function ID: 109142
// Name: HeaderStatus
// Dependencies: [5, 57, 31, 27, 653, 1355, 33, 4165, 689, 1212, 4161, 4695, 5548, 1273, 8223, 14212, 4506, 14213, 1935, 6551, 5497, 4486, 14215, 6529, 3865, 7611, 9405, 14216, 3862, 3811, 1198, 9341, 14218, 1456, 2]
// Exports: default

// Module 14211 (HeaderStatus)
import set from "set";
...
function HeaderStatus(arg0) {
  ...
  if ("" !== str) {
    ...
    obj.color = str3;
    obj.children = str;
    obj.children = closure_11(require(4161) /* Text */.Text, obj);
...
function Header(arg0) {
  ...
  const items1 = [callback2(importDefault(5548), { guild }), , ];
  ...
  const items2 = [callback2(require(4161) /* Text */.Text, obj1), callback2(require(1273) /* Button */.Spacer, { size: 2 }), ];
  ...
  obj2.children = name;
  items2[2] = callback2(require(4161) /* Text */.Text, obj2);
  obj.children = items2;
  ...
  obj3.source = importDefault(8223);
  items1[2] = callback2(require(1273) /* Button */.Icon, obj3);
  obj.children = items1;
  items[1] = closure_12(View, obj);
  obj.children = items;
  return closure_12(require(4695) /* PressableBase */.PressableHighlight, obj);
}
function Separator() {
  const tmp = _createForOfIteratorHelperLoose();
  return callback2(importDefault(14212), { style: _createForOfIteratorHelperLoose().separator, withoutMargins: true });
}
function CardBody(isTrial) {
  ...
  let first = tmp3[0];
  callback = tmp3[1];
  analyticsLocations = subscription(5497)().analyticsLocations;
  ...
  if (isPastDue) {
    ...
    items[2] = callback2(isTrial(4161).Text, obj4);
    obj1.children = items;
  ...
  let tmp20;
  if (isTrial) {
    tmp20 = subscription(6529);
  }
  obj6.icon = tmp20;
  let prop;
  if (isTrial) {
    prop = isTrial(3865).presentGuildRoleSubscriptionTrialTierMonthCost;
  }
  obj6.onPressIcon = prop;
  obj6.children = subscriptionPrice;
  items2[1] = callback2(subscription(14215), obj6);
  items2[2] = callback2(isTrial(1273).Spacer, { size: 16 });
  const obj7 = { style: tmp.cardRow };
  const items3 = [callback2(subscription(14215), { title: nextRenewalLabel, children: nextRenewalDate }), callback2(isTrial(1273).Spacer, { size: 8 }), ];
  const obj8 = {};
  const tmp18 = callback2;
  const tmp19 = subscription(14215);
  ...
  items3[2] = callback2(subscription(14215), obj8);
  ...
  const obj12 = {};
  const tmp26 = subscription(14215);
  ...
  const items4 = [callback2(subscription(14216), obj12), , ];
  const obj13 = {};
  const tmp31 = subscription(14216);
  ...
  items4[1] = callback2(subscription(14216), obj13);
  if (isCancelled) {
...
export default function ManageSubscriptionCard(subscription) {
  ...
  const tmp2 = importDefault(14218)(subscription);
