...
// Function ID: 14734
// Name: HeaderStatus
// Dependencies: [5, 32, 19, 17, 676, 1398, 21, 4444, 712, 1236, 4440, 5015, 5951, 1297, 9184, 14734, 4809, 14735, 2009, 7863, 5900, 4789, 14737, 7846, 4161, 8185, 8969, 14738, 4158, 4107, 1222, 8902, 14740, 1500, 2]
// Exports: default

// Module 14733 (HeaderStatus)
...
import registerAssetDefault from "registerAsset" /* 9184 */;
import FormSeparatorDefault from "FormSeparator" /* 14734 */;
import useManageSubscriptionCardDataDefault from "useManageSubscriptionCardData" /* 14740 */;
...
function CardBody(isTrial) {
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              if (closure_1_0) {
                ...
                closure_1_1(4809).show(obj1);
                v02 = 3;
                const obj6 = closure_1_1(4809);
              } else {
                dependencyMap = 1;
                v02(true);
                closure_0 = false;
  ...
  analyticsLocations = subscription(5900)().analyticsLocations;
  ...
  if (isPastDue) {
    ...
    items[2] = callback2(isTrial(4440).Text, obj3);
    obj1[1] = items;
  ...
  let tmp2Result = tmp2(14737);
  let intl2 = isTrial(1236).intl;
  obj4[0] = intl2.string(isTrial(1236).t.dltUMH);
  tmp2Result = undefined;
  if (isTrial) {
    tmp2Result = tmp2(7846);
  }
  obj4[1] = tmp2Result;
  let prop;
  if (isTrial) {
    prop = tmp15(4161).presentGuildRoleSubscriptionTrialTierMonthCost;
  }
  obj4[2] = prop;
  ...
  const items3 = [callback2(subscription(14737), { title: nextRenewalLabel, children: nextRenewalDate }), callback2(isTrial(1297).Spacer, { size: 8 }), ];
  ...
  obj6[1] = memberSince;
  items3[2] = callback2(subscription(14737), obj6);
  obj5[1] = items3;
  ...
  const tmp2Result1 = subscription(14737);
  ...
  const items4 = [callback2(subscription(14738), obj10), , ];
  const obj11 = { text: null, onPress: null };
  const tmp2Result2 = subscription(14738);
  ...
  items4[1] = callback2(subscription(14738), obj11);
  if (isCancelled) {
    ...
    obj13[2] = tmp6;
    obj12[1] = tmp13(tmp2(8902), obj13);
    let tmp13Result = tmp13(tmp8, obj12);
    const tmp2Result4 = tmp2(8902);
  } else {
    ...
    tmp13Result = tmp13(tmp2(14738), obj14);
    const tmp2Result5 = tmp2(14738);
  }
  items4[2] = tmp13Result;
  obj9[1] = items4;
  obj8[1] = closure_12(isTrial(8969).GappedList, obj9);
  obj7[3] = callback2(_handleResubscribe, obj8);
  items2[4] = callback2(isTrial(8185).FormSection, obj7);
  obj[1] = items2;
