...
// Function ID: 14381
// Name: HeaderStatus
// Dependencies: [5, 32, 19, 17, 676, 1379, 21, 4302, 712, 1236, 4298, 4844, 5719, 1297, 8909, 14381, 4641, 14382, 1988, 7591, 5668, 4621, 14384, 7575, 4001, 7907, 8694, 14385, 3998, 3947, 1222, 8627, 14387, 1480, 2]
// Exports: default

// Module 14380 (HeaderStatus)
import set from "set";
...
function HeaderStatus(arg0) {
  ...
  if ("" !== str) {
    ...
    obj[1] = str2;
    obj[2] = str;
    obj[1] = closure_11(require(4298) /* Text */.Text, obj);
...
function Header(arg0) {
  ...
  const items1 = [callback2(importDefault(5719), { guild }), , ];
  obj = { style: tmp.headerTitlesContainer, children: null };
  const items2 = [callback2(require(4298) /* Text */.Text, { ellipsizeMode: "tail", lineClamp: 2, variant: "text-md/semibold", color: "interactive-text-active", children: listing.name }), callback2(require(1297) /* Button */.Spacer, { size: 2 }), ];
  let name;
  if (guild != null) {
    name = guild.name;
  }
  ...
  items2[2] = callback2(require(4298) /* Text */.Text, { variant: "text-sm/medium", color: "interactive-text-default", children: name });
  obj[1] = items2;
  ...
  items3[1] = expanded;
  items1[2] = callback2(require(1297) /* Button */.Icon, { style: items3, size: require(1297) /* Button */.Icon.Sizes.MEDIUM, source: importDefault(8909) });
  obj[1] = items1;
  items[1] = closure_12(View, obj);
  obj[2] = items;
  return closure_12(require(4844) /* PressableBase */.PressableHighlight, obj);
}
function Separator() {
  const tmp = createCacheKey();
  return callback2(importDefault(14381), { style: createCacheKey().separator, withoutMargins: true });
}
function CardBody(isTrial) {
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              if (outer1_0) {
                ...
                outer1_1(4641).show(obj1);
                v02 = 3;
                const obj6 = outer1_1(4641);
              } else {
                let dependencyMap = 1;
                v02(true);
                closure_0 = false;
  ...
  analyticsLocations = subscription(5668)().analyticsLocations;
  ...
  if (isPastDue) {
    ...
    items[2] = callback2(isTrial(4298).Text, obj3);
    obj1[1] = items;
  ...
  let tmp2Result = tmp2(14384);
  let intl2 = isTrial(1236).intl;
  obj4[0] = intl2.string(isTrial(1236).t.dltUMH);
  tmp2Result = undefined;
  if (isTrial) {
    tmp2Result = tmp2(7575);
  }
  obj4[1] = tmp2Result;
  let prop;
  if (isTrial) {
    prop = tmp15(4001).presentGuildRoleSubscriptionTrialTierMonthCost;
  }
  obj4[2] = prop;
  ...
  const items3 = [callback2(subscription(14384), { title: nextRenewalLabel, children: nextRenewalDate }), callback2(isTrial(1297).Spacer, { size: 8 }), ];
  ...
  obj6[1] = memberSince;
  items3[2] = callback2(subscription(14384), obj6);
  obj5[1] = items3;
  ...
  const tmp2Result1 = subscription(14384);
  ...
  const items4 = [callback2(subscription(14385), obj10), , ];
  const obj11 = { text: null, onPress: null };
  const tmp2Result2 = subscription(14385);
  ...
  items4[1] = callback2(subscription(14385), obj11);
  if (isCancelled) {
    ...
    obj13[2] = tmp6;
    obj12[1] = tmp13(tmp2(8627), obj13);
    let tmp13Result = tmp13(tmp8, obj12);
    const tmp2Result4 = tmp2(8627);
  } else {
    ...
    tmp13Result = tmp13(tmp2(14385), obj14);
    const tmp2Result5 = tmp2(14385);
  }
  items4[2] = tmp13Result;
  obj9[1] = items4;
  obj8[1] = closure_12(isTrial(8694).GappedList, obj9);
  obj7[3] = callback2(_handleResubscribe, obj8);
  items2[4] = callback2(isTrial(7907).FormSection, obj7);
  obj[1] = items2;
...
export default function ManageSubscriptionCard(subscription) {
  ...
  let importDefault;
  const tmp2 = importDefault(14387)(subscription);
