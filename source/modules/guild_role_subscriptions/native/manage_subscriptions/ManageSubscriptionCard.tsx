...
// Function ID: 14320
// Name: HeaderStatus
// Dependencies: [5, 32, 19, 17, 676, 1379, 21, 4255, 712, 1236, 4251, 4783, 5632, 1297, 8558, 14320, 4595, 14321, 1959, 7560, 5581, 4575, 14323, 7544, 3955, 7765, 9587, 14324, 3952, 3901, 1222, 9535, 14326, 1480, 2]
// Exports: default

// Module 14319 (HeaderStatus)
import set from "set";
...
function HeaderStatus(arg0) {
  ...
  if ("" !== str) {
    ...
    obj[1] = str2;
    obj[2] = str;
    obj[1] = closure_11(require(4251) /* Text */.Text, obj);
...
function Header(arg0) {
  ...
  const items1 = [callback2(importDefault(5632), { guild }), , ];
  obj = { style: tmp.headerTitlesContainer, children: null };
  const items2 = [callback2(require(4251) /* Text */.Text, { ellipsizeMode: "tail", lineClamp: 2, variant: "text-md/semibold", color: "interactive-text-active", children: listing.name }), callback2(require(1297) /* Button */.Spacer, { size: 2 }), ];
  let name;
  if (guild != null) {
    name = guild.name;
  }
  ...
  items2[2] = callback2(require(4251) /* Text */.Text, { variant: "text-sm/medium", color: "interactive-text-default", children: name });
  obj[1] = items2;
  ...
  items3[1] = expanded;
  items1[2] = callback2(require(1297) /* Button */.Icon, { style: items3, size: require(1297) /* Button */.Icon.Sizes.MEDIUM, source: importDefault(8558) });
  obj[1] = items1;
  items[1] = closure_12(View, obj);
  obj[2] = items;
  return closure_12(require(4783) /* PressableBase */.PressableHighlight, obj);
}
function Separator() {
  const tmp = createCacheKey();
  return callback2(importDefault(14320), { style: createCacheKey().separator, withoutMargins: true });
}
function CardBody(isTrial) {
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              if (outer1_0) {
                ...
                outer1_1(4595).show(obj1);
                v02 = 3;
                const obj6 = outer1_1(4595);
              } else {
                let dependencyMap = 1;
                v02(true);
                closure_0 = false;
  ...
  analyticsLocations = subscription(5581)().analyticsLocations;
  ...
  if (isPastDue) {
    ...
    items[2] = callback2(isTrial(4251).Text, obj3);
    obj1[1] = items;
  ...
  let prop;
  if (isTrial) {
    prop = tmp15(3955).presentGuildRoleSubscriptionTrialTierMonthCost;
  }
  obj4[2] = prop;
  ...
  const items3 = [callback2(subscription(14323), { title: nextRenewalLabel, children: nextRenewalDate }), callback2(isTrial(1297).Spacer, { size: 8 }), ];
  ...
  obj6[1] = memberSince;
  items3[2] = callback2(subscription(14323), obj6);
  obj5[1] = items3;
  ...
  const tmp2Result1 = subscription(14323);
  ...
  const items4 = [callback2(subscription(14324), obj10), , ];
  const obj11 = { text: null, onPress: null };
  const tmp2Result2 = subscription(14324);
  ...
  items4[1] = callback2(subscription(14324), obj11);
  if (isCancelled) {
    ...
    obj13[2] = tmp6;
    obj12[1] = tmp13(tmp2(9535), obj13);
    let tmp13Result = tmp13(tmp8, obj12);
    const tmp2Result4 = tmp2(9535);
  } else {
    ...
    tmp13Result = tmp13(tmp2(14324), obj14);
    const tmp2Result5 = tmp2(14324);
  }
  items4[2] = tmp13Result;
  obj9[1] = items4;
  obj8[1] = closure_12(isTrial(9587).GappedList, obj9);
  obj7[3] = callback2(_handleResubscribe, obj8);
  items2[4] = callback2(isTrial(7765).FormSection, obj7);
  obj[1] = items2;
...
export default function ManageSubscriptionCard(subscription) {
  ...
  let importDefault;
  const tmp2 = importDefault(14326)(subscription);
