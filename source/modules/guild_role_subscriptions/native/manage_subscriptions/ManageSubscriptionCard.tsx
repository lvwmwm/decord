...
// Function ID: 14518
// Name: HeaderStatus
// Dependencies: [5, 32, 19, 17, 676, 1398, 21, 4344, 712, 1236, 4340, 4886, 5818, 1297, 9014, 14518, 4683, 14519, 2007, 7692, 5767, 4663, 14521, 7676, 4061, 8008, 8799, 14522, 4058, 4007, 1222, 8732, 14524, 1499, 2]
// Exports: default
...
function HeaderStatus(arg0) {
  ...
  if ("" !== str) {
    ...
    obj[1] = str2;
    obj[2] = str;
    obj[1] = closure_11(require(4340) /* Text */.Text, obj);
...
function Header(arg0) {
  ...
  const items1 = [callback2(importDefault(5818), { guild }), , ];
  obj = { style: tmp.headerTitlesContainer, children: null };
  const items2 = [callback2(require(4340) /* Text */.Text, { ellipsizeMode: "tail", lineClamp: 2, variant: "text-md/semibold", color: "interactive-text-active", children: listing.name }), callback2(require(1297) /* Button */.Spacer, { size: 2 }), ];
  let name;
  if (guild != null) {
    name = guild.name;
  }
  ...
  items2[2] = callback2(require(4340) /* Text */.Text, { variant: "text-sm/medium", color: "interactive-text-default", children: name });
  obj[1] = items2;
  ...
  items3[1] = expanded;
  items1[2] = callback2(require(1297) /* Button */.Icon, { style: items3, size: require(1297) /* Button */.Icon.Sizes.MEDIUM, source: importDefault(9014) });
  obj[1] = items1;
  items[1] = closure_12(View, obj);
  obj[2] = items;
  return closure_12(require(4886) /* PressableBase */.PressableHighlight, obj);
}
function Separator() {
  const tmp = createCacheKey();
...
function CardBody(isTrial) {
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              if (outer1_0) {
                ...
                outer1_1(4683).show(obj1);
                v02 = 3;
                const obj6 = outer1_1(4683);
              } else {
                let dependencyMap = 1;
                v02(true);
                closure_0 = false;
  ...
  analyticsLocations = subscription(5767)().analyticsLocations;
  ...
  if (isPastDue) {
    ...
    items[2] = callback2(isTrial(4340).Text, obj3);
    obj1[1] = items;
  ...
  if (isCancelled) {
    ...
    obj13[2] = tmp6;
    obj12[1] = tmp13(tmp2(8732), obj13);
    let tmp13Result = tmp13(tmp8, obj12);
    const tmp2Result4 = tmp2(8732);
  } else {
  ...
  obj9[1] = items4;
  obj8[1] = closure_12(isTrial(8799).GappedList, obj9);
  obj7[3] = callback2(_handleResubscribe, obj8);
  items2[4] = callback2(isTrial(8008).FormSection, obj7);
  obj[1] = items2;
