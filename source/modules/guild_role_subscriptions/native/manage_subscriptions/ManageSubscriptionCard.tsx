...
// Function ID: 14527
// Name: HeaderStatus
// Dependencies: [5, 32, 19, 17, 676, 1398, 21, 4342, 712, 1236, 4338, 4887, 5819, 1297, 9018, 14527, 4684, 14528, 2007, 7696, 5768, 4664, 14530, 7680, 4061, 8012, 8803, 14531, 4058, 4007, 1222, 8736, 14533, 1499, 2]
// Exports: default

// Module 14526 (HeaderStatus)
import set from "set";
...
function Separator() {
  const tmp = createCacheKey();
  return callback2(importDefault(14527), { style: createCacheKey().separator, withoutMargins: true });
}
function CardBody(isTrial) {
  ...
  const items3 = [callback2(subscription(14530), { title: nextRenewalLabel, children: nextRenewalDate }), callback2(isTrial(1297).Spacer, { size: 8 }), ];
  ...
  obj6[1] = memberSince;
  items3[2] = callback2(subscription(14530), obj6);
  obj5[1] = items3;
  ...
  const tmp2Result1 = subscription(14530);
  ...
  const items4 = [callback2(subscription(14531), obj10), , ];
  const obj11 = { text: null, onPress: null };
  const tmp2Result2 = subscription(14531);
  ...
  items4[1] = callback2(subscription(14531), obj11);
  if (isCancelled) {
    ...
    tmp13Result = tmp13(tmp2(14531), obj14);
    const tmp2Result5 = tmp2(14531);
  }
...
export default function ManageSubscriptionCard(subscription) {
  ...
  let importDefault;
  const tmp2 = importDefault(14533)(subscription);
