...
// Function ID: 14518
// Name: HeaderStatus
// Dependencies: [5, 32, 19, 17, 676, 1398, 21, 4342, 712, 1236, 4338, 4887, 5819, 1297, 9018, 14518, 4684, 14519, 2007, 7696, 5768, 4664, 14521, 7680, 4061, 8012, 8803, 14522, 4058, 4007, 1222, 8736, 14524, 1499, 2]
// Exports: default

// Module 14517 (HeaderStatus)
import set from "set";
...
function HeaderStatus(arg0) {
  ...
  if ("" !== str) {
    ...
    obj[1] = str2;
    obj[2] = str;
    obj[1] = closure_11(require(4338) /* Text */.Text, obj);
...
function Header(arg0) {
  ...
  const items1 = [callback2(importDefault(5819), { guild }), , ];
  obj = { style: tmp.headerTitlesContainer, children: null };
  const items2 = [callback2(require(4338) /* Text */.Text, { ellipsizeMode: "tail", lineClamp: 2, variant: "text-md/semibold", color: "interactive-text-active", children: listing.name }), callback2(require(1297) /* Button */.Spacer, { size: 2 }), ];
  let name;
  if (guild != null) {
    name = guild.name;
  }
  ...
  items2[2] = callback2(require(4338) /* Text */.Text, { variant: "text-sm/medium", color: "interactive-text-default", children: name });
  obj[1] = items2;
  ...
  items3[1] = expanded;
  items1[2] = callback2(require(1297) /* Button */.Icon, { style: items3, size: require(1297) /* Button */.Icon.Sizes.MEDIUM, source: importDefault(9018) });
  obj[1] = items1;
  items[1] = closure_12(View, obj);
  obj[2] = items;
  return closure_12(require(4887) /* PressableBase */.PressableHighlight, obj);
}
function Separator() {
  const tmp = createCacheKey();
  return callback2(importDefault(14518), { style: createCacheKey().separator, withoutMargins: true });
}
function CardBody(isTrial) {
          ...
          if (0 === v0) {
            if (arg0 === 1) {
              ...
              if (outer1_0) {
                ...
                outer1_1(4684).show(obj1);
                v02 = 3;
                const obj6 = outer1_1(4684);
              } else {
                let dependencyMap = 1;
                v02(true);
                closure_0 = false;
  ...
  analyticsLocations = subscription(5768)().analyticsLocations;
  ...
  if (isPastDue) {
    ...
    items[2] = callback2(isTrial(4338).Text, obj3);
    obj1[1] = items;
  ...
  let tmp2Result = tmp2(14521);
  let intl2 = isTrial(1236).intl;
  obj4[0] = intl2.string(isTrial(1236).t.dltUMH);
  tmp2Result = undefined;
  if (isTrial) {
    tmp2Result = tmp2(7680);
  }
  obj4[1] = tmp2Result;
  let prop;
  if (isTrial) {
    prop = tmp15(4061).presentGuildRoleSubscriptionTrialTierMonthCost;
  }
  obj4[2] = prop;
  ...
  const items3 = [callback2(subscription(14521), { title: nextRenewalLabel, children: nextRenewalDate }), callback2(isTrial(1297).Spacer, { size: 8 }), ];
  ...
  obj6[1] = memberSince;
  items3[2] = callback2(subscription(14521), obj6);
  obj5[1] = items3;
  ...
  const tmp2Result1 = subscription(14521);
  ...
  const items4 = [callback2(subscription(14522), obj10), , ];
  const obj11 = { text: null, onPress: null };
  const tmp2Result2 = subscription(14522);
  ...
  items4[1] = callback2(subscription(14522), obj11);
  if (isCancelled) {
    ...
    obj13[2] = tmp6;
    obj12[1] = tmp13(tmp2(8736), obj13);
    let tmp13Result = tmp13(tmp8, obj12);
    const tmp2Result4 = tmp2(8736);
  } else {
    ...
    tmp13Result = tmp13(tmp2(14522), obj14);
    const tmp2Result5 = tmp2(14522);
  }
  items4[2] = tmp13Result;
  obj9[1] = items4;
  obj8[1] = closure_12(isTrial(8803).GappedList, obj9);
  obj7[3] = callback2(_handleResubscribe, obj8);
  items2[4] = callback2(isTrial(8012).FormSection, obj7);
  obj[1] = items2;
