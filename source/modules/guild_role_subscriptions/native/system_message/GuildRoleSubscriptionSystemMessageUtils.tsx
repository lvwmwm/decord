...
// Dependencies: [676, 6811, 7881, 4449, 2]
// Exports: handleRoleSubscriptionPurchaseSystemMessageCtaClicked

// Module 11111 (handleRoleSubscriptionPurchaseSystemMessageCtaClicked)
...
export const handleRoleSubscriptionPurchaseSystemMessageCtaClicked = function handleRoleSubscriptionPurchaseSystemMessageCtaClicked(messageChannel, message, stickerId) {
  ...
  const roleSubscriptionPurchaseSystemMessageEventProperties = require(7881) /* identityHook */.getRoleSubscriptionPurchaseSystemMessageEventProperties(messageChannel, message);
  const obj4 = require(7881) /* identityHook */;
  obj = {};
  const merged = Object.assign(roleSubscriptionPurchaseSystemMessageEventProperties);
  obj.sticker_id = stickerId;
  importDefault(4449).trackWithMetadata(AnalyticEvents.ROLE_SUBSCRIPTION_PURCHASE_SYSTEM_MESSAGE_CTA_CLICKED, obj);
};
