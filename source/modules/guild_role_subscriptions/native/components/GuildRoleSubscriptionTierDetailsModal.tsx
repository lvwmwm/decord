...
function Content() {
  ...
  obj4 = { "Null": true, "Null": true, "Null": true, style: tmp.textInput, maxLength: closure_7, value: tmp4 };
  ...
  obj6 = { "Bool(true)": null, "Bool(true)": "text-sm/medium", "Bool(true)": "text-default", "Bool(true)": true, "Bool(true)": "no-hide-descendants", style: tmp.textInput, maxLength: closure_6, value: tmp12 };
