...
// Function ID: 16751
// Name: Content
// Dependencies: [32, 19, 14353, 676, 21, 13161, 16722, 14375, 14360, 16705, 8983, 1236, 16711, 7890, 1297, 16751, 16714, 2]
// Exports: default

// Module 16750 (Content)
...
function Content() {
  ...
  let tmp7;
  let tmp8;
  const tmp3 = importDefault(13161)();
  ...
  obj1[3] = require(16711) /* pickImage */.PreviewShape.CIRCLE;
  ...
  items[2] = callback2(importDefault(8983), obj2);
  ...
  items[3] = callback2(require(7890) /* Form */.FormInput, obj3);
  obj4 = { style: tmp3.header, children: null };
  const tmpResult1 = importDefault(8983);
  const intl5 = tmp4(1236).intl;
  obj4[1] = intl5.string(require(1236) /* getSystemLocale */.t["74JctW"]);
  items[4] = callback2(importDefault(8983), obj4);
  ...
  items[5] = callback2(require(7890) /* Form */.FormInput, obj5);
  const obj6 = { style: tmp3.header, children: null };
  const tmpResult2 = importDefault(8983);
  const intl7 = tmp4(1236).intl;
  obj6[1] = intl7.string(require(1236) /* getSystemLocale */.t.CrRVAx);
  items[6] = callback2(importDefault(8983), obj6);
  const tmpResult3 = importDefault(8983);
  if (!tmp20) {
  ...
  obj7[2] = tmp12;
  obj7[3] = tmp13;
  items[7] = tmp24(importDefault(16751), obj7);
  obj8[0] = items;
