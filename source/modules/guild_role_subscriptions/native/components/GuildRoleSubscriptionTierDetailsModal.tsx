...
// Function ID: 16699
// Name: Content
// Dependencies: [32, 19, 14308, 676, 21, 13119, 16670, 14330, 14315, 16653, 8652, 1236, 16659, 7765, 1297, 16699, 16662, 2]
// Exports: default

// Module 16698 (Content)
...
function Content() {
  ...
  let tmp7;
  let tmp8;
  const tmp3 = importDefault(13119)();
  ...
  obj1[3] = require(16659) /* pickImage */.PreviewShape.CIRCLE;
  ...
  items[2] = callback2(importDefault(8652), obj2);
  ...
  items[3] = callback2(require(7765) /* Form */.FormInput, obj3);
  obj4 = { style: tmp3.header, children: null };
  const tmpResult1 = importDefault(8652);
  const intl5 = tmp4(1236).intl;
  obj4[1] = intl5.string(require(1236) /* getSystemLocale */.t["74JctW"]);
  items[4] = callback2(importDefault(8652), obj4);
  ...
  items[5] = callback2(require(7765) /* Form */.FormInput, obj5);
  const obj6 = { style: tmp3.header, children: null };
  const tmpResult2 = importDefault(8652);
  const intl7 = tmp4(1236).intl;
  obj6[1] = intl7.string(require(1236) /* getSystemLocale */.t.CrRVAx);
  items[6] = callback2(importDefault(8652), obj6);
  const tmpResult3 = importDefault(8652);
  if (!tmp20) {
  ...
  obj7[2] = tmp12;
  obj7[3] = tmp13;
  items[7] = tmp24(importDefault(16699), obj7);
  obj8[0] = items;
