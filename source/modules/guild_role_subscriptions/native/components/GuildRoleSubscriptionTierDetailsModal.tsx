...
// Function ID: 16927
// Name: Content
// Dependencies: [32, 19, 14506, 676, 21, 13312, 16898, 14528, 14513, 16881, 9105, 1236, 16887, 8008, 1297, 16927, 16890, 2]
// Exports: default

// Module 16926 (Content)
...
function Content() {
  ...
  let tmp7;
  let tmp8;
  const tmp3 = importDefault(13312)();
  ...
  obj1[3] = require(16887) /* pickImage */.PreviewShape.CIRCLE;
  ...
  items[2] = callback2(importDefault(9105), obj2);
  ...
  items[3] = callback2(require(8008) /* Form */.FormInput, obj3);
  obj4 = { style: tmp3.header, children: null };
  const tmpResult1 = importDefault(9105);
  const intl5 = tmp4(1236).intl;
  obj4[1] = intl5.string(require(1236) /* getSystemLocale */.t["74JctW"]);
  items[4] = callback2(importDefault(9105), obj4);
  ...
  items[5] = callback2(require(8008) /* Form */.FormInput, obj5);
  const obj6 = { style: tmp3.header, children: null };
  const tmpResult2 = importDefault(9105);
  const intl7 = tmp4(1236).intl;
  obj6[1] = intl7.string(require(1236) /* getSystemLocale */.t.CrRVAx);
  items[6] = callback2(importDefault(9105), obj6);
  const tmpResult3 = importDefault(9105);
  if (!tmp20) {
  ...
  obj7[2] = tmp12;
  obj7[3] = tmp13;
  items[7] = tmp24(importDefault(16927), obj7);
  obj8[0] = items;
