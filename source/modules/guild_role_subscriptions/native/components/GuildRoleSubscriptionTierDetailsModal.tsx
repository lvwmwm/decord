...
// Function ID: 128288
// Name: Content
// Dependencies: [57, 31, 14094, 653, 33, 12905, 16436, 14116, 14101, 16419, 7494, 1212, 16425, 7495, 1273, 16465, 16428, 2]
// Exports: default

// Module 16464 (Content)
...
function Content() {
  ...
  let obj6 = require(14101) /* _createForOfIteratorHelperLoose */;
  ...
  let obj7 = require(16419) /* useRoleSubscriptionSettingsDisabled */;
  ...
  items[3] = callback2(require(7495) /* Form */.FormInput, obj4);
  ...
  items[4] = callback2(importDefault(7494), obj5);
  ...
  items[5] = callback2(require(7495) /* Form */.FormInput, obj6);
  obj7 = { style: tmp.header };
  const tmp24 = importDefault(7494);
  const intl7 = require(1212) /* getSystemLocale */.intl;
  obj7.children = intl7.string(require(1212) /* getSystemLocale */.t.CrRVAx);
  items[6] = callback2(importDefault(7494), obj7);
  const obj8 = {};
  const tmp25 = importDefault(7494);
  ...
  obj8.price = tmp28;
  obj8.onChange = tmp10;
  items[7] = tmp26(importDefault(16465), obj8);
  obj.children = items;
