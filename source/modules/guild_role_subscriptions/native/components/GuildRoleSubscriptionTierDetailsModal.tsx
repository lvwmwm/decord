...
// Function ID: 16869
// Name: Content
// Dependencies: [32, 19, 14449, 676, 21, 13255, 16840, 14471, 14456, 16823, 9066, 1236, 16829, 7969, 1297, 16869, 16832, 2]
// Exports: default

// Module 16868 (Content)
...
function Content() {
  ...
  let tmp7;
  let tmp8;
  const tmp3 = importDefault(13255)();
  ...
  obj1[3] = require(16829) /* pickImage */.PreviewShape.CIRCLE;
  ...
  items[2] = callback2(importDefault(9066), obj2);
  ...
  items[3] = callback2(require(7969) /* Form */.FormInput, obj3);
  obj4 = { style: tmp3.header, children: null };
  const tmpResult1 = importDefault(9066);
  const intl5 = tmp4(1236).intl;
  obj4[1] = intl5.string(require(1236) /* getSystemLocale */.t["74JctW"]);
  items[4] = callback2(importDefault(9066), obj4);
  ...
  items[5] = callback2(require(7969) /* Form */.FormInput, obj5);
  const obj6 = { style: tmp3.header, children: null };
  const tmpResult2 = importDefault(9066);
  const intl7 = tmp4(1236).intl;
  obj6[1] = intl7.string(require(1236) /* getSystemLocale */.t.CrRVAx);
  items[6] = callback2(importDefault(9066), obj6);
  const tmpResult3 = importDefault(9066);
  if (!tmp20) {
  ...
  obj7[2] = tmp12;
  obj7[3] = tmp13;
  items[7] = tmp24(importDefault(16869), obj7);
  obj8[0] = items;
