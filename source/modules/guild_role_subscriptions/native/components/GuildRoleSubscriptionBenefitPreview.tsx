...
// Function ID: 16982
// Name: BaseBenefitRow
// Dependencies: [19, 17, 14551, 21, 4661, 14586, 1297, 11640, 4734, 4034, 14579, 4984, 6832, 1236, 2]
// Exports: GuildRoleSubscriptionBenefitPreview

// Module 16981 (BaseBenefitRow)
import "noop";
...
function BaseBenefitRow(isInteractive) {
  ...
  obj = { style: tmp.emojiContainer, children: callback(importDefault(14586), { guildId, id: emoji }) };
...
function DescriptiveBenefitRow(benefit) {
  ...
  if (null != benefit.description) {
    ...
    tmp2 = callback(require(4734) /* Text */.Text, obj);
  }
...
function ChannelBenefitRow(benefit) {
  ...
  const tmp = callback3();
  let obj = require(14579) /* getUsedTemplateChannelsForGuild */;
  ...
  if (null != channelWithTemplateFallback) {
    channelIcon = tmp2(6832).getChannelIcon(channelWithTemplateFallback);
  ...
  if (null == channelWithTemplateFallback) {
    ...
    let tmp9 = callback(tmp2(4734).Text, obj);
  } else {
...
function IntangibleBenefitRow(benefit) {
  benefit = benefit.benefit;
  obj = { benefit, guildId: benefit.guildId, isInteractive: benefit.isInteractive, children: callback(require(4734) /* Text */.Text, obj) };
...
function EmojiBenefitRow(benefit) {
  ...
  items[2] = callback(require(4734) /* Text */.Text, { style: tmp.emojiColons, variant: "text-md/medium", color: "text-muted", children: ":" });
  obj[4] = items;
