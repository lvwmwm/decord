...
// Function ID: 16929
// Name: BaseBenefitRow
// Dependencies: [19, 17, 14515, 21, 4342, 14550, 1297, 10789, 4338, 4002, 14543, 4535, 4805, 1236, 2]
// Exports: GuildRoleSubscriptionBenefitPreview

// Module 16928 (BaseBenefitRow)
import "noop";
...
function BaseBenefitRow(isInteractive) {
  ...
  obj = { style: tmp.emojiContainer, children: callback(importDefault(14550), { guildId, id: emoji }) };
...
function DescriptiveBenefitRow(benefit) {
  ...
  if (null != benefit.description) {
    ...
    tmp2 = callback(require(4338) /* Text */.Text, obj);
  }
  let emoji = benefit.emoji_id;
  if (emoji == null) {
    let str = "";
    if (null != benefit.emoji_name) {
      str = importDefault(4002).convertSurrogateToName(benefit.emoji_name, false);
...
function ChannelBenefitRow(benefit) {
  ...
  const tmp = callback3();
  let obj = require(14543) /* getUsedTemplateChannelsForGuild */;
  ...
  if (null == channelWithTemplateFallback) {
    ...
    let tmp9 = callback(tmp2(4338).Text, obj);
  } else {
...
function IntangibleBenefitRow(benefit) {
  benefit = benefit.benefit;
  obj = { benefit, guildId: benefit.guildId, isInteractive: benefit.isInteractive, children: callback(require(4338) /* Text */.Text, obj) };
...
function EmojiBenefitRow(benefit) {
  ...
  items[2] = callback(require(4338) /* Text */.Text, { style: tmp.emojiColons, variant: "text-md/medium", color: "text-muted", children: ":" });
  obj[4] = items;
