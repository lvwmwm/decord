...
// Function ID: 16742
// Name: BaseBenefitRow
// Dependencies: [19, 17, 14353, 21, 4285, 14388, 1297, 10738, 4281, 3925, 14381, 4475, 4745, 1236, 2]
// Exports: GuildRoleSubscriptionBenefitPreview

// Module 16741 (BaseBenefitRow)
import "noop";
...
function BaseBenefitRow(isInteractive) {
  ...
  obj = { style: tmp.emojiContainer, children: callback(importDefault(14388), { guildId, id: emoji }) };
...
function DescriptiveBenefitRow(benefit) {
  ...
  if (null != benefit.description) {
    ...
    tmp2 = callback(require(4281) /* Text */.Text, obj);
  }
...
function ChannelBenefitRow(benefit) {
  ...
  const tmp = callback3();
  let obj = require(14381) /* getUsedTemplateChannelsForGuild */;
  ...
  if (null != channelWithTemplateFallback) {
    channelIcon = tmp2(4745).getChannelIcon(channelWithTemplateFallback);
  ...
  if (null == channelWithTemplateFallback) {
    ...
    let tmp9 = callback(tmp2(4281).Text, obj);
  } else {
...
function IntangibleBenefitRow(benefit) {
  benefit = benefit.benefit;
  obj = { benefit, guildId: benefit.guildId, isInteractive: benefit.isInteractive, children: callback(require(4281) /* Text */.Text, obj) };
...
function EmojiBenefitRow(benefit) {
  ...
  items[2] = callback(require(4281) /* Text */.Text, { style: tmp.emojiColons, variant: "text-md/medium", color: "text-muted", children: ":" });
  obj[4] = items;
