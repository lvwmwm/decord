...
// Function ID: 16918
// Name: BaseBenefitRow
// Dependencies: [19, 17, 14506, 21, 4344, 14541, 1297, 10875, 4340, 4002, 14534, 4534, 4804, 1236, 2]
// Exports: GuildRoleSubscriptionBenefitPreview

// Module 16917 (BaseBenefitRow)
import "noop";
...
function DescriptiveBenefitRow(benefit) {
  ...
  if (null != benefit.description) {
    ...
    tmp2 = callback(require(4340) /* Text */.Text, obj);
  }
...
function ChannelBenefitRow(benefit) {
  ...
  if (null != channelWithTemplateFallback) {
    channelIcon = tmp2(4804).getChannelIcon(channelWithTemplateFallback);
    const tmp2Result = tmp2(4804);
  }
  if (null == channelWithTemplateFallback) {
    ...
    let tmp9 = callback(tmp2(4340).Text, obj);
  } else {
...
function IntangibleBenefitRow(benefit) {
  benefit = benefit.benefit;
  obj = { benefit, guildId: benefit.guildId, isInteractive: benefit.isInteractive, children: callback(require(4340) /* Text */.Text, obj) };
...
function EmojiBenefitRow(benefit) {
  ...
  items[2] = callback(require(4340) /* Text */.Text, { style: tmp.emojiColons, variant: "text-md/medium", color: "text-muted", children: ":" });
  obj[4] = items;
