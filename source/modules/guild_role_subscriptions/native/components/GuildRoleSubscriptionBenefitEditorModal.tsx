...
// Function ID: 16755
// Name: DeleteButton
// Dependencies: [5, 32, 19, 17, 3938, 1903, 16753, 14369, 676, 21, 4302, 712, 5235, 13175, 4844, 4261, 1297, 1236, 1609, 16755, 4492, 7907, 16757, 9000, 16758, 2]

// Module 16754 (DeleteButton)
...
function DeleteButton(onDelete) {
  ...
  items = [importDefault(13175)().textInput, tmp.deleteButton];
  obj = { style: tmp.deleteIcon, color: null, size: "custom" };
  obj[1] = importDefault(712).unsafe_rawColors.RED_400;
  const items1 = [callback2(require(4261) /* TrashIcon */.TrashIcon, obj), ];
...
const forwardRefResult = importAllResult.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      let tmp25 = callback2(tmp2(16755), obj);
      let tmp26 = callback2;
    } else {
      ...
      tmp25 = callback2(tmp20(7907).FormInput, obj);
      tmp26 = callback2;
    }
    ...
    const items = [tmp26(tmp2(16757), obj1), ];
    ...
    obj3[0] = first(1609)().bottom + 32 + 16;
    items1[1] = obj3;
    obj2[3] = items1;
    const obj4 = { style: null, children: null };
    obj4[0] = tmp4.header;
    obj4[1] = stringResult1;
    const items2 = [tmp26(tmp2(9000), obj4), tmp25, , , , , ];
    ...
    items2[3] = tmp26(tmp2(16758), obj6);
    ...
    items2[5] = tmp26(tmp20(7907).FormInput, obj9);
