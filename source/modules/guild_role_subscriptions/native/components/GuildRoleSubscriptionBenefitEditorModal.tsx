...
// Function ID: 17269
// Name: DeleteButton
// Dependencies: [5, 32, 19, 17, 4099, 1923, 17267, 14734, 676, 21, 4446, 712, 5426, 13570, 5033, 4404, 1297, 1236, 1629, 17269, 4640, 8309, 17271, 9843, 17272, 2]

// Module 17268 (DeleteButton)
...
import closure_9 from "resetImperatively" /* 17267 */;
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      obj[2] = function handleChannelSelected(id) {
        callback3(id.id);
        dependencyMap(benefitType(4640).computeChannelName(id, first4, first3));
      };
      let tmp25 = callback2(tmp2(17269), obj);
      let tmp26 = callback2;
    } else {
      ...
      tmp25 = callback2(tmp20(8309).FormInput, obj);
      tmp26 = callback2;
    }
    ...
    const items = [tmp26(tmp2(17271), obj1), ];
    ...
    const items2 = [tmp26(tmp2(9843), obj4), tmp25, , , , , ];
    ...
    items2[3] = tmp26(tmp2(17272), obj6);
    ...
    items2[5] = tmp26(tmp20(8309).FormInput, obj9);
