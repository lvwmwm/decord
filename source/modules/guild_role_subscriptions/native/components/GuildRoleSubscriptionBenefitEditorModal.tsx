...
// Function ID: 16911
// Name: DeleteButton
// Dependencies: [5, 32, 19, 17, 3998, 1922, 16909, 14506, 676, 21, 4344, 712, 5275, 13312, 4886, 4303, 1297, 1236, 1628, 16911, 4534, 8008, 16913, 9105, 16914, 2]

// Module 16910 (DeleteButton)
...
function DeleteButton(onDelete) {
  ...
  items = [importDefault(13312)().textInput, tmp.deleteButton];
  obj = { style: tmp.deleteIcon, color: null, size: "custom" };
  obj[1] = importDefault(712).unsafe_rawColors.RED_400;
  const items1 = [callback2(require(4303) /* TrashIcon */.TrashIcon, obj), ];
  ...
  obj[3] = items1;
  return callback3(require(4886) /* PressableBase */.PressableOpacity, obj);
}
...
const forwardRefResult = importAllResult.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      let tmp25 = callback2(tmp2(16911), obj);
      let tmp26 = callback2;
    } else {
      ...
      tmp25 = callback2(tmp20(8008).FormInput, obj);
      tmp26 = callback2;
    }
    ...
    const items = [tmp26(tmp2(16913), obj1), ];
    ...
    obj3[0] = first(1628)().bottom + 32 + 16;
    items1[1] = obj3;
    obj2[3] = items1;
    const obj4 = { style: null, children: null };
    obj4[0] = tmp4.header;
    obj4[1] = stringResult1;
    const items2 = [tmp26(tmp2(9105), obj4), tmp25, , , , , ];
    ...
    items2[3] = tmp26(tmp2(16914), obj6);
    ...
    items2[5] = tmp26(tmp20(8008).FormInput, obj9);
