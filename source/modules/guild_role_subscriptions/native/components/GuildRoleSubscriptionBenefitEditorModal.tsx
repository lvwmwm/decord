...
const forwardRefResult = importAllResult.forwardRef((benefitType) => {
  ...
  if (!tmp12) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      tmp40 = callback2(_require(7575).FormInput, obj);
    }
    ...
    items2[5] = callback2(_require(7575).FormInput, obj9);
    let tmp57 = null;
