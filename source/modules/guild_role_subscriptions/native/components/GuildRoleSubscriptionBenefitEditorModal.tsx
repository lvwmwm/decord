...
// Function ID: 16683
// Name: DeleteButton
// Dependencies: [5, 32, 19, 17, 3892, 1874, 16681, 14308, 676, 21, 4255, 712, 5175, 13119, 4783, 4214, 1297, 1236, 1581, 16683, 4446, 7765, 16685, 8652, 16686, 2]

// Module 16682 (DeleteButton)
...
function DeleteButton(onDelete) {
  ...
  items = [importDefault(13119)().textInput, tmp.deleteButton];
...
const forwardRefResult = importAllResult.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      let tmp25 = callback2(tmp2(16683), obj);
      let tmp26 = callback2;
    } else {
      ...
      tmp25 = callback2(tmp20(7765).FormInput, obj);
      tmp26 = callback2;
    }
    ...
    const items = [tmp26(tmp2(16685), obj1), ];
    ...
    const items2 = [tmp26(tmp2(8652), obj4), tmp25, , , , , ];
    ...
    items2[3] = tmp26(tmp2(16686), obj6);
    const obj8 = { style: null, children: null };
    obj8[0] = tmp4.header;
    tmp2Result = tmp2(8652);
    ...
    items2[5] = tmp26(tmp20(7765).FormInput, obj9);
