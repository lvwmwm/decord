...
// Function ID: 16735
// Name: DeleteButton
// Dependencies: [5, 32, 19, 17, 3921, 1903, 16733, 14353, 676, 21, 4285, 712, 5219, 13161, 4827, 4244, 1297, 1236, 1609, 16735, 4475, 7890, 16737, 8983, 16738, 2]

// Module 16734 (DeleteButton)
...
function DeleteButton(onDelete) {
  ...
  items = [importDefault(13161)().textInput, tmp.deleteButton];
...
const forwardRefResult = importAllResult.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      let tmp25 = callback2(tmp2(16735), obj);
      let tmp26 = callback2;
    } else {
      ...
      tmp25 = callback2(tmp20(7890).FormInput, obj);
      tmp26 = callback2;
    }
    ...
    const items = [tmp26(tmp2(16737), obj1), ];
    ...
    const items2 = [tmp26(tmp2(8983), obj4), tmp25, , , , , ];
    ...
    items2[3] = tmp26(tmp2(16738), obj6);
    ...
    items2[5] = tmp26(tmp20(7890).FormInput, obj9);
