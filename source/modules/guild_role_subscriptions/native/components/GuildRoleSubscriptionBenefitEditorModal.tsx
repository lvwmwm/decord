...
// Function ID: 16695
// Name: DeleteButton
// Dependencies: [5, 32, 19, 17, 3892, 1874, 16693, 14316, 676, 21, 4255, 712, 5189, 13124, 4797, 4214, 1297, 1236, 1581, 16695, 4445, 7749, 16697, 8954, 16698, 2]

// Module 16694 (DeleteButton)
...
function DeleteButton(onDelete) {
  ...
  items = [importDefault(13124)().textInput, tmp.deleteButton];
  obj = { style: tmp.deleteIcon, color: null, size: "custom" };
  obj[1] = importDefault(712).unsafe_rawColors.RED_400;
  const items1 = [callback2(require(4214) /* TrashIcon */.TrashIcon, obj), ];
  ...
  obj[3] = items1;
  return callback3(require(4797) /* PressableBase */.PressableOpacity, obj);
}
...
const forwardRefResult = importAllResult.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      let tmp25 = callback2(tmp2(16695), obj);
      let tmp26 = callback2;
    } else {
      ...
      tmp25 = callback2(tmp20(7749).FormInput, obj);
      tmp26 = callback2;
    }
    ...
    const items = [tmp26(tmp2(16697), obj1), ];
    ...
    obj3[0] = first(1581)().bottom + 32 + 16;
    items1[1] = obj3;
    obj2[3] = items1;
    const obj4 = { style: null, children: null };
    obj4[0] = tmp4.header;
    obj4[1] = stringResult1;
    const items2 = [tmp26(tmp2(8954), obj4), tmp25, , , , , ];
    ...
    items2[3] = tmp26(tmp2(16698), obj6);
    ...
    items2[5] = tmp26(tmp20(7749).FormInput, obj9);
