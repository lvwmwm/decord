...
// Function ID: 17185
// Name: DeleteButton
// Dependencies: [5, 32, 19, 17, 4098, 1922, 17183, 14722, 676, 21, 4444, 712, 5408, 13524, 5015, 4402, 1297, 1236, 1629, 17185, 4638, 8185, 17187, 9275, 17188, 2]

// Module 17184 (DeleteButton)
...
import closure_9 from "resetImperatively" /* 17183 */;
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      obj[2] = function handleChannelSelected(id) {
        callback3(id.id);
        dependencyMap(benefitType(4638).computeChannelName(id, first4, first3));
      };
      let tmp25 = callback2(tmp2(17185), obj);
      let tmp26 = callback2;
    } else {
      ...
      tmp25 = callback2(tmp20(8185).FormInput, obj);
      tmp26 = callback2;
    }
    ...
    const items = [tmp26(tmp2(17187), obj1), ];
    ...
    const items2 = [tmp26(tmp2(9275), obj4), tmp25, , , , , ];
    ...
    items2[3] = tmp26(tmp2(17188), obj6);
    ...
    items2[5] = tmp26(tmp20(8185).FormInput, obj9);
