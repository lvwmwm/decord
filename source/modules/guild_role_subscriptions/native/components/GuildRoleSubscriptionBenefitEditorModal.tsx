...
// Function ID: 17574
// Name: DeleteButton
// Dependencies: [5, 32, 19, 17, 4130, 1921, 17572, 15030, 673, 21, 4478, 709, 5469, 13860, 5076, 4436, 1296, 1233, 1627, 17574, 4674, 8372, 17576, 9927, 17577, 2]

// Module 17573 (DeleteButton)
...
import closure_9 from "resetImperatively" /* 17572 */;
...
const forwardRefResult = importAllResult.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      let tmp25 = callback2(tmp2(17574), obj);
      let tmp26 = callback2;
    } else {
      ...
      tmp25 = callback2(tmp20(8372).FormInput, obj);
      tmp26 = callback2;
    }
    ...
    const items = [tmp26(tmp2(17576), obj1), ];
    ...
    const items2 = [tmp26(tmp2(9927), obj4), tmp25, , , , , ];
    ...
    items2[3] = tmp26(tmp2(17577), obj6);
    ...
    items2[5] = tmp26(tmp20(8372).FormInput, obj9);
