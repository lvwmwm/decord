...
// Function ID: 17251
// Name: DeleteButton
// Dependencies: [5, 32, 19, 17, 4098, 1922, 17249, 14749, 676, 21, 4445, 712, 5413, 13551, 5020, 4403, 1297, 1236, 1629, 17251, 4639, 8295, 17253, 9825, 17254, 2]

// Module 17250 (DeleteButton)
...
import closure_9 from "resetImperatively" /* 17249 */;
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === _handleSave.CHANNEL) {
      ...
      obj[2] = function handleChannelSelected(id) {
        callback3(id.id);
        dependencyMap(benefitType(4639).computeChannelName(id, first4, first3));
      };
      let tmp25 = callback2(tmp2(17251), obj);
      let tmp26 = callback2;
    } else {
      ...
      tmp25 = callback2(tmp20(8295).FormInput, obj);
      tmp26 = callback2;
    }
    ...
    const items = [tmp26(tmp2(17253), obj1), ];
    ...
    const items2 = [tmp26(tmp2(9825), obj4), tmp25, , , , , ];
    ...
    items2[3] = tmp26(tmp2(17254), obj6);
    ...
    items2[5] = tmp26(tmp20(8295).FormInput, obj9);
