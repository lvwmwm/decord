...
// Dependencies: [19, 17, 21, 4661, 712, 5449, 15506, 4734, 2]
// Exports: default
...
export default function UnavailableNotice(brightTitle) {
  ...
  items1[1] = callback(require(4734) /* Text */.Text, { variant: "heading-lg/extrabold", color: "text-default", style: items2, children: title });
  items1[2] = callback(require(4734) /* Text */.Text, { style: tmp.unavailableDescription, variant: "text-sm/medium", color: "text-default", children: description });
  obj[1] = items1;
