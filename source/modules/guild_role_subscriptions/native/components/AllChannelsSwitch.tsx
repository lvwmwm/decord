...
// Function ID: 16921
// Name: Row
// Dependencies: [19, 17, 14529, 676, 21, 4342, 712, 5276, 4073, 9106, 1297, 16921, 1236, 16922, 2]
// Exports: default
...
function Row(arg0) {
  ...
  obj[5] = items;
  return closure_6(importDefault(9106), obj);
}
...
export default function AllChannelsSwitch(style) {
  ...
  obj = { icon: importDefault(16921), label: null, selected: null, onPress: null, disabled: null };
  ...
  const obj1 = { icon: importDefault(16922), label: null, selected: null, onPress: null, disabled: null };
