...
// Function ID: 16919
// Name: Row
// Dependencies: [19, 17, 14529, 676, 21, 4344, 712, 5275, 4073, 9102, 1297, 16919, 1236, 16920, 2]
// Exports: default
...
function Row(arg0) {
  ...
  obj[5] = items;
  return closure_6(importDefault(9102), obj);
}
...
export default function AllChannelsSwitch(style) {
  ...
  obj = { icon: importDefault(16919), label: null, selected: null, onPress: null, disabled: null };
  ...
  const obj1 = { icon: importDefault(16920), label: null, selected: null, onPress: null, disabled: null };
