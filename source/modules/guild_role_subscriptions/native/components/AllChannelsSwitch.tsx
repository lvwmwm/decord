...
// Function ID: 16930
// Name: Row
// Dependencies: [19, 17, 14538, 676, 21, 4342, 712, 5276, 4073, 9106, 1297, 16930, 1236, 16931, 2]
// Exports: default
...
export default function AllChannelsSwitch(style) {
  ...
  obj = { icon: importDefault(16930), label: null, selected: null, onPress: null, disabled: null };
  ...
  const obj1 = { icon: importDefault(16931), label: null, selected: null, onPress: null, disabled: null };
