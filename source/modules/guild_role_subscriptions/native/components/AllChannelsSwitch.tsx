...
// Function ID: 16937
// Name: Row
// Dependencies: [19, 17, 14542, 676, 21, 4342, 712, 5297, 4073, 9120, 1297, 16937, 1236, 16938, 2]
// Exports: default
...
function Row(arg0) {
  ...
  obj[5] = items;
  return closure_6(importDefault(9120), obj);
}
...
export default function AllChannelsSwitch(style) {
  ...
  obj = { icon: importDefault(16937), label: null, selected: null, onPress: null, disabled: null };
  ...
  const obj1 = { icon: importDefault(16938), label: null, selected: null, onPress: null, disabled: null };
