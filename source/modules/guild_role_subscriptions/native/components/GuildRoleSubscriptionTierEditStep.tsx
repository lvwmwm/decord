...
// Function ID: 16597
// Name: Header
// Dependencies: [19, 17, 21, 4193, 712, 5181, 4189, 14253, 1236, 1581, 4604, 1480, 2]
// Exports: default
...
function Header(arg0) {
  ...
  items[2] = callback(importDefault(14253), { style: tmp.separator });
  obj[2] = items;
...
function Footer(arg0) {
  ...
  obj[1] = callback(tmp5(4604).Button, obj);
