...
// Function ID: 16812
// Name: Header
// Dependencies: [19, 17, 21, 4303, 712, 5328, 4299, 14451, 1236, 1609, 4714, 1480, 2]
// Exports: default
...
function Header(arg0) {
  ...
  items[2] = callback(importDefault(14451), { style: tmp.separator });
  obj[2] = items;
...
function Footer(arg0) {
  ...
  obj[1] = callback(tmp5(4714).Button, obj);
