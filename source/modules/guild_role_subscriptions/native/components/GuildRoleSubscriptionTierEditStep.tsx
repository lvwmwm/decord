...
// Function ID: 16891
// Name: Header
// Dependencies: [19, 17, 21, 4344, 712, 5367, 4340, 14518, 1236, 1628, 4754, 1499, 2]
// Exports: default
...
function Header(arg0) {
  ...
  items[2] = callback(importDefault(14518), { style: tmp.separator });
  obj[2] = items;
...
function Footer(arg0) {
  ...
  obj[1] = callback(tmp5(4754).Button, obj);
