...
// Function ID: 16909
// Name: Header
// Dependencies: [19, 17, 21, 4342, 712, 5389, 4338, 14531, 1236, 1628, 4777, 1499, 2]
// Exports: default
...
function Header(arg0) {
  ...
  items[2] = callback(importDefault(14531), { style: tmp.separator });
  obj[2] = items;
...
function Footer(arg0) {
  ...
  obj[1] = callback(tmp5(4777).Button, obj);
