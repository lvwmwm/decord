...
// Function ID: 16675
// Name: Header
// Dependencies: [19, 17, 21, 4255, 712, 5257, 4251, 14328, 1236, 1581, 4665, 1480, 2]
// Exports: default
...
function Header(arg0) {
  ...
  items[2] = callback(importDefault(14328), { style: tmp.separator });
  obj[2] = items;
...
function Footer(arg0) {
  ...
  obj[1] = callback(tmp5(4665).Button, obj);
