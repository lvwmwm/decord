...
// Function ID: 16663
// Name: Header
// Dependencies: [19, 17, 21, 4255, 712, 5243, 4251, 14320, 1236, 1581, 4666, 1480, 2]
// Exports: default
...
function Header(arg0) {
  ...
  items[2] = callback(importDefault(14320), { style: tmp.separator });
  obj[2] = items;
...
function Footer(arg0) {
  ...
  obj[1] = callback(tmp5(4666).Button, obj);
