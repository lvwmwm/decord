...
// Function ID: 8688
// Name: ShinyButton
// Dependencies: [19, 21, 4303, 712, 4715, 1297, 8688, 2]
// Exports: default

// Module 8687 (ShinyButton)
import "noop";
...
export default function ShinyButton(style) {
  ...
  return jsx(require(4715) /* CollapsingText */.BaseTextButton, { onPress, pillStyle: items, loading, disabled, icon: null });
};
