...
// Dependencies: [32, 19, 17, 676, 21, 4285, 712, 5219, 14375, 5311, 8980, 4281, 1236, 1297, 2]
// Exports: default

// Module 16737 (GuildRoleSubscriptionBenefitModalHeader)
...
export default function GuildRoleSubscriptionBenefitModalHeader(canSave) {
  ...
  const items1 = [callback2(importDefault(8980), obj), , ];
  ...
  items1[2] = callback2(importDefault(8980), obj5);
  obj[2] = items1;
