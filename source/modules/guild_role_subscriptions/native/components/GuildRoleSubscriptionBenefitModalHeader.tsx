...
// Dependencies: [32, 19, 17, 676, 21, 4303, 712, 5236, 14463, 5328, 9057, 4299, 1236, 1297, 2]
// Exports: default

// Module 16843 (GuildRoleSubscriptionBenefitModalHeader)
...
export default function GuildRoleSubscriptionBenefitModalHeader(canSave) {
  ...
  obj[3] = callback2(require(4299) /* Text */.Text, obj1);
  const items1 = [callback2(importDefault(9057), obj), , ];
  ...
  items2[1] = callback2(require(4299) /* Text */.Text, { style: tmp.subtitle, variant: "text-xs/medium", color: "text-default", children: callback(obj.useName(listingId), 1)[0] });
  obj2[1] = items2;
  ...
  items1[2] = callback2(importDefault(9057), obj5);
  obj[2] = items1;
