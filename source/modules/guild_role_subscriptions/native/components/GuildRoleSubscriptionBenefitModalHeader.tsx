...
// Dependencies: [32, 19, 17, 676, 21, 4302, 712, 5235, 14391, 5327, 8997, 4298, 1236, 1297, 2]
// Exports: default

// Module 16757 (GuildRoleSubscriptionBenefitModalHeader)
...
export default function GuildRoleSubscriptionBenefitModalHeader(canSave) {
  ...
  obj[3] = callback2(require(4298) /* Text */.Text, obj1);
  const items1 = [callback2(importDefault(8997), obj), , ];
  ...
  items2[1] = callback2(require(4298) /* Text */.Text, { style: tmp.subtitle, variant: "text-xs/medium", color: "text-default", children: callback(obj.useName(listingId), 1)[0] });
  obj2[1] = items2;
  ...
  items1[2] = callback2(importDefault(8997), obj5);
  obj[2] = items1;
