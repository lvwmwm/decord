...
// Dependencies: [19, 17, 21, 4661, 5449, 16913, 16914, 4734, 4745, 1297, 14563, 2]
// Exports: default
...
function EligibilityChecklistRow(item) {
  ...
  obj[1] = tmp6Result;
  const items1 = [closure_4(importDefault(5449), obj), ];
  obj = { style: tmp.rowTextColumn, children: null };
  const items2 = [closure_4(require(4734) /* Text */.Text, { style: tmp.rowLabel, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: item.checked ? item.checkedLabel : item.uncheckedLabel }), closure_4(require(4734) /* Text */.Text, { variant: "text-sm/normal", color: "interactive-text-default", children: item.description }), ];
