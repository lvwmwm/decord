...
// Dependencies: [19, 17, 21, 4302, 5267, 16693, 16694, 4298, 4712, 1297, 14381, 2]
// Exports: default

// Module 16692 (EligibilityChecklistRow)
import "noop";
...
function EligibilityChecklistRow(item) {
  ...
  obj[1] = tmp6Result;
  const items1 = [closure_4(importDefault(5267), obj), ];
  obj = { style: tmp.rowTextColumn, children: null };
  const items2 = [closure_4(require(4298) /* Text */.Text, { style: tmp.rowLabel, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: item.checked ? item.checkedLabel : item.uncheckedLabel }), closure_4(require(4298) /* Text */.Text, { variant: "text-sm/normal", color: "interactive-text-default", children: item.description }), ];
