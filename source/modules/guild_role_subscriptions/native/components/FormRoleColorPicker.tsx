...
// Dependencies: [19, 676, 21, 4342, 4310, 15496, 2007, 13311, 13976, 688, 2]
// Exports: default

// Module 16936 (FormRoleColorPicker)
...
export default function FormRoleColorPicker(color) {
  ...
  obj[0] = jsx(onChange(13976), { color, style: tmp.rowColorBlock, onSelect: callback });
  const tmp3 = onChange(13311);
