...
// Dependencies: [19, 676, 21, 4344, 4312, 15487, 2007, 13310, 13972, 688, 2]
// Exports: default

// Module 16925 (FormRoleColorPicker)
...
export default function FormRoleColorPicker(color) {
  ...
  obj[0] = jsx(onChange(13972), { color, style: tmp.rowColorBlock, onSelect: callback });
  const tmp3 = onChange(13310);
