...
// Function ID: 16844
// Name: PriceTier
// Dependencies: [32, 19, 17, 21, 4303, 712, 4299, 5855, 1236, 14465, 14461, 5268, 16844, 16838, 16817, 14472, 2]
// Exports: GuildRoleSubscriptionListingPreview

// Module 16843 (PriceTier)
...
function PriceTier(arg0) {
  ...
  obj[2] = require(5855) /* formatSingleCurrencyPrice */.formatPrice(price, currency);
  ...
  obj1[0] = require(14465) /* getBenefitKey */.formatPlanInterval(merged);
...
function Header(onPress) {
  ...
  obj[1] = { uri: str };
  items[1] = callback2(importDefault(5268), obj);
  obj1 = {};
  const merged = Object.assign(callback(obj.useSubscriptionPlan(listingId), 1)[0]);
  items[2] = callback2(PriceTier, obj1);
  items[3] = callback2(require(16844) /* GuildPremiumRoleSubscribeButton */.GuildPremiumRoleSubscribeButton, { onPress: onPress.onSubscribePress });
...
function SectionLabel(children) {
  ...
  obj.children = callback2(require(4299) /* Text */.Text, obj);
...
export const GuildRoleSubscriptionListingPreview = function GuildRoleSubscriptionListingPreview(arg0) {
  ...
  obj1[1] = callback2(require(14472) /* GuildRoleSubscriptionMemberPreview */.GuildRoleSubscriptionMemberPreview, { role });
