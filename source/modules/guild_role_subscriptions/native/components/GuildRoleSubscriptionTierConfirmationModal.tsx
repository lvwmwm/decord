...
// Dependencies: [5, 32, 19, 17, 17649, 21, 4481, 709, 13908, 17661, 17653, 1233, 9745, 5542, 4477, 17685, 2]
// Exports: default

// Module 17684 (GuildRoleSubscriptionTierConfirmationModal)
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    if (tmp13Result) {
      ...
      obj3[2] = first;
      obj2[1] = callback3(tmp3(5542), obj3);
  ...
  const items3 = [flag, callback3(onDone(17685).GuildRoleSubscriptionListingPreview, { guildId, listingId: editStateId })];
  obj.children = items3;
