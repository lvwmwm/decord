...
// Dependencies: [5, 32, 19, 17, 16710, 21, 4285, 712, 13161, 16722, 16714, 1236, 8983, 5251, 4281, 16746, 2]
// Exports: default

// Module 16745 (GuildRoleSubscriptionTierConfirmationModal)
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  const tmp5 = importDefault(13161)();
  ...
  obj.children = items3;
  return closure_10(importDefault(16714), obj);
};
