...
// Dependencies: [5, 32, 19, 17, 16886, 21, 4344, 712, 13312, 16898, 16890, 1236, 9105, 5307, 4340, 16922, 2]
// Exports: default

// Module 16921 (GuildRoleSubscriptionTierConfirmationModal)
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  const tmp5 = importDefault(13312)();
  ...
  obj.children = items3;
  return closure_10(importDefault(16890), obj);
};
