...
// Function ID: 13254
// Name: LockedIcon
// Dependencies: [19, 676, 21, 4303, 5236, 712, 1297, 13254, 10822, 13255, 9063, 2]
// Exports: default

// Module 13253 (LockedIcon)
import "noop";
...
export default function FormDropdown(arg0) {
  ...
  const tmp4 = importDefault(13255)();
