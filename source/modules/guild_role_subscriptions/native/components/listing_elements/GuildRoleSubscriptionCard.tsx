...
// Function ID: 14482
// Name: SectionTitle
// Dependencies: [32, 19, 17, 21, 4303, 712, 4299, 14471, 8760, 1236, 1297, 14482, 14483, 14486, 2]
// Exports: Content

// Module 14481 (SectionTitle)
...
export const Content = function Content(arg0) {
  ...
  if (first.size > 0) {
    ...
    obj5[0] = items3;
    obj5[1] = guildId;
    items2[2] = tmp7(importDefault(14483), obj5);
    obj2[0] = items2;
    tmp4Result = tmp4(tmp6, obj2);
    const tmp11 = importDefault(14483);
  }
  items1[1] = tmp4Result;
  tmp4Result = null;
  if (first1.length > 0) {
