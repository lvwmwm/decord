...
// Function ID: 14539
// Name: SectionTitle
// Dependencies: [32, 19, 17, 21, 4344, 712, 4340, 14528, 8799, 1236, 1297, 14539, 14540, 14543, 2]
// Exports: Content

// Module 14538 (SectionTitle)
...
export const Content = function Content(arg0) {
  ...
  if (first.size > 0) {
    ...
    obj5[0] = items3;
    obj5[1] = guildId;
    items2[2] = tmp7(importDefault(14540), obj5);
    obj2[0] = items2;
    tmp4Result = tmp4(tmp6, obj2);
    const tmp11 = importDefault(14540);
  }
  items1[1] = tmp4Result;
  tmp4Result = null;
  if (first1.length > 0) {
