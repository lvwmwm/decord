...
// Dependencies: [19, 17, 1922, 21, 4380, 712, 1236, 589, 4573, 1435, 5859, 5374, 4376, 688, 1297, 5860, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 14682 (GuildRoleSubscriptionMemberPreview)
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(5859).getRoleIconData(role, 16);
    ...
    obj[0] = tmp3.avatar;
    obj[1] = source;
    const items2 = [callback(tmp6(5374), obj), ];
    ...
    const tmp4Result = tmp4(5859);
    obj4[0] = int2hslRawAll.int2hex(role.color);
    obj3[2] = obj4;
    obj3[3] = tmp8;
    const items3 = [callback(tmp4(4376).Text, obj3), , , ];
