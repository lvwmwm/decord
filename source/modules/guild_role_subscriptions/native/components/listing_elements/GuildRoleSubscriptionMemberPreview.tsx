...
// Dependencies: [19, 17, 1874, 21, 4285, 712, 1236, 589, 4474, 1416, 5635, 5236, 4281, 688, 1297, 5636, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 14374 (GuildRoleSubscriptionMemberPreview)
import "noop";
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(5635).getRoleIconData(role, 16);
    ...
    obj[0] = tmp3.avatar;
    obj[1] = source;
    const items2 = [callback(tmp6(5236), obj), ];
    ...
    if (null != roleIconData) {
      ...
      items4[1] = tmp14(tmp6(5636), obj5);
      obj7[0] = items4;
      tmp12Result = tmp12(closure_7, obj7);
      const tmp17 = closure_7;
      const tmp6Result1 = tmp6(5636);
    }
