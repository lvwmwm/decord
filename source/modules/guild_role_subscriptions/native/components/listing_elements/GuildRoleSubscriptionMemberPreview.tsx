...
// Dependencies: [19, 17, 1874, 21, 4255, 712, 1236, 589, 4444, 1416, 5620, 5221, 4251, 688, 1297, 5621, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 14349 (GuildRoleSubscriptionMemberPreview)
import "noop";
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(5620).getRoleIconData(role, 16);
    ...
    obj[0] = tmp3.avatar;
    obj[1] = source;
    const items2 = [callback(tmp6(5221), obj), ];
    ...
    if (null != roleIconData) {
      ...
      items4[1] = tmp14(tmp6(5621), obj5);
      obj7[0] = items4;
      tmp12Result = tmp12(closure_7, obj7);
      const tmp17 = closure_7;
      const tmp6Result1 = tmp6(5621);
    }
