...
// Dependencies: [19, 17, 1874, 21, 4255, 712, 1236, 589, 4445, 1416, 5606, 5207, 4251, 688, 1297, 5607, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 14341 (GuildRoleSubscriptionMemberPreview)
import "noop";
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(5606).getRoleIconData(role, 16);
    ...
    obj[0] = tmp3.avatar;
    obj[1] = source;
    const items2 = [callback(tmp6(5207), obj), ];
    ...
    const tmp4Result = tmp4(5606);
    obj4[0] = importAll(688).int2hex(role.color);
    obj3[2] = obj4;
    obj3[3] = tmp8;
    const items3 = [callback(tmp4(4251).Text, obj3), , , ];
