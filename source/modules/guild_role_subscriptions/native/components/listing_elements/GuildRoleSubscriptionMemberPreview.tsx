...
// Dependencies: [19, 17, 1903, 21, 4285, 712, 1236, 589, 4474, 1416, 5674, 5251, 4281, 688, 1297, 5675, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 14386 (GuildRoleSubscriptionMemberPreview)
import "noop";
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(5674).getRoleIconData(role, 16);
    ...
    obj[0] = tmp3.avatar;
    obj[1] = source;
    const items2 = [callback(tmp6(5251), obj), ];
    ...
    const tmp4Result = tmp4(5674);
    obj4[0] = importAll(688).int2hex(role.color);
    obj3[2] = obj4;
    obj3[3] = tmp8;
    const items3 = [callback(tmp4(4281).Text, obj3), , , ];
