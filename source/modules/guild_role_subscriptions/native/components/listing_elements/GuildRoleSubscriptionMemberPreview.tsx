...
// Dependencies: [19, 17, 1922, 21, 4344, 712, 1236, 589, 4533, 1435, 5792, 5307, 4340, 688, 1297, 5793, 2]
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(5792).getRoleIconData(role, 16);
    ...
    obj[0] = tmp3.avatar;
    obj[1] = source;
    const items2 = [callback(tmp6(5307), obj), ];
    ...
    const tmp4Result = tmp4(5792);
    obj4[0] = importAll(688).int2hex(role.color);
    obj3[2] = obj4;
    obj3[3] = tmp8;
    const items3 = [callback(tmp4(4340).Text, obj3), , , ];
