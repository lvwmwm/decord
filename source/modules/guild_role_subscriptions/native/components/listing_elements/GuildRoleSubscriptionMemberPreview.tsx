...
// Module 14548 (GuildRoleSubscriptionMemberPreview)
import "noop";
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    obj3[2] = obj4;
    obj3[3] = tmp8;
    const items3 = [callback(tmp4(4338).Text, obj3), , , ];
    ...
    items3[3] = callback(tmp4(4338).Text, { variant: "text-xs/medium", color: "text-muted", children: "4:20 PM" });
    obj2[1] = items3;
    const items5 = [closure_8(View, obj2), ];
    const obj8 = { variant: "text-md/normal", color: "text-default", style: null, children: null };
    obj8[2] = textStyle;
    obj8[3] = content;
    items5[1] = callback(tmp4(4338).Text, obj8);
    obj1[1] = items5;
