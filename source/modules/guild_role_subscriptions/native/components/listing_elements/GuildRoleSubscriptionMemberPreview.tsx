...
// Dependencies: [19, 17, 1922, 21, 4661, 712, 1236, 589, 4796, 1435, 7164, 5449, 4734, 688, 1297, 7165, 2]
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(7164).getRoleIconData(role, 16);
