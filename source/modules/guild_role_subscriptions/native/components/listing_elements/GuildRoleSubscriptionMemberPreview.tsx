...
// Dependencies: [19, 17, 1923, 21, 4446, 712, 1236, 589, 4639, 1435, 5943, 5458, 4442, 688, 1297, 5944, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 14767 (GuildRoleSubscriptionMemberPreview)
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(5943).getRoleIconData(role, 16);
    ...
    obj[0] = tmp3.avatar;
    obj[1] = source;
    const items2 = [callback(tmp6(5458), obj), ];
    ...
    const tmp4Result = tmp4(5943);
    obj4[0] = int2hslRawAll.int2hex(role.color);
    obj3[2] = obj4;
    obj3[3] = tmp8;
    const items3 = [callback(tmp4(4442).Text, obj3), , , ];
