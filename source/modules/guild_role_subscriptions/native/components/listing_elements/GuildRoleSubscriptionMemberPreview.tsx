...
// Dependencies: [19, 17, 1922, 21, 4444, 712, 1236, 589, 4637, 1435, 5925, 5440, 4440, 688, 1297, 5926, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 14755 (GuildRoleSubscriptionMemberPreview)
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(5925).getRoleIconData(role, 16);
    ...
    obj[0] = tmp3.avatar;
    obj[1] = source;
    const items2 = [callback(tmp6(5440), obj), ];
    ...
    const tmp4Result = tmp4(5925);
    obj4[0] = int2hslRawAll.int2hex(role.color);
    obj3[2] = obj4;
    obj3[3] = tmp8;
    const items3 = [callback(tmp4(4440).Text, obj3), , , ];
