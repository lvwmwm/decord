...
// Dependencies: [19, 17, 1922, 21, 4668, 712, 1236, 589, 4801, 1435, 7202, 5454, 4739, 688, 1297, 7203, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 14652 (GuildRoleSubscriptionMemberPreview)
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const roleIconData = tmp4(7202).getRoleIconData(role, 16);
    ...
    obj[0] = tmp3.avatar;
    obj[1] = source;
    const items2 = [callback(tmp6(5454), obj), ];
    ...
    const tmp4Result = tmp4(7202);
    obj4[0] = int2hslRawAll.int2hex(role.color);
    obj3[2] = obj4;
    obj3[3] = tmp8;
    const items3 = [callback(tmp4(4739).Text, obj3), , , ];
