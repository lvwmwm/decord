...
// Dependencies: [19, 17, 1921, 21, 4481, 709, 1233, 586, 4680, 1431, 7127, 5542, 4477, 685, 1296, 7128, 2]
// Exports: GuildRoleSubscriptionMemberPreview

// Module 15162 (GuildRoleSubscriptionMemberPreview)
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    obj[0] = tmp3.avatar;
    obj[1] = source;
    const items2 = [callback(tmp6(5542), obj), ];
    ...
    const tmp4Result = tmp4(7127);
    obj4[0] = int2hslRawAll.int2hex(role.color);
    obj3[2] = obj4;
    obj3[3] = tmp8;
    const items3 = [callback(tmp4(4477).Text, obj3), , , ];
    let tmp12Result = null;
    if (null != roleIconData) {
      const items4 = [tmp14(tmp4(1296).Spacer, { size: 4 }), ];
      ...
      items4[1] = tmp14(tmp6(7128), obj5);
      obj7[0] = items4;
      tmp12Result = tmp12(closure_7, obj7);
      const tmp17 = closure_7;
      const tmp6Result1 = tmp6(7128);
    }
    items3[1] = tmp12Result;
    items3[2] = callback(tmp4(1296).Spacer, { size: 8 });
    items3[3] = callback(tmp4(4477).Text, { variant: "text-xs/medium", color: "text-muted", children: "4:20 PM" });
    obj2[1] = items3;
    const items5 = [closure_8(View, obj2), ];
    const obj8 = { variant: "text-md/normal", color: "text-default", style: null, children: null };
    obj8[2] = textStyle;
    obj8[3] = content;
    items5[1] = callback(tmp4(4477).Text, obj8);
    obj1[1] = items5;
