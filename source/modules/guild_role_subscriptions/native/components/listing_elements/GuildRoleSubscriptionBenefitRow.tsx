...
// Function ID: 14544
// Name: BenefitRow
// Dependencies: [19, 17, 1391, 21, 4344, 4002, 14541, 1297, 4340, 589, 4534, 1236, 4804, 2]
...
export const ChannelBenefitRow = function ChannelBenefitRow(benefit) {
  ...
  if (null != benefit.emoji_id) {
    ...
    if (null != benefit.emoji_name) {
      ...
      const tmp5Result = importDefault(4002);
    }
  }
...
export const IntangibleBenefitRow = function IntangibleBenefitRow(benefit) {
  ...
  obj = { emojiId: str, guildId: benefit.guildId, title: tmp(require(4340) /* Text */.Text, obj), description: benefit.description };
