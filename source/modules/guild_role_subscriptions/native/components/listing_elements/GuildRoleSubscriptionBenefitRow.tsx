...
// Function ID: 14354
// Name: BenefitRow
// Dependencies: [19, 17, 1372, 21, 4255, 3896, 14351, 1297, 4251, 589, 4445, 1236, 4715, 2]
// Exports: ChannelBenefitRow, IntangibleBenefitRow

// Module 14353 (BenefitRow)
import "noop";
...
function BenefitRow(description) {
  ...
  const items = [callback(importDefault(14351), { guildId, id: emojiId, size: 22, fontSize: 18 }), callback(require(1297) /* Button */.Spacer, { size: 16 }), ];
