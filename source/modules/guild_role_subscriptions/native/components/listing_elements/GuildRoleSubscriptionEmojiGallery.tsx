...
// Function ID: 14541
// Name: EmojiGallery
// Dependencies: [19, 17, 21, 8797, 8799, 14541, 2]
// Exports: default
...
export default function EmojiGallery(emojiIds) {
  ...
  obj[1] = importDefault(8797)(emojiIds.emojiIds, maxPerRow).map((arr) => {
  ...
  obj[0] = jsx(require(8799) /* GappedList */.GappedList, { gap: 8, children: null });
