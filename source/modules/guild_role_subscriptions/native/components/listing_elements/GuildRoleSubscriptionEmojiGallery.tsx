...
// Function ID: 14388
// Name: EmojiGallery
// Dependencies: [19, 17, 21, 8675, 8677, 14388, 2]
// Exports: default

// Module 14387 (EmojiGallery)
import "noop";
...
export default function EmojiGallery(emojiIds) {
  ...
  obj[1] = importDefault(8675)(emojiIds.emojiIds, maxPerRow).map((arr) => {
  ...
  obj[0] = jsx(require(8677) /* GappedList */.GappedList, { gap: 8, children: null });
