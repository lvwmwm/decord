...
// Function ID: 14253
// Name: EmojiGallery
// Dependencies: [19, 17, 21, 9423, 9425, 14253, 2]
// Exports: default

// Module 14252 (EmojiGallery)
import "noop";
...
export default function EmojiGallery(emojiIds) {
  ...
  obj[1] = importDefault(9423)(emojiIds.emojiIds, maxPerRow).map((arr) => {
  ...
  obj[0] = jsx(require(9425) /* GappedList */.GappedList, { gap: 8, children: null });
