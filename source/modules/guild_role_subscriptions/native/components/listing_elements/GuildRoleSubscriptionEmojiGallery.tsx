...
// Function ID: 14404
// Name: EmojiGallery
// Dependencies: [19, 17, 21, 8692, 8694, 14404, 2]
// Exports: default

// Module 14403 (EmojiGallery)
import "noop";
...
export default function EmojiGallery(emojiIds) {
  ...
  obj[1] = importDefault(8692)(emojiIds.emojiIds, maxPerRow).map((arr) => {
  ...
  obj[0] = jsx(require(8694) /* GappedList */.GappedList, { gap: 8, children: null });
