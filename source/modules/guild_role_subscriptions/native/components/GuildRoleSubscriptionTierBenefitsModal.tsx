...
// Dependencies: [32, 19, 17, 14791, 17277, 14768, 21, 4448, 712, 9029, 5461, 17293, 4444, 1236, 1431, 17294, 13604, 14795, 38, 17272, 8331, 9866, 17295, 17296, 17289, 14775, 17268, 14790, 17298, 17299, 17308, 14794, 17309, 17281, 2]
// Exports: GuildRoleSubscriptionTierChannelBenefitsModal, GuildRoleSubscriptionTierIntangibleBenefitsModal

// Module 17292 (AddBenefitButton)
...
import useRoleSubscriptionFormatDefault from "useRoleSubscriptionFormat" /* 17268 */;
import HeaderDefault from "Header" /* 17281 */;
import registerAssetDefault from "registerAsset" /* 17293 */;
import EmojiAliasDefault from "EmojiAlias" /* 17294 */;
import itemsDefault from "items" /* 17298 */;
import RowDefault from "Row" /* 17309 */;
import closure_4 from "_slicedToArray" /* 32 */;
import closure_5 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import { AllChannelAccessOptions } from "AllChannelAccessOptions" /* 14791 */;
import { useGroupIsFullGateState } from "usePriceTiers" /* 17277 */;
...
function ListFooterSection(onChangeTrialInterval) {
  ...
  const tmp = callback3();
  const tmp4 = options(13604)();
  const tmp5 = options(14795)(interval);
  ...
  let obj = onChangeTrialInterval(17272);
  ...
  const items1 = [callback(onChangeTrialInterval(8331).FormSwitchRow, obj), ];
  ...
  const items3 = [callback(onChangeTrialInterval(4444).Text, obj2), , , , , , ];
  const obj3 = { style: tmp4.header, children: null };
  let tmp2Result = tmp2(9866);
  ...
  items3[4] = callback(options(9866), obj6);
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    type = type.type;
    const obj = { style: callback2(13604)().header, children: null };
    const tmp2 = callback2(13604)();
    ...
    obj[1] = stringResult;
    return tmp3(callback2(9866), obj);
  }
  ...
  roleSubscriptionSettingsDisabled = _require(17272).useRoleSubscriptionSettingsDisabled();
  ...
  obj = {
    ...
    renderItem(item) {
      ...
      if ("roles" in item) {
          ...
          obj = {
            ...
            onDelete() {
              ...
              if (ref_type.ref_type === closure_2_10.CHANNEL) {
                closure_1_8((arr) => arr.filter(/* F122930 */ function() { ... }));
              } else {
                closure_1_10((arr) => arr.filter(/* F122931 */ function() { ... }));
              }
            },
            onSave(ref_type) {
              closure_0 = ref_type;
        ...
        obj2[0] = guildId;
        obj2[1] = item;
        obj[5] = callback4(callback(17308).GuildRoleSubscriptionBenefitPreview, obj2);
        tmp3Result = tmp3(callback2(9029), obj);
        const tmp6 = callback2(9029);
      }
      return tmp3Result;
    },
    keyExtractor: tmp5(14794).getBenefitKey,
    ...
    return closure_12(GuildRoleSubscriptionTierBenefitsModalHeader, {
      ...
      onPress() {
        if (type === constants2.EMOJI) {
          ...
          obj[3] = closure_1_12;
          obj[4] = closure_1_4;
          callback(17299).showEditEmojisModal(obj);
          const obj3 = callback(17299);
        } else {
          if (tmp === tmp2.CHANNEL) {
