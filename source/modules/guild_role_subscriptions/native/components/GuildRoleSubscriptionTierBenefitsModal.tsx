...
// Dependencies: [32, 19, 17, 14745, 17160, 14722, 21, 4444, 712, 9272, 5440, 17176, 4440, 1236, 1435, 17177, 13524, 14749, 38, 17155, 8185, 9275, 17178, 17179, 17172, 14729, 17151, 14744, 17181, 17182, 17191, 14748, 17192, 17164, 2]
// Exports: GuildRoleSubscriptionTierChannelBenefitsModal, GuildRoleSubscriptionTierIntangibleBenefitsModal

// Module 17175 (AddBenefitButton)
...
import useRoleSubscriptionFormatDefault from "useRoleSubscriptionFormat" /* 17151 */;
import HeaderDefault from "Header" /* 17164 */;
import registerAssetDefault from "registerAsset" /* 17176 */;
import EmojiAliasDefault from "EmojiAlias" /* 17177 */;
import itemsDefault from "items" /* 17181 */;
import RowDefault from "Row" /* 17192 */;
import closure_4 from "_slicedToArray" /* 32 */;
import closure_5 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import { AllChannelAccessOptions } from "AllChannelAccessOptions" /* 14745 */;
import { useGroupIsFullGateState } from "usePriceTiers" /* 17160 */;
...
function ListFooterSection(onChangeTrialInterval) {
  ...
  const tmp = callback3();
  const tmp4 = options(13524)();
  const tmp5 = options(14749)(interval);
  ...
  let obj = onChangeTrialInterval(17155);
  ...
  const items1 = [callback(onChangeTrialInterval(8185).FormSwitchRow, obj), ];
  ...
  const items3 = [callback(onChangeTrialInterval(4440).Text, obj2), , , , , , ];
  const obj3 = { style: tmp4.header, children: null };
  let tmp2Result = tmp2(9275);
  ...
  items3[4] = callback(options(9275), obj6);
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    type = type.type;
    const obj = { style: callback2(13524)().header, children: null };
    const tmp2 = callback2(13524)();
    ...
    obj[1] = stringResult;
    return tmp3(callback2(9275), obj);
  }
  ...
  roleSubscriptionSettingsDisabled = _require(17155).useRoleSubscriptionSettingsDisabled();
  ...
  obj = {
    ...
    renderItem(item) {
      ...
      if ("roles" in item) {
          ...
          obj = {
            ...
            onDelete() {
              ...
              if (ref_type.ref_type === closure_2_10.CHANNEL) {
                closure_1_8((arr) => arr.filter(/* F122432 */ function() { ... }));
              } else {
                closure_1_10((arr) => arr.filter(/* F122433 */ function() { ... }));
              }
            },
            onSave(ref_type) {
              closure_0 = ref_type;
        ...
        obj2[0] = guildId;
        obj2[1] = item;
        obj[5] = callback4(callback(17191).GuildRoleSubscriptionBenefitPreview, obj2);
        tmp3Result = tmp3(callback2(9272), obj);
        const tmp6 = callback2(9272);
      }
      return tmp3Result;
    },
    keyExtractor: tmp5(14748).getBenefitKey,
    ...
    return closure_12(GuildRoleSubscriptionTierBenefitsModalHeader, {
      ...
      onPress() {
        if (type === constants2.EMOJI) {
          ...
          obj[3] = closure_1_12;
          obj[4] = closure_1_4;
          callback(17182).showEditEmojisModal(obj);
          const obj3 = callback(17182);
        } else {
          if (tmp === tmp2.CHANNEL) {
