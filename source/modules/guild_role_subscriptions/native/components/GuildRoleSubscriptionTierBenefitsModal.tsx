...
// Dependencies: [32, 19, 17, 14672, 17075, 14649, 21, 4380, 712, 9204, 5374, 17091, 4376, 1236, 1435, 17092, 13451, 14676, 38, 17070, 8118, 9207, 17093, 17094, 17087, 14656, 17066, 14671, 17096, 17097, 17106, 14675, 17107, 17079, 2]
// Exports: GuildRoleSubscriptionTierChannelBenefitsModal, GuildRoleSubscriptionTierIntangibleBenefitsModal

// Module 17090 (AddBenefitButton)
...
import useRoleSubscriptionFormatDefault from "useRoleSubscriptionFormat" /* 17066 */;
import HeaderDefault from "Header" /* 17079 */;
import registerAssetDefault from "registerAsset" /* 17091 */;
import EmojiAliasDefault from "EmojiAlias" /* 17092 */;
import itemsDefault from "items" /* 17096 */;
import RowDefault from "Row" /* 17107 */;
import closure_4 from "_slicedToArray" /* 32 */;
import closure_5 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import { AllChannelAccessOptions } from "AllChannelAccessOptions" /* 14672 */;
import { useGroupIsFullGateState } from "usePriceTiers" /* 17075 */;
...
function ListFooterSection(onChangeTrialInterval) {
  ...
  const tmp = callback3();
  const tmp4 = options(13451)();
  const tmp5 = options(14676)(interval);
  ...
  let obj = onChangeTrialInterval(17070);
  ...
  const items1 = [callback(onChangeTrialInterval(8118).FormSwitchRow, obj), ];
  ...
  const items3 = [callback(onChangeTrialInterval(4376).Text, obj2), , , , , , ];
  ...
  items3[4] = callback(options(9207), obj6);
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    type = type.type;
    const obj = { style: callback2(13451)().header, children: null };
    const tmp2 = callback2(13451)();
    ...
    obj[1] = stringResult;
    return tmp3(callback2(9207), obj);
  }
  ...
  roleSubscriptionSettingsDisabled = _require(17070).useRoleSubscriptionSettingsDisabled();
  ...
  obj = {
    ...
    renderItem(item) {
      ...
      if ("roles" in item) {
          ...
          obj = {
            ...
            onDelete() {
              ...
              if (ref_type.ref_type === closure_2_10.CHANNEL) {
                closure_1_8((arr) => arr.filter(/* F122121 */ function() { ... }));
              } else {
                closure_1_10((arr) => arr.filter(/* F122122 */ function() { ... }));
              }
            },
            onSave(ref_type) {
              closure_0 = ref_type;
        ...
        obj2[0] = guildId;
        obj2[1] = item;
        obj[5] = callback4(callback(17106).GuildRoleSubscriptionBenefitPreview, obj2);
        tmp3Result = tmp3(callback2(9204), obj);
        const tmp6 = callback2(9204);
      }
      return tmp3Result;
    },
    keyExtractor: tmp5(14675).getBenefitKey,
    ...
    return closure_12(GuildRoleSubscriptionTierBenefitsModalHeader, {
      ...
      onPress() {
        if (type === constants2.EMOJI) {
          ...
          obj[3] = closure_1_12;
          obj[4] = closure_1_4;
          callback(17097).showEditEmojisModal(obj);
          const obj3 = callback(17097);
        } else {
          if (tmp === tmp2.CHANNEL) {
