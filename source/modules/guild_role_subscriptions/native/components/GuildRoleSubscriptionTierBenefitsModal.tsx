...
// Dependencies: [32, 19, 17, 14824, 17313, 14801, 21, 4478, 712, 9067, 5493, 17329, 4474, 1236, 1431, 17330, 13637, 14828, 38, 17308, 8363, 9905, 17331, 17332, 17325, 14808, 17304, 14823, 17334, 17335, 17344, 14827, 17345, 17317, 2]
// Exports: GuildRoleSubscriptionTierChannelBenefitsModal, GuildRoleSubscriptionTierIntangibleBenefitsModal

// Module 17328 (AddBenefitButton)
...
import useRoleSubscriptionFormatDefault from "useRoleSubscriptionFormat" /* 17304 */;
import HeaderDefault from "Header" /* 17317 */;
import registerAssetDefault from "registerAsset" /* 17329 */;
import EmojiAliasDefault from "EmojiAlias" /* 17330 */;
import itemsDefault from "items" /* 17334 */;
import RowDefault from "Row" /* 17345 */;
import closure_4 from "_slicedToArray" /* 32 */;
import closure_5 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import { AllChannelAccessOptions } from "AllChannelAccessOptions" /* 14824 */;
import { useGroupIsFullGateState } from "usePriceTiers" /* 17313 */;
...
function ListFooterSection(onChangeTrialInterval) {
  ...
  const tmp = callback3();
  const tmp4 = options(13637)();
  const tmp5 = options(14828)(interval);
  ...
  let obj = onChangeTrialInterval(17308);
  ...
  const items1 = [callback(onChangeTrialInterval(8363).FormSwitchRow, obj), ];
  ...
  items3[4] = callback(options(9905), obj6);
  ...
  const tmp2Result1 = options(9905);
  if (null != selectedOption) {
    tmp15 = roleSubscriptionSettingsDisabled;
  }
  obj8[2] = tmp15;
  items3[6] = callback(options(17332), obj8);
  obj1[1] = items3;
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    type = type.type;
    const obj = { style: callback2(13637)().header, children: null };
    const tmp2 = callback2(13637)();
    ...
    obj[1] = stringResult;
    return tmp3(callback2(9905), obj);
  }
  ...
  roleSubscriptionSettingsDisabled = _require(17308).useRoleSubscriptionSettingsDisabled();
  ...
  obj = {
    ...
    renderItem(item) {
      ...
      if ("roles" in item) {
          ...
          obj = {
            ...
            onDelete() {
              ...
              if (ref_type.ref_type === closure_2_10.CHANNEL) {
                closure_1_8((arr) => arr.filter(/* F123109 */ function() { ... }));
              } else {
                closure_1_10((arr) => arr.filter(/* F123110 */ function() { ... }));
              }
            },
            onSave(ref_type) {
              closure_0 = ref_type;
        ...
        obj2[0] = guildId;
        obj2[1] = item;
        obj[5] = callback4(callback(17344).GuildRoleSubscriptionBenefitPreview, obj2);
        tmp3Result = tmp3(callback2(9067), obj);
        const tmp6 = callback2(9067);
      }
      return tmp3Result;
    },
    keyExtractor: tmp5(14827).getBenefitKey,
    ...
    return closure_12(GuildRoleSubscriptionTierBenefitsModalHeader, {
      ...
      onPress() {
        if (type === constants2.EMOJI) {
          ...
          obj[3] = closure_1_12;
          obj[4] = closure_1_4;
          callback(17335).showEditEmojisModal(obj);
          const obj3 = callback(17335);
        } else {
          if (tmp === tmp2.CHANNEL) {
