...
// Function ID: 16936
// Name: MemberPreviews
// Dependencies: [32, 19, 17, 14515, 676, 21, 4342, 712, 4065, 14548, 13313, 16909, 14537, 5793, 16892, 9109, 1236, 16898, 16936, 16901, 2]
// Exports: GuildRoleSubscriptionTierDesignTab, default

// Module 16935 (MemberPreviews)
...
function MemberPreviews(role) {
  ...
  const items1 = [callback2(require(14548) /* GuildRoleSubscriptionMemberPreview */.GuildRoleSubscriptionMemberPreview, { style: items, textStyle: { color: token3 }, role }), ];
  const items2 = [, , ];
  ({ member: arr3[0], memberDark: arr3[1] } = tmp);
  items2[2] = { backgroundColor: token };
  items1[1] = callback2(require(14548) /* GuildRoleSubscriptionMemberPreview */.GuildRoleSubscriptionMemberPreview, { style: items2, textStyle: { color: token2 }, role });
  obj[1] = items1;
...
function Content() {
  ...
  const roleSubscriptionSettingsDisabled = _require(16892).useRoleSubscriptionSettingsDisabled();
  obj = { children: null };
  ...
  obj2[3] = _require(16898).PreviewShape.SQUIRCLE;
  ...
  const tmp4Result = _require(16892);
