...
// Function ID: 16927
// Name: MemberPreviews
// Dependencies: [32, 19, 17, 14506, 676, 21, 4342, 712, 4065, 14539, 13314, 16900, 14528, 5793, 16883, 9109, 1236, 16889, 16927, 16892, 2]
// Exports: GuildRoleSubscriptionTierDesignTab, default

// Module 16926 (MemberPreviews)
...
function Content() {
  ...
  const roleSubscriptionSettingsDisabled = _require(16883).useRoleSubscriptionSettingsDisabled();
  obj = { children: null };
  ...
  obj2[3] = _require(16889).PreviewShape.SQUIRCLE;
  ...
  const tmp4Result = _require(16883);
