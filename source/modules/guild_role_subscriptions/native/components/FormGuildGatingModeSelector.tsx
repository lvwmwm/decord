...
// Dependencies: [31, 27, 33, 4131, 16477, 4472, 1212, 4127, 16479, 10927, 16480, 2]
// Exports: default

// Module 16476 (FormGuildGatingModeSelector)
...
export default function FormGuildGatingModeSelector(isFullServerGating) {
  ...
  let obj = isFullServerGating(16477);
  ...
  const items2 = [callback(onChange(16479), obj), callback(View, { style: tmp.space }), ];
  let obj2 = {};
  let obj1 = { style: tmp.space };
  const tmp5 = onChange(16479);
  obj2.icon = onChange(16480);
  ...
  items2[2] = callback(onChange(16479), obj2);
  obj.children = items2;
