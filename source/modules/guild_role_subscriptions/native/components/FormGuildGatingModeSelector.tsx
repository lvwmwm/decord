...
// Dependencies: [19, 17, 21, 4193, 16587, 4533, 1236, 4189, 16589, 11004, 16590, 2]
// Exports: default
...
export default function FormGuildGatingModeSelector(isFullServerGating) {
  ...
  const tmp = callback3();
  dependencyMap = tmp;
  let obj = isFullServerGating(16587);
  ...
  const items2 = [callback(onChange(16589), obj), callback(View, { style: tmp.space }), ];
  let obj2 = { icon: null, title: null, description: null, selected: null, onPress: null, disabled: null };
  let obj1 = { style: tmp.space };
  const tmp5 = onChange(16589);
  obj2[0] = onChange(16590);
  ...
  items2[2] = callback(onChange(16589), obj2);
  obj[3] = items2;
