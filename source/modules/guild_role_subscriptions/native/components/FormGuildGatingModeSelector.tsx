...
// Dependencies: [19, 17, 21, 4446, 17239, 4823, 1236, 4442, 17241, 11310, 17242, 2]
// Exports: default

// Module 17238 (FormGuildGatingModeSelector)
...
export default function FormGuildGatingModeSelector(isFullServerGating) {
  ...
  const tmp = callback3();
  dependencyMap = tmp;
  let obj = isFullServerGating(17239);
  ...
  obj = { icon: onChange(11310), title: null, description: null, selected: null, onPress: null, disabled: null };
  ...
  const items2 = [callback(onChange(17241), obj), callback(View, { style: tmp.space }), ];
  let obj2 = { icon: null, title: null, description: null, selected: null, onPress: null, disabled: null };
  obj1 = { style: tmp.space };
  const tmp5 = onChange(17241);
  obj2[0] = onChange(17242);
  ...
  items2[2] = callback(onChange(17241), obj2);
  obj[3] = items2;
