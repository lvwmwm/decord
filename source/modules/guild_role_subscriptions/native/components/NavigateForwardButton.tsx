...
// Dependencies: [19, 21, 4255, 712, 4797, 4251, 1297, 14333, 2]
// Exports: default

// Module 14332 (NavigateForwardButton)
import "noop";
...
export default function NavigateForwardButton(arg0) {
  ...
  obj = { source: null };
  obj[0] = importDefault(14333);
  items[1] = callback(require(1297) /* Button */.Icon, obj);
  obj[2] = items;
  return callback2(require(4797) /* PressableBase */.PressableHighlight, obj);
};
