...
// Function ID: 16101
// Name: emphasisHook
// Dependencies: [5, 32, 19, 17, 1981, 4085, 676, 1394, 21, 14790, 589, 8189, 4444, 4826, 1236, 7614, 4045, 1297, 16094, 4415, 16101, 2009, 16090, 4975, 4896, 9100, 2]
// Exports: default

// Module 16100 (emphasisHook)
...
import closure_9 from "makeGroupListingIndexSubscriptionListingTag" /* 4085 */;
...
function SwitchTiersButton(activeSubscription) {
  ...
  let obj = changeToListingId(14790);
  obj1 = activeListingId(4045)(activeSubscription.currentPeriodEnd);
  obj = { children: null };
  ...
  const items = [callback3(activeSubscription(4444).Text, obj), callback3(activeSubscription(1297).Spacer, { size: 16 }), ];
  ...
  items[2] = callback3(activeSubscription(16094).ArrowButton, obj2);
  obj[0] = items;
