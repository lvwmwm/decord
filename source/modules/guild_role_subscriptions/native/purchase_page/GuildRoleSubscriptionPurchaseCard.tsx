...
// Dependencies: [32, 19, 17, 21, 4285, 712, 1609, 14375, 15549, 5377, 4281, 1297, 15555, 5379, 1236, 14385, 2]
// Exports: default

// Module 15554 (GuildRoleSubscriptionPurchaseCard)
...
export default function GuildRoleSubscriptionPurchaseCard(guildId) {
  ...
  let obj2 = require(15549) /* TruncatedText */;
  ...
  obj2[1] = items;
  const items1 = [callback3(View, obj2), callback2(require(1297) /* Button */.Spacer, { size: 16 }), callback2(require(15549) /* TruncatedText */.TruncatedText, { variant: "text-sm/normal", color: "text-default", lineClamp: 2, children: callback(obj.useDescription(listingId), 1)[0] }), callback2(require(1297) /* Button */.Spacer, { size: 24 }), callback2(importDefault(15555), { listingId })];
  obj1[1] = items1;
  ...
  const items3 = [callback2(require(4281) /* Text */.Text, obj7), callback2(require(1297) /* Button */.Spacer, { size: 24 }), callback2(require(14385) /* SectionTitle */.Content, { listingId, guildId: guildId.guildId })];
  obj5[3] = items3;
  items2[2] = callback3(require(5379) /* BottomSheetModal */.BottomSheetScrollView, obj5);
  obj[1] = items2;
