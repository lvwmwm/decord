...
// Dependencies: [32, 19, 17, 21, 4342, 712, 1628, 14528, 15729, 5437, 4338, 1297, 15735, 5439, 1236, 14538, 2]
// Exports: default
...
export default function GuildRoleSubscriptionPurchaseCard(guildId) {
  ...
  const items3 = [callback2(require(4338) /* Text */.Text, obj7), callback2(require(1297) /* Button */.Spacer, { size: 24 }), callback2(require(14538) /* SectionTitle */.Content, { listingId, guildId: guildId.guildId })];
  obj5[3] = items3;
