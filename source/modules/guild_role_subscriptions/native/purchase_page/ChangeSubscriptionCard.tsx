...
// Function ID: 15413
// Name: emphasisHook
// Dependencies: [32, 19, 17, 676, 21, 4189, 712, 4185, 1581, 14240, 3771, 5243, 1236, 1297, 15405, 4395, 15413, 1959, 4157, 2]
// Exports: default

// Module 15412 (emphasisHook)
...
export default function ChangeSubscriptionCard(activeSubscription) {
  ...
  if (activeSubscription.status !== SubscriptionStatusTypes.CANCELED) {
    ...
    items3[1] = tmp5(tmp6(15405).ArrowButton, obj6);
    obj5[0] = items3;
