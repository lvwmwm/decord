...
// Function ID: 15581
// Name: emphasisHook
// Dependencies: [32, 19, 17, 676, 21, 4302, 712, 4298, 1609, 14391, 3883, 5396, 1236, 1297, 15573, 4507, 15581, 1988, 4270, 2]
// Exports: default

// Module 15580 (emphasisHook)
...
function emphasisHook(children) {
  return callback2(require(4298) /* Text */.Text, { variant: "text-sm/medium", color: "text-default", children });
}
...
export default function ChangeSubscriptionCard(activeSubscription) {
  ...
  let obj2 = importDefault(3883)(activeSubscription.currentPeriodEnd);
