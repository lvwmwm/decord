...
// Function ID: 15557
// Name: emphasisHook
// Dependencies: [32, 19, 17, 676, 21, 4285, 712, 4281, 1609, 14375, 3866, 5377, 1236, 1297, 15549, 4490, 15557, 1988, 4253, 2]
// Exports: default

// Module 15556 (emphasisHook)
...
export default function ChangeSubscriptionCard(activeSubscription) {
  ...
  let obj2 = importDefault(3866)(activeSubscription.currentPeriodEnd);
