...
// Function ID: 15419
// Name: emphasisHook
// Dependencies: [32, 19, 17, 676, 21, 4189, 712, 4185, 1581, 14244, 3771, 5243, 1236, 1297, 15411, 4395, 15419, 1959, 4157, 2]
// Exports: default

// Module 15418 (emphasisHook)
...
function emphasisHook(children) {
  return callback2(require(4185) /* Text */.Text, { variant: "text-sm/medium", color: "text-default", children });
}
...
export default function ChangeSubscriptionCard(activeSubscription) {
  ...
  let obj2 = importDefault(3771)(activeSubscription.currentPeriodEnd);
  ...
  const items1 = [callback2(activeSubscription(4185).Text, obj1), callback2(activeSubscription(1297).Spacer, { size: 16 }), , ];
  ...
  obj2[2] = items2;
  items1[2] = callback3(activeSubscription(4185).Text, obj2);
  let tmp7Result = null;
  if (activeSubscription.status !== SubscriptionStatusTypes.CANCELED) {
    ...
    items3[1] = tmp5(tmp6(15411).ArrowButton, obj6);
    obj5[0] = items3;
  ...
  items1[3] = tmp7Result;
  obj[1] = items1;
  return callback2(activeSubscription(5243).BottomSheet, { startExpanded: true, children: callback3(tmp8, obj) });
};
