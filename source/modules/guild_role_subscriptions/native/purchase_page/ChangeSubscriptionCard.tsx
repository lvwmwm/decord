...
// Function ID: 15681
// Name: emphasisHook
// Dependencies: [32, 19, 17, 676, 21, 4303, 712, 4299, 1628, 14471, 3902, 5397, 1236, 1297, 15673, 4509, 15681, 2007, 4271, 2]
// Exports: default

// Module 15680 (emphasisHook)
...
function emphasisHook(children) {
  return callback2(require(4299) /* Text */.Text, { variant: "text-sm/medium", color: "text-default", children });
}
...
export default function ChangeSubscriptionCard(activeSubscription) {
  ...
  let obj2 = importDefault(3902)(activeSubscription.currentPeriodEnd);
