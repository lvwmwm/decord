...
// Function ID: 15737
// Name: emphasisHook
// Dependencies: [32, 19, 17, 676, 21, 4344, 712, 4340, 1628, 14528, 3943, 5436, 1236, 1297, 15729, 4549, 15737, 2007, 4312, 2]
// Exports: default

// Module 15736 (emphasisHook)
...
function emphasisHook(children) {
  return callback2(require(4340) /* Text */.Text, { variant: "text-sm/medium", color: "text-default", children });
}
