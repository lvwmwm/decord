...
// Function ID: 15653
// Name: ContentHeader
// Dependencies: [32, 19, 17, 1372, 21, 4303, 712, 4299, 4271, 15653, 1988, 8754, 14474, 1297, 589, 4494, 1236, 4764, 14461, 15648, 5268, 15654, 2]
// Exports: default

// Module 15652 (ContentHeader)
...
function EmojiGallery(arg0) {
  ...
  obj[1] = closure_8(require(8754) /* GappedList */.GappedList, { gap: 18, children: items });
...
export default function GuildRoleSubscriptionPurchasePreviewCard(listingId) {
  ...
  obj[1] = items;
  const items2 = [closure_9(closure_6, obj), closure_8(listingId(1297).Spacer, { size: 16 }), closure_8(guildId(15654), { listingId }), ];
  ...
  if (tmp8Result2) {
    ...
    obj4[1] = items6;
    obj3[1] = tmp8(tmp4(8754).GappedList, obj4);
