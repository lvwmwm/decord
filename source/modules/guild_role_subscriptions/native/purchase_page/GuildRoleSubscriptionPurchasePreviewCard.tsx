...
// Function ID: 15505
// Name: ContentHeader
// Dependencies: [32, 19, 17, 1372, 21, 4255, 712, 4251, 4223, 15505, 1959, 9587, 14343, 1297, 589, 4446, 1236, 4716, 14330, 15500, 5207, 15506, 2]
// Exports: default

// Module 15504 (ContentHeader)
...
function EmojiGallery(arg0) {
  ...
  obj[1] = closure_8(require(9587) /* GappedList */.GappedList, { gap: 18, children: items });
...
function ChannelBenefitShowCase(description) {
  ...
  if (null != stateFromStores) {
    ...
    obj[1] = tmp(4716).getChannelIcon(stateFromStores);
...
export default function GuildRoleSubscriptionPurchasePreviewCard(listingId) {
  ...
  const items = [closure_8(guildId(5207), obj1), closure_8(listingId(1297).Spacer, { size: 16 }), ];
  obj2 = { children: null };
  ...
  obj[1] = items;
  const items2 = [closure_9(closure_6, obj), closure_8(listingId(1297).Spacer, { size: 16 }), closure_8(guildId(15506), { listingId }), ];
  ...
  if (tmp8Result2) {
    ...
    obj4[1] = items6;
    obj3[1] = tmp8(tmp4(9587).GappedList, obj4);
