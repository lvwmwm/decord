...
// Function ID: 15578
// Name: ContentHeader
// Dependencies: [32, 19, 17, 1372, 21, 4302, 712, 4298, 4270, 15578, 1988, 8694, 14404, 1297, 589, 4492, 1236, 4762, 14391, 15573, 5267, 15579, 2]
// Exports: default

// Module 15577 (ContentHeader)
...
function ContentHeader(arg0) {
  ...
  const items = [callback2(require(4298) /* Text */.Text, obj), " ", title];
  obj[3] = items;
...
function EmojiGallery(arg0) {
  ...
  obj[1] = closure_8(require(8694) /* GappedList */.GappedList, { gap: 18, children: items });
...
function BenefitShowCase(arg0) {
  ...
  if (typeof title === "string") {
    ...
    obj[2] = title;
    tmp3 = callback2(require(4298) /* Text */.Text, obj);
  }
  const children = [tmp3, ];
  ...
  if (tmpResult) {
    ...
    obj[2] = description;
    items1[1] = callback2(require(4298) /* Text */.Text, obj);
    obj[0] = items1;
...
function ChannelBenefitShowCase(description) {
  ...
  if (null != stateFromStores) {
    ...
    obj[1] = tmp(4762).getChannelIcon(stateFromStores);
    ...
    obj1[2] = tmp4;
    items2[2] = callback2(tmp(4298).Text, obj1);
    obj[1] = items2;
...
function ShowAllButton(onPress) {
  ...
  const items = [callback2(require(4298) /* Text */.Text, obj), callback2(require(1297) /* Button */.Spacer, { size: 3 }), callback2(closure_6, { style: tmp.showAllButtonUnderline })];
  obj[0] = items;
...
export default function GuildRoleSubscriptionPurchasePreviewCard(listingId) {
  ...
  const items = [closure_8(guildId(5267), obj1), closure_8(listingId(1297).Spacer, { size: 16 }), ];
  obj2 = { children: null };
  const items1 = [closure_8(listingId(4298).Text, { variant: "heading-md/semibold", color: "mobile-text-heading-primary", children: callback(obj1.useName(listingId), 1)[0] }), closure_8(listingId(1297).Spacer, { size: 4 }), closure_8(listingId(4298).Text, { variant: "heading-md/medium", color: "text-default", children: formattedSubscriptionPlan })];
  obj2[0] = items1;
  items[2] = closure_9(closure_6, obj2);
  obj[1] = items;
  const items2 = [closure_9(closure_6, obj), closure_8(listingId(1297).Spacer, { size: 16 }), closure_8(guildId(15579), { listingId }), ];
  ...
  if (tmp8Result2) {
    ...
    obj4[1] = items6;
    obj3[1] = tmp8(tmp4(8694).GappedList, obj4);
