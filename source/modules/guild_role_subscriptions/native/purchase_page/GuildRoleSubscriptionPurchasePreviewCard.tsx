...
// Function ID: 16065
// Name: ContentHeader
// Dependencies: [32, 19, 17, 1391, 21, 4446, 712, 4442, 4413, 16065, 2010, 9129, 14769, 1297, 589, 4640, 1236, 4946, 14756, 16060, 5458, 16066, 2]
// Exports: default

// Module 16064 (ContentHeader)
...
function ChannelBenefitShowCase(description) {
  ...
  if (null != stateFromStores) {
    ...
    obj[1] = tmp(4946).getChannelIcon(stateFromStores);
    ...
    obj1[2] = tmp4;
    items2[2] = callback2(tmp(4442).Text, obj1);
    obj[1] = items2;
...
export default function GuildRoleSubscriptionPurchasePreviewCard(listingId) {
  ...
  const items = [closure_8(guildId(5458), obj1), closure_8(listingId(1297).Spacer, { size: 16 }), ];
  obj2 = { children: null };
  const items1 = [closure_8(listingId(4442).Text, { variant: "heading-md/semibold", color: "mobile-text-heading-primary", children: callback(obj1.useName(listingId), 1)[0] }), closure_8(listingId(1297).Spacer, { size: 4 }), closure_8(listingId(4442).Text, { variant: "heading-md/medium", color: "text-default", children: formattedSubscriptionPlan })];
  obj2[0] = items1;
  items[2] = closure_9(closure_6, obj2);
  obj[1] = items;
  const items2 = [closure_9(closure_6, obj), closure_8(listingId(1297).Spacer, { size: 16 }), closure_8(guildId(16066), { listingId }), ];
  ...
  if (tmp8Result2) {
    ...
    obj4[1] = items6;
    obj3[1] = tmp8(tmp4(9129).GappedList, obj4);
