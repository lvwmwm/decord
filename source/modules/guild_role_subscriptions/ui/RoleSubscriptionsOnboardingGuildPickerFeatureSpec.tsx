// Module ID: 13024
// Function ID: 13025
// Dependencies: [4103, 1415, 1236, 589, 12616, 12617, 3810, 2]
  ...
  useIsGuildSupported() {
    ...
    return require(589) /* initialize */.useStateFromStores(items, () => (id) => {
      ...
      if (result) {
        ...
        obj[0] = id;
        obj[3] = callback(12617).isUserInCreatorMonetizationEligibleCountry();
        const obj3 = callback(12617);
