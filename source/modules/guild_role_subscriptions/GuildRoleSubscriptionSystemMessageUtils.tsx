...
// Function ID: 7774
// Name: identityHook
// Dependencies: [1862, 1874, 7774, 676, 11, 1236, 7775, 4384, 2]
...
export const isEligibleForRoleSubscriptionPurchaseSystemMessageSettings = function isEligibleForRoleSubscriptionPurchaseSystemMessageSettings(guild) {
  return require(7775) /* useIsCreatorMonetizationEnabledGuild */.isCreatorMonetizationEnabledGuild(guild);
};
