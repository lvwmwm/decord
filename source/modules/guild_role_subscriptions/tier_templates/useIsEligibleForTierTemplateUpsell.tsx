...
// Dependencies: [1910, 676, 589, 13309, 5921, 2]
// Exports: default
...
export default function useIsEligibleForTierTemplateUpsell(guildId) {
  ...
  const tmp = _require;
  let hasItem;
  const guildEligibleForTierTemplates = _require(13309).useGuildEligibleForTierTemplates(guildId);
