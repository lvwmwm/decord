...
// Dependencies: [5, 31, 1348, 3787, 14223, 14229, 653, 1355, 4405, 624, 1360, 686, 8251, 12600, 13008, 2]
...
// Module 14228 (_createForOfIteratorHelperLoose)
...
export const isEligibleForNewBadge = function isEligibleForNewBadge(features) {
  let result = require(12600) /* canSeeGuildRoleSubscriptionSettingsContent */.canManageGuildRoleSubscriptions(features);
  if (result) {
    features = features.features;
    result = features.has(GuildFeatures.ROLE_SUBSCRIPTIONS_ENABLED);
  }
  if (result) {
    result = require(13008) /* GuildFeatures */.isGuildEligibleForTierTemplates(features.id);
    const obj2 = require(13008) /* GuildFeatures */;
  }
  return result;
};
