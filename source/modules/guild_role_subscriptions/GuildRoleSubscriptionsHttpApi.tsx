...
// Dependencies: [5, 676, 505, 530, 4184, 2]
...
// Module 5785 (_updateGuildRoleSubscriptionGroupListing)
import set from "set";
      ...
      if (c8 === 2) {
        ...
        try {
          ...
          if (0 === c7) {
            ...
            c6 = 0;
            closure_4 = closure_5;
            const aPIError = new callback(4184).APIError(closure_4);
            throw aPIError;
          } else if (arg0 === 1) {
            c8 = 3;
            throw body;
      ...
      if (c9 === 2) {
        ...
        try {
          ...
          if (0 === c8) {
            ...
            c7 = 0;
            closure_5 = closure_6;
            const aPIError = new callback(4184).APIError(closure_5);
            throw aPIError;
          } else if (arg0 === 1) {
            c9 = 3;
            throw body;
