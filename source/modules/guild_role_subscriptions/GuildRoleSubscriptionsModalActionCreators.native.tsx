...
// Dependencies: [16733, 4490, 16734, 1988, 16740, 2]
// Exports: showCreateBenefitModal, showEditBenefitModal, showEditEmojisModal

// Module 16732 (showCreateBenefitModal)
...
export const showCreateBenefitModal = function showCreateBenefitModal(arg0) {
  ...
  importDefault(4490).pushLazy(require(1988) /* asyncRequireImpl */(16734, dependencyMap.paths), { benefitType: type, guildId, onSave, listingId }, GuildRoleSubscriptionBenefitEditorModal);
};
export const showEditBenefitModal = function showEditBenefitModal(benefit) {
  ...
  obj.pushLazy(require(1988) /* asyncRequireImpl */(16734, dependencyMap.paths), obj, GuildRoleSubscriptionBenefitEditorModal);
};
export const showEditEmojisModal = function showEditEmojisModal(initialTierEmojiIds) {
  ...
  obj[3] = listingId;
  obj[4] = onSave;
  obj.pushLazy(require(1988) /* asyncRequireImpl */(16740, dependencyMap.paths), obj, "GuildRoleSubscriptionEmojiEditorModal");
};
