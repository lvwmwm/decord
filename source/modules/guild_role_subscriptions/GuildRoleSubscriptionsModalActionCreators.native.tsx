...
// Dependencies: [16693, 4460, 16694, 1959, 16700, 2]
// Exports: showCreateBenefitModal, showEditBenefitModal, showEditEmojisModal

// Module 16692 (showCreateBenefitModal)
...
export const showCreateBenefitModal = function showCreateBenefitModal(arg0) {
  ...
  importDefault(4460).pushLazy(require(1959) /* asyncRequireImpl */(16694, dependencyMap.paths), { benefitType: type, guildId, onSave, listingId }, GuildRoleSubscriptionBenefitEditorModal);
};
export const showEditBenefitModal = function showEditBenefitModal(benefit) {
  ...
  obj.pushLazy(require(1959) /* asyncRequireImpl */(16694, dependencyMap.paths), obj, GuildRoleSubscriptionBenefitEditorModal);
};
export const showEditEmojisModal = function showEditEmojisModal(initialTierEmojiIds) {
  ...
  obj[3] = listingId;
  obj[4] = onSave;
  obj.pushLazy(require(1959) /* asyncRequireImpl */(16700, dependencyMap.paths), obj, "GuildRoleSubscriptionEmojiEditorModal");
};
