...
// Module 9177 (UserRequiredActions)
let EMAIL;
let PHONE;
let REVERIFY_EMAIL;
let REVERIFY_PHONE;
const _module = require(dependencyMap[0]);
const UserRequiredActions = _module.UserRequiredActions;
const VerificationTypes = _module.VerificationTypes;
...
const result = _module1.fileFinishedImporting("modules/verification/VerificationUtils.tsx");
...
export default {
  ...
  getButtonTitle(arg0) {
    if (VerificationTypes.EMAIL === arg0) {
      ...
      return intl5.string(require(dependencyMap[1]).t.1MPz27);
    } else if (VerificationTypes.PHONE === arg0) {
      const intl4 = require(dependencyMap[1]).intl;
      return intl4.string(require(dependencyMap[1]).t.mjJeco);
    } else if (VerificationTypes.REVERIFY_EMAIL === arg0) {
      const intl3 = require(dependencyMap[1]).intl;
      return intl3.string(require(dependencyMap[1]).t.nmdPFX);
    } else if (VerificationTypes.REVERIFY_PHONE === arg0) {
      const intl2 = require(dependencyMap[1]).intl;
      return intl2.string(require(dependencyMap[1]).t.of2125);
    } else {
      const intl = require(dependencyMap[1]).intl;
      return intl.string(require(dependencyMap[1]).t.oF6+Ww);
    }
  },
  areVerificationTypesEqual(arg0, arg1) {
    return importDefault(dependencyMap[2]).isEqual(arg0, arg1);
  }
};
