...
// Dependencies: [19, 17, 1903, 8395, 676, 21, 4302, 712, 1480, 589, 698, 691, 5967, 4298, 1236, 4712, 8391, 2]
// Exports: default

// Module 8397 (ChangeEmailWarning)
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    obj[0] = tmp.container;
    const items2 = [callback(tmp2(5967).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = callback(tmp2(4298).Text, obj1);
    ...
    obj2[4] = items3;
    items2[2] = callback2(tmp2(4298).Text, obj2);
    ...
    obj5[3] = tmp6;
    const items4 = [callback(tmp2(4712).Button, obj5), ];
    ...
    items4[1] = callback(tmp2(4712).Button, obj6);
    obj4[1] = items4;
