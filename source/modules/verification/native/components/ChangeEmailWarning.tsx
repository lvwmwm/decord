...
// Dependencies: [19, 17, 1922, 7624, 676, 21, 4445, 712, 1500, 589, 698, 691, 6208, 4441, 1236, 4880, 7620, 2]
// Exports: default

// Module 7629 (ChangeEmailWarning)
import ThemesDefault from "Themes" /* 712 */;
import closure_3 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import closure_6 from "mergeGuildAvatar" /* 1922 */;
import { COMMON_SCAMS_EDUCATION_HC_ARTICLE as closure_7 } from "ChangeEmailReasons" /* 7624 */;
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    obj[0] = tmp.container;
    const items2 = [callback(tmp2(6208).TrafficConeSpotIllustration, {}), , , ];
    ...
    obj2[4] = items3;
    items2[2] = callback2(tmp2(4441).Text, obj2);
    ...
    obj5[3] = tmp6;
    const items4 = [callback(tmp2(4880).Button, obj5), ];
    ...
    items4[1] = callback(tmp2(4880).Button, obj6);
    obj4[1] = items4;
