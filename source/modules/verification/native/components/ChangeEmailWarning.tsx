...
// Dependencies: [19, 17, 1922, 8500, 676, 21, 4344, 712, 1499, 589, 698, 691, 6068, 4340, 1236, 4754, 8496, 2]
// Exports: default

// Module 8502 (ChangeEmailWarning)
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    obj[0] = tmp.container;
    const items2 = [callback(tmp2(6068).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = callback(tmp2(4340).Text, obj1);
    ...
    obj2[4] = items3;
    items2[2] = callback2(tmp2(4340).Text, obj2);
    ...
    obj5[3] = tmp6;
    const items4 = [callback(tmp2(4754).Button, obj5), ];
    ...
    items4[1] = callback(tmp2(4754).Button, obj6);
    obj4[1] = items4;
