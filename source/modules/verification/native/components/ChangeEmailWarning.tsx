...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    items2[1] = callback(tmp2(4299).Text, obj1);
    ...
    obj2[4] = items3;
    items2[2] = callback2(tmp2(4299).Text, obj2);
    ...
    obj5[3] = tmp6;
    const items4 = [callback(tmp2(4714).Button, obj5), ];
    ...
    items4[1] = callback(tmp2(4714).Button, obj6);
    obj4[1] = items4;
