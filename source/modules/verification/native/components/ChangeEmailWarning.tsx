...
// Dependencies: [19, 17, 1874, 9363, 676, 21, 4255, 712, 1480, 589, 698, 691, 5926, 4251, 1236, 4666, 9359, 2]
// Exports: default

// Module 9365 (ChangeEmailWarning)
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    obj[0] = tmp.container;
    const items2 = [callback(tmp2(5926).TrafficConeSpotIllustration, {}), , , ];
    ...
    obj5[3] = tmp6;
    const items4 = [callback(tmp2(4666).Button, obj5), ];
    ...
    items4[1] = callback(tmp2(4666).Button, obj6);
    obj4[1] = items4;
