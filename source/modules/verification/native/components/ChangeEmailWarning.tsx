...
// Dependencies: [19, 17, 1922, 8504, 676, 21, 4342, 712, 1499, 589, 698, 691, 6070, 4338, 1236, 4755, 8500, 2]
// Exports: default

// Module 8506 (ChangeEmailWarning)
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    items2[1] = callback(tmp2(4338).Text, obj1);
    ...
    obj2[4] = items3;
    items2[2] = callback2(tmp2(4338).Text, obj2);
