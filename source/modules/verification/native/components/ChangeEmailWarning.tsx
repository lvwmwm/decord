...
// Dependencies: [19, 17, 1874, 8266, 676, 21, 4285, 712, 1480, 589, 698, 691, 5936, 4281, 1236, 4695, 8262, 2]
// Exports: default

// Module 8268 (ChangeEmailWarning)
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    obj[0] = tmp.container;
    const items2 = [callback(tmp2(5936).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = callback(tmp2(4281).Text, obj1);
    ...
    obj2[4] = items3;
    items2[2] = callback2(tmp2(4281).Text, obj2);
    ...
    obj5[3] = tmp6;
    const items4 = [callback(tmp2(4695).Button, obj5), ];
    ...
    items4[1] = callback(tmp2(4695).Button, obj6);
    obj4[1] = items4;
