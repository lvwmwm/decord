...
// Function ID: 71803
// Name: ResendEmail
// Dependencies: [57, 31, 27, 1342, 1850, 653, 33, 4165, 1456, 566, 44, 9161, 9153, 6763, 4161, 1212, 4578, 5623, 3866, 2]
// Exports: default

// Module 9160 (ResendEmail)
...
export default function ResendEmail() {
  ...
  const items4 = [callback2(navigation(6763).EnvelopeOpenSpotIllustration, { scale: 0.75 }), , , , ];
  ...
  items4[1] = callback2(navigation(4161).Text, obj);
  ...
  items4[2] = callback2(navigation(4161).Text, obj1);
  ...
  obj4.grow = true;
  obj3.children = callback2(navigation(4578).Button, obj4);
  ...
  if (tmp5) {
    ...
    obj6.grow = true;
    obj5.children = callback2(navigation(4578).Button, obj6);
