...
// Dependencies: [5, 19, 676, 8457, 21, 5269, 8458, 8459, 4507, 503, 8485, 8453, 5723, 1236, 2]
// Exports: default

// Module 8456 (PhoneVerificationModal)
...
export default function PhoneVerificationModal(onClose) {
  ...
  obj[0] = _require(5269).getHeaderNoTitle();
  const obj4 = _require(5269);
  obj[1] = _require(5269).getHeaderCloseButton(onClose.onClose);
  ...
  const obj5 = _require(5269);
  obj1[0] = _require(5269).getHeaderNoTitle();
  ...
  const obj7 = _require(5269);
  obj2[0] = _require(5269).getHeaderNoTitle();
  ...
  return jsx(_require(5723).Navigator, { headerTitle: null, headerLeft: null, render: null });
};
