...
// Dependencies: [5, 19, 676, 9233, 21, 5143, 9234, 9235, 4395, 503, 9259, 9229, 5570, 1236, 2]
// Exports: default

// Module 9232 (PhoneVerificationModal)
...
export default function PhoneVerificationModal(onClose) {
  ...
  obj[0] = _require(5143).getHeaderNoTitle();
  const obj4 = _require(5143);
  obj[1] = _require(5143).getHeaderCloseButton(onClose.onClose);
  ...
  const obj5 = _require(5143);
  obj1[0] = _require(5143).getHeaderNoTitle();
  ...
  const obj7 = _require(5143);
  obj2[0] = _require(5143).getHeaderNoTitle();
  ...
  return jsx(_require(5570).Navigator, { headerTitle: null, headerLeft: null, render: null });
};
