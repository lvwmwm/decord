...
// Dependencies: [5, 19, 676, 8440, 21, 5253, 8441, 8442, 4490, 503, 8468, 8436, 5704, 1236, 2]
// Exports: default

// Module 8439 (PhoneVerificationModal)
...
export default function PhoneVerificationModal(onClose) {
  ...
  obj[0] = _require(5253).getHeaderNoTitle();
  const obj4 = _require(5253);
  obj[1] = _require(5253).getHeaderCloseButton(onClose.onClose);
  ...
  const obj5 = _require(5253);
  obj1[0] = _require(5253).getHeaderNoTitle();
  ...
  const obj7 = _require(5253);
  obj2[0] = _require(5253).getHeaderNoTitle();
  ...
  return jsx(_require(5704).Navigator, { headerTitle: null, headerLeft: null, render: null });
};
