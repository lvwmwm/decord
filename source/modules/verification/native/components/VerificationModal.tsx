...
// Dependencies: [5, 19, 17, 17429, 1380, 1921, 673, 21, 4481, 1296, 17430, 1233, 4936, 1499, 500, 5579, 7315, 9729, 7135, 6534, 17434, 6532, 6544, 6541, 6922, 6984, 6985, 6533, 17435, 7018, 6933, 586, 4448, 4343, 6940, 2]
// Exports: default

// Module 17428 (PhoneThenEmailInterstitial)
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_6 from "getCountrySelectorOpened" /* 17429 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  let obj = { Illustration: navigation(17430).VerifyPhone, title: null, body: null, children: null };
  ...
  obj[1] = jsx(navigation(4936).Button, { text: null, onPress: null });
...
export default function VerificationModal() {
  ...
  const effect = React.useEffect(() => {
    ...
    stateFromStores(4343).dismissKeyboard();
  }, []);
  obj = {
    screens: React.useMemo(() => {
      ...
      obj3[6] = function render() {
        return callback3(callback2(17434), {});
      };
      ...
      obj5[1] = obj6;
      let obj12 = stateFromStores(5579);
      obj5[2] = obj12.getHeaderNoTitle();
      obj5[3] = function render() {
        return callback3(callback2(6532), {});
      };
      ...
      let obj15 = stateFromStores(5579);
      ...
      let obj18 = stateFromStores(5579);
      obj9[2] = obj18.getHeaderNoTitle();
      obj9[3] = function render() {
        return callback3(callback2(6544), { isChangeEmail: false });
      };
      ...
      obj11[1] = obj12;
      let obj21 = stateFromStores(5579);
      obj11[2] = obj21.getHeaderNoTitle();
      obj11[3] = function render() {
        return callback3(callback2(6541), {});
      };
      ...
      obj13[2] = stateFromStores(5579).getHeaderNoTitle();
      obj13[3] = function render() {
        return callback3(callback2(6922), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5579);
      ...
      obj15[2] = stateFromStores(5579).getHeaderNoTitle();
      obj15[3] = function render(arg0, arg1) {
        let callback = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = callback(6985).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return arr.push(closure_1_10.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F125639 */ function() { ... });
              obj[1] = () => { ... };
              closure_1 = closure_1_3(/* F125641 */ function() { ... });
              obj[2] = () => { ... };
              arr = arr.push(closure_1_10.VERIFY_PASSWORD, obj);
            }
          });
        };
        return callback3(callback2(6984), obj);
      };
      ...
      obj17[1] = obj18;
      const obj28 = stateFromStores(5579);
      obj17[2] = stateFromStores(5579).getHeaderNoTitle();
      obj17[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(7018), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5579);
      ...
      obj19[2] = stateFromStores(5579).getHeaderNoTitle();
      obj19[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(6933), {});
      };
      ...
      const obj34 = stateFromStores(5579);
      ...
      obj21[2] = stateFromStores(5579).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(6940).Navigator, {
    screens: React.useMemo(() => {
      let obj = {};
      obj = { impressionName: stateFromStores(500).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: null, headerTitle: null, render: null };
      obj = { impression_group: stateFromStores(500).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
