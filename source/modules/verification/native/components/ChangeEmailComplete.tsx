...
// Function ID: 8561
// Name: handlePress
// Dependencies: [19, 17, 8498, 21, 4344, 712, 8496, 8507, 4340, 1236, 4754, 2]
// Exports: default

// Module 8560 (handlePress)
import "noop";
...
export default function ChangeEmailComplete(email) {
  ...
  obj = { style: tmp.image, source: importDefault(8507) };
  ...
  obj4[1] = handlePress;
  items[3] = callback(require(4754) /* Button */.Button, obj4);
  obj[3] = items;
