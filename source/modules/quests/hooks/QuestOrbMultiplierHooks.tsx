...
// Dependencies: [1922, 589, 10485, 3966, 2]
// Exports: useQuestOrbMultiplierEligibility

// Module 10484 (getQuestOrbMultiplierEligibilityForUser)
...
function getQuestOrbMultiplierEligibilityForUser(isFractionalPremiumWithNoStandardSub) {
  if (null == isFractionalPremiumWithNoStandardSub) {
    let INELIGIBLE = require(10485) /* items */.QuestOrbMultiplierEligibilityType.INELIGIBLE;
  } else {
    let QuestOrbMultiplierEligibilityType2 = dependencyMap;
    if (obj2.canUseMoreQuestOrbs(isFractionalPremiumWithNoStandardSub)) {
      const questOrbMultiplierSource = require(10485) /* items */.getQuestOrbMultiplierSource(isFractionalPremiumWithNoStandardSub);
      if (questOrbMultiplierSource === require(10485) /* items */.QuestOrbMultiplierSource.CREPE) {
      ...
      const QuestOrbMultiplierEligibilityType = require(10485) /* items */.QuestOrbMultiplierEligibilityType;
