...
// Dependencies: [5, 32, 19, 1946, 1874, 5113, 676, 1876, 1236, 10346, 7075, 7077, 10363, 1945, 11060, 1897, 589, 11061, 9161, 9172, 5116, 10368, 1851, 10503, 10474, 10377, 7081, 7080, 2]
...
// Module 11059 (_getQuestsInstructionsToWinReward)
...
function useQuestsInstructionsToWinReward(arg0) {
  ...
  const thirdPartyTaskDetails = require(10346) /* useQuests */.useThirdPartyTaskDetails(quest);
  const obj2 = require(10346) /* useQuests */;
  const tmp = undefined !== withoutMarkdown && withoutMarkdown;
  const tmp2 = require;
  const inGameQuestConnectState = require(11061) /* useInGameQuestConnectState */.useInGameQuestConnectState(quest);
  const obj3 = require(11061) /* useInGameQuestConnectState */;
  const result = require(7077) /* getApplicationIdsByTaskTypes */.hasAchievementInGameTask(quest);
  const obj5 = require(7077) /* getApplicationIdsByTaskTypes */;
  if (result) {
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(config, arg1, questContent, sourceQuestContent) {
  ...
  let obj4 = require(7075) /* isSponsoredPlayQuest */;
  const isSponsoredPlayQuestResult = obj4.isSponsoredPlayQuest(config);
  let obj5 = require(7077) /* getApplicationIdsByTaskTypes */;
...
export const useQuestDescription = function useQuestDescription(quest, sourceQuestContent, QUEST_HOME_MOBILE, QuestHome) {
  ...
  obj[1] = require(10346) /* useQuests */.useQuestTaskDetails(quest);
...
export const useQuestBarSubtitle = function useQuestBarSubtitle(arg0) {
  ...
  obj[7] = require(9172) /* GameProfileEmbedAction */.GameProfileSources.QuestBar;
  if (tmp8) {
...
export const useQuestBarTitle = function useQuestBarTitle(questCreative) {
  ...
  const questTaskDetails = require(10346) /* useQuests */.useQuestTaskDetails(questCreative);
  const obj2 = require(10346) /* useQuests */;
  const obj3 = require(10346) /* useQuests */;
  const thirdPartyTaskDetails = require(10346) /* useQuests */.useThirdPartyTaskDetails(questCreative);
  ...
  const obj4 = require(10346) /* useQuests */;
};
  ...
  if (constants3.PLAY === memo) {
    ...
    if (hasItem) {
      ...
      if (!tmp20Result) {
        ...
        tmp20Result = importDefault(10503)(supported_platforms);
        const tmp20 = importDefault(10503);
      }
      hasItem = tmp20Result;
    }
    if (hasItem) {
    ...
    if (tmp2Result1.canLaunchActivity(quest)) {
      ...
      if (hasItem1) {
        ...
        if (!tmp12Result) {
          ...
          tmp12Result = importDefault(10503)(supported_platforms1);
          const tmp12 = importDefault(10503);
        }
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  let obj = require(10363) /* _getDefaultRewardName */;
  let platform;
