...
// Dependencies: [5, 32, 19, 1975, 1903, 5160, 676, 1905, 1236, 10393, 7121, 7123, 10410, 1974, 11107, 1926, 589, 11108, 9207, 9218, 5163, 10415, 1879, 10579, 10521, 10424, 7127, 7126, 2]
...
// Module 11106 (_getQuestsInstructionsToWinReward)
...
function useQuestsInstructionsToWinReward(arg0) {
  ...
  const thirdPartyTaskDetails = require(10393) /* useQuests */.useThirdPartyTaskDetails(quest);
  const obj2 = require(10393) /* useQuests */;
  const tmp = undefined !== withoutMarkdown && withoutMarkdown;
  const tmp2 = require;
  const inGameQuestConnectState = require(11108) /* useInGameQuestConnectState */.useInGameQuestConnectState(quest);
  const obj3 = require(11108) /* useInGameQuestConnectState */;
  const result = require(7123) /* getApplicationIdsByTaskTypes */.hasAchievementInGameTask(quest);
  const obj5 = require(7123) /* getApplicationIdsByTaskTypes */;
  if (result) {
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(config, arg1, questContent, sourceQuestContent) {
  ...
  let obj4 = require(7121) /* isSponsoredPlayQuest */;
  const isSponsoredPlayQuestResult = obj4.isSponsoredPlayQuest(config);
  let obj5 = require(7123) /* getApplicationIdsByTaskTypes */;
...
export const useQuestDescription = function useQuestDescription(quest, sourceQuestContent, QUEST_HOME_MOBILE, QuestHome) {
  ...
  obj[1] = require(10393) /* useQuests */.useQuestTaskDetails(quest);
...
export const useQuestBarSubtitle = function useQuestBarSubtitle(arg0) {
  ...
  obj[7] = require(9218) /* GameProfileEmbedAction */.GameProfileSources.QuestBar;
  if (tmp8) {
...
export const useQuestBarTitle = function useQuestBarTitle(questCreative) {
  ...
  const questTaskDetails = require(10393) /* useQuests */.useQuestTaskDetails(questCreative);
  const obj2 = require(10393) /* useQuests */;
  const obj3 = require(10393) /* useQuests */;
  const thirdPartyTaskDetails = require(10393) /* useQuests */.useThirdPartyTaskDetails(questCreative);
  ...
  const obj4 = require(10393) /* useQuests */;
};
  ...
  if (constants3.PLAY === memo) {
    ...
    if (hasItem) {
      ...
      if (!tmp20Result) {
        ...
        tmp20Result = importDefault(10579)(supported_platforms);
        const tmp20 = importDefault(10579);
      }
      hasItem = tmp20Result;
    }
    if (hasItem) {
    ...
    if (tmp2Result1.canLaunchActivity(quest)) {
      ...
      if (hasItem1) {
        ...
        if (!tmp12Result) {
          ...
          tmp12Result = importDefault(10579)(supported_platforms1);
          const tmp12 = importDefault(10579);
        }
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  let obj = require(10410) /* _getDefaultRewardName */;
  let platform;
