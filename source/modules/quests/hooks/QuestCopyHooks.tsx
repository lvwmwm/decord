...
// Dependencies: [5, 57, 31, 1922, 1850, 5011, 653, 1852, 1212, 10468, 5987, 5989, 9460, 1921, 10944, 1873, 566, 10945, 8451, 8462, 5014, 9465, 1827, 10581, 10477, 10474, 5993, 5992, 2]
...
// Module 10943 (formatWithOrWithoutMarkdown)
...
function getQuestInstructionsToWinRewardPlaytimeOnDesktop(taskDetails) {
  ...
  const result1 = require(9460) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest.config);
...
function getQuestInstructionsToWinRewardSponsored(withoutMarkdown) {
  ...
  if (withoutMarkdown.withoutMarkdown) {
    ...
    obj.gameSheetHook = require(10944) /* createGameSheetHook */.createGameSheetHook(obj);
    ...
    const obj2 = require(10944) /* createGameSheetHook */;
  }
  return formatToPlainStringResult;
}
function _getQuestsInstructionsToWinReward(arg0) {
  ...
  let obj = require(1873) /* isPremiumAtLeast */;
  ...
  if (isConsoleQuestResult) {
    let obj3 = require(5989) /* _createForOfIteratorHelperLoose */;
    isConsoleQuestResult = obj3.shouldUsePlayOnDesktopTask(quest);
  }
  let obj4 = require(5987) /* _createForOfIteratorHelperLoose */;
  let obj5 = require(9460) /* getCollectiblesQuestReward */;
  ...
  if (isSponsoredPlayQuestResult) {
    ...
    isPremiumResult = require(9460) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPremiumExtendable(quest6.config);
    const obj38 = require(9460) /* getCollectiblesQuestReward */;
    let result = require(9460) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest6.config);
    ...
    const obj39 = require(9460) /* getCollectiblesQuestReward */;
  } else {
    let obj6 = require(5989) /* _createForOfIteratorHelperLoose */;
    if (obj6.isConsoleQuest(quest)) {
      ...
      isPremiumResult = require(9460) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPremiumExtendable(quest5.config);
      const obj33 = require(9460) /* getCollectiblesQuestReward */;
      let result1 = require(9460) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest5.config);
      isPremiumResult = null;
      ...
      const obj34 = require(9460) /* getCollectiblesQuestReward */;
    } else {
      let obj7 = require(5989) /* _createForOfIteratorHelperLoose */;
      if (obj7.shouldUsePlayOnDesktopTask(quest)) {
        ...
        let obj8 = require(9460) /* getCollectiblesQuestReward */;
        obj5 = { quest };
        if (obj8.isTieredRewardCodeQuest(obj5)) {
          ...
          let obj10 = require(5989) /* _createForOfIteratorHelperLoose */;
          if (obj10.hasWatchVideoTasks(quest)) {
            ...
            const defaultWatchVideoTask = require(5989) /* _createForOfIteratorHelperLoose */.getDefaultWatchVideoTask(quest4.config);
            let videoTitle;
            ...
            const obj25 = require(5989) /* _createForOfIteratorHelperLoose */;
            const result2 = require(9460) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPremiumExtendable(quest4.config);
            const obj26 = require(9460) /* getCollectiblesQuestReward */;
            let result3 = require(9460) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest4.config);
            if (!result2) {
              if (!result2) {
            ...
            const obj27 = require(9460) /* getCollectiblesQuestReward */;
          } else {
            let obj11 = require(5989) /* _createForOfIteratorHelperLoose */;
            if (obj11.hasPlayActivityTask(quest)) {
              ...
              if (obj19.isPlayAnyActivityQuest(quest3)) {
                ...
                if (features.includes(constants2.CLOUD_GAMING_ACTIVITY)) {
                  ...
                  if (features2.includes(constants2.CLOUD_GAMING_PROVIDER_NVIDIA)) {
                    obj11 = { activityName: quest3.config.messages.gameTitle, providerName: "NVIDIA GeForce NOW", providerLink: importDefault(1921).getArticleURL(HelpdeskArticles.NVIDIA_GEFORCE_CLOUD_GAMING_QUEST), streamingDurationRequirement: targetMinutes, questReward: rewardNameWithArticle2 };
                    tmp73 = formatWithOrWithoutMarkdown(require(1212) /* getSystemLocale */.t["0NNM3l"], obj11, withoutMarkdown3);
                    const obj22 = importDefault(1921);
                  }
                }
              ...
              obj19 = require(5987) /* _createForOfIteratorHelperLoose */;
            } else {
              obj12 = require(5989) /* _createForOfIteratorHelperLoose */;
              if (obj12.hasAchievementInGameTask(quest)) {
                if (null != thirdPartyTaskDetails) {
                  ...
                  let obj15 = require(9460) /* getCollectiblesQuestReward */;
                  const result4 = obj15.isCollectibleQuestRewardPremiumExtendable(quest2.config);
                  require(9460) /* getCollectiblesQuestReward */;
                  if (needsToConnect2) {
              ...
              if (null != thirdPartyTaskDetails) {
                ...
                isPremiumResult = require(9460) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPremiumExtendable(quest7.config);
                const obj44 = require(9460) /* getCollectiblesQuestReward */;
                ...
                obj45 = require(9460) /* getCollectiblesQuestReward */;
              }
            }
          }
        }
...
function useQuestsInstructionsToWinReward(arg0) {
  ...
  const thirdPartyTaskDetails = require(10468) /* _createForOfIteratorHelperLoose */.useThirdPartyTaskDetails(quest);
  const obj2 = require(10468) /* _createForOfIteratorHelperLoose */;
  const inGameQuestConnectState = require(10945) /* useInGameQuestConnectState */.useInGameQuestConnectState(quest);
  const obj3 = require(10945) /* useInGameQuestConnectState */;
  const result = require(5989) /* _createForOfIteratorHelperLoose */.hasAchievementInGameTask(quest);
  ...
  if (null == gameProfileSource) {
    gameProfileSource = require(8462) /* GameProfileEmbedAction */.GameProfileSources.QuestHome;
  }
  obj.source = gameProfileSource;
  importDefault(8451)(obj);
  obj = {};
    ...
    if (!obj2.hasPlayActivityTask(quest)) {
      ...
      if (obj3.hasStreamOnDesktopTask(obj)) {
        ...
        if (obj5.hasWatchVideoOnMobileTasks(quest)) {
          ...
          PLAY = require(5989) /* _createForOfIteratorHelperLoose */.isInGameQuest(quest) ? tmp9.IN_GAME : tmp9.PLAY;
          const obj6 = require(5989) /* _createForOfIteratorHelperLoose */;
        }
        obj5 = require(5989) /* _createForOfIteratorHelperLoose */;
      }
      obj3 = require(5989) /* _createForOfIteratorHelperLoose */;
    }
    return PLAY;
  }
...
function canLaunchOnCurrentPlatform(quest, application) {
  ...
  if (!tmp) {
    ...
    if (!tmp7Result) {
      ...
      tmp7Result = importDefault(10581)(supported_platforms);
      const tmp7 = importDefault(10581);
    }
    tmp2 = tmp7Result;
  }
  return tmp2;
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(quest, arg1, questContent, sourceQuestContent) {
  ...
  let obj2 = require(10468) /* _createForOfIteratorHelperLoose */;
  ...
  let obj5 = require(5989) /* _createForOfIteratorHelperLoose */;
  ...
  let obj9 = require(5989) /* _createForOfIteratorHelperLoose */;
  if (obj9.isConsoleQuest(quest)) {
    ...
    if (tmp8Result.hasWatchVideoTasks(quest)) {
      const defaultWatchVideoTask = require(5989) /* _createForOfIteratorHelperLoose */.getDefaultWatchVideoTask(quest.config);
      let videoTitle;
      if (null != defaultWatchVideoTask) {
        videoTitle = defaultWatchVideoTask.messages.videoTitle;
      }
      ...
      obj23 = require(5989) /* _createForOfIteratorHelperLoose */;
    }
    tmp8Result = tmp8(5989);
  }
};
...
export const useQuestDescription = function useQuestDescription(quest, sourceQuestContent, QUEST_HOME_MOBILE, QuestHome) {
  let obj = { quest, taskDetails: require(10468) /* _createForOfIteratorHelperLoose */.useQuestTaskDetails(quest), location: QUEST_HOME_MOBILE, sourceQuestContent, popoutTargetElementRef: arg4, gameProfileSource: QuestHome };
  ...
  require(10468) /* _createForOfIteratorHelperLoose */;
...
export const useQuestBarSubtitle = function useQuestBarSubtitle(arg0) {
  ...
  let obj4 = require(10468) /* _createForOfIteratorHelperLoose */;
  ...
  obj.gameProfileSource = require(8462) /* GameProfileEmbedAction */.GameProfileSources.QuestBar;
  if (tmp6) {
    ...
    const obj8 = require(5989) /* _createForOfIteratorHelperLoose */;
    if (isExpanded) {
      ...
      if (activeScreen !== require(5014) /* QuestsVisibleMessagesChangedSource */.TaskPlatformScreen.SELECT) {
        if (obj17.isSponsoredPlayQuest(quest)) {
          if (tmp8) {
            if (!tmp9) {
              const defaultRewardNameWithArticle = require(9460) /* getCollectiblesQuestReward */.getDefaultRewardNameWithArticle(quest.config, stateFromStores);
              const intl5 = require(1212) /* getSystemLocale */.intl;
        ...
        obj17 = require(5987) /* _createForOfIteratorHelperLoose */;
      }
      return tmp11;
    } else {
      if (obj8.hasWatchVideoTasks(quest)) {
        ...
        if (!obj9.hasAchievementInGameTask(quest)) {
          if (isQuestProgressing) {
            ...
            let contextualEntrypointHeading = tmp22(9465).getContextualEntrypointHeading(obj4);
            const tmp22Result = tmp22(9465);
          } else {
        ...
        obj9 = require(5989) /* _createForOfIteratorHelperLoose */;
      } else {
        const intl = require(1212) /* getSystemLocale */.intl;
...
export const useQuestBarTitle = function useQuestBarTitle(quest) {
  ...
  const questTaskDetails = require(10468) /* _createForOfIteratorHelperLoose */.useQuestTaskDetails(quest);
  const obj2 = require(10468) /* _createForOfIteratorHelperLoose */;
  const obj3 = require(10468) /* _createForOfIteratorHelperLoose */;
  const thirdPartyTaskDetails = require(10468) /* _createForOfIteratorHelperLoose */.useThirdPartyTaskDetails(quest);
  const userStatus = quest.userStatus;
  let completedAt;
  if (null != userStatus) {
  ...
  if (null != completedAt) {
    ...
    if (callback(obj3.useTaskPlatformScreen(quest, questTaskDetails), 1)[0] === require(5014) /* QuestsVisibleMessagesChangedSource */.TaskPlatformScreen.SELECT) {
      const intl2 = require(1212) /* getSystemLocale */.intl;
      ...
      isConsoleQuestResult = require(5989) /* _createForOfIteratorHelperLoose */.isConsoleQuest(quest);
    }
    return stringResult;
  }
  const obj4 = require(10468) /* _createForOfIteratorHelperLoose */;
};
export const usePrimaryCtaCopy = function usePrimaryCtaCopy(showPlayInstantlyLabel) {
  ...
  if (constants3.PLAY === tmp) {
    ...
    return require(10477) /* formatWatchRemainingDurationShort */.getVideoQuestWatchCtaText(tmp3);
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  if (null == platform) {
    platform = require(5014) /* QuestsVisibleMessagesChangedSource */.QuestRewardCodePlatforms.CROSS_PLATFORM;
  }
  ...
  if (result) {
    ...
    obj.idx = tier;
    rewardCodeQuestReward = require(9460) /* getCollectiblesQuestReward */.getRewardCodeQuestReward(obj);
    const obj2 = require(9460) /* getCollectiblesQuestReward */;
  }
  let prop;
  const defaultReward = require(9465) /* getQuestUrl */.getDefaultReward(quest.config);
...
export const useModalCtaConfig = function useModalCtaConfig(quest) {
  ...
  obj.ctaText = quest(9465).getExternalCtaLabel(quest);
