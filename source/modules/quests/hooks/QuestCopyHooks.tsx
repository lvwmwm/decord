...
// Dependencies: [5, 32, 19, 1994, 1922, 5161, 676, 1924, 1236, 10465, 7182, 7184, 10482, 1993, 11179, 1945, 589, 11180, 9278, 9289, 5164, 10487, 1898, 10651, 10593, 10496, 7188, 7187, 2]
...
// Module 11178 (_getQuestsInstructionsToWinReward)
...
function useQuestsInstructionsToWinReward(arg0) {
  ...
  const thirdPartyTaskDetails = require(10465) /* useQuests */.useThirdPartyTaskDetails(quest);
  const obj2 = require(10465) /* useQuests */;
  const tmp = undefined !== withoutMarkdown && withoutMarkdown;
  const tmp2 = require;
  const inGameQuestConnectState = require(11180) /* useInGameQuestConnectState */.useInGameQuestConnectState(quest);
  const obj3 = require(11180) /* useInGameQuestConnectState */;
  const result = require(7184) /* getApplicationIdsByTaskTypes */.hasAchievementInGameTask(quest);
  const obj5 = require(7184) /* getApplicationIdsByTaskTypes */;
  if (result) {
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(config, arg1, questContent, sourceQuestContent) {
  ...
  let obj4 = require(7182) /* isSponsoredPlayQuest */;
  const isSponsoredPlayQuestResult = obj4.isSponsoredPlayQuest(config);
  let obj5 = require(7184) /* getApplicationIdsByTaskTypes */;
...
export const useQuestDescription = function useQuestDescription(quest, sourceQuestContent, QUEST_HOME_MOBILE, QuestHome) {
  ...
  obj[1] = require(10465) /* useQuests */.useQuestTaskDetails(quest);
...
export const useQuestBarSubtitle = function useQuestBarSubtitle(arg0) {
  ...
  obj[7] = require(9289) /* GameProfileEmbedAction */.GameProfileSources.QuestBar;
  if (tmp8) {
...
export const useQuestBarTitle = function useQuestBarTitle(questCreative) {
  ...
  const questTaskDetails = require(10465) /* useQuests */.useQuestTaskDetails(questCreative);
  const obj2 = require(10465) /* useQuests */;
  const obj3 = require(10465) /* useQuests */;
  const thirdPartyTaskDetails = require(10465) /* useQuests */.useThirdPartyTaskDetails(questCreative);
  ...
  const obj4 = require(10465) /* useQuests */;
};
  ...
  if (constants3.PLAY === memo) {
    ...
    if (hasItem) {
      ...
      if (!tmp20Result) {
        ...
        tmp20Result = importDefault(10651)(supported_platforms);
        const tmp20 = importDefault(10651);
      }
      hasItem = tmp20Result;
    }
    if (hasItem) {
    ...
    if (tmp2Result1.canLaunchActivity(quest)) {
      ...
      if (hasItem1) {
        ...
        if (!tmp12Result) {
          ...
          tmp12Result = importDefault(10651)(supported_platforms1);
          const tmp12 = importDefault(10651);
        }
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  let obj = require(10482) /* _getDefaultRewardName */;
  let platform;
