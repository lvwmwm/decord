...
// Dependencies: [5, 32, 19, 1994, 1922, 5223, 676, 1924, 1236, 10436, 7249, 7251, 10452, 1993, 11240, 1945, 589, 11241, 9336, 9347, 5226, 10457, 1898, 10636, 10577, 10469, 7255, 7254, 2]
...
// Module 11239 (_getQuestsInstructionsToWinReward)
...
function useQuestsInstructionsToWinReward(arg0) {
  ...
  const thirdPartyTaskDetails = require(10436) /* useQuests */.useThirdPartyTaskDetails(quest);
  const obj2 = require(10436) /* useQuests */;
  const tmp = undefined !== withoutMarkdown && withoutMarkdown;
  const tmp2 = require;
  const inGameQuestConnectState = require(11241) /* useInGameQuestConnectState */.useInGameQuestConnectState(quest);
  const obj3 = require(11241) /* useInGameQuestConnectState */;
  const result = require(7251) /* getApplicationIdsByTaskTypes */.hasAchievementInGameTask(quest);
  const obj5 = require(7251) /* getApplicationIdsByTaskTypes */;
  if (result) {
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(config, arg1, questContent, sourceQuestContent) {
  ...
  let obj4 = require(7249) /* isSponsoredPlayQuest */;
  const isSponsoredPlayQuestResult = obj4.isSponsoredPlayQuest(config);
  let obj5 = require(7251) /* getApplicationIdsByTaskTypes */;
...
export const useQuestDescription = function useQuestDescription(quest, sourceQuestContent, QUEST_HOME_MOBILE, QuestHome) {
  ...
  obj[1] = require(10436) /* useQuests */.useQuestTaskDetails(quest);
...
export const useQuestBarSubtitle = function useQuestBarSubtitle(arg0) {
  ...
  obj[7] = require(9347) /* GameProfileEmbedAction */.GameProfileSources.QuestBar;
  if (tmp8) {
...
export const useQuestBarTitle = function useQuestBarTitle(questCreative) {
  ...
  const questTaskDetails = require(10436) /* useQuests */.useQuestTaskDetails(questCreative);
  const obj2 = require(10436) /* useQuests */;
  const obj3 = require(10436) /* useQuests */;
  const thirdPartyTaskDetails = require(10436) /* useQuests */.useThirdPartyTaskDetails(questCreative);
  ...
  const obj4 = require(10436) /* useQuests */;
};
  ...
  if (constants3.PLAY === memo) {
    ...
    if (hasItem) {
      ...
      if (!tmp20Result) {
        ...
        tmp20Result = importDefault(10636)(supported_platforms);
        const tmp20 = importDefault(10636);
      }
      hasItem = tmp20Result;
    }
    if (hasItem) {
    ...
    if (tmp2Result1.canLaunchActivity(quest)) {
      ...
      if (hasItem1) {
        ...
        if (!tmp12Result) {
          ...
          tmp12Result = importDefault(10636)(supported_platforms1);
          const tmp12 = importDefault(10636);
        }
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  let obj = require(10452) /* _getDefaultRewardName */;
  let platform;
