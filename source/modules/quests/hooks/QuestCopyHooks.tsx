...
function getQuestInstructionsToWinRewardPlaytimeOnDesktop(taskDetails) {
  ...
  const result1 = require(9420) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest.config);
...
function _getQuestsInstructionsToWinReward(arg0) {
  ...
  if (isSponsoredPlayQuestResult) {
    ...
    isPremiumResult = require(9420) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPremiumExtendable(quest6.config);
    const obj38 = require(9420) /* getCollectiblesQuestReward */;
    let result = require(9420) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest6.config);
    ...
    const obj39 = require(9420) /* getCollectiblesQuestReward */;
  } else {
    let obj6 = require(5955) /* _createForOfIteratorHelperLoose */;
    if (obj6.isConsoleQuest(quest)) {
      ...
      isPremiumResult = require(9420) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPremiumExtendable(quest5.config);
      const obj33 = require(9420) /* getCollectiblesQuestReward */;
      let result1 = require(9420) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest5.config);
      isPremiumResult = null;
      ...
      const obj34 = require(9420) /* getCollectiblesQuestReward */;
    } else {
      let obj7 = require(5955) /* _createForOfIteratorHelperLoose */;
      if (obj7.shouldUsePlayOnDesktopTask(quest)) {
        ...
        let obj8 = require(9420) /* getCollectiblesQuestReward */;
        obj5 = { quest };
        if (obj8.isTieredRewardCodeQuest(obj5)) {
          ...
          let obj10 = require(5955) /* _createForOfIteratorHelperLoose */;
          if (obj10.hasWatchVideoTasks(quest)) {
            ...
            const defaultWatchVideoTask = require(5955) /* _createForOfIteratorHelperLoose */.getDefaultWatchVideoTask(quest4.config);
            let videoTitle;
            ...
            const obj25 = require(5955) /* _createForOfIteratorHelperLoose */;
            const result2 = require(9420) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPremiumExtendable(quest4.config);
            const obj26 = require(9420) /* getCollectiblesQuestReward */;
            let result3 = require(9420) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPermanentWithPremiumSubscription(quest4.config);
            if (!result2) {
              if (!result2) {
            ...
            const obj27 = require(9420) /* getCollectiblesQuestReward */;
          } else {
            let obj11 = require(5955) /* _createForOfIteratorHelperLoose */;
            if (obj11.hasPlayActivityTask(quest)) {
              ...
              obj19 = require(5953) /* _createForOfIteratorHelperLoose */;
            } else {
              obj12 = require(5955) /* _createForOfIteratorHelperLoose */;
              if (obj12.hasAchievementInGameTask(quest)) {
                if (null != thirdPartyTaskDetails) {
                  ...
                  let obj15 = require(9420) /* getCollectiblesQuestReward */;
                  const result4 = obj15.isCollectibleQuestRewardPremiumExtendable(quest2.config);
                  require(9420) /* getCollectiblesQuestReward */;
                  if (needsToConnect2) {
              ...
              if (null != thirdPartyTaskDetails) {
                ...
                isPremiumResult = require(9420) /* getCollectiblesQuestReward */.isCollectibleQuestRewardPremiumExtendable(quest7.config);
                const obj44 = require(9420) /* getCollectiblesQuestReward */;
                ...
                obj45 = require(9420) /* getCollectiblesQuestReward */;
              }
            }
          }
        }
...
function useQuestsInstructionsToWinReward(arg0) {
  ...
  if (null == gameProfileSource) {
    gameProfileSource = require(8418) /* GameProfileEmbedAction */.GameProfileSources.QuestHome;
  }
  obj.source = gameProfileSource;
  importDefault(8407)(obj);
  obj = {};
    ...
    if (!obj2.hasPlayActivityTask(quest)) {
      ...
      if (obj3.hasStreamOnDesktopTask(obj)) {
        ...
        if (obj5.hasWatchVideoOnMobileTasks(quest)) {
          ...
          PLAY = require(5955) /* _createForOfIteratorHelperLoose */.isInGameQuest(quest) ? tmp9.IN_GAME : tmp9.PLAY;
          const obj6 = require(5955) /* _createForOfIteratorHelperLoose */;
        }
        obj5 = require(5955) /* _createForOfIteratorHelperLoose */;
      }
      obj3 = require(5955) /* _createForOfIteratorHelperLoose */;
    }
    return PLAY;
  }
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(quest, arg1, questContent, sourceQuestContent) {
  ...
  let obj5 = require(5955) /* _createForOfIteratorHelperLoose */;
  ...
  let obj9 = require(5955) /* _createForOfIteratorHelperLoose */;
  if (obj9.isConsoleQuest(quest)) {
    ...
    if (tmp8Result.hasWatchVideoTasks(quest)) {
      const defaultWatchVideoTask = require(5955) /* _createForOfIteratorHelperLoose */.getDefaultWatchVideoTask(quest.config);
      let videoTitle;
      if (null != defaultWatchVideoTask) {
        videoTitle = defaultWatchVideoTask.messages.videoTitle;
      }
      ...
      obj23 = require(5955) /* _createForOfIteratorHelperLoose */;
    }
    tmp8Result = tmp8(5955);
  }
};
...
export const useQuestBarSubtitle = function useQuestBarSubtitle(arg0) {
  ...
  if (tmp6) {
    ...
    const obj8 = require(5955) /* _createForOfIteratorHelperLoose */;
    if (isExpanded) {
      ...
      if (activeScreen !== require(4980) /* QuestsVisibleMessagesChangedSource */.TaskPlatformScreen.SELECT) {
        if (obj17.isSponsoredPlayQuest(quest)) {
          if (tmp8) {
            if (!tmp9) {
              const defaultRewardNameWithArticle = require(9420) /* getCollectiblesQuestReward */.getDefaultRewardNameWithArticle(quest.config, stateFromStores);
              const intl5 = require(1212) /* getSystemLocale */.intl;
        ...
        obj17 = require(5953) /* _createForOfIteratorHelperLoose */;
      }
      return tmp11;
    } else {
      if (obj8.hasWatchVideoTasks(quest)) {
        ...
        if (!obj9.hasAchievementInGameTask(quest)) {
          if (isQuestProgressing) {
            ...
            let contextualEntrypointHeading = tmp22(9425).getContextualEntrypointHeading(obj4);
            const tmp22Result = tmp22(9425);
          } else {
        ...
        obj9 = require(5955) /* _createForOfIteratorHelperLoose */;
      } else {
        const intl = require(1212) /* getSystemLocale */.intl;
...
export const useQuestBarTitle = function useQuestBarTitle(quest) {
  ...
  if (null != completedAt) {
    ...
    if (callback(obj3.useTaskPlatformScreen(quest, questTaskDetails), 1)[0] === require(4980) /* QuestsVisibleMessagesChangedSource */.TaskPlatformScreen.SELECT) {
      const intl2 = require(1212) /* getSystemLocale */.intl;
      ...
      isConsoleQuestResult = require(5955) /* _createForOfIteratorHelperLoose */.isConsoleQuest(quest);
    }
    return stringResult;
  }
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  if (null == platform) {
    platform = require(4980) /* QuestsVisibleMessagesChangedSource */.QuestRewardCodePlatforms.CROSS_PLATFORM;
  }
  ...
  if (result) {
    ...
    obj.idx = tier;
    rewardCodeQuestReward = require(9420) /* getCollectiblesQuestReward */.getRewardCodeQuestReward(obj);
    const obj2 = require(9420) /* getCollectiblesQuestReward */;
  }
  let prop;
  const defaultReward = require(9425) /* getQuestUrl */.getDefaultReward(quest.config);
...
export const useModalCtaConfig = function useModalCtaConfig(quest) {
  ...
  obj.ctaText = quest(9425).getExternalCtaLabel(quest);
