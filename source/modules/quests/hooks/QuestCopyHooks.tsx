...
// Dependencies: [5, 32, 19, 1995, 1921, 5404, 673, 1923, 1233, 11415, 7655, 7657, 11222, 1994, 11708, 1945, 586, 11709, 8605, 8616, 5407, 11227, 1896, 9457, 11445, 11428, 7661, 7660, 2]
...
// Module 11707 (_getQuestsInstructionsToWinReward)
...
import useInGameQuestConnectState from "useInGameQuestConnectState" /* 11709 */;
...
function _getQuestsInstructionsToWinReward(arg0) {
  ...
  if (isConsoleQuestResult) {
    isConsoleQuestResult = _1votF6(7657).shouldUsePlayOnDesktopTask(quest);
    const v1votF6Result = _1votF6(7657);
  }
  const v1votF6Result1 = _1votF6(7655);
  const isSponsoredPlayQuestResult = _1votF6(7655).isSponsoredPlayQuest(quest);
  const defaultRewardNameWithArticle = _1votF6(11222).getDefaultRewardNameWithArticle(quest.config, currentUser);
  if (isSponsoredPlayQuestResult) {
    ...
    if (withoutMarkdown) {
      ...
      obj = undefined;
      obj = {};
      const gameSheetHook = _1votF6(11708).createGameSheetHook(obj);
      ...
      const v1votF6Result3 = _1votF6(11708);
    }
  } else if (isConsoleQuestResult) {
    const targetMinutes3 = taskDetails.targetMinutes;
    const result = _1votF6(11222).isCollectibleQuestRewardPremiumExtendable(quest.config);
    const v1votF6Result4 = _1votF6(11222);
    const features4 = quest.config.features;
    const result1 = _1votF6(11222).isCollectibleQuestRewardPermanentWithPremiumSubscription(quest.config);
    ...
    const v1votF6Result5 = _1votF6(11222);
  } else {
    if (v1votF6Result6.isConsoleQuest(quest)) {
      const targetMinutes2 = taskDetails.targetMinutes;
      const result2 = _1votF6(11222).isCollectibleQuestRewardPremiumExtendable(quest.config);
      const v1votF6Result7 = _1votF6(11222);
      if (isPremiumResult) {
        if (result2) {
      ...
      v1votF6Result8 = _1votF6(11222);
    } else {
      if (v1votF6Result9.shouldUsePlayOnDesktopTask(quest)) {
        const result3 = _1votF6(11222).isCollectibleQuestRewardPremiumExtendable(quest.config);
        const v1votF6Result10 = _1votF6(11222);
        const features3 = quest.config.features;
        const result4 = _1votF6(11222).isCollectibleQuestRewardPermanentWithPremiumSubscription(quest.config);
        ...
        const v1votF6Result11 = _1votF6(11222);
      } else {
        ...
        if (v1votF6Result12.isTieredRewardCodeQuest(obj5)) {
          ...
          const v1votF6Result13 = _1votF6(7657);
          const v1votF6Result14 = _1votF6(7657);
          if (hasWatchVideoTasksResult) {
            ...
            const result5 = _1votF6(11222).isCollectibleQuestRewardPremiumExtendable(quest.config);
            const v1votF6Result15 = _1votF6(11222);
            if (result5) {
              if (isPremiumResult) {
            ...
            v1votF6Result17 = _1votF6(7655);
          } else {
            if (v1votF6Result18.hasAchievementInGameTask(quest)) {
              if (null != thirdPartyTaskDetails) {
                const result6 = _1votF6(11222).isCollectibleQuestRewardPremiumExtendable(quest.config);
                _1votF6(11222);
                if (needsToConnect) {
                ...
                const v1votF6Result19 = _1votF6(11222);
              }
            }
            if (null != thirdPartyTaskDetails) {
              let description = thirdPartyTaskDetails.description;
            } else {
              const result7 = _1votF6(11222).isCollectibleQuestRewardPremiumExtendable(quest.config);
              const v1votF6Result21 = _1votF6(11222);
              if (isPremiumResult) {
                if (result7) {
              ...
              v1votF6Result22 = _1votF6(11222);
            }
            return description;
          }
          hasWatchVideoTasksResult = _1votF6(7657).hasWatchVideoTasks(quest);
        }
        v1votF6Result12 = _1votF6(11222);
      }
      v1votF6Result9 = _1votF6(7657);
    }
    v1votF6Result6 = _1votF6(7657);
  }
}
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(config, arg1, questContent, sourceQuestContent) {
  ...
  if (tmpResult.isConsoleQuest(config)) {
    ...
    if (tmpResult1.hasWatchVideoTasks(config)) {
      const defaultWatchVideoTask = tmp(7657).getDefaultWatchVideoTask(config.config);
      let videoTitle;
      if (defaultWatchVideoTask != null) {
      ...
      if (tmpResult3.hasPlayActivityTask(config)) {
        const result = tmp(7655).isPlayAnyActivityQuest(config);
...
export const useQuestBarSubtitle = function useQuestBarSubtitle(arg0) {
  ...
  if (tmp8) {
    ...
    if (isExpanded) {
      ...
      if (activeScreen !== tmp(5407).TaskPlatformScreen.SELECT) {
        if (tmpResult2.isSponsoredPlayQuest(quest)) {
          if (tmp10) {
            if (!tmp11) {
              const defaultRewardNameWithArticle = tmp(11222).getDefaultRewardNameWithArticle(quest.config, stateFromStores);
              const intl5 = tmp(1233).intl;
      ...
      if (tmpResult1.hasWatchVideoTasks(quest)) {
        ...
        if (!tmpResult4.hasAchievementInGameTask(quest)) {
          if (isQuestProgressing) {
            ...
            let contextualEntrypointHeading = tmp(11227).getContextualEntrypointHeading(obj4);
            const tmpResult5 = tmp(11227);
          } else {
            const intl2 = tmp(1233).intl;
...
export const useQuestBarTitle = function useQuestBarTitle(questDockQuest) {
  ...
  if (null != completedAt) {
    ...
    if (callback(obj3.useTaskPlatformScreen(questDockQuest, questTaskDetails), 1)[0] === tmp(5407).TaskPlatformScreen.SELECT) {
      const intl2 = tmp(1233).intl;
      ...
      isConsoleQuestResult = tmp(7657).isConsoleQuest(questDockQuest);
    }
    return stringResult;
  }
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  if (platform == null) {
    platform = tmp(5407).QuestRewardCodePlatforms.CROSS_PLATFORM;
  }
...
export const useModalCtaConfig = function useModalCtaConfig(quest) {
      ...
      if (dependencyMap === 2) {
        ...
        try {
          ...
          if (0 === c1) {
            ...
            obj2[0] = c1;
            obj2[1] = closure_1_0(7661).QuestContentCTA.OPEN_GAME_LINK;
            let tmp5;
            if (callback != null) {
              tmp5 = callback();
            }
            obj2[2] = tmp5;
            obj2[3] = closure_4;
            closure_1_0(11428).openGameLinkDirectly(closure_0, obj2);
            dependencyMap = 3;
            return { value: "HermesInternal", done: null };
          }
        } catch (tmp11) {
  ...
  obj[0] = quest(11227).getExternalCtaLabel(quest);
