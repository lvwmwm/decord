...
// Dependencies: [5, 32, 19, 1975, 1903, 5143, 676, 1905, 1236, 10377, 7102, 7104, 10394, 1974, 11092, 1926, 589, 11093, 9190, 9201, 5146, 10399, 1879, 10582, 10505, 10408, 7108, 7107, 2]
...
// Module 11091 (_getQuestsInstructionsToWinReward)
...
function useQuestsInstructionsToWinReward(arg0) {
  ...
  const thirdPartyTaskDetails = require(10377) /* useQuests */.useThirdPartyTaskDetails(quest);
  const obj2 = require(10377) /* useQuests */;
  const tmp = undefined !== withoutMarkdown && withoutMarkdown;
  const tmp2 = require;
  const inGameQuestConnectState = require(11093) /* useInGameQuestConnectState */.useInGameQuestConnectState(quest);
  const obj3 = require(11093) /* useInGameQuestConnectState */;
  const result = require(7104) /* getApplicationIdsByTaskTypes */.hasAchievementInGameTask(quest);
  const obj5 = require(7104) /* getApplicationIdsByTaskTypes */;
  if (result) {
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(config, arg1, questContent, sourceQuestContent) {
  ...
  let obj4 = require(7102) /* isSponsoredPlayQuest */;
  const isSponsoredPlayQuestResult = obj4.isSponsoredPlayQuest(config);
  let obj5 = require(7104) /* getApplicationIdsByTaskTypes */;
...
export const useQuestDescription = function useQuestDescription(quest, sourceQuestContent, QUEST_HOME_MOBILE, QuestHome) {
  ...
  obj[1] = require(10377) /* useQuests */.useQuestTaskDetails(quest);
...
export const useQuestBarSubtitle = function useQuestBarSubtitle(arg0) {
  ...
  obj[7] = require(9201) /* GameProfileEmbedAction */.GameProfileSources.QuestBar;
  if (tmp8) {
...
export const useQuestBarTitle = function useQuestBarTitle(questCreative) {
  ...
  const questTaskDetails = require(10377) /* useQuests */.useQuestTaskDetails(questCreative);
  const obj2 = require(10377) /* useQuests */;
  const obj3 = require(10377) /* useQuests */;
  const thirdPartyTaskDetails = require(10377) /* useQuests */.useThirdPartyTaskDetails(questCreative);
  ...
  const obj4 = require(10377) /* useQuests */;
};
  ...
  if (constants3.PLAY === memo) {
    ...
    if (hasItem) {
      ...
      if (!tmp20Result) {
        ...
        tmp20Result = importDefault(10582)(supported_platforms);
        const tmp20 = importDefault(10582);
      }
      hasItem = tmp20Result;
    }
    if (hasItem) {
    ...
    if (tmp2Result1.canLaunchActivity(quest)) {
      ...
      if (hasItem1) {
        ...
        if (!tmp12Result) {
          ...
          tmp12Result = importDefault(10582)(supported_platforms1);
          const tmp12 = importDefault(10582);
        }
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  let obj = require(10394) /* _getDefaultRewardName */;
  let platform;
