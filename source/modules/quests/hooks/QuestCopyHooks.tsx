...
// Dependencies: [5, 32, 19, 1994, 1922, 5201, 676, 1924, 1236, 10506, 7221, 7223, 10523, 1993, 11232, 1945, 589, 11233, 9318, 9329, 5204, 10528, 1898, 10704, 10645, 10537, 7227, 7226, 2]
...
// Module 11231 (_getQuestsInstructionsToWinReward)
...
function useQuestsInstructionsToWinReward(arg0) {
  ...
  const thirdPartyTaskDetails = require(10506) /* useQuests */.useThirdPartyTaskDetails(quest);
  const obj2 = require(10506) /* useQuests */;
  const tmp = undefined !== withoutMarkdown && withoutMarkdown;
  const tmp2 = require;
  const inGameQuestConnectState = require(11233) /* useInGameQuestConnectState */.useInGameQuestConnectState(quest);
  const obj3 = require(11233) /* useInGameQuestConnectState */;
  const result = require(7223) /* getApplicationIdsByTaskTypes */.hasAchievementInGameTask(quest);
  const obj5 = require(7223) /* getApplicationIdsByTaskTypes */;
  if (result) {
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(config, arg1, questContent, sourceQuestContent) {
  ...
  let obj4 = require(7221) /* isSponsoredPlayQuest */;
  const isSponsoredPlayQuestResult = obj4.isSponsoredPlayQuest(config);
  let obj5 = require(7223) /* getApplicationIdsByTaskTypes */;
...
export const useQuestDescription = function useQuestDescription(quest, sourceQuestContent, QUEST_HOME_MOBILE, QuestHome) {
  ...
  obj[1] = require(10506) /* useQuests */.useQuestTaskDetails(quest);
...
export const useQuestBarSubtitle = function useQuestBarSubtitle(arg0) {
  ...
  obj[7] = require(9329) /* GameProfileEmbedAction */.GameProfileSources.QuestBar;
  if (tmp8) {
...
export const useQuestBarTitle = function useQuestBarTitle(questCreative) {
  ...
  const questTaskDetails = require(10506) /* useQuests */.useQuestTaskDetails(questCreative);
  const obj2 = require(10506) /* useQuests */;
  const obj3 = require(10506) /* useQuests */;
  const thirdPartyTaskDetails = require(10506) /* useQuests */.useThirdPartyTaskDetails(questCreative);
  ...
  const obj4 = require(10506) /* useQuests */;
};
  ...
  if (constants3.PLAY === memo) {
    ...
    if (hasItem) {
      ...
      if (!tmp20Result) {
        ...
        tmp20Result = importDefault(10704)(supported_platforms);
        const tmp20 = importDefault(10704);
      }
      hasItem = tmp20Result;
    }
    if (hasItem) {
    ...
    if (tmp2Result1.canLaunchActivity(quest)) {
      ...
      if (hasItem1) {
        ...
        if (!tmp12Result) {
          ...
          tmp12Result = importDefault(10704)(supported_platforms1);
          const tmp12 = importDefault(10704);
        }
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  let obj = require(10523) /* _getDefaultRewardName */;
  let platform;
