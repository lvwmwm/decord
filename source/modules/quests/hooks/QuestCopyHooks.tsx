...
// Dependencies: [5, 32, 19, 1994, 1922, 5202, 676, 1924, 1236, 10420, 7227, 7229, 10436, 1993, 11224, 1945, 589, 11225, 9322, 9333, 5205, 10441, 1898, 10620, 10561, 10453, 7233, 7232, 2]
...
// Module 11223 (_getQuestsInstructionsToWinReward)
...
function useQuestsInstructionsToWinReward(arg0) {
  ...
  const tmp2 = require;
  const inGameQuestConnectState = require(11225) /* useInGameQuestConnectState */.useInGameQuestConnectState(quest);
  const obj3 = require(11225) /* useInGameQuestConnectState */;
  const result = require(7229) /* getApplicationIdsByTaskTypes */.hasAchievementInGameTask(quest);
  const obj5 = require(7229) /* getApplicationIdsByTaskTypes */;
  if (result) {
  ...
  const obj4 = require(7229) /* getApplicationIdsByTaskTypes */;
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(config, arg1, questContent, sourceQuestContent) {
  ...
  let obj4 = require(7227) /* isSponsoredPlayQuest */;
  const isSponsoredPlayQuestResult = obj4.isSponsoredPlayQuest(config);
  let obj5 = require(7229) /* getApplicationIdsByTaskTypes */;
  ...
  if (constants3.PLAY === memo) {
    ...
    if (hasItem) {
      ...
      if (!tmp20Result) {
        ...
        tmp20Result = importDefault(10620)(supported_platforms);
        const tmp20 = importDefault(10620);
      }
      hasItem = tmp20Result;
    }
    if (hasItem) {
    ...
    if (tmp2Result1.canLaunchActivity(quest)) {
      ...
      if (hasItem1) {
        ...
        if (!tmp12Result) {
          ...
          tmp12Result = importDefault(10620)(supported_platforms1);
          const tmp12 = importDefault(10620);
        }
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  let obj = require(10436) /* _getDefaultRewardName */;
  let platform;
