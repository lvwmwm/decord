...
// Function ID: 7103
// Name: _toPropertyKey
// Dependencies: [109, 700, 4170, 7103, 705, 7104, 2]

// Module 7102 (_toPropertyKey)
...
obj[1] = createJSONStorage.createJSONStorage(() => importDefault(7104));
...
const withEqualityFnResult = identity(createJSONStorage.persist((arg0, arg1) => {
  ...
  let closure_1 = arg1;
  return {
    volume: _require(7103).DEFAULT_VIDEO_VOLUME,
    muted: false,
