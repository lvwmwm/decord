...
// Function ID: 7209
// Name: _toPropertyKey
// Dependencies: [109, 700, 4210, 7209, 705, 7210, 2]

// Module 7208 (_toPropertyKey)
...
obj[1] = createJSONStorage.createJSONStorage(() => importDefault(7210));
...
const withEqualityFnResult = identity(createJSONStorage.persist((arg0, arg1) => {
  ...
  let closure_1 = arg1;
  return {
    volume: _require(7209).DEFAULT_VIDEO_VOLUME,
    muted: false,
