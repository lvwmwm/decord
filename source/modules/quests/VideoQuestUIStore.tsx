...
// Function ID: 7462
// Name: _toPropertyKey
// Dependencies: [109, 697, 4345, 7462, 702, 7463, 2]

// Module 7461 (_toPropertyKey)
...
obj[1] = createJSONStorage.createJSONStorage(() => importDefault(7463));
...
const withEqualityFnResult = identity(createJSONStorage.persist((arg0, arg1) => {
  ...
  closure_1 = arg1;
  return {
    volume: _require(7462).DEFAULT_VIDEO_VOLUME,
    muted: false,
