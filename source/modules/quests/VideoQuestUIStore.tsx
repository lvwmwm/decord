...
// Function ID: 7203
// Name: _toPropertyKey
// Dependencies: [109, 700, 4212, 7203, 705, 7204, 2]

// Module 7202 (_toPropertyKey)
...
obj[1] = createJSONStorage.createJSONStorage(() => importDefault(7204));
...
const withEqualityFnResult = identity(createJSONStorage.persist((arg0, arg1) => {
  ...
  let closure_1 = arg1;
  return {
    volume: _require(7203).DEFAULT_VIDEO_VOLUME,
    muted: false,
