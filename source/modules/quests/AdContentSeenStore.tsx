...
// Function ID: 14205
// Name: getOrCreateSet
// Dependencies: [32, 7054, 7082, 7052, 589, 709, 2]

// Module 14204 (getOrCreateSet)
...
function syncWithQuestStore() {
  ...
  const obj = getOrCreateSet(require(7082) /* AdCreativeType */.AdCreativeType.QUEST);
  let flag = false;
  while (tmp !== undefined) {
    let tmp3 = callback;
  ...
  const obj4 = getOrCreateSet(require(7082) /* AdCreativeType */.AdCreativeType.QUEST_HOME_HERO);
