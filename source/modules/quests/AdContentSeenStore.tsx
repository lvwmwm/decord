...
// Function ID: 14326
// Name: getOrCreateSet
// Dependencies: [32, 7160, 7188, 7158, 589, 709, 2]

// Module 14325 (getOrCreateSet)
...
function syncWithQuestStore() {
  ...
  const obj = getOrCreateSet(require(7188) /* AdCreativeType */.AdCreativeType.QUEST);
  let flag = false;
  while (tmp !== undefined) {
    let tmp3 = callback;
  ...
  const obj4 = getOrCreateSet(require(7188) /* AdCreativeType */.AdCreativeType.QUEST_HOME_HERO);
