...
// Function ID: 14256
// Name: getOrCreateSet
// Dependencies: [32, 7100, 7128, 7098, 589, 709, 2]

// Module 14255 (getOrCreateSet)
...
function syncWithQuestStore() {
  ...
  const obj = getOrCreateSet(require(7128) /* AdCreativeType */.AdCreativeType.QUEST);
  let flag = false;
  while (tmp !== undefined) {
    let tmp3 = callback;
  ...
  const obj4 = getOrCreateSet(require(7128) /* AdCreativeType */.AdCreativeType.QUEST_HOME_HERO);
