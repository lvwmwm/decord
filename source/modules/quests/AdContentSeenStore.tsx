...
// Function ID: 14406
// Name: getOrCreateSet
// Dependencies: [32, 7228, 7244, 7226, 589, 709, 2]

// Module 14405 (getOrCreateSet)
...
function syncWithQuestStore() {
  ...
  const obj = getOrCreateSet(require(7244) /* AdCreativeType */.AdCreativeType.QUEST);
  let flag = false;
  while (tmp !== undefined) {
    let tmp3 = callback;
  ...
  const obj4 = getOrCreateSet(require(7244) /* AdCreativeType */.AdCreativeType.QUEST_HOME_HERO);
