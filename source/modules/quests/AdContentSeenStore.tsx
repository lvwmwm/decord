...
// Function ID: 14242
// Name: getOrCreateSet
// Dependencies: [32, 7081, 7109, 7079, 589, 709, 2]

// Module 14241 (getOrCreateSet)
...
function syncWithQuestStore() {
  ...
  const obj = getOrCreateSet(require(7109) /* AdCreativeType */.AdCreativeType.QUEST);
  let flag = false;
  while (tmp !== undefined) {
    let tmp3 = callback;
  ...
  const obj4 = getOrCreateSet(require(7109) /* AdCreativeType */.AdCreativeType.QUEST_HOME_HERO);
