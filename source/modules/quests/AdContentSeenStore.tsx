...
// Function ID: 14336
// Name: getOrCreateSet
// Dependencies: [32, 7161, 7189, 7159, 589, 709, 2]

// Module 14335 (getOrCreateSet)
...
function syncWithQuestStore() {
  ...
  const obj = getOrCreateSet(require(7189) /* AdCreativeType */.AdCreativeType.QUEST);
  let flag = false;
  while (tmp !== undefined) {
    let tmp3 = callback;
  ...
  const obj4 = getOrCreateSet(require(7189) /* AdCreativeType */.AdCreativeType.QUEST_HOME_HERO);
