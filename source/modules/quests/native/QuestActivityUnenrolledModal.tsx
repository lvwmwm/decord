...
// Dependencies: [5, 32, 19, 17, 7381, 16525, 5339, 21, 4445, 712, 501, 4380, 1364, 589, 5911, 7402, 11003, 11257, 5342, 1435, 10833, 7406, 4676, 4173, 11256, 14668, 4878, 5445, 11253, 4441, 1236, 4880, 7617, 6189, 7697, 11260, 11420, 2]
// Exports: default

// Module 16526 (QuestActivityUnenrolledModalInner)
...
import closure_9 from "set" /* 16525 */;
...
function QuestActivityUnenrolledModalInner(quest) {
  ...
  let obj5 = quest(11003);
  const questTaskDetails = obj5.useQuestTaskDetails(quest);
  let obj6 = quest(11257);
  obj = { quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5342).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            obj1[0] = closure_1_0(5342).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL;
            obj1[1] = closure_1_0(7406).QuestContentCTA.START_QUEST;
            obj1[2] = closure_1_0(5342).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL;
            v0 = 1;
            dependencyMap = 1;
            const obj2 = { value: null, done: false };
            obj2[0] = closure_1_0(10833).enrollInQuest(closure_1_0.id, obj1);
            return obj2;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const callback1 = React.useCallback(() => {
    trackQuestContentClickedWithImpression({ questId: quest.id, questContent: quest(5342).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL, questContentCTA: quest(7406).QuestContentCTA.QUEST_ACCESS_SUSPENDED, sourceQuestContent: quest(5342).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL });
    first(14668)();
  }, items3);
  ...
  if (tmp18Result) {
    ...
    obj5[0] = obj6;
    obj5[1] = tmp4.appIcon;
    obj4[1] = tmp18(first(5445), obj5);
    tmp18Result = tmp18(tmp17, obj4);
  }
  const items4 = [tmp18Result, ];
  obj8 = { quest, height: 87, width: 87, style: tmp4.questRewardTile };
  items4[1] = closure_11(closure_7, { style: tmp4.rewardTileContainer, children: closure_11(first(11253), obj8) });
  obj3[1] = items4;
  ...
  const items6 = [closure_11(quest(4441).Text, obj10), ];
  ...
  obj11[3] = items7;
  items6[1] = closure_12(quest(4441).Text, obj11);
  obj9[1] = items6;
  ...
  obj15[4] = tmp21;
  const items9 = [closure_11(quest(4880).Button, obj15), ];
  ...
  obj16[2] = function onPress() {
    const result = quest(10833).dismissQuestActivityModal(quest.id);
    let arr = first(4676);
    arr = arr.pop();
  };
  items9[1] = closure_11(quest(4880).Button, obj16);
  obj14[1] = items9;
...
export default function QuestActivityUnenrolledModal(questId) {
  ...
  if (null == stateFromStores) {
    ...
    obj[2] = function headerTitle() {
      ...
      return callback(questId(4441).Text, obj);
    };
    ...
    return callback(tmp(11420).Modal, obj1);
  }
  tmp = questId;
};
