...
// Dependencies: [5, 32, 19, 17, 8717, 5982, 5033, 21, 14040, 589, 10877, 14041, 10881, 14042, 14044, 14045, 14047, 10966, 6011, 5038, 14065, 2]
// Exports: BountiesScrollVideoItem

// Module 14039 (BountiesScrollVideoItemInner)
import set from "set";
...
function BountiesScrollVideoItemInner(bounty) {
  ...
  const BountyVideoEndMode = tmp2(14041).BountyVideoEndMode;
  if (loopingEnabled) {
  ...
  if (!stage1Enabled) {
    ...
    obj[8] = index;
    obj[9] = isActive;
    const bountiesModalVideoAnalytics = tmp2(14045).useBountiesModalVideoAnalytics(obj);
    ...
    obj1[12] = duration;
    const bountiesModalTiming = tmp2(14041).useBountiesModalTiming(obj1);
    ...
    obj2[1] = handleProgress(tmp2(14047).BountyVideo, obj3);
...
export const BountiesScrollVideoItem = function BountiesScrollVideoItem(bounty) {
  ...
  obj[1] = bounty(6011).AdCreativeType.BOUNTY;
  ...
  return flag3(bounty(10966).BillableAdPlacementImpressionTrackerNative, obj);
};
