...
// Module 13791 (getRecapOrbCountFromPullProgress)
  ...
  const fn = function b() {
    if (enabled) {
      if (recapRevealHeight > 0) {
        ...
        if (result <= 0.1) {
          let obj = { "Bool(false)": 0., "Bool(false)": -823154013994709700000000000000000000000000000000000000000000000 };
        } else {
    ...
    return { "Bool(false)": 0., "Bool(false)": -823154013994709700000000000000000000000000000000000000000000000 };
  };
