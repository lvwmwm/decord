...
// Dependencies: [5, 19, 17, 7205, 5202, 676, 505, 21, 1493, 1628, 4342, 712, 589, 9472, 10955, 14327, 14330, 10959, 14328, 14331, 7223, 7222, 7233, 5207, 10560, 14314, 14333, 11226, 14370, 14362, 5368, 14354, 10420, 4072, 2]
// Exports: default

// Module 14369 (BountiesModalContentInner)
import ME from "ME";
...
function BountiesModalContentInner(bounty) {
  ...
  const BountyVideoEndMode = width(14327).BountyVideoEndMode;
  ...
  if (!stage1Enabled) {
    ...
    obj1[11] = duration;
    const bountiesModalTiming = tmp9(14327).useBountiesModalTiming(obj1);
    ...
    obj3[1] = videoDuration(tmp9(14333).BountyVideo, obj4);
    const items9 = [videoDuration(handleProgress, obj3), , ];
    let obj5 = { style: null, children: null };
    obj5[0] = memo2;
    const obj6 = { onPress: null };
    obj6[0] = callback2;
    obj5[1] = videoDuration(tmp2(14362), obj6);
    ...
    obj8[3] = callback3;
    obj7[5] = videoDuration(tmp2(14354), obj8);
    items9[2] = videoDuration(tmp9(5368).SafeAreaPaddingView, obj7);
    obj2[0] = items9;
