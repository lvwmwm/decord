...
// Dependencies: [5, 19, 17, 7205, 5202, 676, 505, 21, 1493, 1628, 4342, 712, 589, 9472, 10953, 14336, 14339, 10957, 14337, 14340, 7222, 7233, 7232, 5207, 10558, 14323, 14342, 11225, 14379, 14371, 5368, 14363, 10420, 4072, 2]
// Exports: default

// Module 14378 (BountiesModalContentInner)
import ME from "ME";
...
function BountiesModalContentInner(bounty) {
  ...
  const BountyVideoEndMode = width(14336).BountyVideoEndMode;
  ...
  if (!stage1Enabled) {
    ...
    obj1[11] = duration;
    const bountiesModalTiming = tmp9(14336).useBountiesModalTiming(obj1);
    ...
    obj3[1] = videoDuration(tmp9(14342).BountyVideo, obj4);
    const items9 = [videoDuration(handleProgress, obj3), , ];
    let obj5 = { style: null, children: null };
    obj5[0] = memo2;
    const obj6 = { onPress: null };
    obj6[0] = callback2;
    obj5[1] = videoDuration(tmp2(14371), obj6);
    ...
    obj8[3] = callback3;
    obj7[5] = videoDuration(tmp2(14363), obj8);
