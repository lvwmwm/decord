...
// Dependencies: [5, 19, 17, 7079, 5128, 676, 505, 21, 1474, 1581, 4285, 712, 589, 9340, 10895, 14166, 14169, 10899, 14167, 14170, 7097, 7108, 7107, 5133, 10501, 14153, 14172, 11090, 14209, 14201, 5272, 14193, 10374, 3997, 2]
// Exports: default

// Module 14208 (BountiesModalContentInner)
import ME from "ME";
...
function BountiesModalContentInner(bounty) {
  ...
  const BountyVideoEndMode = width(14166).BountyVideoEndMode;
  ...
  if (!stage1Enabled) {
    ...
    obj1[11] = duration;
    const bountiesModalTiming = tmp9(14166).useBountiesModalTiming(obj1);
    ...
    obj3[1] = videoDuration(tmp9(14172).BountyVideo, obj4);
    const items9 = [videoDuration(handleProgress, obj3), , ];
    let obj5 = { style: null, children: null };
    obj5[0] = memo2;
    const obj6 = { onPress: null };
    obj6[0] = callback2;
    obj5[1] = videoDuration(tmp2(14201), obj6);
    ...
    obj8[3] = callback3;
    obj7[5] = videoDuration(tmp2(14193), obj8);
