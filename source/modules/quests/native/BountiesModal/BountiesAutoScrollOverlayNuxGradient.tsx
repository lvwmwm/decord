...
// Dependencies: [19, 17, 21, 712, 4050, 4190, 4193, 4611, 2]
// Exports: default

// Module 14075 (BountiesAutoScrollOverlayNuxGradient)
...
export default function BountiesAutoScrollOverlayNuxGradient(active) {
  ...
  obj[3] = { x: 0.5, y: 1 };
  obj[4] = { x: 0.5, y: 0 };
  const items3 = [callback(sharedValue(4611), obj), ];
  ...
  items3[1] = callback(sharedValue(4611), obj1);
  obj[2] = items3;
  return callback2(sharedValue(4050).View, obj);
};
