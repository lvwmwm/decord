...
// Dependencies: [109, 19, 17, 4181, 5033, 21, 4050, 4189, 712, 4190, 4193, 14063, 9475, 4605, 10492, 10494, 6011, 6010, 5038, 7635, 5141, 4185, 4600, 14032, 589, 14033, 8433, 2]
// Exports: default

// Module 14062 (BountiesModalAdvertiserCtaContent)
...
let closure_12 = require("module_4050").createAnimatedComponent(Pressable);
...
const fn2 = function s(value, fn2) {
  const obj = { opacity: null };
  obj[0] = require(4190) /* CONFIG_NEVER_ANIMATE_TIMING */.withTiming(value, require(4193) /* timingNone */.timingFast, "respect-motion-settings", fn2);
  return obj;
};
