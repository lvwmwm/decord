...
// Function ID: 14227
// Name: BouncingArrow
// Dependencies: [19, 17, 21, 4162, 4303, 4302, 712, 4005, 14227, 4298, 1236, 14229, 2]
// Exports: default

// Module 14226 (BouncingArrow)
...
function BouncingArrow(children) {
  ...
  return callback(importDefault(4162).View, { style, children: children.children });
}
...
export default function BountiesAutoScrollIndicator(showProgressRing) {
  ...
  const tmp6 = callback(_require(14227).ArrowSmallUpIcon, obj);
  _require = tmp6;
  ...
  if (flag) {
    ...
    let tmp5Result = tmp5(_require(14229).AnimatedCircularProgress, obj3);
  } else {
