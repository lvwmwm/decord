...
// Function ID: 14409
// Name: BouncingArrow
// Dependencies: [19, 17, 21, 4115, 4664, 4661, 712, 4097, 14409, 4734, 1236, 14411, 2]
// Exports: default
...
function BouncingArrow(children) {
  ...
  return callback(importDefault(4115).View, { style, children: children.children });
}
...
export default function BountiesAutoScrollIndicator(showProgressRing) {
  ...
  const tmp6 = callback(_require(14409).ArrowSmallUpIcon, obj);
  _require = tmp6;
