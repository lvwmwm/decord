...
// Function ID: 14169
// Name: BouncingArrow
// Dependencies: [19, 17, 21, 4116, 4256, 4255, 712, 3959, 14169, 4251, 1236, 14171, 2]
// Exports: default

// Module 14168 (BouncingArrow)
...
export default function BountiesAutoScrollIndicator(showProgressRing) {
  ...
  const tmp6 = callback(_require(14169).ArrowSmallUpIcon, obj);
  _require = tmp6;
  ...
  if (flag) {
    ...
    let tmp5Result = tmp5(_require(14171).AnimatedCircularProgress, obj3);
  } else {
