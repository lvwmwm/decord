...
// Function ID: 14477
// Name: BouncingArrow
// Dependencies: [19, 17, 21, 4119, 4671, 4668, 712, 4100, 14477, 4739, 1236, 14479, 2]
// Exports: default

// Module 14476 (BouncingArrow)
...
function BouncingArrow(children) {
  let sharedValue;
  sharedValue = sharedValue(4119).useSharedValue(0);
  ...
  const style = sharedValue(4119).useAnimatedStyle(fn);
  return callback(_modDef4119.View, { style, children: children.children });
}
...
export default function BountiesAutoScrollIndicator(showProgressRing) {
  ...
  const tmp6 = callback(_require(14477).ArrowSmallUpIcon, obj);
  _require = tmp6;
  ...
  if (flag) {
    ...
    let tmp5Result = tmp5(_require(14479).AnimatedCircularProgress, obj3);
  } else {
