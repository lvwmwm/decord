...
// Function ID: 14507
// Name: BouncingArrow
// Dependencies: [19, 17, 21, 4120, 4381, 4380, 712, 4101, 14507, 4376, 1236, 14509, 2]
// Exports: default

// Module 14506 (BouncingArrow)
...
function BouncingArrow(children) {
  let sharedValue;
  sharedValue = sharedValue(4120).useSharedValue(0);
  ...
  const style = sharedValue(4120).useAnimatedStyle(fn);
  return callback(_modDef4120.View, { style, children: children.children });
}
...
export default function BountiesAutoScrollIndicator(showProgressRing) {
  ...
  const tmp6 = callback(_require(14507).ArrowSmallUpIcon, obj);
  _require = tmp6;
  ...
  if (flag) {
    ...
    let tmp5Result = tmp5(_require(14509).AnimatedCircularProgress, obj3);
  } else {
