...
// Function ID: 14297
// Name: BouncingArrow
// Dependencies: [19, 17, 21, 4036, 4304, 4303, 712, 4005, 14297, 4299, 1236, 14299, 2]
// Exports: default

// Module 14296 (BouncingArrow)
...
function BouncingArrow(children) {
  ...
  return callback(importDefault(4036).View, { style, children: children.children });
}
...
export default function BountiesAutoScrollIndicator(showProgressRing) {
  ...
  const tmp6 = callback(_require(14297).ArrowSmallUpIcon, obj);
  _require = tmp6;
  ...
  if (flag) {
    ...
    let tmp5Result = tmp5(_require(14299).AnimatedCircularProgress, obj3);
  } else {
