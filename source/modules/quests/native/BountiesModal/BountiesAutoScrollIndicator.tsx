...
// Function ID: 14213
// Name: BouncingArrow
// Dependencies: [19, 17, 21, 4145, 4286, 4285, 712, 3988, 14213, 4281, 1236, 14215, 2]
// Exports: default

// Module 14212 (BouncingArrow)
...
function BouncingArrow(children) {
  let sharedValue;
  sharedValue = sharedValue(4145).useSharedValue(0);
  ...
  const style = sharedValue(4145).useAnimatedStyle(fn);
  return callback(importDefault(4145).View, { style, children: children.children });
}
...
export default function BountiesAutoScrollIndicator(showProgressRing) {
  ...
  const tmp6 = callback(_require(14213).ArrowSmallUpIcon, obj);
  _require = tmp6;
  ...
  if (flag) {
    ...
    let tmp5Result = tmp5(_require(14215).AnimatedCircularProgress, obj3);
  } else {
