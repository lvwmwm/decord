...
// Function ID: 14591
// Name: BouncingArrow
// Dependencies: [19, 17, 21, 4186, 4447, 4446, 712, 4166, 14591, 4442, 1236, 14593, 2]
// Exports: default

// Module 14590 (BouncingArrow)
...
export default function BountiesAutoScrollIndicator(showProgressRing) {
  ...
  const tmp6 = callback(_require(14591).ArrowSmallUpIcon, obj);
  _require = tmp6;
  ...
  if (flag) {
    ...
    let tmp5Result = tmp5(_require(14593).AnimatedCircularProgress, obj3);
  } else {
