...
// Function ID: 14203
// Name: BouncingArrow
// Dependencies: [19, 17, 21, 4146, 4286, 4285, 712, 3989, 14203, 4281, 1236, 14205, 2]
// Exports: default

// Module 14202 (BouncingArrow)
...
function BouncingArrow(children) {
  ...
  return callback(importDefault(4146).View, { style, children: children.children });
}
