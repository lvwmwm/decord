...
// Function ID: 14176
// Name: BouncingArrow
// Dependencies: [19, 17, 21, 4116, 4256, 4255, 712, 3959, 14176, 4251, 1236, 14178, 2]
// Exports: default

// Module 14175 (BouncingArrow)
...
function BouncingArrow(children) {
  ...
  const style = sharedValue(4116).useAnimatedStyle(fn);
  return callback(importDefault(4116).View, { style, children: children.children });
}
...
export default function BountiesAutoScrollIndicator(showProgressRing) {
  ...
  const tmp6 = callback(_require(14176).ArrowSmallUpIcon, obj);
  _require = tmp6;
  ...
  if (flag) {
    ...
    let tmp5Result = tmp5(_require(14178).AnimatedCircularProgress, obj3);
  } else {
