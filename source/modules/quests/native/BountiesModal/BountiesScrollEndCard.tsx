...
// Dependencies: [19, 17, 4247, 5099, 21, 4255, 712, 4256, 4259, 11018, 14154, 1236, 4116, 4677, 14157, 14159, 4251, 10127, 14123, 589, 14124, 8751, 2]
// Exports: default

// Module 14156 (BountiesScrollEndCardContent)
...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  obj = { isScrollingInBoundsSharedValue, withTiming: isActive(4256).withTiming, isActive, timingStandard: isActive(4259).timingStandard };
  fn.__closure = obj;
  ...
  items1[1] = callback(isScrollingInBoundsSharedValue(4677), obj2);
  if (isBountiesVerticalScrollExperimentEnabled) {
    ...
    obj4[2] = !isActive;
    const items3 = [tmp10(tmp9(14157), obj4), ];
    ...
    obj6[5] = !isActive;
    obj5[2] = tmp10(tmp9(14159), obj6);
    items3[1] = tmp10(tmp11, obj5);
    obj3[2] = items3;
    let tmp10Result = tmp8(tmp9(4116).View, obj3);
  } else {
    let tmp13;
    if (isActive) {
      tmp13 = onReplay;
    ...
    items6[1] = tmp10(tmp2(10127).RetryIcon, obj12);
    obj8[1] = items6;
    obj7[5] = tmp8(tmp9(4116).View, obj8);
    tmp10Result = tmp10(closure_4, obj7);
    const tmp12 = closure_4;
  }
  items1[2] = tmp10Result;
  obj[2] = items1;
  return closure_10(isScrollingInBoundsSharedValue(4116).View, obj);
}
...
export default function BountiesScrollEndCard(visible) {
  ...
  if (isBountiesModalTransitionsRefactorEnabled) {
    ...
    const tmp14 = importDefault(8751);
