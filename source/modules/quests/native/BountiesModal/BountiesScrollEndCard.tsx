...
// Dependencies: [19, 17, 4470, 5387, 21, 4478, 712, 4479, 4482, 11119, 14643, 1236, 4217, 4940, 14646, 14648, 4474, 9408, 14612, 589, 14613, 8979, 2]
// Exports: default

// Module 14645 (BountiesScrollEndCardContent)
...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  if (isBountiesVerticalScrollExperimentEnabled) {
    ...
    obj4[2] = !isActive;
    const items3 = [tmp10(tmp9(14646), obj4), ];
    ...
    items6[1] = tmp10(tmp2(9408).RetryIcon, obj12);
    obj8[1] = items6;
