...
// Dependencies: [19, 17, 4247, 5113, 21, 4255, 712, 4256, 4259, 10868, 14161, 1236, 4116, 4676, 14164, 14166, 4251, 9748, 14130, 589, 14131, 8553, 2]
// Exports: default

// Module 14163 (BountiesScrollEndCardContent)
...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  items1[1] = callback(isScrollingInBoundsSharedValue(4676), obj2);
  if (isBountiesVerticalScrollExperimentEnabled) {
    ...
    obj4[2] = !isActive;
    const items3 = [tmp10(tmp9(14164), obj4), ];
    ...
    items6[1] = tmp10(tmp2(9748).RetryIcon, obj12);
    obj8[1] = items6;
...
export default function BountiesScrollEndCard(visible) {
  ...
  if (isBountiesModalTransitionsRefactorEnabled) {
    ...
    const tmp14 = importDefault(8553);
