...
// Dependencies: [19, 17, 4277, 21, 4285, 712, 500, 1236, 4281, 9326, 589, 3996, 2]
// Exports: BountiesScrollRecapFooter, BountiesScrollRecapFooterGradient

// Module 14205 (BountiesScrollRecapFooter)
import "noop";
...
export const BountiesScrollRecapFooterGradient = function BountiesScrollRecapFooterGradient() {
  ...
  obj[1] = closure_5(require(3996) /* ManaContext */.BountiesScrollGradientRive, { stateMachine: "State Machine 1", fit: "fill", alignment: "bottom-center", withReducedMotion: str });
