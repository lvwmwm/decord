...
// Dependencies: [19, 17, 4181, 21, 4189, 712, 500, 1236, 4185, 8705, 589, 3901, 2]
// Exports: BountiesScrollRecapFooter, BountiesScrollRecapFooterGradient

// Module 14074 (BountiesScrollRecapFooter)
import "noop";
...
export const BountiesScrollRecapFooter = function BountiesScrollRecapFooter(orbAmount) {
  ...
  const items1 = [callback(require(8705) /* OrbsIcon */.OrbsIcon, { size: "sm", color: "icon-strong", accessible: false }), ];
...
export const BountiesScrollRecapFooterGradient = function BountiesScrollRecapFooterGradient() {
  ...
  obj[1] = closure_5(require(3901) /* ManaContext */.BountiesScrollGradientRive, { stateMachine: "State Machine 1", fit: "fill", alignment: "bottom-center", withReducedMotion: str });
