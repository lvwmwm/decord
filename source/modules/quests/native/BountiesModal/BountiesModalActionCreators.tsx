...
// Dependencies: [4550, 14315, 2007, 2]
...
export default {
  showModal(arg0) {
    ...
    importDefault(4550).pushLazy(require(2007) /* asyncRequireImpl */(14315, dependencyMap.paths), { bountyId, sourceQuestContent }, BOUNTIES_MODAL);
  },
  hideModal() {
