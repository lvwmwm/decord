...
// Dependencies: [4509, 14248, 1988, 2]

// Module 14247 (BOUNTIES_MODAL_KEY)
...
export default {
  showModal(arg0) {
    ...
    importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(14248, dependencyMap.paths), { bountyId, sourceQuestContent }, BOUNTIES_MODAL);
  },
  hideModal() {
