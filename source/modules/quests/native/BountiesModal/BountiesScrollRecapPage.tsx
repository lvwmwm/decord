...
// Dependencies: [19, 17, 4294, 21, 712, 4302, 500, 9321, 14222, 8810, 14223, 1609, 589, 14224, 4298, 1236, 9343, 4712, 2]
// Exports: BountiesScrollRecapPage

// Module 14221 (BountiesRecapOrbsBackground)
import "noop";
...
function BountiesRecapOrbsBackground(arg0) {
  ...
  if (obj.isAndroid()) {
    ...
    obj[0] = importDefault(14222);
    obj[1] = closure_3.absoluteFillObject;
    obj[2] = !reducedMotion;
    obj[4] = tmp3(tmp(9321).APNGPlayer, obj);
    ...
    const obj2 = { uri: null };
    obj2[0] = importDefault(14223);
    obj1[0] = obj2;
    obj1[1] = style;
    obj1[3] = reducedMotion;
    tmp3Result = tmp3(tmp(8810).VideoComponent, obj1);
  }
  return tmp3Result;
}
...
export const BountiesScrollRecapPage = function BountiesScrollRecapPage(orbAmount) {
  ...
  const obj2 = { uri: null };
  obj2[0] = importDefault(14224);
  obj1[0] = obj2;
  obj1[1] = closure_3.absoluteFillObject;
  obj1[3] = stateFromStores;
  const items2 = [callback(require(8810) /* VideoComponent */.VideoComponent, obj1), callback(BountiesRecapOrbsBackground, { style: tmp.orbsBackground, reducedMotion: stateFromStores })];
  obj[2] = items2;
  ...
  const items4 = [callback(require(4298) /* Text */.Text, obj6), , ];
  ...
  const items5 = [callback(require(9343) /* OrbsIcon */.OrbsIcon, { size: "lg", color: "icon-strong", accessible: false }), ];
  const obj9 = { variant: "display-lg", color: "text-strong", accessible: false, style: tmp.orbAmount, children: null };
  obj9[4] = "+" + orbAmount;
  items5[1] = callback(require(4298) /* Text */.Text, obj9);
  obj8[1] = items5;
  ...
  items4[2] = callback(require(4298) /* Text */.Text, obj10);
  obj5[2] = items4;
  ...
  obj13[4] = onClose;
  obj11[1] = callback(require(4712) /* Button */.Button, obj13);
