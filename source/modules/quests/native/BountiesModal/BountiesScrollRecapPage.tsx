...
// Dependencies: [31, 27, 4157, 33, 689, 4165, 477, 6187, 14055, 8118, 14056, 1557, 566, 14057, 4161, 1212, 8681, 4578, 2]
// Exports: BountiesScrollRecapPage

// Module 14054 (BountiesRecapOrbsBackground)
import "result";
...
function BountiesRecapOrbsBackground(arg0) {
  ...
  if (obj.isAndroid()) {
    ...
    obj = { url: importDefault(14055), style: closure_3.absoluteFillObject, autoplay: !reducedMotion };
    obj.children = callback(require(6187) /* useAPNGPlayerControls */.APNGPlayer, obj);
    ...
    const obj2 = { uri: importDefault(14056) };
    obj1.source = obj2;
    obj1.style = style;
    obj1.paused = reducedMotion;
    tmpResult = tmp(require(8118) /* _isNativeReflectConstruct */.VideoComponent, obj1);
  }
  return tmpResult;
}
...
export const BountiesScrollRecapPage = function BountiesScrollRecapPage(orbAmount) {
  ...
  const obj2 = { uri: importDefault(14057) };
  obj1.source = obj2;
  obj1.style = closure_3.absoluteFillObject;
  obj1.paused = stateFromStores;
  const items2 = [callback(require(8118) /* _isNativeReflectConstruct */.VideoComponent, obj1), callback(BountiesRecapOrbsBackground, { style: tmp.orbsBackground, reducedMotion: stateFromStores })];
  obj.children = items2;
  ...
  const items5 = [callback(require(8681) /* OrbsIcon */.OrbsIcon, { size: "lg", color: "icon-strong", accessible: false }), ];
  const obj9 = { variant: "display-lg", color: "text-strong", accessible: false, style: tmp.orbAmount, children: "+" + orbAmount };
  items5[1] = callback(require(4161) /* Text */.Text, obj9);
  ...
  items4[2] = callback(require(4161) /* Text */.Text, obj10);
  ...
  obj11.children = callback(require(4578) /* Button */.Button, obj13);
