...
// Dependencies: [19, 17, 4277, 21, 712, 4285, 500, 9304, 14208, 8793, 14209, 1609, 589, 14210, 4281, 1236, 9326, 4695, 2]
// Exports: BountiesScrollRecapPage

// Module 14207 (BountiesRecapOrbsBackground)
import "noop";
...
export const BountiesScrollRecapPage = function BountiesScrollRecapPage(orbAmount) {
  ...
  const obj2 = { uri: null };
  obj2[0] = importDefault(14210);
  obj1[0] = obj2;
  obj1[1] = closure_3.absoluteFillObject;
  obj1[3] = stateFromStores;
  const items2 = [callback(require(8793) /* VideoComponent */.VideoComponent, obj1), callback(BountiesRecapOrbsBackground, { style: tmp.orbsBackground, reducedMotion: stateFromStores })];
  obj[2] = items2;
  ...
  const items4 = [callback(require(4281) /* Text */.Text, obj6), , ];
  ...
  const items5 = [callback(require(9326) /* OrbsIcon */.OrbsIcon, { size: "lg", color: "icon-strong", accessible: false }), ];
  const obj9 = { variant: "display-lg", color: "text-strong", accessible: false, style: tmp.orbAmount, children: null };
  obj9[4] = "+" + orbAmount;
  items5[1] = callback(require(4281) /* Text */.Text, obj9);
  obj8[1] = items5;
  ...
  items4[2] = callback(require(4281) /* Text */.Text, obj10);
  obj5[2] = items4;
  ...
  obj13[4] = onClose;
  obj11[1] = callback(require(4695) /* Button */.Button, obj13);
