...
// Dependencies: [19, 17, 4336, 21, 712, 4344, 500, 9432, 14359, 8915, 14360, 1628, 589, 14361, 4340, 1236, 9454, 4754, 2]
...
function BountiesRecapOrbsBackground(arg0) {
  ...
  if (obj.isAndroid()) {
    ...
    obj[2] = !reducedMotion;
    obj[4] = tmp3(tmp(9432).APNGPlayer, obj);
    ...
    tmp3Result = tmp3(tmp(8915).VideoComponent, obj1);
  }
  return tmp3Result;
}
...
export const BountiesScrollRecapPage = function BountiesScrollRecapPage(orbAmount) {
  ...
  const items2 = [callback(require(8915) /* VideoComponent */.VideoComponent, obj1), callback(BountiesRecapOrbsBackground, { style: tmp.orbsBackground, reducedMotion: stateFromStores })];
  obj[2] = items2;
  ...
  const items4 = [callback(require(4340) /* Text */.Text, obj6), , ];
  ...
  const items5 = [callback(require(9454) /* OrbsIcon */.OrbsIcon, { size: "lg", color: "icon-strong", accessible: false }), ];
  const obj9 = { variant: "display-lg", color: "text-strong", accessible: false, style: tmp.orbAmount, children: null };
  obj9[4] = "+" + orbAmount;
  items5[1] = callback(require(4340) /* Text */.Text, obj9);
  obj8[1] = items5;
  ...
  items4[2] = callback(require(4340) /* Text */.Text, obj10);
  obj5[2] = items4;
  ...
  obj13[4] = onClose;
  obj11[1] = callback(require(4754) /* Button */.Button, obj13);
