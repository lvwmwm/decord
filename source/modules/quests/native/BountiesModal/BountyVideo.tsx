...
// Function ID: 14146
// Name: BountyVideo
// Dependencies: [32, 19, 17, 5113, 21, 501, 10358, 712, 4255, 14146, 10867, 10868, 4116, 3959, 4256, 4259, 14135, 14147, 14157, 5221, 14158, 14160, 14162, 10026, 2]
// Exports: BountyVideo

// Module 14145 (BountyVideo)
...
let closure_15 = createCacheKey.createStyles(() => {
  ...
  obj[1] = obj;
  obj[2] = { position: "absolute", bottom: 0, height: require(14146) /* BountiesModalProgress */.PROGRESS_BAR_HEIGHT, left: lg, right: lg };
  const obj2 = {};
