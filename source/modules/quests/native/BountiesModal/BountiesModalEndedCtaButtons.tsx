...
// Dependencies: [21, 4255, 712, 10646, 4116, 4256, 4259, 14154, 4666, 10648, 7096, 5104, 7095, 1236, 2]
// Exports: default

// Module 14159 (BountiesModalEndedCtaButtons)
...
export default function BountiesModalEndedCtaButtons(bounty) {
  ...
  if (visible) {
    ...
    const items1 = [callback(tmp2(4666).Button, obj1), ];
    let tmp9Result = null;
    if (showCloseButton) {
      ...
      tmp9Result = tmp9(tmp2(4666).Button, obj2);
    }
    items1[1] = tmp9Result;
    obj[1] = items1;
