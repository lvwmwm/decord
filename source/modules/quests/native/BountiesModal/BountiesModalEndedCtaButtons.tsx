...
// Dependencies: [21, 4255, 712, 10375, 4116, 4256, 4259, 14161, 4665, 10377, 7082, 5118, 7081, 1236, 2]
// Exports: default

// Module 14166 (BountiesModalEndedCtaButtons)
...
export default function BountiesModalEndedCtaButtons(bounty) {
  ...
  let callback;
  let obj = bounty(10375);
  callback = obj.useGetQuestImpressionId();
  let obj1 = bounty(4116);
  const fn = function y() {
  ...
  obj = { withTiming: bounty(4256).withTiming, visible, timingStandard: bounty(4259).timingStandard };
  fn.__closure = obj;
  ...
  if (visible) {
    ...
    const items1 = [callback(tmp2(4665).Button, obj1), ];
    let tmp9Result = null;
    if (showCloseButton) {
      ...
      tmp9Result = tmp9(tmp2(4665).Button, obj2);
    }
    items1[1] = tmp9Result;
    obj[1] = items1;
    visible = closure_4(visible(4116).View, obj);
