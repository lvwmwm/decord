...
// Dependencies: [21, 4380, 712, 10562, 4120, 4381, 4384, 14492, 4815, 10564, 7321, 5273, 7332, 1236, 2]
// Exports: default

// Module 14497 (BountiesModalEndedCtaButtons)
...
export default function BountiesModalEndedCtaButtons(bounty) {
  ...
  obj = { withTiming: bounty(4381).withTiming, visible, timingStandard: bounty(4384).timingStandard };
  fn.__closure = obj;
  ...
  if (visible) {
    ...
    const items1 = [callback(tmp2(4815).Button, obj1), ];
    let tmp9Result = null;
    if (showCloseButton) {
      ...
      tmp9Result = tmp9(tmp2(4815).Button, obj2);
    }
    items1[1] = tmp9Result;
    obj[1] = items1;
    visible = closure_4(visible(4120).View, obj);
