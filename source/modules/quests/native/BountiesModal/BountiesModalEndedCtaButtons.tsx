...
// Dependencies: [21, 4444, 712, 10630, 4184, 4445, 4448, 14565, 4879, 10632, 7387, 5339, 7398, 1236, 2]
// Exports: default

// Module 14570 (BountiesModalEndedCtaButtons)
...
export default function BountiesModalEndedCtaButtons(bounty) {
  ...
  obj = { withTiming: bounty(4445).withTiming, visible, timingStandard: bounty(4448).timingStandard };
  fn.__closure = obj;
  ...
  if (visible) {
    ...
    const items1 = [callback(tmp2(4879).Button, obj1), ];
    let tmp9Result = null;
    if (showCloseButton) {
      ...
      tmp9Result = tmp9(tmp2(4879).Button, obj2);
    }
    items1[1] = tmp9Result;
    obj[1] = items1;
    visible = closure_4(visible(4184).View, obj);
