...
// Dependencies: [21, 4342, 712, 10451, 4083, 4343, 4346, 14349, 4755, 10453, 7222, 5207, 7233, 1236, 2]
// Exports: default

// Module 14354 (BountiesModalEndedCtaButtons)
...
export default function BountiesModalEndedCtaButtons(bounty) {
  ...
  let callback;
  let obj = bounty(10451);
  callback = obj.useGetQuestImpressionId();
  let obj1 = bounty(4083);
  const fn = function y() {
  ...
  obj = { withTiming: bounty(4343).withTiming, visible, timingStandard: bounty(4346).timingStandard };
  fn.__closure = obj;
  ...
  if (visible) {
    ...
    const items1 = [callback(tmp2(4755).Button, obj1), ];
    let tmp9Result = null;
    if (showCloseButton) {
      ...
      tmp9Result = tmp9(tmp2(4755).Button, obj2);
    }
    items1[1] = tmp9Result;
    obj[1] = items1;
    visible = closure_4(visible(4083).View, obj);
