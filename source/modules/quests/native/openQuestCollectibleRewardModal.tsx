...
// Dependencies: [1903, 5143, 21, 4285, 712, 589, 10394, 10377, 4281, 1236, 7087, 10042, 2]
// Exports: openQuestCollectibleRewardModal

// Module 11101 (QuestCollectibleRewardModalMessages)
...
function QuestCollectibleRewardModalMessages(quest) {
  ...
  obj = { children: null };
  const claimedCollectibleRewardMessage = require(10377) /* useQuests */.useClaimedCollectibleRewardMessage(quest.config);
...
export const openQuestCollectibleRewardModal = function openQuestCollectibleRewardModal(onSuccess) {
  ...
  if (null != product) {
    ...
    importDefault(10042).open(obj);
    const obj4 = importDefault(10042);
  } else {
