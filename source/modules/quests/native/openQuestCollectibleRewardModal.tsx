...
// Dependencies: [1874, 5037, 21, 4193, 712, 589, 9495, 10505, 4189, 1236, 5995, 9804, 2]
...
function QuestCollectibleRewardModalMessages(quest) {
  ...
  obj = { children: null };
  const claimedCollectibleRewardMessage = require(10505) /* useQuests */.useClaimedCollectibleRewardMessage(quest.config);
