...
// Dependencies: [19, 17, 21, 4285, 712, 4253, 14222, 7654, 1236, 6053, 4695, 2]
// Exports: default

// Module 14223 (BountiesNuxPromoSheet)
...
export default function BountiesNuxPromoSheet() {
  const callback = React.useCallback(() => {
    callback2(4253).hideActionSheet(callback(14222).PROMO_SHEET_KEY);
  }, []);
  ...
  obj = { style: createCacheKey().illustrationContainer, children: jsx(require(6053) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 }) };
  obj[3] = <View style={createCacheKey().illustrationContainer}>{jsx(require(6053) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 })}</View>;
