...
// Dependencies: [19, 17, 21, 4303, 712, 4271, 14316, 7735, 1236, 6134, 4714, 2]
// Exports: default

// Module 14317 (BountiesNuxPromoSheet)
...
export default function BountiesNuxPromoSheet() {
  ...
  obj = { style: createCacheKey().illustrationContainer, children: jsx(require(6134) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 }) };
  obj[3] = <View style={createCacheKey().illustrationContainer}>{jsx(require(6134) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 })}</View>;
  ...
  obj[4] = callback;
  obj[4] = jsx(require(4714) /* Button */.Button, { grow: true, size: "lg", variant: "primary", text: null, onPress: null });
