...
// Dependencies: [19, 17, 21, 4302, 712, 4270, 14236, 7673, 1236, 6072, 4712, 2]
// Exports: default

// Module 14237 (BountiesNuxPromoSheet)
...
export default function BountiesNuxPromoSheet() {
  const callback = React.useCallback(() => {
    callback2(4270).hideActionSheet(callback(14236).PROMO_SHEET_KEY);
  }, []);
  ...
  obj = { style: createCacheKey().illustrationContainer, children: jsx(require(6072) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 }) };
  obj[3] = <View style={createCacheKey().illustrationContainer}>{jsx(require(6072) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 })}</View>;
  ...
  obj[4] = callback;
  obj[4] = jsx(require(4712) /* Button */.Button, { grow: true, size: "lg", variant: "primary", text: null, onPress: null });
