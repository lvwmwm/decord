...
export default function BountiesNuxPromoSheet() {
  ...
  obj = { style: createCacheKey().illustrationContainer, children: jsx(require(6132) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 }) };
  obj[3] = <View style={createCacheKey().illustrationContainer}>{jsx(require(6132) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 })}</View>;
