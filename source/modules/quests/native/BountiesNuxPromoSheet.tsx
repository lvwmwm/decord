...
// Dependencies: [19, 17, 21, 4344, 712, 4312, 14373, 7774, 1236, 6173, 4754, 2]
// Exports: default
...
export default function BountiesNuxPromoSheet() {
  ...
  obj = { style: createCacheKey().illustrationContainer, children: jsx(require(6173) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 }) };
  obj[3] = <View style={createCacheKey().illustrationContainer}>{jsx(require(6173) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 })}</View>;
  ...
  obj[4] = callback;
  obj[4] = jsx(require(4754) /* Button */.Button, { grow: true, size: "lg", variant: "primary", text: null, onPress: null });
