...
// Dependencies: [19, 17, 21, 4342, 712, 4310, 14386, 7799, 1236, 6196, 4777, 2]
// Exports: default

// Module 14387 (BountiesNuxPromoSheet)
...
export default function BountiesNuxPromoSheet() {
  const callback = React.useCallback(() => {
    callback2(4310).hideActionSheet(callback(14386).PROMO_SHEET_KEY);
  }, []);
  ...
  obj = { style: createCacheKey().illustrationContainer, children: jsx(require(6196) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 }) };
  obj[3] = <View style={createCacheKey().illustrationContainer}>{jsx(require(6196) /* BountiesPosterSpotIllustration */.BountiesPosterSpotIllustration, { width: 273, height: 205 })}</View>;
  ...
  obj[4] = callback;
  obj[4] = jsx(require(4777) /* Button */.Button, { grow: true, size: "lg", variant: "primary", text: null, onPress: null });
