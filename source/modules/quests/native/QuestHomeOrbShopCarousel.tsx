...
// Function ID: 14389
// Name: ListEdgeSpacer
// Dependencies: [32, 19, 17, 7199, 5201, 21, 712, 9390, 14377, 11041, 589, 4340, 1236, 14389, 14390, 7786, 7217, 7227, 9393, 5754, 2]
...
function QuestHomeOrbShopCarouselHeading(orbAmount) {
  ...
  obj[1] = callback(require(4340) /* Text */.Heading, obj);
...
function QuestHomeOrbShopCarouselPlaceholder() {
  ...
  return callback(require(7786) /* noop */.FlashList, obj);
}
