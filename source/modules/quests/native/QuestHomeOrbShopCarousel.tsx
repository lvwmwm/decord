...
// Module 13866 (_createForOfIteratorHelperLoose)
...
function QuestHomeOrbShopCarouselPlaceholder() {
  ...
  const obj = { "Null": 950738584148872700000000000000, "Null": 0.00019836452249855088 };
  const intl = arg1(dependencyMap[12]).intl;
...
export default function QuestHomeOrbShopCarousel(orbShopProducts) {
  ...
  if (obtainableOrbRewards > 0) {
    ...
    if (flag) {
      ...
      const obj3 = { "Null": 950738584148872700000000000000, "Null": 0.00019836452249855088 };
      const intl = arg1(dependencyMap[12]).intl;
