...
// Dependencies: [32, 19, 17, 4295, 11172, 7161, 7183, 5161, 676, 21, 4303, 712, 589, 1499, 14257, 709, 8565, 8572, 14314, 4714, 1236, 4509, 6018, 10465, 10986, 4299, 4846, 14316, 4259, 14318, 10466, 1628, 7159, 10467, 7189, 4021, 8451, 698, 9355, 503, 14338, 12224, 14339, 1500, 5164, 7182, 14321, 14331, 11181, 14340, 14418, 7747, 2]

// Module 14256 (EmptyStateNoQuestsAvailable)
...
function EmptyStateNoQuestsAvailable() {
  ...
  obj[2] = callback;
  obj[0] = callback2(navigation(4714).Button, obj);
  return callback2(importDefault(14314), obj);
}
function EmptyStateFiltered(onClearFilters) {
  ...
  obj[0] = callback2(require(4714) /* Button */.Button, obj);
...
function HeaderPreviewButton() {
  ...
  if (obj.useShouldShowPreviewToolTab()) {
    ...
    obj[1] = callback2(tmp3(4714).Button, obj);
...
function HeaderWithBounties(arg0) {
  ...
  const tmp = callback3();
  let obj = require(10986) /* useBountiesExperience */;
  ...
  if (!verticalScrollEnabled) {
    ...
    const items2 = [tmp6(tmp2(4299).Text, obj), ];
    const obj1 = { onPress: null, hitSlop: 14, "aria-label": null, accessibilityRole: "button", children: null };
    obj1[0] = importDefault(14316);
    const intl2 = tmp2(1236).intl;
    obj1[2] = intl2.string(tmp2(1236).t.hvVgAZ);
    const obj2 = { size: "xs", color: null };
    obj2[1] = importDefault(712).colors.ICON_SUBTLE;
    obj1[4] = tmp6(tmp2(4259).CircleInformationIcon, obj2);
    items2[1] = tmp6(tmp2(4846).PressableOpacity, obj1);
    obj[1] = items2;
    tmp4Result = tmp4(closure_5, obj);
  }
  const obj3 = { children: null };
  items[1] = tmp4Result;
  items[2] = callback2(importDefault(14318), { verticalScrollEnabled, orbShopProducts, obtainableOrbRewards, showOrbShopPlaceholderCarousel });
  ...
  obj4[1] = callback2(require(4299) /* Text */.Text, obj5);
...
const memoResult = importAllResult.memo(function QuestHome(filters) {
  ...
  const filteredQuests = obj1.useFilteredQuests(memo(10465).QuestTabs.ALL, importAllResult.useMemo(() => ({ filters: navigation, sortMethod: closure_2 }), items));
  ...
  obj = { utm_source_current: tmp24.utmSourceCurrent, utm_medium_current: tmp24.utmMediumCurrent, utm_campaign_current: tmp24.utmCampaignCurrent, utm_content_current: tmp24.utmContentCurrent, tab: memo(10465).QuestTabs.ALL };
  obj[2] = obj;
  navigation(9355)(obj);
  ...
  const tmp25 = navigation(9355);
  let tmp5 = navigation;
  showBounties = memo(12224).useVirtualCurrencyMobileEnabled().enabled;
  const obj10 = memo(12224);
  const bountiesExperience = memo(10986).useBountiesExperience(callback4.QUEST_HOME_MOBILE);
  verticalScrollEnabled = bountiesExperience.verticalScrollEnabled;
  const OrbsHoldoutExperiment = memo(14339).OrbsHoldoutExperiment;
  obj2 = { location: callback4.QUEST_HOME_MOBILE };
  const obj11 = memo(10986);
  ...
  const BountiesShopCarouselExperiment = tmp(14321).BountiesShopCarouselExperiment;
  obj3 = { location: tmp30.QUEST_HOME_MOBILE };
  const config = BountiesShopCarouselExperiment.useConfig(obj3);
  ({ enabled, variation } = config);
  const obj13 = memo(1500);
  if (enabled) {
    enabled = showBounties;
  }
  const questHomeOrbShopCarouselData = memo(14331).useQuestHomeOrbShopCarouselData({ enabled, variation });
  ...
  if (!isEligibleForQuests) {
    ...
    obj6[10] = callback1;
    obj6[11] = callback3;
    tmp63Result = verticalScrollEnabled(tmp(7747).FlashList, obj6);
