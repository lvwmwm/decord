...
// Dependencies: [32, 19, 17, 4372, 11327, 7305, 7327, 5268, 676, 21, 4380, 712, 589, 1500, 14457, 709, 4598, 4606, 14514, 4815, 1236, 4611, 6125, 10531, 11068, 4376, 4949, 14516, 4335, 14518, 10532, 1629, 7303, 10533, 7321, 4098, 8602, 698, 9497, 503, 14538, 12428, 14539, 1501, 5271, 7326, 14521, 14531, 11336, 14540, 14618, 7890, 2]

// Module 14456 (EmptyStateNoQuestsAvailable)
import ThemesDefault from "Themes" /* 712 */;
import getSystemLocale from "getSystemLocale" /* 1236 */;
import Text from "Text" /* 4376 */;
import Button from "Button" /* 4815 */;
import useQuests from "useQuests" /* 10531 */;
import useBountiesExperience from "useBountiesExperience" /* 11068 */;
import QuestHomeEmptyStateDefault from "QuestHomeEmptyState" /* 14514 */;
import openBountiesNuxPromoSheetDefault from "openBountiesNuxPromoSheet" /* 14516 */;
import EmptyStateDefault from "EmptyState" /* 14518 */;
import closure_3 from "_slicedToArray" /* 32 */;
import importAllResult from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import closure_7 from "maybeApplyNoTextColorForLightCustomTheme" /* 4372 */;
import closure_8 from "zustandStore" /* 11327 */;
import closure_9 from "initializeState" /* 7305 */;
import closure_10 from "keys" /* 7327 */;
...
function EmptyStateNoQuestsAvailable() {
  ...
  obj[2] = callback;
  obj[0] = callback2(navigation(4815).Button, obj);
...
function HeaderPreviewButton() {
  ...
  if (obj.useShouldShowPreviewToolTab()) {
    ...
    obj[1] = callback2(tmp3(4815).Button, obj);
...
function HeaderWithBounties(arg0) {
  ...
  if (!verticalScrollEnabled) {
    ...
    const items2 = [tmp6(tmp2(4376).Text, obj), ];
    ...
    obj1[4] = tmp6(tmp2(4335).CircleInformationIcon, obj2);
    items2[1] = tmp6(tmp2(4949).PressableOpacity, obj1);
    obj[1] = items2;
...
const memoResult = importAllResult.memo(function QuestHome(filters) {
  ...
  const filteredQuests = obj1.useFilteredQuests(_require(10531).QuestTabs.ALL, importAllResult.useMemo(() => ({ filters: navigation, sortMethod: closure_2 }), items));
  ...
  obj = { utm_source_current: tmp24.utmSourceCurrent, utm_medium_current: tmp24.utmMediumCurrent, utm_campaign_current: tmp24.utmCampaignCurrent, utm_content_current: tmp24.utmContentCurrent, tab: _require(10531).QuestTabs.ALL };
  obj[2] = obj;
  navigation(9497)(obj);
  ...
  const tmp25 = navigation(9497);
  let tmp5 = navigation;
  showBounties = _require(12428).useVirtualCurrencyMobileEnabled().enabled;
  const obj10 = _require(12428);
  const bountiesExperience = _require(11068).useBountiesExperience(callback4.QUEST_HOME_MOBILE);
  verticalScrollEnabled = bountiesExperience.verticalScrollEnabled;
  const OrbsHoldoutExperiment = _require(14539).OrbsHoldoutExperiment;
  obj2 = { location: callback4.QUEST_HOME_MOBILE };
  const obj11 = _require(11068);
  ...
  const BountiesShopCarouselExperiment = tmp(14521).BountiesShopCarouselExperiment;
  ...
  const questHomeOrbShopCarouselData = _require(14531).useQuestHomeOrbShopCarouselData({ enabled, variation });
  ...
  _require = tmp37;
  const tmpResult1 = _require(14531);
  ...
  if (!isEligibleForQuests) {
    ...
    obj6[10] = callback1;
    obj6[11] = callback3;
    tmp63Result = verticalScrollEnabled(tmp(7890).FlashList, obj6);
