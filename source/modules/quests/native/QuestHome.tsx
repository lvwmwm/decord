...
// Dependencies: [32, 19, 17, 4277, 11085, 7081, 7103, 5143, 676, 21, 4285, 712, 589, 1480, 14163, 709, 8482, 8489, 14220, 4695, 1236, 4490, 5937, 10377, 10899, 4281, 4827, 14222, 4241, 14224, 10378, 1609, 7079, 10379, 7109, 3985, 8368, 698, 9267, 503, 14244, 12137, 14245, 1481, 5146, 7102, 14227, 14237, 11094, 14246, 14321, 7666, 2]

// Module 14162 (EmptyStateNoQuestsAvailable)
...
function EmptyStateNoQuestsAvailable() {
  ...
  return callback2(importDefault(14220), obj);
}
...
function HeaderPreviewButton() {
  ...
  if (obj.useShouldShowPreviewToolTab()) {
    ...
    obj[1] = callback2(tmp3(4695).Button, obj);
...
function HeaderWithBounties(arg0) {
  ...
  const tmp = callback3();
  let obj = require(10899) /* useBountiesExperience */;
  ...
  if (!verticalScrollEnabled) {
    ...
    items2[1] = tmp6(tmp2(4827).PressableOpacity, obj1);
    obj[1] = items2;
    tmp4Result = tmp4(closure_5, obj);
  }
  const obj3 = { children: null };
  items[1] = tmp4Result;
  items[2] = callback2(importDefault(14224), { verticalScrollEnabled, orbShopProducts, obtainableOrbRewards, showOrbShopPlaceholderCarousel });
...
const memoResult = importAllResult.memo(function QuestHome(filters) {
  ...
  const filteredQuests = obj1.useFilteredQuests(memo(10377).QuestTabs.ALL, importAllResult.useMemo(() => ({ filters: navigation, sortMethod: closure_2 }), items));
  ...
  obj = { utm_source_current: tmp24.utmSourceCurrent, utm_medium_current: tmp24.utmMediumCurrent, utm_campaign_current: tmp24.utmCampaignCurrent, utm_content_current: tmp24.utmContentCurrent, tab: memo(10377).QuestTabs.ALL };
  obj[2] = obj;
  navigation(9267)(obj);
  ...
  const tmp25 = navigation(9267);
  let tmp5 = navigation;
  showBounties = memo(12137).useVirtualCurrencyMobileEnabled().enabled;
  const obj10 = memo(12137);
  const bountiesExperience = memo(10899).useBountiesExperience(callback4.QUEST_HOME_MOBILE);
  verticalScrollEnabled = bountiesExperience.verticalScrollEnabled;
  const OrbsHoldoutExperiment = memo(14245).OrbsHoldoutExperiment;
  obj2 = { location: callback4.QUEST_HOME_MOBILE };
  const obj11 = memo(10899);
  ...
  const BountiesShopCarouselExperiment = tmp(14227).BountiesShopCarouselExperiment;
  ...
  const questHomeOrbShopCarouselData = memo(14237).useQuestHomeOrbShopCarouselData({ enabled, variation });
  ...
  if (!isEligibleForQuests) {
    ...
    obj6[10] = callback1;
    obj6[11] = callback3;
    tmp63Result = verticalScrollEnabled(tmp(7666).FlashList, obj6);
