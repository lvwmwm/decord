...
// Dependencies: [5, 19, 17, 8708, 7453, 6716, 8703, 21, 4661, 712, 589, 10957, 6719, 8035, 9416, 1236, 8944, 7145, 7476, 11231, 10684, 10954, 14474, 8705, 4342, 10947, 9067, 10496, 6950, 5449, 4756, 691, 10950, 12048, 14504, 4733, 4734, 4745, 14470, 2]
// Exports: default
...
function contextMenuButton(arg0) {
  ...
  obj.size = "sm";
  return callback2(require(8035) /* IconButton */.IconButton, obj);
}
