...
// Dependencies: [5, 19, 4054, 4382, 7200, 5201, 10511, 10651, 505, 14399, 7215, 589, 5204, 7198, 14422, 7228, 9808, 4199, 14424, 7682, 10506, 10507, 10518, 7223, 10653, 7221, 10704, 5768, 10654, 11038, 2]
...
// Module 14398 (useDeliveredDockCreative)
...
function useIsMobileQuestDockRenderedBase(mobileQuestDock) {
  const deliveredQuest = require(14424) /* getDeliveredQuest */.getDeliveredQuest(mobileQuestDock);
  const tmp4 = importDefault(7682)();
  const obj = require(14424) /* getDeliveredQuest */;
  const items = [initializeState];
  let userStatus;
  ...
  const isEligibleForQuests = require(10507) /* getIsEligibleForQuests */.getIsEligibleForQuests();
  if (require(7228) /* AdCreativeType */.AdCreativeType.NO_FILL !== type) {
...
export const useMobileQuestDock = function useMobileQuestDock() {
  const adRefreshLoop = require(14422) /* maybeRefreshAd */.useAdRefreshLoop(require(5204) /* QuestsVisibleMessagesChangedSource */.AdPlacement.MOBILE_HOME_DOCK_AREA);
...
export const useIsMobileQuestDockVisibleToUser = function useIsMobileQuestDockVisibleToUser(mobileQuestDock, isMobileQuestDockRenderedBase) {
  ...
  const isChannelFocused = _require(9808).useIsChannelFocused();
  const obj = _require(9808);
  const currentNavigationRouteName = _require(4199).useCurrentNavigationRouteName();
  const obj2 = _require(4199);
  let tmp4 = null != _require(4199).coerceGuildsRoute({ name: currentNavigationRouteName });
  const obj3 = _require(4199);
  const items = [initializeState];
