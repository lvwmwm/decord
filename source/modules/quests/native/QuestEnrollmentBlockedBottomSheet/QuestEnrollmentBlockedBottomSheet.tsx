...
// Dependencies: [19, 17, 7081, 21, 4285, 712, 589, 11094, 5146, 6824, 5377, 4281, 1236, 2]
// Exports: default

// Module 14320 (QuestEnrollmentBlockedBottomSheet)
import "noop";
...
function QuestEnrollmentBlockedBottomSheet(questEnrollmentBlockedUntil) {
  ...
  const tmp3Result = importDefault(6824)(date);
  ...
  if (null != questEnrollmentBlockedUntil) {
    ...
    tmp12 = jsx(require(5377) /* Background */.BottomSheet, { style: null, children: null });
  }
  return tmp12;
}
