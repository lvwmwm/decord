...
// Dependencies: [19, 17, 7068, 21, 4255, 712, 589, 11105, 5102, 6800, 5309, 4251, 1236, 2]
// Exports: default

// Module 14276 (QuestEnrollmentBlockedBottomSheet)
import "noop";
...
function QuestEnrollmentBlockedBottomSheet(questEnrollmentBlockedUntil) {
  ...
  const tmp3Result = importDefault(6800)(date);
  ...
  if (null != questEnrollmentBlockedUntil) {
    ...
    tmp12 = jsx(require(5309) /* Background */.BottomSheet, { style: null, children: null });
  }
  return tmp12;
}
