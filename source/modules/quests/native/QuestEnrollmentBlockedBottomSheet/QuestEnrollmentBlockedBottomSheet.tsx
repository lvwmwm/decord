...
// Dependencies: [19, 17, 7054, 21, 4255, 712, 589, 11062, 5116, 6797, 5323, 4251, 1236, 2]
// Exports: default

// Module 14283 (QuestEnrollmentBlockedBottomSheet)
import "noop";
...
function QuestEnrollmentBlockedBottomSheet(questEnrollmentBlockedUntil) {
  ...
  const tmp3Result = importDefault(6797)(date);
  ({ minutes, seconds } = tmp3Result);
  const tmp3 = importDefault(6797);
  ...
  if (null != questEnrollmentBlockedUntil) {
    ...
    obj[1] = jsx(require(4251) /* Text */.Text, { variant: "heading-xl/bold", children: null });
    ...
    obj2[1] = jsx(require(4251) /* Text */.Text, { variant: "text-md/normal", children: null });
    obj[3] = <View style={null}>{null}</View>;
    tmp12 = jsx(require(5323) /* Background */.BottomSheet, { style: null, children: null });
  }
  return tmp12;
}
