...
// Dependencies: [19, 17, 7100, 21, 4302, 712, 589, 11109, 5163, 6843, 5396, 4298, 1236, 2]
// Exports: default

// Module 14337 (QuestEnrollmentBlockedBottomSheet)
import "noop";
...
function QuestEnrollmentBlockedBottomSheet(questEnrollmentBlockedUntil) {
  ...
  const tmp3Result = importDefault(6843)(date);
  ...
  if (null != questEnrollmentBlockedUntil) {
    ...
    obj[1] = jsx(require(4298) /* Text */.Text, { variant: "heading-xl/bold", children: null });
    ...
    obj2[1] = jsx(require(4298) /* Text */.Text, { variant: "text-md/normal", children: null });
    obj[3] = <View style={null}>{null}</View>;
    tmp12 = jsx(require(5396) /* Background */.BottomSheet, { style: null, children: null });
  }
  return tmp12;
}
