...
// Dependencies: [17, 1301, 7636, 5404, 673, 7669, 1234, 1233, 7657, 11707, 5407, 1362, 11217, 1623, 13156, 7632, 7651, 7655, 7876, 2]
// Exports: createQuestsEmbed

// Module 13155 (createQuestsEmbed)
...
export const createQuestsEmbed = function createQuestsEmbed(questId) {
  ...
  if (obj.isMetaQuest()) {
    ...
    if (null == result) {
      if (null == value) {
        const result1 = tmp2(7651).trackQuestEmbedFallbackViewed(questId, constants2.UNKNOWN_QUEST);
      ...
      const result2 = tmp2(7651).trackQuestEmbedFallbackViewed(questId, constants2.EXCLUDED_QUEST);
      const intl7 = tmp2(1233).intl;
      const tmp2Result4 = tmp2(7651);
      ...
      if (tmp2Result6.isShareableQuest(result.config)) {
        ...
        if (result.config.expiresAt < date1.toISOString()) {
          ...
          const questTaskDetails = tmp2(7657).getQuestTaskDetails(result);
          const tmp2Result8 = tmp2(7657);
          const thirdPartyTaskDetails = tmp2(7657).getThirdPartyTaskDetails(result);
          const tmp2Result9 = tmp2(7657);
          ...
          obj10[3] = tmp2(5407).QuestContent.QUEST_EMBED_MOBILE;
          obj10[4] = thirdPartyTaskDetails;
          obj10[6] = currentUser;
          formatToPlainStringResult1 = tmp2(11707).getQuestsInstructionsToWinReward(obj10);
          const tmp2Result10 = tmp2(11707);
        }
        ...
        obj11.thumbnailUrl = tmp2(11217).getQuestAsset(result, tmp2(11217).QuestAssetType.GAME_TILE, tmp29).url;
        obj11.embedCanBeTapped = true;
        obj11.canBeAccepted = true;
        obj11.type = InviteTypes.GUILD;
        const tmp2Result11 = tmp2(11217);
        const obj12 = {};
        ...
        const result3 = tmp2(7651).trackQuestEmbedFallbackViewed(questId, constants2.NOT_SHAREABLE_QUEST);
        const intl = tmp2(1233).intl;
        const tmp2Result13 = tmp2(7651);
