// Module ID: 14393
// Function ID: 14394
// Dependencies: [19, 17, 4336, 21, 589, 8915, 4765, 2]
...
const memoResult = require("noop").memo(function BountiesBannerBackground(arg0) {
  ...
  const items1 = [callback(require(8915) /* VideoComponent */.VideoComponent, obj), callback(importDefault(4765), { colors: closure_9, locations: closure_8, style: closure_3.absoluteFillObject }), children];
  obj[1] = items1;
