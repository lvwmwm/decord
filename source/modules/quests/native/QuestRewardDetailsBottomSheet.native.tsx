...
// Dependencies: [19, 17, 1874, 21, 4285, 712, 11080, 4253, 10374, 10391, 7085, 1236, 589, 5338, 4693, 11083, 4281, 2]
// Exports: default

// Module 11082 (QuestRewardDetailsBottomSheet)
...
function QuestRewardDetailsBottomSheet(quest) {
  ...
  const items3 = [callback(memo(11083), { quest, height: 56, width: 56, withAnimation: true }), ];
  ...
  items5[1] = tmp9Result;
  obj[3] = items5;
  return callback(quest(5338).BottomSheet, { startExpanded: true, children: callback2(quest(4693).Stack, obj) });
}
...
export default function QuestRewardDetailsBottomSheetConnected(questId) {
  const callback = React.useCallback(() => {
    const result = callback(11080).showQuestUnavailableAlert();
