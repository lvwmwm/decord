...
// Dependencies: [19, 17, 5339, 676, 678, 21, 4445, 712, 14549, 4441, 1236, 10755, 4412, 10770, 2009, 698, 5925, 7219, 10759, 14553, 7939, 14554, 1500, 12722, 2]
// Exports: default

// Module 14552 (QuestHomeHeaderTitle)
...
function QuestHomeHeaderRight(isVirtualCurrencyEnabled) {
  ...
  if (isVirtualCurrencyEnabled) {
    ...
    obj[0] = balance;
    obj[1] = tmp5;
    isVirtualCurrencyEnabled = callback(balance(10759).BalanceWidgetPillButton, obj);
  }
