...
// Function ID: 14320
// Name: FilterFooter
// Dependencies: [32, 19, 17, 5202, 21, 4342, 712, 5368, 5191, 4755, 1236, 4741, 1363, 4310, 10420, 5437, 5436, 5439, 4753, 8030, 8029, 5807, 8497, 10442, 2]
// Exports: default

// Module 14319 (FilterFooter)
...
function FilterFooter(inline) {
  ...
  obj1[3] = onConfirm;
  const items = [closure_7(require(4755) /* Button */.Button, obj1), ];
  ...
  obj2[3] = onReset;
  items[1] = closure_7(require(4755) /* Button */.Button, obj2);
  obj[2] = items;
  obj[1] = callback2(require(5191) /* ButtonGroup */.ButtonGroup, obj);
  obj[2] = closure_7(require(5368) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
