...
// Dependencies: [19, 17, 21, 4661, 712, 10698, 1236, 10699, 4734, 2]
// Exports: default
...
function AppStoreOverlayStatCardItem(stat) {
  ...
  if ("rating" === type) {
    ...
    let obj2 = require(10698) /* formatAppStoreRatingValue */;
    ...
    obj[2] = callback(importDefault(10699), obj1);
    obj[3] = result1;
    let tmp6 = obj;
  } else if ("age" === type) {
    ...
    const result2 = require(10698) /* formatAppStoreRatingValue */.formatAppStoreChartRank(stat.rank);
    ...
    obj[2] = stat.category;
    tmp6 = obj;
    const obj11 = require(10698) /* formatAppStoreRatingValue */;
  }
  ...
  items[2] = str9;
  const items1 = [closure_6(require(4734) /* Text */.Text, { variant: "text-xs/semibold", color: "text-subtle", children: items }), callback(require(4734) /* Text */.Text, { variant: "text-md/semibold", color: "text-default", lineClamp: 1, children: tmp6.primaryText }), ];
  if (null == secondaryContent) {
    ...
    if (tmp21Result) {
      ...
      tmp21Result = callback(tmp18(4734).Text, obj4);
    }
