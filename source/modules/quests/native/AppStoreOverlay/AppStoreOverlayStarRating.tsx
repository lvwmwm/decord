...
// Function ID: 10700
// Name: FractionalStar
// Dependencies: [19, 17, 21, 4661, 712, 9412, 9410, 2]
// Exports: default
...
function FractionalStar(fillAmount) {
  ...
  obj[2] = tmp.starIcon;
  const items = [callback(require(9412) /* StarOutlineIcon */.StarOutlineIcon, obj), ];
  ...
  if (tmp4Result) {
    ...
    obj2[2] = tmp.starIcon;
    obj[1] = tmp4(require(9410) /* StarIcon */.StarIcon, obj2);
