...
// Function ID: 10640
// Name: FractionalStar
// Dependencies: [19, 17, 21, 4344, 712, 8791, 8789, 2]
// Exports: default

// Module 10639 (FractionalStar)
import "noop";
...
function FractionalStar(fillAmount) {
  ...
  obj[2] = tmp.starIcon;
  const items = [callback(require(8791) /* StarOutlineIcon */.StarOutlineIcon, obj), ];
  ...
  if (tmp4Result) {
    ...
    obj2[2] = tmp.starIcon;
    obj[1] = tmp4(require(8789) /* StarIcon */.StarIcon, obj2);
