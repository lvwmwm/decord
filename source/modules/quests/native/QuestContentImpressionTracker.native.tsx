...
// Dependencies: [32, 19, 6325, 8446, 676, 21, 6673, 8122, 589, 10492, 10493, 6011, 2]
// Exports: BillableAdPlacementImpressionTrackerNative, QuestContentImpressionTrackerNative

// Module 10966 (AdContentImpressionTrackerBaseNative)
...
function AdContentImpressionTrackerBaseNative(skipRemountKey) {
  ...
  let tmp6 = visibilityRef(8122)(tmp3);
  let items1 = [joined];
  const tmp10 = callback(adContentIds2(6673).useRecyclingState(false, items1), 2);
  dependencyMap = tmp11;
  ...
  obj = { visible: overrideVisibility, visibleChanged: overrideVisibility !== tmp5(8122)(overrideVisibility) };
  obj1 = {};
  ...
  if (tmp17) {
    obj2.adCreativeType = tmp(6011).AdCreativeType.QUEST;
    let tmp19 = obj2;
  } else {
    obj2.adCreativeType = skipRemountKey.adCreativeType;
    tmp19 = obj2;
  }
  return createElement(adContentIds2(10493).QuestContentImpressionTracker, tmp19);
}
