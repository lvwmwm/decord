...
// Dependencies: [32, 19, 6328, 8449, 676, 21, 6676, 8125, 589, 10496, 10497, 6013, 2]
// Exports: BillableAdPlacementImpressionTrackerNative, QuestContentImpressionTrackerNative

// Module 10970 (AdContentImpressionTrackerBaseNative)
...
function AdContentImpressionTrackerBaseNative(skipRemountKey) {
  ...
  let tmp6 = visibilityRef(8125)(tmp3);
  let items1 = [joined];
  const tmp10 = callback(adContentIds2(6676).useRecyclingState(false, items1), 2);
  dependencyMap = tmp11;
  ...
  obj = { visible: overrideVisibility, visibleChanged: overrideVisibility !== tmp5(8125)(overrideVisibility) };
  obj1 = {};
  ...
  if (tmp17) {
    obj2.adCreativeType = tmp(6013).AdCreativeType.QUEST;
    let tmp19 = obj2;
  } else {
    obj2.adCreativeType = skipRemountKey.adCreativeType;
    tmp19 = obj2;
  }
  return createElement(adContentIds2(10497).QuestContentImpressionTracker, tmp19);
}
