...
// Dependencies: [19, 17, 4247, 14204, 5113, 21, 4255, 712, 1236, 4251, 14185, 589, 7082, 10867, 5116, 7071, 7081, 14126, 14205, 14206, 1297, 4665, 14199, 11058, 3967, 7640, 11062, 2]

// Module 14203 (BountiesCtaDescription)
...
function BountiesCtaHeaderInner(bounties) {
  ...
  obj[2] = items5;
  const items7 = [closure_11(importDefault(14205), obj), false];
  obj[2] = items7;
