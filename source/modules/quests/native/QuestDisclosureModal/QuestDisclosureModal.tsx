...
// Function ID: 14226
// Name: CloseButton
// Dependencies: [21, 5902, 7809, 14224, 1236, 5223, 14226, 5650, 2]
// Exports: default

// Module 14225 (CloseButton)
...
export default function QuestDisclosureModal(arg0) {
  ...
  function onClose() {
    return callback2(14224).hideModal();
  }
  let obj = {
    headerLeft: onClose,
    headerRight() {
    ...
    headerTitle() {
      ...
      return callback3(callback(5223).NavigatorHeader, obj);
    },
    render() {
  ...
  return jsx(require(5650) /* NavigationStack */.Navigator, { screens: { [closure_4.DISCLOSURE]: obj }, initialRouteName: constants.DISCLOSURE, headerBackTitle: null });
};
