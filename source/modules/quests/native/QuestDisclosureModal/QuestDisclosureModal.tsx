...
// Function ID: 14277
// Name: CloseButton
// Dependencies: [21, 5948, 7967, 14275, 1236, 5269, 14277, 5723, 2]
// Exports: default

// Module 14276 (CloseButton)
...
export default function QuestDisclosureModal(arg0) {
  ...
  function onClose() {
    return callback2(14275).hideModal();
  }
  let obj = {
    headerLeft: onClose,
    headerRight() {
    ...
    headerTitle() {
      ...
      return callback3(callback(5269).NavigatorHeader, obj);
    },
    render() {
  ...
  return jsx(require(5723) /* NavigationStack */.Navigator, { screens: { [closure_4.DISCLOSURE]: obj }, initialRouteName: constants.DISCLOSURE, headerBackTitle: null });
};
