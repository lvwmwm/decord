...
// Function ID: 14263
// Name: CloseButton
// Dependencies: [21, 5929, 7950, 14261, 1236, 5253, 14263, 5704, 2]
// Exports: default

// Module 14262 (CloseButton)
...
export default function QuestDisclosureModal(arg0) {
  ...
  function onClose() {
    return callback2(14261).hideModal();
  }
  let obj = {
    headerLeft: onClose,
    headerRight() {
    ...
    headerTitle() {
      ...
      return callback3(callback(5253).NavigatorHeader, obj);
    },
    render() {
  ...
  return jsx(require(5704) /* NavigationStack */.Navigator, { screens: { [closure_4.DISCLOSURE]: obj }, initialRouteName: constants.DISCLOSURE, headerBackTitle: null });
};
