...
// Function ID: 14357
// Name: CloseButton
// Dependencies: [21, 6010, 8029, 14355, 1236, 5270, 14357, 5783, 2]
// Exports: default

// Module 14356 (CloseButton)
...
export default function QuestDisclosureModal(arg0) {
  ...
  function onClose() {
    return callback2(14355).hideModal();
  }
  let obj = {
    headerLeft: onClose,
    headerRight() {
    ...
    headerTitle() {
      ...
      return callback3(callback(5270).NavigatorHeader, obj);
    },
    render() {
  ...
  return jsx(require(5783) /* NavigationStack */.Navigator, { screens: { [closure_4.DISCLOSURE]: obj }, initialRouteName: constants.DISCLOSURE, headerBackTitle: null });
};
