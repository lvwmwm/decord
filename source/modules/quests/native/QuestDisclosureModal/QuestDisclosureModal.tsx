...
// Function ID: 14427
// Name: CloseButton
// Dependencies: [21, 6072, 8093, 14425, 1236, 5331, 14427, 5844, 2]
// Exports: default

// Module 14426 (CloseButton)
...
export default function QuestDisclosureModal(arg0) {
  ...
  function onClose() {
    return callback2(14425).hideModal();
  }
  let obj = {
    headerLeft: onClose,
    headerRight() {
    ...
    headerTitle() {
      ...
      return callback3(callback(5331).NavigatorHeader, obj);
    },
    render() {
  ...
  return jsx(require(5844) /* NavigationStack */.Navigator, { screens: { [closure_4.DISCLOSURE]: obj }, initialRouteName: constants.DISCLOSURE, headerBackTitle: null });
};
