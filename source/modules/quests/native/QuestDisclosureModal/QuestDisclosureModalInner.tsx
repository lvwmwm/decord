...
// Dependencies: [17, 676, 21, 4302, 712, 3974, 9639, 1236, 10469, 11157, 8702, 5967, 4298, 10415, 5375, 1974, 4712, 2]
// Exports: default

// Module 14277 (QuestDisclosureModalInner)
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  const items2 = [tmp6(View, { style: tmp.illustration, children: tmp6(_require(5967).WumpusCouchSpotIllustration, {}) }), , , , ];
  const obj3 = { variant: "text-md/normal", color: "mobile-text-heading-primary", children: null };
  const obj2 = { style: tmp.illustration, children: tmp6(_require(5967).WumpusCouchSpotIllustration, {}) };
  const tmp7 = closure_6;
  obj3[2] = _require(10415).getDisclosureText({ gamePublisher, gameTitle, isTargetedDisclosure, isContextualDisclosure: setting, cosponsorName, isVideoQuest });
  items2[1] = tmp6(_require(4298).Text, obj3);
  ...
  obj8[4] = onClose;
  obj7[1] = tmp6(_require(4712).Button, obj8);
