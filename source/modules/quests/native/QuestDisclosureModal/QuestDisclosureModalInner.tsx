...
// Dependencies: [17, 673, 21, 4481, 709, 4166, 9215, 1233, 8816, 11757, 9152, 5647, 4477, 11227, 5562, 1994, 4936, 2]
// Exports: default

// Module 15039 (QuestDisclosureModalInner)
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  if (setting) {
    obj[0] = tmp5(tmp2(9215).ServerIcon, { size: "xs" });
    ...
    obj[0] = tmp5(tmp2(8816).GlobeEarthIcon, { size: "xs" });
    const intl = tmp2(1233).intl;
    obj[1] = intl.string(tmp2(1233).t.xQSdPv);
    items1 = [obj, , ];
    obj = { icon: null, text: null };
    obj[0] = tmp5(tmp2(11757).UserIcon, { size: "xs" });
    const intl2 = tmp2(1233).intl;
    obj[1] = intl2.string(tmp2(1233).t.mYt7hQ);
    items1[1] = obj;
    obj = { icon: null, text: null };
    obj[0] = tmp5(tmp2(9152).GameControllerIcon, { size: "xs" });
  ...
  const items2 = [tmp6(closure_4, { style: tmp.illustration, children: tmp6(_require(5647).WumpusCouchSpotIllustration, {}) }), , , , ];
  const obj3 = { variant: "text-md/normal", color: "mobile-text-heading-primary", children: null };
  const obj2 = { style: tmp.illustration, children: tmp6(_require(5647).WumpusCouchSpotIllustration, {}) };
  const tmp7 = closure_7;
  const tmp8 = closure_3;
  const tmp9 = closure_4;
  obj3[2] = _require(11227).getDisclosureText({ adCreativeType, gamePublisher, gameTitle, isTargetedDisclosure, isContextualDisclosure: setting, cosponsorName, isVideoQuest });
  items2[1] = tmp6(_require(4477).Text, obj3);
  if (isTargetedDisclosure) {
    ...
    isTargetedDisclosure = tmp6(tmp2(5562).Card, obj4);
  }
  ...
  obj8[4] = onClose;
  obj7[1] = tmp6(_require(4936).Button, obj8);
