...
// Dependencies: [17, 676, 21, 4342, 712, 4034, 9764, 1236, 10514, 11291, 8825, 6091, 4338, 10457, 5437, 1993, 4777, 2]
// Exports: default

// Module 14427 (QuestDisclosureModalInner)
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  const items2 = [tmp6(closure_4, { style: tmp.illustration, children: tmp6(_require(6091).WumpusCouchSpotIllustration, {}) }), , , , ];
  const obj3 = { variant: "text-md/normal", color: "mobile-text-heading-primary", children: null };
  const obj2 = { style: tmp.illustration, children: tmp6(_require(6091).WumpusCouchSpotIllustration, {}) };
  const tmp7 = closure_7;
  const tmp8 = closure_3;
  const tmp9 = closure_4;
  obj3[2] = _require(10457).getDisclosureText({ gamePublisher, gameTitle, isTargetedDisclosure, isContextualDisclosure: setting, cosponsorName, isVideoQuest });
  ...
  const tmp2Result = _require(10457);
  ...
  obj8[4] = onClose;
  obj7[1] = tmp6(_require(4777).Button, obj8);
