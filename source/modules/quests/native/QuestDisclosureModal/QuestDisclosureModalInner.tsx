...
// Dependencies: [17, 676, 21, 4285, 712, 3957, 9623, 1236, 10453, 11142, 8685, 5948, 4281, 10399, 5356, 1974, 4695, 2]
// Exports: default

// Module 14263 (QuestDisclosureModalInner)
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  const items2 = [tmp6(View, { style: tmp.illustration, children: tmp6(_require(5948).WumpusCouchSpotIllustration, {}) }), , , , ];
  const obj3 = { variant: "text-md/normal", color: "mobile-text-heading-primary", children: null };
  const obj2 = { style: tmp.illustration, children: tmp6(_require(5948).WumpusCouchSpotIllustration, {}) };
  const tmp7 = closure_6;
  obj3[2] = _require(10399).getDisclosureText({ gamePublisher, gameTitle, isTargetedDisclosure, isContextualDisclosure: setting, cosponsorName, isVideoQuest });
  ...
  const tmp2Result = _require(10399);
