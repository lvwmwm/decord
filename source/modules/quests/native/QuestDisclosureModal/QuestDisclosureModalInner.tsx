...
// Dependencies: [17, 676, 21, 4255, 712, 3928, 9594, 1236, 10422, 11108, 8656, 5921, 4251, 10368, 5302, 1945, 4665, 2]
// Exports: default

// Module 14226 (QuestDisclosureModalInner)
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  const items2 = [tmp6(View, { style: tmp.illustration, children: tmp6(_require(5921).WumpusCouchSpotIllustration, {}) }), , , , ];
  const obj3 = { variant: "text-md/normal", color: "mobile-text-heading-primary", children: null };
  const obj2 = { style: tmp.illustration, children: tmp6(_require(5921).WumpusCouchSpotIllustration, {}) };
  const tmp7 = closure_6;
  obj3[2] = _require(10368).getDisclosureText({ gamePublisher, gameTitle, isTargetedDisclosure, isContextualDisclosure: setting, cosponsorName, isVideoQuest });
  ...
  const tmp2Result = _require(10368);
  ...
  obj8[4] = onClose;
  obj7[1] = tmp6(_require(4665).Button, obj8);
