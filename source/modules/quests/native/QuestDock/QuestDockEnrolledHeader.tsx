// Module ID: 14431
// Function ID: 14432
// Dependencies: [32, 19, 17, 21, 4303, 14359, 10460, 11173, 5164, 14373, 4299, 2]
...
const memoResult = require("noop").memo(function QuestDockEnrolledHeader() {
  let obj = require(14359) /* getDeliveredQuest */;
  const questCreative = obj.useQuestCreative();
  const tmp2 = callback4();
  let obj1 = require(10460) /* useQuests */;
  const questTaskDetails = obj1.useQuestTaskDetails(questCreative);
  let obj2 = require(10460) /* useQuests */;
  let obj3 = require(11173) /* _getQuestsInstructionsToWinReward */;
  ...
  const questBarSubtitle = require(11173) /* _getQuestsInstructionsToWinReward */.useQuestBarSubtitle(obj);
  obj2 = { quest: questCreative, size: "x-sm", progress: questTaskDetails.percentComplete, loading: false, hasConfetti: true };
  obj1[1] = callback2(importDefault(14373), obj2);
