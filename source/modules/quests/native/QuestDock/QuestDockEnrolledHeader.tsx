// Module ID: 14429
// Function ID: 14430
// Dependencies: [32, 19, 17, 21, 4303, 14357, 10459, 11172, 5164, 14371, 4299, 2]
...
const memoResult = require("noop").memo(function QuestDockEnrolledHeader() {
  let obj = require(14357) /* getDeliveredQuest */;
  const questCreative = obj.useQuestCreative();
  const tmp2 = callback4();
  let obj1 = require(10459) /* useQuests */;
  const questTaskDetails = obj1.useQuestTaskDetails(questCreative);
  let obj2 = require(10459) /* useQuests */;
  let obj3 = require(11172) /* _getQuestsInstructionsToWinReward */;
  ...
  const questBarSubtitle = require(11172) /* _getQuestsInstructionsToWinReward */.useQuestBarSubtitle(obj);
  obj2 = { quest: questCreative, size: "x-sm", progress: questTaskDetails.percentComplete, loading: false, hasConfetti: true };
  obj1[1] = callback2(importDefault(14371), obj2);
