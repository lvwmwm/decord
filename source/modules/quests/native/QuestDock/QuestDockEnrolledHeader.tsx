// Module ID: 14505
// Function ID: 14506
// Dependencies: [32, 19, 17, 21, 4342, 14433, 10420, 11222, 5205, 14447, 4338, 2]
...
const memoResult = require("noop").memo(function QuestDockEnrolledHeader() {
  let obj = require(14433) /* getDeliveredQuest */;
  ...
  let obj3 = require(11222) /* _getQuestsInstructionsToWinReward */;
  const questBarTitle = obj3.useQuestBarTitle(questCreative);
  obj = { quest: questCreative, isExpanded: false, activeScreen: callback(obj2.useTaskPlatformScreen(questCreative, questTaskDetails), 1)[0], sourceQuestContent: require(5205) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE };
  obj = { style: tmp2.wrapper, children: null };
  obj1 = { style: tmp2.progressIndicatorWrapper, children: null };
  const questBarSubtitle = require(11222) /* _getQuestsInstructionsToWinReward */.useQuestBarSubtitle(obj);
  obj2 = { quest: questCreative, size: "x-sm", progress: questTaskDetails.percentComplete, loading: false, hasConfetti: true };
  obj1[1] = callback2(importDefault(14447), obj2);
