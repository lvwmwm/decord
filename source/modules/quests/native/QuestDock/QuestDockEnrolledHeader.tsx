// Module ID: 14496
// Function ID: 14497
// Dependencies: [32, 19, 17, 21, 4342, 14424, 10420, 11223, 5205, 14438, 4338, 2]
...
const memoResult = require("noop").memo(function QuestDockEnrolledHeader() {
  ...
  let obj3 = require(11223) /* _getQuestsInstructionsToWinReward */;
  ...
  const questBarSubtitle = require(11223) /* _getQuestsInstructionsToWinReward */.useQuestBarSubtitle(obj);
