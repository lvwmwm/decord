// Module ID: 14214
// Function ID: 14215
// Dependencies: [32, 19, 17, 21, 4189, 14204, 10492, 10967, 5036, 14155, 4185, 2]
...
const memoResult = importAllResult.memo(function QuestDockEnrolledHeader() {
  const quest = importAllResult.useContext(importDefault(14204)).quest;
  const tmp = callback4();
  let obj = require(10492) /* useQuests */;
  const questTaskDetails = obj.useQuestTaskDetails(quest);
  let obj1 = require(10492) /* useQuests */;
  let obj2 = require(10967) /* _getQuestsInstructionsToWinReward */;
  const questBarTitle = obj2.useQuestBarTitle(quest);
  let obj3 = require(10967) /* _getQuestsInstructionsToWinReward */;
  ...
  obj1[1] = callback2(importDefault(14155), obj2);
