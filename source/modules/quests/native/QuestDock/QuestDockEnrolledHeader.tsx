// Module ID: 14231
// Function ID: 14232
// Dependencies: [32, 19, 17, 21, 4193, 14223, 10505, 10981, 5040, 14173, 4189, 2]
...
const memoResult = require("noop").memo(function QuestDockEnrolledHeader() {
  let obj = require(14223) /* getDeliveredQuest */;
  ...
  let obj3 = require(10981) /* _getQuestsInstructionsToWinReward */;
  const questBarTitle = obj3.useQuestBarTitle(questCreative);
  obj = { quest: questCreative, isExpanded: false, activeScreen: callback(obj2.useTaskPlatformScreen(questCreative, questTaskDetails), 1)[0], sourceQuestContent: require(5040) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE };
  obj = { style: tmp2.wrapper, children: null };
  obj1 = { style: tmp2.progressIndicatorWrapper, children: null };
  const questBarSubtitle = require(10981) /* _getQuestsInstructionsToWinReward */.useQuestBarSubtitle(obj);
  obj2 = { quest: questCreative, size: "x-sm", progress: questTaskDetails.percentComplete, loading: false, hasConfetti: true };
  obj1[1] = callback2(importDefault(14173), obj2);
  const items = [callback2(View, obj1), ];
  obj3 = { style: tmp2.copy, children: null };
  const items1 = [callback2(require(4189) /* Text */.Text, { variant: "heading-md/semibold", color: "mobile-text-heading-primary", children: questBarTitle }), callback2(require(4189) /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", children: questBarSubtitle })];
  obj3[1] = items1;
