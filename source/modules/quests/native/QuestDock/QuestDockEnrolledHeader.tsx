// Module ID: 14306
// Function ID: 14307
// Dependencies: [32, 19, 17, 21, 4255, 14298, 10346, 11059, 5116, 14247, 4251, 2]
...
const memoResult = require("noop").memo(function QuestDockEnrolledHeader() {
  let obj = require(14298) /* getDeliveredQuest */;
  const questCreative = obj.useQuestCreative();
  const tmp2 = callback4();
  let obj1 = require(10346) /* useQuests */;
  const questTaskDetails = obj1.useQuestTaskDetails(questCreative);
  let obj2 = require(10346) /* useQuests */;
  let obj3 = require(11059) /* _getQuestsInstructionsToWinReward */;
  const questBarTitle = obj3.useQuestBarTitle(questCreative);
  obj = { quest: questCreative, isExpanded: false, activeScreen: callback(obj2.useTaskPlatformScreen(questCreative, questTaskDetails), 1)[0], sourceQuestContent: require(5116) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE };
  obj = { style: tmp2.wrapper, children: null };
  obj1 = { style: tmp2.progressIndicatorWrapper, children: null };
  const questBarSubtitle = require(11059) /* _getQuestsInstructionsToWinReward */.useQuestBarSubtitle(obj);
  obj2 = { quest: questCreative, size: "x-sm", progress: questTaskDetails.percentComplete, loading: false, hasConfetti: true };
  obj1[1] = callback2(importDefault(14247), obj2);
