...
// Dependencies: [19, 6716, 14447, 21, 14448, 10559, 14451, 14533, 4115, 14452, 14449, 6377, 14446, 4343, 2]
...
const memoResult = importAllResult.memo(function QuestDockGestureDetector(children) {
  ...
  return jsx(require(6377) /* LegacyBaseButton */.GestureDetector, { gesture: useQuestDockSwipeGesture(), children: children.children });
});
