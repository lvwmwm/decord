...
// Dependencies: [5, 19, 676, 21, 14703, 7446, 10932, 1236, 5390, 7473, 8998, 8999, 9003, 7463, 5991, 12787, 8363, 11096, 4445, 5989, 7467, 14705, 11334, 5551, 10913, 14707, 11122, 11083, 8843, 14708, 14710, 14712, 7743, 6245, 4425, 5981, 10854, 14714, 2]
// Exports: default

// Module 14704 (QuestDockPreviewTools)
...
function QuestDockPreviewTools(quest) {
  ...
  obj[1] = callback(quest(8363).FormLabel, obj2);
  ...
  obj3[1] = callback(quest(8363).FormLabel, obj5);
  obj3[2] = function onPress() {
    _undefined2(0.9 * Math.random() + 0.03);
    _undefined(_undefined2[18]).hideActionSheet();
  };
  items[1] = callback(quest(5991).ActionSheetRow, obj3);
  const obj6 = { icon: null, label: null, onPress: null };
  const obj4 = { IconComponent: quest(14708).RedoIcon };
  obj6[0] = callback(quest(5991).ActionSheetRow.Icon, { IconComponent: quest(14710).UndoIcon });
  const obj8 = { text: null };
  const intl4 = quest(1236).intl;
  obj8[0] = intl4.string(quest(1236).t.taqkwK);
  obj6[1] = callback(quest(8363).FormLabel, obj8);
  obj6[2] = function onPress() {
    _undefined4();
    _undefined(_undefined2[18]).hideActionSheet();
  };
  items[2] = callback(quest(5991).ActionSheetRow, obj6);
  const obj9 = { icon: null, label: null, onPress: null };
  const obj7 = { IconComponent: quest(14710).UndoIcon };
  obj9[0] = callback(quest(5991).ActionSheetRow.Icon, { IconComponent: quest(14712).UnsendIcon });
  const obj11 = { text: null };
  const intl5 = quest(1236).intl;
  obj11[0] = intl5.string(quest(1236).t.JF6W66);
  obj9[1] = callback(quest(8363).FormLabel, obj11);
  obj9[2] = function onPress() {
    _undefined3();
    _undefined(_undefined2[18]).hideActionSheet();
  };
  items[3] = callback(quest(5991).ActionSheetRow, obj9);
  const obj12 = { icon: null, label: null, onPress: null };
  const obj10 = { IconComponent: quest(14712).UnsendIcon };
  obj12[0] = callback(quest(5991).ActionSheetRow.Icon, { IconComponent: quest(7743).EyeIcon });
  const obj14 = { text: null };
  const intl6 = quest(1236).intl;
  obj14[0] = intl6.string(quest(1236).t["lL6/zF"]);
  obj12[1] = callback(quest(8363).FormLabel, obj14);
  ...
  items[4] = callback(quest(5991).ActionSheetRow, obj12);
  const obj15 = { icon: null, label: null, onPress: null };
  const obj13 = { IconComponent: quest(7743).EyeIcon };
  obj15[0] = callback(quest(5991).ActionSheetRow.Icon, { IconComponent: quest(7743).EyeIcon });
  const obj17 = { text: null };
  const intl7 = quest(1236).intl;
  obj17[0] = intl7.string(quest(1236).t.tx5Ax5);
  obj15[1] = callback(quest(8363).FormLabel, obj17);
  ...
  items[5] = callback(quest(5991).ActionSheetRow, obj15);
  const obj18 = { icon: null, label: null, onPress: null };
  const obj16 = { IconComponent: quest(7743).EyeIcon };
  obj18[0] = callback(quest(5991).ActionSheetRow.Icon, { IconComponent: quest(4425).CopyIcon });
  const obj20 = { text: null };
  const intl8 = quest(1236).intl;
  obj20[0] = intl8.string(quest(1236).t.oisrFi);
  obj18[1] = callback(quest(8363).FormLabel, obj20);
  obj18[2] = function onPress() {
    quest(_undefined2[35]).copy(quest.id);
    const obj = quest(_undefined2[35]);
    _undefined(_undefined2[18]).hideActionSheet();
  };
  items[6] = callback(quest(5991).ActionSheetRow, obj18);
  obj[2] = items;
  return callback2(quest(5991).ActionSheetRow.Group, obj);
}
function QuestDockShareRow(quest) {
  quest = quest.quest;
  let obj = { icon: null, label: null, onPress: null };
  obj = { IconComponent: quest(4425).CopyIcon };
  obj[0] = callback(quest(5991).ActionSheetRow.Icon, obj);
  obj = { text: null };
  const intl = quest(1236).intl;
  ...
  return callback(quest(5991).ActionSheetRow, obj);
}
function QuestDockDisclosureRow(quest) {
  quest = quest.quest;
  let obj = { icon: null, label: null, onPress: null };
  obj = { IconComponent: quest(10854).CircleQuestionIcon };
  obj[0] = callback(quest(5991).ActionSheetRow.Icon, obj);
  obj = { text: null };
  const intl = quest(1236).intl;
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            closure_0 = tmp2;
            closure_1_3(closure_1_0(7473).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT);
            ...
            if (closure_1_0(7446).AdCreativeType.QUEST === type) {
              ...
              if (closure_1_0(7446).AdCreativeType.BOUNTY === type) {
                let obj2 = closure_1_0(11122);
                obj2.dismissAdContent(v0, closure_1_0(5390).QuestContent.QUEST_BAR_MOBILE);
                v0(4445).hideActionSheet();
                const obj4 = v0(4445);
              }
              dependencyMap = 3;
