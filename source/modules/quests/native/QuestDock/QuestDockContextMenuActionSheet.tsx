...
// Dependencies: [5, 19, 676, 21, 7221, 10506, 10528, 5803, 5805, 12723, 8008, 10537, 5204, 7227, 4312, 4292, 1236, 14410, 9562, 9563, 9567, 7228, 7217, 11224, 10201, 14412, 5365, 10508, 14415, 7767, 14416, 14418, 14420, 8542, 6057, 5795, 2]
// Exports: default

// Module 14409 (QuestDockContextMenuActionSheet)
...
export default function QuestDockContextMenuActionSheet(quest) {
  ...
  let obj2 = quest(10528);
  const externalCtaLabel = obj2.getExternalCtaLabel(quest);
  obj = { icon: null, label: null, onPress: null };
  obj = { IconComponent: null };
  obj[0] = quest(12723).LinkExternalMediumIcon;
  obj[0] = callback2(quest(5805).ActionSheetRow.Icon, obj);
  obj[1] = callback2(quest(8008).FormLabel, { text: externalCtaLabel });
  ...
  let items = [callback2(quest(5805).ActionSheetRow, obj), ];
  ...
  if (isShareableQuestResult) {
    ...
    obj2[0] = tmp(4292).CopyIcon;
    obj1[0] = tmp7(tmp(5805).ActionSheetRow.Icon, obj2);
    let obj3 = { text: null };
    const intl = tmp(1236).intl;
    obj3[0] = intl.string(tmp(1236).t.WqhZss);
    obj1[1] = tmp7(tmp(8008).FormLabel, obj3);
    ...
    tmp7Result = tmp7(tmp(5805).ActionSheetRow, obj1);
  }
  items[1] = tmp7Result;
  const children = [closure_6(quest(5805).ActionSheetRow.Group, { hasIcons: true, children: items }), , ];
  const obj4 = { hasIcons: true, children: null };
  const obj5 = { icon: null, label: null, onPress: null };
  const obj6 = { IconComponent: null };
  obj6[0] = importDefault(14410);
  obj5[0] = callback2(tmp(5805).ActionSheetRow.Icon, obj6);
  const obj7 = { text: null };
  const intl2 = tmp(1236).intl;
  obj7[0] = intl2.string(tmp(1236).t.LLLLPD);
  obj5[1] = callback2(tmp(8008).FormLabel, obj7);
  ...
  const items2 = [callback2(tmp(5805).ActionSheetRow, obj5), , ];
  let obj8 = { icon: null, label: null, onPress: null };
  let obj9 = { IconComponent: null };
  obj9[0] = tmp(10201).CircleQuestionIcon;
  obj8[0] = callback2(tmp(5805).ActionSheetRow.Icon, obj9);
  let obj10 = { text: null };
  const intl3 = tmp(1236).intl;
  obj10[0] = intl3.string(tmp(1236).t.GcsZKJ);
  obj8[1] = callback2(tmp(8008).FormLabel, obj10);
  ...
  items2[1] = callback2(tmp(5805).ActionSheetRow, obj8);
  const obj11 = { icon: null, label: null, subLabel: null, onPress: null };
  const obj12 = { IconComponent: null };
  obj12[0] = tmp(5365).XSmallIcon;
  obj11[0] = callback2(tmp(5805).ActionSheetRow.Icon, obj12);
  const obj13 = { text: null };
  const intl4 = tmp(1236).intl;
  obj13[0] = intl4.string(tmp(1236).t.NN79E9);
  obj11[1] = callback2(tmp(8008).FormLabel, obj13);
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp4;
            let tmp25 = outer1_0;
            outer1_0(10508).dismissQuestContent(outer1_0.id, outer1_0(5204).QuestContent.QUEST_BAR_MOBILE);
            const obj8 = outer1_0(10508);
            v0(4312).hideActionSheet();
            const obj9 = v0(4312);
            let captureAdUserAction = outer1_0;
            if (obj10.shouldMigrateToAdAnalyticsInterface(outer1_0(9562).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_dock_context_menu")) {
              ...
              obj1[0] = outer1_0(9567).AdUserActionType.CLICK_INTERNAL;
              obj1[1] = outer1_0(7228).AdCreativeType.QUEST;
              obj1[2] = tmp25.id;
              obj1[3] = outer1_0(7227).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              obj1[4] = outer1_0(5204).QuestContent.QUEST_BAR_MOBILE;
              tmp25 = outer1_0;
              obj1[5] = outer1_0(5204).QuestContent.QUEST_BAR_MOBILE;
              ...
              obj2[0] = tmp25.id;
              obj2[1] = outer1_0(5204).QuestContent.QUEST_BAR_MOBILE;
              obj2[2] = outer1_0(7227).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              obj2[3] = outer1_0(5204).QuestContent.QUEST_BAR_MOBILE;
              const result = captureAdUserAction(7217).trackQuestContentClicked(obj2);
  ...
  items2[2] = callback2(tmp(5805).ActionSheetRow, obj11);
  obj4[1] = items2;
  children[1] = closure_6(tmp(5805).ActionSheetRow.Group, obj4);
  ...
  if (preview) {
    ...
    items3[5] = tmp7(tmp(5805).ActionSheetRow, obj30);
    const obj33 = { icon: null, label: null, onPress: null };
    const obj34 = { IconComponent: null };
    obj34[0] = tmp(4292).CopyIcon;
    obj33[0] = tmp7(tmp(5805).ActionSheetRow.Icon, obj34);
    const obj35 = { text: null };
    const intl13 = tmp(1236).intl;
    obj35[0] = intl13.string(tmp(1236).t.oisrFi);
    obj33[1] = tmp7(tmp(8008).FormLabel, obj35);
    obj33[2] = function onPress() {
      quest(_undefined2[35]).copy(quest.id);
      const obj = quest(_undefined2[35]);
      _undefined(_undefined2[14]).hideActionSheet();
    };
    items3[6] = tmp7(tmp(5805).ActionSheetRow, obj33);
    obj14[2] = items3;
    preview = tmp6(tmp(5805).ActionSheetRow.Group, obj14);
  }
  children[2] = preview;
  return closure_6(quest(5803).ActionSheet, { children });
};
