...
// Dependencies: [5, 19, 676, 21, 7075, 10346, 10368, 5631, 5633, 12536, 7749, 10377, 5116, 7081, 4223, 4203, 1236, 14222, 9405, 9406, 9410, 7082, 7071, 11052, 10041, 14224, 5255, 10348, 14227, 7619, 14228, 14230, 14232, 8280, 5910, 5623, 2]
// Exports: default

// Module 14221 (QuestDockContextMenuActionSheet)
...
export default function QuestDockContextMenuActionSheet(quest) {
  ...
  let obj2 = quest(10368);
  const externalCtaLabel = obj2.getExternalCtaLabel(quest);
  obj = { icon: null, label: null, onPress: null };
  obj = { IconComponent: null };
  obj[0] = quest(12536).LinkExternalMediumIcon;
  obj[0] = callback2(quest(5633).ActionSheetRow.Icon, obj);
  obj[1] = callback2(quest(7749).FormLabel, { text: externalCtaLabel });
  ...
  let items = [callback2(quest(5633).ActionSheetRow, obj), ];
  ...
  if (isShareableQuestResult) {
    ...
    obj2[0] = tmp(4203).CopyIcon;
    obj1[0] = tmp7(tmp(5633).ActionSheetRow.Icon, obj2);
    let obj3 = { text: null };
    const intl = tmp(1236).intl;
    obj3[0] = intl.string(tmp(1236).t.WqhZss);
    obj1[1] = tmp7(tmp(7749).FormLabel, obj3);
    ...
    tmp7Result = tmp7(tmp(5633).ActionSheetRow, obj1);
  }
  items[1] = tmp7Result;
  const children = [closure_6(quest(5633).ActionSheetRow.Group, { hasIcons: true, children: items }), , ];
  const obj4 = { hasIcons: true, children: null };
  const obj5 = { icon: null, label: null, onPress: null };
  const obj6 = { IconComponent: null };
  obj6[0] = importDefault(14222);
  obj5[0] = callback2(tmp(5633).ActionSheetRow.Icon, obj6);
  const obj7 = { text: null };
  const intl2 = tmp(1236).intl;
  obj7[0] = intl2.string(tmp(1236).t.LLLLPD);
  obj5[1] = callback2(tmp(7749).FormLabel, obj7);
  ...
  const items2 = [callback2(tmp(5633).ActionSheetRow, obj5), , ];
  let obj8 = { icon: null, label: null, onPress: null };
  let obj9 = { IconComponent: null };
  obj9[0] = tmp(10041).CircleQuestionIcon;
  obj8[0] = callback2(tmp(5633).ActionSheetRow.Icon, obj9);
  let obj10 = { text: null };
  const intl3 = tmp(1236).intl;
  obj10[0] = intl3.string(tmp(1236).t.GcsZKJ);
  obj8[1] = callback2(tmp(7749).FormLabel, obj10);
  ...
  items2[1] = callback2(tmp(5633).ActionSheetRow, obj8);
  const obj11 = { icon: null, label: null, subLabel: null, onPress: null };
  const obj12 = { IconComponent: null };
  obj12[0] = tmp(5255).XSmallIcon;
  obj11[0] = callback2(tmp(5633).ActionSheetRow.Icon, obj12);
  const obj13 = { text: null };
  const intl4 = tmp(1236).intl;
  obj13[0] = intl4.string(tmp(1236).t.NN79E9);
  obj11[1] = callback2(tmp(7749).FormLabel, obj13);
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp4;
            let tmp25 = outer1_0;
            outer1_0(10348).dismissQuestContent(outer1_0.id, outer1_0(5116).QuestContent.QUEST_BAR_MOBILE);
            const obj8 = outer1_0(10348);
            v0(4223).hideActionSheet();
            const obj9 = v0(4223);
            let captureAdUserAction = outer1_0;
            if (obj10.shouldMigrateToAdAnalyticsInterface(outer1_0(9405).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_dock_context_menu")) {
              ...
              obj1[0] = outer1_0(9410).AdUserActionType.CLICK_INTERNAL;
              obj1[1] = outer1_0(7082).AdCreativeType.QUEST;
              obj1[2] = tmp25.id;
              obj1[3] = outer1_0(7081).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              obj1[4] = outer1_0(5116).QuestContent.QUEST_BAR_MOBILE;
              tmp25 = outer1_0;
              obj1[5] = outer1_0(5116).QuestContent.QUEST_BAR_MOBILE;
              ...
              obj2[0] = tmp25.id;
              obj2[1] = outer1_0(5116).QuestContent.QUEST_BAR_MOBILE;
              obj2[2] = outer1_0(7081).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              obj2[3] = outer1_0(5116).QuestContent.QUEST_BAR_MOBILE;
              const result = captureAdUserAction(7071).trackQuestContentClicked(obj2);
  ...
  items2[2] = callback2(tmp(5633).ActionSheetRow, obj11);
  obj4[1] = items2;
  children[1] = closure_6(tmp(5633).ActionSheetRow.Group, obj4);
  ...
  if (preview) {
    ...
    items3[5] = tmp7(tmp(5633).ActionSheetRow, obj30);
    const obj33 = { icon: null, label: null, onPress: null };
    const obj34 = { IconComponent: null };
    obj34[0] = tmp(4203).CopyIcon;
    obj33[0] = tmp7(tmp(5633).ActionSheetRow.Icon, obj34);
    const obj35 = { text: null };
    const intl13 = tmp(1236).intl;
    obj35[0] = intl13.string(tmp(1236).t.oisrFi);
    obj33[1] = tmp7(tmp(7749).FormLabel, obj35);
    obj33[2] = function onPress() {
      quest(_undefined2[35]).copy(quest.id);
      const obj = quest(_undefined2[35]);
      _undefined(_undefined2[14]).hideActionSheet();
    };
    items3[6] = tmp7(tmp(5633).ActionSheetRow, obj33);
    obj14[2] = items3;
    preview = tmp6(tmp(5633).ActionSheetRow.Group, obj14);
  }
  children[2] = preview;
  return closure_6(quest(5631).ActionSheet, { children });
};
