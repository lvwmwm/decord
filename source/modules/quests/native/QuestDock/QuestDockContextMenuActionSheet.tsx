...
// Dependencies: [5, 19, 676, 21, 7182, 10465, 10487, 5764, 5766, 12664, 7969, 10496, 5164, 7188, 4271, 4251, 1236, 14353, 9522, 9523, 9527, 7189, 7178, 11171, 10160, 14355, 5326, 10467, 14358, 7728, 14359, 14361, 14363, 8503, 6018, 5756, 2]
// Exports: default

// Module 14352 (QuestDockContextMenuActionSheet)
...
export default function QuestDockContextMenuActionSheet(quest) {
  ...
  if (isShareableQuestResult) {
    ...
    obj1[1] = tmp7(tmp(7969).FormLabel, obj3);
  ...
  obj11[1] = callback2(tmp(7969).FormLabel, obj13);
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp4;
            let tmp25 = outer1_0;
            outer1_0(10467).dismissQuestContent(outer1_0.id, outer1_0(5164).QuestContent.QUEST_BAR_MOBILE);
            const obj8 = outer1_0(10467);
            v0(4271).hideActionSheet();
            const obj9 = v0(4271);
            let captureAdUserAction = outer1_0;
            if (obj10.shouldMigrateToAdAnalyticsInterface(outer1_0(9522).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_dock_context_menu")) {
              ...
              obj1[0] = outer1_0(9527).AdUserActionType.CLICK_INTERNAL;
              obj1[1] = outer1_0(7189).AdCreativeType.QUEST;
              obj1[2] = tmp25.id;
              obj1[3] = outer1_0(7188).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              ...
              obj2[2] = outer1_0(7188).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              obj2[3] = outer1_0(5164).QuestContent.QUEST_BAR_MOBILE;
              const result = captureAdUserAction(7178).trackQuestContentClicked(obj2);
  ...
  if (preview) {
    ...
    obj24[1] = tmp7(tmp(7969).FormLabel, obj26);
    ...
    obj27[1] = tmp7(tmp(7969).FormLabel, obj29);
    ...
    obj30[1] = tmp7(tmp(7969).FormLabel, obj32);
    ...
    obj33[1] = tmp7(tmp(7969).FormLabel, obj35);
