...
// Dependencies: [5, 19, 676, 21, 6004, 10488, 9485, 5551, 5553, 12407, 7631, 10494, 5036, 6010, 4157, 4137, 1236, 14126, 8442, 8443, 8447, 6011, 6000, 10956, 9817, 14128, 5175, 9465, 14131, 6646, 14132, 14134, 14136, 8729, 6608, 5543, 2]
// Exports: default

// Module 14125 (QuestDockContextMenuActionSheet)
...
export default function QuestDockContextMenuActionSheet(quest) {
  ...
  obj[0] = quest(12407).LinkExternalMediumIcon;
  obj[0] = callback2(quest(5553).ActionSheetRow.Icon, obj);
  obj[1] = callback2(quest(7631).FormLabel, { text: externalCtaLabel });
  ...
  if (isShareableQuestResult) {
    ...
    obj1[1] = tmp7(tmp(7631).FormLabel, obj3);
  ...
  obj11[1] = callback2(tmp(7631).FormLabel, obj13);
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp4;
            let tmp25 = outer1_0;
            outer1_0(9465).dismissQuestContent(outer1_0.id, outer1_0(5036).QuestContent.QUEST_BAR_MOBILE);
            const obj8 = outer1_0(9465);
            v0(4157).hideActionSheet();
            const obj9 = v0(4157);
            let captureAdUserAction = outer1_0;
            if (obj10.shouldMigrateToAdAnalyticsInterface(outer1_0(8442).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_dock_context_menu")) {
              ...
              obj1[0] = outer1_0(8447).AdUserActionType.CLICK_INTERNAL;
              obj1[1] = outer1_0(6011).AdCreativeType.QUEST;
              obj1[2] = tmp25.id;
              obj1[3] = outer1_0(6010).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              ...
              obj2[2] = outer1_0(6010).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              obj2[3] = outer1_0(5036).QuestContent.QUEST_BAR_MOBILE;
              const result = captureAdUserAction(6000).trackQuestContentClicked(obj2);
  ...
  if (preview) {
    ...
    obj24[1] = tmp7(tmp(7631).FormLabel, obj26);
    ...
    obj27[1] = tmp7(tmp(7631).FormLabel, obj29);
    ...
    obj30[1] = tmp7(tmp(7631).FormLabel, obj32);
    ...
    obj33[1] = tmp7(tmp(7631).FormLabel, obj35);
