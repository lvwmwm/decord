...
// Dependencies: [5, 31, 653, 33, 5987, 10468, 9465, 5533, 5535, 12391, 7611, 10474, 5014, 5993, 4133, 4113, 1212, 14108, 8421, 8422, 8426, 5994, 5983, 10936, 9798, 14110, 5153, 9445, 14113, 6628, 14114, 14116, 14118, 8709, 6590, 5525, 2]
// Exports: default

// Module 14107 (QuestDockContextMenuActionSheet)
...
export default function QuestDockContextMenuActionSheet(quest) {
  ...
  obj = { hasIcons: true };
  obj1 = {};
  obj2 = { IconComponent: quest(12391).LinkExternalMediumIcon };
  obj1.icon = callback2(quest(5535).ActionSheetRow.Icon, obj2);
  obj1.label = callback2(quest(7611).FormLabel, { text: externalCtaLabel });
  ...
  let items = [callback2(quest(5535).ActionSheetRow, obj1), ];
  if (isShareableQuestResult) {
    const obj3 = {};
    const obj4 = { IconComponent: quest(4113).CopyIcon };
    obj3.icon = callback2(quest(5535).ActionSheetRow.Icon, obj4);
    const obj5 = {};
    const intl = quest(1212).intl;
    obj5.text = intl.string(quest(1212).t.WqhZss);
    obj3.label = callback2(quest(7611).FormLabel, obj5);
    ...
    isShareableQuestResult = callback2(quest(5535).ActionSheetRow, obj3);
  }
  items[1] = isShareableQuestResult;
  obj.children = items;
  const items1 = [callback3(quest(5535).ActionSheetRow.Group, obj), , ];
  let obj6 = { hasIcons: true };
  const obj7 = {};
  const obj8 = { IconComponent: importDefault(14108) };
  obj7.icon = callback2(quest(5535).ActionSheetRow.Icon, obj8);
  const obj9 = {};
  const intl2 = quest(1212).intl;
  obj9.text = intl2.string(quest(1212).t.LLLLPD);
  obj7.label = callback2(quest(7611).FormLabel, obj9);
  ...
  const items2 = [callback2(quest(5535).ActionSheetRow, obj7), , ];
  const obj10 = {};
  const obj11 = { IconComponent: quest(9798).CircleQuestionIcon };
  obj10.icon = callback2(quest(5535).ActionSheetRow.Icon, obj11);
  const obj12 = {};
  const intl3 = quest(1212).intl;
  obj12.text = intl3.string(quest(1212).t.GcsZKJ);
  obj10.label = callback2(quest(7611).FormLabel, obj12);
  ...
  items2[1] = callback2(quest(5535).ActionSheetRow, obj10);
  const obj13 = {};
  const obj14 = { IconComponent: quest(5153).XSmallIcon };
  obj13.icon = callback2(quest(5535).ActionSheetRow.Icon, obj14);
  const obj15 = {};
  const intl4 = quest(1212).intl;
  obj15.text = intl4.string(quest(1212).t.NN79E9);
  obj13.label = callback2(quest(7611).FormLabel, obj15);
  ...
  items2[2] = callback2(quest(5535).ActionSheetRow, obj13);
  obj6.children = items2;
  items1[1] = callback3(quest(5535).ActionSheetRow.Group, obj6);
  ...
  if (preview) {
    ...
    obj16.hasIcons = true;
    const obj17 = {};
    const obj18 = { IconComponent: quest(6628).TrophyIcon };
    obj17.icon = callback2(quest(5535).ActionSheetRow.Icon, obj18);
    const obj19 = {};
    const intl7 = quest(1212).intl;
    obj19.text = intl7.string(quest(1212).t.jQEfRT);
    obj17.label = callback2(quest(7611).FormLabel, obj19);
    obj17.onPress = function onPress() {
      callback();
      outer1_1(outer1_2[14]).hideActionSheet();
    };
    const items3 = [callback2(quest(5535).ActionSheetRow, obj17), , , , , , ];
    const obj20 = {};
    const obj21 = { IconComponent: quest(14114).RedoIcon };
    obj20.icon = callback2(quest(5535).ActionSheetRow.Icon, obj21);
    const obj22 = {};
    const intl8 = quest(1212).intl;
    obj22.text = intl8.string(quest(1212).t.cKSLr4);
    obj20.label = callback2(quest(7611).FormLabel, obj22);
    obj20.onPress = function onPress() {
      callback2(0.9 * Math.random() + 0.03);
      outer1_1(outer1_2[14]).hideActionSheet();
    };
    items3[1] = callback2(quest(5535).ActionSheetRow, obj20);
    const obj23 = {};
    const obj24 = { IconComponent: quest(14116).UndoIcon };
    obj23.icon = callback2(quest(5535).ActionSheetRow.Icon, obj24);
    const obj25 = {};
    const intl9 = quest(1212).intl;
    obj25.text = intl9.string(quest(1212).t.taqkwK);
    obj23.label = callback2(quest(7611).FormLabel, obj25);
    obj23.onPress = function onPress() {
      callback4();
      outer1_1(outer1_2[14]).hideActionSheet();
    };
    items3[2] = callback2(quest(5535).ActionSheetRow, obj23);
    const obj26 = {};
    const obj27 = { IconComponent: quest(14118).UnsendIcon };
    obj26.icon = callback2(quest(5535).ActionSheetRow.Icon, obj27);
    const obj28 = {};
    const intl10 = quest(1212).intl;
    obj28.text = intl10.string(quest(1212).t.JF6W66);
    obj26.label = callback2(quest(7611).FormLabel, obj28);
    obj26.onPress = function onPress() {
      callback3();
      outer1_1(outer1_2[14]).hideActionSheet();
    };
    items3[3] = callback2(quest(5535).ActionSheetRow, obj26);
    const obj29 = {};
    const obj30 = { IconComponent: quest(8709).EyeIcon };
    obj29.icon = callback2(quest(5535).ActionSheetRow.Icon, obj30);
    const obj31 = {};
    const intl11 = quest(1212).intl;
    obj31.text = intl11.string(quest(1212).t["lL6/zF"]);
    obj29.label = callback2(quest(7611).FormLabel, obj31);
    ...
    items3[4] = callback2(quest(5535).ActionSheetRow, obj29);
    const obj32 = {};
    const obj33 = { IconComponent: quest(8709).EyeIcon };
    obj32.icon = callback2(quest(5535).ActionSheetRow.Icon, obj33);
    const obj34 = {};
    const intl12 = quest(1212).intl;
    obj34.text = intl12.string(quest(1212).t.tx5Ax5);
    obj32.label = callback2(quest(7611).FormLabel, obj34);
    ...
    items3[5] = callback2(quest(5535).ActionSheetRow, obj32);
    const obj35 = {};
    const obj36 = { IconComponent: quest(4113).CopyIcon };
    obj35.icon = callback2(quest(5535).ActionSheetRow.Icon, obj36);
    const obj37 = {};
    const intl13 = quest(1212).intl;
    obj37.text = intl13.string(quest(1212).t.oisrFi);
    obj35.label = callback2(quest(7611).FormLabel, obj37);
    obj35.onPress = function onPress() {
      quest(outer1_2[35]).copy(quest.id);
      const obj = quest(outer1_2[35]);
      outer1_1(outer1_2[14]).hideActionSheet();
    };
    items3[6] = callback2(quest(5535).ActionSheetRow, obj35);
    obj16.children = items3;
    preview = callback3(quest(5535).ActionSheetRow.Group, obj16);
  }
  items1[2] = preview;
  obj.children = items1;
  return callback3(quest(5533).ActionSheet, obj);
};
