...
// Dependencies: [5, 19, 676, 21, 6006, 10492, 9489, 5551, 5553, 12413, 7634, 10498, 5036, 6012, 4157, 4137, 1236, 14130, 8445, 8446, 8450, 6013, 6002, 10960, 9820, 14132, 5175, 9469, 14135, 6649, 14136, 14138, 14140, 8733, 6611, 5543, 2]
// Exports: default

// Module 14129 (QuestDockContextMenuActionSheet)
...
export default function QuestDockContextMenuActionSheet(quest) {
  ...
  obj[0] = quest(12413).LinkExternalMediumIcon;
  obj[0] = callback2(quest(5553).ActionSheetRow.Icon, obj);
  obj[1] = callback2(quest(7634).FormLabel, { text: externalCtaLabel });
  ...
  let items = [callback2(quest(5553).ActionSheetRow, obj), ];
  ...
  if (isShareableQuestResult) {
    ...
    obj2[0] = tmp(4137).CopyIcon;
    obj1[0] = tmp7(tmp(5553).ActionSheetRow.Icon, obj2);
    let obj3 = { text: null };
    const intl = tmp(1236).intl;
    obj3[0] = intl.string(tmp(1236).t.WqhZss);
    obj1[1] = tmp7(tmp(7634).FormLabel, obj3);
    ...
    tmp7Result = tmp7(tmp(5553).ActionSheetRow, obj1);
  }
  items[1] = tmp7Result;
  const children = [closure_6(quest(5553).ActionSheetRow.Group, { hasIcons: true, children: items }), , ];
  const obj4 = { hasIcons: true, children: null };
  const obj5 = { icon: null, label: null, onPress: null };
  const obj6 = { IconComponent: null };
  obj6[0] = importDefault(14130);
  obj5[0] = callback2(tmp(5553).ActionSheetRow.Icon, obj6);
  const obj7 = { text: null };
  const intl2 = tmp(1236).intl;
  obj7[0] = intl2.string(tmp(1236).t.LLLLPD);
  obj5[1] = callback2(tmp(7634).FormLabel, obj7);
  ...
  const items2 = [callback2(tmp(5553).ActionSheetRow, obj5), , ];
  let obj8 = { icon: null, label: null, onPress: null };
  let obj9 = { IconComponent: null };
  obj9[0] = tmp(9820).CircleQuestionIcon;
  obj8[0] = callback2(tmp(5553).ActionSheetRow.Icon, obj9);
  let obj10 = { text: null };
  const intl3 = tmp(1236).intl;
  obj10[0] = intl3.string(tmp(1236).t.GcsZKJ);
  obj8[1] = callback2(tmp(7634).FormLabel, obj10);
  ...
  items2[1] = callback2(tmp(5553).ActionSheetRow, obj8);
  const obj11 = { icon: null, label: null, subLabel: null, onPress: null };
  const obj12 = { IconComponent: null };
  obj12[0] = tmp(5175).XSmallIcon;
  obj11[0] = callback2(tmp(5553).ActionSheetRow.Icon, obj12);
  const obj13 = { text: null };
  const intl4 = tmp(1236).intl;
  obj13[0] = intl4.string(tmp(1236).t.NN79E9);
  obj11[1] = callback2(tmp(7634).FormLabel, obj13);
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp4;
            let tmp25 = outer1_0;
            outer1_0(9469).dismissQuestContent(outer1_0.id, outer1_0(5036).QuestContent.QUEST_BAR_MOBILE);
            const obj8 = outer1_0(9469);
            v0(4157).hideActionSheet();
            const obj9 = v0(4157);
            let captureAdUserAction = outer1_0;
            if (obj10.shouldMigrateToAdAnalyticsInterface(outer1_0(8445).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_dock_context_menu")) {
              captureAdUserAction = captureAdUserAction(8446).captureAdUserAction;
              const obj1 = { type: null, adCreativeType: null, adCreativeId: null, questContentCTA: null, surfaceId: null, sourceQuestContent: null };
              obj1[0] = outer1_0(8450).AdUserActionType.CLICK_INTERNAL;
              obj1[1] = outer1_0(6013).AdCreativeType.QUEST;
              obj1[2] = tmp25.id;
              obj1[3] = outer1_0(6012).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              obj1[4] = outer1_0(5036).QuestContent.QUEST_BAR_MOBILE;
              tmp25 = outer1_0;
              obj1[5] = outer1_0(5036).QuestContent.QUEST_BAR_MOBILE;
              captureAdUserAction(obj1);
              const captureAdUserActionResult = captureAdUserAction(8446);
            } else {
              const obj2 = { questId: null, questContent: null, questContentCTA: null, sourceQuestContent: null };
              obj2[0] = tmp25.id;
              obj2[1] = outer1_0(5036).QuestContent.QUEST_BAR_MOBILE;
              obj2[2] = outer1_0(6012).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              obj2[3] = outer1_0(5036).QuestContent.QUEST_BAR_MOBILE;
              const result = captureAdUserAction(6002).trackQuestContentClicked(obj2);
              const captureAdUserActionResult2 = captureAdUserAction(6002);
            }
            v0 = 1;
            dependencyMap = 1;
            obj10 = outer1_0(8445);
  ...
  items2[2] = callback2(tmp(5553).ActionSheetRow, obj11);
  obj4[1] = items2;
  children[1] = closure_6(tmp(5553).ActionSheetRow.Group, obj4);
  ...
  if (preview) {
    ...
    items3[5] = tmp7(tmp(5553).ActionSheetRow, obj30);
    const obj33 = { icon: null, label: null, onPress: null };
    const obj34 = { IconComponent: null };
    obj34[0] = tmp(4137).CopyIcon;
    obj33[0] = tmp7(tmp(5553).ActionSheetRow.Icon, obj34);
    const obj35 = { text: null };
    const intl13 = tmp(1236).intl;
    obj35[0] = intl13.string(tmp(1236).t.oisrFi);
    obj33[1] = tmp7(tmp(7634).FormLabel, obj35);
    obj33[2] = function onPress() {
      quest(_undefined2[35]).copy(quest.id);
      const obj = quest(_undefined2[35]);
      _undefined(_undefined2[14]).hideActionSheet();
    };
    items3[6] = tmp7(tmp(5553).ActionSheetRow, obj33);
    obj14[2] = items3;
    preview = tmp6(tmp(5553).ActionSheetRow.Group, obj14);
  }
  children[2] = preview;
  return closure_6(quest(5551).ActionSheet, { children });
};
