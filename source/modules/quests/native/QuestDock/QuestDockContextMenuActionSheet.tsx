...
// Dependencies: [5, 19, 676, 21, 7089, 10643, 9647, 5617, 5619, 12531, 7765, 10648, 5102, 7095, 4223, 4203, 1236, 14215, 8756, 8757, 8761, 7096, 7085, 11095, 9979, 14217, 5241, 9627, 14220, 7635, 14221, 14223, 14225, 8919, 5915, 5609, 2]
// Exports: default

// Module 14214 (QuestDockContextMenuActionSheet)
...
export default function QuestDockContextMenuActionSheet(quest) {
  ...
  obj[0] = quest(12531).LinkExternalMediumIcon;
  obj[0] = callback2(quest(5619).ActionSheetRow.Icon, obj);
  obj[1] = callback2(quest(7765).FormLabel, { text: externalCtaLabel });
  ...
  let items = [callback2(quest(5619).ActionSheetRow, obj), ];
  ...
  if (isShareableQuestResult) {
    ...
    obj1[0] = tmp7(tmp(5619).ActionSheetRow.Icon, obj2);
    let obj3 = { text: null };
    const intl = tmp(1236).intl;
    obj3[0] = intl.string(tmp(1236).t.WqhZss);
    obj1[1] = tmp7(tmp(7765).FormLabel, obj3);
    ...
    tmp7Result = tmp7(tmp(5619).ActionSheetRow, obj1);
  }
  items[1] = tmp7Result;
  const children = [closure_6(quest(5619).ActionSheetRow.Group, { hasIcons: true, children: items }), , ];
  const obj4 = { hasIcons: true, children: null };
  const obj5 = { icon: null, label: null, onPress: null };
  const obj6 = { IconComponent: null };
  obj6[0] = importDefault(14215);
  obj5[0] = callback2(tmp(5619).ActionSheetRow.Icon, obj6);
  const obj7 = { text: null };
  const intl2 = tmp(1236).intl;
  obj7[0] = intl2.string(tmp(1236).t.LLLLPD);
  obj5[1] = callback2(tmp(7765).FormLabel, obj7);
  ...
  const items2 = [callback2(tmp(5619).ActionSheetRow, obj5), , ];
  let obj8 = { icon: null, label: null, onPress: null };
  let obj9 = { IconComponent: null };
  obj9[0] = tmp(9979).CircleQuestionIcon;
  obj8[0] = callback2(tmp(5619).ActionSheetRow.Icon, obj9);
  let obj10 = { text: null };
  const intl3 = tmp(1236).intl;
  obj10[0] = intl3.string(tmp(1236).t.GcsZKJ);
  obj8[1] = callback2(tmp(7765).FormLabel, obj10);
  ...
  items2[1] = callback2(tmp(5619).ActionSheetRow, obj8);
  const obj11 = { icon: null, label: null, subLabel: null, onPress: null };
  const obj12 = { IconComponent: null };
  obj12[0] = tmp(5241).XSmallIcon;
  obj11[0] = callback2(tmp(5619).ActionSheetRow.Icon, obj12);
  const obj13 = { text: null };
  const intl4 = tmp(1236).intl;
  obj13[0] = intl4.string(tmp(1236).t.NN79E9);
  obj11[1] = callback2(tmp(7765).FormLabel, obj13);
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp4;
            let tmp25 = outer1_0;
            outer1_0(9627).dismissQuestContent(outer1_0.id, outer1_0(5102).QuestContent.QUEST_BAR_MOBILE);
            const obj8 = outer1_0(9627);
            v0(4223).hideActionSheet();
            const obj9 = v0(4223);
            let captureAdUserAction = outer1_0;
            if (obj10.shouldMigrateToAdAnalyticsInterface(outer1_0(8756).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_dock_context_menu")) {
              ...
              obj1[0] = outer1_0(8761).AdUserActionType.CLICK_INTERNAL;
              obj1[1] = outer1_0(7096).AdCreativeType.QUEST;
              obj1[2] = tmp25.id;
              obj1[3] = outer1_0(7095).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              obj1[4] = outer1_0(5102).QuestContent.QUEST_BAR_MOBILE;
              tmp25 = outer1_0;
              obj1[5] = outer1_0(5102).QuestContent.QUEST_BAR_MOBILE;
              ...
              obj2[0] = tmp25.id;
              obj2[1] = outer1_0(5102).QuestContent.QUEST_BAR_MOBILE;
              obj2[2] = outer1_0(7095).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT;
              obj2[3] = outer1_0(5102).QuestContent.QUEST_BAR_MOBILE;
              const result = captureAdUserAction(7085).trackQuestContentClicked(obj2);
  ...
  items2[2] = callback2(tmp(5619).ActionSheetRow, obj11);
  obj4[1] = items2;
  children[1] = closure_6(tmp(5619).ActionSheetRow.Group, obj4);
