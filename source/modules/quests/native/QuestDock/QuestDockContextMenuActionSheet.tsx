...
// Dependencies: [5, 19, 676, 21, 7181, 10459, 10481, 5764, 5766, 12658, 7967, 10490, 5164, 7187, 4271, 4251, 1236, 14343, 9516, 9517, 9521, 7188, 7177, 11165, 10154, 14345, 5326, 10461, 14348, 7726, 14349, 14351, 14353, 8497, 6016, 5756, 2]
// Exports: default

// Module 14342 (QuestDockContextMenuActionSheet)
...
export default function QuestDockContextMenuActionSheet(quest) {
  ...
  obj9[0] = tmp(10154).CircleQuestionIcon;
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp4;
            let tmp25 = outer1_0;
            outer1_0(10461).dismissQuestContent(outer1_0.id, outer1_0(5164).QuestContent.QUEST_BAR_MOBILE);
            const obj8 = outer1_0(10461);
