...
// Dependencies: [5, 19, 673, 21, 15026, 5411, 11227, 1233, 5407, 7661, 11124, 11125, 11129, 7651, 7140, 9008, 8523, 11428, 4448, 7138, 7655, 15028, 11699, 5635, 11208, 15030, 11456, 11415, 8647, 15031, 15033, 15035, 6910, 7320, 4428, 7130, 11037, 15037, 2]
// Exports: default

// Module 15027 (QuestDockPreviewTools)
...
function QuestDockPreviewTools(quest) {
  ...
  obj[0] = intl.string(quest(1233).t["Ape+mm"]);
  obj = { icon: callback(quest(7140).ActionSheetRow.Icon, { IconComponent: quest(8647).TrophyIcon }), label: null, onPress: null };
  const obj2 = { text: null };
  const intl2 = quest(1233).intl;
  obj2[0] = intl2.string(quest(1233).t.jQEfRT);
  obj[1] = callback(quest(8523).FormLabel, obj2);
  obj[2] = function onPress() {
    _undefined();
    _undefined(_undefined2[18]).hideActionSheet();
  };
  let items = [callback(quest(7140).ActionSheetRow, obj), , , , , , ];
  const obj3 = { icon: null, label: null, onPress: null };
  obj1 = { IconComponent: quest(8647).TrophyIcon };
  obj3[0] = callback(quest(7140).ActionSheetRow.Icon, { IconComponent: quest(15031).RedoIcon });
  const obj5 = { text: null };
  const intl3 = quest(1233).intl;
  obj5[0] = intl3.string(quest(1233).t.cKSLr4);
  obj3[1] = callback(quest(8523).FormLabel, obj5);
  obj3[2] = function onPress() {
    _undefined2(0.9 * Math.random() + 0.03);
    _undefined(_undefined2[18]).hideActionSheet();
  };
  items[1] = callback(quest(7140).ActionSheetRow, obj3);
  const obj6 = { icon: null, label: null, onPress: null };
  const obj4 = { IconComponent: quest(15031).RedoIcon };
  obj6[0] = callback(quest(7140).ActionSheetRow.Icon, { IconComponent: quest(15033).UndoIcon });
  const obj8 = { text: null };
  const intl4 = quest(1233).intl;
  obj8[0] = intl4.string(quest(1233).t.taqkwK);
  obj6[1] = callback(quest(8523).FormLabel, obj8);
  obj6[2] = function onPress() {
    _undefined4();
    _undefined(_undefined2[18]).hideActionSheet();
  };
  items[2] = callback(quest(7140).ActionSheetRow, obj6);
  const obj9 = { icon: null, label: null, onPress: null };
  const obj7 = { IconComponent: quest(15033).UndoIcon };
  obj9[0] = callback(quest(7140).ActionSheetRow.Icon, { IconComponent: quest(15035).UnsendIcon });
  const obj11 = { text: null };
  const intl5 = quest(1233).intl;
  obj11[0] = intl5.string(quest(1233).t.JF6W66);
  obj9[1] = callback(quest(8523).FormLabel, obj11);
  obj9[2] = function onPress() {
    _undefined3();
    _undefined(_undefined2[18]).hideActionSheet();
  };
  items[3] = callback(quest(7140).ActionSheetRow, obj9);
  const obj12 = { icon: null, label: null, onPress: null };
  const obj10 = { IconComponent: quest(15035).UnsendIcon };
  obj12[0] = callback(quest(7140).ActionSheetRow.Icon, { IconComponent: quest(6910).EyeIcon });
  const obj14 = { text: null };
  const intl6 = quest(1233).intl;
  obj14[0] = intl6.string(quest(1233).t["lL6/zF"]);
  obj12[1] = callback(quest(8523).FormLabel, obj14);
  ...
  items[4] = callback(quest(7140).ActionSheetRow, obj12);
  const obj15 = { icon: null, label: null, onPress: null };
  const obj13 = { IconComponent: quest(6910).EyeIcon };
  obj15[0] = callback(quest(7140).ActionSheetRow.Icon, { IconComponent: quest(6910).EyeIcon });
  const obj17 = { text: null };
  const intl7 = quest(1233).intl;
  obj17[0] = intl7.string(quest(1233).t.tx5Ax5);
  obj15[1] = callback(quest(8523).FormLabel, obj17);
  ...
  items[5] = callback(quest(7140).ActionSheetRow, obj15);
  const obj18 = { icon: null, label: null, onPress: null };
  const obj16 = { IconComponent: quest(6910).EyeIcon };
  obj18[0] = callback(quest(7140).ActionSheetRow.Icon, { IconComponent: quest(4428).CopyIcon });
  const obj20 = { text: null };
  const intl8 = quest(1233).intl;
  obj20[0] = intl8.string(quest(1233).t.oisrFi);
  obj18[1] = callback(quest(8523).FormLabel, obj20);
  obj18[2] = function onPress() {
    quest(_undefined2[35]).copy(quest.id);
    const obj = quest(_undefined2[35]);
    _undefined(_undefined2[18]).hideActionSheet();
  };
  items[6] = callback(quest(7140).ActionSheetRow, obj18);
  obj[2] = items;
  return callback2(quest(7140).ActionSheetRow.Group, obj);
}
function QuestDockShareRow(quest) {
  quest = quest.quest;
  let obj = { icon: null, label: null, onPress: null };
  obj = { IconComponent: quest(4428).CopyIcon };
  obj[0] = callback(quest(7140).ActionSheetRow.Icon, obj);
  obj = { text: null };
  const intl = quest(1233).intl;
  obj[0] = intl.string(quest(1233).t.WqhZss);
  obj[1] = callback(quest(8523).FormLabel, obj);
  obj[2] = function onPress() {
  ...
  return callback(quest(7140).ActionSheetRow, obj);
}
function QuestDockDisclosureRow(creative) {
  creative = creative.creative;
  let obj = { icon: null, label: null, onPress: null };
  obj = { IconComponent: creative(11037).CircleQuestionIcon };
  obj[0] = callback(creative(7140).ActionSheetRow.Icon, obj);
  obj = { text: null };
  const intl = creative(1233).intl;
  obj[0] = intl.string(creative(1233).t.GcsZKJ);
  obj[1] = callback(creative(8523).FormLabel, obj);
  obj[2] = function onPress() {
  ...
  return callback(creative(7140).ActionSheetRow, obj);
}
noopAll;
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            closure_0 = tmp2;
            closure_1_3(closure_1_0(7661).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT);
            const type = closure_1_0.type;
            if (closure_1_0(5411).AdCreativeType.QUEST === type) {
              const obj7 = closure_1_0(11208);
              const dismissQuestContentResult = closure_1_0(11208).dismissQuestContent(tmp37.quest.id, closure_1_0(5407).QuestContent.QUEST_BAR_MOBILE);
              v0(4448).hideActionSheet();
              v0 = 1;
              dependencyMap = 1;
              obj1 = { value: null, done: false };
              obj1[0] = dismissQuestContentResult;
              return obj1;
            } else if (closure_1_0(5411).AdCreativeType.BOUNTY === type) {
              let obj3 = closure_1_0(11456);
              const dismissAdContentResult = obj3.dismissAdContent(v0, closure_1_0(5407).QuestContent.QUEST_BAR_MOBILE);
              v0(4448).hideActionSheet();
              v0 = 2;
              dependencyMap = 1;
