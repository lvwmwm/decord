...
// Dependencies: [5, 19, 676, 21, 7474, 10684, 10496, 7175, 7177, 12820, 8083, 10689, 6719, 7480, 4342, 4322, 1236, 14455, 9502, 9503, 9507, 7469, 7470, 10947, 10415, 14457, 6368, 10477, 14460, 8010, 14461, 14463, 14465, 8607, 7360, 7167, 2]
// Exports: default

// Module 14454 (QuestDockContextMenuActionSheet)
...
export default function QuestDockContextMenuActionSheet(quest) {
  ...
  let items = [callback2(quest(7177).ActionSheetRow, obj), ];
  ...
  if (isShareableQuestResult) {
    ...
    obj2[0] = tmp(4322).CopyIcon;
    obj1[0] = tmp7(tmp(7177).ActionSheetRow.Icon, obj2);
    let obj3 = { text: null };
    const intl = tmp(1236).intl;
    obj3[0] = intl.string(tmp(1236).t.WqhZss);
    obj1[1] = tmp7(tmp(8083).FormLabel, obj3);
    ...
    tmp7Result = tmp7(tmp(7177).ActionSheetRow, obj1);
  }
  items[1] = tmp7Result;
  ...
  obj8[1] = callback2(tmp(8083).FormLabel, obj10);
  ...
  obj11[1] = callback2(tmp(8083).FormLabel, obj13);
  ...
  items2[2] = callback2(tmp(7177).ActionSheetRow, obj11);
  obj4[1] = items2;
  children[1] = closure_6(tmp(7177).ActionSheetRow.Group, obj4);
  ...
  if (preview) {
    ...
    items3[5] = tmp7(tmp(7177).ActionSheetRow, obj30);
    const obj33 = { icon: null, label: null, onPress: null };
    const obj34 = { IconComponent: null };
    obj34[0] = tmp(4322).CopyIcon;
    obj33[0] = tmp7(tmp(7177).ActionSheetRow.Icon, obj34);
    const obj35 = { text: null };
    const intl13 = tmp(1236).intl;
    obj35[0] = intl13.string(tmp(1236).t.oisrFi);
    obj33[1] = tmp7(tmp(8083).FormLabel, obj35);
    obj33[2] = function onPress() {
      quest(_undefined2[35]).copy(quest.id);
      const obj = quest(_undefined2[35]);
      _undefined(_undefined2[14]).hideActionSheet();
    };
    items3[6] = tmp7(tmp(7177).ActionSheetRow, obj33);
    obj14[2] = items3;
    preview = tmp6(tmp(7177).ActionSheetRow.Group, obj14);
  }
  children[2] = preview;
  return closure_6(quest(7175).ActionSheet, { children });
};
