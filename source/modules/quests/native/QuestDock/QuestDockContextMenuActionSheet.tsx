...
export default function QuestDockContextMenuActionSheet(quest) {
  ...
  if (isShareableQuestResult) {
    ...
    isShareableQuestResult = callback2(quest(5500).ActionSheetRow, obj3);
  }
  ...
  items2[1] = callback2(quest(5500).ActionSheetRow, obj10);
  const obj13 = {};
  const obj14 = { IconComponent: quest(5119).XSmallIcon };
  obj13.icon = callback2(quest(5500).ActionSheetRow.Icon, obj14);
  const obj15 = {};
  ...
  items2[2] = callback2(quest(5500).ActionSheetRow, obj13);
  obj6.children = items2;
  items1[1] = callback3(quest(5500).ActionSheetRow.Group, obj6);
  ...
  if (preview) {
    ...
    items3[6] = callback2(quest(5500).ActionSheetRow, obj35);
    obj16.children = items3;
    preview = callback3(quest(5500).ActionSheetRow.Group, obj16);
  }
  items1[2] = preview;
  obj.children = items1;
  return callback3(quest(5498).ActionSheet, obj);
};
