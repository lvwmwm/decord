...
const memoResult = importAllResult.memo(function QuestDockContentCollapsed(children) {
  ...
  const require = tmp;
  const activeQuestDockMode = importAllResult.useContext(require(14215) /* QuestDockMode */.QuestDockGestureContext).activeQuestDockMode;
  ...
  obj = { withSpring: require(4664) /* CONFIG_NEVER_ANIMATE */.withSpring, activeQuestDockMode, QuestDockMode, hideOnExpand: tmp, QUEST_DOCK_MODE_CHANGE_PHYSICS: closure_5 };
  fn.__closure = obj;
