// Module ID: 14339
// Function ID: 14340
// Dependencies: [19, 17, 5143, 14251, 21, 4285, 14252, 4145, 4694, 7932, 2]
...
const memoResult = importAllResult.memo(function QuestDockContentCollapsed(children) {
  ...
  const require = tmp;
  const activeQuestDockMode = importAllResult.useContext(require(14252) /* QuestDockMode */.QuestDockGestureContext).activeQuestDockMode;
  ...
  const animatedProps = require(4145).useAnimatedProps(C);
