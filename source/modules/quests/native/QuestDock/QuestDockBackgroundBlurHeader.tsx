...
// Dependencies: [32, 19, 17, 5404, 15019, 21, 4481, 709, 4935, 15020, 1235, 4197, 15108, 4218, 7013, 15117, 15085, 5084, 4477, 1233, 11037, 15119, 8602, 2]

// Module 15116 (QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED)
...
const memoResult = importAllResult.memo(function QuestDockBackgroundBlurHeader(arg0) {
  ...
  const context = importAllResult.useContext(activeQuestDockMode(15020).QuestDockGestureContext);
  ...
  let obj = activeQuestDockMode(4197);
  token = obj.useToken(questDockWrapperSpecs(709).modules.mobile.QUEST_DOCK_BORDER_RADIUS);
  const tmp9 = questDockWrapperSpecs(15108)(token);
  importAllResult = tmp9;
  obj1 = activeQuestDockMode(4218);
  class G {
    constructor() {
  ...
  obj = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII: closure_9, questDockBorderRadius: token, withSpring: activeQuestDockMode(4935).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  G.__closure = obj;
  G.__workletHash = 17202411570804;
  G.__initData = closure_17;
  const animatedStyle = obj1.useAnimatedStyle(G);
  let obj3 = activeQuestDockMode(4218);
  const fn = function b() {
  ...
  obj = { withSpring: activeQuestDockMode(4935).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn.__closure = obj;
  fn.__workletHash = 5804990093011;
  fn.__initData = closure_18;
  const animatedStyle1 = obj3.useAnimatedStyle(fn);
  let obj5 = activeQuestDockMode(4218);
  class Y {
    constructor() {
      right = 0;
      if (activeQuestDockMode.get() === closure_1_7.EXPANDED) {
  ...
  let obj7 = activeQuestDockMode(4218);
  ...
  fn2.__closure = { withSpring: activeQuestDockMode(4935).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn2.__workletHash = 6229744150165;
  fn2.__initData = closure_20;
  const animatedStyle3 = obj7.useAnimatedStyle(fn2);
  let obj9 = activeQuestDockMode(4218);
  ...
  let obj10 = activeQuestDockMode(4218);
  class W {
    constructor() {
      pointerEvents = "none";
      if (activeQuestDockMode.get() === closure_1_7.EXPANDED) {
  ...
  let obj11 = activeQuestDockMode(4218);
  class V {
    constructor() {
      obj = activeQuestDockMode;
      tmp = closure_1_7;
  ...
  obj3 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII: closure_9, questDockBorderRadius: token, withSpring: activeQuestDockMode(4935).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  V.__closure = obj3;
  ...
  const obj2 = { withSpring: activeQuestDockMode(4935).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  let obj14 = activeQuestDockMode(1235);
  if (obj14.isAndroid()) {
    if (null != blurHash) {
      ...
      obj5[2] = tmp20;
      let tmp23 = callback(tmp7(15117), obj5);
      let tmp22 = callback;
    }
    ...
    if (withPressableDisclosure) {
      ...
      obj13[2] = intl2.string(tmp(1233).t.o6FLcF);
      const items6 = [tmp22(tmp(4477).Text, obj13), ];
      obj14 = { color: null, style: null };
      obj14[0] = tmp7(709).colors.INTERACTIVE_TEXT_ACTIVE;
      obj14[1] = tmp17.actionDisclosuresIcon;
      items6[1] = tmp22(tmp(11037).CircleQuestionIcon, obj14);
      obj12[0] = items6;
      obj11[3] = tmp18(closure_13, obj12);
      let tmp22Result = tmp22(tmp(5084).PressableOpacity, obj11);
    } else {
      ...
      obj16[2] = intl.string(tmp(1233).t.o6FLcF);
      obj15[1] = tmp22(tmp(4477).Text, obj16);
      tmp22Result = tmp22(tmp25, obj15);
    }
    const items8 = [tmp22Result, tmp22(tmp7(15119), {}), ];
    ...
    obj17[1] = obj29.string(tmp(1233).t.PdRCRg);
    obj17[2] = onSubmenuPress;
    obj17[3] = tmp17.tertiaryContent;
    const obj18 = { color: null };
    obj18[0] = tmp7(709).colors.INTERACTIVE_TEXT_ACTIVE;
    obj17[4] = tmp22(tmp(8602).MoreHorizontalIcon, obj18);
    items8[2] = tmp22(tmp(5084).PressableOpacity, obj17);
    obj10[1] = items8;
    obj9[3] = tmp18(tmp7(7013), obj10);
  ...
  tmp22 = callback;
  tmp23 = callback(tmp7(15085), { animatedStyle: animatedStyle5, animatedLayout: tmp20 });
});
