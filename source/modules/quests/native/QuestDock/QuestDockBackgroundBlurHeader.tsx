...
// Dependencies: [32, 19, 17, 5395, 14922, 21, 4478, 709, 4927, 14923, 1235, 4197, 15011, 4217, 7805, 15020, 14988, 5076, 4474, 1233, 11074, 15022, 8813, 2]

// Module 15019 (QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED)
...
const memoResult = importAllResult.memo(function QuestDockBackgroundBlurHeader(arg0) {
  ...
  const context = importAllResult.useContext(activeQuestDockMode(14923).QuestDockGestureContext);
  ...
  const tmp9 = questDockWrapperSpecs(15011)(token);
  ...
  obj = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII: closure_9, questDockBorderRadius: token, withSpring: activeQuestDockMode(4927).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  G.__closure = obj;
  ...
  obj = { withSpring: activeQuestDockMode(4927).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn.__closure = obj;
  ...
  let obj7 = activeQuestDockMode(4217);
  ...
  fn2.__closure = { withSpring: activeQuestDockMode(4927).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn2.__workletHash = 6229744150165;
  fn2.__initData = closure_20;
  const animatedStyle3 = obj7.useAnimatedStyle(fn2);
  let obj9 = activeQuestDockMode(4217);
  ...
  let obj10 = activeQuestDockMode(4217);
  class W {
    constructor() {
      pointerEvents = "none";
      if (activeQuestDockMode.get() === closure_1_7.EXPANDED) {
  ...
  let obj11 = activeQuestDockMode(4217);
  class V {
    constructor() {
      obj = activeQuestDockMode;
      tmp = closure_1_7;
  ...
  obj3 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII: closure_9, questDockBorderRadius: token, withSpring: activeQuestDockMode(4927).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  V.__closure = obj3;
  ...
  const obj2 = { withSpring: activeQuestDockMode(4927).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  if (obj14.isAndroid()) {
    if (null != blurHash) {
      ...
      obj5[2] = tmp20;
      let tmp23 = callback(tmp7(15020), obj5);
      let tmp22 = callback;
    }
    ...
    obj7[0] = items2;
    obj7[1] = tmp20;
    let tmp7Result = tmp7(7805);
    const obj8 = { style: null, children: null };
    obj8[0] = animatedStyle1;
    obj8[1] = collapsedContent;
    obj7[2] = tmp22(tmp7(7805), obj8);
    ...
    if (withPressableDisclosure) {
      ...
      const items6 = [tmp22(tmp(4474).Text, obj13), ];
      obj14 = { color: null, style: null };
      obj14[0] = tmp7(709).colors.INTERACTIVE_TEXT_ACTIVE;
      obj14[1] = tmp17.actionDisclosuresIcon;
      items6[1] = tmp22(tmp(11074).CircleQuestionIcon, obj14);
      obj12[0] = items6;
      obj11[3] = tmp18(closure_13, obj12);
      let tmp22Result = tmp22(tmp(5076).PressableOpacity, obj11);
    } else {
      ...
      obj15[1] = tmp22(tmp(4474).Text, obj16);
      tmp22Result = tmp22(tmp25, obj15);
    }
    const items8 = [tmp22Result, tmp22(tmp7(15022), {}), ];
    ...
    obj17[4] = tmp22(tmp(8813).MoreHorizontalIcon, obj18);
    items8[2] = tmp22(tmp(5076).PressableOpacity, obj17);
    obj10[1] = items8;
    obj9[3] = tmp18(tmp7(7805), obj10);
  ...
  tmp22 = callback;
  tmp23 = callback(tmp7(14988), { animatedStyle: animatedStyle5, animatedLayout: tmp20 });
});
