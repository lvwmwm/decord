...
// Dependencies: [17, 14335, 687, 4713, 2]
...
// Module 14334 (QUEST_DOCK_HORIZONTAL_EDGE_GUTTER_COLLAPSED)
...
function dimensionsLayoutTransition(currentOriginX) {
  ...
  obj[0] = require(4713) /* CONFIG_NEVER_ANIMATE */.withSpring(currentOriginX.targetOriginX, QUEST_DOCK_MODE_CHANGE_PHYSICS);
  const obj4 = require(4713) /* CONFIG_NEVER_ANIMATE */;
  obj[1] = require(4713) /* CONFIG_NEVER_ANIMATE */.withSpring(currentOriginX.targetOriginY, QUEST_DOCK_MODE_CHANGE_PHYSICS);
  const obj5 = require(4713) /* CONFIG_NEVER_ANIMATE */;
  obj[2] = require(4713) /* CONFIG_NEVER_ANIMATE */.withSpring(currentOriginX.targetHeight, QUEST_DOCK_MODE_CHANGE_PHYSICS);
  const obj6 = require(4713) /* CONFIG_NEVER_ANIMATE */;
  obj[3] = require(4713) /* CONFIG_NEVER_ANIMATE */.withSpring(currentOriginX.targetWidth, QUEST_DOCK_MODE_CHANGE_PHYSICS);
  obj[1] = obj;
  return obj;
}
