...
// Dependencies: [17, 14402, 687, 4753, 2]
...
function dimensionsLayoutTransition(currentOriginX) {
  ...
  obj[0] = require(4753) /* CONFIG_NEVER_ANIMATE */.withSpring(currentOriginX.targetOriginX, QUEST_DOCK_MODE_CHANGE_PHYSICS);
  const obj4 = require(4753) /* CONFIG_NEVER_ANIMATE */;
  obj[1] = require(4753) /* CONFIG_NEVER_ANIMATE */.withSpring(currentOriginX.targetOriginY, QUEST_DOCK_MODE_CHANGE_PHYSICS);
  const obj5 = require(4753) /* CONFIG_NEVER_ANIMATE */;
  obj[2] = require(4753) /* CONFIG_NEVER_ANIMATE */.withSpring(currentOriginX.targetHeight, QUEST_DOCK_MODE_CHANGE_PHYSICS);
  const obj6 = require(4753) /* CONFIG_NEVER_ANIMATE */;
  obj[3] = require(4753) /* CONFIG_NEVER_ANIMATE */.withSpring(currentOriginX.targetWidth, QUEST_DOCK_MODE_CHANGE_PHYSICS);
  obj[1] = obj;
  return obj;
}
