...
// Module 13946 (QuestDockWithGestureAnimation)
let StyleSheet;
function QuestDockWithGestureAnimation(appThemedBackgroundColor) {
  ...
  class W {
    constructor() {
      ...
      interpolateResult = obj4.interpolate(closure_10.get(), ["getViewManagerConfig", "hasViewManagerConfig"], [null, null]);
...
class QuestDockWithEntranceAnimation {
  constructor() {
    context = closure_5.useContext(importDefault(f106028[12]));
    isRendered = context.isRendered;
    arg1 = isRendered;
    quest = context.quest;
    importDefault = quest;
    f106028 = closure_4(closure_5.useState(() => performance.now()), 1)[0];
    closure_3 = closure_5.useRef(false);
    tmp2 = f106046();
    tmp3 = closure_4(closure_5.useState({ aze: false, azj: true }), 2);
    first = tmp3[0];
    closure_4 = first;
    closure_5 = tmp3[1];
    obj = arg1(f106028[38]);
    items = [];
    items[0] = Image;
    f106029 = obj.useStateFromStores(items, () => staticUrl.prevRestingQuestDockMode);
    obj2 = arg1(f106028[39]);
    isEligibleForQuests = obj2.getIsEligibleForQuests();
    obj3 = arg1(f106028[35]);
    questBarImpressionSurvey = obj3.useQuestBarImpressionSurvey(quest);
    obj4 = arg1(f106028[17]);
    fn = function c() {
      let obj = {};
      let num = 0;
      if (isRendered) {
    ...
    obj = { withSpring: arg1(f106028[23]).withSpring, isRendered, ENTRANCE_ANIMATION_SPING_CONFIG: f106046, componentDimensions: first };
    fn.__closure = obj;
    fn.__workletHash = 15545726338295;
    fn.__initData = f106046;
    animatedStyle = obj4.useAnimatedStyle(fn);
    tmp8 = closure_4(closure_5.useState(null), 2);
    first1 = tmp8[0];
    closure_7 = first1;
    Image = tmp8[1];
    obj6 = arg1(f106028[40]);
    staticUrl = obj6.useQuestDockHeroAsset(quest).staticUrl;
    Image = staticUrl;
    obj7 = arg1(f106028[40]);
    ...
    obj8 = arg1(f106028[41]);
    gradientBottom = obj8.useGradientBottom();
    obj9 = arg1(f106028[21]);
    token = obj9.useToken(importDefault(f106028[11]).colors.BACKGROUND_SURFACE_HIGH);
    ...
    if (!tmp17) {
      ...
      num2 = 36;
      obj2.questContent = arg1(f106028[36]).QuestContent.QUEST_BAR_MOBILE;
      obj2.questOrQuests = quest;
      obj2.onImpression = questBarImpressionSurvey;
      obj2.sourceQuestContent = arg1(f106028[36]).QuestContent.QUEST_BAR_MOBILE;
      ...
      obj1.children = jsx(arg1(f106028[47]).QuestContentImpressionTrackerNative, obj2);
      tmp19 = jsx(importDefault(f106028[17]).View, obj1);
    }
    return tmp19;
  }
}
...
let obj = { wrapper: { sku: "<string:2408185858>", isOwned: "<string:2102460417>", isContentClassificationRestricted: "<string:2673934692>", beforeBreadcrumb: "<string:75144002>" } };
obj = {};
