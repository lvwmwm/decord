...
// Dependencies: [5, 32, 19, 17, 14400, 5201, 14402, 676, 505, 21, 4344, 712, 14403, 14406, 14399, 4740, 4083, 8777, 1628, 14407, 4065, 14490, 4753, 14401, 4757, 4737, 14491, 8050, 1236, 14492, 14493, 14494, 4742, 10506, 5204, 14495, 14424, 14488, 589, 10507, 14398, 8436, 698, 7103, 7108, 7227, 10508, 11234, 4072, 14496, 14497, 14502, 14503, 14504, 7228, 2]

// Module 14489 (QuestDockWithGestureAnimation)
...
function QuestDockModeChangeTracker(arg0) {
  ...
  obj = { mode, questContent: require(5204) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE, questId, sourceQuestContent: require(5204) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE };
