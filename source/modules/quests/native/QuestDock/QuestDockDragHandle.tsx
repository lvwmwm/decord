...
// Dependencies: [31, 27, 5011, 14100, 33, 4165, 14182, 14101, 14102, 4026, 1324, 4577, 7656, 14099, 5481, 1212, 2]

// Module 14197 (getDragHandleOffsetLeft)
...
const memoResult = importAllResult.memo(function QuestDockDragHandle(isExpanded) {
  const tmp = callback2();
  const context = youBarHorizontalMargin.useContext(activeQuestDockMode(14101).QuestDockGestureContext);
  activeQuestDockMode = context.activeQuestDockMode;
  const windowDimensions = context.windowDimensions;
  const userStatus = youBarHorizontalMargin.useContext(windowDimensions(14182)).quest.userStatus;
  let enrolledAt;
  if (null != userStatus) {
    enrolledAt = userStatus.enrolledAt;
  }
  const dependencyMap = tmp4;
  let obj = activeQuestDockMode(14102);
  youBarHorizontalMargin = obj.useYouBarHorizontalMargin();
  let obj1 = activeQuestDockMode(4026);
  class D {
    constructor() {
  ...
  let obj4 = activeQuestDockMode(4026);
  class E {
    constructor() {
  ...
  let obj6 = activeQuestDockMode(4026);
  const fn = function h() {
    const obj = {};
  ...
  obj1 = { withSpring: activeQuestDockMode(4577).withSpring, isEnrolled: tmp4, activeQuestDockMode, QuestDockMode: enabled, QUEST_DOCK_MODE_CHANGE_PHYSICS: closure_5 };
  fn.__closure = obj1;
  ...
  const obj9 = activeQuestDockMode(4026);
  C.__closure = { withSpring: activeQuestDockMode(4577).withSpring, isEnrolled: null != enrolledAt, activeQuestDockMode, QuestDockMode: enabled, QUEST_DOCK_MODE_CHANGE_PHYSICS: closure_5 };
  ...
  const obj2 = { withSpring: activeQuestDockMode(4577).withSpring, isEnrolled: null != enrolledAt, activeQuestDockMode, QuestDockMode: enabled, QUEST_DOCK_MODE_CHANGE_PHYSICS: closure_5 };
  obj4 = { style: animatedStyle1 };
  const tmp11 = windowDimensions(7656);
  const tmp12 = closure_8;
  obj4.layout = activeQuestDockMode(14099).dimensionsLayoutTransition;
  const obj5 = { style: items1 };
  items1 = [tmp.dragHandleOverlay, animatedStyle3];
  const tmp13 = windowDimensions(7656);
  ...
  obj5.children = callback(activeQuestDockMode(5481).ActionSheetHeaderBar, obj6);
  const items2 = [callback(windowDimensions(7656), obj5), ];
  ...
  obj7.style = items3;
  const tmp14 = windowDimensions(7656);
  obj7.children = callback(activeQuestDockMode(5481).ActionSheetHeaderBar, { variant: "default" });
  items2[1] = callback(windowDimensions(7656), obj7);
