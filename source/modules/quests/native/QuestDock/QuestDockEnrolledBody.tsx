...
// Dependencies: [5, 19, 17, 14239, 5128, 14241, 21, 4285, 712, 14245, 14242, 8654, 14237, 14267, 5131, 14264, 14263, 14265, 14324, 1581, 7103, 2]

// Module 14338 (EnrolledBodyWatchTask)
...
function EnrolledBodyPlayStreamTask(quest) {
  ...
  quest = quest.quest;
  const tmp = callback3();
  let obj = require(14263) /* QuestBottomSheet */;
  ...
  const items = [callback(View, { style: tmp.headerWrapper, children: callback(importDefault(14264), obj2) }), , ];
  ...
  obj3[1] = callback(require(14263) /* QuestBottomSheet */.QuestBottomSheetContent, obj4);
  ...
  const obj1 = { style: tmp.headerWrapper, children: callback(importDefault(14264), obj2) };
  obj6[8] = require(5131) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE;
  obj5[1] = callback(importDefault(14265), obj6);
...
const memoResult = importAllResult.memo(function QuestDockEnrolledBody() {
  let obj = minExpandedContentHeight(14324);
  const questCreative = obj.useQuestCreative();
  minExpandedContentHeight = importAllResult.useContext(minExpandedContentHeight(14242).QuestDockGestureContext).minExpandedContentHeight;
