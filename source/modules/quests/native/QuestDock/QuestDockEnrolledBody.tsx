...
// Dependencies: [5, 19, 17, 14205, 5099, 14207, 21, 4255, 712, 14211, 14208, 8453, 14203, 14233, 5102, 14230, 14229, 14231, 14290, 1581, 7091, 2]

// Module 14304 (EnrolledBodyWatchTask)
...
function EnrolledBodyPlayStreamTask(quest) {
  ...
  quest = quest.quest;
  const tmp = callback3();
  let obj = require(14229) /* QuestBottomSheet */;
  obj = { quest, location: constants.QUESTS_BAR_MOBILE, sourceQuestContent: require(5102) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE };
  ...
  const items = [callback(View, { style: tmp.headerWrapper, children: callback(importDefault(14230), obj2) }), , ];
  ...
  obj4[6] = require(5102) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE;
  obj3[1] = callback(require(14229) /* QuestBottomSheet */.QuestBottomSheetContent, obj4);
  ...
  const obj1 = { style: tmp.headerWrapper, children: callback(importDefault(14230), obj2) };
  obj6[8] = require(5102) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE;
  obj5[1] = callback(importDefault(14231), obj6);
...
const memoResult = importAllResult.memo(function QuestDockEnrolledBody() {
  let obj = minExpandedContentHeight(14290);
  const questCreative = obj.useQuestCreative();
  minExpandedContentHeight = importAllResult.useContext(minExpandedContentHeight(14208).QuestDockGestureContext).minExpandedContentHeight;
