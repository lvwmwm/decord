...
// Dependencies: [19, 17, 5987, 21, 4189, 712, 1581, 9479, 9469, 5551, 5242, 1236, 5245, 4598, 4185, 2]
// Exports: default

// Module 14179 (VideoQuestTranscriptActionSheet)
...
export default function VideoQuestTranscriptActionSheet(quest) {
  ...
  obj[1] = callback2(quest(5242).BottomSheetTitleHeader, obj);
  ...
  obj1[2] = items2;
  obj[1] = closure_8(quest(4598).Stack, obj1);
  obj[2] = callback2(quest(5245).BottomSheetScrollView, obj);
  return callback2(quest(5551).ActionSheet, obj);
};
