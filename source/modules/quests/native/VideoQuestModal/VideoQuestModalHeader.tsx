...
// Dependencies: [19, 17, 7083, 21, 4285, 712, 14279, 10377, 7104, 3897, 10504, 4281, 1236, 14302, 2]
// Exports: default

// Module 14307 (VideoQuestModalHeader)
import "noop";
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(10504).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(10504);
  }
  ...
  const items1 = [closure_5(quest(4281).Text, obj1), ];
  ...
  obj[1] = items1;
  const items3 = [closure_6(View, obj), closure_5(questTaskDetails(14302), { iconColor: closeButtonIconColor, onClose })];
  obj[1] = items3;
