...
// Dependencies: [19, 17, 7163, 21, 4303, 712, 14376, 10465, 7184, 3933, 10592, 4299, 1236, 14399, 2]
// Exports: default

// Module 14404 (VideoQuestModalHeader)
import "noop";
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(10592).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(10592);
  }
  ...
  obj[1] = items1;
  const items3 = [closure_6(View, obj), closure_5(questTaskDetails(14399), { iconColor: closeButtonIconColor, onClose })];
  obj[1] = items3;
