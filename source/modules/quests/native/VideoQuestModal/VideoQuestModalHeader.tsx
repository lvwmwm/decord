...
// Dependencies: [19, 17, 7056, 21, 4255, 712, 14242, 10346, 7077, 3868, 10473, 4251, 1236, 14265, 2]
// Exports: default

// Module 14270 (VideoQuestModalHeader)
import "noop";
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(10473).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(10473);
  }
  ...
  obj[1] = items1;
  const items3 = [closure_6(View, obj), closure_5(questTaskDetails(14265), { iconColor: closeButtonIconColor, onClose })];
  obj[1] = items3;
