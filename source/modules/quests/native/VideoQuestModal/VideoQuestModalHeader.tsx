...
// Dependencies: [19, 17, 7070, 21, 4255, 712, 14235, 10643, 7091, 3868, 10652, 4251, 1236, 14258, 2]
// Exports: default

// Module 14263 (VideoQuestModalHeader)
import "noop";
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(10652).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(10652);
  }
  ...
  const items1 = [closure_5(quest(4251).Text, obj1), ];
  ...
  items1[1] = closure_5(quest(4251).Text, obj3);
  obj[1] = items1;
  const items3 = [closure_6(View, obj), closure_5(questTaskDetails(14258), { iconColor: closeButtonIconColor, onClose })];
  obj[1] = items3;
