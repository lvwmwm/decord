// Module ID: 14160
// Function ID: 108714
// Dependencies: [57, 31, 27, 33, 4165, 689, 14128, 9455, 14158, 14124, 9768, 4026, 4577, 5987, 8172, 9465, 8143, 14101, 14133, 5155, 4576, 4161, 1212, 14151, 7656, 14152, 4578, 4695, 9949, 5119, 12274, 2]
...
const memoResult = importAllResult.memo(function VideoQuestModalContentCompleted(onRestartVideo) {
  ...
  obj = { withDelay: quest(4026).withDelay, ANIMATION_DELAY: 125, withSpring: quest(4577).withSpring, isComponentMounted: sharedValue, ANIMATED_CONTENT_SPRING_CONFIG: closure_10, interpolate: quest(4026).interpolate, ANIMATED_CONTENT_OFFSET_Y: 75 };
  fn.__closure = obj;
  ...
  const windowDimensions = importAllResult.useContext(quest(14101).QuestDockGestureContext).windowDimensions;
  let str = "md";
  ...
  if (null == first) {
    first = quest(14133).QUEST_PROGRESS_DIAMETER_BY_SIZE[str];
  }
  ...
  const items3 = [callback2(quest(4161).Heading, obj3), ];
  obj5 = { onClose, style: tmp.closeButton };
  items3[1] = callback2(sharedValue(14151), obj5);
  obj2.children = items3;
  const items4 = [callback3(quest(4576).Stack, obj2), ];
  ...
  if (isLoading) {
    if (!isClaiming) {
      ...
      if (!tmp6) {
        ...
        tmp31 = callback2(quest(4578).Button, obj9);
      }
      items7[1] = tmp31;
      obj8.children = items7;
      obj7.children = tmp20(quest(4576).Stack, obj8);
      ...
      const items10 = [callback2(quest(4161).Heading, obj13), ];
      const obj14 = { variant: "text-sm/medium", color: "text-subtle", children: quest.config.messages.gamePublisher };
      items10[1] = callback2(quest(4161).Text, obj14);
      obj12.children = items10;
      const items11 = [callback3(quest(4576).Stack, obj12), ];
      ...
      items11[1] = callback2(quest(4695).PressableOpacity, obj15);
      obj11.children = items11;
      const items12 = [callback3(quest(4576).Stack, obj11), , ];
      let tmp41 = null != memo;
      if (tmp41) {
        ...
        obj17.children = callback2(sharedValue(5119), obj19);
        tmp41 = callback2(quest(4695).PressableOpacity, obj17);
      }
      items12[1] = tmp41;
      const obj21 = { direction: "horizontal", spacing: sharedValue(689).space.PX_16, align: "center" };
      const obj22 = { grow: true, variant: "expressive", onPress: videoQuestClickCtaAndMaybeCloseModal, text: quest(9465).getExternalCtaLabel(quest) };
      const items13 = [callback2(quest(4578).Button, obj22), ];
      if (isShareableQuestResult) {
        ...
        obj23.children = callback2(quest(12274).ShareIcon, obj24);
        isShareableQuestResult = callback2(quest(4695).PressableOpacity, obj23);
      }
      items13[1] = isShareableQuestResult;
      obj21.children = items13;
      items12[2] = callback3(quest(4576).Stack, obj21);
      obj10.children = items12;
      items8[1] = callback3(closure_7, obj10);
      obj6.children = items8;
      items4[1] = tmp20(tmp22, obj6);
      obj1.children = items4;
      return tmp20(quest(5155).SafeAreaPaddingView, obj1);
    }
  }
  ...
  const items14 = [callback2(sharedValue(14152), obj26), ];
  ...
  obj27 = callback2(quest(4161).Heading, obj27);
  items14[1] = obj27;
