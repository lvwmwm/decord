// Module ID: 14182
// Function ID: 14183
// Dependencies: [32, 19, 17, 21, 4189, 712, 14150, 9479, 14180, 14146, 9790, 4050, 4599, 6006, 8196, 9489, 8167, 14123, 14155, 5177, 4598, 4185, 1236, 14173, 7679, 14174, 4600, 4717, 9971, 5141, 12296, 2]
...
const memoResult = importAllResult.memo(function VideoQuestModalContentCompleted(onRestartVideo) {
  ...
  obj = { withDelay: tmp2(4050).withDelay, ANIMATION_DELAY: 125, withSpring: tmp2(4599).withSpring, isComponentMounted: sharedValue, ANIMATED_CONTENT_SPRING_CONFIG: closure_10, interpolate: tmp2(4050).interpolate, ANIMATED_CONTENT_OFFSET_Y: 75 };
  fn.__closure = obj;
  ...
  let isShareableQuestResult = quest(6006).isShareableQuest(quest.config);
  ...
  const windowDimensions = obj1.useContext(tmp2(14123).QuestDockGestureContext).windowDimensions;
  const tmp2Result1 = quest(6006);
  let str = "md";
  ...
  if (tmp18 == null) {
    tmp18 = tmp2(14155).QUEST_PROGRESS_DIAMETER_BY_SIZE[str];
  }
  ...
  const items3 = [callback2(quest(4185).Heading, obj3), callback2(sharedValue(14173), { onClose, style: tmp.closeButton })];
  obj2[4] = items3;
  const items4 = [callback3(quest(4598).Stack, obj2), ];
  ...
  if (isLoading) {
    if (!isClaiming) {
      ...
      if (!tmp9) {
        ...
        tmp22Result = tmp22(tmp2(4600).Button, obj9);
      }
      items7[1] = tmp22Result;
      obj8[4] = items7;
      obj7[1] = tmp21(tmp2(4598).Stack, obj8);
      ...
      const items10 = [tmp22(tmp2(4185).Heading, obj13), ];
      const obj14 = { variant: "text-sm/medium", color: "text-subtle", children: null };
      obj14[2] = quest.config.messages.gamePublisher;
      items10[1] = tmp22(tmp2(4185).Text, obj14);
      obj12[2] = items10;
      const items11 = [tmp21(tmp2(4598).Stack, obj12), ];
      ...
      obj15[3] = tmp22(tmp2(9971).RetryIcon, obj16);
      items11[1] = tmp22(tmp2(4717).PressableOpacity, obj15);
      obj11[3] = items11;
      const items12 = [tmp21(tmp2(4598).Stack, obj11), , ];
      ...
      if (tmp22Result) {
        ...
        obj20[0] = memo.url;
        obj19[1] = obj20;
        obj17[3] = tmp22(tmp6(5141), obj19);
        tmp22Result = tmp22(tmp2(4717).PressableOpacity, obj17);
      }
      ...
      obj22[3] = tmp2(9489).getExternalCtaLabel(quest);
      const items13 = [tmp22(tmp2(4600).Button, obj22), ];
      if (isShareableQuestResult) {
        ...
        obj23[3] = tmp22(tmp2(12296).ShareIcon, obj24);
        isShareableQuestResult = tmp22(tmp2(4717).PressableOpacity, obj23);
      }
      items13[1] = isShareableQuestResult;
      obj21[3] = items13;
      items12[2] = tmp21(tmp2(4598).Stack, obj21);
      obj10[1] = items12;
      items8[1] = tmp21(closure_7, obj10);
      obj6[4] = items8;
      items4[1] = tmp21(tmp23, obj6);
      obj1[2] = items4;
      return tmp21(tmp2(5177).SafeAreaPaddingView, obj1);
    }
  }
  const obj25 = { style: tmp.contentRewards, onLayout: callback1, children: null };
  const items14 = [callback2(sharedValue(14174), { withQuestName: false, withRewardAvailableCopy: false, size: str, withRewardTileAnimation: true }), ];
  ...
  obj26 = tmp22(tmp2(4185).Heading, obj26);
  items14[1] = obj26;
  obj25[2] = items14;
