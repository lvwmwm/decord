...
// Dependencies: [21, 712, 4909, 1236, 5387, 2]
// Exports: default

// Module 14469 (VideoQuestModalCloseButton)
...
export default function VideoQuestModalCloseButton(iconColor) {
  ...
  obj[4] = items;
  obj[5] = jsx(require(5387) /* XSmallIcon */.XSmallIcon, { color: MOBILE_TEXT_HEADING_PRIMARY });
  return jsx(require(4909) /* PressableBase */.PressableOpacity, { accessibilityLabel: null, accessibilityRole: "button", hitSlop: 12, onPress: null, style: null, children: null });
};
