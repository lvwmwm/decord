// Module ID: 14303
// Function ID: 14304
// Dependencies: [19, 21, 4285, 14279, 10377, 11084, 4693, 712, 14284, 4281, 1236, 2]
...
const memoResult = importAllResult.memo(function VideoQuestModalReward(withQuestName) {
  ...
  const items1 = [callback(importDefault(14284), obj), ];
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp3(4281).Text, obj4);
  }
  items2[1] = tmp9Result;
  obj1[3] = items2;
  items1[1] = closure_5(quest(4693).Stack, obj1);
  obj[4] = items1;
  return closure_5(quest(4693).Stack, obj);
});
