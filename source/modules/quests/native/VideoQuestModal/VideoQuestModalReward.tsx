// Module ID: 14400
// Function ID: 14401
// Dependencies: [19, 21, 4303, 14376, 10465, 11171, 4712, 712, 14381, 4299, 1236, 2]
...
const memoResult = importAllResult.memo(function VideoQuestModalReward(withQuestName) {
  ...
  const items1 = [callback(importDefault(14381), obj), ];
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp3(4299).Text, obj4);
  }
  items2[1] = tmp9Result;
  obj1[3] = items2;
  items1[1] = closure_5(quest(4712).Stack, obj1);
  obj[4] = items1;
  return closure_5(quest(4712).Stack, obj);
});
