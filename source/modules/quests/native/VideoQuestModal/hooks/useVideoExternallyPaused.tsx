...
export const useVideoExternallyPaused = function useVideoExternallyPaused(id, arg1) {
  const activeContextMenu = require(8648) /* updateContextMenuState */.useActiveContextMenu();
  ...
  const obj5 = require(4685) /* useAlertStore */;
  const tmp5 = require(4685) /* useAlertStore */.useAlertStore((alerts) => alerts.alerts).length > 0;
