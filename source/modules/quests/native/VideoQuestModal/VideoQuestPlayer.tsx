...
// Function ID: 14157
// Name: hasVideoEnded
// Dependencies: [32, 19, 17, 6325, 5985, 5033, 676, 21, 712, 8140, 4189, 689, 14146, 10488, 9475, 3802, 4050, 4599, 4603, 4190, 4193, 14154, 6006, 14157, 1578, 500, 1231, 10496, 9465, 589, 1208, 1581, 1236, 14165, 4717, 14050, 14052, 14054, 14055, 9967, 8124, 8126, 14056, 14057, 2]

// Module 14156 (hasVideoEnded)
...
const memoResult = importAllResult.memo((onLoad) => {
  ...
  if (null != url) {
    let VIDEO_PLAYER_VIDEO = tmp3(9475).QuestAssetType.VIDEO_PLAYER_VIDEO_HLS;
  } else {
    VIDEO_PLAYER_VIDEO = tmp3(9475).QuestAssetType.VIDEO_PLAYER_VIDEO;
  }
  ...
  const defaultWatchVideoTask = handleBufferAnalytics(6006).getDefaultWatchVideoTask(quest.config);
  ...
  const tmp3Result3 = handleBufferAnalytics(6006);
  ...
  if (null == memo2) {
    ...
    obj7[3] = num6;
    obj6[3] = obj7;
    items29[1] = targetSeconds(tmp3(14165).VideoQuestCaptions, obj6);
    if (!tmp72) {
      items29[2] = tmp72;
      tmp80Result = !tmp39;
      if (!tmp39) {
      ...
      if (tmp80Result4) {
        ...
        if (!hasCaptionAsset) {
          ...
          if (flag2) {
            ...
            obj11[4] = tmp80(tmp3(14052).TranscriptOutlineIcon, obj12);
          ...
          obj14[0] = color;
          obj13[4] = tmp80(tmp3(14050).ClosedCaptionsOutlineIcon, obj14);
      ...
      obj16[4] = tmp80(tmp3(14055).SkipBackwardIcon, obj17);
      const items34 = [tmp80(tmp3(14054).VideoQuestPlayerControlButton, obj16), , ];
      if (!tmp22) {
        ...
        if (!tmp22) {
          if (first1 !== tmp17.ERRORED) {
            if (tmp70) {
              let PauseIcon = tmp3(8124).PlayIcon;
            } else {
              PauseIcon = tmp3(8126).PauseIcon;
            }
            let tmp80Result2 = tmp80(PauseIcon, { size: "lg" });
          }
          obj18[3] = tmp80Result2;
          items34[1] = tmp80(tmp3(14054).VideoQuestPlayerControlButton, obj18);
          ...
          obj19[4] = tmp80(tmp3(14056).SkipForwardIcon, obj20);
          items34[2] = tmp80(tmp3(14054).VideoQuestPlayerControlButton, obj19);
          obj15[1] = items34;
          ...
          if (tmp80Result4) {
            ...
            obj22[4] = tmp80(tmp3(14057).FullscreenEnterIcon, {});
        ...
        tmp80Result2 = tmp80(tmp3(9967).RetryIcon, { size: "lg" });
      }
