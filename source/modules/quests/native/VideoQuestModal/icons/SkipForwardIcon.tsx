...
const forwardRefResult = require("result").forwardRef((width) => {
  let num = width.width;
  if (num === undefined) {
    num = 24;
  }
  ...
  const obj2 = { d: "M144.616 190.007V96.608l197.822 69.184-197.822 69.185v-44.97Z", fill: str, transform: "matrix(.0222 .01458 -.04451 .06777 28.52 -8.53)" };
