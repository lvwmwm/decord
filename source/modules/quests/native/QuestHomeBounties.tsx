...
// Function ID: 14225
// Name: EmptyState
// Dependencies: [32, 19, 17, 7080, 5143, 1369, 21, 712, 14225, 4285, 11090, 1236, 5948, 4281, 14222, 1358, 5943, 709, 14226, 4254, 7098, 7108, 5146, 14163, 5742, 9434, 9435, 9439, 7109, 14236, 11094, 7666, 14237, 10377, 589, 14240, 2]

// Module 14224 (EmptyState)
...
function EmptyState(reason) {
  ...
  const items = [callback2(require(5948) /* AccountAgeTier10LargeBadge */.BountiesPosterIllocon, { size: 32 }), ];
...
const memoResult = importAllResult.memo(function QuestHomeBounties(arg0) {
  ...
  if (tmp10) {
    tmp10 = orbShopProducts.length >= tmp(14226).MIN_PRODUCTS_FOR_ORB_SHOP_CAROUSEL || showOrbShopPlaceholderCarousel;
    const tmp11 = orbShopProducts.length >= tmp(14226).MIN_PRODUCTS_FOR_ORB_SHOP_CAROUSEL || showOrbShopPlaceholderCarousel;
  }
  if (!tmp8) {
    if (!stateFromStores) {
      if (verticalScrollEnabled) {
        ...
        const items5 = [callback2(importDefault(14240), obj), ];
        ...
        if (tmp10) {
          ...
          obj1[1] = obtainableOrbRewards;
          obj1[2] = showOrbShopPlaceholderCarousel;
          tmp17Result = tmp17(tmp18(14237), obj1);
        }
  ...
  if (verticalScrollEnabled) {
    ...
    obj[1] = tmp8;
    let tmp20Result = tmp20(importDefault(14240), obj);
    const tmp25 = importDefault(14240);
  } else {
