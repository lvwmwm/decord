...
// Function ID: 14188
// Name: EmptyState
// Dependencies: [32, 19, 17, 7053, 5113, 1369, 21, 712, 14188, 4255, 11058, 1236, 5921, 4251, 14185, 1358, 5916, 709, 14189, 4224, 7071, 7081, 5116, 14126, 5715, 9405, 9406, 9410, 7082, 14199, 11062, 7638, 14200, 10346, 589, 14203, 2]

// Module 14187 (EmptyState)
...
function EmptyState(reason) {
  ...
  const tmp = callback4();
  let obj = require(11058) /* useTrackQuestEventWithImpression */;
  ...
  const items = [callback2(require(5921) /* AccountAgeTier10LargeBadge */.BountiesPosterIllocon, { size: 32 }), ];
  obj = { style: tmp.emptyStateText, children: null };
  const items1 = [callback2(require(4251) /* Text */.Text, { variant: "text-sm/semibold", color: "text-default", children: stringResult }), ];
...
const memoResult = importAllResult.memo(function QuestHomeBounties(arg0) {
  ...
  if (tmp10) {
    tmp10 = orbShopProducts.length >= tmp(14189).MIN_PRODUCTS_FOR_ORB_SHOP_CAROUSEL || showOrbShopPlaceholderCarousel;
    const tmp11 = orbShopProducts.length >= tmp(14189).MIN_PRODUCTS_FOR_ORB_SHOP_CAROUSEL || showOrbShopPlaceholderCarousel;
  }
  if (!tmp8) {
    if (!stateFromStores) {
      if (verticalScrollEnabled) {
        ...
        const items5 = [callback2(importDefault(14203), obj), ];
        ...
        if (tmp10) {
          ...
          obj1[1] = obtainableOrbRewards;
          obj1[2] = showOrbShopPlaceholderCarousel;
          tmp17Result = tmp17(tmp18(14200), obj1);
        }
  ...
  if (verticalScrollEnabled) {
    ...
    obj[1] = tmp8;
    let tmp20Result = tmp20(importDefault(14203), obj);
    const tmp25 = importDefault(14203);
  } else {
