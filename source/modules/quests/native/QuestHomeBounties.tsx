...
// Function ID: 14181
// Name: EmptyState
// Dependencies: [32, 19, 17, 7067, 5099, 1369, 21, 712, 14181, 4255, 11101, 1236, 5926, 4251, 14178, 1358, 5921, 709, 14182, 4224, 7085, 7095, 5102, 14119, 5701, 8756, 8757, 8761, 7096, 14192, 11105, 7654, 14193, 10643, 589, 14196, 2]

// Module 14180 (EmptyState)
...
function EmptyState(reason) {
  ...
  const tmp = callback4();
  let obj = require(11101) /* useTrackQuestEventWithImpression */;
  ...
  const items = [callback2(require(5926) /* AccountAgeTier10LargeBadge */.BountiesPosterIllocon, { size: 32 }), ];
...
const memoResult = importAllResult.memo(function QuestHomeBounties(arg0) {
  ...
  if (tmp10) {
    tmp10 = orbShopProducts.length >= tmp(14182).MIN_PRODUCTS_FOR_ORB_SHOP_CAROUSEL || showOrbShopPlaceholderCarousel;
    const tmp11 = orbShopProducts.length >= tmp(14182).MIN_PRODUCTS_FOR_ORB_SHOP_CAROUSEL || showOrbShopPlaceholderCarousel;
  }
  if (!tmp8) {
    if (!stateFromStores) {
      if (verticalScrollEnabled) {
        ...
        const items5 = [callback2(importDefault(14196), obj), ];
        ...
        if (tmp10) {
          ...
          obj1[1] = obtainableOrbRewards;
          obj1[2] = showOrbShopPlaceholderCarousel;
          tmp17Result = tmp17(tmp18(14193), obj1);
        }
  ...
  if (verticalScrollEnabled) {
    ...
    obj[1] = tmp8;
    let tmp20Result = tmp20(importDefault(14196), obj);
    const tmp25 = importDefault(14196);
  } else {
