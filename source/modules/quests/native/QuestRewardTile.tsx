...
let closure_10 = arg1(dependencyMap[5]).createStyles(() => {
  ...
  obj.container = obj;
  obj.video = { "Null": 0., useRef: 0., intl: 0. };
  obj.image = {};
  return obj;
});
...
export default function QuestRewardTile(quest) {
  ...
  if (tmp5.isAnimated) {
    if (withAnimation) {
      obj = { borderRadius: "game_activity_notifications", alignItems: "enum", flexDirection: "PRIMARY_830", flexGrow: 0.5, flexDirection: 0, justifyContent: null, alignContent: 5, style: tmp6.video };
      obj1 = { uri: tmp5.url };
      obj.source = obj1;
      obj.poster = memo;
      let tmp16 = !tmp7[0];
