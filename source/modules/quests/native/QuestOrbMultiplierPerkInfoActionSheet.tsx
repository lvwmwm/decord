...
// Function ID: 14690
// Name: Footer
// Dependencies: [19, 17, 676, 21, 4444, 712, 4411, 6191, 8943, 4158, 1995, 4879, 1236, 1629, 5884, 4172, 4440, 10618, 3275, 5569, 14686, 2]
// Exports: default
...
import usePremiumFeatureUpsellGetNitroDefault from "usePremiumFeatureUpsellGetNitro" /* 8943 */;
...
function Footer(eligibleToReceivePremiumRewards) {
  ...
  const callback1 = React.useCallback(() => {
    ...
    const obj = callback2(4411);
    const obj2 = callback2(4158);
  ...
  if (eligibleToReceivePremiumRewards.eligibleToReceivePremiumRewards) {
    ...
    obj[3] = callback2;
    items[1] = tmp9(tmp10(4879).Button, obj);
    obj[1] = items;
    let tmp11 = obj;
  } else {
    ...
    obj2[3] = callback;
    items1[1] = tmp9(tmp10(4879).Button, obj2);
    obj[1] = items1;
    tmp11 = obj;
  }
...
export default function QuestOrbMultiplierPerkInfoActionSheet(multiplier) {
  ...
  obj = { visible: orbMultiplierEligibility === multiplier(10618).QuestOrbMultiplierEligibilityType.NITRO || orbMultiplierEligibility === multiplier(10618).QuestOrbMultiplierEligibilityType.UPSELL, children: null };
  const tmp4 = orbMultiplierEligibility === multiplier(10618).QuestOrbMultiplierEligibilityType.NITRO || orbMultiplierEligibility === multiplier(10618).QuestOrbMultiplierEligibilityType.UPSELL;
  obj[1] = callback(SheetContent, { title: memo, body: memo1, eligibleToReceivePremiumRewards: result });
  obj[4] = callback(orbMultiplierEligibility(14686), obj);
  return callback(multiplier(5569).BottomSheet, obj);
};
