...
// Function ID: 14202
// Name: StyleSheet
// Dependencies: [19, 17, 1874, 21, 4193, 712, 10505, 10510, 589, 9495, 6010, 1236, 4189, 5044, 5226, 14173, 9490, 14165, 10974, 4721, 8146, 4615, 5145, 14202, 8131, 2]
...
export const QuestBottomSheetProgressCardPlayStreamTask = function QuestBottomSheetProgressCardPlayStreamTask(quest) {
  ...
  let obj = questTaskDetails(10505);
  questTaskDetails = obj.useQuestTaskDetails(quest);
  let obj1 = questTaskDetails(10505);
  ...
  defaultRewardName = questTaskDetails(9495).getDefaultRewardName(quest.config, stateFromStores);
  const tmp2Result2 = questTaskDetails(9495);
  const isSponsoredPlayQuestResult = questTaskDetails(6010).isSponsoredPlayQuest(quest);
  ...
  const tmp2Result3 = questTaskDetails(6010);
  if (!tmp7) {
    tmp7 = isQuestProgressing;
  }
  obj1[3] = !tmp7;
  const items2 = [defaultRewardName(isQuestProgressing(14173), obj1), ];
  ...
  if (tmp18Result) {
    ...
    obj2[3] = memo;
    tmp18Result = tmp18(tmp2(4189).Text, obj2);
  }
  ...
  if (isQuestProgressing) {
    ...
    obj3[1] = tmp18(tmp2(4189).Text, obj4);
    isQuestProgressing = tmp18(tmp17, obj3);
  }
  items3[1] = isQuestProgressing;
  obj[2] = items3;
  return c8(questTaskDetails(5226).Card, obj);
};
export const QuestBottomSheetProgressCardWatchTask = function QuestBottomSheetProgressCardWatchTask(quest) {
  ...
  if (isHeroVideoSupportedResult) {
    isHeroVideoSupportedResult = tmp2(10974).isHeroVideoSupported(memo);
  ...
  items5[3] = closure_7(closure_4, { style: items8, children: closure_7(importDefault(14173), obj13) });
  obj1[2] = items5;
  obj[3] = closure_8(quest(5226).Card, obj1);
  return closure_7(quest(4721).PressableOpacity, obj);
};
export const QuestBottomSheetProgressCardInGameTask = function QuestBottomSheetProgressCardInGameTask(quest) {
  ...
  obj1[2] = num;
  obj[1] = closure_7(importDefault(14173), obj1);
  obj[2] = closure_7(closure_4, obj);
  return closure_7(require(5226) /* PressableCard */.Card, obj);
};
