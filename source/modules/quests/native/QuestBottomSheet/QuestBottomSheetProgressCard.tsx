...
// Function ID: 14400
// Name: StyleSheet
// Dependencies: [19, 17, 1903, 21, 4303, 712, 10459, 10490, 589, 10476, 7181, 1236, 4299, 5168, 5376, 14371, 10471, 14363, 11165, 14358, 4846, 8870, 4725, 5268, 14400, 8855, 2]
...
export const QuestBottomSheetProgressCardPlayStreamTask = function QuestBottomSheetProgressCardPlayStreamTask(quest) {
  ...
  let obj = questTaskDetails(10459);
  questTaskDetails = obj.useQuestTaskDetails(quest);
  let obj1 = questTaskDetails(10459);
  ...
  defaultRewardName = questTaskDetails(10476).getDefaultRewardName(quest.config, stateFromStores);
  const tmp2Result2 = questTaskDetails(10476);
  const isSponsoredPlayQuestResult = questTaskDetails(7181).isSponsoredPlayQuest(quest);
  ...
  const tmp2Result3 = questTaskDetails(7181);
  if (!tmp7) {
    tmp7 = isQuestProgressing;
  }
  obj1[3] = !tmp7;
  const items2 = [defaultRewardName(isQuestProgressing(14371), obj1), ];
  ...
  if (tmp18Result) {
    ...
    obj2[3] = memo;
    tmp18Result = tmp18(tmp2(4299).Text, obj2);
  }
  ...
  if (isQuestProgressing) {
    ...
    obj3[1] = tmp18(tmp2(4299).Text, obj4);
    isQuestProgressing = tmp18(tmp17, obj3);
  }
  items3[1] = isQuestProgressing;
  obj[2] = items3;
  return c8(questTaskDetails(5376).Card, obj);
};
export const QuestBottomSheetProgressCardWatchTask = function QuestBottomSheetProgressCardWatchTask(quest) {
  ...
  items5[3] = closure_7(closure_4, { style: items8, children: closure_7(importDefault(14371), obj13) });
  obj1[2] = items5;
  obj[3] = closure_8(quest(5376).Card, obj1);
  return closure_7(quest(4846).PressableOpacity, obj);
};
export const QuestBottomSheetProgressCardInGameTask = function QuestBottomSheetProgressCardInGameTask(quest) {
  ...
  obj1[2] = num;
  obj[1] = closure_7(importDefault(14371), obj1);
  obj[2] = closure_7(closure_4, obj);
  return closure_7(require(5376) /* PressableCard */.Card, obj);
};
