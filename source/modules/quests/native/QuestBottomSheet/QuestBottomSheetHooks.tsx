...
// Dependencies: [5, 19, 5033, 14126, 14144, 4157, 10496, 14148, 8445, 8446, 8450, 6013, 6012, 5036, 6002, 2]
// Exports: useMobileActivityPressHandler, useWatchTaskPressHandler

// Module 14147 (useWatchTaskPressHandler)
    ...
    if (dependencyMap === 2) {
      ...
      try {
        ...
        if (0 === c1) {
          ...
          if (obj12.shouldMigrateToAdAnalyticsInterface(outer1_0(8445).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_bottom_sheet_mobile_activity")) {
            ...
            obj3[0] = outer1_0(8450).AdUserActionType.CLICK_INTERNAL;
            obj3[1] = outer1_0(6013).AdCreativeType.QUEST;
            obj3[2] = closure_0;
            obj3[3] = outer1_0(6012).QuestContentCTA.LAUNCH_MOBILE_ACTIVITY;
            ...
            obj4[2] = outer1_0(6012).QuestContentCTA.LAUNCH_MOBILE_ACTIVITY;
            obj2 = noop;
            let questContentPosition1;
            if (noop != null) {
              questContentPosition1 = obj2.getQuestContentPosition();
            ...
            obj4[4] = id1;
            obj4[5] = c1;
            const result = captureAdUserAction(6002).trackQuestContentClicked(obj4);
