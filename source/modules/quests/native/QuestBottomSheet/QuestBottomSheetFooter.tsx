...
// Dependencies: [32, 19, 17, 4334, 1922, 7228, 5459, 21, 712, 4342, 5226, 10436, 10452, 10457, 10172, 589, 4065, 7081, 11232, 14443, 4777, 10577, 10469, 14411, 11239, 14438, 14440, 7817, 1236, 5335, 11238, 10467, 13920, 9579, 9580, 9584, 7244, 7255, 1628, 1493, 4083, 4343, 4781, 2]
// Exports: default

// Module 14442 (useQuestRewardClaimHandler)
...
function WatchTaskButton(arg0) {
  ...
  let obj = require(14443) /* useWatchTaskPressHandler */;
  ...
  obj[5] = require(10577) /* formatWatchRemainingDurationShort */.getVideoQuestWatchCtaText(taskDetails);
  return callback2(require(4777) /* Button */.Button, obj);
}
...
function DefibButton(arg0) {
  ...
  useWatchTaskPressHandler = require(10467) /* useAdContentImpressionTrackerProps */.useQuestImpressionId();
  ...
  obj[6] = callback2(require(13920) /* RefreshIcon */.RefreshIcon, {});
