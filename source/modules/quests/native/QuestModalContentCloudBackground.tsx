...
// Function ID: 14448
// Name: items
// Dependencies: [19, 17, 21, 4342, 1364, 4278, 4788, 5329, 14448, 14449, 2]
// Exports: default
...
export default function QuestModalContentCloudBackground(align) {
  ...
  let obj1 = require(4278) /* useTheme */;
  ...
  if (isThemeDarkResult) {
    ...
    obj2[2] = str2;
    items1[1] = tmp6(importDefault(5329), obj2);
    obj[1] = items1;
