...
// Dependencies: [32, 4522, 11389, 5404, 673, 4509, 7657, 7632, 7655, 11448, 2]
...
function questMatchesActivity(arg0, id) {
  ...
  if (null == arg0) {
      ...
      if (!tmp9) {
        ...
        if (!tmp10) {
          ...
          if (tmp13) {
            ...
            const allApplicationIds = application_id(7657).getAllApplicationIds(id);
            const obj = application_id(7657);
    ...
    const consoleApplicationId = application_id(7657).getConsoleApplicationId(id);
    let flag = false;
    ...
    tmp10 = flag;
    const obj3 = application_id(7657);
...
function questMatchesApplicationId(arg0, quest) {
  const _require = arg0;
  const allApplicationIds = _require(7657).getAllApplicationIds(quest);
  const obj = _require(7657);
