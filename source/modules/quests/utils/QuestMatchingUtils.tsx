...
// Dependencies: [32, 4383, 5223, 676, 4370, 7251, 7226, 7249, 2]
...
// Module 10579 (questMatchesActivity)
...
function questMatchesApplicationId(arg0, quest) {
  const _require = arg0;
  const allApplicationIds = _require(7251).getAllApplicationIds(quest);
  const obj = _require(7251);
