...
// Dependencies: [32, 4226, 5033, 676, 4214, 6006, 5981, 6004, 2]
...
// Module 10498 (questMatchesActivity)
...
function questMatchesActivity(arg0, id) {
  ...
  if (null == arg0) {
      ...
      if (!tmp9) {
        ...
        if (!tmp10) {
          ...
          if (tmp13) {
            ...
            const allApplicationIds = application_id(6006).getAllApplicationIds(id);
            const obj = application_id(6006);
    ...
    const consoleApplicationId = application_id(6006).getConsoleApplicationId(id);
    let flag = false;
    ...
    tmp10 = flag;
    const obj3 = application_id(6006);
...
function questMatchesApplicationId(arg0, quest) {
  const _require = arg0;
  const allApplicationIds = _require(6006).getAllApplicationIds(quest);
  const obj = _require(6006);
