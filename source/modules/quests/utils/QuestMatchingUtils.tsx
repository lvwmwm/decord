...
// Dependencies: [32, 4382, 5201, 676, 4369, 7223, 7198, 7221, 2]
...
// Module 10647 (questMatchesActivity)
...
function questMatchesApplicationId(arg0, quest) {
  const _require = arg0;
  const allApplicationIds = _require(7223).getAllApplicationIds(quest);
  const obj = _require(7223);
