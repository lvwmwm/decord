...
// Dependencies: [32, 4339, 5160, 676, 4327, 7123, 7098, 7121, 2]
...
// Module 10522 (questMatchesActivity)
...
function questMatchesApplicationId(arg0, quest) {
  const _require = arg0;
  const allApplicationIds = _require(7123).getAllApplicationIds(quest);
  const obj = _require(7123);
