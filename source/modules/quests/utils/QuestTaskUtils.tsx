...
// Dependencies: [7636, 5412, 12, 684, 7632, 1394, 2]
...
// Module 7657 (getApplicationIdsByTaskTypes)
...
function _isPlayOnDesktopTaskType(type) {
  ...
  return type === items5(5412).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP;
}
function _getTaskDetailsForType(arg0) {
  ({ quest, taskType, includeTaskTypes } = arg0);
  if (includeTaskTypes === undefined) {
    includeTaskTypes = quest(5412).FirstPartyQuestTaskTypesSets.ALL;
  }
  ...
  if (floorResult == null) {
    floorResult = taskConfigV2.tasks[quest(undefined, 5412).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP];
  }
  if (null == floorResult) {
    const _Error = Error;
    ...
    obj[1] = obj;
    const result = quest(7632).captureQuestsException(error, obj);
    return null;
  } else {
...
function _parseFirstPartyTaskType(arg0) {
  const ALL = items5(5412).FirstPartyQuestTaskTypesSets.ALL;
  let tmp = null;
  if (ALL.has(arg0)) {
    tmp = arg0;
  }
...
export const getDesktopApplicationIds = function getDesktopApplicationIds(nextResult) {
  const items = [items5(5412).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP];
...
export const getConsoleApplicationId = function getConsoleApplicationId(id) {
  const items = [items5(5412).FirstPartyQuestTaskTypes.PLAY_ON_XBOX, items5(5412).FirstPartyQuestTaskTypes.PLAY_ON_PLAYSTATION];
...
export const getPlayActivityApplicationId = function getPlayActivityApplicationId(item10047) {
  const items = [items5(5412).FirstPartyQuestTaskTypes.PLAY_ACTIVITY];
...
export const getInGameApplicationId = function getInGameApplicationId(quest) {
  const items = [items5(5412).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_GAME];
...
export const getActivityApplicationId = function getActivityApplicationId(quest) {
  const items = [items5(5412).FirstPartyQuestTaskTypes.PLAY_ACTIVITY, items5(5412).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_ACTIVITY];
  const tmp = getApplicationIdsByTaskTypes(quest, items);
  let first;
  if (tmp != null) {
    first = tmp[0];
...
export const getStreamingApplicationId = function getStreamingApplicationId(nextResult) {
  const items = [items5(5412).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP];
...
export const hasPlayOnDesktopTask = function hasPlayOnDesktopTask(arg0) {
  return null != arg0.quest.config.taskConfigV2.tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP];
};
export const hasStreamOnDesktopTask = function hasStreamOnDesktopTask(arg0) {
  return null != arg0.quest.config.taskConfigV2.tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP];
};
export const hasAchievementActivityTask = function hasAchievementActivityTask(quest) {
  return null != quest.config.taskConfigV2.tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_ACTIVITY];
};
export const hasAchievementInGameTask = function hasAchievementInGameTask(quest) {
  return null != quest.config.taskConfigV2.tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_GAME];
};
export const hasPlayActivityTask = function hasPlayActivityTask(quest) {
  return null != quest.config.taskConfigV2.tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.PLAY_ACTIVITY];
};
export const shouldUsePlayOnDesktopTask = function shouldUsePlayOnDesktopTask(quest) {
  let tmp = null != quest;
  if (tmp) {
    tmp = null != quest.config.taskConfigV2.tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP];
  }
  return tmp;
};
...
export const isInGameQuest = function isInGameQuest(quest) {
  items5 = quest;
  return Array.from(items5(5412).FirstPartyQuestTaskTypesSets.IN_GAME).some((arg0) => null != lib.config.taskConfigV2.tasks[arg0]);
};
...
export const isDesktopOnlyPlayQuest = function isDesktopOnlyPlayQuest(arg0) {
  ...
  let tmp2 = !someResult;
  if (!someResult) {
    tmp2 = null != arg0.config.taskConfigV2.tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP];
  }
  return tmp2;
};
...
export const getDefaultWatchVideoTask = function getDefaultWatchVideoTask(config) {
  const tmp = config.taskConfigV2.tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.WATCH_VIDEO];
  const tmp2 = config.taskConfigV2.tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.WATCH_VIDEO_ON_MOBILE];
  if (null == tmp) {
    let tmp4 = tmp2;
    if (tmp2 == null) {
      tmp4 = tmp;
...
export const getQuestTaskDetails = function getQuestTaskDetails(closure_0, DESKTOP) {
  ...
  if (arr.some((arg0) => null != lib.config.taskConfigV2.tasks[arg0])) {
    ...
    obj[4] = tmp(5412).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP;
    let tmp13Result = obj;
  } else {
    if (typeof fn !== "function") {
      HermesBuiltin.throwTypeError();
    ...
    if (items5.some((arg0) => null != config.config.taskConfigV2.tasks[arg0])) {
      ...
      if (DESKTOP != null) {
        ...
        tmp13Result = (function _getLatestTaskDetails(arg0) {
          ...
          if (includeTaskTypes === undefined) {
            includeTaskTypes = lib(5412).FirstPartyQuestTaskTypesSets.ALL;
          }
          const userStatus = quest.userStatus;
          let progress;
          if (userStatus != null) {
          ...
          const found = sorted.filter(lib(1394).isNotNullish);
        ...
        const FirstPartyQuestTaskTypesSets = tmp(5412).FirstPartyQuestTaskTypesSets;
      ...
      if (items5.some((arg0) => null != config.config.taskConfigV2.tasks[arg0])) {
        ...
        let tmp14 = config.taskConfigV2.tasks[tmp(undefined, 5412).FirstPartyQuestTaskTypes.WATCH_VIDEO];
        const tmp15 = config.taskConfigV2.tasks[tmp(undefined, 5412).FirstPartyQuestTaskTypes.WATCH_VIDEO_ON_MOBILE];
        if (null == tmp14) {
          let tmp18 = tmp15;
          if (tmp15 == null) {
            tmp18 = tmp14;
        ...
        if (tmp8) {
          tmp8 = null != closure_0.config.taskConfigV2.tasks[tmp(undefined, 5412).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP];
        }
        if (tmp8) {
          const obj2 = { quest: null, taskType: null };
          obj2[0] = closure_0;
          obj2[1] = tmp(5412).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP;
          tmp13Result = _getTaskDetailsForType(obj2);
        } else if (null != closure_0.config.taskConfigV2.tasks[tmp(undefined, 5412).FirstPartyQuestTaskTypes.PLAY_ACTIVITY]) {
          let obj3 = { quest: null, taskType: null };
          obj3[0] = closure_0;
          obj3[1] = tmp(5412).FirstPartyQuestTaskTypes.PLAY_ACTIVITY;
          tmp13Result = _getTaskDetailsForType(obj3);
        } else {
          const obj4 = { quest: null, taskType: null };
          obj4[0] = closure_0;
          obj4[1] = tmp(5412).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP;
  ...
  if (null != tmp13Result) {
    ...
    if (null == tmp26) {
      ...
      obj6[4] = tmp(5412).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP;
      tmp26 = obj6;
    }
    return tmp26;
  }
  arr = Array.from(items5(5412).FirstPartyQuestTaskTypesSets.IN_GAME);
};
export const getDefaultInGameTask = function getDefaultInGameTask(config) {
  const tasks = config.taskConfigV2.tasks;
  let tmp = tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_ACTIVITY];
  if (tmp == null) {
    tmp = tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_GAME];
  }
  if (tmp == null) {
    tmp = null;
  }
...
export const getThirdPartyTaskDetails = function getThirdPartyTaskDetails(closure_0) {
  ...
  let tmp3 = tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_ACTIVITY];
  if (tmp3 == null) {
    tmp3 = tasks[items5(undefined, 5412).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_GAME];
  }
  if (tmp3 == null) {
    tmp3 = null;
  }
