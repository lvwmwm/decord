...
// Dependencies: [32, 4203, 1862, 3817, 4205, 6005, 5033, 6006, 6007, 6008, 6009, 6010, 2]
...
// Module 6004 (isSponsoredPlayQuest)
...
function isSponsoredPlayQuest(quest) {
  if (null == quest) {
    ...
    const desktopApplicationIds = require(6006) /* getApplicationIdsByTaskTypes */.getDesktopApplicationIds(quest);
...
export const isPlayAnyActivityQuest = function isPlayAnyActivityQuest(quest) {
  return require(6006) /* getApplicationIdsByTaskTypes */.getPlayActivityApplicationId(quest) === closure_8;
};
export { hasVariant };
export const canLaunchActivity = function canLaunchActivity(quest) {
  let hasPlayActivityTaskResult = require(6006) /* getApplicationIdsByTaskTypes */.hasPlayActivityTask(quest);
  if (!hasPlayActivityTaskResult) {
    hasPlayActivityTaskResult = require(6006) /* getApplicationIdsByTaskTypes */.hasAchievementActivityTask(quest);
    const tmpResult = require(6006) /* getApplicationIdsByTaskTypes */;
  }
  ...
  while (tmp !== undefined) {
    ...
    if (!isSponsoredPlayQuest(tmp6)) {
      ...
      if (!hasVariant(tmp7, constants.NON_GAMING_PLAY_QUEST)) {
        ...
        let obj2 = require(6006) /* getApplicationIdsByTaskTypes */;
        let tmp14 = tmp6;
...
export const isShareableQuest = function isShareableQuest(config) {
  return config.sharePolicy !== require(6007) /* QuestSharePolicy */.QuestSharePolicy.NOT_SHAREABLE;
};
...
export const getQuestType = function getQuestType(config) {
  ...
  obj = { config };
  const QuestType = require(6009) /* QuestType */.QuestType;
...
export const setQuestHomeUtmContext = function setQuestHomeUtmContext(arg0) {
  ...
  obj[3] = require(6010) /* getQuestContentName */.getQuestContentName(fromContent);
