...
// Dependencies: [32, 4317, 1910, 3948, 4319, 7183, 5161, 7184, 7185, 7186, 7187, 7188, 2]
...
// Module 7182 (isSponsoredPlayQuest)
...
function isSponsoredPlayQuest(quest) {
  if (null == quest) {
    ...
    const desktopApplicationIds = require(7184) /* getApplicationIdsByTaskTypes */.getDesktopApplicationIds(quest);
...
export const isPlayAnyActivityQuest = function isPlayAnyActivityQuest(quest) {
  return require(7184) /* getApplicationIdsByTaskTypes */.getPlayActivityApplicationId(quest) === closure_8;
};
export { hasVariant };
export const canLaunchActivity = function canLaunchActivity(quest) {
  let hasPlayActivityTaskResult = require(7184) /* getApplicationIdsByTaskTypes */.hasPlayActivityTask(quest);
  if (!hasPlayActivityTaskResult) {
    hasPlayActivityTaskResult = require(7184) /* getApplicationIdsByTaskTypes */.hasAchievementActivityTask(quest);
    const tmpResult = require(7184) /* getApplicationIdsByTaskTypes */;
  }
  ...
  while (tmp !== undefined) {
    ...
    if (!isSponsoredPlayQuest(tmp6)) {
      ...
      if (!hasVariant(tmp7, constants.NON_GAMING_PLAY_QUEST)) {
        ...
        let obj2 = require(7184) /* getApplicationIdsByTaskTypes */;
        let tmp14 = tmp6;
...
export const isShareableQuest = function isShareableQuest(config) {
  return config.sharePolicy !== require(7185) /* QuestSharePolicy */.QuestSharePolicy.NOT_SHAREABLE;
};
...
export const getQuestType = function getQuestType(config) {
  ...
  obj = { config };
  const QuestType = require(7187) /* QuestType */.QuestType;
...
export const setQuestHomeUtmContext = function setQuestHomeUtmContext(arg0) {
  ...
  obj[3] = require(7188) /* getQuestContentName */.getQuestContentName(fromContent);
