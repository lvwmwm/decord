...
// Dependencies: [32, 4203, 1862, 3817, 4205, 6007, 5033, 6008, 6009, 6010, 6011, 6012, 2]
...
// Module 6006 (isSponsoredPlayQuest)
...
function isSponsoredPlayQuest(quest) {
  if (null == quest) {
    ...
    const desktopApplicationIds = require(6008) /* getApplicationIdsByTaskTypes */.getDesktopApplicationIds(quest);
...
export const isPlayAnyActivityQuest = function isPlayAnyActivityQuest(quest) {
  return require(6008) /* getApplicationIdsByTaskTypes */.getPlayActivityApplicationId(quest) === closure_8;
};
export { hasVariant };
export const canLaunchActivity = function canLaunchActivity(quest) {
  let hasPlayActivityTaskResult = require(6008) /* getApplicationIdsByTaskTypes */.hasPlayActivityTask(quest);
  if (!hasPlayActivityTaskResult) {
    hasPlayActivityTaskResult = require(6008) /* getApplicationIdsByTaskTypes */.hasAchievementActivityTask(quest);
    const tmpResult = require(6008) /* getApplicationIdsByTaskTypes */;
  }
...
export const isShareableQuest = function isShareableQuest(config) {
  return config.sharePolicy !== require(6009) /* QuestSharePolicy */.QuestSharePolicy.NOT_SHAREABLE;
};
...
export const getQuestType = function getQuestType(config) {
  ...
  obj = { config };
  const QuestType = require(6011) /* QuestType */.QuestType;
...
export const setQuestHomeUtmContext = function setQuestHomeUtmContext(arg0) {
  ...
  obj[3] = require(6012) /* getQuestContentName */.getQuestContentName(fromContent);
