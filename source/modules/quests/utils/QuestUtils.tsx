...
// Dependencies: [32, 4359, 1910, 3989, 4361, 7250, 5223, 7251, 7252, 7253, 7254, 7255, 2]
...
// Module 7249 (isSponsoredPlayQuest)
...
function isSponsoredPlayQuest(quest) {
  if (null == quest) {
    ...
    const desktopApplicationIds = require(7251) /* getApplicationIdsByTaskTypes */.getDesktopApplicationIds(quest);
...
export const isPlayAnyActivityQuest = function isPlayAnyActivityQuest(quest) {
  return require(7251) /* getApplicationIdsByTaskTypes */.getPlayActivityApplicationId(quest) === closure_8;
};
export { hasVariant };
export const canLaunchActivity = function canLaunchActivity(quest) {
  let hasPlayActivityTaskResult = require(7251) /* getApplicationIdsByTaskTypes */.hasPlayActivityTask(quest);
  if (!hasPlayActivityTaskResult) {
    hasPlayActivityTaskResult = require(7251) /* getApplicationIdsByTaskTypes */.hasAchievementActivityTask(quest);
    const tmpResult = require(7251) /* getApplicationIdsByTaskTypes */;
  }
  ...
  while (tmp !== undefined) {
    ...
    if (!isSponsoredPlayQuest(tmp6)) {
      ...
      if (!hasVariant(tmp7, constants.NON_GAMING_PLAY_QUEST)) {
        ...
        let obj2 = require(7251) /* getApplicationIdsByTaskTypes */;
        let tmp14 = tmp6;
...
export const isShareableQuest = function isShareableQuest(config) {
  return config.sharePolicy !== require(7252) /* QuestSharePolicy */.QuestSharePolicy.NOT_SHAREABLE;
};
...
export const getQuestType = function getQuestType(config) {
  ...
  obj = { config };
  const QuestType = require(7254) /* QuestType */.QuestType;
...
export const setQuestHomeUtmContext = function setQuestHomeUtmContext(arg0) {
  ...
  obj[3] = require(7255) /* getQuestContentName */.getQuestContentName(fromContent);
