...
// Dependencies: [32, 4389, 5993, 5990, 2]
...
// Module 5992 (progressFromServer)
...
function getSimpleRewardFromServer(type) {
  if (type.type === require(5990) /* QuestRewardTypes */.QuestRewardTypes.VIRTUAL_CURRENCY) {
...
function _questsEntitlementFromServer(skuId) {
  ...
  if (null != quest_rewards) {
    ...
    if (require(5990) /* QuestRewardTypes */.QuestRewardTypes.IN_GAME === tag) {
      ...
      obj[0] = obj;
      tmp2 = obj;
    } else if (tmp3(5990).QuestRewardTypes.REWARD_CODE === tag) {
...
export const getClaimedQuestWithUserStatusFromServer = function getClaimedQuestWithUserStatusFromServer(id) {
  ...
  obj[8] = require(5993) /* questFromServerV2 */.questCosponsorMetadataFromServer(config.cosponsor_metadata);
  obj[1] = obj;
  let tmp = null;
