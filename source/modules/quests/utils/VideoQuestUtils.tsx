...
// Dependencies: [4346, 7054, 7056, 676, 7052, 10348, 7077, 1236, 7071, 4106, 2, 10474]
...
// Module 10473 (getVideoQuestWatchCtaText)
...
export const sendVideoProgress = function sendVideoProgress(quest, currentTime) {
  let isQuestExpiredResult = require(7052) /* getQuestDeliveryDataForPlacement */.isQuestExpired(quest);
  ...
  if (!isQuestExpiredResult) {
    require(10348) /* _manuallyStartConsoleQuest */.updateVideoProgress(quest.id, currentTime);
    const tmpResult = require(10348) /* _manuallyStartConsoleQuest */;
  }
};
...
export const handleVideoQuestModalClose = function handleVideoQuestModalClose(arg0) {
  ...
  if (null != videoProgress) {
    ...
    if (tmp4) {
      let obj2 = require(7052) /* getQuestDeliveryDataForPlacement */;
    ...
    require(7071) /* trackQuestEvent */.trackQuestEvent(obj);
    const obj5 = require(7071) /* trackQuestEvent */;
    ...
    require(7071) /* trackQuestEvent */.trackQuestEvent(obj1);
    const obj8 = require(7071) /* trackQuestEvent */;
  }
};
...
export const isVideoQuestProgressing = function isVideoQuestProgressing(closure_0) {
  let isModalOpenResult = require(7077) /* getApplicationIdsByTaskTypes */.hasWatchVideoTasks(closure_0);
