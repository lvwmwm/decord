...
// Dependencies: [4376, 7081, 7083, 676, 7079, 10379, 7104, 1236, 7098, 4135, 2, 10505]
...
// Module 10504 (getVideoQuestWatchCtaText)
...
export const sendVideoProgress = function sendVideoProgress(quest, currentTime) {
  let isQuestExpiredResult = require(7079) /* getQuestDeliveryDataForPlacement */.isQuestExpired(quest);
  ...
  if (!isQuestExpiredResult) {
    require(10379) /* _manuallyStartConsoleQuest */.updateVideoProgress(quest.id, currentTime);
    const tmpResult = require(10379) /* _manuallyStartConsoleQuest */;
  }
};
...
export const handleVideoQuestModalClose = function handleVideoQuestModalClose(arg0) {
  ...
  if (null != videoProgress) {
    ...
    if (tmp4) {
      let obj2 = require(7079) /* getQuestDeliveryDataForPlacement */;
    ...
    require(7098) /* trackQuestEvent */.trackQuestEvent(obj);
    const obj5 = require(7098) /* trackQuestEvent */;
    ...
    require(7098) /* trackQuestEvent */.trackQuestEvent(obj1);
    const obj8 = require(7098) /* trackQuestEvent */;
  }
};
...
export const isVideoQuestProgressing = function isVideoQuestProgressing(closure_0) {
  let isModalOpenResult = require(7104) /* getApplicationIdsByTaskTypes */.hasWatchVideoTasks(closure_0);
  if (isModalOpenResult) {
    const _HermesInternal = HermesInternal;
    isModalOpenResult = require(4135) /* navigationToRootTabHelper */.isModalOpen("VIDEO-QUEST-" + closure_0.id);
  }
