...
// Dependencies: [4435, 7200, 7202, 676, 7198, 10508, 7223, 1236, 7217, 4199, 2, 10645]
...
// Module 10644 (getVideoQuestWatchCtaText)
...
export const sendVideoProgress = function sendVideoProgress(quest, currentTime) {
  let isQuestExpiredResult = require(7198) /* getQuestDeliveryDataForPlacement */.isQuestExpired(quest);
  ...
  if (!isQuestExpiredResult) {
    require(10508) /* _manuallyStartConsoleQuest */.updateVideoProgress(quest.id, currentTime);
    const tmpResult = require(10508) /* _manuallyStartConsoleQuest */;
  }
};
...
export const handleVideoQuestModalClose = function handleVideoQuestModalClose(arg0) {
  ...
  if (null != videoProgress) {
    ...
    if (tmp4) {
      let obj2 = require(7198) /* getQuestDeliveryDataForPlacement */;
    ...
    require(7217) /* trackQuestEvent */.trackQuestEvent(obj);
    const obj5 = require(7217) /* trackQuestEvent */;
    ...
    require(7217) /* trackQuestEvent */.trackQuestEvent(obj1);
    const obj8 = require(7217) /* trackQuestEvent */;
  }
};
...
export const isVideoQuestProgressing = function isVideoQuestProgressing(closure_0) {
  let isModalOpenResult = require(7223) /* getApplicationIdsByTaskTypes */.hasWatchVideoTasks(closure_0);
  if (isModalOpenResult) {
    const _HermesInternal = HermesInternal;
    isModalOpenResult = require(4199) /* coerceMainRoute */.isModalOpen("VIDEO-QUEST-" + closure_0.id);
  }
