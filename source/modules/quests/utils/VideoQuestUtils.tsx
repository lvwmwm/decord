...
// Dependencies: [4577, 7636, 7638, 673, 7632, 11208, 7657, 1233, 7651, 4335, 2, 11445]
...
// Module 11444 (getVideoQuestWatchCtaText)
...
import trackQuestEvent from "trackQuestEvent" /* 7651 */;
...
import closure_4 from "_toPropertyKey" /* 7638 */;
...
export const getVideoQuestProgressRemainingAccessibilityLabel = function getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, arg1) {
  if (arg1) {
    ...
    const remainingTaskTime = tmp(7657).getRemainingTaskTime(questTaskDetails);
...
export const handleVideoQuestModalClose = function handleVideoQuestModalClose(arg0) {
  ...
  if (null != videoProgress) {
    ...
    if (tmp4) {
      ...
      if (!isQuestExpiredResult) {
        tmp6(11208).updateVideoProgress(quest.id, videoProgress.maxTimestampSec);
        const tmp6Result = tmp6(11208);
      }
      tmp6 = require;
    }
