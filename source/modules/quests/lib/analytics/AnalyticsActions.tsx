...
// Dependencies: [5, 7474, 703, 7458, 673, 7216, 7476, 7453, 7477, 7479, 7483, 7456, 4700, 695, 7484, 7431, 1234, 511, 7489, 5398, 2]
...
function trackQuestEvent(sourceQuestContent) {
  ...
  if (null != value) {
    ...
    let tmp24Result = tmp24(7483);
    obj[3] = tmp24Result.getQuestStatus(value);
    const id = value.id;
    tmp24Result = tmp24(7476);
    ...
    if (!tmp24Result2.isBillableQuestContent(sourceQuestContent)) {
      const activeSessionUnsafe = tmp24(7216).getActiveSessionUnsafe();
      uuid = undefined;
    ...
    if (QUEST == null) {
      QUEST = tmp24(7456).AdCreativeType.QUEST;
    }
    obj1 = {};
...
function trackAdContentEvent(sourceQuestContent) {
  ...
  if (null != relatedQuestId) {
    ...
    if (null != quest) {
      questStatus = tmp3(7483).getQuestStatus(quest);
      const tmp3Result2 = tmp3(7483);
    }
    obj1[1] = questStatus;
    let obj2 = obj1;
  } else {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            if (arg0 === 1) {
              ...
              let obj5 = callback(7484);
              c4 = 2;
              c5 = 1;
              let obj2 = { value: null, done: false };
              obj2[0] = obj5.getAdUser(callback(7483).getQuestContentName(callback));
              return obj2;
            }
          } else if (arg0 === 1) {
            c5 = 3;
            ...
            closure_6 = arg1;
            const obj4 = {};
            const merged = Object.assign(callback(7483).getContentProperties(callback, callback2, dependencyMap));
        ...
        try {
          ...
          if (0 === adTrafficMetadataSealed) {
            ...
            if (arg0 === 1) {
              ...
              adTrafficMetadataSealed = callback(7453).getAdTrafficMetadataSealed(callback2, callback);
            ...
            const adMetadataSealed = callback(7453).getAdMetadataSealed(callback2);
            c1 = adMetadataSealed;
            if (adMetadataSealed == null) {
              c1 = null;
            }
