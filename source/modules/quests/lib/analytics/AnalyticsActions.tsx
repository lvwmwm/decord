...
// Dependencies: [5, 7246, 706, 7228, 676, 6992, 7248, 7226, 7249, 7251, 7255, 7244, 4549, 698, 7256, 7205, 500, 514, 7261, 5226, 2]
...
function trackQuestEvent(sourceQuestContent) {
  ...
  if (null != value) {
    ...
    obj[0] = value.id;
    obj[1] = require(7249) /* isSponsoredPlayQuest */.getQuestType(value.config);
    const obj12 = require(7249) /* isSponsoredPlayQuest */;
    let allApplicationIds = require(7251) /* getApplicationIdsByTaskTypes */.getAllApplicationIds(value);
    if (allApplicationIds == null) {
      allApplicationIds = [];
    }
    obj[2] = allApplicationIds;
    let tmp24Result = tmp24(7255);
    obj[3] = tmp24Result.getQuestStatus(value);
    const id = value.id;
    tmp24Result = tmp24(7248);
    let uuid = tmp24Result.getOrRefreshAdSession(shouldExtendSession).uuid;
    const obj13 = require(7251) /* getApplicationIdsByTaskTypes */;
    const adDecisionData = require(7226) /* getQuestDeliveryDataForPlacement */.getAdDecisionData(id, sourceQuestContent);
    obj = { client_ad_session_id: null, billing_session_id: null, ad_content_id: null };
    obj[0] = uuid;
    const tmp24Result1 = require(7226) /* getQuestDeliveryDataForPlacement */;
    if (!tmp24Result2.isBillableQuestContent(sourceQuestContent)) {
      const activeSessionUnsafe = tmp24(6992).getActiveSessionUnsafe();
      uuid = undefined;
    ...
    if (QUEST == null) {
      QUEST = tmp24(7244).AdCreativeType.QUEST;
    }
    const obj1 = {};
    ...
    tmp24Result2 = require(7226) /* getQuestDeliveryDataForPlacement */;
  }
}
function trackAdContentEvent(sourceQuestContent) {
  ...
  let obj1 = require(7226) /* getQuestDeliveryDataForPlacement */;
  ...
  let obj3 = require(7226) /* getQuestDeliveryDataForPlacement */;
  if (!obj3.isBillableQuestContent(sourceQuestContent)) {
    let tmp3Result = tmp3(6992);
  ...
  let adTrafficMetadataSealed = require(7226) /* getQuestDeliveryDataForPlacement */.getAdTrafficMetadataSealed(sourceQuestContent, undefined, adContentId);
  ...
  if (null != relatedQuestId) {
    ...
    if (null != quest) {
      questStatus = tmp3(7255).getQuestStatus(quest);
      const tmp3Result2 = tmp3(7255);
    }
    obj1[1] = questStatus;
    let obj2 = obj1;
  } else {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            if (arg0 === 1) {
              ...
              let obj5 = callback(7256);
              c4 = 2;
              c5 = 1;
              let obj2 = { value: null, done: false };
              obj2[0] = obj5.getAdUser(callback(7255).getQuestContentName(callback));
              return obj2;
            }
          } else if (arg0 === 1) {
            c5 = 3;
            ...
            const obj4 = {};
            const merged = Object.assign(callback(7255).getContentProperties(callback, callback2, dependencyMap));
            const merged1 = Object.assign(callback2(7205)());
            obj4.cta_name = c3;
        ...
        try {
          ...
          if (0 === adTrafficMetadataSealed) {
            ...
            if (arg0 === 1) {
              ...
              adTrafficMetadataSealed = callback(7226).getAdTrafficMetadataSealed(callback2, callback);
            ...
            const adMetadataSealed = callback(7226).getAdMetadataSealed(callback2);
            c1 = adMetadataSealed;
            if (adMetadataSealed == null) {
              c1 = null;
            }
...
export const trackAppStoreOverlayEvent = function trackAppStoreOverlayEvent(closure_0, closure_1, arg2, event, time_spent_ms) {
  ...
  obj[0] = require(7255) /* getQuestContentName */.getQuestContentName(closure_1.content);
  ({ ctaContent: obj[1], impressionId: obj[2] } = closure_1);
  const obj2 = require(7255) /* getQuestContentName */;
  obj[3] = require(7255) /* getQuestContentName */.getQuestContentName(closure_1.sourceQuestContent);
  obj[4] = arg2;
...
export const trackAdContentAppStoreOverlayEvent = function trackAdContentAppStoreOverlayEvent(arg0, closure_2, arg2, event, time_spent_ms) {
  ...
  obj[0] = require(7255) /* getQuestContentName */.getQuestContentName(closure_2.content);
  ({ ctaContent: obj[1], impressionId: obj[2] } = closure_2);
  const obj2 = require(7255) /* getQuestContentName */;
  obj[3] = require(7255) /* getQuestContentName */.getQuestContentName(closure_2.sourceQuestContent);
  obj[4] = arg2;
...
export const trackBountyCarouselEmptyStateViewed = function trackBountyCarouselEmptyStateViewed(arg0) {
  ...
  const obj2 = importDefault(698);
  const tmp = require;
  if (!obj4.isBillableQuestContent(require(5226) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_HOME_MOBILE_CAROUSEL)) {
    const activeSessionUnsafe = tmp(6992).getActiveSessionUnsafe();
    uuid = undefined;
    if (activeSessionUnsafe != null) {
      uuid = activeSessionUnsafe.uuid;
    }
...
export const trackBountyVerticalScroll = function trackBountyVerticalScroll(result) {
  ...
  const obj2 = importDefault(698);
  const activeSessionUnsafe = require(6992) /* trackHeartbeat */.getActiveSessionUnsafe();
  let uuid;
  if (activeSessionUnsafe != null) {
    uuid = activeSessionUnsafe.uuid;
  }
...
export const trackQuestBarOrDockModeChange = function trackQuestBarOrDockModeChange(arg0) {
  ...
  let obj = require(7255) /* getQuestContentName */;
