...
// Dependencies: [5, 7178, 706, 7160, 676, 6923, 7180, 7158, 7181, 7183, 7187, 7188, 4498, 698, 7189, 7137, 500, 514, 7194, 5164, 2]
...
function trackQuestEvent(sourceQuestContent) {
  ...
  if (null != value) {
    ...
    obj[0] = value.id;
    obj[1] = require(7181) /* isSponsoredPlayQuest */.getQuestType(value.config);
    const obj12 = require(7181) /* isSponsoredPlayQuest */;
    let allApplicationIds = require(7183) /* getApplicationIdsByTaskTypes */.getAllApplicationIds(value);
    if (allApplicationIds == null) {
      allApplicationIds = [];
    }
    obj[2] = allApplicationIds;
    let tmp24Result = tmp24(7187);
    obj[3] = tmp24Result.getQuestStatus(value);
    const id = value.id;
    tmp24Result = tmp24(7180);
    let uuid = tmp24Result.getOrRefreshAdSession(shouldExtendSession).uuid;
    const obj13 = require(7183) /* getApplicationIdsByTaskTypes */;
    const adDecisionData = require(7158) /* getQuestDeliveryDataForPlacement */.getAdDecisionData(id, sourceQuestContent);
    obj = { client_ad_session_id: null, billing_session_id: null, ad_content_id: null };
    obj[0] = uuid;
    const tmp24Result1 = require(7158) /* getQuestDeliveryDataForPlacement */;
    if (!tmp24Result2.isBillableQuestContent(sourceQuestContent)) {
      const activeSessionUnsafe = tmp24(6923).getActiveSessionUnsafe();
      uuid = undefined;
    ...
    if (QUEST == null) {
      QUEST = tmp24(7188).AdCreativeType.QUEST;
    }
    const obj1 = {};
    ...
    tmp24Result2 = require(7158) /* getQuestDeliveryDataForPlacement */;
  }
}
function trackAdContentEvent(sourceQuestContent) {
  ...
  let obj1 = require(7158) /* getQuestDeliveryDataForPlacement */;
  ...
  let obj3 = require(7158) /* getQuestDeliveryDataForPlacement */;
  if (!obj3.isBillableQuestContent(sourceQuestContent)) {
    let tmp3Result = tmp3(6923);
  ...
  let adTrafficMetadataSealed = require(7158) /* getQuestDeliveryDataForPlacement */.getAdTrafficMetadataSealed(sourceQuestContent, undefined, adContentId);
  ...
  if (null != relatedQuestId) {
    ...
    if (null != quest) {
      questStatus = tmp3(7187).getQuestStatus(quest);
      const tmp3Result2 = tmp3(7187);
    }
    obj1[1] = questStatus;
    let obj2 = obj1;
  } else {
...
function _getCommonClickEventProperties() {
  ...
  const tmp = callback((arg0) => {
    ...
    const iter = (function*(arg0) {
      ...
      yield "ct";
      const obj5 = callback(7189);
      let initializeState = yield obj5.getAdUser(callback(7187).getQuestContentName(callback));
      const obj4 = {};
      const merged = Object.assign(callback(7187).getContentProperties(callback, callback2, dependencyMap));
      const merged1 = Object.assign(callback2(7137)());
      obj4.cta_name = c3;
        ...
        try {
          ...
          if (0 === adTrafficMetadataSealed) {
            ...
            if (arg0 === 1) {
              ...
              adTrafficMetadataSealed = callback(7158).getAdTrafficMetadataSealed(callback2, callback);
            ...
            const adMetadataSealed = callback(7158).getAdMetadataSealed(callback2);
            c1 = adMetadataSealed;
            if (adMetadataSealed == null) {
              c1 = null;
            }
...
export const trackAppStoreOverlayEvent = function trackAppStoreOverlayEvent(f85448, closure_1, arg2, event, time_spent_ms) {
  ...
  const obj2 = require(7187) /* getQuestContentName */;
  obj[3] = require(7187) /* getQuestContentName */.getQuestContentName(closure_1.sourceQuestContent);
  obj[4] = arg2;
...
export const trackAdContentAppStoreOverlayEvent = function trackAdContentAppStoreOverlayEvent(arg0, closure_2, arg2, event, time_spent_ms) {
  ...
  obj[0] = require(7187) /* getQuestContentName */.getQuestContentName(closure_2.content);
  ({ ctaContent: obj[1], impressionId: obj[2] } = closure_2);
  const obj2 = require(7187) /* getQuestContentName */;
  obj[3] = require(7187) /* getQuestContentName */.getQuestContentName(closure_2.sourceQuestContent);
  obj[4] = arg2;
...
export const trackBountyCarouselEmptyStateViewed = function trackBountyCarouselEmptyStateViewed(arg0) {
  ...
  if (!obj4.isBillableQuestContent(require(5164) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_HOME_MOBILE_CAROUSEL)) {
    const activeSessionUnsafe = tmp(6923).getActiveSessionUnsafe();
    uuid = undefined;
    if (activeSessionUnsafe != null) {
      uuid = activeSessionUnsafe.uuid;
    }
...
export const trackBountyVerticalScroll = function trackBountyVerticalScroll(result) {
  ...
  const obj2 = importDefault(698);
  const activeSessionUnsafe = require(6923) /* trackHeartbeat */.getActiveSessionUnsafe();
  let uuid;
  if (activeSessionUnsafe != null) {
    uuid = activeSessionUnsafe.uuid;
  }
...
export const trackQuestBarOrDockModeChange = function trackQuestBarOrDockModeChange(arg0) {
  ...
  let obj = require(7187) /* getQuestContentName */;
