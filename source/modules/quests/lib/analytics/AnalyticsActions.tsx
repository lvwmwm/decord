...
// Dependencies: [5, 7118, 706, 7100, 676, 6863, 7120, 7098, 7121, 7123, 7127, 7128, 4496, 698, 7129, 7077, 500, 514, 7134, 5163, 2]
...
function trackQuestEvent(sourceQuestContent) {
  ...
  if (null != value) {
    ...
    obj[0] = value.id;
    obj[1] = require(7121) /* isSponsoredPlayQuest */.getQuestType(value.config);
    const obj12 = require(7121) /* isSponsoredPlayQuest */;
    let allApplicationIds = require(7123) /* getApplicationIdsByTaskTypes */.getAllApplicationIds(value);
    if (allApplicationIds == null) {
      allApplicationIds = [];
    }
    obj[2] = allApplicationIds;
    let tmp24Result = tmp24(7127);
    obj[3] = tmp24Result.getQuestStatus(value);
    const id = value.id;
    tmp24Result = tmp24(7120);
    let uuid = tmp24Result.getOrRefreshAdSession(shouldExtendSession).uuid;
    const obj13 = require(7123) /* getApplicationIdsByTaskTypes */;
    const adDecisionData = require(7098) /* getQuestDeliveryDataForPlacement */.getAdDecisionData(id, sourceQuestContent);
    obj = { client_ad_session_id: null, billing_session_id: null, ad_content_id: null };
    obj[0] = uuid;
    const tmp24Result1 = require(7098) /* getQuestDeliveryDataForPlacement */;
    if (!tmp24Result2.isBillableQuestContent(sourceQuestContent)) {
      const activeSessionUnsafe = tmp24(6863).getActiveSessionUnsafe();
      uuid = undefined;
    ...
    if (QUEST == null) {
      QUEST = tmp24(7128).AdCreativeType.QUEST;
    }
    const obj1 = {};
    ...
    tmp24Result2 = require(7098) /* getQuestDeliveryDataForPlacement */;
  }
}
function trackAdContentEvent(sourceQuestContent) {
  ...
  let obj1 = require(7098) /* getQuestDeliveryDataForPlacement */;
  ...
  let obj3 = require(7098) /* getQuestDeliveryDataForPlacement */;
  if (!obj3.isBillableQuestContent(sourceQuestContent)) {
    let tmp3Result = tmp3(6863);
  ...
  let adTrafficMetadataSealed = require(7098) /* getQuestDeliveryDataForPlacement */.getAdTrafficMetadataSealed(sourceQuestContent, undefined, adContentId);
  ...
  if (null != relatedQuestId) {
    ...
    if (null != quest) {
      questStatus = tmp3(7127).getQuestStatus(quest);
      const tmp3Result2 = tmp3(7127);
    }
    obj1[1] = questStatus;
    let obj2 = obj1;
  } else {
...
function _getCommonClickEventProperties() {
  ...
  const tmp = callback((arg0) => {
    ...
    const iter = (function*(arg0) {
      ...
      yield "PX_8";
      const obj5 = callback(7129);
      let initializeState = yield obj5.getAdUser(callback(7127).getQuestContentName(callback));
      const obj4 = {};
      const merged = Object.assign(callback(7127).getContentProperties(callback, callback2, dependencyMap));
      const merged1 = Object.assign(callback2(7077)());
      obj4.cta_name = c3;
        ...
        try {
          ...
          if (0 === adTrafficMetadataSealed) {
            ...
            if (arg0 === 1) {
              ...
              adTrafficMetadataSealed = callback(7098).getAdTrafficMetadataSealed(callback2, callback);
            ...
            const adMetadataSealed = callback(7098).getAdMetadataSealed(callback2);
            c1 = adMetadataSealed;
            if (adMetadataSealed == null) {
              c1 = null;
            }
...
export const trackAppStoreOverlayEvent = function trackAppStoreOverlayEvent(f85160, closure_1, arg2, event, time_spent_ms) {
  let obj = { content_name: null, cta_name: null, impression_id: null, source_content_name: null, app_id: null, content_position: null };
  obj[0] = require(7127) /* getQuestContentName */.getQuestContentName(closure_1.content);
  ({ ctaContent: obj[1], impressionId: obj[2] } = closure_1);
  const obj2 = require(7127) /* getQuestContentName */;
  obj[3] = require(7127) /* getQuestContentName */.getQuestContentName(closure_1.sourceQuestContent);
  obj[4] = arg2;
  ...
  obj = { questId: f85160.id, event, properties: null, sourceQuestContent: null };
  let tmp3 = obj;
  if (tmp) {
    obj = {};
...
export const trackAdContentAppStoreOverlayEvent = function trackAdContentAppStoreOverlayEvent(arg0, closure_2, arg2, event, time_spent_ms) {
  ...
  obj[0] = require(7127) /* getQuestContentName */.getQuestContentName(closure_2.content);
  ({ ctaContent: obj[1], impressionId: obj[2] } = closure_2);
  const obj2 = require(7127) /* getQuestContentName */;
  obj[3] = require(7127) /* getQuestContentName */.getQuestContentName(closure_2.sourceQuestContent);
  obj[4] = arg2;
...
export const trackBountyCarouselEmptyStateViewed = function trackBountyCarouselEmptyStateViewed(arg0) {
  ...
  const obj2 = importDefault(698);
  const tmp = require;
  if (!obj4.isBillableQuestContent(require(5163) /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_HOME_MOBILE_CAROUSEL)) {
    const activeSessionUnsafe = tmp(6863).getActiveSessionUnsafe();
    uuid = undefined;
    if (activeSessionUnsafe != null) {
      uuid = activeSessionUnsafe.uuid;
    }
...
export const trackBountyVerticalScroll = function trackBountyVerticalScroll(result) {
  ...
  const obj2 = importDefault(698);
  const activeSessionUnsafe = require(6863) /* trackHeartbeat */.getActiveSessionUnsafe();
  let uuid;
  if (activeSessionUnsafe != null) {
    uuid = activeSessionUnsafe.uuid;
  }
...
export const trackQuestBarOrDockModeChange = function trackQuestBarOrDockModeChange(arg0) {
  ...
  let obj = require(7127) /* getQuestContentName */;
