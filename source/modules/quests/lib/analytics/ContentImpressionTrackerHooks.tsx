...
// Dependencies: [19, 7206, 7222, 589, 7233, 8902, 10452, 2]
...
// Module 10451 (useAdContentImpressionTrackerProps)
...
export const useQuestImpressionRef = function useQuestImpressionRef() {
  return React.useContext(require(10452) /* set */.QuestImpressionContext);
};
export const useQuestImpression = function useQuestImpression() {
  const context = React.useContext(require(10452) /* set */.QuestImpressionContext);
  let current;
  if (context != null) {
...
export const useGetQuestImpressionId = function useGetQuestImpressionId() {
  context = React.useContext(context(10452).QuestImpressionContext);
  const items = [context];
