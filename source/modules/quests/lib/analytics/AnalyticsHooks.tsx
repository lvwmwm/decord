...
// Dependencies: [19, 676, 10494, 7178, 7159, 7190, 7188, 7138, 514, 500, 7195, 5164, 7189, 698, 2]
...
// Module 11177 (useTrackQuestEventWithImpression)
...
export const useTrackQuestEventWithImpression = function useTrackQuestEventWithImpression() {
  getQuestImpressionId = getQuestImpressionId(10494).useGetQuestImpressionId();
...
export const useTrackQuestContentClickedWithImpression = function useTrackQuestContentClickedWithImpression() {
  const getQuestImpressionId = callback(10494).useGetQuestImpressionId();
