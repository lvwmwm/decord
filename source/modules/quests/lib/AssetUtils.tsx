...
// Function ID: 10390
// Name: resolveAsset
// Dependencies: [5143, 676, 10390, 10391, 10392, 10393, 10394, 7086, 10401, 10402, 5150, 1467, 1877, 2]
...
export const getQuestAsset = function getQuestAsset(quest, VIDEO_PLAYER_TRANSCRIPT, DARK, flag) {
  ...
  if (obj.HERO === VIDEO_PLAYER_TRANSCRIPT) {
    ...
    if (questPrimaryReward.type === require(7086) /* QuestRewardTypes */.QuestRewardTypes.VIRTUAL_CURRENCY) {
      let tmp25;
      if (null != arg4) {
        tmp25 = obj8[arg4];
      }
    ...
    obj = require(10394) /* _getDefaultRewardName */;
    const questPrimaryReward1 = obj.getQuestPrimaryReward(quest);
    if (questPrimaryReward1.type === require(7086) /* QuestRewardTypes */.QuestRewardTypes.VIRTUAL_CURRENCY) {
      return null;
    } else {
    ...
    if ("taskConfigV2" in quest.config) {
      const FirstPartyQuestTaskTypes = require(5150) /* set */.FirstPartyQuestTaskTypes;
