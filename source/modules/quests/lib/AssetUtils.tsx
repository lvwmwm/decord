...
// Function ID: 10359
// Name: resolveAsset
// Dependencies: [5113, 676, 10359, 10360, 10361, 10362, 10363, 7059, 10370, 10371, 5120, 1467, 1849, 2]
...
export const getQuestAsset = function getQuestAsset(quest, VIDEO_PLAYER_TRANSCRIPT, DARK, flag) {
  ...
  if (obj.HERO === VIDEO_PLAYER_TRANSCRIPT) {
    ...
    if (questPrimaryReward.type === require(7059) /* QuestRewardTypes */.QuestRewardTypes.VIRTUAL_CURRENCY) {
      let tmp25;
      if (null != arg4) {
        tmp25 = obj8[arg4];
      }
      if (null != tmp25) {
        ...
        obj[0] = importDefault(10370);
        obj1 = obj;
      } else {
        obj1 = { url: null, mimetype: "video/webm", isAnimated: true };
        obj1[0] = importDefault(10371);
      }
      return obj1;
    } else {
    ...
    obj = require(10363) /* _getDefaultRewardName */;
    const questPrimaryReward1 = obj.getQuestPrimaryReward(quest);
    if (questPrimaryReward1.type === require(7059) /* QuestRewardTypes */.QuestRewardTypes.VIRTUAL_CURRENCY) {
      return null;
    } else {
    ...
    if ("taskConfigV2" in quest.config) {
      const FirstPartyQuestTaskTypes = require(5120) /* set */.FirstPartyQuestTaskTypes;
