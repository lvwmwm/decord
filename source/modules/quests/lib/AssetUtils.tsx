...
export const getQuestAsset = function getQuestAsset(quest, VIDEO_PLAYER_TRANSCRIPT, DARK, flag) {
  ...
  if (obj.HERO === VIDEO_PLAYER_TRANSCRIPT) {
    ...
    if (questPrimaryReward.type === require(dependencyMap[7]).QuestRewardTypes.VIRTUAL_CURRENCY) {
      ...
      if (null != tmp30) {
        let obj = { "Null": -191619890291821150000000000000000000000000000000000000, "Null": 0., "Null": 0., url: tmp30 };
        obj1 = obj;
      } else if (flag) {
        obj = { "Null": 50606336, "Null": 35082496, "Null": 118, url: importDefault(dependencyMap[8]) };
        obj1 = obj;
      } else {
        obj1 = { "Null": -191619890291821150000000000000000000000000000000000000, "Null": 0., "Null": 0., url: importDefault(dependencyMap[9]) };
      }
      return obj1;
    } else {
