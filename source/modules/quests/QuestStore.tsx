...
// Dependencies: [32, 7081, 7082, 5128, 687, 12, 5135, 7085, 1208, 7078, 5131, 7086, 7087, 7095, 7096, 584, 589, 709, 2]

// Module 7080 (initializeState)
...
function _runExpirationCheck() {
  ...
  let result = _require(7078).findNextUpcomingExpirationEpochMs(Array.from(store.values()));
  if (null != result) {
    const _Math = Math;
    const _Date = Date;
...
const questStore = new QuestStore(require("dispatcher"), {
  ...
  QUESTS_FETCH_QUEST_TO_DELIVER_SUCCESS: function handleFetchQuestToDeliverSuccess(arg0) {
    ...
    if (obj3.getConfig({ location: "handleFetchQuestToDeliverSuccess" }).enableNewRequestBehavior) {
      ...
      obj[1] = id1;
      obj[2] = fetchedAt;
      obj[3] = require(7096) /* result */.resolveResponseTtl(responseTtlSeconds);
      ...
      const obj6 = require(7096) /* result */;
    } else if (null == quest) {
  ...
  QUESTS_FETCH_EARNED_QUEST_TO_DELIVER_SUCCESS: function handleFetchEarnedQuestToDeliverSuccess(arg0) {
    ...
    const responseTtl = require(7096) /* result */.resolveResponseTtl(responseTtlSeconds);
    ...
    const obj2 = require(7096) /* result */;
    while (tmp5 !== undefined) {
      ...
      if (null != tmp11) {
        ...
        let obj8 = require(7087) /* progressFromServer */;
        let tmp40 = tmp11;
  ...
  QUESTS_CLAIM_REWARD_SUCCESS: function handleClaimRewardSuccess(arg0) {
    ...
    if (null != userStatus) {
      if (null == userStatus.claimedAt) {
        ...
        let rewardCode = null;
        if (tag === require(7085) /* QuestRewardTypes */.QuestRewardTypes.REWARD_CODE) {
  ...
  QUESTS_USER_STATUS_UPDATE: function handleQuestUserStatusUpdate(user_status) {
    ...
    const result = require(7087) /* progressFromServer */.questUserStatusFromServer(user_status);
    ...
    if (null != value1) {
      const isQuestExpiredResult = require(7078) /* getQuestDeliveryDataForPlacement */.isQuestExpired(value1);
  ...
  QUESTS_PREVIEW_UPDATE_SUCCESS: function handlePreviewUpdateSuccess(previewQuestUserStatus) {
    ...
    if (null != value1) {
      ...
      const obj8 = require(7078) /* getQuestDeliveryDataForPlacement */;
    }
  },
  ...
  QUESTS_FETCH_QUEST_HOME_HERO_SUCCESS: function handleFetchQuestHomeHeroSuccess(fetchedAt) {
    ...
    obj[3] = require(7096) /* result */.resolveResponseTtl(fetchedAt.responseTtlSeconds);
