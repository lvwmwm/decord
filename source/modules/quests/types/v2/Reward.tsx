...
// Dependencies: [5205, 7211, 2]
// Exports: questRewardsConfigV2FromServer

// Module 7219 (_rewardRedemptionInstructionsFromServer)
function _rewardRedemptionInstructionsFromServer(redemption_instructions_by_platform) {
  ...
  for (const item10012 of keys) {
    ...
    let tmp4 = parsed;
    let QUEST_REWARD_CODE_PLATFORMS_SET = require(5205) /* QuestsVisibleMessagesChangedSource */.QUEST_REWARD_CODE_PLATFORMS_SET;
...
function _questRewardV2FromServer(type) {
  type = type.type;
  if (require(7211) /* QuestRewardTypes */.QuestRewardTypes.REWARD_CODE === type) {
