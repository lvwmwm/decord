...
// Dependencies: [5036, 5988, 2]
// Exports: questRewardsConfigV2FromServer

// Module 5996 (_rewardRedemptionInstructionsFromServer)
...
function _questRewardV2FromServer(type) {
  ...
  if (require(5988) /* QuestRewardTypes */.QuestRewardTypes.REWARD_CODE === type) {
    ...
    return obj;
  } else if (tmp(5988).QuestRewardTypes.COLLECTIBLE === type) {
    ...
    obj1[0] = tmp(5988).QuestRewardTypes.COLLECTIBLE;
    ...
    return obj1;
  } else if (tmp(5988).QuestRewardTypes.VIRTUAL_CURRENCY === type) {
    const obj3 = { type: null, skuId: null, messages: null, orbQuantity: null, premiumOrbQuantity: null };
    obj3[0] = tmp(5988).QuestRewardTypes.VIRTUAL_CURRENCY;
    obj3[1] = type.sku_id;
    ...
    return obj3;
  } else if (tmp(5988).QuestRewardTypes.FRACTIONAL_PREMIUM === type) {
    const obj5 = { type: null, skuId: null, asset: null, assetVideo: null, quantity: null, messages: null };
    obj5[0] = tmp(5988).QuestRewardTypes.FRACTIONAL_PREMIUM;
    ...
    obj5[5] = obj6;
    return obj5;
  } else if (tmp(5988).QuestRewardTypes.IN_GAME === type) {
    obj = { type: null, skuId: null, asset: null, assetVideo: null, messages: null };
    obj[0] = tmp(5988).QuestRewardTypes.IN_GAME;
