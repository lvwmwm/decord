...
// Dependencies: [5407, 7641, 2]
// Exports: questRewardsConfigV2FromServer

// Module 7649 (_rewardRedemptionInstructionsFromServer)
...
function _questRewardV2FromServer(type) {
  ...
  if (QuestRewardTypes.QuestRewardTypes.REWARD_CODE === type) {
    ...
    obj[0] = tmp(7641).QuestRewardTypes.REWARD_CODE;
    ...
    return obj;
  } else if (tmp(7641).QuestRewardTypes.COLLECTIBLE === type) {
    ...
    obj1[0] = tmp(7641).QuestRewardTypes.COLLECTIBLE;
    ...
    return obj1;
  } else if (tmp(7641).QuestRewardTypes.VIRTUAL_CURRENCY === type) {
    const obj3 = { type: null, skuId: null, messages: null, orbQuantity: null, premiumOrbQuantity: null };
    obj3[0] = tmp(7641).QuestRewardTypes.VIRTUAL_CURRENCY;
    obj3[1] = type.sku_id;
    ...
    return obj3;
  } else if (tmp(7641).QuestRewardTypes.FRACTIONAL_PREMIUM === type) {
    const obj5 = { type: null, skuId: null, asset: null, assetVideo: null, quantity: null, messages: null };
    obj5[0] = tmp(7641).QuestRewardTypes.FRACTIONAL_PREMIUM;
    ...
    obj5[5] = obj6;
    return obj5;
  } else if (tmp(7641).QuestRewardTypes.IN_GAME === type) {
    obj = { type: null, skuId: null, asset: null, assetVideo: null, messages: null };
    obj[0] = tmp(7641).QuestRewardTypes.IN_GAME;
