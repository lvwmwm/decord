...
// Dependencies: [7063, 7067, 7068, 2]
// Exports: questCosponsorMetadataFromServer, questFromServerV2

// Module 7062 (questFromServerV2)
...
export const questFromServerV2 = function questFromServerV2(id) {
  ...
  obj[8] = require(7063) /* _firstPartyTasksFromServer */.questTaskConfigV2FromServer(id.task_config_v2);
  obj1 = { questName: id.messages.quest_name, gameTitle: id.messages.game_title, gamePublisher: id.messages.game_publisher };
  const obj5 = require(7063) /* _firstPartyTasksFromServer */;
  const tmp = require;
  obj[9] = require(7067) /* _rewardRedemptionInstructionsFromServer */.questRewardsConfigV2FromServer(id.rewards_config);
  ...
  const obj6 = require(7067) /* _rewardRedemptionInstructionsFromServer */;
  obj[12] = tmp(7068).questCtaConfigFromServer(id.cta_config);
  return obj;
};
