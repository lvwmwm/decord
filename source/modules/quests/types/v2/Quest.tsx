...
// Dependencies: [5975, 5979, 5980, 2]
// Exports: questFromServerV2

// Module 5974 (questCosponsorMetadataFromServer)
...
export const questFromServerV2 = function questFromServerV2(id) {
  ...
  obj = { primary: id.colors.primary, secondary: id.colors.secondary, taskConfigV2: require(5975) /* _firstPartyTasksFromServer */.questTaskConfigV2FromServer(id.task_config_v2) };
  obj1 = { questName: id.messages.quest_name, gameTitle: id.messages.game_title, gamePublisher: id.messages.game_publisher };
  const obj5 = require(5975) /* _firstPartyTasksFromServer */;
  obj.rewardsConfig = require(5979) /* _rewardRedemptionInstructionsFromServer */.questRewardsConfigV2FromServer(id.rewards_config);
  obj.cosponsorMetadata = questCosponsorMetadataFromServer(id.cosponsor_metadata);
  obj.sharePolicy = id.share_policy;
  const obj6 = require(5979) /* _rewardRedemptionInstructionsFromServer */;
  obj.ctaConfig = require(5980) /* questCtaConfigFromServer */.questCtaConfigFromServer(id.cta_config);
  return obj;
};
