...
export const questFromServerV2 = function questFromServerV2(id) {
  ...
  obj[8] = require(5998) /* _firstPartyTasksFromServer */.questTaskConfigV2FromServer(id.task_config_v2);
  obj1 = { questName: id.messages.quest_name, gameTitle: id.messages.game_title, gamePublisher: id.messages.game_publisher };
  const obj5 = require(5998) /* _firstPartyTasksFromServer */;
  const tmp = require;
  obj[9] = require(6002) /* _rewardRedemptionInstructionsFromServer */.questRewardsConfigV2FromServer(id.rewards_config);
  ...
  const obj6 = require(6002) /* _rewardRedemptionInstructionsFromServer */;
  obj[12] = tmp(6003).questCtaConfigFromServer(id.cta_config);
  return obj;
};
