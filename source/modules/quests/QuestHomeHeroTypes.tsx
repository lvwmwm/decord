...
// Dependencies: [9479, 9494, 2]
// Exports: questHomeHeroFromServer

// Module 9493 (questHomeHeroFromServer)
...
export const questHomeHeroFromServer = function questHomeHeroFromServer(c7) {
  ...
  obj[3] = require(9479) /* resolveAsset */.resolveAdCreativeCdnUrl(creative_content.hero_image);
  const obj2 = require(9479) /* resolveAsset */;
  obj[4] = require(9479) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.hero_video);
  const obj3 = require(9479) /* resolveAsset */;
  obj[5] = require(9479) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.sponsor_image);
  const obj4 = require(9479) /* resolveAsset */;
  obj[6] = require(9494) /* questHomeHeroCtaFromServer */.questHomeHeroCtaFromServer(creative_content.cta);
  ...
  obj[8] = tmp3;
  const obj5 = require(9494) /* questHomeHeroCtaFromServer */;
  obj[9] = require(9479) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.shelf_image);
  const tmpResult1 = require(9479) /* resolveAsset */;
  obj[10] = require(9479) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.shelf_video);
