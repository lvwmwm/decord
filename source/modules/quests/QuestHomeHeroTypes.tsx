...
// Dependencies: [10471, 10486, 2]
// Exports: questHomeHeroFromServer

// Module 10485 (questHomeHeroFromServer)
...
export const questHomeHeroFromServer = function questHomeHeroFromServer(c7) {
  ...
  obj[3] = require(10471) /* resolveAsset */.resolveAdCreativeCdnUrl(creative_content.hero_image);
  const obj2 = require(10471) /* resolveAsset */;
  obj[4] = require(10471) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.hero_video);
  const obj3 = require(10471) /* resolveAsset */;
  obj[5] = require(10471) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.sponsor_image);
  const obj4 = require(10471) /* resolveAsset */;
  obj[6] = require(10486) /* questHomeHeroCtaFromServer */.questHomeHeroCtaFromServer(creative_content.cta);
  ...
  obj[8] = tmp3;
  const obj5 = require(10486) /* questHomeHeroCtaFromServer */;
  obj[9] = require(10471) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.shelf_image);
  const tmpResult1 = require(10471) /* resolveAsset */;
  obj[10] = require(10471) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.shelf_video);
