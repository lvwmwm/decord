...
// Dependencies: [10358, 10373, 2]
// Exports: questHomeHeroFromServer

// Module 10372 (questHomeHeroFromServer)
...
export const questHomeHeroFromServer = function questHomeHeroFromServer(c7) {
  ...
  obj[3] = require(10358) /* resolveAsset */.resolveAdCreativeCdnUrl(creative_content.hero_image);
  const obj2 = require(10358) /* resolveAsset */;
  obj[4] = require(10358) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.hero_video);
  const obj3 = require(10358) /* resolveAsset */;
  obj[5] = require(10358) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.sponsor_image);
  const obj4 = require(10358) /* resolveAsset */;
  obj[6] = require(10373) /* questHomeHeroCtaFromServer */.questHomeHeroCtaFromServer(creative_content.cta);
  ...
  obj[8] = tmp3;
  const obj5 = require(10373) /* questHomeHeroCtaFromServer */;
  obj[9] = require(10358) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.shelf_image);
  const tmpResult1 = require(10358) /* resolveAsset */;
  obj[10] = require(10358) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.shelf_video);
