...
// Dependencies: [10405, 10420, 2]
// Exports: questHomeHeroFromServer

// Module 10419 (questHomeHeroFromServer)
...
export const questHomeHeroFromServer = function questHomeHeroFromServer(c7) {
  ...
  obj[3] = require(10405) /* resolveAsset */.resolveAdCreativeCdnUrl(creative_content.hero_image);
  const obj2 = require(10405) /* resolveAsset */;
  obj[4] = require(10405) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.hero_video);
  const obj3 = require(10405) /* resolveAsset */;
  obj[5] = require(10405) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.sponsor_image);
  const obj4 = require(10405) /* resolveAsset */;
  obj[6] = require(10420) /* questHomeHeroCtaFromServer */.questHomeHeroCtaFromServer(creative_content.cta);
  ...
  obj[8] = tmp3;
  const obj5 = require(10420) /* questHomeHeroCtaFromServer */;
  obj[9] = require(10405) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.shelf_image);
  const tmpResult1 = require(10405) /* resolveAsset */;
  obj[10] = require(10405) /* resolveAsset */.resolveOptionalAdCreativeCdnUrl(creative_content.shelf_video);
