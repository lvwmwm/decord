...
// Dependencies: [19, 17, 1395, 676, 21, 4344, 5773, 9731, 9732, 4683, 1236, 9733, 1222, 9735, 5415, 4752, 5777, 4340, 8643, 7792, 9739, 9740, 9741, 9744, 9746, 2]
// Exports: LinkedChannelInvite

// Module 9730 (LinkedChannelInvite)
...
const memoResult = importAllResult.memo((onInviteRevoked) => {
  ...
  const items2 = [
    callback(invite(4340).Text, obj),
    callback(invite(8643).ContextMenu, {
      items: inviteActions,
      children(ref) {
        const merged = Object.assign(ref, Object.create(null));
        const obj = { size: "sm", variant: "secondary", icon: null, accessibilityLabel: null, ref: null };
        obj[2] = callback(9735).more;
        const intl = invite(1236).intl;
        obj[3] = intl.string(invite(1236).t.DEoVWZ);
        obj[4] = ref.ref;
        const merged1 = Object.assign(merged);
        return callback2(invite(7792).IconButton, obj);
      }
    })
  ];
  obj[2] = items2;
  const items3 = [callback2(invite(4752).Stack, obj), , , ];
  const obj2 = { channel: memo, expiresAt: null };
  obj2[1] = invite.getExpiresAt();
  items3[1] = callback(invite(9739).InstantInviteDetails, obj2);
  if (tmp9Result) {
    const obj3 = { roleIds: null, guildId: null };
    obj3[0] = memo1;
    obj3[1] = id;
    tmp9Result = tmp9(importDefault(9744), obj3);
  }
  items3[2] = tmp9Result;
  ...
  if (null != id1) {
    ...
    obj5[2] = id2;
    obj5[3] = id;
    tmp9Result = tmp9(importDefault(9740), obj5);
    const tmp15 = importDefault(9740);
  }
  const obj6 = { children: null };
  const obj7 = { direction: "horizontal", align: "flex-end", children: null };
  obj4[1] = tmp9Result;
  const items4 = [callback(View, obj4), callback(importDefault(9746), { uses, maxUses })];
  obj7[2] = items4;
  items3[3] = callback2(invite(4752).Stack, obj7);
  obj6[0] = items3;
  return callback2(invite(5415).Card, obj6);
});
...
export const LinkedChannelInvite = function LinkedChannelInvite(channel) {
  ...
  canUnlinkLobbyChannel = channel(9731).useCanUnlinkLobbyChannel(channel);
  let str;
  const tmp3Result = channel(9731);
  ...
  const tmp9Result = canUnlinkLobbyChannel(9732)(channel.id, str);
  ...
  const tmp9 = canUnlinkLobbyChannel(9732);
  obj[1] = channel(5777).GameIconSizes.SIZE_24;
  const items2 = [callback(canUnlinkLobbyChannel(5777), obj), ];
  ...
  obj1[4] = name;
  items2[1] = callback(channel(4340).Text, obj1);
  obj[1] = items2;
  const items3 = [
    closure_8(View, obj),
    callback(channel(8643).ContextMenu, {
      items: memo,
      children(ref) {
        const merged = Object.assign(ref, Object.create(null));
        const obj = { size: "sm", variant: "secondary", icon: null, accessibilityLabel: null, ref: null };
  ...
  obj2[2] = items3;
  const items4 = [closure_8(channel(4752).Stack, obj2), callback(channel(9739).InstantInviteDetails, { channel }), ];
  ...
  if (null != linked_by) {
    ...
    tmp15Result = tmp15(tmp8(9740), obj5);
  }
  const obj6 = { children: null };
  const obj3 = {
    items: memo,
  ...
  const tmp8Result = canUnlinkLobbyChannel(5777);
  obj4[1] = tmp15Result;
  items4[2] = callback(channel(4752).Stack, { direction: "horizontal", align: "flex-end", children: callback(View, obj4) });
  obj6[0] = items4;
  return closure_8(channel(5415).Card, obj6);
};
