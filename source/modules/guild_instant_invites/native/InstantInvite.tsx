...
// Dependencies: [19, 17, 1395, 676, 21, 4342, 5795, 9746, 9747, 4706, 1236, 9748, 1222, 9750, 5437, 4775, 5799, 4338, 8661, 7817, 9754, 9755, 9756, 9759, 9761, 2]
// Exports: LinkedChannelInvite

// Module 9745 (LinkedChannelInvite)
...
const memoResult = importAllResult.memo((onInviteRevoked) => {
  ...
  if (null != id1) {
    ...
    obj5[2] = id2;
    obj5[3] = id;
    tmp9Result = tmp9(importDefault(9755), obj5);
    const tmp15 = importDefault(9755);
  }
  const obj6 = { children: null };
  const obj7 = { direction: "horizontal", align: "flex-end", children: null };
  obj4[1] = tmp9Result;
  const items4 = [callback(View, obj4), callback(importDefault(9761), { uses, maxUses })];
  obj7[2] = items4;
  items3[3] = callback2(invite(4775).Stack, obj7);
  obj6[0] = items3;
  return callback2(invite(5437).Card, obj6);
});
...
export const LinkedChannelInvite = function LinkedChannelInvite(channel) {
  ...
  canUnlinkLobbyChannel = channel(9746).useCanUnlinkLobbyChannel(channel);
  let str;
  const tmp3Result = channel(9746);
  ...
  const tmp9Result = canUnlinkLobbyChannel(9747)(channel.id, str);
  ...
  const tmp9 = canUnlinkLobbyChannel(9747);
  obj[1] = channel(5799).GameIconSizes.SIZE_24;
  const items2 = [callback(canUnlinkLobbyChannel(5799), obj), ];
  ...
  const items3 = [
    closure_8(View, obj),
    callback(channel(8661).ContextMenu, {
      items: memo,
      children(ref) {
        const merged = Object.assign(ref, Object.create(null));
        const obj = { size: "sm", variant: "secondary", icon: null, accessibilityLabel: null, ref: null };
  ...
  obj2[2] = items3;
  const items4 = [closure_8(channel(4775).Stack, obj2), callback(channel(9754).InstantInviteDetails, { channel }), ];
  ...
  if (null != linked_by) {
    ...
    tmp15Result = tmp15(tmp8(9755), obj5);
  }
  const obj6 = { children: null };
  const obj3 = {
    items: memo,
  ...
  const tmp8Result = canUnlinkLobbyChannel(5799);
  obj4[1] = tmp15Result;
  items4[2] = callback(channel(4775).Stack, { direction: "horizontal", align: "flex-end", children: callback(View, obj4) });
  obj6[0] = items4;
  return closure_8(channel(5437).Card, obj6);
};
