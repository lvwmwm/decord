...
// Dependencies: [19, 17, 1395, 676, 21, 4661, 7145, 9949, 9950, 4656, 1236, 9951, 1222, 9953, 6292, 4733, 7149, 4734, 9958, 8035, 9964, 9965, 9967, 9970, 9972, 2]
// Exports: LinkedChannelInvite

// Module 9948 (LinkedChannelInvite)
...
const memoResult = importAllResult.memo((onInviteRevoked) => {
  ...
  const items2 = [
    ...
    callback(invite(9958).ContextMenu, {
      items: inviteActions,
      children(ref) {
  ...
  if (tmp9Result) {
    ...
    obj3[0] = memo1;
    obj3[1] = id;
    tmp9Result = tmp9(importDefault(9970), obj3);
  }
  items3[2] = tmp9Result;
  ...
  if (null != id1) {
    ...
    obj5[2] = id2;
    obj5[3] = id;
    tmp9Result = tmp9(importDefault(9965), obj5);
    const tmp15 = importDefault(9965);
  }
  const obj6 = { children: null };
  const obj7 = { direction: "horizontal", align: "flex-end", children: null };
  obj4[1] = tmp9Result;
  const items4 = [callback(View, obj4), callback(importDefault(9972), { uses, maxUses })];
  obj7[2] = items4;
...
export const LinkedChannelInvite = function LinkedChannelInvite(channel) {
  ...
  canUnlinkLobbyChannel = channel(9949).useCanUnlinkLobbyChannel(channel);
  let str;
  const tmp3Result = channel(9949);
  ...
  const tmp9Result = canUnlinkLobbyChannel(9950)(channel.id, str);
