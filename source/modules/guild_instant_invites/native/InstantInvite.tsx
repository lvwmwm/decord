...
// Dependencies: [19, 17, 1376, 676, 21, 4193, 5525, 10205, 10206, 4533, 1236, 10207, 1222, 10209, 5226, 4602, 5529, 4189, 9310, 6685, 10214, 10215, 10216, 10219, 10221, 2]
...
const memoResult = importAllResult.memo((onInviteRevoked) => {
  ...
  const items2 = [
    callback(invite(4189).Text, obj),
    callback(invite(9310).ContextMenu, {
      items: inviteActions,
      children(ref) {
        const merged = Object.assign(ref, Object.create(null));
        const obj = { size: "sm", variant: "secondary", icon: null, accessibilityLabel: null, ref: null };
        obj[2] = callback(10209).more;
        const intl = invite(1236).intl;
        obj[3] = intl.string(invite(1236).t.DEoVWZ);
        obj[4] = ref.ref;
        const merged1 = Object.assign(merged);
        return callback2(invite(6685).IconButton, obj);
      }
    })
  ];
  obj[2] = items2;
  const items3 = [callback2(invite(4602).Stack, obj), , , ];
  const obj2 = { channel: memo, expiresAt: null };
  obj2[1] = invite.getExpiresAt();
  items3[1] = callback(invite(10214).InstantInviteDetails, obj2);
  if (tmp9Result) {
    const obj3 = { roleIds: null, guildId: null };
    obj3[0] = memo1;
    obj3[1] = id;
    tmp9Result = tmp9(importDefault(10219), obj3);
  }
  items3[2] = tmp9Result;
  ...
  if (null != id1) {
    ...
    obj5[2] = id2;
    obj5[3] = id;
    tmp9Result = tmp9(importDefault(10215), obj5);
    const tmp15 = importDefault(10215);
  }
  const obj6 = { children: null };
  const obj7 = { direction: "horizontal", align: "flex-end", children: null };
  obj4[1] = tmp9Result;
  const items4 = [callback(View, obj4), callback(importDefault(10221), { uses, maxUses })];
  obj7[2] = items4;
  items3[3] = callback2(invite(4602).Stack, obj7);
  obj6[0] = items3;
  return callback2(invite(5226).Card, obj6);
});
...
export const LinkedChannelInvite = function LinkedChannelInvite(channel) {
  ...
  canUnlinkLobbyChannel = channel(10205).useCanUnlinkLobbyChannel(channel);
  let str;
  const tmp3Result = channel(10205);
  ...
  const tmp9Result = canUnlinkLobbyChannel(10206)(channel.id, str);
  ...
  const tmp9 = canUnlinkLobbyChannel(10206);
  obj[1] = channel(5529).GameIconSizes.SIZE_24;
  const items2 = [callback(canUnlinkLobbyChannel(5529), obj), ];
  ...
  obj1[4] = name;
  items2[1] = callback(channel(4189).Text, obj1);
  obj[1] = items2;
  const items3 = [
    closure_8(View, obj),
    callback(channel(9310).ContextMenu, {
      items: memo,
      children(ref) {
        const merged = Object.assign(ref, Object.create(null));
        const obj = { size: "sm", variant: "secondary", icon: null, accessibilityLabel: null, ref: null };
  ...
  obj2[2] = items3;
  const items4 = [closure_8(channel(4602).Stack, obj2), callback(channel(10214).InstantInviteDetails, { channel }), ];
  ...
  if (null != linked_by) {
    ...
    tmp15Result = tmp15(tmp8(10215), obj5);
  }
  const obj6 = { children: null };
  const obj3 = {
    items: memo,
  ...
  const tmp8Result = canUnlinkLobbyChannel(5529);
  obj4[1] = tmp15Result;
  items4[2] = callback(channel(4602).Stack, { direction: "horizontal", align: "flex-end", children: callback(View, obj4) });
  obj6[0] = items4;
  return closure_8(channel(5226).Card, obj6);
};
