...
// Dependencies: [19, 17, 1395, 676, 21, 4446, 5924, 10608, 10609, 4823, 1236, 10610, 1222, 10612, 5566, 4891, 5928, 4442, 8733, 7952, 10616, 10617, 10618, 10621, 10623, 2]
// Exports: LinkedChannelInvite

// Module 10607 (LinkedChannelInvite)
import memoResult1Default from "memoResult1" /* 10617 */;
import InviteRolesDisplayDefault from "InviteRolesDisplay" /* 10621 */;
import InstantInviteUsesLabelDefault from "InstantInviteUsesLabel" /* 10623 */;
...
const memoResult = importAllResult.memo((onInviteRevoked) => {
  ...
  const items2 = [
    callback(invite(4442).Text, obj),
    callback(invite(8733).ContextMenu, {
      items: inviteActions,
      children(ref) {
        const merged = Object.assign(ref, Object.create(null));
        const obj = { size: "sm", variant: "secondary", icon: callback(10612).more, accessibilityLabel: null, ref: null };
        const intl = invite(1236).intl;
        obj[3] = intl.string(invite(1236).t.DEoVWZ);
        obj[4] = ref.ref;
        const merged1 = Object.assign(merged);
        return callback2(invite(7952).IconButton, obj);
      }
    })
  ];
  obj[2] = items2;
  const items3 = [callback2(invite(4891).Stack, obj), , , ];
  obj1 = {
    items: inviteActions,
    children(ref) {
      const merged = Object.assign(ref, Object.create(null));
  ...
  const tmp = callback3();
  items3[1] = callback(invite(10616).InstantInviteDetails, { channel: memo, expiresAt: invite.getExpiresAt() });
  if (tmp9Result) {
  ...
  obj7[2] = items4;
  items3[3] = callback2(invite(4891).Stack, obj7);
  obj6[0] = items3;
  return callback2(invite(5566).Card, obj6);
});
...
export const LinkedChannelInvite = function LinkedChannelInvite(channel) {
  ...
  canUnlinkLobbyChannel = channel(10608).useCanUnlinkLobbyChannel(channel);
  let str;
  const tmp3Result = channel(10608);
  ...
  const tmp9Result = canUnlinkLobbyChannel(10609)(channel.id, str);
  ...
  callback = callback.useCallback(() => {
    if (canUnlinkLobbyChannel) {
      ...
      let obj = canUnlinkLobbyChannel(4823);
  ...
  const memo = callback.useMemo(() => {
    ...
    obj[1] = channel(10610).ArrowSmallRightIcon;
    ...
    obj[1] = canUnlinkLobbyChannel(10612).revoke;
    obj[3] = callback;
    items[1] = obj;
    return items;
  }, items1);
  ...
  const tmp9 = canUnlinkLobbyChannel(10609);
  obj[1] = channel(5928).GameIconSizes.SIZE_24;
  const items2 = [callback(canUnlinkLobbyChannel(5928), obj), ];
  ...
  obj1[4] = name;
  items2[1] = callback(channel(4442).Text, obj1);
  obj[1] = items2;
  const items3 = [
    closure_8(View, obj),
    callback(channel(8733).ContextMenu, {
      items: memo,
      children(ref) {
        const merged = Object.assign(ref, Object.create(null));
        const obj = { size: "sm", variant: "secondary", icon: canUnlinkLobbyChannel(10612).more, accessibilityLabel: null, ref: null };
        const intl = channel(1236).intl;
        obj[3] = intl.string(channel(1236).t.DEoVWZ);
        obj[4] = ref.ref;
        const merged1 = Object.assign(merged);
        return callback(channel(7952).IconButton, obj);
      }
    })
  ];
  obj2[2] = items3;
  const items4 = [closure_8(channel(4891).Stack, obj2), callback(channel(10616).InstantInviteDetails, { channel }), ];
  const obj4 = { style: tmp.creatorWrapper, children: null };
  ...
  if (null != linked_by) {
    ...
    tmp15Result = tmp15(tmp8(10617), obj5);
  }
  const obj6 = { children: null };
  const obj3 = {
    items: memo,
  ...
  const tmp8Result = canUnlinkLobbyChannel(5928);
  obj4[1] = tmp15Result;
  items4[2] = callback(channel(4891).Stack, { direction: "horizontal", align: "flex-end", children: callback(View, obj4) });
  obj6[0] = items4;
  return closure_8(channel(5566).Card, obj6);
};
