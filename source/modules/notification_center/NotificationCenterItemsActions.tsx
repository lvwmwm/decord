...
// Dependencies: [5, 6994, 676, 709, 5079, 503, 1385, 6996, 530, 3928, 2]
...
// Module 15384 (_fetchNotificationCenterItems)
...
export const markNotificationCenterItemAcked = function markNotificationCenterItemAcked(local_id) {
  if (null != local_id.local_id) {
    ...
    obj = require(6996) /* getRelativeTimestamp */;
