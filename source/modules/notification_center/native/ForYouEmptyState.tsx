...
// Dependencies: [19, 17, 21, 4255, 5921, 4251, 1236, 2]
// Exports: ForYouEmptyState

// Module 15418 (ForYouEmptyState)
import "noop";
...
export const ForYouEmptyState = function ForYouEmptyState(height) {
  ...
  obj = { style: tmp.image, children: callback(require(5921) /* AccountAgeTier10LargeBadge */.MailboxSpotIllustration, { scale: 0.75 }) };
