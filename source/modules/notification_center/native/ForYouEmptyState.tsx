...
// Dependencies: [19, 17, 21, 4302, 5967, 4298, 1236, 2]
// Exports: ForYouEmptyState

// Module 15480 (ForYouEmptyState)
import "noop";
...
export const ForYouEmptyState = function ForYouEmptyState(height) {
  ...
  obj = { style: tmp.image, children: callback(require(5967) /* AccountAgeTier10LargeBadge */.MailboxSpotIllustration, { scale: 0.75 }) };
