...
// Dependencies: [32, 19, 17, 676, 1388, 11893, 21, 4445, 712, 698, 10158, 4441, 1236, 4880, 11894, 5020, 5503, 15027, 6203, 1377, 2]
// Exports: default

// Module 15911 (NotificationCenterBannerImpl)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj[1] = callback4(onDismiss(10158).BellSlashIcon, obj);
  ...
  const items1 = [callback4(onDismiss(4441).Text, obj2), , ];
  ...
  items1[1] = callback4(onDismiss(4441).Text, obj3);
  ...
  obj5[1] = callback4(onDismiss(4880).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(5503).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(5020).PressableHighlight, obj7);
  obj[1] = items;
...
export default function NotificationCenterPermissionNudge() {
  ...
  const canSeePushNotificationNudge = _require(11894).useCanSeePushNotificationNudge();
  const obj2 = _require(11894);
  let prop = null;
  ...
  const tmp5 = callback(_require(6203).useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  _require = tmp6;
  const items = [tmp5[1]];
  const obj3 = _require(6203);
  let tmp8 = null;
