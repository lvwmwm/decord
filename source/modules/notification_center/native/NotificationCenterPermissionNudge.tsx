...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  const items1 = [callback4(onDismiss(4185).Text, obj2), , ];
  ...
  items1[1] = callback4(onDismiss(4185).Text, obj3);
  ...
  obj5[1] = callback4(onDismiss(4600).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(5175).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(4717).PressableHighlight, obj7);
  obj[1] = items;
