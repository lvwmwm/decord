...
// Dependencies: [32, 19, 17, 676, 1388, 11912, 21, 4446, 712, 698, 10176, 4442, 1236, 4893, 11913, 5033, 5516, 15013, 6216, 1377, 2]
// Exports: default

// Module 15929 (NotificationCenterBannerImpl)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj[1] = callback4(onDismiss(10176).BellSlashIcon, obj);
  ...
  const items1 = [callback4(onDismiss(4442).Text, obj2), , ];
  ...
  items1[1] = callback4(onDismiss(4442).Text, obj3);
  ...
  obj5[1] = callback4(onDismiss(4893).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(5516).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(5033).PressableHighlight, obj7);
  obj[1] = items;
...
export default function NotificationCenterPermissionNudge() {
  ...
  const canSeePushNotificationNudge = _require(11913).useCanSeePushNotificationNudge();
  const obj2 = _require(11913);
  let prop = null;
  ...
  const tmp5 = callback(_require(6216).useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  _require = tmp6;
  const items = [tmp5[1]];
  const obj3 = _require(6216);
  let tmp8 = null;
