...
// Dependencies: [32, 19, 17, 676, 1369, 11697, 21, 4285, 712, 698, 9649, 4281, 1236, 4695, 11698, 4827, 5309, 14579, 5943, 1358, 2]
// Exports: default

// Module 15418 (NotificationCenterBannerImpl)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj[1] = callback4(onDismiss(9649).BellSlashIcon, obj);
  ...
  items1[1] = callback4(onDismiss(4281).Text, obj3);
  ...
  obj5[1] = callback4(onDismiss(4695).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(5309).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(4827).PressableHighlight, obj7);
  obj[1] = items;
...
export default function NotificationCenterPermissionNudge() {
  let obj = importDefault(14579);
  const canSeePushNotificationNudge = require(11698) /* _requestPushNotificationPermission */.useCanSeePushNotificationNudge();
  const obj2 = require(11698) /* _requestPushNotificationPermission */;
  let prop = null;
  ...
  const tmp5 = callback(require(5943) /* useSelectedDismissibleContent */.useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  require = tmp6;
  const items = [tmp5[1]];
  const obj3 = require(5943) /* useSelectedDismissibleContent */;
  let tmp8 = null;
