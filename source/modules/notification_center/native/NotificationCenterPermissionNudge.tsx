...
// Dependencies: [32, 19, 17, 676, 1388, 11854, 21, 4342, 712, 698, 9792, 4338, 1236, 4777, 11855, 4909, 5387, 14749, 6086, 1377, 2]
// Exports: default

// Module 15616 (NotificationCenterBannerImpl)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj[1] = callback4(onDismiss(9792).BellSlashIcon, obj);
  ...
  obj5[1] = callback4(onDismiss(4777).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(5387).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(4909).PressableHighlight, obj7);
  obj[1] = items;
...
export default function NotificationCenterPermissionNudge() {
  let obj = importDefault(14749);
  const canSeePushNotificationNudge = require(11855) /* _requestPushNotificationPermission */.useCanSeePushNotificationNudge();
  const obj2 = require(11855) /* _requestPushNotificationPermission */;
  let prop = null;
  ...
  const tmp5 = callback(require(6086) /* useSelectedDismissibleContent */.useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  require = tmp6;
  const items = [tmp5[1]];
  const obj3 = require(6086) /* useSelectedDismissibleContent */;
  let tmp8 = null;
