...
// Dependencies: [32, 19, 17, 676, 1384, 11946, 21, 4448, 712, 698, 10199, 4444, 1236, 4896, 11947, 5036, 5519, 15046, 6219, 1373, 2]
// Exports: default

// Module 15963 (NotificationCenterBannerImpl)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj[1] = callback4(onDismiss(10199).BellSlashIcon, obj);
  ...
  const items1 = [callback4(onDismiss(4444).Text, obj2), , ];
  ...
  items1[1] = callback4(onDismiss(4444).Text, obj3);
  ...
  obj5[1] = callback4(onDismiss(4896).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(5519).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(5036).PressableHighlight, obj7);
  obj[1] = items;
...
export default function NotificationCenterPermissionNudge() {
  ...
  const canSeePushNotificationNudge = _require(11947).useCanSeePushNotificationNudge();
  const obj2 = _require(11947);
  let prop = null;
  ...
  const tmp5 = callback(_require(6219).useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  _require = tmp6;
  const items = [tmp5[1]];
  const obj3 = _require(6219);
  let tmp8 = null;
