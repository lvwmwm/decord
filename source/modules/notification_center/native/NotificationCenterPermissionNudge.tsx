...
// Dependencies: [32, 19, 17, 676, 1369, 11518, 21, 4193, 712, 698, 10241, 4189, 1236, 4604, 11519, 4721, 5179, 14460, 8451, 1358, 2]
// Exports: default
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj[1] = callback4(onDismiss(10241).BellSlashIcon, obj);
  ...
  const items1 = [callback4(onDismiss(4189).Text, obj2), , ];
  ...
  items1[1] = callback4(onDismiss(4189).Text, obj3);
  ...
  obj5[1] = callback4(onDismiss(4604).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(5179).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(4721).PressableHighlight, obj7);
  obj[1] = items;
...
export default function NotificationCenterPermissionNudge() {
  let obj = importDefault(14460);
  const canSeePushNotificationNudge = require(11519) /* _requestPushNotificationPermission */.useCanSeePushNotificationNudge();
  const obj2 = require(11519) /* _requestPushNotificationPermission */;
  let prop = null;
  ...
  const tmp5 = callback(require(8451) /* useSelectedDismissibleContent */.useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  require = tmp6;
  const items = [tmp5[1]];
  const obj3 = require(8451) /* useSelectedDismissibleContent */;
  let tmp8 = null;
