...
// Dependencies: [32, 19, 17, 676, 1369, 11663, 21, 4255, 712, 698, 9618, 4251, 1236, 4665, 11664, 4797, 5255, 14541, 5916, 1358, 2]
// Exports: default

// Module 15380 (NotificationCenterBannerImpl)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj[1] = callback4(onDismiss(9618).BellSlashIcon, obj);
  ...
  obj5[1] = callback4(onDismiss(4665).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(5255).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(4797).PressableHighlight, obj7);
  obj[1] = items;
...
export default function NotificationCenterPermissionNudge() {
  let obj = importDefault(14541);
  const canSeePushNotificationNudge = require(11664) /* _requestPushNotificationPermission */.useCanSeePushNotificationNudge();
  const obj2 = require(11664) /* _requestPushNotificationPermission */;
  let prop = null;
  ...
  const tmp5 = callback(require(5916) /* useSelectedDismissibleContent */.useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  require = tmp6;
  const items = [tmp5[1]];
  const obj3 = require(5916) /* useSelectedDismissibleContent */;
  let tmp8 = null;
