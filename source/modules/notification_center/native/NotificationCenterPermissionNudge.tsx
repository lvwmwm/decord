...
// Dependencies: [32, 19, 17, 676, 1369, 11712, 21, 4302, 712, 698, 9665, 4298, 1236, 4712, 11713, 4844, 5325, 14595, 5962, 1358, 2]
// Exports: default

// Module 15442 (NotificationCenterBannerImpl)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj[1] = callback4(onDismiss(9665).BellSlashIcon, obj);
  ...
  const items1 = [callback4(onDismiss(4298).Text, obj2), , ];
  ...
  items1[1] = callback4(onDismiss(4298).Text, obj3);
  ...
  obj5[1] = callback4(onDismiss(4712).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(5325).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(4844).PressableHighlight, obj7);
  obj[1] = items;
...
export default function NotificationCenterPermissionNudge() {
  let obj = importDefault(14595);
  const canSeePushNotificationNudge = require(11713) /* _requestPushNotificationPermission */.useCanSeePushNotificationNudge();
  const obj2 = require(11713) /* _requestPushNotificationPermission */;
  let prop = null;
  ...
  const tmp5 = callback(require(5962) /* useSelectedDismissibleContent */.useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  require = tmp6;
  const items = [tmp5[1]];
  const obj3 = require(5962) /* useSelectedDismissibleContent */;
  let tmp8 = null;
