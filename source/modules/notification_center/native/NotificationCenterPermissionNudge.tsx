...
// Dependencies: [32, 19, 17, 676, 1369, 11778, 21, 4303, 712, 698, 9730, 4299, 1236, 4714, 11779, 4846, 5326, 14665, 6022, 1358, 2]
// Exports: default

// Module 15517 (NotificationCenterBannerImpl)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj[1] = callback4(onDismiss(9730).BellSlashIcon, obj);
  ...
  const items1 = [callback4(onDismiss(4299).Text, obj2), , ];
  ...
  items1[1] = callback4(onDismiss(4299).Text, obj3);
  ...
  obj5[1] = callback4(onDismiss(4714).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(5326).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(4846).PressableHighlight, obj7);
  obj[1] = items;
...
export default function NotificationCenterPermissionNudge() {
  let obj = importDefault(14665);
  const canSeePushNotificationNudge = require(11779) /* _requestPushNotificationPermission */.useCanSeePushNotificationNudge();
  const obj2 = require(11779) /* _requestPushNotificationPermission */;
  let prop = null;
  ...
  const tmp5 = callback(require(6022) /* useSelectedDismissibleContent */.useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  require = tmp6;
  const items = [tmp5[1]];
  const obj3 = require(6022) /* useSelectedDismissibleContent */;
  let tmp8 = null;
