...
// Dependencies: [32, 19, 17, 676, 1388, 11582, 21, 4661, 712, 698, 10001, 4734, 1236, 4745, 11583, 5433, 6368, 14789, 7366, 1377, 2]
// Exports: default
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj5[1] = callback4(onDismiss(4745).Button, obj6);
  ...
  obj7[4] = callback4(onDismiss(6368).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = callback4(onDismiss(5433).PressableHighlight, obj7);
  obj[1] = items;
...
export default function NotificationCenterPermissionNudge() {
  let obj = importDefault(14789);
  const canSeePushNotificationNudge = require(11583) /* _requestPushNotificationPermission */.useCanSeePushNotificationNudge();
  const obj2 = require(11583) /* _requestPushNotificationPermission */;
  let prop = null;
  ...
  const tmp5 = callback(require(7366) /* useSelectedDismissibleContent */.useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  require = tmp6;
  const items = [tmp5[1]];
  const obj3 = require(7366) /* useSelectedDismissibleContent */;
  let tmp8 = null;
