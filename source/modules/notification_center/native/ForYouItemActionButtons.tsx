...
// Function ID: 15781
// Name: focusChatInput
// Dependencies: [5, 19, 17, 1391, 1922, 676, 21, 4380, 1231, 4120, 4381, 4813, 4815, 1236, 4376, 647, 8236, 15403, 4360, 13403, 9782, 7246, 4393, 9391, 4098, 11217, 698, 2]
// Exports: ForYouItemActionButtons, useItemActionButtonPropsV2

// Module 15780 (focusChatInput)
  ...
  constructor(arg0) {
    ...
    class I {
      constructor() {
        ...
        Easing = require("module_4120").Easing;
        obj2[1] = Easing.inOut(require("module_4120").Easing.quad);
    ...
    obj2 = { withDelay: require("module_4120").withDelay, withRepeat: require("module_4120").withRepeat, withTiming: require("CONFIG_NEVER_ANIMATE_TIMING").withTiming, pressed, Easing: require("module_4120").Easing, waveWidth: sharedValue2, waveHeight: sharedValue3 };
    I.__closure = obj2;
    I.__workletHash = 498167545082;
    I.__initData = closure_20;
    animatedStyle3 = obj10.useAnimatedStyle(I);
    obj12 = require("module_4120");
    fn3 = function p() {
    ...
    items2 = [, ];
    items2[0] = tmp15(require("module_4120").View, obj3);
    obj8 = {
    ...
    obj10[3] = tmp15(require("module_4120").View, obj11);
    obj9[2] = tmp15(require("module_4120").View, obj10);
    if (compactMode) {
      str = "sm";
    }
    obj12 = { children: null };
    ...
    items2[1] = tmp15(require("module_4120").View, obj8);
    obj12[0] = items2;
