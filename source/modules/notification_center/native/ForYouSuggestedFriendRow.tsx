...
// Dependencies: [19, 17, 4277, 3922, 676, 21, 4285, 9711, 712, 500, 5610, 4701, 647, 8705, 1959, 4124, 15074, 1236, 4146, 15430, 4812, 15431, 1297, 4281, 15432, 15433, 698, 2]
// Exports: default

// Module 15429 (ForYouSuggestedFriendRow)
...
export default function ForYouSuggestedFriendRow(suggestedFriend) {
  ...
  if (null != suggestedFriend.friendSuggestionName) {
    ...
    if (null != suggestedFriend.mutualFriendsCount) {
      ...
      return tmpResult2.renderChannelPressableWrapper(callback(tmp(4812).PressableHighlight, obj), obj12);
    }
    let tmp5Result = tmp5(4124);
