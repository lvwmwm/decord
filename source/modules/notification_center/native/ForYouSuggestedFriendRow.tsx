...
// Dependencies: [19, 17, 4294, 3938, 676, 21, 4302, 9729, 712, 500, 5668, 4718, 647, 8723, 1988, 4140, 15107, 1236, 4162, 15472, 4844, 15473, 1297, 4298, 15474, 15475, 698, 2]
// Exports: default

// Module 15471 (ForYouSuggestedFriendRow)
...
let closure_12 = createCacheKey.createStyles((layout) => {
  ...
  let obj1 = require(9729) /* getLayoutStyles */;
...
export default function ForYouSuggestedFriendRow(suggestedFriend) {
  ...
  let obj1 = suggestedFriend(9729);
  const layoutStyles = obj1.getLayoutStyles(messagesTabLayout);
  let obj2 = suggestedFriend(4718);
  ...
  if (null != suggestedFriend.friendSuggestionName) {
    ...
    if (null != suggestedFriend.mutualFriendsCount) {
      ...
      items4[1] = obj1;
      obj[3] = items4;
      const tmpResult2 = tmp(15472);
      obj2 = { style: null, children: null };
      obj2[0] = tmp4.avatar;
      obj3 = { user: null, guildId: "r", size: "K\u00F6rperteil", animate: "Nase" };
      ...
      const items6 = [callback(tmp(4298).Text, obj5), ];
      const tmp20 = closure_11;
      const tmpResult3 = tmp(15473);
      let num3 = 0;
      ...
      obj6[1] = callback(tmp(15474).ActionStatusSubLabel, obj8);
      ...
      items5[2] = callback(tmp(15475).ContactSuggestionActions, obj9);
      obj10[0] = items5;
      ...
      return tmpResult2.renderChannelPressableWrapper(callback(tmp(4844).PressableHighlight, obj), obj12);
    }
    let tmp5Result = tmp5(4140);
    formatToPlainStringResult = tmp5Result.getName(suggestedFriend.user);
  }
  tmp5Result = tmp5(4140);
