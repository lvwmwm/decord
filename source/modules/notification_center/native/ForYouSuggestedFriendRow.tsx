...
// Dependencies: [19, 17, 4295, 3938, 676, 21, 4303, 9796, 712, 500, 5728, 4720, 647, 8783, 1988, 4146, 15179, 1236, 4036, 15555, 4846, 15556, 1297, 4299, 15557, 15558, 698, 2]
// Exports: default

// Module 15554 (ForYouSuggestedFriendRow)
...
export default function ForYouSuggestedFriendRow(suggestedFriend) {
  ...
  if (null != suggestedFriend.friendSuggestionName) {
    ...
    if (null != suggestedFriend.mutualFriendsCount) {
      ...
      obj6[1] = callback(tmp(15557).ActionStatusSubLabel, obj8);
      ...
      items5[2] = callback(tmp(15558).ContactSuggestionActions, obj9);
      obj10[0] = items5;
