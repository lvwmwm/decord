...
// Dependencies: [19, 17, 4334, 3998, 676, 21, 4342, 9845, 712, 500, 5768, 4761, 647, 8832, 2007, 4187, 15254, 1236, 4083, 15637, 4887, 15638, 1297, 4338, 15639, 15640, 698, 2]
// Exports: default

// Module 15636 (ForYouSuggestedFriendRow)
...
export default function ForYouSuggestedFriendRow(suggestedFriend) {
  ...
  let obj1 = suggestedFriend(9845);
  const layoutStyles = obj1.getLayoutStyles(messagesTabLayout);
  let obj2 = suggestedFriend(4761);
  ...
  if (null != suggestedFriend.friendSuggestionName) {
    ...
    if (null != suggestedFriend.mutualFriendsCount) {
      ...
      obj6[1] = callback(tmp(15639).ActionStatusSubLabel, obj8);
      ...
      items5[2] = callback(tmp(15640).ContactSuggestionActions, obj9);
      obj10[0] = items5;
      ...
      return tmpResult2.renderChannelPressableWrapper(callback(tmp(4887).PressableHighlight, obj), obj12);
    }
