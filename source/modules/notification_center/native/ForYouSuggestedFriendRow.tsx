...
// Dependencies: [19, 17, 4336, 3998, 676, 21, 4344, 9842, 712, 500, 5767, 4760, 647, 8828, 2007, 4189, 15245, 1236, 4083, 15628, 4886, 15629, 1297, 4340, 15630, 15631, 698, 2]
// Exports: default

// Module 15627 (ForYouSuggestedFriendRow)
...
let closure_12 = createCacheKey.createStyles((layout) => {
  ...
  let obj1 = require(9842) /* getLayoutStyles */;
...
export default function ForYouSuggestedFriendRow(suggestedFriend) {
  ...
  let obj1 = suggestedFriend(9842);
  const layoutStyles = obj1.getLayoutStyles(messagesTabLayout);
  let obj2 = suggestedFriend(4760);
  ...
  if (null != suggestedFriend.friendSuggestionName) {
    ...
    if (null != suggestedFriend.mutualFriendsCount) {
      ...
      const items6 = [callback(tmp(4340).Text, obj5), ];
      const tmp20 = closure_11;
      const tmpResult3 = tmp(15629);
      let num3 = 0;
      ...
      obj6[1] = callback(tmp(15630).ActionStatusSubLabel, obj8);
      ...
      items5[2] = callback(tmp(15631).ContactSuggestionActions, obj9);
      obj10[0] = items5;
      ...
      return tmpResult2.renderChannelPressableWrapper(callback(tmp(4886).PressableHighlight, obj), obj12);
    }
    let tmp5Result = tmp5(4189);
    formatToPlainStringResult = tmp5Result.getName(suggestedFriend.user);
  }
  tmp5Result = tmp5(4189);
