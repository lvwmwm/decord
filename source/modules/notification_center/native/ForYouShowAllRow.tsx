...
// Dependencies: [19, 17, 676, 11938, 21, 4255, 9682, 712, 500, 1480, 698, 1297, 4671, 15410, 4797, 15411, 13307, 4251, 1236, 5309, 2]
// Exports: ForYouSuggestedFriendShowAllRow

// Module 15415 (ForYouShowAllRow)
...
function ForYouShowAllRow(panelVariant) {
  ...
  let obj2 = require(4671) /* getFontScale */;
  const fontScale = obj2.useFontScale();
  let obj3 = require(15410) /* renderChannelPressableWrapper */;
  ...
  let obj5 = require(15411) /* renderChannelWrapper */;
  obj = { style: tmp4.avatar, children: null };
  const obj8 = require(9682) /* getLayoutStyles */;
  const tmp8 = closure_9;
  const tmp9 = closure_8;
  const AvatarSizes = require(1297) /* Button */.AvatarSizes;
  obj1 = { children: null };
  obj2 = { size: require(9682) /* getLayoutStyles */.isLayoutCompact(layout) ? AvatarSizes.XSMALL_20 : AvatarSizes.SMALL, "aria-label": "", children };
  obj[1] = closure_7(require(13307) /* AvatarDuoPile */.AvatarDuoPile, obj2);
  ...
  return obj3.renderChannelPressableWrapper(closure_7(require(4797) /* PressableBase */.PressableHighlight, obj), { layout, panelVariant });
}
