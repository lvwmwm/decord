...
// Dependencies: [19, 17, 676, 12135, 21, 4342, 9856, 712, 500, 1499, 698, 1297, 4783, 15646, 4909, 15647, 13509, 4338, 1236, 5444, 2]
// Exports: ForYouSuggestedFriendShowAllRow

// Module 15651 (ForYouShowAllRow)
...
function ForYouShowAllRow(panelVariant) {
  ...
  let obj2 = require(4783) /* getFontScale */;
  const fontScale = obj2.useFontScale();
  let obj3 = require(15646) /* renderChannelPressableWrapper */;
  ...
  let obj5 = require(15647) /* renderChannelWrapper */;
  obj = { style: tmp4.avatar, children: null };
  const obj8 = require(9856) /* getLayoutStyles */;
  const tmp8 = closure_9;
  const tmp9 = closure_8;
  const AvatarSizes = require(1297) /* Button */.AvatarSizes;
  obj1 = { children: null };
  obj2 = { size: require(9856) /* getLayoutStyles */.isLayoutCompact(layout) ? AvatarSizes.XSMALL_20 : AvatarSizes.SMALL, "aria-label": "", children };
  obj[1] = closure_7(require(13509) /* AvatarDuoPile */.AvatarDuoPile, obj2);
  ...
  return obj3.renderChannelPressableWrapper(closure_7(require(4909) /* PressableBase */.PressableHighlight, obj), { layout, panelVariant });
}
