...
// Dependencies: [19, 17, 676, 11972, 21, 4285, 9713, 712, 500, 1480, 698, 1297, 4701, 15448, 4827, 15449, 13344, 4281, 1236, 5363, 2]
// Exports: ForYouSuggestedFriendShowAllRow

// Module 15453 (ForYouShowAllRow)
...
function ForYouShowAllRow(panelVariant) {
  ...
  let obj5 = require(15449) /* renderChannelWrapper */;
  obj = { style: tmp4.avatar, children: null };
  const obj8 = require(9713) /* getLayoutStyles */;
  const tmp8 = closure_9;
  const tmp9 = closure_8;
  const AvatarSizes = require(1297) /* Button */.AvatarSizes;
  obj1 = { children: null };
  obj2 = { size: require(9713) /* getLayoutStyles */.isLayoutCompact(layout) ? AvatarSizes.XSMALL_20 : AvatarSizes.SMALL, "aria-label": "", children };
  obj[1] = closure_7(require(13344) /* AvatarDuoPile */.AvatarDuoPile, obj2);
  ...
  return obj3.renderChannelPressableWrapper(closure_7(require(4827) /* PressableBase */.PressableHighlight, obj), { layout, panelVariant });
}
