...
// Dependencies: [19, 17, 676, 12053, 21, 4303, 9795, 712, 500, 1480, 698, 1297, 4720, 15547, 4846, 15548, 13428, 4299, 1236, 5383, 2]
// Exports: ForYouSuggestedFriendShowAllRow

// Module 15552 (ForYouShowAllRow)
...
function ForYouShowAllRow(panelVariant) {
  ...
  let obj3 = require(15547) /* renderChannelPressableWrapper */;
  ...
  let obj5 = require(15548) /* renderChannelWrapper */;
  obj = { style: tmp4.avatar, children: null };
  const obj8 = require(9795) /* getLayoutStyles */;
  const tmp8 = closure_9;
  const tmp9 = closure_8;
  const AvatarSizes = require(1297) /* Button */.AvatarSizes;
  obj1 = { children: null };
  obj2 = { size: require(9795) /* getLayoutStyles */.isLayoutCompact(layout) ? AvatarSizes.XSMALL_20 : AvatarSizes.SMALL, "aria-label": "", children };
  obj[1] = closure_7(require(13428) /* AvatarDuoPile */.AvatarDuoPile, obj2);
