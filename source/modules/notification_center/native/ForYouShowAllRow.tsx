...
// Dependencies: [19, 17, 676, 11987, 21, 4302, 9729, 712, 500, 1480, 698, 1297, 4718, 15472, 4844, 15473, 13358, 4298, 1236, 5382, 2]
// Exports: ForYouSuggestedFriendShowAllRow

// Module 15477 (ForYouShowAllRow)
...
function ForYouShowAllRow(panelVariant) {
  ...
  let obj2 = require(4718) /* getFontScale */;
  const fontScale = obj2.useFontScale();
  let obj3 = require(15472) /* renderChannelPressableWrapper */;
  ...
  let obj5 = require(15473) /* renderChannelWrapper */;
  obj = { style: tmp4.avatar, children: null };
  const obj8 = require(9729) /* getLayoutStyles */;
  const tmp8 = closure_9;
  const tmp9 = closure_8;
  const AvatarSizes = require(1297) /* Button */.AvatarSizes;
  obj1 = { children: null };
  obj2 = { size: require(9729) /* getLayoutStyles */.isLayoutCompact(layout) ? AvatarSizes.XSMALL_20 : AvatarSizes.SMALL, "aria-label": "", children };
  obj[1] = closure_7(require(13358) /* AvatarDuoPile */.AvatarDuoPile, obj2);
  ...
  obj3[1] = closure_7(require(4298) /* Text */.Text, obj4);
  ...
  return obj3.renderChannelPressableWrapper(closure_7(require(4844) /* PressableBase */.PressableHighlight, obj), { layout, panelVariant });
}
