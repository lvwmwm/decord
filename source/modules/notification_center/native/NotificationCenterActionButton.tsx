...
// Dependencies: [19, 21, 7792, 8650, 4312, 15595, 2007, 1236, 2]
// Exports: default

// Module 15594 (NotificationCenterActionButton)
import "noop";
...
export default function NotificationCenterActionButton() {
  ...
  return jsx(require(7792) /* IconButton */.IconButton, { variant: "tertiary", size: "sm", icon: null, onPress: null, accessibilityLabel: null, maxFontSizeMultiplier: 2 });
};
