...
// Dependencies: [19, 21, 6679, 8960, 4157, 15271, 1959, 1236, 2]
// Exports: default

// Module 15270 (NotificationCenterActionButton)
import "noop";
...
export default function NotificationCenterActionButton() {
  ...
  return jsx(require(6679) /* IconButton */.IconButton, { variant: "tertiary", size: "sm", icon: null, onPress: null, accessibilityLabel: null, maxFontSizeMultiplier: 2 });
};
