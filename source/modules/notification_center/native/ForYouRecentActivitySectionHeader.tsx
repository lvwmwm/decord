...
// Module 15624 (ForYouRecentActivitySectionHeader)
import "noop";
...
export const ForYouRecentActivitySectionHeader = function ForYouRecentActivitySectionHeader() {
  ...
  obj[1] = jsx(require(4340) /* Text */.Text, { style: tmp.textHeader, color: "text-muted", variant: "text-sm/semibold", accessibilityRole: "header", children: null });
