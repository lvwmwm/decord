...
// Module 15633 (ForYouRecentActivitySectionHeader)
import "noop";
...
export const ForYouRecentActivitySectionHeader = function ForYouRecentActivitySectionHeader() {
  ...
  obj[1] = jsx(require(4338) /* Text */.Text, { style: tmp.textHeader, color: "text-muted", variant: "text-sm/semibold", accessibilityRole: "header", children: null });
