...
// Function ID: 116418
// Name: createItem
// Dependencies: [31, 8108, 6104, 566, 8123, 2]
// Exports: default

// Module 15270 (createItem)
...
function createItem(id, type, unread) {
  ...
  if (require(6104) /* MessageEmbedTypes */.ICYMIItemTypes.MESSAGE === type) {
    ...
    if (require(6104) /* MessageEmbedTypes */.ICYMIItemTypes.ACTIVITY !== type) {
      if (require(6104) /* MessageEmbedTypes */.ICYMIItemTypes.CUSTOM_STATUS !== type) {
        if (require(6104) /* MessageEmbedTypes */.ICYMIItemTypes.GUILD_EVENT === type) {
          const obj3 = { id: id.id };
          const _Date2 = Date;
    ...
    while (num < stateFromStores2) {
      ...
      if (!stateFromStores3[tmp35.id]) {
        ...
        if (tmp8) {
          ...
          tmp8 = tmp35.type === stateFromStores1(6104).ICYMIItemTypes.MESSAGE;
        }
        if (tmp8) {
    ...
    while (num3 < stateFromStores2) {
      ...
      if (!stateFromStores3[tmp37.id]) {
        ...
        if (tmp23) {
          ...
          tmp23 = tmp37.type === stateFromStores1(6104).ICYMIItemTypes.MESSAGE;
        }
        if (tmp23) {
