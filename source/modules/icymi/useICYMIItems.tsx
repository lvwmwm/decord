...
// Function ID: 16411
// Name: createItem
// Dependencies: [19, 8265, 8278, 586, 8281, 2]
// Exports: default

// Module 16410 (createItem)
...
function createItem(id, type, arg2) {
  ...
  if (MessageEmbedTypes.ICYMIItemTypes.MESSAGE === type) {
    ...
    if (tmp(8278).ICYMIItemTypes.ACTIVITY !== type) {
      if (tmp(8278).ICYMIItemTypes.CUSTOM_STATUS !== type) {
        if (tmp(8278).ICYMIItemTypes.GUILD_EVENT === type) {
          ...
          obj3[5] = arg2;
          return obj3;
        } else if (tmp(8278).ICYMIItemTypes.RECOMMENDED_GUILDS === type) {
      ...
      while (true) {
        ...
        if (!stateFromStores3[tmp6.id]) {
          ...
          if (tmp10) {
            ...
            tmp10 = tmp6.type === stateFromStores1(8278).ICYMIItemTypes.MESSAGE;
          }
          if (tmp10) {
      ...
      while (true) {
        ...
        if (!stateFromStores3[tmp19.id]) {
          ...
          if (tmp23) {
            ...
            tmp23 = tmp19.type === stateFromStores1(8278).ICYMIItemTypes.MESSAGE;
          }
          if (tmp23) {
