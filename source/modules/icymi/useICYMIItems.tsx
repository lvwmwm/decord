...
// Function ID: 15351
// Name: createItem
// Dependencies: [19, 8167, 6154, 589, 8182, 2]
// Exports: default

// Module 15350 (createItem)
...
function createItem(id, type, arg2) {
  type = type.type;
  if (require(6154) /* MessageEmbedTypes */.ICYMIItemTypes.MESSAGE === type) {
    ...
    if (tmp(6154).ICYMIItemTypes.ACTIVITY !== type) {
      if (tmp(6154).ICYMIItemTypes.CUSTOM_STATUS !== type) {
        if (tmp(6154).ICYMIItemTypes.GUILD_EVENT === type) {
          ...
          obj3[5] = arg2;
          return obj3;
        } else if (tmp(6154).ICYMIItemTypes.RECOMMENDED_GUILDS === type) {
      ...
      while (true) {
        ...
        if (!stateFromStores3[tmp6.id]) {
          ...
          if (tmp10) {
            ...
            tmp10 = tmp6.type === stateFromStores1(6154).ICYMIItemTypes.MESSAGE;
          }
          if (tmp10) {
      ...
      while (true) {
        ...
        if (!stateFromStores3[tmp19.id]) {
          ...
          if (tmp23) {
            ...
            tmp23 = tmp19.type === stateFromStores1(6154).ICYMIItemTypes.MESSAGE;
          }
          if (tmp23) {
