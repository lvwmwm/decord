...
// Function ID: 13988
// Name: map
// Dependencies: [4359, 1212, 8570, 1218, 8552, 514, 8576, 589, 709, 2]
...
import DEFAULT_UX_VARIATION2 from "DEFAULT_UX_VARIATION" /* 8576 */;
import closure_2 from "getHash" /* 4359 */;
import closure_3 from "initialize" /* 1212 */;
import closure_4 from "getUserAgnosticState" /* 8570 */;
...
prototype["trackItemsLongImpression"] = function trackItemsLongImpression(items) {
  ...
  while (iter !== undefined) {
    ...
    if (uxVariation == null) {
      uxVariation = tmp11(8576).DEFAULT_UX_VARIATION;
    }
    obj[15] = uxVariation;
    let tmp20 = result;
...
prototype["_endImpression"] = function _endImpression(itemId) {
  ...
  if (null != this._activeItems[findIndexResult]) {
    ...
    const ICYMIAnalytics = _require(8576).ICYMIAnalytics;
    ...
    if (DEFAULT_UX_VARIATION == null) {
      DEFAULT_UX_VARIATION = tmp5(8576).DEFAULT_UX_VARIATION;
    }
