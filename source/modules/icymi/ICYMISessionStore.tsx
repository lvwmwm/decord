...
// Function ID: 13581
// Name: map
// Dependencies: [4199, 1212, 8837, 1218, 8820, 514, 8843, 589, 709, 2]
...
prototype["trackItemsLongImpression"] = function trackItemsLongImpression(items) {
  ...
  while (iter !== undefined) {
    ...
    let ICYMIAnalytics = require(8843) /* DEFAULT_UX_VARIATION */.ICYMIAnalytics;
    ...
    if (uxVariation == null) {
      uxVariation = tmp11(8843).DEFAULT_UX_VARIATION;
    }
    obj[15] = uxVariation;
    let tmp20 = result;
...
prototype["trackItemInteraction"] = function trackItemInteraction(id, type, actionType) {
  ...
  const ICYMIAnalytics = require(8843) /* DEFAULT_UX_VARIATION */.ICYMIAnalytics;
  ...
  if (uxVariation == null) {
    uxVariation = require(8843) /* DEFAULT_UX_VARIATION */.DEFAULT_UX_VARIATION;
  }
  obj[4] = uxVariation;
...
prototype["trackFeedPageActioned"] = function trackFeedPageActioned(arg0) {
  ...
  const merged = Object.assign(arg0);
  const result = ICYMIAnalytics.trackFeedPageActioned({ icymiSessionId: this._sessionId, uxVariation: require(8843) /* DEFAULT_UX_VARIATION */.DEFAULT_UX_VARIATION, sessionActionIndex: sum });
};
...
prototype["_constructImpressionFromInput"] = function _constructImpressionFromInput(itemId) {
  ...
  obj[10] = value;
  obj[11] = require(8843) /* DEFAULT_UX_VARIATION */.DEFAULT_UX_VARIATION;
  obj[12] = [];
  return obj;
};
prototype["_endImpression"] = function _endImpression(itemId) {
  ...
  if (null != this._activeItems[findIndexResult]) {
    ...
    const ICYMIAnalytics = _require(8843).ICYMIAnalytics;
    ...
    if (DEFAULT_UX_VARIATION == null) {
      DEFAULT_UX_VARIATION = tmp5(8843).DEFAULT_UX_VARIATION;
    }
