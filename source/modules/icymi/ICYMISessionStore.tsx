...
// Function ID: 13740
// Name: map
// Dependencies: [4258, 1212, 8960, 1218, 8943, 514, 8966, 589, 709, 2]
...
prototype["trackItemsLongImpression"] = function trackItemsLongImpression(items) {
  ...
  while (iter !== undefined) {
    ...
    let ICYMIAnalytics = require(8966) /* DEFAULT_UX_VARIATION */.ICYMIAnalytics;
    ...
    if (uxVariation == null) {
      uxVariation = tmp11(8966).DEFAULT_UX_VARIATION;
    }
    obj[15] = uxVariation;
    let tmp20 = result;
...
prototype["trackItemInteraction"] = function trackItemInteraction(id, type, actionType) {
  ...
  const ICYMIAnalytics = require(8966) /* DEFAULT_UX_VARIATION */.ICYMIAnalytics;
  ...
  if (uxVariation == null) {
    uxVariation = require(8966) /* DEFAULT_UX_VARIATION */.DEFAULT_UX_VARIATION;
  }
  obj[4] = uxVariation;
...
prototype["trackFeedPageActioned"] = function trackFeedPageActioned(arg0) {
  ...
  const merged = Object.assign(arg0);
  const result = ICYMIAnalytics.trackFeedPageActioned({ icymiSessionId: this._sessionId, uxVariation: require(8966) /* DEFAULT_UX_VARIATION */.DEFAULT_UX_VARIATION, sessionActionIndex: sum });
};
...
prototype["_constructImpressionFromInput"] = function _constructImpressionFromInput(itemId) {
  ...
  obj[10] = value;
  obj[11] = require(8966) /* DEFAULT_UX_VARIATION */.DEFAULT_UX_VARIATION;
  obj[12] = [];
  return obj;
};
prototype["_endImpression"] = function _endImpression(itemId) {
  ...
  if (null != this._activeItems[findIndexResult]) {
    ...
    const ICYMIAnalytics = _require(8966).ICYMIAnalytics;
    ...
    if (DEFAULT_UX_VARIATION == null) {
      DEFAULT_UX_VARIATION = tmp5(8966).DEFAULT_UX_VARIATION;
    }
