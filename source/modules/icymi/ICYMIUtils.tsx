...
// Dependencies: [5, 6985, 1376, 1372, 1891, 4521, 4315, 8898, 8911, 676, 7304, 8913, 4523, 11, 589, 8914, 8918, 8234, 8919, 8405, 1236, 5253, 1988, 676, 2]
...
// Module 8912 (generateHydrationId)
...
export const isGuildItem = function isGuildItem(type) {
  let tmp3 = type.type === require(7304) /* MessageEmbedTypes */.ICYMIItemTypes.MESSAGE;
  if (!tmp3) {
    tmp3 = type.type === require(7304) /* MessageEmbedTypes */.ICYMIItemTypes.GUILD_EVENT;
  }
  return tmp3;
};
...
export const icymiEnabled = function icymiEnabled(customScores) {
  return require(8914) /* apexExperiment */.getICYMIEnabled(customScores);
};
export const customStatusToContentInventoryEntry = function customStatusToContentInventoryEntry(data) {
  let obj = { id: data.id, type: require(7304) /* MessageEmbedTypes */.ICYMIItemTypes.CUSTOM_STATUS, activity: null, score: null, score_components: null };
  obj = { id: data.id, author_id: data.data.user_id, author_type: require(8918) /* ContentInventoryAuthorType */.ContentInventoryAuthorType.USER, traits: [], participants: [], content_type: require(8234) /* ContentInventoryEntryType */.ContentInventoryEntryType.CUSTOM_STATUS, extra: null };
...
export const itemToType = function itemToType(item) {
  ...
  if ("end" === kind) {
    ...
    if ("message" === kind) {
      ...
      if (item.data.content.content_type === require(8234) /* ContentInventoryEntryType */.ContentInventoryEntryType.CUSTOM_STATUS) {
...
export const determineContentType = function determineContentType(channel, message) {
  if (channel.type === constants.GUILD_ANNOUNCEMENT) {
    return require(7304) /* MessageEmbedTypes */.ContentType.ANNOUNCEMENT;
  } else if (channel.type === tmp.GUILD_FORUM) {
    return require(7304) /* MessageEmbedTypes */.ContentType.FORUM_POST;
  } else {
    if (null != message.reactions) {
      ...
      if (0 !== mapped.length) {
        if (mapped.reduce((arg0, arg1) => arg0 + arg1) > 10) {
          return require(7304) /* MessageEmbedTypes */.ContentType.POPULAR_MESSAGE;
        }
      }
    }
    if (message.attachments.length > 0) {
      ...
      obj = require(8405) /* isMediaAttachment */;
    } else {
      if (message.embeds.length > 0) {
        let INTERESTING = require(7304) /* MessageEmbedTypes */.ContentType.LINK;
      } else {
        INTERESTING = require(7304) /* MessageEmbedTypes */.ContentType.INTERESTING;
      }
      return INTERESTING;
    }
  }
...
export const contentTypeToText = function contentTypeToText(arg0) {
  ...
  if (require(7304) /* MessageEmbedTypes */.ContentType.POPULAR_MESSAGE === arg0) {
