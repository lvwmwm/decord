...
// Dependencies: [32, 8793, 4169, 6879, 1218, 1372, 8802, 1862, 4472, 3883, 4267, 3892, 4450, 8804, 8805, 676, 8814, 687, 8806, 7198, 8016, 8020, 8798, 8815, 5850, 4474, 589, 709, 2]

// Module 8792 (filterStaffGuild)
...
function filterStaffGuild(data) {
  if (closure_19.filterStaffContent()) {
    if (obj.isGuildItem(data)) {
      if (data.data.guild_id === require(7198) /* MessageEmbedTypes */.GAME_CONTENT_GUILD_ID) {
        return true;
      } else {
...
function injectRecommendedGuildsRow() {
  ...
  if (0 !== length.length) {
    ...
    obj[1] = require(7198) /* MessageEmbedTypes */.ICYMIItemTypes.RECOMMENDED_GUILDS;
...
function getNewUnreadItems(arr9, channelId) {
  ...
  while (iter !== undefined) {
    ...
    let tmp3 = require;
    let tmp4 = dependencyMap;
    if (nextResult.type !== require(7198) /* MessageEmbedTypes */.ICYMIItemTypes.RECOMMENDED_GUILDS) {
...
function maybeFilterChannelItems(arg0, stateFromStores1) {
  const obj = _require(8806);
  if (numberToCustomScoreResult === _require(8806).ICYMICustomScore.MUTED) {
    _require = arg0;
...
function handleReaction(colors) {
  ...
  if (null == dependencyMap[colors.messageId]) {
    return false;
  } else if (tmp3.type !== require(7198) /* MessageEmbedTypes */.ICYMIItemTypes.MESSAGE) {
    return false;
  } else {
...
prototype["getMessage"] = function getMessage(arg0) {
  ...
  if (null != dependencyMap[arg0]) {
    message = null;
    if (tmp.type === require(7198) /* MessageEmbedTypes */.ICYMIItemTypes.MESSAGE) {
      message = tmp.message;
    }
  }
  return message;
...
prototype["customMuted"] = function customMuted(id, id) {
  ...
  let tmp4 = customGuildScore === require(8806) /* generateHydrationId */.ICYMICustomScore.MUTED;
  if (!tmp4) {
    const customChannelScore = self.getCustomChannelScore(id, id);
    tmp4 = customChannelScore === require(8806) /* generateHydrationId */.ICYMICustomScore.MUTED;
  }
  return tmp4;
};
prototype["getCustomChannelScore"] = function getCustomChannelScore(guild_id, id) {
  if (null != dependencyMap2[guild_id]) {
    if (null != dependencyMap2[guild_id][id]) {
      let UNKNOWN = require(8806) /* generateHydrationId */.numberToCustomScore(dependencyMap2[guild_id][id]);
      const obj = require(8806) /* generateHydrationId */;
    }
    return UNKNOWN;
  }
  UNKNOWN = require(8806) /* generateHydrationId */.ICYMICustomScore.UNKNOWN;
};
...
const iCYMIStore = new ICYMIStore(require("dispatcher"), {
  ...
  LOAD_ICYMI_HYDRATED: function handleLoadHydratedItems(arg0) {
    ...
    set.delete(_require(8806).generateHydrationId(startingIndex, endingIndex));
  },
  ...
  MESSAGE_REACTION_ADD_MANY: function handleReactionBatch(arg0) {
    if (null == dependencyMap[arg0.messageId]) {
      return false;
    } else if (tmp2.type !== require(7198) /* MessageEmbedTypes */.ICYMIItemTypes.MESSAGE) {
      return false;
    } else {
  ...
  MESSAGE_REACTION_REMOVE_ALL: function handleRemoveAllReactions(arg0) {
    let tmp2 = null != tmp;
    if (tmp2) {
      const tmp5 = tmp.type === require(7198) /* MessageEmbedTypes */.ICYMIItemTypes.MESSAGE;
      if (tmp5) {
  ...
  MESSAGE_REACTION_REMOVE_EMOJI: function handleRemoveEmojiReactions(arg0) {
    let tmp3 = null != tmp2;
    if (tmp3) {
      const tmp6 = tmp2.type === require(7198) /* MessageEmbedTypes */.ICYMIItemTypes.MESSAGE;
      if (tmp6) {
        const message = tmp2.message;
