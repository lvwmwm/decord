...
// Dependencies: [32, 19, 17, 4480, 8821, 21, 4285, 712, 8835, 1236, 1297, 15468, 15469, 15470, 8879, 9064, 589, 15471, 4281, 5689, 4475, 2]
// Exports: ChannelScoreSettings, GuildScoreSettings

// Module 15467 (ContentSettingsControl)
import _slicedToArray from "_slicedToArray";
import TableSwitchRow from "TableSwitchRow";
import { View } from "module_15471";
...
function ContentSettingsControl(initialValue) {
  ...
  obj[0] = importDefault(15468);
  const items = [tmp.icon, ];
  let iconSelected = null;
  if (tmp3 === require(8835) /* generateHydrationId */.ICYMICustomScore.LESS) {
  ...
  obj1[0] = importDefault(15469);
  const items2 = [tmp.icon, ];
  let iconSelected1 = null;
  if (tmp3 === require(8835) /* generateHydrationId */.ICYMICustomScore.DEFAULT) {
  ...
  obj3[0] = importDefault(15470);
  const items3 = [tmp.icon, ];
  let iconSelected2 = null;
  if (tmp3 === require(8835) /* generateHydrationId */.ICYMICustomScore.MORE) {
  ...
  let num = 0;
  if (require(8835) /* generateHydrationId */.ICYMICustomScore.LESS !== tmp3) {
    num = 1;
    if (tmp4(8835).ICYMICustomScore.MORE === tmp3) {
      num = 2;
    }
  }
  obj4[3] = num;
  let obj5 = null;
  const segmentedControlState = require(8879) /* useSegmentedControlState */.useSegmentedControlState(obj4);
  if (disabled) {
    obj5 = { opacity: 0.7 };
  }
  ...
  obj6[1] = str;
  obj6[2] = closure_8(require(9064) /* SegmentedControl */.SegmentedControl, { variant: "experimental_Large", state: segmentedControlState });
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  const tmp5 = numberToCustomScoreResult === id(8835).ICYMICustomScore.MUTED;
  const items1 = [id];
  ...
  const items3 = [callback2(id(4281).Text, obj), , , , ];
  ...
  items3[1] = callback2(id(4281).Text, obj);
  ...
  obj5[1] = callback2(id(5689).TableSwitchRow, obj6);
  ...
  items3[4] = callback2(id(4281).Text, obj7);
  obj4[0] = items3;
