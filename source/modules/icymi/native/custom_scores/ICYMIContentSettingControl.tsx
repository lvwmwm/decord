...
// Dependencies: [32, 19, 17, 4667, 8552, 21, 4446, 712, 8567, 1236, 1297, 15979, 15980, 15981, 9199, 9701, 589, 15982, 4442, 5958, 4640, 2]
// Exports: ChannelScoreSettings, GuildScoreSettings

// Module 15978 (ContentSettingsControl)
...
import registerAssetDefault from "registerAsset" /* 15979 */;
import registerAssetDefault2 from "registerAsset" /* 15980 */;
import registerAssetDefault3 from "registerAsset" /* 15981 */;
...
function ContentSettingsControl(initialValue) {
  ...
  if (generateHydrationId.ICYMICustomScore.LESS !== tmp3) {
    num = 1;
    if (tmp4(8567).ICYMICustomScore.MORE === tmp3) {
      num = 2;
    }
  }
  obj4[3] = num;
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  const tmp5 = numberToCustomScoreResult === id(8567).ICYMICustomScore.MUTED;
  const items1 = [id];
  ...
  const items3 = [callback2(id(4442).Text, obj), , , , ];
  ...
  items3[1] = callback2(id(4442).Text, obj);
  ...
  obj5[1] = callback2(id(5958).TableSwitchRow, obj6);
  ...
  items3[4] = callback2(id(4442).Text, obj7);
  obj4[0] = items3;
