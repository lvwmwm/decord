...
// Dependencies: [32, 19, 17, 4654, 8537, 21, 4445, 712, 8552, 1236, 1297, 15961, 15962, 15963, 9181, 9683, 589, 15964, 4441, 5945, 4639, 2]
// Exports: ChannelScoreSettings, GuildScoreSettings

// Module 15960 (ContentSettingsControl)
...
import registerAssetDefault from "registerAsset" /* 15961 */;
import registerAssetDefault2 from "registerAsset" /* 15962 */;
import registerAssetDefault3 from "registerAsset" /* 15963 */;
...
function ContentSettingsControl(initialValue) {
  ...
  if (generateHydrationId.ICYMICustomScore.LESS !== tmp3) {
    num = 1;
    if (tmp4(8552).ICYMICustomScore.MORE === tmp3) {
      num = 2;
    }
  }
  obj4[3] = num;
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  const tmp5 = numberToCustomScoreResult === id(8552).ICYMICustomScore.MUTED;
  const items1 = [id];
  ...
  const items3 = [callback2(id(4441).Text, obj), , , , ];
  ...
  items3[1] = callback2(id(4441).Text, obj);
  ...
  obj5[1] = callback2(id(5945).TableSwitchRow, obj6);
  ...
  items3[4] = callback2(id(4441).Text, obj7);
  obj4[0] = items3;
