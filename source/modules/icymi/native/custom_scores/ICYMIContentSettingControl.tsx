...
// Dependencies: [32, 19, 17, 4497, 8838, 21, 4302, 712, 8852, 1236, 1297, 15492, 15493, 15494, 8896, 9081, 589, 15495, 4298, 5708, 4492, 2]
// Exports: ChannelScoreSettings, GuildScoreSettings

// Module 15491 (ContentSettingsControl)
import _slicedToArray from "_slicedToArray";
import TableSwitchRow from "TableSwitchRow";
import { View } from "module_15495";
...
function ContentSettingsControl(initialValue) {
  ...
  obj[0] = importDefault(15492);
  const items = [tmp.icon, ];
  let iconSelected = null;
  if (tmp3 === require(8852) /* generateHydrationId */.ICYMICustomScore.LESS) {
  ...
  obj1[0] = importDefault(15493);
  const items2 = [tmp.icon, ];
  let iconSelected1 = null;
  if (tmp3 === require(8852) /* generateHydrationId */.ICYMICustomScore.DEFAULT) {
  ...
  obj3[0] = importDefault(15494);
  const items3 = [tmp.icon, ];
  let iconSelected2 = null;
  if (tmp3 === require(8852) /* generateHydrationId */.ICYMICustomScore.MORE) {
  ...
  let num = 0;
  if (require(8852) /* generateHydrationId */.ICYMICustomScore.LESS !== tmp3) {
    num = 1;
    if (tmp4(8852).ICYMICustomScore.MORE === tmp3) {
      num = 2;
    }
  }
  obj4[3] = num;
  let obj5 = null;
  const segmentedControlState = require(8896) /* useSegmentedControlState */.useSegmentedControlState(obj4);
  if (disabled) {
    obj5 = { opacity: 0.7 };
  }
  ...
  obj6[1] = str;
  obj6[2] = closure_8(require(9081) /* SegmentedControl */.SegmentedControl, { variant: "experimental_Large", state: segmentedControlState });
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  const tmp5 = numberToCustomScoreResult === id(8852).ICYMICustomScore.MUTED;
  const items1 = [id];
  ...
  const items3 = [callback2(id(4298).Text, obj), , , , ];
  ...
  items3[1] = callback2(id(4298).Text, obj);
  ...
  obj5[1] = callback2(id(5708).TableSwitchRow, obj6);
  ...
  items3[4] = callback2(id(4298).Text, obj7);
  obj4[0] = items3;
