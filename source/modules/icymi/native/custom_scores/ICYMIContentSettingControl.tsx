...
// Dependencies: [32, 19, 17, 4539, 8943, 21, 4344, 712, 8957, 1236, 1297, 15648, 15649, 15650, 9001, 9187, 589, 15651, 4340, 5807, 4534, 2]
...
function ContentSettingsControl(initialValue) {
  ...
  if (tmp3 === require(8957) /* generateHydrationId */.ICYMICustomScore.LESS) {
  ...
  if (tmp3 === require(8957) /* generateHydrationId */.ICYMICustomScore.DEFAULT) {
  ...
  if (tmp3 === require(8957) /* generateHydrationId */.ICYMICustomScore.MORE) {
  ...
  let num = 0;
  if (require(8957) /* generateHydrationId */.ICYMICustomScore.LESS !== tmp3) {
    num = 1;
    if (tmp4(8957).ICYMICustomScore.MORE === tmp3) {
      num = 2;
    }
  }
  obj4[3] = num;
  let obj5 = null;
  const segmentedControlState = require(9001) /* useSegmentedControlState */.useSegmentedControlState(obj4);
  if (disabled) {
    obj5 = { opacity: 0.7 };
  }
  ...
  obj6[1] = str;
  obj6[2] = closure_8(require(9187) /* SegmentedControl */.SegmentedControl, { variant: "experimental_Large", state: segmentedControlState });
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  const tmp5 = numberToCustomScoreResult === id(8957).ICYMICustomScore.MUTED;
  const items1 = [id];
  ...
  const items3 = [callback2(id(4340).Text, obj), , , , ];
  ...
  items3[1] = callback2(id(4340).Text, obj);
  ...
  obj5[1] = callback2(id(5807).TableSwitchRow, obj6);
  ...
  items3[4] = callback2(id(4340).Text, obj7);
  obj4[0] = items3;
