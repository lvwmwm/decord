...
// Dependencies: [31, 33, 15343, 15348, 2]
// Exports: default

// Module 15347 (CustomStatusEntryRow)
import "result";
...
export default function CustomStatusEntryRow(content) {
  ...
  let obj = require(15343) /* useReplyActions */;
  ...
  return jsx(importDefault(15348), { id: content.id, userId: content.author_id, customStatusExtra: content.extra, renderForScreenshot, visible, variant: { kind: "otherUserStatus", handlePressPrimary: openReplyActionSheet, handlePressSecondary: openEmojiPicker } });
};
