...
// Dependencies: [19, 17, 1994, 21, 4342, 712, 12368, 8307, 4338, 589, 8825, 11059, 12371, 1236, 12373, 12375, 12290, 9917, 7792, 687, 2]
...
export const CustomStatusTimestampBadge = function CustomStatusTimestampBadge(entry) {
  ...
  const items = [callback(require(11059) /* TimerIcon */.TimerIcon, obj), callback(ContentTimestamp, { entry: entry.entry })];
  obj[1] = items;
  return callback2(View, obj);
};
