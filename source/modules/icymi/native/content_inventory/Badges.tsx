...
// Dependencies: [19, 17, 1994, 21, 4661, 712, 12103, 8348, 4734, 589, 9430, 10793, 12106, 1236, 12108, 12110, 9526, 10123, 8010, 687, 2]
...
export const CustomStatusTimestampBadge = function CustomStatusTimestampBadge(entry) {
  ...
  const items = [callback(require(10793) /* TimerIcon */.TimerIcon, obj), callback(ContentTimestamp, { entry: entry.entry })];
  obj[1] = items;
  return callback2(View, obj);
};
