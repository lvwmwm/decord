...
// Dependencies: [19, 17, 1975, 21, 4285, 712, 12199, 8161, 4281, 589, 8685, 10987, 12202, 1236, 12204, 12206, 12119, 9779, 7647, 687, 2]
...
export const CustomStatusTimestampBadge = function CustomStatusTimestampBadge(entry) {
  ...
  const items = [callback(require(10987) /* TimerIcon */.TimerIcon, obj), callback(ContentTimestamp, { entry: entry.entry })];
  obj[1] = items;
  return callback2(View, obj);
};
