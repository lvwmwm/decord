...
// Dependencies: [19, 17, 1994, 21, 4303, 712, 12286, 8242, 4299, 589, 8768, 11074, 12289, 1236, 12291, 12293, 12206, 9867, 7728, 687, 2]
...
export const CustomStatusTimestampBadge = function CustomStatusTimestampBadge(entry) {
  ...
  const items = [callback(require(11074) /* TimerIcon */.TimerIcon, obj), callback(ContentTimestamp, { entry: entry.entry })];
  obj[1] = items;
  return callback2(View, obj);
};
