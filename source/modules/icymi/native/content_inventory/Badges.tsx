...
// Dependencies: [19, 17, 1946, 21, 4255, 712, 12165, 8020, 4251, 589, 8656, 10955, 12168, 1236, 12170, 12172, 12085, 9748, 7619, 687, 2]
...
export const CustomStatusTimestampBadge = function CustomStatusTimestampBadge(entry) {
  ...
  const items = [callback(require(10955) /* TimerIcon */.TimerIcon, obj), callback(ContentTimestamp, { entry: entry.entry })];
  obj[1] = items;
  return callback2(View, obj);
};
