...
// Dependencies: [19, 17, 1975, 21, 4303, 712, 12283, 8238, 4299, 589, 8762, 11069, 12286, 1236, 12288, 12290, 12203, 9862, 7726, 687, 2]
...
function ContentTimestamp(entry) {
  entry = entry.entry;
  let obj = require(8238) /* calculateTimestampDurations */;
...
export const CustomStatusTimestampBadge = function CustomStatusTimestampBadge(entry) {
  ...
  const items = [callback(require(11069) /* TimerIcon */.TimerIcon, obj), callback(ContentTimestamp, { entry: entry.entry })];
  obj[1] = items;
  return callback2(View, obj);
};
