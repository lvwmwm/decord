...
// Dependencies: [19, 17, 1372, 1891, 8821, 21, 4285, 712, 589, 4475, 5255, 5700, 1297, 8835, 5685, 10114, 15467, 5688, 5354, 2]
// Exports: default

// Module 15466 (ItemDetailsActionSheet)
import "set";
...
export default function ItemDetailsActionSheet(arg0) {
  ...
  const tmp8 = importDefault(5255)("show_icymi_debug_scores");
  if (result) {
  ...
  obj2[3] = items3;
  return closure_9(require(5685) /* ActionSheet */.ActionSheet, obj2);
};
