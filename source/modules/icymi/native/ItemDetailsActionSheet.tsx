...
// Dependencies: [19, 17, 1391, 1910, 8947, 21, 4342, 712, 589, 4535, 5312, 5819, 1297, 8961, 5804, 10243, 15647, 5807, 5414, 2]
// Exports: default

// Module 15646 (ItemDetailsActionSheet)
import "set";
...
export default function ItemDetailsActionSheet(arg0) {
  ...
  const tmp6 = importDefault(4535)(stateFromStores, true);
  ...
  const tmp8 = importDefault(5312)("show_icymi_debug_scores");
  if (result) {
  ...
  obj2[3] = items3;
  return closure_9(require(5804) /* ActionSheet */.ActionSheet, obj2);
};
