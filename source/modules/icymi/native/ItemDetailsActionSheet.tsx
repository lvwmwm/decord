...
// Dependencies: [19, 17, 1391, 1910, 8943, 21, 4344, 712, 589, 4534, 5311, 5818, 1297, 8957, 5803, 10243, 15647, 5806, 5413, 2]
// Exports: default
...
export default function ItemDetailsActionSheet(arg0) {
  ...
  const tmp6 = importDefault(4534)(stateFromStores, true);
  ...
  const tmp8 = importDefault(5311)("show_icymi_debug_scores");
  if (result) {
  ...
  obj2[3] = items3;
  return closure_9(require(5803) /* ActionSheet */.ActionSheet, obj2);
};
