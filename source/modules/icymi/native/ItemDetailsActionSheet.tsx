...
// Dependencies: [19, 17, 1372, 1862, 8792, 21, 4255, 712, 589, 4445, 5225, 5646, 1297, 8806, 5631, 10083, 15429, 5634, 5300, 2]
// Exports: default

// Module 15428 (ItemDetailsActionSheet)
import "set";
...
export default function ItemDetailsActionSheet(arg0) {
  ...
  const tmp6 = importDefault(4445)(stateFromStores, true);
  ...
  const tmp8 = importDefault(5225)("show_icymi_debug_scores");
  if (result) {
  ...
  obj2[3] = items3;
  return closure_9(require(5631) /* ActionSheet */.ActionSheet, obj2);
};
