...
// Dependencies: [5, 32, 19, 17, 4372, 1910, 15840, 676, 21, 15809, 712, 5885, 9854, 4120, 4381, 8681, 589, 1435, 8447, 5374, 4949, 4376, 4815, 4340, 1236, 1629, 9068, 9060, 4098, 4611, 15824, 7890, 2]
// Exports: default

// Module 15841 (SelectedServerIcon)
...
import closure_10 from "initialize" /* 15840 */;
...
function SelectedServersRow(selectedGuilds) {
  ...
  let obj = selectedGuilds(4120);
  const fn = function _() {
    let obj = selectedGuilds(4381);
    let num = 0;
  ...
  obj = { withTiming: selectedGuilds(4381).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: c15, tokens: first(712) };
  fn.__closure = obj;
  ...
  obj[1] = closure_12(first(8681), obj1);
  return closure_12(first(4120).View, obj);
}
function CutoutGuildBanner(guild) {
  ...
  if (null != guild.banner) {
    ...
    let tmp11Result = tmp11(tmp12(5374), obj2);
  } else {
...
function FeaturedServer(guild) {
  ...
  const items3 = [callback2(guild(4376).Text, { maxFontSizeMultiplier: 1, style: tmp.featuredServerTitle, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: guild.name }), callback2(guild(4376).Text, { maxFontSizeMultiplier: 1, lineClamp: 2, variant: "text-xs/normal", color: "text-default", children: guild.description }), ];
  ...
  if (selected) {
    ...
    tmp7Result = tmp7(tmp2(4340).CircleCheckIcon, obj5);
  }
  obj4[3] = tmp7Result;
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj4[7] = str;
      obj3[1] = tmp7(guild(4815).Button, obj4);
      items3[2] = tmp7(tmp8, obj3);
      obj[1] = items3;
      items2[1] = tmp6(tmp8, obj);
      obj[4] = items2;
      return tmp6(guild(4949).PressableHighlight, obj);
    }
  }
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            obj1[0] = v0(9060).gravityJoinGuild(Array.from(closure_1_3), "icymi_info_modal");
            return obj1;
          }
        } else if (1 === tmp4) {
          if (arg0 === 1) {
            ...
            const recommendedGuilds = v0(9060).getRecommendedGuilds();
            const obj9 = v0(9060);
            v0(4611).popWithKey(closure_1_0(15824).ICYMI_INFO_MODAL_KEY);
            dependencyMap = 3;
          ...
          const guildChannelScores1 = v0(9060).getGuildChannelScores();
          const obj19 = v0(9060);
          const recommendedGuilds1 = v0(9060).getRecommendedGuilds();
          const obj20 = v0(9060);
          v0(4611).popWithKey(closure_1_0(15824).ICYMI_INFO_MODAL_KEY);
          dependencyMap = 3;
          return { value: "HermesInternal", done: "HermesInternal" };
