...
// Dependencies: [5, 32, 19, 17, 4436, 1910, 15919, 676, 21, 15888, 712, 5951, 9921, 4184, 4445, 8749, 589, 1435, 8514, 5440, 5015, 4440, 4879, 4404, 1236, 1629, 9136, 9128, 4162, 4675, 15903, 7957, 2]
// Exports: default

// Module 15920 (SelectedServerIcon)
...
import closure_10 from "initialize" /* 15919 */;
...
function SelectedServersRow(selectedGuilds) {
  ...
  let obj = selectedGuilds(4184);
  const fn = function _() {
    let obj = selectedGuilds(4445);
    let num = 0;
  ...
  obj = { withTiming: selectedGuilds(4445).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: c15, tokens: first(712) };
  fn.__closure = obj;
  ...
  obj[1] = closure_12(first(8749), obj1);
  return closure_12(first(4184).View, obj);
}
function CutoutGuildBanner(guild) {
  ...
  obj1 = { shape: guild(8514).CutoutShape.RoundedRect, x: 8, y: 46, width: 56, height: 56, cornerRadius: 20 };
  const items1 = [obj1];
  obj[0] = items1;
  if (null != guild.banner) {
    ...
    let tmp11Result = tmp11(tmp12(5440), obj2);
  } else {
  ...
  obj4[2] = guild(5951).GuildIconSizes.LARGE;
...
function FeaturedServer(guild) {
  ...
  const items3 = [callback2(guild(4440).Text, { maxFontSizeMultiplier: 1, style: tmp.featuredServerTitle, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: guild.name }), callback2(guild(4440).Text, { maxFontSizeMultiplier: 1, lineClamp: 2, variant: "text-xs/normal", color: "text-default", children: guild.description }), ];
  ...
  if (selected) {
    ...
    tmp7Result = tmp7(tmp2(4404).CircleCheckIcon, obj5);
  }
  obj4[3] = tmp7Result;
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj4[7] = str;
      obj3[1] = tmp7(guild(4879).Button, obj4);
      items3[2] = tmp7(tmp8, obj3);
      obj[1] = items3;
      items2[1] = tmp6(tmp8, obj);
      obj[4] = items2;
      return tmp6(guild(5015).PressableHighlight, obj);
    }
  }
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            obj1[0] = v0(9128).gravityJoinGuild(Array.from(closure_1_3), "icymi_info_modal");
            return obj1;
          }
        } else if (1 === tmp4) {
          if (arg0 === 1) {
            ...
            const recommendedGuilds = v0(9128).getRecommendedGuilds();
            const obj9 = v0(9128);
            v0(4675).popWithKey(closure_1_0(15903).ICYMI_INFO_MODAL_KEY);
            dependencyMap = 3;
          ...
          const guildChannelScores1 = v0(9128).getGuildChannelScores();
          const obj19 = v0(9128);
          const recommendedGuilds1 = v0(9128).getRecommendedGuilds();
          const obj20 = v0(9128);
          v0(4675).popWithKey(closure_1_0(15903).ICYMI_INFO_MODAL_KEY);
          dependencyMap = 3;
          return { value: "HermesInternal", done: null };
