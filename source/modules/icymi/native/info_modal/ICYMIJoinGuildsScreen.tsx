...
// Dependencies: [5, 32, 19, 17, 4247, 1862, 15453, 676, 21, 15422, 712, 5646, 9594, 4116, 4256, 8309, 589, 1416, 8075, 5221, 4797, 4251, 4665, 4216, 1236, 1581, 8815, 8807, 3956, 4460, 15437, 7638, 2]
// Exports: default

// Module 15454 (SelectedServerIcon)
...
function SelectedServerIcon(guild) {
  ...
  if (null != guild) {
    ...
    obj[1] = guild;
    obj[2] = require(5646) /* GuildIconSizes */.GuildIconSizes.LARGE;
    let tmp3Result = tmp3(importDefault(5646), obj);
    ...
    if (tmp2) {
      ...
      tmp3Result = tmp3(require(9594) /* ServerIcon */.ServerIcon, obj);
    }
  }
  obj[1] = tmp3Result;
...
function SelectedServersRow(selectedGuilds) {
  ...
  obj[1] = closure_12(first(8309), obj1);
...
function CutoutGuildBanner(guild) {
  ...
  obj1[0] = guild(8075).CutoutShape.RoundedRect;
  const items1 = [obj1];
  obj[0] = items1;
  if (null != guild.banner) {
    ...
    let tmp11Result = tmp11(tmp12(5221), obj2);
  } else {
  ...
  obj[1] = tmp11Result;
  const items3 = [closure_12(importDefault(8075), obj), ];
  const obj4 = { style: items4, guild, size: null, animate: null };
  items4 = [, ];
  ({ guildIcon: arr5[0], guildIconBorder: arr5[1] } = tmp);
  const tmp13 = importDefault(8075);
  const tmp9 = closure_13;
  obj4[2] = guild(5646).GuildIconSizes.LARGE;
  obj4[3] = !stateFromStores;
  items3[1] = closure_12(importDefault(5646), obj4);
  obj[1] = items3;
...
function FeaturedServer(guild) {
  ...
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj4[7] = str;
      obj3[1] = tmp7(guild(4665).Button, obj4);
      items3[2] = tmp7(tmp8, obj3);
      obj[1] = items3;
      items2[1] = tmp6(tmp8, obj);
      obj[4] = items2;
      return tmp6(guild(4797).PressableHighlight, obj);
    }
  }
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            obj1[0] = v0(8807).gravityJoinGuild(Array.from(outer1_3), "icymi_info_modal");
            return obj1;
          }
        } else if (1 === tmp4) {
          if (arg0 === 1) {
            ...
            const recommendedGuilds = v0(8807).getRecommendedGuilds();
            const obj9 = v0(8807);
            v0(4460).popWithKey(outer1_0(15437).ICYMI_INFO_MODAL_KEY);
            dependencyMap = 3;
          ...
          const guildChannelScores1 = v0(8807).getGuildChannelScores();
          const obj19 = v0(8807);
          const recommendedGuilds1 = v0(8807).getRecommendedGuilds();
          const obj20 = v0(8807);
          v0(4460).popWithKey(outer1_0(15437).ICYMI_INFO_MODAL_KEY);
          dependencyMap = 3;
          return { value: "T", done: null };
