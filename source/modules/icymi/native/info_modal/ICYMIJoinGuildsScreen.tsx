...
// Dependencies: [5, 32, 19, 17, 4440, 1909, 16036, 676, 21, 16005, 712, 5972, 9316, 4187, 4449, 7746, 589, 1431, 8066, 5461, 5036, 4444, 4896, 4408, 1236, 1628, 8598, 8590, 4164, 4691, 16020, 8073, 2]
// Exports: default

// Module 16037 (SelectedServerIcon)
...
import closure_10 from "initialize" /* 16036 */;
...
function SelectedServersRow(selectedGuilds) {
  ...
  let obj = selectedGuilds(4187);
  const fn = function _() {
    let obj = selectedGuilds(4449);
    let num = 0;
  ...
  obj = { withTiming: selectedGuilds(4449).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: c15, tokens: first(712) };
  fn.__closure = obj;
  ...
  obj[1] = closure_12(first(7746), obj1);
  return closure_12(first(4187).View, obj);
}
function CutoutGuildBanner(guild) {
  ...
  obj1 = { shape: guild(8066).CutoutShape.RoundedRect, x: 8, y: 46, width: 56, height: 56, cornerRadius: 20 };
  const items1 = [obj1];
  obj[0] = items1;
  if (null != guild.banner) {
    ...
    let tmp11Result = tmp11(tmp12(5461), obj2);
  } else {
  ...
  obj4[2] = guild(5972).GuildIconSizes.LARGE;
...
function FeaturedServer(guild) {
  ...
  const items3 = [callback2(guild(4444).Text, { maxFontSizeMultiplier: 1, style: tmp.featuredServerTitle, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: guild.name }), callback2(guild(4444).Text, { maxFontSizeMultiplier: 1, lineClamp: 2, variant: "text-xs/normal", color: "text-default", children: guild.description }), ];
  ...
  if (selected) {
    ...
    tmp7Result = tmp7(tmp2(4408).CircleCheckIcon, obj5);
  }
  obj4[3] = tmp7Result;
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj4[7] = str;
      obj3[1] = tmp7(guild(4896).Button, obj4);
      items3[2] = tmp7(tmp8, obj3);
      obj[1] = items3;
      items2[1] = tmp6(tmp8, obj);
      obj[4] = items2;
      return tmp6(guild(5036).PressableHighlight, obj);
    }
  }
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            obj1[0] = v0(8590).gravityJoinGuild(Array.from(closure_1_3), "icymi_info_modal");
            return obj1;
          }
        } else if (1 === tmp4) {
          if (arg0 === 1) {
            ...
            const recommendedGuilds = v0(8590).getRecommendedGuilds();
            const obj9 = v0(8590);
            v0(4691).popWithKey(closure_1_0(16020).ICYMI_INFO_MODAL_KEY);
            dependencyMap = 3;
          ...
          const guildChannelScores1 = v0(8590).getGuildChannelScores();
          const obj19 = v0(8590);
          const recommendedGuilds1 = v0(8590).getRecommendedGuilds();
          const obj20 = v0(8590);
          v0(4691).popWithKey(closure_1_0(16020).ICYMI_INFO_MODAL_KEY);
          dependencyMap = 3;
          return { value: "HermesInternal", done: "HermesInternal" };
