...
// Dependencies: [5, 32, 19, 17, 4470, 1909, 16071, 676, 21, 16040, 712, 6004, 9355, 4217, 4479, 7778, 589, 1431, 8098, 5493, 5068, 4474, 4928, 4438, 1236, 1628, 8630, 8622, 4194, 4723, 16055, 8105, 2]
// Exports: default

// Module 16072 (SelectedServerIcon)
...
import closure_10 from "initialize" /* 16071 */;
...
function SelectedServersRow(selectedGuilds) {
  ...
  obj = { withTiming: selectedGuilds(4479).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: c15, tokens: first(712) };
  fn.__closure = obj;
  ...
  obj[1] = closure_12(first(7778), obj1);
...
function CutoutGuildBanner(guild) {
  ...
  obj1 = { shape: guild(8098).CutoutShape.RoundedRect, x: 8, y: 46, width: 56, height: 56, cornerRadius: 20 };
  const items1 = [obj1];
  obj[0] = items1;
  if (null != guild.banner) {
    ...
    let tmp11Result = tmp11(tmp12(5493), obj2);
  } else {
  ...
  obj4[2] = guild(6004).GuildIconSizes.LARGE;
...
function FeaturedServer(guild) {
  ...
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj[4] = items2;
      return tmp6(guild(5068).PressableHighlight, obj);
    }
  }
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            obj1[0] = v0(8622).gravityJoinGuild(Array.from(closure_1_3), "icymi_info_modal");
            return obj1;
          }
        } else if (1 === tmp4) {
          if (arg0 === 1) {
            ...
            const recommendedGuilds = v0(8622).getRecommendedGuilds();
            const obj9 = v0(8622);
            v0(4723).popWithKey(closure_1_0(16055).ICYMI_INFO_MODAL_KEY);
            dependencyMap = 3;
          ...
          const guildChannelScores1 = v0(8622).getGuildChannelScores();
          const obj19 = v0(8622);
          const recommendedGuilds1 = v0(8622).getRecommendedGuilds();
          const obj20 = v0(8622);
          v0(4723).popWithKey(closure_1_0(16055).ICYMI_INFO_MODAL_KEY);
          dependencyMap = 3;
          return { value: "HermesInternal", done: null };
