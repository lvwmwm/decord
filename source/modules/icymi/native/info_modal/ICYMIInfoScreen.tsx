...
// Dependencies: [32, 5, 19, 17, 505, 21, 4303, 712, 5267, 1628, 4239, 1499, 8927, 15601, 4509, 8388, 8396, 1236, 5268, 15603, 15604, 15605, 15606, 4299, 9709, 12289, 4264, 4271, 15607, 2007, 4714, 2]
// Exports: default

// Module 15600 (ICYMIInfoScreen)
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  obj[1] = callback3(extendedOnboarding(8388).HeaderIconButton, obj);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(15604);
  } else {
    tmp2Result = tmp2(15605);
  }
  ...
  const items9 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(9709).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  const obj14 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(9709).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj16 = { style: tmp.divider };
  const items11 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(12289).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  const obj18 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(12289).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
