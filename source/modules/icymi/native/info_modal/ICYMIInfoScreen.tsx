...
// Dependencies: [32, 5, 19, 17, 505, 21, 4445, 712, 5444, 1629, 4380, 1500, 8561, 15970, 4676, 7540, 7548, 1236, 5445, 15972, 15973, 15974, 15975, 4441, 9276, 9324, 4405, 4412, 15976, 2009, 4880, 2]
// Exports: default

// Module 15969 (ICYMIInfoScreen)
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  obj = {
    source: navigation(7548),
    onPress() {
      return navigation(4676).pop();
    },
  ...
  obj[1] = callback3(extendedOnboarding(7540).HeaderIconButton, obj);
  ...
  const tmp5 = navigation(4380)();
  obj3[0] = navigation(15972);
  obj2[0] = obj3;
  obj2[1] = tmp.bgImage;
  const items5 = [callback3(navigation(5445), obj2), ];
  const obj4 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5445);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(15973);
  } else {
    tmp2Result = tmp2(15974);
  }
  const items7 = [callback3(navigation(5445), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj8 = { source: null, style: null };
  tmp2Result = tmp2(5445);
  obj8[0] = navigation(15975);
  ...
  items7[2] = callback3(extendedOnboarding(4441).Text, obj9);
  ...
  items7[3] = callback3(extendedOnboarding(4441).Text, obj10);
  obj6[1] = items7;
  ...
  const tmp17 = navigation(5445);
  const items9 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(9276).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = callback3(extendedOnboarding(4441).Text, obj15);
  obj13[1] = items9;
  ...
  const obj14 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(9276).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj16 = { style: tmp.divider };
  const items11 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(9324).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = callback3(extendedOnboarding(4441).Text, obj19);
  obj17[1] = items11;
  ...
  const obj18 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(9324).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj20 = { style: tmp.divider };
  const items12 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(4405).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = callback3(extendedOnboarding(4441).Text, obj23);
  obj21[1] = items12;
  ...
  obj24[3] = intl7.format(extendedOnboarding(1236).t["jVS/hc"], {
    feedbackHook(children) {
      return callback(extendedOnboarding(4441).Text, {
  ...
  items13[1] = callback3(extendedOnboarding(4441).Text, obj24);
  obj11[0] = items13;
  ...
  obj27[3] = callback;
  obj26[1] = callback3(extendedOnboarding(4880).Button, obj27);
