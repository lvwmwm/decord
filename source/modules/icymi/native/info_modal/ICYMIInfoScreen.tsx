...
// Dependencies: [32, 5, 19, 17, 505, 21, 4444, 712, 5439, 1629, 4379, 1500, 9136, 15905, 4675, 8607, 8615, 1236, 5440, 15907, 15908, 15909, 15910, 4440, 9921, 12562, 4404, 4411, 15911, 2009, 4879, 2]
// Exports: default

// Module 15904 (ICYMIInfoScreen)
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  obj = {
    source: navigation(8615),
    onPress() {
      return navigation(4675).pop();
    },
  ...
  obj[1] = callback3(extendedOnboarding(8607).HeaderIconButton, obj);
  ...
  const tmp5 = navigation(4379)();
  obj3[0] = navigation(15907);
  obj2[0] = obj3;
  obj2[1] = tmp.bgImage;
  const items5 = [callback3(navigation(5440), obj2), ];
  const obj4 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5440);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(15908);
  } else {
    tmp2Result = tmp2(15909);
  }
  const items7 = [callback3(navigation(5440), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj8 = { source: null, style: null };
  tmp2Result = tmp2(5440);
  obj8[0] = navigation(15910);
  ...
  items7[2] = callback3(extendedOnboarding(4440).Text, obj9);
  ...
  items7[3] = callback3(extendedOnboarding(4440).Text, obj10);
  obj6[1] = items7;
  ...
  const tmp17 = navigation(5440);
  const items9 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(9921).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = callback3(extendedOnboarding(4440).Text, obj15);
  obj13[1] = items9;
  ...
  const obj14 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(9921).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj16 = { style: tmp.divider };
  const items11 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(12562).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = callback3(extendedOnboarding(4440).Text, obj19);
  obj17[1] = items11;
  ...
  const obj18 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(12562).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj20 = { style: tmp.divider };
  const items12 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(4404).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = callback3(extendedOnboarding(4440).Text, obj23);
  obj21[1] = items12;
  ...
  obj24[3] = intl7.format(extendedOnboarding(1236).t["jVS/hc"], {
    feedbackHook(children) {
      return callback(extendedOnboarding(4440).Text, {
  ...
  items13[1] = callback3(extendedOnboarding(4440).Text, obj24);
  obj11[0] = items13;
  ...
  obj27[3] = callback;
  obj26[1] = callback3(extendedOnboarding(4879).Button, obj27);
