...
// Dependencies: [32, 5, 19, 17, 505, 21, 4255, 712, 5220, 1581, 4191, 1480, 8815, 15439, 4460, 8165, 8173, 1236, 5221, 15441, 15442, 15443, 15444, 4251, 9594, 12168, 4216, 4223, 15445, 1959, 4665, 2]
// Exports: default

// Module 15438 (ICYMIInfoScreen)
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  obj[0] = navigation(8173);
  obj[1] = function onPress() {
    return navigation(4460).pop();
  };
  ...
  obj[1] = callback3(extendedOnboarding(8165).HeaderIconButton, obj);
  ...
  obj3[0] = navigation(15441);
  obj2[0] = obj3;
  obj2[1] = tmp.bgImage;
  const items5 = [callback3(navigation(5221), obj2), ];
  const obj4 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5221);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(15442);
  } else {
    tmp2Result = tmp2(15443);
  }
  const items7 = [callback3(navigation(5221), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj8 = { source: null, style: null };
  tmp2Result = tmp2(5221);
  obj8[0] = navigation(15444);
  ...
  const tmp17 = navigation(5221);
  const items9 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(9594).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  const obj14 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(9594).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj16 = { style: tmp.divider };
  const items11 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(12168).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  const obj18 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(12168).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  ...
  obj27[3] = callback;
  obj26[1] = callback3(extendedOnboarding(4665).Button, obj27);
