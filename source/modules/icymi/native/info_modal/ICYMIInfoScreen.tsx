...
// Dependencies: [32, 5, 19, 17, 505, 21, 4344, 712, 5306, 1628, 4280, 1499, 8966, 15657, 4549, 8427, 8435, 1236, 5307, 15659, 15660, 15661, 15662, 4340, 9749, 12352, 4305, 4312, 15663, 2007, 4754, 2]
// Exports: default
...
export default function ICYMIInfoScreen(extendedOnboarding) {
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp2;
            if (outer1_0) {
              const ICYMIAnalytics = outer1_0(8966).ICYMIAnalytics;
  ...
  obj[0] = navigation(8435);
  obj[1] = function onPress() {
    return navigation(4549).pop();
  };
  ...
  obj[1] = callback3(extendedOnboarding(8427).HeaderIconButton, obj);
  ...
  const tmp5 = navigation(4280)();
  obj3[0] = navigation(15659);
  obj2[0] = obj3;
  obj2[1] = tmp.bgImage;
  const items5 = [callback3(navigation(5307), obj2), ];
  const obj4 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5307);
  ...
  const items7 = [callback3(navigation(5307), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  ...
  items7[2] = callback3(extendedOnboarding(4340).Text, obj9);
  ...
  items7[3] = callback3(extendedOnboarding(4340).Text, obj10);
  obj6[1] = items7;
  ...
  const tmp17 = navigation(5307);
  const items9 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(9749).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = callback3(extendedOnboarding(4340).Text, obj15);
  obj13[1] = items9;
  ...
  const obj14 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(9749).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  ...
  items11[1] = callback3(extendedOnboarding(4340).Text, obj19);
  obj17[1] = items11;
  ...
  const items12 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(4305).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = callback3(extendedOnboarding(4340).Text, obj23);
  obj21[1] = items12;
  ...
  obj24[3] = intl7.format(extendedOnboarding(1236).t["jVS/hc"], {
    feedbackHook(children) {
      return callback(extendedOnboarding(4340).Text, {
  ...
  items13[1] = callback3(extendedOnboarding(4340).Text, obj24);
  obj11[0] = items13;
  ...
  obj27[3] = callback;
  obj26[1] = callback3(extendedOnboarding(4754).Button, obj27);
