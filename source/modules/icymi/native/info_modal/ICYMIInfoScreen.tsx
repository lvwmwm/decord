...
// Dependencies: [32, 5, 19, 17, 505, 21, 4446, 712, 5457, 1629, 4381, 1500, 8576, 15988, 4689, 7554, 7562, 1236, 5458, 15990, 15991, 15992, 15993, 4442, 9294, 9342, 4406, 4413, 15994, 2010, 4893, 2]
// Exports: default

// Module 15987 (ICYMIInfoScreen)
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  obj = {
    source: navigation(7562),
    onPress() {
      return navigation(4689).pop();
    },
  ...
  obj[1] = callback3(extendedOnboarding(7554).HeaderIconButton, obj);
  ...
  const tmp5 = navigation(4381)();
  obj3[0] = navigation(15990);
  obj2[0] = obj3;
  obj2[1] = tmp.bgImage;
  const items5 = [callback3(navigation(5458), obj2), ];
  const obj4 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5458);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(15991);
  } else {
    tmp2Result = tmp2(15992);
  }
  const items7 = [callback3(navigation(5458), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj8 = { source: null, style: null };
  tmp2Result = tmp2(5458);
  obj8[0] = navigation(15993);
  ...
  items7[2] = callback3(extendedOnboarding(4442).Text, obj9);
  ...
  items7[3] = callback3(extendedOnboarding(4442).Text, obj10);
  obj6[1] = items7;
  ...
  const tmp17 = navigation(5458);
  const items9 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(9294).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = callback3(extendedOnboarding(4442).Text, obj15);
  obj13[1] = items9;
  ...
  const obj14 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(9294).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj16 = { style: tmp.divider };
  const items11 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(9342).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = callback3(extendedOnboarding(4442).Text, obj19);
  obj17[1] = items11;
  ...
  const obj18 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(9342).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj20 = { style: tmp.divider };
  const items12 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(4406).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = callback3(extendedOnboarding(4442).Text, obj23);
  obj21[1] = items12;
  ...
  obj24[3] = intl7.format(extendedOnboarding(1236).t["jVS/hc"], {
    feedbackHook(children) {
      return callback(extendedOnboarding(4442).Text, {
  ...
  items13[1] = callback3(extendedOnboarding(4442).Text, obj24);
  obj11[0] = items13;
  ...
  obj27[3] = callback;
  obj26[1] = callback3(extendedOnboarding(4893).Button, obj27);
