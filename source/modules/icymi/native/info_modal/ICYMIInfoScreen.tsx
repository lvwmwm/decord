...
// Dependencies: [32, 5, 19, 17, 505, 21, 4285, 712, 5250, 1609, 4221, 1480, 8844, 15477, 4490, 8305, 8313, 1236, 5251, 15479, 15480, 15481, 15482, 4281, 9623, 12202, 4246, 4253, 15483, 1988, 4695, 2]
// Exports: default

// Module 15476 (ICYMIInfoScreen)
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  ({ top, bottom } = navigation(1609)());
  const tmp4 = navigation(1609)();
  ...
  obj[0] = navigation(8313);
  obj[1] = function onPress() {
    return navigation(4490).pop();
  };
  ...
  obj[1] = callback3(extendedOnboarding(8305).HeaderIconButton, obj);
  ...
  const tmp5 = navigation(4221)();
  obj3[0] = navigation(15479);
  obj2[0] = obj3;
  obj2[1] = tmp.bgImage;
  const items5 = [callback3(navigation(5251), obj2), ];
  const obj4 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5251);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(15480);
  } else {
    tmp2Result = tmp2(15481);
  }
  const items7 = [callback3(navigation(5251), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj8 = { source: null, style: null };
  tmp2Result = tmp2(5251);
  obj8[0] = navigation(15482);
  ...
  items7[2] = callback3(extendedOnboarding(4281).Text, obj9);
  ...
  items7[3] = callback3(extendedOnboarding(4281).Text, obj10);
  obj6[1] = items7;
  ...
  const tmp17 = navigation(5251);
  const items9 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(9623).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = callback3(extendedOnboarding(4281).Text, obj15);
  obj13[1] = items9;
  ...
  const obj14 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(9623).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj16 = { style: tmp.divider };
  const items11 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(12202).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = callback3(extendedOnboarding(4281).Text, obj19);
  obj17[1] = items11;
  ...
  const obj18 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(12202).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj20 = { style: tmp.divider };
  const items12 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(4246).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = callback3(extendedOnboarding(4281).Text, obj23);
  obj21[1] = items12;
  ...
  obj24[3] = intl7.format(extendedOnboarding(1236).t["jVS/hc"], {
    feedbackHook(children) {
      return callback(extendedOnboarding(4281).Text, {
  ...
  items13[1] = callback3(extendedOnboarding(4281).Text, obj24);
  obj11[0] = items13;
  ...
  obj27[3] = callback;
  obj26[1] = callback3(extendedOnboarding(4695).Button, obj27);
