...
// Dependencies: [32, 5, 19, 17, 505, 21, 4193, 712, 5144, 1581, 4129, 1480, 8198, 15361, 4399, 9127, 9135, 1236, 5145, 15363, 15364, 15365, 15366, 4189, 9013, 12014, 4154, 4161, 15367, 1959, 4604, 2]
// Exports: default
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  obj[0] = navigation(9135);
  obj[1] = function onPress() {
    return navigation(4399).pop();
  };
  ...
  obj[1] = callback3(extendedOnboarding(9127).HeaderIconButton, obj);
  ...
  const tmp5 = navigation(4129)();
  obj3[0] = navigation(15363);
  obj2[0] = obj3;
  obj2[1] = tmp.bgImage;
  const items5 = [callback3(navigation(5145), obj2), ];
  const obj4 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5145);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(15364);
  } else {
    tmp2Result = tmp2(15365);
  }
  const items7 = [callback3(navigation(5145), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj8 = { source: null, style: null };
  tmp2Result = tmp2(5145);
  obj8[0] = navigation(15366);
  ...
  items7[2] = callback3(extendedOnboarding(4189).Text, obj9);
  ...
  items7[3] = callback3(extendedOnboarding(4189).Text, obj10);
  obj6[1] = items7;
  ...
  const tmp17 = navigation(5145);
  const items9 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(9013).ServerIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items9[1] = callback3(extendedOnboarding(4189).Text, obj15);
  obj13[1] = items9;
  ...
  const obj14 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(9013).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj16 = { style: tmp.divider };
  const items11 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(12014).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items11[1] = callback3(extendedOnboarding(4189).Text, obj19);
  obj17[1] = items11;
  ...
  const obj18 = { style: tmp.infoIcon, children: callback3(extendedOnboarding(12014).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
  const obj20 = { style: tmp.divider };
  const items12 = [callback3(closure_6, { style: tmp.infoIcon, children: callback3(extendedOnboarding(4154).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  items12[1] = callback3(extendedOnboarding(4189).Text, obj23);
  obj21[1] = items12;
  ...
  obj24[3] = intl7.format(extendedOnboarding(1236).t["jVS/hc"], {
    feedbackHook(children) {
      return callback(extendedOnboarding(4189).Text, {
  ...
  items13[1] = callback3(extendedOnboarding(4189).Text, obj24);
  obj11[0] = items13;
  ...
  obj27[3] = callback;
  obj26[1] = callback3(extendedOnboarding(4604).Button, obj27);
