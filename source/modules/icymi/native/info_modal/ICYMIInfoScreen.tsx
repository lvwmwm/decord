...
// Dependencies: [32, 5, 19, 17, 505, 21, 4661, 712, 6370, 1629, 4310, 1500, 9065, 15725, 5260, 8492, 8500, 1236, 5449, 15727, 15728, 15729, 15730, 4734, 9813, 12106, 4335, 4342, 15731, 2007, 4745, 2]
// Exports: default
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  obj[0] = navigation(8500);
  obj[1] = function onPress() {
    return navigation(5260).pop();
  };
  ...
  obj[1] = callback3(extendedOnboarding(8492).HeaderIconButton, obj);
  ...
  obj2[0] = obj3;
  obj2[1] = tmp.bgImage;
  const items5 = [callback3(navigation(5449), obj2), ];
  const obj4 = { style: null, children: null };
  const items6 = [tmp.subContainer, ];
  const tmp16 = navigation(5449);
  ...
  if (tmp5 === ThemeTypes.LIGHT) {
    let tmp2Result = tmp2(15728);
  } else {
    tmp2Result = tmp2(15729);
  }
  const items7 = [callback3(navigation(5449), { source: { uri: tmp2Result }, style: tmp.headerImg }), , , ];
  const obj8 = { source: null, style: null };
  tmp2Result = tmp2(5449);
  obj8[0] = navigation(15730);
  ...
  items7[2] = callback3(extendedOnboarding(4734).Text, obj9);
  ...
  obj24[3] = intl7.format(extendedOnboarding(1236).t["jVS/hc"], {
    feedbackHook(children) {
      return callback(extendedOnboarding(4734).Text, {
