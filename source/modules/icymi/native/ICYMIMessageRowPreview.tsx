...
// Dependencies: [19, 676, 21, 8515, 4071, 8159, 5026, 4310, 4661, 712, 4066, 8157, 10066, 8340, 1236, 2]

// Module 15752 (ICYMIMessageRowPreview)
...
function ICYMIMessageRowPreview(pointerEvents) {
  ...
  let setting1;
  let setting2;
  let obj = require(4661) /* createCacheKey */;
