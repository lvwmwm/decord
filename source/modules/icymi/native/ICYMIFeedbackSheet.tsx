...
// Dependencies: [31, 33, 9518, 1212, 8170, 8161, 2]
// Exports: default

// Module 15312 (ICYMIFeedbackSheet)
import "result";
...
export default function ICYMIFeedbackSheet() {
  ...
  obj.reasons = items;
  obj.otherKey = "other";
  obj.trackOpen = require(8170) /* listItemToType */.ICYMIAnalytics.trackFeedFeedbackPromptViewed;
