...
// Dependencies: [5, 32, 19, 17, 21, 4120, 4376, 15809, 712, 9060, 15826, 15822, 4235, 4381, 4101, 12493, 1236, 4815, 15848, 4826, 691, 689, 2]
// Exports: default

// Module 15872 (ExploreServersRow)
...
export default function ExploreServersRow(visible) {
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            closure_0 = tmp4;
            dependencyMap(true);
            v0(9060).itemInteracted("caught_up", "caught_up", "press_explore");
            const obj5 = v0(9060);
            ...
            v0(9060).feedItemActioned(obj1);
            const obj6 = v0(9060);
            v0 = 1;
            dependencyMap = 1;
            const obj2 = { value: null, done: false };
            obj2[0] = closure_1_0(15826).maybeFetchGuildDiscoveryCategories();
            return obj2;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const callback1 = React.useCallback(() => {
    sharedValue(9060).itemInteracted("caught_up", "caught_up", "press_home");
    const obj = sharedValue(9060);
    sharedValue(9060).feedItemActioned({ itemId: "caught_up", itemType: "caught_up", actionParameters: { actionGestureType: "press", actionTargetElement: "back_to_home_button", actionIntentType: "navigate", actionDestinationType: "guild_home" } });
    const obj2 = sharedValue(9060);
    const rootNavigationRef = visible(4235).getRootNavigationRef();
  ...
  obj = { visibleSharedValue: sharedValue, withTiming: visible(4381).withTiming, Easing: visible(4120).Easing };
  E.__closure = obj;
  E.__workletHash = 6575188656069;
  E.__initData = closure_11;
  const animatedStyle = obj1.useAnimatedStyle(E);
  let obj3 = visible(4120);
  const fn = function b() {
    let num = 0;
    if (sharedValue.get()) {
      let obj = visible(4120);
      const obj2 = visible(4120);
      obj = { duration: 100, easing: null };
      const Easing = visible(4120).Easing;
      obj[1] = Easing.inOut(visible(4120).Easing.ease);
      const obj3 = visible(4381);
      const withTimingResult = visible(4381).withTiming(8, obj);
      obj = { duration: 300, easing: null };
      const Easing2 = visible(4120).Easing;
      obj[1] = Easing2.out(visible(4120).Easing.ease);
      num = obj.withDelay(80, obj2.withSequence(withTimingResult, visible(4381).withTiming(0, obj)));
      const obj5 = visible(4381);
    }
    const transform = [{ translateY: num }];
    return { transform };
  };
  obj = { visibleSharedValue: sharedValue, withDelay: visible(4120).withDelay, withSequence: visible(4120).withSequence, withTiming: visible(4381).withTiming, Easing: visible(4120).Easing };
  fn.__closure = obj;
  fn.__workletHash = 469742746264;
  fn.__initData = closure_12;
  const animatedStyle1 = obj3.useAnimatedStyle(fn);
  let obj5 = visible(4120);
  const fn2 = function x() {
    ...
    if (sharedValue.get()) {
      ...
      const Easing2 = visible(4120).Easing;
      obj[1] = Easing2.out(visible(4120).Easing.ease);
      num = obj.withDelay(115, obj2.withSequence(withTimingResult, visible(4381).withTiming(0, obj)));
      const obj5 = visible(4381);
    }
    const transform = [{ translateY: num }];
    return { transform };
  };
  obj1 = { visibleSharedValue: sharedValue, withDelay: visible(4120).withDelay, withSequence: visible(4120).withSequence, withTiming: visible(4381).withTiming, Easing: visible(4120).Easing };
  fn2.__closure = obj1;
  fn2.__workletHash = 14933607481025;
  fn2.__initData = closure_13;
  const animatedStyle2 = obj5.useAnimatedStyle(fn2);
  let obj7 = visible(4101);
  const token = obj7.useToken(sharedValue(712).colors.BACKGROUND_BRAND);
  let obj2 = { children: null };
  obj3 = { style: tmp.container, children: null };
  const obj4 = { style: tmp.textContainer, children: null };
  obj5 = { style: items1, children: callback3(visible(12493).FlashIcon, obj6) };
  items1 = [tmp.iconWrapper, animatedStyle];
  const items2 = [callback3(sharedValue(4120).View, obj5), , ];
  ...
  obj10[4] = callback;
  obj10[5] = tmp4[0];
  const items6 = [callback3(visible(4815).Button, obj10), ];
  ...
  obj11[4] = callback1;
  items6[1] = callback3(visible(4815).Button, obj11);
  obj9[1] = items6;
  items5[1] = callback4(View, obj9);
  obj3[1] = items5;
  const items7 = [callback4(View, obj3), callback3(visible(15848).Separator, {}), ];
