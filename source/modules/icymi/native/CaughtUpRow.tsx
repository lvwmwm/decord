...
// Dependencies: [5, 32, 19, 17, 21, 4146, 4281, 15442, 712, 8835, 15459, 15455, 4137, 4286, 3989, 12199, 1236, 4695, 15481, 4706, 691, 689, 2]
// Exports: default

// Module 15505 (ExploreServersRow)
...
export default function ExploreServersRow(visible) {
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp4;
            dependencyMap(true);
            v0(8835).itemInteracted("caught_up", "caught_up", "press_explore");
            const obj5 = v0(8835);
  ...
  const callback1 = React.useCallback(() => {
    sharedValue(8835).itemInteracted("caught_up", "caught_up", "press_home");
    const obj = sharedValue(8835);
    sharedValue(8835).feedItemActioned({ itemId: "caught_up", itemType: "caught_up", actionParameters: { actionGestureType: "press", actionTargetElement: "back_to_home_button", actionIntentType: "navigate", actionDestinationType: "guild_home" } });
    const obj2 = sharedValue(8835);
    const rootNavigationRef = visible(4137).getRootNavigationRef();
    if (rootNavigationRef != null) {
      rootNavigationRef.navigate("tabs", { screen: "guilds" });
    }
  }, []);
  let obj1 = visible(4146);
  class E {
    constructor() {
      obj = c1;
      num = -80;
  ...
  obj = { visibleSharedValue: sharedValue, withTiming: visible(4286).withTiming, Easing: visible(4146).Easing };
  E.__closure = obj;
  E.__workletHash = 6575188656069;
  E.__initData = closure_11;
  const animatedStyle = obj1.useAnimatedStyle(E);
  let obj3 = visible(4146);
  const fn = function b() {
    let num = 0;
    if (sharedValue.get()) {
      let obj = visible(4146);
      const obj2 = visible(4146);
      obj = { duration: 100, easing: null };
      const Easing = visible(4146).Easing;
      obj[1] = Easing.inOut(visible(4146).Easing.ease);
      const obj3 = visible(4286);
      const withTimingResult = visible(4286).withTiming(8, obj);
      obj = { duration: 300, easing: null };
      const Easing2 = visible(4146).Easing;
      obj[1] = Easing2.out(visible(4146).Easing.ease);
  ...
  obj = { visibleSharedValue: sharedValue, withDelay: visible(4146).withDelay, withSequence: visible(4146).withSequence, withTiming: visible(4286).withTiming, Easing: visible(4146).Easing };
  fn.__closure = obj;
  fn.__workletHash = 469742746264;
  fn.__initData = closure_12;
  const animatedStyle1 = obj3.useAnimatedStyle(fn);
  let obj5 = visible(4146);
  ...
  obj1 = { visibleSharedValue: sharedValue, withDelay: visible(4146).withDelay, withSequence: visible(4146).withSequence, withTiming: visible(4286).withTiming, Easing: visible(4146).Easing };
  fn2.__closure = obj1;
  fn2.__workletHash = 14933607481025;
  fn2.__initData = closure_13;
  const animatedStyle2 = obj5.useAnimatedStyle(fn2);
  let obj7 = visible(3989);
