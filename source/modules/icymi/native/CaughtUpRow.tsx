...
// Dependencies: [5, 32, 19, 17, 21, 4116, 4251, 15422, 712, 8807, 15439, 15435, 4107, 4256, 3959, 12170, 1236, 4665, 15461, 4676, 691, 689, 2]
// Exports: default

// Module 15485 (ExploreServersRow)
...
let closure_9 = require("module_4116").createAnimatedComponent(require("Text").Text);
...
export default function ExploreServersRow(visible) {
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp4;
            dependencyMap(true);
            v0(8807).itemInteracted("caught_up", "caught_up", "press_explore");
            const obj5 = v0(8807);
            ...
            v0(8807).feedItemActioned(obj1);
            const obj6 = v0(8807);
            v0 = 1;
            dependencyMap = 1;
            const obj2 = { value: null, done: false };
            obj2[0] = outer1_0(15439).maybeFetchGuildDiscoveryCategories();
            return obj2;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const callback1 = React.useCallback(() => {
    sharedValue(8807).itemInteracted("caught_up", "caught_up", "press_home");
    const obj = sharedValue(8807);
    sharedValue(8807).feedItemActioned({ itemId: "caught_up", itemType: "caught_up", actionParameters: { actionGestureType: "press", actionTargetElement: "back_to_home_button", actionIntentType: "navigate", actionDestinationType: "guild_home" } });
    const obj2 = sharedValue(8807);
    const rootNavigationRef = visible(4107).getRootNavigationRef();
    if (rootNavigationRef != null) {
      rootNavigationRef.navigate("tabs", { screen: "guilds" });
    }
  }, []);
  let obj1 = visible(4116);
  class E {
    constructor() {
      obj = c1;
      num = -80;
  ...
  obj = { visibleSharedValue: sharedValue, withTiming: visible(4256).withTiming, Easing: visible(4116).Easing };
  E.__closure = obj;
  E.__workletHash = 6575188656069;
  E.__initData = closure_11;
  const animatedStyle = obj1.useAnimatedStyle(E);
  let obj3 = visible(4116);
  const fn = function b() {
    let num = 0;
    if (sharedValue.get()) {
      let obj = visible(4116);
      const obj2 = visible(4116);
      obj = { duration: 100, easing: null };
      const Easing = visible(4116).Easing;
      obj[1] = Easing.inOut(visible(4116).Easing.ease);
      const obj3 = visible(4256);
      const withTimingResult = visible(4256).withTiming(8, obj);
      obj = { duration: 300, easing: null };
      const Easing2 = visible(4116).Easing;
      obj[1] = Easing2.out(visible(4116).Easing.ease);
      num = obj.withDelay(80, obj2.withSequence(withTimingResult, visible(4256).withTiming(0, obj)));
      const obj5 = visible(4256);
    }
    const transform = [{ translateY: num }];
    return { transform };
  };
  obj = { visibleSharedValue: sharedValue, withDelay: visible(4116).withDelay, withSequence: visible(4116).withSequence, withTiming: visible(4256).withTiming, Easing: visible(4116).Easing };
  fn.__closure = obj;
  fn.__workletHash = 469742746264;
  fn.__initData = closure_12;
  const animatedStyle1 = obj3.useAnimatedStyle(fn);
  let obj5 = visible(4116);
  const fn2 = function x() {
    ...
    if (sharedValue.get()) {
      ...
      const Easing2 = visible(4116).Easing;
      obj[1] = Easing2.out(visible(4116).Easing.ease);
      num = obj.withDelay(115, obj2.withSequence(withTimingResult, visible(4256).withTiming(0, obj)));
      const obj5 = visible(4256);
    }
    const transform = [{ translateY: num }];
    return { transform };
  };
  obj1 = { visibleSharedValue: sharedValue, withDelay: visible(4116).withDelay, withSequence: visible(4116).withSequence, withTiming: visible(4256).withTiming, Easing: visible(4116).Easing };
  fn2.__closure = obj1;
  fn2.__workletHash = 14933607481025;
  fn2.__initData = closure_13;
  const animatedStyle2 = obj5.useAnimatedStyle(fn2);
  let obj7 = visible(3959);
  ...
  obj5[1] = callback3(visible(12170).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" });
  const items2 = [callback3(sharedValue(4116).View, obj5), , ];
  ...
  obj10[4] = callback;
  obj10[5] = tmp4[0];
  const items6 = [callback3(visible(4665).Button, obj10), ];
  ...
  obj11[4] = callback1;
  items6[1] = callback3(visible(4665).Button, obj11);
  obj9[1] = items6;
  items5[1] = callback4(View, obj9);
  obj3[1] = items5;
  const items7 = [callback4(View, obj3), callback3(visible(15461).Separator, {}), ];
