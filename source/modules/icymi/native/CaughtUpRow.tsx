...
// Dependencies: [5, 32, 19, 17, 21, 4116, 4251, 15411, 712, 8496, 15428, 15424, 4107, 4256, 3959, 12112, 1236, 4666, 15450, 4677, 691, 689, 2]
// Exports: default

// Module 15474 (ExploreServersRow)
...
export default function ExploreServersRow(visible) {
      ...
      try {
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            let closure_0 = tmp4;
            dependencyMap(true);
            v0(8496).itemInteracted("caught_up", "caught_up", "press_explore");
            const obj5 = v0(8496);
            ...
            obj2[0] = outer1_0(15428).maybeFetchGuildDiscoveryCategories();
            return obj2;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const callback1 = React.useCallback(() => {
    sharedValue(8496).itemInteracted("caught_up", "caught_up", "press_home");
    const obj = sharedValue(8496);
    sharedValue(8496).feedItemActioned({ itemId: "caught_up", itemType: "caught_up", actionParameters: { actionGestureType: "press", actionTargetElement: "back_to_home_button", actionIntentType: "navigate", actionDestinationType: "guild_home" } });
    const obj2 = sharedValue(8496);
  ...
  obj5[1] = callback3(visible(12112).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" });
  ...
  obj10[4] = callback;
  obj10[5] = tmp4[0];
  const items6 = [callback3(visible(4666).Button, obj10), ];
  ...
  obj11[4] = callback1;
  items6[1] = callback3(visible(4666).Button, obj11);
  obj9[1] = items6;
  items5[1] = callback4(View, obj9);
  obj3[1] = items5;
  const items7 = [callback4(View, obj3), callback3(visible(15450).Separator, {}), ];
