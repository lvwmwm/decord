...
// Dependencies: [19, 17, 21, 15442, 712, 11909, 4146, 15481, 2]
// Exports: ICYMILoading

// Module 15503 (ICYMILoadingItem)
...
function ICYMILoadingItem() {
  ...
  items[2] = tmp2;
  const items1 = [callback(importDefault(4146).View, { style: items }), ];
  ...
  items2[3] = obj2;
  obj1[0] = items2;
  items1[1] = callback(importDefault(4146).View, obj1);
  obj[1] = items1;
  ...
  items4[3] = obj4;
  obj3[0] = items4;
  items3[1] = callback(importDefault(4146).View, obj3);
  ...
  items5[3] = obj6;
  obj5[0] = items5;
  items3[2] = callback(importDefault(4146).View, obj5);
  const items6 = [, , ];
