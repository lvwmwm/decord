...
// Dependencies: [19, 17, 21, 15809, 712, 12197, 4120, 15848, 2]
// Exports: ICYMILoading

// Module 15870 (ICYMILoadingItem)
import ThemesDefault from "Themes" /* 712 */;
import _modDef4120 from "module_4120" /* 4120 */;
import useChatPlaceholderAnimatedStylesDefault from "useChatPlaceholderAnimatedStyles" /* 12197 */;
import Separator from "Separator" /* 15848 */;
...
function ICYMILoadingItem() {
  ...
  items[2] = tmp2;
  const items1 = [callback(_modDef4120.View, { style: items }), ];
  obj1 = { style: null };
  const items2 = [, , , ];
  ...
  items2[3] = obj2;
  obj1[0] = items2;
  items1[1] = callback(_modDef4120.View, obj1);
  obj[1] = items1;
  ...
  items4[3] = obj4;
  obj3[0] = items4;
  items3[1] = callback(_modDef4120.View, obj3);
  ...
  items5[3] = obj6;
  obj5[0] = items5;
  items3[2] = callback(_modDef4120.View, obj5);
  const items6 = [, , ];
  ({ backgroundColor: arr7[0], image: arr7[1] } = tmp);
  items6[2] = tmp2;
  items3[3] = callback(_modDef4120.View, { style: items6 });
  obj[1] = items3;
