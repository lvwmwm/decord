...
// Dependencies: [19, 17, 21, 15411, 712, 11849, 4116, 15450, 2]
// Exports: ICYMILoading

// Module 15472 (ICYMILoadingItem)
...
function ICYMILoadingItem() {
  ...
  let title;
  const tmp = callback3();
  const tmp2 = importDefault(11849)({ visible: true, animated: true });
  ...
  obj[1] = items3;
  const items7 = [callback2(View, obj), callback(require(15450) /* Separator */.Separator, {})];
  obj[0] = items7;
