...
// Dependencies: [19, 17, 21, 15559, 712, 11995, 4036, 15598, 2]
// Exports: ICYMILoading

// Module 15620 (ICYMILoadingItem)
...
function ICYMILoadingItem() {
  ...
  let title;
  const tmp = callback3();
  const tmp2 = importDefault(11995)({ visible: true, animated: true });
  ...
  items[2] = tmp2;
  const items1 = [callback(importDefault(4036).View, { style: items }), ];
  ...
  items2[3] = obj2;
  obj1[0] = items2;
  items1[1] = callback(importDefault(4036).View, obj1);
  obj[1] = items1;
  ...
  items4[3] = obj4;
  obj3[0] = items4;
  items3[1] = callback(importDefault(4036).View, obj3);
  ...
  items5[3] = obj6;
  obj5[0] = items5;
  items3[2] = callback(importDefault(4036).View, obj5);
  const items6 = [, , ];
  ({ backgroundColor: arr7[0], image: arr7[1] } = tmp);
  items6[2] = tmp2;
  items3[3] = callback(importDefault(4036).View, { style: items6 });
  obj[1] = items3;
  const items7 = [callback2(View, obj), callback(require(15598) /* Separator */.Separator, {})];
  obj[0] = items7;
