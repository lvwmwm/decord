...
// Dependencies: [19, 17, 21, 15888, 712, 12270, 4184, 15927, 2]
// Exports: ICYMILoading

// Module 15949 (ICYMILoadingItem)
import ThemesDefault from "Themes" /* 712 */;
import _modDef4184 from "module_4184" /* 4184 */;
import useChatPlaceholderAnimatedStylesDefault from "useChatPlaceholderAnimatedStyles" /* 12270 */;
import Separator from "Separator" /* 15927 */;
...
function ICYMILoadingItem() {
  ...
  items[2] = tmp2;
  const items1 = [callback(_modDef4184.View, { style: items }), ];
  obj1 = { style: null };
  const items2 = [, , , ];
  ...
  items2[3] = obj2;
  obj1[0] = items2;
  items1[1] = callback(_modDef4184.View, obj1);
  obj[1] = items1;
  ...
  items4[3] = obj4;
  obj3[0] = items4;
  items3[1] = callback(_modDef4184.View, obj3);
  ...
  items5[3] = obj6;
  obj5[0] = items5;
  items3[2] = callback(_modDef4184.View, obj5);
  const items6 = [, , ];
  ({ backgroundColor: arr7[0], image: arr7[1] } = tmp);
  items6[2] = tmp2;
  items3[3] = callback(_modDef4184.View, { style: items6 });
  obj[1] = items3;
