...
// Function ID: 15500
// Name: Separator
// Dependencies: [19, 17, 5843, 1372, 1971, 3912, 1903, 676, 21, 7225, 12119, 4796, 9724, 15428, 5236, 5786, 5742, 6838, 4217, 15460, 500, 712, 1297, 8216, 5700, 4701, 4827, 4281, 7023, 15500, 8527, 589, 4474, 8836, 8706, 4803, 8835, 15134, 8967, 1236, 15461, 4221, 3988, 4128, 4145, 4286, 4295, 4781, 5699, 4275, 2]
...
export const navigateToPost = function navigateToPost(id, id2, id3) {
  ...
  importDefault(5786)(closure_17.CHANNEL(id2, id, id3), { openChannel: true, navigationReplace: false });
  if (null != id3) {
    _require(5742).runAfterInteractions(() => {
