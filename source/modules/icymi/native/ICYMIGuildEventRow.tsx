...
// Dependencies: [19, 17, 5779, 1372, 1862, 21, 15316, 712, 8213, 1236, 8207, 4380, 8210, 8312, 8182, 8214, 6687, 8217, 15357, 11, 4185, 8314, 4703, 1297, 589, 2]
// Exports: default

// Module 15380 (ICYMIGuildEventRow)
...
function ICYMIGuildEventRow(event) {
  ...
  let React;
  const tmp = callback4();
  const tmp4 = guild(8213)(event, null);
  ...
  if (tmp18Result) {
    ...
    obj4[0] = guild.id;
    obj3[3] = tmp8(8314).guildEventDetailsParser(event.description, true, obj4);
    tmp18Result = tmp18(tmp8(4185).Text, obj3);
    const tmp8Result2 = tmp8(8314);
  }
  ...
  if (null != locationFromEvent) {
    result = tmp8(8314).guildEventDetailsParser(locationFromEvent, true);
    const tmp8Result3 = tmp8(8314);
  }
