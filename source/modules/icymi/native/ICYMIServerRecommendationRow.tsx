...
// Dependencies: [32, 5, 19, 17, 4247, 1862, 8792, 676, 21, 15422, 712, 589, 1416, 1411, 8075, 5221, 5646, 8807, 3956, 1236, 5185, 4251, 4665, 15461, 8309, 2]
// Exports: ICYMIServerRecommendationRow

// Module 15487 (CutoutGuildBanner)
import _slicedToArray from "_slicedToArray";
import createGuildRecordFromRust from "createGuildRecordFromRust";
import getSystemLocale from "getSystemLocale";
import { View } from "module_8807";
...
function CutoutGuildBanner(guild) {
  ...
  if (null != guild.banner) {
    ...
    let tmp12Result = tmp12(tmp13(5221), obj2);
  } else {
...
function FeaturedServer(guild) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            obj4 = undefined;
            outer1_1(true);
            outer1_1(8807).itemInteracted("recommended_guilds", "recommended_guilds", "press_join_guild");
            const obj17 = outer1_1(8807);
            ...
            outer1_1(8807).feedItemActioned(obj1);
            const obj18 = outer1_1(8807);
            const items = [outer1_0.id];
            dependencyMap = 1;
            c3 = 1;
            let obj2 = { value: null, done: false };
            obj2[0] = outer1_1(8807).gravityJoinGuild(items, "recommended_guilds");
            return obj2;
          }
        } else if (1 === tmp5) {
          if (arg0 === 1) {
            ...
            obj5[0] = obj6;
            obj4[0] = obj5;
            let obj7 = outer1_1(8807);
            const result = obj7.addedRecommendedGuild();
            let obj8 = outer1_1(8807);
  ...
  obj4[2] = stringResult;
  obj4[4] = callback;
  obj3[1] = callback3(guild(4665).Button, obj4);
...
function RecommendedGuildsRow(discoverableGuilds) {
  ...
  if (0 !== discoverableGuilds.length) {
    ...
    tmp2 = callback3(importDefault(8309), obj);
    const tmp6 = importDefault(8309);
  }
  return tmp2;
}
...
export const ICYMIServerRecommendationRow = function ICYMIServerRecommendationRow() {
  ...
  if (0 !== stateFromStoresArray.length) {
    ...
    obj[1] = items1;
    const items2 = [callback4(View, obj), callback3(tmp(15461).Separator, {})];
    obj[0] = items2;
