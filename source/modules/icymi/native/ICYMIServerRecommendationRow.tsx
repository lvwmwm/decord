...
// Dependencies: [32, 5, 19, 17, 4247, 1862, 8481, 676, 21, 15411, 712, 589, 1416, 1411, 8091, 5207, 5632, 8496, 3956, 1236, 5171, 4251, 4666, 15450, 9422, 2]
// Exports: ICYMIServerRecommendationRow

// Module 15476 (CutoutGuildBanner)
import _slicedToArray from "_slicedToArray";
import createGuildRecordFromRust from "createGuildRecordFromRust";
import getSystemLocale from "getSystemLocale";
import { View } from "module_8496";
...
function CutoutGuildBanner(guild) {
  ...
  if (null != guild.banner) {
    ...
    let tmp12Result = tmp12(tmp13(5207), obj2);
  } else {
...
function FeaturedServer(guild) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            obj4 = undefined;
            outer1_1(true);
            outer1_1(8496).itemInteracted("recommended_guilds", "recommended_guilds", "press_join_guild");
            const obj17 = outer1_1(8496);
            ...
            outer1_1(8496).feedItemActioned(obj1);
            const obj18 = outer1_1(8496);
            const items = [outer1_0.id];
            dependencyMap = 1;
            c3 = 1;
            let obj2 = { value: null, done: false };
            obj2[0] = outer1_1(8496).gravityJoinGuild(items, "recommended_guilds");
            return obj2;
          }
        } else if (1 === tmp5) {
          if (arg0 === 1) {
            ...
            obj5[0] = obj6;
            obj4[0] = obj5;
            let obj7 = outer1_1(8496);
            const result = obj7.addedRecommendedGuild();
            let obj8 = outer1_1(8496);
  ...
  const items3 = [callback3(guild(4251).Text, { maxFontSizeMultiplier: 1, lineClamp: 1, style: tmp.featuredServerTitle, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: guild.name }), callback3(guild(4251).Text, { maxFontSizeMultiplier: 1, lineClamp: 3, variant: "text-xs/normal", color: "text-default", children: guild.description })];
  obj[1] = items3;
  ...
  obj4[2] = stringResult;
  obj4[4] = callback;
  obj3[1] = callback3(guild(4666).Button, obj4);
...
function RecommendedGuildsRow(discoverableGuilds) {
  ...
  if (0 !== discoverableGuilds.length) {
    ...
    tmp2 = callback3(importDefault(9422), obj);
    const tmp6 = importDefault(9422);
  }
  return tmp2;
}
...
export const ICYMIServerRecommendationRow = function ICYMIServerRecommendationRow() {
  ...
  if (0 !== stateFromStoresArray.length) {
    ...
    const items1 = [callback3(tmp(4251).Text, obj1), , ];
