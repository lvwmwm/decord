...
// Function ID: 15632
// Name: AddEmojiButton
// Dependencies: [32, 19, 17, 5922, 1391, 5131, 3948, 676, 1925, 21, 3959, 7224, 4303, 712, 500, 4152, 589, 4313, 6920, 8643, 4846, 1236, 7657, 4299, 10205, 688, 1435, 8616, 9529, 10206, 10247, 10300, 15623, 4800, 7223, 11150, 11128, 8919, 10240, 10221, 4024, 4725, 689, 5778, 2]
// Exports: default, onAddReaction, useThread

// Module 15631 (AddEmojiButton)
...
function ForwardButton(disabled) {
  ...
  obj[5] = closure_16(importDefault(10247), { size: "sm" });
...
function ReplyButton(disabled) {
  ...
  obj[5] = closure_16(require(10300) /* ArrowAngleLeftUpIcon */.ArrowAngleLeftUpIcon, { size: "sm" });
  return closure_16(require(4846) /* PressableBase */.PressableOpacity, obj);
}
...
let closure_20 = createCacheKey.createStyles(() => {
  ...
  obj1[3] = require(4152) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.BRAND_500, 0.3);
  obj[14] = obj1;
  obj[15] = { position: "absolute", right: 0, top: 0, bottom: 0, width: 48 };
  obj[16] = { position: "absolute", right: 0 };
  const tmp4 = require;
  const tmp4Result = require(4152) /* hexToRgba */;
...
export const onAddReaction = function onAddReaction(arg0, arg1, byName) {
  if (null != byName) {
    ...
    const obj2 = require(7224) /* checkReactionResponse */;
    obj = { burst: null };
    obj[0] = arg3;
    obj2.addReaction(arg0, arg1, obj.toReactionEmoji(byName), require(7224) /* checkReactionResponse */.ReactionLocations.MESSAGE, obj);
    const toReactionEmojiResult = obj.toReactionEmoji(byName);
  }
};
