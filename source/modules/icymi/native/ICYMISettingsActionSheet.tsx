...
// Dependencies: [5, 19, 17, 4314, 8850, 8838, 676, 21, 4302, 712, 589, 8854, 5704, 5707, 1236, 5708, 8853, 5373, 7244, 692, 11, 5252, 4270, 8852, 4507, 15487, 1988, 15496, 2]
// Exports: default

// Module 15486 (ICYMISettingsActionSheet)
...
export default function ICYMISettingsActionSheet() {
  ...
  const ICYMIStaffDebuggingUtilityExperiment = stateFromStoresObject(8854).ICYMIStaffDebuggingUtilityExperiment;
  ...
  if (ICYMIStaffDebuggingUtilityExperiment.useConfig({ location: "settings action sheet" }).enabled) {
    ...
    const items1 = [callback2(tmp(5708).TableSwitchRow, obj), , ];
    ...
    items1[1] = callback2(tmp(5373).TableRow, obj2);
    ...
    items1[2] = callback2(tmp(5373).TableRow, obj3);
    obj1[0] = items1;
  ...
  items2[1] = callback2(stateFromStoresObject(5373).TableRow, obj5);
  obj[2] = items2;
  const items3 = [closure_12(stateFromStoresObject(5707).TableRowGroup, obj), ];
  const tmp4 = createCacheKey();
  items3[1] = callback2(View, { style: createCacheKey().padding });
  obj4[2] = items3;
  return closure_12(stateFromStoresObject(5704).ActionSheet, obj4);
};
