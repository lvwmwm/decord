...
// Function ID: 8983
// Name: SERVER_INVITE
// Dependencies: [676, 8983, 1486, 4535, 698, 2]

// Module 8982 (SERVER_INVITE)
...
const items = [
  ...
  (target) => {
    ...
    if (null == safeParseWithQueryResult) {
      ...
      const tryParseChannelPathResult = require(4535) /* ME */.tryParseChannelPath(safeParseWithQueryResult.path);
