...
// Function ID: 8206
// Name: SERVER_INVITE
// Dependencies: [676, 8206, 1467, 4381, 698, 2]

// Module 8205 (SERVER_INVITE)
...
const items = [
  ...
  (target) => {
    ...
    if (null == safeParseWithQueryResult) {
      ...
      const tryParseChannelPathResult = require(4381) /* ME */.tryParseChannelPath(safeParseWithQueryResult.path);
