...
// Dependencies: [5, 17, 3882, 676, 3, 3883, 3885, 3886, 3887, 3888, 3889, 1236, 4155, 500, 4157, 1469, 4170, 12983, 2]
// Exports: default

// Module 3881 (sanitizeURLPart)
import module_3883 from "module_3883";
