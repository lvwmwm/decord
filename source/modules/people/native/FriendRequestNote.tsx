...
// Module 12034 (FriendRequestNote)
...
obj = {};
obj = { padding: importDefault(dependencyMap[7]).space.PX_12, borderRadius: importDefault(dependencyMap[7]).radii.md };
obj.container = obj;
const obj1 = { "Bool(false)": false, "Bool(false)": false, "Bool(false)": false, "Bool(false)": false, "Bool(false)": false, "Bool(false)": false, "Bool(false)": false, borderRadius: importDefault(dependencyMap[7]).radii.md };
obj.spoiler = obj1;
    ...
    if (null != note) {
      ...
      if ("" !== note) {
        ...
        if (!first) {
          ...
          items4[1] = tmp15;
          obj2.style = items4;
          const obj4 = { SEARCH_PARTIAL_NAME_MATCH_MAX_QUERY_LENGTH: 44, linkText: null, addWindow: true };
          const obj5 = { size: "sm" };
