...
// Function ID: 11206
// Name: render
// Dependencies: [19, 17, 8948, 21, 1625, 530, 4058, 11206, 4754, 8287, 1236, 1297, 2]
...
export const openUrl = function openUrl(arg0, ALBUM, album_id) {
  if (arg0) {
    ...
    catchPromise = importDefault(4058).openURL(closure_7.WEB_OPEN(ALBUM, album_id, "mobile"));
