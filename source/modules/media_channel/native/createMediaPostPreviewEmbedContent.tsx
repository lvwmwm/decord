...
// Dependencies: [17, 4284, 1372, 1891, 4101, 1903, 10327, 4470, 4476, 1236, 7992, 7994, 712, 4472, 12548, 6980, 4500, 4471, 2]
// Exports: default

// Module 12547 (createMediaPostPreviewEmbedContent)
        ...
        if (null == mediaPostEmbedCommonData) {
          ...
          if (null != mediaPostEmbedCommonData.authorName) {
            if (null != mediaPostEmbedCommonData.channelName) {
              if (null != user) {
                const userAuthorWithProcessedColor = tmp(7992).getUserAuthorWithProcessedColor(user, mediaPostEmbedCommonData.postThread);
              ...
              if (mediaPostEmbedCommonData.shouldShowBlurredThumbnailImage) {
                ...
                obj2.blurredCoverImage = closure_3.resolveAssetSource(tmp10(12548)).uri;
                ...
                const isPendingScanVersionResult = tmp(6980).isPendingScanVersion(mediaPostEmbedCommonData.contentScanVersion);
                let result = value;
                if (value) {
                  result = tmp(6980).shouldAgeVerifyForExplicitMedia();
                  const tmpResult4 = tmp(6980);
                }
