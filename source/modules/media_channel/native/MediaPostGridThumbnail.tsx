...
// Dependencies: [19, 17, 21, 11456, 5308, 500, 2]
// Exports: default

// Module 11458 (MediaPostGridThumbnailAndroid)
import "noop";
...
function MediaPostGridThumbnailAndroid(arg0) {
  ...
  if (null == backgroundImagesource) {
    ...
    obj[0] = shouldSpoiler;
    obj[1] = blurTheme;
    obj[4] = callback(require(11456) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj);
    ...
    obj2[1] = blurTheme;
    items[1] = callback(require(11456) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj2);
    obj[4] = items;
...
function MediaPostGridThumbnailIOS(arg0) {
  ...
  if (null == backgroundImagesource) {
    ...
    obj[0] = shouldSpoiler;
    obj[1] = blurTheme;
    items[1] = callback(require(11456) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj);
    obj[0] = items;
    let obj1 = obj;
  } else {
    obj1 = { children: null };
    ...
    obj4[1] = blurTheme;
    items2[2] = callback(require(11456) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj4);
    obj1[0] = items2;
  }
