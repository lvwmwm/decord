...
// Dependencies: [19, 17, 21, 11284, 5221, 500, 2]
// Exports: default

// Module 11286 (MediaPostGridThumbnailAndroid)
import "noop";
...
function MediaPostGridThumbnailAndroid(arg0) {
  ...
  if (null == backgroundImagesource) {
    ...
    obj[0] = shouldSpoiler;
    obj[1] = blurTheme;
    obj[4] = callback(require(11284) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj);
    ...
    obj1[1] = source;
    obj1[2] = tmp;
    const items = [callback(importDefault(5221), obj1), ];
    const obj2 = { shouldSpoiler: null, blurTheme: null };
    obj2[0] = shouldSpoiler;
    obj2[1] = blurTheme;
    items[1] = callback(require(11284) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj2);
    obj[4] = items;
...
function MediaPostGridThumbnailIOS(arg0) {
  ...
  if (null == backgroundImagesource) {
    ...
    obj[0] = shouldSpoiler;
    obj[1] = blurTheme;
    items[1] = callback(require(11284) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj);
    obj[0] = items;
    let obj1 = obj;
  } else {
    obj1 = { children: null };
    ...
    const items2 = [callback(importDefault(5221), obj2), , ];
    const obj3 = { style: null, source: null, resizeMode: null };
    obj3[0] = iosStyle;
    obj3[1] = source;
    obj3[2] = resizeMode;
    items2[1] = callback(importDefault(5221), obj3);
    const obj4 = { shouldSpoiler: null, blurTheme: null };
    obj4[0] = shouldSpoiler;
    obj4[1] = blurTheme;
    items2[2] = callback(require(11284) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj4);
    obj1[0] = items2;
  }
