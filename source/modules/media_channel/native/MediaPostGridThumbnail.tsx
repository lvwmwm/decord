...
// Dependencies: [31, 27, 33, 11123, 5085, 477, 2]
// Exports: default
...
function MediaPostGridThumbnailAndroid(arg0) {
  ...
  if (null == backgroundImagesource) {
    ...
    obj.children = callback(require(11123) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj);
    ...
    items[1] = callback(require(11123) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj3);
    obj.children = items;
...
function MediaPostGridThumbnailIOS(arg0) {
  ...
  if (null == backgroundImagesource) {
    ...
    obj = { shouldSpoiler, blurTheme };
    items[1] = callback(require(11123) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj);
    obj.children = items;
    let obj1 = obj;
  } else {
    obj1 = {};
    ...
    items2[2] = callback(require(11123) /* ForumPostMediaAndroid */.ForumPostMediaSpoiler, obj5);
