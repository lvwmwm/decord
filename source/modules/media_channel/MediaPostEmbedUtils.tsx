...
// Dependencies: [1910, 3998, 1922, 676, 4531, 1236, 4534, 1435, 1403, 4535, 4326, 4536, 2]
// Exports: canUseMediaPostEmbed, getMediaPostEmbedChannelId, getMediaPostEmbedChannelPath, getMediaPostEmbedCommonData

// Module 4530 (getMediaPostEmbedCommonData)
...
export const getMediaPostEmbedCommonData = function getMediaPostEmbedCommonData(arg0) {
  ...
  if (null == mediaPostEmbedData) {
    ...
    const thumbnailImage = require(4531) /* MAX_THUMBNAIL_COUNT */.getThumbnailImage(mediaPostEmbedData.thumbnail);
    if (!canAccess) {
    ...
    const obj7 = require(4531) /* MAX_THUMBNAIL_COUNT */;
...
export const getMediaPostEmbedChannelId = function getMediaPostEmbedChannelId(url) {
  ...
  if (null != url) {
    const parseURLSafelyResult = require(4326) /* getPathsFromURL */.parseURLSafely(url);
