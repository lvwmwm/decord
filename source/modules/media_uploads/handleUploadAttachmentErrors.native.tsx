...
// Dependencies: [676, 4960, 4919, 8429, 4705, 1236, 12658, 2]
// Exports: handleUploadMessageAttachmentsErrors

// Module 8428 (handleUploadMessageAttachmentsErrors)
import ME from "ME";
...
export const handleUploadMessageAttachmentsErrors = function handleUploadMessageAttachmentsErrors(arg0) {
  ...
  if (undefined === code) {
    ...
    const kestrelConfig = require(4960) /* KESTREL_GA_UPLOAD_LIMIT_MB */.getKestrelConfig({ location: "native.handleUploadMessageAttachmentsErrors" });
    const obj10 = require(4960) /* KESTREL_GA_UPLOAD_LIMIT_MB */;
    const maxFileSizeResult = require(4919) /* getUploadFileSizeSum */.maxFileSize(guildId);
    let obj = { file: null, maxSize: null, baseMaxSize: null, guildId: null, analyticsLocations: null, errorReason: null };
    obj[0] = tmp;
    const obj11 = require(4919) /* getUploadFileSizeSum */;
    const tmp27 = importDefault(8429);
    obj[1] = require(4960) /* KESTREL_GA_UPLOAD_LIMIT_MB */.getEffectiveKestrelLimit(kestrelConfig, maxFileSizeResult);
    ...
    importDefault(4705).show(obj2);
    return true;
  } else if (code === tmp31.INVALID_FILE_ASSET) {
    obj2 = importDefault(4705);
    ...
    obj = require(12658) /* getAttachmentUploadAbortAlertContent */;
