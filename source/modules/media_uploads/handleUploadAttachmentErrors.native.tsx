...
// Dependencies: [676, 4938, 4897, 8407, 4683, 1236, 12640, 2]
// Exports: handleUploadMessageAttachmentsErrors

// Module 8406 (handleUploadMessageAttachmentsErrors)
import ME from "ME";
...
export const handleUploadMessageAttachmentsErrors = function handleUploadMessageAttachmentsErrors(arg0) {
  ...
  if (undefined === code) {
    ...
    const kestrelConfig = require(4938) /* KESTREL_GA_UPLOAD_LIMIT_MB */.getKestrelConfig({ location: "native.handleUploadMessageAttachmentsErrors" });
    const obj10 = require(4938) /* KESTREL_GA_UPLOAD_LIMIT_MB */;
    const maxFileSizeResult = require(4897) /* getUploadFileSizeSum */.maxFileSize(guildId);
    let obj = { file: null, maxSize: null, baseMaxSize: null, guildId: null, analyticsLocations: null, errorReason: null };
    obj[0] = tmp;
    const obj11 = require(4897) /* getUploadFileSizeSum */;
    const tmp27 = importDefault(8407);
    obj[1] = require(4938) /* KESTREL_GA_UPLOAD_LIMIT_MB */.getEffectiveKestrelLimit(kestrelConfig, maxFileSizeResult);
    ...
    importDefault(4683).show(obj2);
    return true;
  } else if (code === tmp31.INVALID_FILE_ASSET) {
    obj2 = importDefault(4683);
    ...
    obj = require(12640) /* getAttachmentUploadAbortAlertContent */;
