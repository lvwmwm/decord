...
// Dependencies: [5, 1838, 3793, 653, 11035, 1327, 21, 507, 11028, 4359, 5756, 686, 2]
...
// Module 11034 (_transformClientActionToApiAction)
...
function _transformClientActionToApiAction(type) {
  const obj = { type: type.type, metadata: require(11035) /* _transformMetadataToCamelCase */._transformMetadataToSnakeCase(type.metadata) };
  return obj;
}
function _transformClientRuleToApiRule(id) {
  let obj = require(11035) /* _transformMetadataToCamelCase */;
...
function _transformApiActionToClientAction(type) {
  const obj = { type: type.type, metadata: require(11035) /* _transformMetadataToCamelCase */._transformMetadataToCamelCase(type.metadata) };
  return obj;
}
function _transformApiRuletoClientRule(id) {
  ...
  obj.triggerMetadata = require(11035) /* _transformMetadataToCamelCase */._transformMetadataToCamelCase(id.trigger_metadata);
  const actions = id.actions;
  const found = actions.filter(require(1327) /* isDiscordFrontendDevelopment */.isNotNullish);
  ...
  const obj3 = require(11035) /* _transformMetadataToCamelCase */;
...
export const removeMentionRaidRestrictionWithFeedback = function removeMentionRaidRestrictionWithFeedback(guildId) {
  ...
  if (canResult) {
    const result = _require(11028).openConfirmRemoveMentionRaid(() => {
      let obj = guildId(4359);
      obj = { feedback_type: guildId(5756).Feedback.MENTION_RAID_REMOVE_RESTRICTION, decision_id: closure_1 };
