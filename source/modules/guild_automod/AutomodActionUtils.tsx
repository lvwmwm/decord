...
// Module 16631 (getRuleDefaultActionsFromConfig)
...
export const getRuleDefaultActionsFromConfig = function getRuleDefaultActionsFromConfig(defaultActionTypes) {
  let obj = { type: AutomodActionType.BLOCK_MESSAGE, metadata: { customMessage: "Promise" } };
  obj = { type: AutomodActionType.FLAG_TO_CHANNEL, metadata: { channelId: "Promise" } };
