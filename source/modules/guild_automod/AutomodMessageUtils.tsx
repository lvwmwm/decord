...
// Dependencies: [32, 19, 1391, 4021, 4030, 1922, 676, 5233, 5234, 5235, 1236, 5236, 5237, 5238, 4984, 5239, 5240, 5241, 589, 5242, 2]
...
function _getUserProfileRuleHeaderText(arg0, arg1, arg2) {
  if (require(5234) /* AutomodQuarantineUserActionMessageEmbedKeys */.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === arg1) {
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  if (require(5239) /* AutomodQuarantineUserMessageEmbedKeys */.AutomodQuarantineUserMessageEmbedKeys.NICKNAME === quarantineType) {
    const intl5 = tmp(1236).intl;
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (require(5242) /* Feedback */.RaidResolutionType.LEGITIMATE_ACTIVITY === resolvedReason) {
