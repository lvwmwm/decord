...
// Dependencies: [32, 19, 1372, 3929, 3938, 1903, 676, 6968, 6969, 6970, 1236, 6971, 6972, 6973, 4494, 6974, 6975, 6976, 589, 6977, 2]
...
// Module 6967 (getDecisionOutcomeFromMessage)
...
function _getUserProfileRuleHeaderText(arg0, arg1, arg2) {
  if (require(6969) /* AutomodQuarantineUserActionMessageEmbedKeys */.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === arg1) {
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  if (require(6974) /* AutomodQuarantineUserMessageEmbedKeys */.AutomodQuarantineUserMessageEmbedKeys.NICKNAME === quarantineType) {
    const intl5 = tmp(1236).intl;
...
export const extractAutomodNotificationFields = function extractAutomodNotificationFields(message) {
  _require = _require(6975).AutomodNotificationEmbedKeys.NOTIFICATION_TYPE;
  let embeds = message.embeds;
  if (embeds == null) {
    embeds = [];
  }
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (require(6977) /* Feedback */.RaidResolutionType.LEGITIMATE_ACTIVITY === resolvedReason) {
