...
// Dependencies: [32, 19, 1391, 3989, 3998, 1922, 676, 7038, 7039, 7040, 1236, 7041, 7042, 7043, 4535, 7044, 7045, 7046, 589, 7047, 2]
...
// Module 7037 (getDecisionOutcomeFromMessage)
...
function _getUserProfileRuleHeaderText(arg0, arg1, arg2) {
  if (require(7039) /* AutomodQuarantineUserActionMessageEmbedKeys */.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === arg1) {
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  if (require(7044) /* AutomodQuarantineUserMessageEmbedKeys */.AutomodQuarantineUserMessageEmbedKeys.NICKNAME === quarantineType) {
    const intl5 = tmp(1236).intl;
...
export const extractAutomodNotificationFields = function extractAutomodNotificationFields(message) {
  _require = _require(7045).AutomodNotificationEmbedKeys.NOTIFICATION_TYPE;
  let embeds = message.embeds;
  if (embeds == null) {
    embeds = [];
  }
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (require(7047) /* Feedback */.RaidResolutionType.LEGITIMATE_ACTIVITY === resolvedReason) {
