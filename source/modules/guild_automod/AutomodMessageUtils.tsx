...
// Dependencies: [32, 19, 1391, 3948, 3957, 1922, 676, 6971, 6972, 6973, 1236, 6974, 6975, 6976, 4494, 6977, 6978, 6979, 589, 6980, 2]
...
// Module 6970 (getDecisionOutcomeFromMessage)
...
function _getUserProfileRuleHeaderText(arg0, arg1, arg2) {
  if (require(6972) /* AutomodQuarantineUserActionMessageEmbedKeys */.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === arg1) {
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  if (require(6977) /* AutomodQuarantineUserMessageEmbedKeys */.AutomodQuarantineUserMessageEmbedKeys.NICKNAME === quarantineType) {
    const intl5 = tmp(1236).intl;
...
export const extractAutomodNotificationFields = function extractAutomodNotificationFields(message) {
  _require = _require(6978).AutomodNotificationEmbedKeys.NOTIFICATION_TYPE;
  let embeds = message.embeds;
  if (embeds == null) {
    embeds = [];
  }
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (require(6980) /* Feedback */.RaidResolutionType.LEGITIMATE_ACTIVITY === resolvedReason) {
