...
// Dependencies: [32, 19, 1391, 3989, 3998, 1922, 676, 7010, 7011, 7012, 1236, 7013, 7014, 7015, 4534, 7016, 7017, 7018, 589, 7019, 2]
...
// Module 7009 (getDecisionOutcomeFromMessage)
...
function _getUserProfileRuleHeaderText(arg0, arg1, arg2) {
  if (require(7011) /* AutomodQuarantineUserActionMessageEmbedKeys */.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === arg1) {
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  if (require(7016) /* AutomodQuarantineUserMessageEmbedKeys */.AutomodQuarantineUserMessageEmbedKeys.NICKNAME === quarantineType) {
    const intl5 = tmp(1236).intl;
...
export const extractAutomodNotificationFields = function extractAutomodNotificationFields(message) {
  _require = _require(7017).AutomodNotificationEmbedKeys.NOTIFICATION_TYPE;
  let embeds = message.embeds;
  if (embeds == null) {
    embeds = [];
  }
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (require(7019) /* Feedback */.RaidResolutionType.LEGITIMATE_ACTIVITY === resolvedReason) {
