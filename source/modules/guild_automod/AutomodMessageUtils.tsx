...
// Dependencies: [32, 19, 1372, 3817, 3826, 1874, 676, 5765, 5766, 5767, 1236, 5768, 5769, 5770, 4380, 5771, 5772, 5773, 589, 5774, 2]
...
// Module 5764 (getDecisionOutcomeFromMessage)
...
function getDecisionOutcomeFromMessage(embeds) {
  DECISION_OUTCOME = DECISION_OUTCOME(5765).AutomodMessageEmbedKeys.DECISION_OUTCOME;
...
function getQuarantineTypeFromMessage(embeds) {
  QUARANTINE_USER = QUARANTINE_USER(5765).AutomodMessageEmbedKeys.QUARANTINE_USER;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
...
function getQuarantineActionFromMessage(embeds) {
  QUARANTINE_USER_ACTION = QUARANTINE_USER_ACTION(5765).AutomodMessageEmbedKeys.QUARANTINE_USER_ACTION;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
...
function getProfileUpdateTypeFromMessage(embeds) {
  BLOCK_PROFILE_UPDATE_TYPE = BLOCK_PROFILE_UPDATE_TYPE(5765).AutomodMessageEmbedKeys.BLOCK_PROFILE_UPDATE_TYPE;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
...
function getQuarantineEventFromMessage(embeds) {
  QUARANTINE_EVENT = QUARANTINE_EVENT(5765).AutomodMessageEmbedKeys.QUARANTINE_EVENT;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
...
function _getUserProfileRuleHeaderText(arg0, arg1, arg2) {
  if (require(5766) /* AutomodQuarantineUserActionMessageEmbedKeys */.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === arg1) {
    if (tmp(5767).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_UPDATE === arg0) {
      const intl6 = tmp(1236).intl;
      let stringResult = intl6.string(tmp(1236).t.t98DPb);
    } else if (tmp(5767).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_RESET === arg0) {
      const intl5 = tmp(1236).intl;
      stringResult = intl5.string(tmp(1236).t["7u/rlU"]);
    }
    return stringResult;
  } else if (tmp(5766).AutomodQuarantineUserActionMessageEmbedKeys.QUARANTINE_USER === arg1) {
    if (tmp(5768).AutomodQuarantineEventMessageEmbedKeys.MESSAGE_SEND === arg2) {
      const intl4 = tmp(1236).intl;
      let stringResult1 = intl4.string(tmp(1236).t.PmSMMS);
    } else if (tmp(5768).AutomodQuarantineEventMessageEmbedKeys.GUILD_JOIN === arg2) {
      const intl3 = tmp(1236).intl;
      stringResult1 = intl3.string(tmp(1236).t.m9wWzo);
    } else if (tmp(5768).AutomodQuarantineEventMessageEmbedKeys.USERNAME_UPDATE === arg2) {
      const intl2 = tmp(1236).intl;
      stringResult1 = intl2.string(tmp(1236).t.KNSkC6);
    } else if (tmp(5768).AutomodQuarantineEventMessageEmbedKeys.CLAN_TAG_UPDATE === arg2) {
      const intl7 = tmp(1236).intl;
      stringResult1 = intl7.string(tmp(1236).t.qV4K6j);
    }
    return stringResult1;
  } else if (tmp(5766).AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_GUEST_JOIN === arg1) {
    const intl = tmp(1236).intl;
    return intl.string(tmp(1236).t.MrYeyS);
  }
}
function extractAutomodMessageFields(message) {
  INTERACTION_CALLBACK_TYPE = INTERACTION_CALLBACK_TYPE(5765).AutomodMessageEmbedKeys.CHANNEL_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.ALERT_ACTIONS_EXECUTION;
  ...
  const result = INTERACTION_CALLBACK_TYPE(5773).parseAlertActionsExecution(tmp11);
  ...
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.RULE_NAME;
  ...
  obj[1] = tmp19;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.DECISION_ID;
  ...
  obj[2] = tmp25;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.KEYWORD;
  ...
  obj[3] = tmp31;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.KEYWORD_MATCHED_CONTENT;
  ...
  obj[4] = tmp37;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.FLAGGED_MESSAGE_ID;
  ...
  obj[5] = tmp43;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.TIMEOUT_DURATION;
  ...
  obj[6] = tmp49;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.QUARANTINE_USER;
  ...
  obj[7] = tmp55;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.QUARANTINE_USER_ACTION;
  ...
  obj[8] = tmp61;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.DECISION_REASON;
  ...
  obj[9] = tmp67;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  obj[10] = tmp73;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.INTERACTION_USER_ID;
  ...
  obj[11] = tmp79;
  INTERACTION_CALLBACK_TYPE = tmp(5765).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
...
export const getActionHeaderTextMobile = function getActionHeaderTextMobile(message, author, interactionUserId) {
  ...
  APPLICATION_NAME = APPLICATION_NAME(5765).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
  let embeds = message.embeds;
  if (embeds == null) {
    embeds = [];
  }
  ...
  APPLICATION_NAME = Xy2Iw_(5765).AutomodMessageEmbedKeys.APPLICATION_NAME;
  let embeds1 = message.embeds;
  if (embeds1 == null) {
    embeds1 = [];
  }
  ...
  if (null != tmp15) {
    ...
    if (tmp9 === Xy2Iw_(5769).AutomodInteractionCallbackTypeEmbedKeys.MODAL) {
      if (null != username2) {
        if (tmp6 !== Xy2Iw_(5770).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
...
export const getActionHeaderText = function getActionHeaderText(embeds, channel) {
  ...
  _require = _4xL9Sk(5765).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
  ...
  _require = _4xL9Sk(5765).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  _require = format(5765).AutomodMessageEmbedKeys.VOICE_CHANNEL_STATUS_OUTCOME;
  ...
  if (null == tmp31) {
    if (null != null) {
      ...
      if (null == tmp21) {
        if (tmp12 !== _4xL9Sk(5770).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
      ...
      if (tmp15 !== _4xL9Sk(5769).AutomodInteractionCallbackTypeEmbedKeys.MODAL) {
        if (tmp12 !== _4xL9Sk(5770).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  if (require(5771) /* AutomodQuarantineUserMessageEmbedKeys */.AutomodQuarantineUserMessageEmbedKeys.NICKNAME === quarantineType) {
    const intl5 = tmp(1236).intl;
    return intl5.string(tmp(1236).t["fkBQa/"]);
  } else if (tmp(5771).AutomodQuarantineUserMessageEmbedKeys.USERNAME === quarantineType) {
    const intl4 = tmp(1236).intl;
    return intl4.string(tmp(1236).t.pJQVnr);
  } else if (tmp(5771).AutomodQuarantineUserMessageEmbedKeys.GLOBAL_NAME === quarantineType) {
    const intl3 = tmp(1236).intl;
    return intl3.string(tmp(1236).t.V9eJ85);
  } else if (tmp(5771).AutomodQuarantineUserMessageEmbedKeys.CLAN_TAG === quarantineType) {
    const intl2 = tmp(1236).intl;
...
export const extractAutomodNotificationFields = function extractAutomodNotificationFields(message) {
  _require = _require(5772).AutomodNotificationEmbedKeys.NOTIFICATION_TYPE;
  let embeds = message.embeds;
  if (embeds == null) {
    embeds = [];
  }
  ...
  _require = tmp(5772).AutomodNotificationEmbedKeys.JOIN_ATTEMPTS;
  let embeds1 = message.embeds;
  if (embeds1 == null) {
    embeds1 = [];
  }
  ...
  _require = tmp(5772).AutomodNotificationEmbedKeys.RAID_DATETIME;
  let embeds2 = message.embeds;
  if (embeds2 == null) {
    embeds2 = [];
  }
  ...
  _require = tmp(5772).AutomodNotificationEmbedKeys.DMS_SENT;
  let embeds3 = message.embeds;
  if (embeds3 == null) {
    embeds3 = [];
  }
  ...
  _require = tmp(5772).AutomodNotificationEmbedKeys.RAID_TYPE;
  let embeds4 = message.embeds;
  if (embeds4 == null) {
    embeds4 = [];
  }
  ...
  _require = tmp(5772).AutomodNotificationEmbedKeys.RESOLVED_REASON;
  let embeds5 = message.embeds;
  if (embeds5 == null) {
    embeds5 = [];
  }
  ...
  _require = tmp(5772).AutomodNotificationEmbedKeys.DECISION_ID;
  let embeds6 = message.embeds;
  if (embeds6 == null) {
    embeds6 = [];
  }
  ...
  _require = tmp(5772).AutomodNotificationEmbedKeys.SUSPICIOUS_MENTION_ACTIVITY_UNTIL;
  let embeds7 = message.embeds;
  if (embeds7 == null) {
    embeds7 = [];
  }
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (require(5774) /* Feedback */.RaidResolutionType.LEGITIMATE_ACTIVITY === resolvedReason) {
    const intl4 = tmp3(1236).intl;
    return intl4.string(tmp3(1236).t["riQ+HH"]);
  } else if (tmp3(5774).RaidResolutionType.DM_SPAM === resolvedReason) {
    const intl3 = tmp3(1236).intl;
    return intl3.string(tmp3(1236).t.j5V0ij);
  } else if (tmp3(5774).RaidResolutionType.JOIN_RAID === resolvedReason) {
...
export const getUserIdOfAutomodAction = function getUserIdOfAutomodAction(message) {
  ACTION_BY_USER_ID = ACTION_BY_USER_ID(5772).AutomodNotificationEmbedKeys.ACTION_BY_USER_ID;
  let embeds = message.embeds;
  if (embeds == null) {
    embeds = [];
  }
