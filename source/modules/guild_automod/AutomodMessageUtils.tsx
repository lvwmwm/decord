...
// Dependencies: [32, 19, 1372, 3929, 3938, 1903, 676, 6908, 6909, 6910, 1236, 6911, 6912, 6913, 4492, 6914, 6915, 6916, 589, 6917, 2]
...
// Module 6907 (getDecisionOutcomeFromMessage)
...
function _getUserProfileRuleHeaderText(arg0, arg1, arg2) {
  if (require(6909) /* AutomodQuarantineUserActionMessageEmbedKeys */.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === arg1) {
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  if (require(6914) /* AutomodQuarantineUserMessageEmbedKeys */.AutomodQuarantineUserMessageEmbedKeys.NICKNAME === quarantineType) {
    const intl5 = tmp(1236).intl;
...
export const extractAutomodNotificationFields = function extractAutomodNotificationFields(message) {
  _require = _require(6915).AutomodNotificationEmbedKeys.NOTIFICATION_TYPE;
  let embeds = message.embeds;
  if (embeds == null) {
    embeds = [];
  }
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (require(6917) /* Feedback */.RaidResolutionType.LEGITIMATE_ACTIVITY === resolvedReason) {
