...
// Dependencies: [1218, 16542, 11195, 16544, 16545, 1236, 7263, 6920, 2]
...
// Module 16541 (getNewAutomodRuleMockId)
...
export const createDefaultRule = function createDefaultRule(arg0, arg1) {
  let obj = require(16544) /* AutomodTriggerType */.triggerConfigs[arg1];
  ...
  const defaultTriggerMetadataForTriggerType = require(16544) /* AutomodTriggerType */.getDefaultTriggerMetadataForTriggerType(arg1, arg0);
  ...
  obj[7] = id.getId();
  const obj2 = require(16544) /* AutomodTriggerType */;
  obj[8] = require(16545) /* getRuleDefaultActionsFromConfig */.getRuleDefaultActionsFromConfig(obj);
  const obj4 = require(16545) /* getRuleDefaultActionsFromConfig */;
  obj[10] = new Set();
  const set = new Set();
  obj[11] = new Set();
  const set1 = new Set();
  ...
  obj5 = require(6920) /* buildCommand */;
};
...
export const isBackendPersistedRule = function isBackendPersistedRule(id) {
  ...
  return require(6920) /* buildCommand */.isSnowflake(str);
};
