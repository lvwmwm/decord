...
// Dependencies: [32, 109, 19, 17, 1218, 1971, 1891, 11195, 676, 3917, 21, 4302, 712, 4730, 1236, 1297, 11203, 4298, 11204, 5956, 647, 3935, 4728, 698, 2]
// Exports: default

// Module 11202 (ChatBlockedAlert)
...
function ChatBlockedAlert(arg0) {
  ...
  obj[0] = importDefault(11203);
  obj[1] = require(1297) /* Button */.Icon.Sizes.CUSTOM;
  obj[2] = tmp2.mainIcon;
  const items = [closure_16(require(1297) /* Button */.Icon, obj), closure_16(require(4298) /* Text */.Text, { style: tmp2.title, accessibilityRole: "header", variant: "heading-md/medium", color: "mobile-text-heading-primary", children: title }), closure_16(require(4298) /* Text */.Text, { style: tmp2.description, variant: "text-sm/medium", color: "text-default", children: description })];
  obj[1] = items;
  obj.children = callback4(View, obj);
  return closure_16(importDefault(4730), obj);
}
function PerServerProfileAlert(arg0) {
  ...
  const tmp2Result = tmp2(11204);
  [require, tmp8] = callback(tmp2(11204).useOpenFixQuarantinedProfileModal({ guildId }), 2);
  if (!tmp8) {
