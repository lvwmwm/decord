...
// Dependencies: [32, 109, 19, 17, 1218, 1990, 1910, 11042, 676, 4009, 21, 4661, 712, 4763, 1236, 1297, 11050, 4734, 11051, 7360, 647, 4027, 4761, 698, 2]
// Exports: default
...
function ChatBlockedAlert(arg0) {
  ...
  obj[2] = tmp2.mainIcon;
  const items = [closure_16(require(1297) /* Button */.Icon, obj), closure_16(require(4734) /* Text */.Text, { style: tmp2.title, accessibilityRole: "header", variant: "heading-md/medium", color: "mobile-text-heading-primary", children: title }), closure_16(require(4734) /* Text */.Text, { style: tmp2.description, variant: "text-sm/medium", color: "text-default", children: description })];
  obj[1] = items;
  obj.children = callback4(View, obj);
  return closure_16(importDefault(4763), obj);
}
