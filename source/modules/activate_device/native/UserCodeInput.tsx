...
// Function ID: 13588
// Name: UserCodeInput
// Dependencies: [32, 19, 17, 13588, 21, 4448, 13589, 13590, 4444, 1236, 7673, 4896, 2]
// Exports: UserCodeInput

// Module 13587 (UserCodeInput)
...
export const UserCodeInput = function UserCodeInput(prefilledUserCode) {
  ...
  const items = [callback2(_require(4444).Text, obj1), ];
  ...
  obj3[6] = error;
  items1[1] = callback2(_require(7673).TextInput, obj3);
  ...
  items1[2] = callback2(_require(4896).Button, obj5);
  obj[0] = items1;
