...
// Function ID: 13554
// Name: UserCodeInput
// Dependencies: [32, 19, 17, 13554, 21, 4446, 13555, 13556, 4442, 1236, 7652, 4893, 2]
// Exports: UserCodeInput

// Module 13553 (UserCodeInput)
...
export const UserCodeInput = function UserCodeInput(prefilledUserCode) {
  ...
  const items = [callback2(_require(4442).Text, obj1), ];
  ...
  obj3[6] = error;
  items1[1] = callback2(_require(7652).TextInput, obj3);
  ...
  items1[2] = callback2(_require(4893).Button, obj5);
  obj[0] = items1;
