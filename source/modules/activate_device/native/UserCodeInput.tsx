...
// Function ID: 13159
// Name: UserCodeInput
// Dependencies: [32, 19, 17, 13159, 21, 4302, 13160, 13161, 4298, 1236, 7730, 4712, 2]
// Exports: UserCodeInput

// Module 13158 (UserCodeInput)
...
export const UserCodeInput = function UserCodeInput(prefilledUserCode) {
  ...
  const items = [callback2(_require(4298).Text, obj1), ];
  ...
  obj3[6] = error;
  items1[1] = callback2(_require(7730).TextInput, obj3);
  ...
  items1[2] = callback2(_require(4712).Button, obj5);
  obj[0] = items1;
