...
// Function ID: 13231
// Name: UserCodeInput
// Dependencies: [32, 19, 17, 13231, 21, 4303, 13232, 13233, 4299, 1236, 7790, 4714, 2]
// Exports: UserCodeInput

// Module 13230 (UserCodeInput)
...
export const UserCodeInput = function UserCodeInput(prefilledUserCode) {
  ...
  const items = [callback2(_require(4299).Text, obj1), ];
  ...
  obj3[6] = error;
  items1[1] = callback2(_require(7790).TextInput, obj3);
  ...
  items1[2] = callback2(_require(4714).Button, obj5);
  obj[0] = items1;
