...
// Function ID: 13435
// Name: UserCodeInput
// Dependencies: [32, 19, 17, 13435, 21, 4380, 13436, 13437, 4376, 1236, 7935, 4815, 2]
// Exports: UserCodeInput

// Module 13434 (UserCodeInput)
...
export const UserCodeInput = function UserCodeInput(prefilledUserCode) {
  ...
  const items = [callback2(_require(4376).Text, obj1), ];
  ...
  obj3[6] = error;
  items1[1] = callback2(_require(7935).TextInput, obj3);
  ...
  items1[2] = callback2(_require(4815).Button, obj5);
  obj[0] = items1;
