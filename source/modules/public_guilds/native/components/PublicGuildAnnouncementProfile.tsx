...
// Dependencies: [19, 17, 21, 4255, 712, 5323, 5221, 7923, 1297, 10999, 4251, 1236, 2]
// Exports: default

// Module 10998 (PublicGuildAnnouncementProfile)
import "noop";
...
export default function PublicGuildAnnouncementProfile() {
  ...
  let obj3 = require(7923) /* isPublicSystemMessage */;
