...
// Dependencies: [19, 17, 21, 4344, 712, 5436, 5307, 8182, 1297, 11171, 4340, 1236, 2]
// Exports: default

// Module 11170 (PublicGuildAnnouncementProfile)
import "noop";
...
export default function PublicGuildAnnouncementProfile() {
  ...
  let obj3 = require(8182) /* isPublicSystemMessage */;
  ...
  items[3] = callback(require(4340) /* Text */.Text, obj5);
  obj[1] = items;
