...
// Dependencies: [32, 19, 17, 8916, 1935, 7924, 676, 21, 3959, 712, 589, 3888, 8915, 506, 16565, 16607, 16606, 16604, 1236, 4251, 4663, 5634, 16616, 5635, 1945, 2]
// Exports: default

// Module 16618 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const tmp19 = first(16607)();
  const enableCommunitySharedStyles = guild(16606).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: null, onSuccess: null, disableNextStep: null, buttonText: null, children: null };
  obj[1] = guild(16604).EnableCommunityModalSteps.STEP_3;
  obj[2] = callback1;
  obj[3] = !first1;
  ...
  const items2 = [callback2(guild(4251).Text, obj1), , , ];
  ...
  items2[2] = callback2(guild(4251).Heading, obj3);
  ...
  items2[3] = callback2(guild(4251).Text, obj4);
  obj[1] = items2;
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5635).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5634).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5635).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5634).TableRowGroup, obj13);
  obj5[2] = items5;
  items3[1] = callback3(guild(4663).Stack, obj5);
  ...
  items3[2] = callback2(guild(4251).Text, obj15);
  obj[5] = items3;
  return callback3(guild(16604).EnableCommunityModalScreen, obj);
};
