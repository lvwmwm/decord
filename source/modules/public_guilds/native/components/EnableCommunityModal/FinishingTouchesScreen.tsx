...
// Dependencies: [32, 19, 17, 8614, 1935, 7940, 676, 21, 3959, 712, 589, 3888, 8613, 506, 16552, 16595, 16594, 16592, 1236, 4251, 4664, 5620, 16604, 5621, 1945, 2]
// Exports: default

// Module 16606 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const callback1 = obj.useCallback((features) => {
    ...
    if (null != everyoneRole) {
      ...
      first(8613).saveGuild(features.id, obj);
  ...
  const tmp19 = first(16595)();
  const enableCommunitySharedStyles = guild(16594).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: null, onSuccess: null, disableNextStep: null, buttonText: null, children: null };
  obj[1] = guild(16592).EnableCommunityModalSteps.STEP_3;
  obj[2] = callback1;
  obj[3] = !first1;
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5621).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5620).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5621).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5620).TableRowGroup, obj13);
  obj5[2] = items5;
  items3[1] = callback3(guild(4664).Stack, obj5);
  ...
  obj[5] = items3;
  return callback3(guild(16592).EnableCommunityModalScreen, obj);
};
