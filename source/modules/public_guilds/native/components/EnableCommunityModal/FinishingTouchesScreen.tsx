...
// Dependencies: [32, 19, 17, 8945, 1964, 8065, 676, 21, 3988, 712, 589, 3917, 8944, 506, 16605, 16647, 16646, 16644, 1236, 4281, 4693, 5688, 16656, 5689, 1974, 2]
// Exports: default

// Module 16658 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const tmp19 = first(16647)();
  const enableCommunitySharedStyles = guild(16646).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: null, onSuccess: null, disableNextStep: null, buttonText: null, children: null };
  obj[1] = guild(16644).EnableCommunityModalSteps.STEP_3;
  obj[2] = callback1;
  obj[3] = !first1;
  ...
  const items2 = [callback2(guild(4281).Text, obj1), , , ];
  ...
  items2[2] = callback2(guild(4281).Heading, obj3);
  ...
  items2[3] = callback2(guild(4281).Text, obj4);
  obj[1] = items2;
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5689).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5688).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5689).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5688).TableRowGroup, obj13);
  obj5[2] = items5;
  items3[1] = callback3(guild(4693).Stack, obj5);
  ...
  obj[5] = items3;
  return callback3(guild(16644).EnableCommunityModalScreen, obj);
};
