...
// Dependencies: [32, 19, 17, 9169, 1985, 8295, 676, 21, 4101, 712, 589, 4030, 9168, 506, 16970, 17012, 17011, 17009, 1236, 4376, 4813, 5873, 17021, 5874, 1995, 2]
// Exports: default

// Module 17023 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const tmp19 = first(17012)();
  const enableCommunitySharedStyles = guild(17011).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: tmp2(17009).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [callback2(guild(4376).Text, obj1), , , ];
  ...
  items2[2] = callback2(guild(4376).Heading, obj3);
  ...
  items2[3] = callback2(guild(4376).Text, obj4);
  obj[1] = items2;
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5874).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5873).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5874).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5873).TableRowGroup, obj13);
  obj5[2] = items5;
  items3[1] = callback3(guild(4813).Stack, obj5);
  ...
  items3[2] = callback2(guild(4376).Text, obj15);
  obj[5] = items3;
  return callback3(guild(17009).EnableCommunityModalScreen, obj);
};
