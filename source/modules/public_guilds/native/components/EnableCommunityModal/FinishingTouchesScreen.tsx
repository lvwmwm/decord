...
// Dependencies: [32, 19, 17, 9729, 1985, 7944, 676, 21, 4197, 712, 589, 4126, 9728, 506, 17208, 17250, 17249, 17247, 1236, 4474, 4926, 5992, 17259, 5993, 1995, 2]
// Exports: default

// Module 17261 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const tmp19 = first(17250)();
  const enableCommunitySharedStyles = guild(17249).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: tmp2(17247).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5993).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5992).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5993).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5992).TableRowGroup, obj13);
  obj5[2] = items5;
  ...
  const tmp2Result = guild(17249);
  obj16[0] = first(1995).getArticleURL(constants.PUBLIC_GUILD_GUILDLINES);
  const tmp4Result1 = first(1995);
  obj16[1] = first(1995).getArticleURL(constants.FRIEND_COMMUNITY_DISCOVERABLE_GUILD_TYPES);
  obj15[3] = intl9.format(guild(1236).t["BwbW/Q"], obj16);
  items3[2] = callback2(guild(4474).Text, obj15);
  obj[5] = items3;
  return callback3(guild(17247).EnableCommunityModalScreen, obj);
};
