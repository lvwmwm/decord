...
// Dependencies: [32, 19, 17, 9690, 1985, 7912, 676, 21, 4167, 712, 589, 4096, 9689, 506, 17172, 17214, 17213, 17211, 1236, 4444, 4894, 5960, 17223, 5961, 1995, 2]
// Exports: default

// Module 17225 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const tmp19 = first(17214)();
  const enableCommunitySharedStyles = guild(17213).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: tmp2(17211).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [callback2(guild(4444).Text, obj1), , , ];
  ...
  items2[2] = callback2(guild(4444).Heading, obj3);
  ...
  items2[3] = callback2(guild(4444).Text, obj4);
  obj[1] = items2;
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5961).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5960).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5961).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5960).TableRowGroup, obj13);
  obj5[2] = items5;
  items3[1] = callback3(guild(4894).Stack, obj5);
  ...
  items3[2] = callback2(guild(4444).Text, obj15);
  obj[5] = items3;
  return callback3(guild(17211).EnableCommunityModalScreen, obj);
};
