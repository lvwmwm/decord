...
// Dependencies: [32, 19, 17, 9650, 1985, 7876, 676, 21, 4165, 712, 589, 4094, 9649, 506, 17121, 17163, 17162, 17160, 1236, 4441, 4878, 5944, 17172, 5945, 1995, 2]
// Exports: default

// Module 17174 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const tmp19 = first(17163)();
  const enableCommunitySharedStyles = guild(17162).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: tmp2(17160).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [callback2(guild(4441).Text, obj1), , , ];
  ...
  items2[2] = callback2(guild(4441).Heading, obj3);
  ...
  items2[3] = callback2(guild(4441).Text, obj4);
  obj[1] = items2;
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5945).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5944).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5945).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5944).TableRowGroup, obj13);
  obj5[2] = items5;
  items3[1] = callback3(guild(4878).Stack, obj5);
  ...
  items3[2] = callback2(guild(4441).Text, obj15);
  obj[5] = items3;
  return callback3(guild(17160).EnableCommunityModalScreen, obj);
};
