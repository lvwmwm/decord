...
export default function FinishingTouchesScreen() {
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5650).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5649).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5650).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5649).TableRowGroup, obj13);
  obj5[2] = items5;
