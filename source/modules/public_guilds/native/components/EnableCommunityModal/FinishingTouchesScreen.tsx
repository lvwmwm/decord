...
// Dependencies: [32, 19, 17, 8962, 1964, 8082, 676, 21, 4005, 712, 589, 3934, 8961, 506, 16625, 16667, 16666, 16664, 1236, 4298, 4710, 5707, 16676, 5708, 1974, 2]
// Exports: default

// Module 16678 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const tmp19 = first(16667)();
  const enableCommunitySharedStyles = guild(16666).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: null, onSuccess: null, disableNextStep: null, buttonText: null, children: null };
  obj[1] = guild(16664).EnableCommunityModalSteps.STEP_3;
  obj[2] = callback1;
  obj[3] = !first1;
  ...
  const items2 = [callback2(guild(4298).Text, obj1), , , ];
  ...
  items2[2] = callback2(guild(4298).Heading, obj3);
  ...
  items2[3] = callback2(guild(4298).Text, obj4);
  obj[1] = items2;
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5708).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5707).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5708).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5707).TableRowGroup, obj13);
  obj5[2] = items5;
  items3[1] = callback3(guild(4710).Stack, obj5);
  ...
  items3[2] = callback2(guild(4298).Text, obj15);
  obj[5] = items3;
  return callback3(guild(16664).EnableCommunityModalScreen, obj);
};
