...
// Dependencies: [32, 19, 17, 9067, 1983, 8183, 676, 21, 4065, 712, 589, 3994, 9066, 506, 16781, 16823, 16822, 16820, 1236, 4340, 4752, 5806, 16832, 5807, 1993, 2]
// Exports: default

// Module 16834 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const tmp19 = first(16823)();
  const enableCommunitySharedStyles = guild(16822).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: null, onSuccess: null, disableNextStep: null, buttonText: null, children: null };
  obj[1] = guild(16820).EnableCommunityModalSteps.STEP_3;
  obj[2] = callback1;
  obj[3] = !first1;
  ...
  const items2 = [callback2(guild(4340).Text, obj1), , , ];
  ...
  items2[2] = callback2(guild(4340).Heading, obj3);
  ...
  items2[3] = callback2(guild(4340).Text, obj4);
  obj[1] = items2;
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5807).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5806).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5807).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5806).TableRowGroup, obj13);
  obj5[2] = items5;
  items3[1] = callback3(guild(4752).Stack, obj5);
  ...
  items3[2] = callback2(guild(4340).Text, obj15);
  obj[5] = items3;
  return callback3(guild(16820).EnableCommunityModalScreen, obj);
};
