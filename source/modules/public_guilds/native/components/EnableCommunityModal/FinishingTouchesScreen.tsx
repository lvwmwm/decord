...
// Dependencies: [32, 19, 17, 8305, 1935, 7817, 676, 21, 3893, 712, 589, 3822, 8304, 506, 16463, 16506, 16505, 16503, 1236, 4185, 4598, 5554, 16515, 5555, 1945, 2]
// Exports: default

// Module 16517 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const tmp19 = first(16506)();
  const enableCommunitySharedStyles = guild(16505).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: null, onSuccess: null, disableNextStep: null, buttonText: null, children: null };
  obj[1] = guild(16503).EnableCommunityModalSteps.STEP_3;
  obj[2] = callback1;
  obj[3] = !first1;
  ...
  const items2 = [callback2(guild(4185).Text, obj1), , , ];
  ...
  items2[2] = callback2(guild(4185).Heading, obj3);
  ...
  items2[3] = callback2(guild(4185).Text, obj4);
  obj[1] = items2;
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5555).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5554).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5555).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5554).TableRowGroup, obj13);
  obj5[2] = items5;
  items3[1] = callback3(guild(4598).Stack, obj5);
  ...
  items3[2] = callback2(guild(4185).Text, obj15);
  obj[5] = items3;
  return callback3(guild(16503).EnableCommunityModalScreen, obj);
};
