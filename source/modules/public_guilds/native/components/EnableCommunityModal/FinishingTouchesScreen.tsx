...
// Module 16232 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  obj1.children = intl2.formatToPlainString(arg1(dependencyMap[18]).t.tInpJj, { 0: 10, 9223372036854775807: 371 });
  ...
  const obj15 = { Promise: false, marginTop: false, flags: false, style: enableCommunitySharedStyles.formHint };
