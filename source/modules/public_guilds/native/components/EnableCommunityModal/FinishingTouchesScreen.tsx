...
// Dependencies: [32, 19, 17, 9022, 1964, 8142, 676, 21, 4005, 712, 589, 3934, 9021, 506, 16702, 16744, 16743, 16741, 1236, 4299, 4712, 5767, 16753, 5768, 1974, 2]
// Exports: default

// Module 16755 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  const tmp19 = first(16744)();
  const enableCommunitySharedStyles = guild(16743).useEnableCommunitySharedStyles();
  obj = { headerRef: ref, currentStep: null, onSuccess: null, disableNextStep: null, buttonText: null, children: null };
  obj[1] = guild(16741).EnableCommunityModalSteps.STEP_3;
  obj[2] = callback1;
  obj[3] = !first1;
  ...
  const items2 = [callback2(guild(4299).Text, obj1), , , ];
  ...
  items2[2] = callback2(guild(4299).Heading, obj3);
  ...
  items2[3] = callback2(guild(4299).Text, obj4);
  obj[1] = items2;
  ...
  obj11[2] = first2;
  obj11[3] = tmp13;
  obj10[1] = callback2(guild(5768).TableSwitchRow, obj11);
  items4[1] = callback2(tmp4Result, obj10);
  obj9[1] = items4;
  const items5 = [callback3(guild(5767).TableRowGroup, obj9), ];
  ...
  obj14[1] = first1;
  obj14[2] = tmp9[1];
  obj13[2] = callback2(guild(5768).TableSwitchRow, obj14);
  items5[1] = callback2(guild(5767).TableRowGroup, obj13);
  obj5[2] = items5;
  items3[1] = callback3(guild(4712).Stack, obj5);
  ...
  obj[5] = items3;
  return callback3(guild(16741).EnableCommunityModalScreen, obj);
};
