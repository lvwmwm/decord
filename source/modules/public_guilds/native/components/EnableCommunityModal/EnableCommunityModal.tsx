...
// Function ID: 16741
// Name: onModalClose
// Dependencies: [19, 21, 16739, 5276, 5270, 1236, 6008, 8027, 16741, 16742, 16754, 16755, 5783, 2]
// Exports: default

// Module 16740 (onModalClose)
import noop from "noop";
import { jsx } from "jsxProd";

const require = arg1;
function onModalClose() {
  importDefault(16739).close();
}
...
export default function EnableCommunityModal() {
  ...
  obj[1] = require(16741) /* EnableCommunityModalSteps */.EnableCommunityModalSteps.STEP_1;
