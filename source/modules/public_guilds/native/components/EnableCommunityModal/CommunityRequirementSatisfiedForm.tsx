...
// Dependencies: [19, 17, 21, 3955, 16606, 4797, 2]
// Exports: default

// Module 16616 (CommunityRequirementSatisfiedForm)
import "noop";
...
export default function CommunityRequirementSatisfiedForm(formSwitchDisabled) {
  ...
  let obj = formSwitchDisabled(16606);
  ...
  if (formSwitchDisabled) {
    ...
    tmp6 = callback(formSwitchDisabled(4797).PressableOpacity, obj);
  }
  items[1] = tmp6;
  obj[1] = items;
