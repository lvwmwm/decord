...
// Dependencies: [5, 4153, 1348, 1838, 3758, 1849, 4146, 1347, 10520, 10521, 4470, 1212, 5465, 10517, 10522, 2]
// Exports: maybeJoinEmbeddedActivity

// Module 10519 (handlePressJoinActivity)
...
function handlePressJoinActivity(arg0) {
  ...
  if (require(10520) /* getEmbeddedActivityJoinability */.EmbeddedActivityJoinability.CAN_JOIN === embeddedActivityJoinability) {
    if (null != handleCanJoin) {
      handleCanJoin();
    }
  } else if (require(10520) /* getEmbeddedActivityJoinability */.EmbeddedActivityJoinability.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION === embeddedActivityJoinability) {
    const result = require(10521) /* showActivitiesInvalidPermissionsAlert */.showActivitiesInvalidPermissionsAlert();
    const obj9 = require(10521) /* showActivitiesInvalidPermissionsAlert */;
  } else if (require(10520) /* getEmbeddedActivityJoinability */.EmbeddedActivityJoinability.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS === embeddedActivityJoinability) {
    let obj = {};
  ...
  } else if (require(10520) /* getEmbeddedActivityJoinability */.EmbeddedActivityJoinability.ACTIVITY_NOT_SUPPORTED_ON_OS === embeddedActivityJoinability) {
    obj = {};
  ...
  } else if (require(10520) /* getEmbeddedActivityJoinability */.EmbeddedActivityJoinability.ACTIVITY_AGE_GATED === embeddedActivityJoinability) {
