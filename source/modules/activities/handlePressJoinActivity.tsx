...
// Dependencies: [5, 4406, 1391, 1910, 4025, 1922, 4399, 1390, 10733, 10724, 4744, 1236, 5835, 10723, 10734, 2]
// Exports: maybeJoinEmbeddedActivity

// Module 10732 (handlePressJoinActivity)
...
function handlePressJoinActivity(arg0) {
  ...
  } else if (tmp(10733).EmbeddedActivityJoinability.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION === embeddedActivityJoinability) {
    const result = tmp(10724).showActivitiesInvalidPermissionsAlert();
    const tmpResult = tmp(10724);
  } else if (tmp(10733).EmbeddedActivityJoinability.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS === embeddedActivityJoinability) {
  ...
  } else if (tmp(10733).EmbeddedActivityJoinability.ACTIVITY_NOT_SUPPORTED_ON_OS === embeddedActivityJoinability) {
  ...
  } else if (tmp(10733).EmbeddedActivityJoinability.ACTIVITY_AGE_GATED === embeddedActivityJoinability) {
    let obj2 = setDefault;
