...
// Dependencies: [5, 4322, 1372, 1960, 1903, 1371, 4310, 10586, 10517, 3902, 10587, 10566, 10565, 10323, 10576, 8260, 10894, 10550, 2]
// Exports: default

// Module 10585 (_handleJoinEmbeddedActivityInternal)
          ...
          try {
            ...
            if (0 === c3) {
                ...
                if (null == currentUser2) {
                  ...
                  if (null != _private) {
                    ...
                    if (null != callback2) {
                        ...
                        if (null != currentEmbeddedActivity2) {
                          if (currentEmbeddedActivity2.applicationId === callback) {
                            ...
                            if (embeddedActivityLocationChannelId === store.getVoiceChannelId()) {
                              ...
                              throwTypeErrorResult = callback2(10587)(guildId, currentEmbeddedActivity2.location);
                      ...
                      obj3[0] = callback2(10566)(callback, callback2);
                      return obj3;
                    }
                  }
                  throwTypeErrorResult = globalThis;
              ...
              if (arg0 === 1) {
                ...
                obj7[0] = callback(10565).confirmActivityLaunchChecks(obj6);
                return obj7;
              }
            } else {
              if (3 === tmp5) {
                if (arg0 === 1) {
                  ...
                  if (null != _private) {
                    closure_17 = callback2(10323)(_private.id);
...
export default function handleJoinEmbeddedActivity(arg0) {
  const _require = arg0;
  const obj = _require(10586);
  return obj.wrapPreemptiveActivityPopout(_require(10586).shouldOpenActivityInPopoutWindow(), () => (function handleJoinEmbeddedActivityInternal(closure_0) {
    const self = this;
