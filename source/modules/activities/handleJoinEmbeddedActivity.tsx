...
// Dependencies: [5, 4486, 1391, 1981, 1922, 1390, 4473, 9372, 9373, 4079, 9440, 9400, 9399, 9409, 9410, 8076, 12380, 9390, 2]
// Exports: default

// Module 9371 (_handleJoinEmbeddedActivityInternal)
...
import { SUPPORTED_ACTIVITY_IN_TEXT_CHANNEL_TYPES as closure_9 } from "items3" /* 4473 */;
          ...
          try {
            ...
            if (0 === c3) {
                ...
                if (null == currentUser2) {
                  ...
                  if (null != _private) {
                    ...
                    if (null != callback2) {
                        ...
                        if (null != currentEmbeddedActivity2) {
                          if (currentEmbeddedActivity2.applicationId === callback) {
                            ...
                            if (embeddedActivityLocationChannelId === store.getVoiceChannelId()) {
                              ...
                              throwTypeErrorResult = callback2(9440)(guildId, currentEmbeddedActivity2.location);
                      ...
                      obj3[0] = callback2(9400)(callback, callback2);
                      return obj3;
                    }
                  }
                  throwTypeErrorResult = globalThis;
              ...
              if (arg0 === 1) {
                ...
                obj7[0] = callback(9399).confirmActivityLaunchChecks(obj6);
                return obj7;
              }
            } else {
              if (3 === tmp5) {
                if (arg0 === 1) {
                  ...
                  if (null != _private) {
                    closure_17 = callback2(9409)(_private.id);
...
export default function handleJoinEmbeddedActivity(arg0) {
  const _require = arg0;
  const obj = _require(9372);
  return obj.wrapPreemptiveActivityPopout(_require(9372).shouldOpenActivityInPopoutWindow(), () => (function handleJoinEmbeddedActivityInternal(closure_0) {
    const self = this;
