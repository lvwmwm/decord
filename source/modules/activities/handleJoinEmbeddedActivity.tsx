...
// Dependencies: [5, 4292, 1372, 1931, 1874, 1371, 4280, 10508, 10509, 3873, 10527, 10843, 10845, 10292, 10852, 8120, 10853, 10485, 2]
// Exports: default

// Module 10507 (_handleJoinEmbeddedActivityInternal)
          ...
          try {
            ...
            if (0 === c3) {
                ...
                if (null == currentUser2) {
                  ...
                  if (null != _private) {
                    ...
                    if (null != callback2) {
                        ...
                        if (null != currentEmbeddedActivity2) {
                          if (currentEmbeddedActivity2.applicationId === callback) {
                            ...
                            if (embeddedActivityLocationChannelId === store.getVoiceChannelId()) {
                              ...
                              throwTypeErrorResult = callback2(10527)(guildId, currentEmbeddedActivity2.location);
                      ...
                      obj3[0] = callback2(10843)(callback, callback2);
                      return obj3;
                    }
                  }
                  throwTypeErrorResult = globalThis;
              ...
              if (arg0 === 1) {
                ...
                obj7[0] = callback(10845).confirmActivityLaunchChecks(obj6);
                return obj7;
              }
            } else {
              if (3 === tmp5) {
                if (arg0 === 1) {
                  ...
                  if (null != _private) {
                    closure_17 = callback2(10292)(_private.id);
...
export default function handleJoinEmbeddedActivity(arg0) {
  const _require = arg0;
  const obj = _require(10508);
  return obj.wrapPreemptiveActivityPopout(_require(10508).shouldOpenActivityInPopoutWindow(), () => (function handleJoinEmbeddedActivityInternal(closure_0) {
    const self = this;
