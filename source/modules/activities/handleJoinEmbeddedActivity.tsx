...
// Dependencies: [5, 4522, 1386, 1980, 1921, 1385, 4509, 9462, 9443, 4110, 9463, 9465, 9467, 9454, 9474, 9475, 9476, 9433, 2]
// Exports: default

// Module 9461 (_handleJoinEmbeddedActivityInternal)
...
import { SUPPORTED_ACTIVITY_IN_TEXT_CHANNEL_TYPES as closure_9 } from "items3" /* 4509 */;
          ...
          try {
            ...
            if (0 === c3) {
                ...
                if (null == currentUser2) {
                  ...
                  if (null != _private) {
                    ...
                    if (null != callback2) {
                        ...
                        if (null != currentEmbeddedActivity2) {
                          if (currentEmbeddedActivity2.applicationId === callback) {
                            ...
                            if (embeddedActivityLocationChannelId === store.getVoiceChannelId()) {
                              ...
                              throwTypeErrorResult = callback2(9463)(guildId, currentEmbeddedActivity2.location);
                      ...
                      obj3[0] = callback2(9465)(callback, callback2);
                      return obj3;
                    }
                  }
                  throwTypeErrorResult = globalThis;
              ...
              if (arg0 === 1) {
                ...
                obj7[0] = callback(9467).confirmActivityLaunchChecks(obj6);
                return obj7;
              }
            } else {
              if (3 === tmp5) {
                if (arg0 === 1) {
                  ...
                  if (null != _private) {
                    closure_17 = callback2(9454)(_private.id);
...
export default function handleJoinEmbeddedActivity(arg0) {
  const _require = arg0;
  const obj = _require(9462);
  return obj.wrapPreemptiveActivityPopout(_require(9462).shouldOpenActivityInPopoutWindow(), () => (function handleJoinEmbeddedActivityInternal(closure_0) {
    const self = this;
