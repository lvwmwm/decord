...
// Dependencies: [5, 4322, 1372, 1931, 1874, 1371, 4310, 10536, 10537, 3903, 10555, 10871, 10873, 10320, 10880, 8148, 10881, 10513, 2]
// Exports: default

// Module 10535 (_handleJoinEmbeddedActivityInternal)
          ...
          try {
            ...
            if (0 === c3) {
                ...
                if (null == currentUser2) {
                  ...
                  if (null != _private) {
                    ...
                    if (null != callback2) {
                        ...
                        if (null != currentEmbeddedActivity2) {
                          if (currentEmbeddedActivity2.applicationId === callback) {
                            ...
                            if (embeddedActivityLocationChannelId === store.getVoiceChannelId()) {
                              ...
                              throwTypeErrorResult = callback2(10555)(guildId, currentEmbeddedActivity2.location);
                      ...
                      obj3[0] = callback2(10871)(callback, callback2);
                      return obj3;
                    }
                  }
                  throwTypeErrorResult = globalThis;
              ...
              if (arg0 === 1) {
                ...
                obj7[0] = callback(10873).confirmActivityLaunchChecks(obj6);
                return obj7;
              }
            } else {
              if (3 === tmp5) {
                if (arg0 === 1) {
                  ...
                  if (null != _private) {
                    closure_17 = callback2(10320)(_private.id);
