...
// Dependencies: [5, 4485, 1391, 1981, 1922, 1390, 4472, 10807, 10757, 4079, 10808, 10787, 10786, 10543, 10797, 8559, 11132, 10771, 2]
// Exports: default

// Module 10806 (_handleJoinEmbeddedActivityInternal)
...
import { SUPPORTED_ACTIVITY_IN_TEXT_CHANNEL_TYPES as closure_9 } from "items3" /* 4472 */;
          ...
          try {
            ...
            if (0 === c3) {
                ...
                if (null == currentUser2) {
                  ...
                  if (null != _private) {
                    ...
                    if (null != callback2) {
                        ...
                        if (null != currentEmbeddedActivity2) {
                          if (currentEmbeddedActivity2.applicationId === callback) {
                            ...
                            if (embeddedActivityLocationChannelId === store.getVoiceChannelId()) {
                              ...
                              throwTypeErrorResult = callback2(10808)(guildId, currentEmbeddedActivity2.location);
                      ...
                      obj3[0] = callback2(10787)(callback, callback2);
                      return obj3;
                    }
                  }
                  throwTypeErrorResult = globalThis;
              ...
              if (arg0 === 1) {
                ...
                obj7[0] = callback(10786).confirmActivityLaunchChecks(obj6);
                return obj7;
              }
            } else {
              if (3 === tmp5) {
                if (arg0 === 1) {
                  ...
                  if (null != _private) {
                    closure_17 = callback2(10543)(_private.id);
...
export default function handleJoinEmbeddedActivity(arg0) {
  const _require = arg0;
  const obj = _require(10807);
  return obj.wrapPreemptiveActivityPopout(_require(10807).shouldOpenActivityInPopoutWindow(), () => (function handleJoinEmbeddedActivityInternal(closure_0) {
    const self = this;
