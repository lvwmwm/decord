...
// Dependencies: [5, 1391, 1922, 10602, 10622, 10572, 10947, 10586, 2]
// Exports: default

// Module 10946 (_handleUsePrimaryEntryPointAppCommand)
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == lib.targetApplicationId) {
                ...
                obj1[0] = outer1_1(10602)(tmp27.targetApplicationId, tmp27.channelId);
                return obj1;
              }
            }
          } else if (1 === tmp7) {
