...
// Dependencies: [5, 1391, 1922, 10635, 10655, 10605, 10980, 10619, 2]
// Exports: default

// Module 10979 (_handleUsePrimaryEntryPointAppCommand)
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == lib.targetApplicationId) {
                ...
                obj1[0] = outer1_1(10635)(tmp27.targetApplicationId, tmp27.channelId);
                return obj1;
              }
            }
          } else if (1 === tmp7) {
