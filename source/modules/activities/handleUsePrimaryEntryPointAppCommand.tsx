...
// Dependencies: [5, 1386, 1921, 9465, 9462, 9443, 9478, 9433, 2]
// Exports: default

// Module 9477 (_handleUsePrimaryEntryPointAppCommand)
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == lib.targetApplicationId) {
                ...
                obj1[0] = closure_1_1(9465)(tmp27.targetApplicationId, tmp27.channelId);
                return obj1;
              }
            }
          } else if (1 === tmp7) {
