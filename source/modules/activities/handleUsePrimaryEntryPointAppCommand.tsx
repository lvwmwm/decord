...
// Dependencies: [5, 1386, 1921, 9492, 9464, 9465, 9529, 9482, 2]
// Exports: default

// Module 9528 (_handleUsePrimaryEntryPointAppCommand)
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == lib.targetApplicationId) {
                ...
                obj1[0] = closure_1_1(9492)(tmp27.targetApplicationId, tmp27.channelId);
                return obj1;
              }
            }
          } else if (1 === tmp7) {
