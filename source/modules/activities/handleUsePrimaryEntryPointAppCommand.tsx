...
// Dependencies: [5, 1391, 1922, 10620, 10640, 10590, 10965, 10604, 2]
// Exports: default

// Module 10964 (_handleUsePrimaryEntryPointAppCommand)
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == lib.targetApplicationId) {
                ...
                obj1[0] = outer1_1(10620)(tmp27.targetApplicationId, tmp27.channelId);
                return obj1;
              }
            }
          } else if (1 === tmp7) {
