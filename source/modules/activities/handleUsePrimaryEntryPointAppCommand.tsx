...
// Dependencies: [5, 1372, 1874, 10871, 10536, 10537, 10883, 10513, 2]
// Exports: default

// Module 10882 (_handleUsePrimaryEntryPointAppCommand)
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == lib.targetApplicationId) {
                ...
                obj1[0] = outer1_1(10871)(tmp27.targetApplicationId, tmp27.channelId);
                return obj1;
              }
            }
          } else if (1 === tmp7) {
