...
// Dependencies: [5, 1387, 1922, 9440, 9412, 9413, 9477, 9430, 2]
// Exports: default

// Module 9476 (_handleUsePrimaryEntryPointAppCommand)
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == lib.targetApplicationId) {
                ...
                obj1[0] = closure_1_1(9440)(tmp27.targetApplicationId, tmp27.channelId);
                return obj1;
              }
            }
          } else if (1 === tmp7) {
