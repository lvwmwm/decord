...
// Dependencies: [5, 1391, 1922, 10787, 10807, 10757, 11134, 10771, 2]
// Exports: default

// Module 11133 (_handleUsePrimaryEntryPointAppCommand)
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == lib.targetApplicationId) {
                ...
                obj1[0] = closure_1_1(10787)(tmp27.targetApplicationId, tmp27.channelId);
                return obj1;
              }
            }
          } else if (1 === tmp7) {
