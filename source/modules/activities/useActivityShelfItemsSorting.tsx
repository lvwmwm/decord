...
// Dependencies: [19, 1374, 10580, 500, 1954, 2]
// Exports: default

// Module 11485 (useActivityShelfItemsSorting)
  ...
  return React.useMemo(() => {
    ...
    const found = mapped.filter((arg0) => {
      ...
      if (embeddedActivityConfig != null) {
        ...
        const tmp7 = embeddedActivityConfig.client_platform_config[v0(10580)(undefined, obj.getOS(obj))];
        if (tmp7 != null) {
