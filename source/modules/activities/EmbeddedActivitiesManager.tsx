...
// Dependencies: [5, 4268, 1376, 1218, 1372, 4327, 1931, 1874, 10672, 1371, 676, 8359, 500, 530, 3873, 10673, 10674, 698, 10665, 10676, 10677, 4449, 514, 1856, 8143, 4434, 1231, 709, 10617, 10659, 10678, 5582, 10680, 1236, 10681, 10664, 10682, 11005, 1906, 5601, 2]
// Exports: getActiveAnalyticsSessionIDs, trackFrameSessionEnd, trackFrameSessionStart

// Module 10671 (getShelfItemTrackingProperties)
...
function getShelfItemTrackingProperties(activity) {
  ...
  if (activity != null) {
    ...
    if (activity != null) {
      ...
      releasePhase = activity.client_platform_config[importDefault(8359)(undefined, obj.getOS(obj))].release_phase;
      const tmp4 = importDefault(8359);
    }
  }
  return { releasePhase };
}
      ...
      if (null != closure_5) {
        if (null != premiumType) {
          if (null == closure_5.connectedSince) {
            ...
            obj5[0] = callback;
            obj5[1] = currentUser;
            activity = lib(10673)(obj5);
            releasePhase = callback2(activity).releasePhase;
            constants = lib(10674).getRawThermalState();
            const obj13 = lib(10674);
...
function handleOpenEmbeddedActivity(applicationId) {
  ...
  let obj = applicationId(10665);
  obj.leaveCurrentFrame();
  let obj1 = applicationId(10676);
  if (obj1.tryLaunchAsFrame({ applicationId })) {
    let tmpResult = tmp(10677);
    ...
    if (isFirstActivityInChannel) {
      const participant = importDefault(4449).selectParticipant(channel.id, null);
      const obj6 = importDefault(4449);
    }
    if (null != found) {
      ...
      if (null != compositeInstanceId) {
        if (!tmp16) {
          ...
          if (null != currentUser) {
            ...
            if (null != channel) {
              commandContextType = tmp(8143).computeCommandContextType(channel, applicationId);
              const tmpResult7 = tmp(8143);
            }
...
class EmbeddedActivitiesManager extends tmp3 {
  constructor() {
    ...
    f107722 = handleOpenEmbeddedActivity((arg0) => {
      let closure_0 = arg0;
      let c4 = 0;
      let c5 = 0;
      const iter = (function*(arg0) {
...
export const trackFrameSessionEnd = function trackFrameSessionEnd(applicationId) {
  ...
  if (null != dependencyMap[applicationId]) {
    if (null != currentUser) {
      ...
      obj[0] = applicationId;
      obj[1] = shelfActivities;
      const tmp13 = importDefault(10673)(obj);
      let release_phase;
      if (tmp13 != null) {
        const activity = tmp13.activity;
        if (activity != null) {
          let tmp11Result = tmp11(8359);
