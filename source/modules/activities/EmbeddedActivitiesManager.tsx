...
// Dependencies: [5, 4316, 1376, 1218, 1372, 4375, 1960, 1903, 10604, 1371, 676, 10605, 500, 530, 3919, 10606, 10607, 698, 10595, 10609, 10610, 4497, 514, 1884, 8344, 4482, 1231, 709, 10405, 10593, 10611, 5729, 10637, 1236, 10645, 10613, 10646, 10973, 1935, 5748, 2]
// Exports: getActiveAnalyticsSessionIDs, trackFrameSessionEnd, trackFrameSessionStart

// Module 10603 (getShelfItemTrackingProperties)
...
function getShelfItemTrackingProperties(activity) {
  ...
  if (activity != null) {
    ...
    if (activity != null) {
      ...
      releasePhase = activity.client_platform_config[importDefault(10605)(undefined, obj.getOS(obj))].release_phase;
      const tmp4 = importDefault(10605);
    }
  }
  return { releasePhase };
}
            ...
            if (null != closure_5) {
              if (null != premiumType) {
                if (null == closure_5.connectedSince) {
                  ...
                  obj5[0] = callback;
                  obj5[1] = currentUser;
                  activity = lib(10606)(obj5);
                  releasePhase = callback2(activity).releasePhase;
                  constants = lib(10607).getRawThermalState();
                  const obj13 = lib(10607);
...
function handleOpenEmbeddedActivity(applicationId) {
  ...
  let obj = importDefault(10595);
  obj.clearMainFrameSlot();
  let obj1 = applicationId(10609);
      ...
      if (null != compositeInstanceId) {
        if (!tmp16) {
          ...
          if (null != currentUser) {
            ...
            const rawThermalState = tmp(10607).getRawThermalState();
...
class EmbeddedActivitiesManager extends tmp3 {
  constructor() {
    ...
    f108346 = handleOpenEmbeddedActivity((arg0) => {
      let closure_0 = arg0;
      let c4 = 0;
      let c5 = 0;
      const iter = (function*(arg0) {
...
export const trackFrameSessionEnd = function trackFrameSessionEnd(applicationId) {
  ...
  if (null != dependencyMap[applicationId]) {
    if (null != currentUser) {
      ...
      obj[0] = applicationId;
      obj[1] = shelfActivities;
      const tmp13 = importDefault(10606)(obj);
      let release_phase;
      if (tmp13 != null) {
        const activity = tmp13.activity;
        if (activity != null) {
          let tmp11Result = tmp11(10605);
