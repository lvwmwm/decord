...
// Dependencies: [19, 17, 4280, 21, 4255, 11002, 4251, 1236, 4666, 3952, 4594, 2]
// Exports: confirmExternalAppLaunchAlert

// Module 11001 (ConfirmActivityGateContent)
import "noop";
...
function ConfirmActivityGateContent(activityName) {
  ...
  obj = { source: importDefault(11002), style: tmp.announcementBirb };
  ...
  items[3] = callback(require(4251) /* Text */.Text, obj3);
  obj[1] = items;
