...
// Dependencies: [19, 17, 4481, 21, 4661, 8743, 4734, 1236, 4745, 4090, 4827, 2]
// Exports: confirmExternalAppLaunchAlert

// Module 8742 (ConfirmActivityGateContent)
import "noop";
...
function ConfirmActivityGateContent(activityName) {
  ...
  obj = { source: importDefault(8743), style: tmp.announcementBirb };
  ...
  items[3] = callback(require(4734) /* Text */.Text, obj3);
  obj[1] = items;
