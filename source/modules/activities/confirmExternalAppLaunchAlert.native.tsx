...
// Dependencies: [19, 17, 4327, 21, 4302, 10569, 4298, 1236, 4712, 3998, 4640, 2]
// Exports: confirmExternalAppLaunchAlert

// Module 10568 (ConfirmActivityGateContent)
import "noop";
...
function ConfirmActivityGateContent(activityName) {
  ...
  obj = { source: importDefault(10569), style: tmp.announcementBirb };
  ...
  items[3] = callback(require(4298) /* Text */.Text, obj3);
  obj[1] = items;
