...
// Dependencies: [19, 17, 4328, 21, 4303, 10635, 4299, 1236, 4714, 3998, 4642, 2]
// Exports: confirmExternalAppLaunchAlert

// Module 10634 (ConfirmActivityGateContent)
import "noop";
...
function ConfirmActivityGateContent(activityName) {
  ...
  obj = { source: importDefault(10635), style: tmp.announcementBirb };
  ...
  items[3] = callback(require(4299) /* Text */.Text, obj3);
  obj[1] = items;
