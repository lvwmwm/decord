...
// Dependencies: [19, 17, 4310, 21, 4285, 10572, 4281, 1236, 4695, 3981, 4623, 2]
// Exports: confirmExternalAppLaunchAlert

// Module 10571 (ConfirmActivityGateContent)
import "noop";
...
function ConfirmActivityGateContent(activityName) {
  ...
  obj = { source: importDefault(10572), style: tmp.announcementBirb };
