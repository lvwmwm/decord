...
// Dependencies: [4083, 10255, 16160, 8821, 16057, 16161, 10377, 2]
// Exports: default

// Module 16159 (usePIPAvoidanceSpecs)
...
export default function usePIPAvoidanceSpecs(safeArea) {
  ...
  obj = { cheapWorkletShallowEqual: _require(8821).cheapWorkletShallowEqual, getPIPBottomOffsetForPIPMode: sharedValue(16057), getAdjustedBottomOffsets: sharedValue(16161), updateSharedValueIfChanged: sharedValue(10377), pipAvoidanceSpecs: sharedValue };
  fn2.__closure = obj;
