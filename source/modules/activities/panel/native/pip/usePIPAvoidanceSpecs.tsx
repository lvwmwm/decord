...
// Dependencies: [4218, 16612, 16933, 9424, 16832, 16934, 11286, 2]
// Exports: default

// Module 16932 (usePIPAvoidanceSpecs)
...
export default function usePIPAvoidanceSpecs(safeArea) {
  ...
  const tmp2 = sharedValue(16612)();
  dependencyMap = tmp2;
  const tmp3 = sharedValue(16933)();
  closure_3 = tmp3;
  const fn = function n() {
  ...
  obj = { cheapWorkletShallowEqual: _require(9424).cheapWorkletShallowEqual, getPIPBottomOffsetForPIPMode: sharedValue(16832), getAdjustedBottomOffsets: sharedValue(16934), updateSharedValueIfChanged: sharedValue(11286), pipAvoidanceSpecs: sharedValue };
  fn2.__closure = obj;
  fn2.__workletHash = 643938425459;
  fn2.__initData = closure_4;
  const animatedReaction = _require(4218).useAnimatedReaction(fn, fn2);
  return sharedValue;
};
