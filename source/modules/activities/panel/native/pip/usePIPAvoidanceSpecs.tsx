...
// Dependencies: [4145, 10126, 15976, 8699, 15875, 15977, 10248, 2]
// Exports: default

// Module 15975 (usePIPAvoidanceSpecs)
...
export default function usePIPAvoidanceSpecs(safeArea) {
  ...
  obj = { cheapWorkletShallowEqual: _require(8699).cheapWorkletShallowEqual, getPIPBottomOffsetForPIPMode: sharedValue(15875), getAdjustedBottomOffsets: sharedValue(15977), updateSharedValueIfChanged: sharedValue(10248), pipAvoidanceSpecs: sharedValue };
  fn2.__closure = obj;
  fn2.__workletHash = 643938425459;
  fn2.__initData = closure_4;
  const animatedReaction = _require(4145).useAnimatedReaction(fn, fn2);
  return sharedValue;
};
