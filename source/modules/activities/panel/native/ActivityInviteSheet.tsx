...
// Function ID: 15953
// Name: Loading
// Dependencies: [32, 19, 17, 9022, 8973, 676, 7090, 505, 21, 4255, 712, 8969, 5595, 5615, 4223, 8677, 8961, 10337, 589, 8974, 5323, 5322, 1236, 1297, 8976, 5886, 15953, 2]
// Exports: default

// Module 15952 (Loading)
import _slicedToArray from "_slicedToArray";
import loadInviteSuggestions from "loadInviteSuggestions";
import { View } from "module_10337";
...
function Loading() {
  ...
  do {
    ...
    let obj = { row: null };
    obj[0] = num;
    let arr = items.push(callback3(importDefault(8969), obj, num));
    num = num + 1;
  } while (num < 10);
  obj = { children: null };
...
export default function ActivityInviteSheet(activity) {
  ...
  let React;
  const tmp = createCacheKey();
  analyticsLocations = analyticsLocations(5595)(analyticsLocations(5615).ACTIVITY_INVITE_SHEET).analyticsLocations;
  const tmp2 = analyticsLocations;
  const tmp4 = analyticsLocations(5595);
  ...
  obj[3] = closure_13(activity(5322).BottomSheetTitleHeader, obj1);
  if (null != tmp6) {
    const obj2 = { style: null, Illustration: null, title: null };
    obj2[0] = tmp.emptyState;
    obj2[1] = tmp11(8976).AppCrash;
    obj2[2] = tmp6;
    ...
    obj5[2] = tmp11(8974).searchInviteSuggestions;
    const intl2 = tmp11(1236).intl;
    obj5[3] = intl2.string(tmp11(1236).t.iI1gMg);
    obj4[1] = tmp17(tmp11(5886).SearchField, obj5);
    ...
    if (tmp16) {
      ...
      obj7[3] = callback2;
      obj7[4] = callback1;
      tmp17Result = tmp17(tmp2(15953), obj7);
    }
  ...
  obj[4] = tmp19Result;
  obj[1] = closure_13(activity(5323).BottomSheet, obj);
  return closure_13(activity(5595).AnalyticsLocationProvider, obj);
};
