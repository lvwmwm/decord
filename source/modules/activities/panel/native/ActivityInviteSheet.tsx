...
// Function ID: 16103
// Name: Loading
// Dependencies: [32, 19, 17, 9128, 9079, 676, 7196, 505, 21, 4303, 712, 9075, 5728, 5748, 4271, 8783, 9067, 10451, 589, 9080, 5397, 5396, 1236, 1297, 9082, 5992, 16103, 2]
// Exports: default

// Module 16102 (Loading)
...
function Loading() {
  ...
  do {
    ...
    let obj = { row: null };
    obj[0] = num;
    let arr = items.push(callback3(importDefault(9075), obj, num));
    num = num + 1;
  } while (num < 10);
  obj = { children: null };
...
export default function ActivityInviteSheet(activity) {
  ...
  let React;
  const tmp = createCacheKey();
  analyticsLocations = analyticsLocations(5728)(analyticsLocations(5748).ACTIVITY_INVITE_SHEET).analyticsLocations;
  const tmp2 = analyticsLocations;
  const tmp4 = analyticsLocations(5728);
  ...
  obj[3] = closure_13(activity(5396).BottomSheetTitleHeader, obj1);
  if (null != tmp6) {
  ...
  obj[4] = tmp19Result;
  obj[1] = closure_13(activity(5397).BottomSheet, obj);
  return closure_13(activity(5728).AnalyticsLocationProvider, obj);
};
