...
export default function ActivityInviteSheet(activity) {
  ...
  let React;
  const tmp = createCacheKey();
  analyticsLocations = analyticsLocations(5515)(analyticsLocations(5535).ACTIVITY_INVITE_SHEET).analyticsLocations;
  const tmp2 = analyticsLocations;
  const tmp4 = analyticsLocations(5515);
  ...
  obj[3] = closure_13(activity(5242).BottomSheetTitleHeader, obj1);
  if (null != tmp6) {
  ...
  obj[4] = tmp19Result;
  obj[1] = closure_13(activity(5243).BottomSheet, obj);
  return closure_13(activity(5515).AnalyticsLocationProvider, obj);
};
