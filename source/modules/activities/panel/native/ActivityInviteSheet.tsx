...
// Function ID: 15940
// Name: Loading
// Dependencies: [32, 19, 17, 11921, 10242, 676, 7104, 505, 21, 4255, 712, 8667, 5581, 5601, 4223, 8668, 8659, 10634, 589, 10241, 5309, 5308, 1236, 1297, 12348, 5891, 15940, 2]
// Exports: default

// Module 15939 (Loading)
import _slicedToArray from "_slicedToArray";
import loadInviteSuggestions from "loadInviteSuggestions";
import { View } from "module_10634";
...
function Loading() {
  ...
  do {
    ...
    let obj = { row: null };
    obj[0] = num;
    let arr = items.push(callback3(importDefault(8667), obj, num));
    num = num + 1;
  } while (num < 10);
  obj = { children: null };
...
export default function ActivityInviteSheet(activity) {
  ...
  let React;
  const tmp = createCacheKey();
  analyticsLocations = analyticsLocations(5581)(analyticsLocations(5601).ACTIVITY_INVITE_SHEET).analyticsLocations;
  const tmp2 = analyticsLocations;
  const tmp4 = analyticsLocations(5581);
  ...
  obj[3] = closure_13(activity(5308).BottomSheetTitleHeader, obj1);
  if (null != tmp6) {
    const obj2 = { style: null, Illustration: null, title: null };
    obj2[0] = tmp.emptyState;
    obj2[1] = tmp11(12348).AppCrash;
    obj2[2] = tmp6;
    ...
    obj5[2] = tmp11(10241).searchInviteSuggestions;
    const intl2 = tmp11(1236).intl;
    obj5[3] = intl2.string(tmp11(1236).t.iI1gMg);
    obj4[1] = tmp17(tmp11(5891).SearchField, obj5);
    ...
    if (tmp16) {
      ...
      obj7[3] = callback2;
      obj7[4] = callback1;
      tmp17Result = tmp17(tmp2(15940), obj7);
    }
  ...
  obj[4] = tmp19Result;
  obj[1] = closure_13(activity(5309).BottomSheet, obj);
  return closure_13(activity(5581).AnalyticsLocationProvider, obj);
};
