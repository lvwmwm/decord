...
// Dependencies: [32, 19, 17, 1371, 9759, 505, 21, 4303, 712, 1609, 4036, 16096, 4013, 5427, 16100, 589, 5734, 16101, 16105, 16106, 16111, 16090, 2]
// Exports: useBaseActivityPanelHeader

// Module 16099 (useBaseActivityPanelHeaderContent)
...
let closure_19 = importAllResult.memo(function ActivityPanelHeaderContentInner(wrapperOffset) {
  ...
  let tmp8Result = tmp8(importDefault(16101), { applicationId: id });
