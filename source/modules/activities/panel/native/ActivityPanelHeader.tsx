...
// Dependencies: [32, 19, 17, 1371, 9758, 505, 21, 4303, 712, 1609, 4036, 16087, 4013, 5427, 16091, 589, 5734, 16092, 16096, 16097, 16102, 16081, 2]
// Exports: useBaseActivityPanelHeader

// Module 16090 (useBaseActivityPanelHeaderContent)
...
let closure_19 = importAllResult.memo(function ActivityPanelHeaderContentInner(wrapperOffset) {
  ...
  let tmp8Result = tmp8(importDefault(16092), { applicationId: id });
