...
// Function ID: 16104
// Name: keyExtractor
// Dependencies: [19, 676, 21, 4303, 5236, 712, 1297, 1236, 4846, 4271, 4159, 4299, 16104, 5369, 5399, 2]
// Exports: default

// Module 16103 (keyExtractor)
...
function FriendsEmptyComponent() {
  ...
  items[1] = callback(require(4846) /* PressableBase */.PressableOpacity, obj);
  obj[0] = items;
