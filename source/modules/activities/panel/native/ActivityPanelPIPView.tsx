...
// Dependencies: [19, 17, 4437, 9548, 1391, 1390, 4473, 9387, 16511, 676, 11758, 21, 1297, 4445, 712, 1629, 589, 1494, 16506, 10911, 4185, 16512, 4172, 4446, 4879, 16513, 16514, 1236, 5604, 4079, 16508, 9525, 2]
// Exports: useBaseActivityPanelPIPView

// Module 16510 (BaseActivityPanelPIPView)
...
import { DEFAULT_PORTRAIT_LETTERBOX_CONFIG as closure_15 } from "DEFAULT_PORTRAIT_SAFE_AREAS_CONFIG" /* 16511 */;
import { ThemeTypes } from "ME" /* 676 */;
import { PIP_WINDOW_OFFSET } from "MIN_PAN_GESTURE_MOVE" /* 11758 */;
...
class BaseActivityPanelPIPView {
  constructor(arg0) {
    ...
    class J {
      constructor() {
        ...
        if (tmp6) {
          ...
          obj1[2] = require("module_4185").runOnJS;
    ...
    obj2[0] = require("module_4185").runOnJS;
    obj2[1] = setMode;
    obj2[2] = width;
    W.__closure = obj2;
    ...
    obj4[1] = tmp15(require("module_4185").View, obj5);
