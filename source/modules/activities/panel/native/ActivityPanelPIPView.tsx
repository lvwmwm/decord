...
class BaseActivityPanelPIPView {
  constructor(arg0) {
    ...
    class J {
      constructor() {
        ...
        if (tmp6) {
          ...
          obj1[2] = require("module_4146").runOnJS;
    ...
    obj2[0] = require("module_4146").runOnJS;
    obj2[1] = setMode;
    obj2[2] = width;
    W.__closure = obj2;
    ...
    obj4[1] = tmp15(require("module_4146").View, obj5);
