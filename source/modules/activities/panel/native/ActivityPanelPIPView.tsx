...
// Dependencies: [19, 17, 4295, 10761, 1391, 1390, 4328, 9764, 16110, 676, 11650, 21, 1297, 4303, 712, 1628, 589, 1493, 16105, 10336, 4042, 16111, 4648, 4304, 4713, 16112, 16113, 1236, 4031, 5427, 3938, 16107, 10726, 2]
// Exports: useBaseActivityPanelPIPView

// Module 16109 (BaseActivityPanelPIPView)
...
class BaseActivityPanelPIPView {
  constructor(arg0) {
    ...
    class J {
      constructor() {
        ...
        if (tmp6) {
          ...
          obj1[2] = require("module_4042").runOnJS;
    ...
    obj2[0] = require("module_4042").runOnJS;
    obj2[1] = setMode;
    obj2[2] = width;
    W.__closure = obj2;
    ...
    obj4[1] = tmp15(require("module_4042").View, obj5);
