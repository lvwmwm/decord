// Module ID: 16122
// Function ID: 16123
// Dependencies: [19, 17, 9764, 21, 4303, 4714, 9485, 1236, 7753, 2]
...
const memoResult = importAllResult.memo(function MinimizeActivityButton(arg0) {
  ...
  if (undefined !== activityName) {
    if ("" !== activityName) {
      ...
      obj[0] = importDefault(9485);
      const intl2 = setMode(1236).intl;
      obj[1] = intl2.string(setMode(1236).t.brPQ5U);
      obj[2] = callback;
      obj[3] = activityName;
      obj[1] = jsx(setMode(4714).Button, { icon: null, accessibilityLabel: null, onPress: null, text: null, size: "sm", variant: "secondary-overlay", maxFontSizeMultiplier: 1, shrink: true });
