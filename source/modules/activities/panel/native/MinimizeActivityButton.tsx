// Module ID: 16611
// Function ID: 16612
// Dependencies: [19, 17, 9466, 21, 4478, 4928, 8936, 1236, 8006, 2]

// Module 16611
import registerAssetDefault from "registerAsset" /* 8936 */;
...
const memoResult = importAllResult.memo(function MinimizeActivityButton(arg0) {
  ...
  obj[2] = callback;
  tmp3 = jsx(setMode(8006).IconButton, { icon: registerAssetDefault, accessibilityLabel: null, onPress: null, size: "sm", variant: "secondary-overlay", maxFontSizeMultiplier: 1 });
});
