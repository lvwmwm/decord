// Module ID: 16575
// Function ID: 16576
// Dependencies: [19, 17, 9427, 21, 4448, 4896, 8899, 1236, 7974, 2]

// Module 16575
import registerAssetDefault from "registerAsset" /* 8899 */;
...
const memoResult = importAllResult.memo(function MinimizeActivityButton(arg0) {
  ...
  if (undefined !== activityName) {
    if ("" !== activityName) {
      ...
      obj[2] = callback;
      obj[3] = activityName;
      obj[1] = jsx(setMode(4896).Button, { icon: null, accessibilityLabel: null, onPress: null, text: null, size: "sm", variant: "secondary-overlay", maxFontSizeMultiplier: 1, shrink: true });
  ...
  obj[2] = callback;
  tmp3 = jsx(setMode(7974).IconButton, { icon: registerAssetDefault, accessibilityLabel: null, onPress: null, size: "sm", variant: "secondary-overlay", maxFontSizeMultiplier: 1 });
});
