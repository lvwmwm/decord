// Module ID: 16523
// Function ID: 16524
// Dependencies: [19, 17, 9387, 21, 4445, 4880, 8859, 1236, 7938, 2]
...
const memoResult = importAllResult.memo(function MinimizeActivityButton(arg0) {
  ...
  if (undefined !== activityName) {
    if ("" !== activityName) {
      ...
      obj[2] = callback;
      obj[3] = activityName;
      obj[1] = jsx(setMode(4880).Button, { icon: null, accessibilityLabel: null, onPress: null, text: null, size: "sm", variant: "secondary-overlay", maxFontSizeMultiplier: 1, shrink: true });
  ...
  obj[2] = callback;
  tmp3 = jsx(setMode(7938).IconButton, { icon: registerAssetDefault, accessibilityLabel: null, onPress: null, size: "sm", variant: "secondary-overlay", maxFontSizeMultiplier: 1 });
});
