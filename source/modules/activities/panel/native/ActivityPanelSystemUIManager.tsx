...
// Dependencies: [19, 9645, 21, 15940, 500, 7641, 10537, 2]

// Module 15963 (BaseActivityPanelSystemUIManager)
...
const memoResult = importAllResult.memo(() => {
  const context = importAllResult.useContext(importDefault(15940));
