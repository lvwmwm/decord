...
// Dependencies: [19, 9809, 21, 16166, 500, 7793, 10630, 2]

// Module 16189 (BaseActivityPanelSystemUIManager)
...
const memoResult = importAllResult.memo(() => {
  const context = importAllResult.useContext(importDefault(16166));
