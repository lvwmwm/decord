...
// Dependencies: [19, 9809, 21, 16175, 500, 7793, 10628, 2]

// Module 16198 (BaseActivityPanelSystemUIManager)
...
const memoResult = importAllResult.memo(() => {
  const context = importAllResult.useContext(importDefault(16175));
