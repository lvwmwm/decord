...
// Dependencies: [19, 9805, 21, 16164, 500, 7789, 10714, 2]

// Module 16187 (BaseActivityPanelSystemUIManager)
...
const memoResult = importAllResult.memo(() => {
  const context = importAllResult.useContext(importDefault(16164));
