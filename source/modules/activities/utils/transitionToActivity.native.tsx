...
// Dependencies: [10174, 1347, 5660, 10175, 3749, 3982, 10445, 10402, 10817, 4324, 10449, 4099, 5668, 2]
// Exports: default

// Module 10444 (transitionToActivity)
...
export default function transitionToActivity(arg0, _location) {
  ...
  if (null != embeddedActivityLocationChannelId) {
    let tmp4 = !require(3982) /* _createForOfIteratorHelperLoose */.isModalOpen(importDefault(10445));
    if (tmp4) {
      tmp4 = importDefault(10402)(embeddedActivityLocationChannelId);
    }
    if (tmp4) {
      importDefault(10817)(embeddedActivityLocationChannelId);
    }
    selfEmbeddedActivityForLocation = selfEmbeddedActivityForLocation.getSelfEmbeddedActivityForLocation(_location);
    if (null != selfEmbeddedActivityForLocation) {
      if (importDefault(10402)(embeddedActivityLocationChannelId)) {
        ...
        const participant = obj3.selectParticipant(embeddedActivityLocationChannelId, require(10449) /* getEmbeddedActivityParticipantId */.getEmbeddedActivityParticipantId(obj));
        const obj4 = require(10449) /* getEmbeddedActivityParticipantId */;
