      ...
      if (c8 === 2) {
        ...
        try {
          ...
          if (0 === c7) {
            ...
            const aPIError = new callback(4088).APIError(ensureGuildLoaded);
            obj3[5] = aPIError;
      ...
      if (1 === tmp5) {
        if (arg0 === 1) {
          ...
          const promise = new Promise((arg0) => {
            ...
            const channel = outer1_4.getChannel(_undefined(3807).getEmbeddedActivityLocationChannelId(_location));
            if (null != value) {
              if (null != channel) {
                if (dependencyMap != null) {
                  dependencyMap();
