...
// Dependencies: [676, 3957, 595, 1384, 7120, 2]
// Exports: computeActivityFlags, isContextlessEmbeddedActivity

// Module 10358 (computeActivityFlags)
import ME from "ME";
...
export const computeActivityFlags = function computeActivityFlags(activity, flag, arg2, canLaunchFrameResult, privacy) {
  ...
  if (flag2) {
    const AllowActivityPartyPrivacyFriends2 = require(3957) /* explicitContentFromProto */.AllowActivityPartyPrivacyFriends;
    const setting = AllowActivityPartyPrivacyFriends2.getSetting();
    const AllowActivityPartyPrivacyVoiceChannel2 = require(3957) /* explicitContentFromProto */.AllowActivityPartyPrivacyVoiceChannel;
    ...
    if (!value) {
      ...
      const AllowActivityPartyPrivacyFriends = require(3957) /* explicitContentFromProto */.AllowActivityPartyPrivacyFriends;
      const setting2 = AllowActivityPartyPrivacyFriends.getSetting();
      const AllowActivityPartyPrivacyVoiceChannel = require(3957) /* explicitContentFromProto */.AllowActivityPartyPrivacyVoiceChannel;
...
export const isContextlessEmbeddedActivity = function isContextlessEmbeddedActivity(remoteApplicationActivity) {
  ...
  if (hasFlagResult) {
    hasFlagResult = importDefault(7120)(remoteApplicationActivity);
  }
