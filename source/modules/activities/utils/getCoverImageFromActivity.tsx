...
// Dependencies: [4327, 8181, 2]
// Exports: default

// Module 12553 (getCoverImageFromActivity)
  ...
  if (null != assets) {
    ...
    if (null != assets.assets) {
      ...
      if (null != assets.assets.large_image) {
        ...
        assetImage = require(8181) /* updateAssets */.getAssetImage(application_id, assets.assets.large_image, items);
        const obj = require(8181) /* updateAssets */;
      }
    }
  }
  return assetImage;
