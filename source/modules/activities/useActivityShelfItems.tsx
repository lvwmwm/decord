...
// Dependencies: [31, 5663, 566, 11151, 11152, 11153, 2]
// Exports: default
...
export default function useActivityShelfItems(enableFilter) {
  ...
  const obj = flag(566);
  const activityShelfData = flag(11151).useActivityShelfData(enableFilter.guildId);
  let tmp2 = filter(11152)(activityShelfData);
  dependencyMap = tmp2;
  const obj2 = flag(11151);
  developerActivityShelfItems = flag(11153).useDeveloperActivityShelfItems();
