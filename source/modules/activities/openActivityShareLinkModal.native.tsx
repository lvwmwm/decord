...
// Dependencies: [4166, 4509, 13751, 1988, 2]
// Exports: closeActivityShareLinkModal, openActivityShareLinkModal

// Module 13750 (ACTIVITY_SHARE_LINK_MODAL)
...
export const openActivityShareLinkModal = function openActivityShareLinkModal(arg0) {
  ...
  importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(13751, dependencyMap.paths), obj, ACTIVITY_SHARE_LINK_MODAL, { presentation: "modal" });
};
