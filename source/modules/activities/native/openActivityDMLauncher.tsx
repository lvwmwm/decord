...
// Dependencies: [5, 1498, 5768, 4354, 12282, 11032, 5787, 7024, 4207, 1626, 2]
// Exports: default

// Module 13393 (_openActivityDMLauncher)
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (arg0 === 1) {
              ...
              obj2[0] = callback2(5768).fetchApplication(callback);
              return obj2;
            }
          } else {
            if (2 === tmp5) {
              ...
              if (arg0 === 1) {
                ...
                if (flag) {
                  ...
                  obj10[1] = {};
                  obj10[2] = c7;
                  const items = [callback2(5787).ACTIVITY_BOOKMARK];
                  obj10[3] = items;
                  obj10[4] = callback(7024).CommandOrigin.ACTIVITY_BOOKMARK_EMBED;
                  obj10[5] = callback2;
                  obj10[6] = customId;
                  c7 = 5;
                  customId = 1;
                  const obj11 = { value: null, done: false };
                  obj11[0] = callback2(11032)(obj10);
                  return obj11;
                }
              }
            } else if (arg0 === 1) {
