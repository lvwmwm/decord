...
// Dependencies: [5, 1499, 5901, 4457, 12494, 11133, 5920, 7195, 4306, 1627, 2]
// Exports: default

// Module 13605 (_openActivityDMLauncher)
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (arg0 === 1) {
              ...
              obj2[0] = callback2(5901).fetchApplication(callback);
              return obj2;
            }
          } else {
            if (2 === tmp5) {
              ...
              if (arg0 === 1) {
                ...
                if (flag) {
                  ...
                  obj10[1] = {};
                  obj10[2] = c7;
                  const items = [callback2(5920).ACTIVITY_BOOKMARK];
                  obj10[3] = items;
                  obj10[4] = callback(7195).CommandOrigin.ACTIVITY_BOOKMARK_EMBED;
                  obj10[5] = callback2;
                  obj10[6] = customId;
                  c7 = 5;
                  customId = 1;
                  const obj11 = { value: null, done: false };
                  obj11[0] = callback2(11133)(obj10);
                  return obj11;
                }
              }
            } else if (arg0 === 1) {
