...
// Dependencies: [5, 32, 19, 17, 1391, 1922, 1390, 9669, 4335, 21, 4342, 712, 589, 7351, 11577, 13809, 5774, 1370, 13811, 6965, 7188, 4062, 1236, 5796, 4061, 1493, 1628, 500, 5317, 8431, 5310, 6051, 4286, 4889, 11131, 11149, 2]
// Exports: default

// Module 13810 (ActivityShareLinkModal)
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          closure_1 = outer1_0(13811).resolveActivityShareMessageContent(c3, name, closure_12);
          callback2(true);
          ...
          const result = outer1_0(13809).closeActivityShareLinkModal();
          const obj9 = outer1_0(13809);
        }
        c3 = 3;
        obj = { value: null, done: true };
        obj[0] = arg1;
