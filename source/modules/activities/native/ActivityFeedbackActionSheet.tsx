...
// Dependencies: [19, 4328, 676, 11087, 21, 698, 16427, 11108, 1236, 11090, 4001, 16428, 2]
// Exports: default

// Module 16426 (ActivityFeedbackReasons)
import "noop";
...
export default function ActivityFeedbackActionSheet(activityApplication) {
  ...
  const tmp2 = importDefault(16427)(true, true === prop);
  ...
  return jsx(importDefault(11108), { applicationName: activityApplication.name });
};
