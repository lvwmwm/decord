...
// Dependencies: [32, 19, 17, 1371, 4214, 4215, 21, 4189, 10652, 1474, 709, 10654, 10655, 10598, 589, 10657, 10605, 10658, 10664, 2]

// Module 10653 (useBaseActivityView)
...
const memoResult = importAllResult.memo(function EmbeddedActivityViewInner(portraitSafeAreasConfig) {
  ...
  currentEmbeddedActivity(10657)({ connectedEmbeddedActivity: currentEmbeddedActivity });
  ...
  obj1 = { orientationLockState: stateFromStores, showLoadingIndicator: tmp19, setShowLoadingStateForLockingOrientation: tmp9, application: tmp4, setOrientationLockState: tmp5(10652).setOrientationLockState };
  ...
  if (null != currentEmbeddedActivity) {
    ...
    if (null != id) {
      ...
      const tmp2Result = tmp2(10658);
      obj3[9] = tmp5(10664).allowPopups(tmp4);
      obj3[11] = layoutMode === constants.PIP || layoutMode === constants.GRID;
      obj3[12] = tmp5(10605).EMBEDDED_ACTIVITY_WEB_VIEW_KEY;
      if (tmp23) {
