...
// Dependencies: [32, 19, 17, 1371, 4218, 4219, 21, 4193, 10670, 1474, 709, 10672, 10673, 10616, 589, 10675, 10623, 10676, 10682, 2]
...
const memoResult = importAllResult.memo(function EmbeddedActivityViewInner(portraitSafeAreasConfig) {
  ...
  const tmp4 = currentEmbeddedActivity(10616)();
  dependencyMap = tmp4;
  ...
  currentEmbeddedActivity(10675)({ connectedEmbeddedActivity: currentEmbeddedActivity });
  ...
  obj1 = { orientationLockState: stateFromStores, showLoadingIndicator: tmp19, setShowLoadingStateForLockingOrientation: tmp9, application: tmp4, setOrientationLockState: tmp5(10670).setOrientationLockState };
  ...
  if (null != currentEmbeddedActivity) {
    ...
    if (null != id) {
      ...
      const tmp2Result = tmp2(10676);
      obj3[9] = tmp5(10682).allowPopups(tmp4);
      obj3[11] = layoutMode === constants.PIP || layoutMode === constants.GRID;
      obj3[12] = tmp5(10623).EMBEDDED_ACTIVITY_WEB_VIEW_KEY;
      if (tmp23) {
