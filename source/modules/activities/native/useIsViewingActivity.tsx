...
// Dependencies: [4358, 10627, 4197, 10624, 589, 2]
// Exports: useIsViewingActivity

// Module 10637 (useIsViewingActivity)
...
export const useIsViewingActivity = function useIsViewingActivity(channelId) {
  ...
  let tmp = importDefault(10627)(channelId);
  const isModalOpen = channelId(4197).useIsModalOpen(importDefault(10624));
