...
// Dependencies: [4316, 10660, 4158, 10657, 589, 2]
// Exports: useIsViewingActivity

// Module 10670 (useIsViewingActivity)
...
export const useIsViewingActivity = function useIsViewingActivity(channelId) {
  ...
  let tmp = importDefault(10660)(channelId);
  const isModalOpen = channelId(4158).useIsModalOpen(importDefault(10657));
