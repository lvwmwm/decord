...
obj = { 9223372036854775807: true, 9223372036854775807: true, 0: true, -9223372036854775808: true, -9223372036854775808: true, -9223372036854775808: true, 0: true };
const items = [{ rotateZ: "225deg" }];
obj.transform = items;
let closure_8 = obj.createStyles({ arrow: obj, tooltip: { padding: 16 }, tooltipContainer: {}, tooltipText: { alignSelf: null, padding: null }, closeButtonWrapper: { marginTop: 14 } });
