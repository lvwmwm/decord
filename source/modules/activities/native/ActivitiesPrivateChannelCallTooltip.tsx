...
// Dependencies: [19, 17, 4247, 4280, 21, 4255, 589, 4116, 4256, 1297, 1236, 4665, 2]
// Exports: default

// Module 12015 (ActivitiesPrivateChannelCallTooltip)
import "noop";
...
export default function ActivitiesPrivateChannelCallTooltip(onClosePress) {
  ...
  obj3[1] = jsx(num(4665).Button, { text: null, onPress: null, variant: "secondary", size: "sm", grow: true });
