...
// Function ID: 10498
// Name: DomainScreen
// Dependencies: [32, 19, 17, 676, 21, 4285, 712, 1480, 530, 5311, 4281, 1236, 8388, 10498, 4695, 4490, 5253, 5704, 2]
// Exports: default

// Module 10497 (DomainScreen)
...
function HTTPProofScreen(children) {
  ...
  const obj3 = { variant: "text-md/normal", selectable: true, style: tmp.code, children: null };
  let obj6 = require(10498) /* EXAMPLE_DOMAIN */;
  ...
  obj[2] = items;
  return callback3(require(5311) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
}
