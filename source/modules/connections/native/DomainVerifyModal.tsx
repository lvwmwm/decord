...
// Function ID: 10467
// Name: DomainScreen
// Dependencies: [32, 19, 17, 676, 21, 4255, 712, 1480, 530, 5257, 4251, 1236, 8248, 10467, 4665, 4460, 5223, 5650, 2]
// Exports: default

// Module 10466 (DomainScreen)
...
function HTTPProofScreen(children) {
  ...
  const obj3 = { variant: "text-md/normal", selectable: true, style: tmp.code, children: null };
  let obj6 = require(10467) /* EXAMPLE_DOMAIN */;
  ...
  obj[2] = items;
  return callback3(require(5257) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
}
