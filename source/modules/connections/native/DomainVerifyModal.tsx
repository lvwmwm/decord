...
// Function ID: 10627
// Name: DomainScreen
// Dependencies: [32, 19, 17, 676, 21, 4344, 712, 1499, 530, 5367, 4340, 1236, 8510, 10627, 4754, 4549, 5309, 5822, 2]
// Exports: default

// Module 10626 (DomainScreen)
...
function HTTPProofScreen(children) {
  ...
  const items1 = [callback2(require(4340) /* Text */.Text, obj2), , , ];
  const obj3 = { variant: "text-md/normal", selectable: true, style: tmp.code, children: null };
  let obj6 = require(10627) /* EXAMPLE_DOMAIN */;
  obj3[3] = obj6.getHttpName(domain);
  items1[1] = callback2(require(4340) /* Text */.Text, obj3);
  const obj4 = { variant: "text-md/normal", children: null };
  const intl3 = require(1236) /* getSystemLocale */.intl;
  obj4[1] = intl3.string(require(1236) /* getSystemLocale */.t.PVLriT);
  items1[2] = callback2(require(4340) /* Text */.Text, obj4);
  items1[3] = callback2(require(4340) /* Text */.Text, { variant: "text-md/normal", selectable: true, style: tmp.code, children: children.proof });
  obj1[1] = items1;
