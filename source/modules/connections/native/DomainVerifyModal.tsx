...
// Function ID: 10586
// Name: DomainScreen
// Dependencies: [32, 19, 17, 676, 21, 4303, 712, 1499, 530, 5328, 4299, 1236, 8471, 10586, 4714, 4509, 5270, 5783, 2]
// Exports: default

// Module 10585 (DomainScreen)
...
function HTTPProofScreen(children) {
  ...
  const obj3 = { variant: "text-md/normal", selectable: true, style: tmp.code, children: null };
  let obj6 = require(10586) /* EXAMPLE_DOMAIN */;
  ...
  items1[2] = callback2(require(4299) /* Text */.Text, obj4);
  items1[3] = callback2(require(4299) /* Text */.Text, { variant: "text-md/normal", selectable: true, style: tmp.code, children: children.proof });
  obj1[1] = items1;
