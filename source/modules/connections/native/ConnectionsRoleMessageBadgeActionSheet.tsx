...
// Function ID: 11219
// Name: PopoutCheck
// Dependencies: [32, 19, 17, 1911, 1218, 1971, 1964, 1891, 11219, 5125, 676, 21, 4303, 712, 1236, 5124, 4255, 4299, 4239, 12, 4005, 5000, 11039, 9131, 1297, 1416, 4153, 38, 5728, 5748, 589, 698, 4498, 5232, 5397, 5772, 4714, 4271, 11042, 8783, 2]
// Exports: default

// Module 11218 (PopoutCheck)
...
function PopoutCheck(arg0) {
  ...
  if (null != formatResult) {
    ...
    const items = [callback(require(4255) /* CheckmarkLargeIcon */.CheckmarkLargeIcon, obj3), ];
    const obj4 = { variant: "text-xs/medium", color: "mobile-text-heading-primary", children: null };
    obj4[2] = formatResult;
    items[1] = callback(require(4299) /* Text */.Text, obj4);
    obj2[1] = items;
