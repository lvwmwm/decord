...
// Dependencies: [5, 32, 19, 676, 21, 4444, 5174, 1236, 5297, 4158, 10724, 5500, 4440, 8690, 1297, 4879, 5442, 5955, 2]
// Exports: default

// Module 10723 (FederatedSocialModal)
...
export default function FederatedSocialModal(platformType) {
  ...
  obj[1] = _require(5442).getHeaderBackButton(platformType.onClose);
  ...
  screens[0] = obj;
  return callback(_require(5955).Navigator, { initialRouteName: "root", screens });
};
