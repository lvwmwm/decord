...
// Dependencies: [5, 32, 19, 676, 21, 4445, 5179, 1236, 5302, 4158, 9274, 5505, 4441, 7637, 1297, 4880, 5447, 5960, 2]
// Exports: default

// Module 9273 (FederatedSocialModal)
...
export default function FederatedSocialModal(platformType) {
  ...
  obj[1] = _require(5447).getHeaderBackButton(platformType.onClose);
  ...
  screens[0] = obj;
  return callback(_require(5960).Navigator, { initialRouteName: "root", screens });
};
