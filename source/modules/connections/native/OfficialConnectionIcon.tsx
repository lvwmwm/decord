...
// Dependencies: [19, 17, 676, 21, 4255, 5619, 712, 688, 1297, 10926, 10927, 2]
// Exports: default

// Module 10925 (OfficialConnectionIcon)
import "noop";
...
export default function OfficialConnectionIcon(arg0) {
  ...
  let obj1 = require(5619) /* useRoleIcon */;
