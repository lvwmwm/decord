...
function PlatformIcon(platformType) {
  ...
  const source = obj2.makeSource(require(4035) /* AccessibilityAnnouncer */.isThemeLight(tmp3) ? icon.lightPNG : icon.darkPNG);
...
function ChannelName(channel) {
  ...
  const items1 = [tmp8, ];
  const tmp5 = importDefault(4380)(channel);
  const tmp6 = closure_30;
  const tmp7 = closure_8;
  items1[1] = callback2(require(4185) /* Text */.Text, { variant: "heading-lg/semibold", color: "text-default", style: tmp.channelNameText, lineClamp: 1, children: importDefault(4380)(channel) });
  obj[1] = items1;
...
function ConnectionsCheck(result) {
  ...
  if (connectionType === closure_20) {
    ...
    if (null != description) {
      ...
      obj = require(4996) /* officialApplicationIds */;
    ...
    if (null != formatResult) {
      ...
      obj2[3] = formatResult;
      tmp21Result = closure_29(require(4185) /* Text */.Text, obj2);
...
function ConnectionsChecks(eligibilityStatesGroups) {
  ...
  getUncachedChannelPermissions = eligibilityStatesGroups(3893).useToken(importDefault(712).unsafe_rawColors.GREEN_330);
  obj = { children: null };
