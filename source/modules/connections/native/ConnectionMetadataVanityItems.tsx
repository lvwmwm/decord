...
// Dependencies: [19, 17, 5166, 21, 4342, 712, 1236, 11022, 11023, 12, 1898, 4338, 1297, 5165, 2]
...
function VanityMetric(label) {
  ...
  style[1] = style;
  return callback(require(4338) /* Text */.Text, { variant: "text-xs/normal", color: "text-muted", style, children });
}
function VanityItem(style) {
  ...
  const items1 = [callback(require(1297) /* Button */.Icon, obj), callback(require(4338) /* Text */.Text, { variant: "text-xs/normal", color: "text-muted", style, children: label })];
  obj[1] = items1;
...
function VanityTag(arg0) {
  ...
  items[2] = style;
  return callback(View, { style: items, children: callback(require(4338) /* Text */.Text, { variant: "text-xs/normal", color: "text-muted", style: textStyle, children: label }) });
}
