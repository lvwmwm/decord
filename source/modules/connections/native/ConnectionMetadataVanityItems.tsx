...
// Dependencies: [19, 17, 5107, 21, 4285, 712, 1236, 10967, 10968, 12, 1879, 4281, 1297, 5106, 2]
...
function VanityDate(arg0) {
  ...
  const tmp = createCacheKey();
  obj[0] = require(5106) /* officialApplicationIds */.getCreatedAtDate(date, locale);
  obj[1] = label;
