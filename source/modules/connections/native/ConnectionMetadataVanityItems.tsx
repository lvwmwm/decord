...
// Dependencies: [19, 17, 5077, 21, 4255, 712, 1236, 10935, 10936, 12, 1851, 4251, 1297, 5076, 2]
...
function VanityDate(arg0) {
  ...
  const tmp = createCacheKey();
  obj[0] = require(5076) /* officialApplicationIds */.getCreatedAtDate(date, locale);
  obj[1] = label;
