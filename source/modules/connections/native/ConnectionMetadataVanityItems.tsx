...
// Dependencies: [19, 17, 5225, 21, 4661, 712, 1236, 10773, 10774, 12, 1898, 4734, 1297, 5224, 2]
...
function VanityMetric(label) {
  ...
  style[1] = style;
  return callback(require(4734) /* Text */.Text, { variant: "text-xs/normal", color: "text-muted", style, children });
}
function VanityItem(style) {
  ...
  const items1 = [callback(require(1297) /* Button */.Icon, obj), callback(require(4734) /* Text */.Text, { variant: "text-xs/normal", color: "text-muted", style, children: label })];
  obj[1] = items1;
...
function VanityTag(arg0) {
  ...
  items[2] = style;
  return callback(View, { style: items, children: callback(require(4734) /* Text */.Text, { variant: "text-xs/normal", color: "text-muted", style: textStyle, children: label }) });
}
function VanityDate(arg0) {
  ...
  const tmp = createCacheKey();
  obj[0] = require(5224) /* officialApplicationIds */.getCreatedAtDate(date, locale);
  obj[1] = label;
