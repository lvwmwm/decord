...
// Dependencies: [19, 17, 5124, 21, 4302, 712, 1236, 10982, 10983, 12, 1879, 4298, 1297, 5123, 2]
...
function VanityMetric(label) {
  ...
  let obj = require(1879) /* shortenAndLocalizeNumber */;
  let str = "";
  ...
  style[1] = style;
  return callback(require(4298) /* Text */.Text, { variant: "text-xs/normal", color: "text-muted", style, children });
}
function VanityItem(style) {
  ...
  const items1 = [callback(require(1297) /* Button */.Icon, obj), callback(require(4298) /* Text */.Text, { variant: "text-xs/normal", color: "text-muted", style, children: label })];
  obj[1] = items1;
...
function VanityTag(arg0) {
  ...
  items[2] = style;
  return callback(View, { style: items, children: callback(require(4298) /* Text */.Text, { variant: "text-xs/normal", color: "text-muted", style: textStyle, children: label }) });
}
function VanityDate(arg0) {
  ...
  const tmp = createCacheKey();
  obj[0] = require(5123) /* officialApplicationIds */.getCreatedAtDate(date, locale);
  obj[1] = label;
