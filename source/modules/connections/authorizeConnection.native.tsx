...
// Dependencies: [4997, 676, 709, 4157, 8927, 8962, 8979, 4395, 8990, 1959, 4871, 8997, 8197, 3886, 4995, 2]
// Exports: default

// Module 8961 (authorizeConnection)
...
export default function authorizeConnection(overrideUrl) {
  ...
  if (platformType === PlatformTypes.XBOX) {
    ...
    overrideUrl(8927).showModal(items);
    if (null != onClose) {
    ...
    if (platformType !== tmp.PLAYSTATION) {
      if (platformType !== tmp.PLAYSTATION_STAGING) {
        if (platformType === tmp.CRUNCHYROLL) {
          ...
          overrideUrl(8979).showModal(items1);
          if (null != onClose) {
          ...
          obj[0] = items2;
          overrideUrl(4395).pushLazy(handleModalClose5(1959)(8990, dependencyMap.paths), obj);
          if (null != onClose) {
          ...
          if (true === isFederated) {
            ...
            tmp28Result.pushLazy(handleModalClose5(1959)(8997, tmp29.paths), obj);
            if (null != onClose) {
            ...
            if (null != overrideUrl) {
              if (platformType === closure_3) {
                let obj2 = handleModalClose5(8197);
    ...
    overrideUrl(8962).showModal(items3, platformType);
    if (null != onClose) {
