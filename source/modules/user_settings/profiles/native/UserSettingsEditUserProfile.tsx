...
// Dependencies: [19, 1922, 21, 7139, 7159, 589, 8417, 14002, 2]
// Exports: default
...
export default function UserSettingsEditUserProfile(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    obj[0] = tmp3(importDefault(7159).USER_SETTINGS_USER_PROFILE).analyticsLocations;
    obj = { currentUser: null };
    obj[0] = stateFromStores;
    const merged = Object.assign(arg0);
    obj[1] = jsx(importDefault(14002), { currentUser: null });
    tmp7 = jsx(stateFromStores(7139).AnalyticsLocationProvider, { currentUser: null });
    const tmpResult = importDefault(14002);
  }
  return tmp7;
};
