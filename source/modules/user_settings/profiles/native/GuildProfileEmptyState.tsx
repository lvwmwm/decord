...
// Dependencies: [5, 19, 17, 21, 4344, 14025, 4340, 1236, 4754, 12123, 2007, 2]
// Exports: default
...
export default function GuildProfileEmptyState() {
  ...
  items[2] = callback2(require(4340) /* Text */.Text, obj2);
  ...
  items[4] = callback2(require(4754) /* Button */.Button, obj5);
  obj[1] = items;
