...
// Dependencies: [5, 31, 27, 33, 4165, 13723, 4161, 1212, 4578, 11774, 1935, 2]
// Exports: default

// Module 13722 (GuildProfileEmptyState)
...
export default function GuildProfileEmptyState() {
  ...
  obj = { style: tmp2.image, children: callback2(importDefault(13723), obj) };
  ...
  items[2] = callback2(require(4161) /* Text */.Text, obj2);
  ...
  items[4] = callback2(require(4578) /* Button */.Button, obj5);
  obj.children = items;
