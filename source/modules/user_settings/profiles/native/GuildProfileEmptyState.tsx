...
// Dependencies: [5, 19, 17, 21, 4302, 13888, 4298, 1236, 4712, 11996, 1988, 2]
// Exports: default

// Module 13887 (GuildProfileEmptyState)
...
export default function GuildProfileEmptyState() {
  ...
  obj = { style: tmp.image, children: callback2(importDefault(13888), obj) };
  obj = { style: tmp.image };
  ...
  items[2] = callback2(require(4298) /* Text */.Text, obj2);
  ...
  items[4] = callback2(require(4712) /* Button */.Button, obj5);
  obj[1] = items;
