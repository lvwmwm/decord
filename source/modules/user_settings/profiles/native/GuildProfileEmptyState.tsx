...
// Dependencies: [5, 19, 17, 21, 4303, 13958, 4299, 1236, 4714, 12062, 1988, 2]
// Exports: default

// Module 13957 (GuildProfileEmptyState)
...
export default function GuildProfileEmptyState() {
  ...
  obj = { style: tmp.image, children: callback2(importDefault(13958), obj) };
  obj = { style: tmp.image };
