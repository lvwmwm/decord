...
// Dependencies: [4297, 1301, 1304, 8226, 1346, 1362, 4325, 2]
  ...
  if (null == syncedClientTheme.getSyncedClientTheme(constants.LIGHT)) {
    if (null == obj1.getSyncedClientTheme(tmp3.DARK)) {
      ...
      if (null != arg0) {
        ...
        obj1[0] = tmp9;
        const result3 = tmp6(4325).updateSyncedClientTheme(tmp8, obj1);
        const tmp6Result1 = tmp6(4325);
      } else {
        obj2 = { theme: null };
        obj2[0] = customThemeBaseTheme;
        const result4 = tmp6(4325).updateSyncedClientTheme(tmp8, obj2);
        const tmp6Result2 = tmp6(4325);
      }
