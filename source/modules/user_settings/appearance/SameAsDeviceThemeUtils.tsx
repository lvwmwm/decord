...
// Dependencies: [4096, 1302, 1305, 8621, 4130, 4126, 2]
// Exports: disableSameAsDeviceTheme, enableSameAsDeviceTheme

// Module 14331 (enableSameAsDeviceTheme)
...
export const enableSameAsDeviceTheme = function enableSameAsDeviceTheme(arg0) {
  ...
  if (null == syncedClientTheme.getSyncedClientTheme(constants.LIGHT)) {
    if (null == obj1.getSyncedClientTheme(tmp3.DARK)) {
      ...
      const tmp4 = require(4130) /* AccessibilityAnnouncer */.isThemeDark(theme) ? tmp3.DARK : tmp3.LIGHT;
      ...
      const obj13 = require(4130) /* AccessibilityAnnouncer */;
    }
  }
  const result5 = require(4126) /* setSystemTheme */.setSameAsDeviceThemeEnabled(true);
  const obj11 = require(4126) /* setSystemTheme */;
  require(4126) /* setSystemTheme */.setUseSystemTheme(constants2.ON);
};
export const disableSameAsDeviceTheme = function disableSameAsDeviceTheme() {
  require(4126) /* setSystemTheme */.setUseSystemTheme(constants2.OFF);
  const obj = require(4126) /* setSystemTheme */;
  const result = require(4126) /* setSystemTheme */.setSameAsDeviceThemeEnabled(false);
};
