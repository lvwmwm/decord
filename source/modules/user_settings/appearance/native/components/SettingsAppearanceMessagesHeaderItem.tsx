...
// Module 14601 (MessagesHeaderItem)
import "noop";
...
export default function MessagesHeaderItem(animatedStyles) {
  ...
  obj[1] = jsx(require(4338) /* Text */.Text, { animated: true, style: animatedStyles.animatedStyles.textNormal, variant: "text-lg/bold", children: null });
