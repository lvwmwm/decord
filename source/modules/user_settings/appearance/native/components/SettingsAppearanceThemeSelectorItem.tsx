...
// Dependencies: [19, 17, 1302, 14383, 505, 21, 4255, 712, 4100, 3965, 4799, 1297, 14385, 647, 3959, 14386, 4069, 3973, 4797, 1236, 2]
// Exports: default

// Module 14384 (GradientThemeBackground)
...
function GradientThemeBackground(arg0) {
  ...
  const items1 = [closure_6(importDefault(4799), obj1), ];
  if (isThemeLocked) {
    const obj3 = { source: null, style: null };
    obj3[0] = importDefault(14385);
    obj3[1] = tmp4.lock;
...
function DefaultThemeBackground(item) {
  ...
  if ("system" === item.theme) {
    ...
    obj2[0] = token2;
    obj1[1] = tmp9(importDefault(14386), obj2);
...
function CustomThemeBackground(arg0) {
  ...
  obj1[3] = item;
  const items1 = [closure_6(require(4799) /* getMixedGradientColor */.CustomThemedGradient, obj1), ];
  if (isThemeLocked) {
    const obj3 = { source: null, style: null };
    obj3[0] = importDefault(14385);
    obj3[1] = tmp4.lock;
...
export default function ThemeSelectorItem(onPress) {
  ...
  return tmp9(require(4797) /* PressableBase */.PressableOpacity, obj1);
};
