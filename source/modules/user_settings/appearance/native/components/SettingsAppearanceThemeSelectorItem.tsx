...
// Dependencies: [19, 17, 1302, 14420, 505, 21, 4285, 712, 4129, 3994, 4829, 1297, 14422, 647, 3988, 14423, 4098, 4002, 4827, 1236, 2]
// Exports: default

// Module 14421 (GradientThemeBackground)
...
function GradientThemeBackground(arg0) {
  ...
  const items1 = [closure_6(importDefault(4829), obj1), ];
  if (isThemeLocked) {
    const obj3 = { source: null, style: null };
    obj3[0] = importDefault(14422);
    obj3[1] = tmp4.lock;
...
function DefaultThemeBackground(item) {
  ...
  const token2 = require(3988) /* map */.useToken(importDefault(712).colors.ICON_STRONG, theme);
  ...
  if ("system" === item.theme) {
    ...
    obj2[0] = token2;
    obj1[1] = tmp9(importDefault(14423), obj2);
...
function CustomThemeBackground(arg0) {
  ...
  obj1[3] = item;
  const items1 = [closure_6(require(4829) /* getMixedGradientColor */.CustomThemedGradient, obj1), ];
  if (isThemeLocked) {
    const obj3 = { source: null, style: null };
    obj3[0] = importDefault(14422);
    obj3[1] = tmp4.lock;
...
export default function ThemeSelectorItem(onPress) {
  ...
  if (isPreview) {
    isPreview = themePreset.type !== require(4098) /* ClientThemeType */.ClientThemeType.STANDARD_BACKGROUND_THEME;
  }
  if (themePreset.type === require(4098) /* ClientThemeType */.ClientThemeType.STANDARD_BACKGROUND_THEME) {
    let obj = { item: null };
    obj[0] = themePreset;
  ...
  const radioA11yNative = require(4002) /* useCheckboxA11yNative */.useRadioA11yNative({ selected: isSelected, disabled: isPreview });
  ...
  return tmp9(require(4827) /* PressableBase */.PressableOpacity, obj1);
};
