...
// Function ID: 109620
// Name: ChannelRowItem
// Dependencies: [31, 27, 653, 33, 4165, 689, 1273, 9070, 4161, 2]
// Exports: default

// Module 14285 (ChannelRowItem)
import "result";
...
export default function ChannelRowItem(isUnread) {
  ...
  if (null != avatar2) {
    ...
    let tmp12 = callback(require(9070) /* FacepileGroupDMAvatar */.FacepileGroupDMAvatar, obj3);
  } else {
  ...
  if (null == preview) {
    ...
    callback(require(4161) /* Text */.Text, obj9);
