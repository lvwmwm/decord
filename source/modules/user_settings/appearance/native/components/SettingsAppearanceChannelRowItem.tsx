...
// Function ID: 14304
// Name: ChannelRowItem
// Dependencies: [19, 17, 676, 21, 4189, 712, 1297, 9090, 4185, 2]
// Exports: default

// Module 14303 (ChannelRowItem)
import "noop";
...
export default function ChannelRowItem(isUnread) {
  ...
  if (null != avatar2) {
    ...
    let tmp5Result = tmp5(require(9090) /* FacepileGroupDMAvatar */.FacepileGroupDMAvatar, obj1);
    let tmp6 = require;
  } else {
    tmp6 = require;
  ...
  const items3 = [closure_4(tmp6(4185).Text, { animated: true, style: flag ? animatedStyles.textNormal : animatedStyles.textMuted, variant: "redesign/channel-title/semibold", children: title }), closure_4(tmp6(4185).Text, { animated: true, style: animatedStyles.textMuted, variant: "text-xs/medium", children: timestamp })];
  obj4[1] = items3;
  ...
  if (null == preview) {
    ...
    tmp5Result = tmp5(tmp6(4185).Text, animatedStyles);
