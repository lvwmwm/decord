...
// Function ID: 14455
// Name: ChannelRowItem
// Dependencies: [19, 17, 676, 21, 4302, 712, 1297, 9598, 4298, 2]
// Exports: default

// Module 14454 (ChannelRowItem)
import "noop";
...
export default function ChannelRowItem(isUnread) {
  ...
  if (null != avatar2) {
    ...
    let tmp5Result = tmp5(require(9598) /* FacepileGroupDMAvatar */.FacepileGroupDMAvatar, obj1);
    let tmp6 = require;
  } else {
    tmp6 = require;
