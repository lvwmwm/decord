// Module ID: 14542
// Function ID: 14543
// Dependencies: [19, 17, 14516, 21, 4042, 4725, 14543, 4304, 4307, 712, 1367, 14544, 2]
...
let num = module_4042.processColor("rgba(0, 0, 0, 0)");
if (num == null) {
  num = 0;
}
let closure_7 = require("module_4042").createAnimatedComponent(require("LinearGradient").LinearGradientNativeComponent);
let items = [num, num];
