// Module ID: 14534
// Function ID: 14535
// Dependencies: [19, 17, 14508, 21, 4036, 4725, 14535, 4304, 4307, 712, 1348, 14536, 2]
...
let num = module_4036.processColor("rgba(0, 0, 0, 0)");
if (num == null) {
  num = 0;
}
let closure_7 = require("module_4036").createAnimatedComponent(require("LinearGradient").LinearGradientNativeComponent);
let items = [num, num];
