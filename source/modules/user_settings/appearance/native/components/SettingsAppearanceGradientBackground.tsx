// Module ID: 14462
// Function ID: 14463
// Dependencies: [19, 17, 14436, 21, 4162, 4723, 14463, 4303, 4306, 712, 1348, 14464, 2]
...
let num = module_4162.processColor("rgba(0, 0, 0, 0)");
if (num == null) {
  num = 0;
}
let closure_7 = require("module_4162").createAnimatedComponent(require("LinearGradient").LinearGradientNativeComponent);
let items = [num, num];
