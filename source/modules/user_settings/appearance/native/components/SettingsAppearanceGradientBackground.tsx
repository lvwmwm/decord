// Module ID: 14446
// Function ID: 14447
// Dependencies: [19, 17, 14420, 21, 4145, 4706, 14447, 4286, 4289, 712, 1348, 14448, 2]
...
let num = module_4145.processColor("rgba(0, 0, 0, 0)");
if (num == null) {
  num = 0;
}
let closure_7 = require("module_4145").createAnimatedComponent(require("LinearGradient").LinearGradientNativeComponent);
let items = [num, num];
