...
// Module 14535 (SettingsAppearanceChannelListPreviewNitroUpsellComponent)
...
function animationEntering(value) {
  ...
  obj[0] = require(4713) /* CONFIG_NEVER_ANIMATE */.withSpring(value, require(4717) /* SUBTLE_SPRING */.springStandard);
  return obj;
}
