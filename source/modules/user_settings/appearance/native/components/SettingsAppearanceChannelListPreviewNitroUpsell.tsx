...
// Dependencies: [19, 17, 4277, 676, 21, 4145, 4706, 4694, 4698, 4285, 712, 5649, 5669, 8545, 8546, 4695, 1236, 1297, 589, 8582, 2]

// Module 14449 (SettingsAppearanceChannelListPreviewNitroUpsellComponent)
...
const memoResult = importAllResult.memo(function SettingsAppearanceChannelListPreviewNitroUpsell(visible) {
  ...
  obj[4] = callback;
  return closure_10(importDefault(8582), obj);
});
