...
// Dependencies: [19, 17, 4247, 676, 21, 4116, 4676, 4664, 4668, 4255, 712, 5595, 5615, 8404, 8405, 4665, 1236, 1297, 589, 8553, 2]

// Module 14412 (SettingsAppearanceChannelListPreviewNitroUpsellComponent)
...
function animationEntering(value) {
  ...
  obj[0] = require(4664) /* CONFIG_NEVER_ANIMATE */.withSpring(value, require(4668) /* SUBTLE_SPRING */.springStandard);
  return obj;
}
...
const memoResult = importAllResult.memo(function SettingsAppearanceChannelListPreviewNitroUpsell(visible) {
  ...
  obj[4] = callback;
  return closure_10(importDefault(8553), obj);
});
