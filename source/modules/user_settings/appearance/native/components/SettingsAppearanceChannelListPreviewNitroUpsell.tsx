...
// Dependencies: [19, 17, 4294, 676, 21, 4162, 4723, 4711, 4715, 4302, 712, 5668, 5688, 8562, 8563, 4712, 1236, 1297, 589, 8599, 2]

// Module 14465 (SettingsAppearanceChannelListPreviewNitroUpsellComponent)
...
function animationEntering(value) {
  ...
  obj[0] = require(4711) /* CONFIG_NEVER_ANIMATE */.withSpring(value, require(4715) /* SUBTLE_SPRING */.springStandard);
  return obj;
}
...
const memoResult = importAllResult.memo(function SettingsAppearanceChannelListPreviewNitroUpsell(visible) {
  ...
  obj[4] = callback;
  return closure_10(importDefault(8599), obj);
});
