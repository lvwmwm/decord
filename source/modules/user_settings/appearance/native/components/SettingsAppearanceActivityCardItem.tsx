...
// Dependencies: [19, 17, 1946, 14330, 21, 4054, 1297, 4193, 712, 647, 7974, 5145, 4189, 1851, 14331, 14332, 14333, 2]
// Exports: default
...
let closure_7 = require("module_4054").createAnimatedComponent(require("Button").Icon);
