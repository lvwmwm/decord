...
// Dependencies: [19, 21, 8037, 712, 14837, 2]
// Exports: default

// Module 14836 (ActivityCardsItem)
...
export default function ActivityCardsItem(animatedStyles) {
  ...
  return jsx(animatedStyles(8037).FlashList, { paddingVertical: ThemesDefault.space.PX_16, paddingHorizontal: ThemesDefault.space.PX_16 });
};
