...
// Dependencies: [19, 17, 21, 4342, 712, 14600, 14601, 14602, 4083, 1236, 14608, 7790, 14611, 2]
// Exports: default

// Module 14599 (ChannelListPreview)
...
export default function ChannelListPreview(useGradientBackground) {
  ...
  if (useGradientBackground) {
    ...
    obj[1] = callback(tmp4(14608), obj);
    tmp7 = callback(closure_4, obj);
    const tmp4Result = tmp4(14608);
  }
  const items2 = [tmp7, , ];
  ...
  items2[1] = callback(animatedStyles(7790).FlashList, obj1);
  items2[2] = callback(importDefault(14611), { visible: isNitroLocked, theme: themes[themeIndex] });
  obj[4] = items2;
