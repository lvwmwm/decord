...
// Dependencies: [19, 17, 21, 4285, 712, 14427, 14428, 14429, 4146, 1236, 14435, 7666, 14438, 2]
// Exports: default

// Module 14426 (ChannelListPreview)
...
export default function ChannelListPreview(useGradientBackground) {
  ...
  if (useGradientBackground) {
    ...
    obj[1] = callback(tmp4(14435), obj);
    tmp7 = callback(closure_4, obj);
    const tmp4Result = tmp4(14435);
  }
  const items2 = [tmp7, , ];
  ...
  items2[2] = callback(importDefault(14438), { visible: isNitroLocked, theme: themes[themeIndex] });
  obj[4] = items2;
