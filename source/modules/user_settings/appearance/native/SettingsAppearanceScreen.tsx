// Module ID: 14279
// Function ID: 14280
// Dependencies: [19, 4001, 1303, 1302, 14280, 7756, 21, 1480, 500, 9118, 1236, 9912, 705, 4616, 14281, 647, 10120, 13678, 2]
...
const memoResult = importAllResult.memo(() => {
  ...
  nativeStackNavigation(4616)(() => {
    if (initialize.shouldSync("appearance")) {
      const userCustomThemes = _undefined(14281).fetchUserCustomThemes();
      const obj = _undefined(14281);
    }
  });
  ...
  return jsx(nativeStackNavigation(13678), { node }, "" + theme + "-" + gradientPresetId);
});
