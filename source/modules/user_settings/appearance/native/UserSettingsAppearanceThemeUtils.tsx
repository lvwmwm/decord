...
// Dependencies: [3942, 1322, 1278, 1281, 653, 3943, 1851, 3944, 1282, 14123, 11119, 8042, 3840, 3972, 675, 2]
...
// Module 14122 (getThemeNameForAnalytics)
...
export const handleSaveTheme = function handleSaveTheme(found, analyticsLocations, isSynced) {
  ...
  if ("system" === found.theme) {
    const result = require(14123) /* updateBackgroundGradientPreset */.resetBackgroundGradientPreset();
    const obj15 = require(14123) /* updateBackgroundGradientPreset */;
    require(11119) /* updateCustomTheme */.resetCustomTheme();
    const obj16 = require(11119) /* updateCustomTheme */;
    obj = { theme: found.theme };
    let saveClientThemeResult = require(8042) /* convertThemeToProto */.saveClientTheme(obj);
    const obj17 = require(8042) /* convertThemeToProto */;
  } else if (found.type === require(3944) /* ClientThemeType */.ClientThemeType.CUSTOM_BACKGROUND_GRADIENT) {
    const result1 = require(14123) /* updateBackgroundGradientPreset */.resetBackgroundGradientPreset();
    const obj10 = require(14123) /* updateBackgroundGradientPreset */;
    require(11119) /* updateCustomTheme */.updateCustomTheme(found.customThemeSettings, found.theme);
    const obj11 = require(11119) /* updateCustomTheme */;
    obj = { customUserThemeSettings: found.customThemeSettings };
    const obj12 = require(8042) /* convertThemeToProto */;
    ...
    const result2 = require(14123) /* updateBackgroundGradientPreset */.updateBackgroundGradientPreset(found.id);
    const obj6 = require(14123) /* updateBackgroundGradientPreset */;
    require(11119) /* updateCustomTheme */.resetCustomTheme();
    const obj7 = require(11119) /* updateCustomTheme */;
    let obj1 = {};
    ({ id: obj9.backgroundGradientPresetId, theme: obj9.theme } = found);
    saveClientThemeResult = require(8042) /* convertThemeToProto */.saveClientTheme(obj1);
    const obj8 = require(8042) /* convertThemeToProto */;
  } else {
    obj1 = require(14123) /* updateBackgroundGradientPreset */;
    const result3 = obj1.resetBackgroundGradientPreset();
    let obj2 = require(11119) /* updateCustomTheme */;
    obj2.resetCustomTheme();
    obj2 = { theme: found.theme };
    saveClientThemeResult = require(8042) /* convertThemeToProto */.saveClientTheme(obj2);
    const obj4 = require(8042) /* convertThemeToProto */;
  }
...
export const enableSameAsDeviceTheme = function enableSameAsDeviceTheme() {
  ...
  const result = importDefault(8042).setShouldSyncAppearanceSettings(false);
  const obj2 = importDefault(8042);
