...
// Dependencies: [3943, 1322, 1278, 1281, 653, 3944, 1852, 3945, 1282, 14134, 11079, 6152, 3841, 3973, 675, 2]
...
// Module 14133 (getThemeNameForAnalytics)
...
function getThemeNameForAnalytics(type) {
  let id = type;
  if (type.type === require(3945) /* ClientThemeType */.ClientThemeType.CUSTOM_BACKGROUND_GRADIENT) {
    return "custom theme";
  } else if (id.type === require(3945) /* ClientThemeType */.ClientThemeType.BACKGROUND_GRADIENT_PRESET) {
    id = id.id;
...
export const handleSaveTheme = function handleSaveTheme(found, analyticsLocations, isSynced) {
  ...
  if ("system" === found.theme) {
    const result = require(14134) /* updateBackgroundGradientPreset */.resetBackgroundGradientPreset();
    const obj15 = require(14134) /* updateBackgroundGradientPreset */;
    require(11079) /* updateCustomTheme */.resetCustomTheme();
    const obj16 = require(11079) /* updateCustomTheme */;
    obj = { theme: found.theme };
    let saveClientThemeResult = require(6152) /* convertThemeToProto */.saveClientTheme(obj);
    const obj17 = require(6152) /* convertThemeToProto */;
  } else if (found.type === require(3945) /* ClientThemeType */.ClientThemeType.CUSTOM_BACKGROUND_GRADIENT) {
    const result1 = require(14134) /* updateBackgroundGradientPreset */.resetBackgroundGradientPreset();
    const obj10 = require(14134) /* updateBackgroundGradientPreset */;
    require(11079) /* updateCustomTheme */.updateCustomTheme(found.customThemeSettings, found.theme);
    const obj11 = require(11079) /* updateCustomTheme */;
    obj = { customUserThemeSettings: found.customThemeSettings };
    const obj12 = require(6152) /* convertThemeToProto */;
    obj.theme = require(3841) /* isThemeLight */.isThemeDark(found.theme) ? closure_9.DARK : closure_9.LIGHT;
    obj12.saveClientTheme(obj);
    const obj14 = require(3841) /* isThemeLight */;
  } else if (found.type === require(3945) /* ClientThemeType */.ClientThemeType.BACKGROUND_GRADIENT_PRESET) {
    const result2 = require(14134) /* updateBackgroundGradientPreset */.updateBackgroundGradientPreset(found.id);
    const obj6 = require(14134) /* updateBackgroundGradientPreset */;
    require(11079) /* updateCustomTheme */.resetCustomTheme();
    const obj7 = require(11079) /* updateCustomTheme */;
    let obj1 = {};
    ({ id: obj9.backgroundGradientPresetId, theme: obj9.theme } = found);
    saveClientThemeResult = require(6152) /* convertThemeToProto */.saveClientTheme(obj1);
    const obj8 = require(6152) /* convertThemeToProto */;
  } else {
    obj1 = require(14134) /* updateBackgroundGradientPreset */;
    const result3 = obj1.resetBackgroundGradientPreset();
    let obj2 = require(11079) /* updateCustomTheme */;
    obj2.resetCustomTheme();
    obj2 = { theme: found.theme };
    saveClientThemeResult = require(6152) /* convertThemeToProto */.saveClientTheme(obj2);
    const obj4 = require(6152) /* convertThemeToProto */;
  }
...
export const handleSaveSyncedModeTheme = function handleSaveSyncedModeTheme(theme, mode, analyticsLocations) {
  if ("system" !== theme.theme) {
    ...
    const result = require(3973) /* setSystemTheme */.updateThemePreferences(obj);
    if (theme.type === require(3945) /* ClientThemeType */.ClientThemeType.CUSTOM_BACKGROUND_GRADIENT) {
      let obj1 = { customUserThemeSettings: theme.customThemeSettings };
      const result1 = require(3973) /* setSystemTheme */.updateSyncedClientTheme(mode, obj1);
      const obj4 = require(3973) /* setSystemTheme */;
    } else if (theme.type === require(3945) /* ClientThemeType */.ClientThemeType.BACKGROUND_GRADIENT_PRESET) {
      obj1 = require(3973) /* setSystemTheme */;
      const obj2 = { backgroundGradientPresetId: theme.id };
      const result2 = obj1.updateSyncedClientTheme(mode, obj2);
    } else {
      obj = require(3973) /* setSystemTheme */;
      const result3 = obj.updateSyncedClientTheme(mode, undefined);
    }
    const obj7 = require(3973) /* setSystemTheme */;
  }
};
...
export const enableSameAsDeviceTheme = function enableSameAsDeviceTheme() {
  ...
  const result = importDefault(6152).setShouldSyncAppearanceSettings(false);
  const obj2 = importDefault(6152);
  const result1 = require(3973) /* setSystemTheme */.updateThemePreferences({ [tmp2]: theme });
  if (null != customTheme) {
    obj = { customUserThemeSettings: customTheme };
    const result2 = require(3973) /* setSystemTheme */.updateSyncedClientTheme(tmp2, obj);
    const obj7 = require(3973) /* setSystemTheme */;
  } else if (null != id) {
    obj = { backgroundGradientPresetId: id };
    const result3 = require(3973) /* setSystemTheme */.updateSyncedClientTheme(tmp2, obj);
    const obj5 = require(3973) /* setSystemTheme */;
  } else {
    const result4 = require(3973) /* setSystemTheme */.updateSyncedClientTheme(tmp2, undefined);
    const obj4 = require(3973) /* setSystemTheme */;
  }
  const obj3 = require(3973) /* setSystemTheme */;
  require(3973) /* setSystemTheme */.setUseSystemTheme(constants.ON);
  const obj9 = require(3973) /* setSystemTheme */;
  const result5 = require(3973) /* setSystemTheme */.setSameAsDeviceThemeEnabled(true);
};
export const disableSameAsDeviceTheme = function disableSameAsDeviceTheme() {
  require(3973) /* setSystemTheme */.setUseSystemTheme(constants.OFF);
  const obj = require(3973) /* setSystemTheme */;
  const result = require(3973) /* setSystemTheme */.clearSyncedClientThemes();
};
