...
// Function ID: 14568
// Name: ThemeTypes
// Dependencies: [32, 19, 17, 4165, 1346, 1303, 1302, 1304, 1305, 505, 21, 4344, 712, 500, 4344, 1236, 14568, 10251, 14570, 1493, 647, 4277, 1367, 1306, 1349, 1364, 5755, 14483, 1500, 5767, 5787, 5316, 9001, 4083, 4193, 4164, 4345, 4348, 4072, 8434, 4340, 4886, 5315, 14484, 14572, 9187, 14578, 14590, 14599, 5367, 7789, 2]
// Exports: default

// Module 14567 (ThemeTypes)
...
function getSegmentedControlItems() {
  ...
  obj[2] = callback(require(14568) /* ThemeLightIcon */.ThemeLightIcon, {});
  const items = [obj, , ];
  ...
  obj[2] = callback(require(10251) /* ThemeDarkIcon */.ThemeDarkIcon, {});
  items[1] = obj;
  obj = { label: null, id: null, icon: null, page: null };
  const intl3 = require(1236) /* getSystemLocale */.intl;
  obj[0] = intl3.string(require(1236) /* getSystemLocale */.t.pQwSpQ);
  obj[1] = ThemeTypes.MIDNIGHT;
  obj[2] = callback(require(14570) /* ThemeMidnightIcon */.ThemeMidnightIcon, {});
  items[2] = obj;
  return items;
}
