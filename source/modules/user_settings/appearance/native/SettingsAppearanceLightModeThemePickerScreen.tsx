...
// Dependencies: [19, 1305, 21, 14580, 1236, 2]
// Exports: default

// Module 14619 (SettingsAppearanceLightModeThemePickerScreen)
import "noop";
...
export default function SettingsAppearanceLightModeThemePickerScreen() {
  ...
  return jsx(importDefault(14580), { mode: SystemTheme.LIGHT, themeSelector: "nitro", headerTitle: null });
};
