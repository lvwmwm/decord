...
// Dependencies: [19, 1305, 21, 14403, 1236, 2]
// Exports: default

// Module 14442 (SettingsAppearanceLightModeThemePickerScreen)
import "noop";
...
export default function SettingsAppearanceLightModeThemePickerScreen() {
  ...
  return jsx(importDefault(14403), { mode: SystemTheme.LIGHT, themeSelector: "nitro", headerTitle: null });
};
