...
// Dependencies: [19, 1305, 21, 14430, 1236, 2]
// Exports: default

// Module 14469 (SettingsAppearanceLightModeThemePickerScreen)
import "noop";
...
export default function SettingsAppearanceLightModeThemePickerScreen() {
  ...
  return jsx(importDefault(14430), { mode: SystemTheme.LIGHT, themeSelector: "nitro", headerTitle: null });
};
