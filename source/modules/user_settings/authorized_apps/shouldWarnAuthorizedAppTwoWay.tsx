...
// Dependencies: [10523, 2]
// Exports: default, useShouldWarnAuthorizedAppTwoWay

// Module 12036 (isAuthorizedAppTwoWay)
...
export default function isAuthorizedAppTwoWay(arg0) {
  let hasItem = require(10523) /* set */.ConsoleOAuthApplications.XBOX_APPLICATION_ID === arg0;
  if (!hasItem) {
    const PLAYSTATION_APPLICATION_IDS = require(10523) /* set */.ConsoleOAuthApplicationsSets.PLAYSTATION_APPLICATION_IDS;
...
export const useShouldWarnAuthorizedAppTwoWay = function useShouldWarnAuthorizedAppTwoWay(id) {
  let hasItem = require(10523) /* set */.ConsoleOAuthApplications.XBOX_APPLICATION_ID === id;
  if (!hasItem) {
    const PLAYSTATION_APPLICATION_IDS = require(10523) /* set */.ConsoleOAuthApplicationsSets.PLAYSTATION_APPLICATION_IDS;
