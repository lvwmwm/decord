...
// Function ID: 10313
// Name: InfoBox
// Dependencies: [19, 17, 21, 4255, 712, 4211, 7688, 4251, 2]
// Exports: default

// Module 10312 (InfoBox)
import "noop";
...
export default function InfoBox(look) {
  ...
  obj[obj2.INFO] = callback(require(4211) /* CircleInformationIcon */.CircleInformationIcon, obj);
  obj = { color: null };
  obj[0] = importDefault(712).colors.ICON_FEEDBACK_WARNING;
  obj[obj2.WARNING] = callback(require(7688) /* CircleErrorIcon */.CircleErrorIcon, obj);
  ...
  items3[1] = callback(require(4251) /* Text */.Text, obj2);
  obj1[1] = items3;
