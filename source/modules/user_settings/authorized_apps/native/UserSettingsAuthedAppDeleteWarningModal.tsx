...
// Dependencies: [21, 10888, 1236, 11841, 10312, 4598, 2]
// Exports: default

// Module 11840 (UserSettingsAuthedAppDeleteWarningModal)
...
export default function UserSettingsAuthedAppDeleteWarningModal(application) {
  ...
  let obj = require(10888) /* isSocialLayerApplication */;
  ...
  let tmp9 = importDefault(11841)(application.id);
  if (tmp9) {
    const obj2 = { children: null };
    let tmp8Result = tmp8(10312);
  ...
  if (result) {
    ...
    tmp8Result = tmp8(10312);
    obj4[0] = tmp(10312).InfoBoxLooks.WARNING;
  ...
  obj7[2] = onDelete;
  const items1 = [callback(require(4598) /* getAlertModalItemKey */.AlertActionButton, obj7, "confirm"), ];
  const obj8 = { variant: "secondary", text: null };
  const intl6 = tmp(1236).intl;
  obj8[1] = intl6.string(require(1236) /* getSystemLocale */.t["ETE/oC"]);
  items1[1] = callback(require(4598) /* getAlertModalItemKey */.AlertActionButton, obj8, "cancel");
  obj6[0] = items1;
  obj5[3] = closure_5(closure_4, obj6);
  return callback(require(4598) /* getAlertModalItemKey */.AlertModal, obj5);
};
