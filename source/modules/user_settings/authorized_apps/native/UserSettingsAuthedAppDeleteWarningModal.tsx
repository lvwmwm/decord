...
// Dependencies: [21, 10920, 1236, 11875, 10343, 4628, 2]
// Exports: default

// Module 11874 (UserSettingsAuthedAppDeleteWarningModal)
...
export default function UserSettingsAuthedAppDeleteWarningModal(application) {
  ...
  let obj = require(10920) /* isSocialLayerApplication */;
  ...
  let tmp9 = importDefault(11875)(application.id);
  if (tmp9) {
    const obj2 = { children: null };
    let tmp8Result = tmp8(10343);
  ...
  if (result) {
    ...
    tmp8Result = tmp8(10343);
    obj4[0] = tmp(10343).InfoBoxLooks.WARNING;
