...
// Dependencies: [32, 4359, 4812, 1218, 4393, 4406, 9222, 11, 1306, 595, 1374, 9221, 12, 13250, 10869, 5322, 2]
...
function handleSetLocalVolume(arg0) {
  ...
  if (userId !== store.getId()) {
    ...
    obj = { volume: null };
    obj[0] = volume;
    const result = require(13250) /* getPendingAudioSettings */.updatePendingSettings(context, userId, obj);
    lib();
    const obj2 = require(13250) /* getPendingAudioSettings */;
  }
}
function handleSetLocalMute(arg0) {
  ...
  ({ context, userId } = arg0);
  if (userId !== store.getId()) {
    let obj = require(13250) /* getPendingAudioSettings */;
    obj = { muted: null };
    obj[0] = _detectH265HardwareDecode.isLocalMute(userId, context);
...
function DEFAULT_VOLUME_FOR_CONTEXT(arg0) {
  if (arg0 === MediaEngineContextTypes.STREAM) {
    let USER = require(9222) /* AudioSettingsDefaultVolumes */.AudioSettingsDefaultVolumes.STREAM;
  } else {
    USER = require(9222) /* AudioSettingsDefaultVolumes */.AudioSettingsDefaultVolumes.USER;
  }
  return USER;
}
