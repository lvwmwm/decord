...
// Dependencies: [19, 17, 4349, 21, 4302, 712, 589, 10793, 10794, 9095, 7925, 1236, 7924, 4298, 10797, 10779, 5708, 2]
// Exports: default

// Module 10792 (VoiceProcessingOptions)
import "noop";
  ...
  constructor() {
    ...
    if (stateFromStores) {
      ...
      obj1[1] = function noiseCancellationChanged(arg0) {
        callback2(9095).setNoiseCancellation(arg0 === callback(10793).NoiseSuppressionOpt.KRISP);
        const obj = callback2(9095);
        callback2(9095).setNoiseSuppression(arg0 === callback(10793).NoiseSuppressionOpt.STANDARD);
      };
      ...
      obj10[3] = function onValueChange(arg0) {
        const NoiseSuppressionOpt = callback(10793).NoiseSuppressionOpt;
        return callback(10793).handleNoiseSuppressionChange(arg0 ? NoiseSuppressionOpt.STANDARD : NoiseSuppressionOpt.NONE);
      };
...
export default function UserSettingsVoiceProcessing() {
  ...
  obj[2] = require(10793) /* handleAutomaticGainControlChange */.handleEchoCancellationChange;
  obj[2] = callback(require(5708) /* TableSwitchRow */.TableSwitchRow, obj);
  ...
  obj1[3] = require(10793) /* handleAutomaticGainControlChange */.handleAutomaticGainControlChange;
  const items2 = [callback(require(5708) /* TableSwitchRow */.TableSwitchRow, obj1), ];
  if (advancedVoiceActivitySupported) {
    ...
    advancedVoiceActivitySupported = callback(tmp(5708).TableSwitchRow, obj2);
  }
