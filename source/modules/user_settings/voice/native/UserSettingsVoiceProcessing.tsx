...
// Dependencies: [19, 17, 4351, 21, 4303, 712, 589, 10859, 10860, 9155, 7985, 1236, 7984, 4299, 10863, 10845, 5768, 2]
// Exports: default

// Module 10858 (VoiceProcessingOptions)
import "noop";
...
export default function UserSettingsVoiceProcessing() {
  ...
  obj[2] = require(10859) /* handleAutomaticGainControlChange */.handleEchoCancellationChange;
  obj[2] = callback(require(5768) /* TableSwitchRow */.TableSwitchRow, obj);
  const items1 = [callback(require(10845) /* UserSettingsVoice */.UserSettingsTableRowGroup, obj), callback(VoiceProcessingOptions, {}), ];
  ...
  obj1[3] = require(10859) /* handleAutomaticGainControlChange */.handleAutomaticGainControlChange;
  ...
  if (advancedVoiceActivitySupported) {
    ...
    advancedVoiceActivitySupported = callback(tmp(5768).TableSwitchRow, obj2);
  }
  const obj3 = { children: null };
  items2[1] = advancedVoiceActivitySupported;
  items1[2] = closure_6(require(10845) /* UserSettingsVoice */.UserSettingsTableRowGroup, { hasIcons: false, children: items2 });
  obj3[0] = items1;
