...
// Dependencies: [19, 17, 4302, 21, 4255, 712, 589, 10726, 10727, 9049, 7767, 1236, 7766, 4251, 10730, 10712, 5635, 2]
// Exports: default

// Module 10725 (VoiceProcessingOptions)
import "noop";
  ...
  constructor() {
    ...
    if (stateFromStores) {
      ...
      obj1[1] = function noiseCancellationChanged(arg0) {
        callback2(9049).setNoiseCancellation(arg0 === callback(10726).NoiseSuppressionOpt.KRISP);
        const obj = callback2(9049);
        callback2(9049).setNoiseSuppression(arg0 === callback(10726).NoiseSuppressionOpt.STANDARD);
      };
      ...
      obj10[3] = function onValueChange(arg0) {
        const NoiseSuppressionOpt = callback(10726).NoiseSuppressionOpt;
        return callback(10726).handleNoiseSuppressionChange(arg0 ? NoiseSuppressionOpt.STANDARD : NoiseSuppressionOpt.NONE);
      };
...
export default function UserSettingsVoiceProcessing() {
  ...
  obj[2] = require(10726) /* handleAutomaticGainControlChange */.handleEchoCancellationChange;
  obj[2] = callback(require(5635) /* TableSwitchRow */.TableSwitchRow, obj);
  const items1 = [callback(require(10712) /* UserSettingsVoice */.UserSettingsTableRowGroup, obj), callback(VoiceProcessingOptions, {}), ];
  ...
  obj1[3] = require(10726) /* handleAutomaticGainControlChange */.handleAutomaticGainControlChange;
  const items2 = [callback(require(5635) /* TableSwitchRow */.TableSwitchRow, obj1), ];
  if (advancedVoiceActivitySupported) {
    ...
    advancedVoiceActivitySupported = callback(tmp(5635).TableSwitchRow, obj2);
  }
  const obj3 = { children: null };
  items2[1] = advancedVoiceActivitySupported;
  items1[2] = closure_6(require(10712) /* UserSettingsVoice */.UserSettingsTableRowGroup, { hasIcons: false, children: items2 });
  obj3[0] = items1;
