...
// Dependencies: [19, 17, 4332, 21, 4285, 712, 589, 10781, 10782, 9078, 7908, 1236, 7907, 4281, 10785, 10767, 5689, 2]
// Exports: default

// Module 10780 (VoiceProcessingOptions)
import "noop";
  ...
  constructor() {
    ...
    if (stateFromStores) {
      ...
      obj1[1] = function noiseCancellationChanged(arg0) {
        callback2(9078).setNoiseCancellation(arg0 === callback(10781).NoiseSuppressionOpt.KRISP);
        const obj = callback2(9078);
        callback2(9078).setNoiseSuppression(arg0 === callback(10781).NoiseSuppressionOpt.STANDARD);
      };
      ...
      obj10[3] = function onValueChange(arg0) {
        const NoiseSuppressionOpt = callback(10781).NoiseSuppressionOpt;
        return callback(10781).handleNoiseSuppressionChange(arg0 ? NoiseSuppressionOpt.STANDARD : NoiseSuppressionOpt.NONE);
      };
...
export default function UserSettingsVoiceProcessing() {
  ...
  obj[2] = require(10781) /* handleAutomaticGainControlChange */.handleEchoCancellationChange;
  obj[2] = callback(require(5689) /* TableSwitchRow */.TableSwitchRow, obj);
  const items1 = [callback(require(10767) /* UserSettingsVoice */.UserSettingsTableRowGroup, obj), callback(VoiceProcessingOptions, {}), ];
  ...
  obj1[3] = require(10781) /* handleAutomaticGainControlChange */.handleAutomaticGainControlChange;
  const items2 = [callback(require(5689) /* TableSwitchRow */.TableSwitchRow, obj1), ];
  if (advancedVoiceActivitySupported) {
    ...
    advancedVoiceActivitySupported = callback(tmp(5689).TableSwitchRow, obj2);
  }
  const obj3 = { children: null };
  items2[1] = advancedVoiceActivitySupported;
  items1[2] = closure_6(require(10767) /* UserSettingsVoice */.UserSettingsTableRowGroup, { hasIcons: false, children: items2 });
  obj3[0] = items1;
