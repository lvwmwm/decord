...
// Dependencies: [19, 17, 4363, 1218, 4392, 4405, 21, 4344, 589, 38, 9201, 10904, 1236, 5413, 10911, 2]
// Exports: default

// Module 10910 (UserSettingsVoiceOutputOptions)
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  obj1 = { style: tmp.slider, children: callback(importDefault(10911), obj2) };
  obj2 = {
    style: tmp.slider,
  ...
  if (tmp9Result) {
    ...
    obj5[1] = callback;
    obj4[1] = tmp9(importDefault(10911), obj5);
