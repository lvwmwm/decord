...
// Dependencies: [19, 17, 4208, 1218, 4236, 4250, 21, 4189, 589, 38, 8838, 10765, 1236, 5220, 10772, 2]
// Exports: default

// Module 10771 (UserSettingsVoiceOutputOptions)
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  obj1 = { style: tmp.slider, children: callback(importDefault(10772), obj2) };
  obj2 = {
    style: tmp.slider,
  ...
  if (tmp9Result) {
    ...
    obj5[1] = callback;
    obj4[1] = tmp9(importDefault(10772), obj5);
    obj3[1] = tmp9(View, obj4);
    tmp9Result = tmp9(tmp2(5220).TableRow, obj3);
  }
  items4[1] = tmp9Result;
  obj[2] = items4;
  return closure_10(stateFromStores1(10765).UserSettingsTableRowGroup, obj);
};
