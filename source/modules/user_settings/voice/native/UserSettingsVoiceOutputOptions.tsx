...
// Dependencies: [31, 27, 4184, 1194, 4212, 4226, 33, 4165, 566, 44, 8814, 10741, 1212, 5198, 10748, 2]
// Exports: default

// Module 10747 (UserSettingsVoiceOutputOptions)
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  obj1 = { style: tmp.slider, children: callback(importDefault(10748), obj2) };
  obj2 = {
    style: tmp.slider,
  ...
  const items4 = [callback(stateFromStores1(5198).TableRow, obj), ];
  ...
  if (tmp7) {
    ...
    obj4.children = callback(importDefault(10748), obj5);
    obj3.subLabel = callback(View, obj4);
    tmp7 = callback(stateFromStores1(5198).TableRow, obj3);
  }
  items4[1] = tmp7;
  obj.children = items4;
  return closure_10(stateFromStores1(10741).UserSettingsTableRowGroup, obj);
};
