...
// Dependencies: [31, 27, 4150, 1194, 4178, 4192, 33, 4131, 566, 44, 8770, 10703, 1212, 5164, 10710, 2]
// Exports: default

// Module 10709 (UserSettingsVoiceOutputOptions)
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  obj1 = { style: tmp.slider, children: callback(importDefault(10710), obj2) };
  obj2 = {
    style: tmp.slider,
  ...
  if (tmp7) {
    ...
    obj4.children = callback(importDefault(10710), obj5);
    obj3.subLabel = callback(View, obj4);
    tmp7 = callback(stateFromStores1(5164).TableRow, obj3);
  }
  items4[1] = tmp7;
  obj.children = items4;
  return closure_10(stateFromStores1(10703).UserSettingsTableRowGroup, obj);
};
