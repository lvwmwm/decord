...
// Dependencies: [19, 17, 10905, 10906, 21, 4344, 5806, 10907, 4752, 10908, 10910, 4340, 1236, 10914, 10915, 10917, 5367, 2]
// Exports: UserSettingsTableRowGroup, default

// Module 10904 (UserSettingsVoice)
import "noop";
...
export default function UserSettingsVoice() {
  ...
  items[3] = callback(importDefault(10914), {});
  const obj2 = { spacing: 24, children: null };
  items[4] = isMobileOverlaySupported() && callback(importDefault(10915), {});
  items[5] = callback(importDefault(10917), {});
  items[6] = callback(require(5367) /* SafeAreaPaddingView */.SafeAreaPaddingView, { bottom: true });
  obj2[1] = items;
  obj[1] = closure_7(require(4752) /* Stack */.Stack, obj2);
  return callback(View, obj);
};
export const UserSettingsTableRowGroup = function UserSettingsTableRowGroup(arg0) {
  const merged = Object.assign(arg0);
  return callback(require(5806) /* TableRowGroupTitle */.TableRowGroup, {});
};
