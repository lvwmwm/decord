...
// Dependencies: [19, 17, 676, 21, 4189, 10776, 5515, 10765, 1236, 5220, 10772, 8048, 4185, 1945, 2]
// Exports: default

// Module 10775 (SoundboardVolume)
import "noop";
...
export default function SoundboardVolume() {
  const tmp = callback3();
  let obj = analyticsLocations(10776);
  ...
  const items = [callback(View, { style: tmp.slider, children: callback(importDefault(10772), obj3) }), ];
  ...
  const obj2 = { style: tmp.slider, children: callback(importDefault(10772), obj3) };
  ...
  return callback(analyticsLocations(10765).UserSettingsTableRowGroup, obj);
};
