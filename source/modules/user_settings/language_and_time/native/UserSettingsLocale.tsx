...
// Dependencies: [5, 19, 17, 1995, 1994, 21, 4344, 712, 8743, 589, 5367, 8026, 1236, 8025, 14678, 2]

// Module 14677 (handleLanguageChange)
...
const memoResult = require("noop").memo(function UserSettingsLocale() {
  ...
  obj[1] = jsx(require(8026) /* context */.TableRadioGroup, { defaultValue: stateFromStores, onChange: handleLanguageChange, hasIcons: true, children: null });
  obj[1] = jsx(require(5367) /* SafeAreaPaddingView */.SafeAreaPaddingView, { bottom: true, children: null });
