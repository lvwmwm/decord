...
// Function ID: 14269
// Name: onPress
// Dependencies: [19, 21, 4310, 14269, 2007, 1499, 6925, 8431, 1236, 14270, 2]
...
const require = arg1;
function onPress() {
  importDefault(4310).openLazy(require(2007) /* asyncRequireImpl */(14269, dependencyMap.paths), "AddConnection");
}
