...
// Dependencies: [19, 17, 676, 1369, 21, 4255, 712, 5189, 1297, 9887, 4251, 4665, 1236, 2]
// Exports: OneWayToTwoWayLinkUpsell

// Module 14090 (OneWayToTwoWayNewTag)
...
export const OneWayToTwoWayLinkUpsell = function OneWayToTwoWayLinkUpsell(newIndicatorDismissibleContent) {
  ...
  obj5[1] = onPress;
  obj4[1] = callback(newIndicatorDismissibleContent(4665).Button, obj5);
