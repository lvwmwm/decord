...
// Dependencies: [19, 17, 21, 4302, 10432, 10511, 4298, 1236, 5327, 4712, 2]
// Exports: default

// Module 10510 (CrunchyrollLinkDiscordSuccess)
import "noop";
...
export default function CrunchyrollLinkDiscordSuccess(onClose) {
  ...
  const tmp = callback3();
  const items = [callback(closure_3, { source: importDefault(10511), style: callback3().image }), , ];
