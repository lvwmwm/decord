...
// Dependencies: [19, 17, 21, 4285, 10416, 10495, 4281, 1236, 5311, 4695, 2]
// Exports: default

// Module 10494 (CrunchyrollLinkDiscordSuccess)
import "noop";
...
export default function CrunchyrollLinkDiscordSuccess(onClose) {
  ...
  const tmp = callback3();
  const items = [callback(closure_3, { source: importDefault(10495), style: callback3().image }), , ];
