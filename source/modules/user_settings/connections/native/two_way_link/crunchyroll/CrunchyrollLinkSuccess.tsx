...
// Dependencies: [19, 17, 21, 4344, 10545, 10624, 4340, 1236, 5367, 4754, 2]
// Exports: default

// Module 10623 (CrunchyrollLinkDiscordSuccess)
import "noop";
...
export default function CrunchyrollLinkDiscordSuccess(onClose) {
  ...
  const tmp = callback3();
  const items = [callback(closure_3, { source: importDefault(10624), style: callback3().image }), , ];
