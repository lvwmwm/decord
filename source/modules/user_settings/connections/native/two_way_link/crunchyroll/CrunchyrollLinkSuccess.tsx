...
// Dependencies: [19, 17, 21, 4342, 10459, 10538, 4338, 1236, 5368, 4755, 2]
// Exports: default

// Module 10537 (CrunchyrollLinkDiscordSuccess)
import "noop";
...
export default function CrunchyrollLinkDiscordSuccess(onClose) {
  ...
  const tmp = callback3();
  const items = [callback(closure_3, { source: importDefault(10538), style: callback3().image }), , ];
