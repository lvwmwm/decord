...
// Dependencies: [19, 8981, 676, 21, 4189, 1236, 8124, 1480, 8933, 8983, 1945, 2]
// Exports: default

// Module 8982 (CrunchyrollLinkLanding)
...
export default function CrunchyrollLinkLanding() {
  ...
  const memo = React.useMemo(() => {
    ...
    obj[1] = navigation(8124).PlayIcon;
    const items = [obj];
    return items;
  }, []);
  ...
  obj[6] = callback;
  obj[7] = memo;
  return jsx(navigation(8933).TwoWayLinkLanding, { platformType: constants2.CRUNCHYROLL, img: null, imgStyle: null, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null });
};
