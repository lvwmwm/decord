...
// Function ID: 8985
// Name: CloseButton
// Dependencies: [19, 8985, 676, 21, 6752, 7699, 8983, 1236, 8986, 8939, 8988, 8990, 8991, 8993, 8938, 8982, 5570, 2]
// Exports: default

// Module 8984 (CloseButton)
...
export default function CrunchyrollLinkModal(locationStack) {
  ...
  const memo = React.useMemo(() => {
    function onClose() {
      return callback(8983).hideModal();
    }
    function blank() {
      return null;
    }
    let obj = {
      ...
      render() {
        return callback2(callback(8986), {});
      }
    };
    obj = {
      headerLeft: blank,
      ...
      render() {
        return callback2(callback(8988), {});
      }
    };
    obj = {
      headerLeft: blank,
      ...
      render(arg0) {
        ...
        return callback2(callback(8990), { callbackCode, callbackState });
      }
    };
    return {
  ...
  const accountLinkStepTracking = twoWayLinkStyles(8982).useAccountLinkStepTracking(PlatformTypes.CRUNCHYROLL, locationStack.locationStack);
