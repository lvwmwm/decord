...
// Dependencies: [19, 10571, 21, 1480, 10554, 10555, 1236, 2]
// Exports: default

// Module 10579 (CrunchyrollLinkDiscordError)
import "noop";
...
export default function CrunchyrollLinkDiscordError(onClose) {
  ...
  const connectRetry = require(10554) /* useConnectRetry */.useConnectRetry(navigation, constants.PRE_CONNECT);
