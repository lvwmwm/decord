...
// Dependencies: [19, 10570, 21, 1480, 10553, 10554, 1236, 2]
// Exports: default

// Module 10578 (CrunchyrollLinkDiscordError)
import "noop";
...
export default function CrunchyrollLinkDiscordError(onClose) {
  ...
  const connectRetry = require(10553) /* useConnectRetry */.useConnectRetry(navigation, constants.PRE_CONNECT);
