...
// Dependencies: [19, 676, 21, 4342, 1993, 14287, 1236, 5308, 14290, 1377, 10518, 2]
// Exports: PlayStationTwoWayLinkUpsell

// Module 14289 (PlayStationTwoWayLinkUpsell)
import "noop";
import ME from "ME";
...
export const PlayStationTwoWayLinkUpsell = function PlayStationTwoWayLinkUpsell() {
  ...
  return jsx(require(14287) /* OneWayToTwoWayNewTag */.OneWayToTwoWayLinkUpsell, { style: callback().upsellImage, source: null, resizeMode: "contain" });
};
