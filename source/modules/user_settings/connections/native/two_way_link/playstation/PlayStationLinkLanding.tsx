...
// Dependencies: [19, 9154, 676, 21, 4255, 1236, 4781, 9121, 1480, 1945, 9156, 9123, 2]
// Exports: PlayStationLinkLanding

// Module 9155 (PlayStationLinkLanding)
...
export const PlayStationLinkLanding = function PlayStationLinkLanding(platformType) {
  ...
  const memo1 = React.useMemo(() => ({ uri: callback(9156) }), []);
  ...
  obj[6] = callback;
  obj[7] = memo;
  return jsx(navigation(9123).TwoWayLinkLanding, { platformType: platformType.platformType, img: memo1, imgStyle: tmp.image, headerConnect: null, headerReconnect: null, body: null, onNext: null, valueProps: null });
};
