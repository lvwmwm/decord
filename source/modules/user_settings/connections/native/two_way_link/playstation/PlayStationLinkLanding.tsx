...
// Dependencies: [19, 10474, 676, 21, 4285, 1236, 4810, 8684, 1480, 1945, 10476, 10412, 2]
// Exports: PlayStationLinkLanding

// Module 10475 (PlayStationLinkLanding)
...
export const PlayStationLinkLanding = function PlayStationLinkLanding(platformType) {
  ...
  const memo = React.useMemo(() => {
    ...
    obj[1] = navigation(8684).GameControllerIcon;
    items[1] = obj;
    return items;
  }, []);
  ...
  const memo1 = React.useMemo(() => ({ uri: callback(10476) }), []);
  ...
  obj[6] = callback;
  obj[7] = memo;
  return jsx(navigation(10412).TwoWayLinkLanding, { platformType: platformType.platformType, img: memo1, imgStyle: tmp.image, headerConnect: null, headerReconnect: null, body: null, onNext: null, valueProps: null });
};
