...
// Dependencies: [19, 8929, 21, 1480, 8975, 8976, 1236, 2]
// Exports: default

// Module 9033 (XboxLinkDiscordError)
import "noop";
...
export default function XboxLinkDiscordError(onClose) {
  ...
  const connectRetry = require(8975) /* useConnectRetry */.useConnectRetry(navigation, XboxLinkModalScenes.PRE_CONNECT);
