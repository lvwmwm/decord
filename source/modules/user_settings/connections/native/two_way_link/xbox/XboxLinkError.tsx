...
// Dependencies: [19, 10412, 21, 1480, 10471, 10472, 1236, 2]
// Exports: default

// Module 10470 (XboxLinkDiscordError)
import "noop";
...
export default function XboxLinkDiscordError(onClose) {
  ...
  const connectRetry = require(10471) /* useConnectRetry */.useConnectRetry(navigation, XboxLinkModalScenes.PRE_CONNECT);
