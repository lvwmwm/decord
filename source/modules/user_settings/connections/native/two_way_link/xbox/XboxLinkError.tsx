...
// Dependencies: [19, 10500, 21, 1499, 10559, 10560, 1236, 2]
// Exports: default

// Module 10558 (XboxLinkDiscordError)
import "noop";
...
export default function XboxLinkDiscordError(onClose) {
  ...
  const connectRetry = require(10559) /* useConnectRetry */.useConnectRetry(navigation, XboxLinkModalScenes.PRE_CONNECT);
