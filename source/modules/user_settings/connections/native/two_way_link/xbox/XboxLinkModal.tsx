...
export default function XboxLinkModal(locationStack) {
  ...
  const accountLinkStepTracking = twoWayLinkStyles(8914).useAccountLinkStepTracking(PlatformTypes.XBOX, locationStack.locationStack);
