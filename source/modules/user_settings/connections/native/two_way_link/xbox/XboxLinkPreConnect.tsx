...
// Dependencies: [19, 10541, 676, 21, 4344, 1499, 10548, 10549, 1236, 2]
// Exports: default

// Module 10547 (XboxLinkPreConnect)
...
export default function XboxLinkPreConnect() {
  ...
  return jsx(navigation(10549).TwoWayLinkPreConnect, { platformType: PlatformTypes.XBOX, onError: callback1, onNext: callback, img: memo, imgStyle: callback().image, title: null, body: null });
};
