...
// Dependencies: [19, 10409, 676, 21, 4285, 1480, 10416, 10417, 1236, 2]
// Exports: default

// Module 10415 (XboxLinkPreConnect)
...
export default function XboxLinkPreConnect() {
  ...
  return jsx(navigation(10417).TwoWayLinkPreConnect, { platformType: PlatformTypes.XBOX, onError: callback1, onNext: callback, img: memo, imgStyle: callback().image, title: null, body: null });
};
