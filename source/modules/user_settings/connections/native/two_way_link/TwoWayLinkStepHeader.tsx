...
// Dependencies: [19, 21, 10504, 4299, 1236, 2]
// Exports: TwoWayLinkStepHeader

// Module 10505 (TwoWayLinkStepHeader)
import "noop";
...
export const TwoWayLinkStepHeader = function TwoWayLinkStepHeader(arg0) {
  ...
  return jsx(require(4299) /* Text */.Text, { variant: "text-xs/bold", color: "text-default", style: twoWayLinkStyles.stepHeader, children: null });
};
