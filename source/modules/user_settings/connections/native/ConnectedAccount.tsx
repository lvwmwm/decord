...
function Integration(integration) {
  ...
  if (!tmp7) {
    ...
    if (tmp12) {
      ...
      tmp12 = callback3(tmp(4185).Text, obj);
    }
    ...
    obj2[1] = tmp(5566).GuildIconSizes.SMALL;
    obj2[2] = legacyClassComponentStyles.integrationGuildIcon;
    const items4 = [callback3(importDefault(5566), obj2), , ];
    ...
    const items5 = [callback3(tmp(4185).Text, obj4), ];
    const tmp16 = callback3;
    const tmp18 = importDefault(5566);
    const value = importDefault(4871).get(integration.type);
    let platformUserUrl;
    if (value != null) {
    ...
    items5[1] = tmp16(tmp(4185).Text, obj5);
    obj3[1] = items5;
    ...
    obj7[4] = stringResult;
    obj7 = tmp8(tmp(4600).Button, obj7);
    obj6[1] = obj7;
    callback3(View, obj6);
    const tmp9 = View;
  }
...
function RowSwitch(label) {
  ...
  return callback3(require(5555) /* TableSwitchRow */.TableSwitchRow, { label: label.label });
}
  ...
  if (account.account !== account) {
    ...
    if (account.verified) {
      ...
      if (null != inProgressMetadataVisibility) {
        ...
        const result = importDefault(4995).setMetadataVisibility(account.type, account.id, inProgressMetadataVisibility);
        const obj2 = importDefault(4995);
      }
    }
    self.setState(obj);
  }
...
prototype["renderMetadata"] = function renderMetadata() {
  ...
  if (null !== createdAtDate) {
    ...
    redditMetadataItems.push(callback3(tmp2(4185).Text, obj, MetadataFields.CREATED_AT));
  }
  ...
  if (0 === redditMetadataItems.length) {
    ...
    const items3 = [callback3(View, obj12), callback3(tmp2(4717).PressableOpacity, obj9)];
    obj11[1] = items3;
...
prototype["render"] = function render() {
  ...
  if (migrationExperimentEnabled) {
    ...
    obj[0] = account.name;
    let name = intl.format(tmp2(2773).Glhokn, obj);
  } else {
    name = account.name;
  }
  ...
  let obj4 = require(4035) /* AccessibilityAnnouncer */;
  ...
  obj6[1] = closure_14(require(5220) /* TableRowInner */.TableRow, { label: name, icon: tmp7Result, trailing: tmp7Result });
  ...
  items1[2] = callback4(require(5554) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items2 });
  items1[3] = result;
  obj7[1] = items1;
