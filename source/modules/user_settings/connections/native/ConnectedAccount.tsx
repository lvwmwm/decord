...
// Function ID: 14276
// Name: Integration
// Dependencies: [5, 32, 19, 17, 5038, 1910, 676, 5165, 21, 4344, 1297, 712, 5275, 5163, 589, 4754, 1236, 4340, 5818, 5040, 5807, 4072, 14276, 10472, 4682, 4772, 10538, 14277, 14280, 5164, 11106, 4058, 1993, 4886, 10071, 14282, 2853, 1435, 1363, 4752, 8068, 5413, 5806, 2]
...
function Integration(integration) {
  ...
  if (!tmp7) {
    ...
    const items4 = [callback3(importDefault(5818), obj2), , ];
    ...
    const tmp18 = importDefault(5818);
    const value = importDefault(5040).get(integration.type);
    let platformUserUrl;
    if (value != null) {
...
function RowSwitch(label) {
  ...
  return callback3(require(5807) /* TableSwitchRow */.TableSwitchRow, { label: label.label });
}
  ...
  if (account.account !== account) {
    ...
    if (account.verified) {
      ...
      if (null != inProgressMetadataVisibility) {
        ...
        const result = importDefault(5163).setMetadataVisibility(account.type, account.id, inProgressMetadataVisibility);
        const obj2 = importDefault(5163);
      }
    }
    self.setState(obj);
  }
...
prototype["render"] = function render() {
  ...
  obj3[1] = importDefault(8068);
  obj2[4] = closure_14(require(1297) /* Button */.Icon, obj3);
  obj1[3] = closure_14(require(4886) /* PressableBase */.PressableOpacity, obj2);
  ...
  obj6[1] = closure_14(require(5413) /* TableRowInner */.TableRow, { label: name, icon: tmp7Result, trailing: tmp7Result });
  ...
  items1[2] = callback4(require(5806) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items2 });
  items1[3] = result;
  obj7[1] = items1;
