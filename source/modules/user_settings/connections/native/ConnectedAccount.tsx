...
// Function ID: 14125
// Name: Integration
// Dependencies: [5, 32, 19, 17, 4979, 1891, 676, 5107, 21, 4285, 1297, 712, 5219, 5105, 589, 4695, 1236, 4281, 5700, 4981, 5689, 3996, 14125, 10343, 4623, 4713, 10409, 14126, 14129, 5106, 10966, 3981, 1974, 4827, 9942, 14131, 2834, 1416, 4130, 4693, 7950, 5354, 5688, 2]

// Module 14124 (Integration)
...
function Integration(integration) {
  ...
  if (!tmp7) {
    ...
    const items4 = [callback3(importDefault(5700), obj2), , ];
    ...
    const tmp18 = importDefault(5700);
    const value = importDefault(4981).get(integration.type);
    let platformUserUrl;
    if (value != null) {
...
function RowSwitch(label) {
  ...
  return callback3(require(5689) /* TableSwitchRow */.TableSwitchRow, { label: label.label });
}
  ...
  if (account.account !== account) {
    ...
    if (account.verified) {
      ...
      if (null != inProgressMetadataVisibility) {
        ...
        const result = importDefault(5105).setMetadataVisibility(account.type, account.id, inProgressMetadataVisibility);
...
prototype["renderUpsell"] = function renderUpsell() {
  ...
  if (account.twoWayLink) {
    ...
    let tmp2 = callback3(require(14126) /* XboxTwoWayLinkUpsell */.XboxTwoWayLinkUpsell, {});
  } else {
    tmp2 = null;
    if (account.type === tmp.PLAYSTATION) {
      tmp2 = callback3(require(14129) /* PlayStationTwoWayLinkUpsell */.PlayStationTwoWayLinkUpsell, {});
    }
  }
};
...
prototype["render"] = function render() {
  ...
  let obj4 = require(4130) /* AccessibilityAnnouncer */;
  ...
  obj3[1] = importDefault(7950);
  obj2[4] = closure_14(require(1297) /* Button */.Icon, obj3);
  obj1[3] = closure_14(require(4827) /* PressableBase */.PressableOpacity, obj2);
  ...
  obj6[1] = closure_14(require(5354) /* TableRowInner */.TableRow, { label: name, icon: tmp7Result, trailing: tmp7Result });
  ...
  items1[2] = callback4(require(5688) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items2 });
  items1[3] = result;
  obj7[1] = items1;
