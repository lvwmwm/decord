...
// Function ID: 14209
// Name: Integration
// Dependencies: [5, 32, 19, 17, 4998, 1891, 676, 5125, 21, 4303, 1297, 712, 5236, 5123, 589, 4714, 1236, 4299, 5779, 5000, 5768, 4013, 14209, 10425, 4642, 4732, 10491, 14210, 14213, 5124, 11047, 3998, 1974, 4846, 10024, 14215, 2834, 1416, 4153, 4712, 8027, 5374, 5767, 2]

// Module 14208 (Integration)
...
prototype["renderUpsell"] = function renderUpsell() {
  ...
  if (account.twoWayLink) {
    ...
    let tmp2 = callback3(require(14210) /* XboxTwoWayLinkUpsell */.XboxTwoWayLinkUpsell, {});
  } else {
    tmp2 = null;
    if (account.type === tmp.PLAYSTATION) {
      tmp2 = callback3(require(14213) /* PlayStationTwoWayLinkUpsell */.PlayStationTwoWayLinkUpsell, {});
    }
  }
};
