...
// Function ID: 14139
// Name: Integration
// Dependencies: [5, 32, 19, 17, 4996, 1891, 676, 5124, 21, 4302, 1297, 712, 5235, 5122, 589, 4712, 1236, 4298, 5719, 4998, 5708, 4013, 14139, 10359, 4640, 4730, 10425, 14140, 14143, 5123, 10981, 3998, 1974, 4844, 9958, 14145, 2834, 1416, 4147, 4710, 7967, 5373, 5707, 2]

// Module 14138 (Integration)
...
function Integration(integration) {
  ...
  if (!tmp7) {
    ...
    const items4 = [callback3(importDefault(5719), obj2), , ];
    ...
    const tmp18 = importDefault(5719);
    const value = importDefault(4998).get(integration.type);
    let platformUserUrl;
    if (value != null) {
...
function RowSwitch(label) {
  ...
  return callback3(require(5708) /* TableSwitchRow */.TableSwitchRow, { label: label.label });
}
  ...
  if (account.account !== account) {
    ...
    if (account.verified) {
      ...
      if (null != inProgressMetadataVisibility) {
        ...
        const result = importDefault(5122).setMetadataVisibility(account.type, account.id, inProgressMetadataVisibility);
        const obj2 = importDefault(5122);
      }
    }
    self.setState(obj);
  }
...
prototype["renderUpsell"] = function renderUpsell() {
  ...
  if (account.twoWayLink) {
    ...
    let tmp2 = callback3(require(14140) /* XboxTwoWayLinkUpsell */.XboxTwoWayLinkUpsell, {});
  } else {
    tmp2 = null;
    if (account.type === tmp.PLAYSTATION) {
      tmp2 = callback3(require(14143) /* PlayStationTwoWayLinkUpsell */.PlayStationTwoWayLinkUpsell, {});
    }
  }
};
...
prototype["render"] = function render() {
  ...
  let obj4 = require(4147) /* AccessibilityAnnouncer */;
  ...
  obj3[1] = importDefault(7967);
  obj2[4] = closure_14(require(1297) /* Button */.Icon, obj3);
  obj1[3] = closure_14(require(4844) /* PressableBase */.PressableOpacity, obj2);
  ...
  obj6[1] = closure_14(require(5373) /* TableRowInner */.TableRow, { label: name, icon: tmp7Result, trailing: tmp7Result });
  ...
  items1[2] = callback4(require(5707) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items2 });
  items1[3] = result;
  obj7[1] = items1;
