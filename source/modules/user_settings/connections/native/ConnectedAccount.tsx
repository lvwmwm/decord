...
// Function ID: 14088
// Name: Integration
// Dependencies: [5, 32, 19, 17, 4949, 1862, 676, 5077, 21, 4255, 1297, 712, 5189, 5075, 589, 4665, 1236, 4251, 5646, 4951, 5635, 3967, 14088, 10312, 4593, 4683, 10378, 14089, 14092, 5076, 10934, 3952, 1945, 4797, 9911, 14094, 2805, 1416, 4101, 4663, 7809, 5300, 5634, 2]

// Module 14087 (Integration)
...
function Integration(integration) {
  ...
  if (!tmp7) {
    ...
    const items4 = [callback3(importDefault(5646), obj2), , ];
    ...
    const tmp18 = importDefault(5646);
    const value = importDefault(4951).get(integration.type);
    let platformUserUrl;
    if (value != null) {
...
function RowSwitch(label) {
  ...
  return callback3(require(5635) /* TableSwitchRow */.TableSwitchRow, { label: label.label });
}
  ...
  if (account.account !== account) {
    ...
    if (account.verified) {
      ...
      if (null != inProgressMetadataVisibility) {
        ...
        const result = importDefault(5075).setMetadataVisibility(account.type, account.id, inProgressMetadataVisibility);
...
prototype["renderUpsell"] = function renderUpsell() {
  ...
  if (account.twoWayLink) {
    ...
    let tmp2 = callback3(require(14089) /* XboxTwoWayLinkUpsell */.XboxTwoWayLinkUpsell, {});
  } else {
    tmp2 = null;
    if (account.type === tmp.PLAYSTATION) {
      tmp2 = callback3(require(14092) /* PlayStationTwoWayLinkUpsell */.PlayStationTwoWayLinkUpsell, {});
    }
  }
};
...
prototype["render"] = function render() {
  ...
  obj3[1] = importDefault(7809);
  obj2[4] = closure_14(require(1297) /* Button */.Icon, obj3);
  obj1[3] = closure_14(require(4797) /* PressableBase */.PressableOpacity, obj2);
  ...
  obj6[1] = closure_14(require(5300) /* TableRowInner */.TableRow, { label: name, icon: tmp7Result, trailing: tmp7Result });
  ...
  items1[2] = callback4(require(5634) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: items2 });
  items1[3] = result;
  obj7[1] = items1;
