...
// Function ID: 14533
// Name: EmptyStateCard
// Dependencies: [19, 17, 676, 21, 4448, 712, 4383, 9260, 14533, 14534, 1431, 1363, 5569, 1297, 4415, 14530, 2009, 4444, 7216, 1628, 4894, 1236, 2]
// Exports: default

// Module 14532 (EmptyStateCard)
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = callback3();
  let obj = emptyStatePlatforms(7216);
  ...
  const items3 = [callback(emptyStatePlatforms(4894).Stack, { spacing: 16, justify: "center", direction: "horizontal", children: memo.map((platform) => callback(closure_9, { platform }, platform.type)) }), ];
  ...
  obj4[3] = items4;
  items3[1] = callback2(emptyStatePlatforms(4894).Stack, obj4);
  obj2[4] = items3;
  const items5 = [callback2(emptyStatePlatforms(4894).Stack, obj2), ];
  ...
  const items6 = [callback(emptyStatePlatforms(4444).Text, obj7), ];
  ...
  items6[1] = callback(emptyStatePlatforms(4444).Text, obj8);
  obj6[3] = items6;
  items5[1] = callback2(emptyStatePlatforms(4894).Stack, obj6);
  obj1[1] = items5;
