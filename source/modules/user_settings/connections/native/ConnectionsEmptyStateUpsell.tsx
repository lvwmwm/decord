...
// Function ID: 14084
// Name: EmptyStateCard
// Dependencies: [19, 17, 676, 21, 4255, 712, 4191, 10378, 14084, 14085, 1416, 4101, 5302, 1297, 4223, 14081, 1959, 4251, 6856, 1581, 4663, 1236, 2]
// Exports: default

// Module 14083 (EmptyStateCard)
...
function OtherConnectionsCard(count) {
  ...
  obj[2] = "+" + count.count;
  obj[3] = callback(require(4251) /* Text */.Text, obj);
  return callback(require(5302) /* PressableCard */.Card, obj);
}
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = callback3();
  let obj = emptyStatePlatforms(6856);
  ...
  const items3 = [callback(emptyStatePlatforms(4663).Stack, obj3), ];
  ...
  obj4[3] = items4;
  items3[1] = callback2(emptyStatePlatforms(4663).Stack, obj4);
  obj2[4] = items3;
  const items5 = [callback2(emptyStatePlatforms(4663).Stack, obj2), ];
  ...
  const items6 = [callback(emptyStatePlatforms(4251).Text, obj7), ];
  ...
  items6[1] = callback(emptyStatePlatforms(4251).Text, obj8);
  obj6[3] = items6;
  items5[1] = callback2(emptyStatePlatforms(4663).Stack, obj6);
  obj1[1] = items5;
