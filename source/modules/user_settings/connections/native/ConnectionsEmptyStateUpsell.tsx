...
// Function ID: 14205
// Name: EmptyStateCard
// Dependencies: [19, 17, 676, 21, 4303, 712, 4239, 10491, 14205, 14206, 1416, 4153, 5376, 1297, 4271, 14202, 1988, 4299, 6962, 1609, 4712, 1236, 2]
// Exports: default

// Module 14204 (EmptyStateCard)
...
function OtherConnectionsCard(count) {
  ...
  obj[2] = "+" + count.count;
  obj[3] = callback(require(4299) /* Text */.Text, obj);
  return callback(require(5376) /* PressableCard */.Card, obj);
}
...
export default function ConnectionsEmptyStateUpsell() {
  ...
  const items3 = [callback(emptyStatePlatforms(4712).Stack, obj3), ];
  ...
  obj4[3] = items4;
  items3[1] = callback2(emptyStatePlatforms(4712).Stack, obj4);
  obj2[4] = items3;
  const items5 = [callback2(emptyStatePlatforms(4712).Stack, obj2), ];
  ...
  const items6 = [callback(emptyStatePlatforms(4299).Text, obj7), ];
  ...
  items6[1] = callback(emptyStatePlatforms(4299).Text, obj8);
  obj6[3] = items6;
  items5[1] = callback2(emptyStatePlatforms(4712).Stack, obj6);
  obj1[1] = items5;
