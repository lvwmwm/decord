...
// Function ID: 14499
// Name: EmptyStateCard
// Dependencies: [19, 17, 676, 21, 4446, 712, 4381, 9238, 14499, 14500, 1435, 1363, 5566, 1297, 4413, 14496, 2010, 4442, 7195, 1629, 4891, 1236, 2]
// Exports: default

// Module 14498 (EmptyStateCard)
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = callback3();
  let obj = emptyStatePlatforms(7195);
  ...
  const items3 = [callback(emptyStatePlatforms(4891).Stack, { spacing: 16, justify: "center", direction: "horizontal", children: memo.map((platform) => callback(closure_9, { platform }, platform.type)) }), ];
  ...
  obj4[3] = items4;
  items3[1] = callback2(emptyStatePlatforms(4891).Stack, obj4);
  obj2[4] = items3;
  const items5 = [callback2(emptyStatePlatforms(4891).Stack, obj2), ];
  ...
  const items6 = [callback(emptyStatePlatforms(4442).Text, obj7), ];
  ...
  items6[1] = callback(emptyStatePlatforms(4442).Text, obj8);
  obj6[3] = items6;
  items5[1] = callback2(emptyStatePlatforms(4891).Stack, obj6);
  obj1[1] = items5;
