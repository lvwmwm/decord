...
// Function ID: 14488
// Name: EmptyStateCard
// Dependencies: [19, 17, 676, 21, 4444, 712, 4379, 10633, 14488, 14489, 1435, 1363, 5548, 1297, 4411, 14485, 2009, 4440, 7175, 1629, 4877, 1236, 2]
// Exports: default

// Module 14487 (EmptyStateCard)
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = callback3();
  let obj = emptyStatePlatforms(7175);
  ...
  const items3 = [callback(emptyStatePlatforms(4877).Stack, { spacing: 16, justify: "center", direction: "horizontal", children: memo.map((platform) => callback(closure_9, { platform }, platform.type)) }), ];
  ...
  obj4[3] = items4;
  items3[1] = callback2(emptyStatePlatforms(4877).Stack, obj4);
  obj2[4] = items3;
  const items5 = [callback2(emptyStatePlatforms(4877).Stack, obj2), ];
  ...
  const items6 = [callback(emptyStatePlatforms(4440).Text, obj7), ];
  ...
  items6[1] = callback(emptyStatePlatforms(4440).Text, obj8);
  obj6[3] = items6;
  items5[1] = callback2(emptyStatePlatforms(4877).Stack, obj6);
  obj1[1] = items5;
