...
// Dependencies: [32, 19, 17, 4266, 8343, 21, 4255, 712, 5631, 5322, 5633, 4203, 5623, 7685, 4665, 8344, 4223, 589, 8747, 5634, 5300, 4251, 7974, 4663, 2]

// Module 14902 (SurveyOverrideInfoActionSheet)
...
function SurveyOverrideInfoActionSheet(survey) {
  ...
  obj[0] = callback2(require(5322) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: "Last Survey Data" });
  ...
  obj[1] = callback2(require(5633) /* ActionSheetRowIcon */.ActionSheetRow.Group, obj);
...
function SurveyOverrideActionSheet() {
  ...
  const first = tmp[0];
  let obj = { header: null, children: null };
  obj[0] = callback2(first(5322).BottomSheetTitleHeader, { title: "Survey Override" });
  const items = [callback2(first(7685).TextInput, { label: "Survey Override", size: "md", placeholder: "Enter the ID of the Survey you want to test", onChange: tmp[1], isClearable: true }), ];
  ...
  items[1] = callback2(first(4665).Button, obj);
  obj[1] = items;
  return closure_10(first(5631).ActionSheet, obj);
}
function SurveyInfo() {
  let obj = require(589) /* initialize */;
  const items = [fetchSurveyIfNeeded];
  const stateFromStores = obj.useStateFromStores(items, () => currentSurvey.getCurrentSurvey());
  const tmp2 = importDefault(8747)(stateFromStores);
  require = tmp2;
  obj = {
  ...
  const items1 = [callback2(require(5300) /* TableRowInner */.TableRow, obj), ];
  let str;
  if (null == tmp2) {
    str = "No survey data";
  }
  ...
  obj[3] = fn;
  items1[1] = callback2(require(5300) /* TableRowInner */.TableRow, obj);
  obj1[2] = items1;
  return closure_10(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj1);
}
function ChangelogOverrideDebuggingActionSheet() {
  let obj = { header: null, children: null };
  obj[0] = callback2(require(5322) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: "Changelog Debugging" });
...
function ChangelogOverrideActionSheet() {
  ...
  const first = tmp[0];
  let obj = { header: null, children: null };
  obj[0] = callback2(first(5322).BottomSheetTitleHeader, { title: "Changelog Override" });
  const items = [callback2(first(7685).TextInput, { label: "Changelog Override", size: "md", placeholder: "Enter the ID of the changelog you want to test", onChange: tmp[1], isClearable: true }), ];
...
function ChangelogInfo() {
  ...
  obj[2] = items;
  return callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj);
}
