...
// Dependencies: [32, 19, 17, 4296, 8483, 21, 4285, 712, 5685, 5376, 5687, 4233, 5677, 7713, 4695, 8484, 4253, 589, 8776, 5688, 5354, 4281, 8115, 4693, 2]

// Module 14940 (SurveyOverrideInfoActionSheet)
...
function SurveyOverrideInfoActionSheet(survey) {
  ...
  obj[0] = callback2(require(5376) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: "Last Survey Data" });
  ...
  obj[1] = callback2(require(5687) /* ActionSheetRowIcon */.ActionSheetRow.Group, obj);
...
function SurveyOverrideActionSheet() {
  ...
  const first = tmp[0];
  let obj = { header: null, children: null };
  obj[0] = callback2(first(5376).BottomSheetTitleHeader, { title: "Survey Override" });
  const items = [callback2(first(7713).TextInput, { label: "Survey Override", size: "md", placeholder: "Enter the ID of the Survey you want to test", onChange: tmp[1], isClearable: true }), ];
  ...
  items[1] = callback2(first(4695).Button, obj);
  obj[1] = items;
  return closure_10(first(5685).ActionSheet, obj);
}
function SurveyInfo() {
  ...
  const items1 = [callback2(require(5354) /* TableRowInner */.TableRow, obj), ];
  let str;
  if (null == tmp2) {
    str = "No survey data";
  }
  ...
  obj[3] = fn;
  items1[1] = callback2(require(5354) /* TableRowInner */.TableRow, obj);
  obj1[2] = items1;
  return closure_10(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj1);
}
function ChangelogOverrideDebuggingActionSheet() {
  let obj = { header: null, children: null };
  obj[0] = callback2(require(5376) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: "Changelog Debugging" });
...
function ChangelogOverrideActionSheet() {
  ...
  const first = tmp[0];
  let obj = { header: null, children: null };
  obj[0] = callback2(first(5376).BottomSheetTitleHeader, { title: "Changelog Override" });
  const items = [callback2(first(7713).TextInput, { label: "Changelog Override", size: "md", placeholder: "Enter the ID of the changelog you want to test", onChange: tmp[1], isClearable: true }), ];
...
function ChangelogInfo() {
  ...
  obj[2] = items;
  return callback3(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj);
}
