...
// Dependencies: [32, 19, 17, 4204, 9283, 21, 4193, 712, 5555, 5246, 5557, 4141, 5547, 6730, 4604, 9284, 4161, 589, 8129, 5558, 5224, 4189, 7872, 4602, 2]
...
function SurveyOverrideInfoActionSheet(survey) {
  ...
  obj[0] = callback2(require(5246) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: "Last Survey Data" });
...
function SurveyOverrideActionSheet() {
  ...
  const first = tmp[0];
  let obj = { header: null, children: null };
  obj[0] = callback2(first(5246).BottomSheetTitleHeader, { title: "Survey Override" });
  const items = [callback2(first(6730).TextInput, { label: "Survey Override", size: "md", placeholder: "Enter the ID of the Survey you want to test", onChange: tmp[1], isClearable: true }), ];
  ...
  items[1] = callback2(first(4604).Button, obj);
  obj[1] = items;
  return closure_10(first(5555).ActionSheet, obj);
}
function SurveyInfo() {
  ...
  const items1 = [callback2(require(5224) /* TableRowInner */.TableRow, obj), ];
  let str;
  if (null == tmp2) {
    str = "No survey data";
  }
  ...
  obj[3] = fn;
  items1[1] = callback2(require(5224) /* TableRowInner */.TableRow, obj);
  obj1[2] = items1;
  return closure_10(require(5558) /* TableRowGroupTitle */.TableRowGroup, obj1);
}
function ChangelogOverrideDebuggingActionSheet() {
  let obj = { header: null, children: null };
  obj[0] = callback2(require(5246) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: "Changelog Debugging" });
...
function ChangelogOverrideActionSheet() {
  ...
  const first = tmp[0];
  let obj = { header: null, children: null };
  obj[0] = callback2(first(5246).BottomSheetTitleHeader, { title: "Changelog Override" });
  const items = [callback2(first(6730).TextInput, { label: "Changelog Override", size: "md", placeholder: "Enter the ID of the changelog you want to test", onChange: tmp[1], isClearable: true }), ];
...
function ChangelogInfo() {
  ...
  obj[2] = items;
  return callback3(require(5558) /* TableRowGroupTitle */.TableRowGroup, obj);
}
