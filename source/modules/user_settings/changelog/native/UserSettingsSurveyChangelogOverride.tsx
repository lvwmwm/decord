...
// Dependencies: [32, 19, 17, 4495, 4719, 21, 4481, 709, 7138, 7089, 7140, 4428, 7130, 6547, 4936, 4720, 4448, 586, 8202, 5642, 5560, 4477, 8023, 4934, 2]

// Module 15629 (SurveyOverrideInfoActionSheet)
...
import closure_7 from "handleUserSettingsProtoStoreChange" /* 4495 */;
import closure_8 from "fetchSurveyIfNeeded" /* 4719 */;
...
function SurveyOverrideActionSheet() {
  ...
  const first = tmp[0];
  let obj = { header: callback2(first(7089).BottomSheetTitleHeader, { title: "Survey Override" }), children: null };
  const items = [callback2(first(6547).TextInput, { label: "Survey Override", size: "md", placeholder: "Enter the ID of the Survey you want to test", onChange: tmp[1], isClearable: true }), ];
  ...
  items[1] = callback2(first(4936).Button, obj);
  obj[1] = items;
  return closure_10(first(7138).ActionSheet, obj);
}
function SurveyInfo() {
  ...
  const items1 = [callback2(_require(5560).TableRow, obj), ];
  let str;
  if (null == tmp2) {
    str = "No survey data";
  }
  ...
  obj[3] = fn;
  items1[1] = callback2(_require(5560).TableRow, obj);
  obj1[2] = items1;
  return closure_10(_require(5642).TableRowGroup, obj1);
}
...
function ChangelogOverrideActionSheet() {
  ...
  const first = tmp[0];
  let obj = { header: callback2(first(7089).BottomSheetTitleHeader, { title: "Changelog Override" }), children: null };
  const items = [callback2(first(6547).TextInput, { label: "Changelog Override", size: "md", placeholder: "Enter the ID of the changelog you want to test", onChange: tmp[1], isClearable: true }), ];
