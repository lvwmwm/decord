...
// Dependencies: [32, 19, 17, 4313, 8500, 21, 4302, 712, 5704, 5395, 5706, 4250, 5696, 7730, 4712, 8501, 4270, 589, 8793, 5707, 5373, 4298, 8132, 4710, 2]

// Module 14956 (SurveyOverrideInfoActionSheet)
...
function SurveyOverrideInfoActionSheet(survey) {
  ...
  obj[0] = callback2(require(5395) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: "Last Survey Data" });
  ...
  obj[1] = callback2(require(5706) /* ActionSheetRowIcon */.ActionSheetRow.Group, obj);
...
function SurveyOverrideActionSheet() {
  ...
  const first = tmp[0];
  let obj = { header: null, children: null };
  obj[0] = callback2(first(5395).BottomSheetTitleHeader, { title: "Survey Override" });
  const items = [callback2(first(7730).TextInput, { label: "Survey Override", size: "md", placeholder: "Enter the ID of the Survey you want to test", onChange: tmp[1], isClearable: true }), ];
  ...
  items[1] = callback2(first(4712).Button, obj);
  obj[1] = items;
  return closure_10(first(5704).ActionSheet, obj);
}
function SurveyInfo() {
  ...
  const items1 = [callback2(require(5373) /* TableRowInner */.TableRow, obj), ];
  let str;
  if (null == tmp2) {
    str = "No survey data";
  }
  ...
  obj[3] = fn;
  items1[1] = callback2(require(5373) /* TableRowInner */.TableRow, obj);
  obj1[2] = items1;
  return closure_10(require(5707) /* TableRowGroupTitle */.TableRowGroup, obj1);
}
function ChangelogOverrideDebuggingActionSheet() {
  let obj = { header: null, children: null };
  obj[0] = callback2(require(5395) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: "Changelog Debugging" });
...
function ChangelogOverrideActionSheet() {
  ...
  const first = tmp[0];
  let obj = { header: null, children: null };
  obj[0] = callback2(first(5395).BottomSheetTitleHeader, { title: "Changelog Override" });
  const items = [callback2(first(7730).TextInput, { label: "Changelog Override", size: "md", placeholder: "Enter the ID of the changelog you want to test", onChange: tmp[1], isClearable: true }), ];
...
function ChangelogInfo() {
  ...
  obj[2] = items;
  return callback3(require(5707) /* TableRowGroupTitle */.TableRowGroup, obj);
}
