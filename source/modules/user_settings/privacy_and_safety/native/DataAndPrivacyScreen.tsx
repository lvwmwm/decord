...
// Dependencies: [19, 6062, 7893, 673, 21, 1233, 1994, 9861, 1498, 14684, 14687, 11288, 14644, 14563, 2]
// Exports: default

// Module 15693 (DataAndPrivacySettings)
...
export default function DataAndPrivacySettings() {
  ...
  const effect = React.useEffect(() => {
    if (!fetchedConsents.fetchedConsents) {
      const consents = stackNavigation(14684).fetchConsents();
      const obj = stackNavigation(14684);
    }
    const harvestStatus = stackNavigation(14687).fetchHarvestStatus();
  }, []);
  ...
  obj12[0] = stackNavigation(14644).SettingsScreen.DATA_AND_PRIVACY;
  const items9 = [callback(items1(14644), obj12), callback(items1(14563), { node: memo })];
  obj11[0] = items9;
