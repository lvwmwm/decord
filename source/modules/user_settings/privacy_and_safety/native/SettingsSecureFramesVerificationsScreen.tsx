...
// Dependencies: [19, 17, 1921, 21, 4481, 9079, 5560, 1233, 5084, 5635, 4477, 6934, 1498, 586, 4325, 7795, 15775, 8804, 2]
// Exports: default

// Module 15778 (VerificationListItem)
...
function VerificationListItem(userId) {
  ...
  obj[2] = start;
  obj[3] = end;
  obj = { onPress: callback, children: jsx(userId(5635).XSmallIcon, {}) };
  obj[4] = jsx(userId(5084).PressableHighlight, { onPress: callback, children: jsx(userId(5635).XSmallIcon, {}) });
  return jsx(userId(5560).TableRow, { onPress: callback, children: jsx(userId(5635).XSmallIcon, {}) });
}
...
function ClearVerificationsListFooter(userId) {
  ...
  obj[0] = jsx(userId(4477).Text, { variant: "text-md/semibold", color: "text-feedback-critical", children: null });
  ...
  obj[1] = jsx(userId(4477).Text, { variant: "text-xs/medium", color: "text-subtle", children: null });
  obj[2] = callback;
  return jsx(userId(5560).TableRow, { variant: "text-xs/medium", color: "text-subtle", children: null });
}
...
export default function SettingsSecureFramesVerificationsScreen() {
  ...
  dependencyMap = navigation(4325).getFormattedName(stateFromStores, false);
  ...
  const obj4 = navigation(4325);
  secureFramesUserVerifiedKeys = userId(15775).useSecureFramesUserVerifiedKeys(userId);
  ...
  obj[1] = jsx(userId(8804).FlashList, { keyExtractor, getItemType, renderItem, data: memo, contentContainerStyle: tmp.listContent, ListFooterComponent: null });
