...
// Dependencies: [31, 33, 5533, 5220, 1212, 5536, 5198, 7632, 7631, 1273, 4133, 2]
// Exports: openUserSettingsDebugLogsFiltersActionSheet

// Module 14501 (UserSettingsDebugLogsFiltersActionSheet)
import "result";
...
function UserSettingsDebugLogsFiltersActionSheet(arg0) {
  ...
  const items = [callback(require(5536) /* TableRowGroupTitle */.TableRowGroup, obj), , ];
  const obj2 = {};
  ...
  obj3.value = "newest";
  const items1 = [callback(require(7631) /* TableRadioRow */.TableRadioRow, obj3), ];
  const obj4 = {};
  const intl5 = require(1212) /* getSystemLocale */.intl;
  obj4.label = intl5.string(require(1212) /* getSystemLocale */.t.mmeWUF);
  obj4.value = "oldest";
  items1[1] = callback(require(7631) /* TableRadioRow */.TableRadioRow, obj4);
  obj2.children = items1;
  items[1] = callback2(require(7632) /* context */.TableRadioGroup, obj2);
