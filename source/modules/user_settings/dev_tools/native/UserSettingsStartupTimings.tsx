...
// Function ID: 15492
// Name: Code
// Dependencies: [5, 32, 19, 17, 703, 673, 21, 4481, 709, 4477, 4342, 1627, 10122, 586, 9, 7408, 8291, 8804, 4934, 5642, 5559, 705, 5560, 8983, 2]
// Exports: default
...
import importDefaultResult from "enforcing" /* 4342 */;
...
export default function UserSettingsStartupTimings() {
  ...
  const memo = React.useMemo(() => first(10122)(closure_5, !first, first1).split("\n"), items);
  obj1 = _require(586);
  ...
  const lastTrackedAppUiViewed2Properties = _require(7408).getLastTrackedAppUiViewed2Properties();
  num = undefined;
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          closure_0 = arg1;
          closure_1 = closure_1_1(10122)(closure_0);
  ...
  obj[1] = function ListHeaderComponent() {
    ...
    obj = { title: "Performance testing", hasIcons: false, children: callback(lib(5559).TableCheckboxRow, obj) };
    obj = {
    ...
    const items = [callback(lib(5642).TableRowGroup, obj), , , , ];
    obj1 = { children: null };
    ...
    obj14[2] = callback(lib(5560).TableRow, obj15);
    items[1] = callback(lib(5642).TableRowGroup, obj14);
    ...
    obj18[2] = callback(lib(5560).TableRow, obj19);
    items[2] = callback(lib(5642).TableRowGroup, obj18);
    const obj21 = { title: "Detailed Times", hasIcons: false, children: null };
    const items11 = [
      callback(lib(5559).TableCheckboxRow, {
    ...
    obj21[2] = items11;
    items[3] = callback2(lib(5642).TableRowGroup, obj21);
    ...
    obj24[2] = callback(lib(5560).TableRow, { icon: callback(lib(8983).ShareIcon, {}), label: "Copy timings to clipboard.", arrow: true, onPress: closure_14 });
    items[4] = callback(lib(5642).TableRowGroup, obj24);
    obj[2] = items;
    const items12 = [callback2(lib(4934).Stack, obj), callback(closure_6, { style: lib.border })];
    obj13[0] = items12;
  ...
  obj[1] = callback2(_require(8804).FlashList, obj);
