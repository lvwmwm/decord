...
// Function ID: 15049
// Name: Code
// Dependencies: [5, 32, 19, 17, 706, 676, 21, 4444, 712, 4440, 4305, 1629, 10092, 589, 9, 7147, 9138, 7957, 4877, 5939, 8673, 708, 5546, 12510, 2]
// Exports: default
...
import importDefaultResult from "enforcing" /* 4305 */;
...
export default function UserSettingsStartupTimings() {
  ...
  const memo = React.useMemo(() => first(10092)(closure_5, !first, first1).split("\n"), items);
  obj1 = _require(589);
  ...
  const lastTrackedAppUiViewed2Properties = _require(7147).getLastTrackedAppUiViewed2Properties();
  num = undefined;
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          closure_0 = arg1;
          closure_1 = closure_1_1(10092)(closure_0);
  ...
  obj[1] = function ListHeaderComponent() {
    ...
    obj = { title: "Performance testing", hasIcons: false, children: callback(lib(8673).TableCheckboxRow, obj) };
    obj = {
    ...
    const items = [callback(lib(5939).TableRowGroup, obj), , , , ];
    obj1 = { children: null };
    ...
    obj14[2] = callback(lib(5546).TableRow, obj15);
    items[1] = callback(lib(5939).TableRowGroup, obj14);
    ...
    obj18[2] = callback(lib(5546).TableRow, obj19);
    items[2] = callback(lib(5939).TableRowGroup, obj18);
    const obj21 = { title: "Detailed Times", hasIcons: false, children: null };
    const items11 = [
      callback(lib(8673).TableCheckboxRow, {
    ...
    obj21[2] = items11;
    items[3] = callback2(lib(5939).TableRowGroup, obj21);
    ...
    obj24[2] = callback(lib(5546).TableRow, { icon: callback(lib(12510).ShareIcon, {}), label: "Copy timings to clipboard.", arrow: true, onPress: closure_14 });
    items[4] = callback(lib(5939).TableRowGroup, obj24);
    obj[2] = items;
    const items12 = [callback2(lib(4877).Stack, obj), callback(closure_6, { style: lib.border })];
    obj13[0] = items12;
  ...
  obj[1] = callback2(_require(7957).FlashList, obj);
