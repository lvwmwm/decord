...
// Function ID: 15113
// Name: Code
// Dependencies: [5, 32, 19, 17, 706, 676, 21, 4445, 712, 4441, 4306, 1629, 10195, 589, 9, 7153, 8563, 8037, 4878, 5944, 7616, 708, 5551, 12692, 2]
// Exports: default
...
import importDefaultResult from "enforcing" /* 4306 */;
...
export default function UserSettingsStartupTimings() {
  ...
  const memo = React.useMemo(() => first(10195)(closure_5, !first, first1).split("\n"), items);
  obj1 = _require(589);
  ...
  const lastTrackedAppUiViewed2Properties = _require(7153).getLastTrackedAppUiViewed2Properties();
  num = undefined;
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          closure_0 = arg1;
          closure_1 = closure_1_1(10195)(closure_0);
  ...
  obj[1] = function ListHeaderComponent() {
    ...
    obj = { title: "Performance testing", hasIcons: false, children: callback(lib(7616).TableCheckboxRow, obj) };
    obj = {
    ...
    const items = [callback(lib(5944).TableRowGroup, obj), , , , ];
    obj1 = { children: null };
    ...
    obj14[2] = callback(lib(5551).TableRow, obj15);
    items[1] = callback(lib(5944).TableRowGroup, obj14);
    ...
    obj18[2] = callback(lib(5551).TableRow, obj19);
    items[2] = callback(lib(5944).TableRowGroup, obj18);
    const obj21 = { title: "Detailed Times", hasIcons: false, children: null };
    const items11 = [
      callback(lib(7616).TableCheckboxRow, {
    ...
    obj21[2] = items11;
    items[3] = callback2(lib(5944).TableRowGroup, obj21);
    ...
    obj24[2] = callback(lib(5551).TableRow, { icon: callback(lib(12692).ShareIcon, {}), label: "Copy timings to clipboard.", arrow: true, onPress: closure_14 });
    items[4] = callback(lib(5944).TableRowGroup, obj24);
    obj[2] = items;
    const items12 = [callback2(lib(4878).Stack, obj), callback(closure_6, { style: lib.border })];
    obj13[0] = items12;
  ...
  obj[1] = callback2(_require(8037).FlashList, obj);
