...
// Function ID: 15410
// Name: Code
// Dependencies: [5, 32, 19, 17, 703, 673, 21, 4478, 709, 4474, 4339, 1627, 10302, 586, 9, 7230, 8651, 8116, 4927, 6001, 7695, 705, 5608, 13012, 2]
// Exports: default
...
export default function UserSettingsStartupTimings() {
  ...
  const lastTrackedAppUiViewed2Properties = _require(7230).getLastTrackedAppUiViewed2Properties();
  num = undefined;
  ...
  obj[1] = function ListHeaderComponent() {
    ...
    obj24[2] = callback(lib(5608).TableRow, { icon: callback(lib(13012).ShareIcon, {}), label: "Copy timings to clipboard.", arrow: true, onPress: closure_14 });
  ...
  obj[1] = callback2(_require(8116).FlashList, obj);
