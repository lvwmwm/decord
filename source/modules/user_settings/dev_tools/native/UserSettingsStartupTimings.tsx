...
// Function ID: 14822
// Name: Code
// Dependencies: [5, 32, 19, 17, 706, 676, 21, 4344, 712, 4340, 4206, 1628, 9921, 589, 9, 6976, 8968, 7786, 4752, 5806, 8493, 708, 5413, 12298, 2]
// Exports: default
...
function Code(arg0) {
  ...
  return callback2(require(4340) /* Text */.Text, { variant: "text-sm/normal", color, lineClamp: 1, style: createCacheKey().code, children });
}
...
export default function UserSettingsStartupTimings() {
  ...
  const memo = React.useMemo(() => first(9921)(TableRowGroupTitle, !first, first1).split("\n"), items);
  ...
  const lastTrackedAppUiViewed2Properties = require(6976) /* getDeviceMetadata */.getLastTrackedAppUiViewed2Properties();
  num = undefined;
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          closure_0 = arg1;
          closure_1 = outer1_1(9921)(closure_0);
          obj = outer1_0(8968);
          obj3 = { message: null };
          obj3[0] = closure_1;
  ...
  obj[1] = function ListHeaderComponent() {
    ...
    obj[2] = callback(callback2(8493).TableCheckboxRow, obj);
    const items = [callback(callback2(5806).TableRowGroup, obj), , , , ];
    ...
    obj14[2] = callback(callback2(5413).TableRow, obj15);
    items[1] = callback(callback2(5806).TableRowGroup, obj14);
    ...
    obj18[2] = callback(callback2(5413).TableRow, obj19);
    items[2] = callback(callback2(5806).TableRowGroup, obj18);
    const obj21 = { title: "Detailed Times", hasIcons: false, children: null };
    const items11 = [
      callback(callback2(8493).TableCheckboxRow, {
    ...
    obj21[2] = items11;
    items[3] = callback2(callback2(5806).TableRowGroup, obj21);
    ...
    obj25[0] = callback(callback2(12298).ShareIcon, {});
    obj25[3] = closure_14;
    obj24[2] = callback(callback2(5413).TableRow, obj25);
    items[4] = callback(callback2(5806).TableRowGroup, obj24);
    obj[2] = items;
    const items12 = [callback2(callback2(4752).Stack, obj), callback(closure_6, { style: callback2.border })];
    obj13[0] = items12;
  ...
  obj[1] = callback2(require(7786) /* noop */.FlashList, obj);
