...
// Function ID: 14764
// Name: Code
// Dependencies: [5, 32, 19, 17, 706, 676, 21, 4303, 712, 4299, 4165, 1628, 9880, 589, 9, 6937, 8929, 7747, 4712, 5767, 8454, 708, 5374, 12235, 2]
// Exports: default
...
function Code(arg0) {
  ...
  return callback2(require(4299) /* Text */.Text, { variant: "text-sm/normal", color, lineClamp: 1, style: createCacheKey().code, children });
}
...
export default function UserSettingsStartupTimings() {
  ...
  const lastTrackedAppUiViewed2Properties = require(6937) /* getDeviceMetadata */.getLastTrackedAppUiViewed2Properties();
  num = undefined;
  ...
  obj[1] = function ListHeaderComponent() {
    ...
    obj14[2] = callback(callback2(5374).TableRow, obj15);
    items[1] = callback(callback2(5767).TableRowGroup, obj14);
    ...
    obj18[2] = callback(callback2(5374).TableRow, obj19);
    ...
    obj[2] = items;
    const items12 = [callback2(callback2(4712).Stack, obj), callback(closure_6, { style: callback2.border })];
    obj13[0] = items12;
  ...
  obj[1] = callback2(require(7747) /* noop */.FlashList, obj);
