...
// Function ID: 14525
// Name: Code
// Dependencies: [5, 32, 19, 17, 706, 676, 21, 4189, 712, 4185, 4047, 1581, 10349, 589, 9, 5731, 8193, 6673, 4598, 5554, 9088, 708, 5220, 12290, 2]
// Exports: default
...
function Code(arg0) {
  ...
  return callback2(require(4185) /* Text */.Text, { variant: "text-sm/normal", color, lineClamp: 1, style: createCacheKey().code, children });
}
...
export default function UserSettingsStartupTimings() {
  ...
  const memo = React.useMemo(() => first(10349)(TableRowGroupTitle, !first, first1).split("\n"), items);
  ...
  const lastTrackedAppUiViewed2Properties = require(5731) /* getDeviceMetadata */.getLastTrackedAppUiViewed2Properties();
  num = undefined;
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          closure_0 = arg1;
          closure_1 = outer1_1(10349)(closure_0);
          obj = outer1_0(8193);
          obj3 = { message: null };
          obj3[0] = closure_1;
  ...
  obj1[0] = first(1581)().bottom + first(712).space.PX_16;
  obj[0] = obj1;
  obj[1] = function ListHeaderComponent() {
    ...
    obj[2] = callback(callback2(9088).TableCheckboxRow, obj);
    const items = [callback(callback2(5554).TableRowGroup, obj), , , , ];
    ...
    obj14[2] = callback(callback2(5220).TableRow, obj15);
    items[1] = callback(callback2(5554).TableRowGroup, obj14);
    ...
    obj18[2] = callback(callback2(5220).TableRow, obj19);
    items[2] = callback(callback2(5554).TableRowGroup, obj18);
    const obj21 = { title: "Detailed Times", hasIcons: false, children: null };
    const items11 = [
      callback(callback2(9088).TableCheckboxRow, {
    ...
    obj21[2] = items11;
    items[3] = callback2(callback2(5554).TableRowGroup, obj21);
    ...
    obj25[0] = callback(callback2(12290).ShareIcon, {});
    obj25[3] = closure_14;
    obj24[2] = callback(callback2(5220).TableRow, obj25);
    items[4] = callback(callback2(5554).TableRowGroup, obj24);
    obj[2] = items;
    const items12 = [callback2(callback2(4598).Stack, obj), callback(closure_6, { style: callback2.border })];
    obj13[0] = items12;
  ...
  obj[1] = callback2(require(6673) /* noop */.FlashList, obj);
