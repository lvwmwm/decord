...
// Function ID: 12527
// Name: CheckIcon
// Dependencies: [32, 19, 17, 676, 1876, 21, 4193, 712, 5034, 4129, 4039, 1297, 12527, 12528, 4189, 1236, 4615, 6574, 3839, 12529, 12530, 5145, 12531, 12532, 12533, 12534, 12535, 2]
// Exports: default
...
function CheckIcon() {
  ...
  obj[0] = tmp(12527);
  obj[1] = obj.isThemeDark(importDefault(4129)()) ? unsafe_rawColors.WHITE : unsafe_rawColors.PRIMARY_860;
...
function CloseIcon() {
  ...
  obj[0] = importDefault(12528);
  obj[1] = callback3().icon;
  obj[2] = require(1297) /* Button */.IconSizes.SMALL;
  return callback2(require(1297) /* Button */.Icon, obj);
}
function CellText(children) {
  return callback2(require(4189) /* Text */.Text, { variant: "text-md/medium", color: "mobile-text-heading-primary", children: children.text });
}
  ...
  if ("nitro_home" === str) {
    if (!highlightColumn1) {
      if (!disableHighlightColumn2) {
        ...
        obj6[4] = column2;
        obj4[3] = tmp5(importDefault(4615), obj6);
      }
