...
// Dependencies: [32, 19, 17, 8835, 21, 4344, 712, 1367, 5767, 5787, 589, 8831, 4340, 1236, 2399, 10087, 4754, 9620, 10080, 12908, 12910, 9524, 2]
// Exports: default

// Module 12907 (GiftingBadgeIntro)
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  analyticsLocations = importDefault(5767)(importDefault(5787).USER_SETTINGS_GIFT_INVENTORY).analyticsLocations;
