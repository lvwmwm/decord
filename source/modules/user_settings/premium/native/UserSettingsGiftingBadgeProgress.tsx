...
// Dependencies: [32, 19, 17, 8790, 21, 4303, 712, 1348, 5728, 5748, 589, 8786, 4299, 1236, 2380, 10041, 4714, 9575, 10034, 12845, 12847, 9478, 2]
// Exports: default

// Module 12844 (GiftingBadgeIntro)
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  analyticsLocations = importDefault(5728)(importDefault(5748).USER_SETTINGS_GIFT_INVENTORY).analyticsLocations;
