...
// Dependencies: [32, 19, 17, 8713, 21, 4285, 712, 1348, 5649, 5669, 589, 8709, 4281, 1236, 2380, 9958, 4695, 9493, 9951, 12758, 12760, 9396, 2]
// Exports: default

// Module 12757 (GiftingBadgeIntro)
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  analyticsLocations = importDefault(5649)(importDefault(5669).USER_SETTINGS_GIFT_INVENTORY).analyticsLocations;
