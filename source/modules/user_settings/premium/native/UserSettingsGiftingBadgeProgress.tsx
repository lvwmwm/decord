...
// Dependencies: [32, 19, 17, 8730, 21, 4302, 712, 1348, 5668, 5688, 589, 8726, 4298, 1236, 2380, 9974, 4712, 9510, 9967, 12773, 12775, 9413, 2]
// Exports: default

// Module 12772 (GiftingBadgeIntro)
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  analyticsLocations = importDefault(5668)(importDefault(5688).USER_SETTINGS_GIFT_INVENTORY).analyticsLocations;
