...
// Dependencies: [32, 19, 17, 8684, 21, 4255, 712, 1348, 5595, 5615, 589, 8680, 4251, 1236, 2351, 9927, 4665, 9464, 9920, 12721, 12723, 9367, 2]
// Exports: default

// Module 12720 (GiftingBadgeIntro)
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  analyticsLocations = importDefault(5595)(importDefault(5615).USER_SETTINGS_GIFT_INVENTORY).analyticsLocations;
