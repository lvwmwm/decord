...
// Dependencies: [32, 19, 17, 4334, 4013, 12752, 676, 1388, 1924, 21, 689, 712, 4342, 1499, 12753, 4887, 5314, 4338, 1236, 698, 6054, 12754, 8207, 12755, 7688, 7692, 12776, 12777, 7799, 12778, 12782, 12794, 7706, 12749, 12750, 6062, 1628, 7685, 589, 6907, 8211, 12795, 9005, 4083, 4754, 1363, 12796, 4164, 1377, 8206, 1379, 5308, 12797, 12798, 9611, 9191, 4766, 500, 4744, 2]
// Exports: default

// Module 12751 (NitroHomeHeader)
...
function NewTab(arg0) {
  ...
  const tmp = callback5();
  let obj = _require(8207);
  const isEligibleSenderForReferralProgram = obj.useIsEligibleSenderForReferralProgram();
  let obj1 = _require(12755);
  const premiumPerkCard = obj1.usePremiumPerkCard();
  let obj2 = _require(7688);
  const promotionMarketingComponent = obj2.usePromotionMarketingComponent(_require(7692).MarketingComponentType.MARKETING_PAGE_BANNER);
  ...
  const items1 = [tmp12, callback2(_require(12778).TieredTenureBadgePerkCard, {}), , , , , ];
  let tmp15Result = null;
  if (isEligibleSenderForReferralProgram) {
    obj2 = { onLayout: null, children: null };
    obj2[0] = importDefault(12776)(ref, scrollToSectionId).createSectionLayoutHandler(NitroHomeSectionId.REFERRAL_PROGRAM);
  ...
  items1[4] = callback2(importDefault(12755), {});
  const obj3 = {};
  const obj4 = {};
  const obj5 = {};
  const tmp10 = closure_18;
  const tmp11 = closure_6;
  const tmp8Result1 = importDefault(12755);
  const merged2 = Object.assign(premiumPerkCard.earlyAccess);
  items1[5] = callback2(importDefault(12755), obj5);
  const obj6 = {};
  const tmp8Result2 = importDefault(12755);
  const merged3 = Object.assign(premiumPerkCard.superReactions);
  items1[6] = callback2(importDefault(12755), obj6);
  obj[6] = items1;
