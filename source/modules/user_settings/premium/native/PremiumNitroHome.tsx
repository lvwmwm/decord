...
// Dependencies: [32, 19, 17, 4662, 4045, 12849, 676, 1388, 1924, 21, 689, 712, 4661, 1500, 12850, 5433, 6316, 4734, 1236, 698, 7355, 12851, 8274, 12852, 7927, 7931, 12873, 12874, 8038, 12875, 12879, 12891, 7945, 12846, 12847, 7363, 1629, 7924, 589, 5356, 8278, 12892, 8799, 4115, 4744, 1363, 12893, 4196, 1377, 8273, 1379, 5449, 12894, 12895, 11785, 10096, 4756, 500, 4724, 2]
// Exports: default
...
function NewTab(arg0) {
  ...
  if (isEligibleSenderForReferralProgram) {
    ...
    obj2[0] = importDefault(12873)(ref, scrollToSectionId).createSectionLayoutHandler(NitroHomeSectionId.REFERRAL_PROGRAM);
  ...
  items1[4] = callback2(importDefault(12852), {});
  const obj5 = {};
  const obj3 = {};
  const obj4 = {};
  const tmp10 = closure_18;
  const tmp11 = closure_6;
  const tmp8Result1 = importDefault(12852);
  const merged2 = Object.assign(premiumPerkCard.earlyAccess);
  items1[5] = callback2(importDefault(12852), obj5);
  const obj6 = {};
  const tmp8Result2 = importDefault(12852);
  const merged3 = Object.assign(premiumPerkCard.superReactions);
  items1[6] = callback2(importDefault(12852), obj6);
  obj[6] = items1;
