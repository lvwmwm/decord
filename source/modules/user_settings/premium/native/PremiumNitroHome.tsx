...
// Dependencies: [32, 19, 17, 4295, 3972, 12693, 676, 1388, 1924, 21, 689, 712, 4303, 1499, 12694, 4846, 5274, 4299, 1236, 698, 6013, 12695, 8164, 12696, 7645, 7649, 12717, 12718, 7756, 12719, 12723, 12735, 7663, 12690, 12691, 6021, 1628, 7642, 589, 6862, 8168, 12736, 8962, 4042, 4713, 1363, 12737, 4125, 1377, 8163, 1379, 5268, 12738, 12739, 9567, 9147, 4725, 500, 4703, 2]
// Exports: default

// Module 12692 (NitroHomeHeader)
...
function NewTab(arg0) {
  ...
  const tmp = callback5();
  let obj = _require(8164);
  const isEligibleSenderForReferralProgram = obj.useIsEligibleSenderForReferralProgram();
  let obj1 = _require(12696);
  const premiumPerkCard = obj1.usePremiumPerkCard();
  let obj2 = _require(7645);
  const promotionMarketingComponent = obj2.usePromotionMarketingComponent(_require(7649).MarketingComponentType.MARKETING_PAGE_BANNER);
  ...
  const items1 = [tmp12, callback2(_require(12719).TieredTenureBadgePerkCard, {}), , , , , ];
  let tmp15Result = null;
  if (isEligibleSenderForReferralProgram) {
    obj2 = { onLayout: null, children: null };
    obj2[0] = importDefault(12717)(ref, scrollToSectionId).createSectionLayoutHandler(NitroHomeSectionId.REFERRAL_PROGRAM);
  ...
  items1[4] = callback2(importDefault(12696), {});
  const obj3 = {};
  const obj4 = {};
  const obj5 = {};
  const tmp10 = closure_18;
  const tmp11 = closure_6;
  const tmp8Result1 = importDefault(12696);
  const merged2 = Object.assign(premiumPerkCard.earlyAccess);
  items1[5] = callback2(importDefault(12696), obj5);
  const obj6 = {};
  const tmp8Result2 = importDefault(12696);
  const merged3 = Object.assign(premiumPerkCard.superReactions);
  items1[6] = callback2(importDefault(12696), obj6);
  obj[6] = items1;
