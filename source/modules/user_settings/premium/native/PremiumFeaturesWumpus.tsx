...
// Dependencies: [19, 1924, 21, 4303, 7643, 7330, 8636, 8637, 8638, 8639, 7332, 5268, 2]
// Exports: default

// Module 8635 (PremiumFeaturesWumpus)
...
export default function PremiumFeaturesWumpus(premiumType) {
  ...
  const items1 = [callback(premiumType(5268), obj), ];
  ...
  obj = { children: null };
  items2[1] = wumpusLeft;
  items1[1] = callback(premiumType(5268), { style: items2, resizeMode: "contain", source: wumpusImageSource });
  obj[0] = items1;
