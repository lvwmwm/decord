...
// Dependencies: [19, 1876, 21, 4255, 7534, 7223, 8524, 8525, 8526, 8527, 7225, 5221, 2]
// Exports: default

// Module 8523 (PremiumFeaturesWumpus)
...
export default function PremiumFeaturesWumpus(premiumType) {
  ...
  const items1 = [callback(premiumType(5221), obj), ];
  ...
  items1[1] = callback(premiumType(5221), { style: items2, resizeMode: "contain", source: wumpusImageSource });
  obj[0] = items1;
