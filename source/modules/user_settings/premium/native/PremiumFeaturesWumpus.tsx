...
// Dependencies: [19, 1925, 21, 4446, 7665, 8302, 8303, 8304, 8305, 8306, 8307, 5458, 2]
// Exports: default

// Module 8301 (PremiumFeaturesWumpus)
...
export default function PremiumFeaturesWumpus(premiumType) {
  ...
  const items1 = [callback(premiumType(5458), obj), ];
  ...
  obj = { children: null };
  items2[1] = wumpusLeft;
  items1[1] = callback(premiumType(5458), { style: items2, resizeMode: "contain", source: wumpusImageSource });
  obj[0] = items1;
