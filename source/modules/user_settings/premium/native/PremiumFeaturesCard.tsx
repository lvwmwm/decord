...
// Function ID: 8407
// Name: PremiumTypes
// Dependencies: [32, 19, 17, 4247, 3906, 3907, 676, 1876, 505, 21, 4255, 712, 5189, 7543, 3901, 5749, 4251, 1236, 7938, 2837, 1892, 38, 6805, 7235, 7946, 6754, 6804, 5595, 589, 8407, 1577, 6765, 7296, 6796, 8073, 8408, 8521, 8523, 8528, 4665, 7597, 6780, 2]
// Exports: default

// Module 8406 (PremiumTypes)
...
function PriceText(fractionalPremiumInfo) {
  ...
  const tmp4 = importDefault(7543)(premiumItem.basePlanId);
...
export default function PremiumFeaturesCard(premiumType) {
  ...
  const tmp12 = importDefault(6754)();
  ...
  const tmp23 = importDefault(8407)(premiumType, flag, UNSPECIFIED);
  ...
  const tmp34 = importDefault(7543)(premiumBundleWithPredicate.basePlanId);
  ...
  obj4[1] = tmp37Result;
  const items5 = [callback2(analyticsLocations, obj4), callback2(importDefault(8523), { premiumType }), , , ];
  if (flag3) {
  ...
  items5[3] = callback2(importDefault(8528), { style: tmp3.featureList, features: tmp23, iconStyle: tmp3.featureIcon, labelStyle: tmp3.featureLabel, rowStyle: tmp3.featureRow });
  if (hideButton) {
    items5[4] = !hideButton;
    obj3[1] = items5;
