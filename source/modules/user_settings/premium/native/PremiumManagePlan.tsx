...
// Dependencies: [5, 32, 19, 17, 3932, 1874, 3933, 3936, 3937, 6770, 6785, 5767, 676, 5277, 4268, 1876, 21, 3, 4285, 712, 1480, 4812, 5242, 4281, 1236, 5125, 1348, 5610, 7553, 5630, 589, 3997, 4131, 691, 4604, 5598, 7295, 6775, 698, 3931, 38, 5764, 12675, 12676, 7528, 7538, 7311, 4695, 7517, 7558, 7557, 4800, 8434, 12596, 1945, 5317, 4706, 1297, 7626, 1581, 7561, 6769, 4711, 5786, 7976, 12638, 12619, 1414, 4684, 7514, 5922, 7559, 12653, 2]
// Exports: default

// Module 12674 (ManagePlanHeader)
...
function FractionalPremiumCredits(durationText) {
  ...
  if (showPremiumFeaturesCard) {
    ...
    showPremiumFeaturesCard = callback3(tmp(8434), obj);
  }
...
export default function PremiumManagePlan() {
  ...
  importDefault(4711)(() => {
    ...
    if (!tmp5) {
      const premiumSubscriptionPlans = navigation(5786).fetchPremiumSubscriptionPlans();
      const obj3 = navigation(5786);
    }
  });
  let obj7 = navigation(7976);
  ...
  if (isInReverseTrial) {
    ...
    isInReverseTrial = tmp29(tmp2(8434), obj3);
  }
  ...
  if (tmp29Result) {
    ...
    tmp29Result = tmp29(tmp2(8434), obj4);
  }
