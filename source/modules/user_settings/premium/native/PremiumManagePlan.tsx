...
// Dependencies: [5, 32, 19, 17, 3931, 1903, 3932, 3935, 3936, 6782, 6797, 5779, 676, 5316, 4268, 1905, 21, 3, 4285, 712, 1480, 4827, 5257, 4281, 1236, 5140, 1348, 5649, 7553, 5669, 589, 3996, 4130, 691, 4604, 5637, 7295, 6787, 698, 3930, 38, 5776, 12683, 12684, 7528, 7538, 7311, 4695, 7517, 7558, 7557, 4800, 8547, 12604, 1974, 5356, 4706, 1297, 7626, 1609, 7561, 6781, 4711, 5798, 8089, 12646, 12627, 1414, 4684, 7514, 5934, 7559, 12661, 2]
// Exports: default

// Module 12682 (ManagePlanHeader)
...
function ManagePlanHeader() {
  ...
  obj[2] = callback3(_require(5257).ArrowLargeLeftIcon, { size: "md" });
  const items = [callback3(_require(4827).PressableOpacity, obj), , ];
...
function FractionalPremiumCredits(durationText) {
  ...
  if (showPremiumFeaturesCard) {
    ...
    showPremiumFeaturesCard = callback3(tmp(8547), obj);
  }
  ...
  if (hasUnactivatedUnits) {
    if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
      ...
      let tmp8Result = tmp8(tmp9(4281).Text, obj12);
    }
    items4[1] = tmp8Result;
    obj10[1] = items4;
    items3[1] = tmp4(tmp5, obj10);
    obj4[4] = items3;
    const items5 = [tmp4(require(5356) /* PressableCard */.Card, obj4), , ];
    const obj13 = { style: null, children: null };
    ...
    if (hasUnactivatedUnits) {
      if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
        ...
        const items6 = [tmp8(tmp9(4281).Text, obj17), ];
        ...
        if (tmp8Result) {
          ...
          tmp8Result = tmp8(tmp9(4281).Text, obj18);
        }
      ...
      if (hasUnactivatedUnits) {
        if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
          ...
          obj21[1] = tmp8(tmp9(4281).Text, obj22);
      ...
      obj24[1] = tmp8(tmp9(4281).Text, obj25);
    ...
    tmp8Result2 = tmp8(tmp9(4281).Text, obj26);
  }
...
let closure_35 = createCacheKey.createStyles((arg0) => {
  ...
  if (arg0) {
    ...
    DIVIDER_BACKGROUND = require(5140) /* result */.DIVIDER_BACKGROUND;
  }
...
export default function PremiumManagePlan() {
  ...
  const tmp12 = importDefault(6781)({ forceFetch: true });
  importDefault(4711)(() => {
    ...
    if (!tmp5) {
      const premiumSubscriptionPlans = navigation(5798).fetchPremiumSubscriptionPlans();
      const obj3 = navigation(5798);
    }
  });
  let obj7 = navigation(8089);
  let isInReverseTrial = obj7.useIsInReverseTrial();
  const tmp9 = callback2(obj4.useStateFromStoresArray(items2, () => {
    const items = [reset.getPremiumTypeSubscription(), reset.hasFetchedSubscriptions()];
    return items;
  }), 2);
  const tmp15 = importDefault(12646);
  let obj8 = navigation(3930);
  ...
  if (isInReverseTrial) {
    ...
    isInReverseTrial = tmp29(tmp2(8547), obj3);
  }
  ...
  if (tmp29Result) {
    ...
    tmp29Result = tmp29(tmp2(8547), obj4);
  }
  ...
  if (tmp27Result) {
    ...
    obj7[2] = tmp10;
    const items10 = [tmp29(tmp2(7517), obj7), ];
    obj8 = { style: null, subscription: null };
    obj8[0] = tmp.billingInfo;
    obj8[1] = tmp10;
    items10[1] = tmp29(tmp2(7557), obj8);
    obj6[0] = items10;
  ...
  tmp15Result = importDefault(12646)(tmp12.endsAt, navigation(12646).CountDownMessageTypes.SHORT_TIME);
  ...
  items9[6] = closure_29(importDefault(12661), obj10);
  obj1[1] = items9;
