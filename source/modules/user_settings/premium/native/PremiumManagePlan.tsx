...
// Dependencies: [5, 32, 19, 17, 3902, 1874, 3903, 3906, 3907, 6755, 6770, 5752, 676, 5262, 4238, 1876, 21, 3, 4255, 712, 1480, 4797, 5227, 4251, 1236, 5110, 1348, 5595, 7525, 5615, 589, 3967, 4101, 691, 4574, 5583, 7267, 6760, 698, 3901, 38, 5749, 12646, 12647, 7500, 7510, 7283, 4665, 7489, 7530, 7529, 4770, 8406, 12567, 1945, 5302, 4676, 1297, 7598, 1581, 7533, 6754, 4681, 5771, 7948, 12609, 12590, 1414, 4654, 7486, 5907, 7531, 12624, 2]
// Exports: default

// Module 12645 (ManagePlanHeader)
...
function ManagePlanHeader() {
  ...
  obj[2] = callback3(_require(5227).ArrowLargeLeftIcon, { size: "md" });
  const items = [callback3(_require(4797).PressableOpacity, obj), , ];
...
function FractionalPremiumCredits(durationText) {
  ...
  if (showPremiumFeaturesCard) {
    ...
    showPremiumFeaturesCard = callback3(tmp(8406), obj);
  }
  ...
  items1[1] = callback3(require(4251) /* Text */.Text, obj2);
  ...
  const items4 = [callback3(require(4251) /* Text */.Text, obj11), ];
  if (hasUnactivatedUnits) {
    if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
      ...
      let tmp8Result = tmp8(tmp9(4251).Text, obj12);
    }
    items4[1] = tmp8Result;
    obj10[1] = items4;
    items3[1] = tmp4(tmp5, obj10);
    obj4[4] = items3;
    const items5 = [tmp4(require(5302) /* PressableCard */.Card, obj4), , ];
    const obj13 = { style: null, children: null };
    ...
    if (hasUnactivatedUnits) {
      if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
        ...
        const items6 = [tmp8(tmp9(4251).Text, obj17), ];
        ...
        if (tmp8Result) {
          ...
          tmp8Result = tmp8(tmp9(4251).Text, obj18);
        }
      ...
      if (hasUnactivatedUnits) {
        if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
          ...
          obj21[1] = tmp8(tmp9(4251).Text, obj22);
      ...
      obj24[1] = tmp8(tmp9(4251).Text, obj25);
    ...
    tmp8Result2 = tmp8(tmp9(4251).Text, obj26);
  }
  ...
  tmp8Result = tmp8(tmp9(4251).Text, obj27);
}
...
let closure_35 = createCacheKey.createStyles((arg0) => {
  ...
  if (arg0) {
    ...
    DIVIDER_BACKGROUND = require(5110) /* result */.DIVIDER_BACKGROUND;
  }
...
export default function PremiumManagePlan() {
  ...
  const tmp12 = importDefault(6754)({ forceFetch: true });
  importDefault(4681)(() => {
    ...
    if (!tmp5) {
      const premiumSubscriptionPlans = navigation(5771).fetchPremiumSubscriptionPlans();
      const obj3 = navigation(5771);
    }
  });
  let obj7 = navigation(7948);
  let isInReverseTrial = obj7.useIsInReverseTrial();
  const tmp9 = callback2(obj4.useStateFromStoresArray(items2, () => {
    const items = [reset.getPremiumTypeSubscription(), reset.hasFetchedSubscriptions()];
    return items;
  }), 2);
  const tmp15 = importDefault(12609);
  let obj8 = navigation(3901);
  ...
  if (isInReverseTrial) {
    ...
    isInReverseTrial = tmp29(tmp2(8406), obj3);
  }
  ...
  if (tmp29Result) {
    ...
    tmp29Result = tmp29(tmp2(8406), obj4);
  }
  ...
  if (tmp27Result) {
    ...
    obj7[2] = tmp10;
    const items10 = [tmp29(tmp2(7489), obj7), ];
    obj8 = { style: null, subscription: null };
    obj8[0] = tmp.billingInfo;
    obj8[1] = tmp10;
    items10[1] = tmp29(tmp2(7529), obj8);
    obj6[0] = items10;
  ...
  tmp15Result = importDefault(12609)(tmp12.endsAt, navigation(12609).CountDownMessageTypes.SHORT_TIME);
  ...
  items9[6] = closure_29(importDefault(12624), obj10);
  obj1[1] = items9;
