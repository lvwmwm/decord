...
// Dependencies: [5, 32, 19, 17, 3840, 1874, 3841, 3844, 3845, 5852, 6331, 5676, 676, 5186, 4176, 1876, 21, 3, 4193, 712, 1480, 4721, 5151, 4189, 1236, 5034, 1348, 5519, 6550, 5539, 589, 3905, 4039, 691, 4513, 5507, 6298, 6555, 698, 3839, 38, 5673, 12548, 12549, 6525, 6535, 6316, 4604, 6514, 6560, 6554, 4709, 9334, 12465, 1945, 5226, 4615, 1297, 6631, 1581, 6563, 5851, 4620, 6304, 7846, 12511, 12488, 1414, 4593, 6508, 6509, 6561, 12526, 2]
// Exports: default
...
function ManagePlanHeader() {
  ...
  obj[2] = callback3(_require(5151).ArrowLargeLeftIcon, { size: "md" });
  const items = [callback3(_require(4721).PressableOpacity, obj), , ];
...
function FractionalPremiumCredits(durationText) {
  ...
  if (showPremiumFeaturesCard) {
    ...
    showPremiumFeaturesCard = callback3(tmp(9334), obj);
  }
  ...
  items1[1] = callback3(require(4189) /* Text */.Text, obj2);
  ...
  const items4 = [callback3(require(4189) /* Text */.Text, obj11), ];
  if (hasUnactivatedUnits) {
    if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
      ...
      let tmp8Result = tmp8(tmp9(4189).Text, obj12);
    }
    items4[1] = tmp8Result;
    obj10[1] = items4;
    items3[1] = tmp4(tmp5, obj10);
    obj4[4] = items3;
    const items5 = [tmp4(require(5226) /* PressableCard */.Card, obj4), , ];
    const obj13 = { style: null, children: null };
    ...
    if (hasUnactivatedUnits) {
      if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
        ...
        const items6 = [tmp8(tmp9(4189).Text, obj17), ];
        ...
        if (tmp8Result) {
          ...
          tmp8Result = tmp8(tmp9(4189).Text, obj18);
        }
      ...
      if (hasUnactivatedUnits) {
        if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
          ...
          obj21[1] = tmp8(tmp9(4189).Text, obj22);
      ...
      obj24[1] = tmp8(tmp9(4189).Text, obj25);
    ...
    tmp8Result2 = tmp8(tmp9(4189).Text, obj26);
  }
  ...
  tmp8Result = tmp8(tmp9(4189).Text, obj27);
}
...
export default function PremiumManagePlan() {
  ...
  const tmp12 = importDefault(5851)({ forceFetch: true });
  importDefault(4620)(() => {
    ...
    if (!tmp5) {
      const premiumSubscriptionPlans = navigation(6304).fetchPremiumSubscriptionPlans();
      const obj3 = navigation(6304);
    }
  });
  let obj7 = navigation(7846);
  let isInReverseTrial = obj7.useIsInReverseTrial();
  const tmp9 = callback2(obj4.useStateFromStoresArray(items2, () => {
    const items = [reset.getPremiumTypeSubscription(), reset.hasFetchedSubscriptions()];
    return items;
  }), 2);
  const tmp15 = importDefault(12511);
  let obj8 = navigation(3839);
  ...
  if (isInReverseTrial) {
    ...
    isInReverseTrial = tmp29(tmp2(9334), obj3);
  }
  ...
  if (tmp29Result) {
    ...
    tmp29Result = tmp29(tmp2(9334), obj4);
  }
  ...
  if (tmp27Result) {
    ...
    obj7[2] = tmp10;
    const items10 = [tmp29(tmp2(6514), obj7), ];
    obj8 = { style: null, subscription: null };
    obj8[0] = tmp.billingInfo;
    obj8[1] = tmp10;
    items10[1] = tmp29(tmp2(6554), obj8);
    obj6[0] = items10;
  ...
  tmp15Result = importDefault(12511)(tmp12.endsAt, navigation(12511).CountDownMessageTypes.SHORT_TIME);
  ...
  items9[6] = closure_29(importDefault(12526), obj10);
  obj1[1] = items9;
