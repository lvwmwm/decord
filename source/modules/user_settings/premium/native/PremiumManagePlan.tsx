...
// Dependencies: [5, 32, 19, 17, 3948, 1903, 3949, 3952, 3953, 6801, 6816, 5798, 676, 5332, 4285, 1905, 21, 3, 4302, 712, 1480, 4844, 5273, 4298, 1236, 5157, 1348, 5668, 7572, 5688, 589, 4013, 4147, 691, 4621, 5656, 7314, 6806, 698, 3947, 38, 5795, 12698, 12699, 7547, 7557, 7330, 4712, 7536, 7577, 7576, 4817, 8564, 12619, 1974, 5375, 4723, 1297, 7645, 1609, 7580, 6800, 4728, 5817, 8106, 12661, 12642, 1414, 4701, 7533, 5953, 7578, 12676, 2]
// Exports: default

// Module 12697 (ManagePlanHeader)
...
function ManagePlanHeader() {
  ...
  obj[2] = callback3(_require(5273).ArrowLargeLeftIcon, { size: "md" });
  const items = [callback3(_require(4844).PressableOpacity, obj), , ];
  ...
  items[1] = callback3(_require(4298).Text, obj1);
...
function FractionalPremiumCredits(durationText) {
  ...
  if (showPremiumFeaturesCard) {
    ...
    showPremiumFeaturesCard = callback3(tmp(8564), obj);
  }
  ...
  const items1 = [callback3(require(4298) /* Text */.Text, obj1), , ];
  ...
  items1[1] = callback3(require(4298) /* Text */.Text, obj2);
  ...
  const items4 = [callback3(require(4298) /* Text */.Text, obj11), ];
  if (hasUnactivatedUnits) {
    if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
      ...
      let tmp8Result = tmp8(tmp9(4298).Text, obj12);
    }
    items4[1] = tmp8Result;
    obj10[1] = items4;
    items3[1] = tmp4(tmp5, obj10);
    obj4[4] = items3;
    const items5 = [tmp4(require(5375) /* PressableCard */.Card, obj4), , ];
    const obj13 = { style: null, children: null };
    ...
    if (hasUnactivatedUnits) {
      if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
        ...
        const items6 = [tmp8(tmp9(4298).Text, obj17), ];
        ...
        if (tmp8Result) {
          ...
          tmp8Result = tmp8(tmp9(4298).Text, obj18);
        }
      ...
      if (hasUnactivatedUnits) {
        if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
          ...
          obj21[1] = tmp8(tmp9(4298).Text, obj22);
      ...
      obj24[1] = tmp8(tmp9(4298).Text, obj25);
    ...
    tmp8Result2 = tmp8(tmp9(4298).Text, obj26);
  }
  ...
  tmp8Result = tmp8(tmp9(4298).Text, obj27);
}
...
export default function PremiumManagePlan() {
  ...
  const tmp12 = importDefault(6800)({ forceFetch: true });
  importDefault(4728)(() => {
    ...
    if (!tmp5) {
      const premiumSubscriptionPlans = navigation(5817).fetchPremiumSubscriptionPlans();
      const obj3 = navigation(5817);
    }
  });
  let obj7 = navigation(8106);
  let isInReverseTrial = obj7.useIsInReverseTrial();
  const tmp9 = callback2(obj4.useStateFromStoresArray(items2, () => {
    const items = [reset.getPremiumTypeSubscription(), reset.hasFetchedSubscriptions()];
    return items;
  }), 2);
  const tmp15 = importDefault(12661);
  ...
  if (isInReverseTrial) {
    ...
    isInReverseTrial = tmp29(tmp2(8564), obj3);
  }
  ...
  if (tmp29Result) {
    ...
    tmp29Result = tmp29(tmp2(8564), obj4);
  }
  ...
  if (tmp27Result) {
    ...
    obj7[2] = tmp10;
    const items10 = [tmp29(tmp2(7536), obj7), ];
    obj8 = { style: null, subscription: null };
    obj8[0] = tmp.billingInfo;
    obj8[1] = tmp10;
    items10[1] = tmp29(tmp2(7576), obj8);
    obj6[0] = items10;
  ...
  tmp15Result = importDefault(12661)(tmp12.endsAt, navigation(12661).CountDownMessageTypes.SHORT_TIME);
  ...
  items9[6] = closure_29(importDefault(12676), obj10);
  obj1[1] = items9;
