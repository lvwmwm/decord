...
// Dependencies: [5, 32, 19, 17, 4140, 1921, 4141, 4144, 4145, 7332, 7347, 7177, 673, 5558, 4463, 1923, 21, 3, 4481, 709, 1498, 5084, 5583, 4477, 1233, 7102, 13271, 7122, 586, 4205, 1362, 688, 4845, 5553, 10592, 7337, 695, 4139, 38, 7174, 13425, 13426, 13248, 13258, 7999, 4936, 13237, 13275, 13274, 5052, 9292, 13343, 1994, 5562, 4948, 1296, 7982, 1627, 13278, 7331, 4953, 7197, 7996, 13388, 13366, 1429, 4925, 6930, 6935, 13276, 13403, 2]
// Exports: default

// Module 13424 (ManagePlanHeader)
...
import PremiumTypesDefault from "PremiumTypes" /* 9292 */;
import roundFPCountdownUnitsDefault from "roundFPCountdownUnits" /* 13388 */;
import CheckIconDefault from "CheckIcon" /* 13403 */;
...
import closure_13 from "handlePaymentSourceCreateEnd" /* 4141 */;
import closure_14 from "addSubscriptionPlan" /* 4144 */;
import closure_15 from "reset" /* 4145 */;
import closure_16 from "addEntitlement" /* 7332 */;
import closure_17 from "getState" /* 7347 */;
import closure_18 from "updateProduct" /* 7177 */;
...
function ManagePlanHeader() {
  ...
  obj = {
    ...
    children: callback3(_require(5583).ArrowLargeLeftIcon, { size: "md" })
  };
  const items = [callback3(_require(5084).PressableOpacity, obj), , ];
  obj1 = { variant: "redesign/heading-18/bold", accessibilityRole: "header", children: null };
  const intl = _require(1233).intl;
  obj1[2] = intl.string(_require(1233).t["1bX7Tx"]);
...
function FractionalPremiumCredits(durationText) {
  ...
  if (hasUnactivatedUnits) {
    if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
      ...
      let tmp8Result = tmp8(tmp9(4477).Text, obj12);
    }
    items4[1] = tmp8Result;
    obj10[1] = items4;
    ...
    if (hasUnactivatedUnits) {
      if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
        ...
        const items6 = [tmp8(tmp9(4477).Text, obj17), ];
        ...
        if (tmp8Result) {
          ...
          tmp8Result = tmp8(tmp9(4477).Text, obj18);
        }
      ...
      if (hasUnactivatedUnits) {
        if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
          ...
          obj21[1] = tmp8(tmp9(4477).Text, obj22);
      ...
      obj24[1] = tmp8(tmp9(4477).Text, obj25);
    ...
    tmp8Result2 = tmp8(tmp9(4477).Text, obj26);
  }
  ...
  tmp8Result = tmp8(tmp9(4477).Text, obj27);
}
...
export default function PremiumManagePlan() {
  ...
  useMountLayoutEffectDefault(() => {
    ...
    if (!tmp5) {
      const premiumSubscriptionPlans = navigation(7197).fetchPremiumSubscriptionPlans();
      const obj3 = navigation(7197);
    }
  });
  let obj7 = navigation(7996);
  ...
  if (isInReverseTrial) {
    ...
    isInReverseTrial = tmp29(tmp2(9292), obj3);
  }
  ...
  if (tmp29Result) {
    ...
    tmp29Result = tmp29(tmp2(9292), obj4);
  }
  ...
  if (tmp27Result) {
    ...
    obj7[2] = tmp10;
    const items10 = [tmp29(tmp2(13237), obj7), ];
    obj8 = { style: null, subscription: null };
    obj8[0] = tmp.billingInfo;
    obj8[1] = tmp10;
    items10[1] = tmp29(tmp2(13274), obj8);
    obj6[0] = items10;
  ...
  tmp15Result = roundFPCountdownUnitsDefault(tmp12.endsAt, navigation(13388).CountDownMessageTypes.SHORT_TIME);
