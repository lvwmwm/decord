...
// Dependencies: [32, 19, 17, 676, 7441, 1924, 21, 712, 4668, 4761, 691, 4739, 5454, 1236, 7980, 7983, 8017, 8020, 4727, 1625, 10350, 1297, 7177, 1494, 698, 2]
// Exports: default

// Module 12961 (PremiumFeaturesCardBackground)
...
export default function PremiumFeaturesCarouselSection(style) {
  ...
  let callback;
  const tmp = callback4();
  analyticsLocations = first(7177)().analyticsLocations;
  ...
  const items2 = [callback2(analyticsLocations(4739).Text, obj), callback2(PremiumFeaturesCarousel, { width: tmp4[0], onEndReached: callback })];
  obj[2] = items2;
