...
// Dependencies: [32, 19, 17, 676, 7124, 1925, 21, 712, 4446, 4905, 691, 4442, 5458, 1236, 12955, 12956, 12959, 12960, 4880, 1625, 10470, 1297, 5918, 1494, 698, 2]
// Exports: default

// Module 13065 (PremiumFeaturesCardBackground)
...
export default function PremiumFeaturesCarouselSection(style) {
  ...
  let callback;
  const tmp = callback4();
  analyticsLocations = first(5918)().analyticsLocations;
  ...
  const items2 = [callback2(analyticsLocations(4442).Text, obj), callback2(PremiumFeaturesCarousel, { width: tmp4[0], onEndReached: callback })];
  obj[2] = items2;
