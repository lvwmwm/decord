...
// Module 12275 (PremiumFeaturesCardBackground)
...
function CarouselCard(arg0) {
  ...
  const tmp = callback5();
  let obj = { style };
  obj = { INTEGRATION_CREATE: null, ConstraintReasonCode: null, style: tmp.cardTitle, children: title };
...
function PremiumFeaturesCarousel(arg0) {
  ...
  const obj2 = { "Bool(true)": 1627390538, "Bool(true)": 127025433, "Bool(true)": 1346764801, "Bool(true)": true, "Bool(true)": true, "Bool(true)": true, "Bool(true)": true, style: tmp.carousel, contentContainerStyle: { paddingHorizontal: bound, gap: PX_12 }, snapToOffsets: arr.map((arg0, arg1) => arg1 * sum), onScroll: callback, children: arr };
...
obj.carousel = { "Null": true, "Null": true };
