...
// Function ID: 12523
// Name: Header
// Dependencies: [19, 17, 21, 4193, 4129, 5145, 1236, 4039, 6684, 12523, 4189, 2]
// Exports: default
...
export default function Header(style) {
  ...
  const tmp8 = importDefault(5145);
  if (obj3.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(6684);
  } else {
    tmp2Result = tmp2(12523);
  }
  obj[3] = tmp2Result;
  ...
  items1[1] = closure_4(require(4189) /* Text */.Text, obj);
  obj[1] = items1;
