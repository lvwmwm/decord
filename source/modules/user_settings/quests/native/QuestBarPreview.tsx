...
// Dependencies: [19, 17, 21, 4342, 712, 14415, 14497, 14433, 14498, 2]
// Exports: QuestBarPreview

// Module 14496 (QuestBarPreview)
import "noop";
...
export const QuestBarPreview = function QuestBarPreview(quest) {
  ...
  if (null != quest) {
    ...
    if (quest.isVisible) {
      ...
      obj2[0] = quest;
      obj2[1] = jsx(require(14498) /* QuestDockWithGestureAnimation */.QuestDockWithEntranceAnimation, {});
      obj1[1] = jsx(require(14433) /* getDeliveredQuest */.QuestDockQuestProvider, { quest: null, children: null });
      obj[0] = jsx(importDefault(14497).Provider, { value: null, children: null });
      obj[1] = jsx(require(14415) /* QuestDockMode */.QuestDockExternalCoordinationContextProvider, { children: null });
