...
// Dependencies: [19, 4131, 1921, 673, 21, 7863, 586, 4469, 11227, 15097, 1233, 8582, 2]
// Exports: QuestEmbedPreview

// Module 15098 (QuestEmbedPreview)
...
export const QuestEmbedPreview = function QuestEmbedPreview(questId) {
  ...
  if (null != memo1) {
    ...
    obj[0] = memo;
    obj[1] = memo1;
    obj[1] = jsx(stateFromStores(8582), { rowGenerator: null, message: null, horizontalOffset: 0, pointerEvents: "none" });
    tmp6 = jsx(stateFromStores(15097), { rowGenerator: null, message: null, horizontalOffset: 0, pointerEvents: "none" });
    const tmp9 = stateFromStores(15097);
  }
  return tmp6;
};
