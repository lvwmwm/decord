...
// Dependencies: [19, 17, 1303, 1302, 4098, 505, 21, 4285, 712, 5610, 5630, 4218, 589, 4099, 3989, 1856, 14319, 4281, 13755, 1236, 2]

// Module 14318 (QuestThemePicker)
...
class QuestThemePicker {
  constructor() {
    ...
    obj3 = { style: tmp.resetIcon, children: f93802(require("RefreshIcon").RefreshIcon, { size: "sm" }) };
    items8 = [, ];
    items8[0] = f93802(isSynced, obj3);
    ...
    items8[1] = f93802(require("Text").Text, obj4);
    obj2[2] = items8;
    items7[1] = jsxs(useRef, obj2);
    obj1[1] = items7;
    obj[1] = jsxs(isSynced, obj1);
    return f93802(isSynced, obj);
  }
}
