...
class QuestThemePicker {
  constructor() {
    ...
    items4[2] = token1;
    items4[3] = token2;
    memo1 = f106015.useMemo(() => memo.map((theme) => {
      theme = theme.theme;
    ...
    items5[1] = isSynced;
    callback = f106015.useCallback((arg0) => {
    ...
    items7[0] = memo1.map((backgroundColor) => {
      ...
      obj = { hasMaxConnections: 0.0392156862745098, isBoostOnlySubscription: "OPACITY_44", style: tmp.themeLabel, children: backgroundColor.name };
    ...
    obj3 = { style: tmp.resetIcon, children: f106022(arg1(dependencyMap[18]).RefreshIcon, { size: "sm" }) };
    items8 = [, ];
    items8[0] = f106022(View, obj3);
    obj4 = { hasMaxConnections: 0.0392156862745098, isBoostOnlySubscription: "OPACITY_44" };
    obj4.style = tmp.themeLabel;
    intl = arg1(dependencyMap[19]).intl;
    obj4.children = intl.string(arg1(dependencyMap[19]).t.yBZMsQ);
    items8[1] = f106022(arg1(dependencyMap[17]).Text, obj4);
    obj2.children = items8;
    items7[1] = jsxs(closure_5, obj2);
    obj1.children = items7;
    obj.children = jsxs(View, obj1);
    return f106022(View, obj);
  }
}
...
const obj6 = { "Bool(true)": -354484222, "Bool(true)": -352714750, "Bool(true)": 7405570, "Bool(true)": 1358954496, "Bool(true)": 947035355, "Bool(true)": 1577058304, "Bool(true)": 1358954497, borderRadius: importDefault(dependencyMap[8]).radii.round };
obj.resetIcon = obj6;
