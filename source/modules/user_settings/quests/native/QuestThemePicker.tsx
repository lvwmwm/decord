...
// Dependencies: [19, 17, 1303, 1302, 1348, 505, 21, 4344, 712, 5767, 5787, 4277, 589, 1349, 4065, 1903, 14483, 4340, 13913, 1236, 2]
...
class QuestThemePicker {
  constructor() {
    ...
    obj3 = { style: tmp.resetIcon, children: f94660(require("RefreshIcon").RefreshIcon, { size: "sm" }) };
    items8 = [, ];
    items8[0] = f94660(isSynced, obj3);
    ...
    items8[1] = f94660(require("Text").Text, obj4);
    obj2[2] = items8;
    items7[1] = jsxs(useRef, obj2);
    obj1[1] = items7;
    obj[1] = jsxs(isSynced, obj1);
    return f94660(isSynced, obj);
  }
}
