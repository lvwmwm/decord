...
class QuestThemePicker {
  constructor() {
    ...
    items4[2] = token1;
    items4[3] = token2;
    memo1 = f106055.useMemo(() => memo.map((theme) => {
      theme = theme.theme;
    ...
    items5[1] = isSynced;
    callback = f106055.useCallback((arg0) => {
    ...
    items7[0] = memo1.map((backgroundColor) => {
      ...
      obj = { cachedAt: "center", edpbxy: "center", style: tmp.themeLabel, children: backgroundColor.name };
    ...
    obj3 = { style: tmp.resetIcon, children: f106062(arg1(dependencyMap[18]).RefreshIcon, { size: "sm" }) };
    items8 = [, ];
    items8[0] = f106062(View, obj3);
    obj4 = { cachedAt: "center", edpbxy: "center" };
    obj4.style = tmp.themeLabel;
    intl = arg1(dependencyMap[19]).intl;
    obj4.children = intl.string(arg1(dependencyMap[19]).t.yBZMsQ);
    items8[1] = f106062(arg1(dependencyMap[17]).Text, obj4);
    obj2.children = items8;
    items7[1] = jsxs(closure_5, obj2);
    obj1.children = items7;
    obj.children = jsxs(View, obj1);
    return f106062(View, obj);
  }
}
...
obj.resetIcon = { borderRadius: importDefault(dependencyMap[8]).radii.round };
