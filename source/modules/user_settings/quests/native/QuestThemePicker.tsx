...
// Dependencies: [19, 17, 1303, 1302, 4120, 505, 21, 4303, 712, 5728, 5748, 4236, 589, 4121, 4005, 1884, 14418, 4299, 13849, 1236, 2]

// Module 14417 (QuestThemePicker)
...
class QuestThemePicker {
  constructor() {
    ...
    obj3 = { style: tmp.resetIcon, children: f94376(require("RefreshIcon").RefreshIcon, { size: "sm" }) };
    items8 = [, ];
    items8[0] = f94376(isSynced, obj3);
    ...
    items8[1] = f94376(require("Text").Text, obj4);
    obj2[2] = items8;
    items7[1] = jsxs(useRef, obj2);
    obj1[1] = items7;
    obj[1] = jsxs(isSynced, obj1);
    return f94376(isSynced, obj);
  }
}
