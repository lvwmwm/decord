...
// Dependencies: [19, 17, 1303, 1302, 1348, 505, 21, 4303, 712, 5728, 5748, 4236, 589, 1349, 4024, 1903, 14426, 4299, 13856, 1236, 2]

// Module 14425 (QuestThemePicker)
...
class QuestThemePicker {
  constructor() {
    ...
    obj3 = { style: tmp.resetIcon, children: f94441(require("RefreshIcon").RefreshIcon, { size: "sm" }) };
    items8 = [, ];
    items8[0] = f94441(isSynced, obj3);
    ...
    items8[1] = f94441(require("Text").Text, obj4);
    obj2[2] = items8;
    items7[1] = jsxs(useRef, obj2);
    obj1[1] = items7;
    obj[1] = jsxs(isSynced, obj1);
    return f94441(isSynced, obj);
  }
}
