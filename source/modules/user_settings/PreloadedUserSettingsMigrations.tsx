...
// Dependencies: [1348, 653, 11485, 1282, 1333, 5631, 587, 1318, 566, 1313, 1334, 5684, 2]

// Module 13496 (migrateDismissibleContent)
...
function migrateHotspotLocation(userContent, ACTIVITY_BEB_TUTORIAL, ACCOUNT_MULTIACCOUNT_TOOLTIP) {
  const HotspotStore = require(5631) /* HotspotStore */.HotspotStore;
...
obj = {
  ...
  run(userContent) {
    ...
    if (!hasHiddenHotspotResult) {
      const HotspotStore = require(5631) /* HotspotStore */.HotspotStore;
      hasHiddenHotspotResult = HotspotStore.hasHiddenHotspot(require(5631) /* HotspotStore */.HotspotLocations.HUB_SECOND_EMAIL_CONNECTION_UPSELL);
    }
    let flag = false;
    if (hasHiddenHotspotResult) {
...
items[4] = {
  version: 7,
  run(userContent) {
    return migrateHotspotLocation(userContent, require(5631) /* HotspotStore */.HotspotLocations.APPLICATION_COMMAND_TOOLTIP, require(1334) /* DismissibleContent */.DismissibleContent.APPLICATION_COMMAND_TOOLTIP);
  },
  cleanup() {
...
items[5] = {
  version: 8,
  run(userContent) {
    return migrateHotspotLocation(userContent, require(5631) /* HotspotStore */.HotspotLocations.CHANNEL_BANNER_MEMBER_LIST_NOTICE, require(1334) /* DismissibleContent */.DismissibleContent.CHANNELINFO_CHANNELBANNER_NOTICE);
  },
  cleanup() {
...
items[6] = {
  ...
  run(userContent) {
    const HotspotStore = require(5631) /* HotspotStore */.HotspotStore;
    if (HotspotStore.hasHiddenHotspot(require(5631) /* HotspotStore */.HotspotLocations.MULTI_ACCOUNT_TOOLTIP)) {
      const Storage = require(587) /* Storage */.Storage;
      const result = Storage.set(closure_5, "true");
    }
    return migrateHotspotLocation(userContent, require(5631) /* HotspotStore */.HotspotLocations.MULTI_ACCOUNT_TOOLTIP, require(1334) /* DismissibleContent */.DismissibleContent.ACCOUNT_MULTIACCOUNT_TOOLTIP);
  },
  cleanup() {
...
items[7] = {
  version: 10,
  run(userContent) {
    let flag = migrateHotspotLocation(userContent, require(5631) /* HotspotStore */.HotspotLocations.HUB_LINK_CHANNEL_NOTICE, require(1334) /* DismissibleContent */.DismissibleContent.CHANNEL_NOTICE_HUBLINK);
    const Storage = require(587) /* Storage */.Storage;
...
items[8] = {
  ...
  run(userContent) {
    let flag = false;
    if (migrateHotspotLocation(userContent, require(5631) /* HotspotStore */.HotspotLocations.GUILD_EVENT_UPSELL, require(1334) /* DismissibleContent */.DismissibleContent.GUILD_HEADER_EVENT_UPSELL)) {
      flag = true;
    }
    if (migrateHotspotLocation(userContent, require(5631) /* HotspotStore */.HotspotLocations.ANIMATED_GUILD_BANNER_GUILD_HEADER_TOOLTIP, require(1334) /* DismissibleContent */.DismissibleContent.GUILD_HEADER_ANIMATED_GUILD_BANNER)) {
      flag = true;
    }
    return flag;
  },
...
items[11] = {
  version: 14,
  run(userContent) {
    return migrateHotspotLocation(userContent, require(5631) /* HotspotStore */.HotspotLocations.ACTIVITY_BEB_TUTORIAL, require(1334) /* DismissibleContent */.DismissibleContent.ACTIVITIES_TUTORIAL_COACH_MARK);
  },
  cleanup() {
...
items[12] = {
  version: 15,
  run(userContent) {
    return migrateHotspotLocation(userContent, require(5631) /* HotspotStore */.HotspotLocations.NOW_PLAYING_CONSENT_CARD, require(1334) /* DismissibleContent */.DismissibleContent.NOW_PLAYING_CONSENT_CARD);
  },
  cleanup() {
...
items[15] = {
  ...
  run(userContent) {
    let flag = false;
    if (migrateHotspotLocation(userContent, require(5631) /* HotspotStore */.HotspotLocations.GUILD_DELETE_FEEDBACK, require(1334) /* DismissibleContent */.DismissibleContent.GUILD_DELETE_FEEDBACK)) {
      flag = true;
    }
    if (migrateHotspotLocation(userContent, require(5631) /* HotspotStore */.HotspotLocations.GUILD_LEAVE_FEEDBACK, require(1334) /* DismissibleContent */.DismissibleContent.GUILD_LEAVE_FEEDBACK)) {
      flag = true;
    }
    return flag;
  },
