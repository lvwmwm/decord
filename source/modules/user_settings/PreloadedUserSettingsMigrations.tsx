...
// Dependencies: [1391, 676, 11843, 1306, 1376, 5874, 595, 1342, 589, 1337, 1377, 7022, 2]

// Module 13794 (migrateHotspotLocation)
...
function migrateHotspotLocation(userContent, ACTIVITY_BEB_TUTORIAL, ACCOUNT_MULTIACCOUNT_TOOLTIP) {
  const HotspotStore = require(5874) /* HotspotStore */.HotspotStore;
...
let items = [
  ...
  },
  {
    version: 7,
    run(userContent) {
      return migrateHotspotLocation(userContent, require(5874) /* HotspotStore */.HotspotLocations.APPLICATION_COMMAND_TOOLTIP, require(1377) /* DismissibleContent */.DismissibleContent.APPLICATION_COMMAND_TOOLTIP);
    },
    cleanup() {
  ...
  },
  {
    version: 8,
    run(userContent) {
      return migrateHotspotLocation(userContent, require(5874) /* HotspotStore */.HotspotLocations.CHANNEL_BANNER_MEMBER_LIST_NOTICE, require(1377) /* DismissibleContent */.DismissibleContent.CHANNELINFO_CHANNELBANNER_NOTICE);
    },
    cleanup() {
  ...
  },
  {
    ...
    run(userContent) {
      const HotspotStore = require(5874) /* HotspotStore */.HotspotStore;
      if (HotspotStore.hasHiddenHotspot(require(5874) /* HotspotStore */.HotspotLocations.MULTI_ACCOUNT_TOOLTIP)) {
        const Storage = tmp(595).Storage;
        const result = Storage.set(closure_5, "true");
      }
      return migrateHotspotLocation(userContent, require(5874) /* HotspotStore */.HotspotLocations.MULTI_ACCOUNT_TOOLTIP, require(1377) /* DismissibleContent */.DismissibleContent.ACCOUNT_MULTIACCOUNT_TOOLTIP);
    },
    cleanup() {
  ...
  },
  {
    version: 10,
    run(userContent) {
      let flag = migrateHotspotLocation(userContent, require(5874) /* HotspotStore */.HotspotLocations.HUB_LINK_CHANNEL_NOTICE, require(1377) /* DismissibleContent */.DismissibleContent.CHANNEL_NOTICE_HUBLINK);
      const Storage = require(595) /* Storage */.Storage;
  ...
  },
  {
    ...
    run(userContent) {
      let flag = false;
      if (migrateHotspotLocation(userContent, require(5874) /* HotspotStore */.HotspotLocations.GUILD_EVENT_UPSELL, require(1377) /* DismissibleContent */.DismissibleContent.GUILD_HEADER_EVENT_UPSELL)) {
        flag = true;
      }
      if (migrateHotspotLocation(userContent, require(5874) /* HotspotStore */.HotspotLocations.ANIMATED_GUILD_BANNER_GUILD_HEADER_TOOLTIP, require(1377) /* DismissibleContent */.DismissibleContent.GUILD_HEADER_ANIMATED_GUILD_BANNER)) {
        flag = true;
      }
      return flag;
    },
  ...
  },
  {
    version: 14,
    run(userContent) {
      return migrateHotspotLocation(userContent, require(5874) /* HotspotStore */.HotspotLocations.ACTIVITY_BEB_TUTORIAL, require(1377) /* DismissibleContent */.DismissibleContent.ACTIVITIES_TUTORIAL_COACH_MARK);
    },
    cleanup() {
  ...
  },
  {
    version: 15,
    run(userContent) {
      return migrateHotspotLocation(userContent, require(5874) /* HotspotStore */.HotspotLocations.NOW_PLAYING_CONSENT_CARD, require(1377) /* DismissibleContent */.DismissibleContent.NOW_PLAYING_CONSENT_CARD);
    },
    cleanup() {
  ...
  },
  {
    ...
    run(userContent) {
      let flag = false;
      if (migrateHotspotLocation(userContent, require(5874) /* HotspotStore */.HotspotLocations.GUILD_DELETE_FEEDBACK, require(1377) /* DismissibleContent */.DismissibleContent.GUILD_DELETE_FEEDBACK)) {
        flag = true;
      }
      if (migrateHotspotLocation(userContent, require(5874) /* HotspotStore */.HotspotLocations.GUILD_LEAVE_FEEDBACK, require(1377) /* DismissibleContent */.DismissibleContent.GUILD_LEAVE_FEEDBACK)) {
        flag = true;
      }
      return flag;
    },
