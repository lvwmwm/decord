...
// Dependencies: [5, 21, 1480, 12821, 4530, 3889, 1236, 4533, 2741, 4533, 2]
// Exports: default

// Module 13805 (SettingsAgeGroupResetAlert)
...
export default function SettingsAgeGroupResetAlert() {
        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              obj1[0] = outer1_0(12821).resetAgeVerification();
              return obj1;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
            let obj2 = outer1_0(3889);
  ...
  obj[0] = intl.string(_handleConfirm(2741)["bD//cU"]);
  const intl2 = _require(1236).intl;
  obj[1] = intl2.string(_handleConfirm(2741).FbTAmI);
  obj = { children: null };
  let obj1 = {
    variant: "destructive",
  ...
  obj1[2] = intl3.string(_handleConfirm(2741).V822Mp);
  const items = [callback(_require(4533).AlertActionButton, obj1, "confirm"), ];
  let obj2 = { variant: "secondary", text: null };
  const intl4 = _require(1236).intl;
  obj2[1] = intl4.string(_require(1236).t["ETE/oC"]);
  items[1] = callback(_require(4533).AlertActionButton, obj2, "cancel");
  obj[0] = items;
  obj[2] = callback2(_require(4533).AlertActions, obj);
  return callback(_require(4533).AlertModal, obj);
};
