...
// Dependencies: [19, 17, 3998, 1922, 676, 7845, 21, 4342, 712, 14072, 1236, 6080, 589, 8585, 8522, 5435, 4777, 2]

// Module 14071 (RestrictedAccountRedirect)
...
function RestrictedAccountRedirect() {
  ...
  return callback(importDefault(14072), obj);
}
...
const memoResult = importAllResult.memo(() => {
  ...
  let obj1 = require(8585) /* handleOpenEmailVerification */;
  ...
  if (null != bannerText) {
    ...
    if (null != bannerText) {
      ...
      obj1[2] = callback;
      obj[4] = callback(tmp2(4777).Button, obj1);
      tmp14 = callback(tmp2(5435).TableRow, obj);
    }
    items2[1] = tmp14;
    obj[1] = items2;
