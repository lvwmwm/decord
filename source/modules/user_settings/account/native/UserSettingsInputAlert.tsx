...
// Function ID: 14123
// Name: renderContent
// Dependencies: [19, 21, 530, 4775, 4338, 7856, 4795, 5885, 2]

// Module 14122 (renderContent)
...
prototype["renderContent"] = function renderContent() {
  ...
  if (null != this.props.error) {
    ...
    if (tmp7) {
      ...
      obj[1] = helpText;
      tmp7 = callback(tmp5(4338).Text, obj);
    }
    const items = [tmp7, ];
...
prototype["render"] = function render() {
  ...
  const tmp5 = callback(importDefault(4795), obj);
  let tmpResult = tmp5;
  if (useKeyboardAwareWrapper) {
    obj = { children: null };
    obj[0] = tmp5;
    tmpResult = callback(importDefault(5885), obj);
  }
  return tmpResult;
};
