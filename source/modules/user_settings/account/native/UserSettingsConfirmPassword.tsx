...
// Dependencies: [5, 32, 19, 17, 1874, 676, 21, 4285, 712, 6787, 589, 5922, 4184, 1208, 1236, 8325, 4281, 8276, 8280, 4695, 2]
// Exports: UserSettingsConfirmPasswordWrapped

// Module 8324 (UserSettingsConfirmPasswordWrapped)
import ME from "ME";
  ...
  if (null != stateFromStores) {
    ...
    if (null != obj1) {
      ...
      if (null == obj1.getFieldMessage("password")) {
        ...
        obj4[0] = tmp.hint;
        obj4[1] = obj1.message;
        tmp19Result = tmp19(tmp20(8280), obj4);
      }
    }
