...
// Dependencies: [5, 32, 19, 17, 1903, 676, 21, 4285, 712, 6799, 589, 5934, 4184, 1208, 1236, 8437, 4281, 8388, 8392, 4695, 2]
// Exports: UserSettingsConfirmPasswordWrapped

// Module 8436 (UserSettingsConfirmPasswordWrapped)
import ME from "ME";
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  if (null != stateFromStores) {
    ...
    if (!hideUnverifiedBanner) {
      tmp15 = callback(importDefault(8437), {});
    }
    ...
    obj3[9] = fieldMessage;
    items3[2] = callback(importDefault(8388), obj3);
    ...
    if (null != obj1) {
      ...
      if (null == obj1.getFieldMessage("password")) {
        ...
        obj4[0] = tmp.hint;
        obj4[1] = obj1.message;
        tmp19Result = tmp19(tmp20(8392), obj4);
      }
    }
    ...
    obj6[3] = handleSubmit;
    obj6[4] = tmp7;
    obj5[1] = callback(tmp3(4695).Button, obj6);
    ...
    tmp20 = importDefault;
    const tmp21 = importDefault(8388);
  }
  return tmp13Result;
});
