...
// Dependencies: [5, 32, 19, 17, 1922, 676, 21, 4344, 712, 6919, 589, 6054, 4243, 1208, 1236, 8559, 4340, 8510, 8514, 4754, 2]
// Exports: UserSettingsConfirmPasswordWrapped

// Module 8558 (UserSettingsConfirmPasswordWrapped)
import ME from "ME";
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  if (null != stateFromStores) {
    ...
    if (!hideUnverifiedBanner) {
      tmp15 = callback(importDefault(8559), {});
    }
    ...
    obj3[9] = fieldMessage;
    items3[2] = callback(importDefault(8510), obj3);
    ...
    tmp20 = importDefault;
    const tmp21 = importDefault(8510);
  }
  return tmp13Result;
});
