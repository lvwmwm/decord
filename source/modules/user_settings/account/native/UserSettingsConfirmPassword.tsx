...
// Dependencies: [5, 32, 19, 17, 1874, 676, 21, 4255, 712, 6772, 589, 5907, 4154, 1208, 1236, 8297, 4251, 8248, 8252, 4665, 2]
// Exports: UserSettingsConfirmPasswordWrapped

// Module 8296 (UserSettingsConfirmPasswordWrapped)
import ME from "ME";
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  if (null != stateFromStores) {
    ...
    if (!hideUnverifiedBanner) {
      tmp15 = callback(importDefault(8297), {});
    }
    ...
    obj3[9] = fieldMessage;
    items3[2] = callback(importDefault(8248), obj3);
    ...
    if (null != obj1) {
      ...
      if (null == obj1.getFieldMessage("password")) {
        ...
        obj4[0] = tmp.hint;
        obj4[1] = obj1.message;
        tmp19Result = tmp19(tmp20(8252), obj4);
      }
    }
    ...
    obj6[3] = handleSubmit;
    obj6[4] = tmp7;
    obj5[1] = callback(tmp3(4665).Button, obj6);
    ...
    tmp20 = importDefault;
    const tmp21 = importDefault(8248);
  }
  return tmp13Result;
});
