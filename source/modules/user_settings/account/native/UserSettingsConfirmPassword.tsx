...
// Dependencies: [5, 32, 19, 17, 1922, 676, 21, 4661, 712, 7385, 589, 7357, 4273, 1208, 1236, 8624, 4734, 8575, 8579, 4745, 2]
// Exports: UserSettingsConfirmPasswordWrapped

// Module 8623 (UserSettingsConfirmPasswordWrapped)
import ME from "ME";
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  if (null != stateFromStores) {
    ...
    if (!hideUnverifiedBanner) {
      tmp15 = callback(importDefault(8624), {});
    }
    ...
    obj3[9] = fieldMessage;
    items3[2] = callback(importDefault(8575), obj3);
    ...
    tmp20 = importDefault;
    const tmp21 = importDefault(8575);
  }
  return tmp13Result;
});
