...
// Dependencies: [19, 17, 13958, 21, 4302, 712, 1480, 13956, 5327, 4712, 1236, 13959, 5269, 13960, 13963, 13964, 13966, 5656, 8418, 5723, 2]
// Exports: TwoFASetupModalScreen, default

// Module 13957 (TwoFAModalSetupSections)
...
export default function TwoFASetupModal(initialRouteName) {
  ...
  return callback(require(5723) /* NavigationStack */.Navigator, obj);
};
