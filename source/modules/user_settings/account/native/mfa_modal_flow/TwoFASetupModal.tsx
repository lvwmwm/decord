...
// Dependencies: [19, 17, 13900, 21, 4255, 712, 1480, 13898, 5243, 4666, 1236, 13901, 5209, 13902, 13905, 13906, 13908, 5569, 9381, 5636, 2]
// Exports: TwoFASetupModalScreen, default

// Module 13899 (TwoFAModalSetupSections)
...
export default function TwoFASetupModal(initialRouteName) {
  ...
  let obj = {
    ...
    screens: importDefault(5569)(() => {
      let obj = callback(9381);
      callback = obj.generateTotpSecret();
      obj = {};
      obj = { headerLeft: null, headerTitle: null, render: null };
      obj[0] = callback(5209).getHeaderCloseButton(callback2(13898).close);
      obj[1] = function headerTitle() {
        return callback3(callback(13901).PageMarker, { currentPage: dependencyMap2[constants.LANDING], numMarkers: Object.keys(dependencyMap2).length - 1 });
      };
      obj[2] = function render() {
        return callback3(callback2(13902), {});
      };
      obj[constants.LANDING] = obj;
      obj[constants.SCAN] = {
        headerTitle() {
          return callback3(callback(13901).PageMarker, { currentPage: dependencyMap2[constants.SCAN], numMarkers: Object.keys(dependencyMap2).length - 1 });
        },
        render() {
      ...
      obj[constants.ENTER_CODE] = {
        headerTitle() {
          return callback3(callback(13901).PageMarker, { currentPage: dependencyMap2[constants.ENTER_CODE], numMarkers: Object.keys(dependencyMap2).length - 1 });
        },
        render() {
      ...
      const obj4 = callback(5209);
      obj1[0] = callback(5209).getHeaderCloseButton(callback2(13898).close);
      obj1[1] = function headerTitle() {
        return null;
      };
      obj1[2] = function render() {
        return callback3(callback2(13908), {});
      };
...
export const TwoFASetupModalScreen = function TwoFASetupModalScreen(children) {
  ...
  if (name === TwoFAModalSetupSections.ENTER_CODE) {
    ...
    obj1[1] = stringResult;
    obj1 = tmp8(tmp2(4666).Button, obj1);
    obj[2] = obj1;
    closure_6(tmp2(5243).SafeAreaPaddingView, obj);
  }
};
