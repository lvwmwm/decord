...
// Dependencies: [19, 17, 14095, 21, 4344, 712, 1499, 14093, 5367, 4754, 1236, 14096, 5309, 14097, 14100, 14101, 14103, 5755, 8523, 5822, 2]
// Exports: TwoFASetupModalScreen, default

// Module 14094 (TwoFAModalSetupSections)
...
export default function TwoFASetupModal(initialRouteName) {
  ...
  let obj = {
    ...
    screens: importDefault(5755)(() => {
      let obj = callback(8523);
      callback = obj.generateTotpSecret();
      obj = {};
      obj = { headerLeft: null, headerTitle: null, render: null };
      obj[0] = callback(5309).getHeaderCloseButton(callback2(14093).close);
      ...
      const obj4 = callback(5309);
      obj1[0] = callback(5309).getHeaderCloseButton(callback2(14093).close);
  ...
  return callback(require(5822) /* NavigationStack */.Navigator, obj);
};
export const TwoFASetupModalScreen = function TwoFASetupModalScreen(children) {
  ...
  if (name === TwoFAModalSetupSections.ENTER_CODE) {
    ...
    obj1[1] = stringResult;
    obj1 = tmp8(tmp2(4754).Button, obj1);
    obj[2] = obj1;
    closure_6(tmp2(5367).SafeAreaPaddingView, obj);
  }
};
