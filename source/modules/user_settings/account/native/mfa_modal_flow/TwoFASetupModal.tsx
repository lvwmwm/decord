...
// Dependencies: [19, 17, 13944, 21, 4285, 712, 1480, 13942, 5311, 4695, 1236, 13945, 5253, 13946, 13949, 13950, 13952, 5637, 8401, 5704, 2]
// Exports: TwoFASetupModalScreen, default

// Module 13943 (TwoFAModalSetupSections)
...
export default function TwoFASetupModal(initialRouteName) {
  ...
  let obj = {
    ...
    screens: importDefault(5637)(() => {
      let obj = callback(8401);
      callback = obj.generateTotpSecret();
      obj = {};
      obj = { headerLeft: null, headerTitle: null, render: null };
      obj[0] = callback(5253).getHeaderCloseButton(callback2(13942).close);
      obj[1] = function headerTitle() {
        return callback3(callback(13945).PageMarker, { currentPage: dependencyMap2[constants.LANDING], numMarkers: Object.keys(dependencyMap2).length - 1 });
      };
      obj[2] = function render() {
        return callback3(callback2(13946), {});
      };
      obj[constants.LANDING] = obj;
      obj[constants.SCAN] = {
        headerTitle() {
          return callback3(callback(13945).PageMarker, { currentPage: dependencyMap2[constants.SCAN], numMarkers: Object.keys(dependencyMap2).length - 1 });
        },
        render() {
      ...
      obj[constants.ENTER_CODE] = {
        headerTitle() {
          return callback3(callback(13945).PageMarker, { currentPage: dependencyMap2[constants.ENTER_CODE], numMarkers: Object.keys(dependencyMap2).length - 1 });
        },
        render() {
      ...
      const obj4 = callback(5253);
      obj1[0] = callback(5253).getHeaderCloseButton(callback2(13942).close);
      obj1[1] = function headerTitle() {
        return null;
      };
      obj1[2] = function render() {
        return callback3(callback2(13952), {});
      };
  ...
  return callback(require(5704) /* NavigationStack */.Navigator, obj);
};
export const TwoFASetupModalScreen = function TwoFASetupModalScreen(children) {
  ...
  if (name === TwoFAModalSetupSections.ENTER_CODE) {
    ...
    obj1[1] = stringResult;
    obj1 = tmp8(tmp2(4695).Button, obj1);
    obj[2] = obj1;
    closure_6(tmp2(5311).SafeAreaPaddingView, obj);
  }
};
