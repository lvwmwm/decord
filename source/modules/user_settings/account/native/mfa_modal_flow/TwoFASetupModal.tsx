...
// Dependencies: [19, 17, 14104, 21, 4342, 712, 1499, 14102, 5368, 4755, 1236, 14105, 5310, 14106, 14109, 14110, 14112, 5756, 8527, 5823, 2]
// Exports: TwoFASetupModalScreen, default

// Module 14103 (TwoFAModalSetupSections)
...
export default function TwoFASetupModal(initialRouteName) {
  ...
  let obj = {
    ...
    screens: importDefault(5756)(() => {
      let obj = callback(8527);
...
export const TwoFASetupModalScreen = function TwoFASetupModalScreen(children) {
  ...
  if (name === TwoFAModalSetupSections.ENTER_CODE) {
    ...
    obj1[1] = stringResult;
    obj1 = tmp8(tmp2(4755).Button, obj1);
    obj[2] = obj1;
    closure_6(tmp2(5368).SafeAreaPaddingView, obj);
  }
};
