...
// Function ID: 105705
// Name: TwoFASetupScan
// Dependencies: [57, 31, 33, 4165, 689, 5525, 13796, 13792, 5155, 1273, 1212, 4161, 4695, 2]
// Exports: default

// Module 13798 (TwoFASetupScan)
...
export default function TwoFASetupScan(totpSecret) {
  ...
  callback = React.useCallback(() => {
    dependencyMap(true);
    totpSecret(5525).copy(totpSecret.replace(/[^a-zA-Z0-9]/g, ""));
  }, items);
  let obj = totpSecret(13796);
  ...
  items2[2] = callback2(totpSecret(4161).Text, { variant: "text-md/bold", style: { textAlign: "center" }, children: totpSecret });
  ...
  items2[3] = callback2(totpSecret(4695).PressableOpacity, obj3);
  obj.children = items2;
  obj.children = closure_5(totpSecret(5155).SafeAreaPaddingView, obj);
  return callback2(totpSecret(13792).TwoFASetupModalScreen, obj);
};
