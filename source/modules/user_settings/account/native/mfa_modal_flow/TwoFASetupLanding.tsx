...
// Dependencies: [19, 17, 21, 4303, 14041, 14037, 5328, 14042, 4299, 1236, 2]
// Exports: default

// Module 14040 (TwoFASetupLanding)
import "noop";
...
export default function TwoFASetupLanding() {
  ...
  return callback(require(14037) /* TwoFAModalSetupSections */.TwoFASetupModalScreen, obj);
};
