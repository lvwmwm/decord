...
// Dependencies: [19, 17, 21, 4344, 14098, 14094, 5367, 14099, 4340, 1236, 2]
// Exports: default

// Module 14097 (TwoFASetupLanding)
import "noop";
...
export default function TwoFASetupLanding() {
  ...
  items[1] = callback(require(4340) /* Text */.Heading, obj3);
  ...
  items[2] = callback(require(4340) /* Text */.Text, obj4);
  obj1[2] = items;
  obj[1] = callback2(require(5367) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj1);
  obj[0] = callback(closure_4, obj);
  return callback(require(14094) /* TwoFAModalSetupSections */.TwoFASetupModalScreen, obj);
};
