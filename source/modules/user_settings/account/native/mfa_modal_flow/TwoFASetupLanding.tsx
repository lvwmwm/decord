...
// Dependencies: [19, 17, 21, 4302, 13961, 13957, 5327, 13962, 4298, 1236, 2]
// Exports: default

// Module 13960 (TwoFASetupLanding)
import "noop";
...
export default function TwoFASetupLanding() {
  ...
  items[1] = callback(require(4298) /* Text */.Heading, obj3);
  ...
  return callback(require(13957) /* TwoFAModalSetupSections */.TwoFASetupModalScreen, obj);
};
