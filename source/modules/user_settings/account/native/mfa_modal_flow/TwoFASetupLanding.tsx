...
// Dependencies: [19, 17, 21, 4342, 14107, 14103, 5368, 14108, 4338, 1236, 2]
// Exports: default

// Module 14106 (TwoFASetupLanding)
import "noop";
...
export default function TwoFASetupLanding() {
  ...
  items[1] = callback(require(4338) /* Text */.Heading, obj3);
  ...
  return callback(require(14103) /* TwoFAModalSetupSections */.TwoFASetupModalScreen, obj);
};
