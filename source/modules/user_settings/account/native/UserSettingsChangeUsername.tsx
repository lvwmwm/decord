...
// Dependencies: [5, 57, 31, 27, 1850, 653, 33, 4165, 689, 4364, 13769, 4161, 1212, 1456, 566, 3811, 13770, 6484, 9202, 507, 1457, 9094, 6706, 9206, 8972, 2]
// Exports: default

// Module 13768 (UsernameStatusMessage)
import ME from "ME";
...
function UsernameStatusMessage(showHint) {
  ...
  const match = showHint(4364).match(showHint.usernameStatus);
  let obj = { type: showHint(13769).NameValidationState.ERROR };
  const P = showHint(4364).P;
  obj.message = P.select();
  const str = showHint(4364);
  obj = { type: showHint(13769).NameValidationState.AVAILABLE };
  const P2 = showHint(4364).P;
