...
function PasswordlessUpsell() {
  ...
  const items2 = [callback2(_require(4755).Button, obj9), callback2(View, {})];
  obj8[1] = items2;
  ...
  obj[1] = callback2(_require(5416).Card, obj);
...
const memoResult = importAllResult.memo(() => {
  ...
  const tmp5Result = require(9005) /* useSegmentedControlState */;
  ...
  const items1 = [callback2(View, { style: tmp.controlContainer, onLayout: callback, children: callback2(require(9191) /* SegmentedControl */.SegmentedControl, { state: segmentedControlState }) }), ];
  const obj4 = { style: tmp.controlContainer, onLayout: callback, children: callback2(require(9191) /* SegmentedControl */.SegmentedControl, { state: segmentedControlState }) };
  items1[1] = callback2(View, { style: tmp.pageContainer, children: callback2(require(9611) /* SegmentedControlPage */.SegmentedControlPages, { state: segmentedControlState }) });
  obj3[0] = items1;
