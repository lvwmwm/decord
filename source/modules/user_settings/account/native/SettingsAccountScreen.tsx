...
// Module 13508 (PasswordlessUpsell)
function PasswordlessUpsell() {
  ...
  const obj5 = { style: {} };
  const obj6 = { cachedAt: "construct", edpbxy: "apply" };
...
let obj = {};
obj = { 9223372036854775807: true, 9223372036854775807: true, 0: true, borderColor: importDefault(dependencyMap[10]).colors.REDESIGN_INPUT_CONTROL_SELECTED, borderRadius: importDefault(dependencyMap[10]).radii.lg };
