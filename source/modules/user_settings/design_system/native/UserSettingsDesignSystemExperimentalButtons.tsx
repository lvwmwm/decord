...
// Dependencies: [19, 17, 21, 3959, 712, 8557, 4663, 5634, 5308, 5901, 4204, 4665, 4251, 3967, 4676, 7752, 5906, 2]
// Exports: default

// Module 14661 (UserSettingsDesignSystemExperimentalButtons)
import "noop";
...
export default function UserSettingsDesignSystemExperimentalButtons() {
  ...
  obj5[2] = importDefault(5308);
  obj3[1] = callback(require(8557) /* TwinButtons */.HeaderButton, obj5);
  obj2[3] = callback(closure_3, obj3);
  const items = [callback(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj2), , , , , , ];
  ...
  obj8[3] = importDefault(5901);
  const items1 = [callback(require(8557) /* TwinButtons */.InputButton, obj8), ];
  const obj9 = {
    onPress() {
  ...
  obj9[3] = importDefault(4204);
  items1[1] = callback(require(8557) /* TwinButtons */.InputButton, obj9);
  obj7[1] = items1;
  obj6[3] = callback2(require(4663) /* Stack */.Stack, obj7);
  items[1] = callback(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj6);
  ...
  const items2 = [
    callback(require(4665) /* Button */.Button, {
      onPress() {
  ...
  obj11[0] = items2;
  obj10[3] = callback2(require(8557) /* TwinButtons */.TwinButtons, obj11);
  items[2] = callback(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj10);
  ...
  obj17[1] = callback(require(4251) /* Text */.Text, { variant: "text-md/semibold", children: "This is a custom button" });
  obj16[1] = callback(closure_3, obj17);
  obj15[1] = callback(require(8557) /* TwinButtons */.PressableScale, obj16);
  obj14[3] = callback(closure_3, obj15);
  items[3] = callback(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj14);
  ...
  items[4] = callback(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj18);
  ...
  obj21[0] = importDefault(5906);
  obj21[4] = function onPress() {

  };
  obj20[4] = callback(require(7752) /* RowButtonWrapper */.RowButton, obj21);
  obj19[1] = callback(importDefault(4676), obj20);
  items[5] = callback(require(3967) /* ManaContext */.ThemeContextProvider, obj19);
  ...
  items[6] = callback(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj22);
  obj1[2] = items;
  obj[1] = callback2(require(4663) /* Stack */.Stack, obj1);
  ...
  obj23[0] = importDefault(5906);
  obj23[1] = function onPress() {

  };
  obj23[4] = collapsibleFloatingActionButtonState;
  items3[1] = callback(require(8557) /* TwinButtons */.CollapsibleFloatingActionButton, obj23);
  obj[0] = items3;
