...
// Dependencies: [19, 17, 21, 3897, 712, 8240, 4602, 5558, 5232, 8299, 4142, 4604, 4189, 3905, 4615, 7642, 9021, 2]
// Exports: default
...
export default function UserSettingsDesignSystemExperimentalButtons() {
  ...
  obj5[2] = importDefault(5232);
  obj3[1] = callback(require(8240) /* TwinButtons */.HeaderButton, obj5);
  obj2[3] = callback(closure_3, obj3);
  const items = [callback(require(5558) /* TableRowGroupTitle */.TableRowGroup, obj2), , , , , , ];
  ...
  obj8[3] = importDefault(8299);
  const items1 = [callback(require(8240) /* TwinButtons */.InputButton, obj8), ];
  const obj9 = {
    onPress() {
  ...
  obj9[3] = importDefault(4142);
  items1[1] = callback(require(8240) /* TwinButtons */.InputButton, obj9);
  obj7[1] = items1;
  obj6[3] = callback2(require(4602) /* Stack */.Stack, obj7);
  items[1] = callback(require(5558) /* TableRowGroupTitle */.TableRowGroup, obj6);
  ...
  obj11[0] = items2;
  obj10[3] = callback2(require(8240) /* TwinButtons */.TwinButtons, obj11);
  items[2] = callback(require(5558) /* TableRowGroupTitle */.TableRowGroup, obj10);
  ...
  obj17[1] = callback(require(4189) /* Text */.Text, { variant: "text-md/semibold", children: "This is a custom button" });
  obj16[1] = callback(closure_3, obj17);
  obj15[1] = callback(require(8240) /* TwinButtons */.PressableScale, obj16);
  obj14[3] = callback(closure_3, obj15);
  items[3] = callback(require(5558) /* TableRowGroupTitle */.TableRowGroup, obj14);
  ...
  items[4] = callback(require(5558) /* TableRowGroupTitle */.TableRowGroup, obj18);
  ...
  obj21[0] = importDefault(9021);
  obj21[4] = function onPress() {

  };
  obj20[4] = callback(require(7642) /* RowButtonWrapper */.RowButton, obj21);
  obj19[1] = callback(importDefault(4615), obj20);
  items[5] = callback(require(3905) /* ManaContext */.ThemeContextProvider, obj19);
  ...
  items[6] = callback(require(5558) /* TableRowGroupTitle */.TableRowGroup, obj22);
  obj1[2] = items;
  obj[1] = callback2(require(4602) /* Stack */.Stack, obj1);
  ...
  obj23[0] = importDefault(9021);
  obj23[1] = function onPress() {

  };
  obj23[4] = collapsibleFloatingActionButtonState;
  items3[1] = callback(require(8240) /* TwinButtons */.CollapsibleFloatingActionButton, obj23);
  obj[0] = items3;
