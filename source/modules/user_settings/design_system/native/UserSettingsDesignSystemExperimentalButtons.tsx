...
// Dependencies: [19, 17, 21, 4097, 712, 8811, 4733, 6286, 6298, 7352, 4323, 4745, 4734, 4104, 4756, 8086, 7356, 2]
// Exports: default

// Module 14909 (UserSettingsDesignSystemExperimentalButtons)
import "noop";
...
export default function UserSettingsDesignSystemExperimentalButtons() {
  ...
  obj5[2] = importDefault(6298);
  obj3[1] = callback(require(8811) /* TwinButtons */.HeaderButton, obj5);
  obj2[3] = callback(closure_3, obj3);
  const items = [callback(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj2), , , , , , ];
  ...
  obj8[3] = importDefault(7352);
  const items1 = [callback(require(8811) /* TwinButtons */.InputButton, obj8), ];
  const obj9 = {
    onPress() {
  ...
  obj9[3] = importDefault(4323);
  items1[1] = callback(require(8811) /* TwinButtons */.InputButton, obj9);
  obj7[1] = items1;
  obj6[3] = callback2(require(4733) /* Stack */.Stack, obj7);
  items[1] = callback(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj6);
  ...
  const items2 = [
    callback(require(4745) /* Button */.Button, {
      onPress() {
  ...
  obj11[0] = items2;
  obj10[3] = callback2(require(8811) /* TwinButtons */.TwinButtons, obj11);
  items[2] = callback(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj10);
  ...
  obj17[1] = callback(require(4734) /* Text */.Text, { variant: "text-md/semibold", children: "This is a custom button" });
  obj16[1] = callback(closure_3, obj17);
  obj15[1] = callback(require(8811) /* TwinButtons */.PressableScale, obj16);
  obj14[3] = callback(closure_3, obj15);
  items[3] = callback(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj14);
  ...
  items[4] = callback(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj18);
  ...
  obj21[0] = importDefault(7356);
  obj21[4] = function onPress() {

  };
  obj20[4] = callback(require(8086) /* RowButtonWrapper */.RowButton, obj21);
  obj19[1] = callback(importDefault(4756), obj20);
  items[5] = callback(require(4104) /* ManaContext */.ThemeContextProvider, obj19);
  ...
  items[6] = callback(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj22);
  obj1[2] = items;
  obj[1] = callback2(require(4733) /* Stack */.Stack, obj1);
  ...
  obj23[0] = importDefault(7356);
  obj23[1] = function onPress() {

  };
  obj23[4] = collapsibleFloatingActionButtonState;
  items3[1] = callback(require(8811) /* TwinButtons */.CollapsibleFloatingActionButton, obj23);
  obj[0] = items3;
