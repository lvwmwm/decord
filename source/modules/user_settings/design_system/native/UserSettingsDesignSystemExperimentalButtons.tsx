...
// Dependencies: [19, 17, 21, 4065, 712, 8708, 4752, 5806, 5421, 6048, 4293, 4754, 4340, 4072, 4765, 8011, 6053, 2]
// Exports: default

// Module 14855 (UserSettingsDesignSystemExperimentalButtons)
import "noop";
...
export default function UserSettingsDesignSystemExperimentalButtons() {
  ...
  obj5[2] = importDefault(5421);
  obj3[1] = callback(require(8708) /* TwinButtons */.HeaderButton, obj5);
  obj2[3] = callback(closure_3, obj3);
  const items = [callback(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj2), , , , , , ];
  ...
  obj8[3] = importDefault(6048);
  const items1 = [callback(require(8708) /* TwinButtons */.InputButton, obj8), ];
  const obj9 = {
    onPress() {
  ...
  obj9[3] = importDefault(4293);
  items1[1] = callback(require(8708) /* TwinButtons */.InputButton, obj9);
  obj7[1] = items1;
  obj6[3] = callback2(require(4752) /* Stack */.Stack, obj7);
  items[1] = callback(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj6);
  ...
  const items2 = [
    callback(require(4754) /* Button */.Button, {
      onPress() {
  ...
  obj11[0] = items2;
  obj10[3] = callback2(require(8708) /* TwinButtons */.TwinButtons, obj11);
  items[2] = callback(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj10);
  ...
  obj17[1] = callback(require(4340) /* Text */.Text, { variant: "text-md/semibold", children: "This is a custom button" });
  obj16[1] = callback(closure_3, obj17);
  obj15[1] = callback(require(8708) /* TwinButtons */.PressableScale, obj16);
  obj14[3] = callback(closure_3, obj15);
  items[3] = callback(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj14);
  ...
  items[4] = callback(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj18);
  ...
  obj21[0] = importDefault(6053);
  obj21[4] = function onPress() {

  };
  obj20[4] = callback(require(8011) /* RowButtonWrapper */.RowButton, obj21);
  obj19[1] = callback(importDefault(4765), obj20);
  ...
  items[6] = callback(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj22);
  obj1[2] = items;
  obj[1] = callback2(require(4752) /* Stack */.Stack, obj1);
  ...
  obj23[0] = importDefault(6053);
  obj23[1] = function onPress() {

  };
  obj23[4] = collapsibleFloatingActionButtonState;
  items3[1] = callback(require(8708) /* TwinButtons */.CollapsibleFloatingActionButton, obj23);
  obj[0] = items3;
