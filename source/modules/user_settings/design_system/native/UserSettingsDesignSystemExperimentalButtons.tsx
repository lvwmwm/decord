...
// Dependencies: [19, 17, 21, 4065, 712, 8726, 4775, 5828, 5443, 6071, 4291, 4777, 4338, 4072, 4788, 8036, 6076, 2]
// Exports: default

// Module 14869 (UserSettingsDesignSystemExperimentalButtons)
import "noop";
...
export default function UserSettingsDesignSystemExperimentalButtons() {
  ...
  obj5[2] = importDefault(5443);
  obj3[1] = callback(require(8726) /* TwinButtons */.HeaderButton, obj5);
  obj2[3] = callback(closure_3, obj3);
  const items = [callback(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj2), , , , , , ];
  ...
  obj8[3] = importDefault(6071);
  const items1 = [callback(require(8726) /* TwinButtons */.InputButton, obj8), ];
  const obj9 = {
    onPress() {
  ...
  items1[1] = callback(require(8726) /* TwinButtons */.InputButton, obj9);
  obj7[1] = items1;
  obj6[3] = callback2(require(4775) /* Stack */.Stack, obj7);
  items[1] = callback(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj6);
  ...
  const items2 = [
    callback(require(4777) /* Button */.Button, {
      onPress() {
  ...
  obj11[0] = items2;
  obj10[3] = callback2(require(8726) /* TwinButtons */.TwinButtons, obj11);
  items[2] = callback(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj10);
  ...
  obj15[1] = callback(require(8726) /* TwinButtons */.PressableScale, obj16);
  obj14[3] = callback(closure_3, obj15);
  items[3] = callback(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj14);
  ...
  items[4] = callback(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj18);
  ...
  obj21[0] = importDefault(6076);
  obj21[4] = function onPress() {

  };
  obj20[4] = callback(require(8036) /* RowButtonWrapper */.RowButton, obj21);
  obj19[1] = callback(importDefault(4788), obj20);
  ...
  items[6] = callback(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj22);
  obj1[2] = items;
  obj[1] = callback2(require(4775) /* Stack */.Stack, obj1);
  ...
  obj23[0] = importDefault(6076);
  obj23[1] = function onPress() {

  };
  obj23[4] = collapsibleFloatingActionButtonState;
  items3[1] = callback(require(8726) /* TwinButtons */.CollapsibleFloatingActionButton, obj23);
  obj[0] = items3;
