...
export default function UserSettingsDesignSystemExperimentalButtons() {
  ...
  obj3.children = callback(require(8174) /* TwinButtons */.HeaderButton, obj5);
  obj2.children = callback(closure_3, obj3);
  const items = [callback(require(5501) /* TableRowGroupTitle */.TableRowGroup, obj2), , , , , , ];
  ...
  const obj8 = {
    ...
    size: "lg",
    text: "Search",
    icon: importDefault(8233),
    isRound: true
  };
  const items1 = [callback(require(8174) /* TwinButtons */.InputButton, obj8), ];
  const obj9 = {
    onPress() {
    ...
    icon: importDefault(4080),
    iconPosition: "end",
    accessibilityLabel: "Copy, http://discord.com/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
  };
  items1[1] = callback(require(8174) /* TwinButtons */.InputButton, obj9);
  obj7.children = items1;
  obj6.children = callback2(require(4542) /* Stack */.Stack, obj7);
  items[1] = callback(require(5501) /* TableRowGroupTitle */.TableRowGroup, obj6);
  ...
  const obj11 = {};
  const items2 = [
    callback(require(4544) /* Button */.Button, {
      onPress() {
  ...
  obj10.children = callback2(require(8174) /* TwinButtons */.TwinButtons, obj11);
  items[2] = callback(require(5501) /* TableRowGroupTitle */.TableRowGroup, obj10);
  ...
  const obj17 = { style: { borderColor: "pink", borderWidth: 1, borderRadius: 8, padding: 12 }, children: callback(require(4127) /* Text */.Text, { variant: "text-md/semibold", children: "This is a custom button" }) };
  obj16.children = callback(closure_3, obj17);
  obj15.children = callback(require(8174) /* TwinButtons */.PressableScale, obj16);
  obj14.children = callback(closure_3, obj15);
  items[3] = callback(require(5501) /* TableRowGroupTitle */.TableRowGroup, obj14);
  ...
  items[4] = callback(require(5501) /* TableRowGroupTitle */.TableRowGroup, obj18);
  ...
  obj20.children = callback(require(7578) /* RowButtonWrapper */.RowButton, obj21);
  obj19.children = callback(importDefault(4555), obj20);
  items[5] = callback(require(3843) /* ManaContext */.ThemeContextProvider, obj19);
  ...
  items[6] = callback(require(5501) /* TableRowGroupTitle */.TableRowGroup, obj22);
  obj1.children = items;
  ...
  items3[1] = callback(require(8174) /* TwinButtons */.CollapsibleFloatingActionButton, obj23);
  obj.children = items3;
