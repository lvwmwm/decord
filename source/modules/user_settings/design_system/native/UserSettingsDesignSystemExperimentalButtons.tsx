...
// Dependencies: [31, 27, 33, 3834, 689, 8416, 4541, 5501, 5172, 5787, 4079, 4543, 4126, 3842, 4554, 7639, 5792, 2]
// Exports: default

// Module 14481 (UserSettingsDesignSystemExperimentalButtons)
import "result";
...
export default function UserSettingsDesignSystemExperimentalButtons() {
  ...
  obj3.children = callback(require(8416) /* TwinButtons */.HeaderButton, obj5);
  ...
  const items1 = [callback(require(8416) /* TwinButtons */.InputButton, obj8), ];
  const obj9 = {
    onPress() {
  ...
  items1[1] = callback(require(8416) /* TwinButtons */.InputButton, obj9);
  ...
  obj10.children = callback2(require(8416) /* TwinButtons */.TwinButtons, obj11);
  ...
  obj15.children = callback(require(8416) /* TwinButtons */.PressableScale, obj16);
  ...
  obj20.children = callback(require(7639) /* RowButtonWrapper */.RowButton, obj21);
  ...
  items3[1] = callback(require(8416) /* TwinButtons */.CollapsibleFloatingActionButton, obj23);
  obj.children = items3;
