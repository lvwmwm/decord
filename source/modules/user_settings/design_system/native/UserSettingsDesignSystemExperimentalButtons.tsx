...
// Dependencies: [19, 17, 21, 3959, 712, 8547, 4664, 5620, 5294, 5906, 4204, 4666, 4251, 3967, 4677, 7768, 5911, 2]
// Exports: default

// Module 14648 (UserSettingsDesignSystemExperimentalButtons)
import "noop";
...
export default function UserSettingsDesignSystemExperimentalButtons() {
  ...
  obj5[2] = importDefault(5294);
  obj3[1] = callback(require(8547) /* TwinButtons */.HeaderButton, obj5);
  obj2[3] = callback(closure_3, obj3);
  const items = [callback(require(5620) /* TableRowGroupTitle */.TableRowGroup, obj2), , , , , , ];
  ...
  obj8[3] = importDefault(5906);
  const items1 = [callback(require(8547) /* TwinButtons */.InputButton, obj8), ];
  const obj9 = {
    onPress() {
  ...
  items1[1] = callback(require(8547) /* TwinButtons */.InputButton, obj9);
  obj7[1] = items1;
  obj6[3] = callback2(require(4664) /* Stack */.Stack, obj7);
  items[1] = callback(require(5620) /* TableRowGroupTitle */.TableRowGroup, obj6);
  ...
  obj11[0] = items2;
  obj10[3] = callback2(require(8547) /* TwinButtons */.TwinButtons, obj11);
  items[2] = callback(require(5620) /* TableRowGroupTitle */.TableRowGroup, obj10);
  ...
  obj15[1] = callback(require(8547) /* TwinButtons */.PressableScale, obj16);
  obj14[3] = callback(closure_3, obj15);
  items[3] = callback(require(5620) /* TableRowGroupTitle */.TableRowGroup, obj14);
  ...
  items[4] = callback(require(5620) /* TableRowGroupTitle */.TableRowGroup, obj18);
  ...
  obj21[0] = importDefault(5911);
  obj21[4] = function onPress() {

  };
  obj20[4] = callback(require(7768) /* RowButtonWrapper */.RowButton, obj21);
  obj19[1] = callback(importDefault(4677), obj20);
  ...
  items[6] = callback(require(5620) /* TableRowGroupTitle */.TableRowGroup, obj22);
  obj1[2] = items;
  obj[1] = callback2(require(4664) /* Stack */.Stack, obj1);
  ...
  obj23[0] = importDefault(5911);
  obj23[1] = function onPress() {

  };
  obj23[4] = collapsibleFloatingActionButtonState;
  items3[1] = callback(require(8547) /* TwinButtons */.CollapsibleFloatingActionButton, obj23);
  obj[0] = items3;
