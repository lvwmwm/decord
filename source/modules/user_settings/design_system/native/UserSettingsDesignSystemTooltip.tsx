...
// Function ID: 15167
// Name: Content
// Dependencies: [32, 19, 17, 21, 4445, 8534, 8896, 4880, 5945, 4441, 5505, 5892, 2]
// Exports: default, useCanRotate

// Module 15166 (Content)
...
function Content() {
  ...
  obj = { children: null };
  obj = { style: tmp.container, children: callback2(first1(4880).Button, obj1) };
  obj1 = {
    ref,
    onPress() {
  ...
  const items2 = [callback2(View, obj), callback2(first1(5945).TableSwitchRow, { label: "Unlock Orientation", value: tmp9, onValueChange: tmp10 }), callback2(first1(5945).TableSwitchRow, { label: "Enable Bottom Position", value: first2, onValueChange: tmp11[1] }), callback2(TooltipNote, {})];
  obj[0] = items2;
