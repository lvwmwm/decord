...
// Function ID: 14806
// Name: Content
// Dependencies: [32, 19, 17, 21, 4303, 8895, 8654, 4714, 5768, 4299, 5328, 5715, 2]
// Exports: default, useCanRotate

// Module 14805 (Content)
...
function Content() {
  ...
  const items2 = [callback2(View, obj), callback2(first1(5768).TableSwitchRow, { label: "Unlock Orientation", value: tmp9, onValueChange: tmp10 }), callback2(first1(5768).TableSwitchRow, { label: "Enable Bottom Position", value: first2, onValueChange: tmp11[1] }), callback2(TooltipNote, {})];
  obj[0] = items2;
...
export default function UserSettingsDesignSystemTooltip() {
  ...
  obj[2] = callback2(require(5715) /* Layer */.LayerScope, obj);
