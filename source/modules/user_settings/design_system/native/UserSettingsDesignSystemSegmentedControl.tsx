...
// Dependencies: [32, 19, 17, 21, 4380, 712, 4376, 9103, 4813, 9289, 12174, 4815, 1351, 2]
// Exports: default

// Module 15011 (UserSettingsDesignSystemSegmentedControl)
...
export default function UserSettingsDesignSystemSegmentedControl() {
  ...
  let items1 = [callback3(first(9289).SegmentedControl, { state: segmentedControlState }), callback3(first(12174).SegmentedControlPages, { state: segmentedControlState }), ];
  const obj2 = { spacing: 8, direction: "horizontal", children: null };
  const items2 = [
    callback3(first(4815).Button, {
      text: "Add Tab",
      variant: "active",
      size: "sm",
      disabled: first >= 5,
  ...
  obj2[2] = items2;
  items1[2] = callback2(first(4813).Stack, obj2);
  obj1[1] = items1;
  obj[2] = callback2(first(4813).Stack, obj1);
