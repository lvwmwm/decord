...
// Dependencies: [32, 19, 17, 21, 4302, 712, 4298, 8896, 4710, 9081, 9497, 4712, 4014, 2]
// Exports: default

// Module 14723 (UserSettingsDesignSystemSegmentedControl)
...
export default function UserSettingsDesignSystemSegmentedControl() {
  ...
  let items1 = [callback3(first(9081).SegmentedControl, { state: segmentedControlState }), callback3(first(9497).SegmentedControlPages, { state: segmentedControlState }), ];
  const obj2 = { spacing: 8, direction: "horizontal", children: null };
  const items2 = [
    callback3(first(4712).Button, {
      text: "Add Tab",
      variant: "active",
      size: "sm",
      disabled: first >= 5,
  ...
  obj2[2] = items2;
  items1[2] = callback2(first(4710).Stack, obj2);
  obj1[1] = items1;
  obj[2] = callback2(first(4710).Stack, obj1);
