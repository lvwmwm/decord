...
// Function ID: 14679
// Name: SampleCard
// Dependencies: [19, 17, 21, 4255, 1297, 5632, 4664, 5288, 4251, 12128, 1419, 13302, 11828, 10088, 11829, 8091, 2]
// Exports: default

// Module 14678 (SampleCard)
import "noop";
...
function SampleCard(arg0) {
  ...
  const tmp3 = callback(require(4664) /* Stack */.Stack, { spacing: 16, children });
  ...
  items[1] = tmp2Result;
  obj[1] = items;
  return closure_6(require(5288) /* PressableCard */.Card, obj);
}
...
export default function UserSettingsDesignSystemPile() {
  ...
  obj = {
    ...
    children: items.map((children) => {
      ...
      items[1] = callback2(callback(12128).AvatarPile, obj);
      obj[0] = items;
      return callback3(callback(4664).Stack, obj, children);
    })
  };
  ...
  items[2] = callback(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items[1] = callback2(callback(13302).AvatarDuoPile, obj);
      obj[0] = items;
      return callback3(callback(4664).Stack, obj, children);
    })
  });
  ...
  items[3] = callback(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      obj[2] = items2;
      items[1] = callback3(callback(13302).AvatarDuoPile, obj);
      obj[0] = items;
      return callback3(callback(4664).Stack, obj, children);
    })
  });
  ...
  items[4] = callback(SampleCard, {
    ...
    children: items1.map((size) => {
      ...
      items[1] = callback2(callback(11828).GuildIconPile, obj);
      obj[0] = items;
      return callback3(callback(4664).Stack, obj, size);
    })
  });
  ...
  items1[1] = items2.map((arg0) => {
    ...
    items1[1] = callback2(callback(10088).Pile, obj);
    obj = { "aria-label": null, shape: null, size: 48, gap: 2, depthX: null, depthY: null, children: null };
    tmp4Result = tmp4(11829);
    obj[0] = tmp4Result.getListSummaryLabel(closure_11, closure_11.length);
    obj[1] = callback(8091).CutoutShape.RoundedRect;
    obj[4] = tmp;
    obj[5] = tmp2;
    obj[6] = closure_11.map((value) => {
      const obj = { value, size: null };
      obj[1] = callback(5632).GuildIconSizes.LARGE;
      return callback3(callback2(5632), obj, arg1);
    });
    items1[2] = callback2(callback(10088).Pile, obj);
    obj[0] = items1;
    return closure_6(callback(4664).Stack, obj, "" + tmp + "," + tmp2);
  });
  obj5[2] = items1;
