...
// Function ID: 14654
// Name: items
// Dependencies: [19, 21, 14651, 705, 5323, 5322, 7749, 2]
// Exports: default
...
export default function UserSettingsDesignSystemButtonActionSheet() {
  ...
  items = [callback(require(5322) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: "Button Settings" }), ];
  obj = { children: null };
  ...
  obj[2] = items.map((label) => {
    ...
    const items = [callback(value(7749).FormRadioRow, obj), callback(value(7749).FormDivider, {})];
    obj[0] = items;
    return callback2(React.Fragment, obj, value);
  });
  const items1 = [callback(require(7749) /* Form */.FormSection, obj), , , , , ];
  const obj1 = { title: "Button Scale", accessibilityRole: "radiogroup", children: null };
  const items2 = [
    callback(require(7749) /* Form */.FormHint, { children: "The amount in pixels that the button width will scale when pressed" }),
    items1.map((label) => {
      const value = label.value;
      let obj = { children: null };
      obj = {
  ...
  obj1[2] = items2;
  items1[1] = callback2(require(7749) /* Form */.FormSection, obj1);
  const obj2 = { children: null };
  obj2[0] = callback(require(7749) /* Form */.FormSwitchRow, {
    label: "Disabled",
  ...
  items1[2] = callback(require(7749) /* Form */.FormSection, obj2);
  const obj4 = { children: null };
  obj4[0] = callback(require(7749) /* Form */.FormSwitchRow, {
    label: "Show Icons",
    value: tmp.showIcon,
    onValueChange(arg0) {
  ...
  items1[3] = callback(require(7749) /* Form */.FormSection, obj4);
  const obj6 = { title: "Icon Position", accessibilityRole: "radiogroup", children: null };
  const items3 = [callback(require(7749) /* Form */.FormHint, { children: "Whether to show the example icon on the left (default) or right." }), ];
  ...
  items3[1] = items4.map((label) => {
    ...
    const items = [callback(label(7749).FormRadioRow, obj), callback(label(7749).FormDivider, {})];
    obj[0] = items;
    return callback2(React.Fragment, obj, label);
  });
  obj6[2] = items3;
  items1[4] = callback2(require(7749) /* Form */.FormSection, obj6);
  const obj7 = { title: "Loading state", accessibilityRole: "radiogroup", children: null };
  const items5 = [callback(require(7749) /* Form */.FormHint, { children: "Whether or not to show a loading state when a button is pressed" }), ];
  ...
  items5[1] = items6.map((arg0) => {
    ...
    const items = [closure_4(tmp(7749).FormRadioRow, obj), closure_4(tmp(7749).FormDivider, {})];
    obj[0] = items;
    let str2 = "disabled";
    if (true === arg0) {
      str2 = "enabled";
  ...
  obj7[2] = items5;
  items1[5] = callback2(require(7749) /* Form */.FormSection, obj7);
  obj[0] = items1;
  items[1] = callback2(require(7749) /* Form */.Form, obj);
  obj[0] = items;
