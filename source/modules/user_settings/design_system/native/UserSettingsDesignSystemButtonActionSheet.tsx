...
// Function ID: 110862
// Name: items
// Dependencies: [31, 33, 14527, 682, 5221, 5220, 7611, 2]
// Exports: default
...
export default function UserSettingsDesignSystemButtonActionSheet() {
  ...
  let obj = {};
  items = [callback(require(5220) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: "Button Settings" }), ];
  obj = {};
  obj = {
    title: "Button Size",
    ...
    children: items.map((label) => {
      ...
      const items = [callback(value(7611).FormRadioRow, obj), callback(value(7611).FormDivider, {})];
      obj.children = items;
      return callback2(React.Fragment, obj, value);
    })
  };
  const items1 = [callback(require(7611) /* Form */.FormSection, obj), , , , , ];
  const obj1 = { title: "Button Scale", accessibilityRole: "radiogroup" };
  const items2 = [
    callback(require(7611) /* Form */.FormHint, { children: "The amount in pixels that the button width will scale when pressed" }),
    items1.map((label) => {
      const value = label.value;
      let obj = {};
      obj = {
  ...
  items1[1] = callback2(require(7611) /* Form */.FormSection, obj1);
  const obj2 = {
    children: callback(require(7611) /* Form */.FormSwitchRow, {
      label: "Disabled",
  ...
  items1[2] = callback(require(7611) /* Form */.FormSection, obj2);
  const obj4 = {
    children: callback(require(7611) /* Form */.FormSwitchRow, {
      label: "Show Icons",
      value: tmp.showIcon,
  ...
  items1[3] = callback(require(7611) /* Form */.FormSection, obj4);
  const obj6 = { title: "Icon Position", accessibilityRole: "radiogroup" };
  const items3 = [callback(require(7611) /* Form */.FormHint, { children: "Whether to show the example icon on the left (default) or right." }), ];
  ...
  items3[1] = items4.map((label) => {
    ...
    const items = [callback(label(7611).FormRadioRow, obj), callback(label(7611).FormDivider, {})];
    obj.children = items;
    return callback2(React.Fragment, obj, label);
  });
  obj6.children = items3;
  items1[4] = callback2(require(7611) /* Form */.FormSection, obj6);
  const obj7 = { title: "Loading state", accessibilityRole: "radiogroup" };
  const items5 = [callback(require(7611) /* Form */.FormHint, { children: "Whether or not to show a loading state when a button is pressed" }), ];
  ...
  items5[1] = items6.map((arg0) => {
    ...
    const items = [callback(tmp(7611).FormRadioRow, obj), callback(tmp(7611).FormDivider, {})];
    obj.children = items;
    let str2 = "disabled";
    if (true === arg0) {
      str2 = "enabled";
  ...
  items1[5] = callback2(require(7611) /* Form */.FormSection, obj7);
  obj.children = items1;
  items[1] = callback2(require(7611) /* Form */.Form, obj);
  obj.children = items;
