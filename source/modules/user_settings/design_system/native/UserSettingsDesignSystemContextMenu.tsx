...
// Dependencies: [19, 17, 21, 12186, 8484, 8119, 8661, 4307, 14877, 14878, 11010, 4342, 712, 12, 8647, 4755, 5416, 4338, 2]
// Exports: default

// Module 14876 (DemoContextMenu)
...
export default function UserSettingsDesignSystemAlertModal() {
  ...
  obj1[1] = items2;
  items1[1] = callback2(require(5416) /* PressableCard */.Card, obj1);
  ...
  obj2[1] = items3;
  items1[2] = callback2(require(5416) /* PressableCard */.Card, obj2);
  ...
  obj3[1] = items4;
  items1[3] = callback2(require(5416) /* PressableCard */.Card, obj3);
  ...
  obj5[1] = items5;
  items1[4] = callback2(require(5416) /* PressableCard */.Card, obj5);
  ...
  obj10[1] = items6;
  items1[5] = callback2(require(5416) /* PressableCard */.Card, obj10);
  obj[1] = items1;
