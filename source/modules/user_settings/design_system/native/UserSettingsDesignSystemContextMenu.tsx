...
// Dependencies: [19, 17, 21, 12057, 8375, 8014, 8552, 4267, 14728, 14729, 10970, 4302, 712, 12, 8538, 4712, 5375, 4298, 2]
// Exports: default

// Module 14727 (DemoContextMenu)
    ...
    if (noop > 1) {
      ...
      let mapped = arr.map(() => {
        ...
        return Array.from(obj).map((arg0, arg1) => {
          const obj = { label: length[arg1 % length.length], IconComponent: "a", iconSource: "<string:4009755510>", variant: "isArray", action: "accessible" };
