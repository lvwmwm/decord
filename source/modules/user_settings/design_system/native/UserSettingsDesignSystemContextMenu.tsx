...
// Dependencies: [19, 17, 21, 12036, 8246, 7884, 8422, 4250, 14694, 14695, 10951, 4285, 712, 12, 8408, 4695, 5317, 4281, 2]
// Exports: default

// Module 14693 (DemoContextMenu)
    ...
    if (noop > 1) {
      ...
      let mapped = arr.map(() => {
        ...
        return Array.from(obj).map((arg0, arg1) => {
          const obj = { label: length[arg1 % length.length], IconComponent: "a", iconSource: "t", variant: "a", action: "isArray" };
