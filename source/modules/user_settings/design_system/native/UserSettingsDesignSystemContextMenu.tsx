...
// Dependencies: [19, 17, 21, 12042, 8358, 7997, 8535, 4250, 14712, 14713, 10955, 4285, 712, 12, 8521, 4695, 5356, 4281, 2]
// Exports: default

// Module 14711 (DemoContextMenu)
...
export default function UserSettingsDesignSystemAlertModal() {
  ...
  obj1[1] = items2;
  items1[1] = callback2(require(5356) /* PressableCard */.Card, obj1);
  ...
  obj2[1] = items3;
  items1[2] = callback2(require(5356) /* PressableCard */.Card, obj2);
  ...
  obj3[1] = items4;
  items1[3] = callback2(require(5356) /* PressableCard */.Card, obj3);
  ...
  obj5[1] = items5;
  items1[4] = callback2(require(5356) /* PressableCard */.Card, obj5);
  ...
  obj10[1] = items6;
  items1[5] = callback2(require(5356) /* PressableCard */.Card, obj10);
  obj[1] = items1;
