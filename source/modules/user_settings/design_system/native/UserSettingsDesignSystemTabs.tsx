...
export default function UserSettingsDesignSystemTabs() {
  ...
  obj3[2] = items4;
  items3[2] = closure_7(first(4598).Stack, obj3);
  const obj6 = { children: null };
  const items5 = [callback2(first(5555).TableSwitchRow, { start: true, label: "Enable Grow", value: first1, onValueChange: tmp4[1] }), callback2(first(5555).TableSwitchRow, { label: "Enable Counts", value: tmp7, onValueChange: tmp8 }), callback2(first(5555).TableSwitchRow, { end: true, label: "Enable Overflow Gradient", value: first2, onValueChange: tmp9[1] })];
  obj6[0] = items5;
  items3[3] = closure_7(closure_5, obj6);
  obj2[1] = items3;
  obj[2] = closure_7(first(4598).Stack, obj2);
