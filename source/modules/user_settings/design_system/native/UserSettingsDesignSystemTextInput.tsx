...
// Function ID: 14816
// Name: Sample
// Dependencies: [32, 19, 17, 21, 4303, 712, 5376, 4712, 7792, 4818, 13431, 5397, 5396, 7978, 4299, 4809, 7793, 5994, 7753, 6013, 5995, 4714, 4271, 8499, 2]
// Exports: default
...
function InputUsername(defaultValue) {
  ...
  return closure_6(require(7792) /* TextInput */.TextInput, obj);
}
function GhostInputUsername(defaultValue) {
  ...
  return closure_6(require(13431) /* GhostInput */.GhostInput, obj);
}
...
export default function UserSettingsDesignSystemTextInput() {
  ...
  const items2 = [callback2(require(7792) /* TextInput */.TextInput, { label: "Small", size: "sm" }), callback2(require(7792) /* TextInput */.TextInput, { label: "Medium", size: "md" }), callback2(require(7792) /* TextInput */.TextInput, { label: "Large (default)" })];
  obj1[0] = items2;
  ...
  const items3 = [callback2(require(7792) /* TextInput */.TextInput, obj3), , , ];
  const obj4 = { label: "Trailing icon", trailingIcon: null };
  obj4[1] = require(4809) /* TextIcon */.TextIcon;
  items3[1] = callback2(require(7792) /* TextInput */.TextInput, obj4);
  items3[2] = callback2(require(7792) /* TextInput */.TextInput, { label: "Leading text", leadingText: "To:" });
  const obj5 = { label: "Combination", leadingText: "To:", trailingIcon: null };
  obj5[2] = require(4818) /* AtIcon */.AtIcon;
  items3[3] = callback2(require(7792) /* TextInput */.TextInput, obj5);
  obj2[0] = items3;
  ...
  const items4 = [callback2(require(5994) /* SearchField */.SearchField, { size: "md", isRound: true }), ];
  const obj9 = { icon: null, accessibilityLabel: "Settings", onPress: null, variant: "tertiary" };
  obj9[0] = callback2(require(6013) /* SettingsIcon */.SettingsIcon, { size: "sm" });
  obj9[2] = function onPress() {
    return null;
  };
  items4[1] = callback2(require(7753) /* IconButton */.IconButton, obj9);
  obj8[0] = items4;
  obj7[0] = callback3(require(7793) /* Input */.Input, obj8);
  ...
  const items5 = [callback2(InputUsername, { defaultValue: "a space" }), callback2(require(7978) /* TextArea */.TextArea, { label: "About me", maxLength: 100, placeholder: "Long form text use TextArea", errorMessage: "This is an example of a multiline error message to showcase the icon alignment to this text" })];
  obj10[0] = items5;
  ...
  items1[20] = callback2(Sample, { children: callback2(require(5995) /* TextField */.TextField, { defaultValue: "Clear this text", isClearable: true }) });
  ...
  const obj11 = { children: callback2(require(5995) /* TextField */.TextField, { defaultValue: "Clear this text", isClearable: true }) };
  items1[24] = callback2(Sample, { children: callback2(require(7792) /* TextInput */.TextInput, { defaultValue: "Can't edit this value", isDisabled: true }) });
  ...
  const obj12 = { children: callback2(require(7792) /* TextInput */.TextInput, { defaultValue: "Can't edit this value", isDisabled: true }) };
  items1[28] = callback2(Sample, { children: callback2(require(7978) /* TextArea */.TextArea, { label: "Limited length", maxLength: 124 }) });
  ...
  const obj13 = { children: callback2(require(7978) /* TextArea */.TextArea, { label: "Limited length", maxLength: 124 }) };
  ...
  const items6 = [callback2(require(8499) /* SplitTextInput */.SplitTextInput, { label: "Small", size: "sm", placeholder: "Placeholder", leadingText: "Click", leadingPressableProps: { accessibilityLabel: "Click" } }), callback2(require(8499) /* SplitTextInput */.SplitTextInput, { label: "Medium", size: "md", placeholder: "Placeholder", leadingText: "Me", leadingPressableProps: { accessibilityLabel: "Me" } }), callback2(require(8499) /* SplitTextInput */.SplitTextInput, { label: "Large", size: "lg", placeholder: "Placeholder", leadingText: "Here", leadingPressableProps: { accessibilityLabel: "Here" } })];
  obj18[0] = items6;
