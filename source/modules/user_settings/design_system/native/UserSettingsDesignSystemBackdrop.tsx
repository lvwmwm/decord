...
// Function ID: 14891
// Name: BackdropCard
// Dependencies: [32, 19, 17, 21, 4342, 5416, 4753, 4338, 4755, 4083, 4754, 4758, 4737, 4743, 2]
// Exports: default

// Module 14890 (BackdropCard)
...
function BackdropCard(arg0) {
  ...
  const items = [callback2(require(4338) /* Text */.Text, { variant: "heading-lg/bold", children: title }), callback2(require(4338) /* Text */.Text, { variant: "text-md/normal", color: "text-subtle", children: description }), ];
  obj = {
    text: buttonLabel,
    onPress() {
      callback2(closure_0);
  ...
  items[2] = callback2(require(4755) /* Button */.Button, obj);
  obj[1] = items;
