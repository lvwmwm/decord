...
function BackdropCard(arg0) {
  ...
  const items = [callback2(require(4299) /* Text */.Text, { variant: "heading-lg/bold", children: title }), callback2(require(4299) /* Text */.Text, { variant: "text-md/normal", color: "text-subtle", children: description }), ];
  obj = {
    text: buttonLabel,
    onPress() {
      callback2(closure_0);
  ...
  items[2] = callback2(require(4714) /* Button */.Button, obj);
  obj[1] = items;
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  obj = { withSpring: first(4713).withSpring, showBackdrop: first, SUBTLE_SPRING: first(4717).SUBTLE_SPRING };
  fn.__closure = obj;
  ...
  obj1[1] = items;
  const items1 = [callback3(first(4712).Stack, obj1), ];
  if (first) {
    ...
    obj3[1] = tmp6;
    obj3[2] = handleClose;
    const items2 = [tmp13(tmp8(4702).Backdrop, obj3), ];
    ...
    obj6[1] = items3;
    obj5[0] = tmp11(tmp8(4299).Text, obj6);
    obj4[2] = tmp13(tmp8(5376).Card, obj5);
    items2[1] = tmp13(closure_5, obj4);
    obj2[1] = items2;
    first = tmp11(tmp8(4696).Dialog, obj2);
  }
  items1[1] = first;
  obj[1] = items1;
