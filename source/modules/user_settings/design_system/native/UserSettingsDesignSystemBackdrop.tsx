...
// Function ID: 14688
// Name: BackdropCard
// Dependencies: [32, 19, 17, 21, 4255, 5302, 4663, 4251, 4665, 4116, 4664, 4668, 4647, 4653, 2]
// Exports: default

// Module 14687 (BackdropCard)
...
function BackdropCard(arg0) {
  ...
  const items = [callback2(require(4251) /* Text */.Text, { variant: "heading-lg/bold", children: title }), callback2(require(4251) /* Text */.Text, { variant: "text-md/normal", color: "text-subtle", children: description }), ];
  obj = {
    text: buttonLabel,
    onPress() {
      callback2(closure_0);
  ...
  items[2] = callback2(require(4665) /* Button */.Button, obj);
  obj[1] = items;
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  obj = { withSpring: first(4664).withSpring, showBackdrop: first, SUBTLE_SPRING: first(4668).SUBTLE_SPRING };
  fn.__closure = obj;
  ...
  obj1[1] = items;
  const items1 = [callback3(first(4663).Stack, obj1), ];
  if (first) {
    ...
    obj3[1] = tmp6;
    obj3[2] = handleClose;
    const items2 = [tmp13(tmp8(4653).Backdrop, obj3), ];
    ...
    obj6[1] = items3;
    obj5[0] = tmp11(tmp8(4251).Text, obj6);
    obj4[2] = tmp13(tmp8(5302).Card, obj5);
    items2[1] = tmp13(closure_5, obj4);
    obj2[1] = items2;
    first = tmp11(tmp8(4647).Dialog, obj2);
  }
  items1[1] = first;
  obj[1] = items1;
