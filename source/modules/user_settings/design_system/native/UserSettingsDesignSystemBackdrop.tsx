...
// Function ID: 14936
// Name: BackdropCard
// Dependencies: [32, 19, 17, 21, 4661, 6292, 4733, 4734, 4745, 4115, 4744, 4748, 4716, 4723, 2]
// Exports: default

// Module 14935 (BackdropCard)
...
function BackdropCard(arg0) {
  ...
  const items = [callback2(require(4734) /* Text */.Text, { variant: "heading-lg/bold", children: title }), callback2(require(4734) /* Text */.Text, { variant: "text-md/normal", color: "text-subtle", children: description }), ];
  obj = {
    text: buttonLabel,
    onPress() {
      callback2(closure_0);
  ...
  items[2] = callback2(require(4745) /* Button */.Button, obj);
  obj[1] = items;
