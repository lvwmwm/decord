...
// Dependencies: [19, 17, 21, 8083, 4733, 712, 4734, 8086, 7356, 2]
// Exports: default
...
export default function UserSettingsDesignSystemRowButton() {
  ...
  obj[0] = obj1;
  const items = [callback(require(4734) /* Text */.Text, { variant: "text-sm/normal", children: "Row Button Row Buttons are full-width, high-emphasis buttons that are used as primary CTAs in a page." }), callback(require(4734) /* Text */.Text, { variant: "text-sm/normal", children: "Only stack up to 2 Row Buttons in a row to to prevent decision fatigue." })];
  obj[1] = items;
  ...
  obj4[1] = importDefault(7356);
  obj4[3] = function onPress() {

  };
  const items2 = [callback(require(8086) /* RowButtonWrapper */.RowButton, obj4), , , , , , ];
  ...
  obj5[1] = importDefault(7356);
  obj5[4] = function onPress() {

  };
  items2[1] = callback(require(8086) /* RowButtonWrapper */.RowButton, obj5);
  const obj6 = { variant: "secondary", icon: null, label: "Secondary Row Button", onPress: null };
  obj6[1] = importDefault(7356);
  obj6[3] = function onPress() {

  };
  items2[2] = callback(require(8086) /* RowButtonWrapper */.RowButton, obj6);
  const obj7 = { icon: null, label: "Secondary Row Button", subLabel: "I am a high emphasis button with a subLabel", onPress: null };
  obj7[0] = importDefault(7356);
  obj7[3] = function onPress() {

  };
  items2[3] = callback(require(8086) /* RowButtonWrapper */.RowButton, obj7);
  ...
  obj8[0] = importDefault(7356);
  obj8[3] = function onPress() {

  };
  items2[4] = callback(require(8086) /* RowButtonWrapper */.RowButton, obj8);
  const obj9 = { icon: null, label: "Row Button", subLabel: "With a custom RowButton.Icon", onPress: null };
  const obj10 = { source: null };
  obj10[0] = importDefault(7356);
  obj9[0] = callback(require(8086) /* RowButtonWrapper */.RowButton.Icon, obj10);
  obj9[3] = function onPress() {

  };
  items2[5] = callback(require(8086) /* RowButtonWrapper */.RowButton, obj9);
  const obj11 = { icon: null, label: "Row Button", subLabel: "I am disabled", onPress: null, disabled: true };
  obj11[0] = importDefault(7356);
  obj11[3] = function onPress() {

  };
  items2[6] = callback(require(8086) /* RowButtonWrapper */.RowButton, obj11);
  obj3[0] = items2;
