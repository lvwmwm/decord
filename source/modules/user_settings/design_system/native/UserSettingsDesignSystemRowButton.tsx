...
// Dependencies: [19, 17, 21, 7749, 4663, 712, 4251, 7752, 5906, 2]
// Exports: default

// Module 14659 (UserSettingsDesignSystemRowButton)
import "noop";
...
export default function UserSettingsDesignSystemRowButton() {
  ...
  obj4[1] = importDefault(5906);
  obj4[3] = function onPress() {

  };
  const items2 = [callback(require(7752) /* RowButtonWrapper */.RowButton, obj4), , , , , , ];
  ...
  obj5[1] = importDefault(5906);
  obj5[4] = function onPress() {

  };
  items2[1] = callback(require(7752) /* RowButtonWrapper */.RowButton, obj5);
  const obj6 = { variant: "secondary", icon: null, label: "Secondary Row Button", onPress: null };
  obj6[1] = importDefault(5906);
  obj6[3] = function onPress() {

  };
  items2[2] = callback(require(7752) /* RowButtonWrapper */.RowButton, obj6);
  const obj7 = { icon: null, label: "Secondary Row Button", subLabel: "I am a high emphasis button with a subLabel", onPress: null };
  obj7[0] = importDefault(5906);
  obj7[3] = function onPress() {

  };
  items2[3] = callback(require(7752) /* RowButtonWrapper */.RowButton, obj7);
  ...
  obj8[0] = importDefault(5906);
  obj8[3] = function onPress() {

  };
  items2[4] = callback(require(7752) /* RowButtonWrapper */.RowButton, obj8);
  const obj9 = { icon: null, label: "Row Button", subLabel: "With a custom RowButton.Icon", onPress: null };
  const obj10 = { source: null };
  obj10[0] = importDefault(5906);
  obj9[0] = callback(require(7752) /* RowButtonWrapper */.RowButton.Icon, obj10);
  obj9[3] = function onPress() {

  };
  items2[5] = callback(require(7752) /* RowButtonWrapper */.RowButton, obj9);
  const obj11 = { icon: null, label: "Row Button", subLabel: "I am disabled", onPress: null, disabled: true };
  obj11[0] = importDefault(5906);
  obj11[3] = function onPress() {

  };
  items2[6] = callback(require(7752) /* RowButtonWrapper */.RowButton, obj11);
  obj3[0] = items2;
