...
// Function ID: 14728
// Name: DemoModal
// Dependencies: [32, 19, 17, 21, 4285, 712, 5704, 5253, 4490, 5929, 1236, 7713, 3981, 11254, 13341, 7730, 7731, 4281, 11252, 13343, 10183, 10182, 5688, 5689, 4695, 2]
// Exports: default

// Module 14727 (DemoModal)
...
function DemoModal() {
  ...
  return callback2(require(11254) /* Modal */.Modal, obj);
}
function DemoStepModal() {
  ...
  return callback2(require(13341) /* StepModal */.StepModal, obj);
}
function DemoScreen(arg0) {
  ...
  obj[0] = items;
  children = [closure_8(require(7731) /* ModalContent */.ModalContent, obj), ];
  if (footer == null) {
  ...
  children[1] = footer;
  return closure_8(require(7730) /* ModalScreen */.ModalScreen, { children });
}
