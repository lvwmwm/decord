...
// Function ID: 14690
// Name: DemoModal
// Dependencies: [32, 19, 17, 21, 4255, 712, 5650, 5223, 4460, 5902, 1236, 7685, 3952, 11220, 13304, 7729, 7730, 4251, 11218, 13306, 10152, 10151, 5634, 5635, 4665, 2]
// Exports: default

// Module 14689 (DemoModal)
...
const require = arg1;
function DemoModal() {
  let obj = require(5650) /* NavigationStack */;
  ...
  return callback2(require(11220) /* Modal */.Modal, obj);
}
function DemoStepModal() {
  ...
  return callback2(require(13304) /* StepModal */.StepModal, obj);
}
function DemoScreen(arg0) {
  ...
  obj[0] = items;
  children = [closure_8(require(7730) /* ModalContent */.ModalContent, obj), ];
  if (footer == null) {
  ...
  children[1] = footer;
  return closure_8(require(7729) /* ModalScreen */.ModalScreen, { children });
}
...
export default function UserSettingsDesignSystemModal() {
  ...
  const items = [callback2(require(4665) /* Button */.Button, obj), callback2(require(4665) /* Button */.Button, { onPress: openDemoStepModal, text: "Show Stepped Modal" })];
  obj[1] = items;
