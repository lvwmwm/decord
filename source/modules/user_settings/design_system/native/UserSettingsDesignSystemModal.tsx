...
// Function ID: 14884
// Name: DemoModal
// Dependencies: [32, 19, 17, 21, 4344, 712, 5822, 5309, 4549, 6049, 1236, 7831, 4058, 11395, 13492, 7848, 7849, 4340, 11393, 13494, 10312, 10311, 5806, 5807, 4754, 2]
// Exports: default

// Module 14883 (DemoModal)
...
const require = arg1;
function DemoModal() {
  let obj = require(5822) /* NavigationStack */;
  ...
  return callback2(require(11395) /* Modal */.Modal, obj);
}
function DemoStepModal() {
  ...
  return callback2(require(13492) /* StepModal */.StepModal, obj);
}
function DemoScreen(arg0) {
  ...
  obj = { children: null };
  const items = [tmp5, callback2(require(4340) /* Text */.Text, { accessibilityRole: "header", variant: "heading-xl/bold", color: "mobile-text-heading-primary", style: tmp.title, children: title }), children];
  obj[0] = items;
  children = [closure_8(require(7849) /* ModalContent */.ModalContent, obj), ];
  if (footer == null) {
  ...
  children[1] = footer;
  return closure_8(require(7848) /* ModalScreen */.ModalScreen, { children });
}
...
export default function UserSettingsDesignSystemModal() {
  ...
  const items = [callback2(require(4754) /* Button */.Button, obj), callback2(require(4754) /* Button */.Button, { onPress: openDemoStepModal, text: "Show Stepped Modal" })];
  obj[1] = items;
