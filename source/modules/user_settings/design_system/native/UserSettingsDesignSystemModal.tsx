...
// Function ID: 15718
// Name: DemoModal
// Dependencies: [32, 19, 17, 21, 4481, 709, 6940, 5579, 4731, 7315, 1233, 6547, 4190, 11860, 14088, 8351, 8352, 4477, 11858, 14090, 10927, 10926, 5642, 7141, 4936, 2]
// Exports: default

// Module 15717 (DemoModal)
...
function DemoModal() {
  ...
  const navigatorScreens = obj.useNavigatorScreens(() => {
    ...
    obj[0] = obj2.getHeaderCloseButton(callback2(4731).pop);
    obj[1] = function headerRight() {
      const obj = { text: null, onPress: null };
      const intl = callback(1233).intl;
      obj[0] = intl.string(callback(1233).t["5Wxrcd"]);
      obj[1] = callback2(4731).pop;
      return callback3(callback(7315).HeaderActionButton, obj);
    };
    obj[2] = function headerTitle() {
      return callback3(callback(5579).NavigatorHeader, { title: constants.START, subtitle: "I said come on fhqwhgads" });
    };
    obj[3] = function render(arg0, arg1) {
      ...
      return callback3(closure_13, {
        ...
        onSecondaryAction: callback2(4731).pop,
        disclaimer: "I said come on fhqwhgads."
      });
    };
    obj[constants.START] = obj;
    obj = { headerLeft: callback(5579).getHeaderBackButton(), headerRight: null, headerTitle: null, render: null };
    const obj5 = callback(5579);
    obj[1] = callback(5579).getHeaderCloseButton(callback2(4731).pop);
    obj[2] = function headerTitle() {
      return callback3(callback(5579).NavigatorHeader, { title: constants.WHO_DAT });
    };
    obj[3] = function render(arg0, arg1) {
      const callback = arg1;
      return callback3(closure_13, {
        ...
        children: callback3(callback(6547).TextInput, { placeholder: "My friend Jake" })
      });
    };
    obj[constants.WHO_DAT] = obj;
    obj1 = { headerLeft: null, headerRight: null, headerTitle: null, render: null };
    const obj6 = callback(5579);
    obj1[0] = callback(5579).getHeaderBackButton();
    const obj8 = callback(5579);
    obj1[1] = callback(5579).getHeaderCloseButton(callback2(4731).pop);
    obj1[2] = function headerTitle() {
      return callback3(callback(5579).NavigatorHeader, { title: constants.EVERYBODY });
    };
    ...
    const obj9 = callback(5579);
    obj2[0] = callback(5579).getHeaderBackButton();
    const obj11 = callback(5579);
    obj2[1] = callback(5579).getHeaderCloseButton(callback2(4731).pop);
    obj2[2] = function headerTitle() {
      return callback3(callback(5579).NavigatorHeader, { title: constants.JOCKIN, subtitle: "Tryin' to play like, you know me" });
    };
    ...
    const obj12 = callback(5579);
    obj3[0] = callback(5579).getHeaderBackButton();
    obj3[1] = function headerRight() {
      return callback3(callback(5579).HeaderSubmittingIndicator, {});
    };
    obj3[2] = function headerTitle() {
      return callback3(callback(5579).NavigatorHeader, { title: constants.LIMIT });
    };
...
function DemoScreen(arg0) {
  ...
  if (tmp5) {
    ...
    obj[2] = tmp.emoji;
    obj[3] = emoji;
    obj[1] = callback2(tmp3(4477).Text, obj);
  ...
  if (footer == null) {
    ...
    if (tmp8Result) {
      ...
      obj2[0] = disclaimer;
      tmp8Result = tmp8(tmp3(14090).ModalDisclaimer, obj2);
    }
    ...
    if (tmp8Result) {
      ...
      obj3[1] = action;
      obj3[2] = onAction;
      tmp8Result = tmp8(tmp3(10927).ModalActionButton, obj3);
    }
    items2[1] = tmp8Result;
    ...
    if (tmp8Result1) {
      ...
      tmp8Result1 = tmp8(tmp3(10927).ModalActionButton, obj4);
    }
    const obj5 = { children: null };
    items2[2] = tmp8Result1;
    obj5[0] = items2;
    footer = tmp2(tmp3(11858).ModalFooter, obj5);
  }
  children[1] = footer;
...
function SwitchesScreen(onAction) {
  ...
  obj[2] = callback2(parts(10926).ModalFloatingAction, obj);
  obj = { style: tmp.tableRows, children: null };
  const tmp2 = callback(React.useState(parts.map(() => false)), 2);
  obj[1] = callback2(parts(5642).TableRowGroup, {
    hasIcons: false,
  ...
  const items = [callback2(closure_5, obj), callback2(parts(10926).ModalFloatingActionSpacer, {})];
  obj[3] = items;
