...
// Function ID: 14744
// Name: DemoModal
// Dependencies: [32, 19, 17, 21, 4302, 712, 5723, 5269, 4507, 5948, 1236, 7730, 3998, 11269, 13355, 7747, 7748, 4298, 11267, 13357, 10199, 10198, 5707, 5708, 4712, 2]
// Exports: default

// Module 14743 (DemoModal)
...
function DemoModal() {
  ...
  return callback2(require(11269) /* Modal */.Modal, obj);
}
function DemoStepModal() {
  ...
  return callback2(require(13355) /* StepModal */.StepModal, obj);
}
function DemoScreen(arg0) {
  ...
  obj = { children: null };
  const items = [tmp5, callback2(require(4298) /* Text */.Text, { accessibilityRole: "header", variant: "heading-xl/bold", color: "mobile-text-heading-primary", style: tmp.title, children: title }), children];
  obj[0] = items;
  children = [closure_8(require(7748) /* ModalContent */.ModalContent, obj), ];
  if (footer == null) {
  ...
  children[1] = footer;
  return closure_8(require(7747) /* ModalScreen */.ModalScreen, { children });
}
...
export default function UserSettingsDesignSystemModal() {
  ...
  const items = [callback2(require(4712) /* Button */.Button, obj), callback2(require(4712) /* Button */.Button, { onPress: openDemoStepModal, text: "Show Stepped Modal" })];
  obj[1] = items;
