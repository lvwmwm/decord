...
// Function ID: 14893
// Name: DemoModal
// Dependencies: [32, 19, 17, 21, 4342, 712, 5823, 5310, 4550, 6051, 1236, 7835, 4058, 11386, 13493, 7852, 7853, 4338, 11384, 13495, 11149, 11148, 5807, 5808, 4755, 2]
// Exports: default

// Module 14892 (DemoModal)
...
function DemoModal() {
  ...
  return callback2(require(11386) /* Modal */.Modal, obj);
}
function DemoStepModal() {
  ...
  return callback2(require(13493) /* StepModal */.StepModal, obj);
}
function DemoScreen(arg0) {
  ...
  obj[0] = items;
  children = [closure_8(require(7853) /* ModalContent */.ModalContent, obj), ];
  if (footer == null) {
  ...
  children[1] = footer;
  return closure_8(require(7852) /* ModalScreen */.ModalScreen, { children });
}
...
export default function UserSettingsDesignSystemModal() {
  ...
  const items = [callback2(require(4755) /* Button */.Button, obj), callback2(require(4755) /* Button */.Button, { onPress: openDemoStepModal, text: "Show Stepped Modal" })];
  obj[1] = items;
