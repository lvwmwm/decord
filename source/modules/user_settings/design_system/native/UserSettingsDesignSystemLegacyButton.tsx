...
// Function ID: 14656
// Name: ComparisonRow
// Dependencies: [19, 17, 21, 1297, 4251, 4665, 4255, 712, 4663, 7749, 2]
// Exports: default

// Module 14655 (ComparisonRow)
import "noop";
...
export default function UserSettingsDesignSystemLegacyButton() {
  ...
  obj[2] = items;
  const items1 = [callback(require(4663) /* Stack */.Stack, obj), , , ];
  ...
  obj1[2] = items2;
  items1[2] = callback(require(4663) /* Stack */.Stack, obj1);
