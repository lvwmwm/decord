...
function ComparisonRow(entry) {
  ...
  items1[2] = str2;
  obj[2] = items1;
  const items2 = [closure_4(require(4338) /* Text */.Text, obj), ];
  const obj1 = { style: tmp.comparisonButtons, children: null };
  const obj2 = { style: tmp.comparisonSide, children: null };
  const items3 = [callback2(require(4338) /* Text */.Text, { variant: "text-xxs/medium", color: "text-muted", children: "legacy" }), ];
...
function ComboRow(combo) {
  ...
  const items2 = [closure_4(require(4338) /* Text */.Text, { variant: "text-xs/medium", color: str2, children: items1 }), ];
