...
// Function ID: 14710
// Name: ComparisonRow
// Dependencies: [19, 17, 21, 1297, 4298, 4712, 4302, 712, 4710, 7907, 2]
// Exports: default

// Module 14709 (ComparisonRow)
import "noop";
...
function ComparisonRow(entry) {
  ...
  items1[2] = str2;
  obj[2] = items1;
  const items2 = [closure_4(require(4298) /* Text */.Text, obj), ];
  const obj1 = { style: tmp.comparisonButtons, children: null };
  const obj2 = { style: tmp.comparisonSide, children: null };
  const items3 = [callback2(require(4298) /* Text */.Text, { variant: "text-xxs/medium", color: "text-muted", children: "legacy" }), ];
...
function ComboRow(combo) {
  ...
  const items2 = [closure_4(require(4298) /* Text */.Text, { variant: "text-xs/medium", color: str2, children: items1 }), ];
...
export default function UserSettingsDesignSystemLegacyButton() {
  ...
  items = [callback2(require(4298) /* Text */.Text, { variant: "heading-xl/bold", children: "Migration Mapping" }), callback2(require(4298) /* Text */.Text, { variant: "text-sm/normal", color: "text-muted", children: "Legacy (uikit-native) \u2192 Mana side-by-side" })];
  obj[2] = items;
  const items1 = [callback(require(4710) /* Stack */.Stack, obj), , , ];
  ...
  const items2 = [callback2(require(4298) /* Text */.Text, { variant: "heading-xl/bold", children: "Legacy Button Audit" }), callback2(require(4298) /* Text */.Text, { variant: "text-sm/normal", color: "text-muted", children: "41 combinations across 185 importers" })];
  obj1[2] = items2;
  items1[2] = callback(require(4710) /* Stack */.Stack, obj1);
