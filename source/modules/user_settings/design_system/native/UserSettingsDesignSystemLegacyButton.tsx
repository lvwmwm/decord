...
// Module 14311 (_createForOfIteratorHelperLoose)
...
function ComparisonRow(entry) {
  ...
  const items3 = [callback2(arg1(dependencyMap[4]).Text, { category: "Header Button", position: "A specialized version of the 'secondary-overlay' Button which functions as both a Header and a button.", top: false }), ];
  ...
  if (null != redesignVariant) {
    ...
    const items5 = [callback2(arg1(dependencyMap[4]).Text, { category: 767181567, position: 679280641, top: 18939905 }), ];
    const obj5 = {
    ...
    const obj6 = { style: tmp.comparisonSide, children: callback2(arg1(dependencyMap[4]).Text, { category: "<string:2355167488>", position: "<string:38780993>", top: "<string:4294603008>" }) };
...
export default function UserSettingsDesignSystemLegacyButton() {
  ...
  const items1 = [callback2(arg1(dependencyMap[4]).Text, { <string:2807142664>: null, <string:1446667417>: "lg" }), callback2(arg1(dependencyMap[4]).Text, { category: null, position: "end", top: "Copy, http://discord.com/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" })];
  ...
  const items3 = [callback2(arg1(dependencyMap[4]).Text, { <string:2807142664>: false, <string:1446667417>: false }), callback2(arg1(dependencyMap[4]).Text, { category: false, position: false, top: false })];
