...
// Dependencies: [19, 17, 21, 3988, 712, 4693, 5688, 4282, 5354, 4281, 2]
// Exports: default

// Module 14686 (UserSettingsDesignSystemText)
import "noop";
...
export default function UserSettingsDesignSystemText() {
  ...
  obj1[2] = TEXT_VARIANT.map((arg0) => {
    ...
    if ("code" !== arg0) {
      ...
      obj[0] = arg0;
      obj[1] = arg0;
      obj[0] = callback2(callback(4281).Text, obj, arg0);
      tmp = callback2(callback(5354).TableRow, obj, arg0);
    }
    return tmp;
  });
  obj[2] = jsx(require(5688) /* TableRowGroupTitle */.TableRowGroup, { title: "Text Variants", hasIcons: false, children: null });
