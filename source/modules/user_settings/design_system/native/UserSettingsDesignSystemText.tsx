...
// Dependencies: [19, 17, 21, 4165, 712, 4878, 5944, 4442, 5551, 4441, 2]
// Exports: default

// Module 15133 (UserSettingsDesignSystemText)
import noopAll from "noop" /* 19 */;
import ThemesDefault from "Themes" /* 712 */;
import map from "map" /* 4165 */;
import TEXT_VARIANT2 from "TEXT_VARIANT" /* 4442 */;
...
export default function UserSettingsDesignSystemText() {
  ...
  obj1[2] = TEXT_VARIANT.map((arg0) => {
    ...
    if ("code" !== arg0) {
      ...
      obj[0] = arg0;
      obj[1] = arg0;
      obj[0] = callback2(callback(4441).Text, obj, arg0);
      tmp = callback2(callback(5551).TableRow, obj, arg0);
    }
    return tmp;
  });
