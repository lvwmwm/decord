...
// Function ID: 14734
// Name: Radio
// Dependencies: [32, 19, 17, 676, 21, 4285, 4281, 7908, 7907, 5688, 5689, 10451, 8371, 5354, 13345, 10775, 4810, 4693, 2]
// Exports: default
...
function Switch() {
  ...
  const items = [callback2(_require(4281).Text, { variant: "heading-lg/bold", children: "Switch" }), callback2(_require(4281).Text, { variant: "text-md/normal", children: "Toggle the state of a single setting on or off, immediately" }), , ];
  const obj3 = { title: "Emoji", hasIcons: false, children: null };
  const merged = Object.assign(obj);
  obj3[2] = callback2(_require(5689).TableSwitchRow, { label: "Show emoji reactions on messages", subLabel: "Show more information in less space" });
  items[2] = callback2(_require(5688).TableRowGroup, obj3);
  const obj5 = { title: "Display images, videos, and lolcats", hasIcons: false, children: null };
  const merged1 = Object.assign(obj);
  const items1 = [callback2(_require(5689).TableSwitchRow, { label: "When posted as links to chat" }), , , ];
  const merged2 = Object.assign(obj);
  items1[1] = callback2(_require(5689).TableSwitchRow, { label: "When uploaded directly to Discord" });
  ...
  items1[2] = callback2(_require(5689).TableSwitchRow, { label: "With image descriptions" });
  items1[3] = callback2(_require(5689).TableSwitchRow, { label: "Disabled switch item", subLabel: "This should not be switchable", disabled: true, value: false, onValueChange: NOOP });
  obj5[2] = items1;
  items[3] = callback3(_require(5688).TableRowGroup, obj5);
  obj2[0] = items;
...
function InlineCheckbox(startChecked) {
  ...
  return callback2(_require(10451).Checkbox, { label, description, required, checked, onToggle });
}
function InlineCheckboxDemo() {
  const obj = { children: null };
  const items = [callback2(require(4281) /* Text */.Text, { variant: "heading-lg/bold", children: "Inline Checkbox" }), callback2(InlineCheckbox, { label: "Checkbox label", description: "This is a description", startChecked: true }), callback2(InlineCheckbox, { label: "Trust google.com links from now on" }), callback2(InlineCheckbox, { label: "I agree to the Terms of Service", required: true })];
  obj[0] = items;
  return callback3(closure_8, obj);
}
function CheckboxRowDemo() {
  let obj = { children: null };
  const items = [callback2(require(4281) /* Text */.Text, { variant: "heading-lg/bold", children: "Checkbox" }), callback2(require(4281) /* Text */.Text, { variant: "text-md/normal", children: "Select one or more options from a short list of options" }), ];
  ...
  const items1 = [callback2(require(8371) /* TableCheckboxRow */.TableCheckboxRow, obj), callback2(require(8371) /* TableCheckboxRow */.TableCheckboxRow, { label: "Friends of Friends", subLabel: "Anyone who is friends with your friends can send you a friend request", checked: true, onPress: NOOP }), callback2(require(8371) /* TableCheckboxRow */.TableCheckboxRow, { label: "Server Members", subLabel: "Anyone who is in a server with you can send you a friend request", checked: true, onPress: NOOP })];
  obj[2] = items1;
  items[2] = callback3(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj);
  obj[0] = items;
  return callback3(closure_8, obj);
}
function SliderDemo() {
  let obj = { children: null };
  const items = [callback2(require(4281) /* Text */.Text, { variant: "heading-lg/bold", children: "Slider" }), ];
  obj = { start: true, end: true, label: "Volume", subLabel: null };
  obj = { startIcon: null, endIcon: null, onValueChange: null };
  obj[0] = callback2(require(10775) /* VoiceXIcon */.VoiceXIcon, {});
  obj[1] = callback2(require(4810) /* VoiceNormalIcon */.VoiceNormalIcon, {});
  obj[2] = NOOP;
  obj[3] = callback2(require(13345) /* Slider */.Slider, obj);
  items[1] = callback2(require(5354) /* TableRowInner */.TableRow, obj);
  obj[0] = items;
  return callback3(closure_8, obj);
}
