...
// Function ID: 14890
// Name: Radio
// Dependencies: [32, 19, 17, 676, 21, 4342, 4338, 8030, 8029, 5807, 5808, 10496, 8497, 5414, 13498, 10828, 4870, 4753, 2]
// Exports: default
...
function Radio() {
  ...
  const items = [callback2(require(4338) /* Text */.Text, { variant: "heading-lg/bold", children: "Radio" }), callback2(require(4338) /* Text */.Text, { variant: "text-md/normal", children: "Select a single option from a short list of multiple options" }), ];
  ...
  obj[4] = items1;
  items[2] = callback3(require(8030) /* context */.TableRadioGroup, obj);
  obj[0] = items;
...
function Switch() {
  ...
  const items = [callback2(_require(4338).Text, { variant: "heading-lg/bold", children: "Switch" }), callback2(_require(4338).Text, { variant: "text-md/normal", children: "Toggle the state of a single setting on or off, immediately" }), , ];
  const obj3 = { title: "Emoji", hasIcons: false, children: null };
  const merged = Object.assign(obj);
  obj3[2] = callback2(_require(5808).TableSwitchRow, { label: "Show emoji reactions on messages", subLabel: "Show more information in less space" });
  items[2] = callback2(_require(5807).TableRowGroup, obj3);
  const obj5 = { title: "Display images, videos, and lolcats", hasIcons: false, children: null };
  const merged1 = Object.assign(obj);
  const items1 = [callback2(_require(5808).TableSwitchRow, { label: "When posted as links to chat" }), , , ];
  const merged2 = Object.assign(obj);
  items1[1] = callback2(_require(5808).TableSwitchRow, { label: "When uploaded directly to Discord" });
  ...
  items1[2] = callback2(_require(5808).TableSwitchRow, { label: "With image descriptions" });
  items1[3] = callback2(_require(5808).TableSwitchRow, { label: "Disabled switch item", subLabel: "This should not be switchable", disabled: true, value: false, onValueChange: NOOP });
  obj5[2] = items1;
  items[3] = callback3(_require(5807).TableRowGroup, obj5);
  obj2[0] = items;
...
function InlineCheckbox(startChecked) {
  ...
  return callback2(_require(10496).Checkbox, { label, description, required, checked, onToggle });
}
function InlineCheckboxDemo() {
  const obj = { children: null };
  const items = [callback2(require(4338) /* Text */.Text, { variant: "heading-lg/bold", children: "Inline Checkbox" }), callback2(InlineCheckbox, { label: "Checkbox label", description: "This is a description", startChecked: true }), callback2(InlineCheckbox, { label: "Trust google.com links from now on" }), callback2(InlineCheckbox, { label: "I agree to the Terms of Service", required: true })];
  obj[0] = items;
  return callback3(closure_8, obj);
}
function CheckboxRowDemo() {
  let obj = { children: null };
  const items = [callback2(require(4338) /* Text */.Text, { variant: "heading-lg/bold", children: "Checkbox" }), callback2(require(4338) /* Text */.Text, { variant: "text-md/normal", children: "Select one or more options from a short list of options" }), ];
  ...
  const items1 = [callback2(require(8497) /* TableCheckboxRow */.TableCheckboxRow, obj), callback2(require(8497) /* TableCheckboxRow */.TableCheckboxRow, { label: "Friends of Friends", subLabel: "Anyone who is friends with your friends can send you a friend request", checked: true, onPress: NOOP }), callback2(require(8497) /* TableCheckboxRow */.TableCheckboxRow, { label: "Server Members", subLabel: "Anyone who is in a server with you can send you a friend request", checked: true, onPress: NOOP })];
  obj[2] = items1;
  items[2] = callback3(require(5807) /* TableRowGroupTitle */.TableRowGroup, obj);
  obj[0] = items;
  return callback3(closure_8, obj);
}
function SliderDemo() {
  let obj = { children: null };
  const items = [callback2(require(4338) /* Text */.Text, { variant: "heading-lg/bold", children: "Slider" }), ];
  obj = { start: true, end: true, label: "Volume", subLabel: null };
  obj = { startIcon: null, endIcon: null, onValueChange: null };
  obj[0] = callback2(require(10828) /* VoiceXIcon */.VoiceXIcon, {});
  obj[1] = callback2(require(4870) /* VoiceNormalIcon */.VoiceNormalIcon, {});
  obj[2] = NOOP;
  obj[3] = callback2(require(13498) /* Slider */.Slider, obj);
