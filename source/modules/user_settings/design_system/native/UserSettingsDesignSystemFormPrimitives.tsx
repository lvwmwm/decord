...
// Function ID: 15366
// Name: Radio
// Dependencies: [32, 19, 17, 676, 21, 4448, 4444, 7660, 7661, 5960, 5961, 9328, 7651, 5567, 13788, 10031, 5018, 4894, 2]
// Exports: default
...
function Switch() {
  ...
  const items = [callback2(_require(4444).Text, { variant: "heading-lg/bold", children: "Switch" }), callback2(_require(4444).Text, { variant: "text-md/normal", children: "Toggle the state of a single setting on or off, immediately" }), , ];
  const obj3 = { title: "Emoji", hasIcons: false, children: null };
  const merged = Object.assign(obj);
  obj3[2] = callback2(_require(5961).TableSwitchRow, { label: "Show emoji reactions on messages", subLabel: "Show more information in less space" });
  items[2] = callback2(_require(5960).TableRowGroup, obj3);
  const obj5 = { title: "Display images, videos, and lolcats", hasIcons: false, children: null };
  const merged1 = Object.assign(obj);
  const items1 = [callback2(_require(5961).TableSwitchRow, { label: "When posted as links to chat" }), , , ];
  const merged2 = Object.assign(obj);
  items1[1] = callback2(_require(5961).TableSwitchRow, { label: "When uploaded directly to Discord" });
  ...
  items1[2] = callback2(_require(5961).TableSwitchRow, { label: "With image descriptions" });
  items1[3] = callback2(_require(5961).TableSwitchRow, { label: "Disabled switch item", subLabel: "This should not be switchable", disabled: true, value: false, onValueChange: NOOP });
  obj5[2] = items1;
  items[3] = callback3(_require(5960).TableRowGroup, obj5);
  obj2[0] = items;
...
function InlineCheckbox(startChecked) {
  ...
  return callback2(_require(9328).Checkbox, { label, description, required, checked, onToggle });
}
