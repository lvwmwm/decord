...
// Function ID: 14685
// Name: HapticButton
// Dependencies: [19, 17, 21, 4255, 4666, 4224, 4225, 4664, 5288, 4251, 4226, 2]
// Exports: default

// Module 14684 (HapticButton)
import "noop";
...
function HapticButton(text) {
  ...
  return callback(type(4666).Button, {
    variant: "secondary",
    onPress() {
...
export default function UserSettingsDesignSystemHaptics() {
  ...
  obj1[0] = items;
  obj[0] = callback2(require(4664) /* Stack */.Stack, obj1);
  const items1 = [callback(require(5288) /* PressableCard */.Card, obj), , , , ];
  ...
  obj3[0] = items2;
  obj2[0] = callback2(require(4664) /* Stack */.Stack, obj3);
  items1[1] = callback(require(5288) /* PressableCard */.Card, obj2);
  ...
  obj5[0] = items3;
  obj4[0] = callback2(require(4664) /* Stack */.Stack, obj5);
  items1[2] = callback(require(5288) /* PressableCard */.Card, obj4);
  ...
  items1[3] = callback(require(5288) /* PressableCard */.Card, obj6);
  ...
  obj9[0] = items5;
  obj8[0] = callback2(require(4664) /* Stack */.Stack, obj9);
  items1[4] = callback(require(5288) /* PressableCard */.Card, obj8);
  obj[1] = items1;
