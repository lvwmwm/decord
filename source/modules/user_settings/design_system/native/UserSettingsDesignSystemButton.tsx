...
// Function ID: 15583
// Name: ExampleButton
// Dependencies: [32, 19, 17, 1347, 21, 15583, 4928, 15584, 8015, 6250, 10003, 14031, 10261, 7867, 9839, 4478, 709, 1498, 4445, 15585, 2008, 4926, 4474, 10666, 9993, 9999, 10001, 10000, 9998, 9997, 5384, 4204, 685, 4940, 5609, 5078, 9005, 2]
// Exports: default
...
function ExampleButton(arg0) {
  ...
  obj[9] = iconPosition;
  obj[10] = buttonScale;
  return closure_9(enableLoadingState(4928).Button, obj);
}
...
function ExampleToggleButton() {
  ...
  obj2.size = "md";
  return callback2(first(4928).Button, obj2);
}
...
export default function UserSettingsDesignSystemButton() {
  ...
  let items = [callback2(_require(4926).Stack, { style: tmp.container, children: callback2(_require(4474).Text, { variant: "heading-lg/bold", children: "Hierarchical buttons" }) }), ];
  ...
  obj3[0] = items;
  const items1 = [callback3(_require(4926).Stack, obj3), , , , , , , , , , , , , , , , , , , ];
  ...
  const items2 = [callback2(_require(4926).Stack, { style: tmp.container, children: callback2(_require(4474).Text, { variant: "heading-lg/bold", children: "Sentiment buttons" }) }), ];
  ...
  obj6[0] = items2;
  items1[1] = callback3(_require(4926).Stack, obj6);
  ...
  const items3 = [callback2(_require(4926).Stack, { style: tmp.container, children: callback2(_require(4474).Text, { variant: "heading-lg/bold", children: "Expressive buttons" }) }), ];
  ...
  obj9[0] = items3;
  items1[2] = callback3(_require(4926).Stack, obj9);
  ...
  const items4 = [callback2(_require(4926).Stack, { style: tmp.container, children: callback2(_require(4474).Text, { variant: "heading-lg/bold", children: "Experimental premium buttons" }) }), ];
  ...
  obj12[0] = items4;
  items1[3] = callback3(_require(4926).Stack, obj12);
  ...
  obj16[1] = items5;
  const items6 = [callback3(_require(4926).Stack, obj16), ];
  const obj14 = {
    children: closure_16.map((variant) => {
      obj = { style: lib.buttonContainer, children: closure_1_9(closure_1_17, obj) };
      obj = { variant };
  ...
  obj15[0] = items6;
  items1[4] = callback3(_require(4926).Stack, obj15);
  ...
  obj19[1] = items7;
  const items8 = [callback3(_require(4926).Stack, obj19), ];
  ...
  obj22[4] = callback2(_require(4928).Button.Icon, { source: registerAssetDefault11 });
  obj21[1] = callback2(_require(4928).Button, obj22);
  ...
  obj25[4] = callback2(_require(4928).Button.Icon, { variant: "entity", source: registerAssetDefault4 });
  obj24[1] = callback2(_require(4928).Button, obj25);
  items9[1] = callback2(closure_5, obj24);
  obj20[0] = items9;
  items8[1] = callback3(closure_5, obj20);
  obj18[0] = items8;
  items1[5] = callback3(_require(4926).Stack, obj18);
  const obj27 = { children: null };
  const obj26 = { variant: "entity", source: registerAssetDefault4 };
  const items10 = [callback2(_require(4926).Stack, { style: tmp.container, children: callback2(_require(4474).Text, { variant: "heading-lg/bold", children: "Buttons with various text lengths" }) }), ];
  ...
  obj30[1] = callback2(_require(4928).Button, {
    onPress() {
  ...
  obj32[1] = callback2(_require(4928).Button, {
    onPress() {
  ...
  items11[2] = callback2(closure_5, { style: tmp.buttonContainer, children: callback2(_require(4928).Button, obj35) });
  const obj34 = { style: tmp.buttonContainer, children: callback2(_require(4928).Button, obj35) };
  items11[3] = callback2(closure_5, { style: tmp.buttonContainer, children: callback2(_require(4928).Button, obj37) });
  obj29[0] = items11;
  items10[1] = callback3(closure_5, obj29);
  obj27[0] = items10;
  items1[6] = callback3(_require(4926).Stack, obj27);
  ...
  obj39[1] = items12;
  const items13 = [callback3(_require(4926).Stack, obj39), ];
  const obj40 = { children: null };
  const obj36 = { style: tmp.buttonContainer, children: callback2(_require(4928).Button, obj37) };
  ...
  obj38[0] = items13;
  items1[7] = callback3(_require(4926).Stack, obj38);
  ...
  obj44[1] = items15;
  const items16 = [callback3(_require(4926).Stack, obj44), ];
  ...
  obj43[0] = items16;
  items1[8] = callback3(_require(4926).Stack, obj43);
  ...
  const items17 = [callback2(_require(4926).Stack, { style: tmp.container, children: callback2(_require(4474).Text, { variant: "heading-lg/bold", children: "Sentiment icon buttons" }) }), ];
  ...
  obj46[0] = items17;
  items1[9] = callback3(_require(4926).Stack, obj46);
  ...
  const items18 = [callback2(_require(4926).Stack, { style: tmp.container, children: callback2(_require(4474).Text, { variant: "heading-lg/bold", children: "Overlay icon buttons" }) }), ];
  ...
  obj49[0] = items18;
  items1[10] = callback3(_require(4926).Stack, obj49);
  ...
  obj53[1] = items19;
  const items20 = [callback3(_require(4926).Stack, obj53), ];
  ...
  obj52[0] = items20;
  items1[11] = callback3(_require(4926).Stack, obj52);
  ...
  obj62[1] = items25;
  const items26 = [callback3(_require(4926).Stack, obj62), , ];
  ...
  obj63[2] = callback2(_require(4926).Stack, { direction: "horizontal", justify: "center", style: tmp.buttonContainer, children: closure_12.map((variant) => callback2(closure_18, { variant, showLabel: true }, variant)) });
  ...
  obj66[3] = items27;
  obj65[2] = callback3(_require(4926).Stack, obj66);
  items26[2] = callback2(closure_6, obj65);
  obj61[1] = items26;
  items1[12] = callback3(_require(4926).Stack, obj61);
  ...
  const items28 = [callback2(_require(4926).Stack, { style: tmp.container, children: callback2(_require(4474).Text, { variant: "heading-lg/bold", children: "ImageButton with a label" }) }), , ];
  ...
  obj73[3] = items29;
  obj72[2] = callback3(_require(4926).Stack, obj73);
  ...
  obj78[3] = items30;
  obj77[2] = callback3(_require(4926).Stack, obj78);
  items28[2] = callback2(closure_6, obj77);
  obj70[1] = items28;
  items1[13] = callback3(_require(4926).Stack, obj70);
  ...
  const items31 = [callback2(_require(4926).Stack, { style: tmp.container, children: callback2(_require(4474).Text, { variant: "heading-lg/bold", children: "Mixing buttons" }) }), ];
  ...
  obj85[0] = items34;
  items1[15] = callback3(_require(4926).Stack, obj85);
  obj91 = { children: null };
  ...
  obj91[0] = items37;
  items1[16] = callback3(_require(4926).Stack, obj91);
  obj = { children: null };
  ...
  obj[1] = items39;
  const items40 = [callback3(_require(4926).Stack, obj), ];
  ...
  obj[1] = items43;
  const items44 = [callback3(_require(4926).Stack, obj), ];
  obj = { theme: 32.theme, gradient: 32, flags: null, children: null };
  obj = _require(4204);
  ...
  obj[0] = items44;
  items1[18] = callback3(_require(4926).Stack, obj);
  obj = { children: null };
  obj = { style: tmp.container, children: null };
  ...
  obj[1] = items47;
  const items48 = [callback3(_require(4926).Stack, obj), callback2(closure_5, { style: { padding: 48 } })];
  obj[0] = items48;
  items1[19] = callback3(_require(4926).Stack, obj);
  obj2[1] = items1;
  obj1[0] = callback3(_require(4926).Stack, obj2);
