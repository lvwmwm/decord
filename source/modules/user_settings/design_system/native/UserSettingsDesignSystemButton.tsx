...
function ExampleImageButton(arg0) {
  ...
  return closure_9(enableLoadingState(9046).ImageButton, obj);
}
function ExampleToggleButton() {
  ...
  obj[0] = obj;
  obj[1] = { text: "Follow", icon: importDefault(7868) };
...
function ExampleIconToggleButton() {
  ...
  obj[0] = obj;
  obj[1] = { variant: "secondary", accessibilityLabel: "Mute", icon: importDefault(9109) };
...
export default function UserSettingsDesignSystemButton() {
  ...
  obj55[1] = callback2(ExampleImageButton, { image: importDefault(9042), label: "Telegram" });
  const items22 = [callback2(closure_5, obj55), , ];
  const obj57 = { style: items23, children: null };
  items23 = [tmp.buttonContainer];
  const obj56 = { image: importDefault(9042), label: "Telegram" };
  obj57[1] = callback2(ExampleImageButton, { image: importDefault(9044), label: "WhatsApp" });
  items22[1] = callback2(closure_5, obj57);
  const obj59 = { style: items24, children: null };
  items24 = [tmp.buttonContainer];
  const obj58 = { image: importDefault(9044), label: "WhatsApp" };
  obj59[1] = callback2(ExampleImageButton, { image: importDefault(9043), label: "Twitter" });
  ...
  obj74[0] = importDefault(9041);
  const items29 = [callback2(ExampleImageButton, obj74), , ];
  const obj60 = { image: importDefault(9043), label: "Twitter" };
  items29[1] = callback2(ExampleImageButton, { image: importDefault(9036), label: "Label", showLabel: true });
  const obj75 = { image: importDefault(9036), label: "Label", showLabel: true };
  items29[2] = callback2(ExampleImageButton, { image: importDefault(9040), label: "Label", showLabel: true });
  obj73[3] = items29;
  ...
  obj79[0] = importDefault(9042);
  const items30 = [callback2(ExampleImageButton, obj79), , ];
  const obj76 = { image: importDefault(9040), label: "Label", showLabel: true };
  items30[1] = callback2(ExampleImageButton, { image: importDefault(9044), label: "Supercalifragilisticexpialidocious", showLabel: true });
  const obj80 = { image: importDefault(9044), label: "Supercalifragilisticexpialidocious", showLabel: true };
  items30[2] = callback2(ExampleImageButton, { image: importDefault(9043), label: "Supercalifragilisticexpialidocious", showLabel: true });
  obj78[3] = items30;
  ...
  obj84[2] = items32;
  items31[1] = callback3(require(5117) /* ButtonGroup */.ButtonGroup, obj84);
  obj82[1] = items31;
  ...
  const obj81 = { image: importDefault(9043), label: "Supercalifragilisticexpialidocious", showLabel: true };
  ...
  obj88[4] = callback2(require(5317) /* PressableCard */.Card, obj89);
  obj87[3] = callback2(importDefault(4706), obj88);
  items34[1] = callback2(require(3997) /* ManaContext */.ThemeContextProvider, obj87);
  obj85[0] = items34;
  ...
  obj[4] = callback2(require(5317) /* PressableCard */.Card, obj);
  obj93[3] = callback2(importDefault(4706), obj);
  items37[1] = callback2(require(3997) /* ManaContext */.ThemeContextProvider, obj93);
  obj91[0] = items37;
  ...
  obj = require(3997) /* ManaContext */;
  obj[2] = obj.setThemeFlag(0, require(3997) /* ManaContext */.ThemeContextFlags.MOBILE_LIGHT_GRADIENT_THEME_ENABLED);
  obj = { style: { position: "relative", padding: 16 }, children: null };
  obj = { absolute: true, gradient: 32 };
  const items41 = [callback2(require(4814) /* getMixedGradientColor */.Gradient, obj), ];
  ...
  items40[1] = callback2(require(3997) /* ManaContext */.ThemeContextProvider, obj);
  obj[0] = items40;
  ...
  obj = { theme: 32.theme, gradient: 32, flags: null, children: null };
  obj = require(3997) /* ManaContext */;
  obj[2] = obj.setThemeFlag(0, require(3997) /* ManaContext */.ThemeContextFlags.MOBILE_DARK_GRADIENT_THEME_ENABLED);
  obj = { style: { position: "relative", padding: 16 }, children: null };
  obj = { absolute: true, gradient: 32 };
  const items45 = [callback2(require(4814) /* getMixedGradientColor */.Gradient, obj), ];
  obj = { style: null, children: null };
  obj = { backgroundColor: null, padding: 16, borderRadius: 16 };
  obj = require(3997) /* ManaContext */;
  ...
  obj[1] = items45;
  obj[3] = callback3(closure_5, obj);
  items44[1] = callback2(require(3997) /* ManaContext */.ThemeContextProvider, obj);
  obj[0] = items44;
  ...
  items49[1] = callback2(require(8592) /* styles */.FloatingActionButton, obj);
  obj[0] = items49;
