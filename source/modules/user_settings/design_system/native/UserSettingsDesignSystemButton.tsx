...
// Function ID: 15072
// Name: ExampleButton
// Dependencies: [32, 19, 17, 1348, 21, 15072, 4879, 15073, 7963, 6187, 9340, 13695, 9955, 8276, 9403, 4444, 712, 1500, 4411, 15074, 2009, 4877, 4440, 10243, 9330, 9336, 9338, 9337, 9335, 9334, 5323, 4172, 688, 4891, 5548, 5017, 8885, 2]
// Exports: default

// Module 15071 (ExampleButton)
import ThemesDefault from "Themes" /* 712 */;
import LinearGradientDefault from "LinearGradient" /* 4891 */;
import registerAssetDefault from "registerAsset" /* 6187 */;
import registerAssetDefault2 from "registerAsset" /* 8276 */;
import registerAssetDefault3 from "registerAsset" /* 9330 */;
import registerAssetDefault4 from "registerAsset" /* 9334 */;
import registerAssetDefault5 from "registerAsset" /* 9335 */;
import registerAssetDefault6 from "registerAsset" /* 9336 */;
import registerAssetDefault7 from "registerAsset" /* 9337 */;
import registerAssetDefault8 from "registerAsset" /* 9338 */;
import registerAssetDefault9 from "registerAsset" /* 9403 */;
import registerAssetDefault10 from "registerAsset" /* 9955 */;
import registerAssetDefault11 from "registerAsset" /* 10243 */;
import keysDefault from "keys" /* 15072 */;
import registerAssetDefault12 from "registerAsset" /* 15073 */;
...
export default function UserSettingsDesignSystemButton() {
  ...
  let items = [callback2(_require(4877).Stack, { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Hierarchical buttons" }) }), ];
  const obj4 = { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Hierarchical buttons" }) };
  ...
  obj3[0] = items;
  const items1 = [callback3(_require(4877).Stack, obj3), , , , , , , , , , , , , , , , , , , ];
  ...
  const items2 = [callback2(_require(4877).Stack, { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Sentiment buttons" }) }), ];
  const obj7 = { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Sentiment buttons" }) };
  ...
  obj6[0] = items2;
  items1[1] = callback3(_require(4877).Stack, obj6);
  ...
  const items3 = [callback2(_require(4877).Stack, { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Expressive buttons" }) }), ];
  const obj10 = { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Expressive buttons" }) };
  ...
  obj9[0] = items3;
  items1[2] = callback3(_require(4877).Stack, obj9);
  ...
  const items4 = [callback2(_require(4877).Stack, { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Experimental premium buttons" }) }), ];
  const obj13 = { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Experimental premium buttons" }) };
  ...
  obj12[0] = items4;
  items1[3] = callback3(_require(4877).Stack, obj12);
  const obj15 = { children: null };
  const obj16 = { style: tmp.container, children: null };
  const items5 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Overlay buttons" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "Overlay buttons are meant to be used overlayed on top of an image or background color. They do not change colors with the theme." })];
  obj16[1] = items5;
  const items6 = [callback3(_require(4877).Stack, obj16), ];
  const obj14 = {
    children: closure_16.map((variant) => {
      obj = { style: lib.buttonContainer, children: closure_1_9(closure_1_17, obj) };
      obj = { variant };
  ...
  obj15[0] = items6;
  items1[4] = callback3(_require(4877).Stack, obj15);
  const obj18 = { children: null };
  const obj19 = { style: tmp.container, children: null };
  const items7 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Custom color icons" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "If a button needs to have an icon which has its own custom color, then create your own Button.Icon to pass as the icon prop." })];
  obj19[1] = items7;
  const items8 = [callback3(_require(4877).Stack, obj19), ];
  ...
  obj22[4] = callback2(_require(4879).Button.Icon, { source: registerAssetDefault11 });
  obj21[1] = callback2(_require(4879).Button, obj22);
  ...
  obj25[4] = callback2(_require(4879).Button.Icon, { variant: "entity", source: registerAssetDefault3 });
  obj24[1] = callback2(_require(4879).Button, obj25);
  items9[1] = callback2(closure_5, obj24);
  obj20[0] = items9;
  items8[1] = callback3(closure_5, obj20);
  obj18[0] = items8;
  items1[5] = callback3(_require(4877).Stack, obj18);
  const obj27 = { children: null };
  const obj26 = { variant: "entity", source: registerAssetDefault3 };
  const items10 = [callback2(_require(4877).Stack, { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Buttons with various text lengths" }) }), ];
  const obj29 = { children: null };
  const obj30 = { style: tmp.buttonContainer, children: null };
  const obj28 = { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Buttons with various text lengths" }) };
  obj30[1] = callback2(_require(4879).Button, {
    onPress() {
  ...
  obj32[1] = callback2(_require(4879).Button, {
    onPress() {
  ...
  items11[2] = callback2(closure_5, { style: tmp.buttonContainer, children: callback2(_require(4879).Button, obj35) });
  const obj34 = { style: tmp.buttonContainer, children: callback2(_require(4879).Button, obj35) };
  items11[3] = callback2(closure_5, { style: tmp.buttonContainer, children: callback2(_require(4879).Button, obj37) });
  obj29[0] = items11;
  items10[1] = callback3(closure_5, obj29);
  obj27[0] = items10;
  items1[6] = callback3(_require(4877).Stack, obj27);
  const obj38 = { children: null };
  const obj39 = { style: tmp.container, children: null };
  const items12 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Toggling button states" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "Use the useToggleButtonProps hook or the useToggleIconButtonProps hook to toggle a button between two states." }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "This hook changes the button presentation and adds some important accessibility attributes for a toggle button." })];
  obj39[1] = items12;
  const items13 = [callback3(_require(4877).Stack, obj39), ];
  const obj40 = { children: null };
  const obj36 = { style: tmp.buttonContainer, children: callback2(_require(4879).Button, obj37) };
  ...
  obj38[0] = items13;
  items1[7] = callback3(_require(4877).Stack, obj38);
  const obj43 = { children: null };
  const obj44 = { style: tmp.container, children: null };
  const items15 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Hierarchical icon buttons" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "While the primary variants of IconButton are supported, these should be used very rarely." }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "An icon button usually has a secondary function and should use the secondary variants." })];
  obj44[1] = items15;
  const items16 = [callback3(_require(4877).Stack, obj44), ];
  ...
  obj43[0] = items16;
  items1[8] = callback3(_require(4877).Stack, obj43);
  ...
  const items17 = [callback2(_require(4877).Stack, { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Sentiment icon buttons" }) }), ];
  const obj47 = { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Sentiment icon buttons" }) };
  ...
  obj46[0] = items17;
  items1[9] = callback3(_require(4877).Stack, obj46);
  ...
  const items18 = [callback2(_require(4877).Stack, { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Overlay icon buttons" }) }), ];
  const obj50 = { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Overlay icon buttons" }) };
  ...
  obj49[0] = items18;
  items1[10] = callback3(_require(4877).Stack, obj49);
  const obj52 = { children: null };
  const obj53 = { style: tmp.container, children: null };
  const items19 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Image buttons" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "Image buttons are rereserved for more branded buttons, like social media sharing buttons." })];
  obj53[1] = items19;
  const items20 = [callback3(_require(4877).Stack, obj53), ];
  ...
  obj52[0] = items20;
  items1[11] = callback3(_require(4877).Stack, obj52);
  const obj61 = { spacing: 24, children: null };
  const obj62 = { style: tmp.container, children: null };
  const items25 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "IconButton with a label" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "Icon buttons with a label require a different combination of props and will only appear in the 'lg' size." }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "It is highly recommended that a list of these buttons appear wrapped in a ScrollView, so that they will horizontally scroll when there are many buttons, when the text is longer through internationalization, or the text is larger through OS font size settings." })];
  obj62[1] = items25;
  const items26 = [callback3(_require(4877).Stack, obj62), , ];
  ...
  obj63[2] = callback2(_require(4877).Stack, { direction: "horizontal", justify: "center", style: tmp.buttonContainer, children: closure_12.map((variant) => callback2(closure_18, { variant, showLabel: true }, variant)) });
  ...
  const items27 = [
    callback2(_require(7963).IconButton, {
      variant: "secondary",
  ...
  items27[1] = callback2(_require(7963).IconButton, {
    variant: "secondary",
    icon: registerAssetDefault,
    label: "Supercalifragilisticexpialidocious",
    grow: true,
  ...
  items27[2] = callback2(_require(7963).IconButton, {
    variant: "secondary",
    icon: registerAssetDefault,
    label: "Supercalifragilisticexpialidocious",
    grow: true,
  ...
  obj66[3] = items27;
  obj65[2] = callback3(_require(4877).Stack, obj66);
  items26[2] = callback2(closure_6, obj65);
  obj61[1] = items26;
  items1[12] = callback3(_require(4877).Stack, obj61);
  ...
  const items28 = [callback2(_require(4877).Stack, { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "ImageButton with a label" }) }), , ];
  ...
  const obj71 = { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "ImageButton with a label" }) };
  ...
  obj73[3] = items29;
  obj72[2] = callback3(_require(4877).Stack, obj73);
  ...
  obj78[3] = items30;
  obj77[2] = callback3(_require(4877).Stack, obj78);
  items28[2] = callback2(closure_6, obj77);
  obj70[1] = items28;
  items1[13] = callback3(_require(4877).Stack, obj70);
  ...
  const items31 = [callback2(_require(4877).Stack, { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Mixing buttons" }) }), ];
  ...
  obj84[2] = items32;
  items31[1] = callback3(_require(5323).ButtonGroup, obj84);
  obj82[1] = items31;
  items1[14] = callback3(_require(4877).Stack, obj82);
  const obj85 = { children: null };
  const obj86 = { style: tmp.container, children: null };
  const items33 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Light Profile Themes" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "All buttons as they appear on a light profile theme" })];
  obj86[1] = items33;
  const items34 = [callback3(_require(4877).Stack, obj86), ];
  ...
  const obj83 = { style: tmp.container, children: callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Mixing buttons" }) };
  ...
  obj90[1] = items35;
  obj89[0] = callback3(_require(4877).Stack, obj90);
  obj88[4] = callback2(_require(5548).Card, obj89);
  obj87[3] = callback2(LinearGradientDefault, obj88);
  items34[1] = callback2(_require(4172).ThemeContextProvider, obj87);
  obj85[0] = items34;
  items1[15] = callback3(_require(4877).Stack, obj85);
  obj91 = { children: null };
  obj92 = { style: tmp.container, children: null };
  const items36 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Dark Profile Themes" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "All buttons as they appear on a dark profile theme" })];
  obj92[1] = items36;
  const items37 = [callback3(_require(4877).Stack, obj92), ];
  ...
  obj[1] = items38;
  obj[0] = callback3(_require(4877).Stack, obj);
  obj[4] = callback2(_require(5548).Card, obj);
  obj93[3] = callback2(LinearGradientDefault, obj);
  items37[1] = callback2(_require(4172).ThemeContextProvider, obj93);
  obj91[0] = items37;
  items1[16] = callback3(_require(4877).Stack, obj91);
  obj = { children: null };
  obj = { style: tmp.container, children: null };
  const items39 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Light Client Theme" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "All buttons as they appear on a light client theme" })];
  obj[1] = items39;
  const items40 = [callback3(_require(4877).Stack, obj), ];
  ...
  const items41 = [callback2(_require(5017).Gradient, obj), ];
  ...
  obj[1] = items42;
  obj[1] = callback3(_require(4877).Stack, obj);
  items41[1] = callback2(closure_5, obj);
  obj[1] = items41;
  obj[3] = callback3(closure_5, obj);
  items40[1] = callback2(_require(4172).ThemeContextProvider, obj);
  obj[0] = items40;
  items1[17] = callback3(_require(4877).Stack, obj);
  obj = { children: null };
  obj = { style: tmp.container, children: null };
  const items43 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Dark Client Theme" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "All buttons as they appear on a dark client theme" })];
  obj[1] = items43;
  const items44 = [callback3(_require(4877).Stack, obj), ];
  obj = { theme: 32.theme, gradient: 32, flags: null, children: null };
  obj = _require(4172);
  obj[2] = obj.setThemeFlag(0, _require(4172).ThemeContextFlags.MOBILE_DARK_GRADIENT_THEME_ENABLED);
  obj = { style: { position: "relative", padding: 16 }, children: null };
  obj = { absolute: true, gradient: 32 };
  const items45 = [callback2(_require(5017).Gradient, obj), ];
  obj = { style: null, children: null };
  obj = { backgroundColor: null, padding: 16, borderRadius: 16 };
  obj = _require(4172);
  ...
  obj[0] = items44;
  items1[18] = callback3(_require(4877).Stack, obj);
  obj = { children: null };
  obj = { style: tmp.container, children: null };
  const items47 = [callback2(_require(4440).Text, { variant: "heading-lg/bold", children: "Floating Action Button" }), callback2(_require(4440).Text, { variant: "text-sm/normal", children: "An ever-present icon button, giving the most important call to action in a compact way." })];
  obj[1] = items47;
  const items48 = [callback3(_require(4877).Stack, obj), callback2(closure_5, { style: { padding: 48 } })];
  obj[0] = items48;
  items1[19] = callback3(_require(4877).Stack, obj);
  obj2[1] = items1;
  obj1[0] = callback3(_require(4877).Stack, obj2);
  ...
  items49[1] = callback2(_require(8885).FloatingActionButton, obj);
  obj[0] = items49;
