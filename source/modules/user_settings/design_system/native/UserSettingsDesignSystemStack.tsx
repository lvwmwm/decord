...
// Function ID: 14724
// Name: StackBlock
// Dependencies: [19, 17, 21, 4285, 712, 4693, 5356, 4281, 2]
// Exports: default

// Module 14723 (StackBlock)
import "noop";
...
export default function UserSettingsDesignSystemStack() {
  ...
  const items2 = [callback(require(5356) /* PressableCard */.Card, obj1), , ];
  ...
  items2[1] = callback(require(5356) /* PressableCard */.Card, obj4);
  ...
  items2[2] = callback(require(5356) /* PressableCard */.Card, obj7);
  obj[1] = items2;
