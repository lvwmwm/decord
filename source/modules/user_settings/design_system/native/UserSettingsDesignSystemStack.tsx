...
// Function ID: 111054
// Name: StackBlock
// Dependencies: [31, 27, 33, 4165, 689, 4576, 5200, 4161, 2]
// Exports: default

// Module 14561 (StackBlock)
import "result";
...
export default function UserSettingsDesignSystemStack() {
  ...
  const obj1 = {};
  const obj2 = {};
  const items = [callback(require(4161) /* Text */.Text, { variant: "text-lg/bold", children: "Basic Example" }), callback(require(4161) /* Text */.Text, { variant: "text-md/medium", color: "text-subtle", children: "By default, stacks are vertical and have a spacing of 8." }), ];
  const obj3 = {};
  const items1 = [callback(StackBlock, {}), callback(StackBlock, {})];
  obj3.children = items1;
  items[2] = callback2(require(4576) /* Stack */.Stack, obj3);
  obj2.children = items;
  obj1.children = callback2(require(4576) /* Stack */.Stack, obj2);
  const items2 = [callback(require(5200) /* getCardBackgroundToken */.Card, obj1), , ];
  const obj4 = {};
  const obj5 = {};
  const items3 = [callback(require(4161) /* Text */.Text, { variant: "text-lg/bold", children: "Spacing" }), callback(require(4161) /* Text */.Text, { variant: "text-md/medium", color: "text-subtle", children: "You can control the spacing with the spacing prop. The spacing prop uses our 4px-based spacing scale. By default, stacks are vertical and have a spacing of 8." }), ];
  const obj6 = { spacing: 24 };
  const items4 = [callback(StackBlock, {}), callback(StackBlock, {})];
  obj6.children = items4;
  items3[2] = callback2(require(4576) /* Stack */.Stack, obj6);
  obj5.children = items3;
  obj4.children = callback2(require(4576) /* Stack */.Stack, obj5);
  items2[1] = callback(require(5200) /* getCardBackgroundToken */.Card, obj4);
  const obj7 = {};
  const obj8 = {};
  const items5 = [callback(require(4161) /* Text */.Text, { variant: "text-lg/bold", children: "Horizontal" }), callback(require(4161) /* Text */.Text, { variant: "text-md/medium", color: "text-subtle", children: "You can control the direction with the direction prop. The direction prop can be either horizontal or vertical." }), ];
  const obj9 = { direction: "horizontal" };
  const items6 = [callback(StackBlock, {}), callback(StackBlock, {})];
  obj9.children = items6;
  items5[2] = callback2(require(4576) /* Stack */.Stack, obj9);
  obj8.children = items5;
  obj7.children = callback2(require(4576) /* Stack */.Stack, obj8);
  items2[2] = callback(require(5200) /* getCardBackgroundToken */.Card, obj7);
  obj.children = items2;
