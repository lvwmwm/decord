...
// Function ID: 1342
// Name: b64ToProto
// Dependencies: [32, 682, 673, 1306, 1305, 1340, 1334, 12, 2]
...
// Module 1341 (b64ToProto)
import applyDefault from "apply" /* 12 */;
import create from "create" /* 1305 */;
import _mod1306 from "module_1306" /* 1306 */;
import create2 from "create" /* 1334 */;
import create3 from "create" /* 1340 */;
import closure_3 from "_slicedToArray" /* 32 */;
import { ZERO_STRING_GUILD_ID } from "ME" /* 673 */;
...
export const mutateUserGuildSettingsInternal = function mutateUserGuildSettingsInternal(guilds, closure_0, f72764) {
  let tmp = closure_0;
  ...
  return f72764(guilds.guilds[tmp]);
};
...
export const mutateUserChannelSettingsInternal = function mutateUserChannelSettingsInternal(channels, closure_0, f72764) {
  if (!(closure_0 in channels.channels)) {
    const ChannelSettings = create.ChannelSettings;
    channels.channels[closure_0] = ChannelSettings.create();
  }
  return f72764(channels.channels[closure_0]);
};
