...
export const mutateUserGuildSettingsInternal = function mutateUserGuildSettingsInternal(guilds, closure_0, f69986) {
  let tmp = closure_0;
  ...
  return f69986(guilds.guilds[tmp]);
};
...
export const mutateUserChannelSettingsInternal = function mutateUserChannelSettingsInternal(channels, closure_0, f69986) {
  if (!(closure_0 in channels.channels)) {
    const ChannelSettings = require(1306) /* create */.ChannelSettings;
    channels.channels[closure_0] = ChannelSettings.create();
  }
  return f69986(channels.channels[closure_0]);
};
