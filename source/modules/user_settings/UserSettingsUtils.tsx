...
export const mutateUserGuildSettingsInternal = function mutateUserGuildSettingsInternal(guilds, closure_0, f71236) {
  let tmp = closure_0;
  ...
  return f71236(guilds.guilds[tmp]);
};
...
export const mutateUserChannelSettingsInternal = function mutateUserChannelSettingsInternal(channels, closure_0, f71236) {
  if (!(closure_0 in channels.channels)) {
    const ChannelSettings = create.ChannelSettings;
    channels.channels[closure_0] = ChannelSettings.create();
  }
  return f71236(channels.channels[closure_0]);
};
