...
// Dependencies: [5, 32, 19, 17, 676, 21, 4342, 712, 6044, 595, 9916, 1628, 6035, 4887, 1236, 8972, 9918, 12300, 7790, 4338, 2]
// Exports: default

// Module 14831 (UserSettingsPushNotificationLogs)
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [callback3(first(6035).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue: first }), ];
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          obj3[0] = outer1_1(9918)(closure_0, false);
  ...
  items2[1] = callback3(first(7790).FlashList, obj1);
  obj[1] = items2;
