...
// Dependencies: [5, 32, 19, 17, 676, 21, 4189, 712, 6741, 595, 10350, 1581, 9239, 4717, 1236, 8196, 10352, 12296, 6676, 4185, 2]
// Exports: default

// Module 14529 (UserSettingsPushNotificationLogs)
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [callback3(first(9239).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue: first }), ];
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          obj3[0] = outer1_1(10352)(closure_0, false);
  ...
  obj[3] = callback3(first(12296).ShareIcon, {});
  items1[1] = callback3(first(4717).PressableOpacity, obj);
  obj[1] = items1;
  ...
  obj2.paddingBottom = first1(1581)().bottom + first1(712).space.PX_16;
  obj1[0] = obj2;
  obj1[1] = tmp6;
  obj1[2] = function renderItem(item) {
    ...
    const items = [outer1_7(first(4185).Text, obj), ];
    obj = { style: tmp9.code, variant: "text-sm/normal", children: null };
    const items1 = [str, "[", item.type, "]", " "];
    const items2 = [outer1_8(first(4185).Text, { style: tmp9.code, variant: "text-sm/normal", color: "text-brand", children: items1 }), item.title, " - ", item.content];
    obj[2] = items2;
    items[1] = outer1_8(first(4185).Text, obj);
    obj[1] = items;
    return outer1_8(outer1_6, obj, item.index);
  };
  items2[1] = callback3(first(6676).FlashList, obj1);
  obj[1] = items2;
