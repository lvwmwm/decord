...
// Dependencies: [5, 32, 19, 17, 676, 21, 4189, 712, 6738, 595, 10346, 1581, 9235, 4717, 1236, 8193, 10348, 12290, 6673, 4185, 2]
// Exports: default

// Module 14525 (UserSettingsPushNotificationLogs)
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [callback3(first(9235).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue: first }), ];
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          obj3[0] = outer1_1(10348)(closure_0, false);
  ...
  obj[3] = callback3(first(12290).ShareIcon, {});
  ...
  items2[1] = callback3(first(6673).FlashList, obj1);
  obj[1] = items2;
