...
// Dependencies: [5, 32, 19, 17, 676, 21, 4255, 712, 5895, 595, 9758, 1581, 5886, 4797, 1236, 8817, 9760, 12114, 7638, 4251, 2]
// Exports: default

// Module 14628 (UserSettingsPushNotificationLogs)
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [callback3(first(5886).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue: first }), ];
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          obj3[0] = outer1_1(9760)(closure_0, false);
  ...
  obj[3] = callback3(first(12114).ShareIcon, {});
  items1[1] = callback3(first(4797).PressableOpacity, obj);
  obj[1] = items1;
  ...
  items2[1] = callback3(first(7638).FlashList, obj1);
  obj[1] = items2;
