...
// Dependencies: [5, 697, 1234, 9616, 702, 4105, 2]
...
// Module 15404 (_initializeAndroidNotificationSettingsStore)
        ...
        if (0 === closure_3) {
          if (arg0 === 1) {
            ...
            if (obj16.isAndroid()) {
              ...
              obj1[0] = closure_1_1(9616).getLightsEnabled();
              return obj1;
            }
