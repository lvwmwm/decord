...
// Dependencies: [19, 17, 1903, 3953, 8022, 676, 21, 4302, 712, 1480, 647, 3947, 4298, 1236, 5375, 1297, 9901, 7533, 10380, 13816, 2]
// Exports: default

// Module 14573 (VideoUploadQualityNitroUpsell)
import module_13816 from "module_13816";
...
function VideoUploadQualityNitroUpsell() {
  ...
  const children = [callback(_require(4298).Text, obj), ];
