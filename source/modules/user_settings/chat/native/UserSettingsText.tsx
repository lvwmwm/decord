...
// Dependencies: [31, 27, 1850, 3817, 1279, 1280, 653, 33, 4165, 689, 675, 3838, 6186, 3869, 566, 3811, 1456, 6484, 1273, 9609, 4161, 1212, 7611, 4576, 5536, 5537, 7632, 7631, 2]
// Exports: default, setLowQualityImageMode, setStickerAutocomplete

// Module 14401 (trackSettingsUpdated)
import "result";
...
function setDataSavingMode(dataSavingMode) {
  ...
  const result = importDefault(6186).updatedUnsyncedSettings({ dataSavingMode });
}
function setVideoUploadQuality(videoUploadQuality) {
  ...
  const result = importDefault(6186).updatedUnsyncedSettings({ videoUploadQuality });
}
...
export const setStickerAutocomplete = function setStickerAutocomplete(enabled) {
  ...
  const IncludeStickersInAutocomplete = require(3838) /* explicitContentFromProto */.IncludeStickersInAutocomplete;
...
export const setLowQualityImageMode = function setLowQualityImageMode(lowQualityImageMode) {
  ...
  const result = importDefault(6186).updatedUnsyncedSettings({ lowQualityImageMode });
};
