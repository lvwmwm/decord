...
// Dependencies: [19, 17, 1922, 4013, 1303, 1304, 676, 21, 4342, 712, 698, 4034, 8747, 4065, 589, 4007, 1499, 7638, 1297, 10012, 4338, 1236, 8012, 4753, 5807, 5808, 8030, 8029, 2]
...
export const setStickerAutocomplete = function setStickerAutocomplete(enabled) {
  ...
  const IncludeStickersInAutocomplete = require(4034) /* explicitContentFromProto */.IncludeStickersInAutocomplete;
...
export const setLowQualityImageMode = function setLowQualityImageMode(lowQualityImageMode) {
  ...
  const result = importDefault(8747).updatedUnsyncedSettings({ lowQualityImageMode });
};
export const setDataSavingMode = function setDataSavingMode(dataSavingMode) {
  ...
  const obj = importDefault(698);
  const result = importDefault(8747).updatedUnsyncedSettings({ dataSavingMode });
};
export const setVideoUploadQuality = function setVideoUploadQuality(videoUploadQuality) {
  ...
  const obj = importDefault(698);
  const result = importDefault(8747).updatedUnsyncedSettings({ videoUploadQuality });
};
