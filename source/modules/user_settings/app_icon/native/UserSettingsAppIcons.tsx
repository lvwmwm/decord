// Module ID: 15007
// Function ID: 15008
// Dependencies: [5, 19, 17, 1922, 676, 7874, 21, 4444, 589, 7873, 1946, 5900, 7875, 8585, 8185, 15008, 9726, 8837, 8838, 1236, 2]

// Module 15007
import contextDefault from "context" /* 5900 */;
import _modDef9726 from "module_9726" /* 9726 */;
import BackwardsCompatibleAppIconRowsDefault from "BackwardsCompatibleAppIconRows" /* 15008 */;
...
const memoResult = importAllResult.memo(() => {
                ...
                if (null != tmp25) {
                  ...
                  if (id === tmp23) {
                    if (v0 !== id) {
                      ...
                      obj2[0] = lib(7873).setAppIcon(id, premiumType);
                      return obj2;
                    }
                  } else {
                    obj2 = lib(7873);
                    ...
                    obj3[0] = obj2.setAppIcon(lib(7875).FreemiumAppIconIds.DEFAULT, premiumType1);
                    return obj3;
                  }
                }
                tmp23 = lib;
  ...
  const children = [callback(stateFromStores(8185).Form, obj), ];
  ...
  if (!isPremiumResult) {
    ...
    obj3[1] = tmp9(_modDef9726, obj4);
    tmp9Result = tmp9(obj, obj3);
    const tmp6Result = _modDef9726;
  }
