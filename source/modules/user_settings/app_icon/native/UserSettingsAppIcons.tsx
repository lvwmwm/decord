// Module ID: 14789
// Function ID: 14790
// Dependencies: [5, 19, 17, 1922, 676, 7707, 21, 4342, 589, 7706, 1945, 5768, 7708, 8410, 8012, 14790, 9562, 8671, 8672, 1236, 2]
...
const memoResult = require("getSystemLocale").memo(() => {
                ...
                if (null != tmp25) {
                  ...
                  if (id === tmp23) {
                    if (v0 !== id) {
                      ...
                      obj2[0] = lib(7706).setAppIcon(id, premiumType);
                      return obj2;
                    }
                  } else {
                    obj2 = lib(7706);
                    ...
                    obj3[0] = obj2.setAppIcon(lib(7708).FreemiumAppIconIds.DEFAULT, premiumType1);
                    return obj3;
                  }
                }
                tmp23 = lib;
  ...
  obj1[1] = callback(importDefault(14790), obj2);
  obj[0] = callback(obj, obj1);
  const children = [callback(stateFromStores(8012).Form, obj), ];
  ...
  if (!isPremiumResult) {
    ...
    obj3[1] = tmp9(importDefault(9562), obj4);
    tmp9Result = tmp9(obj, obj3);
    const tmp6Result = importDefault(9562);
  }
