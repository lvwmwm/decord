// Module ID: 15071
// Function ID: 15072
// Dependencies: [5, 19, 17, 1922, 676, 8110, 21, 4445, 589, 12938, 1946, 5905, 8111, 8101, 8295, 15072, 8892, 8325, 8149, 1236, 2]

// Module 15071
import contextDefault from "context" /* 5905 */;
import _modDef8892 from "module_8892" /* 8892 */;
import BackwardsCompatibleAppIconRowsDefault from "BackwardsCompatibleAppIconRows" /* 15072 */;
...
const memoResult = importAllResult.memo(() => {
                ...
                if (null != tmp25) {
                  ...
                  if (id === tmp23) {
                    if (v0 !== id) {
                      ...
                      obj2[0] = lib(12938).setAppIcon(id, premiumType);
                      return obj2;
                    }
                  } else {
                    obj2 = lib(12938);
                    ...
                    obj3[0] = obj2.setAppIcon(lib(8111).FreemiumAppIconIds.DEFAULT, premiumType1);
                    return obj3;
                  }
                }
                tmp23 = lib;
  ...
  const children = [callback(stateFromStores(8295).Form, obj), ];
  ...
  if (!isPremiumResult) {
    ...
    obj3[1] = tmp9(_modDef8892, obj4);
    tmp9Result = tmp9(obj, obj3);
    const tmp6Result = _modDef8892;
  }
