// Module ID: 14624
// Function ID: 14625
// Dependencies: [5, 19, 17, 1903, 676, 7583, 21, 4285, 589, 7582, 1926, 5649, 7584, 8285, 7890, 14625, 9430, 8545, 8546, 1236, 2]
...
const memoResult = require("getSystemLocale").memo(() => {
                ...
                if (null != tmp25) {
                  ...
                  if (id === tmp23) {
                    if (v0 !== id) {
                      ...
                      obj2[0] = lib(7582).setAppIcon(id, premiumType);
                      return obj2;
                    }
                  } else {
                    obj2 = lib(7582);
                    ...
                    obj3[0] = obj2.setAppIcon(lib(7584).FreemiumAppIconIds.DEFAULT, premiumType1);
                    return obj3;
                  }
                }
                tmp23 = lib;
  ...
  obj1[1] = callback(importDefault(14625), obj2);
  obj[0] = callback(obj, obj1);
  const children = [callback(stateFromStores(7890).Form, obj), ];
