// Module ID: 14780
// Function ID: 14781
// Dependencies: [5, 19, 17, 1922, 676, 7703, 21, 4344, 589, 7702, 1945, 5767, 7704, 8406, 8008, 14781, 9558, 8667, 8668, 1236, 2]
...
const memoResult = require("getSystemLocale").memo(() => {
                ...
                if (null != tmp25) {
                  ...
                  if (id === tmp23) {
                    if (v0 !== id) {
                      ...
                      obj2[0] = lib(7702).setAppIcon(id, premiumType);
                      return obj2;
                    }
                  } else {
                    obj2 = lib(7702);
                    ...
                    obj3[0] = obj2.setAppIcon(lib(7704).FreemiumAppIconIds.DEFAULT, premiumType1);
                    return obj3;
                  }
                }
                tmp23 = lib;
  ...
  obj1[1] = callback(importDefault(14781), obj2);
  obj[0] = callback(obj, obj1);
  const children = [callback(stateFromStores(8008).Form, obj), ];
  ...
  if (!isPremiumResult) {
    ...
    obj3[1] = tmp9(importDefault(9558), obj4);
    tmp9Result = tmp9(obj, obj3);
    const tmp6Result = importDefault(9558);
  }
