// Module ID: 14586
// Function ID: 14587
// Dependencies: [5, 19, 17, 1874, 676, 7555, 21, 4255, 589, 7554, 1897, 5595, 7556, 8145, 7749, 14587, 9401, 8404, 8405, 1236, 2]
...
const memoResult = require("getSystemLocale").memo(() => {
                ...
                if (null != tmp25) {
                  ...
                  if (id === tmp23) {
                    if (v0 !== id) {
                      ...
                      obj2[0] = lib(7554).setAppIcon(id, premiumType);
                      return obj2;
                    }
                  } else {
                    obj2 = lib(7554);
                    ...
                    obj3[0] = obj2.setAppIcon(lib(7556).FreemiumAppIconIds.DEFAULT, premiumType1);
                    return obj3;
                  }
                }
                tmp23 = lib;
  ...
  obj1[1] = callback(importDefault(14587), obj2);
  obj[0] = callback(obj, obj1);
  const children = [callback(stateFromStores(7749).Form, obj), ];
  ...
  if (!isPremiumResult) {
    ...
    obj3[1] = tmp9(importDefault(9401), obj4);
    tmp9Result = tmp9(obj, obj3);
    const tmp6Result = importDefault(9401);
  }
