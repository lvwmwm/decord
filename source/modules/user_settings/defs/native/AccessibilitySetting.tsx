...
// Function ID: 14628
// Name: items
// Dependencies: [32, 19, 676, 1388, 21, 1377, 6063, 1297, 1236, 10493, 14628, 14630, 2]
...
createToggle = {
  ...
  useTrailing() {
    let tmp4;
    let obj = require(6063) /* useSelectedDismissibleContent */;
...
createToggle = {
  ...
  getComponent() {
    return require(14630) /* SettingsAccessibilityScreen */.default;
  }
};
