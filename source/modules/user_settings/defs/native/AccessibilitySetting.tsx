...
// Function ID: 14475
// Name: items
// Dependencies: [32, 19, 676, 1369, 21, 1358, 5943, 1297, 1236, 10364, 14475, 14477, 2]
...
createToggle = {
  ...
  useTrailing() {
    let tmp4;
    let obj = require(5943) /* useSelectedDismissibleContent */;
...
createToggle = {
  ...
  getComponent() {
    return require(14477) /* SettingsAccessibilityScreen */.default;
  }
};
