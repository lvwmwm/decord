...
// Function ID: 14571
// Name: items
// Dependencies: [32, 19, 676, 1388, 21, 1377, 6024, 1297, 1236, 10452, 14571, 14573, 2]
...
createToggle = {
  ...
  useTrailing() {
    let tmp4;
    let obj = require(6024) /* useSelectedDismissibleContent */;
...
createToggle = {
  ...
  getComponent() {
    return require(14573) /* SettingsAccessibilityScreen */.default;
  }
};
