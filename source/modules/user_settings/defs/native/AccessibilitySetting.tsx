...
// Function ID: 14339
// Name: items
// Dependencies: [32, 19, 676, 1369, 21, 1358, 8438, 1297, 1236, 10116, 14339, 14341, 2]
...
createToggle = {
  ...
  useTrailing() {
    let tmp4;
    let obj = require(8438) /* useSelectedDismissibleContent */;
...
createToggle = {
  ...
  getComponent() {
    return require(14341) /* SettingsAccessibilityScreen */.default;
  }
};
