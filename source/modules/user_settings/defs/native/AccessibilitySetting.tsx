...
// Function ID: 14642
// Name: items
// Dependencies: [32, 19, 676, 1388, 21, 1377, 6086, 1297, 1236, 10421, 14642, 14644, 2]
...
createToggle = {
  ...
  useTrailing() {
    let tmp4;
    let obj = require(6086) /* useSelectedDismissibleContent */;
...
createToggle = {
  ...
  getComponent() {
    return require(14644) /* SettingsAccessibilityScreen */.default;
  }
};
