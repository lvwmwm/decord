...
// Function ID: 14730
// Name: route
// Dependencies: [676, 10493, 1236, 14730, 10582, 14731, 2]
...
obj = {
  ...
  usePredicate() {
    return require(14730) /* useWebBrowserSettingOptions */.useWebBrowserSettingOptions().length > 1;
  },
  parent: null,
