...
// Function ID: 14672
// Name: route
// Dependencies: [676, 10452, 1236, 14672, 10541, 14673, 2]
...
obj = {
  ...
  usePredicate() {
    return require(14672) /* useWebBrowserSettingOptions */.useWebBrowserSettingOptions().length > 1;
  },
  parent: null,
