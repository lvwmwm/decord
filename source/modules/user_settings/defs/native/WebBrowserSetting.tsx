...
// Function ID: 14744
// Name: route
// Dependencies: [676, 10421, 1236, 14744, 10514, 14745, 2]
...
obj = {
  ...
  usePredicate() {
    return require(14744) /* useWebBrowserSettingOptions */.useWebBrowserSettingOptions().length > 1;
  },
  parent: null,
