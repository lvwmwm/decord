...
// Dependencies: [676, 14656, 1377, 10493, 1236, 3371, 14658, 13981, 14660, 2]
...
obj = {
  ...
  usePredicate() {
    return "settings" === require(13981) /* apexExperiment */.useCustomTypingIndicatorConfig("TypingIndicatorSetting").entryPoint;
  },
  screen: obj
};
obj = {
