...
// Function ID: 14993
// Name: toggle
// Dependencies: [8127, 10407, 1236, 4034, 13272, 2]
...
const toggle = createToggle.createToggle({
  ...
  useValue() {
    const HideFriendRequestNotes = require(4034) /* explicitContentFromProto */.HideFriendRequestNotes;
  ...
  usePredicate() {
    return importDefault(13272).useConfig({ location: "FriendRequestsNotesSetting" }).enabled;
  }
});
const obj = {
  useTitle() {
