...
// Function ID: 14515
// Name: getClientInfo
// Dependencies: [10464, 21, 1578, 4157, 10976, 5543, 3889, 5551, 5242, 1236, 5553, 4053, 4137, 4169, 10116, 9149, 3862, 2]
// Exports: getClientInfoString

// Module 14514 (getClientInfo)
...
function getClientInfo() {
  ...
  let tmp;
  if (overrides != null) {
    tmp = overrides[require(undefined, 10976) /* setBuildOverrideForBranch */.DEVICE_FIELD];
  }
  let str2 = "N/A";
...
function ClientClientInfoActionSheet() {
  ...
  obj[2] = function onPress() {
    callback(5543).copy(callback2().appVersion);
    const obj = callback(5543);
    const result = callback(3889).presentCopiedToClipboard();
  };
  ...
  obj1[2] = function onPress() {
    callback(5543).copy(callback2().buildNumber);
    const obj = callback(5543);
    const result = callback(3889).presentCopiedToClipboard();
  };
  items[1] = callback(require(5553) /* ActionSheetRowIcon */.ActionSheetRow, obj1);
  ...
  obj2[2] = function onPress() {
    callback(5543).copy(callback2().releaseChannel);
    const obj = callback(5543);
    const result = callback(3889).presentCopiedToClipboard();
  };
  items[2] = callback(require(5553) /* ActionSheetRowIcon */.ActionSheetRow, obj2);
  ...
  obj3[2] = function onPress() {
    callback(5543).copy(callback2().manifest);
    const obj = callback(5543);
    const result = callback(3889).presentCopiedToClipboard();
  };
  items[3] = callback(require(5553) /* ActionSheetRowIcon */.ActionSheetRow, obj3);
  ...
  obj4[2] = function onPress() {
    callback(5543).copy(callback2().buildOverride);
    const obj = callback(5543);
    const result = callback(3889).presentCopiedToClipboard();
  };
  items[4] = callback(require(5553) /* ActionSheetRowIcon */.ActionSheetRow, obj4);
  let obj7 = require(4053) /* isFabric */;
  let tmp4Result = null;
  if (obj7.isFabric()) {
    const obj5 = { label: "React Native New Architecture", subLabel: "Enabled", onPress: null };
    obj5[2] = function onPress() {
      callback(5543).copy("React Native New Architecture is enabled.");
      const obj = callback(5543);
      const result = callback(3889).presentCopiedToClipboard();
    };
    tmp4Result = tmp4(tmp2(5553).ActionSheetRow, obj5);
  }
  items[5] = tmp4Result;
  tmp4Result = null;
  if (tmp2Result.isFabric()) {
    let str = "Disabled";
    if (tmp2(4053).isBridgeless) {
      str = "Enabled";
    }
    ...
    tmp4Result = tmp4(tmp2(5553).ActionSheetRow, obj6);
  }
  items[6] = tmp4Result;
  const items1 = [closure_5(require(5553) /* ActionSheetRowIcon */.ActionSheetRow.Group, { hasIcons: false, children: items }), ];
  obj7 = { hasIcons: true, children: null };
  const obj8 = { icon: null, label: null, onPress: null };
  obj8[0] = callback(require(4137) /* CopyIcon */.CopyIcon, {});
  ...
  obj8[2] = function onPress() {
    ...
    const deviceInfo = callback(4169).getDeviceInfo();
    const obj = callback(4169);
    const combined = "App: " + appVersion + " (" + buildNumber + ") " + releaseChannel + "; Manifest: " + manifest + "; Build Override: " + buildOverride + "; " + "Device: " + deviceInfo + " OS " + callback(4169).getSystemVersion() + ";";
    const obj2 = callback(4169);
    callback(5543).copy(combined);
    const obj3 = callback(5543);
    const result = callback(3889).presentCopiedToClipboard();
  };
  obj7[1] = callback(require(5553) /* ActionSheetRowIcon */.ActionSheetRow, obj8);
  items1[1] = callback(require(5553) /* ActionSheetRowIcon */.ActionSheetRow.Group, obj7);
  obj[2] = items1;
  return closure_5(require(5551) /* ActionSheet */.ActionSheet, obj);
}
