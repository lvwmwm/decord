...
// Function ID: 14222
// Name: route
// Dependencies: [19, 676, 21, 14222, 14223, 8078, 712, 1236, 2335, 10669, 6884, 14226, 2]
...
createToggle = {
  useTitle() {
    ...
    return intl.string(importDefault(2335).RZqaJn);
  },
  parent: null,
    ...
    if (isParentalConsentBannerActive) {
      ...
      if (null != daysRemaining) {
        ...
        if (daysRemaining >= 0) {
          ...
          obj[3] = intl.string(importDefault(2335).wucWfE);
...
createToggle = {
  ...
  getComponent() {
    return require(14226) /* FamilyCenterLoading */.default;
  }
};
