...
// Function ID: 13982
// Name: route
// Dependencies: [19, 676, 21, 13982, 13983, 7760, 712, 1236, 2255, 10272, 4769, 13986, 2]
    ...
    if (isParentalConsentBannerActive) {
      ...
      if (null != daysRemaining) {
        ...
        if (daysRemaining >= 0) {
          ...
          tmp6 = jsx(tmp(7760).WarningIcon, { size: "sm", color: null, accessible: true, accessibilityLabel: null });
        }
      }
    }
    return tmp6;
...
createToggle = {
  ...
  getComponent() {
    return require(13986) /* FamilyCenterLoading */.default;
  }
};
