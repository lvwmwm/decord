...
// Function ID: 14740
// Name: handleLogout
// Dependencies: [21, 595, 691, 5129, 10773, 7593, 5827, 4644, 4647, 1236, 10446, 10789, 2]

// Module 14739 (handleLogout)
...
function handleLogout() {
  ...
  const result1 = importDefault(10773).clearAllNotifications();
