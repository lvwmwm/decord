...
// Function ID: 13857
// Name: pressable
// Dependencies: [7753, 7705, 13850, 13846, 5860, 5879, 1236, 13847, 1306, 10116, 2]
...
const pressable = createToggle.createPressable({
  ...
  useTrailing: function useObscuredContentGuildsSettingValue() {
    ...
    return require(5860) /* redactionSettingToRenderedString */.redactionSettingToRenderedString(obj.useExplicitContentSettingOrDefault().explicitContentGuilds)();
  },
