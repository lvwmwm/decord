...
// Function ID: 14169
// Name: route
// Dependencies: [676, 10380, 1236, 10394, 14169, 14171, 7121, 5165, 2]
...
obj = {
  ...
  usePredicate() {
    return require(10394) /* getIsEligibleForQuests */.getIsEligibleForQuests();
  },
  parent: null,
...
obj = {
  ...
  getComponent() {
    return require(14171) /* QuestHomeSetting */.default;
  }
};
