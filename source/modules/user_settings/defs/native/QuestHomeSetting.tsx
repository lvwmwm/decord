...
// Function ID: 14315
// Name: route
// Dependencies: [676, 10407, 1236, 10421, 14315, 14317, 7226, 5207, 2]
...
obj = {
  ...
  usePredicate() {
    return require(10421) /* getIsEligibleForQuests */.getIsEligibleForQuests();
  },
  parent: null,
...
obj = {
  ...
  getComponent() {
    return require(14317) /* QuestHomeSetting */.default;
  }
};
