...
// Function ID: 106733
// Name: route
// Dependencies: [653, 10059, 1212, 10428, 13959, 13961, 5953, 4982, 2]
...
obj = {
  ...
  usePredicate() {
    return require(10428) /* getIsEligibleForQuests */.getIsEligibleForQuests();
  },
  parent: null,
...
obj = {
  ...
  getComponent() {
    return require(13961) /* parseSortMethod */.default;
  }
};
