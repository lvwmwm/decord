...
// Function ID: 14241
// Name: route
// Dependencies: [676, 10447, 1236, 10461, 14241, 14243, 7181, 5166, 2]
...
obj = {
  ...
  usePredicate() {
    return require(10461) /* getIsEligibleForQuests */.getIsEligibleForQuests();
  },
  parent: null,
...
obj = {
  ...
  getComponent() {
    return require(14243) /* QuestHomeSetting */.default;
  }
};
