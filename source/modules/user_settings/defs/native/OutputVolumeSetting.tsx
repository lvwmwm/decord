...
// Function ID: 14496
// Name: volumeSlider
// Dependencies: [4351, 8084, 589, 10452, 1236, 9161, 10854, 2]

// Module 14495 (volumeSlider)
...
createToggle = {
  ...
  usePredicate() {
    return importDefault(10854).useConfig({ location: "OutputVolumeSetting" }).audioOutputPresent;
  }
};
