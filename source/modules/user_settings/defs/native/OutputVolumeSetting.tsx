...
// Function ID: 14553
// Name: volumeSlider
// Dependencies: [4393, 8127, 589, 10407, 1236, 9205, 10823, 2]

// Module 14552 (volumeSlider)
...
createToggle = {
  ...
  usePredicate() {
    return importDefault(10823).useConfig({ location: "OutputVolumeSetting" }).audioOutputPresent;
  }
};
