...
// Function ID: 14488
// Name: volumeSlider
// Dependencies: [4351, 8082, 589, 10447, 1236, 9155, 10849, 2]

// Module 14487 (volumeSlider)
...
createToggle = {
  ...
  usePredicate() {
    return importDefault(10849).useConfig({ location: "OutputVolumeSetting" }).audioOutputPresent;
  }
};
