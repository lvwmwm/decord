...
// Function ID: 14566
// Name: volumeSlider
// Dependencies: [4393, 8148, 589, 10421, 1236, 9219, 10839, 2]

// Module 14565 (volumeSlider)
...
createToggle = {
  ...
  usePredicate() {
    return importDefault(10839).useConfig({ location: "OutputVolumeSetting" }).audioOutputPresent;
  }
};
