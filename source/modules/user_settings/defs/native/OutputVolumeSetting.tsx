...
// Function ID: 14265
// Name: volumeSlider
// Dependencies: [4236, 7753, 589, 10116, 1236, 8834, 10764, 2]

// Module 14264 (volumeSlider)
...
createToggle = {
  ...
  usePredicate() {
    return importDefault(10764).useConfig({ location: "OutputVolumeSetting" }).audioOutputPresent;
  }
};
