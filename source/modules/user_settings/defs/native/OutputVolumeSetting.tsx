...
// Function ID: 14486
// Name: volumeSlider
// Dependencies: [4351, 8082, 589, 10446, 1236, 9155, 10848, 2]

// Module 14485 (volumeSlider)
...
createToggle = {
  ...
  usePredicate() {
    return importDefault(10848).useConfig({ location: "OutputVolumeSetting" }).audioOutputPresent;
  }
};
