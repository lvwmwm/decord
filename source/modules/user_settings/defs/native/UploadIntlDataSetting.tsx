...
// Dependencies: [5, 17, 676, 21, 644, 705, 1578, 1239, 1273, 1236, 500, 530, 3890, 4145, 10120, 13674, 13873, 2]

// Module 14500 (_serializeIntlData)
      ...
      try {
        ...
        if (0 === c4) {
          ...
          if (2 === tmp9) {
            ...
            obj1[1] = ANDROID_APP(4145).CircleInformationIcon;
            obj5.open(obj1);
            dependencyMap = 0;
            (function onUploadIntlDataRequestFinish() {
              ANDROID_APP(705).batchUpdates(() => state.setState({ isDisabled: true, isUploading: false }));
            ...
            obj5[1] = ANDROID_APP(4145).CircleInformationIcon;
            obj.open(obj5);
            dependencyMap = 1;
          }
          dependencyMap = 0;
