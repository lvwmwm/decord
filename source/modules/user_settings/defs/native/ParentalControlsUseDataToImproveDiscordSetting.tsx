...
// Function ID: 111510
// Name: toggle
// Dependencies: [5765, 7697, 653, 5767, 13790, 10059, 1212, 2]
...
createToggle = {
  ...
  useValue: function useDataToImproveDiscordSettingValue() {
    return require(13790) /* useParentalControlledExplicitContentSettings */.useParentalControlledConsent(Consents.USAGE_STATISTICS).hasConsented;
  },
  onValueChange: function handleUsageStatisticsChange(arg0) {
    ...
    if (null != selectedTeenId) {
      ...
      importDefault(5767).updateTeenConsents(selectedTeenId, items1, items2);
