...
function ViewDebugLogsActionSheetRow(icon) {
  ...
  return callback(title(5648).ActionSheetRow, {
    icon: icon.icon,
    label: title,
    onPress() {
...
function ViewDebugLogsActionSheet() {
  ...
  if (obj5.isAndroid()) {
    ...
    obj2[0] = tmp(tmp2(9649).ChannelNotificationIcon, {});
  ...
  items[2] = tmpResult;
  obj[1] = closure_6(require(5648) /* ActionSheetRowIcon */.ActionSheetRow.Group, { hasIcons: true, children: items });
