...
// Function ID: 14973
// Name: toggle
// Dependencies: [14961, 8127, 4034, 6056, 10407, 1236, 2]
...
const toggle = createToggle.createToggle({
  ...
  useValue() {
    const ActivityRestrictedGuilds = require(4034) /* explicitContentFromProto */.ActivityRestrictedGuilds;
    const setting = ActivityRestrictedGuilds.useSetting();
    return !setting.includes(callback2().selectedGuildId);
  },
  onValueChange(arg0) {
    const tmp = callback();
    const sanitizedActivityRestrictedGuilds = require(6056) /* getSanitizedRestrictedGuilds */.getSanitizedActivityRestrictedGuilds();
    if (arg0) {
