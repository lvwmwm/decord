...
// Function ID: 111405
// Name: toggle
// Dependencies: [14591, 7697, 3804, 6449, 10059, 1212, 2]
...
const toggle = createToggle.createToggle({
  ...
  onValueChange(arg0) {
    const tmp = callback();
    const sanitizedActivityRestrictedGuilds = require(6449) /* getSanitizedRestrictedGuilds */.getSanitizedActivityRestrictedGuilds();
    if (arg0) {
