...
obj = {
  useTitle() {
    ...
    return intl.string(arg1(dependencyMap[8]).t.mozb8f);
  },
  ...
  useValue: function useFriendRequestsMutualGuildsSettingValue() {
    ...
    const arg1 = setting;
    const items = [setting];
    return React.useMemo(() => setting(closure_2[5]).computeFlags(setting), items).mutualGuilds;
  },
...
const result = arg1(dependencyMap[9]).fileFinishedImporting("modules/user_settings/defs/native/FriendRequestsMutualGuildsSetting.tsx");
