// Module ID: 14819
// Function ID: 14820
// Dependencies: [1625, 1236, 14820, 10407, 9583, 4034, 2]
...
let obj = {
  ...
  useTrailing: function useAppVersionSettingTrailing() {
    const clientInfoString = require(14820) /* getClientInfo */.getClientInfoString(closure_3.ReleaseChannel);
    const obj = require(14820) /* getClientInfo */;
    const obj2 = require(14820) /* getClientInfo */;
    ...
    const clientInfoString2 = require(14820) /* getClientInfo */.getClientInfoString(closure_3.Version);
    if (hasItem) {
