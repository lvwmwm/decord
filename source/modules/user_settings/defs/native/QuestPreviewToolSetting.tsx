...
// Function ID: 108616
// Name: route
// Dependencies: [653, 10059, 1212, 10428, 13960, 14128, 2]
...
obj = {
  ...
  usePredicate() {
    return require(10428) /* _createForOfIteratorHelperLoose */.useIsPreviewerOnAnyQuest();
  },
  parent: null,
...
obj = {
  ...
  getComponent() {
    return require(14128) /* SettingsQuestPreviewScreen */.default;
  }
};
