...
// Function ID: 14891
// Name: toggle
// Dependencies: [1891, 14884, 8082, 10448, 14071, 14891, 3974, 4642, 1236, 4732, 6013, 14892, 10447, 2]
...
createToggle = {
  useTitle() {
    const allowFriendsFromMutualGuildsOnly = require(14892) /* useAllowFriendsFromMutualGuildsOnly */.useAllowFriendsFromMutualGuildsOnly();
  ...
  useIsDisabled() {
    let isParentallyControlled = require(14071) /* useParentalControlledExplicitContentSettings */.useIsParentallyControlled();
