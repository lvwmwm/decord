...
// Function ID: 14765
// Name: toggle
// Dependencies: [1862, 14758, 7864, 10334, 13948, 14765, 3928, 4593, 1236, 4683, 5907, 14766, 10333, 2]
...
createToggle = {
  useTitle() {
    const allowFriendsFromMutualGuildsOnly = require(14766) /* useAllowFriendsFromMutualGuildsOnly */.useAllowFriendsFromMutualGuildsOnly();
  ...
  onValueChange: function onAllowDirectMessagesFromServerMembersValueChange(arg0) {
    ...
    if (tmp === closure_6) {
      ...
      let RestrictedGuildIds = _require(3928).RestrictedGuildIds;
      const _Array = Array;
  ...
  useIsDisabled() {
    let isParentallyControlled = require(13948) /* useParentalControlledExplicitContentSettings */.useIsParentallyControlled();
