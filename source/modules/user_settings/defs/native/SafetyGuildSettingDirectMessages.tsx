...
// Function ID: 14803
// Name: toggle
// Dependencies: [1891, 14796, 8005, 10365, 13985, 14803, 3957, 4623, 1236, 4713, 5934, 14804, 10364, 2]
...
createToggle = {
  useTitle() {
    const allowFriendsFromMutualGuildsOnly = require(14804) /* useAllowFriendsFromMutualGuildsOnly */.useAllowFriendsFromMutualGuildsOnly();
  ...
  onValueChange: function onAllowDirectMessagesFromServerMembersValueChange(arg0) {
    ...
    if (tmp === closure_6) {
      ...
      let RestrictedGuildIds = _require(3957).RestrictedGuildIds;
      const _Array = Array;
  ...
  useIsDisabled() {
    let isParentallyControlled = require(13985) /* useParentalControlledExplicitContentSettings */.useIsParentallyControlled();
