...
// Function ID: 14973
// Name: toggle
// Dependencies: [1910, 14966, 8148, 10422, 14149, 14973, 4034, 4705, 1236, 4795, 6077, 14974, 10421, 2]
...
createToggle = {
  useTitle() {
    const allowFriendsFromMutualGuildsOnly = require(14974) /* useAllowFriendsFromMutualGuildsOnly */.useAllowFriendsFromMutualGuildsOnly();
  ...
  useIsDisabled() {
    let isParentallyControlled = require(14149) /* useParentalControlledExplicitContentSettings */.useIsParentallyControlled();
