...
// Function ID: 14889
// Name: toggle
// Dependencies: [1891, 14882, 8082, 10447, 14069, 14889, 3974, 4642, 1236, 4732, 6013, 14890, 10446, 2]
...
createToggle = {
  useTitle() {
    const allowFriendsFromMutualGuildsOnly = require(14890) /* useAllowFriendsFromMutualGuildsOnly */.useAllowFriendsFromMutualGuildsOnly();
  ...
  onValueChange: function onAllowDirectMessagesFromServerMembersValueChange(arg0) {
    ...
    if (tmp === closure_6) {
      ...
      let RestrictedGuildIds = _require(3974).RestrictedGuildIds;
      const _Array = Array;
  ...
  useIsDisabled() {
    let isParentallyControlled = require(14069) /* useParentalControlledExplicitContentSettings */.useIsParentallyControlled();
