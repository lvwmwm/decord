...
// Function ID: 14819
// Name: toggle
// Dependencies: [1891, 14812, 8022, 10381, 13999, 14819, 3974, 4640, 1236, 4730, 5953, 14820, 10380, 2]
...
createToggle = {
  useTitle() {
    const allowFriendsFromMutualGuildsOnly = require(14820) /* useAllowFriendsFromMutualGuildsOnly */.useAllowFriendsFromMutualGuildsOnly();
  ...
  useIsDisabled() {
    let isParentallyControlled = require(13999) /* useParentalControlledExplicitContentSettings */.useIsParentallyControlled();
