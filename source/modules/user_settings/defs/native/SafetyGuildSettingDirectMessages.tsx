...
// Function ID: 15255
// Name: toggle
// Dependencies: [1910, 15248, 7816, 10989, 14379, 15255, 4134, 4809, 1236, 4899, 6194, 15256, 10988, 2]
...
import useAllowFriendsFromMutualGuildsOnly from "useAllowFriendsFromMutualGuildsOnly" /* 15256 */;
...
createToggle = {
  ...
  onValueChange: function onAllowDirectMessagesFromServerMembersValueChange(arg0) {
    ...
    if (tmp === closure_6) {
      ...
      let RestrictedGuildIds = _require(4134).RestrictedGuildIds;
      const _Array = Array;
