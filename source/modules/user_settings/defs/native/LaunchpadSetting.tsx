...
// Function ID: 110460
// Name: radio
// Dependencies: [7733, 10455, 3838, 1282, 1212, 10099, 10456, 2]
...
const radio = createToggle.createRadio({
  ...
  onValueChange: function onLaunchpadSettingValueChange(arg0) {
    if (LaunchPadTypes.GESTURE_FULL === arg0) {
      const LaunchPadModeSetting3 = require(3838) /* explicitContentFromProto */.LaunchPadModeSetting;
      ...
      const LaunchPadModeSetting2 = require(3838) /* explicitContentFromProto */.LaunchPadModeSetting;
      ...
      const LaunchPadModeSetting4 = require(3838) /* explicitContentFromProto */.LaunchPadModeSetting;
