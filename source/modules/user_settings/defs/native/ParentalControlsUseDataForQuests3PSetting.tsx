...
// Function ID: 14997
// Name: toggle
// Dependencies: [7044, 8127, 7383, 14146, 10407, 1236, 2]
...
createToggle = {
  ...
  useValue: function useDataToSupportQuests3PSettingValue() {
    ...
    const ParentalControlledQuests3PDataOptedOut = require(14146) /* result */.ParentalControlledQuests3PDataOptedOut;
