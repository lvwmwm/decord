...
// Dependencies: [5, 17, 7756, 21, 700, 705, 3802, 11771, 585, 3890, 10120, 13873, 2]

// Module 13872 (setFindYourFriendsDeletionIsLoading)
...
identity = {
  ...
  useIsDisabled: function useIsFindYourFriendsDeletionDisabled() {
    return callback2((isLoading) => isLoading.isLoading, require(3802) /* isIterable */.shallow);
  },
  ...
  useTrailing: function useIsFindYourFriendsDeletionTrailing() {
    let tmp = null;
    if (callback2((isLoading) => isLoading.isLoading, require(3802) /* isIterable */.shallow)) {
