...
// Dependencies: [19, 7702, 21, 7258, 13908, 2284, 6967, 4295, 2]
// Exports: default

// Module 13977 (FamilyCenterSettingsParentalControlsNotice)
import "noop";
...
export default function FamilyCenterSettingsParentalControlsNotice() {
  let obj = activeLinkUserIds(7258);
  ...
  return jsx(importDefault(13908), { label: null, noticeType: null, labelHook: null, count: null });
};
