...
// Dependencies: [19, 17, 676, 21, 3866, 6509, 5558, 1236, 5559, 1384, 2]
// Exports: default
...
export default function UserSettingsFriendRequests() {
  let FriendSourceFlagsSetting = setting(3866).FriendSourceFlagsSetting;
  ...
  const items1 = [callback(setting(5559).TableSwitchRow, obj), , ];
  ...
  items1[1] = callback(setting(5559).TableSwitchRow, obj1);
  ...
  items1[2] = callback(setting(5559).TableSwitchRow, obj2);
  obj[2] = items1;
  obj[0] = callback2(setting(5558).TableRowGroup, obj);
