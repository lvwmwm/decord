...
// Dependencies: [19, 17, 676, 21, 4070, 6122, 5873, 1236, 5874, 1403, 2]
// Exports: default

// Module 16125 (UserSettingsFriendRequests)
...
export default function UserSettingsFriendRequests() {
  let FriendSourceFlagsSetting = setting(4070).FriendSourceFlagsSetting;
  ...
  const items1 = [callback(setting(5874).TableSwitchRow, obj), , ];
  ...
  items1[1] = callback(setting(5874).TableSwitchRow, obj1);
  ...
  items1[2] = callback(setting(5874).TableSwitchRow, obj2);
  obj[2] = items1;
  obj[0] = callback2(setting(5873).TableRowGroup, obj);
