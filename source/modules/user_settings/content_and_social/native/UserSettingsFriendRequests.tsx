...
// Dependencies: [19, 17, 676, 21, 4135, 6207, 5957, 1236, 5958, 1403, 2]
// Exports: default

// Module 16289 (UserSettingsFriendRequests)
...
export default function UserSettingsFriendRequests() {
  let FriendSourceFlagsSetting = setting(4135).FriendSourceFlagsSetting;
  ...
  const items1 = [callback(setting(5958).TableSwitchRow, obj), , ];
  ...
  items1[1] = callback(setting(5958).TableSwitchRow, obj1);
  ...
  items1[2] = callback(setting(5958).TableSwitchRow, obj2);
  obj[2] = items1;
  obj[0] = callback2(setting(5957).TableRowGroup, obj);
