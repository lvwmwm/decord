...
// Dependencies: [31, 27, 3802, 33, 4165, 689, 5497, 5517, 1273, 13812, 1212, 5155, 4161, 5536, 13819, 566, 2]
// Exports: default

// Module 13818 (IgnoredUsersList)
import "result";
...
function IgnoredUsersList(userIds) {
  ...
  if (0 === userIds.length) {
    ...
    items[1] = callback(require(5536) /* TableRowGroupTitle */.TableRowGroup, obj4, intl3.string(require(1212) /* getSystemLocale */.t["93ZDWE"]));
    obj1.children = items;
