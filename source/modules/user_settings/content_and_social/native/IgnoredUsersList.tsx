...
// Dependencies: [19, 17, 3938, 21, 4303, 712, 5728, 5748, 1297, 14047, 1236, 5328, 4299, 5767, 14054, 589, 2]
// Exports: default

// Module 14053 (IgnoredUsersList)
import "noop";
...
function IgnoredUsersList(userIds) {
  ...
  if (0 === userIds.length) {
    ...
    obj[0] = require(14047) /* getBlockedSource */.Blocked;
    ...
    const items = [callback(require(4299) /* Text */.Text, obj2), ];
    const obj4 = { hasIcons: true, children: null };
    obj4[1] = userIds.map((userId) => callback2(callback(table[14]), { userId }, userId));
    const intl3 = require(1236) /* getSystemLocale */.intl;
    items[1] = callback(require(5767) /* TableRowGroupTitle */.TableRowGroup, obj4, intl3.string(require(1236) /* getSystemLocale */.t["93ZDWE"]));
    obj1[0] = items;
    obj[2] = callback2(ScrollView, obj1);
    obj[1] = callback(require(5328) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
    tmp7 = callback(require(5728) /* context */.AnalyticsLocationProvider, obj);
  }
  return tmp7;
}
