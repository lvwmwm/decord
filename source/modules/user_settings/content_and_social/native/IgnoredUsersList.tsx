...
function IgnoredUsersList(userIds) {
  ...
  if (0 === userIds.length) {
    ...
    obj.body = intl.string(arg1(dependencyMap[10]).t.PYrWFW);
    ...
    items[1] = callback(arg1(dependencyMap[13]).TableRowGroup, obj4, intl3.string(arg1(dependencyMap[10]).t.93ZDWE));
    obj1.children = items;
...
obj = {};
obj = { marginTop: importDefault(dependencyMap[5]).space.PX_8, paddingHorizontal: importDefault(dependencyMap[5]).space.PX_16 };
obj.list = obj;
...
const result = arg1(dependencyMap[16]).fileFinishedImporting("modules/user_settings/content_and_social/native/IgnoredUsersList.tsx");
