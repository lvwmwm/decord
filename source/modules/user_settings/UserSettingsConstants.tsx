...
export const createEmptyEditInfo = function createEmptyEditInfo() {
  const obj = { protoToSave: "Array", timeout: "ct", timeoutDelay: Number.MIN_SAFE_INTEGER, rateLimited: null, cleanupFuncs: false, errorCallbacks: false, loaded: false, loading: "channel", triggeredMigrations: null, offlineEditDataVersion: null };
  obj[4] = [];
  obj[5] = [];
  return obj;
};
