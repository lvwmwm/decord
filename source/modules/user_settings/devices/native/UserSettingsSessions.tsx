...
// Dependencies: [32, 19, 17, 1903, 676, 21, 4285, 5219, 712, 13896, 589, 14110, 4693, 5688, 1236, 5354, 5311, 4281, 1351, 4827, 1297, 7950, 1480, 11553, 7514, 14111, 12098, 10866, 8410, 14112, 2]
// Exports: default

// Module 14109 (UserSettingsSessions)
...
function UnknownLegacySessionsInfo() {
  ...
  obj[1] = importDefault(11553);
  obj[0] = callback2(_require(5354).TableRow.Icon, obj);
  ...
  return callback2(_require(5354).TableRow, obj);
}
