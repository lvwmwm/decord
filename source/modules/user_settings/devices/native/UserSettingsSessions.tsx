...
// Dependencies: [32, 19, 17, 1903, 676, 21, 4302, 5235, 712, 13910, 589, 14124, 4710, 5707, 1236, 5373, 5327, 4298, 1351, 4844, 1297, 7967, 1480, 11568, 7533, 14125, 12113, 10878, 8427, 14126, 2]
// Exports: default

// Module 14123 (UserSettingsSessions)
...
function UnknownLegacySessionsInfo() {
  ...
  obj[1] = importDefault(11568);
  obj[0] = callback2(_require(5373).TableRow.Icon, obj);
  ...
  return callback2(_require(5373).TableRow, obj);
}
