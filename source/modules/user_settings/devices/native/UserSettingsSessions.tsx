...
// Dependencies: [32, 19, 17, 1874, 676, 21, 4189, 5109, 712, 13766, 589, 13980, 4598, 5554, 1236, 5220, 5177, 4185, 1351, 4717, 1297, 7699, 1480, 11424, 6505, 13981, 11926, 10855, 9208, 13982, 2]
// Exports: default

// Module 13979 (UserSettingsSessions)
...
function UserSettingsSessions() {
  ...
  if (null == currentSession) {
    ...
    obj1[2] = tmp21Result;
    const items1 = [callback2(tmp2(5554).TableRowGroup, obj1), , ];
    if (otherSessions.length > 0) {
      ...
      obj3[2] = items2;
      tmp20Result = tmp20(tmp2(5554).TableRowGroup, obj3);
    } else {
      let mfaEnabled;
    ...
    if (otherSessions.length > 0) {
      ...
      tmp21Result = tmp21(tmp2(5220).TableRow, obj4);
    }
    items1[2] = tmp21Result;
    obj[2] = items1;
    tmp20Result = tmp20(tmp2(4598).Stack, obj);
  }
  ...
  const items3 = [callback2(otherSessions(4185).Text, obj7), tmp20Result];
  obj6[1] = items3;
  obj5[1] = callback3(otherSessions(5177).SafeAreaPaddingView, obj6);
...
function SessionInfo(session) {
  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
      if ("" !== trimmed) {
        if ("ios" !== trimmed) {
          if ("android" !== trimmed) {
            if ("horizon os" === trimmed) {
              ...
              obj[0] = os;
              obj[1] = importDefault(10855);
              obj[2] = session(13982).VrHeadsetIcon;
              let tmp9 = session;
              let tmp10 = importDefault;
            } else {
              obj = { text: null, iconSource: null, IconComponent: null };
              obj[0] = os;
              obj[1] = importDefault(13981);
              obj[2] = session(11926).ScreenIcon;
              tmp9 = session;
              tmp10 = importDefault;
            }
          }
        ...
        obj[0] = os;
        obj[1] = importDefault(10855);
        obj[2] = session(9208).MobilePhoneIcon;
        tmp9 = session;
        tmp10 = importDefault;
      }
      ...
      if (!current) {
        formatDateResult = tmp9(13766).formatDate(session.approx_last_used_time);
        const tmp9Result = tmp9(13766);
      }
      ...
      if (!current) {
        ...
        tmp18 = callback2(tmp9(4717).PressableOpacity, obj1);
      }
      ...
      obj5[1] = found[0];
      const items1 = [callback2(tmp9(4185).Text, obj5), ];
      ...
      if (tmp22Result) {
        ...
        const items2 = [tmp20(tmp9(4185).Text, obj7), ];
        const obj8 = { variant: "text-md/semibold", children: null };
        obj8[1] = found[1];
        items2[1] = tmp20(tmp9(4185).Text, obj8);
        obj6[0] = items2;
      ...
      obj9[0] = callback2(tmp9(5220).TableRow.Icon, obj10);
      obj9[1] = tmp20Result;
      ...
      if (tmp20Result) {
        ...
        obj12[3] = _location;
        obj11[1] = tmp20(tmp9(4185).Text, obj12);
      ...
      if (tmp20Result1) {
        ...
        obj13[1] = tmp20(tmp9(4185).Text, obj14);
      ...
      obj9[3] = tmp18;
      return callback2(tmp9(5220).TableRow, obj9);
    }
  }
  ...
  obj16[1] = importDefault(13981);
  obj16[2] = session(11926).ScreenIcon;
  tmp9 = session;
  tmp10 = importDefault;
  obj = obj16;
}
function UnknownLegacySessionsInfo() {
  ...
  obj[1] = importDefault(11424);
  obj[0] = callback2(_require(5220).TableRow.Icon, obj);
  ...
  return callback2(_require(5220).TableRow, obj);
}
