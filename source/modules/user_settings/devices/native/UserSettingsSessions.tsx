...
// Dependencies: [32, 19, 17, 1903, 676, 21, 4303, 5236, 712, 13980, 589, 14194, 4712, 5767, 1236, 5374, 5328, 4299, 1351, 4846, 1297, 8027, 1480, 11634, 7593, 14195, 12180, 10944, 8487, 14196, 2]
// Exports: default

// Module 14193 (UserSettingsSessions)
...
function UnknownLegacySessionsInfo() {
  ...
  return callback2(_require(5374).TableRow, obj);
}
