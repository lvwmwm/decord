...
// Dependencies: [32, 19, 17, 1922, 676, 21, 4344, 5275, 712, 14047, 589, 14261, 4752, 5806, 1236, 5413, 5367, 4340, 1370, 4886, 1297, 8068, 1499, 11695, 7634, 14262, 12248, 11003, 8532, 14263, 2]
// Exports: default
...
function UnknownLegacySessionsInfo() {
  ...
  obj[1] = importDefault(11695);
  obj[0] = callback2(_require(5413).TableRow.Icon, obj);
  ...
  return callback2(_require(5413).TableRow, obj);
}
