...
// Dependencies: [32, 19, 17, 1874, 676, 21, 4255, 5189, 712, 13859, 589, 14073, 4663, 5634, 1236, 5300, 5257, 4251, 1351, 4797, 1297, 7809, 1480, 11519, 7486, 14074, 12064, 10811, 8270, 14075, 2]
// Exports: default

// Module 14072 (UserSettingsSessions)
...
function UnknownLegacySessionsInfo() {
  ...
  obj[1] = importDefault(11519);
  obj[0] = callback2(_require(5300).TableRow.Icon, obj);
  ...
  return callback2(_require(5300).TableRow, obj);
}
