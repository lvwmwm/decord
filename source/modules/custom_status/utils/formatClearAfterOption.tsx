...
// Dependencies: [11972, 3859, 1236, 687, 1351, 2]
// Exports: default

// Module 11982 (formatClearAfterOption)
...
export default function formatClearAfterOption(arg0) {
  if (ClearAfterValues.TODAY === arg0) {
    ...
    const obj8 = require(3859) /* resetCache */;
    ...
    const obj6 = require(3859) /* resetCache */;
