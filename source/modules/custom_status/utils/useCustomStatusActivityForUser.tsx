...
// Dependencies: [1218, 4341, 676, 589, 9337, 2]
// Exports: default

// Module 9356 (useCustomStatusActivityForUser)
...
export default function useCustomStatusActivityForUser(arg0) {
  ...
  const customStatusActivity = _require(9337).useCustomStatusActivity();
  const obj2 = _require(9337);
