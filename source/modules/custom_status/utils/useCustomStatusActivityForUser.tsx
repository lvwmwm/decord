...
// Dependencies: [1218, 4390, 676, 589, 9454, 2]
// Exports: default

// Module 9473 (useCustomStatusActivityForUser)
...
export default function useCustomStatusActivityForUser(arg0) {
  ...
  const customStatusActivity = _require(9454).useCustomStatusActivity();
  const obj2 = _require(9454);
