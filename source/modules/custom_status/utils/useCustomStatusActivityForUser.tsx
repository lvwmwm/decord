...
// Dependencies: [1218, 4276, 676, 589, 8077, 2]
// Exports: default

// Module 11958 (useCustomStatusActivityForUser)
...
export default function useCustomStatusActivityForUser(arg0) {
  ...
  const customStatusActivity = _require(8077).useCustomStatusActivity();
  const obj2 = _require(8077);
