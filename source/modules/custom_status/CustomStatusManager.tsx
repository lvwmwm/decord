...
// Function ID: 16400
// Name: timeout
// Dependencies: [4996, 676, 4188, 5261, 3974, 9763, 1355, 1337, 9762, 2]

// Module 16399 (timeout)
    ...
    if (null != setting) {
      if ("0" !== setting) {
        ...
        if (diff > 0) {
          ...
          applyArgumentsResult(9762).setFocusMode(false);
          closure_7.stop();
          const tmpResult = applyArgumentsResult(9762);
        }
      }
    }
    if (null != closure_7) {
