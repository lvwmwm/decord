...
// Function ID: 16158
// Name: timeout
// Dependencies: [4867, 676, 4074, 5134, 3862, 10256, 1355, 1337, 10255, 2]

// Module 16157 (timeout)
    ...
    if (null != setting) {
      if ("0" !== setting) {
        ...
        if (diff > 0) {
          ...
          applyArgumentsResult(10255).setFocusMode(false);
          closure_7.stop();
          const tmpResult = applyArgumentsResult(10255);
        }
      }
    }
    if (null != closure_7) {
