...
// Dependencies: [5534, 5472, 5487, 5474, 5536]

// Module 5552 (handleStateChangeEvent)
const require = arg1;
...
function handleUpdateEvent(lastUpdateEvent, arg1, arg2, lastUpdateEvent2) {
  ...
  const result = require(5534) /* isGestureEnabled */.flattenAndFilterEvent(tmp);
  const obj = require(5534) /* isGestureEnabled */;
  require(5534) /* isGestureEnabled */.runCallback(require(5487) /* _isNativeReflectConstruct */.CALLBACK_TYPE.UPDATE, arg1, result);
  if (lastUpdateEvent2) {
...
function handleTouchEvent(eventType) {
  if (eventType.eventType !== require(5474).TouchEventType.UNDETERMINED) {
    let tmpResult = tmp(5534);
    tmpResult = tmp(5534);
...
function eventHandler(arg0, nativeEvent, arg2, arg3, lastUpdateEvent) {
  const result = require(5534) /* isGestureEnabled */.maybeExtractNativeEvent(nativeEvent);
  const obj = require(5534) /* isGestureEnabled */;
