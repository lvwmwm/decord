// Module ID: 12055
// Function ID: 92988
// Dependencies: [12056, 12057, 12058, 12060, 12061, 12063, 12059, 12062, 12065, 12115, 12064, 12116, 12117, 12118, 12119, 12120]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    fn(require("module_12057"), exports);
    fn(require("toDotPath"), exports);
    fn(require("isValidBase64"), exports);
    fn(require("module_12061"), exports);
    fn(require("module_12063"), exports);
    exports.util = fn2(require("cached"));
    exports.regexes = fn2(require("timeSource"));
    exports.locales = fn2(require("module_12065"));
    ...
    obj = {
      enumerable: true,
      get() {
            return require(12119) /* JSONSchemaGenerator */.JSONSchemaGenerator;
          }
    };
    Object.defineProperty(exports, "JSONSchemaGenerator", obj);
    exports.JSONSchema = fn2(require("module_12120"));
  } else {
