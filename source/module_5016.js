// Module ID: 5016
// Function ID: 5017
// Dependencies: [4976, 4991, 4992, 4988, 4971]
...
arg5.default = {
  read(buffer, sum) {
    ...
    let obj2 = require(4991) /* readTag */;
    const ifd = obj1.readIfd(buffer, require(4992) /* importDefaultResult1 */.IFD_TYPE_MPF, sum, obj2.get0thIfdOffset(buffer, sum, byteOrder), byteOrder, arg2);
    if (ifd.MPEntry) {
      const items = [];
      const _Math = Math;
      let num13 = 0;
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          if (0 !== num13) {
            ...
            let obj15 = require(4971) /* getDataView */;
