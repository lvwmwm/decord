...
// Function ID: 8551
// Name: extractFont
// Dependencies: [19, 21, 8544, 8549]
// Exports: default, setTSpan

// Module 8550 (extractFont)
import "noop";
...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(8544) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "y") {
    ...
    obj[7] = importDefault(8549)(tmp);
    obj[8] = importDefault(8549)(tmp2);
    obj[9] = importDefault(8549)(tmp3);
    obj[10] = importDefault(8549)(tmp4);
    obj[11] = importDefault(8549)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
