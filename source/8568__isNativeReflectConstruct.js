...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8569, 8566, 8567]

// Module 8568 (_isNativeReflectConstruct)
...
let obj = {
  ...
  value: function render() {
    ...
    const tmp = importDefault(8569);
    const merged = Object.assign(self(8566).extractFilter(this.props));
    const obj2 = self(8566);
    const merged1 = Object.assign(self(8566).extractIn(this.props));
    const obj3 = self(8566);
    const merged2 = Object.assign(self(8566).extractFeColorMatrix(this.props));
