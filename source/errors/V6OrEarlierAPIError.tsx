...
// Module 3797 (_isNativeReflectConstruct)
...
}(arg1(dependencyMap[7]).V6OrEarlierAPIError);
const result = arg1(dependencyMap[8]).fileFinishedImporting("errors/V6OrEarlierAPIError.tsx");
