...
// Module 3834 (_isNativeReflectConstruct)
...
const tmp2 = ((V6OrEarlierAPIError) => {
  ...
  callback2(APIErrorWithDefaultMessage, V6OrEarlierAPIError);
  return callback(APIErrorWithDefaultMessage);
})(require("_isNativeReflectConstruct").V6OrEarlierAPIError);
let result = require("_possibleConstructorReturn").fileFinishedImporting("errors/V6OrEarlierAPIError.tsx");
