...
// Dependencies: [7567, 7526, 7564]

// Module 7581 (createCheckInEnvelope)
const require = arg1;
...
arg5.createCheckInEnvelope = function createCheckInEnvelope(arg0, arg1, sdk) {
  ...
  if (tmp) {
    obj.dsn = require(7567) /* dsnFromString */.dsnToString(arg4);
    const obj4 = require(7567) /* dsnFromString */;
  }
  if (arg1) {
    obj.trace = require(7526) /* addNonEnumerableProperty */.dropUndefinedKeys(arg1);
    const obj5 = require(7526) /* addNonEnumerableProperty */;
  }
