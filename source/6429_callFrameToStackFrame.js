...
// Dependencies: [6317, 6314, 6427]

// Module 6429 (callFrameToStackFrame)
const require = arg1;
...
arg5.callFrameToStackFrame = function callFrameToStackFrame(location, str) {
  ...
  if (!UNKNOWN_FUNCTION) {
    UNKNOWN_FUNCTION = require(6314) /* createStackParser */.UNKNOWN_FUNCTION;
  }
  ...
  if (replaced) {
    filenameIsInAppResult = require(6427) /* filenameIsInApp */.filenameIsInApp(replaced);
    const obj3 = require(6427) /* filenameIsInApp */;
  }
