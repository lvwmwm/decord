// Module ID: 4974
// Function ID: 4975
// Dependencies: [4934, 4949, 4950, 4946, 4929]
...
arg5.default = {
  read(buffer, sum) {
    ...
    let obj2 = require(4949) /* readTag */;
    const ifd = obj1.readIfd(buffer, require(4950) /* importDefaultResult1 */.IFD_TYPE_MPF, sum, obj2.get0thIfdOffset(buffer, sum, byteOrder), byteOrder, arg2);
    if (ifd.MPEntry) {
      const items = [];
      const _Math = Math;
      let num13 = 0;
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          if (0 !== num13) {
            ...
            let obj15 = require(4929) /* getDataView */;
