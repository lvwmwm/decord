...
// Function ID: 5334
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1500, 5325, 5334, 5335]
// Exports: Button

// Module 5333 (ButtonLink)
import "noop";
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    const obj4 = importDefault(5325)(color);
    str3 = importDefault(5325)(color).fade(0.85).string();
    tmp5 = color;
    const fadeResult = importDefault(5325)(color).fade(0.85);
  } else if ("filled" === str) {
    let str4 = "white";
    if (!obj10.isDark()) {
      const obj2 = tmp9(5325)(color);
      str4 = tmp9(5325)(color).darken(0.71).string();
      const darkenResult = tmp9(5325)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
    obj10 = importDefault(5325)(color);
    tmp9 = importDefault;
  }
  obj = {};
  const merged1 = Object.assign(merged);
  obj = { radius: 40, color: null };
  const obj8 = importDefault(5325)(tmp5);
  obj[1] = importDefault(5325)(tmp5).fade(0.85).string();
  ...
  obj.children = jsx(require(5335) /* Text */.Text, { style: items1, children });
  return jsx(require(5334) /* Animated */.PlatformPressable, { radius: 40, color: null });
}
