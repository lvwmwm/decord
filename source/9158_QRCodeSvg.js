...
// Function ID: 9159
// Name: QRCodeSvg
// Dependencies: [9155, 19, 7876]

// Module 9158 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(7876) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(7876) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(7876) /* inlineStyles */.Path, { d, fill }));
});
