...
// Dependencies: [13191, 13192, 13194]

// Module 13190 (__exportStarResult32)
const require = arg1;
...
arg5.TimeClip = function TimeClip(isFinite) {
  if (isFinite.isFinite()) {
    if (absResult.greaterThan(8640000000000001)) {
      const Decimal2 = require(13191) /* digitsToString */.Decimal;
      const _NaN2 = NaN;
      ...
      ZERO = require(13194) /* TEN */.ZERO;
    }
    absResult = isFinite.abs();
  } else {
    const Decimal = require(13191) /* digitsToString */.Decimal;
    const _NaN = NaN;
