...
// Function ID: 4181
// Name: registerHost
// Dependencies: [4181, 4176]

// Module 4180 (registerHost)
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (portalName(4176).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4176).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4176).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4176).ACTIONS.REMOVE_PORTAL === type) {
