...
// Module 9891 (ModalFloatingAction)
...
let closure_8 = arg1(dependencyMap[3]).createStyles({ floating: { padding: "channel_flags", bottom: "starIcon", sr: "acknowledgeUserTrialOffer", skuId: "%DataViewPrototype%" }, spacer: { height: 96 } });
...
export const ModalFloatingAction = function ModalFloatingAction(isVisible) {
  ...
  const fn = function y() {
    let obj = { opacity: isVisible(sharedValue[4]).interpolate(sharedValue.get(), [null, null], [null, null]), borderBottomColor: floatingBackgroundColor, borderBottomWidth: 16 };
    obj = {};
