...
// Module 16236 (ApplicationStatusNotice)
...
class SectionContainer {
  constructor(arg0) {
    ...
    obj1 = { Promise: false, marginTop: 0, flags: 4 };
    ...
    if (tmp4) {
      ...
      tmp6 = arg1;
      tmp7 = dependencyMap;
      obj2 = { Promise: "xs", marginTop: "interactive-text-default", flags: "md" };
...
function StartEarningButton(isTermsAccepted) {
  ...
  obj = { INTEGRATION_CREATE: true, ConstraintReasonCode: true, children: acceptTermsCheckboxText };
...
obj = { container: { flex: 1 }, contentContainer: { "Bool(true)": 0., "Bool(true)": 0. }, heroImage: {}, subtitle: { marginTop: 8 } };
...
obj.divider = { backgroundColor: importDefault(dependencyMap[8]).colors.BACKGROUND_MOD_MUTED };
obj.sectionTitle = {};
obj.sectionFooter = { marginTop: 36 };
obj.statusNoticeContainer = {};
let closure_14 = obj.createStyles(obj);
const obj1 = { backgroundColor: importDefault(dependencyMap[8]).colors.BACKGROUND_MOD_MUTED };
  ...
  if (!eligibilityLoading) {
    if (null != eligibility) {
      if (!isLoading) {
        ...
        const obj6 = { Promise: "xs", marginTop: "interactive-text-default", flags: "md", style: tmp.subtitle };
