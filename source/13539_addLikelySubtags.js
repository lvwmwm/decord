...
// Dependencies: [1281, 13540, 13541, 13605, 13612, 13617, 13632, 13633]

// Module 13539 (addLikelySubtags)
import e from "e";
...
function addLikelySubtags(locale) {
  ...
  let script;
  let variants;
  const parseUnicodeLocaleIdResult = require(13605) /* isStructurallyValidLanguageTag */.parseUnicodeLocaleId(locale);
