...
const fn = function n(arg0) {
  ...
  if (!configs) {
    configs = require(5246) /* GESTURE_SOURCE */.ANIMATION_CONFIGS;
  }
  ...
  if (!("duration" in configs)) {
    if (!("easing" in configs)) {
      let tmp3 = require;
      let TIMING = require(5246) /* GESTURE_SOURCE */.ANIMATION_METHOD.SPRING;
    }
    if (TIMING === tmp3(5246).ANIMATION_METHOD.TIMING) {
  ...
  TIMING = require(5246) /* GESTURE_SOURCE */.ANIMATION_METHOD.TIMING;
  tmp3 = require;
};
