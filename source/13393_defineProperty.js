...
if (require("getOwnPropertyDescriptor")) {
  ...
  defineProperty2 = function defineProperty(arg0, arg1, value) {
    require(13391) /* all */(arg0);
    const tmp4 = require(13351) /* text */(arg1);
    require(13391) /* all */(value);
    if (!require(13374)) {
      while (true) {
        let tmp10 = value;
        let str = "get";
