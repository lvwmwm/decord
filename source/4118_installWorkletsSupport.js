...
// Dependencies: [4119, 4123]

// Module 4118 (installWorkletsSupport)
import _mod4119 from "module_4119" /* 4119 */;
import getInstalledNitro from "getInstalledNitro" /* 4123 */;
...
arg5.installWorkletsSupport = function installWorkletsSupport() {
  try {
    ...
    obj[3] = fn3;
    const result = _mod4119.registerCustomSerializable(obj);
  } catch (err) {
  }
};
