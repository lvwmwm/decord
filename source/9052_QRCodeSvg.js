...
// Function ID: 9053
// Name: QRCodeSvg
// Dependencies: [9049, 19, 7775]

// Module 9052 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(7775) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(7775) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(7775) /* inlineStyles */.Path, { d, fill }));
});
