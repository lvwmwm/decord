  ...
  if (num4 < arr.length) {
    ...
    do {
      while (true) {
        ...
        if (!tmp14) {
          let tmp15 = closure_5;
          tmp14 = tmp13 > closure_5((2147483647 - tmp6) / num8);
        }
        if (tmp14) {
          let tmp16 = closure_12;
          let tmp17 = closure_12("overflow");
        }
      ...
      let tmp24 = closure_9(sum1 - num7, sum2, 0 === num7);
      if (closure_5(result) > 2147483647 - num2) {
        let tmp27 = closure_12;
        let tmp28 = closure_12("overflow");
      }
      let tmp29 = closure_5;
