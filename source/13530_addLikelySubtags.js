...
// Dependencies: [1281, 13531, 13532, 13596, 13603, 13608, 13623, 13624]

// Module 13530 (addLikelySubtags)
import e from "e";
...
function addLikelySubtags(locale) {
  ...
  let script;
  let variants;
  const parseUnicodeLocaleIdResult = require(13596) /* isStructurallyValidLanguageTag */.parseUnicodeLocaleId(locale);
  ...
  if (script) {
    if (region) {
      ...
      obj[2] = region;
      obj[3] = [];
      const tmp4 = tmp(13596).likelySubtags[tmp(undefined, 13596).emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = tmp(13596).parseUnicodeLanguageId(tmp4);
        ...
        if (result) {
          ...
          obj = { lang: null, script: "Array", region: "isArray", variants: "<string:714932225>" };
          obj[0] = "und";
          obj[3] = variants;
        }
        parseUnicodeLocaleIdResult.lang = obj;
        return tmp(13596).emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    ...
    obj1[1] = script;
    obj1[2] = [];
    const tmp5 = tmp(13596).likelySubtags[tmp(undefined, 13596).emitUnicodeLanguageId(undefined, obj1)];
    if (tmp5) {
      const result1 = tmp(13596).parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    obj4[1] = region;
    obj4[2] = [];
    const tmp6 = tmp(13596).likelySubtags[tmp(undefined, 13596).emitUnicodeLanguageId(undefined, obj4)];
    if (tmp6) {
      const result2 = tmp(13596).parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
      if (result2) {
        ...
        obj6 = { lang: null, script: null, region: "Array", variants: "r" };
        obj6[0] = "und";
        obj6[1] = script;
        obj6[3] = items1;
      }
  ...
  let tmp7 = tmp(13596).likelySubtags[lang];
  if (!tmp7) {
    const obj7 = { lang: "und", script: null, variants: null };
    obj7[1] = script;
    obj7[2] = [];
    tmp7 = tmp(13596).likelySubtags[tmp(undefined, 13596).emitUnicodeLanguageId(undefined, obj7)];
  }
  if (tmp7) {
    const result3 = tmp(13596).parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(locale) {
          ...
          if (tmp2) {
            ...
            obj = { variants: null };
            obj[0] = [];
            const result = callback(13596).emitUnicodeLanguageId(obj.__assign(obj1.__assign({}, callback(13596).parseUnicodeLanguageId(tmp2)), obj));
            const parseUnicodeLocaleIdResult = callback(13596).parseUnicodeLocaleId(locale);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            obj = { lang: null, variants: null };
            obj[0] = lang;
            obj[1] = [];
            if (tmp(callback(13596).emitUnicodeLanguageId(obj)) === result) {
              ...
              obj1 = { lang: null };
              const obj2 = { lang: null, script: "Array", region: "isArray", variants: "<string:714932225>" };
              obj2[0] = lang;
              obj2[3] = variants;
              obj1[0] = obj2;
              let emitUnicodeLocaleIdResult = tmp3(13596).emitUnicodeLocaleId(tmp3Result.__assign(tmp3Result.__assign({}, parseUnicodeLocaleIdResult), obj1));
              ...
              if (region) {
                ...
                obj3[1] = region;
                obj3[2] = [];
                if (tmp(tmp3(13596).emitUnicodeLanguageId(obj3)) === result) {
                  ...
                  obj5[3] = items;
                  obj4[0] = obj5;
                  emitUnicodeLocaleIdResult = tmp3(13596).emitUnicodeLocaleId(tmp3Result1.__assign(tmp3(1281).__assign({}, parseUnicodeLocaleIdResult), obj4));
              ...
              if (script) {
                ...
                obj6[2] = [];
                emitUnicodeLocaleIdResult = locale;
                if (tmp(tmp3(13596).emitUnicodeLanguageId(obj6)) === result) {
                  ...
                  const obj8 = { lang: null, script: null, region: "Array", variants: "r" };
                  obj8[0] = str;
                  obj8[1] = script;
                  obj8[3] = items1;
                  obj7[0] = obj8;
                  emitUnicodeLocaleIdResult = tmp3(13596).emitUnicodeLocaleId(tmp3Result3.__assign(tmp3(1281).__assign({}, parseUnicodeLocaleIdResult), obj7));
  ...
  let obj = {
    get() {
      return Locale(13596).emitUnicodeLanguageId(Locale(13596).parseUnicodeLanguageId(closure_2.default(this).locale));
    },
    enumerable: false,
    configurable: true
  };
  ...
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(13596).parseUnicodeLanguageId(closure_2.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(13596).parseUnicodeLanguageId(closure_2.default(this).locale).script;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(13596).parseUnicodeLanguageId(closure_2.default(this).locale).region;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      ...
      if (Locale(13532).HasOwnProperty(defaultResult, "initializedLocale")) {
