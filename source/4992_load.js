...
// Function ID: 4993
// Name: load
// Dependencies: [4993, 4994, 4995, 4996, 4997, 5010, 5012, 5013, 5025, 5029, 5033, 5035, 5037, 5038, 5039, 5040, 5041, 5042, 5043, 5044, 5045, 5046, 5019]
// Exports: load
  ...
  if (typeof response === "string") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(4994).dataUriToBuffer(response));
        const obj5 = response(4994);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
