...
QRPolynomial.prototype = {
      ...
      do {
        ...
        if (0 < getLength.getLength()) {
          do {
            ...
            let obj = require(12383);
            let obj2 = require(12383);
            let glogResult = obj2.glog(self.get(num));
            let obj3 = require(12383);
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = require(12383);
      const glogResult = require(12383).glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - require(12383).glog(getLength.get(0));
