        ...
        if (null !== onRejected) {
          ...
          while (true) {
            ...
            if (onRejectedResult === outer2_1) {
              ...
              let tmp23 = _72;
              let tmp24 = outer2_0;
              let tmp25 = outer2_6(_72.promise, outer2_0);
            } else {
              let tmp19 = outer2_5;
              let tmp20 = _72;
              let tmp21 = outer2_5(_72.promise, onRejectedResult);
            }
          }
        } else if (1 === _65._65) {
          outer2_5(_72.promise, _65._55);
        } else {
          outer2_6(_72.promise, _65._55);
        }
      });
    })(tmp2, _72);
  }
...
function finale(_40) {
  ...
  if (2 === _40._40) {
    ...
    if (0 < _40._72.length) {
      do {
        let tmp4 = handle;
        let tmp5 = handle(_40, _40._72[num]);
        num = num + 1;
