...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8417, 8425, 8431, 8424, 8512, 8508, 8433]
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(8425).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
      ...
      if (tmp5) {
        ...
        obj[6] = midLine;
        const merged = Object.assign(withoutXYResult, importDefault(8431)(obj, true), obj);
        withoutXYResult.ref = self.refMethod;
        obj1 = {};
        const merged1 = Object.assign(withoutXYResult);
        return jsx(importDefault(8512), {});
      } else {
        ...
        obj[1] = children;
        return jsx(importDefault(8508), { ref: null, children: null });
      }
