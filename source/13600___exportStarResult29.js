...
// Dependencies: [1281, 13581, 13582, 13584, 13594]
...
export const ToRawPrecision = function ToRawPrecision(ZERO, minimumSignificantDigits, maximumSignificantDigits, result) {
  ...
  let tmp4;
  if (ZERO.isZero()) {
    let repeatResult = require(13582) /* getMultiInternalSlots */.repeat("0", maximumSignificantDigits);
    let roundedNumber = require(13584) /* TEN */.ZERO;
    ...
    result = require(13594) /* __exportStarResult11 */.ApplyUnsignedRoundingMode(ZERO, timesResult, roundedNumber, result);
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    ...
    tmp16(13582).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(13582).repeat("0", -num3 - 1)}${arr}`;
