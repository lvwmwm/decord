...
// Function ID: 4729
// Name: TabsHost
// Dependencies: [32, 109, 19, 17, 21, 4729, 4704, 4730, 4731, 4733]
// Exports: default

// Module 4728 (TabsHost)
...
export default function TabsHost(onNativeFocusChange) {
  ...
  let obj = onNativeFocusChange(4729);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4704).experiment.controlledBottomTabs;
  }
