...
// Module 4780 (isMissingNamespaceError)
let closure_0 = { startHeight: true, hasEverExpanded: true, windowDimensions: null, wrapperStyle: "", scrollViewStyle: 6, startExpanded: true, onChange: "/assets/images/platforms", onExpand: 255 };
arg5.isMissingNamespaceError = function isMissingNamespaceError(message) {
  const items = [, , , /Namespace prefix .+ is not defined/];
  let num = 0;
  if (0 < items.length) {
