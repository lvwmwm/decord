...
// Function ID: 5405
// Name: memo
// Dependencies: [19, 17, 21, 1606, 5257, 5250, 5246, 5273]
...
const memoResult = memo(function BottomSheetRefreshControlComponent(arg0) {
  ...
  let dependencyMap;
  let iter;
  const tmp4 = iter(scrollableGesture(5257).BottomSheetDraggableContext);
  dependencyMap = tmp4;
  let obj = scrollableGesture(5250);
  ...
  obj = { animatedScrollableState: iter, SCROLLABLE_STATE: tmp2(5246).SCROLLABLE_STATE };
  fn.__closure = obj;
  ...
  if (tmp7) {
    ...
    let tmp8Result = tmp8(tmp2(5273).GestureDetector, obj);
  } else {
    const obj2 = {};
