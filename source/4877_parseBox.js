...
// Function ID: 4878
// Name: parseBox
// Dependencies: [4878, 4871, 4868]

// Module 4877 (parseBox)
const require = arg1;
const module = arg2;
...
function parseBox(getUint32, sum) {
  ...
  if (length >= 8) {
    ...
    if (1718909296 === uint321) {
      ...
      obj1[1] = require(4868) /* getDataView */.getStringFromDataView(getUint32, contentOffset, 4);
      obj1[2] = length;
      return obj1;
      ...
      const stringFromDataView = require(4868) /* getDataView */.getStringFromDataView(getUint32, contentOffset, 4);
      ...
      if (1835365473 === uint321) {
        ...
        const obj13 = require(4878) /* parseItemLocationBox */;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(4868).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(4868);
            }
          }
        }
      } else {
        parseItemLocationBoxResult = { type: "Array", length: true };
