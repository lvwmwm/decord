...
export default function DevToolsGuildPowerupsScreen() {
  ...
  if (null == stateFromStores) {
    ...
    const obj4 = { width: true, height: true };
    const obj5 = {
    ...
    const obj7 = { width: null, height: null, children: closure_13.map((dc) => callback(closure_24, { dc }, dc)) };
    ...
    const obj10 = { children: closure_14.map((dc) => callback(closure_24, { dc }, dc)) };
