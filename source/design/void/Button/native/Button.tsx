...
// Function ID: 1301
// Name: getTextStyles
// Dependencies: [19, 17, 676, 1301, 21, 4303, 712, 4152, 5158, 500, 12020, 8001, 1363, 5373, 4714, 2]
...
function getButtonStyles(shrink, button) {
  ...
  items[2] = require(12020) /* getClass */.getClass(button, "button", combined, disabled ? closure_14.DISABLED : closure_14.DEFAULT);
  const obj2 = require(12020) /* getClass */;
  const tmp2 = disabled ? closure_14.DISABLED : closure_14.DEFAULT;
  const tmp8 = require;
  items[3] = require(12020) /* getClass */.getClass(button, "button", size);
  const obj3 = require(12020) /* getClass */;
  items[4] = require(12020) /* getClass */.getClass(button, "button", look);
  let faded;
  if (!flag3) {
