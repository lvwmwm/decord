...
// Function ID: 1301
// Name: getTextStyles
// Dependencies: [19, 17, 676, 1301, 21, 4342, 712, 4191, 5199, 500, 12080, 8044, 1363, 5413, 4755, 2]
...
function getButtonStyles(shrink, button) {
  ...
  items[2] = require(12080) /* getClass */.getClass(button, "button", combined, disabled ? closure_14.DISABLED : closure_14.DEFAULT);
  const obj2 = require(12080) /* getClass */;
  const tmp2 = disabled ? closure_14.DISABLED : closure_14.DEFAULT;
  const tmp8 = require;
  items[3] = require(12080) /* getClass */.getClass(button, "button", size);
  const obj3 = require(12080) /* getClass */;
  items[4] = require(12080) /* getClass */.getClass(button, "button", look);
  let faded;
  if (!flag3) {
