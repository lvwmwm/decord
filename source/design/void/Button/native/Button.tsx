...
// Function ID: 1301
// Name: getTextStyles
// Dependencies: [19, 17, 676, 1301, 21, 4302, 712, 4145, 5157, 500, 11950, 7939, 4147, 5372, 4712, 2]
...
function getButtonStyles(shrink, button) {
  ...
  items[2] = require(11950) /* getClass */.getClass(button, "button", combined, disabled ? closure_14.DISABLED : closure_14.DEFAULT);
  const obj2 = require(11950) /* getClass */;
  const tmp2 = disabled ? closure_14.DISABLED : closure_14.DEFAULT;
  const tmp8 = require;
  items[3] = require(11950) /* getClass */.getClass(button, "button", size);
  const obj3 = require(11950) /* getClass */;
  items[4] = require(11950) /* getClass */.getClass(button, "button", look);
  let faded;
  if (!flag3) {
