...
// Dependencies: [19, 17, 12237, 21, 3, 1416, 12238, 12239, 8233, 5267, 4162, 4711, 514, 7775, 643, 2]

// Module 12236 (StaticNativeCutoutAvatarImage)
...
function StaticNativeCutoutAvatarImage(cutout) {
  ...
  const tmp2 = importDefault(12239)(source);
  const items1 = [obj.image, imageStyle];
  obj[2] = callback(importDefault(5267), { style: items1, source: tmp2, usesSmallCache: true });
  return callback(importDefault(8233), obj);
}
function AnimatedNativeCutoutAvatarImage(cutout) {
  ...
  obj[2] = callback(importDefault(5267), { style: items, source: importDefault(12239)(source), usesSmallCache: true });
...
function CutoutAvatarImage(arg0) {
  ...
  if (null != source) {
    if (null != tintColor) {
      ...
      obj1[0] = tintColor;
      obj[0] = obj1;
      obj[1] = importDefault(12239)(source);
      obj[5] = callback(importDefault(5267), obj);
  ...
  obj10[4] = importDefault(12239)(source);
...
const memoResult = importAllResult.memo((style) => {
  ...
  if (null != source) {
    ...
    let obj1 = require(12238) /* getChannelIconURL */;
  ...
  if (null == avatarSource) {
    ...
    if (null != cutout) {
      ...
      obj2[2] = tmp22;
      return callback(importDefault(5267), obj2, "image");
    }
  }
