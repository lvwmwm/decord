...
// Dependencies: [19, 17, 12391, 21, 3, 1435, 12392, 12393, 8363, 5329, 4083, 4776, 514, 7901, 643, 2]

// Module 12390 (StaticNativeCutoutAvatarImage)
...
function StaticNativeCutoutAvatarImage(cutout) {
  ...
  const tmp2 = importDefault(12393)(source);
  const items1 = [obj.image, imageStyle];
  obj[2] = callback(importDefault(5329), { style: items1, source: tmp2, usesSmallCache: true });
  return callback(importDefault(8363), obj);
}
function AnimatedNativeCutoutAvatarImage(cutout) {
  ...
  obj[2] = callback(importDefault(5329), { style: items, source: importDefault(12393)(source), usesSmallCache: true });
...
function CutoutAvatarImage(arg0) {
  ...
  if (null != source) {
    if (null != tintColor) {
      ...
      obj1[0] = tintColor;
      obj[0] = obj1;
      obj[1] = importDefault(12393)(source);
      obj[5] = callback(importDefault(5329), obj);
      let tmp8 = callback(Circle(7901).ForeignObject, obj);
      let tmp9 = importDefault;
      let tmp10 = callback;
      const tmp14 = importDefault(5329);
    }
  ...
  obj10[4] = importDefault(12393)(source);
...
const memoResult = importAllResult.memo((style) => {
  ...
  if (null != source) {
    ...
    let obj1 = require(12392) /* getChannelIconURL */;
  ...
  if (null == avatarSource) {
    ...
    if (null != cutout) {
      ...
      obj2[2] = tmp22;
      return callback(importDefault(5329), obj2, "image");
    }
  }
