...
// Function ID: 13359
// Name: Fonts
// Dependencies: [109, 19, 17, 676, 21, 4285, 712, 5140, 3996, 1297, 4281, 1236, 5917, 4130, 11479, 500, 2]
...
prototype["renderTrailingButton"] = function renderTrailingButton() {
  ...
  if (null == trailingButton) {
    if (clearButtonVisibility === obj7.ALWAYS) {
      ...
      obj[6] = closure_9(require(5917) /* CircleXIcon */.CircleXIcon, { size: "sm" });
...
prototype["renderTextView"] = function renderTextView() {
  ...
  if (placeholderTextColor != null) {
    ...
    if (inActionSheet) {
      let TextInput = importDefault(11479);
    } else {
