...
// Function ID: 13322
// Name: Fonts
// Dependencies: [109, 19, 17, 676, 21, 4255, 712, 5110, 3967, 1297, 4251, 1236, 5890, 4101, 11445, 500, 2]
...
prototype["renderTrailingButton"] = function renderTrailingButton() {
  ...
  if (null == trailingButton) {
    if (clearButtonVisibility === obj7.ALWAYS) {
      ...
      obj[6] = closure_9(require(5890) /* CircleXIcon */.CircleXIcon, { size: "sm" });
...
prototype["renderTextView"] = function renderTextView() {
  ...
  if (placeholderTextColor != null) {
    ...
    if (inActionSheet) {
      let TextInput = importDefault(11445);
    } else {
