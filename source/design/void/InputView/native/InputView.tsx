...
// Function ID: 13514
// Name: Fonts
// Dependencies: [109, 19, 17, 676, 21, 4342, 712, 5220, 4072, 1297, 4338, 1236, 6060, 1363, 11634, 500, 2]
...
prototype["renderTrailingButton"] = function renderTrailingButton() {
  ...
  if (null == trailingButton) {
    if (clearButtonVisibility === obj7.ALWAYS) {
      ...
      obj[6] = closure_9(require(6060) /* CircleXIcon */.CircleXIcon, { size: "sm" });
...
prototype["renderTextView"] = function renderTextView() {
  ...
  if (placeholderTextColor != null) {
    ...
    if (inActionSheet) {
      let TextInput = importDefault(11634);
    } else {
