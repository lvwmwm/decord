...
// Function ID: 13373
// Name: Fonts
// Dependencies: [109, 19, 17, 676, 21, 4302, 712, 5157, 4013, 1297, 4298, 1236, 5936, 4147, 11494, 500, 2]
...
prototype["renderTopContainer"] = function renderTopContainer() {
  ...
  if (tmp10) {
    ...
    obj[2] = items2;
    obj[3] = title;
    tmp12Result = callback2(require(4298) /* Text */.Text, obj);
  ...
  if (tmp15) {
    ...
    obj[1] = helpText;
    tmp16 = callback2(require(4298) /* Text */.Text, obj);
  }
...
prototype["renderTrailingButton"] = function renderTrailingButton() {
  ...
  if (null == trailingButton) {
    if (clearButtonVisibility === obj7.ALWAYS) {
      ...
      obj[6] = closure_9(require(5936) /* CircleXIcon */.CircleXIcon, { size: "sm" });
...
prototype["renderTextView"] = function renderTextView() {
  ...
  if (placeholderTextColor != null) {
    ...
    if (inActionSheet) {
      let TextInput = importDefault(11494);
    } else {
