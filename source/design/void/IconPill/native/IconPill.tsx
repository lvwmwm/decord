...
// Function ID: 13261
// Name: IconPill
// Dependencies: [19, 17, 505, 21, 4285, 712, 4697, 7922, 2]
// Exports: default

// Module 13260 (IconPill)
import "noop";
...
export default function IconPill(IconComponent) {
  ...
  if (null != IconComponent) {
    ...
    obj[0] = source;
    obj[1] = importDefault(4697).Sizes.EXTRA_SMALL;
    obj[2] = tmp.pillIcon;
    tmp8 = callback;
    tmp9 = callback(importDefault(4697), obj);
    const tmp7 = importDefault(4697);
  }
  const items1 = [tmp9, ];
  const items2 = [tmp.pillText, textStyle];
  items1[1] = tmp8(importDefault(7922), { style: items2, numberOfLines: 1, accessibilityLabel, children: text });
  obj[1] = items1;
