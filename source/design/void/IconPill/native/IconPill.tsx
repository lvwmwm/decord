...
// Function ID: 13426
// Name: IconPill
// Dependencies: [19, 17, 505, 21, 4342, 712, 4779, 8065, 2]
// Exports: default

// Module 13425 (IconPill)
import "noop";
...
export default function IconPill(IconComponent) {
  ...
  if (null != IconComponent) {
    ...
    obj[0] = source;
    obj[1] = importDefault(4779).Sizes.EXTRA_SMALL;
    obj[2] = tmp.pillIcon;
    tmp8 = callback;
    tmp9 = callback(importDefault(4779), obj);
    const tmp7 = importDefault(4779);
  }
  const items1 = [tmp9, ];
  const items2 = [tmp.pillText, textStyle];
  items1[1] = tmp8(importDefault(8065), { style: items2, numberOfLines: 1, accessibilityLabel, children: text });
  obj[1] = items1;
