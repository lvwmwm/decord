...
// Function ID: 13413
// Name: NewTag
// Dependencies: [19, 17, 676, 21, 4344, 712, 4765, 4340, 1236, 2]
// Exports: default
...
export default function NewTag(color) {
  ...
  if (flag) {
    ...
    obj1[1] = tmp7(require(4340) /* Text */.Text, obj2);
    obj[4] = tmp7(closure_3, obj1);
    let tmp7Result = tmp7(importDefault(4765), obj);
    const tmp17 = importDefault(4765);
  } else {
    ...
    obj[1] = tmp7(require(4340) /* Text */.Text, obj3);
