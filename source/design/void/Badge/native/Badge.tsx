...
const obj1 = { "Bool(false)": null, "Bool(false)": "shared", "Bool(false)": "nb", "Bool(false)": "1", "Bool(false)": "sh", "Bool(false)": "4", paddingLeft: BADGE_PADDING, paddingRight: BADGE_PADDING, borderRadius: importDefault(dependencyMap[7]).space.PX_8 };
obj.badge = obj1;
...
obj.badgeText = obj2;
const obj3 = { backgroundColor: importDefault(dependencyMap[7]).colors.WHITE, accessibilityRole: null, -45001119: null };
obj.noCount = obj3;
