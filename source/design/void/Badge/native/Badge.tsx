...
const obj1 = { "Bool(false)": "removeHighlightText", "Bool(false)": "%Function.prototype.call%", "Bool(false)": "_headers", "Bool(false)": "ssy", "Bool(false)": "removeHighlightText", "Bool(false)": "%Function.prototype.call%", paddingLeft: BADGE_PADDING, paddingRight: BADGE_PADDING, borderRadius: importDefault(dependencyMap[7]).space.PX_8 };
obj.badge = obj1;
...
obj.badgeText = obj2;
const obj3 = { 2018655073: -0.00000000000000000000000000000000000019983422284383938, 1669594568: -0.0000000000000000000000000000000000000000030492282538427665, 1045670548: 0., backgroundColor: importDefault(dependencyMap[7]).colors.WHITE };
obj.noCount = obj3;
