...
obj = {};
obj = { borderWidth: result.StyleSheet.hairlineWidth, shadowColor: require("result").colors.BLACK, shadowOffset: { aze: "0 0 4px 0 hsl(none 0% 0% / 0.08)", azj: "drop-shadow(0 0 4px hsl(none 0% 0% / 0.08))" }, backgroundColor: require("result").colors.BACKGROUND_BASE_LOWEST };
obj.button = obj;
