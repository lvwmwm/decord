...
obj = {};
obj = { borderWidth: __exportStarResult1.StyleSheet.hairlineWidth, shadowColor: require("__exportStarResult1").colors.BLACK, shadowOffset: { "Null": "0 0 4px 0 hsl(none 0% 0% / 0.08)", "Null": "drop-shadow(0 0 4px hsl(none 0% 0% / 0.08))" }, backgroundColor: require("__exportStarResult1").colors.BACKGROUND_BASE_LOWEST };
obj.button = obj;
