...
// Function ID: 7656
// Name: FormSliderRow
// Dependencies: [19, 17, 21, 4189, 5219, 5222, 4185, 7656, 5213, 2]
// Exports: default

// Module 7655 (FormSliderRow)
...
export default function FormSliderRow(arg0) {
  ...
  if (context) {
    ...
    items1[1] = callback(importDefault(7656), obj2);
    obj[0] = items1;
    let tmp6Result = tmp6(tmp2(5222).Card, obj);
    const tmp18 = importDefault(7656);
  } else {
    obj = { children: null };
    ...
    items2[1] = callback(importDefault(7656), obj4);
    obj[0] = items2;
    tmp6Result = tmp6(closure_7, obj);
    const tmp10 = importDefault(7656);
  }
  return tmp6Result;
};
