...
// Function ID: 8105
// Name: FormSliderRow
// Dependencies: [19, 17, 21, 4661, 6939, 6292, 4734, 8105, 6937, 2]
// Exports: default
...
export default function FormSliderRow(arg0) {
  ...
  if (context) {
    ...
    items1[1] = callback(importDefault(8105), obj2);
    obj[0] = items1;
    let tmp6Result = tmp6(tmp2(6292).Card, obj);
    const tmp18 = importDefault(8105);
  } else {
    obj = { children: null };
    const obj3 = { label: null, trailing: null };
    obj3[0] = label;
    obj3[1] = trailing;
    const items2 = [callback(importDefault(6937), obj3), ];
    const obj4 = {};
    const merged2 = Object.assign(merged);
    items2[1] = callback(importDefault(8105), obj4);
    obj[0] = items2;
    tmp6Result = tmp6(closure_7, obj);
    const tmp10 = importDefault(8105);
  }
  return tmp6Result;
};
