...
// Function ID: 7475
// Name: FormSection
// Dependencies: [19, 17, 1301, 21, 4342, 712, 5434, 5428, 7475, 5828, 7476, 500, 2]
// Exports: default

// Module 7474 (FormSection)
  ...
  if (React.useContext(require(5434) /* context */.RedesignCompatContext)) {
    ...
    const found = toArrayResult.filter((type) => {
      ...
      if (isValidElementResult) {
        isValidElementResult = type.type !== callback(7475);
      }
    ...
    if (obj.isValidElement(element)) {
      flag = false;
      if (element.type !== importDefault(7475)) {
        flag = false;
    ...
    obj1[2] = flag;
    obj1[3] = found;
    obj[1] = callback(tmp3(5828).TableRowGroup, obj1);
    ...
    if (null != title) {
      ...
      obj3[7] = inset;
      tmp6 = callback(importDefault(7476), obj3);
      const tmp10 = importDefault(7476);
    }
