...
// Function ID: 7770
// Name: FormRadioGroup
// Dependencies: [19, 17, 21, 5299, 7767, 7301, 2]
// Exports: default

// Module 7769 (FormRadioGroup)
...
export default function FormRadioGroup(arg0) {
  ...
  if (React.useContext(require(5299) /* context */.RedesignCompatContext)) {
    ...
    obj1[4] = children;
    obj[0] = callback(require(7767) /* context */.TableRadioGroup, obj1);
    ...
    tmp11Result = callback(importDefault(7301), obj);
    const tmp6 = importDefault(7301);
  }
  return tmp11Result;
};
