// Module ID: 8248
// Function ID: 8249
// Dependencies: [19, 17, 21, 4255, 500, 5299, 7685, 1297, 8249, 8250, 8252, 4251, 2]
...
const forwardRefResult = importAllResult.forwardRef((accessibilityLabel, ref) => {
  ...
  const context = importAllResult.useContext(require(5299) /* context */.RedesignCompatContext);
  ...
  if (context) {
    ...
    if (null != label) {
      ...
      obj1[1] = id;
      obj1[2] = label;
      tmp14 = callback(importDefault(8249), obj1);
    }
    const items = [tmp14, , , ];
    const obj2 = {};
    ...
    obj2.style = items1;
    items[1] = callback(importDefault(8250), obj2);
    let tmp17Result = null;
    if (null != error) {
      const obj3 = { style: null, children: null };
      obj3[0] = tmp2.error;
      obj3[1] = error;
      tmp17Result = tmp17(importDefault(8252), obj3);
    }
    items[2] = tmp17Result;
    tmp17Result = null;
    if (null != hint) {
