...
// Dependencies: [4447, 4448, 4185, 2]
// Exports: withTiming

// Module 4446 (CONFIG_NEVER_ANIMATE_TIMING)
import set from "set" /* 2 */;
import _mod4185 from "module_4185" /* 4185 */;
import CONFIG_NEVER_ANIMATE from "CONFIG_NEVER_ANIMATE" /* 4447 */;
...
function withTiming(value, timingStandard, fn, fn2) {
  ...
  if ("animate-always" === str) {
    ...
    if (tmp4) {
      ...
      obj.reduceMotion = tmp(4185).ReduceMotion.Never;
      tmp7 = obj;
    }
    let tmp5 = tmp7;
  } else {
  ...
  return _mod4185.withTiming(value, tmp5, fn2);
}
withTiming.__closure = { accessibilityPreferencesSharedValue: mutable.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: _mod4185.ReduceMotion, REAwithTiming: _mod4185.withTiming };
...
let obj = { accessibilityPreferencesSharedValue: mutable.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: _mod4185.ReduceMotion, REAwithTiming: _mod4185.withTiming };
