...
function withTiming(value, timingStandard, fn, fn2) {
  ...
  return require(4036).withTiming(value, tmp5, fn2);
}
withTiming.__closure = { accessibilityPreferencesSharedValue: require("mutable").accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: require("module_4036").ReduceMotion, REAwithTiming: require("module_4036").withTiming };
...
let obj = { accessibilityPreferencesSharedValue: require("mutable").accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: require("module_4036").ReduceMotion, REAwithTiming: require("module_4036").withTiming };
const result = require("module_4036").fileFinishedImporting("design/animation/reanimated/timing/timing.tsx");
