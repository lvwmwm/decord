...
// Dependencies: [4665, 4666, 4115, 2]
// Exports: withTiming

// Module 4664 (CONFIG_NEVER_ANIMATE_TIMING)
...
function withTiming(value, timingStandard, fn, fn2) {
  ...
  const accessibilityPreferencesSharedValue = require(4666) /* mutable */.accessibilityPreferencesSharedValue;
  ...
  return require(4115).withTiming(value, tmp5, fn2);
}
withTiming.__closure = { accessibilityPreferencesSharedValue: require("mutable").accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: require("module_4115").ReduceMotion, REAwithTiming: require("module_4115").withTiming };
...
let obj = { accessibilityPreferencesSharedValue: require("mutable").accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: require("module_4115").ReduceMotion, REAwithTiming: require("module_4115").withTiming };
const result = require("module_4115").fileFinishedImporting("design/animation/reanimated/timing/timing.tsx");
