...
// Dependencies: [4446, 4447, 4184, 2]
// Exports: withTiming

// Module 4445 (CONFIG_NEVER_ANIMATE_TIMING)
import set from "set" /* 2 */;
import _mod4184 from "module_4184" /* 4184 */;
import CONFIG_NEVER_ANIMATE from "CONFIG_NEVER_ANIMATE" /* 4446 */;
...
function withTiming(value, timingStandard, fn, fn2) {
  ...
  return _mod4184.withTiming(value, tmp5, fn2);
}
withTiming.__closure = { accessibilityPreferencesSharedValue: mutable.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: _mod4184.ReduceMotion, REAwithTiming: _mod4184.withTiming };
...
let obj = { accessibilityPreferencesSharedValue: mutable.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: _mod4184.ReduceMotion, REAwithTiming: _mod4184.withTiming };
