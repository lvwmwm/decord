...
function withTiming(value, timingStandard, fn, fn2) {
  ...
  if ("animate-always" === str) {
    ...
    if (tmp4) {
      ...
      obj.reduceMotion = tmp(4146).ReduceMotion.Never;
      tmp7 = obj;
    }
    let tmp5 = tmp7;
  } else {
...
let obj = { accessibilityPreferencesSharedValue: require("mutable").accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: require("module_4146").ReduceMotion, REAwithTiming: require("module_4146").withTiming };
const result = require("module_4146").fileFinishedImporting("design/animation/reanimated/timing/timing.tsx");
