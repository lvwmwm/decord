...
// Module 4447 (CONFIG_NEVER_ANIMATE_TIMING)
import set from "set" /* 2 */;
import _mod4186 from "module_4186" /* 4186 */;
import CONFIG_NEVER_ANIMATE from "CONFIG_NEVER_ANIMATE" /* 4448 */;
...
function withTiming(value, timingStandard, fn, fn2) {
  ...
  return _mod4186.withTiming(value, tmp5, fn2);
}
withTiming.__closure = { accessibilityPreferencesSharedValue: mutable.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: _mod4186.ReduceMotion, REAwithTiming: _mod4186.withTiming };
...
let obj = { accessibilityPreferencesSharedValue: mutable.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE_TIMING, ReduceMotion: _mod4186.ReduceMotion, REAwithTiming: _mod4186.withTiming };
