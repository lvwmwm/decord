...
const tmp2 = (() => {
  ...
  withSpring.__closure = { accessibilityPreferencesSharedValue: require(4168) /* mutable */.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE, ReduceMotion: require(4026).ReduceMotion, REAwithSpring: require(4026).withSpring };
  withSpring.__workletHash = 14783154107972;
  withSpring.__initData = closure_3;
  return withSpring;
})();
const result = require("module_4026").fileFinishedImporting("design/animation/reanimated/spring/spring.tsx");
