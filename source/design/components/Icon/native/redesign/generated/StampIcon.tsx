...
// Function ID: 76908
// Name: StampIcon
// Dependencies: [31, 33, 689, 3868, 9960, 2]
// Exports: StampIcon
...
export const StampIcon = function StampIcon(color) {
  ...
  return jsx(require(3868) /* BaseIconImage */.BaseIconImage, { source: require(9960) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
