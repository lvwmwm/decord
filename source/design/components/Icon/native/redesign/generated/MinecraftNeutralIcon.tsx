...
// Dependencies: [19, 17, 21, 712, 4023, 9308, 9309, 9310, 2]
// Exports: MinecraftNeutralIcon

// Module 9307 (MinecraftNeutralIcon)
import "noop";
...
export const MinecraftNeutralIcon = function MinecraftNeutralIcon(secondaryColor) {
  ...
  obj[0] = require(9308) /* registerAsset */;
  obj[1] = color;
  obj[2] = style;
  ...
  obj1[0] = require(9310) /* registerAsset */;
  obj1[1] = str2;
  const items3 = [style];
  const items4 = [];
  ...
  items[2] = callback(require(4023) /* BaseIconImage */.BaseIconImage, obj1);
  obj[0] = items;
