...
// Dependencies: [19, 17, 21, 712, 3958, 9191, 9192, 9193, 2]
// Exports: MinecraftNeutralIcon

// Module 9190 (MinecraftNeutralIcon)
import "noop";
...
export const MinecraftNeutralIcon = function MinecraftNeutralIcon(secondaryColor) {
  ...
  obj1[0] = require(9193) /* registerAsset */;
  obj1[1] = str2;
  const items3 = [style];
  const items4 = [];
