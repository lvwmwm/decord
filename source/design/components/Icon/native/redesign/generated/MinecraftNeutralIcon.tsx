...
// Dependencies: [19, 17, 21, 712, 4064, 9348, 9349, 9350, 2]
// Exports: MinecraftNeutralIcon

// Module 9347 (MinecraftNeutralIcon)
import "noop";
...
export const MinecraftNeutralIcon = function MinecraftNeutralIcon(secondaryColor) {
  ...
  obj1[0] = require(9350) /* registerAsset */;
  obj1[1] = str2;
  const items3 = [style];
  const items4 = [];
  ...
  items[2] = callback(require(4064) /* BaseIconImage */.BaseIconImage, obj1);
  obj[0] = items;
