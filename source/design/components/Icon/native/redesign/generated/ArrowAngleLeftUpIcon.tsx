...
// Dependencies: [31, 33, 689, 3833, 9952, 2]
...
export const ArrowAngleLeftUpIcon = function ArrowAngleLeftUpIcon(color) {
  ...
  return jsx(require(3833) /* BaseIconImage */.BaseIconImage, { source: require(9952) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
