...
// Dependencies: [31, 33, 689, 3868, 12961, 2]
// Exports: ChannelListMagnifyingGlassIcon

// Module 12960 (ChannelListMagnifyingGlassIcon)
import "result";
...
export const ChannelListMagnifyingGlassIcon = function ChannelListMagnifyingGlassIcon(color) {
  ...
  obj = { source: require(12961) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style };
  const merged1 = Object.assign(merged);
  return jsx(require(3868) /* BaseIconImage */.BaseIconImage, { source: require(12961) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
