...
// Function ID: 73317
// Name: ObjectIcon
// Dependencies: [31, 33, 689, 3833, 9416, 2]
// Exports: ObjectIcon
...
export const ObjectIcon = function ObjectIcon(color) {
  ...
  return jsx(require(3833) /* BaseIconImage */.BaseIconImage, { source: require(9416) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
