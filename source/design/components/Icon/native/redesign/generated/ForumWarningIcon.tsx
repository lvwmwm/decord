...
export const ForumWarningIcon = function ForumWarningIcon(color) {
  ...
  return jsx(require(3833) /* BaseIconImage */.BaseIconImage, { source: require(4614) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
