...
// Function ID: 40352
// Name: StageLockIcon
// Dependencies: [31, 33, 689, 3833, 4607, 2]
// Exports: StageLockIcon

// Module 4653 (StageLockIcon)
import "result";
...
export const StageLockIcon = function StageLockIcon(color) {
  ...
  return jsx(require(3833) /* BaseIconImage */.BaseIconImage, { source: require(4607) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
