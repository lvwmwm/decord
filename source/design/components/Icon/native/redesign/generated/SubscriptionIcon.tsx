...
// Dependencies: [31, 33, 689, 3834, 13953, 2]
// Exports: SubscriptionIcon

// Module 13952 (SubscriptionIcon)
import "result";
...
export const SubscriptionIcon = function SubscriptionIcon(color) {
  ...
  obj = { source: require(13953) /* registerAsset */, color: ICON_OVERLAY_LIGHT, style: color.style };
  const merged1 = Object.assign(merged);
  return jsx(require(3834) /* BaseIconImage */.BaseIconImage, { source: require(13953) /* registerAsset */, color: ICON_OVERLAY_LIGHT, style: color.style });
};
