...
export const StageIcon = function StageIcon(color) {
  ...
  return jsx(require(3834) /* BaseIconImage */.BaseIconImage, { source: require(4602) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
