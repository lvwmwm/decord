...
// Function ID: 76902
// Name: ClockXIcon
// Dependencies: [31, 33, 689, 3868, 9956, 2]
// Exports: ClockXIcon
...
export const ClockXIcon = function ClockXIcon(color) {
  ...
  return jsx(require(3868) /* BaseIconImage */.BaseIconImage, { source: require(9956) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
