...
// Function ID: 76215
// Name: CirclePlayIcon
// Dependencies: [31, 27, 33, 689, 3868, 9848, 9849, 2]
// Exports: CirclePlayIcon

// Module 9847 (CirclePlayIcon)
import "result";
...
export const CirclePlayIcon = function CirclePlayIcon(color) {
  ...
  obj = {};
  obj = { source: require(9848) /* registerAsset */, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [callback(require(3868) /* BaseIconImage */.BaseIconImage, obj), ];
  const obj1 = { source: require(9849) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT };
  const items1 = [style];
