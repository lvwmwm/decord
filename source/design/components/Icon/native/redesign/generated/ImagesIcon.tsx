...
// Function ID: 76565
// Name: ImagesIcon
// Dependencies: [31, 33, 689, 3868, 9902, 2]
// Exports: ImagesIcon
...
export const ImagesIcon = function ImagesIcon(color) {
  ...
  return jsx(require(3868) /* BaseIconImage */.BaseIconImage, { source: require(9902) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
