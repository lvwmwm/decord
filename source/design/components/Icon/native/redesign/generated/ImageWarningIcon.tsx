...
export const ImageWarningIcon = function ImageWarningIcon(color) {
  ...
  return jsx(require(3834) /* BaseIconImage */.BaseIconImage, { source: require(4618) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
