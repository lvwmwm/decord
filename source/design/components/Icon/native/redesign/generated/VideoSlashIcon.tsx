...
// Function ID: 92492
// Name: VideoSlashIcon
// Dependencies: [31, 33, 689, 3833, 11970, 2]
// Exports: VideoSlashIcon

// Module 11969 (VideoSlashIcon)
import "result";
...
export const VideoSlashIcon = function VideoSlashIcon(color) {
  ...
  return jsx(require(3833) /* BaseIconImage */.BaseIconImage, { source: require(11970) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
