...
// Function ID: 73308
// Name: NatureIcon
// Dependencies: [31, 33, 689, 3833, 9410, 2]
// Exports: NatureIcon
...
export const NatureIcon = function NatureIcon(color) {
  ...
  return jsx(require(3833) /* BaseIconImage */.BaseIconImage, { source: require(9410) /* registerAsset */, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
