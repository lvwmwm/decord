...
// Dependencies: [5, 32, 853, 19, 17, 505, 21, 4255, 712, 4599, 4595, 4116, 1844, 4600, 4647, 705, 4653, 1236, 3974, 1581, 4661, 1474, 4662, 4663, 4251, 4664, 4665, 2]
// Exports: showConfirmModal, useDismissModalCallback

// Module 4598 (getAlertModalItemKey)
import sum from "sum";
...
function dismissTopAlert() {
  const useAlertStore = _require(4595).useAlertStore;
...
function withAlertModalSpring(value, fn2) {
  return require(4664) /* CONFIG_NEVER_ANIMATE */.withSpring(value, createCacheKey, "animate-always", fn2);
}
