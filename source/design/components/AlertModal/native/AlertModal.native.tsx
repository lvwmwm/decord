...
// Dependencies: [5, 32, 853, 19, 17, 505, 21, 4344, 712, 4688, 4684, 4083, 1891, 4689, 4736, 705, 4742, 1236, 1356, 1628, 4750, 1493, 4751, 4752, 4340, 4753, 4754, 2]
// Exports: showConfirmModal, useDismissModalCallback

// Module 4687 (getAlertModalItemKey)
import sum from "sum";
...
function dismissTopAlert() {
  const useAlertStore = _require(4684).useAlertStore;
...
function withAlertModalSpring(value, fn2) {
  return require(4753) /* CONFIG_NEVER_ANIMATE */.withSpring(value, createCacheKey, "animate-always", fn2);
}
