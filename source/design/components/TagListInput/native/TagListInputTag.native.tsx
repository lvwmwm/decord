...
// Dependencies: [19, 17, 21, 4342, 712, 1367, 1236, 9062, 4887, 4338, 2]
// Exports: TagListInputTagComponent

// Module 9061 (TagListInputTagComponent)
import "noop";
...
export const TagListInputTagComponent = function TagListInputTagComponent(end) {
  ...
  ({ onAccessibilityAction, accessibilityActions } = importDefault(9062)(() => callback("remove"), formatToPlainStringResult));
