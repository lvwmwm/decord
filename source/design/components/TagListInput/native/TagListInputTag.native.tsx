...
// Dependencies: [19, 17, 21, 4255, 712, 1348, 1236, 8907, 4797, 4251, 2]
// Exports: TagListInputTagComponent

// Module 8906 (TagListInputTagComponent)
import "noop";
...
export const TagListInputTagComponent = function TagListInputTagComponent(end) {
  ...
  ({ onAccessibilityAction, accessibilityActions } = importDefault(8907)(() => callback("remove"), formatToPlainStringResult));
