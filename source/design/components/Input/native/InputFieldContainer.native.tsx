...
// Function ID: 5895
// Name: useInputStyles
// Dependencies: [19, 17, 21, 712, 3959, 4255, 5895, 4251, 4116, 4664, 2]
// Exports: InputFieldContainer

// Module 5894 (useInputStyles)
import "noop";
...
let closure_9 = createCacheKey.createStyles(() => {
  ...
  let obj = { sm: require(5895) /* InputHeights */.InputHeights.SM, md: require(5895) /* InputHeights */.InputHeights.MD, lg: require(5895) /* InputHeights */.InputHeights.LG };
