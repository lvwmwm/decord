...
// Function ID: 59098
// Name: useInputStyles
// Dependencies: [31, 27, 33, 689, 3869, 4165, 6720, 4161, 4026, 4577, 2]
// Exports: InputFieldContainer

// Module 6719 (useInputStyles)
import "result";
...
function useInputStyles(size) {
  ...
  let token = require(3869) /* map */.useToken(INPUT_FIELD_RADIUS_LG);
  ...
  const token1 = require(3869) /* map */.useToken(INPUT_FIELD_TEXT_STYLE_LG);
  const obj3 = require(3869) /* map */;
  return callback3(str, flag2, flag3, token, token1, tmp10(3869).useToken(importDefault(689).modules.mobile.INPUT_FIELD_PADDING_VERTICAL_SM_IOS));
}
...
let closure_8 = _createForOfIteratorHelperLoose.createStyles(() => {
  ...
  let obj = { sm: require(6720) /* InputHeights */.InputHeights.SM, md: require(6720) /* InputHeights */.InputHeights.MD, lg: require(6720) /* InputHeights */.InputHeights.LG };
  ...
  const obj10 = {};
  const merged = Object.assign(require(4161) /* Text */.TextStyleSheet[str2]);
