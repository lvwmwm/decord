...
// Function ID: 7833
// Name: Input
// Dependencies: [19, 17, 21, 4344, 712, 1236, 4340, 7833, 2]
// Exports: Input
...
export const Input = function Input(arg0) {
  ...
  if (null == label) {
    ...
    if (null != description) {
      ...
      obj[3] = description;
      tmp15Result = tmp15(require(4340) /* Text */.Text, obj);
    }
    items[2] = tmp15Result;
    tmp15Result = null;
    if (null != errorMessage) {
      ...
      obj1[0] = tmp.error;
      obj1[1] = errorMessage;
      tmp15Result = tmp15(require(7833) /* ErrorText */.ErrorText, obj1);
    }
    items[3] = tmp15Result;
    obj[1] = items;
    ...
    obj3[2] = labelId;
    obj3[3] = label;
    const items1 = [callback(require(4340) /* Text */.Text, obj3), labelTrailing];
    obj2[1] = items1;
    ...
    items2[1] = tmp7Result;
    obj4[5] = items2;
    tmp7Result = tmp7(require(4340) /* Text */.Text, obj4);
    tmp22 = require;
  }
};
