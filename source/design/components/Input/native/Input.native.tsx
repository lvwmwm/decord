...
export const Input = function Input(arg0) {
  ...
  if (null == label) {
    ...
    if (null != description) {
      ...
      obj[3] = description;
      tmp15Result = tmp15(require(4299) /* Text */.Text, obj);
    }
    items[2] = tmp15Result;
    tmp15Result = null;
    ...
    obj3[2] = labelId;
    obj3[3] = label;
    const items1 = [callback(require(4299) /* Text */.Text, obj3), labelTrailing];
    obj2[1] = items1;
    ...
    items2[1] = tmp7Result;
    obj4[5] = items2;
    tmp7Result = tmp7(require(4299) /* Text */.Text, obj4);
    tmp22 = require;
  }
};
