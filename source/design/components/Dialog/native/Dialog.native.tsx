...
export const Dialog = function Dialog(dialogKey) {
  ...
  return jsx(require(4648) /* AccessibilityView */.AccessibilityView, { style: items, accessibilityViewIsModal: true, onAccessibilityEscape: onDismiss, nativeID: null });
};
