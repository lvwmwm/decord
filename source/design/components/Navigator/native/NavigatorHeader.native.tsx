...
function HeaderTextButton(text) {
  ...
  return closure_6(require(5277) /* Background */.HeaderBackButton, obj);
}
...
export const NavigatorHeader = function NavigatorHeader(subtitle) {
  ...
  const items = [icon, callback(require(4299) /* Text */.Text, { accessibilityRole: "header", "aria-level": "1", lineClamp: 1, variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", children: title })];
  obj[1] = items;
  ...
  if (tmp6Result) {
    ...
    obj[4] = subtitle;
    tmp6Result = callback(require(4299) /* Text */.Text, obj);
  }
  items1[1] = tmp6Result;
  items1[2] = importDefault(5271)("js-stack");
  obj[1] = items1;
