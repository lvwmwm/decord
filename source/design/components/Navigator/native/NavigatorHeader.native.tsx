...
// Dependencies: [5, 19, 17, 676, 21, 4302, 712, 4298, 5270, 5273, 1481, 5275, 1236, 5276, 5325, 500, 1609, 5266, 2]
...
function HeaderTextButton(text) {
  ...
  return closure_6(require(5276) /* Background */.HeaderBackButton, obj);
}
...
export const NavigatorHeader = function NavigatorHeader(subtitle) {
  ...
  const items = [icon, callback(require(4298) /* Text */.Text, { accessibilityRole: "header", "aria-level": "1", lineClamp: 1, variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", children: title })];
  obj[1] = items;
  ...
  if (tmp6Result) {
    ...
    obj[4] = subtitle;
    tmp6Result = callback(require(4298) /* Text */.Text, obj);
  }
  items1[1] = tmp6Result;
  items1[2] = importDefault(5270)("js-stack");
  obj[1] = items1;
...
export const FauxHeader = function FauxHeader(arg0) {
  ...
  obj = { paddingTop: top, height: top + require(5266) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT };
  items[1] = obj;
  items[2] = style;
  obj[0] = items;
  obj[1] = children;
