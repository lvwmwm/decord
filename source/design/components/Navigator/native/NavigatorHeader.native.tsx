...
// Dependencies: [5, 19, 17, 676, 21, 4342, 712, 4338, 5311, 5314, 1500, 5316, 1236, 5317, 5366, 500, 1628, 5307, 2]
...
function HeaderTextButton(text) {
  ...
  return closure_6(require(5317) /* Background */.HeaderBackButton, obj);
}
...
export const NavigatorHeader = function NavigatorHeader(subtitle) {
  ...
  const items = [icon, callback(require(4338) /* Text */.Text, { accessibilityRole: "header", "aria-level": "1", lineClamp: 1, variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", children: title })];
  obj[1] = items;
  ...
  if (tmp6Result) {
    ...
    obj[4] = subtitle;
    tmp6Result = callback(require(4338) /* Text */.Text, obj);
  }
  items1[1] = tmp6Result;
  items1[2] = importDefault(5311)("js-stack");
  obj[1] = items1;
...
export const FauxHeader = function FauxHeader(arg0) {
  ...
  obj = { paddingTop: top, height: top + require(5307) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT };
  items[1] = obj;
  items[2] = style;
  obj[0] = items;
  obj[1] = children;
