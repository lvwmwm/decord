...
// Dependencies: [5, 19, 17, 676, 21, 4661, 712, 4734, 6315, 6316, 1501, 6318, 1236, 6319, 6368, 500, 1629, 6370, 2]
...
function HeaderTextButton(text) {
  ...
  return closure_6(require(6319) /* Background */.HeaderBackButton, obj);
}
...
export const NavigatorHeader = function NavigatorHeader(subtitle) {
  ...
  const items = [icon, callback(require(4734) /* Text */.Text, { accessibilityRole: "header", "aria-level": "1", lineClamp: 1, variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", children: title })];
  obj[1] = items;
  ...
  if (tmp6Result) {
    ...
    obj[4] = subtitle;
    tmp6Result = callback(require(4734) /* Text */.Text, obj);
  }
  items1[1] = tmp6Result;
  items1[2] = importDefault(6315)("js-stack");
  obj[1] = items1;
...
export const FauxHeader = function FauxHeader(arg0) {
  ...
  let style;
  ({ children, style } = arg0);
  const top = importDefault(1629)().top;
  let obj = { style: null, children: null };
  const items = [createCacheKey().fauxHeaderWrapper, , ];
  obj = { paddingTop: top, height: top + require(6370) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT };
  items[1] = obj;
  items[2] = style;
  obj[0] = items;
  obj[1] = children;
