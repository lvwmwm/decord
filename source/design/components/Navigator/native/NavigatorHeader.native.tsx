...
// Dependencies: [5, 19, 17, 673, 21, 4481, 709, 4477, 5580, 5583, 1499, 5585, 1233, 5586, 5635, 1234, 1627, 5637, 2]
...
function CustomHeaderBackButton(onPress) {
  ...
  return callback(onPress(5586).HeaderBackButton, obj);
}
