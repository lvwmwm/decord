...
// Dependencies: [19, 1301, 21, 4302, 712, 4298, 4716, 4714, 4844, 2]

// Module 5948 (HeaderActionButton)
...
const forwardRefResult = require("noop").forwardRef((arg0, ref) => {
  ...
  if (null != text) {
    ...
    items[2] = textStyle;
    obj[0] = items;
    obj[3] = require(4716) /* MINIMUM_HIT_AREA */.BUTTON_DEFAULT_MAX_FONT_SIZE_MULTIPLIER;
    obj[4] = text;
    let tmp2 = callback(require(4298) /* Text */.Text, obj);
    ...
    obj[1] = imageStyle;
    obj[2] = iconSize;
    tmp2 = callback(importDefault(4714), obj);
  }
  ...
  obj1[11] = items2;
  return closure_5(require(4844) /* PressableBase */.PressableOpacity, obj1);
});
