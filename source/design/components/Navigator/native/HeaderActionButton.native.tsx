...
// Dependencies: [19, 1301, 21, 4255, 712, 4251, 4670, 4668, 4783, 2]

// Module 5907 (HeaderActionButton)
...
const forwardRefResult = require("noop").forwardRef((arg0, ref) => {
  ...
  if (null != text) {
    ...
    items[2] = textStyle;
    obj[0] = items;
    obj[3] = require(4670) /* MINIMUM_HIT_AREA */.BUTTON_DEFAULT_MAX_FONT_SIZE_MULTIPLIER;
    obj[4] = text;
    let tmp2 = callback(require(4251) /* Text */.Text, obj);
    ...
    obj[1] = imageStyle;
    obj[2] = iconSize;
    tmp2 = callback(importDefault(4668), obj);
  }
  ...
  obj1[11] = items2;
  return closure_5(require(4783) /* PressableBase */.PressableOpacity, obj1);
});
