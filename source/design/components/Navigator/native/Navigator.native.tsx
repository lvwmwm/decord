...
// Dependencies: [32, 19, 17, 21, 4285, 712, 5705, 5253, 3988, 5706, 1609, 1236, 12, 5739, 1481, 4221, 5746, 1209, 2]
// Exports: Navigator, useAccessibilityNativeStackOptions, useNavigatorScreens

// Module 5704 (NavigationStack)
...
function WrappedNavigationStack(arg0) {
  ...
  let obj1 = require(5746) /* useNavigationTheme */;
