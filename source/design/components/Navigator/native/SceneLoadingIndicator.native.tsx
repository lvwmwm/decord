...
// Dependencies: [31, 27, 33, 4165, 5619, 5483, 2]
// Exports: SceneLoadingIndicator

// Module 5618 (SceneLoadingIndicator)
import "result";
...
export const SceneLoadingIndicator = function SceneLoadingIndicator() {
  ...
  const items = [callback(require(5619) /* ActivityIndicator */.ActivityIndicator, {}), callback(require(5483) /* NavScrim */.NavScrim, {})];
  obj.children = items;
