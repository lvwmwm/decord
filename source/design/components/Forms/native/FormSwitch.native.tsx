...
// Function ID: 5623
// Name: FormSwitch
// Dependencies: [32, 19, 17, 21, 4116, 4255, 712, 4668, 3974, 1348, 4665, 4669, 3959, 5623, 5624, 4224, 4225, 2]
// Exports: FormSwitch

// Module 5622 (FormSwitch)
...
const require = arg1;
let closure_6 = require("module_4116").createAnimatedComponent(require("set").Pressable);
...
export const FormSwitch = function FormSwitch(onValueChange) {
  ...
  const fn2 = function n() {
    if (enabled) {
      ...
      obj[0] = obj.withSpring(first ? c0 : c1, require(4669) /* SUBTLE_SPRING */.SUBTLE_SPRING, "animate-always");
      obj = { scale: null };
      obj[0] = require(4665) /* CONFIG_NEVER_ANIMATE */.withSpring(1, require(4669) /* SUBTLE_SPRING */.SUBTLE_SPRING);
      const items = [obj];
      obj[1] = items;
      return obj;
    }
