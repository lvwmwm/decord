...
// Function ID: 5809
// Name: FormSwitch
// Dependencies: [32, 19, 17, 21, 4083, 4344, 712, 4756, 1356, 1367, 4753, 4757, 4065, 5809, 5810, 4313, 4314, 2]
// Exports: FormSwitch

// Module 5808 (FormSwitch)
...
export const FormSwitch = function FormSwitch(onValueChange) {
  ...
  const fn2 = function n() {
    if (enabled) {
      ...
      obj[0] = obj.withSpring(first ? c0 : c1, require(4757) /* SUBTLE_SPRING */.SUBTLE_SPRING, "animate-always");
      obj = { scale: null };
      obj[0] = require(4753) /* CONFIG_NEVER_ANIMATE */.withSpring(1, require(4757) /* SUBTLE_SPRING */.SUBTLE_SPRING);
      const items = [obj];
      obj[1] = items;
      return obj;
    }
