...
// Dependencies: [19, 644, 705, 4036, 4272, 2]
...
// Module 8599 (updateContextMenuState)
...
function updateContextMenuState(absoluteX, absoluteY, closure_17) {
  ...
  if (0 < value.length) {
    ...
    if (activeIndex.get() !== result1) {
      ...
      require(4036).runOnJS(require(4272) /* HapticFeedbackTypes */.triggerHapticFeedback)(require(4272) /* HapticFeedbackTypes */.HapticFeedbackTypes.IMPACT_LIGHT);
      const runOnJSResult = require(4036).runOnJS(require(4272) /* HapticFeedbackTypes */.triggerHapticFeedback);
    }
  }
