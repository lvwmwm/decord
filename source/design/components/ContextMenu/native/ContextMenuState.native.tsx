...
// Dependencies: [19, 644, 705, 4042, 4272, 2]
...
// Module 8605 (updateContextMenuState)
...
function updateContextMenuState(absoluteX, absoluteY, closure_17) {
  ...
  if (0 < value.length) {
    ...
    if (activeIndex.get() !== result1) {
      ...
      require(4042).runOnJS(require(4272) /* HapticFeedbackTypes */.triggerHapticFeedback)(require(4272) /* HapticFeedbackTypes */.HapticFeedbackTypes.IMPACT_LIGHT);
      const runOnJSResult = require(4042).runOnJS(require(4272) /* HapticFeedbackTypes */.triggerHapticFeedback);
    }
  }
