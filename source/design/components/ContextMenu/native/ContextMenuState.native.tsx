...
// Dependencies: [19, 644, 705, 4145, 4254, 2]
...
// Module 8522 (updateContextMenuState)
...
function updateContextMenuState(absoluteX, absoluteY, closure_17) {
  ...
  if (0 < value.length) {
    ...
    if (activeIndex.get() !== result1) {
      ...
      require(4145).runOnJS(require(4254) /* HapticFeedbackTypes */.triggerHapticFeedback)(require(4254) /* HapticFeedbackTypes */.HapticFeedbackTypes.IMPACT_LIGHT);
      const runOnJSResult = require(4145).runOnJS(require(4254) /* HapticFeedbackTypes */.triggerHapticFeedback);
    }
  }
