...
// Dependencies: [19, 644, 705, 4115, 4343, 2]
...
function updateContextMenuState(absoluteX, absoluteY, closure_17) {
  ...
  if (0 < value.length) {
    ...
    if (activeIndex.get() !== result1) {
      ...
      require(4115).runOnJS(require(4343) /* HapticFeedbackTypes */.triggerHapticFeedback)(require(4343) /* HapticFeedbackTypes */.HapticFeedbackTypes.IMPACT_LIGHT);
      const runOnJSResult = require(4115).runOnJS(require(4343) /* HapticFeedbackTypes */.triggerHapticFeedback);
    }
  }
