...
// Dependencies: [32, 19, 17, 21, 4116, 8550, 3974, 8552, 8553, 2]
// Exports: AnimatedTooltip

// Module 8549 (renderTooltipItem)
...
function renderTooltipItem(arg0, arg1) {
  ...
  if (null != arg0) {
    ...
    tmpResult = tmp(require(8550) /* Tooltip */.Tooltip, obj);
  }
  obj[2] = tmpResult;
...
export const AnimatedTooltip = function AnimatedTooltip(visible) {
  ...
  return jsx(importDefault(8553), { useReducedMotion: React.useContext(visible(3974).AccessibilityPreferencesContext).reducedMotion.enabled, item: null, entering: null, exiting: null, renderItem: null });
};
