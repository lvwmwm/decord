...
// Function ID: 4299
// Name: Text
// Dependencies: [19, 17, 505, 21, 4162, 712, 12, 4299, 4300, 4302, 299, 4307, 2]
...
const forwardRefResult = importAllResult.forwardRef((animated) => {
  ...
  let obj = require(4307) /* useTypographyVariantRemap */;
  ...
  const manaTextMigrationHighlight = require(4300) /* useManaTextMigrationHighlight */.useManaTextMigrationHighlight(dependencyMap[typographyVariantRemap], style);
