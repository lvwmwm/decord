...
// Function ID: 5303
// Name: PressableCard
// Dependencies: [109, 19, 17, 21, 4116, 712, 4255, 5303, 1348, 3959, 500, 4664, 4668, 5304, 2]

// Module 5302 (PressableCard)
...
class Card {
  constructor(arg0) {
    ...
    tmp3 = f35355(flag, flag2, str3, str, str2, radius);
    items = [, , ];
...
let closure_10 = createCacheKey.createStyles((arg0, arg1, arg2, arg3, arg4, arg5) => {
  ...
  const card = {};
  const merged = Object.assign(require(5303) /* createCardShadowToken */.createCardShadowToken(arg3));
  let tmp21;
  if (arg0) {
    tmp21 = arg5;
  }
