...
export const getWhatYouLoseProfileTier1Source = function getWhatYouLoseProfileTier1Source(theme) {
  ...
  obj = {
    dark() {
      return callback(7835);
    },
    darker() {
      return callback(7836);
    },
    light() {
      return callback(7837);
    }
  };
