...
export const getGuildSubscriptionNoGuildsSource = function getGuildSubscriptionNoGuildsSource(theme) {
  ...
  obj = {
    dark() {
      return callback(13124);
    },
    darker() {
      return callback(13125);
    },
    light() {
      return callback(13126);
    }
  };
