...
// Dependencies: [19, 17, 21, 712, 3959, 689, 4676, 2]
// Exports: ExpressiveGradient

// Module 7627 (ExpressiveGradient)
import "noop";
...
export const ExpressiveGradient = function ExpressiveGradient(color) {
  ...
  items2 = [token, token1];
  const items3 = [callback(importDefault(4676), obj2), ];
  ...
  items3[1] = callback(importDefault(4676), obj3);
  obj1[1] = items3;
