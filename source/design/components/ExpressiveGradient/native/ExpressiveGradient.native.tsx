...
// Dependencies: [19, 17, 21, 712, 3893, 689, 4611, 2]
// Exports: ExpressiveGradient

// Module 6654 (ExpressiveGradient)
import "noop";
...
export const ExpressiveGradient = function ExpressiveGradient(color) {
  ...
  items2 = [token, token1];
  const items3 = [callback(importDefault(4611), obj2), ];
  ...
  items3[1] = callback(importDefault(4611), obj3);
  obj1[1] = items3;
