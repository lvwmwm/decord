...
// Dependencies: [19, 17, 21, 712, 4005, 689, 4723, 2]
// Exports: ExpressiveGradient

// Module 7674 (ExpressiveGradient)
import "noop";
...
export const ExpressiveGradient = function ExpressiveGradient(color) {
  ...
  items2 = [token, token1];
  const items3 = [callback(importDefault(4723), obj2), ];
  ...
  items3[1] = callback(importDefault(4723), obj3);
  obj1[1] = items3;
