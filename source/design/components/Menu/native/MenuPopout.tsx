...
// Function ID: 13664
// Name: MenuPopout
// Dependencies: [32, 19, 21, 8816, 4184, 10241, 13660, 13661, 13662, 2]
// Exports: MenuPopout

// Module 13663 (MenuPopout)
...
export const MenuPopout = function MenuPopout(onRequestOpen) {
  ...
  memo = align.useMemo(() => offset(menuItems(onRequestClose[6]).Menu, {
    ...
    children: menuItems.map((arg0, arg1) => {
      ...
      obj[0] = callback2(callback(13662).MenuItem, obj);
      return callback2(callback(13661).MenuGroup, obj, "chat-context-menu-group-" + arg1);
    })
  }), items1);
