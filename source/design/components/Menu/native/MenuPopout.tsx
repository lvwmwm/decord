...
// Function ID: 13691
// Name: MenuPopout
// Dependencies: [32, 19, 21, 8720, 4185, 10362, 13687, 13688, 13689, 2]
// Exports: MenuPopout

// Module 13690 (MenuPopout)
...
export const MenuPopout = function MenuPopout(onRequestOpen) {
  ...
  memo = align.useMemo(() => offset(menuItems(onRequestClose[6]).Menu, {
    ...
    children: menuItems.map((arg0, arg1) => {
      ...
      obj[0] = callback2(callback(13689).MenuItem, obj);
      return callback2(callback(13688).MenuGroup, obj, "chat-context-menu-group-" + arg1);
    })
  }), items1);
