...
// Function ID: 13744
// Name: MenuPopout
// Dependencies: [32, 19, 21, 8758, 4187, 10404, 13740, 13741, 13742, 2]
// Exports: MenuPopout

// Module 13743 (MenuPopout)
...
export const MenuPopout = function MenuPopout(onRequestOpen) {
  ...
  memo = align.useMemo(() => offset(menuItems(onRequestClose[6]).Menu, {
    ...
    children: menuItems.map((arg0, arg1) => {
      ...
      obj[0] = callback2(callback(13742).MenuItem, obj);
      return callback2(callback(13741).MenuGroup, obj, "chat-context-menu-group-" + arg1);
    })
  }), items1);
