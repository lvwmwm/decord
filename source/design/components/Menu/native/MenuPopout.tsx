...
// Function ID: 13591
// Name: MenuPopout
// Dependencies: [32, 19, 21, 8748, 4120, 10174, 13587, 13588, 13589, 2]
// Exports: MenuPopout

// Module 13590 (MenuPopout)
...
export const MenuPopout = function MenuPopout(onRequestOpen) {
  ...
  memo = align.useMemo(() => offset(menuItems(onRequestClose[6]).Menu, {
    ...
    children: menuItems.map((arg0, arg1) => {
      ...
      obj[0] = callback2(callback(13589).MenuItem, obj);
      return callback2(callback(13588).MenuGroup, obj, "chat-context-menu-group-" + arg1);
    })
  }), items1);
