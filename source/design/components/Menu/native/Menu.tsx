...
// Function ID: 13392
// Name: NOOP
// Dependencies: [32, 19, 17, 676, 21, 13381, 4303, 712, 4042, 1356, 1628, 1493, 500, 1351, 1236, 4710, 4304, 13385, 13379, 4713, 2]
// Exports: Menu
...
function measureButtonRef(arg0, arg1) {
  const measureResult = require(4042).measure(arg0);
  if (null != measureResult) {
    require(4042).runOnJS(arg1)(measureResult);
    const tmpResult = require(4042);
  }
}
