...
let closure_8 = { _createOnViewableItemsChanged: null, nextHopProtocol: "5f77547974eb8f3f02aedbb78b4b73bc", handleBuyNow: "NitroGem12", renderSettingSearchResultItem: "lottie", seenCR: true };
...
export const Menu = function Menu(toggleButtonRef) {
  ...
  const sharedValue1 = obj1.useSharedValue({ aze: false, azj: true });
  ...
  const tmp8 = callback(() => {
    ...
    if (null == first) {
      let point = { "Null": false, "Null": true };
    } else {
      let num = 0;
      ({ pageX, pageY } = first);
      if ("right" === position) {
  ...
  class P {
    constructor() {
      ...
      if (enabled) {
        ...
        items1[1] = num5;
        obj.translateX = obj3.interpolate(value, [null, null], items1);
        items = [, , ];
        items[0] = obj;
        obj1 = {};
        ...
        items2[1] = num6;
        obj1.translateY = obj5.interpolate(value3, [null, null], items2);
        items[1] = obj1;
        obj2 = {};
        tmp28 = closure_11;
        num7 = 2;
