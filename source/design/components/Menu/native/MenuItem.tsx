...
const forwardRefResult = importAllResult.forwardRef((action, ref) => {
  ...
  if (typeof label === "string") {
    ...
    obj[0] = label;
    obj[1] = tmp.formLabel;
    tmp7Result = tmp7(menuClose(5328), obj);
  }
  obj[6] = tmp7Result;
  ...
  return jsx(menuClose(5308), { ref, style, accessibilityRole: "menuitem", disabled, leading: null, trailing: null, label: null, onPress: null });
});
