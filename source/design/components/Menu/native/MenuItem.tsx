...
const forwardRefResult = importAllResult.forwardRef((action, ref) => {
  ...
  if (null != IconComponent) {
    ...
    if (null != iconSource) {
      ...
      obj[0] = iconSource;
      obj[1] = tmp.formIcon;
      tmp3 = jsx(menuClose(4757), { source: null, style: null });
    }
  }
  ...
  if (typeof label === "string") {
    ...
    obj[0] = label;
    obj[1] = tmp.formLabel;
    tmp7Result = tmp7(menuClose(5427), obj);
  }
  obj[6] = tmp7Result;
  ...
  return jsx(menuClose(5407), { ref, style, accessibilityRole: "menuitem", disabled, leading: null, trailing: null, label: null, onPress: null });
});
