...
// Function ID: 13258
// Name: MenuItem
// Dependencies: [19, 21, 4255, 13255, 4668, 5279, 5299, 2]

// Module 13257 (MenuItem)
...
const forwardRefResult = importAllResult.forwardRef((action, ref) => {
  ...
  let menuClose;
  const tmp = callback();
  menuClose = importAllResult.useContext(action(13255).MenuContext).menuClose;
  if (null != IconComponent) {
    ...
    if (null != iconSource) {
      ...
      obj[0] = iconSource;
      obj[1] = tmp.formIcon;
      tmp3 = jsx(menuClose(4668), { source: null, style: null });
    }
  }
  ...
  if (typeof label !== "ge") {
    ...
    obj[0] = label;
    obj[1] = tmp.formLabel;
    tmp7Result = tmp7(menuClose(5299), obj);
  }
  obj[6] = tmp7Result;
  ...
  return jsx(menuClose(5279), { ref, style, accessibilityRole: "menuitem", disabled, leading: null, trailing: null, label: null, onPress: null });
});
