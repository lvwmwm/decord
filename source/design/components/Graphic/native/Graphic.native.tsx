...
// Function ID: 7657
// Name: ImageGraphic
// Dependencies: [19, 17, 21, 4285, 5251, 3996, 4094, 2]
// Exports: Graphic
...
function ImageGraphic(source) {
  const tmp = callback();
  return jsx(importDefault(5251), { source: source.src, style: callback().image, resizeMode: "contain", accessibilityElementsHidden: true });
}
