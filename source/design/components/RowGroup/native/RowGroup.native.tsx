...
// Function ID: 13200
// Name: RowGroup
// Dependencies: [19, 17, 21, 4255, 712, 4664, 5620, 2]
// Exports: RowGroup

// Module 13199 (RowGroup)
import "noop";
...
export const RowGroup = function RowGroup(children) {
  ...
  if (tmp2Result) {
    ...
    if (tmp7) {
      obj = { title: null };
      obj[0] = title;
      tmp7 = callback(tmp5(5620).TableRowGroupTitle, obj);
    }
    obj = { direction: "horizontal", spacing: 4, children: null };
    const items = [tmp7, trailing];
    obj[2] = items;
    tmp2Result = tmp2(require(4664) /* Stack */.Stack, obj);
    tmp5 = require;
  }
