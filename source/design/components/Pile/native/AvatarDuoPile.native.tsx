...
// Function ID: 13510
// Name: AvatarDuoPile
// Dependencies: [19, 21, 11170, 12057, 8363, 12, 12390, 2]
// Exports: AvatarDuoPile

// Module 13509 (AvatarDuoPile)
import "noop";
...
export const AvatarDuoPile = function AvatarDuoPile(size) {
  ...
  const obj = { aria-label, shape: require(8363) /* SolidCutout */.CutoutShape.Circle, size: null, gap: 4, depthX: 0.5, depthY: 0.5, children: null };
  tmp3Result = tmp3(12);
  ...
  obj[2] = mapped;
  obj[6] = size.children;
  return jsx(require(11170) /* Pile */.Pile, { aria-label, shape: require(8363) /* SolidCutout */.CutoutShape.Circle, size: null, gap: 4, depthX: 0.5, depthY: 0.5, children: null });
};
