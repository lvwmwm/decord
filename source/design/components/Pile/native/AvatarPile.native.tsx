...
// Function ID: 12305
// Name: AvatarPile
// Dependencies: [19, 21, 12305, 10270, 11976, 8293, 10271, 2]
// Exports: AvatarPile

// Module 12304 (AvatarPile)
...
export const AvatarPile = function AvatarPile(arg0) {
  ...
  const tmp4 = require(12305) /* StaticNativeCutoutAvatarImage */.AVATAR_SIZE_MAP[size];
  let obj = { "aria-label": null, shape: null, size: null, gap: null, depthX: 0.4, children: null };
  obj[0] = require(11976) /* getListSummaryLabel */.getListSummaryLabel(names, totalCount);
  obj[1] = require(8293) /* SolidCutout */.CutoutShape.Circle;
  obj[2] = tmp4;
  let num = 3;
  if (tmp4 <= 40) {
    num = 2;
  ...
  if (tmp6) {
    ...
    tmp6 = callback(require(10271) /* map */.PileOverflow, obj);
  }
  items[1] = tmp6;
  obj[5] = items;
  return closure_4(require(10270) /* Pile */.Pile, obj);
};
