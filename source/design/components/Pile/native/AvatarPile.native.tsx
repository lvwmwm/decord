...
// Function ID: 12308
// Name: AvatarPile
// Dependencies: [19, 21, 12308, 10275, 11979, 8298, 10276, 2]
// Exports: AvatarPile

// Module 12307 (AvatarPile)
...
export const AvatarPile = function AvatarPile(arg0) {
  ...
  const tmp4 = require(12308) /* StaticNativeCutoutAvatarImage */.AVATAR_SIZE_MAP[size];
  ...
  obj[1] = require(8298) /* SolidCutout */.CutoutShape.Circle;
  obj[2] = tmp4;
  let num = 3;
  if (tmp4 <= 40) {
    num = 2;
