...
// Function ID: 12033
// Name: AvatarPile
// Dependencies: [19, 21, 12033, 9945, 11726, 7974, 9946, 2]
// Exports: AvatarPile
...
export const AvatarPile = function AvatarPile(arg0) {
  ...
  const tmp4 = require(12033) /* StaticNativeCutoutAvatarImage */.AVATAR_SIZE_MAP[size];
  ...
  obj[1] = require(7974) /* SolidCutout */.CutoutShape.Circle;
  obj[2] = tmp4;
  let num = 3;
  if (tmp4 <= 40) {
    num = 2;
