...
// Dependencies: [19, 17, 1946, 21, 4146, 4285, 712, 4694, 8698, 11886, 5368, 500, 2]
// Exports: Tabs

// Module 11885 (defaultCountFormatter)
...
let closure_8 = require("module_4146").createAnimatedComponent(ScrollView);
let c9 = 0.04;
