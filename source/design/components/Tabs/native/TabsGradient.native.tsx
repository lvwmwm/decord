...
// Module 11784 (useGradientAnimatedStyle)
...
let closure_8 = { 84079581: "center", -79768422: 14, -618226596: "2026-04-channel-pinning" };
const importDefaultResult = importDefault(dependencyMap[3]);
let closure_9 = arg1(dependencyMap[5]).createStyles({ gradient: { borderRadius: "user", overflow: 45, justifyContent: 45, borderWidth: "relative", borderColor: "100%" }, left: { left: 0 }, right: { right: 0 } });
