...
// Module 11776 (useGradientAnimatedStyle)
...
let closure_8 = { "Bool(false)": "center", "Bool(false)": 14, "Bool(false)": "2026-04-channel-pinning" };
const importDefaultResult = importDefault(dependencyMap[3]);
let closure_9 = arg1(dependencyMap[5]).createStyles({ gradient: { marginTop: "user", flexDirection: 45, flexWrap: 45, columnGap: "relative", rowGap: "100%" }, left: { left: 0 }, right: { right: 0 } });
