...
// Function ID: 4730
// Name: EllipsisCircle
// Dependencies: [19, 21, 4036, 4303, 712, 4304, 4719, 4730, 2]
// Exports: Ellipsis
...
obj[1] = Easing.inOut(require("module_4036").Easing.quad);
...
obj = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: require("module_4036").withDelay, withRepeat: require("module_4036").withRepeat, withTiming: require("CONFIG_NEVER_ANIMATE_TIMING").withTiming, ELLIPSIS_APPEAR_TIMING: obj };
...
let result = require("module_4036").fileFinishedImporting("design/components/Button/native/ButtonEllipsis.native.tsx");
