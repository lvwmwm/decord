...
// Function ID: 4728
// Name: EllipsisCircle
// Dependencies: [19, 21, 4162, 4302, 712, 4303, 4717, 4728, 2]
// Exports: Ellipsis

// Module 4727 (EllipsisCircle)
import "noop";
...
obj[1] = Easing.inOut(require("module_4162").Easing.quad);
...
function withEllipsisAnimation(arg0, value) {
  ...
  const obj2 = require(4162);
  return obj.withDelay(result, obj2.withRepeat(require(4303) /* CONFIG_NEVER_ANIMATE_TIMING */.withTiming(value, obj, "animate-always"), -1, true));
}
obj = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: require("module_4162").withDelay, withRepeat: require("module_4162").withRepeat, withTiming: require("CONFIG_NEVER_ANIMATE_TIMING").withTiming, ELLIPSIS_APPEAR_TIMING: obj };
...
let result = require("module_4162").fileFinishedImporting("design/components/Button/native/ButtonEllipsis.native.tsx");
