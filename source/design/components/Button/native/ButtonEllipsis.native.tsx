...
// Function ID: 4730
// Name: EllipsisCircle
// Dependencies: [19, 21, 4042, 4303, 712, 4304, 4719, 4730, 2]
// Exports: Ellipsis

// Module 4729 (EllipsisCircle)
import "noop";
...
obj[1] = Easing.inOut(require("module_4042").Easing.quad);
...
function withEllipsisAnimation(arg0, value) {
  const obj = require(4042);
  const result = 166.66666666666666 * arg0;
  const obj2 = require(4042);
  return obj.withDelay(result, obj2.withRepeat(require(4304) /* CONFIG_NEVER_ANIMATE_TIMING */.withTiming(value, obj, "animate-always"), -1, true));
}
obj = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: require("module_4042").withDelay, withRepeat: require("module_4042").withRepeat, withTiming: require("CONFIG_NEVER_ANIMATE_TIMING").withTiming, ELLIPSIS_APPEAR_TIMING: obj };
...
let result = require("module_4042").fileFinishedImporting("design/components/Button/native/ButtonEllipsis.native.tsx");
