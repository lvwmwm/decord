...
// Function ID: 4616
// Name: EllipsisCircle
// Dependencies: [19, 21, 4050, 4189, 712, 4190, 4605, 4616, 2]
// Exports: Ellipsis

// Module 4615 (EllipsisCircle)
import "noop";
...
obj[1] = Easing.inOut(require("module_4050").Easing.quad);
...
function withEllipsisAnimation(arg0, value) {
  ...
  return obj.withDelay(result, obj2.withRepeat(require(4190) /* CONFIG_NEVER_ANIMATE_TIMING */.withTiming(value, obj, "animate-always"), -1, true));
}
obj = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: require("module_4050").withDelay, withRepeat: require("module_4050").withRepeat, withTiming: require("CONFIG_NEVER_ANIMATE_TIMING").withTiming, ELLIPSIS_APPEAR_TIMING: obj };
...
let result = require("module_4050").fileFinishedImporting("design/components/Button/native/ButtonEllipsis.native.tsx");
