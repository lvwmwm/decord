...
// Function ID: 4764
// Name: PillWrapper
// Dependencies: [32, 19, 17, 21, 4758, 4344, 712, 4759, 4072, 4065, 4764, 4765, 4083, 1363, 4769, 1356, 4753, 4757, 2]
// Exports: ButtonPill

// Module 4763 (PillWrapper)
...
function PillWrapper(expressivePressState) {
  ...
  let obj1 = require(4759) /* styleProperties */;
  ...
  if ("experimental_premium-primary" !== variant) {
    if ("experimental_premium-basic" !== variant) {
      ...
      if (tmp11Result) {
        ...
        obj1[4] = obj2;
        obj[1] = callback2(tmp(4072).ExpressiveButtonRive, obj1);
      ...
      obj4[1] = items5;
      items3[1] = tmp9(tmp6(4083).View, obj4);
      obj3[0] = items3;
    }
  ...
  obj5[3] = items;
  const items7 = [callback2(importDefault(4765), obj5), ];
...
class LoadingButtonPill {
  constructor(arg0) {
    ...
    items2[1] = tmp8;
    items3 = [, ];
    items3[0] = jsx(require("module_4083").View, { style: items2, children });
    ...
    obj[1] = tmp12Result;
    items3[1] = tmp12(require("module_4083").View, obj);
    obj[6] = items3;
...
let closure_14 = createCacheKey.createStyles((arg0, arg1) => {
  if ("sm" === arg1) {
    ...
    obj[0] = require(4758) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_HEIGHT;
    obj[1] = require(4758) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_HEIGHT;
    obj[2] = require(4758) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_HORIZONTAL_PADDING;
    obj[3] = closure_11;
  } else if ("md" === arg1) {
    obj = { minHeight: null, minWidth: null, paddingHorizontal: null, paddingVertical: null };
    obj[0] = require(4758) /* MINIMUM_HIT_AREA */.MEDIUM_BUTTON_HEIGHT;
    obj[1] = require(4758) /* MINIMUM_HIT_AREA */.MEDIUM_BUTTON_HEIGHT;
    obj[2] = require(4758) /* MINIMUM_HIT_AREA */.MEDIUM_BUTTON_HORIZONTAL_PADDING;
    obj[3] = closure_12;
  } else {
    obj = {};
    if ("lg" === arg1) {
      const obj1 = { minHeight: null, minWidth: null, paddingHorizontal: null, paddingVertical: null };
      obj1[0] = require(4758) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_HEIGHT;
      obj1[1] = require(4758) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_HEIGHT;
      obj1[2] = require(4758) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_HORIZONTAL_PADDING;
      obj1[3] = closure_13;
      obj = obj1;
    }
  }
  let obj3 = require(4758) /* MINIMUM_HIT_AREA */;
  ...
  obj3 = { flexDirection: "row", alignItems: "center", justifyContent: "center", overflow: "hidden", borderWidth: require(4758) /* MINIMUM_HIT_AREA */.BUTTON_BORDER_WIDTH, borderRadius: buttonBorderRadius };
