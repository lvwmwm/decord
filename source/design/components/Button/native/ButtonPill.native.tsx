...
// Function ID: 4705
// Name: PillWrapper
// Dependencies: [32, 19, 17, 21, 4699, 4285, 712, 4700, 3996, 3988, 4705, 4706, 4145, 4130, 4710, 4003, 4694, 4698, 2]
// Exports: ButtonPill
...
function PillWrapper(expressivePressState) {
  ...
  let obj2 = require(3996) /* ManaContext */;
  const tmp5 = callback3(variant, size);
  let obj3 = require(3988) /* map */;
  ...
  items7[1] = closure_8(importDefault(4145).View, { style: items8, children: items9 });
  obj6[0] = items7;
  obj3 = obj6;
}
