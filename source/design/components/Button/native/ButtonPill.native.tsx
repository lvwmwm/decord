...
// Function ID: 4907
// Name: PillWrapper
// Dependencies: [32, 19, 17, 21, 4901, 4448, 712, 4902, 4174, 4167, 4907, 4908, 4187, 1363, 4912, 1356, 4895, 4899, 2]
// Exports: ButtonPill

// Module 4906 (PillWrapper)
import ThemesDefault from "Themes" /* 712 */;
import map from "map" /* 4167 */;
import ManaContext from "ManaContext" /* 4174 */;
import _modDef4187 from "module_4187" /* 4187 */;
import MINIMUM_HIT_AREA2 from "MINIMUM_HIT_AREA" /* 4901 */;
...
function PillWrapper(expressivePressState) {
  ...
  if (shiny) {
    obj = { variant: null };
    obj[0] = variant;
    tmp7 = callback2(tmp(4907).ButtonShine, obj);
  }
  if ("experimental_premium-primary" !== variant) {
    if ("experimental_premium-basic" !== variant) {
      ...
      if (tmp11Result) {
        ...
        obj1[4] = obj2;
        obj[1] = callback2(tmp(4174).ExpressiveButtonRive, obj1);
      ...
      obj4[1] = items5;
      items3[1] = tmp9(tmp6(4187).View, obj4);
      obj3[0] = items3;
    }
  ...
  items7[1] = closure_8(_modDef4187.View, { style: items8, children: items9 });
  obj6[0] = items7;
  obj3 = obj6;
}
...
class LoadingButtonPill {
  constructor(arg0) {
    ...
    items2[1] = tmp8;
    items3 = [, ];
    items3[0] = jsx(require("module_4187").View, { style: items2, children });
    ...
    obj[1] = tmp12Result;
    items3[1] = tmp12(require("module_4187").View, obj);
    obj[6] = items3;
