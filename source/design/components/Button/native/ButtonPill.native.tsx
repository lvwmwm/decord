...
// Function ID: 4705
// Name: PillWrapper
// Dependencies: [32, 19, 17, 21, 4699, 4285, 712, 4700, 3997, 3989, 4705, 4706, 4146, 4131, 4710, 4004, 4694, 4698, 2]
// Exports: ButtonPill

// Module 4704 (PillWrapper)
  ...
  if ("experimental_premium-primary" !== variant) {
    if ("experimental_premium-basic" !== variant) {
      ...
      if (tmp11Result) {
        ...
        obj1[4] = obj2;
        obj[1] = callback2(tmp(3997).ExpressiveButtonRive, obj1);
      ...
      obj4[1] = items5;
      items3[1] = tmp9(tmp6(4146).View, obj4);
      obj3[0] = items3;
    }
...
class BasicButtonPill {
  constructor(arg0) {
    ...
    tmp3 = f32806(str, DEFAULT_BUTTON_SIZE);
...
class LoadingButtonPill {
  constructor(arg0) {
    ...
    items2[1] = tmp8;
    items3 = [, ];
    items3[0] = jsx(require("module_4146").View, { style: items2, children });
    ...
    obj[1] = tmp12Result;
    items3[1] = tmp12(require("module_4146").View, obj);
    obj[6] = items3;
