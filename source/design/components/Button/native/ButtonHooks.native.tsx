...
// Dependencies: [19, 4189, 3901, 712, 4035, 3893, 4050, 4599, 4603, 4604, 4606, 4602, 4185, 500, 2]
...
export const useForegroundColor = function useForegroundColor(variant) {
  return require(3893) /* map */.useToken(createCacheKey[variant]);
};
...
export const useButtonScaleStyles = function useButtonScaleStyles(pressed, width, scaleAmountInPx) {
  ...
  obj = { width, scaleAmountInPx, withSpring: _require(4599).withSpring, interpolate: _require(4050).interpolate, pressed, ON_PRESS_SPRING: _require(4603).ON_PRESS_SPRING };
  fn.__closure = obj;
...
export const useButtonPressAnimationProps = function useButtonPressAnimationProps(sharedValue, scaleAmountInPx, onLayout, onPressIn, onPressOut) {
  ...
  obj = { width: sharedValue1, scaleAmountInPx: num, withSpring: tmp(4599).withSpring, interpolate: tmp(4050).interpolate, pressed: sharedValue, ON_PRESS_SPRING: tmp(4603).ON_PRESS_SPRING };
  fn.__closure = obj;
  fn.__workletHash = 17256006845494;
  fn.__initData = closure_10;
