...
// Function ID: 9019
// Name: ImageButton
// Dependencies: [19, 17, 21, 4255, 4669, 712, 4670, 4116, 4664, 4668, 4672, 7645, 4251, 2]

// Module 9018 (ImageButton)
...
let closure_8 = createCacheKey.createStyles((arg0, arg1, arg2) => {
  let MEDIUM_BUTTON_PADDING = require(4669) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_PADDING;
  if ("sm" === arg0) {
  ...
  const buttonBorderRadius = require(4669) /* MINIMUM_HIT_AREA */.getButtonBorderRadius(arg0);
  ...
  obj[4] = num;
  const tmpResult = require(4669) /* MINIMUM_HIT_AREA */;
  obj[1] = { paddingHorizontal: 0, paddingVertical: 0, minHeight: sum, minWidth: sum, borderRadius: buttonBorderRadius, borderWidth: 0, outlineWidth: require(4669) /* MINIMUM_HIT_AREA */.BUTTON_BORDER_WIDTH, outlineColor: importDefault(712).colors.CONTROL_SECONDARY_BORDER_DEFAULT, outlineStyle: "solid" };
  obj[2] = { width: sum, height: sum, position: "relative" };
  obj[3] = { width: sum, height: sum };
  const obj1 = { paddingHorizontal: 0, paddingVertical: 0, minHeight: sum, minWidth: sum, borderRadius: buttonBorderRadius, borderWidth: 0, outlineWidth: require(4669) /* MINIMUM_HIT_AREA */.BUTTON_BORDER_WIDTH, outlineColor: importDefault(712).colors.CONTROL_SECONDARY_BORDER_DEFAULT, outlineStyle: "solid" };
