...
// Function ID: 9175
// Name: ImageButton
// Dependencies: [19, 17, 21, 4342, 4759, 712, 4760, 4083, 4754, 4758, 4762, 7797, 4338, 2]

// Module 9174 (ImageButton)
...
let closure_8 = createCacheKey.createStyles((arg0, arg1, arg2) => {
  let MEDIUM_BUTTON_PADDING = require(4759) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_PADDING;
  if ("sm" === arg0) {
  ...
  const buttonBorderRadius = require(4759) /* MINIMUM_HIT_AREA */.getButtonBorderRadius(arg0);
  ...
  obj[4] = num;
  const tmpResult = require(4759) /* MINIMUM_HIT_AREA */;
  obj[1] = { paddingHorizontal: 0, paddingVertical: 0, minHeight: sum, minWidth: sum, borderRadius: buttonBorderRadius, borderWidth: 0, outlineWidth: require(4759) /* MINIMUM_HIT_AREA */.BUTTON_BORDER_WIDTH, outlineColor: importDefault(712).colors.CONTROL_SECONDARY_BORDER_DEFAULT, outlineStyle: "solid" };
  obj[2] = { width: sum, height: sum, position: "relative" };
  obj[3] = { width: sum, height: sum };
  const obj1 = { paddingHorizontal: 0, paddingVertical: 0, minHeight: sum, minWidth: sum, borderRadius: buttonBorderRadius, borderWidth: 0, outlineWidth: require(4759) /* MINIMUM_HIT_AREA */.BUTTON_BORDER_WIDTH, outlineColor: importDefault(712).colors.CONTROL_SECONDARY_BORDER_DEFAULT, outlineStyle: "solid" };
