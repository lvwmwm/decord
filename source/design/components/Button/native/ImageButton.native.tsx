...
// Function ID: 9189
// Name: ImageButton
// Dependencies: [19, 17, 21, 4342, 4781, 712, 4782, 4083, 4776, 4780, 4784, 7818, 4338, 2]

// Module 9188 (ImageButton)
...
let closure_8 = createCacheKey.createStyles((arg0, arg1, arg2) => {
  let MEDIUM_BUTTON_PADDING = require(4781) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_PADDING;
  if ("sm" === arg0) {
  ...
  const buttonBorderRadius = require(4781) /* MINIMUM_HIT_AREA */.getButtonBorderRadius(arg0);
  ...
  obj[4] = num;
  const tmpResult = require(4781) /* MINIMUM_HIT_AREA */;
  obj[1] = { paddingHorizontal: 0, paddingVertical: 0, minHeight: sum, minWidth: sum, borderRadius: buttonBorderRadius, borderWidth: 0, outlineWidth: require(4781) /* MINIMUM_HIT_AREA */.BUTTON_BORDER_WIDTH, outlineColor: importDefault(712).colors.CONTROL_SECONDARY_BORDER_DEFAULT, outlineStyle: "solid" };
  obj[2] = { width: sum, height: sum, position: "relative" };
  obj[3] = { width: sum, height: sum };
  const obj1 = { paddingHorizontal: 0, paddingVertical: 0, minHeight: sum, minWidth: sum, borderRadius: buttonBorderRadius, borderWidth: 0, outlineWidth: require(4781) /* MINIMUM_HIT_AREA */.BUTTON_BORDER_WIDTH, outlineColor: importDefault(712).colors.CONTROL_SECONDARY_BORDER_DEFAULT, outlineStyle: "solid" };
