...
// Function ID: 9171
// Name: ImageButton
// Dependencies: [19, 17, 21, 4344, 4758, 712, 4759, 4083, 4753, 4757, 4761, 7793, 4340, 2]

// Module 9170 (ImageButton)
...
let closure_8 = createCacheKey.createStyles((arg0, arg1, arg2) => {
  let MEDIUM_BUTTON_PADDING = require(4758) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_PADDING;
  if ("sm" === arg0) {
  ...
  const buttonBorderRadius = require(4758) /* MINIMUM_HIT_AREA */.getButtonBorderRadius(arg0);
  ...
  obj[4] = num;
  const tmpResult = require(4758) /* MINIMUM_HIT_AREA */;
  obj[1] = { paddingHorizontal: 0, paddingVertical: 0, minHeight: sum, minWidth: sum, borderRadius: buttonBorderRadius, borderWidth: 0, outlineWidth: require(4758) /* MINIMUM_HIT_AREA */.BUTTON_BORDER_WIDTH, outlineColor: importDefault(712).colors.CONTROL_SECONDARY_BORDER_DEFAULT, outlineStyle: "solid" };
  obj[2] = { width: sum, height: sum, position: "relative" };
  obj[3] = { width: sum, height: sum };
  const obj1 = { paddingHorizontal: 0, paddingVertical: 0, minHeight: sum, minWidth: sum, borderRadius: buttonBorderRadius, borderWidth: 0, outlineWidth: require(4758) /* MINIMUM_HIT_AREA */.BUTTON_BORDER_WIDTH, outlineColor: importDefault(712).colors.CONTROL_SECONDARY_BORDER_DEFAULT, outlineStyle: "solid" };
