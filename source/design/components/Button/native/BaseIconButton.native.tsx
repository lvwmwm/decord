...
// Function ID: 7693
// Name: BaseIconButton
// Dependencies: [19, 21, 4302, 4716, 4162, 4714, 4717, 4719, 4721, 2]

// Module 7692 (BaseIconButton)
...
let closure_4 = createCacheKey.createStyles((arg0, arg1) => {
  if ("sm" === arg1) {
    ...
    obj[0] = require(4716) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_PADDING;
    obj[1] = require(4716) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_PADDING;
  } else if ("md" === arg1) {
    obj = { paddingHorizontal: null, paddingVertical: null };
    obj[0] = require(4716) /* MINIMUM_HIT_AREA */.MEDIUM_BUTTON_PADDING;
    obj[1] = require(4716) /* MINIMUM_HIT_AREA */.MEDIUM_BUTTON_PADDING;
  } else {
    obj = {};
    if ("lg" === arg1) {
      const obj1 = { paddingHorizontal: null, paddingVertical: null };
      obj1[0] = require(4716) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_PADDING;
      obj1[1] = require(4716) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_PADDING;
      obj = obj1;
    }
  }
...
const forwardRefResult = importAllResult.forwardRef((variant, ref) => {
  ...
  if (undefined === DEFAULT_BUTTON_SIZE) {
    DEFAULT_BUTTON_SIZE = require(4716) /* MINIMUM_HIT_AREA */.DEFAULT_BUTTON_SIZE;
  }
  ...
  const iconSizeStyles = require(4717) /* styleProperties */.useIconSizeStyles(DEFAULT_BUTTON_SIZE, true, maxFontSizeMultiplier);
  let MEDIUM_BUTTON_HEIGHT = require(4716) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_HEIGHT;
  ...
  obj[6] = tmp10Result;
  obj.children = jsx(require(4721) /* PillWrapper */.ButtonPill, { style: items1, variant: str, size: DEFAULT_BUTTON_SIZE, loading, loaderSize: null, pressed: null, children: null });
  return jsx(require(4719) /* BaseButton */.BaseButton, { style: items1, variant: str, size: DEFAULT_BUTTON_SIZE, loading, loaderSize: null, pressed: null, children: null });
});
