...
// Function ID: 7646
// Name: BaseIconButton
// Dependencies: [19, 21, 4255, 4669, 4116, 4667, 4670, 4672, 4674, 2]

// Module 7645 (BaseIconButton)
...
let closure_4 = createCacheKey.createStyles((arg0, arg1) => {
  if ("sm" === arg1) {
    ...
    obj[0] = require(4669) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_PADDING;
    obj[1] = require(4669) /* MINIMUM_HIT_AREA */.SMALL_BUTTON_PADDING;
  } else if ("md" === arg1) {
    obj = { paddingHorizontal: null, paddingVertical: null };
    obj[0] = require(4669) /* MINIMUM_HIT_AREA */.MEDIUM_BUTTON_PADDING;
    obj[1] = require(4669) /* MINIMUM_HIT_AREA */.MEDIUM_BUTTON_PADDING;
  } else {
    obj = {};
    if ("lg" === arg1) {
      const obj1 = { paddingHorizontal: null, paddingVertical: null };
      obj1[0] = require(4669) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_PADDING;
      obj1[1] = require(4669) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_PADDING;
      obj = obj1;
    }
  }
...
const forwardRefResult = importAllResult.forwardRef((variant, ref) => {
  ...
  if (undefined === DEFAULT_BUTTON_SIZE) {
    DEFAULT_BUTTON_SIZE = require(4669) /* MINIMUM_HIT_AREA */.DEFAULT_BUTTON_SIZE;
  }
  ...
  const iconSizeStyles = require(4670) /* styleProperties */.useIconSizeStyles(DEFAULT_BUTTON_SIZE, true, maxFontSizeMultiplier);
  let MEDIUM_BUTTON_HEIGHT = require(4669) /* MINIMUM_HIT_AREA */.LARGE_BUTTON_HEIGHT;
  ...
  obj[6] = tmp10Result;
  obj.children = jsx(require(4674) /* PillWrapper */.ButtonPill, { style: items1, variant: str, size: DEFAULT_BUTTON_SIZE, loading, loaderSize: null, pressed: null, children: null });
  return jsx(require(4672) /* BaseButton */.BaseButton, { style: items1, variant: str, size: DEFAULT_BUTTON_SIZE, loading, loaderSize: null, pressed: null, children: null });
});
