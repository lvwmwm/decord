...
// Function ID: 4673
// Name: BaseButton
// Dependencies: [109, 19, 17, 4673, 21, 3967, 4255, 4670, 4116, 1351, 500, 2]

// Module 4672 (BaseButton)
...
let closure_9 = require("module_4116").createAnimatedComponent(TouchableOpacity);
