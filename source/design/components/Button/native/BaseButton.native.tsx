...
// Function ID: 40027
// Name: BaseButton
// Dependencies: [29, 31, 27, 4586, 33, 3877, 4165, 689, 4583, 4026, 1327, 477, 2]

// Module 4585 (BaseButton)
...
let closure_9 = require("module_4026").createAnimatedComponent(Pressable);
let closure_10 = require("module_4026").createAnimatedComponent(TouchableOpacity);
const forwardRefResult = importAllResult.forwardRef((disabled) => {
  ...
  if (null != str) {
    ...
    tmp10 = jsx(flag2(3877).ThemeContextProvider, { theme: str, children });
  }
