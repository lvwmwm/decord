...
// Function ID: 4608
// Name: BaseButton
// Dependencies: [109, 19, 17, 4608, 21, 3901, 4189, 712, 4605, 4050, 1351, 500, 2]

// Module 4607 (BaseButton)
...
let closure_10 = require("module_4050").createAnimatedComponent(TouchableOpacity);
const forwardRefResult = importAllResult.forwardRef((disabled, ref) => {
  ...
  if (null != str) {
    ...
    obj2[0] = str;
    obj2[1] = children;
    tmp11 = jsx(tmp4(3901).ThemeContextProvider, { theme: null, children: null });
  }
