...
// Function ID: 4703
// Name: BaseButton
// Dependencies: [109, 19, 17, 4703, 21, 3996, 4285, 4700, 4145, 1351, 500, 2]

// Module 4702 (BaseButton)
...
let closure_9 = require("module_4145").createAnimatedComponent(TouchableOpacity);
