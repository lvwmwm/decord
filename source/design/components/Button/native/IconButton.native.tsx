...
// Function ID: 7645
// Name: IconButton
// Dependencies: [19, 21, 4255, 712, 4672, 7645, 4251, 2]

// Module 7644 (IconButton)
...
const forwardRefResult = require("noop").forwardRef((grow) => {
  ...
  if (null != label) {
    ...
    const items = [callback(require(7645) /* BaseIconButton */.BaseIconButton, obj), ];
    ...
    obj.children = items;
    let tmp9 = callback2(require(4672) /* BaseButton */.BaseButton, obj);
  } else {
    obj = { ref: null };
    obj[0] = arg1;
    ...
    obj.accessibilityHint = accessibilityHint;
    obj.maxFontSizeMultiplier = maxFontSizeMultiplier;
    tmp9 = callback(require(7645) /* BaseIconButton */.BaseIconButton, obj);
  }
  return tmp9;
});
