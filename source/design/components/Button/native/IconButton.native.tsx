...
// Function ID: 7692
// Name: IconButton
// Dependencies: [19, 21, 4302, 712, 4719, 7692, 4298, 2]

// Module 7691 (IconButton)
...
const forwardRefResult = require("noop").forwardRef((grow) => {
  ...
  if (null != label) {
    ...
    const items = [callback(require(7692) /* BaseIconButton */.BaseIconButton, obj), ];
    ...
    obj.children = items;
    let tmp9 = callback2(require(4719) /* BaseButton */.BaseButton, obj);
  } else {
    obj = { ref: null };
    obj[0] = arg1;
    ...
    obj.accessibilityHint = accessibilityHint;
    obj.maxFontSizeMultiplier = maxFontSizeMultiplier;
    tmp9 = callback(require(7692) /* BaseIconButton */.BaseIconButton, obj);
  }
  return tmp9;
});
