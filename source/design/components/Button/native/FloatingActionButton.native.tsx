...
const styles = createCacheKey.createStyles(() => {
  ...
  obj[0] = obj;
  obj = { minWidth: require(4604) /* MINIMUM_HIT_AREA */.FAB_BUTTON_SIZE, minHeight: require(4604) /* MINIMUM_HIT_AREA */.FAB_BUTTON_SIZE, padding: 0 };
  if (flag) {
...
export const FloatingActionButton = function FloatingActionButton(positionRight) {
  ...
  obj = { withSpring: positionBottom(4599).withSpring, positionBottom, DEFAULT_POSITION_OFFSET: 16, SPRING_CONFIG: closure_6, positionRight };
  F.__closure = obj;
