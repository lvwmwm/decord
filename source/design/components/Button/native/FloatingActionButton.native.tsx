...
// Function ID: 8565
// Name: styles
// Dependencies: [19, 21, 4255, 712, 4669, 1348, 4116, 4664, 7645, 2]
...
const styles = createCacheKey.createStyles(() => {
  ...
  obj[0] = obj;
  obj = { minWidth: require(4669) /* MINIMUM_HIT_AREA */.FAB_BUTTON_SIZE, minHeight: require(4669) /* MINIMUM_HIT_AREA */.FAB_BUTTON_SIZE, padding: 0 };
  if (flag) {
