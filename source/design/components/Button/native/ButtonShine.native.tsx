...
// Dependencies: [32, 19, 21, 4750, 689, 1363, 4115, 4664, 4661, 2]
// Exports: ButtonShine
...
export const ButtonShine = function ButtonShine(variant) {
  ...
  obj[1] = jsx(importDefault(4115).View, { style: shineStyles.shineInner });
  obj[2] = jsx(importDefault(4115).View, { style: shineStyles.shineInner });
  return jsx(importDefault(4115).View, { style: shineStyles.shineInner });
};
