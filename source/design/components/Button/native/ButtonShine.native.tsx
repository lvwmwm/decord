...
// Dependencies: [32, 19, 21, 4717, 689, 4147, 4162, 4303, 4302, 2]
// Exports: ButtonShine

// Module 4722 (useShineEffectStyles)
...
function useShineEffectStyles(width, variant) {
  ...
  enabled = React.useContext(_require(4147).AccessibilityPreferencesContext).reducedMotion.enabled;
  ...
  obj = { width, SHINE_OFFSCREEN_OFFSET: 120, useReducedMotion: enabled, SHINE_WIDTH: 56, withRepeat: _require(4162).withRepeat, withSequence: _require(4162).withSequence, withTiming: _require(4303).withTiming, withDelay: _require(4162).withDelay, SHINE_INITIAL_ANIMATION_DELAY: 750, SHINE_ANIMATION_DURATION: 2000 };
  fn.__closure = obj;
  ...
  obj[0] = _require(4302).createStyles({ shineContainer: { width: "100%", height: "200%", position: "absolute", overflow: "hidden" }, shine: { width: 56, height: "500%", transform: items, backgroundColor: hexResult, top: "-100%", alignItems: "center" }, shineInner: { width: 16, height: "100%", backgroundColor: hexResult } })();
  obj[1] = animatedStyle;
  return obj;
}
...
export const ButtonShine = function ButtonShine(variant) {
  ...
  obj[1] = jsx(importDefault(4162).View, { style: shineStyles.shineInner });
  obj[2] = jsx(importDefault(4162).View, { style: shineStyles.shineInner });
  return jsx(importDefault(4162).View, { style: shineStyles.shineInner });
};
