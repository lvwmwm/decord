...
// Dependencies: [32, 19, 21, 4700, 689, 4130, 4145, 4286, 4285, 2]
// Exports: ButtonShine

// Module 4705 (useShineEffectStyles)
...
function useShineEffectStyles(width, variant) {
  ...
  enabled = React.useContext(_require(4130).AccessibilityPreferencesContext).reducedMotion.enabled;
  ...
  obj = { width, SHINE_OFFSCREEN_OFFSET: 120, useReducedMotion: enabled, SHINE_WIDTH: 56, withRepeat: _require(4145).withRepeat, withSequence: _require(4145).withSequence, withTiming: _require(4286).withTiming, withDelay: _require(4145).withDelay, SHINE_INITIAL_ANIMATION_DELAY: 750, SHINE_ANIMATION_DURATION: 2000 };
  fn.__closure = obj;
...
export const ButtonShine = function ButtonShine(variant) {
  ...
  obj[1] = jsx(importDefault(4145).View, { style: shineStyles.shineInner });
  obj[2] = jsx(importDefault(4145).View, { style: shineStyles.shineInner });
  return jsx(importDefault(4145).View, { style: shineStyles.shineInner });
};
