...
// Dependencies: [32, 19, 17, 21, 4162, 8602, 4020, 8598, 8599, 2]
// Exports: AnimatedCoachmark

// Module 8601 (renderTooltipItem)
...
function renderTooltipItem(arg0, enterExitAnimatedStyles) {
  ...
  if (null != arg0) {
    ...
    tmpResult = tmp(require(8602) /* Coachmark */.CoachmarkContainer, obj);
  }
  obj[2] = tmpResult;
  return jsx(importDefault(4162).View, { style: items, pointerEvents: "box-none", children: null });
}
...
export const AnimatedCoachmark = function AnimatedCoachmark(visible) {
  ...
  return tmp6(importDefault(8599), obj);
};
