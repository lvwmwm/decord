...
// Dependencies: [32, 19, 17, 21, 4145, 8585, 4003, 8581, 8582, 2]
// Exports: AnimatedCoachmark

// Module 8584 (renderTooltipItem)
...
function renderTooltipItem(arg0, enterExitAnimatedStyles) {
  ...
  if (null != arg0) {
    ...
    tmpResult = tmp(require(8585) /* Coachmark */.CoachmarkContainer, obj);
  }
  obj[2] = tmpResult;
  return jsx(importDefault(4145).View, { style: items, pointerEvents: "box-none", children: null });
}
...
export const AnimatedCoachmark = function AnimatedCoachmark(visible) {
  ...
  return tmp6(importDefault(8582), obj);
};
