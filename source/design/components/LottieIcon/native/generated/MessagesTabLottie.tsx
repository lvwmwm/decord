...
// Function ID: 101192
// Name: items
// Dependencies: [31, 33, 9747, 13112, 2]
...
const forwardRefResult = require("result").forwardRef((arg0, ref) => {
  ...
  return jsx(require(9747) /* LottieIcon */.LottieIcon, { dotLottie: require(13112) /* registerAsset */, animation: "all", ref, layers: closure_3, markers: items });
});
