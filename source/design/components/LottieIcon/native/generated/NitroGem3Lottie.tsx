...
// Function ID: 101081
// Name: items
// Dependencies: [31, 33, 9823, 13114, 2]
...
const forwardRefResult = require("result").forwardRef((arg0, ref) => {
  ...
  return jsx(require(9823) /* LottieIcon */.LottieIcon, { dotLottie: require(13114) /* registerAsset */, animation: "all", ref, layers: closure_3, markers: items });
});
