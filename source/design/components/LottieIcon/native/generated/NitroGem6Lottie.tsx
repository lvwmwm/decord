...
// Function ID: 101216
// Name: items
// Dependencies: [31, 33, 9747, 13128, 2]
...
const forwardRefResult = require("result").forwardRef((arg0, ref) => {
  ...
  return jsx(require(9747) /* LottieIcon */.LottieIcon, { dotLottie: require(13128) /* registerAsset */, animation: "all", ref, layers: closure_3, markers: items });
});
