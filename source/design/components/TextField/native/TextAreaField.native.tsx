...
// Function ID: 7788
// Name: TextAreaField
// Dependencies: [19, 17, 21, 4285, 712, 5909, 5903, 3991, 7788, 1236, 5912, 4281, 2]

// Module 7787 (TextAreaField)
...
const forwardRefResult = require("noop").forwardRef((isDisabled, ref) => {
  ...
  let obj1 = require(5909) /* useInputStyles */;
  ...
  obj2.multiline = true;
  const items1 = [callback(_8Q_k1s(5912).NativeTextInput, obj2), ];
  if (null == diff) {
    items1[1] = null;
    obj1.children = items1;
    return closure_4(_8Q_k1s(5909).InputFieldContainer, obj1);
  } else {
