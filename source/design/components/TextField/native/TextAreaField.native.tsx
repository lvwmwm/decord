...
// Function ID: 7776
// Name: TextAreaField
// Dependencies: [19, 17, 21, 4255, 712, 5899, 5893, 3961, 7776, 1236, 5902, 4251, 2]

// Module 7775 (TextAreaField)
...
const forwardRefResult = require("noop").forwardRef((isDisabled, ref) => {
  ...
  let obj1 = require(5899) /* useInputStyles */;
  ...
  obj2.multiline = true;
  const items1 = [callback(_8Q_k1s(5902).NativeTextInput, obj2), ];
  if (null == diff) {
    items1[1] = null;
    obj1.children = items1;
    return closure_4(_8Q_k1s(5899).InputFieldContainer, obj1);
  } else {
    ...
    obj4[3] = diff;
    obj4 = tmp9(_8Q_k1s(4251).Text, obj4);
    obj3[1] = obj4;
    tmp9(View, obj3);
    const tmp13 = View;
  }
