...
// Function ID: 7760
// Name: TextAreaField
// Dependencies: [19, 17, 21, 4255, 712, 5894, 5888, 3961, 7760, 1236, 5897, 4251, 2]

// Module 7759 (TextAreaField)
...
const forwardRefResult = require("noop").forwardRef((isDisabled, ref) => {
  ...
  let obj1 = require(5894) /* useInputStyles */;
  ...
  let obj3 = require(5888) /* useTextFieldState */;
  ...
  obj2.multiline = true;
  const items1 = [callback(_8Q_k1s(5897).NativeTextInput, obj2), ];
  if (null == diff) {
    items1[1] = null;
    obj1.children = items1;
    return closure_4(_8Q_k1s(5894).InputFieldContainer, obj1);
  } else {
