...
// Function ID: 7386
// Name: BaseTextField
// Dependencies: [19, 21, 500, 1367, 7383, 4105, 7386, 4104, 2]

// Module 7385 (BaseTextField)
...
const forwardRefResult = importAllResult.forwardRef((size, ref2) => {
  ...
  const merged2 = Object.assign(ref(4104).mergeProps(size, focusProps));
  let replaced = str3;
  if (null != size.value) {
  ...
  const tmp3Result2 = ref(4104);
  obj2.ref = ref(4104).mergeRefs(ref, ref2);
  const items2 = [, , ];
  ...
  items1[1] = tmp12(ref(7386).NativeTextInput, obj2);
  items1[2] = size.trailing;
  obj1.children = items1;
  return tmp10(ref(7383).InputFieldContainer, obj1);
});
