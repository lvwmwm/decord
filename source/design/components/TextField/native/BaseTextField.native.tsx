...
// Function ID: 5902
// Name: BaseTextField
// Dependencies: [19, 21, 500, 1348, 5899, 3964, 5902, 3963, 2]

// Module 5901 (BaseTextField)
...
const forwardRefResult = importAllResult.forwardRef((size, ref2) => {
  ...
  const merged2 = Object.assign(ref(3963).mergeProps(size, focusProps));
  let replaced = str3;
  if (null != size.value) {
  ...
  const tmp3Result2 = ref(3963);
  obj2.ref = ref(3963).mergeRefs(ref, ref2);
  const items2 = [, , ];
  ...
  items1[1] = tmp12(ref(5902).NativeTextInput, obj2);
  items1[2] = size.trailing;
  obj1.children = items1;
  return tmp10(ref(5899).InputFieldContainer, obj1);
});
