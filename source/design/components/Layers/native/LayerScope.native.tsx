...
// Function ID: 5777
// Name: Layer
// Dependencies: [32, 19, 17, 676, 21, 5777, 5778, 2]
// Exports: LayerScope
...
function Layer(zIndex) {
  ...
  let dependencyMap;
  let callback;
  context = React.useContext(zIndex(5778).LayerContext);
...
export const LayerScope = function LayerScope(arg0) {
  ...
  obj[1] = items;
  return callback3(require(5778) /* add */.LayerContext.Provider, obj);
};
