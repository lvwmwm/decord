...
// Function ID: 8495
// Name: SplitTextField
// Dependencies: [19, 17, 21, 6000, 5994, 5995, 5999, 6002, 2]

// Module 8494 (SplitTextField)
...
const forwardRefResult = require("noop").forwardRef((size, ref) => {
  ...
  let obj2 = require(5994) /* useTextFieldState */;
  const textField = obj2.useTextField(size, ref);
  ({ inputProps, innerRef, state } = textField);
  let obj3 = require(5995) /* useInputClearButton */;
