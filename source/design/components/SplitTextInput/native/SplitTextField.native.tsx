...
// Function ID: 9214
// Name: SplitTextField
// Dependencies: [19, 17, 21, 6740, 6734, 6735, 6739, 6742, 2]

// Module 9213 (SplitTextField)
...
const forwardRefResult = require("noop").forwardRef((size, ref) => {
  ...
  let obj2 = require(6734) /* useTextFieldState */;
  const textField = obj2.useTextField(size, ref);
  ({ inputProps, innerRef, state } = textField);
  let obj3 = require(6735) /* useInputClearButton */;
