...
// Function ID: 9210
// Name: SplitTextField
// Dependencies: [19, 17, 21, 6737, 6731, 6732, 6736, 6739, 2]
...
const forwardRefResult = require("noop").forwardRef((size, ref) => {
  ...
  let obj2 = require(6731) /* useTextFieldState */;
  const textField = obj2.useTextField(size, ref);
  ({ inputProps, innerRef, state } = textField);
  let obj3 = require(6732) /* useInputClearButton */;
  ...
  return jsx(require(6739) /* BaseTextField */.BaseTextField, {});
});
