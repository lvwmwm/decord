...
// Dependencies: [27, 33, 689, 3869, 6961, 2]
// Exports: DiscordNitroLockupLogo

// Module 6960 (DiscordNitroLockupLogo)
...
export const DiscordNitroLockupLogo = function DiscordNitroLockupLogo(color) {
  ...
  const obj1 = { fadeDuration: 0, source: { uri: importDefault(6961) } };
  ...
  return <Image fadeDuration={0} source={{ uri: importDefault(6961) }} />;
};
