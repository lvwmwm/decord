...
// Dependencies: [27, 33, 689, 3869, 6969, 2]
// Exports: DiscordWordmarkLogo

// Module 6968 (DiscordWordmarkLogo)
...
export const DiscordWordmarkLogo = function DiscordWordmarkLogo(color) {
  ...
  const obj1 = { fadeDuration: 0, source: { uri: importDefault(6969) } };
  ...
  return <Image fadeDuration={0} source={{ uri: importDefault(6969) }} />;
};
