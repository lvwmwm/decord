...
// Dependencies: [27, 33, 689, 3835, 6933, 2]
// Exports: DiscordWordmarkLogo

// Module 6932 (DiscordWordmarkLogo)
...
export const DiscordWordmarkLogo = function DiscordWordmarkLogo(color) {
  ...
  const obj1 = { fadeDuration: 0, source: { uri: importDefault(6933) } };
  ...
  return <Image fadeDuration={0} source={{ uri: importDefault(6933) }} />;
};
