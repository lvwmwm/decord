...
// Function ID: 8608
// Name: InputButton
// Dependencies: [109, 19, 17, 21, 4302, 712, 4716, 5940, 4713, 2]

// Module 8607 (InputButton)
...
const forwardRefResult = require("noop").forwardRef((size, ref) => {
  ...
  if (undefined === maxFontSizeMultiplier) {
    maxFontSizeMultiplier = require(4716) /* MINIMUM_HIT_AREA */.BUTTON_DEFAULT_MAX_FONT_SIZE_MULTIPLIER;
  }
  ...
  if (null != icon) {
    ...
    return jsx(require(4713) /* CollapsingText */.BaseTextButton, {});
  }
});
