...
// Function ID: 8717
// Name: InputButton
// Dependencies: [109, 19, 17, 21, 4342, 712, 4759, 6043, 4756, 2]

// Module 8716 (InputButton)
...
const forwardRefResult = require("noop").forwardRef((size, ref) => {
  ...
  if (undefined === maxFontSizeMultiplier) {
    maxFontSizeMultiplier = require(4759) /* MINIMUM_HIT_AREA */.BUTTON_DEFAULT_MAX_FONT_SIZE_MULTIPLIER;
  }
  ...
  if (null != icon) {
    ...
    return jsx(require(4756) /* CollapsingText */.BaseTextButton, {});
  }
});
