...
// Function ID: 8563
// Name: PressableScale
// Dependencies: [109, 19, 17, 21, 4116, 4670, 2]

// Module 8562 (PressableScale)
...
const forwardRefResult = importAllResult.forwardRef((scaleAmountInPx, ref) => {
  ...
  const buttonPressAnimationProps = require(4670) /* styleProperties */.useButtonPressAnimationProps(sharedValue, num, scaleAmountInPx.onLayout, onPressIn, onPressOut);
  obj = {};
