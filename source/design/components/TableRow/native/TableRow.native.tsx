...
// Function ID: 44975
// Name: TableRowInner
// Dependencies: [31, 27, 33, 4131, 689, 1324, 5165, 3835, 5166, 5125, 5170, 5171, 5174, 4550, 477, 5175, 4127, 2]

// Module 5164 (TableRowInner)
...
class TableRowInner {
  constructor(arg0) {
    ...
    tmp7 = f44978(true === disabled, null != tmp2, tmp6, tmp);
    obj3 = require("map");
