...
// Function ID: 5301
// Name: TableRowInner
// Dependencies: [19, 17, 21, 4255, 712, 1348, 5301, 3959, 5302, 5261, 5306, 5307, 5310, 4671, 500, 5311, 4251, 2]

// Module 5300 (TableRowInner)
...
class TableRowInner {
  constructor(arg0) {
    ...
    tmp9 = f35351(true === disabled, null != tmp4, tmp8, tmp3);
