...
// Function ID: 5636
// Name: TableSwitchRow
// Dependencies: [32, 19, 17, 21, 4255, 500, 3961, 5300, 4251, 5636, 2]
// Exports: TableSwitchRow

// Module 5635 (TableSwitchRow)
...
export const TableSwitchRow = function TableSwitchRow(value) {
  ...
  obj.trailing = closure_5(require(5636) /* FormSwitch */.FormSwitch, { "aria-hidden": true, value, onValueChange: handleOnPress, disabled });
  return closure_5(require(5300) /* TableRowInner */.TableRow, obj);
};
