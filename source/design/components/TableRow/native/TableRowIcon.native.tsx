...
// Function ID: 5421
// Name: TableRowIcon
// Dependencies: [109, 19, 17, 21, 4342, 712, 4757, 2]
// Exports: TableRowIcon

// Module 5420 (TableRowIcon)
...
export const TableRowIcon = function TableRowIcon(arg0) {
  ...
  switch (variant) {
    ...
    case "count":
      ...
      if ("default" === variant) {
        let REFRESH_SMALL_16 = require(4757) /* IconSizes */.IconSizes.MEDIUM;
      } else {
        REFRESH_SMALL_16 = require(4757) /* IconSizes */.IconSizes.REFRESH_SMALL_16;
      }
      let str3 = "md";
      if ("default" !== variant) {
        str3 = "md";
      ...
      if (null != IconComponent) {
        ...
        tmp11Result = tmp11(importDefault(4757), obj);
      }
      obj[1] = tmp11Result;
