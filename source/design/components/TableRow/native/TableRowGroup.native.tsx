...
// Dependencies: [19, 17, 21, 4285, 712, 1348, 4281, 3988, 5315, 5355, 2]
// Exports: TableRowGroup

// Module 5688 (TableRowGroupTitle)
...
export const TableRowGroup = function TableRowGroup(accessibilityLabel) {
  ...
  items[3] = tmp6Result1;
  obj[1] = items;
  return closure_5(require(5355) /* context */.TableRowGroupContext.Provider, { value: true, children: closure_7(View, obj) });
};
