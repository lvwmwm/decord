...
// Dependencies: [19, 17, 21, 4189, 712, 1348, 4185, 3893, 5181, 5221, 2]
// Exports: TableRowGroup

// Module 5554 (TableRowGroupTitle)
...
export const TableRowGroup = function TableRowGroup(accessibilityLabel) {
  ...
  if (tmp6Result) {
    ...
    obj1[3] = description;
    tmp6Result = tmp6(tmp2(4185).Text, obj1);
  }
  items[1] = tmp6Result;
  ...
  if (tmp6Result1) {
    ...
    obj2[3] = helperText;
    tmp6Result1 = tmp6(tmp2(4185).Text, obj2);
  }
  items[3] = tmp6Result1;
  obj[1] = items;
  return closure_5(require(5221) /* context */.TableRowGroupContext.Provider, { value: true, children: closure_7(View, obj) });
};
