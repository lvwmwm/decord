...
// Dependencies: [21, 4285, 1348, 4827, 4281, 2]
// Exports: ActionSheetHeaderPressableText

// Module 8899 (ActionSheetHeaderPressableText)
...
export const ActionSheetHeaderPressableText = function ActionSheetHeaderPressableText(onPress) {
  ...
  return jsx(require(4827) /* PressableBase */.PressableOpacity, { style: callback().container, accessibilityRole: "button", onPress: onPress.onPress, accessibilityLabel: null, children: null });
};
