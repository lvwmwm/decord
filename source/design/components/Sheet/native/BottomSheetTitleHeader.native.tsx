...
function Title(arg0) {
  ...
  return callback2(require(4338) /* Text */.Text, { variant: str, color: "mobile-text-heading-primary", accessibilityRole: "header", style: callback4().title });
}
function Subtitle(children) {
  ...
  const tmp = callback4();
  return callback2(require(4338) /* Text */.Text, { variant: str2, color: str, lineClamp: 1, style: callback4().subtitle, children: children.children });
}
