...
// Module 10130 (ActionSheetIconHeader)
import "noop";
...
export const ActionSheetIconHeader = function ActionSheetIconHeader(subtitle) {
  ...
  const items1 = [callback(require(4298) /* Text */.Text, { variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", lineClamp: 2, children: title }), ];
  let tmp4Result = null;
  if (null != subtitle) {
