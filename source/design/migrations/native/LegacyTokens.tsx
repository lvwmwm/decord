...
// Function ID: 5199
// Name: result
// Dependencies: [17, 4344, 1363, 712, 4193, 2]
...
const result15 = createCacheKey.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    let PRIMARY_160 = require(4193) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.WHITE, 0.25);
...
const result24 = createCacheKey.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    let BACKGROUND_BASE_LOW = require(4193) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.WHITE, 0.24);
    const tmpResult = require(4193) /* hexToRgba */;
  } else {
...
const result27 = createCacheKey.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    let WHITE = require(4193) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.WHITE, 0.24);
    const tmpResult = require(4193) /* hexToRgba */;
  } else {
...
const result57 = createCacheKey.experimental_createToken((theme) => {
  ...
  const hexWithOpacity = require(4193) /* hexToRgba */.hexWithOpacity;
  const unsafe_rawColors = importDefault(712).unsafe_rawColors;
  if (isThemeDarkResult) {
...
const result59 = createCacheKey.experimental_createToken((theme) => {
  if (obj.isThemeDark(theme.theme)) {
    ...
    PRIMARY_500 = require(4193) /* hexToRgba */.hexWithOpacity(importDefault(712).unsafe_rawColors.PRIMARY_500, 0.3);
    const tmpResult = require(4193) /* hexToRgba */;
  }
  return PRIMARY_500;
});
