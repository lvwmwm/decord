...
// Function ID: 57581
// Name: flattenIssue
// Dependencies: [65, 6318, 6320, 6367]

// Module 6405 (flattenIssue)
...
function formatIssueMessage(issues) {
  ...
  if (0 === arr.length) {
    ...
    return "Failed to validate keys: " + require(6320) /* isMatchingPattern */.truncate(arr.join(", "), 100);
  }
  obj = set;
    ...
    if (tmp3.exception.values) {
      if (tmp5) {
        if (tmp5.originalException) {
          ...
          let obj = require(6318) /* isBuiltin */;
