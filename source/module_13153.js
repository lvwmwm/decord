// Module ID: 13153
// Function ID: 13154
// Dependencies: [13116, 13145, 13136, 13141, 13137, 13140, 13147, 13144]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13116)(arg0, arg3);
  const tmp4 = new _require(13145)(arg1, arg3);
  if (">" === arg2) {
  ...
  if (_require(13147)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
    if (0 < tmp4.set.length) {
      while (true) {
        ...
        let item = arr.forEach((semver) => {
          let tmp = semver;
          if (semver.semver === require(13144) /* Comparator */.ANY) {
            tmp = new require(13144) /* Comparator */(">=0.0.0");
          }
          let tmp6 = _null;
          if (!_null) {
            tmp6 = tmp;
