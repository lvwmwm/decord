...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7774, 7863, 7773, 7782]

// Module 7862 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      let match = str;
      if (str) {
        match = str.match(self(7774).idPattern);
      }
      let tmp4 = match;
      if (match) {
        tmp4 = match[1];
