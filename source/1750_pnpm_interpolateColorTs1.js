...
let obj = { interpolate: require(dependencyMap[0]).interpolate, Extrapolation: require(dependencyMap[0]).Extrapolation, hsvToColor: require(dependencyMap[1]).hsvToColor };
...
obj = { toLinearSpace: pnpm_interpolateColorTs2, interpolate: require(dependencyMap[0]).interpolate, Extrapolation: require(dependencyMap[0]).Extrapolation, rgbaColor: require(dependencyMap[1]).rgbaColor, toGammaSpace: pnpm_interpolateColorTs3 };
...
obj = { interpolate: require(dependencyMap[0]).interpolate, Extrapolation: require(dependencyMap[0]).Extrapolation, culori: importDefault(dependencyMap[2]), rgbaColor: require(dependencyMap[1]).rgbaColor };
...
pnpm_interpolateColorTs6.__closure = { processColor: require(dependencyMap[1]).processColor, red: require(dependencyMap[1]).red, green: require(dependencyMap[1]).green, blue: require(dependencyMap[1]).blue, opacity: require(dependencyMap[1]).opacity };
...
const obj1 = { processColor: require(dependencyMap[1]).processColor, red: require(dependencyMap[1]).red, green: require(dependencyMap[1]).green, blue: require(dependencyMap[1]).blue, opacity: require(dependencyMap[1]).opacity };
pnpm_interpolateColorTs8.__closure = { _splitColorsIntoChannels: pnpm_interpolateColorTs6, RGBtoHSV: require(dependencyMap[1]).RGBtoHSV };
...
const obj2 = { _splitColorsIntoChannels: pnpm_interpolateColorTs6, RGBtoHSV: require(dependencyMap[1]).RGBtoHSV };
pnpm_interpolateColorTs9.__closure = { _splitColorsIntoChannels: pnpm_interpolateColorTs6, culori: importDefault(dependencyMap[2]) };
...
const obj4 = { RGB: 0, [0]: "RGB", HSV: 1, [1]: "HSV", LAB: 2, [2]: "LAB" };
const obj3 = { _splitColorsIntoChannels: pnpm_interpolateColorTs6, culori: importDefault(dependencyMap[2]) };

export const Extrapolate = require(dependencyMap[0]).Extrapolation;
export const interpolateColor = () => {
  function interpolateColor(arg0, arg1, arg2) {
    ...
    if (arguments.length > 4) {
      ...
      if ("HSV" === str) {
        return callback2(arg0, arg1, callback6(arg2), obj);
      } else if ("RGB" === str) {
        return callback3(arg0, arg1, callback5(arg2), obj);
      } else if ("LAB" === str) {
        return callback4(arg0, arg1, callback7(arg2), obj);
      } else {
        const ReanimatedError = callback(closure_2[3]).ReanimatedError;
...
export const useInterpolateConfig = function useInterpolateConfig(inputRange, outputRange) {
  if (arguments.length > 2) {
    ...
    if (arguments.length > 3) {
      ...
      obj.options = obj;
      return require(dependencyMap[4]).useSharedValue(obj);
    }
    obj = {};
  }
  RGB = obj4.RGB;
