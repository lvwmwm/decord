...
// Function ID: 5618
// Name: hasOwnProperty
// Dependencies: [5615, 5618]

// Module 5617 (hasOwnProperty)
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5615)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
              tmp12 = require(5615) /* keys */;
              tmp9 = hasOwnProperty;
            }
          }
        }
...
obj.to.hex = () => {
  const tmp = require(5618) /* swizzle */(arguments);
...
obj.to.rgb = () => {
  const arr = require(5618) /* swizzle */(arguments);
  if (arr.length >= 4) {
    if (1 !== arr[3]) {
      const _Math = Math;
      const _Math2 = Math;
