...
// Function ID: 13599
// Name: compareKV
// Dependencies: [1281, 13599, 13597, 13600, 13601]

// Module 13598 (compareKV)
const require = arg1;
...
function canonicalizeUnicodeLanguageId(lang) {
  ...
  if (lang.variants.length) {
    ...
    if (0 < variants.length) {
      ...
      obj[1] = items;
      const str = require(13599).languageAlias[require(undefined, 13597) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj)];
      while (!str) {
        num3 = num3 + 1;
        tmp = lang;
      }
  ...
  if (tmp.script) {
    ...
    if (tmp.region) {
      ...
      obj[3] = [];
      const str2 = require(13599).languageAlias[require(undefined, 13597) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj)];
      tmp9 = tmp;
      if (str2) {
  ...
  if (tmp9.region) {
    ...
    obj2[2] = [];
    const str3 = require(13599).languageAlias[require(undefined, 13597) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj2)];
    tmp13 = tmp9;
    if (str3) {
  ...
  const str4 = require(13599).languageAlias[require(undefined, 13597) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj4)];
  let tmp19 = tmp13;
  if (str4) {
  ...
  if (tmp19.variants.length) {
    for (let num7 = 0; num7 < tmp19.variants.length; num7 = num7 + 1) {
      ...
      let tmp29 = num7;
      if (require(13599).variantAlias[formatted2]) {
