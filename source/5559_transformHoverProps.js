...
// Module 5559 (transformHoverProps)
const require = arg1;
...
arg5.useHoverGesture = function useHoverGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(5535) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformHoverProps);
  const obj = require(5535) /* isGestureEnabled */;
  return require(5550) /* useGesture */.useGesture(require(5526) /* ComposedGestureName */.SingleGestureName.Hover, clonedAndRemappedConfig);
};
