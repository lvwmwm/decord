...
export const SliderTrackMark = function SliderTrackMark(arg0) {
  ...
  let obj = jsxProd;
  obj = { style: require(7934) /* styles */.styles.trackMarkContainer, children: null };
  ...
  items[1] = jsxResult1;
  obj[1] = items;
  return <get ActivityIndicator.View style={require(7934) /* styles */.styles.trackMarkContainer}>{null}</get ActivityIndicator.View>;
};
