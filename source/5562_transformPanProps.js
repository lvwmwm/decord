  ...
  if (undefined === str) {
    ...
    if (undefined === str12) {
      ...
      if (undefined === str23) {
        ...
        if (undefined === str34) {
          activeOffsetY.changeEventCalculator = require(5535) /* isGestureEnabled */.getChangeEventCalculator(diffCalculator);
          ...
          if (Array.isArray(str34)) {
            ...
            obj4 = require(5535) /* isGestureEnabled */;
          }
        ...
        if (Array.isArray(str23)) {
          ...
          obj3 = require(5535) /* isGestureEnabled */;
        }
      ...
      if (Array.isArray(str12)) {
        ...
        obj2 = require(5535) /* isGestureEnabled */;
      }
    ...
    if (Array.isArray(str)) {
      ...
      obj = require(5535) /* isGestureEnabled */;
    }
...
arg5.usePanGesture = function usePanGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(5535) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformPanProps);
  const obj = require(5535) /* isGestureEnabled */;
  return require(5550) /* useGesture */.useGesture(require(5526) /* ComposedGestureName */.SingleGestureName.Pan, clonedAndRemappedConfig);
};
