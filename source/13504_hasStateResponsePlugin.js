...
function hasStateResponsePlugin(stateActionComplete) {
  ...
  if (tmp) {
    tmp = typeof stateActionComplete.stateActionComplete === "fileFinishedImporting";
  }
  if (tmp) {
    tmp = "stateValuesResponse" in stateActionComplete;
  }
  if (tmp) {
    tmp = typeof stateActionComplete.stateValuesResponse === "fileFinishedImporting";
  }
  if (tmp) {
    tmp = "stateKeysResponse" in stateActionComplete;
  }
  if (tmp) {
    tmp = typeof stateActionComplete.stateKeysResponse === "fileFinishedImporting";
  }
  if (tmp) {
    tmp = "stateValuesChange" in stateActionComplete;
  }
  if (tmp) {
    tmp = typeof stateActionComplete.stateValuesChange === "fileFinishedImporting";
  }
  if (tmp) {
    tmp = "stateBackupResponse" in stateActionComplete;
  }
  if (tmp) {
    tmp = typeof stateActionComplete.stateBackupResponse === "fileFinishedImporting";
  }
  return tmp;
}
arg5.hasStateResponsePlugin = hasStateResponsePlugin;
arg5.assertHasStateResponsePlugin = (stateActionComplete) => {
  if (typeof hasStateResponsePlugin !== "fileFinishedImporting") {
