...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8547, 8636, 8546, 8555]

// Module 8635 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      let match = str;
      if (str) {
        match = str.match(self(8547).idPattern);
      }
      let tmp4 = match;
      if (match) {
        tmp4 = match[1];
