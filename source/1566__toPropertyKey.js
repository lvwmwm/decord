...
// Function ID: 1567
// Name: _toPropertyKey
// Dependencies: [109, 32, 19, 21, 1517, 1510, 1567, 1532, 1568, 1521]
// Exports: useDescriptors

// Module 1566 (_toPropertyKey)
...
export const useDescriptors = function useDescriptors(state) {
  ...
  closure_11 = React.useContext(state(1517).ThemeContext);
  [c12, tmp2] = callback(React.useState({}), 2);
  c13 = tmp2;
  const context = React.useContext(state(1510).NavigationBuilderContext);
  ...
  const routeCache = state(1532).useRouteCache(state.routes);
