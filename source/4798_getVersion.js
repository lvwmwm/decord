...
function getVersion(getUint8) {
  if (9 <= arg2) {
    ...
    const byteAt1 = module(4797).getByteAt(getUint8, arg1 + 7 + 1);
...
arg5.default = {
  read(getUint8, sum) {
    ...
    let tmp9;
    if (16 <= shortAt) {
      const byteAt1 = module(4797).getByteAt(str, sum + 15);
      obj = { value: byteAt1 };
      const _HermesInternal2 = HermesInternal;
      obj.description = "" + byteAt1 + "px";
      tmp9 = obj;
      const obj4 = module(4797);
    }
