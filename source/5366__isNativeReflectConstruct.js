...
// Dependencies: [41, 42, 93, 95, 98, 19, 5367, 5343, 5358, 5356]

// Module 5366 (_isNativeReflectConstruct)
...
let obj = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(5343).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  obj,
