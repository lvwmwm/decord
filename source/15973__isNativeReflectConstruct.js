...
const timeoutError = new require("result").TimeoutError();

export default (MCP_PROTOCOL_VERSION_ATTRIBUTE) => {
  class PQueue {
    constructor(arg0) {
      self = this;
      ...
      obj = { accessibilityRole: null, Date: 720, state: 30, borderRadius: true, accessibilityLabel: "/assets/.cache/intl/bW9kdWxlcy9ndWlsZF9zZXR0aW5ncy9zZXJ2ZXJfbW9uZXRpemF0aW9uL2d1aWxkX3RoZW1lL3dlYg==" };
      obj.queueClass = closure_0(closure_1[7]).default;
      merged = Object.assign(obj, MCP_PROTOCOL_VERSION_ATTRIBUTE);
  ...
  const callback2 = PQueue;
  result(PQueue, MCP_PROTOCOL_VERSION_ATTRIBUTE);
  let obj = {
  ...
  // CreateGeneratorClosureLongIndex (0x67)
  const callback = callback("addAll");
  ...
  // CreateGeneratorClosureLongIndex (0x67)
  let closure_1 = callback("onEmpty");
