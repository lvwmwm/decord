...
if ("function" === typeof Symbol) {
    ...
    let closure_28 = (arg0) => {
      ...
      const items1 = [
        ...
        },
        {
          ...
          get() {
            delete r1.g_vowel3;
            const items = [null, null, null, null, "acm", "ar", "acq", "ar", "acw", "ar", "acy", "ar", "adf", "ar", "ads", "sgn", "aeb", "ar", "aec", "ar", "aed", "sgn", "aen", "sgn", "afb", "ar", "afg"];
  ...
  if ("function" === typeof globalThis.define) {
    if (globalThis.define.amd) {
      globalThis.define("snowballFactory", [true], fn2);
    }
  }
