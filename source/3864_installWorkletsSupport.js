...
// Module 3864 (installWorkletsSupport)
let require = arg1;
...
arg5.installWorkletsSupport = function installWorkletsSupport() {
  ...
  const result = require(3865) /* getInstalledNitro */.registerCustomSerializable({ name: "nitro.HybridObject", determine, pack, unpack });
};
