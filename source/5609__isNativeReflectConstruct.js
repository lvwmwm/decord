...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5610, 5611, 5575, 5607, 5612, 5620, 5621, 5622]
  ...
  },
  {
    ...
    value: function componentDidUpdate(layout) {
      ...
      if (gestureDirection !== layout.gestureDirection) {
        ...
        inverted.setValue(importDefault(5610)(gestureDirection));
      }
  ...
  },
  {
    ...
    value: function gestureActivationCriteria() {
      ...
      if ("vertical" === gestureDirection) {
        ...
        if (1 === importDefault(5610)(gestureDirection)) {
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (!gestureEnabled) {
        ...
        obj11[4] = children;
        items9[1] = callback4(importDefault(5621), obj11);
        obj8[2] = items9;
        obj7.children = closure_14(RN.View, obj8);
        obj6[2] = callback4(Card(5575).PanGestureHandler, obj7);
        items1[1] = callback4(RN.View, obj6);
        obj3.children = items1;
        items[2] = closure_14(View, obj3);
        obj[1] = items;
        return closure_14(importDefault(5620).Provider, obj);
      } else {
        if ("vertical" !== gestureDirection) {
          if ("vertical-inverted" !== gestureDirection) {
...
export const getIsModalPresentation = (name) => {
  let tmp = name === Card(5622).forModalPresentationIOS;
  if (!tmp) {
