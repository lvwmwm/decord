...
// Function ID: 4102
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4102, 4103, 4105, 4079]
// Exports: RiveView

// Module 4101 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + require(4102).RiveErrorType[message.type] + "] " + message.message);
}

export const RiveView = function RiveView(arg0) {
  let hybridRef;
  let onError;
  let obj = _require(4103);
  ...
  const tmp18 = jsx(_require(4079).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
