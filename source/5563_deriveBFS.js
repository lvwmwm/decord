...
function deriveBFS(arg0) {
  const obj = {};
  const keys = Object.keys(require(5561) /* keys */);
  ...
  while (items.length) {
    ...
    let keys1 = Object.keys(require(5561) /* keys */[arr]);
...
function wrapConversion(arg0, arg1) {
  ...
  let tmp = require(5561) /* keys */[arg1[arg0].parent][arg0];
  ...
  if (arg1[parent].parent) {
    do {
      ...
      tmp = link(require(5561) /* keys */[arg1[parent].parent][parent], tmp);
