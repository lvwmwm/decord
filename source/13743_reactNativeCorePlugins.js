...
// Dependencies: [5, 17, 82, 13744, 13746, 13748, 13749, 13752, 13753, 13766, 13768, 13770, 13771, 13772, 13773, 13754]

// Module 13743 (reactNativeCorePlugins)
...
import module_13752 from "module_13752";
import objectifyError from "objectifyError";
import onSend from "onSend";
import module_13768 from "module_13768";
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL !== "string") {
        ...
        return require(13773) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
