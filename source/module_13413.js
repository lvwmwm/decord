// Module ID: 13413
// Function ID: 102444
// Dependencies: [77, 6, 7, 13414, 13415, 13422]
...
let obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(tmp, require(13414) /* wrapperForImpl */.implSymbol)) {
        if (tmp[require(undefined, 13414) /* wrapperForImpl */.implSymbol] instanceof require(13415) /* URLImpl */.implementation) {
          return true;
        }
      }
  ...
  isImpl(getAll) {
    if (getAll) {
      if (getAll instanceof require(13415) /* URLImpl */.implementation) {
        return true;
      } else {
  ...
  create(arg0, arg1, arg2) {
    if (undefined === arg0[require(undefined, 13414) /* wrapperForImpl */.ctorRegistrySymbol]) {
      ...
      const _URL = arg0[require(undefined, 13414) /* wrapperForImpl */.ctorRegistrySymbol].URL;
      if (undefined === _URL) {
        const _Error = Error;
  ...
  setup(wrapper) {
    if (arguments.length > 2) {
      ...
      if (arguments.length > 3) {
        ...
        const _Object = Object;
        obj = {};
        let implementation = require(13415) /* URLImpl */.implementation;
        ...
        if (require(13415) /* URLImpl */.init) {
          require(13415) /* URLImpl */.init(wrapper[require(undefined, 13414) /* wrapperForImpl */.implSymbol], obj);
          const obj3 = require(13415) /* URLImpl */;
        }
        return wrapper;
      }
      obj = {};
  ...
  install(arg0) {
    ...
    arg0[_require(undefined, 13414).ctorRegistrySymbol].URL = tmp;
