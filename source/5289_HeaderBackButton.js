...
// Dependencies: [32, 19, 17, 21, 1481, 5290, 5261, 5291, 5262, 5295]
// Exports: HeaderBackButton

// Module 5289 (HeaderBackButton)
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[0] = importDefault(5261);
    obj1[1] = tintColor;
    const items1 = [tmp10.icon, "minimal" !== displayMode && tmp10.iconWithLabel];
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(5290).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(5290).ICON_MARGIN);
      }
    }
  ...
  return closure_7(require(5295) /* HeaderButton */.HeaderButton, obj);
};
