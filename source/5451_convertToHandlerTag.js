...
// Dependencies: [32, 19, 5452, 5453, 5463, 5464, 5465, 5467, 5468, 5469, 5448, 5432, 5470, 5430]
// Exports: checkGestureCallbacksForWorklets, extractGestureRelations, useForceRender, useWebEventHandlers

// Module 5451 (convertToHandlerTag)
...
function convertToHandlerTag(num) {
  if (typeof num === "number") {
    return num;
  } else if (num instanceof require(5448) /* _isNativeReflectConstruct */.BaseGesture) {
    num = num.handlerTag;
  } else {
