...
let closure_2 = ["GUILD_JOIN_REQUEST_UPDATE", "CHANNEL_SELECT", "POST_CONNECTION_OPEN", null, null, null, null, null];
  ...
  items[4] = {
    ...
    value: function _onLoad(arg0) {
      ...
      if (this._mounted) {
        ...
        obj = { duration: tmp2, easing: closure_11.out(closure_11.quad) };
  ...
  items[7] = {
    ...
    get() {
      ...
      if (!tmp) {
        ...
        obj = { "Null": 9090, "Null": "reactotron-core-client", "Null": false, color: props.spinnerColor };
...
obj = { -1403977724: null, -2007939940: null, 485752836: null, 724631556: -1908340706, 1136394244: 1358955573, containerStyle: {}, AnimatedImageComponent: Animated.Image };
