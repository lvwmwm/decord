...
const tmp5 = (Component) => {
  ...
  items[33] = {
    ...
    value: function _getSlideAnimation(_activeItem, toValue) {
      ...
      let obj = { toValue };
      const merged = Object.assign({ "Null": 1766088043, "Null": 827788593 }, activeAnimationOptions, obj);
