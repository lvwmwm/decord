...
export default function _createClass(arg0, arg1, arg2) {
  if (arg1) {
    for (let num = 0; num < arg1.length; num = num + 1) {
      ...
      let definePropertyResult = Object.defineProperty(tmp, require(5493) /* toPropertyKey */(tmp3.key), tmp3);
    }
  }
  if (arg2) {
    for (let num3 = 0; num3 < arg2.length; num3 = num3 + 1) {
      ...
      let definePropertyResult1 = Object.defineProperty(arg0, require(5493) /* toPropertyKey */(tmp9.key), tmp9);
    }
  }
