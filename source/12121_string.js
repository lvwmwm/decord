...
// Function ID: 94386
// Name: string
// Dependencies: [5, 65, 12055, 12118, 12122, 12123, 12124, 12117]

// Module 12121 (string)
import asyncGeneratorStep from "module_12123";
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class) {
      ...
      if (arguments.length > 1) {
        ...
        const util = _require(12055).util;
    ...
    const fnResult = fn(require("module_12055"));
    let closure_8 = fn(require("stringProcessor"));
    let closure_9 = fn(require("module_12122"));
    let closure_10 = fn(require("module_12123"));
    let closure_11 = fn(require("module_12124"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      let obj = {};
      obj = { input: _require(12117).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12117).createStandardJSONSchemaMethod(_standard, "output") };
      obj.jsonSchema = obj;
      const merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12117).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
