...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 13320, 8770, 4080]

// Module 13319 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      const items6 = [ParallaxImage(13320).image, style, { position: "relative" }, obj];
      obj3.style = items6;
  ...
  },
  {
    ...
    get() {
      ...
      if (!tmp) {
        ...
        obj[0] = ParallaxImage(13320).loaderContainer;
  ...
  },
  {
    ...
    value: function render() {
      ...
      const items = [this.props.containerStyle, self(13320).container];
      obj[2] = items;
