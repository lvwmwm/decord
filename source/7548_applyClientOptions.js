...
// Dependencies: [7510, 7513, 7526, 7549, 7550, 7536, 7508, 7551, 7544, 7520]

// Module 7548 (applyClientOptions)
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = require(7508) /* isMatchingPattern */.truncate(environment.message, num);
    const obj = require(7508) /* isMatchingPattern */;
  }
  let value = iter;
  ...
  if (value) {
    iter.value = require(7508) /* isMatchingPattern */.truncate(iter.value, num);
    const obj2 = require(7508) /* isMatchingPattern */;
  }
  ...
  if (url) {
    request.url = require(7508) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(7508) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(7551).getFilenameToDebugIdMap(arg1);
  try {
