...
// Dependencies: [32, 19, 17, 21, 1481, 4611, 9294, 4602, 1584, 5645, 9295, 9298, 9299]
// Exports: default

// Module 9293 (NativeStackViewInner)
...
function MaybeNestedStack(children) {
  ...
  return closure_7(importDefault(9294), obj);
}
function SceneView(arg0) {
  ...
  let obj3 = React;
  const context = React.useContext(tmp(5645).HeaderShownContext);
  let num2 = React.useContext(tmp(5645).HeaderHeightContext);
  let num3 = 0;
  const context1 = React.useContext(tmp(5645).HeaderBackContext);
  if (!context) {
  ...
  let defaultHeaderHeight = _require(5645).getDefaultHeaderHeight(safeAreaFrame, tmp12, num3);
  ...
  if (previousDescriptor) {
    obj = { title: null };
    obj[0] = tmp(5645).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    tmp18 = obj;
    const tmpResult3 = tmp(5645);
  }
  ...
  obj9[1] = closure_7(_require(4602).EdgeInsetApplicationContext.Provider, obj10);
  obj8[5] = closure_7(_require(5645).HeaderBackContext.Provider, obj9);
  ...
  const obj13 = {};
  tmp30 = closure_12;
  const tmpResult2 = _require(5645);
  ...
  items1[2] = closure_7(importDefault(9295), obj13);
  obj4[1] = items1;
  obj3[1] = closure_8(_require(5645).HeaderHeightContext.Provider, obj4);
  obj2[1] = closure_7(_require(5645).HeaderShownContext.Provider, obj3);
  ...
  return closure_7(_require(4602).Screen, obj, route.key);
}
...
export default function NativeStackView(arg0) {
  ...
  return callback2(require(5645) /* Background */.SafeAreaProviderCompat, obj);
};
