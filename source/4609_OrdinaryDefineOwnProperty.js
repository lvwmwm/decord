...
// Dependencies: [4546, 541, 4593, 4597, 542, 4610, 562, 4602, 4598, 4611, 4612]

// Module 4609 (OrdinaryDefineOwnProperty)

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (require(4546) /* isObject */(arg0)) {
    if (tmp(4593)(arg1)) {
      if (tmp(4597)(__Writable__)) {
        if (tmp(542)) {
          const tmp30 = tmp(542)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4598)(tmp30);
          }
          return tmp(4612)(arg0, arg1, tmp(4611)(arg0), __Writable__, tmp31);
        } else if (tmp(4610)(__Writable__)) {
          ...
          return tmp(4602)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
