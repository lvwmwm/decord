...
// Function ID: 5415
// Name: useScrollable
// Dependencies: [19, 1634, 5399, 5415]
// Exports: useScrollable

// Module 5414 (useScrollable)
...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(require(5399) /* GESTURE_SOURCE */.SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = require(1634) /* cancelAnimation */.useSharedValue(0);
  const obj2 = require(1634) /* cancelAnimation */;
  const sharedValue2 = require(1634) /* cancelAnimation */.useSharedValue(require(5399) /* GESTURE_SOURCE */.SCROLLABLE_STATE.UNDETERMINED);
