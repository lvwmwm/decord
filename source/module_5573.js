// Module ID: 5573
// Function ID: 5574
// Dependencies: [19, 21, 4545, 1481, 5574]
...
export default Link.createNavigatorFactory(function StackNavigator(arg0) {
  ...
  navigation(4545)(null != mode, "Stack Navigator: 'mode=\"" + mode + "\"' is deprecated. Use 'presentation: \"" + mode + "\"' in 'screenOptions' instead.\n\nSee https://reactnavigation.org/docs/stack-navigator#presentation for more details.");
  const headerMode = merged.headerMode;
  navigation(4545)("none" === headerMode, "Stack Navigator: 'headerMode=\"none\"' is deprecated. Use 'headerShown: false' in 'screenOptions' instead.\n\nSee https://reactnavigation.org/docs/stack-navigator/#headershown for more details.");
  let tmp9 = null != headerMode;
  const tmp4 = navigation(4545);
  const tmp5 = null != mode;
  if (tmp9) {
    tmp9 = "none" !== headerMode;
  }
  navigation(4545)(tmp9, "Stack Navigator: 'headerMode' is moved to 'options'. Moved it to 'screenOptions' to keep current behavior.\n\nSee https://reactnavigation.org/docs/stack-navigator/#headermode for more details.");
  const keyboardHandlingEnabled = merged.keyboardHandlingEnabled;
  navigation(4545)(undefined !== keyboardHandlingEnabled, "Stack Navigator: 'keyboardHandlingEnabled' is moved to 'options'. Moved it to 'screenOptions' to keep current behavior.\n\nSee https://reactnavigation.org/docs/stack-navigator/#keyboardhandlingenabled for more details.");
