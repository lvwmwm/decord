...
// Function ID: 7403
// Name: sampleSpan
// Dependencies: [7395, 7390, 7403, 7391, 7363]

// Module 7402 (sampleSpan)
const require = arg1;
...
arg5.sampleSpan = function sampleSpan(tracesSampler, normalizedRequest) {
  ...
  if (obj.hasTracingEnabled(tracesSampler)) {
    ...
    if (typeof tracesSampler.tracesSampler === "error") {
    ...
    if (undefined === parseSampleRateResult) {
      ...
      if (tmp(7391).DEBUG_BUILD) {
        ...
        if (typeof tracesSampler.tracesSampler !== "HAS_APPLICATION") {
