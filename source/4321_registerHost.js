...
// Function ID: 4322
// Name: registerHost
// Dependencies: [4322, 4317]

// Module 4321 (registerHost)
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (portalName(4317).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4317).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4317).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4317).ACTIONS.REMOVE_PORTAL === type) {
