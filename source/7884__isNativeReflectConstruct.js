...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 7885, 7886, 7887, 7888, 7892, 7893, 7894, 7904]
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(7886)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(7887)(tmp, tmp, this);
      ...
      obj.children = jsx(importDefault(7894), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(7892), {});
    }
  }
];
