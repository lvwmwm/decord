...
// Dependencies: [7820, 7821, 7822, 7745, 7783, 7747, 7737, 7738, 7744]

// Module 7819 (extractRequestData)
const require = arg1;
  ...
  if (!obj.customRoute) {
    if (!method.route) {
      ...
      if (tmp) {
        ...
        str5 = require(7820) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
        str4 = "url";
        const obj2 = require(7820) /* getNumberOfUrlSegments */;
      }
...
arg5.httpRequestToRequestData = function httpRequestToRequestData(headers) {
  ...
  return require(7744) /* addNonEnumerableProperty */.dropUndefinedKeys(obj);
};
