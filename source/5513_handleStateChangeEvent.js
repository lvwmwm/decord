...
// Dependencies: [5495, 5433, 5448, 5435, 5497]

// Module 5513 (handleStateChangeEvent)
const require = arg1;
...
function handleUpdateEvent(lastUpdateEvent, arg1, arg2, lastUpdateEvent2) {
  ...
  const result = require(5495) /* isGestureEnabled */.flattenAndFilterEvent(tmp);
  const obj = require(5495) /* isGestureEnabled */;
  require(5495) /* isGestureEnabled */.runCallback(require(5448) /* _isNativeReflectConstruct */.CALLBACK_TYPE.UPDATE, arg1, result);
  if (lastUpdateEvent2) {
...
function handleTouchEvent(eventType) {
  if (eventType.eventType !== require(5435).TouchEventType.UNDETERMINED) {
    let tmpResult = tmp(5495);
    tmpResult = tmp(5495);
...
function eventHandler(arg0, nativeEvent, arg2, arg3, lastUpdateEvent) {
  const result = require(5495) /* isGestureEnabled */.maybeExtractNativeEvent(nativeEvent);
  const obj = require(5495) /* isGestureEnabled */;
