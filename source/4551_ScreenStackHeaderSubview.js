...
// Dependencies: [109, 19, 17, 21, 4552, 4548, 4553, 4554, 4549, 4555]
...
// Module 4551 (ScreenStackHeaderSubview)
...
const forwardRefResult = require("noop").forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4548).isHeaderBarButtonsAvailableForCurrentPlatform) {
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4548).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4549).experiment.synchronousHeaderConfigUpdatesEnabled;
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  obj[2] = importDefault(4549).experiment.synchronousHeaderSubviewUpdatesEnabled;
  obj = { resizeMode: "center", fadeDuration: 0 };
  const merged = Object.assign(arg0);
  obj[3] = <closure_7 resizeMode="center" fadeDuration={0} />;
  return jsx(importDefault(4555), { resizeMode: "center", fadeDuration: 0 });
};
export const ScreenStackHeaderRightView = (style) => {
  ...
  obj.type = "right";
  obj.synchronousShadowStateUpdatesEnabled = importDefault(4549).experiment.synchronousHeaderSubviewUpdatesEnabled;
  const items = [closure_9.headerSubview, style.style];
  obj.style = items;
  return jsx(importDefault(4555), {});
};
