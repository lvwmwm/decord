...
// Function ID: 5020
// Name: constructTag
// Dependencies: [4975, 4991, 5003, 4972, 4979, 5005]

// Module 5019 (constructTag)
const require = arg1;
const module = arg2;
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  const stringValueFromArray = require(4972) /* getDataView */.getStringValueFromArray(items1);
  let combined = stringValueFromArray;
  if (type !== require(4979).TYPE_TEXT) {
  ...
  if (type === require(4979).TYPE_ITXT) {
