...
// Function ID: 4083
// Name: useRiveColor
// Dependencies: [32, 19, 4064, 4077, 4072]
// Exports: useRiveColor

// Module 4082 (useRiveColor)
import _slicedToArray from "_slicedToArray";

let require = arg1;
require("noop").useCallback;
const f28990 = (colorProperty) => colorProperty.colorProperty(arg1);
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(require(4077) /* useRiveProperty */.useRiveProperty(instance, FillColor, f28990), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
    if (undefined !== tmp5) {
      let RiveColor = require(4072) /* RiveColor */.RiveColor;
