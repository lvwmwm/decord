...
// Function ID: 8432
// Name: extractFont
// Dependencies: [19, 21, 8425, 8430]
// Exports: default, setTSpan

// Module 8431 (extractFont)
import "noop";
...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(8425) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "string") {
    ...
    obj[7] = importDefault(8430)(tmp);
    obj[8] = importDefault(8430)(tmp2);
    obj[9] = importDefault(8430)(tmp3);
    obj[10] = importDefault(8430)(tmp4);
    obj[11] = importDefault(8430)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
