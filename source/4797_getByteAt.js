...
function getLongAt(dataView, sum2, byteOrder) {
  return dataView.getUint32(sum2, byteOrder === module(4785).LITTLE_ENDIAN);
}
function getSlongAt(getInt32, arg1, arg2) {
  return getInt32.getInt32(arg1, arg2 === module(4785).LITTLE_ENDIAN);
}
...
arg5.default = {
  ...
  getShortAt(dataView, sum, byteOrder) {
    return dataView.getUint16(sum, byteOrder === module(4785).LITTLE_ENDIAN);
  },
  getLongAt,
