...
// Dependencies: [5, 27, 91, 13390, 13392, 13394, 13395, 13398, 13399, 13412, 13414, 13416, 13417, 13418, 13419, 13400]

// Module 13389 (getPluginOptions)
...
obj6.host = (function getHost(localhost) {
  ...
  if ("string" !== typeof scriptURL) {
    ...
    return require(13419) /* getHostFromUrl */.getHostFromUrl(scriptURL);
  }
