...
// Dependencies: [5554, 5511, 19, 17, 5555, 5556, 5526, 5557, 5551]
// Exports: useRecyclerViewController

// Module 5553 (useRecyclerViewController)
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  const unmountFlag = _require(5555).useUnmountFlag();
  ...
  _setTimeout = _require(5556).useUnmountAwareTimeout().setTimeout;
