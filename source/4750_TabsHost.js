...
// Function ID: 4751
// Name: TabsHost
// Dependencies: [32, 109, 19, 17, 21, 4751, 4726, 4752, 4753, 4755]
// Exports: default

// Module 4750 (TabsHost)
...
export default function TabsHost(onNativeFocusChange) {
  ...
  let obj = onNativeFocusChange(4751);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4726).experiment.controlledBottomTabs;
  }
