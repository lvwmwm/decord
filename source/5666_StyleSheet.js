...
// Function ID: 5667
// Name: StyleSheet
// Dependencies: [109, 19, 17, 21, 1584, 5667, 5664, 5669, 5670]
// Exports: default

// Module 5666 (StyleSheet)
...
export default function Header(children) {
  ...
  const context = React.useContext(importDefault(5667));
  if (undefined === layout) {
  ...
  if (headerBackground) {
    ...
    if (!headerTransparent) {
      ...
      obj4[0] = items;
      headerBackgroundResult = tmp15(importDefault(5670), obj4);
    }
  }
  ...
  tmp8 = importDefault(5664)(layout, undefined !== modal && modal, headerStatusBarHeight);
