...
// Dependencies: [5699, 5700, 5704, 5705]

// Module 5698 (RenderTimeTracker)
...
const items = [
  {
    ...
    value: function startTracking() {
      ...
      let trackAverageRenderTimeForOffsetProjection = RenderTimeTracker(5705).PlatformConfig.trackAverageRenderTimeForOffsetProjection;
  ...
  },
  {
    ...
    value: function getAverageRenderTime() {
      const self = this;
      if (RenderTimeTracker(5705).PlatformConfig.trackAverageRenderTimeForOffsetProjection) {
        const _Math = Math;
        const _Math2 = Math;
        const _Math3 = Math;
