...
// Dependencies: [7450, 7453, 7455, 7481, 7459, 7482, 7454, 7551, 7468, 7488, 7489]

// Module 7550 (addToMetricsAggregator)
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (client) {
    const activeSpan = require(7459) /* spanTimeInputToSeconds */.getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    const globalSingleton = require(7455) /* getGlobalSingleton */.getGlobalSingleton("globalMetricsAggregators", () => {
    ...
    const tmp3Result1 = require(7455) /* getGlobalSingleton */;
  }
}
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7551).COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7551).DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, require(7551).SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7551).GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    ...
    if (typeof fn === "function") {
      ...
      return _require(7488).startSpanManual(obj, (arg0) => {
        const callback = arg0;
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _require(7551).DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
  ...
  getMetricsAggregatorForClient(on) {
    ...
    const obj = require(7455) /* getGlobalSingleton */;
  }
};
