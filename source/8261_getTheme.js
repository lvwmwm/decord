...
// Function ID: 8262
// Name: getTheme
// Dependencies: [19, 17, 21, 8262, 8266]
...
export default require("noop").memo((theme) => {
  ...
  if (typeof getTextColor !== "fileFinishedImporting") {
    HermesBuiltin.throwTypeError();
  }
  if (typeof getTheme !== "fileFinishedImporting") {
    HermesBuiltin.throwTypeError();
  }
  if (theme.theme) {
    let str = theme.theme;
  ...
  obj.textColor = require(8266) /* colorToHex */.colorToHex(str3);
  let tmp4Result = tmp4(8266);
  if (typeof getDividerColor !== "fileFinishedImporting") {
    HermesBuiltin.throwTypeError();
  }
  ...
  tmp4Result = tmp4(8266);
  if (typeof getButtonColor !== "fileFinishedImporting") {
    HermesBuiltin.throwTypeError();
  }
  ...
  obj.theme = str12;
  if (typeof getTitle !== "fileFinishedImporting") {
    HermesBuiltin.throwTypeError();
  }
