...
// Function ID: 6411
// Name: setMeasurement
// Dependencies: [6373, 6396, 6368, 6383]

// Module 6410 (setMeasurement)
const require = arg1;
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (activeSpan) {
    rootSpan = require(6373) /* spanTimeInputToSeconds */.getRootSpan(activeSpan);
    const obj3 = require(6373) /* spanTimeInputToSeconds */;
  }
  if (rootSpan) {
    if (require(6396) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      const logger = tmp9(6368).logger;
      const _HermesInternal = HermesInternal;
      logger.log("[Measurement] Setting measurement on root span: " + arg0 + " = " + arg1 + " " + arg2);
    }
    obj = {};
    obj[require(6383).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[require(6383).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
