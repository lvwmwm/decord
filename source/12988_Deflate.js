...
// Function ID: 12989
// Name: Deflate
// Dependencies: [12987, 12989, 12990, 12991, 12995]

// Module 12988 (Deflate)
const require = arg1;
    ...
    if (this instanceof Deflate) {
      ...
      if (options.raw) {
        ...
        if (0 !== deflateInit2Result) {
          ...
          tmp23 = new.target;
          tmp24 = new.target;
          error = new Error(require("module_12991")[deflateInit2Result]);
          tmp26 = error;
          throw error;
        } else {
          if (options.header) {
          ...
          if (options.dictionary) {
            ...
            if (0 !== deflateSetDictionaryResult) {
              ...
              tmp18 = new.target;
              tmp19 = new.target;
              error1 = new Error(require("module_12991")[deflateSetDictionaryResult]);
              tmp21 = error1;
              throw error1;
            } else {
              flag2 = true;
