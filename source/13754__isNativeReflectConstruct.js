...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 13755, 13758, 4652]
// Exports: default

// Module 13754 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4652).ScreenContext.Provider, { value: closure_8, children: children.children });
};
