...
// Dependencies: [1693, 1686, 1638, 1675, 1659, 1690, 1704, 1720, 1644, 1721, 1722, 1727]

// Module 1703 (setElementAnimation)
const require = arg1;
...
function setElementAnimation(dummy, dummyAnimationConfig, arg2) {
  ...
  if (dummyAnimationConfig.animationType === _require(1659).LayoutAnimationType.ENTERING) {
  ...
  if (!(animationName in _require(1690).Animations)) {
...
arg5.getReducedMotionFromConfig = function getReducedMotionFromConfig(entering) {
  if (entering.reduceMotionV) {
    ...
    if (require(1659) /* isWorkletFunction */.ReduceMotion.Never === reduceMotionV) {
      return false;
    ...
    return require(1675) /* isReducedMotionEnabledInSystem */.ReducedMotionManager.jsValue;
  }
};
arg5.getProcessedConfig = function getProcessedConfig(animationWithInitialValues, animationType, entering) {
  ...
  let num = 0.3;
  if (animationWithInitialValues in require(1690) /* TransitionType */.Animations) {
...
arg5.maybeModifyStyleForKeyframe = function maybeModifyStyleForKeyframe(style, entering) {
  if (entering instanceof require(1704) /* BaseAnimationBuilder */.Keyframe) {
...
arg5.saveSnapshot = function saveSnapshot(_componentDOMRef) {
  ...
  obj[4] = obj;
  const snapshots = require(1720) /* weakMap */.snapshots;
...
arg5.handleLayoutTransition = function handleLayoutTransition(_componentDOMRef, processedConfig, easingY) {
  ...
  if ("LinearTransition" === animationName) {
    let ENTRY_EXIT = require(1690) /* TransitionType */.TransitionType.LINEAR;
    let tmp4 = require;
  } else if ("SequencedTransition" === animationName) {
    ENTRY_EXIT = require(1690) /* TransitionType */.TransitionType.SEQUENCED;
    tmp4 = require;
  } else if ("FadingTransition" === animationName) {
    ENTRY_EXIT = require(1690) /* TransitionType */.TransitionType.FADING;
    tmp4 = require;
  } else if ("JumpingTransition" === animationName) {
    ENTRY_EXIT = require(1690) /* TransitionType */.TransitionType.JUMPING;
    tmp4 = require;
  } else if ("CurvedTransition" === animationName) {
    ENTRY_EXIT = require(1690) /* TransitionType */.TransitionType.CURVED;
    tmp4 = require;
  } else if ("EntryExitTransition" === animationName) {
    ENTRY_EXIT = require(1690) /* TransitionType */.TransitionType.ENTRY_EXIT;
    tmp4 = require;
  }
...
arg5.handleExitingAnimation = function handleExitingAnimation(offsetParent, processedConfig) {
  ...
  _require(1720).setElementPosition(cloneNodeResult, rect);
