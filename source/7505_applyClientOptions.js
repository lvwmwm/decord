...
// Dependencies: [7467, 7470, 7483, 7506, 7507, 7493, 7465, 7508, 7501, 7477]

// Module 7505 (applyClientOptions)
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = require(7465) /* isMatchingPattern */.truncate(environment.message, num);
    const obj = require(7465) /* isMatchingPattern */;
  }
  let value = iter;
  ...
  if (value) {
    iter.value = require(7465) /* isMatchingPattern */.truncate(iter.value, num);
  ...
  if (url) {
    request.url = require(7465) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(7465) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(7508).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = dependencyMap(7501).normalize(data.data, dependencyMap, dependencyMap);
                  data = obj;
                  const obj3 = dependencyMap(7501);
                }
