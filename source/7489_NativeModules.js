...
// Function ID: 7490
// Name: NativeModules
// Dependencies: [5, 17, 7490, 7491, 7496, 7497, 7498, 7499, 7500]
...
export const setup = () => {
  ...
  if ("STOREKIT1_MODE" === str) {
    require(7491).storekit1Mode();
    const obj4 = require(7491);
  } else if ("STOREKIT2_MODE" === str) {
    require(7491).storekit2Mode();
    const obj3 = require(7491);
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    require(7491).storekitHybridMode();
    const obj2 = require(7491);
  }
};
export const initConnection = () => {
  const nativeModule = require(7491).getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = require(7491).getAndroidModule();
