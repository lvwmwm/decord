...
// Function ID: 5353
// Name: hasOwnProperty
// Dependencies: [5350, 5353]

// Module 5352 (hasOwnProperty)
...
obj.to.hex = () => {
  const tmp = require(5353) /* swizzle */(arguments);
...
obj.to.rgb = () => {
  const arr = require(5353) /* swizzle */(arguments);
  if (arr.length >= 4) {
    if (1 !== arr[3]) {
      const _Math = Math;
      const _Math2 = Math;
