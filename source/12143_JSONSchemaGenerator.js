...
// Dependencies: [109, 41, 42, 12141, 12142]

// Module 12143 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(12141).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(12141).extractDefs(self.ctx, _idmap);
      return _objectWithoutProperties(JSONSchemaGenerator(12141).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
