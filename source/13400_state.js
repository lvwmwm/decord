...
// Function ID: 102413
// Name: state
// Dependencies: [13364, 13339, 13401, 13355, 13402, 13384, 13362, 13395]
...
if (!require("all")) {
  if (!require("__core-js_shared__").state) {
    ...
    let closure_6 = tmp;
    require("module_13384")[tmp] = true;
    function set(facade) {
      if (require(13362) /* call */(facade, closure_6)) {
        let _TypeError = require(13339) /* check */.TypeError;
        const prototype = _TypeError.prototype;
        _TypeError = new _TypeError("Object already initialized");
        throw _TypeError;
      } else {
        arg1.facade = facade;
        require(13395)(facade, closure_6, arg1);
        return arg1;
      }
    }
    let set2 = set;
    function get(arg0) {
      if (require(13362) /* call */(arg0, closure_6)) {
    ...
    let get2 = get;
    function has(arg0) {
      return require(13362) /* call */(arg0, closure_6);
    }
    let has2 = has;
  }
  let obj = {
