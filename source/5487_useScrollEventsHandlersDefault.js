...
// Dependencies: [5468, 1653, 5461, 5488]

// Module 5487 (useScrollEventsHandlersDefault)
const require = arg1;
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj = { animatedSheetState, SHEET_STATE: _require(5461).SHEET_STATE, animatedHandleGestureState, State: _require(5488).State, animatedScrollableState, SCROLLABLE_STATE: _require(5461).SCROLLABLE_STATE, scrollTo: _require(1653).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue };
  E.__closure = obj;
  ...
  obj1 = { scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, rootScrollableContentOffsetY: animatedScrollableContentOffsetY, animatedSheetState, SHEET_STATE: _require(5461).SHEET_STATE };
  O.__closure = obj1;
  ...
  obj2 = { animatedScrollableState, SCROLLABLE_STATE: _require(5461).SCROLLABLE_STATE, scrollTo: _require(1653).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5461).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
  fn2.__closure = obj2;
  ...
  C.__closure = { animatedScrollableState, SCROLLABLE_STATE: _require(5461).SCROLLABLE_STATE, scrollTo: _require(1653).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5461).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
