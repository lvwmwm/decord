...
// Function ID: 1804
// Name: getLatestState
// Dependencies: [32, 19, 1798, 1596]
// Exports: useKeyboardState

// Module 1803 (getLatestState)
...
export const useKeyboardState = function useKeyboardState(arg0) {
  ...
  const tmp2 = callback(callback3(() => {
    ...
    const obj = {};
    const KeyboardController = tmp(1798).KeyboardController;
    const merged = Object.assign(KeyboardController.state());
    const KeyboardController2 = tmp(1798).KeyboardController;
  ...
  callback2(() => {
    ...
    let obj = {};
    let KeyboardController = tmp(1798).KeyboardController;
    let merged = Object.assign(KeyboardController.state());
    let KeyboardController2 = tmp(1798).KeyboardController;
    obj.isVisible = KeyboardController2.isVisible();
    tmp(tmp(obj));
    return () => {
