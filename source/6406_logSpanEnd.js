...
// Function ID: 6407
// Name: logSpanEnd
// Dependencies: [6396, 6373, 6368]

// Module 6406 (logSpanEnd)
const require = arg1;
...
arg5.logSpanStart = function logSpanStart(spanContext) {
  ...
  if (require(6396) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
    ...
    const rootSpan = tmp(6373).getRootSpan(spanContext);
    let str3 = "unsampled";
    ...
    if (rootSpan !== spanContext) {
      ...
      ({ op: op2, description: description2 } = tmp(6373).spanToJSON(rootSpan));
      ...
      const spanToJSONResult1 = tmp(6373).spanToJSON(rootSpan);
    }
    const logger = tmp(6368).logger;
