...
// Dependencies: [7455, 7461]

// Module 7462 (_htmlElementAsString)
const require = arg1;
...
arg5.getComponentName = function getComponentName(arg0) {
  let parentNode = arg0;
  let num = 0;
  if (require(7455) /* getGlobalSingleton */.GLOBAL_OBJ.HTMLElement) {
    while (parentNode) {
...
arg5.getDomElement = function getDomElement(arg0) {
  let element = null;
  if (require(7455) /* getGlobalSingleton */.GLOBAL_OBJ.document) {
    element = null;
...
arg5.getLocationHref = function getLocationHref() {
  try {
    return require(7455) /* getGlobalSingleton */.GLOBAL_OBJ.document.location.href;
  } catch (err) {
    return "";
  }
};
