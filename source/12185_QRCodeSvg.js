...
// Function ID: 95338
// Name: QRCodeSvg
// Dependencies: [12182, 31, 8018]

// Module 12185 (QRCodeSvg)
...
const forwardRefResult = result.forwardRef((obj, ref) => {
  ...
  const element = mod.default.createElement(require(8018) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return mod.default.createElement(require(8018) /* inlineStyles */.Svg, callback({}, obj, obj), element, mod.default.createElement(require(8018) /* inlineStyles */.Path, { d, fill }));
});
