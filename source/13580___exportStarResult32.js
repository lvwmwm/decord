...
// Dependencies: [13581, 13582, 13584]
...
arg5.TimeClip = function TimeClip(isFinite) {
  if (isFinite.isFinite()) {
    if (absResult.greaterThan(8640000000000001)) {
      const decimal = new require(13581) /* digitsToString */.Decimal(NaN);
      return decimal;
    } else {
      ...
      ZERO = require(13584) /* TEN */.ZERO;
    }
    absResult = isFinite.abs();
  } else {
    const decimal1 = new require(13581) /* digitsToString */.Decimal(NaN);
    return decimal1;
  }
};
