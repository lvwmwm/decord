...
// Dependencies: [65, 57, 6348, 6392, 6353, 6394]
...
// Module 6391 (forEachEnvelopeItem)
...
function encodeUTF8(arg0) {
  if (require(6348) /* getGlobalSingleton */.GLOBAL_OBJ.__SENTRY__) {
    if (require(6348) /* getGlobalSingleton */.GLOBAL_OBJ.__SENTRY__.encodePolyfill) {
      const __SENTRY__ = require(6348) /* getGlobalSingleton */.GLOBAL_OBJ.__SENTRY__;
...
export const createEventEnvelopeHeaders = function createEventEnvelopeHeaders(event_id, sdk) {
  ...
  if (tmp4) {
    obj = { dsn: require(6394) /* dsnFromString */.dsnToString(arg3) };
    tmp4 = obj;
    const obj5 = require(6394) /* dsnFromString */;
  }
  let tmp7 = tmp;
  if (event_id.sdkProcessingMetadata && event_id.sdkProcessingMetadata.dynamicSamplingContext) {
    const obj1 = {};
    const _Object = Object;
    obj1.trace = require(6353) /* addNonEnumerableProperty */.dropUndefinedKeys(Object.assign({}, tmp));
    tmp7 = obj1;
    const obj7 = require(6353) /* addNonEnumerableProperty */;
  }
