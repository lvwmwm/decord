...
// Dependencies: [32, 12428, 12429, 12427, 12421]

// Module 12433 (convertBaseSchema)
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema(flag, defaultTarget) {
      if (typeof flag === "boolean") {
        ...
        if (registry == null) {
          registry = require(12421) /* $output */.globalRegistry;
        }
        obj[5] = registry;
    ...
    let obj = {};
    let merged = Object.assign(fn(require("module_12427")));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(require("module_12429"));
    let _Set = Set;
