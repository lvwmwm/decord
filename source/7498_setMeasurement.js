...
// Function ID: 7499
// Name: setMeasurement
// Dependencies: [7461, 7484, 7456, 7471]

// Module 7498 (setMeasurement)
const require = arg1;
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (activeSpan) {
    rootSpan = require(7461) /* spanTimeInputToSeconds */.getRootSpan(activeSpan);
  ...
  if (rootSpan) {
    ...
    obj = {};
    obj[require(7471).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[require(7471).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
