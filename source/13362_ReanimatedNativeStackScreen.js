...
// Module 13362 (ReanimatedNativeStackScreen)
let closure_3 = [null];
...
const forwardRefResult = importDefaultResult.forwardRef((children, ref) => {
  ...
  obj.onTransitionProgressReanimated = ref(dependencyMap[4]).useEvent(pnpm_ReanimatedNativeStackScreenTsx1, [1070106201]);
