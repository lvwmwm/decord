...
// Dependencies: [31, 44, 5227]
// Exports: usePropsValidator

// Module 5340 (usePropsValidator)
  ...
  topInset(() => {
    if (snapPoints) {
      ...
      const mapped = items.map((str) => {
        ...
        snapPoints(enableDynamicSizing[1])(tmp4, "Snap point '" + str + "' is invalid. if you want to allow user to close the sheet, Please use 'enablePanDownToClose' prop.");
      });
