...
// Dependencies: [109, 19, 17, 21, 4664, 4660, 4665, 4666, 4661, 4667]
...
// Module 4663 (ScreenStackHeaderSubview)
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  obj[2] = importDefault(4661).experiment.synchronousHeaderSubviewUpdatesEnabled;
  obj = { resizeMode: "center", fadeDuration: 0 };
  const merged = Object.assign(arg0);
  obj[3] = <closure_7 resizeMode="center" fadeDuration={0} />;
  return jsx(importDefault(4667), { resizeMode: "center", fadeDuration: 0 });
};
export const ScreenStackHeaderRightView = (style) => {
  ...
  obj.type = "right";
  obj.synchronousShadowStateUpdatesEnabled = importDefault(4661).experiment.synchronousHeaderSubviewUpdatesEnabled;
  const items = [closure_9.headerSubview, style.style];
  obj.style = items;
  return jsx(importDefault(4667), {});
};
