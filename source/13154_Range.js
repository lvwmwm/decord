...
// Function ID: 13155
// Name: Range
// Dependencies: [41, 42, 13126, 13153, 13127, 13129, 13128, 13125, 13155]
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13126")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13127).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13127).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13128)("hyphen replace", str);
        let str3 = str.replace(tmp11(13129).safeRe[tmp11(undefined, 13129).t.COMPARATORTRIM], tmp11(13129).comparatorTrimReplace);
        tmp11(13128)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13129).safeRe[tmp11(undefined, 13129).t.TILDETRIM], tmp11(13129).tildeTrimReplace);
        tmp11(13128)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13129).safeRe[tmp11(undefined, 13129).t.CARETTRIM], tmp11(13129).caretTrimReplace);
        tmp11(13128)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13125)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13128)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13153).ANY) {
