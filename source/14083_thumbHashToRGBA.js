...
// Module 14083 (thumbHashToRGBA)
import _slicedToArray from "_slicedToArray";

function thumbHashToRGBA(arg0) {
  let _slicedToArray = arg0;
  let result = (63 & tmp) / 63;
  const tmp6 = (arg0[0] | arg0[1] << 8 | arg0[2] << 16) >> 23;
    ...
    for (let num = 0; num < maxResult1; num = num + 1) {
      ...
      if (num2 * maxResult1 < maxResult * (maxResult1 - num)) {
        do {
          ...
          let tmp5 = +c2;
          c2 = tmp5 + 1;
          let arr = items.push(((table[num5 + (c2 >> 1)] >> ((1 & tmp5) << 2) & 15) / 7.5 - 1) * arg2);
          num2 = num2 + 1;
            ...
            do {
              ...
              if (num21 * maxResult1 < maxResult * (maxResult1 - num17)) {
                do {
                  ...
                  tmp43 = sum2;
                  tmp44 = sum1;
                  result2 = sum1 * maxResult1;
                  result3 = maxResult * (maxResult1 - num17);
...
export const rgbaToThumbHash = function rgbaToThumbHash(arg0, arg1, arg2) {
  ...
  if (arg0 <= 100) {
    if (arg1 <= 100) {
              ...
              do {
                ...
                if (0 < closure_1) {
                  do {
                    ...
                    let tmp15 = PI;
                    let tmp16 = closure_1;
                    let tmp17 = cos(PI / closure_1 * num3 * (num10 + 0.5));
                    ...
                    if (0 < _slicedToArray) {
                      do {
                        ...
                        sum = sum + items[num13 + num10 * _slicedToArray] * items1[num13] * tmp17;
                        num13 = num13 + 1;
                        tmp20 = sum;
                        num14 = num13;
                      } while (num13 < _slicedToArray);
                    }
                    num10 = num10 + 1;
                    let tmp22 = closure_1;
                    num9 = tmp20;
                ...
                let tmp23 = _slicedToArray;
                let tmp24 = closure_1;
                let result = num11 / (_slicedToArray * closure_1);
                let tmp26 = tmp5;
                let tmp27 = tmp6;
                if (num6) {
      ...
      let tmp23 = callback(encodeChannel(items, max(3, maxResult), max(3, maxResult1)), 3);
      [tmp29, tmp30, tmp31] = callback(encodeChannel(items1, 3, 3), 3);
      let tmp28 = callback(encodeChannel(items1, 3, 3), 3);
      ...
      let tmp39 = tmp38[1];
      let tmp33 = callback(encodeChannel(items2, 3, 3), 3);
