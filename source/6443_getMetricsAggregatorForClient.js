...
// Dependencies: [6343, 6346, 6348, 6374, 6352, 6375, 6347, 6444, 6361, 6381, 6382]

// Module 6443 (getMetricsAggregatorForClient)
import "errorCallback";
import module_6346 from "module_6346";

function getMetricsAggregatorForClient(on) {
  const globalSingleton = require(6348) /* getGlobalSingleton */.getGlobalSingleton("globalMetricsAggregators", () => {
  ...
  const obj = require(6348) /* getGlobalSingleton */;
}
function addToMetricsAggregator(arg0, COUNTER_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (arguments.length > 4) {
    ...
    if (client) {
      const activeSpan = require(6352) /* spanTimeInputToSeconds */.getActiveSpan();
      let rootSpan;
      if (activeSpan) {
      ...
      if (rootSpan) {
        description = require(6352) /* spanTimeInputToSeconds */.spanToJSON(rootSpan).description;
...
function distribution(arg0, arg1, replaced) {
  addToMetricsAggregator(arg0, require(6444).DISTRIBUTION_METRIC_TYPE, arg1, ensureNumber(replaced), arg3);
}
...
export const metrics = {
  increment(arg0, arg1) {
    ...
    addToMetricsAggregator(arg0, require(6444).COUNTER_METRIC_TYPE, arg1, ensureNumber(num), tmp);
  },
  distribution,
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, require(6444).SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, replaced) {
    addToMetricsAggregator(arg0, require(6444).GAUGE_METRIC_TYPE, arg1, ensureNumber(replaced), arg3);
  },
  timing(arg0, name) {
    const _require = arg0;
    ...
    if ("function" === typeof arg2) {
      let timestampInSecondsResult = _require(6361).timestampInSeconds();
      const distribution = timestampInSecondsResult;
      const obj2 = _require(6361);
      let obj = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return _require(6381).startSpanManual(obj, (arg0) => {
        const callback = arg0;
