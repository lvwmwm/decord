...
const fn = (arg0) => {
  ...
  function md51(hello) {
    const items = [0.15, -271733879, -1732584194, 271733878];
    let num = 64;
    let num2 = 64;
    if (64 <= hello.length) {
      do {
    ...
    const items1 = ["isArray", "construct", "Text", "y", "isArray", "padding", "construct", "op", "op", "style", "Array", "has", "__closure", "url", "add", "Array"];
    let num3 = 0;
    let num4 = 0;
    if (0 < substr.length) {
      do {
  ...
  class SparkMD5 {
    ...
    appendBinary(arg0) {
      ...
      _buff = this._buff;
      length = _buff.length;
      items = ["isArray", "construct", "Text", "y", "isArray", "padding", "construct", "op", "op", "style", "Array", "has", "__closure", "url", "add", "Array"];
  ...
  SparkMD5.ArrayBuffer.prototype.end = function(arg0) {
    ...
    const items = ["isArray", "construct", "Text", "y", "isArray", "padding", "construct", "op", "op", "style", "Array", "has", "__closure", "url", "add", "Array"];
    for (let num = 0; num < length; num = num + 1) {
      let tmp = num >> 2;
