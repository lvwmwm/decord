...
// Function ID: 5540
// Name: getHandler
// Dependencies: [5509, 5496, 5493, 5531, 5494, 5495]

// Module 5539 (getHandler)
const require = arg1;
const dependencyMap = arg6;
function getHandler(arg0, onBegin) {
  if (require(5509) /* _isNativeReflectConstruct */.CALLBACK_TYPE.BEGAN === arg0) {
...
function touchEventTypeToCallbackType(arg0) {
  if (require(5496).TouchEventType.TOUCHES_DOWN === arg0) {
...
function runWorklet(arg0, arg1, arg2) {
  ...
  if (arg1.isWorklet[arg0]) {
    ...
    console.warn(require(5493) /* tagMessage */.tagMessage("Animated gesture callback must be a worklet"));
    const obj = require(5493) /* tagMessage */;
  }
}
