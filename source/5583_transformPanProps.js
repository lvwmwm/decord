  ...
  if (undefined === str) {
    ...
    if (undefined === str12) {
      ...
      if (undefined === str23) {
        ...
        if (undefined === str34) {
          activeOffsetY.changeEventCalculator = require(5556) /* isGestureEnabled */.getChangeEventCalculator(diffCalculator);
          ...
          if (Array.isArray(str34)) {
            ...
            obj4 = require(5556) /* isGestureEnabled */;
          }
        ...
        if (Array.isArray(str23)) {
          ...
          obj3 = require(5556) /* isGestureEnabled */;
        }
      ...
      if (Array.isArray(str12)) {
        ...
        obj2 = require(5556) /* isGestureEnabled */;
      }
    ...
    if (Array.isArray(str)) {
      ...
      obj = require(5556) /* isGestureEnabled */;
    }
...
arg5.usePanGesture = function usePanGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(5556) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformPanProps);
  const obj = require(5556) /* isGestureEnabled */;
  return require(5571) /* useGesture */.useGesture(require(5547) /* ComposedGestureName */.SingleGestureName.Pan, clonedAndRemappedConfig);
};
