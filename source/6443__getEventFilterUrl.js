...
// Dependencies: [6424, 6396, 6368, 6379, 6377]

// Module 6443 (_getEventFilterUrl)
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (require(6396) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + tmp6(6379).getEventDescription(tmp));
      const tmp6Result = tmp6(6379);
    }
    return null;
  }
}
