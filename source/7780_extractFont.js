...
// Function ID: 7781
// Name: extractFont
// Dependencies: [19, 21, 7774, 7779]
// Exports: default, setTSpan

// Module 7780 (extractFont)
import "noop";
...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(7774) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "string") {
    ...
    obj[7] = importDefault(7779)(tmp);
    obj[8] = importDefault(7779)(tmp2);
    obj[9] = importDefault(7779)(tmp3);
    obj[10] = importDefault(7779)(tmp4);
    obj[11] = importDefault(7779)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
