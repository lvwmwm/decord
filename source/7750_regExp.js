...
arg5.generateSentryTraceHeader = function generateSentryTraceHeader() {
  let traceId = arg0;
  if (arg0 === undefined) {
    traceId = require(7748) /* generatePropagationContext */.generateTraceId();
    const obj = require(7748) /* generatePropagationContext */;
  }
  let spanId = arg1;
  if (arg1 === undefined) {
    spanId = require(7748) /* generatePropagationContext */.generateSpanId();
    const obj2 = require(7748) /* generatePropagationContext */;
  }
  let str = "";
  if (undefined !== arg2) {
    let str2 = "-0";
...
arg5.propagationContextFromHeaders = function propagationContextFromHeaders(str) {
  ...
  let result = require(7751) /* baggageHeaderToDynamicSamplingContext */.baggageHeaderToDynamicSamplingContext(arg1);
  if (tmp) {
    if (tmp.traceId) {
  ...
  const obj2 = require(7751) /* baggageHeaderToDynamicSamplingContext */;
  obj[1] = require(7748) /* generatePropagationContext */.generateSpanId();
  return obj;
};
