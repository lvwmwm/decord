...
// Dependencies: [5, 17, 82, 13469, 13471, 13473, 13474, 13477, 13478, 13491, 13493, 13495, 13496, 13497, 13498, 13479]

// Module 13468 (reactNativeCorePlugins)
...
import module_13493 from "module_13493";
...
const obj18 = {
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL === "init") {
        const _Error = Error;
        const error = new Error("Invalid non-string URL");
        throw error;
      } else {
        return require(13498) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
