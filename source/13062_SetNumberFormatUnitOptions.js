...
// Module 13062 (SetNumberFormatUnitOptions)
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  const GetOptionResult1 = result1(arg6[0]).GetOption(obj, "currencyDisplay", "string", [null, null, null, null], "symbol");
  ...
  const GetOptionResult2 = result1(arg6[0]).GetOption(obj, "currencySign", "string", [true, true], "standard");
