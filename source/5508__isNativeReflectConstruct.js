...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5509, 5510]

// Module 5508 (_isNativeReflectConstruct)
...
obj = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5509).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
    ...
    value: function renderLottieView() {
      ...
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(importDefault(5509), { ref: null });
        }
      }
