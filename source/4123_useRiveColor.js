...
// Function ID: 4124
// Name: useRiveColor
// Dependencies: [32, 19, 4105, 4118, 4113]
// Exports: useRiveColor

// Module 4123 (useRiveColor)
import _slicedToArray from "_slicedToArray";

let require = arg1;
require("noop").useCallback;
const f29087 = (colorProperty) => colorProperty.colorProperty(arg1);
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(require(4118) /* useRiveProperty */.useRiveProperty(instance, FillColor, f29087), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
    if (undefined !== tmp5) {
      let RiveColor = require(4113) /* RiveColor */.RiveColor;
