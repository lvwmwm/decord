...
// Dependencies: [19, 1679, 1698, 1661]
...
function adjustRotationToInterfaceOrientation(pitch) {
  ...
  if (interfaceOrientation === require(1679) /* isWorkletFunction */.InterfaceOrientation.ROTATION_90) {
    pitch.pitch = roll;
    pitch.roll = -pitch;
    const _Math2 = Math;
...
export const useAnimatedSensor = function useAnimatedSensor(arg0, adjustToInterfaceOrientation) {
  ...
  obj[0] = _require(1698).initializeSensor(arg0, tmp13);
