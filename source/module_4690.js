// Module ID: 4690
// Function ID: 4691
// Dependencies: [109, 19, 17, 21, 4691, 4682]
...
export default importDefaultResult.forwardRef(function SearchBar(autoCapitalize, ref) {
  ...
  if (ref(4682).isSearchBarAvailableForCurrentPlatform) {
    let obj = {};
    ...
    return jsx(importDefault(4691), { ref: null });
  } else {
