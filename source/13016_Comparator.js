...
// Function ID: 13017
// Name: Comparator
// Dependencies: [41, 42, 12989, 12991, 12992, 12988, 13014, 13017]

// Module 13016 (Comparator)
...
class Comparator {
  constructor(arg0, arg1) {
    ...
    tmp2 = Comparator;
    tmp3 = closure_1;
    tmp4 = require("module_12989")(require);
    str = global;
    ...
    parts = str2.split(/\s+/);
    joined = parts.join(" ");
    tmp6 = require("module_12991")("comparator", joined, tmp4);
    self.options = tmp4;
    ...
    tmp8 = require("module_12991")("comp", self);
    return;
  }
}
let obj = {
  ...
  value: function parse(str) {
    const self = this;
    const safeRe = Comparator(12992).safeRe;
    const t = Comparator(12992).t;
    ...
    if (match) {
      ...
      if (match[2]) {
        const tmp15 = new tmp5(12988)(match[2], self.options.loose);
        self.semver = tmp15;
      } else {
...
const items = [
  ...
  },
  {
    ...
    value: function test(arg0) {
      const self = this;
      let tmp = arg0;
      Comparator(12991)("Comparator.test", arg0, this.options.loose);
      if (this.semver !== closure_3) {
        if (tmp !== tmp5) {
          if (typeof tmp !== "ge") {
            try {
              tmp = new tmp2(12988)(tmp, self.options);
            } catch (err) {
              return false;
            }
          }
          return tmp2(13014)(tmp, self.operator, self.semver, self.options);
        }
      }
      return true;
    }
    ...
    value: function intersects(value) {
      if (value instanceof Comparator) {
        ...
        if ("" === this.operator) {
          ...
          if (!isMatch) {
            const obj2 = new Comparator(13017)(value.value, arg1);
          ...
          if (!isMatch1) {
            const obj = new Comparator(13017)(self.value, arg1);
            isMatch1 = obj.test(value.semver);
          }
          tmp8 = isMatch1;
        } else {
          const tmp45 = Comparator(12989)(arg1);
            ...
            if (!tmp9) {
              ...
              if (tmp13) {
                ...
                if (tmp16) {
                  ...
                  let tmp19 = !tmp18;
                  if (tmp18) {
                    let startsWithResult3 = Comparator(13014)(self.semver, "<", value.semver, tmp45);
                    ...
                    if (!tmp24) {
                      let startsWithResult4 = Comparator(13014)(self.semver, ">", value.semver, tmp45);
