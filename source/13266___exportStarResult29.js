...
// Dependencies: [1257, 13247, 13248, 13250, 13260]
// Exports: ToRawPrecision

// Module 13266 (__exportStarResult29)
...
export const ToRawPrecision = function ToRawPrecision(isZero, arg1, closure_0, result) {
  ...
  let timesResult1;
  if (isZero.isZero()) {
    let repeatResult = require(13248) /* setInternalSlot */.repeat("0", closure_0);
    ...
    ({ n2, e2, r2 } = obj);
    result = require(13260) /* __exportStarResult11 */.ApplyUnsignedRoundingMode(isZero, r1, ZERO, result);
    if (result.eq(r1)) {
      num4 = e1.toNumber();
      ZERO = r1;
      n2 = obj.n1;
  ...
  if (num4 >= closure_0 - 1) {
    let sum = repeatResult + require(13248) /* setInternalSlot */.repeat("0", num4 - closure_0 + 1);
    let num8 = num4 + 1;
  } else if (num4 >= 0) {
    ...
    require(13248) /* setInternalSlot */.invariant(num4 < 0, "e should be less than 0");
    sum = `0.${require(13248) /* setInternalSlot */.repeat("0", -num4 - 1)}${arr}`;
    num8 = 1;
  }
  let substr1 = sum;
  if (sum.includes(".")) {
