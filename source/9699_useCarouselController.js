...
// Module 9699 (useCarouselController)
...
export const useCarouselController = function useCarouselController(size) {
  ...
  const useRef = dataLength;
  const handlerOffset = size.handlerOffset;
  let closure_4 = handlerOffset;
  const withAnimation = size.withAnimation;
  let closure_5 = withAnimation;
  ...
  let closure_6 = duration;
  const autoFillData = size.autoFillData;
  let closure_7 = autoFillData;
  const fixedDirection = size.fixedDirection;
  let closure_8 = fixedDirection;
  ...
  const memo = React.useMemo(() => ({ length: dataLength, disable: !dataLength, originalLength: dataLength }), items);
  let obj1 = arg1(dependencyMap[2]);
  const sharedValue = obj1.useSharedValue(num);
  const tmp3 = useRef(num);
  ...
  obj = { handlerOffset, round: arg1(dependencyMap[3]).round, size, dataInfo: memo, convertToSharedIndex: arg1(dependencyMap[4]).convertToSharedIndex, loop, autoFillData };
  pnpm_useCarouselControllerTsx1.__closure = obj;
  pnpm_useCarouselControllerTsx1.__workletHash = 15925793381075;
  pnpm_useCarouselControllerTsx1.__initData = closure_4;
  ...
  obj = { index: sharedValue, runOnJS: arg1(dependencyMap[2]).runOnJS, setSharedIndex };
  pnpm_useCarouselControllerTsx2.__closure = obj;
  pnpm_useCarouselControllerTsx2.__workletHash = 4173925309211;
  pnpm_useCarouselControllerTsx2.__initData = closure_5;
  const items2 = [useRef(num), tmp3, size, memo, sharedValue, loop, autoFillData, handlerOffset];
  ...
  const items4 = [memo];
  const callback2 = React.useCallback(() => !memo.disable, items4);
  const items5 = [size];
  const callback3 = React.useCallback(() => {
    if (null != arg0.onScrollEnd) {
      arg0.onScrollEnd();
    }
  }, items5);
  const items6 = [size];
  const callback4 = React.useCallback(() => {
    if (null != arg0.onScrollStart) {
      arg0.onScrollStart();
    }
  }, items6);
  ...
  obj1 = { runOnJS: arg1(dependencyMap[2]).runOnJS, onScrollEnd: callback3, duration, Easing: arg1(dependencyMap[5]).Easing, dealWithAnimation: arg1(dependencyMap[6]).dealWithAnimation, withAnimation };
  pnpm_useCarouselControllerTsx3.__closure = obj1;
  pnpm_useCarouselControllerTsx3.__workletHash = 4740828363382;
  pnpm_useCarouselControllerTsx3.__initData = closure_6;
  const items7 = [duration, withAnimation, callback3];
  const callback5 = React.useCallback(pnpm_useCarouselControllerTsx3, items7);
  ...
  pnpm_useCarouselControllerTsx5.__initData = closure_8;
  const items8 = [callback2, loop, sharedValue, memo, callback4, handlerOffset, size, callback5, callback];
  const callback6 = React.useCallback(pnpm_useCarouselControllerTsx5, items8);
  ...
  const callback8 = React.useCallback((onFinished) => {
    let animated;
    let i;
    ...
    if (i !== sharedValue.value) {
      if (callback2()) {
        ...
        const result = onFinished(size[7]).handlerOffsetDirection(handlerOffset, fixedDirection);
  ...
  const imperativeHandle = React.useImperativeHandle(size.ref, () => ({ next: callback6, prev: callback7, getCurrentIndex: callback1, scrollTo: callback9 }), items12);
  obj2 = {
    next: callback6,
    prev: callback7,
    scrollTo: callback9,
