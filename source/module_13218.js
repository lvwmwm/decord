// Module ID: 13218
// Function ID: 13219
// Dependencies: [13212, 13183, 13203]

// Module 13218

export default (arg0, arg1) => {
  let require;
  let obj = new require(13212) /* Range */(arg0, arg1);
  const tmp3 = new require(13183) /* SemVer */("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
        ...
        do {
          ...
          if (require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = require;
              tmp16 = !require(13203) /* SemVer */(tmp14, require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
