...
// Function ID: 4122
// Name: useRiveColor
// Dependencies: [32, 19, 4103, 4116, 4111]
// Exports: useRiveColor

// Module 4121 (useRiveColor)
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(require(4116) /* useRiveProperty */.useRiveProperty(instance, FillColor, f29088), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
    if (undefined !== tmp5) {
      let RiveColor = require(4111) /* RiveColor */.RiveColor;
