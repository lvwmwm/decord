...
// Module 4746 (getStringFromDataView)
const module = arg2;
  ...
  let obj = {
    get() {
      if (!c3) {
        ...
        const obj = { configurable: true, enumerable: true, value: callback.apply(Compression), writable: true };
...
arg5.padStart = function padStart(arg0, arg1, _1) {
