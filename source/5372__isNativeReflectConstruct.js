...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5373, 5357, 5362, 5358, 5374, 5356, 5375, 5376, 5377, 5378, 5379, 5368]
// Exports: default

// Module 5372 (_isNativeReflectConstruct)
...
UIManager.setJSResponder = (D, __getInternalProperties) => {
  importDefault(5362).handleSetJSResponder(D, __getInternalProperties);
  fn(D, __getInternalProperties);
};
UIManager.clearJSResponder = () => {
  const result = importDefault(5362).handleClearJSResponder();
  fn2();
};
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          ...
          const items = [];
          const obj2 = require(5376) /* transformIntoHandlerTags */;
          ...
          if (self.viewNode) {
            self.attachGestureHandler(importDefault(5379)(self.viewNode));
          } else {
            const _Error = Error;
