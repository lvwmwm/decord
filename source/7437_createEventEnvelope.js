...
// Dependencies: [7393, 7394, 7438, 7441, 7430, 7399]
// Exports: createEventEnvelope, createSessionEnvelope, createSpanEnvelope

// Module 7437 (createEventEnvelope)
...
export const createEventEnvelope = function createEventEnvelope(type, arg1, sdk) {
  const sdkMetadataForEnvelopeHeader = require(7438) /* forEachEnvelopeItem */.getSdkMetadataForEnvelopeHeader(sdk);
  let str = "event";
  if (type.type) {
    str = "event";
...
export const createSessionEnvelope = function createSessionEnvelope(toJSON) {
  let obj = require(7438) /* forEachEnvelopeItem */;
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    const obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(7441).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(7441);
  }
