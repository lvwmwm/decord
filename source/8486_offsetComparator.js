...
// Dependencies: [19, 17, 8415, 8487, 8417]
// Exports: default

// Module 8486 (offsetComparator)
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
      ...
      while (true) {
        ...
        if (typeof tmp10 === "number") {
          ...
          if (!isNaN(num9)) {
            ...
            let items1 = [num9, 16777215 & tmp10 | Math.round(255 * importDefault(8415)(stopOpacity)) << 24];
    ...
    if (gradientUnits) {
      num12 = importDefault(8487)[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
    ...
    obj[4] = importDefault(8417)(gradientTransform);
    return obj;
  } else {
    return null;
  }
