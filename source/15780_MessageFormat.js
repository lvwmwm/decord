...
class MessageFormat {
  constructor(arg0, arg1, arg2) {
    ...
    if (__parseResult) {
      ...
      if ("messageFormatPattern" === __parseResult.type) {
        ...
        require = self._compilePattern(__parseResult, require, _mergeFormatsResult, self._findPluralRuleFunction(self._locale));
        dependencyMap = self;
  ...
  _compilePattern(arg0, arg1, arg2, arg3) {
    _default = new require(dependencyMap[2]).default(require, importDefault, importAll);
      ...
      while (true) {
        ...
        if ("string" !== typeof obj) {
          ...
          if (!require) {
            ...
            tmp2 = require;
            tmp3 = dependencyMap;
            hop = require(dependencyMap[3]).hop;
...
_module.defineProperty(MessageFormat, "formats", { enumerable: true, value: { number: { currency: { style: "currency" }, percent: { style: "percent" } }, date: { short: { "Bool(false)": false, "Bool(false)": false, "Bool(false)": false }, medium: { "Bool(false)": true, "Bool(false)": true, "Bool(false)": true }, long: {}, full: {} }, time: { short: { CONVERSATIONS_EXTRACTION_PROCESSING: false, CREATOR_STORE_PAGE_VIEWED: false }, medium: {}, long: {}, full: {} } } });
const _module1 = require(dependencyMap[0]);
let obj = {};
const _module2 = require(dependencyMap[0]);
obj.value = _module2.objCreate(null);
_module1.defineProperty(MessageFormat, "__localeData__", obj);
...
_module3.defineProperty(MessageFormat, "__addLocaleData", obj);
const _module4 = require(dependencyMap[0]);
_module4.defineProperty(MessageFormat, "__parse", { value: require(dependencyMap[1]).default.parse });
const _module5 = require(dependencyMap[0]);
const obj2 = { SUSPENDED: null, HIDDEN: null, value: undefined };
_module5.defineProperty(MessageFormat, "defaultLocale", obj2);
