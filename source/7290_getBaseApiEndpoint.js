...
// Module 7290 (getBaseApiEndpoint)
const require = arg1;
...
arg5.getReportDialogEndpoint = function getReportDialogEndpoint(arg0, user) {
  const dsn = require(7283) /* dsnFromString */.makeDsn(arg0);
  if (dsn) {
    const _HermesInternal = HermesInternal;
    const combined = "" + getBaseApiEndpoint(dsn) + "embed/error-page/";
    const _HermesInternal2 = HermesInternal;
    let combined1 = "dsn=" + require(7283) /* dsnFromString */.dsnToString(dsn);
    let tmp10 = combined1;
  ...
  const obj = require(7283) /* dsnFromString */;
};
