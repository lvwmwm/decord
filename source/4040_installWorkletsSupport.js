...
// Dependencies: [4041, 4047]

// Module 4040 (installWorkletsSupport)
let require = arg1;
...
arg5.installWorkletsSupport = function installWorkletsSupport() {
  try {
    const NitroModules = require(4047) /* getInstalledNitro */.NitroModules;
    const boxResult = NitroModules.box(require(4047) /* getInstalledNitro */.NitroModules);
    require = boxResult;
    ...
    obj[3] = fn3;
    const result = require(4041).registerCustomSerializable(obj);
  } catch (err) {
  }
};
