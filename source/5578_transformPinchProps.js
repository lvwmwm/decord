...
// Module 5578 (transformPinchProps)
const require = arg1;
...
arg5.usePinchGesture = function usePinchGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(5556) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformPinchProps);
  const obj = require(5556) /* isGestureEnabled */;
  return require(5571) /* useGesture */.useGesture(require(5547) /* ComposedGestureName */.SingleGestureName.Pinch, clonedAndRemappedConfig);
};
