...
obj = {};
obj = { "Bool(false)": "sm", "Bool(false)": null, padding: importDefault(dependencyMap[10]).space.PX_8, borderRadius: importDefault(dependencyMap[10]).radii.xs };
obj.qrCode = obj;
obj.qrCodeContainer = { "Bool(false)": "sm", "Bool(false)": null, "Bool(false)": null, "Bool(false)": 1, "Bool(false)": "absolute" };
obj.qrCodeOverlay = {};
obj.size-40 = {};
