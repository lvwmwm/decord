...
// Dependencies: [19, 17, 4090, 1391, 1981, 676, 1388, 21, 4444, 4301, 9973, 589, 10430, 9068, 4265, 1377, 10431, 10432, 10448, 2]
// Exports: ChannelContainer

// Module 9972 (NotificationsContainer)
...
export const ChannelContainer = function ChannelContainer(children) {
  ...
  if (isStageChannel) {
    tmp5 = channelId(10430)(stateFromStoresObject.voiceChannelId);
  }
  ...
  const tmp8 = channelId(9068)(isPrivateResult);
  React = tmp8;
  const tmp9 = channelId(9068)(channelId);
  closure_4 = tmp9;
  ...
  if (type === ChannelTypes.GUILD_ANNOUNCEMENT) {
    ...
    if (stateFromStores) {
      obj1 = { channel: null };
      obj1[0] = channel;
      tmp15 = callback(tmp4(10432), obj1);
    }
  }
