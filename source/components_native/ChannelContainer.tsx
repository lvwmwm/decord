...
// Dependencies: [19, 17, 4121, 1386, 1980, 673, 1383, 21, 4481, 4338, 10007, 586, 9512, 8202, 4301, 1372, 11255, 11256, 9624, 2]
// Exports: ChannelContainer

// Module 10006 (NotificationsContainer)
...
export const ChannelContainer = function ChannelContainer(children) {
  ...
  const tmp8 = channelId(8202)(isPrivateResult);
  React = tmp8;
  const tmp9 = channelId(8202)(channelId);
  closure_4 = tmp9;
  ...
  if (type === ChannelTypes.GUILD_ANNOUNCEMENT) {
    ...
    if (stateFromStores) {
      obj1 = { channel: null };
      obj1[0] = channel;
      tmp15 = callback(tmp4(11256), obj1);
    }
  }
