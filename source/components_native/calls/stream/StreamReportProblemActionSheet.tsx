...
// Function ID: 16363
// Name: ReportProblem
// Dependencies: [19, 4431, 676, 21, 4342, 712, 4771, 7243, 698, 16363, 4310, 4061, 16364, 5806, 5804, 5436, 1236, 5439, 2]
// Exports: default

// Module 16362 (ReportProblem)
import "noop";
...
export default function ReportProblem(arg0) {
  ...
  const mapped = importDefault(16364)({ isStreamer: false, isEndStream: false }).map((label) => {
  ...
  obj[1] = jsx(require(5806) /* ActionSheetRowIcon */.ActionSheetRow.Group, { hasIcons: false, children: mapped });
  obj[2] = jsx(require(5439) /* BottomSheetModal */.BottomSheetScrollView, { style: tmp.container, children: null });
  return jsx(require(5804) /* ActionSheet */.ActionSheet, { style: tmp.container, children: null });
};
