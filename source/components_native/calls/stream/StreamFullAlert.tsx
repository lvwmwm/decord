...
// Dependencies: [19, 17, 21, 9169, 1236, 4732, 4299, 16934, 2]
// Exports: default

// Module 16933 (StreamFullAlert)
import "noop";
...
export default function StreamFullAlert(arg0) {
  ...
  const errorInfo = obj.getErrorInfo(require(9169) /* mapped */.AVError.STREAM_FULL);
  let errorCode;
  if (errorInfo != null) {
  ...
  items[2] = callback(Image, { source: importDefault(16934), style: closure_6.image });
  obj.children = items;
