...
// Function ID: 10785
// Name: Text
// Dependencies: [19, 17, 1372, 1862, 4326, 10785, 4340, 1874, 4315, 21, 4255, 4099, 712, 1297, 589, 4445, 10787, 10786, 709, 5257, 4665, 1236, 2]
// Exports: default
...
export default function RTCDebugOverlay(arg0) {
  ...
  obj1[1] = onClose;
  obj[1] = callback(require(4665) /* Button */.Button, obj1);
