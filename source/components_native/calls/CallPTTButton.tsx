...
// Dependencies: [32, 19, 1372, 4332, 4356, 676, 21, 4285, 712, 4128, 589, 10214, 9665, 10232, 5407, 4145, 1297, 1236, 2]

// Module 10231 (CallPTTButtonLooks)
...
const memoResult = importAllResult.memo((look) => {
  ...
  class F {
    constructor() {
      tmp = sendCallback;
      tmp2 = f84511;
      obj = sendCallback(f84511[15]);
      tmp3 = obj.runOnJS(c6)(true);
      obj2 = sendCallback(f84511[15]);
