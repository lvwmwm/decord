...
// Function ID: 13157
// Name: textLogoTier2
// Dependencies: [19, 17, 7124, 1925, 21, 4446, 712, 5349, 1367, 4905, 691, 4108, 13157, 13158, 7923, 8302, 10430, 10431, 5566, 2]
// Exports: default

// Module 13156 (textLogoTier2)
...
export default function _default(children) {
  ...
  obj[3] = textLogoTier2;
  if (PremiumTypes.TIER_0 === premiumType) {
    let tmp2Result = tmp2(13157);
  } else if (tmp11.TIER_1 === premiumType) {
    tmp2Result = tmp2(13158);
  } else if (tmp11.TIER_2 === premiumType) {
  ...
  if (PremiumTypes.TIER_0 === premiumType) {
    ...
    tmp2Result = tmp2(10430);
  } else if (tmp11.TIER_2 === premiumType) {
    tmp2Result = tmp2(10431);
  }
  obj[3] = tmp2Result;
