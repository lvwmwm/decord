...
// Dependencies: [19, 17, 5154, 1905, 21, 4302, 712, 12702, 1236, 7635, 12724, 12725, 12727, 8946, 12728, 7595, 12729, 7646, 12730, 11822, 12731, 7598, 12732, 8684, 589, 12621, 12733, 4238, 7549, 4147, 7558, 7559, 4298, 8574, 12737, 12738, 12739, 2]
// Exports: default

// Module 12723 (FEATURES_PREMIUM_GUILD_USER)
...
class FEATURES_PREMIUM_GUILD_USER {
  constructor() {
    ...
    obj[2] = function IconComponent(arg0) {
      ...
      return callback3(callback(12725).BoostTier3Icon, obj);
    };
    items[1] = obj;
...
export default function GuildBoostingUpsell(arg0) {
  ...
  let obj1 = require(12621) /* getSubscriptionPlansLoaded */;
  const subscriptionPlansLoaded = obj1.useSubscriptionPlansLoaded();
  let obj2 = require(12733) /* getGuildSubscriptionNoGuildsSource */;
  ...
  items1[2] = callback(require(4298) /* Text */.Text, obj3);
  ...
  items1[3] = callback(require(4298) /* Text */.Text, obj4);
  obj[1] = items1;
  ...
  items2[1] = callback(require(4298) /* Text */.Text, obj5);
  const obj6 = { style: tmp.features, features: null };
  tmp7Result = tmp7(8574);
  ...
  if (isInReverseTrial) {
    ...
    if (subscriptionPlansLoaded) {
      ...
      tmp13Result = tmp13(tmp7(12739), obj15);
    }
    ...
    if (stateFromStores) {
      ...
      const items5 = [tmp13(tmp2(4298).Text, obj17), , ];
      ...
      items5[1] = tmp13(tmp2(4298).Text, obj18);
      const obj19 = { style: null };
      obj19[0] = tmp.guildList;
      items5[2] = tmp13(tmp7(12738), obj19);
      obj16[0] = items5;
      let tmp19 = obj16;
    } else {
      ...
      items7[1] = tmp13(tmp2(4298).Text, obj21);
      ...
      items7[2] = tmp13(tmp2(4298).Text, obj22);
      obj16[0] = items7;
      tmp19 = obj16;
    }
