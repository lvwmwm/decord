...
// Dependencies: [19, 17, 5333, 1924, 21, 4445, 712, 13073, 1236, 8166, 13095, 13096, 13098, 9634, 13099, 8160, 13100, 10117, 13101, 12009, 13102, 8158, 13103, 9101, 589, 12992, 13104, 4380, 12897, 1363, 12906, 12907, 4441, 8294, 13108, 13109, 13110, 2]
// Exports: default

// Module 13094 (FEATURES_PREMIUM_GUILD_USER)
...
import UploadIcon from "UploadIcon" /* 8158 */;
...
import HeadphonesIcon from "HeadphonesIcon" /* 12009 */;
...
import registerAssetDefault3 from "registerAsset" /* 13098 */;
import registerAssetDefault4 from "registerAsset" /* 13099 */;
import registerAssetDefault5 from "registerAsset" /* 13100 */;
import registerAssetDefault6 from "registerAsset" /* 13101 */;
import registerAssetDefault7 from "registerAsset" /* 13102 */;
import registerAssetDefault8 from "registerAsset" /* 13103 */;
import getGuildSubscriptionNoGuildsSource from "getGuildSubscriptionNoGuildsSource" /* 13104 */;
...
class FEATURES_PREMIUM_GUILD_USER {
  constructor() {
    ...
    obj[2] = function IconComponent(arg0) {
      ...
      return callback3(callback(13096).BoostTier3Icon, obj);
    };
    items[1] = obj;
...
export default function GuildBoostingUpsell(arg0) {
  ...
  obj1 = { style: tmp.imgPremiumGuild, source: tmp7(12897) };
  ...
  if (tmp2Result.isThemeDark(tmp8)) {
    let tmp7Result = tmp7(12906);
  } else {
    tmp7Result = tmp7(12907);
  }
  obj2[1] = tmp7Result;
  ...
  if (isInReverseTrial) {
    ...
    if (subscriptionPlansLoaded) {
      ...
      tmp13Result = tmp13(tmp7(13110), obj15);
    }
    ...
    if (stateFromStores) {
      ...
      const items5 = [tmp13(tmp2(4441).Text, obj17), , ];
      ...
      items5[1] = tmp13(tmp2(4441).Text, obj18);
      const obj19 = { style: null };
      obj19[0] = tmp.guildList;
      items5[2] = tmp13(tmp7(13109), obj19);
      obj16[0] = items5;
      let tmp19 = obj16;
    } else {
      ...
      items7[1] = tmp13(tmp2(4441).Text, obj21);
      ...
      items7[2] = tmp13(tmp2(4441).Text, obj22);
      obj16[0] = items7;
      tmp19 = obj16;
    }
