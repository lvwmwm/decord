...
// Dependencies: [19, 17, 5137, 1905, 21, 4285, 712, 12687, 1236, 7616, 12709, 12710, 12712, 8929, 12713, 7576, 12714, 7627, 12715, 11807, 12716, 7579, 12717, 8667, 589, 12606, 12718, 4221, 7530, 4130, 7539, 7540, 4281, 8557, 12722, 12723, 12724, 2]
// Exports: default

// Module 12708 (FEATURES_PREMIUM_GUILD_USER)
...
class FEATURES_PREMIUM_GUILD_USER {
  constructor() {
    ...
    obj[2] = function IconComponent(arg0) {
      ...
      return callback3(callback(12710).BoostTier3Icon, obj);
    };
    items[1] = obj;
...
export default function GuildBoostingUpsell(arg0) {
  ...
  let obj1 = require(12606) /* getSubscriptionPlansLoaded */;
  const subscriptionPlansLoaded = obj1.useSubscriptionPlansLoaded();
  let obj2 = require(12718) /* getGuildSubscriptionNoGuildsSource */;
  ...
  items1[3] = callback(require(4281) /* Text */.Text, obj4);
  obj[1] = items1;
  ...
  items2[3] = callback(require(4281) /* Text */.Text, obj7);
  const obj8 = { style: tmp.features, features: null };
  const obj9 = { icon: null, label: null, IconComponent: null, color: null };
  tmp2Result = require(4130) /* AccessibilityAnnouncer */;
  obj9[0] = importDefault(12713);
  ...
  const items3 = [obj9, , , , ];
  const obj10 = { icon: importDefault(12714), label: null, IconComponent: null, color: null };
  ...
  items3[1] = obj10;
  const obj11 = { icon: importDefault(12715), label: null, color: "#4173da", IconComponent: null };
  const intl7 = tmp2(1236).intl;
  obj11[1] = intl7.string(require(1236) /* getSystemLocale */.t.rFNkf5);
  obj11[3] = require(11807) /* HeadphonesIcon */.HeadphonesIcon;
  items3[2] = obj11;
  const obj12 = { icon: importDefault(12716), label: null, IconComponent: null, color: null };
  ...
  if (isInReverseTrial) {
    ...
    if (subscriptionPlansLoaded) {
      ...
      tmp13Result = tmp13(tmp7(12724), obj15);
    }
    ...
    if (stateFromStores) {
      ...
      const items5 = [tmp13(tmp2(4281).Text, obj17), , ];
      ...
      items5[2] = tmp13(tmp7(12723), obj19);
      obj16[0] = items5;
      let tmp19 = obj16;
    } else {
      ...
      items7[1] = tmp13(tmp2(4281).Text, obj21);
      ...
      items7[2] = tmp13(tmp2(4281).Text, obj22);
      obj16[0] = items7;
      tmp19 = obj16;
    }
