...
// Dependencies: [19, 17, 5031, 1876, 21, 4193, 712, 12552, 1236, 6621, 12574, 12575, 12577, 8290, 12578, 6579, 12579, 6632, 12580, 11633, 12581, 6582, 12582, 9430, 589, 12467, 12583, 4129, 6527, 4039, 6536, 6537, 4189, 9344, 12587, 12588, 12589, 2]
// Exports: default
...
class FEATURES_PREMIUM_GUILD_USER {
  constructor() {
    ...
    obj[2] = function IconComponent(arg0) {
      ...
      return callback3(callback(12575).BoostTier3Icon, obj);
    };
    items[1] = obj;
...
export default function GuildBoostingUpsell(arg0) {
  ...
  let obj1 = require(12467) /* getSubscriptionPlansLoaded */;
  const subscriptionPlansLoaded = obj1.useSubscriptionPlansLoaded();
  let obj2 = require(12583) /* getGuildSubscriptionNoGuildsSource */;
  ...
  items1[3] = callback(require(4189) /* Text */.Text, obj4);
  obj[1] = items1;
  ...
  if (isInReverseTrial) {
    ...
    if (subscriptionPlansLoaded) {
      ...
      tmp13Result = tmp13(tmp7(12589), obj15);
    }
    ...
    if (stateFromStores) {
      ...
      const items5 = [tmp13(tmp2(4189).Text, obj17), , ];
      ...
      items5[1] = tmp13(tmp2(4189).Text, obj18);
      const obj19 = { style: null };
      obj19[0] = tmp.guildList;
      items5[2] = tmp13(tmp7(12588), obj19);
      obj16[0] = items5;
      let tmp19 = obj16;
    } else {
      ...
      items7[1] = tmp13(tmp2(4189).Text, obj21);
      ...
      items7[2] = tmp13(tmp2(4189).Text, obj22);
      obj16[0] = items7;
      tmp19 = obj16;
    }
