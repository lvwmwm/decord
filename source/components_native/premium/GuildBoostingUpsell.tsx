...
// Dependencies: [19, 17, 5093, 1876, 21, 4255, 712, 12645, 1236, 7604, 12667, 12668, 12670, 8597, 12671, 7564, 12672, 7615, 12673, 11740, 12674, 7567, 12675, 9577, 589, 12564, 12676, 4191, 7518, 4101, 7527, 7528, 4251, 8315, 12680, 12681, 12682, 2]
// Exports: default

// Module 12666 (FEATURES_PREMIUM_GUILD_USER)
...
class FEATURES_PREMIUM_GUILD_USER {
  constructor() {
    ...
    obj[2] = function IconComponent(arg0) {
      ...
      return callback3(callback(12668).BoostTier3Icon, obj);
    };
    items[1] = obj;
...
export default function GuildBoostingUpsell(arg0) {
  ...
  let obj1 = require(12564) /* getSubscriptionPlansLoaded */;
  const subscriptionPlansLoaded = obj1.useSubscriptionPlansLoaded();
  let obj2 = require(12676) /* getGuildSubscriptionNoGuildsSource */;
  ...
  obj1 = { style: tmp.imgPremiumGuild, source: tmp7(7518) };
  ...
  if (tmp2Result.isThemeDark(tmp8)) {
    let tmp7Result = tmp7(7527);
  } else {
    tmp7Result = tmp7(7528);
  }
  obj2[1] = tmp7Result;
  ...
  if (isInReverseTrial) {
    ...
    if (subscriptionPlansLoaded) {
      ...
      tmp13Result = tmp13(tmp7(12682), obj15);
    }
    ...
    if (stateFromStores) {
      ...
      items5[2] = tmp13(tmp7(12681), obj19);
      obj16[0] = items5;
      let tmp19 = obj16;
    } else {
