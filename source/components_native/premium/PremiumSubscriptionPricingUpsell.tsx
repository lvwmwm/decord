...
// Dependencies: [32, 19, 17, 1994, 1922, 4012, 4013, 5920, 676, 1924, 21, 4342, 589, 4007, 12775, 709, 6951, 5923, 4338, 500, 5918, 5917, 1236, 1898, 2]
// Exports: default

// Module 12891 (PricingSubheadingCopy)
...
export default function PremiumSubscriptionPricingUpsell() {
  const tmp = callback3();
  let obj = require(12775) /* getSubscriptionPlansLoaded */;
