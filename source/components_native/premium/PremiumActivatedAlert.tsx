...
// Dependencies: [19, 17, 676, 21, 4380, 5265, 4043, 7523, 7524, 7525, 7526, 7527, 7472, 7473, 7528, 7529, 7530, 7531, 7532, 7533, 7534, 1363, 7535, 7536, 7537, 7538, 7539, 7540, 7541, 7542, 7543, 1236, 4315, 4833, 7544, 7545, 1297, 2]
// Exports: default

// Module 7522 (PremiumActivatedAlert)
...
let closure_11 = createCacheKey.createStyles((arg0) => {
  if (getPremiumPlanItem.Branding.BUNDLE === arg0) {
    ...
    if (tmp(4043).Branding.TIER_0 !== arg0) {
      if (tmp(4043).Branding.TIER_1 !== arg0) {
        if (tmp(4043).Branding.TIER_2 !== arg0) {
          if (tmp(4043).Branding.PREMIUM_GUILD === arg0) {
            obj = { animation: null };
...
export default function PremiumActivatedAlert(onClose) {
  ...
  if (getPremiumPlanItem.Branding.TIER_0 === premiumBranding) {
    ...
    let tmp9 = obj;
  } else if (tmp7(4043).Branding.TIER_1 === premiumBranding) {
    obj = { logo: null };
    obj[0] = { width: 82, height: 32 };
    tmp9 = obj;
  } else {
    if (tmp7(4043).Branding.BUNDLE !== premiumBranding) {
      if (tmp7(4043).Branding.TIER_2 !== premiumBranding) {
        if (tmp7(4043).Branding.PREMIUM_GUILD === premiumBranding) {
          obj1 = { logo: null };
  ...
  let tmp4Result = tmp4(4833);
  const intl = tmp7(1236).intl;
  obj3[1] = intl.string(getSystemLocale.t.TkTvBz);
  obj3[2] = tmp.alert;
  const obj4 = { style: tmp.header, source: null, children: null };
  if (getPremiumPlanItem.Branding.TIER_0 === premiumBranding) {
    tmp4Result = tmp4(7523);
  } else if (tmp7(4043).Branding.TIER_1 === premiumBranding) {
    tmp4Result = tmp4(7524);
  } else if (tmp7(4043).Branding.TIER_2 === premiumBranding) {
    tmp4Result = tmp4(7525);
  } else if (tmp7(4043).Branding.BUNDLE === premiumBranding) {
    tmp4Result = tmp4(7526);
  } else if (tmp7(4043).Branding.PREMIUM_GUILD === premiumBranding) {
    tmp4Result = tmp4(7527);
  }
  obj4[1] = tmp4Result;
  if (getPremiumPlanItem.Branding.TIER_0 === premiumBranding) {
    let tmp4Result1 = tmp4(7531);
  } else if (tmp7(4043).Branding.TIER_1 === premiumBranding) {
    tmp4Result1 = tmp4(7532);
  } else {
    if (tmp7(4043).Branding.BUNDLE !== premiumBranding) {
      if (tmp7(4043).Branding.TIER_2 !== premiumBranding) {
        if (tmp7(4043).Branding.PREMIUM_GUILD === premiumBranding) {
          tmp4Result1 = tmp4(7534);
        }
      }
    }
    tmp4Result1 = tmp4(7533);
  }
  ...
  items[1] = tmp16Result;
  if (getPremiumPlanItem.Branding.TIER_0 === premiumBranding) {
    let tmp4Result2 = tmp4(7472);
  } else if (tmp7(4043).Branding.TIER_1 === premiumBranding) {
    tmp4Result2 = tmp4(7473);
  } else if (tmp7(4043).Branding.TIER_2 === premiumBranding) {
    tmp4Result2 = tmp4(7528);
  } else if (tmp7(4043).Branding.BUNDLE === premiumBranding) {
    tmp4Result2 = tmp4(7529);
  } else if (tmp7(4043).Branding.PREMIUM_GUILD === premiumBranding) {
    tmp4Result2 = tmp4(7530);
  }
  ...
  if (getPremiumPlanItem.Branding.TIER_0 === premiumBranding) {
    ...
    if (tmp7Result.isThemeDark(tmp6)) {
      let tmp4Result4 = tmp4(7535);
    } else {
      tmp4Result4 = tmp4(7536);
    }
  } else {
    if (tmp7(4043).Branding.TIER_1 === premiumBranding) {
      tmp7Result = tmp7(1363);
      if (tmp7Result.isThemeDark(tmp6)) {
        let tmp4Result5 = tmp4(7537);
      } else {
        tmp4Result5 = tmp4(7538);
      }
      let tmp4Result8 = tmp4Result5;
    } else if (tmp7(4043).Branding.TIER_2 === premiumBranding) {
      if (tmp7Result1.isThemeDark(tmp6)) {
        let tmp4Result6 = tmp4(7539);
      } else {
        tmp4Result6 = tmp4(7540);
      }
      tmp4Result8 = tmp4Result6;
      tmp7Result1 = tmp7(1363);
    } else if (tmp7(4043).Branding.BUNDLE === premiumBranding) {
      if (tmp7Result2.isThemeDark(tmp6)) {
        let tmp4Result7 = tmp4(7541);
      } else {
        tmp4Result7 = tmp4(7542);
      }
      tmp4Result8 = tmp4Result7;
      tmp7Result2 = tmp7(1363);
    } else if (tmp7(4043).Branding.PREMIUM_GUILD === premiumBranding) {
      tmp4Result8 = tmp4(7543);
    }
    ...
    if (tmp7(4043).Branding.TIER_0 !== premiumBranding) {
      if (tmp7(4043).Branding.TIER_1 !== premiumBranding) {
        if (tmp7(4043).Branding.TIER_2 === premiumBranding) {
          ...
          obj10[0] = tmp7(4043).getExternalPlanDisplayName({ planId: null, additionalPlans: null });
          stringResult = intl2.format(tmp7(1236).t.YJUUH3, obj10);
          const obj11 = { planId: null, additionalPlans: null };
          const tmp7Result3 = tmp7(4043);
        }
      }
      obj9[1] = stringResult;
