...
// Dependencies: [19, 17, 676, 21, 4255, 5096, 3901, 7289, 7290, 7291, 7292, 7293, 7239, 7240, 7294, 7295, 7296, 7297, 7298, 7299, 7300, 4101, 7301, 7302, 7303, 7304, 7305, 7306, 7307, 7308, 7309, 1236, 4191, 4684, 7310, 7311, 1297, 2]
// Exports: default

// Module 7288 (PremiumActivatedAlert)
...
export default function PremiumActivatedAlert(onClose) {
  ...
  if (require(3901) /* getPremiumPlanItem */.Branding.TIER_0 === premiumBranding) {
    tmp4Result = tmp4(7289);
  } else if (tmp7(3901).Branding.TIER_1 === premiumBranding) {
    tmp4Result = tmp4(7290);
  } else if (tmp7(3901).Branding.TIER_2 === premiumBranding) {
    tmp4Result = tmp4(7291);
    ...
    tmp4Result = tmp4(7293);
  }
  obj4[1] = tmp4Result;
  if (require(3901) /* getPremiumPlanItem */.Branding.TIER_0 === premiumBranding) {
    let tmp4Result1 = tmp4(7297);
  } else if (tmp7(3901).Branding.TIER_1 === premiumBranding) {
    tmp4Result1 = tmp4(7298);
  } else {
    if (tmp7(3901).Branding.BUNDLE !== premiumBranding) {
      if (tmp7(3901).Branding.TIER_2 !== premiumBranding) {
        if (tmp7(3901).Branding.PREMIUM_GUILD === premiumBranding) {
          tmp4Result1 = tmp4(7300);
        }
      }
    }
    tmp4Result1 = tmp4(7299);
  }
  ...
  items[1] = tmp16Result;
  if (require(3901) /* getPremiumPlanItem */.Branding.TIER_0 === premiumBranding) {
    let tmp4Result2 = tmp4(7239);
  } else if (tmp7(3901).Branding.TIER_1 === premiumBranding) {
    tmp4Result2 = tmp4(7240);
  } else if (tmp7(3901).Branding.TIER_2 === premiumBranding) {
    tmp4Result2 = tmp4(7294);
  } else if (tmp7(3901).Branding.BUNDLE === premiumBranding) {
    tmp4Result2 = tmp4(7295);
  } else if (tmp7(3901).Branding.PREMIUM_GUILD === premiumBranding) {
    tmp4Result2 = tmp4(7296);
  }
