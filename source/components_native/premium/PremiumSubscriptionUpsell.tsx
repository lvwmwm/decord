...
// Dependencies: [31, 27, 1922, 1850, 653, 6207, 1852, 33, 4165, 689, 4117, 1212, 1827, 566, 3811, 4589, 668, 4161, 12548, 12549, 9309, 4578, 2]
// Exports: default

// Module 12547 (PremiumSubscriptionUpsell)
import "result";
...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj1.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (obj4.isPremium(stateFromStores)) {
      ...
      tmp14 = callback(require(4161) /* Text */.Text, obj5);
    }
    const items3 = [tmp14, , ];
    const obj6 = { style: tmp.upsellFeatures };
    const obj7 = { style: tmp.upsellFeatureSubLogo, source: importDefault(12548) };
    const items4 = [callback(closure_4, obj7), , ];
    const obj8 = { style: tmp.upsellFeatureLogoTier2, source: importDefault(12549) };
    ...
    const tmp8 = importDefault(4589);
    obj10.IconComponent = require(4117) /* CheckmarkLargeIcon */.CheckmarkLargeIcon;
    const intl4 = require(1212) /* getSystemLocale */.intl;
    const obj11 = {};
    const tmp27 = importDefault(9309);
    ...
    const items5 = [obj10, ];
    const obj12 = { IconComponent: require(4117) /* CheckmarkLargeIcon */.CheckmarkLargeIcon };
    ...
    tmp = callback(require(4578) /* Button */.Button, obj15);
    obj14.children = tmp;
