...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj1.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (obj4.isPremium(stateFromStores)) {
      ...
      tmp14 = callback(require(4127) /* Text */.Text, obj5);
    }
    const items3 = [tmp14, , ];
    ...
    const tmp8 = importDefault(4555);
    obj10.IconComponent = require(4083) /* CheckmarkLargeIcon */.CheckmarkLargeIcon;
    const intl4 = require(1212) /* getSystemLocale */.intl;
    const obj11 = {};
    const tmp27 = importDefault(9265);
    ...
    const items5 = [obj10, ];
    const obj12 = { IconComponent: require(4083) /* CheckmarkLargeIcon */.CheckmarkLargeIcon };
    ...
    tmp = callback(require(4544) /* Button */.Button, obj15);
    obj14.children = tmp;
