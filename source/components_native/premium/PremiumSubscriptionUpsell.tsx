...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj1.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (tmp5Result.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp6(tmp2(4185).Text, obj2), ];
      ...
      items2[1] = tmp6(tmp2(4185).Text, obj3);
      obj1[0] = items2;
      ...
      tmp6Result = tmp6(tmp2(4185).Text, obj5);
    }
    ...
    obj12[0] = tmp2(4141).CheckmarkLargeIcon;
    ...
    tmp = tmp6(tmp2(4600).Button, obj15);
    obj14[1] = tmp;
