...
// Dependencies: [19, 17, 4383, 1218, 10386, 4012, 4391, 676, 1924, 21, 4342, 712, 4072, 10387, 4338, 1236, 4777, 5909, 9461, 1297, 5799, 9541, 5839, 12917, 12918, 12666, 12668, 12669, 12667, 12670, 12671, 12672, 12673, 12233, 12674, 12677, 12678, 12919, 589, 10393, 2]

// Module 12916 (importDefaultResult1)
...
prototype["renderHeader"] = function renderHeader(arg0, children) {
  ...
  let obj1 = require(5909) /* getPrice */;
  ...
  if (isGameItemSKUResult) {
    ...
    obj1[0] = sku;
    const tmp15 = importDefault(9461);
  ...
  const items2 = [closure_14(require(4338) /* Text */.Text, { variant: "heading-sm/semibold", color: "mobile-text-heading-primary", accessibilityRole: "header", children }), ];
  ...
  if (isGameItemSKUResult) {
    ...
    obj6[0] = application;
    obj6[1] = importDefault(5799).Sizes.SIZE_24;
    obj6[2] = sku.id;
    tmp6Result = tmp6(importDefault(5799), obj6);
    const tmp18 = importDefault(5799);
  }
  ...
  obj7[3] = formatResult;
  items4[1] = closure_14(require(4338) /* Text */.Text, obj7);
  obj5[1] = items4;
...
prototype["getCardHeaderThumbnail"] = function getCardHeaderThumbnail(id, giftStyle) {
  if (constants2.STANDARD_BOX === giftStyle) {
    return importDefault(12666);
  } else if (tmp.CAKE === giftStyle) {
    return importDefault(12668);
  } else if (tmp.CHEST === giftStyle) {
    return importDefault(12669);
  } else if (tmp.COFFEE === giftStyle) {
    return importDefault(12667);
  } else if (tmp.SEASONAL_STANDARD_BOX === giftStyle) {
    return importDefault(12670);
  } else if (tmp.SEASONAL_CAKE === giftStyle) {
    return importDefault(12671);
  } else if (tmp.SEASONAL_CHEST === giftStyle) {
    return importDefault(12672);
  } else if (tmp.SEASONAL_COFFEE === giftStyle) {
    return importDefault(12673);
  } else if (tmp.NITROWEEN_STANDARD === giftStyle) {
    const obj = { uri: null };
    obj[0] = importDefault(12233);
    return obj;
  } else if (TIER_0.TIER_0 === id) {
    return importDefault(12674);
  } else if (tmp3.TIER_1 === id) {
    return importDefault(12677);
  } else {
    if (tmp3.TIER_2 !== id) {
      if (tmp3.LEGACY !== id) {
        return null;
...
let tmp11 = require("initialize").connectStores(items, (arg0) => {
  ...
  if (null == value) {
    ...
    if (null != subscriptionPlanId) {
      obj = require(10393) /* getSubscriptionPlans */;
