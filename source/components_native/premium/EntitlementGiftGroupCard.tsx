...
prototype["renderHeader"] = function renderHeader(arg0, children) {
  ...
  let obj1 = require(5662) /* getPrice */;
  ...
  const items2 = [closure_14(require(4185) /* Text */.Text, { variant: "heading-sm/semibold", color: "mobile-text-heading-primary", accessibilityRole: "header", children }), ];
  ...
  if (isGameItemSKUResult) {
    ...
    obj6[0] = application;
    obj6[1] = importDefault(5525).Sizes.SIZE_24;
    obj6[2] = sku.id;
    tmp6Result = tmp6(importDefault(5525), obj6);
    const tmp18 = importDefault(5525);
  }
  ...
  obj7[3] = formatResult;
  items4[1] = closure_14(require(4185) /* Text */.Text, obj7);
  obj5[1] = items4;
