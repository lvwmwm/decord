...
class PremiumUpsellAlert {
  constructor(arg0) {
    ...
    items = [];
    items[0] = closure_13;
    f63472 = obj2.useStateFromStores(items, () => currentUser.getCurrentUser());
...
let obj = arg1(dependencyMap[14]);
obj = { carousel: { alignItems: "center" }, upsellContainer: { alignItems: "center" }, premiumUpsellContainer: {}, nitroWheel: { "Bool(false)": null, "Bool(false)": null, "Bool(false)": null }, upsellImage: { hideWhenScrolling: null, autoCapitalize: "5e2f785032385a803c0dd3d91ffe95da" }, upsellTitle: { value: null, on: null } };
