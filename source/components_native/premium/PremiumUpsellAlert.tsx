...
// Dependencies: [32, 19, 17, 1304, 1874, 676, 7555, 1876, 21, 4255, 712, 3967, 4251, 6805, 1236, 3901, 8146, 8147, 4191, 4101, 8584, 8585, 8586, 8587, 8136, 8588, 8589, 8590, 8591, 589, 5635, 8592, 8145, 1474, 5595, 5615, 4681, 698, 8593, 4150, 4683, 1297, 5221, 8594, 8595, 8149, 2]

// Module 8583 (PremiumUpsellItem)
...
function GlobalEmojiUpsell(arg0) {
  ...
  const obj3 = { image: importDefault(8146), title: null, description: null };
...
function AnimatedEmojiUpsell(alertWidth) {
  ...
  obj = { image: importDefault(8147), title: null, description: null };
...
function CustomProfilesUpsell(alertWidth) {
  ...
  obj = { image: importDefault(8586), title: null, description: null };
  const intl = require(1236) /* getSystemLocale */.intl;
...
function GlobalStickerUpsell(alertWidth) {
  let obj = { alertWidth: alertWidth.alertWidth, upsellItem: null };
  obj = { image: importDefault(8587), title: null, description: null };
  const intl = require(1236) /* getSystemLocale */.intl;
