...
// Dependencies: [5, 19, 17, 11854, 1891, 4195, 3953, 676, 6836, 4190, 21, 4302, 4145, 712, 589, 4194, 8385, 4298, 1236, 12809, 12810, 4712, 12819, 4723, 691, 698, 12776, 38, 4198, 4641, 12823, 1988, 2]
// Exports: default

// Module 12808 (PendingCancellationWarning)
...
function SubscribeConfirmation(arg0) {
  ...
  obj = { style: tmp.subscribeImage, source: importDefault(12809) };
  ...
  items[2] = callback(importDefault(12810), { style: tmp.guildPreview, guild });
  ...
  items[3] = callback(require(4298) /* Text */.Text, obj2);
