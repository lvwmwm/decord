...
// Dependencies: [5, 19, 17, 11839, 1891, 4178, 3936, 676, 6817, 4173, 21, 4285, 4128, 712, 589, 4177, 8368, 4281, 1236, 12794, 12795, 4695, 12804, 4706, 691, 698, 12761, 38, 4181, 4624, 12808, 1988, 2]
// Exports: default

// Module 12793 (PendingCancellationWarning)
...
function SubscribeConfirmation(arg0) {
  ...
  obj = { style: tmp.subscribeImage, source: importDefault(12794) };
  ...
  items[2] = callback(importDefault(12795), { style: tmp.guildPreview, guild });
