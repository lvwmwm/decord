...
// Dependencies: [32, 19, 1302, 5153, 676, 21, 5154, 5270, 5151, 6008, 4153, 6009, 6010, 6011, 1236, 6013, 6016, 1297, 6018, 12878, 5716, 4711, 5783, 2]
// Exports: default

// Module 5152 (PremiumGuildSubscribeModal)
...
export default function PremiumGuildSubscribeModal(arg0) {
  ...
  let items = [first];
  importDefault(4711)(first.useCallback(() => {
  ...
  return jsx(require(5783) /* NavigationStack */.Navigator, { screens: tmp.screens, initialRouteStack: initialStack, headerBackTitle: null, onStateChange: null });
};
