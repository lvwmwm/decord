...
// Dependencies: [32, 19, 1302, 5105, 676, 21, 5106, 5223, 5103, 5902, 4101, 5903, 5904, 5905, 1236, 5907, 5910, 1297, 5912, 12756, 5583, 4662, 5650, 2]
// Exports: default

// Module 5104 (PremiumGuildSubscribeModal)
...
export default function PremiumGuildSubscribeModal(arg0) {
  ...
  let items = [first];
  importDefault(4662)(first.useCallback(() => {
  ...
  return jsx(require(5650) /* NavigationStack */.Navigator, { screens: tmp.screens, initialRouteStack: initialStack, headerBackTitle: null, onStateChange: null });
};
