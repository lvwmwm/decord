...
// Dependencies: [32, 19, 17, 1910, 6937, 21, 4344, 712, 12959, 12960, 589, 4280, 4772, 1236, 4683, 5191, 4765, 691, 1363, 12961, 12962, 4340, 2]
// Exports: default

// Module 12958 (PremiumPaymentGuildAnimation)
...
export default function SubscribeModalSuccessAlert(arg0) {
  ...
  const tmp11 = importDefault(4772);
  ...
  obj5[2] = stringResult;
  const items3 = [callback2(require(4340) /* Text */.Text, obj5), ];
  ...
  items3[1] = callback2(require(4340) /* Text */.Text, obj7);
  obj4[1] = items3;
