...
// Dependencies: [32, 5, 19, 17, 1903, 5779, 676, 1905, 21, 712, 4285, 3930, 7304, 7518, 7519, 7301, 7302, 7303, 7305, 7520, 7521, 7522, 7250, 7523, 7524, 7525, 7526, 7527, 7306, 7528, 7529, 7530, 7531, 7532, 7533, 7534, 7309, 7535, 7536, 7537, 7311, 7538, 7539, 7540, 7295, 7342, 7541, 7542, 6794, 6792, 6804, 514, 4604, 1480, 589, 38, 5649, 5776, 500, 1297, 4695, 1236, 4281, 7553, 5669, 7554, 7555, 2]
// Exports: default, handleManageSubscription, onCancelClick

// Module 7517 (handleCancelSubscription)
...
export default function PremiumSubscriptionDetails(subscription) {
  ...
  obj = { subscriptionId: subscription.id, renewal: true, analyticsLocations: importDefault(5649)().analyticsLocations, analyticsLocation: importDefault(5669).PREMIUM_SUBSCRIPTION_DETAILS };
...
export const handleManageSubscription = function handleManageSubscription(subscription, registerAsset, analyticsLocations) {
  if (subscription.status === constants3.ACCOUNT_HOLD) {
    ...
    obj[4] = prop;
    const result = require(6794) /* launchPremiumPlanSelect */.launchPremiumPlanSelect(obj);
    const obj2 = require(6794) /* launchPremiumPlanSelect */;
    tmp9 = require;
  }
};
