...
// Dependencies: [32, 5, 19, 17, 1874, 5752, 676, 1876, 21, 712, 4255, 3901, 7276, 7490, 7491, 7273, 7274, 7275, 7277, 7492, 7493, 7494, 7223, 7495, 7496, 7497, 7498, 7499, 7278, 7500, 7501, 7502, 7503, 7504, 7505, 7506, 7281, 7507, 7508, 7509, 7283, 7510, 7511, 7512, 7267, 7314, 7513, 7514, 6767, 6765, 6777, 514, 4574, 1480, 589, 38, 5595, 5749, 500, 1297, 4665, 1236, 4251, 7525, 5615, 7526, 7527, 2]
// Exports: default, handleManageSubscription, onCancelClick

// Module 7489 (handleCancelSubscription)
...
export default function PremiumSubscriptionDetails(subscription) {
  ...
  const tmp = callback5();
  let obj = require(7525) /* createSubscriptionInvoicePreview */;
  obj = { subscriptionId: subscription.id, renewal: true, analyticsLocations: importDefault(5595)().analyticsLocations, analyticsLocation: importDefault(5615).PREMIUM_SUBSCRIPTION_DETAILS };
...
export const onCancelClick = function onCancelClick(subscription, analyticsLocations) {
  ...
  if (obj2.isBoostOnlySubscription(subscription)) {
    ...
    obj = { subscription: null, mode: null, onContinue: null };
    obj[0] = subscription;
    obj[1] = _require(7514).WhatYouLoseMode.CANCEL;
    obj[2] = function onContinue(arg0) {
      return outer1_26(closure_0, closure_1, arg0);
    };
    tmp4ResultResult = importDefault(7513)(obj);
    const tmp4Result = importDefault(7513);
  }
...
export const handleManageSubscription = function handleManageSubscription(subscription, registerAsset, analyticsLocations) {
  if (subscription.status === constants3.ACCOUNT_HOLD) {
    ...
    obj[4] = prop;
    const result = require(6767) /* launchPremiumPlanSelect */.launchPremiumPlanSelect(obj);
    const obj2 = require(6767) /* launchPremiumPlanSelect */;
    tmp9 = require;
  }
};
