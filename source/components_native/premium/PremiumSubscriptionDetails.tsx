...
// Dependencies: [32, 5, 19, 17, 1922, 5858, 676, 1924, 21, 712, 4303, 3966, 7385, 7599, 7600, 7382, 7383, 7384, 7386, 7601, 7602, 7603, 7330, 7604, 7605, 7606, 7607, 7608, 7387, 7609, 7610, 7611, 7612, 7613, 7614, 7615, 7390, 7616, 7617, 7618, 7392, 7619, 7620, 7621, 7376, 7423, 7622, 7623, 6875, 6873, 6885, 514, 4623, 1499, 589, 38, 5728, 5855, 500, 1297, 4714, 1236, 4299, 7634, 5748, 7635, 7636, 2]
// Exports: default, handleManageSubscription, onCancelClick

// Module 7598 (handleCancelSubscription)
...
export default function PremiumSubscriptionDetails(subscription) {
  ...
  const tmp = callback5();
  let obj = require(7634) /* createSubscriptionInvoicePreview */;
...
export const onCancelClick = function onCancelClick(subscription, analyticsLocations) {
  ...
  if (obj2.isBoostOnlySubscription(subscription)) {
    ...
    obj = { subscription: null, mode: null, onContinue: null };
    obj[0] = subscription;
    obj[1] = _require(7623).WhatYouLoseMode.CANCEL;
    obj[2] = function onContinue(arg0) {
      return outer1_26(closure_0, closure_1, arg0);
    };
    tmp4ResultResult = importDefault(7622)(obj);
    const tmp4Result = importDefault(7622);
  }
...
export const handleManageSubscription = function handleManageSubscription(subscription, registerAsset, analyticsLocations) {
  if (subscription.status === constants3.ACCOUNT_HOLD) {
    ...
    obj[4] = prop;
    const result = require(6875) /* launchPremiumPlanSelect */.launchPremiumPlanSelect(obj);
    const obj2 = require(6875) /* launchPremiumPlanSelect */;
    tmp9 = require;
  }
};
