...
// Dependencies: [19, 4358, 5057, 7055, 1396, 1391, 1990, 1910, 4393, 4436, 4416, 1979, 4165, 5059, 4550, 1922, 676, 1398, 21, 4549, 7301, 15907, 6995, 1913, 15908, 698, 1370, 15909, 589, 15910, 15911, 2]
// Exports: default

// Module 15906 (componentDidMount)
...
prototype["componentDidMount"] = function componentDidMount() {
  ...
  if (null != selectedChannelId) {
    let obj = {};
    const merged = Object.assign(require(4549) /* collectGuildAnalyticsMetadata */.getChannelOpenedMetadata(selectedChannelId));
    obj.selected_guild_id = selectedGuildId;
    self._trackWithMetadata(constants.CHANNEL_OPENED, obj);
    obj = { channelId: null };
    obj[0] = selectedChannelId;
    importDefault(7301)(obj);
    if (tmp) {
      const obj1 = { channel_is_nsfw: null };
      obj1[0] = tmp2;
      tmp18(4549).trackWithMetadata(tmp17.TEXT_IN_VOICE_OPENED, obj1);
      const tmp18Result = tmp18(4549);
    }
    const obj11 = require(4549) /* collectGuildAnalyticsMetadata */;
    tmp17 = constants;
    tmp18 = require;
  }
  if (null != selectedGuildId) {
    ...
    let obj5 = require(15907) /* collectGuildThemeAnalyticsMetadata */;
    ...
    require(6995) /* isClickstreamEnabled */.trackClickstream(constants.GUILD_VIEWED_CLICKSTREAM, obj5);
    const obj7 = require(6995) /* isClickstreamEnabled */;
...
prototype["componentDidUpdate"] = function componentDidUpdate(voiceChannelId) {
  ...
  if (voiceChannelId.voiceChannelId !== voiceChannelId) {
    if (null != voiceChannelId.voiceChannelId) {
      ...
      obj[8] = id1;
      let obj2 = require(4549) /* collectGuildAnalyticsMetadata */;
  ...
  if (voiceChannelId.voiceChannelId !== voiceChannelId) {
    if (null != voiceChannelId) {
      ...
      let obj3 = require(4549) /* collectGuildAnalyticsMetadata */;
  ...
  if (voiceChannelId.videoEnabled !== videoEnabled) {
    if (null != voiceChannelId) {
      ...
      const merged6 = Object.assign(require(4549) /* collectGuildAnalyticsMetadata */.collectVoiceAnalyticsMetadata(voiceChannelId));
      obj4.track(constants.VIDEO_INPUT_TOGGLED, obj1);
      const tmp31 = require;
      const tmp31Result = require(4549) /* collectGuildAnalyticsMetadata */;
    }
  }
  ...
  if (!tmp41) {
    obj2 = {};
    let obj8 = require(15909) /* getChannelOpenedRouteTrackingProps */;
    const merged7 = Object.assign(obj8.getChannelOpenedRouteTrackingProps(selectedChannelId));
    let obj9 = require(4549) /* collectGuildAnalyticsMetadata */;
    ...
    importDefault(7301)(obj3);
    if (isTextInVoice) {
      obj4 = { channel_is_nsfw: null };
      obj4[0] = isNSFWChannel;
      tmp44(4549).trackWithMetadata(tmp43.TEXT_IN_VOICE_OPENED, obj4);
      const tmp44Result = tmp44(4549);
    }
    tmp43 = constants;
    tmp44 = require;
  }
  ...
  if (isTextInVoice) {
    ...
    require(4549) /* collectGuildAnalyticsMetadata */.trackWithMetadata(constants.TEXT_IN_VOICE_OPENED, obj5);
    const obj14 = require(4549) /* collectGuildAnalyticsMetadata */;
  }
  if (null != selectedGuildId) {
    if (voiceChannelId.selectedGuildId !== selectedGuildId) {
      ...
      const merged10 = Object.assign(require(15907) /* collectGuildThemeAnalyticsMetadata */.collectGuildThemeAnalyticsMetadata(selectedGuildId));
      self._trackWithMetadata(constants.GUILD_VIEWED, obj8);
      const obj19 = require(15907) /* collectGuildThemeAnalyticsMetadata */;
      obj9 = { guild_id: null };
      obj9[0] = selectedGuildId;
      require(6995) /* isClickstreamEnabled */.trackClickstream(constants.GUILD_VIEWED_CLICKSTREAM, obj9);
      const obj20 = require(6995) /* isClickstreamEnabled */;
...
prototype["_trackWithMetadata"] = function _trackWithMetadata(CHANNEL_OPENED, fileSizeLimitEventProperties) {
  ...
  if (this.props.connected) {
    require(4549) /* collectGuildAnalyticsMetadata */.trackWithMetadata(CHANNEL_OPENED, obj);
    const obj5 = require(4549) /* collectGuildAnalyticsMetadata */;
  } else {
