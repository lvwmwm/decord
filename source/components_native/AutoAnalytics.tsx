...
// Dependencies: [19, 4268, 1375, 4945, 6879, 1377, 1372, 1942, 1862, 4302, 4346, 4326, 1931, 4072, 4947, 4450, 1874, 676, 1379, 1876, 21, 4449, 7128, 15669, 6820, 1865, 698, 1351, 15670, 9600, 1897, 9604, 589, 15671, 15672, 2]
// Exports: default

// Module 15668 (componentDidMount)
...
prototype["componentDidMount"] = function componentDidMount() {
  ...
  if (null != selectedChannelId) {
    let obj = {};
    const merged = Object.assign(require(4449) /* collectGuildAnalyticsMetadata */.getChannelOpenedMetadata(selectedChannelId));
    obj.selected_guild_id = selectedGuildId;
    self._trackWithMetadata(constants.CHANNEL_OPENED, obj);
    obj = { channelId: null };
    obj[0] = selectedChannelId;
    importDefault(7128)(obj);
    if (tmp) {
      const obj1 = { channel_is_nsfw: null };
      obj1[0] = tmp2;
      tmp17(4449).trackWithMetadata(tmp16.TEXT_IN_VOICE_OPENED, obj1);
      const tmp17Result = tmp17(4449);
    }
    const obj11 = require(4449) /* collectGuildAnalyticsMetadata */;
    tmp16 = constants;
    tmp17 = require;
  }
  if (null != selectedGuildId) {
    ...
    let obj5 = require(15669) /* collectGuildThemeAnalyticsMetadata */;
    ...
    require(6820) /* isClickstreamEnabled */.trackClickstream(constants.GUILD_VIEWED_CLICKSTREAM, obj5);
    const obj7 = require(6820) /* isClickstreamEnabled */;
    if (obj9.isFavoritesGuildId(selectedGuildId)) {
      const result = self.trackFavoritesGuildViewed();
    }
    obj9 = require(1865) /* getFavoritesAwareGuildName */;
  }
};
prototype["componentDidUpdate"] = function componentDidUpdate(voiceChannelId) {
  ...
  if (voiceChannelId.voiceChannelId !== voiceChannelId) {
    if (null != voiceChannelId.voiceChannelId) {
      ...
      obj[8] = id1;
      let obj2 = require(4449) /* collectGuildAnalyticsMetadata */;
  ...
  if (voiceChannelId.voiceChannelId !== voiceChannelId) {
    if (null != voiceChannelId) {
      ...
      let obj3 = require(4449) /* collectGuildAnalyticsMetadata */;
  ...
  if (voiceChannelId.videoEnabled !== videoEnabled) {
    if (null != voiceChannelId) {
      ...
      const merged6 = Object.assign(require(4449) /* collectGuildAnalyticsMetadata */.collectVoiceAnalyticsMetadata(voiceChannelId));
      obj4.track(constants.VIDEO_INPUT_TOGGLED, obj1);
      const tmp31 = require;
      const tmp31Result = require(4449) /* collectGuildAnalyticsMetadata */;
    }
  }
  ...
  if (!tmp41) {
    obj2 = {};
    let obj8 = require(15670) /* getChannelOpenedRouteTrackingProps */;
    const merged7 = Object.assign(obj8.getChannelOpenedRouteTrackingProps(selectedChannelId));
    let obj9 = require(4449) /* collectGuildAnalyticsMetadata */;
    ...
    importDefault(7128)(obj3);
    if (isTextInVoice) {
      obj4 = { channel_is_nsfw: null };
      obj4[0] = isNSFWChannel;
      tmp44(4449).trackWithMetadata(tmp43.TEXT_IN_VOICE_OPENED, obj4);
      const tmp44Result = tmp44(4449);
    }
    tmp43 = constants;
    tmp44 = require;
  }
  ...
  if (isTextInVoice) {
    ...
    require(4449) /* collectGuildAnalyticsMetadata */.trackWithMetadata(constants.TEXT_IN_VOICE_OPENED, obj5);
    const obj14 = require(4449) /* collectGuildAnalyticsMetadata */;
  }
  if (null != selectedGuildId) {
    if (voiceChannelId.selectedGuildId !== selectedGuildId) {
      ...
      const merged10 = Object.assign(require(15669) /* collectGuildThemeAnalyticsMetadata */.collectGuildThemeAnalyticsMetadata(selectedGuildId));
      self._trackWithMetadata(constants.GUILD_VIEWED, obj8);
      const obj19 = require(15669) /* collectGuildThemeAnalyticsMetadata */;
      obj9 = { guild_id: null };
      obj9[0] = selectedGuildId;
      require(6820) /* isClickstreamEnabled */.trackClickstream(constants.GUILD_VIEWED_CLICKSTREAM, obj9);
      const obj20 = require(6820) /* isClickstreamEnabled */;
      if (obj22.isFavoritesGuildId(selectedGuildId)) {
        const result = self.trackFavoritesGuildViewed();
      }
      obj22 = require(1865) /* getFavoritesAwareGuildName */;
    }
  }
};
prototype["trackFavoritesGuildViewed"] = function trackFavoritesGuildViewed() {
  ...
  const result = require(9604) /* setNextFavoritesGuildViewSource */.trackFavoritesGuildViewed("manual_browsing", favoritesCount.getFavoritesCount(), obj.getFavoritesAccess().isExperimentEnabled, isPremiumExactlyResult);
};
...
prototype["_trackWithMetadata"] = function _trackWithMetadata(CHANNEL_OPENED, fileSizeLimitEventProperties) {
  ...
  if (this.props.connected) {
    require(4449) /* collectGuildAnalyticsMetadata */.trackWithMetadata(CHANNEL_OPENED, obj);
    const obj5 = require(4449) /* collectGuildAnalyticsMetadata */;
  } else {
