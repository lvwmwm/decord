...
// Dependencies: [19, 4298, 1375, 4960, 6894, 1377, 1372, 1942, 1862, 4332, 4376, 4356, 1931, 4102, 4962, 4480, 1874, 676, 1379, 1876, 21, 4479, 7154, 15688, 6835, 1865, 698, 1351, 15689, 9629, 1897, 9633, 589, 15690, 15691, 2]
// Exports: default

// Module 15687 (componentDidMount)
...
prototype["componentDidMount"] = function componentDidMount() {
  ...
  if (null != selectedGuildId) {
    ...
    require(6835) /* isClickstreamEnabled */.trackClickstream(constants.GUILD_VIEWED_CLICKSTREAM, obj5);
    const obj7 = require(6835) /* isClickstreamEnabled */;
...
prototype["componentDidUpdate"] = function componentDidUpdate(voiceChannelId) {
  ...
  if (null != selectedGuildId) {
    if (voiceChannelId.selectedGuildId !== selectedGuildId) {
      ...
      const obj20 = require(6835) /* isClickstreamEnabled */;
...
prototype["trackFavoritesGuildViewed"] = function trackFavoritesGuildViewed() {
  ...
  const result = require(9633) /* setNextFavoritesGuildViewSource */.trackFavoritesGuildViewed("manual_browsing", favoritesCount.getFavoritesCount(), obj.getFavoritesAccess().isExperimentEnabled, isPremiumExactlyResult);
};
