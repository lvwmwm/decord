...
prototype["componentDidMount"] = function componentDidMount() {
  ...
  if (null != selectedChannelId) {
    let obj = {};
    const merged = Object.assign(require(4539) /* collectGuildAnalyticsMetadata */.getChannelOpenedMetadata(selectedChannelId));
    obj.selected_guild_id = selectedGuildId;
    self._trackWithMetadata(constants.CHANNEL_OPENED, obj);
    obj = { channelId: null };
    obj[0] = selectedChannelId;
    importDefault(7279)(obj);
    if (tmp) {
      const obj1 = { channel_is_nsfw: null };
      obj1[0] = tmp2;
      tmp18(4539).trackWithMetadata(tmp17.TEXT_IN_VOICE_OPENED, obj1);
      const tmp18Result = tmp18(4539);
    }
    const obj11 = require(4539) /* collectGuildAnalyticsMetadata */;
    tmp17 = constants;
    tmp18 = require;
  }
...
prototype["componentDidUpdate"] = function componentDidUpdate(voiceChannelId) {
  ...
  if (voiceChannelId.voiceChannelId !== voiceChannelId) {
    if (null != voiceChannelId.voiceChannelId) {
      ...
      obj[8] = id1;
      let obj2 = require(4539) /* collectGuildAnalyticsMetadata */;
  ...
  if (voiceChannelId.voiceChannelId !== voiceChannelId) {
    if (null != voiceChannelId) {
      ...
      let obj3 = require(4539) /* collectGuildAnalyticsMetadata */;
  ...
  if (voiceChannelId.videoEnabled !== videoEnabled) {
    if (null != voiceChannelId) {
      ...
      const merged6 = Object.assign(require(4539) /* collectGuildAnalyticsMetadata */.collectVoiceAnalyticsMetadata(voiceChannelId));
      obj4.track(constants.VIDEO_INPUT_TOGGLED, obj1);
      const tmp31 = require;
      const tmp31Result = require(4539) /* collectGuildAnalyticsMetadata */;
    }
  }
  ...
  if (!tmp41) {
    ...
    importDefault(7279)(obj3);
    if (isTextInVoice) {
      obj4 = { channel_is_nsfw: null };
      obj4[0] = isNSFWChannel;
      tmp44(4539).trackWithMetadata(tmp43.TEXT_IN_VOICE_OPENED, obj4);
      const tmp44Result = tmp44(4539);
    }
    tmp43 = constants;
    tmp44 = require;
  }
  ...
  if (isTextInVoice) {
    ...
    require(4539) /* collectGuildAnalyticsMetadata */.trackWithMetadata(constants.TEXT_IN_VOICE_OPENED, obj5);
    const obj14 = require(4539) /* collectGuildAnalyticsMetadata */;
  }
  if (null != selectedGuildId) {
...
prototype["_trackWithMetadata"] = function _trackWithMetadata(CHANNEL_OPENED, fileSizeLimitEventProperties) {
  ...
  if (this.props.connected) {
    require(4539) /* collectGuildAnalyticsMetadata */.trackWithMetadata(CHANNEL_OPENED, obj);
