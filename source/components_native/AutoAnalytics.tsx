...
// Dependencies: [19, 4298, 1375, 4975, 6906, 1377, 1372, 1971, 1891, 4332, 4376, 4356, 1960, 4101, 4977, 4480, 1903, 676, 1379, 1905, 21, 4479, 7155, 15709, 6847, 1894, 698, 1351, 15710, 9629, 1926, 9635, 589, 15711, 15712, 2]
// Exports: default

// Module 15708 (componentDidMount)
...
prototype["componentDidMount"] = function componentDidMount() {
  ...
  if (null != selectedChannelId) {
    let obj = {};
    const merged = Object.assign(require(4479) /* collectGuildAnalyticsMetadata */.getChannelOpenedMetadata(selectedChannelId));
    obj.selected_guild_id = selectedGuildId;
    self._trackWithMetadata(constants.CHANNEL_OPENED, obj);
    obj = { channelId: null };
    obj[0] = selectedChannelId;
    importDefault(7155)(obj);
    if (tmp) {
      const obj1 = { channel_is_nsfw: null };
      obj1[0] = tmp2;
      tmp17(4479).trackWithMetadata(tmp16.TEXT_IN_VOICE_OPENED, obj1);
      const tmp17Result = tmp17(4479);
    }
    const obj11 = require(4479) /* collectGuildAnalyticsMetadata */;
    tmp16 = constants;
    tmp17 = require;
  }
  if (null != selectedGuildId) {
    ...
    let obj5 = require(15709) /* collectGuildThemeAnalyticsMetadata */;
    ...
    require(6847) /* isClickstreamEnabled */.trackClickstream(constants.GUILD_VIEWED_CLICKSTREAM, obj5);
    const obj7 = require(6847) /* isClickstreamEnabled */;
...
prototype["componentDidUpdate"] = function componentDidUpdate(voiceChannelId) {
  ...
  if (voiceChannelId.voiceChannelId !== voiceChannelId) {
    if (null != voiceChannelId.voiceChannelId) {
      ...
      obj[8] = id1;
      let obj2 = require(4479) /* collectGuildAnalyticsMetadata */;
  ...
  if (voiceChannelId.voiceChannelId !== voiceChannelId) {
    if (null != voiceChannelId) {
      ...
      let obj3 = require(4479) /* collectGuildAnalyticsMetadata */;
  ...
  if (voiceChannelId.videoEnabled !== videoEnabled) {
    if (null != voiceChannelId) {
      ...
      const merged6 = Object.assign(require(4479) /* collectGuildAnalyticsMetadata */.collectVoiceAnalyticsMetadata(voiceChannelId));
      obj4.track(constants.VIDEO_INPUT_TOGGLED, obj1);
      const tmp31 = require;
      const tmp31Result = require(4479) /* collectGuildAnalyticsMetadata */;
    }
  }
  ...
  if (!tmp41) {
    obj2 = {};
    let obj8 = require(15710) /* getChannelOpenedRouteTrackingProps */;
    ...
    importDefault(7155)(obj3);
    if (isTextInVoice) {
      obj4 = { channel_is_nsfw: null };
      obj4[0] = isNSFWChannel;
      tmp44(4479).trackWithMetadata(tmp43.TEXT_IN_VOICE_OPENED, obj4);
      const tmp44Result = tmp44(4479);
    }
    tmp43 = constants;
    tmp44 = require;
  }
  ...
  if (isTextInVoice) {
    ...
    require(4479) /* collectGuildAnalyticsMetadata */.trackWithMetadata(constants.TEXT_IN_VOICE_OPENED, obj5);
    const obj14 = require(4479) /* collectGuildAnalyticsMetadata */;
  }
  if (null != selectedGuildId) {
    if (voiceChannelId.selectedGuildId !== selectedGuildId) {
      ...
      const merged10 = Object.assign(require(15709) /* collectGuildThemeAnalyticsMetadata */.collectGuildThemeAnalyticsMetadata(selectedGuildId));
      self._trackWithMetadata(constants.GUILD_VIEWED, obj8);
      const obj19 = require(15709) /* collectGuildThemeAnalyticsMetadata */;
      obj9 = { guild_id: null };
      obj9[0] = selectedGuildId;
      require(6847) /* isClickstreamEnabled */.trackClickstream(constants.GUILD_VIEWED_CLICKSTREAM, obj9);
      const obj20 = require(6847) /* isClickstreamEnabled */;
...
prototype["trackFavoritesGuildViewed"] = function trackFavoritesGuildViewed() {
  ...
  const result = require(9635) /* setNextFavoritesGuildViewSource */.trackFavoritesGuildViewed("manual_browsing", favoritesCount.getFavoritesCount(), obj.getFavoritesAccess().isExperimentEnabled, isPremiumExactlyResult);
};
...
prototype["_trackWithMetadata"] = function _trackWithMetadata(CHANNEL_OPENED, fileSizeLimitEventProperties) {
  ...
  if (this.props.connected) {
    require(4479) /* collectGuildAnalyticsMetadata */.trackWithMetadata(CHANNEL_OPENED, obj);
    const obj5 = require(4479) /* collectGuildAnalyticsMetadata */;
  } else {
