...
// Function ID: 10720
// Name: VolumeSlider
// Dependencies: [19, 17, 4315, 21, 500, 4255, 712, 3959, 10720, 7771, 4702, 1236, 4780, 2]
// Exports: default

// Module 10719 (VolumeSlider)
import "noop";
...
export default function VolumeSlider(maxTrackTintColor) {
  ...
  const items1 = [callback(require(10720) /* VoiceXIcon */.VoiceXIcon, obj), , ];
  ...
  items1[1] = callback(importDefault(7771), obj1);
  items1[2] = callback(require(4780) /* VoiceNormalIcon */.VoiceNormalIcon, { style: tmp4.rightIcon });
  obj[1] = items1;
