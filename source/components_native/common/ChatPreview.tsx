...
// Dependencies: [19, 17, 4295, 4013, 1391, 1922, 8044, 21, 4303, 712, 4031, 8614, 8043, 8616, 11364, 3990, 1236, 11019, 11013, 12, 4311, 11083, 11062, 11025, 4531, 1891, 11125, 11150, 8619, 7224, 11024, 11026, 11061, 10963, 12025, 11298, 500, 5328, 4846, 4299, 3993, 589, 1493, 5946, 4517, 2]
// Exports: ChatPreview

// Module 8613 (componentDidMount)
...
prototype["render"] = function render() {
  ...
  if (props.isNSFWHidden) {
    ...
    if (null != guild_id) {
      ...
      let tmp14 = callback(importDefault(10963), obj);
    }
  ...
  if (isSpoilerHidden) {
    ...
    if (null != guild_id1) {
      ...
      tmp14 = callback(importDefault(12025), obj1);
    }
  }
  ...
  obj[11] = prop;
  const tmp8 = importDefault(11298);
  let prop1;
  if (!tmp9Result.isIOS()) {
  ...
  obj3[3] = callback(require(4299) /* Text */.Text, { style: tmp.jumpToChatText, variant: "text-md/medium", color: "interactive-text-default", children: self.props.jumpToChatProps.jumpToChatText });
  obj2[2] = callback(require(4846) /* PressableBase */.PressableOpacity, obj3);
  tmp6Result = tmp6(tmp9(5328).SafeAreaPaddingView, obj2);
  tmp14 = tmp6Result;
};
