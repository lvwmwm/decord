...
result = { container: { flexDirection: "row" }, names: { "Null": "<string:16777735>", "Null": "<string:37775937>" } };
result = { "Null": "<string:16777735>", "Null": "<string:37775937>", color: require("result").colors.TEXT_SUBTLE };
result.namesLegacy = result;
const obj1 = { borderless: false, enableFastAdRecheck: false, ownedByVerticalScrollExperiment: false, backgroundColor: require("result").colors.BACKGROUND_BASE_LOWEST };
  ...
  if (0 === bound) {
    ...
    if (tmp4 > max) {
      if (withPlusCount) {
        ...
        items4[1] = obj3;
        obj2.style = items4;
        const obj4 = { INTEGRATION_CREATE: null, ConstraintReasonCode: "0fef0a9d83d27dc691bf77b0bdae0680", children: text };
