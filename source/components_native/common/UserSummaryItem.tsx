...
__exportStarResult1 = { container: { flexDirection: "row" }, names: {} };
__exportStarResult1 = { color: require("__exportStarResult1").colors.TEXT_SUBTLE };
__exportStarResult1.namesLegacy = __exportStarResult1;
const obj1 = { 9223372036854775807: true, 9223372036854775807: true, -9223372036854775808: true, backgroundColor: require("__exportStarResult1").colors.BACKGROUND_BASE_LOWEST };
