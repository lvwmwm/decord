...
// Function ID: 9708
// Name: ActionButton
// Dependencies: [19, 17, 21, 4760, 7796, 2]
// Exports: default

// Module 9707 (ActionButton)
import "noop";
...
export default function ActionButton(style) {
  ...
  obj[3] = str;
  obj[1] = jsx(require(7796) /* IconButton */.IconButton, { icon: null, onPress: null, accessibilityLabel: null, variant: null, size: "sm" });
