...
// Function ID: 9594
// Name: ActionButton
// Dependencies: [19, 17, 21, 4717, 7691, 2]
// Exports: default

// Module 9593 (ActionButton)
import "noop";
...
export default function ActionButton(style) {
  ...
  obj[3] = str;
  obj[1] = jsx(require(7691) /* IconButton */.IconButton, { icon: null, onPress: null, accessibilityLabel: null, variant: null, size: "sm" });
