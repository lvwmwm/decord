...
// Function ID: 16018
// Name: renderLabel
// Dependencies: [109, 19, 17, 21, 4342, 712, 4072, 1297, 4338, 9741, 1363, 2]

// Module 16017 (renderLabel)
...
prototype["renderIcon"] = function renderIcon() {
  ...
  if (null != iconProps) {
    ...
    const items = [callback2(importDefault(9741), obj), ];
    ...
    if (null == source) {
      obj = require(1363) /* AccessibilityAnnouncer */;
