...
prototype["renderHeader"] = function renderHeader() {
  ...
  if (null != title) {
    ...
    if ("" !== title) {
      ...
      const items = [closure_7(require(4299) /* Text */.Text, obj), ];
      obj = { style: null };
      obj[0] = tmp.divider;
...
prototype["renderBody"] = function renderBody() {
  ...
  if (null != body) {
    ...
    obj[1] = closure_7(require(4299) /* Text */.Text, obj);
...
prototype["renderButtons"] = function renderButtons() {
  ...
  if (!props.noDefaultButtons) {
    ...
    if (null != cancelText) {
      ...
      obj[2] = cancelText;
      obj[1] = callback(require(4714) /* Button */.Button, obj);
    ...
    if (null != secondaryConfirmText) {
      ...
      obj[3] = callback(require(4299) /* Text */.Text, obj1);
      tmp11 = callback(require(4846) /* PressableBase */.PressableOpacity, obj);
    }
    ...
    if (renderConfirmButtonResult == null) {
      ...
      obj3[6] = str2;
      renderConfirmButtonResult = callback(require(4714) /* Button */.Button, obj3);
