...
// Function ID: 9742
// Name: IconUploader
// Dependencies: [5, 19, 17, 676, 21, 4342, 4923, 5840, 1435, 9742, 4909, 1236, 2]
// Exports: default

// Module 9741 (IconUploader)
...
export default function IconUploader(disabled) {
  ...
  if ("guild" === str) {
    if (!tmp8) {
      ...
      obj[1] = fnResult;
      obj[2] = name;
      obj[3] = require(5840) /* GuildIconSizes */.GuildIconSizes.XLARGE;
      let tmp7 = callback(importDefault(5840), obj);
  ...
  if (!flag) {
    ...
    obj3[3] = tmp14Result;
    obj2[1] = callback(require(4909) /* PressableBase */.PressableOpacity, obj3);
