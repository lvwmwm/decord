...
// Function ID: 10340
// Name: IconUploader
// Dependencies: [5, 19, 17, 676, 21, 4255, 4797, 5632, 1416, 10340, 4783, 1236, 2]
// Exports: default

// Module 10339 (IconUploader)
...
export default function IconUploader(disabled) {
  ...
  if ("guild" === str) {
    if (!tmp8) {
      ...
      obj[1] = fnResult;
      obj[2] = name;
      obj[3] = require(5632) /* GuildIconSizes */.GuildIconSizes.XLARGE;
      let tmp7 = callback(importDefault(5632), obj);
  ...
  if (!flag) {
    ...
    obj3[3] = tmp14Result;
    obj2[1] = callback(require(4783) /* PressableBase */.PressableOpacity, obj3);
