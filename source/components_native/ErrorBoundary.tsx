...
// Dependencies: [5, 32, 19, 17, 10325, 21, 4285, 589, 11104, 4695, 1236, 3996, 1208, 709, 1297, 9005, 4281, 2]

// Module 13750 (MaybeClearBuildOverride)
...
prototype["render"] = function render() {
  ...
  if (null !== error) {
    ...
    obj[0] = require(9005) /* getAppCrashSource */.AppCrash;
