...
// Dependencies: [5, 32, 19, 17, 10341, 21, 4302, 589, 11119, 4712, 1236, 4013, 1208, 709, 1297, 9022, 4298, 2]

// Module 13764 (MaybeClearBuildOverride)
...
function MaybeClearBuildOverride() {
  ...
  if (null == obj.useStateFromStores(items, () => {
    ...
    return callback2(tmp2(4712).Button, obj);
  }
}
...
prototype["render"] = function render() {
  ...
  if (null !== error) {
    ...
    obj[0] = require(9022) /* getAppCrashSource */.AppCrash;
    ...
    obj[3] = str;
    const items = [closure_9(require(4298) /* Text */.Text, obj), , ];
    ...
    items1[1] = closure_9(require(4712) /* Button */.Button, obj1);
    obj[1] = items1;
