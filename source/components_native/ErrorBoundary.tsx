...
// Dependencies: [5, 32, 19, 17, 10368, 21, 4342, 589, 11236, 4755, 1236, 4072, 1208, 709, 1297, 9132, 4338, 2]

// Module 13902 (MaybeClearBuildOverride)
...
function MaybeClearBuildOverride() {
  ...
  if (null == obj.useStateFromStores(items, () => {
    ...
    return callback2(tmp2(4755).Button, obj);
  }
}
...
prototype["render"] = function render() {
  ...
  if (null !== error) {
    ...
    obj[0] = require(9132) /* getAppCrashSource */.AppCrash;
    ...
    items1[1] = closure_9(require(4755) /* Button */.Button, obj1);
    obj[1] = items1;
