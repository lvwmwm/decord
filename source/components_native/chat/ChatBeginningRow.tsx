...
// Dependencies: [32, 5, 19, 17, 4247, 1371, 5789, 8916, 5203, 6974, 1376, 1415, 1372, 1932, 1942, 1862, 3883, 3892, 4450, 1874, 676, 1379, 11714, 11688, 10250, 21, 4255, 712, 4751, 1236, 4753, 4758, 4760, 4651, 4251, 3952, 3959, 4797, 10958, 1297, 11715, 7798, 9562, 589, 4094, 7852, 4119, 4445, 8891, 5787, 9889, 4191, 4245, 11716, 11717, 38, 11, 11719, 3955, 8915, 4811, 11723, 6031, 8959, 6401, 1945, 11832, 11835, 7802, 4265, 4665, 11839, 4595, 11840, 5603, 10510, 698, 9619, 7840, 5215, 5210, 3956, 4223, 11842, 1959, 5595, 11843, 8090, 8677, 5623, 11844, 8683, 5851, 4460, 11859, 5646, 9133, 9522, 11861, 10251, 11868, 7752, 4106, 7651, 4071, 1358, 10952, 5737, 9553, 9608, 4199, 11872, 11876, 2]
// Exports: default

// Module 11713 (ChatBeginningRowIcon)
...
function ChatBeginningRowIcon(arg0) {
  ...
  if (isForumPost) {
    obj[0] = tmp2(4751).ChatIcon;
    obj[1] = tmp2(1236).t.Y4REmB;
    let tmp5 = tmp2;
    let tmp6 = obj;
  } else if (isThread) {
    obj[0] = tmp2(4753).ThreadIcon;
    obj[1] = tmp2(1236).t["7Xm5QI"];
    tmp5 = tmp2;
    tmp6 = obj;
  } else if (isPrivate) {
    obj[0] = tmp2(4758).TextLockIcon;
    obj[1] = tmp2(1236).t.GK18KJ;
    tmp5 = tmp2;
    tmp6 = obj;
  } else {
    obj[0] = tmp2(4760).TextIcon;
    obj[1] = tmp2(1236).t.GK18KJ;
    tmp5 = tmp2;
    tmp6 = obj;
  }
...
function ChatBeginningRowHeader(arg0) {
  ...
  children[1] = callback2(subtitleLink(4251).Text, { style: items1, accessibilityRole: "header", variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", children: title });
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    items1[1] = callback2(tmp2(4251).Text, obj2);
    obj[3] = items1;
    isPrivate = tmp6(tmp2(4797).PressableOpacity, obj);
  }
  ...
  if (canEdit) {
    ...
    obj4[1] = token;
    const items5 = [callback2(tmp2(9562).PencilIcon, obj4), ];
    ...
    items5[1] = callback2(tmp2(4251).Text, obj5);
    obj3[3] = items5;
    canEdit = tmp6(tmp2(4797).PressableOpacity, obj3);
  }
  items3[1] = canEdit;
  obj[1] = items3;
...
function ThreadOwner(arg0) {
  ...
  if ("username" === stateFromStores2) {
    ...
    obj[2] = tmp16;
    obj[5] = str;
    return callback2(tmp2(4251).Text, obj);
  } else {
    ...
    obj3[2] = str;
    items3[1] = callback2(tmp2(4251).Text, obj3);
    obj2[0] = items3;
...
function ChatBeginningRowThread(channel) {
  ...
  if (null != channel.threadMetadata) {
    ...
    if (!isForumPostResult) {
      ...
      tmp11Result = tmp11(tmp4(4251).Text, obj1);
    }
    items[2] = tmp11Result;
    ...
    if (channel.isForumPost()) {
      ...
      if (null == tmp7) {
        ...
        tmp11Result1 = tmp11(tmp4(4251).Text, obj3);
      }
    }
...
function ChatBeginningRowGuildNonDefaultChannel(channel) {
  ...
  const tmp10 = importDefault(4191)();
  ...
  if (result) {
    ...
    if (canResult) {
      ...
      tmp15Result = callback2(tmp(11716), obj2);
    }
  }
...
function DMSpamButton(channel) {
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return callback2(tmp(4665).Button, obj);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      tmp4 = callback2(tmp2(4665).Button, obj);
    }
  }
  return tmp4;
}
...
function ChatBeginningRowDM(channel) {
  ...
  const tmp = createCacheKey();
  dependencyMap = tmp;
  analyticsLocations = user(5595)().analyticsLocations;
  let id;
  if (user != null) {
    id = user.id;
  }
  ...
  if (null == user) {
    ...
    const items5 = [callback2(tmp7(4797).PressableOpacity, obj1), , , , , , ];
    ...
    obj4[2] = name;
    obj3[3] = callback2(tmp7(4251).Text, obj4);
    items5[1] = callback2(tmp7(4797).PressableOpacity, obj3);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      obj6[2] = userTag;
      obj5[3] = tmp15(tmp7(4251).Text, obj6);
      tmp15Result = tmp15(tmp7(4797).PressableOpacity, obj5);
    }
    ...
    obj7[3] = stringResult;
    items5[3] = callback2(tmp7(4251).Text, obj7);
    tmp15Result = null;
    if (user.isProvisional) {
      let obj8 = { style: null, userId: null, iconSize: 14 };
      obj8[0] = tmp.provisionalAccountExplainer;
      obj8[1] = user.id;
      tmp15Result = tmp15(tmp7(11868).ChatProvisionalAccountExplainerCard, obj8);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
        ...
        function handleOpenMutualGuilds() {
          if (null != user) {
            ...
            obj[1] = function onPressMutualGuild(arg0) {
              ...
              callback2(4460).popWithKey(closure_40);
            };
        ...
        obj10[0] = tmp7(5646).GuildIconSizes.SMALL;
        ...
        const items6 = [tmp15(tmp7(11859).GuildIconPile, obj10), ];
        ...
        items6[1] = tmp15(tmp7(4251).Text, obj11);
        obj9[3] = items6;
        tmp18Result = tmp18(tmp7(4797).PressableOpacity, obj9);
      }
    }
...
function ChatBeginningRowButton(style) {
  ...
  obj[1] = callback2(require(7752) /* RowButtonWrapper */.RowButton.Icon, { IconComponent, variant: iconVariant });
  obj[2] = title;
  obj[3] = subtitle;
  obj[4] = trailing;
  obj[1] = callback2(require(7752) /* RowButtonWrapper */.RowButton, obj);
  return callback2(closure_7, obj);
}
function ChatBeginningRowGroupDM(channel) {
  ...
  const items5 = [callback2(first(9553), obj), , , ];
  ...
  const tmp17 = channel.id === channel(5737).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
  obj1[1] = str;
  obj1[3] = arr;
  items5[1] = callback2(channel(4251).Text, obj1);
  ...
  obj2[3] = formatResult;
  items5[2] = callback2(channel(4251).Text, obj2);
  ...
  if (!tmp17) {
    ...
    if (stateFromStores) {
      ...
      obj4[1] = callback2;
      obj4[2] = tmp7(9608).GroupPlusIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      obj6[0] = channel.id;
      tmp15Result1 = tmp15(first(11872), obj6);
    }
          ...
          try {
            ...
            if (0 === dependencyMap) {
              if (arg0 === 1) {
                ...
                let base64 = tmp2;
                base64 = undefined;
                outer1_1(8915).init(dependencyMap);
                const obj7 = outer1_1(8915);
                let obj1 = { size: null };
                obj1[0] = outer1_35;
                dependencyMap = 1;
                c3 = 1;
...
export default function ChatBeginningRow(channelId) {
  ...
  if (!shouldRender) {
    ...
    obj[1] = tmp19Result;
    return callback2(importDefault(11876), obj);
