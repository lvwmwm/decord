...
// Dependencies: [32, 5, 19, 17, 4295, 1390, 5895, 9028, 5250, 7083, 1395, 1434, 1391, 1980, 1990, 1910, 3948, 3957, 4499, 1922, 676, 1398, 11833, 11807, 10369, 21, 4303, 712, 4800, 1236, 4802, 4807, 4809, 4700, 4299, 4017, 4024, 4846, 11077, 1297, 11834, 8018, 9677, 589, 4148, 8072, 4045, 4494, 9003, 5893, 10008, 4239, 4293, 11835, 11836, 38, 11, 11838, 4020, 9027, 4860, 11842, 6139, 9071, 6509, 1993, 11951, 11954, 8022, 4313, 4714, 11958, 4644, 11959, 5736, 10606, 698, 9737, 8060, 5262, 5257, 4021, 4271, 11961, 2007, 5728, 11962, 8313, 8789, 5756, 11963, 8795, 5959, 4509, 11978, 5779, 9249, 9637, 11980, 10370, 11987, 7972, 4158, 7760, 4125, 1377, 11071, 5843, 9668, 9726, 4247, 11991, 11995, 2]
// Exports: default

// Module 11832 (ChatBeginningRowIcon)
...
function ChatBeginningRowIcon(arg0) {
  ...
  if (isForumPost) {
    obj[0] = tmp2(4800).ChatIcon;
    obj[1] = tmp2(1236).t.Y4REmB;
    let tmp5 = tmp2;
    let tmp6 = obj;
  } else if (isThread) {
    obj[0] = tmp2(4802).ThreadIcon;
    obj[1] = tmp2(1236).t["7Xm5QI"];
    tmp5 = tmp2;
    tmp6 = obj;
  } else if (isPrivate) {
    obj[0] = tmp2(4807).TextLockIcon;
    obj[1] = tmp2(1236).t.GK18KJ;
    tmp5 = tmp2;
    tmp6 = obj;
  } else {
    obj[0] = tmp2(4809).TextIcon;
    obj[1] = tmp2(1236).t.GK18KJ;
    tmp5 = tmp2;
    tmp6 = obj;
  }
...
function ChatBeginningRowHeader(arg0) {
  ...
  children[1] = callback2(subtitleLink(4299).Text, { style: items1, accessibilityRole: "header", variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", children: title });
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    items1[1] = callback2(tmp2(4299).Text, obj2);
    obj[3] = items1;
    isPrivate = tmp6(tmp2(4846).PressableOpacity, obj);
  }
  ...
  if (canEdit) {
    ...
    items5[1] = callback2(tmp2(4299).Text, obj5);
    obj3[3] = items5;
    canEdit = tmp6(tmp2(4846).PressableOpacity, obj3);
  }
  items3[1] = canEdit;
  obj[1] = items3;
...
function ThreadOwner(arg0) {
  ...
  if ("username" === stateFromStores2) {
    ...
    obj[2] = tmp16;
    obj[5] = str;
    return callback2(tmp2(4299).Text, obj);
  } else {
    ...
    obj3[2] = str;
    items3[1] = callback2(tmp2(4299).Text, obj3);
    obj2[0] = items3;
...
function ChatBeginningRowThread(channel) {
  ...
  if (null != channel.threadMetadata) {
    ...
    if (!isForumPostResult) {
      ...
      tmp11Result = tmp11(tmp4(4299).Text, obj1);
    }
    items[2] = tmp11Result;
    ...
    if (channel.isForumPost()) {
      ...
      if (null == tmp7) {
        ...
        tmp11Result1 = tmp11(tmp4(4299).Text, obj3);
      }
    }
...
function ChatBeginningRowGuildNonDefaultChannel(channel) {
  ...
  const tmp10 = importDefault(4239)();
...
function DMSpamButton(channel) {
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return callback2(tmp(4714).Button, obj);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      tmp4 = callback2(tmp2(4714).Button, obj);
    }
  }
  return tmp4;
}
...
function ChatBeginningRowDM(channel) {
  ...
  const tmp = createCacheKey();
  dependencyMap = tmp;
  analyticsLocations = user(5728)().analyticsLocations;
  let id;
  if (user != null) {
    id = user.id;
  }
  ...
  if (null == user) {
    ...
    const items5 = [callback2(tmp7(4846).PressableOpacity, obj1), , , , , , ];
    ...
    obj4[2] = name;
    obj3[3] = callback2(tmp7(4299).Text, obj4);
    items5[1] = callback2(tmp7(4846).PressableOpacity, obj3);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      obj6[2] = userTag;
      obj5[3] = tmp15(tmp7(4299).Text, obj6);
      tmp15Result = tmp15(tmp7(4846).PressableOpacity, obj5);
    }
    ...
    obj7[3] = stringResult;
    items5[3] = callback2(tmp7(4299).Text, obj7);
    tmp15Result = null;
    if (user.isProvisional) {
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
        ...
        obj10[0] = tmp7(5779).GuildIconSizes.SMALL;
        ...
        items6[1] = tmp15(tmp7(4299).Text, obj11);
        obj9[3] = items6;
        tmp18Result = tmp18(tmp7(4846).PressableOpacity, obj9);
      }
    }
...
function ChatBeginningRowButton(style) {
  ...
  obj[1] = callback2(require(7972) /* RowButtonWrapper */.RowButton.Icon, { IconComponent, variant: iconVariant });
  obj[2] = title;
  obj[3] = subtitle;
  obj[4] = trailing;
  obj[1] = callback2(require(7972) /* RowButtonWrapper */.RowButton, obj);
  return callback2(closure_7, obj);
}
function ChatBeginningRowGroupDM(channel) {
  ...
  const tmp17 = channel.id === channel(5843).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
  obj1[1] = str;
  obj1[3] = arr;
  items5[1] = callback2(channel(4299).Text, obj1);
  ...
  obj2[3] = formatResult;
  items5[2] = callback2(channel(4299).Text, obj2);
...
export default function ChatBeginningRow(channelId) {
  ...
  if (!shouldRender) {
    ...
    obj[1] = tmp19Result;
    return callback2(importDefault(11995), obj);
