...
// Dependencies: [32, 5, 19, 17, 4470, 1386, 6124, 9729, 5475, 7366, 1391, 1430, 1387, 1982, 1992, 1909, 4121, 4130, 4701, 1922, 676, 1394, 12033, 12007, 9056, 21, 4478, 712, 5020, 1236, 5022, 5027, 5029, 4915, 4474, 4190, 4197, 5068, 11196, 1297, 12034, 8752, 10327, 589, 4322, 7870, 4674, 9707, 6122, 6119, 10422, 4413, 4468, 12035, 12036, 38, 11, 12038, 4193, 9728, 5082, 12042, 6374, 9909, 6786, 1995, 12153, 12156, 8756, 4491, 4928, 12160, 4859, 12161, 5961, 9453, 698, 10239, 7858, 5487, 5482, 4194, 4445, 12163, 2009, 5953, 12164, 8115, 8896, 5981, 9232, 8559, 6186, 4723, 9270, 6004, 9059, 9075, 9071, 9069, 12165, 8365, 4332, 8649, 4298, 1373, 11192, 6068, 10648, 10115, 4421, 12169, 12173, 2]
// Exports: default

// Module 12032 (ChatBeginningRowIcon)
...
import ChannelAccessInfoDefault from "ChannelAccessInfo" /* 12035 */;
import registerAssetDefault2 from "registerAsset" /* 12160 */;
import PortalAccessibilityWorkaroundViewDefault from "PortalAccessibilityWorkaroundView" /* 12173 */;
...
import closure_12 from "recomputeFromAppTokens" /* 5475 */;
import { FetchState } from "recomputeFromAppTokens" /* 5475 */;
import closure_14 from "createUserWidgetFromServer" /* 7366 */;
...
import closure_21 from "getUncachedChannelPermissions" /* 4121 */;
...
import { MOBILE_MESSAGE_REQUESTS_MODAL_KEY as closure_40 } from "MESSAGE_REQUEST_ACCEPT_CONFIRMATION_MODAL" /* 12007 */;
import { BLOCK_CONFIRMATION_ACTION_SHEET_KEY as closure_41 } from "IGNORE_CONFIRMATION_ACTION_SHEET_KEY" /* 9056 */;
...
function ChatBeginningRowIcon(arg0) {
  ...
  if (isForumPost) {
    obj[0] = tmp2(5020).ChatIcon;
    obj[1] = tmp2(1236).t.Y4REmB;
    let tmp5 = tmp2;
    let tmp6 = obj;
  } else if (isThread) {
    obj[0] = tmp2(5022).ThreadIcon;
    obj[1] = tmp2(1236).t["7Xm5QI"];
    tmp5 = tmp2;
    tmp6 = obj;
  } else if (isPrivate) {
    obj[0] = tmp2(5027).TextLockIcon;
    obj[1] = tmp2(1236).t.GK18KJ;
    tmp5 = tmp2;
    tmp6 = obj;
  } else {
    obj[0] = tmp2(5029).TextIcon;
    obj[1] = tmp2(1236).t.GK18KJ;
    tmp5 = tmp2;
    tmp6 = obj;
  }
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    obj[3] = items1;
    isPrivate = tmp6(tmp2(5068).PressableOpacity, obj);
  }
  ...
  if (canEdit) {
    ...
    obj4[1] = token;
    const items5 = [callback2(tmp2(10327).PencilIcon, obj4), ];
    ...
    obj3[3] = items5;
    canEdit = tmp6(tmp2(5068).PressableOpacity, obj3);
  }
  items3[1] = canEdit;
  obj[1] = items3;
...
function DMSpamButton(channel) {
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return callback2(tmp(4928).Button, obj);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      tmp4 = callback2(tmp2(4928).Button, obj);
    }
  }
  return tmp4;
}
...
function ChatBeginningRowDM(channel) {
  ...
  const tmp = callback3();
  dependencyMap = tmp;
  analyticsLocations = user(5953)().analyticsLocations;
  let id;
  if (user != null) {
    id = user.id;
  }
  ...
  if (null == user) {
    ...
    const items5 = [callback2(tmp7(5068).PressableOpacity, obj1), , , , , , ];
    ...
    items5[1] = callback2(tmp7(5068).PressableOpacity, obj3);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      tmp15Result = tmp15(tmp7(5068).PressableOpacity, obj5);
    }
    ...
    if (user.isProvisional) {
      ...
      obj8[1] = user.id;
      tmp15Result = tmp15(tmp7(12165).ChatProvisionalAccountExplainerCard, obj8);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
        ...
        function handleOpenMutualGuilds() {
          if (null != user) {
            ...
            obj[1] = function onPressMutualGuild(arg0) {
              ...
              callback2(4723).popWithKey(closure_40);
            };
        ...
        obj10[0] = tmp7(6004).GuildIconSizes.SMALL;
        ...
        const items6 = [tmp15(tmp7(9270).GuildIconPile, obj10), ];
        ...
        obj9[3] = items6;
        tmp18Result = tmp18(tmp7(5068).PressableOpacity, obj9);
      }
    }
...
function ChatBeginningRowGroupDM(channel) {
  ...
  const items5 = [callback2(first(10648), obj), , , ];
  ...
  const tmp17 = channel.id === channel(6068).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
  obj1[1] = str;
  obj1[3] = arr;
  ...
  if (!tmp17) {
    ...
    if (stateFromStores) {
      ...
      obj4[1] = callback2;
      obj4[2] = tmp7(10115).GroupPlusIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      obj6[0] = channel.id;
      tmp15Result1 = tmp15(first(12169), obj6);
    }
          ...
          try {
            ...
            if (0 === dependencyMap) {
              if (arg0 === 1) {
                ...
                let base64 = tmp2;
                base64 = undefined;
                closure_1_1(9728).init(dependencyMap);
                const obj7 = closure_1_1(9728);
                obj1 = { size: null };
                obj1[0] = closure_1_35;
                dependencyMap = 1;
                c3 = 1;
