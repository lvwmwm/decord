...
// Dependencies: [32, 5, 19, 17, 4662, 1390, 7239, 8875, 5289, 5365, 1395, 1434, 1391, 1980, 1990, 1910, 4021, 4030, 5043, 1922, 676, 1398, 11637, 11611, 10594, 21, 4661, 712, 6867, 1236, 6869, 6874, 6876, 4721, 4734, 4090, 4097, 5433, 10796, 1297, 11638, 8132, 9925, 589, 4219, 8186, 4984, 8850, 7237, 10263, 4310, 6807, 11639, 11641, 38, 11, 11643, 4093, 8874, 4838, 11647, 5559, 8918, 5931, 1993, 11758, 11761, 8136, 4770, 4745, 11765, 4657, 11766, 7147, 8713, 698, 10002, 8174, 6798, 6795, 4094, 4342, 11768, 2007, 7139, 11769, 8417, 8929, 7167, 11770, 8935, 7302, 5260, 11787, 7188, 9736, 9887, 11791, 10595, 11798, 8086, 4229, 8042, 4196, 1377, 10790, 5389, 9916, 9991, 4318, 11802, 11806, 2]
// Exports: default

// Module 11636 (ChatBeginningRowIcon)
...
function ChatBeginningRowIcon(arg0) {
  ...
  if (isForumPost) {
    obj[0] = tmp2(6867).ChatIcon;
    obj[1] = tmp2(1236).t.Y4REmB;
    let tmp5 = tmp2;
    let tmp6 = obj;
  } else if (isThread) {
    obj[0] = tmp2(6869).ThreadIcon;
    obj[1] = tmp2(1236).t["7Xm5QI"];
    tmp5 = tmp2;
    tmp6 = obj;
  } else if (isPrivate) {
    obj[0] = tmp2(6874).TextLockIcon;
    obj[1] = tmp2(1236).t.GK18KJ;
    tmp5 = tmp2;
    tmp6 = obj;
  } else {
    obj[0] = tmp2(6876).TextIcon;
    obj[1] = tmp2(1236).t.GK18KJ;
    tmp5 = tmp2;
    tmp6 = obj;
  }
...
function ChatBeginningRowHeader(arg0) {
  ...
  children[1] = callback2(subtitleLink(4734).Text, { style: items1, accessibilityRole: "header", variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", children: title });
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    items1[1] = callback2(tmp2(4734).Text, obj2);
    obj[3] = items1;
    isPrivate = tmp6(tmp2(5433).PressableOpacity, obj);
  }
  ...
  if (canEdit) {
    ...
    obj4[1] = token;
    const items5 = [callback2(tmp2(9925).PencilIcon, obj4), ];
    ...
    items5[1] = callback2(tmp2(4734).Text, obj5);
    obj3[3] = items5;
    canEdit = tmp6(tmp2(5433).PressableOpacity, obj3);
  }
  items3[1] = canEdit;
  obj[1] = items3;
...
function ThreadOwner(arg0) {
  ...
  if ("username" === stateFromStores2) {
    ...
    obj[1] = tmp16;
    obj[4] = str;
    return callback2(tmp2(4734).Text, obj);
  } else {
    ...
    obj3[2] = str;
    items3[1] = callback2(tmp2(4734).Text, obj3);
    obj2[0] = items3;
...
function ChatBeginningRowThread(channel) {
  ...
  if (null != channel.threadMetadata) {
    ...
    if (!isForumPostResult) {
      ...
      tmp11Result = tmp11(tmp4(4734).Text, obj1);
    }
    items[2] = tmp11Result;
    ...
    if (channel.isForumPost()) {
      ...
      if (null == tmp7) {
        ...
        tmp11Result1 = tmp11(tmp4(4734).Text, obj3);
      }
    }
...
function ChatBeginningRowGuildNonDefaultChannel(channel) {
  ...
  const tmp10 = importDefault(4310)();
  ...
  if (result) {
    ...
    if (canResult) {
      ...
      tmp15Result = callback2(tmp(11639), obj2);
    }
  }
...
function DMSpamButton(channel) {
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return callback2(tmp(4745).Button, obj);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      tmp4 = callback2(tmp2(4745).Button, obj);
    }
  }
  return tmp4;
}
...
function ChatBeginningRowDM(channel) {
  ...
  const tmp = createCacheKey();
  dependencyMap = tmp;
  analyticsLocations = user(7139)().analyticsLocations;
  let id;
  if (user != null) {
    id = user.id;
  }
  ...
  if (null == user) {
    ...
    const items5 = [callback2(tmp7(5433).PressableOpacity, obj1), , , , , , ];
    ...
    obj4[2] = name;
    obj3[3] = callback2(tmp7(4734).Text, obj4);
    items5[1] = callback2(tmp7(5433).PressableOpacity, obj3);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      obj6[2] = userTag;
      obj5[3] = tmp15(tmp7(4734).Text, obj6);
      tmp15Result = tmp15(tmp7(5433).PressableOpacity, obj5);
    }
    ...
    obj7[3] = stringResult;
    items5[3] = callback2(tmp7(4734).Text, obj7);
    tmp15Result = null;
    if (user.isProvisional) {
      let obj8 = { style: null, userId: null, iconSize: 14 };
      obj8[0] = tmp.provisionalAccountExplainer;
      obj8[1] = user.id;
      tmp15Result = tmp15(tmp7(11798).ChatProvisionalAccountExplainerCard, obj8);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
        ...
        function handleOpenMutualGuilds() {
          if (null != user) {
            ...
            obj[1] = function onPressMutualGuild(arg0) {
              ...
              callback2(5260).popWithKey(closure_40);
            };
        ...
        obj10[0] = tmp7(7188).GuildIconSizes.SMALL;
        ...
        const items6 = [tmp15(tmp7(11787).GuildIconPile, obj10), ];
        ...
        items6[1] = tmp15(tmp7(4734).Text, obj11);
        obj9[3] = items6;
        tmp18Result = tmp18(tmp7(5433).PressableOpacity, obj9);
      }
    }
...
function ChatBeginningRowButton(style) {
  ...
  obj[1] = callback2(require(8086) /* RowButtonWrapper */.RowButton.Icon, { IconComponent, variant: iconVariant });
  obj[2] = title;
  obj[3] = subtitle;
  obj[4] = trailing;
  obj[1] = callback2(require(8086) /* RowButtonWrapper */.RowButton, obj);
  return callback2(closure_7, obj);
}
function ChatBeginningRowGroupDM(channel) {
  ...
  const items5 = [callback2(first(9916), obj), , , ];
  ...
  const tmp17 = channel.id === channel(5389).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
  obj1[1] = str;
  obj1[3] = arr;
  items5[1] = callback2(channel(4734).Text, obj1);
  ...
  obj2[3] = formatResult;
  items5[2] = callback2(channel(4734).Text, obj2);
  ...
  if (!tmp17) {
    ...
    if (stateFromStores) {
      ...
      obj4[1] = callback2;
      obj4[2] = tmp7(9991).GroupPlusIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      obj6[0] = channel.id;
      tmp15Result1 = tmp15(first(11802), obj6);
    }
          ...
          try {
            ...
            if (0 === dependencyMap) {
              if (arg0 === 1) {
                ...
                let base64 = tmp2;
                base64 = undefined;
                outer1_1(8874).init(dependencyMap);
                const obj7 = outer1_1(8874);
                let obj1 = { size: null };
                obj1[0] = outer1_35;
                dependencyMap = 1;
                c3 = 1;
...
export default function ChatBeginningRow(channelId) {
  ...
  if (!shouldRender) {
    ...
    obj[1] = tmp19Result;
    return callback2(importDefault(11806), obj);
