...
// Dependencies: [32, 5, 19, 17, 4470, 1385, 6132, 9751, 5483, 7375, 1390, 1429, 1386, 1981, 1991, 1908, 4120, 4130, 4701, 1921, 673, 1393, 12257, 12231, 9070, 21, 4478, 709, 5024, 1233, 5026, 5058, 5059, 5031, 5033, 4915, 4474, 4190, 4197, 5076, 11417, 1296, 12258, 8767, 10349, 586, 4322, 7879, 4674, 9721, 6130, 6127, 10643, 4413, 4468, 12259, 12260, 38, 11, 12262, 4193, 9750, 5090, 12266, 6383, 9931, 6795, 1994, 12377, 12380, 8771, 4491, 4928, 12384, 4859, 12385, 5969, 9466, 695, 10261, 7867, 5495, 5490, 4194, 4445, 12387, 2008, 5961, 12388, 8123, 8911, 5989, 9246, 8572, 6195, 4723, 9283, 6012, 9073, 9089, 9085, 9083, 12389, 8374, 4332, 8664, 4298, 1372, 11413, 6076, 10869, 10137, 4421, 12393, 12397, 2]
// Exports: default

// Module 12256 (ChatBeginningRowIcon)
...
import ThreadIcon from "ThreadIcon" /* 5026 */;
import RowButtonWrapper from "RowButtonWrapper" /* 8374 */;
import registerAssetDefault from "registerAsset" /* 12258 */;
import ChannelAccessInfoDefault from "ChannelAccessInfo" /* 12259 */;
import registerAssetDefault2 from "registerAsset" /* 12384 */;
import PortalAccessibilityWorkaroundViewDefault from "PortalAccessibilityWorkaroundView" /* 12397 */;
...
import closure_12 from "recomputeFromAppTokens" /* 5483 */;
import { FetchState } from "recomputeFromAppTokens" /* 5483 */;
import closure_14 from "createUserWidgetFromServer" /* 7375 */;
...
import { MOBILE_MESSAGE_REQUESTS_MODAL_KEY as closure_41 } from "MESSAGE_REQUEST_ACCEPT_CONFIRMATION_MODAL" /* 12231 */;
import { BLOCK_CONFIRMATION_ACTION_SHEET_KEY as closure_42 } from "IGNORE_CONFIRMATION_ACTION_SHEET_KEY" /* 9070 */;
...
function ChatBeginningRowIcon(arg0) {
  ...
  if (isForumPost) {
    ...
    if (isPrivate) {
      let AppsIcon = tmp6(5058).AppsLockIcon;
      let tmp8 = tmp7;
      let tmp9 = tmp6;
    } else {
      AppsIcon = tmp6(5059).AppsIcon;
      tmp8 = tmp7;
      tmp9 = tmp6;
    }
    obj = { IconComponent: null, label: null };
    ...
    if (isPrivate) {
      obj1[0] = tmp17(5031).TextLockIcon;
      obj1[1] = tmp17(1233).t.GK18KJ;
      tmp4 = tmp17;
      tmp5 = obj1;
    } else {
      obj1[0] = tmp17(5033).TextIcon;
      obj1[1] = tmp17(1233).t.GK18KJ;
      tmp4 = tmp17;
      tmp5 = obj1;
    }
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    obj[3] = items1;
    isPrivate = tmp6(tmp2(5076).PressableOpacity, obj);
  }
  ...
  if (canEdit) {
    ...
    obj4[1] = token;
    const items5 = [callback2(tmp2(10349).PencilIcon, obj4), ];
    ...
    obj3[3] = items5;
    canEdit = tmp6(tmp2(5076).PressableOpacity, obj3);
  }
  items3[1] = canEdit;
  obj[1] = items3;
...
function ChatBeginningRowDM(channel) {
  ...
  const tmp = callback3();
  dependencyMap = tmp;
  analyticsLocations = user(5961)().analyticsLocations;
  let id;
  if (user != null) {
    id = user.id;
  }
  ...
  if (null == user) {
    ...
    const items5 = [callback2(tmp7(5076).PressableOpacity, obj1), , , , , , ];
    ...
    items5[1] = callback2(tmp7(5076).PressableOpacity, obj3);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      tmp15Result = tmp15(tmp7(5076).PressableOpacity, obj5);
    }
    ...
    if (user.isProvisional) {
      ...
      obj8[1] = user.id;
      tmp15Result = tmp15(tmp7(12389).ChatProvisionalAccountExplainerCard, obj8);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
        ...
        function handleOpenMutualGuilds() {
          if (null != user) {
            ...
            obj[1] = function onPressMutualGuild(arg0) {
              ...
              callback2(4723).popWithKey(closure_41);
            };
        ...
        obj10[0] = tmp7(6012).GuildIconSizes.SMALL;
        ...
        const items6 = [tmp15(tmp7(9283).GuildIconPile, obj10), ];
        ...
        obj9[3] = items6;
        tmp18Result = tmp18(tmp7(5076).PressableOpacity, obj9);
      }
    }
...
function ChatBeginningRowGroupDM(channel) {
  ...
  const items5 = [callback2(first(10869), obj), , , ];
  ...
  const tmp17 = channel.id === channel(6076).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
  obj1[1] = str;
  obj1[3] = arr;
  ...
  if (!tmp17) {
    ...
    if (stateFromStores) {
      ...
      obj4[1] = callback2;
      obj4[2] = tmp7(10137).GroupPlusIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      obj6[0] = channel.id;
      tmp15Result1 = tmp15(first(12393), obj6);
    }
          ...
          try {
            ...
            if (0 === dependencyMap) {
              if (arg0 === 1) {
                ...
                let base64 = tmp2;
                base64 = undefined;
                closure_1_1(9750).init(dependencyMap);
                const obj7 = closure_1_1(9750);
                obj1 = { size: null };
                obj1[0] = closure_1_36;
                dependencyMap = 1;
                c3 = 1;
