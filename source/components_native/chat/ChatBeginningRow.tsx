...
// Dependencies: [32, 5, 19, 17, 4247, 1371, 5775, 8614, 5189, 6977, 1376, 1415, 1372, 1932, 1942, 1862, 3883, 3892, 4451, 1874, 676, 1379, 11681, 11655, 10600, 21, 4255, 712, 4752, 1236, 4754, 4759, 4761, 4652, 4251, 3952, 3959, 4783, 11054, 1297, 11682, 7814, 9284, 589, 4094, 7868, 4119, 4446, 8588, 5773, 9823, 4191, 4245, 11683, 11684, 38, 11, 11686, 3955, 8613, 4797, 11690, 6036, 8657, 6406, 1945, 11800, 11803, 7818, 4265, 4666, 11807, 4596, 11808, 5589, 10688, 698, 10381, 7856, 5201, 5196, 3956, 4223, 11810, 1959, 5581, 11811, 8106, 8668, 5609, 11812, 8443, 5856, 4461, 11828, 5632, 9104, 9238, 11830, 10601, 11837, 7768, 4106, 7667, 4071, 1358, 11048, 5723, 9274, 10375, 4199, 11841, 11845, 2]
// Exports: default

// Module 11680 (ChatBeginningRowIcon)
...
function ChatBeginningRowIcon(arg0) {
  ...
  if (isForumPost) {
    obj[0] = tmp2(4752).ChatIcon;
    obj[1] = tmp2(1236).t.Y4REmB;
    let tmp5 = tmp2;
    let tmp6 = obj;
  } else if (isThread) {
    obj[0] = tmp2(4754).ThreadIcon;
    obj[1] = tmp2(1236).t["7Xm5QI"];
    tmp5 = tmp2;
    tmp6 = obj;
  } else if (isPrivate) {
    obj[0] = tmp2(4759).TextLockIcon;
    obj[1] = tmp2(1236).t.GK18KJ;
    tmp5 = tmp2;
    tmp6 = obj;
  } else {
    obj[0] = tmp2(4761).TextIcon;
    obj[1] = tmp2(1236).t.GK18KJ;
    tmp5 = tmp2;
    tmp6 = obj;
  }
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    obj[3] = items1;
    isPrivate = tmp6(tmp2(4783).PressableOpacity, obj);
  }
  ...
  if (canEdit) {
    ...
    obj4[1] = token;
    const items5 = [callback2(tmp2(9284).PencilIcon, obj4), ];
    ...
    obj3[3] = items5;
    canEdit = tmp6(tmp2(4783).PressableOpacity, obj3);
  }
  items3[1] = canEdit;
  obj[1] = items3;
...
function ChatBeginningRowGuildNonDefaultChannel(channel) {
  ...
  if (result) {
    ...
    if (canResult) {
      ...
      tmp15Result = callback2(tmp(11683), obj2);
    }
  }
...
function DMSpamButton(channel) {
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return callback2(tmp(4666).Button, obj);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      tmp4 = callback2(tmp2(4666).Button, obj);
    }
  }
  return tmp4;
}
...
function ChatBeginningRowDM(channel) {
  ...
  const tmp = createCacheKey();
  dependencyMap = tmp;
  analyticsLocations = user(5581)().analyticsLocations;
  let id;
  if (user != null) {
    id = user.id;
  }
  ...
  if (null == user) {
    ...
    const items5 = [callback2(tmp7(4783).PressableOpacity, obj1), , , , , , ];
    ...
    items5[1] = callback2(tmp7(4783).PressableOpacity, obj3);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      tmp15Result = tmp15(tmp7(4783).PressableOpacity, obj5);
    }
    ...
    if (user.isProvisional) {
      ...
      obj8[1] = user.id;
      tmp15Result = tmp15(tmp7(11837).ChatProvisionalAccountExplainerCard, obj8);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
        ...
        function handleOpenMutualGuilds() {
          if (null != user) {
            ...
            obj[1] = function onPressMutualGuild(arg0) {
              ...
              callback2(4461).popWithKey(closure_40);
            };
        ...
        obj10[0] = tmp7(5632).GuildIconSizes.SMALL;
        ...
        const items6 = [tmp15(tmp7(11828).GuildIconPile, obj10), ];
        ...
        obj9[3] = items6;
        tmp18Result = tmp18(tmp7(4783).PressableOpacity, obj9);
      }
    }
...
function ChatBeginningRowButton(style) {
  ...
  obj[1] = callback2(require(7768) /* RowButtonWrapper */.RowButton.Icon, { IconComponent, variant: iconVariant });
  obj[2] = title;
  obj[3] = subtitle;
  obj[4] = trailing;
  obj[1] = callback2(require(7768) /* RowButtonWrapper */.RowButton, obj);
  return callback2(closure_7, obj);
}
function ChatBeginningRowGroupDM(channel) {
  ...
  const items5 = [callback2(first(9274), obj), , , ];
  ...
  const tmp17 = channel.id === channel(5723).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
  obj1[1] = str;
  obj1[3] = arr;
  ...
  if (!tmp17) {
    ...
    if (stateFromStores) {
      ...
      obj4[1] = callback2;
      obj4[2] = tmp7(10375).GroupPlusIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      obj6[0] = channel.id;
      tmp15Result1 = tmp15(first(11841), obj6);
    }
          ...
          try {
            ...
            if (0 === dependencyMap) {
              if (arg0 === 1) {
                ...
                let base64 = tmp2;
                base64 = undefined;
                outer1_1(8613).init(dependencyMap);
                const obj7 = outer1_1(8613);
                let obj1 = { size: null };
                obj1[0] = outer1_35;
                dependencyMap = 1;
                c3 = 1;
...
export default function ChatBeginningRow(channelId) {
  ...
  if (!shouldRender) {
    ...
    obj[1] = tmp19Result;
    return callback2(importDefault(11845), obj);
