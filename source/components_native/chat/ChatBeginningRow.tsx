...
// Dependencies: [32, 5, 19, 17, 4277, 1371, 5804, 8944, 5218, 6989, 1376, 1415, 1372, 1932, 1942, 1862, 3913, 3922, 4480, 1874, 676, 1379, 11742, 11716, 10278, 21, 4285, 712, 4781, 1236, 4783, 4788, 4790, 4681, 4281, 3982, 3989, 4812, 10986, 1297, 11743, 7826, 9591, 589, 4124, 7880, 4149, 4475, 8919, 5802, 9918, 4221, 4275, 11744, 11745, 38, 11, 11747, 3985, 8943, 4826, 11751, 6046, 8987, 6416, 1945, 11861, 11864, 7830, 4295, 4695, 11868, 4625, 11869, 5618, 10538, 698, 9648, 7868, 5230, 5225, 3986, 4253, 11871, 1959, 5610, 11872, 8118, 8705, 5638, 11873, 8711, 5866, 4490, 11888, 5661, 9161, 9551, 11890, 10279, 11897, 7780, 4136, 7679, 4101, 1358, 10980, 5752, 9582, 9637, 4229, 11901, 11905, 2]
// Exports: default

// Module 11741 (ChatBeginningRowIcon)
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    obj[3] = items1;
    isPrivate = tmp6(tmp2(4812).PressableOpacity, obj);
  }
  ...
  if (canEdit) {
    ...
    obj3[3] = items5;
    canEdit = tmp6(tmp2(4812).PressableOpacity, obj3);
  }
  items3[1] = canEdit;
  obj[1] = items3;
...
function ChatBeginningRowGuildNonDefaultChannel(channel) {
  ...
  if (result) {
    ...
    if (canResult) {
      ...
      tmp15Result = callback2(tmp(11744), obj2);
    }
  }
...
function ChatBeginningRowDM(channel) {
  ...
  const tmp = createCacheKey();
  dependencyMap = tmp;
  analyticsLocations = user(5610)().analyticsLocations;
  let id;
  if (user != null) {
    id = user.id;
  }
  ...
  if (null == user) {
    ...
    const items5 = [callback2(tmp7(4812).PressableOpacity, obj1), , , , , , ];
    ...
    items5[1] = callback2(tmp7(4812).PressableOpacity, obj3);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      tmp15Result = tmp15(tmp7(4812).PressableOpacity, obj5);
    }
    ...
    if (user.isProvisional) {
      ...
      obj8[1] = user.id;
      tmp15Result = tmp15(tmp7(11897).ChatProvisionalAccountExplainerCard, obj8);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
        ...
        obj10[0] = tmp7(5661).GuildIconSizes.SMALL;
        ...
        const items6 = [tmp15(tmp7(11888).GuildIconPile, obj10), ];
        ...
        obj9[3] = items6;
        tmp18Result = tmp18(tmp7(4812).PressableOpacity, obj9);
      }
    }
...
function ChatBeginningRowGroupDM(channel) {
  ...
  const tmp17 = channel.id === channel(5752).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
  obj1[1] = str;
  obj1[3] = arr;
  ...
  if (!tmp17) {
    ...
    if (stateFromStores) {
      ...
      obj4[1] = callback2;
      obj4[2] = tmp7(9637).GroupPlusIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      obj6[0] = channel.id;
      tmp15Result1 = tmp15(first(11901), obj6);
    }
          ...
          try {
            ...
            if (0 === dependencyMap) {
              if (arg0 === 1) {
                ...
                let base64 = tmp2;
                base64 = undefined;
                outer1_1(8943).init(dependencyMap);
                const obj7 = outer1_1(8943);
                let obj1 = { size: null };
                obj1[0] = outer1_35;
                dependencyMap = 1;
                c3 = 1;
...
export default function ChatBeginningRow(channelId) {
  ...
  if (!shouldRender) {
    ...
    obj[1] = tmp19Result;
    return callback2(importDefault(11905), obj);
