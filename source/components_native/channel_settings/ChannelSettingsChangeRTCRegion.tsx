...
// Dependencies: [853, 19, 1372, 15802, 21, 4302, 712, 4013, 1236, 7956, 7924, 7925, 7907, 589, 38, 2]
// Exports: default

// Module 15843 (handleSetRegion)
...
prototype["renderRegion"] = function renderRegion(label) {
  return jsx(require(7924) /* TableRadioRow */.TableRadioRow, { label: label.name, value: label.id }, label.id);
};
...
prototype["render"] = function render() {
  ...
  return jsx(require(7907) /* Form */.Form, { style: createCacheKey(this.context).form, children: null });
};
