...
// Dependencies: [853, 19, 1391, 15960, 21, 4344, 712, 4072, 1236, 8057, 8025, 8026, 8008, 589, 38, 2]
// Exports: default

// Module 16001 (handleSetRegion)
...
prototype["renderRegion"] = function renderRegion(label) {
  return jsx(require(8025) /* TableRadioRow */.TableRadioRow, { label: label.name, value: label.id }, label.id);
};
...
prototype["render"] = function render() {
  ...
  return jsx(require(8008) /* Form */.Form, { style: createCacheKey(this.context).form, children: null });
};
