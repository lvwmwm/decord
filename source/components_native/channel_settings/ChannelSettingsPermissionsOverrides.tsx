...
// Dependencies: [32, 5, 19, 17, 1415, 1372, 1964, 1891, 3912, 3921, 1903, 676, 21, 4285, 712, 1480, 1609, 589, 3917, 506, 8922, 4295, 1935, 4123, 4623, 1236, 3981, 1974, 1380, 15795, 8305, 4281, 4475, 9614, 5354, 5688, 15799, 500, 15800, 2]
// Exports: default

// Module 15794 (ChannelSettingsPermissionsOverrides)
...
export default function ChannelSettingsPermissionsOverrides(fromCreate) {
  ...
  if (fromCreate.type === constants.MEMBER) {
    ...
    obj1[1] = str;
    obj1[3] = tmp10;
    tmp9Result = tmp9(_require(5354).TableRow, obj1);
  }
