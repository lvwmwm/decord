...
// Dependencies: [19, 1376, 1372, 4206, 3922, 4480, 1874, 676, 21, 1236, 4285, 712, 3997, 4479, 5230, 4253, 9734, 1959, 5225, 4475, 5649, 5315, 9738, 5650, 7795, 7794, 4281, 7777, 4693, 589, 9739, 9740, 2]
// Exports: default

// Module 9733 (ChannelSettingsNotificationsGuard)
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (!muted) {
    ...
    if (channel.type === constants3.GUILD_CATEGORY) {
      MuteSettingType = tmp(9738).MuteSettingType;
...
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioGroup = tmp7(7795).TableRadioGroup;
  ...
  const TableRadioRow = tmp7(7794).TableRadioRow;
  if (isGuildStageVoiceResult) {
    ...
    items[1] = tmp12(tmp7(7794).TableRadioRow, obj);
    if (!muted) {
      muted = guildMuted;
    }
    ...
    items[2] = tmp12(tmp7(7794).TableRadioRow, obj1);
    obj[5] = items;
    ...
    items1[1] = tmp12(tmp7(7794).TableRadioRow, obj3);
    ...
    items1[2] = tmp12(tmp7(7794).TableRadioRow, obj4);
    ...
    items1[3] = tmp12(tmp7(7794).TableRadioRow, obj5);
    obj[5] = items1;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5649).TableRowGroup, obj4);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj3[2] = items;
