...
// Dependencies: [19, 1395, 1391, 4265, 3998, 4539, 1922, 676, 21, 1236, 4344, 712, 4072, 4538, 5301, 4312, 9865, 2007, 5296, 4534, 5806, 5413, 9869, 5807, 8026, 8025, 4340, 8008, 4752, 589, 9870, 9871, 2]
// Exports: default

// Module 9864 (ChannelSettingsNotificationsGuard)
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  let obj = require(4534) /* computeChannelName */;
  ...
  obj[2] = closure_16(require(5413) /* TableRowInner */.TableRow, { label: formatResult, onPress: this.handleToggleMuteChannel, arrow: !muted });
  const items = [closure_16(require(5806) /* TableRowGroupTitle */.TableRowGroup, obj), ];
  if (!muted) {
    ...
    if (channel.type === constants3.GUILD_CATEGORY) {
      MuteSettingType = tmp(9869).MuteSettingType;
      let CHANNEL = MuteSettingType.CATEGORY;
    } else {
      CHANNEL = tmp(9869).MuteSettingType.CHANNEL;
    }
    obj4[1] = CHANNEL;
    tmp5(importDefault(9869), obj4);
    const tmp8 = importDefault(9869);
  }
};
prototype["renderForumSettings"] = function renderForumSettings() {
  ...
  return closure_16(require(5807) /* TableSwitchRow */.TableSwitchRow, obj);
};
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioGroup = tmp7(8026).TableRadioGroup;
  ...
  const TableRadioRow = tmp7(8025).TableRadioRow;
  if (isGuildStageVoiceResult) {
    ...
    items[1] = tmp12(tmp7(8025).TableRadioRow, obj);
    if (!muted) {
      muted = guildMuted;
    }
    ...
    items[2] = tmp12(tmp7(8025).TableRadioRow, obj1);
    obj[5] = items;
    ...
    items1[1] = tmp12(tmp7(8025).TableRadioRow, obj3);
    ...
    items1[2] = tmp12(tmp7(8025).TableRadioRow, obj4);
    ...
    items1[3] = tmp12(tmp7(8025).TableRadioRow, obj5);
    obj[5] = items1;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    if (guildMuted) {
      ...
      let tmp5 = callback2(require(4340) /* Text */.Text, obj);
      ...
      tmp5 = callback2(require(4340) /* Text */.Text, obj);
    }
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5806).TableRowGroup, obj4);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj3[2] = items;
    obj2[1] = closure_18(require(4752) /* Stack */.Stack, obj3);
    tmp9Result = tmp9(require(8008) /* Form */.Form, obj2);
...
export default function ChannelSettingsNotificationsSplit(arg0) {
  ...
  if (null == stateFromStores) {
    ...
    tmp11 = callback2(importDefault(9871), obj);
    const tmp14 = importDefault(9871);
  }
};
