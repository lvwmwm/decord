...
// Dependencies: [19, 1391, 1387, 4368, 4100, 4669, 1922, 676, 21, 1236, 4448, 712, 4174, 4668, 5455, 4415, 10186, 2009, 5450, 4642, 5960, 5567, 10190, 5961, 7660, 7661, 4444, 8331, 4894, 589, 10191, 10192, 2]
// Exports: default

// Module 10185 (ChannelSettingsNotificationsGuard)
...
import NotificationSettingsChannelDefault from "NotificationSettingsChannel" /* 10192 */;
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (!muted) {
    ...
    if (channel.type === constants3.GUILD_CATEGORY) {
      MuteSettingType = tmp(10190).MuteSettingType;
      let CHANNEL = MuteSettingType.CATEGORY;
    } else {
      CHANNEL = tmp(10190).MuteSettingType.CHANNEL;
    }
    obj4[1] = CHANNEL;
...
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioRow = tmp7(7661).TableRadioRow;
  if (isGuildStageVoiceResult) {
    ...
    items[1] = tmp12(tmp7(7661).TableRadioRow, obj);
    if (!muted) {
      muted = guildMuted;
    }
    ...
    items[2] = tmp12(tmp7(7661).TableRadioRow, obj1);
    obj[5] = items;
    ...
    items1[1] = tmp12(tmp7(7661).TableRadioRow, obj3);
    ...
    items1[2] = tmp12(tmp7(7661).TableRadioRow, obj4);
    ...
    items1[3] = tmp12(tmp7(7661).TableRadioRow, obj5);
    obj[5] = items1;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5960).TableRowGroup, obj4);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj3[2] = items;
