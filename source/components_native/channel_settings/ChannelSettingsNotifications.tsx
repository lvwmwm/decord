...
// Dependencies: [19, 1395, 1391, 4263, 3998, 4550, 1922, 676, 21, 1236, 4342, 712, 4072, 4549, 5323, 4310, 9879, 2007, 5318, 4535, 5828, 5435, 9883, 5829, 8051, 8050, 4338, 8033, 4775, 589, 9884, 9885, 2]
// Exports: default

// Module 9878 (ChannelSettingsNotificationsGuard)
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  obj[2] = closure_16(require(5435) /* TableRowInner */.TableRow, { label: formatResult, onPress: this.handleToggleMuteChannel, arrow: !muted });
  const items = [closure_16(require(5828) /* TableRowGroupTitle */.TableRowGroup, obj), ];
  if (!muted) {
    ...
    if (channel.type === constants3.GUILD_CATEGORY) {
      MuteSettingType = tmp(9883).MuteSettingType;
      let CHANNEL = MuteSettingType.CATEGORY;
    } else {
      CHANNEL = tmp(9883).MuteSettingType.CHANNEL;
    }
    obj4[1] = CHANNEL;
    tmp5(importDefault(9883), obj4);
    const tmp8 = importDefault(9883);
  }
};
prototype["renderForumSettings"] = function renderForumSettings() {
  ...
  return closure_16(require(5829) /* TableSwitchRow */.TableSwitchRow, obj);
};
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioGroup = tmp7(8051).TableRadioGroup;
  ...
  const TableRadioRow = tmp7(8050).TableRadioRow;
  if (isGuildStageVoiceResult) {
    ...
    items[1] = tmp12(tmp7(8050).TableRadioRow, obj);
    if (!muted) {
      muted = guildMuted;
    }
    ...
    items[2] = tmp12(tmp7(8050).TableRadioRow, obj1);
    obj[5] = items;
    ...
    items1[1] = tmp12(tmp7(8050).TableRadioRow, obj3);
    ...
    items1[2] = tmp12(tmp7(8050).TableRadioRow, obj4);
    ...
    items1[3] = tmp12(tmp7(8050).TableRadioRow, obj5);
    obj[5] = items1;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5828).TableRowGroup, obj4);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj3[2] = items;
    obj2[1] = closure_18(require(4775) /* Stack */.Stack, obj3);
    tmp9Result = tmp9(require(8033) /* Form */.Form, obj2);
...
export default function ChannelSettingsNotificationsSplit(arg0) {
  ...
  if (null == stateFromStores) {
    ...
    tmp11 = callback2(importDefault(9885), obj);
    const tmp14 = importDefault(9885);
  }
};
