...
// Dependencies: [19, 1395, 1391, 4366, 4099, 4667, 1923, 676, 21, 1236, 4446, 712, 4173, 4666, 5452, 4413, 10163, 2010, 5447, 4640, 5957, 5564, 10167, 5958, 7639, 7640, 4442, 8309, 4891, 589, 10168, 10169, 2]
// Exports: default

// Module 10162 (ChannelSettingsNotificationsGuard)
...
import NotificationSettingsChannelDefault from "NotificationSettingsChannel" /* 10169 */;
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (!muted) {
    ...
    if (channel.type === constants3.GUILD_CATEGORY) {
      MuteSettingType = tmp(10167).MuteSettingType;
      let CHANNEL = MuteSettingType.CATEGORY;
    } else {
      CHANNEL = tmp(10167).MuteSettingType.CHANNEL;
    }
    obj4[1] = CHANNEL;
...
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioGroup = tmp7(7639).TableRadioGroup;
  ...
  const TableRadioRow = tmp7(7640).TableRadioRow;
  if (isGuildStageVoiceResult) {
    ...
    items[1] = tmp12(tmp7(7640).TableRadioRow, obj);
    if (!muted) {
      muted = guildMuted;
    }
    ...
    items[2] = tmp12(tmp7(7640).TableRadioRow, obj1);
    obj[5] = items;
    ...
    items1[1] = tmp12(tmp7(7640).TableRadioRow, obj3);
    ...
    items1[2] = tmp12(tmp7(7640).TableRadioRow, obj4);
    ...
    items1[3] = tmp12(tmp7(7640).TableRadioRow, obj5);
    obj[5] = items1;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5957).TableRowGroup, obj4);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj3[2] = items;
