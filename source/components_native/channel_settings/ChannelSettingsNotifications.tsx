...
// Dependencies: [19, 1376, 1372, 4176, 3892, 4450, 1874, 676, 21, 1236, 4255, 712, 3967, 4449, 5215, 4223, 9705, 1959, 5210, 4445, 5634, 5300, 9709, 5635, 7767, 7766, 4251, 7749, 4663, 589, 9710, 9711, 2]
// Exports: default

// Module 9704 (ChannelSettingsNotificationsGuard)
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  obj[2] = closure_16(require(5300) /* TableRowInner */.TableRow, { label: formatResult, onPress: this.handleToggleMuteChannel, arrow: !muted });
  const items = [closure_16(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj), ];
  if (!muted) {
    ...
    if (channel.type === constants3.GUILD_CATEGORY) {
      MuteSettingType = tmp(9709).MuteSettingType;
      let CHANNEL = MuteSettingType.CATEGORY;
    } else {
      CHANNEL = tmp(9709).MuteSettingType.CHANNEL;
    }
    obj4[1] = CHANNEL;
    tmp5(importDefault(9709), obj4);
    const tmp8 = importDefault(9709);
  }
};
prototype["renderForumSettings"] = function renderForumSettings() {
  ...
  return closure_16(require(5635) /* TableSwitchRow */.TableSwitchRow, obj);
};
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioGroup = tmp7(7767).TableRadioGroup;
  ...
  const TableRadioRow = tmp7(7766).TableRadioRow;
  if (isGuildStageVoiceResult) {
    ...
    items[1] = tmp12(tmp7(7766).TableRadioRow, obj);
    if (!muted) {
      muted = guildMuted;
    }
    ...
    items[2] = tmp12(tmp7(7766).TableRadioRow, obj1);
    obj[5] = items;
    ...
    items1[1] = tmp12(tmp7(7766).TableRadioRow, obj3);
    ...
    items1[2] = tmp12(tmp7(7766).TableRadioRow, obj4);
    ...
    items1[3] = tmp12(tmp7(7766).TableRadioRow, obj5);
    obj[5] = items1;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      tmp9Result = tmp9(tmp10(5634).TableRowGroup, obj4);
    }
    items[2] = tmp9Result;
    items[3] = tmp5;
    obj3[2] = items;
    obj2[1] = closure_18(require(4663) /* Stack */.Stack, obj3);
    tmp9Result = tmp9(require(7749) /* Form */.Form, obj2);
...
export default function ChannelSettingsNotificationsSplit(arg0) {
  ...
  if (null == stateFromStores) {
    ...
    tmp11 = callback2(importDefault(9711), obj);
    const tmp14 = importDefault(9711);
  }
};
