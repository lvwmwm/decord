...
// Dependencies: [19, 1395, 1391, 4295, 4030, 5043, 1922, 676, 21, 1236, 4661, 712, 4104, 5042, 6798, 4342, 10083, 2007, 6795, 4984, 6286, 6291, 10087, 7178, 8101, 8100, 4734, 8083, 4733, 589, 10088, 10089, 2]
// Exports: default
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  obj[2] = closure_16(require(6291) /* TableRowInner */.TableRow, { label: formatResult, onPress: this.handleToggleMuteChannel, arrow: !muted });
  const items = [closure_16(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj), ];
  if (!muted) {
    ...
    obj4[1] = CHANNEL;
    tmp5(importDefault(10087), obj4);
    const tmp8 = importDefault(10087);
  }
};
prototype["renderForumSettings"] = function renderForumSettings() {
  ...
  return closure_16(require(7178) /* TableSwitchRow */.TableSwitchRow, obj);
};
prototype["renderNotificationSettings"] = function renderNotificationSettings() {
  ...
  const TableRadioGroup = tmp7(8101).TableRadioGroup;
  ...
  const TableRadioRow = tmp7(8100).TableRadioRow;
...
prototype["render"] = function render() {
  ...
  if (null != channel) {
    if (guildMuted) {
      ...
      let tmp5 = callback2(require(4734) /* Text */.Text, obj);
      ...
      tmp5 = callback2(require(4734) /* Text */.Text, obj);
    }
    ...
    items[3] = tmp5;
    obj3[2] = items;
    obj2[1] = closure_18(require(4733) /* Stack */.Stack, obj3);
    tmp9Result = tmp9(require(8083) /* Form */.Form, obj2);
...
export default function ChannelSettingsNotificationsSplit(arg0) {
  ...
  if (null == stateFromStores) {
    ...
    tmp11 = callback2(importDefault(10089), obj);
    const tmp14 = importDefault(10089);
  }
};
