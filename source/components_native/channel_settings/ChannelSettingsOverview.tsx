...
// Function ID: 15738
// Name: PinImage
// Dependencies: [5, 19, 17, 3885, 1376, 1415, 7799, 1372, 1932, 1862, 3883, 4267, 15738, 3892, 1874, 15739, 676, 1379, 5818, 1235, 505, 21, 4255, 712, 589, 9610, 3967, 12, 15740, 4449, 1236, 5223, 8165, 7798, 3956, 9764, 8138, 4437, 3896, 1384, 4101, 15741, 8893, 4594, 4251, 8915, 4445, 4683, 4107, 4154, 15742, 7685, 7758, 500, 5634, 5635, 4468, 5302, 13308, 15743, 8139, 7767, 7766, 1381, 1383, 1945, 5300, 5783, 8900, 9030, 10080, 4199, 1382, 15744, 8217, 9576, 14078, 9608, 7118, 4219, 4209, 4774, 9612, 4197, 4214, 4663, 10077, 7644, 9321, 4797, 15141, 7749, 1480, 2]
// Exports: default

// Module 15737 (PinImage)
...
prototype["updateNavigation"] = function updateNavigation(submitting, hasChanges) {
  ...
  if (isThread) {
    ...
    if (submitting) {
      let fn = tmp3(5223).HeaderSubmittingIndicator;
    } else {
      fn = (arg0) => {
        const obj = {};
...
prototype["renderChannelInfo"] = function renderChannelInfo() {
  ...
  let obj = require(15742) /* getIsChannelNameSettingEditable */;
  ...
  const TextInput = tmp3(7685).TextInput;
  obj[3] = require(4445) /* computeChannelName */.computeChannelName(channel, mergeGuildAvatar, upsertRelationship);
  ...
  if (!hasItem) {
    ...
    obj1[2] = importDefault(3896).translateSurrogatesToInlineEmoji(channel.topic);
    ...
    closure_43(tmp3(7758).TextArea, obj1);
  ...
  if (channel.type === constants2.GUILD_TEXT) {
    ...
    if (tmp2) {
      ...
      if (!obj.isIOS()) {
        ...
        obj[1] = tmp5(4468).isChannelOrGuildNSFW(channel);
        ...
        obj[4] = stringResult;
        obj[2] = closure_43(tmp5(5635).TableSwitchRow, obj);
        tmp7Result = tmp7(tmp5(5634).TableRowGroup, obj, "nsfw-section");
        const tmp5Result = tmp5(4468);
      }
    }
  }
  return tmp7Result;
...
prototype["renderThreadSpoiler"] = function renderThreadSpoiler() {
  ...
  if (channel.isThread()) {
    ...
    obj[2] = callback3(require(5635) /* TableSwitchRow */.TableSwitchRow, obj);
    tmp = callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj, "thread-spoiler-section");
  }
  return tmp;
};
prototype["renderSlowmode"] = function renderSlowmode() {
  ...
  let obj = require(15741) /* getSecondsSliderLabel */;
  const intl = require(1236) /* getSystemLocale */.intl;
  ...
  const items1 = [callback3(require(4251) /* Text */.Text, obj2), callback3(require(4251) /* Text */.Text, { variant: "text-md/medium", color: "text-muted", children: secondsSliderLabel })];
  obj1[1] = items1;
  ...
  items2[1] = callback3(require(13308) /* Slider */.Slider, obj3);
  obj[1] = items2;
  obj[2] = callback4(require(5302) /* PressableCard */.Card, obj);
  items.push(callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj, "slowmode-section"));
  return items;
};
prototype["renderAutoArchiveDuration"] = function renderAutoArchiveDuration() {
  ...
  if (channel.isThread()) {
    if (canManageThread) {
      ...
      return closure_43(tmp5(15743).AutoArchiveDurationOptions, obj);
    }
  }
  return null;
};
prototype["renderInvitable"] = function renderInvitable() {
  ...
  if (null != channel.threadMetadata) {
    ...
    if (channel.type === constants2.PRIVATE_THREAD) {
      ...
      obj[2] = callback3(require(5635) /* TableSwitchRow */.TableSwitchRow, obj);
      tmp3 = callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj, "thread-invitable-section");
    }
  }
  return tmp3;
};
prototype["renderDefaultAutoArchiveDuration"] = function renderDefaultAutoArchiveDuration() {
  ...
  if (set2.has(channel.type)) {
    ...
    if (props.canManageChannels) {
      ...
      obj[1] = require(8139) /* getAutoArchiveOptions */.getAutoArchiveDuration(channel, null);
      obj[2] = channel;
      obj[3] = this.handleDefaultAutoArchiveDurationChange;
      const obj2 = require(8139) /* getAutoArchiveOptions */;
      ...
      obj[4] = stringResult;
      tmp2(require(15743) /* AutoArchiveDurationOptions */.AutoArchiveDurationOptions, obj);
      isForumLikeChannelResult = channel.isForumLikeChannel();
    }
  }
  return tmp;
...
prototype["renderDefaultSortOrder"] = function renderDefaultSortOrder() {
  ...
  if (channel.isForumLikeChannel()) {
    if (props.canManageChannels) {
      ...
      const items = [callback3(require(7766) /* TableRadioRow */.TableRadioRow, obj), ];
      obj = { label: null, value: null };
      const intl4 = require(1236) /* getSystemLocale */.intl;
      obj[0] = intl4.string(require(1236) /* getSystemLocale */.t.w28f3F);
      obj[1] = require(1381) /* set */.ThreadSortOrder.CREATION_DATE;
      items[1] = callback3(require(7766) /* TableRadioRow */.TableRadioRow, obj);
      obj[5] = items;
      return callback4(require(7767) /* context */.TableRadioGroup, obj);
    }
  }
  return null;
};
      ...
      if (features.has(constants4.NEWS)) {
        ...
        if (channel.id !== rulesChannelId) {
          ...
          if (channel.id !== prop) {
            ...
            obj[2] = callback3(require(5635) /* TableSwitchRow */.TableSwitchRow, obj1);
            items.push(callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj, "announcement-section"));
            return items;
          }
        }
      }
...
prototype["renderBitrateSettings"] = function renderBitrateSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (canManageChannels) {
      const items = [];
      let obj = require(4437) /* allowChannelAccess */;
      ...
      items2[1] = callback3(require(13308) /* Slider */.Slider, obj5);
      obj1[0] = items2;
      obj[2] = callback4(require(5302) /* PressableCard */.Card, obj1);
      items.push(callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj, "bitrate-section"));
      return items;
    }
  }
  return null;
...
prototype["renderVideoQualityModeSettings"] = function renderVideoQualityModeSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (canManageChannels) {
      ...
      const items1 = [callback3(require(7766) /* TableRadioRow */.TableRadioRow, obj), ];
      obj = { label: null, value: null };
      const intl4 = tmp2(1236).intl;
      obj[0] = intl4.string(require(1236) /* getSystemLocale */.t["7jOoJE"]);
      obj[1] = constants7.FULL;
      items1[1] = callback3(require(7766) /* TableRadioRow */.TableRadioRow, obj);
      obj[5] = items1;
      items.push(closure_44(require(7767) /* context */.TableRadioGroup, obj, "video-quality-section"));
      return items;
    }
  }
  return null;
...
prototype["renderUserLimitSettings"] = function renderUserLimitSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (props.canManageChannels) {
      ...
      const items1 = [closure_43(tmp7(4251).Text, obj2), ];
      const obj3 = { variant: "text-md/medium", color: "text-muted", children: null };
      obj3[2] = stringResult;
      items1[1] = closure_43(tmp7(4251).Text, obj3);
      obj1[1] = items1;
      const items2 = [callback4(View, obj1), ];
      ...
      items2[1] = closure_43(tmp7(13308).Slider, obj4);
      obj[0] = items2;
      obj[2] = callback4(tmp7(5302).Card, obj);
      items.push(closure_43(tmp7(5634).TableRowGroup, obj, "channel-user-limit"));
      return items;
    }
  }
  return null;
    ...
    if (self.showVoiceSettings()) {
      if (tmp) {
        if (!channel.isGuildStageVoice()) {
          ...
          obj = { text: null };
          obj[0] = name;
          obj[1] = callback3(channel(5300).TableRow.TrailingText, obj);
          obj[3] = tmp2;
          obj[4] = function onPress() {
            return self.pushScreen(outer1_25.CHANGE_RTC_REGION);
          };
          obj[3] = callback3(channel(5300).TableRow, obj);
          items.push(callback3(channel(5634).TableRowGroup, obj, "channel-region-override"));
          return items;
        }
      }
    }
...
prototype["showVoiceSettings"] = function showVoiceSettings() {
  ...
  if (hasItem) {
    ...
    if (!enabled) {
      const VoiceInThreadsExperiment = require(5783) /* useCanUnarchiveThread */.VoiceInThreadsExperiment;
...
prototype["renderPermissions"] = function renderPermissions() {
  ...
  if (!this.props.canManageRoles) {
    ...
    obj[0] = stringResult;
    ShieldUserIcon = ShieldUserIcon(8900).ShieldUserIcon;
    tmp2Result = tmp2(ShieldUserIcon, {});
    obj[2] = tmp2Result;
    obj[3] = function onPress() {
      return self.pushScreen(outer1_25.PERMISSIONS, { origin: outer1_25.OVERVIEW });
    };
    obj[2] = closure_43(self(5300).TableRow, obj);
    tmp2Result = tmp2(self(5634).TableRowGroup, obj);
  }
};
prototype["renderSettingsSection"] = function renderSettingsSection(items) {
  ...
  if (items.length > 0) {
    ...
    obj[1] = items;
    tmp = callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj);
  }
  return tmp;
};
prototype["renderCommonSettingsSection"] = function renderCommonSettingsSection() {
  ...
  if (tmp2) {
    ...
    obj[2] = callback3(channel(9030).BellIcon, {});
    obj[3] = function onPress() {
      if (channel.isThread()) {
    ...
    items.push(callback3(channel(5300).TableRow, obj, "rowNotifications"));
  }
  if (callback2(channel.type)) {
    ...
    items.push(callback3(channel(5300).TableRow, obj, "rowPinnedMessages"));
  }
  if (canManageChannels) {
  ...
  if (canManageChannels) {
    ...
    obj1[2] = callback3(channel(4199).LinkIcon, {});
    obj1[3] = function onPress() {
      return self.pushScreen(outer1_25.INSTANT_INVITES);
    };
    items.push(callback3(channel(5300).TableRow, obj1, "rowInstantInvites"));
  }
...
prototype["renderDefaultForumLayout"] = function renderDefaultForumLayout() {
  ...
  if (!channel.isForumChannel()) {
    ...
    obj1[0] = stringResult;
    obj[1] = closure_43(self(5300).TableRow.TrailingText, obj1);
    if (channel.defaultForumLayout === GridSquareIcon(1382).ForumLayout.GRID) {
      GridSquareIcon = GridSquareIcon(15744).GridSquareIcon;
      obj = {};
      let tmpResult = tmp(GridSquareIcon, obj);
    } else {
      tmpResult = tmp(GridSquareIcon(8217).ListViewIcon, {});
    }
    obj[3] = tmpResult;
    obj[4] = function onPress() {
      return self.pushScreen(outer1_25.DEFAULT_FORUM_LAYOUT);
    };
    obj[2] = closure_43(self(5300).TableRow, obj, "forumDefaultLayout");
    tmpResult = tmp(self(5634).TableRowGroup, obj, "default-forum-layout");
  }
};
  ...
  if (hasJoinedThread) {
    ...
    if (isArchivedThread) {
      ...
      if (canUnarchiveThread) {
        ...
        obj[0] = callback3(tmp2(4219).ClockIcon, {});
        ...
        callback3(tmp2(5300).TableRow, obj);
    ...
    if (!isArchivedThread) {
      ...
      if (canManageThread) {
        ...
        obj[0] = callback3(tmp2(4209).XLargeIcon, {});
        const intl3 = tmp2(1236).intl;
    ...
    if (isThreadModerator) {
      ...
      if (isLockedThread) {
        ...
        obj1[0] = callback3(tmp2(4774).LockIcon, {});
        const intl4 = tmp2(1236).intl;
        ...
        callback3(tmp2(5300).TableRow, obj1);
    ...
    if (isThreadModerator) {
      ...
      if (!isLockedThread) {
        ...
        obj2[0] = callback3(tmp2(4774).LockIcon, {});
        ...
        callback3(tmp2(5300).TableRow, obj2);
    ...
    obj4[0] = callback3(tmp2(4199).LinkIcon, {});
    ...
    items[5] = callback3(tmp2(5300).TableRow, obj4);
    obj3[1] = items;
    return closure_44(tmp4, obj3);
  } else {
    obj = { icon: null, label: null, onPress: null };
    obj[0] = callback3(tmp2(9608).GroupPlusIcon, {});
...
prototype["renderDeleteButton"] = function renderDeleteButton() {
  ...
  if (canManageChannels) {
    ...
    if (!hasJoinedThread) {
      ...
      obj[1] = callback3(tmp8(4214).TrashIcon, { color: "text-feedback-critical" });
      obj[2] = stringResult;
      obj[3] = this.handleDeleteChannel;
      items[1] = callback3(tmp8(5300).TableRow, obj);
      obj[1] = items;
      tmp = tmp13(tmp14, obj);
    } else {
      obj = { variant: "danger", icon: null, label: null, onPress: null };
      obj[1] = callback3(tmp8(4197).UserMinusIcon, { color: "text-feedback-critical" });
      ...
      callback3(tmp8(5300).TableRow, obj);
      const tmp17 = callback3;
    }
    tmp13 = closure_44;
  }
  ...
  if (channel.isForumLikeChannel()) {
    ...
    if (channel.availableTags.length > 0) {
      ...
      if (tmp3) {
        ...
        obj2[0] = tmp10(tmp7(9321).PlusSmallIcon, obj3);
        obj2[2] = function onPress() {
          return self.handlePressTag();
        };
        const intl3 = tmp7(1236).intl;
        obj2[3] = intl3.string(tmp7(1236).t["/jubeD"]);
        obj1[1] = tmp10(tmp7(7644).IconButton, obj2);
    ...
    const items1 = [closure_43(canManageChannels(5634).TableRowGroup, obj), , , ];
    tmp10Result = null;
    if (channel.availableTags.length <= 0) {
      ...
      obj5[4] = tmp10(tmp7(4251).Text, obj6);
      tmp10Result = tmp10(tmp7(4797).PressableOpacity, obj5);
    }
    ...
    if (tmp10Result1) {
      ...
      obj7[2] = error;
      tmp10Result1 = tmp10(tmp7(4251).Text, obj7);
    }
    ...
    obj8[1] = closure_43(canManageChannels(5635).TableSwitchRow, obj9);
    items1[3] = closure_43(canManageChannels(5634).TableRowGroup, obj8);
    obj[1] = items1;
    return closure_44(canManageChannels(4663).Stack, obj);
  } else {
    return null;
  }
};
prototype["renderShowMediaDownloadOptions"] = function renderShowMediaDownloadOptions() {
  ...
  if (channel.isMediaChannel()) {
    ...
    obj[1] = callback3(require(5635) /* TableSwitchRow */.TableSwitchRow, obj);
    tmp = callback3(require(5634) /* TableRowGroupTitle */.TableRowGroup, obj);
  }
  return tmp;
};
prototype["renderCategory"] = function renderCategory() {
  ...
  if (props.hasCategories) {
    if (props.channel.type !== constants2.GUILD_CATEGORY) {
      ...
      obj[0] = callback3(tmp7(15141).FolderPlusIcon, {});
      const intl2 = tmp7(1236).intl;
      obj[1] = intl2.string(tmp7(1236).t.vHCZwr);
      obj = { text: null };
      obj[0] = stringResult;
      obj[2] = callback3(tmp7(5300).TableRow.TrailingText, obj);
      ...
      obj[4] = fn;
      obj1[1] = callback3(tmp7(5300).TableRow, obj);
      return callback3(tmp7(5634).TableRowGroup, obj1);
    }
  }
  return null;
};
prototype["renderThreadSettings"] = function renderThreadSettings() {
  ...
  obj[2] = items;
  obj[0] = callback4(require(4663) /* Stack */.Stack, obj);
