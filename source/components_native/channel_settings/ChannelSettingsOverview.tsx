...
// Function ID: 16029
// Name: PinImage
// Dependencies: [5, 19, 17, 4023, 1395, 1434, 8133, 1391, 1980, 1910, 4021, 4772, 16029, 4030, 1922, 16030, 676, 1398, 7273, 1235, 505, 21, 4661, 712, 589, 9993, 4104, 12, 16031, 5042, 1236, 6314, 8492, 8132, 4094, 8764, 8464, 4979, 4034, 1403, 1363, 16032, 8852, 4656, 4734, 8874, 4984, 4763, 4230, 4273, 16033, 8071, 8092, 500, 6286, 7178, 5252, 6292, 13542, 16034, 8465, 8101, 8100, 1400, 1402, 1993, 6291, 7234, 8859, 10003, 10513, 4318, 1401, 16035, 8544, 9949, 14311, 9991, 7512, 4338, 4328, 6890, 9995, 4316, 4333, 4733, 10451, 8035, 9262, 5433, 15415, 8083, 1500, 2]
// Exports: default
...
prototype["renderChannelInfo"] = function renderChannelInfo() {
  ...
  let obj = require(16033) /* getIsChannelNameSettingEditable */;
  ...
  const TextInput = tmp3(8071).TextInput;
  obj[3] = require(4984) /* computeChannelName */.computeChannelName(channel, mergeGuildAvatar, markAllUserIdListsStale);
  ...
  if (!hasItem) {
    ...
    obj1[2] = importDefault(4034).translateSurrogatesToInlineEmoji(channel.topic);
    ...
    closure_43(tmp3(8092).TextArea, obj1);
  ...
  if (channel.type === constants2.GUILD_TEXT) {
    ...
    if (tmp2) {
      ...
      if (!obj.isIOS()) {
        ...
        obj[1] = tmp5(5252).isChannelOrGuildNSFW(channel);
        ...
        obj[4] = stringResult;
        obj[2] = closure_43(tmp5(7178).TableSwitchRow, obj);
        tmp7Result = tmp7(tmp5(6286).TableRowGroup, obj, "nsfw-section");
        const tmp5Result = tmp5(5252);
      }
    }
  }
  return tmp7Result;
...
prototype["renderThreadSpoiler"] = function renderThreadSpoiler() {
  ...
  if (channel.isThread()) {
    ...
    obj[2] = callback3(require(7178) /* TableSwitchRow */.TableSwitchRow, obj);
    tmp = callback3(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj, "thread-spoiler-section");
  }
  return tmp;
};
prototype["renderSlowmode"] = function renderSlowmode() {
  ...
  let obj = require(16032) /* getSecondsSliderLabel */;
  const intl = require(1236) /* getSystemLocale */.intl;
  ...
  const items1 = [callback3(require(4734) /* Text */.Text, obj2), callback3(require(4734) /* Text */.Text, { variant: "text-md/medium", color: "text-muted", children: secondsSliderLabel })];
  obj1[1] = items1;
  ...
  items2[1] = callback3(require(13542) /* Slider */.Slider, obj3);
  obj[1] = items2;
  obj[2] = callback4(require(6292) /* PressableCard */.Card, obj);
  items.push(callback3(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj, "slowmode-section"));
  return items;
};
prototype["renderAutoArchiveDuration"] = function renderAutoArchiveDuration() {
  ...
  if (channel.isThread()) {
    if (canManageThread) {
      ...
      return closure_43(tmp5(16034).AutoArchiveDurationOptions, obj);
    }
  }
  return null;
};
prototype["renderInvitable"] = function renderInvitable() {
  ...
  if (null != channel.threadMetadata) {
    ...
    if (channel.type === constants2.PRIVATE_THREAD) {
      ...
      obj[2] = callback3(require(7178) /* TableSwitchRow */.TableSwitchRow, obj);
      tmp3 = callback3(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj, "thread-invitable-section");
    }
  }
  return tmp3;
};
prototype["renderDefaultAutoArchiveDuration"] = function renderDefaultAutoArchiveDuration() {
  ...
  if (set2.has(channel.type)) {
    ...
    if (props.canManageChannels) {
      ...
      obj[1] = require(8465) /* getAutoArchiveOptions */.getAutoArchiveDuration(channel, null);
      obj[2] = channel;
      obj[3] = this.handleDefaultAutoArchiveDurationChange;
      const obj2 = require(8465) /* getAutoArchiveOptions */;
      ...
      obj[4] = stringResult;
      tmp2(require(16034) /* AutoArchiveDurationOptions */.AutoArchiveDurationOptions, obj);
      isForumLikeChannelResult = channel.isForumLikeChannel();
    }
  }
  return tmp;
...
prototype["renderDefaultSortOrder"] = function renderDefaultSortOrder() {
  ...
  if (channel.isForumLikeChannel()) {
    if (props.canManageChannels) {
      ...
      const items = [callback3(require(8100) /* TableRadioRow */.TableRadioRow, obj), ];
      obj = { label: null, value: null };
      const intl4 = require(1236) /* getSystemLocale */.intl;
      obj[0] = intl4.string(require(1236) /* getSystemLocale */.t.w28f3F);
      obj[1] = require(1400) /* set */.ThreadSortOrder.CREATION_DATE;
      items[1] = callback3(require(8100) /* TableRadioRow */.TableRadioRow, obj);
      obj[5] = items;
      return callback4(require(8101) /* context */.TableRadioGroup, obj);
    }
  }
  return null;
};
      ...
      if (features.has(constants4.NEWS)) {
        ...
        if (channel.id !== rulesChannelId) {
          ...
          if (channel.id !== prop) {
            ...
            obj[2] = callback3(require(7178) /* TableSwitchRow */.TableSwitchRow, obj1);
            items.push(callback3(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj, "announcement-section"));
            return items;
          }
        }
      }
...
prototype["renderBitrateSettings"] = function renderBitrateSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (canManageChannels) {
      ...
      const items1 = [callback3(require(4734) /* Text */.Text, obj3), ];
      ...
      items2[1] = callback3(require(13542) /* Slider */.Slider, obj5);
      obj1[0] = items2;
      obj[2] = callback4(require(6292) /* PressableCard */.Card, obj1);
      items.push(callback3(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj, "bitrate-section"));
      return items;
    }
  }
  return null;
...
prototype["renderVideoQualityModeSettings"] = function renderVideoQualityModeSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (canManageChannels) {
      ...
      const items1 = [callback3(require(8100) /* TableRadioRow */.TableRadioRow, obj), ];
      obj = { label: null, value: null };
      const intl4 = tmp2(1236).intl;
      obj[0] = intl4.string(require(1236) /* getSystemLocale */.t["7jOoJE"]);
      obj[1] = constants7.FULL;
      items1[1] = callback3(require(8100) /* TableRadioRow */.TableRadioRow, obj);
      obj[5] = items1;
      items.push(closure_44(require(8101) /* context */.TableRadioGroup, obj, "video-quality-section"));
      return items;
    }
  }
  return null;
...
prototype["renderUserLimitSettings"] = function renderUserLimitSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (props.canManageChannels) {
      ...
      const items1 = [closure_43(tmp7(4734).Text, obj2), ];
      const obj3 = { variant: "text-md/medium", color: "text-muted", children: null };
      obj3[2] = stringResult;
      items1[1] = closure_43(tmp7(4734).Text, obj3);
      obj1[1] = items1;
      const items2 = [callback4(View, obj1), ];
      ...
      items2[1] = closure_43(tmp7(13542).Slider, obj4);
      obj[0] = items2;
      obj[2] = callback4(tmp7(6292).Card, obj);
      items.push(closure_43(tmp7(6286).TableRowGroup, obj, "channel-user-limit"));
      return items;
    }
  }
  return null;
...
prototype["showVoiceSettings"] = function showVoiceSettings() {
  ...
  if (hasItem) {
    ...
    if (!enabled) {
      const VoiceInThreadsExperiment = require(7234) /* useCanUnarchiveThread */.VoiceInThreadsExperiment;
...
prototype["renderPermissions"] = function renderPermissions() {
  ...
  if (!this.props.canManageRoles) {
    ...
    obj[2] = closure_43(self(6291).TableRow, obj);
    tmp2Result = tmp2(self(6286).TableRowGroup, obj);
  }
};
prototype["renderSettingsSection"] = function renderSettingsSection(items) {
  ...
  if (items.length > 0) {
    ...
    obj[1] = items;
    tmp = callback3(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj);
  }
  return tmp;
};
...
prototype["renderDefaultForumLayout"] = function renderDefaultForumLayout() {
  ...
  if (!channel.isForumChannel()) {
    ...
    obj1[0] = stringResult;
    obj[1] = closure_43(self(6291).TableRow.TrailingText, obj1);
    if (channel.defaultForumLayout === GridSquareIcon(1401).ForumLayout.GRID) {
      ...
      tmpResult = tmp(GridSquareIcon(8544).ListViewIcon, {});
    }
    obj[3] = tmpResult;
    obj[4] = function onPress() {
      return self.pushScreen(outer1_25.DEFAULT_FORUM_LAYOUT);
    };
    obj[2] = closure_43(self(6291).TableRow, obj, "forumDefaultLayout");
    tmpResult = tmp(self(6286).TableRowGroup, obj, "default-forum-layout");
  }
};
  ...
  if (hasJoinedThread) {
    ...
    if (isArchivedThread) {
      ...
      if (canUnarchiveThread) {
        ...
        obj[0] = callback3(tmp2(4338).ClockIcon, {});
        ...
        callback3(tmp2(6291).TableRow, obj);
    ...
    if (!isArchivedThread) {
      ...
      if (canManageThread) {
        ...
        obj[0] = callback3(tmp2(4328).XLargeIcon, {});
        const intl3 = tmp2(1236).intl;
    ...
    if (isThreadModerator) {
      ...
      if (isLockedThread) {
        ...
        obj1[0] = callback3(tmp2(6890).LockIcon, {});
        const intl4 = tmp2(1236).intl;
        ...
        callback3(tmp2(6291).TableRow, obj1);
    ...
    if (isThreadModerator) {
      ...
      if (!isLockedThread) {
        ...
        obj2[0] = callback3(tmp2(6890).LockIcon, {});
        ...
        callback3(tmp2(6291).TableRow, obj2);
    ...
    obj4[0] = callback3(tmp2(4318).LinkIcon, {});
    ...
    items[5] = callback3(tmp2(6291).TableRow, obj4);
    obj3[1] = items;
    return closure_44(tmp4, obj3);
  } else {
    obj = { icon: null, label: null, onPress: null };
    obj[0] = callback3(tmp2(9991).GroupPlusIcon, {});
  ...
  if (channel.isForumLikeChannel()) {
    ...
    if (channel.availableTags.length > 0) {
      ...
      if (tmp3) {
        ...
        obj2[0] = tmp10(tmp7(9262).PlusSmallIcon, obj3);
        obj2[2] = function onPress() {
          return self.handlePressTag();
        };
        const intl3 = tmp7(1236).intl;
        obj2[3] = intl3.string(tmp7(1236).t["/jubeD"]);
        obj1[1] = tmp10(tmp7(8035).IconButton, obj2);
    ...
    const items1 = [closure_43(canManageChannels(6286).TableRowGroup, obj), , , ];
    tmp10Result = null;
    if (channel.availableTags.length <= 0) {
      ...
      obj5[4] = tmp10(tmp7(4734).Text, obj6);
      tmp10Result = tmp10(tmp7(5433).PressableOpacity, obj5);
    }
    ...
    if (tmp10Result1) {
      ...
      obj7[2] = error;
      tmp10Result1 = tmp10(tmp7(4734).Text, obj7);
    }
    ...
    obj8[1] = closure_43(canManageChannels(7178).TableSwitchRow, obj9);
    items1[3] = closure_43(canManageChannels(6286).TableRowGroup, obj8);
    obj[1] = items1;
    return closure_44(canManageChannels(4733).Stack, obj);
  } else {
    return null;
  }
};
prototype["renderShowMediaDownloadOptions"] = function renderShowMediaDownloadOptions() {
  ...
  if (channel.isMediaChannel()) {
    ...
    obj[1] = callback3(require(7178) /* TableSwitchRow */.TableSwitchRow, obj);
    tmp = callback3(require(6286) /* TableRowGroupTitle */.TableRowGroup, obj);
  }
  return tmp;
};
...
prototype["renderThreadSettings"] = function renderThreadSettings() {
  ...
  obj[2] = items;
  obj[0] = callback4(require(4733) /* Stack */.Stack, obj);
  return callback3(require(8083) /* Form */.Form, obj);
};
