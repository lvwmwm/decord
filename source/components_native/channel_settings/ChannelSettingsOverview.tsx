...
// Function ID: 15778
// Name: PinImage
// Dependencies: [5, 19, 17, 3914, 1376, 1415, 7940, 1372, 1961, 1891, 3912, 4297, 15778, 3921, 1903, 15779, 676, 1379, 5845, 1235, 505, 21, 4285, 712, 589, 9641, 3996, 12, 15780, 4479, 1236, 5253, 8305, 7939, 3985, 9795, 8278, 4467, 3925, 1384, 4130, 15781, 8922, 4624, 4281, 8944, 4475, 4713, 4136, 4184, 15782, 7713, 7899, 500, 5688, 5689, 4498, 5356, 13345, 15783, 8279, 7908, 7907, 1381, 1383, 1974, 5354, 5810, 8929, 9059, 10111, 4229, 1382, 15784, 8357, 9605, 14115, 9639, 7145, 4249, 4239, 4804, 9643, 4227, 4244, 4693, 10108, 7672, 9350, 4827, 15179, 7890, 1480, 2]
// Exports: default

// Module 15777 (PinImage)
...
prototype["updateNavigation"] = function updateNavigation(submitting, hasChanges) {
  ...
  if (isThread) {
    ...
    if (submitting) {
      let fn = tmp3(5253).HeaderSubmittingIndicator;
    } else {
      fn = (arg0) => {
        const obj = {};
...
prototype["renderChannelInfo"] = function renderChannelInfo() {
  ...
  let obj = require(15782) /* getIsChannelNameSettingEditable */;
  ...
  obj[3] = require(4475) /* computeChannelName */.computeChannelName(channel, mergeGuildAvatar, upsertRelationship);
  ...
  if (!hasItem) {
    ...
    obj1[2] = importDefault(3925).translateSurrogatesToInlineEmoji(channel.topic);
    ...
    closure_43(tmp3(7899).TextArea, obj1);
    const obj5 = importDefault(3925);
  }
};
  ...
  if (channel.type === constants2.GUILD_TEXT) {
    ...
    if (tmp2) {
      ...
      if (!obj.isIOS()) {
        ...
        obj[1] = tmp5(4498).isChannelOrGuildNSFW(channel);
        ...
        obj[4] = stringResult;
        obj[2] = closure_43(tmp5(5689).TableSwitchRow, obj);
        tmp7Result = tmp7(tmp5(5688).TableRowGroup, obj, "nsfw-section");
...
prototype["renderThreadSpoiler"] = function renderThreadSpoiler() {
  ...
  if (channel.isThread()) {
    ...
    obj[2] = callback3(require(5689) /* TableSwitchRow */.TableSwitchRow, obj);
    tmp = callback3(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj, "thread-spoiler-section");
  }
  return tmp;
};
prototype["renderSlowmode"] = function renderSlowmode() {
  ...
  let obj = require(15781) /* getSecondsSliderLabel */;
  const intl = require(1236) /* getSystemLocale */.intl;
  ...
  const items1 = [callback3(require(4281) /* Text */.Text, obj2), callback3(require(4281) /* Text */.Text, { variant: "text-md/medium", color: "text-muted", children: secondsSliderLabel })];
  obj1[1] = items1;
  ...
  items2[1] = callback3(require(13345) /* Slider */.Slider, obj3);
  obj[1] = items2;
  obj[2] = callback4(require(5356) /* PressableCard */.Card, obj);
  items.push(callback3(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj, "slowmode-section"));
  return items;
};
prototype["renderAutoArchiveDuration"] = function renderAutoArchiveDuration() {
  ...
  if (channel.isThread()) {
    if (canManageThread) {
      ...
      return closure_43(tmp5(15783).AutoArchiveDurationOptions, obj);
    }
  }
  return null;
};
prototype["renderInvitable"] = function renderInvitable() {
  ...
  if (null != channel.threadMetadata) {
    ...
    if (channel.type === constants2.PRIVATE_THREAD) {
      ...
      obj[2] = callback3(require(5689) /* TableSwitchRow */.TableSwitchRow, obj);
      tmp3 = callback3(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj, "thread-invitable-section");
    }
  }
  return tmp3;
};
prototype["renderDefaultAutoArchiveDuration"] = function renderDefaultAutoArchiveDuration() {
  ...
  if (set2.has(channel.type)) {
    ...
    if (props.canManageChannels) {
      ...
      obj[1] = require(8279) /* getAutoArchiveOptions */.getAutoArchiveDuration(channel, null);
      obj[2] = channel;
      obj[3] = this.handleDefaultAutoArchiveDurationChange;
      const obj2 = require(8279) /* getAutoArchiveOptions */;
      ...
      obj[4] = stringResult;
      tmp2(require(15783) /* AutoArchiveDurationOptions */.AutoArchiveDurationOptions, obj);
      isForumLikeChannelResult = channel.isForumLikeChannel();
    }
  }
  return tmp;
...
prototype["renderDefaultSortOrder"] = function renderDefaultSortOrder() {
  ...
  if (channel.isForumLikeChannel()) {
    if (props.canManageChannels) {
      ...
      const items = [callback3(require(7907) /* TableRadioRow */.TableRadioRow, obj), ];
      obj = { label: null, value: null };
      const intl4 = require(1236) /* getSystemLocale */.intl;
      obj[0] = intl4.string(require(1236) /* getSystemLocale */.t.w28f3F);
      obj[1] = require(1381) /* set */.ThreadSortOrder.CREATION_DATE;
      items[1] = callback3(require(7907) /* TableRadioRow */.TableRadioRow, obj);
      obj[5] = items;
      return callback4(require(7908) /* context */.TableRadioGroup, obj);
    }
  }
  return null;
};
      ...
      if (features.has(constants4.NEWS)) {
        ...
        if (channel.id !== rulesChannelId) {
          ...
          if (channel.id !== prop) {
            ...
            obj[2] = callback3(require(5689) /* TableSwitchRow */.TableSwitchRow, obj1);
            items.push(callback3(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj, "announcement-section"));
            return items;
          }
        }
      }
...
prototype["renderBitrateSettings"] = function renderBitrateSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (canManageChannels) {
      ...
      items2[1] = callback3(require(13345) /* Slider */.Slider, obj5);
      obj1[0] = items2;
      obj[2] = callback4(require(5356) /* PressableCard */.Card, obj1);
      items.push(callback3(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj, "bitrate-section"));
      return items;
    }
  }
  return null;
...
prototype["renderVideoQualityModeSettings"] = function renderVideoQualityModeSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (canManageChannels) {
      ...
      const items1 = [callback3(require(7907) /* TableRadioRow */.TableRadioRow, obj), ];
      obj = { label: null, value: null };
      const intl4 = tmp2(1236).intl;
      obj[0] = intl4.string(require(1236) /* getSystemLocale */.t["7jOoJE"]);
      obj[1] = constants7.FULL;
      items1[1] = callback3(require(7907) /* TableRadioRow */.TableRadioRow, obj);
      obj[5] = items1;
      items.push(closure_44(require(7908) /* context */.TableRadioGroup, obj, "video-quality-section"));
      return items;
    }
  }
  return null;
...
prototype["renderUserLimitSettings"] = function renderUserLimitSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (props.canManageChannels) {
      ...
      const items1 = [closure_43(tmp7(4281).Text, obj2), ];
      const obj3 = { variant: "text-md/medium", color: "text-muted", children: null };
      obj3[2] = stringResult;
      items1[1] = closure_43(tmp7(4281).Text, obj3);
      obj1[1] = items1;
      const items2 = [callback4(View, obj1), ];
      ...
      items2[1] = closure_43(tmp7(13345).Slider, obj4);
      obj[0] = items2;
      obj[2] = callback4(tmp7(5356).Card, obj);
      items.push(closure_43(tmp7(5688).TableRowGroup, obj, "channel-user-limit"));
      return items;
    }
  }
  return null;
    ...
    if (self.showVoiceSettings()) {
      if (tmp) {
        if (!channel.isGuildStageVoice()) {
          ...
          obj = { text: null };
          obj[0] = name;
          obj[1] = callback3(channel(5354).TableRow.TrailingText, obj);
          obj[3] = tmp2;
          obj[4] = function onPress() {
            return self.pushScreen(outer1_25.CHANGE_RTC_REGION);
          };
          obj[3] = callback3(channel(5354).TableRow, obj);
          items.push(callback3(channel(5688).TableRowGroup, obj, "channel-region-override"));
          return items;
        }
      }
    }
...
prototype["showVoiceSettings"] = function showVoiceSettings() {
  ...
  if (hasItem) {
    ...
    if (!enabled) {
      const VoiceInThreadsExperiment = require(5810) /* useCanUnarchiveThread */.VoiceInThreadsExperiment;
...
prototype["renderPermissions"] = function renderPermissions() {
  ...
  if (!this.props.canManageRoles) {
    ...
    obj[0] = stringResult;
    ShieldUserIcon = ShieldUserIcon(8929).ShieldUserIcon;
    tmp2Result = tmp2(ShieldUserIcon, {});
    obj[2] = tmp2Result;
    obj[3] = function onPress() {
      return self.pushScreen(outer1_25.PERMISSIONS, { origin: outer1_25.OVERVIEW });
    };
    obj[2] = closure_43(self(5354).TableRow, obj);
    tmp2Result = tmp2(self(5688).TableRowGroup, obj);
  }
};
prototype["renderSettingsSection"] = function renderSettingsSection(items) {
  ...
  if (items.length > 0) {
    ...
    obj[1] = items;
    tmp = callback3(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj);
  }
  return tmp;
};
prototype["renderCommonSettingsSection"] = function renderCommonSettingsSection() {
  ...
  if (tmp2) {
    ...
    obj[2] = callback3(channel(9059).BellIcon, {});
    obj[3] = function onPress() {
      if (channel.isThread()) {
    ...
    items.push(callback3(channel(5354).TableRow, obj, "rowNotifications"));
  }
  if (callback2(channel.type)) {
    ...
    items.push(callback3(channel(5354).TableRow, obj, "rowPinnedMessages"));
  }
  if (canManageChannels) {
  ...
  if (canManageChannels) {
    ...
    obj1[2] = callback3(channel(4229).LinkIcon, {});
    obj1[3] = function onPress() {
      return self.pushScreen(outer1_25.INSTANT_INVITES);
    };
    items.push(callback3(channel(5354).TableRow, obj1, "rowInstantInvites"));
  }
...
prototype["renderDefaultForumLayout"] = function renderDefaultForumLayout() {
  ...
  if (!channel.isForumChannel()) {
    ...
    obj1[0] = stringResult;
    obj[1] = closure_43(self(5354).TableRow.TrailingText, obj1);
    if (channel.defaultForumLayout === GridSquareIcon(1382).ForumLayout.GRID) {
      GridSquareIcon = GridSquareIcon(15784).GridSquareIcon;
      obj = {};
      let tmpResult = tmp(GridSquareIcon, obj);
    } else {
      tmpResult = tmp(GridSquareIcon(8357).ListViewIcon, {});
    }
    obj[3] = tmpResult;
    obj[4] = function onPress() {
      return self.pushScreen(outer1_25.DEFAULT_FORUM_LAYOUT);
    };
    obj[2] = closure_43(self(5354).TableRow, obj, "forumDefaultLayout");
    tmpResult = tmp(self(5688).TableRowGroup, obj, "default-forum-layout");
  }
};
  ...
  if (hasJoinedThread) {
    ...
    if (isArchivedThread) {
      ...
      if (canUnarchiveThread) {
        ...
        obj[0] = callback3(tmp2(4249).ClockIcon, {});
        ...
        callback3(tmp2(5354).TableRow, obj);
    ...
    if (!isArchivedThread) {
      ...
      if (canManageThread) {
        ...
        obj[0] = callback3(tmp2(4239).XLargeIcon, {});
        const intl3 = tmp2(1236).intl;
    ...
    if (isThreadModerator) {
      ...
      if (isLockedThread) {
        ...
        obj1[0] = callback3(tmp2(4804).LockIcon, {});
        const intl4 = tmp2(1236).intl;
        ...
        callback3(tmp2(5354).TableRow, obj1);
    ...
    if (isThreadModerator) {
      ...
      if (!isLockedThread) {
        ...
        obj2[0] = callback3(tmp2(4804).LockIcon, {});
        ...
        callback3(tmp2(5354).TableRow, obj2);
    ...
    obj4[0] = callback3(tmp2(4229).LinkIcon, {});
    ...
    items[5] = callback3(tmp2(5354).TableRow, obj4);
    obj3[1] = items;
    return closure_44(tmp4, obj3);
  } else {
    obj = { icon: null, label: null, onPress: null };
    obj[0] = callback3(tmp2(9639).GroupPlusIcon, {});
...
prototype["renderDeleteButton"] = function renderDeleteButton() {
  ...
  if (canManageChannels) {
    ...
    if (!hasJoinedThread) {
      ...
      obj[1] = callback3(tmp8(4244).TrashIcon, { color: "text-feedback-critical" });
      obj[2] = stringResult;
      obj[3] = this.handleDeleteChannel;
      items[1] = callback3(tmp8(5354).TableRow, obj);
      obj[1] = items;
      tmp = tmp13(tmp14, obj);
    } else {
      obj = { variant: "danger", icon: null, label: null, onPress: null };
      obj[1] = callback3(tmp8(4227).UserMinusIcon, { color: "text-feedback-critical" });
      ...
      callback3(tmp8(5354).TableRow, obj);
      const tmp17 = callback3;
    }
    tmp13 = closure_44;
  }
  ...
  if (channel.isForumLikeChannel()) {
    ...
    if (channel.availableTags.length > 0) {
      ...
      if (tmp3) {
        ...
        obj2[0] = tmp10(tmp7(9350).PlusSmallIcon, obj3);
        obj2[2] = function onPress() {
          return self.handlePressTag();
        };
        const intl3 = tmp7(1236).intl;
        obj2[3] = intl3.string(tmp7(1236).t["/jubeD"]);
        obj1[1] = tmp10(tmp7(7672).IconButton, obj2);
    ...
    const items1 = [closure_43(canManageChannels(5688).TableRowGroup, obj), , , ];
    tmp10Result = null;
    if (channel.availableTags.length <= 0) {
      ...
      obj5[4] = tmp10(tmp7(4281).Text, obj6);
      tmp10Result = tmp10(tmp7(4827).PressableOpacity, obj5);
    }
    ...
    if (tmp10Result1) {
      ...
      obj7[2] = error;
      tmp10Result1 = tmp10(tmp7(4281).Text, obj7);
    }
    ...
    obj8[1] = closure_43(canManageChannels(5689).TableSwitchRow, obj9);
    items1[3] = closure_43(canManageChannels(5688).TableRowGroup, obj8);
    obj[1] = items1;
    return closure_44(canManageChannels(4693).Stack, obj);
  } else {
    return null;
  }
};
prototype["renderShowMediaDownloadOptions"] = function renderShowMediaDownloadOptions() {
  ...
  if (channel.isMediaChannel()) {
    ...
    obj[1] = callback3(require(5689) /* TableSwitchRow */.TableSwitchRow, obj);
    tmp = callback3(require(5688) /* TableRowGroupTitle */.TableRowGroup, obj);
  }
  return tmp;
};
prototype["renderCategory"] = function renderCategory() {
  ...
  if (props.hasCategories) {
    if (props.channel.type !== constants2.GUILD_CATEGORY) {
      ...
      obj[0] = callback3(tmp7(15179).FolderPlusIcon, {});
      const intl2 = tmp7(1236).intl;
      obj[1] = intl2.string(tmp7(1236).t.vHCZwr);
      obj = { text: null };
      obj[0] = stringResult;
      obj[2] = callback3(tmp7(5354).TableRow.TrailingText, obj);
      ...
      obj[4] = fn;
      obj1[1] = callback3(tmp7(5354).TableRow, obj);
      return callback3(tmp7(5688).TableRowGroup, obj1);
    }
  }
  return null;
};
prototype["renderThreadSettings"] = function renderThreadSettings() {
  ...
  obj[2] = items;
  obj[0] = callback4(require(4693) /* Stack */.Stack, obj);
  return callback3(require(7890) /* Form */.Form, obj);
};
