...
// Function ID: 15903
// Name: PinImage
// Dependencies: [5, 19, 17, 3950, 1395, 1434, 8019, 1391, 1980, 1910, 3948, 4315, 15903, 3957, 1922, 15904, 676, 1398, 5924, 1235, 505, 21, 4303, 712, 589, 9728, 4031, 12, 15905, 4498, 1236, 5270, 8388, 8018, 4021, 9883, 8360, 4486, 3961, 1403, 1363, 15906, 9005, 4643, 4299, 9027, 4494, 4732, 4159, 4202, 15907, 7792, 7978, 500, 5767, 5768, 4517, 5376, 13439, 15908, 8361, 7987, 7986, 1400, 1402, 1993, 5374, 5889, 9012, 9142, 10199, 4247, 1401, 15909, 8440, 9691, 14209, 9726, 7225, 4267, 4257, 4823, 9730, 4245, 4262, 4712, 10196, 7753, 9438, 4846, 15294, 7969, 1499, 2]
// Exports: default

// Module 15902 (PinImage)
...
prototype["updateNavigation"] = function updateNavigation(submitting, hasChanges) {
  ...
  if (isThread) {
    ...
    if (submitting) {
      let fn = tmp3(5270).HeaderSubmittingIndicator;
    } else {
      fn = (arg0) => {
        const obj = {};
...
prototype["renderChannelInfo"] = function renderChannelInfo() {
  ...
  let obj = require(15907) /* getIsChannelNameSettingEditable */;
  ...
  const TextInput = tmp3(7792).TextInput;
  obj[3] = require(4494) /* computeChannelName */.computeChannelName(channel, mergeGuildAvatar, markAllUserIdListsStale);
  ...
  if (!hasItem) {
    ...
    obj1[2] = importDefault(3961).translateSurrogatesToInlineEmoji(channel.topic);
    ...
    closure_43(tmp3(7978).TextArea, obj1);
  ...
  if (channel.type === constants2.GUILD_TEXT) {
    ...
    if (tmp2) {
      ...
      if (!obj.isIOS()) {
        ...
        obj[1] = tmp5(4517).isChannelOrGuildNSFW(channel);
        ...
        obj[4] = stringResult;
        obj[2] = closure_43(tmp5(5768).TableSwitchRow, obj);
        tmp7Result = tmp7(tmp5(5767).TableRowGroup, obj, "nsfw-section");
...
prototype["renderThreadSpoiler"] = function renderThreadSpoiler() {
  ...
  if (channel.isThread()) {
    ...
    obj[2] = callback3(require(5768) /* TableSwitchRow */.TableSwitchRow, obj);
    tmp = callback3(require(5767) /* TableRowGroupTitle */.TableRowGroup, obj, "thread-spoiler-section");
  }
  return tmp;
};
prototype["renderSlowmode"] = function renderSlowmode() {
  ...
  let obj = require(15906) /* getSecondsSliderLabel */;
  const intl = require(1236) /* getSystemLocale */.intl;
  ...
  const items1 = [callback3(require(4299) /* Text */.Text, obj2), callback3(require(4299) /* Text */.Text, { variant: "text-md/medium", color: "text-muted", children: secondsSliderLabel })];
  obj1[1] = items1;
  ...
  items2[1] = callback3(require(13439) /* Slider */.Slider, obj3);
  obj[1] = items2;
  obj[2] = callback4(require(5376) /* PressableCard */.Card, obj);
  items.push(callback3(require(5767) /* TableRowGroupTitle */.TableRowGroup, obj, "slowmode-section"));
  return items;
};
prototype["renderAutoArchiveDuration"] = function renderAutoArchiveDuration() {
  ...
  if (channel.isThread()) {
    if (canManageThread) {
      ...
      return closure_43(tmp5(15908).AutoArchiveDurationOptions, obj);
    }
  }
  return null;
};
prototype["renderInvitable"] = function renderInvitable() {
  ...
  if (null != channel.threadMetadata) {
    ...
    if (channel.type === constants2.PRIVATE_THREAD) {
      ...
      obj[2] = callback3(require(5768) /* TableSwitchRow */.TableSwitchRow, obj);
      tmp3 = callback3(require(5767) /* TableRowGroupTitle */.TableRowGroup, obj, "thread-invitable-section");
    }
  }
  return tmp3;
};
prototype["renderDefaultAutoArchiveDuration"] = function renderDefaultAutoArchiveDuration() {
  ...
  if (set2.has(channel.type)) {
    ...
    if (props.canManageChannels) {
      ...
      obj[1] = require(8361) /* getAutoArchiveOptions */.getAutoArchiveDuration(channel, null);
      obj[2] = channel;
      obj[3] = this.handleDefaultAutoArchiveDurationChange;
      const obj2 = require(8361) /* getAutoArchiveOptions */;
      ...
      obj[4] = stringResult;
      tmp2(require(15908) /* AutoArchiveDurationOptions */.AutoArchiveDurationOptions, obj);
      isForumLikeChannelResult = channel.isForumLikeChannel();
    }
  }
  return tmp;
...
prototype["renderDefaultSortOrder"] = function renderDefaultSortOrder() {
  ...
  if (channel.isForumLikeChannel()) {
    if (props.canManageChannels) {
      ...
      obj[1] = require(1400) /* set */.ThreadSortOrder.LATEST_ACTIVITY;
      const items = [callback3(require(7986) /* TableRadioRow */.TableRadioRow, obj), ];
      obj = { label: null, value: null };
      const intl4 = require(1236) /* getSystemLocale */.intl;
      obj[0] = intl4.string(require(1236) /* getSystemLocale */.t.w28f3F);
      obj[1] = require(1400) /* set */.ThreadSortOrder.CREATION_DATE;
      items[1] = callback3(require(7986) /* TableRadioRow */.TableRadioRow, obj);
      obj[5] = items;
      return callback4(require(7987) /* context */.TableRadioGroup, obj);
    }
  }
  return null;
};
prototype["renderDefaultTagSetting"] = function renderDefaultTagSetting() {
  ...
  if (channel.isForumLikeChannel()) {
    if (props.canManageChannels) {
      ...
      obj[1] = require(1402) /* set */.ThreadSearchTagSetting.MATCH_SOME;
      const items = [callback3(require(7986) /* TableRadioRow */.TableRadioRow, obj), ];
      obj = { label: null, value: null };
      const intl4 = require(1236) /* getSystemLocale */.intl;
      obj[0] = intl4.string(require(1236) /* getSystemLocale */.t.FCXUu0);
      obj[1] = require(1402) /* set */.ThreadSearchTagSetting.MATCH_ALL;
      items[1] = callback3(require(7986) /* TableRadioRow */.TableRadioRow, obj);
      obj[5] = items;
      return callback4(require(7987) /* context */.TableRadioGroup, obj);
    }
      ...
      if (features.has(constants4.NEWS)) {
        ...
        if (channel.id !== rulesChannelId) {
          ...
          if (channel.id !== prop) {
            ...
            obj[0] = importDefault(1993).getArticleURL(constants5.ANNOUNCEMENT_CHANNELS);
            ...
            obj[2] = callback3(require(5768) /* TableSwitchRow */.TableSwitchRow, obj1);
            items.push(callback3(require(5767) /* TableRowGroupTitle */.TableRowGroup, obj, "announcement-section"));
            return items;
          }
        }
      }
...
prototype["renderBitrateSettings"] = function renderBitrateSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (canManageChannels) {
      ...
      items2[1] = callback3(require(13439) /* Slider */.Slider, obj5);
      obj1[0] = items2;
      obj[2] = callback4(require(5376) /* PressableCard */.Card, obj1);
      items.push(callback3(require(5767) /* TableRowGroupTitle */.TableRowGroup, obj, "bitrate-section"));
      return items;
    }
  }
  return null;
...
prototype["renderVideoQualityModeSettings"] = function renderVideoQualityModeSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (canManageChannels) {
      ...
      const items1 = [callback3(require(7986) /* TableRadioRow */.TableRadioRow, obj), ];
      obj = { label: null, value: null };
      const intl4 = tmp2(1236).intl;
      obj[0] = intl4.string(require(1236) /* getSystemLocale */.t["7jOoJE"]);
      obj[1] = constants7.FULL;
      items1[1] = callback3(require(7986) /* TableRadioRow */.TableRadioRow, obj);
      obj[5] = items1;
      items.push(closure_44(require(7987) /* context */.TableRadioGroup, obj, "video-quality-section"));
      return items;
    }
  }
  return null;
...
prototype["renderUserLimitSettings"] = function renderUserLimitSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (props.canManageChannels) {
      ...
      const items1 = [closure_43(tmp7(4299).Text, obj2), ];
      const obj3 = { variant: "text-md/medium", color: "text-muted", children: null };
      obj3[2] = stringResult;
      items1[1] = closure_43(tmp7(4299).Text, obj3);
      obj1[1] = items1;
      const items2 = [callback4(View, obj1), ];
      ...
      items2[1] = closure_43(tmp7(13439).Slider, obj4);
      obj[0] = items2;
      obj[2] = callback4(tmp7(5376).Card, obj);
      items.push(closure_43(tmp7(5767).TableRowGroup, obj, "channel-user-limit"));
      return items;
    }
  }
  return null;
    ...
    if (self.showVoiceSettings()) {
      if (tmp) {
        if (!channel.isGuildStageVoice()) {
          ...
          obj = { text: null };
          obj[0] = name;
          obj[1] = callback3(channel(5374).TableRow.TrailingText, obj);
          obj[3] = tmp2;
          obj[4] = function onPress() {
            return self.pushScreen(outer1_25.CHANGE_RTC_REGION);
          };
          obj[3] = callback3(channel(5374).TableRow, obj);
          items.push(callback3(channel(5767).TableRowGroup, obj, "channel-region-override"));
          return items;
        }
      }
    }
...
prototype["showVoiceSettings"] = function showVoiceSettings() {
  ...
  if (hasItem) {
    ...
    if (!enabled) {
      const VoiceInThreadsExperiment = require(5889) /* useCanUnarchiveThread */.VoiceInThreadsExperiment;
...
prototype["renderPermissions"] = function renderPermissions() {
  ...
  if (!this.props.canManageRoles) {
    ...
    obj[0] = stringResult;
    ShieldUserIcon = ShieldUserIcon(9012).ShieldUserIcon;
    tmp2Result = tmp2(ShieldUserIcon, {});
    obj[2] = tmp2Result;
    obj[3] = function onPress() {
      return self.pushScreen(outer1_25.PERMISSIONS, { origin: outer1_25.OVERVIEW });
    };
    obj[2] = closure_43(self(5374).TableRow, obj);
    tmp2Result = tmp2(self(5767).TableRowGroup, obj);
  }
};
prototype["renderSettingsSection"] = function renderSettingsSection(items) {
  ...
  if (items.length > 0) {
    ...
    obj[1] = items;
    tmp = callback3(require(5767) /* TableRowGroupTitle */.TableRowGroup, obj);
  }
  return tmp;
};
prototype["renderCommonSettingsSection"] = function renderCommonSettingsSection() {
  ...
  if (tmp2) {
    ...
    obj[2] = callback3(channel(9142).BellIcon, {});
    obj[3] = function onPress() {
      if (channel.isThread()) {
    ...
    items.push(callback3(channel(5374).TableRow, obj, "rowNotifications"));
  }
  if (callback2(channel.type)) {
    ...
    items.push(callback3(channel(5374).TableRow, obj, "rowPinnedMessages"));
  }
  if (canManageChannels) {
  ...
  if (canManageChannels) {
    ...
    obj1[2] = callback3(channel(4247).LinkIcon, {});
    obj1[3] = function onPress() {
      return self.pushScreen(outer1_25.INSTANT_INVITES);
    };
    items.push(callback3(channel(5374).TableRow, obj1, "rowInstantInvites"));
  }
...
prototype["renderDefaultForumLayout"] = function renderDefaultForumLayout() {
  ...
  if (!channel.isForumChannel()) {
    ...
    obj1[0] = stringResult;
    obj[1] = closure_43(self(5374).TableRow.TrailingText, obj1);
    if (channel.defaultForumLayout === GridSquareIcon(1401).ForumLayout.GRID) {
      GridSquareIcon = GridSquareIcon(15909).GridSquareIcon;
      obj = {};
      let tmpResult = tmp(GridSquareIcon, obj);
    } else {
      tmpResult = tmp(GridSquareIcon(8440).ListViewIcon, {});
    }
    obj[3] = tmpResult;
    obj[4] = function onPress() {
      return self.pushScreen(outer1_25.DEFAULT_FORUM_LAYOUT);
    };
    obj[2] = closure_43(self(5374).TableRow, obj, "forumDefaultLayout");
    tmpResult = tmp(self(5767).TableRowGroup, obj, "default-forum-layout");
  }
};
  ...
  if (hasJoinedThread) {
    ...
    if (isArchivedThread) {
      ...
      if (canUnarchiveThread) {
        ...
        obj[0] = callback3(tmp2(4267).ClockIcon, {});
        ...
        callback3(tmp2(5374).TableRow, obj);
    ...
    if (!isArchivedThread) {
      ...
      if (canManageThread) {
        ...
        obj[0] = callback3(tmp2(4257).XLargeIcon, {});
        const intl3 = tmp2(1236).intl;
    ...
    if (isThreadModerator) {
      ...
      if (isLockedThread) {
        ...
        obj1[0] = callback3(tmp2(4823).LockIcon, {});
        const intl4 = tmp2(1236).intl;
        ...
        callback3(tmp2(5374).TableRow, obj1);
    ...
    if (isThreadModerator) {
      ...
      if (!isLockedThread) {
        ...
        obj2[0] = callback3(tmp2(4823).LockIcon, {});
        ...
        callback3(tmp2(5374).TableRow, obj2);
    ...
    obj4[0] = callback3(tmp2(4247).LinkIcon, {});
    ...
    items[5] = callback3(tmp2(5374).TableRow, obj4);
    obj3[1] = items;
    return closure_44(tmp4, obj3);
  } else {
    obj = { icon: null, label: null, onPress: null };
    obj[0] = callback3(tmp2(9726).GroupPlusIcon, {});
...
prototype["renderDeleteButton"] = function renderDeleteButton() {
  ...
  if (canManageChannels) {
    ...
    if (!hasJoinedThread) {
      ...
      obj[1] = callback3(tmp8(4262).TrashIcon, { color: "text-feedback-critical" });
      obj[2] = stringResult;
      obj[3] = this.handleDeleteChannel;
      items[1] = callback3(tmp8(5374).TableRow, obj);
      obj[1] = items;
      tmp = tmp13(tmp14, obj);
    } else {
      obj = { variant: "danger", icon: null, label: null, onPress: null };
      obj[1] = callback3(tmp8(4245).UserMinusIcon, { color: "text-feedback-critical" });
      ...
      callback3(tmp8(5374).TableRow, obj);
      const tmp17 = callback3;
    }
    tmp13 = closure_44;
  }
  ...
  if (channel.isForumLikeChannel()) {
    ...
    if (channel.availableTags.length > 0) {
      ...
      if (tmp3) {
        ...
        obj2[0] = tmp10(tmp7(9438).PlusSmallIcon, obj3);
        obj2[2] = function onPress() {
          return self.handlePressTag();
        };
        const intl3 = tmp7(1236).intl;
        obj2[3] = intl3.string(tmp7(1236).t["/jubeD"]);
        obj1[1] = tmp10(tmp7(7753).IconButton, obj2);
    ...
    const items1 = [closure_43(canManageChannels(5767).TableRowGroup, obj), , , ];
    tmp10Result = null;
    if (channel.availableTags.length <= 0) {
      ...
      obj5[4] = tmp10(tmp7(4299).Text, obj6);
      tmp10Result = tmp10(tmp7(4846).PressableOpacity, obj5);
    }
    ...
    if (tmp10Result1) {
      ...
      obj7[2] = error;
      tmp10Result1 = tmp10(tmp7(4299).Text, obj7);
    }
    ...
    obj8[1] = closure_43(canManageChannels(5768).TableSwitchRow, obj9);
    items1[3] = closure_43(canManageChannels(5767).TableRowGroup, obj8);
    obj[1] = items1;
    return closure_44(canManageChannels(4712).Stack, obj);
  } else {
    return null;
  }
};
prototype["renderShowMediaDownloadOptions"] = function renderShowMediaDownloadOptions() {
  ...
  if (channel.isMediaChannel()) {
    ...
    obj[1] = callback3(require(5768) /* TableSwitchRow */.TableSwitchRow, obj);
    tmp = callback3(require(5767) /* TableRowGroupTitle */.TableRowGroup, obj);
  }
  return tmp;
};
  ...
  if (props.hasCategories) {
    if (props.channel.type !== constants2.GUILD_CATEGORY) {
      if (null == category) {
        ...
        let obj = self(4494);
        stringResult = obj.computeChannelName(category, mergeGuildAvatar, markAllUserIdListsStale);
        tmp7 = self;
      }
      obj = { icon: null, label: null, trailing: null, arrow: null, onPress: null };
      obj[0] = callback3(tmp7(15294).FolderPlusIcon, {});
      const intl2 = tmp7(1236).intl;
      obj[1] = intl2.string(tmp7(1236).t.vHCZwr);
      obj = { text: null };
      obj[0] = stringResult;
      obj[2] = callback3(tmp7(5374).TableRow.TrailingText, obj);
      ...
      obj[4] = fn;
      obj1[1] = callback3(tmp7(5374).TableRow, obj);
      return callback3(tmp7(5767).TableRowGroup, obj1);
    }
  }
  return null;
};
prototype["renderThreadSettings"] = function renderThreadSettings() {
  ...
  obj[2] = items;
  obj[0] = callback4(require(4712) /* Stack */.Stack, obj);
