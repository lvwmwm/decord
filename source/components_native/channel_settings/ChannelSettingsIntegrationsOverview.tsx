...
// Dependencies: [19, 1372, 676, 21, 1480, 5616, 5649, 1236, 5315, 1297, 1416, 4285, 712, 589, 7777, 4693, 15680, 15783, 2]
// Exports: default

// Module 15782 (LinkedLobbyFormSection)
import "noop";
...
export default function ConnectedChannelSettingsIntegrationsOverview(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    if (canManageWebhooks) {
      ...
      obj3[2] = tmp6(tmp(15680).WebhookIcon, {});
      obj3[4] = function onPress() {
        return arr.push(outer1_4.WEBHOOKS);
      };
      const items1 = [tmp6(tmp(5315).TableRow, obj3), ];
      ...
      obj4[2] = tmp6(tmp(15783).ChannelsFollowedIcon, {});
      obj4[4] = function onPress() {
        return arr.push(outer1_4.CHANNELS_FOLLOWED);
      };
      items1[1] = tmp6(tmp(5315).TableRow, obj4);
      obj2[1] = items1;
      canManageWebhooks = tmp7(tmp(5649).TableRowGroup, obj2);
    }
    ...
    tmp6Result = tmp6(tmp(7777).Form, obj);
  }
  return tmp6Result;
};
