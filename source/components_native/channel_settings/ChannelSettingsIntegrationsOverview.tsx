...
// Dependencies: [19, 1390, 1386, 673, 21, 1498, 7108, 5642, 1233, 5560, 1296, 1431, 4481, 709, 586, 8523, 4934, 16649, 16761, 2]
// Exports: default

// Module 16760 (LinkedLobbyFormSection)
...
function LinkedLobbyFormSection(channel) {
  ...
  if (null != getOrFetchApplication) {
    ...
    obj[2] = callback(tmp(5560).TableRow, obj);
    tmp5 = callback(tmp(5642).TableRowGroup, obj);
...
export default function ConnectedChannelSettingsIntegrationsOverview(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    if (canManageWebhooks) {
      ...
      obj2[2] = tmp6(tmp(16649).WebhookIcon, {});
      obj2[4] = function onPress() {
        return arr.push(closure_1_5.WEBHOOKS);
      };
      const items1 = [tmp6(tmp(5560).TableRow, obj2), ];
      ...
      if (hasItem) {
        ...
        obj3[2] = tmp6(tmp(16761).ChannelsFollowedIcon, {});
        obj3[4] = function onPress() {
          return arr.push(closure_1_5.CHANNELS_FOLLOWED);
        };
        hasItem = tmp6(tmp(5560).TableRow, obj3);
      }
      const obj4 = { hasIcons: true, children: null };
      items1[1] = hasItem;
      obj4[1] = items1;
      canManageWebhooks = tmp7(tmp(5642).TableRowGroup, obj4);
    }
    ...
    obj[2] = items2;
    obj[1] = closure_7(tmp(4934).Stack, obj);
    tmp6Result = tmp6(tmp(8523).Form, obj);
  }
  return tmp6Result;
};
