...
// Dependencies: [19, 1372, 676, 21, 1480, 5655, 5688, 1236, 5354, 1297, 1416, 4285, 712, 589, 7890, 4693, 15699, 15804, 2]
// Exports: default

// Module 15803 (LinkedLobbyFormSection)
import "noop";
...
function LinkedLobbyFormSection(channel) {
  ...
  if (null != getOrFetchApplication) {
    ...
    obj[2] = callback(tmp(5354).TableRow, obj);
    tmp5 = callback(tmp(5688).TableRowGroup, obj);
...
export default function ConnectedChannelSettingsIntegrationsOverview(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    if (canManageWebhooks) {
      ...
      obj3[2] = tmp6(tmp(15699).WebhookIcon, {});
      obj3[4] = function onPress() {
        return arr.push(outer1_4.WEBHOOKS);
      };
      const items1 = [tmp6(tmp(5354).TableRow, obj3), ];
      ...
      obj4[2] = tmp6(tmp(15804).ChannelsFollowedIcon, {});
      obj4[4] = function onPress() {
        return arr.push(outer1_4.CHANNELS_FOLLOWED);
      };
      items1[1] = tmp6(tmp(5354).TableRow, obj4);
      obj2[1] = items1;
      canManageWebhooks = tmp7(tmp(5688).TableRowGroup, obj2);
    }
    ...
    obj[2] = items2;
    obj[1] = closure_6(tmp(4693).Stack, obj);
    tmp6Result = tmp6(tmp(7890).Form, obj);
  }
  return tmp6Result;
};
