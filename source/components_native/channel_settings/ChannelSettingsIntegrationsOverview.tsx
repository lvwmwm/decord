...
// Dependencies: [19, 1372, 676, 21, 1480, 5601, 5634, 1236, 5300, 1297, 1416, 4255, 712, 589, 7749, 4663, 15661, 15764, 2]
// Exports: default

// Module 15763 (LinkedLobbyFormSection)
import "noop";
...
function LinkedLobbyFormSection(channel) {
  ...
  if (null != getOrFetchApplication) {
    ...
    obj[2] = callback(tmp(5300).TableRow, obj);
    tmp5 = callback(tmp(5634).TableRowGroup, obj);
...
export default function ConnectedChannelSettingsIntegrationsOverview(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    if (canManageWebhooks) {
      ...
      obj3[2] = tmp6(tmp(15661).WebhookIcon, {});
      obj3[4] = function onPress() {
        return arr.push(outer1_4.WEBHOOKS);
      };
      const items1 = [tmp6(tmp(5300).TableRow, obj3), ];
      ...
      obj4[2] = tmp6(tmp(15764).ChannelsFollowedIcon, {});
      obj4[4] = function onPress() {
        return arr.push(outer1_4.CHANNELS_FOLLOWED);
      };
      items1[1] = tmp6(tmp(5300).TableRow, obj4);
      obj2[1] = items1;
      canManageWebhooks = tmp7(tmp(5634).TableRowGroup, obj2);
    }
    ...
    obj[2] = items2;
    obj[1] = closure_6(tmp(4663).Stack, obj);
    tmp6Result = tmp6(tmp(7749).Form, obj);
  }
  return tmp6Result;
};
