...
// Dependencies: [19, 17, 676, 1930, 21, 4189, 712, 3901, 698, 8115, 14504, 5141, 8142, 1236, 4717, 8340, 9630, 1297, 7865, 1474, 7866, 1481, 5143, 3771, 7867, 4185, 4395, 5570, 2]
// Exports: default

// Module 14503 (ChangeLogScreen)
...
prototype["renderVideo"] = function renderVideo() {
  ...
  if (null != video) {
    ...
    if (null != youtube_video_id) {
      ...
      const items = [callback(importDefault(14504), obj1), ];
      let tmp6Result = null;
      if (!tmp2) {
  ...
  const items1 = [callback(importDefault(8142), obj6), ];
  ...
  if (null != video) {
    ...
    obj8[6] = tmp.playIcon;
    obj7[4] = tmp12(tmp15(8340), obj8);
    tmp12Result = tmp12(tmp18(4717).PressableOpacity, obj7);
    const tmp15Result = tmp15(8340);
  }
...
prototype["render"] = function render() {
  ...
  return callback(importDefault(7865), obj);
};
