...
// Dependencies: [19, 17, 676, 1978, 21, 4344, 712, 4072, 698, 8889, 14797, 5307, 8915, 1236, 4886, 9102, 10013, 1297, 8231, 1493, 8232, 1500, 5309, 3943, 8233, 4340, 4549, 5822, 2]
// Exports: default
...
function hideChangeLog() {
  importDefault(4549).popWithKey(CHANGELOG_MODAL_KEY);
}
...
prototype["renderVideo"] = function renderVideo() {
  ...
  if (null != video) {
    ...
    if (null != youtube_video_id) {
      ...
      if (!tmp2) {
        ...
        obj2[1] = obj3;
        tmp6Result = tmp6(tmp7(5307), obj2);
        const tmp7Result = tmp7(5307);
      }
      items[1] = tmp6Result;
      obj[2] = items;
  ...
  const items1 = [callback(importDefault(8915), obj6), ];
  ...
  if (null != video) {
    ...
    obj8[6] = tmp.playIcon;
    obj7[4] = tmp12(tmp15(9102), obj8);
    tmp12Result = tmp12(tmp18(4886).PressableOpacity, obj7);
    const tmp15Result = tmp15(9102);
  }
...
prototype["render"] = function render() {
  ...
  return callback(importDefault(8231), obj);
};
...
export default function ChangelogModal() {
  ...
  return callback(require(5822) /* NavigationStack */.Navigator, { screens, initialRouteName: "CHANGELOG" });
};
export { ListItem };
