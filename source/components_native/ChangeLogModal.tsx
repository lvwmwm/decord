...
function hideChangeLog() {
  importDefault(4550).popWithKey(CHANGELOG_MODAL_KEY);
}
...
prototype["renderVideo"] = function renderVideo() {
  ...
  if (null != video) {
    ...
    if (null != youtube_video_id) {
      ...
      if (!tmp2) {
        ...
        obj2[1] = obj3;
        tmp6Result = tmp6(tmp7(5308), obj2);
        const tmp7Result = tmp7(5308);
      }
      items[1] = tmp6Result;
      obj[2] = items;
  ...
  const items1 = [callback(importDefault(8919), obj6), ];
  ...
  if (null != video) {
    ...
    obj8[6] = tmp.playIcon;
    obj7[4] = tmp12(tmp15(9106), obj8);
    tmp12Result = tmp12(tmp18(4887).PressableOpacity, obj7);
    const tmp15Result = tmp15(9106);
  }
...
prototype["render"] = function render() {
  ...
  return callback(importDefault(8235), obj);
};
...
export default function ChangelogModal() {
  ...
  return callback(require(5823) /* NavigationStack */.Navigator, { screens, initialRouteName: "CHANGELOG" });
};
export { ListItem };
