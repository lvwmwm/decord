...
// Dependencies: [32, 19, 17, 21, 4255, 712, 4223, 500, 5322, 5632, 8870, 1236, 4661, 4116, 1297, 4256, 4251, 4666, 4191, 8274, 3837, 5323, 8871, 4101, 2]
// Exports: default

// Module 8869 (ActionSheetHeader)
...
function ActionSheetHeader(handleSubmit) {
  ...
  const BottomSheetTitleHeader = require(5322) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader;
  if (isAndroidResult) {
    obj = { title: null, trailing: null };
    obj[0] = title;
    obj = { onPress: null };
    obj[0] = handleCancel;
    obj[1] = tmp4(tmp(5632).ActionSheetCloseButton, obj);
    ...
    obj1[1] = tmp4(tmp(8870).ActionSheetHeaderPressableText, obj2);
    const obj3 = { onPress: null, label: null };
    obj3[0] = handleSubmit.handleSubmit;
    const intl2 = tmp(1236).intl;
    obj3[1] = intl2.string(tmp(1236).t["R3BPH+"]);
    obj1[2] = tmp4(tmp(8870).ActionSheetHeaderPressableText, obj3);
...
function ActionSheetFooter(arg0) {
  ...
  if (obj.isAndroid()) {
    ...
    obj[6] = handleCancel;
    const items = [callback(tmp2(4666).BaseTextButton, obj), ];
    ...
    obj2[7] = handleSubmit;
    items[1] = callback(tmp2(4666).BaseTextButton, obj2);
    obj[1] = items;
...
export default function DatePickerActionSheet(mode) {
  ...
  const tmp27 = minimumDate(8274)((getTime) => {
    if (null != getTime) {
  ...
  const tmp37 = first;
  const tmp13Result = minimumDate(8871);
  let str2 = "dark";
  ...
  obj[2] = items1;
  return tmp28(maximumDate(5323).BottomSheet, obj);
};
