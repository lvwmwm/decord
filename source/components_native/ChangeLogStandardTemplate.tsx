...
// Function ID: 7866
// Name: LHeading
// Dependencies: [19, 17, 1946, 676, 21, 712, 4189, 1297, 647, 7866, 698, 3886, 3888, 7868, 4179, 5177, 6682, 7870, 1236, 3801, 7872, 7874, 2]
// Exports: changelogRules, getRenderChangelog

// Module 7865 (LHeading)
...
function LinkInner(target) {
  ...
  changelog = target(7866).useChangelog(changelogId, stateFromStores).changelog;
  obj = {
...
const memoResult1 = importAllResult.memo((video) => {
  ...
  items3[1] = callback(id(6682).IconButton, obj4);
  const obj5 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: null, accessibilityLabel: null, onPress: null };
  obj5[3] = callback(id(7874).InstagramNeutralIcon, { size: "sm", color: "interactive-icon-default" });
  ...
  items3[2] = callback(id(6682).IconButton, obj5);
  obj2[2] = items3;
