...
// Function ID: 8303
// Name: LHeading
// Dependencies: [19, 17, 1994, 676, 21, 712, 4661, 1297, 647, 8303, 698, 4090, 4092, 8305, 6807, 6803, 8035, 8309, 1236, 4005, 8311, 8313, 2]
// Exports: changelogRules, getRenderChangelog

// Module 8302 (LHeading)
...
function LinkInner(target) {
  ...
  changelog = target(8303).useChangelog(changelogId, stateFromStores).changelog;
  obj = {
...
const memoResult1 = importAllResult.memo((video) => {
  ...
  let obj2 = importDefault(6807);
  id = changeLog.id;
  let obj3 = importDefault(8305);
  {
    obj = { components: null };
  ...
  obj3[3] = callback(id(8309).XNeutralIcon, { size: "sm", color: "interactive-icon-default" });
  const intl = id(1236).intl;
  obj3[4] = intl.string(id(1236).t["/lXfom"]);
  obj3[5] = function onPress() {
    callback(4090).openURL(callback(4005)(constants.TWITTER));
  };
  const items3 = [callback(id(8035).IconButton, obj3), , ];
  const obj4 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: null, accessibilityLabel: null, onPress: null };
  obj4[3] = callback(id(8311).FacebookNeutralIcon, { size: "sm", color: "interactive-icon-default" });
  const intl2 = id(1236).intl;
  obj4[4] = intl2.string(id(1236).t["h0or/l"]);
  obj4[5] = function onPress() {
    callback(4090).openURL(constants2.FACEBOOK_URL);
  };
  items3[1] = callback(id(8035).IconButton, obj4);
  const obj5 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: null, accessibilityLabel: null, onPress: null };
  obj5[3] = callback(id(8313).InstagramNeutralIcon, { size: "sm", color: "interactive-icon-default" });
  const intl3 = id(1236).intl;
  obj5[4] = intl3.string(id(1236).t["5uVPyf"]);
  obj5[5] = function onPress() {
    callback(4090).openURL(constants2.INSTAGRAM_URL);
  };
  items3[2] = callback(id(8035).IconButton, obj5);
  obj2[2] = items3;
  items2[1] = closure_11(id(6803).SafeAreaPaddingView, obj2);
  obj[1] = items2;
  return closure_11(closure_4, obj);
});
