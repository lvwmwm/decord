...
// Function ID: 7863
// Name: LHeading
// Dependencies: [19, 17, 1946, 676, 21, 712, 4189, 1297, 647, 7863, 698, 3886, 3888, 7865, 4179, 5177, 6679, 7867, 1236, 3801, 7869, 7871, 2]
// Exports: changelogRules, getRenderChangelog

// Module 7862 (LHeading)
...
function LinkInner(target) {
  ...
  changelog = target(7863).useChangelog(changelogId, stateFromStores).changelog;
  obj = {
...
const memoResult1 = importAllResult.memo((video) => {
  ...
  let obj2 = importDefault(4179);
  id = changeLog.id;
  let obj3 = importDefault(7865);
  {
    obj = { components: null };
  ...
  obj3[3] = callback(id(7867).XNeutralIcon, { size: "sm", color: "interactive-icon-default" });
  const intl = id(1236).intl;
  obj3[4] = intl.string(id(1236).t["/lXfom"]);
  obj3[5] = function onPress() {
    callback(3886).openURL(callback(3801)(constants.TWITTER));
  };
  const items3 = [callback(id(6679).IconButton, obj3), , ];
  const obj4 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: null, accessibilityLabel: null, onPress: null };
  obj4[3] = callback(id(7869).FacebookNeutralIcon, { size: "sm", color: "interactive-icon-default" });
  const intl2 = id(1236).intl;
  obj4[4] = intl2.string(id(1236).t["h0or/l"]);
  obj4[5] = function onPress() {
    callback(3886).openURL(constants2.FACEBOOK_URL);
  };
  items3[1] = callback(id(6679).IconButton, obj4);
  const obj5 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: null, accessibilityLabel: null, onPress: null };
  obj5[3] = callback(id(7871).InstagramNeutralIcon, { size: "sm", color: "interactive-icon-default" });
  const intl3 = id(1236).intl;
  obj5[4] = intl3.string(id(1236).t["5uVPyf"]);
  obj5[5] = function onPress() {
    callback(3886).openURL(constants2.INSTAGRAM_URL);
  };
  items3[2] = callback(id(6679).IconButton, obj5);
  obj2[2] = items3;
  items2[1] = closure_11(id(5177).SafeAreaPaddingView, obj2);
  obj[1] = items2;
  return closure_11(closure_4, obj);
});
