...
Suppressed.prototype["render"] = function render() {
  ...
  return jsx(tmp6(4915), { title: stringResult, body: stringResult1, iconSource: tmp7, onConfirm: this.close });
};
