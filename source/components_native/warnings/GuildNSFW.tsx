...
// Function ID: 10880
// Name: GuildNSFW
// Dependencies: [109, 19, 1891, 1221, 21, 589, 4498, 4500, 5215, 7720, 7722, 1236, 10880, 2]
// Exports: default

// Module 10879 (GuildNSFW)
...
export default function GuildNSFW(channelId) {
  ...
  if (_require(7722).NsfwSpaceWarningModalType.NSFW_CHANNEL_AGE_VERIFY !== modalType) {
    if (tmp(7722).NsfwSpaceWarningModalType.GUILD_LARGE_SERVER !== modalType) {
      if (tmp(7722).NsfwSpaceWarningModalType.NSFW_CHANNEL_UNDERAGE === modalType) {
        ...
        return jsx(importDefault(10880), { modalType: null, disagreementButtonVariant: "primary", onDisagree: null });
      } else {
        ...
        return jsx(importDefault(10880), { modalType: null, onAgree: null, onDisagree: null });
      }
    }
  }
  ...
  return jsx(importDefault(10880), { modalType, onAgree: callback, onDisagree: handleDisagree });
};
