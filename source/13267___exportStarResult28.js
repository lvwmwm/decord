...
// Dependencies: [1257, 13247, 13260, 13248]
// Exports: ToRawFixed

// Module 13267 (__exportStarResult28)
...
export const ToRawFixed = function ToRawFixed(ZERO, minimumFractionDigits, maximumFractionDigits, roundingIncrement, result) {
  ...
  ({ n2, r2 } = obj);
  result = require(13260) /* __exportStarResult11 */.ApplyUnsignedRoundingMode(ZERO, r1, r2, result);
  if (result.eq(obj.r1)) {
    n2 = obj.n1;
  }
  let str = "0";
  ...
  if (0 !== maximumFractionDigits) {
    ...
    if (str.length <= maximumFractionDigits) {
      sum = require(13248) /* setInternalSlot */.repeat("0", maximumFractionDigits - length2 + 1) + str;
