...
// Dependencies: [5, 27, 91, 13446, 13448, 13450, 13451, 13454, 13455, 13468, 13470, 13472, 13473, 13474, 13475, 13456]

// Module 13445 (getPluginOptions)
...
obj6.host = (function getHost(localhost) {
  ...
  if ("string" !== typeof scriptURL) {
    ...
    return require(13475) /* getHostFromUrl */.getHostFromUrl(scriptURL);
  }
