...
// Function ID: 7651
// Name: SessionFlusher
// Dependencies: [41, 42, 7603, 7624]

// Module 7650 (SessionFlusher)
...
const items = [
  ...
  },
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(7603).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(7624).getIsolationScope();
