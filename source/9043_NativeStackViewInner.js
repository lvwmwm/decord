...
// Module 9043 (NativeStackViewInner)
...
function MaybeNestedStack(children) {
  ...
  return closure_7(importDefault(9044), obj);
}
function SceneView(arg0) {
  ...
  let context = React.useContext(_require(5526).HeaderShownContext);
  const context1 = React.useContext(_require(5526).HeaderHeightContext);
  let num2 = 0;
  const context2 = React.useContext(_require(5526).HeaderBackContext);
  if (!context) {
    num2 = safeAreaInsets.top;
  }
  let obj3 = _require(1457);
  let obj4 = _require(5526);
  ...
  obj9.children = callback2(_require(4479).EdgeInsetApplicationContext.Provider, obj10);
  obj8.children = callback2(_require(5526).HeaderBackContext.Provider, obj9);
  ...
  items1[2] = callback2(importDefault(9045), Object.assign({}, options, obj13));
  obj4.children = items1;
  obj3.children = closure_8(_require(5526).HeaderHeightContext.Provider, obj4);
  obj2.children = callback2(_require(5526).HeaderShownContext.Provider, obj3);
  ...
  return callback2(_require(4479).Screen, obj, route.key);
}
...
export default function NativeStackView(arg0) {
  ...
  return callback2(require(5526) /* Background */.SafeAreaProviderCompat, obj);
};
