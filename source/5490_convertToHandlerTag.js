...
// Dependencies: [32, 19, 5491, 5492, 5502, 5503, 5504, 5506, 5507, 5508, 5487, 5471, 5509, 5469]
// Exports: checkGestureCallbacksForWorklets, extractGestureRelations, useForceRender, useWebEventHandlers

// Module 5490 (convertToHandlerTag)
...
function convertToHandlerTag(num) {
  if (typeof num === "number") {
    return num;
  } else if (num instanceof require(5487) /* _isNativeReflectConstruct */.BaseGesture) {
    num = num.handlerTag;
  } else {
