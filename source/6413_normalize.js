...
// Function ID: 6414
// Name: normalize
// Dependencies: [32, 6414, 6374, 6375, 6371]
// Exports: normalizeUrlToBase

// Module 6413 (normalize)
...
function visit(arg0, __sentry_skip_normalization__) {
  ...
  if (arg4 === undefined) {
    memoBuilderResult = require(6414) /* memoBuilder */.memoBuilder();
    let obj = require(6414) /* memoBuilder */;
  }
      ...
      if (str.startsWith("[object ")) {
        if (__sentry_skip_normalization__.__sentry_skip_normalization__) {
          ...
          if (0 === num) {
            ...
            const convertToPlainObjectResult = require(6374) /* addNonEnumerableProperty */.convertToPlainObject(__sentry_skip_normalization__);
            let num6 = 0;
