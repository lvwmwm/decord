...
// Dependencies: [5441, 5394, 31, 27, 5442, 5443, 5409, 5444, 5438]
// Exports: useRecyclerViewController

// Module 5440 (useRecyclerViewController)
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  const unmountFlag = _require(5442).useUnmountFlag();
  let obj = _require(5442);
  ...
  _setTimeout = _require(5443).useUnmountAwareTimeout().setTimeout;
  ...
  const handlerMethods = callback3(() => {
    ...
    obj.prepareForLayoutAnimationRender = function prepareForLayoutAnimationRender() {
      if (!store.props.keyExtractor) {
        ...
        console.warn(store(5438).WarningMessages.keyExtractorNotDefinedForAnimation);
      }
