...
// Function ID: 5679
// Name: memo
// Dependencies: [19, 17, 21, 1653, 5472, 5465, 5461, 5488]
...
const memoResult = memo(function BottomSheetRefreshControlComponent(arg0) {
  ...
  let dependencyMap;
  let iter;
  const tmp4 = iter(scrollableGesture(5472).BottomSheetDraggableContext);
  dependencyMap = tmp4;
  let obj = scrollableGesture(5465);
  ...
  obj = { animatedScrollableState: iter, SCROLLABLE_STATE: tmp2(5461).SCROLLABLE_STATE };
  fn.__closure = obj;
  ...
  if (tmp7) {
    ...
    let tmp8Result = tmp8(tmp2(5488).GestureDetector, obj);
  } else {
    const obj2 = {};
