...
const fn = function n(arg0, arg1) {
  if ("easeIn" === arg0) {
    ...
    const Easing3 = require(1654) /* cancelAnimation */.Easing;
    obj[0] = Easing3.in(require(1654) /* cancelAnimation */.Easing.ease);
    obj[1] = arg1;
    return obj;
  } else if ("easeOut" === arg0) {
    obj = { easing: null, duration: null };
    const Easing2 = require(1654) /* cancelAnimation */.Easing;
    obj[0] = Easing2.out(require(1654) /* cancelAnimation */.Easing.ease);
    obj[1] = arg1;
    return obj;
  } else if ("easeInEaseOut" === arg0) {
    const obj1 = { easing: null, duration: null };
    const Easing = require(1654) /* cancelAnimation */.Easing;
    obj1[0] = Easing.inOut(require(1654) /* cancelAnimation */.Easing.ease);
    obj1[1] = arg1;
    return obj1;
  } else if ("linear" === arg0) {
    obj = { easing: null, duration: null };
    obj[0] = require(1654) /* cancelAnimation */.Easing.linear;
    obj[1] = arg1;
    return obj;
