...
// Function ID: 4223
// Name: registerHost
// Dependencies: [4223, 4218]

// Module 4222 (registerHost)
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (portalName(4218).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4218).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4218).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4218).ACTIONS.REMOVE_PORTAL === type) {
