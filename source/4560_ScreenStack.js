...
// Function ID: 4561
// Name: ScreenStack
// Dependencies: [109, 19, 21, 4545, 4561, 4539, 4546, 4562, 4549]
// Exports: default

// Module 4560 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_require(4561).GHContext);
  obj = {
  ...
  ref2(4545)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4545)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4549).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = mapped;
  obj1[6] = jsx(ref2(4562), {});
  ...
  return jsx(tmp4(4561).RNSScreensRefContext.Provider, { value: ref, children: null });
};
