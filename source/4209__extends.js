...
// Function ID: 4210
// Name: _extends
// Dependencies: [19, 4210, 1229, 1230, 1223, 4213]

// Module 4209 (_extends)
...
export const MemoryRouter = Component2(4213).Redirect;
export const Prompt = Component2(4213).Redirect;
export const Redirect = Component2(4213).Redirect;
export const Route = Component2(4213).Route;
export const Router = Component2(4213).Router;
export const StaticRouter = Component2(4213).StaticRouter;
export const Switch = Component2(4213).Switch;
export const generatePath = Component2(4213).generatePath;
export const matchPath = Component2(4213).matchPath;
export const useHistory = Component2(4213).useHistory;
export const useLocation = Component2(4213).useLocation;
export const useParams = Component2(4213).useParams;
export const useRouteMatch = Component2(4213).useRouteMatch;
export const withRouter = Component2(4213).withRouter;
