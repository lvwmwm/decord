...
function getExpoUpdatesContext() {
  ...
  if (expoUpdates) {
    ...
    if (typeof checkAutomatically !== "tee") {
    ...
    if (typeof emergencyLaunchReason !== "tee") {
    ...
    if (typeof expoUpdates.launchDuration !== "reType") {
