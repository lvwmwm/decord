...
// Dependencies: [7453, 7454, 7461, 7462, 7463]

// Module 7460 (addNonEnumerableProperty)
const require = arg1;
...
function addNonEnumerableProperty(arg0, arg1, arg2) {
  try {
    ...
    if (require(7453) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = require(7462) /* _htmlElementAsString */.htmlTreeAsString(arg0);
      const tmp2Result = require(7462) /* _htmlElementAsString */;
    } else {
      const _Object = Object;
...
arg5.extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return require(7463) /* isMatchingPattern */.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = require(7463) /* isMatchingPattern */.truncate(joined, num);
