...
// Function ID: 5103
// Name: load
// Dependencies: [5103, 5104, 5105, 5106, 5107, 5120, 5122, 5123, 5135, 5139, 5143, 5145, 5147, 5148, 5149, 5150, 5151, 5152, 5153, 5154, 5155, 5156, 5129]
// Exports: load

// Module 5102 (load)
import errorDefault from "error" /* 5103 */;
  ...
  if (typeof response === "string") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(5104).dataUriToBuffer(response));
        const obj5 = response(5104);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
