...
// Dependencies: [13408, 13409, 13411]

// Module 13407 (__exportStarResult32)
const require = arg1;
...
arg5.TimeClip = function TimeClip(isFinite) {
  if (isFinite.isFinite()) {
    if (absResult.greaterThan(8640000000000001)) {
      const decimal = new require(13408) /* digitsToString */.Decimal(NaN);
      return decimal;
    } else {
      ...
      ZERO = require(13411) /* TEN */.ZERO;
    }
    absResult = isFinite.abs();
  } else {
    const decimal1 = new require(13408) /* digitsToString */.Decimal(NaN);
    return decimal1;
  }
};
