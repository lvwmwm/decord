...
// Dependencies: [6376, 6379, 6392, 6415, 6416, 6402, 6374, 6417, 6410, 6386]

// Module 6414 (applyClientOptions)
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = require(6374) /* isMatchingPattern */.truncate(environment.message, num);
  ...
  if (value) {
    iter.value = require(6374) /* isMatchingPattern */.truncate(iter.value, num);
  ...
  if (url) {
    request.url = require(6374) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(6374) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(6417).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = dependencyMap(6410).normalize(data.data, dependencyMap, dependencyMap);
                  data = obj;
                  const obj3 = dependencyMap(6410);
                }
