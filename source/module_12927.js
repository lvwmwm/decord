// Module ID: 12927
// Function ID: 12928
// Dependencies: [12900, 12904, 12899]
...
export default (arg0, arg1) => {
  if (arg0 instanceof require(12900) /* SemVer */) {
    ...
    if (typeof StringResult === "tee") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(12904).safeRe;
        const t2 = tmp(12904).t;
      ...
      if (null === match2) {
        ...
        return require(12899) /* SemVer */("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
