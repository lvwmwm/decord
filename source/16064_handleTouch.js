...
const obj4 = { <string:2423925279>: null, <string:2596769915>: null, tintColor: importDefault(dependencyMap[8]).colors.INTERACTIVE_TEXT_DEFAULT };
...
export default function NewTermsModal() {
  ...
  if (null != memo) {
    ...
    const obj3 = { "Bool(false)": 700, "Bool(false)": 24 };
