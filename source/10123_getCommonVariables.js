...
// Module 10123 (getCommonVariables)
...
function getCommonStyles(arg0) {
  ...
  if ("left" === snapDirection) {
    ...
    let interpolateResult = require(1653) /* cancelAnimation */.interpolate(value, items2, items3);
    ...
    result = Math.floor(10000 * require(1653) /* cancelAnimation */.interpolate(value, items4, items5)) / 100;
    ...
    interpolateResult = require(1653) /* cancelAnimation */.interpolate(value, items6, items7);
