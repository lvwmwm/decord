...
export const forHorizontalIOS = function forHorizontalIOS(layouts) {
  ...
  let obj = {};
  obj = {};
  obj = { translateX: callback(progress.interpolate({ inputRange: [0, 1], outputRange: items, extrapolate: "clamp" }), inverted) };
  ...
  obj.overlayStyle = { opacity: progress3.interpolate({ inputRange: [0, 1], outputRange: [0, 0.07], extrapolate: "clamp" }) };
  const obj3 = { opacity: progress3.interpolate({ inputRange: [0, 1], outputRange: [0, 0.07], extrapolate: "clamp" }) };
  const progress4 = current.progress;
  obj.shadowStyle = { shadowOpacity: progress4.interpolate({ inputRange: [0, 1], outputRange: [0, 0.3], extrapolate: "clamp" }) };
  return obj;
};
...
export const forModalPresentationIOS = function forModalPresentationIOS(next) {
  ...
  const obj2 = {};
  const obj3 = { overflow: "hidden", borderTopLeftRadius: num9, borderTopRightRadius: num9, borderBottomLeftRadius: 0, borderBottomRightRadius: 0 };
  let num10 = 0;
  if (0 !== index) {
    num10 = top;
  }
  ...
  obj2.cardStyle = obj3;
  obj2.overlayStyle = { opacity: tmp3Result.interpolate({ inputRange: [0, 1, 1.0001, 2], outputRange: [0, 0.3, 1, 1] }) };
  return obj2;
};
export const forFadeFromBottomAndroid = function forFadeFromBottomAndroid(current) {
  ...
  obj.opacity = importDefault(5605)(closing, current.progress, progress2.interpolate({ inputRange: [0, 0.5, 0.9, 1], outputRange: [0, 0.25, 0.7, 1], extrapolate: "clamp" }));
...
export const forRevealFromBottomAndroid = function forRevealFromBottomAndroid(layouts) {
  ...
  obj.cardStyle = obj1;
  const obj2 = { translateY: callback(progress2.interpolate({ inputRange: [0, 1], outputRange: items2, extrapolate: "clamp" }), inverted) };
  const progress4 = current.progress;
  obj.overlayStyle = { opacity: progress4.interpolate({ inputRange: [0, 0.36, 1], outputRange: [0, 0.1, 0.1], extrapolate: "clamp" }) };
  return obj;
};
export const forScaleFromCenterAndroid = function forScaleFromCenterAndroid(closing) {
  ...
  obj = {};
  obj = { opacity: tmpResult.interpolate({ inputRange: [0, 0.75, 0.875, 1, 1.0825, 1.2075, 2], outputRange: [0, 0, 1, 1, 1, 1, 0] }) };
  const obj1 = {};
  const progress3 = current.progress;
  const interpolateResult = progress.interpolate({ inputRange: [0, 1], outputRange: [0, 1], extrapolate: "clamp" });
  const tmp = closure_2;
  const tmp3 = importDefault(5605);
  obj1.scale = tmp3(closing.closing, progress3.interpolate({ inputRange: [0, 1], outputRange: [0.925, 1], extrapolate: "clamp" }), tmpResult.interpolate({ inputRange: [0, 1, 2], outputRange: [0.85, 1, 1.075] }));
  const items = [obj1];
  obj.transform = items;
  obj.cardStyle = obj;
  return obj;
...
export const forBottomSheetAndroid = function forBottomSheetAndroid(current) {
  ...
  const progress2 = current.progress;
  const tmp = callback(progress.interpolate({ inputRange: [0, 1], outputRange: items, extrapolate: "clamp" }), inverted);
  obj.opacity = importDefault(5605)(closing, current.progress, progress2.interpolate({ inputRange: [0, 1], outputRange: [0, 1], extrapolate: "clamp" }));
  const items1 = [{ translateY: tmp }];
  obj.transform = items1;
  obj.cardStyle = obj;
