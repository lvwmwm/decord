// Module ID: 12265
// Function ID: 12266
// Dependencies: [5, 12199, 12262, 12266, 12267, 12268, 12261]

// Module 12265
import asyncGeneratorStep from "module_12268";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12199).util;
    ...
    let closure_8 = fn(require("module_12266"));
    let closure_9 = fn(require("module_12267"));
    let closure_10 = fn(require("module_12268"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12261).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12261).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12261).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
