...
// Function ID: 13052
// Name: Range
// Dependencies: [41, 42, 13023, 13050, 13024, 13026, 13025, 13022, 13052]
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13023")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13024).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13024).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13025)("hyphen replace", str);
        let str3 = str.replace(tmp11(13026).safeRe[tmp11(undefined, 13026).t.COMPARATORTRIM], tmp11(13026).comparatorTrimReplace);
        tmp11(13025)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13026).safeRe[tmp11(undefined, 13026).t.TILDETRIM], tmp11(13026).tildeTrimReplace);
        tmp11(13025)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13026).safeRe[tmp11(undefined, 13026).t.CARETTRIM], tmp11(13026).caretTrimReplace);
        tmp11(13025)("caret trim", str7);
  ...
  },
  {
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp !== "_iter") {
          try {
            tmp = new Range(13022)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13025)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13050).ANY) {
