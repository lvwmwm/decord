// Module ID: 13020
// Function ID: 13021
// Dependencies: [12993, 12997, 12992]

// Module 13020

export default (num) => {
  if (num instanceof require(12993) /* SemVer */) {
    return num;
  } else {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(12997).safeRe;
        const t2 = tmp(12997).t;
      ...
      if (null === match2) {
        ...
        return require(12992) /* SemVer */("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
