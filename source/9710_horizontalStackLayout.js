...
// Module 9710 (horizontalStackLayout)
...
function horizontalStackLayout(first) {
  if (arguments.length > 0) {
    ...
    let obj = { screen: closure_3, modeConfig: first, getCommonVariables: closure_7, getCommonStyles: closure_9, interpolate: first(1582).interpolate, Extrapolation: first(1582).Extrapolation };
...
let closure_9 = (() => {
  function getCommonStyles(arg0) {
    ...
    if ("left" === snapDirection) {
      ...
      let interpolateResult = outer1_0(outer1_1[2]).interpolate(value, items2, items3);
      ...
      result = Math.floor(10000 * outer1_0(outer1_1[2]).interpolate(value, items4, items5)) / 100;
      ...
      interpolateResult = outer1_0(outer1_1[2]).interpolate(value, items6, items7);
      const obj5 = outer1_0(outer1_1[2]);
    }
    obj = { zIndex: Math.round(result), opacity: interpolateResult };
    return obj;
  }
  getCommonStyles.__closure = { interpolate: require(1582) /* cancelAnimation */.interpolate };
