...
// Dependencies: [4501, 4434, 541, 4481, 4485, 4498, 4488, 4489, 4490, 4491, 4502, 4503]

// Module 4500 (ValidateAndApplyPropertyDescriptor)

export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, arg2, __Configurable__) {
  const tmp3 = require(4501) /* Type */(arg0);
  if (undefined !== arg0) {
    if (!tmp(4434)(arg0)) {
      ...
      if (undefined === __Set__) {
        ...
        if (tmp64) {
          if ("Undefined" === tmp3) {
            ...
            tmp66 = tmp(4498)(__Configurable__);
          }
        }
        return tmp64;
      } else {
        ...
        if (tmpResult3(obj, __Set__)) {
          if (!__Set__["[[Configurable]]"]) {
            ...
            if ("[[Enumerable]]" in __Configurable__) {
              if (!tmp(4490)(__Configurable__["[[Enumerable]]"], __Set__["[[Enumerable]]"])) {
                return false;
              }
            }
            if (!tmp(4503)(__Configurable__)) {
              const tmpResult4 = tmp(4490);
              if (!tmpResult4(tmp26, tmp(4498)(__Set__))) {
                return false;
              }
              tmp26 = tmp(4498)(__Configurable__);
            }
            if (tmp(4498)(__Set__)) {
              if ("[[Get]]" in __Configurable__) {
                if (!tmp(4490)(__Configurable__["[[Get]]"], __Set__["[[Get]]"])) {
                  return false;
                }
              }
              if ("[[Set]]" in __Configurable__) {
                if (!tmp(4490)(__Configurable__["[[Set]]"], __Set__["[[Set]]"])) {
                  return false;
                }
              }
              ...
              if ("[[Value]]" in __Configurable__) {
                if (!tmp(4490)(__Configurable__["[[Value]]"], __Set__["[[Value]]"])) {
                  return false;
                }
              }
            }
          ...
          if ("Undefined" === tmp3) {
            ...
            if (!tmp(4489)(__Set__)) {
              if (tmp(4498)(__Set__)) {
                if (tmp(4489)(__Configurable__)) {
                  ...
                  const tmpResult6 = tmp(4489);
                  const tmpResult7 = tmp(4490);
                  ...
                  let tmpResult6Result = tmp(4488)(tmpResult6, tmpResult7, tmpResult8, arg0, arg1, obj);
                  const tmpResult5 = tmp(4488);
                }
              }
              const tmpResult10 = tmp(4489);
              const tmpResult9 = tmp(4488);
              tmpResult6Result = tmpResult9(tmpResult10, tmp(4490), tmp(4491), arg0, arg1, __Configurable__);
              const tmpResult11 = tmp(4490);
            }
            let tmp50 = __Set__;
            if ("[[Configurable]]" in __Configurable__) {
            ...
            const tmpResult13 = tmp(4489);
            const tmpResult14 = tmp(4490);
            const tmpResult15 = tmp(4491);
            ...
            __Set__ = __Set__["[[Set]]"];
            obj1[3] = __Set__;
            tmpResult6Result = tmp(4488)(tmpResult13, tmpResult14, tmpResult15, arg0, arg1, obj1);
            const tmpResult12 = tmp(4488);
          }
        } else {
