...
// Dependencies: [5, 17, 3921, 16291, 16292, 16293]
// Exports: getAppleDeclaredAgeRangeStatus, getIsConsideredOlderThan, setAgeRangeThresholds

// Module 16290 (_getAppleDeclaredAgeRangeStatus)
import importDefaultResult from "module_16293";
...
export const setAgeRangeThresholds = (arg0) => {
  const ageRangeThresholdManager = callback(16291).ageRangeThresholdManager;
...
export const PlayAgeRangeDeclarationUserStatus = require("module_16293").PlayAgeRangeDeclarationUserStatus;
export const PlayAgeRangeDeclarationUserStatusString = require("module_16293").PlayAgeRangeDeclarationUserStatusString;
