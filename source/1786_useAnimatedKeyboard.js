...
arg5.useAnimatedKeyboard = function useAnimatedKeyboard() {
  ...
  const height = obj.useSharedValue(0);
  const arg1 = height;
  const state = arg1(arg6[0]).useSharedValue(obj.UNKNOWN);
  const arg6 = state;
  ...
  arg1(arg6[1]).useKeyboardHandler({ onStart: pnpm_compatTs1, onMove: pnpm_compatTs2, onInteractive: pnpm_compatTs3, onEnd: pnpm_compatTs4 }, []);
  return { height, state };
};
