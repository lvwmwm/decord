...
// Dependencies: [7375, 7347, 7403, 7350]

// Module 7436 (_shouldDropEvent)
        ...
        if (message) {
          ...
          if (message === message2) {
            ...
            if (_isSameFingerprint(message, message2)) {
              const framesFromEvent = require(7350) /* createStackParser */.getFramesFromEvent(message);
              const obj = require(7350) /* createStackParser */;
              const framesFromEvent1 = require(7350) /* createStackParser */.getFramesFromEvent(message2);
              if (framesFromEvent) {
                if (!framesFromEvent) {
                  if (framesFromEvent) {
                    let flag2 = false;
              ...
              const obj2 = require(7350) /* createStackParser */;
            }
          }
        } else {
          flag = false;
        ...
        if (iter2) {
          ...
          if (iter.type === iter2.type) {
            ...
            if (iter.value === iter2.value) {
              flag3 = false;
              if (_isSameFingerprint(message, message2)) {
                const framesFromEvent2 = require(7350) /* createStackParser */.getFramesFromEvent(message);
                const obj3 = require(7350) /* createStackParser */;
                const framesFromEvent3 = require(7350) /* createStackParser */.getFramesFromEvent(message2);
                if (framesFromEvent2) {
                  if (!framesFromEvent2) {
                    if (framesFromEvent2) {
                      let flag4 = false;
                ...
                const obj4 = require(7350) /* createStackParser */;
              }
            }
          }
        }
