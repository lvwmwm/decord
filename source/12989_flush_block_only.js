...
// Dependencies: [12990, 12986, 12991, 12992, 12993]

// Module 12989 (flush_block_only)
const require = arg1;
...
function flush_block_only(state8, arg1) {
  ...
  require(12991) /* StaticTreeDesc */._tr_flush_block(state8, num, state8.strstart - state8.block_start, arg1);
  ...
  if (0 !== avail_out) {
    const tmpResult = require(12986) /* assign */;
...
function deflate_fast(lookahead) {
  while (true) {
    ...
    if (lookahead.match_length >= 3) {
      ...
      let obj2 = require(12991) /* StaticTreeDesc */;
      ...
      let obj = require(12991) /* StaticTreeDesc */;
    ...
    if (lookahead.lookahead < 262) {
      ...
      if (0 === lookahead.lookahead) {
        if (lookahead.match_available) {
          ...
          let obj3 = require(12991) /* StaticTreeDesc */;
...
function DeflateState() {
  ...
  const buf16 = new require(12986) /* assign */.Buf16(1146);
  obj.dyn_ltree = buf16;
  const buf161 = new require(12986) /* assign */.Buf16(122);
  obj.dyn_dtree = buf161;
  const buf162 = new require(12986) /* assign */.Buf16(78);
  obj.bl_tree = buf162;
...
function deflateReset(state) {
  if (state) {
    if (state.state) {
      ...
      state.adler = num5;
      state.last_flush = 0;
      require(12991) /* StaticTreeDesc */._tr_init(state);
      let num = 0;
      const obj = require(12991) /* StaticTreeDesc */;
    }
    if (0 === num) {
                ...
                if (num2 <= 9) {
                  if (strategy >= 0) {
                    if (strategy <= 4) {
                      ...
                      const buf8 = new require(12986) /* assign */.Buf8(2 * obj.w_size);
                      obj.window = buf8;
                      const buf16 = new require(12986) /* assign */.Buf16(obj.hash_size);
                      obj.head = buf16;
                      const buf161 = new require(12986) /* assign */.Buf16(obj.w_size);
                      obj.prev = buf161;
                      obj.lit_bufsize = 1 << memLevel + 6;
                      obj.pending_buf_size = 4 * obj.lit_bufsize;
                      const buf81 = new require(12986) /* assign */.Buf8(obj.pending_buf_size);
            ...
            if (state.input) {
              ...
              if (42 === state8.status) {
                if (2 === state8.wrap) {
                  ...
                  if (state8.gzhead) {
                    ...
                    if (state8.gzhead.hcrc) {
                      state.adler = require(12993)(state.adler, state8.pending_buf, state8.pending, 0);
                    }
                    state8.gzindex = 0;
                    state8.status = 69;
                ...
                if (state8.gzhead.extra) {
                  ...
                  if (state8.gzindex < (65535 & state8.gzhead.extra.length)) {
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      while (state8.gzindex < (65535 & state8.gzhead.extra.length)) {
                        if (state8.pending !== state8.pending_buf_size) {
                          ...
                          if (tmp36) {
                            ...
                            let tmp39 = tmp35;
                            state.adler = require(12993)(state.adler, state8.pending_buf, state8.pending - tmp35, tmp35);
                          }
                      ...
                      if (tmp29) {
                        state.adler = require(12993)(state.adler, state8.pending_buf, state8.pending - pending, pending);
                      }
                      state = state.state;
                      let avail_out = state.pending;
                      ...
                      if (0 !== avail_out) {
                        diff = require;
                        diff = dependencyMap;
                        const obj6 = require(12986) /* assign */;
                        diff = obj6;
                        diff = avail_out;
                  ...
                  if (tmp40) {
                    state.adler = require(12993)(state.adler, state8.pending_buf, state8.pending - pending2, pending2);
                  }
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (tmp46) {
                        ...
                        let tmp49 = pending3;
                        state.adler = require(12993)(state.adler, state8.pending_buf, state8.pending - pending3, tmp44);
                      }
                    ...
                    if (tmp52) {
                      ...
                      let tmp55 = pending4;
                      state.adler = require(12993)(state.adler, state8.pending_buf, state8.pending - pending4, pending4);
                    }
                    if (0 === num46) {
                      state8.gzindex = 0;
                      let num48 = 91;
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (tmp58) {
                        ...
                        let tmp61 = pending5;
                        state.adler = require(12993)(state.adler, state8.pending_buf, state8.pending - pending5, tmp56);
                      }
                    ...
                    if (tmp64) {
                      ...
                      let tmp67 = pending6;
                      state.adler = require(12993)(state.adler, state8.pending_buf, state8.pending - pending6, pending6);
                    }
                    if (0 === num53) {
                      let num55 = 103;
                      state8.status = 103;
                ...
                if (state8.gzhead.hcrc) {
                  if (state8.pending + 2 > state8.pending_buf_size) {
                    ...
                    if (0 !== avail_out5) {
                      diff = require;
                      diff = dependencyMap;
                      const obj10 = require(12986) /* assign */;
                      diff = obj10;
                      diff = avail_out5;
              ...
              if (0 !== state8.pending) {
                ...
                if (0 !== avail_out6) {
                  diff = require;
                  diff = dependencyMap;
                  const obj11 = require(12986) /* assign */;
                  diff = obj11;
                  diff = avail_out6;
                ...
                if (4 === last_flush) {
                  ...
                  if (state8.wrap > 0) {
                    ...
                    if (0 !== avail_out8) {
                      diff = require;
                      diff = dependencyMap;
                      const obj14 = require(12986) /* assign */;
                      diff = obj14;
                      diff = avail_out8;
              ...
              if (2 === state8.strategy) {
                while (true) {
                  ...
                  let tmp99 = require;
                  diff = dependencyMap;
                  let obj4 = require(12991) /* StaticTreeDesc */;
                ...
                if (3 !== funcResult) {
                  if (2 === funcResult) {
                    if (1 === last_flush) {
                      diff = require;
                      diff = dependencyMap;
                      diff = require(12991) /* StaticTreeDesc */._tr_align(state8);
                      const obj5 = require(12991) /* StaticTreeDesc */;
                    } else if (5 !== last_flush) {
                      diff = require;
                      diff = dependencyMap;
                      const obj12 = require(12991) /* StaticTreeDesc */;
                      diff = obj12;
                      diff = state8;
                    ...
                    if (0 !== avail_out7) {
                      diff = require;
                      diff = dependencyMap;
                      const obj13 = require(12986) /* assign */;
                      diff = obj13;
                      diff = avail_out7;
    ...
    if (strm.state) {
      ...
      if (2 !== wrap) {
        if (1 !== wrap) {
          if (!state.lookahead) {
            if (tmp23) {
              strm.adler = require(12992) /* adler32 */(strm.adler, dictionary, length, 0);
            }
            state.wrap = 0;
            let tmp5 = dictionary;
            let w_size = length;
            if (length >= state.w_size) {
              ...
              const buf8 = new require(12986) /* assign */.Buf8(state.w_size);
              const obj = require(12986) /* assign */;
