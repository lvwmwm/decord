...
function instrumentFetch(arg0) {
  ...
  if (tmp) {
    tmp = !_require(6423).supportsNativeFetch();
    let obj = _require(6423);
  }
  if (!tmp) {
    _require(6317).fill(_require(6312).GLOBAL_OBJ, "fetch", (arg0) => {
      let closure_0 = arg0;
      return () => {
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(6309) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  const obj = require(6309) /* addHandler */;
  require(6309) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    outer1_4(outer1_6);
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(6309).addHandler("fetch", arg0);
  const obj = _require(6309);
  _require(6309).maybeInstrument("fetch", () => {
