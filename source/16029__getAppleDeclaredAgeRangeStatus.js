...
// Module 16029 (_getAppleDeclaredAgeRangeStatus)
function _getAppleDeclaredAgeRangeStatus() {
  // CreateGeneratorClosureLongIndex (0x67)
  const obj = callback(tmp);
  const _getAppleDeclaredAgeRangeStatus = obj;
...
function _getAndroidPlayAgeRangeStatus() {
  // CreateGeneratorClosureLongIndex (0x67)
  const obj = callback(tmp);
  const _getAndroidPlayAgeRangeStatus = obj;
  return obj(...arguments);
}
...
export const setAgeRangeThresholds = function setAgeRangeThresholds(arg0) {
  const ageRangeThresholdManager = arg1(dependencyMap[3]).ageRangeThresholdManager;
...
export const PlayAgeRangeDeclarationUserStatus = arg1(dependencyMap[5]).PlayAgeRangeDeclarationUserStatus;
export const PlayAgeRangeDeclarationUserStatusString = arg1(dependencyMap[5]).PlayAgeRangeDeclarationUserStatusString;
