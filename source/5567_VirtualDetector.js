...
// Dependencies: [32, 19, 17, 21, 5566, 5493, 5568, 5555, 5564, 5563, 5542]
// Exports: VirtualDetector

// Module 5567 (VirtualDetector)
    ...
    callback(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: null, handlerTags: null, methods: null, viewRef: "a", userSelect: 1022951427, touchAction: -733675517, enableContextMenu: -167771861 };
          obj[0] = tmp;
          obj[1] = closure_7;
