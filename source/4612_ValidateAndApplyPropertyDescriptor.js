...
// Dependencies: [4613, 4546, 541, 4593, 4597, 4610, 4600, 4601, 4602, 4603, 4614, 4615]

// Module 4612 (ValidateAndApplyPropertyDescriptor)

export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, flag, __Configurable__) {
  const tmp3 = require(4613) /* Type */(arg0);
  if (undefined !== arg0) {
    if (!tmp(4546)(arg0)) {
  ...
  if (require(4593) /* isPropertyKey */(arg1)) {
