...
obj = {
  ...
  value: function parse(arg0, arg1) {
    if ("u" === arg1) {
      let parseNDigitsSignedResult = _createSuperInternal(3576).parseNDigitsSigned(4, arg0);
    } else {
      parseNDigitsSignedResult = _createSuperInternal(3576).parseNDigitsSigned(arg1.length, arg0);
    }
