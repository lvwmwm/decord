...
// Dependencies: [6450, 6451, 6452, 6375, 6413, 6377, 6367, 6368, 6374]

// Module 6449 (extractRequestData)
const require = arg1;
  ...
  if (!obj.customRoute) {
    if (!method.route) {
      ...
      if (tmp) {
        ...
        str5 = require(6450) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
        str4 = "url";
        const obj2 = require(6450) /* getNumberOfUrlSegments */;
      }
...
arg5.httpRequestToRequestData = function httpRequestToRequestData(headers) {
  ...
  return require(6374) /* addNonEnumerableProperty */.dropUndefinedKeys(obj);
};
