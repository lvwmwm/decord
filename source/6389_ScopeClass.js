...
// Function ID: 6390
// Name: ScopeClass
// Dependencies: [32, 41, 42, 6378, 6390, 6391, 6375, 6382, 6393, 6379, 6368]

// Module 6389 (ScopeClass)
...
let items = [
  {
    ...
    value: function clone() {
      ...
      let tmp3Result = tmp3(6390);
      tmp3Result = tmp3(6390);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(6391).updateSession(self._session, obj);
        const obj2 = ScopeClass(6391);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(6390)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(6390);
      obj[0] = ScopeClass(6378).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, arg1) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(6382).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      obj[12] = ScopeClass(6390)._getSpanForScope(self);
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(6393).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      ...
      obj[0] = ScopeClass(6378).generateSpanId();
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(6368).logger;
