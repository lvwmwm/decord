...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8016, 8000, 8009]

// Module 8015 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8009 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8016 */;
...
const items = [
  {
    ...
    value: function render() {
      ...
      const merged = Object.assign(ClipPath(8000).extract(this, props));
