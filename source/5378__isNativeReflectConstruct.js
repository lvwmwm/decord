...
// Dependencies: [93, 95, 98, 42, 41, 5360, 5343]

// Module 5378 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      let obj = ContinousBaseGesture(5360);
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5343).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(5343);
      }
      return tmp;
    }
  }
