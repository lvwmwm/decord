...
// Dependencies: [5, 17, 4033, 16457, 16458, 16459]
// Exports: getAppleDeclaredAgeRangeStatus, getIsConsideredOlderThan, setAgeRangeThresholds

// Module 16456 (_getAppleDeclaredAgeRangeStatus)
import importDefaultResult from "module_16459";
...
export const setAgeRangeThresholds = (arg0) => {
  const ageRangeThresholdManager = callback(16457).ageRangeThresholdManager;
...
export const PlayAgeRangeDeclarationUserStatus = require("module_16459").PlayAgeRangeDeclarationUserStatus;
export const PlayAgeRangeDeclarationUserStatusString = require("module_16459").PlayAgeRangeDeclarationUserStatusString;
