...
// Dependencies: [32, 5, 7392, 7506, 7400, 7395, 7408, 7401]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 7505 (_resolveResponse)
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(7392) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(7392) /* addHandler */;
  require(7392) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    const callback = closure_5;
    {
      callback(7400).fill(callback(7395).GLOBAL_OBJ, "fetch", (arg0) => {
        let closure_0 = arg0;
        return () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(7392).addHandler("fetch", arg0);
  let obj = _require(7392);
  _require(7392).maybeInstrument("fetch", () => {
    let flag = callback;
