...
export default {
  ...
  trigger() {
    let selection = arg0;
    if (arg0 === undefined) {
      selection = require(4347) /* isRingerSilent */.HapticFeedbackTypes.selection;
    }
    let obj = arg1;
    if (arg1 === undefined) {
      obj = {};
    ...
    if (c6) {
      try {
        ...
        importDefault(4348).trigger(selection, obj);
        const obj2 = importDefault(4348);
      } catch (tmp12) {
  ...
  stop() {
    if (c6) {
      try {
        importDefault(4348).stop();
        const obj = importDefault(4348);
      } catch (tmp4) {
        const _console = console;
  ...
  isSupported() {
    try {
      return importDefault(4348).isSupported();
    } catch (err) {
      return false;
    }
  },
  triggerPattern(arg0) {
    ...
    if (c6) {
      try {
        ...
        const merged = Object.assign(closure_5);
        const merged1 = Object.assign(obj);
        importDefault(4348).triggerPattern(arg0, obj);
        const obj2 = importDefault(4348);
      } catch (tmp11) {
        const _console = console;
  ...
  playAHAP(arg0) {
    if (c6) {
      try {
        return importDefault(4348).playAHAP(arg0);
      } catch (err) {
  ...
  impact() {
    ...
    if (arg0 === undefined) {
      impactMedium = require(4347) /* isRingerSilent */.HapticFeedbackTypes.impactMedium;
    }
    let obj = arg2;
    if (arg2 === undefined) {
      obj = {};
    ...
    if (c6) {
      ...
      try {
        ...
        const merged = Object.assign(closure_5);
        const merged1 = Object.assign(obj);
        importDefault(4348).triggerPattern(items, obj);
        const obj2 = importDefault(4348);
      } catch (tmp17) {
