// Module ID: 13025
// Function ID: 13026
// Dependencies: [12988, 13017, 13008, 13013, 13009, 13012, 13019, 13016]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(12988)(arg0, arg3);
  const tmp4 = new _require(13017)(arg1, arg3);
  if (">" === arg2) {
    let dependencyMap = tmp(13008);
    let tmpResult = tmp(13013);
    tmpResult = tmp(13009);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13009);
      tmpResult = tmp(13012);
      tmpResult1 = tmp(13008);
  ...
  if (_require(13019)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
    if (0 < tmp4.set.length) {
      while (true) {
        ...
        let item = arr.forEach((semver) => {
          let tmp = semver;
          if (semver.semver === require(13016) /* Comparator */.ANY) {
            tmp = new require(13016) /* Comparator */(">=0.0.0");
          }
          let tmp6 = _null;
          if (!_null) {
            tmp6 = tmp;
