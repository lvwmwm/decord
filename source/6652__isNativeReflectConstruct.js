...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 6649, 6653, 6654, 6586, 6595]

// Module 6652 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = importDefault(6649)[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = importDefault(6649)[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
