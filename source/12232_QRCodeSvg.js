...
// Function ID: 95562
// Name: QRCodeSvg
// Dependencies: [12229, 31, 8507]

// Module 12232 (QRCodeSvg)
...
const forwardRefResult = result.forwardRef((obj, ref) => {
  ...
  const element = mod.default.createElement(require(8507) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return mod.default.createElement(require(8507) /* inlineStyles */.Svg, callback({}, obj, obj), element, mod.default.createElement(require(8507) /* inlineStyles */.Path, { d, fill }));
});
