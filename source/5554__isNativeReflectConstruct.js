...
// Dependencies: [31, 5522, 31, 33, 5578, 5579, 2, 57, 31, 27, 33, 4126, 689, 4551, 5580, 5581, 5583]
// Exports: getIsModalPresentation

// Module 5554 (_isNativeReflectConstruct)
import closure_4 from "module_31";
import module_5522 from "module_5522";
import closure_6 from "module_31";
import module_33 from "module_33";
import designConfig from "designConfig";
import PostponeRender from "PostponeRender";
...
let closure_3 = [];
({ Animated: closure_11, InteractionManager: closure_12, Platform, StyleSheet } = _slicedToArray);
const View = _slicedToArray.View;
({ jsx: closure_15, jsxs: closure_16 } = module_31);
  ...
  class Card {
    constructor() {
      ...
      if (closure_19()) {
        ...
        tmp6 = designConfig;
        constructResult = Reflect.construct(obj, items1, designConfig(self).constructor);
      } else {
    ...
    value: function gestureActivationCriteria() {
      ...
      if ("vertical" === gestureDirection) {
        ...
        if (1 === callback(closure_2[9])(gestureDirection)) {
          const obj3 = { type: 20, accountId: 4, track: -7, volumePercent: 21 };
          const obj4 = { right: sum };
          obj3.hitSlop = obj4;
          obj = obj3;
        } else {
          obj = { type: "<string:7421925>", accountId: "<string:1090519040>", track: "never", volumePercent: "<string:291909457>" };
          const obj5 = { left: sum };
          obj.hitSlop = obj5;
        }
        return obj;
  ...
  items[4] = {
    ...
    value: function render() {
      ...
      if (!gestureEnabled) {
        ...
        items[2] = closure_16(closure_14, Object.assign({ "Bool(false)": null, "Bool(false)": null }, tmp, obj3));
        obj.children = items;
...
const styles = StyleSheet.create({ container: { flex: 1 }, overlay: { "Bool(false)": true, "Bool(false)": true }, shadow: {}, shadowHorizontal: { shadowOffset: { aze: 1, azj: "text-sm/semibold" } }, shadowLeft: { left: 0 }, shadowRight: { right: 0 }, shadowVertical: { shadowOffset: { aze: "LocalPayment is not enabled for this merchant.", azj: null } }, shadowTop: { top: 0 }, shadowBottom: { bottom: 0 } });
