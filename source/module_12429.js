// Module ID: 12429
// Function ID: 12430
// Dependencies: [5, 12363, 12426, 12430, 12431, 12432, 12425]

// Module 12429
import asyncGeneratorStep from "module_12432";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12363).util;
    ...
    let closure_8 = fn(require("module_12430"));
    let closure_9 = fn(require("module_12431"));
    let closure_10 = fn(require("module_12432"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12425).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12425).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12425).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
