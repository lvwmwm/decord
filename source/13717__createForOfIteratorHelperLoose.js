...
// Module 13717 (_createForOfIteratorHelperLoose)
...
let closure_7 = arg1(dependencyMap[3]).createStyles({ container: {}, permissionContainer: { type: null, guildId: null }, permissionIcon: { marginTop: 1 }, permissionText: {} });
...
export default function UserSettingsAuthedAppPermissions(oauth2Token) {
  ...
  return callback(closure_3, {
    ...
    children: () => {
      ...
      obj = {};
      obj = { INTEGRATION_CREATE: "polite", ConstraintReasonCode: "column", children: name.name };
      const items2 = [callback(tmp(closure_2[7]).Text, obj), , , ];
      const obj1 = { INTEGRATION_CREATE: "safety_flows_enter_email_screen", ConstraintReasonCode: "<string:1091633152>" };
      ...
      items2[2] = items.map((children) => {
        ...
        obj = { Promise: "xs", marginTop: "interactive-text-default", flags: "md", style: items.permissionText, children };
