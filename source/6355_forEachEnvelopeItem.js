...
// Dependencies: [65, 57, 6312, 6356, 6317, 6358]
...
// Module 6355 (forEachEnvelopeItem)
...
function encodeUTF8(arg0) {
  if (require(6312) /* getGlobalSingleton */.GLOBAL_OBJ.__SENTRY__) {
    if (require(6312) /* getGlobalSingleton */.GLOBAL_OBJ.__SENTRY__.encodePolyfill) {
      const __SENTRY__ = require(6312) /* getGlobalSingleton */.GLOBAL_OBJ.__SENTRY__;
...
export const createEventEnvelopeHeaders = function createEventEnvelopeHeaders(event_id, sdk) {
  ...
  if (tmp4) {
    obj = { dsn: require(6358) /* dsnFromString */.dsnToString(arg3) };
    tmp4 = obj;
    const obj5 = require(6358) /* dsnFromString */;
  }
  let tmp7 = tmp;
  if (event_id.sdkProcessingMetadata && event_id.sdkProcessingMetadata.dynamicSamplingContext) {
    const obj1 = {};
    const _Object = Object;
    obj1.trace = require(6317) /* addNonEnumerableProperty */.dropUndefinedKeys(Object.assign({}, tmp));
    tmp7 = obj1;
    const obj7 = require(6317) /* addNonEnumerableProperty */;
  }
