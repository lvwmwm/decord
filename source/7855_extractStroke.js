...
// Function ID: 7856
// Name: extractStroke
// Dependencies: [7853, 7841, 7856]

// Module 7855 (extractStroke)
const module = arg2;
...
arg5.default = function extractStroke(arg0, arg1, arr) {
  ...
  if (null != stroke) {
    arr.push("stroke");
    arg0.stroke = module(7853)(stroke);
  }
  if (null != strokeWidth) {
  ...
  if (null != strokeOpacity) {
    ...
    arg0.strokeOpacity = module(7841)(strokeOpacity);
  }
  if (null != strokeDasharray) {
    ...
    if (strokeDasharray) {
      ...
      if ("none" !== strokeDasharray) {
        tmp9 = module(7856)(strokeDasharray);
      }
    }
    let combined = tmp9;
    if (tmp9) {
