...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = require(12208);
      const glogResult = require(12208).glog(self.get(0));
      const _Array = Array;
      const diff = glogResult - require(12208).glog(getLength.get(0));
