...
// Dependencies: [109, 19, 17, 21, 4729, 4725, 4730, 4731, 4726, 4732]
...
// Module 4728 (ScreenStackHeaderSubview)
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  obj[2] = importDefault(4726).experiment.synchronousHeaderSubviewUpdatesEnabled;
  obj = { resizeMode: "center", fadeDuration: 0 };
  const merged = Object.assign(arg0);
  obj[3] = <closure_7 resizeMode="center" fadeDuration={0} />;
  return jsx(importDefault(4732), { resizeMode: "center", fadeDuration: 0 });
};
export const ScreenStackHeaderRightView = (style) => {
  ...
  obj.type = "right";
  obj.synchronousShadowStateUpdatesEnabled = importDefault(4726).experiment.synchronousHeaderSubviewUpdatesEnabled;
