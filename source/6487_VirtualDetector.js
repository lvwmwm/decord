...
// Dependencies: [32, 19, 17, 21, 6486, 6413, 6488, 6475, 6484, 6483, 6462]
// Exports: VirtualDetector

// Module 6487 (VirtualDetector)
    ...
    callback(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: null, handlerTags: null, methods: null, viewRef: "a", userSelect: "a", touchAction: "isArray", enableContextMenu: "memo" };
          obj[0] = tmp;
          obj[1] = closure_7;
