...
export const METRIC_MAP = { [require(7835).COUNTER_METRIC_TYPE]: _moduleResult, [require(7835).GAUGE_METRIC_TYPE]: _moduleResult1, [require(7835).DISTRIBUTION_METRIC_TYPE]: _moduleResult2, [require(7835).SET_METRIC_TYPE]: _moduleResult3 };
