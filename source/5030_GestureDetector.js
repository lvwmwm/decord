...
export const GestureDetector = function GestureDetector(gesture) {
  ...
  if (gesture.gesture) {
    ...
    const current = callback({ "Bool(true)": null, "Bool(true)": null, "Bool(true)": null, "Bool(true)": null }).current;
    obj = { getDeviceAudioEffects: null, billingAgreementDetails: null, UNKNOWN_GIFT_CODE: "<string:1153327360>", overflow: "name-middle", REQUIRE_REVERIFIED_EMAIL_OR_VERIFIED_PHONE: "name-family", attachedGestures: [], shouldUseReanimated: someResult };
