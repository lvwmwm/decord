...
// Function ID: 75404
// Name: PaginationItem
// Dependencies: [31, 27, 33, 1582]
// Exports: PaginationItem

// Module 9683 (PaginationItem)
import "result";
...
export const PaginationItem = function PaginationItem(animValue) {
  ...
  obj = { horizontal, height, width, index, animValue: iter, count, interpolate: iter(count[3]).interpolate, Extrapolation: iter(count[3]).Extrapolation };
  ...
  let items2 = [obj2, dotStyle];
  obj1.style = items2;
  let items3 = [{ backgroundColor: "black", flex: 1 }, animatedStyle, activeDotStyle];
  obj1.children = height(index(count[3]).View, { style: items3, children });
  obj.children = height(width, obj1);
  return height(horizontal, obj);
};
