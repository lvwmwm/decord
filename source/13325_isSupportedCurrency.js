...
// Dependencies: [13242, 13326]

// Module 13325 (isSupportedCurrency)
const require = arg1;
...
function isSupportedCurrency(arr3, locale) {
  ...
  const memoizedNumberFormat = require(13242) /* _formatToParts */.createMemoizedNumberFormat(str, obj);
...
arg5.getSupportedCurrencies = function getSupportedCurrencies(locale) {
  const items = [];
  const currencies = require(13326).currencies;
  let num = 0;
