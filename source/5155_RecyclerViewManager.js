...
// Module 5155 (RecyclerViewManager)
...
export const RecyclerViewManager = () => {
  class RecyclerViewManager {
    constructor(arg0) {
      ...
      this.propsRef = arg0;
      rVEngagedIndicesTrackerImpl = new RecyclerViewManager(closure_2[2]).RVEngagedIndicesTrackerImpl();
      this.engagedIndicesTracker = rVEngagedIndicesTrackerImpl;
      renderStackManager = new RecyclerViewManager(closure_2[3]).RenderStackManager(arg0.maxItemsInRecyclePool);
  ...
  const arg1 = RecyclerViewManager;
  let obj = {
  ...
  items[10] = {
    ...
    value: function getLayout(arg0) {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(closure_2[5]).ErrorMessages.layoutManagerNotInitializedLayoutInfo);
        throw error;
      }
    }
  };
  ...
  items[13] = {
    ...
    value: function getChildContainerDimensions() {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(closure_2[5]).ErrorMessages.layoutManagerNotInitializedChildContainer);
        throw error;
      }
    }
  };
  ...
  items[15] = {
    ...
    value: function getWindowSize() {
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(closure_2[5]).ErrorMessages.layoutManagerNotInitializedWindowSize);
        throw error;
      }
    }
  };
    ...
    value: function updateLayoutParams(windowSize, firstItemOffset) {
      ...
      if (this.layoutManager) {
        ...
        if (BooleanResult !== Boolean(self.propsRef.horizontal)) {
          const _Error = Error;
          const error = new Error(RecyclerViewManager(closure_2[5]).ErrorMessages.horizontalPropCannotBeToggled);
          throw error;
        }
        const BooleanResult = Boolean(isHorizontalResult);
      }
  ...
  items[23] = {
    ...
    value: function computeVisibleIndices() {
      ...
      if (this.layoutManager) {
        ...
        const _Error = Error;
        const error = new Error(RecyclerViewManager(closure_2[5]).ErrorMessages.layoutManagerNotInitializedVisibleIndices);
        throw error;
      }
    }
  };
  ...
  items[29] = {
    ...
    value: function processDataUpdate() {
      ...
      if (this.hasLayout()) {
        ...
        const tmp4 = self.hasRenderedProgressively && !self.recomputeEngagedIndices();
      }
    }
  };
  items[30] = {
    ...
    value: function getLayoutManagerClass() {
      ...
      if (this.propsRef.masonry) {
        if (self.propsRef.horizontal) {
          const _Error2 = Error;
          const error = new Error(RecyclerViewManager(closure_2[5]).ErrorMessages.masonryAndHorizontalIncompatible);
          throw error;
        }
      }
      if (self.numColumns > 1) {
        if (self.propsRef.horizontal) {
          const _Error = Error;
          const error1 = new Error(RecyclerViewManager(closure_2[5]).ErrorMessages.numColumnsAndHorizontalIncompatible);
          throw error1;
        }
      }
      if (self.propsRef.masonry) {
        let RVLinearLayoutManagerImpl = RecyclerViewManager(closure_2[6]).RVMasonryLayoutManagerImpl;
      } else {
        if (self.numColumns > 1) {
          if (!self.propsRef.horizontal) {
            RVLinearLayoutManagerImpl = RecyclerViewManager(closure_2[7]).RVGridLayoutManagerImpl;
          }
        }
        RVLinearLayoutManagerImpl = RecyclerViewManager(closure_2[8]).RVLinearLayoutManagerImpl;
      }
  ...
  items[41] = {
    ...
    value: function renderProgressively() {
      ...
      const layoutManager = this.layoutManager;
      const RecyclerViewManager = layoutManager;
      if (layoutManager) {
  ...
  items[44] = {
    ...
    value: function checkPropsAndWarn() {
      if (tmp) {
        ...
        console.warn(RecyclerViewManager(closure_2[9]).WarningMessages.keyExtractorNotDefinedForMVCP);
      }
    }
  };
