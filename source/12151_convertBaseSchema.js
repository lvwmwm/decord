...
// Dependencies: [32, 12146, 12147, 12145, 12139]

// Module 12151 (convertBaseSchema)
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema($schema, defaultTarget) {
      if (typeof $schema === "T") {
        ...
        if (registry == null) {
          registry = require(12139) /* $output */.globalRegistry;
        }
        obj[5] = registry;
        return convertSchema($schema, obj);
      }
    };
    const fnResult = fn(require("module_12146"));
    let obj = {};
    let merged = Object.assign(fn(require("module_12145")));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(require("module_12147"));
    let _Set = Set;
