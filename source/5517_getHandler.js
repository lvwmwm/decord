...
// Function ID: 5518
// Name: getHandler
// Dependencies: [5487, 5474, 5471, 5509, 5472, 5473]

// Module 5517 (getHandler)
const require = arg1;
const dependencyMap = arg6;
function getHandler(arg0, onBegin) {
  if (require(5487) /* _isNativeReflectConstruct */.CALLBACK_TYPE.BEGAN === arg0) {
  ...
  } else if (tmp(5487).CALLBACK_TYPE.CHANGE === arg0) {
...
function touchEventTypeToCallbackType(arg0) {
  if (require(5474).TouchEventType.TOUCHES_DOWN === arg0) {
...
function runWorklet(arg0, arg1, arg2) {
  ...
  if (arg1.isWorklet[arg0]) {
    ...
    console.warn(require(5471) /* tagMessage */.tagMessage("Animated gesture callback must be a worklet"));
