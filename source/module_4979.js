...
arg5.default = {
  isPngFile(dataView) {
    let tmp = dataView;
    if (tmp) {
      tmp = require(4972) /* getDataView */.getStringFromDataView(dataView, 0, u0089PNGrnu001An.length) === u0089PNGrnu001An;
