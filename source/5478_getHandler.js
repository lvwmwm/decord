...
// Function ID: 5479
// Name: getHandler
// Dependencies: [5448, 5435, 5432, 5470, 5433, 5434]

// Module 5478 (getHandler)
const require = arg1;
const dependencyMap = arg6;
function getHandler(arg0, onBegin) {
  if (require(5448) /* _isNativeReflectConstruct */.CALLBACK_TYPE.BEGAN === arg0) {
  ...
  } else if (tmp(5448).CALLBACK_TYPE.CHANGE === arg0) {
...
function touchEventTypeToCallbackType(arg0) {
  if (require(5435).TouchEventType.TOUCHES_DOWN === arg0) {
...
function runWorklet(arg0, arg1, arg2) {
  ...
  if (arg1.isWorklet[arg0]) {
    ...
    console.warn(require(5432) /* tagMessage */.tagMessage("Animated gesture callback must be a worklet"));
