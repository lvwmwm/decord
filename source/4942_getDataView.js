...
// Function ID: 4943
// Name: getDataView
// Dependencies: [4929, 4932]

// Module 4942 (getDataView)
const require = arg1;
const module = arg2;
...
arg5.default = {
  isWebpFile(dataView) {
    let tmp = dataView;
    if (tmp) {
      tmp = require(4929) /* getDataView */.getStringFromDataView(dataView, 0, 4) === "RIFF";
      const obj = require(4929) /* getDataView */;
    }
    if (tmp) {
      tmp = require(4929) /* getDataView */.getStringFromDataView(dataView, 8, 4) === "WEBP";
