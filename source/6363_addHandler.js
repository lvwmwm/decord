...
// Function ID: 6364
// Name: addHandler
// Dependencies: [6364, 6365, 6368]

// Module 6363 (addHandler)
const require = arg1;
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (require(6364) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
          const logger = tmp19(6365).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(6368).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(6368);
        }
      }
    }
