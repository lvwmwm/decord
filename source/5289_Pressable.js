...
// Module 5289 (Pressable)
let closure_3 = [true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true];
...
export default function Pressable(pressRetentionOffset) {
  ...
  let closure_20 = onPressIn({ "Null": "%FunctionPrototype%", "Null": "paddingStart" });
  const items = [hitSlop];
  const tmp6 = onPress(() => {
