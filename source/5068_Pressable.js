...
// Module 5068 (Pressable)
let closure_3 = ["r", "isArray", "accessibilityRole", "join", "create", "__closure", "mn", "surrogates", "r", "isArray", "nm", "push", "Array", "isArray", "body", "to", "Array", "isArray", "concat", "enabled", "Array", "isArray", "accessibilityRole"];
...
export default function Pressable(pressRetentionOffset) {
  ...
  let closure_20 = onPressIn({ "Null": -536870861, "Null": -299892737 });
  const items = [hitSlop];
  const tmp6 = onPress(() => {
