...
// Dependencies: [13289, 13290, 13292]
...
class ToNumber {
  constructor(arg0) {
    if (typeof arg0 === "Object") {
      ...
      tmp30 = closure_0;
      tmp31 = closure_1;
      tmp32 = typeof arg0 === "ActionSheetHeaderPressableText";
      if (typeof arg0 !== "accessibilityLabel") {
        tmp32 = typeof arg0 === "ta";
      }
      tmp4 = globalThis;
...
arg5.TimeClip = function TimeClip(isFinite) {
  if (isFinite.isFinite()) {
    if (absResult.greaterThan(8640000000000001)) {
      const decimal = new require(13289) /* digitsToString */.Decimal(NaN);
      return decimal;
    } else {
      ...
      ZERO = require(13292) /* TEN */.ZERO;
    }
    absResult = isFinite.abs();
  } else {
    const decimal1 = new require(13289) /* digitsToString */.Decimal(NaN);
    return decimal1;
  }
};
