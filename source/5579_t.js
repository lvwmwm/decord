...
const fn = function t(arg0, arg1) {
  ...
  if (globalThis._setGestureStateSync) {
    ...
    const _Error = Error;
    const error = new Error(require(5472) /* tagMessage */.tagMessage("Failed to set gesture state"));
    throw error;
  }
};
...
const fn2 = function _(arg0) {
  const ACTIVE = require(5473).State.ACTIVE;
...
obj = { setGestureState: fn, State: require("module_5473").State };
fn2.__closure = obj;
...
const fn3 = function n(arg0) {
  const FAILED = require(5473).State.FAILED;
  if (typeof fn !== "function") {
    HermesBuiltin.throwTypeError();
  }
  const _globalThis = globalThis;
...
fn3.__closure = { setGestureState: fn, State: require("module_5473").State };
...
const fn4 = function s(arg0) {
  const END = require(5473).State.END;
  if (typeof fn !== "function") {
    HermesBuiltin.throwTypeError();
  }
  const _globalThis = globalThis;
...
const obj1 = { setGestureState: fn, State: require("module_5473").State };
fn4.__closure = { setGestureState: fn, State: require("module_5473").State };
