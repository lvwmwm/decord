...
// Module 4789 (getOrientationDescription)
const require = arg1;
const module = arg2;
...
obj = {
  read(byteLength) {
    ...
    const sum = arg1 + arg2;
    let obj1 = require(4765) /* readTag */;
    const ifd = obj1.readIfd(byteLength, require(4766) /* IFD_TYPE_0TH */.IFD_TYPE_PENTAX, sum, sum + 10, byteOrder, arg3, true);
    ...
    let tmp6 = ifd;
    if (LevelInfo) {
      let obj2 = require(4745) /* getStringFromDataView */;
      ...
      if (sum1 + 7 <= byteLength.byteLength) {
        ...
        const int16 = byteLength.getInt16(sum2, byteOrder === module(4750).LITTLE_ENDIAN);
        obj1 = { value: int16, description: getRollAngleDescription(int16) };
        obj.RollAngle = obj1;
        const sum3 = sum1 + obj.PITCH_ANGLE;
        const int161 = byteLength.getInt16(sum3, byteOrder === module(4750).LITTLE_ENDIAN);
        obj2 = { value: int161, description: getPitchAngleDescription(int161) };
        obj.PitchAngle = obj2;
      }
      delete tmp.LevelInfo;
      tmp6 = obj2.objectAssign({}, ifd, obj);
