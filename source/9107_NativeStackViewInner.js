...
// Dependencies: [32, 19, 17, 21, 1481, 4545, 9108, 4536, 1584, 5579, 9109, 9112, 9113]
// Exports: default

// Module 9107 (NativeStackViewInner)
...
function MaybeNestedStack(children) {
  ...
  return closure_7(importDefault(9108), obj);
}
function SceneView(arg0) {
  ...
  let obj3 = React;
  const context = React.useContext(tmp(5579).HeaderShownContext);
  let num2 = React.useContext(tmp(5579).HeaderHeightContext);
  let num3 = 0;
  const context1 = React.useContext(tmp(5579).HeaderBackContext);
  if (!context) {
  ...
  let defaultHeaderHeight = _require(5579).getDefaultHeaderHeight(safeAreaFrame, tmp12, num3);
  ...
  if (previousDescriptor) {
    obj = { title: null };
    obj[0] = tmp(5579).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    tmp18 = obj;
  ...
  obj9[1] = closure_7(_require(4536).EdgeInsetApplicationContext.Provider, obj10);
  obj8[5] = closure_7(_require(5579).HeaderBackContext.Provider, obj9);
  ...
  const obj13 = {};
  tmp30 = closure_12;
  const tmpResult2 = _require(5579);
  ...
  items1[2] = closure_7(importDefault(9109), obj13);
  obj4[1] = items1;
  obj3[1] = closure_8(_require(5579).HeaderHeightContext.Provider, obj4);
  obj2[1] = closure_7(_require(5579).HeaderShownContext.Provider, obj3);
  ...
  return closure_7(_require(4536).Screen, obj, route.key);
}
...
export default function NativeStackView(arg0) {
  ...
  return callback2(require(5579) /* Background */.SafeAreaProviderCompat, obj);
};
