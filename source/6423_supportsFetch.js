...
// Function ID: 57750
// Name: supportsFetch
// Dependencies: [6312, 6310, 6311]

// Module 6423 (supportsFetch)
const require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in require(6312) /* getGlobalSingleton */.GLOBAL_OBJ) {
...
arg5.supportsNativeFetch = function supportsNativeFetch() {
  if ("string" === typeof globalThis.EdgeRuntime) {
    ...
    if (isNativeFunction(require(6312) /* getGlobalSingleton */.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
...
arg5.supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in require(6312) /* getGlobalSingleton */.GLOBAL_OBJ;
};
