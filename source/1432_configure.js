...
function useNetInfo(arg0) {
  ...
  const obj = { "Null": 0, "Null": 0, "Null": "100%", "Null": "10%", type: importAll(dependencyMap[5]).NetInfoStateType.unknown };
...
function useNetInfoInstance() {
  ...
  let obj = { "Null": 0, "Null": 0, "Null": "100%", "Null": "10%", type: importAll(dependencyMap[5]).NetInfoStateType.unknown };
