...
// Dependencies: [4498, 1215, 4558, 673, 4545, 3, 4559, 4581, 706, 13751, 4365, 4561, 5372, 13752, 586, 13754, 695, 2008, 2]

// Module 4557 (createRTCConnection)
import timestampDefault from "timestamp" /* 3 */;
import initializeDefault from "initialize" /* 586 */;
import dispatcherDefault from "dispatcher" /* 706 */;
import sleep from "sleep" /* 4561 */;
import updateVoiceStatesDefault from "updateVoiceStates" /* 13751 */;
import useSpatialAudioControlState from "useSpatialAudioControlState" /* 13752 */;
import trackVideoToggle from "trackVideoToggle" /* 13754 */;
import closure_5 from "set" /* 4498 */;
import closure_6 from "fetchFingerprint" /* 1215 */;
import closure_7 from "getVoiceStatesForGuild" /* 4558 */;
...
function createRTCConnection(arg0, arg1, arg2) {
  if (null == closure_4) {
    ...
    obj[4] = c23;
    obj[5] = arg2;
    _default = new _default(4559).default(obj);
    _default.on(_default(4581).RTCConnectionEvent.State, (arg0, arg1, arg2) => {
      closure_0 = arg0;
      const callback = arg1;
      dependencyMap = arg2;
      callback(706).wait(() => {
    ...
    _default.on(_default(4581).RTCConnectionEvent.Video, (arg0, arg1, arg2, arg3, arg4) => {
      closure_0 = arg0;
      closure_1 = arg1;
      closure_2 = arg2;
      closure_3 = arg3;
    ...
    _default.on(_default(4581).RTCConnectionEvent.Ping, (arg0, arg1) => {
      closure_0 = arg0;
      const callback = arg1;
      callback(706).wait(() => {
    ...
    _default.on(_default(4581).RTCConnectionEvent.OutboundLossRate, (arg0) => {
      closure_0 = arg0;
      callback(706).wait(() => {
    ...
    _default.on(_default(4581).RTCConnectionEvent.Speaking, (userId, speaking) => {
      if (closure_17 != null) {
        closure_17.setSpeaking(userId, speaking);
      }
    });
    _default.on(_default(4581).RTCConnectionEvent.Flags, (arg0, arg1) => {
      closure_0 = arg0;
      closure_1 = arg1;
      closure_1_1(closure_1_2[8]).wait(() => {
        let obj = closure_2_1(closure_2_2[8]);
    ...
    _default.on(_default(4581).RTCConnectionEvent.UsersMerged, (userIds, context) => {
      let obj = callback(706);
      obj = { type: "RTC_CONNECTION_USERS_MERGED", userIds, context };
      obj.dispatch(obj);
    });
    _default.on(_default(4581).RTCConnectionEvent.ClientConnect, (arg0) => {
      closure_0 = arg0;
      closure_1_1(closure_1_2[8]).wait(() => {
        let obj = closure_2_1(closure_2_2[8]);
    ...
    _default.on(_default(4581).RTCConnectionEvent.ClientDisconnect, (arg0) => {
      closure_0 = arg0;
      closure_1_1(closure_1_2[8]).wait(() => {
        let obj = closure_2_1(closure_2_2[8]);
    ...
    _default.on(_default(4581).RTCConnectionEvent.Platform, (arg0, arg1, arg2) => {
      closure_0 = arg0;
      const callback = arg1;
      dependencyMap = arg2;
      callback(706).wait(() => {
    ...
    _default.on(_default(4581).RTCConnectionEvent.SecureFramesUpdate, () => {
      callback(706).wait(() => {
        callback(table[8]).dispatch({ type: "RTC_CONNECTION_SECURE_FRAMES_UPDATE" });
      });
    });
    _default.on(_default(4581).RTCConnectionEvent.RosterMapUpdate, (arg0) => {
      closure_0 = arg0;
      callback(706).wait(() => {
        let obj = closure_1_1(closure_1_2[8]);
...
const rTCConnectionStore = new RTCConnectionStore(dispatcherDefault, {
  ...
  VOICE_CHANNEL_SELECT: function handleVoiceChannelSelect(channelId) {
    ...
    if (null != channelId.channelId) {
      timeout = new _require(4365).Timeout();
      timeout.start(30000, () => {
