...
// Dependencies: [4463, 1218, 4521, 676, 4510, 3, 4522, 4544, 709, 13413, 4330, 4524, 5320, 13414, 589, 13416, 698, 2010, 2]

// Module 4520 (createRTCConnection)
import timestampDefault from "timestamp" /* 3 */;
import initializeDefault from "initialize" /* 589 */;
import dispatcherDefault from "dispatcher" /* 709 */;
import sleep from "sleep" /* 4524 */;
import updateVoiceStatesDefault from "updateVoiceStates" /* 13413 */;
import useIsSpatialAudioAvailable from "useIsSpatialAudioAvailable" /* 13414 */;
import trackVideoToggle from "trackVideoToggle" /* 13416 */;
import closure_5 from "set" /* 4463 */;
import closure_6 from "fetchFingerprint" /* 1218 */;
import closure_7 from "getVoiceStatesForGuild" /* 4521 */;
...
const rTCConnectionStore = new RTCConnectionStore(dispatcherDefault, {
  ...
  VOICE_CHANNEL_SELECT: function handleVoiceChannelSelect(channelId) {
    ...
    if (null != channelId.channelId) {
      timeout = new _require(4330).Timeout();
      timeout.start(30000, () => {
