...
// Dependencies: [4316, 1218, 4374, 676, 4362, 3, 4375, 4397, 709, 13021, 4187, 4377, 5128, 13022, 589, 13024, 698, 1988, 2]

// Module 4373 (createRTCConnection)
import set from "set";
...
function createRTCConnection(arg0, arg1) {
  if (null == closure_4) {
    ...
    obj[3] = arg1;
    obj[4] = c23;
    _default = new _default(4375).default(obj);
    _default.on(_default(4397).RTCConnectionEvent.State, (arg0, arg1, arg2) => {
      let closure_0 = arg0;
      const callback = arg1;
    ...
    _default.on(_default(4397).RTCConnectionEvent.Video, (arg0, arg1, arg2, arg3, arg4) => {
      let closure_0 = arg0;
      let closure_1 = arg1;
      let closure_2 = arg2;
      let closure_3 = arg3;
    ...
    _default.on(_default(4397).RTCConnectionEvent.Ping, (arg0, arg1) => {
      let closure_0 = arg0;
      const callback = arg1;
      callback(709).wait(() => {
    ...
    _default.on(_default(4397).RTCConnectionEvent.OutboundLossRate, (arg0) => {
      let closure_0 = arg0;
      callback(709).wait(() => {
    ...
    _default.on(_default(4397).RTCConnectionEvent.Speaking, (userId, speaking) => {
      if (closure_17 != null) {
        closure_17.setSpeaking(userId, speaking);
      }
    });
    _default.on(_default(4397).RTCConnectionEvent.Flags, (arg0, arg1) => {
      let closure_0 = arg0;
      let closure_1 = arg1;
      outer1_1(outer1_2[8]).wait(() => {
        let obj = outer2_1(outer2_2[8]);
    ...
    _default.on(_default(4397).RTCConnectionEvent.UsersMerged, (userIds, context) => {
      let obj = callback(709);
      obj = { type: "RTC_CONNECTION_USERS_MERGED", userIds, context };
      obj.dispatch(obj);
    });
    _default.on(_default(4397).RTCConnectionEvent.ClientConnect, (arg0) => {
      let closure_0 = arg0;
      outer1_1(outer1_2[8]).wait(() => {
        let obj = outer2_1(outer2_2[8]);
    ...
    _default.on(_default(4397).RTCConnectionEvent.ClientDisconnect, (arg0) => {
      let closure_0 = arg0;
      outer1_1(outer1_2[8]).wait(() => {
        let obj = outer2_1(outer2_2[8]);
    ...
    _default.on(_default(4397).RTCConnectionEvent.Platform, (arg0, arg1, arg2) => {
      let closure_0 = arg0;
      const callback = arg1;
      const dependencyMap = arg2;
      callback(709).wait(() => {
    ...
    _default.on(_default(4397).RTCConnectionEvent.SecureFramesUpdate, () => {
      callback(709).wait(() => {
        callback(table[8]).dispatch({ type: "RTC_CONNECTION_SECURE_FRAMES_UPDATE" });
      });
    });
    _default.on(_default(4397).RTCConnectionEvent.RosterMapUpdate, (arg0) => {
      let closure_0 = arg0;
      callback(709).wait(() => {
        let obj = outer1_1(outer1_2[8]);
...
prototype["initialize"] = function initialize() {
  ...
  const result = require(13024) /* trackVideoToggle */.setVideoToggleAnalyticsParams(this.getRTCConnectionId, this.getMediaSessionId);
};
...
const rTCConnectionStore = new RTCConnectionStore(require("dispatcher"), {
  ...
  RTC_CONNECTION_STATE: function handleRTCConnectionState(state) {
    if (state.state === constants.RTC_CONNECTED) {
      let c19 = true;
      if (null != closure_3) {
        let closure_20 = require(4377) /* sleep */.now();
  ...
  VOICE_CHANNEL_SELECT: function handleVoiceChannelSelect(channelId) {
    ...
    if (null != channelId.channelId) {
      timeout = new _require(4187).Timeout();
      timeout.start(30000, () => {
  ...
  AUDIO_SET_AUDIO_MIXER_SETTINGS: function handleAudioSetAudioMixerSettings(context) {
    if (context.context !== MediaEngineContextTypes.DEFAULT) {
      ...
      if (flag) {
        flag = require(13022) /* useIsSpatialAudioAvailable */.isSpatialAudioAvailable("RTCConnectionStore");
        const obj = require(13022) /* useIsSpatialAudioAvailable */;
      }
      if (closure_3 != null) {
