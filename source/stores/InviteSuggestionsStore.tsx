...
// Dependencies: [6, 7, 15, 17, 18, 6141, 5926, 1348, 3793, 3802, 653, 6003, 8326, 1327, 566, 686, 2]

// Module 10066 (_isNativeReflectConstruct)
...
function _computeRows(query) {
  ...
  const mostRecentDMedUser = set1(8326).getMostRecentDMedUser(set, id);
  ...
  return set1(8326).generateRowsForQuery(obj);
}
...
tmp5 = new tmp5(require("dispatcher"), {
  LOAD_INVITE_SUGGESTIONS: function refreshInviteSuggestions(guild) {
    ...
    let obj = require(8326) /* _createForOfIteratorHelperLoose */;
