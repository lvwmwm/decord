...
// Dependencies: [6, 7, 15, 17, 18, 6107, 5892, 1348, 3759, 3768, 653, 5969, 8288, 1327, 566, 686, 2]

// Module 10026 (_isNativeReflectConstruct)
...
function _computeRows(query) {
  ...
  const mostRecentDMedUser = set1(8288).getMostRecentDMedUser(set, id);
  ...
  return set1(8288).generateRowsForQuery(obj);
}
...
tmp5 = new tmp5(require("dispatcher"), {
  LOAD_INVITE_SUGGESTIONS: function refreshInviteSuggestions(guild) {
    ...
    let obj = require(8288) /* _createForOfIteratorHelperLoose */;
