...
// Function ID: 4341
// Name: initialize
// Dependencies: [4275, 1218, 4302, 4341, 4326, 676, 4319, 38, 4343, 12, 4318, 7092, 709, 4351, 500, 589, 12945, 2]

// Module 4340 (initialize)
...
prototype["getQuality"] = function getQuality(arg0) {
  if (importDefault(12945)(closure_6)) {
    if (null != arg0) {
      let quality;
...
if (importDefaultResult.isSupported()) {
  ...
  obj[7] = function handleRtcConnectionRemoteVideoSinkWants(guildId) {
    ...
    const encodeStreamKeyResult = require(4318) /* isStreamKey */.encodeStreamKey({ streamType: GUILD, guildId, channelId, ownerId: userId });
    let tmp6 = context === require(4351) /* BaseConnectionEvent */.MediaEngineContextTypes.STREAM;
    if (tmp6) {
  ...
  obj[10] = function handleStreamCreate(arg0) {
    ...
    let obj1 = require(4318) /* isStreamKey */;
    let tmp7 = null == obj;
    if (tmp7) {
