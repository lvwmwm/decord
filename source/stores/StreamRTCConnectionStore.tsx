...
// Function ID: 4390
// Name: initialize
// Dependencies: [4323, 1218, 4351, 4390, 4375, 676, 4368, 38, 4392, 12, 4367, 7199, 709, 4400, 500, 589, 13077, 2]

// Module 4389 (initialize)
...
prototype["getQuality"] = function getQuality(arg0) {
  if (importDefault(13077)(closure_6)) {
    if (null != arg0) {
      let quality;
...
if (importDefaultResult.isSupported()) {
  ...
  obj[7] = function handleRtcConnectionRemoteVideoSinkWants(guildId) {
    ...
    const encodeStreamKeyResult = require(4367) /* isStreamKey */.encodeStreamKey({ streamType: GUILD, guildId, channelId, ownerId: userId });
    let tmp6 = context === require(4400) /* BaseConnectionEvent */.MediaEngineContextTypes.STREAM;
    if (tmp6) {
  ...
  obj[10] = function handleStreamCreate(arg0) {
    ...
    let obj1 = require(4367) /* isStreamKey */;
    let tmp7 = null == obj;
    if (tmp7) {
