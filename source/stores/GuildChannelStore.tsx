...
// Function ID: 1933
// Name: comparator
// Dependencies: [1933, 1375, 3816, 1376, 1218, 1372, 1942, 1862, 3817, 3826, 1874, 676, 1865, 12, 4380, 506, 3822, 589, 709, 2]
...
function hasElevatedPermissions(user, context) {
  ...
  return obj.hasAny(importAll(3822).computePermissions(obj), closure_20);
}
