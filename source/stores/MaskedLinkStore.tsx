...
// Dependencies: [6, 7, 15, 17, 18, 8151, 8179, 1443, 587, 566, 686, 2]

// Module 8178 (_isNativeReflectConstruct)
...
function _isTrustedDomain(url) {
  const hostname = require(8179) /* getHostname */.getHostname(url);
...
function _isTrustedProtocol(url) {
  return set1.has(require(8179) /* getHostname */.getProtocol(url));
}
let set = new Set();
const set1 = new Set();
let replaced;
...
tmp5 = new tmp5(require("dispatcher"), {
  MASKED_LINK_ADD_TRUSTED_DOMAIN: function handleAddTrustedDomain(url) {
    ...
    if (_isTrustedDomain(url)) {
      ...
      let obj = require(8179) /* getHostname */;
