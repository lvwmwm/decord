...
// Dependencies: [4169, 5793, 1372, 1862, 3883, 1931, 4072, 1874, 676, 1379, 505, 5794, 1231, 11, 4491, 589, 709, 2]
// Exports: isViewChannelSidebar

// Module 5792 (handlePermissionsChange)
...
function handlePermissionsChange() {
  ...
  if (keys !== undefined) {
    ...
    while (keys[tmp] !== undefined) {
      ...
      if (tmp15.type === require(5794) /* SidebarType */.SidebarType.VIEW_THREAD) {
        let tmp7 = channel;
...
prototype["getCurrentSidebarChannelId"] = function getCurrentSidebarChannelId(channelId) {
  ...
  if (null == tmp) {
    ...
    if (null != dependencyMap[tmp]) {
      if (tmp8.type !== require(5794) /* SidebarType */.SidebarType.VIEW_THREAD) {
...
const channelSectionStore = new ChannelSectionStore(require("dispatcher"), {
  ...
  SIDEBAR_VIEW_CHANNEL: function handleSidebarViewChannel(arg0) {
    ...
    if (null == tmp) {
      ...
      obj[2] = details;
      let tmp9 = obj;
      if (sidebarType === require(5794) /* SidebarType */.SidebarType.VIEW_MOD_REPORT) {
        obj = {};
  ...
  SIDEBAR_CREATE_THREAD: function handleCreateThread(parentChannelId) {
    ...
    if (null != tmp) {
      ...
      obj[0] = require(5794) /* SidebarType */.SidebarType.CREATE_THREAD;
      ...
      if (keys !== undefined) {
        ...
        while (keys[tmp] !== undefined) {
          ...
          if (tmp14) {
            ...
            tmp14 = tmp18.type === require(5794) /* SidebarType */.SidebarType.VIEW_CHANNEL;
          }
          if (tmp14) {
  ...
  THREAD_CREATE: function handleThreadCreate(channel) {
    ...
    if (channel.ownerId === id) {
      ...
      let tmp5 = null != tmp12;
      if (tmp5) {
        tmp5 = tmp12.type === require(5794) /* SidebarType */.SidebarType.CREATE_THREAD;
      }
      if (tmp5) {
      ...
      if (tmp5) {
        ...
        obj[0] = require(5794) /* SidebarType */.SidebarType.VIEW_THREAD;
        obj[1] = channel.id;
  ...
  THREAD_DELETE: function handleThreadDelete(channel) {
    ...
    if (null != dependencyMap[channel.parent_id]) {
      if (tmp3.type === require(5794) /* SidebarType */.SidebarType.VIEW_THREAD) {
...
export const isViewChannelSidebar = function isViewChannelSidebar(type) {
  const items = [require(5794) /* SidebarType */.SidebarType.VIEW_CHANNEL, require(5794) /* SidebarType */.SidebarType.VIEW_THREAD, require(5794) /* SidebarType */.SidebarType.VIEW_MESSAGE_REQUEST, require(5794) /* SidebarType */.SidebarType.VIEW_MOD_REPORT];
