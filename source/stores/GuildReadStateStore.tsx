...
// Dependencies: [7019, 7021, 5206, 3914, 1376, 1218, 1372, 1891, 1220, 3912, 4297, 1960, 4480, 1903, 676, 1379, 4481, 6915, 11, 1894, 12, 3919, 2]

// Module 7018 (updateGuildUnreadSentinel)
  ...
  if (null == channel) {
    ...
    if (channel.hasFlag(ChannelFlags.IS_GUILD_RESOURCE_CHANNEL)) {
      ...
      if (!channel.isPrivate()) {
        let result1 = require(6915) /* useOptInEnabledForGuild */.isOptInEnabledForGuild(channel.guild_id);
        ...
        const obj = require(6915) /* useOptInEnabledForGuild */;
      }
      let tmp16 = num > 0;
      if (!tmp16) {
...
function recountGuild(guildId) {
  ...
  if (NULL_STRING_GUILD_ID !== guildId) {
    ...
    if (null == tmp2) {
      ...
      let obj2 = require(6915) /* useOptInEnabledForGuild */;
...
function handleChannelSelect(arg0) {
  ...
  const isFavoritesGuildIdResult = require(1894) /* getFavoritesAwareGuildName */.isFavoritesGuildId(guildId);
...
function handleThreadMembersUpdate(id) {
  let result = require(3919) /* doesThreadMembersActionAffectMe */.doesThreadMembersActionAffectMe(id);
  if (result) {
    const items = [id.id];
