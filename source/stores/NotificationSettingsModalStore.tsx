...
// Function ID: 16664
// Name: FormStates
// Dependencies: [1395, 5293, 1980, 4265, 1910, 4539, 676, 589, 5294, 709, 2]

// Module 16663 (FormStates)
...
prototype["getProps"] = function getProps() {
  ...
  return {
    ...
    channels: importDefault(5294)(categories._categories, categories, (channel) => {
