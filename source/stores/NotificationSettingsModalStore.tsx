...
// Function ID: 16682
// Name: FormStates
// Dependencies: [1395, 5315, 1980, 4263, 1910, 4550, 676, 589, 5316, 709, 2]

// Module 16681 (FormStates)
...
prototype["getProps"] = function getProps() {
  ...
  return {
    ...
    channels: importDefault(5316)(categories._categories, categories, (channel) => {
