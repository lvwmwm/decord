...
// Function ID: 16441
// Name: FormStates
// Dependencies: [1376, 5207, 1932, 4176, 1862, 4450, 676, 589, 5208, 709, 2]

// Module 16440 (FormStates)
...
prototype["getProps"] = function getProps() {
  ...
  return {
    ...
    channels: importDefault(5208)(categories._categories, categories, (channel) => {
