...
// Function ID: 16594
// Name: FormStates
// Dependencies: [1376, 5254, 1961, 4224, 1891, 4499, 676, 589, 5255, 709, 2]

// Module 16593 (FormStates)
...
prototype["getProps"] = function getProps() {
  ...
  return {
    ...
    channels: importDefault(5255)(categories._categories, categories, (channel) => {
