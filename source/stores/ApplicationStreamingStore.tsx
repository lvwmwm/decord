...
// Function ID: 4323
// Name: reset
// Dependencies: [4317, 4323, 1218, 1372, 1891, 4351, 3929, 4375, 1960, 4319, 676, 4368, 687, 4367, 13178, 13179, 13180, 1988, 7185, 589, 13066, 709, 2]
...
function handleStreamUpdate(streamKey) {
  ...
  const obj = {};
  const merged = Object.assign(require(4367) /* isStreamKey */.decodeStreamKey(streamKey));
...
prototype["getLastActiveStream"] = function getLastActiveStream() {
  let tmp = null;
  if (importDefault(13066)(_detectH265HardwareDecode)) {
    const _Array = Array;
...
prototype["getActiveStreamForApplicationStream"] = function getActiveStreamForApplicationStream(streamForUser) {
  if (importDefault(13066)(_detectH265HardwareDecode)) {
    if (null != streamForUser) {
      const self = this;
      let activeStreamForStreamKey = this.getActiveStreamForStreamKey(require(4367) /* isStreamKey */.encodeStreamKey(streamForUser));
...
prototype["getStreamerActiveStreamMetadata"] = function getStreamerActiveStreamMetadata() {
  ...
  if (null == channel) {
    ...
    if (null != activeStreamForUser) {
      const obj2 = require(4367) /* isStreamKey */;
  ...
  if (importDefault(13066)(_detectH265HardwareDecode)) {
    ...
    if (null != tmp5) {
      ...
      if (!tmp10) {
        ...
        let first = null != basicChannel1;
        if (first) {
          const obj2 = require(7185) /* canStreamInChannel */;
          first = obj2.canWatchStream(basicChannel1, updateVoiceState, createGuildRecordFromRust, getUncachedChannelPermissions, set)[0];
        }
        flag = first;
      }
...
prototype["getViewerIds"] = function getViewerIds(currentUserActiveStream) {
  if (importDefault(13066)(_detectH265HardwareDecode)) {
    ...
    if (typeof currentUserActiveStream !== "string") {
      encodeStreamKeyResult = require(4367) /* isStreamKey */.encodeStreamKey(currentUserActiveStream);
      const obj = require(4367) /* isStreamKey */;
    }
    let tmp5 = null;
...
const applicationStreamingStore = new ApplicationStreamingStore(require("dispatcher"), {
  ...
  NATIVE_SCREEN_SHARE_PICKER_UPDATE: function handleNativePickerUpdate(content) {
    ...
    if (null == content) {
      ...
      if (tmp2) {
        const tmp6 = importDefault(13179)(content);
  ...
  STREAM_DELETE: function handleStreamDelete(unavailable) {
    ...
    if (null == value) {
      ...
      if (unavailable.unavailable) {
        ...
        let obj = guildId(4367);
        guildId = obj.decodeStreamKey(streamKey).guildId;
        guildId(1988)(13180, dependencyMap.paths).then((arg0) => {
          arg0.default(guildId);
        });
        FAILED = tmp22.ENDED;
        const promise = guildId(1988)(13180, dependencyMap.paths);
      } else {
        if (tmp9) {
          FAILED = tmp22.FAILED;
        }
  ...
  STREAM_UPDATE_SELF_HIDDEN: function handleUpdateSelfStreamHidden(arg0) {
    ...
    let isStreamKeyResult = require(4367) /* isStreamKey */.isStreamKey(c24);
  ...
  CHANNEL_RTC_SELECT_PARTICIPANT: function handleStreamCloseAll(id) {
    ...
    if (isStreamKeyResult) {
      isStreamKeyResult = require(4367) /* isStreamKey */.isStreamKey(id);
      const obj = require(4367) /* isStreamKey */;
    }
    if (isStreamKeyResult) {
