...
// Dependencies: [15, 17, 18, 57, 6, 7, 4212, 1850, 653, 4226, 10807, 4262, 686, 566, 2]
// Exports: keySection, parseSection

// Module 10806 (_isNativeReflectConstruct)
...
obj = {
  ...
  RTC_DEBUG_MODAL_OPEN_REPLAY: function handleOpenReplay() {
    importAll(10807).chooseReplayPath();
  },
    ...
    if (mediaEngine.supports(constants.CONNECTION_REPLAY)) {
      if (0 !== path.length) {
        ...
        if (null != replayConnection) {
          replayConnection.on(replayConnection(4262).BaseConnectionEvent.Video, (userId) => {
