...
// Dependencies: [1991, 1982, 1218, 1391, 1983, 1910, 3977, 3, 3978, 1987, 1403, 11, 1899, 1900, 1933, 1370, 1953, 12, 3979, 589, 709, 2]
...
function trackCommunicationDisabled(guildId, tmp10Result) {
  if (null != tmp10Result.communicationDisabledUntil) {
    ...
    obj2 = require(3978) /* isCommunicationDisabled */;
    tmp10 = require;
  }
...
function computeDerivedMemberState(unsafeMutableRoles, roles) {
  ...
  let tmp4;
  if (0 === roles.length) {
    return { colorString: null, colorStrings: null, colorRoleId: "id", hoistRoleId: "result", iconRoleId: "justifyContent", highestRoleId: "ti" };
  } else {
