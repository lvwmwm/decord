...
// Dependencies: [1993, 1984, 1218, 1387, 1985, 1909, 4079, 3, 4080, 1989, 1399, 11, 1898, 1899, 1933, 1471, 1954, 12, 4081, 589, 709, 2]
...
function trackCommunicationDisabled(guildId, tmp10Result) {
  if (null != tmp10Result.communicationDisabledUntil) {
    if (obj2.isMemberCommunicationDisabled(tmp10Result)) {
      ...
      if (result) {
        result = tmp10(4080).isMemberCommunicationDisabled(tmp10Result);
        tmp10Result = tmp10(4080);
      }
      if (result) {
...
function computeDerivedMemberState(unsafeMutableRoles, roles) {
  ...
  let tmp4;
  if (0 === roles.length) {
    return { colorString: null, colorStrings: null, colorRoleId: "channel_id", hoistRoleId: "index", iconRoleId: "key", highestRoleId: "l" };
  } else {
