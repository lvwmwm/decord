...
// Dependencies: [1943, 1934, 1218, 1372, 1935, 1862, 3809, 3, 3810, 1939, 1384, 11, 1852, 1853, 1885, 1351, 1905, 12, 3811, 589, 709, 2]
...
function trackCommunicationDisabled(guildId, tmp10Result) {
  if (null != tmp10Result.communicationDisabledUntil) {
    if (obj2.isMemberCommunicationDisabled(tmp10Result)) {
      ...
      if (result) {
        result = tmp10(3810).isMemberCommunicationDisabled(tmp10Result);
        tmp10Result = tmp10(3810);
      }
      if (result) {
    ...
    obj2 = require(3810) /* isCommunicationDisabled */;
    tmp10 = require;
  }
...
function computeDerivedMemberState(unsafeMutableRoles, roles) {
  ...
  let tmp4;
  if (0 === roles.length) {
    return { colorString: null, colorStrings: null, colorRoleId: "channelId", hoistRoleId: "end", iconRoleId: "jsxs", highestRoleId: "method" };
  } else {
