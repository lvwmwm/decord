...
// Dependencies: [1993, 1984, 1218, 1387, 1985, 1909, 4109, 3, 4110, 1989, 1399, 11, 1898, 1899, 1938, 1471, 1954, 12, 4111, 589, 709, 2]
...
function trackCommunicationDisabled(guildId, tmp10Result) {
  if (null != tmp10Result.communicationDisabledUntil) {
    if (obj2.isMemberCommunicationDisabled(tmp10Result)) {
      ...
      if (result) {
        result = tmp10(4110).isMemberCommunicationDisabled(tmp10Result);
        tmp10Result = tmp10(4110);
      }
      if (result) {
