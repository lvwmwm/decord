...
// Function ID: 10346
// Name: updateGiftCode
// Dependencies: [9547, 676, 4187, 3883, 4536, 709, 10346, 589, 2]

// Module 10345 (updateGiftCode)
...
function resolveMessageGiftCodes(message, arg1) {
  ...
  let obj = require(4536) /* _resolveGiftCode */;
  const isGiftCodeEmbedResult = require(4536) /* _resolveGiftCode */.isGiftCodeEmbed(message);
...
prototype["getUserGiftCodesFetchingForSKUAndPlan"] = function getUserGiftCodesFetchingForSKUAndPlan(skuId, subscriptionPlanId) {
  return set.has(require(4536) /* _resolveGiftCode */.makeComboId(skuId, subscriptionPlanId));
};
prototype["getUserGiftCodesLoadedAtForSKUAndPlan"] = function getUserGiftCodesLoadedAtForSKUAndPlan(skuId, subscriptionPlanId) {
  const obj = require(4536) /* _resolveGiftCode */;
...
const giftCodeStore = new GiftCodeStore(require("dispatcher"), {
  ...
  GIFT_CODES_FETCH: function handleGiftCodesFetch(arg0) {
    ...
    set.add(require(4536) /* _resolveGiftCode */.makeComboId(skuId, subscriptionPlanId));
  },
  GIFT_CODES_FETCH_SUCCESS: function handleGiftCodesFetchSuccess(giftCodes) {
    ...
    const comboId = require(4536) /* _resolveGiftCode */.makeComboId(skuId, subscriptionPlanId);
  ...
  GIFT_CODES_FETCH_FAILURE: function handleGiftCodesFetchFail(arg0) {
    ...
    let subscriptionPlanId;
    ({ skuId, subscriptionPlanId } = arg0);
    set.delete(require(4536) /* _resolveGiftCode */.makeComboId(skuId, subscriptionPlanId));
  },
