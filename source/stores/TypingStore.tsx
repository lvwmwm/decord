...
// Dependencies: [1218, 1391, 7364, 676, 687, 6020, 530, 709, 589, 2]

// Module 11456 (handleTypingStart)
...
const typingStore = new TypingStore(dispatcherDefault, {
  ...
  TYPING_START_LOCAL: function handleTypingStartLocal(channelId) {
    ...
    if (null == id) {
      return false;
    } else if (channelId === channelId(6020).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) {
      return false;
    } else {
      let tmp3 = null != obj;
      if (tmp3) {
