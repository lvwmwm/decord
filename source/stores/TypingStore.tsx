...
// Dependencies: [1218, 1391, 7214, 676, 687, 5904, 530, 709, 589, 2]

// Module 11439 (handleTypingStart)
...
const typingStore = new TypingStore(require("dispatcher"), {
  ...
  TYPING_START_LOCAL: function handleTypingStartLocal(channelId) {
    ...
    if (null == id) {
      return false;
    } else if (channelId === channelId(5904).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) {
      return false;
    } else {
      let tmp3 = null != obj;
      if (tmp3) {
