...
// Dependencies: [1218, 1372, 7067, 676, 687, 5764, 530, 709, 589, 2]

// Module 11290 (handleTypingStart)
...
const typingStore = new TypingStore(require("dispatcher"), {
  ...
  TYPING_START_LOCAL: function handleTypingStartLocal(channelId) {
    ...
    if (null == id) {
      return false;
    } else if (channelId === channelId(5764).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) {
      return false;
    } else {
      let tmp3 = null != obj;
      if (tmp3) {
