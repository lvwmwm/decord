...
// Dependencies: [4382, 1218, 676, 595, 4390, 1403, 589, 12, 709, 2]

// Module 4381 (setLibraryApplications)
...
function setLibraryApplications(libraryApplications) {
  while (tmp !== undefined) {
    ...
    let obj = require(4390) /* getComboId */;
    let tmp7 = closure_9;
...
function handleLibraryApplicationUpdate(libraryApplication) {
  ...
  const comboId = require(4390) /* getComboId */.getComboId(fromServer.id, fromServer.branchId);
...
prototype["hasApplication"] = function hasApplication(arg0, arg1) {
  ...
  const comboId = require(4390) /* getComboId */.getComboId(arg0, arg1);
  ...
  if (tmp5) {
    ...
    if (!isHiddenResult) {
      result = require(4390) /* getComboId */.isUserEntitledToLibraryApplication(obj2);
      const tmpResult = require(4390) /* getComboId */;
    }
    tmp5 = result;
  }
  return tmp5;
...
prototype["getLibraryApplication"] = function getLibraryApplication(applicationId, arg1, arg2) {
  ...
  const comboId = require(4390) /* getComboId */.getComboId(applicationId, arg1);
  ...
  if (flag) {
    ...
    if (null != tmp4) {
      ...
      tmp6 = tmp7;
      tmpResult = require(4390) /* getComboId */;
    }
  }
  return tmp6;
};
prototype["getActiveLibraryApplication"] = function getActiveLibraryApplication(id) {
  ...
  for (const key10030 in obj) {
    ...
    if (obj[key10030].id !== arg0) {
      ...
      let obj6 = require(4390) /* getComboId */;
...
prototype["isUpdatingFlags"] = function isUpdatingFlags(arg0, arg1) {
  return set.has(require(4390) /* getComboId */.getComboId(arg0, arg1));
};
prototype["getActiveLaunchOptionId"] = function getActiveLaunchOptionId(arg0, arg1) {
  const obj = require(4390) /* getComboId */;
...
const libraryApplicationStore = new LibraryApplicationStore(require("dispatcher"), {
  ...
  LIBRARY_APPLICATION_FLAGS_UPDATE_START: function handleFlagsUpdateStart(flags) {
    ...
    const comboId = require(4390) /* getComboId */.getComboId(applicationId, branchId);
    const obj = require(4390) /* getComboId */;
    const comboId1 = require(4390) /* getComboId */.getComboId(applicationId, branchId);
