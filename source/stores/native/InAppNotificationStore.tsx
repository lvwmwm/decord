...
// Dependencies: [1390, 4358, 9802, 5298, 7044, 1340, 1391, 1910, 9803, 4357, 1979, 1385, 1922, 676, 8169, 8167, 3943, 12, 9804, 9806, 5987, 5931, 9807, 9816, 4564, 9817, 9818, 9820, 9812, 9821, 9822, 9826, 4536, 4034, 1306, 8423, 7101, 9827, 4539, 11, 589, 709, 2]

// Module 9801 (handleAlertMessage)
...
function handleEnqueueNotification(notification) {
  ...
  const trackWithMetadata = importDefault(4539).trackWithMetadata;
  if (closure_23) {
...
function trackDismissed(type) {
  ...
  importDefault(4539).trackWithMetadata(constants.IN_APP_NOTIFICATION_DISMISSED, obj);
}
...
prototype["dismissNotification"] = function dismissNotification(guild) {
  guild = guild.guild;
  let obj = require(8167) /* DATE_CONFIG */;
...
const inAppNotificationStore = new InAppNotificationStore(require("dispatcher"), {
  POST_CONNECTION_OPEN: function handlePostConnectionOpen() {
    ...
    let closure_25 = require(9804) /* isOnlyDayLoss */.toScheduleSnapshot(tmp3);
    handleAlertMessage();
  },
  LOGOUT: function handleLogout() {
    let c24 = false;
    const EMPTY_SCHEDULE_SNAPSHOT = require(9804) /* isOnlyDayLoss */.EMPTY_SCHEDULE_SNAPSHOT;
    let c21 = null;
    obj1.removeAll(() => true);
  },
  ...
  MESSAGE_CREATE: function handleIncomingMessage(message) {
    ...
    let obj = require(9806) /* canViewPotentiallyNSFWChannel */;
  ...
  MESSAGE_REQUEST_NOTIFICATION_SENT: function handleMessageRequest(triggeringUserId) {
    ...
    if (obj.getConfig({ location: "inAppNotificationStore" }).enabled) {
      ...
      if (null == user) {
        ...
        obj[4] = require(9818) /* isReactionMilestoneNotification */.getNotificationDuration(MESSAGE_REQUEST);
        obj[5] = function onDismiss() {
          callback(table[27]).clearNotification();
        };
        const obj4 = require(9818) /* isReactionMilestoneNotification */;
        obj[6] = require(9818) /* isReactionMilestoneNotification */.generateInAppNotificationId();
        obj[0] = obj;
        handleEnqueueNotification(obj);
      }
    } else {
  ...
  RESTRICTED_HOURS_STATE_CHANGE: function handleRestrictedHoursStateChange(isInRestrictedHours) {
    ...
    if (isInRestrictedHours) {
      if (null != _null) {
        const result = require(9818) /* isReactionMilestoneNotification */.extractMetadataFromNotification(_null);
        ({ guildId, channelId, messageId } = result);
  ...
  USER_SETTINGS_PROTO_UPDATE: function handleUserSettingsUpdate() {
    ...
    let guildId;
    let messageId;
    let obj = require(9807) /* shouldNotifyBase */;
    const result = obj.allowInAppNotifications();
    let flag = !result;
    if (!result) {
      if (null != _null) {
        const result1 = require(9818) /* isReactionMilestoneNotification */.extractMetadataFromNotification(_null);
        ({ guildId, channelId, messageId } = result1);
        const tmpResult = require(9818) /* isReactionMilestoneNotification */;
