...
// Dependencies: [1218, 1372, 1862, 1931, 4006, 1874, 676, 1351, 8194, 503, 698, 589, 709, 2]

// Module 13455 (handleTokenUpdated)
...
const shareStore = new ShareStore(require("dispatcher"), {
  ...
  LOGOUT: function handleLogout() {
    importDefault(8194).setSelectedChannel(null, null);
    const obj = importDefault(8194);
    const obj2 = importDefault(8194);
  ...
  APP_STATE_UPDATE: function handleAppStateUpdate(state) {
    ...
    if (state === AppStates.INACTIVE) {
      if (null != c4) {
        ...
        importDefault(8194).setSelectedChannel(json1, json);
        c3 = null;
        c4 = null;
