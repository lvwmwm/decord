...
// Dependencies: [6, 7, 15, 17, 18, 1194, 1348, 1838, 1907, 3948, 1850, 653, 1327, 8135, 480, 675, 566, 686, 2]

// Module 13392 (_isNativeReflectConstruct)
...
tmp2 = new tmp2(require("dispatcher"), {
  ...
  LOGOUT: function handleLogout() {
    importDefault(8135).setSelectedChannel(null, null);
    const obj = importDefault(8135);
    const obj2 = importDefault(8135);
  ...
  APP_STATE_UPDATE: function handleAppStateUpdate(state) {
    ...
    if (state === AppStates.INACTIVE) {
      if (null != c4) {
        ...
        importDefault(8135).setSelectedChannel(json1, json);
        c3 = null;
        c4 = null;
