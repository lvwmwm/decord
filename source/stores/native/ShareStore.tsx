...
// Dependencies: [1218, 1372, 1891, 1960, 4118, 1903, 676, 1351, 8864, 503, 698, 589, 709, 2]

// Module 13598 (handleTokenUpdated)
...
const shareStore = new ShareStore(require("dispatcher"), {
  ...
  LOGOUT: function handleLogout() {
    importDefault(8864).setSelectedChannel(null, null);
    const obj = importDefault(8864);
    const obj2 = importDefault(8864);
  ...
  APP_STATE_UPDATE: function handleAppStateUpdate(state) {
    ...
    if (state === AppStates.INACTIVE) {
      if (null != c4) {
        ...
        importDefault(8864).setSelectedChannel(json1, json);
        c3 = null;
        c4 = null;
        const obj3 = importDefault(8864);
      }
    }
    if (null != c5) {
