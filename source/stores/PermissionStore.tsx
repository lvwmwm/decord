...
// Dependencies: [1984, 4122, 1392, 4123, 1391, 1430, 1935, 1387, 1992, 1909, 1922, 676, 4125, 4126, 12, 4128, 1426, 589, 506, 4129, 709, 2]

// Module 4121 (getUncachedChannelPermissions)
...
import closure_12 from "createdAt" /* 1935 */;
...
import { MemberSafetyPagePermissions as closure_18 } from "MemberSafetyPagePermissions" /* 4125 */;
...
prototype["canAccessMemberSafetyPage"] = function canAccessMemberSafetyPage(id) {
  ...
  if (null == NONE) {
    ...
    if (null == currentUser) {
      ...
      const guild = store2.getGuild(id);
      if (null == guild) {
        let NONE2 = tmp(4126).NONE;
      } else {
        obj = { user: null, context: null, checkElevated: null };
        obj[0] = currentUser;
        obj[1] = guild;
        obj[2] = true;
        NONE2 = tmp(4126).computePermissions(obj);
        dependencyMap[id] = NONE2;
        const tmpResult = tmp(4126);
      }
      NONE = NONE2;
    }
  }
