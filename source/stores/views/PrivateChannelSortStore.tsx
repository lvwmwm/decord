...
// Dependencies: [5880, 5881, 1395, 1391, 1910, 4356, 4539, 1922, 11, 3985, 3943, 5882, 589, 709, 2]

// Module 5879 (makeSortedChannel)
...
const privateChannelSortStore = new PrivateChannelSortStore(require("dispatcher"), {
  ...
  CHANNEL_CREATE: function handleChannelCreate(channel) {
    ...
    if (tmp) {
      const tmp4 = channel.id !== require(5882) /* FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID */.FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID;
      if (tmp4) {
