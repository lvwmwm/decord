...
// Dependencies: [32, 1375, 1882, 1218, 1372, 1942, 1874, 4209, 676, 4032, 3817, 11, 1306, 12, 589, 1865, 709, 2]
...
function getVoiceStatesForGuild(guildId) {
  ...
  if (null == tmp) {
    if (typeof SortedVoiceStates !== "fileFinishedImporting") {
    ...
    const set = new Set();
    obj[0] = set;
    const secondaryIndexMap = new require(3817) /* version */.SecondaryIndexMap((voiceState) => {
...
function makeSortedVoiceState(voiceState, guildId, arr) {
  ...
  if (nick == null) {
    nick = importDefault(4032).getName(tmp3);
...
export const makeMemberAndComparator = function makeMemberAndComparator(selfStream, member) {
  ...
  if (nick == null) {
    nick = importDefault(4032).getName(arg2);
    const obj2 = importDefault(4032);
  }
  let str = "\u0001";
