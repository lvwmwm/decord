...
// Dependencies: [4272, 1372, 4326, 1874, 4271, 4327, 676, 4273, 4288, 4444, 8707, 4351, 589, 709, 2]

// Module 12896 (retryFailedUsers)
...
const rTCConnectionDesyncStore = new RTCConnectionDesyncStore(require("dispatcher"), {
  ...
  RTC_CONNECTION_STATE: function handleRTCConnectionState(arg0) {
    ...
    let state;
    ({ state, context } = arg0);
    let tmp = context === require(4351) /* BaseConnectionEvent */.MediaEngineContextTypes.DEFAULT;
    if (tmp) {
  ...
  RTC_CONNECTION_CLIENT_CONNECT: function handleRTCConnectionClientConnect(context) {
    ...
    let reduced = context.context === require(4351) /* BaseConnectionEvent */.MediaEngineContextTypes.DEFAULT;
    if (reduced) {
  ...
  RTC_CONNECTION_CLIENT_DISCONNECT: function handleRTCConnectionClientDisconnect(userId) {
    userId = userId.userId;
    let tmp = userId.context === require(4351) /* BaseConnectionEvent */.MediaEngineContextTypes.DEFAULT;
    if (tmp) {
