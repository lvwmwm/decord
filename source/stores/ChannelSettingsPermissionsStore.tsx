...
// Dependencies: [6, 7, 15, 17, 18, 7664, 1348, 653, 6697, 587, 3798, 22, 566, 686, 2]

// Module 15616 (_isNativeReflectConstruct)
...
function getPermissionOverwrites(channel) {
  ...
  if (tmp3) {
    obj[guildId] = importAll(3798).makeEveryoneOverwrite(guildId);
...
function init() {
  ...
  if (null == _null2) {
    ...
    let closure_14 = importAll(3798).areChannelsLocked(_null2, category);
    let c24 = null;
    let c18 = false;
    ...
    if (channel.id === id) {
      ...
      if (null == channel) {
        ...
        if (null == guildId) {
          ...
          let closure_14 = importAll(3798).areChannelsLocked(channel, category);
          return true;
        }
      }
    }
  ...
  CHANNEL_SETTINGS_PERMISSIONS_UPDATE_PERMISSION: function handleUpdatePermission(id) {
    ...
    if (null != tmp) {
      if (null != c21) {
        ...
        let closure_14 = importAll(3798).areChannelsLocked(c21, c22);
      }
    }
    return false;
  },
