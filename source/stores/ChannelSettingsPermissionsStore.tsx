...
// Function ID: 15652
// Name: init
// Dependencies: [7687, 1372, 676, 6718, 595, 3822, 12, 589, 709, 2]
...
function init() {
  ...
  if (null == _null2) {
    ...
    let closure_4 = importAll(3822).areChannelsLocked(_null2, category);
    let c19 = null;
    let c13 = false;
    ...
    if (channel.id === id) {
      ...
      if (null == channel) {
        ...
        if (null == guildId) {
          ...
          if (tmp6) {
            obj[guildId] = importAll(3822).makeEveryoneOverwrite(guildId);
          ...
          let closure_4 = importAll(3822).areChannelsLocked(channel, category);
          return true;
        }
      }
    }
  ...
  CHANNEL_SETTINGS_PERMISSIONS_UPDATE_PERMISSION: function handleUpdatePermission(id) {
    ...
    if (null != tmp) {
      if (null != c16) {
        ...
        let closure_4 = importAll(3822).areChannelsLocked(c16, c17);
      }
    }
    return false;
  },
