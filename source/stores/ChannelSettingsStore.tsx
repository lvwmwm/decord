...
// Dependencies: [1395, 7801, 1930, 1391, 676, 1235, 4000, 4002, 1400, 1401, 530, 709, 12, 1430, 3943, 589, 2]

// Module 8058 (normalizeChannelPropertyForCompare)
          ...
          if (null != str) {
            ...
            if (obj.isCustomReactionEmojiId(str.emojiId)) {
              ...
              if (null != emojiName) {
                ...
                if ("" !== emojiName) {
                  obj = { emojiName: null };
                  obj[0] = importDefault(4002).translateInlineEmojiToSurrogates(emojiName);
                  tmp5 = obj;
...
function _createInvite(code) {
  ...
  obj[9] = importDefault(3943)(code.created_at);
