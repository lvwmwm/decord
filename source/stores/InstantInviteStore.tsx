...
// Function ID: 8310
// Name: map
// Dependencies: [8310, 7669, 8311, 8313, 8314, 586, 706, 2]

// Module 8309 (map)
import initializeDefault from "initialize" /* 586 */;
import dispatcherDefault from "dispatcher" /* 706 */;
import headDefault from "head" /* 8311 */;
import reverseDefault from "reverse" /* 8313 */;
import _modDef8314 from "module_8314" /* 8314 */;
import closure_3 from "createFromServer" /* 8310 */;
...
const instantInviteStore = new InstantInviteStore(dispatcherDefault, {
  ...
  FRIEND_INVITE_CREATE_SUCCESS: function handleFriendInviteCreateSuccess(invite) {
    ...
    let tmpResult = tmp(tmp2(_modDef8314(Object.values(closure_8), "createdAt")));
    if (tmpResult == null) {
      tmpResult = null;
    }
    c2 = tmpResult;
  ...
  FRIEND_INVITE_REVOKE_SUCCESS: function handleFriendInviteRevokeSuccess(invites) {
    ...
    let tmp2Result = tmp2(tmp3(_modDef8314(Object.values(closure_8), "createdAt")));
    if (tmp2Result == null) {
      tmp2Result = null;
    }
    c2 = tmp2Result;
