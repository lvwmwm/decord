...
// Function ID: 13090
// Name: stopActivity
// Dependencies: [4365, 1340, 1218, 4378, 4381, 4416, 1979, 676, 687, 595, 4390, 10425, 4227, 4514, 589, 709, 2]

// Module 13089 (stopActivity)
...
function updateActivity(applicationId) {
  ...
  importDefault(10425).updateActivity(obj);
