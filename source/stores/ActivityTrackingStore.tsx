...
// Function ID: 12921
// Name: stopActivity
// Dependencies: [4305, 1340, 1218, 4317, 4320, 4356, 1960, 676, 687, 595, 4329, 10368, 4170, 4454, 589, 709, 2]

// Module 12920 (stopActivity)
...
function updateActivity(applicationId) {
  ...
  importDefault(10368).updateActivity(obj);
