...
// Dependencies: [32, 5, 4237, 4242, 4103, 4209, 4258, 1340, 1218, 4259, 4260, 1372, 4261, 1874, 12881, 676, 4254, 4402, 12882, 685, 12883, 4250, 3, 687, 500, 4286, 4074, 4732, 12884, 12885, 12886, 10408, 12887, 12, 12868, 12888, 12889, 12890, 12891, 12892, 12893, 12894, 8848, 698, 709, 10785, 12895, 12896, 12897, 5010, 12898, 12943, 12944, 12945, 12946, 12947, 12948, 4249, 4365, 4183, 3800, 595, 12949, 10764, 5197, 12953, 12954, 1236, 4508, 12955, 12956, 12957, 12958, 38, 12880, 12879, 12959, 12863, 1208, 4247, 10254, 589, 12960, 12961, 12962, 12963, 2]
...
function getSettings() {
  ...
  if (null == obj1.vadDuringPreProcess) {
    obj1.vadDuringPreProcess = require(12885) /* getVADBeforeProcessingExperimentConfig */.getVADBeforeProcessingExperimentConfig({ location: "getSettings" }).enabled;
    const obj7 = require(12885) /* getVADBeforeProcessingExperimentConfig */;
  }
  ...
  const aGC2ExperimentConfig = require(12886) /* getAGC2ExperimentConfig */.getAGC2ExperimentConfig({ location: "getSettings" });
...
function setInputMode(context) {
  ...
  if (context.context === MediaEngineContextTypes.DEFAULT) {
    let obj = require(10408) /* setPushToTalkState */;
    obj.setPushToTalkState(false, false);
  }
  let showPTTSpeakingIndicator = importDefault(12887).getConfig({ location: "setInputMode" }).showPTTSpeakingIndicator;
...
function updateConnectionMuteDeaf(context) {
  ...
  if (context.context === MediaEngineContextTypes.DEFAULT) {
    importDefault(12868).updateNativeMute();
    const obj2 = importDefault(12868);
  }
}
      ...
      if (!tmp) {
        ...
        if (null != tmp2) {
          ...
          if (null != tmp2.desktopSource) {
            ...
            const obj20 = require(12884) /* HdrCaptureMode */;
            ...
            if (isWindowsResult) {
              ...
              isWindowsResult = importDefault(12898).satisfies(release, closure_29);
              const obj6 = importDefault(12898);
            }
            if (!isWindowsResult) {
              ...
              if (!isWindowsResult1) {
                ...
                if (videoHook2) {
                  const DisableHookFramePacerExperiment = tmp70(12891).DisableHookFramePacerExperiment;
                  tmp55 = !DisableHookFramePacerExperiment.getConfig({ location: "updateVideo" }).enabled;
                }
                let enabled2 = videoHook2;
                if (videoHook2) {
                  const VideoHookDX12Experiment = tmp70(12892).VideoHookDX12Experiment;
                  enabled2 = VideoHookDX12Experiment.getConfig({ location: "updateVideo" }).enabled;
                }
                const UpscaleSmallCapturedFramesExperiment = tmp70(12893).UpscaleSmallCapturedFramesExperiment;
                ...
                if (isMacResult) {
                  ...
                  isMacResult = importDefault(12898).satisfies(release1, closure_24);
                  const obj14 = importDefault(12898);
                }
                ...
                obj[13] = tmp70(12894).getGlobalFramePoolLockExperimentConfig({ location: "updateVideo" }).enabled;
                obj[14] = false;
                obj[15] = enabled2;
                ...
                const tmp70Result2 = tmp70(12894);
              } else if (true === c131) {
                const WGCDirtyRegionsExperiment = tmp70(12889).WGCDirtyRegionsExperiment;
                let enabled = WGCDirtyRegionsExperiment.getConfig({ location: "updateVideo" }).enabled;
              } else {
                const WGCDirtyRegionsAllExperiment = tmp70(12890).WGCDirtyRegionsAllExperiment;
              ...
              if (isWindowsResult2) {
                ...
                isWindowsResult2 = importDefault(12898).satisfies(release2, closure_27);
                const obj8 = importDefault(12898);
              }
...
function noiseCancellerErrorToAVUnderlyingError(noise_canceller_error) {
  if (NoiseCancellerError.KRISP_CPU_OVERUSE === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispCpuOveruse;
  } else if (tmp.KRISP_FAILED === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispFailed;
  } else if (tmp.KRISP_VAD_CPU_OVERUSE === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispVadCpuOveruse;
  } else if (tmp.KRISP_INIT_ERROR === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispInitError;
  } else if (tmp.KRISP_INIT_ERROR_NATIVE === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispInitErrorNative;
  } else if (tmp.KRISP_INIT_ERROR_SSE4_NOT_SUPPORTED === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispInitErrorSse4NotSupported;
  } else if (tmp.KRISP_INIT_ERROR_AVX2_NOT_SUPPORTED === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispInitErrorAvx2NotSupported;
  } else if (tmp.KRISP_INIT_ERROR_UNSIGNED === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispInitErrorUnsigned;
  } else if (tmp.KRISP_INIT_ERROR_GLOBAL_INIT === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispInitErrorGlobalInit;
  } else if (tmp.KRISP_INIT_ERROR_WEIGHT_8K === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispInitErrorWeight8k;
  } else if (tmp.KRISP_INIT_ERROR_WEIGHT_16K === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispInitErrorWeight16k;
  } else if (tmp.KRISP_INIT_ERROR_WEIGHT_32K === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispInitErrorWeight32k;
  } else if (tmp.KRISP_INIT_ERROR_WEIGHT_VAD === noise_canceller_error) {
    return require(8848) /* mapped */.AVUnderlyingError.KrispInitErrorWeightVad;
  }
}
function handleVoiceProcessingError(noise_canceller_error) {
  obj.warn("Voice processing error: " + noise_canceller_error);
  obj = require(8848) /* mapped */;
  obj = { type: require(8848) /* mapped */.AVError.NOISE_CANCELLER_ERROR, underlyingError: noiseCancellerErrorToAVUnderlyingError(noise_canceller_error) };
...
function handleVideoFilterError(arg0, arg1) {
  ...
  if (arg1 !== constants10.LIVE) {
    ...
    obj[0] = require(8848) /* mapped */.AVError.VIDEO_BACKGROUND_UNAVAILABLE;
    if (constants9.UNSUPPORTED === arg0) {
      AVUnderlyingError = tmp4(8848).AVUnderlyingError;
      let VideoBackgroundInitFailed = AVUnderlyingError.VideoBackgroundUnsupported;
    } else if (tmp5.INIT_FAILED === arg0) {
      VideoBackgroundInitFailed = tmp4(8848).AVUnderlyingError.VideoBackgroundInitFailed;
    }
...
function updateConnectionVoiceProcessing(setEchoCancellation) {
  ...
  const merged = Object.assign(require(12886) /* getAGC2ExperimentConfig */.getAGC2ExperimentConfig(obj).noiseCancellationConfig);
  const result = setEchoCancellation.setAutomaticGainControl(obj);
  const noiseCancellation = tmp2.noiseCancellation;
  const obj3 = require(12886) /* getAGC2ExperimentConfig */;
  const tmp13Result = importDefault(10785)(noiseCancellation, mediaEngineStore.getSystemMicrophoneMode());
  ...
  if (isWindowsResult) {
    ...
    isWindowsResult = tmp12(12898).satisfies(release, c152);
    const tmp12Result1 = tmp12(12898);
  }
  if (isWindowsResult) {
    if (setEchoCancellation.context === MediaEngineContextTypes.DEFAULT) {
      const systemwideEchoCancellationExperimentConfig = tmp8(12896).getSystemwideEchoCancellationExperimentConfig({ location: "updateConnectionVoiceProcessing" });
...
function applySettings() {
  ...
  if (obj2.isWindows()) {
    if (obj3.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) {
      ...
      if (null != guid) {
        tmp5(12954)(tmp7.guid, inputDeviceId, obj);
      }
    }
    obj3 = importDefault(12953);
    tmp5 = importDefault;
  }
...
function maybeTryHookProcess(pidFromDesktopSource, sound) {
  ...
  if (sound) {
    ...
    if (null != soundshareId) {
      ...
      if (isWindowsResult) {
        ...
        const obj8 = importAll(12888);
        importAll(12888).attachToProcess(soundshareId, obj1).then((closure_0) => {
        ...
        const attachToProcessResult = importAll(12888).attachToProcess(soundshareId, obj1);
      }
  ...
  if (videoHook) {
    importAll(12888).attachToProcess(pidFromDesktopSource);
    const obj6 = importAll(12888);
  }
...
function trackVoiceProcessing(location) {
  ...
  const tmp11 = importDefault(10785);
  const tmp11Result = importDefault(10785)(tmp.noiseCancellation, mediaEngineStore.getSystemMicrophoneMode());
...
function setLoopback() {
  ...
  const tmp15 = importDefault(10785);
  const tmp15Result = importDefault(10785)(tmpResult.noiseCancellation, mediaEngineStore.getSystemMicrophoneMode());
  const voiceFidelityCaps = tmp8(12895).getVoiceFidelityCaps({ location: "updateVoiceFidelityCaps" }, { krispEnabled: tmp15Result, noiseSuppressionEnabled: tmp14, echoCancellationEnabled: tmp13 });
...
let c85 = null;
let closure_86 = { [DEFAULT_DEVICE_ID]: { id: DEFAULT_DEVICE_ID, index: 0, name: "No Input Devices", disabled: true, guid: "accessible", hardwareId: "Object", containerId: "l" } };
let closure_87 = { [DEFAULT_DEVICE_ID]: { id: DEFAULT_DEVICE_ID, index: 0, name: "No Output Devices", disabled: true, guid: "accessibilityRole", hardwareId: "context", containerId: "apply" } };
let closure_88 = { [DEFAULT_DEVICE_ID]: { id: DEFAULT_DEVICE_ID, index: 0, name: "No Video Devices", disabled: true, guid: "accessibilityRole", hardwareId: "disabled", containerId: "View" } };
...
prototype["initialize"] = function initialize() {
  let self = this;
  if (navigation == null) {
    const tmp7 = new _pollMetrics(12960)(store3, self);
    navigation = tmp7;
  }
  ...
  store3.on(pollMetrics(4286).MediaEngineEvent.Connection, (setAttenuation) => {
    ...
    if (enabled) {
      enabled = tmp9(12945).getWmfGpuEncode("MediaEngineStore").enabled;
      const tmp9Result10 = tmp9(12945);
    }
    if (enabled) {
    ...
    if (enabled2) {
      enabled2 = tmp9(12946).getWmfGpuEncodeIntel("MediaEngineStore").enabled;
      const tmp9Result12 = tmp9(12946);
    }
    if (enabled2) {
      setAttenuation.setExperimentFlag(tmp22.WMF_GPU_ENCODE, true);
    ...
    if (enabled3) {
      enabled3 = tmp9(12947).getWmfCpuEncodeIntel("MediaEngineStore").enabled;
      const tmp9Result14 = tmp9(12947);
    }
    if (enabled3) {
      setAttenuation.setExperimentFlag(tmp22.INTEL_GPU_DISABLE, true);
    }
    ...
    if (enabled4) {
      enabled4 = tmp9(12945).getWmfGpuEncode("MediaEngineStore").enabled;
      const tmp9Result16 = tmp9(12945);
    }
    if (enabled4) {
      setAttenuation.setExperimentFlag(tmp22.WMF_GPU_ENCODE, true);
    }
    const result2 = store3.setHasFullbandPerformance(tmp25(12948)());
    ...
    if (c6 === 2) {
      ...
      try {
        ...
        if (0 === c5) {
          ...
          if (typeof closure_2.status !== "reType") {
  ...
  store3.on(pollMetrics(4286).MediaEngineEvent.ClipsRecordingEnded, (arg0, soundshareId) => {
    ...
    if (id === arg0) {
      ...
      if (tmp3) {
        const result = callback(12888).cancelAttachToProcess(soundshareId);
        const obj = callback(12888);
      }
      desktopSource2 = null;
    }
  });
  ...
  store3.on(pollMetrics(4286).MediaEngineEvent.VideoCodecError, (mode) => {
    if ("encode" === mode.mode) {
      let VIDEO_DECODE_ERROR = pollMetrics(8848).AVError.VIDEO_ENCODE_ERROR;
      let tmp3 = pollMetrics;
    } else {
      VIDEO_DECODE_ERROR = pollMetrics(8848).AVError.VIDEO_DECODE_ERROR;
      tmp3 = pollMetrics;
    }
    let obj = { videoCodec: mode.codecStandard, errorMessage: mode.message };
    if (VIDEO_DECODE_ERROR === tmp3(8848).AVError.VIDEO_ENCODE_ERROR) {
      obj = { type: null };
...
prototype["supportsExperimentalSoundshare"] = function supportsExperimentalSoundshare() {
  ...
  if (supportsResult) {
    ...
    supportsResult = importDefault(12898).satisfies(release, closure_31);
    const obj = importDefault(12898);
  }
  return supportsResult;
};
prototype["supportsHookSoundshare"] = function supportsHookSoundshare() {
  ...
  if (isWindowsResult) {
    ...
    isWindowsResult = importDefault(12898).satisfies(release, closure_30);
    const obj2 = importDefault(12898);
  }
...
prototype["getVideoEncoderExperiments"] = function getVideoEncoderExperiments(STREAM, streamer) {
  ...
  if (isWindowsResult) {
    ...
    const VideoCaptureDeviceNoReuseExperiment = tmp6(12962).VideoCaptureDeviceNoReuseExperiment;
...
prototype["supportsScreenSoundshare"] = function supportsScreenSoundshare() {
  if (obj.isMac()) {
    ...
    if (supportsResult) {
      ...
      supportsResult = importDefault(12898).satisfies(release, closure_25);
      const obj5 = importDefault(12898);
    }
    if (supportsResult) {
      ...
      if (satisfiesResult) {
        ...
        satisfiesResult = importDefault(12898).satisfies(release1, closure_24);
        const obj7 = importDefault(12898);
      }
...
prototype["getVideoStreamParameters"] = function getVideoStreamParameters(context) {
  ...
  if (this.supports(Features.VIDEO)) {
    ...
    if (enableSimulcast) {
      const DisableCameraSimulcastExperiment = require(12963) /* apexExperiment */.DisableCameraSimulcastExperiment;
...
const mediaEngineStore = new MediaEngineStore(require("dispatcher"), {
  ...
  CONNECTION_OPEN: function handleConnectionOpen(sessionId) {
    ...
    if (tmp17) {
      ...
      if (setMklZenOverrideEnabled != null) {
        const result1 = setMklZenOverrideEnabled(tmp2(12957).getMklZenOverrideExperimentConfig("handleConnectionOpen").enabled);
        const tmp2Result2 = tmp2(12957);
      }
    ...
    if (tmp2Result3.isIOS()) {
      ...
      if (setNcModels != null) {
        setNcModels(tmp2(12958).getKrispV9iOSModels());
        const tmp2Result4 = tmp2(12958);
      }
      mediaEngineStore.emitChange();
    }
    const inputDeviceId = tmp.inputDeviceId;
    ...
    if (tmp2Result5.isWindows()) {
      if (obj12.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) {
        ...
        if (null != guid) {
          tmp26(12954)(tmp28.guid, inputDeviceId, obj3);
        }
      }
      obj12 = importDefault(12953);
      tmp26 = importDefault;
    }
    applyRemoteSettings();
  },
  ...
  AUDIO_SET_LOCAL_VIDEO_DISABLED: function handleSetLocalVideoDisabled(arg0) {
    ...
    if (!tmp22) {
      ...
      if (isAutomatic) {
        tmp3(12880)(userId, tmp12 ? constants12.AUTO_DISABLE : constants12.AUTO_ENABLE, tmp11);
        if (tmp12) {
          obj.add(userId);
        } else {
          obj.delete(userId);
        ...
        if (hasItem) {
          if (!tmp12) {
            ...
            tmp3(12880)(userId, constants12.MANUAL_REENABLE, tmp11);
          }
        }
        tmp3(12880)(userId, tmp12 ? constants12.MANUAL_DISABLE : constants12.MANUAL_ENABLE, tmp11);
      }
      if (tmp19) {
        tmp19 = !tmp12;
      }
  ...
  AUDIO_SET_AUDIO_MIXER_SETTINGS: function handleSetAudioMixerSettings(arg0) {
    ...
    const Storage = require(595) /* Storage */.Storage;
    const result = Storage.set(MediaEngineStore, dependencyMap);
    let supportsResult = true === settings.enabled && importDefault(12879).getConfig({ location: "MediaEngineStore" }).enabled;
    if (supportsResult) {
      supportsResult = store3.supports(Features.SPATIAL_AUDIO);
    }
    let c120 = supportsResult;
  ...
  AUDIO_SET_INPUT_DEVICE: function handleSetInputDevice(id) {
    ...
    if (obj6.isWindows()) {
      if (obj7.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) {
        ...
        if (null != guid) {
          tmp20(12954)(tmp22.guid, id, obj5);
        }
      }
      obj7 = importDefault(12953);
      tmp20 = importDefault;
    }
  ...
  AUDIO_SET_KRISP_MODEL_OVERRIDE: function handleSetKrispModelOverride(model) {
    const result = importDefault(12863).setKrispModelOverride(model.model);
    model = model.model;
    setLoopback();
  },
  ...
  AUDIO_SET_KRISP_SUPPRESSION_LEVEL: function handleSetKrispSuppressionLevel(level) {
    level = level.level;
    const result = importDefault(12863).setKrispSuppressionLevel(level);
  },
  ...
  MEDIA_ENGINE_DEVICES: function handleDevices(videoDevices) {
    ...
    if (0 === arr.length) {
      let obj = { id: null, index: 0, name: null, disabled: true, guid: "call", hardwareId: "exports", containerId: "message" };
    ...
    if (0 === arr3.length) {
      const obj1 = { id: null, index: 0, name: null, disabled: true, guid: "call", hardwareId: "exports", containerId: "message" };
    ...
    if (0 === arr5.length) {
      obj3 = { id: null, index: 0, name: null, disabled: true, guid: "call", hardwareId: "exports", containerId: "message" };
  ...
  AUDIO_INPUT_DETECTED: function handleInputDetected(inputDetected) {
    ...
    if (null == inputDetected) {
      ...
      if (inputDetected) {
        ...
        if (c102) {
          const config = importDefault(12959).getConfig({ location: "MediaEngineStore.handleInputDetected" });
  ...
  AUDIO_SET_BYPASS_SYSTEM_INPUT_PROCESSING: function handleBypassSystemInputProcessing(bypassEnabled) {
    ...
    const tmp19 = importDefault(10785);
    const tmp19Result = importDefault(10785)(tmp16.noiseCancellation, mediaEngineStore.getSystemMicrophoneMode());
    const voiceFidelityCaps = tmp12(12895).getVoiceFidelityCaps({ location: "updateVoiceFidelityCaps" }, { krispEnabled: tmp19Result, noiseSuppressionEnabled: tmp18, echoCancellationEnabled: tmp17 });
  ...
  CLIPS_INIT: function handleClipsInit(applicationName) {
    ...
    if (obj.isDecoupledClipsEnabled()) {
      if (null != importDefault(3800)) {
        ...
        if (videoHook2) {
          const DisableHookFramePacerExperiment = tmp(12891).DisableHookFramePacerExperiment;
          tmp21 = !DisableHookFramePacerExperiment.getConfig({ location: "handleClipsInit" }).enabled;
        }
        let enabled = videoHook2;
        if (videoHook2) {
          const VideoHookDX12Experiment = tmp(12892).VideoHookDX12Experiment;
          enabled = VideoHookDX12Experiment.getConfig({ location: "handleClipsInit" }).enabled;
        }
        const UpscaleSmallCapturedFramesExperiment = tmp(12893).UpscaleSmallCapturedFramesExperiment;
        ...
        if (isMacResult) {
          ...
          isMacResult = tmp3(12898).satisfies(release1, closure_24);
          const tmp3Result2 = tmp3(12898);
        }
  ...
  MEDIA_ENGINE_SET_DEVICE_AUDIO_EFFECTS: function handleSetDeviceAudioEffects(active) {
    ...
    const tmp4 = importDefault(10785);
    const tmp4Result = importDefault(10785)(tmp.noiseCancellation, mediaEngineStore.getSystemMicrophoneMode());
    const voiceFidelityCaps = require(12895) /* getAudioFidelityExperimentConfig */.getVoiceFidelityCaps({ location: "updateVoiceFidelityCaps" }, { krispEnabled: tmp4Result, noiseSuppressionEnabled: tmp3, echoCancellationEnabled: tmp2 });
