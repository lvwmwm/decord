...
// Function ID: 1603
// Name: weakMap
// Dependencies: [32, 19, 17, 21, 1603, 1502, 1605, 1606, 1607, 1609, 1610, 1599]
...
export const NavigationContainer = importAllResult.forwardRef(function NavigationContainerInner(direction, ref) {
  ...
  if (DefaultTheme === undefined) {
    DefaultTheme = linking(1603).DefaultTheme;
  }
  ...
  const obj6 = linking(1609);
  [tmp20, initialState] = ref(linking(1609).useThenable(obj3.useLinking(ref, obj).getInitialState), 2);
  ...
  if (tmp22) {
    ...
    obj2.ref = ref;
    obj1[1] = tmp23(tmp12(1502).BaseNavigationContainer, obj2);
    obj[1] = tmp23(tmp12(1599).LinkingContext.Provider, obj1);
    let tmp24 = obj;
  } else {
    obj3 = { value: null, children: null };
    obj3[0] = DefaultTheme;
    obj3[1] = fallback;
    obj[1] = tmp23(tmp12(1502).ThemeProvider, obj3);
    tmp24 = obj;
  }
  return jsx(linking(1610).LocaleDirContext.Provider, tmp24);
});
