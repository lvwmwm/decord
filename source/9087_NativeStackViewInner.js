...
// Dependencies: [57, 31, 27, 33, 1457, 4522, 9088, 4513, 1560, 5561, 9089, 9092, 9093]
// Exports: default

// Module 9087 (NativeStackViewInner)
...
function MaybeNestedStack(children) {
  ...
  return closure_7(importDefault(9088), obj);
}
function SceneView(arg0) {
  ...
  let context = React.useContext(_require(5561).HeaderShownContext);
  const context1 = React.useContext(_require(5561).HeaderHeightContext);
  let num2 = 0;
  const context2 = React.useContext(_require(5561).HeaderBackContext);
  if (!context) {
    num2 = safeAreaInsets.top;
  }
  let obj3 = _require(1457);
  let obj4 = _require(5561);
  ...
  obj9.children = callback2(_require(4513).EdgeInsetApplicationContext.Provider, obj10);
  obj8.children = callback2(_require(5561).HeaderBackContext.Provider, obj9);
  ...
  items1[2] = callback2(importDefault(9089), Object.assign({}, options, obj13));
  obj4.children = items1;
  obj3.children = closure_8(_require(5561).HeaderHeightContext.Provider, obj4);
  obj2.children = callback2(_require(5561).HeaderShownContext.Provider, obj3);
  ...
  return callback2(_require(4513).Screen, obj, route.key);
}
...
export default function NativeStackView(arg0) {
  ...
  return callback2(require(5561) /* Background */.SafeAreaProviderCompat, obj);
};
