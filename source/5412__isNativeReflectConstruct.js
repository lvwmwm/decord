...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5344, 5369, 5357]

// Module 5412 (_isNativeReflectConstruct)
...
class Swipeable {
  constructor(arg0) {
    ...
    obj = { dragX: value, rowTranslation: null, rowState: 0, leftWidth: "w", rightOffset: "text", rowWidth: "text" };
...
let items = [
  obj,
  {
    ...
    value: function render() {
      ...
      items8[2] = callback3(self(5357).TapGestureHandler, obj8);
      obj7[2] = items8;
      obj6.children = callback4(RN.View, obj7);
      return callback3(self(5369).PanGestureHandler, obj6);
    }
  }
];
