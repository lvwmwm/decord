...
// Dependencies: [5, 41, 42, 93, 95, 98, 19, 17, 21, 81, 8917, 4175, 8919, 8920, 8921, 8939]

// Module 8916 (_isNativeReflectConstruct)
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f116774);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f116774);
    ...
    f116774 = undefined;
    f116774 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8919").NONE, require("module_8919").INVERT, require("module_8919").MONOCHROME, require("module_8919").POSTERIZE, require("module_8919").FALSE, require("module_8919").MAXIMUMCOMPONENT, require("module_8919").MINIMUMCOMPONENT, require("module_8919").CHROME, require("module_8919").FADE, require("module_8919").INSTANT, require("module_8919").MONO, require("module_8919").NOIR, require("module_8919").PROCESS, require("module_8919").TONAL, require("module_8919").TRANSFER, require("module_8919").SEPIA];
...
const items4 = [require("module_8920").CLEARKEY, require("module_8920").FAIRPLAY, require("module_8920").WIDEVINE, require("module_8920").PLAYREADY];
...
const items8 = [require("module_8939").SRT, require("module_8939").TTML, require("module_8939").VTT];
...
export const TextTrackType = require("module_8939");
export const FilterType = require("module_8919");
export const DRMType = require("module_8920");
