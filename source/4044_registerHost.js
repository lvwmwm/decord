...
// Function ID: 33389
// Name: registerHost
// Dependencies: [4045, 4040]

// Module 4044 (registerHost)
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (require(4040).ACTIONS.REGISTER_HOST === type) {
    registerHost(merged, type.hostName);
    return merged;
  } else if (require(4040).ACTIONS.DEREGISTER_HOST === type) {
    const hostName = type.hostName;
    delete tmp[tmp2];
    return merged;
  } else if (require(4040).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return merged;
  } else if (require(4040).ACTIONS.REMOVE_PORTAL === type) {
