...
// Function ID: 3943
// Name: defaultOnError
// Dependencies: [109, 19, 21, 3943, 3944, 3946, 3924]
// Exports: RiveView
...
function defaultOnError(message) {
  return console.error("[" + require(3943).RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp18 = jsx(_require(3924).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
