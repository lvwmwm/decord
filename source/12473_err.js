...
function flush_block_only(state, arg1) {
  ...
  arg1(arg6[2])._tr_flush_block(state, num, state.strstart - state.block_start, arg1);
    ...
    if (0 === state.strm.avail_in) {
      ...
      if (0 === avail_in) {
        ...
        if (1 === strm.state.wrap) {
          ...
          let tmp19 = avail_in;
          let tmp20 = sum1;
          strm.adler = arg1(arg6[3])(strm.adler, _window, avail_in, sum1);
          ...
          let tmp14 = avail_in;
          let tmp15 = sum1;
          strm.adler = arg1(arg6[4])(strm.adler, _window, avail_in, sum1);
        }
      ...
      if (lookahead.match_length <= lookahead.max_lazy_match) {
        if (lookahead.lookahead >= 3) {
          ...
          do {
            ...
            lookahead.head[lookahead.ins_h] = lookahead.strstart;
            let diff = lookahead.match_length - 1;
    ...
    if (lookahead.prev_length >= 3) {
      if (lookahead.match_length <= lookahead.prev_length) {
        ...
        do {
          ...
          let diff1 = lookahead.prev_length - 1;
...
function DeflateState() {
  ...
  this.good_match = 0;
  this.nice_match = 0;
  const buf16 = new arg1(arg6[1]).Buf16(1146);
  this.dyn_ltree = buf16;
  const buf161 = new arg1(arg6[1]).Buf16(122);
  this.dyn_dtree = buf161;
  const buf162 = new arg1(arg6[1]).Buf16(78);
  this.bl_tree = buf162;
  zero(this.dyn_ltree);
  zero(this.dyn_dtree);
  zero(this.bl_tree);
  ...
  this.d_desc = null;
  this.bl_desc = null;
  const buf163 = new arg1(arg6[1]).Buf16(16);
  this.bl_count = buf163;
  const buf164 = new arg1(arg6[1]).Buf16(573);
  this.heap = buf164;
  zero(this.heap);
  this.heap_len = 0;
  this.heap_max = 0;
  const buf165 = new arg1(arg6[1]).Buf16(573);
  this.depth = buf165;
  zero(this.depth);
  this.l_buf = 0;
  this.lit_bufsize = 0;
              ...
              if (42 === state.status) {
                if (2 === state.wrap) {
                  ...
                  if (state.gzhead) {
                    ...
                    if (state.gzhead.hcrc) {
                      state.adler = last_flush(arg6[4])(state.adler, state.pending_buf, state.pending, 0);
                    }
                    state.gzindex = 0;
                    state.status = 69;
                    const tmp22 = put_byte;
                    const tmp30 = state.gzhead.extra && state.gzhead.extra.length;
                  } else {
                    tmp12(state, 0);
                    tmp12(state, 0);
                    tmp12(state, 0);
                    ...
                    if (state.pending !== state.pending_buf_size) {
                      ...
                      while (state.gzindex < (65535 & state.gzhead.extra.length)) {
                        if (state.pending !== state.pending_buf_size) {
                          ...
                          if (tmp46) {
                            let tmp47 = last_flush;
                            let tmp48 = arg6;
                            let num44 = 4;
                            let tmp49 = tmp45;
                            state.adler = last_flush(arg6[4])(state.adler, state.pending_buf, state.pending - tmp45, tmp45);
                          }
                      ...
                      if (tmp36) {
                        state.adler = last_flush(arg6[4])(state.adler, state.pending_buf, state.pending - pending, pending);
                      }
                      flush_pending(state);
                      pending2 = state.pending;
                      const tmp36 = state.gzhead.hcrc && state.pending > pending;
                    }
                  }
                  if (tmp52) {
                    state.adler = last_flush(arg6[4])(state.adler, state.pending_buf, state.pending - pending2, pending2);
                  }
                  if (state.gzindex === state.gzhead.extra.length) {
                    state.gzindex = 0;
                    state.status = 73;
                  }
                  const tmp52 = state.gzhead.hcrc && state.pending > pending2;
                } else {
                  state.status = 73;
                }
              }
                ...
                if (state.gzhead.name) {
                  ...
                  while (true) {
                    ...
                    if (state.pending !== state.pending_buf_size) {
                      ...
                      if (tmp57) {
                        let tmp58 = last_flush;
                        let tmp59 = arg6;
                        let tmp60 = pending3;
                        state.adler = last_flush(arg6[4])(state.adler, state.pending_buf, state.pending - pending3, pending3);
                      }
                    ...
                    if (tmp66) {
                      let tmp67 = last_flush;
                      let tmp68 = arg6;
                      let tmp69 = pending4;
                      state.adler = last_flush(arg6[4])(state.adler, state.pending_buf, state.pending - pending4, pending4);
                    }
                    if (0 === num52) {
                      state.gzindex = 0;
                      let num54 = 91;
                ...
                if (state.gzhead.comment) {
                  ...
                  while (true) {
                    ...
                    if (state.pending !== state.pending_buf_size) {
                      ...
                      if (tmp71) {
                        let tmp72 = last_flush;
                        let tmp73 = arg6;
                        let tmp74 = pending5;
                        state.adler = last_flush(arg6[4])(state.adler, state.pending_buf, state.pending - pending5, pending5);
                      }
                    ...
                    if (tmp80) {
                      let tmp81 = last_flush;
                      let tmp82 = arg6;
                      let tmp83 = pending6;
                      state.adler = last_flush(arg6[4])(state.adler, state.pending_buf, state.pending - pending6, pending6);
                    }
                    if (0 === num60) {
                      let num62 = 103;
                      state.status = 103;
                ...
                if (3 !== funcResult) {
                  if (2 === funcResult) {
                    if (1 === last_flush) {
                      diff = last_flush;
                      diff = arg6;
                      diff = last_flush(arg6[2])._tr_align(state);
                      const obj6 = last_flush(arg6[2]);
                    } else if (5 !== last_flush) {
                      diff = last_flush;
                      diff = arg6;
                      const obj5 = last_flush(arg6[2]);
                      diff = obj5;
                      diff = state;
    ...
    if (strm.state) {
      ...
      if (2 !== wrap) {
        if (1 !== wrap) {
          if (!state.lookahead) {
            if (tmp24) {
              strm.adler = dictionary(arg6[3])(strm.adler, dictionary, length, 0);
            }
            state.wrap = 0;
            let tmp5 = dictionary;
            let w_size = length;
