...
// Dependencies: [5, 41, 42, 93, 95, 98, 16237, 16239, 16241]
...
class PQueue {
  constructor(arg0) {
    ...
    if (typeof merged.intervalCap !== "reType") {
      num = 1;
                  ...
                  if (0 === c4) {
                    if (arg0 === 1) {
                      ...
                      if (undefined !== lib._timeout) {
                        ...
                        lib(16237).default(resolved, timeout, () => {
