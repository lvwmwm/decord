...
// Function ID: 102240
// Name: state
// Dependencies: [13320, 13295, 13357, 13311, 13358, 13340, 13318, 13351]
...
if (!require("all")) {
  if (!require("__core-js_shared__").state) {
    ...
    let closure_6 = tmp;
    require("module_13340")[tmp] = true;
    function set(facade) {
      if (require(13318) /* call */(facade, closure_6)) {
        let _TypeError = require(13295) /* check */.TypeError;
        const prototype = _TypeError.prototype;
        _TypeError = new _TypeError("Object already initialized");
        throw _TypeError;
      } else {
        arg1.facade = facade;
        require(13351)(facade, closure_6, arg1);
        return arg1;
      }
    }
    let set2 = set;
    function get(arg0) {
      if (require(13318) /* call */(arg0, closure_6)) {
    ...
    let get2 = get;
    function has(arg0) {
      return require(13318) /* call */(arg0, closure_6);
    }
    let has2 = has;
  }
  let obj = {
