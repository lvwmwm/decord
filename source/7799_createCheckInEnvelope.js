...
// Dependencies: [7785, 7744, 7782]

// Module 7799 (createCheckInEnvelope)
const require = arg1;
...
arg5.createCheckInEnvelope = function createCheckInEnvelope(arg0, arg1, sdk) {
  ...
  if (tmp) {
    obj.dsn = require(7785) /* dsnFromString */.dsnToString(arg4);
    const obj4 = require(7785) /* dsnFromString */;
  }
  if (arg1) {
    obj.trace = require(7744) /* addNonEnumerableProperty */.dropUndefinedKeys(arg1);
    const obj5 = require(7744) /* addNonEnumerableProperty */;
  }
