...
// Function ID: 5014
// Name: parseTags
// Dependencies: [4972, 5014]

// Module 5013 (parseTags)
const require = arg1;
...
function parseTags(buffer) {
  ...
  if (buffer.byteLength !== buffer.getUint32()) {
    ...
    const keys = Object.keys(require(5014).iccProfile);
    for (let num = 0; num < keys.length; num = num + 1) {
      let tmp = keys[num];
      let tmp2 = require;
      let tmp3 = dependencyMap;
      let iter = require(5014).iccProfile[tmp];
      ...
      if (buffer.length < 132) {
        ...
        if (0 < uint32) {
          while (buffer.length >= num6 + c8) {
            ...
            let obj17 = require(4972) /* getDataView */;
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (stringFromDataView1 === mluc) {
                  ...
                  if (1 === uint324) {
                    ...
                    if (require(5014).iccTags[stringFromDataView]) {
...
arg5.default = {
  read(buffer, arr) {
    if (arg2) {
      if (arr[0].compressionMethod !== require(4972) /* getDataView */.COMPRESSION_METHOD_NONE) {
