...
// Dependencies: [4444, 4377, 518, 4424, 4428, 4441, 4431, 4432, 4433, 4434, 4445, 4446]

// Module 4443 (ValidateAndApplyPropertyDescriptor)

export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, arg2, __Configurable__) {
  __Set__ = arg4;
  let tmp = require(4444) /* Type */(arg0);
  if (undefined !== arg0) {
  ...
  if (require(4424) /* isPropertyKey */(arg1)) {
    if ("boolean" !== typeof arg2) {
      ...
      tmp = require;
      tmp = dependencyMap;
      if (require(4428) /* isPropertyDescriptor */(__Configurable__)) {
        if (undefined !== __Set__) {
          if (!require(4428) /* isPropertyDescriptor */(__Set__)) {
        ...
        if (undefined === __Set__) {
          ...
          if (!tmp) {
            ...
            if (!tmp) {
              ...
              tmp = require;
              tmp = dependencyMap;
              tmp = require(4441) /* IsAccessorDescriptor */(__Configurable__);
              tmp = require(4431) /* result */;
              tmp = require(4432) /* IsDataDescriptor */;
              tmp = require(4433) /* SameValue */;
              tmp = require(4434) /* FromPropertyDescriptor */;
              if (tmp) {
                tmp = arg0;
                tmp = arg1;
          ...
          tmp = dependencyMap;
          obj = {};
          tmp = require(4445) /* isFullyPopulatedPropertyDescriptor */;
          obj.IsAccessorDescriptor = require(4441) /* IsAccessorDescriptor */;
          let obj1 = 7;
          obj.IsDataDescriptor = require(4432) /* IsDataDescriptor */;
          if (tmp(obj, __Set__)) {
            if (!__Set__["[[Configurable]]"]) {
              ...
              if ("[[Enumerable]]" in __Configurable__) {
                if (!require(4433) /* SameValue */(__Configurable__["[[Enumerable]]"], __Set__["[[Enumerable]]"])) {
                  return false;
                }
              }
              if (!require(4446) /* IsGenericDescriptor */(__Configurable__)) {
                const tmp47 = require(4433) /* SameValue */;
                if (!tmp47(tmp48, require(4441) /* IsAccessorDescriptor */(__Set__))) {
                  return false;
                }
                tmp48 = require(4441) /* IsAccessorDescriptor */(__Configurable__);
              }
              if (require(4441) /* IsAccessorDescriptor */(__Set__)) {
                if ("[[Get]]" in __Configurable__) {
                  if (!require(4433) /* SameValue */(__Configurable__["[[Get]]"], __Set__["[[Get]]"])) {
                    return false;
                  }
                }
                if ("[[Set]]" in __Configurable__) {
                  if (!require(4433) /* SameValue */(__Configurable__["[[Set]]"], __Set__["[[Set]]"])) {
                    return false;
                  }
                }
                ...
                if ("[[Value]]" in __Configurable__) {
                  if (!require(4433) /* SameValue */(__Configurable__["[[Value]]"], __Set__["[[Value]]"])) {
                    return false;
                  }
                }
              }
            ...
            if ("Undefined" === tmp) {
              ...
              if (!require(dependencyMap[obj1])(__Set__)) {
                if (require(4441) /* IsAccessorDescriptor */(__Set__)) {
                  if (require(dependencyMap[obj1])(__Configurable__)) {
                    ...
                    const tmp82 = require(4433) /* SameValue */;
                    const tmp83 = require(4434) /* FromPropertyDescriptor */;
                    ...
                    let tmp68Result = require(4431) /* result */(tmp81, tmp82, tmp83, arg0, arg1, obj);
                    const tmp80 = require(4431) /* result */;
                  }
                  tmp = tmp68Result;
                }
                const tmp69 = require(dependencyMap[obj1]);
                const tmp68 = require(4431) /* result */;
                tmp68Result = tmp68(tmp69, require(4433) /* SameValue */, require(4434) /* FromPropertyDescriptor */, arg0, arg1, __Configurable__);
                const tmp70 = require(4433) /* SameValue */;
              }
              let tmp92 = __Set__;
              if ("[[Configurable]]" in __Configurable__) {
              ...
              const tmp98 = require(4433) /* SameValue */;
              const tmp99 = require(4434) /* FromPropertyDescriptor */;
              ...
              tmp = arg1;
              tmp = obj1;
              tmp68Result = require(4431) /* result */(tmp97, tmp98, tmp99, arg0, arg1, obj1);
              const tmp96 = require(4431) /* result */;
            }
          } else {
