...
// Dependencies: [57, 65, 12078, 12079, 12077, 12071]

// Module 12083 (convertBaseSchema)
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema($schema, defaultTarget) {
      if ("boolean" === typeof $schema) {
        ...
        if (null == registry) {
          registry = require(12071) /* registry */.globalRegistry;
        }
        obj.registry = registry;
        return convertSchema($schema, obj);
      }
    };
    const fnResult = fn(require("module_12078"));
    let _Object4 = Object;
    obj = { iso: fn(require("module_12079")) };
    let _Object5 = Object;
