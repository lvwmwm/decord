...
let closure_6 = [];
const items = [{}, { GameplayAbstractUI: "\u{1F4A0}", cwd: 6 }, { GameplayAbstractUI: "\u{1F4A0}", cwd: 6 }];
let closure_8 = [];
const items1 = [{}, { GameplayAbstractUI: "\u{1F4A0}", cwd: 6 }, { GameplayAbstractUI: "\u{1F4A0}", cwd: 6 }];
