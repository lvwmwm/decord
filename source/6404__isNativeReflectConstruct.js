...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 6405, 6383, 6399, 6406, 6408, 6381, 6410, 6409, 6411, 6412, 6382, 6396]
// Exports: default
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          if (someResult) {
            require(6409).ghQueueMicrotask(() => {
              self.update(1);
            });
            const obj = require(6409);
          }
          const props2 = self.props;
          const items = [];
          const obj2 = require(6408) /* transformIntoHandlerTags */;
          ...
          if (self.viewNode) {
            self.attachGestureHandler(importDefault(6412)(self.viewNode));
          } else {
            const _Error = Error;
