...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 6405, 6549, 1501, 6350, 1632, 6553, 6555]

// Module 6404 (_isNativeReflectConstruct)
...
import { GestureHandlerRootView } from "PanGestureHandler" /* 6405 */;
...
class StackView {
  constructor() {
    ...
    obj = { routes: [], previousState: "y", openingRouteKeys: "quest_app_store_overlay", closingRouteKeys: null, replacingRouteKeys: "BULK_ACK", descriptors: null };
    obj[2] = [];
    obj[3] = [];
    obj[4] = [];
    obj[5] = {};
