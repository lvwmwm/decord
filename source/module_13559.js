// Module ID: 13559
// Function ID: 13560
// Dependencies: [41, 42, 32, 13553, 13560, 13561]
...
obj = {
  value: function next() {
    ...
    let tmp7;
    let tmp8;
    const tmp3 = this[require(undefined, 13553) /* SymbolResult1 */.iterInternalSymbol];
    ({ kind, index } = tmp3);
    const arr = Array.from(tmp3.target[require(undefined, 13553) /* SymbolResult1 */.implSymbol]);
    if (index >= arr.length) {
      return { value: "HermesInternal", done: null };
    } else {
      tmp3.index = index + 1;
      [tmp7, tmp8] = _slicedToArray(arr[index].map(tmp(13553).tryWrapperForImpl), 2);
      if ("key" === kind) {
        let tmp4 = tmp7;
      } else if ("value" === kind) {
        tmp4 = tmp8;
...
obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, require(13553) /* SymbolResult1 */.implSymbol)) {
        if (arg0[tmp(undefined, 13553).implSymbol] instanceof tmp(13560).implementation) {
          return true;
        }
      }
  ...
  isImpl(arg0) {
    if (arg0) {
      if (arg0 instanceof require(13560) /* URLSearchParamsImpl */.implementation) {
        return true;
      } else {
        const _mixedIntoPredicates = module.exports._mixedIntoPredicates;
  ...
  createDefaultIterator(self, key) {
    ...
    Object.defineProperty(obj, require(13553) /* SymbolResult1 */.iterInternalSymbol, { value: obj, configurable: true });
    return obj;
  },
  create(arg0, arg1, arg2) {
    if (undefined === arg0[require(undefined, 13553) /* SymbolResult1 */.ctorRegistrySymbol]) {
      ...
      const _URLSearchParams = arg0[tmp(undefined, 13553).ctorRegistrySymbol].URLSearchParams;
  ...
  setup(wrapper) {
    ...
    const implementation = new require(13560) /* URLSearchParamsImpl */.implementation(arg1, items, obj);
    ...
    if (require(13560) /* URLSearchParamsImpl */.init) {
      tmp2(13560).init(wrapper[tmp2(undefined, 13553).implSymbol], obj);
      const tmp2Result = tmp2(13560);
    }
    return wrapper;
  },
  install(arg0) {
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(URLSearchParams(13561).USVString(arguments[0], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 1" }));
              const obj = URLSearchParams(13561);
              items.push(URLSearchParams(13561).USVString(arguments[1], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 2" }));
              const tmp12 = self[URLSearchParams(undefined, 13553).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13561).USVString(arguments[0], { context: "Failed to execute 'delete' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13553).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13561).USVString(arguments[0], { context: "Failed to execute 'get' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13553).implSymbol];
                const get = tmp6.get;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13561).USVString(arguments[0], { context: "Failed to execute 'getAll' on 'URLSearchParams': parameter 1" }));
                const obj = URLSearchParams(13561);
                const tmp11 = self[URLSearchParams(undefined, 13553).implSymbol];
                const getAll = tmp11.getAll;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return URLSearchParams(13553).tryWrapperForImpl(HermesBuiltin.apply(items1, tmp11));
              }
            }
          }
          const typeError1 = new TypeError("Illegal invocation");
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13561).USVString(arguments[0], { context: "Failed to execute 'has' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13553).implSymbol];
                const has = tmp6.has;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 2) {
                ...
                const items = [];
                items.push(URLSearchParams(13561).USVString(arguments[0], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 1" }));
                const obj = URLSearchParams(13561);
                items.push(URLSearchParams(13561).USVString(arguments[1], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 2" }));
                const tmp12 = self[URLSearchParams(undefined, 13553).implSymbol];
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return HermesBuiltin.apply(items1, tmp12);
      ...
      },
      {
        ...
        value: function sort() {
          ...
          if (this) {
            const _exports = closure_1.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 13553).implSymbol].sort();
            }
          }
      ...
      },
      {
        ...
        value: function toString() {
          ...
          if (this) {
            const _exports = closure_1.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 13553).implSymbol].toString();
            }
          }
          const typeError = new TypeError("Illegal invocation");
          throw typeError;
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const _Array2 = Array;
                let arr = Array.from(self[URLSearchParams(undefined, 13553).implSymbol]);
                let num2 = 0;
                let tmp11 = arr;
                if (0 < arr.length) {
                  do {
                    ...
                    let _Array = Array;
                    arr = Array.from(self[tmp3(undefined, 13553).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr;
    ...
    if (undefined === arg0[URLSearchParams(undefined, 13553).ctorRegistrySymbol]) {
      let _Object = Object;
    ...
    arg0[URLSearchParams(undefined, 13553).ctorRegistrySymbol].URLSearchParams = tmp;
