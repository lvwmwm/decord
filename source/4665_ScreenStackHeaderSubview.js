...
// Dependencies: [109, 19, 17, 21, 4666, 4662, 4667, 4668, 4663, 4669]
...
// Module 4665 (ScreenStackHeaderSubview)
...
const forwardRefResult = require("noop").forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4662).isHeaderBarButtonsAvailableForCurrentPlatform) {
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4662).isHeaderBarButtonsAvailableForCurrentPlatform;
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  obj[2] = importDefault(4663).experiment.synchronousHeaderSubviewUpdatesEnabled;
  obj = { resizeMode: "center", fadeDuration: 0 };
  const merged = Object.assign(arg0);
  obj[3] = <closure_7 resizeMode="center" fadeDuration={0} />;
  return jsx(importDefault(4669), { resizeMode: "center", fadeDuration: 0 });
};
export const ScreenStackHeaderRightView = (style) => {
  ...
  obj.type = "right";
  obj.synchronousShadowStateUpdatesEnabled = importDefault(4663).experiment.synchronousHeaderSubviewUpdatesEnabled;
  const items = [closure_9.headerSubview, style.style];
  obj.style = items;
  return jsx(importDefault(4669), {});
};
