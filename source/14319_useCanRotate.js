...
class TooltipNote {
  constructor() {
    obj = { variant: "text-sm/normal", style: { "Null": "<string:16777479>", "Null": "<string:36295491>" } };
    items = [null];
    items[1] = jsx(arg1(dependencyMap[9]).Text, { position: null, width: null });
