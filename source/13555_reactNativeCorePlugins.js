...
// Dependencies: [5, 17, 82, 13556, 13558, 13560, 13561, 13564, 13565, 13578, 13580, 13582, 13583, 13584, 13585, 13566]

// Module 13555 (reactNativeCorePlugins)
...
import module_13564 from "module_13564";
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL !== "string") {
        ...
        return require(13585) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
