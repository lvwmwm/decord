...
// Function ID: 32111
// Name: DataBindByName
// Dependencies: [7, 6, 3861, 3879, 3884, 3885, 3886, 3887, 3888, 3889, 3890, 3880, 3891, 3892, 3893, 3896, 3897, 3898, 3899, 3900, 3901, 3902, 3903, 3904, 3905]

// Module 3860 (DataBindByName)
import _fromURL from "_fromURL";

class DataBindByName {
  constructor(arg0) {
    tmp = c0(this, DataBindByName);
    this.byName = global;
    return;
  }
}

export const DataBindByName = require("RiveImages")(DataBindByName);
export const NitroRiveView = require("NitroRiveView").NitroRiveView;
export const RiveView = require("defaultOnError").RiveView;
export const Fit = require("module_3884").Fit;
export const Alignment = require("module_3885").Alignment;
...
export const RiveEventType = require("module_3890").RiveEventType;
export const RiveErrorType = require("module_3880").RiveErrorType;
...
export const useRiveColor = require("getColorProperty").useRiveColor;
...
export const useRiveFile = require("isUriInput").useRiveFile;
export const RiveRuntime = require("_initialize").RiveRuntime;
export const DataBindMode = require("module_3905").DataBindMode;
