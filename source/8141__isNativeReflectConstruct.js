...
// Module 8141 (_isNativeReflectConstruct)
let Platform;
...
obj.fullscreenOrientation = importDefault(dependencyMap[11]).oneOf([1384079616, -1106892152, 1615956321]);
...
let closure_17 = obj.requireNativeComponent("RNVVideo", tmp4, { nativeOnly: { <string:2931814753>: "Small", <string:2487528941>: "sm", <string:2974508456>: "Placeholder" } });
