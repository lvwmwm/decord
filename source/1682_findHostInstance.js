...
// Dependencies: [116, 1664]

// Module 1682 (findHostInstance)
const require = arg1;
    ...
    (function resolveFindHostInstance_DEPRECATED() {
      if (undefined === prop) {
        try {
          ...
          const reanimatedError = new callback(1664).ReanimatedError("Failed to resolve findHostInstance_DEPRECATED");
