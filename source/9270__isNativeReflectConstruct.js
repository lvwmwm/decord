...
// Dependencies: [41, 42, 93, 95, 98, 9264, 9265]
// Exports: Chi, Maj
...
let items = [
  {
    ...
    value: function update(B) {
      ...
      let view;
      const self = this;
      HashMD(9265).exists(this);
      ({ buffer, blockLen, view } = this);
      const toBytesResult = HashMD(9264).toBytes(B);
      let num = 0;
  ...
  },
  {
    ...
    value: function digestInto(content) {
      ...
      const self = this;
      HashMD(9265).exists(this);
      HashMD(9265).output(content, this);
      this.finished = true;
      ...
      self.process(view, 0);
      view = HashMD(9264).createView(content);
