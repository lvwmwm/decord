...
// Function ID: 13616
// Name: ResolveLocale
// Dependencies: [13616, 13621, 13622, 13617, 13623, 13624]
...
arg5.ResolveLocale = function ResolveLocale(arg0, arg1, localeMatcher) {
  ...
  if ("lookup" === localeMatcher.localeMatcher) {
    const _Array2 = Array;
    let LookupMatcherResult = require(13616) /* LookupMatcher */.LookupMatcher(Array.from(arg0), arg1, arg5);
    let tmp5 = require;
    let tmp7 = require;
  } else {
    const _Array = Array;
    tmp5 = require;
    tmp7 = require;
    LookupMatcherResult = require(13621) /* BestFitMatcher */.BestFitMatcher(Array.from(arg0), arg1, arg5);
  }
  ...
  if (0 < arg3.length) {
    do {
      ...
      let invariantResult = require(13617) /* isMatched */.invariant(isArray, "keyLocaleData for ".concat(str, " must be an array"));
      let first = items1[0];
      ...
      let invariantResult1 = require(13617) /* isMatched */.invariant(tmp19, "value must be a string or undefined");
