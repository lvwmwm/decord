...
result = result.fileFinishedImporting("modules/app_launcher/native/AppLauncherNativeConstants.tsx");

export const APP_LAUNCHER_BUILT_IN_SECTION_ICON = require("result");
...
export const DEFAULT_CONTENT_PADDING = require("result").space.PX_16;
export const SCREEN_BACKGROUND_COLOR = require("result").colors.MOBILE_KEYBOARD_PANEL_BACKGROUND;
export const FLASH_LIST_ITEM_IMPRESSION_VIEWABILITY_CONFIG = { left: null, right: null };
