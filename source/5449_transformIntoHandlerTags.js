...
// Dependencies: [17, 5430, 5429, 5450, 5435]
// Exports: filterConfig, findNodeHandle, scheduleFlushOperations

// Module 5449 (transformIntoHandlerTags)
import get_ActivityIndicator from "get ActivityIndicator";

let Platform;
let c3;
function transformIntoHandlerTags(arg0) {
  const obj = require(5430) /* toArray */;
  const mapped = require(5430) /* toArray */.toArray(arg0).map((current) => {
