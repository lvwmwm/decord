...
let c7 = 0;
const items3 = [["\\s", 1], , ];
const items4 = ["\\d", require("module_12885").MAX_LENGTH];
items3[1] = items4;
const items5 = ["[a-zA-Z0-9-]", require("module_12885").MAX_SAFE_BUILD_LENGTH];
items3[2] = items5;
function createToken(BUILD, arg1, arg2) {
  ...
  require(12886)(BUILD, +closure_7, arg1);
  obj[BUILD] = +closure_7;
...
const token22 = createToken("COERCEPLAIN", "(^|[^\\d])(\\d{1," + require("module_12885").MAX_SAFE_COMPONENT_LENGTH + "})(?:\\.(\\d{1," + require("module_12885").MAX_SAFE_COMPONENT_LENGTH + "}))?(?:\\.(\\d{1," + require("module_12885").MAX_SAFE_COMPONENT_LENGTH + "}))?");
