...
// Dependencies: [4478, 4411, 518, 4458, 4462, 4475, 4465, 4466, 4467, 4468, 4479, 4480]

// Module 4477 (ValidateAndApplyPropertyDescriptor)

export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, arg2, __Configurable__) {
  __Set__ = arg4;
  let tmp = require(4478) /* Type */(arg0);
  if (undefined !== arg0) {
  ...
  if (require(4458) /* isPropertyKey */(arg1)) {
    if ("boolean" !== typeof arg2) {
      ...
      tmp = require;
      tmp = dependencyMap;
      if (require(4462) /* isPropertyDescriptor */(__Configurable__)) {
        if (undefined !== __Set__) {
          if (!require(4462) /* isPropertyDescriptor */(__Set__)) {
        ...
        if (undefined === __Set__) {
          ...
          if (!tmp) {
            ...
            if (!tmp) {
              ...
              tmp = require;
              tmp = dependencyMap;
              tmp = require(4475) /* IsAccessorDescriptor */(__Configurable__);
              tmp = require(4465) /* result */;
              tmp = require(4466) /* IsDataDescriptor */;
              tmp = require(4467) /* SameValue */;
              tmp = require(4468) /* FromPropertyDescriptor */;
              if (tmp) {
                tmp = arg0;
                tmp = arg1;
          ...
          tmp = dependencyMap;
          obj = {};
          tmp = require(4479) /* isFullyPopulatedPropertyDescriptor */;
          obj.IsAccessorDescriptor = require(4475) /* IsAccessorDescriptor */;
          let obj1 = 7;
          obj.IsDataDescriptor = require(4466) /* IsDataDescriptor */;
          if (tmp(obj, __Set__)) {
            if (!__Set__["[[Configurable]]"]) {
              ...
              if ("[[Enumerable]]" in __Configurable__) {
                if (!require(4467) /* SameValue */(__Configurable__["[[Enumerable]]"], __Set__["[[Enumerable]]"])) {
                  return false;
                }
              }
              if (!require(4480) /* IsGenericDescriptor */(__Configurable__)) {
                const tmp47 = require(4467) /* SameValue */;
                if (!tmp47(tmp48, require(4475) /* IsAccessorDescriptor */(__Set__))) {
                  return false;
                }
                tmp48 = require(4475) /* IsAccessorDescriptor */(__Configurable__);
              }
              if (require(4475) /* IsAccessorDescriptor */(__Set__)) {
                if ("[[Get]]" in __Configurable__) {
                  if (!require(4467) /* SameValue */(__Configurable__["[[Get]]"], __Set__["[[Get]]"])) {
                    return false;
                  }
                }
                if ("[[Set]]" in __Configurable__) {
                  if (!require(4467) /* SameValue */(__Configurable__["[[Set]]"], __Set__["[[Set]]"])) {
                    return false;
                  }
                }
                ...
                if ("[[Value]]" in __Configurable__) {
                  if (!require(4467) /* SameValue */(__Configurable__["[[Value]]"], __Set__["[[Value]]"])) {
                    return false;
                  }
                }
              }
            ...
            if ("Undefined" === tmp) {
              ...
              if (!require(dependencyMap[obj1])(__Set__)) {
                if (require(4475) /* IsAccessorDescriptor */(__Set__)) {
                  if (require(dependencyMap[obj1])(__Configurable__)) {
                    ...
                    const tmp82 = require(4467) /* SameValue */;
                    const tmp83 = require(4468) /* FromPropertyDescriptor */;
                    ...
                    let tmp68Result = require(4465) /* result */(tmp81, tmp82, tmp83, arg0, arg1, obj);
                    const tmp80 = require(4465) /* result */;
                  }
                  tmp = tmp68Result;
                }
                const tmp69 = require(dependencyMap[obj1]);
                const tmp68 = require(4465) /* result */;
                tmp68Result = tmp68(tmp69, require(4467) /* SameValue */, require(4468) /* FromPropertyDescriptor */, arg0, arg1, __Configurable__);
                const tmp70 = require(4467) /* SameValue */;
              }
              let tmp92 = __Set__;
              if ("[[Configurable]]" in __Configurable__) {
              ...
              const tmp98 = require(4467) /* SameValue */;
              const tmp99 = require(4468) /* FromPropertyDescriptor */;
              ...
              tmp = arg1;
              tmp = obj1;
              tmp68Result = require(4465) /* result */(tmp97, tmp98, tmp99, arg0, arg1, obj1);
              const tmp96 = require(4465) /* result */;
            }
          } else {
