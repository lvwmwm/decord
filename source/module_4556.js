// Module ID: 4556
// Function ID: 4557
// Dependencies: [109, 19, 17, 21, 4557, 4548]
...
export default importDefaultResult.forwardRef(function SearchBar(autoCapitalize, ref) {
  ...
  if (ref(4548).isSearchBarAvailableForCurrentPlatform) {
    let obj = {};
    ...
    return jsx(importDefault(4557), { ref: null });
  } else {
