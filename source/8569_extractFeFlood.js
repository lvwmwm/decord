...
export default function extractFeFlood(arg0) {
  ...
  if (null == floodColor) {
    ...
    tmp = importDefault(8549)(floodColor);
  }
  obj = { floodColor: tmp };
  if (null != floodOpacity) {
    obj.floodOpacity = importDefault(8537)(floodOpacity);
  }
  return obj;
};
...
export const extractFeGaussianBlur = (stdDeviation) => {
  ...
  if (Array.isArray(stdDeviation.stdDeviation)) {
    ...
    if (typeof stdDeviation.stdDeviation !== "init") {
