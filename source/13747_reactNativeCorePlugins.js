...
// Dependencies: [5, 17, 82, 13748, 13750, 13752, 13753, 13756, 13757, 13770, 13772, 13774, 13775, 13776, 13777, 13758]

// Module 13747 (reactNativeCorePlugins)
...
import module_13756 from "module_13756";
import objectifyError from "objectifyError";
import onSend from "onSend";
import module_13772 from "module_13772";
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL !== "string") {
        ...
        return require(13777) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
