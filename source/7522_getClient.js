...
// Function ID: 7523
// Name: getClient
// Dependencies: [7513, 7514, 7496, 7516, 7501]

// Module 7522 (getClient)
const require = arg1;
...
arg5.getGlobalScope = function getGlobalScope() {
  return require(7496) /* getGlobalSingleton */.getGlobalSingleton("globalScope", () => {
...
arg5.getTraceContextFromScope = function getTraceContextFromScope(getPropagationContext) {
  ...
  return require(7501) /* addNonEnumerableProperty */.dropUndefinedKeys({ trace_id, span_id, parent_span_id });
};
arg5.withIsolationScope = function withIsolationScope() {
  ...
  const obj2 = require(7514) /* getAsyncContextStrategy */;
};
