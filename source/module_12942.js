// Module ID: 12942
// Function ID: 12943
// Dependencies: [12905, 12934, 12925, 12930, 12926, 12929, 12936, 12933]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(12905)(arg0, arg3);
  const tmp4 = new _require(12934)(arg1, arg3);
  if (">" === arg2) {
    let dependencyMap = tmp(12925);
    let tmpResult = tmp(12930);
    tmpResult = tmp(12926);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(12926);
      tmpResult = tmp(12929);
      tmpResult1 = tmp(12925);
  ...
  if (_require(12936)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
    if (0 < tmp4.set.length) {
      while (true) {
        ...
        let item = arr.forEach((semver) => {
          let tmp = semver;
          if (semver.semver === require(12933) /* Comparator */.ANY) {
            tmp = new require(12933) /* Comparator */(">=0.0.0");
          }
          let tmp6 = _null;
          if (!_null) {
            tmp6 = tmp;
