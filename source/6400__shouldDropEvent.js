...
// Dependencies: [6339, 6311, 6367, 6314]

// Module 6400 (_shouldDropEvent)
...
function _isSameStacktrace(arg0, arg1) {
  const framesFromEvent = require(6314) /* createStackParser */.getFramesFromEvent(arg0);
  const obj = require(6314) /* createStackParser */;
  const framesFromEvent1 = require(6314) /* createStackParser */.getFramesFromEvent(arg1);
  if (!framesFromEvent) {
    if (!framesFromEvent1) {
      return true;
    }
