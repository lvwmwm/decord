// Module ID: 5495
// Function ID: 5496
// Dependencies: [5, 4701, 673, 4133, 682, 706, 5490, 5492, 11, 1362, 1233, 1398, 527, 2]
...
export default {
  ...
  updateGuildAndChannelNotificationSettings(guildId, channel_overrides, OptedIn, location) {
    ...
    const currentGuildSettings = _require(5490).getCurrentGuildSettings(guildId);
    const obj2 = _require(5490);
    const manyCurrentChannelSettings = _require(5490).getManyCurrentChannelSettings(guildId, keys);
    const obj3 = _require(5490);
    ...
    const result1 = _require(5490).trackGuildNotificationSettingsUpdate(guildId, channel_overrides, currentGuildSettings, OptedIn, location);
    const obj7 = _require(5490);
