// Module ID: 5487
// Function ID: 5488
// Dependencies: [5, 4701, 676, 4133, 685, 709, 5482, 5484, 11, 1363, 1236, 1399, 530, 2]
...
export default {
  ...
  updateGuildAndChannelNotificationSettings(guildId, channel_overrides, OptedIn, location) {
    ...
    const currentGuildSettings = _require(5482).getCurrentGuildSettings(guildId);
    const obj2 = _require(5482);
    const manyCurrentChannelSettings = _require(5482).getManyCurrentChannelSettings(guildId, keys);
    const obj3 = _require(5482);
    ...
    const result1 = _require(5482).trackGuildNotificationSettingsUpdate(guildId, channel_overrides, currentGuildSettings, OptedIn, location);
    const obj7 = _require(5482);
