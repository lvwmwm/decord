...
export default {
  ...
  changeVanityURL(id, vanityURLCode) {
    ...
    return HTTP.patch(obj).then((body) => {
      ...
      obj = { "Null": 0., "Null": 0., "Null": 0., error: body.body };
      obj.dispatch(obj);
      return body;
    });
  },
