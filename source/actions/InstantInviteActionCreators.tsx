...
// Dependencies: [5, 7680, 6906, 1376, 1218, 1372, 1961, 1971, 1891, 7682, 4270, 3912, 3921, 4101, 1903, 676, 1221, 1379, 4349, 7117, 5114, 1384, 7695, 5765, 1234, 1222, 5111, 1988, 7696, 9078, 4381, 4464, 12581, 6903, 4771, 8335, 8260, 5220, 8872, 709, 9250, 4498, 12582, 5215, 698, 530, 4185, 687, 5109, 503, 1385, 4271, 5217, 5747, 3953, 12584, 12585, 10331, 4603, 4521, 12586, 12587, 513, 12589, 2]
// Exports: trackInviteEmbedActioned, trackInviteServerClicked, transitionToGuildFromEventInvite

// Module 7679 (generateAcceptInviteOptions)
...
export default {
  ...
  transitionToInvite(closure_0, arg1) {
    ...
    if (null != guild) {
      ...
      if (hasItem) {
        obj(12584).onOpenHubInvite(closure_0);
        const obj6 = obj(12584);
      }
    }
    ...
    if (null != guild) {
      if (!hasFlagResult) {
        if (closure_0.new_member) {
          tmp6Result = tmp6(12585);
          if (tmp6Result.inviteGuildHasPendingMemberDisabledVerification(guild)) {
            const result1 = tmp6(12585).openVerificationModalOrTransitionToApplication(guild.id);
            const tmp6Result1 = tmp6(12585);
          }
        }
      }
    }
  ...
  openNativeAppModal(inviteKey) {
    ...
    importDefault(10331).openNativeAppModal(result.baseCode, constants.INVITE_BROWSER, obj);
  },
  ...
  openApp(code, arg1, fingerprint, username) {
    ...
    if (null != baseCode) {
      let inviteDynamicLinkTemplate = _require(12586).getInviteDynamicLinkTemplate(baseCode);
      let tmp20 = _require;
      const obj5 = _require(12586);
    } else {
      inviteDynamicLinkTemplate = _require(12586).getDefaultDynamicLinkTemplate();
      tmp20 = _require;
      const obj4 = _require(12586);
    }
    let tmp20Result = tmp20(12587);
    ...
    combined = importDefault(12587)(inviteDynamicLinkTemplate, obj1);
    const tmp7Result1 = importDefault(12587);
