...
// Dependencies: [5, 7652, 6879, 1376, 1218, 1372, 1932, 1942, 1862, 7654, 4240, 3883, 3892, 4072, 1874, 676, 1221, 1379, 4319, 7090, 5084, 1384, 7667, 5738, 1234, 1222, 5081, 1959, 7668, 9049, 4351, 4434, 12544, 6876, 4741, 8195, 8120, 5190, 8843, 709, 9221, 4468, 12545, 5185, 698, 530, 4155, 687, 5079, 503, 1385, 4241, 5187, 5720, 3924, 12547, 12548, 10300, 4573, 4491, 12549, 12550, 513, 12552, 2]
// Exports: trackInviteEmbedActioned, trackInviteServerClicked, transitionToGuildFromEventInvite

// Module 7651 (generateAcceptInviteOptions)
...
function generateAcceptInviteOptions(target_type) {
  ...
  obj.isGuestInvite = require(1384) /* hasFlag */.hasFlag(num, require(7667) /* set */.GuildInviteFlags.IS_GUEST_INVITE);
  const obj2 = require(1384) /* hasFlag */;
  let num2 = target_type.flags;
  if (num2 == null) {
    num2 = 0;
  }
  obj.isApplicationBypassInvite = require(1384) /* hasFlag */.hasFlag(num2, require(7667) /* set */.GuildInviteFlags.IS_APPLICATION_BYPASS);
...
export default {
  resolveInvite(arg0, arg1, arg2) {
    ...
    if (obj.isDispatching()) {
      ...
      nextPromise = tmp(9221)(arg0, arg1, arg2).then((arg0) => {
        let code;
        let invite;
        ({ invite, code } = arg0);
        if (null != invite) {
      ...
      const promise = tmp(9221)(arg0, arg1, arg2);
    }
    return nextPromise;
  },
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            obj5[1] = body;
            obj4.dispatch(obj5);
            const tmp30 = new outer1_1(4155)(closure_1);
            throw tmp30;
          } else if (arg0 === 1) {
            c5 = 3;
            throw arg1;
  ...
  transitionToInvite(closure_0, arg1) {
    ...
    if (null != guild) {
      ...
      if (hasItem) {
        obj(12547).onOpenHubInvite(closure_0);
        const obj6 = obj(12547);
      }
    }
    ...
    let hasFlagResult = id(1384).hasFlag(num, id(7667).GuildInviteFlags.IS_GUEST_INVITE);
    if (!hasFlagResult) {
      let tmp6Result = tmp6(1384);
      hasFlagResult = tmp6Result.hasFlag(num, tmp6(7667).GuildInviteFlags.IS_APPLICATION_BYPASS);
    }
    if (null != guild) {
      if (!hasFlagResult) {
        if (closure_0.new_member) {
          tmp6Result = tmp6(12548);
          if (tmp6Result.inviteGuildHasPendingMemberDisabledVerification(guild)) {
            const result1 = tmp6(12548).openVerificationModalOrTransitionToApplication(guild.id);
            const tmp6Result1 = tmp6(12548);
          }
        }
      }
    }
  ...
  openNativeAppModal(inviteKey) {
    ...
    importDefault(10300).openNativeAppModal(result.baseCode, constants.INVITE_BROWSER, obj);
  },
  transitionToInviteOnboarding(baseCode, closure_1) {
    ...
    obj[3] = id;
    const inviteKeyFromExtraData = require(4241) /* readSnowflake */.generateInviteKeyFromExtraData(obj);
    obj = { search: null };
    const result = closure_26.APP_WITH_INVITE_AND_GUILD_ONBOARDING(baseCode.code);
    const obj2 = require(4241) /* readSnowflake */;
    const tmp3 = require;
    obj[0] = require(4241) /* readSnowflake */.getInviteKeySearchSuffix(inviteKeyFromExtraData);
  ...
  openApp(code, arg1, fingerprint, username) {
    ...
    obj1.dispatch(obj);
    if (null != importDefault(4573).ua) {
      const formatted = tmp7(4573).ua.toLowerCase();
    ...
    const os = tmp7(4573).os;
    let family;
    if (os != null) {
      family = os.family;
    }
    if ("Android" !== family) {
      const os2 = tmp7(4573).os;
      let family1;
      if (os2 != null) {
        family1 = os2.family;
      }
      if ("iOS" !== family1) {
        if (!_require(4491).isTablet) {
          let tmp13 = arg1;
          if (arg1 == null) {
    ...
    if (null != baseCode) {
      let inviteDynamicLinkTemplate = _require(12549).getInviteDynamicLinkTemplate(baseCode);
      let tmp20 = _require;
      const obj5 = _require(12549);
    } else {
      inviteDynamicLinkTemplate = _require(12549).getDefaultDynamicLinkTemplate();
      tmp20 = _require;
      const obj4 = _require(12549);
    }
    let tmp20Result = tmp20(12550);
    ...
    combined = importDefault(12550)(inviteDynamicLinkTemplate, obj1);
    const tmp7Result1 = importDefault(12550);
