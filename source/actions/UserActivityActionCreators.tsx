...
// Function ID: 84667
// Name: _getMetadata
// Dependencies: [5, 4252, 653, 686, 10917, 507, 2]
// Exports: getMetadata, play, sync

// Module 10920 (_getMetadata)
...
export const play = function play(closure_0, closure_1) {
  ...
  const spotifyMetadataFromActivity = _require(10917).getSpotifyMetadataFromActivity(closure_0, closure_1);
  let obj = _require(10917);
