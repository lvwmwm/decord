...
// Function ID: 84546
// Name: _getMetadata
// Dependencies: [5, 4218, 653, 686, 10879, 507, 2]
// Exports: getMetadata, play, sync

// Module 10882 (_getMetadata)
...
export const play = function play(closure_0, closure_1) {
  ...
  const spotifyMetadataFromActivity = _require(10879).getSpotifyMetadataFromActivity(closure_0, closure_1);
  let obj = _require(10879);
