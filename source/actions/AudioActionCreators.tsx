...
// Dependencies: [5, 4415, 1391, 4393, 4416, 1979, 1922, 676, 9206, 4406, 3, 698, 636, 709, 9207, 9209, 9210, 9218, 2]

// Module 9205 (trackDeviceChanged)
...
obj = {
  ...
  setSpatialAudio(enabled) {
    ...
    importDefault(9209)("spatial_audio_enabled", enabled, audioMixerSettings.enabled, arg1);
    let obj = importDefault(709);
  ...
  setActiveInputProfile(inputProfile) {
    ...
    importDefault(9209)("active_input_profile", inputProfile, activeInputProfile, obj.analyticsLocations);
    const tmp = importDefault;
    const tmp3 = importDefault(9209);
  ...
  setSidechainCompression(enabled) {
    ...
    importDefault(9209)("stream_attenuation_enabled", enabled, store2.getSidechainCompression(), obj.analyticsLocations);
    const tmp = importDefault(9209);
  ...
  setSidechainCompressionStrength(strength) {
    ...
    importDefault(9209)("stream_attenuation_strength", strength, store2.getSidechainCompressionStrength(), obj.analyticsLocations);
    const tmp = importDefault(9209);
  ...
  setAttenuation(attenuation, attenuateWhileSpeakingSelf, attenuateWhileSpeakingOthers) {
    ...
    if (attenuation !== attenuation) {
      importDefault(9209)("global_attenuation_strength", attenuation, attenuation);
    } else if (attenuateWhileSpeakingSelf !== attenuateWhileSpeakingSelf) {
      importDefault(9209)("global_attenuation_for_self_speak_enabled", attenuateWhileSpeakingSelf, attenuateWhileSpeakingSelf);
    } else if (attenuateWhileSpeakingOthers !== attenuateWhileSpeakingOthers) {
      importDefault(9209)("global_attenuation_for_other_speak_enabled", attenuateWhileSpeakingOthers, attenuateWhileSpeakingOthers);
    }
    let obj = importDefault(709);
  ...
  setQoS(enabled) {
    ...
    importDefault(9209)("quality_of_service_packets_enabled", enabled, store2.getQoS());
    let obj = importDefault(709);
  ...
  setSilenceWarning(enabled) {
    ...
    importDefault(9209)("silence_warning_enabled", enabled, store2.getEnableSilenceWarning());
    let obj = importDefault(709);
  ...
  setVideoHook(enabled) {
    ...
    importDefault(9209)("video_hook_enabled", enabled, store2.getVideoHook());
    let obj = importDefault(709);
  ...
  setExperimentalSoundshare(enabled) {
    ...
    importDefault(9209)("experimental_soundshare_enabled", enabled, store2.getExperimentalSoundshare());
    let obj = importDefault(709);
  ...
  setUseSystemScreensharePicker(enabled) {
    ...
    importDefault(9209)("system_screenshare_picker_enabled", enabled, store2.getUseSystemScreensharePicker());
    let obj = importDefault(709);
  ...
  setVideoEnabled(enabled) {
    let obj = require(9210) /* _getFilterBlob */;
  ...
  setAecDump(enabled) {
    ...
    importDefault(9209)("diagnostic_audio_recording_enabled", enabled, store2.getAecDump());
    let obj = importDefault(709);
