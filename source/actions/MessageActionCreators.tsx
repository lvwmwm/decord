...
// Function ID: 7428
// Name: trackInvite
// Dependencies: [32, 5, 4495, 7428, 7429, 7430, 7432, 7434, 5013, 6769, 4652, 1218, 1391, 7435, 1910, 4359, 4994, 4021, 4559, 4772, 7440, 1922, 676, 7442, 7289, 4663, 17, 3, 4358, 7443, 4363, 7445, 7446, 5042, 7451, 6721, 7470, 698, 4360, 4369, 7487, 4381, 7488, 1236, 1993, 4830, 709, 7500, 4486, 7501, 5001, 530, 4803, 5389, 9, 5082, 4996, 11, 1955, 1974, 5068, 4999, 7502, 7503, 7506, 7507, 4039, 7437, 1403, 7232, 7508, 7577, 5040, 7581, 7587, 7588, 7607, 687, 7608, 1954, 7512, 1363, 7609, 4827, 2]
...
function trackInvite(channelId) {
  ...
  if (null != channel) {
    ...
    importDefault(5042).trackWithMetadata(constants.INVITE_SENT, obj);
    const obj13 = importDefault(5042);
  } else {
    ...
    if (tmp12) {
      ...
      importDefault(5042).trackWithMetadata(constants.INVITE_SENT, obj2);
      const obj8 = importDefault(5042);
    }
  }
}
...
let closure_54 = {
  ...
  [AbortCodes.TOTAL_ATTACHMENT_SIZE_TOO_LARGE]: {
    ...
    messageGetter() {
      ...
      obj[0] = require(4830) /* items */.MAX_TOTAL_ATTACHMENT_SIZE_MB;
...
let obj14 = {
  ...
  sendBotMessage(id, intl, messageName, nonce) {
    ...
    obj14.receiveMessage(id, require(7500) /* createMessage */.createBotMessage(obj));
  },
  sendNitroSystemMessage(channelId, content, nonce) {
    ...
    obj = {};
    const merged = Object.assign(importDefault(7500)(obj));
  ...
  sendExplicitMediaClydeError(c0, attachments, EXPLICIT_MEDIA_ADD_MEDIA_TO_FORUM_POST_BLOCKED) {
    ...
    if (null != channel) {
      ...
      const match = require(4486) /* t */.match(obj);
      ...
      const nonce = require(7501) /* snowflakeSequence */.createNonce();
      obj14.sendBotMessage(c0, message, messageName, nonce);
      const obj8 = require(7501) /* snowflakeSequence */;
      obj = { action: null, messageId: null, channelId: null, context: null };
      obj[0] = require(5001) /* redactionSettingToRenderedString */.TrackMediaRedactionActionType.EXPLICIT_MEDIA_FALSE_POSITIVE_CLYDE_MESSAGE_SENT;
      obj[1] = nonce;
      obj[2] = c0;
      obj[3] = EXPLICIT_MEDIA_ADD_MEDIA_TO_FORUM_POST_BLOCKED;
      const result = require(5001) /* redactionSettingToRenderedString */.trackMediaRedactionAction(obj);
      ...
      const obj9 = require(5001) /* redactionSettingToRenderedString */;
    }
  },
  ...
  dismissAutomatedMessage(loggingName) {
    ...
    const result = require(7609) /* fetchAndReconcileGiftIntentDismissals */.logGiftIntentMessageDismissed(loggingName.channel_id, loggingName.id);
