...
// Function ID: 6858
// Name: trackInvite
// Dependencies: [32, 5, 4992, 6858, 6859, 6860, 7078, 7080, 6994, 5218, 4321, 1218, 1372, 7081, 1891, 4287, 4519, 3929, 4388, 4314, 7086, 1903, 676, 7088, 5881, 4295, 17, 3, 4286, 7089, 4291, 7092, 7093, 4496, 7098, 5165, 7117, 698, 4288, 7135, 7138, 4536, 7140, 1236, 1974, 4850, 709, 7152, 4501, 7153, 6999, 530, 4521, 5783, 9, 6887, 4987, 11, 1936, 1955, 6876, 4990, 7154, 7155, 7158, 7159, 3947, 7083, 1384, 5827, 7160, 7229, 7233, 7236, 7242, 7243, 7262, 687, 7263, 1935, 7164, 4147, 7264, 4640, 2]

// Module 6857 (trackInvite)
...
function trackInvite(channelId) {
  ...
  if (null != channel) {
    ...
    importDefault(4496).trackWithMetadata(constants.INVITE_SENT, obj);
    const obj13 = importDefault(4496);
  } else {
    ...
    if (tmp12) {
      ...
      importDefault(4496).trackWithMetadata(constants.INVITE_SENT, obj2);
      const obj8 = importDefault(4496);
    }
  }
}
...
obj = {
  ...
  messageGetter() {
    ...
    obj[0] = importDefault(1974).getArticleURL(constants7.DM_COULD_NOT_BE_DELIVERED);
...
let closure_54 = {
  ...
  [AbortCodes.TOTAL_ATTACHMENT_SIZE_TOO_LARGE]: {
    ...
    messageGetter() {
      ...
      obj[0] = require(4850) /* items */.MAX_TOTAL_ATTACHMENT_SIZE_MB;
...
let obj14 = {
  ...
  sendBotMessage(id, intl, messageName, nonce) {
    ...
    obj14.receiveMessage(id, require(7152) /* createMessage */.createBotMessage(obj));
  },
  sendNitroSystemMessage(channelId, content, nonce) {
    ...
    obj = {};
    const merged = Object.assign(importDefault(7152)(obj));
  ...
  sendExplicitMediaClydeError(c0, attachments, EXPLICIT_MEDIA_ADD_MEDIA_TO_FORUM_POST_BLOCKED) {
    ...
    if (null != channel) {
      ...
      const match = require(4501) /* t */.match(obj);
      ...
      const nonce = require(7153) /* snowflakeSequence */.createNonce();
      obj14.sendBotMessage(c0, message, messageName, nonce);
      const obj8 = require(7153) /* snowflakeSequence */;
      obj = { action: null, messageId: null, channelId: null, context: null };
      obj[0] = require(6999) /* redactionSettingToRenderedString */.TrackMediaRedactionActionType.EXPLICIT_MEDIA_FALSE_POSITIVE_CLYDE_MESSAGE_SENT;
      obj[1] = nonce;
      obj[2] = c0;
      obj[3] = EXPLICIT_MEDIA_ADD_MEDIA_TO_FORUM_POST_BLOCKED;
      const result = require(6999) /* redactionSettingToRenderedString */.trackMediaRedactionAction(obj);
      ...
      const obj9 = require(6999) /* redactionSettingToRenderedString */;
    }
  },
  ...
  dismissAutomatedMessage(loggingName) {
    ...
    const result = require(7264) /* fetchAndReconcileGiftIntentDismissals */.logGiftIntentMessageDismissed(loggingName.channel_id, loggingName.id);
