// Module ID: 4395
// Function ID: 4396
// Dependencies: [676, 4396, 4040, 4397, 709, 4041, 4398, 2]
...
export default {
  push(modal, props) {
    ...
    obj = { key: tmp, modal: importDefault(4397)(modal, {}, props, tmp) };
  ...
  popAboveKey(voiceChannelKey) {
    return require(4040) /* navigationToRootTabHelper */.popModalsAboveKey(voiceChannelKey);
  },
  popAll() {
    require(4040) /* navigationToRootTabHelper */.popAllModals();
    const obj = require(4040) /* navigationToRootTabHelper */;
