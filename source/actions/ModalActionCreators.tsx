// Module ID: 4490
// Function ID: 4491
// Dependencies: [676, 4491, 4135, 4492, 709, 4136, 4493, 2]
...
export default {
  push(modal, props) {
    ...
    obj = { modal: importDefault(4492)(modal, {}, props, tmp) };
  ...
  popAboveKey(voiceChannelKey) {
    return require(4135) /* navigationToRootTabHelper */.popModalsAboveKey(voiceChannelKey);
  },
  popAll() {
    require(4135) /* navigationToRootTabHelper */.popAllModals();
    const obj = require(4135) /* navigationToRootTabHelper */;
