// Module ID: 4399
// Function ID: 4400
// Dependencies: [676, 4400, 4044, 4401, 709, 4045, 4402, 2]
...
export default {
  push(modal, props) {
    ...
    obj = { key: tmp, modal: importDefault(4401)(modal, {}, props, tmp) };
  ...
  popAboveKey(voiceChannelKey) {
    return require(4044) /* navigationToRootTabHelper */.popModalsAboveKey(voiceChannelKey);
  },
  popAll() {
    require(4044) /* navigationToRootTabHelper */.popAllModals();
    const obj = require(4044) /* navigationToRootTabHelper */;
