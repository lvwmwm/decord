...
// Function ID: 4524
// Name: watchStream
// Dependencies: [5, 4358, 4524, 4525, 4363, 1218, 1391, 1910, 1979, 4360, 676, 4408, 709, 4407, 38, 4526, 4537, 4548, 530, 687, 5167, 503, 9214, 5169, 4354, 9288, 2]
...
function watchStream(stream, forceMultiple) {
  if (null == remoteSessionId.getRemoteSessionId()) {
    ...
    if (null == stream.guildId) {
      const encodeStreamKeyResult = require(4407) /* isStreamKey */.encodeStreamKey(stream);
      ...
      const obj2 = require(4407) /* isStreamKey */;
      ...
      if (!tmp21) {
        const participant = tmp18(4537).selectParticipant(stream.channelId, encodeStreamKeyResult);
        const tmp18Result = tmp18(4537);
      }
      ...
      if (!isInChannelResult) {
        obj = require(4526) /* allowChannelAccess */;
...
export const watchStreamAndTransitionToStream = function watchStreamAndTransitionToStream(stream, forceMultiple) {
  ...
  if (null == stream.guildId) {
    ...
    let isChannelFullResult = !isInChannelResult;
    if (!isInChannelResult) {
      isChannelFullResult = require(4526) /* allowChannelAccess */.isChannelFull(channel, tmp6, createGuildRecordFromRust);
...
export const updateStreamSettings = function updateStreamSettings(noTrack) {
  if (true !== noTrack.noTrack) {
    let obj = require(9214) /* isPremiumResolution */;
...
export const stopOwnStream = function stopOwnStream(arg0) {
  ...
  if (null != currentUserActiveStream) {
    const encodeStreamKeyResult = require(4407) /* isStreamKey */.encodeStreamKey(currentUserActiveStream);
    if (flag === undefined) {
      flag = true;
    }
    if (flag === undefined) {
    ...
    obj[2] = flag;
    obj.dispatch(obj);
    const obj5 = require(4407) /* isStreamKey */;
...
export const joinPrivateChannelAndWatchStream = function joinPrivateChannelAndWatchStream(arg0, streamKey) {
  const _require = arg0;
  id = id.getId();
  const importDefault = _require(4407).decodeStreamKey(streamKey);
  ...
  importDefault(4354).addRecipient(arg0, id, undefined, () => {
