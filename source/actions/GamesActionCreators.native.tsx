...
// Dependencies: [5, 676, 4328, 10598, 691, 5930, 4017, 709, 530, 10600, 10601, 10654, 2]

// Module 11169 (fetchJoinSecret)
...
export default {
  ...
  joinWithSecret(str) {
    ...
    importDefault(4017).openURL(combined, constants2.SAFARI);
  }
};
