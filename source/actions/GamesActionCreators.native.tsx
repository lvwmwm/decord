...
// Dependencies: [5, 676, 4370, 10567, 691, 5971, 4058, 709, 530, 10569, 10570, 10623, 2]

// Module 11214 (fetchJoinSecret)
...
export default {
  ...
  joinWithSecret(str) {
    ...
    importDefault(4058).openURL(combined, constants2.SAFARI);
  }
};
