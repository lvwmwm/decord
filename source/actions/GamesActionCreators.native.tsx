...
// Dependencies: [5, 676, 4310, 10510, 691, 5849, 3981, 709, 530, 10512, 10513, 10585, 2]

// Module 11082 (fetchJoinSecret)
...
export default {
  ...
  joinWithSecret(str) {
    ...
    importDefault(3981).openURL(combined, constants2.SAFARI);
  }
};
