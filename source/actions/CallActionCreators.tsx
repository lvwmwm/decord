// Module ID: 9161
// Function ID: 9162
// Dependencies: [1372, 3921, 1903, 676, 5111, 530, 698, 4623, 1236, 9162, 9157, 709, 2]
...
export default {
    ...
    if (null != arg3) {
      if (!blocked.isBlocked(arg3)) {
        ...
        value.then((body) => {
          ...
          const voiceChannel = id(5111).selectVoiceChannel(id, dependencyMap);
          if (ringable) {
            self.ring(tmp2);
          }
          if (callback != null) {
  ...
  ring(channelId, items, gdm_invite) {
    ...
    if (null != channel) {
      let obj = require(9157) /* useCanRingToGuildVoiceChannel */;
