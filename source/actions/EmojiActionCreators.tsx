...
// Function ID: 9412
// Name: _updateEmoji
// Dependencies: [5, 5048, 4865, 4527, 676, 685, 1355, 1337, 709, 530, 7946, 4035, 1236, 4089, 3830, 1351, 5055, 12, 4528, 2]
// Exports: deleteEmoji, favoriteEmoji, fetchEmoji, setDiversityColor, unfavoriteEmoji, updateEmoji, uploadEmoji

// Module 9411 (_updateEmoji)
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            c4 = 0;
            c4 = c3;
            const tmp18 = new callback2(4089)(c4);
            throw tmp18;
          } else if (arg0 === 1) {
            c6 = 3;
            throw arg1;
...
export const uploadEmoji = function uploadEmoji(guildId) {
  ...
  obj[2] = importDefault(7946).buildHeadersForMd5(originalMd5);
  let page;
  if (analyticsLocation != null) {
    page = analyticsLocation.page;
  }
  obj[3] = { client_event_source: page };
  const obj3 = importDefault(7946);
  const tmp3 = guildId;
...
export const favoriteEmoji = function favoriteEmoji(customEmojiFromJoinedGuild) {
  ...
  if (null != customEmojiFromJoinedGuild) {
    ...
    if (name == null) {
      const result = importDefault(3830).convertSurrogateToBase(customEmojiFromJoinedGuild.surrogates);
      name = undefined;
      if (result != null) {
        name = result.name;
      }
