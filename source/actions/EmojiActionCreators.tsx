...
// Function ID: 8635
// Name: _updateEmoji
// Dependencies: [5, 5128, 4945, 4592, 676, 685, 1355, 1337, 709, 530, 8055, 4101, 1236, 4155, 3896, 1351, 5135, 12, 4593, 2]
// Exports: deleteEmoji, favoriteEmoji, fetchEmoji, setDiversityColor, unfavoriteEmoji, updateEmoji, uploadEmoji

// Module 8634 (_updateEmoji)
...
export const uploadEmoji = function uploadEmoji(guildId) {
  ...
  obj[2] = importDefault(8055).buildHeadersForMd5(originalMd5);
  let page;
  if (analyticsLocation != null) {
    page = analyticsLocation.page;
  }
  obj[3] = { client_event_source: page };
  const obj3 = importDefault(8055);
  const tmp3 = guildId;
