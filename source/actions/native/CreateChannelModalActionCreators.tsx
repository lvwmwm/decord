// Module ID: 8996
// Function ID: 8997
// Dependencies: [1376, 1372, 4311, 4509, 8992, 1988, 2]
...
export default {
  ...
  open(arg0, arg1, arg2, arg3) {
    ...
    if (null != arg1) {
      ...
      obj2.pushLazy(self(1988)(8992, dependencyMap.paths), obj, CREATE_CHANNEL_MODAL_KEY);
      const tmp2 = arg2;
      const tmp3 = arg3;
      const tmp9 = self(1988)(8992, dependencyMap.paths);
    }
  },
  close() {
