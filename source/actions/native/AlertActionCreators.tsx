// Module ID: 4706
// Function ID: 4707
// Dependencies: [19, 21, 4310, 709, 4707, 1236, 1367, 4710, 4795, 4795, 2007, 2]
...
export default {
  ...
  close() {
    if (null != c6) {
      c6 = null;
      require(4707) /* useAlertStore */.dismissAlert(tmp);
      const obj = require(4707) /* useAlertStore */;
    }
  ...
  show(hideActionSheet) {
    ...
    if (obj.isMobileVisualRefreshEnabled("AlertActionCreators")) {
      ...
      if (!tmp11) {
        ...
        const tmp27 = c5;
        const tmp28 = c4;
        obj1[0] = tmp4(4795).getAlertButtonVariant(confirmColor);
        obj1[1] = confirmText;
        ...
        const items = [callback(tmp4(4710).AlertActionButton, obj1), ];
        ...
        if (null != cancelText) {
          ...
          tmp26Result = tmp26(tmp4(4710).AlertActionButton, obj2);
        }
        ...
        tmp4Result.openAlert(text, callback(tmp4(4710).AlertModal, obj), () => {
          if (!c5) {
            if (c4 != null) {
              tmp();
            }
        ...
        const tmp4Result1 = tmp4(4795);
      }
    }
    if (null != c6) {
      tmp4(4707).dismissAlert(c6);
      c6 = null;
      const tmp4Result2 = tmp4(4707);
    }
    this.openLazy({
      importer() {
