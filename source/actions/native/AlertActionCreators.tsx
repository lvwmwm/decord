// Module ID: 4684
// Function ID: 4685
// Dependencies: [19, 21, 4310, 709, 4685, 1236, 1367, 4688, 4773, 4773, 2007, 2]
...
export default {
  ...
  close() {
    if (null != c6) {
      c6 = null;
      require(4685) /* useAlertStore */.dismissAlert(tmp);
      const obj = require(4685) /* useAlertStore */;
    }
  ...
  show(hideActionSheet) {
    ...
    if (obj.isMobileVisualRefreshEnabled("AlertActionCreators")) {
      ...
      if (!tmp11) {
        if (flag) {
          let obj4 = merged(4310);
          obj4.hideActionSheet();
        }
        if (null != c6) {
          let tmp4Result = tmp4(4685);
        ...
        const tmp27 = c5;
        const tmp28 = c4;
        obj1[0] = tmp4(4773).getAlertButtonVariant(confirmColor);
        obj1[1] = confirmText;
        ...
        const items = [callback(tmp4(4688).AlertActionButton, obj1), ];
        ...
        if (null != cancelText) {
          ...
          tmp26Result = tmp26(tmp4(4688).AlertActionButton, obj2);
        }
        ...
        tmp4Result.openAlert(text, callback(tmp4(4688).AlertModal, obj), () => {
          if (!c5) {
            if (c4 != null) {
              tmp();
            }
        ...
        const tmp4Result1 = tmp4(4773);
      }
    }
    if (null != c6) {
      tmp4(4685).dismissAlert(c6);
      c6 = null;
      const tmp4Result2 = tmp4(4685);
    }
    this.openLazy({
      importer() {
