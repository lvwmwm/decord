// Module ID: 4594
// Function ID: 4595
// Dependencies: [19, 21, 4223, 709, 4595, 1236, 1348, 4598, 4683, 4683, 1959, 2]
...
export default {
  ...
  close() {
    if (null != c6) {
      c6 = null;
      require(4595) /* useAlertStore */.dismissAlert(tmp);
      const obj = require(4595) /* useAlertStore */;
    }
  ...
  show(hideActionSheet) {
    ...
    if (obj.isMobileVisualRefreshEnabled("AlertActionCreators")) {
      ...
      if (!tmp11) {
        ...
        const tmp27 = c5;
        const tmp28 = c4;
        obj1[0] = tmp4(4683).getAlertButtonVariant(confirmColor);
        obj1[1] = confirmText;
        ...
        const items = [callback(tmp4(4598).AlertActionButton, obj1), ];
        ...
        if (null != cancelText) {
          ...
          tmp26Result = tmp26(tmp4(4598).AlertActionButton, obj2);
        }
        ...
        tmp4Result.openAlert(text, callback(tmp4(4598).AlertModal, obj), () => {
          if (!c5) {
            if (c4 != null) {
              tmp();
            }
        ...
        const tmp4Result1 = tmp4(4683);
      }
    }
    if (null != c6) {
      tmp4(4595).dismissAlert(c6);
      c6 = null;
      const tmp4Result2 = tmp4(4595);
    }
    this.openLazy({
      importer() {
