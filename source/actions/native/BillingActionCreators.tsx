...
// Dependencies: [109, 5, 19, 5781, 6805, 6806, 1903, 3936, 5779, 676, 505, 21, 3, 1217, 595, 698, 530, 3945, 4604, 500, 7342, 5798, 7343, 709, 12, 5782, 6802, 7366, 1236, 7295, 4624, 7300, 1988, 4490, 6795, 7257, 4184, 7368, 3952, 5109, 503, 7504, 7505, 1385, 7296, 7506, 514, 7333, 2]
...
function handlePurchaseException(code) {
  ...
  if (!set.has(code.code)) {
    let obj = require(7257) /* isSpendingLimitError */;
    ...
    if (obj.isSpendingLimitError(billingError)) {
      ...
      if (null != underlyingIOSError) {
        ...
        if (!(code instanceof tmp(4184).BillingError)) {
          billingError1 = new tmp(4184).BillingError(code);
        }
        let tmp19 = message2 === stringResult && flag;
        if (tmp19) {
          tmp19 = billingError1.code !== tmp(3952).ErrorCodes.UNKNOWN;
        }
        if (tmp19) {
...
function canMakeIAPRequest() {
  ...
  if (!isBusyResult) {
    const isPaymentsBlocked = require(6802) /* useBlockedPaymentsConfig */.getIsPaymentsBlocked();
          ...
          try {
            ...
            if (0 === c10) {
              if (arg0 === 1) {
                ...
                obj1[0] = callback(7343).clearTransactionIOS();
                return obj1;
              }
            } else if (1 === tmp8) {
              length = 0;
              ...
              length = 1;
              c11 = transactionDate;
              length = callback3(7368).getUnderlyingIOSError(c11);
              if (null != length) {
                if (length.length > 0) {
                  let str1 = length;
                }
...
function _getIAPJWTRequestData() {
  ...
  const tmp = callback((arg0) => {
    ...
    return (function*(arg0) {
      ...
      obj1[3] = obj2;
      body = yield outer1_1(5109).post(obj1);
    ...
    if (tmp(7504).APBRequestOperations.CANCEL !== arg0) {
      if (tmp(7504).APBRequestOperations.RESUBSCRIBE !== arg0) {
        if (tmp(7504).APBRequestOperations.REACTIVATE !== arg0) {
          if (tmp(7504).APBRequestOperations.CHARGE === arg0) {
            return tmp(5782).ProductIds.GENERIC_CONSUMABLE;
          } else {
            if (tmp(7505).ACRequestOperations.CREATE !== arg0) {
              if (tmp(7505).ACRequestOperations.CANCEL !== arg0) {
                if (tmp(7505).ACRequestOperations.REACTIVATE !== arg0) {
                  if (tmp(7505).ACRequestOperations.MODIFY !== arg0) {
                    if (tmp(7505).ACRequestOperations.CHARGE === arg0) {
                      return tmp(5782).ProductIds.GENERIC_CONSUMABLE;
                    } else {
                      const _Error = Error;
            ...
            return tmp(5782).ProductIds.GENERIC_SUBSCRIPTION;
          }
        }
      }
    }
  }
  return require(5782) /* SubscriptionPlans */.ProductIds.GENERIC_SUBSCRIPTION;
}
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              if (callback7(c2)) {
                c5 = callback6(callback(7505).ACRequestOperations.CREATE);
                let obj22 = lib(709);
            ...
            if (arg0 === 1) {
              ...
              obj10[0] = callback(7505).ACRequestOperations.CREATE;
        ...
        try {
          ...
          if (0 === GENERIC_SUBSCRIPTION) {
            ...
            if (arg0 === 1) {
              ...
              GENERIC_SUBSCRIPTION = callback(5782).ProductIds.GENERIC_SUBSCRIPTION;
            ...
            if (arg0 === 1) {
              ...
              obj7[0] = callback(7505).ACRequestOperations.MODIFY;
              obj7[1] = callback;
              obj7[2] = callback2;
    ...
    const iter = (function*(arg0, arg1) {
      if (c9 === 2) {
        ...
        try {
          ...
          if (code.code === callback(3952).ErrorCodes.BILLING_PURCHASE_REQUEST_INVALID) {
            const result = callback(3945).captureBillingException(code, {});
            const obj2 = callback(3945);
          }
          while (true) {
            let tmp14 = closure_4;
            let tmp15 = closure_5;
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (callback) {
                ...
                obj2[0] = outer1_0(7343).initConnection();
                return obj2;
              }
            }
          } else if (1 === tmp7) {
...
let items = [require("module_7343").ErrorCode.E_USER_CANCELLED, StoreKitErrors.PAYMENT_CANCELED];
