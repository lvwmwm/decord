// Module ID: 8500
// Function ID: 8501
// Dependencies: [676, 698, 4550, 8501, 2007, 709, 2]
...
export default {
  open() {
    ...
    importDefault(4550).pushLazy(require(2007) /* asyncRequireImpl */(8501, dependencyMap.paths), { isChangeEmail: flag }, EMAIL_VERIFICATION_MODAL_KEY);
  },
  close() {
