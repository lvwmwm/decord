...
export const openApplyBoostModal = function openApplyBoostModal(guildId) {
  ...
  obj = { guildId };
  obj.pushLazy(require(1988) /* asyncRequireImpl */(5152, dependencyMap.paths), obj, PREMIUM_GUILD_SUBSCRIBE_MODAL_KEY);
};
export const openTransferModal = function openTransferModal(arg0) {
  ...
  importDefault(4509).pushLazy(require(1988) /* asyncRequireImpl */(5152, dependencyMap.paths), { guildId, guildBoostSlots, intent, onResult }, PREMIUM_GUILD_SUBSCRIBE_MODAL_KEY);
};
