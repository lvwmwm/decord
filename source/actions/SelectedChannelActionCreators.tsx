// Module ID: 5170
// Function ID: 5171
// Dependencies: [4359, 1391, 4393, 676, 709, 1222, 5171, 10851, 2]
...
export default {
  ...
  selectVoiceChannel(id, c1, flag2) {
    ...
    if (supported.isSupported()) {
      ...
      const obj5 = require(5171) /* selectVoiceChannelAdditional */;
  ...
  disconnect() {
    ...
    if (null != remoteSessionId) {
      importAll(10851).remoteDisconnect(remoteSessionId);
      const obj = importAll(10851);
    }
