// Module ID: 4295
// Function ID: 4296
// Dependencies: [32, 5, 4296, 1376, 1372, 4297, 676, 9161, 530, 5217, 4136, 4293, 5111, 709, 8859, 698, 1222, 4130, 1236, 5859, 4522, 2]
...
export default {
    ...
    if (null != channel) {
      ...
      if (flag) {
        ...
        if (null != obj2.getRootNavigationRef()) {
          ...
          const privateChannel = importDefault(5111).selectPrivateChannel(channel.id);
          tmp3 = channel;
          const obj3 = importDefault(5111);
        }
        obj2 = require(4136) /* getRootNavigationRef */;
        tmp6 = require;
      }
    }
    return tmp3;
  ...
  _openPrivateChannel(body) {
    ...
    if (null != obj2.getRootNavigationRef()) {
      ...
      const privateChannel = tmp2(5111).selectPrivateChannel(tmp.id);
      const tmp2Result = tmp2(5111);
    }
    return tmp;
  },
  closePrivateChannel(id, arg1, arg2) {
    ...
    tmpResult = tmp(709);
    obj = { id, guild_id: "r", parent_id: "channelId" };
