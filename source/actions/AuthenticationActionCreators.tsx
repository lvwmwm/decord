...
// Function ID: 5828
// Name: handleLogout
// Dependencies: [5, 5828, 1218, 5829, 676, 5830, 3, 4297, 709, 4159, 1222, 4509, 5127, 503, 530, 4202, 5831, 5832, 595, 707, 2]

// Module 5827 (handleLogout)
...
function handleLogout(arg0, ME) {
  ...
  if (null != DEFAULT_LOGGED_OUT) {
    ...
    const obj8 = require(4159) /* getRootNavigationRef */;
    tmp11 = require;
  }
}
...
obj = {
  ...
  switchAccountToken(token, switchSynchronously) {
    ...
    const result = importDefault(4297).clearNavigationHistory();
    obj = { type: "LOGOUT" };
