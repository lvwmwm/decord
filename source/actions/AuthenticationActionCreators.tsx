...
// Function ID: 5768
// Name: handleLogout
// Dependencies: [5, 5768, 1218, 5769, 676, 5770, 3, 4296, 709, 4153, 1222, 4507, 5126, 503, 530, 4201, 5771, 5772, 595, 707, 2]

// Module 5767 (handleLogout)
...
function handleLogout(arg0, ME) {
  ...
  if (null != DEFAULT_LOGGED_OUT) {
    ...
    const obj8 = require(4153) /* getRootNavigationRef */;
    tmp11 = require;
  }
}
...
obj = {
  ...
  switchAccountToken(token, switchSynchronously) {
    ...
    const result = importDefault(4296).clearNavigationHistory();
    obj = { type: "LOGOUT" };
