...
// Function ID: 6535
// Name: handleLogout
// Dependencies: [5, 6535, 1215, 6536, 673, 6537, 3, 4475, 706, 4336, 1219, 4731, 4721, 500, 527, 4379, 6538, 6539, 592, 704, 2]

// Module 6534 (handleLogout)
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              obj1[0] = lib(6538).fetchWebAuthnPasswordlessChallenge();
              return obj1;
            }
          } else if (1 === tmp8) {
            dependencyMap = 0;
            ...
            if (4 === tmp8) {
              dependencyMap = 1;
              c4 = c2;
              let tmp16 = c4 instanceof lib(4379).APIError;
              if (tmp16) {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              obj4[0] = closure_1_1(4721).post(obj1);
              return obj4;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
            ...
            const v6OrEarlierAPIError = new closure_1_0(4379).V6OrEarlierAPIError(closure_1);
      ...
      if (token === 2) {
        ...
        try {
          ...
          if (0 === ticket) {
            ...
            dependencyMap = 0;
            constants = sms;
            const v6OrEarlierAPIError = new closure_1_0(4379).V6OrEarlierAPIError(constants);
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              obj1[3] = obj3;
              const obj13 = v6OrEarlierAPIError(4721);
            ...
            dependencyMap = 0;
            v6OrEarlierAPIError = new closure_1_0(4379).V6OrEarlierAPIError(closure_2);
