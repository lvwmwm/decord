...
// Function ID: 5749
// Name: handleLogout
// Dependencies: [5, 5749, 1218, 5750, 676, 5751, 3, 4279, 709, 4136, 1222, 4490, 5109, 503, 530, 4184, 5752, 5753, 595, 707, 2]

// Module 5748 (handleLogout)
...
function handleLogout(arg0, ME) {
  ...
  if (null != DEFAULT_LOGGED_OUT) {
    ...
    const obj8 = require(4136) /* getRootNavigationRef */;
    tmp11 = require;
  }
}
