...
// Function ID: 5867
// Name: handleLogout
// Dependencies: [5, 5867, 1218, 5868, 676, 5869, 3, 4338, 709, 4200, 1222, 4549, 5167, 503, 530, 4243, 5870, 5871, 595, 707, 2]

// Module 5866 (handleLogout)
...
function handleLogout(arg0, ME) {
  ...
  if (null != DEFAULT_LOGGED_OUT) {
    ...
    const obj8 = require(4200) /* getRootNavigationRef */;
    tmp11 = require;
  }
}
...
obj = {
  ...
  switchAccountToken(token, switchSynchronously) {
    ...
    const result = importDefault(4338).clearNavigationHistory();
    obj = { type: "LOGOUT" };
