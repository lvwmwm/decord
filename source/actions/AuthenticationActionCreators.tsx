...
// Function ID: 5257
// Name: handleLogout
// Dependencies: [5, 5257, 1218, 5258, 676, 5259, 3, 4648, 709, 4230, 1222, 5260, 5227, 503, 530, 4273, 5264, 5265, 595, 707, 2]
...
function handleLogout(arg0, ME) {
  ...
  if (null != DEFAULT_LOGGED_OUT) {
    ...
    const obj8 = require(4230) /* getRootNavigationRef */;
    tmp11 = require;
  }
}
...
obj = {
  ...
  switchAccountToken(token, switchSynchronously) {
    ...
    const result = importDefault(4648).clearNavigationHistory();
    obj = { type: "LOGOUT" };
