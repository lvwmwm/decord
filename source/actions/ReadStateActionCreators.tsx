...
// Function ID: 5127
// Name: ack
// Dependencies: [5096, 1376, 1372, 5127, 1874, 676, 709, 11, 2]
...
export const ackChannel = function ackChannel(channel, arg1) {
  if (channel.isCategory()) {
    ...
    if (channel.isForumLikeChannel()) {
      ...
      obj = { type: "CHANNEL_ACK", channelId: null, messageId: "y", immediate: "primary", force: "lg", context: null, location: null };
      obj[1] = id;
      obj[3] = true;
      obj[4] = true;
      obj[5] = CURRENT_APP_CONTEXT;
