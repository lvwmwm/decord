            ...
            if (arg0 === 1) {
              ...
              if (null != guildId) {
                if (tmp23 === guildId) {
                  ...
                  obj1[0] = guildId(8279).checkChattableChannelThresholdMetAfterChannelPermissionDeny(tmp22, tmp25, tmp24);
                  return obj1;
                }
              }
              tmp22 = guildId;
