...
// Dependencies: [1994, 9939, 676, 685, 4498, 9941, 9942, 530, 709, 12, 514, 1486, 9751, 1374, 1341, 4642, 1236, 698, 2]
...
function doSearchRequest(q, arg1, limit) {
  ...
  obj = { search_type: constants3.GIF, load_id: store.getAnalyticsID(), num_modifiers: Object.keys(obj).length, modifiers: obj, gif_provider: _require(9941).GIF_PROVIDER };
...
export const trackSearchStart = function trackSearchStart(arg0) {
  ...
  obj = { search_type: constants3.GIF, load_id: store.getAnalyticsID(), num_modifiers: Object.keys(obj).length, modifiers: obj, gif_provider: require(9941) /* GIF_PROVIDER */.GIF_PROVIDER };
...
export const trackSearchResultViewed = function trackSearchResultViewed(totalResults, TRENDING_GIFS) {
  ...
  let obj2 = require(9942) /* isKlipyProvider */;
  obj = {};
  ...
  const merged3 = Object.assign(result);
  const merged4 = Object.assign(obj1);
  obj2.gif_provider = require(9941) /* GIF_PROVIDER */.GIF_PROVIDER;
...
export const trackSelectGIF = function trackSelectGIF(arg0) {
  ...
  let obj = require(9942) /* isKlipyProvider */;
...
export const gifUrlKey = function gifUrlKey(uri) {
  ...
  if (null != toURLSafeResult) {
    if (obj2.isAttachmentUrl(toURLSafeResult)) {
      str = tmp5(9751).removeSignedUrlParameters(toURLSafeResult);
      str = str.toString();
      const tmp5Result = tmp5(9751);
    }
    tmp4 = str;
    obj2 = require(9751) /* shouldRefreshAttachmentUrl */;
    tmp5 = require;
  }
  return tmp4;
};
