...
// Dependencies: [1994, 9980, 676, 685, 4538, 9982, 9983, 530, 709, 12, 514, 1486, 9792, 1374, 1341, 4682, 1236, 698, 2]
...
function doSearchRequest(q, arg1, limit) {
  ...
  obj = { search_type: constants3.GIF, load_id: store.getAnalyticsID(), num_modifiers: Object.keys(obj).length, modifiers: obj, gif_provider: _require(9982).GIF_PROVIDER };
...
export const trackSearchStart = function trackSearchStart(arg0) {
  ...
  obj = { search_type: constants3.GIF, load_id: store.getAnalyticsID(), num_modifiers: Object.keys(obj).length, modifiers: obj, gif_provider: require(9982) /* GIF_PROVIDER */.GIF_PROVIDER };
  importDefault(4538).trackWithMetadata(constants.SEARCH_STARTED, obj);
};
export const trackSearchResultViewed = function trackSearchResultViewed(totalResults, TRENDING_GIFS) {
  ...
  let obj2 = require(9983) /* isKlipyProvider */;
  obj = {};
  ...
  const merged3 = Object.assign(result);
  const merged4 = Object.assign(obj1);
  obj2.gif_provider = require(9982) /* GIF_PROVIDER */.GIF_PROVIDER;
  importDefault(4538).trackWithMetadata(constants.SEARCH_RESULT_VIEWED, obj2);
};
...
export const trackSelectGIF = function trackSelectGIF(arg0) {
  ...
  let obj = require(9983) /* isKlipyProvider */;
...
export const initializeSearch = function initializeSearch() {
  ...
  importDefault(4538).trackWithMetadata(constants.SEARCH_OPENED, obj);
...
export const gifUrlKey = function gifUrlKey(uri) {
  let str = uri;
  const toURLSafeResult = importDefault(1486).toURLSafe(uri);
  let tmp4 = uri;
  if (null != toURLSafeResult) {
    if (obj2.isAttachmentUrl(toURLSafeResult)) {
      str = tmp5(9792).removeSignedUrlParameters(toURLSafeResult);
      str = str.toString();
      const tmp5Result = tmp5(9792);
    }
    tmp4 = str;
    obj2 = require(9792) /* shouldRefreshAttachmentUrl */;
    tmp5 = require;
  }
  return tmp4;
};
