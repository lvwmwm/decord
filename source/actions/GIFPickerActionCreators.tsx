...
function trackSearchStart(arg0) {
  ...
  obj.gif_provider = require(9534) /* getGifProviderConfig */.getProviderForAPIRequest();
...
function trackSearchResultViewed(arg0, type) {
  ...
  let obj2 = require(9537) /* isKlipyProvider */;
  const obj1 = {};
  ...
  const obj6 = importDefault(4325);
  obj3["gif_provider"] = require(9534) /* getGifProviderConfig */.getProviderForAPIRequest();
...
function doSearchRequest(q, arg1, limit) {
  ...
  obj = { q, media_format: store.getSelectedFormat(), provider: _require(9534).getProviderForAPIRequest(), locale: _isNativeReflectConstruct.locale, limit };
  obj.query = obj;
...
function gifUrlKey(uri) {
  ...
  if (null != toURLSafeResult) {
    if (obj2.isAttachmentUrl(toURLSafeResult)) {
      str = require(9538) /* isAttachmentUrl */.removeSignedUrlParameters(toURLSafeResult);
      str = str.toString();
      const obj3 = require(9538) /* isAttachmentUrl */;
    }
    tmp3 = str;
    obj2 = require(9538) /* isAttachmentUrl */;
  }
  return tmp3;
}
function isProxiedAttachment(src) {
  ...
  if (tmp2) {
    let result = require(9538) /* isAttachmentUrl */.isExternalProxiedAttachmentUrl(toURLSafeResult);
    if (!result) {
      result = require(9538) /* isAttachmentUrl */.isAttachmentUrl(toURLSafeResult);
      const obj3 = require(9538) /* isAttachmentUrl */;
    }
    tmp2 = result;
...
export const fetchSuggestions = function fetchSuggestions(resultQuery) {
  ...
  if (tmp) {
    ...
    obj = { q: resultQuery, provider: _require(9534).getProviderForAPIRequest(), limit: 5, locale: _isNativeReflectConstruct.locale };
    obj.query = obj;
    obj.oldFormErrors = true;
    obj.rejectWithError = true;
    const value = HTTP.get(obj);
...
export const trackSelectGIF = function trackSelectGIF(arg0) {
  ...
  if (null != gifId) {
    const providerForAPIRequest = require(9534) /* getGifProviderConfig */.getProviderForAPIRequest();
    ...
    obj.rejectWithError = true;
    HTTP.post(obj);
    const obj4 = require(9534) /* getGifProviderConfig */;
  }
};
export const initializeSearch = function initializeSearch() {
  ...
  importDefault(4325).trackWithMetadata(constants.SEARCH_OPENED, obj);
...
export const fetchTrending = function fetchTrending() {
  ...
  obj = { provider: require(9534) /* getGifProviderConfig */.getProviderForAPIRequest(), locale: _isNativeReflectConstruct.locale, media_format: store.getSelectedFormat() };
  obj.query = obj;
  obj.oldFormErrors = true;
  obj.rejectWithError = true;
  const value = HTTP.get(obj);
...
export const fetchTrendingGIFs = function fetchTrendingGIFs(closure_10) {
  ...
  obj = { media_format: store.getSelectedFormat(), provider: _require(9534).getProviderForAPIRequest(), locale: _isNativeReflectConstruct.locale, limit: closure_10 };
  obj.query = obj;
  obj.oldFormErrors = true;
  obj.rejectWithError = true;
  const value = HTTP.get(obj);
...
export const fetchTrendingSearchTerms = function fetchTrendingSearchTerms() {
  ...
  obj = { provider: require(9534) /* getGifProviderConfig */.getProviderForAPIRequest(), limit: 5, locale: _isNativeReflectConstruct.locale };
  obj.query = obj;
  obj.oldFormErrors = true;
  obj.rejectWithError = true;
  const value = HTTP.get(obj);
