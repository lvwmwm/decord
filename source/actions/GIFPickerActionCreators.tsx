...
// Dependencies: [1975, 9867, 676, 685, 4496, 9869, 9870, 530, 709, 12, 514, 1467, 9679, 1355, 1341, 4640, 1236, 698, 2]
...
function doSearchRequest(q, arg1, limit) {
  ...
  obj = { search_type: constants3.GIF, load_id: store.getAnalyticsID(), num_modifiers: Object.keys(obj).length, modifiers: obj, gif_provider: _require(9869).GIF_PROVIDER };
...
export const trackSearchStart = function trackSearchStart(arg0) {
  ...
  obj = { search_type: constants3.GIF, load_id: store.getAnalyticsID(), num_modifiers: Object.keys(obj).length, modifiers: obj, gif_provider: require(9869) /* GIF_PROVIDER */.GIF_PROVIDER };
  importDefault(4496).trackWithMetadata(constants.SEARCH_STARTED, obj);
};
export const trackSearchResultViewed = function trackSearchResultViewed(totalResults, TRENDING_GIFS) {
  ...
  let obj2 = require(9870) /* isKlipyProvider */;
  obj = {};
  ...
  const merged3 = Object.assign(result);
  const merged4 = Object.assign(obj1);
  obj2.gif_provider = require(9869) /* GIF_PROVIDER */.GIF_PROVIDER;
  importDefault(4496).trackWithMetadata(constants.SEARCH_RESULT_VIEWED, obj2);
};
...
export const trackSelectGIF = function trackSelectGIF(arg0) {
  ...
  let obj = require(9870) /* isKlipyProvider */;
...
export const initializeSearch = function initializeSearch() {
  ...
  importDefault(4496).trackWithMetadata(constants.SEARCH_OPENED, obj);
...
export const gifUrlKey = function gifUrlKey(uri) {
  ...
  if (null != toURLSafeResult) {
    if (obj2.isAttachmentUrl(toURLSafeResult)) {
      str = tmp5(9679).removeSignedUrlParameters(toURLSafeResult);
      str = str.toString();
      const tmp5Result = tmp5(9679);
    }
    tmp4 = str;
    obj2 = require(9679) /* shouldRefreshAttachmentUrl */;
    tmp5 = require;
  }
  return tmp4;
};
