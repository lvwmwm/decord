...
// Dependencies: [1994, 10194, 676, 685, 5042, 10196, 10197, 530, 709, 12, 514, 1487, 9085, 1374, 1341, 4827, 1236, 698, 2]
...
export const trackSearchStart = function trackSearchStart(arg0) {
  ...
  obj = { search_type: constants3.GIF, load_id: store.getAnalyticsID(), num_modifiers: Object.keys(obj).length, modifiers: obj, gif_provider: require(10196) /* GIF_PROVIDER */.GIF_PROVIDER };
  importDefault(5042).trackWithMetadata(constants.SEARCH_STARTED, obj);
};
export const trackSearchResultViewed = function trackSearchResultViewed(totalResults, TRENDING_GIFS) {
  ...
  let obj2 = require(10197) /* isKlipyProvider */;
  obj = {};
  ...
  const merged3 = Object.assign(result);
  const merged4 = Object.assign(obj1);
  obj2.gif_provider = require(10196) /* GIF_PROVIDER */.GIF_PROVIDER;
  importDefault(5042).trackWithMetadata(constants.SEARCH_RESULT_VIEWED, obj2);
};
...
export const trackSelectGIF = function trackSelectGIF(arg0) {
  ...
  let obj = require(10197) /* isKlipyProvider */;
...
export const initializeSearch = function initializeSearch() {
  ...
  importDefault(5042).trackWithMetadata(constants.SEARCH_OPENED, obj);
...
export const gifUrlKey = function gifUrlKey(uri) {
  let str = uri;
  const toURLSafeResult = importDefault(1487).toURLSafe(uri);
  let tmp4 = uri;
  if (null != toURLSafeResult) {
    if (obj2.isAttachmentUrl(toURLSafeResult)) {
      str = tmp5(9085).removeSignedUrlParameters(toURLSafeResult);
      str = str.toString();
      const tmp5Result = tmp5(9085);
    }
    tmp4 = str;
    obj2 = require(9085) /* shouldRefreshAttachmentUrl */;
    tmp5 = require;
  }
  return tmp4;
};
