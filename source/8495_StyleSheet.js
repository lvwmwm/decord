...
// Function ID: 8496
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1481, 1612, 5260, 8496, 4631, 8497, 8499, 8500, 8501, 8502]
// Exports: NativeStackView

// Module 8495 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5260).HeaderShownContext);
  let num5 = React.useContext(num6(5260).HeaderHeightContext);
  const context1 = React.useContext(num6(5260).HeaderBackContext);
  let obj3 = num6(5260);
  ...
  callback = obj2.useCallback(num6(8496).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4631).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4631).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5260).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5260);
  ...
  let eventResult;
  const headerConfigProps = num6(8497).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  obj15[1] = closure_10(num6(5260).HeaderBackContext.Provider, obj16);
  items5[2] = closure_10(num6(5260).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = closure_11(num6(5260).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(8499).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4631).ScreenStackItem, obj4);
  return closure_10(num6(1481).NavigationProvider, obj3);
}
