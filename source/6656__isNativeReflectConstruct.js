...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 6657, 6659, 6661, 6650, 6663, 6665, 6646]

// Module 6656 (_isNativeReflectConstruct)
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [callback3(FeDropShadow(6657), { in: str, stdDeviation: props.stdDeviation }), callback3(FeDropShadow(6659), { dx, dy, result: "offsetblur" }), , , ];
    obj = { floodColor: self.props.floodColor, floodOpacity: self.props.floodOpacity };
    items[2] = callback3(FeDropShadow(6661), obj);
    items[3] = callback3(FeDropShadow(6650), { in2: "offsetblur", operator: "in" });
    obj = { result, children: null };
    const items1 = [callback3(FeDropShadow(6665), {}), callback3(FeDropShadow(6665), { in: str })];
    obj[1] = items1;
    items[4] = callback4(FeDropShadow(6663), obj);
    obj[0] = items;
