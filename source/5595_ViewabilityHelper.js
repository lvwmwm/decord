...
// Dependencies: [5578, 5579, 5566]

// Module 5595 (ViewabilityHelper)
      ...
      if (null !== prop) {
        ...
        if (undefined !== prop1) {
          ...
          if (null !== prop2) {
            ...
            if (undefined !== prop3) {
              const _Error = Error;
              const error = new Error(timerId(5566).ErrorMessages.multipleViewabilityThresholdTypesNotSupported);
              throw error;
            }
          }
        }
