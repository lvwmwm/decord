...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8414, 8415, 8416, 8417, 8421, 8422, 8423, 8433]

// Module 8413 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(8415)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(8416)(tmp, tmp, this);
      ...
      obj.children = jsx(importDefault(8423), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(8421), {});
    }
  }
];
