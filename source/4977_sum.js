  ...
  findJpegOffsets(byteLength) {
    ...
    if (c5 + c6 + 5 <= byteLength.byteLength) {
      while (true) {
        ...
        let tmp28 = tmp8;
        let sum5 = tmp9;
        if (module(4974).USE_FILE) {
          let tmp30 = c19;
          if (byteLength.getUint16(sum) === c19) {
            break;
          }
        }
        if (tmp19(4974).USE_FILE) {
          let tmp31 = c20;
        ...
        if (tmp19(4974).USE_EXIF) {
          ...
          if (tmp40) {
            let tmp41 = require;
            let obj1 = require(4971) /* getDataView */;
            let tmp42 = c6;
        ...
        if (tmp19(4974).USE_XMP) {
          ...
          if (tmp50) {
            let tmp51 = length4;
            let tmp52 = require;
            let obj4 = require(4971) /* getDataView */;
            let tmp53 = c6;
