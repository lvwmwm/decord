// Module ID: 13353
// Function ID: 102231
// Dependencies: [13354, 13302, 13298, 13299, 13318, 13355, 13356, 13321]
...
if (getOwnPropertyDescriptor) {
  getOwnPropertyDescriptor = !require("module_13299")(() => 8 !== defineProperty(() => {
...
const fn = (name, toString) => {
  ...
  let tmp9 = !require(13318) /* call */(name, "name");
  if (!tmp9) {
    let CONFIGURABLE = require(13355).CONFIGURABLE;
    if (CONFIGURABLE) {
  ...
  if (tmp9) {
    if (require(13298) /* getOwnPropertyDescriptor */) {
  ...
  if (tmp22) {
    tmp22 = require(13318) /* call */(arg2, "arity");
  }
  if (tmp22) {
  ...
  if (arg2) {
    if (require(13318) /* call */(arg2, "constructor")) {
      if (arg2.constructor) {
        if (require(13298) /* getOwnPropertyDescriptor */) {
          obj = { writable: false };
      ...
      while (true) {
        ...
        let num4 = 6;
        let obj4 = require(13356) /* state */;
        let tmp43 = name;
        let enforceResult = obj4.enforce(name);
        let tmp45 = enforceResult;
        let str10 = "source";
        if (require(13318) /* call */(enforceResult, "source")) {
          break;
        } else {
          let tmp48 = text;
          let str11 = "";
...
Function.prototype.toString = fn(function toString() {
  const self = this;
  let source = require(13321) /* all */(this);
  if (source) {
    source = require(13356) /* state */.get(self).source;
    const obj = require(13356) /* state */;
  }
  if (!source) {
