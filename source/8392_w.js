...
let fn = function w() {
  return (() => {
    ...
    let fn = function q(fnResult, fn2Result3, arg2) {
      if (arg2) {
        let num3 = 0;
    ...
    function Q(arg0, arg1) {
          ...
          while (true) {
            ...
            if (tmp5) {
              ...
              if (tmp7) {
                ...
                let tmp52 = outer1_63;
                let arr1 = byweekday1.push(outer1_63[tmp7]);
                tmp16 = tmp3;
              } else {
                let str = "weekday(s)";
                if ("weekday(s)" === obj.symbol) {
                  ...
                  if (!obj.byweekday) {
                    let tmp42 = obj;
                    let tmp43 = outer1_63;
                    let items = [outer1_63.MO, , , , ];
                    let tmp44 = outer1_63;
                    items[1] = outer1_63.TU;
                    let tmp45 = outer1_63;
                    items[2] = outer1_63.WE;
                    let tmp46 = outer1_63;
                    items[3] = outer1_63.TH;
                    let tmp47 = outer1_63;
                    items[4] = outer1_63.FR;
                    obj.byweekday = items;
                    tmp16 = tmp3;
                  }
                } else {
      ...
      let obj = {};
      let obj2 = new closure_44(tmp.tokens);
      let tmp2 = null;
      if (obj2.start(arg0)) {
        (() => {
          ...
          if (obj2.isDone()) {
            ...
            if ("day(s)" === symbol) {
              expectResult = obj;
              expectResult = outer1_63;
              obj.freq = outer1_63.DAILY;
              expectResult = obj2;
              if (obj2.nextSymbol()) {
                expectResult = obj2;
                expectResult = globalThis;
              ...
              expectResult = obj;
              expectResult = outer1_63;
              obj.freq = outer1_63.WEEKLY;
              expectResult = obj;
              expectResult = outer1_63;
              const items1 = [outer1_63.MO, , , , ];
              expectResult = outer1_63;
              items1[1] = outer1_63.TU;
              expectResult = outer1_63;
              items1[2] = outer1_63.WE;
              expectResult = outer1_63;
              items1[3] = outer1_63.TH;
              expectResult = outer1_63;
              items1[4] = outer1_63.FR;
              ...
              const items3 = [outer1_63[str16.toUpperCase(str16)]];
                ...
                if (obj2.accept("comma")) {
                  while (!obj2.isDone()) {
                    ...
                    if (tmp49) {
                      ...
                      let byweekday = obj.byweekday;
                      let tmp57 = outer1_63;
                      arr = byweekday.push(outer1_63[tmp49]);
                      let tmp59 = obj2;
    ...
    function ut(str) {
      ...
      let closure_1 = tmp;
      let parts = str.replace(/^(?:RRULE|EXRULE):/i, "").split(";");
      const item = parts.forEach((str) => {
        let parts = str.split("=");
        const formatted = str.toUpperCase();
        if ("FREQ" === formatted) {
          closure_1.freq = outer1_37[str2.toUpperCase(str2)];
        } else if ("WKST" === formatted) {
          closure_1.wkst = outer1_60[str2.toUpperCase(str2)];
        } else {
          if ("COUNT" !== formatted) {
                              ...
                              if ("BYWEEKDAY" !== formatted) {
                                if ("BYDAY" !== formatted) {
                                  if ("DTSTART" !== formatted) {
                                    if ("TZID" !== formatted) {
                                      if ("UNTIL" === formatted) {
                                        closure_1.until = outer1_32(str2);
                                  ...
                                  ({ tzid: closure_1.tzid, dtstart: closure_1.dtstart } = outer1_72(closure_0));
                                  const tmp14 = outer1_72(closure_0);
                                }
                              }
                              closure_1.byweekday = ((str) => {
                                const parts = str.split(",");
                                return parts.map(() => { ... });
                              })(str2);
                            }
          ...
          if (-1 !== str2.indexOf(",")) {
            ...
            let mapped = parts1.map(outer1_75);
          } else {
            mapped = outer1_75(str2);
          }
          closure_1[str.toLowerCase()] = mapped;
        }
      });
      return tmp;
    }
            ...
            if (p(tmp, keys[num])) {
              ...
              if (i(str5)) {
                ...
                if (!isArray(str5)) {
                  if ("FREQ" === formatted) {
                    let tmp33 = tmp49;
                    let str1 = tmp49.FREQUENCIES[tzid.freq];
                    let tmp19 = tmp2;
                    let tmp20 = str2;
                    let str6 = formatted;
                    let tmp21 = tmp6;
      ...
      if (Array.isArray(arr)) {
        ...
        if (everyResult) {
          everyResult = arr.every((getTime) => {
            ...
            return time === getTime[arg1].getTime();
          });
        }
        let tmp = everyResult;
      } else {
      ...
      if (0 !== count) {
        if (0 !== interval.interval) {
          ...
          let arr2 = ((gettimeset, fromDateResult, interval) => {
            ...
            if (outer1_69(freq)) {
              let items = ((dtstart) => {
                let closure_0 = dtstart;
                dtstart = dtstart.dtstart;
                let closure_1 = dtstart.getTime() % 1000;
                const items = [];
                if (outer2_69(dtstart.freq)) {
                  const byhour = dtstart.byhour;
                  let item = byhour.forEach(() => { ... });
                  return items;
                } else {
                  return items;
                }
    ...
    function Bt(arg0, arg1) {
      ...
      return ((arg0, cache) => {
        ...
        let rdatevals;
        let rrulevals;
        let tmp = (function Kt(str, unfold) {
          let sum;
          let items = [];
          let closure_1 = [];
          const items1 = [];
          let closure_3 = [];
          let tmp = outer2_72(str);
          let tzid = tmp.tzid;
          ...
          if (str) {
            ...
            let obj = { dtstart: tmp.dtstart, tzid, rrulevals: items, rdatevals: closure_1, exrulevals: items1, exdatevals: closure_3 };
            return obj;
          } else {
            let _Error = Error;
            let error = new Error("Invalid empty string");
            throw error;
          }
        })(arg0, cache);
            ...
            if (!rdatevals.length) {
              if (!exrulevals.length) {
                if (!exdatevals.length) {
                  ...
                  let prototype = tmp4.prototype;
                  tmp4 = new tmp4(outer1_86(tmp3, dtstart2, tmp3.tzid || cache.tzid || tzid), tmp2);
                  return tmp4;
                }
              }
            }
        ...
        let obj = new outer1_65(tmp2);
        obj.dtstart(dtstart);
        obj.tzid(tzid);
        let item = rrulevals.forEach((arg0) => {
          obj.rrule(new outer2_63(outer2_86(arg0, dtstart, tzid), closure_2));
        });
        const item1 = rdatevals.forEach((arg0) => {
          obj.rdate(arg0);
        });
        const item2 = exrulevals.forEach((arg0) => {
          obj.exrule(new outer2_63(outer2_86(arg0, dtstart, tzid), closure_2));
        });
        ...
        const items = [];
        const keys = Object.keys(arg0);
        let closure_1 = Object.keys(outer1_64);
        const item = keys.forEach((arg0) => {
          if (!outer2_13(closure_1, arg0)) {
            items.push(arg0);
          }
        });
        if (items.length) {
          ...
          return outer1_36(outer1_36({}, outer1_64), arg0);
        }
      })(obj));
    }
    ...
    function Xt(str, arr) {
      ...
      const parts = str.split(",");
      return parts.map((arg0) => outer1_32(arg0));
    }
    function Gt(arg0) {
      let closure_0 = arg0;
      const self = this;
    ...
    function Vt(arg0, arr, str) {
      ...
      const mapped = arr.map((arg0) => outer1_31(arg0.valueOf(), closure_0));
      const joined = mapped.join(",");
    ...
    let obj = {
      d(arg0, obj) {
        for (const key10006 in arg1) {
          let tmp4 = key10006;
          let tmp5 = obj;
          let oResult = obj.o(arg1, key10006);
          if (oResult) {
            let tmp = obj;
            oResult = !obj.o(arg0, key10006);
          }
          if (!oResult) {
            continue;
          } else {
    ...
    let tmp3 = (() => {
      class t {
        ...
        static fromStr(arg0) {
          tmp = new t(outer1_1.indexOf(arg0));
          return tmp;
        }
        nth(arg0) {
          self = this;
    ...
    let closure_15 = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
    let closure_16 = fn4(1970, 1, 1);
    let closure_17 = [6, 0, 1, 2, 3, 4, 5];
    function k(arg0) {
      let tmp = arg0 % 4 === 0;
      if (tmp) {
        tmp = arg0 % 100 !== 0;
    ...
    function U(arg0) {
      return table2[arg0.getUTCDay(arg0)];
    }
    ...
    let closure_38 = ((arg0) => {
      ...
      class e {
        constructor(arg0, arg1, arg2) {
          tmp = closure_0.call(this, arg0, arg1) || this;
          tmp.iterator = arg2;
          return tmp;
        }
        add(arg0) {
    ...
    let tmp5 = (() => {
      class t {
        constructor(arg0, arg1, arg2, arg3) {
          ...
          if (outer1_3(self.origOptions.byweekday)) {
            tmp8 = outer1_6;
            byweekday = self.origOptions.byweekday;
            if (outer1_6(self.origOptions.byweekday)) {
              items2 = byweekday;
            } else {
              items2 = [];
              items2[0] = byweekday;
        ...
        static isFullyConvertible(arg0) {
          if (arg0.options.freq in t.IMPLEMENTED) {
            ...
            for (const key10014 in arg0.origOptions) {
              tmp3 = key10014;
              tmp4 = outer1_40;
              if (outer1_40(["dtstart", "wkst", "freq"], key10014)) {
                flag3 = true;
                return true;
              } else {
                tmp = outer1_40;
                tmp2 = t;
                if (outer1_40(t.IMPLEMENTED[arg0.options.freq], key10014)) {
                  continue;
                } else {
                  flag2 = false;
                  return false;
        ...
        toString() {
          ...
          if (this.options.freq in t.IMPLEMENTED) {
            ...
            self.text = items;
            tmp = outer1_63;
            tmp2 = self[outer1_63.FREQUENCIES[self.options.freq]]();
    ...
    let closure_47 = ((arg0) => {
      ...
      class e {
        constructor(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
          tmp = closure_0.call(this, arg3, arg4, arg5, arg6) || this;
          tmp.year = arg0;
          tmp.month = arg1;
          tmp.day = arg2;
          return tmp;
        ...
        addMonths(arg0) {
          ...
          if (this.month > 12) {
            ...
            self.month = outer1_9(self.month, 12);
        ...
        fixDay() {
          ...
          if (this.day > 28) {
            tmp3 = outer1_26;
            num = 1;
            tmp2 = outer1_26(self.year, self.month - 1)[1];
            if (self.day > tmp2) {
              num2 = 9999;
              num3 = 13;
              if (self.day > tmp2) {
    ...
    let closure_48 = (() => {
      class t {
        ...
        toString() {
          date = this.date;
          tmp = outer1_31(date.getTime(), this.isUTC);
          if (this.isUTC) {
            concat2 = ":".concat;
            combined = ":".concat(tmp);
          } else {
        ...
        rezonedDate() {
          ...
          if (this.isUTC) {
            ...
            tmp4 = new.target;
            tmp5 = new.target;
            date = new Date(outer1_33(date, DateTimeFormatResult.resolvedOptions().timeZone));
            tmp6 = date;
            _Date2 = Date;
            tmp7 = null;
            str = "UTC";
      ...
      class t {
        ...
        _cacheGet(arg0, arg1) {
              ...
              if (0 < arr2.length) {
                ...
                while (keys.length) {
                  ...
                  if (0 < keys.length) {
                    ...
                    tmp4 = outer1_78;
                    flag2 = true;
                    while (outer1_78(arg1[tmp3], tmp2[tmp3])) {
                      num3 = num3 + 1;
                      flag2 = false;
                      if (num3 >= keys.length) {
                        break;
          ...
          if (!flag) {
            ...
            if (self.all) {
              tmp6 = outer1_34;
              prototype = outer1_34.prototype;
              tmp7 = new.target;
              tmp8 = new.target;
              tmp9 = arg0;
              tmp10 = arg1;
              obj = new outer1_34(arg0, arg1);
              tmp11 = obj;
              num4 = 0;
    ...
    let closure_56 = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366];
    let closure_57 = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365];
    let items3 = [];
    let num = 0;
    do {
    ...
    let closure_59 = (() => {
      class t {
        ...
        rebuild(arg0, arg1) {
          ...
          if (arg0 !== this.lastyear) {
            self.yearinfo = (function _t(lastyear, options) {
              const tmp = outer2_14(lastyear, 1, 1);
              let num = 365;
              let num2 = 365;
              if (outer2_18(lastyear)) {
                num2 = 366;
              }
              let num3 = num;
              if (outer2_18(lastyear + 1)) {
                num3 = 366;
              }
              const tmp3 = outer2_25(tmp);
              let obj = { yearlen: num2, nextyearlen: num3, yearordinal: outer2_22(tmp), yearweekday: tmp3 };
              let num4 = num;
              if (outer2_18(lastyear)) {
                num4 = 366;
              }
              const tmp5 = outer2_25(outer2_14(lastyear, 1, 1));
              if (num === num4) {
                obj = { mmask: outer2_50, mdaymask: outer2_53, nmdaymask: outer2_55, wdaymask: outer2_58.slice(tmp5), mrange: outer2_57 };
              } else {
                obj = { mmask: outer2_51, mdaymask: outer2_52, nmdaymask: outer2_54, wdaymask: outer2_58.slice(tmp5), mrange: outer2_56 };
              }
              const tmp4Result = outer2_36(outer2_36(obj, obj), { wnomask: null });
              if (outer2_11(options.byweekno)) {
                return tmp4Result;
              } else {
                tmp4Result.wnomask = outer2_8(0, num2 + 7);
                const tmp19 = outer2_9(7 - tmp3 + options.wkst, 7);
                let num7 = 4;
                if (tmp19 >= 4) {
                  let sum = tmp4Result.yearlen + outer2_9(tmp3 - options.wkst, 7);
                  let num8 = 0;
                } else {
                  sum = num2 - tmp19;
                  num8 = tmp19;
                ...
                const _Math2 = Math;
                const rounded1 = Math.floor(rounded + outer2_9(sum, 7) / num7);
                let num9 = 0;
                ...
                if (outer2_13(options.byweekno, 1)) {
                ...
                if (num8) {
                  if (outer2_13(options.byweekno, -1)) {
                    ...
                    const obj4 = outer2_25(outer2_14(lastyear - 1, 1, 1));
                    if (outer2_18(lastyear - 1)) {
                      num = 366;
                    }
                    if (tmp45 >= num7) {
                      let sum8 = num + outer2_9(obj4 - options.wkst, 7);
                    } else {
                      sum8 = num2 - num8;
                    }
                    num = sum9.Math;
                    num7 = outer2_9(sum8, 7) / num7;
                    sum9 = 52 + num7;
                    num.floor(sum9);
                    tmp45 = outer2_9(7 - obj4.valueOf() + options.wkst, 7);
                  }
                }
                return tmp4Result;
              }
              const tmp2 = outer2_22(tmp);
            })(arg0, options);
          }
          if (outer1_12(options.bynweekday)) {
            if (arg1 !== self.lastmonth) {
              ...
              items = [];
              tmp = outer1_63;
              if (options.freq === outer1_63.YEARLY) {
                tmp3 = outer1_11;
                if (outer1_11(options.bymonth)) {
                  items1 = [0];
                  items1[1] = yearlen;
                  items2 = [];
                  items2[0] = items1;
                ...
                tmp2 = outer1_63;
                arr2 = items;
                if (options.freq === outer1_63.MONTHLY) {
                  num28 = 1;
                  items3 = [];
              ...
              if (!outer1_11(arr2)) {
                tmp8 = outer1_8;
                num3 = 0;
                obj.nwdaymask = outer1_8(0, yearlen);
                num4 = 1;
                num5 = 7;
                  ...
                  if (0 < options.bynweekday.length) {
                    do {
                      ...
                      if (tmp13 < 0) {
                        sum = diff + 7 * (tmp13 + 1);
                        tmp18 = outer1_9;
                        diff1 = sum - outer1_9(wdaymask[sum] - tmp12, 7);
                      } else {
                        sum1 = first + 7 * (tmp13 - 1);
                        tmp15 = outer1_9;
                        diff1 = sum1 + outer1_9(7 - wdaymask[sum1] + tmp12, 7);
                      }
        ...
        mdayset(arg0, arg1) {
          ...
          tmp3 = outer1_8(null, this.yearlen);
          sum = tmp;
          if (tmp < tmp2) {
            do {
              tmp3[sum] = sum;
        ...
        wdayset(arg0, arg1, arg2) {
          self = this;
          tmp = outer1_8(null, this.yearlen + 7);
          diff = outer1_22(outer1_14(arg0, arg1, arg2)) - this.yearordinal;
          tmp[diff] = diff;
          sum = diff + 1;
          tmp4 = sum;
          num = 0;
        ...
        ddayset(arg0, arg1, arg2) {
          tmp = outer1_8(null, this.yearlen);
          diff = outer1_22(outer1_14(arg0, arg1, arg2)) - this.yearordinal;
          tmp[diff] = diff;
          items = [, , ];
          items[0] = tmp;
        ...
        mtimeset(arg0, arg1, arg2, arg3) {
          ...
          mapped = bysecond.map((arg0) => new outer2_46(closure_0, closure_1, arg0, closure_2));
          tmp2 = outer1_30(mapped);
          return mapped;
        }
        stimeset(arg0, arg1, arg2, arg3) {
          tmp = new outer1_46(arg0, arg1, arg2, arg3);
          items = [];
          items[0] = tmp;
          return items;
        }
    ...
    obj3.WE = new tmp3(2);
    let tmp31 = new tmp3(2);
    obj3.TH = new tmp3(3);
    let tmp32 = new tmp3(3);
    obj3.FR = new tmp3(4);
    let tmp33 = new tmp3(4);
    obj3.SA = new tmp3(5);
    let tmp34 = new tmp3(5);
    obj3.SU = new tmp3(6);
    let obj4 = { freq: obj2.YEARLY, dtstart: null, interval: 1, wkst: obj3.MO, count: null, until: null, tzid: null, bysetpos: null, bymonth: null, bymonthday: null, bynmonthday: null, byyearday: null, byweekno: null, byweekday: null, bynweekday: null, byhour: null, byminute: null, bysecond: null, byeaster: null };
    ...
    let tmp49 = (() => {
      class t {
        constructor(arg0, arg1) {
          ...
          if (!flag) {
            tmp2 = outer1_49;
            prototype = outer1_49.prototype;
            tmp3 = new.target;
            tmp4 = new.target;
            tmp = new outer1_49();
          }
          self._cache = tmp;
          self.origOptions = outer1_70(obj);
          tmp5 = outer1_36({}, outer1_61);
          tmp6 = outer1_36(tmp5, outer1_70(obj));
          if (outer1_3(tmp6.byeaster)) {
            tmp7 = outer1_63;
            tmp6.freq = outer1_63.YEARLY;
          }
          if (outer1_3(tmp6.freq)) {
            tmp8 = outer1_63;
            if (outer1_63.FREQUENCIES[tmp6.freq]) {
              if (!tmp6.dtstart) {
                tmp10 = globalThis;
                _Date = Date;
                _Date2 = Date;
              ...
              tmp18 = outer1_3;
              if (outer1_3(tmp6.wkst)) {
                tmp20 = outer1_4;
                if (!outer1_4(tmp6.wkst)) {
                  tmp6.wkst = tmp6.wkst.weekday;
                }
              } else {
                tmp19 = outer1_63;
                tmp6.wkst = outer1_63.MO.weekday;
              }
              tmp21 = outer1_3;
              if (outer1_3(tmp6.bysetpos)) {
                tmp22 = outer1_4;
                if (outer1_4(tmp6.bysetpos)) {
                  items = [];
              ...
              if (!Boolean(tmp6.byweekno)) {
                tmp25 = outer1_12;
                if (!outer1_12(tmp6.byweekno)) {
                  tmp26 = outer1_12;
                  if (!outer1_12(tmp6.byyearday)) {
                    _Boolean2 = Boolean;
                    if (!Boolean(tmp6.bymonthday)) {
                      tmp27 = outer1_12;
                      if (!outer1_12(tmp6.bymonthday)) {
                        tmp28 = outer1_3;
                        if (!outer1_3(tmp6.byweekday)) {
                          tmp29 = outer1_3;
                          if (!outer1_3(tmp6.byeaster)) {
                            freq = tmp6.freq;
                            tmp30 = outer1_63;
                            if (outer1_63.YEARLY === freq) {
                              if (!tmp6.bymonth) {
                              ...
                              tmp31 = outer1_63;
                              if (outer1_63.MONTHLY === freq) {
                                dtstart = tmp6.dtstart;
                                tmp6.bymonthday = dtstart.getUTCDate();
                              } else {
                                tmp32 = outer1_63;
                                if (outer1_63.WEEKLY === freq) {
                                  tmp33 = outer1_25;
                                  items1 = [];
                                  items1[0] = outer1_25(tmp6.dtstart);
              ...
              tmp34 = outer1_3;
              tmp35 = outer1_3(tmp6.bymonth);
              if (tmp35) {
                tmp36 = outer1_6;
                tmp35 = !outer1_6(tmp6.bymonth);
              }
              if (tmp35) {
                items2 = [];
              ...
              tmp37 = outer1_3;
              tmp38 = outer1_3(tmp6.byyearday);
              if (tmp38) {
                tmp39 = outer1_6;
                tmp38 = !outer1_6(tmp6.byyearday);
              }
              if (tmp38) {
                tmp40 = outer1_4;
                tmp38 = outer1_4(tmp6.byyearday);
              }
              if (tmp38) {
                items3 = [];
              ...
              tmp41 = outer1_3;
              if (outer1_3(tmp6.bymonthday)) {
                tmp42 = outer1_6;
                bymonthday = tmp6.bymonthday;
                num7 = 0;
                if (outer1_6(tmp6.bymonthday)) {
                  items4 = [];
                  items5 = [];
                  num8 = 0;
              ...
              tmp46 = outer1_3;
              tmp47 = outer1_3(tmp6.byweekno);
              if (tmp47) {
                tmp48 = outer1_6;
                tmp47 = !outer1_6(tmp6.byweekno);
              }
              if (tmp47) {
                items8 = [];
              ...
              if (outer1_3(tmp6.byweekday)) {
                ...
                if (outer1_4(tmp6.byweekday)) {
                  ...
                  tmp51 = outer1_5;
                  if (outer1_5(tmp6.byweekday)) {
                    tmp67 = outer1_2;
                    items10 = [];
                    items10[0] = outer1_2.fromStr(tmp6.byweekday).weekday;
                    tmp6.byweekday = items10;
                    tmp6.bynweekday = null;
                  } else {
                    tmp52 = outer1_2;
                    byweekday = tmp6.byweekday;
                    if (tmp6.byweekday instanceof outer1_2) {
                      if (byweekday.n) {
                        tmp66 = outer1_63;
                        if (tmp6.freq <= outer1_63.MONTHLY) {
                          items11 = [, ];
                      ...
                      if (0 < byweekday.length) {
                        do {
                          ...
                          if (outer1_4(tmp53)) {
                            ...
                            if (outer1_5(tmp53)) {
                              tmp59 = outer1_2;
                              arr3 = items14.push(outer1_2.fromStr(tmp53).weekday);
                            } else {
                              if (tmp53.n) {
                                tmp56 = outer1_63;
                                if (tmp6.freq <= outer1_63.MONTHLY) {
                      ...
                      tmp62 = outer1_12;
                      tmp63 = null;
                      if (outer1_12(items14)) {
                        tmp63 = items14;
                      }
                      tmp6.byweekday = tmp63;
                      tmp64 = outer1_12;
                      tmp65 = null;
                      if (outer1_12(items15)) {
                        tmp65 = items15;
                      }
              ...
              tmp68 = outer1_3;
              if (outer1_3(tmp6.byhour)) {
                tmp71 = outer1_4;
                if (outer1_4(tmp6.byhour)) {
                  items17 = [];
              ...
              tmp72 = outer1_3;
              if (outer1_3(tmp6.byminute)) {
                tmp75 = outer1_4;
                if (outer1_4(tmp6.byminute)) {
                  items19 = [];
                ...
                tmp73 = outer1_63;
                tmp74 = null;
                if (tmp6.freq < outer1_63.MINUTELY) {
              ...
              tmp76 = outer1_3;
              if (outer1_3(tmp6.bysecond)) {
                tmp79 = outer1_4;
                if (outer1_4(tmp6.bysecond)) {
                  items21 = [];
                ...
                tmp77 = outer1_63;
                tmp78 = null;
                if (tmp6.freq < outer1_63.SECONDLY) {
        ...
        static fromText(arg0, arg1) {
          ...
          tmp2 = outer1_63;
          tmp3 = outer1_68(arg0, tmp) || undefined;
          tmp2 = new tmp2(tmp3);
          return tmp2;
        }
        ...
        _iter(arg0) {
          return outer1_80(arg0, this.options);
        }
        _cacheGet(arg0, arg1) {
          tmp = !this._cache;
          _cacheGetResult = !tmp;
        ...
        all(arg0) {
          ...
          if (arg0) {
            tmp9 = outer1_38;
            prototype2 = outer1_38.prototype;
            tmp10 = new.target;
            str3 = "all";
            tmp11 = new.target;
            tmp12 = arg0;
            tmp13 = new outer1_38("all", {}, arg0);
            tmp14 = tmp13;
          ...
          if (outer1_20(arg0)) {
            ...
            if (outer1_20(arg1)) {
              ...
              if (arg3) {
                ...
                tmp15 = obj;
                tmp16 = arg3;
                tmp17 = new outer1_38("between", obj, arg3);
                tmp18 = tmp17;
                ...
                if (false === _cacheGetResult) {
                  ...
                  str2 = "between";
                  tmp7 = obj;
                  tmp8 = new outer1_34("between", obj);
                  tmp9 = tmp8;
        ...
        before(arg0, arg1) {
          ...
          if (outer1_20(arg0)) {
            ...
            if (false === _cacheGetResult) {
              tmp7 = outer1_34;
              prototype2 = outer1_34.prototype;
              tmp8 = new.target;
              tmp9 = new.target;
              str3 = "before";
              tmp10 = obj;
              tmp11 = new outer1_34("before", obj);
              tmp12 = tmp11;
        ...
        toString() {
          return outer1_76(this.origOptions);
        }
        toText(arg0, arg1, arg2) {
          str = new outer1_43(this, arg0, arg1, arg2);
          return str.toString();
        }
        isFullyConvertibleToText() {
          return outer1_45(this);
        }
        clone() {
    ...
    let closure_63 = tmp49;
    let closure_64 = { dtstart: null, cache: false, unfold: false, forceset: false, compatible: false, tzid: null };
    let closure_65 = ((arg0) => {
      let closure_0 = arg0;
      class e {
        constructor(arg0) {
          ...
          tmp = closure_0.call(self, {}, flag) || self;
          tmp.dtstart = outer1_88.apply(tmp, ["dtstart"]);
          tmp.tzid = outer1_88.apply(tmp, ["tzid"]);
          tmp._rrule = [];
          tmp._rdate = [];
          tmp._exrule = [];
          tmp._exdate = [];
        ...
        _iter(arg0) {
          ...
          return ((accept, _rrule, _exrule, _rdate, _exdate, arg5) => {
            ...
            let closure_1 = _exrule;
            let closure_2 = arg5;
            const fn = function u(after, before) {
              let closure_0 = after;
              const _exrule = before;
              let item = _exrule.forEach(() => { ... });
            };
            let closure_3 = {};
            accept = accept.accept;
            let item = _exdate.forEach((arg0) => {
              closure_3[Number(new outer3_48(arg0, closure_2).rezonedDate())] = true;
            });
            accept.accept = function(arg0) {
              ...
              if (isNaN(NumberResult)) {
                ...
                let tmp3 = !dependencyMap[NumberResult];
                if (tmp3) {
                  const _Date = Date;
                  ...
                  fn(date, date1);
                  tmp3 = !dependencyMap[NumberResult];
                }
                callResult = !tmp3;
                if (tmp3) {
            ...
            let num = 0;
            if (0 < _rdate.length) {
              let prototype = outer2_48.prototype;
              const obj = new outer2_48(_rdate[num], arg5);
              let _Date = Date;
              let date = new Date(obj.rezonedDate().getTime());
              while (tmp8(date)) {
                num = num + 1;
            ...
            const item1 = _rrule.forEach((options) => {
              outer3_80(closure_0, options.options);
            });
        ...
        rrule(arg0) {
          tmp = outer1_89(arg0, this._rrule);
          return;
        }
        exrule(arg0) {
          tmp = outer1_89(arg0, this._exrule);
          return;
        }
        rdate(arg0) {
          tmp = outer1_90(arg0, this._rdate);
          return;
        }
        exdate(arg0) {
          tmp = outer1_90(arg0, this._exdate);
          return;
        }
        rrules() {
          _rrule = this._rrule;
          return _rrule.map((arg0) => outer2_85(arg0.toString()));
        }
        exrules() {
          _exrule = this._exrule;
          return _exrule.map((arg0) => outer2_85(arg0.toString()));
        }
        rdates() {
          _rdate = this._rdate;
        ...
        valueOf() {
          ...
          if (self._rdate.length) {
            ...
            tmp7 = outer1_91;
            str = "RDATE";
            arr = c0.push(outer1_91("RDATE", self._rdate, self.tzid()));
          }
          if (self._exdate.length) {
            tmp9 = c0;
            tmp10 = outer1_91;
            str2 = "EXDATE";
            arr1 = c0.push(outer1_91("EXDATE", self._exdate, self.tzid()));
          }
          return c0;
        }
        toString() {
