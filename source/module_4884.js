...
arg5.default = {
  read(dataView, sum) {
    ...
    let tmp8;
    if (5 <= shortAt) {
      const shortAt1 = tmp(4885).getShortAt(dataView, sum + 3);
      const obj2 = { value: null, description: null };
      obj2[0] = shortAt1;
      const _HermesInternal = HermesInternal;
      obj2[1] = "" + shortAt1 + "px";
      tmp8 = obj2;
      const tmpResult1 = tmp(4885);
    }
    obj1[1] = tmp8;
    let tmp11;
    if (7 <= shortAt) {
      const shortAt2 = tmp(4885).getShortAt(dataView, sum + 5);
      const obj3 = { value: null, description: null };
      obj3[0] = shortAt2;
      const _HermesInternal2 = HermesInternal;
      obj3[1] = "" + shortAt2 + "px";
      tmp11 = obj3;
      const tmpResult2 = tmp(4885);
    }
    obj1[2] = tmp11;
    obj1[3] = tmp4;
    let tmp14 = tmp4;
