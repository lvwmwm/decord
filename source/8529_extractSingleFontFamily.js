...
// Dependencies: [31, 33, 8523, 8528]
// Exports: default, setTSpan

// Module 8529 (extractSingleFontFamily)
import "result";
...
export default function extractText(children) {
  ...
  if ("string" !== typeof children) {
    ...
    obj.x = importDefault(8528)(tmp);
    obj.y = importDefault(8528)(tmp2);
    obj.dx = importDefault(8528)(tmp3);
    obj.dy = importDefault(8528)(tmp4);
    obj.rotate = importDefault(8528)(tmp5);
    return obj;
  }
  let tmp16 = null;
  if (arg1) {
