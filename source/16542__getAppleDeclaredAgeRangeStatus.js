...
// Dependencies: [5, 17, 4033, 16543, 16544, 16545]
// Exports: getAppleDeclaredAgeRangeStatus, getIsConsideredOlderThan, setAgeRangeThresholds

// Module 16542 (_getAppleDeclaredAgeRangeStatus)
import importDefaultResult from "module_16545";
...
export const setAgeRangeThresholds = (arg0) => {
  const ageRangeThresholdManager = callback(16543).ageRangeThresholdManager;
...
export const PlayAgeRangeDeclarationUserStatus = require("module_16545").PlayAgeRangeDeclarationUserStatus;
export const PlayAgeRangeDeclarationUserStatusString = require("module_16545").PlayAgeRangeDeclarationUserStatusString;
