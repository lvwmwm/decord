...
// Function ID: 57839
// Name: supportsFetch
// Dependencies: [6348, 6346, 6347]

// Module 6459 (supportsFetch)
const require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in require(6348) /* getGlobalSingleton */.GLOBAL_OBJ) {
...
arg5.supportsNativeFetch = function supportsNativeFetch() {
  if ("string" === typeof globalThis.EdgeRuntime) {
    ...
    if (isNativeFunction(require(6348) /* getGlobalSingleton */.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
...
arg5.supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in require(6348) /* getGlobalSingleton */.GLOBAL_OBJ;
};
