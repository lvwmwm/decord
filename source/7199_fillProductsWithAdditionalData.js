...
// Module 7199 (fillProductsWithAdditionalData)
...
export const fillProductsWithAdditionalData = () => {
  const callback = callback(async (arg0) => {
    let closure_0;
    if (closure_1) {
      closure_0 = { "Null": true, "Null": true, "Null": true, "Null": true, "Null": true, "Null": true, "Null": true, "Null": true, "Null": true, "Null": true, "Null": true }[yield closure_1.getUser(closure_1).userMarketplaceAmazon];
