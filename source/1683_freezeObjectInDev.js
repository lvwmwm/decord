...
// Dependencies: [32, 1656, 1684, 1664, 1678, 1669, 1657]
// Exports: makeShareableCloneOnUIRecursive

// Module 1683 (freezeObjectInDev)
...
let fn = function u() {
  const proxy = new Proxy({}, {
    get(arg0, arg1) {
      if ("_isReanimatedSharedValue" !== arg1) {
        if ("__remoteFunction" !== arg1) {
          ...
          const reanimatedError = new callback(1664).ReanimatedError("Trying to access property `" + String(arg1) + "` of an object which cannot be sent to the UI runtime.");
    ...
    set() {
      const reanimatedError = new callback(1664).ReanimatedError("Trying to write to an object which cannot be sent to the UI runtime.");
      throw reanimatedError;
    }
  });
  return proxy;
...
export const makeShareable = isJest ? (function makeShareableJS(arg0) {
  ...
  let closure_0 = arg0;
  const shareableMappingCache = require(1684) /* weakMap */.shareableMappingCache;
  if (shareableMappingCache.get(arg0)) {
    ...
    obj[0] = fn;
    const shareableMappingCache2 = tmp(1684).shareableMappingCache;
