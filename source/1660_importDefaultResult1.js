...
// Dependencies: [41, 42, 90, 91, 1650, 1661, 1656, 1645, 1637, 1662]
// Exports: createNativeReanimatedModule

// Module 1660 (importDefaultResult1)
...
const items = [
  ...
  },
  {
    ...
    value: function getViewProp(arg0, arg1, self) {
      self = this;
      if (obj.isFabric()) {
        const tmpResult = require(1662) /* getShadowNodeWrapperFromRef */;
        const shadowNodeWrapperFromRef = require(1662) /* getShadowNodeWrapperFromRef */.getShadowNodeWrapperFromRef(self);
