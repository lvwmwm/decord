...
// Dependencies: [32, 19, 17, 21, 1501, 6349, 6320, 6350, 6321, 6354]
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  ({ colors, fonts } = theme);
  let obj1 = require(1501) /* createStandardNavigationFactories */;
  ...
  return closure_7(require(6354) /* HeaderButton */.HeaderButton, obj);
};
