...
// Module 7521 (__INTERNAL_VIEW_CONFIG)
const _module = require(dependencyMap[0]);
_module(require(dependencyMap[1]));
let obj = { uiViewClassName: "RNCSlider", bubblingEventTypes: { topChange: { phasedRegistrationNames: {} }, topRNCSliderValueChange: { phasedRegistrationNames: {} } }, directEventTypes: { topRNCSliderSlidingStart: { registrationName: "onRNCSliderSlidingStart" }, topRNCSliderSlidingComplete: { registrationName: "onRNCSliderSlidingComplete" } } };
obj = {};
