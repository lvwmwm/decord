...
// Dependencies: [1281, 13474, 13475, 13539, 13546, 13551, 13566, 13567]

// Module 13473 (addLikelySubtags)
import e from "e";
...
function addLikelySubtags(locale) {
  ...
  let script;
  let variants;
  const parseUnicodeLocaleIdResult = require(13539) /* isStructurallyValidLanguageTag */.parseUnicodeLocaleId(locale);
