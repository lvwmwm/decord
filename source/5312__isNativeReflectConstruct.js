...
// Dependencies: [93, 95, 98, 42, 41, 5294, 5277]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      let obj = ContinousBaseGesture(5294);
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5277).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(5277);
      }
      return tmp;
    }
  }
