...
// Function ID: 9101
// Name: QRCode
// Dependencies: [9101, 9103, 9105, 9106, 9107]
...
prototype.addData = function(arg0) {
  ...
  dataList.push(new require(9101) /* QR8bitByte */(arg0));
  this.dataCache = null;
};
...
prototype.make = function() {
  ...
  if (this.typeNumber < 1) {
    while (true) {
      ...
      let obj = require(9103) /* QRRSBlock */;
      let rSBlocks = obj.getRSBlocks(num, self.errorCorrectLevel);
      let tmp3 = new.target;
      let tmp4 = new.target;
      let obj2 = new require(9105) /* QRBitBuffer */();
      let tmp5 = num;
      let num2 = 0;
      let num3 = 0;
      let num4 = 0;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = require(9106).getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = require(9106).getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = require(9106).getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
...
QRCode.createData = (arg0, arg1, arg2) => {
  ...
  let length2;
  let result1;
  const rSBlocks = require(9103) /* QRRSBlock */.getRSBlocks(arg0, arg1);
  const obj2 = new require(9105) /* QRBitBuffer */();
  let num = 0;
  if (0 < arg2.length) {
    do {
      let obj3 = arg2[num];
  ...
  const obj = require(9103) /* QRRSBlock */;
};
QRCode.createBytes = (arg0, arg1) => {
  ...
  if (0 < arg1.length) {
    do {
      ...
      let tmp16 = require(9107) /* QRPolynomial */;
