...
// Module 14596 (getInitialAuthScreen)
...
function NavigatorWithCaptchaHook() {
  ...
  if (tmp2) {
    ...
    items2[2] = obj6;
    obj4.style = items2;
    const obj7 = { ip: "FRAME_SET_PROXY_TICKET_REFRESHING", hash: "<string:1627463937>", sa: "<string:1361119231>", hash: "<string:809682045>", category: "<string:3187671617>", position: "<string:1358955081>", screens: closure_12, containerStyle: tmp3.cardContainer };
...
obj = { transparent: { backgroundColor: "transparent" }, cardContainer: {}, wideOuterContainer: { -9223372036854775808: 323420161, 0: -2104950783 } };
