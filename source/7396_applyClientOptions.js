...
// Dependencies: [7358, 7361, 7374, 7397, 7398, 7384, 7356, 7399, 7392, 7368]

// Module 7396 (applyClientOptions)
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = require(7356) /* isMatchingPattern */.truncate(environment.message, num);
  ...
  if (value) {
    iter.value = require(7356) /* isMatchingPattern */.truncate(iter.value, num);
  ...
  if (url) {
    request.url = require(7356) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(7356) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(7399).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = dependencyMap(7392).normalize(data.data, dependencyMap, dependencyMap);
                  data = obj;
                  const obj3 = dependencyMap(7392);
                }
