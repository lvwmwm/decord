...
({ useCallback, useEffect: closure_3, useState: closure_4, useMemo } = arg1(dependencyMap[1]));
  ...
  if (cResult[1] === arg0) {
    ...
    if (cResult[4] === arg0) {
      ...
      if (cResult[7] === arg0) {
        ...
        const disposableMemo = arg1(dependencyMap[3]).useDisposableMemo(tmp9, _temp, tmp10);
        if (cResult[10] === arg0) {
        ...
        function t4() {
          ...
          if (tmp) {
            ...
            const error = new Error("List property \"" + arg0 + "\" not found in the ViewModel instance");
            callback(error);
          }
        }
