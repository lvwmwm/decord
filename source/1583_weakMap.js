...
// Function ID: 1584
// Name: weakMap
// Dependencies: [32, 19, 17, 21, 1584, 1483, 1586, 1587, 1588, 1590, 1591, 1580]
...
export const NavigationContainer = importAllResult.forwardRef(function NavigationContainerInner(direction, ref) {
  ...
  if (DefaultTheme === undefined) {
    DefaultTheme = linking(1584).DefaultTheme;
  }
  ...
  const obj6 = linking(1590);
  [tmp20, initialState] = ref(linking(1590).useThenable(obj3.useLinking(ref, obj).getInitialState), 2);
  ...
  if (tmp22) {
    ...
    obj2.ref = ref;
    obj1[1] = tmp23(tmp12(1483).BaseNavigationContainer, obj2);
    obj[1] = tmp23(tmp12(1580).LinkingContext.Provider, obj1);
    let tmp24 = obj;
  } else {
    obj3 = { value: null, children: null };
    obj3[0] = DefaultTheme;
    obj3[1] = fallback;
    obj[1] = tmp23(tmp12(1483).ThemeProvider, obj3);
    tmp24 = obj;
  }
  return jsx(linking(1591).LocaleDirContext.Provider, tmp24);
});
