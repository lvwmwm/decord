...
arg5.isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4774) /* getFileChunk */.isAvifStringIncluded(fileChunk);
};
...
arg5.isHEIC = function isHEIC(fileChunk) {
  fileChunk = require(4774) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4775).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4774) /* getFileChunk */.isHeicSignatureIncluded(fileChunk);
};
