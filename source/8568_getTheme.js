...
// Function ID: 8569
// Name: getTheme
// Dependencies: [19, 17, 21, 8569, 8573]

// Module 8568 (getTheme)
...
export default require("noop").memo((theme) => {
  ...
  if (typeof getTextColor !== "error") {
    HermesBuiltin.throwTypeError();
  }
  if (typeof getTheme !== "error") {
    HermesBuiltin.throwTypeError();
  }
  if (theme.theme) {
    let str = theme.theme;
  ...
  obj.textColor = require(8573) /* colorToHex */.colorToHex(str3);
  let tmp4Result = tmp4(8573);
  if (typeof getDividerColor !== "error") {
    HermesBuiltin.throwTypeError();
  }
  ...
  tmp4Result = tmp4(8573);
  if (typeof getButtonColor !== "error") {
    HermesBuiltin.throwTypeError();
  }
