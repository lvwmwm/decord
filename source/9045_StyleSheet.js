...
// Function ID: 71112
// Name: StyleSheet
// Dependencies: [57, 31, 27, 33, 1457, 9046, 5526, 9047, 4479]
// Exports: default

// Module 9045 (StyleSheet)
...
export default function HeaderConfig(arg0) {
  ...
  let obj1 = require(9046) /* processFonts */;
  ...
  importDefault(9047)();
  let isSearchBarAvailableForCurrentPlatform = "boolean" === typeof require(4479) /* enableScreens */.isSearchBarAvailableForCurrentPlatform;
  if (isSearchBarAvailableForCurrentPlatform) {
    isSearchBarAvailableForCurrentPlatform = require(4479) /* enableScreens */.isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (require(4479) /* enableScreens */.isNewBackTitleImplementation) {
  ...
  if (null != headerLeftResult) {
    ...
    let tmp40Result = callback2(require(4479) /* enableScreens */.ScreenStackHeaderLeftView, obj5);
  ...
  if ("center" === headerTitleAlign) {
    ...
    tmp52Result = callback2(require(4479) /* enableScreens */.ScreenStackHeaderCenterView, obj8);
  ...
  if (undefined !== headerBackImageSource) {
    ...
    tmp58 = callback2(require(4479) /* enableScreens */.ScreenStackHeaderBackButtonImage, obj10);
  }
  items3[1] = tmp58;
  let tmp62 = null;
  if (null != headerRightResult) {
    const obj11 = { children: headerRightResult };
    tmp62 = callback2(require(4479) /* enableScreens */.ScreenStackHeaderRightView, obj11);
  }
  items3[2] = tmp62;
  let tmp66 = null;
  if (tmp19) {
    ...
    obj12.children = callback2(require(4479) /* enableScreens */.SearchBar, Object.assign({}, headerSearchBarOptions));
    tmp66 = callback2(require(4479) /* enableScreens */.ScreenStackHeaderSearchBarView, obj12);
  }
  items3[3] = tmp66;
  obj3.children = items3;
  return closure_9(require(4479) /* enableScreens */.ScreenStackHeaderConfig, obj3);
};
