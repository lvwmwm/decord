...
let closure_6 = arg1(dependencyMap[3]).createStyles((height) => {
  ...
  obj.wrapper = obj;
  const obj1 = { expand: "y", backgroundColor: "isArray", padding: "key", alignItems: "Array", experimental_useNativeText: "construct", borderRadius: importDefault(dependencyMap[4]).radii.round, height };
  obj.badge = obj1;
...
const memoResult = importAllResult.memo(function VoiceOrStageSummaryRow(arg0) {
  ...
  if (tmp6Result) {
    ...
    obj2.style = items3;
    const obj3 = { size: arg1(dependencyMap[7]).Icon.Sizes.CUSTOM, style: { <string:1140607356>: null, <string:1751293292>: null }, source: importDefault(dependencyMap[8]) };
