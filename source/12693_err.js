...
// Function ID: 98081
// Name: err
// Dependencies: [12694, 12690, 12695, 12696, 12697]

// Module 12693 (err)
const require = arg1;
const dependencyMap = arg6;
function err(state, arg1) {
  state.msg = require(12694)[arg1];
  return arg1;
}
...
function flush_block_only(state, arg1) {
  ...
  require(12695) /* zero */._tr_flush_block(state, num, state.strstart - state.block_start, arg1);
    ...
    if (0 === state.strm.avail_in) {
      ...
      if (0 === avail_in) {
        ...
        if (1 === strm.state.wrap) {
          ...
          let tmp19 = avail_in;
          let tmp20 = sum1;
          strm.adler = require(12696) /* adler32 */(strm.adler, _window, avail_in, sum1);
          ...
          let tmp14 = avail_in;
          let tmp15 = sum1;
          strm.adler = require(12697)(strm.adler, _window, avail_in, sum1);
        }
...
function DeflateState() {
  ...
  this.good_match = 0;
  this.nice_match = 0;
  const buf16 = new require(12690) /* _has */.Buf16(1146);
  this.dyn_ltree = buf16;
  const buf161 = new require(12690) /* _has */.Buf16(122);
  this.dyn_dtree = buf161;
  const buf162 = new require(12690) /* _has */.Buf16(78);
  this.bl_tree = buf162;
  zero(this.dyn_ltree);
  zero(this.dyn_dtree);
  zero(this.bl_tree);
  ...
  this.d_desc = null;
  this.bl_desc = null;
  const buf163 = new require(12690) /* _has */.Buf16(16);
  this.bl_count = buf163;
  const buf164 = new require(12690) /* _has */.Buf16(573);
  this.heap = buf164;
  zero(this.heap);
  this.heap_len = 0;
  this.heap_max = 0;
  const buf165 = new require(12690) /* _has */.Buf16(573);
  this.depth = buf165;
  zero(this.depth);
  this.l_buf = 0;
  this.lit_bufsize = 0;
...
function deflateResetKeep(state) {
  if (state) {
    if (state.state) {
      ...
      state.adler = num5;
      state.last_flush = 0;
      require(12695) /* zero */._tr_init(state);
      let num = 0;
      const obj = require(12695) /* zero */;
    }
    return num;
  }
  num = -2;
                ...
                if (num <= 9) {
                  if (strategy >= 0) {
                    if (strategy <= 4) {
                      ...
                      tmp4.window = buf8;
                      const Buf16 = require(12690) /* _has */.Buf16;
                      const prototype3 = Buf16.prototype;
                      const buf16 = new Buf16(tmp4.hash_size);
                      tmp4.head = buf16;
                      const Buf162 = require(12690) /* _has */.Buf16;
                      ...
                      const Buf82 = require(12690) /* _has */.Buf8;
              ...
              if (42 === state.status) {
                if (2 === state.wrap) {
                  ...
                  if (state.gzhead) {
                    ...
                    if (state.gzhead.hcrc) {
                      state.adler = require(12697)(state.adler, state.pending_buf, state.pending, 0);
                    }
                    state.gzindex = 0;
                    state.status = 69;
                ...
                if (state.gzhead.extra) {
                  ...
                  if (state.gzindex < (65535 & state.gzhead.extra.length)) {
                    if (state.pending !== state.pending_buf_size) {
                      ...
                      while (state.gzindex < (65535 & state.gzhead.extra.length)) {
                        if (state.pending !== state.pending_buf_size) {
                          ...
                          if (tmp46) {
                            ...
                            let num44 = 4;
                            let tmp49 = tmp45;
                            state.adler = require(12697)(state.adler, state.pending_buf, state.pending - tmp45, tmp45);
                          }
                      ...
                      if (tmp36) {
                        state.adler = require(12697)(state.adler, state.pending_buf, state.pending - pending, pending);
                      }
                      flush_pending(state);
                      pending2 = state.pending;
                  ...
                  if (tmp52) {
                    state.adler = require(12697)(state.adler, state.pending_buf, state.pending - pending2, pending2);
                  }
                  ...
                  while (true) {
                    ...
                    if (state.pending !== state.pending_buf_size) {
                      ...
                      if (tmp57) {
                        ...
                        let tmp60 = pending3;
                        state.adler = require(12697)(state.adler, state.pending_buf, state.pending - pending3, pending3);
                      }
                    ...
                    if (tmp66) {
                      ...
                      let tmp69 = pending4;
                      state.adler = require(12697)(state.adler, state.pending_buf, state.pending - pending4, pending4);
                    }
                    if (0 === num52) {
                      state.gzindex = 0;
                      let num54 = 91;
                  ...
                  while (true) {
                    ...
                    if (state.pending !== state.pending_buf_size) {
                      ...
                      if (tmp71) {
                        ...
                        let tmp74 = pending5;
                        state.adler = require(12697)(state.adler, state.pending_buf, state.pending - pending5, pending5);
                      }
                    ...
                    if (tmp80) {
                      ...
                      let tmp83 = pending6;
                      state.adler = require(12697)(state.adler, state.pending_buf, state.pending - pending6, pending6);
                    }
                    if (0 === num60) {
                      let num62 = 103;
                      state.status = 103;
                ...
                if (3 !== funcResult) {
                  if (2 === funcResult) {
                    if (1 === last_flush) {
                      diff = require;
                      diff = dependencyMap;
                      diff = require(12695) /* zero */._tr_align(state);
                      const obj6 = require(12695) /* zero */;
                    } else if (5 !== last_flush) {
                      diff = require;
                      diff = dependencyMap;
                      const obj5 = require(12695) /* zero */;
                      diff = obj5;
                      diff = state;
    ...
    if (strm.state) {
      ...
      if (2 !== wrap) {
        if (1 !== wrap) {
          if (!state.lookahead) {
            if (tmp24) {
              strm.adler = require(12696) /* adler32 */(strm.adler, dictionary, length, 0);
            }
            state.wrap = 0;
            let tmp5 = dictionary;
            let w_size = length;
