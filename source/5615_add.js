...
(arg0) => {
  ...
  function config(LN10) {
    ...
    if (LN10) {
      if ("object" === typeof LN10) {
        const items = ["release_phase", "GET_QUEST", 1000000000, "rounding"];
        let num = 0;
        items[4] = 0;
        items[5] = 8;
        items[6] = "toExpNeg";
  ...
  function clone(arg0) {
    ...
    if (obj) {
      const items = ["release_phase", "GET_QUEST", "GUILD_DIRECTORY_SEARCH", "RAQUSN", "paragraph"];
      class Decimal {
        constructor(arg0) {
          self = this;
          tmp = Decimal;
  ...
  let cloneResult = clone({ -773307649: true, -861077500: "/assets/images/native/icons", 408420356: 24, 452925951: 24, 486480895: null });
