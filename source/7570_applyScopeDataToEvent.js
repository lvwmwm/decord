...
// Dependencies: [7545, 7526, 7525, 7556]

// Module 7570 (applyScopeDataToEvent)
const require = arg1;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  const dropUndefinedKeysResult3 = require(7526) /* addNonEnumerableProperty */.dropUndefinedKeys(contexts);
  ...
  if (span) {
    ...
    obj3[0] = tmp3(7525).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(7525);
    obj4[0] = tmp3(7556).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(7556);
    const rootSpan = tmp3(7525).getRootSpan(span);
    const tmp3Result4 = tmp3(7525);
    const description = tmp3(7525).spanToJSON(rootSpan).description;
...
arg5.mergeAndOverwriteScopeData = function mergeAndOverwriteScopeData(arg0, arg1, arg2) {
  arg0[arg1] = require(7545) /* merge */.merge(arg0[arg1], arg2, 1);
};
arg5.mergeScopeData = function mergeScopeData(extra) {
  ...
  let obj = require(7545) /* merge */;
  extra.extra = obj.merge(extra.extra, extra, 1);
  extra.tags = require(7545) /* merge */.merge(extra.tags, tags, 1);
  const obj2 = require(7545) /* merge */;
  extra.user = require(7545) /* merge */.merge(extra.user, user, 1);
  const obj3 = require(7545) /* merge */;
  extra.contexts = require(7545) /* merge */.merge(extra.contexts, contexts, 1);
  const obj4 = require(7545) /* merge */;
  extra.sdkProcessingMetadata = require(7545) /* merge */.merge(extra.sdkProcessingMetadata, sdkProcessingMetadata, 2);
  if (level) {
    extra.level = level;
  }
  if (transactionName) {
