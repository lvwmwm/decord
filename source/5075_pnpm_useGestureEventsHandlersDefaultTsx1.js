...
// Module 5075 (pnpm_useGestureEventsHandlersDefaultTsx1)
const _module = require(dependencyMap[0]);
const Platform = _module.Platform;
const obj = { 0: "P", 9223372036854775807: "DISPLAY_MEDIA_UPLOADS", 9223372036854775807: "%ErrorPrototype%", initialKeyboardState: require(dependencyMap[1]).KEYBOARD_STATE.UNDETERMINED };
