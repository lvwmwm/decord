...
// Function ID: 100178
// Name: coerce
// Dependencies: [12883, 12887, 12882]
...
export default function coerce(arg0, arg1) {
  ...
  if (arg0 instanceof require(12883) /* SemVer */) {
    ...
    if ("string" !== typeof StringResult) {
      ...
      if (obj.rtl) {
        const safeRe2 = require(12887) /* items */.safeRe;
        const t2 = require(12887) /* items */.t;
        ...
        const safeRe = require(12887) /* items */.safeRe;
      ...
      if (null === match2) {
        ...
        return require(12882) /* parse */("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str4 + str6, obj);
      }
    }
  }
};
