...
function getCommonStyles(arg0) {
  ...
  if ("left" === snapDirection) {
    ...
    let interpolateResult = require(1634) /* cancelAnimation */.interpolate(value, items2, items3);
    ...
    result = Math.floor(10000 * require(1634) /* cancelAnimation */.interpolate(value, items4, items5)) / 100;
    ...
    interpolateResult = require(1634) /* cancelAnimation */.interpolate(value, items6, items7);
