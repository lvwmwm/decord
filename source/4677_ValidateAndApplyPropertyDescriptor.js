...
// Dependencies: [4678, 4611, 541, 4658, 4662, 4675, 4665, 4666, 4667, 4668, 4679, 4680]

// Module 4677 (ValidateAndApplyPropertyDescriptor)

export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, flag, __Configurable__) {
  const tmp3 = require(4678) /* Type */(arg0);
  if (undefined !== arg0) {
    if (!tmp(4611)(arg0)) {
  ...
  if (require(4658) /* isPropertyKey */(arg1)) {
