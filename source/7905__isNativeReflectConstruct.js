...
// Module 7905 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(7907)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(7908)(tmp, tmp, this);
      ...
      if (transform) {
        ...
        tmp.transform = self(7909).extractTransformSvgView(tmp);
        const obj3 = self(7909);
      }
      obj = {};
      ...
      obj.children = jsx(importDefault(7915), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(7913), {});
    }
  }
];
