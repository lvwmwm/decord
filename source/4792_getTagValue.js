...
const obj = { handleComponent: null, handleDisabled: null, dismissAccessibilityLabel: null };
arg5.default = {
  get(arg0, arg1) {
    let obj = {};
    ...
    if (tmp7) {
      let flag = false;
      if (tmp7) {
        obj = { value: tmp7, description: arg2(arg6[0]).FocalLengthIn35mmFilm(tmp7) };
