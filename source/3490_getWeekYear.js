...
export default function getWeekYear(defaultResult1, firstWeekContainsDate) {
  ...
  defaultResult1 = closure_3.default(defaultResult1);
  ...
  const defaultResult2 = closure_4.default(num);
  if (defaultResult2 >= 1) {
    if (defaultResult2 <= 7) {
      const _Date = Date;
      ...
      const defaultResult3 = closure_2.default(date, firstWeekContainsDate);
