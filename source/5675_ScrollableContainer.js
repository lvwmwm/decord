...
// Dependencies: [19, 21, 5676, 5677, 5679]

// Module 5675 (ScrollableContainer)
import "noop";
...
export const ScrollableContainer = require("noop").forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  const tmp6 = jsx(require(5676) /* BottomSheetDraggableScrollable */.BottomSheetDraggableScrollable, { ref });
  let tmp2Result = tmp6;
  if (onRefresh) {
    ...
    obj[3] = onRefresh;
    obj[4] = require(5679) /* styles */.styles.container;
    obj[5] = tmp6;
    tmp2Result = jsx(importDefault(5677), { scrollableGesture: null, refreshing: null, progressViewOffset: null, onRefresh: null, style: null, children: null });
    const tmp9 = importDefault(5677);
  }
  return tmp2Result;
});
