...
// Dependencies: [7465, 7468, 7481, 7504, 7505, 7491, 7463, 7506, 7499, 7475]

// Module 7503 (applyClientOptions)
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (!DEFAULT_ENVIRONMENT) {
    DEFAULT_ENVIRONMENT = require(7491).DEFAULT_ENVIRONMENT;
  }
  ...
  if (environment.message) {
    environment.message = require(7463) /* isMatchingPattern */.truncate(environment.message, num);
    const obj = require(7463) /* isMatchingPattern */;
  }
  let value = iter;
  ...
  if (value) {
    iter.value = require(7463) /* isMatchingPattern */.truncate(iter.value, num);
    const obj2 = require(7463) /* isMatchingPattern */;
  }
  ...
  if (url) {
    request.url = require(7463) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(7463) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(7506).getFilenameToDebugIdMap(arg1);
  try {
