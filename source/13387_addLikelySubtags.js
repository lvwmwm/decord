...
// Dependencies: [1281, 13388, 13389, 13453, 13460, 13465, 13480, 13481]

// Module 13387 (addLikelySubtags)
import e from "e";
...
function addLikelySubtags(locale) {
  ...
  let script;
  let variants;
  const parseUnicodeLocaleIdResult = require(13453) /* isStructurallyValidLanguageTag */.parseUnicodeLocaleId(locale);
