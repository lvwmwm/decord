...
// Function ID: 5036
// Name: parseTags
// Dependencies: [4994, 5036]

// Module 5035 (parseTags)
const require = arg1;
...
function parseTags(buffer) {
  ...
  if (buffer.byteLength !== buffer.getUint32()) {
    ...
    const keys = Object.keys(require(5036).iccProfile);
    for (let num = 0; num < keys.length; num = num + 1) {
      let tmp = keys[num];
      let tmp2 = require;
      let tmp3 = dependencyMap;
      let iter = require(5036).iccProfile[tmp];
      ...
      if (buffer.length < 132) {
        ...
        if (0 < uint32) {
          while (buffer.length >= num6 + c8) {
            ...
            let obj17 = require(4994) /* getDataView */;
                ...
                if (stringFromDataView1 === mluc) {
                  ...
                  if (0 < uint324) {
                    do {
                      ...
                      let obj5 = require(4994) /* getDataView */;
                      let stringFromDataView2 = obj5.getStringFromDataView(buffer, sum, 2);
                      let obj6 = require(4994) /* getDataView */;
                      ...
                      let obj7 = require(4994) /* getDataView */;
                  ...
                  if (1 === uint324) {
                    ...
                    if (require(5036).iccTags[stringFromDataView]) {
...
arg5.default = {
  read(buffer, arr) {
    if (arg2) {
      if (arr[0].compressionMethod !== require(4994) /* getDataView */.COMPRESSION_METHOD_NONE) {
