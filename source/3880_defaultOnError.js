...
function defaultOnError(message) {
  return console.error("[" + require(3881).RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp15 = jsx(_require(3862).NitroRiveView, Object.assign({}, tmp3, obj1));
  cResult[12] = tmp3;
  cResult[13] = tmp12;
  cResult[14] = tmp13;
  cResult[15] = tmp15;
