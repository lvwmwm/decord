// Module ID: 5149
// Function ID: 5150
// Dependencies: [5109, 5124, 5125, 5121, 5104]
    ...
    if (ifd.MPEntry) {
      ...
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let tmp10 = num13;
          if (byteOrder === module(5109).LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
        ...
        const typeSize4 = module(5121).getTypeSize("LONG");
        if (byteOrder === module(5109).LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
