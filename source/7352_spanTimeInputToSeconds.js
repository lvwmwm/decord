...
// Dependencies: [7353, 7357, 7359, 7361, 7362, 7363, 7364, 7365, 7366, 7369, 7374, 7347]

// Module 7352 (spanTimeInputToSeconds)
const require = arg1;
  ...
  if (typeof num === "number") {
    ...
    if (Array.isArray(num)) {
      ...
      if (num instanceof Date) {
        ...
        sum = require(7361) /* dateTimestampInSeconds */.timestampInSeconds();
        const obj = require(7361) /* dateTimestampInSeconds */;
      }
    }
  }
  return sum;
  ...
  if ((function spanIsSentrySpan(getSpanJSON) {
    ...
    try {
      ...
      if ((function spanIsOpenTelemetrySdkTraceBaseSpan(attributes) {
        ...
        obj[10] = require(7363) /* getMetricSummaryJsonForSpan */.getMetricSummaryJsonForSpan(getSpanJSON);
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== require(7364) /* getSpanStatusFromHttpCode */.SPAN_STATUS_UNSET) {
      let str = "ok";
...
arg5.addChildSpanToSpan = function addChildSpanToSpan(arg0, arg1) {
  ...
  const result = require(7353) /* addNonEnumerableProperty */.addNonEnumerableProperty(arg1, _sentryRootSpan, tmp2);
  if (arg0[_sentryChildSpans]) {
    ...
    const result1 = require(7353) /* addNonEnumerableProperty */.addNonEnumerableProperty(arg0, tmp6, set);
    const tmp3Result = require(7353) /* addNonEnumerableProperty */;
  }
};
arg5.getActiveSpan = function getActiveSpan() {
  ...
  const asyncContextStrategy = require(7366) /* getAsyncContextStrategy */.getAsyncContextStrategy(mainCarrier);
...
arg5.showSpanDropWarning = function showSpanDropWarning() {
  if (!c2) {
    require(7347) /* consoleSandbox */.consoleSandbox(() => {
      console.warn("[Sentry] Deprecation warning: Returning null from `beforeSendSpan` will be disallowed from SDK version 9.0.0 onwards. The callback will only support mutating spans. To drop certain spans, configure the respective integrations directly.");
    });
    c2 = true;
    const obj = require(7347) /* consoleSandbox */;
  }
};
...
arg5.spanToTraceContext = function spanToTraceContext(spanContext) {
  ...
  if (isRemote) {
    span_id = require(7357) /* generatePropagationContext */.generateSpanId();
    const obj = require(7357) /* generatePropagationContext */;
  }
  return require(7353) /* addNonEnumerableProperty */.dropUndefinedKeys({ parent_span_id, span_id, trace_id: trace_id.traceId });
};
arg5.spanToTraceHeader = function spanToTraceHeader(spanContext) {
  ...
  return require(7359) /* regExp */.generateSentryTraceHeader(traceId, spanId, 1 === spanContext.spanContext().traceFlags);
};
arg5.spanToTransactionTraceContext = function spanToTransactionTraceContext(spanContext) {
  ...
  return require(7353) /* addNonEnumerableProperty */.dropUndefinedKeys({ parent_span_id, span_id, trace_id, data, op, status, origin });
};
