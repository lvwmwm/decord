// Module ID: 13220
// Function ID: 13221
// Dependencies: [13183, 13212, 13203, 13208, 13204, 13207, 13214, 13211]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13183)(arg0, arg3);
  const tmp4 = new _require(13212)(arg1, arg3);
  if (">" === arg2) {
  ...
  if (_require(13214)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
    if (0 < tmp4.set.length) {
      while (true) {
        ...
        let item = arr.forEach((semver) => {
          let tmp = semver;
          if (semver.semver === require(13211) /* Comparator */.ANY) {
            tmp = new require(13211) /* Comparator */(">=0.0.0");
          }
          let tmp6 = _null;
          if (!_null) {
            tmp6 = tmp;
