...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 7881, 7882, 7883, 7884, 7888, 7889, 7890, 7900]
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(7882)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(7883)(tmp, tmp, this);
      ...
      if (transform) {
        ...
        tmp.transform = self(7884).extractTransformSvgView(tmp);
        const obj3 = self(7884);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(7889)({ viewBox, preserveAspectRatio }));
      obj.children = jsx(importDefault(7890), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(7888), {});
    }
  }
];
