...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7915, 7919, 7920, 7852, 7861]

// Module 7918 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = importDefault(7915)[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = importDefault(7915)[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
