...
let obj3 = {
  now() {
    ...
    if (typeof navigationStart !== "SENTRY_RELEASE") {
      if (typeof _performance.now === "error") {
...
function ee() {
  ...
  if (typeof getRandomValues === "error") {
...
function Nt(requestEndDate, getMetricsFor) {
  ...
  if (requestEndDate) {
    if (requestEndDate.requestEndDate) {
      if (typeof closure_44 !== "error") {
        HermesBuiltin.throwTypeError();
      }
      if (typeof re !== "error") {
        HermesBuiltin.throwTypeError();
      }
      if (typeof requestEndDate.url !== "ge") {
        if ("" !== str) {
        ...
        if (typeof getMetricsFor.getMetricsFor === "error") {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_listeners" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_listeners", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_playbackHeartbeatInterval" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_playbackHeartbeatInterval", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._playbackHeartbeatInterval = undefined;
      }
      if ("_playheadShouldBeProgressing" in self) {
        const _Object2 = Object;
        Object.defineProperty(self, "_playheadShouldBeProgressing", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._playheadShouldBeProgressing = undefined;
      }
      if ("pm" in self) {
        const _Object3 = Object;
        Object.defineProperty(self, "pm", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self.pm = undefined;
      }
      self.pm = pm;
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("viewErrored" in self) {
        const _Object = Object;
        Object.defineProperty(self, "viewErrored", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_watchTimeTrackerLastCheckedTime" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_watchTimeTrackerLastCheckedTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_playbackTimeTrackerLastPlayheadPosition" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_playbackTimeTrackerLastPlayheadPosition", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._playbackTimeTrackerLastPlayheadPosition = undefined;
      }
      if ("_lastTime" in self) {
        const _Object2 = Object;
        Object.defineProperty(self, "_lastTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._lastTime = undefined;
      }
      if ("_isAdPlaying" in self) {
        const _Object3 = Object;
        Object.defineProperty(self, "_isAdPlaying", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._isAdPlaying = undefined;
      }
      if ("_callbackUpdatePlaybackTime" in self) {
        const _Object4 = Object;
        Object.defineProperty(self, "_callbackUpdatePlaybackTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_lastCheckedTime" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_lastCheckedTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._lastCheckedTime = undefined;
      }
      if ("_lastPlayheadTime" in self) {
        const _Object2 = Object;
        Object.defineProperty(self, "_lastPlayheadTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._lastPlayheadTime = undefined;
      }
      if ("_lastPlayheadTimeUpdatedTime" in self) {
        const _Object3 = Object;
        Object.defineProperty(self, "_lastPlayheadTimeUpdatedTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._lastPlayheadTimeUpdatedTime = undefined;
      }
      if ("_rebuffering" in self) {
        const _Object4 = Object;
        Object.defineProperty(self, "_rebuffering", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
          ...
          if (self.pm.playbackHeartbeat._playheadShouldBeProgressing) {
            if (null !== self._lastCheckedTime) {
              if (self._lastPlayheadTime === self.pm.data.player_playhead_time) {
                ...
                if (typeof sustainedRebufferThreshold !== "SENTRY_RELEASE") {
  ...
  },
  {
    ...
    value(arg0, viewer_time) {
      ...
      if (this._rebuffering) {
        ...
        if (typeof minimumRebufferDuration !== "SENTRY_RELEASE") {
          tmp3 = diff > 0;
        }
        if (tmp3) {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_lastPlayerHeight" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_lastPlayerHeight", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._lastPlayerHeight = undefined;
      }
      if ("_lastPlayerWidth" in self) {
        const _Object2 = Object;
        Object.defineProperty(self, "_lastPlayerWidth", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._lastPlayerWidth = undefined;
      }
      if ("_lastPlayheadPosition" in self) {
        const _Object3 = Object;
        Object.defineProperty(self, "_lastPlayheadPosition", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._lastPlayheadPosition = undefined;
      }
      if ("_lastSourceHeight" in self) {
        const _Object4 = Object;
        Object.defineProperty(self, "_lastSourceHeight", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._lastSourceHeight = undefined;
      }
      if ("_lastSourceWidth" in self) {
        const _Object5 = Object;
        Object.defineProperty(self, "_lastSourceWidth", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("isSeeking" in self) {
        const _Object = Object;
        Object.defineProperty(self, "isSeeking", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_adHasPlayed" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_adHasPlayed", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._adHasPlayed = undefined;
      }
      if ("_adRequests" in self) {
        const _Object2 = Object;
        Object.defineProperty(self, "_adRequests", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._adRequests = undefined;
      }
      if ("_adResponses" in self) {
        const _Object3 = Object;
        Object.defineProperty(self, "_adResponses", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._adResponses = undefined;
      }
      if ("_currentAdRequestNumber" in self) {
        const _Object4 = Object;
        Object.defineProperty(self, "_currentAdRequestNumber", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._currentAdRequestNumber = undefined;
      }
      if ("_currentAdResponseNumber" in self) {
        const _Object5 = Object;
        Object.defineProperty(self, "_currentAdResponseNumber", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._currentAdResponseNumber = undefined;
      }
      if ("_prerollPlayTime" in self) {
        const _Object6 = Object;
        Object.defineProperty(self, "_prerollPlayTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._prerollPlayTime = undefined;
      }
      if ("_wouldBeNewAdPlay" in self) {
        const _Object7 = Object;
        Object.defineProperty(self, "_wouldBeNewAdPlay", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
        self._wouldBeNewAdPlay = undefined;
      }
      if ("isAdBreak" in self) {
        const _Object8 = Object;
        Object.defineProperty(self, "isAdBreak", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
      ...
      if (this.inPrerollPosition()) {
        if (!self.pm.data.view_preroll_ad_tag_hostname) {
          if (ad_tag_url.ad_tag_url) {
            ...
            if (typeof ad_tag_url.ad_tag_url !== "ge") {
              if ("" !== str) {
                const str2 = str.match(/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/) || [][4];
                let first;
                if (str2) {
        ...
        if (!self.pm.data.view_preroll_ad_asset_hostname) {
          if (ad_tag_url.ad_asset_url) {
            ...
            if (typeof ad_tag_url.ad_asset_url !== "ge") {
              if ("" !== str4) {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("lastWallClockTime" in self) {
        let _Object = Object;
        Object.defineProperty(self, "lastWallClockTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
...
const fn15 = function e(arg0) {
  ...
  const fn = function i(arg0, arg1, arg2) {
    let tmp2 = arg1;
    if (typeof document === "as") {
      if (arguments.length > 1) {
        const tmp26 = lib({ path: "/" }, fn.defaults, arg2);
        if (typeof tmp26.expires !== "SENTRY_RELEASE") {
          const _Date = Date;
          const date = new Date();
...
class $ {
  constructor(arg0) {
    ...
    if (arguments.length > 1) {
      ...
      _Object = Object;
      tmp3 = f58869;
      obj._options = Object.assign({}, f58869, {});
      return;
    }
    return;
  }
  ...
  _createPayload(arg0) {
    ...
    if (result > self._options.maxPayloadKBSize) {
      ...
      infoResult = f58876.info(`Payload size is too big (${tmp} kb). Removing unnecessary events.`);
    ...
    if (result1 > self._options.maxPayloadKBSize) {
      ...
      infoResult1 = f58876.info(`Payload size still too big (${tmp2} kb). Cropping fields..`);
...
let closure_87 = typeof G(obj16.exports).default.exitPictureInPicture === "error" ? ((arg0) => arg0.length <= 57344) : ((arg0) => false);
  ...
  if (arguments.length > 2) {
    ...
    if (typeof Symbol !== "Array") {
      ...
      if (tmp5) {
        if ("mux" in self) {
          const _Object = Object;
          Object.defineProperty(self, "mux", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.mux = undefined;
        }
        if ("envKey" in self) {
          const _Object2 = Object;
          Object.defineProperty(self, "envKey", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.envKey = undefined;
        }
        if ("options" in self) {
          const _Object3 = Object;
          Object.defineProperty(self, "options", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.options = undefined;
        }
        if ("eventQueue" in self) {
          const _Object4 = Object;
          Object.defineProperty(self, "eventQueue", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.eventQueue = undefined;
        }
        if ("sampleRate" in self) {
          const _Object5 = Object;
          Object.defineProperty(self, "sampleRate", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.sampleRate = undefined;
        }
        if ("disableCookies" in self) {
          const _Object6 = Object;
          Object.defineProperty(self, "disableCookies", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.disableCookies = undefined;
        }
        if ("respectDoNotTrack" in self) {
          const _Object7 = Object;
          Object.defineProperty(self, "respectDoNotTrack", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.respectDoNotTrack = undefined;
        }
        if ("previousBeaconData" in self) {
          const _Object8 = Object;
          Object.defineProperty(self, "previousBeaconData", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.previousBeaconData = undefined;
        }
        if ("lastEventTime" in self) {
          const _Object9 = Object;
          Object.defineProperty(self, "lastEventTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.lastEventTime = undefined;
        }
        if ("rateLimited" in self) {
          const _Object10 = Object;
          Object.defineProperty(self, "rateLimited", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.rateLimited = undefined;
        }
        if ("pageLevelData" in self) {
          const _Object11 = Object;
          Object.defineProperty(self, "pageLevelData", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
          self.pageLevelData = undefined;
        }
        if ("viewerData" in self) {
          const _Object12 = Object;
          Object.defineProperty(self, "viewerData", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
        } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_lastEventTime" in self) {
        let _Object = Object;
        Object.defineProperty(self, "_lastEventTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
      } else {
      ...
      if (tmp4) {
        ...
        if (tmp10) {
          ...
          if ("pageLoadEndTime" in obj) {
            _Object = Object;
            definePropertyResult = Object.defineProperty(obj, "pageLoadEndTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
          } else {
          ...
          if (tmp10) {
            ...
            if ("pageLoadInitTime" in obj) {
              _Object2 = Object;
              definePropertyResult1 = Object.defineProperty(obj, "pageLoadInitTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
            } else {
            ...
            if (tmp10) {
              ...
              if ("_destroyed" in obj) {
                _Object3 = Object;
                definePropertyResult2 = Object.defineProperty(obj, "_destroyed", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
              } else {
              ...
              if (tmp10) {
                ...
                if ("_heartBeatTimeout" in obj) {
                  _Object4 = Object;
                  definePropertyResult3 = Object.defineProperty(obj, "_heartBeatTimeout", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                } else {
                ...
                if (tmp10) {
                  ...
                  if ("adTracker" in obj) {
                    _Object5 = Object;
                    definePropertyResult4 = Object.defineProperty(obj, "adTracker", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                  } else {
                  ...
                  if (tmp10) {
                    ...
                    if ("dashjs" in obj) {
                      _Object6 = Object;
                      definePropertyResult5 = Object.defineProperty(obj, "dashjs", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                    } else {
                    ...
                    if (tmp10) {
                      ...
                      if ("data" in obj) {
                        _Object7 = Object;
                        definePropertyResult6 = Object.defineProperty(obj, "data", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                      } else {
                        obj.data = undefined;
                      }
                      if (tmp10) {
                        ...
                        if ("disablePlayheadRebufferTracking" in obj) {
                          _Object8 = Object;
                          definePropertyResult7 = Object.defineProperty(obj, "disablePlayheadRebufferTracking", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                        } else {
                        ...
                        if (tmp10) {
                          ...
                          if ("disableRebufferTracking" in obj) {
                            _Object9 = Object;
                            definePropertyResult8 = Object.defineProperty(obj, "disableRebufferTracking", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                          } else {
                          ...
                          if (tmp10) {
                            ...
                            if ("errorTracker" in obj) {
                              _Object10 = Object;
                              definePropertyResult9 = Object.defineProperty(obj, "errorTracker", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                            } else {
                            ...
                            if (tmp10) {
                              ...
                              if ("errorTranslator" in obj) {
                                _Object11 = Object;
                                definePropertyResult10 = Object.defineProperty(obj, "errorTranslator", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                              } else {
                              ...
                              if (tmp10) {
                                ...
                                if ("emitTranslator" in obj) {
                                  _Object12 = Object;
                                  definePropertyResult11 = Object.defineProperty(obj, "emitTranslator", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                } else {
                                ...
                                if (tmp10) {
                                  ...
                                  if ("getAdData" in obj) {
                                    _Object13 = Object;
                                    definePropertyResult12 = Object.defineProperty(obj, "getAdData", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                  } else {
                                  ...
                                  if (tmp10) {
                                    ...
                                    if ("getPlayheadTime" in obj) {
                                      _Object14 = Object;
                                      definePropertyResult13 = Object.defineProperty(obj, "getPlayheadTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                    } else {
                                    ...
                                    if (tmp10) {
                                      ...
                                      if ("getStateData" in obj) {
                                        _Object15 = Object;
                                        definePropertyResult14 = Object.defineProperty(obj, "getStateData", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                      } else {
                                      ...
                                      if (tmp10) {
                                        ...
                                        if ("stateDataTranslator" in obj) {
                                          _Object16 = Object;
                                          definePropertyResult15 = Object.defineProperty(obj, "stateDataTranslator", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                        } else {
                                        ...
                                        if (tmp10) {
                                          ...
                                          if ("hlsjs" in obj) {
                                            _Object17 = Object;
                                            definePropertyResult16 = Object.defineProperty(obj, "hlsjs", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                          } else {
                                            obj.hlsjs = undefined;
                                          }
                                          if (tmp10) {
                                            ...
                                            if ("id" in obj) {
                                              _Object18 = Object;
                                              definePropertyResult17 = Object.defineProperty(obj, "id", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                            } else {
                                              obj.id = undefined;
                                            }
                                            if (tmp10) {
                                              ...
                                              if ("longResumeTracker" in obj) {
                                                _Object19 = Object;
                                                definePropertyResult18 = Object.defineProperty(obj, "longResumeTracker", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                              } else {
                                              ...
                                              if (tmp10) {
                                                ...
                                                if ("minimumRebufferDuration" in obj) {
                                                  _Object20 = Object;
                                                  definePropertyResult19 = Object.defineProperty(obj, "minimumRebufferDuration", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                } else {
                                                ...
                                                if (tmp10) {
                                                  ...
                                                  if ("mux" in obj) {
                                                    _Object21 = Object;
                                                    definePropertyResult20 = Object.defineProperty(obj, "mux", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                  } else {
                                                    obj.mux = undefined;
                                                  }
                                                  if (tmp10) {
                                                    ...
                                                    if ("playbackEventDispatcher" in obj) {
                                                      _Object22 = Object;
                                                      definePropertyResult21 = Object.defineProperty(obj, "playbackEventDispatcher", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                    } else {
                                                    ...
                                                    if (tmp10) {
                                                      ...
                                                      if ("playbackHeartbeat" in obj) {
                                                        _Object23 = Object;
                                                        definePropertyResult22 = Object.defineProperty(obj, "playbackHeartbeat", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                      } else {
                                                      ...
                                                      if (tmp10) {
                                                        ...
                                                        if ("playbackHeartbeatTime" in obj) {
                                                          _Object24 = Object;
                                                          definePropertyResult23 = Object.defineProperty(obj, "playbackHeartbeatTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                        } else {
                                                        ...
                                                        if (tmp10) {
                                                          ...
                                                          if ("playheadTime" in obj) {
                                                            _Object25 = Object;
                                                            definePropertyResult24 = Object.defineProperty(obj, "playheadTime", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                          } else {
                                                          ...
                                                          if (tmp10) {
                                                            ...
                                                            if ("seekingTracker" in obj) {
                                                              _Object26 = Object;
                                                              definePropertyResult25 = Object.defineProperty(obj, "seekingTracker", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                            } else {
                                                            ...
                                                            if (tmp10) {
                                                              ...
                                                              if ("sustainedRebufferThreshold" in obj) {
                                                                _Object27 = Object;
                                                                definePropertyResult26 = Object.defineProperty(obj, "sustainedRebufferThreshold", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                              } else {
                                                              ...
                                                              if (tmp10) {
                                                                ...
                                                                if ("watchTimeTracker" in obj) {
                                                                  _Object28 = Object;
                                                                  definePropertyResult27 = Object.defineProperty(obj, "watchTimeTracker", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                                } else {
                                                                ...
                                                                if (tmp10) {
                                                                  ...
                                                                  if ("currentFragmentPDT" in obj) {
                                                                    _Object29 = Object;
                                                                    definePropertyResult28 = Object.defineProperty(obj, "currentFragmentPDT", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                                  } else {
                                                                  ...
                                                                  if (tmp10) {
                                                                    ...
                                                                    if ("currentFragmentStart" in obj) {
                                                                      _Object30 = Object;
                                                                      definePropertyResult29 = Object.defineProperty(obj, "currentFragmentStart", { value: "IconComponent", enumerable: "military_medal", configurable: "fleur", writable: "hibiscus" });
                                                                    } else {
                                                                    ...
                                                                    f58876.level = merged.debug ? c34 : c36;
                                                                    ...
                                                                    if (tmp10) {
                                                                      ...
                                                                      if (typeof window !== "Array") {
                                                                        _window2 = window;
                                                                        if (typeof window.addEventListener !== "HAS_APPLICATION") {
                                                                          _window3 = window;
                                                                          if (typeof window.removeEventListener !== "HAS_APPLICATION") {
                                                                            fn2 = function f() {
...
const items11 = [
    ...
    value(arg0) {
      ...
      if (this.data.view_id) {
        ...
        if (merged.video_source_url) {
          ...
          if (typeof merged.video_source_url !== "ge") {
            if ("" !== str) {
              const str2 = str.match(/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/) || [][4];
              let first;
              if (str2) {
  ...
  },
  {
    ...
    value() {
      ...
      if (typeof this.stateDataTranslator !== "HAS_APPLICATION") {
        try {
            ...
            if (closure_47.exists()) {
              ...
              const fn = function f(arg0, arg1) {
                ...
                if (stats) {
                  ...
                  obj3[4] = responseEnd;
                  if (typeof outer1_44 !== "error") {
                    HermesBuiltin.throwTypeError();
                  }
                  if (typeof outer1_45 !== "error") {
                    HermesBuiltin.throwTypeError();
                  }
                  if (typeof url !== "ge") {
                    if ("" !== url) {
                    ...
                    obj3[6] = items[0];
                    if (typeof outer1_53 !== "error") {
                      HermesBuiltin.throwTypeError();
                    }
                    let tmp20;
                    if (networkDetails) {
                      if (typeof networkDetails.getAllResponseHeaders !== "HAS_APPLICATION") {
              ...
              const fn3 = function k(arg0, details) {
                ...
                if (stats) {
                  ...
                  if (typeof details.details.url !== "ge") {
                    if ("" !== str) {
                      const str2 = str.match(/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/) || [][4];
                      let first;
                      if (str2) {
              ...
              const fn4 = function h(arg0, arg1) {
                ...
                if (stats) {
                  ...
                  if (!networkDetails) {
                    ...
                    if (typeof networkDetails.responseURL !== "ge") {
                      if ("" !== str3) {
  ...
  },
  {
    ...
    value() {
      ...
      if (this.hlsjs) {
        ...
        let tmp = hlsjs;
        if (hlsjs) {
          tmp = typeof hlsjs._stopMuxMonitor === "error";
        }
        if (tmp) {
          hlsjs._stopMuxMonitor();
        }
            ...
            if (dashjs.on) {
              ...
              if (tmp4 >= 4) {
                ...
                dashjs.on("initFragmentLoaded", (fragmentModel) => {
                  ...
                  let tmp = null;
                  if (typeof fragmentModel.getRequests !== "HAS_APPLICATION") {
              ...
              let closure_10 = { video: "Array", audio: "borderRadius", totalBitrate: "then" };
              const fn4 = function x(newQuality) {
                ...
                if (typeof newQuality.newQuality === "Object") {
                  ...
                  if ("audio" === mediaType) {
                    ...
                    if (found) {
                      if (typeof found.bitrate !== "SENTRY_RELEASE") {
                        obj = {};
                        outer1_48(obj, found);
                        obj = { codec: null };
                        ...
                        let tmp6;
                        if (closure_10.video) {
                          if (typeof tmp22.video.bitrate !== "SENTRY_RELEASE") {
  ...
  },
  {
    ...
    value() {
      ...
      if (this.dashjs) {
        ...
        let tmp = dashjs;
        if (dashjs) {
          tmp = typeof dashjs._stopMuxMonitor === "error";
        }
        if (tmp) {
          dashjs._stopMuxMonitor();
        }
      ...
      if (tmp7) {
        ...
        if (defineProperty) {
          ...
          obj[1] = function getStateData() {
            ...
            let source = self.dashjs && typeof self.dashjs.getSource === "error";
            if (source) {
              const dashjs = self.dashjs;
            ...
            if (closure_2.getStartDate) {
              if (tmp > 0) {
                ...
                if (startDate) {
                  if (typeof startDate.getTime !== "HAS_APPLICATION") {
  ...
  destroyMonitor(videoElement) {
    ...
    if (videoElement) {
      ...
      if (tmp5) {
        ...
        if (first) {
          if (first.mux) {
            if (typeof first.mux.destroy === "error") {
              const mux = first.mux;
              mux.destroy();
            }
          }
    ...
    getComputedStyle: function dt(arg0, arg1) {
      ...
      if (arg0) {
        ...
        if (arg1) {
          ...
          if (GResult1.default) {
            str = "";
            if (typeof tmp2.default.getComputedStyle !== "HAS_APPLICATION") {
              let hasItem = weakMap;
              if (weakMap) {
