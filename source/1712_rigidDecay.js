...
function rigidDecay(initialVelocity, lastTimestamp, deceleration) {
  ...
  const result1 = velocity * Math.exp(result * require(1710) /* isValidRubberBandConfig */.SLOPE_FACTOR);
  ...
  return absolute < require(1710) /* isValidRubberBandConfig */.VELOCITY_EPS;
}
