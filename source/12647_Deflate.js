...
// Function ID: 97896
// Name: Deflate
// Dependencies: [12646, 12648, 12649, 12650, 12654]

// Module 12647 (Deflate)
const require = arg1;
    ...
    if (this instanceof Deflate) {
      ...
      if (options.raw) {
        ...
        if (0 !== deflateInit2Result) {
          ...
          tmp41 = new.target;
          tmp42 = new.target;
          error = new Error(require("module_12650")[deflateInit2Result]);
          tmp44 = error;
          throw error;
        } else {
          if (options.header) {
          ...
          if (options.dictionary) {
            ...
            if (0 !== deflateSetDictionaryResult) {
              ...
              tmp34 = new.target;
              tmp35 = new.target;
              error1 = new Error(require("module_12650")[deflateSetDictionaryResult]);
              tmp37 = error1;
              throw error1;
            } else {
              flag2 = true;
