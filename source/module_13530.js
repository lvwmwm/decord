// Module ID: 13530
// Function ID: 13531
// Dependencies: [41, 42, 32, 13524, 13531, 13532]
...
obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, require(13524) /* SymbolResult1 */.implSymbol)) {
      ...
      obj = require(13524) /* SymbolResult1 */;
    }
    return false;
  },
  isImpl(arg0) {
    if (arg0) {
      if (arg0 instanceof require(13531) /* URLSearchParamsImpl */.implementation) {
        return true;
      } else {
        const _mixedIntoPredicates = module.exports._mixedIntoPredicates;
  ...
  convert(arg0) {
    ...
    if (_exports.is(arg0)) {
      return require(13524) /* SymbolResult1 */.implForWrapper(arg0);
    } else {
  ...
  createDefaultIterator(self, key) {
    ...
    Object.defineProperty(obj, require(13524) /* SymbolResult1 */.iterInternalSymbol, { value: obj, configurable: true });
    return obj;
  },
  ...
  setup(wrapper) {
    ...
    const implementation = new require(13531) /* URLSearchParamsImpl */.implementation(arg1, items, obj);
    obj[0] = implementation;
    Object.defineProperty(wrapper, require(13524) /* SymbolResult1 */.implSymbol, obj);
    wrapper[require(undefined, 13524) /* SymbolResult1 */.implSymbol][require(13524) /* SymbolResult1 */.wrapperSymbol] = wrapper;
    if (require(13531) /* URLSearchParamsImpl */.init) {
