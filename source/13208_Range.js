...
// Function ID: 13209
// Name: Range
// Dependencies: [41, 42, 13180, 13207, 13181, 13183, 13182, 13179, 13209]

// Module 13208 (Range)
import _createClass from "_createClass" /* 42 */;
import LRUCache from "LRUCache" /* 13209 */;
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13180")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13181).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13181).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13182)("hyphen replace", str);
        let str3 = str.replace(tmp11(13183).safeRe[tmp11(undefined, 13183).t.COMPARATORTRIM], tmp11(13183).comparatorTrimReplace);
        tmp11(13182)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13183).safeRe[tmp11(undefined, 13183).t.TILDETRIM], tmp11(13183).tildeTrimReplace);
        tmp11(13182)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13183).safeRe[tmp11(undefined, 13183).t.CARETTRIM], tmp11(13183).caretTrimReplace);
        tmp11(13182)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13179)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13182)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13207).ANY) {
