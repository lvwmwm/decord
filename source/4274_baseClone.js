...
// Function ID: 37444
// Name: baseClone
// Dependencies: [573, 591, 4275, 4276, 747, 605, 4277, 4278, 4281, 4285, 4289, 4290, 4291, 752, 4297, 4299, 4301, 769, 4286, 601, 592, 4283]

// Module 4274 (baseClone)
let obj = {};
  ...
  if (!arg2) {
    {
      if (_require(573)(arr)) {
        ...
        if (tmp12) {
          const tmp32 = tmp13(4275)(arr);
          obj = tmp32;
          let tmp22 = tmp32;
          if (!tmp) {
            return _require(4276)(arr, tmp32);
          }
        } else {
          ...
          if (_require(605)(arr)) {
            return _require(4277)(arr, tmp);
          } else {
            if (tmp15 != "[object Object]") {
              if (tmp15 != "[object Arguments]") {
                if (obj[tmp15]) {
                  tmp22 = _require(4291)(arr, tmp15, tmp);
                  obj = tmp22;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              if (!tmp16) {
                obj = _require(4278)(arr);
              }
              tmp22 = obj;
              if (!tmp) {
                if (tmp2) {
                  let tmp25Result = tmp25(4281);
                  let tmp25ResultResult = tmp25Result(arr, tmp25(4285)(obj, arr));
                } else {
                  tmp25Result = tmp25(4289);
                  tmp25ResultResult = tmp25Result(arr, tmp25(4290)(obj, arr));
                }
