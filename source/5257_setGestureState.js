...
// Dependencies: [5255, 5258, 5256]

// Module 5257 (setGestureState)
...
export const GestureStateManager = {
  create: (() => {
    ...
    create.__closure = { REANIMATED_AVAILABLE: closure_3, setGestureState, State: require(5256).State, warningMessage: closure_2 };
