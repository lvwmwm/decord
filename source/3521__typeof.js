...
export const StandAloneQuarterParser = (Parser) => {
  ...
  const dependencyMap = StandAloneQuarterParser;
  ...
  let obj = { EntryPointCommandButtonActions: null, NATIVE_SECTION: null, 1476351743: null, value: StandAloneQuarterParser };
      ...
      if ("q" !== arg1) {
        if ("qq" !== arg1) {
          if ("qo" === arg1) {
            ...
            return ordinalNumber.quarter(arg0, { y: null, CHAT_INPUT_FLOATING_CONTENT_PADDING_VERTICAL: null }) || ordinalNumber.quarter(arg0, { y: null, CHAT_INPUT_FLOATING_CONTENT_PADDING_VERTICAL: null });
          } else if ("qqqqq" === arg1) {
            return ordinalNumber.quarter(arg0, { y: null, CHAT_INPUT_FLOATING_CONTENT_PADDING_VERTICAL: null });
          } else {
            return ordinalNumber.quarter(arg0, { y: "a", CHAT_INPUT_FLOATING_CONTENT_PADDING_VERTICAL: "7lZ31J" }) || ordinalNumber.quarter(arg0, { y: null, CHAT_INPUT_FLOATING_CONTENT_PADDING_VERTICAL: null }) || ordinalNumber.quarter(arg0, { y: null, CHAT_INPUT_FLOATING_CONTENT_PADDING_VERTICAL: null });
          }
        }
      }
