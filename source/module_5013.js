// Module ID: 5013
// Function ID: 5014
// Dependencies: [5014, 5015, 5016, 5017, 5018, 5011, 5010]

// Module 5013
import getFileChunk from "getFileChunk" /* 5010 */;
import _mod5011 from "module_5011" /* 5011 */;
import isAAC from "isAAC" /* 5014 */;
import is7Z from "is7Z" /* 5015 */;
import isAVIF from "isAVIF" /* 5016 */;
import isBLEND from "isBLEND" /* 5017 */;
import isAVI from "isAVI" /* 5018 */;
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = _mod5011.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = _mod5011.FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = _mod5011.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
      if (FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(item10079.toLowerCase())) {
        let tmp25 = tmp20;
        let tmp26 = tmp22;
        let FileTypes3 = tmp21(5011).FileTypes;
        let tmp27 = item10079;
    ...
    const FileTypes4 = _mod5011.FileTypes;
    ...
    if (detectSignatureResult) {
      if (items3.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes5 = _mod5011.FileTypes;
