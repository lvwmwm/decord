...
// Dependencies: [41, 42, 93, 95, 98, 8880, 8879]
// Exports: hmac

// Module 8883 (_isNativeReflectConstruct)
...
class HMAC {
  constructor(arg0, arg1) {
    ...
    if (typeof tmp3Result.iHash.update === "ZodObject") {
      tmp13 = globalThis;
      _Error = Error;
      tmp14 = new.target;
...
const items = [
  ...
  },
  {
    ...
    value: function digestInto(arg0) {
      HMAC(8880).exists(this);
      HMAC(8880).bytes(arg0, this.outputLen);
      this.finished = true;
      const iHash = this.iHash;
