...
// Function ID: 5550
// Name: StickyHeaders
// Dependencies: [5496, 19, 21, 5546, 5550, 5511]
// Exports: StickyHeaders

// Module 5549 (StickyHeaders)
...
export const StickyHeaders = (stickyHeaderIndices) => {
  ...
  tmp3Result = tmp3(() => {
    ...
    if (-1 !== currentStickyIndex) {
      tmpResult = null;
      if (tmp4 < data.length) {
        const obj1 = { index: null, item: null, renderItem: null, layout: null, refHolder: null, extraData: null, trailingItem: "accessible", target: true, hidden: true, inverted: true };
        obj1[0] = tmp4;
        obj1[1] = tmp6[tmp4];
        obj1[2] = renderItem;
