...
// Function ID: 4109
// Name: _extends
// Dependencies: [19, 4109, 1229, 1230, 1223, 4112]

// Module 4108 (_extends)
...
export const MemoryRouter = Component2(4112).Redirect;
export const Prompt = Component2(4112).Redirect;
export const Redirect = Component2(4112).Redirect;
export const Route = Component2(4112).Route;
export const Router = Component2(4112).Router;
export const StaticRouter = Component2(4112).StaticRouter;
export const Switch = Component2(4112).Switch;
export const generatePath = Component2(4112).generatePath;
export const matchPath = Component2(4112).matchPath;
export const useHistory = Component2(4112).useHistory;
export const useLocation = Component2(4112).useLocation;
export const useParams = Component2(4112).useParams;
export const useRouteMatch = Component2(4112).useRouteMatch;
export const withRouter = Component2(4112).withRouter;
