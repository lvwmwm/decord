...
// Function ID: 5576
// Name: n
// Dependencies: [19, 5531, 5574]
// Exports: useReanimatedEventHandler

// Module 5575 (n)
import noop from "noop";
import { Reanimated } from "module_5531";
...
export const useReanimatedEventHandler = function useReanimatedEventHandler(handlerTag, memoizedGestureCallbacks, handler, changeEventCalculator, fillInDefaultValues) {
  ...
  const fn = function h(handlerTag) {
    ...
    if (undefined === tmp) {
      const obj = { lastUpdateEvent: "title" };
  ...
  fn.__closure = { lastUpdateEventMap: mutable, eventHandler: _require(5574).eventHandler, handlerTag, workletizedHandlers: tmp, changeEventCalculator, fillInDefaultValues };
  ...
  let Reanimated = _require(5531).Reanimated;
  let event;
  if (Reanimated != null) {
