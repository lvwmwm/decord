...
// Function ID: 33387
// Name: memo
// Dependencies: [57, 31, 33, 4044, 4040, 4039, 4041]
...
const memoResult = memo(function PortalProviderComponent(rootHostName) {
  ...
  [tmp3, tmp4] = callback(callback2(require(4044) /* registerHost */.reducer, require(4040).INITIAL_STATE), 2);
  let obj = { value: tmp4 };
  obj = { value: tmp3 };
  const items = [rootHostName.children, ];
  if (tmp) {
    obj = { name: str };
    tmp = callback3(require(4041) /* PortalHost */.PortalHost, obj);
  }
  items[1] = tmp;
  obj.children = items;
  obj.children = closure_5(require(4039) /* createContext */.PortalStateContext.Provider, obj);
  return callback3(require(4039) /* createContext */.PortalDispatchContext.Provider, obj);
});
