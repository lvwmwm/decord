...
function getCreationDate(value) {
  const stringValue = require(4935) /* getStringValue */.getStringValue(value);
...
obj[524] = {
  ...
  repeatable: true,
  description(value) {
    const obj = require(4935) /* getStringValue */;
    const parts = require(4935) /* getStringValue */.getStringValue(value).split(":");
    let str2 = "";
    let str3 = "";
    if (parts[3]) {
      str3 = `/${tmp[3]}`;
...
obj[662] = {
  name: "Audio Type",
  description(value) {
    let str = require(4935) /* getStringValue */.getStringValue(value);
...
obj[663] = {
  ...
  description(value) {
    return parseInt(require(4935) /* getStringValue */.getStringValue(value), 10) + " Hz";
  }
};
obj[664] = {
  name: "Audio Sampling Resolution",
  description(value) {
    const parsed = parseInt(require(4935) /* getStringValue */.getStringValue(value), 10);
    let str = " bits";
    if (1 === parsed) {
      str = " bit";
    }
...
obj[713] = {
  ...
  description(value, ObjectData_Preview_File_Format) {
    ...
    if (ObjectData_Preview_File_Format["ObjectData Preview File Format"]) {
      const stringValue1 = require(4935) /* getStringValue */.getStringValue(ObjectData_Preview_File_Format["ObjectData Preview File Format"].value);
      if (obj[stringValue1]) {
        if (obj[stringValue1][stringValue]) {
          return obj[stringValue1][stringValue];
        }
      }
      const tmpResult = require(4935) /* getStringValue */;
    }
    return stringValue;
  }
};
