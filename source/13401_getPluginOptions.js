...
// Dependencies: [5, 27, 91, 13402, 13404, 13406, 13407, 13410, 13411, 13424, 13426, 13428, 13429, 13430, 13431, 13412]

// Module 13401 (getPluginOptions)
...
obj6.host = (function getHost(localhost) {
  ...
  if ("string" !== typeof scriptURL) {
    ...
    return require(13431) /* getHostFromUrl */.getHostFromUrl(scriptURL);
  }
