...
let closure_3 = ["EmojiSourceDataTypes", "USN"];
let closure_4 = [];
...
const importDefaultResultResult = importDefault(dependencyMap[9])(importDefault(dependencyMap[10]), { raw: true, textAlign: true });
let closure_17 = null;
...
const styles = StyleSheet.create({ underlay: { "Bool(false)": "center", "Bool(false)": -24, "Bool(false)": null, "Bool(false)": 1, "Bool(false)": "Malaysia" } });
