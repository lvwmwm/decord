...
let closure_9 = ["error_type:SOURCE_ERROR", "rgba(0,0,0,0)", "rgba(0,0,0,0.7)", "rgba(0,0,0,1)", "rgba(0, 0, 0, 0.48)", "rgba(0, 0, 0, 0.8)", "rgba(0,0,0,0.4)", "rgba(0,0,0,0)", "rgba(0, 0, 0, 0.60)"];
const tmp5 = () => {
