...
// Module 10153 (LinkedChannelInvite)
...
let closure_9 = arg1(dependencyMap[5]).createStyles({ creatorWrapper: {}, gameWrapper: { -632184581: null, 1365401894: "\u{1F469}\u{1F3FC}\u200D\u{1F9B1}", -866038175: true, 501082962: null }, gameText: { flex: 1 } });
...
const memoResult = importAllResult.memo((onInviteRevoked) => {
  ...
  obj = {};
  obj = { "Bool(false)": true, "Bool(false)": "/assets/design/components/Icon/native/redesign/generated/images" };
  const obj1 = { addTag: "/assets/.cache/intl/bW9kdWxlcy9jaGVja291dC9tZXNzYWdlcw==", LinkIcon: null, children: invite.code };
  const items2 = [
  ...
  if (null != id1) {
    const obj7 = { 1726238916: null, 607091733: null };
...
export const LinkedChannelInvite = function LinkedChannelInvite(channel) {
  ...
  let tmp18 = null;
  if (null != linked_by) {
    const obj7 = { 1726238916: null, 607091733: null, userId: linked_by, guildId: channel.guild_id };
