...
// Function ID: 99562
// Name: Range
// Dependencies: [65, 6, 7, 12777, 12804, 12778, 12780, 12779, 12776, 12806]

// Module 12805 (Range)
import _toConsumableArray from "_toConsumableArray";
import _classCallCheck from "items";
import _defineProperties from "module_12779";
...
function replaceTilde(str, loose) {
  const _require = str;
  const safeRe = _require(12780).safeRe;
  const t = _require(12780).t;
  if (loose.loose) {
...
function replaceXRanges(str, arg1) {
  const _require = arg1;
  _require(12779)("replaceXRanges", str, arg1);
...
function replaceStars(str, arg1) {
  require(12779)("replaceStars", str, arg1);
  return str.trim().replace(require(12780) /* items */.safeRe[require(undefined, 12780) /* items */.t.STAR], "");
}
function replaceGTE0(str) {
  require(12779)("replaceGTE0", str, arg1);
  const t = require(12780) /* items */.t;
  return str.trim().replace(require(12780) /* items */.safeRe[arg1.includePrerelease ? t.GTE0PRE : t.GTE0], "");
}
    ...
    if (!includePrerelease.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = require(12779)(arg0[num4].semver);
          let tmp6 = tmp2;
          if (arg0[num4].semver !== require(12804) /* Comparator */.ANY) {
            tmp6 = tmp2;
