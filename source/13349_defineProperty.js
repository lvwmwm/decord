...
if (require("getOwnPropertyDescriptor")) {
  ...
  defineProperty2 = function defineProperty(arg0, arg1, value) {
    require(13347) /* all */(arg0);
    const tmp4 = require(13307) /* text */(arg1);
    require(13347) /* all */(value);
    if (!require(13330)) {
      while (true) {
        let tmp10 = value;
        let str = "get";
