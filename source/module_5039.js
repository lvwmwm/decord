// Module ID: 5039
// Function ID: 5040
// Dependencies: [4999, 5014, 5015, 5011, 4994]
...
arg5.default = {
  read(buffer, sum) {
    ...
    let obj1 = require(5014) /* readTag */;
    let obj2 = require(5014) /* readTag */;
    const ifd = obj1.readIfd(buffer, require(5015) /* importDefaultResult1 */.IFD_TYPE_MPF, sum, obj2.get0thIfdOffset(buffer, sum, byteOrder), byteOrder, arg2);
    if (ifd.MPEntry) {
      const items = [];
      const _Math = Math;
      let num13 = 0;
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let tmp10 = num13;
          if (byteOrder === module(4999).LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
          ...
          if (0 !== num13) {
            ...
            let obj15 = require(4994) /* getDataView */;
        ...
        const typeSize4 = module(5011).getTypeSize("LONG");
        if (byteOrder === module(4999).LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
