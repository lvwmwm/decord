...
export const YearParser = (Parser) => {
  class YearParser {
    constructor() {
      if (this instanceof YearParser) {
        ...
        tmp19 = closure_8(applyResult, "incompatibleTokens", [null, null, "i", "e", "c", "t", "T", "GUILD_DELETE", null, null]);
        return applyResult;
      } else {
  ...
  let obj = { EntryPointCommandButtonActions: null, NATIVE_SECTION: null, 1476351743: null, value: YearParser };
