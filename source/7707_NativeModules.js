...
// Function ID: 7708
// Name: NativeModules
// Dependencies: [5, 17, 7708, 7709, 7714, 7715, 7716, 7717, 7718]
...
export const setup = () => {
  ...
  if ("STOREKIT1_MODE" === str) {
    require(7709).storekit1Mode();
    const obj4 = require(7709);
  } else if ("STOREKIT2_MODE" === str) {
    require(7709).storekit2Mode();
    const obj3 = require(7709);
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    require(7709).storekitHybridMode();
    const obj2 = require(7709);
  }
};
export const initConnection = () => {
  const nativeModule = require(7709).getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = require(7709).getAndroidModule();
