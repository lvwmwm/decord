...
// Dependencies: [32, 109, 17, 21, 5458, 1501, 8790, 5449, 4816]
// Exports: useHeaderConfigProps

// Module 8789 (processBarButtonItems)
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  const isSearchBarAvailableForCurrentPlatform = tmp(4816).isSearchBarAvailableForCurrentPlatform;
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = tmp(4816).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      items5[1] = null;
      obj6[1] = items5;
      let tmp33Result = tmp33(tmp(4816).ScreenStackHeaderLeftView, obj6);
    } else {
      if (typeof headerTitle === "function") {
        ...
        obj9[1] = obj;
        obj9[2] = headerTitle;
        obj8[1] = tmp63(tmp(5449).HeaderTitle, obj9);
      }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      obj10[1] = obj;
      obj10[2] = headerTitle;
      headerTitleResult = tmp39(tmp(5449).HeaderTitle, obj10);
    }
    const obj11 = { children: null };
    obj11[0] = headerTitleResult;
    tmp39Result = tmp39(tmp(4816).ScreenStackHeaderCenterView, obj11);
  }
  ...
  if (undefined !== headerBackIcon) {
    ...
    obj12[0] = source;
    let tmp41Result = callback3(tmp(4816).ScreenStackHeaderBackButtonImage, obj12);
  ...
  if (null != headerRightResult) {
    ...
    tmp43 = callback3(tmp(4816).ScreenStackHeaderRightView, obj13);
  }
  items7[2] = tmp43;
  let tmp45 = null;
  if (isSearchBarAvailableForCurrentPlatform2) {
    ...
    obj14[0] = callback3(tmp(4816).SearchBar, obj15);
    tmp45 = callback3(tmp(4816).ScreenStackHeaderSearchBarView, obj14);
  }
  items7[3] = tmp45;
  const obj16 = { backButtonInCustomView: tmp24, backgroundColor, backTitle: headerBackTitle, backTitleVisible: "minimal" !== headerBackButtonDisplayMode, backButtonDisplayMode: "find", backTitleFontFamily: true, backTitleFontSize: true, blurEffect: true, color: true, direction: true, disableBackButtonMenu: true, hidden: true, hideBackButton: true, hideShadow: true, largeTitle: true, largeTitleBackgroundColor: true, largeTitleColor: true, largeTitleFontFamily: true, largeTitleFontSize: true, largeTitleFontWeight: true, largeTitleHideShadow: "love_you_gesture_tone5", title: "love_you_gesture_dark_skin_tone", titleColor: "placeOptimizedMultiColumnItem", titleFontFamily: null, titleFontSize: "\u{1F918}\u{1F3FB}", titleFontWeight: true, topInsetEnabled: null, disableTopInsetApplication: 8, disableLeftInsetApplication: "Open Tall Menu", disableRightInsetApplication: "metal_tone1", disableBottomInsetApplication: "sign_of_the_horns_tone1", translucent: "updateColumnHeightsToIndex", children: null, headerLeftBarButtonItems: "\u{1F918}\u{1F3FC}", headerRightBarButtonItems: true, experimental_userInterfaceStyle: null };
  obj16[5] = tmp10;
  obj16[6] = fontSize;
