...
// Module 4791 (getImageNumberValue)
const require = arg1;
const module = arg2;
const dependencyMap = arg6;
function getImageNumberValue(value, arg1, typeSize, arg3) {
  if (arg3 === module(4751).LITTLE_ENDIAN) {
    let num7 = 0;
    let num8 = 0;
    let num9 = 0;
    if (0 < typeSize) {
...
function getImageOffset(arg0, value) {
  ...
  if (0 !== arg0) {
    ...
    num = getImageNumberValue(value, result + 8, module(4763).getTypeSize("LONG"), arg2) + arg3;
    const obj = module(4763);
  }
  return num;
}
let c3 = 16;
arg5.default = {
  read(getUint16, sum1) {
    const byteOrder = module(4751).getByteOrder(getUint16, sum1);
    let obj = module(4751);
    let obj2 = require(4766) /* readTag */;
    const ifd = obj2.readIfd(getUint16, require(4767) /* IFD_TYPE_0TH */.IFD_TYPE_MPF, sum1, require(4766) /* readTag */.get0thIfdOffset(getUint16, sum1, byteOrder), byteOrder, arg2);
