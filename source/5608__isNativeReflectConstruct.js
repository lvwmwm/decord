...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5609, 5579, 5624, 5611, 5626, 5622, 5627, 5612, 5628]
...
function getProgressFromGesture(interpolate, width, options) {
  ...
  if (undefined !== gestureDirection) {
    const tmp10 = importDefault(5611)(obj, gestureDirection);
    if (tmp10 > 0) {
    ...
    let gestureDirection2 = CardStack(5624).ModalTransition.gestureDirection;
  } else {
    gestureDirection2 = CardStack(5624).DefaultTransition.gestureDirection;
  }
}
class CardStack {
  constructor(arg0) {
...
let obj = {
  ...
  value: function render() {
        ...
        if (undefined === detachPreviousScreen) {
          ...
          if (tmp7) {
            ...
            if (isModalPresentation) {
              ...
              tmp11 = diff !== importDefault(5626)(scenes, (descriptor) => {
    ...
    children[1] = closure_9(CardStack(5627).MaybeScreenContainer, obj2);
    let tmp23 = null;
    if (someResult) {
      tmp23 = tmp15Result;
    }
    children[2] = tmp23;
    return closure_10(CardStack(5579).Background, { children });
  }
};
let items = [obj];
obj = {
