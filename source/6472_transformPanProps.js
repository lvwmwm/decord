  ...
  if (undefined === str) {
    ...
    if (undefined === str12) {
      ...
      if (undefined === str23) {
        ...
        if (undefined === str34) {
          activeOffsetY.changeEventCalculator = require(6445) /* isGestureEnabled */.getChangeEventCalculator(diffCalculator);
          ...
          if (Array.isArray(str34)) {
            ...
            obj4 = require(6445) /* isGestureEnabled */;
          }
        ...
        if (Array.isArray(str23)) {
          ...
          obj3 = require(6445) /* isGestureEnabled */;
        }
      ...
      if (Array.isArray(str12)) {
        ...
        obj2 = require(6445) /* isGestureEnabled */;
      }
    ...
    if (Array.isArray(str)) {
      ...
      obj = require(6445) /* isGestureEnabled */;
    }
...
arg5.usePanGesture = function usePanGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(6445) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformPanProps);
  const obj = require(6445) /* isGestureEnabled */;
  return require(6460) /* useGesture */.useGesture(require(6436) /* ComposedGestureName */.SingleGestureName.Pan, clonedAndRemappedConfig);
};
