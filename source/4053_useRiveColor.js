...
// Function ID: 4054
// Name: useRiveColor
// Dependencies: [32, 19, 4035, 4048, 4043]
// Exports: useRiveColor

// Module 4053 (useRiveColor)
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(require(4048) /* useRiveProperty */.useRiveProperty(instance, FillColor, f28801), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
    if (undefined !== tmp5) {
      let RiveColor = require(4043) /* RiveColor */.RiveColor;
