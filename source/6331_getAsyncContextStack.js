...
// Dependencies: [6, 7, 6332, 6318, 6329, 6337]
// Exports: getStackAsyncContextStrategy

// Module 6331 (getAsyncContextStack)
...
function getAsyncContextStack() {
  ...
  const sentryCarrier = require(6329) /* getSentryCarrier */.getSentryCarrier(mainCarrier);
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = require(6337) /* getDefaultCurrentScope */.getDefaultCurrentScope();
    const obj3 = require(6337) /* getDefaultCurrentScope */;
    const prototype = tmp2.prototype;
    stack = new tmp2(defaultCurrentScope, require(6337) /* getDefaultCurrentScope */.getDefaultIsolationScope());
    const obj4 = require(6337) /* getDefaultCurrentScope */;
  }
