...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 13612, 13615, 4540]
// Exports: default

// Module 13611 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4540).ScreenContext.Provider, { value: closure_8, children: children.children });
};
