...
// Function ID: 4014
// Name: _extends
// Dependencies: [19, 4014, 1229, 1230, 1223, 4017]

// Module 4013 (_extends)
...
export const MemoryRouter = Component2(4017).Redirect;
export const Prompt = Component2(4017).Redirect;
export const Redirect = Component2(4017).Redirect;
export const Route = Component2(4017).Route;
export const Router = Component2(4017).Router;
export const StaticRouter = Component2(4017).StaticRouter;
export const Switch = Component2(4017).Switch;
export const generatePath = Component2(4017).generatePath;
export const matchPath = Component2(4017).matchPath;
export const useHistory = Component2(4017).useHistory;
export const useLocation = Component2(4017).useLocation;
export const useParams = Component2(4017).useParams;
export const useRouteMatch = Component2(4017).useRouteMatch;
export const withRouter = Component2(4017).withRouter;
