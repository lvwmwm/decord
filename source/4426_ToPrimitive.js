...
// Function ID: 38960
// Name: ToPrimitive
// Dependencies: [1378, 4427, 4428, 4429]

// Module 4426 (ToPrimitive)
...
export default function ToPrimitive(arg0) {
  let callResult;
  if (require(4427) /* isPrimitive */(arg0)) {
    return arg0;
  } else {
    let str2 = "default";
    ...
    if (!closure_2) {
      {
        ...
        if (tmp22) {
          let tmp19 = require(4429) /* isDateObject */(arg0);
          if (!tmp19) {
            tmp19 = require(4428)(arg0);
          }
          tmp22 = tmp19;
        }
        let str8 = str2;
        ...
        if (null == arg0) {
          ...
          if (0 < arr.length) {
            while (true) {
              ...
              if (require(1378) /* apply */(obj)) {
                callResult = obj.call(arg0);
                let tmp27 = require;
                let tmp28 = dependencyMap;
                let tmp29 = callResult;
                if (require(4427) /* isPrimitive */(callResult)) {
                  break;
                }
              }
              num6 = num6 + 1;
