...
// Dependencies: [32, 4931, 4948]

// Module 4971 (parseBezierKnot)
...
function parseBezierKnot(dataView) {
  ...
  do {
    ...
    let obj4 = require(4931) /* getDataView */;
...
obj[2999] = {
  ...
  description(getUint8) {
    return callback(require(4931) /* getDataView */.getPascalStringFromDataView(getUint8, 0), 2)[1];
  }
};
obj = {
  description: "Closed subpath length",
  path(dataView, sum) {
    const items = [importDefault(4948).getShortAt(dataView, sum)];
    return items;
  }
};
let closure_4 = {
  ...
  [obj.CLIPBOARD]: {
    ...
    path: function parseClipboard(dataView, sum) {
      const longAt = importDefault(4948).getLongAt(dataView, sum);
      let num = -1;
      let num2 = -1;
      if (longAt >>> 31 === 0) {
        num2 = 1;
      }
      const obj = importDefault(4948);
      const obj2 = require(4931) /* getDataView */;
      const str2 = longAt & parseInt(require(4931) /* getDataView */.strRepeat("1", 24), 2);
      const text = `${str.toString(2)}.`;
      const obj3 = require(4931) /* getDataView */;
      const items = [num2 * obj3.parseFloatRadix(`${(2130706432 & longAt) >>> 24.toString(2)}.` + require(4931) /* getDataView */.padStart(str2.toString(2), 24, "0"), 2), , , ];
      sum = sum + 4;
      ...
      let tmp4Result = tmp4(4931);
      const obj4 = require(4931) /* getDataView */;
      tmp4Result = tmp4(4931);
      const text1 = `${str3.toString(2)}.`;
      const str4 = longAt1 & parseInt(tmp4Result.strRepeat("1", 24), 2);
      items[1] = num3 * tmp4Result.parseFloatRadix(`${(2130706432 & longAt1) >>> 24.toString(2)}.` + require(4931) /* getDataView */.padStart(str4.toString(2), 24, "0"), 2);
      const sum1 = sum + 8;
      tmpResult = tmp(4948);
      ...
      const tmp4Result1 = require(4931) /* getDataView */;
      const tmp4Result2 = require(4931) /* getDataView */;
      const str6 = longAt2 & parseInt(require(4931) /* getDataView */.strRepeat("1", 24), 2);
      const text2 = `${str5.toString(2)}.`;
      const tmp4Result3 = require(4931) /* getDataView */;
      items[2] = num4 * tmp4Result3.parseFloatRadix(`${(2130706432 & longAt2) >>> 24.toString(2)}.` + require(4931) /* getDataView */.padStart(str6.toString(2), 24, "0"), 2);
      const sum2 = sum + 12;
      const tmp4Result4 = require(4931) /* getDataView */;
      const longAt3 = importDefault(4948).getLongAt(dataView, sum2);
      let num5 = num;
      if (longAt3 >>> 31 === 0) {
        num5 = 1;
      }
      const tmpResult1 = importDefault(4948);
      const tmp4Result5 = require(4931) /* getDataView */;
      const str8 = longAt3 & parseInt(require(4931) /* getDataView */.strRepeat("1", 24), 2);
      const text3 = `${str7.toString(2)}.`;
      const tmp4Result6 = require(4931) /* getDataView */;
      items[3] = num5 * tmp4Result6.parseFloatRadix(`${(2130706432 & longAt3) >>> 24.toString(2)}.` + require(4931) /* getDataView */.padStart(str8.toString(2), 24, "0"), 2);
      const items1 = [items, ];
      const sum3 = sum + 16;
      const tmp4Result7 = require(4931) /* getDataView */;
      const longAt4 = importDefault(4948).getLongAt(dataView, sum3);
      if (longAt4 >>> 31 === 0) {
        num = 1;
      }
      const tmpResult2 = importDefault(4948);
      const tmp4Result8 = require(4931) /* getDataView */;
      const str10 = longAt4 & parseInt(require(4931) /* getDataView */.strRepeat("1", 24), 2);
      const text4 = `${str9.toString(2)}.`;
      const tmp4Result9 = require(4931) /* getDataView */;
      items1[1] = num * tmp4Result9.parseFloatRadix(`${(2130706432 & longAt4) >>> 24.toString(2)}.` + require(4931) /* getDataView */.padStart(str10.toString(2), 24, "0"), 2);
      return items1;
    }
  }
};
