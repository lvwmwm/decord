...
// Function ID: 45253
// Name: useScrollable
// Dependencies: [31, 1582, 5224, 5240]
// Exports: useScrollable

// Module 5239 (useScrollable)
...
export const useScrollable = function useScrollable() {
  ...
  const sharedValue = obj.useSharedValue(require(5224) /* GESTURE_SOURCE */.SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = require(1582) /* cancelAnimation */.useSharedValue(0);
  const obj2 = require(1582) /* cancelAnimation */;
  const sharedValue2 = require(1582) /* cancelAnimation */.useSharedValue(require(5224) /* GESTURE_SOURCE */.SCROLLABLE_STATE.UNDETERMINED);
