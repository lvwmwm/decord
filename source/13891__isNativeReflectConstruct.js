...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 13892, 13895, 4694]
// Exports: default

// Module 13891 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4694).ScreenContext.Provider, { value: closure_8, children: children.children });
};
