...
// Function ID: 6408
// Name: setMeasurement
// Dependencies: [6370, 6393, 6365, 6380]

// Module 6407 (setMeasurement)
const require = arg1;
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (activeSpan) {
    rootSpan = require(6370) /* spanTimeInputToSeconds */.getRootSpan(activeSpan);
    const obj3 = require(6370) /* spanTimeInputToSeconds */;
  }
  if (rootSpan) {
    if (require(6393) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      const logger = tmp9(6365).logger;
      const _HermesInternal = HermesInternal;
      logger.log("[Measurement] Setting measurement on root span: " + arg0 + " = " + arg1 + " " + arg2);
    }
    obj = {};
    obj[require(6380).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[require(6380).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
