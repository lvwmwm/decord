...
// Dependencies: [32, 12312, 12313, 12311, 12305]

// Module 12317 (convertBaseSchema)
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema(flag, defaultTarget) {
      if (typeof flag === "boolean") {
        ...
        if (registry == null) {
          registry = require(12305) /* $output */.globalRegistry;
        }
        obj[5] = registry;
        return convertSchema(flag, obj);
      }
    };
    const fnResult = fn(require("module_12312"));
    let obj = {};
    let merged = Object.assign(fn(require("module_12311")));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(require("module_12313"));
    let _Set = Set;
