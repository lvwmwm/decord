...
// Dependencies: [13197, 13281]

// Module 13280 (isSupportedCurrency)
const require = arg1;
...
function isSupportedCurrency(arr3, locale) {
  ...
  const memoizedNumberFormat = require(13197) /* _formatToParts */.createMemoizedNumberFormat(str, obj);
...
arg5.getSupportedCurrencies = function getSupportedCurrencies(locale) {
  const items = [];
  const currencies = require(13281).currencies;
  let num = 0;
