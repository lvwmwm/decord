...
// Dependencies: [6432, 6412, 6433, 6392, 6396, 6368, 6425]

// Module 6431 (createTransport)
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(6412).envelopeItemTypeToDataCategory(arg1);
        const obj = items(6412);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: null };
          obj[0] = items(6412).serializeEnvelope(dependencyMap);
          const obj2 = items(6412);
          ...
          if (arg0 instanceof items(6425).SentryError) {
