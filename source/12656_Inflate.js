...
// Function ID: 97969
// Name: Inflate
// Dependencies: [12647, 12649, 12657, 12660, 12651, 12661, 12655]

// Module 12656 (Inflate)
const require = arg1;
...
class Inflate {
  constructor(arg0) {
    ...
    if (this instanceof Inflate) {
      ...
      num10 = 3;
      if (inflateInit2Result !== require("module_12660").Z_OK) {
        tmp29 = globalThis;
        _Error = Error;
        tmp30 = closure_0;
        tmp31 = closure_1;
        ...
        tmp32 = new.target;
        tmp33 = new.target;
        error = new Error(require("module_12651")[inflateInit2Result]);
        tmp35 = error;
        throw error;
      } else {
        tmp21 = closure_0;
    ...
    if (this.ended) {
      ...
      if (arg1 === ~~arg1) {
        ...
        if (true === arg1) {
          ...
          tmp6 = closure_1;
          num2 = 3;
          Z_NO_FLUSH = require("module_12660").Z_FINISH;
        } else {
          tmp3 = closure_0;
          tmp4 = closure_1;
          num = 3;
          Z_NO_FLUSH = require("module_12660").Z_NO_FLUSH;
        }
        tmp7 = Z_NO_FLUSH;
      }
    }
  ...
  onEnd(arg0) {
    self = this;
    if (arg0 === require("module_12660").Z_OK) {
      str = "string";
