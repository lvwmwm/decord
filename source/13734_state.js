...
// Function ID: 13735
// Name: state
// Dependencies: [13698, 13673, 13735, 13689, 13736, 13718, 13696, 13729]
...
if (!require("all")) {
  if (!require("__core-js_shared__").state) {
    ...
    let fn = function t(facade) {
      if (require(13696) /* call */(facade, closure_6)) {
    ...
    let fn2 = function n(arg0) {
      return require(13696) /* call */(arg0, closure_6) ? arg0[closure_6] : {};
    };
    let fn5 = fn2;
    let fn3 = function u(arg0) {
      return require(13696) /* call */(arg0, closure_6);
    };
    let fn6 = fn3;
  }
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new require(13673).TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
