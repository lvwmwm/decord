...
// Dependencies: [7017, 1654, 7007]

// Module 7016 (useScrollHandler)
const require = arg1;
...
arg5.useScrollHandler = (arg0, onScroll, onScrollBeginDrag, onScrollEndDrag) => {
  ...
  if (arg0 === undefined) {
    useScrollEventsHandlersDefault = _require(7017).useScrollEventsHandlersDefault;
  }
  _require = onScroll;
