...
// Dependencies: [7512, 7463, 7501, 7462, 7465, 7484, 7456]

// Module 7546 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(7484).DEBUG_BUILD) {
                const logger = callback(7456).logger;
