...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 6576, 6577, 6578, 6579, 6583, 6584, 6585, 6595]

// Module 6575 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(6577)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(6578)(tmp, tmp, this);
      ...
      if (transform) {
        ...
        tmp.transform = self(6579).extractTransformSvgView(tmp);
        const obj3 = self(6579);
      }
      obj = {};
      ...
      obj.children = jsx(importDefault(6585), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(6583), {});
    }
  }
];
