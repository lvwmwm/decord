...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7993, 8063, 8072, 7998, 8009]
...
const items = [
  {
    ...
    value: function render() {
      ...
      const tmp3Result = self(7993)(patternTransform);
      ...
      if (patternContentUnits) {
        num2 = tmp(8063)[patternContentUnits];
      }
      obj[8] = num2;
      obj = {
        ref(arg0) {
      ...
      const tmp3 = self(7993);
      const merged = Object.assign(obj);
      const merged1 = Object.assign(tmp(7998)({ viewBox, preserveAspectRatio }));
      obj.children = children;
      return jsx(self(8072), {
        ref(arg0) {
          return self.refMethod(arg0);
        }
      });
