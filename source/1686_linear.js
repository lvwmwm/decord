...
const tmp4 = (() => {
  ...
  ease.__closure = { Bezier: require(1687) /* calcBezier */.Bezier };
...
const tmp14 = (() => {
  ...
  bezier.__closure = { Bezier: require(1687) /* calcBezier */.Bezier };
...
const tmp15 = (() => {
  ...
  bezierFn.__closure = { Bezier: require(1687) /* calcBezier */.Bezier };
