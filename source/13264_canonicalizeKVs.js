...
// Dependencies: [1257, 13265, 13263, 13266, 13267]

// Module 13264 (canonicalizeKVs)
const require = arg1;
...
function canonicalizeUnicodeLanguageId(lang) {
  ...
  if (lang.variants.length) {
    ...
    if (0 < variants.length) {
      ...
      obj.variants = items;
      const str = require(13265).languageAlias[require(undefined, 13263) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj)];
      while (!str) {
        num = num + 1;
        tmp = lang;
      }
      obj = {};
      const result = require(13266) /* isUnicodeLanguageSubtag */.parseUnicodeLanguageId(str.split(require(13266) /* isUnicodeLanguageSubtag */.SEPARATOR));
  ...
  if (tmp.script) {
    ...
    if (tmp.region) {
      ...
      obj.variants = [];
      const str2 = require(13265).languageAlias[require(undefined, 13263) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj)];
      tmp8 = tmp;
      if (str2) {
        const obj1 = {};
        const result1 = require(13266) /* isUnicodeLanguageSubtag */.parseUnicodeLanguageId(str2.split(require(13266) /* isUnicodeLanguageSubtag */.SEPARATOR));
  ...
  if (tmp8.region) {
    ...
    obj2.variants = [];
    const str3 = require(13265).languageAlias[require(undefined, 13263) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj2)];
    tmp14 = tmp8;
    if (str3) {
      const obj3 = {};
      const result2 = require(13266) /* isUnicodeLanguageSubtag */.parseUnicodeLanguageId(str3.split(require(13266) /* isUnicodeLanguageSubtag */.SEPARATOR));
  ...
  const str4 = require(13265).languageAlias[require(undefined, 13263) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj4)];
  let tmp20 = tmp14;
  if (str4) {
    const obj5 = {};
    const result3 = require(13266) /* isUnicodeLanguageSubtag */.parseUnicodeLanguageId(str4.split(require(13266) /* isUnicodeLanguageSubtag */.SEPARATOR));
  ...
  if (tmp20.region) {
    ...
    const str6 = require(13265).territoryAlias[formatted];
    let tmp27;
    if (str6) {
      ...
      obj6.variants = [];
      const str8 = require(13267) /* __exportStarResult2 */.likelySubtags[require(undefined, 13263) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj6)];
      tmp27 = first;
      if (str8) {
        const region = require(13266) /* isUnicodeLanguageSubtag */.parseUnicodeLanguageId(str8.split(require(13266) /* isUnicodeLanguageSubtag */.SEPARATOR)).region;
        let tmp33 = region;
        if (region) {
  ...
  if (tmp20.script) {
    ...
    if (require(13265).scriptAlias[tmp20.script]) {
      tmp20.script = require(13265).scriptAlias[tmp20.script];
    }
  ...
  if (tmp20.variants.length) {
    for (let num17 = 0; num17 < tmp20.variants.length; num17 = num17 + 1) {
      ...
      if (require(13265).variantAlias[formatted2]) {
        let tmp42 = require;
        let tmp43 = dependencyMap;
        let tmp44 = require(13265).variantAlias[formatted2];
        if (require(13266) /* isUnicodeLanguageSubtag */.isUnicodeVariantSubtag(tmp44)) {
          ...
          let tmp47 = tmp44;
          if (require(13266) /* isUnicodeLanguageSubtag */.isUnicodeLanguageSubtag(tmp44)) {
            tmp20.lang = tmp44;
            let tmp48 = tmp44;
          }
        }
