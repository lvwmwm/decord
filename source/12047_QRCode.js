...
const forwardRefResult = _module.forwardRef((obj, ref) => {
  ...
  let size;
  let value;
  const items = [1560281088, 1979711488, 6, 58, 36];
  obj = {};
...
forwardRefResult.defaultProps = { TEST_4: 1091658877, HappeningNowActivityCardSubtitle: 68786, setOnDesktopSourceEnded: 13426, updateChannelOverrideSettingsBulk: 13312 };
