...
// Dependencies: [7419, 7391, 7363, 7374, 7372]

// Module 7438 (_getEventFilterUrl)
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (require(7391) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + tmp6(7374).getEventDescription(tmp));
      const tmp6Result = tmp6(7374);
    }
    return null;
  }
}
