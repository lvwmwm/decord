...
// Function ID: 4034
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4034, 4035, 4037, 4015]
// Exports: RiveView

// Module 4033 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + require(4034).RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp18 = jsx(_require(4015).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
