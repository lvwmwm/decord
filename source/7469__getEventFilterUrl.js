...
// Dependencies: [7450, 7422, 7394, 7405, 7403]

// Module 7469 (_getEventFilterUrl)
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (require(7422) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + tmp6(7405).getEventDescription(tmp));
      const tmp6Result = tmp6(7405);
    }
    return null;
  }
}
