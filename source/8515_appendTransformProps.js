...
// Dependencies: [8516, 8517, 8518]

// Module 8515 (appendTransformProps)
const require = arg1;
...
function appendTransformProps(arg0) {
  ...
  require(8516) /* append */.appendTransform(x + originX, y + originY, scaleX, scaleY, rotation, skewX, skewY, originX, originY);
}
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      if ("number" === typeof arr[0]) {
        const obj4 = require(8516) /* append */;
      ...
      const parsed = require(8517) /* peg$SyntaxError */.parse(arr);
      const obj3 = require(8516) /* append */;
      obj3.append(parsed[0], parsed[3], parsed[1], parsed[4], parsed[2], parsed[5]);
      const obj2 = require(8517) /* peg$SyntaxError */;
    } else {
  ...
  const obj = require(8516) /* append */;
  require(8516) /* append */.toArray();
}
arg5.default = function extractTransform(arr) {
  ...
  if ("string" === typeof arr) {
    const parsed = require(8517) /* peg$SyntaxError */.parse(tmp);
...
arg5.extractTransformSvgView = function extractTransformSvgView(transform) {
  if ("string" === typeof transform.transform) {
    transform = require(8518) /* peg$SyntaxError */.parse(transform.transform);
    const obj = require(8518) /* peg$SyntaxError */;
  } else {
