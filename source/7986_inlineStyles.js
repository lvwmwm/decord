...
// Function ID: 7987
// Name: inlineStyles
// Dependencies: [7987, 7988, 8091, 8092, 8094, 8095, 8009]

// Module 7986 (inlineStyles)
import CircleDefault from "Circle" /* 7988 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8009 */;
import showErrorCSS from "showErrorCSS" /* 8091 */;
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 8092 */;
import _fetchText from "_fetchText" /* 8094 */;
import RNSVGCircle from "RNSVGCircle" /* 8095 */;

for (const key10013 in require("module_7987")) {
  let tmp2 = key10013;
  arg5[key10013] = require("module_7987")[key10013];
  continue;
}
