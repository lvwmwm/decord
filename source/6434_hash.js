...
// Function ID: 6435
// Name: hash
// Dependencies: [32, 6421, 6420, 6435, 6444]
...
function maybeUnpackValue(enabled) {
  const Reanimated = require(6420).Reanimated;
...
function getEnabledSharedValues(Reanimated) {
  if (undefined === require(6420).Reanimated) {
    return [];
  } else {
...
export const hasWorkletEventHandlers = function hasWorkletEventHandlers(useAnimated) {
  const iter = require(6435) /* items2 */.HandlerCallbacks[Symbol.iterator]();
