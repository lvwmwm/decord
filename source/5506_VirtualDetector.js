...
// Dependencies: [32, 19, 17, 21, 5505, 5432, 5507, 5494, 5503, 5502, 5481]
// Exports: VirtualDetector

// Module 5506 (VirtualDetector)
    ...
    callback(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: null, handlerTags: null, methods: null, viewRef: "a", userSelect: true, touchAction: true, enableContextMenu: true };
          obj[0] = tmp;
          obj[1] = closure_7;
