...
// Dependencies: [1281, 13482, 13483, 13547, 13554, 13559, 13574, 13575]

// Module 13481 (addLikelySubtags)
import e from "e";
...
function addLikelySubtags(locale) {
  ...
  let script;
  let variants;
  const parseUnicodeLocaleIdResult = require(13547) /* isStructurallyValidLanguageTag */.parseUnicodeLocaleId(locale);
