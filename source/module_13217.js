// Module ID: 13217
// Function ID: 13218
// Dependencies: [13211, 13182, 13202]

// Module 13217

export default (arg0, arg1) => {
  let require;
  let obj = new require(13211) /* Range */(arg0, arg1);
  const tmp3 = new require(13182) /* SemVer */("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
        ...
        do {
          ...
          if (require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = require;
              tmp16 = !require(13202) /* SemVer */(tmp14, require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
