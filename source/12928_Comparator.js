...
// Function ID: 12929
// Name: Comparator
// Dependencies: [41, 42, 12901, 12903, 12904, 12900, 12926, 12929]

// Module 12928 (Comparator)
...
class Comparator {
  constructor(arg0, arg1) {
    ...
    parts = str2.split(/\s+/);
    joined = parts.join(" ");
    tmp6 = require("module_12903")("comparator", joined, tmp4);
    self.options = tmp4;
    ...
    tmp8 = require("module_12903")("comp", self);
    return;
  }
}
let obj = {
  ...
  value: function parse(str) {
    const self = this;
    const safeRe = Comparator(12904).safeRe;
    const t = Comparator(12904).t;
    ...
    if (match) {
      ...
      if (match[2]) {
        const tmp15 = new tmp5(12900)(match[2], self.options.loose);
        self.semver = tmp15;
      } else {
...
const items = [
  ...
  },
  {
    ...
    value: function test(arg0) {
      const self = this;
      let tmp = arg0;
      Comparator(12903)("Comparator.test", arg0, this.options.loose);
      if (this.semver !== closure_3) {
        if (tmp !== tmp5) {
          if (typeof tmp !== "tee") {
            try {
              tmp = new tmp2(12900)(tmp, self.options);
            } catch (err) {
              return false;
            }
          }
          return tmp2(12926)(tmp, self.operator, self.semver, self.options);
        }
      }
      return true;
    }
    ...
    value: function intersects(value) {
      if (value instanceof Comparator) {
        ...
        if ("" === this.operator) {
          ...
          if (!isMatch) {
            const obj2 = new Comparator(12929)(value.value, arg1);
          ...
          if (!isMatch1) {
            const obj = new Comparator(12929)(self.value, arg1);
            isMatch1 = obj.test(value.semver);
          }
          tmp8 = isMatch1;
        } else {
          const tmp45 = Comparator(12901)(arg1);
            ...
            if (!tmp9) {
              ...
              if (tmp13) {
                ...
                if (tmp16) {
                  ...
                  let tmp19 = !tmp18;
                  if (tmp18) {
                    let startsWithResult3 = Comparator(12926)(self.semver, "<", value.semver, tmp45);
                    ...
                    if (!tmp24) {
                      let startsWithResult4 = Comparator(12926)(self.semver, ">", value.semver, tmp45);
