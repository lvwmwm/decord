...
// Dependencies: [7345, 7348, 7347, 7353]

// Module 7433 (instrumentConsole)
const require = arg1;
const dependencyMap = arg6;
function instrumentConsole() {
  if ("console" in require(7348) /* getGlobalSingleton */.GLOBAL_OBJ) {
    const CONSOLE_LEVELS = require(7347) /* consoleSandbox */.CONSOLE_LEVELS;
...
arg5.addConsoleInstrumentationHandler = function addConsoleInstrumentationHandler(arg0) {
  require(7345) /* addHandler */.addHandler("console", arg0);
  const obj = require(7345) /* addHandler */;
  require(7345) /* addHandler */.maybeInstrument("console", instrumentConsole);
};
