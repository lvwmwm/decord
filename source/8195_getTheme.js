...
// Function ID: 65676
// Name: getTheme
// Dependencies: [31, 27, 33, 8196, 8200]

// Module 8195 (getTheme)
...
export default require("result").memo(function DatePickerWrapper(confirmText) {
  const obj = { textColor: require(8200) /* rgb2hex */.colorToHex(getTextColor(confirmText)) };
  const obj2 = require(8200) /* rgb2hex */;
  const tmp = jsx;
  const tmp2 = DatePickerAndroid;
  obj.dividerColor = require(8200) /* rgb2hex */.colorToHex(getDividerColor(confirmText));
  const obj3 = require(8200) /* rgb2hex */;
  obj.buttonColor = require(8200) /* rgb2hex */.colorToHex(getButtonColor(confirmText));
