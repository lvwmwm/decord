...
// Function ID: 4627
// Name: ToPrimitive
// Dependencies: [1421, 4627, 4628, 4629]

// Module 4626 (ToPrimitive)
...
export default function ToPrimitive(arg0) {
  let tmp22;
  if (require(4627) /* isPrimitive */(arg0)) {
    return arg0;
  } else {
    let str2 = "default";
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4629)(arg0) || tmp(4628)(arg0);
          const tmp15 = tmp(4629)(arg0) || tmp(4628)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
