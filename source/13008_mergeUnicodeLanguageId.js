...
// Module 13008 (mergeUnicodeLanguageId)
...
let closure_6 = [true, true, true, true, true, true, true];
const tmp2 = () => {
  class Locale {
        ...
        if (undefined === arg0) {
          ...
          if ("object" === constructor) {
            ...
            if (defaultResult) {
              ...
              tmp84 = result;
              str30 = "string";
              obj1.hc = Locale(closure_1[2]).GetOption(result, "hourCycle", "string", [null, null, null, null], undefined);
              str31 = "caseFirst";
              tmp85 = result;
              obj1.kf = Locale(closure_1[2]).GetOption(result, "caseFirst", "string", [], undefined);
              str32 = "numeric";
              str33 = "boolean";
              tmp86 = result;
...
if ("undefined" !== typeof Symbol) {
  ...
  Object.defineProperty(tmp3.prototype, Symbol.toStringTag, { acn: null, acp: null, acq: null, acr: null });
}
Object.defineProperty(tmp2.prototype.constructor, "length", { acn: true, acp: "/assets/.cache/intl/bW9kdWxlcy9nb19saXZlL3dlYi9tb2RhbA==", acq: null, acr: "b0f2d18e6d7a6837db7a0d021090104d" });
