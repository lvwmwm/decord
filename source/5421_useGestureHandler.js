...
// Dependencies: [1606, 5339, 5312]

// Module 5421 (useGestureHandler)
const require = arg1;
...
arg5.useGestureHandler = (source, state, gestureSource, onStart, onChange, onEnd, onFinalize) => {
  ...
  obj = { state, State: _require(5339).State, gestureSource, source, onStart };
  R.__closure = obj;
  ...
  obj = { gestureSource, source, state, GESTURE_SOURCE: _require(5312).GESTURE_SOURCE, onEnd };
  C.__closure = obj;
  ...
  obj1 = { gestureSource, source, state, GESTURE_SOURCE: _require(5312).GESTURE_SOURCE, onFinalize };
  T.__closure = obj1;
