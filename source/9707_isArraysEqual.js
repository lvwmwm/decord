...
let closure_5 = () => {
  function isArraysEqual(arr) {
    return arr.length === arg1.length && arr.every((arg0, arg1) => arg0 === arg1[arg1]);
  }
...
export const useVisibleRanges = function useVisibleRanges(total) {
  ...
  const dependencyMap = viewSize;
  const translation = total.translation;
  const useRef = translation;
  ...
  pnpm_useVisibleRangesTsx1.__initData = closure_3;
  const items = [loop, num, tmp, translation];
