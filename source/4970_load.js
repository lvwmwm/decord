...
// Function ID: 4971
// Name: load
// Dependencies: [4971, 4972, 4973, 4974, 4975, 4988, 4990, 4991, 5003, 5007, 5011, 5013, 5015, 5016, 5017, 5018, 5019, 5020, 5021, 5022, 5023, 5024, 4997]
// Exports: load
  ...
  if (typeof response === "string") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(4972).dataUriToBuffer(response));
        const obj5 = response(4972);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
