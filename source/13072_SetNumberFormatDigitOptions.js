...
// Module 13072 (SetNumberFormatDigitOptions)
arg5.SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(internalSlots, result1, minimumFractionDigits, arg3, GetOptionResult1) {
  ...
  const GetOptionResult = result1(arg6[2]).GetOption(result1, "roundingMode", "string", [], "halfExpand");
  ...
  internalSlots.trailingZeroDisplay = result1(arg6[2]).GetOption(result1, "trailingZeroDisplay", "string", ["Africa/Luanda", "Pacific/Auckland"], "auto");
  let flag = true;
  let flag2 = true;
