...
// Function ID: 5416
// Name: getHandler
// Dependencies: [5407, 5376, 5372, 5375, 5373, 5374]

// Module 5415 (getHandler)
const require = arg1;
...
function getHandler(arg0, onBegin) {
  ...
  } else if (tmp(5407).CALLBACK_TYPE.UPDATE === arg0) {
    return onBegin.onUpdate;
  } else if (tmp(5407).CALLBACK_TYPE.CHANGE === arg0) {
    return onBegin.onChange;
  } else if (tmp(5407).CALLBACK_TYPE.END === arg0) {
    return onBegin.onEnd;
  } else if (tmp(5407).CALLBACK_TYPE.FINALIZE === arg0) {
    return onBegin.onFinalize;
  } else if (tmp(5407).CALLBACK_TYPE.TOUCHES_DOWN === arg0) {
    return onBegin.onTouchesDown;
  } else if (tmp(5407).CALLBACK_TYPE.TOUCHES_MOVE === arg0) {
    return onBegin.onTouchesMove;
  } else if (tmp(5407).CALLBACK_TYPE.TOUCHES_UP === arg0) {
    return onBegin.onTouchesUp;
  } else if (tmp(5407).CALLBACK_TYPE.TOUCHES_CANCELLED === arg0) {
...
function touchEventTypeToCallbackType(arg0) {
  ...
  } else if (tmp(5376).TouchEventType.TOUCHES_UP === arg0) {
    return tmp(5407).CALLBACK_TYPE.TOUCHES_UP;
  } else if (tmp(5376).TouchEventType.TOUCHES_CANCELLED === arg0) {
    return tmp(5407).CALLBACK_TYPE.TOUCHES_CANCELLED;
  } else {
    return tmp(5407).CALLBACK_TYPE.UNDEFINED;
  }
}
obj = { TouchEventType: require("module_5376").TouchEventType, CALLBACK_TYPE: require("_isNativeReflectConstruct").CALLBACK_TYPE };
