...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7892, 7981, 7891, 7900]

// Module 7980 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      let match = str;
      if (str) {
        match = str.match(self(7892).idPattern);
      }
      let tmp4 = match;
      if (match) {
        tmp4 = match[1];
