...
// Function ID: 4925
// Name: parseBox
// Dependencies: [4925, 4918, 4915]

// Module 4924 (parseBox)
import getDataView from "getDataView" /* 4915 */;
import parseItemLocationBox from "parseItemLocationBox" /* 4925 */;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(4915).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(4915);
            }
          }
        }
      } else {
