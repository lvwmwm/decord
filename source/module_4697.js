// Module ID: 4697
// Function ID: 4698
// Dependencies: [109, 19, 17, 21, 4695, 4686, 4679, 4698, 4685, 4701, 4674]
...
export default importAllResult.forwardRef(function ScreenStackItem(unstable_sheetFooter, ref) {
  ...
  importDefault(4679)(flag5, "[RNScreens] Using both `blurEffect` and `scrollEdgeEffects` simultaneously may cause overlapping effects.");
  ...
  obj[1] = callback(importDefault(4698), { contentStyle, style: container, stackPresentation, children });
  ...
  const tmp11 = importDefault(4679);
  ...
  return callback(importDefault(4674), obj2);
});
