...
// Dependencies: [1634, 5402, 5415]

// Module 5516 (useAnimatedSnapPoints)
const require = arg1;
...
arg5.useAnimatedSnapPoints = (snapPoints, containerHeight, contentHeight, handleHeight, arg4, enableDynamicSizing, maxDynamicContentSize) => {
  ...
  obj = { containerHeight, INITIAL_CONTAINER_HEIGHT: _require(5402).INITIAL_CONTAINER_HEIGHT, INITIAL_SNAP_POINT: _require(5402).INITIAL_SNAP_POINT, snapPoints, normalizeSnapPoint: _require(5415).normalizeSnapPoint, enableDynamicSizing, handleHeight, INITIAL_HANDLE_HEIGHT: _require(5402).INITIAL_HANDLE_HEIGHT, contentHeight, maxDynamicContentSize, dynamicSnapPointIndex: sharedValue };
  P.__closure = obj;
