...
// Function ID: 7418
// Name: updateSession
// Dependencies: [7393, 7394, 7418, 7408, 7405, 7400]
// Exports: closeSession, makeSession

// Module 7417 (updateSession)
...
function updateSession(ipAddress) {
  ...
  if (!timestamp) {
    timestamp = require(7408) /* dateTimestampInSeconds */.timestampInSeconds();
    const obj2 = require(7408) /* dateTimestampInSeconds */;
  }
  ...
  if (!obj.sid) {
    ...
    if (32 === obj.sid.length) {
      ...
      sid = require(7405) /* addContextToFrame */.uuid4();
