// Module ID: 12360
// Function ID: 12361
// Dependencies: [5, 12294, 12357, 12361, 12362, 12363, 12356]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12294).util;
    ...
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12356).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12356).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12356).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
