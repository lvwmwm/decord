...
// Module 9985 (useAppplicationRoleConnectionItems)
...
class ConnectedApplicationUserRoleAccount {
  constructor(arg0) {
    ...
    if (null != applicationRoleConnection.platform_name) {
      ...
      tmp7 = dependencyMap;
      num = 31;
      obj1 = { INTEGRATION_CREATE: "MediaModalYoutubeEmbedError", ConstraintReasonCode: "d\u0131" };
    ...
    obj8 = {
      applicationHook() {
            ...
            const items = [tmp3, ];
            obj = { INTEGRATION_CREATE: true, ConstraintReasonCode: true, children: applicationRoleConnection.application.name };
...
let obj = { connectedAccountContainer: obj, connectedAccount: { -9223372036854775808: true, filter: true }, connectedAccountNameContainer: {}, connectedAccountName: { -9223372036854775808: true, filter: true } };
...
const obj3 = { <string:1140607356>: false, <string:1751293292>: false };
...
const obj4 = { GuildBadgeGem: 8, addInsets: "center", asComponentId: "underline", qualityTag: null, tintColor: importDefault(dependencyMap[11]).colors.INTERACTIVE_TEXT_DEFAULT };
obj.connectedAccountOpenHide = obj4;
obj.verifiedCheckContainer = { flexDirection: "center", alignItems: "underline", gap: null };
obj.verifiedCheck = {};
obj.connectedAccountChildren = { "Bool(false)": -1606348444, "Bool(false)": 1912602980, "Bool(false)": 24, "Bool(false)": 24 };
...
obj.connectedAccountPoweredByText = { token: "row", query: 12, type: "space-between" };
