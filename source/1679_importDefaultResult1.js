...
// Dependencies: [41, 42, 90, 91, 1669, 1680, 1675, 1664, 1656, 1681]
...
const items = [
  ...
  },
  {
    ...
    value: function getViewProp(arg0, arg1, self) {
      self = this;
      if (obj.isFabric()) {
        const tmpResult = require(1681) /* getShadowNodeWrapperFromRef */;
        const shadowNodeWrapperFromRef = require(1681) /* getShadowNodeWrapperFromRef */.getShadowNodeWrapperFromRef(self);
