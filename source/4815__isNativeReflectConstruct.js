...
// Dependencies: [57, 7, 6, 15, 17, 18, 162, 4780, 4816, 4817, 4818]

// Module 4815 (_isNativeReflectConstruct)
...
function readTags(_raw, byteLength, arg2) {
  ...
  require(4780) /* getStringFromDataView */.objectAssign(_raw, parseXMPObject(convertToObject(tmp2, true)));
  return true;
}
...
function getDescription(arr) {
  ...
  if (Array.isArray(arr)) {
    ...
    if (tmp2) {
      tmp18 = tmp16;
      if ("function" === typeof importDefault(4818)[tmp2]) {
        tmp18 = importDefault(4818)[tmp](arr, tmp16);
        const tmp24 = importDefault(4818);
      }
    }
    return tmp18;
    ...
    if (tmp2) {
      if ("function" === typeof importDefault(4818)[tmp2]) {
        let decodeURIComponentResult = importDefault(4818)[tmp2](arr);
        const tmp11 = importDefault(4818);
      }
...
function parseNodeAsStructureRdfDescription(value, arg1) {
  ...
  let iter = value;
  if (undefined !== value.value["rdf:Description"]) {
    require(4780) /* getStringFromDataView */.objectAssign(obj.value, parseNodeAttributesAsTags(value.value["rdf:Description"].attributes));
    const obj2 = require(4780) /* getStringFromDataView */;
    require(4780) /* getStringFromDataView */.objectAssign(obj.attributes, parseNodeAttributes(value));
    iter = value.value["rdf:Description"];
    const obj3 = require(4780) /* getStringFromDataView */;
  }
  require(4780) /* getStringFromDataView */.objectAssign(obj.value, parseNodeChildrenAsTags(iter.value));
