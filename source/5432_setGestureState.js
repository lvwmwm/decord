...
// Dependencies: [5430, 5433, 5431]

// Module 5432 (setGestureState)
...
function create(handlerTag) {
  ...
  obj = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5431).State, warningMessage: closure_2 };
  T.__closure = obj;
  ...
  fn.__closure = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5431).State, warningMessage: closure_2 };
  ...
  const obj1 = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5431).State, warningMessage: closure_2 };
  fn2.__closure = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5431).State, warningMessage: closure_2 };
  fn2.__workletHash = 2856860112444;
  fn2.__initData = closure_8;
  obj[4] = fn2;
  return obj;
}
obj = { REANIMATED_AVAILABLE: tmp4, setGestureState, State: require("module_5431").State, warningMessage: tagMessageResult };
