...
// Module 4793 (getStringFromDataView)
const require = arg1;
const module = arg2;
...
arg5.default = {
  isWebpFile(dataView) {
    let tmp2 = !tmp;
    if (!!dataView) {
      tmp2 = require(4780) /* getStringFromDataView */.getStringFromDataView(dataView, 0, 4) === "RIFF";
      const obj = require(4780) /* getStringFromDataView */;
    }
    if (tmp2) {
      tmp2 = require(4780) /* getStringFromDataView */.getStringFromDataView(dataView, 8, 4) === "WEBP";
