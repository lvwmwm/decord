...
// Dependencies: [41, 42, 93, 95, 98, 1678, 1677]

// Module 1690 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    value: function springify(durationV) {
      return { durationV, type: ComplexAnimationBuilder(1678).withSpring };
    }
  },
  {
    key: "dampingRatio",
