...
// Dependencies: [32, 7522, 7528, 7517, 7530, 7500, 7512, 7513, 7514, 7507, 7505, 7523, 7495, 7527, 7531, 7533, 7524, 7534, 7536, 7510]
// Exports: continueTrace, startInactiveSpan, startNewTrace, startSpan, startSpanManual, suppressTracing, withActiveSpan

// Module 7529 (createChildOrRootSpan)
...
function _startRootSpan(name) {
  ...
  obj1.attributes = { [require(7510).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE]: "custom" };
  obj1.sampled = tmp6;
...
export const continueTrace = (arg0, arg1) => {
  ...
  let dependencyMap;
  const _require = arg1;
  const mainCarrier = _require(7513).getMainCarrier();
  const obj = _require(7513);
  const tmp = _require;
  const asyncContextStrategy = _require(7514).getAsyncContextStrategy(mainCarrier);
...
export const startInactiveSpan = function startInactiveSpan(experimental) {
  ...
  let asyncContextStrategy = _require(7514).getAsyncContextStrategy(mainCarrier);
...
export const startNewTrace = function startNewTrace(arg0) {
  const _require = arg0;
  return _require(7522).withScope((setPropagationContext) => {
