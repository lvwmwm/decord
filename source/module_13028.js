// Module ID: 13028
// Function ID: 13029
// Dependencies: [13022, 12993, 13013]

// Module 13028

export default (arg0, arg1) => {
  let require;
  let obj = new require(13022) /* Range */(arg0, arg1);
  const tmp3 = new require(12993) /* SemVer */("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(12993)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
        ...
        do {
          ...
          if (require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = require;
              tmp16 = !require(13013) /* SemVer */(tmp14, require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
