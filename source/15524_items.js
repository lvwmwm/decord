...
obj = { borderRadius: importDefault(dependencyMap[0]).radii.md, padding: { direction: true, radius: "/assets/design/components/Icon/native/redesign/generated/images", inset: 24 } };
obj.container = obj;
...
obj.typing = { position: { "Null": 10, "Null": 371 }, typingIndicator: { position: { "Null": false, "Null": false } }, avatarSize: require(dependencyMap[1]).AvatarSizes.REFRESH_MEDIUM_32 };
obj.activeThreadCount = { text: { variant: "text-xs/bold" } };
const obj4 = { text: { variant: "text-xs/bold" }, layout: {} };
const obj3 = { position: { "Null": 10, "Null": 371 }, typingIndicator: { position: { "Null": false, "Null": false } }, avatarSize: require(dependencyMap[1]).AvatarSizes.REFRESH_MEDIUM_32 };
