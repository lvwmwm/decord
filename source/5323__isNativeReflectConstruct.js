...
// Dependencies: [41, 42, 93, 95, 98, 19, 5277, 5280]

// Module 5323 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      try {
        ...
        const _Error = Error;
        const error = new Error(Wrap(5277).tagMessage("GestureDetector got more than one view as a child. If you want the gesture to work on multiple views, wrap them with a common parent and attach the gesture to that view."));
        throw error;
      }
    }
  }
