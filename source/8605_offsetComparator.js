...
// Dependencies: [19, 17, 8534, 8606, 8536]
// Exports: default

// Module 8605 (offsetComparator)
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
      ...
      while (true) {
        ...
        if (typeof tmp10 !== "reType") {
          ...
          if (!isNaN(num9)) {
            ...
            let items1 = [num9, 16777215 & tmp10 | Math.round(255 * importDefault(8534)(stopOpacity)) << 24];
    ...
    if (gradientUnits) {
      num12 = importDefault(8606)[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
    ...
    obj[4] = importDefault(8536)(gradientTransform);
    return obj;
  } else {
    return null;
  }
