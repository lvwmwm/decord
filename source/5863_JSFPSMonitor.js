...
// Function ID: 5864
// Name: JSFPSMonitor
// Dependencies: [5810, 5811, 5798, 5864]

// Module 5863 (JSFPSMonitor)
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        error = new Error(JSFPSMonitor(5798).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      const obj = { minFPS: JSFPSMonitor(5864).roundToDecimalPlaces(self.minFPS, 1), maxFPS: null, averageFPS: null };
      const obj2 = JSFPSMonitor(5864);
      obj[1] = JSFPSMonitor(5864).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(5864);
      obj[2] = JSFPSMonitor(5864).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    }
  }
];
