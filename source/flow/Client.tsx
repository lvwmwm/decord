...
// Module 4060 (GuildThemeSourcePreference)
const _module = require(dependencyMap[0]);
const result = _module.fileFinishedImporting("flow/Client.tsx");

export const GuildThemeSourcePreference = require(dependencyMap[1]).GuildThemeSourcePreference;
