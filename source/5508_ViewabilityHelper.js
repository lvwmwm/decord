...
// Dependencies: [5491, 5492, 5479]

// Module 5508 (ViewabilityHelper)
      ...
      if (null !== prop) {
        ...
        if (undefined !== prop1) {
          ...
          if (null !== prop2) {
            ...
            if (undefined !== prop3) {
              const _Error = Error;
              const error = new Error(timerId(5479).ErrorMessages.multipleViewabilityThresholdTypesNotSupported);
              throw error;
            }
          }
        }
