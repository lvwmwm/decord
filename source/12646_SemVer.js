...
export default () => {
  class SemVer {
    constructor(arg0, arg1) {
      ...
      if (version.length > SemVer(closure_1[3]).MAX_LENGTH) {
        tmp34 = globalThis;
        ...
        tmp37 = new.target;
        tmp38 = new.target;
        typeError1 = new TypeError("version is longer than " + SemVer(closure_1[3]).MAX_LENGTH + " characters");
        tmp40 = typeError1;
        throw typeError1;
      } else {
        tmp41 = SemVer;
        ...
        num2 = 4;
        str14 = "SemVer";
        tmp43 = SemVer(closure_1[4])("SemVer", version, tmp2);
        self.options = tmp2;
        ...
        tmp45 = closure_1;
        num3 = 5;
        safeRe = SemVer(closure_1[5]).safeRe;
        t = SemVer(closure_1[5]).t;
        if (tmp2.loose) {
          tmp9 = safeRe[t.LOOSE];
        } else {
          tmp9 = safeRe[t.FULL];
        ...
        if (match) {
          ...
          tmp16 = SemVer;
          tmp17 = closure_1;
          if (self.major <= SemVer(closure_1[3]).MAX_SAFE_INTEGER) {
            num4 = 0;
            if (self.major >= 0) {
              tmp46 = SemVer;
              tmp47 = closure_1;
              if (self.minor <= SemVer(closure_1[3]).MAX_SAFE_INTEGER) {
                if (self.minor >= 0) {
                  tmp48 = SemVer;
                  tmp49 = closure_1;
                  if (self.patch <= SemVer(closure_1[3]).MAX_SAFE_INTEGER) {
                    if (self.patch >= 0) {
                      if (match[4]) {
                        str5 = match[4];
                        str6 = ".";
                        ...
                        self.prerelease = parts.map((arg0) => {
                          if (obj.test(arg0)) {
                            if (+arg0 >= 0) {
                              if (tmp < callback(closure_1[3]).MAX_SAFE_INTEGER) {
                                return tmp;
                              }
                            }
                          }
  ...
  obj = {
    ...
    value: function compare(loose) {
      const self = this;
      SemVer(closure_1[4])("SemVer.compare", this.version, this.options, loose);
      let tmp2 = loose;
  ...
  items[3] = {
    ...
    value: function compareMain(loose) {
      ...
      let compareIdentifiersResult = SemVer(closure_1[6]).compareIdentifiers(self.major, tmp.major);
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = SemVer(closure_1[6]).compareIdentifiers(self.minor, tmp.minor);
        const obj2 = SemVer(closure_1[6]);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = SemVer(closure_1[6]).compareIdentifiers(self.patch, tmp.patch);
        const obj3 = SemVer(closure_1[6]);
      }
  ...
  items[4] = {
    ...
    value: function comparePre(loose) {
      ...
      while (true) {
        ...
        let tmp11 = tmp6;
        let tmp12 = tmp7;
        let tmp13 = SemVer(closure_1[4])("prerelease compare", num3, tmp6, tmp7);
  ...
  items[5] = {
    ...
    value: function compareBuild(loose) {
      ...
      while (true) {
        ...
        let tmp11 = tmp6;
        let tmp12 = tmp7;
        let tmp13 = SemVer(closure_1[4])("build compare", num, tmp6, tmp7);
        let tmp14 = undefined === tmp6;
        let tmp15 = num;
        if (tmp14) {
          if (undefined === tmp7) {
  ...
  items[6] = {
    ...
    value: function inc(arg0, major2) {
      ...
      if ("premajor" === arg0) {
        ...
        self.patch = 0;
        self.prerelease = [];
        const tmp21 = 0 === self.minor && 0 === self.patch && 0 !== self.prerelease.length;
      } else if ("minor" === arg0) {
        if (!tmp20) {
          self.minor = self.minor + 1;
        }
        self.patch = 0;
        self.prerelease = [];
        const tmp20 = 0 === self.patch && 0 !== self.prerelease.length;
      } else if ("patch" === arg0) {
        if (0 === self.prerelease.length) {
