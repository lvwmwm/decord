...
// Dependencies: [7353, 5, 7358, 4167, 653, 686, 4361, 507, 3797, 7359, 6812, 4027, 3796, 3789, 4443, 4452, 1327, 2, 7360]
// Exports: addTracingHeadersToFetchRequest, instrumentFetchRequest

// Module 7331 (_addTracingHeadersToFetchRequest)
    ...
    if (headers) {
      ...
      if (isInstanceOfResult1) {
        ...
        if (Array.isArray(headers)) {
          ...
          if (baggage) {
            const items3 = [544342017, baggage];
