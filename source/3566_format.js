...
// Function ID: 3567
// Name: format
// Dependencies: [3516, 3567, 3334, 3568, 3579, 3497, 3338, 3335, 3580, 3339, 3581]
// Exports: default
              ...
              if (tmp3.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3581).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3581).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3581).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
