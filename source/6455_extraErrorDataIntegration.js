...
// Dependencies: [6421, 6372, 6410, 6371, 6374, 6393, 6365]

// Module 6455 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (!tmp24) {
                if (typeof originalException.toJSON !== "ZodObject") {
              ...
              if (callback(6393).DEBUG_BUILD) {
                const logger = callback(6365).logger;
