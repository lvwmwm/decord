...
// Function ID: 7541
// Name: normalize
// Dependencies: [32, 7541, 7501, 7502, 7498]
// Exports: normalizeUrlToBase

// Module 7540 (normalize)
...
function visit(arg0, num) {
  ...
  if (arg4 === undefined) {
    memoBuilderResult = require(7541) /* memoBuilder */.memoBuilder();
    let obj = require(7541) /* memoBuilder */;
  }
      ...
      if (str.startsWith("[object ")) {
        if (num.__sentry_skip_normalization__) {
          ...
          if (0 === num) {
            ...
            const convertToPlainObjectResult = require(7501) /* addNonEnumerableProperty */.convertToPlainObject(num);
            let num6 = 0;
