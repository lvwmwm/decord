...
// Function ID: 6393
// Name: getClient
// Dependencies: [6383, 6384, 6366, 6386, 6371]

// Module 6392 (getClient)
const require = arg1;
...
arg5.getGlobalScope = function getGlobalScope() {
  return require(6366) /* getGlobalSingleton */.getGlobalSingleton("globalScope", () => {
...
arg5.getTraceContextFromScope = function getTraceContextFromScope(getPropagationContext) {
  ...
  return require(6371) /* addNonEnumerableProperty */.dropUndefinedKeys({ trace_id, span_id, parent_span_id });
};
arg5.withIsolationScope = function withIsolationScope() {
  ...
  const obj2 = require(6384) /* getAsyncContextStrategy */;
};
