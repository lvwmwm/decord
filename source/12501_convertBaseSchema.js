...
// Dependencies: [32, 12496, 12497, 12495, 12489]

// Module 12501 (convertBaseSchema)
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema(flag, defaultTarget) {
      if (typeof flag === "boolean") {
        ...
        if (registry == null) {
          registry = require(12489) /* $output */.globalRegistry;
        }
        obj[5] = registry;
        return convertSchema(flag, obj);
      }
    };
    const fnResult = fn(require("module_12496"));
    let obj = {};
    let merged = Object.assign(fn(require("module_12495")));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(require("module_12497"));
    let _Set = Set;
