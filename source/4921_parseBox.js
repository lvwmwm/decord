...
// Function ID: 4922
// Name: parseBox
// Dependencies: [4922, 4915, 4912]

// Module 4921 (parseBox)
const require = arg1;
const module = arg2;
...
function parseBox(getUint32, sum) {
  ...
  if (length >= 8) {
    ...
    if (1718909296 === uint321) {
      ...
      obj1[1] = require(4912) /* getDataView */.getStringFromDataView(getUint32, contentOffset, 4);
      obj1[2] = length;
      return obj1;
      ...
      const stringFromDataView = require(4912) /* getDataView */.getStringFromDataView(getUint32, contentOffset, 4);
      ...
      if (1835365473 === uint321) {
        ...
        const obj13 = require(4922) /* parseItemLocationBox */;
