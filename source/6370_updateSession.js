...
// Function ID: 57048
// Name: updateSession
// Dependencies: [6346, 6347, 6371, 6361, 6358, 6353]
// Exports: closeSession, makeSession

// Module 6370 (updateSession)
...
function updateSession(ipAddress) {
  if (arguments.length > 1) {
    ...
    if (!timestamp) {
      timestamp = require(6361) /* dateTimestampInSeconds */.timestampInSeconds();
    ...
    if (!obj.sid) {
      ...
      if (32 === obj.sid.length) {
        ...
        sid = require(6358) /* getFirstException */.uuid4();
        const obj3 = require(6358) /* getFirstException */;
      }
      ipAddress.sid = sid;
    }
  }
