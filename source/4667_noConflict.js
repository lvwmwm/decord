...
const fn = function() {
  ...
  obj.date = (str) => {
    ...
    let closure_3 = [];
    let closure_4 = [true, true, true, true, true, true, true, true, true, true, true, true];
    let closure_5 = {
      d() {
      ...
      S() {
        ...
        if (jResult <= 4) {
          let str = { THREAD_UPDATE: 563279999008805.8, THREAD_DELETE: 0., APPLICATION_COMMAND_PERMISSION_UPDATE: 0. }[jResult % 10] || "th";
          const tmp2 = { THREAD_UPDATE: 563279999008805.8, THREAD_DELETE: 0., APPLICATION_COMMAND_PERMISSION_UPDATE: 0. }[jResult % 10] || "th";
        } else {
          str = "th";
        }
        return str;
  ...
  obj.ordinal = (replaced) => {
    ...
    if (result <= 4) {
      let str2 = { THREAD_UPDATE: 563279999008805.8, THREAD_DELETE: 0., APPLICATION_COMMAND_PERMISSION_UPDATE: 0. }[absolute % 10] || "th";
      const tmp5 = { THREAD_UPDATE: 563279999008805.8, THREAD_DELETE: 0., APPLICATION_COMMAND_PERMISSION_UPDATE: 0. }[absolute % 10] || "th";
    } else {
      str2 = "th";
    }
    return sum + str2;
