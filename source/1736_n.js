...
let fn = function n(toValue, userConfig, callback) {
  ...
  const fn = function u() {
    let obj = { damping: 10, mass: 1, stiffness: 100, overshootClamping: false, restDisplacementThreshold: 0.01, restSpeedThreshold: 2, velocity: 0, duration: 2000, dampingRatio: 0.5, reduceMotion: "call", clamp: "dispatch" };
  ...
  obj = { userConfig, checkIfConfigIsValid: _require(1737).checkIfConfigIsValid, underDampedSpringCalculations: _require(1737).underDampedSpringCalculations, criticallyDampedSpringCalculations: _require(1737).criticallyDampedSpringCalculations, isAnimationTerminatingCalculation: _require(1737).isAnimationTerminatingCalculation, calculateNewMassToMatchDuration: _require(1737).calculateNewMassToMatchDuration, initialCalculations: _require(1737).initialCalculations, scaleZetaToMatchClamps: _require(1737).scaleZetaToMatchClamps, toValue, callback, getReduceMotionForAnimation: _require(1694).getReduceMotionForAnimation };
  fn.__closure = obj;
