...
// Module 13129
let tmp = require("result").process && require("result").process.versions;
if (!tmp) {
  tmp = require("result").Deno && require("result").Deno.version;
  const tmp2 = require("result").Deno && require("result").Deno.version;
}
let str = tmp;
if (tmp) {
  str = tmp.v8;
