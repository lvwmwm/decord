...
// Function ID: 102343
// Name: countSymbols
// Dependencies: [13373, 13374, 488, 13375]

// Module 13372 (countSymbols)
const require = arg1;
let dependencyMap = exports;
dependencyMap = arg6;
function countSymbols(buffer) {
  const ucs2 = require(13373) /* error */.ucs2;
...
function isWindowsDriveLetterString(buffer) {
  ...
  if (isASCIIAlphaResult) {
    isASCIIAlphaResult = require(13374) /* isASCIIDigit */.isASCIIAlpha(buffer.codePointAt(0));
    const obj = require(13374) /* isASCIIDigit */;
  }
  if (isASCIIAlphaResult) {
    let tmp4 = ":" === buffer[1];
    if (!tmp4) {
  ...
  if (isUserinfoPercentEncode(codePointAtResult)) {
    ...
    if (0 < fromResult.length) {
      do {
        ...
        let obj = require(13375) /* replaceByteInByteSequence */;
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    if ("]" !== buffer[buffer.length - 1]) {
      ...
      let ucs2 = require(13373) /* error */.ucs2;
          ...
          if (58 !== decodeResult[num9]) {
            ...
            if (obj2.isASCIIHex(decodeResult[num9])) {
              ...
              while (sum2 < 4) {
                ...
                let obj3 = require(13374) /* isASCIIDigit */;
                tmp44 = sum1;
                num16 = sum;
                num17 = sum2;
                tmp45 = sum1;
                  ...
                  if (undefined === decodeResult[diff1]) {
                    ...
                    while (true) {
                      ...
                      if (num20 <= 0) {
                        ...
                        let obj4 = require(13374) /* isASCIIDigit */;
                        if (obj4.isASCIIDigit(decodeResult[sum7])) {
                          let tmp59 = require;
                          let tmp60 = dependencyMap;
                          let obj5 = require(13374) /* isASCIIDigit */;
                          let tmp61 = sum7;
                          let tmp62 = null;
                          diff1 = sum7;
                          let tmp64 = null;
                            ...
                            while (true) {
                              ...
                              if (null === tmp62) {
                                if (sum6 > 255) {
                                  ...
                                  let obj7 = require(13374) /* isASCIIDigit */;
                                  tmp61 = sum5;
                                  tmp62 = sum6;
                                  diff1 = sum5;
                                  tmp64 = sum6;
    ...
    const _Buffer = require(488) /* createBuffer */.Buffer;
    const obj = require(13375) /* replaceByteInByteSequence */;
    let str2 = require(13375) /* replaceByteInByteSequence */.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str2) {
      str2 = closure_4;
    }
    if (str2 === closure_4) {
    ...
    let str = require(13375) /* replaceByteInByteSequence */.percentDecode(_Buffer.from(buffer));
  }
...
function startsWithWindowsDriveLetter(input, pointer) {
  ...
  let tmp2 = diff >= 2;
  if (tmp2) {
    let isASCIIAlphaResult = require(13374) /* isASCIIDigit */.isASCIIAlpha(input[pointer]);
    if (isASCIIAlphaResult) {
      let tmp7 = 58 === tmp3;
      if (!tmp7) {
        tmp7 = 124 === tmp3;
