...
// Dependencies: [41, 42, 93, 95, 98, 19, 6447, 6413, 6435, 6433]

// Module 6446 (_isNativeReflectConstruct)
...
import importDefaultResult3 from "PlatformConstants" /* 6447 */;
...
let obj = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(6413).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  obj,
