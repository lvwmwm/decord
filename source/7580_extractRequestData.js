...
// Dependencies: [7581, 7582, 7583, 7506, 7544, 7508, 7498, 7499, 7505]

// Module 7580 (extractRequestData)
const require = arg1;
  ...
  if (!obj.customRoute) {
    if (!method.route) {
      ...
      if (tmp) {
        ...
        str5 = require(7581) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
        str4 = "url";
        const obj2 = require(7581) /* getNumberOfUrlSegments */;
      }
...
arg5.httpRequestToRequestData = function httpRequestToRequestData(headers) {
  ...
  return require(7505) /* addNonEnumerableProperty */.dropUndefinedKeys(obj);
};
