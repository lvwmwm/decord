...
arg5.parseAnyDigitsSigned = function parseAnyDigitsSigned(str) {
  const match = str.match(require(3781).numericPatterns.anyDigitsSigned);
  let tmp2 = null;
  if (match) {
    const obj = { value: null, rest: null };
...
arg5.parseNDigits = function parseNDigits(length, str) {
  if (1 === length) {
    const match = str.match(require(3781).numericPatterns.singleDigit);
    let tmp20 = null;
    if (match) {
    ...
    const match1 = str.match(require(3781).numericPatterns.twoDigits);
    let tmp15 = null;
    if (match1) {
    ...
    const match2 = str.match(require(3781).numericPatterns.threeDigits);
    let tmp10 = null;
    if (match2) {
    ...
    const match3 = str.match(require(3781).numericPatterns.fourDigits);
    let tmp5 = null;
    if (match3) {
...
arg5.parseNDigitsSigned = function parseNDigitsSigned(length, str) {
  if (1 === length) {
    const match = str.match(require(3781).numericPatterns.singleDigitSigned);
    let tmp20 = null;
    if (match) {
      let obj = { value: null, rest: null };
      const _parseInt5 = parseInt;
    ...
    const match1 = str.match(require(3781).numericPatterns.twoDigitsSigned);
    let tmp15 = null;
    if (match1) {
      obj = { value: null, rest: null };
      const _parseInt4 = parseInt;
    ...
    const match2 = str.match(require(3781).numericPatterns.threeDigitsSigned);
    let tmp10 = null;
    if (match2) {
      const obj1 = { value: null, rest: null };
      const _parseInt3 = parseInt;
    ...
    const match3 = str.match(require(3781).numericPatterns.fourDigitsSigned);
    let tmp5 = null;
    if (match3) {
      const obj2 = { value: null, rest: null };
      const _parseInt2 = parseInt;
...
arg5.parseTimezonePattern = function parseTimezonePattern(basic, str) {
  ...
  if (match) {
    if ("Z" === match[0]) {
      ...
      obj = { value: null, rest: null };
      const result = num2 * require(3651) /* keys */.millisecondsInHour;
      const sum = result + num4 * require(3651) /* keys */.millisecondsInMinute;
      obj[0] = num * (sum + num6 * require(3651) /* keys */.millisecondsInSecond);
      obj[1] = str.slice(match[0].length);
      return obj;
    }
  } else {
