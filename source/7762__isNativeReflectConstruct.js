...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 7763, 7764, 7765, 7766, 7770, 7771, 7772, 7782]

// Module 7762 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(7764)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(7765)(tmp, tmp, this);
      ...
      if (transform) {
        ...
        tmp.transform = self(7766).extractTransformSvgView(tmp);
        const obj3 = self(7766);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(7771)({ viewBox, preserveAspectRatio }));
      obj.children = jsx(importDefault(7772), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(7770), {});
    }
  }
];
