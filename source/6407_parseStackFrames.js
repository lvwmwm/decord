...
// Dependencies: [57, 77, 6353, 6354, 6392, 6358]
// Exports: eventFromMessage, eventFromUnknownInput

// Module 6407 (parseStackFrames)
...
function getMessageForObject(name) {
  ...
  const result = require(6353) /* addNonEnumerableProperty */.extractExceptionKeysForMessage(name);
...
function getException(getOptions, arg1, arg2, syntheticException) {
  if (obj.isError(arg2)) {
    ...
    if (obj2.isPlainObject(arg2)) {
      ...
      const tmp13 = _defineProperty({}, "__serialized__", require(6392) /* normalize */.normalizeToSize(arg2, normalizeDepth));
      let tmp16;
      ...
      const obj3 = require(6392) /* normalize */;
    } else {
      if (syntheticException) {
    ...
    obj2 = require(6354) /* isBuiltin */;
  }
  obj = require(6354) /* isBuiltin */;
}
    ...
    if (tmp) {
      if (tmp.syntheticException) {
        ...
        if (arr.length) {
          ...
          const result = require(6358) /* getFirstException */.addExceptionMechanism(obj, obj2);
          const obj5 = require(6358) /* getFirstException */;
        }
      }
    }
  }
...
export const eventFromUnknownInput = function eventFromUnknownInput(arg0, arg1, arg2, data) {
  ...
  const result = require(6358) /* getFirstException */.addExceptionTypeValue(obj, undefined, undefined);
  const obj4 = require(6358) /* getFirstException */;
  const result1 = require(6358) /* getFirstException */.addExceptionMechanism(obj, data);
  const obj1 = {};
  let event_id = data;
  if (data) {
