...
// Dependencies: [41, 42, 90, 91, 1622, 1633, 1628, 1617, 1609, 1634]
// Exports: createNativeReanimatedModule

// Module 1632 (importDefaultResult1)
...
class NativeReanimatedModule {
  constructor() {
    ...
    DummyReanimatedModuleProxy._REANIMATED_VERSION_JS = require("module_1633").jsVersion;
...
const items = [
  ...
  },
  {
    ...
    value: function getViewProp(arg0, arg1, self) {
      self = this;
      if (obj.isFabric()) {
        const tmpResult = require(1634) /* getShadowNodeWrapperFromRef */;
        const shadowNodeWrapperFromRef = require(1634) /* getShadowNodeWrapperFromRef */.getShadowNodeWrapperFromRef(self);
