...
// Function ID: 7798
// Name: ScopeClass
// Dependencies: [32, 41, 42, 7786, 7798, 7799, 7783, 7790, 7801, 7787, 7776]

// Module 7797 (ScopeClass)
...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      obj1 = ScopeClass(7786);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(7786);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(7799).updateSession(self._session, obj);
        const obj2 = ScopeClass(7799);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(7798)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(7798);
      obj[0] = ScopeClass(7786).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(7790).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, extra: this._extra, user: this._user, level: this._level, fingerprint: tmp, eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: ScopeClass(7798)._getSpanForScope(self) };
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(7801).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      const obj = { spanId: ScopeClass(7786).generateSpanId() };
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(7776).logger;
