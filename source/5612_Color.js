...
obj = {
  ...
  string(arg0) {
    const self = this;
    let self2 = this;
    if (!(this.model in require(5617) /* hasOwnProperty */.to)) {
      self2 = self.rgb();
    }
    let num = 1;
    ...
    const to = require(5617) /* hasOwnProperty */.to;
  ...
  percentString(arg0) {
    ...
    const rgb = require(5617) /* hasOwnProperty */.to.rgb;
  ...
  object() {
    const self = this;
    const obj = {};
    const channels = require(5613) /* keys */[this.model].channels;
    for (let num = 0; num < channels; num = num + 1) {
      obj[require(5613) /* keys */[this.model].labels[num]] = self.color[num];
    }
    if (1 !== self.valpha) {
  ...
  keyword(color) {
    if (undefined !== color) {
      ...
      const self = this;
      keywordResult = require(5613) /* keys */[this.model].keyword(this.color);
      const obj = require(5613) /* keys */[this.model];
    }
