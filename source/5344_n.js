...
const fn = function n(arg0) {
  ...
  if (!configs) {
    configs = require(5326) /* GESTURE_SOURCE */.ANIMATION_CONFIGS;
  }
  ...
  if (!("duration" in configs)) {
    if (!("easing" in configs)) {
      let tmp3 = require;
      let TIMING = require(5326) /* GESTURE_SOURCE */.ANIMATION_METHOD.SPRING;
    }
  ...
  TIMING = require(5326) /* GESTURE_SOURCE */.ANIMATION_METHOD.TIMING;
  tmp3 = require;
};
