...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7954, 7958, 7959, 7891, 7900]
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = importDefault(7954)[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = importDefault(7954)[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
