...
// Dependencies: [5, 41, 42, 93, 95, 98, 19, 17, 21, 81, 8141, 4014, 8143, 8144, 8145, 8163]
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f115123);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f115123);
    ...
    f115123 = undefined;
    f115123 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8143").NONE, require("module_8143").INVERT, require("module_8143").MONOCHROME, require("module_8143").POSTERIZE, require("module_8143").FALSE, require("module_8143").MAXIMUMCOMPONENT, require("module_8143").MINIMUMCOMPONENT, require("module_8143").CHROME, require("module_8143").FADE, require("module_8143").INSTANT, require("module_8143").MONO, require("module_8143").NOIR, require("module_8143").PROCESS, require("module_8143").TONAL, require("module_8143").TRANSFER, require("module_8143").SEPIA];
...
const items4 = [require("module_8144").CLEARKEY, require("module_8144").FAIRPLAY, require("module_8144").WIDEVINE, require("module_8144").PLAYREADY];
...
const items8 = [require("module_8163").SRT, require("module_8163").TTML, require("module_8163").VTT];
...
export const TextTrackType = require("module_8163");
export const FilterType = require("module_8143");
export const DRMType = require("module_8144");
