...
// Function ID: 1823
// Name: o
// Dependencies: [1823, 1697, 1824, 1665, 1806, 1698]
...
const fn = function o(arg0, arg1, h, useCorrectedHSVInterpolation) {
  ...
  if (undefined !== useCorrectedHSVInterpolation) {
    if (!useCorrectedHSVInterpolation) {
      let tmp = require;
      const obj = require(1823) /* getVal */;
      let interpolateResult = obj.interpolate(arg0, arg1, h.h, require(1823) /* getVal */.Extrapolation.CLAMP);
    }
    let tmpResult = tmp(1823);
    const interpolateResult1 = tmpResult.interpolate(arg0, arg1, h.s, tmp(1823).Extrapolation.CLAMP);
    tmpResult = tmp(1823);
    const interpolateResult2 = tmpResult.interpolate(arg0, arg1, h.v, tmp(1823).Extrapolation.CLAMP);
    const tmpResult1 = tmp(1823);
    const tmpResult2 = tmp(1697);
    return tmpResult2.hsvToColor(interpolateResult, interpolateResult1, interpolateResult2, tmpResult1.interpolate(arg0, arg1, h.a, tmp(1823).Extrapolation.CLAMP));
  }
  const items = [arg1[0]];
  h = h.h;
  const items1 = [h[0]];
  ...
  interpolateResult = (require(1823) /* getVal */.interpolate(arg0, items, items1, require(1823) /* getVal */.Extrapolation.CLAMP) + 1) % 1;
  tmp = require;
};
...
const fn4 = function a(arg0, arg1, arg2, gamma) {
  ...
  const interpolateResult = num(1823).interpolate(arg0, arg1, tmp3, num(1823).Extrapolation.CLAMP);
  const obj = num(1823);
  const interpolateResult1 = num(1823).interpolate(arg0, arg1, tmp2, num(1823).Extrapolation.CLAMP);
  const obj2 = num(1823);
  const interpolateResult2 = num(1823).interpolate(arg0, arg1, mapped2, num(1823).Extrapolation.CLAMP);
  const obj3 = num(1823);
  const interpolateResult3 = num(1823).interpolate(arg0, arg1, arg2.a, num(1823).Extrapolation.CLAMP);
  if (1 === num) {
    let tmp6Result = tmp6(1697);
    let rgbaColorResult = tmp6Result.rgbaColor(interpolateResult, interpolateResult1, interpolateResult2, interpolateResult3);
  } else {
    tmp6Result = tmp6(1697);
...
const fn5 = function n(arg0, arg1, l) {
  ...
  let r;
  const obj = require(1823) /* getVal */;
  const interpolateResult = require(1823) /* getVal */.interpolate(arg0, arg1, l.l, require(1823) /* getVal */.Extrapolation.CLAMP);
  const obj2 = require(1823) /* getVal */;
  const interpolateResult1 = require(1823) /* getVal */.interpolate(arg0, arg1, l.a, require(1823) /* getVal */.Extrapolation.CLAMP);
  const obj3 = require(1823) /* getVal */;
  const interpolateResult2 = require(1823) /* getVal */.interpolate(arg0, arg1, l.b, require(1823) /* getVal */.Extrapolation.CLAMP);
  const obj4 = require(1823) /* getVal */;
  const convert = importDefault(1824).oklab.convert;
  const interpolateResult3 = require(1823) /* getVal */.interpolate(arg0, arg1, l.alpha, require(1823) /* getVal */.Extrapolation.CLAMP);
  ({ r, g, b, alpha } = convert.toRgb({ l: interpolateResult, a: interpolateResult1, b: interpolateResult2, alpha: require(1823) /* getVal */.interpolate(arg0, arg1, l.alpha, require(1823) /* getVal */.Extrapolation.CLAMP) }));
  const toRgbResult = convert.toRgb({ l: interpolateResult, a: interpolateResult1, b: interpolateResult2, alpha: require(1823) /* getVal */.interpolate(arg0, arg1, l.alpha, require(1823) /* getVal */.Extrapolation.CLAMP) });
  return require(1697) /* call */.rgbaColor(r, g, b, alpha);
};
...
const fn9 = function i(arg0) {
  const tmp = fn6(arg0, (arg0) => {
    const convert = callback2(1824).oklab.convert;
...
function interpolateColor(arg0, arg1, arg2) {
  ...
  if ("HSV" === str) {
    ...
    const reanimatedError = new require(1665) /* t */.ReanimatedError("Invalid color space provided: " + str + ". Supported values are: ['RGB', 'HSV', 'LAB'].");
...
export const useInterpolateConfig = function useInterpolateConfig(inputRange, outputRange, arg2, UNDETERMINED) {
  ...
  obj4 = require(1698) /* isReanimated3 */;
  obj[3] = obj4.makeMutable(null);
  obj[4] = obj;
  return require(1806) /* useSharedValue */.useSharedValue(obj);
};
