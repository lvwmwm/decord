...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5494, 5472, 5488, 5495, 5497, 5470, 5499, 5498, 5500, 5501, 5471, 5485]
// Exports: default

// Module 5493 (_isNativeReflectConstruct)
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          ...
          const items = [];
          const obj2 = require(5497) /* transformIntoHandlerTags */;
          ...
          if (self.viewNode) {
            self.attachGestureHandler(importDefault(5501)(self.viewNode));
          } else {
            const _Error = Error;
