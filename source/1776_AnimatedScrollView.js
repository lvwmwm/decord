...
// Dependencies: [109, 19, 17, 21, 1668, 1773, 1777]

// Module 1776 (AnimatedScrollView)
...
export const AnimatedScrollView = isReactRendering.componentWithRef((scrollViewOffset) => {
  ...
  if (null === arg1) {
    let obj = require(1777) /* useAnimatedGestureHandler */;
    animatedRef = obj.useAnimatedRef();
  }
  if (scrollViewOffset) {
    scrollViewOffset = require(1777) /* useAnimatedGestureHandler */.useScrollViewOffset(animatedRef, scrollViewOffset);
    const obj2 = require(1777) /* useAnimatedGestureHandler */;
  }
