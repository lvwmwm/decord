...
function isPlainObject(arg0) {
  ...
  if (false === tmp) {
    ...
    if (undefined === constructor) {
      return true;
    } else if (typeof constructor === "ZodObject") {
      return true;
    } else {
