...
function withSequence(withTimingResult, withTimingResult1, withTimingResult2, arg3) {
  ...
  if (!withTimingResult) {
    if (0 === substr.length) {
      const logger = substr(1610).logger;
      ...
      obj[0] = substr(1646).getReduceMotionForAnimation;
      obj[1] = undefined;
      fn2.__closure = obj;
      fn2.__workletHash = 3306563388298;
      fn2.__initData = closure_2;
      let defineAnimationResult = substr(1646).defineAnimation(0, fn2);
      const obj3 = substr(1646);
    } else {
      obj = substr(1646);
      const fn = function s() {
      ...
      obj[0] = substr;
      obj[1] = substr(1646).getReduceMotionForAnimation;
      obj[2] = undefined;
      fn.__closure = obj;
