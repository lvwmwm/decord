...
export const DayPeriodParser = (Parser) => {
  class DayPeriodParser {
    constructor() {
      if (this instanceof DayPeriodParser) {
        ...
        tmp19 = closure_8(applyResult, "incompatibleTokens", [217907203, 218038275, 218169347, -1326776317]);
        return applyResult;
      } else {
  ...
  const dependencyMap = DayPeriodParser;
  ...
  let obj = { EntryPointCommandButtonActions: null, NATIVE_SECTION: null, 1476351743: null, value: DayPeriodParser };
