...
// Function ID: 6368
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1501, 6359, 6368, 6369]
// Exports: Button

// Module 6367 (ButtonLink)
import noopAll from "noop" /* 19 */;
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1501 */;
import ColorDefault from "Color" /* 6359 */;
import Animated from "Animated" /* 6368 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj10.isDark()) {
      const obj2 = tmp9(6359)(color);
      str4 = tmp9(6359)(color).darken(0.71).string();
      const darkenResult = tmp9(6359)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
