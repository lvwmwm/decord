...
// Function ID: 94406
// Name: string
// Dependencies: [5, 65, 12035, 12098, 12102, 12103, 12104, 12097]

// Module 12101 (string)
import asyncGeneratorStep from "module_12103";
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class) {
      ...
      if (arguments.length > 1) {
        ...
        const util = _require(12035).util;
    ...
    let closure_9 = fn(require("module_12102"));
    let closure_10 = fn(require("module_12103"));
    let closure_11 = fn(require("module_12104"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      let obj = {};
      obj = { input: _require(12097).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12097).createStandardJSONSchemaMethod(_standard, "output") };
      obj.jsonSchema = obj;
      const merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12097).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
