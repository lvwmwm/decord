...
class peg$SyntaxError {
  constructor(arg0, arg1, arg2, arg3) {
    ...
    if (typeof Error.captureStackTrace !== "disabledUntil") {
      _Error = Error;
      tmp = peg$SyntaxError;
...
obj = {
  ...
  parse: function peg$parse(str) {
                                ...
                                if (tmp69() !== tmp54) {
                                  ...
                                  if (tmp67Result3 !== tmp54) {
                                    ...
                                    if (items2 !== tmp84) {
                                      ...
                                      if (tmp99 !== tmp84) {
                                        arr10 = peg$c8;
                                        if (typeof peg$c8 !== "fileFinishedImporting") {
                      ...
                      if (items5 !== arr10) {
                        ...
                        if (arr10 !== arr10) {
                          ...
                          if (items6 !== items7) {
                            ...
                            if (arr10 !== items7) {
                              arr10 = peg$c23;
                              if (typeof peg$c23 !== "fileFinishedImporting") {
                                arr10 = HermesBuiltin.throwTypeError();
                              }
                              arr10 = globalThis;
                              const _Math4 = Math;
                    ...
                    if (items9 !== arr10) {
                      ...
                      if (arr10 !== arr10) {
                        ...
                        if (items10 !== str14) {
                          ...
                          if (arr10 !== str14) {
                            arr10 = peg$c20;
                            if (typeof peg$c20 !== "fileFinishedImporting") {
                              arr10 = HermesBuiltin.throwTypeError();
                            }
                            arr10 = globalThis;
                            const _Math3 = Math;
                            ...
                            if (arr10 !== arr10) {
                              ...
                              if (items16 !== arr10) {
                                ...
                                if (items15 !== str10) {
                                  ...
                                  if (arr10 !== str10) {
                                    arr10 = peg$c17;
                                    if (typeof peg$c17 !== "fileFinishedImporting") {
                                      arr10 = HermesBuiltin.throwTypeError();
                                    }
                                    arr10 = globalThis;
                                    const _Math = Math;
                ...
                if (items19 !== arr10) {
                  ...
                  if (arr10 !== arr10) {
                    ...
                    if (peg$parsecommaWsp() !== arr10) {
                      ...
                      if (arr10 !== arr10) {
                        arr10 = peg$c26;
                        if (typeof peg$c26 !== "fileFinishedImporting") {
                          arr10 = HermesBuiltin.throwTypeError();
                        }
                        if (arr10 === arr10) {
                          arr10 = null;
                    ...
                    if (arr10 !== arr10) {
                      ...
                      if (num11 !== arr10) {
                        ...
                        if (items24 !== str2) {
                          ...
                          if (arr10 !== str2) {
                            arr10 = peg$c11;
                            if (typeof peg$c11 !== "fileFinishedImporting") {
                              arr10 = HermesBuiltin.throwTypeError();
                            }
    ...
    function peg$parsenumber() {
      ...
      if (charAtResult !== regex2) {
        ...
        if (joined1 !== tmp11) {
          ...
          let joined2 = obj4;
          if (obj4 !== tmp11) {
            if (typeof peg$c31 !== "fileFinishedImporting") {
              HermesBuiltin.throwTypeError();
            }
            joined2 = obj4.join("");
          }
          if (joined2 === tmp11) {
            ...
            if (tmp14Result !== tmp11) {
              ...
              let joined3 = obj5;
              if (obj5 !== tmp11) {
                if (typeof peg$c32 !== "fileFinishedImporting") {
                  HermesBuiltin.throwTypeError();
                }
                joined3 = obj5.join("");
              }
      ...
      if (parsed === regex2) {
        ...
        let parsed1 = obj6;
        if (obj6 !== tmp11) {
          if (typeof peg$c25 !== "fileFinishedImporting") {
            HermesBuiltin.throwTypeError();
          }
    ...
    function peg$parseexponent() {
      ...
      let joined = tmp12;
      if (tmp12 !== obj) {
        if (typeof peg$c39 !== "fileFinishedImporting") {
          HermesBuiltin.throwTypeError();
        }
        const items1 = [, , ];
    ...
    function peg$parsetransformList() {
      ...
      if (items !== tmp12) {
        ...
        if (tmp28 !== tmp12) {
          ...
          if (items1 !== tmp30) {
            let tmp26 = tmp28;
            if (typeof peg$c0 !== "fileFinishedImporting") {
              HermesBuiltin.throwTypeError();
            }
          } else {
            c48 = tmp;
