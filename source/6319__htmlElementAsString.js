...
// Module 6319 (_htmlElementAsString)
const require = arg1;
...
arg5.getComponentName = function getComponentName(arg0) {
  let parentNode = arg0;
  let num = 0;
  if (require(6312) /* getGlobalSingleton */.GLOBAL_OBJ.HTMLElement) {
    while (parentNode) {
...
arg5.getDomElement = function getDomElement(arg0) {
  let element = null;
  if (require(6312) /* getGlobalSingleton */.GLOBAL_OBJ.document) {
    element = null;
    if (require(6312) /* getGlobalSingleton */.GLOBAL_OBJ.document.querySelector) {
      const _document = require(6312) /* getGlobalSingleton */.GLOBAL_OBJ.document;
...
arg5.getLocationHref = function getLocationHref() {
  return require(6312) /* getGlobalSingleton */.GLOBAL_OBJ.document.location.href;
};
