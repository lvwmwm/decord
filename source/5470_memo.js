...
// Function ID: 5471
// Name: memo
// Dependencies: [19, 17, 21, 1606, 5323, 5316, 5312, 5339]
...
const memoResult = memo(function BottomSheetRefreshControlComponent(arg0) {
  ...
  let dependencyMap;
  let iter;
  const tmp4 = iter(scrollableGesture(5323).BottomSheetDraggableContext);
  dependencyMap = tmp4;
  let obj = scrollableGesture(5316);
  ...
  obj = { animatedScrollableState: iter, SCROLLABLE_STATE: tmp2(5312).SCROLLABLE_STATE };
  fn.__closure = obj;
  ...
  if (tmp7) {
    ...
    let tmp8Result = tmp8(tmp2(5339).GestureDetector, obj);
  } else {
    const obj2 = {};
