...
// Dependencies: [32, 109, 19, 17, 21, 5500, 5501, 5520, 5560, 5556]
// Exports: FlatList

// Module 5587 (importDefaultResult1)
...
export const FlatList = (ref) => {
  ...
  for (const item10028 of entries) {
    ...
    let NativeWrapperProps = require(5556) /* isGestureEnabled */.NativeWrapperProps;
    let tmp12 = first1;
    let tmp13 = tmp9;
