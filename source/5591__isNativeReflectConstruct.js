...
// Dependencies: [29, 6, 7, 15, 17, 18, 31, 27, 33, 5592, 5593, 5557, 5589, 5594, 5602, 5603, 5604]
...
import module_5603 from "module_5603";
...
export const getIsModalPresentation = function getIsModalPresentation(cardStyleInterpolator) {
  let tmp = cardStyleInterpolator === require(5604) /* Animated */.forModalPresentationIOS;
  if (!tmp) {
