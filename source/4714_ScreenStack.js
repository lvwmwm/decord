...
// Function ID: 4715
// Name: ScreenStack
// Dependencies: [109, 19, 21, 4699, 4715, 4693, 4700, 4716, 4703]
// Exports: default

// Module 4714 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_require(4715).GHContext);
  obj = {
  ...
  ref2(4699)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4699)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4703).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = mapped;
  obj1[6] = jsx(ref2(4716), {});
  ...
  return jsx(tmp4(4715).RNSScreensRefContext.Provider, { value: ref, children: null });
};
