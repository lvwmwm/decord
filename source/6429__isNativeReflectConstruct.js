...
// Dependencies: [93, 95, 98, 42, 41, 6430, 6413]

// Module 6429 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6413).isRemoteDebuggingEnabled();
        obj = ContinousBaseGesture(6413);
      }
      return tmp;
    }
  }
