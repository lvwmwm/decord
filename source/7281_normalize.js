...
// Function ID: 58676
// Name: normalize
// Dependencies: [57, 7282, 7242, 7243, 7239]
// Exports: normalizeUrlToBase

// Module 7281 (normalize)
...
function visit(arg0, __sentry_skip_normalization__) {
            ...
            if (obj.isVueViewModel(_events)) {
              ...
              if (obj2.isSyntheticEvent(_events)) {
                ...
                if ("function" === typeof _events) {
                  ...
                  return "[Function: " + outer1_1(outer1_2[4]).getFunctionName(_events) + "]";
          ...
          if (__sentry_skip_normalization__.__sentry_skip_normalization__) {
            ...
            if (0 === num) {
              ...
              while (true) {
                ...
                let obj3 = require(7242) /* addNonEnumerableProperty */;
  ...
  memoBuilderResult = require(7282) /* memoBuilder */.memoBuilder();
}
