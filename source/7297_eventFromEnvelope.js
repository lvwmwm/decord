          ...
          if (assign) {
            ...
            let tmp11Result = function makeOverrideReleaseTransport(arg0, assign) {
              return (arg0) => {
                ...
                const arg1 = tmp;
                const obj = {};
                const callback = callback2(/* F58880 */ function*() { ... });
    ...
    async function _send2(envelope, arg1) {
      const mapped = callback({
        ...
        if ("string" === typeof dsn) {
          let tmp2 = callback(dsn, undefined);
        } else {
          tmp2 = callback(dsn.dsn, dsn.release);
        }
        return tmp2;
      });
