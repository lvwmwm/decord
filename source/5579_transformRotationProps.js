...
// Module 5579 (transformRotationProps)
const require = arg1;
...
arg5.useRotationGesture = function useRotationGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(5556) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformRotationProps);
  const obj = require(5556) /* isGestureEnabled */;
  return require(5571) /* useGesture */.useGesture(require(5547) /* ComposedGestureName */.SingleGestureName.Rotation, clonedAndRemappedConfig);
};
