...
// Function ID: 7760
// Name: ScopeClass
// Dependencies: [32, 41, 42, 7748, 7760, 7761, 7745, 7752, 7763, 7749, 7738]
...
let items = [
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(7761).updateSession(self._session, obj);
        const obj2 = ScopeClass(7761);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(7760)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(7760);
      obj[0] = ScopeClass(7748).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(7752).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(7763).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(7738).logger;
