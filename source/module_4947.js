// Module ID: 4947
// Function ID: 4948
// Dependencies: [4948, 4949, 4950, 4951, 4952, 4945, 4944]
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = require(4945).FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = require(4945).FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = require(4945).FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
    ...
    fileChunk = require(4944) /* getFileChunk */.getFileChunk(fileChunk, num2);
