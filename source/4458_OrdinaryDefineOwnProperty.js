...
// Dependencies: [4395, 541, 4442, 4446, 542, 4459, 562, 4451, 4447, 4460, 4461]

// Module 4458 (OrdinaryDefineOwnProperty)
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (isObject(arg0)) {
    if (tmp(4442)(arg1)) {
      if (tmp(4446)(__Writable__)) {
        if (tmp(542)) {
          const tmp30 = tmp(542)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4447)(tmp30);
          }
          return tmp(4461)(arg0, arg1, tmp(4460)(arg0), __Writable__, tmp31);
        } else if (tmp(4459)(__Writable__)) {
          ...
          return tmp(4451)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
