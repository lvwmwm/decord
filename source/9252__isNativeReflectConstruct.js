...
// Dependencies: [41, 42, 93, 95, 98, 9246, 9247]
// Exports: Chi, Maj

// Module 9252 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function update(B) {
      ...
      let view;
      const self = this;
      HashMD(9247).exists(this);
      ({ buffer, blockLen, view } = this);
      const toBytesResult = HashMD(9246).toBytes(B);
      let num = 0;
  ...
  },
  {
    ...
    value: function digestInto(content) {
      ...
      const self = this;
      HashMD(9247).exists(this);
      HashMD(9247).output(content, this);
      this.finished = true;
      ...
      self.process(view, 0);
      view = HashMD(9246).createView(content);
