...
const fn = function() {
  ...
  obj.date = (str) => {
    ...
    let closure_3 = [];
    let closure_4 = ["1-\u0432\u043E \u0442\u0440\u0438\u043C\u0435\u0441.", "2-\u0440\u043E \u0442\u0440\u0438\u043C\u0435\u0441.", "3-\u0442\u043E \u0442\u0440\u0438\u043C\u0435\u0441.", "4-\u0442\u043E \u0442\u0440\u0438\u043C\u0435\u0441.", "cara", "cara durmiendo", "dormido", "sue\u00F1o", "zzz", 823346595756444300000000000000000000000000000000000000000000000, 12563289287386380000000000000000000000000000000000000000000, 0.];
    let closure_5 = {
      d() {
      ...
      S() {
        ...
        if (jResult <= 4) {
          let str = {}[jResult % 10] || "th";
          const tmp2 = {}[jResult % 10] || "th";
        } else {
          str = "th";
        }
        return str;
  ...
  obj.ordinal = (replaced) => {
    ...
    if (result <= 4) {
      let str2 = {}[absolute % 10] || "th";
      const tmp5 = {}[absolute % 10] || "th";
    } else {
      str2 = "th";
    }
    return sum + str2;
  ...
  obj.intword = (arg0, arg1, result) => {
    ...
    let str3 = arg6;
    if (!arg1) {
      items = [2060509169, 1313181603, -665590759, -731644408, 717902372];
    }
