...
// Module 5519 (transformHoverProps)
const require = arg1;
...
arg5.useHoverGesture = function useHoverGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(5495) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformHoverProps);
  const obj = require(5495) /* isGestureEnabled */;
  return require(5510) /* useGesture */.useGesture(require(5486) /* ComposedGestureName */.SingleGestureName.Hover, clonedAndRemappedConfig);
};
