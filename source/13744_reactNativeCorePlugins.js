...
// Dependencies: [5, 17, 82, 13745, 13747, 13749, 13750, 13753, 13754, 13767, 13769, 13771, 13772, 13773, 13774, 13755]

// Module 13744 (reactNativeCorePlugins)
...
import module_13753 from "module_13753";
import objectifyError from "objectifyError";
import onSend from "onSend";
import module_13769 from "module_13769";
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL !== "string") {
        ...
        return require(13774) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
