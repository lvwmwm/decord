...
// Dependencies: [19, 21, 5536, 5537, 5539]

// Module 5535 (ScrollableContainer)
import "noop";
...
export const ScrollableContainer = require("noop").forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  const tmp6 = jsx(require(5536) /* BottomSheetDraggableScrollable */.BottomSheetDraggableScrollable, { ref });
  let tmp2Result = tmp6;
  if (onRefresh) {
    ...
    obj[3] = onRefresh;
    obj[4] = require(5539) /* styles */.styles.container;
    obj[5] = tmp6;
    tmp2Result = jsx(importDefault(5537), { scrollableGesture: null, refreshing: null, progressViewOffset: null, onRefresh: null, style: null, children: null });
    const tmp9 = importDefault(5537);
  }
  return tmp2Result;
});
