...
// Function ID: 13662
// Name: formatToParts
// Dependencies: [1281, 13639, 13662, 13657, 13663, 13659]
// Exports: default

// Module 13661 (formatToParts)
...
const regExp = new RegExp("^".concat(_mod13662.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod13662.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13657).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13663).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13659).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
