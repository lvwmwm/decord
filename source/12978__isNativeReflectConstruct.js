...
// Module 12978 (_isNativeReflectConstruct)
let Animated;
...
const tmp5 = (Component) => {
  class ParallaxImage {
    constructor(arg0) {
      ...
      obj = { "Null": 570425343, "Null": 35190849, "Null": 666194432, "Null": 672213460 };
  ...
  items[4] = {
    ...
    value: function _onLoad(arg0) {
      ...
      if (this._mounted) {
        ...
        obj = { 9223372036854775807: "100%", "Null": "hidden", "Null": "flex-end", "Null": "row", "Null": "center", duration: tmp2, easing: closure_11.out(closure_11.quad) };
  ...
  items[7] = {
    ...
    get() {
      ...
      if (!tmp) {
        ...
        obj = { 1578303492: null, 2085683204: "badc2ccdf19fd542b091b55c09e8bee9", 1125270017: "ShopExternalSkus.compiled.messages", color: props.spinnerColor };
