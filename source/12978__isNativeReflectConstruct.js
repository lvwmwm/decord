...
const tmp4 = (PureComponent) => {
  ...
  items[4] = {
    ...
    value: function render() {
      ...
      let obj = { opacity: animOpacity.interpolate({ inputRange: ["replace", "then"], outputRange: items }) };
      ...
      obj = { scale: animTransform.interpolate({ inputRange: ["replace", "then"], outputRange: items1 }) };
