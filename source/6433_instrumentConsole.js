...
// Dependencies: [6345, 6348, 6347, 6353]

// Module 6433 (instrumentConsole)
const require = arg1;
const dependencyMap = arg6;
function instrumentConsole() {
  if ("console" in require(6348) /* getGlobalSingleton */.GLOBAL_OBJ) {
    const CONSOLE_LEVELS = require(6347) /* consoleSandbox */.CONSOLE_LEVELS;
...
arg5.addConsoleInstrumentationHandler = function addConsoleInstrumentationHandler(arg0) {
  require(6345) /* addHandler */.addHandler("console", arg0);
  const obj = require(6345) /* addHandler */;
  require(6345) /* addHandler */.maybeInstrument("console", instrumentConsole);
};
