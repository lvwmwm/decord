...
// Module 4440 (OrdinaryDefineOwnProperty)

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (require(4377) /* isObject */(arg0)) {
    if (tmp(4424)(arg1)) {
      if (tmp8(4428)(__Writable__)) {
        if (tmp15(519)) {
          const tmp45 = tmp22(519)(arg0, arg1);
          let tmp46 = tmp45;
          if (tmp45) {
            tmp46 = require(4429) /* ToPropertyDescriptor */(tmp45);
          }
          return require(4443) /* ValidateAndApplyPropertyDescriptor */(arg0, arg1, require(4442) /* getEvalledConstructor */(arg0), __Writable__, tmp46);
        } else if (tmp22(4441)(__Writable__)) {
          ...
          return require(4433) /* SameValue */(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
