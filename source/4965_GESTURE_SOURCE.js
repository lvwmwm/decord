...
export const MODAL_STACK_BEHAVIOR = {};
export const KEYBOARD_BEHAVIOR = { <string:3426444646>: 1, <string:1759031532>: "flex-start", <string:1454022907>: "center" };
export const KEYBOARD_BLUR_BEHAVIOR = { renderSettingSearchResultItem: false, outboundStats: false };
export const KEYBOARD_INPUT_MODE = { circleIcon: "useChatShowingAutoComplete", numOfEmbedsPendingScan: "<string:508629504>" };
