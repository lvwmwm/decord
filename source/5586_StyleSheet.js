...
// Function ID: 5587
// Name: StyleSheet
// Dependencies: [109, 19, 17, 21, 1584, 5587, 5584, 5589, 5590]
// Exports: default

// Module 5586 (StyleSheet)
...
export default function Header(children) {
  ...
  const context = React.useContext(importDefault(5587));
  if (undefined === layout) {
  ...
  if (headerBackground) {
    ...
    if (!headerTransparent) {
      ...
      obj4[0] = items;
      headerBackgroundResult = tmp15(importDefault(5590), obj4);
    }
  }
  ...
  tmp8 = importDefault(5584)(layout, undefined !== modal && modal, headerStatusBarHeight);
