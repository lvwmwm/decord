...
// Module 15486 (HasBadgeCoachmark)
function HasBadgeCoachmark(markAsDismissed) {
  ...
  const obj3 = { Promise: 0., marginTop: 0., flags: 0., style: tmp.text };
...
function NewBadgeCoachmark(markAsDismissed) {
  ...
  const obj5 = { Promise: null, marginTop: null, flags: null, style: tmp.text };
  const intl2 = arg1(dependencyMap[12]).intl;
...
obj = {};
obj = { xxs: null, xs: null, sm: null, gap: importDefault(dependencyMap[6]).space.PX_24 };
obj.container = obj;
const obj1 = { backgroundColor: true, borderRadius: true, width: true, height: true, padding: importDefault(dependencyMap[6]).space.PX_16 };
obj.graphicContainer = obj1;
obj.newBadgeImage = { alignSelf: -, marginTop: 0., opacity: 0. };
