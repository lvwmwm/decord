...
// Function ID: 33286
// Name: registerHost
// Dependencies: [4011, 4006]

// Module 4010 (registerHost)
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (require(4006).ACTIONS.REGISTER_HOST === type) {
    registerHost(merged, type.hostName);
    return merged;
  } else if (require(4006).ACTIONS.DEREGISTER_HOST === type) {
    const hostName = type.hostName;
    delete tmp[tmp2];
    return merged;
  } else if (require(4006).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return merged;
  } else if (require(4006).ACTIONS.REMOVE_PORTAL === type) {
