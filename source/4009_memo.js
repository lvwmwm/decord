...
// Function ID: 33285
// Name: memo
// Dependencies: [57, 31, 33, 4010, 4006, 4005, 4007]
...
const memoResult = memo(function PortalProviderComponent(rootHostName) {
  ...
  [tmp3, tmp4] = callback(callback2(require(4010) /* registerHost */.reducer, require(4006).INITIAL_STATE), 2);
  let obj = { value: tmp4 };
  obj = { value: tmp3 };
  const items = [rootHostName.children, ];
  if (tmp) {
    obj = { name: str };
    tmp = callback3(require(4007) /* PortalHost */.PortalHost, obj);
  }
  items[1] = tmp;
  obj.children = items;
  obj.children = closure_5(require(4005) /* createContext */.PortalStateContext.Provider, obj);
  return callback3(require(4005) /* createContext */.PortalDispatchContext.Provider, obj);
});
