...
// Function ID: 7375
// Name: getClient
// Dependencies: [7365, 7366, 7348, 7368, 7353]

// Module 7374 (getClient)
const require = arg1;
...
arg5.getGlobalScope = function getGlobalScope() {
  return require(7348) /* getGlobalSingleton */.getGlobalSingleton("globalScope", () => {
...
arg5.getTraceContextFromScope = function getTraceContextFromScope(getPropagationContext) {
  ...
  return require(7353) /* addNonEnumerableProperty */.dropUndefinedKeys({ trace_id, span_id, parent_span_id });
};
arg5.withIsolationScope = function withIsolationScope() {
  ...
  const obj2 = require(7366) /* getAsyncContextStrategy */;
};
