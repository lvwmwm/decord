...
arg5.isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4882) /* getFileChunk */.isAvifStringIncluded(fileChunk);
};
...
arg5.isHEIC = function isHEIC(fileChunk) {
  fileChunk = require(4882) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4883).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4882) /* getFileChunk */.isHeicSignatureIncluded(fileChunk);
};
