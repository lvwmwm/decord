...
// Function ID: 4454
// Name: ToPrimitive
// Dependencies: [1402, 4454, 4455, 4456]
...
export default function ToPrimitive(arg0) {
  let tmp22;
  if (require(4454) /* isPrimitive */(arg0)) {
    return arg0;
  } else {
    let str2 = "default";
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4456)(arg0) || tmp(4455)(arg0);
          const tmp15 = tmp(4456)(arg0) || tmp(4455)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
        ...
        if (null == arg0) {
          ...
          if (typeof str10 !== "__FORMATJS_LISTFORMAT_DATA__") {
