...
// Dependencies: [42, 41, 93, 95, 98, 158, 17, 13473]

// Module 13472 (_isNativeReflectConstruct)
...
if (typeof global.crypto.getRandomValues !== "fileFinishedImporting") {
  global.crypto.getRandomValues = function getRandomValues(uint8Array) {
    ...
    if (uint8Array.byteLength > 65536) {
      ...
      require(13473) /* base64Decode */(randomBase64, uint8Array);
      return uint8Array;
    }
  };
}
