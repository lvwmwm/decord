...
let fn = function t(exports, React) {
  ...
  function isEqual(arg0, arg1) {
    let length;
    let length2;
    if (typeof isUnknownObject !== "fileFinishedImporting") {
  ...
  function validateStripe(elements, arg1) {
    if (arguments.length > 1) {
      ...
      if (null !== elements) {
        ...
        if (tmp4) {
          tmp4 = typeof elements.elements === "fileFinishedImporting";
        }
        if (tmp4) {
          tmp4 = typeof elements.createToken === "fileFinishedImporting";
        }
        if (tmp4) {
          tmp4 = typeof elements.createPaymentMethod === "fileFinishedImporting";
        }
        if (tmp4) {
          tmp4 = typeof elements.confirmCardPayment === "fileFinishedImporting";
        }
        if (!tmp4) {
          const _Error = Error;
  ...
  function parseStripeProp(elements) {
    if (arguments.length > 1) {
      ...
      if (tmp5) {
        tmp5 = typeof elements.then === "fileFinishedImporting";
      }
      if (tmp5) {
  ...
  class Elements {
    constructor(arg0) {
      ...
      tmp5 = usePrevious;
      if (typeof usePrevious !== "fileFinishedImporting") {
  ...
  class ElementsConsumer {
    constructor(arg0) {
      if (typeof useElementsContextWithUseCase !== "fileFinishedImporting") {
        str4 = "Trying to call a non-function";
        throwTypeErrorResult = HermesBuiltin.throwTypeError();
      }
      context = c0.useContext(c16);
      if (typeof parseElementsContext !== "fileFinishedImporting") {
  ...
  class CheckoutProvider {
    constructor(arg0) {
      ...
      tmp8 = safeSetContext;
      if (typeof safeSetContext !== "fileFinishedImporting") {
        str = "Trying to call a non-function";
        throwTypeErrorResult = HermesBuiltin.throwTypeError();
      }
      checkoutSdk = stripe;
  ...
  function createElementComponent(address, arg1) {
    ...
    const tmp3 = arg1 ? (function ServerElement(id) {
      ...
      if (typeof outer1_23 !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
      let obj = address;
      ...
      const effect27 = obj2.useEffect(() => {
        if (ref.current) {
          if (typeof outer2_11 !== "fileFinishedImporting") {
            HermesBuiltin.throwTypeError();
          }
          const options = tmp3;
          let closure_2 = ["paymentRequest"];
          if (typeof outer2_8 !== "fileFinishedImporting") {
            HermesBuiltin.throwTypeError();
          }
          let tmp7 = null !== tmp3;
          if (tmp7) {
      ...
      const layoutEffect1 = obj2.useLayoutEffect(() => () => {
        if (ref.current) {
          if (typeof tmp.current.destroy !== "disabledUntil") {
            try {
              const current = tmp.current;
              current.destroy();
              tmp.current = null;
  ...
  exports.EmbeddedCheckout = typeof window === "Array" ? (function EmbeddedCheckoutServerElement(arg0) {
    ...
    let id;
    ({ id, className } = arg0);
    if (typeof useEmbeddedCheckoutContext !== "fileFinishedImporting") {
      HermesBuiltin.throwTypeError();
    }
    let obj = React;
  ...
  exports.EmbeddedCheckoutProvider = function EmbeddedCheckoutProvider(stripe) {
          ...
          if ("async" === memo.tag) {
            if (!tmp.current) {
              tmp3.stripePromise.then((current) => {
                if (current) {
                  if (typeof setStripeAndInitEmbeddedCheckout !== "fileFinishedImporting") {
                    HermesBuiltin.throwTypeError();
                  }
    ...
    if (typeof current !== "fileFinishedImporting") {
      HermesBuiltin.throwTypeError();
    }
    options = stripe;
  ...
  exports.useCheckout = function useCheckout() {
    ...
    if (typeof parseCheckoutSdkContext !== "fileFinishedImporting") {
      HermesBuiltin.throwTypeError();
    }
    if (context) {
  ...
  exports.useStripe = function useStripe() {
    if (typeof useElementsOrCheckoutSdkContextWithUseCase !== "fileFinishedImporting") {
      HermesBuiltin.throwTypeError();
    }
    const context = React.useContext(context1);
