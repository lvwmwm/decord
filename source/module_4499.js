// Module ID: 4499
// Function ID: 39686
// Dependencies: [29, 31, 27, 33, 4500, 4491]
...
export default importDefaultResult.forwardRef(function SearchBar(autoCapitalize) {
  ...
  if (ref(4491).isSearchBarAvailableForCurrentPlatform) {
    let obj = {};
    ...
    const tmp12 = importDefault(4500);
    obj.obscureBackground = ref(4491).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const obj4 = ref(4491);
    obj.hideNavigationBar = ref(4491).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
