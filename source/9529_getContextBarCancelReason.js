...
// Module 9529 (getContextBarCancelReason)
...
({ AnalyticEvents: closure_9, AnalyticsObjects: closure_10, AnalyticsPages: closure_11, AnalyticsSections: closure_12, GIF_RE_IOS: closure_13, MediaType: closure_14, MessageStates: closure_15, MessageTypes: closure_16 } = arg1(dependencyMap[7]));
const isStaticChannelRoute = arg1(dependencyMap[8]).isStaticChannelRoute;
let closure_18 = arg1(dependencyMap[9]).EXPLICIT_MEDIA_FALSE_POSITIVE_ACTION_SHEET_KEY;
const jsx = arg1(dependencyMap[10]).jsx;
const tmp3 = arg1(dependencyMap[7]);
const result = arg1(dependencyMap[59]).fileFinishedImporting("modules/messages/native/long_press/LongPressMessageActionSheetUtils.tsx");
...
export { handleCopyId };
export const longPressMessageOptionHandler = function longPressMessageOptionHandler(arg0) {
  ...
  let onBack;
  let selectedMedia;
  ({ label, message, channel, chatInputRef, selectedMedia, onActionExecuted, onBack, disabled } = arg0);
  ({ actionSheetSource, analyticsLocations } = arg0);
  ...
  if (!disabled) {
    ...
    if (intl2.string(arg1(dependencyMap[19]).t.+78Pfm) !== label) {
      ...
      if (intl4.string(arg1(dependencyMap[19]).t.n5EBAJ) !== label) {
        ...
        if (intl5.string(importDefault(dependencyMap[47]).1D+vqy) === label) {
          result = arg1;
          result = dependencyMap;
          if (obj53.canReportMessageToMods(message)) {
            result = arg1;
            result = dependencyMap;
            result = arg1(dependencyMap[46]).showReportToModMessageModal(message);
            const obj54 = arg1(dependencyMap[46]);
          }
          const obj53 = arg1(dependencyMap[48]);
        } else {
          result = arg1;
          result = dependencyMap;
          ...
          if (intl6.string(arg1(dependencyMap[19]).t.k5WiPf) === label) {
            ...
            if (message.type === constants6.THREAD_STARTER_MESSAGE) {
              ...
              if (null != message.messageReference) {
                ...
                if (null != guild_id2) {
                  ...
                  const obj59 = arg1(dependencyMap[28]);
                }
              }
            }
          } else {
            ...
            if (intl7.string(arg1(dependencyMap[19]).t.zBoHlf) === label) {
              result = handleCopyId;
              ...
              if (intl8.string(arg1(dependencyMap[19]).t.P8tvKG) === label) {
                result = authStore;
                ...
                if (intl9.string(arg1(dependencyMap[19]).t.cduTBL) === label) {
                  result = importDefault;
                  result = dependencyMap;
                  obj = { userId: message.author.id, channelId: id, messageId: message.id, sourceAnalyticsLocations: analyticsLocations };
                  result = importDefault(dependencyMap[49])(obj);
                } else {
                  result = arg1;
                  result = dependencyMap;
                  const intl10 = arg1(dependencyMap[19]).intl;
                  if (intl10.string(arg1(dependencyMap[19]).t.fsBWmS) === label) {
                    result = handleEdit;
                    result = message;
                    result = channel;
                    result = chatInputRef;
                    ...
                    if (intl11.string(arg1(dependencyMap[19]).t.MFGE51) === label) {
                      result = function handlePublish(id, chatInputRef, id2) {
                        ...
                        obj.title = intl.string(id(closure_2[19]).t.aIz1oV);
                        obj = { channelId: id };
                        obj.children = callback(id2(closure_2[20]), obj);
                        const intl2 = id(closure_2[19]).intl;
                        obj.cancelText = intl2.string(id(closure_2[19]).t.ETE/oC);
                        const intl3 = id(closure_2[19]).intl;
                        obj.confirmText = intl3.string(id(closure_2[19]).t.cY+Oob);
                        obj.onConfirm = function onConfirm() {
                          return arg2(closure_2[17]).crosspostMessage(arg0, arg2);
                        };
                        id2(closure_2[18]).show(obj);
                      }(id, chatInputRef, id2);
                    } else {
                      result = arg1;
                      result = dependencyMap;
                      const intl12 = arg1(dependencyMap[19]).intl;
                      if (intl12.string(arg1(dependencyMap[19]).t.CvQ18w) === label) {
                        result = function handlePin(channel, chatInputRef, message) {
                          ...
                          obj = {};
                          const intl = id(closure_2[19]).intl;
                          obj.title = intl.string(id(closure_2[19]).t.CvQ18w);
                          const intl2 = id(closure_2[19]).intl;
                          obj.body = intl2.string(id(closure_2[19]).t.WG5dyo);
                          obj = { message };
                          obj.children = callback(id2(closure_2[21]), obj);
                          const intl3 = id(closure_2[19]).intl;
                          obj.cancelText = intl3.string(id(closure_2[19]).t.gm1Vej);
                          const intl4 = id(closure_2[19]).intl;
                          obj.confirmText = intl4.string(id(closure_2[19]).t.p89ACt);
                          obj.onConfirm = function onConfirm() {
                        ...
                        if (intl13.string(arg1(dependencyMap[19]).t.Bse+F/) === label) {
                          result = function handleUnpin(channel, chatInputRef, message) {
                            ...
                            obj = {};
                            const intl = id(closure_2[19]).intl;
                            obj.title = intl.string(id(closure_2[19]).t.Bse+F/);
                            const intl2 = id(closure_2[19]).intl;
                            obj.body = intl2.string(id(closure_2[19]).t.NjEPp7);
                            obj = { message };
                            obj.children = callback(id2(closure_2[21]), obj);
                            const intl3 = id(closure_2[19]).intl;
                            obj.cancelText = intl3.string(id(closure_2[19]).t.gm1Vej);
                          ...
                          if (intl14.string(arg1(dependencyMap[19]).t.lE/PG3) === label) {
                            result = importDefault;
                            result = dependencyMap;
                            ...
                            if (intl15.string(arg1(dependencyMap[19]).t.2km5Gf) === label) {
                              result = importDefault;
                              result = dependencyMap;
                              ...
                              if (intl16.string(arg1(dependencyMap[19]).t.xwMqD7) === label) {
                                result = constants5;
                                if (message.state === constants5.SENDING) {
                                  ...
                                  if (message.state === constants5.SEND_FAILED) {
                                    ...
                                    result = function handleDelete(id, chatInputRef, message) {
                                      ...
                                      obj = {};
                                      const intl = id(closure_2[19]).intl;
                                      obj.title = intl.string(id(closure_2[19]).t.MWMcg7);
                                      const intl2 = id(closure_2[19]).intl;
                                      obj.body = intl2.string(id(closure_2[19]).t.AMvpS4);
                                      obj = { message };
                                      obj.children = callback(id2(closure_2[21]), obj);
                                      const intl3 = id(closure_2[19]).intl;
                                      obj.cancelText = intl3.string(id(closure_2[19]).t.gm1Vej);
                                ...
                                result = importDefault(dependencyMap[50]).trackWithMetadata(constants.MESSAGE_ACTION_SHEET_OPTION_PRESSED, obj1);
                                const obj43 = importDefault(dependencyMap[50]);
                              } else {
                                result = arg1;
                                result = dependencyMap;
                                const intl17 = arg1(dependencyMap[19]).intl;
                                if (intl17.string(arg1(dependencyMap[19]).t.5911Lb) === label) {
                                  ...
                                  result = importDefault(dependencyMap[50]).trackWithMetadata(constants.MESSAGE_ACTION_SHEET_OPTION_PRESSED, obj2);
                                  const obj40 = importDefault(dependencyMap[50]);
                                } else {
                                  result = arg1;
                                  result = dependencyMap;
                                  const intl18 = arg1(dependencyMap[19]).intl;
                                  if (intl18.string(arg1(dependencyMap[19]).t.JrGD7E) === label) {
                                    ...
                                    if (intl19.string(arg1(dependencyMap[19]).t.lfIHs4) === label) {
                                      const result1 = arg1(dependencyMap[51]).handleAddNewReactions(channel, id2);
                                      const obj35 = arg1(dependencyMap[51]);
                                    } else {
                                      result = arg1;
                                      result = dependencyMap;
                                      const intl20 = arg1(dependencyMap[19]).intl;
                                      if (intl20.string(arg1(dependencyMap[19]).t.gHp0C4) === label) {
                                        if ("Preview" === actionSheetSource) {
                                          const result2 = arg1(dependencyMap[51]).handleViewPreviewReactions(id2, id);
                                          const obj34 = arg1(dependencyMap[51]);
                                        } else {
                                          let obj3 = { messageId: id2, channelId: id };
                                          const obj4 = { object: constants2.MESSAGE_ACTION_SHEET };
                                          obj3.location = obj4;
                                          arg1(dependencyMap[51]).handleViewReactions(obj3);
                                          const obj31 = arg1(dependencyMap[51]);
                                        }
                                      } else {
                                        result = arg1;
                                        result = dependencyMap;
                                        const intl21 = arg1(dependencyMap[19]).intl;
                                        if (intl21.string(arg1(dependencyMap[19]).t.ZbtGBm) === label) {
                                          const result3 = arg1(dependencyMap[51]).handleRemoveAllReactions(id, id2);
                                          const obj30 = arg1(dependencyMap[51]);
                                        } else {
                                          result = arg1;
                                          result = dependencyMap;
                                          const intl22 = arg1(dependencyMap[19]).intl;
                                          if (intl22.string(arg1(dependencyMap[19]).t.g33r/P) === label) {
                                            ...
                                            if (intl23.string(arg1(dependencyMap[19]).t.Xrt5Po) === label) {
                                              handleCopyMessageLink(channel, id2);
                                            } else {
                                              result = arg1;
                                              result = dependencyMap;
                                              const intl24 = arg1(dependencyMap[19]).intl;
                                              if (intl24.string(arg1(dependencyMap[19]).t.RpE9k7) === label) {
                                                importDefault(dependencyMap[34])(id, id2);
                                              } else {
                                                result = arg1;
                                                result = dependencyMap;
                                                const intl25 = arg1(dependencyMap[19]).intl;
                                                if (intl25.string(arg1(dependencyMap[19]).t.S/xNKV) === label) {
                                                  function handleSaveImage(selectedMedia, id) {
                                                    ...
                                                    if (null != mediaUrl) {
                                                      closure_2 = id(closure_2[35]).urlMatchesFileExtension(fn.mediaUrl, closure_13);
                                                      const obj3 = id(closure_2[35]);
                                                      let num = id2(closure_2[36]).toURLSafe;
                                                      ...
                                                      if (null == numResult) {
                                                        ...
                                                        resolved.then((mediaUrl) => mediaUrl(closure_2[38]).downloadMediaAssetWithContentType(mediaUrl, closure_2 ? closure_14.GIF : closure_14.IMAGE, mediaUrl.contentType)).then(fn, () => {
                                                        ...
                                                        const nextPromise = resolved.then((mediaUrl) => mediaUrl(closure_2[38]).downloadMediaAssetWithContentType(mediaUrl, closure_2 ? closure_14.GIF : closure_14.IMAGE, mediaUrl.contentType));
                                                      } else {
                                                        num = 37;
                                                        const obj = id(closure_2[37]);
                                                      }
                                                      const tmp12 = id2(closure_2[36]);
                                                      resolved = id(closure_2[num]).maybeRefreshAttachmentUrl(fn.mediaUrl);
                                                      const obj2 = id(closure_2[num]);
                                                    }
                                                  }(selectedMedia, id);
                                                } else {
                                                  result = arg1;
                                                  ...
                                                  if (intl26.string(arg1(dependencyMap[19]).t.JVuuz3) === label) {
                                                    function handleSaveVideo(selectedMedia) {
                                                      ...
                                                      if (null != mediaUrl) {
                                                        const result = id(closure_2[38]).downloadMediaAssetWithContentType(selectedMedia.mediaUrl, constants.VIDEO, selectedMedia.contentType);
                                                        result.then(() => {
                                                    ...
                                                    if (intl27.string(arg1(dependencyMap[19]).t.vbAEaA) === label) {
                                                      let mediaUrl;
                                                      if (null != selectedMedia) {
                                                        mediaUrl = selectedMedia.mediaUrl;
                                                      }
                                                      if (null != mediaUrl) {
                                                        ...
                                                        const obj57 = arg1(dependencyMap[39]);
                                                      }
                                                    } else {
                                                      result = arg1;
                                                      result = dependencyMap;
                                                      const intl28 = arg1(dependencyMap[19]).intl;
                                                      if (intl28.string(arg1(dependencyMap[19]).t.92CPQ+) !== label) {
                                                        result = arg1;
                                                        result = dependencyMap;
                                                        const intl29 = arg1(dependencyMap[19]).intl;
                                                        if (intl29.string(arg1(dependencyMap[19]).t.8xHmxo) !== label) {
                                                          result = arg1;
                                                          result = dependencyMap;
                                                          const intl30 = arg1(dependencyMap[19]).intl;
                                                          if (intl30.string(arg1(dependencyMap[19]).t.5IEsGx) === label) {
                                                            const obj7 = { message, channel, chatInputRef, actionSource: "action_sheet" };
                                                            importDefault(dependencyMap[52])(obj7);
                                                          } else {
                                                            result = arg1;
                                                            result = dependencyMap;
                                                            const intl31 = arg1(dependencyMap[19]).intl;
                                                            if (intl31.string(arg1(dependencyMap[19]).t.I3ltXO) === label) {
                                                              let obj8 = { message, source: "long-press-sheet" };
                                                              arg1(dependencyMap[53]).openForwardModal(obj8);
                                                              const obj22 = arg1(dependencyMap[53]);
                                                            } else {
                                                              result = arg1;
                                                              result = dependencyMap;
                                                              const intl32 = arg1(dependencyMap[19]).intl;
                                                              if (intl32.string(arg1(dependencyMap[19]).t.rBIGBL) === label) {
                                                                handleCreateThread(channel, message);
                                                              } else {
                                                                result = arg1;
                                                                result = dependencyMap;
                                                                const intl33 = arg1(dependencyMap[19]).intl;
                                                                if (intl33.string(arg1(dependencyMap[19]).t.39d0Wj) === label) {
                                                                  ...
                                                                  if (intl34.string(arg1(dependencyMap[19]).t.PHjkRE) === label) {
                                                                    let obj16 = importDefault(dependencyMap[42]);
                                                                    obj16.hideActionSheet();
                                                                    let obj17 = arg1(dependencyMap[27]);
                                                                    const obj9 = { channel, commandType: arg1(dependencyMap[54]).ApplicationCommandType.MESSAGE, commandTargetId: message.id };
                                                                    const result4 = obj17.navigateToContextMenuCommands(obj9);
                                                                  } else {
                                                                    result = arg1;
                                                                    result = dependencyMap;
                                                                    const intl35 = arg1(dependencyMap[19]).intl;
                                                                    if (intl35.string(arg1(dependencyMap[19]).t.tpxJto) === label) {
                                                                      let obj14 = arg1(dependencyMap[55]);
                                                                      ...
                                                                      if (intl36.string(arg1(dependencyMap[19]).t.SvXS1Z) === label) {
                                                                        let obj12 = arg1(dependencyMap[55]);
                                                                        ...
                                                                        if (intl37.string(arg1(dependencyMap[19]).t.mJ3P0N) === label) {
                                                                          obj10 = importDefault(dependencyMap[42]);
                                                                          obj12 = {
                                                                            createReminder(dueAt) {
                                                                                                                                                      let obj = id(closure_2[55]);
                                                                          ...
                                                                          obj12.onBack = onBack;
                                                                          obj10.openLazy(arg1(dependencyMap[44])(dependencyMap[56], dependencyMap.paths), "MessageReminderDurationActionSheet", obj12);
                                                                        } else {
                                                                          result = arg1;
                                                                          result = dependencyMap;
                                                                          const intl38 = arg1(dependencyMap[19]).intl;
                                                                          if (intl38.string(arg1(dependencyMap[19]).t.vrbqs1) === label) {
                                                                            ...
                                                                            obj13.onBack = onBack;
                                                                            obj8.openLazy(arg1(dependencyMap[44])(dependencyMap[56], dependencyMap.paths), "MessageReminderDurationActionSheet", obj13);
                                                                          } else {
                                                                            result = arg1;
                                                                            result = dependencyMap;
                                                                            const intl39 = arg1(dependencyMap[19]).intl;
                                                                            if (intl39.string(arg1(dependencyMap[19]).t.ZH7P2h) === label) {
                                                                              if (null != selectedMedia) {
                                                                                id = undefined;
                                                                                ...
                                                                                if (result6) {
                                                                                  ...
                                                                                  obj14.embedId = id;
                                                                                  obj6.openLazy(arg1(dependencyMap[44])(dependencyMap[43], dependencyMap.paths), closure_18, obj14);
                                                                                }
                                                                              }
                                                                            } else {
                                                                              result = arg1;
                                                                              ...
                                                                              if (intl40.string(arg1(dependencyMap[19]).t.grdwwt) === label) {
                                                                                obj3 = importDefault(dependencyMap[57]);
                                                                                ...
                                                                                if (intl41.string(arg1(dependencyMap[19]).t.Rjezbz) === label) {
                                                                                  obj1 = importDefault(dependencyMap[42]);
                                                                                  obj16 = { message, guildId: guild_id, onBack };
                                                                                  obj1.openLazy(arg1(dependencyMap[44])(dependencyMap[58], dependencyMap.paths), "AppInteractionInfoActionSheet", obj16);
                                                                                } else {
                                                                                  result = arg1;
                                                                                  result = dependencyMap;
                                                                                  const intl42 = arg1(dependencyMap[19]).intl;
                                                                                  if (intl42.string(arg1(dependencyMap[19]).t.4sxKOb) !== label) {
                                                                                    result = arg1;
                                                                                    result = dependencyMap;
                                                                                    const intl43 = arg1(dependencyMap[19]).intl;
                                                                                    if (intl43.string(arg1(dependencyMap[19]).t.wUIMqa) !== label) {
    ...
    result = arg1;
    result = dependencyMap;
    if (obj55.canReportMessage(message)) {
      result = arg1;
      result = dependencyMap;
      result = arg1(dependencyMap[46]).showReportModalForMessage(message, "mobile_message_action_sheet");
      const obj56 = arg1(dependencyMap[46]);
    }
    const obj55 = arg1(dependencyMap[45]);
  }
};
