...
// Function ID: 12723
// Name: InflateState
// Dependencies: [12712, 12723, 12719, 12724, 12718]

// Module 12722 (InflateState)
const require = arg1;
...
function InflateState() {
  ...
  const buf16 = new require(12712) /* assign */.Buf16(320);
  obj.lens = buf16;
  const buf161 = new require(12712) /* assign */.Buf16(288);
  obj.work = buf161;
  obj.lendyn = null;
  obj.distdyn = null;
  obj.sane = 0;
    ...
    if (state.state) {
      ...
      if (state) {
        ...
        if (state.state) {
          ...
          state2.hold = 0;
          state2.bits = 0;
          const buf32 = new require(12712) /* assign */.Buf32(852);
          state2.lendyn = buf32;
          state2.lencode = buf32;
          const buf321 = new require(12712) /* assign */.Buf32(592);
...
function updatewindow(state, output3, length, length2) {
  ...
  if (null === state.window) {
    ...
    state.wnext = 0;
    state.whave = 0;
    const buf8 = new require(12712) /* assign */.Buf8(state.wsize);
    state.window = buf8;
  }
  if (length2 >= state.wsize) {
    const obj3 = require(12712) /* assign */;
...
arg5.inflate = function inflate(state) {
  ...
  let output;
  let output2;
  let buf8 = new require(12712) /* assign */.Buf8(4);
        ...
        while (true) {
          ...
          if (1 === mode) {
              ...
              if (bits >= 16) {
                if (2 & state.wrap) {
                  if (35615 === buf8) {
                    ...
                    num = 2;
                    num = 0;
                    state.check = require(12719)(check10, tmp2, 2, 0);
                    state.mode = 2;
                    bits = 0;
                    hold = 0;
                    diff8 = buf8;
            ...
            if (2 === mode) {
              ...
              if (bits >= 16) {
                ...
                if (8 !== (255 & state.flags)) {
                  ...
                  if (512 & state.flags) {
                    ...
                    let num89 = 2;
                    let num90 = 0;
                    state.check = require(12719)(check3, tmp2, 2, 0);
                  }
                  state.mode = 3;
                  let num91 = 0;
                  let num92 = 0;
              ...
              if (3 !== mode) {
                      ...
                      if (!(1024 & state.flags)) {
                        ...
                        if (length4) {
                          ...
                          if (512 & state.flags) {
                            ...
                            buf8 = length4;
                            buf8 = tmp14;
                            state.check = require(12719)(check7, tmp16, length4, buf8);
                          }
                          buf8 = tmp12 - length4;
                          buf8 = tmp14 + length4;
                          ...
                          if (4096 & state.flags) {
                            ...
                            if (0 !== tmp12) {
                              ...
                              if (512 & state.flags) {
                                ...
                                buf8 = input;
                                buf8 = tmp14;
                                state.check = require(12719)(check9, tmp16, buf8, buf8);
                              }
                              buf8 = tmp12 - buf8;
                              buf8 = tmp14 + buf8;
                              num61 = num56;
                                    ...
                                    if (14 === mode) {
                                      ...
                                      if (15 !== mode) {
                                        ...
                                        if (16 !== mode) {
                                              ...
                                              if (19 !== mode) {
                                                                  ...
                                                                  if (bits >= 32) {
                                                                    ...
                                                                    if (!diff3) {
                                                                      ...
                                                                      if (state.flags) {
                                                                        ...
                                                                        let tmp44 = output;
                                                                        let tmp45 = diff3;
                                                                        tmp46 = tmp41(12718)(check, tmp15, diff3, next_out - diff3);
                                                                      }
                                                                      state.check = tmp46;
                                                                      state.adler = tmp46;
                                                                    }
                                                ...
                                                if (buf8 >= 6) {
                                                  if (diff2 >= 258) {
                                                    ...
                                                    buf8 = require;
                                                    buf8 = dependencyMap;
                                                    buf8 = require(12724) /* inflate_fast */(state, avail_out);
                                            ...
                                            if (state.have >= state.nlen + state.ndist) {
                                              ...
                                              if (state.mode === 30) {
                                                ...
                                                if (0 === state.lens[256]) {
                                                  ...
                                                  num = 0;
                                                  buf8 = obj;
                                                  buf8 = require(12723) /* inflate_table */(1, lens5, 0, state.nlen, state.lencode, 0, state.work, obj);
                                                  ...
                                                  if (buf8) {
                                                    ...
                                                    let num74 = 0;
                                                    buf8 = obj;
                                                    buf8 = buf8(12723)(2, lens2, state.nlen, state.ndist, state.distcode, 0, state.work, obj);
                                          ...
                                          let num71 = 0;
                                          buf8 = obj;
                                          buf8 = require(12723) /* inflate_table */(0, lens, 0, 19, state.lencode, 0, state.work, obj);
                                          state.lenbits = obj.bits;
                                          if (buf8) {
                                ...
                                if (state.last) {
                                  ...
                                  if (0 === buf8) {
                                    ...
                                    if (c7) {
                                      ...
                                      buf8 = new.target;
                                      let num77 = 512;
                                      buf8 = new require(12712) /* assign */.Buf32(512);
                                      buf8 = new.target;
                                      buf8 = new.target;
                                      let num78 = 32;
                                      buf8 = new require(12712) /* assign */.Buf32(32);
                                      let num79 = 0;
                                      do {
                                        buf8 = num79 + 1;
                                        state.lens[num79] = 8;
                                      ...
                                      let num82 = 288;
                                      let num83 = 0;
                                      buf8 = require(12723) /* inflate_table */(1, lens3, 0, 288, buf8, 0, state.work, { bits: 9 });
                                      let num84 = 0;
                                      do {
                                        buf8 = num84 + 1;
                                        state.lens[num84] = 5;
                                      ...
                                      let num87 = 32;
                                      let num88 = 0;
                                      buf8 = require(12723) /* inflate_table */(2, lens4, 0, 32, buf8, 0, state.work, { bits: 5 });
                                      c7 = false;
                                    }
                                    state.lencode = buf8;
                                    state.lenbits = 9;
                    ...
                    if (2048 & state.flags) {
                      ...
                      if (0 !== buf8) {
                        ...
                        if (512 & state.flags) {
                          ...
                          buf8 = check8;
                          buf8 = input;
                          state.check = require(12719)(check8, tmp16, buf8, buf8);
                        }
                        buf8 = buf8 - buf8;
                        buf8 = buf8 + buf8;
                        num61 = num56;
                ...
                if (1024 & state.flags) {
                  ...
                  if (512 & state.flags) {
                    ...
                    num = 2;
                    num = 0;
                    num = require(12719)(check6, tmp2, 2, 0);
                    state.check = num;
                    num = 0;
                    num = 0;
                  }
              ...
              if (num95 >= 16) {
                ...
                if (512 & state.flags) {
                  ...
                  let num97 = 2;
                  let num98 = 0;
                  state.check = require(12719)(check5, tmp2, 2, 0);
                }
                state.mode = 5;
                num99 = 0;
                num = 0;
            ...
            if (num91 >= 32) {
              ...
              if (512 & state.flags) {
                ...
                let num93 = 4;
                let num94 = 0;
                state.check = require(12719)(check4, tmp2, 4, 0);
              }
              state.mode = 4;
              num95 = 0;
              num96 = 0;
          ...
          if (!buf8) {
            ...
            if (state.flags) {
              ...
              buf8 = check11;
              buf8 = output;
              buf8 = buf8(12718)(check11, tmp15, buf8, state.next_out - buf8);
            }
            state.check = buf8;
            state.adler = buf8;
          }
