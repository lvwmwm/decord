...
// Function ID: 6419
// Name: SessionFlusher
// Dependencies: [41, 42, 6371, 6392]

// Module 6418 (SessionFlusher)
...
const items = [
  ...
  },
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(6371).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(6392).getIsolationScope();
