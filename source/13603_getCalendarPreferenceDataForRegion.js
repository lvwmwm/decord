...
// Dependencies: [13604, 13605, 1281, 13606, 13607]

// Module 13603 (getCalendarPreferenceDataForRegion)
const require = arg1;
...
arg5.getCalendarPreferenceDataForRegion = function getCalendarPreferenceDataForRegion(region) {
  ...
  return require(13604).calendars[str] || require(13604).calendars["001"].map((arg0) => {
    let str = "gregory";
    if ("gregorian" !== arg0) {
      let str2 = "islamicc";
...
arg5.getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = require(13605).hourCycles[formatted] || tmp2(13605).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
...
arg5.getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  const items = [];
  if (require(13606).timezones[formatted]) {
...
arg5.getWeekDataForRegion = function getWeekDataForRegion(region) {
  ...
  return require(13607).weekData[str] || require(13607).weekData["001"];
};
