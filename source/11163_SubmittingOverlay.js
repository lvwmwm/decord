...
// Module 11163 (SubmittingOverlay)
const jsx = require(dependencyMap[0]).jsx;
const _module = require(dependencyMap[1]);
let obj = {};
obj = { ONE_DAY: false, maxWidth: false, useInappropriateConversationBannerForChannel: false, backgroundColor: importDefault(dependencyMap[2]).colors.BACKGROUND_SCRIM };
obj.ellipsis = obj;
...
export const SubmittingOverlay = function SubmittingOverlay(submitting) {
  ...
  if (submitting) {
    submitting = jsx(require(dependencyMap[6]).Ellipsis, { <string:1522289750>: "/assets/.cache/intl/bW9kdWxlcy9jaGVja291dC9tZXNzYWdlcw==", <string:570601313>: null });
  }
