...
// Dependencies: [6371, 6368, 6481]

// Module 6483 (callFrameToStackFrame)
const require = arg1;
...
arg5.callFrameToStackFrame = function callFrameToStackFrame(location, str) {
  ...
  obj[2] = location.functionName || require(6368) /* createStackParser */.UNKNOWN_FUNCTION;
  obj[3] = sum;
  obj[4] = sum1;
  let filenameIsInAppResult;
  if (replaced) {
    filenameIsInAppResult = tmp4(6481).filenameIsInApp(replaced);
    const tmp4Result = tmp4(6481);
  }
