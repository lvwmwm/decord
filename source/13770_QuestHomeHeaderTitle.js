...
// Module 13770 (QuestHomeHeaderTitle)
function QuestHomeHeaderTitle() {
  const tmp = callback3();
  let obj = { style: tmp.headerTitleContainer };
  const items = [callback(arg1(dependencyMap[8]).QuestsIcon, { flexDirection: null, alignItems: "f8bf13e5289aa31d46196df3283f80c3" }), ];
...
const obj1 = { "Bool(true)": true, "Bool(true)": true, "Bool(true)": true, gap: importDefault(dependencyMap[7]).space.PX_8, marginTop: importDefault(dependencyMap[7]).space.PX_8 };
