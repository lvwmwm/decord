...
// Function ID: 6429
// Name: getHandler
// Dependencies: [6398, 6385, 6382, 6420, 6383, 6384]

// Module 6428 (getHandler)
const require = arg1;
...
function getHandler(arg0, onBegin) {
  ...
  } else if (tmp(6398).CALLBACK_TYPE.CHANGE === arg0) {
...
function runWorklet(arg0, arg1, arg2) {
  ...
  if (arg1.isWorklet[arg0]) {
    ...
    console.warn(require(6382) /* tagMessage */.tagMessage("Animated gesture callback must be a worklet"));
