...
arg5.detectFile = function detectFile(uint8Array, chunkSize) {
  ...
  const fileChunk = require(4943) /* getFileChunk */.getFileChunk(uint8Array, num3);
  if (0 !== fileChunk.length) {
    const items = [];
    const items1 = [];
    for (const key10027 in require(4944).FileTypes) {
      let tmp22 = key10027;
      let _Object4 = Object;
      let call2 = hasOwnProperty2.call;
      let tmp23 = require;
      let tmp24 = dependencyMap;
      let FileTypes5 = require(4944).FileTypes;
