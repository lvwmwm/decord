...
// Function ID: 99552
// Name: coerce
// Dependencies: [12776, 12780, 12775]
...
export default function coerce(arg0, arg1) {
  ...
  if (arg0 instanceof require(12776) /* SemVer */) {
    ...
    if ("string" !== typeof StringResult) {
      ...
      if (obj.rtl) {
        const safeRe2 = require(12780) /* items */.safeRe;
        const t2 = require(12780) /* items */.t;
        ...
        const safeRe = require(12780) /* items */.safeRe;
      ...
      if (null === match2) {
        ...
        return require(12775) /* parse */("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str4 + str6, obj);
      }
    }
  }
};
