...
// Module 12474 (inflate_table)
let closure_2 = [];
let closure_3 = [];
let closure_4 = [];
let closure_5 = [true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true];
