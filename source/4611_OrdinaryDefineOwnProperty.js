...
// Dependencies: [4548, 541, 4595, 4599, 542, 4612, 562, 4604, 4600, 4613, 4614]

// Module 4611 (OrdinaryDefineOwnProperty)

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (require(4548) /* isObject */(arg0)) {
    if (tmp(4595)(arg1)) {
      if (tmp(4599)(__Writable__)) {
        if (tmp(542)) {
          const tmp30 = tmp(542)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4600)(tmp30);
          }
          return tmp(4614)(arg0, arg1, tmp(4613)(arg0), __Writable__, tmp31);
        } else if (tmp(4612)(__Writable__)) {
          ...
          return tmp(4604)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
