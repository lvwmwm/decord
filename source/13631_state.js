...
// Function ID: 13632
// Name: state
// Dependencies: [13595, 13570, 13632, 13586, 13633, 13615, 13593, 13626]
...
if (!require("all")) {
  if (!require("__core-js_shared__").state) {
    ...
    let fn = function t(facade) {
      if (require(13593) /* call */(facade, closure_6)) {
    ...
    let fn2 = function n(arg0) {
      return require(13593) /* call */(arg0, closure_6) ? arg0[closure_6] : {};
    };
    let fn5 = fn2;
    let fn3 = function u(arg0) {
      return require(13593) /* call */(arg0, closure_6);
    };
    let fn6 = fn3;
  }
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new require(13570).TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
