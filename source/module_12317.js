// Module ID: 12317
// Function ID: 12318
// Dependencies: [5, 12251, 12314, 12318, 12319, 12320, 12313]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12251).util;
    ...
    let closure_8 = fn(_mod12318);
    let closure_9 = fn(_mod12319);
    let closure_10 = fn(_mod12320);
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12313).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12313).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12313).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
