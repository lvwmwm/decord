...
((arg0) => {
  ...
  function exp(s) {
    ...
    if (getBase10Exponent(s) > 16) {
      const _Error = Error;
      throw Error(c5 + getBase10Exponent(s));
    } else if (s.s) {
      let tmp7;
      if (null == undefined) {
        let c2 = false;
      ...
      const constructor1 = new constructor(closure_0);
      ...
      do {
        ...
        let tmp23 = round(timesResult1, sum);
        let sum1 = num8 + 1;
        let timesResult2 = obj5.times(sum1);
        let tmp26 = digitsToString;
        let tmp27 = callback;
        let plusResult = obj7.plus(callback(timesResult1, timesResult2, sum));
        let arr = digitsToString(plusResult.d);
        substr = arr.slice(0, sum);
        let arr2 = digitsToString(obj7.d);
        tmp31 = obj7;
        obj5 = timesResult2;
        obj6 = timesResult1;
        obj7 = plusResult;
      ...
      if (+num6) {
        do {
          ...
          let tmp37 = round(timesResult3, sum);
          tmp38 = +diff;
          diff = tmp38 - 1;
          obj8 = timesResult3;
          tmp34 = timesResult3;
      ...
      const prototype = constructor.prototype;
      const constructor2 = new constructor(closure_0);
      return constructor2;
    }
  }
      ...
      if (s.eq(10)) {
        ...
        if (Math.abs(tmp8) < 1500000000000000) {
          if (charAtResult >= 7) {
            ...
            const obj3 = callback(constructor1.minus(closure_0), constructor1.plus(closure_0), sum);
            tmp21 = round(obj3.times(obj3), sum);
            arr = obj3;
            const minusResult = constructor1.minus(closure_0);
          } else {
            num5 = 1;
            obj = s;
          }
    ...
    if (undefined === arg2) {
      if (closure_0 >= 1) {
        if (d[0]) {
          ...
          if (c2) {
            const _Error = Error;
            throw Error(c5 + getBase10Exponent(d));
          }
          return d;
        }
      }
      if (undefined) {
        d.length = 1;
        const diff3 = closure_0 - getBase10Exponent(d) - 1;
      ...
      let tmp9 = closure_0 < 0 || undefined !== d[num6 + 1] || first1 % tmp45;
      if (arg2 < 4) {
        if (!tmp17) {
          tmp17 = tmp9;
        }
    ...
    if (arg1) {
      if (arg2) {
        ...
        if (diff > 0) {
          ...
          let text2 = `${arr.charAt(0)}.${arr.slice(1)}${getZeroString(tmp23)}`;
        }
        let str7 = "e+";
        if (tmp < 0) {
          str7 = "e";
      ...
      const text4 = `0.${getZeroString(-tmp - 1)}${arr}`;
      let tmp20 = arg2;
      if (arg2) {
      ...
      if (constructor.s) {
        ...
        if (diff1 >= 0) {
          do {
            ...
            let tmp21 = c9;
            items[tmp16] = (items[tmp16] + num4) % c9 | 0;
            diff1 = diff1 - 1;
            tmp14 = num4;
          } while (diff1 >= 0);
        }
  ...
  const fn26 = function(arg0) {
    ...
    if (constructor.s) {
      ...
      const constructor1 = new constructor(self);
      if (constructor1.s) {
        if (constructor1.eq(closure_0)) {
          return constructor1;
        } else {
          const precision = constructor.precision;
          if (constructor.eq(closure_0)) {
            round(constructor1, precision);
            return constructor1;
          } else {
              ...
              if (tmp16 <= 9007199254740991) {
                ...
                if (0 !== tmp32) {
                  do {
                    ...
                    let tmp36 = truncate(timesResult1.d, rounded);
                    let tmp37 = obj4;
                    if (tmp32 % 2) {
                      let tmp38 = truncate;
                      let timesResult2 = obj4.times(timesResult1);
                      let tmp40 = truncate(timesResult2.d, rounded);
                      tmp37 = timesResult2;
                    }
                    let tmp41 = floor;
                    tmp32 = floor(tmp32 / 2);
                ...
                if (constructor.s < 0) {
                  const prototype4 = constructor.prototype;
                  const constructor3 = new constructor(closure_0);
      ...
      const prototype = constructor.prototype;
      const constructor4 = new constructor(closure_0);
      return constructor4;
    }
  };
  obj.pow = fn26;
    ...
    function subtract(arr) {
      ...
      if (+arg2) {
        do {
          ...
          let tmp3 = outer1_9;
          arr[diff] = num * outer1_9 + arr[diff] - arg1[diff];
          tmp4 = +diff;
          diff = tmp4 - 1;
        } while (tmp4);
      }
      ...
      if (s.s) {
        if (s2.s) {
          ...
          if (null == tmp) {
            ...
            precision = tmp;
            if (arg3) {
              precision = tmp + (outer1_17(s) - outer1_17(s2)) + 1;
              const tmp18 = outer1_17(s);
            }
          }
          if (precision < 0) {
            const prototype3 = constructor.prototype;
            ...
            let sum9 = tmp;
            if (arg3) {
              sum9 = tmp + outer1_17(constructor) + 1;
            }
            outer1_22(constructor, sum9);
            return constructor;
          }
        } else {
          const _Error = Error;
          ...
          if (arg0 instanceof tmp) {
            ...
            if ("number" === tmp7) {
              num6 = 0;
              {
                ...
                tmp16 = outer1_21;
                tmp17 = outer1_21(self, str2.toString());
                tmp18 = self;
              }
            } else {
              str3 = "string";
  ...
  let cloneResult = clone({ precision: 20, rounding: 4, toExpNeg: -7, toExpPos: 21, LN10: "2.302585092994045684017991454684364207601101488628772976033327900967572609677352480235997205089598298341967784042286" });
  cloneResult.Decimal = cloneResult;
  cloneResult.default = cloneResult;
  cloneResult = new cloneResult(1);
  const dependencyMap = cloneResult;
  ...
  if (undefined !== dependencyMap) {
    if (dependencyMap.exports) {
      dependencyMap.exports = cloneResult;
    }
  }
  if (arg0) {
