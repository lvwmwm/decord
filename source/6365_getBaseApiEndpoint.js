...
// Module 6365 (getBaseApiEndpoint)
const require = arg1;
...
arg5.getReportDialogEndpoint = function getReportDialogEndpoint(arg0, user) {
  const dsn = require(6358) /* dsnFromString */.makeDsn(arg0);
  if (dsn) {
    const _HermesInternal = HermesInternal;
    const combined = "" + getBaseApiEndpoint(dsn) + "embed/error-page/";
    const _HermesInternal2 = HermesInternal;
    let combined1 = "dsn=" + require(6358) /* dsnFromString */.dsnToString(dsn);
    let tmp10 = combined1;
  ...
  const obj = require(6358) /* dsnFromString */;
};
