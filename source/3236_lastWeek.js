...
// Module 3236 (lastWeek)
const obj = {
  areIntervalsOverlapping: "EEEE, d 'de' MMMM 'de' y",
  clamp: "d 'de' MMMM 'de' y",
  closestIndexTo: "d MMM y",
  closestTo: "dd/MM/y",
  compareAsc: "construct",
  compareDesc: "<string:4050538752>",
  lastWeek(getUTCDay) {
