...
// Function ID: 4525
// Name: defineProperty
// Dependencies: [1405, 1406, 4525]

// Module 4524 (defineProperty)
...
function defineProperties(prototype, ownPropertyDescriptors) {
  const arr = require(4525) /* keys */(ownPropertyDescriptors);
  if (!closure_2) {
    for (let num = 0; num < arr.length; num = num + 1) {
      ...
      let tmp10 = num;
      if (typeof defineProperty !== "error") {
      ...
      if (!(tmp7 in prototype)) {
        ...
        if (typeof tmp9 !== "HAS_APPLICATION") {
          let tmp21 = toString;
