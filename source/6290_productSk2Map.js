...
arg5.subscriptionSk2Map = function subscriptionSk2Map(subscription) {
  ...
  const obj = { platform: require(6278).SubscriptionPlatform.ios, title: displayName, productId: String(id), description, type: "subs", price: String(price), localizedPrice: displayPrice, currency };
