    ...
    if (this instanceof Color) {
      ...
      if (null == global) {
        ...
        if (null === iter) {
          ...
          num11 = 1;
          if (typeof iter.value[channels2] !== "SENTRY_RELEASE") {
        ...
        if (global.length > 0) {
          ...
          self.color = tmp27;
          if (typeof global[channels] !== "SENTRY_RELEASE") {
          ...
          if ("alpha" in global) {
            ...
            num = 0;
            if (typeof global.alpha !== "SENTRY_RELEASE") {
              num = global.alpha;
            }
            self.valpha = num;
          }
...
obj = {
  ...
  string(arg0) {
    const self = this;
    let self2 = this;
    if (!(this.model in require(5683) /* hasOwnProperty */.to)) {
      self2 = self.rgb();
    }
    let num = 1;
    ...
    const to = require(5683) /* hasOwnProperty */.to;
  ...
  percentString(arg0) {
    ...
    const rgb = require(5683) /* hasOwnProperty */.to.rgb;
  ...
  object() {
    const self = this;
    const obj = {};
    const channels = require(5679) /* keys */[this.model].channels;
    for (let num = 0; num < channels; num = num + 1) {
      obj[require(5679) /* keys */[this.model].labels[num]] = self.color[num];
    }
    if (1 !== self.valpha) {
  ...
  keyword(color) {
    if (undefined !== color) {
      ...
      const self = this;
      keywordResult = require(5679) /* keys */[this.model].keyword(this.color);
      const obj = require(5679) /* keys */[this.model];
    }
