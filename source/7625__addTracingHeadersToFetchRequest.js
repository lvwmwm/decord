...
// Dependencies: [853, 7516, 7519, 7520, 7534, 7544, 7548, 7552, 7602, 7525, 7554, 7535, 7553, 7591, 7537, 7533, 7527]
// Exports: addTracingHeadersToFetchRequest, instrumentFetchRequest

// Module 7625 (_addTracingHeadersToFetchRequest)
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  let baggage;
  let tmp4;
  let obj = require(7591) /* getTraceData */;
  obj = { span };
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData) {
  ...
  if (fetchData.fetchData) {
    ...
    let obj = require(7552) /* hasTracingEnabled */;
