...
// Dependencies: [7348, 7356, 7353]

// Module 7358 (addContextToFrame)
const require = arg1;
...
arg5.addContextToFrame = function addContextToFrame(arr, lineno) {
  ...
  if (undefined !== lineno.lineno) {
    ...
    lineno.context_line = require(7356) /* isMatchingPattern */.snipLine(arr[bound1], num2);
    const _Math = Math;
    ...
    const obj = require(7356) /* isMatchingPattern */;
  }
};
...
arg5.checkOrSetAlreadyCaught = function checkOrSetAlreadyCaught(__sentry_captured__) {
  if ((function isAlreadyCaptured(__sentry_captured__) {
    ...
    try {
      const result = require(7353) /* addNonEnumerableProperty */.addNonEnumerableProperty(__sentry_captured__, "__sentry_captured__", true);
      return false;
    } catch (err) {
    }
  }
