...
// Dependencies: [6312, 6320, 6317]

// Module 6322 (getFirstException)
const require = arg1;
...
arg5.addContextToFrame = function addContextToFrame(arr, lineno) {
  ...
  if (undefined !== lineno.lineno) {
    ...
    lineno.context_line = require(6320) /* isMatchingPattern */.snipLine(arr[bound1], num2);
    const _Math = Math;
    ...
    const obj = require(6320) /* isMatchingPattern */;
  }
};
