...
// Dependencies: [5, 6, 7, 15, 17, 18, 16146, 16148, 16150]
...
import _defineProperties from "PriorityQueue";
...
export default ((arg0) => {
  class PQueue {
    constructor(arg0) {
      ...
      tmp2Result._resolveEmpty = outer1_8;
      tmp2Result._resolveIdle = outer1_8;
      obj = { carryoverConcurrencyCount: false, intervalCap: Infinity, interval: 0, concurrency: Infinity, autoStart: true };
      obj.queueClass = onIdle(onEmpty[7]).default;
  ...
  items[3] = {
    ...
    value: function _resolvePromises() {
      const self = this;
      this._resolveEmpty();
      this._resolveEmpty = outer1_8;
      if (0 === this._pendingCount) {
        self._resolveIdle();
        self._resolveIdle = outer1_8;
        self.emit("idle");
      }
    }
  };
  ...
  let closure_3 = asyncGeneratorStep(tmp);
  ...
  // CreateGeneratorClosureLongIndex (0x67)
  asyncGeneratorStep = asyncGeneratorStep("addAll");
  ...
  // CreateGeneratorClosureLongIndex (0x67)
  let closure_1 = asyncGeneratorStep("onEmpty");
  ...
  // CreateGeneratorClosureLongIndex (0x67)
  let closure_0 = asyncGeneratorStep("onIdle");
