...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5282, 5307, 5295]

// Module 5350 (_isNativeReflectConstruct)
...
class Swipeable {
  constructor(arg0) {
    ...
    obj = { dragX: value, rowTranslation: null, rowState: 0, leftWidth: "accessibilityRole", rightOffset: "useStateFromStores", rowWidth: "jsxs" };
...
let items = [
  obj,
  {
    ...
    value: function render() {
      ...
      items8[2] = callback3(self(5295).TapGestureHandler, obj8);
      obj7[2] = items8;
      obj6.children = callback4(RN.View, obj7);
      return callback3(self(5307).PanGestureHandler, obj6);
    }
  }
];
