// Module ID: 12253
// Function ID: 12254
// Dependencies: [5, 12187, 12250, 12254, 12255, 12256, 12249]

// Module 12253
import asyncGeneratorStep from "module_12256";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, message) {
      ...
      const util = _require(12187).util;
    ...
    let closure_8 = fn(require("module_12254"));
    let closure_9 = fn(require("module_12255"));
    let closure_10 = fn(require("module_12256"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12249).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12249).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12249).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
