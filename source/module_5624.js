// Module ID: 5624
// Function ID: 5625
// Dependencies: [5625, 5626, 5627, 5686, 5687, 5688, 5689, 5693, 5694, 5647, 5695, 5696, 5691, 5690, 5697, 5648, 5698]
...
if (isNewArch.isNewArch()) {
  ...
  exports.FlashListRef = require("module_5686").FlashListRef;
  exports.FlashListProps = require("module_5687").FlashListProps;
  exports.ListRenderItem = require("module_5687").ListRenderItem;
  exports.ListRenderItemInfo = require("module_5687").ListRenderItemInfo;
  exports.RenderTarget = require("module_5687").RenderTarget;
  exports.RenderTargetOptions = require("module_5687").RenderTargetOptions;
  ...
  exports.ViewToken = require("module_5697");
  ...
  const _Error = Error;
  const error = new Error(require("module_5626").ErrorMessages.flashListV2OnlySupportsNewArchitecture);
  throw error;
}
