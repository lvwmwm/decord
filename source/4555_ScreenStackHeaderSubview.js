...
// Dependencies: [109, 19, 17, 21, 4556, 4552, 4557, 4558, 4553, 4559]
...
// Module 4555 (ScreenStackHeaderSubview)
...
const forwardRefResult = require("noop").forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4552).isHeaderBarButtonsAvailableForCurrentPlatform) {
      let tmpResult = tmp(4557);
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4552).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4553).experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(result1(4558), {});
});
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  obj[2] = importDefault(4553).experiment.synchronousHeaderSubviewUpdatesEnabled;
  obj = { resizeMode: "center", fadeDuration: 0 };
  const merged = Object.assign(arg0);
  obj[3] = <closure_7 resizeMode="center" fadeDuration={0} />;
  return jsx(importDefault(4559), { resizeMode: "center", fadeDuration: 0 });
};
export const ScreenStackHeaderRightView = (style) => {
  ...
  obj.type = "right";
  obj.synchronousShadowStateUpdatesEnabled = importDefault(4553).experiment.synchronousHeaderSubviewUpdatesEnabled;
