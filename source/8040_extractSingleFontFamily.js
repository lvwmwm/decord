...
// Dependencies: [31, 33, 8034, 8039]
// Exports: default, setTSpan

// Module 8040 (extractSingleFontFamily)
import "result";
...
export default function extractText(children) {
  ...
  if ("string" !== typeof children) {
    ...
    obj.x = importDefault(8039)(tmp);
    obj.y = importDefault(8039)(tmp2);
    obj.dx = importDefault(8039)(tmp3);
    obj.dy = importDefault(8039)(tmp4);
    obj.rotate = importDefault(8039)(tmp5);
    return obj;
  }
  let tmp16 = null;
  if (arg1) {
