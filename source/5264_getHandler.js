...
let closure_3 = (() => {
  ...
  getHandler.__closure = { CALLBACK_TYPE: require(5256) /* _callSuper */.CALLBACK_TYPE };
...
let closure_5 = (() => {
  ...
  touchEventTypeToCallbackType.__closure = { TouchEventType: require(5225).TouchEventType, CALLBACK_TYPE: require(5256) /* _callSuper */.CALLBACK_TYPE };
...
let closure_7 = (() => {
  ...
  runWorklet.__closure = { getHandler: closure_3, tagMessage: require(5221) /* hasProperty */.tagMessage };
