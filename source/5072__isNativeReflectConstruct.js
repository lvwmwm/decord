  ...
  class DrawerLayout {
    constructor(arg0) {
      ...
      tmp2Result.updateAnimatedEvent = (drawerWidth, drawerTranslation) => {
        ...
        tmp2Result.openValue = RN.add(addResult2, drawerTranslation.drawerTranslation).interpolate({ inputRange: items1, outputRange: [null, null], extrapolate: "clamp" });
      ...
      tmp2Result.renderDrawer = () => {
        ...
        if ("front" === drawerType) {
          if ("back" === drawerType) {
            ...
            if (tmp2Result.state.drawerState !== "Idle") {
              const obj5 = { inputRange: [null, null] };
              const items5 = [tmp6, 0];
