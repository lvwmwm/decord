...
// Dependencies: [7516, 7519, 7521, 7547, 7525, 7548, 7520, 7617, 7534, 7554, 7555]

// Module 7616 (addToMetricsAggregator)
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = require(7547) /* getClient */.getClient();
    const obj2 = require(7547) /* getClient */;
  }
  if (client) {
    const activeSpan = require(7525) /* spanTimeInputToSeconds */.getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    const globalSingleton = require(7521) /* getGlobalSingleton */.getGlobalSingleton("globalMetricsAggregators", () => {
    ...
    const tmp3Result1 = require(7521) /* getGlobalSingleton */;
  }
}
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7617).COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7617).DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, require(7617).SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, require(7617).GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    ...
    if (typeof fn === "function") {
      ...
      return _require(7554).startSpanManual(obj, (arg0) => {
        const callback = arg0;
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _require(7617).DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
  ...
  getMetricsAggregatorForClient(on) {
    ...
    const obj = require(7521) /* getGlobalSingleton */;
  }
};
