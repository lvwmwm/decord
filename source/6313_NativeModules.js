...
// Function ID: 56576
// Name: NativeModules
// Dependencies: [5, 27, 6314, 6315, 6320, 6321, 6322, 6323, 6324]
...
const subs = require("module_6314").ProductType.subs;
const inapp = require("module_6314").ProductType.inapp;
...
export const isIosStorekit2 = require("module_6315").isIosStorekit2;
...
export const flushFailedPurchasesCachedAsPendingAndroid = function flushFailedPurchasesCachedAsPendingAndroid() {
  const androidModule = require(6315).getAndroidModule();
...
export const deepLinkToSubscriptions = function deepLinkToSubscriptions(isAmazonDevice) {
  ...
  let closure_0 = callback(async () => {
    if (obj) {
      return obj.resume();
    } else if (callback(6315).isAmazon) {
      obj = { isAmazonDevice: outer1_2 };
      const result = outer2_1(6321).deepLinkToSubscriptionsAmazon(obj);
      const obj4 = outer2_1(6321);
    } else if (outer1_1) {
      obj = { sku: outer1_1 };
      const result1 = outer2_1(6322).deepLinkToSubscriptionsAndroid(obj);
      const obj2 = outer2_1(6322);
    } else {
      const _Error = Error;
