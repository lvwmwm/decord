...
// Function ID: 13691
// Name: state
// Dependencies: [13654, 13629, 13691, 13645, 13692, 13674, 13652, 13685]
...
if (!require("all")) {
  if (!require("__core-js_shared__").state) {
    ...
    let fn = function t(facade) {
      if (require(13652) /* call */(facade, closure_6)) {
    ...
    let fn2 = function n(arg0) {
      return require(13652) /* call */(arg0, closure_6) ? arg0[closure_6] : {};
    };
    let fn5 = fn2;
    let fn3 = function u(arg0) {
      return require(13652) /* call */(arg0, closure_6);
    };
    let fn6 = fn3;
  }
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new require(13629).TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
