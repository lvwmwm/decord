...
arg5.isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4854) /* getFileChunk */.isAvifStringIncluded(fileChunk);
};
...
arg5.isHEIC = function isHEIC(fileChunk) {
  fileChunk = require(4854) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4855).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4854) /* getFileChunk */.isHeicSignatureIncluded(fileChunk);
};
