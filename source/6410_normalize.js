...
// Function ID: 6411
// Name: normalize
// Dependencies: [32, 6411, 6371, 6372, 6368]
// Exports: normalizeUrlToBase

// Module 6410 (normalize)
...
function visit(arg0, __sentry_skip_normalization__) {
  ...
  if (arg4 === undefined) {
    memoBuilderResult = require(6411) /* memoBuilder */.memoBuilder();
    let obj = require(6411) /* memoBuilder */;
  }
      ...
      if (str.startsWith("[object ")) {
        if (__sentry_skip_normalization__.__sentry_skip_normalization__) {
          ...
          if (0 === num) {
            ...
            const convertToPlainObjectResult = require(6371) /* addNonEnumerableProperty */.convertToPlainObject(__sentry_skip_normalization__);
            let num6 = 0;
