...
// Dependencies: [77, 6, 7, 15, 17, 18, 31, 27, 33, 5556, 5526, 5571, 5558, 5573, 5569, 5574, 5559, 5575]
...
function getIsModal(descriptor) {
  if (arg2) {
    ...
    let isModalPresentation = require(5556) /* _isNativeReflectConstruct */.getIsModalPresentation(descriptor.descriptor.options.cardStyleInterpolator);
...
function getDistanceFromOptions(arg0, options) {
  ...
  if (undefined !== gestureDirection) {
    return importDefault(5558)(arg0, gestureDirection);
  } else if ("modal" === tmp) {
    let gestureDirection2 = require(5571) /* SlideFromRightIOS */.ModalTransition.gestureDirection;
  } else {
    gestureDirection2 = require(5571) /* SlideFromRightIOS */.DefaultTransition.gestureDirection;
  }
}
