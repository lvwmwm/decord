...
// Function ID: 1829
// Name: useResizeMode
// Dependencies: [19, 1826, 1829, 1827, 1634, 1830, 1831]
...
export const useKeyboardAnimation = () => {
  ...
  return require(1827) /* NOOP */.useKeyboardContext().animated;
};
export const useReanimatedKeyboardAnimation = () => {
  ...
  return require(1827) /* NOOP */.useKeyboardContext().reanimated;
};
export const useGenericKeyboardHandler = function useGenericKeyboardHandler(handler, items10) {
  const _require = handler;
  const dependencyMap = _require(1827).useKeyboardContext();
  const obj = _require(1827);
  ...
  let closure_2 = _require(1634).useEvent(fn, ["onKeyboardMoveStart", "onKeyboardMove", "onKeyboardMoveEnd", "onKeyboardMoveInteractive"], obj2.useHandler(handler, items10).doDependenciesDiffer);
  callback2(() => {
...
export const useKeyboardHandler = function useKeyboardHandler(handler, items) {
  ...
  let dependencyMap;
  callback = undefined;
  dependencyMap = _require(1827).useKeyboardContext();
  const obj = _require(1827);
  const obj2 = _require(1634);
  const fn = function u(eventName) {
    eventName = eventName.eventName;
  ...
  fn.__workletHash = 7080794218426;
  fn.__initData = closure_5;
  callback = _require(1634).useEvent(fn, ["onKeyboardMoveStart", "onKeyboardMove", "onKeyboardMoveEnd", "onKeyboardMoveInteractive"], obj2.useHandler(handler, items).doDependenciesDiffer);
  callback2(() => {
    keyboardHandlers.setKeyboardHandlers(closure_2);
    return () => callback();
  }, items);
...
export const useFocusedInputHandler = function useFocusedInputHandler(handler, items10) {
  ...
  let closure_2 = _require(1634).useEvent(fn, ["onFocusedInputTextChanged", "onFocusedInputSelectionChanged"], obj2.useHandler(handler, items10).doDependenciesDiffer);
  callback2(() => {
