...
// Function ID: 3597
// Name: format
// Dependencies: [3546, 3597, 3364, 3598, 3609, 3527, 3368, 3365, 3610, 3369, 3611]
// Exports: default
              ...
              if (tmp3.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3611).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3611).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3611).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
