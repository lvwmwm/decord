...
// Function ID: 10337
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 10337, 1654, 10314, 10338]
...
export const ItemRenderer = (arg0) => {
  ...
  let obj = require(10337) /* isArraysEqual */;
  ...
  obj = { runOnJS: require(1654) /* cancelAnimation */.runOnJS, setDisplayedItems: tmp4 };
  fn2.__closure = obj;
  fn2.__workletHash = 13763650073050;
  fn2.__initData = visibleRanges;
  const items = [visibleRanges];
  const animatedReaction = require(1654) /* cancelAnimation */.useAnimatedReaction(fn, fn2, items);
  let tmp6 = null;
  if (first) {
    obj = { children: null };
