...
({ Linking: closure_4, StyleSheet, View: closure_5, ActivityIndicator: closure_6 } = result);
...
export default function Hcaptcha(siteKey) {
  ...
  const items2 = [{ "Bool(true)": "flex-end", "Bool(true)": "center" }, style];
  obj = { html: tmp9 };
