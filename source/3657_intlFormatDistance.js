...
// Dependencies: [3526, 3550, 3551, 3553, 3554, 3556, 3561, 3567, 3364, 3365, 3543]
// Exports: default

// Module 3657 (intlFormatDistance)
...
export default function intlFormatDistance(arg0, arg1, unit) {
  ...
  if (absolute < require(3543) /* keys */.secondsInMinute) {
    ...
    if (absolute1 < tmp6(3543).secondsInHour) {
      num2 = tmp15.default(defaultResult1, defaultResult2);
      str = "minute";
    } else {
      const _Math7 = Math;
      const absolute2 = Math.abs(defaultResult3);
      if (absolute2 < tmp6(3543).secondsInDay) {
        const _Math = Math;
      ...
      if (absolute3 < tmp6(3543).secondsInWeek) {
        num2 = tmp3.default(defaultResult1, defaultResult2);
        if (num2) {
          const _Math3 = Math;
          str = "day";
      ...
      if (absolute4 < tmp6(3543).secondsInMonth) {
        num2 = tmp9.default(defaultResult1, defaultResult2);
        str = "week";
      } else {
        const _Math8 = Math;
        const absolute5 = Math.abs(defaultResult3);
        if (absolute5 < tmp6(3543).secondsInQuarter) {
          num2 = tmp5.default(defaultResult1, defaultResult2);
          str = "month";
        } else {
          const _Math5 = Math;
          const absolute6 = Math.abs(defaultResult3);
          if (absolute6 < tmp6(3543).secondsInYear) {
