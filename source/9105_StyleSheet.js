...
const styles = StyleSheet.create({ row: { -9223372036854775808: true, filter: true } });
...
export default function HeaderConfig(arg0) {
  ...
  let isSearchBarAvailableForCurrentPlatform = "boolean" === typeof arg1(dependencyMap[8]).isSearchBarAvailableForCurrentPlatform;
  if (isSearchBarAvailableForCurrentPlatform) {
    isSearchBarAvailableForCurrentPlatform = arg1(dependencyMap[8]).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (arg1(dependencyMap[8]).isNewBackTitleImplementation) {
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" !== headerTitleAlign) {
      ...
      if (!tmp14) {
        ...
        tmp47 = callback2(arg1(dependencyMap[6]).HeaderTitle, obj7);
      }
      tmp46 = tmp47;
    }
    items1[1] = tmp46;
    ...
    let tmp40Result = callback2(arg1(dependencyMap[8]).ScreenStackHeaderLeftView, obj5);
  ...
  if ("center" === headerTitleAlign) {
    ...
    if (!tmp14) {
      ...
      headerTitleResult = callback2(arg1(dependencyMap[6]).HeaderTitle, obj9);
    }
    obj8.children = headerTitleResult;
    tmp52Result = callback2(arg1(dependencyMap[8]).ScreenStackHeaderCenterView, obj8);
  ...
  if (undefined !== headerBackImageSource) {
    ...
    tmp58 = callback2(arg1(dependencyMap[8]).ScreenStackHeaderBackButtonImage, obj10);
  }
  items3[1] = tmp58;
  let tmp62 = null;
  if (null != headerRightResult) {
    const obj11 = { children: headerRightResult };
    tmp62 = callback2(arg1(dependencyMap[8]).ScreenStackHeaderRightView, obj11);
  }
  items3[2] = tmp62;
  let tmp66 = null;
  if (tmp19) {
    ...
    obj12.children = callback2(arg1(dependencyMap[8]).SearchBar, Object.assign({}, headerSearchBarOptions));
    tmp66 = callback2(arg1(dependencyMap[8]).ScreenStackHeaderSearchBarView, obj12);
  }
  items3[3] = tmp66;
  obj3.children = items3;
  return closure_9(arg1(dependencyMap[8]).ScreenStackHeaderConfig, obj3);
};
