...
// Function ID: 26825
// Name: format
// Dependencies: [3426, 3477, 3244, 3478, 3489, 3407, 3248, 3245, 3490, 3249, 3491]
// Exports: default
              ...
              if (isValid.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!useAdditionalWeekYearTokens) {
                      useAdditionalWeekYearTokens = !defaultResult1(3491).isProtectedWeekYearToken(str);
                    }
                    if (!useAdditionalWeekYearTokens) {
                      const _String = String;
                      defaultResult1(3491).throwProtectedError(str, dependencyMap, String(defaultResult1));
                    }
                    ...
                    if (!useAdditionalDayOfYearTokens) {
                      useAdditionalDayOfYearTokens = !defaultResult1(3491).isProtectedDayOfYearToken(str);
                    }
                    if (!useAdditionalDayOfYearTokens) {
