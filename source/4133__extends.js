...
// Function ID: 4134
// Name: _extends
// Dependencies: [19, 4134, 1229, 1230, 1223, 4137]

// Module 4133 (_extends)
...
export const MemoryRouter = Component2(4137).Redirect;
export const Prompt = Component2(4137).Redirect;
export const Redirect = Component2(4137).Redirect;
export const Route = Component2(4137).Route;
export const Router = Component2(4137).Router;
export const StaticRouter = Component2(4137).StaticRouter;
export const Switch = Component2(4137).Switch;
export const generatePath = Component2(4137).generatePath;
export const matchPath = Component2(4137).matchPath;
export const useHistory = Component2(4137).useHistory;
export const useLocation = Component2(4137).useLocation;
export const useParams = Component2(4137).useParams;
export const useRouteMatch = Component2(4137).useRouteMatch;
export const withRouter = Component2(4137).withRouter;
