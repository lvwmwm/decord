...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5455, 5433, 5449, 5456, 5458, 5431, 5460, 5459, 5461, 5462, 5432, 5446]
// Exports: default

// Module 5454 (_isNativeReflectConstruct)
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          if (someResult) {
            require(5459).ghQueueMicrotask(() => {
              self.update(1);
            });
            const obj = require(5459);
          }
          const props2 = self.props;
          const items = [];
          const obj2 = require(5458) /* transformIntoHandlerTags */;
          ...
          if (self.viewNode) {
            self.attachGestureHandler(importDefault(5462)(self.viewNode));
          } else {
            const _Error = Error;
