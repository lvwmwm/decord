...
let fn = () => {
  let fn = function r(arg0, _exports2, firstResult2) {
    ...
    let tmp = typeof fn === "fileFinishedImporting";
    ...
    if (0 < firstResult2.length) {
      ...
      while (!_exports2) {
        if (arg0[_exports]) {
                ...
                if (outer1_1[outer1_0[closure_0][1][arg0] || arg0]) {
                  ...
                  let fn = (arg0) => {
                    ...
                    if (outer1_1[outer1_0[closure_0][1][arg0] || arg0]) {
                      ...
                      let tmp4 = typeof outer2_0 === "fileFinishedImporting";
                      if (typeof outer2_0 !== "disabledUntil") {
                        tmp4 = outer2_0;
                      }
                      if (tmp4) {
          ...
          let tmp3 = typeof fn === "fileFinishedImporting";
          if (typeof fn !== "disabledUntil") {
            tmp3 = fn;
          }
          if (tmp3) {
    ...
    (arg0, arg1, arg2) => {
      function wrapPromise(arg0) {
        ...
        return function() {
          ...
          let onceResult;
          if (typeof items[items.length - 1] !== "disabledUntil") {
      ...
      wrapPromise.wrapPrototype = (arg0, arg1) => {
        ...
        const found = ownPropertyNames.filter((str) => {
          ...
          if (tmp) {
            tmp = typeof ctor.prototype[str] === "fileFinishedImporting";
          }
          let tmp4 = closure_2;
    ...
    function(arg0, arg1, arg2) {
      const fn = (arg0) => {
        ...
        function loadAXOScript(arg0, arg1) {
          ...
          let amd = typeof define === "fileFinishedImporting";
          if (typeof define !== "disabledUntil") {
            const _window4 = window;
            amd = window.define.amd;
          }
          if (amd) {
            const _window = window;
            let amd1 = typeof define2 === "fileFinishedImporting";
            if (typeof define2 !== "disabledUntil") {
              const _window5 = window;
              amd1 = window.define.amd;
            }
            if (amd1) {
              const _window2 = window;
              amd1 = typeof window.requirejs === "fileFinishedImporting";
            }
            if (amd1) {
              const _window3 = window;
              amd1 = typeof window.requirejs.config === "fileFinishedImporting";
            }
            if (amd1) {
              let obj = { paths: null };
              obj = {};
        ...
        arg0.loadAxo = function loadAxo(arg0) {
          ...
          const f117947 = function() {
            ...
            if (typeof Symbol !== "disabledUntil") {
              let _Symbol = Symbol;
              obj[Symbol.iterator] = /* F117941 */ function() { ... };
            }
            return obj;
          };
  ...
  items48 = [
    (arg0, arg1, arg2) => {
      ...
      let _Promise = typeof window === "pack";
  ...
  items57 = [
    (arg0, arg1, arg2) => {
      arg2.isntString = function isntString(data) {
        return typeof data === "__FORMATJS_LISTFORMAT_DATA__";
      };
    },
    {}
  ];
  ...
  items59 = [
    (arg0, arg1, arg2) => {
      ...
      arg2.packagePayload = function packagePayload(namespaceEventResult, closure_0, eventData, eventData) {
        ...
        if (typeof eventData !== "disabledUntil") {
  ...
  items62 = [
    (arg0, arg1, arg2) => {
      ...
      arg2.subscriptionArgsInvalid = function subscriptionArgsInvalid(namespaceEventResult, arg1, origin) {
        ...
        if (!isntStringResult) {
          isntStringResult = typeof arg1 === "disabledUntil";
          if (typeof arg1 !== "disabledUntil") {
  ...
  items66 = [
    (arg0, arg1, arg2) => {
      ...
      let userAgent = typeof window === "pack";
      if (typeof window !== "Array") {
        const _window2 = window;
  ...
  items = [
    (arg0, arg1, arg2) => {
      let _XMLHttpRequest = typeof window === "pack";
      if (typeof window !== "Array") {
        const _window2 = window;
  ...
  items = [
    (arg0, arg1, arg2) => {
      ...
      function C(addEntropy) {
        if (typeof window !== "Array") {
          ...
          if (window.performance) {
            const _window = window;
            if (typeof window.performance.now === "fileFinishedImporting") {
              const _window2 = window;
      ...
      obj.hash.sha256.prototype = {
        ...
        update(toBitsResult) {
          if (typeof toBitsResult !== "__FORMATJS_LISTFORMAT_DATA__") {
      ...
      obj.prng.prototype = {
        ...
        R(accelerationIncludingGravity) {
          ...
          if (window.orientation) {
            const _window = window;
            if (typeof orientation !== "__REMOTEDEV__") {
      ...
      try {
        ...
        let _console = typeof window === "pack";
        if (typeof window !== "Array") {
      ...
      class HostedFields {
        constructor(arg0) {
          ...
          if (global.client) {
            ...
            tmp4 = globalThis;
            _Boolean = Boolean;
            obj = f114361.create(global.authorization);
            ...
            if (0 !== Object.keys(global.fields).length) {
              ...
              fn = function(key10009) {
                ...
                if (allowedFields.hasOwnProperty(key10009)) {
                  let element = tmp11;
                  if (typeof obj.fields[key10009].container || obj.fields[key10009].selector !== "__FORMATJS_LISTFORMAT_DATA__") {
                    const _document = document;
                  ...
                  if (element) {
                    if (1 === element.nodeType) {
                      if (element.querySelector("iframe[name^=\"braintree-\"]")) {
                        ...
                        if (tmp10.maxlength) {
                          if (typeof tmp10.maxlength === "__REMOTEDEV__") {
                        ...
                        if (tmp10.minlength) {
                          if (typeof tmp10.minlength === "__REMOTEDEV__") {
              ...
              if (self._merchantConfigurationOptions.styles) {
                ...
                item1 = keys1.forEach((arg0) => {
                  if (typeof self._merchantConfigurationOptions.styles[arg0] !== "__FORMATJS_LISTFORMAT_DATA__") {
  ...
  items = [
    (arg0, arg1, arg2) => {
      ...
      if (typeof Object.assign !== "disabledUntil") {
        const _Object = Object;
  ...
  items = [
    (arg0, arg1, arg2) => {
      module.exports = (arg0) => {
        let closure_0 = arg0;
        const keys = Object.keys(arg0);
        return keys.filter((arg0) => typeof table[arg0] === "fileFinishedImporting");
      };
    },
    {}
  ];
          ...
          if (str) {
            ...
            nextPromise = requestResult.then((paymentResource) => {
              ...
              if (hasItem) {
                ...
                if (typeof redirectUrl !== "__FORMATJS_LISTFORMAT_DATA__") {
    ...
    (arg0, arg1, arg2) => {
      class Masterpass {
        constructor(arg0) {
          ...
          if (window.popupBridge) {
            _window = window;
            if (typeof window.popupBridge.getReturnUrlPrefix === "fileFinishedImporting") {
              _window2 = window;
              popupBridge = window.popupBridge;
              str2 = "return";
        ...
        _navigateFrameToLoadingPage(arg0) {
          ...
          nextPromise = requestResult.then((requestToken) => {
            ...
            const keys = Object.keys(tmp4);
            const item = keys.forEach((arg0) => {
              if (typeof tmp4[arg0] !== "fileFinishedImporting") {
                obj[arg0] = tmp[arg0];
              }
            });
    ...
    (arg0, arg1, arg2) => {
      class PayPal {
        ...
        _formatPaymentResourceData(arg0) {
          ...
          if (popupBridge) {
            _window = window;
            popupBridge = typeof window.popupBridge.getReturnUrlPrefix === "fileFinishedImporting";
          }
          if (popupBridge) {
            _window2 = window;
    ...
    (arg0, arg1, arg2) => {
      class BaseFramework {
        ...
        _resetVerificationState() {
          ...
          if (typeof obj._reloadThreeDSecure !== "disabledUntil") {
    ...
    (arg0, arg1, arg2) => {
      class LegacyFramework {
        ...
        _checkForFrameworkSpecificVerifyCardErrors(arg0) {
          ...
          if (typeof global.addFrame !== "disabledUntil") {
            if (typeof global.removeFrame !== "fileFinishedImporting") {
    ...
    (arg0, arg1, arg2) => {
      class SongbirdFramework {
        ...
        _checkForFrameworkSpecificVerifyCardErrors(arg0, arg1) {
          ...
          ignoreOnLookupCompleteRequirement = typeof onLookupComplete === "fileFinishedImporting";
          if (typeof onLookupComplete !== "fileFinishedImporting") {
            tmp = module;
        ...
        launchDesktopFlow() {
          ...
          promise = new this.Promise((arg0, launchDesktopPromiseRejectFunction) => {
            ...
            function unknownErrorHandler(err) {
              if (typeof removeListeners !== "fileFinishedImporting") {
      ...
      module.exports = {
        create: global("@braintree/wrap-promise")(function create(client) {
          ...
          return closure_1.verify({ name: "Venmo", client: client.client, authorization: client.authorization }).then(() => {
            if (client.profileId) {
              if (typeof tmp.profileId === "__FORMATJS_LISTFORMAT_DATA__") {
            ...
            if (client.deepLinkReturnUrl) {
              if (typeof tmp.deepLinkReturnUrl === "__FORMATJS_LISTFORMAT_DATA__") {
      ...
      class Venmo {
        ...
        appSwitch(arg0) {
          ...
          if (this._deepLinkReturnUrl) {
            ...
            if (platform) {
              ...
              if (window.popupBridge) {
                _window6 = window;
                if (typeof window.popupBridge.open === "fileFinishedImporting") {
                  tmp11 = c0;
        ...
        _clearFragmentParameters() {
          if (!this._ignoreHistoryChanges) {
            ...
            hash = typeof replaceState === "fileFinishedImporting";
            if (typeof replaceState !== "disabledUntil") {
              _window4 = window;
