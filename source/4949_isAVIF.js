...
arg5.isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4943) /* getFileChunk */.isAvifStringIncluded(fileChunk);
};
...
arg5.isHEIC = function isHEIC(fileChunk) {
  fileChunk = require(4943) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4944).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4943) /* getFileChunk */.isHeicSignatureIncluded(fileChunk);
};
