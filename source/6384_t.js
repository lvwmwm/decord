...
let fn = function t(arg0, arg1) {
  ...
  if (globalThis._setGestureStateSync) {
    ...
    const _Error = Error;
    const error = new Error(require(6382) /* tagMessage */.tagMessage("Failed to set gesture state"));
    throw error;
  }
};
...
function create(handlerTag) {
  ...
  S.__closure = { wrappedSetGestureState: fn, handlerTag, State: _require(6383).State };
  ...
  const obj1 = { wrappedSetGestureState: fn, handlerTag, State: _require(6383).State };
  fn3.__closure = { wrappedSetGestureState: fn, handlerTag, State: _require(6383).State };
  fn3.__workletHash = 6198601582791;
  fn3.__initData = closure_6;
  obj[4] = fn3;
  return obj;
}
obj = { wrappedSetGestureState: fn, State: require("module_6383").State };
