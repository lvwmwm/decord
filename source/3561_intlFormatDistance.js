...
// Dependencies: [3430, 3454, 3455, 3457, 3458, 3460, 3465, 3471, 3268, 3269, 3447]
// Exports: default

// Module 3561 (intlFormatDistance)
...
export default function intlFormatDistance(arg0, arg1, unit) {
  ...
  if (absolute < require(3447) /* keys */.secondsInMinute) {
    ...
    if (absolute1 < tmp6(3447).secondsInHour) {
      ...
      if (absolute3 < tmp6(3447).secondsInWeek) {
        num2 = tmp3.default(defaultResult1, defaultResult2);
        if (num2) {
          const _Math3 = Math;
          str = "day";
      ...
      if (absolute4 < tmp6(3447).secondsInMonth) {
        num2 = tmp9.default(defaultResult1, defaultResult2);
        str = "week";
      } else {
        const _Math8 = Math;
        const absolute5 = Math.abs(defaultResult3);
        if (absolute5 < tmp6(3447).secondsInQuarter) {
          num2 = tmp5.default(defaultResult1, defaultResult2);
          str = "month";
        } else {
          const _Math5 = Math;
          const absolute6 = Math.abs(defaultResult3);
          if (absolute6 < tmp6(3447).secondsInYear) {
