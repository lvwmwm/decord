...
// Dependencies: [5578, 5579, 5583, 5584]

// Module 5577 (RenderTimeTracker)
...
const items = [
  {
    ...
    value: function startTracking() {
      ...
      let trackAverageRenderTimeForOffsetProjection = RenderTimeTracker(5584).PlatformConfig.trackAverageRenderTimeForOffsetProjection;
  ...
  },
  {
    ...
    value: function getAverageRenderTime() {
      const self = this;
      if (RenderTimeTracker(5584).PlatformConfig.trackAverageRenderTimeForOffsetProjection) {
        const _Math = Math;
        const _Math2 = Math;
        const _Math3 = Math;
