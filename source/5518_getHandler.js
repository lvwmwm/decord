...
// Function ID: 5519
// Name: getHandler
// Dependencies: [5488, 5475, 5472, 5510, 5473, 5474]

// Module 5518 (getHandler)
const require = arg1;
const dependencyMap = arg6;
function getHandler(arg0, onBegin) {
  if (require(5488) /* _isNativeReflectConstruct */.CALLBACK_TYPE.BEGAN === arg0) {
  ...
  } else if (tmp(5488).CALLBACK_TYPE.CHANGE === arg0) {
...
function touchEventTypeToCallbackType(arg0) {
  if (require(5475).TouchEventType.TOUCHES_DOWN === arg0) {
...
function runWorklet(arg0, arg1, arg2) {
  ...
  if (arg1.isWorklet[arg0]) {
    ...
    console.warn(require(5472) /* tagMessage */.tagMessage("Animated gesture callback must be a worklet"));
    const obj = require(5472) /* tagMessage */;
  }
}
