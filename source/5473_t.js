...
let fn = function t(arg0, arg1) {
  ...
  if (globalThis._setGestureStateSync) {
    ...
    const _Error = Error;
    const error = new Error(require(5471) /* tagMessage */.tagMessage("Failed to set gesture state"));
    throw error;
  }
};
...
function create(handlerTag) {
  ...
  obj = { wrappedSetGestureState: fn, handlerTag, State: _require(5472).State };
  fn.__closure = obj;
  ...
  S.__closure = { wrappedSetGestureState: fn, handlerTag, State: _require(5472).State };
  ...
  const obj1 = { wrappedSetGestureState: fn, handlerTag, State: _require(5472).State };
  fn3.__closure = { wrappedSetGestureState: fn, handlerTag, State: _require(5472).State };
