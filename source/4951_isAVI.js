...
arg5.isFLV = function isFLV(fileChunk) {
  fileChunk = require(4943) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4944).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "flv") && require(4943) /* getFileChunk */.isFlvStringIncluded(fileChunk);
};
arg5.isM4V = function isM4V(fileChunk) {
  fileChunk = require(4943) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4944).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "m4v") && require(4943) /* getFileChunk */.isftypStringIncluded(fileChunk);
};
arg5.isMKV = function isMKV(fileChunk) {
  fileChunk = require(4943) /* getFileChunk */.getFileChunk(fileChunk, 64);
  const FileTypes = require(4944).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "mkv") && "mkv" === require(4943) /* getFileChunk */.findMatroskaDocTypeElements(fileChunk);
};
...
arg5.isWEBM = function isWEBM(fileChunk) {
  fileChunk = require(4943) /* getFileChunk */.getFileChunk(fileChunk, 64);
  const FileTypes = require(4944).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "webm") && "webm" === require(4943) /* getFileChunk */.findMatroskaDocTypeElements(fileChunk);
};
