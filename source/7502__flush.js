...
// Function ID: 7503
// Name: _flush
// Dependencies: [5, 7481, 7503, 7482, 7454, 7465, 7468, 7461, 7491, 7455, 7477]
...
function endSession() {
  const isolationScope = require(7481) /* getClient */.getIsolationScope();
  const obj = require(7481) /* getClient */;
  const currentScope = require(7481) /* getClient */.getCurrentScope();
  ...
  const currentScope1 = require(7481) /* getClient */.getCurrentScope();
  const tmpResult1 = require(7481) /* getClient */;
...
export const captureException = function captureException(arg0, arg1) {
  const currentScope = require(7481) /* getClient */.getCurrentScope();
  const obj = require(7481) /* getClient */;
  return currentScope.captureException(arg0, require(7503) /* applyClientOptions */.parseEventHintOrCaptureContext(arg1));
};
...
export const captureSession = function captureSession() {
  ...
  if (flag) {
    ...
    const obj5 = require(7481) /* getClient */;
  }
};
...
export const isInitialized = function isInitialized() {
  return require(7481) /* getClient */.getClient();
};
...
export const startSession = function startSession(arg0) {
  ...
  const obj5 = require(7481) /* getClient */;
  const userAgent = require(7455) /* getGlobalSingleton */.GLOBAL_OBJ.navigator || {}.userAgent;
  let tmpResult = tmp(7477);
  obj = { release, environment, user: null };
  const tmp3 = require(7455) /* getGlobalSingleton */.GLOBAL_OBJ.navigator || {};
...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  let currentScope = _require(7481).getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = _require(7481);
  let client = _require(7481).getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = _require(7481);
  captureCheckInResult = _require(7465).uuid4();
};
