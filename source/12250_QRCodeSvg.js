...
// Function ID: 12251
// Name: QRCodeSvg
// Dependencies: [12247, 19, 8528]

// Module 12250 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(8528) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(8528) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(8528) /* inlineStyles */.Path, { d, fill }));
});
