...
let fn = function() {
  ...
  function parse(arg0) {
    ...
    if (text1) {
      ...
      let c2 = product;
      obj = { Apple: { iPad: 1, iPhone: 1, iPod: 1 }, Archos: {}, Amazon: { Kindle: 1, "Kindle Fire": 1 } };
      obj = { Transformer: 1 };
      obj.Asus = obj;
      obj1 = { Nook: 1 };
      ...
      const items4 = ["Windows Phone", "Android", "CentOS", { label: "Chrome OS", pattern: "CrOS" }, "Debian", "Fedora", "FreeBSD", "Gentoo", "Haiku", "Kubuntu", "Linux Mint", "OpenBSD", "Red Hat", "SuSE", "Ubuntu", "Xubuntu", "Cygwin", "Symbian OS", "hpwOS", "webOS ", "webOS", "Tablet OS", "Tizen", "Linux", "Mac OS X", "Macintosh", "Mac", "Windows 98;", "Windows "];
      ...
      if ("IE" == text2) {
        ...
        if (!joined) {
          const items7 = ["(?:Cloud9|CriOS|CrMo|Edge|FxiOS|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$))", "Version", qualify(text2)];
          str = "(?:Firefox|Minefield|NetFront)";
          items7[3] = "(?:Firefox|Minefield|NetFront)";
          joined = (function getVersion(items7) {
            return outer1_12(items7, (arg0, arg1) => {
              let tmp = arg0;
              if (!arg0) {
                const _RegExp = RegExp;
        ...
        if ("Fennec" != text2) {
          ...
          if (obj59.test(str89)) {
            ...
            if (obj62.test(str89)) {
              ...
              let RegExpResult = RegExp(`${str89.replace(/ +/g, " *")}/([.\\d]+)`, "i");
            } else {
              const obj63 = /\bBB10\b/;
            }
            text1 = forOwn;
        ...
        arr13 = str89;
        text1 = manufacturer;
        obj15 = /\blike iPhone OS\b/;
        obj44 = /\bWPDesktop\b/i;
      }
      if (obj16.test(tmp39)) {
        if (!text2) {
          text2 = "Safari";
