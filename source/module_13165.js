...
let closure_5 = require("__exportStarResult1")("".slice);
let closure_6 = require("__exportStarResult1")("".replace);
let closure_7 = require("__exportStarResult1")([].join);
if (__exportStarResult1) {
  __exportStarResult1 = !require("__exportStarResult1")(() => 8 !== defineProperty(() => {
...
Function.prototype.toString = fn(function toString() {
  ...
  if (!source) {
    source = __exportStarResult1(self);
  }
  return source;
}, "toString");
