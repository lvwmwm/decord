...
// Dependencies: [1281, 13385, 13401, 13402]
// Exports: ComputeExponent

// Module 13400 (__exportStarResult13)
import e from "e";
  ...
  if (timesResult.isZero()) {
    ...
    if (roundedNumber.isZero()) {
      ...
      if (floorResult1.eq(floorResult.minus(result))) {
        ...
        const items2 = [tmp2(13401).ComputeExponentForMagnitude(internalSlots, floorResult.plus(1)), floorResult.plus(1).toNumber()];
        return items2;
      }
