...
// Function ID: 7142
// Name: JSFPSMonitor
// Dependencies: [7088, 7089, 7076, 7142]

// Module 7141 (JSFPSMonitor)
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        error = new Error(JSFPSMonitor(7076).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      const obj = { minFPS: JSFPSMonitor(7142).roundToDecimalPlaces(self.minFPS, 1), maxFPS: null, averageFPS: null };
      const obj2 = JSFPSMonitor(7142);
      obj[1] = JSFPSMonitor(7142).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(7142);
      obj[2] = JSFPSMonitor(7142).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    }
  }
];
