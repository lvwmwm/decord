...
// Dependencies: [57, 65, 6429, 6430, 6431, 6354, 6392, 6356, 6346, 6347, 6353]
...
export const addNormalizedRequestDataToEvent = function addNormalizedRequestDataToEvent(request, headers, user, include) {
  ...
  if (merged.ip) {
    ...
    if (ipAddress) {
      ipAddress = require(6430) /* items */.getClientIPAddress(headers.headers);
      const obj4 = require(6430) /* items */;
    }
    if (!ipAddress) {
...
export const addRequestDataToEvent = function addRequestDataToEvent(request, request, include) {
  ...
  if (merged.ip) {
    ...
    if (ip) {
      ip = require(6430) /* items */.getClientIPAddress(request.headers);
      const obj4 = require(6430) /* items */;
    }
    if (!ip) {
      ip = request.ip;
    ...
    if (!obj.customRoute) {
      if (!method.route) {
        ...
        if (tmp) {
          ...
          str4 = require(6429) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
          str5 = "url";
          const obj2 = require(6429) /* getNumberOfUrlSegments */;
        }
