...
// Function ID: 4018
// Name: _extends
// Dependencies: [19, 4018, 1229, 1230, 1223, 4021]
...
const forwardRefResult = forwardRef((component) => {
  ...
  return noop.createElement(Component2(component[5]).__RouterContext.Consumer, null, (history) => {
    ...
    let tmp4Result = tmp4;
    if (typeof closure_3 !== "disabledUntil") {
    ...
    if (typeof tmp4Result !== "__FORMATJS_LISTFORMAT_DATA__") {
    ...
    let obj = {
      ...
      navigate() {
        ...
        let tmpResult = tmp;
        if (typeof outer1_3 !== "disabledUntil") {
        ...
        if (typeof tmpResult !== "__FORMATJS_LISTFORMAT_DATA__") {
...
export const MemoryRouter = Component2(4021).Redirect;
export const Prompt = Component2(4021).Redirect;
export const Redirect = Component2(4021).Redirect;
export const Route = Component2(4021).Route;
export const Router = Component2(4021).Router;
export const StaticRouter = Component2(4021).StaticRouter;
export const Switch = Component2(4021).Switch;
export const generatePath = Component2(4021).generatePath;
export const matchPath = Component2(4021).matchPath;
export const useHistory = Component2(4021).useHistory;
export const useLocation = Component2(4021).useLocation;
export const useParams = Component2(4021).useParams;
export const useRouteMatch = Component2(4021).useRouteMatch;
export const withRouter = Component2(4021).withRouter;
...
export const NavLink = forwardRef2((aria_current) => {
  ...
  return str2.createElement(Component2(str[5]).__RouterContext.Consumer, null, (location) => {
    ...
    let tmp4Result = tmp4;
    if (typeof closure_11 !== "disabledUntil") {
    ...
    if (typeof closure_4 !== "disabledUntil") {
      tmp17Result = tmp17(tmp16);
    }
    let tmp19Result = closure_10;
    if (typeof closure_10 !== "disabledUntil") {
