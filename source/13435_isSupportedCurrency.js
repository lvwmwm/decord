...
// Dependencies: [13352, 13436]

// Module 13435 (isSupportedCurrency)
const require = arg1;
...
function isSupportedCurrency(arr3, locale) {
  ...
  try {
    ...
    obj[2] = arr3;
    const memoizedNumberFormat = require(13352) /* _formatToParts */.createMemoizedNumberFormat(str, obj);
...
arg5.getSupportedCurrencies = function getSupportedCurrencies(locale) {
  const items = [];
  const currencies = require(13436).currencies;
