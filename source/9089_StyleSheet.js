...
// Function ID: 71264
// Name: StyleSheet
// Dependencies: [57, 31, 27, 33, 1457, 9090, 5561, 9091, 4513]
// Exports: default

// Module 9089 (StyleSheet)
...
export default function HeaderConfig(arg0) {
  ...
  let obj1 = require(9090) /* processFonts */;
  ...
  let obj2 = require(5561) /* Background */;
  ...
  importDefault(9091)();
  let isSearchBarAvailableForCurrentPlatform = "boolean" === typeof require(4513) /* enableScreens */.isSearchBarAvailableForCurrentPlatform;
  if (isSearchBarAvailableForCurrentPlatform) {
    isSearchBarAvailableForCurrentPlatform = require(4513) /* enableScreens */.isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (require(4513) /* enableScreens */.isNewBackTitleImplementation) {
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" !== headerTitleAlign) {
      ...
      if (!tmp14) {
        ...
        tmp47 = callback2(require(5561) /* Background */.HeaderTitle, obj7);
      }
      tmp46 = tmp47;
    }
    items1[1] = tmp46;
    ...
    let tmp40Result = callback2(require(4513) /* enableScreens */.ScreenStackHeaderLeftView, obj5);
  ...
  if ("center" === headerTitleAlign) {
    ...
    if (!tmp14) {
      ...
      headerTitleResult = callback2(require(5561) /* Background */.HeaderTitle, obj9);
    }
    obj8.children = headerTitleResult;
    tmp52Result = callback2(require(4513) /* enableScreens */.ScreenStackHeaderCenterView, obj8);
  ...
  if (undefined !== headerBackImageSource) {
    ...
    tmp58 = callback2(require(4513) /* enableScreens */.ScreenStackHeaderBackButtonImage, obj10);
  }
  items3[1] = tmp58;
  let tmp62 = null;
  if (null != headerRightResult) {
    const obj11 = { children: headerRightResult };
    tmp62 = callback2(require(4513) /* enableScreens */.ScreenStackHeaderRightView, obj11);
  }
  items3[2] = tmp62;
  let tmp66 = null;
  if (tmp19) {
    ...
    obj12.children = callback2(require(4513) /* enableScreens */.SearchBar, Object.assign({}, headerSearchBarOptions));
    tmp66 = callback2(require(4513) /* enableScreens */.ScreenStackHeaderSearchBarView, obj12);
  }
  items3[3] = tmp66;
  obj3.children = items3;
  return closure_9(require(4513) /* enableScreens */.ScreenStackHeaderConfig, obj3);
};
