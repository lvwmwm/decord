...
// Function ID: 4221
// Name: registerHost
// Dependencies: [4221, 4216]

// Module 4220 (registerHost)
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (portalName(4216).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4216).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4216).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4216).ACTIONS.REMOVE_PORTAL === type) {
