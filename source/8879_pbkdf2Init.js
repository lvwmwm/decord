...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  ({ c, dkLen, asyncTick } = require(dependencyMap[2]).checkOpts({ <string:4266736225>: true, <string:2486919682>: true }, arg3));
  ...
  const checkOptsResult = require(dependencyMap[2]).checkOpts({ <string:4266736225>: true, <string:2486919682>: true }, arg3);
}
