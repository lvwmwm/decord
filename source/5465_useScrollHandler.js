...
// Dependencies: [5466, 1653, 5456]

// Module 5465 (useScrollHandler)
const require = arg1;
...
arg5.useScrollHandler = (arg0, onScroll, onScrollBeginDrag, onScrollEndDrag) => {
  ...
  if (arg0 === undefined) {
    useScrollEventsHandlersDefault = _require(5466).useScrollEventsHandlersDefault;
  }
  _require = onScroll;
