// Module ID: 1667
// Function ID: 1668
// Dependencies: [32, 41, 42, 91, 1656, 1668, 1669, 1678, 1664, 1657]
...
if (!isJest.isJest()) {
  ...
  obj15[1] = function getViewProp(arg0, arg1, arg2, arg3) {
    const reanimatedError = new JSReanimated(1664).ReanimatedError("getViewProp is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[16] = obj15;
  const obj16 = { key: "configureProps", value: null };
  obj16[1] = function configureProps() {
    const reanimatedError = new JSReanimated(1664).ReanimatedError("configureProps is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[17] = obj16;
