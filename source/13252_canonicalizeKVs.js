...
// Dependencies: [1257, 13253, 13251, 13254, 13255]

// Module 13252 (canonicalizeKVs)
const require = arg1;
const dependencyMap = arg6;
function canonicalizeKVs(fields) {
  const obj = {};
  const items = [];
  for (let num = 0; num < fields.length; num = num + 1) {
    let tmp = fields[num];
    if (!(tmp[0] in obj)) {
      obj[tmp[0]] = 1;
      if (tmp[1]) {
...
function mergeVariants(variants, variants2) {
  const __spreadArrayResult = require(1257) /* createExporter */.__spreadArray([], variants, true);
...
function canonicalizeUnicodeLanguageId(lang) {
  ...
  if (lang.variants.length) {
    ...
    if (0 < variants.length) {
      ...
      obj.variants = items;
      const str = require(13253).languageAlias[require(undefined, 13251) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj)];
      while (!str) {
        num = num + 1;
        tmp = lang;
      }
      obj = {};
      const result = require(13254) /* isUnicodeLanguageSubtag */.parseUnicodeLanguageId(str.split(require(13254) /* isUnicodeLanguageSubtag */.SEPARATOR));
  ...
  if (tmp.script) {
    ...
    if (tmp.region) {
      ...
      obj.variants = [];
      const str2 = require(13253).languageAlias[require(undefined, 13251) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj)];
      tmp8 = tmp;
      if (str2) {
        const obj1 = {};
        const result1 = require(13254) /* isUnicodeLanguageSubtag */.parseUnicodeLanguageId(str2.split(require(13254) /* isUnicodeLanguageSubtag */.SEPARATOR));
  ...
  if (tmp8.region) {
    ...
    obj2.variants = [];
    const str3 = require(13253).languageAlias[require(undefined, 13251) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj2)];
    tmp14 = tmp8;
    if (str3) {
      const obj3 = {};
      const result2 = require(13254) /* isUnicodeLanguageSubtag */.parseUnicodeLanguageId(str3.split(require(13254) /* isUnicodeLanguageSubtag */.SEPARATOR));
  ...
  const str4 = require(13253).languageAlias[require(undefined, 13251) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj4)];
  let tmp20 = tmp14;
  if (str4) {
    const obj5 = {};
    const result3 = require(13254) /* isUnicodeLanguageSubtag */.parseUnicodeLanguageId(str4.split(require(13254) /* isUnicodeLanguageSubtag */.SEPARATOR));
  ...
  if (tmp20.region) {
    ...
    const str6 = require(13253).territoryAlias[formatted];
    let tmp27;
    if (str6) {
      ...
      obj6.variants = [];
      const str8 = require(13255) /* __exportStarResult2 */.likelySubtags[require(undefined, 13251) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj6)];
      tmp27 = first;
      if (str8) {
        const region = require(13254) /* isUnicodeLanguageSubtag */.parseUnicodeLanguageId(str8.split(require(13254) /* isUnicodeLanguageSubtag */.SEPARATOR)).region;
        let tmp33 = region;
        if (region) {
  ...
  if (tmp20.script) {
    ...
    if (require(13253).scriptAlias[tmp20.script]) {
      tmp20.script = require(13253).scriptAlias[tmp20.script];
    }
    const str10 = tmp20.script[0];
    const str11 = script.slice(1);
  }
  if (tmp20.variants.length) {
    for (let num17 = 0; num17 < tmp20.variants.length; num17 = num17 + 1) {
      let str12 = tmp20.variants[num17];
      let formatted2 = str12.toLowerCase();
      let tmp40 = require;
      let tmp41 = dependencyMap;
      if (require(13253).variantAlias[formatted2]) {
        let tmp42 = require;
        let tmp43 = dependencyMap;
        let tmp44 = require(13253).variantAlias[formatted2];
        if (require(13254) /* isUnicodeLanguageSubtag */.isUnicodeVariantSubtag(tmp44)) {
          ...
          let tmp47 = tmp44;
          if (require(13254) /* isUnicodeLanguageSubtag */.isUnicodeLanguageSubtag(tmp44)) {
            tmp20.lang = tmp44;
            let tmp48 = tmp44;
          }
        }
...
arg5.CanonicalizeUnicodeLocaleId = function CanonicalizeUnicodeLocaleId(lang) {
  ...
  if (lang.extensions) {
    ...
    for (let num = 0; num < extensions.length; num = num + 1) {
      ...
      let type = iter.type;
      if ("u" === type) {
        let tmp4 = canonicalizeKVs;
        iter.keywords = canonicalizeKVs(iter.keywords);
        if (iter.attributes) {
        ...
        if (iter.lang) {
          let tmp2 = canonicalizeUnicodeLanguageId;
          iter.lang = canonicalizeUnicodeLanguageId(iter.lang);
        }
        let tmp3 = canonicalizeKVs;
        iter.fields = canonicalizeKVs(iter.fields);
      } else {
        let str3 = iter.value;
