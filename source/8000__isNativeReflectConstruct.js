...
// Module 8000 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      obj.x = null;
      obj.y = null;
      const tmp2Result = importDefault(7916)(obj, this);
      const merged1 = Object.assign(tmp2Result, importDefault(7923)(propsAndStylesResult, false));
      tmp2Result.ref = this.refMethod;
      obj = {};
      const tmp2 = importDefault(7916);
      const merged2 = Object.assign(tmp2Result);
      return jsx(importDefault(8001), {});
    }
  }
];
