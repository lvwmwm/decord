...
// Function ID: 6399
// Name: getClient
// Dependencies: [6389, 6390, 6372, 6392, 6377]
...
arg5.getGlobalScope = function getGlobalScope() {
  return require(6372) /* getGlobalSingleton */.getGlobalSingleton("globalScope", () => {
...
arg5.getTraceContextFromScope = function getTraceContextFromScope(getPropagationContext) {
  ...
  return require(6377) /* addNonEnumerableProperty */.dropUndefinedKeys({ trace_id, span_id, parent_span_id });
};
arg5.withIsolationScope = function withIsolationScope() {
  ...
  const obj2 = require(6390) /* getAsyncContextStrategy */;
};
