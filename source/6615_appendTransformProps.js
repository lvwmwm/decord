...
// Dependencies: [6616, 6617, 6618]

// Module 6615 (appendTransformProps)
import append from "append" /* 6616 */;
import peg$SyntaxError from "peg$SyntaxError" /* 6617 */;
import peg$SyntaxError2 from "peg$SyntaxError" /* 6618 */;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(6617);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(6616);
