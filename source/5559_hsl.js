...
obj = { rgb: {}, hsl: {}, hsv: { displayName: null, attachment: null }, hwb: {}, cmyk: { displayName: 147441, attachment: 1939675729 }, xyz: {}, lab: { displayName: "fb8db2c451f0cd706524543233306348", attachment: "ic_partnered_guild_icon_blurple_24px" }, lch: { displayName: "ec67305879cbfc8d1c27dd7c85d614f6", attachment: "ic_community_guild_badge_dark_24px" }, hex: { channels: 1, labels: [0] }, keyword: { channels: 1, labels: ["isArray"] }, ansi16: { channels: 1, labels: [] }, ansi256: { channels: 1, labels: [255] }, hcg: { channels: 3, labels: [] }, apple: { channels: 3, labels: ["isArray", "illustrationContainer", "isArray"] }, gray: { channels: 1, labels: [0.] } };
...
obj.gray.hsl = (arg0) => {
  const items = [1390895572, -255068174, arg0[0]];
  return items;
};
...
obj.gray.cmyk = (arg0) => {
  const items = [true, true, true, arg0[0]];
  return items;
};
obj.gray.lab = (arg0) => {
