...
// Dependencies: [7538, 7539, 7540, 7463, 7501, 7465, 7455, 7456, 7462]

// Module 7537 (extractRequestData)
const require = arg1;
  ...
  if (!obj.customRoute) {
    if (!method.route) {
      ...
      if (tmp) {
        ...
        str5 = require(7538) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
        str4 = "url";
        const obj2 = require(7538) /* getNumberOfUrlSegments */;
      }
...
arg5.httpRequestToRequestData = function httpRequestToRequestData(headers) {
  ...
  return require(7462) /* addNonEnumerableProperty */.dropUndefinedKeys(obj);
};
