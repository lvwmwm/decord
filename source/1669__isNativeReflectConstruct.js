...
// Dependencies: [41, 42, 93, 95, 98, 1670, 19, 17, 21, 1637, 1688, 38, 1729, 1730, 1738, 1740, 1678, 1659, 1741, 1743, 1737, 1721, 1674, 1663, 1645, 1747, 1662, 1731, 1733, 1748, 1749, 1750, 1772, 1773]
// Exports: createAnimatedComponent

// Module 1669 (_isNativeReflectConstruct)
    ...
    },
    {
      ...
      value: function _configureLayoutAnimation(EXITING, exiting, exiting2) {
        if (!isJest) {
          if (exiting !== exiting2) {
            const self = this;
            const obj = require(1748) /* updateLayoutAnimations */;
            if (obj2.isFabric()) {
