...
// Function ID: 100077
// Name: outside
// Dependencies: [12838, 12867, 12858, 12863, 12859, 12862, 12869, 12866]

// Module 12875 (outside)
...
export default function outside(arg0, arg1, arg2, arg3) {
  ...
  require = tmp;
  let tmp3 = require(12867) /* Range */;
  tmp3 = new tmp3(arg1, arg3);
  const dependencyMap = tmp3;
  if (">" === arg2) {
    let closure_3 = require(12858) /* gt */;
    let closure_4 = require(12863) /* lte */;
    let closure_5 = require(12859) /* lt */;
    let c6 = ">";
    let c7 = ">=";
  } else if ("<" === arg2) {
    closure_3 = require(12859) /* lt */;
    closure_4 = require(12862) /* gte */;
    closure_5 = require(12858) /* gt */;
    c6 = "<";
    c7 = "<=";
  } else {
  ...
  if (require(12869) /* satisfies */(tmp, tmp3, arg3)) {
    return false;
  } else {
    let num7 = 0;
    num7 = 0;
