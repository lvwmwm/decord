...
// Dependencies: [1656, 1663, 1696, 1755, 1756, 1660, 1664]
...
function updatePropsOnReactJS(arg0, arg1) {
  const ComponentRegistry = require(1756) /* map */.ComponentRegistry;
...
if (isJest.shouldBeUseWeb()) {
  ...
  fn = function s(value, transformOrigin) {
    ...
    require(1696) /* call */.processColorsInProps(transformOrigin);
    if ("transformOrigin" in transformOrigin) {
      transformOrigin.transformOrigin = require(1755) /* validateTransformOrigin */.processTransformOrigin(transformOrigin.transformOrigin);
      const tmp2Result = require(1755) /* validateTransformOrigin */;
    }
      ...
      if (__frameTimestamp) {
        if (tmp2) {
          if (__frameTimestamp - tmp2 >= 20) {
            require(1660) /* runWorkletOnJS */.runOnJS(updatePropsOnReactJS)(arg0, tmp.lastUpdateByTag[arg0]);
