...
// Function ID: 4960
// Name: constructTag
// Dependencies: [4915, 4931, 4943, 4912, 4919, 4945]

// Module 4959 (constructTag)
const require = arg1;
const module = arg2;
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  const stringValueFromArray = require(4912) /* getDataView */.getStringValueFromArray(items1);
  let combined = stringValueFromArray;
  if (type !== require(4919).TYPE_TEXT) {
  ...
  if (type === require(4919).TYPE_ITXT) {
