...
arg5.is7Z = function is7Z(fileChunk) {
  fileChunk = require(4718) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4719).FileTypes;
...
arg5.isZIP = function isZIP(fileChunk, chunkSize) {
  ...
  fileChunk = require(4718) /* getFileChunk */.getFileChunk(fileChunk, num);
  const FileTypes = require(4719).FileTypes;
