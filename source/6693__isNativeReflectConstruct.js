...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 6615, 6685, 6694, 6620, 6631]

// Module 6693 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      const tmp3Result = self(6615)(patternTransform);
      ...
      if (patternContentUnits) {
        num2 = tmp(6685)[patternContentUnits];
      }
      obj[8] = num2;
      obj = {
        ref(arg0) {
      ...
      const tmp3 = self(6615);
      const merged = Object.assign(obj);
      const merged1 = Object.assign(tmp(6620)({ viewBox, preserveAspectRatio }));
      obj.children = children;
      return jsx(self(6694), {
        ref(arg0) {
          return self.refMethod(arg0);
        }
      });
