// Module ID: 13653
// Function ID: 13654
// Dependencies: [41, 42, 32, 13647, 13654, 13655]
...
obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, require(13647) /* SymbolResult1 */.implSymbol)) {
      ...
      obj = require(13647) /* SymbolResult1 */;
    }
    return false;
  },
  isImpl(arg0) {
    if (arg0) {
      if (arg0 instanceof require(13654) /* URLSearchParamsImpl */.implementation) {
        return true;
      } else {
        const _mixedIntoPredicates = module.exports._mixedIntoPredicates;
  ...
  convert(arg0) {
    ...
    if (_exports.is(arg0)) {
      return require(13647) /* SymbolResult1 */.implForWrapper(arg0);
    } else {
  ...
  createDefaultIterator(self, key) {
    ...
    Object.defineProperty(obj, require(13647) /* SymbolResult1 */.iterInternalSymbol, { value: obj, configurable: true });
    return obj;
  },
  ...
  setup(wrapper) {
    ...
    const implementation = new require(13654) /* URLSearchParamsImpl */.implementation(arg1, items, obj);
    obj[0] = implementation;
    Object.defineProperty(wrapper, require(13647) /* SymbolResult1 */.implSymbol, obj);
    wrapper[require(undefined, 13647) /* SymbolResult1 */.implSymbol][require(13647) /* SymbolResult1 */.wrapperSymbol] = wrapper;
    if (require(13654) /* URLSearchParamsImpl */.init) {
