...
// Function ID: 1803
// Name: o
// Dependencies: [1803, 1677, 1804, 1645, 1786, 1678]
...
const fn = function o(arg0, arg1, h, useCorrectedHSVInterpolation) {
  ...
  if (undefined !== useCorrectedHSVInterpolation) {
    if (!useCorrectedHSVInterpolation) {
      let tmp = require;
      const obj = require(1803) /* getVal */;
      let interpolateResult = obj.interpolate(arg0, arg1, h.h, require(1803) /* getVal */.Extrapolation.CLAMP);
    }
  ...
  interpolateResult = (require(1803) /* getVal */.interpolate(arg0, items, items1, require(1803) /* getVal */.Extrapolation.CLAMP) + 1) % 1;
  tmp = require;
};
...
const fn5 = function n(arg0, arg1, l) {
  ...
  let r;
  const obj = require(1803) /* getVal */;
  const interpolateResult = require(1803) /* getVal */.interpolate(arg0, arg1, l.l, require(1803) /* getVal */.Extrapolation.CLAMP);
  const obj2 = require(1803) /* getVal */;
  const interpolateResult1 = require(1803) /* getVal */.interpolate(arg0, arg1, l.a, require(1803) /* getVal */.Extrapolation.CLAMP);
  const obj3 = require(1803) /* getVal */;
  const interpolateResult2 = require(1803) /* getVal */.interpolate(arg0, arg1, l.b, require(1803) /* getVal */.Extrapolation.CLAMP);
  const obj4 = require(1803) /* getVal */;
  const convert = importDefault(1804).oklab.convert;
  const interpolateResult3 = require(1803) /* getVal */.interpolate(arg0, arg1, l.alpha, require(1803) /* getVal */.Extrapolation.CLAMP);
  ({ r, g, b, alpha } = convert.toRgb({ l: interpolateResult, a: interpolateResult1, b: interpolateResult2, alpha: require(1803) /* getVal */.interpolate(arg0, arg1, l.alpha, require(1803) /* getVal */.Extrapolation.CLAMP) }));
  const toRgbResult = convert.toRgb({ l: interpolateResult, a: interpolateResult1, b: interpolateResult2, alpha: require(1803) /* getVal */.interpolate(arg0, arg1, l.alpha, require(1803) /* getVal */.Extrapolation.CLAMP) });
  return require(1677) /* call */.rgbaColor(r, g, b, alpha);
};
...
function interpolateColor(arg0, arg1, arg2) {
  ...
  if ("HSV" === str) {
    ...
    const reanimatedError = new require(1645) /* t */.ReanimatedError("Invalid color space provided: " + str + ". Supported values are: ['RGB', 'HSV', 'LAB'].");
...
export const useInterpolateConfig = function useInterpolateConfig(inputRange, outputRange, arg2, UNDETERMINED) {
  ...
  obj4 = require(1678) /* isReanimated3 */;
  obj[3] = obj4.makeMutable(null);
  obj[4] = obj;
  return require(1786) /* useSharedValue */.useSharedValue(obj);
};
