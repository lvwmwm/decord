...
function applyStyleForTopScreen(screenTransition) {
  ...
  require(1753) /* updateProps */.updateProps(obj, topScreenStyleResult, undefined);
}
...
function applyStyleForBelowTopScreen(screenTransition, arg1) {
  ...
  require(1753) /* updateProps */.updateProps(obj, belowTopScreenStyleResult, undefined);
}
...
function applyStyle(closure_1, value) {
  ...
  obj = { value: null };
  const obj2 = require(1753) /* updateProps */;
