...
arg5.default = {
  read(byteLength) {
    ...
    const ifd = obj1.readIfd(byteLength, require(5015) /* importDefaultResult1 */.IFD_TYPE_PENTAX, sum, sum + 10, byteOrder, arg3, true);
    ...
    if (LevelInfo) {
      ...
      const tmp7Result = require(4994) /* getDataView */;
      delete tmp[tmp2];
      tmp10 = require(4994) /* getDataView */.objectAssign({}, ifd, obj);
