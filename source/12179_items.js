...
// Function ID: 95312
// Name: items
// Dependencies: [12180, 12181, 12175]
...
obj.getErrorCorrectPolynomial = function getErrorCorrectPolynomial(diff) {
  let tmp = require(12180) /* QRPolynomial */;
  tmp = new tmp([1], 0);
  ...
  if (0 < diff) {
    do {
      ...
      let tmp6 = require(12180) /* QRPolynomial */;
      let obj2 = require(12181);
...
obj.getLengthInBits = function getLengthInBits(arg0, arg1) {
  if (1 <= arg1) {
    if (arg1 < 10) {
      if (require(12175).MODE_NUMBER === arg0) {
        return 10;
      } else if (require(12175).MODE_ALPHA_NUM === arg0) {
        return 9;
      } else {
        if (require(12175).MODE_8BIT_BYTE !== arg0) {
          if (require(12175).MODE_KANJI !== arg0) {
            const _Error4 = Error;
  ...
  if (arg1 < 27) {
    if (require(12175).MODE_NUMBER === arg0) {
      ...
      return 11;
    } else if (require(12175).MODE_8BIT_BYTE === arg0) {
      return 16;
    } else if (require(12175).MODE_KANJI === arg0) {
      return 10;
    } else {
      const _Error3 = Error;
