...
// Function ID: 41632
// Name: hasTagsData
// Dependencies: [4746, 4788]

// Module 4787 (hasTagsData)
const require = arg1;
...
function parseTags(buffer) {
  ...
  if (buffer.byteLength !== buffer.getUint32()) {
    ...
    const keys = Object.keys(require(4788) /* toCompany */.iccProfile);
    for (let num = 0; num < keys.length; num = num + 1) {
      let tmp = keys[num];
      let tmp2 = require;
      let tmp3 = dependencyMap;
      let iter = require(4788) /* toCompany */.iccProfile[tmp];
      ...
      if (buffer.length < 132) {
        ...
        if (0 < uint32) {
          while (!hasTagsData(buffer, num8)) {
            ...
            let obj1 = require(4746) /* getStringFromDataView */;
            ...
            if (uint321 > buffer.length) {
              ...
              let obj8 = require(4746) /* getStringFromDataView */;
                ...
                if (stringFromDataView1 === mluc) {
                  ...
                  if (0 < uint324) {
                    do {
                      ...
                      let obj5 = require(4746) /* getStringFromDataView */;
...
function addTag(arg0, stringFromDataView, text) {
  if (require(4788) /* toCompany */.iccTags[stringFromDataView]) {
    let obj = { value: text, description: text };
    arg0[require(4788) /* toCompany */.iccTags[stringFromDataView].name] = obj;
  } else {
...
arg5.default = {
  read(buffer, arr) {
    if (arg2) {
      if (arr[0].compressionMethod !== require(4746) /* getStringFromDataView */.COMPRESSION_METHOD_NONE) {
