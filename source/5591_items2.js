...
// Function ID: 5592
// Name: items2
// Dependencies: [5592, 5594, 5595, 5596, 5597, 5598, 5599]

// Module 5591 (items2)
import ComposedGestureName from "ComposedGestureName" /* 5592 */;
import set6 from "set" /* 5594 */;
import set7 from "set" /* 5595 */;
import set8 from "set" /* 5596 */;
import set9 from "set" /* 5597 */;
import set10 from "set" /* 5598 */;
import set11 from "set" /* 5599 */;
