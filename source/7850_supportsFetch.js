...
// Function ID: 7851
// Name: supportsFetch
// Dependencies: [7739, 7737, 7738]

// Module 7850 (supportsFetch)
const require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in require(7739) /* getGlobalSingleton */.GLOBAL_OBJ) {
    try {
...
arg5.supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    ...
    if (isNativeFunction(require(7739) /* getGlobalSingleton */.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
...
arg5.supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in require(7739) /* getGlobalSingleton */.GLOBAL_OBJ;
};
