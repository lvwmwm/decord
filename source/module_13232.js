// Module ID: 13232
// Function ID: 13233
// Dependencies: [13195, 13224, 13215, 13220, 13216, 13219, 13226, 13223]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13195)(arg0, arg3);
  const tmp4 = new _require(13224)(arg1, arg3);
  if (">" === arg2) {
  ...
  if (_require(13226)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
    if (0 < tmp4.set.length) {
      while (true) {
        ...
        let item = arr.forEach((semver) => {
          let tmp = semver;
          if (semver.semver === require(13223) /* Comparator */.ANY) {
            tmp = new require(13223) /* Comparator */(">=0.0.0");
          }
          let tmp6 = _null;
          if (!_null) {
            tmp6 = tmp;
