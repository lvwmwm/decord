...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 7840, 7841, 7842, 7843, 7847, 7848, 7849, 7859]

// Module 7839 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(7841)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(7842)(tmp, tmp, this);
      ...
      if (transform) {
        ...
        tmp.transform = self(7843).extractTransformSvgView(tmp);
        const obj3 = self(7843);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(7848)({ viewBox, preserveAspectRatio }));
      obj.children = jsx(importDefault(7849), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(7847), {});
    }
  }
];
