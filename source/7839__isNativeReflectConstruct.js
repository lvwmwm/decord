...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7836, 7840, 7841, 7773, 7782]
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = importDefault(7836)[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = importDefault(7836)[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
