...
// Function ID: 5574
// Name: JSFPSMonitor
// Dependencies: [5520, 5521, 5508, 5574]

// Module 5573 (JSFPSMonitor)
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        const error = new Error(JSFPSMonitor(5508).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      obj[0] = JSFPSMonitor(5574).roundToDecimalPlaces(self.minFPS, 1);
      const obj2 = JSFPSMonitor(5574);
      obj[1] = JSFPSMonitor(5574).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(5574);
      obj[2] = JSFPSMonitor(5574).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    }
  }
];
