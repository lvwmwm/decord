...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7783, 7853, 7862, 7788, 7799]

// Module 7861 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      const tmp3Result = self(7783)(patternTransform);
      ...
      if (patternContentUnits) {
        num2 = tmp(7853)[patternContentUnits];
      }
      obj[8] = num2;
      obj = {
        ref(arg0) {
      ...
      const tmp3 = self(7783);
      const merged = Object.assign(obj);
      const merged1 = Object.assign(tmp(7788)({ viewBox, preserveAspectRatio }));
      obj.children = children;
      return jsx(self(7862), {
        ref(arg0) {
          return self.refMethod(arg0);
        }
      });
