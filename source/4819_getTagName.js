...
// Function ID: 41734
// Name: getTagName
// Dependencies: [57, 4780, 4797, 4820]

// Module 4819 (getTagName)
          ...
          if (importDefault(4820)[shortAt]) {
            ...
            while (true) {
              ...
              if (tagName) {
                ...
                let tmp32 = shortAt;
                name = importDefault(4820)[shortAt].name;
                break;
              }
              let tmp33 = name;
              let tmp34 = obj;
