...
// Function ID: 44480
// Name: StyleSheet
// Dependencies: [29, 31, 27, 33, 1560, 5136, 5133, 5138, 5139]
// Exports: default

// Module 5135 (StyleSheet)
...
export default function Header(children) {
  ...
  const context = React.useContext(importDefault(5136));
  if (undefined === layout) {
  ...
  if (headerBackground) {
    ...
    if (!headerTransparent) {
      ...
      headerBackgroundResult = callback2(importDefault(5139), obj5);
    }
  }
