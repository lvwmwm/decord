  ...
  findJpegOffsets(byteLength) {
    ...
    if (c5 + c6 + 5 <= byteLength.byteLength) {
      while (true) {
        ...
        let tmp28 = tmp8;
        let sum5 = tmp9;
        if (module(4915).USE_FILE) {
          let tmp30 = c19;
          if (byteLength.getUint16(sum) === c19) {
            break;
          }
        }
        if (tmp19(4915).USE_FILE) {
          let tmp31 = c20;
        ...
        if (tmp19(4915).USE_JFIF) {
          ...
          if (tmp34) {
            let tmp35 = require;
            let obj = require(4912) /* getDataView */;
            let tmp36 = c6;
        ...
        if (tmp19(4915).USE_EXIF) {
          ...
          if (tmp40) {
            let tmp41 = require;
            let obj1 = require(4912) /* getDataView */;
            let tmp42 = c6;
        ...
        if (tmp19(4915).USE_XMP) {
          ...
          if (tmp50) {
            let tmp51 = length4;
            let tmp52 = require;
            let obj4 = require(4912) /* getDataView */;
            let tmp53 = c6;
        ...
        if (tmp19(4915).USE_IPTC) {
          ...
          if (tmp56) {
            let tmp57 = require;
            let obj5 = require(4912) /* getDataView */;
            let tmp58 = c6;
        ...
        if (tmp19(4915).USE_ICC) {
          let tmp60 = length;
          let tmp61 = c27;
          let tmp62 = byteLength.getUint16(sum) === c27;
          if (tmp62) {
            let tmp63 = require;
            let obj6 = require(4912) /* getDataView */;
            let tmp64 = c6;
        ...
        if (!tmp19(4915).USE_MPF) {
          ...
          if (tmp67) {
            let tmp68 = require;
            let obj7 = require(4912) /* getDataView */;
            let tmp69 = c6;
