...
// Dependencies: [5, 17, 4039, 16554, 16555, 16556]
// Exports: getAppleDeclaredAgeRangeStatus, getIsConsideredOlderThan, setAgeRangeThresholds

// Module 16553 (_getAppleDeclaredAgeRangeStatus)
import importDefaultResult from "module_16556";
...
export const setAgeRangeThresholds = (arg0) => {
  const ageRangeThresholdManager = callback(16554).ageRangeThresholdManager;
...
export const PlayAgeRangeDeclarationUserStatus = require("module_16556").PlayAgeRangeDeclarationUserStatus;
export const PlayAgeRangeDeclarationUserStatusString = require("module_16556").PlayAgeRangeDeclarationUserStatusString;
