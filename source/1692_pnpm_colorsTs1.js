...
const tmp2 = () => {
  ...
  PlatformColor.__closure = { IS_IOS: arg1(arg6[0]).IS_IOS };
...
let closure_8 = () => {
  function isDynamicColorObjectIOS(dynamic) {
    let tmp = callback(dynamic);
    if (tmp) {
      tmp = callback(dynamic.dynamic);
    }
    if (tmp) {
...
const obj = { invalidColor: pnpm_colorsTs6, invalidProcessedColor: pnpm_colorsTs7, dynamicNotAvailableOnPlatform: pnpm_colorsTs8 };
/* worklet (recovered source) */ function pnpm_colorsTs6(color){return"Invalid color value: "+JSON.stringify(color);}
...
/* worklet (recovered source) */ function pnpm_colorsTs7(color){return"Invalid processed color value: "+JSON.stringify(color);}
...
/* worklet (recovered source) */ function pnpm_colorsTs8(){return'DynamicColorIOS is not available on this platform.';}
...
const tmp4 = () => {
  function processColorNumber(arg0) {
    const result = callback(closure_1[1]).processColorInitially(arg0);
    let IS_ANDROID = callback(closure_1[0]).IS_ANDROID;
    if (IS_ANDROID) {
  ...
  processColorNumber.__closure = { processColorInitially: arg1(arg6[1]).processColorInitially, IS_ANDROID: arg1(arg6[0]).IS_ANDROID };
...
let closure_14 = ["Array", "widgetType", "Array", "textColumn"];
...
let closure_16 = () => {
  function processDynamicColorObjectIOS(arg0) {
    const dynamic = {};
    const iter = closure_14[Symbol.iterator]();
    ...
    while (iter !== undefined) {
      ...
      if (undefined !== arg0.dynamic[nextResult]) {
        ...
        let tmp5 = arg0;
        let tmp6 = nextResult;
        let tmp7 = callback(arg0.dynamic[tmp2]);
        if (null === tmp7) {
          iter.return();
          return null;
        } else {
  ...
  processDynamicColorObjectIOS.__closure = { DynamicColorIOSProperties: closure_14, processColorNumber: tmp4 };
...
let closure_18 = () => {
  function unprocessDynamicColorObjectIOS(arg0) {
    const dynamic = {};
    for (const item10007 of closure_14) {
      let tmp = item10007;
      let tmp2 = arg0;
      if (undefined !== arg0.dynamic[item10007]) {
        ...
        let tmp5 = closure_13;
        let tmp6 = arg0;
        dynamic[tmp] = closure_13(arg0.dynamic[tmp]);
      }
    }
    return { dynamic };
  }
...
const tmp5 = () => {
  function processColor(arg0, target) {
    ...
    if (tmp) {
      ...
      let tmp26 = target !== callback(closure_1[2]).ValueProcessorTarget.CSS;
      if (!tmp26) {
      ...
      let tmp3 = tmp;
      if (callback3(arg0)) {
        if (callback(closure_1[0]).IS_IOS) {
          tmp3 = callback5(arg0);
        } else {
          const ReanimatedError = callback(closure_1[3]).ReanimatedError;
          const prototype = ReanimatedError.prototype;
          const reanimatedError = new ReanimatedError(closure_9.dynamicNotAvailableOnPlatform());
          throw reanimatedError;
        }
      }
      if (null === tmp3) {
        const ReanimatedError2 = callback(closure_1[3]).ReanimatedError;
        const prototype2 = ReanimatedError2.prototype;
        const reanimatedError2 = new ReanimatedError2(closure_9.invalidColor(arg0));
  ...
  const obj = { processColorNumber: tmp4, ValueProcessorTarget: arg1(arg6[2]).ValueProcessorTarget, isPlatformColorObject: closure_5, isDynamicColorObjectIOS: closure_8, IS_IOS: arg1(arg6[0]).IS_IOS, ERROR_MESSAGES: obj, processDynamicColorObjectIOS: closure_16 };
...
const tmp6 = () => {
  function unprocessColor(color) {
    if ("number" === typeof color) {
      return callback4(color);
    } else if (callback2(color)) {
      return color;
    } else if (callback3(color)) {
      if (tmp2(tmp3[0]).IS_IOS) {
        return callback5(color);
      } else {
        const ReanimatedError2 = callback(closure_1[3]).ReanimatedError;
        const prototype2 = ReanimatedError2.prototype;
        const reanimatedError2 = new ReanimatedError2(closure_9.dynamicNotAvailableOnPlatform());
        throw reanimatedError2;
      }
    } else {
      const ReanimatedError = tmp2(tmp3[3]).ReanimatedError;
      const prototype = ReanimatedError.prototype;
      const reanimatedError = new ReanimatedError(closure_9.invalidProcessedColor(color));
      throw reanimatedError;
    }
  }
  const obj = { unprocessColorNumber: closure_13, isPlatformColorObject: closure_5, isDynamicColorObjectIOS: closure_8, IS_IOS: arg1(arg6[0]).IS_IOS, ERROR_MESSAGES: obj, unprocessDynamicColorObjectIOS: closure_18 };
...
arg5.processColorsInProps = () => {
  function processColorsInProps(obj) {
    for (const key10007 in arg0) {
      ...
      let tmp5 = closure_0;
      let tmp6 = closure_1;
      let ColorProperties = closure_0(closure_1[1]).ColorProperties;
  ...
  processColorsInProps.__closure = { ColorProperties: arg1(arg6[1]).ColorProperties, processColor: tmp5 };
...
arg5.unprocessColorsInProps = () => {
  ...
  unprocessColorsInProps.__closure = { ColorProperties: arg1(arg6[1]).ColorProperties, unprocessColor: tmp6 };
