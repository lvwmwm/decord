...
// Dependencies: [32, 1645, 1646, 1638, 1647, 1648]
// Exports: _updatePropsJS

// Module 1644 (_makeShareableClone)
import _slicedToArray from "_slicedToArray";

const require = arg1;
global._makeShareableClone = () => {
  const reanimatedError = new require(1645) /* t */.ReanimatedError("`_makeShareableClone` should never be called from React runtime.");
  throw reanimatedError;
};
global._scheduleHostFunctionOnJS = () => {
  const reanimatedError = new require(1645) /* t */.ReanimatedError("`_scheduleOnJS` should never be called from React runtime.");
  throw reanimatedError;
};
global._scheduleOnRuntime = () => {
  const reanimatedError = new require(1645) /* t */.ReanimatedError("`_scheduleOnRuntime` should never be called from React runtime.");
  throw reanimatedError;
};
...
export const createJSReanimatedModule = require("module_1648").createJSReanimatedModule;
