...
// Function ID: 13312
// Name: formatToParts
// Dependencies: [1281, 13289, 13312, 13307, 13313, 13309]
// Exports: default
...
const regExp = new RegExp("^".concat(require("module_13312").S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(require("module_13312").S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13307).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13313).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13309).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
