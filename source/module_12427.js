// Module ID: 12427
// Function ID: 12428
// Dependencies: [5, 12361, 12424, 12428, 12429, 12430, 12423]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12361).util;
    ...
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12423).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12423).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12423).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
