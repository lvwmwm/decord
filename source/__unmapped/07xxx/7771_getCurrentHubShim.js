...
// Dependencies: [7690, 7711, 7736]

// Module 7771 (getCurrentHubShim)
...
function getCurrentHubShim() {
  return {
    bindClient(arg0) {
      const currentScope = callback(7690).getCurrentScope();
      currentScope.setClient(arg0);
    },
    withScope: getClient.withScope,
    getClient() {
      return callback(7690).getClient();
    },
    ...
    getIntegration(id) {
      const client = callback(7690).getClient();
