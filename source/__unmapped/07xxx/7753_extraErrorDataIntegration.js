...
// Dependencies: [7719, 7670, 7708, 7669, 7672, 7691, 7663]

// Module 7753 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(7691).DEBUG_BUILD) {
                const logger = callback(7663).logger;
