...
// Dependencies: [7662, 7663, 7707, 7710, 7699, 7668]
// Exports: createEventEnvelope, createSessionEnvelope, createSpanEnvelope

// Module 7706 (createEventEnvelope)
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(7710).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(7710);
  }
