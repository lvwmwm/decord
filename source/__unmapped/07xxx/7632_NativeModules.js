...
// Function ID: 7633
// Name: NativeModules
// Dependencies: [5, 17, 7633, 7634, 7639, 7640, 7641, 7642, 7643]
...
// Module 7632 (NativeModules)
import _mod7634 from "module_7634" /* 7634 */;
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 7640 */;
import NativeModulesAll from "NativeModules" /* 7641 */;
import fetchJsonOrThrowAll from "fetchJsonOrThrow" /* 7642 */;
import syncAll from "sync" /* 7643 */;
...
const subs = require("module_7633").ProductType.subs;
const inapp = require("module_7633").ProductType.inapp;
...
export const isIosStorekit2 = require("module_7634").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod7634.storekit1Mode();
    const obj4 = _mod7634;
  } else if ("STOREKIT2_MODE" === str) {
    _mod7634.storekit2Mode();
    const obj3 = _mod7634;
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod7634.storekitHybridMode();
    const obj2 = _mod7634;
  }
};
export const initConnection = () => {
  const nativeModule = _mod7634.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod7634.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      closure_1 = tmp5;
      closure_0 = tmp2;
      const obj3 = closure_1_0(7634);
      const androidModule = obj3.getAndroidModule();
      yield androidModule.getItemsByType(closure_1_7, closure_1_0);
      closure_0 = arg1.map(closure_1_0(7639).singleProductAndroidMap);
      const obj = closure_1_0(7634);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      ...
      androidModuleType = closure_1_0(7634).getAndroidModuleType();
      const obj10 = closure_1_0(7634);
      const androidModule = closure_1_0(7634).getAndroidModule();
      closure_1 = yield androidModule.getItemsByType(closure_1_6, closure_1_0);
      if ("android" === closure_1_0) {
        return closure_1_8(closure_1, closure_1_0(7633).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp35) {
        const _Error = Error;
      ...
      const obj2 = closure_1_0(7634);
      dependencyMap = yield obj2.fillProductsWithAdditionalData(dependencyMap);
      return closure_1_8(dependencyMap, closure_1_0(7633).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
