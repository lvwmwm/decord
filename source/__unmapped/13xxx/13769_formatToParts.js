...
// Function ID: 13770
// Name: formatToParts
// Dependencies: [1281, 13747, 13770, 13765, 13771, 13767]
// Exports: default

// Module 13769 (formatToParts)
...
const regExp = new RegExp("^".concat(_mod13770.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod13770.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13765).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13771).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13767).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
