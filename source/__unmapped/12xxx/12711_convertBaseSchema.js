...
// Dependencies: [32, 12706, 12707, 12705, 12699]

// Module 12711 (convertBaseSchema)
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const fnResult = fn(_mod12706);
    let obj = {};
    let merged = Object.assign(fn(_mod12705));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(_mod12707);
    let _Set = Set;
