...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5970, 5972, 5449, 5974, 5976, 5977, 5986, 5987]
// Exports: getAnimationEnabled

// Module 5969 (_isNativeReflectConstruct)
...
function getDistanceFromOptions(width, gestureDirection) {
  ...
  if (gestureDirection) {
    return CardStack(5974).getDistanceForDirection(width, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(5970).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(5970).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
    ...
    return tmp3(5974).getDistanceForDirection(width, gestureDirection, arg2);
  }
}
...
obj = {
  ...
  value: function render() {
    ...
    items2[1] = renderHeader(CardStack(5976).MaybeScreenContainer, obj2);
    obj[1] = items2;
