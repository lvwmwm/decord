...
// Function ID: 5981
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 5974, 5975, 1522, 5981, 5960, 5458, 5982, 5983, 5984, 5985]
// Exports: Card

// Module 5980 (StyleSheet)
import closure_3 from "_slicedToArray" /* 32 */;
import closure_4 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import jsxProd from "jsxProd" /* 21 */;
import getShadowStyle from "getShadowStyle" /* 5985 */;
...
export const Card = function Card(shadowEnabled) {
  ...
  if (typeof backgroundColor === "string") {
    tmp16 = 0 === tmp5(5458)(backgroundColor).alpha();
    const obj12 = tmp5(5458)(backgroundColor);
  }
  ...
  let merged = Object.assign(flag2(5983).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }));
  ...
  const items13 = [tmp27, gesture(flag2(5984).CardContent, { enabled: pageOverflowEnabled, layout, style: contentStyle, children })];
  obj5[3] = items13;
  obj4.children = layout(closing.View, obj5);
  obj3[2] = gesture(flag2(5960).PanGestureHandler, obj4);
  items5[2] = gesture(closing.View, obj3);
  obj[1] = items5;
  return layout(flag2(5982).CardAnimationContext.Provider, obj);
};
