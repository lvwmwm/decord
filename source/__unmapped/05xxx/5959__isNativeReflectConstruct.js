...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5960, 5963, 1501, 5449, 1632, 5967, 5969]

// Module 5959 (_isNativeReflectConstruct)
...
import { GestureHandlerRootView } from "PanGestureHandler" /* 5960 */;
...
class StackView {
  constructor() {
    ...
    obj = { routes: [], previousState: "y", openingRouteKeys: "md", closingRouteKeys: null, replacingRouteKeys: null, descriptors: 80.672 };
    obj[2] = [];
    obj[3] = [];
    obj[4] = [];
    obj[5] = {};
