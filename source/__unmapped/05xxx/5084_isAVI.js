...
arg5.isMP4 = function isMP4(fileChunk, excludeSimilarTypes) {
  ...
  if (!checkByFileTypeResult) {
    ...
    if (!excludeSimilarTypes) {
      ...
      tmp8 = FileTypes2.checkByFileType(fileChunk1, "m4v") && tmp(5076).isftypStringIncluded(fileChunk1);
      const tmp10 = FileTypes2.checkByFileType(fileChunk1, "m4v") && tmp(5076).isftypStringIncluded(fileChunk1);
    }
