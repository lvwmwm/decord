...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5627, 5605, 5621, 5628, 5630, 5603, 5632, 5631, 5633, 5634, 5604, 5618]
// Exports: default

// Module 5626 (_isNativeReflectConstruct)
...
import get_ActivityIndicatorDefault from "get ActivityIndicator" /* 5634 */;
...
let closure_10 = { [arg1(5605).State.UNDETERMINED]: undefined, [arg1(5605).State.BEGAN]: "onBegan", [arg1(5605).State.FAILED]: "onFailed", [arg1(5605).State.CANCELLED]: "onCancelled", [arg1(5605).State.ACTIVE]: "onActivated", [arg1(5605).State.END]: "onEnded" };
