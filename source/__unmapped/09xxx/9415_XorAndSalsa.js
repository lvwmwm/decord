...
// Function ID: 9416
// Name: XorAndSalsa
// Dependencies: [5, 9416, 9417, 9419, 9421]
// Exports: scrypt, scryptAsync

// Module 9415 (XorAndSalsa)
import _asyncLoop from "_asyncLoop" /* 9416 */;
import pbkdf2Init from "pbkdf2Init" /* 9419 */;
import _isNativeReflectConstruct from "_isNativeReflectConstruct" /* 9421 */;
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9416).isLE) {
                callback(9416).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
