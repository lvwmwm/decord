...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 14104, 14107, 4820]
// Exports: default

// Module 14103 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4820).ScreenContext.Provider, { value: closure_8, children: children.children });
};
