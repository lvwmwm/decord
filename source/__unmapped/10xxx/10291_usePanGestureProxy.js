...
// Dependencies: [19, 5599, 10292]
// Exports: usePanGestureProxy

// Module 10291 (usePanGestureProxy)
...
export const usePanGestureProxy = (onConfigurePanGesture) => {
  ...
  const tmp = onGestureUpdate(() => {
    ...
    let obj = { onBegin: "call", onStart: "join", onUpdate: "getCurrentUser", onEnd: "find", onFinalize: "IconComponent" };
