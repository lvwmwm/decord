...
// Function ID: 4227
// Name: useRiveFile
// Dependencies: [5, 32, 19, 17, 4209, 4206]
// Exports: useRiveFile

// Module 4226 (useRiveFile)
...
export const useRiveFile = function useRiveFile(src, arg1) {
  ...
  let uri;
  let riveFile;
  [tmp2, c1] = callback(str2({ riveFile: "HermesInternal", isLoading: null, error: "button" }), 2);
            ...
            if (null == obj5) {
              ...
              if (!obj5.startsWith("http://")) {
                if (!obj5.startsWith("https://")) {
                  const RiveFileFactory3 = obj(4209).RiveFileFactory;
                  c4 = 2;
                  c5 = 1;
              ...
              const RiveFileFactory4 = obj(4209).RiveFileFactory;
              c4 = 3;
              c5 = 1;
              ...
              if (typeof obj5 !== "number") {
                if (!("uri" in obj5)) {
                  ...
                  if (obj5 instanceof ArrayBuffer) {
                    const RiveFileFactory = obj(4209).RiveFileFactory;
                    c4 = 5;
                    c5 = 1;
              ...
              const RiveFileFactory2 = obj(4209).RiveFileFactory;
              c4 = 4;
              c5 = 1;
