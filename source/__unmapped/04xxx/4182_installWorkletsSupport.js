...
// Dependencies: [4183, 4187]

// Module 4182 (installWorkletsSupport)
import _mod4183 from "module_4183" /* 4183 */;
import getInstalledNitro from "getInstalledNitro" /* 4187 */;
...
arg5.installWorkletsSupport = function installWorkletsSupport() {
  try {
    ...
    obj[3] = fn3;
    const result = _mod4183.registerCustomSerializable(obj);
  } catch (err) {
  }
};
