...
// Function ID: 4730
// Name: ToPrimitive
// Dependencies: [1421, 4730, 4731, 4732]

// Module 4729 (ToPrimitive)
import apply from "apply" /* 1421 */;
import isPrimitive from "isPrimitive" /* 4730 */;
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4732)(arg0) || tmp(4731)(arg0);
          const tmp15 = tmp(4732)(arg0) || tmp(4731)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
