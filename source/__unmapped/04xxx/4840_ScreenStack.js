...
// Function ID: 4841
// Name: ScreenStack
// Dependencies: [109, 19, 21, 4825, 4841, 4842, 4829]
// Exports: default

// Module 4840 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(ref1(4841).GHContext);
  obj = {
  ...
  ref2(4825)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4825)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4829).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = children;
  obj1[6] = jsx(ref2(4842), {});
  ...
  return jsx(tmp4(4841).RNSScreensRefContext.Provider, { value: ref, children: null });
};
