...
// Dependencies: [4714, 541, 4761, 4765, 542, 4778, 562, 4770, 4766, 4779, 4780]

// Module 4777 (OrdinaryDefineOwnProperty)
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (isObject(arg0)) {
    if (tmp(4761)(arg1)) {
      if (tmp(4765)(__Writable__)) {
        if (tmp(542)) {
          const tmp30 = tmp(542)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4766)(tmp30);
          }
          return tmp(4780)(arg0, arg1, tmp(4779)(arg0), __Writable__, tmp31);
        } else if (tmp(4778)(__Writable__)) {
          ...
          return tmp(4770)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
