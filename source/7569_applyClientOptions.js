...
// Dependencies: [7531, 7534, 7547, 7570, 7571, 7557, 7529, 7572, 7565, 7541]

// Module 7569 (applyClientOptions)
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = require(7529) /* isMatchingPattern */.truncate(environment.message, num);
    const obj = require(7529) /* isMatchingPattern */;
  }
  let value = iter;
  ...
  if (value) {
    iter.value = require(7529) /* isMatchingPattern */.truncate(iter.value, num);
  ...
  if (url) {
    request.url = require(7529) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(7529) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(7572).getFilenameToDebugIdMap(arg1);
  try {
