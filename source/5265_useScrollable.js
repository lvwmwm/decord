...
// Function ID: 5266
// Name: useScrollable
// Dependencies: [19, 1606, 5250, 5266]
// Exports: useScrollable

// Module 5265 (useScrollable)
...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(require(5250) /* GESTURE_SOURCE */.SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = require(1606) /* cancelAnimation */.useSharedValue(0);
  const obj2 = require(1606) /* cancelAnimation */;
  const sharedValue2 = require(1606) /* cancelAnimation */.useSharedValue(require(5250) /* GESTURE_SOURCE */.SCROLLABLE_STATE.UNDETERMINED);
