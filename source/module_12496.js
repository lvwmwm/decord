// Module ID: 12496
// Function ID: 12497
// Dependencies: [5, 12430, 12493, 12497, 12498, 12499, 12492]

// Module 12496
import asyncGeneratorStep from "module_12499";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12430).util;
    ...
    let closure_8 = fn(require("module_12497"));
    let closure_9 = fn(require("module_12498"));
    let closure_10 = fn(require("module_12499"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12492).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12492).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12492).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
