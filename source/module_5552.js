// Module ID: 5552
// Function ID: 47146
// Dependencies: [31, 33, 1560, 5553, 1457, 5554, 5528, 5555]
...
export default importAllResult.memo(function Header(navigation) {
  ...
  const callback = importAllResult.useCallback(navigation(5553)(() => {
  ...
  const context = importAllResult.useContext(navigation(5554));
  ...
  obj = {};
  const tmp5 = jsx;
  const tmp6 = navigation(5555);
  obj.title = route(5528).getHeaderTitle(options, route.name);
