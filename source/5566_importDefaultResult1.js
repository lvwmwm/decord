...
// Dependencies: [32, 109, 19, 17, 21, 5479, 5480, 5499, 5539, 5535]
// Exports: FlatList

// Module 5566 (importDefaultResult1)
...
export const FlatList = (ref) => {
  ...
  for (const item10028 of entries) {
    ...
    let NativeWrapperProps = require(5535) /* isGestureEnabled */.NativeWrapperProps;
    let tmp12 = first1;
    let tmp13 = tmp9;
