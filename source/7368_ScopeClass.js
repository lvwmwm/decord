...
// Function ID: 7369
// Name: ScopeClass
// Dependencies: [32, 41, 42, 7357, 7369, 7370, 7354, 7361, 7372, 7358, 7347]

// Module 7368 (ScopeClass)
...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      let obj1 = ScopeClass(7357);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(7357);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(7370).updateSession(self._session, obj);
        const obj2 = ScopeClass(7370);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(7369)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(7369);
      obj[0] = ScopeClass(7357).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(7361).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      obj[12] = ScopeClass(7369)._getSpanForScope(self);
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(7372).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      ...
      obj[0] = ScopeClass(7357).generateSpanId();
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(7347).logger;
