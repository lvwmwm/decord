...
// Dependencies: [5, 17, 4016, 16431, 16432, 16433]
// Exports: getAppleDeclaredAgeRangeStatus, getIsConsideredOlderThan, setAgeRangeThresholds

// Module 16430 (_getAppleDeclaredAgeRangeStatus)
import importDefaultResult from "module_16433";
...
export const setAgeRangeThresholds = (arg0) => {
  const ageRangeThresholdManager = callback(16431).ageRangeThresholdManager;
...
export const PlayAgeRangeDeclarationUserStatus = require("module_16433").PlayAgeRangeDeclarationUserStatus;
export const PlayAgeRangeDeclarationUserStatusString = require("module_16433").PlayAgeRangeDeclarationUserStatusString;
