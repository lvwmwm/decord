...
// Function ID: 102907
// Name: result1
// Dependencies: [27, 13405]
// Exports: default

// Module 13404 (result1)
...
export default function getReactNativeDimensions() {
  ...
  const reactNativeDimensionsWithDimensions = require(13405) /* getReactNativeDimensionsWithDimensions */.getReactNativeDimensionsWithDimensions(value, value);
};
