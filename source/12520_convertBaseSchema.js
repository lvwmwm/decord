...
// Dependencies: [32, 12515, 12516, 12514, 12508]

// Module 12520 (convertBaseSchema)
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema(flag, defaultTarget) {
      if (typeof flag === "boolean") {
        ...
        if (registry == null) {
          registry = require(12508) /* $output */.globalRegistry;
        }
        obj[5] = registry;
        return convertSchema(flag, obj);
      }
    };
    const fnResult = fn(require("module_12515"));
    let obj = {};
    let merged = Object.assign(fn(require("module_12514")));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(require("module_12516"));
    let _Set = Set;
