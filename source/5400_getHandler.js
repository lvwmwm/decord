...
// Function ID: 5401
// Name: getHandler
// Dependencies: [5392, 5361, 5357, 5360, 5358, 5359]

// Module 5400 (getHandler)
const require = arg1;
const dependencyMap = arg6;
function getHandler(arg0, onBegin) {
  if (require(5392) /* _isNativeReflectConstruct */.CALLBACK_TYPE.BEGAN === arg0) {
...
function touchEventTypeToCallbackType(arg0) {
  if (require(5361).TouchEventType.TOUCHES_DOWN === arg0) {
...
function runWorklet(arg0, arg1, arg2) {
  ...
  if (arg1.isWorklet[arg0]) {
    ...
    console.warn(require(5357) /* toArray */.tagMessage("Animated gesture callback must be a worklet"));
