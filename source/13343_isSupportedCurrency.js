...
// Dependencies: [13260, 13344]

// Module 13343 (isSupportedCurrency)
const require = arg1;
...
function isSupportedCurrency(arr3, locale) {
  ...
  try {
    ...
    obj[2] = arr3;
    const memoizedNumberFormat = require(13260) /* _formatToParts */.createMemoizedNumberFormat(str, obj);
...
arg5.getSupportedCurrencies = function getSupportedCurrencies(locale) {
  const items = [];
  const currencies = require(13344).currencies;
