  ...
  if (cResult[1] === arg0) {
    ...
    if (cResult[4] === arg0) {
      ...
      if (cResult[7] === arg0) {
        ...
        disposableMemo = tmp(3958).useDisposableMemo(tmp11, _temp, tmp12);
        if (cResult[10] === arg0) {
