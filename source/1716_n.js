...
let fn = function n(toValue, userConfig, callback) {
  ...
  const fn = function u() {
    let obj = { damping: 10, mass: 1, stiffness: 100, overshootClamping: false, restDisplacementThreshold: 0.01, restSpeedThreshold: 2, velocity: 0, duration: 2000, dampingRatio: 0.5, reduceMotion: "children", clamp: "formatToPlainString" };
  ...
  obj = { userConfig, checkIfConfigIsValid: _require(1717).checkIfConfigIsValid, underDampedSpringCalculations: _require(1717).underDampedSpringCalculations, criticallyDampedSpringCalculations: _require(1717).criticallyDampedSpringCalculations, isAnimationTerminatingCalculation: _require(1717).isAnimationTerminatingCalculation, calculateNewMassToMatchDuration: _require(1717).calculateNewMassToMatchDuration, initialCalculations: _require(1717).initialCalculations, scaleZetaToMatchClamps: _require(1717).scaleZetaToMatchClamps, toValue, callback, getReduceMotionForAnimation: _require(1674).getReduceMotionForAnimation };
  fn.__closure = obj;
