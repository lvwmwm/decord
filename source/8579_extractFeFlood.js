...
export default function extractFeFlood(arg0) {
  ...
  if (null == floodColor) {
    ...
    tmp = importDefault(8559)(floodColor);
  }
  obj = { floodColor: tmp };
  if (null != floodOpacity) {
    obj.floodOpacity = importDefault(8547)(floodOpacity);
  }
  return obj;
};
...
export const extractFeGaussianBlur = (stdDeviation) => {
  ...
  if (Array.isArray(stdDeviation.stdDeviation)) {
    ...
    if (typeof stdDeviation.stdDeviation !== "__FORMATJS_LISTFORMAT_DATA__") {
    ...
    if (typeof stdDeviation !== "Object") {
      ...
      if (typeof stdDeviation2 !== "__FORMATJS_LISTFORMAT_DATA__") {
