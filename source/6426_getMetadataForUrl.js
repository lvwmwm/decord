...
// Module 6426 (getMetadataForUrl)
const require = arg1;
const dependencyMap = arg6;
function getMetadataForUrl(arg0, arg1) {
  if (require(6348) /* getGlobalSingleton */.GLOBAL_OBJ._sentryModuleMetadata) {
    const _Object = Object;
    const keys = Object.keys(require(6348) /* getGlobalSingleton */.GLOBAL_OBJ._sentryModuleMetadata);
    for (const item10024 of keys) {
      let tmp17 = item10024;
      let tmp18 = require;
      let tmp19 = dependencyMap;
      let tmp20 = require(6348) /* getGlobalSingleton */.GLOBAL_OBJ._sentryModuleMetadata[item10024];
      let tmp21 = set;
