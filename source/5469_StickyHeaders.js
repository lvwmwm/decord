...
// Function ID: 5470
// Name: StickyHeaders
// Dependencies: [5416, 19, 21, 5466, 5470, 5431]
// Exports: StickyHeaders

// Module 5469 (StickyHeaders)
...
export const StickyHeaders = (stickyHeaderIndices) => {
  ...
  tmp3Result = tmp3(() => {
    ...
    if (-1 !== currentStickyIndex) {
      tmpResult = null;
      if (tmp4 < data.length) {
        const obj1 = { index: null, item: null, renderItem: null, layout: null, refHolder: null, extraData: null, trailingItem: "accessibilityRole", target: 553649221, hidden: -1900523263, inverted: 115 };
        obj1[0] = tmp4;
        obj1[1] = tmp6[tmp4];
        obj1[2] = renderItem;
