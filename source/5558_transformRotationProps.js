...
// Module 5558 (transformRotationProps)
const require = arg1;
const dependencyMap = arg6;
function transformRotationProps(arg0) {
  arg0.changeEventCalculator = require(5535) /* isGestureEnabled */.getChangeEventCalculator(diffCalculator);
...
arg5.useRotationGesture = function useRotationGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(5535) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformRotationProps);
  const obj = require(5535) /* isGestureEnabled */;
  return require(5550) /* useGesture */.useGesture(require(5526) /* ComposedGestureName */.SingleGestureName.Rotation, clonedAndRemappedConfig);
};
