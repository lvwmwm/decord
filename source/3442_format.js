...
// Function ID: 26723
// Name: format
// Dependencies: [3392, 3443, 3210, 3444, 3455, 3373, 3214, 3211, 3456, 3215, 3457]
// Exports: default
              ...
              if (isValid.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!useAdditionalWeekYearTokens) {
                      useAdditionalWeekYearTokens = !defaultResult1(3457).isProtectedWeekYearToken(str);
                    }
                    if (!useAdditionalWeekYearTokens) {
                      const _String = String;
                      defaultResult1(3457).throwProtectedError(str, dependencyMap, String(defaultResult1));
                    }
                    ...
                    if (!useAdditionalDayOfYearTokens) {
                      useAdditionalDayOfYearTokens = !defaultResult1(3457).isProtectedDayOfYearToken(str);
                    }
                    if (!useAdditionalDayOfYearTokens) {
