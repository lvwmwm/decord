...
// Dependencies: [5539, 5496, 19, 17, 5540, 5541, 5511, 5542, 5536]
// Exports: useRecyclerViewController

// Module 5538 (useRecyclerViewController)
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  const unmountFlag = _require(5540).useUnmountFlag();
  let obj = _require(5540);
  ...
  _setTimeout = _require(5541).useUnmountAwareTimeout().setTimeout;
