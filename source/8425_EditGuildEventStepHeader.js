...
// Module 8425 (EditGuildEventStepHeader)
importAll(dependencyMap[0]);
const View = arg1(dependencyMap[1]).View;
({ jsx: closure_3, jsxs: closure_4 } = arg1(dependencyMap[2]));
const tmp3 = arg1(dependencyMap[2]);
let closure_5 = arg1(dependencyMap[3]).createStyles({ header: { Set: 24, _desired: "recent_games_enabled" }, headerTitle: {}, headerSubtitle: { textAlign: "center" } });
