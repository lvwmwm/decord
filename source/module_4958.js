...
arg5.default = {
  read(byteLength) {
    ...
    for (let num = 0; num < arg1.length; num = num + 1) {
      ...
      let tmp3 = require;
      let longAt = obj1.getLongAt(byteLength, arg1[num] + require(4917).PNG_CHUNK_LENGTH_OFFSET);
      let obj2 = require(4910) /* getDataView */;
      let sum = arg1[num] + require(4917).PNG_CHUNK_TYPE_OFFSET;
      let stringFromDataView = obj2.getStringFromDataView(byteLength, sum, require(4917).PNG_CHUNK_TYPE_SIZE);
      let tmp7 = num;
      if (stringFromDataView === require(4917).TYPE_PHYS) {
        let tmp22 = arg1[num];
