...
// Dependencies: [1281, 13581, 13594, 13582]
// Exports: ToRawFixed
...
export const ToRawFixed = function ToRawFixed(ZERO, minimumFractionDigits, maximumFractionDigits, roundingIncrement, result) {
  ...
  result = require(13594) /* __exportStarResult11 */.ApplyUnsignedRoundingMode(ZERO, timesResult2, timesResult4, result);
  ...
  if (0 !== maximumFractionDigits) {
    ...
    if (str2.length <= maximumFractionDigits) {
      sum = require(13582) /* getMultiInternalSlots */.repeat("0", maximumFractionDigits - length2 + 1) + str2;
