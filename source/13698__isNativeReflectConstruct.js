...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 13699, 13702, 4606]
// Exports: default

// Module 13698 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4606).ScreenContext.Provider, { value: closure_8, children: children.children });
};
