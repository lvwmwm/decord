...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 7766, 7774, 7780, 7773, 7861, 7857, 7782]

// Module 7860 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(7774).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
      ...
      if (tmp5) {
        ...
        obj[6] = midLine;
        const merged = Object.assign(withoutXYResult, importDefault(7780)(obj, true), obj);
        withoutXYResult.ref = self.refMethod;
        obj1 = {};
        const merged1 = Object.assign(withoutXYResult);
        return jsx(importDefault(7861), {});
      } else {
        ...
        obj[1] = children;
        return jsx(importDefault(7857), { ref: null, children: null });
      }
