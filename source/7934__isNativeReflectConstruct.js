...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7843, 7850, 7851, 7857, 7935, 7859]
...
let items = [
  {
    ...
    value: function render() {
      ...
      obj.x = null;
      obj.y = null;
      const tmp2Result = importDefault(7850)(obj, this);
      const merged1 = Object.assign(tmp2Result, importDefault(7857)(propsAndStylesResult, false));
      tmp2Result.ref = this.refMethod;
      obj = {};
      const tmp2 = importDefault(7850);
      const merged2 = Object.assign(tmp2Result);
      return jsx(importDefault(7935), {});
    }
  }
];
