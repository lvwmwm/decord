...
// Dependencies: [41, 42, 1795, 1678]

// Module 1794 (FrameCallbackRegistryJS)
...
const items = [
  ...
  },
  {
    ...
    value: function unregisterFrameCallback(callbackId) {
      ...
      require(1678) /* isReanimated3 */.runOnUI(fn)();
    }
  },
  {
