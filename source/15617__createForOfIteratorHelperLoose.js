...
obj = { "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, backgroundColor: importDefault(dependencyMap[6]).colors.MOBILE_ACTIONSHEET_BACKGROUND, paddingHorizontal: SOUND_ROW_HORIZONTAL_PADDING };
obj.sectionHeader = obj;
obj.sectionIcon = { right: null, accessible: null, useEffect: null, y: null };
...
const memoResult = importAllResult.memo(function SoundboardSoundPickerListComponent(channel) {
  ...
  obj = {
    ...
    renderSection(arg0) {
      ...
      obj = { 0: "key", -9223372036854775808: "Text", 0: "d", children: isSectionLocked(items1[arg0]) };
