...
// Dependencies: [109, 41, 42, 12630, 12631]

// Module 12632 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(12630).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(12630).extractDefs(self.ctx, _idmap);
      return callback(JSONSchemaGenerator(12630).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
