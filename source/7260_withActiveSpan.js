...
// Function ID: 58498
// Name: withActiveSpan
// Dependencies: [65, 7225, 7226, 7270, 7273, 7262, 7231, 65, 57, 7227, 7271, 7232, 7273, 57, 7272, 7232, 7233, 7229, 57, 7226, 7225]
// Exports: continueTrace, startInactiveSpan, startNewTrace, startSpan, startSpanManual, suppressTracing

// Module 7260 (withActiveSpan)
import _toConsumableArray from "_toConsumableArray";
import module_7225 from "module_7225";
...
function _startRootSpan(name, arg1, parentSampled) {
  ...
  const tmp4 = _toConsumableArray(sampleSpanResult, 2);
  const sentrySpan = new require(dependencyMap[19]).SentrySpan(Object.assign({}, name, { attributes: Object.assign(module_7225({}, require(dependencyMap[20]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, "custom"), name.attributes), sampled: tmp4[0] }));
  if (undefined !== tmp4[1]) {
