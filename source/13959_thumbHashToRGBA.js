...
function rgbaToDataURL(w, h, rgba) {
  ...
  let arr1 = items;
  const items1 = ["Clyde", "Phibi", "Cap", "These examples explore the edge cases of the underlying ", "<Pile>", " component and aren't recommended uses.", "depthX=", "rgba(39, 30, 173, 0.3)", -306674912, -267414716, -690576408, -882789492, -1687895376, -2032938284, -1609899400, -1111625188];
  const diff = sum - 1;
  let num = 1;
  let num2 = 0;
  let num3 = 0;
  ...
  const items2 = [["isArray", "accessibilityRole"], ];
  const items3 = [0., 41 + sum1];
  items2[1] = items3;
