...
// Dependencies: [41, 42, 93, 95, 98, 19, 5372, 5375]

// Module 5418 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      try {
        ...
        const _Error = Error;
        const error = new Error(Wrap(5372).tagMessage("GestureDetector got more than one view as a child. If you want the gesture to work on multiple views, wrap them with a common parent and attach the gesture to that view."));
        throw error;
      }
    }
  }
