...
// Dependencies: [13203, 13204, 13206]

// Module 13202 (__exportStarResult32)
const require = arg1;
...
arg5.TimeClip = function TimeClip(isFinite) {
  if (isFinite.isFinite()) {
    if (absResult.greaterThan(8640000000000001)) {
      const Decimal2 = require(13203) /* digitsToString */.Decimal;
      const _NaN2 = NaN;
      ...
      ZERO = require(13206) /* TEN */.ZERO;
    }
    absResult = isFinite.abs();
  } else {
    const Decimal = require(13203) /* digitsToString */.Decimal;
    const _NaN = NaN;
