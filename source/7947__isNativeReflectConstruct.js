...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 7889, 7948, 7891, 7900]
...
const items = [
  {
    ...
    value: function render() {
      ...
      [tmp2, tmp3] = parts;
      obj[5] = self(7889).meetOrSliceTypes[tmp3] || 0;
      const tmp6 = self(7889).meetOrSliceTypes[tmp3] || 0;
      obj[6] = self(7889).alignEnum[tmp2] || "xMidYMid";
      ...
      const tmp7 = self(7889).alignEnum[tmp2] || "xMidYMid";
      const tmp11 = importDefault(7948);
      const merged = Object.assign(self(7891).withoutXY(this, props));
