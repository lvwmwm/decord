...
// Dependencies: [19, 17, 21, 7858, 7859]
// Exports: defaultRenderError, defaultRenderLoading, useWebWiewLogic

// Module 7857 (originWhitelistToRegex)
...
function originWhitelistToRegex(arg0) {
  return "^".concat(importDefault(7858)(arg0).replace(/\\\*/g, ".*"));
}
...
export const defaultRenderLoading = () => callback(closure_7, { style: importDefault(7859).loadingOrErrorView, children: callback(closure_8, {}) });
export const defaultRenderError = (arg0, arg1, arg2) => {
  let obj = { style: importDefault(7859).loadingOrErrorView, children: null };
  obj = { style: importDefault(7859).errorTextTitle, children: "Error loading page" };
  const items = [callback(closure_9, obj), , , ];
  obj = { style: importDefault(7859).errorText, children: "Domain: ".concat(arg0) };
  items[1] = callback(closure_9, obj);
  items[2] = callback(closure_9, { style: importDefault(7859).errorText, children: "Error Code: ".concat(arg1) });
  const obj1 = { style: importDefault(7859).errorText, children: "Error Code: ".concat(arg1) };
  items[3] = callback(closure_9, { style: importDefault(7859).errorText, children: "Description: ".concat(arg2) });
  obj[1] = items;
