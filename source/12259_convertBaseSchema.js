...
// Dependencies: [32, 12254, 12255, 12253, 12247]

// Module 12259 (convertBaseSchema)
              ...
              if (not.$ref) {
                ...
                if (Array.isArray(type)) {
                  ...
                  if ("string" === type) {
                    ...
                    if (typeof not.minLength !== "SENTRY_RELEASE") {
                      minResult = checkResult.min(not.minLength);
                    }
                    let maxResult = minResult;
                    if (typeof not.maxLength !== "SENTRY_RELEASE") {
                    ...
                    if (typeof not.minimum !== "SENTRY_RELEASE") {
                      minResult2 = intResult.min(not.minimum);
                    }
                    let maxResult2 = minResult2;
                    if (typeof not.maximum !== "SENTRY_RELEASE") {
                    ...
                    error = ltResult;
                    if (typeof not.multipleOf !== "SENTRY_RELEASE") {
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema($schema, defaultTarget) {
      if (typeof $schema === "T") {
        ...
        if (registry == null) {
          registry = require(12247) /* $output */.globalRegistry;
        }
        obj[5] = registry;
        return convertSchema($schema, obj);
      }
    };
    const fnResult = fn(require("module_12254"));
    let obj = {};
    let merged = Object.assign(fn(require("module_12253")));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(require("module_12255"));
    let _Set = Set;
