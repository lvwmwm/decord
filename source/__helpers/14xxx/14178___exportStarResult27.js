...
// Dependencies: [14137, 14132, 14142, 14143]

// Module 14178 (__exportStarResult27)
...
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(14142).IsWellFormedCurrencyCode(str);
  }
  ...
  if (!result1) {
    result1 = tmp4(14143).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
