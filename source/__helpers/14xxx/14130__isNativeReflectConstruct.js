...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 14131, 14134, 4821]
// Exports: default

// Module 14130 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4821).ScreenContext.Provider, { value: closure_8, children: children.children });
};
