...
// Dependencies: [14105, 14100, 14110, 14111]

// Module 14146 (__exportStarResult27)
...
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(14110).IsWellFormedCurrencyCode(str);
  }
  ...
  if (!result1) {
    result1 = tmp4(14111).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
