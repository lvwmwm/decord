...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 14488, 14491, 4877]
// Exports: default

// Module 14487 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4877).ScreenContext.Provider, { value: closure_8, children: children.children });
};
