...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 14150, 14153, 4834]
// Exports: default

// Module 14149 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4834).ScreenContext.Provider, { value: closure_8, children: children.children });
};
