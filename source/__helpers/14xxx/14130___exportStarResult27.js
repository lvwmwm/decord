...
// Dependencies: [14089, 14084, 14094, 14095]

// Module 14130 (__exportStarResult27)
...
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(14094).IsWellFormedCurrencyCode(str);
  }
  ...
  if (!result1) {
    result1 = tmp4(14095).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
