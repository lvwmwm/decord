...
// Dependencies: [41, 42, 93, 95, 98, 10508, 10446, 10447, 10453]

// Module 10510 (_isNativeReflectConstruct)
...
import WEEKDAY_DICTIONARY from "WEEKDAY_DICTIONARY" /* 10508 */;
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      const tmp4 = FRMonthNameLittleEndianParser(10508).MONTH_DICTIONARY[index[3].toLowerCase(index[3])];
      const result = FRMonthNameLittleEndianParser(10508).parseOrdinalNumberPattern(index[1]);
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10508).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = tmp2(10508).parseOrdinalNumberPattern(index[2]);
