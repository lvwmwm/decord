...
// Dependencies: [41, 42, 93, 95, 98, 10505, 10364, 10368]
...
const items = [
  {
    ...
    value: function innerPattern() {
      const regExp = new RegExp("(?:en|por|durante|de|dentro de)\\s*(" + ESTimeUnitWithinFormatParser(10505).TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
      return regExp;
    }
  },
  {
    ...
    value: function innerExtract(reference) {
      const ParsingComponents = ESTimeUnitWithinFormatParser(10364).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, ESTimeUnitWithinFormatParser(10505).parseDuration(arg1[1]));
    }
  }
];
