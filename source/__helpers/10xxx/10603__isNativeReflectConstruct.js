...
// Dependencies: [41, 42, 93, 95, 98, 10604, 10453, 10457]
...
import REGEX_PARTS from "REGEX_PARTS" /* 10604 */;
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return ParsingComponents.createRelativeFromReference(reference.reference, UKTimeUnitWithinFormatParser(10604).parseDuration(arg1[1]));
    }
  }
];
