...
// Dependencies: [41, 42, 93, 95, 98, 10446, 10600, 10447, 10602]
...
const items = [
  {
    ...
    value: function innerPatternString(arg0) {
      return "((?:\u0432|\u0443)\\s*)?(" + UkMonthNameParser(10446).matchAnyPattern(UkMonthNameParser(10600).MONTH_DICTIONARY) + ")\\s*(?:[,-]?\\s*(" + UkMonthNameParser(10600).YEAR_PATTERN + ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)";
    }
  },
  {
    key: "innerExtract",
