...
// Dependencies: [41, 42, 93, 95, 98, 10407, 10364, 10368]

// Module 10415 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function innerPattern() {
      const regExp = new RegExp("(?:in|f\u00FCr|w\u00E4hrend)\\s*(" + DETimeUnitWithinFormatParser(10407).TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
      return regExp;
    }
  },
  {
    ...
    value: function innerExtract(reference) {
      const ParsingComponents = DETimeUnitWithinFormatParser(10364).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, DETimeUnitWithinFormatParser(10407).parseDuration(arg1[1]));
    }
  }
];
