...
// Dependencies: [41, 42, 93, 95, 98, 10450, 10638, 10477, 10457]
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return SVWeekdayParser(10477).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10638).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
