...
// Dependencies: [41, 42, 93, 95, 98, 10575, 10448, 10449, 10577]
...
const items = [
  {
    ...
    value: function innerPatternString(arg0) {
      return "(" + RUTimeUnitAgoFormatParser(10575).TIME_UNITS_PATTERN + ")\\s{0,5}\u043D\u0430\u0437\u0430\u0434(?=(?:\\W|$))";
    }
  },
  {
    key: "innerExtract",
    value: function innerExtract(reference) {
      ...
      return ParsingComponents.createRelativeFromReference(reference.reference, RUTimeUnitAgoFormatParser(10448).reverseDuration(RUTimeUnitAgoFormatParser(10575).parseDuration(arg1[1])));
    }
  }
];
