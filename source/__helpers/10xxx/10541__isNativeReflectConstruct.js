...
// Dependencies: [41, 42, 93, 95, 98, 10446, 10540, 10473, 10453]
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return NLWeekdayParser(10473).createParsingComponentsAtWeekday(reference.reference, NLWeekdayParser(10540).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
