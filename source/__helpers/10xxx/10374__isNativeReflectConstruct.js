...
// Dependencies: [41, 42, 93, 95, 96, 98, 10366, 10375]

// Module 10374 (_isNativeReflectConstruct)
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10366).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10366).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
