...
// Dependencies: [41, 42, 93, 95, 98, 10575, 10449, 10453]
...
import REGEX_PARTS from "REGEX_PARTS" /* 10575 */;
...
const items = [
  {
    ...
    value: function patternLeftBoundary() {
      return RUTimeUnitWithinFormatParser(10575).REGEX_PARTS.leftBoundary;
    }
  },
  {
    key: "innerPattern",
    value: function innerPattern(option) {
      ...
      if (option.option.forwardDate) {
        _RegExp = new _RegExp(tmp, RUTimeUnitWithinFormatParser(10575).REGEX_PARTS.flags);
      } else {
        const _HermesInternal = HermesInternal;
        const combined = "(?:\u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0435|\u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0438)\\s*" + tmp;
        _RegExp = new _RegExp(combined, RUTimeUnitWithinFormatParser(10575).REGEX_PARTS.flags);
      }
      return _RegExp;
    }
  },
  {
    ...
    value: function innerExtract(reference) {
      const ParsingComponents = RUTimeUnitWithinFormatParser(10449).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, RUTimeUnitWithinFormatParser(10575).parseDuration(arg1[1]));
    }
  }
];
