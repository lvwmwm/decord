...
// Dependencies: [41, 42, 93, 95, 98, 10619, 10453, 10457]
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return ParsingComponents.createRelativeFromReference(reference.reference, ENTimeUnitWithinFormatParser(10619).parseDuration(arg1[1]));
    }
  }
];
