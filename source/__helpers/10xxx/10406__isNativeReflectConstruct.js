...
// Dependencies: [41, 42, 93, 95, 98, 10361, 10407, 10388, 10368]
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return DEWeekdayParser(10388).createParsingComponentsAtWeekday(reference.reference, DEWeekdayParser(10407).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
