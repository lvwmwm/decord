...
// Dependencies: [41, 42, 93, 95, 98, 10450, 10619, 10477, 10457]
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return ITWeekdayParser(10477).createParsingComponentsAtWeekday(reference.reference, ITWeekdayParser(10619).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
