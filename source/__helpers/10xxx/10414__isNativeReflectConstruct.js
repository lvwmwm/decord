...
// Dependencies: [41, 42, 93, 95, 98, 10407, 10361, 10363, 10364, 10368]

// Module 10414 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function innerPattern() {
      const regExp = new RegExp("(?:\\s*((?:n\u00E4chste|kommende|folgende|letzte|vergangene|vorige|vor(?:her|an)gegangene)(?:s|n|m|r)?|vor|in)\\s*)?(" + DETimeUnitAgoFormatParser(10407).NUMBER_PATTERN + ")?(?:\\s*(n\u00E4chste|kommende|folgende|letzte|vergangene|vorige|vor(?:her|an)gegangene)(?:s|n|m|r)?)?\\s*(" + DETimeUnitAgoFormatParser(10361).matchAnyPattern(DETimeUnitAgoFormatParser(10407).TIME_UNIT_DICTIONARY) + ")", "i");
      return regExp;
    }
  },
  {
    ...
    value: function innerExtract(reference) {
      let num = 1;
      if (arg1[2]) {
        num = DETimeUnitAgoFormatParser(10407).parseNumberPattern(arg1[2]);
      }
      const obj = {};
      obj[DETimeUnitAgoFormatParser(10407).TIME_UNIT_DICTIONARY[arg1[4].toLowerCase(arg1[4])]] = num;
