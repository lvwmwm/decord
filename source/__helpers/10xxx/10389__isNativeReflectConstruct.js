...
// Dependencies: [41, 42, 93, 95, 98, 10361, 10360, 10364, 10368]

// Module 10389 (_isNativeReflectConstruct)
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(createParsingComponents) {
      ...
      const tmp3 = ENRelativeDateFormatParser(10360).TIME_UNIT_DICTIONARY[str3];
      if ("next" != formatted) {
