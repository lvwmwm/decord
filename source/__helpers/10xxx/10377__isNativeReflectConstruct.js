...
// Dependencies: [41, 42, 93, 95, 98, 10360, 10364, 10368]

// Module 10377 (_isNativeReflectConstruct)
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      const parseDurationResult = ENTimeUnitLaterFormatParser(10360).parseDuration(arg1[1]);
      let relativeFromReference = null;
      if (parseDurationResult) {
        const ParsingComponents = ENTimeUnitLaterFormatParser(10364).ParsingComponents;
