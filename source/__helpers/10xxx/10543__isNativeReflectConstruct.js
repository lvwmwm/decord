...
// Dependencies: [41, 42, 93, 95, 98, 10361, 10530, 10388, 10368]
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return ITWeekdayParser(10388).createParsingComponentsAtWeekday(reference.reference, ITWeekdayParser(10530).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
