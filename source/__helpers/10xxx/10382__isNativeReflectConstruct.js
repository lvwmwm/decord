...
// Dependencies: [41, 42, 93, 95, 98, 10383, 10380]

// Module 10382 (_isNativeReflectConstruct)
...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, start, text) {
      start = start.start;
      const mergeDateTimeResult = AbstractMergeDateTimeRefiner(10383).mergeDateTimeResult;
