...
// Dependencies: [41, 42, 93, 95, 98, 10423, 10364, 10368]

// Module 10427 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function innerPattern() {
      const regExp = new RegExp("(?:dans|en|pour|pendant|de)\\s*(" + FRTimeUnitWithinFormatParser(10423).TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
      return regExp;
    }
  },
  {
    ...
    value: function innerExtract(reference) {
      const ParsingComponents = FRTimeUnitWithinFormatParser(10364).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, FRTimeUnitWithinFormatParser(10423).parseDuration(arg1[1]));
    }
  }
];
