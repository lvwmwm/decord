...
// Dependencies: [41, 42, 93, 95, 98, 10361, 10455, 10364, 10368]
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(createParsingComponents) {
      ...
      const tmp4 = NLRelativeDateFormatParser(10455).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp2(10364).ParsingComponents;
