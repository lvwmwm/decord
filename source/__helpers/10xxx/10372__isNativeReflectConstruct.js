...
// Dependencies: [41, 42, 93, 95, 98, 10361, 10360, 10368]

// Module 10372 (_isNativeReflectConstruct)
  ...
  },
  {
    ...
    value: function innerExtract(arg0, arg1) {
      ...
      if (arg1[3]) {
        ...
        parsed2 = ENYearMonthDayParser(10360).MONTH_DICTIONARY[str.toLowerCase(str)];
      }
      if (parsed2 < 1) {
        const self = this;
