...
// Dependencies: [41, 42, 93, 95, 98, 10469, 10363, 10368]
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (isNaN(num)) {
        num = ZHHansDeadlineFormatParser(10469).zhStringToNumber(index[1]);
      }
      if (isNaN(num)) {
        num = 3;
        if ("\u51E0" !== index[1]) {
      ...
      if (index[2][0].match(/[日天星礼月年]/)) {
        if ("\u65E5" != str3) {
          ...
          const addDurationResult = ZHHansDeadlineFormatParser(10363).addDuration(createParsingResult.refDate, obj);
        ...
        const addDurationResult1 = ZHHansDeadlineFormatParser(10363).addDuration(createParsingResult.refDate, obj);
