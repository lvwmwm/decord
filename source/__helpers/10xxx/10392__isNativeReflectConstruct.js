...
// Module 10392 (_isNativeReflectConstruct)
...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, start, text) {
      const parseDurationResult = ENMergeRelativeAfterDateRefiner(10360).parseDuration(text.text);
      ...
      return new ENMergeRelativeAfterDateRefiner(10364).ParsingResult(reference, index, "" + start.text + arg0 + text.text, relativeFromReference);
    }
  }
];
