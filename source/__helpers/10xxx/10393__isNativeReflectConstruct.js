...
// Dependencies: [41, 42, 93, 95, 98, 10360, 10363, 10364, 10380]

// Module 10393 (_isNativeReflectConstruct)
...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, text, start) {
      const parseDurationResult = ENMergeRelativeFollowByDateRefiner(10360).parseDuration(text.text);
      ...
      return new ENMergeRelativeFollowByDateRefiner(10364).ParsingResult(start.reference, text.index, "" + text.text + arg0 + start.text, relativeFromReference);
    }
  }
];
