...
// Dependencies: [41, 42, 93, 95, 98, 10361, 10549, 10388, 10368]
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return SVWeekdayParser(10388).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10549).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
