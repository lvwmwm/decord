...
// Dependencies: [41, 42, 93, 95, 98, 10361, 10505, 10388, 10368]
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      const tmp4 = ESWeekdayParser(10505).WEEKDAY_DICTIONARY[formatted];
      if (undefined === tmp4) {
        return null;
      } else {
        ...
        return tmp2(10388).createParsingComponentsAtWeekday(reference.reference, tmp4, str5);
      }
      const str = arg1[2];
