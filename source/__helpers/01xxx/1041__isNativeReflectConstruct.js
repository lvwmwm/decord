...
// Dependencies: [41, 42, 93, 95, 96, 98, 17, 1042, 862, 977, 682, 889, 866, 1043, 1044, 993, 679, 994]

// Module 1041 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function eventFromException(arg0) {
      ...
      return ReactNativeClient(889).eventFromException(this._options.stackParser, arg0, obj, this._options.attachStacktrace);
    }
  },
  {
    key: "eventFromMessage",
    value: function eventFromMessage(arg0, arg1, arg2) {
      return ReactNativeClient(889).eventFromMessage(this._options.stackParser, arg0, arg1, arg2, this._options.attachStacktrace);
    }
  },
  {
    key: "nativeCrash",
  ...
  },
  {
    ...
    value: function captureUserFeedback(arg0) {
      let obj = ReactNativeClient(1043);
  ...
  },
  {
    ...
    value: function _initNativeSdk() {
      ...
      obj[0] = self(993).getDefaultSidecarUrl();
      const obj2 = self(993);
  ...
  },
  {
    ...
    value: function _attachClientReportTo(_outcomesBuffer, arg1) {
      if (_outcomesBuffer.length > 0) {
        ...
        obj[0] = ReactNativeClient(682).dateTimestampInSeconds();
