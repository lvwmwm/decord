...
// Dependencies: [32, 41, 42, 93, 95, 98, 19, 1021, 1136, 814, 1137]
// Exports: useProfiler, withProfiler

// Module 1135 (_isNativeReflectConstruct)
...
class Profiler {
  constructor(arg0) {
    ...
    obj = { name: "<" + name + ">", onlyIfParent: true, op: require("module_1136").REACT_MOUNT_OP, attributes: { [closure_1_0(closure_1_1[9]).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN]: "auto.ui.react.profiler", "ui.component_name": name } };
...
let items = [
  ...
  },
  {
    ...
    value: function componentWillUnmount() {
      const self = this;
      Profiler = Profiler(814).timestampInSeconds();
...
export const withProfiler = function withProfiler(displayName, name) {
  ...
  Profiler(1137).hoistNonReactStatics(Wrapped, displayName);
  return Wrapped;
};
