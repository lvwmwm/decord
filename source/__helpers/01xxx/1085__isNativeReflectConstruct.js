...
// Dependencies: [5, 93, 95, 98, 158, 32, 41, 42, 814, 1030]

// Module 1085 (_isNativeReflectConstruct)
...
function addNetworkBreadcrumb(isEnabled, name) {
  ...
  if (isEnabledResult) {
    ...
    if (isSentryRequestUrlResult) {
      obj = _require(814);
      isSentryRequestUrlResult = obj.isSentryRequestUrl(name.name, _require(814).getClient());
      obj2 = _require(814);
    }
    if (!isSentryRequestUrlResult) {
      isEnabled.addUpdate(() => {
...
function mergeWarning(_meta) {
  ...
  if (_meta) {
    ...
    obj = { headers: null, size: "Array", _meta: 102039555 };
    obj[0] = obj;
    obj = { warnings: null };
    const items1 = [arg1];
    obj[0] = items1;
...
function urlMatches(str) {
  ...
  if (!str.startsWith("http://")) {
    ...
    if (!str.startsWith("https://")) {
      substr = str;
      if (!str.startsWith(tmp(814).GLOBAL_OBJ.location.origin)) {
        const _URL = URL;
                    ...
                    if (tmp) {
                      ...
                      if (tmp21) {
                        ...
                        if (tmp23) {
                          ...
                          obj9 = { headers: null, size: "Array", _meta: 102039555 };
                          obj9[0] = obj8;
                        ...
                        if (!tmp14) {
                          ...
                          if (!tmp17) {
                            ...
                            if (tmp22) {
                              ...
                              obj7 = { headers: null, size: "Array", _meta: 102039555 };
                              obj7[0] = obj6;
                          ...
                          if (tmp18) {
                            ...
                            obj10 = { headers: null, size: "Array", _meta: 102039555 };
                            obj10[0] = obj9;
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              tmp = callback;
              tmp = dependencyMap;
              const obj18 = callback(814);
              const currentScope = callback(814).getCurrentScope();
              transport = undefined;
              if (client != null) {
