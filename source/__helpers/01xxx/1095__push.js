...
export const makeBrowserOfflineTransport = function makeBrowserOfflineTransport() {
  ...
  if (arg0 === undefined) {
    makeFetchTransport = _require(1029).makeFetchTransport;
  }
  _require = _require(814).makeOfflineTransport(makeFetchTransport);
  return (arg0) => {
    let obj = {};
