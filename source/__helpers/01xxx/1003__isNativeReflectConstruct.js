...
// Module 1003 (_isNativeReflectConstruct)
...
class Profiler {
  constructor(arg0) {
    ...
    obj = { name: "<" + name + ">", onlyIfParent: true, op: require("module_1004").REACT_MOUNT_OP, attributes: { [closure_1_0(closure_1_1[9]).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN]: "auto.ui.react.profiler", "ui.component_name": name } };
