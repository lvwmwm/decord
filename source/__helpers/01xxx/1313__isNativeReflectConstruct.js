...
// Dependencies: [32, 93, 95, 98, 41, 42, 1312]

// Module 1313 (_isNativeReflectConstruct)
      ...
      if (obj) {
        ...
        if ("0" == trimmed) {
          ...
          if (re8.test(trimmed)) {
            ...
            tmp24 = callback(PbLong(1312).int64fromString(trimmed), 3);
          } else {
            const _Error3 = Error;
  ...
  },
  {
    ...
    value: function toString() {
      ...
      if (obj) {
        ...
        return "-" + PbLong(1312).int64toString(negateResult.lo, negateResult.hi);
      } else {
        obj = PbLong(1312);
    ...
    value: function from(trimmed) {
      ...
      if (obj) {
        ...
        if ("0" == trimmed) {
          ...
          trimmed = trimmed.trim();
          if (re8.test(trimmed)) {
            const obj3 = PbLong(1312);
            [tmp24, tmp26, tmp27] = callback(PbLong(1312).int64fromString(trimmed), 3);
