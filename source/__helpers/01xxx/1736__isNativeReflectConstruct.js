...
// Dependencies: [41, 42, 93, 95, 98, 1724, 1723]

// Module 1736 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    value: function springify(durationV) {
      return { durationV, type: ComplexAnimationBuilder(1724).withSpring };
    }
  },
  {
    key: "dampingRatio",
