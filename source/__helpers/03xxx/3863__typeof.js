...
obj = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    return _createSuperInternal(3849).parseNumericPattern(_createSuperInternal(3850).numericPatterns.dayOfYear, arg0);
  }
};
let items = [
  obj,
  {
    ...
    value: function validate(getUTCFullYear) {
      ...
      let tmp2 = arg1 >= 1;
      if (_createSuperInternal(3849).isLeapYearIndex(uTCFullYear)) {
        if (tmp2) {
          tmp2 = arg1 <= 366;
        }
        let tmp3 = tmp2;
