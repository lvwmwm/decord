...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8223, 8225, 8227, 8216, 8229, 8231, 8212]

// Module 8222 (_isNativeReflectConstruct)
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [callback3(FeDropShadow(8223), { in: str, stdDeviation: props.stdDeviation }), callback3(FeDropShadow(8225), { dx, dy, result: "offsetblur" }), , , ];
    obj = { floodColor: self.props.floodColor, floodOpacity: self.props.floodOpacity };
    items[2] = callback3(FeDropShadow(8227), obj);
    items[3] = callback3(FeDropShadow(8216), { in2: "offsetblur", operator: "in" });
    obj = { result, children: null };
    const items1 = [callback3(FeDropShadow(8231), {}), callback3(FeDropShadow(8231), { in: str })];
    obj[1] = items1;
    items[4] = callback4(FeDropShadow(8229), obj);
    obj[0] = items;
