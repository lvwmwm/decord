...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8391, 8461, 8470, 8396, 8407]
...
const items = [
  {
    ...
    value: function render() {
      ...
      const tmp3Result = self(8391)(patternTransform);
      ...
      if (patternContentUnits) {
        num2 = tmp(8461)[patternContentUnits];
      }
      obj[8] = num2;
      obj = {
        ref(arg0) {
      ...
      const tmp3 = self(8391);
      const merged = Object.assign(obj);
      const merged1 = Object.assign(tmp(8396)({ viewBox, preserveAspectRatio }));
      obj.children = children;
      return jsx(self(8470), {
        ref(arg0) {
          return self.refMethod(arg0);
        }
      });
