...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8214, 8215, 8216, 8217, 8221, 8222, 8223, 8233]

// Module 8213 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import extractOpacityDefault from "extractOpacity" /* 8215 */;
import keysDefault from "keys" /* 8216 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8221 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8223 */;
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8233 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (transform) {
        ...
        tmp.transform = self(8217).extractTransformSvgView(tmp);
        const obj3 = self(8217);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(8222)({ viewBox, preserveAspectRatio }));
