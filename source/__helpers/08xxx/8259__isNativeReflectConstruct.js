...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8181, 8251, 8260, 8186, 8197]

// Module 8259 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      const tmp3Result = self(8181)(patternTransform);
      ...
      if (patternContentUnits) {
        num2 = tmp(8251)[patternContentUnits];
      }
      obj[8] = num2;
      obj = {
        ref(arg0) {
      ...
      const tmp3 = self(8181);
      const merged = Object.assign(obj);
      const merged1 = Object.assign(tmp(8186)({ viewBox, preserveAspectRatio }));
      obj.children = children;
      return jsx(self(8260), {
        ref(arg0) {
          return self.refMethod(arg0);
        }
      });
