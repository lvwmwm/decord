...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8458, 8459, 8460, 8461, 8465, 8466, 8467, 8477]

// Module 8457 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import extractOpacityDefault from "extractOpacity" /* 8459 */;
import keysDefault from "keys" /* 8460 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8465 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8467 */;
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8477 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (transform) {
        ...
        tmp.transform = self(8461).extractTransformSvgView(tmp);
        const obj3 = self(8461);
      }
      obj = {};
