...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8332, 8336, 8337, 8269, 8278]

// Module 8335 (_isNativeReflectConstruct)
...
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8337 */;
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = _modDef8332[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = _modDef8332[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
