...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8391, 8399, 8405, 8398, 8486, 8482, 8407]
...
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8482 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8486 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(8399).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
