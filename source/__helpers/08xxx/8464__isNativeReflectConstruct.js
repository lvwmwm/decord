...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8461, 8465, 8466, 8398, 8407]

// Module 8464 (_isNativeReflectConstruct)
...
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8466 */;
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = _modDef8461[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = _modDef8461[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
