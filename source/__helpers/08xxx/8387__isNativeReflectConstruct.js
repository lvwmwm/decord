...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8388, 8389, 8390, 8391, 8395, 8396, 8397, 8407]

// Module 8387 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import extractOpacityDefault from "extractOpacity" /* 8389 */;
import keysDefault from "keys" /* 8390 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8395 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8397 */;
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8407 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (transform) {
        ...
        tmp.transform = self(8391).extractTransformSvgView(tmp);
        const obj3 = self(8391);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(8396)({ viewBox, preserveAspectRatio }));
