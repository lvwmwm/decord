...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8396, 8455, 8398, 8407]

// Module 8454 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8407 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8455 */;
...
const items = [
  {
    ...
    value: function render() {
      ...
      let obj = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: self(8396).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
      [tmp2, tmp3] = parts;
      const tmp6 = self(8396).meetOrSliceTypes[tmp3] || 0;
      obj[6] = self(8396).alignEnum[tmp2] || "xMidYMid";
      ...
      const tmp7 = self(8396).alignEnum[tmp2] || "xMidYMid";
