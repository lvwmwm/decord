...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8304, 8306, 8308, 8297, 8310, 8312, 8293]

// Module 8303 (_isNativeReflectConstruct)
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [callback3(FeDropShadow(8304), { in: str, stdDeviation: props.stdDeviation }), callback3(FeDropShadow(8306), { dx, dy, result: "offsetblur" }), , , ];
    obj = { floodColor: self.props.floodColor, floodOpacity: self.props.floodOpacity };
    items[2] = callback3(FeDropShadow(8308), obj);
    items[3] = callback3(FeDropShadow(8297), { in2: "offsetblur", operator: "in" });
    obj = { result, children: null };
    const items1 = [callback3(FeDropShadow(8312), {}), callback3(FeDropShadow(8312), { in: str })];
    obj[1] = items1;
    items[4] = callback4(FeDropShadow(8310), obj);
    obj[0] = items;
