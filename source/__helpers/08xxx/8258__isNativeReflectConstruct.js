...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8259, 8260, 8261, 8262, 8266, 8267, 8268, 8278]

// Module 8258 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import extractOpacityDefault from "extractOpacity" /* 8260 */;
import keysDefault from "keys" /* 8261 */;
...
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8278 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (transform) {
        ...
        tmp.transform = self(8262).extractTransformSvgView(tmp);
        const obj3 = self(8262);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(8267)({ viewBox, preserveAspectRatio }));
