...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8267, 8326, 8269, 8278]

// Module 8325 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8278 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8326 */;
...
const items = [
  {
    ...
    value: function render() {
      ...
      let obj = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: self(8267).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
      [tmp2, tmp3] = parts;
      const tmp6 = self(8267).meetOrSliceTypes[tmp3] || 0;
      obj[6] = self(8267).alignEnum[tmp2] || "xMidYMid";
      ...
      const tmp7 = self(8267).alignEnum[tmp2] || "xMidYMid";
