...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8195, 8203, 8209, 8202, 8290, 8286, 8211]
...
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8286 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8290 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(8203).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
