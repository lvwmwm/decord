...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8494, 8491, 8492]
...
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8494 */;
...
let obj = {
  ...
  value: function render() {
    ...
    const merged1 = Object.assign(self(8491).extractIn(this.props));
    const obj3 = self(8491);
    const merged2 = Object.assign(self(8491).extractFeColorMatrix(this.props));
