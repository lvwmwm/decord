...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8255, 8256, 8257, 8258, 8262, 8263, 8264, 8274]

// Module 8254 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import extractOpacityDefault from "extractOpacity" /* 8256 */;
import keysDefault from "keys" /* 8257 */;
...
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8274 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (transform) {
        ...
        tmp.transform = self(8258).extractTransformSvgView(tmp);
        const obj3 = self(8258);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(8263)({ viewBox, preserveAspectRatio }));
