...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8251, 8255, 8256, 8188, 8197]
...
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8256 */;
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = _modDef8251[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = _modDef8251[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
