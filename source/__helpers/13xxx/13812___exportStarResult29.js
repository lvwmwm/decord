...
// Dependencies: [1281, 13793, 13794, 13796, 13806]
// Exports: ToRawPrecision

// Module 13812 (__exportStarResult29)
...
export const ToRawPrecision = function ToRawPrecision(ZERO, minimumSignificantDigits, maximumSignificantDigits, result) {
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(13794).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(13794).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(13794).repeat("0", -num3 - 1)}${arr}`;
