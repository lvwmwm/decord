...
// Dependencies: [13799, 13794, 13804, 13805]

// Module 13840 (__exportStarResult27)
...
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(13804).IsWellFormedCurrencyCode(str);
  }
  ...
  if (!result1) {
    result1 = tmp4(13805).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
