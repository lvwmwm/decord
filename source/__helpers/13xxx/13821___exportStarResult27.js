...
// Dependencies: [13780, 13775, 13785, 13786]

// Module 13821 (__exportStarResult27)
...
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(13785).IsWellFormedCurrencyCode(str);
  }
  ...
  if (!result1) {
    result1 = tmp4(13786).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
