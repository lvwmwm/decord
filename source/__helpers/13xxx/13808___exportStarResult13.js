...
// Dependencies: [1281, 13793, 13809, 13810]
// Exports: ComputeExponent

// Module 13808 (__exportStarResult13)
import digitsToString from "digitsToString" /* 13793 */;
import __exportStarResult14 from "__exportStarResult14" /* 13809 */;
  ...
  if (timesResult.isZero()) {
    ...
    if (roundedNumber.isZero()) {
      ...
      if (floorResult1.eq(floorResult.minus(result))) {
        ...
        const items2 = [tmp2(13809).ComputeExponentForMagnitude(internalSlots, floorResult.plus(1)), floorResult.plus(1).toNumber()];
        return items2;
      }
