...
// Dependencies: [1281, 13860, 13861, 13863, 13873]
// Exports: ToRawPrecision

// Module 13879 (__exportStarResult29)
...
export const ToRawPrecision = function ToRawPrecision(ZERO, minimumSignificantDigits, maximumSignificantDigits, result) {
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(13861).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(13861).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(13861).repeat("0", -num3 - 1)}${arr}`;
