...
// Dependencies: [13866, 13861, 13871, 13872]

// Module 13907 (__exportStarResult27)
...
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(13871).IsWellFormedCurrencyCode(str);
  }
  ...
  if (!result1) {
    result1 = tmp4(13872).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
