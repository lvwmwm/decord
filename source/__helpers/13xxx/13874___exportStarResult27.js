...
// Dependencies: [13833, 13828, 13838, 13839]

// Module 13874 (__exportStarResult27)
...
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(13838).IsWellFormedCurrencyCode(str);
  }
  ...
  if (!result1) {
    result1 = tmp4(13839).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
