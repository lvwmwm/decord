...
// Dependencies: [853, 12245, 12248, 12249, 12263, 12273, 12277, 12281, 12331, 12254, 12283, 12264, 12282, 12320, 12266, 12262, 12256]
// Exports: addTracingHeadersToFetchRequest, instrumentFetchRequest

// Module 12354 (_addTracingHeadersToFetchRequest)
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData) {
  ...
  if (fetchData.fetchData) {
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12266).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12266);
            } else if (endResult.error) {
              obj = { code: null, message: "internal_error" };
              obj[0] = setHttpStatus(12266).SPAN_STATUS_ERROR;
              obj10.setStatus(obj);
            }
            endResult = obj10.end();
            delete tmp2[tmp];
    ...
    if (tmp7) {
      const host = setHttpStatus(12331).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(12331);
    }
    const activeSpan = setHttpStatus(12254).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj1[3] = tmp7;
        obj1[4] = host;
        obj1[setHttpStatus(12264).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj1[setHttpStatus(12264).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj[1] = obj1;
        let startInactiveSpanResult = setHttpStatus(12283).startInactiveSpan(obj);
        const setHttpStatusResult4 = setHttpStatus(12283);
      }
      ...
      if (arg2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12281);
        const tmp13 = _addTracingHeadersToFetchRequest;
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12282).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12254);
  }
};
