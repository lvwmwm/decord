...
// Dependencies: [12785, 12757, 12729, 12740, 12738]

// Module 12804 (_getEventFilterUrl)
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (__SENTRY_DEBUG__.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + tmp6(12740).getEventDescription(tmp));
      const tmp6Result = tmp6(12740);
    }
    return null;
  }
}
