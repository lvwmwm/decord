...
// Dependencies: [12324, 12296, 12268, 12279, 12277]

// Module 12343 (_getEventFilterUrl)
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (__SENTRY_DEBUG__.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + tmp6(12279).getEventDescription(tmp));
      const tmp6Result = tmp6(12279);
    }
    return null;
  }
}
