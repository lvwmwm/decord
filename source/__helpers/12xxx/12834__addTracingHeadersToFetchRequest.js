...
// Dependencies: [850, 12725, 12728, 12729, 12743, 12753, 12757, 12761, 12811, 12734, 12763, 12744, 12762, 12800, 12746, 12742, 12736]
// Exports: addTracingHeadersToFetchRequest, instrumentFetchRequest

// Module 12834 (_addTracingHeadersToFetchRequest)
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData) {
  ...
  if (fetchData.fetchData) {
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12746).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12746);
            } else if (endResult.error) {
              obj = { code: null, message: "internal_error" };
              obj[0] = setHttpStatus(12746).SPAN_STATUS_ERROR;
              obj10.setStatus(obj);
            }
            endResult = obj10.end();
            delete tmp2[tmp];
    ...
    if (tmp7) {
      const host = setHttpStatus(12811).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(12811);
    }
    const activeSpan = setHttpStatus(12734).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj1[3] = tmp7;
        obj1[4] = host;
        obj1[setHttpStatus(12744).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj1[setHttpStatus(12744).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj[1] = obj1;
        let startInactiveSpanResult = setHttpStatus(12763).startInactiveSpan(obj);
        const setHttpStatusResult4 = setHttpStatus(12763);
      }
      ...
      if (arg2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12761);
        const tmp13 = _addTracingHeadersToFetchRequest;
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12762).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12734);
  }
};
