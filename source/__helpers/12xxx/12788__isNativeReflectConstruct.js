...
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 12728, 12743, 12725, 12789, 12753, 12756, 12757, 12729, 12782, 12740, 12790, 12751, 12734, 12765, 12784]
...
let items = [
  {
    ...
    value: function eventFromException(arg0, arg1) {
      const result = ServerRuntimeClient(12789).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
      result.level = "error";
      const obj = ServerRuntimeClient(12789);
      return ServerRuntimeClient(12753).resolvedSyncPromise(result);
    }
  },
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(12753);
      return obj.resolvedSyncPromise(ServerRuntimeClient(12789).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12756).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12756);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        obj[0] = release;
        obj[1] = tmp;
        const sessionFlusher = new tmp2(12782).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12757).DEBUG_BUILD) {
        const logger = tmp2(12729).logger;
    ...
    value: function captureCheckIn(checkInId) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(12790);
          ...
          if (ServerRuntimeClient(12757).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12729).logger;
          ...
          if (ServerRuntimeClient(12757).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12729).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      obj = ServerRuntimeClient(12740);
      checkInId = obj.uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12751)._getSpanForScope(arg0);
        ...
        const tmpResult1 = ServerRuntimeClient(12765);
        if (_getSpanForScopeResult) {
