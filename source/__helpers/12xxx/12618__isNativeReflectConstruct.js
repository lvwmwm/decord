...
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 12558, 12573, 12555, 12619, 12583, 12586, 12587, 12559, 12612, 12570, 12620, 12581, 12564, 12595, 12614]
...
let items = [
  {
    ...
    value: function eventFromException(arg0, arg1) {
      const result = ServerRuntimeClient(12619).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
      result.level = "error";
      const obj = ServerRuntimeClient(12619);
      return ServerRuntimeClient(12583).resolvedSyncPromise(result);
    }
  },
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(12583);
      return obj.resolvedSyncPromise(ServerRuntimeClient(12619).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12586).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12586);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        obj[0] = release;
        obj[1] = tmp;
        const sessionFlusher = new tmp2(12612).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12587).DEBUG_BUILD) {
        const logger = tmp2(12559).logger;
    ...
    value: function captureCheckIn(checkInId) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(12620);
          ...
          if (ServerRuntimeClient(12587).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12559).logger;
          ...
          if (ServerRuntimeClient(12587).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12559).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      obj = ServerRuntimeClient(12570);
      checkInId = obj.uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12581)._getSpanForScope(arg0);
        ...
        const tmpResult1 = ServerRuntimeClient(12595);
        if (_getSpanForScopeResult) {
