...
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 12301, 12316, 12298, 12362, 12326, 12329, 12330, 12302, 12355, 12313, 12363, 12324, 12307, 12338, 12357]

// Module 12361 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function eventFromException(arg0, arg1) {
      const result = ServerRuntimeClient(12362).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
      result.level = "error";
      const obj = ServerRuntimeClient(12362);
      return ServerRuntimeClient(12326).resolvedSyncPromise(result);
    }
  },
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(12326);
      return obj.resolvedSyncPromise(ServerRuntimeClient(12362).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12329).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12329);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        obj[0] = release;
        obj[1] = tmp;
        const sessionFlusher = new tmp2(12355).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12330).DEBUG_BUILD) {
        const logger = tmp2(12302).logger;
    ...
    value: function captureCheckIn(checkInId) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(12363);
          ...
          if (ServerRuntimeClient(12330).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12302).logger;
          ...
          if (ServerRuntimeClient(12330).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12302).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      obj = ServerRuntimeClient(12313);
      checkInId = obj.uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12324)._getSpanForScope(arg0);
        ...
        const tmpResult1 = ServerRuntimeClient(12338);
        if (_getSpanForScopeResult) {
