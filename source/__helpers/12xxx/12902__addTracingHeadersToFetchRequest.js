...
// Dependencies: [718, 12793, 12796, 12797, 12811, 12821, 12825, 12829, 12879, 12802, 12831, 12812, 12830, 12868, 12814, 12810, 12804]
// Exports: addTracingHeadersToFetchRequest, instrumentFetchRequest

// Module 12902 (_addTracingHeadersToFetchRequest)
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              ...
              obj[0] = setHttpStatus(12814).SPAN_STATUS_ERROR;
              obj10.setStatus(obj);
            }
            endResult = obj10.end();
            delete tmp2[tmp];
