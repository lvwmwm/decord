...
// Dependencies: [12391, 12363, 12335, 12346, 12344]

// Module 12410 (_getEventFilterUrl)
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (__SENTRY_DEBUG__.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + tmp6(12346).getEventDescription(tmp));
      const tmp6Result = tmp6(12346);
    }
    return null;
  }
}
