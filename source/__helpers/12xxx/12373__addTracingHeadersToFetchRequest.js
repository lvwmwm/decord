...
// Dependencies: [853, 12264, 12267, 12268, 12282, 12292, 12296, 12300, 12350, 12273, 12302, 12283, 12301, 12339, 12285, 12281, 12275]
// Exports: addTracingHeadersToFetchRequest, instrumentFetchRequest

// Module 12373 (_addTracingHeadersToFetchRequest)
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData) {
  ...
  if (fetchData.fetchData) {
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12285).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12285);
            } else if (endResult.error) {
              obj = { code: null, message: "internal_error" };
              obj[0] = setHttpStatus(12285).SPAN_STATUS_ERROR;
              obj10.setStatus(obj);
            }
            endResult = obj10.end();
            delete tmp2[tmp];
    ...
    if (tmp7) {
      const host = setHttpStatus(12350).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(12350);
    }
    const activeSpan = setHttpStatus(12273).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj1[3] = tmp7;
        obj1[4] = host;
        obj1[setHttpStatus(12283).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj1[setHttpStatus(12283).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj[1] = obj1;
        let startInactiveSpanResult = setHttpStatus(12302).startInactiveSpan(obj);
        const setHttpStatusResult4 = setHttpStatus(12302);
      }
      ...
      if (arg2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12300);
        const tmp13 = _addTracingHeadersToFetchRequest;
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12301).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12273);
  }
};
