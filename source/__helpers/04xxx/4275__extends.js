...
// Function ID: 4276
// Name: _extends
// Dependencies: [19, 4276, 1229, 1230, 1223, 4279]

// Module 4275 (_extends)
...
export const MemoryRouter = Component2(4279).Redirect;
export const Prompt = Component2(4279).Redirect;
export const Redirect = Component2(4279).Redirect;
export const Route = Component2(4279).Route;
export const Router = Component2(4279).Router;
export const StaticRouter = Component2(4279).StaticRouter;
export const Switch = Component2(4279).Switch;
export const generatePath = Component2(4279).generatePath;
export const matchPath = Component2(4279).matchPath;
export const useHistory = Component2(4279).useHistory;
export const useLocation = Component2(4279).useLocation;
export const useParams = Component2(4279).useParams;
export const useRouteMatch = Component2(4279).useRouteMatch;
export const withRouter = Component2(4279).withRouter;
