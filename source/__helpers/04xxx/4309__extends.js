...
// Function ID: 4310
// Name: _extends
// Dependencies: [19, 4310, 1226, 1227, 1220, 4313]

// Module 4309 (_extends)
...
export const MemoryRouter = Component2(4313).Redirect;
export const Prompt = Component2(4313).Redirect;
export const Redirect = Component2(4313).Redirect;
export const Route = Component2(4313).Route;
export const Router = Component2(4313).Router;
export const StaticRouter = Component2(4313).StaticRouter;
export const Switch = Component2(4313).Switch;
export const generatePath = Component2(4313).generatePath;
export const matchPath = Component2(4313).matchPath;
export const useHistory = Component2(4313).useHistory;
export const useLocation = Component2(4313).useLocation;
export const useParams = Component2(4313).useParams;
export const useRouteMatch = Component2(4313).useRouteMatch;
export const withRouter = Component2(4313).withRouter;
