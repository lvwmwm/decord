...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 6945, 6948, 1499, 5586, 1630, 6952, 6954]

// Module 6944 (_isNativeReflectConstruct)
...
import { GestureHandlerRootView } from "PanGestureHandler" /* 6945 */;
...
class StackView {
  constructor() {
    ...
    obj = { routes: [], previousState: "y", openingRouteKeys: "video_upload_quality", closingRouteKeys: false, replacingRouteKeys: false, descriptors: false };
    obj[2] = [];
    obj[3] = [];
    obj[4] = [];
    obj[5] = {};
