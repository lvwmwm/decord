...
// Dependencies: [41, 42, 93, 95, 98, 19, 6600, 6638]
...
const items = [
  {
    ...
    value: function render() {
      try {
        ...
        const _Error = Error;
        error = new Error(Wrap(6600).tagMessage("GestureDetector got more than one view as a child. If you want the gesture to work on multiple views, wrap them with a common parent and attach the gesture to that view."));
        throw error;
      }
    }
  }
