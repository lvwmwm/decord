...
// Dependencies: [41, 42, 93, 95, 98, 19, 6634, 6600, 6622, 6620]
...
import importDefaultResult3 from "PlatformConstants" /* 6634 */;
...
let obj = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(6600).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  obj,
