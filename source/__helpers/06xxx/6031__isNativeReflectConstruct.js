...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 6032, 6034, 5511, 6036, 6038, 6039, 6048, 6049]
// Exports: getAnimationEnabled

// Module 6031 (_isNativeReflectConstruct)
...
function getDistanceFromOptions(width, gestureDirection) {
  ...
  if (gestureDirection) {
    return CardStack(6036).getDistanceForDirection(width, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(6032).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(6032).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
    ...
    return tmp3(6036).getDistanceForDirection(width, gestureDirection, arg2);
  }
}
...
obj = {
  ...
  value: function render() {
    ...
    items2[1] = renderHeader(CardStack(6038).MaybeScreenContainer, obj2);
    obj[1] = items2;
