...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5988, 5990, 5467, 5992, 5994, 5995, 6004, 6005]
// Exports: getAnimationEnabled

// Module 5987 (_isNativeReflectConstruct)
...
function getDistanceFromOptions(width, gestureDirection) {
  ...
  if (gestureDirection) {
    return CardStack(5992).getDistanceForDirection(width, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(5988).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(5988).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
    ...
    return tmp3(5992).getDistanceForDirection(width, gestureDirection, arg2);
  }
}
...
obj = {
  ...
  value: function render() {
    ...
    items2[1] = renderHeader(CardStack(5994).MaybeScreenContainer, obj2);
    obj[1] = items2;
