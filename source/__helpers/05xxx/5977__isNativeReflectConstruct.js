...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5978, 5981, 1501, 5467, 1632, 5985, 5987]

// Module 5977 (_isNativeReflectConstruct)
...
import { GestureHandlerRootView } from "PanGestureHandler" /* 5978 */;
...
class StackView {
  constructor() {
    ...
    obj = { routes: [], previousState: "y", openingRouteKeys: 3, closingRouteKeys: true, replacingRouteKeys: false, descriptors: "echoCancellation" };
    obj[2] = [];
    obj[3] = [];
    obj[4] = [];
    obj[5] = {};
