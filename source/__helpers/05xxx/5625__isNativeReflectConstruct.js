...
// Dependencies: [93, 95, 98, 42, 41, 5626, 5609]

// Module 5625 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5609).isRemoteDebuggingEnabled();
        obj = ContinousBaseGesture(5609);
      }
      return tmp;
    }
  }
