...
// Dependencies: [41, 42, 93, 95, 98, 19, 5643, 5609, 5631, 5629]

// Module 5642 (_isNativeReflectConstruct)
...
import importDefaultResult3 from "PlatformConstants" /* 5643 */;
...
let obj = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(5609).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  obj,
