...
// Dependencies: [13138, 13139, 13141]

// Module 13137 (__exportStarResult32)
const require = arg1;
...
class ToNumber {
  constructor(arg0) {
    ...
    if ("number" === typeof arg0) {
      ...
      tmp37 = closure_1;
      num4 = 0;
      Decimal4 = require("digitsToString").Decimal;
      tmp38 = arg0;
      ...
      invariantResult = require("setInternalSlot").invariant(tmp3, "BigInt and Symbol are not supported", TypeError);
      tmp6 = arg0;
      if (undefined === tmp) {
        tmp30 = closure_0;
        tmp31 = closure_1;
        num3 = 0;
        Decimal3 = require("digitsToString").Decimal;
        _NaN = NaN;
        ...
        if (null !== tmp) {
          ...
          if (0 !== tmp) {
            ...
            if (true === tmp) {
              tmp22 = closure_0;
              tmp23 = closure_1;
              Decimal2 = require("digitsToString").Decimal;
              ...
              if ("string" === typeof tmp) {
                tmp15 = closure_0;
                tmp16 = closure_1;
                Decimal = require("digitsToString").Decimal;
                tmp17 = arg0;
                ...
                invariantResult1 = require("setInternalSlot").invariant("object" === typeof tmp, "object expected", TypeError);
                tmp11 = ToPrimitive;
                tmp12 = ToPrimitive(tmp, "number");
                _TypeError3 = TypeError;
                invariantResult2 = require("setInternalSlot").invariant("object" !== typeof tmp12, "object expected", TypeError);
                tmp14 = ToNumber;
...
class DayFromYear {
  constructor(arg0) {
    if (arg0 < 100) {
      ...
      tmp10 = c2;
      return date.getTime() / c2;
    } else {
      tmp = globalThis;
      _Date = Date;
      num = 0;
      tmp2 = c2;
      return Date.UTC(arg0, 0) / c2;
    }
  }
}
class YearFromTime {
        ...
        if (undefined !== tmp3) {
          ...
          if (undefined !== arg1) {
            ...
            if ("string" !== arg1) {
              ...
              invariantResult = require("setInternalSlot").invariant("number" === arg1, "preferredType must be \"string\" or \"number\"");
              str4 = "number";
            }
          }
...
arg5.TimeClip = function TimeClip(isFinite) {
  if (isFinite.isFinite()) {
    if (absResult.greaterThan(8640000000000001)) {
      const Decimal2 = require(13138) /* digitsToString */.Decimal;
      const _NaN2 = NaN;
      ...
      ZERO = require(13141) /* TEN */.ZERO;
    }
    absResult = isFinite.abs();
  } else {
    const Decimal = require(13138) /* digitsToString */.Decimal;
    const _NaN = NaN;
...
arg5.HourFromTime = function HourFromTime(arg0) {
  return mod(Math.floor(arg0 / c8), c3);
};
arg5.MinFromTime = function MinFromTime(arg0) {
  return mod(Math.floor(arg0 / c7), c4);
};
arg5.SecFromTime = function SecFromTime(arg0) {
  return mod(Math.floor(arg0 / c6), c5);
};
