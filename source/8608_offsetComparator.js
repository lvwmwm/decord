...
// Dependencies: [19, 17, 8537, 8609, 8539]
// Exports: default

// Module 8608 (offsetComparator)
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
      ...
      while (true) {
        ...
        if (typeof tmp10 !== "os") {
          ...
          if (!isNaN(num9)) {
            ...
            let items1 = [num9, 16777215 & tmp10 | Math.round(255 * importDefault(8537)(stopOpacity)) << 24];
    ...
    if (gradientUnits) {
      num12 = importDefault(8609)[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
    ...
    obj[4] = importDefault(8539)(gradientTransform);
    return obj;
  } else {
    return null;
  }
