...
// Dependencies: [7674, 7677, 7690, 7713, 7714, 7700, 7672, 7715, 7708, 7684]

// Module 7712 (applyClientOptions)
...
function applyDebugIds(exception) {
  _require = _require(7715).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = callback(7708).normalize(data.data, callback, dependencyMap);
                  data = obj;
                  const obj3 = callback(7708);
                }
