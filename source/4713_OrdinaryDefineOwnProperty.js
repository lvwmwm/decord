...
// Dependencies: [4650, 541, 4697, 4701, 542, 4714, 562, 4706, 4702, 4715, 4716]

// Module 4713 (OrdinaryDefineOwnProperty)
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (isObject(arg0)) {
    if (tmp(4697)(arg1)) {
      if (tmp(4701)(__Writable__)) {
        if (tmp(542)) {
          const tmp30 = tmp(542)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4702)(tmp30);
          }
          return tmp(4716)(arg0, arg1, tmp(4715)(arg0), __Writable__, tmp31);
        } else if (tmp(4714)(__Writable__)) {
          ...
          return tmp(4706)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
