...
// Function ID: 7858
// Name: extractFont
// Dependencies: [19, 21, 7851, 7856]
// Exports: default, setTSpan

// Module 7857 (extractFont)
import "noop";
...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(7851) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "string") {
    ...
    obj[7] = importDefault(7856)(tmp);
    obj[8] = importDefault(7856)(tmp2);
    obj[9] = importDefault(7856)(tmp3);
    obj[10] = importDefault(7856)(tmp4);
    obj[11] = importDefault(7856)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
