...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    const obj4 = importDefault(5286)(color);
    str3 = importDefault(5286)(color).fade(0.85).string();
    tmp5 = color;
    const fadeResult = importDefault(5286)(color).fade(0.85);
  } else if ("filled" === str) {
    let str4 = "white";
    if (!obj10.isDark()) {
    ...
    tmp5 = str4;
    str3 = color;
    obj10 = importDefault(5286)(color);
    tmp9 = importDefault;
  }
  obj = {};
  const merged1 = Object.assign(merged);
  obj = { radius: 40, color: null };
  const obj8 = importDefault(5286)(tmp5);
  obj[1] = importDefault(5286)(tmp5).fade(0.85).string();
  ...
  obj.children = jsx(require(5296) /* Text */.Text, { style: items1, children });
  return jsx(require(5295) /* Animated */.PlatformPressable, { radius: 40, color: null });
}
