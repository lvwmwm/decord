...
// Dependencies: [5, 41, 42, 93, 95, 98, 16243, 16245, 16247]
...
class PQueue {
  constructor(arg0) {
    ...
    if (typeof merged.intervalCap !== "os") {
      num = 1;
                  ...
                  if (0 === c4) {
                    if (arg0 === 1) {
                      ...
                      if (undefined !== lib._timeout) {
                        ...
                        lib(16243).default(resolved, timeout, () => {
