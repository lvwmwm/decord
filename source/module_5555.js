// Module ID: 5555
// Function ID: 47152
// Dependencies: [29, 31, 33, 4522, 1457, 5556]
...
export default Link.createNavigatorFactory(function StackNavigator(arg0) {
  ...
  const mode = tmp.mode;
  navigation(4522)(null != mode, "Stack Navigator: 'mode=\"" + mode + "\"' is deprecated. Use 'presentation: \"" + mode + "\"' in 'screenOptions' instead.\n\nSee https://reactnavigation.org/docs/stack-navigator#presentation for more details.");
  const headerMode = tmp.headerMode;
  navigation(4522)("none" === headerMode, "Stack Navigator: 'headerMode=\"none\"' is deprecated. Use 'headerShown: false' in 'screenOptions' instead.\n\nSee https://reactnavigation.org/docs/stack-navigator/#headershown for more details.");
  let tmp7 = null != headerMode;
  const tmp2 = navigation(4522);
  const tmp3 = null != mode;
  if (tmp7) {
    tmp7 = "none" !== headerMode;
  }
  navigation(4522)(tmp7, "Stack Navigator: 'headerMode' is moved to 'options'. Moved it to 'screenOptions' to keep current behavior.\n\nSee https://reactnavigation.org/docs/stack-navigator/#headermode for more details.");
  const keyboardHandlingEnabled = tmp.keyboardHandlingEnabled;
  navigation(4522)(undefined !== keyboardHandlingEnabled, "Stack Navigator: 'keyboardHandlingEnabled' is moved to 'options'. Moved it to 'screenOptions' to keep current behavior.\n\nSee https://reactnavigation.org/docs/stack-navigator/#keyboardhandlingenabled for more details.");
  ...
  obj.children = jsx(navigation(5556), Object.assign({}, tmp, { state, descriptors, navigation }));
