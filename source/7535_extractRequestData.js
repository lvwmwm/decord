...
// Dependencies: [7536, 7537, 7538, 7461, 7499, 7463, 7453, 7454, 7460]

// Module 7535 (extractRequestData)
const require = arg1;
  ...
  if (!obj.customRoute) {
    if (!method.route) {
      ...
      if (tmp) {
        ...
        str5 = require(7536) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
        str4 = "url";
        const obj2 = require(7536) /* getNumberOfUrlSegments */;
      }
...
arg5.httpRequestToRequestData = function httpRequestToRequestData(headers) {
  ...
  return require(7460) /* addNonEnumerableProperty */.dropUndefinedKeys(obj);
};
