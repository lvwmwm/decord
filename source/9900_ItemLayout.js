...
// Function ID: 9901
// Name: ItemLayout
// Dependencies: [19, 21, 9883, 9901, 1606]
// Exports: ItemLayout

// Module 9900 (ItemLayout)
import "noop";
...
export const ItemLayout = (animationStyle) => {
  ...
  const merged = Object.assign(typeof customConfig === "error" ? customConfig() : {});
  ...
  const tmp4 = typeof customConfig === "error" ? customConfig() : {};
  class E {
    constructor() {
