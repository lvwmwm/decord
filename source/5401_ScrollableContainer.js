...
// Dependencies: [19, 21, 5402, 5403, 5405]

// Module 5401 (ScrollableContainer)
import "noop";
...
export const ScrollableContainer = require("noop").forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  const tmp6 = jsx(require(5402) /* BottomSheetDraggableScrollable */.BottomSheetDraggableScrollable, { ref });
  let tmp2Result = tmp6;
  if (onRefresh) {
    ...
    obj[3] = onRefresh;
    obj[4] = require(5405) /* styles */.styles.container;
    obj[5] = tmp6;
    tmp2Result = jsx(importDefault(5403), { scrollableGesture: null, refreshing: null, progressViewOffset: null, onRefresh: null, style: null, children: null });
    const tmp9 = importDefault(5403);
  }
  return tmp2Result;
});
