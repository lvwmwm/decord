...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8038, 8023, 8024]
...
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8038 */;
...
let obj = {
  ...
  value: function render() {
    ...
    const merged1 = Object.assign(self(8023).extractFilter(this.props));
    const obj2 = self(8023);
    const merged2 = Object.assign(self(8023).extractIn(this.props));
