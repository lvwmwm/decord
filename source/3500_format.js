...
// Function ID: 3501
// Name: format
// Dependencies: [3450, 3501, 3268, 3502, 3513, 3431, 3272, 3269, 3514, 3273, 3515]
// Exports: default
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = _require(3273).getDefaultOptions();
  locale = undefined;
  if (null != locale) {
              ...
              if (tmp3.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3515).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3515).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3515).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
