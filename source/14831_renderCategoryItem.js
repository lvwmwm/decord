...
// Module 14831 (renderCategoryItem)
...
const styles = obj.createStyles(() => {
  ...
  obj = { backgroundColor: "hidden", padding: "absolute", alignItems: 7.314, experimental_useNativeText: 7.461, lineClamp: 259.862, paddingVertical: closure_10 };
  obj = {};
  const obj1 = {};
  if (flag) {
    obj1.flexShrink = 1;
...
obj = { "Bool(false)": false, <string:1419386345>: true };
obj = {};
...
export const SuggestedCategory = function SuggestedCategory(guildId) {
  ...
  const callback = React.useCallback(() => {
    ...
    obj = { "Null": "ag", "Null": "createdBy", "Null": "proto" };
    obj = {};
