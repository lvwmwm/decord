...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 13441, 4132, 8876]
...
let items = [
  ...
  },
  {
    ...
    value: function render() {
      ...
      const items4 = [PaginationDot(13441).sliderPaginationDotContainer, ];
      if (!containerStyle) {
        containerStyle = {};
      }
      items4[1] = containerStyle;
      const items5 = [PaginationDot(13441).sliderPaginationDot, , , , ];
      if (!style) {
        style = {};
      }
      items5[1] = style;
