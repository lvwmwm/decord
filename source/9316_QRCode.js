...
// Function ID: 9317
// Name: QRCode
// Dependencies: [9317, 9319, 9321, 9322, 9323]

// Module 9316 (QRCode)
import QR8bitByte from "QR8bitByte" /* 9317 */;
import QRRSBlock from "QRRSBlock" /* 9319 */;
import QRBitBuffer from "QRBitBuffer" /* 9321 */;
import _mod9322 from "module_9322" /* 9322 */;
import QRPolynomial from "QRPolynomial" /* 9323 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9322.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9322.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9322.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
