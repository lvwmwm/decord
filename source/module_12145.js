// Module ID: 12145
// Function ID: 12146
// Dependencies: [5, 12079, 12142, 12146, 12147, 12148, 12141]

// Module 12145
import asyncGeneratorStep from "module_12148";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, message) {
      ...
      const util = _require(12079).util;
    ...
    let closure_8 = fn(require("module_12146"));
    let closure_9 = fn(require("module_12147"));
    let closure_10 = fn(require("module_12148"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12141).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12141).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12141).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
