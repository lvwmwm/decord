...
// Module 13055 (SetNumberFormatUnitOptions)
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  const GetOptionResult = result1(arg6[0]).GetOption(obj, "style", "string", [], "decimal");
  ...
  const GetOptionResult1 = result1(arg6[0]).GetOption(obj, "currencyDisplay", "string", [true, true, true, true], "symbol");
  ...
  const GetOptionResult2 = result1(arg6[0]).GetOption(obj, "currencySign", "string", [null, null], "standard");
