...
// Function ID: 99642
// Name: items
// Dependencies: [12805, 12804, 12790, 12807]
...
function simpleSubset(semver2, item10021, includePrerelease) {
  ...
  if (semver2 === item10021) {
    ...
    if (1 === semver2.length) {
      ...
      tmp = dependencyMap;
      tmp = semver2;
      if (semver2[0].semver === require(12804) /* Comparator */.ANY) {
        if (1 === arr.length) {
          if (arr[0].semver === require(12804) /* Comparator */.ANY) {
            return true;
          }
        }
      }
    ...
    if (set.size > 1) {
      ...
      if (tmp) {
        if (tmp2) {
          const tmp45 = require(12790) /* compare */(tmp.semver, tmp2.semver, includePrerelease);
          if (tmp45 > 0) {
            tmp = null;
            return null;
          } else {
      ...
      if (iter2 === undefined) {
        ...
        while (obj2 !== undefined) {
          ...
          let _String3 = String;
          let tmp72 = require(12807) /* satisfies */;
...
function higherGT(semver, semver2, includePrerelease) {
  if (semver) {
    const tmp4 = require(12790) /* compare */(semver.semver, semver2.semver, includePrerelease);
    let tmp5 = semver;
    if (tmp4 <= 0) {
      if (tmp4 < 0) {
        let tmp6 = semver2;
...
export default function subset(arg0, arg1) {
  if (arguments.length > 2) {
    ...
    if (arg0 === arg1) {
      ...
      let tmp19 = require(12805) /* Range */;
      const prototype = tmp19.prototype;
      tmp19 = new tmp19(arg0, obj);
      let tmp27 = require(12805) /* Range */;
