...
export const purchaseUpdatedListener = (arg0, arg1) => {
  ...
  const obj = _require(7491);
  const obj2 = new NativeEventEmitter(_require(7491).getNativeModule());
...
export const purchaseErrorListener = (arg0) => {
  const obj = require(7491);
  return new NativeEventEmitter(require(7491).getNativeModule()).addListener("purchase-error", arg0);
};
export const promotedProductListener = (arg0) => {
  let addListenerResult = null;
  if (require(7491).isIos) {
