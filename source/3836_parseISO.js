...
// Function ID: 3837
// Name: parseISO
// Dependencies: [3441, 3444, 3619]
// Exports: default

// Module 3836 (parseISO)
      ...
      if (!isNaN(undefined.getTime())) {
        ...
        if (obj.time) {
          ...
          if (match1) {
            ...
            num28 = NaN;
            if (tmp63) {
              const result = num29 * require(3619) /* keys */.millisecondsInHour;
              num28 = result + num30 * require(3619) /* keys */.millisecondsInMinute + 1000 * num31;
            }
          }
          const _isNaN2 = isNaN;
          num26 = num28;
        ...
        if (obj.timezone) {
          ...
          if ("Z" !== obj.timezone) {
            ...
            if (defaultResult) {
              ...
              num38 = NaN;
              if (tmp83) {
                const result1 = parsed * require(3619) /* keys */.millisecondsInHour;
                num38 = num * (result1 + num39 * require(3619) /* keys */.millisecondsInMinute);
              }
            }
          }
          const _isNaN3 = isNaN;
