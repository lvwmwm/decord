...
// Dependencies: [7476, 7477, 7478, 7401, 7439, 7403, 7393, 7394, 7400]

// Module 7475 (extractRequestData)
const require = arg1;
  ...
  if (!obj.customRoute) {
    if (!method.route) {
      ...
      if (tmp) {
        ...
        str5 = require(7476) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
        str4 = "url";
        const obj2 = require(7476) /* getNumberOfUrlSegments */;
      }
...
arg5.httpRequestToRequestData = function httpRequestToRequestData(headers) {
  ...
  return require(7400) /* addNonEnumerableProperty */.dropUndefinedKeys(obj);
};
