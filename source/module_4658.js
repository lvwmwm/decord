// Module ID: 4658
// Function ID: 4659
// Dependencies: [109, 19, 17, 21, 4656, 4647, 4640, 4659, 4646, 4662, 4635]
...
export default importAllResult.forwardRef(function ScreenStackItem(unstable_sheetFooter, ref) {
  ...
  dependencyMap = flag4.useContext(screenId(4656).RNSScreensRefContext);
  const imperativeHandle = flag4.useImperativeHandle(ref, () => ref.current);
  let obj1 = screenId(4647);
  let flag;
  ...
  items1[1] = callback(screenId(4646).ScreenStackHeaderConfig, obj);
