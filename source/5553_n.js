...
// Function ID: 5554
// Name: n
// Dependencies: [19, 5509, 5552]
// Exports: useReanimatedEventHandler

// Module 5553 (n)
import noop from "noop";
import { Reanimated } from "module_5509";
...
export const useReanimatedEventHandler = function useReanimatedEventHandler(handlerTag, memoizedGestureCallbacks, handler, changeEventCalculator, fillInDefaultValues) {
  ...
  fn.__closure = { lastUpdateEventMap: mutable, eventHandler: _require(5552).eventHandler, handlerTag, workletizedHandlers: tmp, changeEventCalculator, fillInDefaultValues };
