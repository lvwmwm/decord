...
// Function ID: 5559
// Name: JSFPSMonitor
// Dependencies: [5505, 5506, 5493, 5559]

// Module 5558 (JSFPSMonitor)
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        const error = new Error(JSFPSMonitor(5493).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      obj[0] = JSFPSMonitor(5559).roundToDecimalPlaces(self.minFPS, 1);
      const obj2 = JSFPSMonitor(5559);
      obj[1] = JSFPSMonitor(5559).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(5559);
      obj[2] = JSFPSMonitor(5559).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    }
  }
];
