...
// Function ID: 5048
// Name: parseBox
// Dependencies: [5048, 5041, 5038]

// Module 5047 (parseBox)
import getDataView from "getDataView" /* 5038 */;
import parseItemLocationBox from "parseItemLocationBox" /* 5048 */;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(5038).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(5038);
            }
          }
        }
      } else {
