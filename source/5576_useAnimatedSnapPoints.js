...
arg5.useAnimatedSnapPoints = (snapPoints, containerHeight, contentHeight, handleHeight, arg4, enableDynamicSizing, maxDynamicContentSize) => {
  ...
  obj = { containerHeight, INITIAL_CONTAINER_HEIGHT: _require(5403).INITIAL_CONTAINER_HEIGHT, INITIAL_SNAP_POINT: _require(5403).INITIAL_SNAP_POINT, snapPoints, normalizeSnapPoint: _require(5416).normalizeSnapPoint, enableDynamicSizing, handleHeight, INITIAL_HANDLE_HEIGHT: _require(5403).INITIAL_HANDLE_HEIGHT, contentHeight, maxDynamicContentSize, dynamicSnapPointIndex: sharedValue };
  P.__closure = obj;
  ...
  class N {
    constructor() {
      if (closure_4) {
        ...
        tmp = !length;
        if (length) {
          tmp = !items.find(/* F105550 */ function() { ... });
        }
        return !tmp;
      }
    }
