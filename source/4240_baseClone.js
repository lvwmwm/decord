...
// Function ID: 37332
// Name: baseClone
// Dependencies: [573, 591, 4241, 4242, 747, 605, 4243, 4244, 4247, 4251, 4255, 4256, 4257, 752, 4263, 4265, 4267, 769, 4252, 601, 592, 4249]

// Module 4240 (baseClone)
let obj = {};
  ...
  if (!arg2) {
    {
      if (_require(573)(arr)) {
        ...
        if (tmp12) {
          const tmp32 = tmp13(4241)(arr);
          obj = tmp32;
          let tmp22 = tmp32;
          if (!tmp) {
            return _require(4242)(arr, tmp32);
          }
        } else {
          ...
          if (_require(605)(arr)) {
            return _require(4243)(arr, tmp);
          } else {
            if (tmp15 != "[object Object]") {
              if (tmp15 != "[object Arguments]") {
                if (obj[tmp15]) {
                  tmp22 = _require(4257)(arr, tmp15, tmp);
                  obj = tmp22;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              if (!tmp16) {
                obj = _require(4244)(arr);
              }
              tmp22 = obj;
              if (!tmp) {
                if (tmp2) {
                  let tmp25Result = tmp25(4247);
                  let tmp25ResultResult = tmp25Result(arr, tmp25(4251)(obj, arr));
                } else {
                  tmp25Result = tmp25(4255);
                  tmp25ResultResult = tmp25Result(arr, tmp25(4256)(obj, arr));
                }
