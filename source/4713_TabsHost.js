...
// Function ID: 4714
// Name: TabsHost
// Dependencies: [32, 109, 19, 17, 21, 4714, 4689, 4715, 4716, 4718]
// Exports: default

// Module 4713 (TabsHost)
...
export default function TabsHost(onNativeFocusChange) {
  let obj = onNativeFocusChange(4714);
  ...
  if (undefined === controlledBottomTabs) {
    controlledBottomTabs = ref(4689).experiment.controlledBottomTabs;
  }
