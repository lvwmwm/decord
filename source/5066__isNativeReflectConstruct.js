  ...
  class Swipeable {
    constructor(arg0) {
      ...
      tmp2Result.updateAnimatedEvent = (overshootFriction, rowWidth) => {
        ...
        const interpolateResult = set.add(rowWidth.rowTranslation, dragX.interpolate({ inputRange: items, outputRange: ["replace", "then"] })).interpolate(obj);
        ...
        if (bound > 0) {
          ...
          obj1.outputRange = [false, false, false];
