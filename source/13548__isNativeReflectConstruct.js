...
// Dependencies: [6, 7, 15, 17, 18, 31, 33, 13549, 13552, 4483]
// Exports: default

// Module 13548 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(require(4483) /* Animated */.ScreenContext.Provider, { value: closure_9, children: children.children });
};
