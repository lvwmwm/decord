...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = require(12246);
      const glogResult = require(12246).glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - require(12246).glog(getLength.get(0));
