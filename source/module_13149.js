// Module ID: 13149
// Function ID: 13150
// Dependencies: [13143, 13114, 13134]

// Module 13149

export default (arg0, arg1) => {
  let require;
  let obj = new require(13143) /* Range */(arg0, arg1);
  const tmp3 = new require(13114) /* SemVer */("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
        ...
        do {
          ...
          if (require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = require;
              tmp16 = !require(13134) /* SemVer */(tmp14, require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
