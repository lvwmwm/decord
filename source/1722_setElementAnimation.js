...
arg5.getReducedMotionFromConfig = function getReducedMotionFromConfig(entering) {
  if (entering.reduceMotionV) {
    ...
    if (require(1678) /* isWorkletFunction */.ReduceMotion.Never === reduceMotionV) {
      return false;
    ...
    return require(1694) /* isReducedMotionEnabledInSystem */.ReducedMotionManager.jsValue;
  }
};
arg5.getProcessedConfig = function getProcessedConfig(animationWithInitialValues, animationType, entering) {
  ...
  let num = 0.3;
  if (animationWithInitialValues in require(1709) /* TransitionType */.Animations) {
...
arg5.maybeModifyStyleForKeyframe = function maybeModifyStyleForKeyframe(style, entering) {
  if (entering instanceof require(1723) /* BaseAnimationBuilder */.Keyframe) {
...
arg5.saveSnapshot = function saveSnapshot(_componentDOMRef) {
  ...
  obj[4] = obj;
  const snapshots = require(1739) /* weakMap */.snapshots;
...
arg5.handleLayoutTransition = function handleLayoutTransition(_componentDOMRef, processedConfig, easingY) {
  ...
  if ("LinearTransition" === animationName) {
    let ENTRY_EXIT = require(1709) /* TransitionType */.TransitionType.LINEAR;
    let tmp4 = require;
  } else if ("SequencedTransition" === animationName) {
    ENTRY_EXIT = require(1709) /* TransitionType */.TransitionType.SEQUENCED;
    tmp4 = require;
  } else if ("FadingTransition" === animationName) {
    ENTRY_EXIT = require(1709) /* TransitionType */.TransitionType.FADING;
    tmp4 = require;
  } else if ("JumpingTransition" === animationName) {
    ENTRY_EXIT = require(1709) /* TransitionType */.TransitionType.JUMPING;
    tmp4 = require;
  } else if ("CurvedTransition" === animationName) {
    ENTRY_EXIT = require(1709) /* TransitionType */.TransitionType.CURVED;
    tmp4 = require;
  } else if ("EntryExitTransition" === animationName) {
    ENTRY_EXIT = require(1709) /* TransitionType */.TransitionType.ENTRY_EXIT;
    tmp4 = require;
  }
