...
// Function ID: 4970
// Name: load
// Dependencies: [4970, 4971, 4972, 4973, 4974, 4987, 4989, 4990, 5002, 5006, 5010, 5012, 5014, 5015, 5016, 5017, 5018, 5019, 5020, 5021, 5022, 5023, 4996]
// Exports: load
  ...
  if (typeof response === "string") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(4971).dataUriToBuffer(response));
        const obj5 = response(4971);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
