...
// Function ID: 57247
// Name: normalize
// Dependencies: [57, 6393, 6353, 6354, 6350]
// Exports: normalizeUrlToBase

// Module 6392 (normalize)
...
function visit(arg0, __sentry_skip_normalization__) {
          ...
          if (__sentry_skip_normalization__.__sentry_skip_normalization__) {
            ...
            if (0 === num) {
              ...
              while (true) {
                ...
                let obj3 = require(6353) /* addNonEnumerableProperty */;
  ...
  memoBuilderResult = require(6393) /* memoBuilder */.memoBuilder();
}
