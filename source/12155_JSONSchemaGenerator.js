...
// Dependencies: [109, 41, 42, 12153, 12154]
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(12153).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(12153).extractDefs(self.ctx, _idmap);
      return _objectWithoutProperties(JSONSchemaGenerator(12153).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
