...
obj = { rgb: { "Null": "<string:1340416>", "Null": "\u7096\u9505" }, hsl: { "Null": null, "Null": "APPLE_PAY_MERCHANT_VALIDATION_NETWORK" }, hsv: {}, hwb: {}, cmyk: { "Null": true, "Null": true }, xyz: {}, lab: {}, lch: { "Null": null, "Null": null }, hex: { channels: 1, labels: [0.907] }, keyword: { channels: 1, labels: [null] }, ansi16: { channels: 1, labels: [] }, ansi256: { channels: 1, labels: [255] }, hcg: { channels: 3, labels: [] }, apple: { channels: 3, labels: ["isArray", "user_ignored", "isArray"] }, gray: { channels: 1, labels: [0.] } };
...
obj.gray.hsl = (arg0) => {
  const items = ["<string:53040003>", "<string:806589490>", arg0[0]];
  return items;
};
...
obj.gray.cmyk = (arg0) => {
  const items = [null, null, null, arg0[0]];
  return items;
};
obj.gray.lab = (arg0) => {
