...
// Function ID: 26970
// Name: _typeof
// Dependencies: [3456, 3443, 3210, 3460, 3455, 3373, 3214, 3211, 3215, 3513, 3457, 3514]
// Exports: default

// Module 3512 (_typeof)
import module_3456 from "module_3456";
...
export default function parse(arg0, arg1, defaultResult1, locale) {
  ...
  const module_3456 = String(arg0);
  const StringResult = String(arg1);
  const subMilliseconds = StringResult;
  const defaultOptions = _require(3215).getDefaultOptions();
  locale = undefined;
  if (null != locale) {
        ...
        if (defaultResult2 >= 0) {
          if (tmp26 <= 6) {
            if ("" === str) {
              ...
              const DateToSystemTimezoneSetter = _require(3513).DateToSystemTimezoneSetter;
              ...
              while (true) {
                let tmp40 = obj8;
                let fResult1 = obj8.f();
                let tmp42 = module_3456;
                if (module_3456.length <= 0) {
                  break;
                } else {
                  let tmp43 = regex;
                  let tmp44 = module_3456;
                  if (!regex.test(module_3456)) {
                    break;
                  } else {
                    let _Date3 = Date;
                    let _NaN3 = NaN;
