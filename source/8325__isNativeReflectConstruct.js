...
// Dependencies: [5, 41, 42, 93, 95, 98, 19, 17, 21, 81, 8326, 4080, 8328, 8329, 8330, 8348]
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f115518);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f115518);
    ...
    f115518 = undefined;
    f115518 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8328").NONE, require("module_8328").INVERT, require("module_8328").MONOCHROME, require("module_8328").POSTERIZE, require("module_8328").FALSE, require("module_8328").MAXIMUMCOMPONENT, require("module_8328").MINIMUMCOMPONENT, require("module_8328").CHROME, require("module_8328").FADE, require("module_8328").INSTANT, require("module_8328").MONO, require("module_8328").NOIR, require("module_8328").PROCESS, require("module_8328").TONAL, require("module_8328").TRANSFER, require("module_8328").SEPIA];
...
const items4 = [require("module_8329").CLEARKEY, require("module_8329").FAIRPLAY, require("module_8329").WIDEVINE, require("module_8329").PLAYREADY];
...
const items8 = [require("module_8348").SRT, require("module_8348").TTML, require("module_8348").VTT];
...
export const TextTrackType = require("module_8348");
export const FilterType = require("module_8328");
export const DRMType = require("module_8329");
