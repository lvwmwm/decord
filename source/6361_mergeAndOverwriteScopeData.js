...
// Dependencies: [65, 6336, 6317, 6316, 6347]
// Exports: applyScopeDataToEvent, mergeScopeData

// Module 6361 (mergeAndOverwriteScopeData)
import _toConsumableArray from "_toConsumableArray";

function mergeAndOverwriteScopeData(arg0, arg1, arg2) {
  arg0[arg1] = require(6336) /* merge */.merge(arg0[arg1], arg2, 1);
}
...
export const applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  let obj = require(6317) /* addNonEnumerableProperty */;
  ...
  const dropUndefinedKeysResult1 = require(6317) /* addNonEnumerableProperty */.dropUndefinedKeys(tags);
  ...
  const dropUndefinedKeysResult2 = require(6317) /* addNonEnumerableProperty */.dropUndefinedKeys(user);
  ...
  const obj3 = require(6317) /* addNonEnumerableProperty */;
  const dropUndefinedKeysResult3 = require(6317) /* addNonEnumerableProperty */.dropUndefinedKeys(contexts);
  ...
  if (span) {
    ...
    obj = { trace: require(6316) /* spanTimeInputToSeconds */.spanToTraceContext(span) };
    extra.contexts = Object.assign(obj, extra.contexts);
    const _Object10 = Object;
    obj = {};
    const obj6 = require(6316) /* spanTimeInputToSeconds */;
    obj.dynamicSamplingContext = require(6347) /* getDynamicSamplingContextFromClient */.getDynamicSamplingContextFromSpan(span);
    extra.sdkProcessingMetadata = Object.assign(obj, extra.sdkProcessingMetadata);
    const obj8 = require(6347) /* getDynamicSamplingContextFromClient */;
    const rootSpan = require(6316) /* spanTimeInputToSeconds */.getRootSpan(span);
    const obj9 = require(6316) /* spanTimeInputToSeconds */;
    const description = require(6316) /* spanTimeInputToSeconds */.spanToJSON(rootSpan).description;
...
export const mergeScopeData = function mergeScopeData(sdkProcessingMetadata, extra) {
  ...
  sdkProcessingMetadata.sdkProcessingMetadata = require(6336) /* merge */.merge(sdkProcessingMetadata.sdkProcessingMetadata, sdkProcessingMetadata, 2);
  if (level) {
