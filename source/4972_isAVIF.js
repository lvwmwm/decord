...
arg5.isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4966) /* getFileChunk */.isAvifStringIncluded(fileChunk);
};
...
arg5.isHEIC = function isHEIC(fileChunk) {
  fileChunk = require(4966) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4967).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4966) /* getFileChunk */.isHeicSignatureIncluded(fileChunk);
};
