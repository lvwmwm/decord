...
// Function ID: 8720
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1501, 1632, 5383, 8720, 4752, 8721, 8723, 8724, 8725, 8726]
// Exports: NativeStackView

// Module 8719 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5383).HeaderShownContext);
  let num5 = React.useContext(num6(5383).HeaderHeightContext);
  const context1 = React.useContext(num6(5383).HeaderBackContext);
  let obj3 = num6(5383);
  ...
  callback = obj2.useCallback(num6(8720).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4752).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4752).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5383).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5383);
  ...
  let eventResult;
  const headerConfigProps = num6(8721).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  const tmp8Result3 = num6(8721);
  obj15[1] = closure_10(num6(5383).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(5383).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = tmp38(num6(5383).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(8723).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4752).ScreenStackItem, obj4);
