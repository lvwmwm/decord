...
// Function ID: 13649
// Name: URLImpl
// Dependencies: [41, 42, 13649, 13653, 13652]

// Module 13648 (URLImpl)
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(13649).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(13649).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(13652).parseUrlencoded(query);
          const tmpResult = tmp(13652);
        }
      }
      const obj = URLImpl(13649);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(13649).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
  ...
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13649).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(13649);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13649).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(13649);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(13649).serializeHost(host);
        const obj3 = URLImpl(13649);
      } else {
        const obj = URLImpl(13649);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(13649).serializeInteger(host.port)}`;
        const obj2 = URLImpl(13649);
      }
    },
    set(arg0) {
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(13649).serializeHost(tmp._url.host);
        const obj = URLImpl(13649);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(13649).serializeInteger(tmp._url.port);
        const obj = URLImpl(13649);
      }
      return str;
    },
    set(arg0) {
      ...
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        if ("" === arg0) {
          ...
          obj[0] = self._url;
          URLImpl(13649).basicURLParse(arg0, obj);
          const tmpResult = URLImpl(13649);
        }
      }
    }
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        self._query._list = URLImpl(13652).parseUrlencoded(substr);
      }
    }
  },
  {
