...
// Dependencies: [32, 12433, 12434, 12432, 12426]

// Module 12438 (convertBaseSchema)
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema(flag, defaultTarget) {
      if (typeof flag === "boolean") {
        ...
        if (registry == null) {
          registry = require(12426) /* $output */.globalRegistry;
        }
        obj[5] = registry;
        return convertSchema(flag, obj);
      }
    };
    const fnResult = fn(require("module_12433"));
    let obj = {};
    let merged = Object.assign(fn(require("module_12432")));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(require("module_12434"));
    let _Set = Set;
