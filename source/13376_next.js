...
// Function ID: 102421
// Name: next
// Dependencies: [6, 7, 77, 57, 13370, 13377, 13378]
...
let obj = {
  value: function next() {
    ...
    let tmp7;
    let tmp8;
    const tmp = this[require(undefined, 13370) /* wrapperForImpl */.iterInternalSymbol];
    ({ kind, index } = tmp);
    const arr = Array.from(tmp.target[require(undefined, 13370) /* wrapperForImpl */.implSymbol]);
    if (index >= arr.length) {
      let obj = { value: undefined, done: true };
      return obj;
    } else {
      tmp.index = index + 1;
      [tmp7, tmp8] = _slicedToArray(arr[index].map(require(13370) /* wrapperForImpl */.tryWrapperForImpl), 2);
      if ("key" === kind) {
        let tmp2 = tmp7;
      } else if ("value" === kind) {
        tmp2 = tmp8;
...
obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(tmp, require(13370) /* wrapperForImpl */.implSymbol)) {
        if (tmp[require(undefined, 13370) /* wrapperForImpl */.implSymbol] instanceof require(13377) /* URLSearchParamsImpl */.implementation) {
          return true;
        }
      }
      ...
      obj = require(13370) /* wrapperForImpl */;
    }
    return false;
  },
  isImpl(getAll) {
    if (getAll) {
      if (getAll instanceof require(13377) /* URLSearchParamsImpl */.implementation) {
        return true;
      } else {
        const wrapperForImplResult = require(13370) /* wrapperForImpl */.wrapperForImpl(getAll);
        const _mixedIntoPredicates = module.exports._mixedIntoPredicates;
        ...
        const obj = require(13370) /* wrapperForImpl */;
      }
    }
    return false;
  },
  convert(arg0) {
    if (arguments.length > 1) {
      ...
      if (_exports.is(arg0)) {
        return require(13370) /* wrapperForImpl */.implForWrapper(arg0);
      } else {
  ...
  createDefaultIterator(self, key) {
    ...
    Object.defineProperty(obj, require(13370) /* wrapperForImpl */.iterInternalSymbol, { value: obj, configurable: true });
    return obj;
  },
  create(arg0, arg1, arg2) {
    if (undefined === arg0[require(undefined, 13370) /* wrapperForImpl */.ctorRegistrySymbol]) {
      const _Error2 = Error;
      const error = new Error("Internal error: invalid global object");
      throw error;
    } else {
      const _URLSearchParams = arg0[require(undefined, 13370) /* wrapperForImpl */.ctorRegistrySymbol].URLSearchParams;
  ...
  setup(wrapper) {
    if (arguments.length > 2) {
      ...
      if (arguments.length > 3) {
        ...
        const _Object = Object;
        obj = {};
        let implementation = require(13377) /* URLSearchParamsImpl */.implementation;
        ...
        Object.defineProperty(wrapper, require(13370) /* wrapperForImpl */.implSymbol, obj);
        wrapper[require(undefined, 13370) /* wrapperForImpl */.implSymbol][require(13370) /* wrapperForImpl */.wrapperSymbol] = wrapper;
        if (require(13377) /* URLSearchParamsImpl */.init) {
          require(13377) /* URLSearchParamsImpl */.init(wrapper[require(undefined, 13370) /* wrapperForImpl */.implSymbol], obj);
          const obj3 = require(13377) /* URLSearchParamsImpl */;
        }
        return wrapper;
      }
      obj = {};
  ...
  install(arg0) {
    ...
    if (undefined === arg0[_require(undefined, 13370).ctorRegistrySymbol]) {
      let _Object = Object;
      arg0[_require(13370).ctorRegistrySymbol] = Object.create(null);
    }
    arg0[_require(undefined, 13370).ctorRegistrySymbol].URLSearchParams = tmp;
