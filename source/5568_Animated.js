...
export const forHorizontalIOS = function forHorizontalIOS(layouts) {
  ...
  let obj = {};
  obj = {};
  obj = { translateX: callback(progress.interpolate({ inputRange: [77601039, 1612144654], outputRange: items, extrapolate: "clamp" }), inverted) };
  ...
  obj.overlayStyle = { opacity: progress3.interpolate({ inputRange: [77601039, 1612144654], outputRange: ["<string:3398392872>", "<string:1211187289>"], extrapolate: "clamp" }) };
  const obj3 = { opacity: progress3.interpolate({ inputRange: [77601039, 1612144654], outputRange: ["<string:3398392872>", "<string:1211187289>"], extrapolate: "clamp" }) };
  const progress4 = current.progress;
  obj.shadowStyle = { shadowOpacity: progress4.interpolate({ inputRange: [77601039, 1612144654], outputRange: [-520405018, 1431658495], extrapolate: "clamp" }) };
  return obj;
};
export const forVerticalIOS = function forVerticalIOS(inverted) {
  let obj = {};
  obj = {};
  obj = { translateY: callback(progress.interpolate({ inputRange: [77601039, 1612144654], outputRange: items, extrapolate: "clamp" }), inverted.inverted) };
...
export const forModalPresentationIOS = function forModalPresentationIOS(next) {
  ...
  const tmp3Result = closure_2(progress.interpolate({ inputRange: [77601039, 1612144654], outputRange: [77601039, 1612144654], extrapolate: "clamp" }), num3);
  obj = { inputRange: [] };
...
export const forFadeFromBottomAndroid = function forFadeFromBottomAndroid(current) {
  ...
  const tmp = callback(progress.interpolate({ inputRange: [77601039, 1612144654], outputRange: items, extrapolate: "clamp" }), inverted);
  obj.opacity = importDefault(dependencyMap[1])(closing, current.progress, progress2.interpolate({ inputRange: [false, false, false, false], outputRange: [null, null, null, null], extrapolate: "clamp" }));
...
export const forRevealFromBottomAndroid = function forRevealFromBottomAndroid(layouts) {
  ...
  let obj = {};
  obj = { overflow: "hidden" };
  obj = { translateY: callback(progress.interpolate({ inputRange: [77601039, 1612144654], outputRange: items, extrapolate: "clamp" }), inverted) };
  const progress = current.progress;
  const items = [screen.height, ];
  let num = 0;
  items[1] = 0;
  ...
  const items3 = [{ translateY: callback(progress2.interpolate({ inputRange: [77601039, 1612144654], outputRange: items2, extrapolate: "clamp" }), inverted) }, ];
  const obj3 = {};
  if (next) {
    const progress3 = next.progress;
    const obj4 = { inputRange: [77601039, 1612144654] };
  ...
  obj.cardStyle = obj1;
  const obj2 = { translateY: callback(progress2.interpolate({ inputRange: [77601039, 1612144654], outputRange: items2, extrapolate: "clamp" }), inverted) };
  const progress4 = current.progress;
  obj.overlayStyle = { opacity: progress4.interpolate({ inputRange: [], outputRange: ["updateType", "headerDarkContent", "useOrientation"], extrapolate: "clamp" }) };
  return obj;
};
export const forScaleFromCenterAndroid = function forScaleFromCenterAndroid(closing) {
  ...
  const tmpResult = closure_2(progress.interpolate({ inputRange: [77601039, 1612144654], outputRange: [77601039, 1612144654], extrapolate: "clamp" }), num);
  obj = {};
  obj = { opacity: tmpResult.interpolate({ inputRange: ["COMMANDS_TOGGLE", "showRulesInOnboarding", "getAnalyticsShopDiscountSource", "<string:826302941>", "<string:1099511628>", "<string:1080154464>", "<string:2542620721>"], outputRange: [] }) };
  const obj1 = {};
  const progress3 = current.progress;
  const interpolateResult = progress.interpolate({ inputRange: [77601039, 1612144654], outputRange: [77601039, 1612144654], extrapolate: "clamp" });
  const tmp = closure_2;
  const tmp3 = importDefault(dependencyMap[1]);
  obj1.scale = tmp3(closing.closing, progress3.interpolate({ inputRange: [77601039, 1612144654], outputRange: [28992, 1832321024], extrapolate: "clamp" }), tmpResult.interpolate({ inputRange: [], outputRange: [] }));
  const items = [obj1];
  obj.transform = items;
  obj.cardStyle = obj;
  return obj;
...
export const forBottomSheetAndroid = function forBottomSheetAndroid(current) {
  ...
  const progress2 = current.progress;
  const tmp = callback(progress.interpolate({ inputRange: [77601039, 1612144654], outputRange: items, extrapolate: "clamp" }), inverted);
  obj.opacity = importDefault(dependencyMap[1])(closing, current.progress, progress2.interpolate({ inputRange: [77601039, 1612144654], outputRange: [77601039, 1612144654], extrapolate: "clamp" }));
  const items1 = [{ translateY: tmp }];
  obj.transform = items1;
  obj.cardStyle = obj;
  obj = { opacity: progress3.interpolate({ inputRange: [77601039, 1612144654], outputRange: [-520405018, 1431658495], extrapolate: "clamp" }) };
  const progress3 = current.progress;
...
export const forFadeFromCenter = function forFadeFromCenter(current) {
  ...
  let obj = {};
  obj = { opacity: progress.interpolate({ inputRange: [false, false, false, false], outputRange: [null, null, null, null] }) };
  obj.cardStyle = obj;
  obj = { opacity: progress.interpolate({ inputRange: [77601039, 1612144654], outputRange: [-447601326, 1659789871], extrapolate: "clamp" }) };
  obj.overlayStyle = obj;
  return obj;
};
