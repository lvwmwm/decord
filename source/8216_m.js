...
let fn = function m() {
  function y(arg0, arg1, arg2) {
    ...
    if (StringResult.length > arg1 >> 0) {
      ...
      if (diff <= "0".length) {
        ...
        if (typeof h !== "fileFinishedImporting") {
  ...
  function Q(arg0, arg1) {
    ...
    let obj = {};
    if (typeof closure_46 !== "fileFinishedImporting") {
      ...
      while (true) {
        while (!str3) {
                          ...
                          switch (iter.symbol) {
                            ...
                            case "prototype":
                              ...
                              if (flag) {
                                ...
                                let tmp37 = outer1_72;
                                let arr1 = byweekday.push(outer1_72[flag2]);
                                obj = iter;
                              } else {
                                str4 = iter.symbol;
                              }
                                ...
                                if ("week(s)" === iter.symbol) {
                                  ...
                                  if (acceptNumberResult) {
                                    ...
                                    if (str4) {
                                      ...
                                      let error = new byweekday.Error("Unexpected symbol " + parsed.symbol + "; expected monthday");
                                      let tmp25 = error;
                                      throw error;
                                    }
                                  } else {
          ...
          switch (str4) {
                ...
                if (num11) {
                  ...
                  if ("until" === obj.symbol) {
                    ...
                    if (str6) {
                      ...
                      str = "Cannot parse until date:";
                      str9 = `Cannot parse until date:${obj2.text}`;
            ...
            case "NG":
            break;
            case "hasEmittedPaymentFlowStartedRef":
            break;
            case "favoriteSounds":
            break;
            ...
            break;
            case "COLLECTIBLES_SHOP_NAGBAR":
            break;
            case "NAGBAR_NOTICE_IGNORE_USER_FEEDBACK":
            break;
            case "IGNORE_USER_FEEDBACK_NAGBAR":
            break;
            case "NAGBAR_NOTICE_PREMIUM_PROMO":
            break;
            case "PREMIUM_PROMO":
            break;
            case "PREMIUM_PROMOTION_OPENED":
            break;
            ...
            case "REJECTED":
            break;
            case "woman_juggling_medium_dark_skin_tone":
            break;
            case "man_juggling_medium_dark_skin_tone":
            break;
            ...
            case "IL":
            break;
            case "_INTERNAL_skipAiProviderWrapping":
            break;
            case "ski":
            break;
            case "skip":
            ...
            case "GRAPHQL_URLS":
            break;
            case "CONTEXT_MENU_LONG_PRESS_DURATION_MS":
            break;
            case "SINT32":
            break;
            case "INT32":
              ...
              if (obj.nextSymbol()) {
                ...
                if ("until" === obj.symbol) {
                  ...
                  if (parsed2) {
                    ...
                    let str23 = "Cannot parse until date:";
                    str9 = `Cannot parse until date:${obj2.text}`;
                    _Error6 = Error;
                  }
                } else {
            ...
            case "spendingLimit":
            break;
            case "spendingLimitEqual":
            break;
            case "two_men_holding_hands":
            break;
            case "handshake_dark_skin_tone":
            break;
            case "handshake_dark_skin_tone_light_skin_tone":
            break;
            ...
            case "DAYS_30":
            break;
            case "PARENTAL_CONSENT_WARNING_SURFACE_SHOWN":
            break;
            ...
            case "CUTTING":
            break;
            case "GAME_STORE_OPEN_GAME_LINK":
            break;
            case "KrispInitErrorWeightVad":
            break;
            case "adDecisionData":
            break;
            case "onDataReceived":
            ...
            case "palm_down_hand":
            break;
            case "palm_down_hand_dark_skin_tone":
            break;
            ...
            case "ADS":
            break;
            case "CREATOR_MONETIZATION_ENABLE_REQUESTS":
            break;
            case "REQUESTS":
            break;
            case "QUESTS":
            ...
            break;
            case "MOBILE_BACKGROUND_SCRIM_OPAQUE":
            break;
            case "QUESTS_SEND_HEARTBEAT_SUCCESS":
            break;
            case "includedInLevel":
            break;
        ...
        let tmp86 = globalThis;
        let _Error8 = Error;
        let tmp87 = new.target;
        let str25 = "Unexpected end";
  ...
  function rt(arg0) {
    ...
    for (let num = 0; num < keys.length; num = num + 1) {
      ...
      let arr3 = closure_71;
      let tmp3 = num;
      if (typeof p !== "fileFinishedImporting") {
      ...
      let tmp11 = E;
      if (typeof E !== "fileFinishedImporting") {
              ...
              if (!isArray(str5)) {
                if ("FREQ" === formatted) {
                  ...
                  if (str5) {
                    ...
                    if (typeof closure_55 !== "fileFinishedImporting") {
                  ...
                  tzid = tzid.tzid;
                  let tmp14 = !tzid;
                  if (typeof N !== "fileFinishedImporting") {
  ...
  function At(getValue, count) {
    ...
    if (0 !== count.count) {
      if (0 !== count.interval) {
        ...
        if (typeof closure_67 !== "fileFinishedImporting") {
          HermesBuiltin.throwTypeError();
        }
        ...
        if (freq2 >= obj3.HOURLY) {
          ...
          if (freq2 >= constants.MINUTELY) {
            ...
            if (!tmp17) {
              ...
              if (typeof tmp48 !== "fileFinishedImporting") {
                HermesBuiltin.throwTypeError();
              }
          ...
          if (freq2 >= constants.SECONDLY) {
            ...
            if (!tmp26) {
              ...
              if (typeof tmp56 !== "fileFinishedImporting") {
                HermesBuiltin.throwTypeError();
              }
              if (typeof tmp22 !== "fileFinishedImporting") {
                HermesBuiltin.throwTypeError();
              }
              if (typeof tmp23 !== "fileFinishedImporting") {
                HermesBuiltin.throwTypeError();
              }
              let tmp29 = !tmp28;
              if (null != bysecond) {
          ...
          let item = byhour.forEach((arg0) => {
            ...
            let item = byminute.forEach((arg0) => {
              ...
              const item = bysecond.forEach((second) => {
                let num = outer2_1;
                if (typeof outer3_49 !== "fileFinishedImporting") {
                  HermesBuiltin.throwTypeError();
                }
  ...
  function Bt(str) {
    ...
    let item = keys.forEach((arg0) => {
      ...
      if (typeof callResult !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
      let tmp2 = !tmp;
      if (null != arr) {
    ...
    if (items.length) {
      ...
      if (str) {
            ...
            if (parts1) {
              ...
              if ("RRULE" === formatted) {
                ...
                closure_1 = closure_1.concat(parts3.map((arg0) => {
                  if (typeof closure_34 !== "fileFinishedImporting") {
                    HermesBuiltin.throwTypeError();
                  }
        ...
        if (typeof closure_76 !== "fileFinishedImporting") {
          HermesBuiltin.throwTypeError();
        }
  ...
  function Jt(arg0, arr) {
    if (arg0 instanceof Date) {
      ...
      if (!tmp14) {
        arr.push(arg0);
        if (typeof R !== "fileFinishedImporting") {
          HermesBuiltin.throwTypeError();
        }
  ...
  let obj = {
    ...
    r(arg0) {
      let toStringTag = typeof Symbol === "pack";
  ...
  function Y(arg0, arg1) {
    if (typeof b !== "fileFinishedImporting") {
      HermesBuiltin.throwTypeError();
    }
    ...
    if (1 !== uTCMonth) {
      ...
      if (typeof k !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
  ...
  class e {
    ...
    addHours(arg0, arg1, arg2) {
      ...
      while (true) {
        ...
        tmp = d;
        hour = self.hour;
        if (typeof d !== "fileFinishedImporting") {
          str = "Trying to call a non-function";
          throwTypeErrorResult = HermesBuiltin.throwTypeError();
        }
        _Math2 = Math;
    ...
    _cacheAdd(arg0, arg1, arg2) {
      ...
      if (!arg1) {
        ...
        if (arr instanceof Date) {
          tmp11 = M;
          if (typeof M !== "fileFinishedImporting") {
            str4 = "Trying to call a non-function";
            throwTypeErrorResult = HermesBuiltin.throwTypeError();
          }
          time = arr.getTime();
