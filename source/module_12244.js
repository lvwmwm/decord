// Module ID: 12244
// Function ID: 12245
// Dependencies: [12245, 12246, 12240]
...
const obj = {
  ...
  getErrorCorrectPolynomial(diff) {
    const tmp = new require(12245) /* QRPolynomial */([1], 0);
    ...
    if (0 < diff) {
      do {
        ...
        let tmp5 = require(12245) /* QRPolynomial */;
        let obj2 = require(12246);
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (require(12240).MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(12240).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(12240).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(12240).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (require(12240).MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(12240).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(12240).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(12240).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (require(12240).MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(12240).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(12240).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(12240).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
