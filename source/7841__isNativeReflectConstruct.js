...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 7842, 7843, 7844, 7845, 7849, 7850, 7851, 7861]
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(7843)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(7844)(tmp, tmp, this);
      ...
      if (transform) {
        ...
        tmp.transform = self(7845).extractTransformSvgView(tmp);
        const obj3 = self(7845);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(7850)({ viewBox, preserveAspectRatio }));
      obj.children = jsx(importDefault(7851), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(7849), {});
    }
  }
];
