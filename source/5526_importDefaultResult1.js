...
// Dependencies: [32, 109, 19, 17, 21, 5439, 5440, 5459, 5499, 5495]
// Exports: FlatList

// Module 5526 (importDefaultResult1)
...
export const FlatList = (ref) => {
  ...
  for (const item10028 of entries) {
    ...
    let NativeWrapperProps = require(5495) /* isGestureEnabled */.NativeWrapperProps;
    let tmp12 = first1;
    let tmp13 = tmp9;
