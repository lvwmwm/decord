...
// Dependencies: [7737, 7738, 7745, 7746, 7747]

// Module 7744 (addNonEnumerableProperty)
const require = arg1;
...
function addNonEnumerableProperty(arg0, arg1, arg2) {
  try {
    ...
    if (require(7737) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = require(7746) /* _htmlElementAsString */.htmlTreeAsString(arg0);
      const tmp2Result = require(7746) /* _htmlElementAsString */;
    } else {
      const _Object = Object;
...
arg5.extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return require(7747) /* isMatchingPattern */.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = require(7747) /* isMatchingPattern */.truncate(joined, num);
          const obj2 = require(7747) /* isMatchingPattern */;
        }
