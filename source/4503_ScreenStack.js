...
export default function ScreenStack(arg0) {
  ...
  const context = React.useContext(_require(4504).GHContext);
  let obj = {
  ...
  ref2(4488)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4488)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  obj = { value: ref };
  ...
  const tmp5 = _require;
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4492).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = mapped;
  obj1.children = jsx(ref2(4505), Object.assign({}, tmp, obj2));
  obj.children = <context gestureDetectorBridge={ref2} goBackGesture={goBackGesture} transitionAnimation={transitionAnimation} />;
  return jsx(tmp5(4504).RNSScreensRefContext.Provider, { value: ref });
};
