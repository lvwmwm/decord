...
// Function ID: 7453
// Name: addHandler
// Dependencies: [7453, 7454, 7457]

// Module 7452 (addHandler)
const require = arg1;
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (require(7453) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
          const logger = tmp19(7454).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(7457).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(7457);
        }
      }
    }
