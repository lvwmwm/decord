...
// Dependencies: [1606, 5357]

// Module 5360 (cancelAnimation)
try {
  ...
  if (!setGestureState) {
    const fn = function t() {
      console.warn(require(5357) /* toArray */.tagMessage("Please use newer version of react-native-reanimated in order to control state of the gestures."));
    };
