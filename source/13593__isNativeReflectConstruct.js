...
// Dependencies: [6, 7, 15, 17, 18, 31, 33, 13594, 13597, 4517]
// Exports: default

// Module 13593 (_isNativeReflectConstruct)
...
export default function ReanimatedScreenProvider(children) {
  return jsx(require(4517) /* Animated */.ScreenContext.Provider, { value: closure_9, children: children.children });
};
