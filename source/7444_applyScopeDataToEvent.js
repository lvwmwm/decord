...
// Dependencies: [7419, 7400, 7399, 7430]

// Module 7444 (applyScopeDataToEvent)
const require = arg1;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  const dropUndefinedKeysResult3 = require(7400) /* addNonEnumerableProperty */.dropUndefinedKeys(contexts);
...
arg5.mergeAndOverwriteScopeData = function mergeAndOverwriteScopeData(arg0, arg1, arg2) {
  arg0[arg1] = require(7419) /* merge */.merge(arg0[arg1], arg2, 1);
};
arg5.mergeScopeData = function mergeScopeData(extra) {
  ...
  let obj = require(7419) /* merge */;
  extra.extra = obj.merge(extra.extra, extra, 1);
  extra.tags = require(7419) /* merge */.merge(extra.tags, tags, 1);
  const obj2 = require(7419) /* merge */;
  extra.user = require(7419) /* merge */.merge(extra.user, user, 1);
  const obj3 = require(7419) /* merge */;
  extra.contexts = require(7419) /* merge */.merge(extra.contexts, contexts, 1);
  const obj4 = require(7419) /* merge */;
  extra.sdkProcessingMetadata = require(7419) /* merge */.merge(extra.sdkProcessingMetadata, sdkProcessingMetadata, 2);
  if (level) {
    extra.level = level;
  }
  if (transactionName) {
