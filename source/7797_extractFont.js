...
// Function ID: 7798
// Name: extractFont
// Dependencies: [19, 21, 7791, 7796]
// Exports: default, setTSpan

// Module 7797 (extractFont)
import "noop";
...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(7791) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "string") {
    ...
    obj[7] = importDefault(7796)(tmp);
    obj[8] = importDefault(7796)(tmp2);
    obj[9] = importDefault(7796)(tmp3);
    obj[10] = importDefault(7796)(tmp4);
    obj[11] = importDefault(7796)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
