...
// Dependencies: [6429, 6409, 6430, 6389, 6393, 6365, 6422]

// Module 6428 (createTransport)
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(6409).envelopeItemTypeToDataCategory(arg1);
        const obj = items(6409);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: null };
          obj[0] = items(6409).serializeEnvelope(dependencyMap);
          const obj2 = items(6409);
          ...
          if (arg0 instanceof items(6422).SentryError) {
