...
export const SafeAreaProvider = function SafeAreaProvider(arg0) {
  ...
  if (null == context1) {
    let obj = { "Null": false, "Null": true, width: store.get("window").width, height: store.get("window").height };
    context1 = obj;
  }
