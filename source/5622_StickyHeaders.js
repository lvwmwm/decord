...
// Function ID: 5623
// Name: StickyHeaders
// Dependencies: [5569, 19, 21, 5619, 5623, 5584]
// Exports: StickyHeaders

// Module 5622 (StickyHeaders)
...
export const StickyHeaders = (stickyHeaderIndices) => {
  ...
  tmp3Result = tmp3(() => {
    ...
    if (-1 !== currentStickyIndex) {
      tmpResult = null;
      if (tmp4 < data.length) {
        const obj1 = { index: null, item: null, renderItem: null, layout: null, refHolder: null, extraData: null, trailingItem: "accessible", target: "y", hidden: "DateParser", inverted: "archiveAt" };
        obj1[0] = tmp4;
        obj1[1] = tmp6[tmp4];
        obj1[2] = renderItem;
