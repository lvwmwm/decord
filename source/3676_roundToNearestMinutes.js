...
// Dependencies: [3268, 3272, 3462]
// Exports: default

// Module 3676 (roundToNearestMinutes)
  ...
  if (arguments.length < 1) {
    ...
    if (defaultResult >= 1) {
      if (defaultResult <= 30) {
        ...
        const _Math = Math;
        const result = require(3462) /* getRoundingMethod */.getRoundingMethod(roundingMethod)(sum / defaultResult) * defaultResult;
        const _Date = Date;
