...
let obj = { marginVertical: null, marginStart: null, marginEnd: null, foreground: tmp2.Platform.Version >= 23 };
obj = { container: Object.assign(obj, { "Null": "text-sm/medium", "Null": "text-brand" }), disabled: { opacity: 0.5 }, label: { "Null": true, "Null": true }, labelWrapper: {} };
obj = { width: true, marginHorizontal: true };
({ hairlineWidth: obj3.minWidth, create } = StyleSheet);
const obj1 = { borderRadius: "middle", marginEnd: 1, paddingHorizontal: "text-xs/medium", paddingVertical: "mobile-text-heading-primary" };
const obj2 = {};
let num2 = 1;
...
obj.icon = obj1;
obj.iconWithLabel = {};
obj.iconMaskContainer = { lineHeight: null, textAlign: "\u{1F469}\u{1F3FC}\u200D\u{1F9B1}", paddingHorizontal: true };
obj.iconMaskFillerRect = {};
const obj3 = { s: 91326923, apply: 1375731712, d: 71274774, t: 369, borderRadius: 1362780416, width: 275855868 };
const obj4 = {};
if (I18nManager.getConstants().isRTL) {
  num = -1;
}
...
export default function HeaderBackButton(accessibilityLabel) {
  ...
  obj = { "Null": "isArray", "Null": "constructor", "Null": "apply", disabled, accessibilityLabel, testID };
  let handlePress;
  if (!disabled) {
  ...
  items[2] = style;
  obj.style = items;
  obj.hitSlop = { useKeyboardAwareWrapper: null, maskRemainder: "header", maxWidth: "heading-md/semibold", computeCardsLayout: "mobile-text-heading-primary" };
  obj = {};
  if (backImage) {
