...
// Dependencies: [7844, 7845, 7846]

// Module 7843 (appendTransformProps)
const require = arg1;
...
function appendTransformProps(arg0) {
  ...
  require(7844) /* append */.appendTransform(x + originX, y + originY, scaleX, scaleY, rotation, skewX, skewY, originX, originY);
}
...
function transformToMatrix(arg0, arr) {
  ...
  const obj = require(7844) /* append */;
  return require(7844) /* append */.toArray();
}
arg5.default = function extractTransform(arr) {
  ...
  if (typeof arr === "string") {
    try {
      const parsed = require(7845) /* peg$SyntaxError */.parse(arr);
      const items = [, , , , , ];
      ...
      const _console = tmp.console;
      _console.error(tmp6);
      return require(7844) /* append */.identity;
    }
  } else {
    let transform;
    if (arr != null) {
...
arg5.extractTransformSvgView = function extractTransformSvgView(transform) {
  if (typeof transform.transform === "string") {
    transform = require(7846) /* peg$SyntaxError */.parse(transform.transform);
    const obj = require(7846) /* peg$SyntaxError */;
  } else {
