...
// Module 5557 (transformPinchProps)
const require = arg1;
...
arg5.usePinchGesture = function usePinchGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(5535) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformPinchProps);
  const obj = require(5535) /* isGestureEnabled */;
  return require(5550) /* useGesture */.useGesture(require(5526) /* ComposedGestureName */.SingleGestureName.Pinch, clonedAndRemappedConfig);
};
