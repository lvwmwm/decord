...
export default function defineDataProperty(arg0, arg1, value) {
  if (arg0) {
    ...
    const tmp13 = !require(519);
    let tmp14 = !tmp13;
    if (!tmp13) {
      tmp14 = require(519)(arg0, arg1);
    }
    if (require(541)) {
      let obj = {};
      if (null === tmp9) {
    ...
    tmp10 = arguments.length > 6 && arguments[6];
  }
  let tmp64 = require(518);
