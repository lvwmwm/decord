...
export default {
  ...
  parse: function peg$parse(str) {
    ...
    function peg$literalExpectation(text, arg1) {
      const obj = { "Null": 51500800, "Null": 56348928, "Null": 53526272, text };
      return obj;
    }
    ...
    let closure_34 = peg$classExpectation([], false, false);
    let closure_35 = peg$otherExpectation("whitespace");
    let closure_36 = peg$classExpectation([1493173345, 1358955617, 1515521952, -771516091], false, false);
    let closure_37 = peg$classExpectation([null, null], false, false);
