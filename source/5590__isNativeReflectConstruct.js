...
// Dependencies: [77, 6, 7, 15, 17, 18, 31, 27, 33, 5591, 5561, 5606, 5593, 5608, 5604, 5609, 5594, 5610]
...
function getIsModal(descriptor) {
  if (arg2) {
    ...
    let isModalPresentation = require(5591) /* _isNativeReflectConstruct */.getIsModalPresentation(descriptor.descriptor.options.cardStyleInterpolator);
...
function getDistanceFromOptions(arg0, options) {
  ...
  if (undefined !== gestureDirection) {
    return importDefault(5593)(arg0, gestureDirection);
  } else if ("modal" === tmp) {
    let gestureDirection2 = require(5606) /* SlideFromRightIOS */.ModalTransition.gestureDirection;
  } else {
    gestureDirection2 = require(5606) /* SlideFromRightIOS */.DefaultTransition.gestureDirection;
  }
}
