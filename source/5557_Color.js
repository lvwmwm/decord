...
class Color {
  constructor(arg0, arg1) {
    ...
    if (this instanceof Color) {
        ...
        if (global instanceof Color) {
          ...
          if ("string" === tmp18) {
            ...
            if (null === iter) {
              ...
              value = iter.value;
              num13 = 0;
              self.color = require("get ActivityIndicator");
              num14 = 1;
              str8 = "number";
      ...
      num18 = 1;
      num19 = 0;
      self.valpha = require("get ActivityIndicator");
      _Object = Object;
      if (Object.freeze) {
        _Object2 = Object;
...
while (iter !== undefined) {
  ...
  let _moduleResult = _createForOfIteratorHelperLoose(require("keys")[nextResult].labels);
...
obj = {
  ...
  string(arg0) {
    ...
    if (1 === roundResult.valpha) {
      ...
      color = items.concat(_createForOfIteratorHelperLoose(roundResult.color), items1);
    }
  ...
  array() {
    const self = this;
    if (1 === this.valpha) {
      let combined = _createForOfIteratorHelperLoose(self.color);
    } else {
      const items = [];
      const items1 = [self.valpha];
      combined = items.concat(_createForOfIteratorHelperLoose(self.color), items1);
    }
    return combined;
  },
  object() {
  ...
  round(arg0) {
    ...
    const items1 = [self.valpha];
    return new Color(items.concat(_createForOfIteratorHelperLoose(color.map(function roundToPlace(arg0) {
  ...
  alpha(self, arg1) {
    ...
    if (undefined !== self) {
      ...
      let valpha = new Color(items.concat(_createForOfIteratorHelperLoose(self.color), items1), self.model);
      const tmp3 = _createForOfIteratorHelperLoose(self.color);
    } else {
      valpha = self.valpha;
    }
    return valpha;
  ...
  luminosity() {
    ...
    while (tmp2 !== undefined) {
      let tmp4 = get_ActivityIndicator;
      let tmp5 = get_ActivityIndicator(tmp3, 2);
