...
// Dependencies: [41, 42, 93, 95, 98, 9069, 9070]
// Exports: Chi, Maj
...
let items = [
  {
    ...
    value: function update(B) {
      ...
      let view;
      const self = this;
      HashMD(9070).exists(this);
      ({ buffer, blockLen, view } = this);
      const toBytesResult = HashMD(9069).toBytes(B);
      let num = 0;
  ...
  },
  {
    ...
    value: function digestInto(content) {
      ...
      const self = this;
      HashMD(9070).exists(this);
      HashMD(9070).output(content, this);
      this.finished = true;
      ...
      if (typeof view.setBigUint64 === "error") {
      ...
      self.process(view, 0);
      view = HashMD(9069).createView(content);
