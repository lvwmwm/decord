...
// Function ID: 3683
// Name: _typeof
// Dependencies: [3626, 3613, 3380, 3630, 3625, 3543, 3384, 3381, 3385, 3683, 3627, 3684]
// Exports: default
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  tmp3 = dependencyMap;
  const defaultOptions = _require(3385).getDefaultOptions();
  locale = undefined;
  if (null != locale) {
        ...
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              ...
              obj[2] = locale;
              const dateToSystemTimezoneSetter = new tmp2(3683).DateToSystemTimezoneSetter();
