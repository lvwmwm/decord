...
// Dependencies: [19, 17, 7886, 7958, 7888]
// Exports: default

// Module 7957 (offsetComparator)
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
      ...
      while (true) {
        ...
        if (typeof tmp10 === "number") {
          ...
          if (!isNaN(num9)) {
            ...
            let items1 = [num9, 16777215 & tmp10 | Math.round(255 * importDefault(7886)(stopOpacity)) << 24];
    ...
    if (gradientUnits) {
      num12 = importDefault(7958)[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
    ...
    obj[4] = importDefault(7888)(gradientTransform);
    return obj;
  } else {
    return null;
  }
