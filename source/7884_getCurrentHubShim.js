...
// Dependencies: [7803, 7824, 7849]

// Module 7884 (getCurrentHubShim)
...
function getCurrentHubShim() {
  return {
    bindClient(arg0) {
      const currentScope = callback(7803).getCurrentScope();
      currentScope.setClient(arg0);
    },
    withScope: getClient.withScope,
    getClient() {
      return callback(7803).getClient();
    },
    ...
    getIntegration(id) {
      const client = callback(7803).getClient();
