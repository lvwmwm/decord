...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 7783, 7791, 7797, 7790, 7878, 7874, 7799]
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (tmp5) {
        ...
        obj[6] = midLine;
        const merged = Object.assign(withoutXYResult, importDefault(7797)(obj, true), obj);
        withoutXYResult.ref = self.refMethod;
        obj1 = {};
        const merged1 = Object.assign(withoutXYResult);
        return jsx(importDefault(7878), {});
      } else {
        ...
        obj[1] = children;
        return jsx(importDefault(7874), { ref: null, children: null });
      }
