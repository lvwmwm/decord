...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(7917) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "string") {
    ...
    obj[7] = importDefault(7922)(tmp);
    obj[8] = importDefault(7922)(tmp2);
    obj[9] = importDefault(7922)(tmp3);
    obj[10] = importDefault(7922)(tmp4);
    obj[11] = importDefault(7922)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
