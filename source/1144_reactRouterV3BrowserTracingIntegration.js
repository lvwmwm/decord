  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f101933 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f101933, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f113703 = (name) => {
            ...
            obj[f101933(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            const result = obj.startBrowserTracingNavigationSpan(f113703, obj);
          };
