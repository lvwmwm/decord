  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f101945 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f101945, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f113713 = (name) => {
            ...
            obj[f101945(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            const result = obj.startBrowserTracingNavigationSpan(f113713, obj);
          };
