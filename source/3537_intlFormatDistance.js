...
// Dependencies: [3406, 3430, 3431, 3433, 3434, 3436, 3441, 3447, 3244, 3245, 3423]
// Exports: default

// Module 3537 (intlFormatDistance)
...
export default function intlFormatDistance(defaultResult1, defaultResult1, unit) {
  ...
  if (absolute < require(3423) /* keys */.secondsInMinute) {
    ...
    if (absolute1 < require(3423) /* keys */.secondsInHour) {
      ...
      if (absolute3 < require(3423) /* keys */.secondsInWeek) {
        num2 = differenceInCalendarDays.default(defaultResult1, defaultResult2);
        if (num2) {
          const _Math3 = Math;
          str = "day";
      ...
      if (absolute4 < require(3423) /* keys */.secondsInMonth) {
        num2 = differenceInCalendarWeeks.default(defaultResult1, defaultResult2);
        str = "week";
      } else {
        const _Math8 = Math;
        const absolute5 = Math.abs(defaultResult3);
        if (absolute5 < require(3423) /* keys */.secondsInQuarter) {
          num2 = differenceInCalendarMonths.default(defaultResult1, defaultResult2);
          str = "month";
        } else {
          const _Math5 = Math;
          const absolute6 = Math.abs(defaultResult3);
          if (absolute6 < require(3423) /* keys */.secondsInYear) {
