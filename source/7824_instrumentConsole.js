...
// Dependencies: [7736, 7739, 7738, 7744]

// Module 7824 (instrumentConsole)
const require = arg1;
const dependencyMap = arg6;
function instrumentConsole() {
  if ("console" in require(7739) /* getGlobalSingleton */.GLOBAL_OBJ) {
    const CONSOLE_LEVELS = require(7738) /* consoleSandbox */.CONSOLE_LEVELS;
...
arg5.addConsoleInstrumentationHandler = function addConsoleInstrumentationHandler(arg0) {
  require(7736) /* addHandler */.addHandler("console", arg0);
  const obj = require(7736) /* addHandler */;
  require(7736) /* addHandler */.maybeInstrument("console", instrumentConsole);
};
