...
// Function ID: 100255
// Name: outside
// Dependencies: [12883, 12912, 12903, 12908, 12904, 12907, 12914, 12911]

// Module 12920 (outside)
...
export default function outside(arg0, arg1, arg2, arg3) {
  ...
  require = tmp;
  let tmp3 = require(12912) /* Range */;
  tmp3 = new tmp3(arg1, arg3);
  const dependencyMap = tmp3;
  if (">" === arg2) {
    let closure_3 = require(12903) /* gt */;
    let closure_4 = require(12908) /* lte */;
    let closure_5 = require(12904) /* lt */;
    let c6 = ">";
    let c7 = ">=";
  } else if ("<" === arg2) {
    closure_3 = require(12904) /* lt */;
    closure_4 = require(12907) /* gte */;
    closure_5 = require(12903) /* gt */;
    c6 = "<";
    c7 = "<=";
  } else {
  ...
  if (require(12914) /* satisfies */(tmp, tmp3, arg3)) {
    return false;
  } else {
    let num7 = 0;
    num7 = 0;
