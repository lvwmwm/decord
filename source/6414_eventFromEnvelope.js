...
// Dependencies: [65, 57, 5, 6391, 6394, 6401]
// Exports: makeMultiplexedTransport

// Module 6414 (eventFromEnvelope)
...
function eventFromEnvelope(arg0, arg1) {
  const _require = arg1;
  _require(6391).forEachEnvelopeItem(arg0, (arg0, arg1) => {
    ...
    function getTransport(arg0, assign) {
      ...
      if (value) {
        ...
        if (dsnFromStringResult) {
          let envelopeEndpointWithUrlEncodedAuth = lib(6401).getEnvelopeEndpointWithUrlEncodedAuth(dsnFromStringResult, lib.tunnel);
          let tmp11 = lib;
          obj = globalThis;
          if (assign) {
            ...
            let tmp11Result = (function makeOverrideReleaseTransport(arg0, assign) {
              ...
              return (arg0) => {
                ...
                let closure_1 = tmp;
                const obj = {};
                callback = outer4_4(/* F57508 */ function*() { ... });
