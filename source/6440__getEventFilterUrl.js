...
// Dependencies: [6421, 6393, 6365, 6376, 6374]

// Module 6440 (_getEventFilterUrl)
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (require(6393) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + tmp6(6376).getEventDescription(tmp));
      const tmp6Result = tmp6(6376);
    }
    return null;
  }
}
