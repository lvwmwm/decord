...
// Dependencies: [1257, 13202, 13225, 13220, 13226, 13222]
// Exports: default

// Module 13224 (partitionNumberIntoParts)
...
function partitionNumberIntoParts(currencyGroup, arg1, arg2, arg3, arg4, arg5, arg6, arg7, roundingIncrement, result) {
  ...
  if (roundedNumber.isNaN()) {
    ...
    const tmp4 = require(13226).digitMapping[arg4];
    require = tmp4;
    ...
    if (undefined === substr1) {
      if ("scientific" === arg2) {
        if (roundedNumber.isFinite()) {
          ...
          const obj5 = { type: "exponentInteger", value: require(13222) /* __exportStarResult28 */.ToRawFixed(_default, 0, 0, roundingIncrement, result).formattedString };
          items.push(obj5);
        }
      }
      return items;
...
const regExp = new RegExp("^".concat(require("module_13225").S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(require("module_13225").S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
    ...
    do {
      ...
      if (str22) {
        if ("{0}" === str22) {
          ...
          let tmp50 = first2;
          let tmp51 = style;
          let applyResult = push2.apply(items, tmp39(tmp29, magnitude, notation, exponent, numberingSystem, tmp40, first2, style, currencyDisplay.roundingIncrement, require(13220) /* __exportStarResult22 */.GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp30)));
          tmp32 = tmp31;
        } else if ("-" === str22) {
