...
// Function ID: 8579
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1500, 1631, 5277, 8579, 4650, 8580, 8582, 8583, 8584, 8585]
// Exports: NativeStackView

// Module 8578 (StyleSheet)
...
function SceneView(arg0) {
  ...
  callback = obj2.useCallback(num6(8579).debounce(tmp18, 100), []);
  ...
  let eventResult;
  const headerConfigProps = num6(8580).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  obj4[52] = closure_10(num6(8582).AnimatedHeaderHeightContext.Provider, obj7);
