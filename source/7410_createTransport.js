...
// Dependencies: [7411, 7391, 7412, 7371, 7375, 7347, 7404]

// Module 7410 (createTransport)
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(7391).envelopeItemTypeToDataCategory(arg1);
        const obj = items(7391);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: null };
          obj[0] = items(7391).serializeEnvelope(dependencyMap);
          const obj2 = items(7391);
          ...
          if (arg0 instanceof items(7404).SentryError) {
