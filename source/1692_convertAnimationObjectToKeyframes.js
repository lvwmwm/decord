...
// Dependencies: [32, 1693]
// Exports: convertAnimationObjectToKeyframes

// Module 1692 (convertAnimationObjectToKeyframes)
  ...
  while (tmp2 !== undefined) {
    ...
    for (const item10063 of entries1) {
      ...
      if ("easing" !== first) {
        ...
        let tmp40 = arr;
        if (arr in _require(1693).WebEasings) {
          str = arr;
        } else if (arr.name in tmp38(1693).WebEasings) {
          let tmp19 = arr;
          str = arr.name;
        }
        let tmp20 = _require;
        let tmp21 = str;
        let str2 = tmp38(1693).WebEasings[str];
