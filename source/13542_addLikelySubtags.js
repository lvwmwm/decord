...
// Dependencies: [1281, 13543, 13544, 13608, 13615, 13620, 13635, 13636]

// Module 13542 (addLikelySubtags)
import e from "e";
...
function addLikelySubtags(locale) {
  ...
  let script;
  let variants;
  const parseUnicodeLocaleIdResult = require(13608) /* isStructurallyValidLanguageTag */.parseUnicodeLocaleId(locale);
