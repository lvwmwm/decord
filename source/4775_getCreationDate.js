...
const obj5 = {
  <string:1370119266>: "By-line",
  <string:979455634>: true,
  description(value) {
...
arg5.default = {
  iptc: {
    [256]: obj,
    [261]: { <string:1370119266>: "Reference Number", <string:979455634>: true },
    [276]: obj,
    [278]: obj,
    ...
    [524]: obj5,
    [532]: { <string:1370119266>: "By-line Title", <string:979455634>: true },
    [537]: { <string:1370119266>: "Contact", <string:979455634>: true },
    [538]: { <string:1370119266>: "Writer/Editor", <string:979455634>: true },
    [539]: { <string:1370119266>: "USER_CONNECTIONS_UPDATE", <string:979455634>: true },
    [554]: {
      name: "Action Advised",
      description(value) {
        const stringValue = arg1(arg6[0]).getStringValue(value);
    ...
    [557]: { <string:1370119266>: "key", <string:979455634>: "Text" },
    [559]: { <string:1370119266>: "/assets/images/provisional_account_avatars", <string:979455634>: 320 },
    [562]: { <string:1370119266>: true, <string:979455634>: null },
    ...
    [592]: { <string:1370119266>: "/assets/images/group_dms", <string:979455634>: 96 },
    [597]: {},
    [630]: { <string:1370119266>: 900, <string:979455634>: 45 },
    [634]: {},
    [637]: {
    ...
    [713]: {
      ...
      description(value, ObjectData Preview File Format) {
        const obj = { "00": { "00": "1" }, "01": {}, "02": { "04": "4" }, "03": { 0: "isArrayBuffer", 9223372036854775807: "CONSOLES_DEVICES" }, "04": { "01": "1.40" }, "05": { "01": "2" }, "06": { "01": "1" }, [11]: { "01": "1.02" }, [20]: { overflow: true, flex: "no-hide-descendants", alignSelf: null, marginBottom: "Mastodon" }, [21]: { "02": "2.0" } };
