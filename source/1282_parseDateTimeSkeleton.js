  ...
  const replaced = str.replace(obj, (arg0) => {
    ...
    switch (str) {
      ...
      case "DateParser":
        ...
        throw rangeError3;
      case "at":
        _RangeError3 = new _RangeError3("`b/B` (period) patterns are not supported, use `a` instead");
        throw _RangeError3;
      case "te":
        _RangeError6 = RangeError;
        rangeError3 = new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");
      ...
      case "na":
        ...
        let rangeError6 = new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");
        throw rangeError6;
      case "al":
      break;
      case "CardA11yWrapper":
        _RangeError2 = RangeError;
        rangeError6 = new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");
        throw rangeError6;
      ...
      break;
      case "Component":
        let rangeError7 = new RangeError("`S/A` (second) patterns are not supported, use `s` instead");
        throw rangeError7;
      case "om":
      break;
      case "mp":
        rangeError7 = new RangeError("`S/A` (second) patterns are not supported, use `s` instead");
        throw rangeError7;
      case "po":
      break;
      case "pon":
