...
// Dependencies: [31, 5251, 9716]
// Exports: usePanGestureProxy

// Module 9715 (usePanGestureProxy)
...
export const usePanGestureProxy = function usePanGestureProxy(onConfigurePanGesture) {
  ...
  const tmp = onGestureUpdate(() => {
    ...
    pnpm_usePanGestureProxyTs2.__closure = { onGestureStart: obj, userDefinedConflictGestures: obj };
    pnpm_usePanGestureProxyTs2.__workletHash = 2969501037173;
    pnpm_usePanGestureProxyTs2.__initData = outer1_4;
    const obj1 = { onGestureStart: obj, userDefinedConflictGestures: obj };
    ...
    pnpm_usePanGestureProxyTs3.__initData = outer1_5;
    ...
    pnpm_usePanGestureProxyTs4.__initData = outer1_6;
    ...
    pnpm_usePanGestureProxyTs5.__initData = outer1_7;
