...
// Function ID: 4675
// Name: ScreenStack
// Dependencies: [109, 19, 21, 4659, 4675, 4653, 4660, 4676, 4663]
// Exports: default

// Module 4674 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_require(4675).GHContext);
  obj = {
  ...
  ref2(4659)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4659)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4663).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = mapped;
  obj1[6] = jsx(ref2(4676), {});
  ...
  return jsx(tmp4(4675).RNSScreensRefContext.Provider, { value: ref, children: null });
};
