...
function getMessageForObject(name) {
  ...
  const result = require(6317) /* addNonEnumerableProperty */.extractExceptionKeysForMessage(name);
...
function getException(getOptions, arg1, arg2, syntheticException) {
  if (obj.isError(arg2)) {
    ...
    if (obj2.isPlainObject(arg2)) {
      ...
      const tmp13 = _defineProperty({}, "__serialized__", require(6356) /* normalize */.normalizeToSize(arg2, normalizeDepth));
      let tmp16;
      ...
      const obj3 = require(6356) /* normalize */;
    } else {
      if (syntheticException) {
    ...
    if (tmp) {
      if (tmp.syntheticException) {
        ...
        if (arr.length) {
          ...
          const result = require(6322) /* getFirstException */.addExceptionMechanism(obj, obj2);
          const obj5 = require(6322) /* getFirstException */;
        }
      }
    }
  }
...
export const eventFromUnknownInput = function eventFromUnknownInput(arg0, arg1, arg2, data) {
  ...
  const result = require(6322) /* getFirstException */.addExceptionTypeValue(obj, undefined, undefined);
  const obj4 = require(6322) /* getFirstException */;
  const result1 = require(6322) /* getFirstException */.addExceptionMechanism(obj, data);
  const obj1 = {};
  let event_id = data;
  if (data) {
