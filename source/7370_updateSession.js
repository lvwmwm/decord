...
// Function ID: 7371
// Name: updateSession
// Dependencies: [7346, 7347, 7371, 7361, 7358, 7353]
// Exports: closeSession, makeSession

// Module 7370 (updateSession)
...
function updateSession(ipAddress) {
  ...
  if (!timestamp) {
    timestamp = require(7361) /* dateTimestampInSeconds */.timestampInSeconds();
    const obj2 = require(7361) /* dateTimestampInSeconds */;
  }
  ...
  if (!obj.sid) {
    ...
    if (32 === obj.sid.length) {
      ...
      sid = require(7358) /* addContextToFrame */.uuid4();
