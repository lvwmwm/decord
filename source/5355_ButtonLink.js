...
// Function ID: 5356
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1500, 5347, 5356, 5357]
// Exports: Button

// Module 5355 (ButtonLink)
import "noop";
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    const obj4 = importDefault(5347)(color);
    str3 = importDefault(5347)(color).fade(0.85).string();
    tmp5 = color;
    const fadeResult = importDefault(5347)(color).fade(0.85);
  } else if ("filled" === str) {
    let str4 = "white";
    if (!obj10.isDark()) {
      const obj2 = tmp9(5347)(color);
      str4 = tmp9(5347)(color).darken(0.71).string();
      const darkenResult = tmp9(5347)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
    obj10 = importDefault(5347)(color);
    tmp9 = importDefault;
  }
  obj = {};
  const merged1 = Object.assign(merged);
  obj = { radius: 40, color: null };
  const obj8 = importDefault(5347)(tmp5);
  obj[1] = importDefault(5347)(tmp5).fade(0.85).string();
  ...
  obj.children = jsx(require(5357) /* Text */.Text, { style: items1, children });
  return jsx(require(5356) /* Animated */.PlatformPressable, { radius: 40, color: null });
}
