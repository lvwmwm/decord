...
// Function ID: 9177
// Name: QRCodeSvg
// Dependencies: [9173, 19, 7901]

// Module 9176 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(7901) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(7901) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(7901) /* inlineStyles */.Path, { d, fill }));
});
