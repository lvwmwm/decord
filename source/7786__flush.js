...
// Function ID: 7787
// Name: _flush
// Dependencies: [5, 7765, 7787, 7766, 7738, 7749, 7752, 7745, 7775, 7739, 7761]
...
function endSession() {
  const isolationScope = require(7765) /* getClient */.getIsolationScope();
  const obj = require(7765) /* getClient */;
  ...
  const tmpResult1 = require(7765) /* getClient */;
...
export const captureException = function captureException(arg0, arg1) {
  const currentScope = require(7765) /* getClient */.getCurrentScope();
  const obj = require(7765) /* getClient */;
  return currentScope.captureException(arg0, require(7787) /* applyClientOptions */.parseEventHintOrCaptureContext(arg1));
};
...
export const captureSession = function captureSession() {
  ...
  if (flag) {
    ...
    const obj5 = require(7765) /* getClient */;
  }
};
...
export const isInitialized = function isInitialized() {
  return require(7765) /* getClient */.getClient();
};
...
export const startSession = function startSession(arg0) {
  ...
  const obj5 = require(7765) /* getClient */;
  const userAgent = require(7739) /* getGlobalSingleton */.GLOBAL_OBJ.navigator || {}.userAgent;
  let tmpResult = tmp(7761);
  obj = { release, environment, user: null };
  const tmp3 = require(7739) /* getGlobalSingleton */.GLOBAL_OBJ.navigator || {};
...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  function finishCheckIn(status) {
    ...
    const client = monitorSlug(7765).getClient();
    if (client) {
      if (client.captureCheckIn) {
  ...
  let currentScope = _require(7765).getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = _require(7765);
  let client = _require(7765).getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = _require(7765);
  captureCheckInResult = _require(7749).uuid4();
};
