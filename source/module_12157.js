// Module ID: 12157
// Function ID: 12158
// Dependencies: [5, 12091, 12154, 12158, 12159, 12160, 12153]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, message) {
      ...
      const util = _require(12091).util;
    ...
    let closure_8 = fn(require("module_12158"));
    let closure_9 = fn(require("module_12159"));
    let closure_10 = fn(require("module_12160"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12153).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12153).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12153).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
