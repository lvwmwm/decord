...
arg5.default = function getNativeComponentAttributes(arg0) {
  ...
  if (null == viewManagerConfig) {
    ...
    while (baseModuleName) {
      ...
      let _default2 = require(68) /* measure */.default;
    ...
    for (const key10063 in tmp6) {
      ...
      if ("CATransform3D" === tmp96) {
        ...
        _default = require(77) /* matricesDiffer */.default;
      } else {
        if ("CGPoint" !== tmp96) {
          if ("Point" !== tmp96) {
            if ("CGSize" === tmp96) {
              ...
              _default = require(64) /* sizesDiffer */.default;
            } else if ("UIEdgeInsets" === tmp96) {
              let tmp36 = require;
              let tmp37 = dependencyMap;
              _default = require(79) /* insetsDiffer */.default;
            } else {
              _default = null;
            }
          }
        ...
        _default = require(78) /* pointsDiffer */.default;
      }
      let tmp44 = require;
      let tmp45 = dependencyMap;
      let _default3 = require(57) /* getValidLengthPercentageSizeOrNull */.default;
      while (true) {
        if (null == _default) {
    ...
    obj2.style = require(26) /* result */.default;
    ...
    const constants = require(68) /* measure */.default.getConstants();
    ...
    const _default4 = require(68) /* measure */.default;
    const obj14 = require(70) /* nullthrows */(require(68) /* measure */.default.getDefaultEventTypes)();
    if (obj14) {
    ...
    const tmp47Result = require(70) /* nullthrows */;
  }
};
