...
// Dependencies: [41, 42, 7404, 7399]

// Module 7427 (SentryNonRecordingSpan)
...
const items = [
  {
    ...
    value: function spanContext() {
      return { spanId: this._spanId, traceId: this._traceId, traceFlags: SentryNonRecordingSpan(7399).TRACE_FLAG_NONE };
    }
  },
  {
    key: "end",
