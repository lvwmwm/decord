...
// Dependencies: [830, 65, 77, 6307, 6310, 6311, 6325, 6335, 6339, 6343, 6393, 6316, 6345, 6326, 6344, 6382, 6328, 6324, 6318]
// Exports: addTracingHeadersToFetchRequest, instrumentFetchRequest

// Module 6416 (_addTracingHeadersToFetchRequest)
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  let baggage;
  let tmp2;
  let obj = require(6382) /* getTraceData */;
  obj = { span };
  ...
  if (tmp2) {
    ...
    if (!headers) {
      ...
      if (isInstanceOfResult) {
        ...
        isInstanceOfResult = require(6318) /* isBuiltin */.isInstanceOf(headers, Request);
        const obj3 = require(6318) /* isBuiltin */;
      }
      let headers1;
      if (isInstanceOfResult) {
    ...
    if (headers) {
      ...
      if (isInstanceOfResult1) {
        ...
        isInstanceOfResult1 = require(6318) /* isBuiltin */.isInstanceOf(headers, Headers);
        const obj4 = require(6318) /* isBuiltin */;
      }
      if (isInstanceOfResult1) {
  ...
  if (endResult.fetchData) {
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              require(6328) /* getSpanStatusFromHttpCode */.setHttpStatus(obj10, endResult.response.status);
              ...
              const obj12 = require(6328) /* getSpanStatusFromHttpCode */;
    ...
    while (true) {
      if (!href) {
        ...
        let num2 = 10;
        let obj1 = require(6393) /* getNumberOfUrlSegments */;
      ...
      let num3 = 11;
      let obj2 = require(6316) /* spanTimeInputToSeconds */;
      ...
      if (hasTracingEnabledResult) {
        if (!tmp19) {
          ...
          let num4 = 12;
          let obj4 = require(6345) /* withActiveSpan */;
          obj = {};
          ...
          let num5 = 13;
          let tmp24 = _defineProperty(obj1, require(6326).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, str);
          let str5 = "http.client";
          obj.attributes = _defineProperty(tmp24, require(6326).SEMANTIC_ATTRIBUTE_SENTRY_OP, "http.client");
        ...
        if (arg2(endResult.fetchData.url)) {
          ...
          let obj9 = require(6343) /* hasTracingEnabled */;
          let tmp33;
      ...
      let num6 = 14;
      let SentryNonRecordingSpan = require(6344) /* SentryNonRecordingSpan */.SentryNonRecordingSpan;
