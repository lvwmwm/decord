...
// Function ID: 7563
// Name: setMeasurement
// Dependencies: [7525, 7548, 7520, 7535]

// Module 7562 (setMeasurement)
const require = arg1;
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (activeSpan) {
    rootSpan = require(7525) /* spanTimeInputToSeconds */.getRootSpan(activeSpan);
    const obj3 = require(7525) /* spanTimeInputToSeconds */;
  }
  if (rootSpan) {
    ...
    obj = {};
    obj[require(7535).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[require(7535).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
