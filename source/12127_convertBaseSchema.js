...
// Dependencies: [57, 65, 12122, 12123, 12121, 12115]

// Module 12127 (convertBaseSchema)
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema($schema, defaultTarget) {
      if ("boolean" === typeof $schema) {
        ...
        if (null == registry) {
          registry = require(12115) /* registry */.globalRegistry;
        }
        obj.registry = registry;
        return convertSchema($schema, obj);
      }
    };
    const fnResult = fn(require("module_12122"));
    let _Object4 = Object;
    obj = { iso: fn(require("module_12123")) };
    let _Object5 = Object;
