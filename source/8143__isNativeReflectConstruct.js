...
// Dependencies: [5, 41, 42, 93, 95, 98, 19, 17, 21, 81, 8144, 4014, 8146, 8147, 8148, 8166]

// Module 8143 (_isNativeReflectConstruct)
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f115113);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f115113);
    ...
    f115113 = undefined;
    f115113 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8146").NONE, require("module_8146").INVERT, require("module_8146").MONOCHROME, require("module_8146").POSTERIZE, require("module_8146").FALSE, require("module_8146").MAXIMUMCOMPONENT, require("module_8146").MINIMUMCOMPONENT, require("module_8146").CHROME, require("module_8146").FADE, require("module_8146").INSTANT, require("module_8146").MONO, require("module_8146").NOIR, require("module_8146").PROCESS, require("module_8146").TONAL, require("module_8146").TRANSFER, require("module_8146").SEPIA];
...
const items4 = [require("module_8147").CLEARKEY, require("module_8147").FAIRPLAY, require("module_8147").WIDEVINE, require("module_8147").PLAYREADY];
...
const items8 = [require("module_8166").SRT, require("module_8166").TTML, require("module_8166").VTT];
...
export const TextTrackType = require("module_8166");
export const FilterType = require("module_8146");
export const DRMType = require("module_8147");
