...
// Module 8003 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (tmp5) {
        ...
        obj[6] = midLine;
        const merged = Object.assign(withoutXYResult, importDefault(7923)(obj, true), obj);
        withoutXYResult.ref = self.refMethod;
        obj1 = {};
        const merged1 = Object.assign(withoutXYResult);
        return jsx(importDefault(8004), {});
      } else {
        ...
        obj[1] = children;
        return jsx(importDefault(8000), { ref: null, children: null });
      }
