...
const obj9 = { y: null, ShakeLocation: null, y: "drl", handleGuildScheduledEventRsvp: "bzc", y: "ebk", SECONDLY: "iba", $$typeof: forResult };
...
if ("function" !== typeof require(dependencyMap[2]).ReactFiberErrorDialog.showErrorDialog) {
  ...
  const _Map = Map;
  const map = new Map();
  const obj11 = { y: "ParentalControlledLegacyExplicitContent", SYSTEM_USER: "UnreadIndicator", y: "isArray", MH: "GUILD_SETTINGS_INVITES_V2", y: "applyFunctionToChildren", currentDispatcherRef: __CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE };
  if (null !== obj8) {
  ...
  exports.render = (arg0, containerTag, arg2, arg3, onUncaughtError) => {
    ...
    if (!value) {
      ...
      tmp25.refCount = tmp25.refCount + 1;
      obj = { "Null": "midnight", "Null": "noon", cache: tmp25 };
