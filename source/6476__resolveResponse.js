...
// Dependencies: [32, 5, 6363, 6477, 6371, 6366, 6379, 6372]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 6476 (_resolveResponse)
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(6363) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(6363) /* addHandler */;
  require(6363) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    const callback = closure_5;
    {
      callback(6371).fill(callback(6366).GLOBAL_OBJ, "fetch", (arg0) => {
        let closure_0 = arg0;
        return () => {
      ...
      const obj = callback(6371);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(6363).addHandler("fetch", arg0);
  let obj = _require(6363);
  _require(6363).maybeInstrument("fetch", () => {
    let flag = callback;
