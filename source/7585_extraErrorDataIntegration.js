...
// Dependencies: [7551, 7502, 7540, 7501, 7504, 7523, 7495]

// Module 7585 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(7523).DEBUG_BUILD) {
                const logger = callback(7495).logger;
