...
// Dependencies: [6335, 6339, 6311, 6318]

// Module 6362 (notifyEventProcessors)
const require = arg1;
...
function notifyEventProcessors(arg0, arg1, arg2) {
  ...
  return new _require(6335).SyncPromise((arg0, arg1) => {
    ...
    if (null !== dependencyMap2) {
      if ("function" === typeof tmp) {
        ...
        if (tmp2) {
          const logger = dependencyMap(6311).logger;
          const _HermesInternal = HermesInternal;
          logger.log("Event processor \"" + tmp.id + "\" dropped event");
        }
        tmp2 = dependencyMap(6339).DEBUG_BUILD && tmp.id && null === tmpResult;
