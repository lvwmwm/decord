...
// Dependencies: [41, 42, 93, 95, 98, 1725, 1724]

// Module 1737 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    value: function springify(durationV) {
      return { durationV, type: ComplexAnimationBuilder(1725).withSpring };
    }
  },
  {
    key: "dampingRatio",
