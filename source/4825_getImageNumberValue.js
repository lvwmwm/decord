...
// Dependencies: [4785, 4800, 4801, 4797, 4780]

// Module 4825 (getImageNumberValue)
const require = arg1;
const module = arg2;
const dependencyMap = arg6;
function getImageNumberValue(value, arg1, typeSize, arg3) {
  if (arg3 === module(4785).LITTLE_ENDIAN) {
    let num7 = 0;
    let num8 = 0;
    let num9 = 0;
    if (0 < typeSize) {
...
function getImageOffset(arg0, value) {
  ...
  if (0 !== arg0) {
    ...
    num = getImageNumberValue(value, result + 8, module(4797).getTypeSize("LONG"), arg2) + arg3;
    const obj = module(4797);
  }
  return num;
}
let c3 = 16;
arg5.default = {
  read(getUint16, sum1) {
    const byteOrder = module(4785).getByteOrder(getUint16, sum1);
    let obj = module(4785);
    let obj2 = require(4800) /* readTag */;
    const ifd = obj2.readIfd(getUint16, require(4801) /* IFD_TYPE_0TH */.IFD_TYPE_MPF, sum1, require(4800) /* readTag */.get0thIfdOffset(getUint16, sum1, byteOrder), byteOrder, arg2);
