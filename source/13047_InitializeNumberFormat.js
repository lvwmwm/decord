...
// Module 13047 (InitializeNumberFormat)
arg5.InitializeNumberFormat = function InitializeNumberFormat(arg0, arg1, arg2, arg3) {
  ...
  obj.localeMatcher = arg1(arg6[2]).GetOption(result1, "localeMatcher", "string", [-1806852539, 688836880], "best fit");
  ...
  const GetOptionResult1 = arg1(arg6[2]).GetOption(result1, "notation", "string", [true, true, true, -19180706683170856], "standard");
  ...
  if ("currency" === style) {
    ...
    if ("compact" === GetOptionResult1) {
      internalSlots.compactDisplay = arg1(arg6[2]).GetOption(result1, "compactDisplay", "string", [-0.00000000000000000000000000000000000000000000019705760091967055, ], "short");
      str6 = "min2";
    }
    internalSlots.useGrouping = arg1(arg6[8]).GetStringOrBooleanOption(result1, "useGrouping", [true, true, true], "always", false, str6);
