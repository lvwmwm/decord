...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = require(12252);
      const glogResult = require(12252).glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - require(12252).glog(getLength.get(0));
