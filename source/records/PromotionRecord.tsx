...
// Dependencies: [1912, 7346, 1384, 2]

// Module 7345 (createFromServer)
import "toJS";
...
PromotionRecord["createFromServer"] = function createFromServer(id) {
  ...
  if (BLOCKLIST == null) {
    BLOCKLIST = require(7346) /* CountryListMode */.CountryListMode.BLOCKLIST;
  }
  obj[17] = BLOCKLIST;
...
Object.defineProperty(prototype, "isBogo", {
  get: function isBogo() {
    return this.promotionType === require(7346) /* CountryListMode */.PromotionTypes.BOGO;
  },
  set: undefined
});
Object.defineProperty(prototype, "isMarketingMoment", {
  get: function isMarketingMoment() {
    return this.promotionType === require(7346) /* CountryListMode */.PromotionTypes.MARKETING_MOMENT;
  },
  set: undefined
});
...
prototype["isCountryRestricted"] = function isCountryRestricted(arg0) {
  const self = this;
  if (this.countryListMode === require(7346) /* CountryListMode */.CountryListMode.ALLOWLIST) {
