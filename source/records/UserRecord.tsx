...
let tmp5 = (importDefaultResult) => {
  class UserRecord {
    constructor(arg0) {
      ...
      obj = { NATIVE_SECTION: true, STOPPED_UNEXPECTEDLY: false, FOURTEEN_DAYS: false };
      ...
      obj1 = { NATIVE_SECTION: true, STOPPED_UNEXPECTEDLY: false, FOURTEEN_DAYS: false };
      obj1.value = function value() {
        return tmp2Result.hasFlag(constants.STAFF);
      };
      obj2 = { NATIVE_SECTION: true, STOPPED_UNEXPECTEDLY: false, FOURTEEN_DAYS: false };
      ...
      obj3 = { NATIVE_SECTION: true, STOPPED_UNEXPECTEDLY: false, FOURTEEN_DAYS: false };
