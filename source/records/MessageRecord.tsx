...
// Function ID: 4032
// Name: hasFlag
// Dependencies: [1931, 676, 1403, 4032, 5026, 7510, 8770, 2]
...
prototype["canDeleteOwnMessage"] = function canDeleteOwnMessage(id1) {
  ...
  if (this.author.id === id1) {
    ...
    if (tmp2) {
      tmp2 = require(8770) /* ApplicationIntegrationType */.ApplicationIntegrationType.USER_INSTALL in prop;
    }
    return tmp2;
  }
};
