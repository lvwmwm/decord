...
// Function ID: 57005
// Name: ScopeClass
// Dependencies: [57, 77, 65, 6, 7, 6357, 6369, 6370, 6354, 6361, 6372, 6358, 6347]

// Module 6368 (ScopeClass)
...
const tmp2 = (() => {
  class ScopeClass {
    constructor() {
      ...
      obj = {};
      obj2 = ScopeClass(outer1_1[5]);
      obj.traceId = obj2.generateTraceId();
      obj3 = ScopeClass(outer1_1[5]);
  ...
  let obj = {
    ...
    value: function clone() {
      ...
      tmp._eventProcessors = outer1_4(self._eventProcessors);
      tmp._requestSession = self._requestSession;
      tmp._attachments = outer1_4(self._attachments);
      ...
      const obj2 = ScopeClass(outer1_1[6]);
      obj2._setSpanForScope(tmp, ScopeClass(outer1_1[6])._getSpanForScope(self));
      return tmp;
    }
  };
  let items = [obj, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , ];
  ...
  items[7] = {
    ...
    value: function setUser(user) {
      ...
      if (self._session) {
        obj = { user };
        ScopeClass(outer1_1[7]).updateSession(self._session, obj);
        const obj2 = ScopeClass(outer1_1[7]);
      }
  ...
  items[12] = {
    ...
    value: function setTag(arg0, arg1) {
      this._tags = Object.assign({}, this._tags, outer1_3({}, arg0, arg1));
      const result = this._notifyScopeListeners();
      return this;
    }
  };
  ...
  items[14] = {
    ...
    value: function setExtra(arg0, arg1) {
      this._extra = Object.assign({}, this._extra, outer1_3({}, arg0, arg1));
      const result = this._notifyScopeListeners();
      return this;
    }
  };
    ...
    value: function update(requestSession) {
      ...
      if (requestSession) {
        ...
        if (obj instanceof outer1_7) {
          ...
          obj2 = ScopeClass(outer1_1[8]);
        }
        const tmp5 = outer1_2(items2, 2);
        let first = tmp5[0];
        if (!first) {
          first = {};
        }
  ...
  items[22] = {
    ...
    value: function clear() {
      ...
      let obj = ScopeClass(outer1_1[6]);
      obj._setSpanForScope(this, undefined);
      this._attachments = [];
      obj = { traceId: ScopeClass(outer1_1[5]).generateTraceId() };
  ...
  items[23] = {
    ...
    value: function addBreadcrumb(arg0, arg1) {
      ...
      if (num <= 0) {
        ...
        const _Object = Object;
        const obj = { timestamp: ScopeClass(outer1_1[9]).dateTimestampInSeconds() };
  ...
  items[28] = {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, extra: this._extra, user: this._user, level: this._level, fingerprint: tmp, eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: ScopeClass(outer1_1[6])._getSpanForScope(self) };
      return obj;
    }
  };
  items[29] = {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(outer1_1[10]).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  };
  items[30] = {
    ...
    value: function setPropagationContext(arg0) {
      const obj = { spanId: ScopeClass(outer1_1[5]).generateSpanId() };
    ...
    value: function captureException(originalException, event_id) {
      ...
      if (event_id) {
        ...
        if (self._client) {
          ...
          const logger = ScopeClass(outer1_1[12]).logger;
          logger.warn("No client configured on scope - will not capture exception!");
          return event_id;
        }
      }
      obj = ScopeClass(outer1_1[11]);
      event_id = obj.uuid4();
    }
  };
  items[33] = {
  ...
  return _defineProperties(ScopeClass, items);
})();
let closure_7 = tmp2;
