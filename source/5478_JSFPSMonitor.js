...
// Function ID: 5479
// Name: JSFPSMonitor
// Dependencies: [5425, 5426, 5413, 5479]

// Module 5478 (JSFPSMonitor)
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        const error = new Error(JSFPSMonitor(5413).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      obj[0] = JSFPSMonitor(5479).roundToDecimalPlaces(self.minFPS, 1);
      const obj2 = JSFPSMonitor(5479);
      obj[1] = JSFPSMonitor(5479).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(5479);
      obj[2] = JSFPSMonitor(5479).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    }
  }
];
