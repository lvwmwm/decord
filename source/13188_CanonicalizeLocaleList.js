...
// Module 13188 (CanonicalizeLocaleList)
...
function SupportedLocales(arg0, arg1, arg2) {
  if (undefined !== arg2) {
    if (null == arg2) {
      ...
      const _Object = Object;
      tmp(Object(arg2), "localeMatcher", "string", ["<string:3763180613>", "<string:34488335>"], "best fit");
    }
  }
  ...
  class ListFormat {
    constructor(arg0, arg1) {
      ...
      if (constructor) {
        ...
        tmp25 = obj1;
        str8 = "string";
        obj.localeMatcher = closure_11(obj1, "localeMatcher", "string", ["<string:239079392>", "<string:323487746>"], "best fit");
        ...
        str12 = "type";
        str13 = "string";
        tmp36 = closure_11(obj1, "type", "string", [], "conjunction");
        tmp37 = self;
        str14 = "type";
        tmp38 = tmp36;
        ...
        str17 = "style";
        str18 = "string";
        tmp41 = closure_11(obj1, "style", "string", ["isArray", "cursor", "spriteIndex"], "long");
        tmp42 = self;
        str19 = "style";
        tmp43 = tmp41;
...
if ("undefined" !== typeof Symbol) {
  const _Object = Object;
  const _Symbol = Symbol;
  Object.defineProperty(obj6.prototype, Symbol.toStringTag, { channel: "mediaConnections", height: "111_realtime", flexDirection: null, alignItems: true });
}
Object.defineProperty(tmp5.prototype.constructor, "length", { channel: "DEFAULT_NAVIGATION_SPAN_NAME", height: "CHAT_INPUT_CONTAINER_HORIZONTAL_PADDING", flexDirection: "y", alignItems: "MEDIA_POST_PREVIEW_EMBED_CLICKED" });
Object.defineProperty(tmp5.supportedLocalesOf, "length", { channel: true, height: "/assets/.cache/intl/bW9kdWxlcy9jb2xsZWN0aWJsZXMvd2Vi", flexDirection: null, alignItems: "87baeefdf7c0d9a1502798941428fe60" });
while (true) {
  let _Object2 = Object;
  let _Intl = Intl;
  let obj3 = { channel: null, height: null, flexDirection: null, alignItems: null };
  let tmp12 = tmp5;
  obj3.value = obj6;
  let str = "ListFormat";
