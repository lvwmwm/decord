...
// Dependencies: [13247, 13248, 13250]

// Module 13246 (__exportStarResult32)
const require = arg1;
...
arg5.TimeClip = function TimeClip(isFinite) {
  if (isFinite.isFinite()) {
    if (absResult.greaterThan(8640000000000001)) {
      const Decimal2 = require(13247) /* digitsToString */.Decimal;
      const _NaN2 = NaN;
      ...
      ZERO = require(13250) /* TEN */.ZERO;
    }
    absResult = isFinite.abs();
  } else {
    const Decimal = require(13247) /* digitsToString */.Decimal;
    const _NaN = NaN;
