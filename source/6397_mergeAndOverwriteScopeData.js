...
// Dependencies: [65, 6372, 6353, 6352, 6383]
// Exports: applyScopeDataToEvent, mergeScopeData

// Module 6397 (mergeAndOverwriteScopeData)
import _toConsumableArray from "_toConsumableArray";

function mergeAndOverwriteScopeData(arg0, arg1, arg2) {
  arg0[arg1] = require(6372) /* merge */.merge(arg0[arg1], arg2, 1);
}
...
export const applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  const dropUndefinedKeysResult1 = require(6353) /* addNonEnumerableProperty */.dropUndefinedKeys(tags);
  ...
  const dropUndefinedKeysResult2 = require(6353) /* addNonEnumerableProperty */.dropUndefinedKeys(user);
  ...
  const obj3 = require(6353) /* addNonEnumerableProperty */;
  const dropUndefinedKeysResult3 = require(6353) /* addNonEnumerableProperty */.dropUndefinedKeys(contexts);
  ...
  if (span) {
    ...
    obj = { trace: require(6352) /* spanTimeInputToSeconds */.spanToTraceContext(span) };
    extra.contexts = Object.assign(obj, extra.contexts);
    const _Object10 = Object;
    obj = {};
    const obj6 = require(6352) /* spanTimeInputToSeconds */;
    obj.dynamicSamplingContext = require(6383) /* getDynamicSamplingContextFromClient */.getDynamicSamplingContextFromSpan(span);
    extra.sdkProcessingMetadata = Object.assign(obj, extra.sdkProcessingMetadata);
    const obj8 = require(6383) /* getDynamicSamplingContextFromClient */;
    const rootSpan = require(6352) /* spanTimeInputToSeconds */.getRootSpan(span);
    const obj9 = require(6352) /* spanTimeInputToSeconds */;
    const description = require(6352) /* spanTimeInputToSeconds */.spanToJSON(rootSpan).description;
...
export const mergeScopeData = function mergeScopeData(sdkProcessingMetadata, extra) {
  ...
  sdkProcessingMetadata.sdkProcessingMetadata = require(6372) /* merge */.merge(sdkProcessingMetadata.sdkProcessingMetadata, sdkProcessingMetadata, 2);
  if (level) {
