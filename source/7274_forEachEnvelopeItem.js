...
// Module 7274 (forEachEnvelopeItem)
...
let closure_4 = { left: "headMetaSocial", right: "png", paddingHorizontal: "SERVER_GUIDE_CHANNEL_SELECTED", paddingVertical: "spanToTraceHeader", paddingHorizontal: "Array", gap: "_uploadHttpClient", backgroundColor: "Array", borderRadius: "startShouldSetResponder", alignItems: "isArray", justifyContent: "isArrayBuffer", display: "manifests", flexDirection: "WISHLIST_ITEM", rowGap: "cellIndex", alignItems: "gif", paddingTop: "headMetaSocial", flexDirection: "png" };
