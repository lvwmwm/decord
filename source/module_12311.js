// Module ID: 12311
// Function ID: 12312
// Dependencies: [5, 12245, 12308, 12312, 12313, 12314, 12307]

// Module 12311
import asyncGeneratorStep from "module_12314";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12245).util;
    ...
    let closure_8 = fn(require("module_12312"));
    let closure_9 = fn(require("module_12313"));
    let closure_10 = fn(require("module_12314"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12307).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12307).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12307).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
