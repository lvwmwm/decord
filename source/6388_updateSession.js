...
// Function ID: 6389
// Name: updateSession
// Dependencies: [6364, 6365, 6389, 6379, 6376, 6371]
// Exports: closeSession, makeSession

// Module 6388 (updateSession)
...
function updateSession(ipAddress) {
  ...
  if (!timestamp) {
    timestamp = require(6379) /* dateTimestampInSeconds */.timestampInSeconds();
    const obj2 = require(6379) /* dateTimestampInSeconds */;
  }
  ...
  if (!obj.sid) {
    ...
    if (32 === obj.sid.length) {
      ...
      sid = require(6376) /* addContextToFrame */.uuid4();
