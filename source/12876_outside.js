...
// Function ID: 100082
// Name: outside
// Dependencies: [12839, 12868, 12859, 12864, 12860, 12863, 12870, 12867]

// Module 12876 (outside)
...
export default function outside(arg0, arg1, arg2, arg3) {
  ...
  require = tmp;
  let tmp3 = require(12868) /* Range */;
  tmp3 = new tmp3(arg1, arg3);
  const dependencyMap = tmp3;
  if (">" === arg2) {
    let closure_3 = require(12859) /* gt */;
    let closure_4 = require(12864) /* lte */;
    let closure_5 = require(12860) /* lt */;
    let c6 = ">";
    let c7 = ">=";
  } else if ("<" === arg2) {
    closure_3 = require(12860) /* lt */;
    closure_4 = require(12863) /* gte */;
    closure_5 = require(12859) /* gt */;
    c6 = "<";
    c7 = "<=";
  } else {
  ...
  if (require(12870) /* satisfies */(tmp, tmp3, arg3)) {
    return false;
  } else {
    let num7 = 0;
    num7 = 0;
