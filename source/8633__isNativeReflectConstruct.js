...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8539, 8547, 8553, 8546, 8634, 8630, 8555]

// Module 8633 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(8547).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
      ...
      if (tmp5) {
        ...
        obj[6] = midLine;
        const merged = Object.assign(withoutXYResult, importDefault(8553)(obj, true), obj);
        withoutXYResult.ref = self.refMethod;
        obj1 = {};
        const merged1 = Object.assign(withoutXYResult);
        return jsx(importDefault(8634), {});
      } else {
        ...
        obj[1] = children;
        return jsx(importDefault(8630), { ref: null, children: null });
      }
