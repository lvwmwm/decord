        ...
        constructor(arg0) {
          ...
          if (typeof global !== "function") {
            ...
            if (obj.shouldCatchExceptions(obj)) {
              ...
              catchPromise = _promise.catch(/* F119067 */ function() { ... });
            }
        ...
        arg0.loadAxo = function loadAxo(arg0) {
          ...
          const f119084 = function() {
            ...
            if (typeof Symbol === "function") {
              let _Symbol = Symbol;
              obj[Symbol.iterator] = /* F119078 */ function() { ... };
            }
            return obj;
          };
      ...
      class Framebus {
        ...
        targetFramesAsWindows() {
          if (this.limitBroadcastToFramesArray) {
            ...
            found = mapped.filter(/* F119091 */ function() { ... });
          } else {
            found = [];
          }
          return found;
        ...
        hasMatchingTargetFrame(arg0) {
          ...
          if (this.limitBroadcastToFramesArray) {
            ...
            tmp = globalThis;
            _Boolean = Boolean;
            return Boolean(result.find(/* F119092 */ function() { ... }));
          } else {
            flag = true;
            return true;
          }
    ...
    (arg0, arg1, arg2) => {
      class ApplePay {
        ...
        _createPaymentRequestSynchronously(arg0) {
          _client = this._client;
          applePayWeb = _client.getConfiguration().gatewayConfiguration.applePayWeb;
          obj = { countryCode: applePayWeb.countryCode, currencyCode: applePayWeb.currencyCode, merchantCapabilities: tmp, supportedNetworks: supportedNetworks.map(/* F115425 */ function() { ... }) };
      ...
      class HostedFields {
        constructor(arg0) {
          ...
          if (global.client) {
            ...
            tmp4 = globalThis;
            _Boolean = Boolean;
            obj = f115484.create(global.authorization);
          ...
          if (global.fields) {
            ...
            if (0 !== Object.keys(global.fields).length) {
              ...
              f115484 = setTimeout(() => { ... }, INTEGRATION_TIMEOUT_MS);
              _Promise = Promise;
    ...
    (arg0, arg1, arg2) => {
      class LocalPayment {
        ...
        _initialize() {
          self = this;
          _client = this._client;
          f115531 = setTimeout(() => { ... }, INTEGRATION_TIMEOUT_MS);
          promise = new Promise(() => { ... });
          return promise;
        }
        startPayment(arg0) {
    ...
    (arg0, arg1, arg2) => {
      class PayPalCheckout {
        ...
        _setupFrameService(arg0) {
          ...
          f115565 = setTimeout(() => { ... }, INTEGRATION_TIMEOUT_MS);
        ...
        teardown() {
          ...
          catchPromise = _frameServicePromise.catch(/* F115590 */ function() { ... });
    ...
    (arg0, arg1, arg2) => {
      class InlineIframeFramework {
        ...
        _addV1IframeToPage() {
          ...
          _emitResult = this._emit(InlineIframeFramework.events.AUTHENTICATION_IFRAME_AVAILABLE, obj, /* F115636 */ function() { ... });
          return;
        }
    ...
    (arg0, arg1, arg2) => {
      class SongbirdFramework {
        ...
        prepareLookup(arg0) {
          ...
          nextPromise1 = nextPromise.then(() => { ... });
          catchPromise = nextPromise1.catch(/* F115650 */ function() { ... });
