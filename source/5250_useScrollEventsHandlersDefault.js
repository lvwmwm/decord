...
// Dependencies: [5231, 1582, 5224, 5251]

// Module 5250 (useScrollEventsHandlersDefault)
const require = arg1;
...
arg5.useScrollEventsHandlersDefault = function useScrollEventsHandlersDefault(animatedRef, sharedValue, lockableScrollableContentOffsetY) {
  ...
  obj = { animatedSheetState, SHEET_STATE: _require(5224).SHEET_STATE, animatedHandleGestureState, State: _require(5251).State, animatedScrollableState, SCROLLABLE_STATE: _require(5224).SCROLLABLE_STATE, scrollTo: _require(1582).scrollTo, scrollableRef: animatedRef, scrollableContentOffsetY: sharedValue, _lockableScrollableContentOffsetY: sharedValue };
  ...
  obj1 = { scrollableContentOffsetY: sharedValue, _lockableScrollableContentOffsetY: sharedValue, rootScrollableContentOffsetY: animatedScrollableContentOffsetY, animatedSheetState, SHEET_STATE: _require(5224).SHEET_STATE };
  ...
  obj2 = { animatedScrollableState, SCROLLABLE_STATE: _require(5224).SCROLLABLE_STATE, scrollTo: _require(1582).scrollTo, scrollableRef: animatedRef, scrollableContentOffsetY: sharedValue, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5224).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
  ...
  pnpm_useScrollEventsHandlersDefaultTs6.__closure = { animatedScrollableState, SCROLLABLE_STATE: _require(5224).SCROLLABLE_STATE, scrollTo: _require(1582).scrollTo, scrollableRef: animatedRef, scrollableContentOffsetY: sharedValue, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5224).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
