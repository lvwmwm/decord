...
// Dependencies: [7577, 7578, 7579, 7502, 7540, 7504, 7494, 7495, 7501]

// Module 7576 (extractRequestData)
const require = arg1;
  ...
  if (!obj.customRoute) {
    if (!method.route) {
      ...
      if (tmp) {
        ...
        str5 = require(7577) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
        str4 = "url";
        const obj2 = require(7577) /* getNumberOfUrlSegments */;
      }
...
arg5.httpRequestToRequestData = function httpRequestToRequestData(headers) {
  ...
  return require(7501) /* addNonEnumerableProperty */.dropUndefinedKeys(obj);
};
