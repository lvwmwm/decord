...
export const addNormalizedRequestDataToEvent = function addNormalizedRequestDataToEvent(request, headers, user, include) {
  ...
  if (merged.ip) {
    ...
    if (ipAddress) {
      ipAddress = require(6394) /* items */.getClientIPAddress(headers.headers);
      const obj4 = require(6394) /* items */;
    }
    if (!ipAddress) {
...
export const addRequestDataToEvent = function addRequestDataToEvent(request, request, include) {
  ...
  if (merged.ip) {
    ...
    if (ip) {
      ip = require(6394) /* items */.getClientIPAddress(request.headers);
      const obj4 = require(6394) /* items */;
    }
    if (!ip) {
      ip = request.ip;
    ...
    if (!obj.customRoute) {
      if (!method.route) {
        ...
        if (tmp) {
          ...
          str4 = require(6393) /* getNumberOfUrlSegments */.stripUrlQueryAndFragment(str6);
          str5 = "url";
          const obj2 = require(6393) /* getNumberOfUrlSegments */;
        }
