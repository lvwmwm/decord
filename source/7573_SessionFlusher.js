...
// Function ID: 7574
// Name: SessionFlusher
// Dependencies: [41, 42, 7526, 7547]

// Module 7573 (SessionFlusher)
...
const items = [
  ...
  },
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(7526).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(7547).getIsolationScope();
