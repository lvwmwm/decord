...
// Function ID: 13152
// Name: Comparator
// Dependencies: [41, 42, 13124, 13126, 13127, 13123, 13149, 13152]
...
let obj = {
  ...
  value: function parse(str) {
    const self = this;
    const safeRe = Comparator(13127).safeRe;
    ...
    if (match) {
      ...
      if (match[2]) {
        const tmp15 = new tmp5(13123)(match[2], self.options.loose);
        self.semver = tmp15;
      } else {
...
const items = [
  ...
  },
  {
    ...
    value: function test(arg0) {
      const self = this;
      let tmp = arg0;
      Comparator(13126)("Comparator.test", arg0, this.options.loose);
    ...
    value: function intersects(value) {
      if (value instanceof Comparator) {
        ...
        if ("" === this.operator) {
          ...
          if (!isMatch) {
            const obj2 = new Comparator(13152)(value.value, arg1);
          ...
          if (!isMatch1) {
            const obj = new Comparator(13152)(self.value, arg1);
            isMatch1 = obj.test(value.semver);
          }
          tmp8 = isMatch1;
        } else {
          const tmp45 = Comparator(13124)(arg1);
            ...
            if (!tmp9) {
              ...
              if (tmp13) {
                ...
                if (tmp16) {
                  ...
                  let tmp19 = !tmp18;
                  if (tmp18) {
                    let startsWithResult3 = Comparator(13149)(self.semver, "<", value.semver, tmp45);
                    ...
                    if (!tmp24) {
                      let startsWithResult4 = Comparator(13149)(self.semver, ">", value.semver, tmp45);
