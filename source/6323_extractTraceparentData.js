...
// Dependencies: [6324, 6321]

// Module 6323 (extractTraceparentData)
const require = arg1;
...
arg5.generateSentryTraceHeader = function generateSentryTraceHeader() {
  if (arguments.length > 0) {
    ...
    spanId = require(6321) /* generateTraceId */.generateSpanId();
    const obj2 = require(6321) /* generateTraceId */;
  }
  first = require(6321) /* generateTraceId */.generateTraceId();
};
arg5.propagationContextFromHeaders = function propagationContextFromHeaders(arg0, arg1) {
  const tmp = extractTraceparentData(arg0);
  let obj = require(6324) /* parseBaggageHeader */;
  let result = obj.baggageHeaderToDynamicSamplingContext(arg1);
  if (tmp) {
    if (tmp.traceId) {
      obj = {};
      ({ traceId: obj6.traceId, parentSpanId: obj6.parentSpanId } = tmp);
      obj.spanId = require(6321) /* generateTraceId */.generateSpanId();
  ...
  obj = { traceId: require(6321) /* generateTraceId */.generateTraceId() };
  const obj4 = require(6321) /* generateTraceId */;
  obj.spanId = require(6321) /* generateTraceId */.generateSpanId();
  return obj;
};
