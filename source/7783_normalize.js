...
// Function ID: 7784
// Name: normalize
// Dependencies: [32, 7784, 7744, 7745, 7741]
// Exports: normalizeUrlToBase

// Module 7783 (normalize)
...
function visit(arg0, num) {
  ...
  if (arg4 === undefined) {
    memoBuilderResult = require(7784) /* memoBuilder */.memoBuilder();
    let obj = require(7784) /* memoBuilder */;
  }
      ...
      if (str.startsWith("[object ")) {
        if (num.__sentry_skip_normalization__) {
          ...
          if (0 === num) {
            ...
            const convertToPlainObjectResult = require(7744) /* addNonEnumerableProperty */.convertToPlainObject(num);
            let num6 = 0;
