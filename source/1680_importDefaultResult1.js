...
const items = [
  ...
  },
  {
    ...
    value: function getViewProp(arg0, arg1, self) {
      self = this;
      if (obj.isFabric()) {
        const tmpResult = require(1682) /* getShadowNodeWrapperFromRef */;
        const shadowNodeWrapperFromRef = require(1682) /* getShadowNodeWrapperFromRef */.getShadowNodeWrapperFromRef(self);
