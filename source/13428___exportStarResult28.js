...
// Dependencies: [1281, 13408, 13421, 13409]
// Exports: ToRawFixed

// Module 13428 (__exportStarResult28)
import e from "e";
...
export const ToRawFixed = function ToRawFixed(ZERO, minimumFractionDigits, maximumFractionDigits, roundingIncrement, result) {
  ...
  result = require(13421) /* __exportStarResult11 */.ApplyUnsignedRoundingMode(ZERO, timesResult2, timesResult4, result);
  ...
  if (0 !== maximumFractionDigits) {
    ...
    if (str2.length <= maximumFractionDigits) {
      sum = require(13409) /* getMultiInternalSlots */.repeat("0", maximumFractionDigits - length2 + 1) + str2;
