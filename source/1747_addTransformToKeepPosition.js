...
export const EntryExitTransition = function EntryExitTransition(name, translateX) {
  ...
  const structuredCloneResult = structuredClone(require(1709) /* TransitionType */.AnimationsData[translateX.exiting]);
  ...
  addTransformToKeepPosition(obj.style, structuredClone(require(1709) /* TransitionType */.AnimationsData[translateX.entering]).style, { translateX: "0px", translateY: "0px", scale: "1,1" }, false);
