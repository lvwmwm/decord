...
// Dependencies: [32, 19, 17, 21, 1481, 4610, 8356, 4601, 1584, 5659, 8357, 8360, 8361]
// Exports: default

// Module 8355 (NativeStackViewInner)
...
function MaybeNestedStack(children) {
  ...
  return closure_7(importDefault(8356), obj);
}
function SceneView(arg0) {
  ...
  let defaultHeaderHeight = _require(5659).getDefaultHeaderHeight(safeAreaFrame, tmp12, num3);
  ...
  obj9[1] = closure_7(_require(4601).EdgeInsetApplicationContext.Provider, obj10);
  obj8[5] = closure_7(_require(5659).HeaderBackContext.Provider, obj9);
  ...
  const obj13 = {};
  tmp30 = closure_12;
  const tmpResult2 = _require(5659);
  ...
  items1[2] = closure_7(importDefault(8357), obj13);
  obj4[1] = items1;
  obj3[1] = closure_8(_require(5659).HeaderHeightContext.Provider, obj4);
  obj2[1] = closure_7(_require(5659).HeaderShownContext.Provider, obj3);
  ...
  return closure_7(_require(4601).Screen, obj, route.key);
}
...
export default function NativeStackView(arg0) {
  ...
  return callback2(require(5659) /* Background */.SafeAreaProviderCompat, obj);
};
