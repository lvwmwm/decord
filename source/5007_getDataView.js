...
// Function ID: 5008
// Name: getDataView
// Dependencies: [4994, 4997]

// Module 5007 (getDataView)
const require = arg1;
const module = arg2;
...
arg5.default = {
  isWebpFile(dataView) {
    let tmp = dataView;
    if (tmp) {
      tmp = require(4994) /* getDataView */.getStringFromDataView(dataView, 0, 4) === "RIFF";
      const obj = require(4994) /* getDataView */;
    }
    if (tmp) {
      tmp = require(4994) /* getDataView */.getStringFromDataView(dataView, 8, 4) === "WEBP";
