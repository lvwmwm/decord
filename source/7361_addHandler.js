...
// Function ID: 7362
// Name: addHandler
// Dependencies: [7362, 7363, 7366]

// Module 7361 (addHandler)
const require = arg1;
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (require(7362) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
          const logger = tmp19(7363).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(7366).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(7366);
        }
      }
    }
