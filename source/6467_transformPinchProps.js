...
arg5.usePinchGesture = function usePinchGesture(gestureHandlerProps) {
  ...
  const clonedAndRemappedConfig = require(6445) /* isGestureEnabled */.useClonedAndRemappedConfig(tmp, map, transformPinchProps);
  const obj = require(6445) /* isGestureEnabled */;
  return require(6460) /* useGesture */.useGesture(require(6436) /* ComposedGestureName */.SingleGestureName.Pinch, clonedAndRemappedConfig);
};
