...
// Dependencies: [8472, 8473, 8474]

// Module 8471 (appendTransformProps)
const require = arg1;
...
function appendTransformProps(arg0) {
  ...
  require(8472) /* append */.appendTransform(x + originX, y + originY, scaleX, scaleY, rotation, skewX, skewY, originX, originY);
}
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      if ("number" === typeof arr[0]) {
        const obj4 = require(8472) /* append */;
      ...
      const parsed = require(8473) /* peg$SyntaxError */.parse(arr);
      const obj3 = require(8472) /* append */;
      obj3.append(parsed[0], parsed[3], parsed[1], parsed[4], parsed[2], parsed[5]);
      const obj2 = require(8473) /* peg$SyntaxError */;
    } else {
  ...
  const obj = require(8472) /* append */;
  require(8472) /* append */.toArray();
}
arg5.default = function extractTransform(arr) {
  ...
  if ("string" === typeof arr) {
    const parsed = require(8473) /* peg$SyntaxError */.parse(tmp);
...
arg5.extractTransformSvgView = function extractTransformSvgView(transform) {
  if ("string" === typeof transform.transform) {
    transform = require(8474) /* peg$SyntaxError */.parse(transform.transform);
    const obj = require(8474) /* peg$SyntaxError */;
  } else {
