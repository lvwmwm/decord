...
arg5.withStyleAnimation = () => {
  function withStyleAnimation(animations) {
    let obj = animations(closure_1[0]);
    ...
    obj = { ColorProperties: animations(closure_1[1]).ColorProperties, setPath: closure_5, processColor: animations(closure_1[1]).processColor, styleAnimations: animations, resolvePath: closure_3, __DEV__: false, logger: animations(closure_1[3]).logger, isValidLayoutAnimationProp: animations(closure_1[0]).isValidLayoutAnimationProp, withTiming: animations(closure_1[2]).withTiming };
    pnpm_styleAnimationTs4.__closure = obj;
    pnpm_styleAnimationTs4.__workletHash = 1293354823532;
    pnpm_styleAnimationTs4.__initData = closure_7;
    return obj.defineAnimation({}, pnpm_styleAnimationTs4);
  }
  withStyleAnimation.__closure = { defineAnimation: arg1(arg6[0]).defineAnimation, ColorProperties: arg1(arg6[1]).ColorProperties, setPath: closure_5, processColor: arg1(arg6[1]).processColor, resolvePath: closure_3, __DEV__: false, logger: arg1(arg6[3]).logger, isValidLayoutAnimationProp: arg1(arg6[0]).isValidLayoutAnimationProp, withTiming: arg1(arg6[2]).withTiming };
