...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 13318, 4080, 8770]

// Module 13317 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    value: function render() {
      ...
      const items4 = [PaginationDot(13318).sliderPaginationDotContainer, ];
      if (!containerStyle) {
        containerStyle = {};
      }
      items4[1] = containerStyle;
      const items5 = [PaginationDot(13318).sliderPaginationDot, , , , ];
      if (!style) {
        style = {};
      }
      items5[1] = style;
