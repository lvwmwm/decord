...
let closure_2 = ["<string:1336656203>", "<string:3251476183>"];
let closure_3 = [];
let closure_4 = ["progressViewOffset", "ListEmptyComponent", "ListHeaderComponent"];
...
const importDefaultResultResult = importDefault(dependencyMap[9])(importDefault(dependencyMap[10]), {});
let closure_17 = null;
...
const styles = StyleSheet.create({ underlay: { borderWidth: "isArray", alignSelf: "skuId", marginLeft: "T", marginTop: "r", display: "isArray" } });
...
tmp10.defaultProps = { sendAnalytics: null, CHANNEL_HIGHLIGHT: null };
