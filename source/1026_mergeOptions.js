...
function P$1(insertBefore, arg1, __k, __k2, arg4, arg5, arg6, arg7, __d, arg9, arr) {
  ...
  if (0 < arg1.length) {
    while (true) {
      ...
      let tmp67 = ___d;
      if (tmp64) {
        tmp64 = typeof tmp63 === "SENTRY_RELEASE";
      }
      if (tmp64) {
        tmp64 = typeof tmp63 === "_";
      }
      let tmp68 = tmp65;
      let tmp69 = tmp67;
      if (tmp64) {
...
function Form(onSubmitError) {
  ...
  let tmp5;
  let tmp7;
  ({ options, defaultEmail, defaultName, onSubmit: f101594, onSubmitSuccess } = onSubmitError);
  ...
  closure_15 = fn2(() => f67537, items);
  f101594 = undefined;
  f101594 = screenshotInput((arg0) => {
    let closure_0 = arg0;
    let c5 = 0;
    let c6 = 0;
    let c4 = 0;
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (3 === tmp8) {
              ...
              c4 = closure_3;
              if (messageLabel) {
                const debug = f101594(onSubmitSuccess[2]).debug;
                debug.error(c4);
              }
              outer1_11(c4);
              outer1_2(c4);
  ...
  f101594 = function(arg0) {
    const self = this;
    const apply = f101594.apply;
  ...
  c46 = 8;
  let obj = { class: "form", onSubmit: tmp13(() => f67537, items1) };
  ...
  return () => {
    ...
    _attachTo = function _attachTo(el, arg1) {
      ...
      if (typeof el === "y") {
        ...
        element = null;
        if (typeof el.addEventListener !== "_") {
          element = el;
        }
      }
      if (element) {
