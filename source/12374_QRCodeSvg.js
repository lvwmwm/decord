...
// Function ID: 12375
// Name: QRCodeSvg
// Dependencies: [12371, 19, 8196]

// Module 12374 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(8196) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(8196) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(8196) /* inlineStyles */.Path, { d, fill }));
});
