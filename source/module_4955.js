...
obj = { name: "ExposureTime", description: require("module_4954").ExposureTime };
obj[33434] = obj;
obj = { name: "FNumber", description: require("module_4954").FNumber };
obj[33437] = obj;
obj[34850] = { name: "ExposureProgram", description: require("module_4954").ExposureProgram };
obj[34856] = {
  name: "OECF",
  description() {
...
const obj1 = { name: "ExposureProgram", description: require("module_4954").ExposureProgram };
obj[37121] = { name: "ComponentsConfiguration", description: require("module_4954").ComponentsConfiguration };
const obj2 = { name: "ComponentsConfiguration", description: require("module_4954").ComponentsConfiguration };
obj[37377] = { name: "ShutterSpeedValue", description: require("module_4954").ShutterSpeedValue };
const obj3 = { name: "ShutterSpeedValue", description: require("module_4954").ShutterSpeedValue };
obj[37378] = { name: "ApertureValue", description: require("module_4954").ApertureValue };
obj[37381] = {
...
const obj4 = { name: "ApertureValue", description: require("module_4954").ApertureValue };
obj[37383] = { name: "MeteringMode", description: require("module_4954").MeteringMode };
const obj5 = { name: "MeteringMode", description: require("module_4954").MeteringMode };
obj[37384] = { name: "LightSource", description: require("module_4954").LightSource };
obj[37385] = {
  name: "Flash",
  description(arg0) {
...
const obj6 = { name: "LightSource", description: require("module_4954").LightSource };
obj[37386] = { name: "FocalLength", description: require("module_4954").FocalLength };
obj[37394] = {
...
const obj7 = { name: "FocalLength", description: require("module_4954").FocalLength };
...
obj[40961] = { name: "ColorSpace", description: require("module_4954").ColorSpace };
obj[41484] = {
...
const obj9 = { name: "ColorSpace", description: require("module_4954").ColorSpace };
obj[41488] = { name: "FocalPlaneResolutionUnit", description: require("module_4954").FocalPlaneResolutionUnit };
obj[41492] = {
...
const obj10 = { name: "FocalPlaneResolutionUnit", description: require("module_4954").FocalPlaneResolutionUnit };
obj[41985] = { name: "CustomRendered", description: require("module_4954").CustomRendered };
const obj11 = { name: "CustomRendered", description: require("module_4954").CustomRendered };
obj[41986] = { name: "ExposureMode", description: require("module_4954").ExposureMode };
const obj12 = { name: "ExposureMode", description: require("module_4954").ExposureMode };
obj[41987] = { name: "WhiteBalance", description: require("module_4954").WhiteBalance };
obj[41988] = {
...
const obj13 = { name: "WhiteBalance", description: require("module_4954").WhiteBalance };
obj[41989] = { name: "FocalLengthIn35mmFilm", description: require("module_4954").FocalLengthIn35mmFilm };
const obj14 = { name: "FocalLengthIn35mmFilm", description: require("module_4954").FocalLengthIn35mmFilm };
obj[41990] = { name: "SceneCaptureType", description: require("module_4954").SceneCaptureType };
obj[41991] = {
  name: "GainControl",
  description(arg0) {
    let str = "None";
...
const obj15 = { name: "SceneCaptureType", description: require("module_4954").SceneCaptureType };
obj[41992] = { name: "Contrast", description: require("module_4954").Contrast };
const obj16 = { name: "Contrast", description: require("module_4954").Contrast };
obj[41993] = { name: "Saturation", description: require("module_4954").Saturation };
const obj17 = { name: "Saturation", description: require("module_4954").Saturation };
obj[41994] = { name: "Sharpness", description: require("module_4954").Sharpness };
obj[41995] = {
