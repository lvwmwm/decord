// Module ID: 4955
// Function ID: 4956
// Dependencies: [4915, 4930, 4931, 4927, 4910]
...
arg5.default = {
  read(buffer, sum) {
    ...
    let obj2 = require(4930) /* readTag */;
    const ifd = obj1.readIfd(buffer, require(4931) /* importDefaultResult1 */.IFD_TYPE_MPF, sum, obj2.get0thIfdOffset(buffer, sum, byteOrder), byteOrder, arg2);
    if (ifd.MPEntry) {
      const items = [];
      const _Math = Math;
      let num13 = 0;
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          if (0 !== num13) {
            ...
            let obj15 = require(4910) /* getDataView */;
