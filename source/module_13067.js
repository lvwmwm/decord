// Module ID: 13067
// Function ID: 13068
// Dependencies: [13030, 13059, 13050, 13055, 13051, 13054, 13061, 13058]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13030)(arg0, arg3);
  const tmp4 = new _require(13059)(arg1, arg3);
  if (">" === arg2) {
  ...
  if (_require(13061)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
    if (0 < tmp4.set.length) {
      while (true) {
        ...
        let item = arr.forEach((semver) => {
          let tmp = semver;
          if (semver.semver === require(13058) /* Comparator */.ANY) {
            tmp = new require(13058) /* Comparator */(">=0.0.0");
          }
          let tmp6 = _null;
          if (!_null) {
            tmp6 = tmp;
