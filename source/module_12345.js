// Module ID: 12345
// Function ID: 12346
// Dependencies: [5, 12279, 12342, 12346, 12347, 12348, 12341]

// Module 12345
import asyncGeneratorStep from "module_12348";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12279).util;
    ...
    let closure_8 = fn(require("module_12346"));
    let closure_9 = fn(require("module_12347"));
    let closure_10 = fn(require("module_12348"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12341).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12341).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12341).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
