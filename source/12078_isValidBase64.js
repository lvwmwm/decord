...
// Function ID: 12079
// Name: isValidBase64
// Dependencies: [32, 5, 12079, 12074, 12080, 12077, 12081, 12075, 12082]

// Module 12078 (isValidBase64)
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_7 = fn(require("module_12079"));
    ...
    obj[1] = function get() {
      return require(12077) /* mergeDefs */.clone;
    };
    ...
    exports.$ZodFunction = fnResult.$constructor("$ZodFunction", (_zod, _def) => {
      ...
      _zod._zod.parse = (value) => {
        if (typeof value.value === "ZodObject") {
          const issues = value.issues;
