...
// Function ID: 7426
// Name: NativeModules
// Dependencies: [5, 17, 7426, 7427, 7432, 7433, 7434, 7435, 7436]
...
export const setup = () => {
  ...
  if ("STOREKIT1_MODE" === str) {
    require(7427).storekit1Mode();
    const obj4 = require(7427);
  } else if ("STOREKIT2_MODE" === str) {
    require(7427).storekit2Mode();
    const obj3 = require(7427);
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    require(7427).storekitHybridMode();
    const obj2 = require(7427);
  }
};
export const initConnection = () => {
  const nativeModule = require(7427).getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = require(7427).getAndroidModule();
