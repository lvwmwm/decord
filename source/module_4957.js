// Module ID: 4957
// Function ID: 4958
// Dependencies: [4917, 4932, 4933, 4929, 4912]
...
arg5.default = {
  read(buffer, sum) {
    ...
    let obj2 = require(4932) /* readTag */;
    const ifd = obj1.readIfd(buffer, require(4933) /* importDefaultResult1 */.IFD_TYPE_MPF, sum, obj2.get0thIfdOffset(buffer, sum, byteOrder), byteOrder, arg2);
    if (ifd.MPEntry) {
      const items = [];
      const _Math = Math;
      let num13 = 0;
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let tmp10 = num13;
          if (byteOrder === module(4917).LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
          ...
          if (0 !== num13) {
            ...
            let obj15 = require(4912) /* getDataView */;
        ...
        const typeSize4 = module(4929).getTypeSize("LONG");
        if (byteOrder === module(4917).LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
