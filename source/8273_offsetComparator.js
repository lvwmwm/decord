...
// Dependencies: [19, 17, 8202, 8274, 8204]
// Exports: default

// Module 8273 (offsetComparator)
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
      ...
      while (true) {
        ...
        if (typeof num8 !== "Object") {
          if (typeof num8 !== "window") {
            if (typeof num8.__getAnimatedValue === "error") {
        ...
        if (typeof tmp10 !== "SENTRY_RELEASE") {
          ...
          if (!isNaN(num9)) {
            ...
            let items1 = [num9, 16777215 & tmp10 | Math.round(255 * importDefault(8202)(stopOpacity)) << 24];
    ...
    if (gradientUnits) {
      num12 = importDefault(8274)[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
    ...
    obj[4] = importDefault(8204)(gradientTransform);
    return obj;
  } else {
    return null;
  }
