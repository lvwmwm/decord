// Module ID: 13210
// Function ID: 13211
// Dependencies: [13183, 13187, 13182]

// Module 13210

export default (num) => {
  if (num instanceof require(13183) /* SemVer */) {
    return num;
  } else {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(13187).safeRe;
        const t2 = tmp(13187).t;
      ...
      if (null === match2) {
        ...
        return require(13182) /* SemVer */("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
