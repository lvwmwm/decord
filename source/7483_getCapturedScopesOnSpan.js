...
// Module 7483 (getCapturedScopesOnSpan)
const require = arg1;
...
arg5.setCapturedScopesOnSpan = function setCapturedScopesOnSpan(arg0, arg1, arg2) {
  if (arg0) {
    const result = require(7460) /* addNonEnumerableProperty */.addNonEnumerableProperty(arg0, _sentryIsolationScope, arg2);
    const obj = require(7460) /* addNonEnumerableProperty */;
    const result1 = require(7460) /* addNonEnumerableProperty */.addNonEnumerableProperty(arg0, _sentryScope, arg1);
