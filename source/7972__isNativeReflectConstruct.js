...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 7914, 7973, 7916, 7925]

// Module 7972 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      [tmp2, tmp3] = parts;
      obj[5] = self(7914).meetOrSliceTypes[tmp3] || 0;
      const tmp6 = self(7914).meetOrSliceTypes[tmp3] || 0;
      obj[6] = self(7914).alignEnum[tmp2] || "xMidYMid";
      ...
      const tmp7 = self(7914).alignEnum[tmp2] || "xMidYMid";
      const tmp11 = importDefault(7973);
