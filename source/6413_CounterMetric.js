...
// Function ID: 57653
// Name: CounterMetric
// Dependencies: [77, 6, 7, 6412, 6408]

// Module 6413 (CounterMetric)
...
const _moduleResult = _defineProperty({}, require("module_6408").COUNTER_METRIC_TYPE, tmp3);
const _moduleResult1 = _defineProperty(_defineProperty({}, require("module_6408").COUNTER_METRIC_TYPE, tmp3), require("module_6408").GAUGE_METRIC_TYPE, tmp4);

export const CounterMetric = tmp3;
export const DistributionMetric = tmp5;
export const GaugeMetric = tmp4;
export const METRIC_MAP = _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, require("module_6408").COUNTER_METRIC_TYPE, tmp3), require("module_6408").GAUGE_METRIC_TYPE, tmp4), require("module_6408").DISTRIBUTION_METRIC_TYPE, tmp5), require("module_6408").SET_METRIC_TYPE, tmp6);
