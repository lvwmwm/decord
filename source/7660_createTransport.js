...
// Dependencies: [7661, 7641, 7662, 7621, 7625, 7597, 7654]

// Module 7660 (createTransport)
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(7641).envelopeItemTypeToDataCategory(arg1);
        const obj = items(7641);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: items(7641).serializeEnvelope(dependencyMap) };
          const obj2 = items(7641);
          ...
          if (arg0 instanceof items(7654).SentryError) {
