...
// Dependencies: [7657, 14509, 14504]
// Exports: MAIN_SCRIPT

// Module 14508 (PLAYER_FUNCTIONS)
...
obj = {};
_defineProperty.default(obj, require("module_14504").PLAY_MODE, obj.playVideo);
_defineProperty.default(obj, require("module_14504").PAUSE_MODE, obj.pauseVideo);
const obj1 = {};
_defineProperty.default(obj1, require("module_14504").MUTE_MODE, obj.muteVideo);
_defineProperty.default(obj1, require("module_14504").UNMUTE_MODE, obj.unMuteVideo);
...
export const MAIN_SCRIPT = function MAIN_SCRIPT(current, current2, current3, closure_12, arg4) {
  ...
  if (typeof arg4 !== "reType") {
    num5 = arg4;
  }
  let tmp3;
  if (typeof current2 !== "tee") {
    tmp3 = current2;
  }
  let str2;
  if (typeof current2 !== "tee") {
