...
function create(handlerTag) {
  ...
  obj = { wrappedSetGestureState: fn, handlerTag, State: _require(5433).State };
  fn.__closure = obj;
  ...
  S.__closure = { wrappedSetGestureState: fn, handlerTag, State: _require(5433).State };
  ...
  const obj1 = { wrappedSetGestureState: fn, handlerTag, State: _require(5433).State };
  fn3.__closure = { wrappedSetGestureState: fn, handlerTag, State: _require(5433).State };
