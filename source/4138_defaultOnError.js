...
// Function ID: 4139
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4139, 4140, 4142, 4116]
// Exports: RiveView

// Module 4138 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + _mod4139.RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp18 = jsx(_require(4116).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
