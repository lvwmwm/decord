...
// Function ID: 4626
// Name: ScreenStack
// Dependencies: [109, 19, 21, 4610, 4626, 4604, 4611, 4627, 4614]
// Exports: default

// Module 4625 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_require(4626).GHContext);
  obj = {
  ...
  ref2(4610)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4610)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4614).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = mapped;
  obj1[6] = jsx(ref2(4627), {});
  ...
  return jsx(tmp4(4626).RNSScreensRefContext.Provider, { value: ref, children: null });
};
