...
// Dependencies: [1637, 1638, 1641, 1645, 1649]
// Exports: initializeUIRuntime

// Module 1636 (overrideLogFunctionImplementation)
...
function overrideLogFunctionImplementation() {
  let obj = require(1638) /* addLogBoxLog */;
  const fn = function e(arg0) {
    callback(1641).runOnJS(callback(1638).logToLogBoxAndConsole)(arg0);
  };
  obj = { runOnJS: require(1641) /* runWorkletOnJS */.runOnJS, logToLogBoxAndConsole: require(1638) /* addLogBoxLog */.logToLogBoxAndConsole };
  fn.__closure = obj;
...
function setupConsole() {
  if (!isJest) {
    ...
    obj[0] = require(1641) /* runWorkletOnJS */.runOnJS(closure_9.assert);
    const obj2 = require(1641) /* runWorkletOnJS */;
    obj[1] = require(1641) /* runWorkletOnJS */.runOnJS(closure_9.debug);
    const obj3 = require(1641) /* runWorkletOnJS */;
    obj[2] = require(1641) /* runWorkletOnJS */.runOnJS(closure_9.log);
    const obj4 = require(1641) /* runWorkletOnJS */;
    obj[3] = require(1641) /* runWorkletOnJS */.runOnJS(closure_9.warn);
    const obj5 = require(1641) /* runWorkletOnJS */;
    obj[4] = require(1641) /* runWorkletOnJS */.runOnJS(closure_9.error);
    const obj6 = require(1641) /* runWorkletOnJS */;
    obj[5] = require(1641) /* runWorkletOnJS */.runOnJS(closure_9.info);
    global.console = obj;
    const obj7 = require(1641) /* runWorkletOnJS */;
  }
}
