...
// Function ID: 98146
// Name: zswap32
// Dependencies: [12690, 12701, 12697, 12702, 12696]

// Module 12700 (zswap32)
const require = arg1;
...
function InflateState() {
  ...
  this.have = 0;
  this.next = null;
  const buf16 = new require(12690) /* _has */.Buf16(320);
  this.lens = buf16;
  const buf161 = new require(12690) /* _has */.Buf16(288);
  this.work = buf161;
  this.lendyn = null;
  this.distdyn = null;
  this.sane = 0;
...
function inflateResetKeep(state) {
  ...
  if (state) {
    ...
    if (state.state) {
      ...
      state.hold = 0;
      state.bits = 0;
      const Buf32 = require(12690) /* _has */.Buf32;
      const prototype = Buf32.prototype;
      const buf32 = new Buf32(852);
      state.lendyn = buf32;
      state.lencode = buf32;
      const Buf322 = require(12690) /* _has */.Buf32;
...
function fixedtables(state) {
  ...
  if (c4) {
    ...
    let obj = { bits: 9 };
    require(12701) /* inflate_table */(1, state.lens, 0, 288, buf32, 0, state.work, obj);
    let num19 = 0;
    do {
      let tmp25 = +num19;
      num19 = tmp25 + 1;
    ...
    obj = { bits: 5 };
    require(12701) /* inflate_table */(2, state.lens, 0, 32, buf322, 0, state.work, obj);
    c4 = false;
  }
  state.lencode = buf32;
  state.lenbits = 9;
...
function updatewindow(state, output3, length, buf8) {
  ...
  if (null === state.window) {
    ...
    state.wnext = 0;
    state.whave = 0;
    const Buf8 = require(12690) /* _has */.Buf8;
    const prototype = Buf8.prototype;
    buf8 = new Buf8(state.wsize);
    state.window = buf8;
  }
  if (buf8 >= state.wsize) {
    const obj3 = require(12690) /* _has */;
...
arg5.inflate = function inflate(state) {
  ...
  let output2;
  let tmp24;
  let buf8 = new require(12690) /* _has */.Buf8(4);
        ...
        while (true) {
          ...
          if (1 === mode) {
              ...
              if (bits >= 16) {
                if (2 & state.wrap) {
                  if (35615 === buf8) {
                    ...
                    num58 = 0;
                    let num97 = 0;
                    state.check = require(12697)(check11, tmp2, 2, 0);
                    state.mode = 2;
                    next_in = buf8;
                    diff2 = buf8;
                    hold = 0;
            ...
            if (2 === mode) {
              ...
              if (bits >= 16) {
                ...
                if (8 !== (255 & state.flags)) {
                  ...
                  if (512 & state.flags) {
                    ...
                    num58 = 0;
                    let num78 = 0;
                    state.check = require(12697)(check4, tmp2, 2, 0);
                  }
                  state.mode = 3;
                  let num79 = 0;
                  let num80 = 0;
              ...
              if (3 !== mode) {
                      ...
                      if (!(1024 & state.flags)) {
                        ...
                        if (length9) {
                          ...
                          if (512 & state.flags) {
                            ...
                            buf8 = length9;
                            buf8 = tmp18;
                            state.check = require(12697)(check8, tmp16, length9, buf8);
                          }
                          buf8 = tmp20 - length9;
                          buf8 = tmp18 + length9;
                          ...
                          if (4096 & state.flags) {
                            ...
                            if (0 !== tmp20) {
                              ...
                              if (512 & state.flags) {
                                ...
                                buf8 = input;
                                buf8 = tmp18;
                                state.check = require(12697)(check10, tmp16, buf8, buf8);
                              }
                              buf8 = tmp20 - buf8;
                              buf8 = tmp18 + buf8;
                              tmp50 = buf8;
                                    ...
                                    if (14 === mode) {
                                      ...
                                      if (15 !== mode) {
                                        ...
                                        if (16 !== mode) {
                                              ...
                                              if (19 !== mode) {
                                                ...
                                                if (buf8 >= 6) {
                                                  if (avail_out >= 258) {
                                                    ...
                                                    buf8 = num58;
                                                    buf8 = num58;
                                                    buf8 = require(12702) /* inflate_fast */(state, tmp6);
                                            ...
                                            if (state.have >= state.nlen + state.ndist) {
                                              ...
                                              if (state.mode === 30) {
                                                ...
                                                if (0 === state.lens[256]) {
                                                  ...
                                                  buf8 = require;
                                                  buf8 = require;
                                                  buf8 = require(12701) /* inflate_table */;
                                          ...
                                          let num68 = 0;
                                          buf8 = obj;
                                          buf8 = require(12701) /* inflate_table */(0, lens2, 0, 19, lencode, 0, work, obj);
                                          state.lenbits = obj.bits;
                                          if (buf8) {
                    ...
                    if (2048 & state.flags) {
                      ...
                      if (0 !== buf8) {
                        ...
                        if (512 & state.flags) {
                          ...
                          buf8 = check9;
                          buf8 = input;
                          state.check = require(12697)(check9, tmp16, buf8, buf8);
                        }
                        buf8 = buf8 - buf8;
                        buf8 = buf8 + buf8;
                        tmp50 = buf8;
                ...
                if (1024 & state.flags) {
                  ...
                  if (512 & state.flags) {
                    ...
                    num58 = 0;
                    let num92 = 0;
                    num87 = require(12697)(check7, tmp2, 2, 0);
                    state.check = num87;
                    num89 = 0;
                    num90 = 0;
                  }
              ...
              if (num84 >= 16) {
                ...
                if (512 & state.flags) {
                  ...
                  num58 = 0;
                  let num86 = 0;
                  state.check = require(12697)(check6, tmp2, 2, 0);
                }
                state.mode = 5;
                num87 = 0;
                num88 = 0;
            ...
            if (num80 >= 32) {
              ...
              if (512 & state.flags) {
                ...
                num58 = 0;
                let num82 = 0;
                state.check = require(12697)(check5, tmp2, 4, 0);
              }
              state.mode = 4;
              num83 = 0;
              num84 = 0;
          ...
          if (!buf8) {
            ...
            if (state.flags) {
              ...
              buf8 = output;
              buf8 = buf8(12696)(check12, tmp17, buf8, buf8);
            }
            state.check = buf8;
            state.adler = buf8;
          }
