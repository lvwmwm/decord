...
// Module 8136 (_isNativeReflectConstruct)
let Platform;
...
obj.ignoreSilentSwitch = importDefault(dependencyMap[11]).oneOf([]);
...
obj.fullscreenOrientation = importDefault(dependencyMap[11]).oneOf(["light", "dark", "done"]);
