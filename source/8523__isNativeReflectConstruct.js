...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8445, 8515, 8524, 8450, 8461]
...
const items = [
  {
    ...
    value: function render() {
      ...
      const tmp3Result = self(8445)(patternTransform);
      ...
      if (patternContentUnits) {
        num2 = tmp(8515)[patternContentUnits];
      }
      obj[8] = num2;
      obj = {
        ref(arg0) {
      ...
      const tmp3 = self(8445);
      const merged = Object.assign(obj);
      const merged1 = Object.assign(tmp(8450)({ viewBox, preserveAspectRatio }));
