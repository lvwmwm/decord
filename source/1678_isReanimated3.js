...
// Function ID: 1679
// Name: isReanimated3
// Dependencies: [1679, 1637, 1645, 1642, 1680, 1664, 1682, 1671, 1684, 1641]
...
export const getViewProp = function getViewProp(arg0, arg1, arg2) {
  ...
  if (obj.isFabric()) {
    if (!arg2) {
      const reanimatedError = new tmp(1645).ReanimatedError("Function `getViewProp` requires a component to be passed as an argument on Fabric.");
...
export const registerEventHandler = function registerEventHandler(eventHandler) {
  ...
  return ReanimatedModule.registerEventHandler(require(1664) /* freezeObjectInDev */.makeShareableCloneRecursive(handleAndFlushAnimationFrame), arg1, num);
};
...
export const subscribeForKeyboardEvents = function subscribeForKeyboardEvents(eventHandler, isStatusBarTranslucentAndroid) {
  ...
  const shareableCloneRecursive = require(1664) /* freezeObjectInDev */.makeShareableCloneRecursive(handleAndFlushAnimationFrame);
...
export const registerSensor = function registerSensor(arg0, arg1, arg2) {
  if (!global.__sensorContainer) {
    const sensorContainer = new require(1680) /* SensorContainer */.SensorContainer();
    tmp.__sensorContainer = sensorContainer;
  }
  const __sensorContainer = tmp.__sensorContainer;
  return __sensorContainer.registerSensor(arg0, arg1, require(1664) /* freezeObjectInDev */.makeShareableCloneRecursive(arg2));
};
...
export const enableLayoutAnimations = function enableLayoutAnimations(enableLayoutAnimations) {
  ...
  if (flag) {
    ...
    const ReanimatedModule2 = require(1642) /* ReanimatedModule */.ReanimatedModule;
