// Module ID: 12432
// Function ID: 12433
// Dependencies: [5, 12366, 12429, 12433, 12434, 12435, 12428]

// Module 12432
import asyncGeneratorStep from "module_12435";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12366).util;
    ...
    let closure_8 = fn(require("module_12433"));
    let closure_9 = fn(require("module_12434"));
    let closure_10 = fn(require("module_12435"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12428).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12428).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12428).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
