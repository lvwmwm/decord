...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8541, 8600, 8543, 8552]
...
const items = [
  {
    ...
    value: function render() {
      ...
      [tmp2, tmp3] = parts;
      obj[5] = self(8541).meetOrSliceTypes[tmp3] || 0;
      const tmp6 = self(8541).meetOrSliceTypes[tmp3] || 0;
      obj[6] = self(8541).alignEnum[tmp2] || "xMidYMid";
      ...
      const tmp7 = self(8541).alignEnum[tmp2] || "xMidYMid";
      const tmp11 = importDefault(8600);
