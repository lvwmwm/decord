...
// Function ID: 8636
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1500, 1631, 5338, 8636, 4713, 8637, 8639, 8640, 8641, 8642]
// Exports: NativeStackView

// Module 8635 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5338).HeaderShownContext);
  let num5 = React.useContext(num6(5338).HeaderHeightContext);
  const context1 = React.useContext(num6(5338).HeaderBackContext);
  let obj3 = num6(5338);
  ...
  callback = obj2.useCallback(num6(8636).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4713).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4713).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5338).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5338);
  ...
  let eventResult;
  const headerConfigProps = num6(8637).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  obj15[1] = closure_10(num6(5338).HeaderBackContext.Provider, obj16);
  items5[2] = closure_10(num6(5338).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = closure_11(num6(5338).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(8639).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4713).ScreenStackItem, obj4);
