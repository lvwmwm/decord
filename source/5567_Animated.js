...
export const forHorizontalIOS = function forHorizontalIOS(layouts) {
  ...
  let obj = {};
  obj = {};
  obj = { translateX: callback(progress.interpolate({ inputRange: [null, null], outputRange: items, extrapolate: "clamp" }), inverted) };
  ...
  obj.overlayStyle = { opacity: progress3.interpolate({ inputRange: [null, null], outputRange: ["<string:3398392872>", "<string:1211187289>"], extrapolate: "clamp" }) };
  const obj3 = { opacity: progress3.interpolate({ inputRange: [null, null], outputRange: ["<string:3398392872>", "<string:1211187289>"], extrapolate: "clamp" }) };
  const progress4 = current.progress;
  obj.shadowStyle = { shadowOpacity: progress4.interpolate({ inputRange: [null, null], outputRange: [-520405018, 1431658495], extrapolate: "clamp" }) };
  return obj;
};
export const forVerticalIOS = function forVerticalIOS(inverted) {
  let obj = {};
  obj = {};
  obj = { translateY: callback(progress.interpolate({ inputRange: [null, null], outputRange: items, extrapolate: "clamp" }), inverted.inverted) };
...
export const forModalPresentationIOS = function forModalPresentationIOS(next) {
  ...
  const tmp3Result = closure_2(progress.interpolate({ inputRange: [null, null], outputRange: [null, null], extrapolate: "clamp" }), num3);
  obj = { inputRange: [] };
  ...
  if (screen.width <= screen.height) {
    if (tmp5) {
      const obj1 = { inputRange: [], outputRange: ["PRIVATE_CHANNEL_INTEGRATIONS", "CONVERSATION_SUMMARIES", "gatedChannelId", "isArray"] };
      num = tmp3Result.interpolate(obj1);
    }
    num9 = num;
  }
  const obj2 = {};
  const obj3 = { "Bool(false)": "500", "Bool(false)": 10, "Bool(false)": "1.5", TIME_UPDATE: "M8,16a8,8,0,1,1,8-8A8,8,0,0,1,8,16ZM8,1.53A6.47,6.47,0,1,0,14.47,8,6.47,6.47,0,0,0,8,1.53Z", SEEKING: "1.5", borderTopLeftRadius: num9, borderTopRightRadius: num9 };
  let num10 = 0;
  if (0 !== index) {
    num10 = top;
  }
...
export const forFadeFromBottomAndroid = function forFadeFromBottomAndroid(current) {
  ...
  const tmp = callback(progress.interpolate({ inputRange: [null, null], outputRange: items, extrapolate: "clamp" }), inverted);
...
export const forRevealFromBottomAndroid = function forRevealFromBottomAndroid(layouts) {
  ...
  let obj = {};
  obj = { overflow: "hidden" };
  obj = { translateY: callback(progress.interpolate({ inputRange: [null, null], outputRange: items, extrapolate: "clamp" }), inverted) };
  const progress = current.progress;
  const items = [screen.height, ];
  let num = 0;
  items[1] = 0;
  ...
  const items3 = [{ translateY: callback(progress2.interpolate({ inputRange: [null, null], outputRange: items2, extrapolate: "clamp" }), inverted) }, ];
  const obj3 = {};
  if (next) {
    const progress3 = next.progress;
    const obj4 = { inputRange: [null, null] };
  ...
  obj.cardStyle = obj1;
  const obj2 = { translateY: callback(progress2.interpolate({ inputRange: [null, null], outputRange: items2, extrapolate: "clamp" }), inverted) };
  const progress4 = current.progress;
  obj.overlayStyle = { opacity: progress4.interpolate({ inputRange: [], outputRange: ["updateUserSoundboardVolume", "onStartShouldSetPanResponderCapture", "usePIPState"], extrapolate: "clamp" }) };
  return obj;
};
export const forScaleFromCenterAndroid = function forScaleFromCenterAndroid(closing) {
  ...
  const tmpResult = closure_2(progress.interpolate({ inputRange: [null, null], outputRange: [null, null], extrapolate: "clamp" }), num);
  obj = {};
  obj = { opacity: tmpResult.interpolate({ inputRange: ["useRichChatTextBox", "STALL_TOTAL_TIME", "SmokeIllocon", "<string:826302941>", "<string:1099511628>", "<string:1080154464>", "<string:2542620721>"], outputRange: [] }) };
  const obj1 = {};
  const progress3 = current.progress;
  const interpolateResult = progress.interpolate({ inputRange: [null, null], outputRange: [null, null], extrapolate: "clamp" });
  const tmp = closure_2;
  const tmp3 = importDefault(dependencyMap[1]);
  obj1.scale = tmp3(closing.closing, progress3.interpolate({ inputRange: [null, null], outputRange: [1070977777, 1065151889], extrapolate: "clamp" }), tmpResult.interpolate({ inputRange: [], outputRange: [] }));
  const items = [obj1];
  obj.transform = items;
  obj.cardStyle = obj;
  return obj;
...
export const forBottomSheetAndroid = function forBottomSheetAndroid(current) {
  ...
  const progress2 = current.progress;
  const tmp = callback(progress.interpolate({ inputRange: [null, null], outputRange: items, extrapolate: "clamp" }), inverted);
  obj.opacity = importDefault(dependencyMap[1])(closing, current.progress, progress2.interpolate({ inputRange: [null, null], outputRange: [null, null], extrapolate: "clamp" }));
  const items1 = [{ translateY: tmp }];
  obj.transform = items1;
  obj.cardStyle = obj;
  obj = { opacity: progress3.interpolate({ inputRange: [null, null], outputRange: [-520405018, 1431658495], extrapolate: "clamp" }) };
  const progress3 = current.progress;
...
export const forFadeFromCenter = function forFadeFromCenter(current) {
  ...
  obj.cardStyle = obj;
  obj = { opacity: progress.interpolate({ inputRange: [null, null], outputRange: [false, false], extrapolate: "clamp" }) };
  obj.overlayStyle = obj;
  return obj;
};
