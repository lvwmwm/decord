...
// Dependencies: [5, 41, 42, 93, 95, 98, 32, 19, 21, 8649, 8650]
// Exports: SvgUri, getStyle

// Module 8648 (_isNativeReflectConstruct)
  ...
  function openingTag() {
    ...
    if ("?" === sum) {
      ...
      if ("/" !== sum) {
        ...
        if (typeof obj.style !== "__FORMATJS_LISTFORMAT_DATA__") {
          obj.styles = str15;
          obj = {};
...
export const getStyle = function getStyle(str) {
  ...
  for (let num = 0; num < length; num = num + 1) {
    ...
    if (0 !== arr3.length) {
      ...
      let tmp3 = camelCase;
      let str3 = str.trim();
      if (typeof camelCase !== "fileFinishedImporting") {
