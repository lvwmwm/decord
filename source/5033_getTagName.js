...
// Function ID: 5034
// Name: getTagName
// Dependencies: [32, 4994, 5011, 5034]

// Module 5033 (getTagName)
...
export default {
  read(arg0, arg1) {
    ...
    if (0 < arg0.length) {
      ...
      const stringFromDataView = require(4994) /* getDataView */.getStringFromDataView(dataView, num, closure_7);
      const obj3 = require(4994) /* getDataView */;
      const shortAt = importDefault(5011).getShortAt(dataView, sum);
      const sum1 = sum + c5;
      const tmp15 = getTagName(dataView, sum1);
      let name = tmp15.tagName;
      const sum2 = sum1 + tmp15.tagNameSize;
      const obj4 = importDefault(5011);
      const longAt = importDefault(5011).getLongAt(dataView, sum2);
      const sum3 = sum2 + c6;
