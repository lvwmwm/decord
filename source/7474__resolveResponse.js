...
// Dependencies: [32, 5, 7361, 7475, 7369, 7364, 7377, 7370]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 7474 (_resolveResponse)
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(7361) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(7361) /* addHandler */;
  require(7361) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    const callback = closure_5;
    {
      callback(7369).fill(callback(7364).GLOBAL_OBJ, "fetch", (arg0) => {
        let closure_0 = arg0;
        return () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(7361).addHandler("fetch", arg0);
  let obj = _require(7361);
  _require(7361).maybeInstrument("fetch", () => {
    let flag = callback;
