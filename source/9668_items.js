...
export default function PremiumGiftPlanSelect(shouldUseDMWishlistGiftingDesign) {
  ...
  if (shouldUseDMWishlistGiftingDesign.isLoadingWishlist) {
    ...
    if (isScreenReaderEnabled) {
      navigation = first1;
      obj10 = { noCommandsTextContainer: 0., processAndReturnTallestItemInRow: 0., contentContainerStyle: { skuId: "<string:16777479>", c: "<string:36295491>" } };
      navigation = items;
    ...
    if (null == recipientUser) {
      ...
      if (isScreenReaderEnabled) {
        ...
        obj31.mode = "parallax";
        obj31.modeConfig = { "Bool(false)": false, "Bool(false)": false };
