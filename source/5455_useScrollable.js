...
// Function ID: 5456
// Name: useScrollable
// Dependencies: [19, 1653, 5440, 5456]
// Exports: useScrollable

// Module 5455 (useScrollable)
...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(require(5440) /* GESTURE_SOURCE */.SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = require(1653) /* cancelAnimation */.useSharedValue(0);
  const obj2 = require(1653) /* cancelAnimation */;
  const sharedValue2 = require(1653) /* cancelAnimation */.useSharedValue(require(5440) /* GESTURE_SOURCE */.SCROLLABLE_STATE.UNDETERMINED);
