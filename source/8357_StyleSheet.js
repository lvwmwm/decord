...
// Function ID: 8358
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1481, 8358, 5659, 8359, 4601]
// Exports: default

// Module 8357 (StyleSheet)
...
export default function HeaderConfig(arg0) {
  ...
  importDefault(8359)();
  const isSearchBarAvailableForCurrentPlatform = tmp(4601).isSearchBarAvailableForCurrentPlatform;
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = tmp(4601).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (require(4601) /* enableScreens */.isNewBackTitleImplementation) {
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" !== headerTitleAlign) {
      ...
      if (typeof headerTitle !== "function") {
        ...
        obj5[1] = obj;
        obj5[2] = headerTitle;
        tmp37Result = tmp37(tmp(5659).HeaderTitle, obj5);
      }
      tmp40 = tmp37Result;
    }
    ...
    tmp37Result = tmp37(tmp(4601).ScreenStackHeaderLeftView, obj6);
    const tmp38 = View;
  } else {
    tmp37Result = null;
  }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      obj7[1] = obj;
      obj7[2] = headerTitle;
      headerTitleResult = tmp43(tmp(5659).HeaderTitle, obj7);
    }
    const obj8 = { children: null };
    obj8[0] = headerTitleResult;
    tmp43Result = tmp43(tmp(4601).ScreenStackHeaderCenterView, obj8);
  }
  ...
  if (undefined !== headerBackImageSource) {
    ...
    tmp44 = callback2(tmp(4601).ScreenStackHeaderBackButtonImage, obj9);
  }
  items3[1] = tmp44;
  let tmp46 = null;
  if (null != headerRightResult) {
    ...
    tmp46 = callback2(tmp(4601).ScreenStackHeaderRightView, obj10);
  }
  items3[2] = tmp46;
  let tmp48 = null;
  if (tmp17) {
    ...
    obj11[0] = callback2(tmp(4601).SearchBar, obj12);
    tmp48 = callback2(tmp(4601).ScreenStackHeaderSearchBarView, obj11);
  }
  items3[3] = tmp48;
  obj3[31] = items3;
  return closure_9(require(4601) /* enableScreens */.ScreenStackHeaderConfig, obj3);
};
