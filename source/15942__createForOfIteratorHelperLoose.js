...
// Module 15942 (_createForOfIteratorHelperLoose)
...
function MainAreaCanUpload(arg0) {
  ...
  const formatSizeResult = obj.formatSize(maxSizeBytes / arg1(dependencyMap[8]).BYTE_IN_KB, { "Bool(true)": null, "Bool(true)": null });
