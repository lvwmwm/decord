...
// Dependencies: [32, 7744, 7745, 7783, 7749]
...
export const eventFromMessage = function eventFromMessage(arg0, message, arg2, event_id) {
    ...
    if (event_id) {
      if (event_id.syntheticException) {
        ...
        if (arr.length) {
          ...
          obj[0] = items;
          obj.exception = obj;
          const result = require(7749) /* addContextToFrame */.addExceptionMechanism(obj, { synthetic: true });
          const obj5 = require(7749) /* addContextToFrame */;
        }
  ...
  obj6 = require(7745) /* isInstanceOf */;
};
export const eventFromUnknownInput = function eventFromUnknownInput(getOptions, arg1, name, data) {
  ...
  let obj1 = require(7745) /* isInstanceOf */;
  if (obj1.isError(name)) {
    ...
    if (tmp2Result.isPlainObject(name)) {
      ...
      if (tmp12) {
        ...
        const result = require(7744) /* addNonEnumerableProperty */.extractExceptionKeysForMessage(name);
        const obj6 = require(7744) /* addNonEnumerableProperty */;
        ...
        obj7 = require(7745) /* isInstanceOf */;
      }
    } else {
  ...
  const result1 = require(7749) /* addContextToFrame */.addExceptionTypeValue(obj2, undefined, undefined);
  const obj11 = require(7749) /* addContextToFrame */;
  const result2 = require(7749) /* addContextToFrame */.addExceptionMechanism(obj2, data);
  const obj3 = {};
