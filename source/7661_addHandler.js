...
// Function ID: 7662
// Name: addHandler
// Dependencies: [7662, 7663, 7666]

// Module 7661 (addHandler)
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (__SENTRY_DEBUG__.DEBUG_BUILD) {
          const logger = tmp19(7663).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(7666).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(7666);
        }
      }
    }
