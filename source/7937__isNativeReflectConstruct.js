...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 7843, 7851, 7857, 7850, 7938, 7934, 7859]

// Module 7937 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(7851).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
      ...
      if (tmp5) {
        ...
        obj[6] = midLine;
        const merged = Object.assign(withoutXYResult, importDefault(7857)(obj, true), obj);
        ...
        obj[1] = children;
        return jsx(importDefault(7934), { ref: null, children: null });
      }
