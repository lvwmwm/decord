...
arg5.useAnimatedGesture = function useAnimatedGesture(current2, needsToReattachResult) {
  if (needsToReattachResult(arg6[3]).Reanimated) {
    ...
    current2.animatedEventHandler = Reanimated3.useEvent(pnpm_useAnimatedGestureTs6, ["NitroGem9Lottie", "useFirstMediaIsEmbed"], needsToReattachResult);
