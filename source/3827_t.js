...
const fn = function t() {
  ...
  function parserFor(rules) {
    ...
    let closure_4 = new Map();
    const items = [];
    const parseTableAlignCapture = items;
    ...
    function nestedParse(content, arg1) {
      ...
      if (sum > 1000) {
        ...
        if (content) {
          ...
          const _Error2 = Error;
          const error1 = new Error("Could not find a matching rule for the below content. The rule with highest `order` should always match content provided to it. Check the definition of `match` for '" + found[closure_2.length - 1] + "'. It seems to not match the following source:\n" + str3);
          throw error1;
        }
        return items;
      }
    }
    let closure_7 = nestedParse;
    function outerParse(arg0, arg1) {
      const tmp = callback2(arg1, arg1);
      let disableAutoBlockNewlines = tmp.inline;
      if (!disableAutoBlockNewlines) {
        disableAutoBlockNewlines = tmp.disableAutoBlockNewlines;
      }
      let text = arg0;
      if (!disableAutoBlockNewlines) {
        text = `${arg0}
      ...
      return nestedParse(callback(text), tmp);
    }
    ...
    if (keys !== undefined) {
      ...
      while (keys[tmp] !== undefined) {
        ...
        if (!tmp6) {
          ...
          let text = ` ${closure_19(tmp5)}`;
          str = `${tmp4}${` ${closure_19(tmp5)}`}="${closure_19(tmp14)}"`;
          // continue
        }
        continue;
      }
  ...
  function sanitizeText(content) {
    return String(content).replace(closure_17, (arg0) => closure_18[arg0]);
  }
  let closure_20 = /\\([^0-9A-Za-z\s])/g;
  ...
  function parseTableRow(str, arg1, inTable) {
    ...
    const arr = arg1(str.trim(), inTable);
    let closure_1 = arr;
  ...
  function parseTable(arg0) {
    let closure_0 = arg0;
    return (arg0, arg1, arg2) => {
      arg2.inline = true;
      let str2 = str;
      if (arg0) {
        str2 = str.replace(arg0, "");
      }
      const tmp = arg0;
      const tmp2 = callback(arg0[1], arg1, arg2, arg0);
      const parts = str2.trim().split("|");
      const mapped = parts.map(closure_5);
      arg2.inline = false;
      ...
      return {
        ...
        cells: function parseTableCells(str, arg1, arg2, arg3) {
          ...
          return parts.map((arg0) => callback(arg0, arg1, arg2, arg3));
        }(arg0[3], arg1, arg2, tmp)
      };
    };
  }
  let closure_31 = /mailto:/i;
  ...
  while (true) {
    ...
    obj5.react = function react(lang, arg1, key) {
      ...
      let obj = { children: reactElement("code", null, obj) };
    ...
    obj8.parse = function parse(arg0, arg1, arg2) {
      ...
      const match = arg0[0].replace(tmp3, "\n").match(regExp1);
      let closure_2 = match;
      let closure_3 = false;
      const obj = {
        ...
        items: match.map((str) => {
          ...
          const replaced = str.replace(regExp, "").replace(regex, "");
          ...
          if (tmp4) {
            tmp5.inline = false;
            let replaced1 = replaced.replace(closure_28, "\n\n");
          } else {
            tmp5.inline = true;
            replaced1 = replaced.replace(closure_28, "");
          }
          arg2.inline = inline;
          arg2._list = _list;
          return arg1(replaced1, arg2);
        })
      };
      return obj;
    };
    obj8.react = function react(ordered, arg1, key) {
      ...
      return reactElement(str, key.key, { start: ordered.start, children: items.map((arg0, arg1) => callback("li", `${arg1}`, { children: arg1(arg0, arg2) })) });
    };
    obj8.html = function html(items) {
      let closure_0 = arg1;
      let closure_1 = arg2;
      items = items.items;
      const mapped = items.map((arg0) => callback("li", arg1(arg0, arg2)));
      let str = "ul";
    ...
    obj10.react = function react(arg0, arg1, key) {
      ...
      function getStyle(arg0) {
        if (null == arg0.align[arg0]) {
          let obj = {};
        } else {
          obj = { textAlign: arg0.align[arg0] };
        }
        return obj;
      }
      ({ header, cells } = arg0);
      const mapped = header.map((arg0, arg1) => callback("th", `${arg1}`, { style: getStyle(arg1), scope: "col", children: arg1(arg0, arg2) }));
      let obj = {};
      obj = {};
      const mapped1 = cells.map((arr) => callback("tr", `${arg1}`, { children: arr.map((arg0, arg1) => callback3("td", `${arg1}`, { style: callback2(arg1), children: callback(arg0, closure_2) })) }));
    ...
    obj10.html = function html(header) {
      ...
      const mapped = header.map((arg0, arg1) => {
        ...
        return callback("th", arg1(arg0, arg2), obj);
      });
      const cells = header.cells;
      const joined = mapped.join("");
      const mapped1 = cells.map((arr) => {
        const mapped = arr.map((arg0, arg1) => {
          const obj = { style: callback2(arg1) };
          return callback3("td", callback(arg0, closure_2), obj);
        });
        return callback("tr", mapped.join(""));
      });
        ...
        if (_Array[html]) {
          ...
          function nestedOutput(arg0, arg1) {
            ...
            if (Array.isArray(arg0)) {
              ...
              tmp6 = arg0[arg0.type][closure_1](arg0, nestedOutput, tmp);
              const tmp3 = arg0[arg0.type];
            }
            return tmp6;
          }
    ...
    let obj29 = {
      ...
      ruleOutput(importDefaultResultResult, react) {
          let tmp = react;
          let closure_0 = importDefaultResultResult;
          let closure_1 = react;
          if (!react) {
            const _console = console;
          ...
          return function nestedRuleOutput(arg0, arg1, arg2) {
            return arg0[arg0.type][closure_1](arg0, arg1, arg2);
          };
        },
      reactFor(arg0) {
          let closure_0 = arg0;
          function nestedOutput(arg0, arg1) {
            ...
            if (Array.isArray(arg0)) {
              ...
              return arg0(arg0, nestedOutput, obj);
            }
          }
          let closure_1 = nestedOutput;
          return nestedOutput;
        },
      htmlFor(arg0) {
          let closure_0 = arg0;
          function nestedOutput(arr) {
            ...
            if (Array.isArray(arr)) {
              const mapped = arr.map((arg0) => callback(arg0, obj));
              let joined = mapped.join("");
            } else {
              joined = arr(arr, nestedOutput, obj);
            }
            return joined;
          }
          let closure_1 = nestedOutput;
