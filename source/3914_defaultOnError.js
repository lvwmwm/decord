...
// Function ID: 32267
// Name: defaultOnError
// Dependencies: [29, 31, 33, 3915, 3916, 3918, 3896]
// Exports: RiveView

// Module 3914 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + require(3915).RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp15 = jsx(_require(3896).NitroRiveView, Object.assign({}, tmp3, obj1));
  cResult[12] = tmp3;
  cResult[13] = tmp12;
  cResult[14] = tmp13;
  cResult[15] = tmp15;
