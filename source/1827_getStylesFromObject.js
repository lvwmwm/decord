...
if (!isJest.isJest()) {
  require = () => {
    const reanimatedError = new require(1665) /* t */.ReanimatedError("`setUpTests` is available only in Jest environment.");
