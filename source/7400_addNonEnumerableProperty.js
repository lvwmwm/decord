...
// Dependencies: [7393, 7394, 7401, 7402, 7403]

// Module 7400 (addNonEnumerableProperty)
const require = arg1;
...
function addNonEnumerableProperty(arg0, arg1, arg2) {
  try {
    ...
    if (require(7393) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = require(7402) /* _htmlElementAsString */.htmlTreeAsString(arg0);
      const tmp2Result = require(7402) /* _htmlElementAsString */;
    } else {
      const _Object = Object;
...
arg5.extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return require(7403) /* isMatchingPattern */.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = require(7403) /* isMatchingPattern */.truncate(joined, num);
