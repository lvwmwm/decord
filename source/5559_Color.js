...
obj = {
  ...
  string(arg0) {
    const self = this;
    let self2 = this;
    if (!(this.model in require(5564) /* clamp */.to)) {
      self2 = self.rgb();
    }
    let num = 1;
    ...
    const to = require(5564) /* clamp */.to;
  ...
  percentString(arg0) {
    ...
    const rgb = require(5564) /* clamp */.to.rgb;
  ...
  object() {
    const self = this;
    const obj = {};
    const channels = require(5560) /* keys */[this.model].channels;
    for (let num = 0; num < channels; num = num + 1) {
      obj[require(5560) /* keys */[this.model].labels[num]] = self.color[num];
    }
    if (1 !== self.valpha) {
  ...
  keyword(color) {
    ...
    if (undefined !== color) {
      ...
      keywordResult = require(5560) /* keys */[self.model].keyword(self.color);
      const obj = require(5560) /* keys */[self.model];
    }
