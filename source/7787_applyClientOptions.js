...
// Dependencies: [7749, 7752, 7765, 7788, 7789, 7775, 7747, 7790, 7783, 7759]
...
function applyClientOptions(environment, environment2) {
  ...
  if (!DEFAULT_ENVIRONMENT) {
    DEFAULT_ENVIRONMENT = require(7775).DEFAULT_ENVIRONMENT;
  }
  ...
  if (environment.message) {
    environment.message = require(7747) /* isMatchingPattern */.truncate(environment.message, num);
    const obj = require(7747) /* isMatchingPattern */;
  }
  let value = iter;
  ...
  if (value) {
    iter.value = require(7747) /* isMatchingPattern */.truncate(iter.value, num);
  ...
  if (url) {
    request.url = require(7747) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(7747) /* isMatchingPattern */;
  }
}
