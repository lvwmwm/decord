...
// Function ID: 13511
// Name: state
// Dependencies: [13474, 13449, 13511, 13465, 13512, 13494, 13472, 13505]
...
if (!require("all")) {
  if (!require("__core-js_shared__").state) {
    ...
    let fn = function t(facade) {
      if (require(13472) /* call */(facade, closure_6)) {
    ...
    let fn2 = function n(arg0) {
      return require(13472) /* call */(arg0, closure_6) ? arg0[closure_6] : {};
    };
    let fn5 = fn2;
    let fn3 = function u(arg0) {
      return require(13472) /* call */(arg0, closure_6);
    };
    let fn6 = fn3;
  }
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new require(13449).TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
