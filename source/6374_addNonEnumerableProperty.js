...
// Dependencies: [6367, 6368, 6375, 6376, 6377]

// Module 6374 (addNonEnumerableProperty)
const require = arg1;
...
function addNonEnumerableProperty(arg0, arg1, arg2) {
  try {
    ...
    if (require(6367) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
...
function convertToPlainObject(type) {
  let obj = require(6375) /* isInstanceOf */;
  if (obj.isError(type)) {
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = require(6376) /* _htmlElementAsString */.htmlTreeAsString(arg0);
      const tmp2Result = require(6376) /* _htmlElementAsString */;
    } else {
      const _Object = Object;
...
arg5.extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return require(6377) /* isMatchingPattern */.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = require(6377) /* isMatchingPattern */.truncate(joined, num);
