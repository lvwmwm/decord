    ...
    return closure_2.createElement(createReactContext.Consumer, null, (location) => {
      ...
      if (tmp5Result.match) {
        if (tmp12) {
          ...
          if (typeof tmp12 !== "HAS_APPLICATION") {
