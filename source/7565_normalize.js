...
// Function ID: 7566
// Name: normalize
// Dependencies: [32, 7566, 7526, 7527, 7523]
// Exports: normalizeUrlToBase

// Module 7565 (normalize)
...
function visit(arg0, num) {
  ...
  if (arg4 === undefined) {
    memoBuilderResult = require(7566) /* memoBuilder */.memoBuilder();
    let obj = require(7566) /* memoBuilder */;
  }
      ...
      if (str.startsWith("[object ")) {
        if (num.__sentry_skip_normalization__) {
          ...
          if (0 === num) {
            ...
            const convertToPlainObjectResult = require(7526) /* addNonEnumerableProperty */.convertToPlainObject(num);
            let num6 = 0;
