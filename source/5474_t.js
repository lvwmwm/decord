...
function create(handlerTag) {
  ...
  obj = { wrappedSetGestureState: fn, handlerTag, State: _require(5473).State };
  fn.__closure = obj;
  ...
  S.__closure = { wrappedSetGestureState: fn, handlerTag, State: _require(5473).State };
  ...
  const obj1 = { wrappedSetGestureState: fn, handlerTag, State: _require(5473).State };
  fn3.__closure = { wrappedSetGestureState: fn, handlerTag, State: _require(5473).State };
  fn3.__workletHash = 6198601582791;
  fn3.__initData = closure_6;
  obj[4] = fn3;
  return obj;
}
obj = { wrappedSetGestureState: fn, State: require("module_5473").State };
