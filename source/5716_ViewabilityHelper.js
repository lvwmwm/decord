...
// Dependencies: [5699, 5700, 5687]

// Module 5716 (ViewabilityHelper)
      ...
      if (null !== prop) {
        ...
        if (undefined !== prop1) {
          ...
          if (null !== prop2) {
            ...
            if (undefined !== prop3) {
              const _Error = Error;
              const error = new Error(timerId(5687).ErrorMessages.multipleViewabilityThresholdTypesNotSupported);
              throw error;
            }
          }
        }
