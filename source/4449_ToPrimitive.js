...
// Function ID: 4450
// Name: ToPrimitive
// Dependencies: [1402, 4450, 4451, 4452]
...
export default function ToPrimitive(arg0) {
  let tmp22;
  if (require(4450) /* isPrimitive */(arg0)) {
    return arg0;
  } else {
    let str2 = "default";
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4452)(arg0) || tmp(4451)(arg0);
          const tmp15 = tmp(4452)(arg0) || tmp(4451)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
