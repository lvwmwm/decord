...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5643, 5644]
...
obj = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5643).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
    ...
    value: function renderLottieView() {
      ...
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(importDefault(5643), { ref: null });
        }
      }
