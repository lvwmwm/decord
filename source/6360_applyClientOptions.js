...
// Dependencies: [57, 65, 6322, 6325, 6338, 6361, 6362, 6348, 6320, 6363, 6356, 6332]
// Exports: parseEventHintOrCaptureContext, prepareEvent

// Module 6360 (applyClientOptions)
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = require(6320) /* isMatchingPattern */.truncate(environment.message, num);
  ...
  if (value) {
    iter.value = require(6320) /* isMatchingPattern */.truncate(iter.value, num);
    const obj2 = require(6320) /* isMatchingPattern */;
  }
  ...
  if (url) {
    request.url = require(6320) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(6320) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(6363).getFilenameToDebugIdMap(arg1);
...
export const parseEventHintOrCaptureContext = function parseEventHintOrCaptureContext(captureContext) {
  if (captureContext) {
    let tmp3 = captureContext instanceof require(6332) /* ScopeClass */.Scope;
    if (!tmp3) {
