...
// Dependencies: [32, 109, 17, 21, 5269, 1481, 8498, 5260, 4631]
// Exports: useHeaderConfigProps

// Module 8497 (processBarButtonItems)
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      items5[1] = null;
      obj6[1] = items5;
      let tmp33Result = tmp33(tmp(4631).ScreenStackHeaderLeftView, obj6);
    } else {
      if (typeof headerTitle === "function") {
        ...
        obj9[1] = obj;
        obj9[2] = headerTitle;
        obj8[1] = tmp63(tmp(5260).HeaderTitle, obj9);
      }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      obj10[1] = obj;
      obj10[2] = headerTitle;
      headerTitleResult = tmp39(tmp(5260).HeaderTitle, obj10);
    }
    const obj11 = { children: null };
    obj11[0] = headerTitleResult;
    tmp39Result = tmp39(tmp(4631).ScreenStackHeaderCenterView, obj11);
  }
  ...
  if (undefined !== headerBackIcon) {
    ...
    obj12[0] = source;
    let tmp41Result = callback3(tmp(4631).ScreenStackHeaderBackButtonImage, obj12);
  ...
  if (null != headerRightResult) {
    ...
    tmp43 = callback3(tmp(4631).ScreenStackHeaderRightView, obj13);
  }
  items7[2] = tmp43;
  let tmp45 = null;
  if (isSearchBarAvailableForCurrentPlatform2) {
    ...
    obj14[0] = callback3(tmp(4631).SearchBar, obj15);
    tmp45 = callback3(tmp(4631).ScreenStackHeaderSearchBarView, obj14);
  }
  items7[3] = tmp45;
