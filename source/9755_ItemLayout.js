...
// Function ID: 9756
// Name: ItemLayout
// Dependencies: [19, 21, 9738, 9756, 1606]
// Exports: ItemLayout
...
export const ItemLayout = (animationStyle) => {
  ...
  const merged = Object.assign(typeof customConfig === "fileFinishedImporting" ? customConfig() : {});
  ...
  const tmp4 = typeof customConfig === "fileFinishedImporting" ? customConfig() : {};
  class E {
    constructor() {
