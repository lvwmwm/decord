...
// Dependencies: [3380, 3384, 3574]
// Exports: default

// Module 3788 (roundToNearestMinutes)
  ...
  if (arguments.length < 1) {
    ...
    if (defaultResult >= 1) {
      if (defaultResult <= 30) {
        ...
        const _Math = Math;
        const result = require(3574) /* getRoundingMethod */.getRoundingMethod(roundingMethod)(sum / defaultResult) * defaultResult;
        const _Date = Date;
