...
// Function ID: 4777
// Name: ScreenStack
// Dependencies: [109, 19, 21, 4761, 4777, 4778, 4765]
// Exports: default

// Module 4776 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(ref1(4777).GHContext);
  obj = {
  ...
  ref2(4761)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4761)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4765).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = children;
  obj1[6] = jsx(ref2(4778), {});
  ...
  return jsx(tmp4(4777).RNSScreensRefContext.Provider, { value: ref, children: null });
};
