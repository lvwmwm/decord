...
// Dependencies: [1634, 5411]

// Module 5414 (cancelAnimation)
try {
  ...
  if (!setGestureState) {
    const fn = function t() {
      console.warn(require(5411) /* toArray */.tagMessage("Please use newer version of react-native-reanimated in order to control state of the gestures."));
    };
