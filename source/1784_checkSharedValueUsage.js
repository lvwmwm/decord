...
// Dependencies: [19, 17, 1637, 1785, 1780, 1734, 1645, 1786, 1706, 1678, 1732]
// Exports: useAnimatedStyle

// Module 1784 (checkSharedValueUsage)
      ...
      if (typeof value === "object") {
        if (null !== value) {
          if (undefined !== value.value) {
            ...
            const reanimatedError = new require(1645) /* t */.ReanimatedError("Invalid value passed to `" + nextResult + "`, maybe you forgot to use `.value`?");
...
function styleUpdater(arg0, arg1, animations) {
  ...
  if (boxShadow) {
    _require(1785).processBoxShadow(obj);
    const obj3 = _require(1785);
  }
  obj = {};
  let flag2 = false;
  let flag3 = false;
  ...
  if (flag5) {
    ...
    if (flag4) {
      _require(1734).updateProps(arg0, obj);
      const obj8 = _require(1734);
    }
  } else {
    animations.isAnimationCancelled = true;
    animations.animations = [];
    let shallowEqualResult = _require(1780).shallowEqual(last, obj);
