// Module ID: 12339
// Function ID: 12340
// Dependencies: [5, 12273, 12336, 12340, 12341, 12342, 12335]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12273).util;
    ...
    let closure_8 = fn(require("module_12340"));
    let closure_9 = fn(require("module_12341"));
    let closure_10 = fn(require("module_12342"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12335).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12335).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12335).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
