...
const fn = function t(arg0, arg1) {
  ...
  if (globalThis._setGestureStateSync) {
    ...
    const _Error = Error;
    const error = new Error(require(5432) /* tagMessage */.tagMessage("Failed to set gesture state"));
    throw error;
  }
};
...
const fn2 = function _(arg0) {
  const ACTIVE = require(5433).State.ACTIVE;
...
const fn3 = function n(arg0) {
  const FAILED = require(5433).State.FAILED;
  if (typeof fn !== "function") {
    HermesBuiltin.throwTypeError();
  }
  const _globalThis = globalThis;
...
const fn4 = function s(arg0) {
  const END = require(5433).State.END;
  if (typeof fn !== "function") {
    HermesBuiltin.throwTypeError();
  }
  const _globalThis = globalThis;
