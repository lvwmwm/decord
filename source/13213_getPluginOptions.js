...
const obj7 = { verticalAlign: true, flexDirection: true, platform: _module1.Platform.OS, platformVersion: _module1.Platform.Version, osRelease, model, serverHost, forceTouch, interfaceIdiom, systemName, uiMode, serial, reactNativeVersion: result.default() };
