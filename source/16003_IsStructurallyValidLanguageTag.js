...
// Dependencies: [16004, 16005]

// Module 16003 (IsStructurallyValidLanguageTag)
let require = arg1;
const dependencyMap = arg6;
function IsStructurallyValidLanguageTag(StringResult1) {
  const expBCP47Syntax = require(16004) /* RegExpResult1 */.expBCP47Syntax;
  const tmp = !expBCP47Syntax.test(StringResult1);
  let tmp2 = !tmp;
  if (!tmp) {
    const expVariantDupes = require(16004) /* RegExpResult1 */.expVariantDupes;
    let tmp5 = !expVariantDupes.test(StringResult1);
    if (tmp5) {
      const expSingletonDupes = require(16004) /* RegExpResult1 */.expSingletonDupes;
...
function CanonicalizeLanguageTag(StringResult1) {
  ...
  const match = str5.match(require(16004) /* RegExpResult1 */.expExtSequences);
  let tmp2 = match;
  if (match) {
    tmp2 = match.length > 1;
  }
  ...
  if (tmp2) {
    ...
    replaced = str5.replace(RegExp(`(?:${require(16004) /* RegExpResult1 */.expExtSequences.source})+`, "i"), join.call(match, ""));
    const RegExpResult = RegExp(`(?:${require(16004) /* RegExpResult1 */.expExtSequences.source})+`, "i");
  }
  let str10 = replaced;
    ...
    if (tmp) {
      if (tmp["[[initializedNumberFormat]]"]) {
        if (undefined === tmp["[[boundFormat]]"]) {
          tmp4 = f123673;
          tmp["[[boundFormat]]"] = f123673.call(function F(arg0) {
...
function InitializeDateTimeFormat(prototype, first, arg2) {
  ...
  if (true === tmp["[[initializedIntlObject]]"]) {
    ...
    if ("[object Array]" !== toString.call(formats)) {
      obj = require(16005) /* isDateFormatOnly */;
  ...
  constructor() {
    ...
    if (tmp) {
      if (tmp["[[initializedDateTimeFormat]]"]) {
        if (undefined === tmp["[[boundFormat]]"]) {
          tmp4 = f123673;
          tmp["[[boundFormat]]"] = f123673.call(function F() {
...
class List {
  constructor() {
    tmp = f123669(this, "length", { writable: true, value: 0 });
    if (arguments.length) {
      tmp2 = push;
      tmp3 = slice;
      tmp4 = arguments;
