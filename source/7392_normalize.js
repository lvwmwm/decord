...
// Function ID: 7393
// Name: normalize
// Dependencies: [32, 7393, 7353, 7354, 7350]
// Exports: normalizeUrlToBase

// Module 7392 (normalize)
...
function visit(arg0, num) {
  ...
  if (arg4 === undefined) {
    memoBuilderResult = require(7393) /* memoBuilder */.memoBuilder();
    let obj = require(7393) /* memoBuilder */;
  }
      ...
      if (str.startsWith("[object ")) {
        if (num.__sentry_skip_normalization__) {
          ...
          if (0 === num) {
            ...
            const convertToPlainObjectResult = require(7353) /* addNonEnumerableProperty */.convertToPlainObject(num);
            let num6 = 0;
