...
export const DayOfYearParser = (Parser) => {
  class DayOfYearParser {
    constructor() {
      if (this instanceof DayOfYearParser) {
        ...
        str2 = "priority";
        num2 = 90;
        tmp17 = closure_8(applyResult, "priority", 90);
  ...
  const dependencyMap = DayOfYearParser;
  ...
  let obj = { EntryPointCommandButtonActions: null, NATIVE_SECTION: null, 1476351743: null, value: DayOfYearParser };
