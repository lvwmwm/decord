...
// Dependencies: [830, 65, 77, 6343, 6346, 6347, 6361, 6371, 6375, 6379, 6429, 6352, 6381, 6362, 6380, 6418, 6364, 6360, 6354]
// Exports: addTracingHeadersToFetchRequest, instrumentFetchRequest

// Module 6452 (_addTracingHeadersToFetchRequest)
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  let baggage;
  let tmp2;
  let obj = require(6418) /* getTraceData */;
  obj = { span };
  ...
  if (tmp2) {
    ...
    if (!headers) {
      ...
      if (isInstanceOfResult) {
        ...
        isInstanceOfResult = require(6354) /* isBuiltin */.isInstanceOf(headers, Request);
        const obj3 = require(6354) /* isBuiltin */;
      }
      let headers1;
      if (isInstanceOfResult) {
    ...
    if (headers) {
      ...
      if (isInstanceOfResult1) {
        ...
        isInstanceOfResult1 = require(6354) /* isBuiltin */.isInstanceOf(headers, Headers);
        const obj4 = require(6354) /* isBuiltin */;
      }
      if (isInstanceOfResult1) {
  ...
  if (endResult.fetchData) {
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              require(6364) /* getSpanStatusFromHttpCode */.setHttpStatus(obj10, endResult.response.status);
              ...
              const obj12 = require(6364) /* getSpanStatusFromHttpCode */;
    ...
    while (true) {
      if (!href) {
        ...
        let num2 = 10;
        let obj1 = require(6429) /* getNumberOfUrlSegments */;
      ...
      let num3 = 11;
      let obj2 = require(6352) /* spanTimeInputToSeconds */;
      ...
      if (hasTracingEnabledResult) {
        if (!tmp19) {
          ...
          let num4 = 12;
          let obj4 = require(6381) /* withActiveSpan */;
          obj = {};
          ...
          let num5 = 13;
          let tmp24 = _defineProperty(obj1, require(6362).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, str);
          let str5 = "http.client";
          obj.attributes = _defineProperty(tmp24, require(6362).SEMANTIC_ATTRIBUTE_SENTRY_OP, "http.client");
        ...
        if (arg2(endResult.fetchData.url)) {
          ...
          let obj9 = require(6379) /* hasTracingEnabled */;
          let tmp33;
      ...
      let num6 = 14;
      let SentryNonRecordingSpan = require(6380) /* SentryNonRecordingSpan */.SentryNonRecordingSpan;
