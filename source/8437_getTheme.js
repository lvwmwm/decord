...
// Function ID: 67025
// Name: getTheme
// Dependencies: [31, 27, 33, 8438, 8442]

// Module 8437 (getTheme)
...
export default require("result").memo(function DatePickerWrapper(confirmText) {
  const obj = { textColor: require(8442) /* rgb2hex */.colorToHex(getTextColor(confirmText)) };
  const obj2 = require(8442) /* rgb2hex */;
  const tmp = jsx;
  const tmp2 = DatePickerAndroid;
  obj.dividerColor = require(8442) /* rgb2hex */.colorToHex(getDividerColor(confirmText));
  const obj3 = require(8442) /* rgb2hex */;
  obj.buttonColor = require(8442) /* rgb2hex */.colorToHex(getButtonColor(confirmText));
