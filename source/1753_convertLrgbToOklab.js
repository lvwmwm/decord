...
obj = {
  fromRgb: () => {
    function convertRgbToOklab(arg0) {
      const convert = callback(closure_1[0]).convert;
      const tmp = callback2(convert.fromRgb(arg0));
      if (tmp2) {
        tmp.b = 0;
        tmp.a = 0;
      }
    ...
    convertRgbToOklab.__closure = { lrgb: arg2(arg6[0]), convertLrgbToOklab: closure_3 };
