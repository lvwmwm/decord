    ...
    if (obj.start(arg0)) {
      ...
      while (!str3) {
        ...
        switch (symbol) {
          ...
          break;
          case "KRISP_INIT_ERROR_UNSIGNED":
          break;
          case "batchChannelUpdate":
          break;
          case "ChannelUp":
          break;
          case "getCollectibleQuestRewardExtendableExpirationDate":
          break;
          case "getAckTimestamp":
          break;
          case "BountyStaleRefreshQuestHomeExperiment":
          break;
          case "fre":
          break;
          case "QuestHome":
          ...
          break;
          case "sessionIdlePause":
          break;
          case "useAcceptedRequestsCount":
          break;
          case "ACCEPT_ROLES":
          break;
          case "ROLE":
          ...
          case "GE":
          break;
          case "getOrEnsurePrivateChannel":
          break;
          case "variantGroupStoreListingId":
          break;
          case "systemVersion":
          break;
          ...
          case "WHITE_500":
          break;
          case "PRESS_VIEW_ACTIVITY_MENU_ITEM":
          break;
          case "EMOJI_ROW_EMOJI_LINE_HEIGHT":
          break;
          case "TIERLESS_BOOSTING_SYSTEM_MESSAGE":
          break;
          case "MESSAGE_LOG_GUILD_CHANNELS":
          break;
          case "GUILD_CHANNEL":
          break;
          case "GUILD_CHANNELS":
          ...
          break;
          case "SECURE_FRAMES_LINKING_BOTTOM_SHEET_KEY":
          break;
          ...
          break;
          case "SHOP_THIS_LOOK_ROW_ACTION":
          break;
          ...
          case "VIDEOTOOLBOX":
          break;
          case "VIDEOTOOLBOX_RATE_CONTROL":
            obj.bymonth = symbol;
            tmp2 = obj;
            if (obj.nextSymbol()) {
              str = "comma";
          ...
          break;
          case "CONTROL_CHECKBOX_BORDER_WIDTH":
          break;
          case "APPLE_ARCADE":
          break;
          case "ARCADE":
          ...
          break;
          case "TABLE_ROW_LABEL_TEXT_STYLE":
          break;
          ...
          case "INFO":
          break;
          case "setEnableHardwareAcceleration":
          break;
          ...
          break;
          case "CHECKPOINT_PERSONA_FOUR_GRADIENT_START":
          break;
          case "START_EVENT_MODAL_KEY":
          break;
  ...
  function st(str) {
    ...
    if (replaced.length) {
      ...
      if (match) {
          ...
          switch (formatted) {
            ...
            case "description":
              while (true) {
                ...
                let num2 = obj.parseInt(formatted[7], tmp);
                if (!num2) {
                  num2 = 0;
                }
                let tmp18 = tmp9;
                ...
                let tmp23 = num;
                let tmp24 = num2;
                let tmp8Result = tmp8(tmp7, tmp2, tmp6, tmp5, num, num2);
                let tmp26 = new.target;
                let tmp27 = new.target;
                tmp4 = new tmp4(tmp8Result);
                let tmp29 = tmp4;
                str.until = tmp4;
              }
            break;
            ...
            case "$ZodDate":
              while (true) {
                ...
                num2 = obj.parseInt(formatted[7], tmp);
                if (!num2) {
                  num2 = 0;
                }
                tmp18 = tmp9;
                ...
                tmp23 = num;
                tmp24 = num2;
                tmp8Result = tmp8(tmp7, tmp2, tmp6, tmp5, num, num2);
                tmp26 = new.target;
                tmp27 = new.target;
                tmp4 = new tmp4(tmp8Result);
                tmp29 = tmp4;
        ...
        let tmp4 = at(replaced.replace(/^RRULE:/i, ""));
        closure_1 = tmp4;
