...
// Dependencies: [7460, 7457, 7570]

// Module 7572 (callFrameToStackFrame)
const require = arg1;
...
arg5.callFrameToStackFrame = function callFrameToStackFrame(location, str) {
  ...
  obj[2] = location.functionName || require(7457) /* createStackParser */.UNKNOWN_FUNCTION;
  obj[3] = sum;
  obj[4] = sum1;
  let filenameIsInAppResult;
  if (replaced) {
    filenameIsInAppResult = tmp4(7570).filenameIsInApp(replaced);
    const tmp4Result = tmp4(7570);
  }
