...
// Module 1736 (validateTransformOrigin)
...
function validateTransformOrigin(arg0) {
  ...
  let tmp30;
  if (3 !== arg0.length) {
    const reanimatedError = new require(1645) /* t */.ReanimatedError("Transform origin must have exactly 3 values.");
    throw reanimatedError;
  } else {
    [obj, obj2, tmp30] = callback(arg0, 3);
    if (typeof obj !== "number") {
      const _HermesInternal = HermesInternal;
      const reanimatedError1 = new require(1645) /* t */.ReanimatedError("Transform origin x-position must be a number or a percentage string. Passed value: " + obj + ".");
      throw reanimatedError1;
    }
    if (typeof obj2 !== "number") {
      const _HermesInternal2 = HermesInternal;
      const reanimatedError2 = new require(1645) /* t */.ReanimatedError("Transform origin y-position must be a number or a percentage string. Passed value: " + obj2 + ".");
      throw reanimatedError2;
    }
    if (typeof tmp30 !== "number") {
      const _HermesInternal3 = HermesInternal;
      const reanimatedError3 = new require(1645) /* t */.ReanimatedError("Transform origin z-position must be a number. Passed value: " + tmp30 + ".");
...
function processTransformOrigin(str) {
    ...
    if (match) {
      while (true) {
        ...
        if ("left" !== formatted) {
          if ("right" !== formatted) {
              ...
              if ("bottom" !== formatted) {
                if ("center" === formatted) {
                  if (2 === num4) {
                    ...
                    let reanimatedError = new require(1645) /* t */.ReanimatedError("Transform-origin value " + str + " cannot be used for z-position");
            ...
            if (2 === num4) {
              ...
              let reanimatedError1 = new require(1645) /* t */.ReanimatedError("Transform-origin " + str + " can only be used for y-position");
              ...
              if (0 === num4) {
                ...
                if (null != match1) {
                  ...
                  if ("left" === formatted1) {
                    ...
                    let reanimatedError2 = new require(1645) /* t */.ReanimatedError("Could not parse transform-origin: " + str);
        ...
        if (0 !== num4) {
          ...
          let reanimatedError3 = new require(1645) /* t */.ReanimatedError("Transform-origin " + str + " can only be used for x-position");
      ...
      const _HermesInternal = HermesInternal;
      const reanimatedError4 = new require(1645) /* t */.ReanimatedError("Invalid numeric value in transform-origin: " + str);
  ...
  if (typeof str !== "string") {
    const _Array = Array;
    if (!Array.isArray(str)) {
      const reanimatedError5 = new require(1645) /* t */.ReanimatedError("Invalid transformOrigin type: " + typeof str);
