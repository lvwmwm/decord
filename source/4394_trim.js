...
// Module 4394 (trim)
let closure_2 = require(dependencyMap[0])("String.prototype.replace");
...
export default function trim() {
  return callback(callback(require(dependencyMap[1])(require(dependencyMap[2])(this)), closure_3, ""), closure_4, "");
};
