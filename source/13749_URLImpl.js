...
// Function ID: 13750
// Name: URLImpl
// Dependencies: [41, 42, 13750, 13754, 13753]
...
class URLImpl {
  constructor(arg0, arg1) {
    ...
    if (null === basicURLParseResult1) {
      ...
      tmp7Result = require("module_13754");
      items = [];
      items[0] = str;
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(13750).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(13750).basicURLParse(arg0);
      if (null === basicURLParseResult) {
  ...
  },
  {
    key: "origin",
    get() {
      return URLImpl(13750).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
  ...
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(13750).serializeHost(host);
        const obj3 = URLImpl(13750);
      } else {
        const obj = URLImpl(13750);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(13750).serializeInteger(host.port)}`;
        const obj2 = URLImpl(13750);
      }
    },
    set(arg0) {
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(13750).serializeHost(tmp._url.host);
        const obj = URLImpl(13750);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(13750).serializeInteger(tmp._url.port);
        const obj = URLImpl(13750);
      }
      return str;
    },
    set(arg0) {
      ...
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        if ("" === arg0) {
          ...
          obj[0] = self._url;
          URLImpl(13750).basicURLParse(arg0, obj);
          const tmpResult = URLImpl(13750);
        }
      }
    }
