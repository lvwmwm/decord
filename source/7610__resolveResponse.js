...
// Dependencies: [32, 5, 7497, 7611, 7505, 7500, 7513, 7506]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 7610 (_resolveResponse)
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(7497) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(7497) /* addHandler */;
  require(7497) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    const callback = closure_5;
    {
      callback(7505).fill(callback(7500).GLOBAL_OBJ, "fetch", (arg0) => {
        let closure_0 = arg0;
        return () => {
      ...
      const obj = callback(7505);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(7497).addHandler("fetch", arg0);
  let obj = _require(7497);
  _require(7497).maybeInstrument("fetch", () => {
    let flag = callback;
