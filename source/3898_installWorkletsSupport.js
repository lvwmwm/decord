...
// Module 3898 (installWorkletsSupport)
let require = arg1;
...
arg5.installWorkletsSupport = function installWorkletsSupport() {
  ...
  const result = require(3899) /* getInstalledNitro */.registerCustomSerializable({ name: "nitro.HybridObject", determine, pack, unpack });
};
