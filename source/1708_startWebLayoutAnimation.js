...
// Dependencies: [1678, 1709, 1657, 1722, 1723, 1741, 1739, 1740, 1705]

// Module 1708 (startWebLayoutAnimation)
const require = arg1;
const dependencyMap = arg6;
function startWebLayoutAnimation(props, _componentDOMRef, ENTERING, easingY) {
  if (ENTERING === require(1678) /* isWorkletFunction */.LayoutAnimationType.ENTERING) {
  ...
  const result = require(1722) /* setElementAnimation */.maybeModifyStyleForKeyframe(_componentDOMRef, props.entering);
  let animationName;
  if (processedConfig != null) {
    animationName = processedConfig.animationName;
  }
  if (animationName in require(1709) /* TransitionType */.Animations) {
    let animationName1;
    if (processedConfig != null) {
...
arg5.tryActivateLayoutTransition = function tryActivateLayoutTransition(props, _componentDOMRef, arg2) {
  if (props.layout) {
    ...
    let obj = require(1740) /* findDescendantWithExitingAnimation */;
