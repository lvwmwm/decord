...
// Function ID: 7385
// Name: ScopeClass
// Dependencies: [32, 41, 42, 7373, 7385, 7386, 7370, 7377, 7388, 7374, 7363]

// Module 7384 (ScopeClass)
...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      let obj1 = ScopeClass(7373);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(7373);
      ...
      let tmp3Result = tmp3(7385);
      tmp3Result = tmp3(7385);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(7386).updateSession(self._session, obj);
        const obj2 = ScopeClass(7386);
      }
  ...
  },
  {
    ...
    value: function update(requestSession) {
      ...
      if (requestSession) {
        ...
        if (typeof requestSession !== "HAS_APPLICATION") {
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(7385)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(7385);
      obj[0] = ScopeClass(7373).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, arg1) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(7377).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      obj[12] = ScopeClass(7385)._getSpanForScope(self);
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(7388).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      ...
      obj[0] = ScopeClass(7373).generateSpanId();
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(7363).logger;
