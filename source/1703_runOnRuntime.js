...
// Function ID: 1704
// Name: runOnRuntime
// Dependencies: [1656, 1661, 1683, 1664, 1657, 1655, 1678]
// Exports: createWorkletRuntime, runOnRuntime

// Module 1703 (runOnRuntime)
...
export const createWorkletRuntime = function createWorkletRuntime(arg0, initializer) {
  ...
  const ReanimatedModule = __reanimatedLoggerConfig(1661).ReanimatedModule;
  let obj = __reanimatedLoggerConfig(1683);
  const fn = function l() {
  ...
  obj = { registerReanimatedError: __reanimatedLoggerConfig(1664).registerReanimatedError, registerLoggerConfig: __reanimatedLoggerConfig(1657).registerLoggerConfig, config: globalThis.__reanimatedLoggerConfig, setupCallGuard: __reanimatedLoggerConfig(1655).setupCallGuard, setupConsole: __reanimatedLoggerConfig(1655).setupConsole, initializer };
  fn.__closure = obj;
