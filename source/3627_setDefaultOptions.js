...
// Dependencies: [3211, 3215]
// Exports: default

// Module 3627 (setDefaultOptions)
...
export default function setDefaultOptions(obj) {
  ...
  obj = {};
  const defaultOptions = require(3215) /* getDefaultOptions */.getDefaultOptions();
  ...
  require(3215) /* getDefaultOptions */.setDefaultOptions(obj);
};
