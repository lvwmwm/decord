...
// Function ID: 100010
// Name: Range
// Dependencies: [65, 6, 7, 12839, 12866, 12840, 12842, 12841, 12838, 12868]

// Module 12867 (Range)
import _toConsumableArray from "_toConsumableArray";
import _classCallCheck from "items";
import _defineProperties from "module_12841";
...
function replaceTilde(str, loose) {
  const _require = str;
  const safeRe = _require(12842).safeRe;
  const t = _require(12842).t;
  if (loose.loose) {
...
function replaceXRanges(str, arg1) {
  const _require = arg1;
  _require(12841)("replaceXRanges", str, arg1);
...
function replaceStars(str, arg1) {
  require(12841)("replaceStars", str, arg1);
  return str.trim().replace(require(12842) /* items */.safeRe[require(undefined, 12842) /* items */.t.STAR], "");
}
function replaceGTE0(str) {
  require(12841)("replaceGTE0", str, arg1);
  const t = require(12842) /* items */.t;
  return str.trim().replace(require(12842) /* items */.safeRe[arg1.includePrerelease ? t.GTE0PRE : t.GTE0], "");
}
    ...
    if (!includePrerelease.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = require(12841)(arg0[num4].semver);
          let tmp6 = tmp2;
          if (arg0[num4].semver !== require(12866) /* Comparator */.ANY) {
            tmp6 = tmp2;
