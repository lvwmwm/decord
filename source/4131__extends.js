...
// Function ID: 4132
// Name: _extends
// Dependencies: [19, 4132, 1229, 1230, 1223, 4135]

// Module 4131 (_extends)
...
export const MemoryRouter = Component2(4135).Redirect;
export const Prompt = Component2(4135).Redirect;
export const Redirect = Component2(4135).Redirect;
export const Route = Component2(4135).Route;
export const Router = Component2(4135).Router;
export const StaticRouter = Component2(4135).StaticRouter;
export const Switch = Component2(4135).Switch;
export const generatePath = Component2(4135).generatePath;
export const matchPath = Component2(4135).matchPath;
export const useHistory = Component2(4135).useHistory;
export const useLocation = Component2(4135).useLocation;
export const useParams = Component2(4135).useParams;
export const useRouteMatch = Component2(4135).useRouteMatch;
export const withRouter = Component2(4135).withRouter;
