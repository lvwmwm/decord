...
// Function ID: 1764
// Name: r
// Dependencies: [1764, 1696, 1765, 1664]
...
function processColorNumber(arr) {
  const result = require(1696) /* call */.processColorInitially(arr);
  const obj = require(1696) /* call */;
  let tmp3 = result;
  if (tmp2) {
    tmp3 = result | 0;
  }
...
function processColor(arr, target) {
  ...
  tmp4 = require(1764) /* JEST_WORKER_ID */.IS_ANDROID && typeof result === "number";
}
...
function processColorsInProps(obj) {
  for (const key10005 in arg0) {
    ...
    let ColorProperties = require(1696) /* call */.ColorProperties;
