...
// Function ID: 4701
// Name: ScreenStack
// Dependencies: [109, 19, 21, 4685, 4701, 4702, 4689]
// Exports: default

// Module 4700 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(ref1(4701).GHContext);
  obj = {
  ...
  ref2(4685)("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  ref2(4685)(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  obj2.iosPreventReattachmentOfDismissedScreens = ref2(4689).experiment.iosPreventReattachmentOfDismissedScreens;
  obj2.onFinishTransitioning = onFinishTransitioning;
  obj2.ref = ref1;
  obj2.children = children;
  obj1[6] = jsx(ref2(4702), {});
  ...
  return jsx(tmp4(4701).RNSScreensRefContext.Provider, { value: ref, children: null });
};
