...
let closure_7 = arg1(dependencyMap[5]).createStyles({ unreadBadge: { body: "%ArrayProto_keys%", backgroundColor: "tr", accessibilityRole: "isArray" }, unreadBadgePanel: { marginLeft: -16 } });
