...
// Dependencies: [7494, 7495, 7539, 7542, 7531, 7500]
// Exports: createEventEnvelope, createSessionEnvelope, createSpanEnvelope

// Module 7538 (createEventEnvelope)
...
export const createEventEnvelope = function createEventEnvelope(type, arg1, sdk) {
  const sdkMetadataForEnvelopeHeader = require(7539) /* forEachEnvelopeItem */.getSdkMetadataForEnvelopeHeader(sdk);
  let str = "event";
  if (type.type) {
    str = "event";
...
export const createSessionEnvelope = function createSessionEnvelope(toJSON) {
  let obj = require(7539) /* forEachEnvelopeItem */;
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    const obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(7542).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(7542);
  }
