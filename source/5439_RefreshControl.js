...
// Function ID: 5440
// Name: RefreshControl
// Dependencies: [32, 109, 19, 17, 21, 5402, 5372, 5403]

// Module 5439 (RefreshControl)
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  const items = [];
  items[HermesBuiltin.arraySpread(require(5372) /* toArray */.toArray(waitFor), 0)] = ref;
  obj.waitFor = items;
...
export const FlatList = importAllResult.forwardRef((arg0, ref) => {
  ...
  while (tmp3 !== undefined) {
    ...
    let nativeViewProps = ref(5403).nativeViewProps;
    let tmp12 = first;
    let tmp13 = tmp9;
