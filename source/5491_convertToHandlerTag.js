...
// Dependencies: [32, 19, 5492, 5493, 5503, 5504, 5505, 5507, 5508, 5509, 5488, 5472, 5510, 5470]
// Exports: checkGestureCallbacksForWorklets, extractGestureRelations, useForceRender, useWebEventHandlers

// Module 5491 (convertToHandlerTag)
...
function convertToHandlerTag(num) {
  if (typeof num === "number") {
    return num;
  } else if (num instanceof require(5488) /* _isNativeReflectConstruct */.BaseGesture) {
    num = num.handlerTag;
  } else {
