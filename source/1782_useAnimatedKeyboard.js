...
// Dependencies: [19, 1678, 1659]
// Exports: useAnimatedKeyboard

// Module 1782 (useAnimatedKeyboard)
...
export const useAnimatedKeyboard = function useAnimatedKeyboard() {
  ...
  if (null === tmp.current) {
    ...
    obj[0] = obj(1678).makeMutable(obj(1659).KeyboardState.UNKNOWN);
    const obj3 = obj(1678);
    obj[1] = obj(1678).makeMutable(0);
    const obj4 = obj(1678);
    ...
    fn.__initData = obj;
    tmp2.current = obj(1678).subscribeForKeyboardEvents(fn, obj);
    tmp.current = obj;
    tmp3.current = true;
    const obj5 = obj(1678);
  }
