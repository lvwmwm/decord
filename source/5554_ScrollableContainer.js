...
// Dependencies: [19, 21, 5555, 5556, 5558]

// Module 5554 (ScrollableContainer)
import "noop";
...
export const ScrollableContainer = require("noop").forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  const tmp6 = jsx(require(5555) /* BottomSheetDraggableScrollable */.BottomSheetDraggableScrollable, { ref });
  let tmp2Result = tmp6;
  if (onRefresh) {
    ...
    obj[3] = onRefresh;
    obj[4] = require(5558) /* styles */.styles.container;
    obj[5] = tmp6;
    tmp2Result = jsx(importDefault(5556), { scrollableGesture: null, refreshing: null, progressViewOffset: null, onRefresh: null, style: null, children: null });
    const tmp9 = importDefault(5556);
  }
  return tmp2Result;
});
