...
// Dependencies: [32, 5, 7518, 7632, 7526, 7521, 7534, 7527]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 7631 (_resolveResponse)
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(7518) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(7518) /* addHandler */;
  require(7518) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    const callback = closure_5;
    {
      callback(7526).fill(callback(7521).GLOBAL_OBJ, "fetch", (arg0) => {
        let closure_0 = arg0;
        return () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(7518).addHandler("fetch", arg0);
  let obj = _require(7518);
  _require(7518).maybeInstrument("fetch", () => {
    let flag = callback;
