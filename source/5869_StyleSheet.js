...
// Function ID: 5870
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 5863, 5864, 1521, 5870, 5849, 5347, 5871, 5872, 5873, 5874]
// Exports: Card

// Module 5869 (StyleSheet)
...
export const Card = function Card(shadowEnabled) {
  ...
  if (typeof backgroundColor === "string") {
    tmp16 = 0 === tmp5(5347)(backgroundColor).alpha();
    const obj12 = tmp5(5347)(backgroundColor);
  }
  ...
  let merged = Object.assign(flag2(5872).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }));
  ...
  const items13 = [tmp27, gesture(flag2(5873).CardContent, { enabled: pageOverflowEnabled, layout, style: contentStyle, children })];
  obj5[3] = items13;
  obj4.children = layout(closing.View, obj5);
  obj3[2] = gesture(flag2(5849).PanGestureHandler, obj4);
  items5[2] = gesture(closing.View, obj3);
  obj[1] = items5;
  return layout(flag2(5871).CardAnimationContext.Provider, obj);
};
