...
// Dependencies: [41, 42, 93, 95, 98, 19, 5301, 5277, 5292, 5290]

// Module 5300 (_isNativeReflectConstruct)
...
let obj = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(5277).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  obj,
