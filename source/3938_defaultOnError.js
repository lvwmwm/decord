...
// Function ID: 3939
// Name: defaultOnError
// Dependencies: [109, 19, 21, 3939, 3940, 3942, 3920]
// Exports: RiveView

// Module 3938 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + require(3939).RiveErrorType[message.type] + "] " + message.message);
}

export const RiveView = function RiveView(arg0) {
  let hybridRef;
  let onError;
  let obj = _require(3940);
  ...
  const tmp18 = jsx(_require(3920).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
