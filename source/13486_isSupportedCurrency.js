...
// Dependencies: [13403, 13487]

// Module 13486 (isSupportedCurrency)
const require = arg1;
...
function isSupportedCurrency(arr3, locale) {
  ...
  try {
    ...
    obj[2] = arr3;
    const memoizedNumberFormat = require(13403) /* _formatToParts */.createMemoizedNumberFormat(str, obj);
...
arg5.getSupportedCurrencies = function getSupportedCurrencies(locale) {
  const items = [];
  const currencies = require(13487).currencies;
