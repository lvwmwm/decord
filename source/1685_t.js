...
let fn = function t(toValue, userConfig, callback) {
  ...
  obj = { Easing: _require(1686).Easing, userConfig, toValue, callback, getReduceMotionForAnimation: _require(1674).getReduceMotionForAnimation };
  fn.__closure = obj;
