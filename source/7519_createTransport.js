...
// Dependencies: [7520, 7500, 7521, 7480, 7484, 7456, 7513]

// Module 7519 (createTransport)
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(7500).envelopeItemTypeToDataCategory(arg1);
        const obj = items(7500);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: null };
          obj[0] = items(7500).serializeEnvelope(dependencyMap);
          const obj2 = items(7500);
          ...
          if (arg0 instanceof items(7513).SentryError) {
