...
class URLStateMachine {
  constructor(arg0, arg1, arg2, arg3, arg4) {
    ...
    if (!self.url) {
      obj = { "Bool(true)": false, "Bool(true)": false, "Bool(true)": false, "Bool(true)": false, "Bool(true)": false, "Bool(true)": false, "Bool(true)": false, "Bool(true)": false, "Bool(true)": false };
      str3 = "";
      obj.path = [];
      self.url = obj;
      str4 = self.input;
...
let closure_3 = { "Null": "Array", "Null": "MERCH_STORE", "Null": "isArray", "Null": "HEADER", "Null": "isArray", "Null": "isArrayBuffer" };
let closure_4 = Symbol("failure");
const set = new Set([null, null, null, null, null, null, null, null, null, null]);
const set1 = new Set([]);
const set2 = new Set([552909930, 377957184, -470298919, 28991]);
