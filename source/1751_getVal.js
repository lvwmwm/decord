...
// Module 1751 (getVal)
const obj = { IDENTITY: "identity", CLAMP: "clamp", EXTEND: "extend" };
...
let closure_4 = () => {
  function getVal(arg0, arg1, arg2, arg3, arg4, arg5) {
    let tmp = arg4;
    if (constants.IDENTITY === arg0) {
      return arg5;
    } else if (constants.CLAMP === arg0) {
      if (arg1 * arg2 < arg1 * arg3) {
        tmp = arg3;
      }
      return tmp;
    } else {
      const EXTEND = constants.EXTEND;
      return arg2;
    }
  }
  const obj = { Extrapolation: obj };
...
let closure_6 = () => {
  function isExtrapolate(arg0) {
    let tmp = arg0 === constants.EXTEND;
    if (!tmp) {
      tmp = arg0 === constants.CLAMP;
    }
    if (!tmp) {
      tmp = arg0 === constants.IDENTITY;
    }
    return tmp;
  }
  const obj = { Extrapolation: obj };
...
let closure_8 = () => {
  function validateType(extrapolateLeft) {
    const obj = { extrapolateLeft: constants.EXTEND, extrapolateRight: constants.EXTEND };
    if (extrapolateLeft) {
      if ("string" === typeof extrapolateLeft) {
        if (callback2(extrapolateLeft)) {
          obj.extrapolateLeft = extrapolateLeft;
          obj.extrapolateRight = extrapolateLeft;
          return obj;
        } else {
          const ReanimatedError2 = callback(closure_1[0]).ReanimatedError;
  ...
  const obj = { Extrapolation: obj, isExtrapolate: closure_6 };
  ...
  function internalInterpolate(arg0, arg1, extrapolateLeft) {
    ...
    if (rightEdgeInput - leftEdgeInput == 0) {
      ...
      if (num * sum < num * leftEdgeOutput) {
        let tmp = callback(extrapolateLeft.extrapolateLeft, num, sum, leftEdgeOutput, rightEdgeOutput, arg0);
      } else {
        tmp = sum;
        if (num * sum > num * rightEdgeOutput) {
          tmp = callback(extrapolateLeft.extrapolateRight, num, sum, leftEdgeOutput, rightEdgeOutput, arg0);
        }
      }
      return tmp;
    }
  ...
  function interpolate(arg0, arg1, arg2, arg3) {
    if (arg1.length >= 2) {
      if (arg2.length >= 2) {
        ...
        return callback3(arg0, obj, callback2(arg3));
      }
    }
    const reanimatedError = new callback(closure_1[0]).ReanimatedError("Interpolation input and output ranges should contain at least two values.");
    throw reanimatedError;
  }
