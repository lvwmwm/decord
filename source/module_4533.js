// Module ID: 4533
// Function ID: 39800
// Dependencies: [29, 31, 27, 33, 4534, 4525]
...
export default importDefaultResult.forwardRef(function SearchBar(autoCapitalize) {
  ...
  if (ref(4525).isSearchBarAvailableForCurrentPlatform) {
    let obj = {};
    ...
    obj.obscureBackground = ref(4525).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const obj4 = ref(4525);
    obj.hideNavigationBar = ref(4525).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
