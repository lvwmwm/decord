...
// Function ID: 7903
// Name: extractFont
// Dependencies: [19, 21, 7896, 7901]
// Exports: default, setTSpan

// Module 7902 (extractFont)
import "noop";
...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(7896) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "string") {
    ...
    obj[7] = importDefault(7901)(tmp);
    obj[8] = importDefault(7901)(tmp2);
    obj[9] = importDefault(7901)(tmp3);
    obj[10] = importDefault(7901)(tmp4);
    obj[11] = importDefault(7901)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
