...
// Function ID: 4981
// Name: parseBox
// Dependencies: [4981, 4974, 4971]

// Module 4980 (parseBox)
const require = arg1;
const module = arg2;
...
function parseBox(getUint32, sum) {
  ...
  if (length >= 8) {
    ...
    if (1718909296 === uint321) {
      ...
      obj1[1] = require(4971) /* getDataView */.getStringFromDataView(getUint32, contentOffset, 4);
      obj1[2] = length;
      return obj1;
      ...
      const stringFromDataView = require(4971) /* getDataView */.getStringFromDataView(getUint32, contentOffset, 4);
      ...
      if (1835365473 === uint321) {
        ...
        const obj13 = require(4981) /* parseItemLocationBox */;
