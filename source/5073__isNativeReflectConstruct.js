  ...
  class DrawerLayout {
    constructor(arg0) {
      ...
      tmp2Result.updateAnimatedEvent = (drawerWidth, drawerTranslation) => {
        ...
        tmp2Result.openValue = RN.add(addResult2, drawerTranslation.drawerTranslation).interpolate({ inputRange: items1, outputRange: ["replace", "then"], extrapolate: "clamp" });
      ...
      tmp2Result.renderDrawer = () => {
        ...
        if ("front" === drawerType) {
          if ("back" === drawerType) {
            ...
            if (tmp2Result.state.drawerState !== "Idle") {
              const obj5 = { inputRange: ["replace", "then"] };
              const items5 = [tmp6, 0];
          ...
          obj = {};
          const obj6 = {};
          let obj7 = { inputRange: ["replace", "then"] };
          const items6 = [0.229];
          if (tmp) {
      ...
      obj = { now: null, t: null, container: 10, source: null, createStyles: "Path 10", has: "ADBE Vector Shape - Group" };
      obj.dragX = value;
      obj.touchX = value1;
...
tmp4.defaultProps = {};
tmp4.positions = { "Bool(true)": "%Math%", "Bool(true)": "isArrayBuffer" };
const tmp3 = arg1(dependencyMap[7]);
const styles = StyleSheet.create({ drawerContainer: Object.assign({}, StyleSheet.absoluteFillObject, { includesBounties: null, valueSetter: null }), containerInFront: Object.assign({}, StyleSheet.absoluteFillObject, { zIndex: 1002 }), containerOnBack: Object.assign({}, StyleSheet.absoluteFillObject), main: { "Null": -1136001021, "Null": -1136001021, "Null": -226295805 }, overlay: Object.assign({}, StyleSheet.absoluteFillObject, { zIndex: 1000 }) });
