...
obj[282] = { name: "XResolution", description: require("module_4769").XResolution };
const obj1 = {
  name: "Thresholding",
  description(arg0) {
    return { 1: "No dithering or halftoning", 2: "Ordered dither or halfton", 3: "Randomized dither" }[arg0] || "Unknown";
...
const obj4 = { name: "XResolution", description: require("module_4769").XResolution };
obj[283] = { name: "YResolution", description: require("module_4769").YResolution };
obj[286] = {
  name: "XPosition",
  description(arg0) {
...
const obj5 = { name: "YResolution", description: require("module_4769").YResolution };
const obj6 = {
  name: "XPosition",
  description(arg0) {
    return "" + Math.round(arg0[0] / arg0[1]);
...
obj[296] = { name: "ResolutionUnit", description: require("module_4769").ResolutionUnit };
obj[318] = {
  name: "WhitePoint",
  description(arr) {
...
const obj9 = { name: "ResolutionUnit", description: require("module_4769").ResolutionUnit };
obj[50778] = { name: "CalibrationIlluminant1", description: require("module_4769").LightSource };
const obj20 = { name: "CalibrationIlluminant1", description: require("module_4769").LightSource };
obj[50779] = { name: "CalibrationIlluminant2", description: require("module_4769").LightSource };
obj[50941] = {
