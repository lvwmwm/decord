...
// Dependencies: [32, 5, 7452, 7566, 7460, 7455, 7468, 7461]
// Exports: addFetchEndInstrumentationHandler, addFetchInstrumentationHandler

// Module 7565 (_resolveResponse)
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(7452) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(7452) /* addHandler */;
  require(7452) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(7452).addHandler("fetch", arg0);
  let obj = _require(7452);
  _require(7452).maybeInstrument("fetch", () => {
    let flag = callback;
