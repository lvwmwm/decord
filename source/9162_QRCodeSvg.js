...
// Function ID: 9163
// Name: QRCodeSvg
// Dependencies: [9159, 19, 7880]

// Module 9162 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(7880) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(7880) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(7880) /* inlineStyles */.Path, { d, fill }));
});
