// Module ID: 13230
// Function ID: 13231
// Dependencies: [13224, 13195, 13215]

// Module 13230

export default (arg0, arg1) => {
  let require;
  let obj = new require(13224) /* Range */(arg0, arg1);
  const tmp3 = new require(13195) /* SemVer */("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(13195)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
        ...
        do {
          ...
          if (require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = require;
              tmp16 = !require(13215) /* SemVer */(tmp14, require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
