...
// Function ID: 6478
// Name: supportsFetch
// Dependencies: [6366, 6364, 6365]

// Module 6477 (supportsFetch)
const require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in require(6366) /* getGlobalSingleton */.GLOBAL_OBJ) {
    try {
...
arg5.supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "y") {
    ...
    if (isNativeFunction(require(6366) /* getGlobalSingleton */.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = tmp5(6366).GLOBAL_OBJ.document;
      if (_document) {
...
arg5.supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in require(6366) /* getGlobalSingleton */.GLOBAL_OBJ;
};
