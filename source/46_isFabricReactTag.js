...
if (true === global.RN$Bridgeless) {
  let _default = require("raiseSoftError").default;
} else {
  _default = require("_getConstants").default;
}
...
export default Object.assign({}, _default, {
  measure(arg0, arg1) {
    if (isFabricReactTag(arg0)) {
      ...
      const tmp5Result = tmp5(require(49) /* getFabricUIManager */.getFabricUIManager());
  ...
  measureLayout(arg0, arg1, arg2, arg3) {
    if (isFabricReactTag(arg0)) {
      const tmp10 = importDefault(48);
      const tmp10Result = tmp10(require(49) /* getFabricUIManager */.getFabricUIManager());
  ...
  measureLayoutRelativeToParent(arg0, arg1, arg2) {
    ...
    if (isFabricReactTag(arg0)) {
      ...
      const tmp8 = importDefault(48);
      const tmp8Result = tmp8(_require(49).getFabricUIManager());
