// Module ID: 1648
// Function ID: 1649
// Dependencies: [32, 41, 42, 91, 1637, 1649, 1650, 1659, 1645, 1638]
...
if (!isJest.isJest()) {
  ...
  isJest[1] = function createWorkletRuntime(arg0, arg1) {
    const reanimatedError = new JSReanimated(1645).ReanimatedError("createWorkletRuntime is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[1] = isJest;
  const obj1 = { key: "scheduleOnRuntime", value: null };
  obj1[1] = function scheduleOnRuntime() {
    const reanimatedError = new JSReanimated(1645).ReanimatedError("scheduleOnRuntime is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[2] = obj1;
  let obj2 = { key: "registerEventHandler", value: null };
  obj2[1] = function registerEventHandler(arg0, arg1, arg2) {
    const reanimatedError = new JSReanimated(1645).ReanimatedError("registerEventHandler is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[3] = obj2;
  const obj3 = { key: "unregisterEventHandler", value: null };
  obj3[1] = function unregisterEventHandler(arg0) {
    const reanimatedError = new JSReanimated(1645).ReanimatedError("unregisterEventHandler is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[4] = obj3;
  ...
  obj4[1] = function enableLayoutAnimations() {
    if (obj.isWeb()) {
      const logger3 = tmp(1638).logger;
      logger3.warn("Layout Animations are not supported on web yet.");
    } else {
      let tmpResult = tmp(1637);
      if (tmpResult.isJest()) {
        const logger2 = tmp(1638).logger;
  ...
  obj13[1] = function getSettledUpdates() {
    const reanimatedError = new JSReanimated(1645).ReanimatedError("`getSettledUpdates` is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[14] = obj13;
  ...
  obj15[1] = function getViewProp(arg0, arg1, arg2, arg3) {
    const reanimatedError = new JSReanimated(1645).ReanimatedError("getViewProp is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[16] = obj15;
  const obj16 = { key: "configureProps", value: null };
  obj16[1] = function configureProps() {
    const reanimatedError = new JSReanimated(1645).ReanimatedError("configureProps is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[17] = obj16;
  const obj17 = { key: "executeOnUIRuntimeSync", value: null };
  obj17[1] = function executeOnUIRuntimeSync(arg0) {
    const reanimatedError = new JSReanimated(1645).ReanimatedError("`executeOnUIRuntimeSync` is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[18] = obj17;
  const obj18 = { key: "markNodeAsRemovable", value: null };
  obj18[1] = function markNodeAsRemovable(arg0) {
    const reanimatedError = new JSReanimated(1645).ReanimatedError("markNodeAsRemovable is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[19] = obj18;
  const obj19 = { key: "unmarkNodeAsRemovable", value: null };
  obj19[1] = function unmarkNodeAsRemovable(arg0) {
    const reanimatedError = new JSReanimated(1645).ReanimatedError("unmarkNodeAsRemovable is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[20] = obj19;
