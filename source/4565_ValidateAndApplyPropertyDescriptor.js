...
// Dependencies: [4566, 4499, 541, 4546, 4550, 4563, 4553, 4554, 4555, 4556, 4567, 4568]

// Module 4565 (ValidateAndApplyPropertyDescriptor)

export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, flag, __Configurable__) {
  const tmp3 = require(4566) /* Type */(arg0);
  if (undefined !== arg0) {
    if (!tmp(4499)(arg0)) {
  ...
  if (require(4546) /* isPropertyKey */(arg1)) {
