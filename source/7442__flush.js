...
// Function ID: 7443
// Name: _flush
// Dependencies: [5, 7421, 7443, 7422, 7394, 7405, 7408, 7401, 7431, 7395, 7417]
...
function endSession() {
  const isolationScope = require(7421) /* getClient */.getIsolationScope();
  const obj = require(7421) /* getClient */;
  ...
  const tmpResult1 = require(7421) /* getClient */;
...
export const captureException = function captureException(arg0, arg1) {
  const currentScope = require(7421) /* getClient */.getCurrentScope();
  const obj = require(7421) /* getClient */;
  return currentScope.captureException(arg0, require(7443) /* applyClientOptions */.parseEventHintOrCaptureContext(arg1));
};
...
export const captureSession = function captureSession() {
  ...
  if (flag) {
    ...
    const obj5 = require(7421) /* getClient */;
  }
};
...
export const isInitialized = function isInitialized() {
  return require(7421) /* getClient */.getClient();
};
...
export const startSession = function startSession(arg0) {
  ...
  const obj5 = require(7421) /* getClient */;
  const userAgent = require(7395) /* getGlobalSingleton */.GLOBAL_OBJ.navigator || {}.userAgent;
  let tmpResult = tmp(7417);
  obj = { release, environment, user: null };
  const tmp3 = require(7395) /* getGlobalSingleton */.GLOBAL_OBJ.navigator || {};
...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  let currentScope = _require(7421).getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = _require(7421);
  let client = _require(7421).getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = _require(7421);
  captureCheckInResult = _require(7405).uuid4();
};
