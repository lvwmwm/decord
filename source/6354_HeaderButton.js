...
// Function ID: 6355
// Name: HeaderButton
// Dependencies: [19, 17, 21, 6337]

// Module 6354 (HeaderButton)
...
const forwardRefResult = require("noop").forwardRef(function HeaderButtonInternal(disabled, ref) {
  ...
  obj[11] = children;
  return jsx(require(6337) /* Animated */.PlatformPressable, { ref, disabled, href, "aria-label": accessibilityLabel, testID, onPress, pressColor, pressOpacity, android_ripple: obj, style: null, hitSlop: null, children: null });
});
