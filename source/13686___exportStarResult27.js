...
// Dependencies: [13645, 13640, 13650, 13651]

// Module 13686 (__exportStarResult27)
...
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(13650).IsWellFormedCurrencyCode(str);
  }
  ...
  if (!result1) {
    result1 = tmp4(13651).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
