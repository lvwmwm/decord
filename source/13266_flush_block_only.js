...
// Dependencies: [13267, 13263, 13268, 13269, 13270]

// Module 13266 (flush_block_only)
import assign from "assign" /* 13263 */;
import _mod13267 from "module_13267" /* 13267 */;
import StaticTreeDesc from "StaticTreeDesc" /* 13268 */;
import adler32 from "adler32" /* 13269 */;
    ...
    if (0 === state.strm.avail_in) {
      ...
      if (0 === avail_in) {
        ...
        if (1 === strm.state.wrap) {
          ...
          let tmp13 = avail_in;
          let tmp14 = sum1;
          strm.adler = tmp15(13270)(strm.adler, _window, avail_in, sum1);
        }
...
function DeflateState() {
  ...
  obj.d_desc = null;
  obj.bl_desc = null;
  const buf163 = new tmp(13263).Buf16(16);
  obj.bl_count = buf163;
  const buf164 = new tmp(13263).Buf16(573);
  obj.heap = buf164;
  const heap = obj.heap;
  ...
  obj.heap_len = 0;
  obj.heap_max = 0;
  const buf165 = new tmp(13263).Buf16(573);
  obj.depth = buf165;
              ...
              if (42 === state8.status) {
                if (2 === state8.wrap) {
                  ...
                  if (state8.gzhead) {
                    ...
                    if (state8.gzhead.hcrc) {
                      state.adler = _mod13270(state.adler, state8.pending_buf, state8.pending, 0);
                    }
                    state8.gzindex = 0;
                    state8.status = 69;
                ...
                if (state8.gzhead.extra) {
                  ...
                  if (state8.gzindex < (65535 & state8.gzhead.extra.length)) {
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      while (state8.gzindex < (65535 & state8.gzhead.extra.length)) {
                        if (state8.pending !== state8.pending_buf_size) {
                          ...
                          if (tmp36) {
                            ...
                            let tmp39 = tmp35;
                            state.adler = _mod13270(state.adler, state8.pending_buf, state8.pending - tmp35, tmp35);
                          }
                      ...
                      if (tmp29) {
                        state.adler = _mod13270(state.adler, state8.pending_buf, state8.pending - pending, pending);
                      }
                      state = state.state;
                      let avail_out = state.pending;
                  ...
                  if (tmp40) {
                    state.adler = _mod13270(state.adler, state8.pending_buf, state8.pending - pending2, pending2);
                  }
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (tmp46) {
                        ...
                        let tmp49 = pending3;
                        state.adler = _mod13270(state.adler, state8.pending_buf, state8.pending - pending3, tmp44);
                      }
                    ...
                    if (tmp52) {
                      ...
                      let tmp55 = pending4;
                      state.adler = _mod13270(state.adler, state8.pending_buf, state8.pending - pending4, pending4);
                    }
                    if (0 === num46) {
                      state8.gzindex = 0;
                      let num48 = 91;
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (tmp58) {
                        ...
                        let tmp61 = pending5;
                        state.adler = _mod13270(state.adler, state8.pending_buf, state8.pending - pending5, tmp56);
                      }
                    ...
                    if (tmp64) {
                      ...
                      let tmp67 = pending6;
                      state.adler = _mod13270(state.adler, state8.pending_buf, state8.pending - pending6, pending6);
                    }
                    if (0 === num53) {
                      let num55 = 103;
                      state8.status = 103;
