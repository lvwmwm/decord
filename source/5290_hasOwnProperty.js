...
// Function ID: 5291
// Name: hasOwnProperty
// Dependencies: [5288, 5291]

// Module 5290 (hasOwnProperty)
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5288)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
              tmp12 = require(5288) /* keys */;
              tmp9 = hasOwnProperty;
            }
          }
        }
...
obj.to.hex = () => {
  const tmp = require(5291) /* swizzle */(arguments);
...
obj.to.rgb = () => {
  const arr = require(5291) /* swizzle */(arguments);
  if (arr.length >= 4) {
    if (1 !== arr[3]) {
      const _Math = Math;
      const _Math2 = Math;
