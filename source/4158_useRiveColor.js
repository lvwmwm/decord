...
// Function ID: 4159
// Name: useRiveColor
// Dependencies: [32, 19, 4140, 4153, 4148]
// Exports: useRiveColor

// Module 4158 (useRiveColor)
import c from "c" /* 4140 */;
import RiveColor2 from "RiveColor" /* 4148 */;
import useRiveProperty from "useRiveProperty" /* 4153 */;
import closure_2 from "_slicedToArray" /* 32 */;

require = arg1;
require("noop").useCallback;
const f29340 = (colorProperty) => colorProperty.colorProperty(arg1);

export const useRiveColor = function useRiveColor(FillColor, instance) {
  let obj = c;
  const cResult = obj.c(8);
  const tmp4 = callback(useRiveProperty.useRiveProperty(instance, FillColor, f29340), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
