...
// Function ID: 3708
// Name: format
// Dependencies: [3657, 3708, 3475, 3709, 3720, 3638, 3479, 3476, 3721, 3480, 3722]
// Exports: default

// Module 3707 (format)
import isValid from "isValid" /* 3657 */;
import subMilliseconds from "subMilliseconds" /* 3708 */;
import _typeof from "_typeof" /* 3475 */;
import G from "G" /* 3709 */;
import dateLongFormatter from "dateLongFormatter" /* 3720 */;
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = _require(3480).getDefaultOptions();
  locale = undefined;
  if (null != locale) {
              ...
              if (isValid.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3722).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3722).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3722).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
