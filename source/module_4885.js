// Module ID: 4885
// Function ID: 4886
// Dependencies: [4886, 4887, 4888, 4889, 4890, 4883, 4882]
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = require(4883).FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = require(4883).FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = require(4883).FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
    ...
    fileChunk = require(4882) /* getFileChunk */.getFileChunk(fileChunk, num2);
    const FileTypes4 = require(4883).FileTypes;
