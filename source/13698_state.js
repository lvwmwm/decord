...
// Function ID: 13699
// Name: state
// Dependencies: [13662, 13637, 13699, 13653, 13700, 13682, 13660, 13693]
...
if (!require("all")) {
  if (!require("__core-js_shared__").state) {
    ...
    let closure_6 = tmp;
    require("module_13682")[tmp] = true;
    let fn = function t(facade) {
      if (require(13660) /* call */(facade, closure_6)) {
        const typeError = new tmp(13637).TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        tmp(13693)(facade, tmp3, arg1);
        return arg1;
      }
      tmp3 = closure_6;
    };
    ...
    let fn2 = function n(arg0) {
      return require(13660) /* call */(arg0, closure_6) ? arg0[closure_6] : {};
    };
    let fn5 = fn2;
    let fn3 = function u(arg0) {
      return require(13660) /* call */(arg0, closure_6);
    };
    let fn6 = fn3;
  }
...
if (!state) {
  ...
  const weakMap = new require("module_13637").WeakMap();
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new require(13637).TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
