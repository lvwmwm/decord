...
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 5495, 5473, 5489, 5496, 5498, 5471, 5500, 5499, 5501, 5502, 5472, 5486]
// Exports: default

// Module 5494 (_isNativeReflectConstruct)
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          if (someResult) {
            require(5499).ghQueueMicrotask(() => {
              self.update(1);
            });
            const obj = require(5499);
          }
          const props2 = self.props;
          const items = [];
          const obj2 = require(5498) /* transformIntoHandlerTags */;
          ...
          if (self.viewNode) {
            self.attachGestureHandler(importDefault(5502)(self.viewNode));
          } else {
            const _Error = Error;
