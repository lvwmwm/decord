// Module ID: 13288
// Function ID: 101772
// Dependencies: [13289, 13237, 13233, 13234, 13253, 13290, 13291, 13256]
...
if (getOwnPropertyDescriptor) {
  getOwnPropertyDescriptor = !require("module_13234")(() => 8 !== defineProperty(() => {
...
const fn = (name, toString) => {
  ...
  let tmp9 = !require(13253) /* call */(name, "name");
  if (!tmp9) {
    let CONFIGURABLE = require(13290).CONFIGURABLE;
    if (CONFIGURABLE) {
  ...
  if (tmp9) {
    if (require(13233) /* getOwnPropertyDescriptor */) {
  ...
  if (tmp22) {
    tmp22 = require(13253) /* call */(arg2, "arity");
  }
  if (tmp22) {
  ...
  if (arg2) {
    if (require(13253) /* call */(arg2, "constructor")) {
      if (arg2.constructor) {
        if (require(13233) /* getOwnPropertyDescriptor */) {
          obj = { writable: false };
      ...
      while (true) {
        ...
        let num4 = 6;
        let obj4 = require(13291) /* state */;
        let tmp43 = name;
        let enforceResult = obj4.enforce(name);
        let tmp45 = enforceResult;
        let str10 = "source";
        if (require(13253) /* call */(enforceResult, "source")) {
          break;
        } else {
          let tmp48 = text;
          let str11 = "";
...
Function.prototype.toString = fn(function toString() {
  const self = this;
  let source = require(13256) /* all */(this);
  if (source) {
    source = require(13291) /* state */.get(self).source;
    const obj = require(13291) /* state */;
  }
  if (!source) {
