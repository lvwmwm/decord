// Module ID: 13369
// Function ID: 102271
// Dependencies: [77, 6, 7, 13370, 13371, 13378]
...
let obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(tmp, require(13370) /* wrapperForImpl */.implSymbol)) {
        if (tmp[require(undefined, 13370) /* wrapperForImpl */.implSymbol] instanceof require(13371) /* URLImpl */.implementation) {
          return true;
        }
      }
  ...
  isImpl(getAll) {
    if (getAll) {
      if (getAll instanceof require(13371) /* URLImpl */.implementation) {
        return true;
      } else {
  ...
  create(arg0, arg1, arg2) {
    if (undefined === arg0[require(undefined, 13370) /* wrapperForImpl */.ctorRegistrySymbol]) {
      ...
      const _URL = arg0[require(undefined, 13370) /* wrapperForImpl */.ctorRegistrySymbol].URL;
      if (undefined === _URL) {
        const _Error = Error;
  ...
  setup(wrapper) {
    if (arguments.length > 2) {
      ...
      if (arguments.length > 3) {
        ...
        const _Object = Object;
        obj = {};
        let implementation = require(13371) /* URLImpl */.implementation;
        ...
        if (require(13371) /* URLImpl */.init) {
          require(13371) /* URLImpl */.init(wrapper[require(undefined, 13370) /* wrapperForImpl */.implSymbol], obj);
          const obj3 = require(13371) /* URLImpl */;
        }
        return wrapper;
      }
      obj = {};
  ...
  install(arg0) {
    ...
    arg0[_require(undefined, 13370).ctorRegistrySymbol].URL = tmp;
