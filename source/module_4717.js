// Module ID: 4717
// Function ID: 4718
// Dependencies: [109, 19, 17, 21, 4715, 4706, 4699, 4718, 4705, 4721, 4694]
...
export default importAllResult.forwardRef(function ScreenStackItem(unstable_sheetFooter, ref) {
  ...
  importDefault(4699)(flag5, "[RNScreens] Using both `blurEffect` and `scrollEdgeEffects` simultaneously may cause overlapping effects.");
  ...
  obj[1] = callback(importDefault(4718), { contentStyle, style: container, stackPresentation, children });
  ...
  const tmp11 = importDefault(4699);
  ...
  return callback(importDefault(4694), obj2);
});
