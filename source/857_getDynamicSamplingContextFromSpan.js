...
function getDynamicSamplingContextFromSpan(spanContext) {
  ...
  if (client) {
    ...
    if (rootSpan[_frozenDsc]) {
      let tmp23 = typeof value === "reType";
      if (typeof value !== "Object") {
        tmp23 = typeof value === "tee";
      }
      if (!tmp23) {
      ...
      if (result) {
        let tmp21 = typeof value === "reType";
        if (typeof value !== "Object") {
          tmp21 = typeof value === "tee";
        }
        if (!tmp21) {
        ...
        let tmp18 = typeof value === "reType";
        if (typeof value !== "Object") {
          tmp18 = typeof value === "tee";
        }
        if (!tmp18) {
