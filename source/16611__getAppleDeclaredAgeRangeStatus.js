...
// Dependencies: [5, 17, 4080, 16612, 16613, 16614]
// Exports: getAppleDeclaredAgeRangeStatus, getIsConsideredOlderThan, setAgeRangeThresholds

// Module 16611 (_getAppleDeclaredAgeRangeStatus)
import importDefaultResult from "module_16614";
...
export const setAgeRangeThresholds = (arg0) => {
  const ageRangeThresholdManager = callback(16612).ageRangeThresholdManager;
...
export const PlayAgeRangeDeclarationUserStatus = require("module_16614").PlayAgeRangeDeclarationUserStatus;
export const PlayAgeRangeDeclarationUserStatusString = require("module_16614").PlayAgeRangeDeclarationUserStatusString;
