...
// Dependencies: [32, 19, 17, 21, 1481, 4545, 9112, 4536, 1584, 5579, 9113, 9116, 9117]
// Exports: default

// Module 9111 (NativeStackViewInner)
...
function MaybeNestedStack(children) {
  ...
  return closure_7(importDefault(9112), obj);
}
function SceneView(arg0) {
  ...
  items1[2] = closure_7(importDefault(9113), obj13);
  obj4[1] = items1;
