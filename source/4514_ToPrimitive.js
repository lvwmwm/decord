...
// Function ID: 4515
// Name: ToPrimitive
// Dependencies: [1402, 4515, 4516, 4517]

// Module 4514 (ToPrimitive)
...
export default function ToPrimitive(arg0) {
  let tmp22;
  if (require(4515) /* isPrimitive */(arg0)) {
    return arg0;
  } else {
    let str2 = "default";
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4517)(arg0) || tmp(4516)(arg0);
          const tmp15 = tmp(4517)(arg0) || tmp(4516)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
