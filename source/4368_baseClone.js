...
// Function ID: 4369
// Name: baseClone
// Dependencies: [606, 599, 4369, 4370, 770, 621, 4371, 4372, 4375, 4379, 4383, 4384, 4385, 775, 4391, 4393, 4395, 792, 4380, 616, 600, 4377]

// Module 4368 (baseClone)
let obj = {};
  ...
  if (!arg2) {
    {
      if (_require(606)(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4369)(arr);
          obj = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4370)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(621)(arr)) {
            return tmp32(4371)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (obj[tmp11]) {
                  tmp14 = tmp32(4385)(arr, tmp11, tmp);
                  obj = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4375);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4379)(obj, arr));
                } else {
                  tmp32Result = tmp32(4383);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4384)(obj, arr));
                }
