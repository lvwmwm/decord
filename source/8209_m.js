...
let fn = function m() {
      ...
      while (true) {
        ...
        while (!str3) {
          ...
          switch (symbol) {
                ...
                if (num14) {
                  ...
                  if ("until" === obj.symbol) {
                    ...
                    if (obj.accept("for")) {
                      ...
                      obj.count = parseInt(obj.value[0], num2);
                      str3 = "number";
            ...
            case "$":
            break;
            case "isPureReactComponent":
            break;
            case "transitionToStep":
            break;
            case "parseStackFrames":
            break;
            case "getSkuIdForAnalytics":
            break;
            ...
            case "int64toString":
            break;
            case "AD_VIDEO_TIME_TO_FIRST_FRAME":
            break;
            case "FIRST_FRAME_CALLBACK":
            break;
            case "BACK_TO_PREVIOUS_SCREEN":
            break;
            case "SCREEN":
            break;
            case "SCREENSHARE_REPLACES_CHAT":
            break;
            case "CHAT_CONTEXT_BAR_ACTION_CANCELED":
            break;
            case "DURABLE_PRIMARY":
            break;
            case "PRIMARY_MEDIUM":
            break;
            case "MEDIUM_BUTTON_HORIZONTAL_PADDING":
            break;
            case "GUILD_CAP":
            break;
            ...
            case "localUser":
            break;
            case "localUserCreatedTimestamp":
            break;
            case "parseInline":
            break;
            ...
            case "BORDER_SUBTLE":
            break;
            case "LEGACY_LAUNCH_CLIENT_VALIDATION_FAILED":
            break;
            case "USER_APPLIED_GUILD_BOOSTS":
            break;
            case "APPLIED_GUILD_BOOST":
            break;
            case "APPLIED_GUILD_BOOSTS_FOR_GUILD":
            break;
            case "GUILD_BOOST":
            break;
            case "GUILD_BOOSTS":
            break;
            case "GUILD_ACTION_STUDENT_HUB_ADD_SERVER":
            break;
            case "SERVER_GUIDE_VIEWED":
            break;
            case "GUILD_SETTINGS_SUBMIT":
            break;
            case "GUILD_SETTINGS_SUBMIT_SUCCESS":
            break;
            case "pillLabel":
            break;
            ...
            case "#11806a":
            break;
            case "PRESS_KICK_USER":
            break;
            case "USER_ACCOUNT_EMAIL_CHANGE_WARNING":
            break;
            case "USER_ACCOUNT_EMAIL_CHANGE_WARNING_CONTINUE":
            break;
            case "#1abc9c":
            break;
            case "abc":
            ...
            case "06":
            break;
            case "useQuestOrbRewardMultiplier":
            break;
            case "#2ecc71":
            break;
            ...
            break;
            case "liabilityShifted":
            break;
            case "#3498db":
            break;
            case "useNullableMessageAuthor":
            break;
            case "getBuildOverrides":
            break;
            case "#546e7a":
            break;
            case "#5865f2":
            ...
            case "_cancel":
            break;
            case "_cancelHoverInDelayTimeout":
            break;
            case "cancel":
            break;
            case "outboundBandwidthSurplus":
            break;
            case "plusCountContainer":
            break;
            case "#979c9f":
            break;
            ...
            case "aa":
            break;
            case "isFreeForStaffSelfPurchase":
            break;
            ...
            case "kicking":
            break;
            case "getIntervalString":
            break;
            case "getIntervalStringAsNoun":
            break;
            case "unProcessedIndices":
            break;
            case "itemFeedIndex":
            break;
            case "expressionSourceApplication":
            break;
            case "ApplicationStreamSettingRequirements":
            break;
            case "qui":
            break;
            case "endFillColor":
            ...
            break;
            case "person_with_crown_dark_skin_tone":
            break;
            case "crown":
            break;
            case "$ZodGUID":
            ...
            break;
            case "SUPER_REACTION_TOGGLE_EDUCATION_MOBILE":
            break;
            case "MOBILE_COMMAND_BAR_DIVIDER":
            break;
            case "DIVIDER_BACKGROUND":
            break;
            case "BACKGROUND_LIGHTNESS_DARK_THEME":
            break;
            case "THEME_ITEM_HEIGHT":
            break;
            case "ITEM_HEIGHT":
            break;
            case "$ZodKSUID":
            ...
            case "doNotTrack":
            break;
            case "TrackMediaRedactionContext":
            break;
            case "textGreen":
            break;
            case "$ZodLazy":
            ...
            case "getProductName":
            break;
            case "getProductNameAndTypeFromSku":
            break;
            case "$ZodOptional":
            break;
            case "ZodOptional":
            ...
            case "ZodSuccess":
            break;
            case "useFetchStickerPack":
            break;
            case "useFetchStickerPacks":
            break;
            ...
            case "omit":
            break;
            case "getHardwareEncoding":
            break;
            case "getHeaderNoTitle":
            break;
            case "verticalInset":
            break;
            case "$modal":
            ...
            case "FRAME_STOP":
              ...
              num = 12;
            break;
            case "STOP_IMMEDIATE_PROPAGATION_FLAG_KEY":
            break;
            case "hasMessageSnapshotsWithAttachmentsOrEmbeds":
            break;
            case "+cGVV6":
            break;
            case "V6nAfF":
            ...
            break;
            case "getLastAudioInputDeviceChangeTimestamp":
            break;
            ...
            case "-5":
            break;
            case "getProtoFieldClass":
            break;
            case "-6":
            break;
            case "detachInactiveScreens":
            break;
            case "PremiumGiftSuccessActions":
            break;
            case "scrollInterpolator":
            break;
            case "imageStyle":
            break;
            case "../../../../lib/assign":
            ...
            case "debugLogText":
            break;
            case "extractCaptchaPropsFromResponse":
            break;
            case "searchTokenType":
            break;
            case "canUseCollectibles":
            break;
            case "CollectiblesAnalyticsProvider":
            break;
            case "clientApiUrl":
            break;
            case "challenges":
            ...
            case "paypalClientId":
            break;
            case "merchantCheckoutId":
            break;
            case "supportedCardBrands":
            break;
            case "unvettedMerchant":
            break;
            case "currencyCode":
            break;
            case "usBankAccount":
            ...
            case "routeId":
            break;
            case "enrichedCustomerDataEnabled":
            break;
            case "visa":
            break;
            case "visaCheckout":
            ...
            break;
            case "doesDatabaseVersionMatchJsConstants":
            break;
            case "getTrait":
            break;
            case "/w/EYk":
            break;
            case "notifyMessagesInSelectedChannel":
            break;
            case "btLpToken":
            break;
            case "en-001":
            ...
            case "2/1":
            break;
            case "CHAT_INPUT_SEND_BUTTON_HEIGHT":
            break;
            case "BLUE_NEW_21":
            break;
            case "21/9":
            ...
            case "2jxGer":
            break;
            case "tiffHeaderOffset":
            break;
            case "setClipRecordUser":
            break;
            case "2mIlKQ":
            break;
            case "Q":
            ...
            case "nsfwAllowed":
            break;
            case "categoryStoreListingId":
            break;
            case "disableViewPreallocationAndroid":
            break;
            case "3340dY":
            break;
            case "39d0Wj":
            ...
            case "TGO":
            break;
            case "GUILD_FOLDER_PREVIEW_OPACITY":
            break;
            case "OPACITY_28":
            break;
            ...
            case "selectedColors":
            break;
            case "attenuateWhileSpeakingSelf":
            break;
            case "SelfDismissibleAlertBody":
            break;
            ...
            case "RE":
            break;
            case "SUMMER_BOGO_2025":
            break;
            case "BOGO_2025_ANNOUNCEMENT_MODAL":
            break;
            case "MODAL_CAROUSEL_PREV":
            break;
            case "CAROUSEL_PREV":
            break;
            ...
            break;
            case "GUILD_CHANNEL_RESYNC_COMPLETED":
            break;
            ...
            case "CYP":
            break;
            case "updateSessionDataForTransport":
            break;
            case "school":
            break;
            case "school_satchel":
            break;
            case "possiblyViewableIndices":
            break;
            ...
            break;
            case "FAMILY_CENTER_LINK_CODE":
            break;
            case "FAMILY_CENTER_LINK_CODE_FETCH_SUCCESS":
            break;
            ...
            case "OPACITY_52":
            break;
            case "QUEST_VIDEO_FULLSCREEN_EXITED":
            break;
            case "5h8p5P":
            break;
            case "timeWindow":
            ...
            break;
            case "getKrispEnableStats":
            break;
            case "getScrollableNode":
            break;
            case "defaultStackLineParsers":
            break;
            ...
            case "attachmentIds":
            break;
            case "showIconSparkle":
            break;
            case "POLL_ANSWER_VOTERS":
            break;
            case "crocodile":
            break;
            case "dil":
            ...
            case "sneezing_face":
            break;
            case "handleShowUrgentMessageAlert":
            break;
            ...
            case "6Qgrev":
            break;
            case "getQuestOrbRewardQuantityForUser":
            break;
            case "flag_td":
            break;
            case "NEUTRAL_33":
            ...
            break;
            case "disableNewUserDismissibleContent":
            break;
            case "DismissibleContent":
            break;
            case "DismissibleContentGroupName":
            break;
            case "6moJ8s":
            break;
            ...
            break;
            case "GUILD_DEFAULT_PROPERTY_VALUES":
            break;
            case "StretchOutX":
            break;
            case "tXXD6v":
            ...
            break;
            case "IS_MODERATOR_REPORT_CHANNEL":
            break;
            case "CHANNEL_AUTOCOMPLETE_SELECTED":
            break;
            case "DIVIDER_MARGIN_TOP":
            break;
            ...
            case "SIZE_152":
            break;
            case "client_track_timestamp":
            break;
            case "times":
            break;
            case "timestamp":
            break;
            case "timestampAccessibilityLabel":
            break;
            case "isAudioFile":
            break;
            ...
            case "oEAioF":
            break;
            case "woman_in_motorized_wheelchair_medium_light_skin_tone":
            break;
            case "man_in_motorized_wheelchair_medium_light_skin_tone":
            break;
            case "8jmdON":
            break;
            case "jmd":
            ...
            case "forLater":
            break;
            case "markForumPostItemAsSeen":
            break;
            case "enableFriendAnniversaryNotifications":
            break;
            case "customNativeProps":
            break;
            case "9rfonh":
            break;
            case "rf":
            ...
            break;
            case "cartesianOffset":
            break;
            case "setActiveSpanId":
            break;
            case "unusual_dm_activity_until":
            break;
            ...
            case "Model":
            break;
            case "CHANNEL_NOTICE_PREMIUM_GUILD_SUBSCRIPTION":
            break;
            case "PREMIUM_GUILD":
            break;
            case "PREMIUM_GUILD_SUBSCRIPTIONS_PANEL":
            break;
            case "GUILD_SUBSCRIPTION":
            break;
            case "SUBSCRIPTIONS_PANEL":
            break;
            case "includeMessageReferences":
            break;
            ...
            break;
            case "ACCEPT_HAM_CONFIRMATION_PROMPT":
            break;
            case "PROMPT_SKIPPED":
            break;
            case "APPROVED":
            ...
            break;
            case "SPAN_ORIGIN_AUTO_NAVIGATION_CUSTOM":
            break;
            case "CUSTOM_APP_ICONS_NEW_BADGE":
            break;
            ...
            break;
            case "MESSAGE_REQUEST_ACCEPT_CONFIRMATION_MODAL":
            break;
            case "AG":
            break;
            case "isAgeVerificationMessageWithRetryCta":
            break;
            case "ACCEPT_QUEST":
            break;
            case "QUESTS_ENROLL":
            ...
            case "DISCOVERABLE":
            break;
            case "DISCOVERABLE_GUILD_INVITE_LURKER":
            break;
            case "SC":
            break;
            case "COVER":
            ...
            case "GUILD_INVITE":
            break;
            case "LURKER_STAGE_CHANNEL_PERMISSIONS_ALLOWLIST":
            break;
            case "ALLOWLIST":
            break;
            case "STAGE_CHANNEL_UPSELL":
            break;
            ...
            case "THEME":
            break;
            case "MESSAGE_SEARCH_RESULT_TABS":
            break;
            case "MESSAGE_SEARCH_RESULT_TABS_SET":
            break;
            case "SET_OVERLAY_LOCKED":
            break;
            ...
            case "SKU":
            break;
            case "subscriptionHasPremiumGuildPlan":
            break;
            case "star_struck":
            break;
            case "ACCOUNT_DELETE":
            ...
            case "MU":
            break;
            case "MULTIACCOUNT_TOOLTIP_SEEN_KEY":
            break;
            case "TO":
            break;
            case "K0OWP+":
            break;
            case "GameServerHostingRive":
            break;
            case "xbb":
            break;
            case "MESSAGE_GROUP_SPACING":
            break;
            case "flag_je":
            break;
            case "nitroJoinCTA":
            ...
            break;
            case "GUILD_ENTITLEMENTS":
            break;
            case "ENTITLEMENTS_FOR_APPLICATION":
            break;
            case "APPLICATION_COMMAND_CACHE_FETCH":
            break;
            case "FETCH_BACKOFF_MAX_MS":
            break;
            case "SUB_COMMAND":
            break;
            ...
            case "bento_box":
            break;
            case "impressionEndTimestamp":
            break;
            case "parseContentLengthHeader":
            break;
            case "ACCOUNT_POPOUT":
            break;
            case "POP":
            ...
            case "DAYS_30":
            break;
            case "BILLING_SPENDING_LIMIT_REACHED":
            break;
            case "DISCORD_ORB":
            break;
            case "ORBITRON":
            ...
            case "COPY_APP_ID":
            break;
            case "woman_bowing_medium_dark_skin_tone":
            break;
            case "man_bowing_medium_dark_skin_tone":
            break;
  ...
  let obj = {
    ...
    r(arg0) {
      let toStringTag = typeof Symbol === "__INTERNAL_SLOT_MAP__";
