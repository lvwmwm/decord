...
// Dependencies: [32, 12318, 12319, 12317, 12311]

// Module 12323 (convertBaseSchema)
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const fnResult = fn(_mod12318);
    let obj = {};
    let merged = Object.assign(fn(_mod12317));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(_mod12319);
    let _Set = Set;
