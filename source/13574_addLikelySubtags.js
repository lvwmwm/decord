...
// Dependencies: [1281, 13575, 13576, 13640, 13647, 13652, 13667, 13668]
...
function addLikelySubtags(locale) {
  ...
  let script;
  let variants;
  const parseUnicodeLocaleIdResult = require(13640) /* isStructurallyValidLanguageTag */.parseUnicodeLocaleId(locale);
