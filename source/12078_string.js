...
// Function ID: 94216
// Name: string
// Dependencies: [5, 65, 12012, 12075, 12079, 12080, 12081, 12074]

// Module 12078 (string)
import asyncGeneratorStep from "module_12080";
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class) {
      ...
      if (arguments.length > 1) {
        ...
        const util = _require(12012).util;
    ...
    let closure_9 = fn(require("module_12079"));
    let closure_10 = fn(require("module_12080"));
    let closure_11 = fn(require("module_12081"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      let obj = {};
      obj = { input: _require(12074).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12074).createStandardJSONSchemaMethod(_standard, "output") };
      obj.jsonSchema = obj;
      const merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12074).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
