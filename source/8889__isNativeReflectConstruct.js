...
// Dependencies: [41, 42, 93, 95, 98, 8883, 8884]
// Exports: Chi, Maj

// Module 8889 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function update(B) {
      ...
      let view;
      const self = this;
      HashMD(8884).exists(this);
      ({ buffer, blockLen, view } = this);
      const toBytesResult = HashMD(8883).toBytes(B);
      let num = 0;
  ...
  },
  {
    ...
    value: function digestInto(content) {
      ...
      const self = this;
      HashMD(8884).exists(this);
      HashMD(8884).output(content, this);
      this.finished = true;
      ...
      self.process(view, 0);
      view = HashMD(8883).createView(content);
