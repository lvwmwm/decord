...
// Dependencies: [5, 27, 91, 13401, 13403, 13405, 13406, 13409, 13410, 13423, 13425, 13427, 13428, 13429, 13430, 13411]

// Module 13400 (getPluginOptions)
...
obj6.host = (function getHost(localhost) {
  ...
  if ("string" !== typeof scriptURL) {
    ...
    return require(13430) /* getHostFromUrl */.getHostFromUrl(scriptURL);
  }
