...
// Dependencies: [7832, 7783, 7821, 7782, 7785, 7804, 7776]

// Module 7866 (extraErrorDataIntegration)
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(7804).DEBUG_BUILD) {
                const logger = callback(7776).logger;
