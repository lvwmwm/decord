...
// Dependencies: [41, 42, 17, 1641, 1678, 1637, 1645]

// Module 1770 (ProgressTransitionManager)
...
let obj = {
  ...
  value: function addProgressAnimation(viewTag, progressAnimation) {
    ...
    _require(1641).runOnUIImmediately(fn)();
...
const items = [
  obj,
  {
    ...
    value: function removeProgressAnimation(viewTag) {
      ...
      flag(1641).runOnUIImmediately(fn)();
    }
  },
  {
    ...
    value: function registerEventHandlers() {
      ...
      if (!this._eventHandler.isRegistered) {
        ...
        let c0 = -1;
        let obj = require(1678) /* isReanimated3 */;
        ...
        _eventHandler.onAppear = require(1678) /* isReanimated3 */.registerEventHandler(fn2, "onAppear");
        const obj3 = require(1678) /* isReanimated3 */;
        ...
        _eventHandler.onDisappear = require(1678) /* isReanimated3 */.registerEventHandler(fn3, "onFinishTransitioning");
        const obj4 = require(1678) /* isReanimated3 */;
      }
    }
  },
  {
    ...
    value: function unregisterEventHandlers() {
      ...
      if (0 === this._sharedElementCount) {
        ...
        if (-1 !== this._eventHandler.onTransitionProgress) {
          const result = require(1678) /* isReanimated3 */.unregisterEventHandler(_eventHandler.onTransitionProgress);
          _eventHandler.onTransitionProgress = -1;
          const obj = require(1678) /* isReanimated3 */;
        }
        if (-1 !== this._eventHandler.onAppear) {
          const result1 = require(1678) /* isReanimated3 */.unregisterEventHandler(_eventHandler.onAppear);
          _eventHandler.onAppear = -1;
          const obj2 = require(1678) /* isReanimated3 */;
        }
        if (-1 !== this._eventHandler.onDisappear) {
          const result2 = require(1678) /* isReanimated3 */.unregisterEventHandler(_eventHandler.onDisappear);
          _eventHandler.onDisappear = -1;
          const obj3 = require(1678) /* isReanimated3 */;
        }
        if (-1 !== this._eventHandler.onSwipeDismiss) {
          const result3 = require(1678) /* isReanimated3 */.unregisterEventHandler(_eventHandler.onSwipeDismiss);
...
if (isJest.shouldBeUseWeb()) {
  function maybeThrowError() {
    if (!obj.isJest()) {
      const reanimatedError = new tmp(1645).ReanimatedError("`ProgressTransitionRegister` is not available on non-native platform.");
