...
// Dependencies: [19, 5533, 10225]
// Exports: usePanGestureProxy

// Module 10224 (usePanGestureProxy)
...
export const usePanGestureProxy = (onConfigurePanGesture) => {
  ...
  const tmp = onGestureUpdate(() => {
    ...
    let obj = { onBegin: "call", onStart: "substring_i", onUpdate: "getCurrentUser", onEnd: "find", onFinalize: "IconComponent" };
