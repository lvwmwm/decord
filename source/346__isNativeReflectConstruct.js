...
export default (arg0) => {
  class AnimatedAddition {
    constructor(arg0, arg1, arg2) {
      ...
      items = [];
      items[0] = arg2;
      obj = closure_5(AnimatedAddition);
      tmp2 = closure_4;
      if (closure_8()) {
        tmp4 = globalThis;
        _Reflect = Reflect;
      ...
      if ("number" === typeof arg0) {
        ...
        tmp9 = closure_1;
        num = 6;
        tmp10 = AnimatedAddition(closure_1[6]);
      ...
      if ("number" === typeof arg1) {
        ...
        tmp16 = closure_1;
        num2 = 6;
        tmp17 = AnimatedAddition(closure_1[6]);
  ...
  const importDefault = AnimatedAddition;
  ...
  let obj = {
    ...
    value: function __makeNative(arg0) {
      ...
      const items = [arg0];
      callback4(AnimatedAddition, "__makeNative", this, 3)(items);
    }
  };
  const items = [obj, , , , , ];
  obj = {
  ...
  obj = {
    ...
    value: function interpolate(arg0) {
      let tmp = AnimatedAddition(closure_1[7]);
  ...
  items[3] = {
    ...
    value: function __attach() {
      ...
      const _b = this._b;
      _b.__addChild(this);
      callback4(AnimatedAddition, "__attach", this, 3)([]);
    }
  };
  items[4] = {
    key: "__detach",
    value: function __detach() {
      ...
      callback4(AnimatedAddition, "__detach", this, 3)([]);
    }
  };
  items[5] = {
