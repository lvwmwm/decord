...
export const horizontalStackLayout = function horizontalStackLayout() {
  ...
  obj = { screen: closure_3, modeConfig: obj, getCommonVariables, getCommonStyles, interpolate: obj(1606).interpolate, Extrapolation: obj(1606).Extrapolation };
  fn.__closure = obj;
