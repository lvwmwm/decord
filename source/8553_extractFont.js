...
// Function ID: 8554
// Name: extractFont
// Dependencies: [19, 21, 8547, 8552]
// Exports: default, setTSpan

// Module 8553 (extractFont)
import "noop";
...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(8547) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "y") {
    ...
    obj[7] = importDefault(8552)(tmp);
    obj[8] = importDefault(8552)(tmp2);
    obj[9] = importDefault(8552)(tmp3);
    obj[10] = importDefault(8552)(tmp4);
    obj[11] = importDefault(8552)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
