...
export const forFadeFromBottomAndroid = function forFadeFromBottomAndroid(current) {
  ...
  obj[0] = require(5841) /* conditional */.conditional(closing, current.progress, progress2.interpolate({ inputRange: [0, 0.5, 0.9, 1], outputRange: [0, 0.25, 0.7, 1], extrapolate: "clamp" }));
...
export const forScaleFromCenterAndroid = function forScaleFromCenterAndroid(closing) {
  ...
  const tmp = closure_3;
  const progress3 = current.progress;
  const obj6 = require(5841) /* conditional */;
...
export const forFadeFromRightAndroid = function forFadeFromRightAndroid(closing) {
  ...
  const progress3 = current.progress;
  obj[0] = require(5841) /* conditional */.conditional(closing.closing, progress3.interpolate({ inputRange: [0, 1], outputRange: [0, 1], extrapolate: "clamp" }), current.progress);
...
export const forBottomSheetAndroid = function forBottomSheetAndroid(current) {
  ...
  const tmp = callback(progress.interpolate({ inputRange: [0, 1], outputRange: items, extrapolate: "clamp" }), inverted);
  const progress2 = current.progress;
  obj[0] = require(5841) /* conditional */.conditional(closing, current.progress, progress2.interpolate({ inputRange: [0, 1], outputRange: [0, 1], extrapolate: "clamp" }));
  const items1 = [{ translateY: tmp }];
  obj[1] = items1;
  obj[0] = obj;
