...
// Dependencies: [5446, 1653, 5439, 5466]

// Module 5465 (useScrollEventsHandlersDefault)
const require = arg1;
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj = { animatedSheetState, SHEET_STATE: _require(5439).SHEET_STATE, animatedHandleGestureState, State: _require(5466).State, animatedScrollableState, SCROLLABLE_STATE: _require(5439).SCROLLABLE_STATE, scrollTo: _require(1653).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue };
  E.__closure = obj;
  ...
  obj1 = { scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, rootScrollableContentOffsetY: animatedScrollableContentOffsetY, animatedSheetState, SHEET_STATE: _require(5439).SHEET_STATE };
  O.__closure = obj1;
  ...
  obj2 = { animatedScrollableState, SCROLLABLE_STATE: _require(5439).SCROLLABLE_STATE, scrollTo: _require(1653).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5439).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
  fn2.__closure = obj2;
  ...
  const obj11 = _require(1653);
  C.__closure = { animatedScrollableState, SCROLLABLE_STATE: _require(5439).SCROLLABLE_STATE, scrollTo: _require(1653).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5439).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
