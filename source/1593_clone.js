...
// Function ID: 1594
// Name: clone
// Dependencies: [19, 17, 1483, 1580, 1502, 1594]
...
export const useLinkProps = function useLinkProps(arg0) {
  ...
  let context1;
  let obj = merged;
  const context = merged.useContext(require(1483) /* BaseNavigationContainer */.NavigationContainerRefContext);
  context1 = merged.useContext(require(1483) /* BaseNavigationContainer */.NavigationHelpersContext);
  if (context1 == null) {
    context1 = context;
  }
  if (null == context1) {
    ...
    const options = obj.useContext(tmp2(1580).LinkingContext).options;
    const tmp14 = importDefault(1502)((preventDefault) => {
    ...
    const items = [merged.href, tmp2(1594).useDeepStableValue(undefined), , ];
