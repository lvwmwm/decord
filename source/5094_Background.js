...
// Function ID: 44346
// Name: Background
// Dependencies: [5095, 5096, 5097, 5098, 5099, 5100, 5101, 5106, 5112, 5105, 5113, 5102, 5104, 5114, 5115, 5111, 5116, 5117, 5118]

// Module 5094 (Background)
const items = [require("registerAsset"), require("registerAsset")];
for (const key10023 in require("module_5097")) {
  let tmp2 = key10023;
  arg5[key10023] = require("module_5097")[key10023];
  continue;
}
...
export const HeaderBackButton = require("StyleSheet");
