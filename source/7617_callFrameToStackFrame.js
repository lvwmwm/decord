...
// Dependencies: [7505, 7502, 7615]

// Module 7617 (callFrameToStackFrame)
const require = arg1;
...
arg5.callFrameToStackFrame = function callFrameToStackFrame(location, str) {
  ...
  obj[2] = location.functionName || require(7502) /* createStackParser */.UNKNOWN_FUNCTION;
  obj[3] = sum;
  obj[4] = sum1;
  let filenameIsInAppResult;
  if (replaced) {
    filenameIsInAppResult = tmp4(7615).filenameIsInApp(replaced);
    const tmp4Result = tmp4(7615);
  }
