...
obj1 = { aze: true, azj: true, borderRadius: importDefault(dependencyMap[8]).radii.round, backgroundColor: importDefault(dependencyMap[8]).colors.BACKGROUND_MOD_STRONG };
...
let closure_13 = importAllResult.memo(function GuildItemInner(guildId) {
  ...
  obj = { "Null": 366, "Null": null, guildId, selected: guildId.selected, onPress: callback, onLongPress: callback1, backgroundColor: tmp.maskStrokeStyle.backgroundColor };
