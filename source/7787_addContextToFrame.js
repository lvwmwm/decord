...
// Dependencies: [7777, 7785, 7782]

// Module 7787 (addContextToFrame)
...
arg5.addContextToFrame = function addContextToFrame(arr, lineno) {
  ...
  if (undefined !== lineno.lineno) {
    ...
    lineno.pre_context = substr.map((arg0) => callback(7785).snipLine(arg0, 0));
    const _Math5 = Math;
    ...
    lineno.post_context = substr1.map((arg0) => callback(7785).snipLine(arg0, 0));
