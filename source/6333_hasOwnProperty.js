...
// Function ID: 6334
// Name: hasOwnProperty
// Dependencies: [6331, 6334]

// Module 6333 (hasOwnProperty)
...
obj.to.hex = () => {
  const tmp = require(6334) /* swizzle */(arguments);
...
obj.to.rgb = () => {
  const arr = require(6334) /* swizzle */(arguments);
  if (arr.length >= 4) {
    if (1 !== arr[3]) {
      const _Math = Math;
      const _Math2 = Math;
