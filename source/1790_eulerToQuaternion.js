...
// Dependencies: [19, 1659, 1678, 1641]
// Exports: useAnimatedSensor

// Module 1790 (eulerToQuaternion)
...
function adjustRotationToInterfaceOrientation(pitch) {
  ...
  if (interfaceOrientation === require(1659) /* isWorkletFunction */.InterfaceOrientation.ROTATION_90) {
    pitch.pitch = roll;
    pitch.roll = -pitch;
    const _Math2 = Math;
...
export const useAnimatedSensor = function useAnimatedSensor(arg0, adjustToInterfaceOrientation) {
  ...
  obj[0] = _require(1678).initializeSensor(arg0, tmp13);
