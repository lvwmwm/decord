...
// Function ID: 71418
// Name: StyleSheet
// Dependencies: [57, 31, 27, 33, 1457, 9118, 5528, 9119, 4478]
// Exports: default

// Module 9117 (StyleSheet)
...
export default function HeaderConfig(arg0) {
  ...
  let obj1 = require(9118) /* processFonts */;
  ...
  let obj2 = require(5528) /* Background */;
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" !== headerTitleAlign) {
      ...
      if (!tmp14) {
        ...
        tmp47 = callback2(require(5528) /* Background */.HeaderTitle, obj7);
      }
      tmp46 = tmp47;
    }
    items1[1] = tmp46;
  ...
  if ("center" === headerTitleAlign) {
    ...
    if (!tmp14) {
      ...
      headerTitleResult = callback2(require(5528) /* Background */.HeaderTitle, obj9);
    }
