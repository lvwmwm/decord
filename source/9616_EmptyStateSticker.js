...
let closure_13 = arg1(dependencyMap[8]).createStyles({ header: { bounces: null, keyboardShouldPersistTaps: null }, blurb: { registerAsset: false, ref: false, user: false }, premiumButton: {}, nitroWheel: { width: 32 }, stickersRow: { title: true, commandId: true }, sticker: { paddingHorizontal: 2 } });
