...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8617, 8612, 8552]

// Module 8618 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (points) {
        const _HermesInternal = HermesInternal;
        combined = "M" + Polyline(8617)(points);
      }
      obj[1] = combined;
      const merged = Object.assign(props);
      return jsx(Polyline(8612), { ref: this.refMethod, d: null });
    }
  }
];
