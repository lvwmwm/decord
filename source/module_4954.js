...
arg5.default = {
  read(byteLength) {
    ...
    const sum = arg1 + arg2;
    let obj1 = require(4930) /* readTag */;
    const ifd = obj1.readIfd(byteLength, require(4931) /* importDefaultResult1 */.IFD_TYPE_PENTAX, sum, sum + 10, byteOrder, arg3, true);
    ...
    if (LevelInfo) {
      ...
      const tmp7Result = require(4910) /* getDataView */;
      delete tmp[tmp2];
      tmp10 = require(4910) /* getDataView */.objectAssign({}, ifd, obj);
      const objectAssignResult = require(4910) /* getDataView */.objectAssign({}, ifd, obj);
    }
    return tmp10;
  },
