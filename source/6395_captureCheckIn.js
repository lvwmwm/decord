...
// Function ID: 57266
// Name: captureCheckIn
// Dependencies: [5, 6374, 6396, 6375, 6347, 6358, 6361, 6354, 6384, 6348, 6370]
...
function endSession() {
  ...
  if (tmp) {
    require(6370) /* updateSession */.closeSession(tmp);
    const obj5 = require(6370) /* updateSession */;
  }
  _sendSessionUpdate();
...
function _sendSessionUpdate() {
  ...
  const obj = require(6374) /* getCurrentScope */;
  const currentScope = require(6374) /* getCurrentScope */.getCurrentScope();
  const obj3 = require(6374) /* getCurrentScope */;
  const client = require(6374) /* getCurrentScope */.getClient();
  const tmp = currentScope.getSession() || isolationScope.getSession();
  let tmp2 = tmp;
  if (tmp) {
...
export const captureException = function captureException(arg0, arg1) {
  const currentScope = require(6374) /* getCurrentScope */.getCurrentScope();
  const obj = require(6374) /* getCurrentScope */;
  return currentScope.captureException(arg0, require(6396) /* applyClientOptions */.parseEventHintOrCaptureContext(arg1));
};
...
export const isInitialized = function isInitialized() {
  return require(6374) /* getCurrentScope */.getClient();
};
...
export const startSession = function startSession(arg0) {
  ...
  if (undefined === environment) {
    environment = require(6384).DEFAULT_ENVIRONMENT;
  }
  const obj5 = require(6374) /* getCurrentScope */;
  const userAgent = require(6348) /* getGlobalSingleton */.GLOBAL_OBJ.navigator || {}.userAgent;
  const tmp3 = require(6348) /* getGlobalSingleton */.GLOBAL_OBJ.navigator || {};
  obj = { release, environment };
  const obj8 = require(6370) /* updateSession */;
  ...
  if (tmp8) {
    ...
    require(6370) /* updateSession */.updateSession(session1, obj1);
    const obj11 = require(6370) /* updateSession */;
  }
  endSession();
...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  function finishCheckIn(status) {
    const obj = { monitorSlug, status, checkInId: closure_2, duration: monitorSlug(6361).timestampInSeconds() - callback };
    callback(obj);
  }
  let closure_2 = captureCheckIn({ monitorSlug, status: "in_progress" }, arg2);
  captureCheckIn = _require(6361).timestampInSeconds();
  let obj = { monitorSlug, status: "in_progress" };
  const obj2 = _require(6361);
  return _require(6374).withIsolationScope(() => {
