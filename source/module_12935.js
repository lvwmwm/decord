// Module ID: 12935
// Function ID: 12936
// Dependencies: [12929, 12900, 12920]

// Module 12935

export default (arg0, arg1) => {
  let require;
  let obj = new require(12929) /* Range */(arg0, arg1);
  const tmp3 = new require(12900) /* SemVer */("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(12900)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
        ...
        do {
          ...
          if (require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = require;
              tmp16 = !require(12920) /* SemVer */(tmp14, require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
