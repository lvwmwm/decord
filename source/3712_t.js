...
let fn = function t() {
  class hooks {
    ...
    static updateLocale(arg0, arg1) {
      if (null != arg1) {
        _config = Hours;
        tmp6 = loadLocale;
        tmp7 = loadLocale(arg0);
        if (null != tmp7) {
          _config = tmp7._config;
        }
        tmp8 = Locale;
        tmp9 = mergeConfigs;
        ...
        tmp10 = new.target;
        tmp11 = new.target;
        tmp12 = new Locale(mergeConfigs(_config, arg1));
        tmp13 = tmp12;
        tmp14 = Hours;
        tmp12.parentLocale = Hours[arg0];
        tmp15 = Hours;
        Hours[arg0] = tmp12;
        tmp16 = getSetGlobalLocale;
        tmp17 = getSetGlobalLocale(arg0);
      } else {
        tmp3 = Hours;
        if (null != Hours[arg0]) {
          tmp18 = Hours;
          if (null != Hours[arg0].parentLocale) {
            tmp5 = Hours;
            Hours[arg0] = Hours[arg0].parentLocale;
          } else {
            tmp4 = Hours;
            if (null != Hours[arg0]) {
              tmp19 = Hours;
  ...
  function hasOwnProp(closure_15, key10005) {
    return hasOwnProperty.call(closure_15, key10005);
  }
  ...
  function createUTC(items, _f) {
    return createLocalOrUTC(items, _f, arg2, arg3, true).utc();
  }
  function getParsingFlags(_pf) {
    if (null == _pf._pf) {
      const obj = { empty: false, unusedTokens: [], unusedInput: [], overflow: -2, charsLeftOver: 0, nullInput: false, invalidMonth: null, invalidFormat: false, userInvalidated: false, iso: false, parsedDateParts: [], meridiem: null, rfc2822: false, weekdayMismatch: false };
      _pf._pf = obj;
    }
    return _pf._pf;
  }
  function isValid(_isValid) {
    if (null == _isValid._isValid) {
      ...
      callResult = some.call(tmp7.parsedDateParts, (arg0) => null != arg0);
    }
    ...
    if (0 < bound) {
      do {
        ...
        if (!tmp3) {
          ...
          if (tmp4) {
            let tmp5 = toInt;
            let tmp6 = toInt(arg0[num2]);
            tmp4 = tmp6 !== toInt(arg1[num2]);
          }
          tmp3 = tmp4;
        }
        let sum = num3;
  ...
  function deprecate(closure_0, closure_1) {
    let c2 = true;
    const fn = function() {
      if (null != outer1_55.deprecationHandler) {
        outer1_55.deprecationHandler(null, closure_0);
      }
      if (c2) {
        const items = [];
  ...
  function mergeConfigs(_config, parentLocale) {
    ...
    for (const key10028 in arg0) {
      let tmp16 = key10028;
      let tmp17 = hasOwnProp;
      let tmp10 = hasOwnProp(arg0, key10028);
      if (tmp10) {
        let tmp9 = hasOwnProp;
        tmp10 = !hasOwnProp(arg1, key10028);
      }
      if (tmp10) {
        let tmp11 = isObject;
        tmp10 = isObject(arg0[key10028]);
      }
      if (!tmp10) {
        continue;
      } else {
        let tmp12 = extend;
        obj = {};
        let tmp13 = extend(obj, obj[key10028]);
        obj[key10028] = obj;
        continue;
      }
      continue;
  ...
  function normalizeUnits(key10006) {
    let tmp;
    if ("string" === typeof key10006) {
      let tmp3 = dependencyMap[key10006];
      if (!tmp3) {
        tmp3 = dependencyMap[key10006.toLowerCase(key10006)];
      }
      tmp = tmp3;
    }
    return tmp;
  }
  function normalizeObjectUnits(closure_15) {
    const obj = {};
    for (const key10006 in arg0) {
      let tmp5 = key10006;
      let tmp6 = hasOwnProp;
      let tmp3 = hasOwnProp(arg0, key10006);
      if (tmp3) {
        let tmp2 = normalizeUnits;
        tmp3 = normalizeUnits(key10006);
        let tmp = tmp3;
      }
      let tmp4 = tmp;
      if (!tmp3) {
  ...
  function addFormatToken(D, items, DDDo, year) {
    ...
    if (items) {
      closure_11[items[0]] = function() {
        return outer1_81(func(...arguments), items[1], items[2]);
      };
    }
    if (DDDo) {
  ...
  function formatMoment(self, Z) {
    if (self.isValid()) {
      let tmp4 = expandFormat(Z, self.localeData());
      let tmp6 = dependencyMap2[tmp4];
      if (!tmp6) {
        tmp6 = (function makeFormatFunction(str) {
          let closure_0 = str;
          const match = str.match(outer1_8);
          const length = match.length;
          let num = 0;
          if (0 < length) {
            do {
              let tmp2 = outer1_11;
              if (outer1_11[match[num]]) {
                let tmp4 = outer1_11;
                match[num] = outer1_11[match[num]];
                str = tmp;
              } else {
                str = match[num];
      ...
      dependencyMap2[tmp4] = tmp6;
      let invalidDateResult = dependencyMap2[tmp4](self);
  ...
  function addRegexToken(A, matchMeridiem, addRegexTokenResult29) {
    ...
    let closure_0 = matchMeridiem;
    let closure_1 = addRegexTokenResult29;
  ...
  function getParseRegexForToken(key10005, _strict) {
    if (hasOwnProp(dependencyMap3, key10005)) {
      let regExp = dependencyMap3[key10005](_strict._strict, _strict._locale);
    } else {
      const _RegExp = RegExp;
      regExp = new RegExp((function unescapeFormat(key10005) {
        return outer1_86(key10005.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, (arg0, arg1, arg2, arg3, arg4) => {
          let tmp = arg1;
          if (!arg1) {
            tmp = arg2;
          }
  ...
  function addTimeToArrayFromToken(key10005, first, _a) {
    let tmp = null != first;
    if (tmp) {
      tmp = hasOwnProp(dependencyMap4, key10005);
    }
    if (tmp) {
      dependencyMap4[key10005](first, _a._a, _a, key10005);
    }
  }
  ...
  function makeGetSet(Date, arg1) {
    ...
    return function(arg0) {
      const self = this;
      if (null != arg0) {
        outer1_92(self, closure_0, arg0);
        outer1_55.updateOffset(self, closure_1);
        let tmp3 = self;
      } else {
        tmp3 = outer1_91(self, closure_0);
      }
      return tmp3;
    };
  }
  ...
  function computeMonthsParse() {
    ...
    let num2 = 0;
    do {
      let tmp10 = regexEscape;
      items[num2] = regexEscape(items[num2]);
      items1[num2] = regexEscape(items1[num2]);
      num2 = num2 + 1;
      num3 = 0;
    } while (num2 < 12);
    do {
      let tmp11 = regexEscape;
      items2[num3] = regexEscape(items2[num3]);
      num3 = num3 + 1;
    } while (num3 < 24);
  ...
  function computeWeekdaysParse() {
    ...
    let num2 = 0;
    do {
      let tmp12 = regexEscape;
      items1[num2] = regexEscape(items1[num2]);
      items2[num2] = regexEscape(items2[num2]);
      items3[num2] = regexEscape(items3[num2]);
      num2 = num2 + 1;
    } while (num2 < 7);
  ...
  function defineLocale(bg, parentLocale) {
    if (null !== parentLocale) {
      ...
      if (null != dependencyMap5[bg]) {
        deprecateSimple("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info.");
        _config = dependencyMap5[bg]._config;
      } else if (null != parentLocale.parentLocale) {
        if (null != dependencyMap5[parentLocale.parentLocale]) {
          _config = dependencyMap5[parentLocale.parentLocale]._config;
        } else {
          const tmp6 = loadLocale(parentLocale.parentLocale);
          if (null == tmp6) {
            if (!dependencyMap6[parentLocale.parentLocale]) {
              dependencyMap6[parentLocale.parentLocale] = [];
            }
            let arr = dependencyMap6[parentLocale.parentLocale];
      ...
      dependencyMap5[bg] = tmp20;
      if (dependencyMap6[bg]) {
        const item = dependencyMap6[bg].forEach((name) => {
          outer1_109(name.name, name.config);
        });
        const arr2 = dependencyMap6[bg];
      }
      getSetGlobalLocale(bg);
      return dependencyMap5[bg];
    } else {
      delete tmp[tmp2];
      return null;
    }
  ...
  function checkOverflow(_a) {
    ...
    if (tmp) {
      if (_a[c18] >= 0) {
        if (_a[c18] <= 11) {
          if (_a[c19] >= 1) {
            if (_a[c19] <= daysInMonth(_a[c17], _a[c18])) {
              if (_a[c20] >= 0) {
                if (_a[c20] <= 24) {
                  if (24 !== _a[c20]) {
                    if (_a[c21] >= 0) {
  ...
  function configFromArray(_d) {
    ...
    if (!_d._d) {
      ...
      if (_w) {
        ...
        if (null == _w2.GG) {
          if (null == _w2.W) {
            if (null == _w2.E) {
              ...
              const tmp60 = defaults(_w2.gg, _d._a[c17], tmp57.year);
            ...
            if (tmp12 >= 1) {
              if (tmp12 <= weeksInYear(tmp11, num, num2)) {
                if (null != flag) {
                  ...
                  ({ year: _d._a[c17], dayOfYear: _d._dayOfYear } = dayOfYearFromWeeks(tmp11, tmp12, tmp13, num, num2));
        ...
        const tmp21 = defaults(_w2.GG, _d._a[c17], weekOfYear(createLocal(), 1, 4).year);
      ...
      if (null != _d._dayOfYear) {
        const tmp65 = defaults(_d._a[c17], items2[c17]);
        ...
        _d._a[c18] = obj2.getUTCMonth();
        _d._a[c19] = obj2.getUTCDate();
      }
      let num15 = 0;
      let num16 = 0;
      if (null == _d._a[0]) {
  ...
  function configFromStringAndFormat(_f) {
    ...
    if (_f._f !== hooks.ISO_8601) {
      if (_f._f !== hooks.RFC_2822) {
        ...
        ({ _meridiem: getParsingFlags(undefined, _f).meridiem, _locale } = _f);
  ...
  function prepareConfig(_l) {
    ...
    if (null !== _i) {
      ...
      if (isMoment(tmp2)) {
        checkOverflow(tmp2);
        let prototype2 = Moment.prototype;
        tmp33 = new Moment(tmp2);
      } else {
        if (isDate(tmp2)) {
          _l._d = tmp2;
        } else if (isArray(_f)) {
          if (0 === _l._f.length) {
            ...
            if (0 < _l._f.length) {
              do {
                let tmp10 = copyConfig;
                let obj = {};
                let tmp11 = copyConfig(obj, _l);
                if (null != _l._useUTC) {
                  obj._useUTC = _l._useUTC;
                }
                obj._f = _l._f[num2];
                let tmp12 = configFromStringAndFormat;
                let tmp13 = configFromStringAndFormat(obj);
                let tmp14 = isValid;
                let tmp15 = tmp20;
                let tmp16 = tmp21;
                if (isValid(obj)) {
                  let tmp17 = getParsingFlags;
                  let sum = getParsingFlags(obj).charsLeftOver + 10 * getParsingFlags(obj).unusedTokens.length;
          ...
          (function configFromInput(_i) {
            ...
            if (outer1_58(_i)) {
              const _Date4 = Date;
              const date = new Date(outer1_55.now());
              _i._d = date;
            } else if (outer1_60(_i)) {
              const _Date3 = Date;
              const date1 = new Date(_i.valueOf());
              _i._d = date1;
            } else if ("string" === typeof _i) {
              const match = outer1_44.exec(_i._i);
              if (null === match) {
                outer1_114(_i);
                if (false === _i._isValid) {
                  ...
                  if (false === _i._isValid) {
                    delete tmp._isValid;
                    const fromInputFallback = outer1_55.createFromInputFallback(_i);
                  }
                }
              } else {
                const _Date2 = Date;
            ...
            } else if (outer1_56(_i)) {
              _i._a = outer1_61(_i.slice(0), (replaced) => parseInt(replaced, 10));
              outer1_113(_i);
            } else if (outer1_57(_i)) {
              (function configFromObject(_d) {
                let day;
                if (!_d._d) {
                  const tmp2 = outer2_80(_d._i);
                  const items = [, , , , , , ];
                  ...
                  _d._a = outer2_61(items, (replaced) => {
                    let parsed = replaced;
                    if (replaced) {
                      const _parseInt = parseInt;
                  ...
                  outer2_113(_d);
                  const tmp3 = outer2_61;
                }
              })(_i);
            } else if (outer1_59(_i)) {
              const _Date = Date;
              const date3 = new Date(_i);
              _i._d = date3;
            } else {
              const fromInputFallback1 = outer1_55.createFromInputFallback(_i);
            }
          })(_l);
        }
        tmp33 = _l;
  ...
  class Duration {
    constructor(arg0) {
      ...
      for (const key10019 in tmp) {
        ...
        tmp21 = f28298;
        flag = false;
        if (-1 === indexOf.call(f28298, key10019)) {
        ...
        while (true) {
          ...
          if (!tmp[f28298[num]]) {
            ...
            if (flag2) {
              ...
              tmp14 = toInt;
              tmp15 = f28298;
              parsed = parseFloat(tmp[f28298[num]]);
              flag3 = flag2;
              if (parsed !== toInt(tmp[f28298[num]])) {
                flag3 = true;
              }
            }
          }
  ...
  function offset(start, arg1, arg2) {
    let closure_0 = arg1;
    addFormatToken(start, 0, 0, function() {
      ...
      const sum = str + outer1_81(~~tmp2 / 60, 2) + closure_0;
      return sum + outer1_81(~~tmp2 % 60, 2);
    });
  }
  function offsetFromString(closure_14, _i) {
    let str = _i;
    if (!_i) {
      str = "";
    }
    const match = str.match(closure_14);
    if (null === match) {
      return null;
    } else {
      const tmp = match[match.length - 1] || [];
      const text = `${tmp}`;
      const tmp4 = `${tmp}`.match(closure_48) || ["-", 0, 0];
  ...
  function createDuration(self, m) {
    if (isDuration(self)) {
      ...
      if (match) {
        ...
        let obj1 = { y: 0, d: toInt(match[c19]) * num10, h: toInt(match[c20]) * num10, m: toInt(match[c21]) * num10, s: toInt(match[c22]) * num10, ms: toInt(absRound(1000 * match[c23])) * num10 };
        obj = obj1;
      } else {
        ...
        if (match1) {
          ...
          if (tmp8) {
            ...
            ({ milliseconds: obj5.ms, months: obj5.M } = { milliseconds: 0, months: 0 });
            obj = {};
  ...
  function positiveMomentsDifference(month, month2) {
    const obj = { milliseconds: 0, months: 0 };
  ...
  function createAdder(arg0, add) {
    ...
    return function(arg0, arg1) {
      ...
      let tmp4 = arg1;
      if (!isNaNResult) {
        outer1_75(closure_1, `moment().${closure_1}(period, number) is deprecated. Please use moment().${closure_1}(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info.`);
        tmp3 = arg1;
        tmp4 = arg0;
      }
      let tmp10 = tmp3;
      ...
      outer1_131(self, outer1_128(tmp10, tmp4), closure_0);
      return self;
    };
  }
  ...
  function listWeekdaysImpl(arg0, arg1, arg2, weekdays) {
    ...
    if (null != tmp3) {
      ...
      do {
        ...
        let tmp7 = weekdays;
        let str4 = "day";
        items[num3] = get$1(str, (num3 + num) % 7, weekdays, "day");
        num3 = num3 + 1;
      } while (num3 < 7);
      return items;
    }
  ...
  let closure_6 = {};
  let closure_7 = {};
  const re8 = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g;
  const re9 = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g;
  let closure_10 = {};
  let closure_11 = {};
  ...
  let tmp11 = /[+-]?\d{1,6}/;
  let tmp12 = /[+-]?\d+/;
  const re13 = /Z|[+-]\d\d:?\d\d/gi;
  let tmp13 = /Z|[+-]\d\d(?::?\d\d)?/gi;
  let closure_14 = tmp13;
  let tmp14 = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i;
  let closure_15 = {};
  let closure_16 = {};
  let c17 = 0;
  let c18 = 1;
  ...
  addParseToken("YYYY", (arg0, arg1) => {
    ...
    arg1[c17] = parseTwoDigitYearResult;
  });
  addParseToken("YY", (arg0, arg1) => {
    arg1[c17] = hooks.parseTwoDigitYear(arg0);
  });
  addParseToken("Y", (replaced) => {
    arg1[c17] = parseInt(replaced, 10);
  });
  ...
  addParseToken(["M", "MM"], (arg0, arg1) => {
    arg1[c18] = toInt(arg0) - 1;
  });
  ...
  addRegexToken("W", tmp6);
  addRegexToken("WW", tmp6, tmp2);
  addWeekParseToken(["w", "ww", "W", "WW"], (arg0, arg1, arg2, str) => {
  ...
  addWeekParseToken(["d", "e", "E"], (arg0, arg1, arg2, arg3) => {
  ...
  let closure_32 = tmp14;
  let closure_33 = tmp14;
  ...
  addRegexTokenResult29 = addParseToken(["H", "HH"], 3);
  addRegexTokenResult29 = addParseToken(["k", "kk"], (arg0, arg1, arg2) => {
  ...
  addRegexTokenResult29 = addParseToken(["a", "A"], (_meridiem, arg1, _locale) => {
    _locale = _locale._locale;
    _locale._isPm = _locale.isPM(_meridiem);
    _locale._meridiem = _meridiem;
  });
  addRegexTokenResult29 = addParseToken(["h", "hh"], (arg0, arg1, _pf) => {
    arg1[c20] = toInt(arg0);
    getParsingFlags(_pf).bigHour = true;
  });
  addRegexTokenResult29 = addParseToken("hmm", (str, arg1, _pf) => {
    const diff = str.length - 2;
    arg1[c20] = toInt(str.substr(0, diff));
    arg1[c21] = toInt(str.substr(diff));
    getParsingFlags(_pf).bigHour = true;
  });
  addRegexTokenResult29 = addParseToken("hmmss", (str, arg1, _pf) => {
    ...
    arg1[c20] = toInt(str.substr(0, diff));
    arg1[c21] = toInt(str.substr(diff, 2));
    arg1[c22] = toInt(str.substr(diff1));
    getParsingFlags(_pf).bigHour = true;
  });
  ...
  let obj = { calendar: { sameDay: "[Today at] LT", nextDay: "[Tomorrow at] LT", nextWeek: "dddd [at] LT", lastDay: "[Yesterday at] LT", lastWeek: "[Last] dddd [at] LT", sameElse: "L" }, longDateFormat: { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, invalidDate: "Invalid date", ordinal: "%d", dayOfMonthOrdinalParse: /\d{1,2}/, relativeTime: { future: "in %s", past: "%s ago", s: "a few seconds", ss: "%d seconds", m: "a minute", mm: "%d minutes", h: "an hour", hh: "%d hours", d: "a day", dd: "%d days", M: "a month", MM: "%d months", y: "a year", yy: "%d years" }, months: parts, monthsShort: parts1, week: { dow: 0, doy: 6 }, weekdays: parts2, weekdaysMin: parts4, weekdaysShort: parts3, meridiemParse: /[ap]\.?m?\.?/i };
  let closure_37 = {};
  let closure_38 = {};
  const re39 = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/;
  const re40 = /^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/;
  const re41 = /Z|[+-]\d\d(?::?\d\d)?/;
  let items2 = ["YYYYYY-MM-DD", /[+-]\d{6}-\d\d-\d\d/];
  let items3 = [items2, , , , , , , , , , ];
  let items4 = ["YYYY-MM-DD", /\d{4}-\d\d-\d\d/];
  items3[1] = items4;
  let items5 = ["GGGG-[W]WW-E", /\d{4}-W\d\d-\d/];
  items3[2] = items5;
  let items6 = ["GGGG-[W]WW", /\d{4}-W\d\d/, false];
  items3[3] = items6;
  const items7 = ["YYYY-DDD", /\d{4}-\d{3}/];
  items3[4] = items7;
  const items8 = ["YYYY-MM", /\d{4}-\d\d/, false];
  items3[5] = items8;
  const items9 = ["YYYYYYMMDD", /[+-]\d{10}/];
  items3[6] = items9;
  const items10 = ["YYYYMMDD", /\d{8}/];
  items3[7] = items10;
  const items11 = ["GGGG[W]WWE", /\d{4}W\d{3}/];
  items3[8] = items11;
  const items12 = ["GGGG[W]WW", /\d{4}W\d{2}/, false];
  items3[9] = items12;
  const items13 = ["YYYYDDD", /\d{7}/];
  items3[10] = items13;
  const items14 = ["HH:mm:ss.SSSS", /\d\d:\d\d:\d\d\.\d+/];
  const items15 = [items14, , , , , , , , ];
  const items16 = ["HH:mm:ss,SSSS", /\d\d:\d\d:\d\d,\d+/];
  items15[1] = items16;
  const items17 = ["HH:mm:ss", /\d\d:\d\d:\d\d/];
  items15[2] = items17;
  const items18 = ["HH:mm", /\d\d:\d\d/];
  items15[3] = items18;
  const items19 = ["HHmmss.SSSS", /\d\d\d\d\d\d\.\d+/];
  items15[4] = items19;
  const items20 = ["HHmmss,SSSS", /\d\d\d\d\d\d,\d+/];
  items15[5] = items20;
  const items21 = ["HHmmss", /\d\d\d\d\d\d/];
  items15[6] = items21;
  const items22 = ["HHmm", /\d\d\d\d/];
  items15[7] = items22;
  const items23 = ["HH", /\d\d/];
  items15[8] = items23;
  const re44 = /^\/?Date\((\-?\d+)/i;
  const re45 = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;
  let closure_46 = { UT: 0, GMT: 0, EDT: -240, EST: -300, CDT: -300, CST: -360, MDT: -360, MST: -420, PDT: -420, PST: -480 };
  ...
  let closure_47 = ["year", "quarter", "month", "week", "day", "hour", "minute", "second", "millisecond"];
  ...
  addRegexTokenResult29 = addParseToken(["Z", "ZZ"], (_i) => {
    arg2._useUTC = true;
    arg2._tzm = offsetFromString(closure_14, _i);
  });
  const re48 = /([\+\-]|\d\d)/gi;
  const re49 = /^(\-|\+)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/;
  const re50 = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;
  ...
  addRegexTokenResult29 = addFormatToken(0, ["gg", 2], 0, function() {
  ...
  addRegexTokenResult29 = addRegexToken("ggggg", tmp11, tmp5);
  addRegexTokenResult29 = addWeekParseToken(["gggg", "ggggg", "GGGG", "GGGGG"], (arg0, arg1, arg2, str) => {
    const substr = str.substr(0, 2);
    arg1[substr] = toInt(arg0);
  });
  addRegexTokenResult29 = addWeekParseToken(["gg", "GG"], (arg0, arg1, arg2, arg3) => {
  ...
  addRegexTokenResult29 = addParseToken("Q", (arg0, arg1) => {
    arg1[c18] = 3 * (toInt(arg0) - 1);
  });
  addRegexTokenResult29 = addFormatToken("D", ["DD", 2], "Do", "date");
  ...
  addRegexTokenResult29 = addParseToken(["D", "DD"], 2);
  addRegexTokenResult29 = addParseToken("Do", (arg0, arg1) => {
    arg1[c19] = toInt(arg0.match(closure_12)[0]);
  });
  addRegexTokenResult29 = makeGetSet("Date", true);
  addRegexTokenResult29 = addFormatToken("DDD", ["DDDD", 3], "DDDo", "dayOfYear");
  ...
  addRegexTokenResult29 = addParseToken(["DDD", "DDDD"], (arg0, arg1, arg2) => {
    arg2._dayOfYear = toInt(arg0);
  });
  addRegexTokenResult29 = addFormatToken("m", ["mm", 2], 0, "minute");
  ...
  addRegexTokenResult29 = addParseToken(["m", "mm"], 4);
  addRegexTokenResult29 = makeGetSet("Minutes", false);
  addRegexTokenResult29 = addFormatToken("s", ["ss", 2], 0, "second");
  ...
  addRegexTokenResult29 = addParseToken(["s", "ss"], 5);
  addRegexTokenResult29 = makeGetSet("Seconds", false);
  addRegexTokenResult29 = addFormatToken("S", 0, 0, function() {
    return ~~this.millisecond() / 100;
  });
  addRegexTokenResult29 = addFormatToken(0, ["SS", 2], 0, function() {
    return ~~this.millisecond() / 10;
  });
  addRegexTokenResult29 = addFormatToken(0, ["SSS", 3], 0, "millisecond");
  addRegexTokenResult29 = addFormatToken(0, ["SSSS", 4], 0, function() {
    return 10 * this.millisecond();
  });
  addRegexTokenResult29 = addFormatToken(0, ["SSSSS", 5], 0, function() {
    return 100 * this.millisecond();
  });
  addRegexTokenResult29 = addFormatToken(0, ["SSSSSS", 6], 0, function() {
    return 1000 * this.millisecond();
  });
  addRegexTokenResult29 = addFormatToken(0, ["SSSSSSS", 7], 0, function() {
    return 10000 * this.millisecond();
  });
  addRegexTokenResult29 = addFormatToken(0, ["SSSSSSSS", 8], 0, function() {
    return 100000 * this.millisecond();
  });
  addRegexTokenResult29 = addFormatToken(0, ["SSSSSSSSS", 9], 0, function() {
  ...
  prototype.diff = function diff(_d, key10006) {
    const self = this;
    if (this.isValid()) {
  ...
  prototype.from = function from(isValid) {
    ...
    if (this.isValid()) {
      ...
      humanizeResult = createDuration(obj).locale(self.locale()).humanize(!arg1);
  ...
  prototype.set = function stringSet(key10006) {
    let length;
    const self = this;
    if ("object" === typeof key10006) {
      const tmp6 = normalizeObjectUnits(key10006);
      let arr = (function getPrioritizedUnits(obj) {
        const items = [];
        for (const key10003 in arg0) {
          let tmp2 = key10003;
          obj = { unit: key10003 };
          let tmp3 = outer1_7;
          obj.priority = outer1_7[key10003];
      ...
      let tmp3 = normalizeUnits(key10006);
  ...
  prototype.utcOffset = function getSetOffset(_i) {
    ...
    if (self.isValid()) {
      if (null != _i) {
        if ("string" === typeof _i) {
          let result = offsetFromString(closure_14, _i);
          if (null === result) {
            return self;
          }
        } else {
  ...
  prototype2.months = function localeMonths(arg0, arg1) {
    ...
    if (arg0) {
      if (tmp) {
        ...
        obj = this._months.isFormat || closure_27;
      }
    } else {
  ...
  prototype2.monthsShortRegex = function monthsShortRegex(arg0) {
    ...
    if (this._monthsParseExact) {
      ...
      if (!tmp(self, "_monthsShortRegex")) {
        self._monthsShortRegex = closure_29;
      }
  ...
  prototype2.weekdaysRegex = function weekdaysRegex(arg0) {
    ...
    if (this._weekdaysParseExact) {
      ...
      if (!tmp) {
        self._weekdaysRegex = closure_32;
      }
  ...
  prototype2.weekdaysShortRegex = function weekdaysShortRegex(arg0) {
    ...
    if (this._weekdaysParseExact) {
      ...
      if (!tmp(self, "_weekdaysShortRegex")) {
        self._weekdaysShortRegex = closure_33;
      }
  ...
  prototype2.weekdaysMinRegex = function weekdaysMinRegex(arg0) {
    ...
    if (this._weekdaysParseExact) {
      ...
      if (!tmp(self, "_weekdaysMinRegex")) {
        self._weekdaysMinRegex = closure_34;
      }
  ...
  let closure_53 = { ss: 44, s: 45, m: 45, h: 22, d: 26, M: 11 };
  abs = Math.abs;
  ...
  prototype3.humanize = function humanize(arg0) {
    ...
    if (isValidResult) {
      ...
      if (!tmp17) {
        tmp17 = tmp7 <= 1 && ["m"];
        const tmp20 = tmp7 <= 1 && ["m"];
      }
      if (!tmp17) {
        let tmp22 = tmp7 < closure_53.m;
        if (tmp22) {
          const items2 = ["mm", tmp7];
          tmp22 = items2;
        }
        tmp17 = tmp22;
      }
      if (!tmp17) {
        tmp17 = tmp9 <= 1 && ["h"];
        const tmp23 = tmp9 <= 1 && ["h"];
      }
      if (!tmp17) {
        let tmp25 = tmp9 < closure_53.h;
        if (tmp25) {
          const items3 = ["hh", tmp9];
          tmp25 = items3;
        }
        tmp17 = tmp25;
      }
      if (!tmp17) {
        tmp17 = tmp11 <= 1 && ["d"];
        const tmp26 = tmp11 <= 1 && ["d"];
      }
      if (!tmp17) {
        let tmp28 = tmp11 < closure_53.d;
        if (tmp28) {
          const items4 = ["dd", tmp11];
          tmp28 = items4;
        }
        tmp17 = tmp28;
      }
      if (!tmp17) {
        tmp17 = tmp13 <= 1 && ["M"];
        const tmp29 = tmp13 <= 1 && ["M"];
      }
      if (!tmp17) {
        let tmp31 = tmp13 < closure_53.M;
        if (tmp31) {
          const items5 = ["MM", tmp13];
          tmp31 = items5;
        }
        tmp17 = tmp31;
      }
      if (!tmp17) {
        tmp17 = tmp15 <= 1 && ["y"];
        const tmp32 = tmp15 <= 1 && ["y"];
      }
      if (!tmp17) {
        const items6 = ["yy", tmp15];
        tmp17 = items6;
      }
      tmp17[2] = !arg0;
      tmp17[3] = +self > 0;
  ...
  hooks.HTML5_FMT = { DATETIME_LOCAL: "YYYY-MM-DDTHH:mm", DATETIME_LOCAL_SECONDS: "YYYY-MM-DDTHH:mm:ss", DATETIME_LOCAL_MS: "YYYY-MM-DDTHH:mm:ss.SSS", DATE: "YYYY-MM-DD", TIME: "HH:mm", TIME_SECONDS: "HH:mm:ss", TIME_MS: "HH:mm:ss.SSS", WEEK: "YYYY-[W]WW", MONTH: "YYYY-MM" };
  return hooks;
};
