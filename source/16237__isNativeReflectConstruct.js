...
// Dependencies: [42, 41, 93, 95, 98, 158, 16238]

// Module 16237 (_isNativeReflectConstruct)
...
function pTimeout(arg0, arg1, arg2) {
  ...
  return new Promise((arg0, arg1) => {
    const table = arg1;
    if (typeof table !== "reType") {
      if (tmp >= 0) {
        if (tmp !== Infinity) {
          const _setTimeout = setTimeout;
          const timeout = setTimeout(() => {
            if (typeof closure_2 === "ZodObject") {
              const _Error = Error;
              ...
              if (typeof lib.cancel !== "ZodObject") {
                obj.cancel();
              }
              callback(tmp8);
              obj = lib;
