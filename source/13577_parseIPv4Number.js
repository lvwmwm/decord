...
// Dependencies: [13578, 13579, 511, 13580]

// Module 13577 (parseIPv4Number)
const require = arg1;
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    if ("]" !== buffer[buffer.length - 1]) {
      ...
      const ucs22 = require(13578) /* error */.ucs2;
    ...
    if (-1 !== buffer.search(/\u0000|\u0009|\u000A|\u000D|\u0020|#|\/|:|\?|@|\[|\\|\]/)) {
      ...
      const ucs2 = require(13578) /* error */.ucs2;
          ...
          if (tmp8) {
            ...
            if (0 < fromResult.length) {
              do {
                ...
                let obj3 = require(13580) /* replaceByteInByteSequence */;
    ...
    let str = require(13580) /* replaceByteInByteSequence */.percentDecode(_Buffer.from(buffer));
    str = str.toString();
    if (null === str) {
      str = closure_4;
    }
    ...
    const obj = require(13580) /* replaceByteInByteSequence */;
  }
}
    ...
    if (hasItem) {
      ...
      if (0 < fromResult.length) {
        do {
          ...
          let obj = require(13580) /* replaceByteInByteSequence */;
