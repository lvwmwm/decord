...
arg5.useGestureHandler = function useGestureHandler(CONTENT, animatedContentGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize) {
  animatedContentGestureState = CONTENT;
  handleOnFinalize = animatedContentGestureState;
  let closure_2 = sharedValue;
  let closure_3 = handleOnStart;
  let closure_4 = handleOnChange;
  let closure_5 = handleOnEnd;
  let obj = {};
  let obj1 = animatedContentGestureState(handleOnFinalize[0]);
  ...
  obj = { state: animatedContentGestureState, State: animatedContentGestureState(handleOnFinalize[1]).State, gestureSource: sharedValue, source: CONTENT, onStart: handleOnStart };
  ...
  obj.handleOnChange = animatedContentGestureState(handleOnFinalize[0]).useWorkletCallback(pnpm_useGestureHandlerTs2, items1);
  const obj4 = animatedContentGestureState(handleOnFinalize[0]);
  ...
  obj = { gestureSource: sharedValue, source: CONTENT, state: animatedContentGestureState, GESTURE_SOURCE: animatedContentGestureState(handleOnFinalize[2]).GESTURE_SOURCE, onEnd: handleOnEnd };
  ...
  obj.handleOnEnd = animatedContentGestureState(handleOnFinalize[0]).useWorkletCallback(pnpm_useGestureHandlerTs3, items2);
  const obj5 = animatedContentGestureState(handleOnFinalize[0]);
  ...
  obj1 = { gestureSource: sharedValue, source: CONTENT, state: animatedContentGestureState, GESTURE_SOURCE: animatedContentGestureState(handleOnFinalize[2]).GESTURE_SOURCE, onFinalize: handleOnFinalize };
  ...
  obj.handleOnFinalize = animatedContentGestureState(handleOnFinalize[0]).useWorkletCallback(pnpm_useGestureHandlerTs4, items3);
  return obj;
};
