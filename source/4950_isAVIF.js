...
arg5.isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4944) /* getFileChunk */.isAvifStringIncluded(fileChunk);
};
...
arg5.isHEIC = function isHEIC(fileChunk) {
  fileChunk = require(4944) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4945).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4944) /* getFileChunk */.isHeicSignatureIncluded(fileChunk);
};
