...
// Dependencies: [32, 7547, 7553, 7542, 7555, 7525, 7537, 7538, 7539, 7532, 7530, 7548, 7520, 7552, 7556, 7558, 7549, 7559, 7561, 7535]
// Exports: continueTrace, startInactiveSpan, startNewTrace, startSpan, startSpanManual, suppressTracing, withActiveSpan

// Module 7554 (createChildOrRootSpan)
...
function _startRootSpan(name) {
  ...
  obj1.attributes = { [require(7535).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE]: "custom" };
  obj1.sampled = tmp6;
...
export const continueTrace = (arg0, arg1) => {
  ...
  let dependencyMap;
  const _require = arg1;
  const mainCarrier = _require(7538).getMainCarrier();
  const obj = _require(7538);
  const tmp = _require;
  const asyncContextStrategy = _require(7539).getAsyncContextStrategy(mainCarrier);
...
export const startNewTrace = function startNewTrace(arg0) {
  const _require = arg0;
  return _require(7547).withScope((setPropagationContext) => {
