// Module ID: 13065
// Function ID: 13066
// Dependencies: [13059, 13030, 13050]

// Module 13065

export default (arg0, arg1) => {
  let require;
  let obj = new require(13059) /* Range */(arg0, arg1);
  const tmp3 = new require(13030) /* SemVer */("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(13030)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
        ...
        do {
          ...
          if (require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = require;
              tmp16 = !require(13050) /* SemVer */(tmp14, require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
