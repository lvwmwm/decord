...
// Function ID: 12948
// Name: items
// Dependencies: [12934, 12933, 12919, 12936]
...
function simpleSubset(arg0, item10015, includePrerelease) {
  ...
  if (arg0 === item10015) {
    ...
    if (1 === arg0.length) {
      tmp9 = arg0;
      if (arg0[0].semver === require(12933) /* Comparator */.ANY) {
        if (1 === item10015.length) {
          if (item10015[0].semver === tmp6(12933).ANY) {
            return true;
          }
        }
      }
    ...
    if (1 === item10015.length) {
      tmp13 = item10015;
      if (item10015[0].semver === require(12933) /* Comparator */.ANY) {
    ...
    if (set.size > 1) {
      ...
      if (tmp) {
        if (tmp2) {
          const tmp46 = require(12919) /* SemVer */(tmp.semver, tmp2.semver, includePrerelease);
          if (tmp46 > 0) {
            tmp = null;
            return null;
          } else {
...
function higherGT(semver, semver2, includePrerelease) {
  if (semver) {
    const tmp4 = require(12919) /* SemVer */(semver.semver, semver2.semver, includePrerelease);
    let tmp5 = semver;
    if (tmp4 <= 0) {
      if (tmp4 < 0) {
        let tmp6 = semver2;
...
export default (arg0, arg1, includePrerelease) => {
  ...
  if (arg0 === arg1) {
    ...
    const tmp22 = new require(12934) /* Range */(arg0, obj);
    const tmp27 = new require(12934) /* Range */(arg1, obj);
    let flag = false;
