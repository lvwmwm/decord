...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8249, 8234, 8235]
...
let obj = {
  ...
  value: function render() {
    ...
    const tmp = importDefault(8249);
    const merged1 = Object.assign(self(8234).extractFilter(this.props));
    const obj2 = self(8234);
    const merged2 = Object.assign(self(8234).extractIn(this.props));
