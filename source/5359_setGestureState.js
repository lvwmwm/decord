...
// Dependencies: [5357, 5360, 5358]

// Module 5359 (setGestureState)
...
function create(handlerTag) {
  ...
  obj = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5358).State, warningMessage: closure_2 };
  T.__closure = obj;
  ...
  fn.__closure = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5358).State, warningMessage: closure_2 };
  ...
  const obj1 = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5358).State, warningMessage: closure_2 };
  fn2.__closure = { REANIMATED_AVAILABLE: closure_3, setGestureState, handlerTag, State: _require(5358).State, warningMessage: closure_2 };
