...
// Dependencies: [4656, 4589, 541, 4636, 4640, 4653, 4643, 4644, 4645, 4646, 4657, 4658]

// Module 4655 (ValidateAndApplyPropertyDescriptor)

export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, flag, __Configurable__) {
  const tmp3 = require(4656) /* Type */(arg0);
  if (undefined !== arg0) {
    if (!tmp(4589)(arg0)) {
      ...
      if (undefined === __Set__) {
        ...
        if (tmp64) {
          if ("Undefined" === tmp3) {
            ...
            tmp66 = tmp(4653)(__Configurable__);
          }
        }
        return tmp64;
      } else {
        ...
        if (tmpResult3(obj, __Set__)) {
          if (!__Set__["[[Configurable]]"]) {
            ...
            if ("[[Enumerable]]" in __Configurable__) {
              if (!tmp(4645)(__Configurable__["[[Enumerable]]"], __Set__["[[Enumerable]]"])) {
                return false;
              }
            }
            if (!tmp(4658)(__Configurable__)) {
              const tmpResult4 = tmp(4645);
              if (!tmpResult4(tmp26, tmp(4653)(__Set__))) {
                return false;
              }
              tmp26 = tmp(4653)(__Configurable__);
            }
            if (tmp(4653)(__Set__)) {
              if ("[[Get]]" in __Configurable__) {
                if (!tmp(4645)(__Configurable__["[[Get]]"], __Set__["[[Get]]"])) {
                  return false;
                }
              }
              if ("[[Set]]" in __Configurable__) {
                if (!tmp(4645)(__Configurable__["[[Set]]"], __Set__["[[Set]]"])) {
                  return false;
                }
              }
              ...
              if ("[[Value]]" in __Configurable__) {
                if (!tmp(4645)(__Configurable__["[[Value]]"], __Set__["[[Value]]"])) {
                  return false;
                }
              }
            }
          ...
          if ("Undefined" === tmp3) {
            ...
            if (!tmp(4644)(__Set__)) {
              if (tmp(4653)(__Set__)) {
                if (tmp(4644)(__Configurable__)) {
                  ...
                  const tmpResult6 = tmp(4644);
                  const tmpResult7 = tmp(4645);
                  const tmpResult8 = tmp(4646);
                  ...
                  let tmpResult6Result = tmp(4643)(tmpResult6, tmpResult7, tmpResult8, arg0, arg1, obj);
                  const tmpResult5 = tmp(4643);
                }
              }
              const tmpResult10 = tmp(4644);
              const tmpResult9 = tmp(4643);
              tmpResult6Result = tmpResult9(tmpResult10, tmp(4645), tmp(4646), arg0, arg1, __Configurable__);
              const tmpResult11 = tmp(4645);
            }
            let tmp50 = __Set__;
            if ("[[Configurable]]" in __Configurable__) {
            ...
            const tmpResult13 = tmp(4644);
            const tmpResult14 = tmp(4645);
            const tmpResult15 = tmp(4646);
            ...
            __Set__ = __Set__["[[Set]]"];
            obj1[3] = __Set__;
            tmpResult6Result = tmp(4643)(tmpResult13, tmpResult14, tmpResult15, arg0, arg1, obj1);
            const tmpResult12 = tmp(4643);
          }
        } else {
