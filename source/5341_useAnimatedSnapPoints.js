...
// Dependencies: [1582, 5227, 5240]

// Module 5341 (useAnimatedSnapPoints)
const require = arg1;
...
arg5.useAnimatedSnapPoints = function useAnimatedSnapPoints(snapPoints, derivedValue, sharedValue1, reactiveSharedValue2, sharedValue, DEFAULT_DYNAMIC_SIZING, maxDynamicContentSize) {
  ...
  obj = { containerHeight: derivedValue, INITIAL_CONTAINER_HEIGHT: _require(5227).INITIAL_CONTAINER_HEIGHT, INITIAL_SNAP_POINT: _require(5227).INITIAL_SNAP_POINT, snapPoints, normalizeSnapPoint: _require(5240).normalizeSnapPoint, enableDynamicSizing: DEFAULT_DYNAMIC_SIZING, handleHeight: reactiveSharedValue2, INITIAL_HANDLE_HEIGHT: _require(5227).INITIAL_HANDLE_HEIGHT, contentHeight: sharedValue1, maxDynamicContentSize, dynamicSnapPointIndex: sharedValue };
