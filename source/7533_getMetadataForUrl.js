...
// Module 7533 (getMetadataForUrl)
const require = arg1;
const dependencyMap = arg6;
function getMetadataForUrl(arg0, arg1) {
  (function ensureMetadataStacksAreParsed(arg0) {
    if (callback(7455).GLOBAL_OBJ._sentryModuleMetadata) {
      const _Object = Object;
      const keys = Object.keys(callback(7455).GLOBAL_OBJ._sentryModuleMetadata);
      for (const item10026 of keys) {
        ...
        let tmp16 = callback(7455).GLOBAL_OBJ._sentryModuleMetadata[item10026];
        let obj = set;
