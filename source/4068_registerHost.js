...
// Function ID: 4069
// Name: registerHost
// Dependencies: [4069, 4064]

// Module 4068 (registerHost)
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (portalName(4064).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4064).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4064).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4064).ACTIONS.REMOVE_PORTAL === type) {
