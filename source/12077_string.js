...
// Function ID: 94211
// Name: string
// Dependencies: [5, 65, 12011, 12074, 12078, 12079, 12080, 12073]

// Module 12077 (string)
import asyncGeneratorStep from "module_12079";
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class) {
      ...
      if (arguments.length > 1) {
        ...
        const util = _require(12011).util;
    ...
    let closure_9 = fn(require("module_12078"));
    let closure_10 = fn(require("module_12079"));
    let closure_11 = fn(require("module_12080"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      let obj = {};
      obj = { input: _require(12073).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12073).createStandardJSONSchemaMethod(_standard, "output") };
      obj.jsonSchema = obj;
      const merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12073).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
