...
arg5.detectFile = function detectFile(uint8Array, chunkSize) {
  ...
  const fileChunk = require(4752) /* getFileChunk */.getFileChunk(uint8Array, num3);
  if (0 !== fileChunk.length) {
    const items = [];
    const items1 = [];
    for (const key10027 in require(4753).FileTypes) {
      let tmp27 = key10027;
      let _Object4 = Object;
      let tmp28 = require;
      let tmp29 = dependencyMap;
      if (!hasOwnProperty2.call(require(4753).FileTypes, key10027)) {
        continue;
      } else {
        let tmp4 = require;
        let tmp5 = dependencyMap;
        let FileTypes = require(4753).FileTypes;
        let signaturesByName = FileTypes.getSignaturesByName(key10027);
        let FileTypes2 = require(4753).FileTypes;
        ...
        if (!detectbBySignaturesResult) {
          ...
          let FileTypes3 = require(4753).FileTypes;
          let infoByName = FileTypes3.getInfoByName(key10027);
          let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = require(4753).FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
    ...
    if (0 !== items.length) {
      ...
      const FileTypes4 = require(4753).FileTypes;
