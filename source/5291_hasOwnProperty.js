...
// Function ID: 5292
// Name: hasOwnProperty
// Dependencies: [5289, 5292]

// Module 5291 (hasOwnProperty)
...
obj.to.hex = () => {
  const tmp = require(5292) /* swizzle */(arguments);
...
obj.to.rgb = () => {
  const arr = require(5292) /* swizzle */(arguments);
  if (arr.length >= 4) {
    if (1 !== arr[3]) {
      const _Math = Math;
      const _Math2 = Math;
