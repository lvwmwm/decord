...
// Function ID: 8453
// Name: extractProps
// Dependencies: [8453, 8444, 8454, 8457, 8445, 8443]

// Module 8452 (extractProps)
const require = arg1;
const module = arg2;
...
function extractProps(markerMid) {
  ...
  const obj = {};
  const items = [];
  module(8444)(obj, markerMid, arg1);
  module(8454)(obj, markerMid, items);
  module(8457)(obj, markerMid, items);
  if (markerMid.color) {
  ...
  const tmp6 = module(8445)(markerMid);
  if (null !== tmp6) {
    obj.matrix = tmp6;
  }
  if (null != opacity) {
    obj.opacity = tmp(8443)(opacity);
  }
  if (null != display) {
    let str4;
    if ("none" === display) {
