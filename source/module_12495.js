// Module ID: 12495
// Function ID: 12496
// Dependencies: [5, 12429, 12492, 12496, 12497, 12498, 12491]

// Module 12495
import asyncGeneratorStep from "module_12498";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = _require(12429).util;
    ...
    let closure_8 = fn(require("module_12496"));
    let closure_9 = fn(require("module_12497"));
    let closure_10 = fn(require("module_12498"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12491).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12491).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12491).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
