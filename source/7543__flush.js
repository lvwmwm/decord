...
// Function ID: 7544
// Name: _flush
// Dependencies: [5, 7522, 7544, 7523, 7495, 7506, 7509, 7502, 7532, 7496, 7518]
...
function endSession() {
  const isolationScope = require(7522) /* getClient */.getIsolationScope();
  const obj = require(7522) /* getClient */;
  ...
  const tmpResult1 = require(7522) /* getClient */;
...
export const captureException = function captureException(arg0, arg1) {
  const currentScope = require(7522) /* getClient */.getCurrentScope();
  const obj = require(7522) /* getClient */;
  return currentScope.captureException(arg0, require(7544) /* applyClientOptions */.parseEventHintOrCaptureContext(arg1));
};
...
export const captureSession = function captureSession() {
  ...
  if (flag) {
    ...
    const obj5 = require(7522) /* getClient */;
  }
};
...
export const isInitialized = function isInitialized() {
  return require(7522) /* getClient */.getClient();
};
...
export const startSession = function startSession(arg0) {
  ...
  const obj5 = require(7522) /* getClient */;
  const userAgent = require(7496) /* getGlobalSingleton */.GLOBAL_OBJ.navigator || {}.userAgent;
  let tmpResult = tmp(7518);
  obj = { release, environment, user: null };
  const tmp3 = require(7496) /* getGlobalSingleton */.GLOBAL_OBJ.navigator || {};
...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  let currentScope = _require(7522).getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = _require(7522);
  let client = _require(7522).getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = _require(7522);
  captureCheckInResult = _require(7506).uuid4();
};
