  ...
  const tmp6 = (() => {
        ...
        if (arguments.length > 0) {
          ...
          if (arguments.length > 1) {
            ...
            if (self instanceof PluralRules) {
              ...
              obj.writable = true;
              obj.value = undefined;
              tmp10 = WeakMap(self, outer1_5, obj);
              obj1 = {};
              obj1.writable = true;
              obj1.value = undefined;
              tmp11 = outer1_6;
              tmp12 = WeakMap(self, outer1_6, obj1);
              obj2 = {};
              obj2.writable = true;
              obj2.value = undefined;
              tmp13 = outer1_7;
              tmp14 = WeakMap(self, outer1_7, obj2);
              obj3 = {};
              obj3.writable = true;
              obj3.value = undefined;
              tmp15 = outer1_8;
              tmp16 = WeakMap(self, outer1_8, obj3);
              obj4 = {};
              obj4.writable = true;
              obj4.value = undefined;
              tmp17 = outer1_9;
              tmp18 = WeakMap(self, outer1_9, obj4);
              tmp19 = findLocale;
              tmp20 = closure_0;
              arr = closure_0([]);
              num2 = 0;
              if (0 >= arr.length) {
                ...
                tmp26 = obj7;
                tmp27 = outer1_4;
                tmp22 = outer1_4(obj7.resolvedOptions().locale);
              } else {
                tmp21 = outer1_4;
                tmp22 = outer1_4(arr[num2]);
                while (!tmp22) {
                  num2 = num2 + 1;
                  break;
                }
              ...
              tmp29 = outer1_1;
              tmp30 = closure_3;
              tmp19Result1 = tmp19(self, tmp13, outer1_1(closure_3(self, tmp9)));
              tmp32 = outer1_3;
              tmp19Result2 = tmp19(self, tmp11, outer1_3(closure_3(self, tmp9)));
              tmp34 = globalThis;
              _Object = Object;
    ...
    let obj = {
      ...
      value: function resolvedOptions() {
        ...
        const self = this;
        let obj = callback(this, outer1_9);
        const resolvedOptionsResult = obj.resolvedOptions();
        ({ minimumSignificantDigits, roundingPriority } = resolvedOptionsResult);
        obj = { locale: callback(this, outer1_5), type: callback(this, outer1_8), minimumIntegerDigits, minimumFractionDigits, maximumFractionDigits };
        ...
        const tmp2 = callback(self, outer1_5);
        obj.pluralCategories = outer1_2(callback(self, outer1_5), "ordinal" === callback(self, outer1_8)).slice(0);
        if (!roundingPriority) {
      ...
      value: function select(arg0) {
        ...
        if (this instanceof PluralRules) {
          ...
          if (isFinite(NumberResult)) {
            const _Math = Math;
            const obj = callback(self, outer1_9);
            const formatResult = callback(self, outer1_9).format(Math.abs(NumberResult));
            return callback(self, outer1_7).call(self, formatResult, "ordinal" === callback(self, outer1_8));
          } else {
            return "other";
          }
        } else {
      ...
      value: function selectRange(arg0, arg1) {
        ...
        if (this instanceof PluralRules) {
          if (undefined === arg0) {
            ...
            const tmp28 = weakMap2(arg0);
            const tmp29 = weakMap2(arg1);
            const _isFinite2 = isFinite;
            if (isFinite(tmp28)) {
              const _isFinite = isFinite;
              if (isFinite(tmp29)) {
                const obj = callback(self, outer1_6);
    ...
    const items1 = [
      {
        ...
        value: function supportedLocalesOf(arg0) {
          return PluralRules(arg0).filter(outer1_4);
        }
      }
    ];
    callback2(PluralRules.prototype, items);
    callback2(PluralRules, items1);
