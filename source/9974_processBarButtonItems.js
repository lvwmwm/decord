...
// Dependencies: [32, 109, 17, 21, 6359, 1501, 9975, 6350, 4676]
// Exports: useHeaderConfigProps

// Module 9974 (processBarButtonItems)
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  if (headerLeft != null) {
    obj = { tintColor: null, canGoBack: null, label: null, href: "ct" };
    obj[0] = text;
    obj[1] = tmp18;
  ...
  const isSearchBarAvailableForCurrentPlatform = tmp(4676).isSearchBarAvailableForCurrentPlatform;
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = tmp(4676).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      items5[1] = null;
      obj6[1] = items5;
      let tmp33Result = tmp33(tmp(4676).ScreenStackHeaderLeftView, obj6);
    } else {
      if (typeof headerTitle === "function") {
        ...
        obj9[1] = obj;
        obj9[2] = headerTitle;
        obj8[1] = tmp63(tmp(6350).HeaderTitle, obj9);
      }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      obj10[1] = obj;
      obj10[2] = headerTitle;
      headerTitleResult = tmp39(tmp(6350).HeaderTitle, obj10);
    }
    const obj11 = { children: null };
    obj11[0] = headerTitleResult;
    tmp39Result = tmp39(tmp(4676).ScreenStackHeaderCenterView, obj11);
  }
  ...
  if (undefined !== headerBackIcon) {
    ...
    obj12[0] = source;
    let tmp41Result = callback3(tmp(4676).ScreenStackHeaderBackButtonImage, obj12);
  ...
  if (null != headerRightResult) {
    ...
    tmp43 = callback3(tmp(4676).ScreenStackHeaderRightView, obj13);
  }
  items7[2] = tmp43;
  let tmp45 = null;
  if (isSearchBarAvailableForCurrentPlatform2) {
