...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7884, 7954, 7963, 7889, 7900]

// Module 7962 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      const tmp3Result = self(7884)(patternTransform);
      ...
      if (patternContentUnits) {
        num2 = tmp(7954)[patternContentUnits];
      }
      obj[8] = num2;
      obj = {
        ref(arg0) {
      ...
      const tmp3 = self(7884);
      const merged = Object.assign(obj);
      const merged1 = Object.assign(tmp(7889)({ viewBox, preserveAspectRatio }));
      obj.children = children;
      return jsx(self(7963), {
        ref(arg0) {
          return self.refMethod(arg0);
        }
      });
