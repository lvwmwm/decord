...
// Function ID: 5158
// Name: StyleSheet
// Dependencies: [109, 19, 17, 21, 1584, 5158, 5155, 5160, 5161]
// Exports: default

// Module 5157 (StyleSheet)
...
export default function Header(children) {
  ...
  const context = React.useContext(importDefault(5158));
  if (undefined === layout) {
  ...
  if (headerBackground) {
    ...
    if (!headerTransparent) {
      ...
      obj4[0] = items;
      headerBackgroundResult = tmp15(importDefault(5161), obj4);
    }
  }
  ...
  tmp8 = importDefault(5155)(layout, undefined !== modal && modal, headerStatusBarHeight);
