...
// Function ID: 4801
// Name: load
// Dependencies: [4801, 4802, 4803, 4804, 4805, 4818, 4820, 4821, 4833, 4837, 4841, 4843, 4845, 4846, 4847, 4848, 4849, 4850, 4851, 4852, 4853, 4854, 4827]
// Exports: load
  ...
  if (typeof response === "y") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(4802).dataUriToBuffer(response));
        const obj5 = response(4802);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
