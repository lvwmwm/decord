...
// Dependencies: [1281, 13402, 13403, 13467, 13474, 13479, 13494, 13495]

// Module 13401 (addLikelySubtags)
import e from "e";
...
function addLikelySubtags(locale) {
  ...
  let script;
  let variants;
  const parseUnicodeLocaleIdResult = require(13467) /* isStructurallyValidLanguageTag */.parseUnicodeLocaleId(locale);
