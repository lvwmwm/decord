...
// Function ID: 100015
// Name: Range
// Dependencies: [65, 6, 7, 12840, 12867, 12841, 12843, 12842, 12839, 12869]

// Module 12868 (Range)
import _toConsumableArray from "_toConsumableArray";
import _classCallCheck from "items";
import _defineProperties from "module_12842";
...
function replaceTilde(str, loose) {
  const _require = str;
  const safeRe = _require(12843).safeRe;
  const t = _require(12843).t;
  if (loose.loose) {
...
function replaceXRanges(str, arg1) {
  const _require = arg1;
  _require(12842)("replaceXRanges", str, arg1);
...
function replaceStars(str, arg1) {
  require(12842)("replaceStars", str, arg1);
  return str.trim().replace(require(12843) /* items */.safeRe[require(undefined, 12843) /* items */.t.STAR], "");
}
function replaceGTE0(str) {
  require(12842)("replaceGTE0", str, arg1);
  const t = require(12843) /* items */.t;
  return str.trim().replace(require(12843) /* items */.safeRe[arg1.includePrerelease ? t.GTE0PRE : t.GTE0], "");
}
    ...
    if (!includePrerelease.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = require(12842)(arg0[num4].semver);
          let tmp6 = tmp2;
          if (arg0[num4].semver !== require(12867) /* Comparator */.ANY) {
            tmp6 = tmp2;
