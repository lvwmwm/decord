...
// Dependencies: [5, 17, 82, 13687, 13689, 13691, 13692, 13695, 13696, 13709, 13711, 13713, 13714, 13715, 13716, 13697]

// Module 13686 (reactNativeCorePlugins)
...
import module_13711 from "module_13711";
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL !== "string") {
        ...
        return require(13716) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
