...
// Function ID: 7437
// Name: setMeasurement
// Dependencies: [7399, 7422, 7394, 7409]

// Module 7436 (setMeasurement)
const require = arg1;
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (activeSpan) {
    rootSpan = require(7399) /* spanTimeInputToSeconds */.getRootSpan(activeSpan);
    const obj3 = require(7399) /* spanTimeInputToSeconds */;
  }
  if (rootSpan) {
    if (require(7422) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      const logger = tmp9(7394).logger;
      const _HermesInternal = HermesInternal;
      logger.log("[Measurement] Setting measurement on root span: " + arg0 + " = " + arg1 + " " + arg2);
    }
    obj = {};
    obj[require(7409).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[require(7409).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
