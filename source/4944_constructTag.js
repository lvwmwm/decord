...
// Function ID: 4945
// Name: constructTag
// Dependencies: [4900, 4916, 4928, 4897, 4904, 4930]

// Module 4944 (constructTag)
const require = arg1;
const module = arg2;
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  if (type !== require(4904).TYPE_TEXT) {
    ...
    if (0 !== items2.length) {
      ...
      combined = "" + stringValueFromArray + " (" + tmp4(4897).getStringValueFromArray(items2) + ")";
      const tmp4Result = tmp4(4897);
    }
  }
