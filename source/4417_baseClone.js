...
// Function ID: 4418
// Name: baseClone
// Dependencies: [606, 599, 4418, 4419, 770, 621, 4420, 4421, 4424, 4428, 4432, 4433, 4434, 775, 4440, 4442, 4444, 792, 4429, 616, 600, 4426]

// Module 4417 (baseClone)
let obj = {};
  ...
  if (!arg2) {
    {
      if (_require(606)(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4418)(arr);
          obj = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4419)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(621)(arr)) {
            return tmp32(4420)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (obj[tmp11]) {
                  tmp14 = tmp32(4434)(arr, tmp11, tmp);
                  obj = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4424);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4428)(obj, arr));
                } else {
                  tmp32Result = tmp32(4432);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4433)(obj, arr));
                }
