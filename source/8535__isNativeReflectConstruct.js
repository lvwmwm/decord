...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8536, 8537, 8538, 8539, 8543, 8544, 8545, 8555]
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(8537)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(8538)(tmp, tmp, this);
      ...
      if (transform) {
        ...
        tmp.transform = self(8539).extractTransformSvgView(tmp);
        const obj3 = self(8539);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(8544)({ viewBox, preserveAspectRatio }));
      obj.children = jsx(importDefault(8545), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(8543), {});
    }
  }
];
