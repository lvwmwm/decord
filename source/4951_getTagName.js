...
// Function ID: 4952
// Name: getTagName
// Dependencies: [32, 4912, 4929, 4952]

// Module 4951 (getTagName)
...
export default {
  read(arg0, arg1) {
    ...
    if (0 < arg0.length) {
      ...
      const stringFromDataView = require(4912) /* getDataView */.getStringFromDataView(dataView, num, closure_7);
      const obj3 = require(4912) /* getDataView */;
      const shortAt = importDefault(4929).getShortAt(dataView, sum);
      const sum1 = sum + c5;
      const tmp15 = getTagName(dataView, sum1);
      let name = tmp15.tagName;
      const sum2 = sum1 + tmp15.tagNameSize;
      const obj4 = importDefault(4929);
      const longAt = importDefault(4929).getLongAt(dataView, sum2);
      const sum3 = sum2 + c6;
