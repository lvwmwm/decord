...
// Dependencies: [1606, 5253, 5266]

// Module 5367 (useAnimatedSnapPoints)
const require = arg1;
...
arg5.useAnimatedSnapPoints = (snapPoints, containerHeight, contentHeight, handleHeight, arg4, enableDynamicSizing, maxDynamicContentSize) => {
  ...
  obj = { containerHeight, INITIAL_CONTAINER_HEIGHT: _require(5253).INITIAL_CONTAINER_HEIGHT, INITIAL_SNAP_POINT: _require(5253).INITIAL_SNAP_POINT, snapPoints, normalizeSnapPoint: _require(5266).normalizeSnapPoint, enableDynamicSizing, handleHeight, INITIAL_HANDLE_HEIGHT: _require(5253).INITIAL_HANDLE_HEIGHT, contentHeight, maxDynamicContentSize, dynamicSnapPointIndex: sharedValue };
  P.__closure = obj;
