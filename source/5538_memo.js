...
// Function ID: 5539
// Name: memo
// Dependencies: [19, 17, 21, 1634, 5391, 5384, 5380, 5407]
...
const memoResult = memo(function BottomSheetRefreshControlComponent(arg0) {
  ...
  let dependencyMap;
  let iter;
  const tmp4 = iter(scrollableGesture(5391).BottomSheetDraggableContext);
  dependencyMap = tmp4;
  let obj = scrollableGesture(5384);
  ...
  obj = { animatedScrollableState: iter, SCROLLABLE_STATE: tmp2(5380).SCROLLABLE_STATE };
  fn.__closure = obj;
  ...
  if (tmp7) {
    ...
    let tmp8Result = tmp8(tmp2(5407).GestureDetector, obj);
  } else {
    const obj2 = {};
