...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7896, 7985, 7895, 7904]

// Module 7984 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      let match = str;
      if (str) {
        match = str.match(self(7896).idPattern);
      }
      let tmp4 = match;
      if (match) {
        tmp4 = match[1];
