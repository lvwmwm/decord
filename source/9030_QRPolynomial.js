...
QRPolynomial.prototype = {
      ...
      do {
        ...
        if (0 < getLength.getLength()) {
          do {
            ...
            let obj = require(9031);
            let obj2 = require(9031);
            let glogResult = obj2.glog(self.get(num));
            let obj3 = require(9031);
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = require(9031);
      const glogResult = require(9031).glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - require(9031).glog(getLength.get(0));
