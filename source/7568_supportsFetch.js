...
// Function ID: 7569
// Name: supportsFetch
// Dependencies: [7457, 7455, 7456]

// Module 7568 (supportsFetch)
const require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in require(7457) /* getGlobalSingleton */.GLOBAL_OBJ) {
    try {
...
arg5.supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    ...
    if (isNativeFunction(require(7457) /* getGlobalSingleton */.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
...
arg5.supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in require(7457) /* getGlobalSingleton */.GLOBAL_OBJ;
};
