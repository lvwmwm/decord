...
// Dependencies: [5535, 5473, 5488, 5475, 5537]

// Module 5553 (handleStateChangeEvent)
const require = arg1;
...
function handleUpdateEvent(lastUpdateEvent, arg1, arg2, lastUpdateEvent2) {
  ...
  const result = require(5535) /* isGestureEnabled */.flattenAndFilterEvent(tmp);
  const obj = require(5535) /* isGestureEnabled */;
  require(5535) /* isGestureEnabled */.runCallback(require(5488) /* _isNativeReflectConstruct */.CALLBACK_TYPE.UPDATE, arg1, result);
  if (lastUpdateEvent2) {
...
function handleTouchEvent(eventType) {
  if (eventType.eventType !== require(5475).TouchEventType.UNDETERMINED) {
    let tmpResult = tmp(5535);
    tmpResult = tmp(5535);
...
function eventHandler(arg0, nativeEvent, arg2, arg3, lastUpdateEvent) {
  const result = require(5535) /* isGestureEnabled */.maybeExtractNativeEvent(nativeEvent);
  const obj = require(5535) /* isGestureEnabled */;
