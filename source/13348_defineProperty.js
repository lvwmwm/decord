...
if (require("getOwnPropertyDescriptor")) {
  ...
  defineProperty2 = function defineProperty(arg0, arg1, value) {
    require(13346) /* all */(arg0);
    const tmp4 = require(13306) /* text */(arg1);
    require(13346) /* all */(value);
    if (!require(13329)) {
      while (true) {
        let tmp10 = value;
        let str = "get";
