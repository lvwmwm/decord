...
// Dependencies: [5, 17, 82, 13464, 13466, 13468, 13469, 13472, 13473, 13486, 13488, 13490, 13491, 13492, 13493, 13474]

// Module 13463 (reactNativeCorePlugins)
...
import module_13472 from "module_13472";
import objectifyError from "objectifyError";
import onSend from "onSend";
import module_13488 from "module_13488";
...
const obj18 = {
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL === "tee") {
        const _Error = Error;
        const error = new Error("Invalid non-string URL");
        throw error;
      } else {
        return require(13493) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
