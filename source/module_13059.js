// Module ID: 13059
// Function ID: 13060
// Dependencies: [13022, 13051, 13042, 13047, 13043, 13046, 13053, 13050]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13022)(arg0, arg3);
  const tmp4 = new _require(13051)(arg1, arg3);
  if (">" === arg2) {
    let dependencyMap = tmp(13042);
    let tmpResult = tmp(13047);
    tmpResult = tmp(13043);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13043);
      tmpResult = tmp(13046);
      tmpResult1 = tmp(13042);
  ...
  if (_require(13053)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
    if (0 < tmp4.set.length) {
      while (true) {
        ...
        let item = arr.forEach((semver) => {
          let tmp = semver;
          if (semver.semver === require(13050) /* Comparator */.ANY) {
            tmp = new require(13050) /* Comparator */(">=0.0.0");
          }
          let tmp6 = _null;
          if (!_null) {
            tmp6 = tmp;
