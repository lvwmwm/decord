...
// Function ID: 13828
// Name: state
// Dependencies: [13791, 13766, 13828, 13782, 13829, 13811, 13789, 13822]
...
import all from "all" /* 13828 */;
import __core_js_shared__2 from "__core-js_shared__" /* 13829 */;
  ...
  if (!__core_js_shared__.state) {
    ...
    let fn = function t(facade) {
      if (call(facade, closure_6)) {
        const typeError = new tmp(13766).TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        tmp(13822)(facade, tmp3, arg1);
        return arg1;
      }
      tmp3 = closure_6;
    };
...
if (!state) {
  ...
  const weakMap = new _mod13766.WeakMap();
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new _mod13766.TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
