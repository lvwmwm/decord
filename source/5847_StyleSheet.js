...
// Function ID: 5848
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 5841, 5842, 1521, 5848, 5827, 5325, 5849, 5850, 5851, 5852]
// Exports: Card

// Module 5847 (StyleSheet)
...
export const Card = function Card(shadowEnabled) {
  ...
  if (typeof backgroundColor === "string") {
    tmp16 = 0 === tmp5(5325)(backgroundColor).alpha();
    const obj12 = tmp5(5325)(backgroundColor);
  }
  ...
  let merged = Object.assign(flag2(5850).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }));
  ...
  const items13 = [tmp27, gesture(flag2(5851).CardContent, { enabled: pageOverflowEnabled, layout, style: contentStyle, children })];
  obj5[3] = items13;
  obj4.children = layout(closing.View, obj5);
  obj3[2] = gesture(flag2(5827).PanGestureHandler, obj4);
  items5[2] = gesture(closing.View, obj3);
  obj[1] = items5;
  return layout(flag2(5849).CardAnimationContext.Provider, obj);
};
