...
// Function ID: 5331
// Name: hasOwnProperty
// Dependencies: [5328, 5331]

// Module 5330 (hasOwnProperty)
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5328)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
              tmp12 = require(5328) /* keys */;
              tmp9 = hasOwnProperty;
            }
          }
        }
...
obj.to.hex = () => {
  const tmp = require(5331) /* swizzle */(arguments);
...
obj.to.rgb = () => {
  const arr = require(5331) /* swizzle */(arguments);
  if (arr.length >= 4) {
    if (1 !== arr[3]) {
      const _Math = Math;
      const _Math2 = Math;
