...
// Function ID: 12388
// Name: QRCodeSvg
// Dependencies: [12384, 19, 6571]

// Module 12387 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(6571) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(6571) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(6571) /* inlineStyles */.Path, { d, fill }));
});
