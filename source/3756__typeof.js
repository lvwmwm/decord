...
obj = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("L" === arg1) {
      return _createSuperInternal(3748).mapValue(_createSuperInternal(3748).parseNumericPattern(_createSuperInternal(3749).numericPatterns.month, arg0), valueCallback);
    } else if ("LL" === arg1) {
      return _createSuperInternal(3748).mapValue(_createSuperInternal(3748).parseNDigits(2, arg0), valueCallback);
    } else if ("Lo" === arg1) {
      return _createSuperInternal(3748).mapValue(ordinalNumber.ordinalNumber(arg0, { unit: "month" }), valueCallback);
    } else if ("LLL" === arg1) {
