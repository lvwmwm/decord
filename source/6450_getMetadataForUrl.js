...
function getMetadataForUrl(arg0, arg1) {
  (function ensureMetadataStacksAreParsed(arg0) {
    if (callback(6372).GLOBAL_OBJ._sentryModuleMetadata) {
      const _Object = Object;
      const keys = Object.keys(callback(6372).GLOBAL_OBJ._sentryModuleMetadata);
      for (const item10026 of keys) {
        ...
        let tmp16 = callback(6372).GLOBAL_OBJ._sentryModuleMetadata[item10026];
        let obj = set;
