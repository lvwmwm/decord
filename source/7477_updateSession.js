...
// Function ID: 7478
// Name: updateSession
// Dependencies: [7453, 7454, 7478, 7468, 7465, 7460]
// Exports: closeSession, makeSession

// Module 7477 (updateSession)
...
function updateSession(ipAddress) {
  ...
  if (!timestamp) {
    timestamp = require(7468) /* dateTimestampInSeconds */.timestampInSeconds();
    const obj2 = require(7468) /* dateTimestampInSeconds */;
  }
  ...
  if (!obj.sid) {
    ...
    if (32 === obj.sid.length) {
      ...
      sid = require(7465) /* addContextToFrame */.uuid4();
