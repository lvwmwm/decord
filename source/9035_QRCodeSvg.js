...
// Function ID: 9036
// Name: QRCodeSvg
// Dependencies: [9032, 19, 7758]

// Module 9035 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(7758) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(7758) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(7758) /* inlineStyles */.Path, { d, fill }));
});
