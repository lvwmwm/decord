...
// Function ID: 8573
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1481, 1612, 5277, 8573, 4650, 8574, 8576, 8577, 8578, 8579]
// Exports: NativeStackView

// Module 8572 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5277).HeaderShownContext);
  let num5 = React.useContext(num6(5277).HeaderHeightContext);
  const context1 = React.useContext(num6(5277).HeaderBackContext);
  let obj3 = num6(5277);
  ...
  callback = obj2.useCallback(num6(8573).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4650).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4650).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5277).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5277);
  ...
  let eventResult;
  const headerConfigProps = num6(8574).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  obj15[1] = closure_10(num6(5277).HeaderBackContext.Provider, obj16);
  items5[2] = closure_10(num6(5277).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = closure_11(num6(5277).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(8576).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4650).ScreenStackItem, obj4);
