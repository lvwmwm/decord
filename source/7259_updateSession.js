...
function updateSession(ipAddress) {
  if (arguments.length > 1) {
    ...
    if (!timestamp) {
      timestamp = require(7250) /* dateTimestampInSeconds */.timestampInSeconds();
    ...
    if (!obj.sid) {
      ...
      if (32 === obj.sid.length) {
        ...
        sid = require(7247) /* getFirstException */.uuid4();
        const obj3 = require(7247) /* getFirstException */;
      }
      ipAddress.sid = sid;
    }
  }
