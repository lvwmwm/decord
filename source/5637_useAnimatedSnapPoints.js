...
// Dependencies: [1653, 5464, 5477]

// Module 5637 (useAnimatedSnapPoints)
const require = arg1;
...
arg5.useAnimatedSnapPoints = (snapPoints, containerHeight, contentHeight, handleHeight, arg4, enableDynamicSizing, maxDynamicContentSize) => {
  ...
  obj = { containerHeight, INITIAL_CONTAINER_HEIGHT: _require(5464).INITIAL_CONTAINER_HEIGHT, INITIAL_SNAP_POINT: _require(5464).INITIAL_SNAP_POINT, snapPoints, normalizeSnapPoint: _require(5477).normalizeSnapPoint, enableDynamicSizing, handleHeight, INITIAL_HANDLE_HEIGHT: _require(5464).INITIAL_HANDLE_HEIGHT, contentHeight, maxDynamicContentSize, dynamicSnapPointIndex: sharedValue };
  P.__closure = obj;
  ...
  class N {
    constructor() {
      if (closure_4) {
        ...
        tmp = !length;
        if (length) {
          tmp = !items.find(/* F105963 */ function() { ... });
        }
        return !tmp;
      }
    }
