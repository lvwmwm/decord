...
// Module 7320 (extraErrorDataIntegration)
            ...
            if (arguments.length > 1) {
              ...
              if (obj.originalException) {
                if (obj2.isError(obj.originalException)) {
                  ...
                  const items = [0., "prototype", 150.334, null, null, null, null, null, null];
                  obj = {};
