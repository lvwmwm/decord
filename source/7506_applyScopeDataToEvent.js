...
// Dependencies: [7481, 7462, 7461, 7492]

// Module 7506 (applyScopeDataToEvent)
const require = arg1;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  let obj = require(7462) /* addNonEnumerableProperty */;
  ...
  const dropUndefinedKeysResult3 = require(7462) /* addNonEnumerableProperty */.dropUndefinedKeys(contexts);
  ...
  if (span) {
    ...
    obj3[0] = tmp3(7461).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(7461);
    obj4[0] = tmp3(7492).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(7492);
    const rootSpan = tmp3(7461).getRootSpan(span);
    const tmp3Result4 = tmp3(7461);
    const description = tmp3(7461).spanToJSON(rootSpan).description;
...
arg5.mergeAndOverwriteScopeData = function mergeAndOverwriteScopeData(arg0, arg1, arg2) {
  arg0[arg1] = require(7481) /* merge */.merge(arg0[arg1], arg2, 1);
};
arg5.mergeScopeData = function mergeScopeData(extra) {
  ...
  let obj = require(7481) /* merge */;
  extra.extra = obj.merge(extra.extra, extra, 1);
  extra.tags = require(7481) /* merge */.merge(extra.tags, tags, 1);
  const obj2 = require(7481) /* merge */;
  extra.user = require(7481) /* merge */.merge(extra.user, user, 1);
  const obj3 = require(7481) /* merge */;
  extra.contexts = require(7481) /* merge */.merge(extra.contexts, contexts, 1);
  const obj4 = require(7481) /* merge */;
  extra.sdkProcessingMetadata = require(7481) /* merge */.merge(extra.sdkProcessingMetadata, sdkProcessingMetadata, 2);
  if (level) {
    extra.level = level;
  }
  if (transactionName) {
