...
// Dependencies: [7455, 7456, 7463, 7464, 7465]

// Module 7462 (addNonEnumerableProperty)
const require = arg1;
...
function addNonEnumerableProperty(arg0, arg1, arg2) {
  try {
    ...
    if (require(7455) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = require(7464) /* _htmlElementAsString */.htmlTreeAsString(arg0);
      const tmp2Result = require(7464) /* _htmlElementAsString */;
    } else {
      const _Object = Object;
...
arg5.extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return require(7465) /* isMatchingPattern */.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = require(7465) /* isMatchingPattern */.truncate(joined, num);
          const obj2 = require(7465) /* isMatchingPattern */;
        }
