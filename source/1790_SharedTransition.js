...
// Dependencies: [41, 42, 1678, 1693, 1767, 1664, 1725, 1789]

// Module 1790 (SharedTransition)
...
const items = [
        ...
        if (!self._defaultTransitionType) {
          if (self._customAnimationFactory) {
            if (!self._customProgressAnimation) {
              self._defaultTransitionType = obj(1678).SharedTransitionType.ANIMATION;
            }
          }
          self._defaultTransitionType = obj(1678).SharedTransitionType.PROGRESS_ANIMATION;
        }
        if (self._defaultTransitionType === obj(1678).SharedTransitionType.ANIMATION) {
          let SHARED_ELEMENT_TRANSITION_PROGRESS = obj(1678).LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
        } else {
          SHARED_ELEMENT_TRANSITION_PROGRESS = obj(1678).LayoutAnimationType.SHARED_ELEMENT_TRANSITION_PROGRESS;
        }
        obj = obj(1767);
  ...
  },
  {
    ...
    value: function unregisterTransition(componentViewTag, flag) {
      ...
      if (this._defaultTransitionType === require(1678) /* isWorkletFunction */.SharedTransitionType.ANIMATION) {
        let SHARED_ELEMENT_TRANSITION_PROGRESS = tmp(1678).LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
      } else {
        SHARED_ELEMENT_TRANSITION_PROGRESS = tmp(1678).LayoutAnimationType.SHARED_ELEMENT_TRANSITION_PROGRESS;
      }
      const result = require(1767) /* updateLayoutAnimations */.updateLayoutAnimations(componentViewTag, SHARED_ELEMENT_TRANSITION_PROGRESS, undefined, undefined, flag);
...
obj = {
  ...
  value: function custom(arg0) {
    ...
    obj._reduceMotion = require(1678) /* isWorkletFunction */.ReduceMotion.System;
