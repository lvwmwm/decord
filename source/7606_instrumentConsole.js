...
// Dependencies: [7518, 7521, 7520, 7526]

// Module 7606 (instrumentConsole)
const require = arg1;
const dependencyMap = arg6;
function instrumentConsole() {
  if ("console" in require(7521) /* getGlobalSingleton */.GLOBAL_OBJ) {
    const CONSOLE_LEVELS = require(7520) /* consoleSandbox */.CONSOLE_LEVELS;
...
arg5.addConsoleInstrumentationHandler = function addConsoleInstrumentationHandler(arg0) {
  require(7518) /* addHandler */.addHandler("console", arg0);
  const obj = require(7518) /* addHandler */;
  require(7518) /* addHandler */.maybeInstrument("console", instrumentConsole);
};
