...
// Dependencies: [32, 1537, 1538, 1539, 1540]
// Exports: exclude, extract, parseUrl, pick, stringify, stringifyUrl

// Module 1536 (validateArrayFormatSeparator)
...
function decode(arg0, decode) {
  let tmp = arg0;
  if (decode.decode) {
    tmp = require(1538) /* decodeComponents */(arg0);
  }
  return tmp;
}
    ...
    const mapped = keys1.map((arg0) => {
      if (undefined === dependencyMap[arg0]) {
        ...
        if (!merged.encode) {
          ...
          let encodeURIComponentResult = dependencyMap(1537)(arg0);
        } else {
          const _encodeURIComponent3 = encodeURIComponent;
        ...
        if (Array.isArray(arr)) {
          ...
          if (!tmp13.encode) {
            ...
            let encodeURIComponentResult1 = dependencyMap(1537)(arg0);
          } else {
          ...
          if (!tmp.encode) {
            ...
            let encodeURIComponentResult2 = dependencyMap(1537)(arr);
          } else {
            const _encodeURIComponent2 = encodeURIComponent;
            encodeURIComponentResult2 = encodeURIComponent(arr);
          }
        } else if (tmp.strict) {
          let encodeURIComponentResult3 = dependencyMap(1537)(arg0);
        } else {
          const _encodeURIComponent = encodeURIComponent;
...
export const parseUrl = (arr) => {
  ...
  [str, tmp5] = _slicedToArray(require(1539)(arr, "#"), 2);
  const tmp2 = require;
  const tmp4 = _slicedToArray(require(1539)(arr, "#"), 2);
  ...
  if (!url.fragmentIdentifier) {
    ...
    if (merged[tmp]) {
      if (!merged.encode) {
        ...
        let encodeURIComponentResult = require(1537)(fragmentIdentifier);
      } else {
        const _encodeURIComponent = encodeURIComponent;
...
export const pick = (arg0, arg1, arg2) => {
  ...
  obj = { url: parseUrlResult.url, query: require(1540)(query, arg1), fragmentIdentifier };
