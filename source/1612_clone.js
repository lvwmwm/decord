...
// Function ID: 1613
// Name: clone
// Dependencies: [19, 17, 1502, 1599, 1521, 1613]
...
export const useLinkProps = function useLinkProps(arg0) {
  ...
  let context1;
  let obj = merged;
  const context = merged.useContext(require(1502) /* BaseNavigationContainer */.NavigationContainerRefContext);
  context1 = merged.useContext(require(1502) /* BaseNavigationContainer */.NavigationHelpersContext);
  if (context1 == null) {
    context1 = context;
  }
  if (null == context1) {
    ...
    const options = obj.useContext(tmp2(1599).LinkingContext).options;
    const tmp14 = importDefault(1521)((preventDefault) => {
