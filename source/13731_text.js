...
// Function ID: 13732
// Name: text
// Dependencies: [13732, 13680, 13676, 13677, 13696, 13733, 13734, 13699]
...
const fn = (toString, toString2) => {
  ...
  const tmp8 = require(13696) /* call */(toString, "name");
  let tmp9 = !tmp8;
  if (tmp8) {
...
function toString() {
  const self = this;
  let source = require(13699) /* all */(this);
  if (source) {
    source = require(13734) /* state */.get(self).source;
    const tmpResult = require(13734) /* state */;
  }
  if (!source) {
