...
// Dependencies: [4780, 4783]

// Module 4787 (isPngImageHeaderChunk)
const require = arg1;
const module = arg2;
const dependencyMap = arg6;
function isPngImageHeaderChunk(byteLength, length) {
  return "IHDR" === require(4780) /* getStringFromDataView */.getStringFromDataView(byteLength, length + c7, c5);
}
function isPngXmpChunk(byteLength, length) {
  let tmp = require(4780) /* getStringFromDataView */.getStringFromDataView(byteLength, length + c7, c5) === iTXt;
  if (tmp) {
    tmp = require(4780) /* getStringFromDataView */.getStringFromDataView(byteLength, length + c8, XMLcomadobexmp0.length) === XMLcomadobexmp0;
    const obj2 = require(4780) /* getStringFromDataView */;
  }
  return tmp;
}
function isPngTextChunk(byteLength, length, arg2) {
  const stringFromDataView = require(4780) /* getStringFromDataView */.getStringFromDataView(byteLength, length + c7, c5);
...
function isPngExifChunk(byteLength, length) {
  return require(4780) /* getStringFromDataView */.getStringFromDataView(byteLength, length + c7, c5) === eXIf;
}
function isPngIccpChunk(byteLength, length) {
  return require(4780) /* getStringFromDataView */.getStringFromDataView(byteLength, length + c7, c5) === iCCP;
}
function isPngChunk(byteLength, length) {
  const items = [pHYs, tIME];
  return items.includes(require(4780) /* getStringFromDataView */.getStringFromDataView(byteLength, length + c7, c5));
}
...
function parseIccHeader(getUint8, sum) {
  let obj = require(4780) /* getStringFromDataView */;
...
arg5.default = {
  isPngFile(dataView) {
    let tmp2 = !tmp;
    if (!!dataView) {
      tmp2 = require(4780) /* getStringFromDataView */.getStringFromDataView(dataView, 0, u0089PNGrnu001An.length) === u0089PNGrnu001An;
    ...
    if (length + c4 + c5 <= byteLength.byteLength) {
      while (true) {
        ...
        if (isPngTextChunk(byteLength, length, arg1)) {
          ...
          let obj3 = require(4780) /* getStringFromDataView */;
          let tmp39 = c7;
          let tmp40 = c5;
