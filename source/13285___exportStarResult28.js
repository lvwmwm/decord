...
// Dependencies: [1281, 13265, 13278, 13266]
// Exports: ToRawFixed

// Module 13285 (__exportStarResult28)
import e from "e";
...
export const ToRawFixed = function ToRawFixed(ZERO, minimumFractionDigits, maximumFractionDigits, roundingIncrement, result) {
  ...
  result = require(13278) /* __exportStarResult11 */.ApplyUnsignedRoundingMode(ZERO, timesResult2, timesResult4, result);
  ...
  if (0 !== maximumFractionDigits) {
    ...
    if (str2.length <= maximumFractionDigits) {
      sum = require(13266) /* getMultiInternalSlots */.repeat("0", maximumFractionDigits - length2 + 1) + str2;
