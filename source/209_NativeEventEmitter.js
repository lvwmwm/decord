...
export default () => {
  ...
  const importDefault = NativeEventEmitter;
  let obj = {
    key: "addListener",
    value: function addListener(arg0, arg1, arg2) {
      const NativeEventEmitter = this;
      const _nativeModule = this._nativeModule;
      if (null != _nativeModule) {
        _nativeModule.addListener(arg0);
      }
      let obj = NativeEventEmitter(closure_1[2]);
      closure_1 = obj.addListener(arg0, arg1, arg2);
      obj = {
        remove() {
          if (null != closure_1) {
  ...
  obj = {
    ...
    value: function emit(arg0) {
      ...
      const emit = NativeEventEmitter(closure_1[2]).emit;
      const items = [arg0];
      emit.apply(NativeEventEmitter(closure_1[2]), items.concat(array));
    }
  };
  items[1] = obj;
  obj = {
    ...
    value: function removeAllListeners(arg0) {
      const self = this;
      NativeEventEmitter(closure_1[3])(null != arg0, "`NativeEventEmitter.removeAllListener()` requires a non-null argument.");
      const _nativeModule = this._nativeModule;
      if (null != _nativeModule) {
        _nativeModule.removeListeners(self.listenerCount(arg0));
      }
      NativeEventEmitter(closure_1[2]).removeAllListeners(arg0);
    }
  };
  items[2] = obj;
  items[3] = {
    ...
    value: function listenerCount(arg0) {
      return NativeEventEmitter(closure_1[2]).listenerCount(arg0);
    }
  };
