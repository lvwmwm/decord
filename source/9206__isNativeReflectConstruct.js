...
// Dependencies: [41, 42, 93, 95, 98, 9200, 9201]
// Exports: Chi, Maj
...
let items = [
  {
    ...
    value: function update(B) {
      ...
      let view;
      const self = this;
      HashMD(9201).exists(this);
      ({ buffer, blockLen, view } = this);
      const toBytesResult = HashMD(9200).toBytes(B);
      let num = 0;
  ...
  },
  {
    ...
    value: function digestInto(content) {
      ...
      const self = this;
      HashMD(9201).exists(this);
      HashMD(9201).output(content, this);
      this.finished = true;
      ...
      self.process(view, 0);
      view = HashMD(9200).createView(content);
