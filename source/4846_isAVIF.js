...
arg5.isAVIF = function isAVIF(fileChunk) {
  ...
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4840) /* getFileChunk */.isAvifStringIncluded(fileChunk);
};
...
arg5.isHEIC = function isHEIC(fileChunk) {
  fileChunk = require(4840) /* getFileChunk */.getFileChunk(fileChunk);
  const FileTypes = require(4841).FileTypes;
  return FileTypes.checkByFileType(fileChunk, "avif") && require(4840) /* getFileChunk */.isHeicSignatureIncluded(fileChunk);
};
