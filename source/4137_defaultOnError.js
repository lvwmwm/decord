...
// Function ID: 4138
// Name: defaultOnError
// Dependencies: [109, 19, 21, 4138, 4139, 4141, 4115]
// Exports: RiveView

// Module 4137 (defaultOnError)
...
function defaultOnError(message) {
  return console.error("[" + _mod4138.RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp18 = jsx(_require(4115).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
