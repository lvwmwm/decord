...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5690, 5691, 5655, 5687, 5692, 5700, 5701, 5702]
// Exports: getIsModalPresentation

// Module 5689 (_isNativeReflectConstruct)
  ...
  },
  {
    ...
    value: function componentDidUpdate(layout) {
      ...
      if (gestureDirection !== layout.gestureDirection) {
        ...
        inverted.setValue(importDefault(5690)(gestureDirection));
      }
  ...
  },
  {
    ...
    value: function gestureActivationCriteria() {
      ...
      if ("vertical" === gestureDirection) {
        ...
        if (1 === importDefault(5690)(gestureDirection)) {
    ...
    value: function render() {
      ...
      if (!gestureEnabled) {
        ...
        if (typeof backgroundColor === "string") {
          tmp10 = 0 === importDefault(5692)(backgroundColor).alpha();
          const obj19 = importDefault(5692)(backgroundColor);
        }
        ...
        obj11[4] = children;
        items9[1] = callback4(importDefault(5701), obj11);
        obj8[2] = items9;
        obj7.children = closure_14(RN.View, obj8);
        obj6[2] = callback4(Card(5655).PanGestureHandler, obj7);
        items1[1] = callback4(RN.View, obj6);
        obj3.children = items1;
        items[2] = closure_14(View, obj3);
        obj[1] = items;
        return closure_14(importDefault(5700).Provider, obj);
      } else {
        if ("vertical" !== gestureDirection) {
          if ("vertical-inverted" !== gestureDirection) {
...
export const getIsModalPresentation = (name) => {
  let tmp = name === Card(5702).forModalPresentationIOS;
  if (!tmp) {
