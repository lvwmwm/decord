...
// Dependencies: [41, 42, 1659, 1674, 1748, 1645, 1706, 1770]

// Module 1771 (SharedTransition)
...
const items = [
        ...
        if (!self._defaultTransitionType) {
          if (self._customAnimationFactory) {
            if (!self._customProgressAnimation) {
              self._defaultTransitionType = obj(1659).SharedTransitionType.ANIMATION;
            }
          }
          self._defaultTransitionType = obj(1659).SharedTransitionType.PROGRESS_ANIMATION;
        }
        if (self._defaultTransitionType === obj(1659).SharedTransitionType.ANIMATION) {
          let SHARED_ELEMENT_TRANSITION_PROGRESS = obj(1659).LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
        } else {
          SHARED_ELEMENT_TRANSITION_PROGRESS = obj(1659).LayoutAnimationType.SHARED_ELEMENT_TRANSITION_PROGRESS;
        }
        obj = obj(1748);
  ...
  },
  {
    ...
    value: function unregisterTransition(componentViewTag, flag) {
      ...
      if (this._defaultTransitionType === require(1659) /* isWorkletFunction */.SharedTransitionType.ANIMATION) {
        let SHARED_ELEMENT_TRANSITION_PROGRESS = tmp(1659).LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
      } else {
        SHARED_ELEMENT_TRANSITION_PROGRESS = tmp(1659).LayoutAnimationType.SHARED_ELEMENT_TRANSITION_PROGRESS;
      }
      const result = require(1748) /* updateLayoutAnimations */.updateLayoutAnimations(componentViewTag, SHARED_ELEMENT_TRANSITION_PROGRESS, undefined, undefined, flag);
...
obj = {
  ...
  value: function custom(arg0) {
    ...
    obj._reduceMotion = require(1659) /* isWorkletFunction */.ReduceMotion.System;
