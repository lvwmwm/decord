...
// Dependencies: [6307, 6310, 6312, 6338, 6316, 6339, 6311, 6408, 6325, 6345, 6346]

// Module 6407 (getMetricsAggregatorForClient)
import "errorCallback";
import module_6310 from "module_6310";

function getMetricsAggregatorForClient(on) {
  const globalSingleton = require(6312) /* getGlobalSingleton */.getGlobalSingleton("globalMetricsAggregators", () => {
  ...
  const obj = require(6312) /* getGlobalSingleton */;
}
function addToMetricsAggregator(arg0, COUNTER_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (arguments.length > 4) {
    ...
    if (client) {
      const activeSpan = require(6316) /* spanTimeInputToSeconds */.getActiveSpan();
      let rootSpan;
      if (activeSpan) {
      ...
      if (rootSpan) {
        description = require(6316) /* spanTimeInputToSeconds */.spanToJSON(rootSpan).description;
...
function distribution(arg0, arg1, replaced) {
  addToMetricsAggregator(arg0, require(6408).DISTRIBUTION_METRIC_TYPE, arg1, ensureNumber(replaced), arg3);
}
...
export const metrics = {
  increment(arg0, arg1) {
    ...
    addToMetricsAggregator(arg0, require(6408).COUNTER_METRIC_TYPE, arg1, ensureNumber(num), tmp);
  },
  distribution,
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, require(6408).SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, replaced) {
    addToMetricsAggregator(arg0, require(6408).GAUGE_METRIC_TYPE, arg1, ensureNumber(replaced), arg3);
  },
  timing(arg0, name) {
    const _require = arg0;
    ...
    if ("function" === typeof arg2) {
      let timestampInSecondsResult = _require(6325).timestampInSeconds();
      ...
      return _require(6345).startSpanManual(obj, (arg0) => {
        const callback = arg0;
