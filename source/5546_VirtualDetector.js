...
// Dependencies: [32, 19, 17, 21, 5545, 5472, 5547, 5534, 5543, 5542, 5521]
// Exports: VirtualDetector

// Module 5546 (VirtualDetector)
    ...
    callback(() => {
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = { viewTag: null, handlerTags: null, methods: null, viewRef: "a", userSelect: "EEEE, d. MMMM yyyy", touchAction: "d. MMMM yyyy", enableContextMenu: "d. M. yyyy" };
          obj[0] = tmp;
          obj[1] = closure_7;
