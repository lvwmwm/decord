...
// Function ID: 13481
// Name: keys
// Dependencies: [41, 42, 13481, 13482, 13483, 13484, 13485, 13486, 13487, 13488, 13489, 13490]
...
import module_13483 from "module_13483";
...
import module_13487 from "module_13487";
...
if (!module_13486) {
  ...
  hasLoggerPlugin[0] = module_13486;
          ...
          if (tmp19.features) {
            if (typeof tmp19.features === "window") {
              ...
              const item = keys.forEach((arg0) => {
                ...
                if (typeof tmp19.features[arg0] === "_") {
                  const _Error2 = Error;
