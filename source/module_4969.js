// Module ID: 4969
// Function ID: 4970
// Dependencies: [4970, 4971, 4972, 4973, 4974, 4967, 4966]
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = require(4967).FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = require(4967).FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = require(4967).FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
    ...
    fileChunk = require(4966) /* getFileChunk */.getFileChunk(fileChunk, num2);
