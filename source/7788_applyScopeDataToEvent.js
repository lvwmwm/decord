...
// Dependencies: [7763, 7744, 7743, 7774]
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  const dropUndefinedKeysResult3 = require(7744) /* addNonEnumerableProperty */.dropUndefinedKeys(contexts);
...
arg5.mergeAndOverwriteScopeData = function mergeAndOverwriteScopeData(arg0, arg1, arg2) {
  arg0[arg1] = require(7763) /* merge */.merge(arg0[arg1], arg2, 1);
};
arg5.mergeScopeData = function mergeScopeData(extra) {
  ...
  let obj = require(7763) /* merge */;
  extra.extra = obj.merge(extra.extra, extra, 1);
  extra.tags = require(7763) /* merge */.merge(extra.tags, tags, 1);
  const obj2 = require(7763) /* merge */;
  extra.user = require(7763) /* merge */.merge(extra.user, user, 1);
  const obj3 = require(7763) /* merge */;
  extra.contexts = require(7763) /* merge */.merge(extra.contexts, contexts, 1);
  const obj4 = require(7763) /* merge */;
  extra.sdkProcessingMetadata = require(7763) /* merge */.merge(extra.sdkProcessingMetadata, sdkProcessingMetadata, 2);
  if (level) {
    extra.level = level;
  }
  if (transactionName) {
