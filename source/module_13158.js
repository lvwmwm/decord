// Module ID: 13158
// Function ID: 13159
// Dependencies: [13152, 13123, 13143]

// Module 13158

export default (arg0, arg1) => {
  let require;
  let obj = new require(13152) /* Range */(arg0, arg1);
  const tmp3 = new require(13123) /* SemVer */("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(13123)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
        ...
        do {
          ...
          if (require) {
            ...
            if (tmp14) {
              ...
              let tmp19 = require;
              tmp16 = !require(13143) /* SemVer */(tmp14, require);
            }
            tmp13 = tmp16;
          }
          if (!tmp13) {
