...
// Dependencies: [13585, 13582, 13587, 13586]
...
arg5.SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(internalSlots, result1, minimumFractionDigits, arg3, GetOptionResult1) {
  ...
  internalSlots.minimumIntegerDigits = require(13585) /* __exportStarResult3 */.GetNumberOption(result1, "minimumIntegerDigits", 1, 21, 1);
  const GetNumberOptionResult = require(13585) /* __exportStarResult3 */.GetNumberOption(result1, "roundingIncrement", 1, 5000, 1);
  const hasItem = set.has(GetNumberOptionResult);
  const combined = "Invalid rounding increment value: ".concat(GetNumberOptionResult, ".\nValid values are ");
  require(13582) /* getMultiInternalSlots */.invariant(hasItem, combined.concat(Array.from(set).join(", "), "."));
  const arr = Array.from(set);
  GetOptionResult1 = require(13587) /* __exportStarResult4 */.GetOption(result1, "roundingPriority", "string", ["auto", "morePrecision", "lessPrecision"], "auto");
  const GetOptionResult = require(13587) /* __exportStarResult4 */.GetOption(result1, "roundingMode", "string", ["ceil", "floor", "expand", "trunc", "halfCeil", "halfFloor", "halfExpand", "halfTrunc", "halfEven"], "halfExpand");
  ...
  internalSlots.trailingZeroDisplay = require(13587) /* __exportStarResult4 */.GetOption(result1, "trailingZeroDisplay", "string", ["auto", "stripIfInteger"], "auto");
  let flag = true;
  let flag2 = true;
