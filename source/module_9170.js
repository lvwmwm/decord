...
const obj = {
  ...
  getErrorCorrectPolynomial(diff) {
    const tmp = new require(9171) /* QRPolynomial */([1], 0);
    ...
    if (0 < diff) {
      do {
        ...
        let tmp5 = require(9171) /* QRPolynomial */;
        let obj2 = require(9172);
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (require(9166).MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(9166).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(9166).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(9166).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (require(9166).MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(9166).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(9166).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(9166).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (require(9166).MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(9166).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(9166).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(9166).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
