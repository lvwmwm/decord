...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = require(12228);
      const glogResult = require(12228).glog(self.get(0));
      const _Array = Array;
      const diff = glogResult - require(12228).glog(getLength.get(0));
