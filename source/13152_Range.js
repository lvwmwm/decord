...
// Function ID: 13153
// Name: Range
// Dependencies: [41, 42, 13124, 13151, 13125, 13127, 13126, 13123, 13153]
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13124")(require);
...
let items = [
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13125).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13126)("hyphen replace", str);
        let str3 = str.replace(tmp11(13127).safeRe[tmp11(undefined, 13127).t.COMPARATORTRIM], tmp11(13127).comparatorTrimReplace);
        tmp11(13126)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13127).safeRe[tmp11(undefined, 13127).t.TILDETRIM], tmp11(13127).tildeTrimReplace);
        tmp11(13126)("tilde trim", str5);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13123)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
