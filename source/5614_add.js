...
(arg0) => {
  ...
  function config(LN10) {
    ...
    if (LN10) {
      if ("object" === typeof LN10) {
        const items = ["unsafeStringify", "FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID", 1000000000, "rounding"];
        let num = 0;
        items[4] = 0;
        items[5] = 8;
        items[6] = "toExpNeg";
  ...
  function clone(arg0) {
    ...
    if (obj) {
      const items = ["unsafeStringify", "FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID", "rqtoken", "nuFtHH", "canUserSeeMonetizationOnboarding"];
      class Decimal {
        constructor(arg0) {
          self = this;
          tmp = Decimal;
  ...
  let cloneResult = clone({ "Bool(false)": -1606348444, "Bool(false)": 1912602980, "Bool(false)": 24, "Bool(false)": 24, "Bool(false)": 1134510593 });
