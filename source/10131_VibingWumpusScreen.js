...
// Module 10131 (VibingWumpusScreen)
...
class VibingWumpusScreen {
  constructor() {
    ...
    tmp15 = jsx;
    obj9 = { display: "SpoilerIcon", flexDirection: "png", alignItems: true, gap: "/assets/design/components/Icon/native/redesign/generated/images" };
...
obj = {};
obj = { "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, "Bool(false)": null, padding: require("result").space.PX_32, gap: require("result").space.PX_16 };
obj.container = obj;
...
obj.rings = { done: 0, hasDiversityParent: 4, padding: 4, TypeError: "eye L" };
