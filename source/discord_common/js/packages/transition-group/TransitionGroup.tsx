...
// Function ID: 10210
// Name: _toPropertyKey
// Dependencies: [109, 19, 10210, 2]

// Module 10209 (_toPropertyKey)
...
TransitionGroup["getDerivedStateFromProps"] = function getDerivedStateFromProps(children) {
  ...
  const childMapping = require(10210) /* getChildMapping */.getChildMapping(children.children);
  children = childMapping;
  if (!firstRender) {
    children = require(10210) /* getChildMapping */.mergeChildMappings(children, childMapping);
    const tmpResult = require(10210) /* getChildMapping */;
  }
...
prototype["componentDidUpdate"] = function componentDidUpdate(children, children2) {
  ...
  let obj = require(10210) /* getChildMapping */;
  ...
  if (self.props.transitionLeave) {
    ...
    let num4 = 0;
    const tmp3Result = require(10210) /* getChildMapping */;
    if (0 < items.length) {
      do {
        let tmp9 = items[num4];
        delete tmp[tmp2];
    ...
    mergeChildMappingsResult = require(10210) /* getChildMapping */.mergeChildMappings(children, childMapping);
  }
};
...
prototype["_handleDonePerform"] = function _handleDonePerform(closure_1, _objectWithoutProperties, flag) {
  ...
  const childMapping = _require(10210).getChildMapping(self.props.children);
  if (flag) {
