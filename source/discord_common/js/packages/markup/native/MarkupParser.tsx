...
// Function ID: 8036
// Name: saferParse
// Dependencies: [8036, 4000, 2]

// Module 8035 (saferParse)
function saferParse(arg0, arg1, inline) {
  ...
  `;
    ...
    const flattenAstResult = require(8036) /* collectAst */.flattenAst(inline, tmp8);
    const obj = require(8036) /* collectAst */;
    const obj2 = require(8036) /* collectAst */;
    ({ hasBailedAst, ast } = require(8036) /* collectAst */.constrainAst(flattenAstResult));
    if (tmp6) {
...
export default {
  astParserFor(importDefaultResultResult) {
    let closure_0 = importDefault(4000).parserFor(importDefaultResultResult);
    return (arg0, inline) => {
      let str = arg0;
      if (arg0 === undefined) {
        str = "";
  ...
  reactParserFor(importDefaultResultResult) {
    ...
    importDefault = obj2.reactFor(importDefault(4000).ruleOutput(importDefaultResultResult, "react"));
    return () => {
      let str = arg0;
      if (arg0 === undefined) {
        str = "";
