...
// Function ID: 7770
// Name: saferParse
// Dependencies: [7770, 3888, 2]

// Module 7769 (saferParse)
function saferParse(arg0, arg1, inline) {
  ...
  `;
    ...
    const flattenAstResult = require(7770) /* collectAst */.flattenAst(inline, tmp8);
    const obj = require(7770) /* collectAst */;
    const obj2 = require(7770) /* collectAst */;
    ({ hasBailedAst, ast } = require(7770) /* collectAst */.constrainAst(flattenAstResult));
    if (tmp6) {
...
export default {
  astParserFor(importDefaultResultResult) {
    let closure_0 = importDefault(3888).parserFor(importDefaultResultResult);
    return (arg0, inline) => {
      let str = arg0;
      if (arg0 === undefined) {
        str = "";
  ...
  reactParserFor(defaultRules) {
    let closure_0 = importDefault(3888).parserFor(defaultRules);
    let obj = importDefault(3888);
    const obj2 = importDefault(3888);
    importDefault = obj2.reactFor(importDefault(3888).ruleOutput(defaultRules, "react"));
    return () => {
      let str = arg0;
      if (arg0 === undefined) {
        str = "";
