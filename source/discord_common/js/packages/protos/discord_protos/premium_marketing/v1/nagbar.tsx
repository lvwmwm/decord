...
// Function ID: 7434
// Name: create
// Dependencies: [32, 1307, 7417, 7416, 7415, 1337, 2]
...
class Nagbar$Type extends MessageType {
  constructor() {
    ...
    items[2] = {
      ...
      kind: "enum",
      T() {
            const items = ["discord_protos.premium_marketing.v1.ButtonAction", callback(7417).ButtonAction, "BUTTON_ACTION_"];
            return items;
          }
    };
...
// ThrowIfThisInitialized (0x7c)
let result = require("create").fileFinishedImporting("../discord_common/js/packages/protos/discord_protos/premium_marketing/v1/nagbar.tsx");
