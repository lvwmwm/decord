...
// Function ID: 6265
// Name: create
// Dependencies: [32, 1307, 6265, 6266, 6267, 2]
  ...
  if (pos.pos < sum) {
    do {
      ...
      if (1 === tmp5) {
        ...
        let LocalizedString3 = require(6265) /* create */.LocalizedString;
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.bodyLocalized) {
    const LocalizedString3 = require(6265) /* create */.LocalizedString;
...
let items = [
  ...
  },
  {
    ...
    kind: "message",
    T() {
      return require(6265) /* create */.LocalizedString;
    }
  },
  {
    no: 9,
...
const items3 = [
  { no: 1, name: "disclaimer_text", kind: "scalar", T: 9 },
  {
    ...
    kind: "message",
    T() {
      return require(6266) /* create */.HelpArticle;
    }
  },
  {
    no: 3,
