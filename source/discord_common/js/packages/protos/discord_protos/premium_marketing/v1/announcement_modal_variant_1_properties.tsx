...
// Function ID: 7244
// Name: create
// Dependencies: [32, 1307, 7244, 7245, 7246, 2]
  ...
  if (pos.pos < sum) {
    do {
      ...
      if (1 === tmp5) {
        ...
        let LocalizedString3 = require(7244) /* create */.LocalizedString;
...
let items = [
  ...
  },
  {
    ...
    kind: "message",
    T() {
      return require(7244) /* create */.LocalizedString;
    }
  },
  {
    no: 9,
...
const items3 = [
  { no: 1, name: "disclaimer_text", kind: "scalar", T: 9 },
  {
    ...
    kind: "message",
    T() {
      return require(7245) /* create */.HelpArticle;
    }
  },
  {
    no: 3,
