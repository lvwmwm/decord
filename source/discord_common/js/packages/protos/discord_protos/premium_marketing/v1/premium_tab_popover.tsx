...
// Function ID: 7412
// Name: create
// Dependencies: [32, 1307, 7404, 7396, 7395, 7394, 2]
  ...
  if (pos.pos < sum) {
    do {
      ...
      if (1 === tmp5) {
        ...
        let CTAButton = require(7396) /* create */.CTAButton;
        let tmp39 = CTAButton;
        let tmp40 = pos;
        ...
        let HelpArticle = require(7395) /* create */.HelpArticle;
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.button) {
    const CTAButton = require(7396) /* create */.CTAButton;
  ...
  if (header.helpArticle) {
    const HelpArticle = require(7395) /* create */.HelpArticle;
