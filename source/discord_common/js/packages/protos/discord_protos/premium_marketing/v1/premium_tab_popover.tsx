...
// Function ID: 7408
// Name: create
// Dependencies: [32, 1307, 7400, 7392, 7391, 7390, 2]
  ...
  if (pos.pos < sum) {
    do {
      ...
      if (1 === tmp5) {
        ...
        let CTAButton = require(7392) /* create */.CTAButton;
        let tmp39 = CTAButton;
        let tmp40 = pos;
        ...
        let HelpArticle = require(7391) /* create */.HelpArticle;
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.button) {
    const CTAButton = require(7392) /* create */.CTAButton;
  ...
  if (header.helpArticle) {
    const HelpArticle = require(7391) /* create */.HelpArticle;
