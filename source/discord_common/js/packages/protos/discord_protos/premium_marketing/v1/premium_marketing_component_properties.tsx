...
// Function ID: 6264
// Name: create
// Dependencies: [32, 1307, 6264, 6268, 6269, 6270, 6271, 6272, 6274, 6276, 6277, 6278, 6279, 6280, 6281, 6282, 6283, 6284, 6285, 6286, 6287, 2]
...
class PremiumMarketingComponentProperties$Type extends MessageType {
  constructor() {
    ...
    items[1] = {
      ...
      oneof: "properties",
      T() {
            return callback(6264).AnnouncementModalVariant1Properties;
          }
    };
    items[2] = {
      no: 4,
      ...
      oneof: "properties",
      T() {
            return callback(6268).PremiumTab;
          }
    };
    items[3] = {
      no: 5,
      ...
      oneof: "properties",
      T() {
            return callback(6269).MarketingPageBanner;
          }
    };
    items[4] = {
      no: 6,
      ...
      oneof: "properties",
      T() {
            return callback(6270).PaymentModalBanner;
          }
    };
    items[5] = {
      no: 7,
      ...
      oneof: "properties",
      T() {
            return callback(6271).MobileBottomSheet;
          }
    };
    items[6] = {
      no: 8,
    ...
    items[7] = {
      ...
      oneof: "properties",
      T() {
            return callback(6274).GiftIconCoachmark;
          }
    };
    items[8] = {
      no: 10,
      ...
      oneof: "properties",
      T() {
            return callback(6276).GiftPlanSelectionCardBanner;
          }
    };
    items[9] = {
      no: 11,
      ...
      oneof: "properties",
      T() {
            return callback(6277).GiftCustomizationBanner;
          }
    };
    items[10] = {
      no: 12,
      ...
      oneof: "properties",
      T() {
            return callback(6278).BillingSettingsNitroGiftBanner;
          }
    };
    items[11] = {
      no: 13,
      ...
      oneof: "properties",
      T() {
            return callback(6279).GiftReminderNagbar;
          }
    };
    items[12] = {
      no: 14,
      ...
      oneof: "properties",
      T() {
            return callback(6280).GiftReminderCoachmark;
          }
    };
    items[13] = {
      no: 15,
      ...
      oneof: "properties",
      T() {
            return callback(6281).PremiumTabTooltip;
          }
    };
    items[14] = {
      no: 16,
      ...
      oneof: "properties",
      T() {
            return callback(6282).PremiumTabPopover;
          }
    };
    items[15] = {
      no: 17,
    ...
    items[16] = {
      ...
      oneof: "properties",
      T() {
            return callback(6284).PlanSelectCardBanner;
          }
    };
    items[17] = {
      no: 20,
      ...
      oneof: "properties",
      T() {
            return callback(6285).BillingSettingsBanner;
          }
    };
    ...
    items[19] = {
      ...
      oneof: "properties",
      T() {
            return callback(6287).AdminEditorTestComponent;
          }
    };
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(properties, tag, writeUnknownFields) {
  ...
  if ("announcementModalVariant1" === properties.properties.oneofKind) {
    const AnnouncementModalVariant1Properties = require(6264) /* create */.AnnouncementModalVariant1Properties;
  ...
  if ("premiumTab" === properties.properties.oneofKind) {
    const PremiumTab = require(6268) /* create */.PremiumTab;
  ...
  if ("marketingPageBanner" === properties.properties.oneofKind) {
    const MarketingPageBanner = require(6269) /* create */.MarketingPageBanner;
  ...
  if ("paymentModalBanner" === properties.properties.oneofKind) {
    const PaymentModalBanner = require(6270) /* create */.PaymentModalBanner;
  ...
  if ("mobileBottomSheet" === properties.properties.oneofKind) {
    const MobileBottomSheet = require(6271) /* create */.MobileBottomSheet;
  ...
  if ("giftIcon" === properties.properties.oneofKind) {
    const GiftIcon = require(6272) /* create */.GiftIcon;
  ...
  if ("giftIconCoachmark" === properties.properties.oneofKind) {
    const GiftIconCoachmark = require(6274) /* create */.GiftIconCoachmark;
  ...
  if ("giftPlanSelectionCardBanner" === properties.properties.oneofKind) {
    const GiftPlanSelectionCardBanner = require(6276) /* create */.GiftPlanSelectionCardBanner;
  ...
  if ("giftCustomizationBanner" === properties.properties.oneofKind) {
    const GiftCustomizationBanner = require(6277) /* create */.GiftCustomizationBanner;
  ...
  if ("billingSettingsNitroGiftBanner" === properties.properties.oneofKind) {
    const BillingSettingsNitroGiftBanner = require(6278) /* create */.BillingSettingsNitroGiftBanner;
  ...
  if ("giftReminderNagbar" === properties.properties.oneofKind) {
    const GiftReminderNagbar = require(6279) /* create */.GiftReminderNagbar;
  ...
  if ("giftReminderCoachmark" === properties.properties.oneofKind) {
    const GiftReminderCoachmark = require(6280) /* create */.GiftReminderCoachmark;
  ...
  if ("premiumTabTooltip" === properties.properties.oneofKind) {
    const PremiumTabTooltip = require(6281) /* create */.PremiumTabTooltip;
  ...
  if ("premiumTabPopover" === properties.properties.oneofKind) {
    const PremiumTabPopover = require(6282) /* create */.PremiumTabPopover;
  ...
  if ("nagbar" === properties.properties.oneofKind) {
    const Nagbar = require(6283) /* create */.Nagbar;
  ...
  if ("planSelectCardBanner" === properties.properties.oneofKind) {
    const PlanSelectCardBanner = require(6284) /* create */.PlanSelectCardBanner;
  ...
  if ("billingSettingsBanner" === properties.properties.oneofKind) {
    const BillingSettingsBanner = require(6285) /* create */.BillingSettingsBanner;
  ...
  if ("shopNagbar" === properties.properties.oneofKind) {
    const ShopNagbar = require(6286) /* create */.ShopNagbar;
  ...
  if ("adminEditorTestComponent" === properties.properties.oneofKind) {
    const AdminEditorTestComponent = require(6287) /* create */.AdminEditorTestComponent;
