...
// Function ID: 6267
// Name: create
// Dependencies: [32, 1307, 6267, 6271, 6272, 6273, 6274, 6275, 6277, 6279, 6280, 6281, 6282, 6283, 6284, 6285, 6286, 6287, 6288, 6289, 6290, 2]
...
class PremiumMarketingComponentProperties$Type extends MessageType {
  constructor() {
    ...
    items[1] = {
      ...
      oneof: "properties",
      T() {
            return callback(6267).AnnouncementModalVariant1Properties;
          }
    };
    items[2] = {
      no: 4,
      ...
      oneof: "properties",
      T() {
            return callback(6271).PremiumTab;
          }
    };
    items[3] = {
      no: 5,
      ...
      oneof: "properties",
      T() {
            return callback(6272).MarketingPageBanner;
          }
    };
    items[4] = {
      no: 6,
      ...
      oneof: "properties",
      T() {
            return callback(6273).PaymentModalBanner;
          }
    };
    items[5] = {
      no: 7,
      ...
      oneof: "properties",
      T() {
            return callback(6274).MobileBottomSheet;
          }
    };
    items[6] = {
      no: 8,
    ...
    items[7] = {
      ...
      oneof: "properties",
      T() {
            return callback(6277).GiftIconCoachmark;
          }
    };
    items[8] = {
      no: 10,
      ...
      oneof: "properties",
      T() {
            return callback(6279).GiftPlanSelectionCardBanner;
          }
    };
    items[9] = {
      no: 11,
      ...
      oneof: "properties",
      T() {
            return callback(6280).GiftCustomizationBanner;
          }
    };
    items[10] = {
      no: 12,
      ...
      oneof: "properties",
      T() {
            return callback(6281).BillingSettingsNitroGiftBanner;
          }
    };
    items[11] = {
      no: 13,
      ...
      oneof: "properties",
      T() {
            return callback(6282).GiftReminderNagbar;
          }
    };
    items[12] = {
      no: 14,
      ...
      oneof: "properties",
      T() {
            return callback(6283).GiftReminderCoachmark;
          }
    };
    items[13] = {
      no: 15,
      ...
      oneof: "properties",
      T() {
            return callback(6284).PremiumTabTooltip;
          }
    };
    items[14] = {
      no: 16,
      ...
      oneof: "properties",
      T() {
            return callback(6285).PremiumTabPopover;
          }
    };
    items[15] = {
      no: 17,
    ...
    items[16] = {
      ...
      oneof: "properties",
      T() {
            return callback(6287).PlanSelectCardBanner;
          }
    };
    items[17] = {
      no: 20,
      ...
      oneof: "properties",
      T() {
            return callback(6288).BillingSettingsBanner;
          }
    };
    ...
    items[19] = {
      ...
      oneof: "properties",
      T() {
            return callback(6290).AdminEditorTestComponent;
          }
    };
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(properties, tag, writeUnknownFields) {
  ...
  if ("announcementModalVariant1" === properties.properties.oneofKind) {
    const AnnouncementModalVariant1Properties = require(6267) /* create */.AnnouncementModalVariant1Properties;
  ...
  if ("premiumTab" === properties.properties.oneofKind) {
    const PremiumTab = require(6271) /* create */.PremiumTab;
  ...
  if ("marketingPageBanner" === properties.properties.oneofKind) {
    const MarketingPageBanner = require(6272) /* create */.MarketingPageBanner;
  ...
  if ("paymentModalBanner" === properties.properties.oneofKind) {
    const PaymentModalBanner = require(6273) /* create */.PaymentModalBanner;
  ...
  if ("mobileBottomSheet" === properties.properties.oneofKind) {
    const MobileBottomSheet = require(6274) /* create */.MobileBottomSheet;
  ...
  if ("giftIcon" === properties.properties.oneofKind) {
    const GiftIcon = require(6275) /* create */.GiftIcon;
  ...
  if ("giftIconCoachmark" === properties.properties.oneofKind) {
    const GiftIconCoachmark = require(6277) /* create */.GiftIconCoachmark;
  ...
  if ("giftPlanSelectionCardBanner" === properties.properties.oneofKind) {
    const GiftPlanSelectionCardBanner = require(6279) /* create */.GiftPlanSelectionCardBanner;
  ...
  if ("giftCustomizationBanner" === properties.properties.oneofKind) {
    const GiftCustomizationBanner = require(6280) /* create */.GiftCustomizationBanner;
  ...
  if ("billingSettingsNitroGiftBanner" === properties.properties.oneofKind) {
    const BillingSettingsNitroGiftBanner = require(6281) /* create */.BillingSettingsNitroGiftBanner;
  ...
  if ("giftReminderNagbar" === properties.properties.oneofKind) {
    const GiftReminderNagbar = require(6282) /* create */.GiftReminderNagbar;
  ...
  if ("giftReminderCoachmark" === properties.properties.oneofKind) {
    const GiftReminderCoachmark = require(6283) /* create */.GiftReminderCoachmark;
  ...
  if ("premiumTabTooltip" === properties.properties.oneofKind) {
    const PremiumTabTooltip = require(6284) /* create */.PremiumTabTooltip;
  ...
  if ("premiumTabPopover" === properties.properties.oneofKind) {
    const PremiumTabPopover = require(6285) /* create */.PremiumTabPopover;
  ...
  if ("nagbar" === properties.properties.oneofKind) {
    const Nagbar = require(6286) /* create */.Nagbar;
  ...
  if ("planSelectCardBanner" === properties.properties.oneofKind) {
    const PlanSelectCardBanner = require(6287) /* create */.PlanSelectCardBanner;
  ...
  if ("billingSettingsBanner" === properties.properties.oneofKind) {
    const BillingSettingsBanner = require(6288) /* create */.BillingSettingsBanner;
  ...
  if ("shopNagbar" === properties.properties.oneofKind) {
    const ShopNagbar = require(6289) /* create */.ShopNagbar;
  ...
  if ("adminEditorTestComponent" === properties.properties.oneofKind) {
    const AdminEditorTestComponent = require(6290) /* create */.AdminEditorTestComponent;
