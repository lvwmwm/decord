...
// Function ID: 7389
// Name: create
// Dependencies: [32, 1307, 7389, 7393, 7394, 7395, 7396, 7397, 7399, 7401, 7402, 7403, 7404, 7405, 7406, 7407, 7408, 7409, 7410, 7411, 7412, 2]
...
class PremiumMarketingComponentProperties$Type extends MessageType {
  constructor() {
    ...
    items[1] = {
      ...
      oneof: "properties",
      T() {
            return callback(7389).AnnouncementModalVariant1Properties;
          }
    };
    items[2] = {
      no: 4,
      ...
      oneof: "properties",
      T() {
            return callback(7393).PremiumTab;
          }
    };
    items[3] = {
      no: 5,
      ...
      oneof: "properties",
      T() {
            return callback(7394).MarketingPageBanner;
          }
    };
    items[4] = {
      no: 6,
      ...
      oneof: "properties",
      T() {
            return callback(7395).PaymentModalBanner;
          }
    };
    items[5] = {
      no: 7,
      ...
      oneof: "properties",
      T() {
            return callback(7396).MobileBottomSheet;
          }
    };
    items[6] = {
      no: 8,
    ...
    items[7] = {
      ...
      oneof: "properties",
      T() {
            return callback(7399).GiftIconCoachmark;
          }
    };
    items[8] = {
      no: 10,
      ...
      oneof: "properties",
      T() {
            return callback(7401).GiftPlanSelectionCardBanner;
          }
    };
    items[9] = {
      no: 11,
      ...
      oneof: "properties",
      T() {
            return callback(7402).GiftCustomizationBanner;
          }
    };
    items[10] = {
      no: 12,
      ...
      oneof: "properties",
      T() {
            return callback(7403).BillingSettingsNitroGiftBanner;
          }
    };
    items[11] = {
      no: 13,
      ...
      oneof: "properties",
      T() {
            return callback(7404).GiftReminderNagbar;
          }
    };
    items[12] = {
      no: 14,
      ...
      oneof: "properties",
      T() {
            return callback(7405).GiftReminderCoachmark;
          }
    };
    items[13] = {
      no: 15,
      ...
      oneof: "properties",
      T() {
            return callback(7406).PremiumTabTooltip;
          }
    };
    items[14] = {
      no: 16,
      ...
      oneof: "properties",
      T() {
            return callback(7407).PremiumTabPopover;
          }
    };
    items[15] = {
      no: 17,
    ...
    items[16] = {
      ...
      oneof: "properties",
      T() {
            return callback(7409).PlanSelectCardBanner;
          }
    };
    items[17] = {
      no: 20,
      ...
      oneof: "properties",
      T() {
            return callback(7410).BillingSettingsBanner;
          }
    };
    ...
    items[19] = {
      ...
      oneof: "properties",
      T() {
            return callback(7412).AdminEditorTestComponent;
          }
    };
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(properties, tag, writeUnknownFields) {
  ...
  if ("announcementModalVariant1" === properties.properties.oneofKind) {
    const AnnouncementModalVariant1Properties = require(7389) /* create */.AnnouncementModalVariant1Properties;
  ...
  if ("premiumTab" === properties.properties.oneofKind) {
    const PremiumTab = require(7393) /* create */.PremiumTab;
  ...
  if ("marketingPageBanner" === properties.properties.oneofKind) {
    const MarketingPageBanner = require(7394) /* create */.MarketingPageBanner;
  ...
  if ("paymentModalBanner" === properties.properties.oneofKind) {
    const PaymentModalBanner = require(7395) /* create */.PaymentModalBanner;
  ...
  if ("mobileBottomSheet" === properties.properties.oneofKind) {
    const MobileBottomSheet = require(7396) /* create */.MobileBottomSheet;
  ...
  if ("giftIcon" === properties.properties.oneofKind) {
    const GiftIcon = require(7397) /* create */.GiftIcon;
  ...
  if ("giftIconCoachmark" === properties.properties.oneofKind) {
    const GiftIconCoachmark = require(7399) /* create */.GiftIconCoachmark;
  ...
  if ("giftPlanSelectionCardBanner" === properties.properties.oneofKind) {
    const GiftPlanSelectionCardBanner = require(7401) /* create */.GiftPlanSelectionCardBanner;
  ...
  if ("giftCustomizationBanner" === properties.properties.oneofKind) {
    const GiftCustomizationBanner = require(7402) /* create */.GiftCustomizationBanner;
  ...
  if ("billingSettingsNitroGiftBanner" === properties.properties.oneofKind) {
    const BillingSettingsNitroGiftBanner = require(7403) /* create */.BillingSettingsNitroGiftBanner;
  ...
  if ("giftReminderNagbar" === properties.properties.oneofKind) {
    const GiftReminderNagbar = require(7404) /* create */.GiftReminderNagbar;
  ...
  if ("giftReminderCoachmark" === properties.properties.oneofKind) {
    const GiftReminderCoachmark = require(7405) /* create */.GiftReminderCoachmark;
  ...
  if ("premiumTabTooltip" === properties.properties.oneofKind) {
    const PremiumTabTooltip = require(7406) /* create */.PremiumTabTooltip;
  ...
  if ("premiumTabPopover" === properties.properties.oneofKind) {
    const PremiumTabPopover = require(7407) /* create */.PremiumTabPopover;
  ...
  if ("nagbar" === properties.properties.oneofKind) {
    const Nagbar = require(7408) /* create */.Nagbar;
  ...
  if ("planSelectCardBanner" === properties.properties.oneofKind) {
    const PlanSelectCardBanner = require(7409) /* create */.PlanSelectCardBanner;
  ...
  if ("billingSettingsBanner" === properties.properties.oneofKind) {
    const BillingSettingsBanner = require(7410) /* create */.BillingSettingsBanner;
  ...
  if ("shopNagbar" === properties.properties.oneofKind) {
    const ShopNagbar = require(7411) /* create */.ShopNagbar;
  ...
  if ("adminEditorTestComponent" === properties.properties.oneofKind) {
    const AdminEditorTestComponent = require(7412) /* create */.AdminEditorTestComponent;
