...
// Function ID: 6283
// Name: create
// Dependencies: [32, 1307, 6281, 6279, 6271, 2]
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.cardAsset) {
    const ThemeAwareAsset4 = require(6281) /* create */.ThemeAwareAsset;
  ...
  if (header.mobileBannerAsset) {
    const ThemeAwareAsset5 = require(6281) /* create */.ThemeAwareAsset;
