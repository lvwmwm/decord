...
// Function ID: 7427
// Name: create
// Dependencies: [32, 1307, 7425, 7423, 7415, 2]
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.bannerAsset) {
    const ThemeAwareAsset2 = require(7425) /* create */.ThemeAwareAsset;
  ...
  if (header.backgroundAsset) {
    const ThemeAwareAsset3 = require(7425) /* create */.ThemeAwareAsset;
  ...
  if (header.cardAsset) {
    const ThemeAwareAsset4 = require(7425) /* create */.ThemeAwareAsset;
  ...
  if (header.mobileBannerAsset) {
    const ThemeAwareAsset5 = require(7425) /* create */.ThemeAwareAsset;
  ...
  if (header.mobileBodyLocalized) {
    const LocalizedString3 = require(7415) /* create */.LocalizedString;
