...
// Function ID: 7645
// Name: create
// Dependencies: [32, 1307, 7643, 7641, 7633, 2]
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.cardAsset) {
    const ThemeAwareAsset4 = require(7643) /* create */.ThemeAwareAsset;
  ...
  if (header.mobileBannerAsset) {
    const ThemeAwareAsset5 = require(7643) /* create */.ThemeAwareAsset;
