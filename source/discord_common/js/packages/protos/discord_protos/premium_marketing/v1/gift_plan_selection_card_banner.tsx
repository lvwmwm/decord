...
// Function ID: 7362
// Name: create
// Dependencies: [32, 1307, 7360, 7358, 7350, 2]
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.backgroundAsset) {
    const ThemeAwareAsset3 = require(7360) /* create */.ThemeAwareAsset;
  ...
  if (header.cardAsset) {
    const ThemeAwareAsset4 = require(7360) /* create */.ThemeAwareAsset;
  ...
  if (header.mobileBannerAsset) {
    const ThemeAwareAsset5 = require(7360) /* create */.ThemeAwareAsset;
