...
// Function ID: 7272
// Name: create
// Dependencies: [32, 1307, 7270, 7268, 7260, 2]
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.cardAsset) {
    const ThemeAwareAsset4 = require(7270) /* create */.ThemeAwareAsset;
  ...
  if (header.mobileBannerAsset) {
    const ThemeAwareAsset5 = require(7270) /* create */.ThemeAwareAsset;
