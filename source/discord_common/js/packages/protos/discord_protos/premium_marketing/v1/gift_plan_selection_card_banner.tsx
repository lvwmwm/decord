...
// Function ID: 6280
// Name: create
// Dependencies: [32, 1307, 6278, 6276, 6268, 2]
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.bannerAsset) {
    const ThemeAwareAsset2 = require(6278) /* create */.ThemeAwareAsset;
  ...
  if (header.backgroundAsset) {
    const ThemeAwareAsset3 = require(6278) /* create */.ThemeAwareAsset;
  ...
  if (header.cardAsset) {
    const ThemeAwareAsset4 = require(6278) /* create */.ThemeAwareAsset;
  ...
  if (header.mobileBannerAsset) {
    const ThemeAwareAsset5 = require(6278) /* create */.ThemeAwareAsset;
  ...
  if (header.mobileBodyLocalized) {
    const LocalizedString3 = require(6268) /* create */.LocalizedString;
