...
// Function ID: 6277
// Name: create
// Dependencies: [32, 1307, 6275, 6273, 6265, 2]
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(header, tag, writeUnknownFields) {
  ...
  if (header.cardAsset) {
    const ThemeAwareAsset4 = require(6275) /* create */.ThemeAwareAsset;
  ...
  if (header.mobileBannerAsset) {
    const ThemeAwareAsset5 = require(6275) /* create */.ThemeAwareAsset;
