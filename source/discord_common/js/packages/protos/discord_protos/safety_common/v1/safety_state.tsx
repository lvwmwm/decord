...
// Function ID: 1942
// Name: create
// Dependencies: [32, 1307, 1336, 1942, 1337, 2]
...
const items2 = [
  ...
  },
  {
    ...
    repeat: 1,
    T() {
      const items = ["discord_protos.safety_common.v1.ClassificationType", require(1942) /* ClassificationType */.ClassificationType];
      return items;
    }
  },
