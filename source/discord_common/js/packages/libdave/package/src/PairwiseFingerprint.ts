...
// Function ID: 9415
// Name: compareArrays
// Dependencies: [5, 9413, 9415, 2]
// Exports: generatePairwiseFingerprint

// Module 9414 (compareArrays)
...
function _generatePairwiseFingerprint() {
  ...
  const tmp = callback((arg0, arg1, arg2, arg3, arg4) => {
    ...
    return (function*(arg0, arg1, arg2, arg3, arg4) {
      closure_6 = tmp2;
      const items = [lib(9413).generateKeyFingerprint(lib, uint8Array, closure_2), ];
      const obj9 = lib(9413);
      items[1] = lib(9413).generateKeyFingerprint(lib, closure_3, closure_4);
