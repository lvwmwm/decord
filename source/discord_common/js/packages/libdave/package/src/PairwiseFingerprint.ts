...
// Function ID: 9851
// Name: compareArrays
// Dependencies: [5, 9849, 9851, 2]
// Exports: generatePairwiseFingerprint

// Module 9850 (compareArrays)
...
function _generatePairwiseFingerprint() {
  ...
  const tmp = callback((arg0, arg1, arg2, arg3, arg4) => {
    ...
    return (function*(arg0, arg1, arg2, arg3, arg4) {
      closure_6 = tmp2;
      const items = [lib(9849).generateKeyFingerprint(lib, uint8Array, closure_2), ];
      const obj9 = lib(9849);
      items[1] = lib(9849).generateKeyFingerprint(lib, closure_3, closure_4);
