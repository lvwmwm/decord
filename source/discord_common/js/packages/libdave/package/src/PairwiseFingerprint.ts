...
// Function ID: 9737
// Name: compareArrays
// Dependencies: [5, 9735, 9737, 2]
// Exports: generatePairwiseFingerprint

// Module 9736 (compareArrays)
...
function _generatePairwiseFingerprint() {
  ...
  const tmp = callback((arg0, arg1, arg2, arg3, arg4) => {
    ...
    return (function*(arg0, arg1, arg2, arg3, arg4) {
      closure_6 = tmp2;
      const items = [lib(9735).generateKeyFingerprint(lib, uint8Array, closure_2), ];
      const obj9 = lib(9735);
      items[1] = lib(9735).generateKeyFingerprint(lib, closure_3, closure_4);
