...
export const isBlockedDomain = function isBlockedDomain(arg0) {
  const BlockedDomainsStore = require(1846) /* LIBDISCORE_JSI */.BlockedDomainsStore;
