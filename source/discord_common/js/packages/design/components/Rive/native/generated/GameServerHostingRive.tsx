...
let closure_8 = { Game_Server_Hosting_Main: [], c_chara_5: [], hytale_gameplay: [], c_chara_1: [], c_chara_4: [], c_chara_2: [], c_chara_3: [] };
let closure_9 = {
...
const result = arg1(dependencyMap[6]).fileFinishedImporting("../discord_common/js/packages/design/components/Rive/native/generated/GameServerHostingRive.tsx");
