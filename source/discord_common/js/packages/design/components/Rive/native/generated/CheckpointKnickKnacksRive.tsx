...
// Dependencies: [109, 19, 21, 4036, 4107, 4093, 2]

// Module 4106 (CheckpointKnickKnacksRive)
...
let closure_9 = {
  Preview: function PreviewBindings(reducedMotionEnabled) {
    ...
    const colorBinding = require(4036) /* BaseRive */.useColorBinding("iconColor", instance, iconColor, iconColor1, playIfNeeded);
    return null;
  },
