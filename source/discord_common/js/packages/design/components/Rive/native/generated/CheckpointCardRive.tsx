...
// Dependencies: [109, 19, 21, 4077, 4142, 4134, 2]

// Module 4141 (CheckpointCardRive)
...
let closure_9 = {
  Main: function MainBindings(reducedMotionEnabled) {
    ...
    const artboardBinding = require(4077) /* BaseRive */.useArtboardBinding("Icon", instance, file, Icon, playIfNeeded);
    ...
    const numberBinding1 = require(4077) /* BaseRive */.useNumberBinding("PowerMeter", instance, PowerMeter, PowerMeter1, playIfNeeded);
    ...
    const stringBinding = require(4077) /* BaseRive */.useStringBinding("LVL", instance, LVL, LVL1, playIfNeeded);
    ...
    const stringBinding1 = require(4077) /* BaseRive */.useStringBinding("PersonaName", instance, PersonaName, PersonaName1, playIfNeeded);
    ...
    const stringBinding2 = require(4077) /* BaseRive */.useStringBinding("id#", instance, prop, prop1, playIfNeeded);
    const tmpResult4 = require(4077) /* BaseRive */;
    let Outof;
    if (dataBinding != null) {
    ...
    const stringBinding3 = require(4077) /* BaseRive */.useStringBinding("Outof", instance, Outof, Outof1, playIfNeeded);
    const tmpResult5 = require(4077) /* BaseRive */;
    let FillColor;
    if (dataBinding != null) {
    ...
    const colorBinding = require(4077) /* BaseRive */.useColorBinding("FillColor", instance, FillColor, FillColor1, playIfNeeded);
    return null;
  },
