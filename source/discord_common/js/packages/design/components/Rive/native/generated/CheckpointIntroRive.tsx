...
// Dependencies: [109, 19, 21, 4077, 4146, 4134, 2]

// Module 4145 (CheckpointIntroRive)
...
let closure_9 = {
  "Checkpoint Intro Desktop": function CheckpointIntroDesktopBindings(reducedMotionEnabled) {
    ...
    const stringBinding = require(4077) /* BaseRive */.useStringBinding("Subtitle", instance, Subtitle, Subtitle1, playIfNeeded);
