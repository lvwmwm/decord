...
// Dependencies: [109, 19, 21, 4036, 4105, 4093, 2]

// Module 4104 (CheckpointIntroRive)
...
let closure_9 = {
  "Checkpoint Intro Desktop": function CheckpointIntroDesktopBindings(reducedMotionEnabled) {
    ...
    const stringBinding = require(4036) /* BaseRive */.useStringBinding("Subtitle", instance, Subtitle, Subtitle1, playIfNeeded);
