...
// Dependencies: [109, 19, 21, 4030, 4085, 4081, 2]

// Module 4084 (BountiesScrollIndicatorRive)
...
let closure_9 = {
  "Bounties Scroll Indicator": function BountiesScrollIndicatorBindings(arg0) {
    ...
    const triggerBinding = require(4030) /* BaseRive */.useTriggerBinding("startAnimation", instance, startAnimation, startAnimation1, playIfNeeded);
