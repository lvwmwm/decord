...
// Dependencies: [109, 19, 21, 4013, 4080, 4064, 2]

// Module 4079 (ExpressiveButtonRive)
...
let closure_9 = {
  "Mobile Expressive Button Lightmode": function MobileExpressiveButtonLightmodeBindings(arg0) {
    ...
    const numberBinding = require(4013) /* BaseRive */.useNumberBinding("posy", instance, posy, posy1, playIfNeeded);
    ...
    const numberBinding2 = require(4013) /* BaseRive */.useNumberBinding("cornerRadius", instance, cornerRadius, cornerRadius1, playIfNeeded);
    ...
    const booleanBinding = require(4013) /* BaseRive */.useBooleanBinding("pressed", instance, pressed, pressed1, playIfNeeded);
    return null;
  },
