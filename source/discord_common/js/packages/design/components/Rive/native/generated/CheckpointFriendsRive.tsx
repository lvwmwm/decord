...
// Dependencies: [109, 19, 21, 4109, 4174, 4164, 2]
...
let closure_9 = {
  MAIN: function MAINBindings(reducedMotionEnabled) {
    ...
    const booleanBinding1 = require(4109) /* BaseRive */.useBooleanBinding("twoFriends", instance, twoFriends, twoFriends1, playIfNeeded);
  ...
  Avatar: function AvatarBindings(arg0) {
    ...
    const numberBinding = require(4109) /* BaseRive */.useNumberBinding("ShadowVisibility", instance, ShadowVisibility, ShadowVisibility1, playIfNeeded);
    ...
    const colorBinding = require(4109) /* BaseRive */.useColorBinding("Stroke", instance, Stroke, Stroke1, playIfNeeded);
    ...
    const colorBinding1 = require(4109) /* BaseRive */.useColorBinding("Fill", instance, Fill, Fill1, playIfNeeded);
    ...
    const stringBinding = require(4109) /* BaseRive */.useStringBinding("Username", instance, Username, Username1, playIfNeeded);
    ...
    const imageBinding = require(4109) /* BaseRive */.useImageBinding("img", instance, img, img1, playIfNeeded);
    return null;
  },
