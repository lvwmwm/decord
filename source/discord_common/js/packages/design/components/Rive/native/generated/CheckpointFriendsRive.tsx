...
// Dependencies: [29, 31, 33, 3894, 3955, 3945, 2]

// Module 3954 (CheckpointFriendsRive)
...
let closure_9 = {
  MAIN: function MAINBindings(reducedMotionEnabled) {
    ...
    let booleanBinding = require(3894) /* useObservedValue */.useBooleanBinding("reducedMotion", instance, reducedMotionEnabled.reducedMotionEnabled, undefined, playIfNeeded);
    ...
    const booleanBinding1 = require(3894) /* useObservedValue */.useBooleanBinding("twoFriends", instance, twoFriends, twoFriends1, playIfNeeded);
    ...
    const numberBinding1 = require(3894) /* useObservedValue */.useNumberBinding("Avatar01/ShadowVisibility", instance, prop, prop1, playIfNeeded);
    ...
    const numberBinding2 = require(3894) /* useObservedValue */.useNumberBinding("Avatar01/StrokeVisibility", instance, prop2, prop3, playIfNeeded);
    ...
    const numberBinding3 = require(3894) /* useObservedValue */.useNumberBinding("Avatar01/UsernameVisibility", instance, prop4, prop5, playIfNeeded);
    ...
    const colorBinding = require(3894) /* useObservedValue */.useColorBinding("Avatar01/Stroke", instance, prop6, prop7, playIfNeeded);
    ...
    const colorBinding1 = require(3894) /* useObservedValue */.useColorBinding("Avatar01/Fill", instance, prop8, prop9, playIfNeeded);
    ...
    const stringBinding = require(3894) /* useObservedValue */.useStringBinding("Avatar01/Username", instance, prop10, prop11, playIfNeeded);
    ...
    const imageBinding = require(3894) /* useObservedValue */.useImageBinding("Avatar01/img", instance, prop12, prop13, playIfNeeded);
    const obj10 = require(3894) /* useObservedValue */;
    let prop14;
    if (null != dataBinding) {
    ...
    const numberBinding4 = require(3894) /* useObservedValue */.useNumberBinding("Avatar02/ShadowVisibility", instance, prop14, prop15, playIfNeeded);
    const obj11 = require(3894) /* useObservedValue */;
    let prop16;
    if (null != dataBinding) {
    ...
    const numberBinding5 = require(3894) /* useObservedValue */.useNumberBinding("Avatar02/StrokeVisibility", instance, prop16, prop17, playIfNeeded);
    const obj12 = require(3894) /* useObservedValue */;
    let prop18;
    if (null != dataBinding) {
    ...
    const numberBinding6 = require(3894) /* useObservedValue */.useNumberBinding("Avatar02/UsernameVisibility", instance, prop18, prop19, playIfNeeded);
    const obj13 = require(3894) /* useObservedValue */;
    let prop20;
    if (null != dataBinding) {
    ...
    const colorBinding2 = require(3894) /* useObservedValue */.useColorBinding("Avatar02/Stroke", instance, prop20, prop21, playIfNeeded);
    const obj14 = require(3894) /* useObservedValue */;
    let prop22;
    if (null != dataBinding) {
    ...
    const colorBinding3 = require(3894) /* useObservedValue */.useColorBinding("Avatar02/Fill", instance, prop22, prop23, playIfNeeded);
    const obj15 = require(3894) /* useObservedValue */;
    let prop24;
    if (null != dataBinding) {
    ...
    const stringBinding1 = require(3894) /* useObservedValue */.useStringBinding("Avatar02/Username", instance, prop24, prop25, playIfNeeded);
    const obj16 = require(3894) /* useObservedValue */;
    let prop26;
    if (null != dataBinding) {
    ...
    const imageBinding1 = require(3894) /* useObservedValue */.useImageBinding("Avatar02/img", instance, prop26, prop27, playIfNeeded);
    const obj17 = require(3894) /* useObservedValue */;
    let prop28;
    if (null != dataBinding) {
    ...
    const numberBinding7 = require(3894) /* useObservedValue */.useNumberBinding("Avatar03/ShadowVisibility", instance, prop28, prop29, playIfNeeded);
    const obj18 = require(3894) /* useObservedValue */;
    let prop30;
    if (null != dataBinding) {
    ...
    const numberBinding8 = require(3894) /* useObservedValue */.useNumberBinding("Avatar03/StrokeVisibility", instance, prop30, prop31, playIfNeeded);
    const obj19 = require(3894) /* useObservedValue */;
    let prop32;
    if (null != dataBinding) {
    ...
    const numberBinding9 = require(3894) /* useObservedValue */.useNumberBinding("Avatar03/UsernameVisibility", instance, prop32, prop33, playIfNeeded);
    const obj20 = require(3894) /* useObservedValue */;
    let prop34;
    if (null != dataBinding) {
    ...
    const colorBinding4 = require(3894) /* useObservedValue */.useColorBinding("Avatar03/Stroke", instance, prop34, prop35, playIfNeeded);
    const obj21 = require(3894) /* useObservedValue */;
    let prop36;
    if (null != dataBinding) {
    ...
    const colorBinding5 = require(3894) /* useObservedValue */.useColorBinding("Avatar03/Fill", instance, prop36, prop37, playIfNeeded);
    const obj22 = require(3894) /* useObservedValue */;
    let prop38;
    if (null != dataBinding) {
    ...
    const stringBinding2 = require(3894) /* useObservedValue */.useStringBinding("Avatar03/Username", instance, prop38, prop39, playIfNeeded);
    const obj23 = require(3894) /* useObservedValue */;
    let prop40;
    if (null != dataBinding) {
    ...
    const imageBinding2 = require(3894) /* useObservedValue */.useImageBinding("Avatar03/img", instance, prop40, prop41, playIfNeeded);
    const obj24 = require(3894) /* useObservedValue */;
    let prop42;
    if (null != dataBinding) {
    ...
    const numberBinding10 = require(3894) /* useObservedValue */.useNumberBinding("Avatar04/ShadowVisibility", instance, prop42, prop43, playIfNeeded);
    const obj25 = require(3894) /* useObservedValue */;
    let prop44;
    if (null != dataBinding) {
    ...
    const numberBinding11 = require(3894) /* useObservedValue */.useNumberBinding("Avatar04/StrokeVisibility", instance, prop44, prop45, playIfNeeded);
    const obj26 = require(3894) /* useObservedValue */;
    let prop46;
    if (null != dataBinding) {
    ...
    const numberBinding12 = require(3894) /* useObservedValue */.useNumberBinding("Avatar04/UsernameVisibility", instance, prop46, prop47, playIfNeeded);
    const obj27 = require(3894) /* useObservedValue */;
    let prop48;
    if (null != dataBinding) {
    ...
    const colorBinding6 = require(3894) /* useObservedValue */.useColorBinding("Avatar04/Stroke", instance, prop48, prop49, playIfNeeded);
    const obj28 = require(3894) /* useObservedValue */;
    let prop50;
    if (null != dataBinding) {
    ...
    const colorBinding7 = require(3894) /* useObservedValue */.useColorBinding("Avatar04/Fill", instance, prop50, prop51, playIfNeeded);
    const obj29 = require(3894) /* useObservedValue */;
    let prop52;
    if (null != dataBinding) {
    ...
    const stringBinding3 = require(3894) /* useObservedValue */.useStringBinding("Avatar04/Username", instance, prop52, prop53, playIfNeeded);
    const obj30 = require(3894) /* useObservedValue */;
    let prop54;
    if (null != dataBinding) {
    ...
    const imageBinding3 = require(3894) /* useObservedValue */.useImageBinding("Avatar04/img", instance, prop54, prop55, playIfNeeded);
    const obj31 = require(3894) /* useObservedValue */;
    let prop56;
    if (null != dataBinding) {
    ...
    const numberBinding13 = require(3894) /* useObservedValue */.useNumberBinding("Avatar05/ShadowVisibility", instance, prop56, prop57, playIfNeeded);
    const obj32 = require(3894) /* useObservedValue */;
    let prop58;
    if (null != dataBinding) {
    ...
    const numberBinding14 = require(3894) /* useObservedValue */.useNumberBinding("Avatar05/StrokeVisibility", instance, prop58, prop59, playIfNeeded);
    const obj33 = require(3894) /* useObservedValue */;
    let prop60;
    if (null != dataBinding) {
    ...
    booleanBinding = require(3894) /* useObservedValue */.useNumberBinding("Avatar05/UsernameVisibility", instance, prop60, prop61, playIfNeeded);
    const obj34 = require(3894) /* useObservedValue */;
    ...
    booleanBinding = require(3894) /* useObservedValue */.useColorBinding("Avatar05/Stroke", instance, booleanBinding, booleanBinding, playIfNeeded);
    const obj35 = require(3894) /* useObservedValue */;
    booleanBinding = undefined;
    if (null != dataBinding) {
    ...
    booleanBinding = require(3894) /* useObservedValue */.useColorBinding("Avatar05/Fill", instance, booleanBinding, booleanBinding, playIfNeeded);
    const obj36 = require(3894) /* useObservedValue */;
    booleanBinding = undefined;
    if (null != dataBinding) {
    ...
    booleanBinding = require(3894) /* useObservedValue */.useStringBinding("Avatar05/Username", instance, booleanBinding, booleanBinding, playIfNeeded);
    const obj37 = require(3894) /* useObservedValue */;
    booleanBinding = undefined;
    if (null != dataBinding) {
    ...
    booleanBinding = require(3894) /* useObservedValue */.useImageBinding("Avatar05/img", instance, booleanBinding, booleanBinding, playIfNeeded);
    const obj38 = require(3894) /* useObservedValue */;
    booleanBinding = undefined;
    if (null != dataBinding) {
    ...
    booleanBinding = require(3894) /* useObservedValue */.useColorBinding("ConnectorColor", instance, booleanBinding, booleanBinding, playIfNeeded);
    return null;
  },
  ...
  Avatar: function AvatarBindings(arg0) {
    ...
    const numberBinding = require(3894) /* useObservedValue */.useNumberBinding("ShadowVisibility", instance, ShadowVisibility, ShadowVisibility1, playIfNeeded);
    const obj = require(3894) /* useObservedValue */;
    ...
    const numberBinding1 = require(3894) /* useObservedValue */.useNumberBinding("StrokeVisibility", instance, StrokeVisibility, StrokeVisibility1, playIfNeeded);
    const obj2 = require(3894) /* useObservedValue */;
    ...
    const numberBinding2 = require(3894) /* useObservedValue */.useNumberBinding("UsernameVisibility", instance, UsernameVisibility, UsernameVisibility1, playIfNeeded);
    const obj3 = require(3894) /* useObservedValue */;
    let Stroke;
    if (null != dataBinding) {
    ...
    const colorBinding = require(3894) /* useObservedValue */.useColorBinding("Stroke", instance, Stroke, Stroke1, playIfNeeded);
    const obj4 = require(3894) /* useObservedValue */;
    let Fill;
    if (null != dataBinding) {
    ...
    const colorBinding1 = require(3894) /* useObservedValue */.useColorBinding("Fill", instance, Fill, Fill1, playIfNeeded);
    const obj5 = require(3894) /* useObservedValue */;
    let Username;
    if (null != dataBinding) {
    ...
    const stringBinding = require(3894) /* useObservedValue */.useStringBinding("Username", instance, Username, Username1, playIfNeeded);
    const obj6 = require(3894) /* useObservedValue */;
    let img;
    if (null != dataBinding) {
      img = dataBinding.img;
    ...
    const imageBinding = require(3894) /* useObservedValue */.useImageBinding("img", instance, img, img1, playIfNeeded);
    return null;
  },
