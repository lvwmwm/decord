...
// Dependencies: [109, 19, 21, 3918, 3979, 3969, 2]

// Module 3978 (CheckpointFriendsRive)
...
let closure_9 = {
  MAIN: function MAINBindings(reducedMotionEnabled) {
    ...
    const booleanBinding1 = require(3918) /* BaseRive */.useBooleanBinding("twoFriends", instance, twoFriends, twoFriends1, playIfNeeded);
    ...
    const numberBinding = prop60(3918).useNumberBinding("AnimationState", instance, AnimationState, AnimationState1, playIfNeeded);
    const prop60Result = prop60(3918);
    let prop;
    if (dataBinding != null) {
    ...
    const numberBinding1 = prop60(3918).useNumberBinding("Avatar01/ShadowVisibility", instance, prop, prop1, playIfNeeded);
    const prop60Result1 = prop60(3918);
    let prop2;
    if (dataBinding != null) {
    ...
    const numberBinding2 = prop60(3918).useNumberBinding("Avatar01/StrokeVisibility", instance, prop2, prop3, playIfNeeded);
    const prop60Result2 = prop60(3918);
    let prop4;
    if (dataBinding != null) {
    ...
    const numberBinding3 = prop60(3918).useNumberBinding("Avatar01/UsernameVisibility", instance, prop4, prop5, playIfNeeded);
    const prop60Result3 = prop60(3918);
    let prop6;
    if (dataBinding != null) {
    ...
    const colorBinding = prop60(3918).useColorBinding("Avatar01/Stroke", instance, prop6, prop7, playIfNeeded);
    const prop60Result4 = prop60(3918);
    let prop8;
    if (dataBinding != null) {
    ...
    const colorBinding1 = prop60(3918).useColorBinding("Avatar01/Fill", instance, prop8, prop9, playIfNeeded);
    const prop60Result5 = prop60(3918);
    let prop10;
    if (dataBinding != null) {
    ...
    const stringBinding = prop60(3918).useStringBinding("Avatar01/Username", instance, prop10, prop11, playIfNeeded);
    const prop60Result6 = prop60(3918);
    let prop12;
    if (dataBinding != null) {
    ...
    const imageBinding = prop60(3918).useImageBinding("Avatar01/img", instance, prop12, prop13, playIfNeeded);
    const prop60Result7 = prop60(3918);
    let prop14;
    if (dataBinding != null) {
    ...
    const numberBinding4 = prop60(3918).useNumberBinding("Avatar02/ShadowVisibility", instance, prop14, prop15, playIfNeeded);
    const prop60Result8 = prop60(3918);
    let prop16;
    if (dataBinding != null) {
    ...
    const numberBinding5 = prop60(3918).useNumberBinding("Avatar02/StrokeVisibility", instance, prop16, prop17, playIfNeeded);
    const prop60Result9 = prop60(3918);
    let prop18;
    if (dataBinding != null) {
    ...
    const numberBinding6 = prop60(3918).useNumberBinding("Avatar02/UsernameVisibility", instance, prop18, prop19, playIfNeeded);
    const prop60Result10 = prop60(3918);
    let prop20;
    if (dataBinding != null) {
    ...
    const colorBinding2 = prop60(3918).useColorBinding("Avatar02/Stroke", instance, prop20, prop21, playIfNeeded);
    const prop60Result11 = prop60(3918);
    let prop22;
    if (dataBinding != null) {
    ...
    const colorBinding3 = prop60(3918).useColorBinding("Avatar02/Fill", instance, prop22, prop23, playIfNeeded);
    const prop60Result12 = prop60(3918);
    let prop24;
    if (dataBinding != null) {
    ...
    const stringBinding1 = prop60(3918).useStringBinding("Avatar02/Username", instance, prop24, prop25, playIfNeeded);
    const prop60Result13 = prop60(3918);
    let prop26;
    if (dataBinding != null) {
    ...
    const imageBinding1 = prop60(3918).useImageBinding("Avatar02/img", instance, prop26, prop27, playIfNeeded);
    const prop60Result14 = prop60(3918);
    let prop28;
    if (dataBinding != null) {
    ...
    const numberBinding7 = prop60(3918).useNumberBinding("Avatar03/ShadowVisibility", instance, prop28, prop29, playIfNeeded);
    const prop60Result15 = prop60(3918);
    let prop30;
    if (dataBinding != null) {
    ...
    const numberBinding8 = prop60(3918).useNumberBinding("Avatar03/StrokeVisibility", instance, prop30, prop31, playIfNeeded);
    const prop60Result16 = prop60(3918);
    let prop32;
    if (dataBinding != null) {
    ...
    const numberBinding9 = prop60(3918).useNumberBinding("Avatar03/UsernameVisibility", instance, prop32, prop33, playIfNeeded);
    const prop60Result17 = prop60(3918);
    let prop34;
    if (dataBinding != null) {
    ...
    const colorBinding4 = prop60(3918).useColorBinding("Avatar03/Stroke", instance, prop34, prop35, playIfNeeded);
    const prop60Result18 = prop60(3918);
    let prop36;
    if (dataBinding != null) {
    ...
    const colorBinding5 = prop60(3918).useColorBinding("Avatar03/Fill", instance, prop36, prop37, playIfNeeded);
    const prop60Result19 = prop60(3918);
    let prop38;
    if (dataBinding != null) {
    ...
    const stringBinding2 = prop60(3918).useStringBinding("Avatar03/Username", instance, prop38, prop39, playIfNeeded);
    const prop60Result20 = prop60(3918);
    let prop40;
    if (dataBinding != null) {
    ...
    const imageBinding2 = prop60(3918).useImageBinding("Avatar03/img", instance, prop40, prop41, playIfNeeded);
    const prop60Result21 = prop60(3918);
    let prop42;
    if (dataBinding != null) {
    ...
    const numberBinding10 = prop60(3918).useNumberBinding("Avatar04/ShadowVisibility", instance, prop42, prop43, playIfNeeded);
    const prop60Result22 = prop60(3918);
    let prop44;
    if (dataBinding != null) {
    ...
    const numberBinding11 = prop60(3918).useNumberBinding("Avatar04/StrokeVisibility", instance, prop44, prop45, playIfNeeded);
    const prop60Result23 = prop60(3918);
    let prop46;
    if (dataBinding != null) {
    ...
    const numberBinding12 = prop60(3918).useNumberBinding("Avatar04/UsernameVisibility", instance, prop46, prop47, playIfNeeded);
    const prop60Result24 = prop60(3918);
    let prop48;
    if (dataBinding != null) {
    ...
    const colorBinding6 = prop60(3918).useColorBinding("Avatar04/Stroke", instance, prop48, prop49, playIfNeeded);
    const prop60Result25 = prop60(3918);
    let prop50;
    if (dataBinding != null) {
    ...
    const colorBinding7 = prop60(3918).useColorBinding("Avatar04/Fill", instance, prop50, prop51, playIfNeeded);
    const prop60Result26 = prop60(3918);
    let prop52;
    if (dataBinding != null) {
    ...
    const stringBinding3 = prop60(3918).useStringBinding("Avatar04/Username", instance, prop52, prop53, playIfNeeded);
    const prop60Result27 = prop60(3918);
    let prop54;
    if (dataBinding != null) {
    ...
    const imageBinding3 = prop60(3918).useImageBinding("Avatar04/img", instance, prop54, prop55, playIfNeeded);
    const prop60Result28 = prop60(3918);
    let prop56;
    if (dataBinding != null) {
    ...
    const numberBinding13 = prop60(3918).useNumberBinding("Avatar05/ShadowVisibility", instance, prop56, prop57, playIfNeeded);
    const prop60Result29 = prop60(3918);
    let prop58;
    if (dataBinding != null) {
    ...
    const numberBinding14 = prop60(3918).useNumberBinding("Avatar05/StrokeVisibility", instance, prop58, prop59, playIfNeeded);
    const prop60Result30 = prop60(3918);
    prop60 = undefined;
    if (dataBinding != null) {
    ...
    prop60 = prop60(3918).useNumberBinding("Avatar05/UsernameVisibility", instance, prop60, prop60, playIfNeeded);
    const prop60Result31 = prop60(3918);
    prop60 = undefined;
    if (dataBinding != null) {
    ...
    prop60 = prop60(3918).useColorBinding("Avatar05/Stroke", instance, prop60, prop60, playIfNeeded);
    const prop60Result32 = prop60(3918);
    prop60 = undefined;
    if (dataBinding != null) {
    ...
    prop60 = prop60(3918).useColorBinding("Avatar05/Fill", instance, prop60, prop60, playIfNeeded);
    const prop60Result33 = prop60(3918);
    prop60 = undefined;
    if (dataBinding != null) {
    ...
    prop60 = prop60(3918).useStringBinding("Avatar05/Username", instance, prop60, prop60, playIfNeeded);
    const prop60Result34 = prop60(3918);
    prop60 = undefined;
    if (dataBinding != null) {
    ...
    prop60 = prop60(3918).useImageBinding("Avatar05/img", instance, prop60, prop60, playIfNeeded);
    const prop60Result35 = prop60(3918);
    prop60 = undefined;
    if (dataBinding != null) {
    ...
    prop60 = prop60(3918).useColorBinding("ConnectorColor", instance, prop60, prop60, playIfNeeded);
    return null;
  },
  ...
  Avatar: function AvatarBindings(arg0) {
    ...
    const numberBinding = require(3918) /* BaseRive */.useNumberBinding("ShadowVisibility", instance, ShadowVisibility, ShadowVisibility1, playIfNeeded);
    ...
    const colorBinding = require(3918) /* BaseRive */.useColorBinding("Stroke", instance, Stroke, Stroke1, playIfNeeded);
    ...
    const colorBinding1 = require(3918) /* BaseRive */.useColorBinding("Fill", instance, Fill, Fill1, playIfNeeded);
    ...
    const stringBinding = require(3918) /* BaseRive */.useStringBinding("Username", instance, Username, Username1, playIfNeeded);
    ...
    const imageBinding = require(3918) /* BaseRive */.useImageBinding("img", instance, img, img1, playIfNeeded);
    return null;
  },
