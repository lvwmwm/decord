...
// Dependencies: [109, 19, 21, 4036, 4103, 4093, 2]

// Module 4102 (CheckpointFriendsRive)
...
let closure_9 = {
  MAIN: function MAINBindings(reducedMotionEnabled) {
    ...
    const booleanBinding1 = require(4036) /* BaseRive */.useBooleanBinding("twoFriends", instance, twoFriends, twoFriends1, playIfNeeded);
  ...
  Avatar: function AvatarBindings(arg0) {
    ...
    const numberBinding = require(4036) /* BaseRive */.useNumberBinding("ShadowVisibility", instance, ShadowVisibility, ShadowVisibility1, playIfNeeded);
    ...
    const colorBinding = require(4036) /* BaseRive */.useColorBinding("Stroke", instance, Stroke, Stroke1, playIfNeeded);
    ...
    const colorBinding1 = require(4036) /* BaseRive */.useColorBinding("Fill", instance, Fill, Fill1, playIfNeeded);
    ...
    const stringBinding = require(4036) /* BaseRive */.useStringBinding("Username", instance, Username, Username1, playIfNeeded);
    ...
    const imageBinding = require(4036) /* BaseRive */.useImageBinding("img", instance, img, img1, playIfNeeded);
    return null;
  },
