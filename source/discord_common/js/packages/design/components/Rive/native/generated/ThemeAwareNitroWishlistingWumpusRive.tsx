...
// Dependencies: [109, 19, 21, 4030, 4115, 4087, 2]

// Module 4114 (ThemeAwareNitroWishlistingWumpusRive)
...
let closure_9 = {
  "Nitro Wishlist": function NitroWishlistBindings(reducedMotionEnabled) {
    ...
    const colorBinding = require(4030) /* BaseRive */.useColorBinding("logoColor", instance, logoColor, logoColor1, playIfNeeded);
    return null;
  }
};
