...
// Dependencies: [32, 12355, 12438, 2]
// Exports: default

// Module 12437 (isVisualUnfurledMedia)
  ...
  if (null == primary) {
    ...
    while (tmp29 !== undefined) {
      ...
      if (typeof tmp8 === "string") {
        ...
        obj[0] = require(12355) /* resolveFieldValue */.ResolvedValueType.STRING;
        let tmp25 = tmp8;
        obj[1] = tmp9;
        obj[tmp7] = obj;
      } else {
        ...
        if (typeof tmp9 === "number") {
          ...
          obj[0] = require(12355) /* resolveFieldValue */.ResolvedValueType.NUMBER;
          let tmp21 = tmp8;
          obj[1] = tmp9;
          obj[tmp7] = obj;
        } else {
              ...
              if ("proxy_url" in tmp9) {
                ...
                if ("loading_state" in tmp9) {
                  ...
                  if (isVisualUnfurledMedia(tmp9)) {
                    ...
                    obj1[0] = require(12355) /* resolveFieldValue */.ResolvedValueType.MEDIA;
...
function resolvedValuesFromDynamic(data) {
  ...
  if (null == dynamic) {
    ...
    while (iter2 !== undefined) {
      ...
      if (nextResult.type === require(12438) /* ProfileDataDynamicType */.ProfileDataDynamicType.STRING) {
        let tmp9 = nextResult;
        obj = { type: null, value: null };
        obj[0] = tmp5(12355).ResolvedValueType.STRING;
        obj[1] = iter.value;
        obj[iter.name] = obj;
      } else {
        let tmp11 = nextResult;
        if (iter.type === tmp5(12438).ProfileDataDynamicType.NUMBER) {
          let tmp8 = nextResult;
          obj = { type: null, value: null };
          obj[0] = tmp5(12355).ResolvedValueType.NUMBER;
          obj[1] = iter.value;
          obj[iter.name] = obj;
        } else {
          let tmp12 = nextResult;
          if (iter.type === tmp5(12438).ProfileDataDynamicType.MEDIA) {
            let tmp13 = isVisualUnfurledMedia;
            let tmp14 = nextResult;
            if (isVisualUnfurledMedia(iter.value)) {
              let tmp7 = nextResult;
              let obj1 = { type: null, media: null };
              obj1[0] = tmp5(12355).ResolvedValueType.MEDIA;
              let obj2 = { url: null, width: null, height: null };
