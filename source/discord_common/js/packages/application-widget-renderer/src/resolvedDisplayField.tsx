...
// Module 12066 (resolveTextComponentValues)
...
export const resolveTextComponentValues = function resolveTextComponentValues(subtitle_1, resolveFieldValue, numberFormat, arg3) {
  ...
  if (null == subtitle_1) {
    ...
    const items = [require(12067) /* resolveFieldValue */.ResolvedValueType.STRING, require(12067) /* resolveFieldValue */.ResolvedValueType.NUMBER];
    let iter = resolveFieldValue(subtitle_1.fields.text, items);
    let str = null;
    if (!flag2) {
      const items1 = [tmp9(12067).ResolvedValueType.STRING, tmp9(12067).ResolvedValueType.NUMBER];
    ...
    const items2 = [require(12067) /* resolveFieldValue */.ResolvedValueType.MEDIA];
...
export const resolveStatComponentValues = function resolveStatComponentValues(fields, closure_1, closure_2, formatDurationNarrow, arg4) {
  ...
  if (null == fields) {
    ...
    const items1 = [require(12067) /* resolveFieldValue */.ResolvedValueType.STRING];
    ...
    if (null == iter) {
      ...
      if (iter.type === tmp6(12067).ResolvedValueType.STRING) {
        let formatResult = iter.value;
      } else if (iter.presentationType === tmp6(12068).ApplicationWidgetFieldPresentationType.DURATION) {
...
export const resolveSingleStringOrSkeleton = function resolveSingleStringOrSkeleton(componentConfig, description, resolveFieldValue) {
  ...
  const items = [require(12067) /* resolveFieldValue */.ResolvedValueType.STRING];
