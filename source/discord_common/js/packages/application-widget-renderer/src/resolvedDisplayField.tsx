...
// Module 12287 (resolveTextComponentValues)
...
export const resolveTextComponentValues = function resolveTextComponentValues(subtitle_1, resolveFieldValue, numberFormat, arg3) {
  ...
  if (null == subtitle_1) {
    ...
    const items = [require(12288) /* resolveFieldValue */.ResolvedValueType.STRING, require(12288) /* resolveFieldValue */.ResolvedValueType.NUMBER];
    ...
    const items2 = [require(12288) /* resolveFieldValue */.ResolvedValueType.MEDIA];
...
export const resolveStatComponentValues = function resolveStatComponentValues(fields, closure_1, closure_2, formatDurationNarrow, arg4) {
  ...
  if (null == fields) {
    ...
    const items1 = [require(12288) /* resolveFieldValue */.ResolvedValueType.STRING];
...
export const resolveSingleStringOrSkeleton = function resolveSingleStringOrSkeleton(componentConfig, description, resolveFieldValue) {
  ...
  const items = [require(12288) /* resolveFieldValue */.ResolvedValueType.STRING];
