...
// Function ID: 4354
// Name: destroy
// Dependencies: [32, 5, 4316, 4354, 4355, 4356, 4359, 4, 4304, 4352, 4360, 669, 4362, 4422, 2]
        ...
        if (c3 === 2) {
          ...
          try {
            ...
            if (0 === dependencyMap) {
              ...
              voiceEngine.emit(outer1_0(4352).MediaEngineEvent.VoiceQueueMetrics, closure_1);
...
prototype["connect"] = function connect(arg0, arg1, processPriority) {
  ...
  obj = self(4362).create(arg0, arg1, processPriority);
  obj.on(obj(4352).BaseConnectionEvent.Destroy, (arg0) => {
  ...
  obj.on(obj(4352).BaseConnectionEvent.Connected, () => {
    obj.setVideoBroadcast(self.shouldConnectionBroadcastVideo(obj));
  });
  obj.on(obj(4352).BaseConnectionEvent.Silence, (arg0) => {
  ...
  self.emit(obj(4352).MediaEngineEvent.Connection, obj);
  return obj;
};
...
prototype["getAudioInputDevices"] = function getAudioInputDevices() {
  return require(4422) /* sanitizeDevices */.getAudioInputDevices();
};
...
prototype["setAudioInputDevice"] = function setAudioInputDevice(audioInputDeviceId) {
  ...
  self.emit(_require(4352).MediaEngineEvent.SelectedDeviceChange, constants3.AUDIO_INPUT, this.audioInputDeviceId, audioInputDeviceId);
};
prototype["getAudioOutputDevices"] = function getAudioOutputDevices() {
  return require(4422) /* sanitizeDevices */.getAudioOutputDevices();
};
prototype["setAudioOutputDevice"] = function setAudioOutputDevice(audioOutputDeviceId) {
  ...
  self.emit(_require(4352).MediaEngineEvent.SelectedDeviceChange, constants3.AUDIO_OUTPUT, this.audioOutputDeviceId, audioOutputDeviceId);
};
prototype["getVideoInputDevices"] = function getVideoInputDevices() {
  return require(4422) /* sanitizeDevices */.getVideoInputDevices();
};
...
prototype["setLoopback"] = function setLoopback(arg0, arg1) {
  ...
  if (null != tmp2Result.getVoiceEngine().setEmitVADLevel2) {
    ...
    if (!tmp) {
      tmp = self.listenerCount(tmp2(4352).MediaEngineEvent.VoiceActivity) > 0;
    }
    ...
    let tmp6 = tmp;
    if (!tmp) {
      tmp6 = self.listenerCount(tmp2(4352).MediaEngineEvent.VoiceActivity) > 0;
    }
...
prototype["createReplayConnection"] = function createReplayConnection(arg0, arg1) {
  let self = this;
  self = this;
  const replay = importDefault(4362).createReplay(arg0, arg1);
  let tmp2 = null;
  if (null != replay) {
    replay.on(self(4352).BaseConnectionEvent.Destroy, (arg0) => {
      const connections = self.connections;
      connections.delete(arg0);
      if (self.connectionsEmpty()) {
    ...
    self.emit(self(4352).MediaEngineEvent.Connection, replay);
    tmp2 = replay;
...
prototype["setOnVideoContainerResized"] = function setOnVideoContainerResized(onContainerResized) {
  importDefault(4356).onContainerResized = onContainerResized;
};
...
prototype["stopLocalAudioRecording"] = function stopLocalAudioRecording(arg0) {
  ...
  let tmp5 = this.listenerCount(tmp(4352).MediaEngineEvent.VoiceActivity) > 0;
  if (tmp5) {
    let tmpResult = tmp(4304);
