...
// Function ID: 4409
// Name: create
// Dependencies: [32, 4362, 4400, 4409, 4351, 4, 4398, 4457, 4458, 4459, 4407, 4461, 4410, 4462, 4414, 4463, 4466, 2]
...
prototype["setSelfMute"] = function setSelfMute(selfMute) {
  ...
  this.emit(require(4398) /* BaseConnectionEvent */.BaseConnectionEvent.Mute, selfMute);
};
...
prototype["setSelfDeaf"] = function setSelfDeaf(deaf) {
  ...
  this.emit(require(4398) /* BaseConnectionEvent */.BaseConnectionEvent.Deafen, deaf);
};
...
prototype["setLocalMute"] = function setLocalMute(closure_0, flag) {
  ...
  this.emit(require(4398) /* BaseConnectionEvent */.BaseConnectionEvent.LocalMute, closure_0, flag);
};
...
prototype["setLocalVideoDisabled"] = function setLocalVideoDisabled(arg0, arg1) {
  ...
  this.emit(require(4398) /* BaseConnectionEvent */.BaseConnectionEvent.LocalVideoDisabled, arg0, arg1);
};
...
prototype["setDesktopEncodingOptions"] = function setDesktopEncodingOptions(result, resolution, frameRate) {
  ...
  if (!this.destroyed) {
    ...
    if (null != calcMaxBitrateFuncResult) {
      ...
      const VideoQuality = require(4410) /* WantsVideoQuality */.VideoQuality;
...
prototype["createInputModeOptions"] = function createInputModeOptions() {
  ...
  if (constants3.VOICE_ACTIVITY === inputMode) {
    ...
    const VADAggressiveness = require(4462) /* VADAggressiveness */.VADAggressiveness;
...
prototype["getConnectionTransportOptions"] = function getConnectionTransportOptions() {
  ...
  let supportsFeatureResult = require(4351) /* inject */.supportsFeature(constants8.VIDEO_EFFECTS);
...
prototype["mergeUsers"] = function mergeUsers(items4) {
  ...
  this.emit(require(4398) /* BaseConnectionEvent */.BaseConnectionEvent.UsersMerged, items4);
};
