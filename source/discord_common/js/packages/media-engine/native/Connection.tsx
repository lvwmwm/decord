...
// Function ID: 4451
// Name: create
// Dependencies: [32, 4405, 4442, 4451, 4394, 4, 4440, 4499, 4500, 4501, 4449, 4503, 4452, 4504, 4456, 4505, 4508, 2]
...
prototype["setSelfMute"] = function setSelfMute(selfMute) {
  ...
  this.emit(require(4440) /* BaseConnectionEvent */.BaseConnectionEvent.Mute, selfMute);
};
...
prototype["setSelfDeaf"] = function setSelfDeaf(deaf) {
  ...
  this.emit(require(4440) /* BaseConnectionEvent */.BaseConnectionEvent.Deafen, deaf);
};
...
prototype["setLocalMute"] = function setLocalMute(closure_0, flag) {
  ...
  this.emit(require(4440) /* BaseConnectionEvent */.BaseConnectionEvent.LocalMute, closure_0, flag);
};
...
prototype["setLocalVideoDisabled"] = function setLocalVideoDisabled(arg0, arg1) {
  ...
  this.emit(require(4440) /* BaseConnectionEvent */.BaseConnectionEvent.LocalVideoDisabled, arg0, arg1);
};
...
prototype["setDesktopEncodingOptions"] = function setDesktopEncodingOptions(result, resolution, frameRate) {
  ...
  if (!this.destroyed) {
    ...
    if (null != calcMaxBitrateFuncResult) {
      ...
      const VideoQuality = require(4452) /* WantsVideoQuality */.VideoQuality;
...
prototype["createInputModeOptions"] = function createInputModeOptions() {
  ...
  if (constants3.VOICE_ACTIVITY === inputMode) {
    ...
    const VADAggressiveness = require(4504) /* VADAggressiveness */.VADAggressiveness;
...
prototype["getConnectionTransportOptions"] = function getConnectionTransportOptions() {
  ...
  let supportsFeatureResult = require(4394) /* inject */.supportsFeature(constants8.VIDEO_EFFECTS);
...
prototype["mergeUsers"] = function mergeUsers(items4) {
  ...
  this.emit(require(4440) /* BaseConnectionEvent */.BaseConnectionEvent.UsersMerged, items4);
};
