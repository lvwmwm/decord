...
// Function ID: 4411
// Name: create
// Dependencies: [32, 4364, 4402, 4411, 4353, 4, 4400, 4459, 4460, 4461, 4409, 4463, 4412, 4464, 4416, 4465, 4468, 2]
...
prototype["setSelfMute"] = function setSelfMute(selfMute) {
  ...
  this.emit(require(4400) /* BaseConnectionEvent */.BaseConnectionEvent.Mute, selfMute);
};
...
prototype["setSelfDeaf"] = function setSelfDeaf(deaf) {
  ...
  this.emit(require(4400) /* BaseConnectionEvent */.BaseConnectionEvent.Deafen, deaf);
};
...
prototype["setLocalMute"] = function setLocalMute(closure_0, flag) {
  ...
  this.emit(require(4400) /* BaseConnectionEvent */.BaseConnectionEvent.LocalMute, closure_0, flag);
};
...
prototype["setLocalVideoDisabled"] = function setLocalVideoDisabled(arg0, arg1) {
  ...
  this.emit(require(4400) /* BaseConnectionEvent */.BaseConnectionEvent.LocalVideoDisabled, arg0, arg1);
};
...
prototype["setDesktopEncodingOptions"] = function setDesktopEncodingOptions(result, resolution, frameRate) {
  ...
  if (!this.destroyed) {
    ...
    if (null != calcMaxBitrateFuncResult) {
      ...
      const VideoQuality = require(4412) /* WantsVideoQuality */.VideoQuality;
...
prototype["createInputModeOptions"] = function createInputModeOptions() {
  ...
  if (constants3.VOICE_ACTIVITY === inputMode) {
    ...
    const VADAggressiveness = require(4464) /* VADAggressiveness */.VADAggressiveness;
...
prototype["getConnectionTransportOptions"] = function getConnectionTransportOptions() {
  ...
  let supportsFeatureResult = require(4353) /* inject */.supportsFeature(constants8.VIDEO_EFFECTS);
...
prototype["mergeUsers"] = function mergeUsers(items4) {
  ...
  this.emit(require(4400) /* BaseConnectionEvent */.BaseConnectionEvent.UsersMerged, items4);
};
