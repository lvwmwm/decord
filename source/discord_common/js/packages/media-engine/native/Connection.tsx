...
// Function ID: 4362
// Name: create
// Dependencies: [32, 4315, 4353, 4362, 4304, 4, 4351, 4410, 4411, 4412, 4360, 4414, 4363, 4415, 4367, 4416, 4419, 2]
...
prototype["setSelfMute"] = function setSelfMute(selfMute) {
  ...
  this.emit(require(4351) /* BaseConnectionEvent */.BaseConnectionEvent.Mute, selfMute);
};
...
prototype["setSelfDeaf"] = function setSelfDeaf(deaf) {
  ...
  this.emit(require(4351) /* BaseConnectionEvent */.BaseConnectionEvent.Deafen, deaf);
};
...
prototype["setLocalMute"] = function setLocalMute(closure_0, flag) {
  ...
  this.emit(require(4351) /* BaseConnectionEvent */.BaseConnectionEvent.LocalMute, closure_0, flag);
};
...
prototype["setLocalVideoDisabled"] = function setLocalVideoDisabled(arg0, arg1) {
  ...
  this.emit(require(4351) /* BaseConnectionEvent */.BaseConnectionEvent.LocalVideoDisabled, arg0, arg1);
};
...
prototype["setDesktopEncodingOptions"] = function setDesktopEncodingOptions(result, resolution, frameRate) {
  ...
  if (!this.destroyed) {
    ...
    if (null != calcMaxBitrateFuncResult) {
      ...
      const VideoQuality = require(4363) /* WantsVideoQuality */.VideoQuality;
...
prototype["createInputModeOptions"] = function createInputModeOptions() {
  ...
  if (constants3.VOICE_ACTIVITY === inputMode) {
    ...
    const VADAggressiveness = require(4415) /* VADAggressiveness */.VADAggressiveness;
...
prototype["mergeUsers"] = function mergeUsers(items4) {
  ...
  this.emit(require(4351) /* BaseConnectionEvent */.BaseConnectionEvent.UsersMerged, items4);
};
