...
// Dependencies: [5, 4398, 4407, 2]
// Exports: default

// Module 4406 (pollConnectionStats)
...
export default function pollConnectionStats(on) {
  ...
  on.on(_require(4398).MediaEngineEvent.Destroy, () => {
    let c1 = true;
    return true;
  });
  let timerId = setTimeout(pollStats, _require(4407).STATS_INTERVAL);
};
