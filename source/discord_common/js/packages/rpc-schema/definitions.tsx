...
// Function ID: 13675
// Name: response
// Dependencies: [13675, 8842, 2]

// Module 13674 (response)
...
obj = {
  ...
  response(string) {
    ...
    const items = [...require(13675) /* RPCCommands */.joiEnum(require(8842) /* set */.OAuth2Scopes)];
    const obj12 = require(13675) /* RPCCommands */;
...
export const RPCCommandSchemas = {
  [require(13675).RPCCommand.INITIATE_IMAGE_UPLOAD]: obj,
  [require(13675).RPCCommand.OPEN_SHARE_MOMENT_DIALOG]: obj,
  [require(13675).RPCCommand.AUTHENTICATE]: obj,
  [require(13675).RPCCommand.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS]: obj1,
  [require(13675).RPCCommand.SHARE_INTERACTION]: {
    request(string) {
  ...
  [require(13675).RPCCommand.SHARE_LINK]: {
    request(string) {
  ...
  [require(13675).RPCCommand.GET_RELATIONSHIPS]: obj4,
  [require(13675).RPCCommand.INVITE_USER_EMBEDDED]: {
    request(string) {
  ...
  [require(13675).RPCCommand.GET_USER]: {
    request(string) {
      const obj = { id: null };
      const stringResult = string.string();
  ...
  [require(13675).RPCCommand.GET_QUEST_ENROLLMENT_STATUS]: {
    request(string) {
  ...
  [require(13675).RPCCommand.QUEST_START_TIMER]: {
    request(string) {
      const obj = { quest_id: null };
      obj[0] = string.string().required();
      return obj;
  ...
  [require(13675).RPCCommand.GET_QUEST]: obj9,
  [require(13675).RPCCommand.REQUEST_PROXY_TICKET_REFRESH]: obj10
};
