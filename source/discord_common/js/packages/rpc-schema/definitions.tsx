...
// Function ID: 13661
// Name: response
// Dependencies: [13661, 8825, 2]

// Module 13660 (response)
...
obj = {
  ...
  response(string) {
    ...
    const items = [...require(13661) /* RPCCommands */.joiEnum(require(8825) /* set */.OAuth2Scopes)];
    const obj12 = require(13661) /* RPCCommands */;
...
export const RPCCommandSchemas = {
  [require(13661).RPCCommand.INITIATE_IMAGE_UPLOAD]: obj,
  [require(13661).RPCCommand.OPEN_SHARE_MOMENT_DIALOG]: obj,
  [require(13661).RPCCommand.AUTHENTICATE]: obj,
  [require(13661).RPCCommand.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS]: obj1,
  [require(13661).RPCCommand.SHARE_INTERACTION]: {
    request(string) {
  ...
  [require(13661).RPCCommand.SHARE_LINK]: {
    request(string) {
  ...
  [require(13661).RPCCommand.GET_RELATIONSHIPS]: obj4,
  [require(13661).RPCCommand.INVITE_USER_EMBEDDED]: {
    request(string) {
  ...
  [require(13661).RPCCommand.GET_USER]: {
    request(string) {
      const obj = { id: null };
      const stringResult = string.string();
  ...
  [require(13661).RPCCommand.GET_QUEST_ENROLLMENT_STATUS]: {
    request(string) {
  ...
  [require(13661).RPCCommand.QUEST_START_TIMER]: {
    request(string) {
      const obj = { quest_id: null };
      obj[0] = string.string().required();
      return obj;
  ...
  [require(13661).RPCCommand.GET_QUEST]: obj9,
  [require(13661).RPCCommand.REQUEST_PROXY_TICKET_REFRESH]: obj10
};
