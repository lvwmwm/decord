...
const items = [require("module_5743").Key.F6, "f6"];
const items1 = [items, , , , , , , ];
const items2 = [require("module_5743").Key.Tab, "tab"];
items1[1] = items2;
const items3 = [require("module_5743").Key.ArrowDown, "down"];
items1[2] = items3;
const items4 = [require("module_5743").Key.ArrowUp, "up"];
items1[3] = items4;
const items5 = [require("module_5743").Key.ArrowLeft, "left"];
items1[4] = items5;
const items6 = [require("module_5743").Key.ArrowRight, "right"];
items1[5] = items6;
const items7 = [require("module_5743").Key.Home, "home"];
items1[6] = items7;
const items8 = [require("module_5743").Key.End, "end"];
items1[7] = items8;
...
export const KeyboardEventKey = require("module_5743").Key;
export const FOCUS_SECTION_JUMP_KEY = require("module_5743").Key.F6;
