...
// Dependencies: [4819, 4820, 506, 4821, 4822, 4823, 4824, 4825, 4826, 2]
// Exports: contentClassificationToAgeRestriction

// Module 4818 (contentClassificationToAgeRestrictionConclusion)
  ...
  if (null == data) {
    ...
    if (data.type === obj.MINIMAL) {
      if (null != data.discord_classifications) {
        ...
        obj[0] = require(4819) /* AgeRestrictionSource */.AgeRestrictionSource.DISCORD_CLASSIFICATION;
        if (obj15.has(deserializeResult, require(4821) /* frozen */.DiscordContentClassificationFlags.EMERGENCY_ONLY_USE_IF_YOU_HAVE_TO_FORCE_MARK_AGE_RESTRICTED)) {
          ADULT = tmp28(4820).AgeRestrictionStatus.ADULT;
          obj[1] = ADULT;
          let tmp12 = obj;
        } else {
          const tmp29Result = tmp29(506);
          const AgeRestrictionStatus3 = tmp28(4820).AgeRestrictionStatus;
          obj[1] = tmp29(506).hasAny(deserializeResult, tmp28(4821).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT) ? AgeRestrictionStatus3.ADULT : AgeRestrictionStatus3.EVERYONE;
          tmp12 = obj;
          const hasAnyResult = tmp29(506).hasAny(deserializeResult, tmp28(4821).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT);
        }
        items.push(tmp12);
        obj15 = importAll(506);
      }
      ...
      obj = { source: null, status: null };
      obj[0] = require(4819) /* AgeRestrictionSource */.AgeRestrictionSource.MANUAL_CLASSIFICATION;
      if (obj2.has(deserializeResult1, require(4821) /* frozen */.DiscordContentClassificationFlags.EMERGENCY_ONLY_USE_IF_YOU_HAVE_TO_FORCE_MARK_AGE_RESTRICTED)) {
        obj[1] = tmp4(4820).AgeRestrictionStatus.ADULT;
        let tmp9 = obj;
      } else {
        const tmp6Result = tmp6(506);
        const AgeRestrictionStatus2 = tmp4(4820).AgeRestrictionStatus;
        obj[1] = tmp6(506).hasAny(deserializeResult1, tmp4(4821).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT) ? AgeRestrictionStatus2.ADULT : AgeRestrictionStatus2.EVERYONE;
        tmp9 = obj;
        const hasAnyResult1 = tmp6(506).hasAny(deserializeResult1, tmp4(4821).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT);
      }
      items.push(tmp9);
      tmp6 = importAll;
      ...
      obj1[0] = require(4819) /* AgeRestrictionSource */.AgeRestrictionSource.AUTOMATED_CLASSIFICATION;
      if (obj12.has(deserializeResult2, require(4821) /* frozen */.DiscordContentClassificationFlags.EMERGENCY_ONLY_USE_IF_YOU_HAVE_TO_FORCE_MARK_AGE_RESTRICTED)) {
        obj1[1] = tmp24(4820).AgeRestrictionStatus.ADULT;
        let tmp2 = obj1;
      } else {
        const tmp26Result = tmp26(506);
        const AgeRestrictionStatus = tmp24(4820).AgeRestrictionStatus;
        obj1[1] = tmp26(506).hasAny(deserializeResult2, tmp24(4821).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT) ? AgeRestrictionStatus.ADULT : AgeRestrictionStatus.EVERYONE;
        tmp2 = obj1;
        const hasAnyResult2 = tmp26(506).hasAny(deserializeResult2, tmp24(4821).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT);
      }
      items.push(tmp2);
      obj12 = importAll(506);
    }
    if (null != data.agency_ratings) {
      if (null == data.agency_ratings.esrb) {
        if (null == data.agency_ratings.pegi) {
          if (null == data.agency_ratings.gop) {
            if (null != data.agency_ratings.igdb) {
              ...
              let AgeRestrictionStatus7 = require(4820) /* AgeRestrictionStatus */.AgeRestrictionStatus;
              if (someResult) {
              ...
              obj2[0] = tmp21(4819).AgeRestrictionSource.AGENCY_CLASSIFICATION_IGDB;
              obj2[1] = EVERYONE;
              AgeRestrictionStatus7 = items.push(obj2);
              someResult = themes.some((arg0) => {
                const ADULT_THEMES = callback(4825).ContentRatingIGDBThemeSets.ADULT_THEMES;
                return ADULT_THEMES.has(arg0);
              });
            }
          } else {
            let AGENCY_CLASSIFICATION_GOP = dependencyMap;
            const IS_ADULT = require(4824) /* set */.ContentRatingGOPClassificationSets.IS_ADULT;
            const hasItem = IS_ADULT.has(data.agency_ratings.gop.classification);
            let AgeRestrictionStatus6 = require(4820) /* AgeRestrictionStatus */.AgeRestrictionStatus;
            const obj3 = { source: null, status: null };
            AGENCY_CLASSIFICATION_GOP = require(4819) /* AgeRestrictionSource */.AgeRestrictionSource.AGENCY_CLASSIFICATION_GOP;
          ...
          const IS_ADULT_ONLY2 = require(4823) /* set */.ContentRatingPEGIRatingSets.IS_ADULT_ONLY;
          const hasItem1 = IS_ADULT_ONLY2.has(data.agency_ratings.pegi.rating);
          let AgeRestrictionStatus5 = require(4820) /* AgeRestrictionStatus */.AgeRestrictionStatus;
          const obj4 = { source: null, status: null };
          AGENCY_CLASSIFICATION_PEGI = require(4819) /* AgeRestrictionSource */.AgeRestrictionSource.AGENCY_CLASSIFICATION_PEGI;
        ...
        const IS_ADULT_ONLY = require(4822) /* set */.ContentRatingESRBRatingSets.IS_ADULT_ONLY;
        const hasItem2 = IS_ADULT_ONLY.has(data.agency_ratings.esrb.rating);
        let AgeRestrictionStatus4 = require(4820) /* AgeRestrictionStatus */.AgeRestrictionStatus;
        const obj5 = { source: null, status: null };
        AGENCY_CLASSIFICATION_ESRB = require(4819) /* AgeRestrictionSource */.AgeRestrictionSource.AGENCY_CLASSIFICATION_ESRB;
