...
obj[11] = new Set(["applications.commands", "bot", "managed_platform.application_identities.write", "webhook.incoming"]);
...
obj[13] = new Set(["activities.invites.write", "activities.read", "activities.write", "application_identities.write", "dm_channels.messages.read", "dm_channels.messages.write", "dm_channels.read", "gateway.connect", "guilds", "guilds.channels.read", "identify", "lobbies.write", "relationships.read", "relationships.write"]);
...
obj[0] = new Set(["activities.invites.write", "activities.read", "activities.write", "application_identities.write", "gateway.connect", "identify", "identify.premium", "relationships.read", "relationships.write"]);
...
obj[1] = new Set(["activities.invites.write", "activities.read", "activities.write", "application_identities.write", "dm_channels.messages.read", "dm_channels.messages.write", "dm_channels.read", "gateway.connect", "guilds", "guilds.channels.read", "identify", "identify.premium", "lobbies.write", "relationships.read", "relationships.write"]);
obj[16] = obj;
...
obj[18] = new Set(["activities.invites.write", "activities.read", "activities.write", "application_identities.write", "dm_channels.messages.read", "dm_channels.messages.write", "dm_channels.read", "gateway.connect", "guilds", "guilds.channels.read", "identify", "lobbies.write", "relationships.read", "relationships.write"]);
