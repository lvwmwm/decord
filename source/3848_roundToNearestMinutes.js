...
// Dependencies: [3440, 3444, 3634]
// Exports: default

// Module 3848 (roundToNearestMinutes)
  ...
  if (arguments.length < 1) {
    ...
    if (defaultResult >= 1) {
      if (defaultResult <= 30) {
        ...
        const _Math = Math;
        const result = require(3634) /* getRoundingMethod */.getRoundingMethod(roundingMethod)(sum / defaultResult) * defaultResult;
        const _Date = Date;
