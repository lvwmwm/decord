...
// Dependencies: [6, 7, 6368, 6354, 6365, 6373]
// Exports: getStackAsyncContextStrategy

// Module 6367 (getAsyncContextStack)
...
function getAsyncContextStack() {
  ...
  const sentryCarrier = require(6365) /* getSentryCarrier */.getSentryCarrier(mainCarrier);
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = require(6373) /* getDefaultCurrentScope */.getDefaultCurrentScope();
    const obj3 = require(6373) /* getDefaultCurrentScope */;
    const prototype = tmp2.prototype;
    stack = new tmp2(defaultCurrentScope, require(6373) /* getDefaultCurrentScope */.getDefaultIsolationScope());
    const obj4 = require(6373) /* getDefaultCurrentScope */;
  }
