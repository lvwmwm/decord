...
// Dependencies: [1257, 13202, 13215, 13203]
// Exports: ToRawFixed

// Module 13222 (__exportStarResult28)
...
export const ToRawFixed = function ToRawFixed(ZERO, minimumFractionDigits, maximumFractionDigits, roundingIncrement, result) {
  ...
  ({ n2, r2 } = obj);
  result = require(13215) /* __exportStarResult11 */.ApplyUnsignedRoundingMode(ZERO, r1, r2, result);
  if (result.eq(obj.r1)) {
    n2 = obj.n1;
  }
  let str = "0";
  ...
  if (0 !== maximumFractionDigits) {
    ...
    if (str.length <= maximumFractionDigits) {
      sum = require(13203) /* setInternalSlot */.repeat("0", maximumFractionDigits - length2 + 1) + str;
