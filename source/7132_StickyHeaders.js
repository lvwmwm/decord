...
// Function ID: 7133
// Name: StickyHeaders
// Dependencies: [7079, 19, 21, 7129, 7133, 7094]
// Exports: StickyHeaders

// Module 7132 (StickyHeaders)
...
export const StickyHeaders = (stickyHeaderIndices) => {
  ...
  tmp3Result = tmp3(() => {
    ...
    if (-1 !== currentStickyIndex) {
      tmpResult = null;
      if (tmp4 < data.length) {
        obj1 = { index: null, item: null, renderItem: null, layout: null, refHolder: null, extraData: null, trailingItem: "accessibilityLabel", target: "set", hidden: "y", inverted: "isArray" };
        obj1[0] = tmp4;
        obj1[1] = tmp6[tmp4];
        obj1[2] = renderItem;
