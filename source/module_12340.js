// Module ID: 12340
// Function ID: 12341
// Dependencies: [5, 12274, 12337, 12341, 12342, 12343, 12336]

// Module 12340
import asyncGeneratorStep from "module_12343";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, message) {
      ...
      const util = _require(12274).util;
    ...
    let closure_8 = fn(require("module_12341"));
    let closure_9 = fn(require("module_12342"));
    let closure_10 = fn(require("module_12343"));
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: _require(12336).createStandardJSONSchemaMethod(_standard, "input"), output: _require(12336).createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = _require(12336).createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
