...
// Function ID: 6367
// Name: addHandler
// Dependencies: [6367, 6368, 6371]

// Module 6366 (addHandler)
const require = arg1;
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (require(6367) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
          const logger = tmp19(6368).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(6371).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(6371);
        }
      }
    }
