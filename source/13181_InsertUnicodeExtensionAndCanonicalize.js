...
// Dependencies: [13174, 13182]

// Module 13181 (InsertUnicodeExtensionAndCanonicalize)
const require = arg1;
const dependencyMap = arg6;
arg5.InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(locale, arg1, items) {
  let length;
  require(13174) /* isMatched */.invariant(-1 === locale.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let str = "-u";
  let num = 0;
  let str2 = "-u";
  if (0 < arg1.length) {
  ...
  if ("-u" === tmp3) {
    return require(13182) /* CanonicalizeUnicodeLocaleId */.CanonicalizeUnicodeLocaleId(locale);
  } else {
    ...
    return require(13182) /* CanonicalizeUnicodeLocaleId */.CanonicalizeUnicodeLocaleId(sum2);
  }
};
