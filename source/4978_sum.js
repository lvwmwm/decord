  ...
  findJpegOffsets(byteLength) {
    ...
    if (c5 + c6 + 5 <= byteLength.byteLength) {
      while (true) {
        ...
        let tmp28 = tmp8;
        let sum5 = tmp9;
        if (module(4975).USE_FILE) {
          let tmp30 = c19;
          if (byteLength.getUint16(sum) === c19) {
            break;
          }
        }
        if (tmp19(4975).USE_FILE) {
          let tmp31 = c20;
        ...
        if (tmp19(4975).USE_EXIF) {
          ...
          if (tmp40) {
            let tmp41 = require;
            let obj1 = require(4972) /* getDataView */;
            let tmp42 = c6;
        ...
        if (tmp19(4975).USE_IPTC) {
          ...
          if (tmp56) {
            let tmp57 = require;
            let obj5 = require(4972) /* getDataView */;
            let tmp58 = c6;
        ...
        if (tmp19(4975).USE_ICC) {
          let tmp60 = length;
          let tmp61 = c27;
          let tmp62 = byteLength.getUint16(sum) === c27;
          if (tmp62) {
            let tmp63 = require;
            let obj6 = require(4972) /* getDataView */;
            let tmp64 = c6;
        ...
        if (!tmp19(4975).USE_MPF) {
          ...
          if (tmp67) {
            let tmp68 = require;
            let obj7 = require(4972) /* getDataView */;
            let tmp69 = c6;
