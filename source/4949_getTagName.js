...
// Function ID: 4950
// Name: getTagName
// Dependencies: [32, 4910, 4927, 4950]
...
function getTagName(dataView, sum1) {
  let obj = require(4910) /* getDataView */;
...
export default {
  read(arg0, arg1) {
    ...
    if (0 < arg0.length) {
      ...
      const stringFromDataView = require(4910) /* getDataView */.getStringFromDataView(dataView, num, closure_7);
      const obj3 = require(4910) /* getDataView */;
      const shortAt = importDefault(4927).getShortAt(dataView, sum);
      const sum1 = sum + c5;
      const tmp15 = getTagName(dataView, sum1);
      let name = tmp15.tagName;
      const sum2 = sum1 + tmp15.tagNameSize;
      const obj4 = importDefault(4927);
      const longAt = importDefault(4927).getLongAt(dataView, sum2);
      const sum3 = sum2 + c6;
