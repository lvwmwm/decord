...
arg5.default = {
  read(byteLength) {
    ...
    const sum = arg1 + arg2;
    let obj1 = require(4822) /* readTag */;
    const ifd = obj1.readIfd(byteLength, require(4823) /* importDefaultResult1 */.IFD_TYPE_PENTAX, sum, sum + 10, byteOrder, arg3, true);
    ...
    if (LevelInfo) {
      ...
      if (sum1 + 7 <= byteLength.byteLength) {
        ...
        const int16 = byteLength.getInt16(sum2, byteOrder === tmp3(4807).LITTLE_ENDIAN);
        obj1 = { value: null, description: null };
        obj1[0] = int16;
        obj1[1] = "" + -0.5 * int16;
        obj.RollAngle = obj1;
        const sum3 = sum1 + tmp17.PITCH_ANGLE;
        const int161 = byteLength.getInt16(sum3, byteOrder === tmp3(4807).LITTLE_ENDIAN);
        const obj2 = { value: null, description: null };
        obj2[0] = int161;
        obj2[1] = "" + -0.5 * int161;
        obj.PitchAngle = obj2;
      }
      const tmp7Result = require(4802) /* getDataView */;
      delete tmp[tmp2];
      tmp10 = require(4802) /* getDataView */.objectAssign({}, ifd, obj);
      const objectAssignResult = require(4802) /* getDataView */.objectAssign({}, ifd, obj);
    }
    return tmp10;
  },
