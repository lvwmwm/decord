...
// Dependencies: [93, 95, 98, 42, 41, 5298, 5281]

// Module 5316 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      let obj = ContinousBaseGesture(5298);
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5281).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(5281);
      }
      return tmp;
    }
  }
