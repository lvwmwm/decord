...
// Function ID: 7538
// Name: setMeasurement
// Dependencies: [7500, 7523, 7495, 7510]

// Module 7537 (setMeasurement)
const require = arg1;
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (activeSpan) {
    rootSpan = require(7500) /* spanTimeInputToSeconds */.getRootSpan(activeSpan);
  ...
  if (rootSpan) {
    ...
    obj = {};
    obj[require(7510).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[require(7510).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
