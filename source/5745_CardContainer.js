...
// Function ID: 5746
// Name: CardContainer
// Dependencies: [19, 17, 21, 1481, 5276, 5746, 5747, 5748, 5735]

// Module 5745 (CardContainer)
...
export const CardContainer = importAllResult.memo(function CardContainerInner(active) {
  ...
  let num = importAllResult.useContext(active(5276).HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let tmp2Result = tmp2(5746);
  ...
  if (previousScene) {
    ...
    headerTitle = tmp2(5276).getHeaderTitle(options, route.name);
    href = tmp2Result1.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result2 = tmp2(5276);
  }
  c15 = tmp12;
  ...
  obj8[1] = closure_4(active(5276).HeaderHeightContext.Provider, { value: headerHeight, children: descriptor.render() });
  obj7[1] = closure_4(active(5276).HeaderShownContext.Provider, obj8);
  obj6[1] = closure_4(active(5276).HeaderBackContext.Provider, obj7);
  items4[1] = closure_4(closure_3, obj6);
  obj4[1] = items4;
  obj3[1] = tmp22(active(5735).ModalPresentationContext.Provider, obj4);
  obj1[29] = closure_4(closure_3, obj3);
  obj[6] = closure_4(active(5748).Card, obj1);
  return closure_4(active(5747).CardA11yWrapper, obj);
});
