...
// Module 4982 (parseItemLocationBox)
const require = arg1;
      ...
      while (true) {
        ...
        if (4 === baseOffset) {
          ...
          if (8 === baseOffset) {
            ...
            let obj4 = require(4983) /* get64BitValue */;
        ...
        if (0 < obj.extentCount) {
          while (true) {
            ...
            if (4 === tmp4) {
              ...
              if (8 === tmp4) {
                ...
                let obj7 = require(4983) /* get64BitValue */;
            ...
            if (4 === tmp5) {
              ...
              if (8 === tmp5) {
                ...
                let obj8 = require(4983) /* get64BitValue */;
          ...
          if (4 === tmp7) {
            ...
            if (8 === tmp7) {
              ...
              let obj5 = require(4983) /* get64BitValue */;
