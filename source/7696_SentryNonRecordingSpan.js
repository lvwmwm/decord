...
// Dependencies: [41, 42, 7673, 7668]

// Module 7696 (SentryNonRecordingSpan)
...
const items = [
  {
    ...
    value: function spanContext() {
      return { spanId: this._spanId, traceId: this._traceId, traceFlags: SentryNonRecordingSpan(7668).TRACE_FLAG_NONE };
    }
  },
  {
    key: "end",
