...
// Function ID: 4059
// Name: useRiveFile
// Dependencies: [5, 32, 19, 17, 4041, 4038]
// Exports: useRiveFile

// Module 4058 (useRiveFile)
        ...
        try {
          ...
          if (arg0 === 1) {
            ...
            if (null == obj5) {
              ...
              const RiveFileFactory4 = obj(4041).RiveFileFactory;
              c4 = 3;
              c5 = 1;
              ...
              if (typeof obj5 !== "Object") {
                if (!("uri" in obj5)) {
                  ...
                  if (obj5 instanceof ArrayBuffer) {
                    const RiveFileFactory = obj(4041).RiveFileFactory;
                    c4 = 5;
                    c5 = 1;
              ...
              const RiveFileFactory2 = obj(4041).RiveFileFactory;
              c4 = 4;
              c5 = 1;
