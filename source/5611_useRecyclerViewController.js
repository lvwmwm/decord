...
// Dependencies: [5612, 5569, 19, 17, 5613, 5614, 5584, 5615, 5609]
// Exports: useRecyclerViewController

// Module 5611 (useRecyclerViewController)
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  const unmountFlag = _require(5613).useUnmountFlag();
  let obj = _require(5613);
  ...
  _setTimeout = _require(5614).useUnmountAwareTimeout().setTimeout;
