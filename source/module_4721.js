// Module ID: 4721
// Function ID: 41083
// Dependencies: [65, 4722, 4723, 4724, 4725, 4726, 4719, 4718]
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    while (iter !== undefined) {
      ...
      if (hasOwnProperty2.call(require(4719).FileTypes, nextResult)) {
        let tmp9 = items;
    ...
    for (const item10070 of items) {
      ...
      let tmp39 = item10070;
      let FileTypes4 = require(4719).FileTypes;
      let tmp42 = items1;
    ...
    fileChunk = require(4718) /* getFileChunk */.getFileChunk(fileChunk, num4);
    const FileTypes2 = require(4719).FileTypes;
    ...
    if (detectSignatureResult) {
      if (items2.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes3 = require(4719).FileTypes;
