...
// Dependencies: [41, 42, 93, 95, 98, 1690, 19, 17, 21, 1657, 1708, 38, 1749, 1750, 1758, 1760, 1698, 1679, 1761, 1763, 1757, 1741, 1694, 1683, 1665, 1767, 1682, 1751, 1753, 1768, 1769, 1770, 1792, 1793]
    ...
    },
    {
      ...
      value: function _configureLayoutAnimation(EXITING, exiting, exiting2) {
        if (!isJest) {
          if (exiting !== exiting2) {
            const self = this;
            const obj = require(1768) /* updateLayoutAnimations */;
            if (obj2.isFabric()) {
