...
// Function ID: 7364
// Name: NativeModules
// Dependencies: [5, 17, 7364, 7365, 7370, 7371, 7372, 7373, 7374]
...
export const setup = () => {
  ...
  if ("STOREKIT1_MODE" === str) {
    require(7365).storekit1Mode();
    const obj4 = require(7365);
  } else if ("STOREKIT2_MODE" === str) {
    require(7365).storekit2Mode();
    const obj3 = require(7365);
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    require(7365).storekitHybridMode();
    const obj2 = require(7365);
  }
};
export const initConnection = () => {
  const nativeModule = require(7365).getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = require(7365).getAndroidModule();
