...
// Dependencies: [41, 42, 93, 95, 98, 19, 7975, 21, 7884, 7891, 7892, 7898, 7977, 7900]

// Module 7974 (_isNativeReflectConstruct)
...
let items = [
  {
    ...
    value: function render() {
      ...
      obj.x = null;
      obj.y = null;
      const tmp2Result = importDefault(7891)(obj, this);
      const merged1 = Object.assign(tmp2Result, importDefault(7898)(propsAndStylesResult, true));
      tmp2Result.ref = this.refMethod;
      obj = {};
      const tmp2 = importDefault(7891);
      const merged2 = Object.assign(tmp2Result);
      return jsx(importDefault(7977), {});
    }
  }
];
