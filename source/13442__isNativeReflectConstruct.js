...
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 13443, 8876, 4132]

// Module 13442 (_isNativeReflectConstruct)
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      const items6 = [ParallaxImage(13443).image, style, { position: "relative" }, obj];
      obj3.style = items6;
  ...
  },
  {
    ...
    get() {
      ...
      if (!tmp) {
        ...
        obj[0] = ParallaxImage(13443).loaderContainer;
  ...
  },
  {
    ...
    value: function render() {
      ...
      const items = [this.props.containerStyle, self(13443).container];
      obj[2] = items;
