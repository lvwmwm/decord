...
// Dependencies: [109, 19, 21, 1502, 1598, 1600]
// Exports: createStandardNavigationFactories

// Module 1597 (createStandardNavigationFactories)
...
export const createStandardNavigationFactories = function createStandardNavigationFactories(arg0, arg1, arg2) {
  ...
  if ("standard" !== type) {
    ...
    obj[0] = _require(1502).createNavigatorFactory(function StandardNavigationNavigator(UNSTABLE_routeNamesChangeBehavior) {
      let obj = callback(1502);
      navigationBuilder = obj.useNavigationBuilder(navigationBuilder, UNSTABLE_routeNamesChangeBehavior);
      const dependencyMap = callback(1598).useBuildHref();
      let tmp2 = callback(1600);
    ...
    const obj2 = _require(1502);
    obj[1] = _require(1502).createScreenFactory();
    return obj;
  }
};
