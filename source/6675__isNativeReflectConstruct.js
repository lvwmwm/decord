...
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 6587, 6676, 6586, 6595]

// Module 6675 (_isNativeReflectConstruct)
...
const items = [
  {
    ...
    value: function render() {
      ...
      let match = str;
      if (str) {
        match = str.match(self(6587).idPattern);
      }
      let tmp4 = match;
      if (match) {
        tmp4 = match[1];
