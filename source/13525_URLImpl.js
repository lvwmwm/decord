...
// Function ID: 13526
// Name: URLImpl
// Dependencies: [41, 42, 13526, 13530, 13529]

// Module 13525 (URLImpl)
...
class URLImpl {
  constructor(arg0, arg1) {
    ...
    if (null === basicURLParseResult1) {
      ...
      tmp7Result = require("module_13530");
      items = [];
      items[0] = str;
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(13526).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(13526).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(13529).parseUrlencoded(query);
          const tmpResult = tmp(13529);
        }
      }
      const obj = URLImpl(13526);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(13526).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
  ...
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13526).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(13526);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13526).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(13526);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(13526).serializeHost(host);
        const obj3 = URLImpl(13526);
      } else {
        const obj = URLImpl(13526);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(13526).serializeInteger(host.port)}`;
        const obj2 = URLImpl(13526);
      }
    },
    set(arg0) {
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(13526).serializeHost(tmp._url.host);
        const obj = URLImpl(13526);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(13526).serializeInteger(tmp._url.port);
        const obj = URLImpl(13526);
      }
      return str;
    },
    set(arg0) {
      ...
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        if ("" === arg0) {
          ...
          obj[0] = self._url;
          URLImpl(13526).basicURLParse(arg0, obj);
          const tmpResult = URLImpl(13526);
        }
      }
    }
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        self._query._list = URLImpl(13529).parseUrlencoded(substr);
      }
    }
  },
  {
