...
// Module 4494 (ScreenStackHeaderSubview)
...
const forwardRefResult = require("result").forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (require(4491) /* isSearchBarAvailableForCurrentPlatform */.isHeaderBarButtonsAvailableForCurrentPlatform) {
      result = require(4496) /* prepareMenu */.prepareHeaderBarButtonItems(headerLeftBarButtonItems, "left");
      const obj2 = require(4496) /* prepareMenu */;
    }
  }
  require = result;
  let result1;
  if (headerRightBarButtonItems) {
    if (require(4491) /* isSearchBarAvailableForCurrentPlatform */.isHeaderBarButtonsAvailableForCurrentPlatform) {
      result1 = require(4496) /* prepareMenu */.prepareHeaderBarButtonItems(headerRightBarButtonItems, "right");
      const obj3 = require(4496) /* prepareMenu */;
    }
  }
  let isHeaderBarButtonsAvailableForCurrentPlatform = require(4491) /* isSearchBarAvailableForCurrentPlatform */.isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj = { userInterfaceStyle: disableLeftInsetApplication.experimental_userInterfaceStyle, consumeLeftInset, consumeRightInset, consumeBottomInset, headerLeftBarButtonItems: result, headerRightBarButtonItems: result1, onPressHeaderBarButtonItem: fn, onPressHeaderBarButtonMenuItem: fn2, ref, style: closure_10.headerConfig, pointerEvents: "box-none", synchronousShadowStateUpdatesEnabled: result1(4492).experiment.synchronousHeaderConfigUpdatesEnabled };
  return jsx(result1(4497), Object.assign({}, disableLeftInsetApplication, obj));
});
...
export const ScreenStackHeaderBackButtonImage = function ScreenStackHeaderBackButtonImage(arg0) {
  const obj = { type: "back", style: closure_10.headerSubview, synchronousShadowStateUpdatesEnabled: importDefault(4492).experiment.synchronousHeaderSubviewUpdatesEnabled, children: <closure_8 {...Object.assign({ resizeMode: "center", fadeDuration: 0 }, arg0)} /> };
  return jsx(importDefault(4498), { type: "back", style: closure_10.headerSubview, synchronousShadowStateUpdatesEnabled: importDefault(4492).experiment.synchronousHeaderSubviewUpdatesEnabled, children: <closure_8 {...Object.assign({ resizeMode: "center", fadeDuration: 0 }, arg0)} /> });
};
export const ScreenStackHeaderRightView = function ScreenStackHeaderRightView(style) {
  ...
  obj.synchronousShadowStateUpdatesEnabled = importDefault(4492).experiment.synchronousHeaderSubviewUpdatesEnabled;
  const items = [closure_10.headerSubview, style.style];
  obj.style = items;
  return jsx(importDefault(4498), Object.assign({}, tmp, obj));
};
...
export const ScreenStackHeaderSearchBarView = function ScreenStackHeaderSearchBarView(arg0) {
  const obj = { type: "searchBar", synchronousShadowStateUpdatesEnabled: importDefault(4492).experiment.synchronousHeaderSubviewUpdatesEnabled, style: closure_10.headerSubview };
  return jsx(importDefault(4498), Object.assign({}, arg0, obj));
};
