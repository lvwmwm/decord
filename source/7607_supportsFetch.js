...
// Function ID: 7608
// Name: supportsFetch
// Dependencies: [7496, 7494, 7495]

// Module 7607 (supportsFetch)
const require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in require(7496) /* getGlobalSingleton */.GLOBAL_OBJ) {
    try {
...
arg5.supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    ...
    if (isNativeFunction(require(7496) /* getGlobalSingleton */.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = tmp5(7496).GLOBAL_OBJ.document;
      if (_document) {
...
arg5.supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in require(7496) /* getGlobalSingleton */.GLOBAL_OBJ;
};
