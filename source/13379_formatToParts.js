...
// Function ID: 13380
// Name: formatToParts
// Dependencies: [1281, 13357, 13380, 13375, 13381, 13377]
// Exports: default

// Module 13379 (formatToParts)
import e from "e";
import digitsToString from "digitsToString";

const regExp = new RegExp("^".concat(require("module_13380").S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(require("module_13380").S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13375).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13381).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13377).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
