...
// Function ID: 5345
// Name: RefreshControl
// Dependencies: [32, 109, 19, 17, 21, 5307, 5277, 5308]

// Module 5344 (RefreshControl)
...
const forwardRefResult = importAllResult.forwardRef((arg0, ref) => {
  ...
  const items = [];
  items[HermesBuiltin.arraySpread(require(5277) /* toArray */.toArray(waitFor), 0)] = ref;
  obj.waitFor = items;
...
export const FlatList = importAllResult.forwardRef((arg0, ref) => {
  ...
  while (tmp3 !== undefined) {
    ...
    let nativeViewProps = ref(5308).nativeViewProps;
    let tmp12 = first;
    let tmp13 = tmp9;
