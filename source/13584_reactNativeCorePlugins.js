...
// Dependencies: [5, 17, 82, 13585, 13587, 13589, 13590, 13593, 13594, 13607, 13609, 13611, 13612, 13613, 13614, 13595]

// Module 13584 (reactNativeCorePlugins)
...
import module_13593 from "module_13593";
import objectifyError from "objectifyError";
import onSend from "onSend";
import module_13609 from "module_13609";
  ...
  host: ((localhost) => {
    try {
      ...
      if (typeof scriptURL === "_iter") {
        ...
        return require(13614) /* getHostFromUrl */.getHostFromUrl(scriptURL);
      }
