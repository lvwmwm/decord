...
function getColorType(byteLength, arg1) {
  if (arg1 + 9 + 1 <= byteLength.byteLength) {
    ...
    obj = { value: byteAt, description: { "Null": "<string:410124289>", "Null": "<string:402653184>", "Null": "<string:16777216>", "Null": "<string:30798658>", "Null": "<string:46093824>" }[byteAt] || "Unknown" };
    return obj;
  }
}
...
function getInterlace(byteLength, arg1) {
  if (arg1 + 12 + 1 <= byteLength.byteLength) {
    ...
    obj = { value: byteAt, description: { <string:80557568>: null, <string:80489472>: null }[byteAt] || "Unknown" };
    return obj;
  }
}
arg5.default = {
