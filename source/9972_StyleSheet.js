...
// Function ID: 9973
// Name: StyleSheet
// Dependencies: [32, 19, 17, 21, 1501, 1632, 6350, 9973, 4676, 9974, 9976, 9977, 9978, 9979]
// Exports: NativeStackView

// Module 9972 (StyleSheet)
...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(6350).HeaderShownContext);
  let num5 = React.useContext(num6(6350).HeaderHeightContext);
  const context1 = React.useContext(num6(6350).HeaderBackContext);
  let obj3 = num6(6350);
  ...
  callback = obj2.useCallback(num6(9973).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4676).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4676).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(6350).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(6350);
  ...
  let eventResult;
  const headerConfigProps = num6(9974).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  const tmp8Result3 = num6(9974);
  obj15[1] = closure_10(num6(6350).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(6350).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = tmp38(num6(6350).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(9976).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4676).ScreenStackItem, obj4);
