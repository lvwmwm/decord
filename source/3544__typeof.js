...
export const SecondParser = (Parser) => {
  class SecondParser {
    constructor() {
      if (this instanceof SecondParser) {
        ...
        str2 = "priority";
        num2 = 50;
        tmp17 = closure_8(applyResult, "priority", 50);
  ...
  const dependencyMap = SecondParser;
  ...
  let obj = { EntryPointCommandButtonActions: null, NATIVE_SECTION: null, 1476351743: null, value: SecondParser };
