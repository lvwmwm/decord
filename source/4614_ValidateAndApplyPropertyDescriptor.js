...
// Dependencies: [4615, 4548, 541, 4595, 4599, 4612, 4602, 4603, 4604, 4605, 4616, 4617]

// Module 4614 (ValidateAndApplyPropertyDescriptor)

export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, flag, __Configurable__) {
  const tmp3 = require(4615) /* Type */(arg0);
  if (undefined !== arg0) {
    if (!tmp(4548)(arg0)) {
      ...
      if (undefined === __Set__) {
        ...
        if (tmp64) {
          if ("Undefined" === tmp3) {
            ...
            tmp66 = tmp(4612)(__Configurable__);
          }
        }
        return tmp64;
      } else {
        ...
        if (tmpResult3(obj, __Set__)) {
          if (!__Set__["[[Configurable]]"]) {
            ...
            if ("[[Enumerable]]" in __Configurable__) {
              if (!tmp(4604)(__Configurable__["[[Enumerable]]"], __Set__["[[Enumerable]]"])) {
                return false;
              }
            }
            if (!tmp(4617)(__Configurable__)) {
              const tmpResult4 = tmp(4604);
              if (!tmpResult4(tmp26, tmp(4612)(__Set__))) {
                return false;
              }
              tmp26 = tmp(4612)(__Configurable__);
            }
            if (tmp(4612)(__Set__)) {
              if ("[[Get]]" in __Configurable__) {
                if (!tmp(4604)(__Configurable__["[[Get]]"], __Set__["[[Get]]"])) {
                  return false;
                }
              }
              if ("[[Set]]" in __Configurable__) {
                if (!tmp(4604)(__Configurable__["[[Set]]"], __Set__["[[Set]]"])) {
                  return false;
                }
              }
              ...
              if ("[[Value]]" in __Configurable__) {
                if (!tmp(4604)(__Configurable__["[[Value]]"], __Set__["[[Value]]"])) {
                  return false;
                }
              }
            }
          ...
          if ("Undefined" === tmp3) {
            ...
            if (!tmp(4603)(__Set__)) {
              if (tmp(4612)(__Set__)) {
                if (tmp(4603)(__Configurable__)) {
                  ...
                  const tmpResult6 = tmp(4603);
                  const tmpResult7 = tmp(4604);
                  const tmpResult8 = tmp(4605);
                  ...
                  let tmpResult6Result = tmp(4602)(tmpResult6, tmpResult7, tmpResult8, arg0, arg1, obj);
                  const tmpResult5 = tmp(4602);
                }
              }
              const tmpResult10 = tmp(4603);
              const tmpResult9 = tmp(4602);
              tmpResult6Result = tmpResult9(tmpResult10, tmp(4604), tmp(4605), arg0, arg1, __Configurable__);
              const tmpResult11 = tmp(4604);
            }
            let tmp50 = __Set__;
            if ("[[Configurable]]" in __Configurable__) {
            ...
            const tmpResult13 = tmp(4603);
            const tmpResult14 = tmp(4604);
            const tmpResult15 = tmp(4605);
            ...
            __Set__ = __Set__["[[Set]]"];
            obj1[3] = __Set__;
            tmpResult6Result = tmp(4602)(tmpResult13, tmpResult14, tmpResult15, arg0, arg1, obj1);
            const tmpResult12 = tmp(4602);
          }
        } else {
