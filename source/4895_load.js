...
// Function ID: 4896
// Name: load
// Dependencies: [4896, 4897, 4898, 4899, 4900, 4913, 4915, 4916, 4928, 4932, 4936, 4938, 4940, 4941, 4942, 4943, 4944, 4945, 4946, 4947, 4948, 4949, 4922]
// Exports: load
  ...
  if (typeof response === "y") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(4897).dataUriToBuffer(response));
        const obj5 = response(4897);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
