...
// Function ID: 12257
// Name: QRCodeSvg
// Dependencies: [12253, 19, 8531]

// Module 12256 (QRCodeSvg)
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const element = tmp4.default.createElement(require(8531) /* inlineStyles */.Path, { d: bgD, fill: bgColor });
  return tmp4.default.createElement(require(8531) /* inlineStyles */.Svg, fn({}, obj, obj), element, tmp4.default.createElement(require(8531) /* inlineStyles */.Path, { d, fill }));
});
