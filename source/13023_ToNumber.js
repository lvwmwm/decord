...
// Function ID: 99074
// Name: ToNumber
// Dependencies: [13027, 13025, 13042]

// Module 13023 (ToNumber)
class ToNumber {
  constructor(arg0) {
    tmp = arg0;
    if ("number" === typeof arg0) {
      ...
      if (undefined === tmp) {
        ...
        tmp29 = arg6;
        num2 = 2;
        return require("GetUnsignedRoundingMode").ZERO;
      }
    }
  }
}
    ...
    if ("object" === typeof arg0) {
      ...
      if (null != arg0) {
        ...
        if (undefined !== tmp3) {
          ...
          str2 = "string";
          arr = "string" === str ? [80257857, -1190178560] : [false, false];
          num = 0;
          if (0 < arr.length) {
            while (true) {
              obj = arg0[arr[num]];
