// Module ID: 13368
// Function ID: 102266
// Dependencies: [77, 6, 7, 13369, 13370, 13377]
...
let obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(tmp, require(13369) /* wrapperForImpl */.implSymbol)) {
        if (tmp[require(undefined, 13369) /* wrapperForImpl */.implSymbol] instanceof require(13370) /* URLImpl */.implementation) {
          return true;
        }
      }
      ...
      obj = require(13369) /* wrapperForImpl */;
    }
    return false;
  },
  isImpl(getAll) {
    if (getAll) {
      if (getAll instanceof require(13370) /* URLImpl */.implementation) {
        return true;
      } else {
        const wrapperForImplResult = require(13369) /* wrapperForImpl */.wrapperForImpl(getAll);
        const _mixedIntoPredicates = module.exports._mixedIntoPredicates;
        ...
        const obj = require(13369) /* wrapperForImpl */;
      }
    }
    return false;
  },
  convert(arg0) {
    if (arguments.length > 1) {
      ...
      if (_exports.is(arg0)) {
        return require(13369) /* wrapperForImpl */.implForWrapper(arg0);
      } else {
  ...
  create(arg0, arg1, arg2) {
    if (undefined === arg0[require(undefined, 13369) /* wrapperForImpl */.ctorRegistrySymbol]) {
      const _Error2 = Error;
      const error = new Error("Internal error: invalid global object");
      throw error;
    } else {
      const _URL = arg0[require(undefined, 13369) /* wrapperForImpl */.ctorRegistrySymbol].URL;
      if (undefined === _URL) {
        const _Error = Error;
  ...
  setup(wrapper) {
    if (arguments.length > 2) {
      ...
      if (arguments.length > 3) {
        ...
        const _Object = Object;
        obj = {};
        let implementation = require(13370) /* URLImpl */.implementation;
        ...
        Object.defineProperty(wrapper, require(13369) /* wrapperForImpl */.implSymbol, obj);
        wrapper[require(undefined, 13369) /* wrapperForImpl */.implSymbol][require(13369) /* wrapperForImpl */.wrapperSymbol] = wrapper;
        if (require(13370) /* URLImpl */.init) {
          require(13370) /* URLImpl */.init(wrapper[require(undefined, 13369) /* wrapperForImpl */.implSymbol], obj);
          const obj3 = require(13370) /* URLImpl */;
        }
        return wrapper;
      }
      obj = {};
  ...
  install(arg0) {
    ...
    if (undefined === arg0[_require(undefined, 13369).ctorRegistrySymbol]) {
      let _Object = Object;
      arg0[_require(13369).ctorRegistrySymbol] = Object.create(null);
    }
    arg0[_require(undefined, 13369).ctorRegistrySymbol].URL = tmp;
