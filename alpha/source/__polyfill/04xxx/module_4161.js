// Module ID: 4161
// Function ID: 4162
// Dependencies: [4089, 4111, 4116, 4159, 3913, 4162, 4163, 4076, 3914, 3918]
// Exports: default
...
if (!module_4076) {
  const obj8 = { default: module_4076 };
  let tmp17 = obj8;
} else {
  tmp17 = module_4076;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_4076.default(defaultResult5) - module_4076.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_4076.default(defaultResult5);
    }
  } else {
