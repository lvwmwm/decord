// Module ID: 4163
// Function ID: 4164
// Dependencies: [4091, 4113, 4118, 4161, 3915, 4164, 4165, 4078, 3916, 3920]
// Exports: default
...
if (!module_4078) {
  const obj8 = { default: module_4078 };
  let tmp17 = obj8;
} else {
  tmp17 = module_4078;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_4078.default(defaultResult5) - module_4078.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_4078.default(defaultResult5);
    }
  } else {
