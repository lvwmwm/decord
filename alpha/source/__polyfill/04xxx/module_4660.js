// Module ID: 4660
// Function ID: 4661
// Dependencies: [19, 4656, 1108, 1109, 4661, 4663, 4665, 1102]
...
import parse_mod from "module_4661" /* 4661 */;
...
let module_4665 = module_4665_mod;
if (module_4665) {
  if (typeof module_4665 === "object") {
    if ("default" in module_4665) {
      module_4665 = module_4665.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F128742 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4665(fn, displayName);
};
