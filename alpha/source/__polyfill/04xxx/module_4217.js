// Module ID: 4217
// Function ID: 4218
// Dependencies: [4161, 4148, 3915, 4165, 4160, 4078, 3919, 3916, 3920, 4218, 4162, 4219]
// Exports: default

// Module 4217
import throwProtectedError from "throwProtectedError" /* 4162 */;
import parsers from "parsers" /* 4219 */;
  ...
  if (locale1.match) {
    ...
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        ...
        const defaultResult2 = module_3919.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(4218).DateToSystemTimezoneSetter();
