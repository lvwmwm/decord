...
const entry = {
  ...
  value: function parse(arg0, arg1) {
    if ("u" === arg1) {
      let parseNDigitsSignedResult = _createSuperInternal(4226).parseNDigitsSigned(4, arg0);
    } else {
      parseNDigitsSignedResult = _createSuperInternal(4226).parseNDigitsSigned(arg1.length, arg0);
    }
