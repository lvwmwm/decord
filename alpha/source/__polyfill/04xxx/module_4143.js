// Module ID: 4143
// Function ID: 4144
// Dependencies: [4093, 4144, 3911, 4145, 4156, 4074, 3915, 3912, 4157, 3916, 4158]
// Exports: default
...
if (!module_3915) {
  const obj7 = { default: module_3915 };
  let tmp15 = obj7;
} else {
  tmp15 = module_3915;
}
...
export default function format(arg0, arg1, locale) {
  ...
  if (defaultResult1 >= 1) {
    if (defaultResult1 <= 7) {
      ...
      const defaultResult2 = module_3915.default(num4);
      if (defaultResult2 >= 0) {
        if (defaultResult2 <= 6) {
          if (locale1.localize) {
            if (locale1.formatLong) {
              const defaultResult3 = _typeof.default(arg0);
              if (module_4093.default(defaultResult3)) {
                _typeof = locale1.default(defaultResult3, module_4074.default(defaultResult3));
