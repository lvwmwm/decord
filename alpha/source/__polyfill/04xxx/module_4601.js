// Module ID: 4601
// Function ID: 4602
// Dependencies: [32, 19, 4583, 4596, 4591]
...
const RiveColor2 = tmp(4591);
require = fn;
fn(19).useCallback;
const f30702 = (colorProperty, arg1) => colorProperty.colorProperty(arg1);

export const useRiveColor = function useRiveColor(FillColor, instance) {
  const cResult = c.c(8);
  const tmp4 = _slicedToArray(_mod4596.useRiveProperty(instance, FillColor, f30702), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
