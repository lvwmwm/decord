// Module ID: 4655
// Function ID: 4656
// Dependencies: [19, 4656, 1108, 1109, 1102, 4659]
...
export const MemoryRouter = Component2(4659).MemoryRouter;
export const Prompt = Component2(4659).Prompt;
export const Redirect = Component2(4659).Redirect;
export const Route = Component2(4659).Route;
export const Router = Component2(4659).Router;
export const StaticRouter = Component2(4659).StaticRouter;
export const Switch = Component2(4659).Switch;
export const generatePath = Component2(4659).generatePath;
export const matchPath = Component2(4659).matchPath;
export const useHistory = Component2(4659).useHistory;
export const useLocation = Component2(4659).useLocation;
export const useParams = Component2(4659).useParams;
export const useRouteMatch = Component2(4659).useRouteMatch;
export const withRouter = Component2(4659).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4659).matchPath(_location.pathname, obj2);
          const obj = Component2(4659);
        }
