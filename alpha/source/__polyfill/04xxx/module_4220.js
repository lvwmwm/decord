// Module ID: 4220
// Function ID: 4221
// Dependencies: [4164, 4151, 3918, 4168, 4163, 4081, 3922, 3919, 3923, 4221, 4165, 4222]
// Exports: default

// Module 4220
import throwProtectedError from "throwProtectedError" /* 4165 */;
import parsers from "parsers" /* 4222 */;
  ...
  if (locale1.match) {
    ...
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        ...
        const defaultResult2 = module_3922.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(4221).DateToSystemTimezoneSetter();
