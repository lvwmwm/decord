// Module ID: 4060
// Function ID: 4061
// Dependencies: [4061, 4062, 3913, 3914, 3917]
// Exports: default
...
export default function add(arg0, years) {
  ...
  if (years) {
    if ("object" === _typeof(years)) {
      ...
      if (num2) {
        let defaultResult2 = module_4062.default(defaultResult1, num2 + 12 * num);
      } else {
        defaultResult2 = defaultResult1;
      }
      if (num4) {
        let defaultResult3 = module_4061.default(defaultResult2, num4 + 7 * num3);
      } else {
