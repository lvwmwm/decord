// Module ID: 4169
// Function ID: 4170
// Dependencies: [4081, 4094, 3918, 4167, 4168, 4164, 3919, 3923]
// Exports: default
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_4081.default(defaultResult5) - module_4081.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_4081.default(defaultResult5);
    }
  } else {
