// Module ID: 12362
// Function ID: 12363
// Dependencies: [5, 12339, 12342, 12349]
    ...
    function getTransport(arg0, arg1) {
      ...
      if (value) {
        ...
        if (dsnFromStringResult) {
          let merged = tunnel;
          const envelopeEndpointWithUrlEncodedAuth = tmp4(12349).getEnvelopeEndpointWithUrlEncodedAuth(dsnFromStringResult, tunnel.tunnel);
          let tmp9 = tunnel;
          let obj3 = {};
          if (arg1) {
