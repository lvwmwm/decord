// Module ID: 12391
// Function ID: 12392
// Dependencies: [12291, 12294, 12296, 12322, 12300, 12323, 12295, 12392, 12309, 12329, 12330]
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (client) {
    ...
    let rootSpan;
    if (activeSpan) {
      rootSpan = tmp3(12300).getRootSpan(activeSpan);
      const tmp3Result = tmp3(12300);
    }
    let description = rootSpan;
    if (rootSpan) {
      description = tmp3(12300).spanToJSON(rootSpan).description;
      const tmp3Result3 = tmp3(12300);
    }
    ...
    if (_mod12323.DEBUG_BUILD) {
      const logger = tmp3(12295).logger;
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      ...
      const obj = require("module_12309");
