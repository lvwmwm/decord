...
export const createEventEnvelopeHeaders = function createEventEnvelopeHeaders(event_id, sdk, arg2, arg3) {
  ...
  let tmp4 = arg2 && arg3;
  if (tmp4) {
    const obj3 = { dsn: _mod12360.dsnToString(arg3) };
    tmp4 = obj3;
  }
...
export const parseEnvelope = function parseEnvelope(arr) {
  if (typeof arr !== "string") {
    function readJson() {
      ...
      if (_mod12314.GLOBAL_OBJ.__SENTRY__) {
        if (tmp3(12314).GLOBAL_OBJ.__SENTRY__.decodePolyfill) {
  ...
  function append(json) {
    if (typeof sum === "string") {
      if (typeof json === "string") {
        ...
        if (_mod12314.GLOBAL_OBJ.__SENTRY__) {
          if (tmp14(12314).GLOBAL_OBJ.__SENTRY__.encodePolyfill) {
            const __SENTRY__2 = tmp14(12314).GLOBAL_OBJ.__SENTRY__;
