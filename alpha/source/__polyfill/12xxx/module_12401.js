// Module ID: 12401
// Function ID: 12402
// Dependencies: [5, 12291, 12294, 12295, 12323, 12309, 12319, 12343, 12322, 12340, 12329, 12310]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(12322).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(12340);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(12340);
        ...
        closure_0(12322).withScope((setContext) => {
