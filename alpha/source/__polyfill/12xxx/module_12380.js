// Module ID: 12380
// Function ID: 12381
// Dependencies: [5, 12357, 12360, 12367]
    ...
    function getTransport(arg0, arg1) {
      ...
      if (value) {
        ...
        if (dsnFromStringResult) {
          let merged = tunnel;
          const envelopeEndpointWithUrlEncodedAuth = tmp4(12367).getEnvelopeEndpointWithUrlEncodedAuth(dsnFromStringResult, tunnel.tunnel);
          let tmp9 = tunnel;
          let obj3 = {};
          if (arg1) {
