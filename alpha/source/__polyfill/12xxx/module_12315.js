// Module ID: 12315
// Function ID: 12316
// Dependencies: [41, 42, 12316, 12302, 12313, 12321]
...
function withScope(arg0) {
  const mainCarrier = AsyncContextStack(12313).getMainCarrier();
  const obj = AsyncContextStack(12313);
  const sentryCarrier = AsyncContextStack(12313).getSentryCarrier(mainCarrier);
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = tmp(12321).getDefaultCurrentScope();
    const tmpResult = tmp(12321);
    stack = new _moduleResult(defaultCurrentScope, tmp(12321).getDefaultIsolationScope());
    const tmpResult2 = tmp(12321);
  }
...
function withIsolationScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = tmp(12321).getDefaultCurrentScope();
    const tmpResult = tmp(12321);
    stack = new closure_3(defaultCurrentScope, tmp(12321).getDefaultIsolationScope());
    const tmpResult2 = tmp(12321);
  }
  sentryCarrier.stack = stack;
  return stack.withScope(() => {
    ...
    let stack = sentryCarrier.stack;
    if (!stack) {
      const defaultCurrentScope = tmp2(12321).getDefaultCurrentScope();
      const tmp2Result = tmp2(12321);
      stack = new closure_2_3(defaultCurrentScope, tmp2(12321).getDefaultIsolationScope());
      const tmp2Result2 = tmp2(12321);
    }
    sentryCarrier.stack = stack;
...
export function getStackAsyncContextStrategy() {
  return {
    ...
    withSetIsolationScope(arg0, arg1) {
      closure_0 = arg1;
      let mainCarrier = closure_0(12313).getMainCarrier();
      let obj = closure_0(12313);
      let sentryCarrier = closure_0(12313).getSentryCarrier(mainCarrier);
      let stack = sentryCarrier.stack;
      if (!stack) {
        let defaultCurrentScope = tmp(12321).getDefaultCurrentScope();
        const tmpResult = tmp(12321);
        stack = new closure_3(defaultCurrentScope, tmp(12321).getDefaultIsolationScope());
        const tmpResult2 = tmp(12321);
      }
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = tmp(12321).getDefaultCurrentScope();
        const tmpResult = tmp(12321);
        stack = new closure_1_3(defaultCurrentScope, tmp(12321).getDefaultIsolationScope());
        const tmpResult2 = tmp(12321);
      }
      sentryCarrier.stack = stack;
