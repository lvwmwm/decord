// Module ID: 12406
// Function ID: 12407
// Dependencies: [32, 5, 12293, 12407, 12301, 12296, 12309, 12302]
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod12293.addHandler("fetch-body-resolved", arg0);
        ...
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(12293);
                    obj5.endTimestamp = 1000 * stack(12309).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(12309);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            if (tmp5) {
              ...
              const result = tmp(12301).addNonEnumerableProperty(error, "framesToPop", 1);
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_12293").addHandler("fetch", arg0);
