// Module ID: 12400
// Function ID: 12401
// Dependencies: [718, 12291, 12294, 12295, 12309, 12319, 12323, 12327, 12377, 12300, 12329, 12310, 12328, 12366, 12312, 12308, 12302]
...
import "module_12294";
import consoleSandbox from "module_12295" /* 12295 */;
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  const traceData = _mod12366.getTraceData({ span });
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = tmp(12302).isInstanceOf(headers, Request);
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = tmp(12302).isInstanceOf(headers, Headers);
        const tmpResult2 = tmp(12302);
      }
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData, fn, fn2, arg3) {
  ...
  if (fetchData.fetchData) {
    ...
    let hasTracingEnabledResult = _mod12327.hasTracingEnabled();
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12312).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12312);
            } else if (endResult.error) {
              const obj2 = { code: setHttpStatus(12312).SPAN_STATUS_ERROR, message: "internal_error" };
    ...
    if (tmp7) {
      const host = setHttpStatus(12377).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(12377);
    }
    const activeSpan = setHttpStatus(12300).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj4[setHttpStatus(12310).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj4[setHttpStatus(12310).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj3.attributes = obj4;
        let startInactiveSpanResult = setHttpStatus(12329).startInactiveSpan(obj3);
        const setHttpStatusResult4 = setHttpStatus(12329);
      }
      ...
      if (fn2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12327);
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12328).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12300);
  }
};
