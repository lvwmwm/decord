// Module ID: 1636
// Function ID: 1637
// Dependencies: [5, 32, 19, 17, 21, 1637, 1638, 1628, 1827, 1829, 1830, 1831]
...
const controlEdgeToEdgeValues = fn(1637);
let closure_12 = controlEdgeToEdgeValues.isEdgeToEdge();
let closure_13 = cancelAnimation.createAnimatedComponent(Animated.createAnimatedComponent(fn(1628).KeyboardControllerView));
...
export const KeyboardProvider = (enabled) => {
  ...
  closure_4 = require("module_1827").useAnimatedValue(0);
  let obj = require("module_1827");
  closure_5 = require("module_1827").useAnimatedValue(0);
  let obj2 = require("module_1827");
  ...
  Animated = require("module_1827").useEventHandlerRegistration(tmp3);
  const obj6 = require("module_1827");
  const obj7 = require("module_1827");
  ...
  let items = [enabled];
  const setInputHandlers = require("module_1827").useEventHandlerRegistration(tmp3);
  ...
  const obj9 = require("module_1829");
  const animatedKeyboardHandler = require("module_1829").useAnimatedKeyboardHandler(obj10, []);
  ...
  const obj11 = require("module_1829");
  closure_5(() => {
    if (closure_0) {
  ...
  obj14.onFocusedInputLayoutChangedReanimated = require("module_1829").useFocusedInputLayoutHandler(obj12, []);
