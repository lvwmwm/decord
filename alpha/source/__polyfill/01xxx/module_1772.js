  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function e(originX) {
        ...
        const withTimingResult = delayFunction(1710).withTiming(reversed ? originX.currentOriginX : originX.targetOriginX, obj);
        size.originX = delayFunction(delay, obj2.withSequence(withTimingResult, delayFunction(1710).withTiming(originX.targetOriginX, obj)));
        const tmp3Result = delayFunction(1710);
        const tmp3Result10 = delayFunction(1710);
        const tmp3Result11 = delayFunction(1710);
        const withTimingResult1 = delayFunction(1710).withTiming(reversed ? originX.targetOriginY : originX.currentOriginY, obj);
        size.originY = delayFunction(delay, tmp3Result10.withSequence(withTimingResult1, delayFunction(1710).withTiming(originX.targetOriginY, obj)));
        const tmp3Result12 = delayFunction(1710);
        const tmp3Result13 = delayFunction(1710);
        const tmp3Result14 = delayFunction(1710);
        const withTimingResult2 = delayFunction(1710).withTiming(reversed ? originX.currentWidth : originX.targetWidth, obj);
        size.width = delayFunction(delay, tmp3Result13.withSequence(withTimingResult2, delayFunction(1710).withTiming(originX.targetWidth, obj)));
        const tmp3Result15 = delayFunction(1710);
        const tmp3Result16 = delayFunction(1710);
        const tmp3Result17 = delayFunction(1710);
        const withTimingResult3 = delayFunction(1710).withTiming(reversed ? originX.targetHeight : originX.currentHeight, obj);
        size.height = delayFunction(delay, tmp3Result16.withSequence(withTimingResult3, delayFunction(1710).withTiming(originX.targetHeight, obj)));
        obj.animations = size;
        obj.callback = callbackV;
        return obj;
      };
      fn.__closure = { delayFunction, delay, withSequence: SequencedTransition(1710).withSequence, withTiming: SequencedTransition(1710).withTiming, reverse: reversed, config, callback: callbackV };
