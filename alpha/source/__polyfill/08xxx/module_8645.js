// Module ID: 8645
// Function ID: 8646
// Dependencies: [19, 17, 21, 113, 8646, 39, 38, 8648, 8649]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8648").container, require("module_8648").webView, style];
  const items4 = [require("module_8648").container, containerStyle];
