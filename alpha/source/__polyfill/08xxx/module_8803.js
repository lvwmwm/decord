// Module ID: 8803
// Function ID: 8804
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8745, 8804, 8747, 8756]
...
_inherits(SvgImage, _modDef8756);
const entry = {
  key: "render",
  value: function render() {
    ...
    const size = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: SvgImage(8745).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
    [tmp2, tmp3] = parts;
    const tmp6 = SvgImage(8745).meetOrSliceTypes[tmp3] || 0;
    size.align = SvgImage(8745).alignEnum[tmp2] || "xMidYMid";
    ...
    const tmp7 = SvgImage(8745).alignEnum[tmp2] || "xMidYMid";
    const merged = Object.assign(SvgImage(8747).withoutXY(this, props));
