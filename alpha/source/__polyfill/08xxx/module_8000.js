// Module ID: 8000
// Function ID: 8001
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7909, 7916, 7917, 7923, 8001, 7925]
...
class TSpan {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const propsAndStylesResult = TSpan(7916).propsAndStyles(matrix);
      const obj = TSpan(7916);
      const merged = Object.assign(propsAndStylesResult, TSpan(7917).pickNotNil(extractFontDefault(propsAndStylesResult, false)));
      if (closure_0.root) {
...
_inherits(TSpan, _modDef7925);
const entry = {
  key: "render",
  value: function render() {
    const propsAndStylesResult = TSpan(7916).propsAndStyles(this.props);
    const obj2 = {};
    const obj = TSpan(7916);
