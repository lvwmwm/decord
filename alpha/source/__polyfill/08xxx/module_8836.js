// Module ID: 8836
// Function ID: 8837
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8748, 8837, 8747, 8756]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8748).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8747).withoutXY(this, props));
