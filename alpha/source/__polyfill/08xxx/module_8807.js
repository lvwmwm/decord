// Module ID: 8807
// Function ID: 8808
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8808, 8809, 8810, 8811, 8815, 8816, 8817, 8827]
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8808).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8808).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8827);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8811).extractTransformSvgView(tmp);
      const obj3 = Svg(8811);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8816)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8817, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8815, {});
  }
};
let items = [entry];
