// Module ID: 8818
// Function ID: 8819
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8740, 8810, 8819, 8745, 8756]
...
const entry = {
  ...
  value: function render() {
    ...
    const tmp3Result = Pattern(8740)(patternTransform);
    ...
    if (patternContentUnits) {
      num2 = tmp(8810)[patternContentUnits];
    }
    ...
    const tmp3 = Pattern(8740);
    const merged = Object.assign(size);
    const merged1 = Object.assign(tmp(8745)({ viewBox, preserveAspectRatio }));
    obj.children = children;
    return jsx(Pattern(8819), {
      ref(arg0) {
        return self.refMethod(arg0);
      }
    });
