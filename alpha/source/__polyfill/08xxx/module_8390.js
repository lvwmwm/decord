// Module ID: 8390
// Function ID: 8391
// Dependencies: [8391, 8457, 8458, 8461, 8460, 8462, 8410, 8454, 8463, 8401, 8459, 8464]

// Module 8390
import ar from "ar" /* 8401 */;
import _mod8410 from "module_8410" /* 8410 */;
import _mod8457 from "module_8457" /* 8457 */;
import lt from "lt" /* 8458 */;
import _mod8460 from "module_8460" /* 8460 */;
import _mod8461 from "module_8461" /* 8461 */;
import _mod8462 from "module_8462" /* 8462 */;
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.core = fn(require("module_8391"));
    fn2(_mod8457, exports);
    fn2(lt, exports);
    fn2(_mod8461, exports);
    fn2(_mod8460, exports);
    fn2(_mod8462, exports);
    require("module_8391").config(fn3(_mod8410).default());
    const _Object4 = Object;
    let obj = {
      enumerable: true,
      get() {
            return require("module_8391").globalRegistry;
          }
    };
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_8391").registry;
          }
    };
    ...
    const obj4 = {
      enumerable: true,
      get() {
            return require("module_8391").$output;
          }
    };
    ...
    const obj5 = {
      enumerable: true,
      get() {
            return require("module_8391").$input;
          }
    };
    ...
    const obj7 = {
      enumerable: true,
      get() {
            return require("module_8391").clone;
          }
    };
    ...
    const obj8 = {
      enumerable: true,
      get() {
            return require("module_8391").regexes;
          }
    };
    ...
    const obj9 = {
      enumerable: true,
      get() {
            return require("module_8391").treeifyError;
          }
    };
    ...
    const obj10 = {
      enumerable: true,
      get() {
            return require("module_8391").prettifyError;
          }
    };
    ...
    const obj11 = {
      enumerable: true,
      get() {
            return require("module_8391").formatError;
          }
    };
    ...
    const obj12 = {
      enumerable: true,
      get() {
            return require("module_8391").flattenError;
          }
    };
    ...
    const obj13 = {
      enumerable: true,
      get() {
            return require("module_8391").TimePrecision;
          }
    };
    ...
    const obj14 = {
      enumerable: true,
      get() {
            return require("module_8391").util;
          }
    };
    ...
    const obj15 = {
      enumerable: true,
      get() {
            return require("module_8391").NEVER;
          }
    };
    ...
    const obj18 = {
      enumerable: true,
      get() {
            return require("module_8459").ZodISODateTime;
          }
    };
    ...
    const obj19 = {
      enumerable: true,
      get() {
            return require("module_8459").ZodISODate;
          }
    };
    ...
    const obj20 = {
      enumerable: true,
      get() {
            return require("module_8459").ZodISOTime;
          }
    };
    ...
    const obj21 = {
      enumerable: true,
      get() {
            return require("module_8459").ZodISODuration;
          }
    };
    Object.defineProperty(exports, "ZodISODuration", obj21);
    exports.iso = fn(require("module_8459"));
    exports.coerce = fn(_mod8464);
  } else {
