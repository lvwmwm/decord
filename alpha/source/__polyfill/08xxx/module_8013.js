// Module ID: 8013
// Function ID: 8014
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7925, 8014, 7924, 7933]

// Module 8013
import _possibleConstructorReturnDefault from "_possibleConstructorReturn" /* 93 */;
import _modDef7933 from "module_7933" /* 7933 */;
import _modDef8014 from "module_8014" /* 8014 */;
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(7925).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(7924).withoutXY(this, props));
