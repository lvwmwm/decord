// Module ID: 8907
// Function ID: 8908
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8819, 8908, 8818, 8827]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8819).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8818).withoutXY(this, props));
