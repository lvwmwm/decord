// Module ID: 8909
// Function ID: 8910
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8815, 8823, 8829, 8822, 8910, 8906, 8831]
...
class TextPath {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(matrix, TextPath(8823).pickNotNil(extractFontDefault(matrix, true)));
      if (closure_0.root) {
...
_inherits(TextPath, _modDef8831);
const entry = {
  key: "render",
  value: function render() {
    ...
    let match = href;
    if (href) {
      match = href.match(TextPath(8823).idPattern);
    }
    let tmp5 = match;
    if (match) {
      tmp5 = match[1];
    ...
    if (tmp5) {
      const withoutXYResult = TextPath(8822).withoutXY(self, tmp);
      ...
      const obj5 = {};
      const obj2 = TextPath(8822);
      const merged1 = Object.assign(withoutXYResult);
      return jsx(_modDef8910, {});
    } else {
      ...
      return jsx(_modDef8906, { ref: self.refMethod, children });
    }
