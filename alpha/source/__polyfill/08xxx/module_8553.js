// Module ID: 8553
// Function ID: 8554
// Dependencies: [8554, 32, 109, 19, 17, 8555, 21, 8557, 8558, 8559]
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = obj6.jsx(tmp24(8559).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
