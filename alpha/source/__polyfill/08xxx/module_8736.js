// Module ID: 8736
// Function ID: 8737
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8737, 8738, 8739, 8740, 8744, 8745, 8746, 8756]

// Module 8736
import extractOpacityDefault from "extractOpacity" /* 8738 */;
import extractResponderDefault from "extractResponder" /* 8739 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8737).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8737).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8756);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8740).extractTransformSvgView(tmp);
      const obj3 = Svg(8740);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8745)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8746, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8744, {});
  }
};
let items = [entry];
