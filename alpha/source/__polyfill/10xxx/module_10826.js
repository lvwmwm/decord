// Module ID: 10826
// Function ID: 10827
// Dependencies: [41, 42, 93, 95, 98, 10774, 10820, 10775, 10781]
...
const regExp = new RegExp("(?:am\\s*?)?(?:den\\s*?)?([0-9]{1,2})\\.(?:\\s*(?:bis(?:\\s*(?:am|zum))?|\\-|\\\u2013|\\s)\\s*([0-9]{1,2})\\.?)?\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10820.MONTH_DICTIONARY) + ")(?:(?:-|/|,?\\s*)(" + _mod10820.YEAR_PATTERN + "(?![^\\s]\\d)))?(?=\\W|$)", "i");
