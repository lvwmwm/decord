// Module ID: 10951
// Function ID: 10952
// Dependencies: [41, 42, 93, 95, 98, 10943, 10777, 10781]
...
const regExp = new RegExp("(" + _mod10943.TIME_UNITS_PATTERN + ")\\s{0,5}(?:dopo|pi\u00F9 tardi|da adesso|avanti|oltre|a seguire)(?=(?:\\W|$))", "i");
const regExp1 = new RegExp("(" + _mod10943.TIME_UNITS_PATTERN + ")(dopo|pi\u00F9 tardi)(?=(?:\\W|$))", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ParsingComponents.createRelativeFromReference(reference.reference, ENTimeUnitLaterFormatParser(10943).parseDuration(arg1[1]));
    }
  }
];
