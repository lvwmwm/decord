// Module ID: 10847
// Function ID: 10848
// Dependencies: [41, 42, 93, 95, 98, 10842, 10780, 10782, 10783, 10787]
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      let num = 1;
      if (arg1[1]) {
        num = FRTimeUnitAgoFormatParser(10842).parseNumberPattern(arg1[1]);
      }
      const obj = {};
      obj[FRTimeUnitAgoFormatParser(10842).TIME_UNIT_DICTIONARY[arg1[3].toLowerCase(arg1[3])]] = num;
