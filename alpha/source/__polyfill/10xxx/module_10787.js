// Module ID: 10787
// Function ID: 10788
// Dependencies: [41, 42, 93, 95, 96, 98, 10779, 10788]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10779).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10779).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
