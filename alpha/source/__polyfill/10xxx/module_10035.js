// Module ID: 10035
// Function ID: 10036
// Dependencies: [41, 42, 93, 95, 98, 10028, 9887, 9891]
...
const entry = {
  ...
  value: function innerPattern() {
    const regExp = new RegExp("(?:en|por|durante|de|dentro de)\\s*(" + ESTimeUnitWithinFormatParser(10028).TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
    return regExp;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      const ParsingComponents = ESTimeUnitWithinFormatParser(9887).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, ESTimeUnitWithinFormatParser(10028).parseDuration(arg1[1]));
    }
  }
];
