// Module ID: 10000
// Function ID: 10001
// Dependencies: [41, 42, 93, 95, 98, 9999, 9886, 9891]
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (isNaN(num)) {
        num = ZHHantDeadlineFormatParser(9999).zhStringToNumber(index[1]);
      }
      if (isNaN(num)) {
        num = 3;
        if ("\u5E7E" !== index[1]) {
      ...
      if (index[2][0].match(/[日天星禮月年]/)) {
        if ("\u65E5" != str3) {
          ...
          const addDurationResult = ZHHantDeadlineFormatParser(9886).addDuration(createParsingResult.refDate, obj);
        ...
        const addDurationResult1 = ZHHantDeadlineFormatParser(9886).addDuration(createParsingResult.refDate, obj);
