// Module ID: 10711
// Function ID: 10712
// Dependencies: [41, 42, 93, 95, 96, 98, 10703, 10712]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10703).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10703).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
