...
export const useIAP = () => {
  const iAPContext = require("module_10519").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_10504").requestPurchase,
    requestSubscription: require("module_10504").requestSubscription
  };
};
