// Module ID: 10885
// Function ID: 10886
// Dependencies: [41, 42, 93, 95, 98, 10698, 10886, 10725, 10705]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:p\u00E5\\s*?)?(?:(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10886.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*vecka)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return SVWeekdayParser(10725).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10886).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
