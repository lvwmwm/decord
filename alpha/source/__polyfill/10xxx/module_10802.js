// Module ID: 10802
// Function ID: 10803
// Dependencies: [41, 42, 93, 95, 98, 10774, 10773, 10777, 10781]
...
const regExp = new RegExp("(this|last|past|next|after\\s*this)\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10773.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp3 = ENRelativeDateFormatParser(10773).TIME_UNIT_DICTIONARY[str3];
      if ("next" != formatted) {
