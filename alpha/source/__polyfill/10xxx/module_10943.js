// Module ID: 10943
// Function ID: 10944
// Dependencies: [41, 42, 93, 95, 98, 10804, 10786, 10936]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    _inherits(UKCasualTimeParser, _mod10936.AbstractParserWithLeftRightBoundaryChecking);
    const entry = {
                      ...
                      if (!str2.endsWith("\u0437\u0440\u0430\u043D\u043A\u0443")) {
                        if (str2.endsWith("\u043E\u043F\u0456\u0432\u0434\u043D\u0456")) {
                          ...
                          if (str2.match(/наступної\s*ночі/)) {
                            ...
                            UKCasualTimeParser(10786).assignSimilarDate(parsingComponents, date);
