// Module ID: 10867
// Function ID: 10868
// Dependencies: [41, 42, 93, 95, 96, 98, 10686, 10706]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10686).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10686).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
