...
const regExp = new RegExp("(dit|deze|vorig|afgelopen|(?:aan)?komend|over|\\+|-)e?\\s*(" + _mod10874.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const parseDurationResult = NLTimeUnitCasualRelativeFormatParser(10874).parseDuration(arg1[2]);
      if ("vorig" !== formatted) {
