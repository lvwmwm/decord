// Module ID: 10825
// Function ID: 10826
// Dependencies: [41, 42, 93, 95, 98, 10780, 10826, 10807, 10787]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:a[mn]\\s*?)?(?:(diese[mn]|letzte[mn]|n(?:\u00E4|ae)chste[mn])\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10826.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(diese|letzte|n(?:\u00E4|ae)chste)\\s*woche)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return DEWeekdayParser(10807).createParsingComponentsAtWeekday(reference.reference, DEWeekdayParser(10826).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
