// Module ID: 10841
// Function ID: 10842
// Dependencies: [41, 42, 93, 95, 98, 10836, 10774, 10776, 10777, 10781]
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      let num = 1;
      if (arg1[1]) {
        num = FRTimeUnitAgoFormatParser(10836).parseNumberPattern(arg1[1]);
      }
      const obj = {};
      obj[FRTimeUnitAgoFormatParser(10836).TIME_UNIT_DICTIONARY[arg1[3].toLowerCase(arg1[3])]] = num;
      ...
      if (formatted) {
        ...
        if (isMatch) {
          reverseDurationResult = tmp3(10776).reverseDuration(obj);
        }
        const ParsingComponents = tmp3(10777).ParsingComponents;
