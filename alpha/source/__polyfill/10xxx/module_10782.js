// Module ID: 10782
// Function ID: 10783
// Dependencies: [41, 42, 93, 95, 98, 10773, 10774, 10775, 10781]
...
const regExp = new RegExp("(?:on\\s{0,3})?(" + _mod10773.ORDINAL_NUMBER_PATTERN + ")(?:\\s{0,3}(?:to|\\-|\\\u2013|until|through|till)?\\s{0,3}(" + _mod10773.ORDINAL_NUMBER_PATTERN + "))?(?:-|/|\\s{0,3}(?:of)?\\s{0,3})(" + repeatedTimeunitPattern.matchAnyPattern(_mod10773.MONTH_DICTIONARY) + ")(?:(?:-|/|,?\\s{0,3})(" + _mod10773.YEAR_PATTERN + "(?!\\w)))?(?=\\W|$)", "i");
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10773).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = tmp2(10773).parseOrdinalNumberPattern(index[2]);
