// Module ID: 10966
// Function ID: 10967
// Dependencies: [10776, 10783, 10785, 10809, 10821, 10967, 10969, 10970, 10971, 10816]
...
fn(_mod10969);
fn(_mod10970);
const _isNativeReflectConstruct = fn(_mod10971);
...
obj7.parsers = items;
obj7.refiners = [];
const chrono1 = new require("module_10776").Chrono(includeCommonConfiguration.includeCommonConfiguration(obj7, true));
