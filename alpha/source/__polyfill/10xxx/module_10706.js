// Module ID: 10706
// Function ID: 10707
// Dependencies: [41, 42, 93, 95, 98, 10697, 10698, 10699, 10705]
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10697).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = tmp2(10697).parseOrdinalNumberPattern(index[2]);
