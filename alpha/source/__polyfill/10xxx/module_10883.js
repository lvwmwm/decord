// Module ID: 10883
// Function ID: 10884
// Dependencies: [41, 42, 93, 95, 98, 10867, 10700, 10701, 10717]
...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, text, start) {
      const parseDurationResult = ENMergeRelativeDateRefiner(10867).parseDuration(text.text);
      ...
      return new ENMergeRelativeDateRefiner(10701).ParsingResult(start.reference, text.index, "" + text.text + arg0 + start.text, relativeFromReference);
    }
  }
];
