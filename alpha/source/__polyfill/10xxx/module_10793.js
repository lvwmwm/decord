// Module ID: 10793
// Function ID: 10794
// Dependencies: [41, 42, 93, 95, 96, 98, 10785, 10794]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10785).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10785).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
