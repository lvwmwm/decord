// Module ID: 10793
// Function ID: 10794
// Dependencies: [41, 42, 93, 95, 98, 10698, 10792, 10725, 10705]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:op\\s*?)?(?:(deze|vorige|volgende)\\s*(?:week\\s*)?)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10792.WEEKDAY_DICTIONARY) + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return NLWeekdayParser(10725).createParsingComponentsAtWeekday(reference.reference, NLWeekdayParser(10792).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
