// Module ID: 10725
// Function ID: 10726
// Dependencies: [10701, 10703]
// Exports: createParsingComponentsAtWeekday, getBackwardDaysToWeekday, getDaysForwardToWeekday, getDaysToWeekdayClosest

// Module 10725
import ReferenceWithTimezone from "ReferenceWithTimezone" /* 10701 */;
import Meridiem from "Meridiem" /* 10703 */;
...
function getDaysToWeekday(dateWithAdjustedTimezone, sum, next) {
  ...
  if ("this" === next) {
    ...
    if (day == Meridiem.Weekday.SUNDAY) {
      let num12 = 7;
      if (sum != tmp6(10703).Weekday.SUNDAY) {
        num12 = sum;
      }
      let sum3 = num12;
    } else if (day == tmp6(10703).Weekday.SATURDAY) {
      let num9 = 7;
      if (sum != tmp6(10703).Weekday.SATURDAY) {
        let num10 = 8;
        if (sum != tmp6(10703).Weekday.SUNDAY) {
          num10 = 1 + sum;
        }
