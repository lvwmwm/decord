// Module ID: 10873
// Function ID: 10874
// Dependencies: [41, 42, 93, 95, 96, 98, 10692, 10712]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10692).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10692).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
