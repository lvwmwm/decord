...
export const useIAP = () => {
  const iAPContext = require("module_10530").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_10515").requestPurchase,
    requestSubscription: require("module_10515").requestSubscription
  };
};
