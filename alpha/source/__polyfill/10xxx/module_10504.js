// Module ID: 10504
// Function ID: 10505
// Dependencies: [5, 17, 10505, 10506, 10511, 10512, 10513, 10514, 10515]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 10512 */;
import _modAll10513 from "module_10513" /* 10513 */;
import _modAll10514 from "module_10514" /* 10514 */;
import syncAll from "sync" /* 10515 */;
...
const subs = fn(10505).ProductType.subs;
const inapp = fn(10505).ProductType.inapp;
...
export const IapAndroid = _modAll10513;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll10514;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(10506).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod10506.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod10506.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod10506.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod10506.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod10506.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(10506).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(10511).singleProductAndroidMap);
      return tmp2(10506).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(10506).getAndroidModuleType();
      const androidModule = tmp2(10506).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(10505).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(10506).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(10505).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(10506).getAndroidModule();
            ...
            const androidModule1 = v3(10506).getAndroidModule();
