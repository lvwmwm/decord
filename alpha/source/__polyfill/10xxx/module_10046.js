// Module ID: 10046
// Function ID: 10047
// Dependencies: [41, 42, 93, 95, 98, 10040, 10041]
// Exports: Chi, Maj
...
const entry = {
  ...
  value: function update(B) {
    let tmp8;
    const self = this;
    HashMD(10041).exists(this);
    ({ buffer, blockLen, view } = this);
    const toBytesResult = HashMD(10040).toBytes(B);
    let num = 0;
...
let items = [
  entry,
  {
    ...
    value: function digestInto(content) {
      const self = this;
      HashMD(10041).exists(this);
      HashMD(10041).output(content, this);
      this.finished = true;
      ...
      self.process(view, 0);
      const view1 = HashMD(10040).createView(content);
