// Module ID: 10692
// Function ID: 10693
// Dependencies: [10693, 10694, 10701, 10703, 10741, 10753, 10766, 10777, 10786, 10804, 10825, 10840, 10850, 10865, 10884]

// Module 10692
import Chrono from "Chrono" /* 10693 */;
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_10694").ParsingContext;
          }
    };
    ...
    exports.de = fn(_mod10741);
    exports.fr = fn(_mod10753);
    exports.ja = fn(_mod10766);
    exports.pt = fn(_mod10777);
    exports.nl = fn(_mod10786);
    exports.zh = fn(_mod10804);
    exports.ru = fn(_mod10825);
    exports.es = fn(_mod10840);
    exports.uk = fn(_mod10850);
    exports.it = fn(_mod10865);
    exports.sv = fn(_mod10884);
