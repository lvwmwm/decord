// Module ID: 10796
// Function ID: 10797
// Dependencies: [41, 42, 93, 95, 98, 10779, 10783, 10787]
...
const regExp = new RegExp("(" + _mod10779.TIME_UNITS_PATTERN + ")\\s{0,5}(?:later|after|from now|henceforth|forward|out)(?=(?:\\W|$))", "i");
const regExp1 = new RegExp("(" + _mod10779.TIME_UNITS_NO_ABBR_PATTERN + ")\\s{0,5}(later|after|from now)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      const parseDurationResult = ENTimeUnitLaterFormatParser(10779).parseDuration(arg1[1]);
