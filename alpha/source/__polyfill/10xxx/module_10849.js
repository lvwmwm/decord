// Module ID: 10849
// Function ID: 10850
// Dependencies: [41, 42, 93, 95, 98, 10844, 10779, 10781]
...
function createTimeComponents(createParsingComponents, arg1, arg2, arg3, arg4) {
  ...
  let parsed = parseInt(JPTimeExpressionParser(10844).toHankaku(arg1));
  if (isNaN(parsed)) {
    parsed = tmp(10844).jaStringToNumber(arg1);
  }
  if (parsed > 24) {
    return null;
  } else {
    if (arg2) {
      ...
      if ("\u534A" !== arg2) {
        ...
        const parsed1 = parseInt(tmp(10844).toHankaku(arg2));
        const _isNaN = isNaN;
        num = parsed1;
        if (isNaN(parsed1)) {
          num = tmp(10844).jaStringToNumber(arg2);
        }
      }
      if (num >= 60) {
        return null;
    ...
    if (arg3) {
      ...
      let parsed2 = parseInt(tmp(10844).toHankaku(arg3));
      const _isNaN2 = isNaN;
      if (isNaN(parsed2)) {
        parsed2 = tmp(10844).jaStringToNumber(arg3);
      }
      if (parsed2 >= 60) {
        return null;
      } else {
        ...
        if ("\u5348\u524D" !== arg4) {
          if ("a" !== str2.toLowerCase()) {
            ...
            if (!tmp8) {
              ...
              num6 = sum;
              num5 = tmp(10779).Meridiem.PM;
            }
          }
          str2 = arg4[0];
        }
        const AM = tmp(10779).Meridiem.AM;
        num5 = AM;
        num6 = parsed;
        if (12 === parsed) {
          num6 = 0;
    ...
    if (num5 >= 0) {
      ...
      parsingComponents.imply("meridiem", tmp(10779).Meridiem.AM);
    } else {
      parsingComponents.imply("meridiem", tmp(10779).Meridiem.PM);
    }
            ...
            if (isCertainResult1) {
              ...
              if (value === JPTimeExpressionParser(10779).Meridiem.PM) {
                ...
                if (diff > end10.get("hour")) {
                  ...
                  end6.imply("meridiem", tmp22(10779).Meridiem.AM);
                } else {
