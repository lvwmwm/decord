// Module ID: 10871
// Function ID: 10872
// Dependencies: [41, 42, 93, 95, 98, 10774, 10868, 10775, 10781]
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      if (arg1[2]) {
        parsingComponents.assign("year", tmp2(10868).parseYear(arg1[2]));
      } else {
        parsingComponents.imply("year", tmp2(10775).findYearClosestToRef(createParsingComponents.refDate, 1, tmp4));
      }
