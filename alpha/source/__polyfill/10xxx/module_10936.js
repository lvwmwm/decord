// Module ID: 10936
// Function ID: 10937
// Dependencies: [41, 42, 93, 95, 98, 10934, 10787]
...
const entry = {
  ...
  value: function patternLeftBoundary() {
    return AbstractParserWithLeftRightBoundaryChecking(10934).REGEX_PARTS.leftBoundary;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerPattern(arg0) {
      const regExp = new RegExp(this.innerPatternString(arg0), AbstractParserWithLeftRightBoundaryChecking(10934).REGEX_PARTS.flags);
      return regExp;
    }
  },
  {
...
const entry1 = {
  key: "innerPattern",
  value: function innerPattern(arg0) {
    const combined = "" + this.innerPatternString(arg0) + AbstractParserWithLeftRightBoundaryChecking(10934).REGEX_PARTS.rightBoundary;
    const regExp = new RegExp(combined, AbstractParserWithLeftRightBoundaryChecking(10934).REGEX_PARTS.flags);
    return regExp;
  }
};
const items1 = [entry1];
