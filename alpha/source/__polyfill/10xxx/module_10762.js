// Module ID: 10762
// Function ID: 10763
// Dependencies: [41, 42, 93, 95, 98, 10760, 10698, 10699, 10705]
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10760).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = tmp2(10760).parseOrdinalNumberPattern(index[2]);
