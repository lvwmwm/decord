// Module ID: 10006
// Function ID: 10007
// Dependencies: [9922, 9880, 9887, 9889, 9997, 9998, 10000, 10001, 10002, 10003, 10004, 10005, 9920]
...
fn(_mod10003);
fn(_mod10004);
const _isNativeReflectConstruct = fn(_mod10005);
...
const chrono1 = new require("module_9880").Chrono(configuration1);
const chrono2 = new require("module_9880").Chrono(createConfiguration());
