// Module ID: 10694
// Function ID: 10695
// Dependencies: [41, 42, 10695, 10701]

// Module 10694
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10695 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof ParsingContext(10701).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10701).ParsingComponents)) {
...
const entry2 = {
  ...
  value: function createParsingComponents(date) {
    ...
    if (!(date instanceof ParsingContext(10701).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10701).ParsingComponents(this.reference, date);
    }
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10701).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
