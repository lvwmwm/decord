// Module ID: 10208
// Function ID: 10209
// Dependencies: [10209, 10211, 10213, 10214, 10215]

// Module 10208
import QR8bitByte from "QR8bitByte" /* 10209 */;
import QRRSBlock from "QRRSBlock" /* 10211 */;
import QRBitBuffer from "QRBitBuffer" /* 10213 */;
import _mod10214 from "module_10214" /* 10214 */;
import QRPolynomial from "QRPolynomial" /* 10215 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod10214.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10214.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10214.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
