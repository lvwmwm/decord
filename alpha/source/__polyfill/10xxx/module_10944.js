// Module ID: 10944
// Function ID: 10945
// Dependencies: [41, 42, 93, 95, 98, 10943, 10774, 10775, 10781]
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10943).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = tmp2(10943).parseOrdinalNumberPattern(index[2]);
