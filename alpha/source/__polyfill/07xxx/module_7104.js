// Module ID: 7104
// Function ID: 7105
// Dependencies: [32, 109, 19, 17, 21, 6990, 7086, 7087, 7088, 7089, 7105, 7083, 7008, 7081]
// Exports: default

// Module 7104
import tagMessage2 from "tagMessage" /* 6990 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 7086 */;
import StateMachineEvent2 from "StateMachineEvent" /* 7089 */;
import GestureObjects2 from "GestureObjects" /* 7105 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(7086).gestureToPressableEvent(arg0));
        let obj = hitSlop(7086);
      }
    };
