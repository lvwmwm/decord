// Module ID: 7139
// Function ID: 7140
// Dependencies: [19, 21, 6962, 1637, 6958, 6968]
// Exports: default
...
export default function _default(children) {
  ...
  if (useGestureEventsHandlersDefault === undefined) {
    useGestureEventsHandlersDefault = _mod6962.useGestureEventsHandlersDefault;
  }
  ...
  const gestureHandler = _mod6962.useGestureHandler(value2.GESTURE_SOURCE.CONTENT, animatedContentGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
  const gestureHandler1 = _mod6962.useGestureHandler(value2.GESTURE_SOURCE.HANDLE, animatedHandleGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
