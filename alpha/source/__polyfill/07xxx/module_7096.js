// Module ID: 7096
// Function ID: 7097
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 7097, 7079, 6989]
...
class InnerBaseButton {
  constructor(arg0) {
    ...
    tmp3Result.handleEvent = (nativeEvent) => {
      ...
      let tmp18 = state !== InnerBorderlessButton(6989).State.ACTIVE || pointerInside || undefined === tmp7.longPressTimeout;
      if (tmp18) {
