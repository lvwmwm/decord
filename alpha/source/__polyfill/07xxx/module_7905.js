// Module ID: 7905
// Function ID: 7906
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 7906, 7907, 7908, 7909, 7913, 7914, 7915, 7925]
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(7906).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(7906).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef7925);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(7909).extractTransformSvgView(tmp);
      const obj3 = Svg(7909);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(7914)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef7915, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef7913, {});
  }
};
let items = [entry];
