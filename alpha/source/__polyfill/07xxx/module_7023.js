// Module ID: 7023
// Function ID: 7024
// Dependencies: [41, 42, 93, 95, 98, 19, 7024, 6990, 7012, 7010]
...
import PlatformConstants from "module_7024" /* 7024 */;
...
const entry = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(6990).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  entry,
...
if (forceTouchAvailable) {
  ...
  const items2 = [];
  HermesBuiltin.arraySpread(items1, HermesBuiltin.arraySpread(fn(7010).baseGestureHandlerProps, 0));
  obj.allowedProps = items2;
  obj.config = {};
  importDefaultResultResult = _modDef7012(obj);
  const importDefaultResult4 = _modDef7012;
}
let flag;
if (PlatformConstants != null) {
