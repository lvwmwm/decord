// Module ID: 7747
// Function ID: 7748
// Dependencies: [19, 17, 21, 113, 7748, 39, 38, 7750, 7751]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_7750").container, require("module_7750").webView, style];
  const items4 = [require("module_7750").container, containerStyle];
