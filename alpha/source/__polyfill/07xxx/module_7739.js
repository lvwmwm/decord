// Module ID: 7739
// Function ID: 7740
// Dependencies: [19, 17, 21, 113, 7740, 39, 38, 7742, 7743]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_7742").container, require("module_7742").webView, style];
  const items4 = [require("module_7742").container, containerStyle];
