// Module ID: 7935
// Function ID: 7936
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7916, 7936, 7925]
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ cx, cy, rx, ry } = props);
    const merged = Object.assign(Ellipse(7916).extract(this, props));
    obj.cx = cx;
    obj.cy = cy;
    obj.rx = rx;
    obj.ry = ry;
    const obj2 = Ellipse(7916);
    const obj3 = {
      ref(arg0) {
