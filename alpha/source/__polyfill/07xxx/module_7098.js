// Module ID: 7098
// Function ID: 7099
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 7099, 7081, 6991]
...
class InnerBaseButton {
  constructor(arg0) {
    ...
    tmp3Result.handleEvent = (nativeEvent) => {
      ...
      let tmp18 = state !== InnerBorderlessButton(6991).State.ACTIVE || pointerInside || undefined === tmp7.longPressTimeout;
      if (tmp18) {
