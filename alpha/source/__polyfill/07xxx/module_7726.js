// Module ID: 7726
// Function ID: 7727
// Dependencies: [7727, 32, 109, 19, 17, 7728, 21, 7730, 7731, 7732]
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = obj6.jsx(tmp24(7732).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
