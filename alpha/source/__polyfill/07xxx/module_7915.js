// Module ID: 7915
// Function ID: 7916
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 7909, 7916, 7923, 7924, 7925]
...
_inherits(G, _modDef7925);
const entry = {
  key: "render",
  value: function render() {
    const self = this;
    const props = this.props;
    const propsAndStylesResult = G(7916).propsAndStyles(props);
    const tmp5 = extractPropsDefault(propsAndStylesResult, this);
    const obj = G(7916);
    const extractFontResult = G(7923).extractFont(propsAndStylesResult);
