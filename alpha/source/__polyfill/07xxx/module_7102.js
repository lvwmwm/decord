// Module ID: 7102
// Function ID: 7103
// Dependencies: [32, 109, 19, 17, 21, 6988, 7084, 7085, 7086, 7087, 7103, 7081, 7006, 7079]
// Exports: default

// Module 7102
import tagMessage2 from "tagMessage" /* 6988 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 7084 */;
import StateMachineEvent2 from "StateMachineEvent" /* 7087 */;
import GestureObjects2 from "GestureObjects" /* 7103 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(7084).gestureToPressableEvent(arg0));
        let obj = hitSlop(7084);
      }
    };
