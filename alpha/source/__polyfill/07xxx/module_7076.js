// Module ID: 7076
// Function ID: 7077
// Dependencies: [32, 109, 19, 21, 7077, 6876, 4630, 7078, 6888, 6873]

// Module 7076
import normalizeSnapPoint from "normalizeSnapPoint" /* 6888 */;
import id from "id" /* 7078 */;
...
let noop = noop_mod;
const jsx = fn(21).jsx;
let closure_14 = { mount: false, data: "flex" };
const memoResult = memo(forwardRef(function BottomSheetModalComponent(name, arg1) {
  ...
  closure_9 = tmp9[1];
  const bottomSheetModalInternal = require("module_6876").useBottomSheetModalInternal();
