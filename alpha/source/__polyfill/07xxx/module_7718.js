// Module ID: 7718
// Function ID: 7719
// Dependencies: [7719, 32, 109, 19, 17, 7720, 21, 7722, 7723, 7724]
...
const _slicedToArray = module_7719(_mod32);
const _objectWithoutProperties = module_7719(_objectWithoutProperties2);
...
const __INTERNAL_VIEW_CONFIG = module_7719(_mod7720);
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (undefined === SLIDER_DEFAULT_INITIAL_VALUE) {
    SLIDER_DEFAULT_INITIAL_VALUE = _mod7722.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (undefined === lowerLimit) {
    ...
    const obj = { web: num, default: _mod7722.constants.LIMIT_MIN_VALUE };
  ...
  if (undefined === upperLimit) {
    ...
    const obj2 = { web: num2, default: _mod7722.constants.LIMIT_MAX_VALUE };
  ...
  if (null == SLIDER_DEFAULT_INITIAL_VALUE2) {
    SLIDER_DEFAULT_INITIAL_VALUE2 = _mod7722.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (!num3) {
    DEFAULT_STEP_RESOLUTION = _mod7722.constants.DEFAULT_STEP_RESOLUTION;
  }
  ...
  if ("ios" === get_ActivityIndicator.Platform.OS) {
    let defaultSlider = _mod7723.styles.defaultSlideriOS;
    let tmp24 = require;
  } else {
    tmp24 = require;
    defaultSlider = _mod7723.styles.defaultSlider;
  }
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = obj6.jsx(tmp24(7724).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
