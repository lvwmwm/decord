// Module ID: 13870
// Function ID: 13871
// Dependencies: [41, 42, 32, 13864, 13871, 13872]
...
let obj2 = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, _mod13864.implSymbol)) {
        if (arg0[tmp(undefined, 13864).implSymbol] instanceof tmp(13871).implementation) {
          return true;
        }
      }
  ...
  setup(wrapper, arg1) {
    ...
    if (URLSearchParamsImpl.init) {
      tmp2(13871).init(wrapper[tmp2(undefined, 13864).implSymbol], obj);
      const tmp2Result = tmp2(13871);
    }
    return wrapper;
  },
  install(arg0) {
              ...
              if (arguments.length < 1) {
                ...
                if (0 < arr2.length) {
                  do {
                    ...
                    let _Array = Array;
                    arr3 = Array.from(self[tmp3(undefined, 13864).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr3;
