// Module ID: 13167
// Function ID: 13168
// Dependencies: [718, 13163, 13168, 13169, 13141, 13150, 13158, 13151, 13136, 13153, 13164, 13170]
...
export const startIdleSpan = function startIdleSpan(arg0) {
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod13153.SPAN_STATUS_ERROR, message: "cancelled" };
  ...
  const client = require("module_13163").getClient();
  if (client) {
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod13150.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod13153.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
