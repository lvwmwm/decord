// Module ID: 13866
// Function ID: 13867
// Dependencies: [13867, 13868, 1252, 13869]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod13869.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod13869.percentDecode(_Buffer.from(buffer));
  }
}
