// Module ID: 13113
// Function ID: 13114
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 13053, 13068, 13050, 13114, 13078, 13081, 13082, 13054, 13107, 13065, 13115, 13076, 13059, 13090, 13109]
...
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      return obj.resolvedSyncPromise(ServerRuntimeClient(13114).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(13107).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(13082).DEBUG_BUILD) {
        const logger = tmp2(13054).logger;
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        ...
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(13059).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(13059);
        } else {
          spanToTraceContextResult = tmp(13081).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(13081);
        }
