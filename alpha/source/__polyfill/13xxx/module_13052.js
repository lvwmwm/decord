// Module ID: 13052
// Function ID: 13053
// Dependencies: [13053, 13054, 13057]
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (_mod13053.DEBUG_BUILD) {
          const logger = tmp19(13054).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(13057).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(13057);
        }
      }
    }
