// Module ID: 13151
// Function ID: 13152
// Dependencies: [13144, 13145, 13152, 13153, 13154]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(13152).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(13152);
        }
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod13153.htmlTreeAsString(arg0);
      const tmp2Result = _mod13153;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod13154.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod13154.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod13144.DEBUG_BUILD) {
        const logger = tmp7(13145).logger;
        const _HermesInternal = HermesInternal;
