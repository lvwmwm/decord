// Module ID: 13188
// Function ID: 13189
// Dependencies: [13144, 13145, 13189, 13192, 13181, 13150]
...
export const createEventEnvelope = function createEventEnvelope(type, arg1, sdk, arg3) {
  ...
  const eventEnvelopeHeaders = _mod13189.createEventEnvelopeHeaders(type, sdkMetadataForEnvelopeHeader, arg3, arg1);
  delete tmp[tmp2];
...
export const createSessionEnvelope = function createSessionEnvelope(toJSON, arg1, arg2, arg3) {
  const sdkMetadataForEnvelopeHeader = _mod13189.getSdkMetadataForEnvelopeHeader(arg2);
  ...
  let tmp6 = arg3 && arg1;
  if (tmp6) {
    const obj4 = { dsn: tmp(13192).dsnToString(arg1) };
    tmp6 = obj4;
    const tmpResult = tmp(13192);
  }
