// Module ID: 13074
// Function ID: 13075
// Dependencies: [41, 42, 13075, 13061, 13072, 13080]
...
function withScope(arg0) {
  ...
  if (!stack) {
    ...
    stack = new _moduleResult(defaultCurrentScope, tmp(13080).getDefaultIsolationScope());
...
function withIsolationScope(arg0) {
  ...
  return stack.withScope(() => {
    ...
    let stack = sentryCarrier.stack;
    if (!stack) {
      const defaultCurrentScope = tmp2(13080).getDefaultCurrentScope();
      const tmp2Result = tmp2(13080);
      stack = new closure_2_3(defaultCurrentScope, tmp2(13080).getDefaultIsolationScope());
      const tmp2Result2 = tmp2(13080);
    }
    sentryCarrier.stack = stack;
  ...
  return {
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = tmp(13080).getDefaultCurrentScope();
        const tmpResult = tmp(13080);
        stack = new closure_1_3(defaultCurrentScope, tmp(13080).getDefaultIsolationScope());
        const tmpResult2 = tmp(13080);
      }
      sentryCarrier.stack = stack;
