// Module ID: 13161
// Function ID: 13162
// Dependencies: [32, 5, 13048, 13162, 13056, 13051, 13064, 13057]
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod13048.addHandler("fetch-body-resolved", arg0);
        ...
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(13048);
                    obj5.endTimestamp = 1000 * stack(13064).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(13064);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            if (tmp5) {
              ...
              const result = tmp(13056).addNonEnumerableProperty(error, "framesToPop", 1);
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_13048").addHandler("fetch", arg0);
  let obj = require("module_13048");
  require("module_13048").maybeInstrument("fetch", () => {
    let flag = closure_0;
