// Module ID: 13910
// Function ID: 13911
// Dependencies: [13911, 13912, 1252, 13913]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod13913.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod13913.percentDecode(_Buffer.from(buffer));
  }
}
