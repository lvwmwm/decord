// Module ID: 13690
// Function ID: 13691
// Dependencies: [1161, 13691, 13692, 13756, 13763, 13768, 13783, 13784]

// Module 13690
import _mod13691 from "module_13691" /* 13691 */;
import _mod13692 from "module_13692" /* 13692 */;
import _mod13756 from "module_13756" /* 13756 */;
import e from "e" /* 1161 */;

function addLikelySubtags(arr3) {
  const parseUnicodeLocaleIdResult = _mod13756.parseUnicodeLocaleId(arr3);
  ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
  if (script) {
    if (region) {
      const obj = { lang, script, region, variants: [] };
      const tmp4 = tmp(13756).likelySubtags[tmp(undefined, 13756).emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = tmp(13756).parseUnicodeLanguageId(tmp4);
        ...
        return tmp(13756).emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj4 = { lang, script, variants: [] };
    const tmp5 = tmp(13756).likelySubtags[tmp(undefined, 13756).emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = tmp(13756).parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = tmp(13756).likelySubtags[tmp(undefined, 13756).emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = tmp(13756).parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = tmp(13756).likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = tmp(13756).likelySubtags[tmp(undefined, 13756).emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = tmp(13756).parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
...
const module_13691 = e.__importDefault(_mod13691);
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(13756).emitUnicodeLanguageId(obj.__assign(Locale(1161).__assign({}, Locale(13756).parseUnicodeLanguageId(tmp2)), obj3));
            const parseUnicodeLocaleIdResult = Locale(13756).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            const obj4 = { lang, variants: [] };
            if (tmp(Locale(13756).emitUnicodeLanguageId(obj4)) === result) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = tmp3(13756).emitUnicodeLocaleId(tmp3Result.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj5));
              const __assignResult = tmp3(1161).__assign({}, parseUnicodeLocaleIdResult);
            } else {
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (tmp(tmp3(13756).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = tmp3(13756).emitUnicodeLocaleId(tmp3Result7.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj8));
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (tmp(tmp3(13756).emitUnicodeLanguageId(obj10)) === result) {
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = tmp3(13756).emitUnicodeLocaleId(tmp3Result9.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj11));
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(13756).emitUnicodeLanguageId(Locale(13756).parseUnicodeLanguageId(module_13691.default(this).locale));
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "calendar", {
    get() {
      return module_13691.default(this).calendar;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "collation", {
    get() {
      return module_13691.default(this).collation;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "caseFirst", {
    get() {
      return module_13691.default(this).caseFirst;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numeric", {
    get() {
      return module_13691.default(this).numeric;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numberingSystem", {
    get() {
      return module_13691.default(this).numberingSystem;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(13756).parseUnicodeLanguageId(module_13691.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(13756).parseUnicodeLanguageId(module_13691.default(this).locale).script;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(13756).parseUnicodeLanguageId(module_13691.default(this).locale).region;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      const defaultResult = module_13691.default(this);
      if (Locale(13692).HasOwnProperty(defaultResult, "initializedLocale")) {
