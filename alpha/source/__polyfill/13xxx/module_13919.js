...
export default () => {
  ...
  return (arg0) => {
    ...
    obj = {
      onConnect() {
        const XHRInterceptor = obj(13920).XHRInterceptor;
        XHRInterceptor.setSendCallback(onSend);
        const XHRInterceptor2 = obj(13920).XHRInterceptor;
        XHRInterceptor2.setResponseCallback(onResponse);
        const XHRInterceptor3 = obj(13920).XHRInterceptor;
