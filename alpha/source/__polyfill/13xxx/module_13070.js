// Module ID: 13070
// Function ID: 13071
// Dependencies: [41, 42, 13071, 13057, 13068, 13076]
...
function withScope(arg0) {
  ...
  if (!stack) {
    ...
    stack = new _moduleResult(defaultCurrentScope, tmp(13076).getDefaultIsolationScope());
...
function withIsolationScope(arg0) {
  ...
  return stack.withScope(() => {
    ...
    let stack = sentryCarrier.stack;
    if (!stack) {
      const defaultCurrentScope = tmp2(13076).getDefaultCurrentScope();
      const tmp2Result = tmp2(13076);
      stack = new closure_2_3(defaultCurrentScope, tmp2(13076).getDefaultIsolationScope());
      const tmp2Result2 = tmp2(13076);
    }
    sentryCarrier.stack = stack;
  ...
  return {
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = tmp(13076).getDefaultCurrentScope();
        const tmpResult = tmp(13076);
        stack = new closure_1_3(defaultCurrentScope, tmp(13076).getDefaultIsolationScope());
        const tmpResult2 = tmp(13076);
      }
      sentryCarrier.stack = stack;
