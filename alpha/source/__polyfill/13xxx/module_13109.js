// Module ID: 13109
// Function ID: 13110
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 13049, 13064, 13046, 13110, 13074, 13077, 13078, 13050, 13103, 13061, 13111, 13072, 13055, 13086, 13105]
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(13103).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(13078).DEBUG_BUILD) {
        const logger = tmp2(13050).logger;
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        ...
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(13055).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(13055);
        } else {
          spanToTraceContextResult = tmp(13077).getTraceContextFromScope(arg0);
