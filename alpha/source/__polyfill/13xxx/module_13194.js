// Module ID: 13194
// Function ID: 13195
// Dependencies: [13156, 13159, 13172, 13195, 13196, 13182, 13154, 13197, 13190, 13166]
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = _mod13154.truncate(environment.message, num);
  }
  value = iter;
  ...
  if (value) {
    iter.value = _mod13154.truncate(iter.value, num);
  }
  ...
  if (url) {
    request.url = _mod13154.truncate(request.url, num);
  }
}
function applyDebugIds(exception, arg1) {
  const filenameToDebugIdMap = _mod13197.getFilenameToDebugIdMap(arg1);
  try {
