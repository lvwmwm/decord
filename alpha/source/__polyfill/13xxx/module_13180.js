// Module ID: 13180
// Function ID: 13181
// Dependencies: [32, 13137, 13181, 13142, 13183]
...
export const createEventEnvelopeHeaders = function createEventEnvelopeHeaders(event_id, sdk, arg2, arg3) {
  ...
  let tmp4 = arg2 && arg3;
  if (tmp4) {
    const obj3 = { dsn: _mod13183.dsnToString(arg3) };
    tmp4 = obj3;
  }
...
export const parseEnvelope = function parseEnvelope(arr) {
  if (typeof arr !== "string") {
    function readJson() {
      ...
      if (_mod13137.GLOBAL_OBJ.__SENTRY__) {
        if (tmp3(13137).GLOBAL_OBJ.__SENTRY__.decodePolyfill) {
          const __SENTRY__ = tmp3(13137).GLOBAL_OBJ.__SENTRY__;
  ...
  function append(json) {
    if (typeof sum === "string") {
      if (typeof json === "string") {
        ...
        if (_mod13137.GLOBAL_OBJ.__SENTRY__) {
          if (tmp14(13137).GLOBAL_OBJ.__SENTRY__.encodePolyfill) {
            const __SENTRY__2 = tmp14(13137).GLOBAL_OBJ.__SENTRY__;
