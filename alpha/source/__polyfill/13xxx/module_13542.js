// Module ID: 13542
// Function ID: 13543
// Dependencies: [41, 42, 13543, 13544, 13545, 13546, 13547]
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(13547).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = tmp3(13547);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(13547).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = tmp3(13547);
      }
