// Module ID: 13117
// Function ID: 13118
// Dependencies: [13118, 13098, 13119, 13078, 13082, 13054, 13111]
        ...
        return recordEnvelopeLoss.add(() => {
          ...
          if (arg0 instanceof _mod13111.SentryError) {
            ...
            if (typeof recordEnvelopeLoss === "function") {
              ...
              tmp(13098).forEachEnvelopeItem(closure_1, (arg0, arg1) => {
                if ("event" === arg1) {
                  const _Array = Array;
                  let tmp4;
                  if (Array.isArray(arg0)) {
              ...
              const tmpResult = tmp(13098);
              return tmp(13078).resolvedSyncPromise({});
            } else {
              throw new TypeError("Trying to call a non-function");
            }
          } else {
