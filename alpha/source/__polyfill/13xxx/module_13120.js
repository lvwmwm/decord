// Module ID: 13120
// Function ID: 13121
// Dependencies: [5, 13082, 13054, 13098, 13119]
          ...
          if (0 === c6) {
            ...
            const obj10 = {
              value: (function shouldQueue(arg0, arg1, arg2) {
                      const result = createStore(13098).envelopeContainsItemType(arg0, ["client_report"]);
                      let tmp2 = !result;
                      if (!result) {
            ...
            if (arg0 === 1) {
              ...
              closure_130_3 = createStore(13119).parseRetryAfterHeader(closure_130_2.headers["retry-after"]);
              const obj5 = createStore(13119);
            }
          } else {
            if (6 === tmp6) {
              if (arg0 === 1) {
