// Module ID: 13142
// Function ID: 13143
// Dependencies: [13135, 13136, 13143, 13144, 13145]
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(13143).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(13143);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod13135.DEBUG_BUILD) {
        const logger = tmp7(13136).logger;
        const _HermesInternal = HermesInternal;
