// Module ID: 13560
// Function ID: 13561
// Dependencies: [41, 42, 13561, 13562, 13563, 13564, 13565]
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(13565).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = tmp3(13565);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(13565).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = tmp3(13565);
      }
