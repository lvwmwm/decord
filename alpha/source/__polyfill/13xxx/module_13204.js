// Module ID: 13204
// Function ID: 13205
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 13144, 13159, 13141, 13205, 13169, 13172, 13173, 13145, 13198, 13156, 13206, 13167, 13150, 13181, 13200]
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(13198).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(13173).DEBUG_BUILD) {
        const logger = tmp2(13145).logger;
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        ...
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(13150).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(13150);
        } else {
          spanToTraceContextResult = tmp(13172).getTraceContextFromScope(arg0);
