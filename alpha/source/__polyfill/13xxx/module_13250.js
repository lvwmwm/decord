// Module ID: 13250
// Function ID: 13251
// Dependencies: [718, 13141, 13144, 13145, 13159, 13169, 13173, 13177, 13227, 13150, 13179, 13160, 13178, 13216, 13162, 13158, 13152]
...
function _addTracingHeadersToFetchRequest(headers, headers2, span) {
  const traceData = _mod13216.getTraceData({ span });
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = tmp(13152).isInstanceOf(headers, Request);
        const tmpResult = tmp(13152);
      }
      let headers1;
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = tmp(13152).isInstanceOf(headers, Headers);
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData, fn, fn2, arg3) {
  ...
  if (fetchData.fetchData) {
    ...
    let hasTracingEnabledResult = _mod13177.hasTracingEnabled();
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(13162).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(13162);
            } else if (endResult.error) {
              const obj2 = { code: setHttpStatus(13162).SPAN_STATUS_ERROR, message: "internal_error" };
    ...
    if (tmp7) {
      const host = setHttpStatus(13227).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(13227);
    }
    const activeSpan = setHttpStatus(13150).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj4[setHttpStatus(13160).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj4[setHttpStatus(13160).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj3.attributes = obj4;
        let startInactiveSpanResult = setHttpStatus(13179).startInactiveSpan(obj3);
        const setHttpStatusResult4 = setHttpStatus(13179);
      }
      ...
      if (fn2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(13177);
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(13178).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(13150);
  }
};
