// Module ID: 13734
// Function ID: 13735
// Dependencies: [1161, 13735, 13736, 13800, 13807, 13812, 13827, 13828]
...
function addLikelySubtags(arr3) {
  const parseUnicodeLocaleIdResult = _mod13800.parseUnicodeLocaleId(arr3);
  ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
  if (script) {
    if (region) {
      const obj = { lang, script, region, variants: [] };
      const tmp4 = tmp(13800).likelySubtags[tmp(undefined, 13800).emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = tmp(13800).parseUnicodeLanguageId(tmp4);
        ...
        if (result) {
          ...
          obj3 = { lang: "und", script: "Array", region: "ao", variants };
        }
        parseUnicodeLocaleIdResult.lang = obj3;
        return tmp(13800).emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj4 = { lang, script, variants: [] };
    const tmp5 = tmp(13800).likelySubtags[tmp(undefined, 13800).emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = tmp(13800).parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = tmp(13800).likelySubtags[tmp(undefined, 13800).emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = tmp(13800).parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = tmp(13800).likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = tmp(13800).likelySubtags[tmp(undefined, 13800).emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = tmp(13800).parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
...
const module_13735 = e.__importDefault(_mod13735);
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(13800).emitUnicodeLanguageId(obj.__assign(Locale(1161).__assign({}, Locale(13800).parseUnicodeLanguageId(tmp2)), obj3));
            const parseUnicodeLocaleIdResult = Locale(13800).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            const obj4 = { lang, variants: [] };
            if (tmp(Locale(13800).emitUnicodeLanguageId(obj4)) === result) {
              ...
              const obj6 = { lang, script: "Array", region: "ao", variants };
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = tmp3(13800).emitUnicodeLocaleId(tmp3Result.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj5));
              const __assignResult = tmp3(1161).__assign({}, parseUnicodeLocaleIdResult);
            } else {
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (tmp(tmp3(13800).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = tmp3(13800).emitUnicodeLocaleId(tmp3Result7.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj8));
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (tmp(tmp3(13800).emitUnicodeLanguageId(obj10)) === result) {
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = tmp3(13800).emitUnicodeLocaleId(tmp3Result9.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj11));
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(13800).emitUnicodeLanguageId(Locale(13800).parseUnicodeLanguageId(module_13735.default(this).locale));
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "calendar", {
    get() {
      return module_13735.default(this).calendar;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "collation", {
    get() {
      return module_13735.default(this).collation;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "caseFirst", {
    get() {
      return module_13735.default(this).caseFirst;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numeric", {
    get() {
      return module_13735.default(this).numeric;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numberingSystem", {
    get() {
      return module_13735.default(this).numberingSystem;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(13800).parseUnicodeLanguageId(module_13735.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(13800).parseUnicodeLanguageId(module_13735.default(this).locale).script;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(13800).parseUnicodeLanguageId(module_13735.default(this).locale).region;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      const defaultResult = module_13735.default(this);
      if (Locale(13736).HasOwnProperty(defaultResult, "initializedLocale")) {
