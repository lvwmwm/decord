// Module ID: 13060
// Function ID: 13061
// Dependencies: [13053, 13054, 13061, 13062, 13063]
...
function convertToPlainObject(type) {
  if (obj.isError(type)) {
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type === "object") {
        ...
        if (typeof globalThis.CustomEvent !== "undefined") {
          isInstanceOfResult = tmp2(13061).isInstanceOf(type, globalThis.CustomEvent);
          const tmp2Result2 = tmp2(13061);
        }
    ...
    tmp2Result = tmp2(13061);
  }
}
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = _mod13062.htmlTreeAsString(arg0);
      const tmp2Result = _mod13062;
    } else {
      const _Object = Object;
...
export const extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return _mod13063.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = _mod13063.truncate(joined, num);
        }
...
export const fill = function fill(arg0, arg1, fn) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (_mod13053.DEBUG_BUILD) {
        const logger = tmp7(13054).logger;
        const _HermesInternal = HermesInternal;
