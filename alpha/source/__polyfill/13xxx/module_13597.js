// Module ID: 13597
// Function ID: 13598
// Dependencies: [13560, 13589, 13580, 13585, 13581, 13584, 13591, 13588]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_13560")(arg0, arg3);
  const tmp4 = new require("module_13589")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(13580);
    let tmpResult = tmp(13585);
    const tmpResult3 = tmp(13581);
  ...
  if (require("module_13591")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
