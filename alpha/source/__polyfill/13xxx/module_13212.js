// Module ID: 13212
// Function ID: 13213
// Dependencies: [5, 13189, 13192, 13199]
    ...
    function getTransport(arg0, arg1) {
      ...
      if (value) {
        ...
        if (dsnFromStringResult) {
          let merged = tunnel;
          const envelopeEndpointWithUrlEncodedAuth = tmp4(13199).getEnvelopeEndpointWithUrlEncodedAuth(dsnFromStringResult, tunnel.tunnel);
          let tmp9 = tunnel;
          let obj3 = {};
          if (arg1) {
