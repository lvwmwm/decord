// Module ID: 13256
// Function ID: 13257
// Dependencies: [32, 5, 13143, 13257, 13151, 13146, 13159, 13152]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod13143;
      obj2.endTimestamp = 1000 * _mod13159.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod13143.addHandler("fetch-body-resolved", arg0);
  _mod13143.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(13151).fill(closure_0(13146).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(13143);
                    obj5.endTimestamp = 1000 * stack(13159).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(13159);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(13143);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(13159).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(13159);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(13152);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(13151).addNonEnumerableProperty(error, "framesToPop", 1);
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  ...
  require("module_13143").maybeInstrument("fetch", () => {
    ...
    if (!flag) {
      _mod13151.fill(_mod13146.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
