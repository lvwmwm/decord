// Module ID: 13242
// Function ID: 13243
// Dependencies: [5, 13132, 13135, 13136, 13164, 13150, 13160, 13184, 13163, 13181, 13170, 13151]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(13163).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(13181);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(13181);
        ...
        closure_0(13163).withScope((setContext) => {
