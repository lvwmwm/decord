// Module ID: 13571
// Function ID: 13572
// Dependencies: [41, 42, 13543, 13570, 13544, 13546, 13545, 13542, 13572]
          ...
          if (typeof parseComparator === "function") {
            ...
            if (typeof replaceCarets === "function") {
              ...
              if (typeof replaceTildes === "function") {
                          ...
                          if (typeof tmp4 === "function") {
                            ...
                            if (tmp6) {
                              ...
                              if (tmp7) {
                                ...
                                tmp(13545)("replaceTilde pr", arg4);
                                const _HermesInternal2 = HermesInternal;
                ...
                tmp2(13545)("tildes", str7);
                if (typeof replaceXRanges === "function") {
                  tmp2(13545)("replaceXRanges", str7, options);
                    ...
                    if (typeof replaceXRange === "function") {
                      ...
                      return str.replace(tmp5, (arg0, arg1, str, str2, str3, arg5) => {
                        ...
                        if (typeof closure_2_9 === "function") {
                          ...
                          tmp2(13545)("xRange return", combined);
                          return combined;
                        } else {
                          throw new TypeError("Trying to call a non-function");
                        }
                  ...
                  tmp2(13545)("xrange", str10);
                  if (typeof replaceStars === "function") {
                    tmp2(13545)("replaceStars", str10, options);
                    const replaced = str10.trim().replace(tmp2(13546).safeRe[tmp2(undefined, 13546).t.STAR], "");
                    tmp2(13545)("stars", replaced);
                    return replaced;
                  } else {
                    throw new TypeError("Trying to call a non-function");
                  }
