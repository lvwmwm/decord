// Module ID: 13914
// Function ID: 13915
// Dependencies: [41, 42, 32, 13908, 13915, 13916]
...
let obj2 = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, _mod13908.implSymbol)) {
        if (arg0[tmp(undefined, 13908).implSymbol] instanceof tmp(13915).implementation) {
          return true;
        }
      }
  ...
  setup(wrapper, arg1) {
    ...
    if (URLSearchParamsImpl.init) {
      tmp2(13915).init(wrapper[tmp2(undefined, 13908).implSymbol], obj);
              ...
              if (arguments.length < 1) {
                ...
                if (0 < arr2.length) {
                  do {
                    ...
                    let _Array = Array;
                    arr3 = Array.from(self[tmp3(undefined, 13908).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr3;
