// Module ID: 13165
// Function ID: 13166
// Dependencies: [32, 5, 13052, 13166, 13060, 13055, 13068, 13061]
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod13052.addHandler("fetch-body-resolved", arg0);
        ...
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(13052);
                    obj5.endTimestamp = 1000 * stack(13068).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(13068);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            if (tmp5) {
              ...
              const result = tmp(13060).addNonEnumerableProperty(error, "framesToPop", 1);
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_13052").addHandler("fetch", arg0);
