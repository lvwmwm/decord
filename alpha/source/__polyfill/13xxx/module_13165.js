// Module ID: 13165
// Function ID: 13166
// Dependencies: [41, 42, 13166, 13152, 13163, 13171]
...
function withScope(arg0) {
  ...
  if (!stack) {
    ...
    stack = new _moduleResult(defaultCurrentScope, tmp(13171).getDefaultIsolationScope());
...
function withIsolationScope(arg0) {
  ...
  return stack.withScope(() => {
    ...
    let stack = sentryCarrier.stack;
    if (!stack) {
      const defaultCurrentScope = tmp2(13171).getDefaultCurrentScope();
      const tmp2Result = tmp2(13171);
      stack = new closure_2_3(defaultCurrentScope, tmp2(13171).getDefaultIsolationScope());
  ...
  return {
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = tmp(13171).getDefaultCurrentScope();
        const tmpResult = tmp(13171);
        stack = new closure_1_3(defaultCurrentScope, tmp(13171).getDefaultIsolationScope());
        const tmpResult2 = tmp(13171);
      }
      sentryCarrier.stack = stack;
