// Module ID: 13054
// Function ID: 13055
// Dependencies: [13055, 13053]

// Module 13054
import GLOBAL_OBJ from "module_13055" /* 13055 */;

const require = globalThis.__r;

function consoleSandbox(fn) {
  if ("console" in console(13055).GLOBAL_OBJ) {
    console = console(13055).GLOBAL_OBJ.console;
    dependencyMap = {};
...
export const logger = GLOBAL_OBJ.getGlobalSingleton("logger", function makeLogger() {
  ...
  if (require("module_13053").DEBUG_BUILD) {
