// Module ID: 5843
// Function ID: 5844
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 5844, 5845]
...
const jsx = fn(21).jsx;
let obj = { source: "sa", progress: null, speed: true, loop: false, autoPlay: false, enableMergePathsAndroidForKitKatAndAbove: false, enableSafeModeAndroid: true, cacheComposition: false, useNativeLooping: "contain", resizeMode: null, colorFilters: [], textFiltersAndroid: [], textFiltersIOS: [] };
class LottieView {
  constructor(arg0) {
    self = this;
...
const entry = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5844).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
...
let items = [
  ...
  },
  {
    ...
    value: function renderLottieView() {
      ...
      const parsePossibleSourcesResult = LottieView(5845).parsePossibleSources(source);
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(_modDef5844, { ref: self.captureRef });
        }
      }
