// Module ID: 5991
// Function ID: 5992
// Dependencies: [32, 19, 17, 21, 1616, 5971, 5983, 5967, 5964, 5950, 1486]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5964.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
