// Module ID: 5984
// Function ID: 5985
// Dependencies: [32, 19, 17, 21, 1615, 5964, 5976, 5960, 5957, 5943, 1485]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5957.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
