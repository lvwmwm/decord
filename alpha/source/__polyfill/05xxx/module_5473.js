            ...
            if (uint321 > buffer.length) {
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (uint323 > uint322) {
                  ...
                  if (tmp55(5474).iccTags[stringFromDataView]) {
                    let obj3 = { value: applyResult, description: applyResult };
                    obj2[tmp55(5474).iccTags[stringFromDataView].name] = obj3;
                  } else {
                ...
                if (1 === uint324) {
                  ...
                  if (iccTags.iccTags[stringFromDataView]) {
                    ...
                    obj2[tmp33(5474).iccTags[stringFromDataView].name] = obj12;
                  } else {
                ...
                if (tmp55(5474).iccTags[stringFromDataView]) {
                  ...
                  obj2[tmp55(5474).iccTags[stringFromDataView].name] = obj14;
                } else {
                ...
                if (tmp55(5474).iccTags[stringFromDataView]) {
                  ...
                  obj2[tmp55(5474).iccTags[stringFromDataView].name] = obj16;
                } else {
