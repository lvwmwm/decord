// Module ID: 5950
// Function ID: 5951
// Dependencies: [5948, 5951]

// Module 5950
import _mod5948 from "module_5948" /* 5948 */;
import swizzle from "swizzle" /* 5951 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5948")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5948");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5948")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5948)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
