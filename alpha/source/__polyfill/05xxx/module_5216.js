// Module ID: 5216
// Function ID: 5217
// Dependencies: [109, 19, 17, 21, 5217, 5218, 5219]
// Exports: default
...
export default function TabsScreen(arg0) {
  ...
  const result = _mod5219.parseAndroidIconToNativeProps(icon);
  const tmp5Result = _mod5219;
  const result1 = _mod5219.parseAndroidIconToNativeProps(selectedIcon);
