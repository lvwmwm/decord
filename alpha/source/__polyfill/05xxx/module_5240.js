// Module ID: 5240
// Function ID: 5241
// Dependencies: [109, 19, 17, 21, 5228, 5238, 5237, 5241, 5242, 5245, 5227, 5247, 5218]
...
export default noop.forwardRef(function ScreenStackItem(arg0, ref) {
  ...
  dependencyMap = flag5.useContext(tmp4(5238).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = tmp4(5241).isIOS26OrHigher;
  }
  ...
  if (screenId(5241).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(tmp4(5245).SafeAreaView, obj5);
  }
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(tmp4(5247).FooterComponent, obj7);
  }
