            ...
            if (uint321 > buffer.length) {
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (uint323 > uint322) {
                  ...
                  if (tmp55(5568).iccTags[stringFromDataView]) {
                    let obj3 = { value: applyResult, description: applyResult };
                    obj2[tmp55(5568).iccTags[stringFromDataView].name] = obj3;
                  } else {
                ...
                if (1 === uint324) {
                  text = items[0].text;
                  if (tmp25(5568).iccTags[stringFromDataView]) {
                    let obj9 = { value: text, description: text };
                    obj2[tmp25(5568).iccTags[stringFromDataView].name] = obj9;
                  } else {
                  ...
                  if (iccTags.iccTags[stringFromDataView]) {
                    ...
                    obj2[tmp33(5568).iccTags[stringFromDataView].name] = obj12;
                  } else {
                ...
                if (tmp55(5568).iccTags[stringFromDataView]) {
                  ...
                  obj2[tmp55(5568).iccTags[stringFromDataView].name] = obj14;
                } else {
                ...
                if (tmp55(5568).iccTags[stringFromDataView]) {
                  ...
                  obj2[tmp55(5568).iccTags[stringFromDataView].name] = obj16;
                } else {
