// Module ID: 5957
// Function ID: 5958
// Dependencies: [5955, 5958]

// Module 5957
import _mod5955 from "module_5955" /* 5955 */;
import swizzle from "swizzle" /* 5958 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5955")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5955");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5955")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5955)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
