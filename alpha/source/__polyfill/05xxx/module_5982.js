// Module ID: 5982
// Function ID: 5983
// Dependencies: [32, 19, 17, 21, 1615, 5962, 5974, 5958, 5955, 5941, 1485]
// Exports: Screen
...
export const Screen = function Screen(aria_hidden) {
  ...
  const frameSize = modal(headerStatusBarHeight[7]).useFrameSize((layout) => _mod5955.getDefaultHeaderHeight(layout, modal, headerStatusBarHeight));
