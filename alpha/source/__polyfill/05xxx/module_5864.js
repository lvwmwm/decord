// Module ID: 5864
// Function ID: 5865
// Dependencies: [5862, 5865]

// Module 5864
import _mod5862 from "module_5862" /* 5862 */;
import swizzle from "swizzle" /* 5865 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5862")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5862");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5862")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5862)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
