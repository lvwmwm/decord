// Module ID: 5243
// Function ID: 5244
// Dependencies: [109, 19, 17, 21, 5231, 5241, 5240, 5244, 5245, 5248, 5230, 5250, 5221]
...
export default noop.forwardRef(function ScreenStackItem(arg0, ref) {
  ...
  dependencyMap = flag5.useContext(tmp4(5241).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = tmp4(5244).isIOS26OrHigher;
  }
  ...
  if (screenId(5244).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(tmp4(5248).SafeAreaView, obj5);
  }
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(tmp4(5250).FooterComponent, obj7);
  }
