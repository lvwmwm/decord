...
export const useIAP = () => {
  const iAPContext = require("module_11421").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11406").requestPurchase,
    requestSubscription: require("module_11406").requestSubscription
  };
};
