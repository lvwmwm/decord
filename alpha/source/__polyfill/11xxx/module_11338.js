...
export const useIAP = () => {
  const iAPContext = require("module_11339").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11324").requestPurchase,
    requestSubscription: require("module_11324").requestSubscription
  };
};
