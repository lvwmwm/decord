...
export const useIAP = () => {
  const iAPContext = require("module_11415").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11400").requestPurchase,
    requestSubscription: require("module_11400").requestSubscription
  };
};
