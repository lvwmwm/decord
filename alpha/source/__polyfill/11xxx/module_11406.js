// Module ID: 11406
// Function ID: 11407
// Dependencies: [5, 17, 11407, 11408, 11413, 11414, 11415, 11416, 11417]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11414 */;
import _modAll11415 from "module_11415" /* 11415 */;
import _modAll11416 from "module_11416" /* 11416 */;
import syncAll from "sync" /* 11417 */;
...
const subs = fn(11407).ProductType.subs;
const inapp = fn(11407).ProductType.inapp;
...
export const IapAndroid = _modAll11415;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11416;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11408).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11408.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11408.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11408.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11408.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11408.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11408).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11413).singleProductAndroidMap);
      return tmp2(11408).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11408).getAndroidModuleType();
      const androidModule = tmp2(11408).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11407).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11408).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11407).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11408).getAndroidModule();
            ...
            const androidModule1 = v3(11408).getAndroidModule();
