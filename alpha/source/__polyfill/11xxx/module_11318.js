// Module ID: 11318
// Function ID: 11319
// Dependencies: [5, 17, 11319, 11320, 11325, 11326, 11327, 11328, 11329]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11326 */;
import _modAll11327 from "module_11327" /* 11327 */;
import _modAll11328 from "module_11328" /* 11328 */;
import syncAll from "sync" /* 11329 */;
...
const subs = fn(11319).ProductType.subs;
const inapp = fn(11319).ProductType.inapp;
...
export const IapAndroid = _modAll11327;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11328;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11320).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11320.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11320.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11320.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11320.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11320.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11320).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11325).singleProductAndroidMap);
      return tmp2(11320).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11320).getAndroidModuleType();
      const androidModule = tmp2(11320).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11319).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11320).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11319).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11320).getAndroidModule();
            ...
            const androidModule1 = v3(11320).getAndroidModule();
