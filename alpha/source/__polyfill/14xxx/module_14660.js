// Module ID: 14660
// Function ID: 14661
// Dependencies: [14661, 14662, 1252, 14663]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14663.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14663.percentDecode(_Buffer.from(buffer));
  }
}
