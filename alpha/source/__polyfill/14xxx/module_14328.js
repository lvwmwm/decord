// Module ID: 14328
// Function ID: 14329
// Dependencies: [14291, 14320, 14311, 14316, 14312, 14315, 14322, 14319]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14291")(arg0, arg3);
  const tmp4 = new require("module_14320")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14311);
    let tmpResult = tmp(14316);
    const tmpResult3 = tmp(14312);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14312);
      tmpResult = tmp(14315);
      tmpResult4 = tmp(14311);
  ...
  if (require("module_14322")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
