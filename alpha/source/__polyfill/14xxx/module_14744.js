// Module ID: 14744
// Function ID: 14745
// Dependencies: [41, 42, 32, 14738, 14745, 14746]
...
let obj2 = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, _mod14738.implSymbol)) {
        if (arg0[tmp(undefined, 14738).implSymbol] instanceof tmp(14745).implementation) {
          return true;
        }
      }
  ...
  setup(wrapper, arg1) {
    ...
    if (URLSearchParamsImpl.init) {
      tmp2(14745).init(wrapper[tmp2(undefined, 14738).implSymbol], obj);
              ...
              if (arguments.length < 1) {
                ...
                if (0 < arr2.length) {
                  do {
                    ...
                    let _Array = Array;
                    arr3 = Array.from(self[tmp3(undefined, 14738).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr3;
