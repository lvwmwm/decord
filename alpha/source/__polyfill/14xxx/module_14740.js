// Module ID: 14740
// Function ID: 14741
// Dependencies: [14741, 14742, 1252, 14743]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14743.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14743.percentDecode(_Buffer.from(buffer));
  }
}
