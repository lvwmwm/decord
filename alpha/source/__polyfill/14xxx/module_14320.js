// Module ID: 14320
// Function ID: 14321
// Dependencies: [41, 42, 14292, 14319, 14293, 14295, 14294, 14291, 14321]
          ...
          if (typeof parseComparator === "function") {
            ...
            if (typeof replaceCarets === "function") {
              ...
              if (typeof replaceTildes === "function") {
                          ...
                          if (typeof tmp4 === "function") {
                            ...
                            if (tmp6) {
                              ...
                              if (tmp7) {
                                ...
                                tmp(14294)("replaceTilde pr", arg4);
                                const _HermesInternal2 = HermesInternal;
                ...
                tmp2(14294)("tildes", str7);
                if (typeof replaceXRanges === "function") {
                  tmp2(14294)("replaceXRanges", str7, options);
                    ...
                    if (typeof replaceXRange === "function") {
                      ...
                      return str.replace(tmp5, (arg0, arg1, str, str2, str3, arg5) => {
                        ...
                        if (typeof closure_2_9 === "function") {
                          ...
                          tmp2(14294)("xRange return", combined);
                          return combined;
                        } else {
                          throw new TypeError("Trying to call a non-function");
                        }
                  ...
                  tmp2(14294)("xrange", str10);
                  if (typeof replaceStars === "function") {
                    tmp2(14294)("replaceStars", str10, options);
                    const replaced = str10.trim().replace(tmp2(14295).safeRe[tmp2(undefined, 14295).t.STAR], "");
                    tmp2(14294)("stars", replaced);
                    return replaced;
                  } else {
                    throw new TypeError("Trying to call a non-function");
                  }
