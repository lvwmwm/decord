// Module ID: 14607
// Function ID: 14608
// Dependencies: [14608, 1161, 14609]
// Exports: findBestMatch, invariant

// Module 14607
import e from "e" /* 1161 */;
import data from "data" /* 14608 */;
import regions from "regions" /* 14609 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14608).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14608).data.supplemental.languageMatching["written-new"];
