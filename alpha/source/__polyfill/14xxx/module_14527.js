// Module ID: 14527
// Function ID: 14528
// Dependencies: [14528, 1161, 14529]
// Exports: findBestMatch, invariant

// Module 14527
import e from "e" /* 1161 */;
import data from "data" /* 14528 */;
import regions from "regions" /* 14529 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14528).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14528).data.supplemental.languageMatching["written-new"];
