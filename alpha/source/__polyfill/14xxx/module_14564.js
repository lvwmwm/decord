// Module ID: 14564
// Function ID: 14565
// Dependencies: [1161, 14565, 14566, 14630, 14637, 14642, 14657, 14658]
...
function addLikelySubtags(arr3) {
  ...
  if (script) {
    if (region) {
      ...
      const tmp4 = tmp(14630).likelySubtags[tmp(undefined, 14630).emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = tmp(14630).parseUnicodeLanguageId(tmp4);
        ...
        return tmp(14630).emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj4 = { lang, script, variants: [] };
    const tmp5 = tmp(14630).likelySubtags[tmp(undefined, 14630).emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = tmp(14630).parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = tmp(14630).likelySubtags[tmp(undefined, 14630).emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = tmp(14630).parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = tmp(14630).likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = tmp(14630).likelySubtags[tmp(undefined, 14630).emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = tmp(14630).parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            if (tmp(Locale(14630).emitUnicodeLanguageId(obj4)) === result) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = tmp3(14630).emitUnicodeLocaleId(tmp3Result.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj5));
              const __assignResult = tmp3(1161).__assign({}, parseUnicodeLocaleIdResult);
            } else {
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (tmp(tmp3(14630).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = tmp3(14630).emitUnicodeLocaleId(tmp3Result7.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj8));
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (tmp(tmp3(14630).emitUnicodeLanguageId(obj10)) === result) {
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = tmp3(14630).emitUnicodeLocaleId(tmp3Result9.__assign(tmp3(1161).__assign({}, parseUnicodeLocaleIdResult), obj11));
