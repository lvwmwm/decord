// Module ID: 14381
// Function ID: 14382
// Dependencies: [41, 42, 14382, 14383, 14384, 14385, 14386]
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14386).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = tmp3(14386);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14386).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = tmp3(14386);
      }
