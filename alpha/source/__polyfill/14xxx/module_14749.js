// Module ID: 14749
// Function ID: 14750
// Dependencies: [14750, 14751, 1252, 14752]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14752.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14752.percentDecode(_Buffer.from(buffer));
  }
}
