// Module ID: 14372
// Function ID: 14373
// Dependencies: [41, 42, 14373, 14374, 14375, 14376, 14377]
...
let items = [
  ...
  },
  {
    ...
    value: function compare(tmp2Result) {
      const self = this;
      SemVer(14375)("SemVer.compare", this.version, this.options, tmp2Result);
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      let compareIdentifiersResult = SemVer(14377).compareIdentifiers(self.major, tmpResult.major);
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14377).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = tmp3(14377);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14377).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = tmp3(14377);
      }
  ...
  },
  {
    ...
    value: function comparePre(tmp2Result) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14375)("prerelease compare", num3, tmp3, tmp4);
  ...
  },
  {
    ...
    value: function compareBuild(arg0) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14375)("build compare", num, tmp3, tmp4);
        let tmp11 = undefined === tmp3;
        if (tmp11) {
          if (undefined === tmp4) {
            break;
