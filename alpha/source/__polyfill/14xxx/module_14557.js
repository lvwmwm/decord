// Module ID: 14557
// Function ID: 14558
// Dependencies: [14558, 14559, 1161, 14560, 14561]
...
import calendars from "calendars" /* 14558 */;
import hourCycles from "hourCycles" /* 14559 */;
import timezones from "timezones" /* 14560 */;
import weekData from "weekData" /* 14561 */;
...
export const getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = hourCycles.hourCycles[formatted] || tmp2(14559).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
    v001 = tmp2(14559).hourCycles["".concat("", formatted, "-001")];
  }
  if (!v001) {
    v001 = tmp2(14559).hourCycles["001"];
  }
...
export const getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  if (timezones.timezones[formatted]) {
    return tmp2(1161).__spreadArray(items, tmp2(14560).timezones[formatted], true);
  } else {
    return items;
  }
};
