// Module ID: 6106
// Function ID: 6107
// Dependencies: [41, 42, 93, 95, 98, 19, 6107, 6073, 6095, 6093]
...
import PlatformConstants from "module_6107" /* 6107 */;
...
const entry = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(6073).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  entry,
...
if (forceTouchAvailable) {
  ...
  const items2 = [];
  HermesBuiltin.arraySpread(items1, HermesBuiltin.arraySpread(fn(6093).baseGestureHandlerProps, 0));
  obj.allowedProps = items2;
  obj.config = {};
  importDefaultResultResult = _modDef6095(obj);
  const importDefaultResult4 = _modDef6095;
}
let flag;
if (PlatformConstants != null) {
