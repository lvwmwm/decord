// Module ID: 6089
// Function ID: 6090
// Dependencies: [93, 95, 98, 42, 41, 6090, 6073]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6090).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6073).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6073);
      }
      return tmp;
    }
  }
