// Module ID: 6094
// Function ID: 6095
// Dependencies: [93, 95, 98, 42, 41, 6095, 6078]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6095).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6078).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6078);
      }
      return tmp;
    }
  }
