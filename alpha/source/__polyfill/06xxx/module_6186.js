// Module ID: 6186
// Function ID: 6187
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 6187, 6169, 6079]
...
class InnerBaseButton {
  constructor(arg0) {
    ...
    tmp3Result.handleEvent = (nativeEvent) => {
      ...
      let tmp18 = state !== InnerBorderlessButton(6079).State.ACTIVE || pointerInside || undefined === tmp7.longPressTimeout;
      if (tmp18) {
