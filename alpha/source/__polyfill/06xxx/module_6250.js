// Module ID: 6250
// Function ID: 6251
// Dependencies: [32, 109, 19, 21, 6251, 6050, 4708, 6252, 6062, 6047]

// Module 6250
import normalizeSnapPoint from "normalizeSnapPoint" /* 6062 */;
import id from "id" /* 6252 */;
...
const memoResult = memo(forwardRef(function BottomSheetModalComponent(name, arg1) {
  ...
  closure_9 = tmp9[1];
  const bottomSheetModalInternal = require("module_6050").useBottomSheetModalInternal();
