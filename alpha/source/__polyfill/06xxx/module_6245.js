// Module ID: 6245
// Function ID: 6246
// Dependencies: [32, 109, 19, 21, 6246, 6045, 4704, 6247, 6057, 6042]

// Module 6245
import normalizeSnapPoint from "normalizeSnapPoint" /* 6057 */;
import id from "id" /* 6247 */;
...
const memoResult = memo(forwardRef(function BottomSheetModalComponent(name, arg1) {
  ...
  closure_9 = tmp9[1];
  const bottomSheetModalInternal = require("module_6045").useBottomSheetModalInternal();
