// Module ID: 9894
// Function ID: 9895
// Dependencies: [41, 42, 93, 95, 98, 9884, 9883, 9885, 9891]
  ...
  entry,
  {
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (index[3]) {
        ...
        start5.assign("year", tmp8(9883).parseYear(index[3]));
      } else {
        const start4 = parsingResult.start;
        start4.imply("year", tmp8(9885).findYearClosestToRef(createParsingResult.refDate, 1, tmp10));
      }
