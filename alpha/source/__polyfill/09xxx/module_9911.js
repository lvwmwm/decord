// Module ID: 9911
// Function ID: 9912
// Dependencies: [41, 42, 93, 95, 98, 9894, 9898, 9902]
...
const regExp = new RegExp("(" + _mod9894.TIME_UNITS_PATTERN + ")\\s{0,5}(?:later|after|from now|henceforth|forward|out)(?=(?:\\W|$))", "i");
const regExp1 = new RegExp("(" + _mod9894.TIME_UNITS_NO_ABBR_PATTERN + ")\\s{0,5}(later|after|from now)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      const parseDurationResult = ENTimeUnitLaterFormatParser(9894).parseDuration(arg1[1]);
