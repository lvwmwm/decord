...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      if (arg1[2]) {
        parsingComponents.assign("year", tmp2(9989).parseYear(arg1[2]));
      } else {
        parsingComponents.imply("year", tmp2(9896).findYearClosestToRef(createParsingComponents.refDate, 1, tmp4));
      }
