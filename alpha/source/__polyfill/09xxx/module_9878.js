// Module ID: 9878
// Function ID: 9879
// Dependencies: [9879, 9880, 9887, 9889, 9927, 9939, 9952, 9963, 9972, 9990, 10011, 10026, 10036, 10051, 10070]

// Module 9878
import Chrono from "Chrono" /* 9879 */;
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_9880").ParsingContext;
          }
    };
    ...
    exports.de = fn(_mod9927);
    exports.fr = fn(_mod9939);
    exports.ja = fn(_mod9952);
    exports.pt = fn(_mod9963);
    exports.nl = fn(_mod9972);
    exports.zh = fn(_mod9990);
    exports.ru = fn(_mod10011);
    exports.es = fn(_mod10026);
    exports.uk = fn(_mod10036);
    exports.it = fn(_mod10051);
    exports.sv = fn(_mod10070);
