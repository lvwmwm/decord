// Module ID: 9948
// Function ID: 9949
// Dependencies: [41, 42, 93, 95, 98, 9946, 9884, 9885, 9891]
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(9946).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = tmp2(9946).parseOrdinalNumberPattern(index[2]);
