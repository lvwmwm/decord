// Module ID: 9908
// Function ID: 9909
// Dependencies: [41, 42, 93, 95, 96, 98, 9900, 9909]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(9900).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(9900).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
