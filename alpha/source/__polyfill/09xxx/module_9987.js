// Module ID: 9987
// Function ID: 9988
// Dependencies: [41, 42, 93, 95, 98, 9884, 9978, 9887, 9891]
...
const regExp = new RegExp("(dit|deze|(?:aan)?komend|volgend|afgelopen|vorig)e?\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod9978.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLRelativeDateFormatParser(9978).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp2(9887).ParsingComponents;
