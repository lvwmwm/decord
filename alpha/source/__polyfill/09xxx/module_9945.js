// Module ID: 9945
// Function ID: 9946
// Dependencies: [41, 42, 93, 95, 98, 9884, 9946, 9911, 9891]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:(?:ce)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod9946.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(dernier|prochain)\\s*)?(?=\\W|\\d|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const tmp4 = FRWeekdayParser(9946).WEEKDAY_DICTIONARY[formatted];
      if (undefined === tmp4) {
        return null;
      } else {
        ...
        return tmp2(9911).createParsingComponentsAtWeekday(reference.reference, tmp4, str4);
      }
