...
// Dependencies: [5, 19, 17, 502, 1372, 1074, 1229, 21, 4757, 576, 1612, 1478, 1365, 1241, 4960, 4614, 1101, 5111, 5115, 6854, 1115, 5115, 6836, 5343, 4575, 14138, 4753, 7187, 2]
// Exports: default

// Module 14137 (OneTimeLoginModal)
...
export default function OneTimeLoginModal(token) {
  ...
  const obj3 = { dark: token(4575).OverlayOpacity.LEVEL_1 };
  obj2.mixAmount = obj3;
  const items6 = [closure_13(ThemedGradientDefault, obj2), ];
  let obj4 = { style: tmp.container, children: null };
  let obj5 = { style: tmp.centerContent, children: null };
  const items7 = [closure_13(callback3, { source: token(14138), style: tmp.logo }), ];
  ...
  items8[1] = closure_13(token(4753).Text, obj8);
  ...
  const items10 = [closure_13(token(4753).Text, obj10), ];
  ...
  items10[1] = closure_13(token(7187).LinkButton, obj11);
