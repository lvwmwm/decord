...
// Dependencies: [4794, 5030, 11586, 1980, 2]

// Module 11585 (AddImageDescriptionModalActionCreators)
...
export default {
  open(merged) {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11586, dependencyMap.paths), merged, ADD_IMAGE_DESCRIPTION_MODAL_KEY);
  },
  close() {
