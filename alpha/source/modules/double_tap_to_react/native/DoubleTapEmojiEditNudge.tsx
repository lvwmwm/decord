...
// Dependencies: [5, 19, 17, 4749, 1479, 1074, 1375, 21, 4757, 576, 2020, 8230, 1481, 504, 1397, 11392, 1241, 11395, 4753, 1115, 7377, 5341, 2]
// Exports: DoubleTapEmojiEditNudge

// Module 11990 (DoubleTapEmojiEditNudge)
...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  const callback = noop.useCallback(() => {
        ...
        if (c4 === 2) {
          ...
          try {
            ...
            if (0 === c3) {
              ...
              const result = _location(11395).showDoubleTapEmojiUpdatedToast(obj17);
              c4 = 3;
              return { value: "HermesInternal", done: null };
            }
          } catch (tmp12) {
    ...
    let result = _location(11392).openEmojiPickerActionSheet(obj2, "stack");
  }, items2);
  ...
  const items3 = [closure_11(_location(4753).Text, obj4), , ];
  ...
  obj6.children = closure_11(_location(4753).Text, obj7);
