...
// Dependencies: [19, 17, 11991, 21, 9170, 16808, 4827, 576, 4761, 4524, 5277, 8189, 4789, 12041, 504, 8183, 8178, 8181, 7513, 8188, 8265, 1115, 2]
...
const ClipViewDefault = tmp(9170);
require = fn;
function BadgedIcon(arg0) {
  ...
  if (type === SavedMessagesTypes.SavedMessageSortTypes.REMINDER) {
    let BookmarkIcon = tmp4(4789).ClockIcon;
  } else {
    BookmarkIcon = tmp4(12041).BookmarkIcon;
  }
