...
// Dependencies: [21, 11968, 12474, 4719, 2]
...
export const ForLaterCardReminderHeader = function ForLaterCardReminderHeader(savedMessage) {
  ...
  if (null != savedMessage.saveData.dueAt) {
    const obj3 = { IconComponent: tmp(4719).ClockIcon, label: tmp5, isCritical: tmp6, actions };
    tmp7 = jsx(tmp(12474).ForLaterCardStatusHeader, { IconComponent: tmp(4719).ClockIcon, label: tmp5, isCritical: tmp6, actions });
  }
  return tmp7;
};
