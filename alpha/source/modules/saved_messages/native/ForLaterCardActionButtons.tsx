...
// Dependencies: [19, 17, 21, 4757, 4724, 11967, 1980, 11961, 11966, 1115, 11993, 5899, 13604, 10514, 8178, 8183, 8186, 2]
// Exports: default

// Module 13603 (ForLaterCardActionButtons)
...
export default function ForLaterCardActionButtons(savedMessage) {
  ...
  const callback = noop.useCallback(() => ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11967, dependencyMap.paths), "MessageReminderDurationActionSheet", {
    ...
    removeReminder() {
      return savedMessage(11961).removeSavedMessage({ channelId: closure_1_0.saveData.channelId, messageId: closure_1_0.saveData.messageId, displayToast: true, isReminder: true });
    },
