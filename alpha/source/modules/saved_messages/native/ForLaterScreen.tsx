...
// Function ID: 13690
// Name: ForLaterScreen
// Dependencies: [32, 19, 17, 11998, 21, 4829, 576, 4561, 5272, 13690, 8191, 8185, 504, 7495, 7515, 9128, 1249, 1091, 13692, 13698, 9077, 13702, 2]
...
function ForLaterPage(type) {
  ...
  if (0 === arr.length) {
    ...
    if (tmp9) {
      ...
      tmp25Result = tmp25(tmp2(13702), obj10);
    }
