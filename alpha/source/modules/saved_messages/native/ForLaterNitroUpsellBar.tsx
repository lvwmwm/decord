...
// Dependencies: [19, 1374, 8182, 21, 7495, 12047, 12563, 4483, 1115, 2]
// Exports: default

// Module 13702 (ForLaterNitroUpsellBar)
import openForLaterLimitUpsellDefault from "openForLaterLimitUpsell" /* 12047 */;
...
export default function ForLaterNitroUpsellBar(isReminder) {
  ...
  const tmp2 = jsx;
  const tmp3 = analyticsLocations(12563);
  const premiumTypeDisplayName = isReminder(4483).getPremiumTypeDisplayName(PremiumTypes.TIER_2);
