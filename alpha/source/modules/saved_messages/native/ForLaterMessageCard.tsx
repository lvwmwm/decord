...
// Dependencies: [5, 19, 17, 4464, 1074, 21, 4829, 576, 5912, 6940, 4825, 1115, 8269, 4787, 12045, 12052, 5032, 1241, 8191, 4416, 13693, 504, 13694, 13697, 12557, 12558, 2]

// Module 13692 (ForLaterMessageCard)
    ...
    if (null != savedMessageChannel) {
      if (obj2.useStateFromStores(items1, () => {
        ...
        if (null != savedMessage.saveData.dueAt) {
          ...
          tmp6Result = tmp6(tmp2(13697).ForLaterCardReminderHeader, obj5);
        }
