...
// Dependencies: [5, 19, 17, 4462, 1074, 21, 4827, 576, 5910, 6938, 4823, 1115, 8265, 4785, 12038, 12045, 5030, 1241, 8189, 4414, 13684, 504, 13685, 13688, 12548, 12549, 2]

// Module 13683 (ForLaterMessageCard)
...
export default noop.memo(function ForLaterMessageCard(savedMessage) {
  ...
  const savedMessageChannel = savedMessage(12045).useSavedMessageChannel(savedMessage);
                ...
                try {
                  ...
                  if (0 === c1) {
                    if (arg0 === 1) {
                      ...
                      c1 = 1;
                      c2 = 1;
                      const obj5 = { value: v3(12045).savedMessageJumpToMessage(tmp4, c1), done: false };
                      return obj5;
                    }
                  } else if (arg0 === 1) {
                    c2 = 3;
                    ...
                    if (null != tmp4.saveData.dueAt) {
                      let BOOKMARK = v3(8189).SavedMessageSortTypes.REMINDER;
                    } else {
                      BOOKMARK = v3(8189).SavedMessageSortTypes.BOOKMARK;
                    }
                    obj8.type = BOOKMARK;
                    let diffResult;
                    if (null != tmp4.saveData.dueAt) {
                      diffResult = v1(4414)().diff(tmp4.saveData.dueAt);
                      const obj = v1(4414)();
                    }
  ...
  if (null != savedMessage.message) {
    if (null != savedMessageChannel) {
      if (obj2.useStateFromStores(items1, () => {
        ...
        const tmp8 = closure_10(savedMessageChannel(13685), obj3);
        ...
        if (null != savedMessage.saveData.dueAt) {
          ...
          tmp6Result = tmp6(tmp2(13688).ForLaterCardReminderHeader, obj5);
        }
        ...
        obj6.actions = tmp12;
        items2[1] = closure_10(tmp2(12548).ForLaterCardHeader, obj6);
        ...
        items2[3] = closure_10(tmp2(12549).ForLaterMessageRow, obj8);
        obj4.children = items2;
        return closure_11(tmp2(5910).Card, obj4);
      }
    }
  }
