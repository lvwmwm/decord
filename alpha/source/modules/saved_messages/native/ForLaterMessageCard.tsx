...
// Dependencies: [5, 19, 17, 4396, 1074, 21, 4757, 576, 5826, 6854, 4753, 1115, 8183, 4715, 11961, 11968, 4960, 1241, 8107, 4348, 13602, 504, 13603, 13606, 12472, 12473, 2]

// Module 13601 (ForLaterMessageCard)
import nativeDefault from "native" /* 576 */;
import _modDef4715 from "module_4715" /* 4715 */;
...
export default noop.memo(function ForLaterMessageCard(savedMessage) {
  ...
  const savedMessageChannel = savedMessage(11968).useSavedMessageChannel(savedMessage);
                ...
                try {
                  ...
                  if (0 === c1) {
                    if (arg0 === 1) {
                      ...
                      c1 = 1;
                      c2 = 1;
                      const obj5 = { value: v3(11968).savedMessageJumpToMessage(tmp4, c1), done: false };
                      return obj5;
                    }
                  } else if (arg0 === 1) {
                    c2 = 3;
                    ...
                    if (null != tmp4.saveData.dueAt) {
                      let BOOKMARK = v3(8107).SavedMessageSortTypes.REMINDER;
                    } else {
                      BOOKMARK = v3(8107).SavedMessageSortTypes.BOOKMARK;
                    }
                    obj8.type = BOOKMARK;
                    let diffResult;
                    if (null != tmp4.saveData.dueAt) {
  ...
  if (null != savedMessage.message) {
    if (null != savedMessageChannel) {
      if (obj2.useStateFromStores(items1, () => {
        ...
        const tmp8 = closure_10(savedMessageChannel(13603), obj3);
        ...
        if (null != savedMessage.saveData.dueAt) {
          ...
          tmp6Result = tmp6(tmp2(13606).ForLaterCardReminderHeader, obj5);
        }
        ...
        obj6.actions = tmp12;
        items2[1] = closure_10(tmp2(12472).ForLaterCardHeader, obj6);
        ...
        items2[3] = closure_10(tmp2(12473).ForLaterMessageRow, obj8);
        obj4.children = items2;
        return closure_11(tmp2(5826).Card, obj4);
      }
    }
  }
