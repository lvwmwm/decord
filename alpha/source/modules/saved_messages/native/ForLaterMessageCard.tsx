...
// Dependencies: [5, 19, 17, 4466, 1074, 21, 4829, 576, 5914, 6023, 4825, 1115, 7358, 4787, 11190, 11197, 5032, 1241, 7280, 4418, 12847, 504, 12848, 12851, 11683, 11684, 2]

// Module 12846 (ForLaterMessageCard)
import nativeDefault from "native" /* 576 */;
import _modDef4787 from "module_4787" /* 4787 */;
    ...
    if (null != savedMessageChannel) {
      if (obj2.useStateFromStores(items1, () => {
        ...
        if (null != savedMessage.saveData.dueAt) {
          ...
          tmp6Result = tmp6(tmp2(12851).ForLaterCardReminderHeader, obj5);
        }
