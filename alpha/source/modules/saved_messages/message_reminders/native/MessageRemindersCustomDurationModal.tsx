...
// Dependencies: [32, 19, 17, 21, 4757, 576, 1612, 1875, 4724, 9808, 1980, 1115, 5850, 8110, 1364, 5843, 5341, 4753, 2]

// Module 11970 (MessageRemindersCustomDurationModal)
...
export default noop.memo((onClose) => {
  ...
  obj5 = onClose(1364);
  obj3.headerLeft = onClose(5843).getHeaderCloseButton(onClose);
  ...
  const items1 = [error(onClose(5850).Header, obj3), ];
  ...
  const items2 = [error(onClose(4753).Text, obj8), ];
  ...
  obj9.children = error(onClose(4753).Text, { variant: "text-md/medium", children: formatResult });
  ...
  const items4 = [error(onClose(4753).Text, obj10), , ];
  ...
  obj11.children = error(onClose(4753).Text, { variant: "text-md/medium", children: formatResult1 });
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp11(4753).Text, obj12);
  }
