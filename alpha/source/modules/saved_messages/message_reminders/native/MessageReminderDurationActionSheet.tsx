...
// Dependencies: [32, 19, 11998, 21, 4829, 576, 504, 1091, 12052, 7482, 1115, 5427, 5933, 12053, 5910, 4796, 5032, 12054, 1980, 4416, 7483, 5992, 4779, 2]
// Exports: default
...
export default function MessageReminderDurationActionSheet(createReminder) {
  ...
  const memo = obj2.useMemo(() => {
    ...
    if (tmpResult) {
      ...
      obj2.onPress = tmp4;
      obj2.children = tmp(tmp2(5933).ArrowLargeLeftIcon, { size: "md" });
      tmpResult = tmp(tmp2(5427).PressableOpacity, obj2);
    }
