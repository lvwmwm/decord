...
// Dependencies: [32, 19, 11991, 21, 4827, 576, 504, 1091, 12045, 7480, 1115, 5425, 5931, 12046, 5908, 4794, 5030, 12047, 1980, 4414, 7481, 5990, 4777, 2]
// Exports: default
...
export default function MessageReminderDurationActionSheet(createReminder) {
  ...
  const memo = obj2.useMemo(() => {
    ...
    if (tmpResult) {
      ...
      obj2.onPress = tmp4;
      obj2.children = tmp(tmp2(5931).ArrowLargeLeftIcon, { size: "md" });
      tmpResult = tmp(tmp2(5425).PressableOpacity, obj2);
    }
