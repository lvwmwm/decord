...
// Dependencies: [32, 19, 11915, 21, 4757, 576, 504, 1091, 11968, 7396, 1115, 5341, 5847, 11969, 5824, 4724, 4960, 11970, 1980, 4348, 7397, 5906, 4707, 2]
// Exports: default
...
export default function MessageReminderDurationActionSheet(createReminder) {
  ...
  const memo = obj2.useMemo(() => {
    ...
    if (tmpResult) {
      ...
      obj2.onPress = tmp4;
      obj2.children = tmp(tmp2(5847).ArrowLargeLeftIcon, { size: "md" });
