...
// Dependencies: [32, 19, 4821, 504, 1364, 16749, 5894, 2]
// Exports: default

// Module 16748 (usePreloadedAsset)
  ...
  const effect = obj4.useEffect(() => {
    if (null != c0) {
      if (closure_3) {
        ...
        if (dependencyMap) {
          if (null != num(16749)) {
            let preloadResult = num(16749).preload(tmp);
            const obj2 = num(16749);
          }
          preloadResult.then(() => {
            if (!c0) {
              c0 = true;
        ...
        preloadResult = num(5894).preload(tmp, timeout + 1000);
        let obj = num(5894);
      }
    }
  }, items1);
