...
// Dependencies: [19, 17, 2064, 1074, 21, 4531, 4533, 4827, 576, 504, 2056, 1478, 1397, 10097, 4761, 4524, 10098, 5283, 10099, 4823, 10101, 10108, 2]
...
function GuildProfileBackground(guildProfile) {
  ...
  if (stateFromStores) {
    if (null != guildProfile.customBanner) {
      ...
      obj2.size = tmp3(10097)() * useWindowDimensionsDefault().width;
...
export default function GuildProfileView(guildProfile) {
  ...
  if (tmp5Result) {
    ...
    tmp5Result = tmp5(guildProfile(4823).Text, obj3);
  }
