...
// Dependencies: [19, 17, 2064, 1074, 21, 4465, 4467, 4757, 576, 504, 2056, 1478, 1397, 10024, 4691, 4458, 10025, 5199, 10026, 4753, 10028, 10035, 2]
...
function GuildProfileBackground(guildProfile) {
  ...
  if (stateFromStores) {
    if (null != guildProfile.customBanner) {
      ...
      obj2.size = tmp3(10024)() * useWindowDimensionsDefault().width;
...
export default function GuildProfileView(guildProfile) {
  ...
  if (tmp5Result) {
    ...
    tmp5Result = tmp5(guildProfile(4753).Text, obj3);
  }
