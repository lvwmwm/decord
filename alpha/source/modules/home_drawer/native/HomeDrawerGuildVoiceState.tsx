...
// Dependencies: [19, 17, 4394, 4406, 4938, 4781, 1074, 21, 4757, 576, 13325, 1177, 4753, 1115, 10325, 5806, 5199, 16669, 504, 12, 13983, 2]
...
export const GuildVoiceState = function GuildVoiceState(arg0) {
  ...
  if (!tmp2) {
    ...
    if (null == previewUrl) {
      ...
      obj6.source = obj7;
      const items1 = [tmp7(tmp3(5806), obj6), , , , ];
