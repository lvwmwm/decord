...
// Function ID: 7225
// Name: JoinServer
// Dependencies: [19, 17, 7225, 21, 4757, 576, 7226, 4753, 1115, 7228, 1484, 1478, 6849, 5187, 2]
// Exports: default

// Module 7224 (JoinServer)
...
export default function JoinServer(arg0) {
  ...
  if (useWindowDimensionsDefault().height > closure_6) {
    ...
    const items2 = [closure_8(tmp4(4753).Text, obj5), ];
    ...
    items2[1] = closure_8(tmp4(4753).Text, obj6);
  ...
  items3[2] = closure_8(navigation(4753).Text, obj9);
  ...
  items5[1] = closure_8(navigation(5187).Button, obj13);
  ...
  items5[3] = closure_8(navigation(5187).Button, obj14);
