...
// Function ID: 13067
// Name: InviteDetails
// Dependencies: [32, 19, 17, 12762, 1386, 1372, 1074, 13067, 21, 4829, 576, 5746, 8064, 1177, 13007, 4673, 1115, 5895, 4825, 1397, 5892, 1241, 504, 13068, 9953, 5273, 5738, 2]
// Exports: default
...
export default function InviteDetails(invite) {
  ...
  if (tmp8Result) {
    ...
    const items3 = [tmp10(tmp4(9953).GuildEventCardHeader, obj10), , ];
    const obj11 = { event: guild_scheduled_event };
    items3[1] = tmp10(tmp4(9953).GuildEventCardMetaInfo, obj11);
    const obj12 = { event: guild_scheduled_event };
    items3[2] = tmp10(tmp4(9953).GuildEventCardGuildInfo, obj12);
  ...
  if (null != userAvatarSource) {
    ...
    tmp10Result = tmp10(tmp4(5273).Button.Icon, obj13);
  }
  if (null != stateFromStores) {
