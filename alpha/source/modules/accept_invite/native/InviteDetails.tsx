...
// Function ID: 12976
// Name: InviteDetails
// Dependencies: [32, 19, 17, 12671, 1386, 1372, 1074, 12976, 21, 4757, 576, 5660, 7980, 1177, 12916, 4601, 1115, 5809, 4753, 1397, 5806, 1241, 504, 12977, 9875, 5187, 5652, 2]
// Exports: default
...
function InviteHeader(invite) {
  ...
  if (null != name) {
    ...
    items[1] = closure_1_12(tmp2(4753).Heading, obj7);
    obj4.children = items;
    tmp9 = map1(View, obj4);
  }
  return tmp9;
...
export default function InviteDetails(invite) {
  ...
  if (tmp8Result) {
    ...
    const items3 = [tmp10(tmp4(9875).GuildEventCardHeader, obj10), , ];
    const obj11 = { event: guild_scheduled_event };
    items3[1] = tmp10(tmp4(9875).GuildEventCardMetaInfo, obj11);
    const obj12 = { event: guild_scheduled_event };
    items3[2] = tmp10(tmp4(9875).GuildEventCardGuildInfo, obj12);
  ...
  if (null != userAvatarSource) {
    ...
    tmp10Result = tmp10(tmp4(5187).Button.Icon, obj13);
  }
  if (null != stateFromStores) {
