...
// Function ID: 13057
// Name: AcceptInvite
// Dependencies: [32, 19, 17, 1074, 21, 4827, 576, 1370, 4524, 5884, 13057, 13060, 1397, 1431, 13065, 1478, 5910, 2]
// Exports: default

// Module 13056 (AcceptInvite)
...
function AcceptInviteCardComponent(invite) {
  ...
  if (null == invite) {
    ...
    obj2.invite = invite;
    return closure_9(first(13057), obj2);
  } else if (tmp22.ERROR === first) {
    let obj = {};
    const merged1 = Object.assign(invite);
    obj.invite = invite;
    return closure_9(first(13060), obj);
  } else {
    return closure_9(InviteResolving, {});
  }
}
...
export default function AcceptInvite(invite) {
  ...
  if (null == splash) {
    let guildSplashSource = tmp3(13065);
  } else {
