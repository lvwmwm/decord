...
// Function ID: 17123
// Name: RecentScreen
// Dependencies: [32, 5, 19, 7525, 12621, 17123, 12597, 8125, 12611, 1074, 21, 5341, 12619, 1115, 4753, 11130, 17124, 4770, 12616, 12598, 504, 1485, 17127, 12596, 15106, 8686, 8688, 17128, 17129, 17132, 2]

// Module 17122 (RecentScreen)
...
import SearchHistoryStore from "SearchHistoryStore" /* 17123 */;
...
function ClearAllHistory(searchContext) {
  ...
  obj.children = jsx(searchContext(4753).Text, { variant: "text-sm/semibold", color: "text-brand", children: null });
