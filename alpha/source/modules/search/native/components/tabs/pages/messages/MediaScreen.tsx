...
// Function ID: 16492
// Name: MediaScreen
// Dependencies: [19, 6743, 2044, 6694, 11808, 7298, 11822, 1074, 21, 16485, 16428, 16492, 504, 16493, 11807, 4688, 11809, 7700, 16425, 14338, 7851, 7853, 16494, 16498, 16432, 2]
...
export default noop.memo(function MediaScreen(searchContext) {
  ...
  const callback1 = searchMessages.useCallback((media, index) => {
    ...
    if (obj.shouldAgeVerifyForSearchMedia(media, found)) {
      const obj2 = { entryPoint: tmp2(7853).AgeVerificationModalEntryPoint.SEARCH_MEDIA_PREVIEW };
      ...
      obj5.index = index;
      const result1 = tmp2(16494).trackMessageItemPress(obj5);
      onPressMediaItem(media, media.originView);
      const tmp2Result = tmp2(16494);
    }
  }, items4);
