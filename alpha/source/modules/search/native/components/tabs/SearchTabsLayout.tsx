...
// Dependencies: [19, 17, 7609, 12673, 12696, 8207, 1074, 21, 4827, 12, 12692, 17178, 12700, 17179, 17180, 1115, 12674, 17181, 12693, 12672, 17273, 17161, 6983, 4559, 12695, 12681, 12682, 1110, 17274, 17275, 12955, 504, 17276, 17277, 17278, 17279, 2]
// Exports: default
...
const SearchPlatformUtilsDefault = tmp(12672);
require = fn;
function NoSearchResultsScreen(searchContext) {
  ...
  if (obj2.isIntelligenceSearchEmptyOrErrored(obj.useIntelligenceSearchStatus(searchContext).status)) {
    let tmp4Result = tmp4(tmp5(17179), {});
  } else {
    const obj3 = { text: null };
    const intl = tmp(1115).intl;
    obj3.text = intl.string(tmp(1115).t.V6nAfF);
    tmp4Result = tmp4(tmp5(17180), obj3);
    const tmp5Result = tmp5(17180);
  }
  return tmp4Result;
}
