...
export default {
  fetchTabMessages(searchContext) {
    ...
    const tokenizeQueryResult = searchContext(11823).tokenizeQuery(searchQueryString);
    const searchQueryFromTokens = searchContext(11823).getSearchQueryFromTokens(tokenizeQueryResult);
    ...
    const result = searchContext(11823).searchModeToSearchQueryParams(searchMode);
    let obj3 = {};
    const merged = Object.assign(searchQueryFromTokens);
    const merged1 = Object.assign(result);
    const merged2 = Object.assign(searchAnalyticsIds);
    const tmpResult = searchContext(11823);
    guildIdFromSearchContext = searchContext(11823).getGuildIdFromSearchContext(searchContext);
    if (null != guildIdFromSearchContext) {
      tmp(11823).setIncludeNSFW(obj3, guildIdFromSearchContext);
      const tmpResult5 = tmp(11823);
    }
    const tmpResult4 = searchContext(11823);
    ...
    obj4.id = searchContext(11823).getSearchContextId(searchContext);
    ...
    const tmpResult6 = searchContext(11823);
  ...
  fetchMessages(arg0) {
    ...
    let obj2 = {};
    const obj = guildIdFromSearchContext(11823);
    const tokenizeQueryResult = guildIdFromSearchContext(11823).tokenizeQuery(searchQueryString);
    const merged = Object.assign(guildIdFromSearchContext(11823).getSearchQueryFromTokens(tokenizeQueryResult));
    let obj3 = guildIdFromSearchContext(11823);
    const merged1 = Object.assign(guildIdFromSearchContext(11823).searchModeToSearchQueryParams(searchMode));
    const merged2 = Object.assign(searchAnalyticsIds);
    ...
    if (null != guildIdFromSearchContext) {
      tmp(11823).setIncludeNSFW(obj2, guildIdFromSearchContext);
    ...
    searchContextId = guildIdFromSearchContext(11823).getSearchContextId(searchContext);
    const tmp10 = searchContextId;
    const tmpResult2 = guildIdFromSearchContext(11823);
    ...
    const obj7 = searchContextId(11834).create({ id: searchContextId, searchType: searchContext.type, searchQuery: obj2 });
