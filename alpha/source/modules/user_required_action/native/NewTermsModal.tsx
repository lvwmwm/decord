...
// Function ID: 17933
// Name: NewTermsModal
// Dependencies: [5, 32, 19, 17, 2036, 1074, 21, 4757, 576, 7441, 1115, 6836, 1612, 5849, 5182, 8454, 9053, 1249, 4753, 5187, 10017, 9904, 2]
// Exports: default

// Module 17932 (NewTermsModal)
...
export default function NewTermsModal() {
  ...
  memo(5849).useNavigatorBackPressHandler(memo(5182).BackPressHandler.minimize);
  ...
  if (null != memo) {
    ...
    const items2 = [closure_12(tmp6(4753).Text, obj6), , , , , , ];
    ...
    items2[1] = closure_12(tmp6(4753).Text, obj7);
    ...
    items2[2] = closure_12(tmp6(4753).Text, obj9);
    ...
    items2[3] = closure_12(tmp6(4753).Text, obj11);
    ...
    items2[4] = closure_12(tmp6(4753).Text, obj13);
    ...
    items2[5] = closure_12(tmp6(4753).Text, obj15);
    ...
    items2[6] = closure_12(tmp6(4753).Text, obj17);
    ...
    obj18.children = closure_12(tmp6(5187).Button, obj19);
