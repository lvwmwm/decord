...
// Dependencies: [32, 5, 19, 17, 502, 4674, 1372, 12762, 12763, 16803, 1074, 21, 8245, 4829, 576, 504, 1177, 5196, 1115, 12766, 5427, 15663, 16368, 4561, 4830, 8622, 1241, 7456, 16804, 16369, 12772, 16805, 5920, 8951, 11556, 7333, 8194, 11277, 16394, 6922, 7273, 16393, 2]

// Module 16802 (ManageAccountsModal)
...
function RemoveMultiAccountUserButton(user) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            v3 = 1;
            const obj7 = { value: v1(5196).confirm(obj4), done: false };
            return obj7;
          }
        } else if (arg0 === 1) {
          v3 = 3;
          ...
          if (value) {
            v3(12766).removeAccount(closure_128_0.id);
            const obj = v3(12766);
          }
          v3 = 3;
          return { value: "HermesInternal", done: null };
  ...
  if (id === user.id) {
    ...
    obj3.children = closure_18(tmp(15663).CircleMinusIcon, obj4);
    return closure_18(tmp(5427).PressableOpacity, obj3);
  }
  let obj2 = user(504);
}
...
const ManageAccountsScreens = fn(16803).ManageAccountsScreens;
Constants = fn(1074);
...
export default noop.memo(function ManageAccountsModal(initialRouteName) {
  ...
  const items = [
    ...
    closure_18(closure_20.Screen, {
      ...
      children() {
        return closure_1_18(isEditing(16394), {
          handleLogin(login, password, undelete) {
            isEditing(6922).login({ login, password, undelete });
          },
          onReset() {
            isEditing(6922).loginReset(true);
          }
        });
      }
    }),
    closure_18(closure_20.Screen, {
      ...
      children() {
        return closure_1_18(isEditing(7273), { isMultiAccount: true });
      }
    }),
    closure_18(closure_20.Screen, {
      ...
      children() {
        return closure_1_18(isEditing(16393), { isMultiAccount: true });
      }
    })
  ];
  obj2.children = items;
