...
// Dependencies: [19, 5049, 21, 504, 7495, 7515, 11608, 2]
// Exports: default

// Module 11607 (MessageReactions)
...
export default function MessageReactions(emoji) {
  ...
  if (items3.length > 0) {
    ...
    let tmp9Result = tmp9(tmp4(11608).MessageReactionsContent, obj3);
  } else {
    tmp9Result = tmp9(tmp4(11608).MessageReactionsEmpty, {});
  }
  obj2.children = tmp9Result;
  return jsx(items3(7495).AnalyticsLocationProvider, { value: tmp3(AnalyticsLocationDefault.MESSAGE_REACTIONS).analyticsLocations, children: null });
};
