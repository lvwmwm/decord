...
// Dependencies: [19, 5049, 21, 504, 6578, 6598, 10813, 2]
// Exports: default

// Module 10812 (MessageReactions)
...
export default function MessageReactions(emoji) {
  ...
  if (items3.length > 0) {
    ...
    let tmp9Result = tmp9(tmp4(10813).MessageReactionsContent, obj3);
  } else {
    tmp9Result = tmp9(tmp4(10813).MessageReactionsEmpty, {});
  }
  obj2.children = tmp9Result;
  return jsx(items3(6578).AnalyticsLocationProvider, { value: tmp3(AnalyticsLocationDefault.MESSAGE_REACTIONS).analyticsLocations, children: null });
};
