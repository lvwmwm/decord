...
// Dependencies: [19, 17, 4821, 2041, 21, 4561, 504, 4526, 576, 4830, 5272, 4829, 11479, 1115, 9570, 2]
// Exports: default

// Module 11478 (BurstReactionToggle)
...
export default function BurstReactionToggle(arg0) {
  ...
  obj5.style = items2;
  obj4.children = jsx(tmp7(4561).View, { style: null, ref, children: jsx(SuperReactionIcon.SuperReactionIcon, { color: INTERACTIVE_TEXT_DEFAULT }) });
