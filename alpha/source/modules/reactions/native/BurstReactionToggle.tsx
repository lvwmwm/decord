...
// Dependencies: [19, 17, 4821, 2041, 21, 4563, 504, 4528, 576, 4830, 5273, 4829, 10577, 1115, 8668, 2]
// Exports: default

// Module 10576 (BurstReactionToggle)
...
export default function BurstReactionToggle(arg0) {
  ...
  obj5.style = items2;
  obj4.children = jsx(tmp7(4563).View, { style: null, ref, children: jsx(SuperReactionIcon.SuperReactionIcon, { color: INTERACTIVE_TEXT_DEFAULT }) });
