...
// Dependencies: [32, 2043, 13390, 504, 7501, 2]
// Exports: default

// Module 13389 (useEntryActivityAndApplication)
...
export default function useEntryActivityAndApplication(extra) {
  ...
  [activityApplication, obj2.fallbackApplication] = activityApplication(7501)(items1);
  ...
  const tmp4 = activityApplication(7501);
