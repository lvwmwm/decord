...
// Function ID: 7778
// Name: matchUtils
// Dependencies: [1074, 7778, 7780, 7781, 7783, 7784, 7584, 2]
...
function isMatchingListeningActivity(extra, party) {
  if (obj.isListenedSessionEntry(extra)) {
    ...
    let isTopArtistEntryResult = provider === tmp(7783).ContentInventoryListenedMediaProvider.SPOTIFY;
  } else {
    isTopArtistEntryResult = tmp(7781).isTopArtistEntry(extra);
    if (isTopArtistEntryResult) {
      isTopArtistEntryResult = extra.extra.media.provider === tmp(7783).ContentInventoryListenedMediaProvider.SPOTIFY;
    }
