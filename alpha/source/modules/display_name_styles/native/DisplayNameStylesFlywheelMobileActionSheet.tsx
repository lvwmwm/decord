...
// Dependencies: [19, 17, 1372, 1074, 2041, 21, 4547, 4682, 4763, 6395, 504, 4485, 1115, 2876, 6795, 6454, 4651, 2028, 6566, 6539, 6570, 16726, 1364, 5894, 16728, 8263, 4825, 5274, 4829, 576, 2]
// Exports: default
...
export default function DisplayNameStylesFlywheelMobileActionSheet(markAsDismissed) {
  ...
  if (enabled) {
    tmp15Result = tmp15(tmp2(16726).DisplayNameStylesV2AbstractUI, { resizeMode: "contain" });
  }
  ...
  if (enabled) {
    ...
    items4[2] = tmp15(tmp2(4825).Text, obj10);
    ...
    items4[3] = tmp15(tmp2(4825).Text, obj11);
    ...
    const items7 = [tmp15(tmp2(5274).Button, obj14), ];
    ...
    items7[1] = tmp15(tmp2(5274).Button, obj15);
    obj13.children = items7;
    items4[4] = tmp16(tmp17, obj13);
    obj7.children = items4;
    obj12.children = tmp16(tmp17, obj7);
    obj6.children = tmp15(tmp2(6539).SafeAreaPaddingView, obj12);
    return tmp15(tmp2(6566).BottomSheet, obj6);
  } else {
    if (tmp2Result.isIOS()) {
      ...
      let tmp15Result2 = tmp15(tmp4(5894), obj16);
      const tmp4Result = tmp4(5894);
    } else {
      const obj18 = { url: tmp4(16728), style: tmp6.image, autoplay: true };
      tmp15Result2 = tmp15(tmp2(8263).APNGPlayer, obj18);
    }
