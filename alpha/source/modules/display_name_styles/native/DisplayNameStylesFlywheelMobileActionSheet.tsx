...
// Dependencies: [19, 17, 1372, 1074, 2039, 21, 4477, 4608, 4691, 7226, 504, 4415, 1115, 2872, 7627, 7285, 4577, 2028, 7397, 7370, 7401, 5911, 1364, 5806, 17416, 9094, 4753, 5187, 4757, 576, 2]
// Exports: default
...
export default function DisplayNameStylesFlywheelMobileActionSheet(markAsDismissed) {
  ...
  if (enabled) {
    tmp15Result = tmp15(tmp2(5911).DisplayNameStylesV2AbstractUI, { resizeMode: "contain" });
  }
  ...
  if (enabled) {
    ...
    items4[2] = tmp15(tmp2(4753).Text, obj10);
    ...
    items4[3] = tmp15(tmp2(4753).Text, obj11);
    ...
    const items7 = [tmp15(tmp2(5187).Button, obj14), ];
    ...
    items7[1] = tmp15(tmp2(5187).Button, obj15);
    obj13.children = items7;
    items4[4] = tmp16(tmp17, obj13);
    obj7.children = items4;
    obj12.children = tmp16(tmp17, obj7);
    obj6.children = tmp15(tmp2(7370).SafeAreaPaddingView, obj12);
    ...
    if (tmp2Result.isIOS()) {
      ...
      let tmp15Result2 = tmp15(tmp4(5806), obj16);
      const tmp4Result = tmp4(5806);
    } else {
      const obj18 = { url: tmp4(17416), style: tmp6.image, autoplay: true };
      tmp15Result2 = tmp15(tmp2(9094).APNGPlayer, obj18);
    }
