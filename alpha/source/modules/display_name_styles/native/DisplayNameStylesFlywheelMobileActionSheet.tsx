...
// Dependencies: [19, 17, 1372, 1074, 2041, 21, 4545, 4680, 4763, 7312, 504, 4483, 1115, 2876, 7712, 7371, 4649, 2028, 7483, 7456, 7487, 5997, 1364, 5892, 17508, 9169, 4825, 5273, 4829, 576, 2]
// Exports: default
...
export default function DisplayNameStylesFlywheelMobileActionSheet(markAsDismissed) {
  ...
  if (enabled) {
    tmp15Result = tmp15(tmp2(5997).DisplayNameStylesV2AbstractUI, { resizeMode: "contain" });
  }
  ...
  if (enabled) {
    ...
    const items7 = [tmp15(tmp2(5273).Button, obj14), ];
    ...
    items7[1] = tmp15(tmp2(5273).Button, obj15);
    obj13.children = items7;
    items4[4] = tmp16(tmp17, obj13);
    obj7.children = items4;
    obj12.children = tmp16(tmp17, obj7);
    obj6.children = tmp15(tmp2(7456).SafeAreaPaddingView, obj12);
    return tmp15(tmp2(7483).BottomSheet, obj6);
  } else {
    if (tmp2Result.isIOS()) {
      ...
      let tmp15Result2 = tmp15(tmp4(5892), obj16);
      const tmp4Result = tmp4(5892);
    } else {
      const obj18 = { url: tmp4(17508), style: tmp6.image, autoplay: true };
      tmp15Result2 = tmp15(tmp2(9169).APNGPlayer, obj18);
    }
