...
// Dependencies: [32, 19, 17, 1085, 21, 4829, 576, 8518, 15688, 15690, 1392, 1389, 4797, 4796, 7483, 15694, 1115, 2876, 5273, 5271, 14986, 10080, 4825, 4783, 2]
// Exports: default
...
export default function DisplayNameStylesFontPickerSheet(displayName) {
  ...
  if (tmp15Result) {
    ...
    let items2 = [tmp11(tmp2(4783).CircleInformationIcon, { size: "sm" }), ];
    ...
    items2[1] = tmp11(tmp2(4825).Text, obj12);
