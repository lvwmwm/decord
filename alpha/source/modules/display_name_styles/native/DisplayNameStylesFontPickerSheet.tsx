...
// Dependencies: [32, 19, 17, 1085, 21, 4827, 576, 8514, 15674, 15676, 1392, 1389, 4795, 4794, 7481, 15680, 1115, 2874, 5271, 5269, 14977, 10075, 4823, 4781, 2]
// Exports: default
...
export default function DisplayNameStylesFontPickerSheet(displayName) {
  ...
  if (tmp15Result) {
    ...
    let items2 = [tmp11(tmp2(4781).CircleInformationIcon, { size: "sm" }), ];
    ...
    items2[1] = tmp11(tmp2(4823).Text, obj12);
