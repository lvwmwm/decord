...
// Dependencies: [19, 17, 21, 4827, 11248, 11249, 4823, 2]
// Exports: default

// Module 11247 (PerLetterEffect)
...
export default function PerLetterEffect(name) {
  ...
  const memo = noop.useMemo(() => {
    const regex = colors(11248)();
    closure_1 = 0;
    let obj = name(11249);
    return name(11249).splitGraphemes(regex).map((children, index) => {
      regex.lastIndex = 0;
  ...
  obj2.style = items2;
  obj2.children = memo;
  obj.children = jsx(name(4823).Text, {});
