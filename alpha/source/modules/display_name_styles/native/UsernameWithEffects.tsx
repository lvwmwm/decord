...
// Dependencies: [19, 17, 1390, 21, 1391, 4757, 576, 1365, 11167, 4990, 10003, 1389, 4991, 10002, 4458, 11168, 4753, 4763, 4461, 11171, 1370, 2]

// Module 11166 (UsernameWithEffects)
...
export default noop.memo((userName) => {
  ...
  if (STATIC === undefined) {
    STATIC = userName(11167).EffectDisplayType.STATIC;
  }
  ...
  let num2;
  const tmp6 = num2(4990)({ userId, guildId, pendingDisplayNameStyles, ignoreDisabledStylesSetting });
  const isDisplayNameStylesFlywheelViewersEnabled = userName(10003).useIsDisplayNameStylesFlywheelViewersEnabled("UsernameWithEffects");
  const obj = userName(10003);
  ...
  const displayNameStylesEnabled = userName(4991).useDisplayNameStylesEnabled({ location: "UsernameWithEffects" });
  const obj3 = userName(4991);
  const displayNameStylesFont = userName(10002).useDisplayNameStylesFont({ displayNameStyles: result, ignoreDisabledStylesSetting });
  let tmp12;
  ...
  const obj4 = userName(10002);
  const token = userName(4458).useToken(tmp4(576).colors.BACKGROUND_BASE_LOW);
  const tmp7Result = userName(4458);
  const token1 = userName(4458).useToken(tmp4(576).colors.WHITE);
  const tmp7Result7 = userName(4458);
  const displayNameStylesAccessibleColors = userName(11168).useDisplayNameStylesAccessibleColors({ displayNameStyles: result, backgroundColor: token });
  let first;
  ...
  const tmp7Result10 = userName(4763);
  const tmp20 = userName(4753).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
  ...
  if (displayNameStylesEnabled) {
    if (null != tmp6) {
      if (STATIC !== tmp7(11167).EffectDisplayType.PLAIN) {
        if (null != colorVariants) {
          ...
          if (effectId === tmp7(1391).DisplayNameEffect.GUMMY) {
            const tmp4Result = tmp4(11171);
            const tmp66 = closure_9;
            let str3 = tmp7(4461).getNodeText(userName);
            if (str3 == null) {
              str3 = "";
            }
            ...
            if (tmp7(1391).DisplayNameEffect.GRADIENT !== effectId) {
              if (tmp7(1391).DisplayNameEffect.PRISM !== effectId) {
                if (tmp7(1391).DisplayNameEffect.NEON === effectId) {
                  ...
                  if (null != colorVariants) {
                    ...
                    const items6 = [closure_9(tmp7(4753).Text, obj10), ];
                    const obj11 = {};
                    ...
                    items6[1] = closure_9(tmp7(4753).Text, obj11);
              ...
              return closure_9(tmp7(4753).Text, obj13);
            }
      ...
      return closure_9(tmp7(4753).Text, obj14);
    }
  }
  const obj15 = {};
  ...
  return closure_9(userName(4753).Text, obj15);
});
