...
// Dependencies: [32, 19, 17, 1390, 1074, 21, 1092, 14900, 4836, 576, 7615, 10361, 1389, 4801, 4800, 14153, 1241, 6571, 14892, 1115, 2877, 5281, 12, 4783, 14901, 2]
// Exports: default
    ...
    return closure_1_9(first, {
      ...
      children: arr.map((item, index) => {
        ...
        if (tmp) {
          ...
          let str = "black";
          if (darkness > tmp5(14900).DARK_SWATCH_THRESHOLD) {
            str = "white";
          }
          obj5.color = str;
          obj4.children = tmp2(tmp5(4783).CheckmarkLargeIcon, obj5);
