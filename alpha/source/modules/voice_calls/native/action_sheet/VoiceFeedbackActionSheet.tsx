...
// Dependencies: [19, 1074, 11107, 21, 1241, 1115, 2748, 11110, 16292, 16300, 16294, 4796, 16295, 1980, 4524, 2]
// Exports: default

// Module 16299 (VoiceFeedbackActionSheet)
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1980 */;
import _modDef2748 from "module_2748" /* 2748 */;
import ToastUtils from "ToastUtils" /* 4524 */;
import FeedbackUtils from "FeedbackUtils" /* 11110 */;
import FeedbackActionSheetV2Default from "FeedbackActionSheetV2" /* 16292 */;
import shouldShowLogUploadForCategory from "shouldShowLogUploadForCategory" /* 16294 */;
import trackVoiceFeedbackDefault from "trackVoiceFeedback" /* 16300 */;
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj.problemOptions = analyticsData(11110).getConnectionFeedbackOptions();
  ...
  let obj2 = analyticsData(11110);
  obj4.problemOptions = analyticsData(11110).getAudioFeedbackOptions({ isMobile: true });
  ...
  let obj5 = analyticsData(11110);
  obj7.problemOptions = analyticsData(11110).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11110);
  obj10.problemOptions = analyticsData(11110).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11110);
    ...
    if (null != rating) {
      ...
      if (null != reason) {
        if (obj3.shouldShowLogUploadForCategory(rating, category, reason)) {
          ...
          tmp20(4796).openLazy(asyncRequireImpl(16295, dependencyMap.paths), "UploadLogs", { mediaSessionId: null, rtcConnectionId: null });
