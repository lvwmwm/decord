...
// Dependencies: [19, 1074, 11881, 21, 1241, 1115, 2744, 11884, 17017, 17025, 17019, 4724, 17020, 1980, 4454, 2]
// Exports: default

// Module 17024 (VoiceFeedbackActionSheet)
...
import FeedbackActionSheetV2Default from "FeedbackActionSheetV2" /* 17017 */;
import shouldShowLogUploadForCategory from "shouldShowLogUploadForCategory" /* 17019 */;
import trackVoiceFeedbackDefault from "trackVoiceFeedback" /* 17025 */;
...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj.problemOptions = analyticsData(11884).getConnectionFeedbackOptions();
  ...
  let obj2 = analyticsData(11884);
  obj4.problemOptions = analyticsData(11884).getAudioFeedbackOptions({ isMobile: true });
  ...
  let obj5 = analyticsData(11884);
  obj7.problemOptions = analyticsData(11884).getVideoFeedbackOptions();
  ...
  const obj8 = analyticsData(11884);
  obj10.problemOptions = analyticsData(11884).getPeopleFeedbackOptions();
  ...
  const obj11 = analyticsData(11884);
    ...
    if (null != rating) {
      ...
      if (null != reason) {
        if (obj3.shouldShowLogUploadForCategory(rating, category, reason)) {
          ...
          tmp20(4724).openLazy(asyncRequireImpl(17020, dependencyMap.paths), "UploadLogs", { mediaSessionId: null, rtcConnectionId: null });
          const obj7 = { mediaSessionId: null, rtcConnectionId: null };
          const tmp20Result = tmp20(4724);
        }
