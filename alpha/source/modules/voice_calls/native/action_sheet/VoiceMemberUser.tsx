...
// Dependencies: [19, 17, 1182, 502, 5497, 2042, 2105, 1992, 4797, 1074, 21, 4757, 576, 9624, 504, 4608, 14063, 14064, 1177, 14065, 14066, 14067, 14068, 9719, 4753, 1115, 8876, 7983, 10321, 4614, 4964, 4724, 5341, 10008, 4909, 10000, 4601, 2]
...
function StreamingUserRow(user) {
  ...
  if (null != stateFromStores) {
    ...
    if (tmp10Result) {
      ...
      obj4.children = tmp10(channel(10321), obj5);
...
let closure_16 = noop.memo((user) => {
  ...
  if (flag3) {
    ...
    if (!flag) {
      ...
      if (user.isSpectating) {
        const obj9 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14068), style: tmp19 };
      ...
      if (!tmp15) {
        ...
        if (tmp14) {
          const obj10 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14065), style: tmp19 };
        ...
        if (!tmp13) {
          ...
          if (localVideoDisabled) {
            const obj12 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14066), style: tmp2.voiceStatusIconMargin, disableColor: true };
            let obj13 = obj12;
          } else {
            obj13 = { size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp5(14067), style: tmp19 };
          }
          tmp20(tmp8(1177).Icon, obj13);
        }
      } else {
        if (tmp8Result.isThemeDark(stateFromStores)) {
          let tmp5Result = tmp5(14063);
        } else {
          tmp5Result = tmp5(14064);
        }
  ...
  if (localVideoAutoDisabled) {
    ...
    const obj20 = { source: tmp5(9719), size: tmp8(1177).Icon.Sizes.EXTRA_SMALL, disableColor: true };
    ...
    items6[1] = tmp20(tmp8(4753).Text, obj21);
