...
// Dependencies: [19, 17, 4851, 21, 4827, 7493, 7513, 504, 4684, 5034, 14124, 14125, 7528, 14135, 14138, 14139, 5259, 14142, 2]
// Exports: default
...
export default function VoiceActionSheet(channel) {
  ...
  if (obj2.requiresVoiceChannelsOnboard()) {
    ...
    const obj4 = { channel };
    obj3.children = closure_6(tmp2(14135), obj4);
    let children = closure_6(tmp5(7528).ActionSheet, obj3);
    let tmp8 = closure_6;
  } else if (stateFromStores) {
    const obj5 = { children: null };
    const obj6 = { channel };
    const items2 = [closure_6(tmp2(14138), obj6), ];
    const obj7 = { channel };
    items2[1] = closure_6(tmp2(14139), obj7);
    ...
    const items3 = [closure_6(tmp2(5259), obj10), ];
    const obj11 = { channel };
    items3[1] = closure_6(tmp2(14142), obj11);
