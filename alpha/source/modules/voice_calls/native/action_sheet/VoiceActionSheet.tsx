...
// Dependencies: [19, 17, 4781, 21, 4757, 7409, 7429, 504, 4614, 4964, 14042, 14043, 7444, 14053, 14056, 14057, 5175, 14060, 2]
// Exports: default
...
export default function VoiceActionSheet(channel) {
  ...
  if (obj2.requiresVoiceChannelsOnboard()) {
    ...
    const obj4 = { channel };
    obj3.children = closure_6(tmp2(14053), obj4);
    let children = closure_6(tmp5(7444).ActionSheet, obj3);
    let tmp8 = closure_6;
  } else if (stateFromStores) {
    const obj5 = { children: null };
    const obj6 = { channel };
    const items2 = [closure_6(tmp2(14056), obj6), ];
    const obj7 = { channel };
    items2[1] = closure_6(tmp2(14057), obj7);
    ...
    const items3 = [closure_6(tmp2(5175), obj10), ];
    const obj11 = { channel };
    items3[1] = closure_6(tmp2(14060), obj11);
