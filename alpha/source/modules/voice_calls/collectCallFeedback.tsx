...
// Dependencies: [9100, 2044, 1992, 4852, 2098, 1372, 9087, 5009, 9103, 9104, 573, 2]
// Exports: default

// Module 13154 (collectCallFeedback)
import DispatcherDefault from "Dispatcher" /* 573 */;
import AppAnalyticsUtils from "AppAnalyticsUtils" /* 5009 */;
import VideoBackgroundStore from "VideoBackgroundStore" /* 9100 */;
    ...
    if (null != voiceChannelId) {
      if (null != channel) {
        ...
        if (VideoBackgroundStore.hasUsedBackgroundInCall) {
          ...
          const lastUsedVideoBackgroundOption = tmp5(9103).getLastUsedVideoBackgroundOption(UserStore.getCurrentUser());
          ...
          const tmp5Result = tmp5(9103);
          obj7.video_effect_type = tmp5(9104).getEffectAnalyticsType(lastUsedVideoBackgroundOption);
          const tmp5Result3 = tmp5(9104);
          obj7.video_effect_detail = tmp5(9104).getEffectDetailAnalyticsName(lastUsedVideoBackgroundOption);
          const merged2 = Object.assign(obj7);
          const tmp5Result4 = tmp5(9104);
