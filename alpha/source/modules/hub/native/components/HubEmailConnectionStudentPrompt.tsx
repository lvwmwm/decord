...
// Dependencies: [19, 17, 13058, 1074, 21, 4827, 5827, 576, 1484, 13066, 1177, 1115, 7468, 13068, 1241, 13069, 2]
// Exports: default

// Module 13067 (HubEmailConnectionStudentPrompt)
...
export default function HubEmailConnectionStudentPrompt(onClose) {
  ...
  obj6.source = invite(13068);
  obj5.leading = closure_7(closure_4, obj6);
  obj5.trailing = invite(7468).Arrow;
