...
// Dependencies: [19, 17, 12972, 1074, 21, 4756, 5741, 576, 1484, 12980, 1177, 1115, 7382, 12982, 1241, 12983, 2]
// Exports: default

// Module 12981 (HubEmailConnectionStudentPrompt)
...
export default function HubEmailConnectionStudentPrompt(onClose) {
  ...
  obj6.source = invite(12982);
  obj5.leading = closure_7(closure_4, obj6);
  obj5.trailing = invite(7382).Arrow;
