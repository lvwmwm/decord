...
// Dependencies: [19, 17, 12976, 1074, 21, 4757, 5743, 576, 1484, 12984, 1177, 1115, 7384, 12986, 1241, 12987, 2]
// Exports: default

// Module 12985 (HubEmailConnectionStudentPrompt)
...
export default function HubEmailConnectionStudentPrompt(onClose) {
  ...
  obj6.source = invite(12986);
  obj5.leading = closure_7(closure_4, obj6);
  obj5.trailing = invite(7384).Arrow;
