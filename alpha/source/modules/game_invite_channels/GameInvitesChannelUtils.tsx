...
// Dependencies: [109, 19, 2042, 1074, 2049, 7601, 7602, 504, 7603, 7632, 38, 7637, 7494, 7639, 7641, 5811, 2]
...
// Module 7600 (GameInvitesChannelUtils)
...
const MAX_FORUM_POST_TAGS = fn(7601).MAX_FORUM_POST_TAGS;
let c12 = "No Mic";
const size = fn(2);
