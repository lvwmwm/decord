...
// Dependencies: [32, 19, 17, 2042, 21, 4757, 576, 7409, 504, 5849, 13027, 7228, 13029, 4768, 4724, 11518, 1980, 1115, 5341, 5899, 4753, 3614, 7332, 7516, 5906, 5824, 7447, 5187, 2]
// Exports: default

// Module 13028 (CreateGameInvitePostModal)
...
function CreateGameInvitePostContent(parentChannel) {
  ...
  const insets = tags(7228)({ includeKeyboardHeight: true }).insets;
  ...
  const createGameInvitePost = parentChannel(13029).useCreateGameInvitePost({
    parentChannel,
    description: tmp5,
    appliedTagIds: memo,
    upload: NOOP_UPLOAD,
  ...
  obj5.children = closure_7(parentChannel(5899).XSmallIcon, {});
  ...
  items4[1] = closure_7(parentChannel(4753).Text, obj6);
  ...
  if (tmp15Result) {
    ...
    obj10.children = tmp15(tmp9(4753).Text, obj11);
    obj9.trailing = tmp15(tmp14, obj10);
    obj9.onPress = callback1;
    tmp15Result = tmp15(tmp9(5824).TableRow, obj9);
  }
  ...
  items7[1] = closure_7(parentChannel(7447).TableSwitchRow, obj13);
  obj12.children = items7;
  items6[1] = closure_8(parentChannel(5906).TableRowGroup, obj12);
  ...
  obj14.children = closure_7(parentChannel(5187).Button, obj15);
...
export default function CreateGameInvitePostModal(parentChannelId) {
  ...
  parentChannelId(5849).useNavigatorBackPressHandler(() => {
