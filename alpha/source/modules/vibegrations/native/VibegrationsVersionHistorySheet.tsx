...
// Dependencies: [32, 19, 17, 13366, 21, 4757, 576, 7880, 1612, 5115, 1115, 3678, 4724, 4753, 5906, 5824, 7444, 7396, 6871, 2]
// Exports: default

// Module 17003 (VibegrationsVersionHistorySheet)
...
export default function VibegrationsVersionHistorySheet(projectId) {
  ...
  obj7.children = tmp7(projectId(6871).BottomSheetScrollView, { contentContainerStyle: { paddingBottom: onRestore(1612)().bottom }, children: tmp9 });
