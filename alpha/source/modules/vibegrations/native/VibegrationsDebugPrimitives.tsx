...
// Dependencies: [19, 17, 21, 4827, 576, 4823, 1115, 3712, 17137, 5271, 2]
// Exports: DebugMeter, DebugNote, DebugSection, DebugSnapshotToolbar, DebugStatRow

// Module 17140 (VibegrationsDebugPrimitives)
...
export const DebugSnapshotToolbar = function DebugSnapshotToolbar(onRefresh) {
  ...
  if ("loading" === fetchState) {
    ...
    obj3.children = intl2.string(_modDef3712["K+FvtM"]);
    ...
    if (null != generatedAt) {
      ...
      obj4.children = intl.formatToPlainString(_modDef3712["4NpaEk"], obj6);
  ...
  obj7.text = intl3.string(_modDef3712.aw0IJm);
