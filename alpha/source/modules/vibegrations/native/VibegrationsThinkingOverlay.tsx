...
// Dependencies: [19, 17, 13458, 21, 4829, 576, 504, 17127, 5912, 16847, 4825, 1115, 3714, 17125, 2]
// Exports: default

// Module 17151 (VibegrationsThinkingOverlay)
...
export default function VibegrationsThinkingOverlay(projectId) {
  ...
  const text = projectId(17127).useVibegrationsRevealedText(str, { streaming: tmp6 }).text;
  ...
  const obj2 = projectId(17127);
  const tmp9 = closure_8;
  const items2 = [closure_7(projectId(16847).LightbulbIcon, { size: "xs", color: ref(576).colors.TEXT_BRAND }), ];
  const obj8 = { variant: "text-sm/semibold", color: "text-strong", children: null };
  const intl = tmp3(1115).intl;
  obj8.children = intl.string(ref(3714).ltkR4n);
  items2[1] = closure_7(projectId(4825).Text, obj8);
  ...
  if ("" !== text) {
    ...
    obj9.children = tmp7(tmp10(17125), obj10);
    ...
    tmp7Result = tmp7(tmp3(4825).Text, obj11);
  }
  const obj7 = { size: "xs", color: ref(576).colors.TEXT_BRAND };
  items3[1] = tmp7Result;
  obj5.children = items3;
  obj4.children = closure_7(projectId(5912).Card, { variant: "primary", shadow: "high", children: tmp9(closure_5, obj5) });
