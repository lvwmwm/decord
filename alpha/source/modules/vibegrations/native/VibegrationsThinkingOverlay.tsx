...
// Dependencies: [19, 17, 12608, 21, 4829, 576, 504, 16318, 5914, 16033, 4825, 1115, 3714, 16316, 2]
// Exports: default

// Module 16365 (VibegrationsThinkingOverlay)
...
export default function VibegrationsThinkingOverlay(projectId) {
  ...
  const text = projectId(16318).useVibegrationsRevealedText(str, { streaming: tmp6 }).text;
  ...
  const obj2 = projectId(16318);
  const tmp9 = closure_8;
  const items2 = [closure_7(projectId(16033).LightbulbIcon, { size: "xs", color: ref(576).colors.TEXT_BRAND }), ];
  ...
  if ("" !== text) {
    ...
    obj9.children = tmp7(tmp10(16316), obj10);
  ...
  obj4.children = closure_7(projectId(5914).Card, { variant: "primary", shadow: "high", children: tmp9(closure_5, obj5) });
