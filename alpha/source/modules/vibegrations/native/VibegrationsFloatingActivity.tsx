...
// Dependencies: [32, 19, 17, 21, 4829, 576, 4563, 4830, 16349, 5428, 1115, 3714, 9600, 4825, 5845, 2]
// Exports: default
...
export default function VibegrationsFloatingActivity(agents) {
  ...
  if (null == todos) {
    ...
    colors = tmp16(tmp2(5845).ClipboardListIcon, obj12);
    obj10.children = colors;
    tmp16(tmp2(5428).PressableOpacity, obj10);
  }
};
