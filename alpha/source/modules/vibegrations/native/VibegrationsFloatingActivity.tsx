...
// Dependencies: [32, 19, 17, 21, 4827, 576, 4559, 4828, 17109, 5425, 1115, 3712, 10493, 4823, 5841, 2]
// Exports: default
...
export default function VibegrationsFloatingActivity(arg0) {
  ...
  if (null == todos) {
    ...
    colors = tmp16(tmp2(5841).ClipboardListIcon, obj12);
    obj10.children = colors;
    tmp16(tmp2(5425).PressableOpacity, obj10);
  }
};
