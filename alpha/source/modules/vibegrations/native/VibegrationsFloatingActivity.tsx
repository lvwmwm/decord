...
// Dependencies: [32, 19, 17, 21, 4829, 576, 4561, 4830, 17136, 5427, 1115, 3714, 10498, 4825, 5843, 2]
// Exports: default
...
export default function VibegrationsFloatingActivity(arg0) {
  ...
  if (null == todos) {
    ...
    colors = tmp16(tmp2(5843).ClipboardListIcon, obj12);
    obj10.children = colors;
    tmp16(tmp2(5427).PressableOpacity, obj10);
  }
};
