...
// Dependencies: [32, 19, 17, 21, 4757, 576, 17054, 4753, 1115, 3678, 5826, 5187, 6850, 2]
// Exports: default
...
export default function VibegrationsClarificationCard(clarification) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (null != onSubmit) {
      ...
      if (null == result) {
        const result1 = tmp13(17054).formatClarificationAnswers(tmp15, obj);
        if ("" !== result1) {
          tmp(result1);
        }
        const tmp13Result = tmp13(17054);
      } else {
        closure_6(result);
      }
      tmp13 = require;
