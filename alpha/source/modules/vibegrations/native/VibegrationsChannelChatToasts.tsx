...
// Dependencies: [19, 17, 21, 4757, 576, 1115, 4601, 5826, 1177, 4753, 17097, 2]
// Exports: default
...
function ChatToast(message) {
  ...
  if ("" !== trimmed) {
    ...
    const items2 = [hasOwnProperty(tmp2(4753).Text, obj6), ];
    const obj7 = { variant: "text-sm/normal", color: "text-default", lineClamp: 1, children: trimmed };
    items2[1] = hasOwnProperty(tmp2(4753).Text, obj7);
    obj5.children = items2;
    items1[1] = timestampProducer(View, obj5);
    obj3.children = items1;
    obj2.children = timestampProducer(tmp2(5826).Card, obj3);
