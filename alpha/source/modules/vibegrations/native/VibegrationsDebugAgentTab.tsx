...
// Dependencies: [19, 17, 12624, 16403, 21, 4836, 576, 16408, 4832, 16407, 16410, 1115, 3715, 5371, 504, 5281, 16421, 2]
// Exports: default
...
export default function VibegrationsDebugAgentTab(projectId) {
  ...
  if (null == lifetime) {
    ...
    let tmp16Result5 = tmp18(tmp2(16410).DebugNote, obj8);
  } else {
    const obj9 = { label: null, value: null, hint: null };
    const intl35 = tmp2(1115).intl;
    obj9.label = intl35.string(tmp20(3715)["8MSJDH"]);
    ...
    obj9.hint = intl36.formatToPlainString(tmp20(3715)["6Z2KhK"], obj10);
    const items13 = [tmp18(tmp2(16410).DebugStatRow, obj9), , , , ];
    const intl37 = tmp2(1115).intl;
    const orchestrator = lifetime.orchestrator;
    const tmp2Result45 = tmp2(16407);
    const obj11 = { label: intl37.string(tmp20(3715).hk4jJr), value: null, hint: null };
    const intl38 = tmp2(1115).intl;
    const obj12 = { count: null };
    const stringResult = intl37.string(tmp20(3715).hk4jJr);
    const tmp2Result46 = tmp2(16407);
    obj12.count = tmp2Result46.formatCount(tmp2(5371).runeCount(orchestrator));
    obj11.value = intl38.formatToPlainString(tmp20(3715).U98VaN, obj12);
    ...
    items13[1] = tmp18(tmp2(16410).DebugStatRow, obj11);
    const intl39 = tmp2(1115).intl;
    const codegen = lifetime.codegen;
    const tmp2Result50 = tmp2(16407);
    const obj13 = { label: intl39.string(tmp20(3715).R9aduM), value: null, hint: null };
    const intl40 = tmp2(1115).intl;
    const obj14 = { count: null };
    const stringResult1 = intl39.string(tmp20(3715).R9aduM);
    const tmp2Result51 = tmp2(16407);
    obj14.count = tmp2Result51.formatCount(tmp2(5371).runeCount(codegen));
    obj13.value = intl40.formatToPlainString(tmp20(3715).U98VaN, obj14);
    ...
    items13[2] = tmp18(tmp2(16410).DebugStatRow, obj13);
    const intl41 = tmp2(1115).intl;
    const tmp2Result55 = tmp2(16407);
    const stringResult2 = intl41.string(tmp20(3715).Tj6b30);
    ...
    obj15.value = intl42.formatToPlainString(tmp20(3715).U98VaN, obj16);
    ...
    items13[3] = tmp18(tmp2(16410).DebugStatRow, obj15);
    let outcomes;
    if (status != null) {
    ...
    if (null != outcomes) {
      ...
      if (Object.keys(status.agent.outcomes).length > 0) {
        ...
        tmp18Result9 = tmp18(tmp2(16410).DebugStatRow, obj17);
      }
    }
  ...
  if (null == stateFromStores) {
    ...
    let tmp18Result10 = tmp18(tmp2(16410).DebugNote, obj20);
  } else {
    const intl43 = tmp2(1115).intl;
    const total = stateFromStores.total;
    const obj21 = { label: intl43.string(tmp20(3715)["VwF+oY"]), value: null, hint: null };
    const intl44 = tmp2(1115).intl;
    const obj22 = { count: null };
    const stringResult3 = intl43.string(tmp20(3715)["VwF+oY"]);
    const tmp63 = closure_9;
    const tmp2Result62 = tmp2(16407);
    obj22.count = tmp2Result62.formatCount(tmp2(5371).runeCount(total));
    obj21.value = intl44.formatToPlainString(tmp20(3715).U98VaN, obj22);
    ...
    const items14 = [tmp18(tmp2(16410).DebugStatRow, obj21), ];
    const obj23 = { label: null, value: null };
    const intl45 = tmp2(1115).intl;
    obj23.label = intl45.string(tmp20(3715)["kILb+R"]);
    ...
    items14[1] = tmp18(tmp2(16410).DebugStatRow, obj23);
  ...
  if (null != stateFromStores1) {
    if (null != promptCeiling) {
      ...
      const items15 = [tmp18(tmp2(16410).DebugMeter, obj27), ];
      ...
      items15[1] = tmp18(tmp2(16410).DebugStatRow, obj28);
    ...
    if (null != stateFromStores2) {
      ...
      tmp18Result11 = tmp18(tmp2(16410).DebugStatRow, obj30);
    ...
    if (true === pendingTurn) {
      ...
      obj36.text = intl46.string(tmp20(3715)["044+ju"]);
      ...
      obj37.children = intl47.string(tmp20(3715)["8D32H6"]);
    ...
    items12[3] = tmp16(tmp2(16410).DebugSection, obj25);
    if (traceVisible) {
      items12[4] = null;
      if (null != session) {
        ...
        if (null != session) {
          ...
          const items19 = [tmp18(tmp2(16410).DebugStatRow, obj39), , , ];
          ...
          items19[1] = tmp18(tmp2(16410).DebugStatRow, obj40);
          ...
          items19[2] = tmp18(tmp2(16410).DebugStatRow, obj41);
          ...
          if (session.queued_messages > 0) {
            ...
            tmp18Result12 = tmp18(tmp2(16410).DebugStatRow, obj42);
        ...
        if (null != analytics) {
          ...
          tmp18Result13 = tmp18(tmp2(16421).VibegrationsDebugAgentAnalyticsRows, obj44);
        }
        items20[1] = tmp18Result13;
        obj38.children = items20;
        let tmp16Result8 = tmp16(tmp2(16410).DebugSection, obj38);
      } else {
        let analytics1;
        if (status != null) {
      ...
      if (null != limits) {
        ...
        obj48.value = intl29.formatToPlainString(tmp20(3715).U98VaN, obj49);
        items21[2] = tmp18(tmp2(16410).DebugStatRow, obj48);
        const obj50 = { label: null, value: null };
        const intl30 = tmp2(1115).intl;
        obj50.label = intl30.string(tmp20(3715).iEAvzu);
      ...
      obj55.title = intl15.string(tmp20(3715).F5eP7e);
      if (0 === stateFromStores4.length) {
        const obj56 = { children: null };
        const intl17 = tmp2(1115).intl;
        obj56.children = intl17.string(tmp20(3715).j8NMgl);
        let tmp18Result14 = tmp18(tmp2(16410).DebugNote, obj56);
      } else {
        ...
        if (stateFromStores4.length > tmp2(16408).MAX_MODEL_CALL_ROWS) {
          ...
          obj57.children = intl16.formatToPlainString(tmp20(3715)["3hYhpp"], obj58);
          tmp18Result15 = tmp18(tmp2(4832).Text, obj57);
        }
      ...
      tmp18(tmp2(16410).DebugSection, obj55);
    }
  ...
  if (null != promptCeiling) {
    ...
    let formatToPlainStringResult = intl8.formatToPlainString(tmp20(3715).LKGmsP, obj60);
    const tmp2Result86 = tmp2(16407);
  } else {
    const intl7 = tmp2(1115).intl;
    formatToPlainStringResult = intl7.string(tmp20(3715).gPabB9);
  }
  tmp18Result17 = tmp18(tmp2(16410).DebugNote, { children: formatToPlainStringResult });
};
