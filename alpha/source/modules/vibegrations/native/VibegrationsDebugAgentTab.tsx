...
// Dependencies: [19, 17, 12607, 16374, 21, 4829, 576, 16379, 4825, 16378, 16381, 1115, 3714, 5364, 504, 5274, 16392, 2]
// Exports: default
...
export default function VibegrationsDebugAgentTab(projectId) {
  ...
  if (null == lifetime) {
    ...
    let tmp16Result5 = tmp18(tmp2(16381).DebugNote, obj8);
  } else {
    ...
    const items13 = [tmp18(tmp2(16381).DebugStatRow, obj9), , , , ];
    ...
    items13[1] = tmp18(tmp2(16381).DebugStatRow, obj11);
    ...
    items13[2] = tmp18(tmp2(16381).DebugStatRow, obj13);
    ...
    items13[3] = tmp18(tmp2(16381).DebugStatRow, obj15);
    let outcomes;
    if (status != null) {
    ...
    if (null != outcomes) {
      ...
      if (Object.keys(status.agent.outcomes).length > 0) {
        ...
        tmp18Result9 = tmp18(tmp2(16381).DebugStatRow, obj17);
      }
    }
  ...
  if (null == stateFromStores) {
    ...
    let tmp18Result10 = tmp18(tmp2(16381).DebugNote, obj20);
  } else {
    ...
    const items14 = [tmp18(tmp2(16381).DebugStatRow, obj21), ];
    ...
    items14[1] = tmp18(tmp2(16381).DebugStatRow, obj23);
  ...
  if (null != stateFromStores1) {
    if (null != promptCeiling) {
      ...
      const items15 = [tmp18(tmp2(16381).DebugMeter, obj27), ];
      ...
      items15[1] = tmp18(tmp2(16381).DebugStatRow, obj28);
    ...
    if (null != stateFromStores2) {
      ...
      tmp18Result11 = tmp18(tmp2(16381).DebugStatRow, obj30);
    ...
    const items17 = [tmp18(tmp2(5274).Button, obj33), , ];
    let str9 = "text-muted";
    if (null != tmp15) {
      str9 = "text-muted";
    ...
    items17[1] = tmp18(tmp2(4825).Text, obj34);
    let pendingTurn;
    if (tmp15 != null) {
    ...
    if (true === pendingTurn) {
      ...
      const items18 = [tmp18(tmp2(5274).Button, obj36), ];
      ...
      items18[1] = tmp18(tmp2(4825).Text, obj37);
    ...
    items12[3] = tmp16(tmp2(16381).DebugSection, obj25);
    if (traceVisible) {
      items12[4] = null;
      if (null != session) {
        ...
        if (null != session) {
          ...
          const items19 = [tmp18(tmp2(16381).DebugStatRow, obj39), , , ];
          ...
          items19[1] = tmp18(tmp2(16381).DebugStatRow, obj40);
          ...
          items19[2] = tmp18(tmp2(16381).DebugStatRow, obj41);
          ...
          if (session.queued_messages > 0) {
            ...
            tmp18Result12 = tmp18(tmp2(16381).DebugStatRow, obj42);
        ...
        if (null != analytics) {
          ...
          tmp18Result13 = tmp18(tmp2(16392).VibegrationsDebugAgentAnalyticsRows, obj44);
        }
        items20[1] = tmp18Result13;
        obj38.children = items20;
        let tmp16Result8 = tmp16(tmp2(16381).DebugSection, obj38);
      } else {
        let analytics1;
        if (status != null) {
      ...
      if (null != limits) {
        ...
        const items21 = [tmp18(tmp2(16381).DebugStatRow, obj46), , , , , , ];
        ...
        items21[1] = tmp18(tmp2(16381).DebugStatRow, obj47);
        ...
        items21[2] = tmp18(tmp2(16381).DebugStatRow, obj48);
        ...
        items21[3] = tmp18(tmp2(16381).DebugStatRow, obj50);
        ...
        items21[4] = tmp18(tmp2(16381).DebugStatRow, obj52);
        ...
        items21[5] = tmp18(tmp2(16381).DebugStatRow, obj53);
        ...
        items21[6] = tmp18(tmp2(16381).DebugStatRow, obj54);
        obj45.children = items21;
        tmp16Result9 = tmp16(tmp2(16381).DebugSection, obj45);
      ...
      if (0 === stateFromStores4.length) {
        ...
        let tmp18Result14 = tmp18(tmp2(16381).DebugNote, obj56);
      } else {
        ...
        if (stateFromStores4.length > tmp2(16379).MAX_MODEL_CALL_ROWS) {
          ...
          tmp18Result15 = tmp18(tmp2(4825).Text, obj57);
        }
      ...
      tmp18(tmp2(16381).DebugSection, obj55);
    }
  ...
  tmp18Result17 = tmp18(tmp2(16381).DebugNote, { children: formatToPlainStringResult });
};
