...
// Dependencies: [5, 32, 19, 17, 4819, 17129, 13448, 1074, 21, 576, 4827, 1115, 3712, 5361, 9386, 4524, 504, 5452, 11569, 4794, 17130, 12572, 16332, 15336, 4771, 12579, 17131, 4823, 5425, 6944, 8260, 11298, 8955, 4533, 2]
// Exports: default
  ...
  callback5 = obj.useCallback((arg0) => {
    ...
    if (0 !== arg0.length) {
      ...
      if (map.length > diff) {
        ...
        let obj = { count: null };
        VIBEGRATIONS_MAX_ATTACHMENTS_PER_MESSAGE = tmp16(5361).VIBEGRATIONS_MAX_ATTACHMENTS_PER_MESSAGE;
