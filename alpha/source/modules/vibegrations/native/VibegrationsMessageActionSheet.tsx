...
// Dependencies: [19, 21, 8452, 4724, 7436, 4455, 1115, 4703, 7444, 7446, 12083, 2]
// Exports: openMessageAuthorProfile, showVibegrationsMessageActions

// Module 17038 (VibegrationsMessageActionSheet)
...
function VibegrationsMessageActionSheet(content) {
  ...
  if ("" !== content) {
    ...
    const obj3 = { IconComponent: tmp4(4703).CopyIcon };
    obj2.icon = tmp3(tmp4(7446).ActionSheetRow.Icon, obj3);
    obj2.onPress = callback;
    tmp3Result = tmp3(tmp4(7446).ActionSheetRow, obj2);
  }
  ...
  if (null != userId) {
    ...
    let obj4 = { IconComponent: tmp4(12083).UserIcon };
    obj.icon = tmp3(tmp4(7446).ActionSheetRow.Icon, obj4);
    obj.onPress = callback1;
    tmp3Result2 = tmp3(tmp4(7446).ActionSheetRow, obj);
  }
  items2[1] = tmp3Result2;
  return closure_4(content(7444).ActionSheet, { children: closure_5(content(7446).ActionSheetRow.Group, { hasIcons: true, children: items2 }) });
}
const jsxProd = fn(21);
