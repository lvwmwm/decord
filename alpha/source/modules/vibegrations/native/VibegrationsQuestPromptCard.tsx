...
// Dependencies: [5, 32, 19, 17, 8024, 1182, 1074, 21, 4827, 576, 15443, 5750, 8022, 504, 8045, 17123, 4559, 4828, 15451, 11622, 8049, 11628, 4531, 5910, 4823, 1115, 3712, 5271, 2]
// Exports: default

// Module 17122 (VibegrationsQuestPromptCard)
...
import VibegrationsQuestPrompt from "VibegrationsQuestPrompt" /* 17123 */;
...
export default function VibegrationsQuestPromptCard(open) {
  ...
  if (null != quest) {
    ...
    if (tmp2Result8.hasWatchVideoOnMobileTasks(quest)) {
      ...
      watchableQuestResult = tmp2(17123).watchableQuest(quest, obj3);
      const tmp2Result9 = tmp2(17123);
    }
    tmp2Result8 = tmp2(8045);
  }
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != tmp2) {
              const QUEST_BAR_MOBILE = tmp2(5750).QuestContent.QUEST_BAR_MOBILE;
              ...
              if (null == enrolledAt) {
                const obj5 = { questContent: tmp2(5750).QuestContent.QUEST_BAR_MOBILE, questContentCTA: tmp2(8049).QuestContentCTA.START_QUEST, sourceQuestContent: QUEST_BAR_MOBILE };
                dependencyMap = 1;
                c3 = 1;
                const obj6 = { value: tmp2(11622).enrollInQuest(tmp2.id, obj5), done: false };
                return obj6;
              } else {
          ...
          if (value.type === tmp2(11622).QuestEnrollmentResultType.SUCCESS) {
  ...
  if (tmp17) {
    if (null != tmp29) {
      const tmp2Result13 = tmp2(11628);
      const url = tmp2Result13.getQuestAsset(tmp29, tmp2(11628).QuestAssetType.GAME_TILE, tmp2(4531).isThemeDark(stateFromStores1) ? tmp38.DARK : tmp38.LIGHT).url;
      ...
      obj13.children = intl.string(_modDef3712["09LJ+I"]);
      const items7 = [closure_11(tmp2(4823).Text, obj13), ];
      ...
      items7[1] = closure_11(tmp2(4823).Text, obj14);
      ...
      obj18.text = intl3.string(_modDef3712.egO5fO);
      obj18.onPress = tmp31;
      obj17.children = closure_11(tmp2(5271).Button, obj18);
      ...
      obj19.children = closure_11(tmp2(5271).Button, obj20);
      ...
      obj5.children = closure_11(tmp2(5910).Card, obj11);
