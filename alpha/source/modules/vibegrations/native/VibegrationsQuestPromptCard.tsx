...
// Dependencies: [5, 32, 19, 17, 7111, 1182, 1074, 21, 4829, 576, 14622, 5754, 7109, 504, 7132, 16364, 4563, 4830, 14630, 10670, 7136, 10676, 4535, 5914, 4825, 1115, 3714, 5274, 2]
// Exports: default

// Module 16363 (VibegrationsQuestPromptCard)
import nativeDefault from "native" /* 576 */;
import _modDef3714 from "module_3714" /* 3714 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4563 */;
import timing from "timing" /* 4830 */;
import QuestTypes from "QuestTypes" /* 5754 */;
import VibegrationsQuestPrompt from "VibegrationsQuestPrompt" /* 16364 */;
...
export default function VibegrationsQuestPromptCard(open) {
  ...
  if (null != quest) {
    ...
    if (tmp2Result8.hasWatchVideoOnMobileTasks(quest)) {
      ...
      watchableQuestResult = tmp2(16364).watchableQuest(quest, obj3);
      const tmp2Result9 = tmp2(16364);
    }
    tmp2Result8 = tmp2(7132);
  }
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != tmp2) {
              const QUEST_BAR_MOBILE = tmp2(5754).QuestContent.QUEST_BAR_MOBILE;
              ...
              if (null == enrolledAt) {
                const obj5 = { questContent: tmp2(5754).QuestContent.QUEST_BAR_MOBILE, questContentCTA: tmp2(7136).QuestContentCTA.START_QUEST, sourceQuestContent: QUEST_BAR_MOBILE };
                dependencyMap = 1;
                c3 = 1;
                const obj6 = { value: tmp2(10670).enrollInQuest(tmp2.id, obj5), done: false };
                return obj6;
              } else {
          ...
          if (value.type === tmp2(10670).QuestEnrollmentResultType.SUCCESS) {
  ...
  if (tmp17) {
    if (null != tmp29) {
      const tmp2Result13 = tmp2(10676);
      const url = tmp2Result13.getQuestAsset(tmp29, tmp2(10676).QuestAssetType.GAME_TILE, tmp2(4535).isThemeDark(stateFromStores1) ? tmp38.DARK : tmp38.LIGHT).url;
      ...
      obj18.onPress = tmp31;
      obj17.children = closure_11(tmp2(5274).Button, obj18);
      ...
      obj19.children = closure_11(tmp2(5274).Button, obj20);
      ...
      obj5.children = closure_11(tmp2(5914).Card, obj11);
