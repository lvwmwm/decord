...
// Dependencies: [32, 19, 17, 12607, 21, 4829, 576, 4509, 4418, 1612, 16280, 5202, 1115, 3714, 9072, 4796, 8984, 1980, 4825, 5994, 7050, 5912, 6613, 6565, 6040, 9073, 6019, 5274, 2]
// Exports: default

// Module 16279 (VibegrationsRestorePointsSheet)
import nativeDefault from "native" /* 576 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1980 */;
import _modDef4418 from "module_4418" /* 4418 */;
import DateUtils from "DateUtils" /* 4509 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4796 */;
import VibegrationsRestorePanelOp from "VibegrationsRestorePanelOp" /* 16280 */;
...
export default function VibegrationsRestorePointsSheet(projectId) {
  ...
  callback5 = obj.useCallback((mode, startDate, minimumDate, onSubmit) => {
    ...
    obj.openLazy(asyncRequireImpl(8984, dependencyMap.paths), str, { mode, title, startDate, minimumDate: minimumDate[0], maximumDate: minimumDate[1], onSubmit }, "stack");
  }, items6);
