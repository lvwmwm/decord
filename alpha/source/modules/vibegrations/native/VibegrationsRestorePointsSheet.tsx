...
// Dependencies: [32, 19, 17, 13366, 21, 4757, 576, 4439, 4348, 1612, 17005, 5115, 1115, 3678, 9896, 4724, 9808, 1980, 4753, 5906, 7880, 5824, 7444, 7396, 6871, 9897, 6850, 5187, 2]
// Exports: default

// Module 17004 (VibegrationsRestorePointsSheet)
import nativeDefault from "native" /* 576 */;
import asyncRequireImpl from "asyncRequireImpl" /* 1980 */;
import _modDef4348 from "module_4348" /* 4348 */;
import DateUtils from "DateUtils" /* 4439 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4724 */;
import VibegrationsRestorePanelOp from "VibegrationsRestorePanelOp" /* 17005 */;
...
export default function VibegrationsRestorePointsSheet(projectId) {
  ...
  callback5 = obj.useCallback((mode, startDate, minimumDate, onSubmit) => {
    ...
    obj.openLazy(asyncRequireImpl(9808, dependencyMap.paths), str, { mode, title, startDate, minimumDate: minimumDate[0], maximumDate: minimumDate[1], onSubmit }, "stack");
  }, items6);
