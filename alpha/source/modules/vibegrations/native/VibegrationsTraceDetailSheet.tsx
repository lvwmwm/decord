...
function FieldRow(field) {
  if (null != field.field.value) {
    ...
    if (null != iter.chars) {
      ...
      let formatToPlainStringResult = intl2.formatToPlainString(_modDef3715.DdXP0P, obj3);
    } else {
...
function RichEntries(arg0) {
  ...
  if (0 !== entries.length) {
    ...
    obj2.children = intl.string(_modDef3715.fy9PRy);
    let items = [
      ...
      entries.map((children) => {
          ...
          if (true === children.scrubbed) {
            ...
            const intl2 = util.intl;
            obj5.children = intl2.string(_modDef3715.PkIUHD);
          ...
          if (true !== children.truncated) {
            ...
            if (null == children.chars) {
              intl = util.intl;
              let stringResult = intl.string(_modDef3715["1kBG9Z"]);
            } else {
              const intl3 = util.intl;
              const obj6 = { count: children.chars };
              stringResult = intl3.formatToPlainString(_modDef3715.VGSwo4, obj6);
            }
...
export default function VibegrationsTraceDetailSheet(projectId) {
  ...
  if (traceDetailSectionsResult.includes("arguments")) {
    ...
    if ("tool" === findTraceEntryResult.kind) {
      ...
      obj13.title = intl25.string(tmp5(3715).jXY3mm);
  ...
  if (traceDetailSectionsResult.includes("result")) {
    ...
    if ("tool" === findTraceEntryResult.kind) {
      ...
      obj16.title = intl26.string(tmp5(3715).KXrf5F);
      const obj17 = { label: null, value: null };
      const intl27 = tmp2(1115).intl;
      obj17.label = intl27.string(tmp5(3715)["2Aii2k"]);
      ...
      obj17.value = intl28.formatToPlainString(tmp5(3715).DdXP0P, obj18);
      ...
      if (null != findTraceEntryResult.resultAdded) {
        ...
        obj19.label = intl2.string(tmp5(3715).hpGFzS);
      ...
      if (true === findTraceEntryResult.resultTruncated) {
        ...
        obj20.label = intl3.string(tmp5(3715)["UV2R1/"]);
        const intl4 = tmp2(1115).intl;
        obj20.value = intl4.string(tmp5(3715)["1kBG9Z"]);
  ...
  if (traceDetailSectionsResult.includes("usage")) {
    ...
    if ("model" === findTraceEntryResult.kind) {
      ...
      obj22.title = intl29.string(tmp5(3715)["W+4BVk"]);
      ...
      if (null != findTraceEntryResult.inputTokens) {
        ...
        obj27.label = intl9.string(tmp5(3715)["/703Yk"]);
      ...
      if (null != findTraceEntryResult.outputTokens) {
        ...
        obj28.label = intl10.string(tmp5(3715)["6+W0dJ"]);
      ...
      if (null != findTraceEntryResult.cacheReadTokens) {
        ...
        obj29.label = intl11.string(tmp5(3715).VyAl6j);
        ...
        obj29.value = intl12.formatToPlainString(tmp5(3715).lkMc23, obj30);
      ...
      if (null != findTraceEntryResult.costUsd) {
        ...
        obj31.label = intl13.string(tmp5(3715).l9YFEQ);
  ...
  if (traceDetailSectionsResult.includes("diagnostics")) {
    ...
    obj34.title = intl16.string(tmp5(3715).T7SFyZ);
    if (null == findTraceEntryResult1) {
      ...
      if (length > 0) {
        ...
        obj35.label = intl18.string(tmp5(3715).fI6mzD);
        const intl19 = tmp2(1115).intl;
        const obj36 = { count: length };
        obj35.value = intl19.formatToPlainString(tmp5(3715).hO8FYp, obj36);
      ...
      if (null != findTraceEntryResult.turnId) {
        ...
        obj37.label = intl20.string(tmp5(3715).I7cJP0);
      ...
      obj38.label = intl21.string(tmp5(3715)["XVTP/S"]);
      ...
      if (null != formatClockTimeResult) {
        ...
        obj39.label = intl22.string(tmp5(3715).rD7bm0);
      ...
      if ("model" === findTraceEntryResult.kind) {
        ...
        if (null != findTraceEntryResult.stopReason) {
          ...
          obj41.label = intl23.string(tmp5(3715).rxmzYT);
      ...
      obj44.label = intl17.string(tmp5(3715).NnBqcd);
  ...
  obj5.children = closure_5(tmp2(6045).BottomSheetScrollView, obj6);
  return closure_5(tmp2(6618).ActionSheet, obj5);
};
