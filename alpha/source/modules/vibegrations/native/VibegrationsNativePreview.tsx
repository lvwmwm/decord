...
// Dependencies: [32, 19, 17, 8491, 502, 2044, 4844, 1979, 16213, 1074, 8492, 21, 4829, 576, 5914, 4825, 8743, 12428, 16253, 8752, 16254, 16255, 16262, 1115, 3714, 5274, 504, 7042, 8379, 6579, 4842, 6526, 10869, 1364, 16264, 2]
// Exports: default, leaveVibegrationsPreviewFrame

// Module 16252 (VibegrationsNativePreview)
...
import UserProfileApplicationWidgetCardDefault from "UserProfileApplicationWidgetCard" /* 8379 */;
...
function PreviewBot(previewApplicationId) {
  ...
  if (!application.isLoading) {
    ...
    if (tmp9) {
      ...
      tmp19Result = tmp19(tmp2(5274).Button, obj4);
    }
  ...
  if (null == stateFromStores) {
    ...
    if (tmp2Result6.isAndroid()) {
      tmp29Result = tmp29(tmp2(16264).PortalKeyboardRenderer, { portal: true });
    }
