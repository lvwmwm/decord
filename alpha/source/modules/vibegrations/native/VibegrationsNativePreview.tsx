...
// Dependencies: [32, 19, 17, 9393, 502, 2044, 4844, 1979, 17023, 1074, 9394, 21, 4829, 576, 5912, 4825, 9645, 13278, 17062, 9654, 17063, 17064, 17071, 1115, 3714, 5273, 504, 7957, 9281, 7496, 4842, 7443, 11689, 1364, 17073, 2]
// Exports: default, leaveVibegrationsPreviewFrame

// Module 17061 (VibegrationsNativePreview)
...
import UserProfileApplicationWidgetCardDefault from "UserProfileApplicationWidgetCard" /* 9281 */;
...
function PreviewBot(previewApplicationId) {
    ...
    if (null != c0) {
      if (null == stateFromStores) {
        if (!closure_3) {
          ...
          stateFromStores(4842).openPrivateChannel(obj2).catch(() => {
            if (!c0) {
              closure_2(id);
            }
          });
  ...
  if (!application.isLoading) {
    ...
    if (tmp9) {
      ...
      tmp19Result = tmp19(tmp2(5273).Button, obj4);
    }
  ...
  if (null == stateFromStores) {
    ...
    if (tmp2Result6.isAndroid()) {
      tmp29Result = tmp29(tmp2(17073).PortalKeyboardRenderer, { portal: true });
    }
