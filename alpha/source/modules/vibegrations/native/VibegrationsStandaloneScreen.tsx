...
// Dependencies: [32, 5, 19, 17, 5063, 2108, 2067, 4469, 16241, 16243, 12624, 8495, 1074, 2052, 8500, 21, 4836, 576, 1101, 6584, 1115, 3715, 7055, 5917, 9023, 16244, 7365, 1613, 1485, 504, 5370, 4800, 16245, 16257, 16259, 16264, 6616, 10413, 16269, 16270, 4832, 5281, 8496, 16271, 4512, 4421, 5999, 16273, 4566, 16274, 16276, 8503, 16278, 8498, 12446, 16279, 16277, 1479, 9083, 16280, 16301, 16302, 4528, 16303, 16305, 14638, 4527, 16306, 2021, 16307, 16281, 12450, 16309, 8674, 6798, 15343, 5936, 16312, 7358, 16313, 9084, 16334, 5372, 16402, 6421, 2]
// Exports: default
...
const VibegrationsHeaderIconButtonDefault = tmp10(16244);
require = fn;
function ProjectRow(project) {
  ...
  if (null != project.updated_at) {
    ...
    obj2.time = tmp(7055).getRelativeTimestamp(date.getTime());
