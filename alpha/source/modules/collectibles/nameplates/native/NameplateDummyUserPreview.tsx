...
// Dependencies: [19, 17, 1182, 21, 1177, 576, 4757, 504, 4465, 9104, 9106, 9107, 2]
// Exports: NameplateDummyUserPreview

// Module 9103 (NameplateDummyUserPreview)
...
export const NameplateDummyUserPreview = function NameplateDummyUserPreview(hideAvatar) {
  ...
  obj4.children = hasOwnProperty(native.Avatar, { source: importDefault(stateFromStores ? 9106 : 9107), size: NORMAL, "aria-hidden": true, style: tmp3.avatar });
