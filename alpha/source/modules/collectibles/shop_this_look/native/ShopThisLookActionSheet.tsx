...
// Dependencies: [19, 17, 8567, 7484, 7541, 21, 4829, 576, 9133, 4523, 1115, 9233, 504, 13515, 7883, 13517, 11390, 9198, 8563, 13493, 7495, 7515, 4796, 7871, 11504, 4825, 2]
// Exports: default

// Module 13514 (ShopThisLookActionSheet)
...
import ShopThisLookUtils from "ShopThisLookUtils" /* 13515 */;
...
function ShopThisLookCard(skuId) {
  ...
  const collectiblesShopProduct = skuId(9233).useCollectiblesShopProduct(skuId, { needsCategory: false, shouldFetchProduct: false });
  ...
  const memo1 = stateFromStores.useMemo(() => {
    if (null == c2) {
      ...
      if (obj.getIsVariantProduct(tmp)) {
        ...
        return tmp2(7883).getSelectedProduct(tmp, bound);
      } else {
        return tmp;
      }
  ...
  if ("loading" === collectiblesShopProduct.state) {
    ...
    let tmp23 = closure_9(onPress(9133), obj3);
  } else {
    tmp23 = null;
    if (null != stateFromStores) {
      if (memo) {
        ...
        const items7 = [closure_9(onPress(11390), obj5), ];
        ...
        if (tmp17Result) {
          ...
          tmp17Result = tmp17(tmp18(9198), callback1);
        }
        ...
        const obj6 = { sku: stateFromStores, size, overlay: tmp(9133).WishlistItemCardOverlay.LOCKED, onPress: tmp10 };
        tmp15Result = closure_9(onPress(11390), obj6);
        const tmp13 = onPress(11390);
      }
    }
  }
  return tmp23;
...
let obj6 = {};
const merged = Object.assign(fn(9133).CARD_TOP_RIGHT_OVERLAY_POSITION);
obj6.zIndex = 1;
...
export default function ShopThisLookActionSheet(arg0) {
  ...
  ({ cardWidth: c0, rowWidth, gap } = analyticsLocations(13493)({ maxWidth: ACTION_SHEET_MAX_WIDTH }));
  const tmp2 = analyticsLocations(13493)({ maxWidth: ACTION_SHEET_MAX_WIDTH });
  analyticsLocations = analyticsLocations(7495)(analyticsLocations(7515).USER_PROFILE_OVERFLOW_MENU).analyticsLocations;
  ...
  const items1 = [analyticsLocations(7515).SHOP_THIS_LOOK_ACTION_SHEET];
  obj3.value = items1;
  ...
  obj3.children = closure_9(analyticsLocations(11504), obj4);
