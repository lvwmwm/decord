...
// Dependencies: [19, 17, 6653, 1074, 21, 4829, 576, 8219, 6968, 8305, 6969, 8307, 8318, 4825, 1115, 8290, 1364, 8319, 8114, 7616, 4485, 4528, 4680, 8321, 504, 5286, 8322, 2]
...
const CollectiblesShopCardVariantsDefault = tmp4(8322);
require = fn;
