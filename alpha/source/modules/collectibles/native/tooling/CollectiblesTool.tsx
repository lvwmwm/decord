...
// Dependencies: [32, 19, 17, 7787, 7802, 8476, 21, 4757, 576, 9049, 4753, 5188, 563, 11000, 16045, 1177, 11351, 2]
// Exports: default

// Module 16044 (CollectiblesTool)
...
let closure_9 = fn(8476).useFramePreviewOverrideStore;
const jsxProd = fn(21);
