...
// Dependencies: [19, 17, 4819, 21, 4827, 576, 5927, 5030, 9205, 11438, 504, 5890, 12119, 8653, 12120, 7454, 9200, 4823, 1115, 5271, 8511, 9203, 7331, 2]
// Exports: default
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    let tmp9Result = tmp9(onPressViewBadge(5890), obj3);
    ...
    tmp9Result = tmp9(tmp2(8653).VideoComponent, obj5);
