...
// Dependencies: [19, 17, 4749, 21, 4757, 576, 5843, 4960, 9134, 11362, 504, 5806, 12042, 8582, 12043, 7370, 9129, 4753, 1115, 5187, 8440, 9132, 7247, 2]
// Exports: default
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    let tmp9Result = tmp9(onPressViewBadge(5806), obj3);
    ...
    tmp9Result = tmp9(tmp2(8582).VideoComponent, obj5);
