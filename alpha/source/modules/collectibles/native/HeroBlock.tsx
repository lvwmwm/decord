...
// Function ID: 15434
// Name: HeroBlock
// Dependencies: [19, 17, 6962, 1076, 1074, 21, 8226, 4836, 576, 8337, 15434, 1485, 8229, 504, 10682, 4767, 15435, 4531, 4683, 15436, 14604, 6583, 6603, 15438, 1241, 4685, 15440, 15441, 15442, 5293, 4832, 5281, 1115, 10678, 5761, 5435, 6630, 6577, 15443, 8179, 2]
// Exports: default

// Module 15433 (HeroBlock)
...
import FeaturedFirstCardCoachmarkAnchorDefault from "FeaturedFirstCardCoachmarkAnchor" /* 15438 */;
  ...
  if (undefined === stateFromStores) {
    ...
    if (!tmp4) {
      ...
      if (tmp4) {
        ...
        let tmp22Result9 = tmp22(tmp6(15443), obj30);
