...
// Dependencies: [5, 32, 19, 1074, 3, 11289, 7786, 4724, 11351, 1609, 7561, 4430, 4455, 1115, 2]
// Exports: default, useHandleBuyNow

// Module 13478 (useHandleBuyNow)
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(7786).fetchCollectiblesPurchases(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
