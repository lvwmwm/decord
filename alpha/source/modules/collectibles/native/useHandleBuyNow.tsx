...
// Dependencies: [5, 32, 19, 1074, 3, 11365, 7869, 4794, 11427, 1609, 7645, 4496, 4521, 1115, 2]
// Exports: default, useHandleBuyNow

// Module 13560 (useHandleBuyNow)
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(7869).fetchCollectiblesPurchases(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
