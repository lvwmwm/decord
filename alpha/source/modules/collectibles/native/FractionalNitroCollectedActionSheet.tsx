...
// Dependencies: [19, 17, 1074, 1374, 21, 4757, 576, 9130, 5806, 13472, 4691, 7832, 4608, 10990, 10991, 4753, 1115, 2108, 4452, 7397, 7676, 5341, 11377, 5187, 4724, 7401, 2]
// Exports: default
...
export default function FractionalNitroCollectedActionSheet(skuId) {
  ...
  const memo = noop.useMemo(() => {
    if (consumed) {
      ...
      if (obj2.isThemeDark(closure_3)) {
        let tmp8Result = tmp8(10990);
      } else {
        tmp8Result = tmp8(10991);
      }
  ...
  if (consumed) {
    ...
    let tmp12Result = tmp12(tmp2(7676), obj2);
    let tmp15 = tmp12;
  } else {
    let obj3 = { skuId };
