...
// Dependencies: [19, 17, 1074, 1374, 21, 4827, 576, 9201, 5890, 13554, 4761, 7915, 4678, 11066, 11067, 4823, 1115, 2108, 4518, 7481, 7759, 5425, 11453, 5271, 4794, 7485, 2]
// Exports: default
...
export default function FractionalNitroCollectedActionSheet(skuId) {
  ...
  const memo = noop.useMemo(() => {
    if (consumed) {
      ...
      if (obj2.isThemeDark(closure_3)) {
        let tmp8Result = tmp8(11066);
      } else {
        tmp8Result = tmp8(11067);
      }
  ...
  if (consumed) {
    ...
    let tmp12Result = tmp12(tmp2(7759), obj2);
    let tmp15 = tmp12;
  } else {
    let obj3 = { skuId };
