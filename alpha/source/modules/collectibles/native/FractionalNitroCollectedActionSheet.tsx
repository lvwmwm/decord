...
// Dependencies: [19, 17, 1074, 1374, 21, 4829, 576, 9205, 5892, 13563, 4763, 7917, 4680, 11072, 11073, 4825, 1115, 2110, 4520, 7483, 7761, 5427, 11459, 5273, 4796, 7487, 2]
// Exports: default
...
export default function FractionalNitroCollectedActionSheet(skuId) {
  ...
  const memo = noop.useMemo(() => {
    if (consumed) {
      ...
      if (obj2.isThemeDark(closure_3)) {
        let tmp8Result = tmp8(11072);
      } else {
        tmp8Result = tmp8(11073);
      }
  ...
  if (consumed) {
    ...
    let tmp12Result = tmp12(tmp2(7761), obj2);
    let tmp15 = tmp12;
  } else {
    let obj3 = { skuId };
