...
// Dependencies: [19, 17, 1074, 1374, 21, 4756, 576, 9125, 5804, 13464, 4690, 7829, 4607, 10984, 10985, 4752, 1115, 2108, 4451, 7395, 7673, 5339, 11373, 5186, 4723, 7399, 2]
// Exports: default
...
export default function FractionalNitroCollectedActionSheet(skuId) {
  ...
  const memo = noop.useMemo(() => {
    if (consumed) {
      ...
      if (obj2.isThemeDark(closure_3)) {
        let tmp8Result = tmp8(10984);
      } else {
        tmp8Result = tmp8(10985);
      }
  ...
  if (consumed) {
    ...
    let tmp12Result = tmp12(tmp2(7673), obj2);
    let tmp15 = tmp12;
  } else {
    let obj3 = { skuId };
