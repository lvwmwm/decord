...
// Dependencies: [32, 19, 17, 1076, 21, 8218, 576, 4829, 8250, 5402, 6968, 1973, 7609, 8252, 5894, 8298, 1077, 8299, 8265, 8254, 8277, 8279, 4680, 4528, 8219, 2]

// Module 8297 (CollectiblesShopCardAssetTileV2)
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1973).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      let size = { skuId: product.skuId, width: tmp2(8299).FRACTIONAL_NITRO_COIN_SIZE.CARD, height: tmp2(8299).FRACTIONAL_NITRO_COIN_SIZE.CARD };
      return closure_7(tmp2(8299).FractionalNitroCoinIllustration, size);
    } else {
      ...
      if (tmp2(1973).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj9 = { profileFrame: first, previewWidth: tmp2(8218).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32, previewHeight, profileBackgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW };
