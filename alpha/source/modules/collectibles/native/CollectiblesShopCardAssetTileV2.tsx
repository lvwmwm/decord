...
// Dependencies: [32, 19, 17, 1076, 21, 9124, 576, 4829, 9156, 5401, 7883, 1973, 8519, 9158, 5892, 9204, 1077, 9205, 9171, 9160, 9183, 9185, 4678, 4526, 9125, 2]

// Module 9203 (CollectiblesShopCardAssetTileV2)
...
function ProductPreviewInner(arg0) {
  ...
  if (product.type === cardWidth(1973).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      let size = { skuId: product.skuId, width: tmp2(9205).FRACTIONAL_NITRO_COIN_SIZE.CARD, height: tmp2(9205).FRACTIONAL_NITRO_COIN_SIZE.CARD };
      return closure_7(tmp2(9205).FractionalNitroCoinIllustration, size);
    } else {
      ...
      if (tmp2(1973).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj9 = { profileFrame: first, previewWidth: tmp2(9124).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32, previewHeight, profileBackgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW };
