...
// Dependencies: [19, 17, 21, 4829, 9124, 16236, 9231, 16237, 2]
// Exports: default

// Module 16235 (FeedProductList)
import CollectiblesShopCardsGridDefault from "CollectiblesShopCardsGrid" /* 16237 */;
...
function SkeletonGrid(accessibilityLabel) {
  ...
  num = undefined;
  const tmp = closure_5();
  const cardLayout = num(16236).useCardLayout();
  ...
  for (let num = 0; num < loadingCardsNum; num = num + columns) {
    ...
    obj3.children = arr.map((item, index) => {
      ...
      const obj2 = { marginBottom: num(9124).COLLECTIBLES_SHOP_CARD_GAP };
      obj.style = obj2;
      return closure_4(closure_1(9231), obj, "" + num + "-" + index);
    });
...
let obj2 = { skeletonGrid: { flex: 1, alignItems: "center" }, skeletonRow: { flexDirection: "row", gap: fn(9124).COLLECTIBLES_SHOP_CARD_GAP, paddingBottom: fn(9124).COLLECTIBLES_SHOP_CARD_GAP } };
