...
// Dependencies: [19, 17, 7877, 1971, 7878, 7879, 8570, 9159, 21, 576, 4829, 9171, 9183, 5892, 9184, 9162, 1970, 9179, 2]

// Module 13540 (CollectiblesItemMiniPreview)
...
let closure_8 = fn(8570).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
