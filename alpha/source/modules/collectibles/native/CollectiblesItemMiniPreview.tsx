...
// Dependencies: [19, 17, 7789, 1971, 7790, 7791, 8491, 9079, 21, 576, 4756, 9091, 9103, 5804, 9104, 9082, 1970, 9099, 2]

// Module 13443 (CollectiblesItemMiniPreview)
...
let closure_8 = fn(8491).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
