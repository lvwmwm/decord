...
// Function ID: 16241
// Name: FeedBlock
// Dependencies: [19, 17, 4821, 1182, 6924, 1076, 1074, 21, 4829, 576, 504, 4680, 16228, 16241, 15411, 7871, 7515, 7495, 1115, 4825, 5427, 4796, 16242, 1980, 4783, 5273, 16235, 16243, 1364, 9170, 16244, 5892, 16245, 16246, 2]
// Exports: default
...
export default function _default(feedBlock) {
  ...
  if (isPersonalized) {
    ...
    isPersonalized = tmp12(tmp(5427).PressableOpacity, obj9);
  }
  ...
  if (screen !== constants.ORBS) {
    ...
    tmp12Result = tmp12(tmp(5273).Button, obj10);
  }
  ...
  if (screen === constants.ORBS) {
    if (stateFromStores2) {
      ...
      if (tmpResult.isAndroid()) {
        ...
        tmp12Result2 = tmp12(tmp5(9170), obj16);
        ...
        tmp12Result2 = tmp12(tmp5(5892), obj17);
    ...
    return tmp12(tmp(7495).AnalyticsLocationProvider, obj5);
  }
};
