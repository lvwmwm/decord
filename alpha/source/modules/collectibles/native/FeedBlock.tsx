...
// Function ID: 16166
// Name: FeedBlock
// Dependencies: [19, 17, 4749, 1182, 6838, 1076, 1074, 21, 4757, 576, 504, 4608, 16153, 16166, 15350, 7786, 7429, 7409, 1115, 4753, 5341, 4724, 16167, 1980, 4711, 5187, 16160, 16168, 1364, 9095, 16169, 5806, 16170, 16171, 2]
// Exports: default
...
export default function _default(feedBlock) {
  ...
  if (isPersonalized) {
    ...
    obj9.children = tmp12(tmp(4711).CircleInformationIcon, { size: "xs" });
    isPersonalized = tmp12(tmp(5341).PressableOpacity, obj9);
  }
  ...
  if (screen !== constants.ORBS) {
    ...
    tmp12Result = tmp12(tmp(5187).Button, obj10);
  }
  ...
  if (screen === constants.ORBS) {
    if (stateFromStores2) {
      ...
      if (tmpResult.isAndroid()) {
        ...
        tmp12Result2 = tmp12(tmp5(9095), obj16);
        ...
        tmp12Result2 = tmp12(tmp5(5806), obj17);
    ...
    return tmp12(tmp(7409).AnalyticsLocationProvider, obj5);
  }
};
