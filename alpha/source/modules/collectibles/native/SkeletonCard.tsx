...
// Function ID: 9228
// Name: SkeletonCard
// Dependencies: [19, 21, 4827, 576, 9120, 4559, 4828, 2]
// Exports: default

// Module 9227 (SkeletonCard)
...
export default function _default(width) {
  ...
  if (COLLECTIBLES_SHOP_CARD_WIDTH === undefined) {
    COLLECTIBLES_SHOP_CARD_WIDTH = sharedValue(9120).COLLECTIBLES_SHOP_CARD_WIDTH;
  }
  let COLLECTIBLES_SHOP_CARD_HEIGHT = width.height;
  sharedValue = undefined;
  if (COLLECTIBLES_SHOP_CARD_HEIGHT == null) {
    COLLECTIBLES_SHOP_CARD_HEIGHT = sharedValue(9120).COLLECTIBLES_SHOP_CARD_HEIGHT;
  }
  ...
  const animatedStyle = sharedValue(4559).useAnimatedStyle(C);
