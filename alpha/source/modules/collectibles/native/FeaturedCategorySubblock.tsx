...
// Dependencies: [19, 17, 7787, 1076, 1074, 21, 4757, 1484, 9052, 504, 16152, 16159, 5341, 1115, 576, 1241, 7786, 7429, 7799, 9116, 2]
// Exports: default
...
export default function _default(subblock) {
  ...
  if (result) {
    ...
    result = tmp11(tmp2(9116).LimitedTimeBadge, obj11);
  }
  items1[1] = result;
