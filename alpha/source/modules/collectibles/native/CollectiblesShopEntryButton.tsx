...
// Dependencies: [32, 19, 7829, 2039, 21, 7633, 2028, 17268, 12395, 1115, 17270, 563, 14262, 7810, 10891, 2]
// Exports: default
...
export default function CollectiblesShopEntryButton(navigateToShop) {
  ...
  if (type === navigateToShop(7810).CollectiblesMarketingType.COACHMARK) {
    ...
    if (tmp4) {
      ...
      let tmp15Result = tmp15(tmp(10891).SelectedVersionedDismissibleContent, obj3);
    } else {
      let type2;
      if (stateFromStores != null) {
