...
// Dependencies: [32, 19, 7912, 2039, 21, 7716, 2028, 17337, 12471, 1115, 17339, 563, 14345, 7893, 10967, 2]
// Exports: default
...
export default function CollectiblesShopEntryButton(navigateToShop) {
  ...
  if (type === navigateToShop(7893).CollectiblesMarketingType.COACHMARK) {
    ...
    if (tmp4) {
      ...
      let tmp15Result = tmp15(tmp(10967).SelectedVersionedDismissibleContent, obj3);
    } else {
      let type2;
      if (stateFromStores != null) {
