...
// Dependencies: [19, 17, 7790, 9079, 21, 4756, 13474, 14904, 13475, 7427, 8495, 5804, 9104, 9082, 2]
...
const memoResult = noop.memo((size) => {
  ...
  obj2.children = substr.map((item, index) => {
    if (item === useProfileEffectSections.NONE_ITEM) {
      ...
      return timestampProducer(tmp(13475).EditCollectiblesListItemNone, obj2, "none");
    } else if (item === tmp(14904).SHOP_ITEM) {
      const obj3 = { size, analyticsSource: AnalyticsLocationDefault.EDIT_PROFILE_EFFECT_SHEET };
      return timestampProducer(tmp(13475).EditCollectiblesListItemShop, obj3, "shop");
