...
// Dependencies: [19, 17, 7794, 8495, 21, 576, 4757, 13482, 14914, 13483, 7429, 9108, 2]

// Module 14915 (EditProfileFrameSection)
...
import useProfileFrameSections from "useProfileFrameSections" /* 14914 */;
import noop from "module_19" /* 19 */;

require = fn;
const View = fn(17).View;
const isProfileFrameRecord = fn(7794).isProfileFrameRecord;
let closure_6 = fn(8495).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
({ jsx: closure_7, Fragment: closure_8, jsxs: closure_9 } = jsxProd);
const PX_8 = nativeDefault.space.PX_8;
const createStyles = fn(4757);
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(13482).GUTTER_SIZE }, rowSpacer: null, previewContainer: null };
...
const memoResult = noop.memo((arg0) => {
  ...
  obj2.children = substr.map((profileFrame, index) => {
    ...
    } else if (profileFrame === tmp(14914).SHOP_ITEM) {
