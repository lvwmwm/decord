...
// Dependencies: [19, 17, 9155, 7539, 21, 4827, 576, 8568, 4524, 8565, 8551, 5967, 5890, 9180, 2]
// Exports: default

// Module 9179 (ProfileFrameSamplePreview)
...
let obj2 = { profileFrameContainer: { flex: 1 }, profileContainer: { flex: 1, overflow: "hidden", borderWidth: 1, borderColor: nativeDefault.colors.BORDER_NORMAL, borderRadius: nativeDefault.radii.xs }, sampleProfile: { width: "100%", aspectRatio: fn(9155).SAMPLE_PROFILE_ASPECT_RATIO } };
