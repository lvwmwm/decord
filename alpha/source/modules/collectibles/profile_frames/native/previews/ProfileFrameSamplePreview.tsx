...
// Dependencies: [19, 17, 9084, 7455, 21, 4757, 576, 8497, 4458, 8494, 8480, 5883, 5806, 9109, 2]
// Exports: default

// Module 9108 (ProfileFrameSamplePreview)
...
let obj2 = { profileFrameContainer: { flex: 1 }, profileContainer: { flex: 1, overflow: "hidden", borderWidth: 1, borderColor: nativeDefault.colors.BORDER_NORMAL, borderRadius: nativeDefault.radii.xs }, sampleProfile: { width: "100%", aspectRatio: fn(9084).SAMPLE_PROFILE_ASPECT_RATIO } };
