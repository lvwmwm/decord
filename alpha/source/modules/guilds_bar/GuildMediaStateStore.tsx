...
// Dependencies: [2043, 1235, 7856, 2049, 2048, 4851, 502, 2044, 2066, 4464, 4474, 2098, 5010, 4848, 1074, 14076, 1095, 4453, 14077, 9834, 11, 5721, 9683, 504, 558, 573, 2]
  ...
  const found = embeddedActivitiesForGuild.filter((location) => {
    ...
    if (tmp5) {
      ...
      if (!tmp7) {
        ...
        tmp7 = !tmp(14077).hasBlockedOrIgnoredUserIds(items, tmp6.blockedOrIgnoredUserIds);
        const tmpResult = tmp(14077);
      }
      tmp5 = tmp7;
    }
    return tmp5;
