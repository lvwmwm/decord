...
// Dependencies: [2041, 1235, 7854, 2047, 2046, 4849, 502, 2042, 2064, 4462, 4472, 2096, 5008, 4846, 1074, 14067, 1095, 4451, 14068, 9829, 11, 5719, 9679, 504, 558, 573, 2]
  ...
  const found = embeddedActivitiesForGuild.filter((location) => {
    ...
    if (tmp5) {
      ...
      if (!tmp7) {
        ...
        tmp7 = !tmp(14068).hasBlockedOrIgnoredUserIds(items, tmp6.blockedOrIgnoredUserIds);
