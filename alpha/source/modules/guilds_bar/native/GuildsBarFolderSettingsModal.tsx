...
// Dependencies: [32, 19, 17, 5657, 16640, 21, 4757, 9478, 7228, 4724, 16641, 1980, 576, 5185, 6850, 1115, 5906, 5824, 1092, 14879, 5843, 504, 16638, 7247, 2]
// Exports: default
...
export default function GuildFolderSettingsModal(folderId) {
  ...
  const memo = obj2.useMemo(() => {
    ...
    if (closure_5) {
      ...
      let fn = tmp3(5843).getHeaderTextButton(intl2.string(tmp3(1115).t["R3BPH+"]), callback);
      const tmp3Result = tmp3(5843);
    } else {
      fn = () => null;
    }
    obj2.headerRight = fn;
