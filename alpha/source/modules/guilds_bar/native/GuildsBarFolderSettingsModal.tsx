...
// Dependencies: [32, 19, 17, 5741, 16692, 21, 4827, 9549, 7312, 4794, 16693, 1980, 576, 5269, 6934, 1115, 5990, 5908, 1092, 14959, 5927, 504, 16690, 7331, 2]
// Exports: default
...
export default function GuildFolderSettingsModal(folderId) {
  ...
  const memo = obj2.useMemo(() => {
    ...
    if (closure_5) {
      ...
      let fn = tmp3(5927).getHeaderTextButton(intl2.string(tmp3(1115).t["R3BPH+"]), callback);
      const tmp3Result = tmp3(5927);
    } else {
      fn = () => null;
    }
    obj2.headerRight = fn;
