...
// Dependencies: [19, 17, 8288, 21, 4827, 1364, 576, 8509, 4541, 5908, 4794, 1115, 5887, 10092, 5992, 12, 7481, 4823, 9073, 8947, 2]
// Exports: default

// Module 15004 (UserPrimaryGuildListBottomSheet)
...
let closure_9 = noop.memo((item) => {
  ...
  if (tmp10Result2) {
    ...
    tmp10Result2 = tmp10(tmp7(10092).BaseGuildTagChiplet, obj10);
  }
