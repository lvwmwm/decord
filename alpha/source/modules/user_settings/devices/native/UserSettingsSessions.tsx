...
// Dependencies: [32, 19, 17, 1372, 1074, 21, 4827, 5827, 576, 15033, 504, 15286, 5269, 5990, 1115, 5908, 7454, 4823, 1370, 5425, 1177, 7323, 1484, 12597, 7321, 15287, 9237, 10406, 7289, 15288, 2]
// Exports: default
...
function UserSettingsSessions() {
  ...
  if (null == currentSession) {
    ...
    const items1 = [closure_10(tmp2(5990).TableRowGroup, obj5), , ];
    if (otherSessions.length > 0) {
      ...
      let tmp20Result = tmp20(tmp2(5990).TableRowGroup, obj7);
    } else {
      let mfaEnabled;
    ...
    if (otherSessions.length > 0) {
      ...
      tmp21Result2 = tmp21(tmp2(5908).TableRow, obj8);
    }
    items1[2] = tmp21Result2;
    obj4.children = items1;
    tmp20Result2 = tmp20(tmp2(5269).Stack, obj4);
  }
  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
      ...
      if (tmp22Result) {
        ...
        const items2 = [tmp20(tmp9(4823).Text, obj10), ];
        const obj11 = { variant: "text-md/semibold", children: found[1] };
        items2[1] = tmp20(tmp9(4823).Text, obj11);
      ...
      if (tmp20Result3) {
        ...
        obj14.children = tmp20(tmp9(4823).Text, obj15);
      ...
      if (tmp20Result4) {
        ...
        obj16.children = tmp20(tmp9(4823).Text, obj17);
