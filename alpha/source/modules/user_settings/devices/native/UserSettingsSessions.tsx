  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
      ...
      if (tmp22Result) {
        ...
        const items2 = [tmp20(tmp9(4832).Text, obj10), ];
        const obj11 = { variant: "text-md/semibold", children: found[1] };
        items2[1] = tmp20(tmp9(4832).Text, obj11);
      ...
      if (tmp20Result3) {
        ...
        obj14.children = tmp20(tmp9(4832).Text, obj15);
      ...
      if (tmp20Result4) {
        ...
        obj16.children = tmp20(tmp9(4832).Text, obj17);
