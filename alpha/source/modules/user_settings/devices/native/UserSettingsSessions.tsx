...
// Dependencies: [32, 19, 17, 1372, 1074, 21, 4829, 5829, 576, 15042, 504, 15295, 5271, 5992, 1115, 5910, 7456, 4825, 1370, 5427, 1177, 7325, 1484, 12606, 7323, 15296, 9241, 10411, 7291, 15297, 2]
// Exports: default
...
function UserSettingsSessions() {
  ...
  if (null == currentSession) {
    ...
    const items1 = [closure_10(tmp2(5992).TableRowGroup, obj5), , ];
    if (otherSessions.length > 0) {
      ...
      let tmp20Result = tmp20(tmp2(5992).TableRowGroup, obj7);
    } else {
      let mfaEnabled;
    ...
    if (otherSessions.length > 0) {
      ...
      tmp21Result2 = tmp21(tmp2(5910).TableRow, obj8);
    }
    items1[2] = tmp21Result2;
    obj4.children = items1;
    tmp20Result2 = tmp20(tmp2(5271).Stack, obj4);
  }
