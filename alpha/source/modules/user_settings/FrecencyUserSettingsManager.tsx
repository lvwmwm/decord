...
// Dependencies: [5, 8585, 8584, 5766, 5312, 5808, 5816, 1220, 1084, 1349, 1091, 6534, 2025, 1221, 1222, 12, 2]

// Module 17102 (FrecencyUserSettingsManager)
...
const MAX_NUM_SELECTED_ITEMS = fn(5816).MAX_NUM_SELECTED_ITEMS;
