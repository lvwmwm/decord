...
// Dependencies: [5, 9483, 9482, 5762, 5309, 5804, 5812, 1220, 1084, 1349, 1091, 7449, 2025, 1221, 1222, 12, 2]

// Module 17853 (FrecencyUserSettingsManager)
...
const MAX_NUM_SELECTED_ITEMS = fn(5812).MAX_NUM_SELECTED_ITEMS;
