...
// Dependencies: [19, 17, 21, 4757, 9336, 8614, 1115, 4753, 4716, 576, 9338, 15223, 2]
// Exports: default
      ...
      if (_undefined3 != null) {
        mapped = _undefined3.map((disclosure, index) => {
          ...
          if (null != textForDisclosure) {
            ...
            items = [hasOwnProperty(tmp(15223).DisclosureIcon, obj3), ];
            const obj4 = { style: items.permissionText, variant: "text-sm/normal", children: textForDisclosure };
            items[1] = hasOwnProperty(tmp(4753).Text, obj4);
            obj2.children = items;
