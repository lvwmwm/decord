...
// Dependencies: [32, 19, 17, 8319, 1074, 21, 4827, 576, 1115, 2108, 16257, 15152, 13019, 16262, 7629, 11805, 15150, 15048, 16263, 4823, 2]
...
export const DiscordPermissionsPage = function DiscordPermissionsPage() {
  ...
  const memo = noop.useMemo(() => {
    ...
    if (!allServersOptionSelected) {
      const items11 = [];
      HermesBuiltin.arraySpread(tmp2(16257).GUILD_SPECIFIC_SETTINGS, HermesBuiltin.arraySpread(items6, 0));
      tmp9 = items11;
    ...
    if (tmp7) {
      if (tmp8) {
        tmp15 = React7(tmp2(15152).MessageRequestsNotice, {});
      }
    }
