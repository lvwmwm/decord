...
// Dependencies: [19, 17, 1074, 21, 1186, 2154, 2020, 7531, 1115, 4827, 576, 5990, 2108, 2]
// Exports: default

// Module 16251 (ManageSponsoredContentScreen)
...
function AdTopicRow(adTopic) {
  ...
  return closure_5(adTopic(7531).TableSwitchRow, obj);
}
