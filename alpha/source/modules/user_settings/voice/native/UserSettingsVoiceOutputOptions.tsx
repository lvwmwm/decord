...
// Dependencies: [19, 17, 4849, 502, 1992, 4852, 21, 4827, 504, 38, 9990, 10321, 1115, 5908, 10328, 2]
// Exports: default
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(5908).TableRow, obj8);
    const tmp11Result = VolumeSliderDefault;
  }
  items4[1] = tmp9Result;
  obj4.children = items4;
  return tmp8(stateFromStores1(10321).UserSettingsTableRowGroup, obj4);
};
