...
// Dependencies: [19, 17, 4779, 502, 1992, 4782, 21, 4757, 504, 38, 9917, 10242, 1115, 5824, 10249, 2]
// Exports: default
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(5824).TableRow, obj8);
    const tmp11Result = VolumeSliderDefault;
  }
  items4[1] = tmp9Result;
  obj4.children = items4;
  return tmp8(stateFromStores1(10242).UserSettingsTableRowGroup, obj4);
};
