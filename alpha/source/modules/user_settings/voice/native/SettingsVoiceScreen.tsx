...
// Dependencies: [19, 17, 1992, 8237, 1074, 21, 2108, 4757, 4691, 4608, 10261, 10262, 1115, 6899, 10260, 4753, 10257, 11729, 14971, 2]
// Exports: default

// Module 15528 (SettingsVoiceScreen)
import util from "util" /* 1115 */;
import useThemeDefault from "useTheme" /* 4691 */;
import Text_Text from "Text/Text" /* 4753 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6899 */;
import KrispLogo2 from "KrispLogo" /* 10260 */;
...
function KrispLogo() {
  ...
  if (obj.isThemeLight(tmp4)) {
    let tmp2Result = tmp2(10261);
  } else {
    tmp2Result = tmp2(10262);
  }
...
function SystemProcessingSubLabel() {
  ...
  if (obj.useNoiseCancellationDeferredToSystem()) {
    ...
    tmp3 = React7(tmp(4753).Text, obj2);
  }
  return tmp3;
}
