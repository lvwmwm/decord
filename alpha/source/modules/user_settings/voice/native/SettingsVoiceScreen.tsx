...
// Dependencies: [19, 17, 1992, 8319, 1074, 21, 2108, 4827, 4761, 4678, 10340, 10341, 1115, 6983, 10339, 4823, 10336, 11805, 15048, 2]
// Exports: default

// Module 15582 (SettingsVoiceScreen)
import util from "util" /* 1115 */;
import useThemeDefault from "useTheme" /* 4761 */;
import Text_Text from "Text/Text" /* 4823 */;
import LegacyBaseButton from "LegacyBaseButton" /* 6983 */;
import KrispLogo2 from "KrispLogo" /* 10339 */;
...
function KrispLogo() {
  ...
  if (obj.isThemeLight(tmp4)) {
    let tmp2Result = tmp2(10340);
  } else {
    tmp2Result = tmp2(10341);
  }
...
function SystemProcessingSubLabel() {
  ...
  if (obj.useNoiseCancellationDeferredToSystem()) {
    ...
    tmp3 = React7(tmp(4823).Text, obj2);
  }
  return tmp3;
}
