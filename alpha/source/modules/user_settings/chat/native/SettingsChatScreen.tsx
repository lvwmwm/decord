...
// Dependencies: [19, 17, 1372, 4487, 8319, 1074, 21, 4827, 576, 1484, 563, 4481, 4823, 1115, 5910, 1177, 10739, 7321, 11805, 15048, 2]
// Exports: default

// Module 15798 (SettingsChatScreen)
...
function VideoUploadQualityNitroUpsell() {
  ...
  if (!stateFromStores) {
    ...
    const obj7 = { style: tmp3.cardIcon, source: _modDef10739, size: tmp(1177).Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.PRIMARY_400 };
    ...
    items2[1] = tmp7(tmp(4823).Text, obj8);
    obj6.children = items2;
    obj5.children = tmp5(tmp6, obj6);
    obj4.children = tmp7(tmp(5910).Card, obj5);
