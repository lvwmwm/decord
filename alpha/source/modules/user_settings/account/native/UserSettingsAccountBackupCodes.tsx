...
// Dependencies: [19, 17, 13274, 21, 4829, 576, 6605, 4524, 5912, 6549, 1115, 4528, 504, 14217, 5272, 4825, 5994, 2]
// Exports: default
...
function CodeRow(code) {
  ...
  if (showCheckMark) {
    ...
    tmp2Result = tmp2(code(6549).CheckmarkSmallIcon, obj2);
  }
...
export default function UserSettingsAccountBackupCodes(headerLabel) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp3(5994).TableRowGroup, obj5);
  }
  ...
  if (tmp10Result3) {
    ...
    tmp10Result3 = tmp10(tmp3(5994).TableRowGroup, obj6);
  }
  ...
  if (tmp10Result4) {
    ...
    obj8.label = tmp10(tmp3(4825).Text, obj9);
    ...
    obj7.children = tmp10(tmp3(5912).TableRow, obj8);
    tmp10Result4 = tmp10(tmp3(5994).TableRowGroup, obj7);
  }
  const obj4 = { paddingHorizontal: token, paddingTop: nativeDefault.space.PX_16 };
  items2[3] = tmp10Result4;
  obj3.children = items2;
  return closure_6(tmp11, { children: tmp12(stateFromStores(5272).Stack, obj3) });
};
