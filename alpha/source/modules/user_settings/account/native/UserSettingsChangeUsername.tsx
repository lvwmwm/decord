...
// Dependencies: [5, 32, 19, 17, 1372, 1074, 21, 4836, 576, 5021, 14265, 4832, 1115, 1485, 504, 4488, 14266, 6411, 6405, 1271, 1486, 7288, 6024, 6419, 6357, 2]
// Exports: default

// Module 14264 (UserSettingsChangeUsername)
...
function UsernameStatusMessage(showHint) {
  ...
  return match.with(obj, (children) => closure_1_11(showHint(4832).Text, { variant: "text-xs/medium", color: "text-feedback-critical", children })).with(obj2, (children) => closure_1_11(showHint(4832).Text, { variant: "text-xs/medium", color: "text-feedback-positive", children })).otherwise(() => {
    let tmp = null;
    if (showHint) {
