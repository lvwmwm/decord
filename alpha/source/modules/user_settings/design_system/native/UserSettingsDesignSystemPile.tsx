...
// Dependencies: [19, 17, 21, 4829, 1177, 5889, 5271, 5912, 4825, 13416, 1400, 14552, 12966, 11357, 12967, 9174, 2]
// Exports: default

// Module 16198 (UserSettingsDesignSystemPile)
...
import ListUtils from "ListUtils" /* 12967 */;
...
let items1 = [fn(5889).GuildIconSizes.XSMALL, fn(5889).GuildIconSizes.SMALL_32, fn(5889).GuildIconSizes.NORMAL, fn(5889).GuildIconSizes.LARGE, fn(5889).GuildIconSizes.XLARGE];
...
export default function UserSettingsDesignSystemPile() {
  ...
  items[0] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items = [closure_5(size(4825).Text, { variant: "text-md/medium", color: "text-subtle", children }), ];
      ...
      items[1] = closure_5(size(13416).AvatarPile, obj3);
      obj.children = items;
      return closure_6(size(5271).Stack, obj, children);
    })
  });
  let obj3 = {
    title: "Avatar Pile",
  ...
  items[2] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items[1] = closure_5(size(14552).AvatarDuoPile, obj3);
      obj.children = items;
      return closure_6(size(5271).Stack, obj, children);
    })
  });
  ...
  items[4] = hasOwnProperty(SampleCard, {
    ...
    children: items1.map((size) => {
      const obj = { children: null };
      items = [closure_5(size(4825).Text, { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() }), ];
      const obj2 = { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() };
      items[1] = closure_5(size(12966).GuildIconPile, { size, names: names2, totalCount: 128, children: names2.map((value, index) => closure_2_5(GuildIconDefault, { value, size }, index)) });
      obj.children = items;
      return closure_6(size(5271).Stack, obj, size);
    })
  });
  ...
  items1[1] = items2.map((item) => {
    ...
    obj3.children = names2.map((value, index) => {
      const obj = { value, size: closure_1_0(5889).GuildIconSizes.LARGE };
      return closure_1_5(closure_1_1(5889), obj, index);
    });
