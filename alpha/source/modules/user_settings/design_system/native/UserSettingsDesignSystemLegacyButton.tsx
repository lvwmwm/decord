...
// Dependencies: [19, 17, 21, 1177, 4753, 5187, 4757, 576, 5185, 8876, 2]
// Exports: default

// Module 16087 (UserSettingsDesignSystemLegacyButton)
...
function ComparisonRow(entry) {
  ...
  if (null != redesignVariant) {
    ...
    const items5 = [tmp9(tmp4(4753).Text, { variant: "text-xxs/medium", color: "text-muted", children: "mana" }), ];
    const obj7 = {
    ...
    items5[1] = tmp9(tmp4(5187).Button, obj7);
    obj6.children = items5;
    let tmp9Result = tmp7(tmp8, obj6);
  } else {
    const obj8 = { style: tmp.comparisonSide, children: tmp9(tmp4(4753).Text, { variant: "text-xs/medium", color: "text-muted", children: "no mapping" }) };
