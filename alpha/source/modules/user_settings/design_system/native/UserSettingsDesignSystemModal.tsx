...
// Dependencies: [32, 19, 17, 21, 4757, 576, 7247, 5843, 4960, 7622, 1115, 6850, 4452, 11469, 14460, 8697, 8698, 4753, 12185, 14462, 11268, 11267, 5906, 7447, 5187, 2]
// Exports: default
...
function DemoScreen(arg0) {
  ...
  if (tmp5) {
    ...
    obj.children = React5(tmp3(4753).Text, obj2);
  ...
  if (footer == null) {
    ...
    if (tmp8Result) {
      ...
      tmp8Result = tmp8(tmp3(14462).ModalDisclaimer, obj5);
    }
    const items2 = [tmp8Result, , ];
    let tmp8Result3 = null != action;
    if (tmp8Result3) {
      const obj6 = { variant: "primary", text: action, onPress: onAction };
      tmp8Result3 = tmp8(tmp3(11268).ModalActionButton, obj6);
    }
    ...
    if (tmp8Result4) {
      ...
      tmp8Result4 = tmp8(tmp3(11268).ModalActionButton, obj7);
    }
    const obj8 = { children: null };
    items2[2] = tmp8Result4;
    obj8.children = items2;
    footer = tmp2(tmp3(12185).ModalFooter, obj8);
  }
  children1[1] = footer;
