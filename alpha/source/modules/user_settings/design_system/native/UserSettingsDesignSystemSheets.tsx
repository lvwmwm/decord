...
// Dependencies: [32, 19, 17, 1074, 21, 4829, 7530, 7482, 9887, 7531, 5271, 6936, 7532, 4796, 5273, 1115, 10578, 6141, 5912, 4825, 2]
// Exports: default
...
function DemoActionSheet() {
  ...
  if (first) {
    ...
    tmp14Result = tmp14(tmp15(9887).ActionSheetHeaderPressableText, obj2);
  }
  obj.leading = tmp14Result;
  let tmp14Result2 = tmp2;
  if (tmp2) {
    const obj3 = { onPress: NOOP };
    tmp14Result2 = tmp14(tmp15(7531).ActionSheetCloseButton, obj3);
  }
