...
// Dependencies: [32, 19, 17, 1074, 21, 4829, 6613, 6565, 8985, 6614, 5272, 6019, 6615, 4796, 5274, 1115, 9680, 15379, 5914, 4825, 2]
// Exports: default
...
function DemoActionSheet() {
  ...
  if (first) {
    ...
    tmp14Result = tmp14(tmp15(8985).ActionSheetHeaderPressableText, obj2);
  }
  obj.leading = tmp14Result;
  let tmp14Result2 = tmp2;
  if (tmp2) {
    const obj3 = { onPress: NOOP };
    tmp14Result2 = tmp14(tmp15(6614).ActionSheetCloseButton, obj3);
  }
