...
// Dependencies: [32, 19, 17, 21, 4757, 5826, 5185, 4753, 5187, 4493, 5186, 5190, 5168, 5173, 2]
// Exports: default

// Module 16119 (UserSettingsDesignSystemBackdrop)
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  let obj = showBackdrop(4493);
  fn.__closure = { withSpring: showBackdrop(5186).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5190).SUBTLE_SPRING };
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(5185).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5173).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4753).Text, obj9);
    obj7.children = tmp13(tmp8(5826).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5168).Dialog, obj5);
  }
