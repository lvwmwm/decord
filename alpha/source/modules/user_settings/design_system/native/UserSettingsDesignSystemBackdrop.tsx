...
// Dependencies: [32, 19, 17, 21, 4829, 5912, 5271, 4825, 5273, 4561, 5272, 5276, 5254, 5259, 2]
// Exports: default

// Module 16194 (UserSettingsDesignSystemBackdrop)
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  fn.__closure = { withSpring: showBackdrop(5272).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5276).SUBTLE_SPRING };
  ...
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5259).Backdrop, obj6), ];
    ...
    obj7.children = tmp13(tmp8(5912).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5254).Dialog, obj5);
  }
