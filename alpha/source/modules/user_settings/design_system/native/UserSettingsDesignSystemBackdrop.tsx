...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  obj4.children = items;
  const items1 = [closure_7(showBackdrop(5279).Stack, obj4), ];
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5267).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4832).Text, obj9);
    obj7.children = tmp13(tmp8(5919).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5262).Dialog, obj5);
  }
