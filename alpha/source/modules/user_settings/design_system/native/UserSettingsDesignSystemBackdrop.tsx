...
// Dependencies: [32, 19, 17, 21, 4827, 5910, 5269, 4823, 5271, 4559, 5270, 5274, 5252, 5257, 2]
// Exports: default

// Module 16172 (UserSettingsDesignSystemBackdrop)
...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  fn.__closure = { withSpring: showBackdrop(5270).withSpring, showBackdrop, SUBTLE_SPRING: showBackdrop(5274).SUBTLE_SPRING };
  ...
  if (showBackdrop) {
    ...
    const items2 = [tmp13(tmp8(5257).Backdrop, obj6), ];
    ...
    obj8.children = tmp11(tmp8(4823).Text, obj9);
    obj7.children = tmp13(tmp8(5910).Card, obj8);
    items2[1] = tmp13(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = tmp11(tmp8(5252).Dialog, obj5);
  }
