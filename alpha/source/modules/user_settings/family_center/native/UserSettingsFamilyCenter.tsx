...
// Dependencies: [32, 19, 17, 7867, 1372, 1074, 1099, 7868, 21, 5271, 4829, 576, 7495, 7515, 9003, 15216, 15217, 9005, 563, 9974, 1115, 2486, 15218, 15258, 7869, 1241, 5171, 5176, 5290, 7544, 9975, 12964, 2]
// Exports: default
...
function FamilyCenter() {
  ...
  if (isLoading) {
    ...
    tmp14Result = tmp14(tmp4(12964).SegmentedControlPages, obj13);
  }
