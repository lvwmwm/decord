...
// Dependencies: [19, 17, 1182, 15555, 1085, 21, 4757, 576, 4607, 4465, 5343, 1177, 15557, 563, 4458, 15558, 1230, 4475, 5341, 1115, 2]
// Exports: default
...
const _modDef15557 = tmp8(15557);
const SynchronizeIconNativeDefault = tmp5(15558);
require = fn;
