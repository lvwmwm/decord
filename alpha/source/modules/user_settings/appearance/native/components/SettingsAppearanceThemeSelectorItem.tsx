...
// Dependencies: [19, 17, 1182, 15609, 1085, 21, 4827, 576, 4677, 4531, 5427, 1177, 15611, 563, 4524, 15612, 1230, 4541, 5425, 1115, 2]
// Exports: default
...
const _modDef15611 = tmp8(15611);
const SynchronizeIconNativeDefault = tmp5(15612);
require = fn;
