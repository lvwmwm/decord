...
// Dependencies: [19, 17, 1182, 14821, 1085, 21, 4836, 576, 4684, 4538, 5437, 1177, 14823, 563, 4531, 14824, 1230, 4548, 5435, 1115, 2]
// Exports: default
...
const _modDef14823 = tmp8(14823);
const SynchronizeIconNativeDefault = tmp5(14824);
require = fn;
