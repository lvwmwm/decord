...
// Dependencies: [19, 17, 1182, 14793, 1085, 21, 4829, 576, 4681, 4535, 5430, 1177, 14795, 563, 4528, 14796, 1230, 4545, 5428, 1115, 2]
// Exports: default
...
const _modDef14795 = tmp8(14795);
const SynchronizeIconNativeDefault = tmp5(14796);
require = fn;
