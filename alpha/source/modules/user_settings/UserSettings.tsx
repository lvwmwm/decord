...
// Function ID: 2021
// Name: UserSettings
// Dependencies: [2021, 1084, 2022, 1074, 2023, 2024, 1217, 1186, 558, 7299, 12, 504, 5730, 6712, 1225, 2]
...
items[1] = fn(7299).ChannelListLayoutTypes.COZY;
items[2] = fn(7299).ChannelListLayoutTypes.COMPACT;
...
const items1 = [fn(7299).MessagePreviewTypes.ALL, fn(7299).MessagePreviewTypes.UNREADS, fn(7299).MessagePreviewTypes.NONE];
