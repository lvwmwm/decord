...
// Function ID: 2021
// Name: UserSettings
// Dependencies: [2021, 1084, 2022, 1074, 2023, 2024, 1217, 1186, 558, 8210, 12, 504, 5728, 7629, 1225, 2]
...
items[1] = fn(8210).ChannelListLayoutTypes.COZY;
items[2] = fn(8210).ChannelListLayoutTypes.COMPACT;
...
const items1 = [fn(8210).MessagePreviewTypes.ALL, fn(8210).MessagePreviewTypes.UNREADS, fn(8210).MessagePreviewTypes.NONE];
