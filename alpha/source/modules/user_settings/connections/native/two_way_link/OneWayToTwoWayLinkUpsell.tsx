...
// Dependencies: [19, 17, 1074, 2039, 21, 4757, 576, 5743, 1177, 10891, 4753, 5187, 1115, 2]
// Exports: OneWayToTwoWayLinkUpsell

// Module 15251 (OneWayToTwoWayLinkUpsell)
...
export const OneWayToTwoWayLinkUpsell = function OneWayToTwoWayLinkUpsell(newIndicatorDismissibleContent) {
  ...
  const items1 = [closure_6(SelectedDismissibleContentDefault, obj4), closure_6(newIndicatorDismissibleContent(4753).Text, { style: tmp.title, variant: "text-md/semibold", children: title })];
  obj3.children = items1;
  const items2 = [closure_7(View, obj3), img];
  obj2.children = items2;
  const items3 = [closure_7(View, obj2), closure_6(newIndicatorDismissibleContent(4753).Text, { style: tmp.body, variant: "text-sm/medium", children: body }), ];
  ...
  obj7.children = closure_6(newIndicatorDismissibleContent(5187).Button, obj8);
