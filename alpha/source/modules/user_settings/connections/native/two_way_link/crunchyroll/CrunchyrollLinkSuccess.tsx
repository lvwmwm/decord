...
// Dependencies: [19, 17, 21, 4757, 9357, 9399, 4753, 1115, 7370, 5187, 2]
// Exports: default

// Module 9398 (CrunchyrollLinkSuccess)
...
export default function CrunchyrollLinkDiscordSuccess(onClose) {
  ...
  const items = [hasOwnProperty(React3, { source: _modDef9399, style: tmp.image }), , ];
