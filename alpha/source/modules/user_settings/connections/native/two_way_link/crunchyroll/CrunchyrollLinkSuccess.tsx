...
// Dependencies: [19, 17, 21, 4827, 9428, 9470, 4823, 1115, 7454, 5271, 2]
// Exports: default

// Module 9469 (CrunchyrollLinkSuccess)
...
export default function CrunchyrollLinkDiscordSuccess(onClose) {
  ...
  const items = [hasOwnProperty(React3, { source: _modDef9470, style: tmp.image }), , ];
