...
// Dependencies: [19, 9467, 1074, 8688, 21, 4829, 1484, 9436, 9471, 1115, 2]
// Exports: default

// Module 9470 (CrunchyrollLinkPreConnect)
...
const redirectDestination = fn(8688).CRUNCHYROLL_LINK_DEST_ORIGIN;
const jsx = fn(21).jsx;
...
export default function CrunchyrollLinkPreConnect() {
  ...
  const obj2 = { platformType: PlatformTypes.CRUNCHYROLL, onError: callback1, onNext: callback, img: _modDef9471, imgStyle: tmp.image, title: null, body: null, redirectDestination: null };
  ...
  return jsx(navigation(9436).TwoWayLinkPreConnect, { platformType: PlatformTypes.CRUNCHYROLL, onError: callback1, onNext: callback, img: _modDef9471, imgStyle: tmp.image, title: null, body: null, redirectDestination: null });
};
