...
// Dependencies: [19, 9381, 1074, 21, 4757, 1115, 5321, 9354, 1484, 2108, 9383, 9356, 2]
// Exports: PlayStationLinkLanding

// Module 9382 (PlayStationLinkLanding)
...
export const PlayStationLinkLanding = function PlayStationLinkLanding(platformType) {
  ...
  return jsx(navigation(9356).TwoWayLinkLanding, { platformType: platformType.platformType, img: memo1, imgStyle: tmp.image, headerConnect: null, headerReconnect: null, body: null, onNext: null, valueProps: null });
};
