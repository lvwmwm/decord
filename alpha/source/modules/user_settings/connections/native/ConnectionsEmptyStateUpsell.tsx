...
// Dependencies: [19, 17, 1074, 21, 4827, 576, 4761, 9418, 15297, 15298, 1397, 4678, 5910, 1177, 4794, 15294, 1980, 4823, 7831, 1612, 5269, 1115, 2]
// Exports: default

// Module 15296 (ConnectionsEmptyStateUpsell)
...
import ConnectionsTracking from "ConnectionsTracking" /* 15297 */;
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = closure_8();
  emptyStatePlatforms = emptyStatePlatforms(7831).useEmptyStatePlatforms();
  ...
  const obj = emptyStatePlatforms(7831);
  ...
  const items3 = [closure_6(emptyStatePlatforms(5269).Stack, { spacing: 16, justify: "center", direction: "horizontal", children: memo.map((platform) => closure_1_6(EmptyStateCard, { platform }, platform.type)) }), ];
  ...
  items3[1] = closure_7(emptyStatePlatforms(5269).Stack, obj7);
  obj5.children = items3;
  const items5 = [closure_7(emptyStatePlatforms(5269).Stack, obj5), ];
  ...
  const items6 = [closure_6(emptyStatePlatforms(4823).Text, obj10), ];
  ...
  items6[1] = closure_6(emptyStatePlatforms(4823).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(emptyStatePlatforms(5269).Stack, obj9);
