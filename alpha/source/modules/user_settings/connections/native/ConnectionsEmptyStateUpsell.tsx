...
// Dependencies: [19, 17, 1074, 21, 4757, 576, 4691, 9347, 15245, 15246, 1397, 4608, 5826, 1177, 4724, 15242, 1980, 4753, 7748, 1612, 5185, 1115, 2]
// Exports: default

// Module 15244 (ConnectionsEmptyStateUpsell)
...
import ConnectionsTracking from "ConnectionsTracking" /* 15245 */;
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = closure_8();
  emptyStatePlatforms = emptyStatePlatforms(7748).useEmptyStatePlatforms();
  ...
  const obj = emptyStatePlatforms(7748);
  ...
  const items3 = [closure_6(emptyStatePlatforms(5185).Stack, { spacing: 16, justify: "center", direction: "horizontal", children: memo.map((platform) => closure_1_6(EmptyStateCard, { platform }, platform.type)) }), ];
  ...
  items3[1] = closure_7(emptyStatePlatforms(5185).Stack, obj7);
  obj5.children = items3;
  const items5 = [closure_7(emptyStatePlatforms(5185).Stack, obj5), ];
  ...
  const items6 = [closure_6(emptyStatePlatforms(4753).Text, obj10), ];
  ...
  items6[1] = closure_6(emptyStatePlatforms(4753).Text, obj11);
  obj9.children = items6;
  items5[1] = closure_7(emptyStatePlatforms(5185).Stack, obj9);
