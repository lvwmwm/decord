...
// Dependencies: [5, 32, 19, 17, 5586, 2066, 1074, 5713, 21, 4829, 1177, 576, 5829, 5711, 504, 5273, 1115, 4825, 5889, 5588, 7533, 4535, 15310, 10146, 5195, 5292, 9422, 15311, 15314, 5712, 11913, 4520, 2110, 5427, 11000, 15316, 3134, 1397, 4680, 5271, 7325, 5910, 5992, 2]
...
function Integration(integration) {
  ...
  if (!tmp7) {
    ...
    items5[1] = tmp16(tmp(4825).Text, obj10);
    ...
    obj13 = tmp8(tmp(5273).Button, obj13);
  ...
  constructor() {
    ...
    applyArgumentsResult.handleDisconnect = function handleDisconnect() {
      ...
      if (shouldWarnConnectedAccountTwoWayDefault(account)) {
        ...
        const items = [closure_2_14(tmp6(4825).Text, obj4), ];
        ...
        items[1] = closure_2_14(tmp3(10146), obj5);
        obj3.children = items;
        tmp8 = __initData(View, obj3);
        const tmp3Result = tmp3(10146);
      }
