...
// Dependencies: [32, 19, 17, 1074, 7760, 1374, 21, 576, 4827, 5283, 1094, 4823, 5890, 1115, 13829, 13830, 13831, 13832, 5256, 1609, 11101, 1177, 7493, 1478, 1241, 2]
// Exports: default

// Module 13828 (PremiumFeaturesCarouselSection)
...
function PremiumFeaturesCarousel(arg0) {
  ...
  const isScreenReaderEnabled = onEndReached(5256).useIsScreenReaderEnabled();
  ...
  if (!onEndReached(1609).isThumbstickScrollDevice) {
    if (!isScreenReaderEnabled) {
      ...
      let tmp19 = closure_10(currentIndex(11101), obj3);
    }
    let items3 = [tmp19, ];
...
export default function PremiumFeaturesCarouselSection(style) {
  ...
  const tmp = closure_14();
  const analyticsLocations = first(7493)().analyticsLocations;
  ...
  const items2 = [closure_10(analyticsLocations(4823).Text, obj3), closure_10(PremiumFeaturesCarousel, { width: tmp4[0], onEndReached: callback })];
