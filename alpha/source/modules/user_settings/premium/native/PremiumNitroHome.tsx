...
// Dependencies: [32, 19, 17, 4749, 4421, 13671, 1074, 2039, 1374, 21, 672, 576, 4757, 1484, 13672, 5341, 5847, 4753, 1115, 1241, 7625, 13673, 8319, 13674, 13695, 11005, 13699, 13700, 13701, 13706, 13710, 13727, 13728, 13730, 13731, 7630, 1612, 13732, 504, 7638, 8328, 13733, 9896, 4493, 5186, 4608, 13734, 4577, 2028, 8318, 2030, 5806, 13735, 13736, 12873, 9897, 5199, 1364, 5174, 2]
// Exports: default
...
function NitroHomeHeader(arg0) {
  ...
  if (mobileNitroManageSubscriptionsSettingsExperiment) {
    ...
    const obj8 = {
      ...
      children: tmp11(tmp2(7625).SettingsIcon, { size: "md", color: "white" })
    };
  ...
  if (tmp11Result2) {
    const obj9 = { style: tmp.pillParent, children: tmp11(tmp2(13673).PremiumReferralTrialPill, { hasExtraMargin: true }) };
...
function NewTab(arg0) {
  ...
  if (tmp12) {
    ...
    tmp12 = closure_17(tmp8(13701), obj6);
    const tmp8Result = tmp8(13701);
  }
  const items1 = [tmp12, closure_17(require("TieredTenureBadgePerkCard").TieredTenureBadgePerkCard, {}), , , , , ];
  let tmp15Result = null;
  if (isEligibleSenderForReferralProgram) {
    const obj8 = { onLayout: useScrollToSectionDefault(ref, scrollToSectionId).createSectionLayoutHandler(NitroHomeSectionId.REFERRAL_PROGRAM), children: tmp15(tmp2(13710).ReferralProgramPerkCard, {}) };
...
export default function PremiumNitroHome(onClose) {
  ...
  const effect2 = obj5.useEffect(() => {
    if (!obj.UNSAFE_isDismissibleContentDismissed(dismissible_content.DismissibleContent.MOBILE_NITRO_HOME_SETTINGS_BADGE)) {
      const result = tmp(4577).UNSAFE_markDismissibleContentAsDismissed(tmp(2028).DismissibleContent.MOBILE_NITRO_HOME_SETTINGS_BADGE);
    ...
    if (!tmpResult4.UNSAFE_isDismissibleContentDismissed(dismissible_content.DismissibleContent.REFERRAL_TRIAL_MOBILE_NITRO_HOME_BADGE)) {
      const result1 = tmp(4577).UNSAFE_markDismissibleContentAsDismissed(tmp(2028).DismissibleContent.REFERRAL_TRIAL_MOBILE_NITRO_HOME_BADGE);
      const tmpResult5 = tmp(4577);
    }
    if (isEligibleSenderForReferralProgram) {
      const result2 = tmp(8318).markReferralProgramEntrypointBadgeAcknowledged();
      const tmpResult6 = tmp(8318);
    }
  }, items5);
  ...
  if (tmp26Result) {
    ...
    tmp26Result = tmp26(tmp6(13736), obj19);
  }
  ...
  if (!isThemeDarkResult) {
    ...
    items12[1] = obj25;
    obj24.style = items12;
    tmp26Result5 = tmp26(tmp6(5199), obj24);
  }
  ...
  if (tmpResult10.isAndroid()) {
    ...
    tmp26Result6 = tmp26(tmp6(5174), obj28);
