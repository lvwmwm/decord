...
// Dependencies: [32, 19, 17, 4825, 4494, 12936, 1074, 2042, 1374, 21, 672, 576, 4836, 1485, 12937, 5435, 5940, 4832, 1115, 1241, 6798, 12938, 7500, 12939, 12960, 10203, 12964, 12965, 12966, 12971, 12975, 12995, 12996, 12998, 12999, 6803, 1613, 13000, 504, 6813, 7509, 13001, 9083, 4566, 5280, 4685, 13002, 4654, 2029, 7499, 2031, 5899, 13003, 13004, 12113, 9084, 5293, 1364, 5268, 2]
// Exports: default
...
function NitroHomeHeader(arg0) {
  ...
  if (mobileNitroManageSubscriptionsSettingsExperiment) {
    ...
    const obj8 = {
      ...
      children: tmp11(tmp2(6798).SettingsIcon, { size: "md", color: "white" })
    };
    tmp11Result = tmp11(tmp2(5435).PressableOpacity, obj8);
  }
  ...
  if (tmp11Result2) {
    const obj9 = { style: tmp.pillParent, children: tmp11(tmp2(12938).PremiumReferralTrialPill, { hasExtraMargin: true }) };
...
function NewTab(arg0) {
  ...
  if (tmp12) {
    ...
    tmp12 = closure_17(tmp8(12966), obj6);
    const tmp8Result = tmp8(12966);
  }
  const items1 = [tmp12, closure_17(require("TieredTenureBadgePerkCard").TieredTenureBadgePerkCard, {}), , , , , ];
  let tmp15Result = null;
  if (isEligibleSenderForReferralProgram) {
    const obj8 = { onLayout: useScrollToSectionDefault(ref, scrollToSectionId).createSectionLayoutHandler(NitroHomeSectionId.REFERRAL_PROGRAM), children: tmp15(tmp2(12975).ReferralProgramPerkCard, {}) };
...
export default function PremiumNitroHome(onClose) {
  ...
  const effect2 = obj5.useEffect(() => {
    ...
    if (isEligibleSenderForReferralProgram) {
      const result2 = tmp(7499).markReferralProgramEntrypointBadgeAcknowledged();
      const tmpResult6 = tmp(7499);
    }
  }, items5);
  ...
  if (tmp26Result) {
    ...
    tmp26Result = tmp26(tmp6(13004), obj19);
  }
  ...
  if (!isThemeDarkResult) {
    ...
    items12[1] = obj25;
    obj24.style = items12;
    tmp26Result5 = tmp26(tmp6(5293), obj24);
  }
  ...
  if (tmpResult10.isAndroid()) {
    ...
    tmp26Result6 = tmp26(tmp6(5268), obj28);
