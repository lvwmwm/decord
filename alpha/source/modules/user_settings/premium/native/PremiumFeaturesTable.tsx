...
obj2.themedHighlightedCell = { backgroundColor: fn(5753).PREMIUM_FEATURES_TABLE_HIGHLIGHTED_CELL_BG };
...
let obj7 = { icon: null };
let obj5 = { backgroundColor: fn(5753).PREMIUM_FEATURES_TABLE_HIGHLIGHTED_CELL_BG };
