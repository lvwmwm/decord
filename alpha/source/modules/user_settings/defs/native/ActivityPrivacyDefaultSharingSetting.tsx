...
// Dependencies: [19, 7417, 1186, 1115, 2021, 15528, 14388, 4800, 15529, 1981, 11006, 2]

// Module 15527 (ActivityPrivacyDefaultSharingSetting)
import util from "util" /* 1115 */;
import preloaded_user_settings from "preloaded_user_settings" /* 1186 */;
import UserSettings from "UserSettings" /* 2021 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4800 */;
import ActivityPrivacyMatchingExperiment from "ActivityPrivacyMatchingExperiment" /* 15528 */;
...
const radio = SettingBuilders.createRadio({
  ...
  onValueChange(arg0) {
    ...
    if (obj.getIsInActivityPrivacyUpsellExperiment("ActivityPrivacyDefaultSharingSetting")) {
      const affectedGuilds = tmp2(14388).computeAffectedGuilds(setting, NumberResult);
      if (null != affectedGuilds) {
        const activityRestrictionSettingName = tmp2(14388).getActivityRestrictionSettingName(NumberResult);
        const tmp2Result2 = tmp2(14388);
        ...
        ActionSheetActionCreatorsDefault.openLazy(tmp2(1981)(15529, dependencyMap.paths), "ActivityPrivacyUpsellActionSheet", obj2);
      }
