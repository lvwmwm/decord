...
// Dependencies: [5, 17, 8237, 1074, 4966, 12668, 12676, 1241, 9563, 11729, 1115, 2]

// Module 15775 (SystemNotificationsSetting)
...
let closure_6 = fn(4966).NotificationAuthorizationStatus;
