...
// Dependencies: [19, 17, 1074, 12750, 21, 4827, 576, 12751, 1241, 5910, 10495, 4823, 1115, 5271, 2]
// Exports: default

// Module 15825 (NotificationPermissionSettingsHeader)
...
export default function NotificationPermissionSettingsHeader() {
  ...
  canSeePushNotificationNudge = canSeePushNotificationNudge(12751).useCanSeePushNotificationNudge();
  ...
  if (canSeePushNotificationNudge) {
    ...
    obj5.children = closure_11(tmp2(10495).BellSlashIcon, obj6);
    ...
    items1[1] = closure_11(tmp2(4823).Text, obj7);
    ...
    items1[2] = closure_11(tmp2(4823).Text, obj8);
    ...
    obj10.onPress = tmp6;
    obj9.children = closure_11(tmp2(5271).Button, obj10);
    items1[3] = closure_11(View, obj9);
    obj4.children = items1;
    obj3.children = closure_12(View, obj4);
    obj2.children = closure_11(tmp2(5910).Card, obj3);
