...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4757, 576, 6866, 510, 10454, 1612, 7297, 5341, 1115, 8636, 10455, 13211, 9002, 4753, 2]
// Exports: default

// Module 15857 (UserSettingsPushNotificationLogs)
...
let size = { backgroundColor: nativeDefault.colors.INPUT_BACKGROUND_DEFAULT, marginLeft: nativeDefault.space.PX_8, borderRadius: nativeDefault.radii.md, height: fn(6866).InputHeights.MD, width: fn(6866).InputHeights.MD, justifyContent: "center", alignItems: "center" };
...
export default function UserSettingsPushNotificationLogs() {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp5(10454)(), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          const obj6 = { message: tmp5(10455)(closure_128_0, false) };
          tmp2(8636).showShareActionSheet(obj6, "push-notification-logs");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp16) {
  ...
  obj3.children = closure_7(defaultValue(13211).ShareIcon, {});
  ...
  items2[1] = closure_7(defaultValue(9002).FlashList, obj4);
  obj.children = items2;
