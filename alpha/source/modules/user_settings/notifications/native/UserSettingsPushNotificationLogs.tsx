...
// Dependencies: [5, 32, 19, 17, 1074, 21, 4827, 576, 6950, 510, 10533, 1612, 7381, 5425, 1115, 8707, 10534, 13293, 9073, 4823, 2]
// Exports: default

// Module 15911 (UserSettingsPushNotificationLogs)
...
let size = { backgroundColor: nativeDefault.colors.INPUT_BACKGROUND_DEFAULT, marginLeft: nativeDefault.space.PX_8, borderRadius: nativeDefault.radii.md, height: fn(6950).InputHeights.MD, width: fn(6950).InputHeights.MD, justifyContent: "center", alignItems: "center" };
...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [closure_7(defaultValue(7381).SearchField, { size: "md", placeholder: "Filter (regex)", onChange: tmp[1], defaultValue }), ];
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp5(10533)(), done: false };
            return obj4;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          const obj6 = { message: tmp5(10534)(closure_128_0, false) };
          tmp2(8707).showShareActionSheet(obj6, "push-notification-logs");
          c3 = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp16) {
  ...
  obj3.children = closure_7(defaultValue(13293).ShareIcon, {});
  items1[1] = closure_7(defaultValue(5425).PressableOpacity, obj3);
  ...
  items2[1] = closure_7(defaultValue(9073).FlashList, obj4);
  obj.children = items2;
