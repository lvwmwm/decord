...
// Dependencies: [19, 17, 15836, 8323, 21, 4829, 576, 7313, 12760, 15837, 15838, 4825, 1115, 5912, 6940, 11811, 15839, 15840, 15057, 2]
...
function SystemNotificationsSubLabel() {
  ...
  if (result) {
    ...
    result = React5(tmp2(4825).Text, obj5);
  }
  ...
  if (showReactivationPrompt) {
    ...
    const items1 = [React5(tmp2(6940).CircleErrorIcon, obj9), ];
    ...
    obj10.children = React5(tmp2(4825).Text, obj11);
    items1[1] = React5(View, obj10);
    obj8.children = items1;
    obj7.children = tmp8(View, obj8);
    obj6.children = React5(tmp2(5912).Card, obj7);
