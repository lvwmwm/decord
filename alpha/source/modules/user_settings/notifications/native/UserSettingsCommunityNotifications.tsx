    ...
    const obj4 = {
      ...
      children: keys.map((item) => {
          ...
          obj2.onValueChange = function onValueChange() {
            const result = stateFromStores(2026).updateUserGuildSettings(closure_0, (disableRaidAlertNag) => {
              disableRaidAlertNag.disableRaidAlertNag = !disableRaidAlertNag.disableRaidAlertNag;
            }, stateFromStores(2026).UserSettingsDelay.INFREQUENT_USER_ACTION);
          };
          ...
          obj3.onValueChange = function onValueChange() {
            const result = stateFromStores(2026).updateUserGuildSettings(closure_0, (disableRaidAlertPush) => {
