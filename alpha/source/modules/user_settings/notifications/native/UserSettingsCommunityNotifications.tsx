...
// Dependencies: [19, 10343, 21, 4757, 504, 11, 8876, 5185, 5906, 7447, 1115, 2025, 2]
// Exports: default

// Module 15807 (UserSettingsCommunityNotifications)
...
export default function UserSettingsCommunityNotifications() {
  ...
  if (0 !== keys.length) {
    ...
    obj3.children = closure_4(tmp2(5185).Stack, obj4);
