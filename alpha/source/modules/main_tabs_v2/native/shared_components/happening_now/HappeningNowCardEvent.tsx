...
// Dependencies: [19, 17, 2111, 1372, 15645, 1074, 21, 4829, 576, 1177, 9174, 504, 7641, 9837, 9962, 1241, 9971, 1397, 9961, 15646, 5395, 4825, 1881, 1115, 2]

// Module 16514 (HappeningNowCardEvent)
...
const point = { shape: fn(9174).CutoutShape.Circle, x: -8, y: HAPPENING_NOW_CONTENT_HEIGHT / 2 - 8, size: 16 };
let items = [point];
