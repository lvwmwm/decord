...
// Dependencies: [5, 32, 19, 17, 4869, 15645, 1085, 21, 4829, 576, 563, 5076, 10080, 16504, 16505, 11230, 9951, 15646, 1364, 11244, 1177, 4825, 2]
...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result4.isAndroid()) {
      ...
      tmp15Result3 = tmp15(tmp9(11244), obj9);
    }
    const items4 = [
      tmp15Result3,
    ...
    items6[1] = tmp15(tmp6(15646).HappeningNowCardHeader, obj12);
    ...
    if (tmp15Result4) {
      ...
      tmp15Result4 = tmp15(tmp6(4825).Text, obj13);
    }
    ...
    const items8 = [tmp15(tmp6(15646).HappeningNowCardHeader, obj18), ];
    ...
    items8[1] = tmp15(tmp6(4825).Text, obj19);
