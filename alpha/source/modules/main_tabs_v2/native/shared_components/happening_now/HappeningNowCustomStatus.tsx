...
// Dependencies: [5, 32, 19, 17, 4869, 14815, 1085, 21, 4829, 576, 563, 5077, 9177, 15684, 15685, 10328, 9049, 14816, 1364, 10342, 1177, 4825, 2]
...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result4.isAndroid()) {
      ...
      tmp15Result3 = tmp15(tmp9(10342), obj9);
    }
    const items4 = [
      tmp15Result3,
    ...
    items6[1] = tmp15(tmp6(14816).HappeningNowCardHeader, obj12);
    ...
    const items8 = [tmp15(tmp6(14816).HappeningNowCardHeader, obj18), ];
