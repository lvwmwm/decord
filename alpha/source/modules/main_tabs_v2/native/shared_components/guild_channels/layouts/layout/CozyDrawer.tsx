...
// Function ID: 10379
// Name: CozyDrawer
// Dependencies: [10379, 10380, 576, 1177, 5801, 7417, 2]

// Module 10378 (CozyDrawer)
import nativeDefault from "native" /* 576 */;
import "deepmerge";
import deepmerge from "deepmerge" /* 10379 */;
...
obj.icon = { avatarSize: fn(1177).AvatarSizes.NORMAL, guildIconSize: fn(5801).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5801).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj4 = { avatarSize: fn(1177).AvatarSizes.NORMAL, guildIconSize: fn(5801).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5801).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
obj5.icon = { size: fn(1177).IconSizes.REFRESH_SMALL_16, gameSize: fn(7417).GameIconSizes.SMALL };
...
const obj6 = { size: fn(1177).IconSizes.REFRESH_SMALL_16, gameSize: fn(7417).GameIconSizes.SMALL };
...
const importDefaultResultResult = deepmerge(fn(10380).CHANNEL_LIST_STYLES_COMPACT, obj);
...
export const CHANNEL_LIST_STYLES_COZY_DRAWER_SMOL = deepmerge(fn(10380).CHANNEL_LIST_STYLES_COMPACT, obj9);
