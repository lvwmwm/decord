...
obj.icon = { avatarSize: fn(1177).AvatarSizes.NORMAL, guildIconSize: fn(5896).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5896).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj4 = { avatarSize: fn(1177).AvatarSizes.NORMAL, guildIconSize: fn(5896).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5896).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
obj5.icon = { size: fn(1177).IconSizes.REFRESH_SMALL_16, gameSize: fn(6593).GameIconSizes.SMALL };
...
const obj6 = { size: fn(1177).IconSizes.REFRESH_SMALL_16, gameSize: fn(6593).GameIconSizes.SMALL };
...
const importDefaultResultResult = deepmerge(fn(9583).CHANNEL_LIST_STYLES_COMPACT, obj);
...
export const CHANNEL_LIST_STYLES_COZY_DRAWER_SMOL = deepmerge(fn(9583).CHANNEL_LIST_STYLES_COMPACT, obj9);
