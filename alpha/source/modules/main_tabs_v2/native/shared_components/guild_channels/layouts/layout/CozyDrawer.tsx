...
// Function ID: 9571
// Name: CozyDrawer
// Dependencies: [9571, 9572, 576, 1177, 5891, 6588, 2]

// Module 9570 (CozyDrawer)
import nativeDefault from "native" /* 576 */;
import "deepmerge";
import deepmerge from "deepmerge" /* 9571 */;
...
obj.icon = { avatarSize: fn(1177).AvatarSizes.NORMAL, guildIconSize: fn(5891).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5891).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj4 = { avatarSize: fn(1177).AvatarSizes.NORMAL, guildIconSize: fn(5891).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5891).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
obj5.icon = { size: fn(1177).IconSizes.REFRESH_SMALL_16, gameSize: fn(6588).GameIconSizes.SMALL };
...
const obj6 = { size: fn(1177).IconSizes.REFRESH_SMALL_16, gameSize: fn(6588).GameIconSizes.SMALL };
...
const importDefaultResultResult = deepmerge(fn(9572).CHANNEL_LIST_STYLES_COMPACT, obj);
...
export const CHANNEL_LIST_STYLES_COZY_DRAWER_SMOL = deepmerge(fn(9572).CHANNEL_LIST_STYLES_COMPACT, obj9);
