...
CHANNEL_LIST_STYLES_COMPACT.icon = { avatarSize: fn(1177).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5896).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5896).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
const obj5 = { avatarSize: fn(1177).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5896).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5896).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
obj7.icon = { size: fn(1177).IconSizes.EXTRA_SMALL, gameSize: fn(6593).GameIconSizes.SIZE_24 };
...
const obj8 = { size: fn(1177).IconSizes.EXTRA_SMALL, gameSize: fn(6593).GameIconSizes.SIZE_24 };
const size = fn(2);
