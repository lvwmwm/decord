...
// Function ID: 10471
// Name: Compact
// Dependencies: [576, 1177, 5889, 7505, 10469, 2]
// Exports: getCompactStyles

// Module 10470 (Compact)
import nativeDefault from "native" /* 576 */;
import deepmergeDefault from "deepmerge" /* 10469 */;
...
CHANNEL_LIST_STYLES_COMPACT.icon = { avatarSize: fn(1177).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5889).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5889).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
const obj5 = { avatarSize: fn(1177).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5889).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5889).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
obj7.icon = { size: fn(1177).IconSizes.EXTRA_SMALL, gameSize: fn(7505).GameIconSizes.SIZE_24 };
...
const obj8 = { size: fn(1177).IconSizes.EXTRA_SMALL, gameSize: fn(7505).GameIconSizes.SIZE_24 };
const size = fn(2);
