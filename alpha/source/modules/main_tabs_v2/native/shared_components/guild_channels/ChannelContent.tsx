...
// Function ID: 17203
// Name: ChannelContent
// Dependencies: [19, 17, 10459, 5009, 21, 4827, 1364, 10462, 5363, 17203, 5399, 8942, 16520, 4823, 2]
...
const GuildRoleSubscriptionGatedChannelIconDefault = tmp13(16520);
require = fn;
function ChannelContentComponent(arg0) {
  ...
  if (obj17) {
    ...
    tmp10Result5 = tmp10(tmp2(4823).Text, obj16);
  }
