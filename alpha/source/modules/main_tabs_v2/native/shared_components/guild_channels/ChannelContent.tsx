...
// Function ID: 17143
// Name: ChannelContent
// Dependencies: [19, 17, 10380, 4939, 21, 4757, 1364, 10383, 5279, 17143, 5315, 8871, 16468, 4753, 2]
...
const GuildRoleSubscriptionGatedChannelIconDefault = tmp13(16468);
require = fn;
function ChannelContentComponent(arg0) {
  ...
  if (obj17) {
    ...
    tmp10Result5 = tmp10(tmp2(4753).Text, obj16);
  }
