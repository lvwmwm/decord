...
// Dependencies: [19, 17, 15365, 1074, 21, 4756, 576, 4457, 1177, 9094, 9037, 2]
...
const ClipViewDefault = tmp4(9094);
require = fn;
function AvatarDefault() {
  ...
  const point = { shape: tmp2(9094).CutoutShape.Circle, x: diff, y: diff, size: 2 * sum };
