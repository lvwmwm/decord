...
// Dependencies: [19, 17, 15425, 1074, 21, 4827, 576, 4524, 1177, 9170, 9113, 2]
...
const ClipViewDefault = tmp4(9170);
require = fn;
function AvatarDefault() {
  ...
  const point = { shape: tmp2(9170).CutoutShape.Circle, x: diff, y: diff, size: 2 * sum };
