...
// Function ID: 16815
// Name: YouBarAvatar
// Dependencies: [5, 32, 19, 17, 4821, 5584, 1372, 15434, 1074, 21, 4829, 576, 504, 1177, 4535, 4561, 8564, 9174, 5272, 4526, 9173, 8505, 4797, 7712, 1980, 6985, 2]

// Module 16814 (YouBarAvatar)
...
function YouBarAvatarLarge(transitionState) {
  ...
  if (null != stateFromStores) {
    ...
    const obj7 = { user: stateFromStores, guildId: "Array", size, animate: true, needsOffscreenAlphaCompositing: null, status: null, statusSizeOverride: null, cutout: null, statusStyle: "\u00E5ngbastu" };
    if (OFFLINE === StatusTypes.UNKNOWN) {
      OFFLINE = StatusTypes.OFFLINE;
    }
    obj7.status = OFFLINE;
