...
// Function ID: 15975
// Name: YouBar
// Dependencies: [5, 32, 19, 17, 4650, 4652, 1372, 14602, 1074, 2041, 21, 4829, 576, 1478, 14595, 11008, 4691, 14601, 14605, 4563, 5273, 7792, 15975, 14251, 504, 7655, 15979, 4689, 4797, 1370, 12, 15982, 1980, 4688, 10775, 6755, 2028, 1115, 6795, 15609, 6068, 1177, 15996, 15997, 15998, 16003, 16006, 4537, 16008, 16009, 2]
...
let closure_26 = noop.memo(() => {
  ...
  callback3 = sharedValue.useCallback(() => {
    ...
    if (null != coerceGuildsRouteResult) {
      const result = tmp(4797).triggerHapticFeedback(tmp(4797).HapticFeedbackTypes.SOFT);
      ...
      if (guildId === ME) {
        ...
        if (null != lastSelectedGuildId) {
          tmp(6755).transitionToGuild(lastSelectedGuildId);
          const tmpResult3 = tmp(6755);
        }
      } else {
        if (ref2.current === tmp(2028).DismissibleContent.YOU_BAR_DM_SWIPE_COACHMARK) {
          ref.current(ContentDismissActionType.TAKE_ACTION);
        }
        tmp(6755).transitionToGuild(tmp5);
  ...
  if (null != nameplate) {
    ...
    tmp40Result = tmp40(tmp2(15997), obj7);
  }
  ...
  if (iCYMIEnabled) {
    ...
    tmp40Result2 = tmp40(tmp2(16003), obj11);
  }
