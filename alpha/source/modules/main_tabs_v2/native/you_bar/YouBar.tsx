...
// Function ID: 16715
// Name: YouBar
// Dependencies: [5, 32, 19, 17, 4576, 4578, 1372, 15373, 1074, 2039, 21, 4757, 576, 1478, 15366, 11783, 4617, 15372, 15376, 4493, 5186, 8627, 16715, 14999, 504, 8490, 16717, 4615, 4725, 1370, 12, 16720, 1980, 4614, 11488, 7587, 2028, 1115, 7627, 16352, 6899, 1177, 16734, 16735, 16736, 16741, 16744, 4467, 16746, 16747, 2]
...
let closure_26 = noop.memo(() => {
  ...
  callback3 = sharedValue.useCallback(() => {
    ...
    if (null != coerceGuildsRouteResult) {
      const result = tmp(4725).triggerHapticFeedback(tmp(4725).HapticFeedbackTypes.SOFT);
      ...
      if (guildId === ME) {
        ...
        if (null != lastSelectedGuildId) {
          tmp(7587).transitionToGuild(lastSelectedGuildId);
        ...
        tmp(7587).transitionToGuild(tmp5);
  ...
  if (null != nameplate) {
    ...
    tmp40Result = tmp40(tmp2(16735), obj7);
  }
  ...
  if (iCYMIEnabled) {
    ...
    tmp40Result2 = tmp40(tmp2(16741), obj11);
  }
