...
// Dependencies: [19, 17, 21, 4559, 4827, 576, 16447, 4828, 5270, 1177, 16847, 5271, 1115, 2]
// Exports: ContactSuggestionActions

// Module 16846 (ContactSuggestionActions)
...
obj.easing = Easing.in(fn(4559).Easing.quad);
let obj2 = { duration: 250, easing: null };
const Easing2 = fn(4559).Easing;
obj2.easing = Easing2.in(fn(4559).Easing.quad);
let obj3 = { duration: 250, easing: null };
const Easing3 = fn(4559).Easing;
obj3.easing = Easing3.in(fn(4559).Easing.quad);
let obj4 = { duration: 250, easing: null };
const Easing4 = fn(4559).Easing;
obj4.easing = Easing4.out(fn(4559).Easing.quad);
