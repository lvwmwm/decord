...
// Dependencies: [19, 17, 21, 4493, 4757, 576, 16394, 4758, 5186, 1177, 16795, 5187, 1115, 2]
// Exports: ContactSuggestionActions

// Module 16794 (ContactSuggestionActions)
...
obj.easing = Easing.in(fn(4493).Easing.quad);
let obj2 = { duration: 250, easing: null };
const Easing2 = fn(4493).Easing;
obj2.easing = Easing2.in(fn(4493).Easing.quad);
let obj3 = { duration: 250, easing: null };
const Easing3 = fn(4493).Easing;
obj3.easing = Easing3.in(fn(4493).Easing.quad);
let obj4 = { duration: 250, easing: null };
const Easing4 = fn(4493).Easing;
obj4.easing = Easing4.out(fn(4493).Easing.quad);
