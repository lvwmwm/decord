...
// Dependencies: [19, 21, 4757, 4468, 4493, 4753, 5194, 4758, 2]
// Exports: ActionStatusSubLabel

// Module 16793 (ActionStatusSubLabel)
...
let closure_7 = ReanimatedRexport.createAnimatedComponent(fn(4753).Text);
