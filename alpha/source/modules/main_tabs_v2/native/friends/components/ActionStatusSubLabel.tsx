...
// Dependencies: [19, 21, 4827, 4534, 4559, 4823, 5278, 4828, 2]
// Exports: ActionStatusSubLabel

// Module 16845 (ActionStatusSubLabel)
...
let closure_7 = ReanimatedRexport.createAnimatedComponent(fn(4823).Text);
