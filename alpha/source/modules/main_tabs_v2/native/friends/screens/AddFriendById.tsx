...
// Function ID: 14132
// Name: AddFriendById
// Dependencies: [32, 19, 17, 1074, 21, 4757, 576, 1115, 4753, 6857, 14132, 10013, 10009, 4454, 1241, 4468, 7332, 5187, 2]
...
export default noop.forwardRef((arg0, ref) => {
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(5187).Button, obj7);
    ...
    const items8 = [tmp17(sourcePage(4753).Text, obj9), , ];
    ...
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4753).Text, obj11);
