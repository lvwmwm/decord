...
// Function ID: 14214
// Name: AddFriendById
// Dependencies: [32, 19, 17, 1074, 21, 4827, 576, 1115, 4823, 6941, 14214, 10086, 10082, 4520, 1241, 4534, 7416, 5271, 2]
...
export default noop.forwardRef((arg0, ref) => {
  ...
  if (!enabled) {
    ...
    items6[2] = tmp17(sourcePage(5271).Button, obj7);
    ...
    const items8 = [tmp17(sourcePage(4823).Text, obj9), , ];
    ...
    obj10.status = str2;
    items8[1] = tmp17(sourcePage(7416).TextArea, obj10);
    if (first1.status !== tmp4.ERROR) {
      ...
      let tmp17Result = tmp17(tmp18(4823).Text, obj11);
