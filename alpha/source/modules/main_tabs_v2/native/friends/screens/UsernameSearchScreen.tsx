...
// Dependencies: [19, 17, 1074, 21, 4827, 576, 1241, 7312, 5256, 8201, 1364, 5881, 5427, 14213, 1115, 2]
// Exports: default

// Module 17321 (UsernameSearchScreen)
...
export default function UsernameSearchScreen(navigation) {
  ...
  const clientThemesOverride = navigation(8201).useClientThemesOverride();
  let obj = navigation(8201);
  let prop = null;
  if (obj2.isIOS()) {
    prop = null;
  ...
  const items2 = [closure_8(ref(5427), { absolute: true }), ];
  ...
  obj7.ref = ref;
  obj5.children = closure_8(ref(14213), obj7);
