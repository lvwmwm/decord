...
// Dependencies: [19, 17, 1074, 21, 4757, 576, 1241, 7228, 5172, 8119, 1364, 5797, 5343, 14131, 1115, 2]
// Exports: default

// Module 17252 (UsernameSearchScreen)
...
export default function UsernameSearchScreen(navigation) {
  ...
  const clientThemesOverride = navigation(8119).useClientThemesOverride();
  let obj = navigation(8119);
  let prop = null;
  if (obj2.isIOS()) {
    prop = null;
  ...
  obj7.ref = ref;
  obj5.children = closure_8(ref(14131), obj7);
