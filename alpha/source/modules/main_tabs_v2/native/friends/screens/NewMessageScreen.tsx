...
// Dependencies: [5, 32, 19, 17, 2046, 2042, 4472, 7549, 11204, 1074, 21, 4559, 4823, 4827, 576, 1364, 4840, 7552, 573, 504, 1241, 17310, 4828, 17311, 8192, 1115, 11683, 17045, 7493, 7513, 7312, 5288, 11925, 11923, 11922, 8204, 1101, 11926, 4520, 10373, 10374, 4764, 4763, 11342, 5271, 12704, 17249, 2]
// Exports: default
...
function Header(recipientLimit) {
  ...
  if (recipientLimit.usePersonLimitCopy) {
    ...
    const obj4 = { title };
    const items1 = [closure_17(tmp3(8192).GenericHeaderTitle, obj4), ];
