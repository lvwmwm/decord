...
// Function ID: 17327
// Name: FriendsScreen
// Dependencies: [19, 17, 7981, 4474, 21, 4829, 576, 1484, 7495, 7515, 1612, 504, 17327, 1875, 8527, 17328, 17331, 16871, 4773, 1115, 5910, 11348, 5997, 5273, 11211, 12239, 2]
// Exports: default

// Module 17326 (FriendsScreen)
...
export default function FriendsScreen() {
  ...
  const memo = bottom.useMemo(() => {
    ...
    const items = [];
    if (tmp2) {
      const obj = { icon: _modDef16871, IconComponent: SendMessageIcon.SendMessageIcon, iconVariant: "default", label: null, subLabel: null, onPress: null };
