...
// Dependencies: [19, 17, 21, 8157, 4756, 576, 8110, 8107, 12849, 1115, 7717, 7245, 17222, 17228, 17231, 17232, 17233, 17240, 17241, 17242, 17244, 17247, 17248, 4609, 1612, 4466, 2]
// Exports: default

// Module 17221 (FriendsNavigator)
...
function RequestsSettingsModalButton(onPress) {
  ...
  const obj2 = { source: _modDef12849, onPress: onPress.onPress, accessibilityLabel: null };
...
function FriendsNavigator() {
    ...
    closure_5(closure_7.Screen, {
      ...
      options(navigation) {
        ...
        obj.headerRight = function headerRight(arg0) {
          ...
          return closure_2_5(navigation(8107).HeaderTextButton, obj);
        };
        return obj;
      },
      getComponent() {
  ...
  obj4.getComponent = function getComponent() {
    return closure_0(17228).default;
  };
