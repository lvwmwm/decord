...
// Dependencies: [19, 17, 21, 8243, 4827, 576, 8195, 8192, 12935, 1115, 7803, 7331, 17303, 17309, 17312, 17313, 17314, 17321, 17322, 17323, 17325, 17328, 17329, 4680, 1612, 4533, 2]
// Exports: default

// Module 17302 (FriendsNavigator)
...
function RequestsSettingsModalButton(onPress) {
  ...
  const obj2 = { source: _modDef12935, onPress: onPress.onPress, accessibilityLabel: null };
...
function FriendsNavigator() {
    ...
    closure_5(closure_7.Screen, {
      ...
      options(navigation) {
        ...
        obj.headerRight = function headerRight(arg0) {
          ...
          return closure_2_5(navigation(8192).HeaderTextButton, obj);
        };
        return obj;
      },
      getComponent() {
        return closure_0(17303).default;
      }
    }),
  ,
  ,
  ...
  obj4.getComponent = function getComponent() {
    return closure_0(17309).default;
  };
  ...
  obj6.getComponent = function getComponent() {
    return closure_0(17312).default;
  };
  ...
  obj8.getComponent = function getComponent() {
    return closure_0(17313).default;
  };
  ...
  obj10.getComponent = function getComponent() {
    return closure_0(17314).default;
  };
  ...
  obj12.getComponent = function getComponent() {
    return closure_0(17321).default;
  };
  ...
  obj14.getComponent = function getComponent() {
    return closure_0(17322).default;
  };
  ...
  obj16.getComponent = function getComponent() {
    return closure_0(17323).default;
  };
  ...
  items[8] = closure_5(closure_7.Screen, {
    ...
    getComponent() {
      return closure_0(17325).default;
    }
  });
  ...
  obj21.getComponent = function getComponent() {
    return closure_0(17329).default;
  };
