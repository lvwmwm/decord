...
// Dependencies: [19, 17, 21, 8161, 4757, 576, 8113, 8110, 12853, 1115, 7720, 7247, 17234, 17240, 17243, 17244, 17245, 17252, 17253, 17254, 17256, 17259, 17260, 4610, 1612, 4467, 2]
// Exports: default

// Module 17233 (FriendsNavigator)
...
function RequestsSettingsModalButton(onPress) {
  ...
  const obj2 = { source: _modDef12853, onPress: onPress.onPress, accessibilityLabel: null };
...
function FriendsNavigator() {
    ...
    closure_5(closure_7.Screen, {
      ...
      options(navigation) {
        ...
        obj.headerRight = function headerRight(arg0) {
          ...
          return closure_2_5(navigation(8110).HeaderTextButton, obj);
        };
        return obj;
      },
      getComponent() {
  ...
  obj4.getComponent = function getComponent() {
    return closure_0(17240).default;
  };
  ...
  obj14.getComponent = function getComponent() {
    return closure_0(17253).default;
  };
  ...
  obj19.getComponent = function getComponent() {
    return closure_0(17259).default;
  };
  ...
  obj21.getComponent = function getComponent() {
    return closure_0(17260).default;
  };
