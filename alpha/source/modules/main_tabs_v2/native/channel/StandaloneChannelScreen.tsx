...
// Dependencies: [19, 17, 13648, 2042, 8193, 1074, 2049, 21, 4827, 576, 1485, 1612, 8201, 504, 2067, 9477, 1115, 4684, 8260, 8194, 7487, 13661, 8204, 16937, 11803, 5304, 7553, 4761, 4687, 13673, 5360, 1177, 5427, 16946, 16963, 16981, 16998, 17153, 17157, 11683, 17161, 17162, 17163, 2]
...
export default noop.memo(function StandaloneChannelScreen(arg0) {
  ...
  if (null != channelId) {
    if (null != guildId) {
        ...
        if (!needSubscriptionToAccess) {
          if (channelId === tmp41.GUILD_HOME) {
            ...
            if (canSeeOnboardingHome) {
              const obj7 = { guildId };
              tmp32Result = tmp32(tmp5(16963), obj7);
            }
            ...
            const obj8 = { guildId };
            return closure_12(tmp5(16981), obj8);
          } else if (channelId === tmp41.VIBEGRATIONS) {
            const obj9 = { guildId };
            return closure_12(tmp5(16998), obj9);
          } else {
            if (isVibegrationsChannelCandidate) {
              if (!tmp18) {
                if (null != stateFromStores) {
                  ...
                  obj12.children = closure_12(tmp5(17153), obj13);
            ...
            if (showCreateThread) {
              ...
              items6[1] = closure_12(tmp2(17157).CreateThreadView, obj16);
              ...
              obj19.children = closure_12(tmp5(11683), obj20);
              items7[1] = closure_12(tmp2(16937).NavTTIView, obj19);
              ...
              if (isSwipeToMemberListEnabled) {
                ...
                let tmp21Result = tmp21(tmp5(17161), obj21);
              } else {
                const obj22 = {
                  name: "channel_screen",
                  navigationKey: channelId,
                  definition: tmp2(17163).CHANNEL_NAVIGATION_TTI,
                ...
                tmp21Result = tmp21(tmp2(17162).NavTTISurfaceProvider, obj22);
              }
              return tmp21Result;
            }
          }
      ...
      const items9 = [closure_12(tmp5(5427), { absolute: true }), ];
      ...
      items9[1] = closure_12(tmp5(16946), obj26);
