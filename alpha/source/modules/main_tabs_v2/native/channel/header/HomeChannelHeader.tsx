...
// Dependencies: [19, 17, 21, 4757, 576, 1177, 13034, 4753, 1115, 2]

// Module 13581 (HomeChannelHeader)
...
export default noop.memo(function HomeChannelHeader() {
  ...
  const items = [React4(native.Icon, { source: _modDef13034, size: native.Icon.Sizes.MEDIUM, disableColor: true }), ];
