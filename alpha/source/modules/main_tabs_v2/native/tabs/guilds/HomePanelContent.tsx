...
// Dependencies: [19, 17, 16355, 1074, 16621, 21, 4756, 16361, 16622, 4492, 11259, 5341, 16364, 8118, 4457, 576, 1365, 5180, 12151, 2]
...
function HomeDrawerPanelContent() {
  ...
  if (doesLandOnHomeDrawer) {
    tmp17Result2 = tmp17(tmp3(12151).TTIFirstContentfulPaint, { label: "home_drawer", checkFocusedScreen: "guilds" });
  }
