...
// Dependencies: [19, 17, 21, 16018, 576, 8268, 4829, 1115, 8362, 4825, 2]

// Module 16575 (YouScreenNavIcon)
...
const md = fn(16018).ICON_SIZE.md;
const result = (nativeDefault.space.PX_32 - md) / 2;
const TEXT_DEFAULT = nativeDefault.colors.TEXT_DEFAULT;
const point = { shape: fn(8268).CutoutShape.Circle, x: md - 8 - 4, y: -4, size: 16 };
let items = [point];
