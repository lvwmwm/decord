...
// Dependencies: [19, 17, 21, 16832, 576, 9174, 4829, 1115, 9264, 4825, 2]

// Module 17360 (YouScreenNavIcon)
...
const md = fn(16832).ICON_SIZE.md;
const result = (nativeDefault.space.PX_32 - md) / 2;
const TEXT_DEFAULT = nativeDefault.colors.TEXT_DEFAULT;
const point = { shape: fn(9174).CutoutShape.Circle, x: md - 8 - 4, y: -4, size: 16 };
let items = [point];
