...
// Dependencies: [19, 17, 14080, 1074, 7760, 1374, 21, 1091, 4827, 576, 17354, 1241, 1115, 4414, 563, 7775, 7767, 17352, 2108, 4823, 4481, 5425, 1177, 9016, 5283, 7538, 2]
// Exports: default
...
export default function YouExpiringTrialOfferCard(navigateToPremium) {
  ...
  let num = 0;
  const obj3 = navigateToPremium(7775);
