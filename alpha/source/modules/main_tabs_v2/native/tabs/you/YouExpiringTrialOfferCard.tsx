...
// Dependencies: [19, 17, 14089, 1074, 7762, 1374, 21, 1091, 4829, 576, 17377, 1241, 1115, 4416, 563, 7777, 7769, 17375, 2110, 4825, 4483, 5427, 1177, 9020, 5285, 7540, 2]
// Exports: default
...
export default function YouExpiringTrialOfferCard(navigateToPremium) {
  ...
  let num = 0;
  const obj3 = navigateToPremium(7777);
