...
// Dependencies: [32, 19, 17, 21, 4827, 1478, 1484, 9124, 1249, 5428, 15427, 16457, 4823, 1115, 5271, 2]
// Exports: default

// Module 16456 (MessagesEmptyState)
...
export default function MessagesEmptyState() {
  ...
  const obj8 = { resizeMode: "contain", source: _modDef16457, style: null };
  let num = 350;
  if (result < 622) {
    num = result / 622 * 350;
  }
