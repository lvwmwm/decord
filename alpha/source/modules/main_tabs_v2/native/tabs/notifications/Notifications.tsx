...
// Dependencies: [19, 17, 11434, 2039, 21, 4827, 576, 4685, 7274, 8183, 16805, 7454, 5425, 1115, 16806, 4823, 16807, 8189, 16809, 7493, 7513, 7803, 5933, 7487, 16813, 16814, 12232, 4680, 1612, 16417, 5427, 4533, 2]
// Exports: ThemedNotificationsModal

// Module 16804 (notifications/Notifications)
...
import useForLaterCoachmarkDefault from "useForLaterCoachmark" /* 16805 */;
import NotificationCenterPermissionNudgeDefault from "NotificationCenterPermissionNudge" /* 16813 */;
import NotificationCenterForYou from "NotificationCenterForYou" /* 16814 */;
...
let closure_12 = noop.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  if (!nestedInLaunchPad) {
    ...
    obj4.onPress = goBack;
    obj4.children = tmp12(tmp5(16806).LeftBackIconWithBadge, {});
    const items1 = [tmp12(tmp5(5425).PressableOpacity, obj4), , ];
    ...
    items1[1] = tmp12(tmp5(4823).Text, obj5);
    const obj6 = { style: tmp.actionButtons, children: null };
    let tmp10Result = null;
    if (isForLaterExperimentOn) {
      const obj7 = { children: null };
      const obj8 = { ref, type: tmp5(8189).SavedMessageSortTypes.BOOKMARK, onOpen: callback };
      const items2 = [tmp12(tmp2(16807), obj8), ];
      const obj9 = { type: null, onOpen: null };
      const tmp2Result = tmp2(16807);
      obj9.type = tmp5(8189).SavedMessageSortTypes.REMINDER;
      obj9.onOpen = callback;
      items2[1] = tmp12(tmp2(16807), obj9);
      obj7.children = items2;
      tmp10Result = tmp10(closure_8, obj7);
      const tmp2Result2 = tmp2(16807);
    }
    const items3 = [tmp10Result, tmp12(tmp2(16809), {})];
