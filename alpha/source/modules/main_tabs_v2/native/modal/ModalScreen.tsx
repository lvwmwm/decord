...
// Dependencies: [109, 19, 17, 1074, 21, 4757, 576, 4960, 9053, 1249, 7720, 1612, 17353, 1364, 16988, 2]
// Exports: default
...
export default function Modal(route) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => modal(7720).trackAppUIViewed("ModalScreen"), []);
