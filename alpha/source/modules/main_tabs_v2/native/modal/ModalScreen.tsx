...
// Dependencies: [109, 19, 17, 1074, 21, 4829, 576, 5032, 8222, 1249, 6890, 1612, 16662, 1364, 16264, 2]
// Exports: default
...
export default function Modal(route) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => modal(6890).trackAppUIViewed("ModalScreen"), []);
