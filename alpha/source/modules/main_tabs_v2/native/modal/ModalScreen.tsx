...
// Dependencies: [109, 19, 17, 1074, 21, 4829, 576, 5032, 9128, 1249, 7805, 1612, 17445, 1364, 17073, 2]
// Exports: default
...
export default function Modal(route) {
  ...
  const layoutEffect = obj2.useLayoutEffect(() => modal(7805).trackAppUIViewed("ModalScreen"), []);
