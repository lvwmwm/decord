...
// Dependencies: [502, 2095, 5638, 5631, 1982, 573, 510, 13221, 2]

// Module 13220 (StageChannelNewUserManager)
...
let require = fn;
let closure_7 = fn(5631).STAGE_AUDIENCE_NOTICE_SHOWN_STORAGE_KEY;
