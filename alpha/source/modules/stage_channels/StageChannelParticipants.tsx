...
// Dependencies: [4779, 2042, 5645, 2105, 4406, 1372, 4776, 4781, 5640, 2047, 5647, 4904, 4391, 4909, 5648, 4809, 2]
    ...
    if (null == user) {
      ...
      if (null != streamForUser) {
        if (streamForUser.channelId === self.channelId) {
          const obj6 = {};
          const tmp11Result2 = tmp11(4809);
          const merged1 = Object.assign(obj2);
          obj6.id = tmp11(4809).encodeStreamKey(streamForUser);
          obj6.type = tmp19.STREAM;
          obj6.rtsState = tmp11(4904).RequestToSpeakStates.NONE;
          items.push(obj6);
          const encodeStreamKeyResult = tmp11(4809).encodeStreamKey(streamForUser);
        }
      }
      return items;
    }
