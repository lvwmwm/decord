...
// Dependencies: [5, 32, 19, 17, 2047, 5717, 1074, 2048, 21, 4827, 576, 504, 5725, 5288, 1241, 1875, 8744, 4794, 4727, 8753, 4823, 1115, 7481, 7454, 6934, 8756, 5271, 2]
// Exports: default

// Module 8743 (StartStageChannelActionSheet)
...
export default function StartStageChannelEventActionSheet(channel) {
      ...
      try {
        ...
        if (0 === c4) {
          if (noop === 1) {
            ...
            if ("" !== importAll.trim()) {
              ...
              if (null != stateFromStores) {
                c4 = 3;
                c5 = 1;
                const obj6 = { value: tmp33(8744).editStage(channel, tmp53, constants.GUILD_ONLY), done: false };
                return obj6;
              } else {
                const tmp33Result2 = tmp33(8744);
                c4 = 2;
                c5 = 1;
          ...
          if (1 === tmp7) {
            dependencyMap = 0;
            closure_128_1 = tmp45;
            const aPIError = new channel(4727).APIError(closure_128_1);
            ...
            tmp3(4794).hideActionSheet(closure_1_10);
            dependencyMap = 0;
            const obj2 = tmp3(4794);
          }
          dependencyMap = 0;
          c5 = 3;
  ...
  const shouldAgeVerifyToSpeakForCurrentUser = channel(5725).useShouldAgeVerifyToSpeakForCurrentUser(channel.id);
  stateFromStores(5288)(() => {
    let id;
    if (stateFromStores != null) {
  ...
  const items1 = [closure_13(stateFromStores(8753), {}), , ];
  ...
  items1[1] = closure_13(channel(4823).Text, obj5);
  ...
  items1[2] = closure_13(channel(4823).Text, obj6);
  obj4.children = items1;
  let stringResult2;
  const tmp11 = stateFromStores;
  const tmp2Result = channel(5725);
  if (null == stateFromStores) {
  ...
  items2[1] = closure_13(channel(6934).TextInput, obj8);
  items2[2] = closure_13(tmp11(8756), {
    onConfirmPress() {
  ...
  if (null != obj3) {
    ...
    tmp15Result = tmp15(tmp2(4823).Text, obj10);
  }
  ...
  obj11.children = closure_13(channel(5271).Button, { text: stringResult3, onPress: handleSave, disabled: "" === value, loading: tmp8, accessibilityHint: stringResult2 });
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = tmp15(tmp2(4823).Text, obj13);
  }
  ...
  return closure_13(channel(7481).BottomSheet, { keyboardShouldPersistTaps: "always", children: closure_14(channel(7454).SafeAreaPaddingView, obj7) });
};
