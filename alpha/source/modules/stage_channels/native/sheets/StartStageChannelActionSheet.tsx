...
// Dependencies: [5, 32, 19, 17, 2049, 5719, 1074, 2050, 21, 4829, 576, 504, 5727, 5290, 1241, 1875, 8748, 4796, 4729, 8757, 4825, 1115, 7483, 7456, 6936, 8760, 5273, 2]
// Exports: default

// Module 8747 (StartStageChannelActionSheet)
...
export default function StartStageChannelEventActionSheet(channel) {
          ...
          if (noop === 1) {
            ...
            if ("" !== importAll.trim()) {
              ...
              if (null != stateFromStores) {
                c4 = 3;
                c5 = 1;
                const obj6 = { value: tmp33(8748).editStage(channel, tmp53, constants.GUILD_ONLY), done: false };
                return obj6;
              } else {
                const tmp33Result2 = tmp33(8748);
                c4 = 2;
                c5 = 1;
  ...
  if (null != obj3) {
    ...
    tmp15Result = tmp15(tmp2(4825).Text, obj10);
  }
  ...
  obj11.children = closure_13(channel(5273).Button, { text: stringResult3, onPress: handleSave, disabled: "" === value, loading: tmp8, accessibilityHint: stringResult2 });
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = tmp15(tmp2(4825).Text, obj13);
  }
  ...
  return closure_13(channel(7483).BottomSheet, { keyboardShouldPersistTaps: "always", children: closure_14(channel(7456).SafeAreaPaddingView, obj7) });
};
