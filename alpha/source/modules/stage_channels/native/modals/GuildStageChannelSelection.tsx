...
// Dependencies: [19, 4406, 1372, 21, 4757, 9803, 4910, 1875, 4724, 9546, 1980, 1115, 4753, 2]
// Exports: default

// Module 10079 (GuildStageChannelSelection)
...
export default function GuildStageChannelSelection(channel) {
  ...
  function handleSelectChannel() {
    ...
    obj2.openLazy(asyncRequireImpl(9546, dependencyMap.paths), "SelectUpdatesChannel", obj3);
  }
