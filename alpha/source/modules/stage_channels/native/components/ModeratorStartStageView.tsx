...
// Dependencies: [32, 19, 2066, 21, 504, 8932, 8940, 8941, 8943, 8944, 8935, 8945, 1115, 8964, 9342, 2]
// Exports: default
...
const StageViewWithPromptsDefault = tmp5(8945);
const require = fn;
const jsxProd = fn(21);
  ...
  if (null != stateFromStores) {
    ...
    if (canManageGuildEventResult) {
      ...
      if (null != first) {
        ...
        tmp10Result = tmp10(tmp(8964).StartEventPrompt, obj7);
      }
    }
    ...
    if (useCurrentUserStageRolesDefault(channel.id, true).moderator) {
      ...
      tmp10Result4 = tmp10(tmp(9342).StartStagePrompt, obj8);
    }
    items2[1] = tmp10Result4;
    let tmp10Result5 = null;
    if (tmp7) {
      const obj9 = { channel, isLive, guild: stateFromStores };
      tmp10Result5 = tmp10(tmp(8964).ScheduleEventPrompt, obj9);
    }
