...
// Dependencies: [32, 19, 2064, 21, 504, 9756, 9764, 9765, 9767, 9768, 9759, 9769, 1115, 9788, 10160, 2]
// Exports: default
...
const StageViewWithPromptsDefault = tmp5(9769);
const require = fn;
const jsxProd = fn(21);
...
export default function ModeratorStartStageView(channel) {
  ...
  if (null != stateFromStores) {
    ...
    if (useCurrentUserStageRolesDefault(channel.id, true).moderator) {
      ...
      tmp10Result4 = tmp10(tmp(10160).StartStagePrompt, obj8);
    }
