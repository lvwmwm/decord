...
// Function ID: 8683
// Name: StageSparkle
// Dependencies: [19, 17, 21, 4757, 576, 8683, 5806, 8684, 4467, 2]
// Exports: default

// Module 8682 (StageSparkle)
...
function StageSparkleInner(style) {
  ...
  const obj5 = { style: tmp3.sparkles, source: tmp10(8684) };
  items1[1] = React4(tmp10(5806), obj5);
  obj.children = items1;
