...
// Dependencies: [19, 17, 1074, 21, 4757, 576, 7409, 5341, 8452, 10187, 1177, 4753, 10188, 1115, 10189, 4904, 7239, 5650, 8673, 5806, 10190, 7319, 2]
// Exports: default

// Module 10186 (RequestToSpeakParticipantList)
...
export default function RequestToSpeakParticipantList(channel) {
  ...
  if (0 === sortedRequestToSpeakParticipants.length) {
    ...
    const obj4 = { source: require("module_10190") };
