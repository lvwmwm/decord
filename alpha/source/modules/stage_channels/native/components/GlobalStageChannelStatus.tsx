...
// Dependencies: [5, 32, 19, 17, 4514, 2047, 1074, 21, 1115, 4827, 576, 4980, 504, 5288, 9636, 8974, 9843, 5725, 8757, 8759, 8744, 8740, 1177, 4823, 5272, 5271, 9845, 9751, 4761, 4531, 9729, 5325, 2]
// Exports: default
...
export default function GlobalStageChannelStatus(arg0) {
  ...
  let invitedHeaderText = tmp3(9751)(id);
    ...
    if (null != channel) {
      if (null != guild) {
        ...
        if (tmp7) {
          ...
          const items2 = [closure_10(tmp3(9729), obj4), , ];
