...
// Dependencies: [19, 17, 5633, 1074, 21, 4757, 576, 4724, 9910, 8874, 1177, 1115, 4753, 5187, 8673, 2]
// Exports: default

// Module 13222 (EndStageActionSheet)
...
export default function EndStageActionSheet(channel) {
  ...
  items[1] = closure_5(channel(4753).Text, obj4);
  ...
  obj5.children = closure_5(channel(5187).Button, obj6);
  ...
  obj7.children = closure_5(channel(5187).Button, obj8);
