...
// Dependencies: [32, 19, 17, 4845, 10392, 1074, 21, 4829, 576, 504, 5737, 5427, 10401, 4825, 1115, 2]

// Module 10421 (ActiveSpeakerTooltip)
...
export default noop.memo((channel) => {
  ...
  const first = _slicedToArray(channel(504).useStateFromStores(items, () => {
    ...
    return items;
  }, items1, channel(5737).isVersionEqual), 1)[0];
  let tmp5 = null;
  if (0 !== first.length) {
    tmp5 = null;
    if (_slicedToArray(closure_7(), 1)[0]) {
      ...
      obj6.children = closure_8(tmp2(4825).Text, obj7);
