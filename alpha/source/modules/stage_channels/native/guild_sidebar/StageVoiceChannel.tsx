...
// Dependencies: [19, 17, 6942, 4466, 4844, 5010, 4853, 2049, 1074, 9566, 21, 1115, 4829, 576, 504, 5724, 15844, 5738, 5732, 5357, 5876, 1875, 5036, 10363, 4982, 8825, 15722, 15833, 15727, 2]
...
export default noop.memo((channel) => {
  ...
  if (null != channel.userLimit) {
    ...
    obj3.channelInfo = tmp12(tmp5(15833), obj5);
    ...
    if (tmp12Result) {
      ...
      obj6.children = tmp12(tmp5(15727), obj7);
