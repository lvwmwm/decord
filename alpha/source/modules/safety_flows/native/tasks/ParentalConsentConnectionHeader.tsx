...
// Dependencies: [19, 17, 1372, 21, 4827, 5985, 576, 1612, 504, 4823, 6920, 1115, 2778, 2]
// Exports: ParentalConsentConnectionNavbar

// Module 18418 (ParentalConsentConnectionHeader)
...
let obj2 = { row: { height: fn(5985).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_16 }, logOut: null };
let obj3 = { height: fn(5985).NAV_BAR_HEIGHT, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_16 };
