...
// Function ID: 17663
// Name: OverviewScreen
// Dependencies: [19, 21, 4829, 17663, 1484, 17664, 7862, 7863, 5272, 576, 4825, 1115, 2780, 5994, 8028, 17658, 11391, 17665, 10448, 2]
// Exports: default

// Module 17662 (OverviewScreen)
import SafetyFlowsUtils from "SafetyFlowsUtils" /* 17664 */;
...
export default function OverviewScreen() {
  let tmp = closure_6();
  task = task(17663).useSafetyFlowTask().task;
  let obj = task(17663);
  ...
  if (flow_context != null) {
    ...
    if (tasks != null) {
      mapped = tasks.map((task_type, index) => {
        const obj = { tip: task(17658).TASK_TYPE_TO_TITLE[task_type.task_type], index: index + 1 };
        return closure_1_4(navigation(8028), obj, task_type.task_type);
      });
    }
  }
  const obj7 = { children: null };
  const obj8 = { children: null };
  const items2 = [closure_4(task(5994).TableRowGroup, { hasIcons: true, children: mapped }), ];
  ...
  items1[2] = closure_5(task(5272).Stack, obj6);
  obj3.children = items1;
  obj8.children = closure_5(task(5272).Stack, obj3);
  const items3 = [closure_4(task(7863).ModalContent, obj8), ];
  const obj10 = { children: null };
  const items4 = [closure_4(navigation(17665), {}), ];
  const obj11 = { variant: "primary", text: null, onPress: null };
  const intl4 = tmp2(1115).intl;
  obj11.text = intl4.string(navigation(2780).Ks6opt);
  obj11.onPress = callback;
  items4[1] = closure_4(task(10448).ModalActionButton, obj11);
  obj10.children = items4;
  items3[1] = closure_5(task(11391).ModalFooter, obj10);
  obj7.children = items3;
  return closure_5(task(7862).ModalScreen, obj7);
};
