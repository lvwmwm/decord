...
// Function ID: 17945
// Name: AddAvatarModal
// Dependencies: [5, 32, 19, 17, 8508, 1074, 21, 4829, 576, 5987, 5829, 1612, 504, 14964, 17945, 8517, 8596, 5442, 8512, 8514, 4825, 1115, 17954, 1177, 5273, 17942, 1249, 7707, 5929, 7333, 2]

// Module 17944 (AddAvatarModal)
...
import AddAvatarModalActionCreators from "AddAvatarModalActionCreators" /* 17942 */;
...
function AddAvatarScreen() {
  ...
  if (null != selectedAvatar) {
    let obj2 = { imageUri: tmp9(17945).DEFAULT_AVATARS[selectedAvatar], description: null };
    const tmp9Result = tmp9(14964);
    obj2.description = tmp9(8517).generateAvatarDescription();
    pendingImage = tmp9Result.createPendingImage(obj2);
    const tmp9Result3 = tmp9(8517);
  }
  ...
  items3[1] = closure_9(selectedAvatar(17954), {
  ...
  const items4 = [closure_10(View, obj4), closure_9(selectedAvatar(17945), { onAvatarSelect: tmp4[1], selectedAvatar }), ];
    ...
    memo = closure_5.useMemo(() => {
      ...
      const obj2 = {
        ...
        headerRight() {
          ...
          return closure_1_9(closure_1_0(7707).HeaderActionButton, obj);
        },
        headerLeft() {
          return null;
        },
