...
// Dependencies: [4794, 16539, 1980, 2]
// Exports: default

// Module 16538 (openFavoritesGuildActionSheet)
...
export default function openFavoritesGuildActionSheet() {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16539, dependencyMap.paths), FavoritesGuildActionSheet, {
    onClose() {
