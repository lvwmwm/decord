...
// Dependencies: [4796, 16563, 1980, 2]
// Exports: default

// Module 16562 (openFavoritesGuildActionSheet)
...
export default function openFavoritesGuildActionSheet() {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16563, dependencyMap.paths), FavoritesGuildActionSheet, {
    onClose() {
