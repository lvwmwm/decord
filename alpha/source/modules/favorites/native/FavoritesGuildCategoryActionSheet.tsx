...
// Dependencies: [19, 2045, 21, 4910, 11247, 2020, 7444, 7396, 7446, 11222, 1115, 7625, 16461, 10895, 7436, 4454, 504, 2]
// Exports: default
...
function FavoritesGuildCategoryActionSheetConnected(category) {
  ...
  if (null != tmp3) {
    ...
    obj3.icon = tmp7(tmp4(7446).ActionSheetRow.Icon, obj4);
    obj3.onPress = function onPress() {
      closure_2.perform();
      onClose();
    };
    obj2.children = tmp7(tmp4(7446).ActionSheetRow, obj3);
    tmp7Result = tmp7(tmp4(7446).ActionSheetRow.Group, obj2);
  }
  ...
  if (setting) {
    ...
    obj9.icon = tmp7(tmp4(7446).ActionSheetRow.Icon, obj10);
    obj9.onPress = function onPress() {
      ClipboardUtils.copy(category.id);
      ToastUtils.presentIdCopied();
      onClose();
    };
    obj8.children = tmp7(tmp4(7446).ActionSheetRow, obj9);
    tmp7Result2 = tmp7(tmp4(7446).ActionSheetRow.Group, obj8);
  }
  items[2] = tmp7Result2;
  obj.children = items;
  return tmp6(category(7444).ActionSheet, obj);
}
const jsxProd = fn(21);
