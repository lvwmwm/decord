...
// Function ID: 12724
// Name: DiceRollBar
// Dependencies: [19, 17, 4819, 12292, 21, 4827, 576, 504, 4559, 4828, 1177, 12724, 9189, 4823, 2]
// Exports: default

// Module 12723 (DiceRollBar)
...
const useDiceRollState = fn(12292).useDiceRollState;
const jsxProd = fn(21);
