...
// Dependencies: [19, 17, 17627, 1372, 1074, 21, 4829, 576, 5320, 5889, 1115, 10738, 4791, 17643, 9071, 5427, 1177, 5401, 4797, 4798, 504, 4483, 10313, 1612, 6985, 4702, 8593, 2]
...
function SoundCategoryItem(style) {
  ...
  if (SoundboardTypes.SoundboardSoundGridSectionType.GUILD === type) {
    ...
    let tmp6 = null;
    let tmp7 = null;
  } else if (tmp2(5320).SoundboardSoundGridSectionType.FAVORITES === type) {
    const intl4 = tmp2(1115).intl;
    name = intl4.string(tmp2(1115).t.y3LQCG);
    tmp6 = _modDef10738;
    tmp7 = null;
    tmp14Result = null;
  } else if (tmp2(5320).SoundboardSoundGridSectionType.FREQUENTLY_USED === type) {
    ...
    tmp6 = null;
    tmp14Result = null;
  } else if (tmp2(5320).SoundboardSoundGridSectionType.DEFAULTS === type) {
    const intl2 = tmp2(1115).intl;
    name = intl2.string(tmp2(1115).t.Rtvk9X);
    tmp6 = _modDef17643;
    tmp7 = null;
    tmp14Result = null;
  } else if (tmp2(5320).SoundboardSoundGridSectionType.SEARCH === type) {
    ...
    tmp14Result = null;
    name = null;
    if (tmp2(5320).SoundboardSoundGridSectionType.TOP_SOUNDS === type) {
      ...
      tmp7 = closure_1_10(tmp2(9071).TrophyIcon, obj4);
      tmp6 = null;
      tmp14Result = null;
    }
  }
  ...
  if (locked) {
    ...
    obj8.children = tmp14(tmp2(5401).LockIcon, obj9);
