...
// Dependencies: [19, 17, 1372, 17537, 21, 4757, 576, 5234, 1115, 10609, 504, 4415, 10229, 10571, 17544, 5194, 12, 5803, 1177, 17552, 10656, 4719, 8996, 10570, 7319, 4753, 2]
    ...
    const items2 = [
      ...
      section.soundsByRow[row].map((type, index) => {
          ...
          if (SoundboardTypes.SoundboardSoundItemType.SOUND === type) {
            ...
            return React5(tmp(17544).SoundButton, obj, "" + section.category.key + "-" + sound.soundId);
  ...
  return closure_7(FastListDefault, {
    ...
    renderSection(arg0) {
      ...
      if (SoundboardTypes.SoundboardSoundGridSectionType.GUILD === type) {
        ...
        const obj4 = { source: _modDef17552, style: tmp11.sectionIcon };
        tmp8Result = tmp8(native.Icon, obj4);
      } else if (SoundboardTypes.SoundboardSoundGridSectionType.FAVORITES === type) {
        const obj5 = { source: _modDef10656, style: tmp11.sectionIcon };
