...
// Dependencies: [5, 19, 17, 21, 4827, 12654, 2056, 12655, 12642, 12643, 4823, 1115, 12651, 2]
// Exports: default

// Module 12653 (GuildDirectoryCreateOrAddDescription)
import GuildDirectoryEditDescriptionTemplateDefault from "GuildDirectoryEditDescriptionTemplate" /* 12651 */;
...
export default function GuildDirectoryCreateOrAddDescription(directoryChannelId) {
  ...
  const items = [closure_6(directoryChannelId(4823).Text, obj4), ];
  ...
  items[1] = closure_6(directoryChannelId(4823).Text, obj5);
  obj3.children = items;
  ...
  return closure_6(directoryChannelId(12643).GuildDirectoryAddModalScreen, obj);
};
