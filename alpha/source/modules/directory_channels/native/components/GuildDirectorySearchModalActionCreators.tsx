...
// Dependencies: [5030, 12635, 1980, 2]

// Module 12634 (GuildDirectorySearchModalActionCreators)
...
export default {
  open(channel) {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12635, dependencyMap.paths), { channel: channel.channel }, GUILD_DIRECTORY_SEARCH_MODAL_KEY);
  },
  close() {
