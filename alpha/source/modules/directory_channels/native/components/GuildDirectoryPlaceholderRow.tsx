...
// Dependencies: [19, 17, 21, 4829, 576, 5746, 12680, 2]

// Module 12679 (GuildDirectoryPlaceholderRow)
...
let size = { width: 40, height: 40, borderRadius: nativeDefault.radii.sm, overflow: "hidden", marginRight: 16, backgroundColor: fn(5746).DARK_PRIMARY_500_LIGHT_PRIMARY_230 };
