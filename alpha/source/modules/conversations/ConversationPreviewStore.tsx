...
// Dependencies: [32, 502, 2044, 4476, 1372, 7010, 1438, 7011, 7012, 5051, 504, 573, 2]
    ...
    if (null != peekResult) {
      ...
      if (null != value2) {
        ...
        if (flag2) {
          ...
          const result1 = tmp5(7012).replaceHydratedMessage(peekResult, messageId, applyReactionResult);
          flag2 = true;
        ...
        if (null != peekResult) {
          ...
          if (null != value2) {
            ...
            if (flag2) {
              ...
              const result1 = tmp7(7012).replaceHydratedMessage(peekResult, id, updateMessageRecordResult);
              flag2 = true;
              const tmp7Result = tmp7(7012);
            }
            flag = flag2;
            tmp7 = require;
          }
