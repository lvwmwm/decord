...
// Dependencies: [19, 21, 5272, 576, 7366, 6382, 4825, 1115, 2]
// Exports: default

// Module 7365 (ConversationPreviewBlockedMessage)
...
export default function ConversationPreviewBlockedMessage(reason) {
  ...
  if ("blocked" === reason.reason) {
    let EyeSlashIcon = tmp2(7366).DenyIcon;
  } else {
    EyeSlashIcon = tmp2(6382).EyeSlashIcon;
  }
