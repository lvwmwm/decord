...
// Dependencies: [19, 21, 5271, 576, 8277, 7299, 4825, 1115, 2]
// Exports: default

// Module 8276 (ConversationPreviewBlockedMessage)
...
export default function ConversationPreviewBlockedMessage(reason) {
  ...
  if ("blocked" === reason.reason) {
    let EyeSlashIcon = tmp2(8277).DenyIcon;
  } else {
    EyeSlashIcon = tmp2(7299).EyeSlashIcon;
  }
