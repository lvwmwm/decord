...
// Dependencies: [19, 21, 5269, 576, 8273, 7297, 4823, 1115, 2]
// Exports: default

// Module 8272 (ConversationPreviewBlockedMessage)
...
export default function ConversationPreviewBlockedMessage(reason) {
  ...
  if ("blocked" === reason.reason) {
    let EyeSlashIcon = tmp2(8273).DenyIcon;
  } else {
    EyeSlashIcon = tmp2(7297).EyeSlashIcon;
  }
