...
// Function ID: 9799
// Name: ActivityTile
// Dependencies: [5, 32, 19, 17, 2041, 1372, 1074, 1181, 2004, 21, 1177, 4827, 576, 504, 1370, 7499, 4979, 4671, 9799, 7493, 7513, 9785, 1115, 9715, 9716, 9801, 9714, 5425, 9802, 9818, 4823, 5272, 4533, 2]
// Exports: default

// Module 9798 (ActivityTile)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import GlobalUtils from "GlobalUtils" /* 1370 */;
import native2 from "native" /* 4533 */;
import handlePressJoinActivityDefault from "handlePressJoinActivity" /* 9714 */;
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            if (tmp12) {
              ...
              v1 = 1;
              dependencyMap = 1;
              const obj5 = { value: v1(9716)(obj4), done: false };
              return obj5;
            } else {
              dependencyMap = 3;
            }
          ...
          const result = tmp2(9801).setOrientationLockState(closure_128_3);
          const obj = tmp2(9801);
        }
        dependencyMap = 3;
