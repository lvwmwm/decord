...
// Dependencies: [32, 19, 17, 9646, 1074, 21, 4757, 1177, 9664, 1478, 7228, 9667, 4493, 5186, 9668, 9669, 6899, 1364, 2]

// Module 9663 (PictureInPicture)
...
const toggleFocus = fn(9646).toggleFocus;
