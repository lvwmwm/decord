...
// Function ID: 9746
// Name: CallBarAction
// Dependencies: [19, 17, 9719, 21, 4676, 576, 4827, 9746, 5425, 9747, 4823, 2]
// Exports: NotifiedActionButton, PrimaryActionButton, ToggledActionButton

// Module 9745 (CallBarAction)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4823 */;
import Pressables from "Pressables" /* 5425 */;
import CircleWithCutoutUtilsDefault from "CircleWithCutoutUtils" /* 9747 */;
...
const resetFocusTimer = fn(9719).resetFocusTimer;
const jsxProd = fn(21);
