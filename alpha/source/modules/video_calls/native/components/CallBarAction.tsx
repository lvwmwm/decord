...
// Function ID: 9673
// Name: CallBarAction
// Dependencies: [19, 17, 9646, 21, 4606, 576, 4757, 9673, 5341, 9674, 4753, 2]
// Exports: NotifiedActionButton, PrimaryActionButton, ToggledActionButton

// Module 9672 (CallBarAction)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4753 */;
import Pressables from "Pressables" /* 5341 */;
import CircleWithCutoutUtilsDefault from "CircleWithCutoutUtils" /* 9674 */;
...
const resetFocusTimer = fn(9646).resetFocusTimer;
const jsxProd = fn(21);
