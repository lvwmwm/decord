...
// Function ID: 9771
// Name: VideoRenderer
// Dependencies: [32, 19, 17, 21, 4827, 9771, 9772, 9774, 1478, 1364, 8678, 9779, 9780, 9782, 4559, 2]

// Module 9770 (VideoRenderer)
...
export default noop.memo((gestureEnabled) => {
  ...
  let onReady;
  const tmp2 = onReady();
  const surfaceDirectRendererExperiment = resizeMode(9771).useSurfaceDirectRendererExperiment(userId, { location: "VideoRenderer" });
  ...
  closure_8 = tmp15;
  const obj = resizeMode(9771);
  [tmp17, c9] = first1(noop.useState(true), 2);
  width(9772)({ location: "VideoRenderer", videoSpinnerContext, userId, streamId, paused, loading: tmp17 });
  onReady = width(9774)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  noop.useRef(null);
  ...
  const store = resizeMode(8678).useStore((orientation) => orientation.orientation);
  ...
  if (tmp17) {
    ...
    tmp35 = closure_8(tmp18(9779), obj3);
  }
  const tmp37 = store === resizeMode(8678).OrientationType.PORTRAIT;
  const obj2 = resizeMode(8678);
  if (tmp3Result.isAndroid()) {
    ...
    const items11 = [closure_8(tmp18(9782), obj7), tmp35];
    obj6.children = items11;
    obj5.children = c9(first2, obj6);
    const items12 = [closure_8(tmp18(9780), obj5), ];
    ...
    obj12.children = closure_8(tmp18(9782), obj13);
    const items13 = [closure_8(tmp18(4559).View, obj12), ];
    let tmp48 = null;
    if (tmp37) {
    ...
    const items17 = [closure_8(tmp18(9782), obj16), tmp35];
