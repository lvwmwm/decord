...
// Function ID: 9737
// Name: CameraPreview
// Dependencies: [32, 19, 17, 2043, 4845, 9737, 4851, 502, 9738, 9723, 9724, 1074, 4850, 21, 6985, 4561, 1177, 504, 9739, 9731, 9748, 9732, 5430, 1612, 9745, 8682, 8622, 9740, 5987, 4830, 9756, 1115, 9757, 9759, 9760, 9742, 9726, 9699, 9826, 9827, 2]
// Exports: default
...
function CameraPreview(arg0) {
  ...
  if (constants3.HIDE_PIP === tmp27) {
    ...
    obj9.onClick = tmp(9757).openIgnoreThermalStateAlert;
    const items5 = [obj9];
    items6 = items5;
  } else {
    items6 = [];
  ...
  if (null != tmp27) {
    ...
    tmp32 = closure_21(tmp(6985).GestureDetector, obj10);
  }
  const items7 = [tmp32, ];
