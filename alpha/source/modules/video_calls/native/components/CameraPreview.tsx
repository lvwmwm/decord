...
// Function ID: 8835
// Name: CameraPreview
// Dependencies: [32, 19, 17, 2043, 4845, 8835, 4851, 502, 8836, 8821, 8822, 1074, 4850, 21, 6068, 4563, 1177, 504, 8837, 8829, 8846, 8830, 5431, 1612, 8843, 7772, 7712, 8838, 5989, 4830, 8854, 1115, 8855, 8857, 8858, 8840, 8824, 8797, 8924, 8925, 2]
// Exports: default
...
function CameraPreview(arg0) {
  ...
  if (constants3.HIDE_PIP === tmp27) {
    ...
    obj9.onClick = tmp(8855).openIgnoreThermalStateAlert;
    const items5 = [obj9];
    items6 = items5;
  } else {
    items6 = [];
  ...
  if (null != tmp27) {
    ...
    tmp32 = closure_21(tmp(6068).GestureDetector, obj10);
  }
  const items7 = [tmp32, ];
