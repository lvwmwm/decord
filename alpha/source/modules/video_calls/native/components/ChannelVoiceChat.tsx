...
// Dependencies: [19, 17, 9640, 21, 4756, 576, 10199, 1612, 9678, 12, 9644, 4690, 5341, 10334, 9650, 4607, 11603, 5339, 1115, 1177, 11830, 13027, 2]
...
export default noop.memo((channel) => {
  ...
  if (!flag) {
    ...
    obj6.barStyle = str2;
    tmp16Result = tmp16(tmp4(9650), obj6);
    const tmp19 = !tmp2;
  ...
  items3[3] = closure_6(guild_id(11603), { guildId: guild_id, channelId: id, chatInputRef: ref, screenIndex: "voice-panel" });
