...
// Dependencies: [19, 17, 17756, 21, 4827, 1115, 5290, 4823, 9549, 2]
// Exports: default

// Module 17757 (HideSelfStreamAndVideoConfirmDialog)
...
const constants = fn(17756).SelfStreamAndVideoAlertType;
const jsxProd = fn(21);
...
export default function HideSelfStreamAndVideoConfirmDialog(arg0) {
  ...
  const items = [closure_5(tmp6(4823).Text, { style: tmp2.description, variant: "text-sm/medium", children: stringResult1 }), ];
  const obj4 = {
  ...
  items[1] = closure_5(tmp6(4823).Text, obj4);
  obj2.children = items;
