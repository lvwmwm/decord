...
// Dependencies: [19, 17, 2043, 4845, 4846, 4851, 502, 1992, 9738, 4850, 4854, 21, 4829, 9748, 10295, 504, 9994, 5722, 10296, 9988, 9757, 9749, 1115, 10299, 10300, 9727, 10322, 10323, 5030, 4971, 4881, 9659, 10324, 7601, 10152, 7495, 7515, 9752, 10325, 10349, 10359, 2]
...
export default function ChannelCallActionBar(arg0) {
  ...
  if (shouldShowConnectingScreen) {
    const obj4 = { channel };
    let tmp13Result = tmp11(tmp9(10325).CallConnectingActionBar, obj4);
  } else {
    ...
    items[2] = tmp11(tmp9(10349).ChannelCallMicButton, obj8);
    if (tmp7.END_REMOTE === END_REMOTE) {
      const obj9 = { channel, isSmallSize: isFiveButtonLayout };
      let tmp11Result6 = tmp11(tmp9(10359).DisconnectRemoteButton, obj9);
