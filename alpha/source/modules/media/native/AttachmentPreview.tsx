...
// Dependencies: [19, 17, 21, 4829, 576, 9647, 9648, 9649, 9650, 9651, 9652, 9653, 9654, 9655, 9656, 9657, 9658, 9659, 9660, 5439, 4825, 1364, 5894, 1177, 8168, 7747, 2]
// Exports: default
    ...
    if (!isVideo) {
      ...
      if (isVideo) {
        ...
        if (tmp7Result.isIOS()) {
          ...
          const obj6 = { uri };
          obj5.source = obj6;
          obj4.children = timestampProducer(tmp7(7747).VideoComponent, obj5);
