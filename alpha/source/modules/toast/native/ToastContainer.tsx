...
// Function ID: 17505
// Name: ToastContainer
// Dependencies: [19, 4819, 17505, 21, 4827, 5744, 4559, 1478, 15418, 1612, 504, 5256, 15427, 5270, 4533, 4534, 17506, 1177, 4521, 2]
...
function AnimatedToast(toast) {
  ...
  let fn = function p() {
    ...
    if (stateFromStores) {
      ...
      value2 = tmp8(5270).withSpring(obj2.get(), closure_10);
      const tmp8Result = tmp8(5270);
    }
    const obj3 = { opacity: value2, transform: null, maxWidth: null };
    let withSpringResult = interpolateResult;
    if (!stateFromStores) {
      const tmp8Result2 = tmp8(5270);
      ...
      obj4 = { state, TransitionStates: tmp8(4533).TransitionStates, runOnJS: tmp8(4559).runOnJS, cleanUp };
      fn.__closure = obj4;
