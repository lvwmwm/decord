...
// Function ID: 17436
// Name: ToastContainer
// Dependencies: [19, 4749, 17436, 21, 4757, 5660, 4493, 1478, 15366, 1612, 504, 5172, 15375, 5186, 4467, 4468, 17437, 1177, 4455, 2]
...
function AnimatedToast(toast) {
  ...
  let fn = function p() {
    ...
    if (stateFromStores) {
      ...
      value2 = tmp8(5186).withSpring(obj2.get(), closure_10);
      const tmp8Result = tmp8(5186);
    }
    const obj3 = { opacity: value2, transform: null, maxWidth: null };
    let withSpringResult = interpolateResult;
    if (!stateFromStores) {
      const tmp8Result2 = tmp8(5186);
      ...
      obj4 = { state, TransitionStates: tmp8(4467).TransitionStates, runOnJS: tmp8(4493).runOnJS, cleanUp };
      fn.__closure = obj4;
