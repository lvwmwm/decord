...
// Function ID: 17528
// Name: ToastContainer
// Dependencies: [19, 4821, 17528, 21, 4829, 5746, 4561, 1478, 15427, 1612, 504, 5258, 15436, 5272, 4535, 4536, 17529, 1177, 4523, 2]
...
function AnimatedToast(toast) {
  ...
  let fn = function p() {
    ...
    if (stateFromStores) {
      ...
      value2 = tmp8(5272).withSpring(obj2.get(), closure_10);
      const tmp8Result = tmp8(5272);
    }
    const obj3 = { opacity: value2, transform: null, maxWidth: null };
    let withSpringResult = interpolateResult;
    if (!stateFromStores) {
      const tmp8Result2 = tmp8(5272);
      ...
      obj4 = { state, TransitionStates: tmp8(4535).TransitionStates, runOnJS: tmp8(4561).runOnJS, cleanUp };
      fn.__closure = obj4;
