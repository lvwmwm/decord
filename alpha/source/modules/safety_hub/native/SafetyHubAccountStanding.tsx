...
// Dependencies: [32, 19, 17, 1372, 8781, 8770, 21, 8771, 15116, 4829, 576, 1115, 15108, 4788, 6940, 9796, 6946, 7271, 504, 1397, 9172, 1177, 4825, 2]
// Exports: default

// Module 15115 (SafetyHubAccountStanding)
...
let obj = { [fn(8771).AccountStandingState.ALL_GOOD]: { left: "0%" } };
let obj2 = { left: "25%", transform: null };
let items = [{ translateX: -0.5 * fn(15116).SUBWAY_MARKER_WIDTH }];
obj2.transform = items;
obj[fn(8771).AccountStandingState.LIMITED] = obj2;
let obj4 = { left: "50%", transform: null };
let obj3 = { translateX: -0.5 * fn(15116).SUBWAY_MARKER_WIDTH };
let items1 = [{ translateX: -0.5 * fn(15116).SUBWAY_MARKER_WIDTH }];
obj4.transform = items1;
obj[fn(8771).AccountStandingState.VERY_LIMITED] = obj4;
let obj6 = { left: "75%", transform: null };
let obj5 = { translateX: -0.5 * fn(15116).SUBWAY_MARKER_WIDTH };
let items2 = [{ translateX: -0.5 * fn(15116).SUBWAY_MARKER_WIDTH }];
obj6.transform = items2;
obj[fn(8771).AccountStandingState.AT_RISK] = obj6;
let obj8 = { left: "100%", transform: null };
let obj7 = { translateX: -0.5 * fn(15116).SUBWAY_MARKER_WIDTH };
let items3 = [{ translateX: -fn(15116).SUBWAY_MARKER_WIDTH }];
obj8.transform = items3;
obj[fn(8771).AccountStandingState.SUSPENDED] = obj8;
...
const obj9 = { translateX: -fn(15116).SUBWAY_MARKER_WIDTH };
