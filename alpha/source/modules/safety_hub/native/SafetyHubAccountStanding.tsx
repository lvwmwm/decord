...
// Dependencies: [32, 19, 17, 1372, 8777, 8766, 21, 8767, 15107, 4827, 576, 1115, 15099, 4786, 6938, 9792, 6944, 7269, 504, 1397, 9168, 1177, 4823, 2]
// Exports: default

// Module 15106 (SafetyHubAccountStanding)
...
let obj = { [fn(8767).AccountStandingState.ALL_GOOD]: { left: "0%" } };
let obj2 = { left: "25%", transform: null };
let items = [{ translateX: -0.5 * fn(15107).SUBWAY_MARKER_WIDTH }];
obj2.transform = items;
obj[fn(8767).AccountStandingState.LIMITED] = obj2;
let obj4 = { left: "50%", transform: null };
let obj3 = { translateX: -0.5 * fn(15107).SUBWAY_MARKER_WIDTH };
let items1 = [{ translateX: -0.5 * fn(15107).SUBWAY_MARKER_WIDTH }];
obj4.transform = items1;
obj[fn(8767).AccountStandingState.VERY_LIMITED] = obj4;
let obj6 = { left: "75%", transform: null };
let obj5 = { translateX: -0.5 * fn(15107).SUBWAY_MARKER_WIDTH };
let items2 = [{ translateX: -0.5 * fn(15107).SUBWAY_MARKER_WIDTH }];
obj6.transform = items2;
obj[fn(8767).AccountStandingState.AT_RISK] = obj6;
let obj8 = { left: "100%", transform: null };
let obj7 = { translateX: -0.5 * fn(15107).SUBWAY_MARKER_WIDTH };
let items3 = [{ translateX: -fn(15107).SUBWAY_MARKER_WIDTH }];
obj8.transform = items3;
obj[fn(8767).AccountStandingState.SUSPENDED] = obj8;
...
const obj9 = { translateX: -fn(15107).SUBWAY_MARKER_WIDTH };
...
export default function SafetyHubAccountStanding() {
  ...
  const items5 = [closure_9(accountStanding(4823).Text, obj8), closure_9(accountStanding(4823).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
