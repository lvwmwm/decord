...
// Dependencies: [5, 32, 19, 7873, 7860, 504, 1364, 7859, 7880, 1380, 7883, 2]
// Exports: useShouldShowInitialGoogleWalletBanner

// Module 14278 (useShouldShowInitialGoogleWalletBanner)
          ...
          try {
            ...
            if (0 === c3) {
              if (arg0 === 1) {
                ...
                c3 = 2;
                c4 = 1;
                const obj6 = { value: _true(7880).fetchAgeVerificationMethodsV2SuspendedUser(), done: false };
                return obj6;
              }
            } else {
              if (1 === tmp7) {
              ...
              c3 = 3;
              c4 = 1;
              const obj8 = { value: _true(7883).checkGoogleWalletAvailable(), done: false };
              return obj8;
            }
          } catch (tmp27) {
            if (tmp4 === c2) {
