...
// Dependencies: [19, 7873, 7860, 504, 11, 7859, 7861, 11346, 2]
...
// Module 11345 (useSafetyHubClassifications)
...
require = fn;
const ViolationType = fn(7860).ViolationType;
const size = fn(2);
...
export const useSafetyHubClassification = function useSafetyHubClassification(classificationId) {
  ...
  if (obj5.isGuildClassification(stateFromStores)) {
    ...
    if (member_type === tmp(7861).MemberType.OWNER) {
