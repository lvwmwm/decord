...
// Dependencies: [32, 19, 17, 21, 4827, 576, 1364, 4524, 13344, 4559, 5259, 5385, 4823, 1115, 2]
...
export default noop.memo(function MediaModalSpoilerOverlay(source) {
  ...
  if (!tmp5[0]) {
    ...
    if (source.obscure) {
      ...
      items2[1] = tmp9(tmp(4823).Text, obj7);
      ...
      obj6.children = tmp9(tmp(4823).Text, obj8);
    ...
    React5(tmp3(4559).View, obj3);
    const tmp3Result = tmp3(5259);
  }
});
