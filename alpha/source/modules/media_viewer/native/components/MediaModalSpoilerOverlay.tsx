...
// Dependencies: [32, 19, 17, 21, 4757, 576, 1364, 4458, 13262, 4493, 5175, 5301, 4753, 1115, 2]
...
export default noop.memo(function MediaModalSpoilerOverlay(source) {
  ...
  if (!tmp5[0]) {
    ...
    const items1 = [timestampProducer(tmp3(5175), obj4), ];
    ...
    if (source.obscure) {
      ...
      items2[1] = tmp9(tmp(4753).Text, obj7);
      ...
      obj6.children = tmp9(tmp(4753).Text, obj8);
    ...
    React5(tmp3(4493).View, obj3);
    const tmp3Result = tmp3(5175);
  }
});
