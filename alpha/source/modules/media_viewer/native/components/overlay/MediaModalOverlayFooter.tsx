...
// Dependencies: [32, 19, 17, 21, 4757, 576, 4493, 11792, 4758, 1177, 13270, 6899, 4494, 7370, 7401, 13271, 13261, 2]
// Exports: MediaModalOverlayFooter

// Module 13269 (MediaModalOverlayFooter)
...
let obj2 = { drawerContainer: { overflow: "hidden", backgroundColor: "WireType" }, drawerHeaderTab: { width: 40, backgroundColor: nativeDefault.unsafe_rawColors.PRIMARY_600 }, drawerHeader: { backgroundColor: "max" }, messagePreviewContainer: { marginLeft: 6 }, thumbnailsContainer: { paddingTop: 8 } };
