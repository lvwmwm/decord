...
// Function ID: 8620
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4827, 1364, 5901, 12, 672, 5471, 5425, 1115, 8620, 8622, 4823, 8624, 8633, 576, 2]
// Exports: default

// Module 8619 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  closure_9 = tmp8[1];
  const tmp11 = paused(5901)(() => _modDef12.throttle((arg0) => {
    closure_1_5(arg0);
  }, 100));
  closure_10 = tmp11;
  closure_11 = paused(5901)(() => _modDef12.throttle((arg0) => {
    closure_1_6(arg0);
    let str = "transparent";
    if (1 === arg0) {
