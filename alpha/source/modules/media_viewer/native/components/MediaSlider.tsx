...
// Function ID: 8624
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4829, 1364, 5903, 12, 672, 5473, 5427, 1115, 8624, 8626, 4825, 8628, 8637, 576, 2]
// Exports: default

// Module 8623 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  closure_9 = tmp8[1];
  const tmp11 = paused(5903)(() => _modDef12.throttle((arg0) => {
    closure_1_5(arg0);
  }, 100));
  closure_10 = tmp11;
  closure_11 = paused(5903)(() => _modDef12.throttle((arg0) => {
    closure_1_6(arg0);
    let str = "transparent";
    if (1 === arg0) {
