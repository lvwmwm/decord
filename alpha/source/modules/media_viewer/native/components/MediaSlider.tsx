...
// Function ID: 7714
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4829, 1364, 5905, 12, 672, 5475, 5428, 1115, 7714, 7716, 4825, 7718, 7727, 576, 2]
// Exports: default

// Module 7713 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  closure_9 = tmp8[1];
  const tmp11 = paused(5905)(() => _modDef12.throttle((arg0) => {
    closure_1_5(arg0);
  }, 100));
  closure_10 = tmp11;
  closure_11 = paused(5905)(() => _modDef12.throttle((arg0) => {
    closure_1_6(arg0);
    let str = "transparent";
    if (1 === arg0) {
  ...
  obj2.style = items3;
  const timeFormat = controls(5475).getTimeFormat(tmp3);
  ...
  if (paused) {
    let PauseIcon = tmp16(7714).PlayIcon;
  } else {
    PauseIcon = tmp16(7716).PauseIcon;
  }
  obj3.children = closure_6(PauseIcon, { size: "md", color: "white" });
  const items4 = [closure_6(controls(5428).PressableOpacity, obj3), , , ];
  ...
  let obj = controls(5475);
  const tmp9Result = paused(7718);
  ...
  items7[1] = closure_6(paused(7718), obj11);
  ...
  const tmp9Result4 = paused(7718);
  obj13.children = controls(5475).getTimeFormat(ref.current);
