...
// Dependencies: [19, 8610, 2042, 4977, 8635, 1074, 7846, 21, 563, 7845, 8398, 4724, 8540, 4907, 8636, 8536, 7436, 4454, 8645, 4452, 11936, 4768, 4617, 11932, 1980, 11916, 8640, 4705, 1115, 11945, 13211, 4699, 13254, 11993, 5301, 7444, 7446, 2]
// Exports: default

// Module 8609 (MediaShareActions)
...
import ChatArrowRightIcon from "ChatArrowRightIcon" /* 11993 */;
...
function useMediaShareActions(source) {
  ...
  callback6 = obj4.useCallback(() => {
    ...
    if (tmp5) {
      ...
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11932, dependencyMap.paths), closure_11, obj2);
...
let closure_11 = fn(7846).EXPLICIT_MEDIA_FALSE_POSITIVE_ACTION_SHEET_KEY;
const jsx = fn(21).jsx;
const size = fn(2);
