...
// Dependencies: [32, 19, 17, 21, 1364, 4693, 13363, 13364, 8611, 8610, 11993, 8606, 6983, 13365, 9780, 2]
...
export const MediaViewerItem = noop.memo((index) => {
  ...
  const memo = obj.useMemo(() => {
    ...
    const Gesture2 = tmp(6983).Gesture;
    ...
    const Gesture5 = tmp(6983).Gesture;
    ...
    const Gesture6 = tmp(6983).Gesture;
