...
// Dependencies: [32, 19, 17, 21, 1364, 4623, 13281, 13282, 8540, 8539, 11917, 8535, 6899, 13283, 9707, 2]
...
export const MediaViewerItem = noop.memo((index) => {
  ...
  const memo = obj.useMemo(() => {
    ...
    const Gesture2 = tmp(6899).Gesture;
    ...
    const Gesture5 = tmp(6899).Gesture;
    ...
    const Gesture6 = tmp(6899).Gesture;
