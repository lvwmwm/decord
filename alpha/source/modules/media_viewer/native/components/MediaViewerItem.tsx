...
// Dependencies: [32, 19, 17, 21, 1364, 4697, 12522, 12523, 7705, 7704, 11143, 7700, 6068, 12524, 8882, 2]
...
export const MediaViewerItem = noop.memo((index) => {
  ...
  const memo = obj.useMemo(() => {
    ...
    const Gesture2 = tmp(6068).Gesture;
    ...
    const Gesture5 = tmp(6068).Gesture;
    ...
    const Gesture6 = tmp(6068).Gesture;
