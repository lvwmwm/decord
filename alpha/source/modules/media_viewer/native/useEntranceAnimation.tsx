...
// Dependencies: [32, 19, 1177, 560, 1248, 4828, 4559, 2]
// Exports: useEntranceAnimation

// Module 13364 (useEntranceAnimation)
...
export const useEntranceAnimation = function useEntranceAnimation(entranceAnimationDriver) {
  ...
  const handleError = noop.useCallback(() => {
    if (1 !== entranceAnimationDriver.get()) {
      ...
      const obj3 = timing;
      const fn = function t() {
        closure_0(4559).runOnJS(setUseEntranceAnimationState)({ isComplete: true });
        obj = closure_0(4559);
        closure_0(4559).runOnJS(incrementLoads)();
      };
