...
// Dependencies: [32, 19, 4749, 1074, 21, 1177, 4493, 5186, 4467, 4758, 504, 12649, 12685, 12686, 9433, 2]
...
export const useSuggestionBarHeight = function useSuggestionBarHeight(transitionState, cleanUp, arg2, onOccupiedHeightChange) {
  ...
  const effect = sharedValue.useEffect(() => {
    if (closure_0 === native.TransitionStates.YEETED) {
      ...
      const __closure = { runOnJS: tmp(4493).runOnJS, cleanUp };
      ...
      const result1 = sharedValue.set(tmp(4758).withTiming(dependencyMap, __closure));
