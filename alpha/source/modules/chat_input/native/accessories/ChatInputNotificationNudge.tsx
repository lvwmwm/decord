...
// Dependencies: [32, 19, 17, 4398, 4938, 12667, 1074, 2039, 12668, 21, 4757, 576, 1241, 10416, 4753, 5341, 12669, 1115, 12670, 5899, 504, 12402, 12678, 7633, 2028, 2]
// Exports: default
...
export default function ChatInputNotificationNudge(channel) {
  ...
  const tmp11Result = tmp11(channel(7633).useSelectedTimeRecurringDismissibleContent(prop1, { cooldownDurationMs: tmp10 }, undefined, true), 2);
  dependencyMap = tmp17;
  const items1 = [tmp14];
