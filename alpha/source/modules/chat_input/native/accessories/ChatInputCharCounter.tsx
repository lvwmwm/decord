...
// Dependencies: [32, 19, 1372, 1074, 1374, 21, 4827, 504, 4481, 9495, 9504, 4521, 1115, 5425, 4823, 9016, 2]

// Module 12769 (ChatInputCharCounter)
...
const forwardRefResult = noop.forwardRef((analyticsLocations, ref) => {
  ...
  const tmp7 = stateFromStores(9495)();
  _slicedToArray = tmp7;
  ...
  if (tmp6 > 0) {
    ...
    obj3.children = "-" + tmp6;
    const items2 = [closure_8(tmp2(4823).Text, obj3), closure_8(tmp2(9016).NitroWheelIcon, { size: "sm" })];
    obj2.children = items2;
    tmp10 = closure_9(tmp2(5425).PressableOpacity, obj2);
  }
  return tmp10;
});
