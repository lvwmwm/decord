...
// Dependencies: [32, 19, 1372, 1074, 1374, 21, 4757, 504, 4415, 9424, 9433, 4455, 1115, 5341, 4753, 8945, 2]

// Module 12687 (ChatInputCharCounter)
...
const forwardRefResult = noop.forwardRef((analyticsLocations, ref) => {
  ...
  const tmp7 = stateFromStores(9424)();
  _slicedToArray = tmp7;
  ...
  if (tmp6 > 0) {
    ...
    obj3.children = "-" + tmp6;
    const items2 = [closure_8(tmp2(4753).Text, obj3), closure_8(tmp2(8945).NitroWheelIcon, { size: "sm" })];
