...
// Function ID: 12703
// Name: ChatInputGuard
// Dependencies: [19, 17, 9654, 21, 4756, 576, 670, 8117, 12514, 12513, 5341, 1364, 12520, 5822, 8179, 11199, 11194, 4752, 5186, 5650, 9184, 2]
...
export default function ChatInputGuard(type) {
  ...
  if ("simple-action" === type.type) {
    ...
    if (null != actionLabel) {
      if (null != actionOnPress) {
        ...
        if (actionIcon == null) {
          ...
          actionIcon = tmp7(tmp9(11199).ArrowSmallRightIcon, obj5);
        }
        obj4.icon = actionIcon;
        obj4.onPress = actionOnPress;
        let tmp7Result = tmp7(tmp9(8179).IconButton, obj4);
      }
    ...
    if (null != countdown) {
      ...
      tmp7Result = tmp7(tmp(11194), obj7);
    }
    tmp8 = hasOwnProperty;
  } else {
    ...
    if (null != buttonSecondaryText) {
      ...
      if (null != buttonSecondaryOnPress) {
        ...
        tmp16Result = tmp16(tmp14(9184).TwinButtons, obj11);
      }
    }
    ...
    if (null != countdown2) {
      ...
      tmp13Result2 = tmp13(tmp(11194), obj14);
    }
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  if (tmp3) {
    tmp10Result3 = tmp10(tmp(5341), { absolute: true, wide: true, tall: true, mix: true });
  }
  ...
  if (tmp4Result.isIOS()) {
    ...
    if (null != channelId) {
      ...
      tmp10Result4 = tmp10(tmp(12520), obj6);
    }
  }
