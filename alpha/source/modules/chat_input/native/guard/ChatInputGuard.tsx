...
// Function ID: 12789
// Name: ChatInputGuard
// Dependencies: [19, 17, 9733, 21, 4827, 576, 670, 8202, 12594, 12593, 5427, 1364, 12600, 5908, 8265, 11281, 11276, 4823, 5271, 5736, 9260, 2]
...
export default function ChatInputGuard(type) {
  ...
  if ("simple-action" === type.type) {
    ...
    if (null != actionLabel) {
      if (null != actionOnPress) {
        ...
        if (actionIcon == null) {
          ...
          actionIcon = tmp7(tmp9(11281).ArrowSmallRightIcon, obj5);
        }
        obj4.icon = actionIcon;
        obj4.onPress = actionOnPress;
        let tmp7Result = tmp7(tmp9(8265).IconButton, obj4);
      }
      obj3.trailing = tmp7Result;
      const obj6 = { variant: "text-sm/semibold", children: message };
      obj3.label = tmp7(tmp9(4823).Text, obj6);
    ...
    if (null != countdown) {
      ...
      tmp7Result = tmp7(tmp(11276), obj7);
    }
    tmp8 = hasOwnProperty;
  } else {
    ...
    if (null != subtext2) {
      ...
      if (typeof subtext2 === "string") {
        ...
        if (subtext2.length > 0) {
          ...
          tmp13Result = tmp13(tmp14(4823).Text, obj);
        }
      }
    }
    ...
    if (null != buttonSecondaryText) {
      ...
      if (null != buttonSecondaryOnPress) {
        ...
        items2[1] = tmp13(tmp14(5271).Button, obj12);
        obj11.children = items2;
        tmp16Result = tmp16(tmp14(9260).TwinButtons, obj11);
      }
    }
    ...
    if (null != countdown2) {
      ...
      tmp13Result2 = tmp13(tmp(11276), obj14);
    }
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  if (tmp3) {
    tmp10Result3 = tmp10(tmp(5427), { absolute: true, wide: true, tall: true, mix: true });
  }
  ...
  if (tmp4Result.isIOS()) {
    ...
    if (null != channelId) {
      ...
      tmp10Result4 = tmp10(tmp(12600), obj6);
    }
  }
