...
// Function ID: 11924
// Name: ChatInputGuard
// Dependencies: [19, 17, 8835, 21, 4829, 576, 670, 7293, 11729, 11728, 5430, 1364, 11735, 5912, 7358, 10385, 10380, 4825, 5274, 5740, 8362, 2]
...
export default function ChatInputGuard(type) {
  ...
  if ("simple-action" === type.type) {
    ...
    if (null != actionLabel) {
      if (null != actionOnPress) {
        ...
        if (actionIcon == null) {
          ...
          actionIcon = tmp7(tmp9(10385).ArrowSmallRightIcon, obj5);
        }
        obj4.icon = actionIcon;
        obj4.onPress = actionOnPress;
        let tmp7Result = tmp7(tmp9(7358).IconButton, obj4);
      }
      obj3.trailing = tmp7Result;
      const obj6 = { variant: "text-sm/semibold", children: message };
      obj3.label = tmp7(tmp9(4825).Text, obj6);
    ...
    if (null != countdown) {
      ...
      tmp7Result = tmp7(tmp(10380), obj7);
    }
    tmp8 = hasOwnProperty;
  } else {
    ...
    if (null != subtext2) {
      ...
      if (typeof subtext2 === "string") {
        ...
        if (subtext2.length > 0) {
          ...
          tmp13Result = tmp13(tmp14(4825).Text, obj);
        }
      }
    }
    ...
    if (null != buttonSecondaryText) {
      ...
      if (null != buttonSecondaryOnPress) {
        ...
        items2[1] = tmp13(tmp14(5274).Button, obj12);
        obj11.children = items2;
        tmp16Result = tmp16(tmp14(8362).TwinButtons, obj11);
      }
    }
    ...
    if (null != countdown2) {
      ...
      tmp13Result2 = tmp13(tmp(10380), obj14);
    }
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  if (tmp3) {
    tmp10Result3 = tmp10(tmp(5430), { absolute: true, wide: true, tall: true, mix: true });
  }
  ...
  if (tmp4Result.isIOS()) {
    ...
    if (null != channelId) {
      ...
      tmp10Result4 = tmp10(tmp(11735), obj6);
    }
  }
