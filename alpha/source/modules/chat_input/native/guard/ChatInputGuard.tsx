...
// Function ID: 12798
// Name: ChatInputGuard
// Dependencies: [19, 17, 9737, 21, 4829, 576, 670, 8204, 12603, 12602, 5429, 1364, 12609, 5910, 8269, 11287, 11282, 4825, 5273, 5738, 9264, 2]
...
export default function ChatInputGuard(type) {
  ...
  if ("simple-action" === type.type) {
    ...
    if (null != actionLabel) {
      if (null != actionOnPress) {
        ...
        if (actionIcon == null) {
          ...
          actionIcon = tmp7(tmp9(11287).ArrowSmallRightIcon, obj5);
        }
        obj4.icon = actionIcon;
        obj4.onPress = actionOnPress;
        let tmp7Result = tmp7(tmp9(8269).IconButton, obj4);
      }
    ...
    if (null != countdown) {
      ...
      tmp7Result = tmp7(tmp(11282), obj7);
    }
    tmp8 = hasOwnProperty;
  } else {
    ...
    if (null != buttonSecondaryText) {
      ...
      if (null != buttonSecondaryOnPress) {
        ...
        items2[1] = tmp13(tmp14(5273).Button, obj12);
        obj11.children = items2;
        tmp16Result = tmp16(tmp14(9264).TwinButtons, obj11);
      }
    }
    ...
    if (null != countdown2) {
      ...
      tmp13Result2 = tmp13(tmp(11282), obj14);
    }
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  if (tmp3) {
    tmp10Result3 = tmp10(tmp(5429), { absolute: true, wide: true, tall: true, mix: true });
  }
  ...
  if (tmp4Result.isIOS()) {
    ...
    if (null != channelId) {
      ...
      tmp10Result4 = tmp10(tmp(12609), obj6);
    }
  }
