...
// Dependencies: [19, 10633, 21, 576, 4827, 12766, 4559, 10650, 10669, 4533, 2]

// Module 12771 (EmojiSuggestionBarSmall)
...
function EmojiSuggestionBarSmallAnimated(displayEmojis) {
  ...
  const suggestionBarHeight = displayEmojis(12766).useSuggestionBarHeight(transitionState, cleanUp, CONTAINER_SMALL_WRAPPER_HEIGHT, onOccupiedHeightChange);
  let obj = displayEmojis(12766);
  class A {
    constructor() {
      obj = { opacity: null };
  ...
  let obj2 = displayEmojis(4559);
  A.__closure = { interpolate: displayEmojis(4559).interpolate, heightSv: suggestionBarHeight, CONTAINER_SMALL_WRAPPER_HEIGHT };
  ...
  const obj4 = {
    ...
    children: displayEmojis.map((emoji, index) => {
      ...
      if (locked) {
        ...
        openEmojiActionSheet = tmp2(10669).openEmojiActionSheet;
      }
...
const jsx = fn(21).jsx;
const sum = fn(10633).IMAGE_SIZE + 2 * nativeDefault.space.PX_8 + 2;
