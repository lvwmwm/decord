...
// Dependencies: [17, 14006, 14008, 3, 1364, 14007, 5443, 2]
// Exports: getCompressionHandler

// Module 14005 (GatewayCompressionHandler)
import LoggerDefault from "Logger" /* 3 */;
import _mod17 from "module_17" /* 17 */;
import PlatformUtils from "PlatformUtils" /* 1364 */;
import ProcessArgs2 from "ProcessArgs" /* 5443 */;
import GatewayZstdUtils from "GatewayZstdUtils" /* 14006 */;
import NativeCompressionModule from "NativeCompressionModule" /* 14007 */;
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = _mod14008;
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(14007).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(14007).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(14007).default;
      if (_default != null) {
