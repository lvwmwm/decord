...
// Dependencies: [17, 14015, 14017, 3, 1364, 14016, 5445, 2]
// Exports: getCompressionHandler

// Module 14014 (GatewayCompressionHandler)
import LoggerDefault from "Logger" /* 3 */;
import _mod17 from "module_17" /* 17 */;
import PlatformUtils from "PlatformUtils" /* 1364 */;
import ProcessArgs2 from "ProcessArgs" /* 5445 */;
import GatewayZstdUtils from "GatewayZstdUtils" /* 14015 */;
import NativeCompressionModule from "NativeCompressionModule" /* 14016 */;
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = _mod14017;
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(14016).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(14016).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(14016).default;
      if (_default != null) {
