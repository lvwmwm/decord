...
// Dependencies: [2044, 2107, 2066, 4474, 1372, 1074, 5051, 1385, 504, 573, 2]

// Module 14087 (GuildOfficialMessagesStore)
  ...
  MESSAGE_UPDATE: function handleMessageUpdate(message) {
    ...
    if (null == message.id) {
      ...
      if (null == guildId) {
        ...
        if (hasFlagResult) {
          if (null == tmp45) {
            const messageRecord = tmp46(5051).createMessageRecord(message);
            if (null != obj[guildId]) {
              const obj5 = {};
        ...
        if (hasFlagResult) {
          if (null != tmp45) {
            const updateMessageRecordResult1 = tmp46(5051).updateMessageRecord(tmp45, message);
            if (null != obj[guildId]) {
              const obj15 = {};
