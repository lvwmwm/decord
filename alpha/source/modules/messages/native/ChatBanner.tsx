...
// Function ID: 11688
// Name: ChatBanner
// Dependencies: [19, 17, 5496, 4772, 11688, 1074, 21, 4757, 576, 11689, 11690, 504, 11, 1241, 4937, 7360, 4753, 1115, 5187, 7513, 8010, 5341, 7357, 8235, 2]
// Exports: default
...
function ArchivedLockedThreadChatBanner(channel) {
  ...
  if (canUnarchiveThread) {
    ...
    obj4.children = tmp8(tmp3(5187).Button, obj5);
