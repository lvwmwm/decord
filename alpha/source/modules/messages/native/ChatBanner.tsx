...
// Function ID: 11764
// Name: ChatBanner
// Dependencies: [19, 17, 5580, 4842, 11764, 1074, 21, 4827, 576, 11765, 11766, 504, 11, 1241, 5007, 7444, 4823, 1115, 5271, 7597, 8092, 5425, 7441, 8317, 2]
// Exports: default
...
function ArchivedLockedThreadChatBanner(channel) {
  ...
  if (canUnarchiveThread) {
    ...
    obj4.children = tmp8(tmp3(5271).Button, obj5);
