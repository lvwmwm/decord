...
// Function ID: 7373
// Name: BlockedGroup
// Dependencies: [7370, 1085, 12, 4682, 576, 4680, 7373, 2]
...
let closure_5 = apply.memoize((arg0) => {
  ...
  if (tmpResult6.isThemeDark(arg0)) {
    let GREY1 = tmp(4680).hexWithOpacity(nativeDefault.unsafe_rawColors.PRIMARY_300, 0.6);
    const tmpResult7 = tmp(4680);
  } else {
