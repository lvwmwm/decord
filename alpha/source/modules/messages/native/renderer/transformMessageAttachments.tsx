...
// Dependencies: [8277, 1074, 1385, 11621, 4977, 8463, 1364, 8462, 1115, 8482, 8612, 5437, 8480, 2]
// Exports: default
  ...
  return found.map((attachment, index) => {
    ...
    if (isImageFileResult) {
      if (null != width) {
        ...
        const result1 = tmp(8462).sanitizeMediaDimension(num4);
        ...
        const result2 = tmp(8462).sanitizeMediaDimension(num5);
        ...
        if (tmp30) {
          tmp30 = null != tmp(8482).isSuspiciousDownload(localUri);
          const tmpResult11 = tmp(8482);
        }
        ...
        const merged = Object.assign(tmp(8480).getAttachmentObscurityProps(obj8));
