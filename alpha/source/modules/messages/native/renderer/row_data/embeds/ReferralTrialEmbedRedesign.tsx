...
// Dependencies: [2042, 1372, 4487, 7778, 7568, 1074, 1374, 4827, 576, 7571, 8399, 1115, 4671, 2108, 4481, 7777, 8400, 1609, 8290, 8396, 2]
      ...
      if (channel.isDM()) {
        ...
        if (null != user) {
          if (null != user1) {
            ...
            obj6.headerImageUrl = tmp41(8399);
            ...
            if (null == relevantUserTrialOffer) {
              ...
              const values = Object.values(tmp39(7571).TrialIdToProductOfferId[closure_9]);
              id = undefined;
              ...
              const isPremiumResult = tmp41(4481).isPremium(user);
              ...
              const tmp41Result10 = tmp41(4481);
              const result = tmp39(7777).hasUserTrialOfferExpired(relevantUserTrialOffer);
              const tmp39Result = tmp39(7777);
              let tmp15 = null == relevantUserTrialOffer.expiresAt;
              const name1 = tmp41(4671).getName(user);
              if (!tmp15) {
                tmp15 = result;
              }
              if (!tmp15) {
              ...
              if (!tmp15) {
                ...
                const referralTrialOfferExpirationCopy = tmp39(8400).getReferralTrialOfferExpirationCopy(expiresAt.getTime());
                const intl = tmp39(1115).intl;
                const tmp39Result5 = tmp39(8400);
                ...
                obj9.duration = tmp39(4481).formatIntervalDuration(obj8);
                const tmp39Result6 = tmp39(4481);
              ...
              if (tmp10) {
                if (!tmp21) {
                  ...
                  if (tmp27) {
                    ...
                    obj13.acceptLabelIconUrl = tmp39(8290).getAssetUriForEmbed(tmp41(8396));
                    tmp31 = obj13;
                    const tmp39Result7 = tmp39(8290);
                  }
                  return tmp31;
                }
              }
              ...
              const tmp41Result11 = tmp41(4671);
            }
            const formatToPartsResult = intl11.formatToParts(tmp39(1115).t.yisueA, obj4);
          }
        }
        const obj19 = { titleText: "", titleColor, headerImageUrl: tmp41(8399), headerText: "", headerColor: headerTextColor, backgroundColor, borderColor: backgroundColor, bodyText: null, bodyTextColor: null, canBeAccepted: false };
