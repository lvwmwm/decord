...
// Dependencies: [17, 1074, 8770, 4416, 1115, 8294, 8947, 2]
// Exports: createSafetyPolicyNoticeEmbed

// Module 13648 (SafetyPolicyNoticeEmbed)
      ...
      if (type === MessageEmbedTypes.SAFETY_POLICY_NOTICE) {
        ...
        if (null != rawValue) {
          if (null != parsed) {
            ...
            obj.titleIcon = renderer_EmbedUtils.getAssetUriForEmbed(Image.resolveAssetSource(_modDef8947));
            const intl2 = util.intl;
            const obj3 = { daysAgo: null };
            const obj4 = _modDef4416();
            obj3.daysAgo = obj4.diff(_modDef4416.unix(parsed), "days");
