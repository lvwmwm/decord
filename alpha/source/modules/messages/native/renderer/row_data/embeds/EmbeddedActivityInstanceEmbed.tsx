...
// Dependencies: [2041, 5054, 502, 2042, 4867, 1372, 11652, 12274, 1115, 12275, 13610, 13620, 12276, 12277, 7494, 12465, 2]
// Exports: createActivityInstanceEmbed

// Module 13619 (EmbeddedActivityInstanceEmbed)
    ...
    if (null != id1) {
      if (null != channel) {
        ...
        if (ContentClassificationVisibility.ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          ...
          const embeddedActivityParticipantAvatarUris = tmp5(13610).getEmbeddedActivityParticipantAvatarUris(obj);
          id = application.id;
          value = undefined;
          if (found != null) {
          ...
          obj8 = PresenceStore;
          const tmp5Result = tmp5(13610);
          const playInContext = tmp5(12276).getPlayInContext(application.id, channel_id);
          ...
          if (null != application.icon) {
            appIconSrc = tmp5(12277).getAppIconSrc(application.id, application.icon, application.bot);
            const tmp5Result9 = tmp5(12277);
          }
          if (null == instanceId) {
          ...
          if (tmp24) {
            const application1 = tmp5(7494).fetchApplication(application.id);
            const tmp5Result10 = tmp5(7494);
          }
          const obj6 = { displayType: tmp5(12275).AppMessageEmbedDisplayType.DISPLAY, appId: application.id, messageId: message.id, title: null, header: null, info: null, tagline: null, staticBannerSrc: null, iconSrc: null, embedUrl: null, bannerRatio: "bot", actions: null, extendedType: null, gradientColors: null, backgroundColor: 0, borderColor: 0, headerColor: 0, headerText: null, type: null };
          ...
          const tmp5Result8 = tmp5(12276);
          const obj7 = { applicationId: application.id, referrerId: AuthenticationStore.getId() };
          obj6.embedUrl = tmp5(12465).getActivityLaunchURL(obj7);
          obj6.actions = items;
          obj6.extendedType = CodedLinkExtendedType.APP_MESSAGE_EMBED;
          const tmp5Result11 = tmp5(12465);
          obj6.gradientColors = tmp5(12277).getAppGradientColors(appIconSrc);
          ...
          id = application.id;
          if (contentClassificationVisibility === tmp5(12274).ContentClassificationVisibility.BLOCK_UNDERAGE) {
