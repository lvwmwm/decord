...
// Dependencies: [17, 11768, 8063, 8289, 12124, 13615, 1363, 1115, 8280, 576, 4678, 12143, 12144, 13613, 2]
            ...
            if (tmpResultResult.valid) {
              ...
              if (override != null) {
                ...
                if (targetBuildOverride2 != null) {
                  const tmp30 = targetBuildOverride2[tmp28(undefined, 12124).DEVICE_FIELD];
                  if (tmp30 != null) {
                    type = tmp30.type;
                  }
                }
              ...
              obj3.thumbnailUrl = Image.resolveAssetSource(tmp(13613)).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
