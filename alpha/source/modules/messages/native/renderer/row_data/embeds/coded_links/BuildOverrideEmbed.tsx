...
// Dependencies: [17, 11692, 7981, 8207, 12047, 13533, 1363, 1115, 8198, 576, 4608, 12066, 12067, 13531, 2]
            ...
            if (tmpResultResult.valid) {
              ...
              if (override != null) {
                ...
                if (targetBuildOverride2 != null) {
                  const tmp30 = targetBuildOverride2[tmp28(undefined, 12047).DEVICE_FIELD];
                  if (tmp30 != null) {
                    type = tmp30.type;
                  }
                }
              ...
              obj3.thumbnailUrl = Image.resolveAssetSource(tmp(13531)).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
