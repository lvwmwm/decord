...
// Function ID: 13651
// Name: CtaButton
// Dependencies: [7623, 12254, 5041, 1115, 3102, 2]
...
export const createCtaButtons = function createCtaButtons(id, channel_id, arg2) {
  ...
  if (CtaButtonUtils.CtaButtonType.MARK_AS_FALSE_POSITIVE === ctaButtonType) {
    ...
    if (ExplicitMediaStore.canSubmitFpReport(id)) {
      prop = tmp(12254).CtaButtonType.MARK_AS_FALSE_POSITIVE;
    }
    const obj6 = { ctaButton: null };
    obj3.callback = prop;
    obj6.ctaButton = obj3;
    return obj6;
  } else if (tmp(12254).CtaButtonType.AGE_VERIFICATION_RETRY === ctaButtonType) {
    ...
    let prop1;
    if (result) {
      prop1 = tmp(12254).CtaButtonType.AGE_VERIFICATION_RETRY;
    }
    ...
    if (tmpResult.isAgeVerificationMessageWithManualReviewCta(channel_id, id)) {
      ...
      let prop2;
      if (result) {
        prop2 = tmp(12254).CtaButtonType.AGE_VERIFICATION_MANUAL_REVIEW;
      }
    ...
    return obj10;
  } else if (tmp(12254).CtaButtonType.CONNECT_TO_TEEN === ctaButtonType) {
    ...
    obj19.callback = tmp(12254).CtaButtonType.CONNECT_TO_TEEN;
