...
// Dependencies: [17, 2044, 2107, 4466, 4476, 1372, 1074, 12, 4682, 576, 7373, 6923, 5076, 1115, 7428, 4418, 7451, 7452, 1397, 7455, 6025, 1400, 7456, 7457, 7401, 4982, 4453, 4509, 7458, 7459, 2]
// Exports: createAutoModerationActionSystemMessage

// Module 7450 (AutoModerationActionSystemMessage)
...
const CommunicationDisabledUtils = tmp(4453);
const DateUtils = tmp(4509);
const useChannelName = tmp(4982);
const useMessageAuthor = tmp(5076);
const AutomodMessageUtils = tmp(6923);
const RowGeneratorStyleSheet = tmp(7373);
const AutomodNotificationEmbedTypeKeys = tmp(7428);
const AutomodRaidAlertTypes = tmp(7451);
const GuildAntiRaidUtils = tmp(7452);
const getRoleIcon = tmp(7457);
...
export const createAutoModerationActionSystemMessage = function createAutoModerationActionSystemMessage(message) {
  ...
  if (obj.isAutomodMessageRecord(message)) {
    ...
    if (result1) {
        ...
        if (AutomodNotificationEmbedTypeKeys.AutomodNotificationEmbedTypeKeys.RAID !== notificationType) {
          if (AutomodNotificationEmbedTypeKeys.AutomodNotificationEmbedTypeKeys.MENTION_RAID === notificationType) {
            ...
            if (null != resolvedReason.raidDatetime) {
              fromNowResult = _modDef4418(resolvedReason.raidDatetime).fromNow();
              const obj17 = _modDef4418(resolvedReason.raidDatetime);
            }
            ...
            obj2.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef6025)).uri;
            ...
            if (null != avatar) {
              ...
              obj4.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef7456)).uri;
              ...
              obj4.subtitleRight = _modDef4418(message.timestamp).fromNow();
              ...
              tmp14 = obj4;
              tmp15 = stringResult;
              const obj16 = _modDef4418(message.timestamp);
            }
            ...
            obj5.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef6025)).uri;
      ...
      let fromNowResult1;
      if (null != resolvedReason.raidDatetime) {
        fromNowResult1 = _modDef4418(resolvedReason.raidDatetime).fromNow();
        const obj22 = _modDef4418(resolvedReason.raidDatetime);
      }
      let str2 = "";
      if (null != resolvedReason.raidDatetime) {
        const _Date = Date;
      ...
      obj8.headerIconURL = getRaidAlertResolveCTAText(intl9(importDefault(tmp42 ? 7455 : 6025))).uri;
    ...
    if (null == guildId) {
      ...
      obj12.actionsIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(tmp57(result1 ? 7458 : 7459))).uri;
