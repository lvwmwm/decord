...
// Dependencies: [2044, 2066, 1074, 5076, 7397, 7434, 7435, 7429, 1400, 1397, 7399, 1115, 7401, 2]
  ...
  if (null == roleSubscriptionData) {
    ...
    if (null != guildId) {
      if (null != channel) {
        ...
        const tmp5Result = tmp5(7434);
        if (tmp5Result.computeIsStickerReplyEnabled(guildId, channel, message, tmp9)) {
          const tmp5Result7 = tmp5(7435);
          const tmp5Result8 = tmp5(7429);
          const transformStickerResult = tmp5Result7.transformSticker(tmp5(7429).pickRoleSubscriptionPurchaseSticker(message.id));
        }
      }
    }
    utils_AvatarUtils;
    if (null != guildMemberAvatar) {
      ...
      obj6.content = tmp5(7429).getRoleSubscriptionPurchaseSystemMessageContentMobile(obj5);
      ...
      const tmp5Result11 = tmp5(7429);
      obj6.stickerLabel = tmp5(7429).getRoleSubscriptionPurchaseStickerCTA(message.id, false);
