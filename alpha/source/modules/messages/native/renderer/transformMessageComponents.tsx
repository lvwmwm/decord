...
// Dependencies: [109, 17, 4982, 8384, 8135, 1370, 1978, 4981, 1115, 8385, 8392, 8393, 8395, 8398, 8399, 4969, 5353, 8400, 8402, 8213, 4907, 1385, 4987, 8381, 8380, 1366, 1438, 1091, 4747, 8416, 1365, 4410, 2]
                    ...
                    if (null != height) {
                      if (height > 0) {
                        if (obj.isImageContentType(contentType)) {
                          let VISUAL_PLACEHOLDER = tmp(8399).MediaGalleryItemType.IMAGE;
                        } else {
                          if (tmpResult.isVideoContentType(contentType)) {
                            VISUAL_PLACEHOLDER = tmp(8399).MediaGalleryItemType.VIDEO;
                          }
                          tmpResult = tmp(4907);
                        }
  ...
  if (null != width) {
    if (width > 0) {
      if (null != height) {
        if (height > 0) {
          if (obj.isImageContentType(contentType)) {
            return tmp(8399).MediaGalleryItemType.IMAGE;
          } else {
            if (tmpResult.isVideoContentType(contentType)) {
              return tmp(8399).MediaGalleryItemType.VIDEO;
            }
            tmpResult = tmp(4907);
          }
          obj = MediaFormatTesters;
