...
// Dependencies: [19, 7919, 4407, 7920, 8083, 1372, 11923, 1074, 2049, 7846, 21, 4601, 11, 11924, 10515, 7429, 1241, 7701, 5109, 1115, 11925, 11928, 11929, 4468, 8079, 11931, 8010, 4614, 1101, 4981, 7436, 4454, 4902, 4770, 10511, 4907, 1366, 10206, 8540, 8645, 8648, 7536, 4724, 11932, 1980, 7533, 8912, 2614, 7520, 4768, 8452, 11934, 4937, 11524, 11935, 1110, 11936, 1978, 11961, 11966, 11967, 11971, 11984, 2]
...
export const handleCopyMessageLink = function handleCopyMessageLink(channel, message_id) {
  ...
  if (null != channelPermalink) {
    ...
    tmp3(4454).presentLinkCopied();
    const tmp3Result2 = tmp3(4454);
  }
};
...
export const longPressMessageOptionHandler = function longPressMessageOptionHandler(analyticsLocations) {
  ...
  if (!disabled) {
      ...
      if (intl26.string(tmp(1115).t.n5EBAJ) !== label) {
        ...
        if (intl27.string(id(2614)["1D+vqy"]) === label) {
          if (tmpResult.canReportMessageToMods(message)) {
            let result = tmp(8912).showReportToModMessageModal(message);
            const tmpResult34 = tmp(8912);
          }
          tmpResult = tmp(7520);
        } else {
          ...
          if (intl28.string(tmp(1115).t.k5WiPf) === label) {
            ...
            if (intl29.string(tmp(1115).t["+TSRGD"]) === label) {
              tmp(4768).transitionToMessage(id, id2, { navigationReplace: true });
              const tmpResult36 = tmp(4768);
            } else {
              const intl30 = tmp(1115).intl;
              if (intl30.string(tmp(1115).t.zBoHlf) === label) {
                tmp(7436).copy(id2);
                const tmpResult37 = tmp(7436);
                const result1 = tmp(4454).presentMessageIdCopied();
                const tmpResult38 = tmp(4454);
              } else {
                    ...
                    if (intl33.string(tmp(1115).t.fsBWmS) === label) {
                      ...
                      if (intl34.string(tmp(1115).t.Y8ujqr) === label) {
                        ...
                        if ("attachment" === sourceType) {
                          ...
                          tmp131(4724).openLazy(tmp(1980)(11934, tmp2.paths), "EditAttachmentActionSheet", obj3);
                                    ...
                                    if (intl41.string(tmp(1115).t["5911Lb"]) === label) {
                                      ...
                                      if (intl42.string(tmp(1115).t.JrGD7E) === label) {
                                        ...
                                        if (isMessageComponentsV2(contentMessage)) {
                                          const allTextDisplayContent = tmp(4981).getAllTextDisplayContent(contentMessage.components);
                                          if (null != allTextDisplayContent) {
                                            tmp(7436).copy(allTextDisplayContent);
                                            const tmpResult40 = tmp(7436);
                                          }
                                          const tmpResult39 = tmp(4981);
                                        } else {
                                          tmp(7436).copy(contentMessage.content);
                                          const tmpResult41 = tmp(7436);
                                        }
                                        tmp(4454).presentMessageCopied();
                                        const tmpResult42 = tmp(4454);
                                      } else {
                                        const intl43 = tmp(1115).intl;
                                        if (intl43.string(tmp(1115).t.lfIHs4) === label) {
                                          const result4 = tmp(11524).handleAddNewReactions(channel, id2);
                                          const tmpResult43 = tmp(11524);
                                        } else {
                                          const intl44 = tmp(1115).intl;
                                          if (intl44.string(tmp(1115).t.gHp0C4) === label) {
                                            if ("Preview" === actionSheetSource) {
                                              const result5 = tmp(11524).handleViewPreviewReactions(id2, id);
                                              const tmpResult44 = tmp(11524);
                                            } else {
                                              ...
                                              tmp(11524).handleViewReactions(obj18);
                                              const tmpResult45 = tmp(11524);
                                            }
                                          } else {
                                            const intl45 = tmp(1115).intl;
                                            if (intl45.string(tmp(1115).t.ZbtGBm) === label) {
                                              const result6 = tmp(11524).handleRemoveAllReactions(id, id2);
                                              const tmpResult46 = tmp(11524);
                                            } else {
                                              ...
                                              if (intl46.string(tmp(1115).t["g33r/P"]) === label) {
                                                ...
                                                if (intl47.string(tmp(1115).t.Xrt5Po) === label) {
                                                  ...
                                                  const channelPermalink = tmp(4902).getChannelPermalink(channel.guild_id, channel.id, id2);
                                                  if (null != channelPermalink) {
                                                    tmp(7436).copy(channelPermalink);
                                                    const tmpResult48 = tmp(7436);
                                                    tmp(4454).presentLinkCopied();
                                                    const tmpResult49 = tmp(4454);
                                                  }
                                                  const tmpResult47 = tmp(4902);
                                                } else {
                                                  ...
                                                  if (intl48.string(tmp(1115).t.RpE9k7) === label) {
                                                    ...
                                                    if (intl49.string(tmp(1115).t["S/xNKV"]) === label) {
                                                      ...
                                                      if (null != mediaUrl) {
                                                        closure_131_2 = tmp(4907).urlMatchesFileExtension(selectedMedia.mediaUrl, closure_15);
                                                        const tmpResult50 = tmp(4907);
                                                      ...
                                                      if (intl50.string(tmp(1115).t.JVuuz3) === label) {
                                                        ...
                                                        if (null != mediaUrl1) {
                                                          const result8 = tmp(8540).downloadMediaAssetWithContentType(selectedMedia.mediaUrl, constants6.VIDEO, selectedMedia.contentType);
                                                          result8.then(() => {
                                                        ...
                                                        if (intl51.string(tmp(1115).t.vbAEaA) === label) {
                                                          ...
                                                          if (null != mediaUrl2) {
                                                            ...
                                                            tmp(8645).handleClick(obj22);
                                                            const tmpResult52 = tmp(8645);
                                                          }
                                                        } else {
                                                                  ...
                                                                  if (intl56.string(tmp(1115).t.rBIGBL) === label) {
                                                                    ...
                                                                    if (intl57.string(tmp(1115).t["39d0Wj"]) === label) {
                                                                      ...
                                                                      if (intl58.string(tmp(1115).t.PHjkRE) === label) {
                                                                        ...
                                                                        const result11 = tmp(4614).navigateToContextMenuCommands(obj25);
                                                                        const tmpResult58 = tmp(4614);
                                                                      } else {
                                                                        const intl59 = tmp(1115).intl;
                                                                        if (intl59.string(tmp(1115).t.tpxJto) === label) {
                                                                          const obj26 = { channelId: id, messageId: id2, displayToast: true, source: tmp(11966).SavedMessageSources.LONG_PRESS_ACTION_SHEET };
                                                                          const result12 = tmp(11961).addOrUpdateSavedMessage(obj26);
                                                                          const tmpResult59 = tmp(11961);
                                                                        } else {
                                                                          ...
                                                                          if (intl60.string(tmp(1115).t.SvXS1Z) === label) {
                                                                            ...
                                                                            tmp(11961).removeSavedMessage(obj27);
                                                                            const tmpResult60 = tmp(11961);
                                                                          } else {
                                                                            ...
                                                                            if (intl61.string(tmp(1115).t.mJ3P0N) === label) {
                                                                              ...
                                                                              obj28.onBack = onBack;
                                                                              tmp131(4724).openLazy(tmp(1980)(11967, tmp2.paths), "MessageReminderDurationActionSheet", obj28);
                                                                              ...
                                                                              if (intl62.string(tmp(1115).t.vrbqs1) === label) {
                                                                                ...
                                                                                obj29.onBack = onBack;
                                                                                tmp131(4724).openLazy(tmp(1980)(11967, tmp2.paths), "MessageReminderDurationActionSheet", obj29);
                                                                                ...
                                                                                if (intl63.string(tmp(1115).t.ZH7P2h) === label) {
                                                                                  if (null != selectedMedia) {
                                                                                    ...
                                                                                    if (result13) {
                                                                                      ...
                                                                                      obj30.embedId = id3;
                                                                                      tmp131(4724).openLazy(tmp(1980)(11932, tmp2.paths), closure_20, obj30);
                                                                                  ...
                                                                                  if (intl64.string(tmp(1115).t.grdwwt) === label) {
                                                                                    ...
                                                                                    if (intl65.string(tmp(1115).t.Rjezbz) === label) {
                                                                                      ...
                                                                                      tmp131(4724).openLazy(tmp(1980)(11984, tmp2.paths), "AppInteractionInfoActionSheet", obj32);
                                                          ...
                                                          if (flag) {
                                                            ...
                                                            tmp(4454).presentLinkCopied();
                                                            flag = true;
                                                            const tmpResult63 = tmp(4454);
                                                          }
                                                          if (flag) {
                                                            let hostname;
                                                            if (null != mediaUrl3) {
                                                              hostname = tmp(8648).getHostname(mediaUrl3);
                                                              const tmpResult64 = tmp(8648);
                                                            }
    ...
    if (tmpResult65.canReportMessage(message)) {
      const result14 = tmp(8912).showReportModalForMessage(message, "mobile_message_action_sheet");
      const tmpResult66 = tmp(8912);
    }
