...
// Dependencies: [19, 17, 5888, 21, 4827, 576, 5887, 1397, 5890, 4823, 1115, 5425, 10682, 5893, 1177, 2]

// Module 10683 (ExpressionGuildDetails)
...
const GuildBadgeDefault = tmp8(5893);
require = fn;
const View = fn(17).View;
const React4 = fn(5888).ExpressionSourceGuildRecord;
const jsxProd = fn(21);
