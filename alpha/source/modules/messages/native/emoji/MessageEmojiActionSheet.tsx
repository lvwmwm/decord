...
// Dependencies: [19, 17, 1074, 21, 4827, 1364, 1255, 7481, 1241, 10671, 10678, 10679, 2]
// Exports: default

// Module 10670 (MessageEmojiActionSheet)
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import StandardEmojiContentDefault from "StandardEmojiContent" /* 10671 */;
import CustomEmojiContentDefault from "CustomEmojiContent" /* 10679 */;
...
function MessageCustomEmojiActionSheet(emojiNode) {
  ...
  if (emojiAndSource.isFetching) {
    ...
    return jsx(tmp2(7481).BottomSheet, {
      startExpanded: true,
      onDismiss() {
          AnalyticsUtilsDefault.track(AnalyticEvents.CLOSE_POPOUT, { nonce });
        },
