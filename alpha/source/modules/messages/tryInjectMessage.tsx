...
// Dependencies: [502, 1074, 7997, 4979, 1385, 12211, 12212, 2]
// Exports: tryCreateInjectedMessage

// Module 12210 (tryInjectMessage)
        ...
        if (id2.isDM()) {
          ...
          if (id.author.id !== AuthenticationStore.getId()) {
            ...
            if (null == id.activity) {
              ...
              tmp4 = null;
              if (!tmpResult.hasFlag(num, tmp(12211).ChannelRecipientPrivateUserDataFlags.DISMISSED_IN_GAME_MESSAGE_NUX)) {
                tmp4 = null;
                if (!obj.has(id2.id)) {
                  ...
                  const messageRecord1 = tmp(4979).createMessageRecord(tmp9);
                  ...
                  const setFlagResult = tmp(1385).setFlag(num2, tmp(12211).ChannelRecipientPrivateUserDataFlags.DISMISSED_IN_GAME_MESSAGE_NUX, true);
                  const result1 = tmp6(12212).updatePrivateChannelRecipientFlags(id2.id, setFlagResult);
                  tmp4 = messageRecord1;
                  const tmp6Result = tmp6(12212);
                }
              }
              tmpResult = tmp(1385);
            }
