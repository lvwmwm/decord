...
// Dependencies: [1074, 1091, 7514, 11, 4439, 2]
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4439).isWithinInterval(content.timestamp, type.timestamp, closure_6);
