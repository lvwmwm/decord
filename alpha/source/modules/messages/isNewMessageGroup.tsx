...
// Dependencies: [1074, 1091, 7600, 11, 4507, 2]
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4507).isWithinInterval(content.timestamp, type.timestamp, closure_6);
