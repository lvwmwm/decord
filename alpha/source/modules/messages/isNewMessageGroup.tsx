...
// Dependencies: [1074, 1091, 6683, 11, 4509, 2]
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4509).isWithinInterval(content.timestamp, type.timestamp, closure_6);
