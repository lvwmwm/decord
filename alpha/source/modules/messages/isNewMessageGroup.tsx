...
// Dependencies: [1074, 1091, 7598, 11, 4505, 2]
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4505).isWithinInterval(content.timestamp, type.timestamp, closure_6);
