...
// Dependencies: [5, 17, 1074, 1085, 675, 3, 1233, 1101, 1241, 14437, 5169, 5174, 1357, 1231, 1363, 5170, 1364, 4806, 1609, 1358, 1344, 2]
// Exports: initSentry
...
function trackCrash(event, hint, arg2) {
  ...
  const AppCrashedReasons = tmp11(14437).AppCrashedReasons;
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          require("module_675").setTag("buildNumber", "6493");
