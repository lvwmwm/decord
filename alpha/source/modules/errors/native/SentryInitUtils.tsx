...
// Dependencies: [5, 17, 1074, 1085, 675, 3, 1233, 1101, 1241, 13625, 5179, 5184, 1357, 1231, 1363, 5180, 1364, 4812, 1610, 1358, 1344, 2]
// Exports: initSentry
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          require("module_675").setTag("buildNumber", "6521");
