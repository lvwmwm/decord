...
// Dependencies: [5, 17, 1074, 1085, 675, 3, 1233, 1101, 1241, 14446, 5171, 5176, 1357, 1231, 1363, 5172, 1364, 4808, 1609, 1358, 1344, 2]
// Exports: initSentry
...
function trackCrash(event, hint, arg2) {
  ...
  const AppCrashedReasons = tmp11(14446).AppCrashedReasons;
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          require("module_675").setTag("buildNumber", "6502");
