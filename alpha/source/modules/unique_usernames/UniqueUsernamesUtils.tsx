...
export const formatUsernameLiveCheckValidation = function formatUsernameLiveCheckValidation(arg0) {
  const match = _mod5021.match(arg0);
  let obj = { error: null };
  const P = _mod5021.P;
  obj.error = P.not(_mod5021.P.nullish);
  ...
  const obj2 = { error: _mod5021.P.nullish };
  return withResult3.with({ error: _mod5021.P.nullish }, () => ({ type: UniqueUsernamesTypes.NameValidationState.INTERNAL_ERROR, message: "" })).otherwise(() => {
