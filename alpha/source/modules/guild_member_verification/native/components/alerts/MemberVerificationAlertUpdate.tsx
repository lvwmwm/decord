...
// Dependencies: [19, 17, 1074, 21, 4827, 5290, 1115, 4518, 7422, 4823, 2]
// Exports: default

// Module 7421 (MemberVerificationAlertUpdate)
...
export default function MemberVerificationAlertUpdate(onClose) {
  ...
  const items = [hasOwnProperty(Image, { source: _modDef7422, style: tmp.headerImage }), , ];
