...
// Dependencies: [19, 4649, 21, 563, 5872, 5830, 1115, 5840, 7424, 5271, 2]
// Exports: default

// Module 7423 (MemberVerificationAlertIncomplete)
...
export default function MemberVerificationAlertIncomplete(guildId) {
  ...
  obj3.icon = guildId(7424).ListViewIcon;
