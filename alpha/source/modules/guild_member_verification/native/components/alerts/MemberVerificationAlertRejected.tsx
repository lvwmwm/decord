...
// Dependencies: [5, 19, 2107, 1372, 4653, 21, 5852, 504, 5853, 5848, 5876, 1115, 5844, 5987, 5274, 2]
// Exports: default

// Module 5851 (MemberVerificationAlertRejected)
    ...
    if (dependencyMap === 2) {
      ...
      try {
        ...
        if (0 === v1) {
          ...
          const result = guildId(5876).openMemberVerificationModal(closure_128_0);
          dependencyMap = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp19) {
