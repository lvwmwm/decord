...
// Dependencies: [19, 17, 5876, 21, 4827, 576, 1397, 5886, 1612, 4559, 5283, 5887, 5893, 4823, 1115, 2]
// Exports: default

// Module 5885 (MemberVerificationGuildHeader)
...
const MemberVerificationFormConstants = fn(5876);
...
export default function MemberVerificationGuildHeader(hasManualFormFields) {
  ...
  if (null != guild.banner) {
    ...
    tmp3 = top;
    guildBannerSource = require("module_5886");
    tmp5 = importDefault;
  }
