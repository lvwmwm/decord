...
// Dependencies: [19, 17, 2044, 7484, 7541, 21, 4829, 576, 8589, 8578, 8575, 8586, 8527, 17015, 8594, 8604, 11464, 13449, 13520, 504, 12981, 4652, 5273, 5377, 1115, 4653, 13288, 4825, 6946, 4507, 11, 4788, 5738, 8269, 4779, 4781, 1612, 17018, 2]
...
let closure_12 = noop.memo((user) => {
  ...
  if (null != user) {
    ...
    const items1 = [closure_8(tmp(8594), obj3), ];
    ...
    obj5.onPress = tmp8;
    const items2 = [closure_8(tmp(8604), obj5), ];
...
let closure_14 = noop.memo((joinRequest) => {
  ...
  if (applicationStatus === MemberVerificationTypes.GuildJoinRequestApplicationStatuses.SUBMITTED) {
    if (null != joinRequest.interviewChannelId) {
      ...
      const items = [React6(tmp2(13288).HourglassIcon, obj4), ];
  ...
  if (MemberVerificationTypes.GuildJoinRequestApplicationStatuses.REJECTED === applicationStatus) {
    ...
    const items2 = [React6(tmp2(6946).CircleXIcon, obj10), ];
  ...
  } else if (tmp2(4653).GuildJoinRequestApplicationStatuses.APPROVED === applicationStatus) {
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  if (tmp6Result) {
    ...
    obj6.icon = tmp6(tmp2(5377).ChatIcon, obj7);
    const intl3 = tmp2(1115).intl;
    obj6.label = intl3.string(tmp2(1115).t.KQeYoC);
    obj6.onPress = handleOpenInterview;
    obj6.disabled = submitting;
    tmp6Result = tmp6(tmp2(8269).IconButton, obj6);
  }
  children[2] = tmp6Result;
  return tmp5(joinRequest(5738).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
let closure_16 = noop.memo((arg0) => {
  ...
  if (MemberVerificationTypes.VerificationFormFieldTypes.TERMS === field_type) {
    ...
    obj2.children = items1;
    return React7(View, obj2);
  } else if (tmp2(4653).VerificationFormFieldTypes.MULTIPLE_CHOICE === field_type) {
