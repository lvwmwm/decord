...
// Dependencies: [5358, 1074, 4653, 1370, 2]
  ...
  if (required.required) {
    if (null == response) {
      ...
      if (MemberVerificationTypes.VerificationFormFieldTypes.TERMS !== field_type) {
        if (tmp4(4653).VerificationFormFieldTypes.VERIFICATION !== field_type) {
          if (tmp4(4653).VerificationFormFieldTypes.TEXT_INPUT !== field_type) {
            if (tmp4(4653).VerificationFormFieldTypes.PARAGRAPH !== field_type) {
              if (tmp4(4653).VerificationFormFieldTypes.MULTIPLE_CHOICE === field_type) {
