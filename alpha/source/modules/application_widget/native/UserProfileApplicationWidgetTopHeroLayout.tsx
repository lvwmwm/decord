...
// Dependencies: [32, 19, 17, 1074, 7539, 21, 4827, 576, 9280, 8585, 9367, 9368, 5967, 5283, 2]
// Exports: default
...
export default function UserProfileApplicationWidgetTopHeroLayout(header) {
  ...
  if (tmp15Result) {
    ...
    tmp15Result = tmp15(tmp4(9368).ImageSkeleton, obj9);
  }
  ...
  if (tmp15Result4) {
    ...
    if (tmp15Result3) {
      ...
      tmp15Result3 = tmp15(_modDef5967, obj12);
    }
