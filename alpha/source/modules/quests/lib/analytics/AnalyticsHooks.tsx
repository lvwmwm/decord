...
// Function ID: 12116
// Name: AnalyticsHooks
// Dependencies: [19, 1074, 11829, 8041, 8022, 8057, 8051, 8000, 1255, 1364, 8053, 5752, 5756, 1241, 2]
...
import QuestHomeSearchSession from "QuestHomeSearchSession" /* 8053 */;
...
export const useTrackQuestEventWithImpression = function useTrackQuestEventWithImpression() {
  getQuestImpressionId = getQuestImpressionId(11829).useGetQuestImpressionId();
...
export const useTrackQuestContentClickedWithImpression = function useTrackQuestContentClickedWithImpression() {
  const getQuestImpressionId = callback(11829).useGetQuestImpressionId();
  ...
  return noop.useCallback((questId) => {
    ...
    const adMetadataSealed = callback(8022).getAdMetadataSealed(sourceQuestContent);
    let obj = callback(8022);
    const adTrafficMetadataSealed = callback(8022).getAdTrafficMetadataSealed(sourceQuestContent, questId);
    let obj2 = callback(8022);
    let obj3 = callback(8057);
    const adUser = obj3.getAdUser(callback(8051).getQuestContentName(questContent));
...
export const useTrackAdContentClickedWithImpression = function useTrackAdContentClickedWithImpression() {
  ...
  return noop.useCallback((arg0) => {
    ...
    let obj = callback(8057);
    const adUser = obj.getAdUser(callback(8051).getQuestContentName(questContent));
    adUser.then((advertisingId) => {
...
export const useQuestHomeEntrypointAnalyticsEvents = function useQuestHomeEntrypointAnalyticsEvents(questHomeHero) {
  ...
  let memo;
  const QuestContent = questHomeHero(5752).QuestContent;
