...
// Dependencies: [5, 8021, 8053, 5742, 4876, 5741, 8024, 8026, 5747, 1074, 5750, 1271, 573, 4728, 1115, 8031, 1231, 5020, 1249, 5167, 8061, 8050, 8060, 5754, 8039, 11623, 8020, 5017, 5025, 11624, 7789, 8042, 11625, 4666, 11626, 11627, 11642, 1241, 7998, 11644, 11628, 1091, 11645, 2]
          ...
          if (arg0 === 1) {
            ...
            if (null != questContentCTA.questContentCTA) {
              ...
              if (obj27.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "enroll_in_quest")) {
                ...
                tmp73(8050).captureAdUserAction(obj5);
                const tmp73Result = tmp73(8050);
              } else {
                ...
                const result = tmp73(8039).trackQuestContentClicked(obj6);
                const tmp73Result2 = tmp73(8039);
              }
