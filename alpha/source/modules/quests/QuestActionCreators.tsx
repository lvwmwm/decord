...
// Dependencies: [5, 7939, 7971, 5658, 4806, 5657, 7942, 7944, 5663, 1074, 5666, 1271, 573, 4658, 1115, 7949, 1231, 4950, 1249, 5083, 7979, 7968, 7978, 5670, 7957, 11547, 7938, 4947, 4955, 11548, 7706, 7960, 11549, 4596, 11550, 11551, 11566, 1241, 7916, 11568, 11552, 1091, 11569, 2]
          ...
          if (arg0 === 1) {
            ...
            if (null != questContentCTA.questContentCTA) {
              ...
              if (obj27.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "enroll_in_quest")) {
                ...
                tmp73(7968).captureAdUserAction(obj5);
                const tmp73Result = tmp73(7968);
              } else {
                ...
                const result = tmp73(7957).trackQuestContentClicked(obj6);
                const tmp73Result2 = tmp73(7957);
              }
