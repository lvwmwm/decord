...
// Function ID: 7939
// Name: QuestDataUtils
// Dependencies: [7939, 2109, 7941, 7942, 5663, 5666, 1385, 7940, 1231, 2]
...
function getQuestDeliveryDataForPlacement(questPlacementFromQuestContent, adContentId) {
  ...
  if (null != tmp) {
    ...
    if (questPlacementFromQuestContent === QuestTypes.AdPlacement.QUEST_HOME_BANNER_DESKTOP) {
      if (null != value) {
        const obj5 = { questId: tmp11(7940).getDeliveredQuestId(value.creative), adCreativeId: null, adDecisionData: null, adContext: null, metadataSealed: null, trafficMetadataSealed: null, provenanceMetadataSealed: null };
        const tmp11Result = tmp11(7940);
        obj5.adCreativeId = tmp11(7940).getDeliveredAdCreativeId(value.creative);
        ...
        let tmp8 = obj5;
        const tmp11Result4 = tmp11(7940);
      }
      return tmp8;
    }
    tmp8 = null;
    if (null != value) {
      const obj6 = { questId: tmp11(7940).getDeliveredQuestId(value.creative), adCreativeId: null, adDecisionData: null, adContext: null, metadataSealed: null, trafficMetadataSealed: null, provenanceMetadataSealed: null };
      const tmp11Result5 = tmp11(7940);
      obj6.adCreativeId = tmp11(7940).getDeliveredAdCreativeId(value.creative);
...
export const isDismissed = function isDismissed(dismissedQuestContent, arg1) {
  ...
  if (keys.includes(QuestTypes.QuestContent[arg1])) {
    return tmp2(1385).hasFlag(dismissedQuestContent.dismissedQuestContent, tmp[tmp2(undefined, 5666).QuestContent[arg1]]);
  } else {
    return false;
  }
  tmp = React5;
