...
// Dependencies: [32, 19, 17, 7941, 2039, 21, 576, 4757, 2028, 7633, 15345, 573, 15347, 11742, 504, 15354, 15360, 2]

// Module 15344 (QuestHomeBounties)
import DispatcherDefault from "Dispatcher" /* 573 */;
import nativeDefault from "native" /* 576 */;
import dismissible_content from "dismissible_content" /* 2028 */;
import openBountiesNuxPromoSheetDefault from "openBountiesNuxPromoSheet" /* 15345 */;
import BountiesCtaHeaderDefault from "BountiesCtaHeader" /* 15354 */;
import QuestHomeOrbShopCarouselDefault from "QuestHomeOrbShopCarousel" /* 15360 */;
...
export default noop.memo(function QuestHomeBounties(shopCarouselConfig) {
  ...
  if (0 !== questHomeBounties.length) {
    if (!stateFromStores) {
      ...
      if (tmp11) {
        tmp11 = orbShopProducts.length >= tmp(15347).MIN_PRODUCTS_FOR_ORB_SHOP_CAROUSEL || showOrbShopPlaceholderCarousel;
        const tmp12 = orbShopProducts.length >= tmp(15347).MIN_PRODUCTS_FOR_ORB_SHOP_CAROUSEL || showOrbShopPlaceholderCarousel;
      }
      if (!tmp11) {
