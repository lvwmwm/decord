...
// Dependencies: [19, 17, 7941, 21, 4756, 576, 15393, 11738, 7960, 4379, 11767, 4752, 1115, 15415, 2]
// Exports: default

// Module 15420 (VideoQuestModalHeader)
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11767).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
  ...
  const items2 = [closure_6(View, obj4), closure_5(questTaskDetails(15415), { iconColor: closeButtonIconColor, onClose })];
