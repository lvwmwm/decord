...
// Dependencies: [19, 21, 4827, 15453, 11818, 12101, 5269, 576, 15458, 4823, 1115, 2]

// Module 15476 (VideoQuestModalReward)
import nativeDefault from "native" /* 576 */;
import QuestUtils from "QuestUtils" /* 12101 */;
import QuestProgressIndicatorDefault from "QuestProgressIndicator" /* 15458 */;
...
export default noop.memo(function VideoQuestModalReward(style) {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp3(4823).Text, obj8);
  }
  items2[1] = tmp9Result;
