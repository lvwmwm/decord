...
// Dependencies: [32, 19, 17, 5747, 1085, 21, 672, 576, 15458, 4827, 1364, 11628, 4559, 4828, 1612, 7454, 4533, 15460, 15475, 7404, 15476, 15454, 15477, 5269, 5425, 4823, 15478, 5890, 5271, 11638, 8265, 1115, 9952, 11282, 11818, 11847, 15423, 8613, 5283, 15480, 11281, 15367, 15365, 13293, 8267, 15453, 4794, 15481, 1980, 11821, 8043, 8061, 8050, 8060, 5754, 8049, 5750, 8039, 8707, 15482, 12101, 15483, 5755, 2]
...
export default noop.memo(function VideoQuestModalContentInProgress(arg0) {
  ...
  if (!tmp20) {
    tmp20 = "portrait" === tmp(11847).getVideoOrientation(tmp19);
    const tmpResult = tmp(11847);
  }
