...
// Dependencies: [32, 19, 17, 5749, 1085, 21, 672, 576, 15467, 4829, 1364, 11634, 4561, 4830, 1612, 7456, 4535, 15469, 15484, 7406, 15485, 15463, 15486, 5271, 5427, 4825, 15487, 5892, 5273, 11644, 8269, 1115, 9957, 11288, 11824, 11853, 15432, 8617, 5285, 15489, 11287, 15376, 15374, 13302, 8271, 15462, 4796, 15490, 1980, 11829, 8045, 8063, 8052, 8062, 5756, 8051, 5752, 8041, 8711, 15491, 12108, 15492, 5757, 2]
...
export default noop.memo(function VideoQuestModalContentInProgress(arg0) {
  ...
  if (!tmp20) {
    tmp20 = "portrait" === tmp(11853).getVideoOrientation(tmp19);
    const tmpResult = tmp(11853);
  }
