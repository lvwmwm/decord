...
// Dependencies: [19, 17, 21, 4827, 4676, 576, 4524, 4761, 4679, 5283, 5967, 2]
// Exports: default

// Module 15491 (PremiumRewardGradient)
...
function PremiumRewardGlowGradient(arg0) {
  ...
  items2[1] = glowLight;
  const items3 = [timestampProducer(_modDef5967, obj5), children];
  obj4.children = items3;
