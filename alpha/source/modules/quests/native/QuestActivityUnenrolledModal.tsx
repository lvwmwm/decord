...
// Dependencies: [5, 32, 19, 17, 8024, 17576, 5747, 21, 4827, 576, 1365, 4761, 4531, 504, 7499, 8045, 11818, 12109, 5750, 1397, 11622, 8049, 5030, 4541, 12108, 15445, 5269, 5890, 12104, 4823, 1115, 5271, 5920, 7705, 7323, 12112, 11545, 2]
// Exports: default

// Module 17577 (QuestActivityUnenrolledModal)
...
import openQuestAccessSuspendedBottomSheetDefault from "openQuestAccessSuspendedBottomSheet" /* 15445 */;
...
function QuestActivityUnenrolledModalInner(quest) {
  ...
  const theme = quest(4761).useTheme();
  let obj = quest(4761);
  const tmp4 = closure_14(quest(4531).isThemeDark(theme));
  let obj2 = quest(4531);
  ...
  let obj3 = quest(504);
  let obj4 = quest(7499);
  const getOrFetchApplication = obj4.useGetOrFetchApplication(quest(8045).getActivityApplicationId(quest));
  const obj5 = quest(8045);
  const questTaskDetails = quest(11818).useQuestTaskDetails(quest);
  let obj6 = quest(11818);
  const obj7 = quest(12109);
  const items1 = [getOrFetchApplication];
  const questsInstructionsToWinReward = obj7.useQuestsInstructionsToWinReward({ quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5750).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL });
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const obj4 = { questContent: tmp4(5750).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL, questContentCTA: tmp4(8049).QuestContentCTA.START_QUEST, sourceQuestContent: tmp4(5750).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: tmp4(11622).enrollInQuest(quest.id, obj4), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const obj8 = { quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_UNENROLLED_MODAL, sourceQuestContent: quest(5750).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL };
  const checkboxA11yNative = quest(4541).useCheckboxA11yNative({ checked });
  ({ accessibilityRole, accessibilityState } = checkboxA11yNative);
  const obj9 = quest(4541);
  const isQuestAccessSuspended = quest(11818).useIsQuestAccessSuspended();
  const obj10 = quest(11818);
  trackQuestContentClickedWithImpression = quest(12108).useTrackQuestContentClickedWithImpression();
  ...
  if (tmp18Result) {
    ...
    obj16.children = tmp18(checked(5890), obj17);
  ...
  obj19.children = closure_11(checked(12104), size);
  ...
  const items6 = [closure_11(quest(4823).Text, obj21), ];
  ...
  items6[1] = closure_12(quest(4823).Text, obj22);
  ...
  const items9 = [closure_11(quest(5271).Button, obj26), ];
  ...
  items9[1] = closure_11(quest(5271).Button, obj27);
  ...
  if (null == stateFromStores) {
    ...
    const obj3 = {
      ...
      headerTitle() {
          ...
          return closure_1_11(questId(4823).Text, obj);
        },
      render() {
    ...
    return closure_11(tmp(11545).Modal, obj4);
  }
  let obj = questId(504);
  tmp = questId;
};
