...
// Dependencies: [19, 17, 1074, 21, 4829, 576, 4796, 6795, 9411, 4522, 2110, 5274, 1115, 6395, 1612, 6570, 4537, 4825, 10684, 3520, 6566, 14670, 2]
// Exports: default
...
function Footer(eligibleToReceivePremiumRewards) {
  ...
  if (eligibleToReceivePremiumRewards.eligibleToReceivePremiumRewards) {
    ...
    items[1] = tmp9(tmp10(5274).Button, obj3);
    obj.children = items;
    let tmp11 = obj;
  } else {
    ...
    items1[1] = tmp9(tmp10(5274).Button, obj5);
    obj.children = items1;
    tmp11 = obj;
  }
