...
// Dependencies: [32, 5, 19, 17, 4749, 1372, 1979, 5663, 21, 4960, 12036, 1980, 4757, 576, 9121, 5850, 5899, 1115, 5806, 9094, 1365, 12037, 12038, 12039, 504, 9134, 1094, 11557, 12040, 12024, 5666, 12041, 7370, 4753, 5187, 2]
...
export default function QuestOrbsRewardModal(quest) {
  ...
  if (!tmp6) {
    ...
    let items6 = [tmp13(tmp2(4753).Heading, obj14), ];
    ...
    items6[1] = tmp13(tmp2(4753).Text, obj16);
    ...
    tmp11(tmp2(7370).SafeAreaPaddingView, rect);
  }
};
