...
// Dependencies: [19, 17, 1085, 21, 4757, 15377, 15367, 15388, 5666, 7967, 4691, 4608, 15366, 15467, 4753, 1115, 5806, 15471, 15472, 15425, 2]
...
export default noop.memo(function QuestDockUnenrolledHeader() {
  ...
  if (LIGHT === tmp10.DARK) {
    let tmp7Result4 = tmp7(15471);
  } else {
    tmp7Result4 = tmp7(15472);
  }
