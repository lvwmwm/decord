...
// Dependencies: [19, 17, 1085, 21, 4829, 15438, 15428, 15449, 5752, 8051, 4763, 4680, 15427, 15528, 4825, 1115, 5892, 15532, 15533, 15486, 2]
...
export default noop.memo(function QuestDockUnenrolledHeader() {
  ...
  if (LIGHT === tmp10.DARK) {
    let tmp7Result4 = tmp7(15532);
  } else {
    tmp7Result4 = tmp7(15533);
  }
