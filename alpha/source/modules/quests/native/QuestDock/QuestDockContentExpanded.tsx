...
// Dependencies: [19, 17, 5747, 15422, 21, 4827, 15423, 11696, 4559, 15421, 5270, 7404, 2]

// Module 15514 (QuestDockContentExpanded)
...
let QUEST_DOCK_MODE_CHANGE_PHYSICS = fn(15422).QUEST_DOCK_MODE_CHANGE_PHYSICS;
const jsx = fn(21).jsx;
