...
// Dependencies: [19, 17, 5663, 15370, 21, 4757, 15371, 11620, 4493, 15369, 5186, 7320, 2]

// Module 15462 (QuestDockContentExpanded)
...
let QUEST_DOCK_MODE_CHANGE_PHYSICS = fn(15370).QUEST_DOCK_MODE_CHANGE_PHYSICS;
const jsx = fn(21).jsx;
