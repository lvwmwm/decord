...
// Dependencies: [19, 15420, 5747, 15422, 21, 7405, 1478, 4559, 15424, 15421, 12367, 2]

// Module 15423 (QuestDockGestureContext)
...
const height = fn(15422).QUEST_DOCK_COLLAPSED_HEIGHT;
const jsx = fn(21).jsx;
