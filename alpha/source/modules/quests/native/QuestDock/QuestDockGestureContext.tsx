...
// Dependencies: [19, 14597, 5751, 14599, 21, 6490, 1478, 4563, 14601, 14598, 11502, 2]

// Module 14600 (QuestDockGestureContext)
...
const height = fn(14599).QUEST_DOCK_COLLAPSED_HEIGHT;
const jsx = fn(21).jsx;
