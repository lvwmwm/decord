...
// Dependencies: [5, 19, 5663, 1074, 21, 15377, 11779, 5670, 11562, 1115, 5666, 7967, 7979, 7968, 7978, 7957, 7446, 13219, 8876, 11755, 4724, 7444, 7961, 15379, 12024, 5899, 11546, 15381, 11780, 11742, 8996, 15382, 15384, 15386, 7215, 7627, 4703, 7436, 11377, 15388, 2]
// Exports: default

// Module 15378 (QuestDockContextMenuActionSheet)
...
function QuestDockPreviewTools(quest) {
  ...
  c3 = undefined;
  c4 = undefined;
  const questPreviewActions = quest(11742).useQuestPreviewActions(quest.id);
  ...
  let obj = quest(11742);
  obj3.icon = closure_6(quest(7446).ActionSheetRow.Icon, { IconComponent: quest(8996).TrophyIcon });
  ...
  let items = [closure_6(quest(7446).ActionSheetRow, obj3), , , , , , ];
  const obj6 = { icon: null, label: null, onPress: null };
  const obj4 = { IconComponent: quest(8996).TrophyIcon };
  obj6.icon = closure_6(quest(7446).ActionSheetRow.Icon, { IconComponent: quest(15382).RedoIcon });
  ...
  items[1] = closure_6(quest(7446).ActionSheetRow, obj6);
  const obj9 = { icon: null, label: null, onPress: null };
  const obj7 = { IconComponent: quest(15382).RedoIcon };
  obj9.icon = closure_6(quest(7446).ActionSheetRow.Icon, { IconComponent: quest(15384).UndoIcon });
  ...
  items[2] = closure_6(quest(7446).ActionSheetRow, obj9);
  const obj12 = { icon: null, label: null, onPress: null };
  const obj10 = { IconComponent: quest(15384).UndoIcon };
  obj12.icon = closure_6(quest(7446).ActionSheetRow.Icon, { IconComponent: quest(15386).UnsendIcon });
  ...
  items[3] = closure_6(quest(7446).ActionSheetRow, obj12);
  const obj15 = { icon: null, label: null, onPress: null };
  const obj13 = { IconComponent: quest(15386).UnsendIcon };
  obj15.icon = closure_6(quest(7446).ActionSheetRow.Icon, { IconComponent: quest(7215).EyeIcon });
  ...
  items[4] = closure_6(quest(7446).ActionSheetRow, obj15);
  const obj18 = { icon: null, label: null, onPress: null };
  const obj16 = { IconComponent: quest(7215).EyeIcon };
  obj18.icon = closure_6(quest(7446).ActionSheetRow.Icon, { IconComponent: quest(7215).EyeIcon });
  ...
  items[5] = closure_6(quest(7446).ActionSheetRow, obj18);
  const obj21 = { icon: null, label: null, onPress: null };
  const obj19 = { IconComponent: quest(7215).EyeIcon };
  obj21.icon = closure_6(quest(7446).ActionSheetRow.Icon, { IconComponent: quest(4703).CopyIcon });
  ...
  items[6] = closure_6(quest(7446).ActionSheetRow, obj21);
  obj2.children = items;
  return closure_7(quest(7446).ActionSheetRow.Group, obj2);
}
function QuestDockShareRow(quest) {
  quest = quest.quest;
  let obj = { icon: closure_6(quest(7446).ActionSheetRow.Icon, { IconComponent: quest(4703).CopyIcon }), label: null, onPress: null };
  ...
  return closure_6(quest(7446).ActionSheetRow, obj);
}
function QuestDockDisclosureRow(creative) {
  creative = creative.creative;
  let obj = { icon: closure_6(creative(7446).ActionSheetRow.Icon, { IconComponent: creative(11377).CircleQuestionIcon }), label: null, onPress: null };
  let obj3 = { text: null };
  ...
  return closure_6(creative(7446).ActionSheetRow, obj);
}
...
export default function QuestDockContextMenuActionSheet(creative) {
  ...
  function trackInternalClick(CONTEXT_MENU_HIDE_CONTENT) {
    if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_dock_context_menu")) {
      const obj2 = { type: tmp(7978).AdUserActionType.CLICK_INTERNAL };
  ...
  obj4.onPress = function onPress() {
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      tmp2(11755).openGameLinkDirectly(tmp.quest, obj3);
      const tmp2Result = tmp2(11755);
      ...
      const result = tmp2(11755).openAdGameLinkDirectly(obj, obj3);
      const tmp2Result2 = tmp2(11755);
    }
    ActionSheetActionCreatorsDefault.hideActionSheet();
  };
  ...
  if (!tmp3) {
    ...
    obj7.onPress = function onPress() {
      ...
      if (AdCreativeType.AdCreativeType.QUEST === type) {
        ...
        tmp(12024).openQuestHome(obj);
        const tmpResult = tmp(12024);
      } else if (tmp(5670).AdCreativeType.BOUNTY === type) {
        const obj2 = { fromContent: tmp(5666).QuestContent.QUEST_BAR_MOBILE };
        tmp(12024).openQuestHome(obj2);
        const tmpResult2 = tmp(12024);
      }
      ActionSheetActionCreatorsDefault.hideActionSheet();
    };
      ...
      try {
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            trackInternalClick(tmp2(7967).QuestContentCTA.CONTEXT_MENU_HIDE_CONTENT);
            const type = creative.type;
            if (tmp2(5670).AdCreativeType.QUEST === type) {
              const obj7 = tmp2(11546);
              const dismissQuestContentResult = tmp2(11546).dismissQuestContent(tmp36.quest.id, tmp2(5666).QuestContent.QUEST_BAR_MOBILE);
              v2(4724).hideActionSheet();
              v2 = 1;
              dependencyMap = 1;
              const obj9 = { value: dismissQuestContentResult, done: false };
              return obj9;
            } else if (tmp2(5670).AdCreativeType.BOUNTY === type) {
              const obj4 = tmp2(11780);
              const dismissAdContentResult = tmp2(11780).dismissAdContent(closure_1, tmp2(5666).QuestContent.QUEST_BAR_MOBILE);
              v2(4724).hideActionSheet();
              v2 = 2;
              dependencyMap = 1;
          ...
          if (arg0 === 1) {
            ...
            const result = tmp2(15381).displayQuestDismissalToast();
            const obj2 = tmp2(15381);
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
          throw value;
