...
// Dependencies: [32, 19, 17, 5751, 14599, 21, 4829, 576, 5273, 14600, 1365, 4528, 14690, 4563, 5428, 4825, 1115, 10557, 6489, 14699, 14667, 14701, 7360, 2]

// Module 14698 (QuestDockBackgroundBlurHeader)
...
export default noop.memo(function QuestDockBackgroundBlurHeader(promotedLabelLeading) {
  ...
  fn.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5273).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  fn.__workletHash = 17202411570804;
  fn.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(fn);
  let obj3 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5273).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  class W {
    constructor() {
  ...
  W.__closure = { withSpring: activeQuestDockMode(5273).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  W.__workletHash = 5804990093011;
  W.__initData = __initData2;
  const animatedStyle1 = obj4.useAnimatedStyle(W);
  let obj5 = { withSpring: activeQuestDockMode(5273).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  class F {
    constructor() {
      right = 0;
      if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
  ...
  V.__closure = { withSpring: activeQuestDockMode(5273).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  V.__workletHash = 6229744150165;
  V.__initData = __initData4;
  const animatedStyle3 = obj8.useAnimatedStyle(V);
  const obj9 = { withSpring: activeQuestDockMode(5273).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  class Z {
    constructor() {
      right = 0;
      if (activeQuestDockMode.get() !== QuestDockMode.EXPANDED) {
  ...
  fn3.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5273).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  fn3.__workletHash = 8904986205240;
  fn3.__initData = __initData7;
  const animatedStyle5 = obj12.useAnimatedStyle(fn3);
  const obj13 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5273).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  class J {
    constructor() {
      obj = closure_0(closure_2[8]);
      num = 0;
  ...
  J.__closure = { withSpring: activeQuestDockMode(5273).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  if (withPressableDisclosure) {
    ...
    items1[1] = tmp19(tmp(10557).CircleQuestionIcon, obj19);
    obj17.children = items1;
    obj16.children = closure_14(closure_13, obj17);
    let tmp19Result = tmp19(tmp(5428).PressableOpacity, obj16);
    let tmp22 = tmp19;
  } else {
  ...
  obj22.style = items3;
  const obj15 = { withSpring: activeQuestDockMode(5273).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  if (tmpResult.isAndroid()) {
    ...
    obj29.children = tmp25(tmp7(6489), obj30);
  ...
  tmp22Result = tmp22(tmp7(14667), { layoutAnimatedStyle: animatedStyle5, opacityAnimatedStyle: animatedStyle6, layoutAnimation: tmp27 });
});
