...
// Dependencies: [21, 4829, 576, 10698, 4563, 4830, 4833, 14553, 5274, 10706, 5758, 5756, 7136, 1115, 2]
// Exports: default

// Module 14558 (BountiesModalEndedCtaButtons)
...
export default function BountiesModalEndedCtaButtons(bounty) {
  ...
  let tmp = closure_5();
  closure_3 = bounty(10698).useGetQuestImpressionId();
  let obj = bounty(10698);
  const fn = function y() {
    let num = 0;
    if (visible) {
      num = 1;
  ...
  if (visible) {
    ...
    const items1 = [closure_3(tmp2(5274).Button, obj5), ];
    let tmp9Result = null;
    if (showCloseButton) {
      ...
      tmp9Result = tmp9(tmp2(5274).Button, obj6);
    }
    items1[1] = tmp9Result;
    obj4.children = items1;
    visible = closure_4(visible(4563).View, obj4);
    tmp9 = closure_3;
  }
  return visible;
};
