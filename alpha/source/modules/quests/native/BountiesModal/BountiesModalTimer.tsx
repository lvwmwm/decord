...
// Dependencies: [19, 17, 21, 5276, 4559, 8803, 4827, 576, 1364, 4828, 4823, 9632, 2]
// Exports: default

// Module 15379 (BountiesModalTimer)
...
let c7 = "#2ECC71";
let result = (fn(5276).SMALL_BUTTON_HEIGHT - 4) / 2;
...
let closure_13 = ReanimatedRexport.createAnimatedComponent(fn(8803).Circle);
...
let size = { alignItems: "center", justifyContent: "center", backgroundColor: nativeDefault.colors.CONTROL_OVERLAY_SECONDARY_BACKGROUND_DEFAULT, borderRadius: nativeDefault.radii.round, width: fn(5276).SMALL_BUTTON_HEIGHT, height: fn(5276).SMALL_BUTTON_HEIGHT };
obj.progress = size;
