...
let c7 = "#2ECC71";
let result = (fn(5286).SMALL_BUTTON_HEIGHT - 4) / 2;
...
let closure_13 = ReanimatedRexport.createAnimatedComponent(fn(7909).Circle);
...
let size = { alignItems: "center", justifyContent: "center", backgroundColor: nativeDefault.colors.CONTROL_OVERLAY_SECONDARY_BACKGROUND_DEFAULT, borderRadius: nativeDefault.radii.round, width: fn(5286).SMALL_BUTTON_HEIGHT, height: fn(5286).SMALL_BUTTON_HEIGHT };
obj.progress = size;
