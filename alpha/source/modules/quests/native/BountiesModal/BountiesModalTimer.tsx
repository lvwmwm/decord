...
// Dependencies: [19, 17, 21, 5279, 4563, 7901, 4829, 576, 1364, 4830, 4825, 8734, 2]
// Exports: default

// Module 14554 (BountiesModalTimer)
...
let c7 = "#2ECC71";
let result = (fn(5279).SMALL_BUTTON_HEIGHT - 4) / 2;
...
let closure_13 = ReanimatedRexport.createAnimatedComponent(fn(7901).Circle);
...
let size = { alignItems: "center", justifyContent: "center", backgroundColor: nativeDefault.colors.CONTROL_OVERLAY_SECONDARY_BACKGROUND_DEFAULT, borderRadius: nativeDefault.radii.round, width: fn(5279).SMALL_BUTTON_HEIGHT, height: fn(5279).SMALL_BUTTON_HEIGHT };
obj.progress = size;
