...
// Dependencies: [19, 17, 21, 5192, 4493, 8732, 4757, 576, 1364, 4758, 4753, 9559, 2]
// Exports: default

// Module 15327 (BountiesModalTimer)
...
let c7 = "#2ECC71";
let result = (fn(5192).SMALL_BUTTON_HEIGHT - 4) / 2;
...
let closure_13 = ReanimatedRexport.createAnimatedComponent(fn(8732).Circle);
...
let size = { alignItems: "center", justifyContent: "center", backgroundColor: nativeDefault.colors.CONTROL_OVERLAY_SECONDARY_BACKGROUND_DEFAULT, borderRadius: nativeDefault.radii.round, width: fn(5192).SMALL_BUTTON_HEIGHT, height: fn(5192).SMALL_BUTTON_HEIGHT };
obj.progress = size;
