...
// Dependencies: [19, 17, 4749, 5663, 21, 4757, 576, 4758, 4761, 4493, 5199, 15329, 15331, 15293, 504, 15294, 10232, 2]
// Exports: default

// Module 15328 (BountiesScrollEndCard)
...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  let obj = isActive(4493);
  S.__closure = { isScrollingInBoundsSharedValue, withTiming: isActive(4758).withTiming, isActive, timingStandard: isActive(4761).timingStandard };
  ...
  obj3.style = items;
  const items1 = [closure_8(closure_5, { style: tmp.backdropTint, pointerEvents: "none" }), closure_8(isScrollingInBoundsSharedValue(5199), { colors: ["rgba(0, 0, 0, 0.48)", "rgba(0, 0, 0, 0.8)"], style: tmp.backdropGradient, pointerEvents: "none" }), ];
  const obj6 = { style: null, pointerEvents: "box-none", children: null };
  const items2 = [tmp.overlayContent, animatedStyle];
  obj6.style = items2;
  const items3 = [closure_8(isScrollingInBoundsSharedValue(15329), { bounty, sourceQuestContent, disabled: !isActive }), ];
  const obj8 = {
    style: tmp.endedCtaButtonsContainer,
    pointerEvents: "box-none",
    children: closure_8(isScrollingInBoundsSharedValue(15331), {
      bounty,
      visible,
      sourceQuestContent,
      onClose() {
  ...
  items1[2] = closure_9(isScrollingInBoundsSharedValue(4493).View, obj6);
  obj3.children = items1;
  return closure_9(isScrollingInBoundsSharedValue(4493).View, obj3);
}
