...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  S.__closure = { isScrollingInBoundsSharedValue, withTiming: isActive(4837).withTiming, isActive, timingStandard: isActive(4840).timingStandard };
  ...
  items1[2] = closure_9(isScrollingInBoundsSharedValue(4566).View, obj6);
  obj3.children = items1;
  return closure_9(isScrollingInBoundsSharedValue(4566).View, obj3);
}
