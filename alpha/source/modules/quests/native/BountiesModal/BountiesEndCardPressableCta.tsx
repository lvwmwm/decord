...
// Dependencies: [19, 17, 15391, 21, 4829, 576, 11829, 15387, 11634, 11837, 5756, 5754, 8051, 5892, 4825, 2]
// Exports: default

// Module 15390 (BountiesEndCardPressableCta)
...
const END_CARD_IMAGE_SIZE = fn(15391).END_CARD_IMAGE_SIZE;
const jsxProd = fn(21);
