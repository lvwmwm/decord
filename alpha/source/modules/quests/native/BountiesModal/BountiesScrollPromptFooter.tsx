...
let obj2 = { withTiming: fn(4830).withTiming, timingStandard: fn(4833).timingStandard };
fn2.__closure = { withTiming: fn(4830).withTiming, timingStandard: fn(4833).timingStandard };
