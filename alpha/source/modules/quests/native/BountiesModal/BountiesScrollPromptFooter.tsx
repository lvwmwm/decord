...
// Dependencies: [19, 17, 4819, 5747, 21, 4827, 576, 4828, 4831, 504, 1612, 4559, 4533, 15345, 15346, 10311, 2]
// Exports: default

// Module 15344 (BountiesScrollPromptFooter)
...
function BountiesScrollPromptFooterContent(zIndex) {
  ...
  obj3.children = closure_7(zIndex(4533).BountiesScrollGradientRive, { stateMachine: "State Machine 1", fit: "fill", alignment: "bottom-center", withReducedMotion: str });
