...
// Dependencies: [19, 17, 1074, 7482, 21, 4827, 576, 8039, 5890, 4823, 11838, 1115, 11841, 11846, 1612, 4524, 672, 5283, 5271, 2]
...
export const AppStoreOverlayBody = function AppStoreOverlayBody(arg0) {
  ...
  if (tmp17Result) {
    ...
    tmp17Result = tmp17(tmp18(4823).Text, obj10);
  }
  ...
  if (tmp4Result) {
    ...
    const items5 = [tmp17(tmp18(4823).Text, obj13), ];
