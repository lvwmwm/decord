...
// Dependencies: [19, 17, 1074, 7398, 21, 4757, 576, 7957, 5806, 4753, 11762, 1115, 11765, 11770, 1612, 4458, 672, 5199, 5187, 2]
...
export const AppStoreOverlayBody = function AppStoreOverlayBody(arg0) {
  ...
  if (tmp17Result) {
    ...
    tmp17Result = tmp17(tmp18(4753).Text, obj10);
  }
  ...
  if (tmp4Result) {
    ...
    const items5 = [tmp17(tmp18(4753).Text, obj13), ];
