...
// Dependencies: [5756, 8047, 15438, 8063, 8052, 8062, 8041, 5032, 15450, 1980, 2]
...
export default {
  showModal(isTargetedDisclosure) {
    ...
    if (obj2.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_disclosure_modal")) {
      ...
      const result = tmp(8041).trackQuestContentClicked(obj5);
      ...
      const result1 = tmp(8041).trackAdContentClicked({ adContentId: null, adCreativeType: null, questContent: null, questContentCTA: null, questContentPosition: null, sourceQuestContent: null });
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      ...
      obj10.adCreativeType = tmp(5756).AdCreativeType.QUEST;
      ...
      obj10.isVideoQuest = tmp(8047).hasWatchVideoTasks(creative.quest);
      let tmp11 = obj10;
      const tmpResult6 = tmp(8047);
    } else if (tmp(5756).AdCreativeType.BOUNTY === type) {
      const obj11 = { adCreativeType: tmp(5756).AdCreativeType.BOUNTY, gamePublisher: creative.bounty.advertiserName };
      tmp11 = obj11;
    }
    const obj12 = {};
    const merged1 = Object.assign(tmp11);
    obj12.isTargetedDisclosure = isTargetedDisclosure.isTargetedDisclosure;
    obj9.pushLazy(asyncRequireImpl(15450, tmp2.paths), obj12, QUEST_DISCLOSURE_MODAL);
  },
  hideModal() {
