...
// Dependencies: [5754, 8045, 15429, 8061, 8050, 8060, 8039, 5030, 15441, 1980, 2]
...
export default {
  showModal(isTargetedDisclosure) {
    ...
    if (obj2.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_disclosure_modal")) {
      ...
      const result = tmp(8039).trackQuestContentClicked(obj5);
      ...
      const result1 = tmp(8039).trackAdContentClicked({ adContentId: null, adCreativeType: null, questContent: null, questContentCTA: null, questContentPosition: null, sourceQuestContent: null });
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      ...
      obj10.adCreativeType = tmp(5754).AdCreativeType.QUEST;
      ...
      obj10.isVideoQuest = tmp(8045).hasWatchVideoTasks(creative.quest);
      let tmp11 = obj10;
      const tmpResult6 = tmp(8045);
    } else if (tmp(5754).AdCreativeType.BOUNTY === type) {
      const obj11 = { adCreativeType: tmp(5754).AdCreativeType.BOUNTY, gamePublisher: creative.bounty.advertiserName };
      tmp11 = obj11;
    }
    const obj12 = {};
    const merged1 = Object.assign(tmp11);
    obj12.isTargetedDisclosure = isTargetedDisclosure.isTargetedDisclosure;
    obj9.pushLazy(asyncRequireImpl(15441, tmp2.paths), obj12, QUEST_DISCLOSURE_MODAL);
  },
  hideModal() {
