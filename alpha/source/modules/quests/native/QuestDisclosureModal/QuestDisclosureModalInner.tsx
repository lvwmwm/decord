...
// Dependencies: [17, 1074, 21, 4757, 576, 2020, 9406, 1115, 9173, 12083, 9354, 5911, 4753, 11562, 5826, 2108, 5187, 2]
// Exports: default
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  if (setting) {
    obj.icon = tmp5(tmp2(9406).ServerIcon, { size: "xs" });
    ...
    obj.icon = tmp5(tmp2(9173).GlobeEarthIcon, { size: "xs" });
    const intl = tmp2(1115).intl;
    obj.text = intl.string(tmp2(1115).t.xQSdPv);
    items1 = [obj, , ];
    const obj2 = { icon: tmp5(tmp2(12083).UserIcon, { size: "xs" }), text: null };
    const intl2 = tmp2(1115).intl;
    obj2.text = intl2.string(tmp2(1115).t.mYt7hQ);
    items1[1] = obj2;
    const obj3 = { icon: tmp5(tmp2(9354).GameControllerIcon, { size: "xs" }), text: null };
