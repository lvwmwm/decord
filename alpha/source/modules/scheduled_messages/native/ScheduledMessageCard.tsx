...
// Dependencies: [19, 17, 2042, 1074, 21, 4757, 576, 504, 1101, 4960, 5826, 12472, 5796, 12473, 10374, 4753, 1115, 8091, 12474, 12466, 12475, 2]

// Module 12471 (ScheduledMessageCard)
...
import ScheduledMessageCardActionButtonsDefault from "ScheduledMessageCardActionButtons" /* 12475 */;
...
export default noop.memo(function ScheduledMessageCard(scheduledMessage) {
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = closure_7(tmp2(12472).ForLaterCardHeader, obj4);
    ...
    if (isPendingRemoval) {
      ...
      if (length > 0) {
        ...
        const items2 = [tmp10(tmp2(10374).AttachmentIcon, obj9), ];
        ...
        items2[1] = tmp10(tmp2(4753).Text, obj10);
        obj8.children = items2;
        tmp9Result = tmp9(tmp12, obj8);
      }
      obj7.footer = tmp9Result;
      tmp10Result = tmp10(tmp2(12473).ForLaterMessageRow, obj7);
    }
    items1[3] = tmp10Result;
    obj2.children = items1;
    return closure_8(tmp2(5826).Card, obj2);
  }
