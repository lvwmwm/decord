...
// Dependencies: [32, 19, 1182, 4648, 1227, 576, 672, 4678, 4679, 1230, 4680, 4682, 4763, 4760, 2]
...
// Module 4647 (client_themes/ClientThemesUtils)
...
function calculateGradientValueWithOpacity(customBackgroundGradient, END, theme, arg3) {
  ...
  if (customBackgroundGradient.type === ClientThemesTypes.ClientThemeType.CUSTOM_BACKGROUND_GRADIENT) {
    ...
    tmp11 = arg3;
    if (arg3 == null) {
      tmp(4680).isThemeDark(theme) ? obj.LEVEL_2 : obj.LEVEL_4;
  ...
  if (tmp10 === obj3.START) {
    ...
    const color = tmp(4678).mixColors(tmp35, tmp38);
