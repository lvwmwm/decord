...
// Dependencies: [32, 19, 1182, 4646, 1227, 576, 672, 4676, 4677, 1230, 4678, 4680, 4761, 4758, 2]
...
// Module 4645 (client_themes/ClientThemesUtils)
...
function calculateGradientValueWithOpacity(customBackgroundGradient, END, theme, arg3) {
  ...
  if (customBackgroundGradient.type === ClientThemesTypes.ClientThemeType.CUSTOM_BACKGROUND_GRADIENT) {
    ...
    tmp11 = arg3;
    if (arg3 == null) {
      tmp(4678).isThemeDark(theme) ? obj.LEVEL_2 : obj.LEVEL_4;
  ...
  if (tmp10 === obj3.START) {
    ...
    const color = tmp(4676).mixColors(tmp35, tmp38);
