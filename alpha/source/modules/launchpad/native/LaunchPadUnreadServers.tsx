...
// Dependencies: [19, 17, 2042, 4772, 1372, 1074, 21, 4757, 576, 7587, 17451, 504, 1177, 11180, 5806, 13328, 4770, 4768, 8115, 16456, 1478, 17456, 1115, 7319, 2]

// Module 17450 (LaunchPadUnreadServers)
...
import isGuildSelectableDefault from "isGuildSelectable" /* 17456 */;
...
let closure_13 = noop.memo(function GuildItemInner(guildId) {
  ...
  obj.children = closure_10(onGuildSelect(17451), { size: 48, borderRadius: 16, guildId, selected: guildId.selected, onPress: callback, onLongPress: callback1, backgroundColor: tmp.maskStrokeStyle.backgroundColor });
