...
// Dependencies: [4749, 5678, 2042, 2105, 4977, 1372, 11694, 1074, 1085, 4942, 4410, 4414, 1397, 9039, 4402, 4383, 11975, 1115, 8006, 11977, 1364, 11978, 11979, 2]
      ...
      if (null != tmp9) {
        ...
        const mapped = answers.map((answer_id) => {
          ...
          if (null == name) {
            ...
            const match1 = tmp8(4942).match(layout_type);
            const str2 = tmp8(4942);
            obj2.votes = match1.with(tmp8(11977).PollLayoutTypes.IMAGE_ONLY_ANSWERS, () => "(" + num.toLocaleString() + ")").otherwise(() => {
