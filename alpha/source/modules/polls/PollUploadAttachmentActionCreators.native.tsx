...
// Dependencies: [5, 5106, 8074, 12462, 8478, 5356, 5346, 9427, 2]
...
// Module 12461 (PollUploadAttachmentActionCreators)
...
const POLL_ATTACHMENT_FOLDER = fn(8074).POLL_ATTACHMENT_FOLDER;
let size = fn(2);
