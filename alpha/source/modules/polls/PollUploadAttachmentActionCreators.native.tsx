...
// Dependencies: [5, 5192, 8158, 12547, 8553, 5442, 5432, 9502, 2]
...
// Module 12546 (PollUploadAttachmentActionCreators)
...
const POLL_ATTACHMENT_FOLDER = fn(8158).POLL_ATTACHMENT_FOLDER;
let size = fn(2);
