...
// Dependencies: [5, 32, 19, 8074, 8006, 12460, 11971, 12461, 12462, 12463, 1115, 11977, 2]
// Exports: default

// Module 12459 (useCreatePollFormData)
...
import PollUploadAttachmentActionCreatorsAll from "PollUploadAttachmentActionCreators" /* 12461 */;
import PollAttachmentUtils from "PollAttachmentUtils" /* 12462 */;
import PollTypes from "PollTypes" /* 12463 */;
...
function createPollCreationImageForMedia(mediaURL, status) {
  const obj = { mediaAttachmentState: { status, mediaURL }, emoji: "Array", stickerId: "limit" };
  return obj;
}
...
export default function useCreatePollCommonData(id, arg1, arg2, initialQuestion) {
  ...
  const callback5 = obj.useCallback((arg0, arg1, arg2) => {
    ...
    callback3(arg0, arg1);
    const obj = { mediaAttachmentState: { status: PollTypes.PollMediaUploadAttachmentStatus.PREPARING, mediaURL: objectURL }, emoji: "Array", stickerId: "limit" };
    callback2(obj, arg1);
    ...
    const obj4 = { mediaAttachmentState: null, emoji: "Array", stickerId: "limit" };
  ...
  const callback6 = obj.useCallback((emoji, arg1) => {
    callback3(id, arg1);
    callback2({ emoji, stickerId: "Array", mediaAttachmentState: "limit" }, arg1);
  }, items3);
  ...
  const callback10 = obj.useCallback(() => {
    ...
    if (first.filter((item) => c0(8006).isAnswerFilled(item)).length < React6) {
      c0 = false;
