...
// Function ID: 12452
// Name: PollCreation
// Dependencies: [19, 17, 8071, 21, 4756, 576, 1364, 5114, 1115, 6848, 1177, 12452, 4752, 12453, 4723, 12454, 1980, 5822, 4622, 9048, 1249, 7226, 8088, 12450, 4454, 10898, 4467, 12455, 12460, 5847, 8003, 5110, 12461, 7619, 5898, 12462, 12464, 8090, 12476, 8871, 12478, 5821, 2]
// Exports: default
...
export default function PollCreation(channel) {
  ...
  const callback = answers.useCallback((arg0) => {
    ...
    PollCreationModalActionCreators.closeCreatePollModal();
    if (null == arg0) {
      const obj3 = { key: "POLL_CREATED_SUCCESS", IconComponent: tmp(10898).PollsIcon, content: null };
  ...
  obj9.onPress = function onPress() {
    if (obj.isPollCreationEmpty(c4, answers)) {
      closure_18();
      tmp(12450).closeCreatePollModal();
      const AccessibilityAnnouncer = tmp(4467).AccessibilityAnnouncer;
      const intl = tmp(1115).intl;
      AccessibilityAnnouncer.announce(intl.string(tmp(1115).t["+G3oRq"]));
      const tmpResult = tmp(12450);
    } else {
      const obj2 = { onConfirm: handleCancelClose };
      tmp(5110).openAlert("poll-creation-unsaved-changes", React7(UnsavedChangesAlertModal, obj2));
