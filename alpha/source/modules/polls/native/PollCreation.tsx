...
// Function ID: 11667
// Name: PollCreation
// Dependencies: [19, 17, 7243, 21, 4829, 576, 1364, 5202, 1115, 6019, 1177, 11667, 4825, 11668, 4796, 11669, 1980, 5912, 4697, 8222, 1249, 6397, 7260, 11665, 4525, 10090, 4538, 11670, 11675, 5937, 7175, 5198, 11676, 6790, 5988, 11677, 11679, 7262, 11691, 8045, 11693, 5911, 2]
// Exports: default
...
export default function PollCreation(channel) {
  ...
  const callback = answers.useCallback((arg0) => {
    ...
    PollCreationModalActionCreators.closeCreatePollModal();
    if (null == arg0) {
      const obj3 = { key: "POLL_CREATED_SUCCESS", IconComponent: tmp(10090).PollsIcon, content: null };
  ...
  channel(5937).useNavigatorBackPressHandler(() => {
    if (obj.isPollCreationEmpty(c4, answers)) {
      ...
      tmp(5198).openAlert("poll-creation-unsaved-changes", React7(UnsavedChangesAlertModal, obj2));
      flag = true;
  ...
  obj9.onPress = function onPress() {
    if (obj.isPollCreationEmpty(c4, answers)) {
      closure_18();
      tmp(11665).closeCreatePollModal();
      const AccessibilityAnnouncer = tmp(4538).AccessibilityAnnouncer;
      const intl = tmp(1115).intl;
      AccessibilityAnnouncer.announce(intl.string(tmp(1115).t["+G3oRq"]));
