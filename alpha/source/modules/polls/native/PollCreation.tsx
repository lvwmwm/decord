...
// Function ID: 12541
// Name: PollCreation
// Dependencies: [19, 17, 8158, 21, 4829, 576, 1364, 5201, 1115, 6936, 1177, 12541, 4825, 12542, 4796, 12543, 1980, 5910, 4695, 9128, 1249, 7314, 8175, 12539, 4523, 10986, 4536, 12544, 12549, 5935, 8090, 5197, 12550, 7707, 5986, 12551, 12553, 8177, 12565, 8951, 12567, 5909, 2]
// Exports: default
...
export default function PollCreation(channel) {
  ...
  const callback = answers.useCallback((arg0) => {
    ...
    PollCreationModalActionCreators.closeCreatePollModal();
    if (null == arg0) {
      const obj3 = { key: "POLL_CREATED_SUCCESS", IconComponent: tmp(10986).PollsIcon, content: null };
  ...
  channel(5935).useNavigatorBackPressHandler(() => {
    if (obj.isPollCreationEmpty(c4, answers)) {
      ...
      tmp(5197).openAlert("poll-creation-unsaved-changes", React7(UnsavedChangesAlertModal, obj2));
      flag = true;
  ...
  obj9.onPress = function onPress() {
    if (obj.isPollCreationEmpty(c4, answers)) {
      closure_18();
      tmp(12539).closeCreatePollModal();
      const AccessibilityAnnouncer = tmp(4536).AccessibilityAnnouncer;
      const intl = tmp(1115).intl;
      AccessibilityAnnouncer.announce(intl.string(tmp(1115).t["+G3oRq"]));
