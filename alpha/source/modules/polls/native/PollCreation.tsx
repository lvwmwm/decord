...
// Function ID: 11681
// Name: PollCreation
// Dependencies: [19, 17, 7248, 21, 4836, 576, 1364, 5209, 1115, 6024, 1177, 11681, 4832, 11682, 4800, 11683, 1981, 5917, 4701, 8230, 1249, 6402, 7265, 11679, 4528, 10101, 4541, 11684, 11689, 5942, 7180, 5205, 11690, 6795, 5993, 11691, 11693, 7267, 11705, 8053, 11707, 5916, 2]
// Exports: default
...
export default function PollCreation(channel) {
  ...
  const callback = answers.useCallback((arg0) => {
    ...
    PollCreationModalActionCreators.closeCreatePollModal();
    if (null == arg0) {
      const obj3 = { key: "POLL_CREATED_SUCCESS", IconComponent: tmp(10101).PollsIcon, content: null };
  ...
  channel(5942).useNavigatorBackPressHandler(() => {
    if (obj.isPollCreationEmpty(c4, answers)) {
      ...
      tmp(5205).openAlert("poll-creation-unsaved-changes", React7(UnsavedChangesAlertModal, obj2));
      flag = true;
  ...
  obj9.onPress = function onPress() {
    if (obj.isPollCreationEmpty(c4, answers)) {
      closure_18();
      tmp(11679).closeCreatePollModal();
      const AccessibilityAnnouncer = tmp(4541).AccessibilityAnnouncer;
      const intl = tmp(1115).intl;
      AccessibilityAnnouncer.announce(intl.string(tmp(1115).t["+G3oRq"]));
