...
// Function ID: 12532
// Name: PollCreation
// Dependencies: [19, 17, 8156, 21, 4827, 576, 1364, 5199, 1115, 6934, 1177, 12532, 4823, 12533, 4794, 12534, 1980, 5908, 4693, 9124, 1249, 7312, 8173, 12530, 4521, 10980, 4534, 12535, 12540, 5933, 8088, 5195, 12541, 7705, 5984, 12542, 12544, 8175, 12556, 8947, 12558, 5907, 2]
// Exports: default
...
export default function PollCreation(channel) {
  ...
  const callback = answers.useCallback((arg0) => {
    ...
    PollCreationModalActionCreators.closeCreatePollModal();
    if (null == arg0) {
      const obj3 = { key: "POLL_CREATED_SUCCESS", IconComponent: tmp(10980).PollsIcon, content: null };
  ...
  channel(5933).useNavigatorBackPressHandler(() => {
    if (obj.isPollCreationEmpty(c4, answers)) {
      ...
      tmp(5195).openAlert("poll-creation-unsaved-changes", React7(UnsavedChangesAlertModal, obj2));
      flag = true;
  ...
  obj9.onPress = function onPress() {
    if (obj.isPollCreationEmpty(c4, answers)) {
      closure_18();
      tmp(12530).closeCreatePollModal();
      const AccessibilityAnnouncer = tmp(4534).AccessibilityAnnouncer;
      const intl = tmp(1115).intl;
      AccessibilityAnnouncer.announce(intl.string(tmp(1115).t["+G3oRq"]));
