...
// Dependencies: [5030, 12531, 1980, 2]
// Exports: closeCreatePollModal, openCreatePollModal

// Module 12530 (PollCreationModalActionCreators)
...
export const openCreatePollModal = function openCreatePollModal(merged) {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12531, dependencyMap.paths), merged, c3);
};
