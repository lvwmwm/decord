...
// Function ID: 16489
// Name: PollBadge
// Dependencies: [19, 17, 21, 4836, 576, 1177, 16489, 4832, 1115, 2]
// Exports: default

// Module 16488 (PollBadge)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import native from "native" /* 1177 */;
import Text_Text from "Text/Text" /* 4832 */;
import _modDef16489 from "module_16489" /* 16489 */;
...
export default function PollBadge(style) {
  ...
  obj.style = items;
  const items1 = [React4(native.Icon, { size: native.IconSizes.EXTRA_SMALL_10, source: _modDef16489 }), ];
