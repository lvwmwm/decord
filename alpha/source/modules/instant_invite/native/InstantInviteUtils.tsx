...
// Dependencies: [7785, 2046, 2042, 10163, 4460, 4811, 4867, 1372, 9095, 8063, 10167, 1074, 1241, 8065, 10168, 10169, 4812, 4794, 8707, 4520, 8086, 7520, 4960, 38, 10165, 2]
...
import CreateInviteModalActionCreatorsDefault from "CreateInviteModalActionCreators" /* 10168 */;
import openInstantInviteActionSheetDefault from "openInstantInviteActionSheet" /* 10169 */;
...
function showInstantInviteActionSheet(channel, source) {
  ...
  if (tmp17) {
    tmp(10168).init(channel.getGuildId(), channel.id, obj2);
    const tmpResult3 = tmp(10168);
  }
...
const IOS_COPY_TO_PASTEBOARD = fn(10167).IOS_COPY_TO_PASTEBOARD;
...
export const handleOpenShareSheet = function handleOpenShareSheet(code, channel, intl, ADD_FRIENDS_WIDGET) {
  ...
  if (null != code) {
    ...
    tmp26(4794).hideAllActionSheets();
    const tmp26Result = tmp26(4794);
    const obj2 = {
      message: intl,
    ...
    tmp21(8707).showShareActionSheet(obj2, ADD_FRIENDS_WIDGET);
    const tmp21Result = tmp21(8707);
  }
};
export const handleCopy = function handleCopy(code, channel, GROUP_DM, arg3) {
  ...
  if (null != code) {
    ...
    tmp13(4520).presentLinkCopied();
    const tmp13Result = tmp13(4520);
  }
};
...
export const handleOpenInviteActionsheet = function handleOpenInviteActionsheet(guild, id, channels, GUILD_HEADER) {
  ...
  if (null != guild.vanityURLCode) {
    if ("" !== guild.vanityURLCode) {
      ...
      tmp4(10168).init(guild.id, channel.id, { skipCreateInvite: true });
