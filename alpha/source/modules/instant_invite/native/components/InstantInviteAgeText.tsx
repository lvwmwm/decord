...
// Dependencies: [19, 17, 10168, 21, 4829, 7313, 504, 4825, 10169, 5427, 10167, 1115, 2]
// Exports: default
...
export default function InstantInviteAgeText(style) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [tmp2(10169).maxAgeString(stateFromStores.maxAge, stateFromStores.maxUses), " "];
    ...
    if (canEditInvite) {
      ...
      canEditInvite = tmp9(tmp2(5427).PressableOpacity, obj5);
    }
    items3[1] = canEditInvite;
    obj3.children = items3;
    tmp7Result = tmp7(View, obj3);
    const tmp2Result = tmp2(10169);
  }
  return tmp7Result;
};
