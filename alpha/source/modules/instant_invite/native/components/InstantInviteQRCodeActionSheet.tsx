...
// Dependencies: [19, 17, 2064, 1372, 1074, 21, 4757, 576, 5803, 504, 1115, 573, 4454, 7444, 7396, 10126, 4753, 2]
// Exports: default
  ...
  if (null != channel) {
    ...
    if (null != channel2) {
      ...
      if (null != GuildStore.getGuild(channel2.guild_id)) {
        const obj4 = { guild: obj8.getGuild(channel2.guild_id), size: tmp6(5803).GuildIconSizes.LARGE };
    ...
    if (tmp19Result2) {
      ...
      tmp19Result2 = tmp19(tmp6(4753).Text, obj13);
    }
