...
// Dependencies: [4796, 10175, 1980, 1249, 2]
// Exports: default

// Module 10174 (openInstantInviteActionSheet)
...
export default function openInstantInviteActionSheet(invite_channel_id) {
  ...
  obj.openLazy(asyncRequireImpl(10175, dependencyMap.paths), combined, obj2, invite_channel_id.stackingBehavior);
};
