...
// Dependencies: [19, 17, 10163, 21, 4827, 576, 504, 1177, 10196, 1115, 7268, 5425, 7708, 4823, 10164, 5271, 2]
// Exports: default
...
export default function _default(link) {
  ...
  if (null == stateFromStores) {
    ...
    items1[3] = tmp7(tmp2(5271).Button, obj8);
    obj2.children = items1;
    return tmp5(tmp6, obj2);
  } else {
    const maxAgeOptionByValue = tmp8(10164).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(10164).getMaxUsesOptions;
