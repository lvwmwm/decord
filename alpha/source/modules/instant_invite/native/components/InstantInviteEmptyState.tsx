...
// Dependencies: [19, 17, 10168, 21, 4829, 576, 504, 1177, 10201, 1115, 7270, 5427, 7710, 4825, 10169, 5273, 2]
// Exports: default
...
export default function _default(link) {
  ...
  if (null == stateFromStores) {
    ...
    items1[3] = tmp7(tmp2(5273).Button, obj8);
    obj2.children = items1;
    return tmp5(tmp6, obj2);
  } else {
    const maxAgeOptionByValue = tmp8(10169).getMaxAgeOptionByValue(stateFromStores.maxAge);
    let str2 = "";
    let str3 = "";
    ...
    const getMaxUsesOptions = tmp8(10169).getMaxUsesOptions;
