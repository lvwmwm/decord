...
// Dependencies: [5, 17, 1346, 1074, 5036, 1364, 10436, 10438, 1255, 7449, 10558, 2]

// Module 10557 (BugReportManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            notificationDuration = tmp2(10436).getNotificationDuration(BUG_REPORTER);
            const obj5 = tmp2(10436);
