...
// Dependencies: [5, 17, 1346, 1074, 4966, 1364, 10357, 10359, 1255, 7365, 10479, 2]

// Module 10478 (BugReportManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            notificationDuration = tmp2(10357).getNotificationDuration(BUG_REPORTER);
            const obj5 = tmp2(10357);
