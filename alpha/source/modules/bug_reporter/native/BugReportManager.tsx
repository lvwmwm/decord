...
// Dependencies: [5, 17, 1346, 1074, 4965, 1364, 10351, 10353, 1255, 7363, 10473, 2]

// Module 10472 (BugReportManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            notificationDuration = tmp2(10351).getNotificationDuration(BUG_REPORTER);
            const obj5 = tmp2(10351);
