...
// Dependencies: [5, 32, 19, 17, 4514, 8001, 2042, 5190, 12293, 12294, 1074, 4820, 5036, 21, 4827, 576, 8317, 4684, 5034, 12589, 4559, 11858, 1478, 12209, 5429, 5430, 7784, 9500, 12000, 1110, 4521, 1115, 10431, 4685, 5441, 4520, 9926, 6983, 12591, 12572, 10347, 2]

// Module 12588 (VoiceMessageButton)
...
import VoiceMessageUtils from "VoiceMessageUtils" /* 12589 */;
...
const VoiceMessageConstants = fn(12294);
...
export default noop.memo((disabled) => {
  ...
  const tmp9 = sharedValue1(11858)();
  _require = sharedValue(function*(arg0) {
    closure_129_2 = yield closure_0(12589).endAudioRecording();
    const data = closure_129_2.data;
    const startTimeMillis = closure_129_2.startTimeMillis;
    closure_1_6(false);
    if (closure_129_0) {
      closure_1_9.current = closure_129_1;
      let result = closure_0(12589).emitVoiceMessageRecorded(closure_129_1, data.durationSecs, startTimeMillis);
    }
    if (data.durationSecs < closure_2_20 / 1000) {
      const result1 = closure_0(12589).emitVoiceMessageRecorded(closure_0(12209).VoiceMessageRecordingResult.CANCELLED_DURATION, data.durationSecs, startTimeMillis);
      __initData();
    }
    const result2 = closure_0(12589).emitVoiceMessageRecorded(closure_0(12209).VoiceMessageRecordingResult.SENT, data.durationSecs, startTimeMillis);
    const channel = callback.getChannel(closure_1);
    if (null != channel) {
      const cloudUpload = new closure_0(5429).CloudUpload({ uri: data.filename, originalUri: data.filename, mimeType: "audio/ogg", filename: "voice-message.ogg", platform: closure_0(5430).UploadPlatform.REACT_NATIVE, durationSecs: data.durationSecs, waveform: data.waveform }, channel.id);
      const items = [cloudUpload];
      closure_129_6 = items;
      const pendingReply2 = pendingReply.getPendingReply(closure_1);
      const sendMessageOptionsForReply = sharedValue1(7784).getSendMessageOptionsForReply(pendingReply2);
      { uri: data.filename, originalUri: data.filename, mimeType: "audio/ogg", filename: "voice-message.ogg", platform: closure_0(5430).UploadPlatform.REACT_NATIVE, durationSecs: data.durationSecs, waveform: data.waveform };
      const id = channel.id;
      ...
      sharedValue1(7784).sendMessage(id, { content: "", tts: false, invalidEmojis: [], validNonShortcutEmojis: [] }, undefined, obj17);
      sharedValue1(7784);
      closure_0(12000).deletePendingReply(closure_1);
      closure_0(12000);
      sharedValue1(7784);
    }
    ...
    if (cancelReason === undefined) {
      cancelReason = closure_0(12209).VoiceMessageRecordingResult.CANCELLED_USER_REQUESTED;
    }
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              c3 = 1;
              const obj5 = { value: cancel(12589).endAudioRecording(), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            closure_128_0 = value;
            const result = cancel(12589).emitVoiceMessageRecorded(cancel(12209).VoiceMessageRecordingResult.CANCELLED_GESTURE_CONFLICT, closure_128_0.data.durationSecs, closure_128_0.startTimeMillis);
            const obj = cancel(12589);
          }
          c3 = 3;
  ...
  let obj6 = { ref: sharedValue1(12591)().tooltipTargetRef, IconComponent: null, active: false, accessibilityLabel: null, accessibilityActions: null, onAccessibilityAction: null, disabled: null };
  ...
  obj5.children = jsx(sharedValue1(12572), { ref: sharedValue1(12591)().tooltipTargetRef, IconComponent: null, active: false, accessibilityLabel: null, accessibilityActions: null, onAccessibilityAction: null, disabled: null });
