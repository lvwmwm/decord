...
// Dependencies: [19, 17, 1372, 10123, 8749, 21, 4829, 576, 15056, 15084, 8761, 8763, 1177, 5273, 1115, 3070, 15096, 10127, 5728, 5041, 15163, 9002, 2]
...
// Module 15162 (TinyBroncoSettingsNotices)
...
const TinyBroncoExperiment = tmp(10127);
require = fn;
...
function UnconfirmedNotice(message) {
  ...
  obj2.button = jsx(AGE_CONFIRMATION_NOTICE(5273).Button, { variant: "secondary", size: "sm", text: null, onPress: null });
...
export const shouldShowUnconfirmedNotice = function shouldShowUnconfirmedNotice() {
  ...
  if (hasAgeGatedFeaturesResult) {
    hasAgeGatedFeaturesResult = tmp(10127).isTinyBroncoEnabled(closure_6);
    const tmpResult2 = tmp(10127);
  }
