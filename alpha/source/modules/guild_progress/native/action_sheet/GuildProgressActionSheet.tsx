...
// Dependencies: [5, 19, 17, 9862, 4394, 12727, 1074, 21, 4757, 576, 504, 12732, 4454, 1241, 12735, 12736, 10082, 6473, 1115, 9861, 5356, 6053, 4768, 4724, 1110, 6591, 12737, 7429, 6043, 4753, 5187, 5341, 7444, 1177, 2]
// Exports: default

// Module 12734 (GuildProgressActionSheet)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            let base64;
            tmp5(9861).init(View);
            const obj6 = tmp5(9861);
            tmp2(12732).hideActionSheet(id.id);
            const obj7 = tmp2(12732);
            const obj4 = { size };
            dependencyMap = 1;
            c3 = 1;
          ...
          base64 = value.base64;
          if (null != base64) {
            tmp5(9861).updateIcon(closure_129_5, base64);
            const obj = tmp5(9861);
          }
          c3 = 3;
          return { value: "HermesInternal", done: null };
