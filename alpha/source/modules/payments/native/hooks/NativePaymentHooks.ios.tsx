...
// Dependencies: [5, 32, 19, 7570, 4486, 4487, 7568, 1074, 3, 504, 7747, 11098, 4496, 11150, 5901, 1241, 11152, 7571, 38, 5164, 11154, 11155, 2]
...
function useCancelSubscription(arg0, arg1) {
  ...
  obj2.cancelSubscription = memo.useCallback(storeFront(function*() {
    ...
    closure_128_0 = yield tmp2(7747).cancelGenericSubscription(closure_6.requestIdentifier, closure_6.subscriptionId, closure_1);
...
function useResubscribeSubscription(arg0) {
  ...
  obj2.resubscribeSubscription = noop.useCallback(stateFromStores(function*() {
    ...
    closure_128_0 = yield tmp2(7747).resubscribeGenericSubscription(closure_5, stateFromStores.isACOM);
    yield tmp2(5164).fetchSubscriptions();
    return closure_128_0;
  }), items3);
  return obj2;
