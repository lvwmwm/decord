...
// Dependencies: [5, 19, 17, 17245, 2036, 1372, 1074, 21, 4829, 1177, 17246, 1115, 5274, 1485, 1249, 5931, 6790, 9080, 6610, 6005, 17250, 6001, 6016, 6013, 6398, 6460, 6461, 6002, 17251, 6494, 6409, 504, 4796, 4697, 6416, 2]
// Exports: default

// Module 17244 (VerificationModal)
import Link from "Link" /* 1485 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4796 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import noop from "module_19" /* 19 */;
import PhoneVerificationStore from "PhoneVerificationStore" /* 17245 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  const obj = { Illustration: navigation(17246).VerifyPhone, title: null, body: null, children: null };
  ...
  obj2.children = jsx(navigation(5274).Button, { text: null, onPress: null });
  obj.children = <View style={closure_12().button}>{null}</View>;
  return jsx(navigation(1177).EmptyState, { Illustration: navigation(17246).VerifyPhone, title: null, body: null, children: null });
}
...
export default function VerificationModal() {
  ...
  const effect = noop.useEffect(() => {
    ...
    stateFromStores(4697).dismissKeyboard();
  }, []);
  let obj2 = {
    screens: noop.useMemo(() => {
      ...
      obj2.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      ...
      obj5.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      ...
      obj8.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      obj8.headerRight = function headerRight() {
        const obj = { source: closure_1_1(9080), accessibilityLabel: null, onPress: null };
        ...
        obj.onPress = function onPress() {
          ...
          const items = [obj3];
          obj2.options = items;
          const result = closure_1_0(6610).showSimpleActionSheet(obj2);
        };
        return closure_1_11(stateFromStores(6790).HeaderActionButton, obj);
      };
      obj8.render = function render() {
        return closure_1_11(closure_1_1(17250), {});
      };
      ...
      let obj10 = stateFromStores(5931);
      ...
      obj11.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      obj11.render = function render() {
        return closure_1_11(closure_1_1(6001), {});
      };
      ...
      const obj13 = stateFromStores(5931);
      ...
      obj14.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      ...
      const obj16 = stateFromStores(5931);
      ...
      obj17.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      obj17.render = function render() {
        return closure_1_11(closure_1_1(6016), { isChangeEmail: false });
      };
      ...
      const obj19 = stateFromStores(5931);
      ...
      obj20.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      obj20.render = function render() {
        return closure_1_11(closure_1_1(6013), {});
      };
      ...
      const obj22 = stateFromStores(5931);
      ...
      obj23.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      obj23.render = function render() {
        return closure_1_11(closure_1_1(6398), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5931);
      ...
      obj26.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      obj26.render = function render(arg0, arg1) {
        closure_0 = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = closure_0(6461).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return closure_0.push(constants.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F128233 */ function() { ... });
              obj.onSubmit = function onSubmit() { ... };
              closure_1 = closure_1_3(/* F128235 */ function() { ... });
              obj.onSuccess = function onSuccess() { ... };
              closure_0.push(constants.VERIFY_PASSWORD, obj);
            }
          });
        };
        return closure_11(closure_1(6460), obj);
      };
      ...
      const obj28 = stateFromStores(5931);
      ...
      obj29.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      obj29.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(6494), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5931);
      ...
      obj32.headerTitle = stateFromStores(5931).getHeaderNoTitle();
      obj32.render = function render(arg0) {
        const merged = Object.assign(arg0);
        return closure_1_11(closure_1_1(6409), {});
      };
      ...
      const obj34 = stateFromStores(5931);
      ...
      obj35.headerTitle = stateFromStores(5931).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(6416).Navigator, {
    screens: noop.useMemo(() => {
      let obj = {};
      let obj2 = { impressionName: stateFromStores(1249).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS }, headerTitle: null, render: null };
      let obj3 = { impression_group: stateFromStores(1249).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
