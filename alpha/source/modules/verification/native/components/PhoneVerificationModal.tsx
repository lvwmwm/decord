...
// Dependencies: [5, 19, 1074, 7374, 21, 5927, 7375, 7376, 5030, 1249, 7409, 7324, 7331, 1115, 2]
// Exports: default

// Module 7373 (PhoneVerificationModal)
import UserSettingsConfirmPasswordDefault from "UserSettingsConfirmPassword" /* 7324 */;
import AddPhoneDefault from "AddPhone" /* 7375 */;
import PhoneActionCreatorsDefault from "PhoneActionCreators" /* 7376 */;
import VerifyPhoneDefault from "VerifyPhone" /* 7409 */;
  ...
  obj6.render = function render(arg0, arg1) {
    ...
    obj.onVerified = function onVerified(arg0) {
            ...
            try {
              ...
              if (0 === c2) {
                if (arg0 === 1) {
                  ...
                  c2 = 2;
                  c1 = 1;
                  const obj5 = { value: v3(7376).addPhone(reason, reason, reason.reason), done: false };
                  return obj5;
                }
              } else if (1 === tmp6) {
                c4 = 0;
      ...
      obj.onSuccess = function onSuccess() {
        closure_1(5030).popWithKey(closure_1_5);
      };
