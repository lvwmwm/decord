...
const hcArticle = fn(5996).COMMON_SCAMS_EDUCATION_HC_ARTICLE;
...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  const navigation = changeEmailReason(1485).useNavigation();
  const obj = changeEmailReason(1485);
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_9(tmp2(6004).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = closure_9(tmp2(4832).Text, obj5);
    ...
    items2[2] = closure_10(tmp2(4832).Text, obj6);
    ...
    obj9.onPress = tmp6;
    const items4 = [closure_9(tmp2(5281).Button, obj9), ];
    ...
    items4[1] = closure_9(tmp2(5281).Button, obj10);
