...
// Dependencies: [5, 4733, 1074, 5038, 8689, 14856, 9664, 10167, 14847, 5443, 5454, 9676, 4730, 2]
...
const instant_invite_InstantInviteUtils = tmp(10167);
require = fn;
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (arg0 === 1) {
            ...
            dependencyMap = 2;
            c3 = 1;
            const obj8 = { value: tmp85(5454).launchImageLibraryAsync({ mediaType: "photo", includeBase64: false, selectionLimit: 1 }), done: false };
            return obj8;
          } else {
            const obj9 = { errorCode: constants.UNKNOWN_ERROR };
            const tmp42 = new tmp85(9664)(obj9, "Missing photo permissions");
            throw tmp42;
          }
        } else if (2 === tmp6) {
          if (arg0 === 1) {
