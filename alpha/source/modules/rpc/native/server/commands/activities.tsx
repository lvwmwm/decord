...
// Dependencies: [5, 4735, 1074, 5038, 7779, 14018, 8762, 9264, 14009, 5444, 5455, 8774, 4732, 2]
...
const instant_invite_InstantInviteUtils = tmp(9264);
require = fn;
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (arg0 === 1) {
            ...
            dependencyMap = 2;
            c3 = 1;
            const obj8 = { value: tmp85(5455).launchImageLibraryAsync({ mediaType: "photo", includeBase64: false, selectionLimit: 1 }), done: false };
            return obj8;
          } else {
            const obj9 = { errorCode: constants.UNKNOWN_ERROR };
            const tmp42 = new tmp85(8762)(obj9, "Missing photo permissions");
            throw tmp42;
          }
        } else if (2 === tmp6) {
          if (arg0 === 1) {
