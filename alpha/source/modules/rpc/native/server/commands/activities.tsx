...
// Dependencies: [5, 4731, 1074, 5036, 8685, 14847, 9660, 10162, 14838, 5441, 5452, 9672, 4728, 2]
...
const instant_invite_InstantInviteUtils = tmp(10162);
require = fn;
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (arg0 === 1) {
            ...
            dependencyMap = 2;
            c3 = 1;
            const obj8 = { value: tmp85(5452).launchImageLibraryAsync({ mediaType: "photo", includeBase64: false, selectionLimit: 1 }), done: false };
            return obj8;
          } else {
            const obj9 = { errorCode: constants.UNKNOWN_ERROR };
            const tmp42 = new tmp85(9660)(obj9, "Missing photo permissions");
            throw tmp42;
          }
        } else if (2 === tmp6) {
          if (arg0 === 1) {
