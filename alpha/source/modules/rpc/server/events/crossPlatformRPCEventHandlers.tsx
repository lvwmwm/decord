...
// Dependencies: [5056, 1999, 2062, 4851, 2044, 2107, 2066, 1992, 4852, 1372, 4848, 4735, 1074, 8765, 8767, 8762, 5039, 13996, 7779, 12, 14001, 1086, 558, 8768, 14058, 14059, 2]

// Module 14057 (crossPlatformRPCEventHandlers)
...
import VibegrationsVoiceSessionCoordinatorDefault from "VibegrationsVoiceSessionCoordinator" /* 13996 */;
import transformGuildMemberDefault from "transformGuildMember" /* 14058 */;
import transformApplicationDefault from "transformApplication" /* 14059 */;
...
obj2[RPCEvents.MESSAGE_CREATE] = { scope: fn(7779).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
const obj12 = { scope: fn(7779).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
obj2[RPCEvents.MESSAGE_UPDATE] = { scope: fn(7779).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
const obj13 = { scope: fn(7779).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
obj2[RPCEvents.MESSAGE_DELETE] = { scope: fn(7779).OAuth2Scopes.RPC, validation: messageEventsValidation, handler: messageEvents };
