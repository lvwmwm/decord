...
// Function ID: 14046
// Name: soundboard
// Dependencies: [5, 5312, 1372, 4735, 1085, 7779, 6751, 5321, 8765, 6786, 6757, 8762, 6788, 6598, 2]
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (null == closure_128_2) {
            ...
            const tmp22 = new tmp74(8762)(obj10, "Invalid Sound.");
            throw tmp22;
          }
        }
      } catch (tmp56) {
