...
// Function ID: 14875
// Name: soundboard
// Dependencies: [5, 5309, 1372, 4731, 1085, 8685, 7666, 5318, 9663, 7701, 7672, 9660, 7703, 7513, 2]
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (null == closure_128_2) {
            ...
            const tmp22 = new tmp74(9660)(obj10, "Invalid Sound.");
            throw tmp22;
          }
        }
      } catch (tmp56) {
