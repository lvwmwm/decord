...
// Function ID: 14795
// Name: soundboard
// Dependencies: [5, 5225, 1372, 4661, 1085, 8614, 7583, 5234, 9590, 7618, 7589, 9587, 7620, 7429, 2]
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (null == closure_128_2) {
            ...
            const tmp22 = new tmp74(9587)(obj10, "Invalid Sound.");
            throw tmp22;
          }
        }
      } catch (tmp56) {
