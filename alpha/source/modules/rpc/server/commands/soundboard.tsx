...
// Function ID: 14884
// Name: soundboard
// Dependencies: [5, 5311, 1372, 4733, 1085, 8689, 7668, 5320, 9667, 7703, 7674, 9664, 7705, 7515, 2]
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (null == closure_128_2) {
            ...
            const tmp22 = new tmp74(9664)(obj10, "Invalid Sound.");
            throw tmp22;
          }
        }
      } catch (tmp56) {
