...
// Function ID: 14858
// Name: links
// Dependencies: [5, 2043, 5056, 4733, 1074, 2004, 14837, 14858, 1364, 4823, 1241, 9721, 4453, 14859, 4514, 8720, 14860, 9664, 9667, 9669, 7712, 14852, 9215, 14861, 2]
...
import validateEmbeddedAppFrame from "validateEmbeddedAppFrame" /* 14837 */;
import fetchIsLinkTrusted from "fetchIsLinkTrusted" /* 14859 */;
import openActivityShareLinkModal from "openActivityShareLinkModal" /* 14861 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import EmbeddedActivitiesStore from "EmbeddedActivitiesStore" /* 2043 */;
import ApplicationStore from "ApplicationStore" /* 5056 */;

const openUserSettings = tmp(7712);
const ApplicationFlagUtils = tmp(9215);
require = fn;
      ...
      if (0 === c6) {
        if (arg0 === 1) {
          ...
          if (null != obj18.tryValidateEmbeddedAppFrame(closure_0)) {
            internalDeepLink = tmp84(14858).resolveInternalDeepLink(tmp83);
            const tmp84Result = tmp84(14858);
          }
        ...
        if (value) {
          ...
          new Promise((arg0) => {
            ...
            return obj.handleClick(obj2, undefined, undefined, closure_1_0(14860).getActivitiesModalContextKey({ application, channelId }));
          });
        }
        c5 = 0;
        c7 = 3;
