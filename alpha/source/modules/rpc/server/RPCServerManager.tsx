...
// Dependencies: [32, 8491, 7111, 2044, 2107, 2066, 1992, 4869, 4852, 4476, 2098, 1372, 4848, 4735, 1074, 2004, 8492, 4854, 1364, 573, 1241, 13996, 504, 1370, 8767, 8773, 14001, 8768, 7132, 2]

// Module 13995 (RPCServerManager)
...
const FrameLayoutModes = fn(8492).FrameLayoutModes;
  ...
  constructor(arg0) {
    ...
    obj.handleNotificationCreate = function handleNotificationCreate(icon) {
      ...
      if (0 !== obj.rpcServer.subscriptions.length) {
        ...
        if (null != icon) {
          remoteIconURL = tmp8(8767).getRemoteIconURL(icon);
          const tmp8Result = tmp8(8767);
        }
