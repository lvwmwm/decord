...
// Dependencies: [19, 21, 9834, 4724, 7444, 7396, 1115, 5904, 5907, 9838, 9836, 2]
// Exports: default
...
export default function AppChannelApplicationActionSheet(arg0) {
  ...
  obj4.children = options.map((item) => {
    ...
    return jsx(onChange(5907).TableRadioRow, { value: application.id, label: application.name, subLabel: getAppChannelApplicationUnsupportedTextDefault(status), disabled: !status.supported, icon: jsx(AppChannelApplicationIconDefault, { application }) }, application.id);
  });
  obj2.children = jsx(onChange(5904).TableRadioGroup, { accessibilityLabel: null, value: null, onChange: null, hasIcons: true, children: null });
