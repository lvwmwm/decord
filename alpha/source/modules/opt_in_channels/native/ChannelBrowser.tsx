...
// Function ID: 11888
// Name: ChannelBrowser
// Dependencies: [32, 19, 17, 7860, 7442, 4460, 2064, 5008, 1074, 2039, 21, 4827, 576, 7312, 11888, 504, 11890, 4647, 2028, 11886, 7381, 9073, 5910, 5425, 1115, 6944, 5890, 11892, 4823, 4980, 4541, 5990, 5920, 4524, 5325, 5907, 5914, 1177, 4817, 2]
// Exports: default

// Module 11887 (ChannelBrowser)
...
let closure_17 = noop.memo((channel) => {
  ...
  const items1 = [closure_12(channel(5990).TableRowGroupTitle, { style: tmp.categoryTitle, title: tmp3, lineClamp: 1 }), ];
  ...
  if ("null" !== channel.id) {
    ...
    obj6.children = tmp8(tmp4(5920).FormCheckbox, obj7);
    ...
    items2[1] = tmp8(tmp4(4823).Text, obj8);
