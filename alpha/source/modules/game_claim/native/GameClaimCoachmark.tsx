...
// Dependencies: [5, 19, 17, 1074, 2041, 21, 576, 16617, 10465, 5278, 4829, 16618, 9278, 1115, 5912, 5427, 5985, 4825, 5273, 8935, 7647, 7651, 2]
...
const GameClaimCardStackDefault = tmp5(16617);
require = fn;
...
export default noop.memo((arg0) => {
  ...
  if (null == coverImageUrl) {
    ...
    let obj3 = {
      ...
      children: closure_8(tmp2(5985).XSmallIcon, { size: "sm", color: "text-default" })
    };
    const items = [closure_8(tmp2(5427).PressableOpacity, obj3), , , , ];
    ...
    items[2] = closure_8(tmp2(4825).Text, obj5);
    ...
    items[3] = closure_8(tmp2(4825).Text, obj7);
    ...
    obj9.icon = closure_8(tmp2(8935).LinkExternalSmallIcon, { size: "xs", color: "white" });
    ...
    obj8.children = closure_8(tmp2(5273).Button, obj9);
    items[4] = closure_8(View, obj8);
    obj2.children = items;
    return closure_9(tmp2(5912).Card, obj2);
  }
