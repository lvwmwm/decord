...
// Dependencies: [5, 19, 17, 1074, 2041, 21, 576, 15797, 9567, 5279, 4829, 15798, 8376, 1115, 5914, 5428, 5987, 4825, 5274, 8029, 6730, 6734, 2]
...
const GameClaimCardStackDefault = tmp5(15797);
require = fn;
...
export default noop.memo((arg0) => {
  ...
  if (null == coverImageUrl) {
    ...
    let obj3 = {
      ...
      children: closure_8(tmp2(5987).XSmallIcon, { size: "sm", color: "text-default" })
    };
    const items = [closure_8(tmp2(5428).PressableOpacity, obj3), , , , ];
    ...
    obj9.icon = closure_8(tmp2(8029).LinkExternalSmallIcon, { size: "xs", color: "white" });
    ...
    obj8.children = closure_8(tmp2(5274).Button, obj9);
    items[4] = closure_8(View, obj8);
    obj2.children = items;
    return closure_9(tmp2(5914).Card, obj2);
  }
