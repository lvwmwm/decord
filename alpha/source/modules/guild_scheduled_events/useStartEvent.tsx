...
// Function ID: 10158
// Name: useStartEvent
// Dependencies: [5, 32, 19, 10158, 10159, 4729, 2]
// Exports: default

// Module 10157 (useStartEvent)
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (arg0 === 1) {
              ...
              c7 = 3;
              c8 = 1;
              const obj7 = { value: closure_1(10158).preStartEventActions(closure_131_0, closure_131_3), done: false };
              return obj7;
            }
          } else {
            if (2 === tmp7) {
              ...
              const aPIError = new closure_0(4729).APIError(closure_131_5);
              ...
              if (arg0 === 1) {
                ...
                c7 = 4;
                c8 = 1;
                const obj10 = { value: closure_1(10158).setEventAsActive(closure_131_0, closure_131_1), done: false };
                return obj10;
              }
            } else if (4 === tmp7) {
              if (arg0 === 1) {
                ...
                c7 = 5;
                c8 = 1;
                const obj13 = { value: closure_0(10159).navigateToEvent(closure_131_0, closure_131_2), done: false };
                return obj13;
              }
            } else if (5 === tmp7) {
              if (arg0 === 1) {
                ...
                c7 = 6;
                c8 = 1;
                const obj15 = { value: closure_0(10159).postStartActions(closure_131_0, closure_131_2), done: false };
                return obj15;
              }
            } else if (arg0 === 1) {
              c8 = 3;
