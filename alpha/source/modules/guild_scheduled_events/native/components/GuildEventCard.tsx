...
// Function ID: 10065
// Name: GuildEventCard
// Dependencies: [19, 17, 4779, 7768, 2047, 21, 4756, 576, 9869, 5650, 504, 9789, 5824, 8681, 9894, 2]

// Module 10064 (GuildEventCard)
import nativeDefault from "native" /* 576 */;
import ButtonGroup from "ButtonGroup" /* 5650 */;
import GuildEventCardComponents from "GuildEventCardComponents" /* 9869 */;
...
function GuildEventCardControls(onCloseAction) {
  ...
  if (tmp6Result) {
    const obj3 = { event };
    tmp6Result = tmp6(tmp2(9869).GuildEventCardRSVPAction, obj3);
  }
  items[1] = tmp6Result;
