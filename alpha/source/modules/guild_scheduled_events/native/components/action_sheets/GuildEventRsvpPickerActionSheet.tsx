...
// Dependencies: [32, 19, 17, 2050, 21, 4829, 576, 9875, 1115, 7483, 7482, 7456, 5990, 5993, 5273, 9867, 4796, 2]
// Exports: default
...
export default function GuildEventRsvpPickerActionSheet(event) {
  ...
  const obj2 = { header: closure_7(event(7482).BottomSheetTitleHeader, { title: stringResult }), children: null };
