...
// Dependencies: [32, 19, 17, 2046, 9894, 9863, 1074, 21, 4827, 576, 5425, 1177, 7323, 9895, 4823, 1115, 5271, 5030, 9896, 1980, 4794, 2]
// Exports: default

// Module 9893 (StageChannelUpsell)
  ...
  if (!tmp2[0]) {
    ...
    const obj8 = {
      suggestionsHook(children, arg1) {
          return closure_1_10(guildId(4823).Text, { variant: "text-sm/semibold", color: "mobile-text-heading-primary", children }, arg1);
        }
    };
    ...
    obj10.onPress = function onPress() {
      ...
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9896, dependencyMap.paths), {
        guildId,
