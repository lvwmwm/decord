...
// Dependencies: [32, 19, 17, 2046, 9821, 9790, 1074, 21, 4757, 576, 5341, 1177, 7239, 9822, 4753, 1115, 5187, 4960, 9823, 1980, 4724, 2]
// Exports: default
  ...
  if (!tmp2[0]) {
    ...
    const obj8 = {
      suggestionsHook(children, arg1) {
          return closure_1_10(guildId(4753).Text, { variant: "text-sm/semibold", color: "mobile-text-heading-primary", children }, arg1);
        }
    };
