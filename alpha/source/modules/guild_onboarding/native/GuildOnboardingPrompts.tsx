...
// Dependencies: [32, 5, 19, 17, 4821, 5879, 2044, 2066, 2098, 6516, 6517, 6513, 1074, 21, 1101, 4829, 5989, 576, 1475, 4680, 5894, 5286, 1094, 504, 1612, 1484, 4563, 6521, 6522, 1397, 1879, 1241, 5009, 4830, 5931, 6539, 6540, 1370, 5836, 4825, 1115, 2]
// Exports: default

// Module 6538 (GuildOnboardingPrompts)
        ...
        if (!required1) {
          if (closure_17) {
            ...
            if (currentPromptIdx < prompts.length - 1) {
              ...
              const merged1 = Object.assign(tmp5(5009).collectGuildAnalyticsMetadata(tmp6));
              obj4.step = tmp9 + 1;
              obj4.required = arr[tmp9 + 1].required;
              tmp2Result.track(tmp4.GUILD_ONBOARDING_STEP_VIEWED, obj4);
              const tmp5Result = tmp5(5009);
            }
