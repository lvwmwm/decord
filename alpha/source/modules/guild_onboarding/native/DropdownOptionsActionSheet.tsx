...
// Dependencies: [19, 17, 5762, 7431, 1375, 21, 4827, 563, 7461, 1397, 1177, 1115, 4823, 7467, 1612, 4794, 7480, 7481, 6955, 5271, 2]
// Exports: default

// Module 7466 (DropdownOptionsActionSheet)
...
export default function DropdownOptionsActionSheet(arg0) {
  ...
  if (null == stateFromStores) {
    ...
    const obj4 = { scrollable: true, header: closure_8(tmp3(7480).BottomSheetTitleHeader, obj3), children: null };
    ...
    obj8.children = closure_8(tmp3(5271).Button, obj9);
    items2[1] = closure_8(responses, obj8);
    obj5.children = items2;
    obj4.children = closure_9(tmp3(6955).BottomSheetScrollView, obj5);
    return closure_8(tmp3(7481).BottomSheet, obj4);
  }
};
