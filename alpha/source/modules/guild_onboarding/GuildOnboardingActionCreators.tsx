...
// Dependencies: [5, 32, 2098, 2042, 2105, 1372, 7347, 1074, 4382, 4939, 1271, 573, 1231, 5771, 12, 7353, 1370, 7356, 1241, 4937, 7357, 11, 1385, 7360, 7367, 2]
...
obj.completeOnboarding = function completeOnboarding(guildId, prompts) {
  ...
  const merged = Object.assign(items1(4937).collectGuildAnalyticsMetadata(guildId));
  ...
  const tmp2Result14 = items1(4937);
