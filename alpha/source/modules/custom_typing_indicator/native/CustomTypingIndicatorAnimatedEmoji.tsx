      ...
      if (animation !== user.TypingIndicatorAnimation.UNSPECIFIED) {
        if (stateFromStores) {
          ...
          if (tmp5(1380).TypingIndicatorAnimation.PULSE === tmp4) {
            ...
            const tmp5Result18 = tmp5(4830);
            const withTimingResult1 = tmp5(4830).withTiming(1, obj5);
            ...
            const tmp5Result27 = tmp5(4830);
            const withTimingResult3 = tmp5(4830).withTiming(0, obj9);
            const obj10 = { duration: result4 };
            const result8 = sharedValue2.set(tmp5Result23.withDelay(result3, tmp5Result24.withRepeat(tmp5Result25.withSequence(withTimingResult2, withTimingResult3, tmp5(4830).withTiming(0, obj10)), -1)));
            const tmp5Result28 = tmp5(4830);
          }
          return () => {
