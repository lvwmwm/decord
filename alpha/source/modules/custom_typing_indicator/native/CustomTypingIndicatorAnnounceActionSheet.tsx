...
// Dependencies: [19, 17, 1074, 2039, 21, 4827, 576, 7710, 7481, 7454, 7485, 12303, 1380, 12305, 12306, 12307, 12308, 12309, 12310, 12311, 1177, 1115, 4823, 3714, 5271, 2]
// Exports: default

// Module 12302 (CustomTypingIndicatorAnnounceActionSheet)
...
export default function CustomTypingIndicatorAnnounceActionSheet(markAsDismissed) {
  ...
  const items3 = [
    closure_7(markAsDismissed(7485).ActionSheetHeaderBar, {
      onPress() {
  ...
  const items5 = [ref(12305), ref(12306), ref(12305)];
  obj7.emojiSource = items5;
  obj7.style = tmp2.outerStack;
  obj6.children = closure_7(ref(12303), obj7);
  ...
  obj13.children = intl2.string(ref(3714).uGxDiu);
  items3[3] = closure_7(markAsDismissed(4823).Text, obj13);
  const obj14 = { variant: "text-md/normal", style: tmp2.body, color: "text-muted", children: null };
  const intl3 = markAsDismissed(1115).intl;
  obj14.children = intl3.string(ref(3714).yezU3E);
  items3[4] = closure_7(markAsDismissed(4823).Text, obj14);
  ...
  obj16.text = intl4.string(ref(3714).TswY68);
  obj16.onPress = callback;
  const items11 = [closure_7(markAsDismissed(5271).Button, obj16), ];
  ...
  items11[1] = closure_7(markAsDismissed(5271).Button, obj17);
  obj15.children = items11;
  items3[5] = closure_8(View, obj15);
  obj3.children = items3;
  obj2.children = closure_8(View, obj3);
  obj.children = closure_7(markAsDismissed(7454).SafeAreaPaddingView, obj2);
  return closure_7(markAsDismissed(7481).BottomSheet, obj);
};
