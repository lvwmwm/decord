...
// Dependencies: [19, 17, 21, 4829, 576, 4796, 6566, 6565, 1115, 6614, 4825, 5274, 6009, 4525, 10104, 4788, 8894, 8040, 2]
// Exports: default

// Module 14205 (WebAuthnDeleteActionSheet)
...
export default function WebAuthnDeleteActionSheet(credential) {
  ...
  obj2.trailing = closure_4(credential(6614).ActionSheetCloseButton, { onPress: handleClose });
  const items = [closure_4(credential(6565).BottomSheetTitleHeader, obj2), , , ];
  ...
  obj6.children = closure_4(credential(5274).Button, obj7);
  ...
  obj9.onPress = function onPress() {
    ...
    result.then(() => {
      ...
      obj.open({ key: "WEBAUTHN_CREDENTIAL_DELETE_ERROR_TOAST_KEY", content: error.message, icon: closure_1_1(8894), IconComponent: credential(8040).WarningIcon, iconColor: "icon-feedback-critical" });
    }).finally(() => {
      closure_1_1(false);
    });
  };
  ...
  obj8.children = closure_4(credential(5274).Button, obj9);
  items[3] = closure_4(View, obj8);
  obj.children = items;
  return closure_5(credential(6566).BottomSheet, obj);
};
