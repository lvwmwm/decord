...
// Dependencies: [19, 17, 21, 4757, 576, 4724, 7397, 7396, 1115, 7445, 4753, 5187, 6840, 4455, 10918, 4716, 9719, 8871, 2]
// Exports: default

// Module 14952 (WebAuthnDeleteActionSheet)
...
export default function WebAuthnDeleteActionSheet(credential) {
  ...
  obj2.trailing = closure_4(credential(7445).ActionSheetCloseButton, { onPress: handleClose });
  ...
  obj4.children = closure_4(credential(4753).Text, obj5);
  ...
  obj6.children = closure_4(credential(5187).Button, obj7);
  ...
  obj9.onPress = function onPress() {
    ...
    result.then(() => {
      ...
      obj.open({ key: "WEBAUTHN_CREDENTIAL_DELETE_ERROR_TOAST_KEY", content: error.message, icon: closure_1_1(9719), IconComponent: credential(8871).WarningIcon, iconColor: "icon-feedback-critical" });
    }).finally(() => {
      closure_1_1(false);
    });
  };
  ...
  obj8.children = closure_4(credential(5187).Button, obj9);
