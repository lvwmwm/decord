...
// Dependencies: [19, 17, 21, 4827, 576, 4794, 7481, 7480, 1115, 7529, 4823, 5271, 6924, 4521, 10994, 4786, 9792, 8942, 2]
// Exports: default

// Module 15032 (WebAuthnDeleteActionSheet)
...
export default function WebAuthnDeleteActionSheet(credential) {
  ...
  obj2.trailing = closure_4(credential(7529).ActionSheetCloseButton, { onPress: handleClose });
  const items = [closure_4(credential(7480).BottomSheetTitleHeader, obj2), , , ];
  ...
  obj4.children = closure_4(credential(4823).Text, obj5);
  ...
  obj6.children = closure_4(credential(5271).Button, obj7);
  ...
  obj9.onPress = function onPress() {
    ...
    result.then(() => {
      ...
      const obj = closure_1_1(4521);
      obj.open({ key: "WEBAUTHN_CREDENTIAL_DELETE_ERROR_TOAST_KEY", content: error.message, icon: closure_1_1(9792), IconComponent: credential(8942).WarningIcon, iconColor: "icon-feedback-critical" });
    }).finally(() => {
      closure_1_1(false);
    });
  };
  ...
  obj8.children = closure_4(credential(5271).Button, obj9);
  items[3] = closure_4(View, obj8);
  obj.children = items;
  return closure_5(credential(7481).BottomSheet, obj);
};
