...
// Dependencies: [32, 19, 17, 11877, 21, 4756, 576, 4723, 12, 8543, 5203, 4959, 11899, 1980, 1115, 4752, 11881, 5821, 5904, 5822, 5186, 1612, 7395, 7394, 7443, 6869, 2]
// Exports: default

// Module 17005 (FeedbackActionSheetV2)
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  const unmountEffect = optionsTree(5203).useUnmountEffect(() => {
    if (c16) {
      ...
      obj2.pushLazy(asyncRequireImpl(11899, dependencyMap.paths), obj4);
      const tmp11 = asyncRequireImpl(11899, dependencyMap.paths);
    } else {
  ...
  if (null == first2) {
    ...
    items2[1] = closure_7(tmp3(11881), obj5);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(5821).TableCheckboxRow, obj6);
    }
    ...
    if (first2 !== first.GOOD) {
      if (null == first4) {
        ...
        obj9.children = closure_7(tmp20(5904).TableRowGroup, obj10);
    ...
    if (tmp23) {
      ...
      obj13.children = closure_7(tmp20(5904).TableRowGroup, obj14);
  ...
  if (showHeaderCloseButton) {
    const obj18 = { onPress };
    tmp40Result = tmp40(tmp20(7443).ActionSheetCloseButton, obj18);
  }
  obj17.trailing = tmp40Result;
  obj16.header = closure_7(optionsTree(7394).BottomSheetTitleHeader, obj17);
  ...
  obj16.children = closure_7(optionsTree(6869).BottomSheetScrollView, obj19);
  return closure_7(optionsTree(7395).BottomSheet, obj16);
};
