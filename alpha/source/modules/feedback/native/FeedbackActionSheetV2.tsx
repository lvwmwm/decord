...
// Dependencies: [32, 19, 17, 11881, 21, 4757, 576, 4724, 12, 8547, 5204, 4960, 11903, 1980, 1115, 4753, 11885, 5823, 5906, 5824, 5187, 1612, 7397, 7396, 7445, 6871, 2]
// Exports: default

// Module 17017 (FeedbackActionSheetV2)
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  const unmountEffect = optionsTree(5204).useUnmountEffect(() => {
    if (c16) {
      ...
      obj2.pushLazy(asyncRequireImpl(11903, dependencyMap.paths), obj4);
      const tmp11 = asyncRequireImpl(11903, dependencyMap.paths);
    } else {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      tmp35 = closure_7(tmp20(4753).Text, obj4);
    }
    const items2 = [tmp35, , ];
    const obj5 = { ratingOptions, selectedRating: first2, onChangeRating: callback };
    items2[1] = closure_7(tmp3(11885), obj5);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(5823).TableCheckboxRow, obj6);
    }
      ...
      if (null == first4) {
        ...
        const obj10 = {
          ...
          children: first.map((label, index) => {
                  closure_0 = label;
                  return closure_7(optionsTree(5824).TableRow, {
                    label: label.label,
                    labelLineClamp: 2,
                    onPress() {
        ...
        obj9.children = closure_7(tmp20(5906).TableRowGroup, obj10);
        ...
        items3[1] = closure_7(tmp20(5187).Button, obj11);
    ...
    if (tmp23) {
      ...
      obj13.children = closure_7(tmp20(5906).TableRowGroup, obj14);
      ...
      items4[1] = closure_7(tmp20(5187).Button, obj15);
  ...
  if (showHeaderCloseButton) {
    const obj18 = { onPress };
    tmp40Result = tmp40(tmp20(7445).ActionSheetCloseButton, obj18);
  }
  ...
  obj16.children = closure_7(optionsTree(6871).BottomSheetScrollView, obj19);
