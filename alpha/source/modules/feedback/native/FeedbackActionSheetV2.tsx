...
// Dependencies: [32, 19, 17, 11957, 21, 4827, 576, 4794, 12, 8618, 5288, 5030, 11979, 1980, 1115, 4823, 11961, 5907, 5990, 5908, 5271, 1612, 7481, 7480, 7529, 6955, 2]
// Exports: default

// Module 17074 (FeedbackActionSheetV2)
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  const unmountEffect = optionsTree(5288).useUnmountEffect(() => {
    if (c16) {
      ...
      obj2.pushLazy(asyncRequireImpl(11979, dependencyMap.paths), obj4);
      const tmp11 = asyncRequireImpl(11979, dependencyMap.paths);
    } else {
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      tmp35 = closure_7(tmp20(4823).Text, obj4);
    }
    const items2 = [tmp35, , ];
    const obj5 = { ratingOptions, selectedRating: first2, onChangeRating: callback };
    items2[1] = closure_7(tmp3(11961), obj5);
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(5907).TableCheckboxRow, obj6);
    }
      ...
      if (null == first4) {
        ...
        const obj10 = {
          ...
          children: first.map((label, index) => {
                  closure_0 = label;
                  return closure_7(optionsTree(5908).TableRow, {
                    label: label.label,
                    labelLineClamp: 2,
                    onPress() {
        ...
        obj9.children = closure_7(tmp20(5990).TableRowGroup, obj10);
        ...
        items3[1] = closure_7(tmp20(5271).Button, obj11);
    ...
    if (tmp23) {
      ...
      obj13.children = closure_7(tmp20(5990).TableRowGroup, obj14);
      ...
      items4[1] = closure_7(tmp20(5271).Button, obj15);
  ...
  if (showHeaderCloseButton) {
    const obj18 = { onPress };
    tmp40Result = tmp40(tmp20(7529).ActionSheetCloseButton, obj18);
  }
  obj17.trailing = tmp40Result;
  obj16.header = closure_7(optionsTree(7480).BottomSheetTitleHeader, obj17);
  ...
  obj16.children = closure_7(optionsTree(6955).BottomSheetScrollView, obj19);
  return closure_7(optionsTree(7481).BottomSheet, obj16);
};
