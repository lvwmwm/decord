...
// Function ID: 11969
// Name: RatingSelector
// Dependencies: [19, 17, 11964, 21, 4829, 11969, 11970, 1115, 11974, 11975, 11979, 11980, 8953, 5427, 2]
// Exports: default

// Module 11968 (RatingSelector)
...
export default function RatingSelector(ratingOptions) {
  ...
  let obj3 = { selected: _modDef11969, normal: null };
  tmp = closure_9();
  obj3.normal = textLabels(11970).useFeedbackModalSadDesaturatedSource();
  obj2.source = obj3;
  ...
  let obj6 = { selected: _modDef11974, normal: null };
  let obj4 = textLabels(11970);
  obj6.normal = textLabels(11975).useFeedbackModalNeutralDesaturatedSource();
  obj5.source = obj6;
  ...
  const obj9 = { selected: _modDef11979, normal: null };
  let obj7 = textLabels(11975);
  obj9.normal = textLabels(11980).useFeedbackModalHappyDesaturatedSource();
  obj8.source = obj9;
  ...
  return <closure_3 style={tmp2.ratings}>{mapped.map((rating) => {
    ...
    if (null != rating) {
      ...
      obj.children = jsx(textLabels(8953).RowButton, { accessibilityRole: "button", accessibilityLabel: getLabel(), accessibilityState: null, onPress: null, icon: null, label: null });
      ...
      tmp14Result = jsx(textLabels(5427).PressableOpacity, { accessibilityRole: "button", accessibilityLabel: getLabel(), accessibilityState: null, onPress: null, children: null }, rating);
    }
    return tmp14Result;
  })}</closure_3>;
};
