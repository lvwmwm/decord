...
// Dependencies: [19, 17, 1372, 2023, 10621, 1218, 21, 4829, 576, 672, 5401, 1364, 2020, 9516, 4797, 4798, 5190, 7667, 5573, 10523, 10749, 1231, 5427, 2]
// Exports: default
...
const StickerSendability = tmp(7667);
require = fn;
      ...
      do {
        let tmp8 = (function _loop() {
          ...
          if (undefined === stickers[c12]) {
            ...
            const items1 = [closure_8(isSectionNitroLocked(10523), obj3, tmp), ];
            let tmp17 = null;
            if (tmp11) {
