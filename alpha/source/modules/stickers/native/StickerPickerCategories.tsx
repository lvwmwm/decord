...
// Dependencies: [32, 19, 17, 2064, 10655, 1074, 1218, 21, 4757, 576, 2020, 5104, 5487, 1241, 5341, 1177, 1397, 5803, 10439, 5315, 4725, 4726, 10623, 10624, 7302, 1115, 10686, 2]
// Exports: default

// Module 10685 (StickerPickerCategories)
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(10623)();
  ...
  if (tmp22Result) {
    ...
    obj4.style = items10;
    const obj5 = { style: tmp.guildIcon, source: tmp17(10686) };
  ...
  obj.children = items9;
  return tmp20(categoryIndex(10624), obj);
};
