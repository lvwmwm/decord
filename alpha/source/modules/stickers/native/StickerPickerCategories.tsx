...
// Dependencies: [32, 19, 17, 2064, 10731, 1074, 1218, 21, 4827, 576, 2020, 5188, 5571, 1241, 5425, 1177, 1397, 5887, 10518, 5399, 4795, 4796, 10699, 10700, 7386, 1115, 10762, 2]
// Exports: default

// Module 10761 (StickerPickerCategories)
...
export default function _default(categories) {
  ...
  const tmp19 = categoryIndex(10699)();
  const tmp20 = closure_15;
  const items9 = [closure_14(categoryIndex(7386), { estimatedListSize: "windowSize", horizontal: true, itemSize: EXPRESSION_FOOTER_HEIGHT, keyboardShouldPersistTaps: "always", listId: ExpressionPickerViewType.STICKER, onLayout: callback4, onScroll: callback1, placeholderConfig: tmp19, ref, scrollReporting: "callbacks", sections: memo, renderItem: callback5, showsHorizontalScrollIndicator: false, style: tmp.list }), ];
  ...
  if (tmp22Result) {
    ...
    obj4.style = items10;
    const obj5 = { style: tmp.guildIcon, source: tmp17(10762) };
    obj4.children = tmp22(categories(1177).Icon, obj5);
    obj3.children = tmp22(closure_5, obj4);
    tmp22Result = tmp22(categories(5425).PressableOpacity, obj3);
  }
  items9[1] = tmp22Result;
  obj.children = items9;
  return tmp20(categoryIndex(10700), obj);
};
