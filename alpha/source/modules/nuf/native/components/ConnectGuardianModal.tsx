...
export default function ConnectGuardianModal(route) {
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj5.children = intl.string(tmp2(2487).ITlV6p);
    const items2 = [closure_7(tmp4(4832).Text, obj5), ];
    const obj6 = { style: tmp.description, variant: "text-sm/medium", color: "text-muted", children: null };
    const intl2 = tmp4(1115).intl;
    obj6.children = intl2.format(tmp2(2487).F4GT2S, { link: "https://support.discord.com/hc/articles/14155060633623" });
    items2[1] = closure_7(tmp4(4832).Text, obj6);
    ...
    const obj13 = { paddingBottom: connectGuardianGate(1613)().bottom + tmp2(576).space.PX_16 };
    items5[1] = obj13;
    obj12.style = items5;
