...
// Dependencies: [19, 17, 1074, 7868, 21, 4829, 576, 1612, 17964, 1241, 5882, 4825, 1115, 2486, 15227, 5273, 2]
// Exports: default

// Module 17963 (ConnectGuardianModal)
...
export default function ConnectGuardianModal(route) {
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    items4[1] = closure_7(tmp4(15227).ConnectGuardianCard, { shareActions: "compact", linkCode: null, expiresAt: null, onRefresh: null });
