...
let closure_10 = fn(12233).HUBS_IN_ONBOARDING_COUNTRIES;
...
let obj3 = {
  ...
  transitionToStep: fn(12173).openContactSyncModalOnboarding
};
items[1] = {
  ...
  transitionToStep: fn(12201).openDiscoverabilityModal
};
items[2] = obj3;
items[3] = {
  key: obj.STUDENT_HUB,
