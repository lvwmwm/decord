...
// Dependencies: [32, 5, 19, 17, 12667, 12668, 1074, 4966, 9566, 1241, 12670, 12676, 12677, 504, 2]
...
// Module 12669 (NotificationPermissionUtil)
...
let closure_10 = fn(4966).NotificationAuthorizationStatus;
const size = fn(2);
