...
// Dependencies: [32, 5, 19, 17, 12749, 12750, 1074, 5036, 9639, 1241, 12752, 12758, 12759, 504, 2]
...
// Module 12751 (NotificationPermissionUtil)
...
let closure_10 = fn(5036).NotificationAuthorizationStatus;
const size = fn(2);
