...
// Dependencies: [5, 17022, 3, 13194, 7171, 15, 9, 10, 504, 2]
// Exports: default

// Module 17021 (executeRunnable)
...
const require = fn;
const NativeAppStartup = fn(17022);
...
export default function executeRunnable(arg0, arg1) {
  ...
  return RequestGatewaySocketAll.withRequest(combined, asyncGeneratorStep(async () => {
    ...
    v2(7171).startBridgeTo("AppContainer:" + closure_129_0.toLowerCase());
