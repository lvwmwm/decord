...
// Dependencies: [19, 2111, 1372, 6648, 1074, 1374, 12, 6649, 1365, 1385, 504, 6642, 6650, 4485, 6657, 2]
  ...
  const memo = pricesForPurchaseType.useMemo(() => {
    ...
    if (null != sku) {
      if (null != stateFromStores1) {
        ...
        if (tmp12 == null) {
          tmp12 = tmp11[tmp4(undefined, 6649).StorefrontPurchaseType.SELF_PURCHASE];
        }
        let found;
        if (tmp12 != null) {
    ...
    const obj2 = { userPrice: "r", pricesForPurchaseType: "channelId", purchaseType: SELF_PURCHASE, storeHasPrice: null != stateFromStores1 };
    return obj2;
  }, items1);
