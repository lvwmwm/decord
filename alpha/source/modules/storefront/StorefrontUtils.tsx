...
// Dependencies: [19, 2111, 1372, 7565, 1074, 1374, 12, 7566, 1365, 1385, 504, 7559, 7567, 4483, 7574, 2]
  ...
  const memo = pricesForPurchaseType.useMemo(() => {
    ...
    if (null != sku) {
      if (null != stateFromStores1) {
        ...
        if (tmp12 == null) {
          tmp12 = tmp11[tmp4(undefined, 7566).StorefrontPurchaseType.SELF_PURCHASE];
        }
        let found;
        if (tmp12 != null) {
