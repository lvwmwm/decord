...
// Dependencies: [32, 19, 17, 1074, 21, 4827, 576, 10710, 6950, 4559, 4828, 4831, 8265, 7383, 1115, 7381, 10708, 5425, 10716, 4823, 2]

// Module 10715 (GIFPickerHeader)
...
obj.headerContainer = { flexDirection: "row", justifyContent: "space-between", gap: fn(10710).GIF_PICKER_GUTTER_SPACING };
let obj4 = { flexDirection: "row", justifyContent: "space-between", gap: fn(10710).GIF_PICKER_GUTTER_SPACING };
obj.header = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6950).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
...
let obj5 = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6950).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
const size = fn(2);
...
export default noop.memo(function GIFPickerHeader(arg0) {
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp13Result = tmp6(tmp2(7381).SearchField, obj2);
  } else {
    ...
    const items = [tmp6(tmp2(10716).ChevronLargeLeftIcon, obj6), ];
    ...
    items[1] = tmp6(tmp2(4823).Text, obj7);
    obj4.children = items;
    const items1 = [React7(tmp2(5425).PressableOpacity, obj4), ];
