...
// Dependencies: [32, 19, 17, 1074, 21, 4757, 576, 10634, 6866, 4493, 4758, 4761, 8183, 7299, 1115, 7297, 10632, 5341, 10640, 4753, 2]

// Module 10639 (GIFPickerHeader)
...
obj.headerContainer = { flexDirection: "row", justifyContent: "space-between", gap: fn(10634).GIF_PICKER_GUTTER_SPACING };
let obj4 = { flexDirection: "row", justifyContent: "space-between", gap: fn(10634).GIF_PICKER_GUTTER_SPACING };
obj.header = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6866).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
...
let obj5 = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6866).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
const size = fn(2);
...
export default noop.memo(function GIFPickerHeader(arg0) {
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp13Result = tmp6(tmp2(7297).SearchField, obj2);
  } else {
    ...
    const items = [tmp6(tmp2(10640).ChevronLargeLeftIcon, obj6), ];
    ...
    items[1] = tmp6(tmp2(4753).Text, obj7);
    obj4.children = items;
    const items1 = [React7(tmp2(5341).PressableOpacity, obj4), ];
