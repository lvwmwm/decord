...
// Dependencies: [32, 19, 17, 1074, 21, 4829, 576, 10715, 6952, 4561, 4830, 4833, 8269, 7385, 1115, 7383, 10713, 5427, 10721, 4825, 2]

// Module 10720 (GIFPickerHeader)
...
obj.headerContainer = { flexDirection: "row", justifyContent: "space-between", gap: fn(10715).GIF_PICKER_GUTTER_SPACING };
let obj4 = { flexDirection: "row", justifyContent: "space-between", gap: fn(10715).GIF_PICKER_GUTTER_SPACING };
obj.header = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6952).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
...
let obj5 = { borderWidth: 1, borderColor: "transparent", paddingHorizontal: nativeDefault.space.PX_8, height: fn(6952).InputHeights.MD, flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8 };
const size = fn(2);
...
export default noop.memo(function GIFPickerHeader(arg0) {
  ...
  if (categoryType === GIFPickerResultTypes.SEARCH) {
    ...
    let tmp13Result = tmp6(tmp2(7383).SearchField, obj2);
  } else {
    ...
    const items = [tmp6(tmp2(10721).ChevronLargeLeftIcon, obj6), ];
    ...
    items[1] = tmp6(tmp2(4825).Text, obj7);
    obj4.children = items;
    const items1 = [React7(tmp2(5427).PressableOpacity, obj4), ];
