...
// Dependencies: [19, 17, 1386, 2064, 1372, 21, 4757, 1612, 11985, 9324, 504, 8454, 5803, 4753, 1115, 5341, 8452, 1177, 7397, 2]
// Exports: default
...
export default function AppInteractionInfoActionSheet(message) {
  ...
  if (null != stateFromStores1) {
    ...
    const items5 = [closure_8(tmp2(5803), obj6), ];
