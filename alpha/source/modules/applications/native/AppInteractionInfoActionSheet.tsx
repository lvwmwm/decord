...
// Dependencies: [19, 17, 1386, 2066, 1372, 21, 4829, 1612, 12069, 9399, 504, 8529, 5889, 4825, 1115, 5427, 8527, 1177, 7483, 2]
// Exports: default
...
export default function AppInteractionInfoActionSheet(message) {
  ...
  if (null != stateFromStores1) {
    ...
    const items5 = [closure_8(tmp2(5889), obj6), ];
