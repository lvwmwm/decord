...
// Function ID: 9339
// Name: disclosures
// Dependencies: [5, 1074, 1271, 9339, 1115, 2]
// Exports: ackDisclosures, getDisclosures, getTextForDisclosure

// Module 9338 (disclosures)
...
export const ApplicationDisclosure = fn(9339).ApplicationDisclosureType;
...
export const getTextForDisclosure = function getTextForDisclosure(disclosure) {
  ...
  } else if (tmp(9339).ApplicationDisclosureType.DISPLAYS_ADVERTISEMENTS === disclosure) {
