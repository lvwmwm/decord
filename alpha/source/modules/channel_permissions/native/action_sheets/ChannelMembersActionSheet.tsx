...
// Dependencies: [19, 17, 2044, 2107, 2101, 2066, 4464, 1074, 21, 4829, 576, 1612, 504, 1484, 4982, 11948, 9907, 1115, 7483, 7482, 5427, 4796, 8983, 11950, 7710, 8953, 11946, 10379, 1177, 6957, 9923, 4825, 2]
// Exports: default
    ...
    if (null != guild) {
      if (null != sortedGuildRoles) {
        ...
        if (canResult) {
          ...
          obj9.children = tmp32(tmp5(7710).SettingsIcon, {});
          tmp32Result = tmp32(tmp5(5427).PressableOpacity, obj9);
        }
        const obj10 = { scrollable: true, header: null, startExpanded: true, children: null };
        obj8.trailing = tmp32Result;
        obj10.header = closure_11(tmp5(7482).BottomSheetTitleHeader, obj8);
        ...
        if (canResult) {
          ...
          obj12.icon = tmp32(tmp5(10379).GroupPlusIcon, {});
          let tmp32Result2 = tmp32(tmp5(8953).RowButton, obj12);
        } else {
        ...
        items6[1] = closure_11(tmp5(6957).BottomSheetSectionList, obj15);
        obj11.children = items6;
        obj10.children = closure_12(stateFromStores, obj11);
        return closure_11(tmp5(7483).BottomSheet, obj10);
      }
    }
  }
  return null;
