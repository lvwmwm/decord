...
// Dependencies: [19, 17, 1372, 8747, 21, 4827, 5199, 1115, 4840, 4520, 5425, 6944, 5908, 9919, 9902, 4823, 1177, 9920, 9921, 4541, 5920, 2]
// Exports: ChannelOverwritesCheckboxItem

// Module 9918 (ChannelOverwritesItem)
...
function RemoveIcon(item) {
  ...
  if (null != channelId) {
    ...
    let obj2 = { style: prop };
    obj.children = closure_7(item(6944).CircleXIcon, obj2);
    tmp3Result = tmp3(item(5425).PressableOpacity, obj);
  }
  return tmp3Result;
}
...
function MemberItem(arg0) {
  ...
  if (item.rowType === RowType.OWNER) {
    const obj3 = { size: tmp5(1177).Icon.Sizes.REFRESH_SMALL_16, source: _modDef9920, disableColor: true, style: tmp.ownerIcon };
...
function EmptyRoleItem(item) {
  ...
  const tmp = closure_9();
  obj.icon = React5(native.Icon, { source: _modDef9921, color: item.colorString, size: native.IconSizes.MEDIUM, style: closure_9().roleIcon });
  obj.label = item.name;
  return React5(TableRow.TableRow, obj);
}
