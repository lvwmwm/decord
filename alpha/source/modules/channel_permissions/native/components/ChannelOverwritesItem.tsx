...
// Dependencies: [19, 17, 1372, 8676, 21, 4757, 5115, 1115, 4770, 4454, 5341, 6860, 5824, 9846, 9829, 4753, 1177, 9847, 9848, 4475, 5836, 2]
// Exports: ChannelOverwritesCheckboxItem

// Module 9845 (ChannelOverwritesItem)
...
function RemoveIcon(item) {
  ...
  if (null != channelId) {
    ...
    let obj2 = { style: prop };
    obj.children = closure_7(item(6860).CircleXIcon, obj2);
...
function MemberItem(arg0) {
  ...
  if (item.rowType === RowType.OWNER) {
    const obj3 = { size: tmp5(1177).Icon.Sizes.REFRESH_SMALL_16, source: _modDef9847, disableColor: true, style: tmp.ownerIcon };
...
function EmptyRoleItem(item) {
  ...
  const tmp = closure_9();
  obj.icon = React5(native.Icon, { source: _modDef9848, color: item.colorString, size: native.IconSizes.MEDIUM, style: closure_9().roleIcon });
  obj.label = item.name;
  return React5(TableRow.TableRow, obj);
}
