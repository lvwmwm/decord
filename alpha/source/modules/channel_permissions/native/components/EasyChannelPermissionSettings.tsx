...
// Dependencies: [32, 5, 19, 17, 17302, 2042, 2105, 2099, 2064, 4396, 4406, 1372, 8676, 1074, 21, 4757, 576, 1484, 11865, 504, 9829, 9830, 9831, 1115, 4910, 5109, 9845, 4401, 5185, 5906, 7447, 1177, 5824, 11474, 11863, 5849, 4937, 9896, 9897, 17303, 17305, 2]
// Exports: default

// Module 17301 (EasyChannelPermissionSettings)
...
import ChannelSettingsPermissionsStore from "ChannelSettingsPermissionsStore" /* 17302 */;
...
function ChannelPermissionSettingsBasicView(channel) {
  ...
  closure_8 = async function _onPrivateChannelSwitchChange(arg0, value) {
    if (dependencyMap === 2) {
      ...
      try {
        ...
        closure_128_1 = tmp5(4910).computeChannelName(closure_129_0, UserStore, RelationshipStore);
  ...
  const layoutEffect = togglePrivateChannel.useLayoutEffect(() => {
    navigation.setOptions({ headerRight: "max" });
  }, items1);
...
const SettingMode = fn(8676).SettingMode;
