...
// Dependencies: [19, 21, 4827, 576, 1612, 7481, 5269, 5995, 4823, 1115, 5271, 4794, 4512, 2]
// Exports: default

// Module 13327 (SuspiciousDownloadActionSheet)
...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  const items1 = [closure_3(href(5995).TrafficConeSpotIllustration, {}), , ];
  ...
  items1[1] = closure_3(href(4823).Text, obj4);
  ...
  items1[2] = closure_3(href(4823).Text, obj5);
  obj3.children = items1;
  const items2 = [closure_4(href(5269).Stack, obj3), ];
  ...
  const items3 = [closure_3(href(5271).Button, obj7), ];
  ...
  items3[1] = closure_3(href(5271).Button, obj8);
  obj6.children = items3;
  items2[1] = closure_4(href(5269).Stack, obj6);
  obj2.children = items2;
  obj.children = closure_4(href(5269).Stack, obj2);
  return closure_3(href(7481).BottomSheet, obj);
};
