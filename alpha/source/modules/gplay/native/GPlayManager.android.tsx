...
// Function ID: 11051
// Name: GPlayManager
// Dependencies: [109, 5, 19, 17, 7748, 7749, 502, 4487, 7568, 9559, 7569, 1074, 4809, 1374, 21, 3, 7571, 573, 9558, 1240, 4414, 7757, 4496, 5164, 1241, 5194, 1115, 11051, 1980, 5030, 7740, 2]

// Module 11050 (GPlayManager)
...
const useGPlayAnalyticsStore = fn(9559).useGPlayAnalyticsStore;
let Constants = fn(7569);
...
let closure_28 = null;
let closure_29 = null;
const items = [fn(7571).ProductIds.PREMIUM_TIER_2_MONTHLY];
const size = fn(2);
