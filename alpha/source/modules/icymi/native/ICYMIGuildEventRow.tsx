...
// Dependencies: [19, 17, 6941, 2044, 2066, 21, 16067, 576, 8938, 1115, 8935, 4982, 8972, 9048, 7791, 9069, 6755, 9060, 16108, 11, 4825, 9050, 5396, 1177, 504, 2]
// Exports: default
  ...
  obj7.children = closure_11(event(4825).Text, {
    ...
    children: noop.useMemo(() => {
      if (closure_2) {
        ...
        eventTimeData = tmp(8935).getEventTimeData(c3);
