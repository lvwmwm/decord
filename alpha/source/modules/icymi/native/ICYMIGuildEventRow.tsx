...
// Dependencies: [19, 17, 7854, 2042, 2064, 21, 16855, 576, 9835, 1115, 9832, 4980, 9869, 9945, 8697, 9966, 7670, 9957, 16896, 11, 4823, 9947, 5393, 1177, 504, 2]
// Exports: default
...
function ICYMIGuildEventRow(event) {
  ...
  obj7.children = closure_11(event(4823).Text, {
    ...
    children: noop.useMemo(() => {
      if (closure_2) {
        ...
        eventTimeData = tmp(9832).getEventTimeData(c3);
  ...
  if (tmp19Result) {
    ...
    tmp19Result = tmp19(tmp8(4823).Text, obj9);
