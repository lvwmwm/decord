...
// Dependencies: [19, 17, 7856, 2044, 2066, 21, 16879, 576, 9840, 1115, 9837, 4982, 9874, 9950, 8701, 9971, 7672, 9962, 16920, 11, 4825, 9952, 5395, 1177, 504, 2]
// Exports: default
...
function ICYMIGuildEventRow(event) {
  ...
  obj7.children = closure_11(event(4825).Text, {
    ...
    children: noop.useMemo(() => {
      if (closure_2) {
        ...
        eventTimeData = tmp(9837).getEventTimeData(c3);
  ...
  if (tmp19Result) {
    ...
    tmp19Result = tmp19(tmp8(4825).Text, obj9);
