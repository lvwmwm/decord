...
// Dependencies: [19, 17, 7771, 2042, 2064, 21, 16803, 576, 9762, 1115, 9759, 4910, 9796, 9872, 8626, 9893, 7587, 9884, 16844, 11, 4753, 9874, 5309, 1177, 504, 2]
// Exports: default
...
function ICYMIGuildEventRow(event) {
  ...
  obj7.children = closure_11(event(4753).Text, {
    ...
    children: noop.useMemo(() => {
      if (closure_2) {
        ...
        eventTimeData = tmp(9759).getEventTimeData(c3);
  ...
  if (tmp19Result) {
    ...
    tmp19Result = tmp19(tmp8(4753).Text, obj9);
