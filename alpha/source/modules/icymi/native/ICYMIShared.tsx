...
// Function ID: 16843
// Name: ICYMIShared
// Dependencies: [19, 17, 7550, 2042, 2105, 4396, 1372, 1074, 21, 8623, 10031, 5307, 8999, 16771, 7357, 7491, 7285, 7701, 4687, 16803, 1364, 576, 1177, 9099, 5803, 5194, 5341, 4753, 7880, 16843, 8185, 504, 4909, 8626, 8452, 5314, 8625, 16438, 9889, 1115, 16804, 4691, 4458, 4606, 4493, 4758, 4770, 5291, 7456, 4747, 2]
...
export const SimplePost = function SimplePost(arg0) {
  ...
  if (highlight) {
    ...
    const items2 = [tmp12(tmp2(4493).View, obj7), ];
  ...
  if (obj2.useStateFromStores(items2, () => PermissionStore.canWithPartialContext(constants5.VIEW_CHANNEL, { channelId: parentMessage.id }))) {
    if (null != thread) {
      if (null != mostRecentMessage) {
        ...
        items4[1] = closure_18(tmp2(4753).Text, obj5);
        const obj7 = { style: tmp.commentCount, children: null };
        const obj8 = { style: tmp.commentsIcon };
        const items5 = [closure_18(tmp2(5291).ChatIcon, obj8), , ];
        const obj9 = { variant: "text-sm/bold", color: "interactive-text-default", children: str };
        items5[1] = closure_18(tmp2(4753).Text, obj9);
        const obj10 = { style: tmp.chevron, size: "xxs" };
        items5[2] = closure_18(tmp2(7456).ChevronSmallRightIcon, obj10);
        obj7.children = items5;
        items4[2] = closure_19(View, obj7);
        obj3.children = items4;
        return closure_19(tmp2(5341).PressableHighlight, obj3);
      }
    }
    ...
    const items7 = [closure_18(tmp2(4753).Text, obj12), ];
    const obj13 = { style: tmp.commentCount, children: null };
    const obj14 = { style: tmp.commentsIcon };
    const items8 = [closure_18(tmp2(5291).ChatIcon, obj14), ];
    const obj15 = { style: tmp.chevron, size: "xxs" };
    items8[1] = closure_18(tmp2(7456).ChevronSmallRightIcon, obj15);
    obj13.children = items8;
    items7[1] = closure_19(View, obj13);
    obj11.children = items7;
    return closure_19(tmp2(5341).PressableHighlight, obj11);
  } else {
    return null;
  }
