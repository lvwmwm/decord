...
// Dependencies: [19, 17, 21, 16804, 8626, 2]

// Module 16871 (CardHeightMeasurer)
...
export const CardHeightMeasurer = noop.memo((children) => {
  ...
  }, items)} pointerEvents="box-none" style={{ width: noop.useContext(itemId(16804).ICYMIContext).width, alignSelf: "center" }}>{arg0.children}</View>;
});
