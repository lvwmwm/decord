...
// Dependencies: [5, 32, 19, 17, 4749, 2064, 16834, 1074, 21, 16803, 576, 5803, 9406, 4493, 4758, 7302, 504, 1397, 9099, 5806, 5341, 4753, 5187, 4716, 1115, 1612, 8634, 8626, 4455, 4960, 16818, 9002, 2]
// Exports: default

// Module 16835 (ICYMIJoinGuildsScreen)
...
import ICYMIPopularGuildsStore from "ICYMIPopularGuildsStore" /* 16834 */;
...
function SelectedServersRow(selectedGuilds) {
  ...
  let obj = selectedGuilds(4493);
  fn.__closure = { withTiming: selectedGuilds(4758).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: v50, tokens: first(576) };
  ...
  let num = 3;
  let obj2 = { withTiming: selectedGuilds(4758).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: v50, tokens: first(576) };
  const tmp8 = v50;
  ...
  return closure_12(first(4493).View, obj3);
}
function CutoutGuildBanner(guild) {
  ...
  obj7.style = items4;
  obj7.size = guild(5803).GuildIconSizes.LARGE;
...
function FeaturedServer(guild) {
  ...
  if (selected) {
    ...
    tmp7Result = tmp7(tmp2(4716).CircleCheckIcon, obj8);
  }
  ...
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj7.variant = str;
      obj6.children = tmp7(guild(5187).Button, obj7);
      ...
      try {
        ...
        if (0 === v3) {
          if (arg0 === 1) {
            ...
            v3 = 1;
            dependencyMap = 1;
            const obj5 = { value: v3(8626).gravityJoinGuild(Array.from(first), "icymi_info_modal"), done: false };
            return obj5;
          }
        } else if (1 === tmp4) {
          if (arg0 === 1) {
            ...
            v3 = 2;
            dependencyMap = 1;
            const obj11 = { value: tmp51(8626).fetchDehydrated({ isReloading: true, forceRefresh: true }), done: false };
            return obj11;
          } else {
            ...
            tmp51(4455).open(obj12);
            const tmp51Result2 = tmp51(4455);
            const dehydrated = v3(8626).fetchDehydrated();
            const obj7 = v3(8626);
            const guildChannelScores = v3(8626).getGuildChannelScores();
            const obj8 = v3(8626);
            const recommendedGuilds = v3(8626).getRecommendedGuilds();
            const obj9 = v3(8626);
            v3(4960).popWithKey(stateFromStoresArray(16818).ICYMI_INFO_MODAL_KEY);
            dependencyMap = 3;
          ...
          if (arg0 === 1) {
            ...
            v3 = 3;
            dependencyMap = 1;
            const obj16 = { value: v3(8626).reloadICYMITab(), done: false };
            return obj16;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
          ...
          const guildChannelScores1 = v3(8626).getGuildChannelScores();
          const obj19 = v3(8626);
          const recommendedGuilds1 = v3(8626).getRecommendedGuilds();
          const obj20 = v3(8626);
          v3(4960).popWithKey(stateFromStoresArray(16818).ICYMI_INFO_MODAL_KEY);
          dependencyMap = 3;
          return { value: "HermesInternal", done: null };
