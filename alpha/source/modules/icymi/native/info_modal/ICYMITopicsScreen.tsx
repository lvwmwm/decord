...
// Dependencies: [5, 32, 19, 17, 16873, 16880, 21, 9425, 11227, 5392, 16881, 10253, 5379, 15597, 12260, 9628, 16882, 10693, 16884, 10695, 11589, 4827, 576, 4541, 5271, 1612, 1484, 16886, 1980, 8697, 4521, 1115, 504, 8705, 4823, 2]
// Exports: default
...
export default function ICYMITopicsScreen() {
  ...
  if (tmp12Result) {
    ...
    obj9.children = tmp12(tmp7(5271).Button, obj11);
