...
// Dependencies: [5, 32, 19, 17, 16821, 16828, 21, 9354, 11151, 5308, 16829, 10173, 5295, 15543, 12183, 9555, 16830, 10617, 16832, 10619, 11513, 4757, 576, 4475, 5187, 1612, 1484, 16834, 1980, 8626, 4455, 1115, 504, 8634, 4753, 2]
// Exports: default
...
export default function ICYMITopicsScreen() {
  ...
  if (tmp12Result) {
    ...
    obj9.children = tmp12(tmp7(5187).Button, obj11);
