...
// Dependencies: [5, 19, 2044, 5192, 1372, 1375, 4822, 21, 504, 8489, 9502, 4842, 16934, 4673, 8005, 7786, 16930, 4796, 4523, 1115, 15233, 8701, 11474, 8092, 16934, 1980, 2]
    ...
    obj2.openReplyActionSheet = noop.useCallback(() => {
      if (null != stateFromStores) {
        ...
        if (ContentInventoryEntryType.ContentInventoryEntryType.CUSTOM_STATUS !== content_type) {
          if (tmp9(8489).ContentInventoryEntryType.TOP_GAME === content_type) {
        ...
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16934, tmp10.paths), "ReactActionSheet", obj5);
      }
    }, items6);
