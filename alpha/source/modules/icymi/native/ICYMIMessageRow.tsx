...
function ReplyMessageContent(message) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_14(tmp2(4832).Text, obj5), ];
    ...
    obj10.style = obj11;
    obj10.children = tmp2(4988).getName(guild.id, channel.id, stateFromStores);
    const items4 = [closure_14(tmp2(4832).Text, obj10), ];
...
export default function MessageRowWrapper(arg0) {
  ...
  gravityMessage = gravityMessage(7798).useGravityMessage(message);
