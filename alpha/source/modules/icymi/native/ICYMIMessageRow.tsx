...
// Dependencies: [19, 17, 2042, 2105, 2064, 4406, 4938, 1372, 16841, 1074, 21, 576, 16803, 1364, 16804, 8540, 8623, 504, 16847, 16848, 4753, 1115, 1177, 4909, 5739, 8625, 8626, 11183, 11912, 16842, 16844, 11, 5341, 9873, 16850, 2]
// Exports: default
...
function ReplyMessageContent(message) {
  ...
  const context = noop.useContext(message(16804).ICYMIContext);
  ...
  const width = obj.useContext(tmp2(16804).ICYMIContext).width;
  let tmp8 = null;
  if (null != stateFromStores) {
    ...
    const items2 = [closure_14(tmp2(4753).Text, obj5), ];
    ...
    obj10.style = obj11;
    obj10.children = tmp2(4909).getName(guild.id, channel.id, stateFromStores);
    const items4 = [closure_14(tmp2(4753).Text, obj10), ];
    ...
    items4[1] = closure_14(tmp2(16804).ICYMIContext.Provider, obj12);
...
export default function MessageRowWrapper(arg0) {
  ...
  gravityMessage = gravityMessage(8625).useGravityMessage(message);
  const obj = gravityMessage(8625);
