...
// Dependencies: [5, 19, 8634, 8626, 2]
// Exports: useICYMIReloadHandler

// Module 16838 (useICYMIReloadHandler)
      ...
      try {
        ...
        if (0 === v3) {
          if (arg0 === 1) {
            ...
            v3 = 1;
            dependencyMap = 1;
            const obj7 = { value: v3(8626).fetchDehydrated({ isReloading: true }), done: false };
            return obj7;
          }
        } else if (1 === tmp5) {
          if (arg0 === 1) {
            ...
            v3 = 2;
            dependencyMap = 1;
            const obj9 = { value: v3(8626).reloadICYMITab(), done: false };
            return obj9;
          }
        } else if (2 === tmp5) {
          if (arg0 === 1) {
            ...
            v3 = 3;
            dependencyMap = 1;
            const obj12 = { value: v3(8626).getGuildChannelScores(), done: false };
            return obj12;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
