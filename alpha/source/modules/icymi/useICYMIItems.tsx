...
// Function ID: 16914
// Name: useICYMIItems
// Dependencies: [19, 8685, 8698, 504, 8701, 2]
// Exports: default
...
function createItem(id, type, unread) {
  ...
  if (ICYMITypes.ICYMIItemTypes.MESSAGE === type) {
    ...
    if (tmp(8698).ICYMIItemTypes.ACTIVITY !== type) {
      if (tmp(8698).ICYMIItemTypes.CUSTOM_STATUS !== type) {
        if (tmp(8698).ICYMIItemTypes.GUILD_EVENT === type) {
          ...
          obj6.unread = unread;
          return obj6;
        } else if (tmp(8698).ICYMIItemTypes.RECOMMENDED_GUILDS === type) {
