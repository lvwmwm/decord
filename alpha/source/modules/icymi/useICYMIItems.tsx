...
// Function ID: 16890
// Name: useICYMIItems
// Dependencies: [19, 8681, 8694, 504, 8697, 2]
// Exports: default
...
function createItem(id, type, unread) {
  ...
  if (ICYMITypes.ICYMIItemTypes.MESSAGE === type) {
    ...
    if (tmp(8694).ICYMIItemTypes.ACTIVITY !== type) {
      if (tmp(8694).ICYMIItemTypes.CUSTOM_STATUS !== type) {
        if (tmp(8694).ICYMIItemTypes.GUILD_EVENT === type) {
          ...
          obj6.unread = unread;
          return obj6;
        } else if (tmp(8694).ICYMIItemTypes.RECOMMENDED_GUILDS === type) {
