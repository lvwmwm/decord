...
// Function ID: 16838
// Name: useICYMIItems
// Dependencies: [19, 8610, 8623, 504, 8626, 2]
// Exports: default
...
function createItem(id, type, unread) {
  ...
  if (ICYMITypes.ICYMIItemTypes.MESSAGE === type) {
    ...
    if (tmp(8623).ICYMIItemTypes.ACTIVITY !== type) {
      if (tmp(8623).ICYMIItemTypes.CUSTOM_STATUS !== type) {
        if (tmp(8623).ICYMIItemTypes.GUILD_EVENT === type) {
          ...
          obj6.unread = unread;
          return obj6;
        } else if (tmp(8623).ICYMIItemTypes.RECOMMENDED_GUILDS === type) {
