...
// Dependencies: [19, 17, 8990, 21, 4757, 576, 7409, 7429, 8991, 8992, 8997, 9004, 9005, 9015, 9016, 9022, 9035, 9048, 9162, 9164, 9183, 9184, 2]
// Exports: default
...
export default function GameProfileView(arg0) {
  ...
  if (tmp6Result) {
    ...
    obj5.children = tmp6(tmp2(9004), obj6);
