...
// Dependencies: [19, 17, 4984, 1372, 21, 4757, 576, 7190, 9017, 9018, 7412, 504, 8962, 1115, 5806, 1177, 4753, 5187, 9020, 2]
// Exports: default

// Module 9016 (GameProfileLinkAccount)
...
let closure_11 = noop.memo(() => {
  ...
  if (!tmp4) {
    ...
    tmp5Result = tmp5(tmp2(9018), obj13);
  }
