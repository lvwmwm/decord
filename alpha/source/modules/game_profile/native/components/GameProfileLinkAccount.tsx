...
// Dependencies: [19, 17, 5054, 1372, 21, 4827, 576, 7274, 9088, 9089, 7496, 504, 9033, 1115, 5890, 1177, 4823, 5271, 9091, 2]
// Exports: default

// Module 9087 (GameProfileLinkAccount)
...
let closure_11 = noop.memo(() => {
  ...
  if (!tmp4) {
    ...
    tmp5Result = tmp5(tmp2(9089), obj13);
  }
