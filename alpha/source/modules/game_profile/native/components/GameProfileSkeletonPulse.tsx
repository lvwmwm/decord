...
// Dependencies: [19, 4749, 4493, 4758, 504, 2]
// Exports: useSkeletonPulseStyle

// Module 9019 (GameProfileSkeletonPulse)
...
const inOutResult = Easing.inOut(fn(4493).Easing.quad);
...
export const useSkeletonPulseStyle = function useSkeletonPulseStyle(animationDelayMs) {
  ...
  return stateFromStores(4493).useAnimatedStyle(P);
};
