...
// Dependencies: [19, 17, 9065, 21, 5293, 1115, 4829, 576, 9093, 7276, 9092, 9111, 9112, 4825, 9115, 4507, 9117, 7495, 9119, 9037, 9031, 9122, 9078, 2]
// Exports: default

// Module 9110 (GameProfileAnnouncements)
...
import AnnouncementMessageUtils from "AnnouncementMessageUtils" /* 9112 */;
import ImageWithPlaceholder from "ImageWithPlaceholder" /* 9115 */;
import navigateToGameAnnouncementDefault from "navigateToGameAnnouncement" /* 9122 */;
...
function EmbedAnnouncementCard(message) {
  ...
  if (null == embedSource) {
    ...
    if (tmp13Result2) {
      ...
      const items6 = [tmp11(tmp34(9117).ReactionIcon, obj23), ];
      ...
      items6[1] = tmp11(tmp34(4825).Text, obj25);
...
function MessageAnnouncementCard(message) {
  ...
  if (tmp10Result) {
    ...
    const items3 = [tmp26(tmp27(9117).ReactionIcon, obj15), ];
    ...
    items3[1] = tmp26(tmp27(4825).Text, obj17);
...
function PollAnnouncementCard(message) {
  ...
  if (null == poll) {
    ...
    const date = new Date(message.timestamp);
    obj9.createdAt = date;
    obj9.expiryLabel = message(9112).getPollExpiryLabel(poll);
...
const MAX_VISIBLE_ANNOUNCEMENTS = fn(9065).MAX_VISIBLE_ANNOUNCEMENTS;
const jsxProd = fn(21);
