...
// Dependencies: [19, 17, 21, 4757, 576, 9049, 9017, 9036, 9156, 9157, 8962, 7786, 7429, 1115, 9002, 9003, 2]
// Exports: default
  ...
  if (gameProfileShopCollectionProducts.isLoading) {
    ...
    if (0 !== products.length) {
      ...
      const obj5 = {
        ...
        snapToInterval: tmp2(9049).COLLECTIBLES_SHOP_CARD_WIDTH + tmp2(9049).COLLECTIBLES_SHOP_CARD_GAP
      };
      obj3.children = jsx(tmp2(9002).FlashList, {
        horizontal: true,
        renderScrollComponent: trackAction(9003),
        data: products,
        renderItem(item) {
