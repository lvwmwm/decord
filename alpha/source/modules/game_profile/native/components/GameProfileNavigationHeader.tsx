...
// Dependencies: [19, 17, 21, 4827, 576, 4559, 4828, 1397, 9260, 4823, 9066, 2]
// Exports: default
...
export default function GameProfileNavigationHeader(game) {
  ...
  if (null != name) {
    ...
    if (tmp13Result) {
      ...
      const items5 = [tmp15(application(9066), obj9), ];
      const obj10 = { style: null, children: null };
      const items6 = [StyleSheet.absoluteFill, animatedStyle1];
      obj10.style = items6;
      const obj11 = { rank: game.l30Rank };
      obj10.children = tmp15(application(9066), obj11);
      items5[1] = tmp15(application(4559).View, obj10);
    ...
    if (tmp15Result2) {
      ...
      tmp15Result2 = tmp15(application(4559).View, obj12);
    }
