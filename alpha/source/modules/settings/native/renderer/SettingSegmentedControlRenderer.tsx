...
// Dependencies: [32, 19, 17, 14973, 11730, 21, 4757, 576, 14976, 14867, 38, 14975, 9896, 9897, 12873, 2]
// Exports: default

// Module 14985 (SettingSegmentedControlRenderer)
...
export default function SettingSegmentedControl(node) {
  ...
  const memo = noop.useMemo(() => {
    ...
    const item = settings.forEach((id) => {
      const tmp = items(14867).SETTING_RENDERER_CONFIG[id];
      ...
      obj.label = items(14975).getSettingTitle(id);
      obj.id = id;
