...
// Dependencies: [32, 19, 17, 15050, 11806, 21, 4827, 576, 15053, 14947, 38, 15052, 9969, 9970, 12955, 2]
// Exports: default

// Module 15062 (SettingSegmentedControlRenderer)
...
export default function SettingSegmentedControl(node) {
  ...
  const memo = noop.useMemo(() => {
    ...
    const item = settings.forEach((id) => {
      const tmp = items(14947).SETTING_RENDERER_CONFIG[id];
      ...
      obj.label = items(15052).getSettingTitle(id);
      obj.id = id;
