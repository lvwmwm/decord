...
// Dependencies: [11730, 1074, 8237, 7237, 7242, 6869, 1364, 1875, 14865, 38, 14867, 14976, 12, 2]
  ...
  const item = entries.forEach((item) => {
    ...
    if (!tmp2.unsearchable) {
      ...
      if (null != cachedSettingTitle) {
        ...
        HermesBuiltin.arraySpread(tmp3(14865).getCachedSettingSearchTerms(tmp), 1);
        items[1] = items1;
        items.push(items);
        const tmp3Result = tmp3(14865);
      }
      tmp3 = require;
    }
  });
