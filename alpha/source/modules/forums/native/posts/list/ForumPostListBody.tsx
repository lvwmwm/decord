...
// Dependencies: [19, 17, 7601, 21, 4827, 7600, 12348, 12338, 12347, 12349, 12356, 12342, 2]
// Exports: default

// Module 12355 (ForumPostListBody)
...
import ForumPostMessageContentDefault from "ForumPostMessageContent" /* 12356 */;
...
export default function ForumPostListBody(arg0) {
  ...
  if (!isGameInvitesPost) {
    ...
    tmp9Result = tmp9(tmp10(12349), obj7);
  }
  items2[1] = tmp9Result;
  ...
  if (!blocked) {
    ...
    if (null != media) {
      ...
      tmp9Result2 = tmp9(tmp2(12342).ForumPostMediaThumbnail, obj8);
    }
  }
