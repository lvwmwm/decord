...
// Dependencies: [19, 17, 7517, 21, 4757, 7516, 12272, 12262, 12271, 12273, 12280, 12266, 2]
// Exports: default

// Module 12279 (ForumPostListBody)
...
import ForumPostMessageContentDefault from "ForumPostMessageContent" /* 12280 */;
...
export default function ForumPostListBody(arg0) {
  ...
  if (!isGameInvitesPost) {
    ...
    tmp9Result = tmp9(tmp10(12273), obj7);
  }
  items2[1] = tmp9Result;
  ...
  if (!blocked) {
    ...
    if (null != media) {
      ...
      tmp9Result2 = tmp9(tmp2(12266).ForumPostMediaThumbnail, obj8);
    }
  }
