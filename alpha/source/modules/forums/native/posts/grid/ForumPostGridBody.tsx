...
// Dependencies: [32, 19, 17, 21, 4829, 576, 1177, 12349, 12350, 11597, 4825, 1478, 1370, 12351, 7605, 8229, 12355, 2]
// Exports: default
...
export default function ForumPostGridBody(thread) {
  ...
  if (tmp13Result) {
    ...
    obj4.children = tmp13(tmp2(12355).ForumPostAppliedTagPills, obj5);
