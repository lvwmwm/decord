...
// Dependencies: [32, 19, 17, 21, 4829, 576, 1177, 11475, 11476, 10802, 4825, 1478, 1370, 11477, 6688, 7318, 11481, 2]
// Exports: default
...
export default function ForumPostGridBody(thread) {
  ...
  if (tmp13Result) {
    ...
    obj4.children = tmp13(tmp2(11481).ForumPostAppliedTagPills, obj5);
