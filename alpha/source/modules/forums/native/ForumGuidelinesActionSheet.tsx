...
// Dependencies: [32, 19, 17, 7517, 21, 4757, 576, 8132, 1612, 10532, 1364, 10533, 4724, 7370, 5188, 1115, 4584, 4911, 8908, 7397, 6871, 5341, 4753, 10514, 8682, 5295, 4747, 10531, 1980, 2]
// Exports: default, openForumGuidelinesActionSheet

// Module 10531 (ForumGuidelinesActionSheet)
...
import ForumGuidelinesManagerDefault from "ForumGuidelinesManager" /* 10533 */;
...
export const openForumGuidelinesActionSheet = function openForumGuidelinesActionSheet(arg0) {
  ...
  obj.openLazy(asyncRequireImpl(10531, dependencyMap.paths), closure_6, obj2);
};
