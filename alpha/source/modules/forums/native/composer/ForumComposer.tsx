...
// Function ID: 10519
// Name: ForumComposer
// Dependencies: [5, 32, 19, 17, 4749, 1182, 5106, 2105, 4396, 2096, 7926, 5105, 1372, 1074, 2049, 2039, 1218, 1114, 1085, 21, 4757, 576, 7409, 504, 4608, 4625, 9424, 4910, 8132, 7921, 7519, 4601, 7228, 4493, 8022, 4768, 7701, 12, 8146, 8908, 10519, 10520, 5110, 1115, 10521, 10523, 1364, 10524, 10525, 10528, 2028, 10529, 1980, 10530, 10531, 8876, 1177, 7518, 1610, 1482, 7186, 8452, 10534, 4753, 10535, 10687, 10891, 10892, 9146, 10893, 10897, 7622, 11516, 5307, 10901, 8012, 4724, 11518, 9042, 5187, 5291, 2]
// Exports: default

// Module 10518 (ForumComposer)
...
import TagIcon from "TagIcon" /* 9146 */;
import useFocusHandlers from "useFocusHandlers" /* 10523 */;
import ForumGuidelinesActionSheet from "ForumGuidelinesActionSheet" /* 10531 */;
import openExpressionPickerActionSheet from "openExpressionPickerActionSheet" /* 10535 */;
...
function ActionBar(channel) {
  ...
  if (isMediaChannelResult) {
    ...
    isMediaChannelResult = closure_29(tmp5(10897), obj4);
  }
  ...
  if (!stateFromStores1) {
    ...
    if (tmp10) {
      ...
      obj6.style = items5;
      obj6.IconComponent = tmp2(9146).TagIcon;
      obj6.onPress = function onPress() {
        ...
        obj.openLazy(asyncRequireImpl(11518, dependencyMap.paths), "ForumPostTagsActionSheet", obj2);
      };
      tmp10 = closure_29(tmp2(7622).HeaderActionButton, obj6);
    }
    items4[1] = tmp10;
    let tmp18 = lastInput === tmp2(10523).PostComposerInputs.CONTENT;
    if (tmp18) {
      ...
      obj7.IconComponent = tmp2(9042).ReactionIcon;
      obj7.onPress = onShowExpressionPicker;
      tmp18 = closure_29(tmp2(7622).HeaderActionButton, obj7);
    }
    items4[2] = tmp18;
    ...
    obj9.icon = closure_29(tmp2(5291).ChatIcon, obj10);
    obj9.onPress = function onPress() {
      if (canPost) {
        _slicedToArray({});
      }
    };
    obj8.children = closure_29(tmp2(5187).Button, obj9);
    ...
    obj11.style = items6;
    if (tmp8) {
      let ImageIcon = tmp2(11516).KeyboardIcon;
    } else {
      ImageIcon = tmp2(5307).ImageIcon;
    }
    ...
    closure_29(tmp2(7622).HeaderActionButton, obj11);
  }
}
      ...
      if (!isEdit) {
        ...
        if (null != name) {
          ...
          if (tmp6Result !== name2) {
            ...
            tmp4(8022).changeThreadSettings(channel.id, obj);
            closure_15(tmp6Result);
            const tmp4Result = tmp4(8022);
          }
          tmp4 = importDefault;
        }
      }
