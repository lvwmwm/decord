...
// Function ID: 10598
// Name: ForumComposer
// Dependencies: [5, 32, 19, 17, 4819, 1182, 5190, 2105, 4462, 2096, 8008, 5189, 1372, 1074, 2049, 2039, 1218, 1114, 1085, 21, 4827, 576, 7493, 504, 4678, 4695, 9495, 4980, 8214, 8003, 7603, 4671, 7312, 4559, 8104, 4838, 7784, 12, 8228, 8979, 10598, 10599, 5194, 1115, 10600, 10602, 1364, 10603, 10604, 10607, 2028, 10608, 1980, 10609, 10610, 8947, 1177, 7602, 1610, 1482, 7270, 8523, 10613, 4823, 10614, 10763, 10967, 10968, 9217, 10969, 10973, 7705, 11592, 5391, 10977, 8094, 4794, 11594, 9113, 5271, 5375, 2]
// Exports: default

// Module 10597 (ForumComposer)
...
import useFocusHandlers from "useFocusHandlers" /* 10602 */;
import ForumGuidelinesActionSheet from "ForumGuidelinesActionSheet" /* 10610 */;
import openExpressionPickerActionSheet from "openExpressionPickerActionSheet" /* 10614 */;
...
function ActionBar(channel) {
  ...
  if (isMediaChannelResult) {
    ...
    isMediaChannelResult = closure_29(tmp5(10973), obj4);
  }
  ...
  if (!stateFromStores1) {
    ...
    if (tmp10) {
      ...
      obj6.style = items5;
      obj6.IconComponent = tmp2(9217).TagIcon;
      obj6.onPress = function onPress() {
        ...
        obj.openLazy(asyncRequireImpl(11594, dependencyMap.paths), "ForumPostTagsActionSheet", obj2);
      };
      tmp10 = closure_29(tmp2(7705).HeaderActionButton, obj6);
    }
    items4[1] = tmp10;
    let tmp18 = lastInput === tmp2(10602).PostComposerInputs.CONTENT;
    if (tmp18) {
      ...
      obj7.IconComponent = tmp2(9113).ReactionIcon;
      obj7.onPress = onShowExpressionPicker;
      tmp18 = closure_29(tmp2(7705).HeaderActionButton, obj7);
    }
    items4[2] = tmp18;
    ...
    obj9.icon = closure_29(tmp2(5375).ChatIcon, obj10);
    obj9.onPress = function onPress() {
      if (canPost) {
        _slicedToArray({});
      }
    };
    obj8.children = closure_29(tmp2(5271).Button, obj9);
    ...
    obj11.style = items6;
    if (tmp8) {
      let ImageIcon = tmp2(11592).KeyboardIcon;
    } else {
      ImageIcon = tmp2(5391).ImageIcon;
    }
    ...
    closure_29(tmp2(7705).HeaderActionButton, obj11);
  }
}
      ...
      if (!isEdit) {
        ...
        if (null != name) {
          ...
          if (tmp6Result !== name2) {
            ...
            tmp4(8104).changeThreadSettings(channel.id, obj);
            closure_15(tmp6Result);
            const tmp4Result = tmp4(8104);
          }
          tmp4 = importDefault;
        }
      }
