...
// Dependencies: [19, 17, 4819, 2099, 2064, 4472, 1372, 1074, 21, 4827, 5827, 576, 4559, 5288, 4828, 504, 1177, 4823, 4671, 7518, 7536, 8479, 5325, 4980, 5890, 2]

// Module 10966 (HorizontalAutocomplete)
...
export default {
  ...
  Role(onPress) {
    ...
    if (null != stateFromStores) {
      roleIconData = tmp2(7518).getRoleIconData(stateFromStores, 30);
  ...
  Channel(channel) {
    ...
    if (channel.type === constants.GUILD_CATEGORY) {
      ...
      channelIconWithGuild = tmp2(5325).getChannelIconWithGuild(channel, tmp5);
    ...
    items[1] = closure_11(channel(4823).Text, { style: tmp.channelName, variant: "text-sm/semibold", children: channelName });
    obj.children = items;
