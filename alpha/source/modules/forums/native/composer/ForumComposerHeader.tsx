...
// Dependencies: [19, 17, 21, 4827, 576, 4980, 5425, 1115, 5983, 5392, 4823, 5379, 2]
// Exports: default

// Module 10609 (ForumComposerHeader)
...
export default function ForumComposerHeader(height) {
  ...
  if (length > 0) {
    ...
    obj5.children = tmp6(tmp7(5379).BookCheckIcon, {});
    tmp6Result = tmp6(tmp7(5425).PressableOpacity, obj5);
  }
  items[2] = tmp6Result;
