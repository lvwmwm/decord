...
// Dependencies: [8012, 4960, 10516, 1980, 2]
// Exports: closeCreateForumPostModal, openCreateForumPostModal

// Module 10515 (ForumComposerModalActionCreators)
...
export const openCreateForumPostModal = function openCreateForumPostModal(guildId) {
  ...
  if (!tmp4) {
    ...
    const result1 = tmp(8012).trackForumCreateNewPostStarted({ guildId: null, channelId: null });
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10516, tmp2.paths), guildId, c3);
};
