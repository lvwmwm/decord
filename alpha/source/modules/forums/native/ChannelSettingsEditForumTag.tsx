...
// Dependencies: [32, 19, 17, 5678, 2042, 1375, 21, 4757, 576, 1484, 504, 4753, 1115, 8146, 7622, 5185, 5906, 5824, 5341, 11392, 7377, 1397, 9042, 1177, 6860, 7447, 5110, 2]
// Exports: default

// Module 17335 (ChannelSettingsEditForumTag)
  ...
  const layoutEffect = obj2.useLayoutEffect(() => {
    navigation.setOptions({
      headerTitle() {
        ...
        return closure_10(channelId(4753).Text, { variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", children });
      }
    });
  }, items3);
