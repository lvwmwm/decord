...
// Dependencies: [32, 19, 17, 4463, 4464, 2042, 1074, 21, 4827, 576, 504, 7632, 1478, 11598, 8201, 11757, 5425, 1115, 4777, 4823, 9953, 4769, 7784, 11, 4757, 11758, 2]
// Exports: default
...
export default function ForumPostActionBar(channel) {
  ...
  if (stateFromStores2) {
    ...
    tmp9(tmp2(5425).PressableOpacity, tmp15);
  }
};
