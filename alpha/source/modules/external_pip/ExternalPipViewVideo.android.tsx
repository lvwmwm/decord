...
// Dependencies: [32, 19, 17, 2044, 1372, 4850, 21, 4829, 576, 9771, 4783, 4825, 1115, 504, 1177, 9775, 4526, 17571, 9786, 17572, 9780, 2]
...
function ExternalPipViewVideoUnavailable(wasStream) {
  ...
  if (wasStream) {
    ...
    let tmp4Result = tmp4(tmp5(9771).StreamEnded, obj2);
    let tmp8 = tmp4;
    let tmp10 = tmp5;
  } else {
