...
// Dependencies: [19, 17, 21, 4829, 576, 12976, 12977, 5912, 4825, 1115, 6940, 7540, 2]
// Exports: ChatProvisionalAccountExplainerCard, UserProfileProvisionalAccountExplainerCard

// Module 12975 (ProvisionalAccountExplainer)
...
export const ChatProvisionalAccountExplainerCard = function ChatProvisionalAccountExplainerCard(iconSize) {
  ...
  const provisionalAccountExplanationText = iconSize(12977).useProvisionalAccountExplanationText({ userId, renderApplicationName: callback });
  ...
  const items2 = [closure_5(iconSize(4825).Text, obj4), closure_5(iconSize(6940).CircleErrorIcon, { size: "xs", color: "text-default" })];
  ...
  return closure_6(iconSize(5912).Card, obj2);
};
export const UserProfileProvisionalAccountExplainerCard = function UserProfileProvisionalAccountExplainerCard(iconSize) {
  ...
  const obj = iconSize(12977);
  const intl = iconSize(1115).intl;
  obj2.title = intl.string(iconSize(1115).t.Iyka0U);
  obj2.titleIcon = closure_5(iconSize(6940).CircleErrorIcon, { size: "xs", color: "text-default" });
