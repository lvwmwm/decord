...
// Dependencies: [19, 17, 21, 4829, 576, 12107, 12108, 5914, 4825, 1115, 6023, 6623, 2]
// Exports: ChatProvisionalAccountExplainerCard, UserProfileProvisionalAccountExplainerCard

// Module 12106 (ProvisionalAccountExplainer)
...
export const ChatProvisionalAccountExplainerCard = function ChatProvisionalAccountExplainerCard(iconSize) {
  ...
  const provisionalAccountExplanationText = iconSize(12108).useProvisionalAccountExplanationText({ userId, renderApplicationName: callback });
  ...
  const items2 = [closure_5(iconSize(4825).Text, obj4), closure_5(iconSize(6023).CircleErrorIcon, { size: "xs", color: "text-default" })];
  obj3.children = items2;
  const items3 = [closure_6(View, obj3), closure_5(iconSize(4825).Text, { variant: "text-sm/normal", color: "text-default", children: provisionalAccountExplanationText })];
  obj2.children = items3;
  return closure_6(iconSize(5914).Card, obj2);
};
export const UserProfileProvisionalAccountExplainerCard = function UserProfileProvisionalAccountExplainerCard(iconSize) {
  ...
  const obj = iconSize(12108);
  const intl = iconSize(1115).intl;
  obj2.title = intl.string(iconSize(1115).t.Iyka0U);
  obj2.titleIcon = closure_5(iconSize(6023).CircleErrorIcon, { size: "xs", color: "text-default" });
  obj2.children = closure_5(iconSize(4825).Text, { variant: "text-md/normal", color: "text-default", children: provisionalAccountExplanationText });
