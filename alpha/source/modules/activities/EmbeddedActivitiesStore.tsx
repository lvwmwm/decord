...
// Dependencies: [32, 502, 2042, 2096, 1372, 2004, 9392, 1074, 9698, 9699, 4451, 9393, 14344, 1110, 9717, 573, 9693, 9603, 1364, 1978, 7851, 504, 2]
...
function updateEmbeddedActivities(content_classification) {
  ...
  if (null != tmp3) {
      ...
      if (_location.id === value9.location.id) {
        if (application_id === value9.applicationId) {
          if (someResult) {
            ...
            const embeddedActivityLocationChannelId1 = tmp76(4451).getEmbeddedActivityLocationChannelId(_location);
            if (null != embeddedActivityLocationChannelId1) {
              ...
              let str5 = tmp76(4451).getEmbeddedActivityLocationGuildId(_location);
              if (str5 == null) {
                str5 = "0";
              }
              ...
              obj17 = map1;
              obj22 = map2;
              const tmp76Result4 = tmp76(4451);
            }
            const tmp76Result = tmp76(4451);
          } else {
            const _Array = Array;
      ...
      if (sessionId === obj4.getSessionId()) {
        ...
        if (null != tmp36) {
          if (null != obj4.getSessionId()) {
            ...
            if (id1 !== _location.id) {
              const embeddedActivityLocationChannelId2 = tmp76(4451).getEmbeddedActivityLocationChannelId(_location);
    ...
    obj6 = map4;
    const someResult1 = mapped.some((item) => application_id(14344).isActivityParticipantCurrentUserCurrentSession(item));
  }
}
