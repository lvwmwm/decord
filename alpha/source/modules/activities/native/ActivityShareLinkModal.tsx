...
// Dependencies: [5, 32, 19, 17, 2042, 1372, 2041, 11128, 4750, 21, 4757, 576, 504, 11253, 12389, 14772, 7415, 1370, 14774, 7701, 7921, 4455, 1115, 7436, 4454, 1478, 1612, 1364, 5850, 8110, 5843, 7622, 4699, 5343, 11256, 11267, 2]
// Exports: default

// Module 14773 (ActivityShareLinkModal)
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != first3) {
              dependencyMap = 1;
              c3 = 1;
              let obj4 = { value: Promise.all(first1.map(tmp2(11253).getOrResolveChannelIdFromDestinationId)), done: false };
              return obj4;
            } else {
              c3 = 3;
            }
          ...
          closure_128_1 = tmp2(14774).resolveActivityShareMessageContent(closure_129_3, closure_129_14, closure_129_12);
          closure_129_6(true);
                  ...
                  if (0 === c2) {
                    if (arg0 === 1) {
                      ...
                      if (null != channel) {
                        ...
                        c2 = 1;
                        c1 = 1;
                        const obj7 = { value: obj2.sendMessage(tmp17, closure_2_1(7921).parse(channel, c1), false, obj6), done: false };
                        return obj7;
                      }
                    }
                  } else if (arg0 === 1) {
