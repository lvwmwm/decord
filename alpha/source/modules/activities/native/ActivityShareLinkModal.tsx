...
// Dependencies: [5, 32, 19, 17, 2042, 1372, 2041, 11204, 4820, 21, 4827, 576, 504, 11329, 12465, 14852, 7499, 1370, 14854, 7784, 8003, 4521, 1115, 7520, 4520, 1478, 1612, 1364, 5934, 8192, 5927, 7705, 4769, 5427, 11332, 11343, 2]
// Exports: default

// Module 14853 (ActivityShareLinkModal)
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != first3) {
              dependencyMap = 1;
              c3 = 1;
              let obj4 = { value: Promise.all(first1.map(tmp2(11329).getOrResolveChannelIdFromDestinationId)), done: false };
              return obj4;
            } else {
              c3 = 3;
            }
          ...
          closure_128_1 = tmp2(14854).resolveActivityShareMessageContent(closure_129_3, closure_129_14, closure_129_12);
          closure_129_6(true);
                ...
                try {
                  ...
                  if (0 === c2) {
                    if (arg0 === 1) {
                      ...
                      if (null != channel) {
                        const obj2 = closure_2_1(7784);
                        const obj6 = { location: constants.ACTIVITY_SHARE };
                        c2 = 1;
                        c1 = 1;
                        const obj7 = { value: obj2.sendMessage(tmp17, closure_2_1(8003).parse(channel, c1), false, obj6), done: false };
                        return obj7;
                      }
                    }
                  } else if (arg0 === 1) {
          ...
          let obj6 = tmp3(4521);
          const result = tmp2(14852).closeActivityShareLinkModal();
          const obj9 = tmp2(14852);
        }
        c3 = 3;
