...
// Dependencies: [19, 17, 4819, 2004, 21, 4827, 504, 4559, 4828, 1177, 1115, 5271, 2]
// Exports: default

// Module 13119 (ActivitiesPrivateChannelCallTooltip)
...
export default function ActivitiesPrivateChannelCallTooltip(onClosePress) {
  ...
  const tmp2Result = num(4559);
  T.__closure = { withRepeat: num(4559).withRepeat, withSequence: num(4559).withSequence, withTiming: num(4828).withTiming, OFFSET: 40, translateBounceOffset: num, TIMING_CONFIG };
  ...
  obj6.children = jsx(num(5271).Button, { text: null, onPress: null, variant: "secondary", size: "sm", grow: true });
