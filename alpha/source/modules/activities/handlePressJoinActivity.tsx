...
// Dependencies: [5, 2002, 2042, 2064, 4462, 1372, 4846, 2041, 9715, 9692, 5193, 1115, 7494, 9691, 9716, 2]
// Exports: maybeJoinEmbeddedActivity

// Module 9714 (handlePressJoinActivity)
...
function handlePressJoinActivity(arg0) {
  ...
  } else if (tmp(9715).EmbeddedActivityJoinability.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION === embeddedActivityJoinability) {
    const result = tmp(9692).showActivitiesInvalidPermissionsAlert();
    const tmpResult = tmp(9692);
  } else if (tmp(9715).EmbeddedActivityJoinability.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS === embeddedActivityJoinability) {
  ...
  } else if (tmp(9715).EmbeddedActivityJoinability.ACTIVITY_NOT_SUPPORTED_ON_OS === embeddedActivityJoinability) {
  ...
  } else if (tmp(9715).EmbeddedActivityJoinability.ACTIVITY_AGE_GATED === embeddedActivityJoinability) {
