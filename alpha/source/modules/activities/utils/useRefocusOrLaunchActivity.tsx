...
// Dependencies: [5, 19, 9389, 2041, 9390, 7494, 504, 9673, 9650, 9718, 11852, 2]
// Exports: default

// Module 11851 (useRefocusOrLaunchActivity)
            ...
            if (null != applicationId) {
              if (null != data) {
                ...
                if (tmp9) {
                  ...
                  tmp3(9718)(guild_id, _location);
                  const tmp26 = tmp3(9718);
                } else {
                ...
                dependencyMap = 3;
                c5 = 1;
                const obj12 = { value: analyticsLocations(11852).launchActivityInBotDM(obj11), done: false };
                return obj12;
              }
            }
            c5 = 3;
