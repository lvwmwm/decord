...
// Dependencies: [5, 19, 9393, 2043, 9394, 7496, 504, 9677, 9654, 9722, 11858, 2]
// Exports: default

// Module 11857 (useRefocusOrLaunchActivity)
              ...
              if (null != data) {
                ...
                if (null != stateFromStores1) {
                  if (tmp10.applicationId === tmp41) {
                    ...
                    const result = tmp3(9654).updateFrameLayoutMode(obj5);
                    const obj10 = tmp3(9654);
                  }
                }
                if (tmp9) {
                  ...
                  tmp3(9722)(guild_id, _location);
                  const tmp26 = tmp3(9722);
                } else {
                  ...
                  if (c7) {
                    ...
                    dependencyMap = 2;
                    c5 = 1;
                    const obj9 = { value: tmp3(9654).launchFrame(obj7), done: false };
                    return obj9;
                  } else {
                    let id;
                    if (tmp42 != null) {
                ...
                dependencyMap = 3;
                c5 = 1;
                const obj12 = { value: analyticsLocations(11858).launchActivityInBotDM(obj11), done: false };
                return obj12;
              }
            }
            c5 = 3;
