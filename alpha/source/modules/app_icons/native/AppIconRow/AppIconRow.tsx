...
// Function ID: 15870
// Name: AppIconRow
// Dependencies: [32, 19, 21, 1115, 4827, 576, 9515, 12, 4541, 5908, 15866, 5992, 2]
// Exports: default
...
export default function AppIconRow(arg0) {
  ...
  if (!icon.isHidden) {
    ...
    if (!tmp7) {
      ...
      tmp10Result = tmp10(tmp3(5908).TableRow, obj2, id);
    }
    const obj4 = { selected: tmp7 };
    tmp10Result2 = tmp10(tmp3(5992).FormRadio, obj4);
  }
};
