...
// Dependencies: [9444, 9445, 1115, 9446, 9447, 9448, 9449, 9450, 9451, 9452, 9453, 9454, 9455, 9456, 9457, 9458, 9459, 9460, 9461, 9462, 9463, 9464, 9465, 9466, 9467, 9468, 9469, 2]
...
export const getIconById = function getIconById(currentAppIcon) {
  ...
  if (null == found) {
    const obj2 = { id: tmp(9444).FreemiumAppIconIds.DEFAULT, iconSource: _modDef9445, name: null, isPremium: false };
