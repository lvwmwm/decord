...
// Dependencies: [8617, 8618, 1115, 8619, 8620, 8621, 8622, 8623, 8624, 8625, 8626, 8627, 8628, 8629, 8630, 8631, 8632, 8633, 8634, 8635, 8636, 8637, 8638, 8639, 8640, 8641, 8642, 2]
...
export const getIconById = function getIconById(currentAppIcon) {
  ...
  if (null == found) {
    const obj2 = { id: tmp(8617).FreemiumAppIconIds.DEFAULT, iconSource: _modDef8618, name: null, isPremium: false };
