...
// Dependencies: [9515, 9516, 1115, 9517, 9518, 9519, 9520, 9521, 9522, 9523, 9524, 9525, 9526, 9527, 9528, 9529, 9530, 9531, 9532, 9533, 9534, 9535, 9536, 9537, 9538, 9539, 9540, 2]
...
export const getIconById = function getIconById(currentAppIcon) {
  ...
  if (null == found) {
    const obj2 = { id: tmp(9515).FreemiumAppIconIds.DEFAULT, iconSource: _modDef9516, name: null, isPremium: false };
