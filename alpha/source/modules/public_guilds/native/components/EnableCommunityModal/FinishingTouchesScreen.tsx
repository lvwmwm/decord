...
// Dependencies: [32, 19, 17, 9940, 2101, 8384, 1074, 21, 4526, 576, 504, 4469, 9939, 1086, 18162, 18206, 18205, 18203, 1115, 4825, 5271, 5992, 18215, 7533, 2110, 2]
// Exports: default

// Module 18217 (FinishingTouchesScreen)
...
export default function FinishingTouchesScreen() {
  ...
  let obj4 = { headerRef: ref, currentStep: guild(18203).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
