...
// Dependencies: [19, 17, 21, 4454, 18113, 5341, 2]
// Exports: default

// Module 18123 (CommunityRequirementSatisfiedForm)
...
export default function CommunityRequirementSatisfiedForm(formSwitchDisabled) {
  ...
  const enableCommunitySharedStyles = formSwitchDisabled(18113).useEnableCommunitySharedStyles();
