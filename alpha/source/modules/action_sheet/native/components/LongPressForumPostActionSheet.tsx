...
// Dependencies: [19, 4467, 4468, 6719, 502, 2066, 4844, 1074, 2051, 21, 9672, 9695, 1115, 9696, 9698, 6384, 6526, 4769, 7179, 9056, 4791, 4781, 9700, 5402, 9702, 9703, 11, 6598, 6793, 8077, 10807, 4796, 10805, 1980, 4771, 10809, 9602, 9589, 10413, 10841, 10405, 5196, 4786, 6871, 1177, 10081, 6605, 4524, 504, 6717, 6682, 7305, 2020, 4982, 10426, 5891, 6613, 1609, 10453, 6615, 2]
// Exports: default
...
export default function ForumPostLongPressActionSheet(thread) {
  ...
  if (null != stateFromStores) {
    ...
    let tmp21 = jsx(tmp17(5891), { guild: stateFromStores, size: tmp(5891).GuildIconSizes.LARGE });
    let tmp20 = jsx;
    const tmp17Result = tmp17(5891);
  } else {
    tmp20 = jsx;
