...
// Dependencies: [19, 4397, 4398, 7550, 502, 2064, 4772, 1074, 2049, 21, 10486, 10507, 1115, 10508, 10510, 7215, 7357, 4697, 8010, 9880, 4719, 4709, 10512, 5315, 10514, 10515, 11, 7429, 7625, 8908, 11520, 4724, 11518, 1980, 4699, 11522, 10416, 10403, 11233, 11579, 11225, 5109, 4714, 7701, 1177, 10895, 7436, 4454, 504, 7548, 7513, 8132, 2020, 4910, 11246, 5803, 7444, 1609, 11273, 7446, 2]
// Exports: default
...
export default function ForumPostLongPressActionSheet(thread) {
  ...
  if (null != stateFromStores) {
    ...
    let tmp21 = jsx(tmp17(5803), { guild: stateFromStores, size: tmp(5803).GuildIconSizes.LARGE });
    let tmp20 = jsx;
    const tmp17Result = tmp17(5803);
  } else {
    tmp20 = jsx;
