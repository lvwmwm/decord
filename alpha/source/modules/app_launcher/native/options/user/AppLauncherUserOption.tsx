...
// Dependencies: [32, 19, 4819, 21, 4827, 576, 504, 12509, 1875, 4794, 12518, 1980, 12518, 1177, 12512, 11263, 12515, 4823, 2]
// Exports: default
...
export default function AppLauncherUserOption(option) {
  ...
  if (null != tmp8) {
    ...
    tmp9Result = tmp9(tmp10(12512), obj4);
    const tmp10Result = tmp10(12512);
  }
  obj2.leading = tmp9Result;
  if (null != tmp8) {
    const obj5 = { guildId: guild_id, user: tmp8 };
    let tmp9Result2 = tmp9(tmp10(12515), obj5);
  } else {
    tmp9Result2 = null;
    if (null != tmp6) {
