...
// Dependencies: [5, 32, 19, 21, 12285, 9409, 12250, 7768, 5831, 5187, 1115, 4701, 2]
...
export default function CommandRowIcon(hasOptions) {
  if (hasOptions.hasOptions) {
    let tmp3Result = tmp3(tmp4(5831).TableRowArrow, {});
  } else {
    ...
    obj.onPress = tmp2;
    obj.icon = tmp3(tmp4(4701).SendMessageIcon, { size: "sm" });
    obj.disabled = tmp;
    tmp3Result = tmp3(tmp4(5187).Button, obj);
  }
  return tmp3Result;
};
