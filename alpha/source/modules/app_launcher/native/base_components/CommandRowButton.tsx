...
// Dependencies: [5, 32, 19, 21, 12361, 9480, 12326, 7851, 5915, 5271, 1115, 4771, 2]
...
export default function CommandRowIcon(hasOptions) {
  if (hasOptions.hasOptions) {
    let tmp3Result = tmp3(tmp4(5915).TableRowArrow, {});
  } else {
    ...
    obj.onPress = tmp2;
    obj.icon = tmp3(tmp4(4771).SendMessageIcon, { size: "sm" });
    obj.disabled = tmp;
    tmp3Result = tmp3(tmp4(5271).Button, obj);
  }
  return tmp3Result;
};
