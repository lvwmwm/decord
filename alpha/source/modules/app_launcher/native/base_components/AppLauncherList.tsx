...
// Dependencies: [19, 17, 21, 4757, 1612, 12359, 4463, 1177, 12425, 1115, 7297, 2]
// Exports: AppLauncherListEmptyState, AppLauncherListSearchBar

// Module 12424 (AppLauncherList)
...
export const AppLauncherList = noop.forwardRef((contentContainerStyle, arg1) => {
  ...
  return jsx(appLauncherFlashListProps(12359), { contentContainerStyle: null, scrollIndicatorInsets: { bottom }, ref: memo });
});
export const AppLauncherListEmptyState = function AppLauncherListEmptyState() {
  const tmp = closure_6();
  const obj = { style: tmp.emptyState, imageStyle: tmp.emptyStateImage, lightSource: _modDef12425, darkSource: _modDef12425, title: null, body: null };
  const intl = util.intl;
  obj.title = intl.string(util.t.vYocDz);
  const intl2 = util.intl;
  obj.body = intl2.string(util.t.V6nAfF);
  return jsx(native.EmptyState, { style: tmp.emptyState, imageStyle: tmp.emptyStateImage, lightSource: _modDef12425, darkSource: _modDef12425, title: null, body: null });
};
