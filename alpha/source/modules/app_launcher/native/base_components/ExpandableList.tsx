...
export default function ExpandableList(onExpand) {
  ...
  sharedValue = memo1(4566).useSharedValue(0);
  let obj3 = memo1(4566);
  sharedValue1 = memo1(4566).useSharedValue(0);
  const obj4 = memo1(4566);
  class C {
    constructor() {
      if (closure_5) {
        obj = closure_9;
  ...
  derivedValue = memo1(4566).useDerivedValue(C);
  ...
  const obj6 = memo1(4566);
  A.__closure = { collapsedListHeight: sharedValue, withTiming: memo1(4837).withTiming, containerHeight: derivedValue, timingStandard: memo1(4840).timingStandard };
  ...
  if (!showsExpandCTAOverride) {
    ...
    obj13.children = tmp16(tmp9(4832).Text, obj15);
