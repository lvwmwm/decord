...
// Function ID: 12447
// Name: NoPermsState
// Dependencies: [19, 17, 21, 4827, 576, 4678, 4761, 12447, 12448, 12384, 9602, 4823, 1115, 2]
// Exports: default

// Module 12446 (NoPermsState)
...
export default function EmptyState() {
  const tmp = closure_7();
  const tmp4Result = importDefault(shared.isThemeLight(useThemeDefault()) ? 12447 : 12448);
  const logAppLauncherEmptyStateView = AppLauncherNativeUtils.useLogAppLauncherEmptyStateView(tmp2(9602).AppLauncherEmptyStateType.HOME_NO_PERMISSIONS);
