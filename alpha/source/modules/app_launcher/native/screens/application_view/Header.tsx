...
// Dependencies: [19, 17, 1372, 9605, 1483, 1074, 21, 576, 4829, 4561, 504, 12393, 4526, 8491, 12398, 9484, 9215, 12473, 4825, 1177, 8269, 4772, 1241, 7522, 12474, 4522, 1115, 12475, 2]
// Exports: default
      ...
      const obj15 = {
        ...
        onPress() {
              ...
              if (c2) {
                ...
                const merged = Object.assign(tmp4(9484).getInstallAppProps(tmp2));
