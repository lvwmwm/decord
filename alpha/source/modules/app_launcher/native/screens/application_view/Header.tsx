...
// Dependencies: [19, 17, 1372, 9601, 1483, 1074, 21, 576, 4827, 4559, 504, 12384, 4524, 8487, 12389, 9480, 9211, 12464, 4823, 1177, 8265, 4770, 1241, 7520, 12465, 4520, 1115, 12466, 2]
// Exports: default
      ...
      const obj15 = {
        ...
        onPress() {
              ...
              if (c2) {
                ...
                const merged = Object.assign(tmp4(9480).getInstallAppProps(tmp2));
