...
// Dependencies: [19, 17, 1372, 9528, 1483, 1074, 21, 576, 4757, 4493, 504, 12308, 4458, 8405, 12313, 9409, 9140, 12388, 4753, 1177, 8183, 4700, 1241, 7436, 12389, 4454, 1115, 12390, 2]
// Exports: default
      ...
      const obj15 = {
        ...
        onPress() {
              ...
              if (c2) {
                ...
                const merged = Object.assign(tmp4(9409).getInstallAppProps(tmp2));
