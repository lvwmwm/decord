...
// Dependencies: [19, 17, 1372, 8703, 1483, 1074, 21, 576, 4829, 4563, 504, 11519, 4528, 7581, 11524, 8582, 8313, 11599, 4825, 1177, 7358, 4772, 1241, 6605, 11600, 4524, 1115, 11601, 2]
// Exports: default
      ...
      const obj15 = {
        ...
        onPress() {
              ...
              if (c2) {
                ...
                const merged = Object.assign(tmp4(8582).getInstallAppProps(tmp2));
