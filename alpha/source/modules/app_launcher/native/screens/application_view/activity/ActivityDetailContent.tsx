...
// Dependencies: [5, 32, 19, 17, 8312, 2002, 1074, 21, 576, 4829, 4825, 10772, 11609, 11525, 11519, 6938, 8582, 1115, 1241, 8704, 5274, 4842, 10728, 8782, 6578, 6598, 10445, 5431, 504, 5909, 6616, 10729, 6019, 6584, 11610, 11611, 11612, 1177, 11552, 8581, 5396, 11614, 2]
// Exports: default
  ...
  if (tmp2Result7.isRealApplication(application)) {
    ...
    if (isDeveloperOfThisApp) {
      ...
      if (useActivityUrlOverride) {
        ...
        const obj8 = { placeholder: "e.g. http://192.168.1.1:3000", value: activityUrlOverride, onChange: tmp23(10729).setActivityUrlOverride };
        obj7.children = tmp22(tmp2(6019).TextInput, obj8);
