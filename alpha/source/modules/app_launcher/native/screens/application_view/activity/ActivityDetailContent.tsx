...
// Dependencies: [5, 32, 19, 17, 9139, 2002, 1074, 21, 576, 4757, 4753, 11485, 12398, 12314, 12308, 7768, 9409, 1115, 1241, 9529, 5187, 4770, 11777, 9607, 7409, 7429, 11265, 5344, 504, 5821, 7447, 11778, 6850, 7415, 12399, 12400, 12401, 1177, 12341, 9408, 5309, 12403, 2]
// Exports: default
  ...
  if (tmp2Result7.isRealApplication(application)) {
    ...
    if (isDeveloperOfThisApp) {
      ...
      if (useActivityUrlOverride) {
        ...
        const obj8 = { placeholder: "e.g. http://192.168.1.1:3000", value: activityUrlOverride, onChange: tmp23(11778).setActivityUrlOverride };
        obj7.children = tmp22(tmp2(6850).TextInput, obj8);
    ...
    if (null != getPrimaryAppCommand) {
      ...
      if (tmp39Result2) {
        ...
        tmp39Result2 = tmp39(tmp2(4753).Text, obj17);
      }
