...
// Dependencies: [5, 32, 19, 17, 9210, 2002, 1074, 21, 576, 4827, 4823, 11561, 12474, 12390, 12384, 7851, 9480, 1115, 1241, 9602, 5271, 4840, 11853, 9680, 7493, 7513, 11341, 5428, 504, 5905, 7531, 11854, 6934, 7499, 12475, 12476, 12477, 1177, 12417, 9479, 5393, 12479, 2]
// Exports: default
  ...
  if (tmp2Result7.isRealApplication(application)) {
    ...
    if (isDeveloperOfThisApp) {
      ...
      if (useActivityUrlOverride) {
        ...
        const obj8 = { placeholder: "e.g. http://192.168.1.1:3000", value: activityUrlOverride, onChange: tmp23(11854).setActivityUrlOverride };
        obj7.children = tmp22(tmp2(6934).TextInput, obj8);
    ...
    if (null != getPrimaryAppCommand) {
      ...
      if (tmp39Result2) {
        ...
        tmp39Result2 = tmp39(tmp2(4823).Text, obj17);
      }
