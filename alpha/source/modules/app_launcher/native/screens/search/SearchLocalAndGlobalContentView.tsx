...
// Dependencies: [32, 19, 17, 9410, 12325, 1483, 21, 4757, 576, 12308, 12313, 12362, 9529, 1115, 5824, 9409, 12311, 1612, 7296, 9606, 12324, 7768, 7766, 12363, 12364, 4468, 12347, 12340, 12359, 4753, 12365, 9189, 12366, 2]

// Module 12361 (SearchLocalAndGlobalContentView)
...
function CommandRow(arg0) {
  ...
  const appLauncherIconSource = hasOptions(12308).getAppLauncherIconSource(application);
  let tmp4 = null != appLauncherIconSource;
  if (tmp4) {
    const obj2 = { iconSource: appLauncherIconSource };
    tmp4 = closure_10(onPressSend(12313), obj2);
  }
  obj = hasOptions(12308);
  const tmpResult = hasOptions(12362);
  const commandRowSend = tmpResult.useCommandRowSend({ command, context, beforeExecuteCommand, onExecuteCommand, sectionName: hasOptions(9529).AppLauncherSectionName.SEARCH });
  ...
  const obj3 = { command, context, beforeExecuteCommand, onExecuteCommand, sectionName: hasOptions(9529).AppLauncherSectionName.SEARCH };
  obj4.subLabel = hasOptions(9409).getSectionName(application);
  obj4.start = isFirstRow;
  obj4.end = isLastRow;
  obj4.onPress = onPress;
  obj4.accessibilityActions = memo;
  obj4.onAccessibilityAction = callback;
  obj4.trailing = closure_10(onPressSend(12362), { hasOptions, sending: commandRowSend.sending, onPressSend });
  return closure_10(hasOptions(5824).TableRow, obj4);
}
