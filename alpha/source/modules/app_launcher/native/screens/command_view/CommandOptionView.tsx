...
// Dependencies: [19, 17, 4749, 21, 1978, 4757, 576, 504, 4493, 12418, 12419, 4753, 12420, 1177, 10680, 2]
// Exports: default
...
export default function CommandOptionView(option) {
  ...
  if (set.has(option.type)) {
    ...
    if (hasItem1) {
      ...
      tmp17Result = tmp17(tmp2(4753).Text, obj7);
    }
    ...
    if (hasItem) {
      ...
      const obj11 = { style: tmp.optionErrorIcon, source: tmp18(10680), size: tmp2(1177).IconSizes.REFRESH_SMALL_16 };
      ...
      items3[1] = tmp17(tmp2(4753).Text, obj12);
      obj10.children = items3;
      hasItem = tmp19(tmp18(4493).View, obj10);
    }
    items2[3] = hasItem;
