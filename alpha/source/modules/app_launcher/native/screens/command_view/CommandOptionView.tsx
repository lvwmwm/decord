...
// Dependencies: [19, 17, 4819, 21, 1978, 4827, 576, 504, 4559, 12494, 12495, 4823, 12496, 1177, 10756, 2]
// Exports: default
...
export default function CommandOptionView(option) {
  ...
  if (set.has(option.type)) {
    ...
    if (hasItem1) {
      ...
      tmp17Result = tmp17(tmp2(4823).Text, obj7);
    }
    ...
    if (hasItem) {
      ...
      const obj11 = { style: tmp.optionErrorIcon, source: tmp18(10756), size: tmp2(1177).IconSizes.REFRESH_SMALL_16 };
      ...
      items3[1] = tmp17(tmp2(4823).Text, obj12);
      obj10.children = items3;
      hasItem = tmp19(tmp18(4559).View, obj10);
    }
    items2[3] = hasItem;
