...
EnteringAnimation.__closure = { withTiming: fn(4830).withTiming, timingStandard: fn(4833).timingStandard };
...
ExitingAnimation.__closure = { withTiming: fn(4830).withTiming, timingStandard: fn(4833).timingStandard };
