...
// Function ID: 11530
// Name: BannerBase
// Dependencies: [32, 19, 17, 4821, 21, 576, 4829, 11518, 4563, 1478, 4680, 504, 5273, 5286, 5836, 11530, 4825, 2]
// Exports: default

// Module 11529 (BannerBase)
...
export default function BannerBase(arg0) {
  ...
  obj8.style = items3;
  const items4 = [closure_7(sharedValue(5286), obj8), , ];
  ...
  obj10.source = require("module_11530");
  obj10.autoPlay = !stateFromStores;
  const items5 = [closure_7(sharedValue(5836), obj10), image];
  ...
  return closure_8(sharedValue(4563).View, obj7);
};
