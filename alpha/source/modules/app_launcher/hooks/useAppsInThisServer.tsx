...
// Dependencies: [19, 9410, 1372, 5211, 504, 9536, 1978, 9420, 12378, 12, 9526, 2]
// Exports: default

// Module 12379 (useAppsInThisServer)
...
const require = fn;
const useGuildIndexState = fn(9410).useGuildIndexState;
const limit = fn(5211).DISCOVERY_COMMANDS_QUERY_LIMIT;
const size = fn(2);
