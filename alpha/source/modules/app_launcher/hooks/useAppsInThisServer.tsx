...
// Dependencies: [19, 9481, 1372, 5295, 504, 9609, 1978, 9491, 12454, 12, 9599, 2]
// Exports: default

// Module 12455 (useAppsInThisServer)
...
const require = fn;
const useGuildIndexState = fn(9481).useGuildIndexState;
const limit = fn(5295).DISCOVERY_COMMANDS_QUERY_LIMIT;
const size = fn(2);
