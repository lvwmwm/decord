...
// Dependencies: [19, 9485, 1372, 5297, 504, 9613, 1978, 9495, 12463, 12, 9603, 2]
// Exports: default

// Module 12464 (useAppsInThisServer)
...
const require = fn;
const useGuildIndexState = fn(9485).useGuildIndexState;
const limit = fn(5297).DISCOVERY_COMMANDS_QUERY_LIMIT;
const size = fn(2);
