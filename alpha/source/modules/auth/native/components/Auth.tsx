...
// Function ID: 16339
// Name: Auth
// Dependencies: [32, 19, 17, 12753, 1074, 21, 16339, 16340, 5927, 16349, 7333, 7280, 4827, 576, 16390, 7273, 1626, 7304, 16391, 7302, 7331, 1365, 1115, 16392, 7803, 16396, 2]
...
function NavigatorWithCaptchaHook() {
  ...
  if (tmp5) {
    ...
    obj10.children = tmp17(tmp(7331).Navigator, obj11);
    obj7.children = tmp17(closure_6, obj10);
    obj5.children = tmp17(closure_6, obj7);
    let tmp17Result = tmp17(tmp(7302).WideAuthScrollContext.Provider, obj5);
    tmpResult = tmp(1365);
  } else {
    ...
    tmp17Result = tmp17(tmp(7331).Navigator, obj13);
  }
