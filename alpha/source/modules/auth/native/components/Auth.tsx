...
// Function ID: 16286
// Name: Auth
// Dependencies: [32, 19, 17, 12671, 1074, 21, 16286, 16287, 5843, 16296, 7249, 7196, 4757, 576, 16337, 7189, 1626, 7220, 16338, 7218, 7247, 1365, 1115, 16339, 7720, 16343, 2]
...
function NavigatorWithCaptchaHook() {
  ...
  if (tmp5) {
    ...
    obj10.children = tmp17(tmp(7247).Navigator, obj11);
    obj7.children = tmp17(closure_6, obj10);
    obj5.children = tmp17(closure_6, obj7);
    let tmp17Result = tmp17(tmp(7218).WideAuthScrollContext.Provider, obj5);
    tmpResult = tmp(1365);
  } else {
    ...
    tmp17Result = tmp17(tmp(7247).Navigator, obj13);
  }
