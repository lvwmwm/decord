...
// Dependencies: [5, 32, 19, 17, 16288, 16289, 21, 4757, 5194, 7189, 1484, 16298, 1094, 16285, 16303, 16304, 16287, 5204, 7208, 7217, 16305, 5187, 1115, 7186, 5797, 16307, 16308, 9896, 9897, 2]
...
function RegisterIdentityBase(inputMode) {
  ...
  if (null != memo) {
    ...
    if ("" !== memo) {
      ...
      tmp15Result = tmp15(tmp3(7186), obj9);
    }
  }
  ...
  if (!tmp4) {
    ...
    tmp15Result4 = tmp15(tmp3(5797), obj10);
  }
  return tmp15Result4;
}
