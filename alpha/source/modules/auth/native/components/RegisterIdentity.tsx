...
// Dependencies: [5, 32, 19, 17, 15543, 15544, 21, 4829, 5281, 6358, 1484, 15553, 1094, 15540, 15558, 15559, 15542, 5291, 6377, 6386, 15560, 5274, 1115, 6355, 5885, 15562, 15563, 9072, 9073, 2]
...
function RegisterIdentityBase(inputMode) {
  ...
  if (null != memo) {
    ...
    if ("" !== memo) {
      ...
      tmp15Result = tmp15(tmp3(6355), obj9);
    }
  }
  ...
  if (!tmp4) {
    ...
    tmp15Result4 = tmp15(tmp3(5885), obj10);
  }
  return tmp15Result4;
}
