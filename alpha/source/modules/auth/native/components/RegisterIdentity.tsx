...
// Dependencies: [5, 32, 19, 17, 16363, 16364, 21, 4829, 5280, 7275, 1484, 16373, 1094, 16360, 16378, 16379, 16362, 5290, 7294, 7303, 16380, 5273, 1115, 7272, 5883, 16382, 16383, 9974, 9975, 2]
...
function RegisterIdentityBase(inputMode) {
  ...
  if (null != memo) {
    ...
    if ("" !== memo) {
      ...
      tmp15Result = tmp15(tmp3(7272), obj9);
    }
  }
  ...
  if (!tmp4) {
    ...
    tmp15Result4 = tmp15(tmp3(5883), obj10);
  }
  return tmp15Result4;
}
