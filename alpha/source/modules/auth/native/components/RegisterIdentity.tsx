...
// Dependencies: [5, 32, 19, 17, 16341, 16342, 21, 4827, 5278, 7273, 1484, 16351, 1094, 16338, 16356, 16357, 16340, 5288, 7292, 7301, 16358, 5271, 1115, 7270, 5881, 16360, 16361, 9969, 9970, 2]
...
function RegisterIdentityBase(inputMode) {
  ...
  if (null != memo) {
    ...
    if ("" !== memo) {
      ...
      tmp15Result = tmp15(tmp3(7270), obj9);
    }
  }
  ...
  if (!tmp4) {
    ...
    tmp15Result4 = tmp15(tmp3(5881), obj10);
  }
  return tmp15Result4;
}
