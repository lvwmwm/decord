...
// Dependencies: [5, 32, 19, 16363, 16364, 1074, 21, 16360, 16379, 5290, 7378, 1115, 7412, 16392, 7413, 2]
// Exports: default

// Module 16391 (components/VerifyPhone)
import RegistrationBailoutButtonDefault from "RegistrationBailoutButton" /* 16392 */;
...
export default function VerifyPhone(phone) {
  ...
  onPhoneTokenReceived(16379)(closure_7(sourceState));
  const items = [context];
  ...
  onBail(function*(arg0) {
    ...
    yield onPhoneTokenReceived(7378).verifyPhone(closure_0, closure_0, false);
    if (1 === tmp7) {
      v0 = 0;
  ...
  onPhoneTokenReceived(7412)(callback1);
  const items3 = [onBail];
  ...
  const tmp7 = onPhoneTokenReceived(16379);
  obj.codeType = require("CodeField").CodeType.NUMERIC;
  obj.footer = memo;
  obj.disabled = tmp5;
  return jsx(onPhoneTokenReceived(7413), { title, description, error: tmp3, onCodeEntered, codeType: null, footer: null, disabled: null, loading: null, disableKeyboardAvoidingView: true });
};
