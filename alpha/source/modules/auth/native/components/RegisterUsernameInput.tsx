...
// Dependencies: [109, 32, 19, 16363, 21, 4829, 4561, 15074, 5271, 6940, 576, 4825, 1115, 16381, 6936, 1364, 2]
...
function UsernameStatusMessage(arg0) {
  ...
  if (type === UniqueUsernamesTypes.NameValidationState.ERROR) {
    ...
    const items = [React7(tmp3(6940).CircleErrorIcon, obj3), ];
    ...
    obj2.children = items;
    let tmp6 = closure_1_10(tmp3(5271).Stack, obj2);
  } else {
    if (isUsernameFocused) {
      ...
      if (type1 === tmp3(15074).NameValidationState.AVAILABLE) {
        const obj5 = {};
