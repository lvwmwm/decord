...
// Function ID: 16375
// Name: auth/register
// Dependencies: [5, 16375, 502, 1074, 1099, 4416, 1241, 5022, 1249, 4730, 5169, 573, 16376, 16377, 2]
...
function registerFull(giftCodeSKUId) {
  ...
  if (null != birthday) {
    tmp4(16376)(birthday, constants2.REGISTER);
    ...
    const diffResult = tmp4(4416)().diff(birthday, "years");
    if (diffResult >= 13) {
      if (diffResult < 13) {
        let str3 = "23+";
        if (diffResult >= 18) {
