...
// Function ID: 9407
// Name: Authorize
// Dependencies: [2042, 4648, 1074, 9407, 8685, 5759, 4467, 1086, 2]
// Exports: filterScopes, parseOAuth2AuthorizeProps

// Module 9406 (Authorize)
...
export const filterScopes = function filterScopes(items) {
  ...
  if (hasItem) {
    hasItem = !found.includes(tmp(8685).OAuth2Scopes.APPLICATIONS_COMMANDS);
  }
  if (hasItem) {
    found.push(tmp(8685).OAuth2Scopes.APPLICATIONS_COMMANDS);
  }
  return found;
};
