...
// Function ID: 9336
// Name: Authorize
// Dependencies: [2042, 4578, 1074, 9336, 8614, 5675, 4401, 1086, 2]
...
export const filterScopes = function filterScopes(items) {
  ...
  if (hasItem) {
    hasItem = !found.includes(tmp(8614).OAuth2Scopes.APPLICATIONS_COMMANDS);
  }
  if (hasItem) {
    found.push(tmp(8614).OAuth2Scopes.APPLICATIONS_COMMANDS);
  }
  return found;
};
