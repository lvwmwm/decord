...
// Dependencies: [19, 17, 1074, 21, 4829, 576, 9416, 8689, 1115, 4524, 9618, 9429, 7710, 4825, 9620, 2]
// Exports: default
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4524).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9618).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9429).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7710).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8689).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4524).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9429).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7710).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9620).AuthorizeFormSeparator, {})];
