...
// Dependencies: [19, 17, 1074, 21, 4757, 576, 9341, 8614, 1115, 4456, 9541, 9354, 7625, 4753, 9543, 2]
// Exports: default
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4456).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9541).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9354).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7625).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8614).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4456).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9354).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7625).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4753).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9543).AuthorizeFormSeparator, {})];
