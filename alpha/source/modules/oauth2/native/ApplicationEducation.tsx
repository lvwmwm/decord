...
// Dependencies: [19, 17, 1074, 21, 4756, 576, 9335, 8610, 1115, 4455, 9535, 9348, 7622, 4752, 9537, 2]
// Exports: default
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj6 = { iconComponent: tmp4(9535).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9348).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7622).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8610).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj12 = { iconComponent: tmp4(9348).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7622).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9537).AuthorizeFormSeparator, {})];
