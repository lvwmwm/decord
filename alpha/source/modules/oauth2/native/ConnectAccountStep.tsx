...
export default function ConnectAccountStep(clientId) {
  ...
  if (null == value) {
    ...
    items6[1] = closure_8(tmp5(4832).Text, obj14);
    ...
    items7[1] = closure_8(tmp5(4832).Text, obj18);
    const obj19 = {
      variant: "primary",
      size: "sm",
      onPress() {
    ...
    const items8 = [closure_8(tmp5(4787).CircleInformationIcon, obj21), ];
    ...
    items8[1] = closure_8(tmp5(4832).Text, obj22);
    ...
    const source = tmp5Result.makeSource(tmp5(4685).isThemeLight(tmp4) ? icon.lightPNG : icon.darkPNG);
    const tmp5Result2 = tmp5(4685);
  }
};
