...
// Dependencies: [19, 17, 5056, 502, 1372, 21, 4829, 576, 4763, 504, 5590, 1397, 4682, 6579, 1177, 7360, 4825, 1115, 5274, 8520, 4783, 4779, 2]
// Exports: ConnectedAccountCard, default

// Module 8519 (ConnectAccountStep)
...
export default function ConnectAccountStep(clientId) {
  ...
  if (null == value) {
    ...
    items6[1] = closure_8(tmp5(4825).Text, obj14);
    ...
    items7[1] = closure_8(tmp5(4825).Text, obj18);
    const obj19 = {
      variant: "primary",
      size: "sm",
      onPress() {
    ...
    const items8 = [closure_8(tmp5(4783).CircleInformationIcon, obj21), ];
    ...
    items8[1] = closure_8(tmp5(4825).Text, obj22);
