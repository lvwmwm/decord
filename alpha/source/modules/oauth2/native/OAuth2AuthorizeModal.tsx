...
// Dependencies: [19, 17, 21, 4757, 576, 9333, 1612, 4493, 5186, 5341, 1115, 9560, 5899, 4753, 7370, 9562, 2]
// Exports: default

// Module 9332 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  const tmp = closure_8();
  const tmp4 = sharedValue(9333)(arg0);
  _require = tmp4;
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(9560).ArrowSmallLeftIcon, obj7);
  } else {
    const obj8 = { color: tmp2(576).colors.INTERACTIVE_TEXT_DEFAULT };
    tmp11Result = tmp11(tmp5(5899).XSmallIcon, obj8);
  }
  ...
  obj11.style = items3;
  items2[2] = closure_5(sharedValue(4493).View, obj11);
  ...
  obj12.children = closure_5(sharedValue(9562), obj13);
