...
// Dependencies: [19, 17, 21, 4827, 576, 9404, 1612, 4559, 5270, 5425, 1115, 9633, 5983, 4823, 7454, 9635, 2]
// Exports: default

// Module 9403 (OAuth2AuthorizeModal)
...
export default function OAuth2AuthorizeModal(arg0) {
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = tmp11(tmp5(9633).ArrowSmallLeftIcon, obj7);
  } else {
    const obj8 = { color: tmp2(576).colors.INTERACTIVE_TEXT_DEFAULT };
    tmp11Result = tmp11(tmp5(5983).XSmallIcon, obj8);
  }
