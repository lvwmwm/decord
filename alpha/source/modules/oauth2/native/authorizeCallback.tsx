...
// Dependencies: [9326, 4960, 9328, 1980, 1366, 9330, 4721, 1094, 4452, 2]
// Exports: default
      ...
      if (tmp8Result.isDiscordHostname(host)) {
        if (null != pathname) {
          if (null != pathname.match(re5)) {
            ...
            tmp8(4960).pushLazy(asyncRequireImpl(9330, tmp9.paths), obj3, React3);
          } else if (null != pathname.match(re6)) {
            if (!canceled) {
              let str1;
              const tmp8Result5 = tmp8(4960);
              ...
              tmp8Result5.pushLazy(asyncRequireImpl(9328, tmp9.paths), obj4, React4);
              const tmp17 = asyncRequireImpl(9328, tmp9.paths);
            }
          }
        }
      }
