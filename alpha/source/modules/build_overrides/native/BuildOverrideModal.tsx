...
// Dependencies: [19, 17, 11768, 21, 4827, 576, 4761, 4678, 14228, 14229, 504, 12124, 4414, 7454, 4823, 1115, 5271, 5030, 2]
// Exports: default
...
export default function BuildOverrideModal(overrideUrl) {
  ...
  if (null != id) {
    ...
    const items3 = [tmp14(tmp5(4823).Text, obj7), ];
    ...
    items3[1] = tmp14(tmp5(4823).Text, obj8);
    ...
    tmp14Result = tmp14(tmp5(4823).Text, obj10);
  }
  ...
  if (null != id) {
    ...
    obj13.children = tmp14(tmp5(5271).Button, obj14);
    ...
    items5[1] = tmp14(tmp5(5271).Button, obj15);
    ...
    tmp12Result2 = tmp14(tmp5(5271).Button, obj16);
  }
