...
// Dependencies: [19, 4672, 4944, 4945, 1074, 21, 4493, 504, 7470, 12542, 1241, 4937, 5739, 16912, 16913, 16918, 16922, 16923, 16926, 7469, 2]
// Exports: default
...
function GuildOnboardingHomePage(guildId) {
  ...
  if (tmp6) {
    ...
    if (tmp5) {
      ...
      const obj6 = { guildId };
      const items4 = [tmp12(tmp4(16918), obj6), , ];
      const obj7 = { guildId };
      items4[1] = tmp12(tmp4(16922), obj7);
      tmp4 = tmp4(16923);
      const obj8 = { guildId };
      tmp = tmp12(tmp4, obj8);
      items4[2] = tmp;
      ...
      const obj9 = { guildId };
      tmp12Result = tmp12(tmp4(16926), obj9);
    }
