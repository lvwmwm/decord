...
// Dependencies: [19, 17, 2044, 4464, 5049, 4466, 1074, 21, 4829, 576, 504, 7318, 11477, 16193, 6871, 11753, 1397, 5428, 4825, 4819, 16186, 1101, 1115, 16194, 5274, 2]
// Exports: default
        ...
        if (null != firstResult) {
          ...
          if (!blocked) {
            ...
            if (null != first) {
              ...
              tmp19Result6 = tmp19(tmp2(11477).ForumPostMediaThumbnail, obj17);
