...
// Dependencies: [19, 17, 2105, 21, 4757, 576, 504, 12488, 1115, 5806, 4753, 2]
// Exports: default

// Module 12654 (ApplicationSectionHeader)
...
export default function ApplicationSectionHeader(section) {
  ...
  const applicationCommandsIconSource = section(12488).getApplicationCommandsIconSource(section, stateFromStores);
  let nick;
  ...
  if (tmp9) {
    ...
    tmp9 = closure_5(guildId(5806), obj4);
  }
  const items1 = [tmp9, closure_5(section(4753).Text, { variant: "eyebrow", color: "interactive-text-default", children: name })];
