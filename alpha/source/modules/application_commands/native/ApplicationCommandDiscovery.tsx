...
// Dependencies: [32, 19, 17, 5211, 12653, 10527, 1074, 21, 12654, 4757, 576, 5194, 12655, 9536, 1978, 9418, 4468, 1115, 4937, 12, 12656, 7768, 12657, 12658, 1177, 10684, 2]
// Exports: default
...
export default function ApplicationCommandDiscovery(channel) {
  ...
  obj9.renderSectionHeader = function renderSectionHeader(section) {
    ...
    if (tmp3Result) {
      const obj3 = { lightSource: tmp4(10684), darkSource: tmp4(10684), body: null, containerStyle: null, imageStyle: null };
      const intl = util.intl;
