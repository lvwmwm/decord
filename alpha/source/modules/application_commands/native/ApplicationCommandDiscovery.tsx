...
// Dependencies: [32, 19, 17, 5295, 12735, 10606, 1074, 21, 12736, 4827, 576, 5278, 12737, 9609, 1978, 9489, 4534, 1115, 5007, 12, 12738, 7851, 12739, 12740, 1177, 10760, 2]
// Exports: default
...
export default function ApplicationCommandDiscovery(channel) {
  ...
  obj9.renderSectionHeader = function renderSectionHeader(section) {
    ...
    if (tmp3Result) {
      const obj3 = { lightSource: tmp4(10760), darkSource: tmp4(10760), body: null, containerStyle: null, imageStyle: null };
      const intl = util.intl;
