...
// Function ID: 13007
// Name: ChannelSpoiler
// Dependencies: [32, 19, 17, 4843, 2042, 2064, 12604, 21, 4827, 576, 504, 4980, 12605, 5028, 5823, 4685, 5325, 4823, 1115, 5269, 4817, 5425, 13005, 8759, 2]
// Exports: default
...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = obj4.useContext(tmp6(12605)).setControlsMode;
  const items2 = [, , , ];
  ...
  if (null != topic) {
    ...
    if ("" !== str.trim()) {
      ...
      if (tmp5[0]) {
        ...
        obj12.children = tmp24(tmp(4823).Text, obj13);
        tmp24Result = tmp24(tmp(5425).PressableHighlight, obj12);
      }
      items5[2] = tmp24Result;
      const obj14 = { style: tmp4.divider };
      items5[3] = closure_10(tmp25, obj14);
      obj6.children = items5;
      tmp23Result = tmp23(tmp(5269).Stack, obj6);
