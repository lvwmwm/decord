...
// Function ID: 4919
// Name: GuildRoomUtils
// Dependencies: [4915, 4919, 4920, 4917, 4916, 2]
// Exports: findSeat, serverGuildRoomToClient

// Module 4918 (GuildRoomUtils)
...
function serverGuildRoomObjectToClient(object_type) {
  if (object_type.object_type === GuildRoomTypes.GuildRoomObjectTypes.PLANT) {
    const obj = { objectType: tmp(4916).GuildRoomObjectTypes.PLANT };
    ...
    obj8 = { objectType: tmp(4916).GuildRoomObjectTypes.NOTE };
...
let closure_3 = fn(4919).GUILD_ROOM_BACKGROUND_CONFIG;
const size = fn(2);
