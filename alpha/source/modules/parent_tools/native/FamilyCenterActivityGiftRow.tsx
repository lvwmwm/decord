...
// Dependencies: [19, 17, 21, 4836, 576, 7618, 14430, 14439, 14441, 4678, 14440, 4832, 2]
// Exports: default
...
export default function FamilyCenterActivityGiftRow(arg0) {
  ...
  if (null == displayName) {
    ...
    const items = [React4(tmp2(14440), obj5), ];
