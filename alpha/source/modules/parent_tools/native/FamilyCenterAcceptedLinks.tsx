...
// Dependencies: [19, 17, 7780, 21, 4756, 576, 8924, 8923, 12174, 1115, 2482, 4752, 15194, 15196, 5339, 4959, 15199, 1980, 1177, 15201, 2]
// Exports: default
...
export default function FamilyCenterAcceptedLinks() {
  ...
  if (0 === activeLinkUsers.length) {
    ...
    obj6.children = tmp10(tmp2(15194), obj7);
    let mapped = tmp10(tmp9, obj6);
    const tmp2Result = tmp2(15194);
  } else {
