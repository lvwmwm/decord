...
const memoResult = noop.memo((action) => {
  ...
  if (null == stateFromStores) {
    ...
    obj6.children = tmp3(4678).getName(stateFromStores);
    const items2 = [closure_8(tmp6(4832).Text, obj6), ];
...
const memoResult1 = noop.memo((action) => {
  ...
  if (undefined === stateFromStores) {
    ...
    items2[1] = closure_8(tmp2(4832).Text, obj9);
    ...
    if (undefined !== stateFromStores.approximateMemberCount) {
      ...
      obj10.children = intl.format(tmp6(2487)["5JmNgg"], obj19);
      tmp11Result2 = tmp11(tmp2(4832).Text, obj10);
    }
