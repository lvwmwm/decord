...
// Dependencies: [32, 19, 17, 7866, 21, 4827, 576, 9000, 7920, 15231, 4823, 12252, 1115, 2484, 15237, 5425, 2]
// Exports: default
  ...
  if (0 === actionsForDisplayType.length) {
    ...
    if (substr.length >= actionTotalsForDisplayType) {
      ...
      if (familyCenterActions.isMoreLoading) {
        ...
        obj10.children = tmp17(tmp(4823).Text, obj11);
        tmp17Result = tmp17(tmp(5425).PressableOpacity, obj10);
      }
