...
// Dependencies: [32, 19, 17, 7783, 21, 4757, 576, 8929, 7837, 15179, 4753, 12175, 1115, 2482, 15185, 5341, 2]
// Exports: default
  ...
  if (0 === actionsForDisplayType.length) {
    ...
    if (substr.length >= actionTotalsForDisplayType) {
      ...
      if (familyCenterActions.isMoreLoading) {
        ...
        obj10.children = tmp17(tmp(4753).Text, obj11);
