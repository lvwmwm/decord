...
// Dependencies: [5, 19, 17, 21, 4829, 576, 8040, 4825, 1115, 2486, 14420, 4525, 4788, 5032, 4524, 6650, 7862, 7863, 5272, 6019, 11391, 5740, 5274, 5931, 10756, 2]
// Exports: default
...
function ChangeSpendingLimitScreen(teenId) {
  ...
  if (null == formatPriceResult) {
    ...
    items[1] = tmp8(tmp2(5272).Stack, obj4);
    obj2.children = items;
    obj8.children = tmp8(tmp2(5272).Stack, obj2);
    const items3 = [tmp9(tmp2(7863).ModalContent, obj8), ];
    if (isClearingCap) {
    ...
    const items4 = [tmp9(tmp2(5274).Button, obj10), ];
    ...
    items4[1] = tmp9(tmp2(5274).Button, obj14);
    obj13.children = items4;
    obj12.children = tmp8(tmp2(5740).ButtonGroup, obj13);
    items3[1] = tmp9(tmp2(11391).ModalFooter, obj12);
    obj11.children = items3;
    return tmp8(tmp2(7862).ModalScreen, obj11);
    ...
    const items5 = [tmp9(tmp2(8040).WarningIcon, obj16), ];
