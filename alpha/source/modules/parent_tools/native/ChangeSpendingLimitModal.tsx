...
// Dependencies: [5, 19, 17, 21, 4829, 576, 8946, 4825, 1115, 2486, 15254, 4523, 4788, 5032, 4522, 7567, 8772, 8773, 5271, 6936, 12269, 5738, 5273, 5929, 11551, 2]
// Exports: default
...
function ChangeSpendingLimitScreen(teenId) {
  ...
  if (null == formatPriceResult) {
    ...
    items[1] = tmp8(tmp2(5271).Stack, obj4);
    obj2.children = items;
    obj8.children = tmp8(tmp2(5271).Stack, obj2);
    const items3 = [tmp9(tmp2(8773).ModalContent, obj8), ];
    if (isClearingCap) {
    ...
    const items4 = [tmp9(tmp2(5273).Button, obj10), ];
    ...
    items4[1] = tmp9(tmp2(5273).Button, obj14);
    obj13.children = items4;
    obj12.children = tmp8(tmp2(5738).ButtonGroup, obj13);
    items3[1] = tmp9(tmp2(12269).ModalFooter, obj12);
    obj11.children = items3;
    return tmp8(tmp2(8772).ModalScreen, obj11);
    ...
    const items5 = [tmp9(tmp2(8946).WarningIcon, obj16), ];
    ...
    items5[1] = tmp9(tmp2(4825).Text, obj17);
    ...
    tmp9Result1 = tmp9(tmp2(4825).Text, obj19);
  }
}
