...
// Dependencies: [19, 17, 21, 4829, 576, 5032, 4524, 1115, 11381, 7862, 7863, 14434, 4772, 4825, 2486, 14404, 11383, 11391, 5740, 5274, 5931, 10756, 2]
// Exports: default

// Module 14437 (FamilyCenterModalAccept)
...
function FamilyCenterModalAcceptScreen(otherUser) {
  ...
  obj5.iconSrc = acceptLinkRequest(4772);
  obj5.iconStyles = tmp.icon;
  const items1 = [closure_5(acceptLinkRequest(14434), obj5), , ];
  ...
  items1[2] = closure_5(acceptLinkRequest(14404), { user: otherUser });
  obj4.children = items1;
  const items2 = [closure_6(View, obj4), closure_5(acceptLinkRequest(11383), {}), ];
  ...
  items2[2] = closure_5(otherUser(4825).Text, obj7);
  obj3.children = items2;
  const items3 = [closure_6(otherUser(7863).ModalContent, obj3), ];
  ...
  const items4 = [closure_5(otherUser(5274).Button, obj11), ];
  ...
  obj12.onPress = acceptLinkRequest(5032).pop;
  items4[1] = closure_5(otherUser(5274).Button, obj12);
  obj10.children = items4;
  obj9.children = closure_6(otherUser(5740).ButtonGroup, obj10);
  items3[1] = closure_5(otherUser(11391).ModalFooter, obj9);
