...
// Dependencies: [32, 19, 17, 21, 4757, 576, 4960, 4601, 8928, 4454, 1115, 12175, 12178, 2482, 8697, 8698, 15207, 7239, 4753, 15159, 5185, 9549, 12185, 5652, 5187, 5843, 11469, 2]
// Exports: default
...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  if (requiresParentalConsent) {
    ...
    tmp28Result = tmp28(tmp3(15159), obj13);
  }
