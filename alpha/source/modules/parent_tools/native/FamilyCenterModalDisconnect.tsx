...
// Dependencies: [32, 19, 17, 21, 4829, 576, 5032, 4675, 8097, 4524, 1115, 11381, 11384, 2486, 7862, 7863, 14434, 6408, 4825, 14386, 5272, 8724, 11391, 5740, 5274, 5931, 10756, 2]
// Exports: default
...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  if (requiresParentalConsent) {
    ...
    tmp28Result = tmp28(tmp3(14386), obj13);
  }
