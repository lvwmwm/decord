...
// Dependencies: [19, 17, 21, 4836, 8105, 8106, 14413, 576, 11398, 1115, 2487, 14420, 14421, 4832, 2]
// Exports: default
...
const FamilyCenterBannerButton = tmp2(14413);
require = fn;
...
export default function FamilyCenterActivityBanner() {
  ...
  obj5.source = tmp(tmp3 ? 14420 : 14421);
  obj5.style = tmp4.art;
