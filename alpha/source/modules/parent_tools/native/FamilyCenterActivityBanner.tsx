...
// Dependencies: [19, 17, 21, 4757, 8928, 8929, 15161, 576, 12178, 1115, 2482, 15168, 15169, 4753, 2]
// Exports: default

// Module 15160 (FamilyCenterActivityBanner)
...
const FamilyCenterBannerButton = tmp2(15161);
require = fn;
...
export default function FamilyCenterActivityBanner() {
  ...
  obj5.source = tmp(tmp3 ? 15168 : 15169);
  obj5.style = tmp4.art;
