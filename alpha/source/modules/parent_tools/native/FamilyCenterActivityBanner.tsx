...
// Dependencies: [19, 17, 21, 4756, 8923, 8924, 15154, 576, 12174, 1115, 2482, 15161, 15162, 4752, 2]
// Exports: default

// Module 15153 (FamilyCenterActivityBanner)
...
const FamilyCenterBannerButton = tmp2(15154);
require = fn;
...
export default function FamilyCenterActivityBanner() {
  ...
  obj5.source = tmp(tmp3 ? 15161 : 15162);
  obj5.style = tmp4.art;
