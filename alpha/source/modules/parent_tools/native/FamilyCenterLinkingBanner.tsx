...
function FamilyCenterLinkingBannerParentContent() {
  ...
  obj2.header = intl.string(_modDef2487["7xxAni"]);
  const intl2 = util.intl;
  obj2.description = intl2.string(_modDef2487["1M9So2"]);
  const items = [hasOwnProperty(FamilyCenterLinkingInstructionsRow, obj2), , , ];
  const obj3 = { index: 2, header: null, description: null };
  const intl3 = util.intl;
  obj3.header = intl3.string(_modDef2487["AXgx+a"]);
  const intl4 = util.intl;
  obj3.description = intl4.string(_modDef2487.GzMFnb);
  ...
  obj4.header = intl5.string(_modDef2487.MZn1tG);
  const intl6 = util.intl;
  obj4.description = intl6.string(_modDef2487["8rLBxD"]);
...
export default function FamilyCenterLinkingBanner() {
  ...
  const intl2 = util.intl;
  const ageSpecificText = obj.useAgeSpecificText(intl.string(_modDef2487.zUCWEL), intl2.string(_modDef2487.B0NPbp));
