...
// Dependencies: [19, 17, 7866, 1074, 21, 4827, 576, 9000, 8999, 7920, 12255, 1115, 2484, 1177, 15227, 4823, 10090, 5030, 15228, 1980, 13108, 15229, 15230, 12252, 4794, 4520, 4671, 9619, 1241, 10283, 15231, 15232, 15233, 15236, 15243, 2]
// Exports: default
...
function FamilyCenterActivityCardPrefaceText() {
  ...
  let tmp12 = null;
  if (!tmp4) {
    const obj7 = { color: tmp.icon.color, source: tmp2(15227), style: tmp.icon };
