...
// Dependencies: [19, 17, 7783, 1074, 21, 4757, 576, 8929, 8928, 7837, 12178, 1115, 2482, 1177, 15175, 4753, 10017, 4960, 15176, 1980, 13026, 15177, 15178, 12175, 4724, 4454, 4601, 9546, 1241, 10203, 15179, 15180, 15181, 15184, 15191, 2]
// Exports: default
...
function FamilyCenterActivityCardPrefaceText() {
  ...
  let tmp12 = null;
  if (!tmp4) {
    const obj7 = { color: tmp.icon.color, source: tmp2(15175), style: tmp.icon };
