...
// Dependencies: [19, 17, 7783, 1074, 21, 4757, 576, 4753, 1115, 2482, 4960, 15192, 1980, 15194, 5824, 8928, 15178, 1484, 15195, 5185, 5906, 5187, 7831, 4770, 15110, 7784, 15196, 2]
// Exports: default
...
function FamilyCenterSettingsParentalControls() {
  ...
  if (tmp14Result2) {
    ...
    tmp14Result2 = tmp14(tmp2(5824).TableRow, obj11);
  }
