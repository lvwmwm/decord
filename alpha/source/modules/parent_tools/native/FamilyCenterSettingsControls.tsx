...
// Dependencies: [19, 17, 7866, 1074, 21, 4827, 576, 4823, 1115, 2484, 5030, 15244, 1980, 15246, 5908, 8999, 15230, 1484, 15247, 5269, 5990, 5271, 7914, 4840, 15155, 7867, 15248, 2]
// Exports: default
...
function FamilyCenterSettingsParentalControls() {
  ...
  if (tmp14Result2) {
    ...
    tmp14Result2 = tmp14(tmp2(5908).TableRow, obj11);
  }
