...
export const ForwardPreview = function ForwardPreview(message) {
  ...
  if (attachments.length > 1) {
    ...
    if (null != tmp6) {
      ...
      items3[1] = timestampProducer(tmp2(4832).Text, obj18);
  ...
  if (tmp36Result) {
    const obj23 = { variant: "text-md/medium", children: tmp2(5081).getCheckpointLabel(checkpointDataFromMessage) };
    tmp36Result = tmp36(tmp2(4832).Text, obj23);
    const tmp2Result2 = tmp2(5081);
  }
  ...
  if (tmp34Result) {
    ...
    if (tmp36Result7) {
      ...
      tmp36Result7 = tmp36(tmp2(4832).Text, obj27);
    }
