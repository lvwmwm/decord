...
// Function ID: 11952
// Name: ForwardPreview
// Dependencies: [19, 17, 21, 4757, 576, 4691, 8399, 8194, 8935, 11952, 1978, 11953, 12, 11954, 1115, 11956, 8999, 5307, 10374, 5806, 1477, 9099, 4753, 3000, 8416, 2]
...
export const ForwardPreview = function ForwardPreview(message) {
  ...
  if (null != checkpointData) {
    ...
    tmp6 = tmp2(11953).CHECKPOINT_PERSONA_COLORS[num];
  }
  if (tmp6 != null) {
  ...
  if (attachments.length > 0) {
    ...
    if (num2 > 0) {
      if (num3 > 0) {
        ...
        let AttachmentIcon = tmp2(11956).ImagesIcon;
      }
      if (num3 > 0) {
        if (length === num3) {
          ...
          items1[1] = hasOwnProperty(tmp2(8999).CirclePlayIcon, obj5);
    ...
    if (num3 > 0) {
      ...
      AttachmentIcon = tmp2(8999).CirclePlayIcon;
    } else if (num2 > 0) {
      ...
      if (1 === num2) {
        ...
        ImagesIcon = tmp2(11956).ImagesIcon;
      }
      ...
      AttachmentIcon = tmp2(10374).AttachmentIcon;
    }
  ...
  if (attachments.length > 1) {
    tmp33 = tmp7;
    if (null != tmp7) {
      const size3 = { shape: tmp2(9099).CutoutShape.RoundedRect, x: 28, y: 28, width: 32, height: 32, cornerRadius: 12 };
      ...
      items3[1] = timestampProducer(tmp2(4753).Text, obj17);
  ...
  if (tmp36Result) {
    ...
    tmp36Result = tmp36(tmp2(4753).Text, obj22);
  }
  ...
  if (tmp34Result) {
    ...
    if (tmp36Result7) {
      ...
      tmp36Result7 = tmp36(tmp2(4753).Text, obj26);
    }
  ...
  if (tmp36Result8) {
    ...
    const obj29 = { uri: tmp2(8416).getCardAssetUrl(num5) };
    size4.source = obj29;
    obj27.children = tmp36(tmp46, size4);
    tmp36Result8 = tmp36(tmp35, obj27);
    const tmp2Result2 = tmp2(8416);
  }
