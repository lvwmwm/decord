...
// Function ID: 12015
// Name: ForwardModal
// Dependencies: [5, 32, 19, 17, 7922, 7926, 8681, 2042, 5047, 8706, 12015, 11204, 21, 4827, 576, 1478, 11329, 504, 12013, 12012, 5933, 12016, 4521, 1115, 1370, 12018, 5195, 12019, 10285, 4838, 12020, 12021, 4972, 4795, 4796, 4520, 7520, 1364, 11331, 7705, 4769, 5427, 11332, 12024, 11343, 2]
// Exports: default

// Module 12014 (ForwardModal)
...
import ForwardingAnalyticsUtils from "ForwardingAnalyticsUtils" /* 12013 */;
import ForwardDestinationUtils from "ForwardDestinationUtils" /* 12016 */;
...
let UserRowModes = fn(11204).UserRowModes;
const jsxProd = fn(21);
              ...
              if (arg0 === 1) {
                ...
                if (forwardOptions(source[25])(message, closure_129_1)) {
                  const promise = new Promise((arg0) => {
                    closure_0 = arg0;
                    closure_1_0(5195).openAlert("staff-to-non-staff-forward", closure_1_15(forwardOptions(12019), {
                      onConfirm() {
