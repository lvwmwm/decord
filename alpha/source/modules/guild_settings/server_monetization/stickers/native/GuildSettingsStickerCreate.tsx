...
export default noop.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    let obj9 = stickerId(4731);
    const tmp26 = closure_16;
    const tmp27 = onPressEmoji;
    obj11.articleUrl = tmp14(2111).getArticleURL(uri.STICKERS_UPLOAD);
    obj10.children = intl3.format(stickerId(1115).t.UBj0aX, obj11);
    items2[2] = onPressEmoji(stickerId(4832).Text, obj10);
  ...
  const items4 = [onPressEmoji(stickerId(4832).Text, obj15), , , , , , ];
  ...
  items4[2] = onPressEmoji(stickerId(4832).Text, obj20);
  const obj21 = {
