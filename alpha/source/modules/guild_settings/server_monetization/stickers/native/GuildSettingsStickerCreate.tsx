...
// Dependencies: [5, 32, 19, 17, 5678, 5721, 1074, 1375, 2023, 21, 4757, 576, 7228, 11417, 5817, 4410, 5356, 18027, 10653, 5104, 4753, 1115, 4653, 2108, 5187, 5185, 5341, 10439, 18028, 11392, 7377, 1397, 9042, 6850, 7332, 2]

// Module 18026 (GuildSettingsStickerCreate)
...
export default noop.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    items2[2] = onPressEmoji(stickerId(4753).Text, obj10);
    ...
    obj12.variant = str;
    items2[3] = tmp27(stickerId(5187).Button, obj12);
  ...
  const items4 = [onPressEmoji(stickerId(4753).Text, obj15), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    let tmp32Result = tmp32(tmp14(10439), obj17);
    const tmp14Result4 = tmp14(10439);
  } else if (null != uri) {
    ...
    tmp32Result = tmp32(tmp31(18028).StickerPlusIcon, { size: "lg" });
  }
  ...
  items4[2] = onPressEmoji(stickerId(4753).Text, obj20);
  const obj21 = {
  ...
  if (null != first1) {
    ...
    tmp32Result2 = tmp32(tmp31(9042).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = onPressEmoji(stickerId(4753).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  ...
  items4[4] = onPressEmoji(stickerId(6850).TextInput, obj24);
  ...
  items4[6] = onPressEmoji(stickerId(5187).Button, obj27);
  obj14.children = items4;
  items3[1] = closure_17(stickerId(5185).Stack, obj14);
