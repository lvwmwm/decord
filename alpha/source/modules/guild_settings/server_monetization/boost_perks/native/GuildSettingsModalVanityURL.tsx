...
// Dependencies: [19, 17, 18160, 2064, 9935, 1074, 21, 4827, 576, 5927, 7705, 1115, 18161, 8086, 4823, 18006, 6934, 18162, 1484, 504, 7371, 2]
// Exports: default
...
prototype["render"] = function render() {
  ...
  if (isEditing) {
    ...
    if (tmp17Result) {
      ...
      tmp17Result = tmp17(tmp18(4823).Text, obj11);
    }
