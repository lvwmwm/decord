...
// Dependencies: [5, 19, 17, 2112, 1074, 21, 4836, 576, 504, 17480, 1241, 6735, 6739, 5279, 4832, 1115, 1177, 5281, 17500, 6461, 2]
// Exports: default
...
export default function GuildSettingsModalAnalytics(guildId) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            v3 = 1;
            const obj6 = { value: v1(6735).redirectDeveloperPortalWithHandoffToken(result, v3(6739).LoginHandoffSource.GUILD_ANALYTICS_SETTING), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          v3 = 3;
  ...
  if (null == notice) {
    ...
    if (null != analytics) {
      ...
      const tmp11Result4 = tmp11(17500);
      ...
      const tmp11Result5 = tmp11(17500);
      ...
      items4[3] = tmp9(tmp11(17500), obj12);
      obj8.children = items4;
      tmp7Result = tmp7(tmp2(5279).Stack, obj8);
      const tmp11Result6 = tmp11(17500);
    }
    const obj13 = { children: null };
    items3[4] = tmp7Result;
    obj4.children = items3;
    obj3.children = tmp7(guildId(5279).Stack, obj4);
    const items5 = [tmp9(tmp10, obj3), tmp9(tmp2(6461).NavScrim, {})];
