...
// Dependencies: [32, 19, 17, 4819, 2064, 18124, 1074, 21, 4827, 576, 7274, 1478, 5256, 4559, 1241, 5007, 8624, 5425, 4823, 11101, 1177, 11895, 5271, 1115, 2]
// Exports: default
      ...
      renderItem(item) {
        ...
        if (null != contentPrefaceResult) {
          ...
          if ("" !== contentPrefaceResult) {
            ...
            tmp3Result = tmp3(tmp10(4823).Text, obj6);
          }
        }
