...
// Dependencies: [5, 32, 19, 17, 2060, 2099, 1372, 9935, 18124, 1074, 21, 4827, 5985, 576, 1241, 5007, 4823, 1115, 18122, 504, 38, 4467, 1484, 6953, 5927, 5823, 4520, 18121, 4794, 16693, 1980, 5269, 6934, 5990, 5908, 14959, 1092, 5271, 18128, 18129, 9934, 18130, 7312, 5256, 5265, 7370, 5288, 7331, 2]
// Exports: default
        ...
        if (null != selectedRoleId) {
          if (null != role) {
            if (null != guild) {
              ...
              const merged = Object.assign(tmp13(5007).collectGuildAnalyticsMetadata(guild.id));
