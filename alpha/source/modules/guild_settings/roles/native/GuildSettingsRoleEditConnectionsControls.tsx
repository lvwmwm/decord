...
// Dependencies: [19, 17, 7461, 18148, 1074, 5713, 21, 4829, 576, 5712, 12, 6940, 4825, 1115, 5271, 5427, 2110, 5990, 5993, 18176, 5273, 11556, 4796, 18178, 1980, 18179, 18181, 504, 8951, 18162, 2]
// Exports: default
...
function HeaderSection(arg0) {
  ...
  if (hasConnections) {
    ...
    obj6.children = tmp13(tmp10(4825).Text, obj7);
    tmp13Result = tmp13(tmp10(5427).PressableOpacity, obj6);
  }
...
function AndOrRadios(setPendingRoleConfigurations) {
  ...
  if (ConnectionsUtils.ConnectionConfigurationRuleOperator.OR === ConnectionsUtils.ConnectionConfigurationRuleOperator.AND) {
    ...
    const obj3 = { value: tmp(5712).ConnectionConfigurationRuleOperator.OR, label: null, disabled: null };
    ...
    obj3.disabled = tmp11;
    const items2 = [closure_1_10(tmp(5993).TableRadioRow, obj3), ];
    const obj4 = { value: tmp(5712).ConnectionConfigurationRuleOperator.AND, label: null, disabled: null };
    const intl3 = tmp(1115).intl;
    obj4.label = intl3.string(tmp(1115).t.gHXS9A);
    obj4.disabled = locked;
    items2[1] = closure_1_10(tmp(5993).TableRadioRow, obj4);
    obj2.children = items2;
    return closure_1_11(tmp(5990).TableRadioGroup, obj2);
  }
}
