...
// Dependencies: [5, 19, 17376, 1074, 1375, 21, 504, 4796, 5443, 1475, 17394, 4524, 1115, 17390, 6613, 6565, 4825, 5994, 5912, 10572, 2]
// Exports: default

// Module 17393 (RoleIconActionSheet)
...
export default function RoleIconActionSheet(arg0) {
  ...
  obj5.onPress = function handleSelectEmoji() {
          ...
          if (0 === c7) {
            if (arg0 === 1) {
              ...
              if (null == closure_0.id) {
                ...
                if (null != surrogates) {
                  closure_0(17390).updateRoleIcon(surrogates, null, tmp26);
                  const obj5 = closure_0(17390);
                }
              } else {
                c6 = 1;
                const tmp22 = closure_0(17390);
                closure_4 = tmp22;
                const updateRoleIcon = tmp22.updateRoleIcon;
                closure_2 = surrogates;
                c7 = 2;
                c8 = 1;
                const obj7 = { value: closure_0(17394).fetchCustomEmojiAsPngDataUri(tmp38.id), done: false };
                return obj7;
              }
            }
          } else {
            if (1 === tmp7) {
              ...
              closure_0(4524).presentError(intl.string(closure_0(1115).t.R0RpRX));
    ...
    const result = guildId(10572).openEmojiPickerActionSheet(obj2, "stack");
  };
  ...
  if (stateFromStores) {
    ...
    tmp5Result = closure_7(tmp(5912).TableRow, obj6);
  }
