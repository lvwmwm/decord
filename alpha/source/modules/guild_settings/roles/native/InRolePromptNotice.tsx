...
// Dependencies: [19, 17, 1074, 21, 4757, 576, 1385, 18079, 1177, 9719, 4753, 1115, 2]
// Exports: default
...
export default function InRolePromptNotice(role) {
  ...
  if (!obj.hasFlag(role.flags, RoleFlags.IN_PROMPT)) {
    ...
    if (isRolePowerfulResult) {
      ...
      items1[1] = tmp6(tmp(4753).Text, obj6);
      obj2.children = items1;
      tmp4Result = tmp4(tmp5, obj2);
    }
    isRolePowerfulResult = tmp(18079).isRolePowerful(role);
  }
};
