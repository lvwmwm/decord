...
// Dependencies: [19, 17, 1074, 21, 4827, 576, 1385, 18148, 1177, 9792, 4823, 1115, 2]
// Exports: default
...
export default function InRolePromptNotice(role) {
  ...
  if (!obj.hasFlag(role.flags, RoleFlags.IN_PROMPT)) {
    ...
    if (isRolePowerfulResult) {
      ...
      items1[1] = tmp6(tmp(4823).Text, obj6);
      obj2.children = items1;
      tmp4Result = tmp4(tmp5, obj2);
    }
    isRolePowerfulResult = tmp(18148).isRolePowerful(role);
  }
};
