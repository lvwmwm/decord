...
// Dependencies: [19, 17, 2060, 2064, 1372, 9862, 1074, 21, 4757, 576, 504, 9861, 4753, 1115, 5187, 15076, 7287, 2]
// Exports: default

// Module 18048 (GuildSettingsModalSecurity)
...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items4 = [closure_12(guildId(4753).Text, obj5), , ];
  ...
  obj6.children = closure_12(guildId(5187).Button, obj7);
  ...
  if (hasItem) {
    ...
    tmp17Result = tmp17(tmp2(4753).Text, obj8);
  }
  ...
  const items6 = [closure_12(closure_5, { source: stateFromStores(15076), style: tmp.image, resizeMode: "contain" }), ];
  ...
  obj12.children = closure_12(guildId(4753).Text, obj13);
  items6[1] = closure_12(closure_4, obj12);
  obj10.children = items6;
  items5[1] = closure_13(closure_4, obj10);
  obj3.children = items5;
  const items7 = [closure_13(closure_4, obj3), closure_12(guildId(7287).NavScrim, {})];
