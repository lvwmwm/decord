...
// Dependencies: [19, 4462, 9935, 1074, 21, 4827, 576, 8998, 9934, 5990, 1115, 2108, 7531, 4533, 5927, 7705, 5988, 15174, 5991, 4823, 8947, 5269, 7371, 1484, 504, 2]
// Exports: default
...
function GuildSettingsOwnerConfiguredContentLevel(guild) {
  ...
  if (!userIsTeen) {
    ...
    obj5.disabled = tmp7;
    obj2.children = closure_1_10(tmp3(7531).TableSwitchRow, obj5);
    tmp9 = closure_1_10(tmp3(5990).TableRowGroup, obj2, "filter-section");
  }
  return tmp9;
}
