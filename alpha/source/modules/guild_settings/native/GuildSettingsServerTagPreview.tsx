...
// Dependencies: [5, 32, 19, 17, 1372, 8292, 21, 4829, 576, 504, 4981, 1397, 14281, 4825, 1115, 5271, 10506, 10097, 14282, 14326, 5273, 5912, 2]
// Exports: default
...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  let obj = guildId(504);
  const name = onAdopted(4981).useName(guildId, null, stateFromStores);
  let obj3 = onAdopted(4981);
  let avatarURL;
  ...
  const items2 = [closure_10(guildId(4825).Text, obj2), ];
  ...
  items5[1] = closure_10(guildId(4825).Text, obj9);
  ...
  const items8 = [closure_10(guildId(4825).Text, { variant: "text-md/semibold", color: "text-default", children: name }), ];
  ...
  if (tmp15Result3) {
    ...
    if (null != badge) {
      ...
      tmp15Result = tmp15(tmp2(14282).GuildBadge, size);
    }
    obj14.guildBadge = tmp15Result;
    tmp15Result3 = tmp15(tmp2(10097).BaseGuildTagChiplet, obj14);
  }
  ...
  items9[1] = closure_10(guildId(4825).Text, obj15);
  ...
  const items11 = [closure_10(tmp18, { source: onAdopted(14326), style: tmp.avatar, importantForAccessibility: "no" }), ];
  ...
  items12[1] = closure_10(guildId(4825).Text, obj20);
  ...
  if ("plain" !== variant) {
    ...
    tmp15Result4 = tmp15(tmp2(5912).Card, obj23);
  }
  return tmp15Result4;
};
