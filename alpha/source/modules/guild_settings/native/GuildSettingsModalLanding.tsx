...
// Dependencies: [19, 4394, 2064, 4396, 1372, 16493, 9862, 1074, 21, 4937, 4757, 5824, 1115, 4711, 4401, 17935, 15239, 9864, 9146, 17937, 4699, 5906, 9042, 10376, 11997, 5309, 9846, 17938, 9555, 5757, 9553, 15883, 10649, 4458, 576, 1484, 504, 9861, 17940, 7504, 7511, 4454, 8876, 5185, 17331, 1397, 17941, 7287, 2]
// Exports: default
...
function SettingsSection(guild) {
  ...
  if (canManageGuild) {
    ...
    obj6.icon = tmp(tmp2(5824).TableRow.Icon, obj7);
    obj6.onPress = function onPress() {
      return importDefault(constants2.INTEGRATIONS);
    };
    items.push(tmp(tmp2(5824).TableRow, obj6, "integrations"));
  }
  ...
  if (tmp2Result.canUseMobileServerTagSettings(guild.id)) {
    ...
    obj8.icon = tmp(tmp2(5824).TableRow.Icon, obj9);
    obj8.onPress = function onPress() {
      return importDefault(constants2.TAG);
    };
    items.push(tmp(tmp2(5824).TableRow, obj8, "server-tag"));
  }
  if (isGuildAdmin) {
  ...
  if (isGuildAdmin) {
    ...
    obj10.icon = tmp(tmp2(5824).TableRow.Icon, obj11);
    obj10.onPress = function onPress() {
      return importDefault(constants2.VANITY_URL);
    };
    items.push(tmp(tmp2(5824).TableRow, obj10, "vanity"));
  }
  let tmpResult = null;
  if (0 !== items.length) {
    ...
    tmpResult = tmp(tmp2(5906).TableRowGroup, obj12);
  }
  return tmpResult;
}
...
function PeopleSection(pushScreen) {
  ...
  if (canManageRoles) {
    ...
    obj3.icon = tmp(tmp2(5824).TableRow.Icon, obj4);
    obj3.onPress = function onPress() {
      return pushScreen(constants2.ROLES);
    };
    items.push(tmp(tmp2(5824).TableRow, obj3, "roles"));
  }
  if (canManageGuild) {
    const obj5 = { label: null, arrow: true, icon: null, onPress: null };
    const intl3 = tmp2(1115).intl;
    ...
    obj5.icon = tmp(tmp2(5824).TableRow.Icon, obj6);
    obj5.onPress = function onPress() {
      return pushScreen(constants2.INSTANT_INVITES);
    };
    items.push(tmp(tmp2(5824).TableRow, obj5, "invites"));
  }
  const obj7 = { title: null, hasIcons: true, children: null };
  const intl4 = tmp2(1115).intl;
...
function CommunitySection(pushScreen) {
  ...
  if (!canManageGuild) {
    ...
    if (hasItem) {
      ...
      obj.icon = tmp2(tmp3(5824).TableRow.Icon, obj6);
      obj.onPress = function onPress() {
...
function GuildSettingsModalLandingInner(guild) {
  ...
  if (canManageGuildRoleSubscriptions) {
    ...
    tmp17Result = tmp17(tmp3(17941), obj11);
  }
