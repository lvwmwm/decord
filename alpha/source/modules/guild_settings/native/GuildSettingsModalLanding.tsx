...
// Dependencies: [19, 4462, 2066, 4464, 1372, 16569, 9940, 1074, 21, 5009, 4829, 5910, 1115, 4783, 4469, 18027, 15300, 9942, 9221, 18029, 4771, 5992, 9117, 10460, 12081, 5395, 9924, 18030, 9632, 5843, 9630, 15951, 10730, 4526, 576, 1484, 504, 9939, 18032, 7590, 7597, 4522, 8951, 5271, 17423, 1397, 18033, 7373, 2]
// Exports: default
...
function SettingsSection(guild) {
  ...
  if (canManageGuild) {
    ...
    obj6.icon = tmp(tmp2(5910).TableRow.Icon, obj7);
    obj6.onPress = function onPress() {
      return importDefault(constants2.INTEGRATIONS);
    };
    items.push(tmp(tmp2(5910).TableRow, obj6, "integrations"));
  }
  ...
  if (tmp2Result.canUseMobileServerTagSettings(guild.id)) {
    ...
    obj8.icon = tmp(tmp2(5910).TableRow.Icon, obj9);
    obj8.onPress = function onPress() {
      return importDefault(constants2.TAG);
    };
    items.push(tmp(tmp2(5910).TableRow, obj8, "server-tag"));
  }
  if (isGuildAdmin) {
  ...
  if (isGuildAdmin) {
    ...
    obj10.icon = tmp(tmp2(5910).TableRow.Icon, obj11);
    obj10.onPress = function onPress() {
      return importDefault(constants2.VANITY_URL);
    };
    items.push(tmp(tmp2(5910).TableRow, obj10, "vanity"));
  }
  let tmpResult = null;
  if (0 !== items.length) {
    ...
    tmpResult = tmp(tmp2(5992).TableRowGroup, obj12);
  }
  return tmpResult;
}
...
function PeopleSection(pushScreen) {
  ...
  if (canManageRoles) {
    ...
    obj3.icon = tmp(tmp2(5910).TableRow.Icon, obj4);
    obj3.onPress = function onPress() {
      return pushScreen(constants2.ROLES);
    };
    items.push(tmp(tmp2(5910).TableRow, obj3, "roles"));
  }
  if (canManageGuild) {
    const obj5 = { label: null, arrow: true, icon: null, onPress: null };
    const intl3 = tmp2(1115).intl;
    ...
    obj5.icon = tmp(tmp2(5910).TableRow.Icon, obj6);
    obj5.onPress = function onPress() {
      return pushScreen(constants2.INSTANT_INVITES);
    };
    items.push(tmp(tmp2(5910).TableRow, obj5, "invites"));
  }
  const obj7 = { title: null, hasIcons: true, children: null };
  const intl4 = tmp2(1115).intl;
...
function CommunitySection(pushScreen) {
  ...
  if (!canManageGuild) {
    ...
    if (hasItem) {
      ...
      obj.icon = tmp2(tmp3(5910).TableRow.Icon, obj6);
      obj.onPress = function onPress() {
...
function GuildSettingsModalLandingInner(guild) {
  ...
  if (canManageGuildRoleSubscriptions) {
    ...
    tmp17Result = tmp17(tmp3(18033), obj11);
  }
