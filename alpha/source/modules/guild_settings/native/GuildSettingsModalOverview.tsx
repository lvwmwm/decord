...
// Dependencies: [19, 2060, 2042, 4394, 4676, 4396, 4406, 1372, 9862, 1074, 21, 4757, 576, 1115, 4467, 4454, 5843, 7622, 9861, 11596, 1385, 7441, 5110, 5206, 6850, 4910, 5906, 5824, 8254, 17769, 7472, 7447, 5904, 5907, 16507, 2108, 17947, 1397, 11614, 1177, 7332, 5768, 8876, 5185, 7287, 1484, 504, 2]
// Exports: default
...
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  if (hasFlagResult) {
    ...
    hasFlagResult = tmp17(tmp(7447).TableSwitchRow, obj8);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = tmp17(tmp(7447).TableSwitchRow, obj9);
  ...
  if (result1) {
    ...
    result1 = tmp17(tmp(7447).TableSwitchRow, obj10);
  ...
  if (guildSpaceExperimentEnabled) {
    ...
    guildSpaceExperimentEnabled = tmp17(tmp(5824).TableRow, obj11);
  }
  items[8] = guildSpaceExperimentEnabled;
  obj2.children = items;
  return tmp16(tmp(5906).TableRowGroup, obj2);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  if (obj.getMobileBoostProgressBarEnabled("GuildSettingsModalOverview")) {
    ...
    obj2.children = closure_1_20(tmp(7447).TableSwitchRow, obj3);
    tmp3 = closure_1_20(tmp(5906).TableRowGroup, obj2);
  }
  return tmp3;
};
...
prototype["renderSummaries"] = function renderSummaries() {
  ...
  if (obj.canGuildUseConversationSummaries(guild, false)) {
    ...
    obj4.children = closure_1_20(tmp(7447).TableSwitchRow, obj5);
    return closure_1_20(tmp(5906).TableRowGroup, obj4);
  } else {
    return null;
  }
