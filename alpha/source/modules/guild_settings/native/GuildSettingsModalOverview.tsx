...
// Dependencies: [19, 2062, 2044, 4464, 4750, 4466, 4476, 1372, 9038, 1074, 21, 4829, 576, 1115, 4537, 4524, 5931, 6790, 9037, 10858, 1385, 6610, 5197, 5293, 6019, 4982, 5994, 5912, 7429, 17087, 6641, 6616, 5992, 5995, 15763, 2110, 17267, 1397, 10876, 1177, 6501, 5856, 8045, 5272, 6456, 1484, 504, 2]
// Exports: default
...
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  if (hasFlagResult) {
    ...
    hasFlagResult = tmp17(tmp(6616).TableSwitchRow, obj8);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = tmp17(tmp(6616).TableSwitchRow, obj9);
  ...
  if (result1) {
    ...
    result1 = tmp17(tmp(6616).TableSwitchRow, obj10);
  ...
  if (guildSpaceExperimentEnabled) {
    ...
    guildSpaceExperimentEnabled = tmp17(tmp(5912).TableRow, obj11);
  }
  items[8] = guildSpaceExperimentEnabled;
  obj2.children = items;
  return tmp16(tmp(5994).TableRowGroup, obj2);
};
...
prototype["renderBoostProgressBar"] = function renderBoostProgressBar() {
  ...
  if (obj.getMobileBoostProgressBarEnabled("GuildSettingsModalOverview")) {
    ...
    obj2.children = closure_1_20(tmp(6616).TableSwitchRow, obj3);
    tmp3 = closure_1_20(tmp(5994).TableRowGroup, obj2);
  }
  return tmp3;
};
...
prototype["renderSummaries"] = function renderSummaries() {
  ...
  if (obj.canGuildUseConversationSummaries(guild, false)) {
    ...
    obj4.children = closure_1_20(tmp(6616).TableSwitchRow, obj5);
    return closure_1_20(tmp(5994).TableRowGroup, obj4);
  } else {
    return null;
  }
