...
// Dependencies: [19, 17, 2062, 2102, 2107, 2101, 2066, 4466, 1372, 11301, 1074, 21, 4829, 576, 4471, 12, 5911, 11302, 5912, 1115, 5994, 4537, 6790, 5931, 4675, 4825, 8733, 4453, 8045, 5272, 1177, 6019, 11303, 11304, 4524, 11309, 1484, 504, 38, 8698, 6724, 6456, 11314, 11316, 5905, 6416, 2]
// Exports: default
...
prototype["render"] = function render() {
  ...
  if (null == member) {
    ...
    if (user.bot) {
      ...
      tmp17Result = tmp17(tmp20(8733), obj);
      const tmp20Result = tmp20(8733);
    }
    items[1] = tmp17Result;
    obj2.children = items;
    if (null == member) {
      ...
      if (!bot) {
        ...
        obj4.children = tmp17(tmp18(5912).TableRow, obj5);
        tmp17Result3 = tmp17(tmp18(5994).TableRowGroup, obj4);
      }
      ...
      obj9.label = tmp6;
      obj8.children = tmp17(tmp18(5912).TableRow, obj9);
      const items2 = [tmp17(tmp18(5994).TableRowGroup, obj8), , , , , , ];
      if (!canChangeNick) {
      ...
      if (canChangeNick) {
        ...
        canChangeNick = tmp17(tmp18(6019).TextInput, obj11);
      }
      ...
      if (canKick) {
        ...
        const obj15 = { user: tmp20(4675).getName(user) };
        obj14.label = intl5.formatToPlainString(tmp18(1115).t.yOiJHB, obj15);
        obj14.onPress = self.handleKick;
        obj13.children = tmp17(tmp18(5912).TableRow, obj14);
        canKick = tmp17(tmp18(5994).TableRowGroup, obj13);
        const tmp20Result5 = tmp20(4675);
      }
      items2[4] = canKick;
      if (canBan) {
        ...
        const obj20 = { user: tmp20(4675).getName(user) };
        obj19.label = intl6.formatToPlainString(tmp18(1115).t.TuAZuW, obj20);
        obj19.onPress = self.handleBan;
        obj18.children = tmp17(tmp18(5912).TableRow, obj19);
        canBan = tmp17(tmp18(5994).TableRowGroup, obj18);
        const tmp20Result6 = tmp20(4675);
      }
      items2[5] = canBan;
      items2[6] = tmp17Result3;
      obj7.children = items2;
      obj6.children = tmp15(tmp18(5272).Stack, obj7);
      return tmp17(tmp18(8045).Form, obj6);
    } else {
      const result = tmp18(4453).isMemberCommunicationDisabled(member);
      const TableRowGroup = tmp18(5994).TableRowGroup;
      const obj21 = { hasIcons: false, children: null };
      const TableRow = tmp18(5912).TableRow;
      ...
      if (result) {
        const obj23 = { user: tmp20(4675).getName(user) };
        ...
        const tmp20Result7 = tmp20(4675);
      } else {
        const obj24 = { user: tmp20(4675).getName(user) };
        ...
        const tmp20Result8 = tmp20(4675);
      }
      const tmp18Result = tmp18(4453);
    }
    tmp15 = closure_1_19;
  }
};
