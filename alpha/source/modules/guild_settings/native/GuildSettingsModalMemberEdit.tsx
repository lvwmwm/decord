...
prototype["render"] = function render() {
  ...
  if (null == member) {
    ...
    if (null == member) {
      ...
      if (result) {
        const obj23 = { user: tmp20(4678).getName(user) };
        ...
        const tmp20Result7 = tmp20(4678);
      } else {
        const obj24 = { user: tmp20(4678).getName(user) };
        ...
        const tmp20Result8 = tmp20(4678);
      }
      const tmp18Result = tmp18(4456);
    }
    tmp15 = closure_1_19;
  }
};
