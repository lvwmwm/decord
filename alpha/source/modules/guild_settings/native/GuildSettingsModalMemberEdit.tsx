...
// Dependencies: [19, 17, 2060, 2100, 2105, 2099, 2064, 4396, 1372, 12095, 1074, 21, 4757, 576, 4401, 12, 5823, 12096, 5824, 1115, 5906, 4467, 7622, 5843, 4601, 4753, 9558, 4383, 8876, 5185, 1177, 6850, 12097, 12098, 4454, 12103, 1484, 504, 38, 9523, 7555, 7287, 12108, 12110, 5817, 7247, 2]
// Exports: default

// Module 12094 (GuildSettingsModalMemberEdit)
...
import GuildSettingsModalMembersActionCreatorsDefault from "GuildSettingsModalMembersActionCreators" /* 12097 */;
...
import GuildSettingsModalMembersStore from "GuildSettingsModalMembersStore" /* 12095 */;
...
prototype["updateNavigator"] = function updateNavigator(submitting) {
  ...
  if (!tmp) {
    if (submitting) {
      ...
      fn = self(5843).getHeaderCloseButton(onClose);
      let obj = self(5843);
    }
...
prototype["render"] = function render() {
  ...
  if (null == member) {
    ...
    if (user.bot) {
      ...
      tmp17Result = tmp17(tmp20(9558), obj);
      const tmp20Result = tmp20(9558);
    }
    items[1] = tmp17Result;
    obj2.children = items;
    if (null == member) {
      ...
      if (!bot) {
        ...
        obj4.children = tmp17(tmp18(5824).TableRow, obj5);
        tmp17Result3 = tmp17(tmp18(5906).TableRowGroup, obj4);
      }
      ...
      obj9.label = tmp6;
      obj8.children = tmp17(tmp18(5824).TableRow, obj9);
      const items2 = [tmp17(tmp18(5906).TableRowGroup, obj8), , , , , , ];
      if (!canChangeNick) {
      ...
      if (canChangeNick) {
        ...
        canChangeNick = tmp17(tmp18(6850).TextInput, obj11);
      }
      ...
      if (canKick) {
        ...
        const obj15 = { user: tmp20(4601).getName(user) };
        obj14.label = intl5.formatToPlainString(tmp18(1115).t.yOiJHB, obj15);
        obj14.onPress = self.handleKick;
        obj13.children = tmp17(tmp18(5824).TableRow, obj14);
        canKick = tmp17(tmp18(5906).TableRowGroup, obj13);
        const tmp20Result5 = tmp20(4601);
      }
      items2[4] = canKick;
      if (canBan) {
        ...
        const obj20 = { user: tmp20(4601).getName(user) };
        obj19.label = intl6.formatToPlainString(tmp18(1115).t.TuAZuW, obj20);
        obj19.onPress = self.handleBan;
        obj18.children = tmp17(tmp18(5824).TableRow, obj19);
        canBan = tmp17(tmp18(5906).TableRowGroup, obj18);
        const tmp20Result6 = tmp20(4601);
      }
      items2[5] = canBan;
      items2[6] = tmp17Result3;
      obj7.children = items2;
      obj6.children = tmp15(tmp18(5185).Stack, obj7);
      return tmp17(tmp18(8876).Form, obj6);
    } else {
      const result = tmp18(4383).isMemberCommunicationDisabled(member);
      const TableRowGroup = tmp18(5906).TableRowGroup;
      const obj21 = { hasIcons: false, children: null };
      const TableRow = tmp18(5824).TableRow;
      ...
      if (result) {
        const obj23 = { user: tmp20(4601).getName(user) };
        ...
        const tmp20Result7 = tmp20(4601);
      } else {
        const obj24 = { user: tmp20(4601).getName(user) };
...
GuildSettingsModalMemberEdit.contextType = fn(4467).ThemeContext;
const size = fn(2);
...
export default function MemberModalEdit(onClose) {
  ...
  const tmp = onRemove(5817)(guildId);
  closure_2 = tmp;
    ...
    return {
      ...
      [closure_2_17.MEMBER_KICK]: {
        ...
        render(arg0) {
          ...
          obj.guildId = guildId;
          obj.onKick = onKick;
          return closure_2_18(onRemove(12108), obj);
        }
      },
      [closure_2_17.MEMBER_BAN]: {
        ...
        render(arg0) {
          ...
          obj.guildId = guildId;
          obj.onBan = onBan;
          return closure_2_18(onRemove(12110), obj);
        }
      }
    };
  }, items);
  ...
  return closure_18(onClose(7247).Navigator, obj);
};
