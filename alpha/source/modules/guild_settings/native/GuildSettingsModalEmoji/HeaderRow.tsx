...
// Function ID: 17336
// Name: HeaderRow
// Dependencies: [5, 32, 19, 17, 17329, 1074, 1375, 21, 4829, 576, 8941, 9786, 1241, 1115, 1255, 5443, 5274, 4825, 504, 2]
// Exports: ConnectedHeaderRow

// Module 17335 (HeaderRow)
...
import GuildSettingsEmojiStore from "GuildSettingsEmojiStore" /* 17329 */;
...
function HeaderRow(guild) {
            ...
            if (arg0 === 1) {
              ...
              if (null != base64) {
                upload = function upload(image, originalMd5, roles) {
                  ...
                  const uploadEmojiResult = closure_1_0(9786).uploadEmoji({ guildId: image.id, image, name: combined, roles, originalMd5 });
                  closure_1_0(9786).uploadEmoji({ guildId: image.id, image, name: combined, roles, originalMd5 }).then(() => closure_2_1(1241).track(constants.EMOJI_UPLOAD_COMPLETED, { guild_id: image.id, upload_id })).catch((error) => {
  ...
  if (canCreateExpressions) {
    ...
    canCreateExpressions = tmp13(tmp7(5274).Button, obj8);
  }
