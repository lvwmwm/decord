...
// Dependencies: [32, 19, 17, 2066, 18101, 21, 12, 10682, 4829, 576, 1115, 5769, 4722, 504, 9843, 4825, 18103, 18107, 1177, 18108, 5882, 7373, 1484, 5929, 2]
// Exports: computeSectionItem, default

// Module 18100 (GuildSettingsModalEmoji)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import native from "native" /* 1177 */;
import Text_Text from "Text/Text" /* 4825 */;
import RoleSubscriptionEmojiUtils from "RoleSubscriptionEmojiUtils" /* 5769 */;
import GuildSettingsModalEmoji_EmojiRow from "GuildSettingsModalEmoji/EmojiRow" /* 18103 */;
import HeaderRow from "HeaderRow" /* 18107 */;
import EmptyServerSettingsEmoji from "EmptyServerSettingsEmoji" /* 18108 */;
...
let apply = apply_mod;
let closure_12 = apply.throttle(fn(10682).fetchEmoji, 1000);
