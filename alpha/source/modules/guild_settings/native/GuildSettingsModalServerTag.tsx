...
// Dependencies: [5, 32, 19, 17, 9914, 2064, 9935, 1074, 8288, 21, 4827, 576, 1484, 9937, 504, 9915, 8509, 9916, 9934, 4520, 1115, 12819, 4719, 5927, 7705, 1485, 5194, 1177, 7370, 10109, 4823, 5990, 7531, 5908, 5269, 14273, 8947, 14271, 18102, 2]
// Exports: default

// Module 18101 (GuildSettingsModalServerTag)
...
export default function GuildSettingsModalServerTag(guildId) {
  ...
  const result = guildId(9937).canUseMobileServerTagSettings(guildId);
  dependencyMap = result;
  let obj2 = guildId(9937);
  const items = [result1];
  ...
  if (guildSupportsTagsResult) {
    guildSupportsTagsResult = tmp2(8509).guildSupportsTags(stateFromStores);
  ...
  result1 = guildId(9937).isServerTagDraftDirty(stateFromStores1, stateFromStores2);
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
              ...
              if (!ref.current) {
                if (closure_9) {
                  if (dependencyMap) {
                    ...
                    dependencyMap = 1;
                    c3 = 1;
                    const obj7 = { value: tmp2(9916).saveGuildProfile(guildId, { tag: null, badge: null, badgeColorPrimary: null, badgeColorSecondary: null }), done: false };
                    return obj7;
                  }
                }
              }
          ...
          tmp2(4520).presentError(intl.string(tmp2(1115).t.RTSuVn));
          const obj = tmp2(4520);
        }
        c3 = 3;
      } catch (tmp27) {
  ...
  const effect2 = obj7.useEffect(() => {
    if (c2) {
      if (closure_12) {
        if (c7) {
          let obj = {
            headerRight: first ? (() => closure_1_13(guildId(5927).HeaderSubmittingIndicator, {})) : (() => {
                    const obj = { text: null, onPress: null, disabled: null };
                    const intl = guildId(1115).intl;
                    obj.text = intl.string(guildId(1115).t["R3BPH+"]);
                    obj.onPress = onPress;
                    obj.disabled = !closure_1_9;
                    return closure_13(guildId(7705).HeaderActionButton, obj);
                  })
          };
  ...
  const tmp2Result3 = guildId(9937);
  let tmp26 = result1;
  if (result1) {
    tmp26 = !first;
  }
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return closure_13(navigation(10109), obj8);
      } else if (null == stateFromStores1) {
        return closure_13(tmp2(7370).SceneLoadingIndicator, {});
      } else {
        let tmp29;
        if (tmp14) {
          if (null != stateFromStores1.tag) {
            if ("" !== stateFromStores1.tag) {
              ...
              tmp29 = closure_13(tmp2(4823).Text, obj9);
            }
          }
        }
        ...
        const items11 = [closure_13(tmp2(7531).TableSwitchRow, obj11), ];
        ...
        if (null != tmp29) {
          ...
          if (tmp32Result) {
            ...
            tmp32Result = tmp32(tmp2(14273).GuildBadge, size);
          }
          const items12 = [tmp32Result, tmp29];
          obj13.children = items12;
          tmp31Result = tmp31(tmp2(5269).Stack, obj13);
        }
        obj12.trailing = tmp31Result;
        items11[1] = closure_13(tmp2(5908).TableRow, obj12);
        obj10.children = items11;
        const tmp31Result2 = closure_14(tmp2(5990).TableRowGroup, obj10);
        ...
        if (guildSupportsTagsResult) {
          ...
          const items14 = [tmp32(tmp2(4823).Text, obj17), tmp31Result2, , ];
          ...
          items14[2] = tmp32(tmp2(4823).Text, obj18);
          ...
          items14[3] = tmp32(tmp39(14271), obj19);
          obj15.children = items14;
          let tmp40 = obj15;
        } else {
          const obj20 = { guildId, onUnlockPress: callback2 };
          const items15 = [tmp32(tmp39(18102), obj20), tmp31Result2];
          obj15.children = items15;
          tmp40 = obj15;
        }
        obj14.children = closure_14(tmp2(5269).Stack, tmp40);
        return closure_13(tmp2(8947).Form, obj14);
      }
    } else {
      return closure_13(tmp2(7370).SceneLoadingIndicator, {});
    }
