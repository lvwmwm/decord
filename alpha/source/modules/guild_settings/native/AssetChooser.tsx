...
// Function ID: 17948
// Name: AssetChooser
// Dependencies: [5, 19, 17, 1074, 21, 4757, 576, 4467, 5356, 5341, 1115, 17948, 17949, 1177, 2]

// Module 17947 (AssetChooser)
...
prototype["render"] = function render() {
  ...
  if (!disabled) {
    ...
    const obj4 = { style: tmp.uploadIcon, source: _modDef17949 };
...
AssetChooser.contextType = fn(4467).ThemeContext;
size = fn(2);
