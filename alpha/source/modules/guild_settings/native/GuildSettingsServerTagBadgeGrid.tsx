...
// Dependencies: [19, 17, 8288, 21, 576, 4827, 18106, 12819, 5269, 4823, 1115, 18107, 18108, 14273, 7540, 2]
// Exports: default
...
export default function GuildSettingsServerTagBadgeGrid(guildId) {
  ...
  if (tmp6Result) {
    ...
    items2[1] = tmp8(tmp7(4823).Text, obj6);
    const obj7 = { size: "md", color: nativeDefault.colors.ICON_SUBTLE };
    items2[2] = tmp8(tmp7(7540).ChevronSmallRightIcon, obj7);
