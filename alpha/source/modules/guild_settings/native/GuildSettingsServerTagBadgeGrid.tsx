...
// Dependencies: [19, 17, 7381, 21, 576, 4829, 17357, 11957, 5272, 4825, 1115, 17358, 17359, 13443, 6625, 2]
// Exports: default
...
export default function GuildSettingsServerTagBadgeGrid(guildId) {
  ...
  if (tmp6Result) {
    ...
    items2[1] = tmp8(tmp7(4825).Text, obj6);
    const obj7 = { size: "md", color: nativeDefault.colors.ICON_SUBTLE };
    items2[2] = tmp8(tmp7(6625).ChevronSmallRightIcon, obj7);
