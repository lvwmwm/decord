...
// Function ID: 10325
// Name: ActivityStatus
// Dependencies: [19, 17, 4869, 4476, 1372, 10325, 1074, 21, 4829, 504, 10326, 10327, 10328, 10329, 10334, 10335, 10340, 10342, 10333, 2]
// Exports: default

// Module 10324 (ActivityStatus)
...
const DOT_UNICODE = fn(10325).DOT_UNICODE;
...
export default function ActivityStatus(guildId) {
  ...
  const voiceChannel = stateFromStores1(10327)({ userId, guildId: guildId.guildId }).voiceChannel;
  ...
  const tmp6 = stateFromStores1(10326)(userId);
  let state;
  if (memo != null) {
    state = memo.state;
  }
  const gameMentionsAsPlainText = userId(10328).useGameMentionsAsPlainText(state);
  const obj3 = userId(10328);
  ...
  if (tmp2Result.useStateFromStores(items3, () => RelationshipStore.isBlockedOrIgnored(userId))) {
    ...
    if (null != tmp6) {
      let found;
      if (stateFromStores1 != null) {
        found = stateFromStores1.find(tmp5(10334));
      }
      ...
      obj4.hideIcon = tmp12;
      obj4.hideText = tmp13;
      let tmp18Result = closure_10(tmp5(10329), obj4);
      const tmp5Result = tmp5(10329);
    } else {
      let found1;
      if (stateFromStores1 != null) {
      ...
      if (null != found1) {
        ...
        obj5.hideIcon = tmp12;
        obj5.hideText = tmp13;
        tmp18Result = closure_10(tmp5(10335), obj5);
      } else {
        tmp18Result = null;
        if (null != voiceChannel) {
          ...
          obj6.hideIcon = tmp12;
          obj6.hideText = tmp13;
          tmp18Result = closure_10(tmp5(10340), obj6);
        }
      }
    }
    let tmp21 = null;
    if (null != memo) {
      ...
      if (null != memo) {
        ...
        if (tmp25) {
          ...
          tmp25 = closure_10(tmp5(10342), obj7);
        }
        const items7 = [tmp25, ];
        ...
        if (tmp27) {
          ...
          tmp27 = closure_10(tmp5(10333), obj8);
        }
    ...
    if (tmp31) {
      ...
      tmp31 = closure_10(tmp5(10333), obj11);
    }
    items8[1] = tmp31;
    items8[2] = tmp21;
