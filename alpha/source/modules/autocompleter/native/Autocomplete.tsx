...
export default {
  ...
  Game(game) {
    ...
    if (obj2.isNullOrEmpty(tmp4)) {
      ...
      let tmp6Result = tmp6(tmp5(8021).UnknownGameIcon, obj3);
      let tmp8 = tmp6;
    } else {
  ...
  Timestamp(description) {
    ...
    if (null != result) {
      ...
      const obj4 = { text: str };
      obj2.trailing = React7(tmp(5926).TableRowTrailingText, obj4);
      tmp5Result = tmp5(tmp(5917).TableRow, obj2);
    }
    return tmp5Result;
  }
};
