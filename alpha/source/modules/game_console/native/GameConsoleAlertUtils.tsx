...
// Dependencies: [19, 1992, 9439, 1074, 21, 4649, 2028, 1115, 5196, 10140, 9422, 2]

// Module 10139 (game_console/GameConsoleAlertUtils)
...
require = fn;
let closure_4 = fn(9439).GAME_CONSOLE_ALERT_MODAL_LOCATION;
...
export default {
        ...
        if (null == obj[XBOX]) {
          ...
          resolved = new Promise((arg0) => {
            ...
            obj2.onConfirm = function onConfirm() {
              const result = closure_0(4649).UNSAFE_markDismissibleContentAsDismissed(closure_0(2028).DismissibleContent.CONSOLE_PTT_DISABLE_ALERT);
              closure_0();
            };
  ...
  showSelfDismissableAlert(reconnectPlatformType) {
    ...
    obj2.body = jsx(reconnectPlatformType(10140).SelfDismissibleAlertBody, { body, errorCodeMessage, dismissCallback: actions_AlertActionCreatorsDefault.close });
    obj2.onConfirm = function onConfirm() {
