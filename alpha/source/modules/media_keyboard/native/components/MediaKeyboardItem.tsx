...
// Dependencies: [19, 17, 5105, 10915, 21, 4493, 4757, 576, 4606, 1177, 10662, 4753, 504, 5354, 10916, 1115, 5387, 5356, 10917, 10918, 4758, 1478, 10919, 5307, 10374, 2]
// Exports: isAttachFilesNode, isMediaCameraNode, isSpecialMediaGridNode, isViewAllPhotosNode

// Module 10914 (MediaKeyboardItem)
...
function NewCaption(arg0) {
  ...
  obj.style = items;
  const items1 = [React7(native.Icon, { source: _modDef10662, style: tmp.icon }), React7(Text_Text.Text, { style: textStyle, color: "text-overlay-light", variant: "text-xs/bold", children: label })];
  obj.children = items1;
...
const DeviceConstants = fn(10915);
