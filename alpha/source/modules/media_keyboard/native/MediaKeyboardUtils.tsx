...
// Dependencies: [5, 1184, 2042, 5190, 2096, 5189, 1608, 1074, 5036, 5430, 9498, 5438, 5440, 5441, 1241, 5452, 1364, 4806, 10978, 1110, 11003, 5265, 11568, 11569, 12, 2]
                ...
                const obj11 = {
                  value: Promise.all(Array.from(closure_129_6).map((() => {
                                  closure_0 = closure_1_3(function*(arg0) {
                                    ...
                                    closure_132_2 = yield closure_0(5440).getImageDimensionsIfMissing(uri, undefined, undefined, c1);
