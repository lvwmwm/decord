...
// Dependencies: [5, 1184, 2044, 5192, 2098, 5191, 1608, 1074, 5038, 5432, 9502, 5440, 5442, 5443, 1241, 5454, 1364, 4808, 10984, 1110, 11009, 5267, 11574, 11575, 12, 2]
                ...
                const obj11 = {
                  value: Promise.all(Array.from(closure_129_6).map((() => {
                                  closure_0 = closure_1_3(function*(arg0) {
                                    ...
                                    closure_132_2 = yield closure_0(5442).getImageDimensionsIfMissing(uri, undefined, undefined, c1);
