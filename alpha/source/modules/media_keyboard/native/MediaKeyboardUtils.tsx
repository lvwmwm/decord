...
// Dependencies: [5, 1184, 2044, 5193, 2098, 5192, 1608, 1074, 5038, 5433, 8600, 5441, 5443, 5444, 1241, 5455, 1364, 4808, 10088, 1110, 10113, 5268, 10779, 10780, 12, 2]
                ...
                const obj11 = {
                  value: Promise.all(Array.from(closure_129_6).map((() => {
                                  closure_0 = closure_1_3(function*(arg0) {
                                    ...
                                    closure_132_2 = yield closure_0(5443).getImageDimensionsIfMissing(uri, undefined, undefined, c1);
