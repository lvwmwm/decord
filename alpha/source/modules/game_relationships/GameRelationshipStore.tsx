...
// Dependencies: [4472, 1074, 4457, 504, 573, 2]

// Module 7979 (GameRelationshipStore)
...
const secondaryIndexMap = new fn(4457).SecondaryIndexMap(function gameRelationshipsIndex(arg0) {
  const items = [];
