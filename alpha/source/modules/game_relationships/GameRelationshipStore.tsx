...
// Dependencies: [4476, 1074, 4461, 504, 573, 2]

// Module 7066 (GameRelationshipStore)
...
const secondaryIndexMap = new fn(4461).SecondaryIndexMap(function gameRelationshipsIndex(arg0) {
  const items = [];
