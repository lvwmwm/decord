...
// Dependencies: [4474, 1074, 4459, 504, 573, 2]

// Module 7981 (GameRelationshipStore)
...
const secondaryIndexMap = new fn(4459).SecondaryIndexMap(function gameRelationshipsIndex(arg0) {
  const items = [];
