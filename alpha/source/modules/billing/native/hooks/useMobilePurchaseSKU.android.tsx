...
// Dependencies: [5, 19, 7754, 1372, 1074, 7571, 3, 11051, 5903, 1241, 573, 7759, 4498, 2010, 11166, 1255, 2]
// Exports: default

// Module 11165 (useMobilePurchaseSKU)
...
const require = fn;
let closure_5 = fn(7754).useNativeCheckoutStoreOrNull;
