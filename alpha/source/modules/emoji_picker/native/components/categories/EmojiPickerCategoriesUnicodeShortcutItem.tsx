...
// Dependencies: [32, 19, 17, 1074, 21, 4757, 4493, 9670, 5341, 1115, 10614, 2]
// Exports: default

// Module 10625 (EmojiPickerCategoriesUnicodeShortcutItem)
  ...
  const fn2 = function b(end, current) {
    if (null != end) {
      if (!obj.cheapWorkletShallowEqual(end, tmp)) {
        ...
        tmp2(4493).runOnJS(closure_5)(result > diff);
