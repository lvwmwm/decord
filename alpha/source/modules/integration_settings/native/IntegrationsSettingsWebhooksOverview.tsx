...
// Dependencies: [5, 19, 2042, 4394, 2064, 4396, 1372, 17322, 1074, 21, 4757, 576, 1484, 1397, 5824, 1177, 1115, 11, 4601, 504, 17323, 8878, 17324, 4467, 2108, 4753, 17326, 5906, 8876, 5185, 7287, 2]
// Exports: default
...
prototype["renderWebhooks"] = function renderWebhooks() {
  ...
  items[1] = tmp4Result;
  if (0 === found.length) {
    const obj2 = { Illustration: tmp5(17326).WebhookEmpty, title: null };
    ...
    items[2] = tmp4(tmp5(5906).TableRowGroup, obj3);
    obj4.children = items;
