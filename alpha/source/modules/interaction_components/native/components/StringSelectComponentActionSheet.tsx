...
// Dependencies: [32, 19, 21, 4827, 576, 8474, 1978, 4794, 12157, 7461, 4823, 1115, 2]
// Exports: default

// Module 12156 (StringSelectComponentActionSheet)
...
export default function StringSelectComponentActionSheet(selectionActionComponent) {
  ...
  let tmp3 = first(noop.useState(new Set(selectionActionComponent(8474).getInitialStringSelectOptions(selectionActionComponent, containerId))), 2);
  first = tmp3[0];
  noop = tmp3[1];
  ...
  let set = new Set(selectionActionComponent(8474).getInitialStringSelectOptions(selectionActionComponent, containerId));
  const tmp9 = memo;
