...
// Dependencies: [5, 19, 17, 2042, 5106, 1074, 21, 4757, 4653, 5824, 15827, 1115, 4981, 4716, 10460, 8183, 5899, 8385, 38, 504, 12415, 5380, 5352, 17814, 1978, 5109, 5356, 12254, 9427, 10902, 1875, 10901, 5354, 5185, 576, 5906, 2]
// Exports: default

// Module 17813 (FileUploadActionComponent)
    ...
    if (mediaFilesAllowed) {
      const obj3 = {
        ...
        onManageLimited() {
            ...
            const result = obj.handleLimitedPickerDialog({ onDismissKeyboard: InteractionModal(10902).hideMediaKeyboardActionSheet, onRestoreKeyboard });
          },
