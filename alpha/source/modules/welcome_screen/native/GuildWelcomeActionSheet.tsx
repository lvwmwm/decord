...
// Dependencies: [19, 17, 5678, 2042, 2064, 4396, 12911, 12915, 1074, 1375, 1085, 21, 4757, 576, 5743, 504, 4910, 1101, 4724, 5806, 1397, 4410, 4753, 1177, 12062, 8876, 573, 12913, 1241, 7444, 12916, 1115, 2]
// Exports: default

// Module 12914 (GuildWelcomeActionSheet)
...
const WELCOME_SCREEN_TYPE = fn(12915).WELCOME_SCREEN_TYPE;
...
export default function GuildWelcomeActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != welcomeScreen) {
      ...
      const obj5 = { style: tmp.guildIcon, guild: stateFromStores, size: onHide(12916).Sizes.MEDIUM, textScale: 2 };
      const items9 = [closure_17(onHide(12916), obj5), , , , ];
      ...
      tmp12 = closure_17(tmp2(7444).ActionSheet, obj3);
