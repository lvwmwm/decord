...
// Dependencies: [19, 17, 5762, 2042, 2064, 4462, 12993, 12997, 1074, 1375, 1085, 21, 4827, 576, 5827, 504, 4980, 1101, 4794, 5890, 1397, 4476, 4823, 1177, 12139, 8947, 573, 12995, 1241, 7528, 12998, 1115, 2]
// Exports: default

// Module 12996 (GuildWelcomeActionSheet)
...
const WELCOME_SCREEN_TYPE = fn(12997).WELCOME_SCREEN_TYPE;
...
export default function GuildWelcomeActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != welcomeScreen) {
      ...
      const obj5 = { style: tmp.guildIcon, guild: stateFromStores, size: onHide(12998).Sizes.MEDIUM, textScale: 2 };
      const items9 = [closure_17(onHide(12998), obj5), , , , ];
      ...
      tmp12 = closure_17(tmp2(7528).ActionSheet, obj3);
