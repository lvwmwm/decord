...
// Dependencies: [32, 19, 17, 21, 4757, 576, 4493, 14880, 5199, 6899, 2]
// Exports: default

// Module 14882 (SaturationValueColorPicker)
import nativeDefault from "native" /* 576 */;
import LinearGradientDefault from "LinearGradient" /* 5199 */;
import ColorPickerUtils from "ColorPickerUtils" /* 14880 */;
import _slicedToArray from "module_32" /* 32 */;
import noop from "module_19" /* 19 */;

const ReanimatedRexport = tmp(4493);
require = fn;
function ColorBox(hue) {
  ...
  let obj = hue(4493);
  S.__closure = { hslToRgbWorklet: hue(14880).hslToRgbWorklet, hue };
  ...
  const obj2 = { hslToRgbWorklet: hue(14880).hslToRgbWorklet, hue };
  fn.__closure = { runOnJS: hue(4493).runOnJS, setColor: tmp2[1] };
  ...
  obj4.colors = items1;
  const obj3 = { runOnJS: hue(4493).runOnJS, setColor: tmp2[1] };
...
export default function SaturationValueColorPicker(hue) {
  ...
  let size = { saturation, normalizeValue: hue(14880).normalizeValue, width: colorBoxWidth, value, height: first1, onPanUpdate, runOnJS: hue(4493).runOnJS };
  fn.__closure = size;
  ...
  const size1 = { saturation, normalizeValue: hue(14880).normalizeValue, width: colorBoxWidth, value, height: first1, onPanUpdate, runOnJS: hue(4493).runOnJS };
  fn2.__closure = size1;
  ...
  let obj = hue(6899);
  fn3.__closure = { onPanFinalize, runOnJS: hue(4493).runOnJS };
  fn3.__workletHash = 12553589408812;
  fn3.__initData = __initData5;
  obj2.onFinalize = fn3;
  const panGesture = obj.usePanGesture(obj2);
  let obj3 = { onPanFinalize, runOnJS: hue(4493).runOnJS };
  ...
  let obj6 = hue(4493);
  fn4.__closure = { hsvToRgbWorklet: hue(14880).hsvToRgbWorklet, hue, saturation, value, colorBoxWidth, colorBoxHeight: first1 };
  ...
  let obj4 = { hsvToRgbWorklet: hue(14880).hsvToRgbWorklet, hue, saturation, value, colorBoxWidth, colorBoxHeight: first1 };
