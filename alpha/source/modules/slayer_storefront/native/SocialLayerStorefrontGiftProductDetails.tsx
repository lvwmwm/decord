...
export default function SocialLayerStorefrontGiftProductDetails(sku) {
  ...
  if (tmp6Result) {
    ...
    items2[1] = tmp8(tmp2(4825).Text, obj9);
    obj6.children = items2;
    tmp6Result = tmp6(tmp7, obj6);
  }
  const items3 = [tmp6Result, closure_7(getOrFetchApplication(4825).Text, { variant: "text-md/semibold", children: sku.name })];
  ...
  if (tmp8Result2) {
    ...
    tmp8Result2 = tmp8(tmp2(4825).Text, obj11);
  }
