...
// Dependencies: [32, 19, 17, 1074, 1374, 21, 9113, 1115, 10455, 12872, 5405, 5401, 10722, 13944, 9564, 4769, 13946, 4827, 576, 13938, 5744, 4559, 4828, 4823, 4761, 4678, 5283, 5425, 4720, 13947, 13949, 4676, 1177, 13951, 13952, 5884, 12904, 2]
// Exports: default

// Module 13943 (GuildBoostingMarketingTierCards)
...
import ServerBoostStreamQualityMarketingExperiment from "ServerBoostStreamQualityMarketingExperiment" /* 13946 */;
...
let items = [
  {
    orderCollapsed: 0,
    isIncluded: true,
    IconComponent: fn(9113).ReactionIcon,
    getCopy() {
...
items[1] = {
  isIncluded: true,
  IconComponent: fn(10455).StickerIcon,
  getCopy() {
    const intl = util.intl;
...
items[2] = {
  isIncluded: true,
  IconComponent: fn(12872).ScreenArrowIcon,
  getCopy() {
    const intl = util.intl;
...
items[3] = {
  orderCollapsed: 2,
  isIncluded: true,
  IconComponent: fn(5405).VoiceNormalIcon,
  getCopy() {
    const intl = util.intl;
...
items[4] = {
  isIncluded: true,
  IconComponent: fn(5401).StageIcon,
  getCopy() {
    const intl = util.intl;
...
items[5] = {
  orderCollapsed: 1,
  isIncluded: true,
  IconComponent: fn(10722).GifIcon,
  getCopy() {
    const intl = util.intl;
...
items[6] = {
  isIncluded: true,
  IconComponent: fn(13944).ServerGridIcon,
  getCopy() {
    const intl = util.intl;
...
items[7] = {
  isIncluded: false,
  IconComponent: fn(9564).UploadIcon,
  getCopy() {
    const intl = util.intl;
...
items[10] = {
  isIncluded: false,
  IconComponent: fn(4769).LinkIcon,
  getCopy() {
    const intl = util.intl;
...
obj37.cardsScroller = { flex: 1, marginTop: fn(13938).PROGRESS_BAR_SPACING };
...
const obj41 = { flex: 1, marginTop: fn(13938).PROGRESS_BAR_SPACING };
obj37.sparkleStar = { position: "absolute", tintColor: fn(5744).DARK_WHITE_500_LIGHT_GUILD_BOOSTING_PINK };
...
let closure_16 = noop.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13947).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13949).ChevronLargeDownIcon;
  }
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      const tmp2Result4 = tmp2(5283);
      const items7 = [tmp7(4676).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result7 = tmp7(4676);
      items7[1] = tmp7(4676).hexWithOpacity(tmp9, 1);
      const tmp7Result8 = tmp7(4676);
      items7[2] = tmp7(4676).hexWithOpacity(tmp9, 0);
      obj15.colors = items7;
      obj15.start = { x: 0, y: 0 };
      obj15.end = { x: 1, y: 0 };
      ...
      const tmp7Result9 = tmp7(4676);
      const tmp2Result5 = tmp2(5283);
      const items10 = [tmp7(4676).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result10 = tmp7(4676);
      items10[1] = tmp7(4676).hexWithOpacity(tmp9, 1);
      const tmp7Result11 = tmp7(4676);
      items10[2] = tmp7(4676).hexWithOpacity(tmp9, 0);
    ...
    obj22 = tmp13(tmp7(4823).Text, obj22);
    obj21.children = obj22;
    tmp13(tmp2(5283), obj21);
    const tmp2Result6 = tmp2(5283);
  }
});
const size = fn(2);
