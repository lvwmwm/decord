...
// Dependencies: [32, 19, 17, 1074, 1374, 21, 8219, 1115, 9573, 12028, 5415, 5411, 9842, 13129, 8674, 4775, 13131, 4836, 576, 13123, 5753, 4566, 4837, 4832, 4767, 4685, 5293, 5435, 4728, 13132, 13134, 4683, 1177, 13136, 13137, 5893, 12060, 2]
// Exports: default
...
let items = [
  {
    orderCollapsed: 0,
    isIncluded: true,
    IconComponent: fn(8219).ReactionIcon,
    getCopy() {
...
items[1] = {
  isIncluded: true,
  IconComponent: fn(9573).StickerIcon,
  getCopy() {
    const intl = util.intl;
...
items[2] = {
  isIncluded: true,
  IconComponent: fn(12028).ScreenArrowIcon,
  getCopy() {
    const intl = util.intl;
...
items[3] = {
  orderCollapsed: 2,
  isIncluded: true,
  IconComponent: fn(5415).VoiceNormalIcon,
  getCopy() {
    const intl = util.intl;
...
items[4] = {
  isIncluded: true,
  IconComponent: fn(5411).StageIcon,
  getCopy() {
    const intl = util.intl;
...
items[7] = {
  isIncluded: false,
  IconComponent: fn(8674).UploadIcon,
  getCopy() {
    const intl = util.intl;
...
items[10] = {
  isIncluded: false,
  IconComponent: fn(4775).LinkIcon,
  getCopy() {
    const intl = util.intl;
...
let closure_16 = noop.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13132).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13134).ChevronLargeDownIcon;
  }
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      const tmp2Result4 = tmp2(5293);
      const items7 = [tmp7(4683).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result7 = tmp7(4683);
      items7[1] = tmp7(4683).hexWithOpacity(tmp9, 1);
      const tmp7Result8 = tmp7(4683);
      items7[2] = tmp7(4683).hexWithOpacity(tmp9, 0);
      obj15.colors = items7;
      obj15.start = { x: 0, y: 0 };
      obj15.end = { x: 1, y: 0 };
      ...
      const tmp7Result9 = tmp7(4683);
      const tmp2Result5 = tmp2(5293);
      const items10 = [tmp7(4683).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result10 = tmp7(4683);
      items10[1] = tmp7(4683).hexWithOpacity(tmp9, 1);
      const tmp7Result11 = tmp7(4683);
      items10[2] = tmp7(4683).hexWithOpacity(tmp9, 0);
    ...
    obj22 = tmp13(tmp7(4832).Text, obj22);
    obj21.children = obj22;
    tmp13(tmp2(5293), obj21);
    const tmp2Result6 = tmp2(5293);
  }
});
const size = fn(2);
