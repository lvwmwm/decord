...
// Dependencies: [32, 19, 17, 1074, 1374, 21, 9042, 1115, 10376, 12790, 5321, 5317, 10646, 13859, 9491, 4699, 13861, 4757, 576, 13853, 5660, 4493, 4758, 4753, 4691, 4608, 5199, 5341, 4650, 13862, 13864, 4606, 1177, 13866, 13867, 5800, 12822, 2]
// Exports: default

// Module 13858 (GuildBoostingMarketingTierCards)
...
import ServerBoostStreamQualityMarketingExperiment from "ServerBoostStreamQualityMarketingExperiment" /* 13861 */;
...
let items = [
  {
    orderCollapsed: 0,
    isIncluded: true,
    IconComponent: fn(9042).ReactionIcon,
    getCopy() {
...
items[1] = {
  isIncluded: true,
  IconComponent: fn(10376).StickerIcon,
  getCopy() {
    const intl = util.intl;
...
items[2] = {
  isIncluded: true,
  IconComponent: fn(12790).ScreenArrowIcon,
  getCopy() {
    const intl = util.intl;
...
items[5] = {
  orderCollapsed: 1,
  isIncluded: true,
  IconComponent: fn(10646).GifIcon,
  getCopy() {
    const intl = util.intl;
...
items[6] = {
  isIncluded: true,
  IconComponent: fn(13859).ServerGridIcon,
  getCopy() {
    const intl = util.intl;
...
items[7] = {
  isIncluded: false,
  IconComponent: fn(9491).UploadIcon,
  getCopy() {
    const intl = util.intl;
...
items[10] = {
  isIncluded: false,
  IconComponent: fn(4699).LinkIcon,
  getCopy() {
    const intl = util.intl;
...
obj37.cardsScroller = { flex: 1, marginTop: fn(13853).PROGRESS_BAR_SPACING };
...
const obj41 = { flex: 1, marginTop: fn(13853).PROGRESS_BAR_SPACING };
...
let closure_16 = noop.forwardRef((onCardPress, ref) => {
  ...
  if (isExpanded) {
    let ChevronLargeDownIcon = tmp7(13862).ChevronLargeUpIcon;
  } else {
    ChevronLargeDownIcon = tmp7(13864).ChevronLargeDownIcon;
  }
  ...
  if (!tmp16) {
    ...
    if (tmp11Result) {
      ...
      const tmp2Result4 = tmp2(5199);
      const items7 = [tmp7(4606).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result7 = tmp7(4606);
      items7[1] = tmp7(4606).hexWithOpacity(tmp9, 1);
      const tmp7Result8 = tmp7(4606);
      items7[2] = tmp7(4606).hexWithOpacity(tmp9, 0);
      obj15.colors = items7;
      obj15.start = { x: 0, y: 0 };
      obj15.end = { x: 1, y: 0 };
      ...
      const tmp7Result9 = tmp7(4606);
      const tmp2Result5 = tmp2(5199);
      const items10 = [tmp7(4606).hexWithOpacity(tmp9, 0), , ];
      const tmp7Result10 = tmp7(4606);
      items10[1] = tmp7(4606).hexWithOpacity(tmp9, 1);
      const tmp7Result11 = tmp7(4606);
      items10[2] = tmp7(4606).hexWithOpacity(tmp9, 0);
    ...
    obj22 = tmp13(tmp7(4753).Text, obj22);
    obj21.children = obj22;
    tmp13(tmp2(5199), obj21);
    const tmp2Result6 = tmp2(5199);
  }
});
const size = fn(2);
