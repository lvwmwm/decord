...
// Dependencies: [32, 19, 17, 4749, 1074, 21, 4757, 13854, 576, 4691, 563, 4493, 4650, 5186, 5199, 4608, 2]
// Exports: default

// Module 13853 (GuildBoostingMarketingProgressBar)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexport from "ReanimatedRexport" /* 4493 */;
import GuildBoostingUtils from "GuildBoostingUtils" /* 4650 */;
import spring from "spring" /* 5186 */;
import GuildBoostingMarketingProgressBarMarker from "GuildBoostingMarketingProgressBarMarker" /* 13854 */;
...
let obj2 = { progressBarContainer: { display: "flex", alignItems: "center", width: "100%", marginTop: 40, paddingHorizontal: fn(13854).MARKER_DIMENSIONS / 2 + 34 }, progressBar: { height: 54, maxWidth: 660, width: "100%" }, progressBarScrubber: null, progressBarTrack: null, progressBarFill: null, progressBarGradientFill: null };
let obj3 = { display: "flex", alignItems: "center", width: "100%", marginTop: 40, paddingHorizontal: fn(13854).MARKER_DIMENSIONS / 2 + 34 };
obj2.progressBarScrubber = { height: 8, top: fn(13854).MARKER_DIMENSIONS / 2 - 4, marginHorizontal: fn(13854).MARKER_DIMENSIONS / 2 + 2 };
