...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  let obj3 = guild(4566);
  fn.__closure = { withTiming: guild(4837).withTiming, isVisible };
  fn.__workletHash = 6895237370657;
  fn.__initData = __initData;
  closure_130_0 = tmp12;
  const animatedStyle = obj3.useAnimatedStyle(fn);
  const obj4 = { withTiming: guild(4837).withTiming, isVisible };
  ...
  const isPremiumResult = isVisible(4488).isPremium(stateFromStores);
  ...
  const items7 = [closure_12(guild(4832).Text, { style: tmp.guildName, color: "text-overlay-light", variant: "text-md/bold", children: guild.name }), ];
  ...
  items9[1] = closure_12(guild(4832).Text, obj21);
  obj19.children = items9;
  const items10 = [closure_13(isVisible(4566).View, obj19), ];
  ...
  obj22.children = closure_12(guild(4832).Text, obj23);
  items10[1] = closure_12(isVisible(4566).View, obj22);
