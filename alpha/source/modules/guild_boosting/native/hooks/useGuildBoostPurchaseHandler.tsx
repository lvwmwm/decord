...
// Dependencies: [5, 19, 1074, 3, 7651, 10929, 7650, 1241, 5110, 1115, 5653, 2]
// Exports: default

// Module 12796 (useGuildBoostPurchaseHandler)
      ...
      try {
        ...
        if (0 === c3) {
          if (arg0 === 1) {
            ...
            newAnalyticsLoadId = args(10929).getNewAnalyticsLoadId();
            const obj7 = args(7650);
            c3 = 1;
            c4 = 1;
            const obj4 = {
