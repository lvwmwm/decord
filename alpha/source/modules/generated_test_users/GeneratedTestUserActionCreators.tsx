...
// Dependencies: [5, 1386, 15118, 1074, 7839, 6005, 7844, 5022, 1249, 573, 15142, 2]
// Exports: getGeneratedPoolById, loginAsGeneratedUser, removeGeneratedPoolFromList

// Module 15141 (GeneratedTestUserActionCreators)
...
let closure_8 = async function _getGeneratedPoolById() {
  ...
  await value.then((body) => {
    ...
    if (body.ok) {
      ...
      const GeneratedTestPoolRecord = closure_0(15142).GeneratedTestPoolRecord;
      ...
      closure_1(7844).showFailedToast(constants.GENERIC_ERROR);
      const obj = closure_1(7844);
    }
  }).catch(() => {
    closure_1_1(7844).showFailedToast(constants.GENERIC_ERROR);
    return null;
  });
  return arg1;
};
