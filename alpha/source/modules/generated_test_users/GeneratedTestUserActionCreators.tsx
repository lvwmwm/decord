...
// Dependencies: [5, 1386, 15948, 1074, 8749, 6922, 8754, 5022, 1249, 573, 15972, 2]
// Exports: getGeneratedPoolById, loginAsGeneratedUser, removeGeneratedPoolFromList

// Module 15971 (GeneratedTestUserActionCreators)
...
let closure_8 = async function _getGeneratedPoolById() {
  ...
  await value.then((body) => {
    ...
    if (body.ok) {
      ...
      const GeneratedTestPoolRecord = closure_0(15972).GeneratedTestPoolRecord;
      ...
      closure_1(8754).showFailedToast(constants.GENERIC_ERROR);
      const obj = closure_1(8754);
    }
  }).catch(() => {
    closure_1_1(8754).showFailedToast(constants.GENERIC_ERROR);
    return null;
  });
  return arg1;
};
