...
// Dependencies: [5, 32, 19, 1182, 8687, 8690, 21, 4757, 8693, 8697, 8698, 5185, 5796, 5911, 4753, 1115, 3034, 5906, 5824, 2]
// Exports: default
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    ...
    obj2.children = tmp6(tmp7(5185).Stack, obj3);
    ...
    const items1 = [tmp6(tmp7(5911).ShieldSpotIllustration, { height: 100, width: 177 }), ];
    ...
    const items2 = [tmp6(tmp7(4753).Text, obj7), ];
    ...
    items2[1] = tmp6(tmp7(4753).Text, obj8);
    ...
    if (tmp6Result) {
      ...
      tmp6Result = tmp6(tmp7(4753).Text, obj9);
    }
    items3[1] = tmp6Result;
    ...
    const items4 = [tmp6(tmp7(5824).TableRow, obj11), ];
    ...
    items4[1] = tmp6(tmp7(5824).TableRow, obj12);
