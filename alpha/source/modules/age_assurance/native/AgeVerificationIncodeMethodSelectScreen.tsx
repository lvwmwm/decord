...
// Dependencies: [5, 32, 19, 1182, 8758, 8761, 21, 4827, 8764, 8768, 8769, 5269, 5880, 5995, 4823, 1115, 3036, 5990, 5908, 2]
// Exports: default
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = { align: "center", justify: "center", spacing: 16, style: tmp5.loadingContainer, children: tmp6(tmp7(5880).ActivityIndicator, { size: "large" }) };
    obj2.children = tmp6(tmp7(5269).Stack, obj3);
    ...
    const items1 = [tmp6(tmp7(5995).ShieldSpotIllustration, { height: 100, width: 177 }), ];
    ...
    const items2 = [tmp6(tmp7(4823).Text, obj7), ];
    ...
    items2[1] = tmp6(tmp7(4823).Text, obj8);
    ...
    if (tmp6Result) {
      ...
      tmp6Result = tmp6(tmp7(4823).Text, obj9);
    }
    items3[1] = tmp6Result;
    ...
    const items4 = [tmp6(tmp7(5908).TableRow, obj11), ];
    ...
    items4[1] = tmp6(tmp7(5908).TableRow, obj12);
