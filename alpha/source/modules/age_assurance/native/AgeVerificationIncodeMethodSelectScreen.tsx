...
// Dependencies: [5, 32, 19, 1182, 7860, 7863, 21, 4836, 7866, 7870, 7871, 5279, 5889, 7872, 4832, 1115, 3039, 5999, 5917, 2]
// Exports: default
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = { align: "center", justify: "center", spacing: 16, style: tmp5.loadingContainer, children: tmp6(tmp7(5889).ActivityIndicator, { size: "large" }) };
    obj2.children = tmp6(tmp7(5279).Stack, obj3);
    ...
    const items1 = [tmp6(tmp7(7872).ShieldSpotIllustration, { height: 100, width: 177 }), ];
    ...
    const items2 = [tmp6(tmp7(4832).Text, obj7), ];
    ...
    items2[1] = tmp6(tmp7(4832).Text, obj8);
    ...
    if (tmp6Result) {
      ...
      tmp6Result = tmp6(tmp7(4832).Text, obj9);
    }
    items3[1] = tmp6Result;
    ...
    const items4 = [tmp6(tmp7(5917).TableRow, obj11), ];
    ...
    items4[1] = tmp6(tmp7(5917).TableRow, obj12);
