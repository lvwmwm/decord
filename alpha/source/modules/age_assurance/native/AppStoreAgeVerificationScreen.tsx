...
// Dependencies: [5, 32, 19, 17, 21, 5169, 5174, 1484, 5039, 8918, 8922, 8786, 8919, 8768, 8769, 5269, 4823, 1115, 3036, 5736, 5271, 8759, 2]
// Exports: default
...
export default function AppStoreAgeVerificationScreen(modalSessionId) {
  ...
  if ("loading" === tmp5.type) {
    ...
    items3[1] = tmp10(tmp(4823).Text, obj4);
    ...
    const items4 = [tmp10(tmp(4823).Text, obj6), ];
    ...
    obj7.children = tmp10(tmp(5271).Button, obj8);
    items4[1] = tmp10(tmp(5736).ButtonGroup, obj7);
