...
// Dependencies: [5, 1372, 8687, 8690, 4966, 8674, 21, 5357, 4960, 8691, 1980, 8679, 8700, 8701, 1609, 5111, 8702, 1380, 1364, 8703, 8704, 4969, 5642, 573, 8705, 8711, 8718, 8855, 8856, 4452, 8688, 8867, 8868, 8869, 2]

// Module 8686 (AgeVerificationActionCreators)
...
function openIncodeAgeVerificationModal(arg0) {
  ...
  if (flag) {
    (async (arg0, value) => {
      ...
      if (1 === tmp7) {
        dependencyMap = 0;
        tmp3(8679).showFailedToast(constants2.TIGGER_PAWTECT_ERROR);
        closure_129_0();
        c4 = 3;
        tmp3(8679);
      } else if (2 === tmp7) {
        if (arg0 === 1) {
          ...
          c4 = 1;
          return {
            value: tmp3(4960).pushLazy(v3(async () => {
...
const AgeVerificationConstants = fn(8687);
...
let closure_12 = fn(8690).AGE_VERIFICATION_INCODE_PATH;
...
export default {
  ...
  showAgeVerificationGetStartedModal(entryPoint) {
    ...
    UserStore = undefined;
    if (obj.isMetaQuest()) {
      tmp(5111).openAlert(closure_7, jsx(onClose(8702), {}), onClose);
      const tmpResult = tmp(5111);
    } else {
      let isAgeVerifiedResult = tmp(4969).isAgeVerified();
      ...
      if (tmpResult8.isAgeVerificationIncodeEnabled(entryPoint)) {
        ...
        if (tmpResult9.isExpressiveModalV2Enabled(entryPoint)) {
              ...
              try {
                ...
                if (0 === dependencyMap) {
                  if (arg0 === 1) {
                    ...
                    dependencyMap = 1;
                    v3 = 1;
                    const obj5 = { value: entryPoint(8711).shouldShowManualReviewFallback(entryPoint), done: false };
                    return obj5;
                  }
                } else if (arg0 === 1) {
                  v3 = 3;
                  ...
                  if (value) {
                    ...
                    onClose(4960).pushLazy(v3(function*() {
          ...
          onClose(4960).pushLazy(prop(function*() {
