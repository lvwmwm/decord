...
// Dependencies: [5, 32, 19, 5042, 5043, 502, 5049, 1372, 7896, 7852, 1074, 1099, 7839, 7853, 5731, 1978, 504, 5730, 7879, 573, 7851, 7844, 7858, 7712, 1115, 3038, 13291, 2]
...
function shouldCallReactiveCheck() {
  ...
  let tmp7 = !tmp5;
  if (!tmp5) {
    let isFeatureAgeGatedResult = RegionalFeatureConfigStore.isFeatureAgeGated(tmp3(5731).AgeGatedFeature.REACTIVE_CHECK);
