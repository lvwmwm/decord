...
// Dependencies: [5, 32, 19, 4464, 1372, 1074, 21, 4829, 5989, 5826, 5443, 11789, 5827, 2058, 9291, 6539, 11803, 2]
// Exports: default

// Module 11802 (CreateGuildContainer)
...
let obj2 = { flex: { flex: 1 }, contentContainer: { marginTop: fn(5989).NAV_BAR_HEIGHT } };
