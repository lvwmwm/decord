...
// Dependencies: [5, 32, 19, 4394, 1372, 1074, 21, 4757, 5901, 5738, 5356, 12578, 5739, 2056, 10109, 7370, 12592, 2]
// Exports: default

// Module 12591 (CreateGuildContainer)
...
let obj2 = { flex: { flex: 1 }, contentContainer: { marginTop: fn(5901).NAV_BAR_HEIGHT } };
