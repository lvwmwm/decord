...
// Function ID: 12968
// Name: GuildTemplates
// Dependencies: [32, 19, 17, 12964, 7225, 1074, 21, 4757, 5901, 576, 4753, 1115, 1484, 1612, 5187, 12940, 1241, 12582, 12968, 7370, 5906, 2]
// Exports: default

// Module 12967 (GuildTemplates)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1115 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import Text_Text from "Text/Text" /* 4753 */;
import ListSelectionItemDefault from "ListSelectionItem" /* 12582 */;
import NewUserAnalyticsUtils from "NewUserAnalyticsUtils" /* 12940 */;
import CreateGuildIcons from "CreateGuildIcons" /* 12968 */;
...
function GuildTemplatesJoinFooter(trigger) {
  ...
  const items2 = [
    closure_14(trigger(4753).Text, obj4),
    closure_14(trigger(5187).Button, {
      variant: "primary",
      grow: true,
      text: stringResult,
      onPress() {
...
let obj2 = { flex: { flex: 1 }, contentContainer: { marginTop: fn(5901).NAV_BAR_HEIGHT }, scrollContainer: null, sections: null, headerContainer: null, headerTitle: null, headerDescription: null, footerSafeAreaContainer: null, footerContainer: null, footerTitle: null };
let obj3 = { marginTop: fn(5901).NAV_BAR_HEIGHT };
