...
// Function ID: 11804
// Name: CreateGuild
// Dependencies: [19, 17, 1372, 1074, 21, 4829, 576, 5259, 5268, 5272, 4825, 1115, 11262, 6019, 6616, 5274, 6355, 2]
// Exports: default
...
export default function CreateGuild(arg0) {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(6616).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(6355), obj11);
