...
// Function ID: 12669
// Name: CreateGuild
// Dependencies: [19, 17, 1372, 1074, 21, 4827, 576, 5256, 5265, 5269, 4823, 1115, 12133, 6934, 7531, 5271, 7270, 2]
// Exports: default
...
export default function CreateGuild(arg0) {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(7531).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(7270), obj11);
