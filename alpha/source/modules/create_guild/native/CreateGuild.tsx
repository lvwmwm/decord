...
// Function ID: 12593
// Name: CreateGuild
// Dependencies: [19, 17, 1372, 1074, 21, 4757, 576, 5172, 5181, 5185, 4753, 1115, 12056, 6850, 7447, 5187, 7186, 2]
// Exports: default
...
export default function CreateGuild(arg0) {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp4(7447).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = tmp9(ref(7186), obj11);
