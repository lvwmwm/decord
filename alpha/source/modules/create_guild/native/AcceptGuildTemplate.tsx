...
// Dependencies: [19, 17, 2046, 2100, 1074, 7571, 21, 4757, 576, 5743, 5796, 1177, 12054, 1115, 7226, 38, 1612, 2101, 4753, 12056, 6849, 5187, 8882, 12, 9804, 12061, 12062, 11218, 1092, 2]
// Exports: default

// Module 12053 (AcceptGuildTemplate)
...
import InvalidLink from "InvalidLink" /* 12054 */;
import GuildIconUploaderDefault from "GuildIconUploader" /* 12056 */;
...
function GuildTemplateResolved(guildTemplate) {
  ...
  const typeConsolidationTextTransform = guildTemplate(7226).useTypeConsolidationTextTransform("AcceptGuildTemplate");
  ...
  obj8.children = closure_11(guildTemplate(5187).Button, obj9);
  ...
  items1[6] = closure_11(guildTemplate(4753).Text, obj11);
  ...
  items1[7] = closure_11(guildTemplate(4753).Text, obj12);
  ...
  items1[9] = closure_12(guildTemplate(4753).Text, obj14);
  let tmp9Result = null;
  if (found.length > 0) {
    ...
    const items5 = [tmp11(tmp2(4753).Text, obj17), , ];
    ...
    items5[1] = tmp11(tmp2(4753).Text, obj18);
  ...
  let obj2 = {
    ...
    children: _modDef12(channels.channels).sortBy((parent_id) => {
      ...
      if (isGuildVocalChannelType(type)) {
        ...
        tmp10Result = tmp10(12061);
      } else {
        tmp10Result = tmp10(12062);
      }
