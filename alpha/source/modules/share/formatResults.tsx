...
// Function ID: 11254
// Name: formatResults
// Dependencies: [5, 10096, 2042, 4396, 1372, 11254, 1074, 10097, 4770, 10106, 1115, 1370, 12, 2]
...
export const formatResultsWithHeaders = function formatResultsWithHeaders(hasNonEmptyQuery) {
  ...
  if (hasNonEmptyQuery.hasNonEmptyQuery) {
    ...
    if (null != queryMode) {
      ...
      items4 = [tmp(10097).createHeaderResult(intl2.string(tmp(1115).t["80lOZ1"])), , ];
      let tmp13 = null;
      if (null != selectedChannelId) {
        ...
        if (null != tmp7) {
          ...
          if (isAllowedType(tmp7)) {
            let canResult = tmp7.type === tmp(10097).AutocompleterResultTypes.USER;
            if (!canResult) {
