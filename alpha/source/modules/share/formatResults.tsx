...
// Function ID: 11336
// Name: formatResults
// Dependencies: [5, 10181, 2044, 4464, 1372, 11336, 1074, 10182, 4842, 10191, 1115, 1370, 12, 2]
...
export const formatResultsWithHeaders = function formatResultsWithHeaders(hasNonEmptyQuery) {
  ...
  if (hasNonEmptyQuery.hasNonEmptyQuery) {
    ...
    if (null != queryMode) {
      ...
      items4 = [tmp(10182).createHeaderResult(intl2.string(tmp(1115).t["80lOZ1"])), , ];
      let tmp13 = null;
      if (null != selectedChannelId) {
        ...
        if (null != tmp7) {
          ...
          if (isAllowedType(tmp7)) {
            let canResult = tmp7.type === tmp(10182).AutocompleterResultTypes.USER;
            if (!canResult) {
