...
// Dependencies: [32, 19, 17, 1074, 11204, 21, 4827, 576, 11333, 7369, 11329, 10177, 7982, 1370, 7380, 10460, 11341, 11210, 11342, 1115, 5427, 7381, 2]
// Exports: default
...
export default function SearchableDestinationList(getRowIsUnavailable) {
  ...
  const callback5 = obj.useCallback((arg0, arg1) => {
    ...
    if (type !== sortByMatchScore.AutocompleterResultTypes.HEADER) {
      const tmp2Result = tmp2(11329);
      const destinationKeyResult = tmp2Result.destinationKey(tmp2(11329).getDestinationIdFromResult(tmp));
      let tmp6;
      ...
      if (tmp2(10177).AutocompleterResultTypes.USER === type) {
        ...
        obj3.user = record;
        obj3.type = tmp2(7982).getRelationshipType(record.id);
