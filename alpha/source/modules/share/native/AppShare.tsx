...
// Function ID: 18395
// Name: AppShare
// Dependencies: [32, 19, 17, 7705, 14681, 502, 1074, 12672, 21, 504, 6836, 1364, 14720, 12675, 7720, 1241, 5204, 14840, 14175, 1609, 8637, 7286, 17389, 17435, 5115, 2]
// Exports: default
...
export default function AppShare(targetUserId) {
  ...
  if (first) {
    ...
    const tmp14Result = tmp14(14175);
    if (tmp9Result.isMetaQuest()) {
      exitApp = tmp14(8637).close;
    } else {
    ...
    const items5 = [tmp19(tmp9(7286).SceneLoadingIndicator, {}), , , ];
    const obj5 = { appEntryKey: tmp18 };
    items5[1] = tmp19(tmp9(17389).ActionSheetContainer, obj5);
    items5[2] = tmp19(tmp14(17435), {});
    items5[3] = tmp19(tmp9(5115).AlertModalContainer, {});
