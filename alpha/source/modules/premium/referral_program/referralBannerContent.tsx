...
// Dependencies: [13703, 1074, 13704, 13705, 7695, 1115, 2108, 2]
...
// Module 13714 (referralBannerContent)
...
import Constants from "Constants" /* 13703 */;
...
export const getReferralBannerHeadingText = function getReferralBannerHeadingText(arg0) {
  ...
  } else if (arg0 === tmp(13705).ReferralRewardType.DISCOUNT) {
  ...
  if (arg0) {
    if (null == arg2) {
      ...
      if (numSent.numSent === useReferralProgramBannerDetails.MAX_REFERRALS_SENT) {
        if (numSent.numRedeemed === v1aEjsH(13704).MAX_REFERRALS_SENT) {
    ...
    if (numSent.numRewardGranted !== useReferralProgramBannerDetails.MAX_REFERRALS_SENT) {
      if (numSent.numSent === OluhLp(13704).MAX_REFERRALS_SENT) {
        if (arg2 === OluhLp(13705).ReferralRewardType.ORBS) {
