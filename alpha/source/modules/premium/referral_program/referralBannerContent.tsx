...
// Dependencies: [12959, 1074, 12960, 12961, 6868, 1115, 2110, 2]
...
// Module 12973 (referralBannerContent)
...
import Constants from "Constants" /* 12959 */;
...
export const getReferralBannerHeadingText = function getReferralBannerHeadingText(arg0) {
  ...
  } else if (arg0 === tmp(12961).ReferralRewardType.DISCOUNT) {
  ...
  if (arg0) {
    if (null == arg2) {
      ...
      if (numSent.numSent === useReferralProgramBannerDetails.MAX_REFERRALS_SENT) {
        if (numSent.numRedeemed === v1aEjsH(12960).MAX_REFERRALS_SENT) {
    ...
    if (numSent.numRewardGranted !== useReferralProgramBannerDetails.MAX_REFERRALS_SENT) {
      if (numSent.numSent === OluhLp(12960).MAX_REFERRALS_SENT) {
        if (arg2 === OluhLp(12961).ReferralRewardType.ORBS) {
