...
// Dependencies: [13805, 1074, 13806, 13807, 7783, 1115, 2110, 2]
...
// Module 13816 (referralBannerContent)
...
import Constants from "Constants" /* 13805 */;
...
export const getReferralBannerHeadingText = function getReferralBannerHeadingText(arg0) {
  ...
  } else if (arg0 === tmp(13807).ReferralRewardType.DISCOUNT) {
  ...
  if (arg0) {
    if (null == arg2) {
      ...
      if (numSent.numSent === useReferralProgramBannerDetails.MAX_REFERRALS_SENT) {
        if (numSent.numRedeemed === v1aEjsH(13806).MAX_REFERRALS_SENT) {
    ...
    if (numSent.numRewardGranted !== useReferralProgramBannerDetails.MAX_REFERRALS_SENT) {
      if (numSent.numSent === OluhLp(13806).MAX_REFERRALS_SENT) {
        if (arg2 === OluhLp(13807).ReferralRewardType.ORBS) {
