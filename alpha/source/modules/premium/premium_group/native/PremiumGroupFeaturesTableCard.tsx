...
// Dependencies: [17, 7762, 21, 4829, 576, 4825, 1115, 13852, 1177, 5285, 4678, 9578, 2]
// Exports: default

// Module 13851 (PremiumGroupFeaturesTableCard)
...
import ColorConstants from "ColorConstants" /* 7762 */;
import usePremiumGroupFeaturesTableCardTextDefault from "usePremiumGroupFeaturesTableCardText" /* 13852 */;
...
export default function PremiumGroupFeaturesTableCard(arg0) {
  ...
  if (null == tmp4) {
    ...
    const items1 = [hasOwnProperty(tmp2(9578), { width: 181, height: 16 }), hasOwnProperty(BetaPill, {})];
