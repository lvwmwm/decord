...
// Dependencies: [17, 7760, 21, 4827, 576, 4823, 1115, 13843, 1177, 5283, 4676, 9574, 2]
// Exports: default

// Module 13842 (PremiumGroupFeaturesTableCard)
...
import ColorConstants from "ColorConstants" /* 7760 */;
import usePremiumGroupFeaturesTableCardTextDefault from "usePremiumGroupFeaturesTableCardText" /* 13843 */;
...
export default function PremiumGroupFeaturesTableCard(arg0) {
  ...
  if (null == tmp4) {
    ...
    const items1 = [hasOwnProperty(tmp2(9574), { width: 181, height: 16 }), hasOwnProperty(BetaPill, {})];
