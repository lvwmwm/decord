...
// Dependencies: [8180, 1094, 8183, 9516, 2]
// Exports: default

// Module 9515 (shouldOpenPremiumUpsellActionSheet)
...
export default function maybeOpenPremiumUpsellActionSheet(initialUpsellKey) {
  ...
  if (ConstantsIOS.UpsellTypes.UPLOAD === initialUpsellKey) {
    const INCREASED_FILE_UPLOAD_SIZE = tmp(8183).EntitlementFeatureNames.INCREASED_FILE_UPLOAD_SIZE;
    ...
    const EMOJIS_EVERYWHERE = tmp(8183).EntitlementFeatureNames.EMOJIS_EVERYWHERE;
    ...
    const ANIMATED_EMOJIS = tmp(8183).EntitlementFeatureNames.ANIMATED_EMOJIS;
    ...
    let flag4 = tmp(9516).getMobileStickerPickerUpsellRestyleEnabled("native.shouldOpenPremiumUpsellActionSheet");
    if (flag4) {
      const STICKERS_EVERYWHERE = tmp(8183).EntitlementFeatureNames.STICKERS_EVERYWHERE;
    ...
    const SOUNDBOARD_EVERYWHERE = tmp(8183).EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE;
    ...
    const STREAM_HIGH_QUALITY = tmp(8183).EntitlementFeatureNames.STREAM_HIGH_QUALITY;
