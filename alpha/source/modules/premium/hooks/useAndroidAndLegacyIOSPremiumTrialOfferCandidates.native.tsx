...
export const useAndroidAndLegacyIOSPremiumTrialOfferCandidates = function useAndroidAndLegacyIOSPremiumTrialOfferCandidates() {
  ...
  const values6 = Object.values(tmp(6661).TrialIdToProductOfferId[React3]);
  let tmp6 = null;
  ...
  const values7 = Object.values(tmp(6661).TrialIdToProductOfferId[React4]);
  let tmp8 = null;
  ...
  const values9 = Object.values(tmp(6661).TrialIdToProductOfferId[React5]);
  let tmp12 = null;
  ...
  const values10 = Object.values(tmp(6661).TrialIdToProductOfferId[React6]);
  let tmp14 = null;
