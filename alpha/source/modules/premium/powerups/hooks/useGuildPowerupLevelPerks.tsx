...
// Dependencies: [19, 4716, 4720, 1115, 2516, 1370, 2]
// Exports: default

// Module 12866 (useGuildPowerupLevelPerks)
...
require = fn;
const GUILD_FEATURE_TO_PERK = fn(4716).GUILD_FEATURE_TO_PERK;
const size = fn(2);
...
export default function useGuildPowerupLevelPerks(arg0) {
  ...
  return includeSoundboards.useMemo(() => {
    ...
    if (includeEmojis) {
      ...
      obj.description = intl.formatToPlainString(_modDef2516["NXvV0+"], obj2);
      items.push(obj);
    }
    if (includeStickers) {
      ...
      obj3.description = intl2.formatToPlainString(_modDef2516.ZEvvPz, obj4);
      items.push(obj3);
    }
    if (includeSoundboards) {
      ...
      obj5.description = intl3.formatToPlainString(_modDef2516["s9u/E7"], obj6);
      items.push(obj5);
    }
