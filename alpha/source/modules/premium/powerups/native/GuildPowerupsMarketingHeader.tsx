...
// Dependencies: [19, 17, 4715, 21, 4827, 576, 672, 4823, 13933, 12828, 12853, 1115, 2516, 13934, 2]
// Exports: default
      ...
      if (null != arr) {
        ...
        if (0 !== arr.length) {
          ...
          if (1 === first.length) {
            ...
            formatResult = intl2.format(tmp2(2516).MNO3sG, obj4);
          }
        }
      }
      const obj7 = { perks: str2 };
      obj2.children = intl.format(tmp2(2516)["7lwpzR"], obj7);
