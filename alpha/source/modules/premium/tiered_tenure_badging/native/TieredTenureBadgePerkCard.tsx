...
// Dependencies: [19, 17, 1372, 1074, 21, 4757, 11455, 13707, 504, 11429, 1241, 4724, 11428, 1980, 11428, 1115, 13709, 4753, 11454, 13674, 5806, 2]
...
export const TieredTenureBadgePerkCard = function TieredTenureBadgePerkCard() {
  ...
  if (null == tieredTenureBadgeData) {
    ...
    if (tmp30Result) {
      ...
      tmp30Result = tmp30(tmp(4753).Text, obj12);
    }
