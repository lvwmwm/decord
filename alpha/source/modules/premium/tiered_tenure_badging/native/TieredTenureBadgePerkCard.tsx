...
// Dependencies: [19, 17, 1372, 1074, 21, 4829, 11537, 13801, 504, 11511, 1241, 4796, 11510, 1980, 11510, 1115, 13803, 4825, 11536, 13768, 5892, 2]
...
export const TieredTenureBadgePerkCard = function TieredTenureBadgePerkCard() {
  ...
  if (null == tieredTenureBadgeData) {
    ...
    if (tmp30Result) {
      ...
      tmp30Result = tmp30(tmp(4825).Text, obj12);
    }
