...
// Dependencies: [19, 17, 1372, 1374, 1074, 21, 4827, 576, 11505, 7956, 11530, 5890, 4823, 1115, 11531, 504, 1969, 9124, 1249, 1612, 7710, 4794, 8523, 10309, 10312, 7481, 6955, 2]
// Exports: default
...
function TieredTenureBadgeItem(arg0) {
  ...
  if (null != tieredTenureBadgeData) {
    ...
    if (isUsersBadge) {
      ...
      isUsersBadge = tmp11(tmp2(4823).Text, obj6);
    }
