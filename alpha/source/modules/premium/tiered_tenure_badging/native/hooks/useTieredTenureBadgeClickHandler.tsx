...
// Dependencies: [19, 1372, 1374, 8538, 1074, 7539, 11503, 7956, 504, 7710, 4794, 11504, 1980, 11504, 1241, 2]
// Exports: useTieredTenureBadgeClickHandler

// Module 11502 (useTieredTenureBadgeClickHandler)
...
export const useTieredTenureBadgeClickHandler = function useTieredTenureBadgeClickHandler(id, userId, themeType) {
  ...
  if (typeof id === "string") {
    tmp4 = null != tmp(7956).getTieredTenureBadge(id);
  ...
  if (tmp4) {
    callback = isPremiumSubscriber.useCallback(() => {
      if (closure_2 === UserProfileThemeTypes.YOU_SCREEN) {
        ...
        const tmp4 = asyncRequireImpl(11504, dependencyMap.paths);
        const obj4 = { userId };
