...
// Dependencies: [19, 1372, 1374, 8463, 1074, 7453, 11423, 7870, 504, 7624, 4723, 11424, 1980, 11424, 1241, 2]
// Exports: useTieredTenureBadgeClickHandler

// Module 11422 (useTieredTenureBadgeClickHandler)
...
export const useTieredTenureBadgeClickHandler = function useTieredTenureBadgeClickHandler(id, userId, themeType) {
  ...
  if (typeof id === "string") {
    tmp4 = null != tmp(7870).getTieredTenureBadge(id);
  ...
  if (tmp4) {
    callback = isPremiumSubscriber.useCallback(() => {
      if (closure_2 === UserProfileThemeTypes.YOU_SCREEN) {
        ...
        const tmp4 = asyncRequireImpl(11424, dependencyMap.paths);
        const obj4 = { userId };
