...
// Dependencies: [19, 17, 21, 4829, 576, 7495, 13796, 9128, 1249, 11087, 13799, 4825, 4520, 10317, 2]
// Exports: default
...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  const items2 = [tmp12Result, closure_5(helpArticleLinkProps(4825).Text, { color: "mobile-text-heading-primary", variant: "text-lg/bold", children: bannerFields.header }), , ];
  ...
  if (tmp12Result3) {
    ...
    tmp12Result3 = tmp12(tmp4(4825).Text, obj11);
  }
  items3[2] = tmp12Result3;
  obj10.children = items3;
  items2[2] = closure_6(helpArticleLinkProps(4825).Text, obj10);
  ...
  if (tmp12Result4) {
    ...
    obj12.children = tmp12(tmp2(10317), obj13);
