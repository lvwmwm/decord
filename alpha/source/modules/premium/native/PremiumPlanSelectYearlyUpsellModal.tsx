...
// Dependencies: [32, 19, 17, 2112, 6658, 13083, 1374, 1085, 21, 4836, 5836, 5753, 6829, 504, 1882, 5300, 13095, 1177, 1115, 4488, 5281, 2]
// Exports: default
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    const formatPercentResult = tmp5(1882).formatPercent(stateFromStores, closure_10 / 100);
    ...
    obj9.planName = tmp5(4488).getPremiumTypeDisplayName(premiumTier);
