...
// Dependencies: [32, 19, 17, 2111, 6653, 13066, 1374, 1085, 21, 4829, 5831, 5748, 6824, 504, 1881, 5293, 13078, 1177, 1115, 4485, 5274, 2]
// Exports: default

// Module 13077 (PremiumPlanSelectYearlyUpsellModal)
...
const usePremiumPlanSelectStore = fn(13066).usePremiumPlanSelectStore;
...
obj2.header = obj3;
obj2.description = { alignSelf: "center", textAlign: "center", paddingBottom: 32, color: fn(5748).DARK_WHITE_500_LIGHT_BLACK_500 };
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  const premiumBundledItemsFromProductId = productId(6824).getPremiumBundledItemsFromProductId(productId);
  const obj2 = productId(6824);
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj9.planName = tmp5(4485).getPremiumTypeDisplayName(premiumTier);
    ...
    obj12.children = closure_11(tmp5(5274).Button, obj13);
    ...
    obj15.children = closure_11(tmp5(5274).Button, obj16);
    ...
    obj17.children = closure_11(tmp5(5274).Button, obj18);
