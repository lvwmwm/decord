...
// Dependencies: [32, 19, 17, 2111, 7570, 13909, 1374, 1085, 21, 4829, 5829, 5746, 7739, 504, 1881, 5292, 13919, 1177, 1115, 4483, 5273, 2]
// Exports: default

// Module 13918 (PremiumPlanSelectYearlyUpsellModal)
...
const usePremiumPlanSelectStore = fn(13909).usePremiumPlanSelectStore;
...
obj2.header = obj3;
obj2.description = { alignSelf: "center", textAlign: "center", paddingBottom: 32, color: fn(5746).DARK_WHITE_500_LIGHT_BLACK_500 };
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  const premiumBundledItemsFromProductId = productId(7739).getPremiumBundledItemsFromProductId(productId);
  const obj2 = productId(7739);
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj9.planName = tmp5(4483).getPremiumTypeDisplayName(premiumTier);
    ...
    obj12.children = closure_11(tmp5(5273).Button, obj13);
    ...
    obj15.children = closure_11(tmp5(5273).Button, obj16);
    ...
    obj17.children = closure_11(tmp5(5273).Button, obj18);
