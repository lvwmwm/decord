...
// Dependencies: [19, 17, 1374, 1074, 21, 5280, 13769, 4483, 7712, 7515, 1115, 13770, 13771, 13772, 13773, 13774, 13775, 13776, 13777, 13778, 13779, 13780, 13781, 13782, 13783, 13784, 13785, 13786, 4825, 2110, 4829, 576, 5892, 13787, 5273, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    ...
    if (tmp29Result) {
      ...
      obj13.children = tmp29(tmp6(5273).Button, obj14);
