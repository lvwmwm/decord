...
// Dependencies: [19, 17, 1374, 1074, 21, 5194, 13675, 4415, 7627, 7429, 1115, 13676, 13677, 13678, 13679, 13680, 13681, 13682, 13683, 13684, 13685, 13686, 13687, 13688, 13689, 13690, 13691, 13692, 4753, 2108, 4757, 576, 5806, 13693, 5187, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      imageSrc = React7(tmp6(4753).Text, obj5);
    ...
    if (null != description) {
      ...
      let tmp21 = React7(tmp6(4753).Text, obj7);
    } else {
      tmp21 = null;
    ...
    items4[2] = React7(tmp6(4753).Text, obj11);
    ...
    if (tmp29Result) {
      ...
      obj13.children = tmp29(tmp6(5187).Button, obj14);
