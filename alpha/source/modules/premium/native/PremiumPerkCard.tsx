...
// Dependencies: [19, 17, 1374, 1074, 21, 5278, 13760, 4481, 7710, 7513, 1115, 13761, 13762, 13763, 13764, 13765, 13766, 13767, 13768, 13769, 13770, 13771, 13772, 13773, 13774, 13775, 13776, 13777, 4823, 2108, 4827, 576, 5890, 13778, 5271, 2]
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      imageSrc = React7(tmp6(4823).Text, obj5);
    ...
    if (null != description) {
      ...
      let tmp21 = React7(tmp6(4823).Text, obj7);
    } else {
      tmp21 = null;
    ...
    items4[2] = React7(tmp6(4823).Text, obj11);
    ...
    if (tmp29Result) {
      ...
      obj13.children = tmp29(tmp6(5271).Button, obj14);
