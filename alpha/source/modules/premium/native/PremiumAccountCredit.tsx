...
// Dependencies: [19, 17, 7639, 1074, 21, 4757, 576, 7419, 4415, 1115, 3162, 9495, 4753, 504, 12, 2]
// Exports: default

// Module 13669 (PremiumAccountCredit)
...
function AccountCreditTier(arg0) {
    ...
    if (null != currentSubscription) {
      if (currentSubscription.planId === planId) {
        if (currentSubscription.status === SubscriptionStatusTypes.PAUSED) {
          ...
          let num = tmp2(4415).extendDateWithUnconsumedFractionalPremium(date, unconsumedFractionalPremiumUnits);
  ...
  if (result1) {
    ...
    obj8.children = tmp24(tmp2(9495).BoostGemIcon, obj9);
  ...
  if (!tmp18) {
    ...
    tmp27Result = tmp27(tmp2(4753).Text, obj13);
  }
