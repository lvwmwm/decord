...
// Dependencies: [19, 4749, 21, 4757, 576, 4458, 504, 1364, 4493, 5341, 5748, 2]
// Exports: PremiumAnimatedGiftButton

// Module 12506 (PremiumAnimatedGiftButton)
...
export const PremiumAnimatedGiftButton = function PremiumAnimatedGiftButton(arg0) {
  ...
  obj6.children = jsx(tmp3(5748), { ref: tmp9, style: tmp7.animationRefresh, source: { uri: animationDataUrl }, loop, autoPlay: false, onAnimationFinish: onAnimationFinished });
  ...
  return jsx(stateFromStores(4493).View, { exiting: FadeOut, children: null });
};
