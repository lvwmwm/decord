...
// Dependencies: [19, 17, 7630, 10484, 2041, 21, 4829, 576, 1612, 5032, 4689, 5274, 10485, 1115, 2582, 10486, 4825, 10196, 4797, 4798, 10202, 10487, 4651, 2028, 504, 7622, 2]
// Exports: default
...
function LevelUpScreen(arg0) {
  ...
  if (tmp10Result) {
    ...
    tmp10Result = tmp10(tmp(10202), obj6);
  }
