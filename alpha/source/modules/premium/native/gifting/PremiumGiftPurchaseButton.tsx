...
// Dependencies: [19, 17, 7630, 10117, 1074, 21, 4829, 576, 6397, 1484, 10151, 10502, 504, 10191, 10205, 10192, 7622, 10196, 10115, 10114, 10497, 1115, 10206, 10207, 2550, 9702, 10209, 6598, 4825, 2110, 5274, 4697, 2]
// Exports: default
    ...
    if (!isPurchasing) {
      fn = () => {
        ...
        if (closure_10) {
          if (closure_8) {
            if (closure_8) {
              _undefined2(tmp(10115).PaymentFlowStep.REWARD_SKU_SELECT);
              ...
              navigation.navigate(tmp(10114).PremiumGiftScreens.REWARD_SELECT, obj2);
            }
          }
        }
        _undefined(() => {
