...
// Dependencies: [19, 17, 8465, 10931, 1074, 21, 4757, 576, 7228, 1484, 10965, 11322, 504, 11005, 11018, 11006, 8457, 11010, 10929, 10928, 11317, 1115, 11019, 11021, 2546, 10514, 11024, 7429, 4753, 2108, 5187, 4623, 2]
// Exports: default
    ...
    if (!isPurchasing) {
      fn = () => {
        ...
        if (closure_10) {
          if (closure_8) {
            if (closure_8) {
              _undefined2(tmp(10929).PaymentFlowStep.REWARD_SKU_SELECT);
              ...
              navigation.navigate(tmp(10928).PremiumGiftScreens.REWARD_SELECT, obj2);
            }
          }
        }
        _undefined(() => {
