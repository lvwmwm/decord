...
// Dependencies: [19, 17, 4484, 21, 4829, 576, 5746, 1177, 1115, 4483, 2]
// Exports: default

// Module 13759 (SubscriptionRenewalMutationsNotice)
...
const obj2 = { container: { padding: 10, marginVertical: 5, marginHorizontal: 15, borderRadius: nativeDefault.radii.xs, display: "flex", flexDirection: "row", justifyContent: "center", backgroundColor: fn(5746).DARK_PRIMARY_630_LIGHT_PRIMARY_230 }, icon: null, text: null };
let obj3 = { padding: 10, marginVertical: 5, marginHorizontal: 15, borderRadius: nativeDefault.radii.xs, display: "flex", flexDirection: "row", justifyContent: "center", backgroundColor: fn(5746).DARK_PRIMARY_630_LIGHT_PRIMARY_230 };
