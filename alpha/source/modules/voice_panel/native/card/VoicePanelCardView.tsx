...
// Dependencies: [32, 19, 17, 4773, 12530, 12528, 17565, 12533, 4778, 21, 17608, 4493, 9670, 12529, 4458, 576, 12534, 11265, 5186, 17568, 5805, 7320, 5140, 17558, 504, 12, 4468, 1115, 4467, 2]
...
const spring = tmp23(5186);
const roundToNearestPixelDefault = tmp3(11265);
require = fn;
