...
// Dependencies: [32, 19, 17, 2043, 4845, 8836, 4851, 502, 2044, 1372, 11741, 16880, 1074, 2004, 4850, 21, 4829, 576, 4563, 5286, 11740, 16872, 8885, 1110, 4537, 16883, 5896, 16879, 563, 1478, 8904, 8281, 7689, 8873, 8891, 1177, 8894, 11743, 6489, 16795, 8878, 8869, 2]
  ...
  if (canRenderParticipantVideo) {
    ...
    if (tmp18) {
      ...
      if (consumedRequestToRespondToSeriousThermalState) {
        ...
        tmp35Result2 = tmp35(tmp6(5896), obj11);
