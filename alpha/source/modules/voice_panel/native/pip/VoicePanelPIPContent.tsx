...
// Dependencies: [32, 19, 17, 2043, 4845, 9738, 4851, 502, 2044, 1372, 12615, 17656, 1074, 2004, 4850, 21, 4829, 576, 4561, 5285, 12614, 17648, 9787, 1110, 4535, 17659, 5894, 17655, 563, 1478, 9806, 9187, 8599, 9775, 9793, 1177, 9796, 12617, 7406, 17571, 9780, 9771, 2]
  ...
  if (canRenderParticipantVideo) {
    ...
    if (tmp18) {
      ...
      if (consumedRequestToRespondToSeriousThermalState) {
        ...
        tmp35Result2 = tmp35(tmp6(5894), obj11);
