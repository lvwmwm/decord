...
// Dependencies: [32, 19, 17, 2041, 4843, 9734, 4849, 502, 2042, 1372, 12606, 17633, 1074, 2004, 4848, 21, 4827, 576, 4559, 5283, 12605, 17625, 9783, 1110, 4533, 17636, 5892, 17632, 563, 1478, 9802, 9183, 8595, 9771, 9789, 1177, 9792, 12608, 7404, 17548, 9776, 9767, 2]
  ...
  if (canRenderParticipantVideo) {
    ...
    if (tmp18) {
      ...
      if (consumedRequestToRespondToSeriousThermalState) {
        ...
        tmp35Result2 = tmp35(tmp6(5892), obj11);
