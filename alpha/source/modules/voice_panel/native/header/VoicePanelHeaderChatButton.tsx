...
// Dependencies: [19, 1074, 21, 4757, 576, 1110, 17606, 5808, 17510, 5291, 1115, 2]
// Exports: default

// Module 17605 (VoicePanelHeaderChatButton)
...
import useChatBadgeDefault from "useChatBadge" /* 17606 */;
...
export default function VoicePanelHeaderChatButton(channelId) {
  ...
  if (tmp8Result) {
    ...
    obj4.style = items1;
    obj3.children = tmp8(tmp3(5808), obj4);
    tmp8Result = tmp8(tmp3(5808), obj3);
