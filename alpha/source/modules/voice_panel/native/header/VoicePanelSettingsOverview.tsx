...
// Dependencies: [19, 2043, 4845, 8836, 502, 2044, 1992, 4466, 1372, 4853, 1074, 4850, 9154, 21, 4829, 576, 504, 16904, 4982, 9172, 9133, 5896, 4825, 9227, 1115, 5402, 7, 4525, 16901, 7801, 5912, 5918, 15089, 8079, 5919, 573, 6616, 2020, 9093, 5030, 8077, 9422, 4796, 16905, 1980, 9156, 9175, 16906, 16894, 16847, 10953, 9120, 16907, 6793, 16908, 9125, 16909, 9558, 9396, 9481, 9480, 2]
...
function ShareActivityLogsButton() {
  ...
  const obj = { onPress: callback, icon: collapsedCategories(TableRowIcon.TableRowIcon, { IconComponent: WrenchIcon.WrenchIcon, source: _modDef8079 }), label: null, trailing: null };
  let intl = util.intl;
