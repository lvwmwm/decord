...
// Dependencies: [19, 12530, 12528, 12531, 7321, 12532, 1614, 12536, 2]

// Module 12529 (VoicePanelStateContext)
import VoicePanelCardLayoutManagerDefault from "VoicePanelCardLayoutManager" /* 12532 */;
import VoicePanelPIPHandoffDefault from "VoicePanelPIPHandoff" /* 12536 */;
...
ReanimatedHelperTypes = fn(7321);
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12531).MorphablePanelModes.PANEL);
