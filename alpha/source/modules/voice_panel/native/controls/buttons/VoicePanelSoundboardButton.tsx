...
// Dependencies: [19, 21, 4829, 576, 12614, 17752, 17767, 17753, 1115, 5894, 12877, 2]
// Exports: default
...
export default function SoundboardButton(arg0) {
  ...
  if (visible) {
    ...
    items[1] = obj3;
    obj2.style = items;
    const items1 = [React4(tmp(5894), obj2), ];
    const obj4 = { style: tmp3.iconContainer, children: null };
    const tmpResult = tmp(17753);
    const obj5 = { color };
    obj4.children = React4(tmp4(12877).SoundboardIcon, obj5);
    items1[1] = React4(tmp(5894), obj4);
    element.children = items1;
    tmp8 = hasOwnProperty(tmpResult, element);
    const tmpResult2 = tmp(5894);
  }
  return tmp8;
};
