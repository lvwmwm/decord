...
// Dependencies: [19, 1992, 12604, 1074, 21, 17728, 17731, 17737, 17739, 17741, 17743, 17745, 17750, 17646, 1609, 12605, 17581, 504, 4559, 12613, 8613, 2]
// Exports: default
  ...
  return treatment.useMemo(() => {
    ...
    const mapped = (function getButtons(arg0, stateFromStores, treatment) {
      ...
      if (arg0) {
        ...
        if (treatment === tmp10(17646).MobileGoLiveEntrypointTreatment.SCREENSHARE_REPLACES_SOUNDBOARD) {
