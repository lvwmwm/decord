...
// Dependencies: [19, 1992, 12613, 1074, 21, 17751, 17754, 17760, 17762, 17764, 17766, 17768, 17773, 17669, 1609, 12614, 17604, 504, 4561, 12622, 8617, 2]
// Exports: default
  ...
  return treatment.useMemo(() => {
    ...
    const mapped = (function getButtons(arg0, stateFromStores, treatment) {
      ...
      if (arg0) {
        ...
        if (treatment === tmp10(17669).MobileGoLiveEntrypointTreatment.SCREENSHARE_REPLACES_SOUNDBOARD) {
