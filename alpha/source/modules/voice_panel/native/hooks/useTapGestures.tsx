...
// Function ID: 17613
// Name: useTapGestures
// Dependencies: [19, 12529, 6899, 4493, 4725, 2]
// Exports: default

// Module 17612 (useTapGestures)
...
export default function useTapGestures(onSingleTap) {
  ...
  isFocusedVideoZoomed = noop.useContext(isFocusedVideoZoomed(12529)).isFocusedVideoZoomed;
  ...
  return noop.useMemo(() => {
    ...
    const Gesture = current(6899).Gesture;
    const Gesture2 = current(6899).Gesture;
    ...
    fn.__closure = { runOnJS: current(4493).runOnJS, handleEvent };
    fn.__workletHash = 13571114432746;
    fn.__initData = __initData;
    const obj2 = { runOnJS: current(4493).runOnJS, handleEvent };
    const Gesture3 = tmp(6899).Gesture;
    ...
    fn2.__closure = { runOnJS: current(4493).runOnJS, handleEvent };
    fn2.__workletHash = 14109132753191;
    fn2.__initData = gesturesEnabled;
    const obj3 = { runOnJS: current(4493).runOnJS, handleEvent };
    const Gesture4 = tmp(6899).Gesture;
    ...
    fn3.__closure = { runOnJS: current(4493).runOnJS, triggerHapticFeedback: current(4725).triggerHapticFeedback, HapticFeedbackTypes: current(4725).HapticFeedbackTypes, handleEvent };
