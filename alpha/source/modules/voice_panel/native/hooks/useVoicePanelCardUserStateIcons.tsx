...
// Dependencies: [19, 4852, 4848, 4850, 21, 12614, 10024, 563, 10364, 4884, 10329, 16662, 17620, 4523, 6940, 576, 1115, 2]
// Exports: default
...
export default function useVoicePanelCardUserStateIcons(arg0, id, guildId) {
  ...
  callback1 = obj.useCallback(() => {
    const obj2 = {
      ...
      icon() {
        return stateFromStores1(closure_1_0(6940).CircleErrorIcon, { size: "xs", color: id(576).colors.STATUS_WARNING });
      },
      content: null
    };
        ...
        if (null != muteDeafenIconState) {
          let obj5 = {
            ...
            onPress() {
                    ...
                    } else if (tmp2(10024).MuteDeafenIconState.DEAFENED === tmp) {
                    ...
                    } else if (tmp2(10024).MuteDeafenIconState.MUTED_SERVER === tmp) {
                    ...
                    } else if (tmp2(10024).MuteDeafenIconState.MUTED_LOCAL === tmp) {
                    ...
                    } else if (tmp2(10024).MuteDeafenIconState.MUTED === tmp) {
