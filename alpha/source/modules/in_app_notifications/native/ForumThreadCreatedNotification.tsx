...
// Dependencies: [19, 10437, 21, 4980, 1115, 5073, 4838, 5030, 10480, 1980, 10512, 1177, 4823, 2]
// Exports: default

// Module 10524 (ForumThreadCreatedNotification)
...
require = fn;
let closure_4 = fn(10437).NOTIFICATION_PREVIEW_LINE_CLAMP;
const jsx = fn(21).jsx;
const size = fn(2);
...
export default function ForumThreadCreatedNotification(notification) {
  ...
  const callback1 = guild.useCallback(() => ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10480, dependencyMap.paths), { channelId: notification.parentChannel.id }, "in-app-notification-settings-modal"), items2);
