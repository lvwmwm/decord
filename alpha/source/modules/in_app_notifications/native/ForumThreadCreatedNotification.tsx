...
// Dependencies: [19, 10358, 21, 4910, 1115, 4989, 4768, 4960, 10401, 1980, 10433, 1177, 4753, 2]
// Exports: default

// Module 10445 (ForumThreadCreatedNotification)
...
require = fn;
let closure_4 = fn(10358).NOTIFICATION_PREVIEW_LINE_CLAMP;
const jsx = fn(21).jsx;
const size = fn(2);
...
export default function ForumThreadCreatedNotification(notification) {
  ...
  const callback1 = guild.useCallback(() => ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10401, dependencyMap.paths), { channelId: notification.parentChannel.id }, "in-app-notification-settings-modal"), items2);
