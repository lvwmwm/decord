...
// Dependencies: [19, 17, 4749, 10358, 1074, 1085, 21, 4757, 1365, 576, 2020, 10393, 4753, 1397, 10482, 7377, 1115, 7546, 10357, 10370, 10371, 10399, 11180, 1177, 5803, 12, 4989, 504, 4960, 4768, 10359, 10401, 1980, 10433, 10437, 2]
// Exports: default

// Module 10481 (ReactionNotification)
...
function ReactionNotificationBody(arg0) {
  ...
  if (null != secondaryText) {
    ...
    tmp8Result = tmp8(tmp2(4753).Text, obj3);
  }
  ...
  if (hasMessageContent) {
    ...
    if (null != messagePreview) {
      ...
      tmp8Result2 = tmp8(tmp2(10371).NativeChannelRowPreview, obj4);
    }
  }
...
export default function ReactionNotification(notification) {
  ...
  const callback1 = obj2.useCallback(() => ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10401, dependencyMap.paths), { channelId: id }, "in-app-notification-settings-modal"), items4);
