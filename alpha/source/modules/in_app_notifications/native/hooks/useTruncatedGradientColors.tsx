...
// Dependencies: [19, 4827, 4524, 576, 672, 2]
// Exports: default

// Module 10449 (useTruncatedGradientColors)
...
export default function useTruncatedGradientColors() {
  const tmp = closure_4();
  token = token(4524).useToken(nativeDefault.colors.MOBILE_ALERT_BACKGROUND_DEFAULT);
