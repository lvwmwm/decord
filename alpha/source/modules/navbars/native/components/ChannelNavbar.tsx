...
// Function ID: 13032
// Name: ChannelNavbar
// Dependencies: [19, 17, 5496, 2046, 2042, 2064, 4797, 4406, 1372, 1074, 2049, 2039, 21, 4757, 5743, 576, 504, 1115, 5241, 4910, 11144, 13032, 13033, 1177, 13034, 13035, 5806, 13036, 10558, 5341, 4753, 4601, 8532, 10017, 4577, 2028, 10891, 13037, 2]
...
export const ChannelTitleWithoutRoute = function ChannelTitleWithoutRoute(arg0) {
  ...
  if (null != stateFromStores) {
    channelName = tmp2(4910).computeChannelName(stateFromStores, UserStore, RelationshipStore);
  ...
  if (buttons != null) {
    mapped = buttons.map((onPress, index) => {
      ...
      if (hasActivitiesPrivateChannelTooltip) {
        ...
        tmp3Result = tmp3(closure_1(10891), obj2);
