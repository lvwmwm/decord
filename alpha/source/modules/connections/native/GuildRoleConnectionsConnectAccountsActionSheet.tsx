...
// Dependencies: [5, 32, 19, 17, 7354, 2109, 1386, 502, 2042, 5500, 2105, 4396, 5627, 1074, 21, 4757, 576, 4691, 5502, 1397, 4608, 1177, 5241, 4910, 4753, 1115, 5626, 11818, 7412, 9558, 11819, 11820, 12, 4458, 11821, 38, 4455, 11523, 5204, 8876, 5625, 504, 5628, 5739, 1241, 4937, 4724, 7627, 11824, 9347, 573, 4960, 9332, 1980, 9324, 11828, 7397, 11829, 7450, 5187, 2]

// Module 11817 (GuildRoleConnectionsConnectAccountsActionSheet)
...
function ConnectionsChecks(eligibilityStatesGroups) {
  ...
  obj3.children = sorted.map((item) => {
    ...
    if (tmp3) {
      const obj3 = { source: tmp5(11819), style: closure_5.connectionsChecksGroupCheckmark };
      ...
      tmp22Result = tmp22(tmp15(4753).Text, obj4);
      tmp24 = tmp22;
    } else if (tmp8) {
      const obj5 = { source: tmp5(11820), style: closure_5.connectionsChecksGroupCaret };
      ...
      tmp22Result = tmp22(tmp15(4753).Text, obj6);
      tmp24 = tmp22;
    }
    let type1;
    if (value != null) {
    ...
    if (hasItem) {
      ...
      let tmp24Result = tmp24(tmp5(11821), obj7);
    } else if (null != tmp11) {
      const obj8 = { style: closure_5.botTag, verified: tmp11.isVerifiedBot() };
      tmp24Result = tmp24(tmp5(9558), obj8);
      const tmp5Result = tmp5(9558);
    }
    ...
    const items2 = [tmp24(eligibilityStatesGroups(4753).Text, { variant: "text-md/medium", color: "mobile-text-heading-primary", children: name }), tmp24Result, ];
    ...
    if (null != tmp28) {
      ...
      const obj17 = { source: tmp5(11523), size: tmp15(1177).Icon.Sizes.SMALL_20, style: tmp38.connectionsChecksGroupTextNameInfoIcon };
          ...
          handlePlatformConnect = function handlePlatformConnect(platformType, role_connections_verification_url) {
            ...
            let obj = {
              ...
              onClose() {
                ...
                let tmp7 = null;
                const guildRoleConnectionsConnectAccountsActionSheetKey = platformType(11824).makeGuildRoleConnectionsConnectAccountsActionSheetKey(role.id);
