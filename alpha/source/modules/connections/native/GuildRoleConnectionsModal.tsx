...
// Dependencies: [19, 21, 1115, 7707, 7325, 11909, 7333, 2]

// Module 11908 (GuildRoleConnectionsModal)
...
export default noop.memo((guildId) => {
  ...
  const memo = noop.useMemo(() => {
    ...
    obj2.headerRight = function headerRight() {
      const obj = { source: onClose(7325), onPress, accessibilityLabel: null };
      const intl = guildId(1115).intl;
      obj.accessibilityLabel = intl.string(guildId(1115).t.cpT0Cq);
      return jsx(guildId(7707).HeaderActionButton, { source: onClose(7325), onPress, accessibilityLabel: null });
    };
    obj2.render = function render() {
      return jsx(onClose(11909), { guildId, onCloseModal });
    };
    obj[GUILD_ROLE_CONNECTIONS_SCREEN] = obj2;
    return obj;
  }, items);
  return jsx(guildId(7333).Navigator, { screens: memo, initialRouteName: GUILD_ROLE_CONNECTIONS_SCREEN });
});
