...
// Dependencies: [32, 19, 17, 2044, 5049, 4476, 1372, 1074, 16880, 21, 4829, 576, 4528, 504, 4982, 7706, 4825, 17017, 5286, 6871, 6660, 4563, 4830, 1115, 8362, 5935, 4781, 1241, 14073, 4451, 17014, 7716, 7714, 17018, 2]
// Exports: default
    ...
    if (null != contentMessage) {
      if (null != activeMediaPlayerSource) {
        ...
        if (memo) {
          ...
          const items3 = [tmp13(tmp2(17017).Marquee, obj7), ];
...
export default function MediaPlaybackPip() {
  ...
  const memo = obj.useMemo(() => {
    if (progress) {
      let PlayIcon = tmp2(7716).PauseIcon;
    } else {
      PlayIcon = tmp2(7714).PlayIcon;
    }
