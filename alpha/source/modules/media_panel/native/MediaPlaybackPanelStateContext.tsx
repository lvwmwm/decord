...
// Dependencies: [19, 14903, 12607, 7405, 2]

// Module 17767 (MediaPlaybackPanelStateContext)
...
obj.mode = ReanimatedHelperTypes.createFakeSharedValue(fn(14903).MediaPlaybackPanelModes.PIP);
...
obj.morphablePanelMode = ReanimatedHelperTypes.createFakeSharedValue(fn(12607).MorphablePanelModes.PIP);
ReanimatedHelperTypes = fn(7405);
