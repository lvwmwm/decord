...
// Dependencies: [19, 17, 5008, 21, 4827, 576, 10489, 1115, 4980, 1484, 5927, 7450, 7445, 504, 8947, 10491, 10492, 10498, 10505, 10511, 5271, 2]
// Exports: default

// Module 10488 (NotificationSettingsChannel)
...
export default function NotificationSettingsChannel(channel) {
  ...
  if (isForumLikeChannelResult) {
    ...
    isForumLikeChannelResult = tmp11(tmp(10511).NotificationSettingsChannelPost, obj9);
  }
  ...
  if (!inherited) {
    ...
    obj10.children = tmp11(tmp(5271).Button, obj11);
