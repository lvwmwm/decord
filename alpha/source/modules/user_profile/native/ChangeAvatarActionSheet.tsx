...
// Dependencies: [19, 17, 1372, 1074, 21, 4757, 576, 504, 4415, 7444, 7396, 1115, 8945, 5906, 5824, 8876, 14876, 2]
// Exports: default

// Module 14892 (ChangeAvatarActionSheet)
...
const UserProfileUpsellButtonDefault = tmp5(14876);
require = fn;
...
export default function ChangeAvatarActionSheet(showRemoveAvatar) {
  ...
  if (isPremiumResult) {
    isPremiumResult = tmp8(tmp2(8945).NitroWheelIcon, {});
  }
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(5824).TableRow, obj6);
  }
  items2[1] = tmp8Result;
  if (showAnimatedAvatarUpsell) {
    ...
    items3[1] = tmp8(tmp2(8945).NitroWheelIcon, obj10);
    ...
    showAnimatedAvatarUpsell = tmp8(tmp2(5824).TableRow, obj7);
  ...
  if (tmp8Result2) {
    ...
    tmp8Result2 = tmp8(tmp2(5824).TableRow, obj15);
  }
  ...
  if (flag) {
    ...
    flag = tmp8(tmp2(5824).TableRow, obj18);
  }
