...
// Dependencies: [19, 17, 1372, 1074, 21, 4829, 576, 504, 4485, 6613, 6565, 1115, 8114, 5994, 5912, 8045, 14127, 2]
// Exports: default

// Module 14143 (ChangeAvatarActionSheet)
...
const UserProfileUpsellButtonDefault = tmp5(14127);
require = fn;
...
export default function ChangeAvatarActionSheet(showRemoveAvatar) {
  ...
  if (isPremiumResult) {
    isPremiumResult = tmp8(tmp2(8114).NitroWheelIcon, {});
  }
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp2(5912).TableRow, obj6);
  }
  items2[1] = tmp8Result;
  if (showAnimatedAvatarUpsell) {
    ...
    const items3 = [tmp8(tmp2(8045).FormLabel, obj9), ];
    const obj10 = { style: tmp.nitroWheel, size: "sm" };
    items3[1] = tmp8(tmp2(8114).NitroWheelIcon, obj10);
    ...
    const items4 = [tmp8(tmp2(8045).FormSubLabel, obj12), ];
    ...
    showAnimatedAvatarUpsell = tmp8(tmp2(5912).TableRow, obj7);
  ...
  if (tmp8Result2) {
    ...
    obj16.children = tmp8(tmp2(8045).FormLabel, obj17);
    obj15.label = tmp8(View, obj16);
    obj15.onPress = handleEditAvatarDecorationSelect;
    tmp8Result2 = tmp8(tmp2(5912).TableRow, obj15);
  }
  ...
  if (flag) {
    ...
    obj18.label = tmp8(tmp2(8045).FormLabel, obj19);
    obj18.onPress = handleRemoveAvatarSelect;
    flag = tmp8(tmp2(5912).TableRow, obj18);
  }
