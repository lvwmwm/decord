...
// Dependencies: [19, 17, 2109, 2105, 2064, 7539, 1074, 1483, 21, 4827, 4524, 576, 4823, 1115, 11554, 504, 5710, 11, 11162, 5887, 11555, 1177, 8716, 7493, 8534, 11556, 4794, 4685, 1101, 7369, 4693, 1610, 8523, 11557, 5271, 7538, 2]
// Exports: default
...
const GuildIconDefault = tmp9(5887);
require = fn;
...
function MemberJoinDates(userId) {
  ...
  if (tmp13Result) {
    ...
    const items6 = [tmp15(tmp4(4823).Text, obj11), ];
...
function FriendsSinceDate(themeType) {
  ...
  if (null != friendsSinceDate) {
    ...
    items[1] = closure_1_11(tmp3(4823).Text, obj4);
    obj2.children = items;
