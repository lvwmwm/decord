...
// Dependencies: [19, 17, 4819, 9133, 8527, 7539, 1074, 1076, 21, 576, 4827, 13483, 504, 13489, 8534, 13484, 7493, 5901, 1255, 13490, 9132, 4794, 7869, 7513, 5271, 12471, 1115, 13491, 4559, 4823, 8265, 5983, 13492, 2]
// Exports: default
...
function WishlistSuggestionsGridContents(arg0) {
  ...
  if (0 === items2.length) {
    ...
    items6[1] = closure_12(tmp6(13492), obj17);
    ...
    obj8.children = closure_13(tmp6(4559).View, obj10);
    tmp12Result = tmp12(tmp(13491).WishlistAnalyticsProvider, obj8);
  }
  return tmp12Result;
}
