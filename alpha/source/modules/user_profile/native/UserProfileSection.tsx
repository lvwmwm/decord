...
// Dependencies: [19, 17, 21, 4757, 576, 4467, 7431, 4606, 8882, 4753, 2]
// Exports: default
...
export default function UserProfileSection(title) {
  ...
  if (null != primaryColor) {
    if (null != profileThemeValues) {
      let borderColor = tmp3(4606).hexOpacityToRgba(tmp3(8882).DIVIDER_COLORS[theme], profileThemeValues.dividerOpacity);
    ...
    if (null != title) {
      ...
      const items1 = [React3(tmp3(4753).Text, obj7), headerIcon];
