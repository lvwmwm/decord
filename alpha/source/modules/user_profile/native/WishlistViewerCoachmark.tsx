...
// Dependencies: [19, 17, 2039, 21, 4827, 13524, 1115, 11474, 2]
// Exports: default

// Module 13523 (WishlistViewerCoachmark)
...
function CoachmarkImage() {
  ...
  const obj2 = { source: { uri: _modDef13524 }, style: tmp.image };
  obj.children = <hasOwnProperty source={{ uri: _modDef13524 }} style={tmp.image} />;
