...
// Dependencies: [5, 19, 17, 6957, 10490, 8231, 8234, 8232, 1372, 5817, 7030, 7621, 1074, 1076, 1374, 21, 3, 4829, 576, 12642, 4537, 4682, 7628, 4796, 6956, 6598, 4825, 1115, 5274, 12251, 12643, 6578, 10195, 8659, 504, 12644, 7612, 12624, 12645, 4689, 4525, 11078, 4485, 6656, 5197, 10113, 1365, 10251, 6647, 10250, 7617, 4498, 10462, 6730, 4500, 7614, 12646, 1980, 4783, 7358, 9702, 10488, 2]
// Exports: default

// Module 12641 (UserProfileWishlistGrid)
...
let closure_9 = fn(8234).isCollectiblesWishlistItemRecord;
const getWishlistProductLines = fn(8232).getWishlistProductLines;
let Constants = fn(7621);
...
export default function UserProfileWishlistGrid(wishlistId) {
                            ...
                            if (!set.has(tmp161.skuId)) {
                              ...
                              if (obj25.isCollectibleGiftingSupported()) {
                                ...
                                obj7.onNavigateAway = function onNavigateAway() {
                                  closure_1(7617)({ userId: user.id, initialSection: constants2.WISHLIST });
                                };
  ...
  const callback = obj12.useCallback(() => {
    ...
    trackUserProfileWishlistAction(obj);
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12646, dependencyMap.paths), "EditWishlistActionSheet", { wishlistId, analyticsContext: context, analyticsLocations }, "stack");
  }, items14);
