...
// Dependencies: [5, 19, 17, 7787, 11310, 9062, 9065, 9063, 1372, 5729, 7860, 8456, 1074, 1076, 1374, 21, 3, 4757, 576, 13401, 4467, 4608, 8463, 4724, 7786, 7429, 4753, 1115, 5187, 13010, 13402, 7409, 11009, 9486, 504, 13403, 8447, 13383, 13404, 4615, 4455, 11852, 4415, 7487, 5110, 10927, 1365, 11066, 7478, 11065, 8452, 4428, 11282, 7561, 4430, 8449, 13405, 1980, 4711, 8183, 10514, 11308, 2]
// Exports: default

// Module 13400 (UserProfileWishlistGrid)
...
let closure_9 = fn(9065).isCollectiblesWishlistItemRecord;
const getWishlistProductLines = fn(9063).getWishlistProductLines;
let Constants = fn(8456);
...
export default function UserProfileWishlistGrid(wishlistId) {
                            ...
                            if (!set.has(tmp161.skuId)) {
                              ...
                              if (obj25.isCollectibleGiftingSupported()) {
                                ...
                                obj7.onNavigateAway = function onNavigateAway() {
                                  closure_1(8452)({ userId: user.id, initialSection: constants2.WISHLIST });
                                };
  ...
  const callback = obj12.useCallback(() => {
    ...
    trackUserProfileWishlistAction(obj);
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(13405, dependencyMap.paths), "EditWishlistActionSheet", { wishlistId, analyticsContext: context, analyticsLocations }, "stack");
  }, items14);
