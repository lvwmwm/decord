...
// Dependencies: [32, 19, 17, 502, 1074, 21, 4757, 576, 8942, 8943, 4753, 1115, 2020, 8944, 4467, 5806, 5199, 8528, 504, 7454, 8945, 8946, 2]
// Exports: default
...
function PersonalWidgetShowMoreButton() {
  ...
  t = tmp5(tmp(4753).Text, { variant: "text-sm/medium", color: "text-subtle", children: intl.string(isExpanded ? t["6MwJo/"] : t.lBeKY2) });
  obj2.children = t;
  ...
  if (null != source) {
    ...
    if (null != source) {
      if ("" !== section.title) {
        ...
        tmp24Result4 = tmp24(tmp14(5199), obj9);
      } else {
        tmp24Result4 = null;
      }
    }
    ...
    if (showGifTag) {
      ...
      tmp24Result5 = tmp24(tmp14(8528), obj10);
    }
...
function UserProfilePersonalWidgetCardContent(style) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = tmp4(tmp5(8946), obj3);
  }
