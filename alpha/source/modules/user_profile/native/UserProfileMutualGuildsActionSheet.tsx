...
// Dependencies: [19, 17, 21, 4829, 576, 12950, 11504, 12951, 12952, 12956, 2]
// Exports: default
...
export default function UserProfileMutualGuildsActionSheet(user) {
  ...
  if (null == mutualGuilds) {
    ...
    const obj4 = { style: tmp.emptyState, children: tmp3(user(12952).NoMutualServers, {}) };
    ...
    tmp3Result = tmp3(user(11504).UserProfileStackedActionSheetList, obj5);
  }
