...
// Dependencies: [32, 19, 17, 7885, 7877, 1074, 21, 4827, 576, 8530, 8514, 7493, 7513, 1241, 8508, 8515, 7481, 4823, 1115, 8516, 11076, 504, 14994, 8510, 8531, 14995, 13568, 13569, 8517, 11565, 5283, 2]
// Exports: default

// Module 14993 (EditProfileFrameActionSheet)
...
import EditProfileFrameSection from "EditProfileFrameSection" /* 14995 */;
...
function ProfileFrameSectionPreview(arg0) {
  ...
  const items1 = [closure_9(purchase(11565), { user, guildId, profileFrame: memo, maxWidth: 280 }), ];
