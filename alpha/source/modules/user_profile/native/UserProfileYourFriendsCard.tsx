...
// Dependencies: [32, 19, 17, 7067, 4476, 1372, 1074, 21, 1177, 4829, 504, 12602, 9292, 12, 1370, 5912, 4825, 1115, 2]
// Exports: default

// Module 16595 (UserProfileYourFriendsCard)
...
export default function UserProfileYourFriendsCard(navigateToFriends) {
  ...
  const effect = stateFromStoresArray1.useEffect(() => {
    const userAffinitiesV2 = closure_0(9292).fetchUserAffinitiesV2();
  }, []);
