...
// Dependencies: [19, 17, 2038, 21, 4756, 576, 8510, 10885, 2027, 4710, 4752, 1115, 5339, 5897, 2]
// Exports: default
...
export default function UserProfileWidgetsBoardEditNotice() {
  ...
  obj.children = function children(markAsDismissed) {
    ...
    if (markAsDismissed.visibleContent === dismissible_content.DismissibleContent.USER_PROFILE_WIDGETS_BOARD_MOBILE_EDIT_NOTICE) {
      ...
      obj5.children = hasOwnProperty(tmp(5897).XSmallIcon, { size: "sm" });
      items1[2] = hasOwnProperty(tmp(5339).PressableOpacity, obj5);
      obj.children = items1;
