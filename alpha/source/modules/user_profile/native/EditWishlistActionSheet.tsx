...
// Dependencies: [32, 19, 17, 4821, 9137, 9138, 1372, 7945, 8531, 7484, 21, 4829, 576, 4561, 4830, 504, 1612, 7495, 7515, 13493, 13494, 13474, 9143, 8539, 11504, 1115, 6957, 5992, 7533, 7406, 11390, 8269, 4786, 2]
// Exports: default
...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  let tmp5 = analyticsContext(7495);
  ...
  if (stateFromStores1) {
    ...
    obj4.children = tmp16(tmp2(6957).BottomSheetScrollView, obj5);
