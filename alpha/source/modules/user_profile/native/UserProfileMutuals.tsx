...
// Dependencies: [19, 17, 8527, 7539, 21, 4827, 8534, 12941, 13374, 4794, 12947, 1980, 8523, 7670, 5425, 13407, 1177, 4823, 12948, 12957, 5887, 12942, 2]
// Exports: default

// Module 13511 (UserProfileMutuals)
...
const DIVIDER_DOT = fn(7539).DIVIDER_DOT;
const jsxProd = fn(21);
...
export default function UserProfileMutuals(user) {
  ...
  const userProfileAnalyticsContext = user(8534).useUserProfileAnalyticsContext();
  ({ context: c2, trackUserProfileAction: c3 } = userProfileAnalyticsContext);
  let obj = user(8534);
  ({ mutualFriends, mutualGuilds } = guildId(12941)(user));
  if (guildId(13374)(user)) {
    ...
    if (tmp7) {
      ...
      const obj3 = {
        ...
        onPress() {
              ...
              ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12947, dependencyMap.paths), "UserProfileMutualsActionSheet", {
                user,
                ...
                onPressMutualGuild(arg0) {
                  ...
                  const obj = user(7670);
                  guildId(4794).hideAllActionSheets();
                }
              }, "stack");
            },
        children: null
      ...
      const items = [closure_6(tmp2(13407).AvatarPile, obj4), ];
      const obj5 = { variant, color, children: tmp5(12948)(mutualFriends.length) };
      items[1] = closure_6(tmp2(4823).Text, obj5);
      obj3.children = items;
      tmp9Result = tmp9(tmp2(5425).PressableOpacity, obj3);
    }
    ...
    if (tmp15) {
      ...
      tmp15 = closure_6(tmp2(4823).Text, obj6);
    }
    items1[1] = tmp15;
    ...
    if (tmp8) {
      ...
      if (!tmp7) {
        ...
        tmp21 = closure_6(tmp2(12957).GuildIconPile, obj8);
      }
      const items2 = [tmp21, ];
      const obj9 = { variant, color, children: tmp5(12942)(mutualGuilds.length) };
      items2[1] = closure_6(tmp2(4823).Text, obj9);
      obj7.children = items2;
      tmp9Result2 = tmp9(tmp2(5425).PressableOpacity, obj7);
    }
