...
// Dependencies: [19, 17, 8456, 7455, 21, 4757, 8463, 12859, 13292, 4724, 12865, 1980, 8452, 7587, 5341, 13325, 1177, 4753, 12866, 12875, 5803, 12860, 2]
// Exports: default

// Module 13429 (UserProfileMutuals)
...
export default function UserProfileMutuals(user) {
  ...
  const userProfileAnalyticsContext = user(8463).useUserProfileAnalyticsContext();
  ({ context: c2, trackUserProfileAction: c3 } = userProfileAnalyticsContext);
  let obj = user(8463);
  ({ mutualFriends, mutualGuilds } = guildId(12859)(user));
  if (guildId(13292)(user)) {
    ...
    if (tmp7) {
      ...
      const obj3 = {
        ...
        onPress() {
              ...
              ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12865, dependencyMap.paths), "UserProfileMutualsActionSheet", {
                user,
                ...
                onPressMutualGuild(arg0) {
                  ...
                  const obj = user(7587);
                  guildId(4724).hideAllActionSheets();
                }
              }, "stack");
            },
        children: null
      ...
      const items = [closure_6(tmp2(13325).AvatarPile, obj4), ];
      const obj5 = { variant, color, children: tmp5(12866)(mutualFriends.length) };
    ...
    if (tmp15) {
      ...
      tmp15 = closure_6(tmp2(4753).Text, obj6);
    }
    items1[1] = tmp15;
    ...
    if (tmp8) {
      ...
      if (!tmp7) {
        ...
        tmp21 = closure_6(tmp2(12875).GuildIconPile, obj8);
      }
      const items2 = [tmp21, ];
      const obj9 = { variant, color, children: tmp5(12860)(mutualGuilds.length) };
      items2[1] = closure_6(tmp2(4753).Text, obj9);
