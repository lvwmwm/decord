...
// Dependencies: [5, 19, 1372, 1074, 1374, 563, 8606, 4796, 5443, 4485, 14126, 7607, 7605, 7602, 7604, 2]
// Exports: default
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (closure_129_1) {
            tmp28(7605).setTryItOutAvatar(closure_128_4);
            const tmp28Result = tmp28(7605);
          } else {
            const obj11 = { guildId: closure_129_0, avatar: closure_128_4 };
            tmp28(7602).setPendingChanges(obj11);
            const tmp28Result2 = tmp28(7602);
