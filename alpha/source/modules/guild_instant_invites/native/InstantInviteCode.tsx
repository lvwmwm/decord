...
// Dependencies: [19, 17, 2046, 4472, 1372, 21, 4827, 576, 5325, 5384, 5269, 4823, 4980, 4789, 1115, 11276, 2]
// Exports: default

// Module 11287 (InstantInviteCode)
...
export default function InstantInviteCode(invite) {
  ...
  const items1 = [closure_8(invite(4823).Text, { variant: "text-lg/bold", tabularNumbers: true, children: invite.code }), ];
  ...
  obj.children = closure_9(invite(5269).Stack, obj2);
