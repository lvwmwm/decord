...
// Function ID: 11203
// Name: InstantInvite
// Dependencies: [19, 17, 2046, 1372, 1074, 21, 4757, 576, 504, 7415, 11203, 11204, 5110, 1115, 11205, 1101, 11207, 5826, 5185, 7419, 4753, 8178, 8183, 11211, 11212, 11214, 11217, 11219, 2]
// Exports: LinkedChannelInvite

// Module 11202 (InstantInvite)
...
import InstantInviteIconsDefault from "InstantInviteIcons" /* 11207 */;
import InstantInviteCreatorDefault from "InstantInviteCreator" /* 11212 */;
import InviteRolesDisplayDefault from "InviteRolesDisplay" /* 11217 */;
import InstantInviteUsesLabelDefault from "InstantInviteUsesLabel" /* 11219 */;
...
export default noop.memo((onInviteRevoked) => {
  ...
  const inviteActions = invite(11214).useInviteActions({ invite, onInviteRevoked: onInviteRevoked.onInviteRevoked });
  ...
  const items2 = [
    closure_8(invite(4753).Text, { variant: "text-lg/bold", tabularNumbers: true, children: invite.code }),
    closure_8(invite(8178).ContextMenu, {
      items: inviteActions,
      children(ref) {
        ...
        return closure_1_8(invite(8183).IconButton, obj);
      }
    })
  ];
  obj2.children = items2;
  const items3 = [closure_9(invite(5185).Stack, obj2), , , ];
  let obj = invite(11214);
  ...
  items3[1] = closure_8(invite(11211).InstantInviteDetails, { channel: memo, expiresAt: invite.getExpiresAt() });
  if (tmp9Result) {
  ...
  items3[3] = closure_9(invite(5185).Stack, obj8);
  obj7.children = items3;
  return closure_9(invite(5826).Card, obj7);
});
export const LinkedChannelInvite = function LinkedChannelInvite(channel) {
  ...
  canUnlinkLobbyChannel = channel(11203).useCanUnlinkLobbyChannel(channel);
  let str;
  const tmp2Result = channel(11203);
  ...
  const tmp9Result = canUnlinkLobbyChannel(11204)(channel.id, str);
  ...
  const tmp9 = canUnlinkLobbyChannel(11204);
  obj4.size = channel(7419).GameIconSizes.SIZE_24;
  const items3 = [closure_8(canUnlinkLobbyChannel(7419), obj4), ];
  ...
  obj5.children = name;
  items3[1] = closure_8(channel(4753).Text, obj5);
  obj3.children = items3;
  const items4 = [
    closure_9(View, obj3),
    closure_8(channel(8178).ContextMenu, {
      items: memo,
      children(ref) {
        const merged = Object.assign(ref, Object.assign({ ref: 0 }));
        const obj = { size: "sm", variant: "secondary", icon: canUnlinkLobbyChannel(11207).more, accessibilityLabel: null, ref: null };
        const intl = channel(1115).intl;
        obj.accessibilityLabel = intl.string(channel(1115).t.DEoVWZ);
        obj.ref = ref.ref;
        const merged1 = Object.assign(merged);
        return closure_1_8(channel(8183).IconButton, obj);
      }
    })
  ];
  obj7.children = items4;
  const items5 = [closure_9(channel(5185).Stack, obj7), closure_8(channel(11211).InstantInviteDetails, { channel }), ];
  const obj9 = { direction: "horizontal", align: "flex-end", children: null };
  const obj10 = { style: tmp.creatorWrapper, children: closure_8(canUnlinkLobbyChannel(11212), { user: stateFromStores, guildId: channel.guild_id }) };
  obj9.children = closure_8(View, obj10);
  items5[2] = closure_8(channel(5185).Stack, obj9);
  obj6.children = items5;
  return closure_9(channel(5826).Card, obj6);
};
