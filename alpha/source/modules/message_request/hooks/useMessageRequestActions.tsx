...
// Dependencies: [5, 32, 19, 7030, 11918, 1074, 11919, 10411, 4731, 9794, 7625, 1241, 11921, 2020, 8081, 2]
// Exports: useMessageRequestActions

// Module 11917 (useMessageRequestActions)
...
require = fn;
const MessageRequestConstants = fn(11918);
