...
// Dependencies: [5, 32, 19, 7943, 12783, 1074, 12784, 11307, 4727, 10685, 8531, 1241, 12786, 2020, 8983, 2]
// Exports: useMessageRequestActions

// Module 12782 (useMessageRequestActions)
...
require = fn;
const MessageRequestConstants = fn(12783);
