...
// Dependencies: [5, 32, 19, 7945, 12792, 1074, 12793, 11313, 4729, 10690, 8535, 1241, 12795, 2020, 8987, 2]
// Exports: useMessageRequestActions

// Module 12791 (useMessageRequestActions)
...
require = fn;
const MessageRequestConstants = fn(12792);
