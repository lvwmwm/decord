...
// Dependencies: [19, 17, 4472, 21, 4827, 1177, 576, 504, 4671, 17427, 1400, 4823, 1115, 17428, 17429, 2]
// Exports: default
...
export default function MessageRequestRowSenderDetails(isRestricted) {
  ...
  if (tmp9Result) {
    ...
    const items3 = [" ", tmp2(4671).getUserTag(otherUser)];
  ...
  if (!flag) {
    ...
    tmp11Result = tmp11(tmp7(17428), obj12);
  }
  ...
  if (flag) {
    ...
    flag = tmp11(tmp7(17429), obj13);
    const tmp7Result = tmp7(17429);
  }
