...
// Dependencies: [5, 7806, 4744, 1182, 502, 2044, 1346, 1074, 7994, 2051, 21, 4808, 7995, 1255, 1363, 4687, 4686, 10, 1231, 1241, 7996, 4693, 7998, 9, 1091, 1358, 7999, 5196, 5292, 1980, 2]
...
const NavigationRouteUtils = tmp(4686);
require = fn;
