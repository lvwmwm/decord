...
// Dependencies: [5, 6891, 4746, 1182, 502, 2044, 1346, 1074, 7079, 2051, 21, 4808, 7080, 1255, 1363, 4689, 4688, 10, 1231, 1241, 7081, 4695, 7083, 9, 1091, 1358, 7084, 5197, 5293, 1980, 2]
...
const NavigationRouteUtils = tmp(4688);
require = fn;
