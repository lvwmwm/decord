...
// Function ID: 8995
// Name: NodeView
// Dependencies: [32, 19, 17, 4828, 2044, 4464, 8995, 8993, 1074, 1085, 21, 4829, 576, 5903, 5293, 4825, 4678, 4783, 504, 5427, 8996, 1484, 5258, 5267, 8990, 8988, 5009, 4536, 8998, 9002, 9003, 7456, 9006, 9007, 9008, 9009, 9014, 9015, 13293, 13294, 13295, 13296, 13297, 13298, 13299, 13301, 13303, 13304, 13305, 13306, 13307, 13308, 13309, 13312, 2]
// Exports: default

// Module 8994 (NodeView)
...
import ArrowDefault from "Arrow" /* 8996 */;
...
function ChildItem(child) {
  ...
  const items1 = [closure_16(child(4825).Text, { style: tmp.childButtonText, variant: "text-md/semibold", color: "mobile-text-heading-primary", children: tmp3 }), ];
  if (stateFromStores) {
  ...
  if (stateFromStores) {
    ...
    stateFromStores = tmp9(tmp5(4825).Text, obj6);
  }
  ...
  return closure_16(child(5427).PressableHighlight, obj2);
}
...
const REMEDIATION_ELEMENT_TYPES = fn(8995).REMEDIATION_ELEMENT_TYPES;
