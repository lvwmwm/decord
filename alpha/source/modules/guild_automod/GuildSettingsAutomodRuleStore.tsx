...
// Dependencies: [5, 1074, 1115, 1243, 12, 1370, 1248, 18047, 18050, 18048, 8287, 18045, 12210, 4729, 4447, 2]
// Exports: useAutomodEditingRuleActions, useAutomodEditingRuleState

// Module 18046 (GuildSettingsAutomodRuleStore)
...
let closure_6 = identity.createWithEqualityFn((arg0, arg1) => {
  ...
  let obj = {
    ...
    createNewEditingRule(guildId, triggerType, arg2) {
      let obj = arg2;
      const obj2 = {};
      const merged = Object.assign(obj2(18047).createDefaultRule(guildId, triggerType));
      if (arg2 == null) {
        obj = {};
      }
      const merged1 = Object.assign(obj);
      const obj3 = obj2(18047);
    ...
    if (c10 === 2) {
      ...
      try {
        ...
        if (0 === c9) {
          if (arg0 === 1) {
            ...
            if (null == closure_0) {
              ...
              if (obj27.isRuleKeywordFilter(tmp97)) {
                const obj8 = closure_0(18050);
                const keywordFilter = tmp97.triggerMetadata.keywordFilter;
                dependencyMap = keywordFilter;
                if (keywordFilter == null) {
                  dependencyMap = [];
                }
                tmp97.triggerMetadata.keywordFilter = obj8.sortKeywords(closure_0(18050).dedupeKeywords(dependencyMap));
                const obj9 = closure_0(18050);
                const obj10 = closure_0(18050);
                const allowList = tmp97.triggerMetadata.allowList;
                closure_3 = allowList;
                if (allowList == null) {
                  closure_3 = [];
                }
                tmp97.triggerMetadata.allowList = obj10.sortKeywords(closure_0(18050).dedupeKeywords(closure_3));
                const obj11 = closure_0(18050);
              }
              obj27 = closure_0(18047);
              if (obj12.isRuleDefaultKeywordListFilter(tmp97)) {
                const obj13 = closure_0(18050);
                const allowList2 = tmp97.triggerMetadata.allowList;
                closure_4 = allowList2;
                if (allowList2 == null) {
                  closure_4 = [];
                }
                tmp97.triggerMetadata.allowList = obj13.sortKeywords(closure_0(18050).dedupeKeywords(closure_4));
                const obj14 = closure_0(18050);
              }
              obj12 = closure_0(18047);
              const result = closure_0(18048).validateRuleByTriggerConfigOrThrow(tmp97, tmp98);
              const obj15 = closure_0(18048);
              const result1 = closure_0(18047).validateRuleBeforeSaveOrThrow(tmp97);
              c8 = 2;
              const obj16 = closure_0(18047);
              closure_0(1248).batchUpdates(() => {
              ...
              if (obj18.isBackendPersistedRule(tmp97)) {
                if (!obj19.isDefaultRuleId(tmp97.id)) {
                  c9 = 4;
                  c10 = 1;
                  const obj21 = { value: closure_0(12210).updateAutomodRule(tmp97), done: false };
                  return obj21;
                }
                obj19 = closure_0(18045);
              }
              obj18 = closure_0(18047);
              c9 = 3;
              c10 = 1;
              const obj23 = { value: closure_0(12210).createAutomodRule(tmp97), done: false };
              return obj23;
            }
          }
        } else if (1 === tmp9) {
          ...
          if (closure_133_2 instanceof closure_0(8287).InvalidKeywordError) {
            closure_0(1248).batchUpdates(() => {
            ...
            const tmp41 = closure_133_2 instanceof closure_0(8287).InvalidRegexPatternError;
            if (!tmp41) {
              obj6.batchUpdates(() => {
          ...
          const aPIError = new closure_0(4729).APIError(closure_133_3);
...
export const useAutomodEditingRuleActions = function useAutomodEditingRuleActions() {
  return closure_6((hasChanges) => ({ hasChanges: hasChanges.hasChanges, editingRule: hasChanges.editingRule, isLoading: hasChanges.isLoading, errorMessage: hasChanges.errorMessage, saveRule: hasChanges.saveRule, saveEditingRule: hasChanges.saveEditingRule, cancelEditingRule: hasChanges.cancelEditingRule }), _mod4447.shallow);
};
export const useAutomodEditingRuleState = function useAutomodEditingRuleState(id) {
  ...
  const obj = closure_6((hasChanges) => ({ hasChanges: hasChanges.hasChanges, editingRule: hasChanges.editingRule, setEditingRule: hasChanges.setEditingRule, createNewEditingRule: hasChanges.createNewEditingRule }), _mod4447.shallow);
  if (null != tmp) {
