...
// Function ID: 18032
// Name: getRuleInfo
// Dependencies: [12198, 5394, 18032, 18034, 16227, 9628, 18035, 4769, 2]
// Exports: getRuleInfo

// Module 18031 (getRuleInfo)
import Constants from "Constants" /* 12198 */;
import _modDef18034 from "module_18034" /* 18034 */;
import BaseRuleInfo from "BaseRuleInfo" /* 18035 */;
  ...
  if (null != baseRuleInfo) {
    ...
    if (null != triggerType) {
      ...
      if (AutomodTriggerType.MENTION_SPAM === triggerType) {
        const obj3 = { IconComponent: tmp(5394).AtIcon };
        let tmp9 = obj3;
      } else if (tmp8.KEYWORD === triggerType) {
        const obj4 = { IconComponent: tmp(18032).ChannelListPlusIcon };
        tmp9 = obj4;
      } else {
        if (tmp8.ML_SPAM !== triggerType) {
          if (tmp8.USER_PROFILE !== triggerType) {
            if (tmp8.DEFAULT_KEYWORD_LIST === triggerType) {
              const obj5 = { IconComponent: tmp(16227).MenuIcon };
              tmp9 = obj5;
            } else if (tmp8.APPLICATION === triggerType) {
              const obj6 = { IconComponent: tmp(9628).RobotIcon };
              tmp9 = obj6;
            }
          }
        }
        const obj7 = { source: _modDef18034 };
        tmp9 = obj7;
      }
      if (tmp9 == null) {
        const obj8 = { IconComponent: tmp(4769).LinkIcon };
        tmp9 = obj8;
      }
      obj2.icon = tmp9;
      tmp4 = obj2;
