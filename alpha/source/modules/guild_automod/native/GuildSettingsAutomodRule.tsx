...
// Dependencies: [5, 19, 18044, 18046, 12205, 21, 4829, 576, 1484, 17405, 2020, 18047, 5201, 1115, 5929, 7707, 8951, 5271, 4825, 6936, 7533, 18061, 18072, 18075, 5992, 5910, 12210, 4522, 4729, 7522, 7373, 2]
// Exports: default

// Module 18060 (GuildSettingsAutomodRule)
...
require = fn;
const useAutomodRulesList = fn(18044).useAutomodRulesList;
const GuildSettingsAutomodRuleStore = fn(18046);
({ useAutomodEditingRuleActions: metroRequire, useAutomodEditingRuleState: closure_7 } = GuildSettingsAutomodRuleStore);
const MAX_RULE_NAME_LENGTH = fn(12205).MAX_RULE_NAME_LENGTH;
const jsxProd = fn(21);
                  ...
                  try {
                    ...
                    if (0 === c5) {
                      if (arg0 === 1) {
                        ...
                        c5 = 2;
                        c6 = 1;
                        const obj6 = { value: closure_0(12210).deleteAutomodRule(id, closure_0), done: false };
                        return obj6;
                      }
                    } else if (1 === tmp7) {
                      v0 = 0;
                      closure_129_0 = closure_3;
                      const aPIError = new closure_0(4729).APIError(closure_129_0);
                      ...
                      closure_0(4522).presentError(closure_0);
                      throw closure_129_0;
                    } else if (arg0 === 1) {
                      c6 = 3;
                      throw value;
