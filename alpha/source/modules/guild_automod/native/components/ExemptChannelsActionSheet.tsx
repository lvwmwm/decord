...
// Dependencies: [19, 7356, 2063, 4405, 1372, 21, 504, 7357, 4909, 5239, 5822, 17973, 1115, 2]
// Exports: default

// Module 17974 (ExemptChannelsActionSheet)
...
export default function ExemptChannelsActionSheet(guildId) {
  ...
  obj3.onSave = onSave;
  return jsx(stateFromStores(17973), { title: null, searchPlaceholder: null, listId: "automod-exempt-channels", items: null, initialSelected: null, getId: null, getSearchText: null, renderLabel: null, renderIcon: null, onSave: null });
};
