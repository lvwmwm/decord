...
// Dependencies: [32, 19, 17, 2042, 4472, 1372, 10083, 11725, 1074, 21, 4827, 576, 8529, 1115, 4783, 5990, 5908, 1177, 1612, 7493, 7513, 504, 8525, 7481, 1241, 6955, 8274, 4823, 4979, 7298, 4794, 11727, 1980, 1249, 5271, 10082, 8750, 2108, 4518, 2]
...
export default noop.memo(function BlockConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    if (!stateFromStores1) {
      ...
      obj17.children = tmp13(tmp7(5908).TableRow, obj18);
      obj16.children = tmp13(tmp7(5990).TableRowGroup, obj17);
    ...
    tmp13Result2 = tmp13(tmp7(7493).AnalyticsLocationProvider, obj4);
