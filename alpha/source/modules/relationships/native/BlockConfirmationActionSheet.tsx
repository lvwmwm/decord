...
// Dependencies: [32, 19, 17, 2044, 4474, 1372, 10088, 11731, 1074, 21, 4829, 576, 8533, 1115, 4785, 5992, 5910, 1177, 1612, 7495, 7515, 504, 8529, 7483, 1241, 6957, 8278, 4825, 4981, 7300, 4796, 11733, 1980, 1249, 5273, 10087, 8754, 2110, 4520, 2]
...
export default noop.memo(function BlockConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    if (!stateFromStores1) {
      ...
      obj17.children = tmp13(tmp7(5910).TableRow, obj18);
      obj16.children = tmp13(tmp7(5992).TableRowGroup, obj17);
    ...
    tmp13Result2 = tmp13(tmp7(7495).AnalyticsLocationProvider, obj4);
