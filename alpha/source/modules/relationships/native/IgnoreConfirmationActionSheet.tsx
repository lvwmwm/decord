...
// Dependencies: [32, 19, 17, 2042, 1372, 10010, 11649, 1074, 21, 4757, 576, 8458, 1115, 4713, 5906, 5824, 1177, 1612, 7409, 7429, 504, 1241, 8454, 7397, 6871, 7214, 4753, 4909, 8192, 4724, 11650, 1980, 1249, 5187, 10009, 2108, 4452, 2]
...
export default noop.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    tmp12Result = tmp12(tmp7(7409).AnalyticsLocationProvider, obj3);
