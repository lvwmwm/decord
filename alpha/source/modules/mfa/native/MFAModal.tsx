...
// Function ID: 15961
// Name: MFAModal
// Dependencies: [5, 19, 17, 21, 7196, 4960, 1115, 15961, 7622, 7239, 5843, 15962, 15963, 15968, 15971, 15972, 15973, 7247, 5110, 2]
...
class MFAModal {
  constructor(arg0) {
    ...
    memo2 = c4.useMemo(() => {
      ...
      if ("webauthn" === type) {
        let headerCloseButton = tmp(5843).getHeaderCloseButton(callback1);
        const tmpResult = tmp(5843);
      } else {
        headerCloseButton = tmp(5843).getHeaderBackButton();
        const tmpResult10 = tmp(5843);
      }
      ...
      if ("totp" === type2) {
        let headerCloseButton1 = tmp(5843).getHeaderCloseButton(callback1);
        const tmpResult11 = tmp(5843);
      } else {
        headerCloseButton1 = tmp(5843).getHeaderBackButton();
        const tmpResult12 = tmp(5843);
      }
      ...
      if ("backup" === type4) {
        let headerCloseButton2 = tmp(5843).getHeaderCloseButton(callback1);
        const tmpResult13 = tmp(5843);
      } else {
        headerCloseButton2 = tmp(5843).getHeaderBackButton();
        const tmpResult14 = tmp(5843);
      }
      ...
      if ("sms" === type6) {
        let headerCloseButton3 = tmp(5843).getHeaderCloseButton(callback1);
        const tmpResult15 = tmp(5843);
      } else {
        headerCloseButton3 = tmp(5843).getHeaderBackButton();
        const tmpResult16 = tmp(5843);
      }
      ...
      if ("password" === type8) {
        let headerCloseButton4 = tmp(5843).getHeaderCloseButton(callback1);
        const tmpResult17 = tmp(5843);
      } else {
        headerCloseButton4 = tmp(5843).getHeaderBackButton();
        const tmpResult18 = tmp(5843);
      }
