...
// Dependencies: [19, 17, 21, 6358, 15204, 6539, 5272, 4825, 15205, 6389, 2]
// Exports: default
...
export default function MFAOptionScreen(arg0) {
  ...
  if (tmp10Result5) {
    ...
    tmp10Result5 = tmp10(tmp(15205), obj8);
  }
