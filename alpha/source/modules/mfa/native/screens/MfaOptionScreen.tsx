...
// Dependencies: [19, 17, 21, 7189, 15965, 7370, 5185, 4753, 15966, 7220, 2]
// Exports: default
...
export default function MFAOptionScreen(arg0) {
  ...
  if (tmp10Result5) {
    ...
    tmp10Result5 = tmp10(tmp(15966), obj8);
  }
