...
// Dependencies: [19, 17, 21, 7273, 16019, 7454, 5269, 4823, 16020, 7304, 2]
// Exports: default
...
export default function MFAOptionScreen(arg0) {
  ...
  if (tmp10Result5) {
    ...
    tmp10Result5 = tmp10(tmp(16020), obj8);
  }
