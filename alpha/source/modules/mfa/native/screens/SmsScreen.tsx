...
// Function ID: 15961
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 1074, 21, 7187, 15953, 1115, 1271, 15957, 15952, 6848, 5186, 15955, 2]
// Exports: default

// Module 15960 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  let obj4 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15957).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, placeholder: null, errorMessage: null };
