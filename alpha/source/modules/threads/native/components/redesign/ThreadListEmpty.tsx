...
// Dependencies: [19, 17, 21, 4757, 576, 1177, 12495, 4753, 1115, 5187, 2]

// Module 17194 (ThreadListEmpty)
...
export default noop.memo((onCreateThreadPress) => {
  ...
  const obj2 = { style: tmp.iconWrapper, children: React4(native.Icon, { source: _modDef12495, size: native.Icon.Sizes.MEDIUM }) };
  ...
  if (tmp4Result) {
    ...
    tmp4Result = React4(tmp5(5187).Button, obj6);
  }
  items[3] = tmp4Result;
  obj.children = items;
