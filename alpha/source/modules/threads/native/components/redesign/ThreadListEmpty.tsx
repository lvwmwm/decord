...
// Dependencies: [19, 17, 21, 4827, 576, 1177, 12571, 4823, 1115, 5271, 2]

// Module 17268 (ThreadListEmpty)
...
export default noop.memo((onCreateThreadPress) => {
  ...
  const obj2 = { style: tmp.iconWrapper, children: React4(native.Icon, { source: _modDef12571, size: native.Icon.Sizes.MEDIUM }) };
  ...
  if (tmp4Result) {
    ...
    tmp4Result = React4(tmp5(5271).Button, obj6);
  }
  items[3] = tmp4Result;
  obj.children = items;
