...
// Function ID: 17192
// Name: ThreadList
// Dependencies: [19, 17, 21, 4757, 4753, 17192, 4493, 4467, 5186, 5190, 13018, 2051, 2053, 1115, 5824, 8878, 12494, 17194, 17195, 9002, 2]
// Exports: default

// Module 17191 (ThreadList)
...
import ThreadListTableRowDefault from "ThreadListTableRow" /* 17192 */;
import ThreadListEmptyDefault from "ThreadListEmpty" /* 17194 */;
import ThreadListLoadingIndicatorDefault from "ThreadListLoadingIndicator" /* 17195 */;
...
export default function ThreadList(onCreateThreadPress) {
  ...
  const callback1 = noop.useCallback((arg0, arg1, state, cleanUp) => {
    if (constants.EMPTY === arg1) {
      ...
      obj.children = jsx(_mod9002.AnimatedFlashList, { data: memo, ListHeaderComponent: memo2, ListHeaderComponentStyle: closure_3.header, renderItem, keyExtractor, onEndReached, onEndReachedThreshold: 0.4, accessibilityLabel: null, ListFooterComponent: null, ListFooterComponentStyle: null, contentContainerStyle: null });
      return <EnterExitCrossFadeContainer key={arg0} contentContainerStyle={closure_3.container} state={arg2} cleanUp={arg3}>{null}</EnterExitCrossFadeContainer>;
    }
  }, items4);
