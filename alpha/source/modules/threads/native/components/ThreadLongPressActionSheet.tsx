...
// Dependencies: [19, 2042, 2064, 4772, 4776, 4398, 1074, 21, 10507, 1115, 10508, 10510, 7215, 7357, 10486, 4697, 8010, 10295, 8127, 4719, 4709, 10512, 5315, 10514, 8908, 4699, 11227, 10416, 4724, 10403, 1980, 9880, 11233, 11579, 504, 7513, 12, 8151, 4910, 2020, 11246, 5803, 1177, 7444, 11273, 7446, 10895, 7436, 4454, 2]
// Exports: default

// Module 16465 (ThreadLongPressActionSheet)
...
function ThreadLongPressActionSheetConnected(channel) {
  ...
  const canMarkChannelUnread = channel(10510).useCanMarkChannelUnread(channel);
  const obj4 = channel(10510);
  ...
  const tmp14 = onClose(8151)(channel);
  const DeveloperMode = channel(2020).DeveloperMode;
  let setting = DeveloperMode.useSetting();
  const tmp15 = onClose(4910)(channel);
  if (null != stateFromStores) {
    const obj11 = { guild: stateFromStores, size: tmp(5803).GuildIconSizes.LARGE };
    let tmp19 = closure_13(tmp13(5803), obj11);
    let tmp18 = closure_13;
    const tmp13Result = tmp13(5803);
  } else {
    tmp18 = closure_13;
  ...
  if (MarkChannelUnreadExperiment.getConfig({ location: "thread_action_sheet" }).enabled) {
    if (!stateFromStores1) {
      if (canMarkChannelUnread) {
        ...
        obj14.IconComponent = tmp(10508).ChatMarkUnreadIcon;
      ...
      if (hasJoined) {
        ...
        const obj17 = {
          label: string2Result,
          IconComponent: tmp(4697).UserMinusIcon,
          isDestructive: true,
          onPress() {
        ...
        const obj18 = {
          label: stringResult,
          IconComponent: tmp(10295).GroupPlusIcon,
          onPress() {
        ...
        if (null == tmp23) {
          ...
          if (archived) {
            if (canUnarchiveThread) {
              ...
              const obj19 = {
                label: string5Result,
                IconComponent: tmp(4719).ClockIcon,
                onPress() {
            ...
            const obj20 = {
              label: string4Result,
              IconComponent: tmp(4709).XLargeIcon,
              onPress() {
          ...
          if (isThreadModerator) {
            ...
            if (isLockedThreadResult) {
              ...
              obj21.IconComponent = tmp(10512).LockUnlockedIcon;
          ...
          if (!isThreadModerator) {
            ...
            obj22.IconComponent = tmp(4699).LinkIcon;
            ...
            if (isMuted) {
              ...
              obj24.IconComponent = tmp(9880).BellIcon;
              ...
              obj24[1] = tmp(10416).BellSlashIcon;
              ...
              obj25.IconComponent = tmp(11233).ChannelNotificationIcon;
              ...
              obj26.header = tmp18(tmp(11273).ActionSheetIconHeader, obj27);
              const items8 = [
                items5.map((buttons) => {
              ...
              if (setting) {
                ...
                const obj30 = { IconComponent: tmp(10895).IdIcon };
                obj29.icon = tmp18(tmp(7446).ActionSheetRow.Icon, obj30);
                ...
                obj28.children = tmp18(tmp(7446).ActionSheetRow, obj29);
                setting = tmp18(tmp(7446).ActionSheetRow.Group, obj28, "developer-actions");
              }
              items8[1] = setting;
              obj26.children = items8;
              return closure_14(tmp(7444).ActionSheet, obj26);
            }
          } else {
            ...
            const obj31 = {
              label: string7Result,
              IconComponent: tmp(10514).PencilIcon,
              onPress() {
          ...
          const obj32 = { label: string3Result, IconComponent: tmp(8127).PhoneCallIcon, onPress: tmp23 };
  ...
  obj33.IconComponent = tmp(7215).EyeIcon;
