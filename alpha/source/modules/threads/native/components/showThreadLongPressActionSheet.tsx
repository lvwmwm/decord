...
// Dependencies: [4796, 16541, 1980, 2]
// Exports: default

// Module 16540 (showThreadLongPressActionSheet)
...
export default function showThreadLongPressActionSheet(channelId) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16541, dependencyMap.paths), "ThreadLongPressActionSheet", {
    channelId,
    onClose() {
