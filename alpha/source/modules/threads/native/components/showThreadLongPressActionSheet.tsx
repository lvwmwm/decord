...
// Dependencies: [4794, 16517, 1980, 2]
// Exports: default

// Module 16516 (showThreadLongPressActionSheet)
...
export default function showThreadLongPressActionSheet(channelId) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16517, dependencyMap.paths), "ThreadLongPressActionSheet", {
    channelId,
    onClose() {
