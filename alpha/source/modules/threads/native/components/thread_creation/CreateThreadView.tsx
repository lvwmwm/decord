...
// Dependencies: [5, 32, 19, 17, 5193, 7095, 1074, 21, 4829, 576, 8598, 7191, 6578, 6598, 1612, 6397, 5430, 5380, 16399, 6616, 1115, 16401, 11451, 11426, 12121, 10887, 1485, 1241, 5009, 4696, 1101, 9707, 16400, 4697, 2]

// Module 16398 (CreateThreadView)
...
import useCreateThreadViewPropsDefault from "useCreateThreadViewProps" /* 10887 */;
...
function CreateThreadViewInner(screenIndex) {
  ...
  const effect = noop.useEffect(() => () => {
    parentChannel(7191).clearDraft(user.id, DraftType.ThreadSettings);
    const obj = parentChannel(7191);
    parentChannel(7191).clearDraft(user.id, DraftType.FirstThreadMessage);
  }, items);
  ...
  const tmp12Result = parentChannel(9707)(obj4);
          ...
          if (0 === v2) {
            if (arg0 === 1) {
              ...
              if (!current) {
                ...
                if (null == parentMessageId.parentMessageId) {
                  current(closure_0(16400).makeEmptyTitleError());
                  const obj8 = closure_0(16400);
                  closure_0(4697).dismissKeyboard();
                  tmp60.current = false;
                  c5 = 0;
                  c7 = 3;
                  return { value: "HermesInternal", done: null };
            ...
            if (1 === current) {
              ...
              if (code === constants.AUTOMOD_TITLE_BLOCKED) {
                current(closure_0(16400).makeAutomodViolationError(closure_130_0.body, closure_0));
                const obj5 = closure_0(16400);
                closure_0(4697).dismissKeyboard();
                const obj6 = closure_0(4697);
              } else {
                ...
                if (tmp23) {
                  current(closure_0(16400).makeApiNameRequiredError());
                  const obj3 = closure_0(16400);
                  closure_0(4697).dismissKeyboard();
                  const obj4 = closure_0(4697);
                }
              }
            } else if (arg0 === 1) {
              c7 = 3;
              ...
              parentChannel(7191).saveDraft(closure_0.id, "", DraftType.FirstThreadMessage);
              c5 = 0;
              const obj = parentChannel(7191);
            }
            current = tmp60;
  ...
  const tmp12 = parentChannel(9707);
  const tmp11Result = parentChannel(6578);
  const tmp16 = parentChannel(1612)();
  const ref = noop.useRef(null);
  const ref1 = noop.useRef(null);
  let obj5 = { value: tmp11Result(parentChannel(6598).CREATE_THREAD).analyticsLocations, children: null };
  const items3 = [closure_13(parentChannel(5430), { absolute: true }), ];
  let obj6 = { style: null, children: null };
  const items4 = [tmp.container, { marginBottom: parentChannel(6397)({ isKeyboardAwareOnAndroid: false, includeKeyboardHeight: true }).insets.bottom - tmp16.bottom }];
  obj6.style = items4;
  ...
  const items6 = [closure_13(closure_6, { style: tmp.threadIconContainer, children: closure_13(require("ThreadIcon").ThreadIcon, { size: "lg" }) }), closure_13(parentChannel(16399), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
  let tmp22Result = null;
  if (!isForumLikeChannelResult) {
    tmp22Result = null;
    if (null == threadSettingsDraft.parentMessageId) {
      tmp22Result = null;
      if (privateThreadMode !== tmp2(8598).PrivateThreadMode.Disabled) {
        const obj12 = { style: tmp.optionPrivateThread, children: null };
        const obj13 = { start: true, end: true, disabled: privateThreadMode !== tmp2(8598).PrivateThreadMode.Enabled, label: null, subLabel: null, value: null, onValueChange: null };
        const intl = tmp2(1115).intl;
        obj13.label = intl.string(tmp2(1115).t.F1zyvU);
        const intl2 = tmp2(1115).intl;
        obj13.subLabel = intl2.string(tmp2(1115).t.Wy5RIQ);
        obj13.value = tmp2(8598).getIsPrivate(threadSettingsDraft, privateThreadMode);
        ...
        obj12.children = tmp22(tmp2(6616).TableSwitchRow, obj13);
        tmp22Result = tmp22(tmp23, obj12);
        const tmp2Result = tmp2(8598);
      }
    }
  }
  ...
  if (null != threadSettingsDraft.parentMessageId) {
    ...
    items8[1] = tmp22(tmp2(16401).ThreadCreationStarterMessage, obj16);
  ...
  if (parentChannel.rateLimitPerUser > 0) {
    ...
    obj17.children = tmp22(tmp11(11451), obj18);
    tmp22Result2 = tmp22(tmp23, obj17);
  }
  items5[2] = tmp22Result2;
  items5[3] = closure_13(parentChannel(11426), { ref, channel: parentChannel, onJumpToPresent, screenIndex: screenIndex.screenIndex, secondaryTextFieldRef: ref1, threadCreationCallback: callback1 });
  items5[4] = closure_13(parentChannel(12121), { channelId: parentChannel.id });
