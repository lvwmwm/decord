...
// Dependencies: [5, 32, 19, 17, 5192, 8010, 1074, 21, 4829, 576, 9500, 8106, 7495, 7515, 1612, 7314, 5429, 5379, 17184, 7533, 1115, 17186, 12325, 12300, 12990, 11707, 1485, 1241, 5009, 4694, 1101, 10603, 17185, 4695, 2]

// Module 17183 (CreateThreadView)
...
import useCreateThreadViewPropsDefault from "useCreateThreadViewProps" /* 11707 */;
...
function CreateThreadViewInner(screenIndex) {
  ...
  const effect = noop.useEffect(() => () => {
    parentChannel(8106).clearDraft(user.id, DraftType.ThreadSettings);
    const obj = parentChannel(8106);
    parentChannel(8106).clearDraft(user.id, DraftType.FirstThreadMessage);
  }, items);
  ...
  const tmp12Result = parentChannel(10603)(obj4);
          ...
          if (0 === v2) {
            if (arg0 === 1) {
              ...
              if (!current) {
                ...
                if (null == parentMessageId.parentMessageId) {
                  current(closure_0(17185).makeEmptyTitleError());
                  const obj8 = closure_0(17185);
                  closure_0(4695).dismissKeyboard();
                  tmp60.current = false;
                  c5 = 0;
                  c7 = 3;
                  return { value: "HermesInternal", done: null };
            ...
            if (1 === current) {
              ...
              if (code === constants.AUTOMOD_TITLE_BLOCKED) {
                current(closure_0(17185).makeAutomodViolationError(closure_130_0.body, closure_0));
                const obj5 = closure_0(17185);
                closure_0(4695).dismissKeyboard();
                const obj6 = closure_0(4695);
              } else {
                ...
                if (tmp23) {
                  current(closure_0(17185).makeApiNameRequiredError());
                  const obj3 = closure_0(17185);
                  closure_0(4695).dismissKeyboard();
                  const obj4 = closure_0(4695);
                }
              }
            } else if (arg0 === 1) {
              c7 = 3;
              ...
              parentChannel(8106).saveDraft(closure_0.id, "", DraftType.FirstThreadMessage);
              c5 = 0;
              const obj = parentChannel(8106);
            }
            current = tmp60;
  ...
  const tmp12 = parentChannel(10603);
  const tmp11Result = parentChannel(7495);
  const tmp16 = parentChannel(1612)();
  const ref = noop.useRef(null);
  const ref1 = noop.useRef(null);
  let obj5 = { value: tmp11Result(parentChannel(7515).CREATE_THREAD).analyticsLocations, children: null };
  const items3 = [closure_13(parentChannel(5429), { absolute: true }), ];
  let obj6 = { style: null, children: null };
  const items4 = [tmp.container, { marginBottom: parentChannel(7314)({ isKeyboardAwareOnAndroid: false, includeKeyboardHeight: true }).insets.bottom - tmp16.bottom }];
  obj6.style = items4;
  ...
  const items6 = [closure_13(closure_6, { style: tmp.threadIconContainer, children: closure_13(require("ThreadIcon").ThreadIcon, { size: "lg" }) }), closure_13(parentChannel(17184), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
  let tmp22Result = null;
  if (!isForumLikeChannelResult) {
    tmp22Result = null;
    if (null == threadSettingsDraft.parentMessageId) {
      tmp22Result = null;
      if (privateThreadMode !== tmp2(9500).PrivateThreadMode.Disabled) {
        const obj12 = { style: tmp.optionPrivateThread, children: null };
        const obj13 = { start: true, end: true, disabled: privateThreadMode !== tmp2(9500).PrivateThreadMode.Enabled, label: null, subLabel: null, value: null, onValueChange: null };
        const intl = tmp2(1115).intl;
        obj13.label = intl.string(tmp2(1115).t.F1zyvU);
        const intl2 = tmp2(1115).intl;
        obj13.subLabel = intl2.string(tmp2(1115).t.Wy5RIQ);
        obj13.value = tmp2(9500).getIsPrivate(threadSettingsDraft, privateThreadMode);
        ...
        obj12.children = tmp22(tmp2(7533).TableSwitchRow, obj13);
        tmp22Result = tmp22(tmp23, obj12);
        const tmp2Result = tmp2(9500);
      }
    }
  }
  ...
  if (null != threadSettingsDraft.parentMessageId) {
    ...
    items8[1] = tmp22(tmp2(17186).ThreadCreationStarterMessage, obj16);
  ...
  if (parentChannel.rateLimitPerUser > 0) {
    ...
    obj17.children = tmp22(tmp11(12325), obj18);
    tmp22Result2 = tmp22(tmp23, obj17);
  }
  items5[2] = tmp22Result2;
  items5[3] = closure_13(parentChannel(12300), { ref, channel: parentChannel, onJumpToPresent, screenIndex: screenIndex.screenIndex, secondaryTextFieldRef: ref1, threadCreationCallback: callback1 });
  items5[4] = closure_13(parentChannel(12990), { channelId: parentChannel.id });
