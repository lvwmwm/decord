...
// Dependencies: [5, 2048, 502, 2044, 4464, 8095, 4466, 8105, 1074, 2051, 1271, 573, 5195, 1115, 5009, 8106, 8107, 8110, 8111, 1370, 2055, 2]
...
const ApplicationCommandActionCreators = tmp(8107);
require = fn;
