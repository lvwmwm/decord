...
// Dependencies: [5, 2046, 502, 2042, 4462, 8093, 4464, 8103, 1074, 2049, 1271, 573, 5193, 1115, 5007, 8104, 8105, 8108, 8109, 1370, 2053, 2]
...
const ApplicationCommandActionCreators = tmp(8105);
require = fn;
