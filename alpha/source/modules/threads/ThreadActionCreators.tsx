...
// Dependencies: [5, 2048, 502, 2044, 4466, 7180, 4468, 7190, 1074, 2051, 1271, 573, 5196, 1115, 5009, 7191, 7192, 7195, 7196, 1370, 2055, 2]
...
const ApplicationCommandActionCreators = tmp(7192);
require = fn;
