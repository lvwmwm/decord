...
// Dependencies: [5, 2046, 502, 2042, 4396, 8011, 4398, 8021, 1074, 2049, 1271, 573, 5109, 1115, 4937, 8022, 8023, 8026, 8027, 1370, 2053, 2]
...
const ApplicationCommandActionCreators = tmp(8023);
require = fn;
