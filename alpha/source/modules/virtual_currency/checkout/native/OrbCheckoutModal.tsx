...
// Dependencies: [19, 1074, 1085, 21, 13549, 11393, 5269, 13550, 11623, 11152, 1241, 13551, 5030, 8768, 8769, 12262, 38, 1255, 1115, 5927, 11545, 2]
// Exports: default
...
function OrbCheckoutModalContent(orbBalance) {
  ...
  if (tmp6) {
    ...
    tmp6 = closure_1_11(tmp(13550).OrbCheckoutErrorCard, obj3);
  }
  const items = [tmp6, , ];
  if (product == null) {
    product = null;
