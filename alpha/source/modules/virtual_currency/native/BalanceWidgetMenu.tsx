...
// Dependencies: [19, 1074, 1076, 2039, 5663, 21, 5824, 4753, 1115, 10891, 2028, 1241, 12024, 5666, 16022, 9134, 4724, 11373, 1980, 7429, 7786, 11372, 4577, 5203, 2]
// Exports: default
...
export default function BalanceWidgetMenuWrapper() {
  ...
  if (null == balance) {
    ...
    obj2.trailing = jsx(tmp(5203).Ellipsis, { variant: "primary", size: "sm" });
