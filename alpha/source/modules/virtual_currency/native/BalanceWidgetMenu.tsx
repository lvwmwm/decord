...
// Dependencies: [19, 1074, 1076, 2041, 5749, 21, 5910, 4825, 1115, 10973, 2028, 1241, 12108, 5752, 16097, 9209, 4796, 11455, 1980, 7515, 7871, 11454, 4649, 5289, 2]
// Exports: default

// Module 16096 (BalanceWidgetMenu)
...
import BalanceWidgetPillButtonDefault from "BalanceWidgetPillButton" /* 11454 */;
  ...
  constructor() {
    ...
    obj.children = function children(markAsDismissed) {
      ...
      if (markAsDismissed.visibleContent === markAsDismissed(2028).DismissibleContent.VIRTUAL_CURRENCY_MOBILE_ONBOARDING_PILL) {
        ...
        obj.trailing = closure_9(closure_1(16097), {});
...
function BalanceWidgetMenu() {
  str = str(9209).useFetchVirtualCurrencyBalance().balance;
  let items = [str];
  const callback = noop.useCallback(() => {
    ...
    obj4.onButtonPress = function onButtonPress() {
      ...
      const result = str(7871).openCollectiblesShopMobile(obj5);
    };
    ...
    obj5.onButtonPress = function onButtonPress() {
      ...
      ActionSheetActionCreatorsDefault.hideActionSheet();
      const obj4 = str(12108);
      obj4.openQuestHome({ mergeExistingRoutes: true, filter: constants3.VIRTUAL_CURRENCY, fromContent: str(5752).QuestContent.ORBS_BALANCE_MENU });
    };
...
export default function BalanceWidgetMenuWrapper() {
  ...
  if (null == balance) {
    ...
    obj2.trailing = jsx(tmp(5289).Ellipsis, { variant: "primary", size: "sm" });
