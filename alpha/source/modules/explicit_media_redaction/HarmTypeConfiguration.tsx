...
// Dependencies: [1074, 7626, 5059, 7627, 2020, 7628, 7631, 1186, 2]

// Module 7625 (HarmTypeConfiguration)
...
obj3[obj.EXPLICIT] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    let tmp9;
    if (tmp != null) {
      tmp9 = tmp[tmp7(undefined, 7627).ContentHarmTypeChannel.GUILD];
    }
    ...
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 7627).ContentHarmTypeChannel.FRIEND_DM];
    }
    ...
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 7627).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
