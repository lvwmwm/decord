...
// Dependencies: [1372, 7846, 8125, 1186, 1115, 7845, 8686, 8688, 4724, 15107, 1980, 7536, 7541, 2]
// Exports: handleSensitiveMediaFilterPress, shouldAgeVerifyForSearchMedia

// Module 15106 (ExplicitMediaRedactionNativeUtils)
...
export const handleSensitiveMediaFilterPress = function handleSensitiveMediaFilterPress(arg0) {
  ...
  if (tmp5) {
    ...
    obj.onPress = function onPress() {
      if (obj.shouldAgeVerifyForExplicitMedia()) {
        const obj3 = { entryPoint: tmp(8688).AgeVerificationModalEntryPoint.OBSCURED_MEDIA };
  ...
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15107, dependencyMap.paths), closure_4, { title, subtitle, options: items, currentValue });
};
  ...
  if (null == found) {
    ...
    if (0 === enabledHarmTypesForMessage) {
      ...
      if (tmp2) {
        ...
        if (result) {
          result = tmp4(7845).shouldAgeVerifyForExplicitMedia();
          const tmp4Result2 = tmp4(7845);
        }
        tmp2 = result;
