...
// Dependencies: [19, 17, 21, 11677, 11678, 11679, 11680, 11681, 11682, 1115, 4827, 4761, 4678, 7768, 12, 5290, 4823, 2]
// Exports: default

// Module 11676 (ChannelFollowSuccessAlert)
...
const common_AlertDefault = tmp2(5290);
require = fn;
