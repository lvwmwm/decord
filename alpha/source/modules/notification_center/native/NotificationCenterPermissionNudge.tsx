...
// Dependencies: [32, 19, 17, 1074, 2039, 12750, 21, 4827, 576, 1241, 10495, 4823, 1115, 5271, 12751, 5425, 5983, 15823, 7716, 2028, 2]
// Exports: default

// Module 16813 (NotificationCenterPermissionNudge)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  const obj2 = { style: tmp.iconContainer, children: closure_14(onDismiss(10495).BellSlashIcon, { size: "md", color: nativeDefault.colors.ICON_STRONG }) };
  ...
  const items1 = [closure_14(onDismiss(4823).Text, obj5), , ];
  ...
  items1[1] = closure_14(onDismiss(4823).Text, obj6);
  ...
  obj9.onPress = function onPress() {
    const pushNotificationPermission = onDismiss(12751).requestPushNotificationPermission(constants2.ALLOW_TO_REQUEST, constants3.NOTIFICATION_CENTER, closure_1_8);
    const obj = onDismiss(12751);
  ...
  obj8.children = closure_14(onDismiss(5271).Button, obj9);
  ...
  obj10.children = closure_14(onDismiss(5983).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = closure_14(onDismiss(5425).PressableHighlight, obj10);
  obj.children = items;
