...
// Dependencies: [32, 19, 17, 1074, 2039, 12668, 21, 4757, 576, 1241, 10416, 4753, 1115, 5187, 12669, 5341, 5899, 15769, 7633, 2028, 2]
// Exports: default

// Module 16761 (NotificationCenterPermissionNudge)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  const obj2 = { style: tmp.iconContainer, children: closure_14(onDismiss(10416).BellSlashIcon, { size: "md", color: nativeDefault.colors.ICON_STRONG }) };
  ...
  const items1 = [closure_14(onDismiss(4753).Text, obj5), , ];
  ...
  items1[1] = closure_14(onDismiss(4753).Text, obj6);
  ...
  obj9.onPress = function onPress() {
    const pushNotificationPermission = onDismiss(12669).requestPushNotificationPermission(constants2.ALLOW_TO_REQUEST, constants3.NOTIFICATION_CENTER, closure_1_8);
    const obj = onDismiss(12669);
  ...
  obj8.children = closure_14(onDismiss(5187).Button, obj9);
  ...
  obj10.children = closure_14(onDismiss(5899).XSmallIcon, { size: "sm", color: "icon-strong" });
