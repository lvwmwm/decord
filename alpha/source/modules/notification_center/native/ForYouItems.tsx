...
// Function ID: 16770
// Name: ForYouItems
// Dependencies: [5, 32, 19, 17, 4749, 4984, 2042, 2064, 1372, 16763, 1074, 6839, 21, 4757, 4753, 576, 5207, 16768, 1115, 1385, 8305, 8006, 11515, 10686, 8902, 504, 8135, 1177, 12885, 16770, 1484, 4737, 14126, 7879, 1241, 13499, 16771, 11878, 4455, 11901, 1980, 4724, 16773, 4714, 16765, 7441, 16774, 16775, 11, 5341, 16776, 7880, 13432, 1485, 2020, 8126, 16786, 16787, 16788, 16789, 16790, 16796, 675, 16797, 16798, 1370, 16767, 9002, 16799, 2]
...
function ForYouMessagePreviewV2(item) {
  ...
  if (null == ATTACHMENT) {
    ...
    items3[1] = tmp21(tmp2(4753).Text, obj5);
