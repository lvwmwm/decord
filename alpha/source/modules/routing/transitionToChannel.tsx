...
// Dependencies: [2044, 1074, 4841, 4842, 1101, 5030, 38, 2]
...
export const transitionToChannel = function transitionToChannel(id, openTextInVoiceIfVoiceChannel) {
  ...
  if (null != channel) {
    ...
    if (prop) {
      tmp7(5030).updateChatOpen(channel.id, true);
      const tmp7Result = tmp7(5030);
    }
...
export const tryTransitionToThreadMessage = function tryTransitionToThreadMessage(parentChannelId, threadId, messageId, arg3) {
  ...
  if (null != channel) {
    ...
    if (null != channel1) {
      ...
      if (prop) {
        tmp20(5030).updateChatOpen(channel1.id, true);
        const tmp20Result = tmp20(5030);
      }
