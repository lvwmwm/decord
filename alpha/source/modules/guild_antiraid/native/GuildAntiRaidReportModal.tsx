...
// Dependencies: [5, 32, 19, 17, 14241, 21, 4757, 576, 1612, 4753, 4452, 1115, 5906, 5823, 5187, 5843, 11197, 7209, 12089, 7247, 2]
// Exports: default

// Module 14240 (GuildAntiRaidReportModal)
...
const GuildReportRaidModalConstants = fn(14241);
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            tmp21.current = true;
            const result = tmp2(12089).trackReportRaidViewed(guildId, first);
            const obj2 = tmp2(12089);
            tmp2(12089).handleReportRaid(guildId);
