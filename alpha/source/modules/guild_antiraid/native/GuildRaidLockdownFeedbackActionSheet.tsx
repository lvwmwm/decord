...
// Dependencies: [32, 19, 1074, 21, 4757, 1115, 7763, 4724, 7444, 7396, 5797, 5906, 5823, 7332, 5187, 4937, 2]
// Exports: default

// Module 12090 (GuildRaidLockdownFeedbackActionSheet)
...
export default function GuildRaidLockdownFeedbackActionSheet(guildId) {
  ...
  const tmp9 = raid_lockdown_feedback_type(5797);
  const items1 = [
    closure_6(guildId(5906).TableRowGroup, {
      hasIcons: false,
  ...
  let hasItem = raid_lockdown_feedback_type.includes(guildId(7763).RaidLockdownFeedbackType.OTHER);
  if (hasItem) {
  ...
  items1[2] = closure_6(guildId(5187).Button, obj12);
  obj9.children = items1;
  obj7.children = tmp8(tmp9, obj9);
  return closure_6(guildId(7444).ActionSheet, obj7);
};
