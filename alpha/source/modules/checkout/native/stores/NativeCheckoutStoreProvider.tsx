...
// Dependencies: [5, 32, 19, 17, 7752, 1074, 4809, 21, 4827, 5901, 11149, 573, 7757, 7758, 5880, 1255, 1231, 5288, 11152, 1241, 11156, 2]
// Exports: default

// Module 11148 (NativeCheckoutStoreProvider)
...
function NativeCheckoutStoreProvider(children) {
  ...
  const contextMetadata = order(5901)(() => {
    let id;
    if (order != null) {
      id = order.id;
    }
  ...
  const effect1 = noop.useEffect(() => () => {
    ...
    if (null != orderRecord) {
      ...
      checkoutInitParameters(11156).discardDraftOrder(obj2);
      const obj = checkoutInitParameters(11156);
...
const NativeCheckoutStore = fn(7752);
