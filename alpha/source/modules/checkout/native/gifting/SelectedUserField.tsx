...
// Dependencies: [19, 17, 21, 4827, 576, 6949, 1115, 4671, 7382, 1177, 4823, 6944, 2]
// Exports: default

// Module 11201 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    items2[1] = tmp2(tmp4(4823).Text, obj8);
    ...
    tmp2Result1 = tmp2(tmp4(4823).Text, obj9);
  }
  ...
  if (null != selectedUser) {
    ...
    obj11.children = tmp2(tmp4(6944).CircleXIcon, { size: "xs" });
