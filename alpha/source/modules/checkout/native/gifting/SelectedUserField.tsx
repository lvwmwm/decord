...
// Dependencies: [19, 17, 21, 4757, 576, 6865, 1115, 4601, 7298, 1177, 4753, 6860, 2]
// Exports: default

// Module 11125 (SelectedUserField)
...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    items2[1] = tmp2(tmp4(4753).Text, obj8);
    ...
    tmp2Result1 = tmp2(tmp4(4753).Text, obj9);
  }
  ...
  if (null != selectedUser) {
    ...
    obj11.children = tmp2(tmp4(6860).CircleXIcon, { size: "xs" });
