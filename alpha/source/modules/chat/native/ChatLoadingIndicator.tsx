...
// Dependencies: [32, 19, 17, 4819, 5580, 5047, 2096, 1372, 1979, 1074, 21, 4827, 576, 5194, 5290, 1980, 504, 4823, 13667, 4559, 4828, 1115, 5425, 2]
...
let closure_18 = noop.memo(() => {
  ...
  if (messagesCached !== false) {
    ...
    tmp4Result = tmp4(tmp(4823).Text, obj3);
  }
  items1[4] = tmp4Result;
  ...
  if (messagesReady !== true) {
    ...
    tmp4Result3 = tmp4(tmp(4823).Text, obj5);
  }
  ...
  if (connected !== true) {
    ...
    tmp4Result4 = tmp4(tmp(4823).Text, obj7);
  }
