...
// Dependencies: [32, 19, 17, 4984, 7354, 2064, 4578, 21, 4757, 576, 504, 7417, 1612, 7415, 7412, 5906, 5824, 4753, 6850, 5187, 2]
// Exports: default
...
export default function DevToolsAccountLinkingScreen() {
  ...
  if (null != stateFromStores) {
    if (found.length > 0) {
      ...
      mapped1 = tmp18(tmp8(5824).TableRow, { label: "No official games" });
    }
  } else {
    obj6.children = tmp18(tmp8(5824).TableRow, { label: "No guild selected" });
    const items6 = [tmp18(tmp8(5906).TableRowGroup, obj6), , , ];
    const obj7 = { style: null, children: null };
    const obj8 = { padding: tmp2(576).space.PX_12 };
    obj7.style = obj8;
    const obj9 = { label: "Application ID", value, onChange: tmp7 };
    obj7.children = tmp18(tmp8(6850).TextInput, obj9);
    ...
    items7[1] = tmp18(tmp8(5824).TableRow, obj11);
    const obj12 = { label: null };
    const _HermesInternal2 = HermesInternal;
    obj12.label = "Linked Games: " + str2;
    items7[2] = tmp18(tmp8(5824).TableRow, obj12);
    obj10.children = items7;
    items6[1] = tmp16(tmp8(5906).TableRowGroup, obj10);
    ...
    obj13.children = str7;
    obj14.trailing = tmp18(tmp8(4753).Text, obj13);
    const items8 = [tmp18(tmp8(5824).TableRow, obj14), , ];
    let str8 = "text-muted";
    if (hasAlreadyLinked) {
    ...
    obj15.children = str9;
    obj17.trailing = tmp18(tmp8(4753).Text, obj15);
    items8[1] = tmp18(tmp8(5824).TableRow, obj17);
    ...
    if (tmp16Result) {
      ...
      items10[1] = tmp18(tmp8(5824).TableRow, obj26);
      obj25.children = items10;
      tmp16Result = tmp16(tmp8(5906).TableRowGroup, obj25);
    }
