...
// Dependencies: [5, 32, 19, 17, 15118, 502, 21, 11289, 8697, 10485, 15119, 11389, 15121, 9404, 15123, 13369, 15125, 15127, 15129, 15131, 9802, 15133, 15135, 15137, 15139, 6793, 4829, 576, 5272, 6019, 5274, 4796, 15141, 6566, 6565, 5994, 5912, 4779, 504, 6397, 2]
// Exports: default
...
export default function DevToolsGeneratedTestUsersScreen() {
  ...
  if (tmp5Result) {
    tmp5Result = tmp5(stateFromStoresArray(5912).TableRow, { label: "No pools available." });
  }
