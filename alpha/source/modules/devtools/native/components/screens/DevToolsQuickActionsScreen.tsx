...
// Dependencies: [32, 5, 19, 17, 4825, 5589, 1373, 2112, 1182, 1184, 1372, 7132, 1074, 12202, 1374, 10905, 1185, 21, 4836, 576, 12262, 573, 12201, 8659, 13999, 5039, 15225, 1981, 10946, 2026, 2029, 14316, 14318, 13242, 4528, 15117, 5082, 1613, 504, 2021, 15241, 5999, 6621, 15132, 1177, 14816, 4685, 14876, 15242, 9713, 1115, 5917, 14972, 5924, 6377, 15243, 15246, 15284, 6387, 1231, 1350, 1364, 2]
// Exports: default
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp9) {
    return closure_21(tmp2(15241).default, {});
  } else {
    ...
    const obj12 = { label: str, disabled: usingSystemTheme, icon: tmp15(tmp2(14816).ThemeLightIcon, {}), value: tmp2(4685).isThemeLight(stateFromStoresObject.theme), onValueChange: handleThemeChange };
    const items6 = [tmp15(tmp2(6621).TableSwitchRow, obj12), ];
    const obj13 = { label: "Reduced Motion", icon: tmp15(tmp2(14876).AccessibilityIcon, {}), value: stateFromStores, onValueChange: handleReducedMotionChange };
    ...
    const obj18 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp12, icon: tmp15(tmp2(14972).LanguageIcon, {}), trailing: tmp15(tmp2(5924).TableRowArrow, {}) };
    ...
    obj20.icon = tmp15(tmp2(15117).WrenchIcon, {});
    ...
    const obj26 = { label: "Test captcha", onPress: tmp2(15284).showCaptchaTestModal, icon: tmp15(tmp2(6377).KeyIcon, {}), trailing: tmp15(tmp2(5924).TableRowArrow, {}) };
