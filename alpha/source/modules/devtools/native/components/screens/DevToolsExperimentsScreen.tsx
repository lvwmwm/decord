...
// Dependencies: [32, 19, 17, 4672, 502, 2064, 4673, 21, 4757, 576, 11739, 11740, 7228, 7296, 12071, 12, 1177, 8505, 7297, 7302, 8140, 4677, 4724, 5824, 4753, 1254, 12068, 5906, 8138, 7436, 4455, 4716, 7397, 7396, 2]
...
function GuildExperimentDebugView(arg0) {
  ...
  if (0 === mapped.length) {
    let mapped3 = tmp19(tmp20(5824).TableRow, { label: "none" });
  } else {
