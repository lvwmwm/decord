...
// Dependencies: [5, 19, 17, 1220, 12911, 2066, 4650, 16103, 1074, 21, 4829, 576, 1271, 4416, 4726, 12837, 15976, 7533, 12843, 2025, 2028, 1612, 504, 4825, 5992, 5910, 2]
// Exports: default
...
function GuildDCSwitchRow(dc) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (arg0) {
      const result = tmp(12843).markContentAsDismissed(dc, guildId, false);
