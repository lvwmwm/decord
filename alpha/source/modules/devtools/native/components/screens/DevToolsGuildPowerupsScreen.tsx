...
// Dependencies: [5, 19, 17, 1220, 12902, 2064, 4648, 16081, 1074, 21, 4827, 576, 1271, 4414, 4724, 12828, 15962, 7531, 12834, 2025, 2028, 1612, 504, 4823, 5990, 5908, 2]
// Exports: default
...
function GuildDCSwitchRow(dc) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (arg0) {
      const result = tmp(12834).markContentAsDismissed(dc, guildId, false);
