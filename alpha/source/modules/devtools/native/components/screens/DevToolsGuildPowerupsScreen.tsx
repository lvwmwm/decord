...
// Dependencies: [5, 19, 17, 1220, 12820, 2064, 4578, 16028, 1074, 21, 4757, 576, 1271, 4348, 4654, 12746, 15908, 7447, 12752, 2025, 2028, 1612, 504, 4753, 5906, 5824, 2]
// Exports: default
...
function GuildDCSwitchRow(dc) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (arg0) {
      const result = tmp(12752).markContentAsDismissed(dc, guildId, false);
