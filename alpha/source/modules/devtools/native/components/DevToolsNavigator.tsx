...
// Dependencies: [19, 17, 21, 8245, 7333, 14954, 8194, 16144, 9630, 4825, 576, 15938, 15061, 4796, 5032, 4694, 2]
// Exports: navigateToDevTools

// Module 14953 (DevToolsNavigator)
import Types from "Types" /* 4694 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4796 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 5032 */;
import HeaderShared from "HeaderShared" /* 8194 */;
import SettingHookHarnessDefault from "SettingHookHarness" /* 14954 */;
import DevToolsContentDefault from "DevToolsContent" /* 16144 */;
...
let closure_8 = noop.memo((screenKey) => {
      ...
      options() {
        return {
          headerTitle() {
            ...
            const items = [closure_1_4(closure_1_0(9630).HammerIcon, { size: "sm" }), ];
            ...
            items[1] = closure_1_4(closure_1_0(4825).Text, obj2);
            obj.children = items;
  ...
  let merged = Object.assign(tmp(15938).DevToolsScreens);
  let merged1 = Object.assign(tmp(15938).PerformanceTestingScreens);
