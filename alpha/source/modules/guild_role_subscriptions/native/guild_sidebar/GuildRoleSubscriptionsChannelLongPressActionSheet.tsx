...
// Dependencies: [19, 17, 2049, 21, 4827, 576, 7528, 7480, 1177, 13118, 1115, 8947, 16501, 11303, 2]
// Exports: default

// Module 16608 (GuildRoleSubscriptionsChannelLongPressActionSheet)
...
export default function GuildRoleSubscriptionsChannelLongPressActionSheet(arg0) {
  ...
  const tmp = closure_7();
  obj3.children = closure_5(native.Icon, { disableColor: true, source: _modDef13118 });
  ...
  const obj4 = { disableColor: true, source: _modDef13118 };
  obj5.leading = closure_5(native.Icon, { source: _modDef16501 });
