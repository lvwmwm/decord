...
// Dependencies: [19, 17, 2049, 21, 4757, 576, 7444, 7396, 1177, 13036, 1115, 8876, 16449, 11227, 2]
// Exports: default

// Module 16556 (GuildRoleSubscriptionsChannelLongPressActionSheet)
...
export default function GuildRoleSubscriptionsChannelLongPressActionSheet(arg0) {
  ...
  const tmp = closure_7();
  obj3.children = closure_5(native.Icon, { disableColor: true, source: _modDef13036 });
  ...
  const obj4 = { disableColor: true, source: _modDef13036 };
  obj5.leading = closure_5(native.Icon, { source: _modDef16449 });
