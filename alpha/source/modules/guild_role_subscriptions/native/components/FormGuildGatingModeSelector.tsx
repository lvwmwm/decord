...
// Dependencies: [19, 17, 21, 4827, 18264, 5194, 1115, 4823, 18266, 12139, 18267, 2]
// Exports: default

// Module 18263 (FormGuildGatingModeSelector)
...
export default function FormGuildGatingModeSelector(isFullServerGating) {
  ...
  const tmp = closure_8();
  dependencyMap = tmp;
  const roleSubscriptionSettingsDisabled = isFullServerGating(18264).useRoleSubscriptionSettingsDisabled();
  let items = [onChange];
  ...
  let obj = isFullServerGating(18264);
  obj3.icon = onChange(12139);
  ...
  const items2 = [closure_5(onChange(18266), obj3), closure_5(View, { style: tmp.space }), ];
  let obj5 = { icon: null, title: null, description: null, selected: null, onPress: null, disabled: null };
  let obj4 = { style: tmp.space };
  const tmp5 = onChange(18266);
  obj5.icon = onChange(18267);
  ...
  items2[2] = closure_5(onChange(18266), obj5);
