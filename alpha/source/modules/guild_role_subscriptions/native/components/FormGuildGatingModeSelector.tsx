...
// Dependencies: [19, 17, 21, 4757, 18195, 5110, 1115, 4753, 18197, 12062, 18198, 2]
// Exports: default

// Module 18194 (FormGuildGatingModeSelector)
...
export default function FormGuildGatingModeSelector(isFullServerGating) {
  ...
  const tmp = closure_8();
  dependencyMap = tmp;
  const roleSubscriptionSettingsDisabled = isFullServerGating(18195).useRoleSubscriptionSettingsDisabled();
  let items = [onChange];
  ...
  let obj = isFullServerGating(18195);
  obj3.icon = onChange(12062);
  ...
  const items2 = [closure_5(onChange(18197), obj3), closure_5(View, { style: tmp.space }), ];
  let obj5 = { icon: null, title: null, description: null, selected: null, onPress: null, disabled: null };
  let obj4 = { style: tmp.space };
  const tmp5 = onChange(18197);
  obj5.icon = onChange(18198);
  ...
  items2[2] = closure_5(onChange(18197), obj5);
