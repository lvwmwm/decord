...
// Dependencies: [19, 17, 21, 4827, 576, 7454, 4823, 15552, 1115, 1612, 5271, 1484, 2]
// Exports: default

// Module 18273 (GuildRoleSubscriptionTierEditStep)
...
function Footer(arg0) {
  ...
  obj.style = items;
  obj.children = timestampProducer(tmp5(5271).Button, { loading: submitting, disabled: !canProceedToNextStep, text: stringResult, onPress: onProceed });
