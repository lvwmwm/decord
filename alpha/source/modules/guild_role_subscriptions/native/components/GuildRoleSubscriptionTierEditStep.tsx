...
// Dependencies: [19, 17, 21, 4757, 576, 7370, 4753, 15498, 1115, 1612, 5187, 1484, 2]
// Exports: default

// Module 18204 (GuildRoleSubscriptionTierEditStep)
...
function Footer(arg0) {
  ...
  obj.style = items;
  obj.children = timestampProducer(tmp5(5187).Button, { loading: submitting, disabled: !canProceedToNextStep, text: stringResult, onPress: onProceed });
