...
// Function ID: 10560
// Name: ShinyButton
// Dependencies: [19, 21, 4756, 576, 5187, 1177, 10560, 2]
// Exports: default

// Module 10559 (ShinyButton)
...
export default function ShinyButton(style) {
  ...
  let tmp3Result;
  if (!loading) {
    const obj2 = { size: tmp4(1177).Icon.Sizes.REFRESH_SMALL_16, source: _modDef10560, style: null };
