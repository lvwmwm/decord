...
// Dependencies: [19, 17, 1372, 21, 4757, 576, 1115, 504, 4909, 1397, 7434, 5806, 4753, 1092, 1177, 7452, 2]
...
export const GuildRoleSubscriptionMemberPreview = function GuildRoleSubscriptionMemberPreview(content) {
  ...
  if (null == role) {
    ...
    const items2 = [timestampProducer(tmp6(5806), obj3), ];
    ...
    obj6.style = obj7;
    obj6.children = tmp8;
    const items3 = [timestampProducer(tmp4(4753).Text, obj6), , , ];
    ...
    items3[3] = timestampProducer(tmp4(4753).Text, { variant: "text-xs/medium", color: "text-muted", children: "4:20 PM" });
    obj5.children = items3;
    const items5 = [React6(View, obj5), ];
    const obj10 = { variant: "text-md/normal", color: "text-default", style: textStyle, children: content };
    items5[1] = timestampProducer(tmp4(4753).Text, obj10);
