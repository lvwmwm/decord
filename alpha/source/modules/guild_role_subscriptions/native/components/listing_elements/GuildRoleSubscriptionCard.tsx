...
// Dependencies: [32, 19, 17, 21, 4827, 576, 7310, 4823, 15562, 10687, 1115, 1177, 15573, 15574, 15577, 2]
// Exports: Content
...
export const Content = function Content(arg0) {
  ...
  if (first1.length > 0) {
    ...
    items4[2] = tmp7(tmp5(10687).GappedList, obj15);
  ...
  if (first2.length > 0) {
    ...
    items5[2] = tmp7(tmp5(10687).GappedList, obj19);
