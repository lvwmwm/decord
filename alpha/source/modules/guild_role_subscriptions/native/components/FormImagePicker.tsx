...
// Dependencies: [5, 19, 17, 21, 4757, 576, 5356, 1431, 10017, 1115, 5806, 18202, 10514, 4753, 5187, 2]
// Exports: default

// Module 18201 (FormImagePicker)
...
export default function FormImagePicker(children) {
  ...
  const items = [
    closure_6(tmp6(4753).Text, { style: tmp2.imageDescription, variant: "text-sm/medium", color: "text-default", children: children.description }),
    closure_6(tmp6(5187).Button, {
      text: stringResult,
      variant: "secondary",
      onPress() {
