...
// Dependencies: [5, 32, 19, 17, 4406, 1372, 18223, 15486, 1074, 21, 4757, 576, 5743, 14173, 5341, 4714, 1177, 1115, 1612, 18225, 4910, 8876, 18227, 10078, 18228, 2]

// Module 18224 (GuildRoleSubscriptionBenefitEditorModal)
...
export default noop.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === constants.CHANNEL) {
      ...
      let tmp25 = closure_13(tmp2(18225), obj);
    ...
    const items = [tmp26(tmp2(18227), obj4), ];
    ...
    items2[3] = tmp26(tmp2(18228), obj9);
    ...
    items2[4] = tmp26(tmp2(10078), obj11);
