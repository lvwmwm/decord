...
// Dependencies: [5, 32, 19, 17, 4479, 1372, 17576, 14752, 1074, 21, 4836, 576, 5836, 13443, 5435, 4790, 1177, 1115, 1613, 17578, 4989, 8053, 17580, 9271, 17581, 2]
...
export default noop.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === constants.CHANNEL) {
      ...
      tmp25 = closure_13(tmp20(8053).FormInput, obj2);
      tmp26 = closure_13;
    }
    ...
    items2[5] = tmp26(tmp20(8053).FormInput, obj12);
