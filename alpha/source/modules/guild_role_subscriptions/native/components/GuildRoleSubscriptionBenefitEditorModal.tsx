...
// Dependencies: [5, 32, 19, 17, 4472, 1372, 18292, 15540, 1074, 21, 4827, 576, 5827, 14255, 5425, 4784, 1177, 1115, 1612, 18294, 4980, 8947, 18296, 10158, 18297, 2]

// Module 18293 (GuildRoleSubscriptionBenefitEditorModal)
...
export default noop.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === constants.CHANNEL) {
      ...
      let tmp25 = closure_13(tmp2(18294), obj);
      ...
      tmp25 = closure_13(tmp20(8947).FormInput, obj2);
      tmp26 = closure_13;
    }
    ...
    const items = [tmp26(tmp2(18296), obj4), ];
    ...
    items2[5] = tmp26(tmp20(8947).FormInput, obj12);
