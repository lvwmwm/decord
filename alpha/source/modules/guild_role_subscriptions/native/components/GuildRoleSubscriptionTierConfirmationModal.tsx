...
// Dependencies: [5, 32, 19, 17, 18188, 21, 4756, 576, 14166, 18200, 18192, 1115, 10072, 5804, 4752, 18224, 2]
// Exports: default
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    items2[1] = React6(tmp3(10072), obj8);
