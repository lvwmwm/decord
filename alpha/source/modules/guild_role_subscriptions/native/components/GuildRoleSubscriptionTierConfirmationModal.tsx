...
// Dependencies: [5, 32, 19, 17, 18292, 21, 4829, 576, 14264, 18304, 18296, 1115, 10163, 5892, 4825, 18328, 2]
// Exports: default
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    items2[1] = React6(tmp3(10163), obj8);
