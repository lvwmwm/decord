...
// Dependencies: [5, 32, 19, 17, 18200, 21, 4757, 576, 14173, 18212, 18204, 1115, 10078, 5806, 4753, 18236, 2]
// Exports: default
...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    items2[1] = React6(tmp3(10078), obj8);
    ...
    items2[2] = React6(tmp6(4753).Text, obj9);
    obj7.children = items2;
    flag = tmp13(tmp16, obj7);
    const tmp3Result2 = tmp3(10078);
  }
