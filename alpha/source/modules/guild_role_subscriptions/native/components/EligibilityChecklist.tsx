...
// Dependencies: [19, 17, 21, 4757, 5806, 18163, 18164, 4753, 5187, 1177, 15498, 2]
// Exports: default
...
function EligibilityChecklistRow(item) {
  ...
  if (item.checked) {
    let tmp6Result = tmp6(18163);
  } else {
    tmp6Result = tmp6(18164);
  }
  ...
  if (tmp5Result) {
    ...
    obj6.children = tmp5(tmp10(5187).Button, { text: null, onPress: null, grow: true });
  ...
  if (item.isLast) {
    ...
    tmp5Result2 = tmp5(tmp6(15498), obj15);
  }
