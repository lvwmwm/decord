...
// Dependencies: [19, 17, 21, 4827, 5890, 18232, 18233, 4823, 5271, 1177, 15552, 2]
// Exports: default
...
function EligibilityChecklistRow(item) {
  ...
  if (item.checked) {
    let tmp6Result = tmp6(18232);
  } else {
    tmp6Result = tmp6(18233);
  }
  ...
  if (tmp5Result) {
    ...
    obj6.children = tmp5(tmp10(5271).Button, { text: null, onPress: null, grow: true });
  ...
  if (item.isLast) {
    ...
    tmp5Result2 = tmp5(tmp6(15552), obj15);
  }
