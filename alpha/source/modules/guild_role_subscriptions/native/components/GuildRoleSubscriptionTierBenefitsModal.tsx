...
// Dependencies: [32, 19, 17, 15509, 18200, 15486, 21, 4757, 576, 10017, 5806, 18216, 4753, 1115, 1397, 18217, 14173, 15513, 38, 18195, 8876, 10078, 18218, 18219, 18212, 15493, 18191, 15508, 18221, 18222, 18231, 15512, 18232, 18204, 2]
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    ...
    return tmp3(closure_1(10078), obj);
  }
