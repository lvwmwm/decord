...
// Dependencies: [32, 19, 17, 14747, 17523, 14724, 21, 4829, 576, 9192, 5894, 17539, 4825, 1115, 1397, 17540, 13425, 14751, 38, 17518, 8045, 9260, 17541, 17542, 17535, 14731, 17514, 14746, 17544, 17545, 17554, 14750, 17555, 17527, 2]
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    ...
    return tmp3(closure_1(9260), obj);
  }
  ...
  const obj10 = {
    ...
    renderItem(item) {
      ...
      if ("roles" in item) {
        ...
        tmp3Result = tmp3(closure_1(9192), obj);
