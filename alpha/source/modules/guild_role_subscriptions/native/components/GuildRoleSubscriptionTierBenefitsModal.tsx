...
// Dependencies: [32, 19, 17, 15563, 18269, 15540, 21, 4827, 576, 10090, 5890, 18285, 4823, 1115, 1397, 18286, 14255, 15567, 38, 18264, 8947, 10158, 18287, 18288, 18281, 15547, 18260, 15562, 18290, 18291, 18300, 15566, 18301, 18273, 2]
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    ...
    return tmp3(closure_1(10158), obj);
  }
  ...
  const obj10 = {
    ...
    renderItem(item) {
      ...
      if ("roles" in item) {
        ...
        tmp3Result = tmp3(closure_1(10090), obj);
