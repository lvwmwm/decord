...
// Dependencies: [32, 19, 17, 15577, 18292, 15554, 21, 4829, 576, 10095, 5892, 18308, 4825, 1115, 1397, 18309, 14264, 15581, 38, 18287, 8951, 10163, 18310, 18311, 18304, 15561, 18283, 15576, 18313, 18314, 18323, 15580, 18324, 18296, 2]
...
function Content(arg0) {
  ...
  function GuildRoleSubscriptionTierBenefitsModalHeader(type) {
    ...
    return tmp3(closure_1(10163), obj);
  }
  ...
  const obj10 = {
    ...
    renderItem(item) {
      ...
      if ("roles" in item) {
        ...
        tmp3Result = tmp3(closure_1(10095), obj);
