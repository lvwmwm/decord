...
// Dependencies: [32, 19, 17, 2042, 21, 4827, 576, 7310, 4823, 4794, 16959, 1980, 10687, 15575, 1177, 504, 4980, 1115, 5325, 15562, 16954, 5890, 16960, 2]
// Exports: default
...
export default function GuildRoleSubscriptionPurchasePreviewCard(listingId) {
  ...
  if (tmp8Result6) {
    ...
    obj11.children = tmp8(tmp4(10687).GappedList, obj12);
