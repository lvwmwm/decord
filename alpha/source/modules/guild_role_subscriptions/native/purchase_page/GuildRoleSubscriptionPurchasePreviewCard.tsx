...
// Dependencies: [32, 19, 17, 2044, 21, 4829, 576, 6395, 4825, 4796, 16173, 1980, 9796, 14759, 1177, 504, 4982, 1115, 5328, 14746, 16168, 5894, 16174, 2]
// Exports: default
...
export default function GuildRoleSubscriptionPurchasePreviewCard(listingId) {
  ...
  if (tmp8Result6) {
    ...
    obj11.children = tmp8(tmp4(9796).GappedList, obj12);
