...
// Dependencies: [32, 19, 17, 2042, 21, 4757, 576, 7226, 4753, 4724, 16907, 1980, 10611, 15521, 1177, 504, 4910, 1115, 5241, 15508, 16902, 5806, 16908, 2]
// Exports: default
...
export default function GuildRoleSubscriptionPurchasePreviewCard(listingId) {
  ...
  if (tmp8Result6) {
    ...
    obj11.children = tmp8(tmp4(10611).GappedList, obj12);
