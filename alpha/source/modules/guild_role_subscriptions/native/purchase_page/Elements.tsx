...
// Function ID: 16955
// Name: Elements
// Dependencies: [32, 19, 17, 4486, 21, 4827, 576, 4823, 1115, 5425, 1177, 16955, 9557, 15562, 563, 9560, 7565, 2]
// Exports: ArrowButton, TruncatedText, useFormattedSubscriptionPlan

// Module 16954 (Elements)
...
export const ArrowButton = function ArrowButton(arg0) {
  ...
  const items = [React7(Text_Text.Text, { variant: "text-md/semibold", color: "text-default", style: tmp.arrowButtonText, children: text }), React7(native.Icon, { size: native.Icon.Sizes.SMALL, source: _modDef16955, style: tmp.arrowButtonIcon })];
  obj.children = items;
...
export const useFormattedSubscriptionPlan = function useFormattedSubscriptionPlan(listingId) {
  ...
  if (null != price) {
    ...
    str = "" + tmp3(7565).formatPrice(price.amount, price.currency) + "/mo.";
    const tmp3Result = tmp3(7565);
  }
  return str;
};
