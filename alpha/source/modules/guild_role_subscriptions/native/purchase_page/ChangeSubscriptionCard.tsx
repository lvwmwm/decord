...
// Dependencies: [32, 19, 17, 1074, 21, 4827, 576, 4823, 1612, 15562, 4414, 7481, 1115, 1177, 16954, 5030, 16962, 1980, 4794, 2]
// Exports: default
...
export default function ChangeSubscriptionCard(activeSubscription) {
  ...
  if (activeSubscription.status !== SubscriptionStatusTypes.CANCELED) {
    ...
    items3[1] = tmp5(tmp6(16954).ArrowButton, obj11);
  ...
  return closure_7(activeSubscription(7481).BottomSheet, { startExpanded: true, children: closure_8(tmp8, obj4) });
};
