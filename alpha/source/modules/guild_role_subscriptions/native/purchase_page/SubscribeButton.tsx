...
// Dependencies: [5, 32, 19, 17, 2098, 4459, 1074, 2051, 21, 14746, 504, 8659, 4825, 5197, 1115, 5876, 4418, 1177, 16168, 4796, 16175, 1980, 16164, 5357, 5274, 9750, 2]
// Exports: default

// Module 16174 (SubscribeButton)
...
function SwitchTiersButton(activeSubscription) {
  ...
  let obj = changeToListingId(14746);
  const obj3 = { children: null };
  const obj2 = activeListingId(4418)(activeSubscription.currentPeriodEnd);
  const obj4 = { variant: "text-xs/normal", color: "text-muted", children: null };
  const intl = activeSubscription(1115).intl;
  const formatResult = activeListingId(4418)(activeSubscription.currentPeriodEnd).format("MMMM Do");
  obj4.children = intl.format(activeSubscription(1115).t.lA7ztO, { activeListingName: _slicedToArray(obj.useName(activeListingId), 1)[0], billingEndDate: activeListingId(4418)(activeSubscription.currentPeriodEnd).format("MMMM Do"), emphasisHook });
  ...
  obj6.onPress = function onPress() {
    ...
    obj.openLazy(asyncRequireImpl(16175, dependencyMap.paths), "ChangeSubscriptionCard:" + changeToListingId, { activeSubscription, activeListingId, changeToListingId });
  };
  items[2] = closure_12(activeSubscription(16168).ArrowButton, obj6);
  obj3.children = items;
