...
// Dependencies: [19, 2064, 21, 12, 5683, 18008, 18251, 1115, 18195, 504, 4724, 18252, 1980, 18205, 2]
// Exports: default

// Module 18250 (GuildSettingsRoleSubscriptionEmojis)
import asyncRequireImpl from "asyncRequireImpl" /* 1980 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4724 */;
import RoleSubscriptionEmojiUtils from "RoleSubscriptionEmojiUtils" /* 5683 */;
import GuildSettingsRoleSubscriptionContainerDefault from "GuildSettingsRoleSubscriptionContainer" /* 18205 */;
import getMaxRoleSubscriptionEmojiSlotsDefault from "getMaxRoleSubscriptionEmojiSlots" /* 18251 */;
...
function GuildSettingsRoleSubscriptionEmojisInner(guildId) {
  ...
  const roleSubscriptionSettingsDisabled = guildId(18195).useRoleSubscriptionSettingsDisabled();
  let obj = guildId(18195);
  ...
  if (null == stateFromStores) {
    ...
    const obj3 = { maxSlots: stateFromStores(18251)(stateFromStores) };
    const obj4 = {
      ...
      onSelectRolesForEmoji(emoji) {
          if (null == stateFromStores) {
            ...
            rejectResult = new Promise((arg0, arg1) => {
              ...
              obj.openLazy(asyncRequireImpl(18252, dependencyMap.paths), "role-subscription-emoji-" + stateFromStores.id, {
                guildId: stateFromStores.id,
                emoji,
                onSave(arg0) {
                  stateFromStores(4724).hideActionSheet();
                  closure_0(arg0);
                },
                onCancel() {
                  stateFromStores(4724).hideActionSheet();
    ...
    return jsx(tmp(18008).ManageEmojisModal, {
      guild: stateFromStores,
      headerDescription: intl.formatToPlainString(tmp(1115).t.H9Jxp6, obj3),
      computeEmojiItems,
      onSelectRolesForEmoji(emoji) {
