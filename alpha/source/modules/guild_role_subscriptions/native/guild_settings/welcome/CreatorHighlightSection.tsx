...
// Dependencies: [19, 17, 21, 4757, 576, 4753, 1177, 10566, 1115, 7226, 18179, 4452, 18151, 5806, 15521, 5188, 2]
// Exports: default
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp6.isLoading) {
    ...
    if (tmp9Result) {
      ...
      const items5 = [tmp11(tmp2(4753).Text, obj14), ];
      ...
      if (tmp11Result2) {
        ...
        tmp11Result2 = tmp11(tmp2(4753).Text, obj16);
      }
