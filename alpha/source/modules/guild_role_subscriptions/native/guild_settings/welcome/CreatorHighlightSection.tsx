...
// Dependencies: [19, 17, 21, 4827, 576, 4823, 1177, 10642, 1115, 7310, 18248, 4518, 18220, 5890, 15575, 5272, 2]
// Exports: default
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp6.isLoading) {
    ...
    if (tmp9Result) {
      ...
      const items5 = [tmp11(tmp2(4823).Text, obj14), ];
      ...
      if (tmp11Result2) {
        ...
        tmp11Result2 = tmp11(tmp2(4823).Text, obj16);
      }
