...
// Dependencies: [5, 32, 19, 17, 1074, 2049, 21, 4827, 576, 1115, 4823, 5425, 5887, 1177, 9875, 15552, 5194, 15553, 1980, 9557, 7493, 5164, 15555, 13108, 4520, 8947, 10687, 15556, 4518, 4481, 1101, 10641, 15558, 1484, 2]
// Exports: default
...
function CardBody(isTrial) {
  ...
  if (isCancelled) {
    ...
    obj15.loading = tmp6;
    obj14.children = tmp13(tmp2(10641), obj15);
    ...
    tmp13Result = tmp13(tmp2(15556), obj16);
