...
// Dependencies: [5, 32, 19, 17, 1074, 2051, 21, 4829, 576, 1115, 4825, 5428, 5891, 1177, 8978, 14736, 5197, 14737, 1980, 8659, 6578, 5167, 14739, 12267, 4524, 8045, 9796, 14740, 4522, 4485, 1101, 9750, 14742, 1484, 2]
// Exports: default
...
function CardBody(isTrial) {
  ...
  if (isCancelled) {
    ...
    obj15.loading = tmp6;
    obj14.children = tmp13(tmp2(9750), obj15);
    ...
    tmp13Result = tmp13(tmp2(14740), obj16);
