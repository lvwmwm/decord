...
// Dependencies: [32, 19, 17, 21, 4757, 4990, 10002, 4753, 4601, 1115, 16475, 2]
// Exports: default
...
export default function VoiceUserNameItem(arg0) {
  ...
  if (isGuest) {
    ...
    isGuest = tmp18(tmp5(4753).Text, obj6);
  }
  items1[1] = isGuest;
  ...
  if (tmp12) {
    ...
    obj7.children = React5(tmp2(16475), obj8);
