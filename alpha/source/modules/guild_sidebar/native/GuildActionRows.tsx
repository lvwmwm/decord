...
// Dependencies: [19, 17, 7777, 4772, 10380, 7344, 4939, 21, 4757, 576, 7580, 4577, 2028, 563, 7773, 4960, 11804, 1980, 12637, 12549, 1115, 14119, 2]
// Exports: GuildRolesAndChannelsRow

// Module 16558 (GuildActionRows)
...
let obj2 = { container: { marginVertical: fn(10380).CHANNEL_MARGIN_VERTICAL, marginHorizontal: 8, borderRadius: nativeDefault.radii.md }, channelInfoContainer: { paddingStart: 4 } };
...
export const GuildRolesAndChannelsRow = function GuildRolesAndChannelsRow(guild) {
  ...
  const callback = noop.useCallback(() => {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11804, dependencyMap.paths), { guildId: id }, closure_7);
  }, items2);
  let SELECTED = guild(12637).ChannelModes.DEFAULT;
  if (selected) {
    SELECTED = tmp5(12637).ChannelModes.SELECTED;
  }
  let tmp10 = !result;
  if (result) {
  ...
  let tmp11 = null;
  if (tmp10) {
    const obj4 = { style: tmp.channelInfoContainer, children: jsx(tmp5(12549).NewBadge, {}) };
    tmp11 = <View style={tmp.channelInfoContainer}>{jsx(tmp5(12549).NewBadge, {})}</View>;
  }
  ...
  obj5.name = jsx(guild(12637).BaseChannelName, { name: string2Result, mode: SELECTED });
  const tmp2Result = tmp2(12637);
  obj5.icon = jsx(guild(12637).BaseChannelIcon, { mode: SELECTED, IconComponent: guild(14119).ChannelListMagnifyingGlassIcon });
