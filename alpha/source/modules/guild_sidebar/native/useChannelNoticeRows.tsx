...
// Dependencies: [32, 19, 12733, 4394, 2064, 1372, 7779, 1074, 2039, 563, 7410, 7412, 16610, 7633, 2028, 4577, 16534, 16611, 2]
// Exports: default
...
require = fn;
let closure_9 = fn(7779).ChannelListChannelNoticeRow;
