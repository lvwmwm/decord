...
// Function ID: 16472
// Name: VoiceUsers
// Dependencies: [19, 17, 2105, 21, 4757, 576, 10383, 8120, 504, 16472, 10381, 1115, 12788, 4753, 10004, 16476, 7555, 16479, 2]
// Exports: default, getAudienceItemHeight

// Module 16471 (VoiceUsers)
...
import HeadphonesIcon from "HeadphonesIcon" /* 12788 */;
...
let closure_12 = noop.memo((voiceState) => {
  ...
  const tmp = channel;
  const tmp3 = closure_11(channel(8120)());
  ...
  obj2.children = closure_6(tmp(16472), obj5, user.id);
