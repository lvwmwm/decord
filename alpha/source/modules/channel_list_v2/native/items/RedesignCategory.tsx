...
// Dependencies: [19, 17, 7859, 7448, 5008, 10459, 21, 4827, 1364, 576, 4823, 13092, 5425, 11500, 11889, 11259, 504, 4980, 11323, 16509, 16510, 7444, 1115, 7526, 11890, 6944, 2]
  ...
  if (null == trailingAction) {
    ...
    if (null == note) {
      ...
      if (tmp) {
        ...
        let tmp28Result = tmp28(trailingAction(5425).PressableHighlight, obj7);
      } else {
    ...
    obj10 = tmp9(trailingAction(5425).PressableOpacity, obj10);
    obj9.children = obj10;
