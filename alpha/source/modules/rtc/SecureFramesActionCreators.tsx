...
// Dependencies: [5, 502, 2042, 4776, 9978, 1074, 573, 9976, 4657, 5109, 1115, 9980, 5630, 2]

// Module 9979 (SecureFramesActionCreators)
...
let closure_7 = fn(9978).SECURE_FRAMES_PUBLIC_KEY_VERSION;
