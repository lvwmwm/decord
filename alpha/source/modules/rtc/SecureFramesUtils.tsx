...
// Dependencies: [32, 5, 502, 1992, 4780, 4796, 1372, 9977, 9978, 1074, 2108, 9979, 9987, 9961, 9980, 1115, 4601, 4348, 1091, 38, 206, 1271, 1231, 5109, 4909, 2]
...
export const deleteVerification = function deleteVerification(userId, arg1, isOtherUserKeyPersistent) {
  if (isOtherUserKeyPersistent) {
    ...
    const serializeKeyResult = _mod9961.serializeKey(uint8Array);
