...
// Dependencies: [32, 5, 502, 1992, 4852, 4868, 1372, 9153, 9154, 1074, 2110, 9155, 9163, 9137, 9156, 1115, 4675, 4418, 1091, 38, 206, 1271, 1231, 5196, 4981, 2]
...
export const deleteVerification = function deleteVerification(userId, arg1, isOtherUserKeyPersistent) {
  if (isOtherUserKeyPersistent) {
    ...
    const serializeKeyResult = _mod9137.serializeKey(uint8Array);
...
export const getSecureFramesUserVerifiedTimestamp = function getSecureFramesUserVerifiedTimestamp(timestamp) {
  const tmp3 = _modDef4418(timestamp);
  const diffResult = _modDef4418().diff(tmp3, "s");
