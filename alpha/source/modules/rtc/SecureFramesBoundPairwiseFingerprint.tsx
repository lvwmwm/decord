...
// Dependencies: [5, 502, 4852, 10056, 206, 10039, 2]
// Exports: computeBoundPairwiseFingerprint

// Module 10061 (SecureFramesBoundPairwiseFingerprint)
...
let closure_6 = fn(10056).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
const map = new Map();
const size = fn(2);
