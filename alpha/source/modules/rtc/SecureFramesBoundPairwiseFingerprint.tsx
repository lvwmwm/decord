...
// Dependencies: [5, 502, 4780, 9978, 206, 9961, 2]
// Exports: computeBoundPairwiseFingerprint

// Module 9983 (SecureFramesBoundPairwiseFingerprint)
...
let closure_6 = fn(9978).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
const map = new Map();
const size = fn(2);
