...
// Dependencies: [5, 502, 4850, 10051, 206, 10034, 2]
// Exports: computeBoundPairwiseFingerprint

// Module 10056 (SecureFramesBoundPairwiseFingerprint)
...
let closure_6 = fn(10051).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
const map = new Map();
const size = fn(2);
