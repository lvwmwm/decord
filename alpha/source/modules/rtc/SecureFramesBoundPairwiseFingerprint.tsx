...
// Dependencies: [5, 502, 4852, 9154, 206, 9137, 2]
// Exports: computeBoundPairwiseFingerprint

// Module 9159 (SecureFramesBoundPairwiseFingerprint)
...
let closure_6 = fn(9154).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
const map = new Map();
const size = fn(2);
