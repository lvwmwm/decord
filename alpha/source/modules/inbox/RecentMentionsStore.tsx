...
// Dependencies: [4473, 502, 2042, 5047, 4842, 4472, 4648, 5008, 1372, 1074, 510, 5049, 5037, 5078, 12, 4856, 7598, 7960, 504, 573, 2]
        ...
        if (!tmp2(7960)(message, id)) {
          ...
          if (tmp2(5078)(obj)) {
            ...
            if (tmp2ResultResult) {
              ...
              tmp2ResultResult = tmp2(5078)(obj3);
