...
// Dependencies: [4475, 502, 2044, 5049, 4844, 4474, 4650, 5010, 1372, 1074, 510, 5051, 5039, 5080, 12, 4858, 7600, 7962, 504, 573, 2]
        ...
        if (!tmp2(7962)(message, id)) {
          ...
          if (tmp2(5080)(obj)) {
            ...
            if (tmp2ResultResult) {
              ...
              tmp2ResultResult = tmp2(5080)(obj3);
