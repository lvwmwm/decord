...
// Dependencies: [4477, 502, 2044, 5049, 4844, 4476, 4652, 5010, 1372, 1074, 510, 5051, 5039, 5081, 12, 4858, 6683, 7047, 504, 573, 2]
        ...
        if (!tmp2(7047)(message, id)) {
          ...
          if (tmp2(5081)(obj)) {
            ...
            if (tmp2ResultResult) {
              ...
              tmp2ResultResult = tmp2(5081)(obj3);
