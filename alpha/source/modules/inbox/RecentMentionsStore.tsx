...
// Dependencies: [4407, 502, 2042, 4977, 4772, 4406, 4578, 4938, 1372, 1074, 510, 4979, 4967, 4994, 12, 4786, 7514, 7877, 504, 573, 2]
        ...
        if (!tmp2(7877)(message, id)) {
          ...
          if (tmp2(4994)(obj)) {
            ...
            if (tmp2ResultResult) {
              ...
              tmp2ResultResult = tmp2(4994)(obj3);
              const tmp2Result = tmp2(4994);
            }
            tmp20 = tmp12;
            if (tmp2ResultResult) {
              c26 = false;
