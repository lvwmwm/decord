...
// Dependencies: [7875, 7874, 1971, 7876, 7877, 5814, 9135, 1074, 1973, 2]
// Exports: isCollectiblesWishlistItemRecord

// Module 9136 (CollectiblesWishlistItemRecord)
...
let closure_3 = fn(7874).transformSKUToCollectiblesItem;
