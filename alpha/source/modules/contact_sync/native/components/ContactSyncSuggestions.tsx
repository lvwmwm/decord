...
// Dependencies: [32, 19, 17, 1074, 13038, 21, 4827, 576, 5985, 5278, 4823, 4671, 1397, 5907, 1177, 1115, 4524, 4676, 11, 8947, 9073, 5283, 1094, 5271, 1241, 2]
// Exports: default
...
function SuggestionRow(suggestion) {
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp3(4823).Text, obj5);
  }
  items[1] = tmp8Result;
