...
// Dependencies: [32, 19, 17, 1074, 12178, 21, 4829, 576, 5989, 5281, 4825, 4675, 1397, 5911, 1177, 1115, 4528, 4680, 11, 8045, 8171, 5286, 1094, 5274, 1241, 2]
// Exports: default
...
function SuggestionRow(suggestion) {
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp3(4825).Text, obj5);
  }
  items[1] = tmp8Result;
