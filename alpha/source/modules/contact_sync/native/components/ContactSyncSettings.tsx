...
// Dependencies: [5, 19, 1372, 12936, 1074, 21, 12937, 4455, 1115, 5816, 12941, 1241, 12933, 504, 2020, 1385, 8876, 4960, 15130, 1980, 2]
// Exports: default, handleSyncContacts

// Module 15129 (ContactSyncSettings)
...
export default function ContactSyncSettings() {
  contactSyncAccount = contactSyncAccount(12937).useContactSyncAccount();
  let obj = contactSyncAccount(12937);
  ...
  const tmpResult = contactSyncAccount(12937);
  const FriendDiscoverySettings = tmp(2020).FriendDiscoverySettings;
  const setting = FriendDiscoverySettings.useSetting();
  const isContactSyncEnabledResult = contactSyncAccount(12937).isContactSyncEnabled(contactSyncAccount);
  ...
  if (isStaffResult) {
    ...
    const obj5 = { label: "STAFF ONLY - Find your friends deletion", value: true, onValueChange: tmp(12937).adminDeleteContactSync };
  ...
  obj11.children = intl4.format(contactSyncAccount(1115).t.BoR0dO, { onClick: contactSyncAccount(12937).handleOpenLearnMoreLink });
