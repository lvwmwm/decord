...
// Dependencies: [19, 17, 11706, 21, 4827, 576, 11742, 1115, 4823, 5271, 4518, 11713, 2]
// Exports: default

// Module 11741 (SafetyToolsCrisisTextLineActionSheet)
...
export default function SafetyToolsCrisisTextLineActionSheet(trackAnalyticsEvent) {
  ...
  const items = [closure_6(trackAnalyticsEvent(4823).Text, obj3), , ];
  ...
  items[1] = closure_6(trackAnalyticsEvent(5271).Button, obj4);
  ...
  items[2] = closure_6(trackAnalyticsEvent(5271).Button, obj5);
  obj2.children = items;
