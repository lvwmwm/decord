...
// Dependencies: [19, 17, 4476, 10892, 21, 4829, 576, 10921, 10924, 10925, 504, 10899, 6625, 1115, 8229, 8228, 4796, 10929, 1980, 4522, 6385, 6383, 6384, 6382, 9184, 10932, 6029, 7844, 5197, 10919, 8117, 8116, 8081, 9356, 9355, 5032, 10933, 10937, 10938, 10939, 8696, 8697, 10940, 10930, 5994, 5912, 5918, 2]
// Exports: default

// Module 10923 (SafetyToolsActionSheet)
...
import EducationIcon from "EducationIcon" /* 10938 */;
...
export default function SafetyToolsActionSheet(channelId) {
  ...
  const memo = recipientId.useMemo(() => {
    ...
    if (stateFromStores1) {
      let EyeSlashIcon = tmp(6384).EyeIcon;
    } else {
      EyeSlashIcon = tmp(6382).EyeSlashIcon;
    }
