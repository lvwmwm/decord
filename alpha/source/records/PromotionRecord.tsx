...
// Dependencies: [1387, 11015, 11045, 1385, 2]

// Module 11014 (PromotionRecord)
...
prototype["isCountryRestricted"] = function isCountryRestricted(arg0) {
  ...
  if (this.countryListMode === require("constants").CountryListMode.ALLOWLIST) {
    ...
    if (tmp(11045).PromotionTypes.THIRD_PARTY_INBOUND !== promotionType) {
      if (tmp(11045).PromotionTypes.THIRD_PARTY_DIRECT_FULFILLMENT !== promotionType) {
        if (tmp(11045).PromotionTypes.THIRD_PARTY_OUTBOUND !== promotionType) {
          if (tmp(11045).PromotionTypes.THIRD_PARTY_OUTBOUND_RECURRING !== promotionType) {
            return false;
          }
        }
