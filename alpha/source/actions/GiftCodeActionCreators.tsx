...
// Dependencies: [5, 5056, 7872, 7880, 1074, 1374, 573, 5081, 7496, 7871, 4729, 4506, 1231, 1271, 11780, 11781, 2]
// Exports: deliverGiftCodes, reportUnexpectedGiftCodeError, resolveGiftCode

// Module 11779 (GiftCodeActionCreators)
import HTTPUtils from "HTTPUtils" /* 1271 */;
import errors_V6OrEarlierAPIErrorDefault from "errors/V6OrEarlierAPIError" /* 4506 */;
import CodedLinkActionCreatorsDefault from "CodedLinkActionCreators" /* 11780 */;
...
let closure_6 = fn(7880).isUnknownCollectiblesItemRecord;
...
const merged = Object.assign(fn(11781).default);
const size = fn(2);
