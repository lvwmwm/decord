...
// Dependencies: [32, 1372, 1074, 10083, 5856, 5193, 5825, 1115, 10084, 10085, 10086, 1271, 4671, 4678, 573, 10087, 8750, 2]
        ...
        if (num !== tmp2.RELATIONSHIP_INVALID_NO_CONFIRMATION) {
          if (SHOW_ALWAYS === obj.SHOW_ALWAYS) {
            if (null != userTag) {
              ...
              let humanizeAbortCodeResult = tmp18(10086).humanizeAbortCode(num, userTag);
              const tmp18Result = tmp18(10086);
            } else {
            ...
            tmp18(5856).closeContextMenu();
            const tmp18Result2 = tmp18(5856);
