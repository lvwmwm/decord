...
export default {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            if (4 === tmp8) {
              ...
              let tmp16 = closure_128_4 instanceof closure_0(4735).APIError;
              if (tmp16) {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj7 = { value: tmp3(5029).post(request), done: false };
              return obj7;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
            ...
            const v6OrEarlierAPIError = new ticket(4735).V6OrEarlierAPIError(closure_128_1);
  ...
  logout(TTI_test, LOGIN) {
    ...
    request.body = obj2;
    const obj = DEFAULT_LOGGED_OUT(5029);
    const tmp3 = _require;
  ...
  verify(arg0) {
    ...
    return (async () => {
      ...
      closure_128_0 = await tmp2(5029).post(request);
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            const v6OrEarlierAPIError = new token(4735).V6OrEarlierAPIError(closure_128_9);
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            const v6OrEarlierAPIError = new login(4735).V6OrEarlierAPIError(closure_128_2);
