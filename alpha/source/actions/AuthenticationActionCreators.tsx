...
export default {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj7 = { value: tmp3(5022).post(request), done: false };
              return obj7;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
  ...
  logout(TTI_test, LOGIN) {
    ...
    request.body = obj2;
    const obj = DEFAULT_LOGGED_OUT(5022);
    const tmp3 = _require;
  ...
  verify(arg0) {
    ...
    return (async () => {
      ...
      closure_128_0 = await tmp2(5022).post(request);
