...
// Dependencies: [109, 5, 17, 9559, 502, 7568, 1074, 7569, 1374, 1085, 3, 7571, 7585, 5044, 573, 4494, 559, 1364, 1462, 4496, 1241, 5193, 1115, 1271, 2]
    ...
    try {
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          closure_131_1 = tmp77;
          id = id.getId();
          const SubscriptionProductIds = React(7571).SubscriptionProductIds;
