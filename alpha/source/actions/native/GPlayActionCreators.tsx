...
// Dependencies: [109, 5, 17, 9563, 502, 7570, 1074, 7571, 1374, 1085, 3, 7573, 7587, 5046, 573, 4496, 559, 1364, 1462, 4498, 1241, 5195, 1115, 1271, 2]
    ...
    try {
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          closure_131_1 = tmp77;
          id = id.getId();
          const SubscriptionProductIds = React(7573).SubscriptionProductIds;
