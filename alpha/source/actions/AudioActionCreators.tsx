...
// Dependencies: [5, 9996, 2044, 1992, 4852, 2098, 1372, 1074, 9997, 4854, 3, 1241, 551, 573, 9998, 10000, 10001, 9790, 2]

// Module 9995 (AudioActionCreators)
...
import applyBackgroundOption from "applyBackgroundOption" /* 10001 */;
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              v1 = 1;
              dependencyMap = 1;
              const obj4 = { value: v1(10000)("debug_logging_enabled", closure_0, debugLogging.getDebugLogging()), done: false };
              return obj4;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              v1 = 1;
              dependencyMap = 1;
              const obj4 = { value: v1(10000)("audio_subsystem", closure_0, audioSubsystem.getAudioSubsystem()), done: false };
              return obj4;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
