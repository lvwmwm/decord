...
// Dependencies: [5, 3, 5057, 5474, 4443, 2]
// Exports: convertFileToJpeg

// Module 5569 (imageConversion)
...
export const renameToJpegExtension = fn(5474).renameToJpegExtension;
