...
// Dependencies: [1346, 1992, 4782, 1091, 4815, 559, 3, 4786, 14354, 1364, 38, 2]
...
prototype["createWebSocket"] = function createWebSocket() {
  ...
  self.connectionStartTime = self(4786).now();
...
prototype["handleHello"] = function handleHello(d) {
  ...
  const diff = tmp4(4786).now() - self.connectionStartTime;
