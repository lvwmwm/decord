...
// Dependencies: [1346, 1993, 4861, 1091, 4894, 559, 3, 4865, 13622, 1364, 38, 2]
...
prototype["createWebSocket"] = function createWebSocket() {
  ...
  self.connectionStartTime = self(4865).now();
...
prototype["handleHello"] = function handleHello(d) {
  ...
  const diff = tmp4(4865).now() - self.connectionStartTime;
