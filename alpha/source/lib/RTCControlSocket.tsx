...
// Dependencies: [1346, 1992, 4852, 1091, 4885, 559, 3, 4856, 14434, 1364, 38, 2]
...
prototype["createWebSocket"] = function createWebSocket() {
  ...
  self.connectionStartTime = self(4856).now();
...
prototype["handleHello"] = function handleHello(d) {
  ...
  const diff = tmp4(4856).now() - self.connectionStartTime;
