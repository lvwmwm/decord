...
// Dependencies: [32, 502, 1074, 4852, 1091, 5162, 1364, 4885, 4896, 2037, 9775, 11, 12, 558, 4882, 2]
...
prototype["reset"] = function reset() {
  ...
  const WindowVisibilityVideoManager = tmp3(9775).WindowVisibilityVideoManager;
