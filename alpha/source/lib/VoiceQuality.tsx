...
// Function ID: 14093
// Name: VoiceQuality
// Dependencies: [32, 7987, 4815, 14093, 7993, 4812, 12, 4786, 2]

// Module 14092 (VoiceQuality)
  ...
  constructor(arg0) {
    ...
    tmp3.sampleStats = function sampleStats(rtp) {
      ...
      if (null != rtp) {
        ...
        const result = networkQuality.incrementNetworkStats(outboundStats(4786).now());
