...
// Dependencies: [109, 19, 17, 21, 4757, 576, 4467, 10127, 5175, 10141, 8518, 2]

// Module 10126 (components_native/QRCode)
import nativeDefault from "native" /* 576 */;
import VisualEffectViewThemedDefault from "VisualEffectViewThemed" /* 8518 */;
import QRCodeDefault from "QRCode" /* 10127 */;
import _mod10141 from "module_10141" /* 10141 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;

const VisualEffectViewDefault = tmp7(5175);
require = fn;
...
QRCode.contextType = fn(4467).ThemeContext;
...
QRCodeWithOverlay.prototype["render"] = function render() {
  ...
  obj3.style = items1;
  obj4 = { style: tmp[frozen[SIZE_40]], source: _mod10141 };
...
QRCodeWithOverlay.contextType = fn(4467).ThemeContext;
