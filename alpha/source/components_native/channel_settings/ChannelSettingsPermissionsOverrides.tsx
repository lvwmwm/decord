...
// Dependencies: [32, 5, 19, 17, 2060, 2042, 2099, 2064, 4396, 4406, 1372, 1074, 21, 4757, 576, 1484, 1612, 504, 11866, 11865, 4401, 1086, 9831, 4770, 1978, 4601, 5109, 1115, 4452, 2108, 2050, 17310, 8110, 4753, 4910, 11213, 5824, 1177, 5906, 17314, 1364, 17315, 2]
// Exports: default
...
export default function ChannelSettingsPermissionsOverrides(fromCreate) {
  ...
  if (fromCreate.type === constants.MEMBER) {
    ...
    let tmp12Result = tmp12(tmp5(11213), obj6);
  } else {
    ...
    tmp12Result = tmp12(tmp2(5824).TableRow, obj7);
  }
      ...
      children: permissions.map((description, index) => {
        ...
        if (false !== tmp) {
          ...
          if ("" !== tmp) {
            ...
            tmp5Result = tmp5(tmp6(4753).Text, obj3);
          }
        }
        items[1] = tmp5Result;
