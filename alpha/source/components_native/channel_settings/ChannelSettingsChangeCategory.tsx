...
// Dependencies: [32, 718, 19, 2042, 7442, 2064, 4462, 4472, 1372, 1074, 21, 4827, 576, 4533, 7443, 12756, 4467, 5823, 5193, 1115, 4980, 5908, 5990, 8947, 5269, 4823, 504, 1484, 11941, 38, 2]
// Exports: default
  ...
  if (null != first) {
    ...
    if ("null" === first.id) {
      ...
      if (null != category) {
        ...
        obj4.children = tmp3(tmp4(5908).TableRow, obj5, first.id);
        tmp3Result = tmp3(tmp4(5990).TableRowGroup, obj4);
      }
    }
  }
  items[1] = tmp3Result;
