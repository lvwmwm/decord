...
// Dependencies: [19, 17, 5054, 502, 11772, 4486, 5813, 1074, 1374, 21, 4827, 576, 4533, 11773, 4823, 1115, 5271, 7557, 9182, 1177, 7503, 11500, 7540, 13587, 13589, 13590, 13588, 13591, 13592, 13593, 13594, 11373, 13595, 13598, 13599, 13921, 504, 11784, 2]
...
prototype["renderHeader"] = function renderHeader(source, children) {
  ...
  if (isOpen) {
    let ChevronSmallRightIcon = tmp2(11500).ChevronSmallDownIcon;
  } else {
    ChevronSmallRightIcon = tmp2(7540).ChevronSmallRightIcon;
  }
