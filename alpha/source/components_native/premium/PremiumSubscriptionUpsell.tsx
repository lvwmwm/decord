...
// Dependencies: [19, 17, 2109, 1372, 1074, 7760, 1374, 21, 4827, 576, 4777, 1115, 1881, 504, 4481, 5283, 1094, 4823, 13897, 13898, 9584, 5271, 2]
// Exports: default
...
export default function PremiumSubscriptionUpsell(arg0) {
  ...
  if (obj2.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (tmp5Result3.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp6(tmp2(4823).Text, obj6), ];
      ...
      items2[1] = tmp6(tmp2(4823).Text, obj7);
      ...
      tmp6Result1 = tmp6(tmp2(4823).Text, obj9);
    }
    const items3 = [tmp6Result1, , ];
    const obj10 = { style: tmp.upsellFeatures, children: null };
    const obj11 = { style: tmp.upsellFeatureSubLogo, source: tmp5(13897) };
    const items4 = [closure_1_10(React4, obj11), , ];
    const obj12 = { style: tmp.upsellFeatureLogoTier2, source: tmp5(13898) };
    ...
    tmp5Result3 = tmp5(4481);
    obj15.IconComponent = tmp2(4777).CheckmarkLargeIcon;
    const intl4 = tmp2(1115).intl;
    const obj16 = { discountPercentage: null };
    const tmp5Result4 = tmp5(9584);
    ...
    const items5 = [obj15, ];
    const obj17 = { IconComponent: tmp2(4777).CheckmarkLargeIcon, label: null, color: null };
    ...
    tmp = tmp6(tmp2(5271).Button, obj20);
    obj19.children = tmp;
