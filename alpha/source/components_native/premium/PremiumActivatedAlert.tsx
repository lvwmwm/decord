...
// Dependencies: [19, 17, 1074, 21, 4757, 5660, 4415, 10976, 10977, 10978, 10979, 10980, 9505, 10981, 10982, 10983, 10984, 10985, 10986, 8330, 10987, 4608, 10988, 10989, 10990, 10991, 10992, 10993, 10994, 10995, 10996, 1115, 4691, 5206, 10997, 10998, 1177, 2]
// Exports: default
...
let closure_11 = createStyles.createStyles((arg0) => {
  if (PremiumUtils.Branding.BUNDLE === arg0) {
    ...
    if (tmp(4415).Branding.TIER_0 !== arg0) {
      if (tmp(4415).Branding.TIER_1 !== arg0) {
        if (tmp(4415).Branding.TIER_2 !== arg0) {
          if (tmp(4415).Branding.PREMIUM_GUILD === arg0) {
...
export default function PremiumActivatedAlert(onClose) {
  ...
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    ...
    let tmp9 = obj2;
  } else if (tmp7(4415).Branding.TIER_1 === premiumBranding) {
    const obj3 = { logo: { width: 82, height: 32 } };
    tmp9 = obj3;
  } else {
    if (tmp7(4415).Branding.BUNDLE !== premiumBranding) {
      if (tmp7(4415).Branding.TIER_2 !== premiumBranding) {
        if (tmp7(4415).Branding.PREMIUM_GUILD === premiumBranding) {
  ...
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    let tmp4Result10 = tmp4(10976);
  } else if (tmp7(4415).Branding.TIER_1 === premiumBranding) {
    tmp4Result10 = tmp4(10977);
  } else if (tmp7(4415).Branding.TIER_2 === premiumBranding) {
    tmp4Result10 = tmp4(10978);
  } else if (tmp7(4415).Branding.BUNDLE === premiumBranding) {
    tmp4Result10 = tmp4(10979);
  } else if (tmp7(4415).Branding.PREMIUM_GUILD === premiumBranding) {
    tmp4Result10 = tmp4(10980);
  }
  obj7.source = tmp4Result10;
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    let tmp4Result11 = tmp4(10985);
  } else if (tmp7(4415).Branding.TIER_1 === premiumBranding) {
    tmp4Result11 = tmp4(10986);
  } else {
    if (tmp7(4415).Branding.BUNDLE !== premiumBranding) {
      if (tmp7(4415).Branding.TIER_2 !== premiumBranding) {
        if (tmp7(4415).Branding.PREMIUM_GUILD === premiumBranding) {
          tmp4Result11 = tmp4(10987);
        }
      }
    }
    tmp4Result11 = tmp4(8330);
  }
  const items = [React5(React3, { source: tmp4Result11, style: tmp9.logo }), , ];
  let tmp16Result = null;
  if (premiumBranding === PremiumUtils.Branding.BUNDLE) {
    const obj9 = { source: tmp4(10997), style: tmp.logoPlusPremiumGuild };
    tmp16Result = tmp16(tmp17, obj9);
  }
  items[1] = tmp16Result;
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    let tmp4Result12 = tmp4(9505);
  } else if (tmp7(4415).Branding.TIER_1 === premiumBranding) {
    tmp4Result12 = tmp4(10981);
  } else if (tmp7(4415).Branding.TIER_2 === premiumBranding) {
    tmp4Result12 = tmp4(10982);
  } else if (tmp7(4415).Branding.BUNDLE === premiumBranding) {
    tmp4Result12 = tmp4(10983);
  } else if (tmp7(4415).Branding.PREMIUM_GUILD === premiumBranding) {
    tmp4Result12 = tmp4(10984);
  }
  ...
  if (PremiumUtils.Branding.TIER_0 === premiumBranding) {
    if (tmp7Result.isThemeDark(tmp6)) {
      let tmp4Result14 = tmp4(10988);
    } else {
      tmp4Result14 = tmp4(10989);
    }
    tmp7Result = tmp7(4608);
  } else {
    if (tmp7(4415).Branding.TIER_1 === premiumBranding) {
      if (tmp7Result5.isThemeDark(tmp6)) {
        let tmp4Result15 = tmp4(10990);
      } else {
        tmp4Result15 = tmp4(10991);
      }
      let tmp4Result18 = tmp4Result15;
      tmp7Result5 = tmp7(4608);
    } else if (tmp7(4415).Branding.TIER_2 === premiumBranding) {
      if (tmp7Result6.isThemeDark(tmp6)) {
        let tmp4Result16 = tmp4(10992);
      } else {
        tmp4Result16 = tmp4(10993);
      }
      tmp4Result18 = tmp4Result16;
      tmp7Result6 = tmp7(4608);
    } else if (tmp7(4415).Branding.BUNDLE === premiumBranding) {
      if (tmp7Result7.isThemeDark(tmp6)) {
        let tmp4Result17 = tmp4(10994);
      } else {
        tmp4Result17 = tmp4(10995);
      }
      tmp4Result18 = tmp4Result17;
      tmp7Result7 = tmp7(4608);
    } else if (tmp7(4415).Branding.PREMIUM_GUILD === premiumBranding) {
      tmp4Result18 = tmp4(10996);
    }
    ...
    if (tmp7(4415).Branding.TIER_0 !== premiumBranding) {
      if (tmp7(4415).Branding.TIER_1 !== premiumBranding) {
        if (tmp7(4415).Branding.TIER_2 === premiumBranding) {
          ...
          obj14.planName = tmp7(4415).getExternalPlanDisplayName({ planId: null, additionalPlans: null });
