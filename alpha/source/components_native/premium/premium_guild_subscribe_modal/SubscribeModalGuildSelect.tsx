...
// Dependencies: [32, 19, 17, 2066, 5743, 5741, 21, 4829, 576, 5746, 1484, 504, 5747, 7456, 7706, 1115, 5739, 5427, 5889, 1177, 2]
// Exports: default

// Module 5742 (SubscribeModalGuildSelect)
...
import SearchBarNavDefault from "SearchBarNav" /* 7706 */;
...
let closure_9 = fn(5741).PremiumGuildSubscribeModalScenes;
const jsxProd = fn(21);
...
obj2.guildName = { marginLeft: 32, fontSize: 16, lineHeight: 20, color: fn(5746).DARK_WHITE_500_LIGHT_PRIMARY_660 };
...
export default function SubscribeModalGuildSelect(guildBoostSlots) {
  ...
  obj5.children = closure_10(guildBoostSlots(7456).SafeAreaPaddingView, {
    bottom: true,
  ...
  return closure_11(guildBoostSlots(7456).SafeAreaPaddingView, obj3);
};
