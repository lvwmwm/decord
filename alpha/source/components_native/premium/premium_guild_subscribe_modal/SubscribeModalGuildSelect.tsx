...
// Dependencies: [32, 19, 17, 2064, 5741, 5739, 21, 4827, 576, 5744, 1484, 504, 5745, 7454, 7704, 1115, 5737, 5425, 5887, 1177, 2]
// Exports: default

// Module 5740 (SubscribeModalGuildSelect)
...
let closure_9 = fn(5739).PremiumGuildSubscribeModalScenes;
const jsxProd = fn(21);
...
obj2.guildName = { marginLeft: 32, fontSize: 16, lineHeight: 20, color: fn(5744).DARK_WHITE_500_LIGHT_PRIMARY_660 };
...
export default function SubscribeModalGuildSelect(guildBoostSlots) {
  ...
  obj5.children = closure_10(guildBoostSlots(7454).SafeAreaPaddingView, {
    bottom: true,
  ...
  return closure_11(guildBoostSlots(7454).SafeAreaPaddingView, obj3);
};
