...
// Dependencies: [32, 19, 17, 2064, 5657, 5655, 21, 4757, 576, 5660, 1484, 504, 5661, 7370, 7621, 1115, 5653, 5341, 5803, 1177, 2]
// Exports: default
...
let closure_9 = fn(5655).PremiumGuildSubscribeModalScenes;
const jsxProd = fn(21);
...
export default function SubscribeModalGuildSelect(guildBoostSlots) {
  ...
  obj5.children = closure_10(guildBoostSlots(7370).SafeAreaPaddingView, {
    bottom: true,
  ...
  return closure_11(guildBoostSlots(7370).SafeAreaPaddingView, obj3);
};
