...
// Dependencies: [5, 19, 17, 12040, 2066, 4725, 4491, 1074, 6847, 4720, 21, 4829, 4680, 576, 504, 4724, 5904, 4825, 1115, 13133, 13134, 5274, 13143, 5286, 1094, 1241, 13098, 38, 4728, 5197, 13147, 1980, 2]
// Exports: default
...
function PendingCancellationWarning(slots) {
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      items1[1] = closure_1_19(tmp2(4825).Text, obj4);
