...
// Function ID: 8105
// Name: ChatItem
// Dependencies: [32, 19, 17, 4821, 1074, 7370, 21, 576, 8105, 1090, 8106, 6683, 8107, 4829, 1364, 7575, 4528, 672, 5286, 2]
// Exports: default

// Module 8104 (ChatItem)
...
import AutoModerationSystemMessageViewNativeComponent from "AutoModerationSystemMessageViewNativeComponent" /* 8105 */;
...
function DCDChatItem(message) {
  ...
  if (message.type === MessageTypes.AUTO_MODERATION_ACTION) {
    ...
    if (AUTOMOD_INCIDENT_ACTIONS.has(message.type)) {
      ...
      tmp3Result = closure_1_10(tmp21(8106).default, obj3);
    } else if (isSystemMessageDefault(message)) {
      const obj4 = {};
      const merged3 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8107).default, obj4);
    } else {
      const obj = {};
      const merged4 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8106).default, obj);
    }
  }
  return tmp3Result;
}
