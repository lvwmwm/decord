...
// Function ID: 8936
// Name: ChatItem
// Dependencies: [32, 19, 17, 4749, 1074, 8195, 21, 576, 8936, 1090, 8937, 7514, 8938, 4757, 1364, 8399, 4458, 672, 5199, 2]
// Exports: default

// Module 8935 (ChatItem)
...
import AutoModerationSystemMessageViewNativeComponent from "AutoModerationSystemMessageViewNativeComponent" /* 8936 */;
...
function DCDChatItem(message) {
  ...
  if (message.type === MessageTypes.AUTO_MODERATION_ACTION) {
    ...
    if (AUTOMOD_INCIDENT_ACTIONS.has(message.type)) {
      ...
      tmp3Result = closure_1_10(tmp21(8937).default, obj3);
    } else if (isSystemMessageDefault(message)) {
      const obj4 = {};
      const merged3 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8938).default, obj4);
    } else {
      const obj = {};
      const merged4 = Object.assign(merged);
      tmp3Result = tmp3(tmp21(8937).default, obj);
    }
  }
  return tmp3Result;
}
...
export const DCDMessageView = fn(8937).default;
export const DCDSystemMessageView = fn(8938).default;
export const DCDAutoModerationSystemMessageView = fn(8936).default;
