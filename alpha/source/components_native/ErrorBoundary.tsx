...
// Function ID: 14939
// Name: ErrorBoundary
// Dependencies: [5, 32, 19, 17, 11768, 21, 4827, 504, 12124, 5271, 1115, 4533, 1231, 573, 1177, 10191, 4823, 2]

// Module 14938 (ErrorBoundary)
...
import AppCrash from "AppCrash" /* 10191 */;
...
function MaybeClearBuildOverride() {
  ...
  if (null == obj.useStateFromStores(items, () => {
    ...
    return closure_9(tmp2(5271).Button, obj2);
  }
...
ErrorBoundary.contextType = fn(4533).ThemeContext;
const size = fn(2);
