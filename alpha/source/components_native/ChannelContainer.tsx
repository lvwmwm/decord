...
// Dependencies: [19, 17, 4463, 2042, 2096, 1074, 2039, 21, 4827, 4687, 10420, 504, 9751, 8618, 4647, 2028, 11666, 11667, 9859, 2]
// Exports: ChannelContainer

// Module 10419 (ChannelContainer)
...
import useChannelStylesShared from "useChannelStylesShared" /* 11666 */;
...
export const ChannelContainer = function ChannelContainer(children) {
  ...
  if (isStageChannel) {
    tmp5 = channelId(9751)(stateFromStoresObject.voiceChannelId);
  }
  ...
  const tmp8 = channelId(8618)(isPrivateResult);
  noop = tmp8;
  const tmp9 = channelId(8618)(channelId);
  closure_4 = tmp9;
