...
// Dependencies: [19, 17, 4467, 2044, 2098, 1074, 2041, 21, 4829, 4691, 9527, 504, 8853, 7712, 4651, 2028, 10852, 10853, 8962, 2]
// Exports: ChannelContainer

// Module 9526 (ChannelContainer)
...
import useChannelStylesShared from "useChannelStylesShared" /* 10852 */;
...
export const ChannelContainer = function ChannelContainer(children) {
  ...
  if (isStageChannel) {
    tmp5 = channelId(8853)(stateFromStoresObject.voiceChannelId);
  }
  ...
  const tmp8 = channelId(7712)(isPrivateResult);
  noop = tmp8;
  const tmp9 = channelId(7712)(channelId);
  closure_4 = tmp9;
