...
// Dependencies: [2100, 4466, 2048, 2044, 2066, 1372, 1074, 4477, 5011, 1084, 4467, 12, 1385, 573, 11, 504, 2]
...
const AccountNotificationFlags = fn(4477).AccountNotificationFlags;
