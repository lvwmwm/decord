...
// Dependencies: [4651, 4465, 1220, 5744, 5193, 2107, 2066, 1073, 5010, 1372, 5745, 1331, 38, 1370, 2018, 2]
...
function convertNodeToGuildFolder(type) {
  ...
  if (obj42(5745).GuildsNodeType.FOLDER === type) {
    ...
    return obj3;
  } else if (tmp(5745).GuildsNodeType.GUILD === type) {
  ...
  if (null != node) {
    if (null != node1) {
      ...
      if (combine) {
        ...
        if (node1.type !== tmp13(5745).GuildsNodeType.FOLDER) {
