...
// Dependencies: [4578, 4396, 1220, 5656, 5106, 2105, 2063, 1073, 4937, 1372, 5657, 1331, 38, 1370, 2017, 2]
...
function convertNodeToGuildFolder(type) {
  ...
  if (obj42(5657).GuildsNodeType.FOLDER === type) {
    ...
    return obj3;
  } else if (tmp(5657).GuildsNodeType.GUILD === type) {
  ...
  if (null != node) {
    if (null != node1) {
      ...
      if (combine) {
        ...
        if (node1.type !== tmp13(5657).GuildsNodeType.FOLDER) {
