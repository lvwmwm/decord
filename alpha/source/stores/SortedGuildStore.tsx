...
// Dependencies: [4653, 4467, 1220, 5746, 5194, 2107, 2066, 1073, 5010, 1372, 5747, 1331, 38, 1370, 2018, 2]
...
function convertNodeToGuildFolder(type) {
  ...
  if (obj42(5747).GuildsNodeType.FOLDER === type) {
    ...
    return obj3;
  } else if (tmp(5747).GuildsNodeType.GUILD === type) {
  ...
  if (null != node) {
    if (null != node1) {
      ...
      if (combine) {
        ...
        if (node1.type !== tmp13(5747).GuildsNodeType.FOLDER) {
