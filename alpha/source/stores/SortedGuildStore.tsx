...
// Dependencies: [4656, 4470, 1220, 5751, 5201, 2108, 2067, 1073, 5017, 1372, 5752, 1331, 38, 1370, 2019, 2]
...
function convertNodeToGuildFolder(type) {
  ...
  if (obj42(5752).GuildsNodeType.FOLDER === type) {
    ...
    return obj3;
  } else if (tmp(5752).GuildsNodeType.GUILD === type) {
  ...
  if (null != node) {
    if (null != node1) {
      ...
      if (combine) {
        ...
        if (node1.type !== tmp13(5752).GuildsNodeType.FOLDER) {
