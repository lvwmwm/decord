...
// Dependencies: [7959, 7961, 5809, 4464, 2046, 502, 2042, 2064, 1073, 4462, 4842, 2096, 5008, 1372, 1074, 2049, 5009, 7863, 11, 2067, 12, 4470, 2]

// Module 7958 (GuildReadStateStore)
...
const ReadStateConstants = fn(5009);
