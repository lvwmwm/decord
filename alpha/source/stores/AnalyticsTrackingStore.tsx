...
// Dependencies: [502, 1074, 1249, 573, 6876, 1241, 6887, 6888, 2]

// Module 6875 (stores/AnalyticsTrackingStore)
...
const obj2 = {
  ...
  scheduleWhenIdle: fn(6887).requestSafeIdleCallback,
  sendUnloadRequest: fn(6888).sendUnloadRequest
};
