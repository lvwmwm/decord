...
let closure_8 = ReanimatedRexport.createAnimatedComponent(fn(6270).FlashList);
const forwardRefResult = noop.forwardRef((arg0, ref) => {
  maintainVisibleContentPosition = { maintainVisibleContentPosition, ref };
  const merged = Object.assign(arg0);
  return jsx(_mod6270.FlashList, { maintainVisibleContentPosition, ref });
});
...
let ReanimatedRexport = ReanimatedRexport_mod;
let closure_9 = ReanimatedRexport.createAnimatedComponent(fn(6270).FlashList);
const forwardRefResult2 = noop.forwardRef((arg0, ref) => {
  ...
  return jsx(_mod6270.FlashList, { ref, maintainVisibleContentPosition, masonry: true });
});
const forwardRefResult3 = noop.forwardRef((arg0, ref) => {
  ...
  return jsx(refreshControl(6269), { ref, maintainVisibleContentPosition });
});
const size = fn(2);
const result = size.fileFinishedImporting("../discord_common/js/packages/flash-list/index.js");
for (const key10063 in require("module_6270")) {
  arg5[key10063] = require("module_6270")[key10063];
  continue;
}
...
export const BottomSheetMasonryFlashList = noop.forwardRef((arg0, ref) => {
  ...
  maintainVisibleContentPosition.renderScrollComponent = preventNativeModalDismiss(6045).BottomSheetScrollView;
  const merged1 = Object.assign(merged);
  maintainVisibleContentPosition.refreshControl = memo;
