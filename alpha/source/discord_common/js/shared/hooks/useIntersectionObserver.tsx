...
import InteractionObserverUtils from "InteractionObserverUtils" /* 7111 */;
...
export const useIntersectionObserver = function useIntersectionObserver(arg0, arg1) {
  ...
  const tmp3Result = flag(7110)(tmp4);
...
export const useIsVisible = function useIsVisible(arg0, arg1) {
  ...
  let current = num(7110)((isIntersecting) => {
  ...
  const tmpResultResult = num(7110)(tmp8);
