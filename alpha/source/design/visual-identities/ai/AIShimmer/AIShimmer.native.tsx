...
// Function ID: 14414
// Name: AIShimmer
// Dependencies: [32, 19, 17, 21, 4757, 14414, 4467, 4753, 14415, 4493, 14416, 14417, 14411, 2]

// Module 14413 (AIShimmer)
import ReanimatedRexport from "ReanimatedRexport" /* 4493 */;
import Text_Text from "Text/Text" /* 4753 */;
import AIShimmerTypes from "AIShimmerTypes" /* 14414 */;
import waveTransition2 from "waveTransition" /* 14415 */;
import createWaveTransition from "createWaveTransition" /* 14417 */;
...
function ShimmerLayers(pass) {
  ...
  const obj5 = pass(4493);
  fn.__closure = { animationProgress: animationProgress2, bandEdgesAt: pass(14415).bandEdgesAt, animationWidth: animationWidth2, overshoot: overshoot2, glyphLayerOpacityAt: pass(14415).glyphLayerOpacityAt, easeTail: pass(14415).easeTail };
  ...
  const obj6 = { animationProgress: animationProgress2, bandEdgesAt: pass(14415).bandEdgesAt, animationWidth: animationWidth2, overshoot: overshoot2, glyphLayerOpacityAt: pass(14415).glyphLayerOpacityAt, easeTail: pass(14415).easeTail };
  class T {
    constructor() {
  ...
  const animatedStyle = pass(4493).useAnimatedStyle(T);
  const obj7 = pass(4493);
  ...
  const animatedStyle1 = pass(4493).useAnimatedStyle(fn2);
  const obj8 = pass(4493);
  ...
  const animatedStyle2 = pass(4493).useAnimatedStyle(fn3);
  const obj9 = pass(4493);
  ...
  const animatedStyle3 = pass(4493).useAnimatedStyle(fn4);
