...
// Dependencies: [19, 17, 21, 5256, 4561, 2]

// Module 5255 (AccessibilityView)
import useAccessibilityViewIsModalToggleDefault from "useAccessibilityViewIsModalToggle" /* 5256 */;
