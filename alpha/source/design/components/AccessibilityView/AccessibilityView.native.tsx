...
// Dependencies: [19, 17, 21, 5257, 4563, 2]

// Module 5256 (AccessibilityView)
import useAccessibilityViewIsModalToggleDefault from "useAccessibilityViewIsModalToggle" /* 5257 */;
