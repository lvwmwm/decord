...
// Dependencies: [19, 21, 5278, 4825, 4829, 5274, 2]

// Module 9267 (Button/HeaderButton)
...
const diff = fn(5278).SMALL_BUTTON_HEIGHT - 2 * fn(5278).BUTTON_BORDER_WIDTH;
...
HeaderButton.Icon = fn(5274).BaseTextButton.Icon;
const size = fn(2);
