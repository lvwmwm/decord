...
// Dependencies: [19, 17, 21, 576, 4606, 4467, 5175, 4458, 5174, 4493, 5186, 5190, 2]
...
const VisualEffectViewAnimatedDefault = tmp3(5174);
const VisualEffectViewDefault = tmp3(5175);
require = fn;
