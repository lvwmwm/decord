...
// Dependencies: [19, 17, 21, 576, 4676, 4533, 5259, 4524, 5258, 4559, 5270, 5274, 2]
...
const VisualEffectViewAnimatedDefault = tmp3(5258);
const VisualEffectViewDefault = tmp3(5259);
require = fn;
