...
// Function ID: 11476
// Name: useTooltip
// Dependencies: [32, 5, 19, 21, 3, 1255, 7488, 11476, 1478, 11480, 2]
// Exports: useTooltip, useTooltipHelper

// Module 11475 (useTooltip)
import LoggerDefault from "Logger" /* 3 */;
import useWindowDimensionsDefault from "useWindowDimensions" /* 1478 */;
import AnimatedTooltip from "AnimatedTooltip" /* 11476 */;
...
export const useTooltip = function useTooltip(ref, memo) {
  ...
  const callback1 = obj.useCallback((arg0) => {
    ...
    closure_1 = async function _measureHelper(arg0, arg1) {
      closure_129_0 = ref;
      const measurements = memo(11480).getMeasurements(surfaceRef.surfaceRef, memo);
      const items = [measurements, memo(11480).getMeasurements(closure_1, memo)];
