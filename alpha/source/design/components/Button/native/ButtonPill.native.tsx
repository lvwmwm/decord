...
// Function ID: 5284
// Name: ButtonPill
// Dependencies: [32, 19, 17, 21, 5278, 4829, 576, 5279, 4535, 4526, 5284, 5285, 4561, 4680, 5289, 4545, 5272, 5276, 2]
// Exports: ButtonPill
...
function PillWrapper(expressivePressState) {
  ...
  if (shiny) {
    const obj7 = { variant };
    tmp7 = React5(tmp(5284).ButtonShine, obj7);
  }
  if ("experimental_premium-primary" !== variant) {
    if ("experimental_premium-basic" !== variant) {
      ...
      if (tmp11Result) {
        ...
        obj8.children = React5(tmp(4535).ExpressiveButtonRive, obj9);
      ...
      items3[1] = tmp9(tmp6(4561).View, obj12);
...
function useLoadingStyles(flag, DEFAULT_BUTTON_SIZE) {
  ...
  const fn = function o() {
    ...
    if (enabled) {
      ...
      if (!tmp3) {
        withDelayResult = tmp(4561).withDelay(c10, withSpringResult);
      ...
      const obj3 = { translateY: tmp(5272).withSpring(num2, tmp(5276).SUBTLE_SPRING) };
      const items1 = [obj3];
