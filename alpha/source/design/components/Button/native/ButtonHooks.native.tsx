...
// Function ID: 5281
// Name: ButtonHooks
// Dependencies: [19, 4829, 4537, 576, 4682, 4528, 4563, 5273, 5277, 5279, 5281, 5276, 4825, 1364, 2]
...
export const useIconSizeStyles = (arg0) => {
  ...
  return fontScale.useMemo(() => {
    Icon;
    if ("sm" === closure_0) {
      let iconSize = tmp(5276).getIconSize(tmp(5279).SMALL_BUTTON_ICON_SIZE);
      const tmpResult = tmp(5276);
    } else {
      iconSize = tmp4;
      if ("lg" === tmp5) {
        iconSize = tmp(5276).getIconSize(tmp(5279).LARGE_BUTTON_ICON_SIZE);
        const tmpResult4 = tmp(5276);
      }
    }
    let width = iconSize;
    if (flag) {
