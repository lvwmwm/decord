...
// Function ID: 5288
// Name: ButtonEllipsis
// Dependencies: [19, 21, 4559, 4827, 576, 4828, 5277, 5288, 2]
// Exports: Ellipsis

// Module 5287 (ButtonEllipsis)
  ...
  const mountLayoutEffect = offset(sharedValue1[7]).useMountLayoutEffect(() => {
    if (typeof withEllipsisAnimation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        const tmp5Result3 = tmp5(4559);
        tmp11(tmp5Result.withDelay(result1, tmp5Result3.withRepeat(tmp5(4828).withTiming(1, tmp8, "animate-always"), -1, true)));
        return () => {
...
withEllipsisAnimation.__closure = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: fn(4559).withDelay, withRepeat: fn(4559).withRepeat, withTiming: fn(4828).withTiming, ELLIPSIS_APPEAR_TIMING };
