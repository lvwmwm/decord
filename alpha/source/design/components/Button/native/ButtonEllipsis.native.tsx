...
// Function ID: 5204
// Name: ButtonEllipsis
// Dependencies: [19, 21, 4493, 4757, 576, 4758, 5193, 5204, 2]
// Exports: Ellipsis

// Module 5203 (ButtonEllipsis)
  ...
  const mountLayoutEffect = offset(sharedValue1[7]).useMountLayoutEffect(() => {
    if (typeof withEllipsisAnimation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        const tmp5Result3 = tmp5(4493);
        tmp11(tmp5Result.withDelay(result1, tmp5Result3.withRepeat(tmp5(4758).withTiming(1, tmp8, "animate-always"), -1, true)));
        return () => {
...
withEllipsisAnimation.__closure = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: fn(4493).withDelay, withRepeat: fn(4493).withRepeat, withTiming: fn(4758).withTiming, ELLIPSIS_APPEAR_TIMING };
