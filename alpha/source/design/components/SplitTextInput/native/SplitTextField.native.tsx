...
// Function ID: 7297
// Name: SplitTextField
// Dependencies: [19, 17, 21, 6949, 6942, 6943, 6947, 6951, 2]
...
export const SplitTextField = noop.forwardRef((size, ref) => {
  ...
  if (null != size.leadingText) {
    ...
    if (size.leadingText.length > 0) {
      ...
      obj8.children = tmp(6947).renderInputAttachment(undefined, size.leadingText, inputStyles.text);
