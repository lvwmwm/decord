...
// Function ID: 7248
// Name: Navigator
// Dependencies: [32, 19, 17, 21, 4757, 576, 7248, 5843, 4458, 7249, 1612, 1115, 12, 7282, 1485, 4691, 7288, 5850, 1232, 2]
  ...
  const obj4 = {
    ...
    screenOptions: gestureDirection.useCallback((navigation) => {
      ...
      if (navigatorShouldCrossfade) {
        ...
        fn2 = tmp3(7249).CardStyleInterpolators.forHorizontalIOS;
      }
      obj.cardStyleInterpolator = fn2;
      if (disableHeaderAnimation) {
        let fn3 = tmp3(7249).HeaderStyleInterpolators.forNoAnimation;
      } else if (tmp2) {
        fn3 = tmp3(7249).HeaderStyleInterpolators.forFade;
      } else {
        fn3 = (arg0) => {
