...
// Function ID: 7332
// Name: Navigator
// Dependencies: [32, 19, 17, 21, 4827, 576, 7332, 5927, 4524, 7333, 1612, 1115, 12, 7366, 1485, 4761, 7372, 5934, 1232, 2]
  ...
  const obj4 = {
    ...
    screenOptions: gestureDirection.useCallback((navigation) => {
      ...
      if (navigatorShouldCrossfade) {
        ...
        fn2 = tmp3(7333).CardStyleInterpolators.forHorizontalIOS;
      }
      obj.cardStyleInterpolator = fn2;
      if (disableHeaderAnimation) {
        let fn3 = tmp3(7333).HeaderStyleInterpolators.forNoAnimation;
      } else if (tmp2) {
        fn3 = tmp3(7333).HeaderStyleInterpolators.forFade;
      } else {
        fn3 = (arg0) => {
