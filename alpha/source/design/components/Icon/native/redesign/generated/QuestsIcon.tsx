...
// Function ID: 14532
// Name: QuestsIcon
// Dependencies: [19, 21, 576, 4530, 14532, 2]
// Exports: QuestsIcon

// Module 14531 (QuestsIcon)
...
export const QuestsIcon = function QuestsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod14532, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
