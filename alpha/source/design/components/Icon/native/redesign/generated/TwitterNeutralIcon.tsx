...
// Dependencies: [19, 21, 576, 4525, 12700, 2]
// Exports: TwitterNeutralIcon

// Module 12699 (TwitterNeutralIcon)
...
export const TwitterNeutralIcon = function TwitterNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12700, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
