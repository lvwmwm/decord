...
// Dependencies: [19, 21, 576, 4457, 14120, 2]
// Exports: ChannelListMagnifyingGlassIcon

// Module 14119 (ChannelListMagnifyingGlassIcon)
...
export const ChannelListMagnifyingGlassIcon = function ChannelListMagnifyingGlassIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod14120, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
