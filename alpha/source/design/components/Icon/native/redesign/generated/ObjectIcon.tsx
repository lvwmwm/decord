...
// Function ID: 10703
// Name: ObjectIcon
// Dependencies: [19, 21, 576, 4525, 10703, 2]
// Exports: ObjectIcon

// Module 10702 (ObjectIcon)
...
export const ObjectIcon = function ObjectIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10703, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
