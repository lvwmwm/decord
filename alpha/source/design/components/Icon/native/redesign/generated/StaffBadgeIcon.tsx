...
// Function ID: 15922
// Name: StaffBadgeIcon
// Dependencies: [19, 21, 576, 4523, 15922, 2]
// Exports: StaffBadgeIcon

// Module 15921 (StaffBadgeIcon)
...
export const StaffBadgeIcon = function StaffBadgeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15922, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
