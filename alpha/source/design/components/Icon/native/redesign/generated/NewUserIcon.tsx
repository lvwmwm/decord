...
// Function ID: 12549
// Name: NewUserIcon
// Dependencies: [19, 21, 576, 4527, 12549, 2]
// Exports: NewUserIcon

// Module 12548 (NewUserIcon)
...
export const NewUserIcon = function NewUserIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12549, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
