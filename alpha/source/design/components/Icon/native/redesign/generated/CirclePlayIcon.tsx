...
// Function ID: 9071
// Name: CirclePlayIcon
// Dependencies: [19, 17, 21, 576, 4523, 9071, 9072, 2]
// Exports: CirclePlayIcon

// Module 9070 (CirclePlayIcon)
...
export const CirclePlayIcon = function CirclePlayIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod9071, color: secondaryColor, style }), ];
  const obj3 = { source: _mod9072, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
