...
// Function ID: 9000
// Name: CirclePlayIcon
// Dependencies: [19, 17, 21, 576, 4457, 9000, 9001, 2]
// Exports: CirclePlayIcon

// Module 8999 (CirclePlayIcon)
...
export const CirclePlayIcon = function CirclePlayIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod9000, color: secondaryColor, style }), ];
  const obj3 = { source: _mod9001, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
