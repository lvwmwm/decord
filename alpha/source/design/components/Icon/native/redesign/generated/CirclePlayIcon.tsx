...
// Function ID: 9075
// Name: CirclePlayIcon
// Dependencies: [19, 17, 21, 576, 4525, 9075, 9076, 2]
// Exports: CirclePlayIcon

// Module 9074 (CirclePlayIcon)
...
export const CirclePlayIcon = function CirclePlayIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod9075, color: secondaryColor, style }), ];
  const obj3 = { source: _mod9076, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
