...
// Dependencies: [19, 21, 576, 4457, 4702, 2]
// Exports: SendMessageIcon

// Module 4701 (SendMessageIcon)
...
export const SendMessageIcon = function SendMessageIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4702, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
