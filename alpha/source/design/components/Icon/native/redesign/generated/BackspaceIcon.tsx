...
// Function ID: 9824
// Name: BackspaceIcon
// Dependencies: [19, 21, 576, 4530, 9824, 2]
// Exports: BackspaceIcon

// Module 9823 (BackspaceIcon)
...
export const BackspaceIcon = function BackspaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9824, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
