...
// Function ID: 9223
// Name: PlusSmallIcon
// Dependencies: [19, 21, 576, 4523, 9223, 2]
// Exports: PlusSmallIcon

// Module 9222 (PlusSmallIcon)
...
export const PlusSmallIcon = function PlusSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9223, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
