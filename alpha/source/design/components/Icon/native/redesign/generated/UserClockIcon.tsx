...
// Function ID: 13529
// Name: UserClockIcon
// Dependencies: [19, 21, 576, 4525, 13529, 2]
// Exports: UserClockIcon

// Module 13528 (UserClockIcon)
...
export const UserClockIcon = function UserClockIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13529, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
