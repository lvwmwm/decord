...
// Dependencies: [19, 21, 576, 4457, 15910, 2]
// Exports: DoubleCheckmarkIcon

// Module 15909 (DoubleCheckmarkIcon)
...
export const DoubleCheckmarkIcon = function DoubleCheckmarkIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15910, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
