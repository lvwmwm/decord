...
// Function ID: 11217
// Name: PlusLargeIcon
// Dependencies: [19, 21, 576, 4456, 11217, 2]
// Exports: PlusLargeIcon

// Module 11216 (PlusLargeIcon)
...
export const PlusLargeIcon = function PlusLargeIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11217, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
