...
// Dependencies: [19, 21, 576, 4530, 8038, 2]
// Exports: LinkExternalSmallIcon

// Module 8037 (LinkExternalSmallIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4530 */;
import _mod8038 from "module_8038" /* 8038 */;
...
export const LinkExternalSmallIcon = function LinkExternalSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8038, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
