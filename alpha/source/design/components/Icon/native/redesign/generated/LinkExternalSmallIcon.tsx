...
// Dependencies: [19, 21, 576, 4527, 8030, 2]
// Exports: LinkExternalSmallIcon

// Module 8029 (LinkExternalSmallIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4527 */;
import _mod8030 from "module_8030" /* 8030 */;
...
export const LinkExternalSmallIcon = function LinkExternalSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8030, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
