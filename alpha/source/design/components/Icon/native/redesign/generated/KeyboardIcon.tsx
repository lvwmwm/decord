...
// Function ID: 10804
// Name: KeyboardIcon
// Dependencies: [19, 21, 576, 4527, 10804, 2]
// Exports: KeyboardIcon

// Module 10803 (KeyboardIcon)
...
export const KeyboardIcon = function KeyboardIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10804, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
