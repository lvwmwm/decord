...
// Function ID: 10252
// Name: MusicSlashIcon
// Dependencies: [19, 21, 576, 4523, 10252, 2]
// Exports: MusicSlashIcon

// Module 10251 (MusicSlashIcon)
...
export const MusicSlashIcon = function MusicSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10252, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
