...
// Function ID: 10172
// Name: MusicSlashIcon
// Dependencies: [19, 21, 576, 4457, 10172, 2]
// Exports: MusicSlashIcon

// Module 10171 (MusicSlashIcon)
...
export const MusicSlashIcon = function MusicSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10172, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
