...
// Dependencies: [19, 21, 576, 4523, 9249, 2]
// Exports: BlueskyNeutralIcon

// Module 9248 (BlueskyNeutralIcon)
...
export const BlueskyNeutralIcon = function BlueskyNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9249, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
