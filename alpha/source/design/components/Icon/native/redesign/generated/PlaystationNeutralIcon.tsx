...
// Dependencies: [19, 21, 576, 4523, 9240, 2]
// Exports: PlaystationNeutralIcon

// Module 9239 (PlaystationNeutralIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4523 */;
import _mod9240 from "module_9240" /* 9240 */;
...
export const PlaystationNeutralIcon = function PlaystationNeutralIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9240, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
