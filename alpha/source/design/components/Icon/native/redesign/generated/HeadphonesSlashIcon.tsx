...
// Dependencies: [19, 21, 576, 4525, 10028, 2]
// Exports: HeadphonesSlashIcon

// Module 10027 (HeadphonesSlashIcon)
...
export const HeadphonesSlashIcon = function HeadphonesSlashIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10028, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
