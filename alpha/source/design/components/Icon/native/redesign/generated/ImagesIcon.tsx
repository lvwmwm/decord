...
// Function ID: 11196
// Name: ImagesIcon
// Dependencies: [19, 21, 576, 4530, 11196, 2]
// Exports: ImagesIcon

// Module 11195 (ImagesIcon)
...
export const ImagesIcon = function ImagesIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11196, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
