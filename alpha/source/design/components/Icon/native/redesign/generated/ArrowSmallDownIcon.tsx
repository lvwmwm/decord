...
// Dependencies: [19, 21, 576, 4457, 16074, 2]
// Exports: ArrowSmallDownIcon

// Module 16073 (ArrowSmallDownIcon)
...
export const ArrowSmallDownIcon = function ArrowSmallDownIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod16074, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
