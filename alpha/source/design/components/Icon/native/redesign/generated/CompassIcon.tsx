...
// Function ID: 15152
// Name: CompassIcon
// Dependencies: [19, 21, 576, 4530, 15152, 2]
// Exports: CompassIcon

// Module 15151 (CompassIcon)
...
export const CompassIcon = function CompassIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15152, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
