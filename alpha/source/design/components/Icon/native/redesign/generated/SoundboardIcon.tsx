...
// Function ID: 12869
// Name: SoundboardIcon
// Dependencies: [19, 21, 576, 4523, 12869, 2]
// Exports: SoundboardIcon

// Module 12868 (SoundboardIcon)
...
export const SoundboardIcon = function SoundboardIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12869, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
