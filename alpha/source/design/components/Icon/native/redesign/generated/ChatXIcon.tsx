...
// Function ID: 12815
// Name: ChatXIcon
// Dependencies: [19, 21, 576, 4525, 12815, 2]
// Exports: ChatXIcon

// Module 12814 (ChatXIcon)
...
export const ChatXIcon = function ChatXIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12815, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
