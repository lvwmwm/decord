...
// Function ID: 17741
// Name: ScreenXIcon
// Dependencies: [19, 21, 576, 4523, 10313, 2]
// Exports: ScreenXIcon

// Module 17740 (ScreenXIcon)
...
export const ScreenXIcon = function ScreenXIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10313, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
