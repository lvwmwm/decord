...
// Function ID: 17672
// Name: ScreenXIcon
// Dependencies: [19, 21, 576, 4457, 10234, 2]
// Exports: ScreenXIcon

// Module 17671 (ScreenXIcon)
...
export const ScreenXIcon = function ScreenXIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10234, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
