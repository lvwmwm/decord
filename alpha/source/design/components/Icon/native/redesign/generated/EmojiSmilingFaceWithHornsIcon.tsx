...
// Dependencies: [19, 21, 576, 4530, 14941, 2]
// Exports: EmojiSmilingFaceWithHornsIcon

// Module 14940 (EmojiSmilingFaceWithHornsIcon)
...
export const EmojiSmilingFaceWithHornsIcon = function EmojiSmilingFaceWithHornsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod14941, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
