...
// Dependencies: [19, 17, 21, 4827, 576, 5425, 1115, 1177, 7269, 38, 2]

// Module 7268 (FreeFormTextInput)
...
function ClearButton(onPress) {
  ...
  const tmp = closure_9();
  obj.children = React5(native.Icon, { source: _modDef7269, style: closure_9().closeIcon, size: native.Icon.Sizes.MEDIUM });
