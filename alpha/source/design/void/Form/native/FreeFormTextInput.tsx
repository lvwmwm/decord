...
// Dependencies: [19, 17, 21, 4757, 576, 5341, 1115, 1177, 7185, 38, 2]

// Module 7184 (FreeFormTextInput)
...
function ClearButton(onPress) {
  ...
  const tmp = closure_9();
  obj.children = React5(native.Icon, { source: _modDef7185, style: closure_9().closeIcon, size: native.Icon.Sizes.MEDIUM });
