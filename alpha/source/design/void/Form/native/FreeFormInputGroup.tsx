...
// Dependencies: [19, 17, 21, 4827, 1364, 5989, 6934, 1177, 7267, 7268, 7270, 4823, 2]
...
export default noop.forwardRef((accessibilityLabel, ref) => {
  ...
  if (context) {
    ...
    return hasOwnProperty(tmp8(6934).TextInput, obj3);
  } else {
    ...
    if (null != hint) {
      ...
      tmp17Result2 = tmp17(tmp8(4823).Text, obj8);
    }
