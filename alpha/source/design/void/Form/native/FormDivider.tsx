...
// Function ID: 8883
// Name: FormDivider
// Dependencies: [19, 17, 1074, 21, 4757, 576, 4467, 7431, 4606, 5905, 2]
// Exports: default
...
export default function Divider(arg0) {
  ...
  let tmp7 = null;
  if (tmp6) {
    const obj3 = { backgroundColor: tmp2(4606).hexOpacityToRgba(obj2[theme], profileThemeValues.dividerOpacity) };
    tmp7 = obj3;
