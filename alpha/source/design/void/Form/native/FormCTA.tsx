...
// Function ID: 8949
// Name: FormCTA
// Dependencies: [19, 17, 1085, 21, 4827, 576, 1177, 5920, 7468, 8949, 2]
// Exports: default

// Module 8948 (FormCTA)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import FormCheckbox2 from "FormCheckbox" /* 5920 */;
...
export default function FormCTA(arg0) {
  ...
  if ("row-button" === variant) {
    ...
    if (completed) {
      FormCheckbox = FormCheckbox(5920).FormCheckbox;
      obj7 = { checked: true };
      trailing = tmp16(FormCheckbox, obj7);
    } else if (trailing == null) {
      trailing = tmp16(tmp17(7468).Arrow, {});
    }
