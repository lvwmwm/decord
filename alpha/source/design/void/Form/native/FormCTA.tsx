...
// Function ID: 8878
// Name: FormCTA
// Dependencies: [19, 17, 1085, 21, 4757, 576, 1177, 5836, 7384, 8878, 2]
// Exports: default

// Module 8877 (FormCTA)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import FormCheckbox2 from "FormCheckbox" /* 5836 */;
...
export default function FormCTA(arg0) {
  ...
  if ("row-button" === variant) {
    ...
    if (completed) {
      FormCheckbox = FormCheckbox(5836).FormCheckbox;
      obj7 = { checked: true };
      trailing = tmp16(FormCheckbox, obj7);
    } else if (trailing == null) {
      trailing = tmp16(tmp17(7384).Arrow, {});
    }
