...
// Dependencies: [19, 17, 1074, 21, 4827, 8967, 2]

// Module 8966 (LegacyText/LegacyText)
import useLegacyTextMigrationHighlight from "useLegacyTextMigrationHighlight" /* 8967 */;
