...
// Dependencies: [5, 19, 4516, 5037, 2044, 4474, 2098, 1372, 1074, 1099, 5038, 21, 5039, 5030, 8744, 1110, 7371, 7544, 4796, 14132, 1980, 5032, 5716, 5196, 1115, 5443, 4695, 14167, 5197, 10086, 2]
  ...
  if (!obj.maybeOpenAgeGateForVoiceChannel(channel.id)) {
    ...
    if (channel.isGuildStageVoice()) {
      if (SelectedChannelStore.getVoiceChannelId() === channel.id) {
        tmp(8744).openStageChannel(channel);
...
export const openVoiceChannelActionSheet = function openVoiceChannelActionSheet(channel) {
  ...
  obj.openLazy(asyncRequireImpl(14132, dependencyMap.paths), "" + c17 + "-" + channel.id, { channel });
};
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj7 = { value: v1(5443).requestPermission(constants.CAMERA), done: false };
            return obj7;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
        ...
        const obj2 = tmp4(4695);
        const voiceChannel = v1(5716).selectVoiceChannel(closure_128_0.id, closure_128_1);
        dependencyMap = 3;
        return { value: "HermesInternal", done: null };
      } catch (tmp17) {
        dependencyMap = tmp;
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (flag) {
              dependencyMap = 1;
              c3 = 1;
              const obj6 = { value: tmp5(5443).requestPermission(constants2.CAMERA), done: false };
              return obj6;
            }
          }
        } else if (arg0 === 1) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj6 = { value: v1(5443).requestPermission(constants.CAMERA), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
