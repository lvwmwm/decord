...
// Dependencies: [19, 17, 21, 4757, 576, 5660, 5207, 4753, 7227, 8358, 1929, 2]
...
function ChangeLogStrong(arg0) {
  ...
  if (obj.useManaTypeConsolidationExperiment("ChangeLogStrong")) {
    ...
    const obj2 = { variant: "experimental/body-sm/semibold", color: str, children: tmp(8358).smartOutput(node, output, state) };
    let reactResult = jsx(tmp(4753).Text, { variant: "experimental/body-sm/semibold", color: str, children: tmp(8358).smartOutput(node, output, state) });
    const tmpResult = tmp(8358);
  } else {
