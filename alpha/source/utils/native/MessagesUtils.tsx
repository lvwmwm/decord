...
// Function ID: 12290
// Name: MessagesUtils
// Dependencies: [1074, 7654, 4815, 8220, 4975, 2]
      ...
      if (someResult) {
        ...
        someResult = codedLinks.some((item) => {
          ...
          if (CodedLink.CodedLinkType.BUILD_OVERRIDE !== type) {
            if (tmp(4815).CodedLinkType.MANUAL_BUILD_OVERRIDE !== type) {
              if (tmp(4815).CodedLinkType.EXPERIMENT === type) {
                const experimentFromEmbedURL = tmp(8220).getExperimentFromEmbedURL(code);
                ...
                if (tmp(4815).CodedLinkType.EVENT !== type) {
                  if (tmp(4815).CodedLinkType.CHANNEL_LINK !== type) {
                    if (tmp(4815).CodedLinkType.APP_DIRECTORY_PROFILE === type) {
                      ...
                      return tmp25;
                    } else if (tmp(4815).CodedLinkType.ACTIVITY_BOOKMARK === type) {
                          ...
                          if (tmp(4815).CodedLinkType.SOCIAL_LAYER_STOREFRONT !== type) {
                            if (tmp(4815).CodedLinkType.SOCIAL_LAYER_STOREFRONT_APP !== type) {
                              if (tmp(4815).CodedLinkType.QUESTS_EMBED === type) {
                                ...
                                if (tmp(4815).CodedLinkType.APP_DIRECTORY_STOREFRONT !== type) {
                                  if (tmp(4815).CodedLinkType.APP_DIRECTORY_STOREFRONT_SKU !== type) {
                                    if (tmp(4815).CodedLinkType.APP_OAUTH2_LINK === type) {
