...
// Dependencies: [1074, 9401, 1241, 8720, 4520, 9402, 1086, 5032, 9407, 1980, 8689, 2]
...
export const installApplication = function installApplication(arg0) {
  ...
  if (null != customInstallUrl) {
    ...
    if (null != installParams) {
      ...
      tmp32Result2.pushLazy(customInstallUrl(1980)(9407, tmp33.paths), obj12, closure_5);
      const tmp10 = customInstallUrl(1980)(9407, tmp33.paths);
    }
  }
};
