...
// Function ID: 5083
// Name: StoreUtils
// Dependencies: [5, 502, 4483, 4484, 4487, 1074, 5083, 5081, 5162, 1431, 5164, 1271, 1364, 1115, 2]
...
const isMobile = fn(5081).isMobile;
let tmp4 = !isMobile;
if (!isMobile) {
  tmp4 = !fn(5081).isTablet;
}
if (tmp4) {
  tmp4 = -1 !== fn(5162).getChromeVersion();
  let obj2 = fn(5162);
}
let closure_9 = tmp4;
const size = fn(2);
