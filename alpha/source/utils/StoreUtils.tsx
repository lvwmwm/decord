...
// Function ID: 5085
// Name: StoreUtils
// Dependencies: [5, 502, 4485, 4486, 4489, 1074, 5085, 5083, 5164, 1431, 5166, 1271, 1364, 1115, 2]
...
const isMobile = fn(5083).isMobile;
let tmp4 = !isMobile;
if (!isMobile) {
  tmp4 = !fn(5083).isTablet;
}
if (tmp4) {
  tmp4 = -1 !== fn(5164).getChromeVersion();
  let obj2 = fn(5164);
}
let closure_9 = tmp4;
const size = fn(2);
