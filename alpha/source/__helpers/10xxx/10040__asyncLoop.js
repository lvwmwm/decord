...
// Function ID: 10041
// Name: _asyncLoop
// Dependencies: [41, 42, 5, 10041, 10042]
...
export const randomBytes = function randomBytes(result) {
  ...
  if (Hash(10042).crypto) {
    if (typeof tmp(10042).crypto.getRandomValues === "function") {
      const _crypto2 = tmp(10042).crypto;
      const _Uint8Array = Uint8Array;
  ...
  if (Hash(10042).crypto) {
    if (typeof tmp(10042).crypto.randomBytes === "function") {
      const _crypto = tmp(10042).crypto;
