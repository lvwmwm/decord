...
// Function ID: 13194
// Name: _flush
// Dependencies: [5, 13172, 13194, 13173, 13145, 13156, 13159, 13152, 13182, 13146, 13168]
...
function endSession() {
  ...
  if (tmp3) {
    tmp(13168).closeSession(tmp3);
    const tmpResult = tmp(13168);
  }
...
export const captureException = function captureException(arg0, arg1) {
  const currentScope = _mod13172.getCurrentScope();
  return currentScope.captureException(arg0, _mod13194.parseEventHintOrCaptureContext(arg1));
};
...
export const startSession = function startSession(arg0) {
  ...
  if (undefined === environment) {
    environment = tmp(13182).DEFAULT_ENVIRONMENT;
  }
  ...
  if (tmp10) {
    tmp(13168).updateSession(session1, { status: "exited" });
    const tmpResult2 = tmp(13168);
  }
  endSession();
