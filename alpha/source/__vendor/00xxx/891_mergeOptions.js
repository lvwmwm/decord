...
function Form(onSubmitError) {
  ({ options, defaultEmail, defaultName, onSubmit: f110601, onSubmitSuccess } = onSubmitError);
  ...
  closure_15 = fn2(() => f73093, items);
  f110601 = screenshotInput(function*(arg0, value) {
    if (c6 === 2) {
      c6 = 3;
      ...
      try {
        ...
        if (0 === c5) {
          ...
          if (3 === tmp8) {
            ...
            if (messageLabel) {
              const debug = f110601(onSubmitSuccess[2]).debug;
  ...
  f110601 = function(arg0) {
    const self = this;
    const apply = f110601.apply;
  ...
  obj = { class: "form", onSubmit: tmp13(() => f73093, items1) };
...
function Dialog(onFormSubmitted) {
  ...
  const tmp2 = fn2(() => {
    obj = { __html: null };
    const _document = f73093(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document2 = f73093(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document3 = f73093(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document4 = f73093(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document5 = f73093(merged[2]).GLOBAL_OBJ.document;
    const elementNS4 = _document5.createElementNS("http://www.w3.org/2000/svg", "defs");
    const _document6 = f73093(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document7 = f73093(merged[2]).GLOBAL_OBJ.document;
