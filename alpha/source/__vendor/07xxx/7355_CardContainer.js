...
// Function ID: 7356
// Name: CardContainer
// Dependencies: [19, 17, 21, 1485, 5936, 7356, 7357, 7358, 7345]

// Module 7355 (CardContainer)
import Link from "Link" /* 1485 */;
import _mod5936 from "module_5936" /* 5936 */;
import ModalPresentationContext from "ModalPresentationContext" /* 7345 */;
import _mod7356 from "module_7356" /* 7356 */;
import CardA11yWrapper from "CardA11yWrapper" /* 7357 */;
import _mod7358 from "module_7358" /* 7358 */;
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let num = noop.useContext(_mod5936.HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let obj2 = Link;
  const keyboardManager = _mod7356.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7356;
  ...
  if (previousScene) {
    ...
    headerTitle = tmp2(5936).getHeaderTitle(options, route.name);
  ...
  obj12.children = React4(_mod5936.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5936.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5936.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod7358.Card, obj5);
