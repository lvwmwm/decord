...
// Dependencies: [7187, 19, 21, 7206, 7205]

// Module 7256 (LayoutCommitObserver)
...
const memoResult = noop.memo((children) => {
  ...
  [r10018, tmp3] = _mod7205.useLayoutState(0);
  _slicedToArray = tmp3;
  const tmp2 = _slicedToArray(_mod7205.useLayoutState(0), 2);
  ...
  return jsx(_mod7206.RecyclerViewContextProvider, { value, children: children.children });
});
