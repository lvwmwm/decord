...
// Function ID: 7086
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6990, 7057, 7086, 7087, 7088, 7089, 7090, 7083, 6998, 6996]
// Exports: default
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(7086).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(7086);
          } else {
