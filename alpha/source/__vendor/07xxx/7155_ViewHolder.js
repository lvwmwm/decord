...
// Function ID: 7156
// Name: ViewHolder
// Dependencies: [19, 21, 7118, 7151]

// Module 7155 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_7118").getInvertedTransformStyle(horizontal);
    let obj = require("module_7118");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
