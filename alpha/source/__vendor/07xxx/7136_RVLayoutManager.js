...
// Dependencies: [7110, 7111, 7115, 7137, 7124, 7098, 7138]
    ...
    value: function getVisibleLayouts(bound1, arg1) {
      ...
      if (-1 !== result) {
        if (-1 !== findLastVisibleIndexResult) {
          let EMPTY = new tmp(7124).ConsecutiveNumbers(result, findLastVisibleIndexResult);
        }
        return EMPTY;
      }
      EMPTY = tmp(7124).ConsecutiveNumbers.EMPTY;
    }
  },
  {
    key: "deleteLayout",
