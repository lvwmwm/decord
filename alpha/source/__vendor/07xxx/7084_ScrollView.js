...
// Function ID: 7085
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6997, 6998, 7017, 7057, 7053]
// Exports: FlatList

// Module 7084 (ScrollView)
...
const jsx = fn(21).jsx;
let closure_11 = module_6997(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6998).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6997(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6998).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6997(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6997(TextInput);
