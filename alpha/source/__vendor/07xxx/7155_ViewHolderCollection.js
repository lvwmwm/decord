...
// Dependencies: [7099, 19, 21, 7118, 7149, 7153]
// Exports: ViewHolderCollection

// Module 7155 (ViewHolderCollection)
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(7118).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7149).CompatView, { style: tmp19, children: null });
};
