...
// Function ID: 6174
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6078, 6145, 6174, 6175, 6176, 6177, 6178, 6171, 6086, 6084]
// Exports: default
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6174).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6174);
          } else {
