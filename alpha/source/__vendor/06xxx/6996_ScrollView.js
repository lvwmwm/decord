...
// Function ID: 6997
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6909, 6910, 6929, 6969, 6965]
// Exports: FlatList

// Module 6996 (ScrollView)
...
const jsx = fn(21).jsx;
let closure_11 = module_6909(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6910).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6909(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6910).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6909(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6909(TextInput);
