...
// Dependencies: [109, 19, 17, 21, 6116, 1745, 6088]

// Module 6146 (NativeEventsManager1)
...
if (!NativeEventsManager1) {
  try {
    NativeEventsManager = fn(1745).NativeEventsManager;
...
if (tmp4) {
  ...
  if (tmp5 != null) {
    ...
    LeanReanimatedNativeDetector = obj.createAnimatedComponent(_modDef6088);
  }
}
