...
// Function ID: 6173
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6085, 6086, 6105, 6145, 6141]
// Exports: FlatList

// Module 6172 (ScrollView)
...
const jsx = fn(21).jsx;
let closure_11 = module_6085(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6086).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6085(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6086).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6085(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6085(TextInput);
