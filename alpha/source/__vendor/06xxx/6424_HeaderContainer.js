...
// Dependencies: [19, 17, 21, 5938, 1485, 6425, 6426]
// Exports: HeaderContainer

// Module 6424 (HeaderContainer)
...
export const HeaderContainer = function HeaderContainer(getFocusedRoute) {
  ...
  closure_6 = noop.useContext(_mod5938.HeaderBackContext);
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = { title: require("module_5938").getHeaderTitle(tmp11, route.name), href: buildHref(route.name, route.params) };
                tmp9 = obj2;
                const obj3 = require("module_5938");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_6425").forSlideRight;
                    } else {
                      forSlideUp = require("module_6425").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_6425").forSlideUp;
              }
            } else {
              forNoAnimation = require("module_6425").forNoAnimation;
            }
