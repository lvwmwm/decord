...
// Function ID: 6998
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6902, 6969, 6998, 6999, 7000, 7001, 7002, 6995, 6910, 6908]
// Exports: default
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6969.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6998).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6998);
          } else {
