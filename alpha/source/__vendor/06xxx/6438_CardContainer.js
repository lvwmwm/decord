...
// Function ID: 6439
// Name: CardContainer
// Dependencies: [19, 17, 21, 1485, 5938, 6439, 6440, 6441, 6428]

// Module 6438 (CardContainer)
import Link from "Link" /* 1485 */;
import _mod5938 from "module_5938" /* 5938 */;
import ModalPresentationContext from "ModalPresentationContext" /* 6428 */;
import _mod6439 from "module_6439" /* 6439 */;
import CardA11yWrapper from "CardA11yWrapper" /* 6440 */;
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let num = noop.useContext(_mod5938.HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let obj2 = Link;
  const keyboardManager = _mod6439.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod6439;
  ...
  if (previousScene) {
    ...
    headerTitle = tmp2(5938).getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = tmp2(5938);
  }
  closure_15 = tmp12;
  ...
  obj12.children = React4(_mod5938.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5938.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5938.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod6441.Card, obj5);
