...
// Function ID: 6169
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6073, 6140, 6169, 6170, 6171, 6172, 6173, 6166, 6081, 6079]
// Exports: default

// Module 6168 (hitSlop)
import _mod6140 from "module_6140" /* 6140 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6169 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6172 */;
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6140.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6169).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6169);
          } else {
