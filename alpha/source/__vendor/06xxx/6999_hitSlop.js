...
// Function ID: 7000
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6904, 6971, 7000, 7001, 7002, 7003, 7004, 6997, 6912, 6910]
// Exports: default
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(7000).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(7000);
          } else {
