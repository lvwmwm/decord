...
// Dependencies: [32, 19, 17, 21, 6977, 6904, 6979, 6966, 6975, 6974, 6953]
// Exports: VirtualDetector

// Module 6978 (VirtualDetector)
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("module_6977").useInterceptingDetectorContext();
