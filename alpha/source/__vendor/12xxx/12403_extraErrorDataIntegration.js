...
// Dependencies: [12369, 12320, 12358, 12319, 12322, 12341, 12313]
      ...
      if (obj.originalException) {
        ...
        if (obj2.isError(obj.originalException)) {
          ...
          if (tmp7) {
            ...
            const normalizer = tmp4(12358);
            const normalizeResult = normalizer.normalize(tmp7, num);
            if (tmp4Result.isPlainObject(normalizeResult)) {
              const result = tmp4(12319).addNonEnumerableProperty(normalizeResult, "__sentry_skip_normalization__", true);
              obj3[tmp6] = normalizeResult;
              const tmp4Result2 = tmp4(12319);
            }
            let obj4 = {};
            const merged1 = Object.assign(contexts);
            obj4.contexts = obj3;
            tmp3 = obj4;
            tmp4Result = tmp4(12320);
          }
