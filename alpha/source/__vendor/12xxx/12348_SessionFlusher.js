...
// Function ID: 12349
// Name: SessionFlusher
// Dependencies: [41, 42, 12301, 12322]

// Module 12348 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12301).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12322).getIsolationScope();
        ...
        const obj = SessionFlusher(12322);
      }
    }
  },
  {
