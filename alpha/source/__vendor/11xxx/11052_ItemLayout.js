...
// Function ID: 11053
// Name: ItemLayout
// Dependencies: [19, 21, 11035, 11053, 1637]
// Exports: ItemLayout

// Module 11052 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod11035.useGlobalState().props;
  ...
  const offsetX = _mod11053.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod11053;
  const fn = function k() {
