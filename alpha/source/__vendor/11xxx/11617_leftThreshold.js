...
// Function ID: 11618
// Name: leftThreshold
// Dependencies: [109, 19, 17, 21, 1637, 11618, 7066, 6998]
// Exports: default

// Module 11617 (leftThreshold)
...
function _default(hitSlop) {
  ...
  let fn2 = function p(arg0, arg1) {
    ...
    if (!tmp2) {
      ...
      if (tmp12) {
        if (arg0 > 0) {
          let RIGHT = _mod11618.SwipeDirection.LEFT;
        } else {
          RIGHT = _mod11618.SwipeDirection.RIGHT;
        }
      ...
      if (arg1 > 0) {
        let LEFT = _mod11618.SwipeDirection.RIGHT;
      } else {
        LEFT = _mod11618.SwipeDirection.LEFT;
      }
