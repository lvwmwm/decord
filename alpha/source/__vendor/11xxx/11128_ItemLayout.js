...
// Function ID: 11129
// Name: ItemLayout
// Dependencies: [19, 21, 11111, 11129, 1637]
// Exports: ItemLayout

// Module 11128 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod11111.useGlobalState().props;
  ...
  const offsetX = _mod11129.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod11129;
  const fn = function k() {
