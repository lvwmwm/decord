...
// Function ID: 11612
// Name: leftThreshold
// Dependencies: [109, 19, 17, 21, 1637, 11612, 7064, 6996]
// Exports: default

// Module 11611 (leftThreshold)
import cancelAnimation from "cancelAnimation" /* 1637 */;
import _mod11612 from "module_11612" /* 11612 */;
...
function _default(hitSlop) {
  ...
  let fn2 = function p(arg0, arg1) {
    ...
    if (!tmp2) {
      ...
      if (tmp12) {
        if (arg0 > 0) {
          let RIGHT = _mod11612.SwipeDirection.LEFT;
        } else {
          RIGHT = _mod11612.SwipeDirection.RIGHT;
        }
      ...
      if (arg1 > 0) {
        let LEFT = _mod11612.SwipeDirection.RIGHT;
      } else {
        LEFT = _mod11612.SwipeDirection.LEFT;
      }
