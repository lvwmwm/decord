...
// Function ID: 1466
// Name: configure
// Dependencies: [32, 19, 17, 1466, 1467, 1472]
// Exports: addEventListener, configure, fetch, refresh, useNetInfo, useNetInfoInstance

// Module 1465 (configure)
import StateDefault from "State" /* 1467 */;
import NetInfoStateTypeAll from "NetInfoStateType" /* 1472 */;
import _slicedToArray from "module_32" /* 32 */;
import module_1466 from "module_1466" /* 1466 */;

const require = globalThis.__r;

function configure(arg0) {
  const merged = Object.assign(module_1466);
  const merged1 = Object.assign(arg0);
  module_1466 = {};
  if (closure_8) {
    closure_8.tearDown();
    if (typeof createState === "function") {
      const tmp10 = new StateDefault(module_1466);
      closure_8 = tmp10;
    } else {
...
function fetch(arg0) {
  ...
  if (!closure_8) {
    if (typeof createState === "function") {
      const tmp7 = new StateDefault(module_1466);
      closure_8 = tmp7;
      obj = tmp7;
    } else {
      throw new TypeError("Trying to call a non-function");
...
function useNetInfo(arg0) {
  ...
  closure_5(() => {
    let f74118 = closure_0;
    obj = closure_8;
    if (!closure_8) {
      if (typeof createState === "function") {
        const tmp8 = new StateDefault(module_1466);
        closure_8 = tmp8;
        obj = tmp8;
      } else {
        throw new TypeError("Trying to call a non-function");
