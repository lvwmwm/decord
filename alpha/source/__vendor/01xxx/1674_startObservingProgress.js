...
// Dependencies: [1641, 1663, 1675, 1677, 1645]
      ...
      withStyleAnimationResult.callback = (arg0) => {
        if (arg0) {
          ...
          if (typeof stopObservingProgress === "function") {
            ...
            global._notifyAboutEnd(tmp2, tmp6 === _mod1663.LayoutAnimationType.EXITING);
            const tmp10 = tmp6 === _mod1663.LayoutAnimationType.EXITING;
          } else {
            throw new TypeError("Trying to call a non-function");
          }
          obj = mutableUI;
