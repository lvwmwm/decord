  ...
  obj3.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f111055 = (name) => {
        ...
        result = feedbackAsyncIntegration.startBrowserTracingPageLoadSpan(f111055, obj2);
      };
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f123581 = (name) => {
            ...
            obj2.attributes = obj3;
            result = result(889).startBrowserTracingNavigationSpan(f123581, obj2);
          };
