...
// Dependencies: [32, 1641, 1669, 1649, 1663, 1654, 1642]
// Exports: makeShareableCloneOnUIRecursive

// Module 1668 (freezeObjectInDev)
...
fn = function u() {
  const proxy = new Proxy({}, {
    get(arg0, arg1) {
      if ("_isReanimatedSharedValue" !== arg1) {
        if ("__remoteFunction" !== arg1) {
          ...
          const reanimatedError = new require("module_1649").ReanimatedError("Trying to access property `" + String(arg1) + "` of an object which cannot be sent to the UI runtime.");
    ...
    set() {
      const reanimatedError = new require("module_1649").ReanimatedError("Trying to write to an object which cannot be sent to the UI runtime.");
      throw reanimatedError;
    }
  });
  return proxy;
...
const tmp3 = module_1641 ? (function makeShareableCloneRecursiveWeb(arg0) {
  return arg0;
                          ...
                          const fn = function s() {
                            if (closure_9.includes(name)) {
                              if (undefined === global[tmp]) {
                                ...
                                const reanimatedError = new require("module_1649").ReanimatedError("[Reanimated] Constructor for `" + tmp + "` not found.");
                                throw reanimatedError;
                              } else {
                              ...
                              const _HermesInternal = HermesInternal;
                              const reanimatedError1 = new require("module_1649").ReanimatedError("[Reanimated] Invalid array view name `" + tmp + "`.");
...
makeShareableCloneOnUIRecursive.__closure = { SHOULD_BE_USE_WEB: module_1641, isHostObject, isRemoteFunction };
...
export const makeShareable = module_1641 ? (function makeShareableJS(arg0) {
  return arg0;
}) : (function makeShareableNative(value) {
  closure_0 = value;
  const shareableMappingCache = _mod1669.shareableMappingCache;
  if (shareableMappingCache.get(value)) {
    ...
    obj.__init = fn;
    const shareableMappingCache2 = _mod1669.shareableMappingCache;
