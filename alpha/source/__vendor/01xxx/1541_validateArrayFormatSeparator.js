...
// Dependencies: [32, 1542, 1543, 1544, 1545]
// Exports: exclude, extract, parseUrl, pick, stringify, stringifyUrl

// Module 1541 (validateArrayFormatSeparator)
import _mod1542 from "module_1542" /* 1542 */;
import decodeComponents from "decodeComponents" /* 1543 */;
              ...
              if (!closure_0.skipNull) {
                ...
                if (null === arg1) {
                  ...
                  if (!encode) {
                    ...
                    let encodeURIComponentResult = closure_0(1542)(tmp24);
                  } else {
              ...
              if (!closure_0.skipNull) {
                ...
                if (null === arg1) {
                  ...
                  if (!tmp25.encode) {
                    ...
                    let encodeURIComponentResult = closure_0(1542)(tmp18);
                  } else {
                    const _encodeURIComponent3 = encodeURIComponent;
                  ...
                  if (!tmp25.encode) {
                    ...
                    let encodeURIComponentResult2 = closure_0(1542)(tmp30);
                  } else {
                    const _encodeURIComponent = encodeURIComponent;
                ...
                if (0 === arg0.length) {
                  if (!tmp25.encode) {
                    ...
                    if (!tmp25.encode) {
                      ...
                      let encodeURIComponentResult = closure_0(1542)(str3);
                    } else {
                      const _encodeURIComponent3 = encodeURIComponent;
                      encodeURIComponentResult = encodeURIComponent(str3);
                    }
                  } else if (tmp25.strict) {
                    let encodeURIComponentResult1 = closure_0(1542)(tmp10);
                  } else {
                    const _encodeURIComponent2 = encodeURIComponent;
                  ...
                  if (!tmp25.encode) {
                    ...
                    let encodeURIComponentResult2 = closure_0(1542)(str3);
                  } else {
                    const _encodeURIComponent = encodeURIComponent;
    ...
    const mapped = keys1.map((item) => {
      if (undefined === dependencyMap[item]) {
        ...
        if (!merged.encode) {
          ...
          let encodeURIComponentResult = _mod1542(item);
        } else {
          const _encodeURIComponent3 = encodeURIComponent;
        ...
        if (Array.isArray(arr)) {
          ...
          if (!tmp13.encode) {
            ...
            let encodeURIComponentResult1 = _mod1542(item);
          } else {
          ...
          if (!tmp.encode) {
            ...
            let encodeURIComponentResult2 = _mod1542(arr);
          } else {
            const _encodeURIComponent2 = encodeURIComponent;
            encodeURIComponentResult2 = encodeURIComponent(arr);
          }
        } else if (tmp.strict) {
          let encodeURIComponentResult3 = _mod1542(item);
        } else {
          const _encodeURIComponent = encodeURIComponent;
...
export const parseUrl = (arr, arg1) => {
  ...
  [str, tmp5] = _mod1544(arr, "#");
  const tmp4 = _slicedToArray(_mod1544(arr, "#"), 2);
  ...
  if (!url.fragmentIdentifier) {
    ...
    if (merged[tmp]) {
      if (!merged.encode) {
        ...
        let encodeURIComponentResult = _mod1542(fragmentIdentifier);
      } else {
        const _encodeURIComponent = encodeURIComponent;
...
export const pick = (arg0, arg1, arg2) => {
  ...
  const request = { url: parseUrlResult.url, query: _mod1545(query, arg1), fragmentIdentifier };
