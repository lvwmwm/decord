...
// Dependencies: [1641, 1642, 1645, 1649, 1653]
  ...
  if (!obj.isWeb()) {
    if (ReanimatedModule) {
      if (closure_3) {
        ...
        globalThis.requestAnimationFrame = tmp(1653).mockedRequestAnimationFrame;
      }
      const fn = function o() {
      ...
      let obj2 = { setupCallGuard, setupConsole, SHOULD_BE_USE_WEB: module_1641, setupMicrotasks: tmp(1645).setupMicrotasks, setupRequestAnimationFrame };
      fn.__closure = obj2;
      fn.__workletHash = 2162023783290;
      fn.__initData = __initData;
      tmp(1645).runOnUIImmediately(fn)();
      const tmpResult = tmp(1645);
    } else {
      const _Error = Error;
