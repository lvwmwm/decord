...
// Function ID: 5952
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1485, 5943, 5952, 5953]
// Exports: Button

// Module 5951 (ButtonLink)
import Link from "Link" /* 1485 */;
import ColorDefault from "Color" /* 5943 */;
import _mod5952 from "module_5952" /* 5952 */;
import Text from "Text" /* 5953 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5943)(color);
      str4 = tmp9(5943)(color).darken(0.71).string();
      const darkenResult = tmp9(5943)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
