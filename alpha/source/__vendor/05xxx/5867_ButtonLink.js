...
// Function ID: 5868
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1485, 5859, 5868, 5869]
// Exports: Button
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5859)(color);
      str4 = tmp9(5859)(color).darken(0.71).string();
      const darkenResult = tmp9(5859)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
