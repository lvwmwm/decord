...
// Dependencies: [5091, 1282, 5138, 5142, 1283, 5155, 1303, 5147, 5143, 5156, 5157]
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod5091(arg0)) {
    if (tmp(5138)(arg1)) {
      if (tmp(5142)(__Writable__)) {
        if (tmp(1283)) {
          const tmp30 = tmp(1283)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(5143)(tmp30);
          }
          return tmp(5157)(arg0, arg1, tmp(5156)(arg0), __Writable__, tmp31);
        } else if (tmp(5155)(__Writable__)) {
          ...
          return tmp(5147)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
