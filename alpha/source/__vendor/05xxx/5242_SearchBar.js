...
// Function ID: 5243
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 5243, 5235]
// Exports: default

// Module 5242 (SearchBar)
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(5243).Commands;
  ...
  if (ref1(5235).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(5235).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(5235);
    obj.hideNavigationBar = tmp3(5235).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
