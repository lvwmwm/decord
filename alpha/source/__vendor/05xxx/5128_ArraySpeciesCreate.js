...
// Dependencies: [1281, 5129, 1282, 5130, 5132, 5138, 5092, 5140]
...
export default function ArraySpeciesCreate(arg0, arg1) {
  if (_mod5129(arg1)) {
    if (arg1 >= 0) {
      if (tmp(5130)(arg0)) {
        const tmp3 = tmp(5138)(arg0, "constructor");
        let tmp5 = closure_2;
        if (closure_2) {
          tmp5 = tmp(5092)(tmp3);
        }
        let tmp6 = tmp3;
        if (tmp5) {
          const tmp7 = tmp(5138)(tmp3, tmp4);
          tmp5 = null === tmp7;
          tmp6 = tmp7;
        }
        if (undefined === tmp6) {
          return tmp(5132)(arg1);
        } else if (tmp(5140)(tmp6)) {
