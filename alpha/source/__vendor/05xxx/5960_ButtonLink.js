...
// Function ID: 5961
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1486, 5952, 5961, 5962]
// Exports: Button

// Module 5960 (ButtonLink)
import Link from "Link" /* 1486 */;
import ColorDefault from "Color" /* 5952 */;
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5952)(color);
      str4 = tmp9(5952)(color).darken(0.71).string();
      const darkenResult = tmp9(5952)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
  ...
  return jsx(_mod5961.PlatformPressable, {});
}
