...
// Function ID: 5235
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 5235, 5227]
// Exports: default

// Module 5234 (SearchBar)
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(5235).Commands;
  ...
  if (ref1(5227).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(5227).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(5227);
    obj.hideNavigationBar = tmp3(5227).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
