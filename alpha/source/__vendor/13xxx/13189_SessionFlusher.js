...
// Function ID: 13190
// Name: SessionFlusher
// Dependencies: [41, 42, 13142, 13163]

// Module 13189 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(13142).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(13163).getIsolationScope();
        ...
        const obj = SessionFlusher(13163);
      }
    }
  },
  {
