...
// Dependencies: [13733, 13741]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 13740 (InsertUnicodeExtensionAndCanonicalize)
import _mod13733 from "module_13733" /* 13733 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 13741 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod13733.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
