...
// Dependencies: [13703, 13698, 13708, 13709]
// Exports: SetNumberFormatUnitOptions

// Module 13744 (SetNumberFormatUnitOptions)
...
export const SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(13708).IsWellFormedCurrencyCode(str);
  }
  _mod13698.invariant(result, "Malformed currency code", RangeError);
  let tmp10 = "currency" !== GetOptionResult;
  if (!tmp10) {
    tmp10 = undefined !== str;
  }
  _mod13698.invariant(tmp10, "currency cannot be undefined", TypeError);
  ...
  if (!result1) {
    result1 = tmp4(13709).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
  _mod13698.invariant(result1, "Invalid unit argument for Intl.NumberFormat()", RangeError);
  let tmp17 = "unit" !== GetOptionResult;
  if (!tmp17) {
    tmp17 = undefined !== GetOptionResult3;
  }
  _mod13698.invariant(tmp17, "unit cannot be undefined", TypeError);
