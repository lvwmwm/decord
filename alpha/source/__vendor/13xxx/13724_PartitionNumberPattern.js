...
// Dependencies: [1161, 13697, 13719, 13698, 13712, 13714]
// Exports: PartitionNumberPattern

// Module 13724 (PartitionNumberPattern)
...
export const PartitionNumberPattern = function PartitionNumberPattern(internalSlots, isNaN) {
  ...
  return module_13719.default({ roundedNumber, formattedString, exponent: num, magnitude: num2, sign: num7 }, internalSlots.dataLocaleData, pl, internalSlots);
};
