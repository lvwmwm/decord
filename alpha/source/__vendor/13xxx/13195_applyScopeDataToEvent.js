...
// Dependencies: [13170, 13151, 13150, 13181]
...
export const applyScopeDataToEvent = function applyScopeDataToEvent(extra, arg1) {
  ...
  if (span) {
    const obj6 = { trace: tmp3(13150).spanToTraceContext(span) };
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj6;
    const obj7 = { dynamicSamplingContext: null };
    const tmp3Result9 = tmp3(13150);
    obj7.dynamicSamplingContext = tmp3(13181).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj7;
    const tmp3Result10 = tmp3(13181);
    const rootSpan = tmp3(13150).getRootSpan(span);
    const tmp3Result11 = tmp3(13150);
    const description = tmp3(13150).spanToJSON(rootSpan).description;
