...
// Function ID: 13866
// Name: URLImpl
// Dependencies: [41, 42, 13866, 13870, 13869]

// Module 13865 (URLImpl)
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(13866).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(13866).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(13869).parseUrlencoded(query);
          const tmpResult = tmp(13869);
        }
      }
      const obj = URLImpl(13866);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(13866).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
    ...
    set(arg0) {
      URLImpl(13866).basicURLParse(`${arg0}:`, { url: this._url, stateOverride: "scheme start" });
    }
  },
  {
    key: "username",
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13866).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(13866);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13866).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(13866);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(13866).serializeHost(host);
        const obj3 = URLImpl(13866);
      } else {
        const obj = URLImpl(13866);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(13866).serializeInteger(host.port)}`;
        const obj2 = URLImpl(13866);
      }
    },
    set(arg0) {
      if (!this._url.cannotBeABaseURL) {
        const obj2 = { url: tmp._url, stateOverride: "host" };
        URLImpl(13866).basicURLParse(arg0, obj2);
        const obj = URLImpl(13866);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(13866).serializeHost(tmp._url.host);
        const obj = URLImpl(13866);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(13866).serializeInteger(tmp._url.port);
        const obj = URLImpl(13866);
      }
      return str;
    },
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        URLImpl(13866).basicURLParse(substr, obj2);
        const obj = URLImpl(13866);
        self._query._list = URLImpl(13869).parseUrlencoded(substr);
      }
    }
  },
  {
