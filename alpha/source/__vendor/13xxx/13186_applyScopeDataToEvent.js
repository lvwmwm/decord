...
// Dependencies: [13161, 13142, 13141, 13172]
...
export const applyScopeDataToEvent = function applyScopeDataToEvent(extra, arg1) {
  ...
  if (span) {
    const obj6 = { trace: tmp3(13141).spanToTraceContext(span) };
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj6;
    const obj7 = { dynamicSamplingContext: null };
    const tmp3Result9 = tmp3(13141);
    obj7.dynamicSamplingContext = tmp3(13172).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj7;
    const tmp3Result10 = tmp3(13172);
    const rootSpan = tmp3(13141).getRootSpan(span);
    const tmp3Result11 = tmp3(13141);
    const description = tmp3(13141).spanToJSON(rootSpan).description;
