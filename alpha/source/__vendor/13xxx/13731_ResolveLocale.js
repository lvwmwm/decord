...
// Function ID: 13732
// Name: ResolveLocale
// Dependencies: [13732, 13737, 13738, 13733, 13739, 13740]
...
export const ResolveLocale = function ResolveLocale(arg0, arg1, localeMatcher, arg3, arg4, fn) {
  ...
  if (0 < arg3.length) {
    do {
      ...
      let invariantResult2 = tmp14(13733).invariant(tmp24, "optionsValue must be a string or undefined");
      let str3 = tmp23;
      if (typeof tmp23 === "string") {
        let formatted = str.toLowerCase();
        str3 = tmp14(13739).CanonicalizeUValue(formatted, tmp23);
        if ("" === str3) {
          str3 = "true";
        }
      }
