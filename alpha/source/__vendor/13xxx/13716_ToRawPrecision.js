...
// Function ID: 13717
// Name: ToRawPrecision
// Dependencies: [1161, 13697, 13698, 13700, 13710]
// Exports: ToRawPrecision

// Module 13716 (ToRawPrecision)
...
export const ToRawPrecision = function ToRawPrecision(ZERO, minimumSignificantDigits, maximumSignificantDigits, result) {
  ...
  let tmp4;
  if (ZERO.isZero()) {
    let repeatResult = _mod13698.repeat("0", maximumSignificantDigits);
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(13698).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(13698).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(13698).repeat("0", -num3 - 1)}${arr}`;
