...
// Dependencies: [109, 19, 17, 21, 1637, 5133, 1615, 14844, 14845]

// Module 14843 (ReanimatedNativeStackScreen)
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  const obj4 = { value: sharedValue, children: jsx(_modDef14845.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) };
  obj3.children = jsx(_modDef14844.Provider, { value: sharedValue, children: jsx(_modDef14845.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) });
