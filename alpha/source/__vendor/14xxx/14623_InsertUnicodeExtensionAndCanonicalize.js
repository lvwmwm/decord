...
// Dependencies: [14616, 14624]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14623 (InsertUnicodeExtensionAndCanonicalize)
import _mod14616 from "module_14616" /* 14616 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14624 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14616.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
