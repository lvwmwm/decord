...
// Dependencies: [14607, 14615]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14614 (InsertUnicodeExtensionAndCanonicalize)
import _mod14607 from "module_14607" /* 14607 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14615 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14607.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
