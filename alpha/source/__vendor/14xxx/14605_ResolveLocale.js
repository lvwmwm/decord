...
// Function ID: 14606
// Name: ResolveLocale
// Dependencies: [14606, 14611, 14612, 14607, 14613, 14614]
...
export const ResolveLocale = function ResolveLocale(arg0, arg1, localeMatcher, arg3, arg4, fn) {
  ...
  if (0 < arg3.length) {
    do {
      ...
      let invariantResult2 = tmp14(14607).invariant(tmp24, "optionsValue must be a string or undefined");
      let str3 = tmp23;
      if (typeof tmp23 === "string") {
        let formatted = str.toLowerCase();
        str3 = tmp14(14613).CanonicalizeUValue(formatted, tmp23);
        if ("" === str3) {
          str3 = "true";
        }
      }
