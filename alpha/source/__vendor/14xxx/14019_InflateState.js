...
// Function ID: 14020
// Name: InflateState
// Dependencies: [14009, 14020, 14016, 14021, 14015]
                                                                ...
                                                                if (bits >= 32) {
                                                                  ...
                                                                  if (!diff12) {
                                                                    ...
                                                                    if (state.flags) {
                                                                      ...
                                                                      tmp46 = tmp41(14015)(check, tmp15, diff12, next_out - diff12);
                                                                    }
                                                                    state.check = tmp46;
                                                                    state.adler = tmp46;
                                                                  }
                                            ...
                                            if (state.mode === 30) {
                                              ...
                                              if (0 === state.lens[256]) {
                                                ...
                                                if (tmp643) {
                                                  ...
                                                  let tmp191 = tmp639(14020)(2, lens2, state.nlen, state.ndist, state.distcode, 0, state.work, obj7);
