...
// Function ID: 9971
// Name: pbkdf2Init
// Dependencies: [5, 9968, 9967, 9971]
// Exports: pbkdf2, pbkdf2Async

// Module 9970 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9967).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9971).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9967).toBytes(B);
