...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(9351).process(_idmap, initializeContextResult);
    tmp2(9351).extractDefs(initializeContextResult, _idmap);
    return tmp2(9351).finalize(initializeContextResult, _idmap);
  }
