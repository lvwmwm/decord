...
// Dependencies: [109, 41, 42, 9280, 9281]

// Module 9282 (JSONSchemaGenerator)
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(9280).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(9280).extractDefs(self.ctx, _idmap);
      return _objectWithoutProperties(JSONSchemaGenerator(9280).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
