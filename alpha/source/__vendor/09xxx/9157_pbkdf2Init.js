...
// Function ID: 9158
// Name: pbkdf2Init
// Dependencies: [5, 9155, 9154, 9158]
// Exports: pbkdf2, pbkdf2Async

// Module 9157 (pbkdf2Init)
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9154).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9158).hmac;
    const obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9154).toBytes(B);
