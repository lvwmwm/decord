...
const items = [
  entry,
  {
    ...
    value: function extract(createParsingComponents, arg1) {
      const parsed = parseInt(JPStandardParser(9965).toHankaku(arg1[5]));
      const parsed1 = parseInt(JPStandardParser(9965).toHankaku(arg1[6]));
      ...
      if (arg1[2]) {
        ...
        parsingComponents.imply("year", tmp(9896).findYearClosestToRef(createParsingComponents.refDate, parsed1, parsed));
