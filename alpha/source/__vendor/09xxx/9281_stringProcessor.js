...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(9280).process(_idmap, initializeContextResult);
    tmp2(9280).extractDefs(initializeContextResult, _idmap);
    return tmp2(9280).finalize(initializeContextResult, _idmap);
  }
