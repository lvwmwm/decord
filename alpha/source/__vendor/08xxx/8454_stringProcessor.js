...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(8453).process(_idmap, initializeContextResult);
    tmp2(8453).extractDefs(initializeContextResult, _idmap);
    return tmp2(8453).finalize(initializeContextResult, _idmap);
  }
