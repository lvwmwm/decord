...
// Dependencies: [8741, 8742, 8743]
// Exports: default, extractTransformSvgView

// Module 8740 (appendTransformProps)
import append from "append" /* 8741 */;
import peg$SyntaxError from "peg$SyntaxError" /* 8742 */;
...
export const extractTransformSvgView = function extractTransformSvgView(transform) {
  if (typeof transform.transform === "string") {
    transform = _mod8743.parse(transform.transform);
  } else {
    transform = transform.transform;
  }
  return transform;
