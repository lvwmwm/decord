...
// Function ID: 8635
// Name: StepsIndicator
// Dependencies: [19, 17, 21, 8632, 8633, 8635, 8636]
// Exports: StepsIndicator

// Module 8634 (StepsIndicator)
import _mod8632 from "module_8632" /* 8632 */;
import _mod8633 from "module_8633" /* 8633 */;
import SliderTrackMark from "SliderTrackMark" /* 8635 */;
import StepNumber from "StepNumber" /* 8636 */;
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8632.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8632.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8633.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8632.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8633.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8632).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8633).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8633).styles.stepIndicatorElement;
    }
