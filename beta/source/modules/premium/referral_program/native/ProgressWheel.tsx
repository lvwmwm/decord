...
// Function ID: 13719
// Name: ProgressWheel
// Dependencies: [19, 17, 21, 4758, 558, 568, 4462, 580, 13707, 5802, 13719, 8733, 13720, 2]

// Module 13718 (ProgressWheel)
import c from "c" /* 568 */;
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[0] === tmp10) {
    ...
    if (cResult[3] === token1) {
      ...
      if (cResult[6] !== result1) {
        ...
        const tmp22 = React4(tmp(8733).Circle, obj4);
        cResult[6] = result1;
        cResult[7] = tmp22;
        let tmp19 = tmp22;
      } else {
      ...
      if (cResult[8] === tmp15) {
        ...
        const tmp31 = React4(tmp5(5802), obj7);
      ...
      const tmp26 = hasOwnProperty(tmp5(8733), size);
      cResult[8] = tmp15;
      cResult[9] = tmp19;
      cResult[10] = tmp26;
      tmp23 = tmp26;
    ...
    const tmp17 = React4(tmp(8733).Circle, obj8);
    cResult[3] = token1;
    cResult[4] = token;
    cResult[5] = tmp17;
    tmp15 = tmp17;
  ...
  let tmp12 = tmp10;
  if (tmp10) {
    const obj9 = { source: tmp5(13719), style: tmp4.glowImage };
    tmp12 = React4(tmp5(5802), obj9);
  ...
  if (tmp9) {
    const obj4 = { source: tmp4(13719), style: tmp.glowImage };
    tmp9 = React4(tmp4(5802), obj4);
