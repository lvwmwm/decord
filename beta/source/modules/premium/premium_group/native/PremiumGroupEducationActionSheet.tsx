...
// Dependencies: [17, 4464, 21, 4790, 580, 558, 568, 7208, 4786, 1119, 3198, 7429, 2]

// Module 13819 (PremiumGroupEducationActionSheet)
    ...
    if (cResult[7] === tmp4.aboutContainer) {
      if (cResult[8] === tmp5) {
        ...
        if (cResult[11] === Symbol.for("react.memo_cache_sentinel")) {
          ...
          const formatResult = intl.format(_modDef3198.ah1Ecm, obj4);
