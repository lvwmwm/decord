...
// Dependencies: [17, 4432, 21, 4758, 580, 558, 568, 7176, 4754, 1119, 3166, 7397, 2]
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((aboutText) => {
    ...
    if (cResult[7] === tmp4.aboutContainer) {
      if (cResult[8] === tmp5) {
        ...
        if (cResult[11] === Symbol.for("react.memo_cache_sentinel")) {
          ...
          const formatResult = intl.format(_modDef3166.ah1Ecm, obj4);
  ...
  obj6.children = intl.format(_modDef3166.ah1Ecm, { helpCenterLink: HELP_CENTER_LINK });
