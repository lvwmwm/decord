...
// Dependencies: [19, 17, 4456, 17413, 1078, 2042, 21, 4790, 580, 558, 568, 504, 4450, 7513, 7429, 4786, 1119, 2112, 5220, 2]

// Module 17412 (GooglePlayPriceChangeActionSheet)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((markAsDismissed) => {
                            ...
                            if (cResult[30] === tmp30) {
                              if (cResult[31] === tmp21) {
                                ...
                                if (cResult[35] !== markAsDismissed) {
                                  ...
                                  const tmp42 = closure_8(tmp(5220).Button, obj2);
  ...
  const tierDisplayNameByPlanId = markAsDismissed(4450).getTierDisplayNameByPlanId(str);
  const tmpResult8 = markAsDismissed(4450);
  const tmpResult9 = markAsDismissed(4450);
  const intervalStringAsNoun = markAsDismissed(4450).getIntervalStringAsNoun(tmpResult9.getInterval(str).intervalType);
  const tmpResult10 = markAsDismissed(4450);
  const tmpResult11 = markAsDismissed(7513);
  const formatPriceResult = markAsDismissed(7513).formatPrice(stateFromStores.oldPrice, stateFromStores.oldCurrency);
  const tmpResult12 = markAsDismissed(7513);
  ...
  const tmp27 = closure_8(markAsDismissed(4786).Text, obj4);
  ...
  const formatPriceResult1 = markAsDismissed(7513).formatPrice(stateFromStores.newPrice, stateFromStores.newCurrency);
  ...
  const tierDisplayNameByPlanId = markAsDismissed(4450).getTierDisplayNameByPlanId(str);
  const tmp2Result = markAsDismissed(4450);
  const tmp2Result5 = markAsDismissed(4450);
  const intervalStringAsNoun = markAsDismissed(4450).getIntervalStringAsNoun(tmp2Result5.getInterval(str).intervalType);
  const tmp2Result6 = markAsDismissed(4450);
  const tmp2Result7 = markAsDismissed(7513);
  const formatPriceResult = markAsDismissed(7513).formatPrice(stateFromStores.oldPrice, stateFromStores.oldCurrency);
  const tmp2Result8 = markAsDismissed(7513);
  ...
  const items2 = [closure_8(markAsDismissed(4786).Text, obj6), ];
  ...
  items2[1] = closure_8(markAsDismissed(4786).Text, obj7);
  ...
  items3[1] = closure_8(markAsDismissed(5220).Button, obj9);
  obj4.children = items3;
  obj3.children = closure_9(View, obj4);
  return closure_8(markAsDismissed(7429).BottomSheet, obj3);
});
