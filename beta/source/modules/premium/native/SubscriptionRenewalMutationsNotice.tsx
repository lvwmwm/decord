...
// Dependencies: [19, 17, 4451, 21, 4790, 580, 5692, 558, 568, 1181, 1119, 4450, 2]

// Module 13696 (SubscriptionRenewalMutationsNotice)
import c from "c" /* 568 */;
...
let obj2 = { container: { padding: 10, marginVertical: 5, marginHorizontal: 15, borderRadius: nativeDefault.radii.xs, display: "flex", flexDirection: "row", justifyContent: "center", backgroundColor: fn(5692).DARK_PRIMARY_630_LIGHT_PRIMARY_230 }, icon: null, text: null };
let obj3 = { padding: 10, marginVertical: 5, marginHorizontal: 15, borderRadius: nativeDefault.radii.xs, display: "flex", flexDirection: "row", justifyContent: "center", backgroundColor: fn(5692).DARK_PRIMARY_630_LIGHT_PRIMARY_230 };
obj2.icon = { alignSelf: "center", marginLeft: 15, color: fn(5692).DARK_PRIMARY_300_LIGHT_PRIMARY_500 };
let obj4 = { alignSelf: "center", marginLeft: 15, color: fn(5692).DARK_PRIMARY_300_LIGHT_PRIMARY_500 };
obj2.text = { paddingLeft: 10, marginRight: 15, color: fn(5692).DARK_PRIMARY_300_LIGHT_PRIMARY_500 };
let closure_7 = createStyles.createStyles(obj2);
const ReactCompilerGating = fn(558);
let obj5 = { paddingLeft: 10, marginRight: 15, color: fn(5692).DARK_PRIMARY_300_LIGHT_PRIMARY_500 };
const size = fn(2);
