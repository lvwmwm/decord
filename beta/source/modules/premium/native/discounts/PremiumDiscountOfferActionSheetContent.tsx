...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? ((onConfirm) => {
  ...
  if (cResult[3] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp11 = hasOwnProperty(tmp(5907).NitroWumpusFlightRight3dIllustration, { width: 180, height: 180 });
    cResult[3] = tmp11;
    let tmp9 = tmp11;
  } else {
    tmp9 = cResult[3];
  ...
  if (cResult[8] === tmp4.title) {
    ...
    if (cResult[14] === Symbol.for("react.memo_cache_sentinel")) {
      ...
      const tmp29 = hasOwnProperty(tmp(8938).NitroWheelIcon, obj11);
      cResult[14] = tmp29;
      let tmp26 = tmp29;
    } else {
      tmp26 = cResult[14];
    ...
    const tmp32 = hasOwnProperty(tmp(5188).Button, obj14);
