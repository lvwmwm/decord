...
// Dependencies: [19, 2045, 21, 558, 568, 565, 5148, 17622, 1119, 5148, 2]

// Module 17624 (VoicePanelMaxCapacityAlert)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((channelId) => {
  ...
  const dismissModalCallback = channelId(5148).useDismissModalCallback();
  ...
  if (cResult[9] !== dismissModalCallback) {
    ...
    const tmp22 = jsx(tmp(5148).AlertActionButton, { variant: "secondary", text: tmp18, onPress: dismissModalCallback });
  ...
  const tmp24 = jsx(channelId(5148).AlertModal, { header: tmp10, title: tmp11, content: tmp16, actions: tmp20 });
  cResult[11] = tmp16;
  cResult[12] = tmp20;
  cResult[13] = tmp24;
  tmp23 = tmp24;
  ...
  obj4.onPress = channelId(5148).useDismissModalCallback();
  obj3.actions = jsx(channelId(5148).AlertActionButton, { variant: "secondary", text: null, onPress: null });
  return jsx(channelId(5148).AlertModal, { header: jsx(VoicePanelLockedIconDefault, {}), title: null, content: null, actions: null });
});
