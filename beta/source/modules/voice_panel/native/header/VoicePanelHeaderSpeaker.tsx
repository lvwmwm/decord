...
// Dependencies: [109, 19, 17, 17549, 4807, 17550, 9915, 2045, 4808, 1078, 21, 558, 17552, 568, 17499, 9914, 10079, 10059, 565, 10077, 10058, 17556, 1368, 9944, 9916, 1119, 9941, 9943, 17557, 10060, 4611, 2031, 5836, 17479, 14443, 2]

// Module 17548 (VoicePanelHeaderSpeaker)
...
import useSpeakerTooltipsDefault from "useSpeakerTooltips" /* 17552 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;
import GameConsoleStore from "GameConsoleStore" /* 4807 */;
import StageChannelAudioStore from "StageChannelAudioStore" /* 17550 */;
...
const setVoiceUpsellDismissed = fn(17549).setVoiceUpsellDismissed;
