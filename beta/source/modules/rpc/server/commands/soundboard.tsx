...
// Function ID: 14789
// Name: soundboard
// Dependencies: [5, 5224, 1372, 4660, 1085, 8610, 7580, 5232, 9584, 7615, 7586, 9581, 7617, 7427, 2]
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (null == closure_128_2) {
            ...
            const tmp22 = new tmp74(9581)(obj10, "Invalid Sound.");
            throw tmp22;
          }
        }
      } catch (tmp56) {
