...
// Dependencies: [5, 4663, 1078, 4967, 8615, 14764, 9577, 10055, 14755, 5357, 5368, 9589, 4660, 2]

// Module 14797 (commands/activities)
import RPCErrorDefault from "RPCError" /* 9577 */;
import validateOpenInviteDialog from "validateOpenInviteDialog" /* 14764 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;

const instant_invite_InstantInviteUtils = tmp(10055);
require = fn;
...
let obj3 = {};
const items = [fn(8615).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE, RPC_AUTHENTICATED_SCOPE];
...
let obj5 = {};
const items1 = [fn(8615).OAuth2Scopes.RPC, RPC_LOCAL_SCOPE, RPC_AUTHENTICATED_SCOPE];
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null == id) {
              ...
              const tmp62 = new tmp2(9577)(obj4, "No application.");
              throw tmp62;
            } else {
              const tmp91 = tmp2(14755)(tmp87);
              let id1;
              if (tmp91 != null) {
                id1 = tmp91.id;
              }
              ...
              if (null == id1) {
                ...
                const tmp54 = new tmp2(9577)(obj5, "Unable to find selected channel");
                throw tmp54;
              } else {
          ...
          if (arg0 === 1) {
            ...
            const tmp42 = new tmp85(9577)(obj9, "Missing photo permissions");
            throw tmp42;
          }
        } else if (2 === tmp6) {
          if (arg0 === 1) {
            ...
            if (null == closure_128_2) {
              ...
              const tmp36 = new tmp2(9577)(obj11, "No image selected");
              throw tmp36;
            } else {
              const obj13 = { name: closure_128_2.fileName, type: closure_128_2.type, uri: closure_128_2.uri };
              dependencyMap = 3;
              c3 = 1;
              const obj14 = { value: tmp3(9589).uploadImageAttachment(closure_128_0, closure_128_1, obj13), done: false };
              return obj14;
            }
          }
        } else if (arg0 === 1) {
          ...
          if (null != closure_128_3) {
            if (null != closure_128_3.url) {
              if (!(closure_128_3 instanceof tmp2(4660))) {
          ...
          const _JSON = JSON;
          const tmp202 = new tmp2(9577)(obj17, JSON.stringify(closure_128_3));
          throw tmp202;
        }
      } catch (tmp64) {
        c3 = tmp;
