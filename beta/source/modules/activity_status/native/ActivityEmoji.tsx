...
// Function ID: 11235
// Name: ActivityEmoji
// Dependencies: [19, 21, 4790, 2023, 1401, 9067, 7409, 2]
// Exports: default

// Module 11234 (ActivityEmoji)
...
export default function ActivityEmoji(emoji) {
  ...
  const AnimateEmoji = emoji(2023).AnimateEmoji;
  let animated;
  ...
  if (null == emoji) {
    ReactionIcon = ReactionIcon(9067).ReactionIcon;
