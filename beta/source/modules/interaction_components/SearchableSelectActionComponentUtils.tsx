...
// Dependencies: [2041, 2105, 2099, 2063, 4405, 1372, 8382, 1978, 5659, 4908, 4987, 4909, 8390, 1370, 2]
...
export const getInitialSnowflakeSelectOptions = function getInitialSnowflakeSelectOptions(selectActionComponent, containerId, guildId) {
  ...
  if (null != defaultValues) {
    ...
    const mapped = defaultValues.map((type) => {
      ...
      } else if (tmp(8390).SnowflakeSelectDefaultValueTypes.ROLE === type) {
        if (null == closure_1) {
          return null;
        } else {
      ...
      } else if (tmp(8390).SnowflakeSelectDefaultValueTypes.CHANNEL === type) {
        if (null == closure_1) {
          return null;
        } else {
