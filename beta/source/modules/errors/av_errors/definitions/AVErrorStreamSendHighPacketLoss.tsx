...
// Dependencies: [4780, 4797, 4810, 18298, 9681, 18295, 2]

// Module 18300 (AVErrorStreamSendHighPacketLoss)
  ...
  getActiveErrors() {
    ...
    if (null == currentUserActiveStream) {
      ...
      if (null == mediaEngineConnectionId) {
        ...
        const accumulatedStatsWithMinDatapoints = tmp8(18298).getAccumulatedStatsWithMinDatapoints(mediaEngineConnectionId, currentUserActiveStream.ownerId);
        let tmp6 = null;
        if (null != accumulatedStatsWithMinDatapoints) {
          if (10 < 100 * accumulatedStatsWithMinDatapoints.short.packetLossRate) {
            const obj2 = { type: tmp8(9681).AVError.STREAM_SEND_HIGH_PACKET_LOSS };
            const tmp8Result3 = tmp8(18295);
