...
// Dependencies: [19, 2045, 2100, 2099, 1078, 21, 558, 568, 14233, 4667, 504, 10058, 10055, 1119, 9487, 580, 4938, 4725, 5653, 8178, 10285, 8212, 7366, 7625, 9833, 5652, 2]

// Module 14245 (GuildActionSheetTabItems)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((guild) => {
  ...
  guild = guild.guild;
  let obj = guild(568);
  const canAccessSettings = guild(14233).useGuildActionSheetPermissions(guild).canAccessSettings;
  const total = stateFromStores(4667)(guild.id).total;
    ...
    if (cResult[6] === stateFromStores) {
      ...
      if (cResult[10] !== total) {
        ...
        if (cResult[12] === Symbol.for("react.memo_cache_sentinel")) {
          ...
          const tmp18 = closure_12(tmp(9487).BoostGemIcon, obj5);
          cResult[12] = tmp18;
          let tmp16 = tmp18;
        } else {
          tmp16 = cResult[12];
        ...
        if (cResult[15] === cResult[11]) {
          ...
          if (cResult[18] === tmp9) {
            ...
            if (cResult[22] !== guild.id) {
              ...
              const tmp28 = closure_12(tmp(8178).IconButton, obj6);
              cResult[22] = guild.id;
              cResult[23] = tmp28;
            } else {
              class R {
            ...
            if (cResult[24] === canAccessSettings) {
              ...
              const tmp33 = closure_13(tmp(5652).ButtonGroup, obj7);
              cResult[27] = tmp23;
              cResult[28] = tmp27;
              cResult[29] = tmp29;
              cResult[30] = tmp20;
            ...
            if (canAccessSettings) {
              ...
              tmp30 = closure_12(tmp(8178).IconButton, obj8);
            }
          ...
          if (tmp9) {
            ...
            obj9.icon = tmp4(10285);
            obj9.onPress = function onPress() {
              ActionSheetActionCreatorsDefault.hideActionSheet();
              closure_2();
            };
            tmp24 = closure_12(tmp(8178).IconButton, obj9);
          }
          cResult[18] = tmp9;
          cResult[19] = tmp11;
          cResult[20] = tmp24;
        ...
        const tmp22 = closure_12(tmp(8178).IconButton, obj11);
  ...
  const shouldRenderInviteResult = guild(10058).shouldRenderInvite(stateFromStores, guild);
  ...
  guild = guild.guild;
  let stateFromStores;
  let canAccessSettings = guild(14233).useGuildActionSheetPermissions(guild).canAccessSettings;
  const total = stateFromStores(4667)(guild.id).total;
  let obj = guild(14233);
  const items = [GuildChannelStore];
  stateFromStores = guild(504).useStateFromStores(items, () => GuildChannelStore.getChannels(guild.id));
  let obj2 = guild(504);
  let shouldRenderInviteResult = guild(10058).shouldRenderInvite(stateFromStores, guild);
  ...
  let obj3 = guild(10058);
  const tmp6 = closure_13;
  obj6.icon = closure_12(guild(9487).BoostGemIcon, { color: stateFromStores(580).unsafe_rawColors.GUILD_BOOSTING_PINK });
  ...
  obj9.icon = stateFromStores(8212);
  obj9.onPress = function onPress() {
    ActionSheetActionCreatorsDefault.hideActionSheet();
    NotificationSettingsModalActionCreatorsDefault.open(guild.id);
  };
