...
// Dependencies: [32, 19, 2109, 1376, 1982, 558, 568, 504, 17298, 5739, 1374, 2]

// Module 17297 (useGetOrFetchChannelOverwriteUsers)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((arg0, arg1) => {
  ...
  let tmp2 = first(noop.useMemo(() => {
    ...
    return _modDef17298(items, (arg0) => stateFromStoresArray.includes(arg0));
  }, items2), 2);
  first = tmp2[0];
  noop = tmp4;
