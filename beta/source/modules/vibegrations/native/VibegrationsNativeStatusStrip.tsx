...
// Dependencies: [32, 19, 17, 14404, 21, 4756, 576, 17049, 14403, 14407, 4723, 17058, 5339, 1115, 3678, 4752, 4710, 2]
// Exports: default
...
export default function VibegrationsNativeStatusStrip(projectId) {
  ...
  if (thinking) {
    ...
    tmp10Result = tmp10(tmp2(5339).PressableOpacity, obj4);
  }
  ...
  if (null != runesUsedLabelsResult) {
    ...
    tmp8Result = tmp8(tmp2(5339).PressableOpacity, obj8);
  }
  items1[2] = tmp8Result;
