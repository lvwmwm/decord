...
// Dependencies: [19, 17, 9339, 21, 4790, 580, 558, 568, 4786, 1119, 3714, 17087, 17086, 1616, 504, 17088, 17092, 17093, 17090, 7481, 7428, 6895, 2]

// Module 17091 (VibegrationsTraceDetailSheet)
import c from "c" /* 568 */;
...
let closure_11 = ReactCompilerGating.isReactCompilerEnabled() ? ((field) => {
  ...
  if (null != field.field.value) {
    ...
    if (cResult[3] === iter.chars) {
      if (cResult[4] === iter.items) {
        ...
        if (cResult[6] !== omitted) {
          const omissionLabelResult = tmp(17087).omissionLabel(omitted);
          cResult[6] = omitted;
          cResult[7] = omissionLabelResult;
          let tmp9 = omissionLabelResult;
          const tmpResult = tmp(17087);
        } else {
          tmp9 = cResult[7];
        }
    ...
    if (null != iter.chars) {
      ...
      let formatToPlainStringResult = intl2.formatToPlainString(_modDef3714.DdXP0P, obj4);
    } else {
      formatToPlainStringResult = null;
      if (null != iter.items) {
        const intl = tmp(1119).intl;
        const obj6 = { count: iter.items };
        formatToPlainStringResult = intl.formatToPlainString(_modDef3714.OB8Qvn, obj6);
      }
    }
...
let closure_12 = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (0 === entries.length) {
    ...
    if (cResult[0] === Symbol.for("react.memo_cache_sentinel")) {
      ...
      const tmp8 = closure_5(tmp(4786).Text, obj2);
      cResult[0] = tmp8;
      let first = tmp8;
    } else {
      first = cResult[0];
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((projectId) => {
  ...
  const traceCategoryTextStyles = projectId(17086).useTraceCategoryTextStyles();
  ...
  const obj2 = projectId(17086);
  const stateFromStoresArray = tmp(504).useStateFromStoresArray(first, tmp9, tmp10);
  const tmpResult = tmp(504);
  let findTraceEntryResult = tmp(17088).findTraceEntry(stateFromStoresArray, entryId);
  ...
  if ("tool" === findTraceEntryResult.kind) {
    ...
    findTraceEntryResult1 = tmp(17088).findTraceEntry(stateFromStoresArray, parentId);
    const tmpResult16 = tmp(17088);
  }
  const tmpResult15 = tmp(17088);
  const length = tmp(17088).traceChildren(stateFromStoresArray, findTraceEntryResult.id).length;
  const tmpResult17 = tmp(17088);
  const traceDetailSectionsResult = tmp(17092).traceDetailSections(findTraceEntryResult, { childCount: length, hasParent: null != findTraceEntryResult1 });
  const obj3 = { childCount: length, hasParent: null != findTraceEntryResult1 };
  const tmpResult18 = tmp(17092);
  let detailId;
  if ("tool" === findTraceEntryResult.kind) {
    detailId = findTraceEntryResult.detailId;
  }
  const vibegrationsTraceDetail = tmp(17093).useVibegrationsTraceDetail(projectId, detailId);
  const tmp17 = "model" === findTraceEntryResult.kind ? findTraceEntryResult.model : findTraceEntryResult.tool;
  const tmpResult19 = tmp(17093);
  const formatClockTimeResult = tmp(17090).formatClockTime(findTraceEntryResult.startedAt, "millis");
  const tmpResult20 = tmp(17090);
  const traceCategoryResult = tmp(17088).traceCategory(findTraceEntryResult);
  if (cResult[4] !== vibegrationsTraceDetail) {
    const traceRichStatusLabelResult = tmp(17087).traceRichStatusLabel(vibegrationsTraceDetail);
    cResult[4] = vibegrationsTraceDetail;
    cResult[5] = traceRichStatusLabelResult;
    let tmp20 = traceRichStatusLabelResult;
    const tmpResult22 = tmp(17087);
  } else {
    tmp20 = cResult[5];
  }
  if (cResult[6] !== bottom) {
  ...
  const obj5 = { scrollable: true, header: closure_5(tmp(7428).BottomSheetTitleHeader, { title: tmp17 }), children: null };
  ...
  const items2 = [closure_5(tmp(17086).TraceStatusDot, { status: findTraceEntryResult.status }), , ];
  ...
  const tmpResult21 = tmp(17088);
  obj10.children = tmp(17087).categoryLabel(traceCategoryResult);
  items2[1] = closure_5(tmp(4786).Text, obj10);
  ...
  if (null == findTraceEntryResult.durationMs) {
    let intl = tmp(1119).intl;
    let stringResult = intl.string(tmp6(3714).HpKDyl);
  } else {
    stringResult = tmp(17087).formatDuration(findTraceEntryResult.durationMs);
    const tmpResult24 = tmp(17087);
  }
  obj11.children = stringResult;
  items2[2] = closure_5(tmp(4786).Text, obj11);
  ...
  if (null != findTraceEntryResult.error) {
    ...
    tmp23Result = tmp23(tmp(4786).Text, obj12);
  }
  ...
  if (traceDetailSectionsResult.includes("arguments")) {
    ...
    if ("tool" === findTraceEntryResult.kind) {
      ...
      obj13.title = intl25.string(tmp6(3714).jXY3mm);
      ...
      if (null != tmp20) {
        ...
        tmp23Result19 = tmp23(tmp(4786).Text, obj15);
      }
  ...
  if (traceDetailSectionsResult.includes("result")) {
    ...
    if ("tool" === findTraceEntryResult.kind) {
      ...
      obj16.title = intl26.string(tmp6(3714).KXrf5F);
      const obj17 = { label: null, value: null };
      const intl27 = tmp(1119).intl;
      obj17.label = intl27.string(tmp6(3714)["2Aii2k"]);
      ...
      obj17.value = intl28.formatToPlainString(tmp6(3714).DdXP0P, obj18);
      ...
      if (null != findTraceEntryResult.resultAdded) {
        ...
        const intl2 = tmp(1119).intl;
        obj19.label = intl2.string(tmp6(3714).hpGFzS);
      ...
      if (true === findTraceEntryResult.resultTruncated) {
        ...
        obj20.label = intl3.string(tmp6(3714)["UV2R1/"]);
        const intl4 = tmp(1119).intl;
        obj20.value = intl4.string(tmp6(3714)["1kBG9Z"]);
  ...
  if (traceDetailSectionsResult.includes("usage")) {
    ...
    if ("model" === findTraceEntryResult.kind) {
      ...
      obj22.title = intl29.string(tmp6(3714)["W+4BVk"]);
      let tmp23Result23 = null;
      if (null != findTraceEntryResult.promptTokens) {
        const obj23 = { label: null, value: null };
        const intl5 = tmp(1119).intl;
        obj23.label = intl5.string(tmp6(3714).Ran4BY);
        const intl6 = tmp(1119).intl;
        const obj24 = { tokens: tmp(17087).formatTokens(findTraceEntryResult.promptTokens) };
        obj23.value = intl6.formatToPlainString(tmp6(3714)["PYO+Jv"], obj24);
        tmp23Result23 = tmp23(closure_9, obj23);
        const tmpResult25 = tmp(17087);
      }
      ...
      if (null != findTraceEntryResult.systemTokens) {
        ...
        obj25.label = intl7.string(tmp6(3714).vPIcyv);
        const intl8 = tmp(1119).intl;
        const obj26 = { system: tmp(17087).formatTokens(findTraceEntryResult.systemTokens), tools: null, toolCount: null, messages: null, messageCount: null };
        const tmp43 = closure_9;
        const tmpResult26 = tmp(17087);
        let num10 = findTraceEntryResult.toolsTokens;
        if (num10 == null) {
          num10 = 0;
        }
        obj26.tools = tmp(17087).formatTokens(num10);
        let num11 = findTraceEntryResult.tools;
        if (num11 == null) {
          num11 = 0;
        }
        obj26.toolCount = num11;
        const tmpResult27 = tmp(17087);
        let num12 = findTraceEntryResult.messagesTokens;
        if (num12 == null) {
          num12 = 0;
        }
        obj26.messages = tmp(17087).formatTokens(num12);
        let num13 = findTraceEntryResult.messages;
        if (num13 == null) {
          num13 = 0;
        }
        obj26.messageCount = num13;
        obj25.value = intl8.formatToPlainString(tmp6(3714).Qy2iTq, obj26);
        tmp23Result24 = tmp23(tmp43, obj25);
        const tmpResult28 = tmp(17087);
      }
      ...
      if (null != findTraceEntryResult.inputTokens) {
        ...
        obj27.label = intl9.string(tmp6(3714)["/703Yk"]);
      ...
      if (null != findTraceEntryResult.outputTokens) {
        ...
        obj28.label = intl10.string(tmp6(3714)["6+W0dJ"]);
      ...
      if (null != findTraceEntryResult.cacheReadTokens) {
        ...
        obj29.label = intl11.string(tmp6(3714).VyAl6j);
        ...
        obj29.value = intl12.formatToPlainString(tmp6(3714).lkMc23, obj30);
      ...
      if (null != findTraceEntryResult.costUsd) {
        ...
        obj31.label = intl13.string(tmp6(3714).l9YFEQ);
      ...
      obj32.children = intl14.string(tmp6(3714).F9jaUF);
      items6[6] = tmp23(tmp(4786).Text, obj32);
  ...
  if (traceDetailSectionsResult.includes("arguments")) {
    ...
    obj33.children = intl15.string(tmp6(3714)["ppv+97"]);
    let tmp23Result29 = tmp23(tmp(4786).Text, obj33);
  } else {
    tmp23Result29 = null;
  }
  ...
  if (traceDetailSectionsResult.includes("diagnostics")) {
    ...
    obj34.title = intl16.string(tmp6(3714).T7SFyZ);
    if (null == findTraceEntryResult1) {
      ...
      if (length > 0) {
        ...
        obj35.label = intl18.string(tmp6(3714).fI6mzD);
        const intl19 = tmp(1119).intl;
        const obj36 = { count: length };
        obj35.value = intl19.formatToPlainString(tmp6(3714).hO8FYp, obj36);
      ...
      if (null != findTraceEntryResult.turnId) {
        ...
        obj37.label = intl20.string(tmp6(3714).I7cJP0);
      ...
      obj38.label = intl21.string(tmp6(3714)["XVTP/S"]);
      ...
      if (null != formatClockTimeResult) {
        ...
        obj39.label = intl22.string(tmp6(3714).rD7bm0);
      ...
      if ("model" === findTraceEntryResult.kind) {
        ...
        if (null != findTraceEntryResult.stopReason) {
          ...
          obj40.label = intl23.string(tmp6(3714).rxmzYT);
      ...
      if ("tool" === findTraceEntryResult.kind) {
        ...
        if (null != findTraceEntryResult.schema) {
          ...
          if (findTraceEntryResult.schema.length > 0) {
            ...
            obj43.children = intl24.string(tmp6(3714)["6oILKx"]);
            const items8 = [tmp23(tmp(4786).Text, obj43), ];
      ...
      obj44.label = intl17.string(tmp6(3714).NnBqcd);
  ...
  return closure_5(tmp(7481).ActionSheet, obj5);
}) : ((projectId) => {
  projectId = projectId.projectId;
  ({ entryId, initialEntry } = projectId);
  const tmp = closure_8();
  ...
  let findTraceEntryResult = projectId(17088).findTraceEntry(stateFromStoresArray, entryId);
  if (findTraceEntryResult == null) {
    findTraceEntryResult = initialEntry;
  }
  let findTraceEntryResult1 = null;
  if ("tool" === findTraceEntryResult.kind) {
    ...
    findTraceEntryResult1 = tmp2(17088).findTraceEntry(stateFromStoresArray, parentId);
    const tmp2Result = tmp2(17088);
  }
  const obj3 = projectId(17088);
  const length = tmp2(17088).traceChildren(stateFromStoresArray, findTraceEntryResult.id).length;
  const tmp2Result13 = tmp2(17088);
  const traceDetailSectionsResult = tmp2(17092).traceDetailSections(findTraceEntryResult, { childCount: length, hasParent: null != findTraceEntryResult1 });
  const obj4 = { childCount: length, hasParent: null != findTraceEntryResult1 };
  const tmp2Result14 = tmp2(17092);
  let detailId;
  if ("tool" === findTraceEntryResult.kind) {
    detailId = findTraceEntryResult.detailId;
  }
  const vibegrationsTraceDetail = tmp2(17093).useVibegrationsTraceDetail(projectId, detailId);
  const tmp12 = "model" === findTraceEntryResult.kind ? findTraceEntryResult.model : findTraceEntryResult.tool;
  const tmp2Result15 = tmp2(17093);
  const formatClockTimeResult = tmp2(17090).formatClockTime(findTraceEntryResult.startedAt, "millis");
  const tmp2Result16 = tmp2(17090);
  const traceCategoryResult = tmp2(17088).traceCategory(findTraceEntryResult);
  const tmp2Result17 = tmp2(17088);
  const traceRichStatusLabelResult = tmp2(17087).traceRichStatusLabel(vibegrationsTraceDetail);
  const obj5 = { scrollable: true, header: closure_5(tmp2(7428).BottomSheetTitleHeader, { title: tmp12 }), children: null };
  ...
  const items2 = [closure_5(tmp2(17086).TraceStatusDot, { status: findTraceEntryResult.status }), , ];
  const obj10 = { variant: "text-xs/semibold", style: traceCategoryTextStyles[traceCategoryResult], children: null };
  const obj9 = { status: findTraceEntryResult.status };
  const tmp2Result18 = tmp2(17087);
  obj10.children = tmp2(17087).categoryLabel(traceCategoryResult);
  items2[1] = closure_5(tmp2(4786).Text, obj10);
  ...
  if (null == findTraceEntryResult.durationMs) {
    ...
    stringResult = tmp2(17087).formatDuration(findTraceEntryResult.durationMs);
    const tmp2Result20 = tmp2(17087);
  }
  obj11.children = stringResult;
  items2[2] = closure_5(tmp2(4786).Text, obj11);
  obj8.children = items2;
  const items3 = [closure_6(View, obj8), , , , , , ];
  let tmp16Result = null;
  if (null != findTraceEntryResult.error) {
    const obj12 = { variant: "text-xs/normal", color: "text-feedback-critical", selectable: true, children: findTraceEntryResult.error };
    tmp16Result = tmp16(tmp2(4786).Text, obj12);
  }
  ...
  if (traceDetailSectionsResult.includes("arguments")) {
    ...
    if ("tool" === findTraceEntryResult.kind) {
      ...
      if (null != traceRichStatusLabelResult) {
        ...
        tmp16Result19 = tmp16(tmp2(4786).Text, obj15);
      }
  ...
  if (traceDetailSectionsResult.includes("usage")) {
    ...
    if ("model" === findTraceEntryResult.kind) {
      ...
      if (null != findTraceEntryResult.promptTokens) {
        ...
        const obj24 = { tokens: tmp2(17087).formatTokens(findTraceEntryResult.promptTokens) };
        obj23.value = intl6.formatToPlainString(tmp5(3714)["PYO+Jv"], obj24);
        tmp16Result23 = tmp16(closure_9, obj23);
        const tmp2Result21 = tmp2(17087);
      }
      ...
      if (null != findTraceEntryResult.systemTokens) {
        ...
        const obj26 = { system: tmp2(17087).formatTokens(findTraceEntryResult.systemTokens), tools: null, toolCount: null, messages: null, messageCount: null };
        const tmp2Result22 = tmp2(17087);
        const tmp37 = closure_9;
        let num2 = findTraceEntryResult.toolsTokens;
        if (num2 == null) {
          num2 = 0;
        }
        obj26.tools = tmp2(17087).formatTokens(num2);
        let num3 = findTraceEntryResult.tools;
        if (num3 == null) {
          num3 = 0;
        }
        obj26.toolCount = num3;
        const tmp2Result23 = tmp2(17087);
        let num4 = findTraceEntryResult.messagesTokens;
        if (num4 == null) {
          num4 = 0;
        }
        obj26.messages = tmp2(17087).formatTokens(num4);
      ...
      items6[6] = tmp16(tmp2(4786).Text, obj32);
      obj22.children = items6;
  ...
  if (traceDetailSectionsResult.includes("arguments")) {
    ...
    let tmp16Result29 = tmp16(tmp2(4786).Text, obj33);
  } else {
    tmp16Result29 = null;
  }
      ...
      if ("tool" === findTraceEntryResult.kind) {
        ...
        if (null != findTraceEntryResult.schema) {
          ...
          if (findTraceEntryResult.schema.length > 0) {
            ...
            const items8 = [tmp16(tmp2(4786).Text, obj43), ];
            const schema = findTraceEntryResult.schema;
            items8[1] = schema.map((label) => {
              const obj = { label: label.name, value: null };
              const intl = projectId(1119).intl;
  ...
  obj7.children = items3;
  obj6.children = closure_6(View, obj7);
  obj5.children = closure_5(tmp2(6895).BottomSheetScrollView, obj6);
  return closure_5(tmp2(7481).ActionSheet, obj5);
});
