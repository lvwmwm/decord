...
// Dependencies: [32, 19, 17, 1376, 8739, 8728, 21, 8729, 15047, 4790, 580, 558, 568, 1119, 15039, 4749, 7208, 9740, 6883, 7213, 504, 1401, 9122, 1181, 4786, 2]

// Module 15046 (SafetyHubAccountStanding)
...
import SafetyHubAccountStandingLabels from "SafetyHubAccountStandingLabels" /* 15039 */;
import SafetyHubAccountStandingSubwayMarkerDefault from "SafetyHubAccountStandingSubwayMarker" /* 15047 */;
...
let c11 = 20;
let obj = { [fn(8729).AccountStandingState.ALL_GOOD]: { left: "0%" } };
let obj2 = { left: "25%", transform: null };
let items = [{ translateX: -0.5 * fn(15047).SUBWAY_MARKER_WIDTH }];
obj2.transform = items;
obj[fn(8729).AccountStandingState.LIMITED] = obj2;
let obj4 = { left: "50%", transform: null };
let obj3 = { translateX: -0.5 * fn(15047).SUBWAY_MARKER_WIDTH };
let items1 = [{ translateX: -0.5 * fn(15047).SUBWAY_MARKER_WIDTH }];
obj4.transform = items1;
obj[fn(8729).AccountStandingState.VERY_LIMITED] = obj4;
let obj6 = { left: "75%", transform: null };
let obj5 = { translateX: -0.5 * fn(15047).SUBWAY_MARKER_WIDTH };
let items2 = [{ translateX: -0.5 * fn(15047).SUBWAY_MARKER_WIDTH }];
obj6.transform = items2;
obj[fn(8729).AccountStandingState.AT_RISK] = obj6;
let obj8 = { left: "100%", transform: null };
let obj7 = { translateX: -0.5 * fn(15047).SUBWAY_MARKER_WIDTH };
let items3 = [{ translateX: -fn(15047).SUBWAY_MARKER_WIDTH }];
obj8.transform = items3;
obj[fn(8729).AccountStandingState.SUSPENDED] = obj8;
...
let obj9 = { translateX: -fn(15047).SUBWAY_MARKER_WIDTH };
...
export default ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[2] !== tmp9.good) {
    let obj4 = { title: tmp(1119).t.uaKrRi, description: tmp10, status: tmp(15039).ACCOUNT_STANDING_SHORT_STATUS[tmp(undefined, 8729).AccountStandingState.ALL_GOOD], style: tmp9.good, CustomIcon: tmp(4749).CircleCheckIcon };
    cResult[2] = tmp9.good;
    cResult[3] = obj4;
    let tmp13 = obj4;
  } else {
  ...
  if (cResult[5] !== tmp9.limited) {
    const obj5 = { title: tmp(1119).t.epkcmS, description: tmp14, status: tmp(15039).ACCOUNT_STANDING_SHORT_STATUS[tmp(undefined, 8729).AccountStandingState.LIMITED], style: tmp9.limited, CustomIcon: tmp(7208).CircleErrorIcon, iconSource: first1(9740) };
  ...
  if (cResult[8] !== tmp9.veryLimited) {
    const obj6 = { title: tmp(1119).t.crzE2X, description: tmp18, status: tmp(15039).ACCOUNT_STANDING_SHORT_STATUS[tmp(undefined, 8729).AccountStandingState.VERY_LIMITED], style: tmp9.veryLimited, CustomIcon: tmp(7208).CircleErrorIcon, iconSource: first1(9740) };
  ...
  if (cResult[11] !== tmp9.atRisk) {
    let obj7 = { title: tmp(1119).t.XRNVzO, description: tmp22, status: tmp(15039).ACCOUNT_STANDING_SHORT_STATUS[tmp(undefined, 8729).AccountStandingState.AT_RISK], style: tmp9.atRisk, CustomIcon: tmp(7208).CircleErrorIcon, iconSource: first1(9740) };
  ...
  if (cResult[14] !== tmp9.suspended) {
    const obj8 = { title: tmp(1119).t.MExFkz, description: tmp26, status: tmp(15039).ACCOUNT_STANDING_SHORT_STATUS[tmp(undefined, 8729).AccountStandingState.SUSPENDED], style: tmp9.suspended, CustomIcon: tmp(6883).CircleXIcon, iconSource: first1(7213) };
                        ...
                        if (cResult[43] === style) {
                          if (cResult[44] === title) {
                            if (cResult[48] !== cResult[45]) {
                              ...
                              const tmp60 = closure_9(tmp(4786).Text, obj11);
                              cResult[48] = tmp54;
                              cResult[49] = tmp60;
                              let tmp58 = tmp60;
                            } else {
                            ...
                            if (cResult[51] !== description) {
                              ...
                              const tmp64 = closure_9(tmp(4786).Text, obj13);
  ...
  const obj23 = {};
  obj23[first(8729).AccountStandingState.ALL_GOOD] = tmp13;
  obj23[first(8729).AccountStandingState.LIMITED] = tmp16;
  obj23[first(8729).AccountStandingState.VERY_LIMITED] = tmp20;
  obj23[first(8729).AccountStandingState.AT_RISK] = tmp24;
  obj23[first(8729).AccountStandingState.SUSPENDED] = tmp28;
  cResult[16] = tmp28;
  cResult[17] = tmp13;
  cResult[18] = tmp16;
  cResult[19] = tmp20;
  ...
  const items5 = [closure_9(accountStanding(4786).Text, obj8), closure_9(accountStanding(4786).Text, { variant: "text-sm/medium", color: "text-muted", style: { textAlign: "center" }, children: description })];
