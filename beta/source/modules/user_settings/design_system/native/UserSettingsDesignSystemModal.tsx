...
// Dependencies: [32, 19, 17, 21, 4756, 576, 7245, 5841, 4959, 7619, 1115, 6848, 4451, 11465, 14454, 8693, 8694, 4752, 12181, 14456, 11262, 11261, 5904, 7445, 5186, 2]
// Exports: default
...
function DemoScreen(arg0) {
  ...
  if (footer == null) {
    ...
    if (tmp8Result) {
      ...
      tmp8Result = tmp8(tmp3(14456).ModalDisclaimer, obj5);
    }
    const items2 = [tmp8Result, , ];
    let tmp8Result3 = null != action;
    if (tmp8Result3) {
      const obj6 = { variant: "primary", text: action, onPress: onAction };
      tmp8Result3 = tmp8(tmp3(11262).ModalActionButton, obj6);
    }
    ...
    if (tmp8Result4) {
      ...
      tmp8Result4 = tmp8(tmp3(11262).ModalActionButton, obj7);
    }
    const obj8 = { children: null };
    items2[2] = tmp8Result4;
    obj8.children = items2;
    footer = tmp2(tmp3(12181).ModalFooter, obj8);
  }
  children1[1] = footer;
