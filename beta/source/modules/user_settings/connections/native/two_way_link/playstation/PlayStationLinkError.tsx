...
// Dependencies: [19, 9373, 1078, 21, 558, 568, 1488, 9367, 1119, 9368, 2]

// Module 9381 (PlayStationLinkError)
import c from "c" /* 568 */;
...
export const PlayStationLinkError = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[0] !== errorCode) {
    ...
    const tmp15 = jsx(tmp(9368).TwoWayLinkError, { title: tmp11, body: cResult[1], onClose, onRetry: connectRetry });
    cResult[3] = cResult[1];
    cResult[4] = onClose;
