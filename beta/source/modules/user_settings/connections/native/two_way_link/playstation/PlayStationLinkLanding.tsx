...
// Dependencies: [19, 9405, 1078, 21, 4790, 1119, 5353, 9378, 558, 568, 1488, 2112, 9407, 9380, 2]

// Module 9406 (PlayStationLinkLanding)
...
export const PlayStationLinkLanding = ReactCompilerGating.isReactCompilerEnabled() ? ((platformType) => {
  ...
  cResult[10] = jsx(navigation(9380).TwoWayLinkLanding, { platformType, img: tmp13, imgStyle: tmp4.image, headerConnect: tmp16, headerReconnect: tmp17, body: first, onNext: tmp12, valueProps: tmp11 });
}) : ((platformType) => {
  let navigation;
  const tmp = closure_7();
  navigation = navigation(1488).useNavigation();
  ...
  const memo1 = noop.useMemo(() => ({ uri: _modDef9407 }), []);
  ...
  return jsx(navigation(9380).TwoWayLinkLanding, { platformType: platformType.platformType, img: memo1, imgStyle: tmp.image, headerConnect: null, headerReconnect: null, body: null, onNext: null, valueProps: null });
});
