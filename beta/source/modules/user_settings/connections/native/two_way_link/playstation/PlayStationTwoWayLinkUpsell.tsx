...
// Dependencies: [19, 1078, 21, 4790, 558, 568, 2112, 15243, 1119, 5834, 15246, 9403, 2031, 2]

// Module 15245 (PlayStationTwoWayLinkUpsell)
import c from "c" /* 568 */;
...
export const PlayStationTwoWayLinkUpsell = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[3] !== tmp4.upsellImage) {
    const obj4 = { style: tmp4.upsellImage, source: _modDef15246, resizeMode: "contain" };
    const tmp17 = jsx(FastImageDefault, { style: tmp4.upsellImage, source: _modDef15246, resizeMode: "contain" });
