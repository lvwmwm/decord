...
// Function ID: 9342
// Name: XboxLinkModal
// Dependencies: [19, 9342, 1078, 21, 558, 568, 9340, 7621, 7238, 1119, 9343, 9350, 9351, 9355, 9359, 9364, 9366, 9349, 9370, 7246, 2]

// Module 9341 (XboxLinkModal)
import c from "c" /* 568 */;
...
import XboxLinkLandingDefault from "XboxLinkLanding" /* 9343 */;
import TwoWayLinkStyles from "TwoWayLinkStyles" /* 9349 */;
import XboxLinkPreConnectDefault from "XboxLinkPreConnect" /* 9351 */;
import XboxLinkDiscordConsentDefault from "XboxLinkDiscordConsent" /* 9355 */;
import XboxLinkSuccessDefault from "XboxLinkSuccess" /* 9359 */;
import XboxLinkEducationDefault from "XboxLinkEducation" /* 9364 */;
import XboxLinkErrorDefault from "XboxLinkError" /* 9366 */;
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((locationStack) => {
  ...
  const accountLinkStepTracking = twoWayLinkStyles(9370).useAccountLinkStepTracking(PlatformTypes.XBOX, locationStack.locationStack);
  ...
  return jsx(twoWayLinkStyles(7246).Navigator, { onStateChange: accountLinkStepTracking, screens: memo, initialRouteName: XboxLinkModalScenes.LANDING, headerBackTitle: null });
});
