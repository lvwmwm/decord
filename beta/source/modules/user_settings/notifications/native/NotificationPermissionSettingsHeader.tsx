...
// Dependencies: [19, 17, 1078, 12559, 21, 4758, 580, 558, 568, 12560, 1245, 10382, 4754, 1119, 5188, 5824, 2]

// Module 15748 (NotificationPermissionSettingsHeader)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  canSeePushNotificationNudge = canSeePushNotificationNudge(12560).useCanSeePushNotificationNudge();
  ...
  if (canSeePushNotificationNudge) {
    ...
    if (cResult[4] === Symbol.for("react.memo_cache_sentinel")) {
      ...
      const tmp12 = closure_11(tmp(10382).BellSlashIcon, obj3);
      cResult[4] = tmp12;
      const tmp10 = tmp12;
    } else {
      class E {
    ...
    if (cResult[7] === Symbol.for("react.memo_cache_sentinel")) {
      ...
      const tmp17 = closure_11(tmp(4754).Text, obj5);
      cResult[7] = tmp17;
      const tmp16 = tmp17;
    } else {
      class E {
    ...
    if (cResult[9] !== tmp4.body) {
      ...
      const tmp21 = closure_11(tmp(4754).Text, obj7);
      cResult[9] = tmp4.body;
      cResult[10] = tmp21;
    } else {
      class E {
    ...
    if (cResult[12] === Symbol.for("react.memo_cache_sentinel")) {
      ...
      obj9.onPress = tmp9;
      obj8.children = closure_11(tmp(5188).Button, obj9);
    ...
    const tmp31 = closure_11(tmp(5824).Card, obj10);
  ...
  if (canSeePushNotificationNudge) {
    ...
    obj5.children = closure_11(tmp2(10382).BellSlashIcon, obj6);
    ...
    items1[1] = closure_11(tmp2(4754).Text, obj7);
    ...
    items1[2] = closure_11(tmp2(4754).Text, obj8);
    ...
    obj10.onPress = tmp6;
    obj9.children = closure_11(tmp2(5188).Button, obj10);
