...
// Dependencies: [32, 19, 17, 8466, 21, 4758, 580, 558, 568, 11041, 7409, 7429, 8458, 504, 4754, 1119, 2582, 11046, 11330, 5188, 10959, 13839, 11408, 2]

// Module 13838 (UserSettingsGiftingBadgeProgress)
...
let closure_8 = fn(8466).getSingleRequirementThreshold;
const jsxProd = fn(21);
...
let closure_14 = ReactCompilerGating.isReactCompilerEnabled() ? ((analyticsLocation) => {
  ...
  importDefault = tmp;
  dependencyMap = analyticsLocation(11041).useIsGiftingBadgeComplexArtEnabled(UserSettingsGiftingBadgeProgress);
  let obj = analyticsLocation(11041);
  ...
  if (null != stateFromStores) {
    ...
    obj4.children = closure_9(tmp2(4754).Text, obj5);
    ...
    obj7.icon = closure_9(tmp2(11330).GiftIcon, obj8);
    const intl2 = tmp2(1119).intl;
    obj7.text = intl2.string(tmp4(2582).DZnomS);
    obj7.onPress = function onPress() {
      utils_openGiftModal.openGiftModal({ analyticsLocation, analyticsLocations });
    };
    items1[2] = closure_9(tmp2(5188).Button, obj7);
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((analyticsLocation) => {
  ...
  if (cResult[0] === Symbol.for("react.memo_cache_sentinel")) {
    let items = [BadgeDirectoryStore];
    const fn = function b() {
      singleRequirementProgress = singleRequirementProgress.getSingleRequirementProgress(analyticsLocation(8458).BadgeId.GIFTING);
      let num;
      ...
      const obj2 = { badgeProgress: num, currentTier: singleRequirementProgress.getCurrentTier(analyticsLocation(8458).BadgeId.GIFTING), nextTier: singleRequirementProgress.getNextTier(analyticsLocation(8458).BadgeId.GIFTING), giftsRemaining: singleRequirementProgress.getRemainingToNextTier(analyticsLocation(8458).BadgeId.GIFTING), tiers: null };
      const badgeById = obj.getBadgeById(tmp(8458).BadgeId.GIFTING);
      let tiers;
      if (badgeById != null) {
        tiers = badgeById.tiers;
      }
  ...
  const isGiftingBadgeComplexArtEnabled = analyticsLocation(11041).useIsGiftingBadgeComplexArtEnabled(UserSettingsGiftingBadgeProgress);
  if (0 === badgeProgress) {
                                              ...
                                              if (cResult[83] === tmp19) {
                                                if (cResult[84] === tmp40) {
                                                  ...
                                                  if (cResult[87] === Symbol.for("react.memo_cache_sentinel")) {
                                                    ...
                                                    const tmp49 = closure_9(tmp(11330).GiftIcon, obj3);
                                                  ...
                                                  if (cResult[89] === analyticsLocation) {
                                                    ...
                                                    if (cResult[95] === Symbol.for("react.memo_cache_sentinel")) {
                                                      ...
                                                      const tmp60 = closure_9(tmp(4754).Text, obj5);
                                                      cResult[95] = tmp60;
                                                      const tmp59 = tmp60;
                                                    } else {
                                                      class J {
                                                    ...
                                                    if (cResult[96] !== tmp6) {
                                                      ...
                                                      if (cResult[98] === tmp4.dropdownRow) {
                                                        ...
                                                        if (tmp6) {
                                                          ...
                                                          items1[1] = closure_9(tmp(4754).Text, obj9);
                                                  ...
                                                  const tmp53 = closure_9(tmp(5188).Button, obj11);
    ...
    const giftingBadgeProgressPercent = tmp(11041).getGiftingBadgeProgressPercent(badgeProgress, currentTier, nextTier);
    cResult[33] = badgeProgress;
    cResult[34] = currentTier;
    cResult[35] = nextTier;
    cResult[36] = giftingBadgeProgressPercent;
    const tmpResult4 = tmp(11041);
  }
}) : ((analyticsLocation) => {
  analyticsLocation = analyticsLocation.analyticsLocation;
  ...
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(11041).getGiftingBadgeProgressPercent(badgeProgress, currentTier, nextTier);
    const tmp7Result = tmp7(11041);
    let giftingBadgeTierIconUrl = tmp7(11041).getGiftingBadgeTierIconUrl(currentTier, isGiftingBadgeComplexArtEnabled);
    const tmp7Result3 = tmp7(11041);
    const giftingBadgeTierIconUrl1 = tmp7(11041).getGiftingBadgeTierIconUrl(nextTier, isGiftingBadgeComplexArtEnabled);
    if (null != nextTier) {
    ...
    obj16.children = closure_9(tmp7(4754).Text, obj18);
    ...
    const items6 = [closure_9(tmp7(4754).Text, obj23), ];
    if (tmp11Result) {
    ...
    if (tmp11Result) {
      ...
      items7[1] = tmp15(tmp7(4754).Text, obj27);
  ...
  let obj2 = analyticsLocation(11041);
});
