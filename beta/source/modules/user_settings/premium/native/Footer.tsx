...
// Function ID: 13761
// Name: Footer
// Dependencies: [19, 17, 21, 4758, 558, 568, 13761, 7429, 4754, 1119, 5188, 5802, 13762, 2]
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[0] === style) {
        ...
        if (cResult[5] === showSubscribeButton) {
          if (cResult[6] === tmp4.button) {
            ...
            if (cResult[9] !== easterEggSpacing) {
              const obj2 = { style: easterEggSpacing, source: tmp5(13762) };
              const tmp19 = React4(tmp5(5802), obj2);
    ...
    if (showSubscribeButton) {
      ...
      const items1 = [React4(tmp(4754).Text, obj5), ];
      ...
      obj6.children = React4(tmp(5188).Button, obj7);
  ...
  items2[1] = tmp14(tmp2Result, { style: easterEggSpacing, source: _modDef13762 });
  obj.children = items2;
