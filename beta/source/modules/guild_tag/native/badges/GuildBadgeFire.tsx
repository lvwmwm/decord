...
export const GuildBadgeFire = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[9] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp21 = React4(tmp(8765).Path, { d: "M0 8v4h1V8H0ZM15 9v3h1V9h-1ZM14 6v3h1V6h-1ZM13 4v2h1V4h-1Z", fill: "#000" });
    cResult[9] = tmp21;
    let tmp19 = tmp21;
  } else {
    tmp19 = cResult[9];
  ...
  if (cResult[17] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp36 = React4(tmp(8765).Path, { opacity: 0.5, d: "M11 4v1h1V4h-1ZM12 9V8h-1V6h-1v1H9v1H6V7H5v2H3v2h1v2h1v1h6v-1h1v-2h1V9h-1Z", fill: "#fff" });
    cResult[17] = tmp36;
    let tmp34 = tmp36;
  } else {
    tmp34 = cResult[17];
  ...
  if (cResult[22] !== primaryColorsTransformed[2]) {
    ...
    const tmp45 = React4(tmp(8765).Path, obj9);
  ...
  if (cResult[24] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp48 = React4(tmp(8765).Path, { d: "M12 1v3h1V1h-1Z", fill: "#000" });
    cResult[24] = tmp48;
    let tmp46 = tmp48;
  } else {
    tmp46 = cResult[24];
