...
export const GuildBadgeSmoke = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[6] === tmp4) {
    ...
    if (cResult[16] !== secondaryColorsTransformed[0]) {
      ...
      const tmp31 = React4(tmp(8765).Path, obj6);
    ...
    obj9.children = items;
    const tmp43 = hasOwnProperty(tmp(8765).Svg, obj9);
    cResult[23] = num8;
    cResult[24] = tmp5;
    cResult[25] = tmp32;
    cResult[26] = tmp35;
