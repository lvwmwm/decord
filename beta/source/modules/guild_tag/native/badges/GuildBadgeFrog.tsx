...
export const GuildBadgeFrog = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[6] === tmp4) {
    ...
    if (cResult[11] === Symbol.for("react.memo_cache_sentinel")) {
      const tmp27 = React4(tmp(8765).Path, { d: "M13 3V2H10V3H13Z", fill: "white" });
      const tmp28 = React4(tmp(8765).Path, { d: "M13 7V6H10V7H13Z", fill: "white" });
      const tmp29 = React4(tmp(8765).Path, { d: "M14 6V3H13V6H14Z", fill: "white" });
      const tmp30 = React4(tmp(8765).Path, { d: "M10 6V3H9V6H10Z", fill: "white" });
      const tmp31 = React4(tmp(8765).Path, { d: "M6 3V2H3V3H6Z", fill: "white" });
      const tmp32 = React4(tmp(8765).Path, { d: "M6 7V6H3V7H6Z", fill: "white" });
      const tmp33 = React4(tmp(8765).Path, { d: "M7 6V3H6V6H7Z", fill: "white" });
      const tmp34 = React4(tmp(8765).Path, { d: "M3 6V3H2V6H3Z", fill: "white" });
      cResult[11] = tmp32;
      cResult[12] = tmp33;
      cResult[13] = tmp34;
      cResult[14] = tmp27;
    ...
    if (cResult[19] !== secondaryColorsTransformed[1]) {
      ...
      const tmp37 = React4(tmp(8765).Path, obj3);
    ...
    if (cResult[30] === Symbol.for("react.memo_cache_sentinel")) {
      const tmp76 = React4(tmp(8765).Path, { d: "M14 14V13H12V14H14Z", fill: "black" });
      const tmp77 = React4(tmp(8765).Path, { d: "M9 3V2H7V3H9Z", fill: "black" });
      const tmp78 = React4(tmp(8765).Path, { d: "M13 2V1L9 1V2H13Z", fill: "black" });
      const tmp79 = React4(tmp(8765).Path, { d: "M7 2V1L3 1V2H7Z", fill: "black" });
      const tmp80 = React4(tmp(8765).Path, { d: "M4 14V13H2V14H4Z", fill: "black" });
      const tmp81 = React4(tmp(8765).Path, { d: "M15 12H14V13H15V12Z", fill: "black" });
      const tmp82 = React4(tmp(8765).Path, { d: "M14 2H13V3H14V2Z", fill: "black" });
      const tmp83 = React4(tmp(8765).Path, { d: "M3 2H2V3H3V2Z", fill: "black" });
      const tmp84 = React4(tmp(8765).Path, { d: "M2 12H1V13H2V12Z", fill: "black" });
      const tmp85 = React4(tmp(8765).Path, { d: "M12 14H4V15H12V14Z", fill: "black" });
      const tmp86 = React4(tmp(8765).Path, { d: "M16 12V6.99998H15V12H16Z", fill: "black" });
      const tmp87 = React4(tmp(8765).Path, { d: "M15 7V3H14V7H15Z", fill: "black" });
      const tmp88 = React4(tmp(8765).Path, { d: "M2 7L2 3H1L1 7H2Z", fill: "black" });
      const tmp89 = React4(tmp(8765).Path, { d: "M1 12L1 6.99998H0L0 12H1Z", fill: "black" });
      const tmp90 = React4(tmp(8765).Path, { d: "M13 6V3H10V6H13Z", fill: "black" });
      const tmp91 = React4(tmp(8765).Path, { d: "M6 6V3H3V6H6Z", fill: "black" });
      const tmp92 = React4(tmp(8765).Path, { d: "M13 9H3V10H13V9Z", fill: "black" });
      const tmp93 = React4(tmp(8765).Path, { d: "M14 8H13V9H14V8Z", fill: "black" });
      const tmp94 = React4(tmp(8765).Path, { d: "M7 7H6V8H7V7Z", fill: "black" });
      const tmp95 = React4(tmp(8765).Path, { d: "M10 7H9V8H10V7Z", fill: "black" });
      const tmp96 = React4(tmp(8765).Path, { d: "M3 8H2V9H3V8Z", fill: "black" });
      cResult[30] = tmp76;
      cResult[31] = tmp77;
      cResult[32] = tmp78;
      cResult[33] = tmp79;
    ...
    const tmp102 = hasOwnProperty(tmp(8765).Svg, obj11);
    cResult[51] = num8;
    cResult[52] = tmp5;
    cResult[53] = tmp35;
    cResult[54] = tmp38;
