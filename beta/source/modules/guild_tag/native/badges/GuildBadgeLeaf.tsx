...
export const GuildBadgeLeaf = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[11] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp24 = React4(tmp(8765).Path, { d: "M15 2V1H9v1h6ZM9 3V2H5v1h4Z", fill: "#fff" });
    cResult[11] = tmp24;
    let tmp22 = tmp24;
  } else {
    tmp22 = cResult[11];
  ...
  if (cResult[14] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp30 = React4(tmp(8765).Path, { d: "M16 1h-1v6h1V1Z", fill: "#000" });
    cResult[14] = tmp30;
    let tmp28 = tmp30;
  } else {
    tmp28 = cResult[14];
  ...
  if (cResult[17] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp37 = React4(tmp(8765).Path, { d: "M15 0H9v1h6V0ZM11 13H5v1h6v-1ZM9 1H5v1h4V1ZM5 2H3v1h2V2ZM3 3H2v2h1V3ZM1 7H0v5h1v3h1v-3H1V7h1V5H1v2ZM13 12h-2v1h2v-1ZM14 10h-1v2h1v-2h1V7h-1v3ZM4 13h1v-1H3v3h1v-2ZM3 15H2v1h1v-1Z", fill: "#000" });
    const tmp38 = React4(tmp(8765).Path, { d: "M2 7h1V5H2v2ZM1 9h1V7H1v2ZM5 3H3v2h1V4h1V3Z", fill: "#fff" });
    cResult[17] = tmp37;
    cResult[18] = tmp38;
    let tmp35 = tmp38;
    let tmp34 = tmp37;
  ...
  if (cResult[21] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp44 = React4(tmp(8765).Path, { d: "M5 4v1h1V4H5Z", fill: "#fff" });
    cResult[21] = tmp44;
    let tmp42 = tmp44;
  } else {
    tmp42 = cResult[21];
