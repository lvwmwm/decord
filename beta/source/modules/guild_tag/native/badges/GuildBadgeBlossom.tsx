...
// Module 14222 (GuildBadgeBlossom)
import c from "c" /* 568 */;
...
export const GuildBadgeBlossom = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[7] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp18 = React4(tmp(8733).Path, { d: "M9 10h-2v-2h2v2Z", fill: "#FCF4A9" });
    cResult[7] = tmp18;
    let tmp16 = tmp18;
  } else {
    tmp16 = cResult[7];
  ...
  if (cResult[12] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp29 = React4(tmp(8733).Path, { d: "M8 15h-1v-1h1v1ZM5 3h-1v1h-1V2h2v1Z", fill: "#0E7941" });
    const tmp30 = React4(tmp(8733).Path, { d: "M9 15h-1v-1h1v1ZM13 4h-1v-1h-1V2h2v2Z", fill: "#054725" });
    const tmp31 = React4(tmp(8733).Path, { d: "M11 15h-1v-1h1v1ZM3 14H2V11h1v3ZM10 14h-1v-1h1v1ZM4 11h-1v-1h1v1ZM2 8H1V5h2v1H2v2ZM7 7h-1v-1h1v1ZM15 6H12v-1h3v1ZM8 2h-1V1h1v1Z", fill: "white" });
    cResult[12] = tmp29;
    cResult[13] = tmp30;
    cResult[14] = tmp31;
    let tmp27 = tmp31;
  ...
  if (cResult[15] !== primaryColorsTransformed[3]) {
    ...
    const tmp34 = React4(tmp(8733).Path, obj5);
  ...
  if (cResult[17] !== primaryColorsTransformed[1]) {
    ...
    const tmp37 = React4(tmp(8733).Path, obj6);
