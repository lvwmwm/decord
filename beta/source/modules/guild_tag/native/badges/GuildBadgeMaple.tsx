...
export const GuildBadgeMaple = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[13] === Symbol.for("react.memo_cache_sentinel")) {
    const tmp27 = React4(tmp(8765).Path, { d: "M2 14H1v-1h1v1ZM3 13H2v-1h1v1ZM4 12h-1v-1h1v1ZM4 6H2v2H1V5h3v1ZM12 7h-1v-1h1v1ZM13 6h-1v-1h1v1ZM7 5h-1V2h1v3ZM9 2h-2V1h2v1Z", fill: "white" });
    cResult[13] = tmp27;
    let tmp25 = tmp27;
  } else {
    tmp25 = cResult[13];
  ...
  if (cResult[16] !== primaryColorsTransformed[3]) {
    ...
    const tmp35 = React4(tmp(8765).Path, obj8);
