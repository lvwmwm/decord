...
export const GuildBadgeSnail = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[6] === tmp4) {
    ...
    if (cResult[9] === Symbol.for("react.memo_cache_sentinel")) {
      const tmp17 = React4(tmp(8765).Path, { d: "M9 13h-1v-1h1v1ZM8 12h-1v-1h1v1ZM7 11h-1v-2h1v2ZM12 10h-1v-1h1v1ZM11 9h-1v-1h1v1ZM13 9h-1v-1h1v1ZM12 8h-1v-1h1v1ZM2 6H1v-1h1v1ZM8 5h-2v-1h2v1ZM4 2h-1V1h1v1Z", fill: "white" });
      cResult[9] = tmp17;
      let tmp15 = tmp17;
    } else {
      tmp15 = cResult[9];
    ...
    if (cResult[10] !== primaryColorsTransformed[1]) {
      ...
      const tmp22 = React4(tmp(8765).Path, obj2);
    ...
    obj8.children = items;
    const tmp47 = hasOwnProperty(tmp(8765).Svg, obj8);
    cResult[21] = num8;
    cResult[22] = tmp5;
    cResult[23] = tmp31;
    cResult[24] = tmp36;
