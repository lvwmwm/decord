...
// Function ID: 16462
// Name: VoiceGuildTag
// Dependencies: [19, 17, 1376, 8207, 21, 1368, 4758, 580, 558, 568, 504, 8439, 9980, 4754, 2]

// Module 16461 (VoiceGuildTag)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((userId) => {
  ...
  if (cResult[4] !== primaryGuild) {
    ...
    const userPrimaryGuild = tmp(8439).getUserPrimaryGuild(primaryGuild1);
    ...
    if (null != guildId) {
      tmp18 = null;
      if (null != tag) {
        guildTagBadgeUrl = tmp(8439).getGuildTagBadgeUrl(guildId, tmp17, GuildTagBadgeSize.SIZE_12);
        tmp18 = forResult;
        const tmpResult4 = tmp(8439);
      }
    }
    let primaryGuild2;
    if (stateFromStores != null) {
  ...
  if (tmp12 !== Symbol.for("react.early_return_sentinel")) {
    ...
    if (cResult[8] !== tmp11) {
      ...
      const tmp25 = closure_5(tmp(9980).GuildTagBadge, obj2);
      cResult[8] = tmp11;
      cResult[9] = tmp25;
      let tmp22 = tmp25;
    } else {
    ...
    const tmp28 = closure_5(tmp(4754).Text, obj6);
    cResult[10] = tmp4.tag;
    cResult[11] = tmp13;
    cResult[12] = tmp28;
    tmp26 = tmp28;
