...
// Dependencies: [19, 17, 11593, 21, 4790, 580, 558, 568, 4725, 4642, 14179, 14180, 504, 11954, 4384, 7403, 1119, 4786, 5220, 4993, 2]

// Module 14178 (BuildOverrideModal)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((overrideUrl) => {
  ...
  const obj = str(568);
  const tmp5 = stateFromStores(4725)();
  if (tmpResult.isThemeDark(tmp5)) {
    let tmp4Result = tmp4(14179);
  } else {
    tmp4Result = tmp4(14180);
  }
  ...
  if (override != null) {
    ...
    if (targetBuildOverride != null) {
      const tmp11 = targetBuildOverride[tmp(undefined, 11954).DEVICE_FIELD];
      if (tmp11 != null) {
                        ...
                        if (cResult[33] === tmp17) {
                          if (cResult[34] === tmp18) {
                            ...
                            if (null != actionButton) {
                              ...
                              obj4.children = closure_6(tmp(5220).Button, obj6);
                              ...
                              onPress = function onPress() {
                                return stateFromStores(4993).pop();
                              };
                              obj7.onPress = onPress;
                              items3[1] = closure_6(tmp(5220).Button, obj7);
                              ...
                              tmp45 = closure_6(tmp(5220).Button, obj8);
                            }
  ...
  const tmp4Result2 = stateFromStores(4384);
  let expiresAt1;
  if (override != null) {
    expiresAt1 = override.expiresAt;
  }
  const obj5 = stateFromStores(4384)();
  const durationResult = tmp4Result2.duration(stateFromStores(4384)().diff(expiresAt1));
  ...
  if (cResult[25] === tmp3.imageWrapper) {
    ...
    if (cResult[29] !== tmp3.text) {
      ...
      const tmp33 = closure_6(tmp(4786).Text, obj11);
    ...
    if (null != actionButton) {
      ...
      const items5 = [closure_6(tmp(4786).Text, obj13), ];
      ...
      items5[1] = closure_6(tmp(4786).Text, obj14);
      ...
      tmp35 = closure_6(tmp(4786).Text, obj16);
    }
    let expiresAt2;
    if (override != null) {
  ...
  if (obj.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(14179);
  } else {
    tmp2Result = tmp2(14180);
  }
  obj = str(4642);
  const items = [BuildOverrideStore];
  const items1 = [str];
  ...
  if (override != null) {
    const targetBuildOverride = override.targetBuildOverride;
    if (targetBuildOverride != null) {
      const tmp9 = targetBuildOverride[tmp5(undefined, 11954).DEVICE_FIELD];
      if (tmp9 != null) {
        id = tmp9.id;
      }
    }
  ...
  const tmp2Result2 = stateFromStores(4384);
  let expiresAt;
  if (override != null) {
    expiresAt = override.expiresAt;
  }
  const obj4 = stateFromStores(4384)();
  const durationResult = tmp2Result2.duration(stateFromStores(4384)().diff(expiresAt));
  const rect = { top: true, bottom: true, style: tmp.container, children: null };
  const obj2 = { style: tmp.content, children: null };
  const humanizeResult = tmp2Result2.duration(stateFromStores(4384)().diff(expiresAt)).humanize();
  ...
  if (null != id) {
    ...
    items3[1] = tmp14(tmp5(4786).Text, obj8);
    ...
    tmp14Result = tmp14(tmp5(4786).Text, obj10);
  }
  ...
  if (null != id) {
    ...
    obj13.children = tmp14(tmp5(5220).Button, obj14);
    ...
    items5[1] = tmp14(tmp5(5220).Button, obj15);
    obj12.children = items5;
    ...
    tmp12Result2 = tmp14(tmp5(5220).Button, obj16);
  }
  obj11.children = tmp12Result2;
  items4[1] = closure_6(closure_4, obj11);
  rect.children = items4;
  return closure_8(str(7403).SafeAreaPaddingView, rect);
});
