...
// Dependencies: [1078, 7540, 4988, 7541, 2023, 7542, 7545, 1190, 2]

// Module 7539 (HarmTypeConfiguration)
import preloaded_user_settings from "preloaded_user_settings" /* 1190 */;
import UserSettings from "UserSettings" /* 2023 */;
import MediaTypes from "MediaTypes" /* 4988 */;
...
obj3[obj.EXPLICIT] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    if (arg0 == null) {
      ...
      const ExplicitContentSettings = tmp12(2023).ExplicitContentSettings;
      ...
      const ExplicitContentSettings2 = tmp12(2023).ExplicitContentSettings;
    ...
    let tmp9;
    if (tmp != null) {
      tmp9 = tmp[tmp7(undefined, 7541).ContentHarmTypeChannel.GUILD];
    }
    ...
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 7541).ContentHarmTypeChannel.FRIEND_DM];
    }
    ...
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 7541).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
...
obj3[obj.GORE] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    if (arg0 == null) {
      ...
      const obj = {};
      obj[ExplicitMediaRedactionModels.ContentHarmTypeChannel.GUILD] = goreContentGuilds;
      const GoreContentSettings = tmp12(2023).GoreContentSettings;
      ...
      obj[ExplicitMediaRedactionModels.ContentHarmTypeChannel.FRIEND_DM] = goreContentFriendDm;
      const GoreContentSettings2 = tmp12(2023).GoreContentSettings;
