...
// Dependencies: [32, 19, 17, 5005, 21, 4790, 580, 558, 568, 7217, 5006, 7328, 5768, 5854, 4786, 7329, 7332, 7333, 1119, 7334, 2]

// Module 7327 (CountryCallingCodeSelect)
...
const getI18NCountryName = fn(5005).getI18NCountryName;
const jsxProd = fn(21);
