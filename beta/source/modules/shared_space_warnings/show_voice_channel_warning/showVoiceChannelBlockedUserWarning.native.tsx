...
// Dependencies: [1983, 14042, 14045, 1098, 4757, 14048, 1984, 1253, 2]
// Exports: showVoiceChannelBlockedUserWarning

// Module 14047 (showVoiceChannelBlockedUserWarning)
...
const constants = fn(14045).VoiceChannelWarningSurfaces;
const size = fn(2);
...
export const showVoiceChannelBlockedUserWarning = function showVoiceChannelBlockedUserWarning(channelId, items1) {
  ...
  if (state === ConstantsIOS.AppStates.ACTIVE) {
    ...
    obj.openLazy(tmp2(1984)(14048, dependencyMap.paths), "gdm_blocked_user_action_sheet", obj2);
    const tmp11 = tmp2(1984)(14048, dependencyMap.paths);
  } else {
    React4();
  }
};
