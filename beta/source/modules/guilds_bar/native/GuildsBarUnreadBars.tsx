...
// Dependencies: [32, 19, 17, 7872, 4577, 5655, 16621, 15365, 21, 4756, 7317, 1612, 15358, 15367, 551, 558, 504, 4492, 16695, 2]

// Module 16694 (GuildsBarUnreadBars)
      ...
      if (tmp4.type === FastList.FastListItemTypes.ITEM) {
        if (tmp4.layoutStart > diff) {
          ...
          if (0 !== tmp4.layoutSize) {
            ...
            let type = tmp4.type;
            if (tmp41(7317).FastListItemTypes.SECTION === type) {
              ...
              if (tmp41(7317).FastListItemTypes.ITEM === type) {
...
let closure_17 = { beforeItem: "paths", afterItem: "scales" };
