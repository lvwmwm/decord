...
// Dependencies: [5, 19, 17, 2067, 5689, 16636, 16633, 4529, 551, 4758, 4642, 12, 1235, 1119, 7351, 16371, 4494, 580, 4415, 11329, 1252, 5771, 9502, 8215, 1368, 1616, 5205, 16637, 16638, 15365, 6923, 2]
// Exports: default

// Module 16635 (useGuildsBarGesture)
    ...
    if (tmp7 !== tmp8Result) {
        ...
        if ("convert-after" !== overState2) {
          if ("drop-into" === overState2) {
            ...
            if (overNode.type === GuildsNodeType.FOLDER) {
              ...
              formatToPlainStringResult = intl6.formatToPlainString(tmp18(1119).t.uLDoxR, obj3);
            }
            ...
            if (GuildsNodeType.GUILD === type2) {
              ...
              if (name5 == null) {
                ...
                name5 = intl5.string(tmp18(1119).t.fKYRlM);
              }
              let tmp26 = name5;
              ...
              if (name2 == null) {
                ...
                name2 = intl4.string(tmp18(1119).t.ebAnWE);
              }
              tmp26 = name2;
            }
            const obj4 = { itemName: tmp26 };
            formatToPlainStringResult1 = intl3.formatToPlainString(tmp18(1119).t["A5aDw+"], obj4);
          } else if ("after" === overState2) {
            const intl14 = tmp18(1119).intl;
            ...
            if (GuildsNodeType.GUILD === type5) {
              ...
              if (name6 == null) {
                ...
                name6 = intl2.string(tmp18(1119).t.fKYRlM);
              }
              let tmp20 = name6;
              ...
              if (name == null) {
                ...
                name = intl.string(tmp18(1119).t.ebAnWE);
              }
              tmp20 = name;
            }
            const obj = { itemName: tmp20 };
            formatToPlainStringResult1 = intl14.formatToPlainString(tmp18(1119).t.w8FN92, obj);
          }
      ...
      if (GuildsNodeType.GUILD === type3) {
        ...
        if (name3 == null) {
          ...
          name3 = intl8.string(tmp18(1119).t.ebAnWE);
        }
        tmp33 = name3;
      }
    ...
    if (item.section >= GUILDS) {
      ...
      if (null != GUILDS) {
        ...
        if (FastList.FastListItemTypes.SECTION !== type) {
          if (tmp9(7351).FastListItemTypes.ITEM === type) {
...
let closure_16 = debounce(fn(4758).triggerHapticFeedback, 16);
...
export default function useGuildsBarGesture() {
  ...
  W.__closure = { gestureState_0: gestureState, pushScrollAccumulatedTime: sharedValue1, MS_PER_FRAME_60FPS: frameCallback, pushScroll: sharedValue, scrollTo: gesture(token[7]).scrollTo, scrollerRef, roundToNearestPixel: require("roundToNearestPixel"), scrollPosition_0: scrollPosition };
  ...
  handleGestureEnd = fastListRef.useCallback((event) => {
      ...
      if (null != overSpecs) {
        if (null != dragSpecs) {
          ...
          if (FastList.FastListItemTypes.SECTION === type2) {
            ...
            if (tmp34(7351).FastListItemTypes.SECTION === type) {
              let str = "before";
              let str2 = "before";
    ...
    state1.setStateShallow({ dragSpecs: "state", overSpecs: "toCharArray$esjava$1" });
        ...
        if (tmp10Result4.getIsScreenReaderEnabled()) {
          ...
          if (scrollPosition.GUILD === type) {
            ...
            if (items.length > 0) {
              ...
              size.state = tmp12;
              size.dividerIndexes = [];
              size.requestClose = function requestClose(arg0) {
                if (!arg0) {
  ...
  const callback4 = fastListRef.useCallback((arg0) => {
    ...
    if (null != obj2) {
      ...
      if (id !== id1) {
        const ContextMenuStore = tmp66(8215).ContextMenuStore;
        if (null != ContextMenuStore.getState().menu) {
          tmp66(8215).hideContextMenu();
          const tmp66Result = tmp66(8215);
        }
        node2 = node;
            ...
            if (null != node3) {
              if (null != node2) {
                ...
                if (node3.id !== node2.id) {
                  ...
                  if (tmp66(7351).FastListItemTypes.SECTION === type2) {
                    let type = item2.type;
                    if (tmp66(7351).FastListItemTypes.SECTION === type) {
                      const str5 = "self";
  ...
  const gesture1 = fastListRef.useMemo(() => {
    ...
    __closure = { scrollPosition_0: scrollPosition, gestureState_0: gestureState, dragRegion_0: dragRegion, runOnJS: ReanimatedRexport2.runOnJS, handleTouchesDown: callback1 };
    ...
    fn6.__closure = { gestureState_0: gestureState, dragDropInProgress_0: dragDropInProgress, DRAG_GESTURE_MINIMUM_DISTANCE: 10, runOnJS: ReanimatedRexport2.runOnJS, handleContextMenuDrag: callback3, handleGuildDrag: callback4 };
    fn6.__workletHash = 14446965742992;
    fn6.__initData = __initData9;
    let obj5 = { gestureState_0: gestureState, dragDropInProgress_0: dragDropInProgress, DRAG_GESTURE_MINIMUM_DISTANCE: 10, runOnJS: ReanimatedRexport2.runOnJS, handleContextMenuDrag: callback3, handleGuildDrag: callback4 };
    ...
    fn7.__closure = { gestureState_0: gestureState, listInsets_0: listInsets, GESTURE_ACCELERATION_RANGE, windowSize_0: windowSize, runOnJS: ReanimatedRexport2.runOnJS, handleGuildDrag: callback4, handleContextMenuDrag: callback3 };
    fn7.__workletHash = 17459732592512;
    fn7.__initData = __initData8;
    const obj6 = { gestureState_0: gestureState, listInsets_0: listInsets, GESTURE_ACCELERATION_RANGE, windowSize_0: windowSize, runOnJS: ReanimatedRexport2.runOnJS, handleGuildDrag: callback4, handleContextMenuDrag: callback3 };
