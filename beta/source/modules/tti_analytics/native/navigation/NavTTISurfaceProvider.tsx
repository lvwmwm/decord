...
// Dependencies: [109, 19, 17, 4757, 21, 558, 568, 16883, 16877, 16884, 16872, 16880, 504, 16878, 2]

// Module 17095 (NavTTISurfaceProvider)
import c from "c" /* 568 */;
...
let closure_14 = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[3] === descendantTracking) {
    if (cResult[4] === name) {
      ...
      const navigationTTIRegionHierarchy = tmp(16883).useNavigationTTIRegionHierarchy(tmp10);
      ...
      if (cResult[7] === tmp4) {
        ...
        const tmp18 = closure_1_11(tmp(16884).NavigationTTIRegionDebugOverlay, obj3);
      ...
      const tmp15 = closure_1_11(tmp(16883).NavigationTTIRegionHierarchyContext.Provider, obj4);
      cResult[7] = tmp4;
...
export const NavTTISurfaceProvider = ReactCompilerGating.isReactCompilerEnabled() ? ((definition) => {
  ...
  if (cResult[8] === Symbol.for("react.memo_cache_sentinel")) {
    const result = tmp(16872).isNavigationTTIEnabled();
    cResult[8] = result;
    let tmp14 = result;
    const tmpResult = tmp(16872);
  } else {
    tmp14 = cResult[8];
  }
  dependencyMap = tmp14;
                ...
                if (cResult[24] === tmp6) {
                  if (cResult[25] === tmp9) {
                    if (cResult[26] === stateFromStores) {
                      ...
                      tmp35[0] = tmp21;
                      tmp35[1] = cResult[27];
                      const tmp36 = closure_11(tmp(16878).NavTTISurfaceContext.Provider, tmp35);
