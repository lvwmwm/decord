...
// Dependencies: [7794, 7793, 1975, 7795, 7796, 5730, 9057, 1078, 1977, 2]
// Exports: isCollectiblesWishlistItemRecord

// Module 9058 (CollectiblesWishlistItemRecord)
...
let closure_3 = fn(7793).transformSKUToCollectiblesItem;
