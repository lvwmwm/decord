...
// Dependencies: [19, 9311, 9312, 9313, 21, 558, 568, 504, 17474, 17456, 17478, 9567, 16970, 2]

// Module 17477 (FramePanelFocusedView)
import FramesActionCreatorsDefault from "FramesActionCreators" /* 9567 */;
import FrameViewDefault from "FrameView" /* 16970 */;
import ActivityPanelFocusedView from "ActivityPanelFocusedView" /* 17456 */;
import FramePanelStateContextDefault from "FramePanelStateContext" /* 17474 */;
import FramePanelHeaderDefault from "FramePanelHeader" /* 17478 */;
...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  const baseActivityPanelFocusedView = stateFromStores(17456).useBaseActivityPanelFocusedView(tmp8);
  ...
  if (cResult[6] === landscapeSafeAreasConfig) {
    ...
    const tmp22 = jsx(tmp(17456).BaseActivityPanelFocusedView, { transitionState, transitionCleanUp, updateActivityPanelModeToPIP: tmp15, hasActivity: tmp16, context: FramePanelStateContextDefault, header: tmp11, children: tmp17 });
    cResult[9] = tmp16;
    cResult[10] = tmp17;
