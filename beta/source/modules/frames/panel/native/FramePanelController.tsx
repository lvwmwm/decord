...
// Dependencies: [19, 4985, 9311, 9312, 9313, 21, 558, 568, 504, 9567, 17440, 17474, 2]

// Module 17473 (FramePanelController)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((children) => {
  ...
  const tmp13 = jsx(mainFrameId(17440).BaseActivityPanelController, { context: FramePanelStateContextDefault, orientationLockStateForApp, mode, hasConnectedActivity: null != mainFrameId, connectedActivityAppId, currentApp, updateActivityPanelMode: tmp10, children });
  cResult[5] = children;
  ...
  return jsx(mainFrameId(17440).BaseActivityPanelController, { context: FramePanelStateContextDefault, orientationLockStateForApp, mode, hasConnectedActivity: null != mainFrameId, connectedActivityAppId, currentApp, updateActivityPanelMode: callback, children: children.children });
});
