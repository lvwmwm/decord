...
// Dependencies: [2045, 504, 577, 4649, 4648, 4651, 2]
// Exports: getNavigationHistory, handleHistoryStoreNavigationChange

// Module 7604 (NavigationHistoryStore)
  ...
  if (null != rootNavigationRef) {
    ...
    if (null != currentRoute) {
      if (null != currentRoute.params) {
        const coerceChannelRouteResult = tmp(4648).coerceChannelRoute(currentRoute);
        if (null == coerceChannelRouteResult) {
          const coerceGuildsRouteResult = tmp(4648).coerceGuildsRoute(currentRoute);
