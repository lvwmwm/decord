...
// Dependencies: [2045, 504, 577, 4617, 4616, 4619, 2]
// Exports: getNavigationHistory, handleHistoryStoreNavigationChange

// Module 7572 (NavigationHistoryStore)
  ...
  if (null != rootNavigationRef) {
    ...
    if (null != currentRoute) {
      if (null != currentRoute.params) {
        const coerceChannelRouteResult = tmp(4616).coerceChannelRoute(currentRoute);
        if (null == coerceChannelRouteResult) {
          const coerceGuildsRouteResult = tmp(4616).coerceGuildsRoute(currentRoute);
