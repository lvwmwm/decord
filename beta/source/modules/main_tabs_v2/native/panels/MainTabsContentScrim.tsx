...
// Dependencies: [17, 21, 4790, 580, 558, 568, 4529, 2]

// Module 16880 (MainTabsContentScrim)
...
export const MainTabsContentScrim = ReactCompilerGating.isReactCompilerEnabled() ? ((translateX) => {
  ...
  const obj2 = translateX(4529);
  fn.__closure = { interpolate: translateX(4529).interpolate, translateX, maxWidth, Extrapolation: translateX(4529).Extrapolation };
  ...
  obj4.style = items;
  const tmp6 = jsx(maxWidth(4529).View, { style: null, pointerEvents: "none" });
  ...
  obj3.style = items;
  return jsx(maxWidth(4529).View, { style: null, pointerEvents: "none" });
});
