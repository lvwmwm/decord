...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[0] !== users) {
    ...
    if (cResult[3] !== cResult[1]) {
      ...
      const tmp13 = React3(tmp(14460).AvatarDuoPile, obj2);
      cResult[3] = tmp6;
      cResult[4] = tmp13;
      let tmp11 = tmp13;
    } else {
      ...
      if (cResult[10] === tmp4.labelContainer) {
        if (cResult[11] === tmp11) {
          ...
          if (cResult[14] === Symbol.for("react.memo_cache_sentinel")) {
            const tmp26 = React3(tmp(5822).TableRow.Arrow, {});
            cResult[14] = tmp26;
            let tmp24 = tmp26;
          } else {
            tmp24 = cResult[14];
          ...
          const tmp29 = React3(tmp(5822).TableRow, obj4);
          cResult[15] = onPress;
          cResult[16] = tmp19;
          cResult[17] = tmp29;
          tmp27 = tmp29;
    ...
    const tmp18 = React3(tmp(4754).Text, obj6);
