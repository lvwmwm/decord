...
// Dependencies: [19, 17, 21, 4529, 4790, 580, 558, 568, 16393, 4791, 5219, 1181, 16797, 1119, 5220, 2]

// Module 16796 (ContactSuggestionActions)
...
obj.easing = Easing.in(fn(4529).Easing.quad);
let obj2 = { duration: 250, easing: null };
const Easing2 = fn(4529).Easing;
obj2.easing = Easing2.in(fn(4529).Easing.quad);
let obj3 = { duration: 250, easing: null };
const Easing3 = fn(4529).Easing;
obj3.easing = Easing3.in(fn(4529).Easing.quad);
let obj4 = { duration: 250, easing: null };
const Easing4 = fn(4529).Easing;
obj4.easing = Easing4.out(fn(4529).Easing.quad);
