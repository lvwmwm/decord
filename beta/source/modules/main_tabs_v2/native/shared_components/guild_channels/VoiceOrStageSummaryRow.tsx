...
// Dependencies: [19, 17, 21, 4790, 580, 558, 568, 12250, 4786, 1181, 17142, 2]

// Module 17141 (guild_channels/VoiceOrStageSummaryRow)
...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (tmp8Result) {
    ...
    obj5.style = items3;
    let obj6 = { size: tmp(tmp2[9]).Icon.Sizes.CUSTOM, style: { height: 14, width: 14 }, source: require("module_17142") };
