...
// Function ID: 12216
// Name: CozyDrawer
// Dependencies: [12216, 12217, 580, 1181, 5799, 7419, 2]

// Module 12215 (CozyDrawer)
import nativeDefault from "native" /* 580 */;
import "deepmerge";
import deepmerge from "deepmerge" /* 12216 */;
...
obj.icon = { avatarSize: fn(1181).AvatarSizes.NORMAL, guildIconSize: fn(5799).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5799).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj4 = { avatarSize: fn(1181).AvatarSizes.NORMAL, guildIconSize: fn(5799).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5799).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
obj5.icon = { size: fn(1181).IconSizes.REFRESH_SMALL_16, gameSize: fn(7419).GameIconSizes.SMALL };
...
const obj6 = { size: fn(1181).IconSizes.REFRESH_SMALL_16, gameSize: fn(7419).GameIconSizes.SMALL };
...
const importDefaultResultResult = deepmerge(fn(12217).CHANNEL_LIST_STYLES_COMPACT, obj);
...
export const CHANNEL_LIST_STYLES_COZY_DRAWER_SMOL = deepmerge(fn(12217).CHANNEL_LIST_STYLES_COMPACT, obj9);
