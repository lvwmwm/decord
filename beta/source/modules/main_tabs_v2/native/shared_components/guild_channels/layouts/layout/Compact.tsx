...
// Function ID: 12254
// Name: Compact
// Dependencies: [580, 1181, 5831, 7451, 12252, 2]
// Exports: getCompactStyles

// Module 12253 (Compact)
import nativeDefault from "native" /* 580 */;
import deepmergeDefault from "deepmerge" /* 12252 */;
...
CHANNEL_LIST_STYLES_COMPACT.icon = { avatarSize: fn(1181).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5831).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5831).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
const obj5 = { avatarSize: fn(1181).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5831).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5831).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
obj7.icon = { size: fn(1181).IconSizes.EXTRA_SMALL, gameSize: fn(7451).GameIconSizes.SIZE_24 };
...
const obj8 = { size: fn(1181).IconSizes.EXTRA_SMALL, gameSize: fn(7451).GameIconSizes.SIZE_24 };
const size = fn(2);
