...
// Dependencies: [19, 1483, 21, 4756, 4723, 7763, 1177, 12421, 1115, 12419, 12439, 11839, 12420, 5822, 2]
// Exports: default

// Module 12438 (AppLauncherUserListActionSheet)
...
function EmptyStateWithSnowflakeQuery(onPressRow) {
  ...
  obj.data = items;
  return jsx(onPressRow(12420).AppLauncherList, {
    contentContainerStyle: closure_6().emptyState,
    data: null,
    renderItem(label) {
      return jsx(TableRow.TableRow, { label: label.item, start: true, end: true, onPress: onPressRow });
