...
// Dependencies: [5, 32, 19, 17, 9164, 2006, 1078, 21, 580, 4790, 558, 568, 4786, 11505, 12223, 12317, 7802, 12217, 9433, 1119, 1245, 9551, 5220, 4803, 11678, 9629, 7441, 7461, 11329, 5376, 504, 5849, 7478, 11679, 6878, 7447, 12318, 12319, 12320, 1181, 12260, 9432, 5341, 12322, 2]

// Module 12316 (ActivityDetailContent)
import c from "c" /* 568 */;
...
import DeveloperActivityShelfActionCreatorsAll from "DeveloperActivityShelfActionCreators" /* 11679 */;
...
let closure_18 = ReactCompilerGating.isReactCompilerEnabled() ? ((botUserId) => {
  ...
  if (cResult[0] === analyticsLocations) {
    if (cResult[1] === applicationId) {
      ...
      const tmp12 = closure_11(tmp(5220).Button, obj2);
      cResult[5] = tmp5;
      cResult[6] = tmp6;
      cResult[7] = str;
      cResult[8] = tmp12;
  ...
  _require = asyncGeneratorStep(async (arg0, value) => {
    applicationId(1245).track(constants.APP_DETAIL_PAGE_ENTRY_POINT_COMMAND_BUTTON_CLICKED, { application_id: tmp3, button_action: recipientIds(9551).EntryPointCommandButtonActions.OPEN_APP_DM });
    const _setTimeout = setTimeout;
    ref.current = setTimeout(() => {
      v0(true);
    }, 250);
    let v0 = 1;
    await applicationId(4803).openPrivateChannel({ recipientIds });
    if (1 === tmp7) {
      v0 = 0;
      ...
      if (arg0 === 1) {
        ...
        closure_128_0 = value;
        c5 = 1;
        return { value: applicationId(11678)({ targetApplicationId: tmp3, channelId: closure_128_0, analyticsLocations }), done: false };
      }
    } else if (arg0 === 1) {
      c5 = 3;
      throw value;
  ...
  const callback = noop.useCallback(asyncGeneratorStep(async (arg0, value) => {
    tmp3(1245).track(constants.APP_DETAIL_PAGE_ENTRY_POINT_COMMAND_BUTTON_CLICKED, { application_id: applicationId, button_action: botUserId(9551).EntryPointCommandButtonActions.OPEN_APP_DM });
    const _setTimeout = setTimeout;
    closure_4.current = setTimeout(() => {
      dependencyMap(true);
    }, 250);
    await tmp3(4803).openPrivateChannel({ recipientIds: botUserId });
    if (1 === tmp7) {
      dependencyMap = 0;
      const _clearTimeout = clearTimeout;
      ...
      if (arg0 === 1) {
        ...
        c4 = 3;
        c5 = 1;
        return { value: tmp3(11678)({ targetApplicationId: closure_129_1, channelId: closure_128_0, analyticsLocations: closure_129_2 }), done: false };
      }
    } else if (arg0 === 1) {
      c5 = 3;
      throw value;
  ...
  return closure_11(botUserId(5220).Button, obj);
});
ReactCompilerGating = fn(558);
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((application) => {
  ...
  const width = application(11505).useRequiredAppLauncherContext().width;
  const obj2 = application(11505);
  const getPrimaryAppCommand = application(9629).useGetPrimaryAppCommand(context, application.id);
  const obj3 = application(9629);
  ...
  const isScreenLandscape = application(5376).useIsScreenLandscape();
  entrypoint !== application(9551).AppLauncherEntrypoint.VOICE && isScreenLandscape;
  ...
  const tmpResult = application(5376);
  ...
  if (tmpResult4.isRealApplication(application)) {
    ...
    if (isDeveloperOfThisApp) {
      ...
      obj4.marginBottom = 0;
      obj5.style = obj4;
      const items1 = [closure_11(tmp(5849).TableRowDivider, {}), , ];
      ...
      items1[1] = closure_11(tmp(7478).TableSwitchRow, obj6);
      ...
      if (useActivityUrlOverride) {
        ...
        const obj7 = { placeholder: "e.g. http://192.168.1.1:3000", value: activityUrlOverride, onChange: tmp26(11679).setActivityUrlOverride };
        tmp28[1] = tmp25(tmp(6878).TextInput, obj7);
  ...
  const tmp = closure_15();
  const width = application(11505).useRequiredAppLauncherContext().width;
  let obj = application(11505);
  const getPrimaryAppCommand = application(9629).useGetPrimaryAppCommand(context, application.id);
  const obj2 = application(9629);
  const analyticsLocations = useAnalyticsLocationsDefault(AnalyticsLocationDefault.APP_DETAIL).analyticsLocations;
  ...
  const tmp7 = _slicedToArray(noop.useState(undefined), 2);
  const isScreenLandscape = application(5376).useIsScreenLandscape();
  let detailsContainerLandscape = entrypoint !== application(9551).AppLauncherEntrypoint.VOICE && isScreenLandscape;
  const obj3 = application(5376);
  const items = [DeveloperActivityShelfStore];
  ...
  if (tmp2Result7.isRealApplication(application)) {
    ...
    if (isDeveloperOfThisApp) {
      ...
      obj5.style = obj4;
      const items1 = [closure_11(tmp2(5849).TableRowDivider, {}), , ];
      const obj6 = { label: null, value: null, onValueChange: null, end: true };
      let intl = tmp2(1119).intl;
      obj6.label = intl.string(tmp2(1119).t["3TSGuD"]);
      obj6.value = useActivityUrlOverride;
      obj6.onValueChange = DeveloperActivityShelfActionCreatorsAll.toggleUseActivityUrlOverride;
      items1[1] = closure_11(tmp2(7478).TableSwitchRow, obj6);
      let tmp22Result = null;
      if (useActivityUrlOverride) {
        const obj7 = { style: tmp.activityUrlOverrideInputContainer, children: null };
        const obj8 = { placeholder: "e.g. http://192.168.1.1:3000", value: activityUrlOverride, onChange: tmp23(11679).setActivityUrlOverride };
        obj7.children = tmp22(tmp2(6878).TextInput, obj8);
    ...
    const getOrFetchApplication = tmp2(7447).useGetOrFetchApplication(application.id);
    let bot;
    if (getOrFetchApplication != null) {
      bot = getOrFetchApplication.bot;
    }
    const tmp2Result8 = tmp2(7447);
    const obj9 = { context, applicationId: application.id };
    const activityAction = tmp2(12223).useActivityAction(obj9);
    const tmp2Result9 = tmp2(12223);
    const delayedSwapToActivityActionLeave = tmp2(12318).useDelayedSwapToActivityActionLeave(activityAction);
    const obj10 = { context, application, activityAction: delayedSwapToActivityActionLeave };
    const tmp2Result10 = tmp2(12318);
    ({ reason, disabled } = tmp5(12319)(obj10));
    ...
    if (null != getPrimaryAppCommand) {
      ...
      if (tmp39Result2) {
        ...
        tmp39Result2 = tmp39(tmp2(4786).Text, obj17);
      }
      ...
      if (isDeveloperOfThisApp) {
        isDeveloperOfThisApp = tmp2(9433).isEmbeddedApp(application);
        const tmp2Result11 = tmp2(9433);
      }
      if (isDeveloperOfThisApp) {
    ...
    let result = width;
    const tmp29 = tmp5(12319)(obj10);
    if (detailsContainerLandscape) {
      result = 65 * width / 100;
    }
    obj25.width = result;
    obj25.contentWidth = tmp8;
    obj24.children = closure_11(tmp5(12260), obj25);
    ...
    const items7 = [closure_11(tmp5(9432), obj27), , , , ];
    ...
    obj29.icon = closure_11(tmp2(5341).GroupIcon, obj30);
    const tmp52 = closure_16;
    const tmp5Result3 = tmp5(12260);
    let num5 = num;
    if (num == null) {
      num5 = 0;
    }
    obj29.tagName = tmp2(12322).getItemSubtitleForMaxPlayersShort(num5);
    const tmp2Result12 = tmp2(12322);
    if (num == null) {
      num = 0;
    }
    obj29.accessibilityLabel = tmp5(12322)(num);
    ...
    return closure_11(tmp2(7441).AnalyticsLocationProvider, obj20);
  } else {
    const _Error = Error;
    const error = new Error("ActivityDetailContent was passed the Built-in App, which is not supported.");
    throw error;
  }
  tmp2Result7 = application(9433);
});
