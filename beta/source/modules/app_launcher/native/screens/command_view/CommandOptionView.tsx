...
// Dependencies: [19, 17, 4782, 21, 1982, 4790, 580, 558, 568, 504, 4529, 12337, 4786, 12338, 1181, 10746, 12345, 2]

// Module 12336 (CommandOptionView)
import nativeDefault from "native" /* 580 */;
import ReanimatedRexportDefault from "ReanimatedRexport" /* 4529 */;
import AppLauncherCommandOptionDefault from "AppLauncherCommandOption" /* 12338 */;
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((onPressAttachmentOption) => {
  ...
  if (set.has(option.type)) {
    ...
    const obj5 = {
      ...
      exiting: tmp2(12337).ExitingAnimation,
      layout: tmp2(12337).LayoutAnimation,
      onLayout(arg0) {
    ...
    if (hasItem1) {
      ...
      tmp17Result = tmp17(tmp2(4786).Text, obj7);
    }
    ...
    items2[2] = closure_5(tmp2(4786).Text, obj9);
    if (hasItem) {
      ...
      const obj11 = { style: tmp.optionErrorIcon, source: tmp18(10746), size: tmp2(1181).IconSizes.REFRESH_SMALL_16 };
      ...
      items3[1] = tmp17(tmp2(4786).Text, obj12);
      obj10.children = items3;
      hasItem = tmp19(tmp18(4529).View, obj10);
    }
    items2[3] = hasItem;
    obj6.children = items2;
    obj5.children = closure_6(View, obj6);
    obj4.children = closure_5(ReanimatedRexportDefault.View, obj5);
    obj3.children = closure_5(tmp2(12345).AwaitAnimationContext, obj4);
    return closure_5(tmp2(4529).LayoutAnimationConfig, obj3);
  } else {
    return null;
  }
  const tmp2Result = option(12337);
});
