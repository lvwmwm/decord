...
// Dependencies: [19, 17, 5669, 2049, 2045, 2100, 4814, 12249, 2052, 7813, 21, 16537, 16539, 16543, 580, 7351, 7807, 16454, 1119, 12479, 16532, 16544, 16476, 5225, 16546, 16548, 16550, 16554, 16556, 16557, 16558, 16559, 16560, 16563, 16565, 16566, 16570, 16462, 1099, 16574, 16575, 16585, 16587, 16589, 2070, 16469, 5676, 16467, 16590, 2]
...
// Module 16538 (renderRedesignChannelListItem)
...
import CategoryChannel from "CategoryChannel" /* 16454 */;
import ThreadChannelDefault from "ThreadChannel" /* 16462 */;
import VoiceUserSummary from "VoiceUserSummary" /* 16476 */;
import channel_list_v2_ChannelListUtils from "channel_list_v2/ChannelListUtils" /* 16532 */;
import ShowAllVoiceChannelsButtonDefault from "ShowAllVoiceChannelsButton" /* 16544 */;
...
const GuildSidebarConstants = fn(7813);
({ ChannelListChannelNoticeRow: closure_16, ChannelListGuildActionRow: closure_17 } = GuildSidebarConstants);
const jsxProd = fn(21);
({ jsx: closure_18, jsxs: closure_19, Fragment: closure_20 } = jsxProd);
let obj = { nonChannelContainer: { marginHorizontal: 16 }, liveChannelNotice: { marginTop: fn(16537).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(16537).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 }, gameClaimNotice: null, applicationAccountLinkNotice: null, showAllVoiceChannelsButtonLastShownChannelActive: null, showAllVoiceChannelsButtonLastShownChannelInactive: null };
let obj2 = { marginTop: fn(16537).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(16537).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
obj.gameClaimNotice = { marginTop: fn(16539).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(16539).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj3 = { marginTop: fn(16539).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(16539).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
obj.applicationAccountLinkNotice = { marginTop: fn(16543).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16543).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj4 = { marginTop: fn(16543).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16543).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
...
export const getFastListRecyclerKey = function getFastListRecyclerKey(guildChannels, arg1, arg2, arg3) {
  ...
  } else if (arg1 === tmp(7351).FastListItemTypes.SECTION) {
  ...
  if (guildChannels.favoritesSectionNumber === section) {
    ...
    if (obj.isNamedCategorySection(section)) {
      ...
      if (null != namedCategoryFromSection) {
        ...
        tmp5 = collapsedCategories(tmp(16454).CategoryChannel, obj8);
      }
      return tmp5;
    } else {
      return null;
...
export const renderChannelListSectionFooter = function renderChannelListSectionFooter(guildChannels, section, ref, channels) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return null;
  } else if (tmp5(7807).SECTION_INDEX_GUILD_ACTIONS === section) {
    const guildActionSection = guildChannels.getGuildActionSection();
    let flag = false;
...
export const getChannelListSectionFooterSize = function getChannelListSectionFooterSize(guildChannels, section, result) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    return 0;
  } else if (tmp3(7807).SECTION_INDEX_GUILD_ACTIONS === section) {
    const guildActionSection = guildChannels.getGuildActionSection();
    let flag = false;
    if (!guildActionSection.isEmpty()) {
      const rows = guildActionSection.getRows();
    ...
    let num5 = 0;
    if (flag) {
      num5 = tmp3(12479).DIVIDER_HEIGHT;
    }
    return num5;
  } else {
    if (guildChannels.favoritesSectionNumber !== section) {
      if (guildChannels.recentsSectionNumber !== section) {
        if (guildChannels.voiceChannelsSectionNumber === section) {
          ...
          if (!obj.render) {
            ...
            const sum = num + tmp3(5225).SMALL_BUTTON_HEIGHT;
            if (tmp6) {
    ...
    return tmp3(12479).DIVIDER_HEIGHT;
  }
};
export const renderChannelListItem = function renderChannelListItem(arg0) {
  ...
  if (channel(7807).SECTION_INDEX_CHANNEL_NOTICES === section) {
    const channelNoticeSection = guildChannels.getChannelNoticeSection();
    ...
    if (null != row1) {
      if (constants.SPACER === row1) {
        ...
        const obj5 = { guild };
        obj4.children = closure_18(selectedChannelId(16546), obj5);
        tmp65 = closure_18(View, obj4);
      } else if (tmp66.MFA_WARNING === row1) {
        const obj6 = { style: obj.nonChannelContainer, children: closure_18(selectedChannelId(16548), {}) };
        tmp65 = closure_18(View, obj6);
      } else if (tmp66.LIVE_CHANNEL_NOTICE === row1) {
        const obj7 = { style: obj.liveChannelNotice, guild };
        tmp65 = closure_18(selectedChannelId(16537), obj7);
        ...
        if (null != gameClaimMarkAsDismissed) {
          ...
          obj9.children = closure_18(selectedChannelId(16539), obj10);
        ...
        if (null != applicationAccountLinkMarkAsDismissed) {
          ...
          if (null != startApplicationAccountLinkAuthorization) {
            ...
            if (null != accountLinkApplication) {
              ...
              obj11.children = closure_18(selectedChannelId(16543), obj12);
        ...
        if (tmp66.FAVORITES_SUGGESTIONS === row1) {
          tmp65 = closure_18(selectedChannelId(16550), {});
        }
      }
    }
    return tmp65;
  } else if (tmp(7807).SECTION_INDEX_GUILD_ACTIONS === section) {
    const guildActionSection = guildChannels.getGuildActionSection();
    ...
    if (null != row2) {
      if (constants2.GUILD_ROLE_SUBSCRIPTIONS === row2) {
        ...
        tmp55Result = closure_18(selectedChannelId(16554), obj13);
      } else if (tmp32.GUILD_HOME === row2) {
        const obj14 = { guild, selected: selectedChannelId === StaticChannelRoute.GUILD_HOME };
        tmp55Result = closure_18(selectedChannelId(16556), obj14);
        ...
        tmp55Result = closure_18(tmp(16557).GuildRolesAndChannelsRow, obj15);
        ...
        tmp55Result = closure_18(selectedChannelId(16558), obj16);
        ...
        obj18.children = closure_18(tmp(16559).NewMemberActionsProgress, obj19);
        const items = [closure_18(View, obj18), closure_18(selectedChannelId(12479), {})];
        obj17.children = items;
        tmp55Result = closure_19(View, obj17);
      } else if (tmp32.GUILD_HUB_HEADER_OPTIONS === row2) {
        const obj20 = { guild };
        tmp55Result = closure_18(selectedChannelId(16560), obj20);
...
export const getChannelListItemSize = function getChannelListItemSize(liveChannelNoticeHeight) {
  ...
  if (ChannelListState.SECTION_INDEX_CHANNEL_NOTICES === section) {
    ...
    if (constants.SPACER === row1) {
      ...
      return tmp(16546).getScaledGuildProgressButtonHeight(fontScale);
    } else if (tmp28.MFA_WARNING === row1) {
      return tmp(16548).getScaledGuildMFAWarningHeight(fontScale);
      ...
      return tmp(16539).getScaledGameClaimNoticeHeight(fontScale);
    } else if (tmp28.APPLICATION_ACCOUNT_LINK === row1) {
      return tmp(16543).getScaledAccountLinkBannerHeight(fontScale);
                ...
                if (tmp26.GUILD_BOOSTS !== row2) {
                  ...
                  if (tmp26.GUILD_VIBEGRATIONS !== row2) {
                    if (tmp26.GUILD_NEW_MEMBER_ACTIONS_PROGRESS_BAR === row2) {
                      num4 = 48 + tmp(12479).DIVIDER_HEIGHT;
                    } else {
                      ...
                      if (tmp26.GUILD_HUB_HEADER_OPTIONS !== row2) {
                        ...
                        if (tmp26.GUILD_SCHEDULED_EVENTS !== row2) {
                          if (tmp26.GUILD_PREMIUM_PROGRESS_BAR === row2) {
                            num4 = tmp(16570).BOOST_PROGRESS_BAR_HEIGHT + tmp(12479).DIVIDER_HEIGHT;
                          } else {
                            num4 = 0;
    ...
    if (null != channelFromSectionRow) {
      ...
      if (type1 === type) {
              ...
              if (tmp(1099).ChannelTypes.GROUP_DM !== type) {
                if (tmp(1099).ChannelTypes.PUBLIC_THREAD !== type) {
                  if (tmp(1099).ChannelTypes.PRIVATE_THREAD !== type) {
                    ...
                    tmpResult11 = tmp(2070);
                  }
                }
                const result = SortedVoiceStateStore.countVoiceStatesForChannel(record.id);
                let sum1 = tmp31;
                if (result > 0) {
                  sum1 = tmp31 + result * tmp(16469).getVoiceUserHeight(fontScale);
                  const tmpResult12 = tmp(16469);
                }
                num = sum1;
              }
            }
        ...
        const voiceUserHeight = tmp(16469).getVoiceUserHeight(fontScale);
        if (record.type === tmp(1099).ChannelTypes.GUILD_STAGE_VOICE) {
          let participantCount = StageChannelParticipantStore.getParticipantCount(record.id, tmp(5676).StageChannelParticipantNamedIndex.SPEAKER);
        } else {
        ...
        if (record.type === tmp(1099).ChannelTypes.GUILD_STAGE_VOICE) {
          num3 = 0;
          if (StageChannelParticipantStore.getParticipantCount(record.id, tmp(5676).StageChannelParticipantNamedIndex.AUDIENCE) > 0) {
            num3 = tmp(16467).getAudienceItemHeight(fontScale);
            const tmpResult14 = tmp(16467);
          }
        }
        let sum4 = tmp31;
        if (participantCount > 0) {
          const sum2 = tmp31 + num2;
          const sum3 = sum2 + tmp(16585).VOICE_USERS_MARGIN_TOP + voiceUserHeight * participantCount;
          sum4 = sum3 + tmp(16585).VOICE_USERS_MARGIN_BOTTOM + num3;
        }
        num = sum4;
        const tmpResult13 = tmp(16469);
      }
    }
    return num;
  }
...
export const calculateVoiceSummary = function calculateVoiceSummary(arg0) {
  ...
  if (!obj.isVoiceChannelsSection(section, guildChannels)) {
    if (section < tmp(7807).SECTION_INDEX_FIRST_NAMED_CATEGORY) {
      return null;
    }
  }
  obj = channel_list_v2_ChannelListUtils;
  if (tmpResult.getSectionFooterConfig(guildChannels, optInChannelsEnabled, section).canHaveVoiceSummary) {
    ...
    if (null == namedCategoryFromSection) {
      ...
      const sectionFooterActiveVoiceChannels = tmp(16590).getSectionFooterActiveVoiceChannels(obj2);
      let tmp5 = null;
