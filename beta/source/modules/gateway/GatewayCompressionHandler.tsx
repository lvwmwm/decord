...
// Dependencies: [17, 13952, 13954, 3, 1368, 13953, 5391, 2]
// Exports: getCompressionHandler

// Module 13951 (GatewayCompressionHandler)
import LoggerDefault from "Logger" /* 3 */;
import _mod17 from "module_17" /* 17 */;
import PlatformUtils from "PlatformUtils" /* 1368 */;
import ProcessArgs2 from "ProcessArgs" /* 5391 */;
import GatewayZstdUtils from "GatewayZstdUtils" /* 13952 */;
import NativeCompressionModule from "NativeCompressionModule" /* 13953 */;
...
const fn3 = () => {
  ...
  applyArgumentsResult._pako = _mod13954;
...
prototype5["bindWebSocket"] = function bindWebSocket(_socketId) {
  ...
  if (supportsZstdResult) {
    if (isAndroidResult) {
      const _default2 = tmp2(13953).default;
      if (_default2 != null) {
    ...
    const _default = tmp2(13953).default;
    if (_default != null) {
...
prototype5["close"] = function close() {
  ...
  if (null !== _socketId) {
    if (obj.isAndroid()) {
      const _default = tmp(13953).default;
      if (_default != null) {
