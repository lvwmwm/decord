...
// Dependencies: [5728, 4678, 2067, 5657, 1190, 7241, 1119, 2023, 2]
...
// Module 15118 (ActivityPrivacyUpsellUtils)
  ...
  if (setting === ACTIVITY_STATUS_OFF) {
    ...
    if (num >= 0) {
      if (num2 >= 0) {
        ...
        dependencyMap = tmp8(7241).getSanitizedActivityRestrictedGuilds();
