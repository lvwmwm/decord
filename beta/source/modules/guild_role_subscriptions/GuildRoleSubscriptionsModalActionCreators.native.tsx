...
// Dependencies: [18214, 4961, 18215, 1984, 18221, 2]
// Exports: showCreateBenefitModal, showEditBenefitModal, showEditEmojisModal

// Module 18213 (GuildRoleSubscriptionsModalActionCreators)
...
export const showCreateBenefitModal = function showCreateBenefitModal(arg0) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(18215, dependencyMap.paths), { benefitType: type, guildId, onSave, listingId }, GuildRoleSubscriptionBenefitEditorModal);
};
export const showEditBenefitModal = function showEditBenefitModal(benefit) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(18215, dependencyMap.paths), { benefitType: benefit.ref_type, guildId, onDelete, onSave, listingId }, GuildRoleSubscriptionBenefitEditorModal);
};
export const showEditEmojisModal = function showEditEmojisModal(initialTierEmojiIds) {
  ...
  obj2.onSave = onSave;
  obj.pushLazy(asyncRequireImpl(18221, dependencyMap.paths), obj2, "GuildRoleSubscriptionEmojiEditorModal");
};
