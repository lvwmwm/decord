...
// Dependencies: [19, 17, 21, 4790, 580, 558, 568, 1181, 12979, 4786, 1119, 2]

// Module 13611 (GuildRoleSubscriptionsChannelHeader)
import c from "c" /* 568 */;
...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] === Symbol.for("react.memo_cache_sentinel")) {
    const obj2 = { source: _modDef12979, size: tmp(1181).Icon.Sizes.MEDIUM, disableColor: true };
  ...
  if (cResult[1] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    obj3.children = intl.string(tmp(1119).t["KzCF/6"]);
  ...
  const items = [React4(native.Icon, { source: _modDef12979, size: native.Icon.Sizes.MEDIUM, disableColor: true }), ];
  const obj3 = { variant: "heading-lg/extrabold", color: "interactive-text-active", children: null };
