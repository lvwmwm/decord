...
// Dependencies: [19, 17, 21, 4758, 580, 558, 568, 1181, 12943, 4754, 1119, 2]

// Module 13575 (GuildRoleSubscriptionsChannelHeader)
import c from "c" /* 568 */;
...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] === Symbol.for("react.memo_cache_sentinel")) {
    const obj2 = { source: _modDef12943, size: tmp(1181).Icon.Sizes.MEDIUM, disableColor: true };
  ...
  const items = [React4(native.Icon, { source: _modDef12943, size: native.Icon.Sizes.MEDIUM, disableColor: true }), ];
  const obj3 = { variant: "heading-lg/extrabold", color: "interactive-text-active", children: null };
