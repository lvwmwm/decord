...
// Dependencies: [19, 17, 21, 4790, 558, 568, 18197, 5143, 1119, 4786, 18199, 11970, 18200, 2]

// Module 18196 (FormGuildGatingModeSelector)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((isFullServerGating) => {
  ...
  const roleSubscriptionSettingsDisabled = isFullServerGating(18197).useRoleSubscriptionSettingsDisabled();
    ...
    if (cResult[3] === onChange) {
      ...
      if (cResult[10] === tmp6) {
        if (cResult[11] === roleSubscriptionSettingsDisabled) {
          ...
          const obj6 = { icon: onChange(18200), title: tmp24, description: tmp25, selected: isFullServerGating, onPress: tmp7, disabled: roleSubscriptionSettingsDisabled };
          const tmp32 = closure_5(onChange(18199), obj6);
          cResult[18] = tmp7;
          cResult[19] = isFullServerGating;
          cResult[20] = roleSubscriptionSettingsDisabled;
          cResult[21] = tmp32;
          tmp28 = tmp32;
          const tmp31 = onChange(18199);
        }
      }
      const obj7 = { icon: onChange(11970), title: tmp10, description: tmp11, selected: !isFullServerGating, onPress: tmp6, disabled: roleSubscriptionSettingsDisabled };
      const tmp19 = closure_5(onChange(18199), obj7);
      cResult[10] = tmp6;
      cResult[11] = roleSubscriptionSettingsDisabled;
      cResult[12] = !isFullServerGating;
      cResult[13] = tmp19;
      tmp15 = tmp19;
      const tmp18 = onChange(18199);
    }
  }
  ...
  let obj = isFullServerGating(18197);
  obj3.icon = onChange(11970);
  ...
  const items2 = [closure_5(onChange(18199), obj3), closure_5(View, { style: tmp.space }), ];
  let obj5 = { icon: null, title: null, description: null, selected: null, onPress: null, disabled: null };
  let obj4 = { style: tmp.space };
  const tmp5 = onChange(18199);
  obj5.icon = onChange(18200);
  ...
  items2[2] = closure_5(onChange(18199), obj5);
