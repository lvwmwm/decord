...
// Dependencies: [19, 21, 4790, 580, 558, 568, 4786, 1181, 15491, 5373, 2]

// Module 15490 (NavigateForwardButton)
import c from "c" /* 568 */;
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[0] === tmp4.text) {
    ...
    if (cResult[3] === Symbol.for("react.memo_cache_sentinel")) {
      const obj2 = { source: _modDef15491 };
    ...
    obj3.children = items;
    const tmp14 = React4(tmp(5373).PressableHighlight, obj3);
    cResult[4] = onPress;
  ...
  const items = [React3(Text_Text.Text, { style: tmp.text, variant: "text-md/semibold", color: "interactive-text-active", children: text }), React3(native.Icon, { source: _modDef15491 })];
  obj.children = items;
