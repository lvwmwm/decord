...
// Dependencies: [5, 19, 17, 1224, 12763, 2067, 4612, 16015, 1078, 21, 4790, 580, 1275, 4384, 4688, 12687, 558, 568, 15895, 7478, 12693, 2028, 2031, 1616, 504, 4786, 5854, 5935, 2]

// Module 16014 (DevToolsGuildPowerupsScreen)
import c from "c" /* 568 */;
...
import GuildDismissibleContentUtils from "GuildDismissibleContentUtils" /* 12693 */;
    ...
    try {
      ...
      if (0 === c5) {
        if (arg0 === 1) {
          ...
          let addResult = null;
          if (!closure_2) {
            addResult = _modDef4384().add(1, "day");
...
const DevToolsGuildPowerupsConstants = fn(16015);
...
let closure_26 = ReactCompilerGating.isReactCompilerEnabled() ? ((dc) => {
  ...
  if (cResult[0] === dc) {
    ...
    const tmp10 = closure_18(dc(7478).TableSwitchRow, obj2);
    cResult[5] = tmp4;
  ...
  const fn = function t(arg0) {
    if (arg0) {
      const result = tmp(12693).markContentAsDismissed(dc, guildId, false);
      const tmpResult = tmp(12693);
    } else {
  ...
  return closure_18(dc(7478).TableSwitchRow, { label: closure_15(dc), value: dc.isDismissed, onValueChange: callback });
});
ReactCompilerGating = fn(558);
...
export default ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (null == stateFromStores) {
    ...
    obj5.style = items4;
    obj5.children = closure_18(tmp5(4786).Text, { variant: "heading-md/semibold", color: "text-muted", children: "No guild selected" });
    ...
    const items6 = [closure_18(tmp5(5935).TableRowGroup, obj8), , , , , , ];
    ...
    items6[3] = closure_18(tmp5(5935).TableRowGroup, obj14);
    ...
    items6[6] = closure_18(tmp5(5935).TableRowGroup, obj17);
