...
// Dependencies: [5, 19, 17, 1220, 12816, 2063, 4577, 16016, 1074, 21, 4756, 576, 1271, 4348, 4653, 12742, 15896, 7445, 12748, 2024, 2027, 1612, 504, 4752, 5904, 5822, 2]
// Exports: default
...
function GuildDCSwitchRow(dc) {
  ...
  const callback = noop.useCallback((arg0) => {
    if (arg0) {
      const result = tmp(12748).markContentAsDismissed(dc, guildId, false);
      const tmpResult = tmp(12748);
    } else {
