...
// Dependencies: [5, 32, 19, 17, 1376, 13044, 21, 4790, 580, 676, 1095, 4993, 1488, 504, 1119, 5871, 5378, 4490, 7270, 13046, 561, 13047, 9649, 7653, 5932, 5834, 1401, 5400, 5218, 4786, 5856, 11553, 5373, 1181, 5220, 6878, 5935, 5854, 4757, 13057, 1984, 5933, 7364, 1351, 13058, 10730, 558, 568, 7278, 2]

// Module 13045 (BugReporterModal)
import c from "c" /* 568 */;
  ...
  constructor(arg0) {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj5 = { value: tmp5(5400).launchImageLibraryAsync({ mediaType: "any", includeBase64: false, selectionLimit: 1 }), done: false };
              return obj5;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            if (null != closure_128_0) {
              ...
              obj6.platform = tmp2(5378).UploadPlatform.REACT_NATIVE;
              obj6.filename = closure_128_1.fileName;
              closure_128_2 = obj6;
              const tmp34 = new tmp5(5378)(closure_128_2);
              closure_128_3 = tmp34;
              closure_129_23.current = closure_129_7.length;
              closure_129_8((arg0) => {
                const items = [];
          ...
          try {
            ...
            if (0 === description) {
              if (arg0 === 1) {
                      ...
                      try {
                        ...
                        if (0 === c5) {
                          if (arg0 === 1) {
                            ...
                            const tmp66 = new closure_2_1(561)(closure_2_17, closure_2_18, true);
                            closure_131_3 = tmp66;
                            closure_131_4 = false;
                            closure_131_5 = 0;
                            if (closure_131_5 >= 20) {
                              if (closure_131_4) {
                                ...
                                const obj5 = { key: "BUG_REPORT_BUG_SUBMITTED", icon: closure_2_1(9649), content: null, toastDurationMs: null };
                                const intl2 = closure_2_0(1119).intl;
                                obj5.content = intl2.string(closure_2_0(1119).t.jB8yOL);
                                obj5.toastDurationMs = toastDurationMs;
                                closure_2_1(4490).open(obj5);
                                const obj6 = closure_2_1(4490);
                              } else {
                                const obj7 = { key: "BUG_REPORT_FAILED_TO_SUBMIT", icon: closure_2_1(7270), content: null };
                                const intl = closure_2_0(1119).intl;
                                obj7.content = intl.string(closure_2_0(1119).t["4t1o0u"]);
                                closure_2_1(4490).open(obj7);
                                const obj4 = closure_2_1(4490);
                              }
                              c6 = 3;
                            }
                          }
                        ...
                        c5 = 1;
                        c6 = 1;
                        const obj11 = { value: closure_2_0(13047).submitReport(closure_131_0, closure_131_1, closure_131_2), done: false };
                        return obj11;
                      } catch (tmp50) {
                        c6 = tmp;
                        throw tmp50;
                ...
                if (ref.current) {
                  if (first5) {
                    let obj5 = { key: "BUG_REPORT_SUBMITTING_BUG", icon: screenshot(7270), content: null, toastDurationMs: null };
                    let intl2 = handleSubmit(1119).intl;
                    obj5.content = intl2.string(handleSubmit(1119).t.Uuqbcm);
                    obj5.toastDurationMs = toastDurationMs;
                    screenshot(4490).open(obj5);
                    closure_1_16(true);
                    first8();
                    let obj9 = screenshot(4490);
                  }
                  priority = 3;
                } else {
                  callback(true);
                  if (null == priority) {
                    let obj7 = { key: "BUG_REPORT_FAILED_TO_SUBMIT", icon: screenshot(7270), content: null };
                    let intl = handleSubmit(1119).intl;
                    obj7.content = intl.string(handleSubmit(1119).t["4t1o0u"]);
                    screenshot(4490).open(obj7);
                    callback(false);
                    priority = 3;
                    ...
                    description = 1;
                    priority = 1;
                    let obj10 = { value: handleSubmit(13046).getAttachments(first3), done: false };
                    return obj10;
                  }
                }
              }
      ...
      navigation.setOptions({
        headerRight() {
          if (first5) {
            ...
            let stringResult = intl2.string(tmp2(1119).t["tUu8V+"]);
          } else {
    ...
    if (!stateFromStores) {
      ...
      obj34.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(13057, dependencyMap.paths), "BugReporterFeatureActionSheet", { features: null != first7 ? first7.features : [], feature: first8, setFeature });
      };
      if (null != first8) {
        name = first8.name;
      } else {
...
export default ReactCompilerGating.isReactCompilerEnabled() ? (function BugReportModal(arg0) {
  ...
  if (cResult[0] === screenshot) {
    ...
    if (cResult[3] !== tmp4) {
      ...
      const tmp7 = v65535(tmp(7278).Navigator, obj2);
      cResult[3] = tmp4;
      cResult[4] = tmp7;
      let tmp5 = tmp7;
    } else {
  ...
  const obj4 = { title: null, initialParams: null, render: null };
  ...
  return closure_10(screenshotUri(7278).Navigator, { screens, initialRouteName: "BUG_REPORT_CREATE" });
});
