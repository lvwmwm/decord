...
// Dependencies: [19, 17, 21, 4790, 580, 558, 568, 5333, 1119, 4786, 9013, 2]

// Module 9012 (ObscuredSurface)
import c from "c" /* 568 */;
...
const ImageWarningIcon = tmp(5333);
const ObscuredSurfaceContext = tmp(9013);
require = fn;
