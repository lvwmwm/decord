...
// Dependencies: [2045, 12487, 8126, 1078, 12507, 12488, 4938, 1259, 2023, 2]

// Module 12506 (search/tracking/Tracking)
...
require = fn;
let closure_5 = fn(8126).SEARCH_HISTORY_TO_ANALYTICS_SEARCH_HISTORY;
