...
// Dependencies: [19, 17, 7557, 12523, 8159, 21, 4790, 580, 558, 568, 12524, 565, 4529, 4791, 7330, 1368, 2]

// Module 17113 (SearchBarActivityIcon)
...
let closure_7 = fn(8159).SEARCH_MESSAGE_TAB_SENTINEL;
const jsxProd = fn(21);
