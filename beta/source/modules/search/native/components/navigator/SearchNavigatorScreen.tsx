...
// Dependencies: [19, 17, 21, 4790, 580, 558, 568, 17109, 4653, 17349, 1119, 5875, 5373, 5375, 17111, 17120, 16714, 2]

// Module 17348 (SearchNavigatorScreen)
import c from "c" /* 568 */;
...
import useSearchSuggestionsGesture from "useSearchSuggestionsGesture" /* 17109 */;
import SearchScreenSearchBarDefault from "SearchScreenSearchBar" /* 17111 */;
import SearchScreenLayoutDefault from "SearchScreenLayout" /* 17120 */;
import useSearchLayoutInsetTopDefault from "useSearchLayoutInsetTop" /* 17349 */;
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((navigation) => {
  ...
  if (cResult[1] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    const tmp12 = hasOwnProperty(tmp(5875).ArrowLargeLeftIcon, obj3);
    cResult[1] = tmp12;
    let tmp10 = tmp12;
  } else {
    tmp10 = cResult[1];
  ...
  if (cResult[2] === navigation.goBack) {
    ...
    if (cResult[5] === Symbol.for("react.memo_cache_sentinel")) {
      const tmp17 = hasOwnProperty(tmp6(5375), { absolute: true, wide: true, tall: true });
      cResult[5] = tmp17;
      let tmp15 = tmp17;
    } else {
      tmp15 = cResult[5];
    ...
    if (cResult[8] === tmp4.wrapper) {
        ...
        if (cResult[12] === dismissed) {
          if (cResult[13] === onLayoutMeasure) {
            if (cResult[14] === searchContext) {
                ...
                if (cResult[20] === tmp4.tabs) {
                  ...
                  if (cResult[23] === tmp20) {
                    if (cResult[24] === tmp26) {
                      ...
                      items[1] = hasOwnProperty(tmp(16714).NonCollapsableGestureDetector, obj6);
                      obj5.children = items;
              ...
              const tmp25 = hasOwnProperty(tmp6(17120), obj9);
      ...
      const tmp22 = hasOwnProperty(tmp6(17111), obj10);
      cResult[11] = tmp13;
  ...
  const tmp = closure_8();
  importDefault = tmp;
  const searchSuggestionsGesture = navigation(17109).useSearchSuggestionsGesture(searchContext);
  ({ gesture, dismissed, setDismissed, onLayoutMeasure } = searchSuggestionsGesture);
  const items = [navigation.goBack, tmp.back];
  let obj = navigation(17109);
  ...
  items1[1] = closure_5(navigation(16714).NonCollapsableGestureDetector, obj3);
