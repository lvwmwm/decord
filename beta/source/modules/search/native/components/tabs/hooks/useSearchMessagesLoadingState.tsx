...
// Dependencies: [7557, 12523, 8159, 558, 568, 17130, 12524, 504, 2]

// Module 17183 (useSearchMessagesLoadingState)
...
require = fn;
let closure_4 = fn(8159).SEARCH_TABS_TO_SEARCH_QUERY_LIMITS;
