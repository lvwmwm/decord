...
// Dependencies: [32, 19, 17, 2049, 9825, 9793, 1078, 21, 4790, 580, 5373, 1181, 7270, 9826, 4786, 1119, 5220, 4993, 9827, 1984, 4757, 2]
// Exports: default

// Module 9824 (StageChannelUpsell)
...
let closure_7 = fn(9825).useStageChannelUpsellCardStore;
let closure_8 = fn(9793).CREATE_GUILD_EVENT_MODAL_KEY;
  ...
  if (!tmp2[0]) {
    ...
    const obj8 = {
      suggestionsHook(children, arg1) {
          return closure_1_10(guildId(4786).Text, { variant: "text-sm/semibold", color: "mobile-text-heading-primary", children }, arg1);
        }
    };
    ...
    obj10.onPress = function onPress() {
      ...
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(9827, dependencyMap.paths), {
        guildId,
