...
// Module 16291 (RegistrationConstants)
...
export const authStateToRegisterTransitionStep = function authStateToRegisterTransitionStep(arg0) {
  ...
  } else if (tmp(1098).AuthStates.REGISTER_DISPLAY_NAME === arg0) {
    return obj.ACCOUNT_DISPLAY_NAME;
  } else if (tmp(1098).AuthStates.REGISTER_ACCOUNT_INFORMATION === arg0) {
    return obj.ACCOUNT_INFORMATION;
  } else if (tmp(1098).AuthStates.AGE_GATE === arg0) {
    return obj.AGE_GATE;
  } else if (tmp(1098).AuthStates.VERIFY_PHONE === arg0) {
