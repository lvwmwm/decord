...
// Dependencies: [5, 32, 19, 17, 16280, 16281, 21, 4758, 5195, 7185, 1488, 16290, 1098, 16277, 16295, 16296, 16279, 5203, 7204, 7213, 16297, 5188, 1119, 7182, 7287, 558, 568, 16299, 16300, 9868, 9869, 2]
...
function RegisterIdentityBase(inputMode) {
  ...
  const tmp2 = closure_16(45 * Math.min(2, inputMode(5195).useFontScale()));
  let obj = inputMode(5195);
  const tmp4 = setInputMode(7185)();
  dependencyMap = inputMode(1488).useNavigation();
  const tmp5 = closure_11((errors) => errors.errors);
  let message = tmp5;
  let obj2 = inputMode(1488);
  const identityRegistrationStep = inputMode(16290).useIdentityRegistrationStep(inputMode(1098).AuthStates.REGISTER_IDENTITY, inputMode);
  ...
  setInputMode(16295)(inputMode(1098).AuthStates.REGISTER_IDENTITY);
  const tmp10 = setInputMode(16295);
  const tmp12 = setInputMode(16296);
  tmp12(inputMode(16279).getPreviousRegistrationTransitionStep(inputMode(1098).AuthStates.REGISTER_IDENTITY));
  setInputMode(5203)(() => {
  ...
  obj7.children = closure_14(inputMode(5188).Button, obj8);
...
export const RegisterIdentity = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  let obj = hasItem(5195);
  const tmp3 = closure_16(45 * Math.min(2, hasItem(5195).useFontScale()));
  ...
  obj4.controlComponent = closure_14(closure_6, { style: tmp3.segmentedControl, children: closure_14(hasItem(9869).SegmentedControl, { state: segmentedControlState, keyboardShouldPersistTaps: "handled" }) });
