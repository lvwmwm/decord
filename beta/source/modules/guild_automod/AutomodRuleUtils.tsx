...
// Dependencies: [502, 17944, 11993, 1374, 17948, 17949, 1119, 8202, 7768, 2]
...
require = fn;
const getRuleCountByTriggerType = fn(17944).getRuleCountByTriggerType;
