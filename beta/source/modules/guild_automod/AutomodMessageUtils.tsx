...
// Dependencies: [32, 19, 2045, 4399, 4409, 1376, 1078, 7756, 7757, 7758, 1119, 7759, 7760, 7761, 4911, 7762, 7763, 7764, 558, 568, 504, 7765, 2]
...
// Module 7755 (AutomodMessageUtils)
import useChannelName from "useChannelName" /* 4911 */;
import AutomodMessageEmbedKeys from "AutomodMessageEmbedKeys" /* 7756 */;
import AutomodQuarantineUserActionMessageEmbedKeys from "AutomodQuarantineUserActionMessageEmbedKeys" /* 7757 */;
import AutomodQuarantineUserMessageEmbedKeys from "AutomodQuarantineUserMessageEmbedKeys" /* 7762 */;
import AutomodNotificationEmbedKeys from "AutomodNotificationEmbedKeys" /* 7763 */;
...
const AutomodInteractionCallbackTypeEmbedKeys = prop(7760);
const AutomodDecisionOutcomeEmbedKeys = prop(7761);
require = fn;
...
function _getUserProfileRuleHeaderText(profileUpdateTypeFromMessage, quarantineActionFromMessage, quarantineEventFromMessage) {
  if (AutomodQuarantineUserActionMessageEmbedKeys.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === quarantineActionFromMessage) {
    if (tmp(7758).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_UPDATE === profileUpdateTypeFromMessage) {
      const intl6 = tmp(1119).intl;
      let stringResult = intl6.string(tmp(1119).t.t98DPb);
    } else if (tmp(7758).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_RESET === profileUpdateTypeFromMessage) {
      const intl5 = tmp(1119).intl;
      stringResult = intl5.string(tmp(1119).t["7u/rlU"]);
    }
    return stringResult;
  } else if (tmp(7757).AutomodQuarantineUserActionMessageEmbedKeys.QUARANTINE_USER === quarantineActionFromMessage) {
    if (tmp(7759).AutomodQuarantineEventMessageEmbedKeys.MESSAGE_SEND === quarantineEventFromMessage) {
      const intl4 = tmp(1119).intl;
      let stringResult1 = intl4.string(tmp(1119).t.PmSMMS);
    } else if (tmp(7759).AutomodQuarantineEventMessageEmbedKeys.GUILD_JOIN === quarantineEventFromMessage) {
      const intl3 = tmp(1119).intl;
      stringResult1 = intl3.string(tmp(1119).t.m9wWzo);
    } else if (tmp(7759).AutomodQuarantineEventMessageEmbedKeys.USERNAME_UPDATE === quarantineEventFromMessage) {
      const intl2 = tmp(1119).intl;
      stringResult1 = intl2.string(tmp(1119).t.KNSkC6);
    } else if (tmp(7759).AutomodQuarantineEventMessageEmbedKeys.CLAN_TAG_UPDATE === quarantineEventFromMessage) {
      const intl7 = tmp(1119).intl;
      stringResult1 = intl7.string(tmp(1119).t.qV4K6j);
    }
    return stringResult1;
  } else if (tmp(7757).AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_GUEST_JOIN === quarantineActionFromMessage) {
...
function extractAutomodMessageFields(message) {
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.ALERT_ACTIONS_EXECUTION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.RULE_NAME;
  ...
  obj.ruleName = tmp19;
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.DECISION_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.KEYWORD;
  ...
  obj.keyword = tmp31;
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.KEYWORD_MATCHED_CONTENT;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.FLAGGED_MESSAGE_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.TIMEOUT_DURATION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.QUARANTINE_USER;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.QUARANTINE_USER_ACTION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.DECISION_REASON;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.INTERACTION_USER_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7756).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
...
export const getActionHeaderText = function getActionHeaderText(embeds, channel, arg2, integrationOwnerHook) {
  ...
  let GUILD_ROOM_NOTE_OUTCOME = v4xL9Sk(7756).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
  ...
  GUILD_ROOM_NOTE_OUTCOME = v4xL9Sk(7756).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  GUILD_ROOM_NOTE_OUTCOME = format(7756).AutomodMessageEmbedKeys.VOICE_CHANNEL_STATUS_OUTCOME;
  ...
  if (null == tmp32) {
    if (null != null) {
      ...
      GUILD_ROOM_NOTE_OUTCOME = format(7756).AutomodMessageEmbedKeys.GUILD_ROOM_NOTE_OUTCOME;
      ...
      if (null == tmp39) {
        if (null != null) {
          ...
          if (null == tmp22) {
            if (tmp13 !== v4xL9Sk(7761).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
          ...
          if (tmp16 !== v4xL9Sk(7760).AutomodInteractionCallbackTypeEmbedKeys.MODAL) {
            if (tmp13 !== v4xL9Sk(7761).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  ...
  } else if (tmp(7762).AutomodQuarantineUserMessageEmbedKeys.USERNAME === quarantineType) {
    const intl4 = tmp(1119).intl;
    return intl4.string(tmp(1119).t.pJQVnr);
  } else if (tmp(7762).AutomodQuarantineUserMessageEmbedKeys.GLOBAL_NAME === quarantineType) {
    const intl3 = tmp(1119).intl;
    return intl3.string(tmp(1119).t.V9eJ85);
  } else if (tmp(7762).AutomodQuarantineUserMessageEmbedKeys.CLAN_TAG === quarantineType) {
    const intl2 = tmp(1119).intl;
...
export const extractAutomodNotificationFields = function extractAutomodNotificationFields(message) {
  ...
  NOTIFICATION_TYPE = tmp(7763).AutomodNotificationEmbedKeys.JOIN_ATTEMPTS;
  let embeds1 = message.embeds;
  if (embeds1 == null) {
    embeds1 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7763).AutomodNotificationEmbedKeys.RAID_DATETIME;
  let embeds2 = message.embeds;
  if (embeds2 == null) {
    embeds2 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7763).AutomodNotificationEmbedKeys.DMS_SENT;
  let embeds3 = message.embeds;
  if (embeds3 == null) {
    embeds3 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7763).AutomodNotificationEmbedKeys.RAID_TYPE;
  let embeds4 = message.embeds;
  if (embeds4 == null) {
    embeds4 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7763).AutomodNotificationEmbedKeys.RESOLVED_REASON;
  let embeds5 = message.embeds;
  if (embeds5 == null) {
    embeds5 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7763).AutomodNotificationEmbedKeys.DECISION_ID;
  let embeds6 = message.embeds;
  if (embeds6 == null) {
    embeds6 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7763).AutomodNotificationEmbedKeys.SUSPICIOUS_MENTION_ACTIVITY_UNTIL;
  let embeds7 = message.embeds;
  if (embeds7 == null) {
    embeds7 = [];
  }
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (tmp3(7765).RaidResolutionType.DM_SPAM === resolvedReason) {
    const intl3 = tmp3(1119).intl;
    return intl3.string(tmp3(1119).t.j5V0ij);
  } else if (tmp3(7765).RaidResolutionType.JOIN_RAID === resolvedReason) {
