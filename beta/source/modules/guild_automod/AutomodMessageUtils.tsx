...
// Dependencies: [32, 19, 2045, 4431, 4441, 1376, 1078, 7788, 7789, 7790, 1119, 7791, 7792, 7793, 4943, 7794, 7795, 7796, 558, 568, 504, 7797, 2]
...
// Module 7787 (AutomodMessageUtils)
import useChannelName from "useChannelName" /* 4943 */;
import AutomodMessageEmbedKeys from "AutomodMessageEmbedKeys" /* 7788 */;
import AutomodQuarantineUserActionMessageEmbedKeys from "AutomodQuarantineUserActionMessageEmbedKeys" /* 7789 */;
import AutomodQuarantineUserMessageEmbedKeys from "AutomodQuarantineUserMessageEmbedKeys" /* 7794 */;
import AutomodNotificationEmbedKeys from "AutomodNotificationEmbedKeys" /* 7795 */;
...
const AutomodInteractionCallbackTypeEmbedKeys = prop(7792);
const AutomodDecisionOutcomeEmbedKeys = prop(7793);
require = fn;
...
function _getUserProfileRuleHeaderText(profileUpdateTypeFromMessage, quarantineActionFromMessage, quarantineEventFromMessage) {
  if (AutomodQuarantineUserActionMessageEmbedKeys.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === quarantineActionFromMessage) {
    if (tmp(7790).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_UPDATE === profileUpdateTypeFromMessage) {
      const intl6 = tmp(1119).intl;
      let stringResult = intl6.string(tmp(1119).t.t98DPb);
    } else if (tmp(7790).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_RESET === profileUpdateTypeFromMessage) {
      const intl5 = tmp(1119).intl;
      stringResult = intl5.string(tmp(1119).t["7u/rlU"]);
    }
    return stringResult;
  } else if (tmp(7789).AutomodQuarantineUserActionMessageEmbedKeys.QUARANTINE_USER === quarantineActionFromMessage) {
    if (tmp(7791).AutomodQuarantineEventMessageEmbedKeys.MESSAGE_SEND === quarantineEventFromMessage) {
      const intl4 = tmp(1119).intl;
      let stringResult1 = intl4.string(tmp(1119).t.PmSMMS);
    } else if (tmp(7791).AutomodQuarantineEventMessageEmbedKeys.GUILD_JOIN === quarantineEventFromMessage) {
      const intl3 = tmp(1119).intl;
      stringResult1 = intl3.string(tmp(1119).t.m9wWzo);
    } else if (tmp(7791).AutomodQuarantineEventMessageEmbedKeys.USERNAME_UPDATE === quarantineEventFromMessage) {
      const intl2 = tmp(1119).intl;
      stringResult1 = intl2.string(tmp(1119).t.KNSkC6);
    } else if (tmp(7791).AutomodQuarantineEventMessageEmbedKeys.CLAN_TAG_UPDATE === quarantineEventFromMessage) {
      const intl7 = tmp(1119).intl;
      stringResult1 = intl7.string(tmp(1119).t.qV4K6j);
    }
    return stringResult1;
  } else if (tmp(7789).AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_GUEST_JOIN === quarantineActionFromMessage) {
    const intl = tmp(1119).intl;
    return intl.string(tmp(1119).t.MrYeyS);
  }
}
function extractAutomodMessageFields(message) {
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.ALERT_ACTIONS_EXECUTION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.RULE_NAME;
  ...
  obj.ruleName = tmp19;
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.DECISION_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.KEYWORD;
  ...
  obj.keyword = tmp31;
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.KEYWORD_MATCHED_CONTENT;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.FLAGGED_MESSAGE_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.TIMEOUT_DURATION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.QUARANTINE_USER;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.QUARANTINE_USER_ACTION;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.DECISION_REASON;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.INTERACTION_USER_ID;
  ...
  INTERACTION_CALLBACK_TYPE = tmp(7788).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
...
export const getActionHeaderText = function getActionHeaderText(embeds, channel, arg2, integrationOwnerHook) {
  ...
  let GUILD_ROOM_NOTE_OUTCOME = v4xL9Sk(7788).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
  ...
  GUILD_ROOM_NOTE_OUTCOME = v4xL9Sk(7788).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  GUILD_ROOM_NOTE_OUTCOME = format(7788).AutomodMessageEmbedKeys.VOICE_CHANNEL_STATUS_OUTCOME;
  ...
  if (null == tmp32) {
    if (null != null) {
      ...
      GUILD_ROOM_NOTE_OUTCOME = format(7788).AutomodMessageEmbedKeys.GUILD_ROOM_NOTE_OUTCOME;
      ...
      if (null == tmp39) {
        if (null != null) {
          ...
          if (null == tmp22) {
            if (tmp13 !== v4xL9Sk(7793).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
              intl = v4xL9Sk(1119).intl;
              const obj2 = { channelName, channelHook: tmp30 };
              let formatResult = intl.format(v4xL9Sk(1119).t.IZg0VQ, obj2);
            } else {
              const intl5 = v4xL9Sk(1119).intl;
              const obj4 = { channelName, channelHook: tmp30 };
              formatResult = intl5.format(v4xL9Sk(1119).t.lOIOSK, obj4);
            }
          }
          if (tmp16 !== v4xL9Sk(7792).AutomodInteractionCallbackTypeEmbedKeys.MODAL) {
            if (tmp13 !== v4xL9Sk(7793).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
              const intl7 = v4xL9Sk(1119).intl;
              const obj5 = { applicationName: tmp22, channelName, channelHook: tmp30, integrationOwnerHook };
              let formatResult1 = intl7.format(v4xL9Sk(1119).t.AXQufN, obj5);
            } else {
              const intl6 = v4xL9Sk(1119).intl;
              const obj6 = { applicationName: tmp22, channelName, channelHook: tmp30, integrationOwnerHook };
              formatResult1 = intl6.format(v4xL9Sk(1119).t.s3tjMN, obj6);
            }
          } else {
            intl = arg4;
          }
          if (tmp13 !== v4xL9Sk(7793).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
            const intl9 = v4xL9Sk(1119).intl;
            v4xL9Sk = v4xL9Sk(1119).t["4xL9Sk"];
            obj7 = { applicationName: tmp22, interactionUserHook: intl, integrationOwnerHook };
            let formatResult2 = intl9.format(v4xL9Sk, obj7);
          } else {
            const intl8 = v4xL9Sk(1119).intl;
            const obj8 = { applicationName: tmp22, interactionUserHook: intl, integrationOwnerHook };
            formatResult2 = intl8.format(v4xL9Sk(1119).t.S3lNIT, obj8);
          }
        }
      } else {
        if ("blocked" === tmp39) {
          let v9x7Jdd = format(1119).t["9x7Jdd"];
        } else {
          v9x7Jdd = format(1119).t["srla2+"];
        }
        const intl4 = format(1119).intl;
        format = intl4.format;
    ...
    if ("blocked" === tmp32) {
      let bma6cs = format(1119).t.cLQrqz;
    } else {
      bma6cs = format(1119).t.bma6cs;
    }
    const intl3 = format(1119).intl;
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  if (AutomodQuarantineUserMessageEmbedKeys.AutomodQuarantineUserMessageEmbedKeys.NICKNAME === quarantineType) {
    const intl5 = tmp(1119).intl;
    return intl5.string(tmp(1119).t["fkBQa/"]);
  } else if (tmp(7794).AutomodQuarantineUserMessageEmbedKeys.USERNAME === quarantineType) {
    const intl4 = tmp(1119).intl;
    return intl4.string(tmp(1119).t.pJQVnr);
  } else if (tmp(7794).AutomodQuarantineUserMessageEmbedKeys.GLOBAL_NAME === quarantineType) {
    const intl3 = tmp(1119).intl;
    return intl3.string(tmp(1119).t.V9eJ85);
  } else if (tmp(7794).AutomodQuarantineUserMessageEmbedKeys.CLAN_TAG === quarantineType) {
    const intl2 = tmp(1119).intl;
    return intl2.string(tmp(1119).t.Rtum01);
  } else {
    const intl = tmp(1119).intl;
    return intl.string(tmp(1119).t.pJQVnr);
  }
};
export const extractAutomodNotificationFields = function extractAutomodNotificationFields(message) {
  ...
  NOTIFICATION_TYPE = tmp(7795).AutomodNotificationEmbedKeys.JOIN_ATTEMPTS;
  let embeds1 = message.embeds;
  if (embeds1 == null) {
    embeds1 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7795).AutomodNotificationEmbedKeys.RAID_DATETIME;
  let embeds2 = message.embeds;
  if (embeds2 == null) {
    embeds2 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7795).AutomodNotificationEmbedKeys.DMS_SENT;
  let embeds3 = message.embeds;
  if (embeds3 == null) {
    embeds3 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7795).AutomodNotificationEmbedKeys.RAID_TYPE;
  let embeds4 = message.embeds;
  if (embeds4 == null) {
    embeds4 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7795).AutomodNotificationEmbedKeys.RESOLVED_REASON;
  let embeds5 = message.embeds;
  if (embeds5 == null) {
    embeds5 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7795).AutomodNotificationEmbedKeys.DECISION_ID;
  let embeds6 = message.embeds;
  if (embeds6 == null) {
    embeds6 = [];
  }
  ...
  NOTIFICATION_TYPE = tmp(7795).AutomodNotificationEmbedKeys.SUSPICIOUS_MENTION_ACTIVITY_UNTIL;
  let embeds7 = message.embeds;
  if (embeds7 == null) {
    embeds7 = [];
  }
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  if (null == resolvedReason) {
    ...
    return intl4.string(tmp3(1119).t["riQ+HH"]);
  } else if (tmp3(7797).RaidResolutionType.DM_SPAM === resolvedReason) {
    const intl3 = tmp3(1119).intl;
    return intl3.string(tmp3(1119).t.j5V0ij);
  } else if (tmp3(7797).RaidResolutionType.JOIN_RAID === resolvedReason) {
    const intl2 = tmp3(1119).intl;
    return intl2.string(tmp3(1119).t.qhaRbG);
  } else {
    const intl = tmp3(1119).intl;
    return intl.string(tmp3(1119).t.GPg6JM);
  }
};
