...
// Dependencies: [2103, 2067, 5659, 1078, 1370, 38, 1119, 12, 5660, 2]
      ...
      if (PlatformTypes.REDDIT === connectionType) {
        if (constants.CREATED_AT === connectionMetadataField) {
          ...
          const obj4 = {
            platformQuantityHook() {
                      ...
                      return intl.string(closure_0(1119).t["+/5TCx"]);
                    }
          };
          ...
          const obj5 = {
            platformQuantityHook() {
                      const intl = closure_0(1119).intl;
                      return intl.string(closure_0(1119).t["9rPbEs"]);
                    }
          };
        ...
        if (constants.CREATED_AT === connectionMetadataField) {
          ...
          const obj14 = {
            platformQuantityHook() {
                      const intl = closure_0(1119).intl;
                      return intl.string(closure_0(1119).t.xRygZL);
                    }
          };
        ...
        if (constants.CREATED_AT === connectionMetadataField) {
          ...
          const obj18 = {
            platformQuantityHook() {
                      const intl = closure_0(1119).intl;
                      return intl.string(closure_0(1119).t.slSQuB);
                    }
          };
        ...
        if (constants.CREATED_AT === connectionMetadataField) {
          ...
          const obj20 = {
            platformQuantityHook() {
                      const intl = closure_0(1119).intl;
                      return intl.string(closure_0(1119).t.TEEYwa);
                    }
          };
        ...
        if (constants.TIKTOK_VERIFIED === connectionMetadataField) {
          ...
          const obj24 = {
            platformQuantityHook() {
                      const intl = closure_0(1119).intl;
                      return intl.string(closure_0(1119).t.uv7ety);
                    }
          };
