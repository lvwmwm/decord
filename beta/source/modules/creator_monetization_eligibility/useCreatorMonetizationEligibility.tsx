...
// Dependencies: [5, 32, 19, 18155, 18158, 4692, 2]
// Exports: default

// Module 18185 (useCreatorMonetizationEligibility)
...
let closure_6 = fn(18155).CreatorMonetizationApplicationState;
const size = fn(2);
      ...
      try {
        ...
        if (0 === c5) {
          ...
          if (2 === tmp8) {
            ...
            const tmp45 = new closure_0(4692)(closure_129_1);
            tmp4(tmp45);
            c4 = 0;
            closure_1(false);
            c6 = 3;
