...
// Dependencies: [5, 19, 1376, 12826, 1078, 21, 12827, 4458, 1119, 5812, 12831, 1245, 12823, 504, 2023, 1389, 8876, 4961, 15112, 1984, 2]
// Exports: default, handleSyncContacts

// Module 15111 (ContactSyncSettings)
...
export default function ContactSyncSettings() {
  contactSyncAccount = contactSyncAccount(12827).useContactSyncAccount();
  let obj = contactSyncAccount(12827);
  ...
  const tmpResult = contactSyncAccount(12827);
  const FriendDiscoverySettings = tmp(2023).FriendDiscoverySettings;
  const setting = FriendDiscoverySettings.useSetting();
  const isContactSyncEnabledResult = contactSyncAccount(12827).isContactSyncEnabled(contactSyncAccount);
  ...
  if (isStaffResult) {
    ...
    const obj5 = { label: "STAFF ONLY - Find your friends deletion", value: true, onValueChange: tmp(12827).adminDeleteContactSync };
    const items1 = [closure_10(tmp(8876).FormSwitchRow, obj5), closure_10(tmp(8876).FormDivider, {})];
  ...
  items2[1] = closure_10(contactSyncAccount(8876).FormSwitchRow, obj6);
  let tmp10Result2 = null;
  if (null != contactSyncAccount) {
    const obj7 = { children: null };
    const items3 = [tmp14(tmp(8876).FormDivider, {}), ];
    ...
    obj8.trailing = tmp14(tmp(8876).FormRow.Arrow, obj9);
    ...
    items3[1] = tmp14(tmp(8876).FormRow, obj8);
  ...
  const items4 = [closure_12(contactSyncAccount(8876).FormSection, obj3), , , ];
  const obj11 = { children: null };
  const intl4 = tmp(1119).intl;
  const tmpResult4 = contactSyncAccount(1389);
  obj11.children = intl4.format(contactSyncAccount(1119).t.BoR0dO, { onClick: contactSyncAccount(12827).handleOpenLearnMoreLink });
  items4[1] = closure_10(contactSyncAccount(8876).FormHint, obj11);
  const obj13 = { children: null };
  const intl5 = tmp(1119).intl;
  obj13.children = intl5.string(contactSyncAccount(1119).t.cW1nr9);
  items4[2] = closure_10(contactSyncAccount(8876).FormHint, obj13);
  ...
  const items5 = [closure_10(contactSyncAccount(8876).FormSwitchRow, obj15), closure_10(contactSyncAccount(8876).FormDivider, {}), ];
  ...
  items5[2] = closure_10(contactSyncAccount(8876).FormSwitchRow, obj16);
  obj14.children = items5;
  items4[3] = closure_12(contactSyncAccount(8876).FormSection, obj14);
