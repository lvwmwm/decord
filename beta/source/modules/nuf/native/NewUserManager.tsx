...
let closure_10 = fn(12866).HUBS_IN_ONBOARDING_COUNTRIES;
...
let obj3 = {
  ...
  transitionToStep: fn(12823).openContactSyncModalOnboarding
};
items[1] = {
  ...
  transitionToStep: fn(12851).openDiscoverabilityModal
};
items[2] = obj3;
items[3] = {
  key: obj.STUDENT_HUB,
