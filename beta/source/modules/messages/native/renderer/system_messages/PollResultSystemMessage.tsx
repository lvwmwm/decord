...
// Dependencies: [1379, 8255, 8257, 1119, 1401, 4445, 8338, 8259, 2]
// Exports: createPollResultSystemMessage

// Module 8337 (PollResultSystemMessage)
...
export const createPollResultSystemMessage = function createPollResultSystemMessage(message) {
  ...
  if (null == tmp3) {
    ...
    obj2.usernameOnClick = tmp(8257)(obj4);
    ...
    if (0 === tmp3.totalVotes) {
      ...
      if (null == tmp3.victorAnswerId) {
        ...
        if (null == id) {
          ...
          items.push(obj9);
          const intl = tmp21(1119).intl;
          const obj10 = {};
          const merged2 = Object.assign(obj2);
          obj11 = { type: "strong", content: items };
          obj10.answerHook = () => obj11;
          obj10.percentage = combined;
          formatToPartsResult = intl.formatToParts(tmp21(1119).t.zFwIxC, obj10);
        } else {
          if (null != id.id) {
            ...
            obj12.src = tmp(1401).getEmojiURL(obj13);
            const tmpResult = tmp(1401);
            const obj15 = { id: null, animated: false, size: null };
            id = id.id;
            obj15.id = id;
            obj15.size = EMOJI_URL_BASE_SIZE;
            obj12.frozenSrc = tmp(1401).getEmojiURL(obj15);
            items.push(obj12);
            const tmpResult3 = tmp(1401);
          } else {
            const obj = { type: "emoji", content: tmp(4445).convertSurrogateToName(id.name, false), surrogate: id.name };
            items.push(obj);
            const tmpResult4 = tmp(4445);
          }
    ...
    const obj16 = {};
    const merged3 = Object.assign(tmp(8259)(message));
