...
// Dependencies: [2045, 8243, 8223, 8334, 1119, 8225, 8227, 2]
// Exports: createVoiceSessionSystemMessage

// Module 8333 (VoiceSessionSystemMessage)
...
export const createVoiceSessionSystemMessage = function createVoiceSessionSystemMessage(message) {
  ...
  if (null == tmp3) {
    ...
    obj3.usernameOnClick = tmp(8225)(obj4);
    ...
    obj5.usernameOnClick = tmp(8225)(obj6);
