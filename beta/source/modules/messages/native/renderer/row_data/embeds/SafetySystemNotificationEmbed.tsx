...
// Dependencies: [17, 1074, 4348, 8867, 5247, 8690, 8204, 1115, 2]
          ...
          if (null != parseMessageForPropsResult) {
            ...
            if (null != parseMessageForPropsResult.ctas) {
              ...
              if (null != parseMessageForPropsResult.ctas[0]) {
                mapCtaToNativeDataResult = tmp6(8690).mapCtaToNativeData(parseMessageForPropsResult.ctas[0], parseMessageForPropsResult.learn_more_link, parseMessageForPropsResult.classification_id);
                const tmp6Result = tmp6(8690);
              }
              let mapCtaToNativeDataResult1;
              if (null != parseMessageForPropsResult.ctas[1]) {
                mapCtaToNativeDataResult1 = tmp6(8690).mapCtaToNativeData(parseMessageForPropsResult.ctas[1], parseMessageForPropsResult.learn_more_link, parseMessageForPropsResult.classification_id);
                const tmp6Result3 = tmp6(8690);
              }
            ...
            const obj2 = { titleText: str, titleIcon: tmp6(8204).getAssetUriForEmbed(Image.resolveAssetSource(importDefault("danger" === parseMessageForPropsResult.icon ? 8867 : 5247))), subtitleText: null, descriptionText: null, primaryCtaText: null, primaryCtaType: null, primaryCtaKey: null, secondaryCtaText: null, secondaryCtaType: null, secondaryCtaKey: null, footerTheme: null };
