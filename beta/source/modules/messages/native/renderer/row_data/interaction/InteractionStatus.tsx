...
// Dependencies: [8390, 1119, 2]
// Exports: createInteractionStatus

// Module 13485 (InteractionStatus)
...
export const createInteractionStatus = function createInteractionStatus(message, interaction) {
  ...
  if (InteractionUtils.InteractionStatusViewState.SENDING === interactionStatusViewState) {
    ...
    return obj2;
  } else if (tmp(8390).InteractionStatusViewState.CREATED === interactionStatusViewState) {
    ...
    return obj3;
  } else if (tmp(8390).InteractionStatusViewState.TIMED_OUT === interactionStatusViewState) {
    const obj5 = { text: null, state: null };
    const intl2 = tmp(1119).intl;
    obj5.text = intl2.string(tmp(1119).t.h8hzPd);
    obj5.state = constants.FAILED;
    return obj5;
  } else if (tmp(8390).InteractionStatusViewState.FAILED === interactionStatusViewState) {
    ...
    return obj6;
  } else if (tmp(8390).InteractionStatusViewState.EPHEMERAL_SUCCESS === interactionStatusViewState) {
