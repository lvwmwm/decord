...
// Dependencies: [1078, 1095, 7514, 11, 4442, 2]
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4442).isWithinInterval(content.timestamp, type.timestamp, closure_6);
