...
// Dependencies: [1078, 1095, 7546, 11, 4474, 2]
// Exports: isNewGroupItem

// Module 12117 (isNewMessageGroup)
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4474).isWithinInterval(content.timestamp, type.timestamp, closure_6);
