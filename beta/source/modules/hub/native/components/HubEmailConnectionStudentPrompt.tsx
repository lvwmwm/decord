...
// Dependencies: [19, 17, 12902, 1078, 21, 4790, 5775, 580, 558, 568, 1488, 1245, 1119, 1181, 12914, 7417, 12915, 12912, 2]

// Module 12913 (HubEmailConnectionStudentPrompt)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((onClose) => {
  ...
  obj6.source = invite(12914);
  obj5.leading = closure_7(closure_4, obj6);
  obj5.trailing = invite(7417).Arrow;
