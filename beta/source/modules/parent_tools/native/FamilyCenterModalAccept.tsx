...
// Dependencies: [19, 17, 21, 4758, 580, 558, 568, 4961, 4457, 1119, 12047, 15189, 4701, 2486, 4754, 15159, 12049, 8699, 5188, 12057, 5652, 8698, 5839, 11453, 2]

// Module 15192 (FamilyCenterModalAccept)
...
let closure_8 = ReactCompilerGating.isReactCompilerEnabled() ? ((otherUser) => {
  ...
  const familyCenterActions = otherUser(12047).useFamilyCenterActions(tmp7);
  ...
  if (cResult[3] === acceptLinkRequest) {
    ...
    if (cResult[6] === otherUser) {
      ...
      if (cResult[12] !== otherUser) {
        ...
        const tmp25 = closure_5(acceptLinkRequest(15159), obj4);
        ...
        if (cResult[15] === tmp22) {
          if (cResult[16] === tmp11) {
            ...
            if (cResult[19] === Symbol.for("react.memo_cache_sentinel")) {
              const tmp33 = closure_5(acceptLinkRequest(12049), {});
              cResult[19] = tmp33;
              let tmp30 = tmp33;
            } else {
              tmp30 = cResult[19];
            ...
            if (cResult[22] === tmp4.disclaimer) {
              ...
              if (cResult[25] === tmp26) {
                ...
                if (cResult[29] === tmp9) {
                  ...
                  if (cResult[32] === Symbol.for("react.memo_cache_sentinel")) {
                    ...
                    obj6.onPress = acceptLinkRequest(4961).pop;
                    const tmp52 = closure_5(tmp(5188).Button, obj6);
                    cResult[32] = tmp52;
                    let tmp49 = tmp52;
                  } else {
                    tmp49 = cResult[32];
                  ...
                  if (cResult[33] !== tmp46) {
                    ...
                    obj8.children = items;
                    obj7.children = closure_6(tmp(5652).ButtonGroup, obj8);
                    const tmp56 = closure_5(tmp(12057).ModalFooter, obj7);
                    cResult[33] = tmp46;
                    cResult[34] = tmp56;
                    let tmp53 = tmp56;
                  } else {
                  ...
                  const tmp59 = closure_6(tmp(8698).ModalScreen, obj9);
                  cResult[35] = tmp40;
                  cResult[36] = tmp53;
                  cResult[37] = tmp59;
                  tmp57 = tmp59;
                ...
                const tmp48 = closure_5(tmp(5188).Button, obj10);
                cResult[29] = tmp9;
              ...
              const tmp42 = closure_6(tmp(8699).ModalContent, obj11);
              cResult[25] = tmp26;
              cResult[26] = tmp37;
              cResult[27] = tmp42;
              tmp40 = tmp42;
            ...
            const tmp39 = closure_5(tmp(4754).Text, obj12);
    ...
    const obj14 = { otherUser, iconSrc: acceptLinkRequest(4701), iconStyles: tmp4.icon };
    const tmp15 = closure_5(acceptLinkRequest(15189), obj14);
    cResult[6] = otherUser;
    cResult[7] = tmp4.icon;
    cResult[8] = tmp15;
    tmp11 = tmp15;
    const tmp14 = acceptLinkRequest(15189);
  }
  ...
  obj5.iconSrc = acceptLinkRequest(4701);
  obj5.iconStyles = tmp.icon;
  const items1 = [closure_5(acceptLinkRequest(15189), obj5), , ];
  ...
  items1[2] = closure_5(acceptLinkRequest(15159), { user: otherUser });
  ...
  items2[2] = closure_5(otherUser(4754).Text, obj7);
  obj3.children = items2;
  const items3 = [closure_6(otherUser(8699).ModalContent, obj3), ];
  const obj9 = { children: null };
  ...
  const items4 = [closure_5(otherUser(5188).Button, obj11), ];
  ...
  obj12.onPress = acceptLinkRequest(4961).pop;
  items4[1] = closure_5(otherUser(5188).Button, obj12);
