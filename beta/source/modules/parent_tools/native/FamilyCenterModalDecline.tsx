...
// Module 15203 (FamilyCenterModalDecline)
...
let closure_8 = ReactCompilerGating.isReactCompilerEnabled() ? ((otherUser) => {
  ...
  const tmp6 = declineLinkRequest(8954)();
  ...
  if (cResult[3] === declineLinkRequest) {
    ...
    if (cResult[6] !== otherUser) {
      const obj3 = { otherUser, iconSrc: tmp5(7270) };
      const tmp16 = closure_5(tmp5(15199), obj3);
      cResult[6] = otherUser;
      cResult[7] = tmp16;
      let tmp13 = tmp16;
    ...
    if (cResult[11] !== otherUser) {
      ...
      const tmp24 = closure_5(tmp5(15169), obj5);
      ...
      if (cResult[14] === tmp22) {
        if (cResult[15] === tmp13) {
          ...
          if (cResult[19] !== tmp4.noticeHeader) {
            ...
            const tmp33 = closure_5(tmp(4786).Text, obj6);
          ...
          if (cResult[21] === Symbol.for("react.memo_cache_sentinel")) {
            ...
            const tmp36 = closure_5(tmp(4786).Text, obj7);
            cResult[21] = tmp36;
            let tmp34 = tmp36;
          } else {
            tmp34 = cResult[21];
          ...
          if (cResult[22] === tmp4.body) {
            ...
            if (cResult[25] === tmp25) {
              ...
              if (cResult[29] === tmp11) {
                ...
                if (cResult[32] === Symbol.for("react.memo_cache_sentinel")) {
                  ...
                  obj8.onPress = tmp5(4993).pop;
                  const tmp51 = closure_5(tmp(5220).Button, obj8);
                  cResult[32] = tmp51;
                  let tmp49 = tmp51;
                } else {
                  tmp49 = cResult[32];
                ...
                if (cResult[33] !== tmp46) {
                  ...
                  obj9.children = closure_6(tmp(5684).ButtonGroup, obj10);
                  const tmp55 = closure_5(tmp(12093).ModalFooter, obj9);
                  cResult[33] = tmp46;
                  cResult[34] = tmp55;
                  let tmp52 = tmp55;
                } else {
                ...
                const tmp58 = closure_6(tmp(8730).ModalScreen, obj11);
                cResult[35] = tmp41;
                cResult[36] = tmp52;
                cResult[37] = tmp58;
                tmp56 = tmp58;
              ...
              const tmp48 = closure_5(tmp(5220).Button, obj12);
              cResult[29] = tmp11;
            ...
            const tmp43 = closure_6(tmp(8731).ModalContent, obj13);
            cResult[25] = tmp25;
            cResult[26] = tmp37;
            cResult[27] = tmp43;
            tmp41 = tmp43;
  ...
  const tmp2 = declineLinkRequest(8954)();
  ...
  obj5.iconSrc = declineLinkRequest(7270);
  const items1 = [closure_5(declineLinkRequest(15199), obj5), , ];
  ...
  items1[2] = closure_5(declineLinkRequest(15169), { user: otherUser });
  ...
  const items3 = [closure_5(otherUser(4786).Text, obj8), ];
  ...
  items3[1] = closure_5(otherUser(4786).Text, obj9);
  obj7.children = items3;
  items2[1] = closure_6(View, obj7);
  obj3.children = items2;
  const items4 = [closure_6(otherUser(8731).ModalContent, obj3), ];
  const obj10 = { children: null };
  const obj11 = { children: null };
  ...
  const items5 = [closure_5(otherUser(5220).Button, obj12), ];
  ...
  obj13.onPress = declineLinkRequest(4993).pop;
  items5[1] = closure_5(otherUser(5220).Button, obj13);
  obj11.children = items5;
  obj10.children = closure_6(otherUser(5684).ButtonGroup, obj11);
  items4[1] = closure_5(otherUser(12093).ModalFooter, obj10);
