...
function ConnectGuardianShareScreen() {
  ...
  const callback = noop.useCallback(() => {
    ...
    getLinkCode(4457).presentFailedToast(intl.string(getLinkCode(1119).t.R0RpRX));
    const obj = getLinkCode(4457);
  ...
  const items2 = [closure_6(getLinkCode(4754).Text, obj7), ];
  ...
  items2[1] = closure_6(getLinkCode(4754).Text, obj8);
  obj6.children = items2;
  const items3 = [closure_7(getLinkCode(5186).Stack, obj6), ];
  ...
  const items4 = [closure_6(getLinkCode(4754).Text, obj10), ];
  if (null != stateFromStores) {
    if (null != stateFromStores1) {
      const obj11 = { shareActions: "full", linkCode: stateFromStores, expiresAt: stateFromStores1, onRefresh: getLinkCode };
      let tmp11Result = tmp11(tmp2(15148).ConnectGuardianCard, obj11);
    }
    const obj12 = { children: null };
    const obj13 = { children: null };
    items4[1] = tmp11Result;
    obj9.children = items4;
    items3[1] = tmp12(getLinkCode(5186).Stack, obj9);
    obj5.children = items3;
    obj13.children = tmp12(getLinkCode(5186).Stack, obj5);
    obj12.children = tmp11(getLinkCode(8699).ModalContent, obj13);
    return tmp11(getLinkCode(8698).ModalScreen, obj12);
  }
...
export default ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    const obj3 = {
      headerShown: true,
      headerLeft: tmp(5839).getHeaderBackButton(ModalActionCreatorsDefault.pop),
      headerTitle() {
          return null;
        },
      render() {
