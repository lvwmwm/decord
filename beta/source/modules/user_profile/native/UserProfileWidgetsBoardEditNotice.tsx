...
// Dependencies: [19, 17, 2042, 21, 4790, 580, 558, 568, 8547, 2031, 10957, 4744, 4786, 1119, 5373, 5878, 2]

// Module 13396 (UserProfileWidgetsBoardEditNotice)
  ...
  const tmp9 = closure_5(SelectedDismissibleContentDefault, {
    ...
    children(markAsDismissed) {
      ...
      if (markAsDismissed.visibleContent === dismissible_content.DismissibleContent.USER_PROFILE_WIDGETS_BOARD_MOBILE_EDIT_NOTICE) {
        ...
        obj2.children = hasOwnProperty(tmp(4744).CircleInformationIcon, obj3);
        ...
        obj4.children = intl.string(tmp(1119).t.kv8ULD);
        ...
        obj5.accessibilityLabel = intl2.string(tmp(1119).t.WAI6xu);
        obj5.onPress = function onPress() {
          return markAsDismissed(constants.USER_DISMISS);
        };
        obj5.style = closure_0.closeButton;
        obj5.children = hasOwnProperty(tmp(5878).XSmallIcon, { size: "sm" });
        items1[2] = hasOwnProperty(tmp(5373).PressableOpacity, obj5);
        obj.children = items1;
