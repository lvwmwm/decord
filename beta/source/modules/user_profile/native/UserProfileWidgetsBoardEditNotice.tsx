...
// Dependencies: [19, 17, 2042, 21, 4758, 580, 558, 568, 8515, 2031, 10921, 4712, 4754, 1119, 5341, 5846, 2]

// Module 13360 (UserProfileWidgetsBoardEditNotice)
  ...
  const tmp9 = closure_5(SelectedDismissibleContentDefault, {
    ...
    children(markAsDismissed) {
      ...
      if (markAsDismissed.visibleContent === dismissible_content.DismissibleContent.USER_PROFILE_WIDGETS_BOARD_MOBILE_EDIT_NOTICE) {
        ...
        obj2.children = hasOwnProperty(tmp(4712).CircleInformationIcon, obj3);
        ...
        obj5.children = hasOwnProperty(tmp(5846).XSmallIcon, { size: "sm" });
