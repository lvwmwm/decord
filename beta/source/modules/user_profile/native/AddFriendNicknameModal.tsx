...
// Dependencies: [5, 32, 19, 17, 4409, 1376, 21, 4758, 580, 11232, 504, 1119, 4961, 10009, 7287, 5207, 4754, 6848, 4603, 2]
// Exports: default

// Module 13437 (AddFriendNicknameModal)
...
export default function AddFriendNicknameModal(arg0) {
  ...
  _slicedToArray = showUserProfile(11232)();
  ...
  const tmp3Result = showUserProfile(7287);
  ...
  const tmp3Result3 = showUserProfile(5207);
  obj8.placeholder = showUserProfile(4603).getName(stateFromStores1);
