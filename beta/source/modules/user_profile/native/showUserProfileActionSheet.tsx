...
// Dependencies: [5, 5777, 4409, 3, 1376, 1984, 8454, 8455, 2023, 8456, 4725, 8474, 2]
...
// Module 8453 (showUserProfileActionSheet)
...
function showUserProfileActionSheet(ignoreBlockedSpeedBump, arg1) {
  ...
  if (!ignoreBlockedSpeedBump.ignoreBlockedSpeedBump) {
    ...
    if (isIgnoredResult) {
      const tmp8 = tmp2(1984)(8456, tmp3.paths);
  ...
  const tmp20 = asyncRequireImpl(8474, dependencyMap.paths);
