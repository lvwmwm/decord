...
// Dependencies: [32, 19, 17, 7799, 7791, 1074, 21, 4756, 576, 8455, 8439, 7407, 7427, 1241, 8433, 8440, 7395, 4752, 1115, 8441, 10994, 504, 14908, 8435, 8456, 14909, 13478, 13479, 8442, 11485, 5198, 2]
// Exports: default

// Module 14907 (EditProfileFrameActionSheet)
...
import EditProfileFrameSection from "EditProfileFrameSection" /* 14909 */;
...
function ProfileFrameSectionPreview(arg0) {
  ...
  const items1 = [closure_9(purchase(11485), { user, guildId, profileFrame: memo, maxWidth: 280 }), ];
