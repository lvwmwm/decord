...
// Dependencies: [32, 19, 17, 4782, 9087, 9088, 1376, 7894, 8489, 7430, 21, 4790, 580, 4529, 4791, 558, 568, 504, 1616, 7441, 7461, 13436, 13437, 13417, 9093, 8497, 11441, 1119, 6895, 5935, 7478, 7352, 11369, 8210, 4747, 2]

// Module 13439 (EditWishlistActionSheet)
...
import WishlistVisibility2 from "WishlistVisibility" /* 13437 */;
...
let closure_12 = fn(8489).TrackUserProfileWishlistActions;
...
exitingAnimation.__closure = { withTiming: fn(4791).withTiming };
...
let obj6 = { withTiming: fn(4791).withTiming };
const size = fn(2);
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((wishlistId) => {
  ...
  const analyticsLocations2 = analyticsContext(7441)(tmp9, tmp8(7461).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  ...
  const tmp8Result = analyticsContext(7441);
  ({ cardWidth: closure_5, rowWidth } = analyticsContext(13436)(tmp12));
  if (null != rowWidth) {
  ...
  const tmp14 = analyticsContext(13436)(tmp12);
  ...
  analyticsLocations = analyticsContext(7441)(analyticsLocations1, tmp4(7461).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  const obj2 = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  let tmp5 = analyticsContext(7441);
  ({ cardWidth: c5, rowWidth } = analyticsContext(13436)({ maxWidth: ACTION_SHEET_MAX_WIDTH }));
  if (null != rowWidth) {
    let obj3 = { width: rowWidth };
    let tmp7 = obj3;
  }
  let tmp6 = analyticsContext(13436)({ maxWidth: ACTION_SHEET_MAX_WIDTH });
  const items1 = [value];
  ...
  obj9.children = closure_14(wishlistId(7478).TableSwitchRow, obj10);
  obj8.children = closure_14(wishlistId(5935).TableRowGroup, obj9);
  ...
  if (stateFromStores1) {
    ...
    obj4.children = tmp16(tmp2(6895).BottomSheetScrollView, obj5);
