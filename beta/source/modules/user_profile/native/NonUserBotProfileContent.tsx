...
// Dependencies: [19, 17, 7455, 7398, 21, 558, 568, 8515, 8464, 4910, 4603, 8516, 8504, 8517, 1616, 8501, 8512, 7436, 4457, 8518, 8530, 1119, 11407, 11461, 4497, 2]

// Module 8514 (NonUserBotProfileContent)
import ToastUtils from "ToastUtils" /* 4457 */;
import UserUtilsDefault from "UserUtils" /* 4603 */;
import NicknameUtilsDefault from "NicknameUtils" /* 4910 */;
import ClipboardUtils from "ClipboardUtils" /* 7436 */;
import useProfileThemeDefault from "useProfileTheme" /* 8501 */;
...
import useUserProfileOverscrollStylesDefault from "useUserProfileOverscrollStyles" /* 8517 */;
...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  const obj2 = trackUserProfileAction(8464);
  let guild_id1;
  if (channel != null) {
  ...
  const name = userTag(4910).useName(guild_id1, id, user);
  const obj3 = userTag(4910);
  userTag = userTag(4603).useUserTag(user);
  const tmp10 = userTag(8516)(displayProfile);
  const tmp11 = userTag(8504)(ACTION_SHEET_MAX_WIDTH);
  if (cResult[0] === tmp11) {
    if (cResult[1] === scrollPosition) {
      let tmp12 = cResult[2];
    }
    ({ bannerAnimatedStyle, bannerImageAnimatedStyle, contentAnimatedStyle, blurAnimatedProps, showBlur } = tmp4(8517)(tmp12));
    if (cResult[3] === displayProfile) {
      if (cResult[4] === user) {
        let tmp15 = cResult[5];
      }
      ({ theme, primaryColor, secondaryColor } = tmp4(8501)(tmp15));
      if (cResult[6] === primaryColor) {
        if (cResult[7] === secondaryColor) {
          if (cResult[8] === theme) {
            let tmp17 = cResult[9];
          }
          const userProfileColors = tmp(8512).useUserProfileColors(tmp17);
          ...
          if (null == user) {
            ...
            if (cResult[10] === trackUserProfileAction) {
                    ...
                    if (cResult[18] === blurAnimatedProps) {
                      if (cResult[19] === displayProfile) {
                        if (cResult[20] === showBlur) {
                            ...
                            if (cResult[24] === guildId) {
                              ...
                              if (cResult[29] === tmp5.profileContent) {
                                if (cResult[30] === tmp5.profileContentWrapper) {
                                  ...
                                  const tmp37 = closure_7(tmp4(11407), obj6);
                                  cResult[34] = tmp10;
                          ...
                          const tmp26 = closure_7(tmp(8530).OpenableUserProfileAvatar, obj7);
              ...
              const tmp23 = closure_7(tmp4(8518), obj8);
  ...
  trackUserProfileAction = trackUserProfileAction(8464).useUserProfileAnalyticsContext().trackUserProfileAction;
  let obj = trackUserProfileAction(8464);
  let guild_id;
  if (channel != null) {
  ...
  const userProfileColors = trackUserProfileAction(8512).useUserProfileColors({ theme, primaryColor, secondaryColor });
  ...
  if (null == user) {
    ...
    const items = [closure_7(tmp(8518), obj3), ];
    ...
    const items1 = [closure_7(tmp4(8530).OpenableUserProfileAvatar, obj5), ];
    ...
    obj8.children = closure_7(tmp(11407), obj9);
    ...
    items4[1] = obj13;
    obj12.style = items4;
    obj11.children = closure_7(tmp(11461), obj12);
    items3[1] = closure_7(View, obj11);
    obj6.children = items3;
    items1[1] = closure_8(View, obj6);
    obj4.children = items1;
    items[1] = closure_8(tmp(4497).View, obj4);
    obj10.children = items;
    return closure_8(closure_9, obj10);
  }
  const tmp4Result = trackUserProfileAction(8512);
}));
