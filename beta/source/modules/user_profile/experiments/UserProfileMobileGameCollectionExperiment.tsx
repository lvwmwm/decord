...
// Module 13231 (UserProfileMobileGameCollectionExperiment)
import c from "c" /* 568 */;
...
export const useIsMobileGameCollectionExperimentEnabled = ReactCompilerGating.isReactCompilerEnabled() ? ((location) => {
  const cResult = c.c(2);
