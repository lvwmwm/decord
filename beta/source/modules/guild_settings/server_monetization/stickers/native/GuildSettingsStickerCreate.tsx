...
// Dependencies: [5, 32, 19, 17, 5710, 5753, 1078, 1379, 2026, 21, 4790, 580, 7256, 11436, 5845, 4445, 5388, 18029, 10716, 5137, 4786, 1119, 4687, 2112, 5220, 5218, 5373, 10730, 18030, 10475, 7409, 1401, 9067, 6878, 7364, 2]

// Module 18028 (GuildSettingsStickerCreate)
...
export default noop.forwardRef((stickerId, ref) => {
  ...
  if (null == stickerId) {
    ...
    items2[2] = onPressEmoji(stickerId(4786).Text, obj10);
    ...
    obj12.variant = str;
    items2[3] = tmp27(stickerId(5220).Button, obj12);
  ...
  const items4 = [onPressEmoji(stickerId(4786).Text, obj15), , , , , , ];
  ...
  if (null != tmp16Result) {
    ...
    let tmp32Result = tmp32(tmp14(10730), obj17);
    const tmp14Result4 = tmp14(10730);
  } else if (null != uri) {
    ...
    tmp32Result = tmp32(tmp31(18030).StickerPlusIcon, { size: "lg" });
  }
  obj16.children = tmp32Result;
  items4[1] = onPressEmoji(stickerId(5373).PressableHighlight, obj16);
  ...
  items4[2] = onPressEmoji(stickerId(4786).Text, obj20);
  const obj21 = {
  ...
  if (null != first1) {
    ...
    obj22.src = emojiURL;
    let tmp32Result2 = tmp32(tmp14(7409), obj22);
    const tmp14Result5 = tmp14(7409);
  } else {
    tmp32Result2 = tmp32(tmp31(9067).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = onPressEmoji(stickerId(4786).Text, { variant: "text-md/semibold", color: "input-placeholder-text-default", children: combined });
  obj21.children = items5;
  items4[3] = closure_17(stickerId(5373).PressableHighlight, obj21);
  ...
  items4[4] = onPressEmoji(stickerId(6878).TextInput, obj24);
  ...
  items4[5] = onPressEmoji(stickerId(7364).TextArea, obj26);
  const obj27 = {
  ...
  items4[6] = onPressEmoji(stickerId(5220).Button, obj27);
  obj14.children = items4;
  items3[1] = closure_17(stickerId(5218).Stack, obj14);
