...
// Dependencies: [1078, 1119, 8678, 2112, 8679, 2]
// Exports: getChannelPermissionSpecMap

// Module 8677 (ChannelPermissionsConstants)
import util from "util" /* 1119 */;
import HelpdeskUtilsDefault from "HelpdeskUtils" /* 2112 */;
import ForumPlatformUtilsDefault from "ForumPlatformUtils" /* 8678 */;
import GuildTiVPlatformUtilsDefault from "GuildTiVPlatformUtils" /* 8679 */;
...
export const getChannelPermissionSpecMap = function getChannelPermissionSpecMap(type, arg1, createPostsDisabled) {
  ...
  if (arg1) {
    if (GUILD_CATEGORY === type) {
      let M2iEy3 = tmp8(1119).t["o/vBzj"];
    } else {
      if (tmp3.GUILD_VOICE !== type) {
        if (tmp3.GUILD_STAGE_VOICE !== type) {
          M2iEy3 = tmp8(1119).t["3jG0Bo"];
        }
      }
      M2iEy3 = tmp8(1119).t.ejL1Wo;
    }
  } else if (type === GUILD_CATEGORY) {
    M2iEy3 = tmp8(1119).t.SzosGs;
  } else {
    M2iEy3 = tmp8(1119).t.M2iEy3;
  }
  ...
  if (type === tmp3.GUILD_CATEGORY) {
    ...
    let stringResult1 = intl4.string(tmp10(1119).t["9qLtWs"]);
  } else {
    const intl3 = tmp10(1119).intl;
    stringResult1 = intl3.string(tmp10(1119).t.nAw15L);
  }
  const obj3 = { title: stringResult1, description: null, flag: null };
  if (tmp3.GUILD_CATEGORY === type) {
    let ydL28i = tmp8(1119).t.KJ2JnG;
  } else if (tmp3.GUILD_VOICE === type) {
    ydL28i = tmp8(1119).t["+gl2ne"];
  } else if (tmp3.GUILD_STAGE_VOICE === type) {
    ydL28i = tmp8(1119).t.SDX669;
  } else {
    ydL28i = tmp8(1119).t.ydL28i;
  }
  ...
  obj4.title = intl5.string(tmp10(1119).t.ICb6am);
  if (tmp3.GUILD_CATEGORY === type) {
    let hOMXOv = tmp8(1119).t.TyyCMD;
  } else if (tmp3.GUILD_STAGE_VOICE === type) {
    hOMXOv = tmp8(1119).t.hcw4mx;
  } else {
    hOMXOv = tmp8(1119).t.hOMXOv;
  }
  ...
  const intl6 = tmp10(1119).intl;
  obj5.title = intl6.string(tmp10(1119).t["/ADKmM"]);
  if (type === tmp3.GUILD_CATEGORY) {
    let CYBZry = tmp10(1119).t["K5+ZZ7"];
  } else {
    CYBZry = tmp10(1119).t.CYBZry;
  }
  ...
  const intl7 = tmp10(1119).intl;
  obj6.title = intl7.string(tmp10(1119).t.zJrgTG);
  if (tmp3.GUILD_CATEGORY === type) {
    let lUCs1n = tmp8(1119).t["3YFAAX"];
  } else {
    if (tmp3.GUILD_VOICE !== type) {
      if (tmp3.GUILD_STAGE_VOICE !== type) {
        lUCs1n = tmp8(1119).t.q4g2aI;
      }
    }
    lUCs1n = tmp8(1119).t.lUCs1n;
  }
  ...
  if (GUILD_THREADS_ONLY.has(type)) {
    const intl10 = tmp10(1119).intl;
    let stringResult2 = intl10.string(tmp10(1119).t.nJwAHX);
  } else if (type === tmp3.GUILD_CATEGORY) {
    const intl9 = tmp10(1119).intl;
    stringResult2 = intl9.string(tmp10(1119).t.S1VOwd);
  } else {
    const intl8 = tmp10(1119).intl;
    stringResult2 = intl8.string(tmp10(1119).t.T32rkC);
  }
  const obj7 = { title: stringResult2, description: null, flag: null };
  if (tmp3.GUILD_CATEGORY === type) {
    let WQ6zpT = tmp8(1119).t.IjeLuu;
  ...
  const intl12 = tmp10(1119).intl;
  obj12.title = intl12.string(tmp10(1119).t["969dEL"]);
  if (type === tmp3.GUILD_CATEGORY) {
    let XFFhA0 = tmp10(1119).t["7zlUay"];
  } else {
    XFFhA0 = tmp10(1119).t.XFFhA0;
  }
  ...
  const intl13 = tmp10(1119).intl;
  obj13.title = intl13.string(tmp10(1119).t["3AS4UM"]);
  if (type === tmp3.GUILD_CATEGORY) {
    let WK9r7F = tmp10(1119).t.XREf9l;
  } else {
    WK9r7F = tmp10(1119).t.WK9r7F;
  }
  ...
  const intl14 = tmp10(1119).intl;
  obj14.title = intl14.string(tmp10(1119).t.yEoJAr);
  if (tmp3.GUILD_CATEGORY === type) {
    let PVjR1Y = tmp8(1119).t.pZT2Zh;
  } else if (tmp3.GUILD_VOICE === type) {
    PVjR1Y = tmp8(1119).t.xSSbIs;
  } else {
    PVjR1Y = tmp8(1119).t.PVjR1Y;
  }
  ...
  const intl15 = tmp10(1119).intl;
  obj15.title = intl15.string(tmp10(1119).t["+bxf3H"]);
  if (type === tmp3.GUILD_CATEGORY) {
    let Qc5vOr = tmp10(1119).t.mWAbK4;
  } else {
    Qc5vOr = tmp10(1119).t.Qc5vOr;
  }
  ...
  const intl16 = tmp10(1119).intl;
  obj16.title = intl16.string(tmp10(1119).t.ERNhYf);
  if (type === tmp3.GUILD_CATEGORY) {
    let VF4fZZ = tmp10(1119).t["39whJ4"];
  } else {
    VF4fZZ = tmp10(1119).t.VF4fZZ;
  }
  ...
  if (type === tmp3.GUILD_STAGE_VOICE) {
    const intl18 = tmp10(1119).intl;
    let stringResult3 = intl18.string(tmp10(1119).t.VDUAHO);
  } else {
    const intl17 = tmp10(1119).intl;
    stringResult3 = intl17.string(tmp10(1119).t.Y78KGC);
  }
  const obj17 = { title: stringResult3, description: null, flag: null };
  if (type === tmp3.GUILD_CATEGORY) {
    let prop = tmp10(1119).t["HOhg/B"];
  } else if (type === tmp3.GUILD_STAGE_VOICE) {
    prop = tmp10(1119).t.rZn1oO;
  } else {
    prop = tmp10(1119).t["6IUSdt"];
  }
  ...
  const intl19 = tmp10(1119).intl;
  obj18.title = intl19.string(tmp10(1119).t["6lU9xM"]);
  if (tmp3.GUILD_CATEGORY === type) {
    let v5R9nYh = tmp8(1119).t["5R9nYh"];
  } else if (tmp3.GUILD_ANNOUNCEMENT === type) {
    const intl20 = tmp8(1119).intl;
    const obj19 = { articleURL: HelpdeskUtilsDefault.getArticleURL(constants3.ANNOUNCEMENT_CHANNELS) };
    v5R9nYh = intl20.format(tmp8(1119).t.XRxOo0, obj19);
  } else {
    v5R9nYh = tmp8(1119).t["SeA+G9"];
  }
  ...
  const intl21 = tmp10(1119).intl;
  obj21.title = intl21.string(tmp10(1119).t.Y5BI39);
  if (type === tmp3.GUILD_CATEGORY) {
    let gmbD87 = tmp10(1119).t.gmbD87;
  } else {
    gmbD87 = tmp10(1119).t["0l2EjL"];
  }
  ...
  const intl22 = tmp10(1119).intl;
  obj22.title = intl22.string(tmp10(1119).t.kqcjeV);
  if (type === tmp3.GUILD_CATEGORY) {
    let Ha1xbw = tmp10(1119).t.C4t1Xu;
  } else {
    Ha1xbw = tmp10(1119).t.Ha1xbw;
  }
  ...
  const intl23 = tmp10(1119).intl;
  obj23.title = intl23.string(tmp10(1119).t.Aj9ruN);
  if (type === tmp3.GUILD_CATEGORY) {
    let qEbw4W = tmp10(1119).t["Pf0e/Q"];
  } else {
    qEbw4W = tmp10(1119).t.qEbw4W;
  }
  ...
  const intl24 = tmp10(1119).intl;
  const string = intl24.string;
  const t = tmp10(1119).t;
  if (hasItem) {
  ...
  if (tmp3.GUILD_CATEGORY === type) {
    ...
    if (tmp3.GUILD_FORUM !== type) {
      if (tmp3.GUILD_MEDIA !== type) {
        RqCc7i = tmp8(1119).t.cuMfH0;
      }
    }
    RqCc7i = tmp8(1119).t.RqCc7i;
  }
  ...
  const intl25 = tmp10(1119).intl;
  obj26.title = intl25.string(tmp10(1119).t.mMbwh7);
  if (type === tmp3.GUILD_CATEGORY) {
    let CpakGz = tmp10(1119).t.b7pc9U;
  } else {
    CpakGz = tmp10(1119).t.CpakGz;
  }
  ...
  const intl26 = tmp10(1119).intl;
  obj27.title = intl26.string(tmp10(1119).t.nkoPOt);
  if (type === tmp3.GUILD_CATEGORY) {
    let ReG3gG = tmp10(1119).t["D+qW0J"];
  } else {
    ReG3gG = tmp10(1119).t.ReG3gG;
  }
  ...
  const intl27 = tmp10(1119).intl;
  obj28.title = intl27.string(tmp10(1119).t.WlWSBT);
  if (type === tmp3.GUILD_CATEGORY) {
    let BhEo9V = tmp10(1119).t.gavGfv;
  } else {
    BhEo9V = tmp10(1119).t.BhEo9V;
  }
  ...
  const intl28 = tmp10(1119).intl;
  obj29.title = intl28.string(tmp10(1119).t.UMQ7Ww);
  if (type === tmp3.GUILD_CATEGORY) {
    let ckKKIO = tmp10(1119).t["18Ya7L"];
  } else {
    ckKKIO = tmp10(1119).t.ckKKIO;
  }
  ...
  const intl29 = tmp10(1119).intl;
  obj30.title = intl29.string(tmp10(1119).t.S0W8Z5);
  const GUILD_CATEGORY2 = tmp3.GUILD_CATEGORY;
  if (arg1) {
    if (GUILD_CATEGORY2 === type) {
      let XcrieN = tmp8(1119).t.XcrieN;
    } else if (tmp3.GUILD_STAGE_VOICE === type) {
      XcrieN = tmp8(1119).t.SOFNhP;
    } else {
      if (tmp3.GUILD_TEXT !== type) {
        if (tmp3.GUILD_FORUM !== type) {
          if (tmp3.GUILD_MEDIA !== type) {
            XcrieN = tmp8(1119).t.j4AyO8;
          }
        }
      }
      XcrieN = tmp8(1119).t.LsS8xT;
    }
  } else if (GUILD_CATEGORY2 === type) {
    XcrieN = tmp8(1119).t.stA0Hl;
  } else if (tmp3.GUILD_STAGE_VOICE === type) {
    XcrieN = tmp8(1119).t["G9+Qie"];
  } else {
    if (tmp3.GUILD_TEXT !== type) {
      if (tmp3.GUILD_FORUM !== type) {
        if (tmp3.GUILD_MEDIA !== type) {
          XcrieN = tmp8(1119).t.HvG8uR;
        }
      }
    }
    XcrieN = tmp8(1119).t["QU/Rw8"];
  }
  ...
  const intl30 = tmp10(1119).intl;
  obj31.title = intl30.string(tmp10(1119).t["8w1tIR"]);
  if (tmp3.GUILD_CATEGORY === type) {
    let iXhS6R = tmp8(1119).t.iXhS6R;
  } else if (tmp3.GUILD_STAGE_VOICE === type) {
    iXhS6R = tmp8(1119).t.a8n741;
  } else {
    if (tmp3.GUILD_TEXT !== type) {
      if (tmp3.GUILD_FORUM !== type) {
        if (tmp3.GUILD_MEDIA !== type) {
          iXhS6R = tmp8(1119).t["568E6d"];
        }
      }
    }
    iXhS6R = tmp8(1119).t["+VXsJI"];
  }
  ...
  const intl31 = tmp10(1119).intl;
  obj32.title = intl31.string(tmp10(1119).t.FlNoSV);
  if (tmp3.GUILD_CATEGORY === type) {
    let AuEQEC = tmp8(1119).t["ryG0/J"];
  } else {
    if (tmp3.GUILD_TEXT !== type) {
      if (tmp3.GUILD_FORUM !== type) {
        if (tmp3.GUILD_MEDIA !== type) {
          if (tmp3.GUILD_STAGE_VOICE === type) {
            AuEQEC = tmp8(1119).t.swJcN6;
          } else {
            AuEQEC = tmp8(1119).t.RY8rIc;
          }
        }
      }
    }
    AuEQEC = tmp8(1119).t.AuEQEC;
  }
  ...
  const intl32 = tmp10(1119).intl;
  obj33.title = intl32.string(tmp10(1119).t.rLSGeh);
  if (tmp3.GUILD_CATEGORY === type) {
    let RyEwla = tmp8(1119).t.maNzCO;
  } else {
    if (tmp3.GUILD_FORUM !== type) {
      if (tmp3.GUILD_MEDIA !== type) {
        RyEwla = tmp8(1119).t.qinvMU;
      }
    }
    RyEwla = tmp8(1119).t.RyEwla;
  }
  ...
  const intl33 = tmp10(1119).intl;
  obj34.title = intl33.string(tmp10(1119).t["3TzAk0"]);
  if (tmp3.GUILD_CATEGORY === type) {
    let qPUPip = tmp8(1119).t.bgIY3H;
  } else {
    if (tmp3.GUILD_FORUM !== type) {
      if (tmp3.GUILD_MEDIA !== type) {
        qPUPip = tmp8(1119).t.czqMLp;
      }
    }
    qPUPip = tmp8(1119).t.qPUPip;
  }
  ...
  const intl34 = tmp10(1119).intl;
  obj35.title = intl34.string(tmp10(1119).t.Bco7NG);
  if (tmp3.GUILD_CATEGORY === type) {
    const intl37 = tmp8(1119).intl;
    const obj36 = { helpCenterArticle: HelpdeskUtilsDefault.getArticleURL(constants3.SOUNDBOARD) };
    let formatResult = intl37.format(tmp8(1119).t["0kBp/0"], obj36);
  } else {
    if (tmp3.GUILD_TEXT !== type) {
      if (tmp3.GUILD_FORUM !== type) {
        if (tmp3.GUILD_MEDIA !== type) {
          const intl35 = tmp8(1119).intl;
          const obj38 = { helpCenterArticle: HelpdeskUtilsDefault.getArticleURL(constants3.SOUNDBOARD) };
          formatResult = intl35.format(tmp8(1119).t.GEi6Ym, obj38);
        }
      }
    }
    const intl36 = tmp8(1119).intl;
    const obj40 = { helpCenterArticle: HelpdeskUtilsDefault.getArticleURL(constants3.SOUNDBOARD) };
    formatResult = intl36.format(tmp8(1119).t["6eYqU1"], obj40);
  }
  ...
  const intl38 = tmp10(1119).intl;
  obj42.title = intl38.string(tmp10(1119).t.pwaVJ6);
  obj42.description = tmp10(1119).t.qDpPtX;
  ...
  const intl39 = tmp10(1119).intl;
  obj43.title = intl39.string(tmp10(1119).t["08zAV7"]);
  if (tmp3.GUILD_CATEGORY === type) {
    let fUYPly = tmp8(1119).t.fUYPly;
  } else if (tmp3.GUILD_STAGE_VOICE === type) {
    fUYPly = tmp8(1119).t.BJKqsW;
  } else {
    if (tmp3.GUILD_TEXT !== type) {
      if (tmp3.GUILD_FORUM !== type) {
        if (tmp3.GUILD_MEDIA !== type) {
          fUYPly = tmp8(1119).t.s2eihY;
        }
      }
    }
    fUYPly = tmp8(1119).t["3GJwsc"];
  }
  ...
  const intl40 = tmp10(1119).intl;
  obj44.title = intl40.string(tmp10(1119).t.BVK71i);
  if (tmp3.GUILD_CATEGORY === type) {
    const intl45 = tmp8(1119).intl;
    const obj45 = { keybind: null };
    const intl46 = tmp8(1119).intl;
    obj45.keybind = intl46.string(tmp8(1119).t.DkSwJ2);
    let formatResult1 = intl45.format(tmp8(1119).t.g5MzON, obj45);
  } else {
    if (tmp3.GUILD_TEXT !== type) {
      if (tmp3.GUILD_FORUM !== type) {
        if (tmp3.GUILD_MEDIA !== type) {
          const intl41 = tmp8(1119).intl;
          const obj46 = { keybind: null };
          const intl42 = tmp8(1119).intl;
          obj46.keybind = intl42.string(tmp8(1119).t.DkSwJ2);
          formatResult1 = intl41.format(tmp8(1119).t.Ij0yKX, obj46);
        }
      }
    }
    const intl43 = tmp8(1119).intl;
    const obj47 = { keybind: null };
    const intl44 = tmp8(1119).intl;
    obj47.keybind = intl44.string(tmp8(1119).t.DkSwJ2);
    formatResult1 = intl43.format(tmp8(1119).t["4nbjL0"], obj47);
  }
  ...
  const intl47 = tmp10(1119).intl;
  obj48.title = intl47.string(tmp10(1119).t["8EI30/"]);
  if (tmp3.GUILD_CATEGORY === type) {
    let KYDG2K = tmp8(1119).t.bcuobK;
  } else if (tmp3.GUILD_STAGE_VOICE === type) {
    KYDG2K = tmp8(1119).t.EbvdH9;
  } else {
    if (tmp3.GUILD_TEXT !== type) {
      if (tmp3.GUILD_FORUM !== type) {
        if (tmp3.GUILD_MEDIA !== type) {
          KYDG2K = tmp8(1119).t.LW5C9P;
        }
      }
    }
    KYDG2K = tmp8(1119).t.KYDG2K;
  }
  ...
  const intl48 = tmp10(1119).intl;
  obj49.title = intl48.string(tmp10(1119).t["9L47Fr"]);
  if (tmp3.GUILD_CATEGORY === type) {
    let amZ5vn = tmp8(1119).t.amZ5vn;
  } else {
    if (tmp3.GUILD_TEXT !== type) {
      if (tmp3.GUILD_FORUM !== type) {
        if (tmp3.GUILD_MEDIA !== type) {
          amZ5vn = tmp8(1119).t.UAdIxo;
        }
      }
    }
    amZ5vn = tmp8(1119).t["d+i1nX"];
  }
  ...
  const intl49 = tmp10(1119).intl;
  obj50.title = intl49.string(tmp10(1119).t.YtjJPQ);
  if (tmp3.GUILD_CATEGORY === type) {
    let cbdQy2 = tmp8(1119).t.XmoyRD;
  } else if (tmp3.GUILD_STAGE_VOICE === type) {
    cbdQy2 = tmp8(1119).t.bizKz6;
  } else {
    if (tmp3.GUILD_TEXT !== type) {
      if (tmp3.GUILD_FORUM !== type) {
        if (tmp3.GUILD_MEDIA !== type) {
          cbdQy2 = tmp8(1119).t.nSD1ah;
        }
      }
    }
    cbdQy2 = tmp8(1119).t.cbdQy2;
  }
  ...
  const intl50 = tmp10(1119).intl;
  obj51.title = intl50.string(tmp10(1119).t["5kicT2"]);
  if (type === tmp3.GUILD_CATEGORY) {
    let uzlYFE = tmp10(1119).t.T1lMSl;
  } else {
    uzlYFE = tmp10(1119).t.uzlYFE;
  }
  ...
  if (GUILD_THREADS_ONLY3.has(type)) {
    const intl53 = tmp10(1119).intl;
    let stringResult5 = intl53.string(tmp10(1119).t.ossiZD);
  } else if (type === tmp3.GUILD_CATEGORY) {
    const intl52 = tmp10(1119).intl;
    stringResult5 = intl52.string(tmp10(1119).t.QKe7Q3);
  } else {
    const intl51 = tmp10(1119).intl;
    stringResult5 = intl51.string(tmp10(1119).t.kEqgr7);
  }
  const obj52 = { title: stringResult5, description: null, flag: null };
  if (tmp3.GUILD_CATEGORY === type) {
    let S31soU = tmp8(1119).t.S31soU;
  } else {
    if (tmp3.GUILD_FORUM !== type) {
      if (tmp3.GUILD_MEDIA !== type) {
        S31soU = tmp8(1119).t.yvan0j;
      }
    }
    S31soU = tmp8(1119).t["XLi/jG"];
  }
  ...
  const intl54 = tmp10(1119).intl;
  obj53.title = intl54.string(tmp10(1119).t["25rKnX"]);
  if (type === tmp3.GUILD_CATEGORY) {
    let prop2 = tmp10(1119).t["+M1yLj"];
  } else {
    prop2 = tmp10(1119).t["5SDtGB"];
  }
  ...
  const intl55 = tmp10(1119).intl;
  obj54.title = intl55.string(tmp10(1119).t.QwbTSa);
  if (type === tmp3.GUILD_CATEGORY) {
    let Chg2zd = tmp10(1119).t["hBS/zn"];
  } else {
    Chg2zd = tmp10(1119).t.Chg2zd;
  }
  ...
  if (GUILD_THREADS_ONLY4.has(type)) {
    const intl58 = tmp10(1119).intl;
    let stringResult6 = intl58.string(tmp10(1119).t.fqhqWm);
  } else if (type === tmp3.GUILD_CATEGORY) {
    const intl57 = tmp10(1119).intl;
    stringResult6 = intl57.string(tmp10(1119).t["5QlVGy"]);
  } else {
    const intl56 = tmp10(1119).intl;
    stringResult6 = intl56.string(tmp10(1119).t.fTE74g);
  }
  const obj55 = { title: stringResult6, description: null, flag: null };
  if (tmp3.GUILD_CATEGORY === type) {
    let XTnrPH = tmp8(1119).t.DlIVcN;
  } else {
    if (tmp3.GUILD_FORUM !== type) {
      if (tmp3.GUILD_MEDIA !== type) {
        XTnrPH = tmp8(1119).t.xHO6Me;
      }
    }
    XTnrPH = tmp8(1119).t.XTnrPH;
  }
  ...
  const intl59 = tmp10(1119).intl;
  obj56.title = intl59.string(tmp10(1119).t.HIgA5a);
  if (type === tmp3.GUILD_CATEGORY) {
    let CP2sz4 = tmp10(1119).t.CP2sz4;
  } else {
    CP2sz4 = tmp10(1119).t["4pO/TY"];
  }
  ...
  const intl60 = tmp10(1119).intl;
  obj57.title = intl60.string(tmp10(1119).t.qyjZua);
  if (type === tmp3.GUILD_CATEGORY) {
    let sPoBLa = tmp10(1119).t.XpibmC;
  } else {
    sPoBLa = tmp10(1119).t.sPoBLa;
  }
  ...
  const intl61 = tmp10(1119).intl;
  obj58.title = intl61.string(tmp10(1119).t.VBwkUf);
