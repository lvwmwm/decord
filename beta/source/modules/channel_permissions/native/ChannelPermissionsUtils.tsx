...
// Dependencies: [1078, 1245, 4725, 9816, 1984, 11729, 2]
// Exports: openAddMembersActionSheet, openChannelMembersActionSheet

// Module 11728 (channel_permissions/ChannelPermissionsUtils)
...
export const openAddMembersActionSheet = function openAddMembersActionSheet(stateFromStores) {
  ...
  obj2.openLazy(asyncRequireImpl(9816, dependencyMap.paths), "channel-add-members-" + stateFromStores.id, { channel: stateFromStores, canSkip: flag });
};
export const openChannelMembersActionSheet = function openChannelMembersActionSheet(id, guild_id) {
  ...
  const obj2 = ActionSheetActionCreatorsDefault;
  obj2.openLazy(asyncRequireImpl(11729, dependencyMap.paths), "channel-members-" + id, { channelId: id, guildId: guild_id });
};
