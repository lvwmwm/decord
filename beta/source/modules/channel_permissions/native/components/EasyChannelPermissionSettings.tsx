...
// Dependencies: [32, 5, 19, 17, 17293, 2045, 2109, 2103, 2067, 4399, 4409, 1376, 8677, 1078, 21, 4758, 580, 558, 568, 1488, 11730, 504, 9801, 9802, 9803, 1119, 4911, 5110, 9817, 4404, 5186, 7446, 5903, 1181, 11458, 5822, 11728, 5845, 4938, 9868, 9869, 17294, 17296, 2]

// Module 17292 (EasyChannelPermissionSettings)
...
import ChannelSettingsPermissionsStore from "ChannelSettingsPermissionsStore" /* 17293 */;
...
const SettingMode = fn(8677).SettingMode;
      ...
      try {
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            const result = v2(9801).isPrivateGuildChannel(accessPermissions);
            const obj9 = v2(9801);
            const tmp21 = v2;
            closure_128_0 = v2(9801).flipEveryonePermission(accessPermissions, accessPermissions, result);
            ...
            if (!tmp7) {
              v2 = 1;
              dependencyMap = 1;
              const obj4 = { value: tmp21(9801).grantUserChannelAccess(accessPermissions, accessPermissions), done: false };
              return obj4;
            }
        ...
        v2 = 2;
        dependencyMap = 1;
        const obj7 = { value: tmp2(9802).savePermissionUpdates(closure_129_0.id, items), done: false };
        return obj7;
      } catch (tmp16) {
        dependencyMap = tmp;
        throw tmp16;
  ...
  closure_8 = async function _onPrivateChannelSwitchChange2(arg0, value) {
    if (dependencyMap === 2) {
      ...
      try {
          ...
          if (arg0 === 1) {
            ...
            if (null != guild_id.guild_id) {
              if (!privateToggleState) {
                c2 = 1;
                dependencyMap = 1;
                const obj6 = { value: tmp5(9803).checkChattableChannelThresholdMetAfterChannelPermissionDeny(guild_id, constants.VIEW_CHANNEL), done: false };
                return obj6;
              }
            }
          }
        ...
        closure_128_1 = tmp5(4911).computeChannelName(closure_129_0, UserStore, RelationshipStore);
