...
// Dependencies: [5, 109, 32, 19, 17, 2105, 2099, 2063, 1372, 8672, 1085, 21, 4756, 576, 4400, 7226, 4743, 504, 9823, 4467, 1115, 1177, 4752, 9839, 6869, 8997, 9843, 5736, 9848, 4909, 4901, 9824, 4453, 4723, 7395, 7394, 5186, 2]
// Exports: default

// Module 9838 (AddMembersActionSheet)
...
export default function AddMembersActionSheet(channel) {
  ...
  closure_2 = async function _handleAddPressed() {
    ...
    await closure_0(9824).savePermissionUpdates(channel.id, items);
    if (1 === tmp7) {
      dependencyMap = 0;
      c5 = 3;
    } else if (arg0 === 1) {
  ...
  if (null == stateFromStores) {
    ...
    if (channel.canSkip) {
      ...
      obj4.header = tmp11(tmp4(7394).BottomSheetTitleHeader, obj2);
      ...
      return tmp11(tmp4(7395).BottomSheet, obj4);
    }
