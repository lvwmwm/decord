...
// Dependencies: [8058, 8059, 5358, 5753, 2045, 2109, 2067, 1078, 5244, 5245, 10756, 1379, 12, 9553, 5693, 2023, 10115, 7610, 10757, 10716, 7613, 1401, 1119, 2]
// Exports: getAutocompleteOptions

// Module 10755 (AutocompleteOptions)
        ...
        if (prop) {
          if (queryEmojiResultsResult.emojis.locked.length > 0) {
            ...
            if (flag2) {
              ...
              const items2 = [query];
              const items3 = [channel, (arg0, arg1) => arg1 === channel(7613).StickerSendability.SENDABLE];
