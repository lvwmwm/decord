...
fn.__closure = { runOnUI: ReanimatedRexport.runOnUI, updateSharedValueIfChanged: "r" };
...
const obj3 = { runOnUI: ReanimatedRexport.runOnUI, updateSharedValueArrayIfChanged: "r" };
