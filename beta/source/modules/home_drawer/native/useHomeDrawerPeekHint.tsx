...
// Dependencies: [32, 19, 4782, 16366, 1078, 2042, 4529, 2031, 558, 568, 1489, 16374, 504, 16368, 4611, 7664, 4791, 5219, 16371, 2]

// Module 16373 (useHomeDrawerPeekHint)
...
const easing = Easing.inOut(fn(4529).Easing.cubic);
let closure_10 = [];
