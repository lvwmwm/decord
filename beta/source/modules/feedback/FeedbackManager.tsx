...
// Dependencies: [7493, 4813, 17016, 11784, 7492, 2023, 510, 12, 17017, 7397, 2]

// Module 17015 (feedback/FeedbackManager)
import _mod12 from "module_12" /* 12 */;
import UserSettings from "UserSettings" /* 2023 */;
import SearchResultsFeedbackExperiment from "SearchResultsFeedbackExperiment" /* 17017 */;
import HotspotStore from "hotspot/HotspotStore" /* 7493 */;
import RTCConnectionStore from "RTCConnectionStore" /* 4813 */;
import FeedbackOverrideStore from "FeedbackOverrideStore" /* 17016 */;
...
function recencyEligibilityCheck(cooldown, storageKey) {
  ...
  if (!isNaNResult) {
    const InAppFeedbackStates2 = tmp(2023).InAppFeedbackStates;
    InAppFeedbackStates2.updateSetting((arg0) => {
      const obj = {};
      const merged = Object.assign(arg0);
      obj2 = {};
...
obj3.hotspot = fn(7492).HotspotLocations.VOICE_CALL_FEEDBACK;
...
obj4.hotspot = fn(7492).HotspotLocations.REPORT_PROBLEM_POST_STREAM;
...
obj5.hotspot = fn(7492).HotspotLocations.VIDEO_BACKGROUND_FEEDBACK;
...
obj2[FeedbackType.ACTIVITY] = { cooldown: 0, chance: 0.5, group: FeedbackGroup.AV, hotspot: fn(7492).HotspotLocations.POST_ACTIVITY_FEEDBACK, storageKey: "lastActivityFeedback", feedbackType: FeedbackType.ACTIVITY };
const obj6 = { cooldown: 0, chance: 0.5, group: FeedbackGroup.AV, hotspot: fn(7492).HotspotLocations.POST_ACTIVITY_FEEDBACK, storageKey: "lastActivityFeedback", feedbackType: FeedbackType.ACTIVITY };
obj2[FeedbackType.IN_APP_REPORTS] = { cooldown: 172800000, chance: 0.5, group: FeedbackGroup.SAFETY, hotspot: fn(7492).HotspotLocations.IN_APP_REPORTS_FEEDBACK, storageKey: "inAppReportsFeedback", feedbackType: FeedbackType.IN_APP_REPORTS };
const obj8 = {};
const merged3 = Object.assign(obj);
obj8.group = FeedbackGroup.SEARCH;
obj8.hotspot = fn(7492).HotspotLocations.SEARCH_RESULTS_FEEDBACK;
...
const obj7 = { cooldown: 172800000, chance: 0.5, group: FeedbackGroup.SAFETY, hotspot: fn(7492).HotspotLocations.IN_APP_REPORTS_FEEDBACK, storageKey: "inAppReportsFeedback", feedbackType: FeedbackType.IN_APP_REPORTS };
obj2[FeedbackType.VIBEGRATIONS] = { cooldown: 3600000, chance: 1, group: FeedbackGroup.BUILDER, hotspot: fn(7492).HotspotLocations.VIBEGRATIONS_FEEDBACK, storageKey: "lastVibegrationsFeedback", feedbackType: FeedbackType.VIBEGRATIONS };
