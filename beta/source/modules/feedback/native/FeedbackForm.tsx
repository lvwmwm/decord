...
// Function ID: 11787
// Name: FeedbackForm
// Dependencies: [32, 19, 11784, 21, 4790, 580, 558, 568, 8580, 12, 11787, 5235, 8908, 4786, 5856, 11788, 1119, 2]

// Module 11786 (FeedbackForm)
...
require = fn;
let FeedbackRating = fn(11784).FeedbackRating;
const jsxProd = fn(21);
