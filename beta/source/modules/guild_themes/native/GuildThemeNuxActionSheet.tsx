...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((guildId) => {
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === v2) {
            ...
            v0(intl.string(closure_0(1119).t.fEptJP));
            v2(false);
            c5 = 3;
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            if (stateFromStores === guildId) {
              ...
              v2 = 2;
              c5 = 1;
              const obj5 = { value: guildId(tmp39[13]).saveGuildThemeNuxPreference(tmp48, closure_6), done: false };
              return obj5;
            } else {
              c5 = 3;
            }
  ...
  if (tmp10) {
    ...
    const obj11 = { messageType: tmp2(1181).HelpMessageTypes.WARNING, borderRadius: tmp21(580).radii.md, children: null };
    const intl7 = tmp2(1119).intl;
    obj11.children = intl7.string(tmp2(1119).t.tTHQAy);
    obj10.children = tmp20(tmp2(1181).HelpMessage, obj11);
  ...
  if (null != tmp7) {
    ...
    const obj13 = { messageType: tmp2(1181).HelpMessageTypes.ERROR, borderRadius: tmp21(580).radii.md, children: tmp7 };
    obj12.children = tmp20(tmp2(1181).HelpMessage, obj13);
