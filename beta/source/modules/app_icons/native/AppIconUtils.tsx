...
// Function ID: 13760
// Name: AppIconUtils
// Dependencies: [32, 5, 19, 17, 9467, 1078, 1378, 3, 1368, 13760, 9468, 558, 568, 577, 5235, 1245, 4490, 1119, 7658, 1613, 2]
// Exports: isAppIconsSupported, navigateToAppIconSettings, setAppIcon, useAppIcons

// Module 13759 (AppIconUtils)
...
const AppIconConstants = fn(9467);
...
if (PlatformUtils.isAndroid()) {
  let DCDIconManager = fn(13760).default;
} else {
