...
// Function ID: 8582
// Name: MediaSlider
// Dependencies: [32, 19, 17, 21, 4790, 1368, 5845, 12, 676, 5419, 5373, 1119, 8582, 8584, 4786, 8586, 8595, 580, 2]
// Exports: default

// Module 8581 (MediaSlider)
...
export default function MediaSlider(controls) {
  ...
  closure_9 = tmp8[1];
  const tmp11 = paused(5845)(() => _modDef12.throttle((arg0) => {
    closure_1_5(arg0);
  }, 100));
  closure_10 = tmp11;
  closure_11 = paused(5845)(() => _modDef12.throttle((arg0) => {
    closure_1_6(arg0);
    let str = "transparent";
    if (1 === arg0) {
  ...
  obj2.style = items3;
  const timeFormat = controls(5419).getTimeFormat(tmp3);
  ...
  if (paused) {
    let PauseIcon = tmp16(8582).PlayIcon;
  } else {
    PauseIcon = tmp16(8584).PauseIcon;
  }
  obj3.children = closure_6(PauseIcon, { size: "md", color: "white" });
  const items4 = [closure_6(controls(5373).PressableOpacity, obj3), , , ];
  ...
  obj4.style = items5;
  items4[1] = closure_6(controls(4786).Text, obj4);
  ...
  let obj = controls(5419);
  const tmp9Result = paused(8586);
  ...
  items7[1] = closure_6(paused(8586), obj11);
  ...
  const tmp9Result4 = paused(8586);
  obj13.children = controls(5419).getTimeFormat(ref.current);
  items4[3] = closure_6(controls(4786).Text, obj13);
