...
// Dependencies: [4993, 12958, 1984, 2]
// Exports: closeCreateGameInvitePostModal, openCreateGameInvitePostModal

// Module 12957 (CreateGameInvitePostModalActionCreators)
...
export const openCreateGameInvitePostModal = function openCreateGameInvitePostModal(merged) {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12958, dependencyMap.paths), merged, c3);
};
