...
// Dependencies: [32, 7799, 4909, 11, 4419, 4437, 2]
// Exports: getDefaultSearchState

// Module 7798 (GuildMemberSafetySearch)
...
prototype["updateSearchState"] = function updateSearchState(arg0) {
  ...
  this._searchState = {};
  this.hasDefaultQuery = _modDef4909(this._searchState, closure_4);
  return true;
};
