...
// Dependencies: [19, 17, 21, 4790, 5225, 580, 1368, 558, 568, 11513, 1119, 11514, 11519, 11520, 2]

// Module 11512 (virtual_currency/BalanceWidgetPill)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import util from "util" /* 1119 */;
import useVirtualCurrencyBalanceAnimationData from "useVirtualCurrencyBalanceAnimationData" /* 11513 */;
import OrbLottieAnimation from "OrbLottieAnimation" /* 11514 */;
import BalanceCounter from "BalanceCounter" /* 11519 */;
import AnimationUtils from "AnimationUtils" /* 11520 */;
...
let tmp4 = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[0] === balance) {
    ...
    const virtualCurrencyBalanceAnimationData = tmp(11513).useVirtualCurrencyBalanceAnimationData(tmp6);
        ...
        if (cResult[7] === tmp5) {
          ...
          if (cResult[11] === currentAnimationType) {
            ...
            if (cResult[14] === tmp9.orbsLottieContainer) {
              ...
              const obj5 = { value: balance, onValueChange, onValueReached, targetTotalCounterTime: tmp(11520).EXPECTED_ORB_LOTTIE_ANIMATION_DURATION_MS, style: tmp9.balanceText };
              const tmp24 = React3(tmp(11519).BalanceCounter, obj5);
          ...
          const tmp17 = React3(tmp(11514).OrbLottieAnimation, obj7);
