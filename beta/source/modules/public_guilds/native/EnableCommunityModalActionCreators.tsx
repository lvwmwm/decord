...
// Dependencies: [4961, 18102, 1984, 2]

// Module 18101 (EnableCommunityModalActionCreators)
...
export default {
  open() {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(18102, dependencyMap.paths), undefined, ENABLED_COMMUNITY_MODAL_KEY);
  },
  close() {
