...
// Dependencies: [5, 19, 17, 21, 4790, 12504, 2059, 12505, 12492, 12493, 4786, 1119, 12501, 2]
// Exports: default

// Module 12503 (GuildDirectoryCreateOrAddDescription)
...
export default function GuildDirectoryCreateOrAddDescription(directoryChannelId) {
  ...
  const intl = directoryChannelId(1119).intl;
  obj4.children = intl.string(directoryChannelId(1119).t["5bQcoa"]);
  const items = [closure_6(directoryChannelId(4786).Text, obj4), ];
  let obj5 = { style: tmp.description, variant: "text-sm/medium", color: "text-default", children: null };
  const intl2 = directoryChannelId(1119).intl;
  obj5.children = intl2.string(directoryChannelId(1119).t.Ie60Wc);
  items[1] = closure_6(directoryChannelId(4786).Text, obj5);
  obj3.children = items;
  ...
  const intl3 = directoryChannelId(1119).intl;
  obj6.buttonLabel = intl3.string(directoryChannelId(1119).t.H9jxS1);
  ...
  return closure_6(directoryChannelId(12493).GuildDirectoryAddModalScreen, obj);
};
