...
// Dependencies: [19, 17, 2041, 2105, 2063, 4405, 4937, 1372, 16829, 1074, 21, 576, 16791, 1364, 16792, 8536, 8619, 504, 16835, 16836, 4752, 1115, 1177, 4908, 5737, 8621, 8622, 11177, 11908, 16830, 16832, 11, 5339, 9867, 16838, 2]
// Exports: default

// Module 16834 (ICYMIMessageRow)
...
function ReplyMessageContent(message) {
  ...
  const context = noop.useContext(message(16792).ICYMIContext);
  ...
  const width = obj.useContext(tmp2(16792).ICYMIContext).width;
  let tmp8 = null;
  if (null != stateFromStores) {
    ...
    items4[1] = closure_14(tmp2(16792).ICYMIContext.Provider, obj12);
...
export default function MessageRowWrapper(arg0) {
  ...
  gravityMessage = gravityMessage(8621).useGravityMessage(message);
  const obj = gravityMessage(8621);
