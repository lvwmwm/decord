...
// Dependencies: [19, 17, 7768, 2041, 2063, 21, 16791, 576, 9756, 1115, 9753, 4909, 9790, 9866, 8622, 9887, 7584, 9878, 16832, 11, 4752, 9868, 5307, 1177, 504, 2]
// Exports: default
  ...
  obj7.children = closure_11(event(4752).Text, {
    ...
    children: noop.useMemo(() => {
      if (closure_2) {
        ...
        eventTimeData = tmp(9753).getEventTimeData(c3);
