...
// Dependencies: [5, 5107, 8076, 12351, 8479, 5356, 5346, 9419, 2]
...
// Module 12350 (PollUploadAttachmentActionCreators)
...
const POLL_ATTACHMENT_FOLDER = fn(8076).POLL_ATTACHMENT_FOLDER;
let size = fn(2);
