...
// Dependencies: [4959, 12451, 1980, 2]
// Exports: closeCreatePollModal, openCreatePollModal

// Module 12450 (PollCreationModalActionCreators)
...
export const openCreatePollModal = function openCreatePollModal(merged) {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12451, dependencyMap.paths), merged, c3);
};
