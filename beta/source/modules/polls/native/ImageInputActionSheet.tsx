...
// Dependencies: [19, 17, 8076, 21, 4758, 580, 558, 568, 12372, 4625, 4725, 4754, 1181, 1119, 7445, 12374, 7449, 2]

// Module 12373 (ImageInputActionSheet)
...
let closure_5 = fn(8076).POLL_CREATION_IMAGE_INPUT_ACTION_SHEET_KEY;
const jsxProd = fn(21);
