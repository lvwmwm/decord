...
// Dependencies: [32, 5107, 8027, 1078, 5213, 1612, 12122, 12121, 8025, 7768, 9526, 7770, 9522, 1982, 9419, 4627, 1614, 12295, 12, 12158, 12124, 4745, 12297, 12123, 4726, 4938, 10639, 2]

// Module 12555 (ApplicationCommandManager)
...
import ApplicationCommandActionCreators from "ApplicationCommandActionCreators" /* 8025 */;
  ...
  constructor(arg0) {
    ...
    obj.setPastedCommand = function setPastedCommand(arg0, channel) {
      ...
      if (null != command) {
        let tmp8 = null;
        if (null != application) {
          const obj5 = { type: tmp2(7770).ApplicationCommandSectionType.APPLICATION, id: null, icon: null, name: null, application: null };
        ...
        const initialValuesFromInteractionOptions = tmp2(9522).getInitialValuesFromInteractionOptions(command, interactionOptions);
        ...
        const obj6 = { channelId: channel.id, command, section: tmp8, location: tmp2(7770).ApplicationCommandTriggerLocations.PASTE, commandText: null };
        ...
        obj.setCommand(obj6);
        const tmp2Result = tmp2(9522);
      } else {
        ({ id, name } = parsed);
        obj.setPartialCommand(id, name, tmp2(7770).ApplicationCommandTriggerLocations.PASTE);
      }
    };
    ...
    obj.addCommandOptionParserRules = function addCommandOptionParserRules() {
      ...
      obj = {
        ...
        matchFunction(c22, activeCommand) {
          return obj(12121).getMatchedOptions(c22, activeCommand);
        },
        style() {
...
prototype["mergePropsAndUpdate"] = function mergePropsAndUpdate(editId) {
  ...
  if (text === editId.text) {
    ...
    if (tmp84) {
      ...
      if (!focused2) {
        const keyboardType = obj10(4627).getKeyboardType();
        focused2 = keyboardType !== obj10(1614).KeyboardTypes.SYSTEM;
        const obj6 = obj10(4627);
      }
    ...
    if (tmp140) {
      const keyboardType1 = tmp113(4627).getKeyboardType();
      tmp140 = keyboardType1 !== tmp113(1614).KeyboardTypes.SYSTEM;
      const tmp113Result2 = tmp113(4627);
    }
    if (tmp140) {
