...
// Dependencies: [32, 19, 2067, 9434, 5244, 1078, 7800, 9442, 558, 568, 504, 9444, 1374, 1982, 9439, 9547, 7802, 2]
// Exports: executeQuery, getCachedApplicationSection, getCachedCommand, getCachedResults, getChangeKeys, useCommand

// Module 9558 (ApplicationCommandQueryApi)
import c from "c" /* 568 */;
...
const ApplicationCommandBuiltIns = tmp(9444);
require = fn;
        ...
        if (null == first1) {
          if (!loading) {
            ...
            if (null != first2) {
              ...
              const tmp53 = tmp(9444).BUILT_IN_SECTIONS[BuiltInSectionId.BUILT_IN];
...
obj6.type = fn(7802).ApplicationCommandSectionType.APPLICATION;
const size = fn(2);
...
export const getCachedCommand = function getCachedCommand(type, commandId, applicationId) {
  ...
  if (null == commandId) {
    return { application: "Array", command: "unicodeVersion", section: "d" };
  } else {
...
export const useCommand = function useCommand(cResult, commandId) {
  ...
  return noop.useMemo(() => {
    ...
    return { command: "state", application: "toCharArray$esjava$1" };
  }, items);
};
