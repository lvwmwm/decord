...
// Dependencies: [2113, 5138, 1982, 9556, 38, 1119, 9554, 7800, 9557, 2]

// Module 12332 (ApplicationCommandValidators)
import _modDef38 from "module_38" /* 38 */;
import util from "util" /* 1119 */;
import Server from "Server" /* 1982 */;
import ApplicationCommandUtils from "ApplicationCommandUtils" /* 7800 */;
import ApplicationCommandOptionUtilsAll from "ApplicationCommandOptionUtils" /* 9554 */;
import ApplicationCommandChoiceUtils from "ApplicationCommandChoiceUtils" /* 9556 */;
...
export default {
  [fn(1982).ApplicationCommandOptionType.SUB_COMMAND]: () => ({ success: false }),
  [fn(1982).ApplicationCommandOptionType.SUB_COMMAND_GROUP]: () => ({ success: false }),
  [fn(1982).ApplicationCommandOptionType.BOOLEAN]: (type) => {
    if ("text" !== type.type) {
  ...
  [fn(1982).ApplicationCommandOptionType.STRING]: (type, type2, id) => {
    ...
    if (null != type2.choices) {
      const obj = { success: null != tmp3(9556).findChoiceStringValue(type2.choices, surrogate) };
      return obj;
    } else {
        ...
        if (null == surrogate) {
          ...
          if (undefined !== type2.maxLength) {
            if (undefined !== type2.minLength) {
              if (type2.minLength === type2.maxLength) {
                ...
                obj4.value = minLength3.toLocaleString(tmp3(1119).intl.currentLocale, { useGrouping: false });
                obj3.error = intl4.formatToPlainString(tmp3(1119).t["e+9/SY"], obj4);
                obj2 = obj3;
              }
            }
          }
          if (undefined !== type2.maxLength) {
            if (undefined !== type2.minLength) {
              ...
              obj6.minimum = minLength2.toLocaleString(tmp3(1119).intl.currentLocale, { useGrouping: false });
              const maxLength2 = type2.maxLength;
              obj6.maximum = maxLength2.toLocaleString(tmp3(1119).intl.currentLocale, { useGrouping: false });
              obj5.error = intl3.formatToPlainString(tmp3(1119).t.IE1sTh, obj6);
              obj2 = obj5;
            }
          }
          if (undefined !== type2.minLength) {
            ...
            obj8.minimum = minLength.toLocaleString(tmp3(1119).intl.currentLocale, { useGrouping: false });
            obj7.error = intl2.formatToPlainString(tmp3(1119).t.rXAFQD, obj8);
            obj2 = obj7;
            ...
            obj10.maximum = maxLength.toLocaleString(tmp3(1119).intl.currentLocale, { useGrouping: false });
            obj9.error = intl.formatToPlainString(tmp3(1119).t["ycEPx/"], obj10);
            obj2 = obj9;
          }
        }
      }
  ...
  [fn(1982).ApplicationCommandOptionType.INTEGER]: (type, type2, id) => {
    ...
    if (null != trimmed) {
      if (0 !== trimmed.length) {
        if (null != type2.choices) {
          const obj = { success: null != tmp3(9556).findChoiceNumberValue(type2.choices, trimmed) };
          return obj;
        } else {
          if (type2.autocomplete) {
            ...
            if (!isNaN(NumberResult)) {
              ...
              if (Number.isInteger(NumberResult)) {
                ...
                if (Number.isSafeInteger(NumberResult)) {
                  let obj3 = validateNumericOptionRange(NumberResult, type2, tmp3(1119).t["8Y5zsp"], tmp3(1119).t.CyRLmH, tmp3(1119).t["VD3Q+S"]);
                }
                return obj3;
              }
            }
  ...
  [fn(1982).ApplicationCommandOptionType.NUMBER]: (type, type2, id) => {
  ...
  [fn(1982).ApplicationCommandOptionType.USER]: (type, arg1, id2, id) => {
    if ("text" === type.type) {
      if (obj2.isSnowflake(type.text)) {
        return { success: true };
      } else {
        const tmpResult = tmp(9557);
  ...
  [fn(1982).ApplicationCommandOptionType.CHANNEL]: (type, arg1, id2, id) => {
    if ("text" === type.type) {
      if (obj2.isSnowflake(type.text)) {
        return { success: true };
      } else {
        const applicationCommandOption = tmp(9557).resolveApplicationCommandOption(type.text, id, id2);
        type = undefined;
        if (applicationCommandOption != null) {
          type = applicationCommandOption.type;
        }
  ...
  [fn(1982).ApplicationCommandOptionType.ROLE]: (type, arg1, id2, id) => {
    if ("text" === type.type) {
      if (obj2.isSnowflake(type.text)) {
        return { success: true };
      } else {
        const tmp3Result = tmp3(9557);
  ...
  [fn(1982).ApplicationCommandOptionType.MENTIONABLE]: (type, arg1, id2, id) => {
    if ("text" === type.type) {
      if (obj2.isSnowflake(type.text)) {
        return { success: true };
      } else {
        const applicationCommandOption = tmp4(9557).resolveApplicationCommandOption(type.text, id, id2);
  ...
  [fn(1982).ApplicationCommandOptionType.ATTACHMENT]: (type, name, channelId, arg3, arg4) => {
    if ("text" !== type.type) {
      return { success: false };
    } else {
