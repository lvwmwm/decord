...
// Dependencies: [32, 19, 17, 14959, 14960, 21, 4790, 580, 504, 5939, 4786, 1119, 5684, 8210, 4747, 4757, 14972, 1984, 10662, 5935, 5854, 14973, 558, 568, 1488, 6868, 7224, 7653, 8908, 2]

// Module 14971 (PasskeyInitStep)
...
function CredentialList(navigation) {
  ...
  if (0 === credentials.length) {
    ...
    const items1 = [closure_8(tmp(5939).PasskeysSpotIllustration, { scale: 0.6 }), ];
    ...
    items1[1] = closure_8(tmp(4786).Text, obj3);
    ...
    obj4.children = credentials.map((label) => {
      ...
      obj3.onPress = function onPress() {
        return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(14972, dependencyMap.paths), "WEBAUTHN_DELETE_SHEET_KEY", { credential, deleting, setDeleting });
      };
    ...
    return closure_8(tmp(5935).TableRowGroup, obj4);
  }
