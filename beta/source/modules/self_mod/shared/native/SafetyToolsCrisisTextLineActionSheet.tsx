...
// Dependencies: [19, 17, 10394, 21, 4790, 580, 558, 568, 1119, 4786, 5220, 4487, 10408, 10443, 2]

// Module 10442 (SafetyToolsCrisisTextLineActionSheet)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[2] !== tmp4.description) {
    ...
    const tmp11 = closure_6(tmp(4786).Text, obj2);
  ...
  if (cResult[5] !== trackAnalyticsEvent) {
    ...
    const tmp16 = closure_6(tmp(5220).Button, obj3);
  ...
  if (cResult[8] !== trackAnalyticsEvent) {
    ...
    const tmp21 = closure_6(tmp(5220).Button, obj4);
  ...
  const items = [closure_6(trackAnalyticsEvent(4786).Text, obj3), , ];
  ...
  items[1] = closure_6(trackAnalyticsEvent(5220).Button, obj4);
  ...
  items[2] = closure_6(trackAnalyticsEvent(5220).Button, obj5);
  obj2.children = items;
