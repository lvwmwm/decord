...
// Dependencies: [5, 14009, 9867, 1078, 7397, 18300, 577, 1275, 1476, 18301, 7617, 2]

// Module 18299 (GlobalDiscoveryServersFeaturedSearchManager)
...
let closure_6 = fn(9867).DISCOVERY_ALL_CATEGORIES_ID;
