...
// Dependencies: [8046, 4993, 10664, 1984, 2]
// Exports: closeCreateForumPostModal, openCreateForumPostModal

// Module 10663 (ForumComposerModalActionCreators)
...
export const openCreateForumPostModal = function openCreateForumPostModal(guildId) {
  ...
  if (!tmp4) {
    ...
    const result1 = tmp(8046).trackForumCreateNewPostStarted({ guildId: null, channelId: null });
    const obj3 = { guildId: null, channelId: null };
    const tmpResult = tmp(8046);
  }
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(10664, tmp2.paths), guildId, c3);
};
