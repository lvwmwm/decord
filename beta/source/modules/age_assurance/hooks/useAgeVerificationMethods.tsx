...
// Dependencies: [5, 32, 19, 8725, 8683, 504, 4968, 8684, 8712, 5084, 5089, 8860, 8689, 1115, 2]
// Exports: default
  ...
  const effect = noop.useEffect(() => {
    ...
    result.then((result) => {
      if (!c0) {
        ...
        if (result) {
          result = tmp4(8860).isGoogleWalletEnabled("age_verification_methods");
          const tmp4Result = tmp4(8860);
        }
        closure_4(result);
        tmp4 = require;
      }
