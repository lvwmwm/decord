...
// Dependencies: [5, 32, 19, 8762, 8727, 8746, 577, 2]
// Exports: useAgeVerificationMethodsV2

// Module 8761 (useAgeVerificationMethodsV2)
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            v0(false);
            v0 = 2;
            const result = closure_0(8727).isCurrentUserSuspended();
            const obj7 = closure_0(8746);
            if (result) {
              c5 = 4;
              c6 = 1;
