...
// Dependencies: [19, 21, 4790, 558, 568, 1119, 3038, 7233, 580, 4786, 5218, 8730, 8731, 2]

// Module 8763 (AgeVerificationOtherWindowScreen)
import c from "c" /* 568 */;
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((copy) => {
  ...
  if (cResult[4] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    const tmp18 = React3(tmp(7233).MobilePhoneIcon, obj2);
    cResult[4] = tmp18;
    let tmp15 = tmp18;
  } else {
    tmp15 = cResult[4];
  ...
  if (cResult[5] === tmp4.text) {
    ...
    if (cResult[8] === tmp11) {
      ...
      if (cResult[11] === tmp19) {
        ...
        obj3.children = React3(tmp(8731).ModalContent, obj4);
        const tmp30 = React3(tmp(8730).ModalScreen, obj3);
      ...
      const tmp26 = React4(tmp(5218).Stack, obj6);
      cResult[11] = tmp19;
      cResult[12] = tmp21;
      cResult[13] = tmp26;
      tmp24 = tmp26;
    ...
    const tmp23 = React3(tmp(4786).Text, obj7);
    cResult[8] = tmp11;
    cResult[9] = tmp4.text;
    cResult[10] = tmp23;
    tmp21 = tmp23;
