...
// Dependencies: [5, 32, 19, 17, 21, 5086, 5091, 1488, 4970, 8848, 8851, 8716, 8850, 8698, 8699, 5186, 4754, 1119, 3038, 5652, 5188, 8689, 2]
// Exports: default

// Module 8847 (AppStoreAgeVerificationScreen)
...
export default function AppStoreAgeVerificationScreen(modalSessionId) {
  ...
  const watchAgeVerificationStatusChange = modalSessionId(4970).useWatchAgeVerificationStatusChange(modalSessionId.onClose);
  ...
  if ("loading" === tmp5.type) {
    ...
    items3[1] = tmp10(tmp(4754).Text, obj4);
    ...
    const items4 = [tmp10(tmp(4754).Text, obj6), ];
    ...
    obj7.children = tmp10(tmp(5188).Button, obj8);
    items4[1] = tmp10(tmp(5652).ButtonGroup, obj7);
    obj5.children = items4;
    tmp15 = closure_9(closure_8, obj5);
  }
  let obj9 = { children: null };
  let obj2 = modalSessionId(4970);
  obj9.children = closure_7(modalSessionId(8699).ModalContent, { children: closure_7(modalSessionId(5186).Stack, { align: "center", justify: "center", spacing: 16, children: tmp15 }) });
  return closure_7(modalSessionId(8698).ModalScreen, obj9);
};
