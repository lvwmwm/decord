...
// Dependencies: [19, 17, 7828, 8528, 21, 580, 4790, 13513, 558, 568, 14935, 13514, 7461, 9133, 2]

// Module 14936 (EditProfileFrameSection)
import c from "c" /* 568 */;
...
import useProfileFrameSections from "useProfileFrameSections" /* 14935 */;
import noop from "module_19" /* 19 */;

require = fn;
const View = fn(17).View;
const isProfileFrameRecord = fn(7828).isProfileFrameRecord;
let closure_6 = fn(8528).PROFILE_FRAME_ASPECT_RATIO;
const jsxProd = fn(21);
({ jsx: closure_7, Fragment: closure_8, jsxs: closure_9 } = jsxProd);
const PX_8 = nativeDefault.space.PX_8;
const createStyles = fn(4790);
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(13513).GUTTER_SIZE }, rowSpacer: null, previewContainer: null };
...
const memoResult = noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? ((setSelectedProfileFrame) => {
  ...
  const mapped = substr.map((profileFrame, index) => {
    ...
    } else if (profileFrame === tmp(14935).SHOP_ITEM) {
