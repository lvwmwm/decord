...
// Dependencies: [19, 17, 7821, 21, 4790, 9074, 558, 568, 9077, 16148, 12, 2]

// Module 16149 (CollectiblesShopCardsGrid)
...
let obj2 = { rowContainer: { flexDirection: "row", gap: fn(9074).COLLECTIBLES_SHOP_CARD_GAP } };
...
let obj3 = { flexDirection: "row", gap: fn(9074).COLLECTIBLES_SHOP_CARD_GAP };
const size = fn(2);
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((preferVCPrice) => {
  ...
  const cardLayout = products(16148).useCardLayout();
  const columns = cardLayout.columns;
  const cardWidth = cardLayout.cardWidth;
  ...
  let obj = products(16148);
  obj2.contentContainerStyle = { gap: products(9074).COLLECTIBLES_SHOP_CARD_GAP, paddingTop, paddingBottom, width: cardLayout.rowWidth, alignSelf: "center" };
