...
// Dependencies: [19, 17, 7784, 21, 4756, 9044, 9047, 16150, 12, 2]
// Exports: default

// Module 16151 (CollectiblesShopCardsGrid)
...
let obj2 = { rowContainer: { flexDirection: "row", gap: fn(9044).COLLECTIBLES_SHOP_CARD_GAP } };
...
export default function CollectiblesShopCardsGrid(accessibilityLabel) {
  ...
  const cardLayout = products(16150).useCardLayout();
  ...
  let obj = products(16150);
  obj2.contentContainerStyle = { gap: products(9044).COLLECTIBLES_SHOP_CARD_GAP, paddingTop, paddingBottom, width: cardLayout.rowWidth, alignSelf: "center" };
