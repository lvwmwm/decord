...
// Function ID: 9150
// Name: SkeletonCard
// Dependencies: [19, 21, 4758, 580, 558, 568, 9042, 4497, 4759, 2]

// Module 9149 (SkeletonCard)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (undefined === width) {
    width = tmp(9042).COLLECTIBLES_SHOP_CARD_WIDTH;
  }
  if (height == null) {
    height = tmp(9042).COLLECTIBLES_SHOP_CARD_HEIGHT;
  }
  ...
  const animatedStyle = sharedValue(4497).useAnimatedStyle(L);
  ...
  if (COLLECTIBLES_SHOP_CARD_WIDTH === undefined) {
    COLLECTIBLES_SHOP_CARD_WIDTH = sharedValue(9042).COLLECTIBLES_SHOP_CARD_WIDTH;
  }
  let COLLECTIBLES_SHOP_CARD_HEIGHT = width.height;
  sharedValue = undefined;
  if (COLLECTIBLES_SHOP_CARD_HEIGHT == null) {
    COLLECTIBLES_SHOP_CARD_HEIGHT = sharedValue(9042).COLLECTIBLES_SHOP_CARD_HEIGHT;
  }
