...
// Dependencies: [32, 19, 17, 21, 4758, 580, 558, 568, 8444, 15599, 15600, 4726, 4725, 1119, 2876, 15604, 5188, 5186, 7397, 11205, 11202, 11203, 2]

// Module 15605 (DisplayNameStylesEffectPickerSheet)
import c from "c" /* 568 */;
...
let closure_10 = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[0] !== effectId) {
    ...
    let OpWJ3f = tmp(11205).DISPLAY_NAME_STYLES_EFFECT_NAMES[effectId];
    if (OpWJ3f == null) {
  ...
  if (cResult[4] === tmp4.effectCard) {
    ...
    const obj6 = { userId, userName: tmp5, effectDisplayType: tmp(11203).EffectDisplayType.STATIC, pendingDisplayNameStyles: displayNameStylesEffectConfig.previewStyles, style: tmp4.effectName, variant: "text-md/semibold" };
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((userId) => {
  ...
  const tmp = closure_9();
  let obj = userId(8444);
  const visibleEffectOrder = userId(15599).useVisibleEffectOrder();
  const obj2 = userId(15599);
  const displayNameStylesNewEffects = userId(15600).useDisplayNameStylesNewEffects(visibleEffectOrder);
  ...
  if (null != userId) {
    ...
    obj6.onPress = tmp8;
    obj5.trailing = closure_7(tmp2(5188).Button, obj6);
    obj4.header = closure_7(onSelectEffect(15604), obj5);
