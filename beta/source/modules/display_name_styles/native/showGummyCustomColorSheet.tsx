...
// Dependencies: [4725, 15609, 1984, 2]
// Exports: default

// Module 15608 (showGummyCustomColorSheet)
...
export default function showGummyCustomColorSheet(arg0) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15609, dependencyMap.paths), DisplayNameStylesGummyCustomColorSheet, arg0, "stack");
};
