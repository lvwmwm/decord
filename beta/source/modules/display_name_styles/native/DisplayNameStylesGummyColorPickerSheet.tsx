...
// Dependencies: [32, 19, 17, 1394, 1078, 21, 1393, 4758, 580, 558, 568, 11205, 1395, 560, 15607, 4726, 15608, 1245, 4725, 1119, 5188, 15604, 14882, 10626, 7397, 2]

// Module 15606 (DisplayNameStylesGummyColorPickerSheet)
...
import showGummyCustomColorSheetDefault from "showGummyCustomColorSheet" /* 15608 */;
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((selectedColors) => {
  ...
  const displayNameStylesEffectConfig = selectedColors(11205).useDisplayNameStylesEffectConfig(selectedColors(1395).DisplayNameEffect.GUMMY);
  ...
  if (cResult[2] === tmp6) {
    ...
    const tmp16 = onSelectColors(15607);
    ...
    const tmp16Result = onSelectColors(15607)(tmp(1395).DisplayNameEffect.GUMMY);
    AnalyticEvents = onSelectColors(15607)(tmp(1395).DisplayNameEffect.GUMMY).findIndex(tmp17);
    class I {
      constructor() {
        if (closure_3) {
          tmp2 = closure_0;
    ...
    if (cResult[13] === customSwatchEmpty) {
      ...
      if (cResult[17] !== tmp25) {
        ...
        const tmp29 = tmp23(tmp(5188).Button, obj4);
        cResult[17] = tmp25;
        cResult[18] = tmp29;
      } else {
        class Y {
        ...
        if (cResult[22] === tmp4.colorRowInset) {
          ...
          if (cResult[25] === tmp4.swatch) {
            ...
            if (tmp19) {
              ...
              tmp41Result = tmp41(tmp15(14882), tmp42);
            }
      ...
      const tmp32 = tmp23(tmp15(15604), obj7);
    ...
    cResult[15] = X;
    const findIndexResult = onSelectColors(15607)(tmp(1395).DisplayNameEffect.GUMMY).findIndex(tmp17);
  }
  class I {
    constructor() {
      if (closure_3) {
  ...
  let obj = selectedColors(11205);
  const tmp11 = onSelectColors;
  const tmp12Result = onSelectColors(15607)(selectedColors(1395).DisplayNameEffect.GUMMY);
  ...
  const tmp12 = onSelectColors(15607);
  ...
  obj3.trailing = closure_9(selectedColors(5188).Button, obj4);
  obj2.header = closure_9(onSelectColors(15604), obj3);
  ...
  if (findIndexResult >= 0) {
    ...
    tmp18Result = tmp18(tmp11(14882), obj10);
  }
  const items4 = [tmp18Result, ];
  const obj11 = { style: tmp.customIconOverlay, pointerEvents: "none", children: null };
  const tmp19 = onSelectColors(15604);
  const tmp22 = first1;
  obj11.children = closure_9(closure_5, { style: tmp.customIconScrim, children: closure_9(selectedColors(10626).PencilIcon, { color: "white", size: "sm" }) });
  ...
  items6[1] = closure_9(selectedColors(5188).Button, obj13);
