...
// Dependencies: [5, 1078, 3, 1095, 7397, 17832, 1235, 1245, 7754, 7750, 7740, 2]

// Module 17831 (JSWatchdogManager)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj6 = { value: tmp2(7740).getSession(), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          c3 = 3;
