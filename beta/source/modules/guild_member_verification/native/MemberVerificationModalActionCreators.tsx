...
// Dependencies: [5304, 1078, 1245, 5798, 4993, 5822, 1984, 2]

// Module 5821 (guild_member_verification/MemberVerificationModalActionCreators)
...
export default {
  openMemberVerificationModal(guildId, startCreateForumPostFlow) {
    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(5822, dependencyMap.paths), { guildId, onClose: startCreateForumPostFlow }, React4);
  },
