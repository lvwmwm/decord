...
// Dependencies: [21, 558, 568, 11873, 12400, 4752, 2]

// Module 13637 (ForLaterCardReminderHeader)
import jsxProd from "jsxProd" /* 21 */;
import c from "c" /* 568 */;
import SavedMessageUtils from "SavedMessageUtils" /* 11873 */;
...
export const ForLaterCardReminderHeader = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (cResult[0] === dueAt) {
    ...
    const dueInString = tmp(11873).useDueInString(tmp4);
    ...
    if (null == savedMessage.saveData.dueAt) {
      ...
      ClockIcon = tmp(4752).ClockIcon;
      obj2.IconComponent = ClockIcon;
      obj2.label = dueInText;
      obj2.isCritical = isOverdue;
      obj2.actions = actions;
      const tmp9 = jsx(tmp(12400).ForLaterCardStatusHeader, { IconComponent: null, label: null, isCritical: null, actions: null });
      cResult[3] = actions;
      cResult[4] = dueInText;
      cResult[5] = isOverdue;
      cResult[6] = tmp9;
  ...
  let tmp7 = null;
  if (null != savedMessage.saveData.dueAt) {
    const obj3 = { IconComponent: tmp(4752).ClockIcon, label: tmp5, isCritical: tmp6, actions };
    tmp7 = jsx(tmp(12400).ForLaterCardStatusHeader, { IconComponent: tmp(4752).ClockIcon, label: tmp5, isCritical: tmp6, actions });
  }
  return tmp7;
});
