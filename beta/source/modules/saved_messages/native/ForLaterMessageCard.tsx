...
// Dependencies: [5, 19, 17, 4395, 1074, 21, 4756, 576, 5824, 6852, 4752, 1115, 8179, 4714, 11957, 11964, 4959, 1241, 8104, 4348, 13594, 504, 13595, 13598, 12468, 12469, 2]
    ...
    if (null != savedMessageChannel) {
      if (obj2.useStateFromStores(items1, () => {
        ...
        if (null != savedMessage.saveData.dueAt) {
          ...
          tmp6Result = tmp6(tmp2(13598).ForLaterCardReminderHeader, obj5);
        }
