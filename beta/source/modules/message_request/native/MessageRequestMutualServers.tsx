...
// Dependencies: [19, 17, 21, 4756, 5801, 17349, 1115, 12871, 4752, 5339, 2]
// Exports: default

// Module 17348 (MessageRequestMutualServers)
...
export default function MessageRequestMutualServers(textVariant) {
  ...
  if (iconSize === undefined) {
    iconSize = iconSize(5801).GuildIconSizes.XXSMALL_12;
  }
  ...
  const mutualGuildsForMessageRequests = iconSize(17349).useMutualGuildsForMessageRequests(userId);
  ...
  if (tmp9) {
    ...
    tmp9 = closure_4(tmp4(12871).GuildIconPile, obj4);
  }
  const items1 = [tmp9, ];
  ...
  if (null != onPress) {
    ...
    if (length > 0) {
      ...
      tmp11Result = tmp11(tmp4(5339).PressableOpacity, obj6);
    }
  }
  return tmp11Result;
};
