...
// Dependencies: [19, 17, 21, 4790, 580, 10642, 11310, 4757, 10646, 1984, 10645, 5939, 5218, 4786, 1119, 3360, 5220, 12940, 2]
// Exports: default

// Module 17224 (FavoritesEmptyState)
...
export default function FavoritesEmptyState() {
  ...
  if (obj.useFavoritesAccess("favorites_empty_state").hasAccess) {
    ...
    obj6.icon = tmp8(tmp2(12940).PlusMediumIcon, {});
