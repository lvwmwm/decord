...
// Dependencies: [19, 2044, 21, 4909, 11241, 2019, 7442, 7394, 7444, 11216, 1115, 7622, 16450, 10889, 7434, 4453, 504, 2]
// Exports: default
...
function FavoritesGuildCategoryActionSheetConnected(category) {
  ...
  if (null != tmp3) {
    ...
    obj3.icon = tmp7(tmp4(7444).ActionSheetRow.Icon, obj4);
    obj3.onPress = function onPress() {
      closure_2.perform();
      onClose();
    };
    obj2.children = tmp7(tmp4(7444).ActionSheetRow, obj3);
    tmp7Result = tmp7(tmp4(7444).ActionSheetRow.Group, obj2);
  }
  ...
  if (setting) {
    ...
    obj9.icon = tmp7(tmp4(7444).ActionSheetRow.Icon, obj10);
    obj9.onPress = function onPress() {
      ClipboardUtils.copy(category.id);
      ToastUtils.presentIdCopied();
      onClose();
    };
    obj8.children = tmp7(tmp4(7444).ActionSheetRow, obj9);
    tmp7Result2 = tmp7(tmp4(7444).ActionSheetRow.Group, obj8);
  }
  items[2] = tmp7Result2;
  obj.children = items;
  return tmp6(category(7442).ActionSheet, obj);
}
const jsxProd = fn(21);
