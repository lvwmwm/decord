...
// Dependencies: [19, 2048, 21, 558, 568, 4911, 11273, 2023, 7396, 7445, 11257, 1119, 7624, 16450, 10925, 7436, 4457, 7449, 504, 2]
...
let closure_7 = ReactCompilerGating.isReactCompilerEnabled() ? ((category) => {
  ...
  const tmp4 = onClose(4911)(category, true);
  const tmp5 = onClose(11273)(category);
  dependencyMap = tmp5;
  const DeveloperMode = category(2023).DeveloperMode;
  const setting = DeveloperMode.useSetting();
  if (cResult[0] !== tmp4) {
    const obj2 = { title: tmp4 };
    const tmp9 = closure_5(tmp(7396).BottomSheetTitleHeader, obj2);
    cResult[0] = tmp4;
    cResult[1] = tmp9;
    let tmp7 = tmp9;
  } else {
  ...
  if (cResult[2] === tmp5) {
    ...
    if (cResult[5] === Symbol.for("react.memo_cache_sentinel")) {
      ...
      const tmp18 = closure_5(tmp(7445).ActionSheetRow.Icon, obj3);
    ...
    if (cResult[7] === category.id) {
      ...
      if (cResult[10] === category.id) {
        if (cResult[11] === setting) {
          ...
          obj4.children = items;
          const tmp27 = closure_6(tmp(7449).ActionSheet, obj4);
          cResult[14] = tmp7;
          cResult[15] = tmp10;
          cResult[16] = tmp19;
          cResult[17] = tmp22;
      ...
      if (setting) {
        ...
        const obj7 = { IconComponent: tmp(10925).IdIcon };
        obj6.icon = closure_5(tmp(7445).ActionSheetRow.Icon, obj7);
        obj6.onPress = function onPress() {
          ClipboardUtils.copy(category.id);
          ToastUtils.presentIdCopied();
          onClose();
        };
        obj5.children = closure_5(tmp(7445).ActionSheetRow, obj6);
        tmp23 = closure_5(tmp(7445).ActionSheetRow.Group, obj5);
      }
    ...
    obj8.children = closure_5(tmp(7445).ActionSheetRow, obj9);
    const tmp21 = closure_5(tmp(7445).ActionSheetRow.Group, obj8);
  ...
  if (null != tmp5) {
    ...
    const obj12 = { IconComponent: tmp(11257).PlusLargeIcon };
    obj11.icon = closure_5(tmp(7445).ActionSheetRow.Icon, obj12);
    obj11.onPress = function onPress() {
      closure_2.perform();
      onClose();
    };
    obj10.children = closure_5(tmp(7445).ActionSheetRow, obj11);
    tmp11 = closure_5(tmp(7445).ActionSheetRow.Group, obj10);
  }
  cResult[2] = tmp5;
  cResult[3] = onClose;
  cResult[4] = tmp11;
  ...
  category = category.category;
  const onClose = category.onClose;
  const tmp3 = onClose(11273)(category);
  dependencyMap = tmp3;
  const DeveloperMode = category(2023).DeveloperMode;
  const setting = DeveloperMode.useSetting();
  let obj = { header: closure_5(category(7396).BottomSheetTitleHeader, { title: onClose(4911)(category, true) }), children: null };
  let tmp7Result = null;
  if (null != tmp3) {
    const obj2 = { hasIcons: true, children: null };
    const obj3 = { label: tmp3.label, icon: null, onPress: null };
    const obj4 = { IconComponent: tmp4(11257).PlusLargeIcon };
    obj3.icon = tmp7(tmp4(7445).ActionSheetRow.Icon, obj4);
    obj3.onPress = function onPress() {
      closure_2.perform();
      onClose();
    };
    obj2.children = tmp7(tmp4(7445).ActionSheetRow, obj3);
    tmp7Result = tmp7(tmp4(7445).ActionSheetRow.Group, obj2);
  }
  ...
  const tmp2 = onClose(4911)(category, true);
  const tmp6 = closure_6;
  obj6.icon = closure_5(category(7445).ActionSheetRow.Icon, { IconComponent: category(7624).SettingsIcon });
  obj6.onPress = function onPress() {
    openFavoritesGuildCategorySettingsModalDefault(category.id);
    onClose();
  };
  obj5.children = closure_5(category(7445).ActionSheetRow, obj6);
  items[1] = closure_5(category(7445).ActionSheetRow.Group, obj5);
  ...
  if (setting) {
    ...
    obj9.icon = tmp7(tmp4(7445).ActionSheetRow.Icon, obj10);
    obj9.onPress = function onPress() {
      ClipboardUtils.copy(category.id);
      ToastUtils.presentIdCopied();
      onClose();
    };
    obj8.children = tmp7(tmp4(7445).ActionSheetRow, obj9);
    tmp7Result2 = tmp7(tmp4(7445).ActionSheetRow.Group, obj8);
  }
  items[2] = tmp7Result2;
  obj.children = items;
  return tmp6(category(7449).ActionSheet, obj);
});
