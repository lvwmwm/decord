...
// Dependencies: [5, 2037, 2049, 2045, 4431, 2099, 4612, 2048, 2058, 1078, 1089, 1190, 1221, 12, 10642, 10645, 5142, 1119, 2028, 11, 10648, 10650, 2070, 1105, 10651, 10652, 10654, 2]
...
// Module 10641 (FavoritesActionCreators)
...
import FavoritesGuildIntroPopover from "FavoritesGuildIntroPopover" /* 10652 */;
      ...
      if (tmp12.type === preloaded_user_settings.FavoriteChannelType.CATEGORY) {
        ...
        if (null != channel) {
          if (null == tmp12.channelType) {
            let UInt32Value = tmp3(1221).UInt32Value;
              ...
              let obj6 = {
                update(favoriteChannels) {
                              ...
                              while (iter !== undefined) {
                                ...
                                let tmp11 = closure_2_21(favoriteChannels.favoriteChannels, closure_0(1190).FavoriteChannelType.REFERENCE_ORIGINAL);
                                if (null != tmp11) {
                                  if (!closure_1_3) {
                                  ...
                                  if ("categoryName" in closure_1_1) {
                                    if (!flag) {
                                      ...
                                      tmp4 = tmp16;
                                      let tmp8Result = tmp8(favoriteChannels.favoriteChannels, closure_0(1190).FavoriteChannelType.REFERENCE_ORIGINAL);
                                      if (null != tmp8Result) {
                                        if (!closure_1_3) {
                                  ...
                                  let tmp31 = channel;
                                  let FavoriteChannel = closure_0(1190).FavoriteChannel;
                                  let obj = { nickname: "", type: null, channelType: null, position: null, parentId: null };
                                  obj.type = closure_0(1190).FavoriteChannelType.REFERENCE_ORIGINAL;
                                  let obj6;
                                  if (null != channel) {
                                    let UInt32Value = closure_0(1221).UInt32Value;
                                    let obj2 = { value: null };
                                ...
                                if (flag) {
                                  let BoolValue = closure_0(1221).BoolValue;
                                  favoriteChannels.guildVisible = BoolValue.create({ value: true });
                                  let obj4 = closure_0(10648);
                                  let str = "auto";
            ...
            let obj5 = {
              update(favoriteChannels) {
                          ...
                          if (obj.size(favoriteChannels) >= closure_2_13) {
                            ...
                            const favoritesAccess = tmp(10642).getFavoritesAccess();
                            const favoriteLimit = favoritesAccess.favoriteLimit;
                            tmp6 = null;
                            if (favoriteLimit > 0) {
                              tmp6 = null;
                              if (closure_0(1190).FavoriteChannelType.CATEGORY !== tmp(1190).FavoriteChannelType.CATEGORY) {
                                tmp6 = null;
                          ...
                          if (null != tmp6) {
                            ...
                            if (tmp6.canUpsell) {
                              ...
                              obj4.title = intl.string(tmp(1119).t["+XYXtZ"]);
                              const intl2 = tmp(1119).intl;
                              const obj5 = { count: limit };
                              obj4.body = intl2.formatToPlainString(tmp(1119).t.JaIyFi, obj5);
                              tmp4(5142).show(obj4);
                              const tmp4Result2 = tmp4(5142);
                            }
                            return false;
                          } else {
...
const resetFatigueCooldown = fn(2037).resetFatigueCooldown;
        ...
        if (!tmp2) {
          ...
          if (null == tmp8) {
            ...
            if (obj5.size(favoriteChannels) >= __initData2) {
              ...
              favoritesAccess = tmp18(10642).getFavoritesAccess();
              const favoriteLimit = favoritesAccess.favoriteLimit;
              tmp11 = null;
              if (favoriteLimit > 0) {
                favoritesAccess = tmp18(1190).FavoriteChannelType.CATEGORY;
                tmp11 = null;
            ...
            if (null == tmp11) {
              ...
              obj.title = intl.string(tmp18(1119).t["+XYXtZ"]);
              const intl2 = tmp18(1119).intl;
              const obj2 = { count: tmp11.limit };
              obj.body = intl2.formatToPlainString(tmp18(1119).t.JaIyFi, obj2);
              tmp7(5142).show(obj);
              const tmp7Result2 = tmp7(5142);
            }
            str = tmp7(10645)(favoritesAccess);
            obj5 = _modDef12;
          }
        }
      }
...
export const setFavoritesGuildVisibilityFromSettings = function setFavoritesGuildVisibilityFromSettings(arg0) {
  ...
  if (isFavoritesGuildIdResult) {
    tmp(1105).transitionTo(closure_15.ME);
    const tmpResult2 = tmp(1105);
  }
};
