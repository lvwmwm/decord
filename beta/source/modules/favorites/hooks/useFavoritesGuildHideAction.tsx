...
// Dependencies: [19, 4612, 1078, 558, 568, 10642, 10641, 2070, 1105, 1119, 3360, 2]

// Module 16487 (useFavoritesGuildHideAction)
...
export default ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  hasAccess = hasAccess(10642).useFavoritesAccess().hasAccess;
  ...
  if (cResult[2] !== hasAccess) {
    ...
    if (cResult[4] !== hasAccess) {
      ...
      if (hasAccess) {
        ...
        stringResult1 = intl2.string(_modDef3360.FaHxWl);
      }
      cResult[4] = hasAccess;
