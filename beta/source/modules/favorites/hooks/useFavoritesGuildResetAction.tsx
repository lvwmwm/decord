...
// Dependencies: [19, 4580, 1078, 558, 568, 2023, 10606, 2070, 1105, 10605, 1119, 3328, 2]
...
export default ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[1] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    const stringResult = intl.string(_modDef3328.YkET6R);
    const intl2 = tmp(1119).intl;
    const stringResult1 = intl2.string(_modDef3328.ZzcwNk);
  ...
  const intl = tmp(1119).intl;
  obj2.label = intl.string(_modDef3328.YkET6R);
  const intl2 = tmp(1119).intl;
  obj2.subLabel = intl2.string(_modDef3328.ZzcwNk);
