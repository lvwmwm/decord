...
// Dependencies: [5, 32, 19, 17, 1376, 21, 4790, 1488, 504, 6873, 1098, 4692, 4490, 1119, 6874, 4786, 5220, 2]
// Exports: default

// Module 6872 (ConfirmEmailChangeStart)
...
export default function ConfirmEmailChangeStart() {
  ...
  if (null == stateFromStores) {
    ...
    let obj6 = { style: tmp.image, source: navigation(6874) };
    ...
    items1[1] = closure_10(tmp2(4786).Text, obj7);
    ...
    obj9.onPress = tmp7;
    obj9.loading = tmp6[0];
    obj8.children = closure_10(tmp2(5220).Button, obj9);
