...
// Dependencies: [19, 17, 1376, 5931, 1078, 21, 4790, 580, 558, 568, 1488, 504, 1245, 1098, 5939, 1119, 4786, 5220, 5868, 2]

// Module 5938 (ChangeEmailWarning)
...
const hcArticle = fn(5931).COMMON_SCAMS_EDUCATION_HC_ARTICLE;
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((changeEmailReason) => {
  ...
  if (cResult[2] === changeEmailReason) {
    ...
    if (null == tmp10) {
      ...
      if (cResult[5] === Symbol.for("react.memo_cache_sentinel")) {
        const tmp15 = closure_9(tmp(5939).TrafficConeSpotIllustration, {});
        cResult[5] = tmp15;
        let tmp13 = tmp15;
      } else {
        tmp13 = cResult[5];
      ...
      if (cResult[7] !== tmp4.title) {
        ...
        const tmp20 = closure_9(tmp(4786).Text, obj3);
      ...
      if (cResult[11] === tmp4.body) {
        ...
        if (cResult[15] !== tmp11) {
          ...
          const tmp33 = closure_9(tmp(5220).Button, obj5);
          cResult[15] = tmp11;
          cResult[16] = tmp33;
          let tmp31 = tmp33;
        } else {
        ...
        if (cResult[17] === Symbol.for("react.memo_cache_sentinel")) {
          ...
          const tmp36 = closure_9(tmp(5220).Button, obj6);
          cResult[17] = tmp36;
          let tmp34 = tmp36;
        } else {
          tmp34 = cResult[17];
      ...
      const tmp28 = closure_10(tmp(4786).Text, obj10);
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_9(tmp2(5939).TrafficConeSpotIllustration, {}), , , ];
    ...
    items2[1] = closure_9(tmp2(4786).Text, obj5);
    ...
    items2[2] = closure_10(tmp2(4786).Text, obj6);
    ...
    obj9.onPress = tmp6;
    const items4 = [closure_9(tmp2(5220).Button, obj9), ];
    ...
    items4[1] = closure_9(tmp2(5220).Button, obj10);
