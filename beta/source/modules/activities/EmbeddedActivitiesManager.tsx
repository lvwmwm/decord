...
// Dependencies: [5, 4806, 7976, 2049, 502, 2045, 4813, 2099, 1376, 9595, 2044, 1078, 9552, 1368, 1275, 4421, 9596, 9597, 1245, 9599, 9623, 9624, 4991, 1259, 2013, 9439, 9652, 5118, 9625, 5123, 9650, 1986, 1114, 577, 9642, 9346, 7442, 9640, 1119, 9662, 9621, 9663, 11678, 1982, 7461, 2]
// Exports: getActiveAnalyticsSessionIDs, trackFrameSessionEnd, trackFrameSessionStart, trackFrameSessionStartFailed

// Module 9594 (EmbeddedActivitiesManager)
...
import ActivityShelfStore from "ActivityShelfStore" /* 9595 */;
...
function handleOpenEmbeddedActivity(applicationId) {
  ...
  if (obj2.tryLaunchAsFrame({ applicationId })) {
    ...
    obj3.channelId = tmp4(4421).getEmbeddedActivityLocationChannelId(_location);
    const tmp4Result9 = tmp4(4421);
    obj3.guildId = tmp4(4421).getEmbeddedActivityLocationGuildId(_location);
    ...
    const tmp4Result10 = tmp4(4421);
  } else {
    const id = AuthenticationStore.getId();
    const found = participants.find((userId) => userId.userId === closure_1);
    const embeddedActivityLocationChannelId = tmp4(4421).getEmbeddedActivityLocationChannelId(_location);
    const tmp4Result11 = tmp4(4421);
    const embeddedActivityLocationGuildId = tmp4(4421).getEmbeddedActivityLocationGuildId(_location);
        ...
        if (!tmp18) {
          ...
          if (null != currentUser) {
            ...
            if (tmp55 != null) {
              ...
              if (activity != null) {
                const tmp4Result14 = tmp4(1368);
                release_phase = activity.client_platform_config[tmp54(9552)(undefined, tmp4Result14.getOS(tmp4Result14))].release_phase;
                const tmp54Result = tmp54(9552);
              }
            }
            ...
            let isNullOrEmptyResult = tmp4(2013).isNullOrEmpty(found.nonce);
            ...
            if (null != channel) {
              commandContextType = tmp4(9439).computeCommandContextType(channel, applicationId);
              const tmp4Result16 = tmp4(9439);
            }
          ...
          const tmp4Result13 = tmp4(1259);
        }
      }
    }
    const tmp4Result12 = tmp4(4421);
  }
}
  ...
  constructor() {
    ...
    applyArgumentsResult.handleSelectedChannelUpdate = function handleSelectedChannelUpdate() {
      ...
      while (iter !== undefined) {
        ...
        let tmp4 = _location;
        let obj2 = applyArgumentsResult(4421);
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (1 === getChannel) {
                ...
                if (undefined !== closure_131_5) {
                  ...
                  if (!set.has(type)) {
                    ...
                    if (getChannel !== closure_131_1) {
                      c5 = 2;
                      set = 1;
                      const obj5 = { value: getChannel(7442).fetchApplication(closure_131_1), done: false };
                      return obj5;
                    }
                  } else {
              ...
              if (arg0 === 1) {
                ...
                if (!obj25.getIsActivitiesEnabledForCurrentPlatform()) {
                  ...
                  closure_132_1.showLaunchErrorModal(intl.string(applyArgumentsResult(1119).t.UXoQTp));
                }
                obj25 = applyArgumentsResult(9640);
              }
            } else {
              if (3 === getChannel) {
                if (arg0 === 1) {
                  ...
                  if (null == getChannel(9596)(obj9)) {
                    const obj11 = { guildId: closure_131_8, force: true };
                    c5 = 4;
                    set = 1;
                    const obj12 = { value: applyArgumentsResult(9621).fetchShelf(obj11), done: false };
                    return obj12;
                  }
                }
              ...
              if (dependencyMap > 0) {
                ...
                c5 = 6;
                set = 1;
                const obj20 = { value: applyArgumentsResult(9663).maybeJoinEmbeddedActivity(obj18), done: false };
                return obj20;
              } else {
                ...
                c5 = 5;
                set = 1;
                const obj22 = { value: getChannel(11678)(obj21), done: false };
                return obj22;
              }
            }
            ...
            if (tmp56(supported_platforms)) {
              ...
              c5 = 3;
              set = 1;
              const obj24 = { value: applyArgumentsResult(9621).fetchShelf(obj23), done: false };
              return obj24;
            } else {
              const intl2 = applyArgumentsResult(1119).intl;
              closure_132_1.showLaunchErrorModal(intl2.string(applyArgumentsResult(1119).t.uGDCcw));
            }
            tmp56 = getChannel(9662);
          }
        } catch (tmp89) {
          set = tmp;
          throw tmp89;
    ...
    applyArgumentsResult.handleInteractionQueue = function handleInteractionQueue(arg0) {
      ...
      if (null == dependencyMap2[data.applicationId]) {
        if (data.interactionType === applyArgumentsResult(1982).InteractionTypes.APPLICATION_COMMAND) {
          const items = [AnalyticsLocationDefault.INTERACTION_APPLICATION_COMMAND];
          let tmp2 = items;
        } else if (data.interactionType === tmp7(1982).InteractionTypes.MESSAGE_COMPONENT) {
          const items1 = [AnalyticsLocationDefault.INTERACTION_MESSAGE_COMPONENT];
          tmp2 = items1;
        } else if (data.interactionType === tmp7(1982).InteractionTypes.MODAL_SUBMIT) {
  ...
  if (null != tmp4) {
    ...
    if (null != currentUser) {
      ...
      if (locationKind == null) {
        if (null != channel) {
          if (null != guildId) {
            let PRIVATE_CHANNEL = tmp2(9625).EmbeddedActivityLocationKind.GUILD_CHANNEL;
          } else {
            PRIVATE_CHANNEL = tmp2(9625).EmbeddedActivityLocationKind.PRIVATE_CHANNEL;
          }
        }
      }
      const mediaSessionId = RTCConnectionStore.getMediaSessionId();
      ...
      if (tmp27 != null) {
        ...
        if (activity != null) {
          const tmp2Result4 = tmp2(1368);
          release_phase = activity.client_platform_config[tmp26(9552)(undefined, tmp2Result4.getOS(tmp2Result4))].release_phase;
          const tmp26Result = tmp26(9552);
        }
      }
      const tmp2Result = tmp2(1259);
      const rawThermalState = ThermalUtilsDefault.getRawThermalState();
      ...
      let commandContextType = null;
      if (null != channel) {
        commandContextType = tmp2(9439).computeCommandContextType(channel, applicationId);
        const tmp2Result5 = tmp2(9439);
      }
      ...
      const eligibleQuestsForApplicationId = tmp2(9652).getEligibleQuestsForApplicationId(QuestStore.quests, applicationId, true);
      if (eligibleQuestsForApplicationId.length > 0) {
        const _HermesInternal2 = HermesInternal;
        ...
        const obj6 = { name: tmp2(5123).MetricEvents.FRAME_SESSION_JOIN, tags: items2 };
        tmp26(5118).increment(obj6);
        const tmp26Result7 = tmp26(5118);
      }
      const tmp2Result6 = tmp2(9652);
    ...
    if (null != currentUser) {
      ...
      if (tmp13 != null) {
        ...
        if (activity != null) {
          ...
          release_phase = activity.client_platform_config[tmp11(9552)(undefined, obj2.getOS(obj2))].release_phase;
          const tmp11Result = tmp11(9552);
        }
      }
      const rawThermalState = ThermalUtilsDefault.getRawThermalState();
      let diff = null;
