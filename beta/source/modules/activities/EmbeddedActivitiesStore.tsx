...
// Dependencies: [32, 502, 2045, 2099, 1376, 2008, 9313, 1078, 9615, 9616, 4389, 9314, 14257, 1114, 9634, 577, 9610, 9520, 1368, 1982, 7770, 504, 2]
...
const isVoiceEmbeddedActivityDefault = combined(9610);
require = fn;
...
function updateEmbeddedActivities(content_classification) {
  ...
  if (null != tmp3) {
    const embeddedActivityLocationChannelId = application_id(4389).getEmbeddedActivityLocationChannelId(_location);
    ...
    const obj19 = application_id(4389);
      ...
      if (_location.id === value9.location.id) {
        if (application_id === value9.applicationId) {
          if (someResult) {
            ...
            const embeddedActivityLocationChannelId1 = tmp76(4389).getEmbeddedActivityLocationChannelId(_location);
            if (null != embeddedActivityLocationChannelId1) {
              ...
              let str5 = tmp76(4389).getEmbeddedActivityLocationGuildId(_location);
              if (str5 == null) {
                str5 = "0";
              }
              ...
              obj17 = map1;
              obj22 = map2;
              const tmp76Result4 = tmp76(4389);
            }
            const tmp76Result = tmp76(4389);
          } else {
            const _Array = Array;
      ...
      if (sessionId === obj4.getSessionId()) {
        ...
        if (null != tmp36) {
          if (null != obj4.getSessionId()) {
            ...
            if (id1 !== _location.id) {
              const embeddedActivityLocationChannelId2 = tmp76(4389).getEmbeddedActivityLocationChannelId(_location);
    ...
    obj6 = map4;
    const someResult1 = mapped.some((item) => application_id(14257).isActivityParticipantCurrentUserCurrentSession(item));
  }
}
