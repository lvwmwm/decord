...
// Dependencies: [32, 19, 17, 1074, 2038, 12664, 21, 4756, 576, 1241, 10410, 4752, 1115, 5186, 12665, 5339, 5897, 15757, 7630, 2027, 2]
// Exports: default

// Module 16749 (NotificationCenterPermissionNudge)
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  const obj2 = { style: tmp.iconContainer, children: closure_14(onDismiss(10410).BellSlashIcon, { size: "md", color: nativeDefault.colors.ICON_STRONG }) };
  ...
  obj9.onPress = function onPress() {
    const pushNotificationPermission = onDismiss(12665).requestPushNotificationPermission(constants2.ALLOW_TO_REQUEST, constants3.NOTIFICATION_CENTER, closure_1_8);
    const obj = onDismiss(12665);
  ...
  obj10.children = closure_14(onDismiss(5897).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = closure_14(onDismiss(5339).PressableHighlight, obj10);
  obj.children = items;
