...
// Dependencies: [19, 11782, 1078, 21, 1119, 1245, 558, 568, 11785, 4489, 11805, 2]

// Module 11804 (NotificationSurveyActionSheet)
...
const constants = fn(11782).NotificationUserFeedbackReasons;
