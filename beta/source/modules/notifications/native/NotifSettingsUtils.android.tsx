...
// Dependencies: [14765, 1119, 14770, 14771, 1235, 2]

// Module 14769 (NotifSettingsUtils)
...
function buildChannelsAndMapping() {
  const assignedNotifSettingsAndMappings = map(14771).getAssignedNotifSettingsAndMappings();
