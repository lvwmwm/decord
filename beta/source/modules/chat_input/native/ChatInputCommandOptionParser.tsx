...
// Dependencies: [32, 17, 4782, 5710, 2103, 4431, 1078, 5245, 1379, 12158, 4449, 12159, 2012, 2013, 8437, 5268, 7610, 10675, 2023, 580, 4943, 2]
...
// Module 12157 (ChatInputCommandOptionParser)
...
function buildGameMentionResult(id) {
  ...
  const obj = { location: 0, length: __initData2(id.name).length, icon: null, iconSize: 16, iconCornerRadius: 4, iconSpacing: 4 };
