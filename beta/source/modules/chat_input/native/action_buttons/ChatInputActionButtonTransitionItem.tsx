...
// Dependencies: [19, 17, 12215, 21, 4466, 4492, 4757, 12500, 2]
// Exports: default, interactivityProps

// Module 12499 (ChatInputActionButtonTransitionItem)
...
const CHAT_INPUT_TIMING_CONFIG = fn(12215).CHAT_INPUT_TIMING_CONFIG;
const jsx = fn(21).jsx;
