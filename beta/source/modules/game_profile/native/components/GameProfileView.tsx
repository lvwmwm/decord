...
// Dependencies: [19, 17, 8985, 21, 4756, 576, 7407, 7427, 8986, 8987, 8992, 8999, 9000, 9010, 9011, 9017, 9030, 9043, 9157, 9159, 9178, 9179, 2]
// Exports: default
...
export default function GameProfileView(arg0) {
  ...
  if (tmp6Result) {
    ...
    obj5.children = tmp6(tmp2(8999), obj6);
