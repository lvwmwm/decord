...
// Dependencies: [19, 17, 21, 4758, 580, 558, 568, 4481, 8953, 4455, 8999, 9000, 8944, 1119, 8963, 4754, 2022, 9001, 9007, 8959, 8960, 2]

// Module 8998 (GameProfileReviews)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import GameProfileAnalyticUtils from "GameProfileAnalyticUtils" /* 8944 */;
import useSteamWebsiteUrl from "useSteamWebsiteUrl" /* 8959 */;
...
let closure_11 = ReactCompilerGating.isReactCompilerEnabled() ? ((url) => {
  ...
  const alwaysShowLinkDecorations = noop.useContext(url(4481).AccessibilityPreferencesContext).alwaysShowLinkDecorations;
  const obj = url(568);
  const tmp5 = trackAction;
  const tmp6Result = trackAction(8953)(trackAction(4455).openURL);
                                ...
                                if (cResult[44] === tmp13) {
                                  if (cResult[45] === tmp14) {
                                    ...
                                    if (tmp46) {
                                      ...
                                      tmp46 = closure_7(tmp(4754).Text, obj4);
  ...
  const tmp6 = trackAction(8953);
  const result = url(8999).calculateSteamReviewScoreDescription(rating, ratingCount, isRecentRating);
  const tmpResult = url(8999);
  const steamReviewScoreDescriptionColor = url(9000).getSteamReviewScoreDescriptionColor(result);
    ...
    if (cResult[29] === trackAction) {
      ...
      if (cResult[33] === tmp4.reviewRow) {
        ...
        if (cResult[36] === Symbol.for("react.memo_cache_sentinel")) {
          ...
          const tmp30 = closure_7(tmp(8963).SteamNeutralIcon, obj7);
          cResult[36] = tmp30;
          let tmp28 = tmp30;
        } else {
          tmp28 = cResult[36];
        ...
        if (cResult[37] !== title) {
          ...
          const tmp33 = closure_7(tmp(4754).Text, obj8);
          cResult[37] = title;
          cResult[38] = tmp33;
          let tmp31 = tmp33;
        } else {
        ...
        if (cResult[39] === tmp4.steamNameContainer) {
          ...
          const steamReviewScoreDescriptionIntl = tmp(9000).getSteamReviewScoreDescriptionIntl(result);
  ...
  const tmp5Result = trackAction(8953)(trackAction(4455).openURL);
  ...
  const items2 = [closure_7(url(8963).SteamNeutralIcon, { size: "sm", color: tmp4(580).colors.ICON_STRONG }), closure_7(url(4754).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title })];
  ...
  let linkText;
  if (noop.useContext(url(4481).AccessibilityPreferencesContext).alwaysShowLinkDecorations) {
    linkText = tmp.linkText;
  }
  obj7.style = linkText;
  const obj5 = { size: "sm", color: tmp4(580).colors.ICON_STRONG };
  obj7.children = url(9000).getSteamReviewScoreDescriptionIntl(result);
  const items4 = [closure_7(url(4754).Text, obj7), ];
  ...
  if (tmp12Result) {
    ...
    tmp12Result = tmp12(tmp2(4754).Text, obj8);
...
let closure_12 = ReactCompilerGating.isReactCompilerEnabled() ? ((trackAction) => {
  ...
  const tmp10Result = trackAction(8953)(trackAction(4455).openURL);
  ...
  if (cResult[2] === tmp10Result) {
    if (cResult[3] === trackAction) {
      ...
      if (cResult[6] !== tier) {
        let str = "";
        if (null != tier) {
          str = tmp(9001).getOpenCriticTierText(tier);
          const tmpResult = tmp(9001);
        }
        cResult[6] = tier;
        cResult[7] = str;
        let tmp13 = str;
      ...
      if (cResult[8] !== tier) {
        if (null != tier) {
          let openCriticCircleRatingColor = tmp(9001).getOpenCriticCircleRatingColor(tier);
          const tmpResult4 = tmp(9001);
        } else {
        ...
        if (cResult[11] === Symbol.for("react.memo_cache_sentinel")) {
          ...
          const tmp21 = closure_7(tmp(4754).Text, obj2);
          cResult[11] = tmp21;
          let tmp19 = tmp21;
        } else {
          tmp19 = cResult[11];
          ...
          if (cResult[13] === tmp4.opencriticTopCriticImage) {
            if (cResult[14] === tier) {
                    ...
                    if (cResult[20] === topCriticRating) {
                      if (cResult[21] === tmp4.opencriticTopCriticContainer) {
                        ...
                        if (cResult[24] !== tmp8) {
                          let tmp34 = null;
                          if (tmp8) {
                            const obj3 = { variant: "text-xs/medium", color: tmp(9000).getSteamReviewScoreDescriptionColor(tmp(2022).SteamReviewScoreDescription.NO_USER_REVIEWS), children: null };
                            const intl4 = tmp(1119).intl;
                            obj3.children = intl4.string(tmp(1119).t["0xYzpO"]);
                            tmp34 = closure_7(tmp(4754).Text, obj3);
                            const tmpResult5 = tmp(9000);
                          }
                          cResult[24] = tmp8;
                          cResult[25] = tmp34;
                          let tmp33 = tmp34;
              ...
              if (tmp14) {
                ...
                const items3 = [closure_7(tmp9(9007), obj8), ];
                ...
                obj9.children = closure_7(tmp(4754).Text, obj10);
        ...
        if (null != tier) {
          ...
          const obj13 = { uri: tmp(9001).getOpenCriticTierImage(tier) };
          obj12.source = obj13;
  ...
  const tmp4Result = trackAction(8953)(trackAction(4455).openURL);
  ...
  if (null != tier) {
    str = url(9001).getOpenCriticTierText(tier);
    const obj2 = url(9001);
  }
  if (null != tier) {
    let openCriticCircleRatingColor = url(9001).getOpenCriticCircleRatingColor(tier);
    const obj4 = url(9001);
  } else {
    openCriticCircleRatingColor = { foregroundColor: "", backgroundColor: "" };
  }
  ...
  const items1 = [closure_7(url(4754).Text, obj3), ];
  ...
  if (null != tier) {
    ...
    const obj8 = { uri: tmp11(9001).getOpenCriticTierImage(tier) };
    obj7.source = obj8;
  ...
  if (null != tier) {
    ...
    if (topCriticRating > 0) {
      ...
      if (num > 0) {
        ...
        const items4 = [tmp12(trackAction(9007), obj11), ];
        ...
        obj12.children = tmp12(tmp11(4754).Text, obj13);
  ...
  if (topCriticRating <= 0) {
    ...
    if (null == tier) {
      const obj14 = { variant: "text-xs/medium", color: tmp11(9000).getSteamReviewScoreDescriptionColor(tmp11(2022).SteamReviewScoreDescription.NO_USER_REVIEWS), children: null };
      const intl4 = tmp11(1119).intl;
      obj14.children = intl4.string(tmp11(1119).t["0xYzpO"]);
      tmp12Result2 = tmp12(tmp11(4754).Text, obj14);
      const tmp11Result2 = tmp11(9000);
    }
  } else {
    tmp12Result2 = null;
  }
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (null == game) {
    ...
    const tmp7 = game.steamReleaseStatus !== tmp(8960).SteamReleaseStatus.RETIRED_ABANDONED && null != steamWebsiteUrl;
    const reviews = game.reviews;
    let steam;
    if (reviews != null) {
      steam = reviews.steam;
    ...
    if (cResult[0] === recentRating) {
      ...
      const result = tmp(9000).canShowLocalizedSteamReview(steam);
      if (result) {
        let localizedRating;
        if (!tmp15) {
      ...
      if (cResult[4] !== tmp4.headerText) {
        ...
        const tmp28 = React5(tmp(4754).Text, obj3);
      ...
      tmp31 = tmp33Result;
      const tmpResult = tmp(9000);
    }
    const result1 = tmp(8999).calculateSteamReviewScoreDescription(recentRating, recentRatingCount, true);
    cResult[0] = recentRating;
    cResult[1] = recentRatingCount;
    cResult[2] = result1;
    tmp11 = result1;
    const tmpResult2 = tmp(8999);
  }
}) : ((arg0) => {
  ({ game, trackAction } = arg0);
  const tmp = closure_10();
  ...
  if (null == game) {
    ...
    const tmp6 = game.steamReleaseStatus !== tmp2(8960).SteamReleaseStatus.RETIRED_ABANDONED && null != steamWebsiteUrl;
    const reviews = game.reviews;
    let steam;
    if (reviews != null) {
      steam = reviews.steam;
    }
    const calculateSteamReviewScoreDescription = tmp2(8999).calculateSteamReviewScoreDescription;
    if (steam != null) {
    ...
    const tmp2Result = tmp2(8999);
    const result = tmp2(9000).canShowLocalizedSteamReview(steam);
    if (result) {
      let localizedRating;
      if (!tmp12) {
        localizedRating = steam.localizedRating;
    ...
    const items = [React5(tmp2(4754).Text, obj3), ];
