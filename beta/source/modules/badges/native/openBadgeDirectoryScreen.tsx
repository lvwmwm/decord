...
// Dependencies: [4993, 11485, 1984, 2]
// Exports: closeBadgeDirectoryScreen, openBadgeDirectoryScreen

// Module 11484 (openBadgeDirectoryScreen)
...
export const openBadgeDirectoryScreen = function openBadgeDirectoryScreen(arg0) {
  ...
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11485, dependencyMap.paths), { targetUserId: obj.targetUserId }, c3);
};
