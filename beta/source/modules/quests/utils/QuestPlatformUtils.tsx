...
// Dependencies: [5663, 1078, 7965, 5671, 7970, 7971, 7981, 5670, 7959, 9339, 1119, 1368, 10580, 4722, 11621, 1114, 11613, 4449, 11622, 11624, 1259, 11612, 11617, 7626, 577, 2]
...
// Module 11620 (QuestPlatformUtils)
          ...
          if (null != getIosAttribution) {
            ...
            let catchPromise = getIosAttribution().then((result) => {
              ...
              result = link(inlineStoreParams[13]).openPlayStoreInlineInstall(url, appId, (arg0) => {
                closure_1_1();
                closure_0(constants.QUEST_APP_STORE_OVERLAY_CLOSED, str, closure_0(7959).AppStoreOverlayVariant.NATIVE, arg0);
                ...
                if (result) {
                  const obj = {
                    trackOverlayEvent(arg0, arg1) {
                        return closure_1_0(arg0, str, closure_0(7959).AppStoreOverlayVariant.NATIVE, arg1, closure_0(7959).AppStoreOverlaySurfaces.MAIN_CTA);
                      }
                  };
                  dependencyMap(obj);
                  closure_0(constants.QUEST_APP_STORE_OVERLAY_OPEN_SUCCEEDED, str, closure_0(7959).AppStoreOverlayVariant.NATIVE);
                } else {
                  closure_1_1();
                  closure_0(constants.QUEST_APP_STORE_OVERLAY_OPEN_FAILED, str, closure_0(7959).AppStoreOverlayVariant.NATIVE);
                  const ComponentDispatch = closure_0(1114).ComponentDispatch;
                  ComponentDispatch.dispatch(constants2.QUEST_APP_STORE_OVERLAY_FINISHED);
                }
                return result;
            ...
            ({ clearAppStoreOverlayOpen: closure_1, setAppStoreOverlayOpen: inlineStoreParams } = tmp(11621));
            ({ url, appId } = inlineStoreParams);
            if (appId != null) {
              let str = appId.toString();
            }
            let result = tmp(4722).openPlayStoreInlineInstall(url, appId, (arg0) => {
              closure_1_1();
              closure_0(constants.QUEST_APP_STORE_OVERLAY_CLOSED, str, closure_0(7959).AppStoreOverlayVariant.NATIVE, arg0);
              const ComponentDispatch = closure_0(1114).ComponentDispatch;
              ComponentDispatch.dispatch(constants2.QUEST_APP_STORE_OVERLAY_FINISHED);
            }, undefined);
            const tmpResult = tmp(11621);
...
function openAdGameLinkDirectlyImpl(adContentId, impressionId, preferExternalAppStore) {
  ...
  if (obj.shouldMigrateToAdAnalyticsInterface(adContentId(7970).AdAnalyticsInterfaceExperimentStep.STEP_3_CLICKED_EXTERNAL, "open_ad_game_link_directly")) {
    const obj2 = { type: tmp2(7981).AdUserActionType.CLICK_EXTERNAL_ADVERTISER_CTA, adCreativeType, adCreativeId: adContentId, questContentCTA: null, surfaceId: null, sourceQuestContent: null, questContentPosition: null, impressionId: null };
    ...
    tmp2(7971).captureAdUserAction(obj2);
    const tmp2Result = tmp2(7971);
  } else {
    ...
    const result = tmp2(7959).trackAdContentClicked(obj4);
    const tmp2Result3 = tmp2(7959);
  }
  ...
  if (null != impressionId) {
    ...
    iosAttributionClickFramework = tmp2(11612).getIosAttributionClickFramework(null != iosAppId, impressionId.sourceQuestContent, adContentId);
    const tmp2Result4 = tmp2(11612);
  }
  let fn;
  obj = adContentId(7970);
...
export const supportedTaskPlatforms = function supportedTaskPlatforms(quest) {
  ...
  if (!hasPlayOnDesktopTaskResult) {
    const obj3 = { quest };
    hasPlayOnDesktopTaskResult = tmp(7965).hasStreamOnDesktopTask(obj3);
    const tmpResult = tmp(7965);
  }
  if (!hasPlayOnDesktopTaskResult) {
    hasPlayOnDesktopTaskResult = tmp(7965).hasAchievementInGameTask(quest);
...
export const openAuthorizationConnectionModal = function openAuthorizationConnectionModal(platformType, ctaContent) {
  ...
  if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "open_authorization_connection_modal")) {
    const obj2 = { type: tmp(7981).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp(5670).AdCreativeType.QUEST, adCreativeId: quest.id, questContentCTA: null, surfaceId: null, sourceQuestContent: null, impressionId: null };
...
export const openConsoleConnectionSettings = function openConsoleConnectionSettings(quest, arg1) {
  ...
  if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "open_console_connection_settings")) {
    const obj2 = { type: tmp(7981).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp(5670).AdCreativeType.QUEST, adCreativeId: quest.id, questContentCTA: null, surfaceId: null, sourceQuestContent: null, impressionId: null, questContentPosition: null };
...
export const openAddConsoleConnectionModal = function openAddConsoleConnectionModal(quest, arg1) {
  ...
  if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "open_add_console_connection_modal")) {
    const obj2 = { type: tmp(7981).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp(5670).AdCreativeType.QUEST, adCreativeId: quest.id, questContentCTA: null, surfaceId: null, sourceQuestContent: null, impressionId: null, questContentPosition: null, questContentRowIndex: null };
