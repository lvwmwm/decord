...
// Dependencies: [32, 19, 17, 4748, 1372, 7939, 7396, 21, 576, 4756, 5664, 11738, 11553, 11558, 11311, 504, 4457, 7794, 12020, 15390, 5186, 11768, 11751, 15358, 12028, 15385, 15387, 8179, 1115, 5845, 12027, 11741, 15425, 7965, 7966, 7976, 5668, 7964, 1612, 1478, 4492, 4757, 5191, 2]
// Exports: default
  ...
  let obj3 = {
    ...
    onPress(arg0) {
      if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_bottom_sheet_footer")) {
        const obj2 = { type: tmp(7976).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp(5668).AdCreativeType.QUEST, adCreativeId: questId, questContentCTA: tmp(7964).QuestContentCTA.DEFIBRILLATOR, surfaceId: tmp(5664).QuestContent.QUEST_BOTTOM_SHEET, sourceQuestContent, impressionId };
        tmp(7966).captureAdUserAction(obj2);
        const tmpResult = tmp(7966);
      } else {
        const obj3 = { questId, questContent: tmp(5664).QuestContent.QUEST_BOTTOM_SHEET, questContentCTA: tmp(7964).QuestContentCTA.DEFIBRILLATOR, sourceQuestContent };
        closure_3(obj3);
      }
...
function ClaimButton(arg0) {
  ...
  let obj3 = {
    ...
    onPress() {
      if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_bottom_sheet_footer")) {
        const obj2 = { type: tmp(7976).AdUserActionType.CLICK_INTERNAL, adCreativeType: tmp(5668).AdCreativeType.QUEST, adCreativeId: questId, questContentCTA: tmp(7964).QuestContentCTA.CLAIM_REWARD, surfaceId: tmp(5664).QuestContent.QUEST_BOTTOM_SHEET, sourceQuestContent, impressionId };
        tmp(7966).captureAdUserAction(obj2);
        const tmpResult = tmp(7966);
      } else {
        const obj3 = { questId, questContent: tmp(5664).QuestContent.QUEST_BOTTOM_SHEET, questContentCTA: tmp(7964).QuestContentCTA.CLAIM_REWARD, sourceQuestContent };
        closure_3(obj3);
      }
      importDefault();
    },
...
export default function QuestBottomSheetFooter(quest) {
  ...
  if (step !== quest(15387).QuestBottomSheetStep.TASK_SELECT) {
    ...
    if (tmp40Result5) {
      ...
      obj18.icon = tmp40(tmp2(5845).ArrowLargeLeftIcon, {});
      obj18.onPress = onBack;
      tmp40Result5 = tmp40(tmp2(8179).IconButton, obj18);
    }
