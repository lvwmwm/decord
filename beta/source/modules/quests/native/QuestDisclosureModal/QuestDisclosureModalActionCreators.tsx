...
// Dependencies: [5668, 7960, 15369, 7965, 7966, 7976, 7954, 4959, 15381, 1980, 2]
...
export default {
  showModal(isTargetedDisclosure) {
    ...
    if (obj2.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_disclosure_modal")) {
      ...
      const result = tmp(7954).trackQuestContentClicked(obj5);
      ...
      const result1 = tmp(7954).trackAdContentClicked({ adContentId: null, adCreativeType: null, questContent: null, questContentCTA: null, questContentPosition: null, sourceQuestContent: null });
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      ...
      obj10.adCreativeType = tmp(5668).AdCreativeType.QUEST;
      ...
      obj10.isVideoQuest = tmp(7960).hasWatchVideoTasks(creative.quest);
      let tmp11 = obj10;
      const tmpResult6 = tmp(7960);
    } else if (tmp(5668).AdCreativeType.BOUNTY === type) {
      const obj11 = { adCreativeType: tmp(5668).AdCreativeType.BOUNTY, gamePublisher: creative.bounty.advertiserName };
      tmp11 = obj11;
    }
    const obj12 = {};
    const merged1 = Object.assign(tmp11);
    obj12.isTargetedDisclosure = isTargetedDisclosure.isTargetedDisclosure;
    obj9.pushLazy(asyncRequireImpl(15381, tmp2.paths), obj12, QUEST_DISCLOSURE_MODAL);
  },
  hideModal() {
