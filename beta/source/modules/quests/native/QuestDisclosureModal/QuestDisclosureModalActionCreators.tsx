...
// Dependencies: [5702, 7997, 15368, 8002, 8003, 8013, 7991, 4993, 15380, 1984, 2]

// Module 15379 (QuestDisclosureModalActionCreators)
...
export default {
  showModal(isTargetedDisclosure) {
    ...
    if (obj2.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_disclosure_modal")) {
      const obj3 = { type: tmp(8013).AdUserActionType.CLICK_INTERNAL };
      ...
      tmp(8003).captureAdUserAction(obj3);
      const tmpResult = tmp(8003);
    } else if (creativeAnalyticsParams.adCreativeType === tmp(5702).AdCreativeType.QUEST) {
      ...
      const result = tmp(7991).trackQuestContentClicked(obj5);
      ...
      const result1 = tmp(7991).trackAdContentClicked({ adContentId: null, adCreativeType: null, questContent: null, questContentCTA: null, questContentPosition: null, sourceQuestContent: null });
    ...
    if (AdCreativeType.AdCreativeType.QUEST === type) {
      ...
      obj10.adCreativeType = tmp(5702).AdCreativeType.QUEST;
      ...
      obj10.isVideoQuest = tmp(7997).hasWatchVideoTasks(creative.quest);
      let tmp11 = obj10;
      const tmpResult6 = tmp(7997);
    } else if (tmp(5702).AdCreativeType.BOUNTY === type) {
      const obj11 = { adCreativeType: tmp(5702).AdCreativeType.BOUNTY, gamePublisher: creative.bounty.advertiserName };
      tmp11 = obj11;
    }
    const obj12 = {};
    const merged1 = Object.assign(tmp11);
    obj12.isTargetedDisclosure = isTargetedDisclosure.isTargetedDisclosure;
    obj9.pushLazy(asyncRequireImpl(15380, tmp2.paths), obj12, QUEST_DISCLOSURE_MODAL);
  },
  hideModal() {
