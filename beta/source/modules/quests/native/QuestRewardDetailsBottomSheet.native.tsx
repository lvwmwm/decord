...
// Dependencies: [19, 17, 1376, 21, 4758, 580, 558, 568, 11895, 4725, 11607, 10575, 7949, 1119, 504, 11898, 4754, 5186, 7397, 2]

// Module 11897 (QuestRewardDetailsBottomSheet)
import c from "c" /* 568 */;
...
let closure_10 = ReactCompilerGating.isReactCompilerEnabled() ? ((quest) => {
  ...
  if (cResult[0] !== quest.config) {
    const result = tmp(10575).isCollectibleQuestRewardPremiumExtendable(quest.config);
  ...
  if (QuestRewardTypes.QuestRewardTypes.COLLECTIBLE === type) {
    ...
    let tmp9 = null;
    if (tmp(7949).QuestRewardTypes.FRACTIONAL_PREMIUM === type) {
    ...
    if (cResult[7] === stateFromStores) {
      ...
      if (tmp24 === Symbol.for("react.memo_cache_sentinel")) {
        ...
        const tmp27 = timestampProducer(tmp(4754).Text, obj2);
        cResult[12] = tmp27;
        let tmp25 = tmp27;
      } else {
        tmp25 = cResult[12];
      ...
      if (cResult[15] === tmp4.rewardDetailsCopy) {
        ...
        if (cResult[18] === tmp20) {
          ...
          if (cResult[21] === tmp9) {
            ...
            tmp48[1] = React5(tmp(5186).Stack, obj4);
            const tmp51 = timestampProducer(tmp(7397).BottomSheet, tmp48);
          ...
          if (tmp42) {
            ...
            items2[1] = timestampProducer(tmp(4754).Text, obj7);
        ...
        tmp37[3] = items3;
        const tmp39 = React5(tmp(5186).Stack, tmp37);
        cResult[18] = tmp20;
        cResult[19] = tmp31;
        cResult[20] = tmp39;
        tmp35 = tmp39;
      ...
      const tmp34 = React5(tmp(5186).Stack, obj9);
    ...
    const defaultRewardName = tmp(10575).getDefaultRewardName(quest.config, stateFromStores);
  ...
  let obj = quest(504);
  const tmp4 = quest;
  const defaultRewardName = quest(10575).getDefaultRewardName(quest.config, stateFromStores);
  ...
  const items3 = [closure_6(memo(11898), { quest, height: 56, width: 56, withAnimation: true }), ];
  ...
  const items4 = [closure_6(quest(4754).Text, obj6), closure_6(quest(4754).Text, { variant: "heading-lg/semibold", color: "text-strong", children: defaultRewardName })];
  obj5.children = items4;
  items3[1] = closure_7(quest(5186).Stack, obj5);
  obj4.children = items3;
  const items5 = [closure_7(quest(5186).Stack, obj4), ];
  ...
  if (tmp9Result) {
    ...
    items6[1] = tmp8(tmp4(4754).Text, obj9);
  ...
  return closure_6(quest(7397).BottomSheet, { startExpanded: true, children: closure_7(quest(5186).Stack, obj3) });
});
let size = fn(2);
