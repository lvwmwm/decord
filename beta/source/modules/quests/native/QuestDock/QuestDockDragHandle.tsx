...
// Dependencies: [19, 17, 5695, 15361, 21, 4790, 558, 568, 15362, 15363, 4529, 5219, 1119, 7433, 7352, 15360, 2]

// Module 15453 (QuestDockDragHandle)
...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? ((isExpanded) => {
  ...
  const context = youBarHorizontalMargin.useContext(activeQuestDockMode(15362).QuestDockGestureContext);
  activeQuestDockMode = context.activeQuestDockMode;
  const windowDimensions = context.windowDimensions;
  dependencyMap = tmp6;
  const obj = activeQuestDockMode(568);
  youBarHorizontalMargin = activeQuestDockMode(15363).useYouBarHorizontalMargin();
  let obj2 = activeQuestDockMode(15363);
  const fn = function n() {
  ...
  const animatedStyle = activeQuestDockMode(4529).useAnimatedStyle(fn);
  let obj3 = activeQuestDockMode(4529);
  ...
  const animatedStyle1 = activeQuestDockMode(4529).useAnimatedStyle(fn2);
  const obj5 = activeQuestDockMode(4529);
  ...
  const obj7 = activeQuestDockMode(4529);
  M.__closure = { withSpring: activeQuestDockMode(5219).withSpring, isDefaultVariant: "default" === isExpanded.variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  M.__workletHash = 7055026667171;
  M.__initData = __initData3;
  const animatedStyle2 = obj7.useAnimatedStyle(M);
  const obj8 = { withSpring: activeQuestDockMode(5219).withSpring, isDefaultVariant: "default" === isExpanded.variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  class C {
    constructor() {
      tmp = closure_0(closure_2[11]);
      if (!closure_2) {
  ...
  const obj9 = activeQuestDockMode(4529);
  C.__closure = { withSpring: activeQuestDockMode(5219).withSpring, isDefaultVariant: "default" === isExpanded.variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
    ...
    if (cResult[3] === animatedStyle3) {
      ...
      if (cResult[6] !== isExpanded) {
        ...
        if (cResult[8] !== cResult[7]) {
          ...
          const tmp20 = closure_7(tmp(7433).ActionSheetHeaderBar, obj11);
          cResult[8] = tmp14;
          cResult[9] = tmp20;
          let tmp18 = tmp20;
        } else {
        ...
        if (cResult[10] === tmp13) {
          ...
          if (cResult[13] === animatedStyle2) {
            ...
            if (cResult[16] === Symbol.for("react.memo_cache_sentinel")) {
              const tmp29 = closure_7(tmp(7433).ActionSheetHeaderBar, { variant: "default" });
              cResult[16] = tmp29;
              let tmp27 = tmp29;
            } else {
              tmp27 = cResult[16];
            ...
            if (cResult[17] !== tmp25) {
              ...
              const tmp33 = closure_7(windowDimensions(7352), obj12);
              cResult[17] = tmp25;
              cResult[18] = tmp33;
              let tmp30 = tmp33;
            } else {
            ...
            if (cResult[19] === animatedStyle1) {
              if (cResult[20] === tmp21) {
                ...
                const tmp42 = closure_7(windowDimensions(7352), obj13);
                cResult[23] = tmp12;
                cResult[24] = tmp34;
                cResult[25] = tmp42;
                tmp39 = tmp42;
            ...
            const obj14 = { style: animatedStyle1, layout: tmp(15360).dimensionsLayoutTransition, children: null };
            let items = [tmp21, tmp30];
            obj14.children = items;
            const tmp38 = closure_8(windowDimensions(7352), obj14);
            cResult[19] = animatedStyle1;
            cResult[20] = tmp21;
            cResult[21] = tmp30;
            cResult[22] = tmp38;
            tmp34 = tmp38;
            const tmp37 = windowDimensions(7352);
          }
        ...
        const tmp24 = closure_7(windowDimensions(7352), obj15);
        cResult[10] = tmp13;
        cResult[11] = tmp18;
        cResult[12] = tmp24;
        tmp21 = tmp24;
  ...
  dependencyMap = tmp5;
  youBarHorizontalMargin = activeQuestDockMode(15363).useYouBarHorizontalMargin();
  const obj = activeQuestDockMode(15363);
  ...
  const animatedStyle = activeQuestDockMode(4529).useAnimatedStyle(fn);
  let obj2 = activeQuestDockMode(4529);
  ...
  const animatedStyle1 = activeQuestDockMode(4529).useAnimatedStyle(fn2);
  const obj4 = activeQuestDockMode(4529);
  ...
  const obj6 = activeQuestDockMode(4529);
  M.__closure = { withSpring: activeQuestDockMode(5219).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  M.__workletHash = 14664873965359;
  M.__initData = __initData7;
  const animatedStyle2 = obj6.useAnimatedStyle(M);
  const obj7 = { withSpring: activeQuestDockMode(5219).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  class E {
    constructor() {
      tmp = closure_0(closure_2[11]);
      if (!closure_2) {
  ...
  const obj8 = activeQuestDockMode(4529);
  E.__closure = { withSpring: activeQuestDockMode(5219).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  ...
  obj10.style = items;
  const obj9 = { withSpring: activeQuestDockMode(5219).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  const tmp12 = windowDimensions;
  const obj11 = { style: animatedStyle1, layout: null, children: null };
  const tmp13 = windowDimensions(7352);
  const tmp14 = closure_8;
  obj11.layout = activeQuestDockMode(15360).dimensionsLayoutTransition;
  const obj12 = { style: null, children: null };
  const items1 = [tmp.dragHandleOverlay, animatedStyle3];
  obj12.style = items1;
  const tmp15 = windowDimensions(7352);
  ...
  obj12.children = closure_7(activeQuestDockMode(7433).ActionSheetHeaderBar, { variant: "overlay", accessibilityLabel: stringResult });
  const items2 = [closure_7(windowDimensions(7352), obj12), ];
  ...
  obj13.style = items3;
  const tmp16 = windowDimensions(7352);
  obj13.children = closure_7(tmp2(7433).ActionSheetHeaderBar, { variant: "default" });
  items2[1] = closure_7(tmp12(7352), obj13);
