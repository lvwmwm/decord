...
// Dependencies: [19, 15359, 5695, 15361, 21, 1095, 7353, 558, 568, 4529, 15360, 10600, 1368, 2]

// Module 15365 (QuestDockExternalCoordinationContext)
...
let closure_5 = fn(15361).QUEST_DOCK_EXTERNAL_SCROLL_DELTA_THRESHOLD;
const jsx = fn(21).jsx;
