...
// Dependencies: [19, 15349, 5663, 15351, 21, 7321, 1482, 4497, 15353, 15350, 12164, 2]

// Module 15352 (QuestDockGestureContext)
...
const height = fn(15351).QUEST_DOCK_COLLAPSED_HEIGHT;
const jsx = fn(21).jsx;
