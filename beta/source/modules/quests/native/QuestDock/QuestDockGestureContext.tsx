...
// Dependencies: [19, 15359, 5695, 15361, 21, 7353, 1482, 4529, 15363, 15360, 12200, 2]

// Module 15362 (QuestDockGestureContext)
...
const height = fn(15361).QUEST_DOCK_COLLAPSED_HEIGHT;
const jsx = fn(21).jsx;
