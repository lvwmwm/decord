...
// Dependencies: [19, 17, 5695, 15361, 21, 4790, 558, 568, 15362, 10383, 4529, 15360, 5219, 7352, 2]

// Module 15452 (QuestDockContentExpanded)
...
let QUEST_DOCK_MODE_CHANGE_PHYSICS = fn(15361).QUEST_DOCK_MODE_CHANGE_PHYSICS;
const jsx = fn(21).jsx;
