...
// Dependencies: [32, 19, 17, 5695, 15361, 21, 4790, 580, 5219, 558, 568, 15362, 1369, 4494, 15450, 4529, 15461, 15427, 7352, 5373, 4786, 1119, 11526, 15463, 8212, 2]

// Module 15460 (QuestDockBackgroundBlurHeader)
...
questDockHeaderLayoutAnimation.__closure = { withSpring: fn(5219).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
...
let obj5 = { withSpring: fn(5219).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
let size = fn(2);
...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  const context = noop.useContext(tmp(15362).QuestDockGestureContext);
  ...
  token = activeQuestDockMode(4494).useToken(questDockWrapperSpecs(580).modules.mobile.QUEST_DOCK_BORDER_RADIUS);
  const tmp13 = questDockWrapperSpecs(15450)(token);
  noop = tmp13;
  const tmpResult = activeQuestDockMode(4494);
  class F {
    constructor() {
  ...
  const tmpResult10 = activeQuestDockMode(4529);
  F.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5219).withSpring, questDockAnimatedBorderRadius: tmp13, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  F.__workletHash = 17202411570804;
  F.__initData = __initData;
  const animatedStyle = tmpResult10.useAnimatedStyle(F);
  let obj3 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5219).withSpring, questDockAnimatedBorderRadius: tmp13, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  const fn = function j() {
    let num = 1;
  ...
  const tmpResult11 = activeQuestDockMode(4529);
  ...
  let obj4 = { withSpring: activeQuestDockMode(5219).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  const animatedStyle2 = activeQuestDockMode(4529).useAnimatedStyle(fn2);
  let obj5 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_HORIZONTAL_EDGE_GUTTER_COLLAPSED: closure_10 };
  const tmpResult12 = activeQuestDockMode(4529);
  class J {
    constructor() {
  ...
  const tmpResult13 = activeQuestDockMode(4529);
  J.__closure = { withSpring: activeQuestDockMode(5219).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  J.__workletHash = 6229744150165;
  J.__initData = __initData4;
  const animatedStyle3 = tmpResult13.useAnimatedStyle(J);
  let obj6 = { withSpring: activeQuestDockMode(5219).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  const fn3 = function $() {
    let right = 0;
    if (activeQuestDockMode.get() !== QuestDockMode.EXPANDED) {
      right = v65535;
  ...
  const animatedStyle4 = activeQuestDockMode(4529).useAnimatedStyle(fn3);
  const tmpResult14 = activeQuestDockMode(4529);
  function ee() {
  ...
  const animatedProps = activeQuestDockMode(4529).useAnimatedProps(ee);
  const tmpResult15 = activeQuestDockMode(4529);
  function te() {
  ...
  const tmpResult16 = activeQuestDockMode(4529);
  te.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5219).withSpring, questDockAnimatedBorderRadius: tmp13, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  te.__workletHash = 8904986205240;
  te.__initData = __initData7;
  const animatedStyle5 = tmpResult16.useAnimatedStyle(te);
  activeQuestDockMode(4529);
  function oe() {
    let num = 0;
    if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
      num = 1;
  ...
  const obj7 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5219).withSpring, questDockAnimatedBorderRadius: tmp13, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  oe.__closure = { withSpring: activeQuestDockMode(5219).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  if (cResult[2] === animatedStyle) {
    ...
    if (tmpResult18.isAndroid()) {
      ...
      if (null != blurHash) {
        ...
        let tmp26 = closure_12(tmp11(15461), obj9);
      }
      cResult[5] = blurHash;
    ...
    tmp26 = closure_12(tmp11(15427), obj10);
  ...
  const context = noop.useContext(activeQuestDockMode(15362).QuestDockGestureContext);
  activeQuestDockMode = context.activeQuestDockMode;
  const questDockWrapperSpecs = context.questDockWrapperSpecs;
  ...
  token = activeQuestDockMode(4494).useToken(questDockWrapperSpecs(580).modules.mobile.QUEST_DOCK_BORDER_RADIUS);
  const tmp9 = questDockWrapperSpecs(15450)(token);
  noop = tmp9;
  let obj = activeQuestDockMode(4494);
  class Y {
    constructor() {
      obj = activeQuestDockMode;
      tmp = QuestDockMode;
  ...
  Y.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5219).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  Y.__workletHash = 3882883093351;
  Y.__initData = __initData9;
  const animatedStyle = obj2.useAnimatedStyle(Y);
  let obj3 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5219).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_11 };
  const fn = function x() {
    let num = 1;
    if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
      num = 0;
  ...
  let obj4 = activeQuestDockMode(4529);
  fn.__closure = { withSpring: activeQuestDockMode(5219).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn.__workletHash = 5461767762400;
  fn.__initData = __initData10;
  const animatedStyle1 = obj4.useAnimatedStyle(fn);
  let obj5 = { withSpring: activeQuestDockMode(5219).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  const animatedStyle2 = activeQuestDockMode(4529).useAnimatedStyle(fn2);
  let obj6 = activeQuestDockMode(4529);
  ...
  W.__closure = { withSpring: activeQuestDockMode(5219).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  W.__workletHash = 17362940839906;
  W.__initData = __initData12;
  const animatedStyle3 = obj8.useAnimatedStyle(W);
  const obj9 = { withSpring: activeQuestDockMode(5219).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  class Z {
    constructor() {
      right = 0;
      if (activeQuestDockMode.get() !== QuestDockMode.EXPANDED) {
  ...
  const animatedStyle4 = activeQuestDockMode(4529).useAnimatedStyle(Z);
  const obj10 = activeQuestDockMode(4529);
  class V {
    constructor() {
      pointerEvents = "none";
      if (activeQuestDockMode.get() === QuestDockMode.EXPANDED) {
  ...
  const animatedProps = activeQuestDockMode(4529).useAnimatedProps(V);
  const obj11 = activeQuestDockMode(4529);
  class F {
    constructor() {
      obj = activeQuestDockMode;
      tmp = QuestDockMode;
  ...
  const obj12 = activeQuestDockMode(4529);
  F.__closure = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5219).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  F.__workletHash = 5464365691303;
  F.__initData = __initData15;
  const animatedStyle5 = obj12.useAnimatedStyle(F);
  const obj13 = { activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, withSpring: activeQuestDockMode(5219).withSpring, questDockAnimatedBorderRadius: tmp9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, questDockWrapperSpecs };
  ...
  const obj14 = activeQuestDockMode(4529);
  fn3.__closure = { withSpring: activeQuestDockMode(5219).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  ...
  obj16.style = items;
  const obj15 = { withSpring: activeQuestDockMode(5219).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  const tmp7Result = questDockWrapperSpecs(7352);
  if (tmpResult.isAndroid()) {
    if (null != blurHash) {
      ...
      let tmp24 = closure_12(tmp7(15461), obj17);
    ...
    if (withPressableDisclosure) {
      ...
      obj27.children = tmp23(tmp(4786).Text, obj28);
      tmp23Result = tmp23(tmp26, obj27);
    }
    const items8 = [tmp23Result, tmp23(tmp7(15463), {}), ];
    ...
    obj29.children = tmp23(tmp(8212).MoreHorizontalIcon, obj30);
    items8[2] = tmp23(tmp(5373).PressableOpacity, obj29);
    obj22.children = items8;
    obj21.children = tmp19(tmp7(7352), obj22);
  ...
  tmp23 = closure_12;
  tmp24 = closure_12(tmp7(15427), { layoutAnimatedStyle: animatedStyle5, opacityAnimatedStyle: animatedStyle6, layoutAnimation: tmp21 });
}));
