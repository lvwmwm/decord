...
const forwardRefResult = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0, ref) => {
  ...
  if (cResult[5] !== str) {
    ...
    const tmp15 = hasOwnProperty(tmp(8765).Path, obj2);
    ...
    const tmp16 = hasOwnProperty(tmp(8765).Path, obj3);
    ...
    const tmp17 = hasOwnProperty(tmp(8765).Path, obj4);
    cResult[5] = str;
    cResult[6] = tmp15;
    cResult[7] = tmp16;
    cResult[8] = tmp17;
