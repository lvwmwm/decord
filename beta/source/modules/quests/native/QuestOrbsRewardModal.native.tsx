...
// Dependencies: [32, 5, 19, 17, 4748, 1372, 1979, 5661, 21, 4959, 12032, 1980, 4756, 576, 9116, 5848, 5897, 1115, 5804, 9089, 1365, 12033, 12034, 12035, 504, 9129, 1094, 11553, 12036, 12020, 5664, 12037, 7368, 4752, 5186, 2]
...
export default function QuestOrbsRewardModal(quest) {
  ...
  if (!tmp6) {
    ...
    tmp11(tmp2(7368).SafeAreaPaddingView, rect);
  }
};
