...
// Dependencies: [32, 19, 17, 2041, 4405, 1372, 10004, 11645, 1074, 21, 4756, 576, 8454, 1115, 4712, 5904, 5822, 1177, 1612, 7407, 7427, 504, 8450, 7395, 1241, 6869, 8188, 4752, 4908, 7212, 4723, 11647, 1980, 1249, 5186, 10003, 8675, 2108, 4451, 2]
...
export default noop.memo(function BlockConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    if (!stateFromStores1) {
      ...
      obj16.children = tmp13(tmp7(5904).TableRowGroup, obj17);
    ...
    tmp13Result2 = tmp13(tmp7(7407).AnalyticsLocationProvider, obj4);
