...
// Module 17869 (RedesignSkipAvatarUploadAlertModal)
import c from "c" /* 568 */;
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((onConfirm) => {
  ...
  if (cResult[0] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    const stringResult = intl.string(tmp(1119).t.DnKHuV);
    const intl2 = tmp(1119).intl;
    const stringResult1 = intl2.string(tmp(1119).t["1EPySE"]);
  ...
  if (cResult[2] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    const stringResult2 = intl3.string(tmp(1119).t.nhJ8OC);
  ...
  if (cResult[5] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    obj3.text = intl4.string(tmp(1119).t["7eZ3ji"]);
    const tmp15 = React2(tmp(5148).AlertActionButton, obj3, "add-profile-picture");
    cResult[5] = tmp15;
    let tmp13 = tmp15;
  } else {
    tmp13 = cResult[5];
