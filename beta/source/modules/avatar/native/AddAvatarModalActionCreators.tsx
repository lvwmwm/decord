...
// Dependencies: [17842, 1078, 1245, 7230, 5110, 1119, 8438, 8440, 4961, 17843, 1984, 12851, 2]
// Exports: handlePressNext, openAddAvatarModal, showSkipAvatarModal

// Module 17841 (AddAvatarModalActionCreators)
...
import AddAvatarModalConstants from "AddAvatarModalConstants" /* 17842 */;
...
export const openAddAvatarModal = function openAddAvatarModal() {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(17843, dependencyMap.paths), {}, ADD_AVATAR_MODAL_KEY);
};
