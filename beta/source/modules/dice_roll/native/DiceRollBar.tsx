...
// Function ID: 12569
// Name: DiceRollBar
// Dependencies: [19, 17, 4782, 12125, 21, 4790, 580, 558, 568, 504, 4529, 4791, 1181, 12569, 9143, 4786, 2]

// Module 12568 (DiceRollBar)
...
const useDiceRollState = fn(12125).useDiceRollState;
const jsxProd = fn(21);
