...
// Function ID: 9724
// Name: VideoRenderer
// Dependencies: [32, 19, 17, 21, 4790, 558, 568, 9724, 9725, 9726, 1482, 1368, 8640, 9731, 9732, 9734, 4529, 2]
...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  onReady = width(9726)({ streamId, userId, videoSpinnerContext, paused, loading: tmp17, streamKey }).onReady;
  noop.useRef(null);
  ...
  const store = resizeMode(8640).useStore((orientation) => orientation.orientation);
  ...
  if (tmp17) {
    ...
    tmp35 = ref(tmp18(9731), obj3);
  }
  const tmp37 = store === resizeMode(8640).OrientationType.PORTRAIT;
  const obj2 = resizeMode(8640);
  if (tmp3Result.isAndroid()) {
    ...
    const items11 = [ref(tmp18(9732), obj7), tmp35];
    obj6.children = items11;
    obj5.children = c9(first2, obj6);
    const items12 = [ref(tmp18(9734), obj5), ];
    ...
    obj12.children = ref(tmp18(9732), obj13);
    const items13 = [ref(tmp18(4529).View, obj12), ];
    let tmp48 = null;
    if (tmp37) {
    ...
    const items17 = [ref(tmp18(9732), obj16), tmp35];
