...
// Dependencies: [5, 32, 19, 17, 9746, 9641, 1074, 9320, 21, 4756, 1478, 9678, 4492, 9747, 10333, 9644, 4966, 4959, 9326, 1980, 1110, 10195, 12918, 4609, 9772, 1364, 4466, 4639, 7245, 2]
// Exports: default

// Module 9745 (ChannelCallNavigator)
...
function CallWithVoiceChat(channel) {
  ...
  if (channel.isGuildStageVoice()) {
    const obj6 = { channel };
    tmp16 = closure_12(tmp2(9747), obj6);
  }
  const items1 = [tmp16, ];
  ...
  if (tmp11[0]) {
    const obj9 = { channel };
    tmp18Result = tmp18(tmp2(10333), obj9);
  }
...
function MainCallScreen(channel) {
  ...
  isConnectedToVoiceChannel = isConnectedToVoiceChannel(9644).useIsConnectedToVoiceChannel(channel);
  const id = noop.useId();
  ...
  let obj = isConnectedToVoiceChannel(9644);
  ...
  if (isChannelContentGated) {
    ...
    if (channel.isGuildStageVoice()) {
      let obj7 = { channel };
      tmp14Result = tmp14(id(9747), obj7);
    }
...
const ChannelCallScreens = fn(9641).ChannelCallScreens;
const ComponentActions = fn(1074).ComponentActions;
let closure_11 = fn(9320).OAUTH2_AUTHORIZE_MODAL_KEY;
const jsxProd = fn(21);
...
export default function ChannelCallNavigator(channel) {
  ...
  obj.children = closure_12(channel(7245).Navigator, obj2);
