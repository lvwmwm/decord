...
// Dependencies: [19, 17, 2040, 4772, 4773, 4778, 502, 1992, 9655, 4777, 4781, 21, 4756, 9665, 10204, 504, 9910, 5634, 10205, 9904, 9674, 9666, 1115, 10208, 10209, 9644, 10232, 10233, 4957, 4898, 4808, 9576, 10234, 7513, 10061, 7407, 7427, 9669, 10235, 10259, 10269, 2]
...
export default function ChannelCallActionBar(arg0) {
  ...
  if (shouldShowConnectingScreen) {
    const obj4 = { channel };
    let tmp13Result = tmp11(tmp9(10235).CallConnectingActionBar, obj4);
  } else {
    ...
    items[2] = tmp11(tmp9(10259).ChannelCallMicButton, obj8);
    if (tmp7.END_REMOTE === END_REMOTE) {
      const obj9 = { channel, isSmallSize: isFiveButtonLayout };
      let tmp11Result6 = tmp11(tmp9(10269).DisconnectRemoteButton, obj9);
