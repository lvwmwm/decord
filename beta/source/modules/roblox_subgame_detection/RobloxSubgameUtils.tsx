...
// Dependencies: [5, 2003, 1078, 4921, 12, 4922, 4481, 2]
...
// Module 4920 (RobloxSubgameUtils)
import _modDef12 from "module_12" /* 12 */;
import RobloxSubgameTypes from "RobloxSubgameTypes" /* 4921 */;
import RobloxSubgamePlatformUtilsDefault from "RobloxSubgamePlatformUtils" /* 4922 */;
  ...
  if (null == subgameInfo) {
    ...
    if (null != application) {
      ...
      if (isDetectionEnabled(obj2)) {
        ...
        const obj7 = {};
        obj7[tmp9(4921).RobloxMetadataKeys.ROBLOX_TIME_STARTED] = str.toString();
        const universeId = subgameInfo.universeId;
        obj.sku = universeId;
        if (null != subgameInfo.placeId) {
          obj7[tmp9(4921).RobloxMetadataKeys.PLACE_ID] = subgameInfo.placeId;
        }
...
export const convertMapToRobloxSubgameInfo = function convertMapToRobloxSubgameInfo(arg0) {
  ...
  if (null != arg0[RobloxSubgameTypes.NativeRobloxSubgameKeys.UNIVERSE_ID]) {
    tmp3 = null;
    if (null != arg0[tmp(undefined, 4921).NativeRobloxSubgameKeys.PLACE_ID]) {
      const obj = { universeId: arg0[tmp(undefined, 4921).NativeRobloxSubgameKeys.UNIVERSE_ID], placeId: arg0[tmp(undefined, 4921).NativeRobloxSubgameKeys.PLACE_ID] };
      tmp3 = obj;
    }
  }
  return tmp3;
  ...
  if (currentGameForAnalytics.distributor === constants.ROBLOX) {
    ...
    if (null != currentGameForAnalytics.gameMetadata) {
      ...
      if (null != currentGameForAnalytics.gameMetadata[RobloxSubgameTypes.RobloxMetadataKeys.PLACE_ID]) {
        const _JSON = JSON;
        const obj = { placeId: currentGameForAnalytics.gameMetadata[tmp2(undefined, 4921).RobloxMetadataKeys.PLACE_ID] };
  ...
  if (visibleGame.distributor === constants.ROBLOX) {
    if (null != visibleGame.gameMetadata) {
      if (null != visibleGame.gameMetadata[RobloxSubgameTypes.RobloxMetadataKeys.ROBLOX_TIME_STARTED]) {
        if (visibleGame.id !== tmp2(4921).ROBLOX_APPLICATION_ID) {
          if (null != visibleGame.gameName) {
            let obj = { name: null, sync_id: null };
            ({ gameName: obj.name, gameMetadata } = visibleGame);
            obj.sync_id = gameMetadata[tmp2(undefined, 4921).RobloxMetadataKeys.ROBLOX_TIME_STARTED];
          }
          return obj;
        }
      }
...
export const maybeTransformRobloxSubgameToRoblox = function maybeTransformRobloxSubgameToRoblox(distributor) {
  ...
  if (distributor.distributor === constants.ROBLOX) {
    ...
    if (distributor.id !== RobloxSubgameTypes.ROBLOX_APPLICATION_ID) {
      ...
      obj.id = tmp3(4921).ROBLOX_APPLICATION_ID;
