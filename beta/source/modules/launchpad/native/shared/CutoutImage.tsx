...
const getReactNativeSVGImageSourceDefault = tmp13(13327);
require = fn;
  ...
  if (num14 <= 0) {
    ...
    if (null == v4Result) {
      ...
      if (null != imageBackgroundColor) {
        ...
        tmp15Result13 = tmp15(tmp(8733).Rect, size3);
      }
      ...
      if (null == imageSource) {
        ...
        if (null != borderStroke) {
          ...
          tmp15Result14 = tmp15(tmp(8733).Rect, size4);
        }
        ...
        if (typeof imageSource !== "number") {
          ...
          let tmp15Result15 = tmp15(tmp(8733).Image, size5);
        }
    ...
    tmp15Result18 = tmp15(tmp(8733).Rect, size9);
  }
});
