...
// Dependencies: [19, 17, 21, 4790, 580, 558, 568, 17147, 4786, 1181, 17142, 2]

// Module 17701 (VoiceOrStageSummaryRow)
...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? ((audienceCount) => {
  ...
  if (tmp8Result) {
    ...
    obj4.style = items3;
    let obj5 = { size: max(1181).Icon.Sizes.CUSTOM, style: { height: 14, width: 14 }, source: _modDef17142 };
    const items4 = [closure_4(max(1181).Icon, obj5), ];
    let obj6 = { variant: "text-sm/bold", style: { marginLeft: 4 }, children: audienceCount };
    items4[1] = closure_4(max(4786).Text, obj6);
