...
// Dependencies: [19, 17, 2045, 2099, 21, 4758, 558, 568, 565, 12328, 17164, 11708, 1119, 4754, 2]

// Module 17692 (LaunchPadMembers)
...
import ThreadChannelUserListDefault from "ThreadChannelUserList" /* 17164 */;
...
export default noop.memo(ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    const fn = function y() {
      ...
      return { channelId: "unicodeVersion", type: 0. };
    };
    cResult[0] = items;
    cResult[1] = fn;
    tmp5 = items;
