...
// Dependencies: [5, 3, 5020, 5422, 4413, 2]
// Exports: convertFileToJpeg

// Module 5517 (imageConversion)
...
export const renameToJpegExtension = fn(5422).renameToJpegExtension;
