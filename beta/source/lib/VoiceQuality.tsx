...
// Function ID: 14089
// Name: VoiceQuality
// Dependencies: [32, 7989, 4816, 14089, 7995, 4813, 12, 4787, 2]

// Module 14088 (VoiceQuality)
  ...
  constructor(arg0) {
    ...
    tmp3.sampleStats = function sampleStats(rtp) {
      ...
      if (null != rtp) {
        ...
        const result = networkQuality.incrementNetworkStats(outboundStats(4787).now());
