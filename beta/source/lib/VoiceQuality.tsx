...
// Function ID: 14126
// Name: VoiceQuality
// Dependencies: [32, 8021, 4848, 14126, 8027, 4845, 12, 4819, 2]

// Module 14125 (VoiceQuality)
  ...
  constructor(arg0) {
    ...
    tmp3.sampleStats = function sampleStats(rtp) {
      ...
      if (null != rtp) {
        ...
        const result = networkQuality.incrementNetworkStats(outboundStats(4819).now());
