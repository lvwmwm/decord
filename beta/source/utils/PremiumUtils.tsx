...
// Function ID: 4451
// Name: PremiumUtils
// Dependencies: [32, 19, 4451, 1376, 4452, 4453, 4455, 4456, 1078, 1378, 4464, 1089, 3, 558, 568, 4465, 4462, 1973, 38, 1119, 3198, 4384, 4474, 4481, 7513, 4463, 13765, 1095, 504, 11610, 5380, 4687, 14290, 1382, 1384, 9503, 2]
...
import useFPDurationLeft from "useFPDurationLeft" /* 13765 */;
import ProductCatalog from "ProductCatalog" /* 14290 */;
    ...
    if (tmp24) {
      ...
      if (tmp24) {
        ...
        if (SubscriptionPlans.PREMIUM_MONTH_TIER_0 !== planId) {
          if (tmp46.PREMIUM_YEAR_TIER_0 !== planId) {
              ...
              if (tmp46.PREMIUM_YEAR_TIER_1 !== planId) {
                ...
                if (tmp17.CANCELED === CANCELED) {
                  ...
                  if (null != subscription.pauseEndsAt) {
                    diffResult = _modDef4384(subscription.pauseEndsAt).diff(subscription.currentPeriodEnd, "days");
                    const obj19 = _modDef4384(subscription.pauseEndsAt);
                  }
                  if (null != diffResult) {
                    const intl11 = util.intl;
                  ...
                  const obj16 = _modDef4384(subscription.currentPeriodStart);
                  obj15.endDate = _modDef4384(subscription.currentPeriodStart).add(closure_1_29, "days").toDate();
            ...
            if (tmp17.CANCELED === CANCELED) {
              ...
              if (null != subscription.pauseEndsAt) {
                diffResult1 = _modDef4384(subscription.pauseEndsAt).diff(subscription.currentPeriodEnd, "days");
                const obj32 = _modDef4384(subscription.pauseEndsAt);
              }
              if (null != diffResult1) {
        ...
        if (tmp17.CANCELED === CANCELED) {
          ...
          if (null != subscription.pauseEndsAt) {
            diffResult2 = _modDef4384(subscription.pauseEndsAt).diff(subscription.currentPeriodEnd, "days");
            const obj42 = _modDef4384(subscription.pauseEndsAt);
          }
          if (null != diffResult2) {
...
function getBillingGracePeriodDaysAndExpiresDate(subscription) {
  if (subscription.isPurchasedViaApple) {
    ...
    if (null != prop) {
      const obj11 = _modDef4384(subscription.metadata.apple_grace_period_expires_date);
      const obj3 = { days: null, expiresDate: null };
      obj3.days = _modDef4384.duration(obj11.diff(subscription.currentPeriodStart)).days();
  ...
  if (subscription.isPurchasedViaGoogle) {
    ...
    if (null != prop1) {
      ...
      if (null != prop2) {
        const obj7 = _modDef4384(subscription.metadata.google_grace_period_expires_date);
        const obj4 = { days: null, expiresDate: null };
        const tmp20 = _modDef4384(subscription.metadata.google_original_expires_date);
        obj4.days = _modDef4384.duration(obj7.diff(tmp20)).days();
  ...
  if (subscription.isPurchasedExternally) {
    ...
    const obj5 = { days: tmp15, expiresDate: _modDef4384(subscription.currentPeriodStart).add(tmp15, "days") };
    return obj5;
  } else {
    ...
    if (null != prop3) {
      ...
      obj8.days = _modDef4384(prop4).diff(subscription.currentPeriodStart, "days");
      obj8.expiresDate = tmp11(4384)(subscription.metadata.grace_period_expires_date);
      return obj8;
    } else {
      const tmp8 = null == subscription.paymentSourceId ? closure_1_19 : __initData3;
      obj = { days: tmp8, expiresDate: _modDef4384(subscription.currentPeriodStart).add(tmp8, "days") };
      return obj;
    }
  }
}
...
let closure_47 = fn(4464).getPremiumGroupProductName;
Constants = fn(1089);
...
function getBillingInformationString(status, subscriptionPeriodStart, first1, flag, fractionalPremiumInfo) {
  ...
  if (fractionalPremiumInfo === undefined) {
    obj = { isFractionalPremiumActive: false, fetched: true, fractionalState: constants6.NONE, startsAt: _modDef4384(0), endsAt: _modDef4384(0), currentEntitlementId: "", currentEntitlementEndsAt: _modDef4384(0), unactivatedUnits: [] };
    tmp2 = obj;
  }
  ...
  if (isOnReverseTrialResult) {
    ...
    if (isPurchasedViaGoogle) {
      expiresDate = _modDef4384(status.metadata.google_grace_period_expires_date);
    }
    ...
    if (isPurchasedViaApple) {
      expiresDate = _modDef4384(status.metadata.apple_grace_period_expires_date);
    }
    ...
    const obj18 = _modDef4384(status.currentPeriodStart);
    obj13.endDate = _modDef4384(status.currentPeriodStart).add(closure_1_29, "days").toDate();
    ...
    if (status.isPurchasedViaGoogle) {
      if (!tmp14Result.isGooglePlayBillingSupported()) {
        ...
        const obj12 = _modDef4384(status.currentPeriodStart);
        obj14.endDate = _modDef4384(status.currentPeriodStart).add(closure_1_26, "days").toDate();
        ...
        const addResult1 = _modDef4384(status.currentPeriodStart).add(closure_1_26, "days");
      }
      return formatResult2;
    }
    const intl7 = tmp14(1119).intl;
    const obj16 = { endDate: null, price: null };
    const obj15 = _modDef4384(status.currentPeriodStart);
    obj16.endDate = _modDef4384(status.currentPeriodStart).add(closure_1_26, "days").toDate();
    obj16.price = formatPriceResult;
    formatResult2 = intl7.format(tmp14(1119).t.EMTLOT, obj16);
    const addResult2 = _modDef4384(status.currentPeriodStart).add(closure_1_26, "days");
  } else {
...
function extendDateWithUnconsumedFractionalPremium(date, unconsumedFractionalPremiumUnits, diff, excludeReverseTrialFromCountdown) {
  ...
  const tmp3Result = _modDef4384(tmp4);
  ...
  if (!excludeReverseTrialFromCountdown) {
    ...
    if (undefined !== diff) {
      const diffResult = diff.diff(_modDef4384(), "hours", true);
      addResult1 = addResult;
      if (diffResult > 0) {
...
obj6.canUseShopDiscounts = function canUseShopDiscounts(currentUser) {
  ...
  if (!hasPerkResult) {
    hasPerkResult = tmp(14290).canUserUse(tmp(14290).COLLECTIBLES, currentUser);
    const tmpResult = tmp(14290);
  }
...
obj6.canUseMoreQuestOrbs = function canUseMoreQuestOrbs(perks) {
  ...
  if (!hasPerkResult) {
    hasPerkResult = tmp(14290).canUserUse(tmp(14290).QUEST_ORB_MULTIPLIER, perks);
    const tmpResult = tmp(14290);
  }
  return hasPerkResult;
};
