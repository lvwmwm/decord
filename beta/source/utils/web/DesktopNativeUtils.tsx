...
// Dependencies: [32, 5, 1078, 38, 4721, 1368, 510, 5817, 2022, 4, 5818, 5819, 1370, 1275, 4816, 2]

// Module 5816 (DesktopNativeUtils)
import logger_Logger from "logger/Logger" /* 4 */;
import Storage3 from "Storage" /* 510 */;
import GameDetectionTypes from "GameDetectionTypes" /* 2022 */;
import Client from "Client" /* 4721 */;
import discord_common_DiscordNative from "discord_common/DiscordNative" /* 4816 */;
import DomainMigrationUtils from "DomainMigrationUtils" /* 5817 */;
import IPCEvents from "IPCEvents" /* 5818 */;
import _slicedToArray from "module_32" /* 32 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;

const FileExtensionUtils = tmp2(5819);
require = fn;
...
obj2.setBadge = function setBadge(arg0) {
  if ("darwin" === obj.getPlatformName()) {
    ...
    if ("win32" === tmpResult.getPlatformName()) {
      const self = this;
      this.sendIPC(tmp(5818).IPCEvents.APP_BADGE_SET, arg0);
    } else {
      ...
      try {
        ...
        if (0 === c3) {
          ...
          if (arg0 === 1) {
            ...
            closure_129_0 = value;
            closure_129_1 = closure_0(5819).decideFileExtension(closure_130_0, closure_130_1);
...
obj2.canSaveImage = function canSaveImage(uri, contentType) {
  if (null != uri) {
    if (require("PlatformUtils").isPlatformEmbedded) {
      const decideFileExtensionResult = tmp(5819).decideFileExtension(uri, contentType);
          ...
          if (arg0 === 1) {
            ...
            if (null == toURLSafeResult) {
              ...
              if (null != str2) {
                ...
                const decideFileExtensionResult = unknown(5819).decideFileExtension(tmp54, closure_1);
...
obj2.setTrafficLightPosition = function setTrafficLightPosition(arg0) {
  if (require("PlatformUtils").isPlatformEmbedded) {
    if ("darwin" === tmpResult.getPlatformName()) {
      try {
        const self = this;
        this.sendIPC(tmp(5818).IPCEvents.WINDOW_SET_TRAFFIC_LIGHT_POSITION, arg0);
      } catch (err) {
      }
    }
    tmpResult = tmp(1368);
...
obj2.setTrafficLightAppearance = function setTrafficLightAppearance(arg0, arg1) {
  if (require("PlatformUtils").isPlatformEmbedded) {
    if ("darwin" === tmpResult.getPlatformName()) {
      try {
        const self = this;
        this.sendIPC(tmp(5818).IPCEvents.WINDOW_SET_TRAFFIC_LIGHT_APPEARANCE, arg0, arg1);
      } catch (err) {
      }
    }
    tmpResult = tmp(1368);
