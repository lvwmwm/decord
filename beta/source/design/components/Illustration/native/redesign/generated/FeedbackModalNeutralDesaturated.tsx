...
// Dependencies: [19, 17, 21, 8507, 11760, 11761, 11762, 558, 568, 4610, 2]
// Exports: getFeedbackModalNeutralDesaturatedSource

// Module 11759 (FeedbackModalNeutralDesaturated)
import c from "c" /* 568 */;
...
let tmp3 = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] !== theme) {
    const obj3 = {
      dark() {
          return require("module_11760");
        },
      darker() {
          return require("module_11761");
        },
      light() {
...
export const FeedbackModalNeutralDesaturated = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(3);
