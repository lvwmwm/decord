...
// Function ID: 9859
// Name: NoResultsAlt
// Dependencies: [19, 17, 21, 8539, 9859, 9860, 7333, 558, 568, 4642, 2]
// Exports: getNoResultsAltSource

// Module 9858 (NoResultsAlt)
import c from "c" /* 568 */;
...
let tmp3 = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] !== theme) {
    const obj3 = {
      dark() {
          return require("module_9859");
        },
      darker() {
          return require("module_9860");
        },
      light() {
          return require("module_7333");
        }
    };
