...
// Dependencies: [19, 17, 21, 8539, 8540, 8541, 8542, 558, 568, 4642, 2]
// Exports: getNoResultsSource

// Module 8538 (generated/NoResults)
import c from "c" /* 568 */;
...
let tmp3 = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] !== theme) {
    const obj3 = {
      dark() {
          return require("module_8540");
        },
      darker() {
          return require("module_8541");
        },
      light() {
          return require("module_8542");
        }
    };
