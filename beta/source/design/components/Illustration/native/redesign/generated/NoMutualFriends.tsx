...
// Dependencies: [19, 17, 21, 8507, 12773, 12774, 12775, 558, 568, 4610, 2]
// Exports: getNoMutualFriendsSource

// Module 12772 (NoMutualFriends)
import c from "c" /* 568 */;
...
let tmp3 = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] !== theme) {
    const obj3 = {
      dark() {
          return require("module_12773");
        },
      darker() {
          return require("module_12774");
        },
      light() {
          return require("module_12775");
        }
    };
