...
// Dependencies: [19, 17, 21, 8539, 12809, 12810, 12811, 558, 568, 4642, 2]
// Exports: getNoMutualFriendsSource

// Module 12808 (NoMutualFriends)
import c from "c" /* 568 */;
...
let tmp3 = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] !== theme) {
    const obj3 = {
      dark() {
          return require("module_12809");
        },
      darker() {
          return require("module_12810");
        },
      light() {
          return require("module_12811");
        }
    };
...
export const NoMutualFriends = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(3);
