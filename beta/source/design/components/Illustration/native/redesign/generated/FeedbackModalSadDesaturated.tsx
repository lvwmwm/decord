...
// Dependencies: [19, 17, 21, 8539, 11791, 11792, 11793, 558, 568, 4642, 2]
// Exports: getFeedbackModalSadDesaturatedSource

// Module 11790 (FeedbackModalSadDesaturated)
import c from "c" /* 568 */;
...
let tmp3 = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] !== theme) {
    const obj3 = {
      dark() {
          return require("module_11791");
        },
      darker() {
          return require("module_11792");
        },
      light() {
