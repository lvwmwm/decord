...
// Dependencies: [19, 17, 21, 8507, 11755, 11756, 11757, 558, 568, 4610, 2]
// Exports: getFeedbackModalSadDesaturatedSource

// Module 11754 (FeedbackModalSadDesaturated)
import c from "c" /* 568 */;
...
let tmp3 = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] !== theme) {
    const obj3 = {
      dark() {
          return require("module_11755");
        },
      darker() {
          return require("module_11756");
        },
      light() {
          return require("module_11757");
        }
    };
