...
// Function ID: 10124
// Name: AppCrash
// Dependencies: [19, 17, 21, 8539, 10124, 10125, 10126, 558, 568, 4642, 2]
// Exports: getAppCrashSource

// Module 10123 (AppCrash)
import c from "c" /* 568 */;
...
let tmp3 = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] !== theme) {
    const obj3 = {
      dark() {
          return require("module_10124");
        },
      darker() {
          return require("module_10125");
        },
      light() {
          return require("module_10126");
        }
    };
