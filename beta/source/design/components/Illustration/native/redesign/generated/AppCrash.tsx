...
// Function ID: 10085
// Name: AppCrash
// Dependencies: [19, 17, 21, 8507, 10085, 10086, 10087, 558, 568, 4610, 2]
// Exports: getAppCrashSource

// Module 10084 (AppCrash)
import c from "c" /* 568 */;
...
let tmp3 = ReactCompilerGating.isReactCompilerEnabled() ? (() => {
  ...
  if (cResult[0] !== theme) {
    const obj3 = {
      dark() {
          return require("module_10085");
        },
      darker() {
          return require("module_10086");
        },
      light() {
          return require("module_10087");
        }
    };
