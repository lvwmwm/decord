...
// Dependencies: [109, 19, 21, 558, 568, 580, 15626, 4461, 2]

// Module 15625 (EmojiColdFaceIcon)
import c from "c" /* 568 */;
...
export const EmojiColdFaceIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
