...
// Dependencies: [109, 19, 21, 558, 568, 580, 16061, 4493, 2]

// Module 16060 (ArrowSmallDownIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod16061 from "module_16061" /* 16061 */;
...
export const ArrowSmallDownIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod16061, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
