...
// Function ID: 11757
// Name: ChatPlusIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11757, 4493, 2]

// Module 11756 (ChatPlusIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod11757 from "module_11757" /* 11757 */;
...
export const ChatPlusIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11757, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
