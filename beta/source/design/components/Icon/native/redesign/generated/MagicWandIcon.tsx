...
// Function ID: 13021
// Name: MagicWandIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 13021, 4493, 2]

// Module 13020 (MagicWandIcon)
import c from "c" /* 568 */;
...
export const MagicWandIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13021, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
