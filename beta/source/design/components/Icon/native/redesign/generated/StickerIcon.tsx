...
// Function ID: 12733
// Name: StickerIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 12733, 4493, 2]

// Module 12732 (StickerIcon)
import c from "c" /* 568 */;
...
export const StickerIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
