...
// Function ID: 17300
// Name: GridSquareIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 16093, 4493, 2]

// Module 17299 (GridSquareIcon)
import c from "c" /* 568 */;
...
export const GridSquareIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod16093, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
