...
// Function ID: 15376
// Name: UndoIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15376, 4493, 2]

// Module 15375 (UndoIcon)
import c from "c" /* 568 */;
...
export const UndoIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
