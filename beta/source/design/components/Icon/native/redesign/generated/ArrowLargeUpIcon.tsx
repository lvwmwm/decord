...
// Dependencies: [109, 19, 21, 558, 568, 580, 11548, 4461, 2]

// Module 11547 (ArrowLargeUpIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod11548 from "module_11548" /* 11548 */;
...
export const ArrowLargeUpIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11548, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
