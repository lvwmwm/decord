...
// Dependencies: [109, 19, 21, 558, 568, 580, 5298, 4493, 2]

// Module 5333 (ImageWarningIcon)
import c from "c" /* 568 */;
...
export const ImageWarningIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
