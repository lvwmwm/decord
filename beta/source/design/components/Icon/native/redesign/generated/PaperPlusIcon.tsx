...
// Function ID: 13355
// Name: PaperPlusIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 13355, 4461, 2]

// Module 13354 (PaperPlusIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod13355 from "module_13355" /* 13355 */;
...
export const PaperPlusIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13355, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
