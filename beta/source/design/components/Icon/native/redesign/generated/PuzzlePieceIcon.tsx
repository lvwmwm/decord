...
// Dependencies: [109, 19, 21, 558, 568, 580, 15232, 4493, 2]

// Module 15231 (PuzzlePieceIcon)
import c from "c" /* 568 */;
...
export const PuzzlePieceIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
