...
// Dependencies: [109, 19, 21, 558, 568, 580, 15994, 4493, 2]

// Module 15993 (ArrowLargeRightIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod15994 from "module_15994" /* 15994 */;
...
export const ArrowLargeRightIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15994, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
