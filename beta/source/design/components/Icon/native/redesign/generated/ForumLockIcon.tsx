...
// Function ID: 5339
// Name: ForumLockIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 5319, 4493, 2]

// Module 5338 (ForumLockIcon)
import c from "c" /* 568 */;
...
export const ForumLockIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5319, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
