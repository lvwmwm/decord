...
// Function ID: 8237
// Name: XSmallBoldIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 7448, 4461, 2]

// Module 8236 (XSmallBoldIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod7448 from "module_7448" /* 7448 */;
...
export const XSmallBoldIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7448, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
