...
// Function ID: 13636
// Name: BellZIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 13636, 4493, 2]

// Module 13635 (BellZIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod13636 from "module_13636" /* 13636 */;
...
export const BellZIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13636, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
