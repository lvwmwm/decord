...
// Dependencies: [109, 19, 21, 558, 568, 580, 11901, 4493, 2]

// Module 11900 (ChatArrowRightIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod11901 from "module_11901" /* 11901 */;
...
export const ChatArrowRightIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11901, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
