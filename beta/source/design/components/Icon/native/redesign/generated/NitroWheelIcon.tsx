...
// Function ID: 8939
// Name: NitroWheelIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8315, 4461, 2]

// Module 8938 (NitroWheelIcon)
import c from "c" /* 568 */;
...
export const NitroWheelIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8315, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
