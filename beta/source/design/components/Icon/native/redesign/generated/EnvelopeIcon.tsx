...
// Function ID: 7361
// Name: EnvelopeIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 7361, 4493, 2]

// Module 7360 (EnvelopeIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod7361 from "module_7361" /* 7361 */;
...
export const EnvelopeIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7361, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
