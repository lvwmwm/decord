...
// Dependencies: [109, 19, 21, 558, 568, 580, 13215, 4461, 2]

// Module 13214 (LinkExternalMediumIcon)
import c from "c" /* 568 */;
...
export const LinkExternalMediumIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13215, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
