...
// Dependencies: [109, 19, 21, 558, 568, 580, 13251, 4493, 2]

// Module 13250 (LinkExternalMediumIcon)
import c from "c" /* 568 */;
...
export const LinkExternalMediumIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13251, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
