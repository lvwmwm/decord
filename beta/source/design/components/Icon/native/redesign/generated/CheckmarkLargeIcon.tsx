...
// Dependencies: [109, 19, 21, 558, 568, 580, 4709, 4461, 2]

// Module 4708 (CheckmarkLargeIcon)
import c from "c" /* 568 */;
...
export const CheckmarkLargeIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4709, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
