...
// Dependencies: [109, 19, 21, 558, 568, 580, 17625, 4461, 2]

// Module 17624 (MobilePhoneShareIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod17625 from "module_17625" /* 17625 */;
...
export const MobilePhoneShareIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod17625, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
