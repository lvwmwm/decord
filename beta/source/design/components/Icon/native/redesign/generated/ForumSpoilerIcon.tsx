...
// Dependencies: [109, 19, 21, 558, 568, 580, 5296, 4493, 2]

// Module 5335 (ForumSpoilerIcon)
import c from "c" /* 568 */;
...
export const ForumSpoilerIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
