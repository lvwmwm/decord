...
// Function ID: 5294
// Name: ThreadIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 5243, 4461, 2]

// Module 5293 (ThreadIcon)
import c from "c" /* 568 */;
...
export const ThreadIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
