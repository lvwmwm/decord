...
// Function ID: 15477
// Name: TicketIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15477, 4493, 2]

// Module 15476 (TicketIcon)
import c from "c" /* 568 */;
...
export const TicketIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
