...
// Function ID: 15628
// Name: ChatDotsIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15628, 4493, 2]

// Module 15627 (ChatDotsIcon)
import c from "c" /* 568 */;
...
export const ChatDotsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
