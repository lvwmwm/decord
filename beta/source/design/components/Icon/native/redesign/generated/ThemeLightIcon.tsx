...
// Function ID: 15529
// Name: ThemeLightIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15529, 4461, 2]

// Module 15528 (ThemeLightIcon)
import c from "c" /* 568 */;
...
export const ThemeLightIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15529, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
