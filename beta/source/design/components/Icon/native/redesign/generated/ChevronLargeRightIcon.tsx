...
// Dependencies: [109, 19, 21, 558, 568, 580, 12517, 4461, 2]

// Module 12516 (ChevronLargeRightIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod12517 from "module_12517" /* 12517 */;
...
export const ChevronLargeRightIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12517, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
