...
// Dependencies: [109, 19, 21, 558, 568, 580, 12553, 4493, 2]

// Module 12552 (ChevronLargeRightIcon)
import c from "c" /* 568 */;
...
export const ChevronLargeRightIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12553, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
