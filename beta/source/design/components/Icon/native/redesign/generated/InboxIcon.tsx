...
// Function ID: 11300
// Name: InboxIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11300, 4493, 2]

// Module 11299 (InboxIcon)
import c from "c" /* 568 */;
...
export const InboxIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11300, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
