...
// Function ID: 15873
// Name: BurgerIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15873, 4461, 2]

// Module 15872 (BurgerIcon)
import c from "c" /* 568 */;
...
export const BurgerIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
