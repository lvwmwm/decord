...
// Function ID: 11734
// Name: VideoIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11734, 4461, 2]

// Module 11733 (VideoIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod11734 from "module_11734" /* 11734 */;
...
export const VideoIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11734, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
