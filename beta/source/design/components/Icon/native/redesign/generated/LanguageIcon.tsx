...
// Function ID: 15684
// Name: LanguageIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15684, 4461, 2]

// Module 15683 (LanguageIcon)
import c from "c" /* 568 */;
...
export const LanguageIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
