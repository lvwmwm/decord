...
// Function ID: 9574
// Name: EmbedIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9574, 4493, 2]

// Module 9573 (EmbedIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod9574 from "module_9574" /* 9574 */;
...
export const EmbedIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9574, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
