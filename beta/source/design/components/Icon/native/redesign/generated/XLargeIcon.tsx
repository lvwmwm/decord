...
// Function ID: 4711
// Name: XLargeIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 4711, 4461, 2]

// Module 4710 (XLargeIcon)
import c from "c" /* 568 */;
...
export const XLargeIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4711, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
