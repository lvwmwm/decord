...
// Dependencies: [109, 19, 21, 558, 568, 580, 11550, 4493, 2]

// Module 11549 (generated/SpoilerIcon)
import c from "c" /* 568 */;
...
export const SpoilerIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
