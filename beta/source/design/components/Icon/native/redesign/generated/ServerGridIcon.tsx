...
// Function ID: 13891
// Name: ServerGridIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 13891, 4493, 2]

// Module 13890 (ServerGridIcon)
import c from "c" /* 568 */;
...
export const ServerGridIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13891, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
