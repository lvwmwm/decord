...
// Function ID: 11871
// Name: StampXIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11871, 4461, 2]

// Module 11870 (StampXIcon)
import c from "c" /* 568 */;
...
export const StampXIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
