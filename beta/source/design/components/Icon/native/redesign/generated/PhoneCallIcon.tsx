...
// Function ID: 8162
// Name: PhoneCallIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8162, 4493, 2]

// Module 8161 (PhoneCallIcon)
import c from "c" /* 568 */;
...
export const PhoneCallIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8162, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
