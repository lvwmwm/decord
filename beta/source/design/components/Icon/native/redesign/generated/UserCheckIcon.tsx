...
// Function ID: 13394
// Name: UserCheckIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8370, 4493, 2]

// Module 13393 (UserCheckIcon)
import c from "c" /* 568 */;
...
export const UserCheckIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8370, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
