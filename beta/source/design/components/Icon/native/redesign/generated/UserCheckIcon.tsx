...
// Function ID: 13358
// Name: UserCheckIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8338, 4461, 2]

// Module 13357 (UserCheckIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod8338 from "module_8338" /* 8338 */;
...
export const UserCheckIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8338, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
