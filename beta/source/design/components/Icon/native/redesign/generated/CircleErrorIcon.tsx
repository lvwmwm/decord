...
// Dependencies: [109, 19, 17, 21, 558, 568, 580, 7177, 4461, 7178, 2]

// Module 7176 (CircleErrorIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod7177 from "module_7177" /* 7177 */;
import _mod7178 from "module_7178" /* 7178 */;
...
export const CircleErrorIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  const items = [timestampProducer(BaseIconImage.BaseIconImage, { source: _mod7177, color: secondaryColor, style }), ];
  const obj3 = { source: _mod7178, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
