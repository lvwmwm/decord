...
// Function ID: 9851
// Name: ShieldUserIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8429, 4493, 2]

// Module 9850 (ShieldUserIcon)
import c from "c" /* 568 */;
...
export const ShieldUserIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8429, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
