...
// Function ID: 5325
// Name: ThreadLockIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 5274, 4493, 2]

// Module 5324 (ThreadLockIcon)
import c from "c" /* 568 */;
...
export const ThreadLockIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
