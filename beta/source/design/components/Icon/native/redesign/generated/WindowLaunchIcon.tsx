...
// Dependencies: [109, 19, 21, 558, 568, 580, 13253, 4461, 2]

// Module 13252 (WindowLaunchIcon)
import c from "c" /* 568 */;
...
export const WindowLaunchIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13253, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
