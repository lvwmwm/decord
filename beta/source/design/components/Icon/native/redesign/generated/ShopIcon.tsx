...
// Function ID: 12315
// Name: ShopIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 12315, 4493, 2]

// Module 12314 (ShopIcon)
import c from "c" /* 568 */;
...
export const ShopIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12315, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
