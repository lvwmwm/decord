...
// Function ID: 15875
// Name: MagicDoorIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15875, 4461, 2]

// Module 15874 (MagicDoorIcon)
import c from "c" /* 568 */;
...
export const MagicDoorIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
