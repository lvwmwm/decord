...
// Function ID: 17216
// Name: WebhookIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 17216, 4493, 2]

// Module 17215 (WebhookIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod17216 from "module_17216" /* 17216 */;
...
export const WebhookIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod17216, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
