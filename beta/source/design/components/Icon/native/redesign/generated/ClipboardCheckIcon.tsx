...
// Dependencies: [19, 21, 576, 4456, 15939, 2]
// Exports: ClipboardCheckIcon

// Module 15938 (ClipboardCheckIcon)
...
export const ClipboardCheckIcon = function ClipboardCheckIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15939, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
