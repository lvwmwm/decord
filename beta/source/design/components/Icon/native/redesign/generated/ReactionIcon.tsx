...
// Function ID: 9068
// Name: ReactionIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9068, 4493, 2]

// Module 9067 (ReactionIcon)
import c from "c" /* 568 */;
...
export const ReactionIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9068, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
