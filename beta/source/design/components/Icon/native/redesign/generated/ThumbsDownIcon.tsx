...
// Function ID: 8209
// Name: ThumbsDownIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8209, 4493, 2]

// Module 8208 (ThumbsDownIcon)
import c from "c" /* 568 */;
...
export const ThumbsDownIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
