...
// Dependencies: [109, 19, 21, 558, 568, 580, 18020, 4461, 2]

// Module 18019 (StickerPlusIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod18020 from "module_18020" /* 18020 */;
...
export const StickerPlusIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod18020, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
