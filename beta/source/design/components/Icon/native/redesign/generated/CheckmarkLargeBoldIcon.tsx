...
// Dependencies: [109, 19, 21, 558, 568, 580, 9075, 4461, 2]

// Module 9074 (CheckmarkLargeBoldIcon)
import c from "c" /* 568 */;
...
export const CheckmarkLargeBoldIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9075, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
