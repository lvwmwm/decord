...
// Function ID: 15861
// Name: TreehouseIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15861, 4461, 2]

// Module 15860 (TreehouseIcon)
import c from "c" /* 568 */;
...
export const TreehouseIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15861, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
