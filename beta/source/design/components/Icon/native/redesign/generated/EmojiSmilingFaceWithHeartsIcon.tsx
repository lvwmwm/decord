...
// Dependencies: [109, 19, 21, 558, 568, 580, 15676, 4493, 2]

// Module 15675 (EmojiSmilingFaceWithHeartsIcon)
import c from "c" /* 568 */;
...
export const EmojiSmilingFaceWithHeartsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
