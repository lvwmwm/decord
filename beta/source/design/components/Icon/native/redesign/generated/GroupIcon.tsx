...
// Function ID: 5342
// Name: GroupIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 5279, 4493, 2]

// Module 5341 (GroupIcon)
import c from "c" /* 568 */;
...
export const GroupIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
