...
// Dependencies: [109, 19, 21, 558, 568, 580, 11863, 4461, 2]

// Module 11862 (ArrowAngleLeftUpIcon)
import c from "c" /* 568 */;
...
export const ArrowAngleLeftUpIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11863, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
