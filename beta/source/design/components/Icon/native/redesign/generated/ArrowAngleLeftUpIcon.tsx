...
// Dependencies: [109, 19, 21, 558, 568, 580, 11899, 4493, 2]

// Module 11898 (ArrowAngleLeftUpIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod11899 from "module_11899" /* 11899 */;
...
export const ArrowAngleLeftUpIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11899, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
