...
// Function ID: 15839
// Name: WrenchIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15839, 4493, 2]

// Module 15838 (WrenchIcon)
import c from "c" /* 568 */;
...
export const WrenchIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
