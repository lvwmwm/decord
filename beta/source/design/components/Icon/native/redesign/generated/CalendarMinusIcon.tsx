...
// Dependencies: [109, 19, 21, 558, 568, 580, 17106, 4461, 2]

// Module 17105 (CalendarMinusIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod17106 from "module_17106" /* 17106 */;
...
export const CalendarMinusIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod17106, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
