...
// Function ID: 16953
// Name: RemixIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 16953, 4461, 2]

// Module 16952 (RemixIcon)
import c from "c" /* 568 */;
...
export const RemixIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
