...
// Function ID: 11991
// Name: UserIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11991, 4493, 2]

// Module 11990 (UserIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod11991 from "module_11991" /* 11991 */;
...
export const UserIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11991, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
