...
// Function ID: 15368
// Name: UnsendIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15368, 4461, 2]

// Module 15367 (UnsendIcon)
import c from "c" /* 568 */;
...
export const UnsendIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
