...
// Function ID: 11534
// Name: KeyboardIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11534, 4461, 2]

// Module 11533 (KeyboardIcon)
import c from "c" /* 568 */;
...
export const KeyboardIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11534, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
