...
// Function ID: 15851
// Name: HashmarkIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15851, 4461, 2]

// Module 15850 (HashmarkIcon)
import c from "c" /* 568 */;
...
export const HashmarkIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15851, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
