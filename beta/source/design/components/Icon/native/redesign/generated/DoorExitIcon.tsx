...
// Function ID: 10190
// Name: DoorExitIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10190, 4493, 2]

// Module 10189 (DoorExitIcon)
import c from "c" /* 568 */;
...
export const DoorExitIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10190, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
