...
// Function ID: 18000
// Name: HomeIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 18000, 4493, 2]

// Module 17999 (HomeIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod18000 from "module_18000" /* 18000 */;
...
export const HomeIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod18000, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
