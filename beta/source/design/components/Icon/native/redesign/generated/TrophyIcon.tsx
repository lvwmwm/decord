...
// Function ID: 8990
// Name: TrophyIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8411, 4461, 2]

// Module 8989 (TrophyIcon)
import c from "c" /* 568 */;
...
export const TrophyIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
