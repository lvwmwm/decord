...
// Function ID: 10713
// Name: AnalyticsIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10713, 4493, 2]

// Module 10712 (AnalyticsIcon)
import c from "c" /* 568 */;
...
export const AnalyticsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10713, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
