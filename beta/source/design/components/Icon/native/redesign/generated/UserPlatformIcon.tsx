...
// Dependencies: [109, 19, 21, 558, 568, 580, 4697, 4461, 2]

// Module 4696 (UserPlatformIcon)
import c from "c" /* 568 */;
...
export const UserPlatformIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
