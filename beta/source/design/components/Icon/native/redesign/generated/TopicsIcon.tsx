...
// Function ID: 11776
// Name: TopicsIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11776, 4461, 2]

// Module 11775 (TopicsIcon)
import c from "c" /* 568 */;
...
export const TopicsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
