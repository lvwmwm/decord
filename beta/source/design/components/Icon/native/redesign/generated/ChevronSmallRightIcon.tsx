...
// Dependencies: [109, 19, 21, 558, 568, 580, 5862, 4493, 2]

// Module 7488 (ChevronSmallRightIcon)
import c from "c" /* 568 */;
...
export const ChevronSmallRightIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
