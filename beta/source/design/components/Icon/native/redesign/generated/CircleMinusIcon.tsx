...
// Dependencies: [109, 19, 17, 21, 558, 568, 580, 15584, 4493, 15585, 2]

// Module 15583 (CircleMinusIcon)
import c from "c" /* 568 */;
...
export const CircleMinusIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  const items = [timestampProducer(BaseIconImage.BaseIconImage, { source: _mod15584, color: secondaryColor, style }), ];
  const obj3 = { source: _mod15585, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
