...
// Dependencies: [109, 19, 17, 21, 558, 568, 580, 15574, 4461, 15575, 2]

// Module 15573 (CircleMinusIcon)
import c from "c" /* 568 */;
...
export const CircleMinusIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  const items = [timestampProducer(BaseIconImage.BaseIconImage, { source: _mod15574, color: secondaryColor, style }), ];
  const obj3 = { source: _mod15575, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
