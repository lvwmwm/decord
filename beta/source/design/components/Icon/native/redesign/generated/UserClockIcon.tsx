...
// Function ID: 13419
// Name: UserClockIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 13419, 4461, 2]

// Module 13418 (UserClockIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod13419 from "module_13419" /* 13419 */;
...
export const UserClockIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13419, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
