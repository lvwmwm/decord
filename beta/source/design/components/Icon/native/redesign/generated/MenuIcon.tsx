...
// Function ID: 16153
// Name: MenuIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 16153, 4461, 2]

// Module 16152 (MenuIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod16153 from "module_16153" /* 16153 */;
...
export const MenuIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod16153, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
