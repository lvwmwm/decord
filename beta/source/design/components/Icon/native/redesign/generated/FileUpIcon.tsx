...
// Function ID: 15805
// Name: FileUpIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15805, 4461, 2]

// Module 15804 (FileUpIcon)
import c from "c" /* 568 */;
...
export const FileUpIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15805, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
