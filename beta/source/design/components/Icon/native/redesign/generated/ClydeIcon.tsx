...
// Function ID: 11118
// Name: ClydeIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11118, 4461, 2]

// Module 11117 (ClydeIcon)
import c from "c" /* 568 */;
...
export const ClydeIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11118, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
