...
// Function ID: 11331
// Name: GiftIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8346, 4461, 2]

// Module 11330 (GiftIcon)
import c from "c" /* 568 */;
...
export const GiftIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
