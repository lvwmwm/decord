...
// Dependencies: [109, 19, 21, 558, 568, 580, 17638, 4493, 2]

// Module 17637 (MobilePhoneDenyIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod17638 from "module_17638" /* 17638 */;
...
export const MobilePhoneDenyIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod17638, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
