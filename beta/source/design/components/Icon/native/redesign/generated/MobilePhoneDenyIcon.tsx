...
// Dependencies: [109, 19, 21, 558, 568, 580, 17627, 4461, 2]

// Module 17626 (MobilePhoneDenyIcon)
import c from "c" /* 568 */;
...
export const MobilePhoneDenyIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod17627, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
