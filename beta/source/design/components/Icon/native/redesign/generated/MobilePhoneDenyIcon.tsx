...
// Dependencies: [109, 19, 21, 558, 568, 580, 17628, 4461, 2]

// Module 17627 (MobilePhoneDenyIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod17628 from "module_17628" /* 17628 */;
...
export const MobilePhoneDenyIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod17628, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
