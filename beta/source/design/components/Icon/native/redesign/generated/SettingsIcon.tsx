...
// Function ID: 7625
// Name: SettingsIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 7625, 4461, 2]

// Module 7624 (SettingsIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod7625 from "module_7625" /* 7625 */;
...
export const SettingsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7625, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
