...
// Function ID: 10530
// Name: NatureIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10530, 4461, 2]

// Module 10529 (NatureIcon)
import c from "c" /* 568 */;
...
export const NatureIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10530, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
