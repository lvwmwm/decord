...
// Function ID: 9544
// Name: HammerIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9544, 4461, 2]

// Module 9543 (HammerIcon)
import c from "c" /* 568 */;
...
export const HammerIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
