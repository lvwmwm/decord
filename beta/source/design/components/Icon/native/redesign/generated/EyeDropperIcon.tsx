...
// Function ID: 15623
// Name: EyeDropperIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15623, 4493, 2]

// Module 15622 (EyeDropperIcon)
import c from "c" /* 568 */;
...
export const EyeDropperIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
