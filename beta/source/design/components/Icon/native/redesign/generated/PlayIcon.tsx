...
// Function ID: 8583
// Name: PlayIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8583, 4493, 2]

// Module 8582 (PlayIcon)
import c from "c" /* 568 */;
...
export const PlayIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8583, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
