...
// Dependencies: [109, 19, 21, 558, 568, 580, 8281, 4461, 2]

// Module 12602 (ChatWarningIcon)
import c from "c" /* 568 */;
...
export const ChatWarningIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8281, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
