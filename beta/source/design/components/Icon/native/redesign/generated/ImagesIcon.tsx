...
// Function ID: 11825
// Name: ImagesIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11825, 4461, 2]

// Module 11824 (ImagesIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod11825 from "module_11825" /* 11825 */;
...
export const ImagesIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11825, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
