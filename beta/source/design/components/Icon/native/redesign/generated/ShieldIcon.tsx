...
// Function ID: 9544
// Name: ShieldIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9542, 4493, 2]

// Module 9543 (ShieldIcon)
import c from "c" /* 568 */;
...
export const ShieldIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
