...
// Function ID: 13793
// Name: BoostTier3Icon
// Dependencies: [109, 19, 21, 558, 568, 580, 13793, 4461, 2]

// Module 13792 (BoostTier3Icon)
import c from "c" /* 568 */;
...
export const BoostTier3Icon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13793, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
