...
// Dependencies: [109, 19, 21, 558, 568, 580, 16418, 4461, 2]

// Module 16417 (SpotifyNeutralIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod16418 from "module_16418" /* 16418 */;
...
export const SpotifyNeutralIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod16418, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
