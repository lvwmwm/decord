...
// Function ID: 15863
// Name: CompassIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15863, 4461, 2]

// Module 15862 (CompassIcon)
import c from "c" /* 568 */;
...
export const CompassIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15863, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
