...
// Function ID: 10937
// Name: AttachmentIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10937, 4461, 2]

// Module 10936 (AttachmentIcon)
import c from "c" /* 568 */;
...
export const AttachmentIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
