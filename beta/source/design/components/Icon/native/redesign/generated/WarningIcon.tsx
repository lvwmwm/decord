...
// Function ID: 8904
// Name: WarningIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8904, 4493, 2]

// Module 8903 (WarningIcon)
import c from "c" /* 568 */;
...
export const WarningIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
