...
// Dependencies: [109, 19, 21, 558, 568, 580, 16742, 4461, 2]

// Module 16741 (ConnectionFineIcon)
import c from "c" /* 568 */;
...
export const ConnectionFineIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod16742, color: ICON_FEEDBACK_POSITIVE, style: color.style });
});
