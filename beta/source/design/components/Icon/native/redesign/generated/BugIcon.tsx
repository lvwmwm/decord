...
// Function ID: 16052
// Name: BugIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 16052, 4493, 2]

// Module 16051 (BugIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod16052 from "module_16052" /* 16052 */;
...
export const BugIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod16052, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
