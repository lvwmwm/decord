...
// Dependencies: [109, 19, 21, 558, 568, 580, 14116, 4461, 2]

// Module 14115 (ChannelListMagnifyingGlassIcon)
import c from "c" /* 568 */;
...
export const ChannelListMagnifyingGlassIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod14116, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
