...
// Function ID: 10299
// Name: MicrophoneIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10299, 4493, 2]

// Module 10298 (MicrophoneIcon)
import c from "c" /* 568 */;
...
export const MicrophoneIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10299, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
