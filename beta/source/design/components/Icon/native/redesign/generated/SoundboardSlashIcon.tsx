...
// Dependencies: [109, 19, 21, 558, 568, 580, 13377, 4493, 2]

// Module 13376 (SoundboardSlashIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod13377 from "module_13377" /* 13377 */;
...
export const SoundboardSlashIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13377, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
