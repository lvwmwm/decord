...
// Function ID: 10899
// Name: PollsIcon
// Dependencies: [19, 21, 576, 4456, 10899, 2]
// Exports: PollsIcon

// Module 10898 (PollsIcon)
...
export const PollsIcon = function PollsIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10899, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
