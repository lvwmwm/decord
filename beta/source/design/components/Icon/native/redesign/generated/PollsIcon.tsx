...
// Function ID: 10971
// Name: PollsIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10971, 4493, 2]

// Module 10970 (PollsIcon)
import c from "c" /* 568 */;
...
export const PollsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10971, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
