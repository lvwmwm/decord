...
// Function ID: 10532
// Name: FoodIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10532, 4461, 2]

// Module 10531 (FoodIcon)
import c from "c" /* 568 */;
...
export const FoodIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10532, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
