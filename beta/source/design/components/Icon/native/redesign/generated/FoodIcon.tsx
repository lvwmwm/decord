...
// Function ID: 10568
// Name: FoodIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10568, 4493, 2]

// Module 10567 (FoodIcon)
import c from "c" /* 568 */;
...
export const FoodIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10568, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
