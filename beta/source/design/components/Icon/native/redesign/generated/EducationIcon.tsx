...
// Function ID: 10414
// Name: EducationIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10412, 4461, 2]

// Module 10413 (EducationIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod10412 from "module_10412" /* 10412 */;
...
export const EducationIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10412, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
