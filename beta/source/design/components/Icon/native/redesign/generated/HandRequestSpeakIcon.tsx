...
// Dependencies: [109, 19, 21, 558, 568, 580, 10212, 4493, 2]

// Module 10211 (HandRequestSpeakIcon)
import c from "c" /* 568 */;
...
export const HandRequestSpeakIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10212, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
