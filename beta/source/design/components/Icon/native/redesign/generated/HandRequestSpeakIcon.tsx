...
// Dependencies: [109, 19, 21, 558, 568, 580, 10173, 4461, 2]

// Module 10172 (HandRequestSpeakIcon)
import c from "c" /* 568 */;
...
export const HandRequestSpeakIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10173, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
