...
// Function ID: 9862
// Name: CalendarIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9862, 4461, 2]

// Module 9861 (CalendarIcon)
import c from "c" /* 568 */;
...
export const CalendarIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9862, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
