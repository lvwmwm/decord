...
// Function ID: 7373
// Name: ListViewIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 7373, 4493, 2]

// Module 7372 (ListViewIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod7373 from "module_7373" /* 7373 */;
...
export const ListViewIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7373, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
