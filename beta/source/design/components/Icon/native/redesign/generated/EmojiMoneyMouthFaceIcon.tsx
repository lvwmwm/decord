...
// Dependencies: [109, 19, 21, 558, 568, 580, 15642, 4461, 2]

// Module 15641 (EmojiMoneyMouthFaceIcon)
import c from "c" /* 568 */;
...
export const EmojiMoneyMouthFaceIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
