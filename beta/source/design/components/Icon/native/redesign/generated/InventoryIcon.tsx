...
// Function ID: 15871
// Name: InventoryIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15871, 4461, 2]

// Module 15870 (InventoryIcon)
import c from "c" /* 568 */;
...
export const InventoryIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
