...
// Function ID: 15415
// Name: RefreshIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15415, 4461, 2]

// Module 15414 (RefreshIcon)
import c from "c" /* 568 */;
...
export const RefreshIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15415, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
