...
// Function ID: 9144
// Name: DiceIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9144, 4493, 2]

// Module 9143 (DiceIcon)
import c from "c" /* 568 */;
...
export const DiceIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
