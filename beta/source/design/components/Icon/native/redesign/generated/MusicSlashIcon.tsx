...
// Function ID: 10145
// Name: MusicSlashIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10145, 4461, 2]

// Module 10144 (MusicSlashIcon)
import c from "c" /* 568 */;
...
export const MusicSlashIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
