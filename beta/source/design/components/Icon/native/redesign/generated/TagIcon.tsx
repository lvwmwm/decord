...
// Function ID: 9140
// Name: TagIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9140, 4461, 2]
...
export const TagIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9140, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
