...
// Dependencies: [109, 19, 21, 558, 568, 580, 5790, 4493, 2]

// Module 5789 (ClipboardListIcon)
import c from "c" /* 568 */;
...
export const ClipboardListIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5790, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
