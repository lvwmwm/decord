...
// Function ID: 15364
// Name: RedoIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15364, 4461, 2]

// Module 15363 (RedoIcon)
import c from "c" /* 568 */;
...
export const RedoIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
