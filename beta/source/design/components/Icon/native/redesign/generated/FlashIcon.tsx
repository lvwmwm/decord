...
// Function ID: 13344
// Name: FlashIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 13344, 4493, 2]

// Module 13343 (FlashIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod13344 from "module_13344" /* 13344 */;
...
export const FlashIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13344, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
