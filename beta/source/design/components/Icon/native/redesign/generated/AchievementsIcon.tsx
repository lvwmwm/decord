...
// Dependencies: [109, 19, 21, 558, 568, 580, 15859, 4461, 2]

// Module 15858 (AchievementsIcon)
import c from "c" /* 568 */;
...
export const AchievementsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
