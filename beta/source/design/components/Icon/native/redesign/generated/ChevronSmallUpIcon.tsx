...
// Dependencies: [19, 21, 576, 4456, 12899, 2]
// Exports: ChevronSmallUpIcon

// Module 13836 (ChevronSmallUpIcon)
...
export const ChevronSmallUpIcon = function ChevronSmallUpIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12899, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
