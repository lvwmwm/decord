...
// Function ID: 9145
// Name: PlusSmallIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9145, 4461, 2]

// Module 9144 (PlusSmallIcon)
import c from "c" /* 568 */;
...
export const PlusSmallIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9145, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
