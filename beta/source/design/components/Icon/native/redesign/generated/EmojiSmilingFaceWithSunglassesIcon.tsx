...
// Dependencies: [109, 19, 21, 558, 568, 580, 15654, 4461, 2]

// Module 15653 (EmojiSmilingFaceWithSunglassesIcon)
import c from "c" /* 568 */;
...
export const EmojiSmilingFaceWithSunglassesIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
