...
// Function ID: 12905
// Name: PlusMediumIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 12345, 4461, 2]
...
export const PlusMediumIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12345, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
