...
// Function ID: 11201
// Name: CrownIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11201, 4461, 2]

// Module 11200 (CrownIcon)
import c from "c" /* 568 */;
...
export const CrownIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11201, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
