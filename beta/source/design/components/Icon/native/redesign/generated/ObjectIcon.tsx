...
// Function ID: 10536
// Name: ObjectIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10536, 4461, 2]

// Module 10535 (ObjectIcon)
import c from "c" /* 568 */;
...
export const ObjectIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10536, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
