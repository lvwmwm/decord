...
// Function ID: 10572
// Name: ObjectIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10572, 4493, 2]

// Module 10571 (ObjectIcon)
import c from "c" /* 568 */;
...
export const ObjectIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10572, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
