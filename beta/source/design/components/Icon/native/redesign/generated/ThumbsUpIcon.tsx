...
// Function ID: 8175
// Name: ThumbsUpIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8175, 4461, 2]

// Module 8174 (ThumbsUpIcon)
import c from "c" /* 568 */;
...
export const ThumbsUpIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8175, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
