...
// Function ID: 5314
// Name: AppsLockIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 5314, 4493, 2]

// Module 5313 (AppsLockIcon)
import c from "c" /* 568 */;
...
export const AppsLockIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
