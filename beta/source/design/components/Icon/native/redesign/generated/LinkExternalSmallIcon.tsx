...
// Dependencies: [109, 19, 21, 558, 568, 580, 8861, 4461, 2]

// Module 8860 (LinkExternalSmallIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod8861 from "module_8861" /* 8861 */;
...
export const LinkExternalSmallIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8861, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
