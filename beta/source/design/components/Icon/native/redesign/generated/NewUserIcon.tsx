...
// Function ID: 13342
// Name: NewUserIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 13342, 4493, 2]

// Module 13341 (NewUserIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod13342 from "module_13342" /* 13342 */;
...
export const NewUserIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13342, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
