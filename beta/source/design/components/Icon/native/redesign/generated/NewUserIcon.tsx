...
// Function ID: 13306
// Name: NewUserIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 13306, 4461, 2]

// Module 13305 (NewUserIcon)
import c from "c" /* 568 */;
...
export const NewUserIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13306, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
