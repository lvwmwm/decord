...
// Function ID: 10710
// Name: GifIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8379, 4493, 2]

// Module 10709 (GifIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod8379 from "module_8379" /* 8379 */;
...
export const GifIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8379, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
