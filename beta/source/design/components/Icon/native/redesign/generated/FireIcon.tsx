...
// Function ID: 9993
// Name: FireIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9993, 4461, 2]

// Module 9992 (FireIcon)
import c from "c" /* 568 */;
...
export const FireIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
