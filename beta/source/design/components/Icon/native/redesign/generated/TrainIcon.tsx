...
// Function ID: 15867
// Name: TrainIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15867, 4461, 2]

// Module 15866 (TrainIcon)
import c from "c" /* 568 */;
...
export const TrainIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
