...
// Dependencies: [109, 19, 21, 558, 568, 580, 15522, 4461, 2]

// Module 15521 (PaintPaletteIcon)
import c from "c" /* 568 */;
...
export const PaintPaletteIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15522, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
