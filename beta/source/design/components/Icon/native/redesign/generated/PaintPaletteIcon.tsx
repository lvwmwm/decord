...
// Dependencies: [109, 19, 21, 558, 568, 580, 15532, 4493, 2]

// Module 15531 (PaintPaletteIcon)
import c from "c" /* 568 */;
...
export const PaintPaletteIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15532, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
