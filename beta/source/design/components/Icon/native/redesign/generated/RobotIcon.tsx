...
// Function ID: 9546
// Name: RobotIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9546, 4461, 2]

// Module 9545 (RobotIcon)
import c from "c" /* 568 */;
...
export const RobotIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
