...
// Function ID: 11259
// Name: UserCircleIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11259, 4493, 2]

// Module 11258 (UserCircleIcon)
import c from "c" /* 568 */;
...
export const UserCircleIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod11259, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
