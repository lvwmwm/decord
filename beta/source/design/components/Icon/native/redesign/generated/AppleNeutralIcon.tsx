...
// Dependencies: [109, 19, 21, 558, 568, 580, 8759, 4493, 2]

// Module 8758 (AppleNeutralIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod8759 from "module_8759" /* 8759 */;
...
export const AppleNeutralIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8759, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
