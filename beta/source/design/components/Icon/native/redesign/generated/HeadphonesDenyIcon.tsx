...
// Dependencies: [109, 19, 21, 558, 568, 580, 9920, 4461, 2]

// Module 9919 (HeadphonesDenyIcon)
import c from "c" /* 568 */;
...
export const HeadphonesDenyIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
