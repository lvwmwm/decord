...
// Dependencies: [109, 19, 21, 558, 568, 580, 8968, 4461, 2]

// Module 8967 (RobloxNeutralIcon)
import c from "c" /* 568 */;
...
export const RobloxNeutralIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
