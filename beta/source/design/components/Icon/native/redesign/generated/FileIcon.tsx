...
// Function ID: 12353
// Name: FileIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 12353, 4493, 2]

// Module 12352 (FileIcon)
import c from "c" /* 568 */;
...
export const FileIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12353, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
