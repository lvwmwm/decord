...
// Function ID: 12317
// Name: FileIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 12317, 4461, 2]

// Module 12316 (FileIcon)
import c from "c" /* 568 */;
...
export const FileIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12317, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
