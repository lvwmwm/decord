...
// Function ID: 12784
// Name: BoostTier1Icon
// Dependencies: [109, 19, 21, 558, 568, 580, 12784, 4493, 2]

// Module 12783 (BoostTier1Icon)
import c from "c" /* 568 */;
...
export const BoostTier1Icon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12784, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
