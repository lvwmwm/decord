...
// Dependencies: [109, 19, 21, 558, 568, 580, 10166, 4461, 2]

// Module 10165 (HandRequestSpeakListIcon)
import c from "c" /* 568 */;
...
export const HandRequestSpeakListIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
