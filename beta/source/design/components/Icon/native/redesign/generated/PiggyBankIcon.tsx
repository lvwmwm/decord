...
// Function ID: 12092
// Name: PiggyBankIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 12092, 4493, 2]

// Module 12091 (PiggyBankIcon)
import c from "c" /* 568 */;
...
export const PiggyBankIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12092, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
