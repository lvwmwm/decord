...
// Function ID: 15240
// Name: ClipsIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15240, 4461, 2]

// Module 15239 (ClipsIcon)
import c from "c" /* 568 */;
...
export const ClipsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
