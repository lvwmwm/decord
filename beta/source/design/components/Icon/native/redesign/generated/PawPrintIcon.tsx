...
// Function ID: 15877
// Name: PawPrintIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15877, 4461, 2]

// Module 15876 (PawPrintIcon)
import c from "c" /* 568 */;
...
export const PawPrintIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
