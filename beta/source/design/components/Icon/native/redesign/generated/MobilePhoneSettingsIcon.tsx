...
// Dependencies: [109, 19, 21, 558, 568, 580, 15836, 4493, 2]

// Module 15835 (MobilePhoneSettingsIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod15836 from "module_15836" /* 15836 */;
...
export const MobilePhoneSettingsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15836, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
