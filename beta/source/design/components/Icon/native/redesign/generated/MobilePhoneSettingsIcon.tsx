...
// Dependencies: [109, 19, 21, 558, 568, 580, 15826, 4461, 2]

// Module 15825 (MobilePhoneSettingsIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod15826 from "module_15826" /* 15826 */;
...
export const MobilePhoneSettingsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15826, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
