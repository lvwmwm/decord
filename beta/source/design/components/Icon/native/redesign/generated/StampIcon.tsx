...
// Function ID: 11869
// Name: StampIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11869, 4461, 2]

// Module 11868 (StampIcon)
import c from "c" /* 568 */;
...
export const StampIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
