...
// Function ID: 15865
// Name: CarIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15865, 4461, 2]

// Module 15864 (CarIcon)
import c from "c" /* 568 */;
...
export const CarIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
