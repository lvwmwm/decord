...
// Dependencies: [109, 19, 21, 558, 568, 580, 15841, 4461, 2]

// Module 15840 (FileWarningIcon)
import c from "c" /* 568 */;
...
export const FileWarningIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
