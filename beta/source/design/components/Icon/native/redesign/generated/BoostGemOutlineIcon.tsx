...
// Dependencies: [109, 19, 21, 558, 568, 580, 18013, 4461, 2]

// Module 18012 (BoostGemOutlineIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod18013 from "module_18013" /* 18013 */;
...
export const BoostGemOutlineIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod18013, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
