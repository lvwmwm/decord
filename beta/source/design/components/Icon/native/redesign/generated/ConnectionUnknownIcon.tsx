...
// Dependencies: [109, 19, 21, 558, 568, 580, 16751, 4493, 2]

// Module 16750 (ConnectionUnknownIcon)
import c from "c" /* 568 */;
...
export const ConnectionUnknownIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod16751, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
