...
// Dependencies: [109, 19, 21, 558, 568, 580, 12505, 4461, 2]

// Module 12504 (TwitterNeutralIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod12505 from "module_12505" /* 12505 */;
...
export const TwitterNeutralIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12505, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
