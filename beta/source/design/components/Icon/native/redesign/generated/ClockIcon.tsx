...
// Function ID: 4753
// Name: ClockIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 4753, 4493, 2]

// Module 4752 (ClockIcon)
import c from "c" /* 568 */;
...
export const ClockIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4753, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
