...
// Function ID: 4721
// Name: ClockIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 4721, 4461, 2]

// Module 4720 (ClockIcon)
import c from "c" /* 568 */;
...
export const ClockIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4721, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
