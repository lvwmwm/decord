...
// Function ID: 9431
// Name: ServerIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9431, 4493, 2]

// Module 9430 (ServerIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod9431 from "module_9431" /* 9431 */;
...
export const ServerIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9431, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
