...
// Function ID: 9399
// Name: ServerIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 9399, 4461, 2]

// Module 9398 (ServerIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod9399 from "module_9399" /* 9399 */;
...
export const ServerIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9399, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
