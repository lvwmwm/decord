...
// Function ID: 10578
// Name: BackspaceIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 10578, 4493, 2]

// Module 10577 (BackspaceIcon)
import c from "c" /* 568 */;
...
export const BackspaceIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10578, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
