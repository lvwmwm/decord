...
// Function ID: 15155
// Name: ChatCheckIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 15155, 4461, 2]

// Module 15154 (ChatCheckIcon)
import c from "c" /* 568 */;
...
export const ChatCheckIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
