...
// Dependencies: [109, 19, 21, 558, 568, 580, 17956, 4461, 2]

// Module 17955 (ChannelListPlusIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod17956 from "module_17956" /* 17956 */;
...
export const ChannelListPlusIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod17956, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
