...
// Dependencies: [109, 19, 21, 558, 568, 580, 17966, 4493, 2]

// Module 17965 (ChannelListPlusIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4493 */;
import _mod17966 from "module_17966" /* 17966 */;
...
export const ChannelListPlusIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod17966, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
