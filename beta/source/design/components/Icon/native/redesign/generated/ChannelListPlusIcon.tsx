...
// Dependencies: [109, 19, 21, 558, 568, 580, 17955, 4461, 2]

// Module 17954 (ChannelListPlusIcon)
import c from "c" /* 568 */;
import nativeDefault from "native" /* 580 */;
import BaseIconImage from "BaseIconImage" /* 4461 */;
import _mod17955 from "module_17955" /* 17955 */;
...
export const ChannelListPlusIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod17955, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
