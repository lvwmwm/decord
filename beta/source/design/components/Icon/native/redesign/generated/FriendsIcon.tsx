...
// Function ID: 4492
// Name: FriendsIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 4492, 4493, 2]

// Module 4491 (FriendsIcon)
import c from "c" /* 568 */;
...
export const FriendsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod4492, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
