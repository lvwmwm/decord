...
// Function ID: 5313
// Name: AppsIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 5278, 4493, 2]

// Module 5312 (AppsIcon)
import c from "c" /* 568 */;
...
export const AppsIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
