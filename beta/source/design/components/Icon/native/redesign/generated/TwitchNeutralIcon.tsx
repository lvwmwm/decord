...
// Dependencies: [109, 19, 21, 558, 568, 580, 9207, 4493, 2]

// Module 9206 (TwitchNeutralIcon)
import c from "c" /* 568 */;
...
export const TwitchNeutralIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
