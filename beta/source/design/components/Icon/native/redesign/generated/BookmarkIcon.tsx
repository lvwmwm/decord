...
// Function ID: 11834
// Name: BookmarkIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 11834, 4461, 2]

// Module 11833 (BookmarkIcon)
import c from "c" /* 568 */;
...
export const BookmarkIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
