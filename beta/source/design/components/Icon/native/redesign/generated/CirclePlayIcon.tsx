...
// Function ID: 8993
// Name: CirclePlayIcon
// Dependencies: [109, 19, 17, 21, 558, 568, 580, 8993, 4461, 8994, 2]

// Module 8992 (CirclePlayIcon)
import c from "c" /* 568 */;
...
export const CirclePlayIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  const items = [timestampProducer(BaseIconImage.BaseIconImage, { source: _mod8993, color: secondaryColor, style }), ];
  const obj3 = { source: _mod8994, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
