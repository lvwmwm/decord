...
// Function ID: 8995
// Name: CirclePlayIcon
// Dependencies: [19, 17, 21, 576, 4456, 8995, 8996, 2]
// Exports: CirclePlayIcon

// Module 8994 (CirclePlayIcon)
...
export const CirclePlayIcon = function CirclePlayIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod8995, color: secondaryColor, style }), ];
  const obj3 = { source: _mod8996, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
