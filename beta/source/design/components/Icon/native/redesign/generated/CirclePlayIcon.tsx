...
// Function ID: 9025
// Name: CirclePlayIcon
// Dependencies: [109, 19, 17, 21, 558, 568, 580, 9025, 4493, 9026, 2]

// Module 9024 (CirclePlayIcon)
import c from "c" /* 568 */;
...
export const CirclePlayIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  const items = [timestampProducer(BaseIconImage.BaseIconImage, { source: _mod9025, color: secondaryColor, style }), ];
  const obj3 = { source: _mod9026, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
