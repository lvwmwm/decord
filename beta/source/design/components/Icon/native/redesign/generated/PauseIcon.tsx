...
// Function ID: 8553
// Name: PauseIcon
// Dependencies: [109, 19, 21, 558, 568, 580, 8553, 4461, 2]

// Module 8552 (PauseIcon)
import c from "c" /* 568 */;
...
export const PauseIcon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
  if (cResult[0] !== arg0) {
    ({ style, color } = arg0);
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod8553, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
});
