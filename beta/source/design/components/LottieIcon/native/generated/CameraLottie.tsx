...
// Function ID: 10203
// Name: CameraLottie
// Dependencies: [19, 21, 558, 568, 10203, 10204, 2]

// Module 10202 (CameraLottie)
import c from "c" /* 568 */;
...
export const CameraLottie = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0, ref) => {
  const cResult = c.c(4);
  if (cResult[0] === Symbol.for("react.memo_cache_sentinel")) {
    const tmpResult = tmp(10203);
    cResult[0] = tmpResult;
    let first = tmpResult;
  } else {
    first = cResult[0];
  ...
  const merged = Object.assign(arg0);
  return jsx(LottieIcon.LottieIcon, { dotLottie: _mod10203, ref, layers, markers: items });
}));
