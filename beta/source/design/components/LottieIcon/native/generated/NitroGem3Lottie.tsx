...
// Dependencies: [19, 21, 558, 568, 14431, 10204, 2]

// Module 14430 (NitroGem3Lottie)
import c from "c" /* 568 */;
...
export const NitroGem3Lottie = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0, ref) => {
  const cResult = c.c(4);
  if (cResult[0] === Symbol.for("react.memo_cache_sentinel")) {
    const tmpResult = tmp(14431);
    cResult[0] = tmpResult;
    let first = tmpResult;
  } else {
    first = cResult[0];
  ...
  const merged = Object.assign(arg0);
  return jsx(LottieIcon.LottieIcon, { dotLottie: _mod14431, animation: "all", ref, layers, markers: items });
}));
