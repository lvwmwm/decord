...
// Dependencies: [19, 21, 558, 568, 14479, 10243, 2]

// Module 14478 (NitroGem18Lottie)
import c from "c" /* 568 */;
...
export const NitroGem18Lottie = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0, ref) => {
  ...
  const merged = Object.assign(arg0);
  return jsx(LottieIcon.LottieIcon, { dotLottie: _mod14479, animation: "all", ref, layers, markers: items });
}));
