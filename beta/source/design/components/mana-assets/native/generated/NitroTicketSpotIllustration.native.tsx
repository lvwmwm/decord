...
// Dependencies: [21, 558, 568, 6575, 5834, 2]

// Module 6574 (NitroTicketSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroTicketSpotIllustration.native.tsx");

export const NitroTicketSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
