...
// Dependencies: [21, 558, 568, 6607, 5834, 2]

// Module 6606 (OrbNitroSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/OrbNitroSpotIllustration.native.tsx");

export const OrbNitroSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
