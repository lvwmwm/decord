...
// Dependencies: [21, 558, 568, 6367, 5834, 2]

// Module 6366 (GemHero3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GemHero3dIllustration.native.tsx");

export const GemHero3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
