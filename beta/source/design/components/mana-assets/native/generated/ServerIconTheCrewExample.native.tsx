...
// Dependencies: [21, 558, 568, 6713, 5834, 2]

// Module 6712 (ServerIconTheCrewExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerIconTheCrewExample.native.tsx");

export const ServerIconTheCrewExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
