...
// Dependencies: [21, 558, 568, 6017, 5834, 2]

// Module 6016 (AppsButtonSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AppsButtonSpotIllustration.native.tsx");

export const AppsButtonSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
