...
// Dependencies: [21, 558, 568, 6821, 5834, 2]

// Module 6820 (TreasureChestSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/TreasureChestSpotIllustration.native.tsx");

export const TreasureChestSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
