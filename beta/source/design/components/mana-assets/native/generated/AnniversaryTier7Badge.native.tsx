...
// Dependencies: [21, 558, 568, 6007, 5834, 2]

// Module 6006 (AnniversaryTier7Badge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AnniversaryTier7Badge.native.tsx");

export const AnniversaryTier7Badge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
