...
// Dependencies: [21, 558, 568, 6483, 5834, 2]

// Module 6482 (KeyRingSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/KeyRingSpotIllustration.native.tsx");

export const KeyRingSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
