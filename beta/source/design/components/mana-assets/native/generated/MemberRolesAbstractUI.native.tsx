...
// Dependencies: [21, 558, 568, 6507, 5834, 2]

// Module 6506 (MemberRolesAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/MemberRolesAbstractUI.native.tsx");

export const MemberRolesAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
