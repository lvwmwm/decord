...
// Dependencies: [21, 558, 568, 6571, 5802, 2]

// Module 6570 (OrbMultiplierSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/OrbMultiplierSpotIllustration.native.tsx");

export const OrbMultiplierSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
