...
// Dependencies: [21, 558, 568, 6309, 5834, 2]

// Module 6308 (GameDepthTier7SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier7SmallBadge.native.tsx");

export const GameDepthTier7SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
