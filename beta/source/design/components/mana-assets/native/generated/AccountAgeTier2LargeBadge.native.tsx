...
// Dependencies: [21, 558, 568, 5917, 5802, 2]

// Module 5916 (AccountAgeTier2LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AccountAgeTier2LargeBadge.native.tsx");

export const AccountAgeTier2LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
