...
// Dependencies: [21, 558, 568, 5987, 5802, 2]

// Module 5986 (AutoClipsConsentAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AutoClipsConsentAbstractUI.native.tsx");

export const AutoClipsConsentAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
