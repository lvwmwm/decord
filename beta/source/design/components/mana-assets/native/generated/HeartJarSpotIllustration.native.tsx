...
// Dependencies: [21, 558, 568, 6467, 5834, 2]

// Module 6466 (HeartJarSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/HeartJarSpotIllustration.native.tsx");

export const HeartJarSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
