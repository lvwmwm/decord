...
// Dependencies: [21, 558, 568, 5993, 5834, 2]

// Module 5992 (AnniversaryTier10Badge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AnniversaryTier10Badge.native.tsx");

export const AnniversaryTier10Badge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
