...
// Dependencies: [21, 558, 568, 6585, 5802, 2]

// Module 6584 (PingPongPaddleIllocon)
...
export const PingPongPaddleIllocon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(8);
