...
// Dependencies: [21, 558, 568, 6303, 5802, 2]

// Module 6302 (GameDiversityTier4LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDiversityTier4LargeBadge.native.tsx");

export const GameDiversityTier4LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
