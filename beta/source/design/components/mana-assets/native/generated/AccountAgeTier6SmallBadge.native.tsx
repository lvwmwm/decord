...
// Dependencies: [21, 558, 568, 5935, 5802, 2]

// Module 5934 (AccountAgeTier6SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AccountAgeTier6SmallBadge.native.tsx");

export const AccountAgeTier6SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
