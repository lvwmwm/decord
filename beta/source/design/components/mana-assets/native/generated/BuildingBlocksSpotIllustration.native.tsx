...
// Dependencies: [21, 558, 568, 6085, 5834, 2]

// Module 6084 (BuildingBlocksSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/BuildingBlocksSpotIllustration.native.tsx");

export const BuildingBlocksSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
