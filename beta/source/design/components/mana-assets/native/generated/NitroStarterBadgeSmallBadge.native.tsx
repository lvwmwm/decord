...
// Dependencies: [21, 558, 568, 6539, 5802, 2]

// Module 6538 (NitroStarterBadgeSmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroStarterBadgeSmallBadge.native.tsx");

export const NitroStarterBadgeSmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
