...
// Dependencies: [21, 558, 568, 6195, 5802, 2]

// Module 6194 (EmojiVomitExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/EmojiVomitExample.native.tsx");

export const EmojiVomitExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
