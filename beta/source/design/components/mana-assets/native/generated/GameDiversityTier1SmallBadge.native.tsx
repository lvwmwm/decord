...
// Dependencies: [21, 558, 568, 6325, 5834, 2]

// Module 6324 (GameDiversityTier1SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDiversityTier1SmallBadge.native.tsx");

export const GameDiversityTier1SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
