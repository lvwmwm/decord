...
// Dependencies: [21, 558, 568, 6181, 5802, 2]

// Module 6180 (EmojiCatStarsExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/EmojiCatStarsExample.native.tsx");

export const EmojiCatStarsExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
