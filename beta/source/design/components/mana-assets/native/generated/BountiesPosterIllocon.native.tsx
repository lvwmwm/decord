...
// Dependencies: [21, 558, 568, 6043, 5802, 2]

// Module 6042 (BountiesPosterIllocon)
...
export const BountiesPosterIllocon = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(8);
