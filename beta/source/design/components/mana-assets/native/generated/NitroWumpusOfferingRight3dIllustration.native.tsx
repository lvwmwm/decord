...
// Dependencies: [21, 558, 568, 6595, 5834, 2]

// Module 6594 (NitroWumpusOfferingRight3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroWumpusOfferingRight3dIllustration.native.tsx");

export const NitroWumpusOfferingRight3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
