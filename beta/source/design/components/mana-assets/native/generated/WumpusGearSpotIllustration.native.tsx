...
// Dependencies: [21, 558, 568, 6825, 5802, 2]

// Module 6824 (WumpusGearSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/WumpusGearSpotIllustration.native.tsx");

export const WumpusGearSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
