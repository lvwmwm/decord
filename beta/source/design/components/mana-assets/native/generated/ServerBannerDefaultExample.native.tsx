...
// Dependencies: [21, 558, 568, 6681, 5834, 2]

// Module 6680 (ServerBannerDefaultExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerBannerDefaultExample.native.tsx");

export const ServerBannerDefaultExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
