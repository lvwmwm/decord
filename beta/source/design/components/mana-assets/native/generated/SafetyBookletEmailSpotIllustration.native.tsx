...
// Dependencies: [21, 558, 568, 6665, 5834, 2]

// Module 6664 (SafetyBookletEmailSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/SafetyBookletEmailSpotIllustration.native.tsx");

export const SafetyBookletEmailSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
