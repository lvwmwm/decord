...
// Dependencies: [21, 558, 568, 6819, 5834, 2]

// Module 6818 (TreasureChestBannerSpotIllustration)
...
export const TreasureChestBannerSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
