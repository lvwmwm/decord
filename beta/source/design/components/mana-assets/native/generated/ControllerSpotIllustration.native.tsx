...
// Dependencies: [21, 558, 568, 6113, 5802, 2]

// Module 6112 (ControllerSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ControllerSpotIllustration.native.tsx");

export const ControllerSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
