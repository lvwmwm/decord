...
// Dependencies: [21, 558, 568, 6565, 5802, 2]

// Module 6564 (NitroWumpusPinkSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroWumpusPinkSpotIllustration.native.tsx");

export const NitroWumpusPinkSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
