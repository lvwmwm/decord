...
// Dependencies: [21, 558, 568, 5999, 5834, 2]

// Module 5998 (AnniversaryTier3Badge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AnniversaryTier3Badge.native.tsx");

export const AnniversaryTier3Badge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
