...
// Dependencies: [21, 558, 568, 6441, 5802, 2]

// Module 6440 (HighFiveSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/HighFiveSpotIllustration.native.tsx");

export const HighFiveSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
