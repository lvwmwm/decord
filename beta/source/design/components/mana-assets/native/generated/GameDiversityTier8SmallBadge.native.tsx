...
// Dependencies: [21, 558, 568, 6353, 5834, 2]

// Module 6352 (GameDiversityTier8SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDiversityTier8SmallBadge.native.tsx");

export const GameDiversityTier8SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
