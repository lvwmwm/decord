...
// Dependencies: [21, 558, 568, 5933, 5802, 2]

// Module 5932 (AccountAgeTier6LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AccountAgeTier6LargeBadge.native.tsx");

export const AccountAgeTier6LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
