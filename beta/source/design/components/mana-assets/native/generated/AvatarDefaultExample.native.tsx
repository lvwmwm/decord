...
// Dependencies: [21, 558, 568, 6031, 5834, 2]

// Module 6030 (AvatarDefaultExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AvatarDefaultExample.native.tsx");

export const AvatarDefaultExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
