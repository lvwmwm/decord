...
// Dependencies: [21, 558, 568, 6115, 5834, 2]

// Module 6114 (ChestOrbSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ChestOrbSpotIllustration.native.tsx");

export const ChestOrbSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
