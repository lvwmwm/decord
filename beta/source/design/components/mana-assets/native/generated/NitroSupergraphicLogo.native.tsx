...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroSupergraphicLogo.native.tsx");

export const NitroSupergraphicLogo = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
