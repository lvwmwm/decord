...
// Dependencies: [21, 558, 568, 6843, 5834, 2]

// Module 6842 (WhiteboardAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/WhiteboardAbstractUI.native.tsx");

export const WhiteboardAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
