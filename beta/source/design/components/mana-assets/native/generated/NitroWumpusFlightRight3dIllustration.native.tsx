...
// Dependencies: [21, 558, 568, 6585, 5834, 2]

// Module 6584 (NitroWumpusFlightRight3dIllustration)
...
export const NitroWumpusFlightRight3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
