...
// Dependencies: [21, 558, 568, 6097, 5802, 2]

// Module 6096 (ClydeHologramSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ClydeHologramSpotIllustration.native.tsx");

export const ClydeHologramSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
