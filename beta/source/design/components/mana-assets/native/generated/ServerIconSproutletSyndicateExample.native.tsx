...
// Dependencies: [21, 558, 568, 6675, 5802, 2]

// Module 6674 (ServerIconSproutletSyndicateExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerIconSproutletSyndicateExample.native.tsx");

export const ServerIconSproutletSyndicateExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
