...
// Dependencies: [21, 558, 568, 6259, 5802, 2]

// Module 6258 (GameDepthTier3LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier3LargeBadge.native.tsx");

export const GameDepthTier3LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
