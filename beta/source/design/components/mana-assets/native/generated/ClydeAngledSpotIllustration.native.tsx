...
// Dependencies: [21, 558, 568, 6089, 5802, 2]

// Module 6088 (ClydeAngledSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ClydeAngledSpotIllustration.native.tsx");

export const ClydeAngledSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
