...
// Dependencies: [21, 558, 568, 6703, 5802, 2]

// Module 6702 (SleepingWumpusSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/SleepingWumpusSpotIllustration.native.tsx");

export const SleepingWumpusSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
