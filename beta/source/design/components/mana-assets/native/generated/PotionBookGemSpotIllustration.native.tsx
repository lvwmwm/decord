...
// Dependencies: [21, 558, 568, 6591, 5802, 2]

// Module 6590 (PotionBookGemSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/PotionBookGemSpotIllustration.native.tsx");

export const PotionBookGemSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
