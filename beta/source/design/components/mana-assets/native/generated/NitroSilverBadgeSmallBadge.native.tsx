...
// Dependencies: [21, 558, 568, 6567, 5834, 2]

// Module 6566 (NitroSilverBadgeSmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroSilverBadgeSmallBadge.native.tsx");

export const NitroSilverBadgeSmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
