...
// Dependencies: [21, 558, 568, 6651, 5802, 2]

// Module 6650 (ServerBannerStaffServerExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerBannerStaffServerExample.native.tsx");

export const ServerBannerStaffServerExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
