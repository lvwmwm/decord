...
// Dependencies: [21, 558, 568, 6371, 5834, 2]

// Module 6370 (GemInHandSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GemInHandSpotIllustration.native.tsx");

export const GemInHandSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
