...
// Dependencies: [21, 558, 568, 6527, 5802, 2]

// Module 6526 (NitroRocketSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroRocketSpotIllustration.native.tsx");

export const NitroRocketSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
