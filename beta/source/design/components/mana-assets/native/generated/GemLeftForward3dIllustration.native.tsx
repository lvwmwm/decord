...
// Dependencies: [21, 558, 568, 6341, 5802, 2]

// Module 6340 (GemLeftForward3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GemLeftForward3dIllustration.native.tsx");

export const GemLeftForward3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
