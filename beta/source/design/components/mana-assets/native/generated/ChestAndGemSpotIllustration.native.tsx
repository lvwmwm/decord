...
// Dependencies: [21, 558, 568, 6079, 5802, 2]

// Module 6078 (ChestAndGemSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ChestAndGemSpotIllustration.native.tsx");

export const ChestAndGemSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
