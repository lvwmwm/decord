...
// Dependencies: [21, 558, 568, 6731, 5834, 2]

// Module 6730 (SingleWidgetAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/SingleWidgetAbstractUI.native.tsx");

export const SingleWidgetAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
