...
// Dependencies: [21, 558, 568, 6293, 5834, 2]

// Module 6292 (GameDepthTier3SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier3SmallBadge.native.tsx");

export const GameDepthTier3SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
