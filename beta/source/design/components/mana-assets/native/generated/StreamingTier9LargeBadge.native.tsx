...
// Dependencies: [21, 558, 568, 6765, 5802, 2]

// Module 6764 (StreamingTier9LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/StreamingTier9LargeBadge.native.tsx");

export const StreamingTier9LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
