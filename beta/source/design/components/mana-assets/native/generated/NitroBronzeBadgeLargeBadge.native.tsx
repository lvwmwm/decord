...
// Dependencies: [21, 558, 568, 6525, 5834, 2]

// Module 6524 (NitroBronzeBadgeLargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroBronzeBadgeLargeBadge.native.tsx");

export const NitroBronzeBadgeLargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
