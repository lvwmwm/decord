...
// Dependencies: [21, 558, 568, 6697, 5834, 2]

// Module 6696 (ServerIconDefaultExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerIconDefaultExample.native.tsx");

export const ServerIconDefaultExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
