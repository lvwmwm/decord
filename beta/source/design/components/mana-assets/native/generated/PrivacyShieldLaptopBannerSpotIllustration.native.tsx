...
// Dependencies: [21, 558, 568, 6601, 5802, 2]

// Module 6600 (PrivacyShieldLaptopBannerSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/PrivacyShieldLaptopBannerSpotIllustration.native.tsx");

export const PrivacyShieldLaptopBannerSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
