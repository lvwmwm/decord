...
// Dependencies: [21, 558, 568, 6085, 5802, 2]

// Module 6084 (CloudKeypadSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/CloudKeypadSpotIllustration.native.tsx");

export const CloudKeypadSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
