...
// Dependencies: [21, 558, 568, 6115, 5802, 2]

// Module 6114 (CouchSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/CouchSpotIllustration.native.tsx");

export const CouchSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
