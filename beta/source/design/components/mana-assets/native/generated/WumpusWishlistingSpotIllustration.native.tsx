...
// Dependencies: [21, 558, 568, 6861, 5834, 2]

// Module 6860 (WumpusWishlistingSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/WumpusWishlistingSpotIllustration.native.tsx");

export const WumpusWishlistingSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
