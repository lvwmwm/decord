...
// Dependencies: [21, 558, 568, 6589, 5834, 2]

// Module 6588 (NitroWumpusGreenSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroWumpusGreenSpotIllustration.native.tsx");

export const NitroWumpusGreenSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
