...
// Dependencies: [21, 558, 568, 5941, 5834, 2]

// Module 5940 (AccountAgeTier10LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AccountAgeTier10LargeBadge.native.tsx");

export const AccountAgeTier10LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
