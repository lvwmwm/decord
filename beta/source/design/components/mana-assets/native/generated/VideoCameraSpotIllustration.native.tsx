...
// Dependencies: [21, 558, 568, 6797, 5802, 2]

// Module 6796 (VideoCameraSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/VideoCameraSpotIllustration.native.tsx");

export const VideoCameraSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
