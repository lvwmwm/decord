...
// Dependencies: [21, 558, 568, 6699, 5834, 2]

// Module 6698 (ServerIconEyespyExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerIconEyespyExample.native.tsx");

export const ServerIconEyespyExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
