...
// Dependencies: [21, 558, 568, 6653, 5834, 2]

// Module 6652 (ReactionsSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ReactionsSpotIllustration.native.tsx");

export const ReactionsSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
