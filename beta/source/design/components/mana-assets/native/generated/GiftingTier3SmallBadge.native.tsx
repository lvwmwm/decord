...
// Dependencies: [21, 558, 568, 6433, 5834, 2]

// Module 6432 (GiftingTier3SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftingTier3SmallBadge.native.tsx");

export const GiftingTier3SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
