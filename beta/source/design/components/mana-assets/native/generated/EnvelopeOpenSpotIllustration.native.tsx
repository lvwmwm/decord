...
// Dependencies: [21, 558, 568, 6237, 5834, 2]

// Module 6236 (EnvelopeOpenSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/EnvelopeOpenSpotIllustration.native.tsx");

export const EnvelopeOpenSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
