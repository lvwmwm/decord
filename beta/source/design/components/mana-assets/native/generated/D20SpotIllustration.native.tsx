...
// Dependencies: [21, 558, 568, 6123, 5802, 2]

// Module 6122 (D20SpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/D20SpotIllustration.native.tsx");

export const D20SpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
