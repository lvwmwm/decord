...
// Dependencies: [21, 558, 568, 6737, 5802, 2]

// Module 6736 (StreamingTier2LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/StreamingTier2LargeBadge.native.tsx");

export const StreamingTier2LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
