...
// Dependencies: [21, 558, 568, 6429, 5802, 2]

// Module 6428 (HeadsetSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/HeadsetSpotIllustration.native.tsx");

export const HeadsetSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
