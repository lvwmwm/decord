...
// Dependencies: [21, 558, 568, 6549, 5834, 2]

// Module 6548 (NitroOpalBadgeLargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroOpalBadgeLargeBadge.native.tsx");

export const NitroOpalBadgeLargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
