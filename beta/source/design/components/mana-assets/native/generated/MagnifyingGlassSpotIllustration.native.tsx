...
// Dependencies: [21, 558, 568, 6499, 5834, 2]

// Module 6498 (MagnifyingGlassSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/MagnifyingGlassSpotIllustration.native.tsx");

export const MagnifyingGlassSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
