...
// Dependencies: [21, 558, 568, 6721, 5834, 2]

// Module 6720 (ShareNitroSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ShareNitroSpotIllustration.native.tsx");

export const ShareNitroSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
