...
// Dependencies: [21, 558, 568, 6261, 5834, 2]

// Module 6260 (FileFolderSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/FileFolderSpotIllustration.native.tsx");

export const FileFolderSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
