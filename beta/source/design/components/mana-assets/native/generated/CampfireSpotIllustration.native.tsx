...
// Dependencies: [21, 558, 568, 6063, 5802, 2]

// Module 6062 (CampfireSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/CampfireSpotIllustration.native.tsx");

export const CampfireSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
