...
// Dependencies: [21, 558, 568, 6657, 5802, 2]

// Module 6656 (ServerChannelsAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerChannelsAbstractUI.native.tsx");

export const ServerChannelsAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
