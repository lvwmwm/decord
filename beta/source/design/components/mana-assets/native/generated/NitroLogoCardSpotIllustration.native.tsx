...
// Dependencies: [21, 558, 568, 6515, 5802, 2]

// Module 6514 (NitroLogoCardSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroLogoCardSpotIllustration.native.tsx");

export const NitroLogoCardSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
