...
// Dependencies: [21, 558, 568, 5937, 5802, 2]

// Module 5936 (AccountAgeTier7LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AccountAgeTier7LargeBadge.native.tsx");

export const AccountAgeTier7LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
