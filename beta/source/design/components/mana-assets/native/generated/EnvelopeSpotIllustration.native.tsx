...
// Dependencies: [21, 558, 568, 6239, 5834, 2]

// Module 6238 (EnvelopeSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/EnvelopeSpotIllustration.native.tsx");

export const EnvelopeSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
