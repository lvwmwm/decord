...
// Dependencies: [21, 558, 568, 6225, 5802, 2]

// Module 6224 (FamilySpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/FamilySpotIllustration.native.tsx");

export const FamilySpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
