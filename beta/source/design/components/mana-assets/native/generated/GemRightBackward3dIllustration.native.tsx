...
// Dependencies: [21, 558, 568, 6389, 5834, 2]

// Module 6388 (GemRightBackward3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GemRightBackward3dIllustration.native.tsx");

export const GemRightBackward3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
