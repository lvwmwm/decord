...
// Dependencies: [21, 558, 568, 6253, 5802, 2]

// Module 6252 (GameDepthTier1SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier1SmallBadge.native.tsx");

export const GameDepthTier1SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
