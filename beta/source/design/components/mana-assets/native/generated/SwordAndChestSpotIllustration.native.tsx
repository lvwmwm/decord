...
// Dependencies: [21, 558, 568, 6803, 5834, 2]

// Module 6802 (SwordAndChestSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/SwordAndChestSpotIllustration.native.tsx");

export const SwordAndChestSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
