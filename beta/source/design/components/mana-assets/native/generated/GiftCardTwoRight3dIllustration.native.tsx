...
// Dependencies: [21, 558, 568, 6385, 5802, 2]

// Module 6384 (GiftCardTwoRight3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftCardTwoRight3dIllustration.native.tsx");

export const GiftCardTwoRight3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
