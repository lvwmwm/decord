...
// Dependencies: [21, 558, 568, 6369, 5802, 2]

// Module 6368 (GiftCardAvatar3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftCardAvatar3dIllustration.native.tsx");

export const GiftCardAvatar3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
