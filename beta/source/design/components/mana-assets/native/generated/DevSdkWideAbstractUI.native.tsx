...
// Dependencies: [21, 558, 568, 6171, 5834, 2]

// Module 6170 (DevSdkWideAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/DevSdkWideAbstractUI.native.tsx");

export const DevSdkWideAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
