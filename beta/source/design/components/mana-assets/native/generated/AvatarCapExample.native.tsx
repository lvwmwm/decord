...
// Dependencies: [21, 558, 568, 6023, 5834, 2]

// Module 6022 (AvatarCapExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AvatarCapExample.native.tsx");

export const AvatarCapExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
