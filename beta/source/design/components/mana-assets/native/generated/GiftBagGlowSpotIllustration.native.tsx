...
// Dependencies: [21, 558, 568, 6397, 5834, 2]

// Module 6396 (GiftBagGlowSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftBagGlowSpotIllustration.native.tsx");

export const GiftBagGlowSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
