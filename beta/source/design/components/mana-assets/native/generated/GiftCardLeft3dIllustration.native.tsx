...
// Dependencies: [21, 558, 568, 6375, 5802, 2]

// Module 6374 (GiftCardLeft3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftCardLeft3dIllustration.native.tsx");

export const GiftCardLeft3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
