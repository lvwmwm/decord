...
// Dependencies: [21, 558, 568, 6331, 5802, 2]

// Module 6330 (GameTrophySpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameTrophySpotIllustration.native.tsx");

export const GameTrophySpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
