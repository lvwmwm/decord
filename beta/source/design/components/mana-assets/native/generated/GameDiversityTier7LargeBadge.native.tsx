...
// Dependencies: [21, 558, 568, 6347, 5834, 2]

// Module 6346 (GameDiversityTier7LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDiversityTier7LargeBadge.native.tsx");

export const GameDiversityTier7LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
