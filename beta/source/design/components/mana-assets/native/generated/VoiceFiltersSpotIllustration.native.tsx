...
// Dependencies: [21, 558, 568, 6801, 5802, 2]

// Module 6800 (VoiceFiltersSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/VoiceFiltersSpotIllustration.native.tsx");

export const VoiceFiltersSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
