...
// Dependencies: [21, 558, 568, 6535, 5834, 2]

// Module 6534 (NitroDiamondBadgeSmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroDiamondBadgeSmallBadge.native.tsx");

export const NitroDiamondBadgeSmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
