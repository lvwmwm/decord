...
// Dependencies: [21, 558, 568, 6297, 5834, 2]

// Module 6296 (GameDepthTier4SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier4SmallBadge.native.tsx");

export const GameDepthTier4SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
