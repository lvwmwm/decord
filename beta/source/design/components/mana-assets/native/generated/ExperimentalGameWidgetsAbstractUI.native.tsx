...
// Dependencies: [21, 558, 568, 6247, 5834, 2]

// Module 6246 (ExperimentalGameWidgetsAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ExperimentalGameWidgetsAbstractUI.native.tsx");

export const ExperimentalGameWidgetsAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
