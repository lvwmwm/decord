...
// Dependencies: [21, 558, 568, 6387, 5802, 2]

// Module 6386 (GiftCardWallet3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftCardWallet3dIllustration.native.tsx");

export const GiftCardWallet3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
