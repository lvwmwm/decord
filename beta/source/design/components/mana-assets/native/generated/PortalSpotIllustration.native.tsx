...
// Dependencies: [21, 558, 568, 6621, 5834, 2]

// Module 6620 (PortalSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/PortalSpotIllustration.native.tsx");

export const PortalSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
