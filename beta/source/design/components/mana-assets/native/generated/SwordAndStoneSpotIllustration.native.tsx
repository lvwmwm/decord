...
// Dependencies: [21, 558, 568, 6805, 5834, 2]

// Module 6804 (SwordAndStoneSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/SwordAndStoneSpotIllustration.native.tsx");

export const SwordAndStoneSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
