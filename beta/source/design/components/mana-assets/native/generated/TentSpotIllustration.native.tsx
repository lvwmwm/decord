...
// Dependencies: [21, 558, 568, 6781, 5802, 2]

// Module 6780 (TentSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/TentSpotIllustration.native.tsx");

export const TentSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
