...
// Dependencies: [21, 558, 568, 6287, 5802, 2]

// Module 6286 (GameDiversityTier10LargeBadge)
...
export const GameDiversityTier10LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
