...
// Dependencies: [21, 558, 568, 6593, 5802, 2]

// Module 6592 (PotionSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/PotionSpotIllustration.native.tsx");

export const PotionSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
