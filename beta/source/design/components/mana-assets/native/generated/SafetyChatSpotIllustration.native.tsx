...
// Dependencies: [21, 558, 568, 6669, 5834, 2]

// Module 6668 (SafetyChatSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/SafetyChatSpotIllustration.native.tsx");

export const SafetyChatSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
