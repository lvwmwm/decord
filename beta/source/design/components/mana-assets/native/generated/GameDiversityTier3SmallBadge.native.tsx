...
// Dependencies: [21, 558, 568, 6301, 5802, 2]

// Module 6300 (GameDiversityTier3SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDiversityTier3SmallBadge.native.tsx");

export const GameDiversityTier3SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
