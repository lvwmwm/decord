...
// Dependencies: [21, 558, 568, 6623, 5802, 2]

// Module 6622 (RewardsLaptopSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/RewardsLaptopSpotIllustration.native.tsx");

export const RewardsLaptopSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
