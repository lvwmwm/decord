...
// Dependencies: [21, 558, 568, 6429, 5834, 2]

// Module 6428 (GiftingTier2SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftingTier2SmallBadge.native.tsx");

export const GiftingTier2SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
