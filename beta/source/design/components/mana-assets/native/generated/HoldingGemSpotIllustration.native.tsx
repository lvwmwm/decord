...
// Dependencies: [21, 558, 568, 6443, 5802, 2]

// Module 6442 (HoldingGemSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/HoldingGemSpotIllustration.native.tsx");

export const HoldingGemSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
