...
// Dependencies: [21, 558, 568, 6367, 5802, 2]

// Module 6366 (GiftBoxSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftBoxSpotIllustration.native.tsx");

export const GiftBoxSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
