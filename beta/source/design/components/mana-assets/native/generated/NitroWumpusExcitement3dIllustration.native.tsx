...
// Dependencies: [21, 558, 568, 6581, 5834, 2]

// Module 6580 (NitroWumpusExcitement3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroWumpusExcitement3dIllustration.native.tsx");

export const NitroWumpusExcitement3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
