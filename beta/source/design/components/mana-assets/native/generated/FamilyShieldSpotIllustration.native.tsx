...
// Dependencies: [21, 558, 568, 6223, 5802, 2]

// Module 6222 (FamilyShieldSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/FamilyShieldSpotIllustration.native.tsx");

export const FamilyShieldSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
