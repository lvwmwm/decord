...
// Dependencies: [21, 558, 568, 6731, 5802, 2]

// Module 6730 (StreamingTier10SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/StreamingTier10SmallBadge.native.tsx");

export const StreamingTier10SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
