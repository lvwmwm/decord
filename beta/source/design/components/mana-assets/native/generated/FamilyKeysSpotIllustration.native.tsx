...
// Dependencies: [21, 558, 568, 6221, 5802, 2]

// Module 6220 (FamilyKeysSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/FamilyKeysSpotIllustration.native.tsx");

export const FamilyKeysSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
