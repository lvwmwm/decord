...
// Dependencies: [21, 558, 568, 6263, 5834, 2]

// Module 6262 (FileUploadSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/FileUploadSpotIllustration.native.tsx");

export const FileUploadSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
