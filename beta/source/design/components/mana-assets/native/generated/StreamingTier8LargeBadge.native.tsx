...
// Dependencies: [21, 558, 568, 6793, 5834, 2]

// Module 6792 (StreamingTier8LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/StreamingTier8LargeBadge.native.tsx");

export const StreamingTier8LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
