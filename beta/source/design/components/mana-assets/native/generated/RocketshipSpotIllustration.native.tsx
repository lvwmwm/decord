...
// Dependencies: [21, 558, 568, 6659, 5834, 2]

// Module 6658 (RocketshipSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/RocketshipSpotIllustration.native.tsx");

export const RocketshipSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
