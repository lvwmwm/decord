...
// Dependencies: [21, 558, 568, 6123, 5834, 2]

// Module 6122 (ClydeAnnouncementSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ClydeAnnouncementSpotIllustration.native.tsx");

export const ClydeAnnouncementSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
