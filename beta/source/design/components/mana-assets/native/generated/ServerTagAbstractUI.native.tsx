...
// Dependencies: [21, 558, 568, 6685, 5802, 2]

// Module 6684 (ServerTagAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerTagAbstractUI.native.tsx");

export const ServerTagAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
