...
// Dependencies: [21, 558, 568, 6131, 5834, 2]

// Module 6130 (ClydeShieldSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ClydeShieldSpotIllustration.native.tsx");

export const ClydeShieldSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
