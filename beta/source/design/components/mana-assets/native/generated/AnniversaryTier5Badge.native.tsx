...
// Dependencies: [21, 558, 568, 5971, 5802, 2]

// Module 5970 (AnniversaryTier5Badge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AnniversaryTier5Badge.native.tsx");

export const AnniversaryTier5Badge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
