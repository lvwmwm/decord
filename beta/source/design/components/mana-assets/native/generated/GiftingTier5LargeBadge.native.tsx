...
// Dependencies: [21, 558, 568, 6439, 5834, 2]

// Module 6438 (GiftingTier5LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftingTier5LargeBadge.native.tsx");

export const GiftingTier5LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
