...
// Dependencies: [21, 558, 568, 6359, 5802, 2]

// Module 6358 (GemRightUpwards3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GemRightUpwards3dIllustration.native.tsx");

export const GemRightUpwards3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
