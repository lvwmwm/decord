...
// Dependencies: [21, 558, 568, 6581, 5802, 2]

// Module 6580 (PasskeysSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/PasskeysSpotIllustration.native.tsx");

export const PasskeysSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
