...
// Dependencies: [21, 558, 568, 6171, 5802, 2]

// Module 6170 (DoorwaySpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/DoorwaySpotIllustration.native.tsx");

export const DoorwaySpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
