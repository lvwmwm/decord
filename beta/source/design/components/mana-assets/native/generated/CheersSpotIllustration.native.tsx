...
// Dependencies: [21, 558, 568, 6077, 5802, 2]

// Module 6076 (CheersSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/CheersSpotIllustration.native.tsx");

export const CheersSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
