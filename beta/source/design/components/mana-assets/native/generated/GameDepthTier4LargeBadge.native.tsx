...
// Dependencies: [21, 558, 568, 6263, 5802, 2]

// Module 6262 (GameDepthTier4LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier4LargeBadge.native.tsx");

export const GameDepthTier4LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
