...
// Dependencies: [21, 558, 568, 6081, 5802, 2]

// Module 6080 (ChestLogoSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ChestLogoSpotIllustration.native.tsx");

export const ChestLogoSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
