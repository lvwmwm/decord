...
// Dependencies: [21, 558, 568, 6509, 5834, 2]

// Module 6508 (MicrophoneAndKeyboardSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/MicrophoneAndKeyboardSpotIllustration.native.tsx");

export const MicrophoneAndKeyboardSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
