...
// Dependencies: [21, 558, 568, 6093, 5802, 2]

// Module 6092 (ClydeCoinsSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ClydeCoinsSpotIllustration.native.tsx");

export const ClydeCoinsSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
