...
// Dependencies: [21, 558, 568, 6663, 5834, 2]

// Module 6662 (RulebookSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/RulebookSpotIllustration.native.tsx");

export const RulebookSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
