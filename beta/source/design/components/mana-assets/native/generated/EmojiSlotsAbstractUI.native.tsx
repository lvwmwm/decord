...
// Dependencies: [21, 558, 568, 6191, 5802, 2]

// Module 6190 (EmojiSlotsAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/EmojiSlotsAbstractUI.native.tsx");

export const EmojiSlotsAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
