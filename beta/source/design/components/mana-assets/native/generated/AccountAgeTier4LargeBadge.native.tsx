...
// Dependencies: [21, 558, 568, 5957, 5834, 2]

// Module 5956 (AccountAgeTier4LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AccountAgeTier4LargeBadge.native.tsx");

export const AccountAgeTier4LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
