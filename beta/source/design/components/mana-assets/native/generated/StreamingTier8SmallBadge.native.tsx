...
// Dependencies: [21, 558, 568, 6763, 5802, 2]

// Module 6762 (StreamingTier8SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/StreamingTier8SmallBadge.native.tsx");

export const StreamingTier8SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
