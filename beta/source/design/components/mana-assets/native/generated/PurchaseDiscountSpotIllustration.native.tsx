...
// Dependencies: [21, 558, 568, 6611, 5802, 2]

// Module 6610 (PurchaseDiscountSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/PurchaseDiscountSpotIllustration.native.tsx");

export const PurchaseDiscountSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
