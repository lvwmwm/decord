...
// Dependencies: [21, 558, 568, 6201, 5802, 2]

// Module 6200 (EmojiWumpSweatExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/EmojiWumpSweatExample.native.tsx");

export const EmojiWumpSweatExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
