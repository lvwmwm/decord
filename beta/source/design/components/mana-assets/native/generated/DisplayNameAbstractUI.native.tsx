...
// Dependencies: [21, 558, 568, 6159, 5802, 2]

// Module 6158 (DisplayNameAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/DisplayNameAbstractUI.native.tsx");

export const DisplayNameAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
