...
// Dependencies: [21, 558, 568, 6511, 5834, 2]

// Module 6510 (MicrophoneSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/MicrophoneSpotIllustration.native.tsx");

export const MicrophoneSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
