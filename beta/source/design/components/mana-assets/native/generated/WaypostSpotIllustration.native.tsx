...
// Dependencies: [21, 558, 568, 6841, 5834, 2]

// Module 6840 (WaypostSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/WaypostSpotIllustration.native.tsx");

export const WaypostSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
