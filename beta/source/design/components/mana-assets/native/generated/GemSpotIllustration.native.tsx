...
// Dependencies: [21, 558, 568, 6393, 5834, 2]

// Module 6392 (GemSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GemSpotIllustration.native.tsx");

export const GemSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
