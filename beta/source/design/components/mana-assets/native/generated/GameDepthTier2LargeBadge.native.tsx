...
// Dependencies: [21, 558, 568, 6255, 5802, 2]

// Module 6254 (GameDepthTier2LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier2LargeBadge.native.tsx");

export const GameDepthTier2LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
