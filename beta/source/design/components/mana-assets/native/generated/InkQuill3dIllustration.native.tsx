...
// Dependencies: [21, 558, 568, 6447, 5802, 2]

// Module 6446 (InkQuill3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/InkQuill3dIllustration.native.tsx");

export const InkQuill3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
