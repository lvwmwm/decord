...
// Dependencies: [21, 558, 568, 6775, 5834, 2]

// Module 6774 (StreamingTier3SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/StreamingTier3SmallBadge.native.tsx");

export const StreamingTier3SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
