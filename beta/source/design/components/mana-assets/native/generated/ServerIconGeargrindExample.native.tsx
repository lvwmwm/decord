...
// Dependencies: [21, 558, 568, 6669, 5802, 2]

// Module 6668 (ServerIconGeargrindExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerIconGeargrindExample.native.tsx");

export const ServerIconGeargrindExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
