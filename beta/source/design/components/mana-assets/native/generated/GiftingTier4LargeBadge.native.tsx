...
// Dependencies: [21, 558, 568, 6403, 5802, 2]

// Module 6402 (GiftingTier4LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftingTier4LargeBadge.native.tsx");

export const GiftingTier4LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
