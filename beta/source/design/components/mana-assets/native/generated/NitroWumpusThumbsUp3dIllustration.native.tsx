...
// Dependencies: [21, 558, 568, 6599, 5834, 2]

// Module 6598 (NitroWumpusThumbsUp3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroWumpusThumbsUp3dIllustration.native.tsx");

export const NitroWumpusThumbsUp3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
