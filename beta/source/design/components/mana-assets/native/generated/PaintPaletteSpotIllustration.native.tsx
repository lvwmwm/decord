...
// Dependencies: [21, 558, 568, 6579, 5802, 2]

// Module 6578 (PaintPaletteSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/PaintPaletteSpotIllustration.native.tsx");

export const PaintPaletteSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
