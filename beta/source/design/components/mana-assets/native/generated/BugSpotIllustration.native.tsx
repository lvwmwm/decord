...
// Dependencies: [21, 558, 568, 6051, 5802, 2]

// Module 6050 (BugSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/BugSpotIllustration.native.tsx");

export const BugSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
