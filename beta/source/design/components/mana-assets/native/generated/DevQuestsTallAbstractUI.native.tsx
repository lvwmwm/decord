...
// Dependencies: [21, 558, 568, 6165, 5834, 2]

// Module 6164 (DevQuestsTallAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/DevQuestsTallAbstractUI.native.tsx");

export const DevQuestsTallAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
