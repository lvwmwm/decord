...
// Dependencies: [21, 558, 568, 6377, 5802, 2]

// Module 6376 (GiftCardRight3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftCardRight3dIllustration.native.tsx");

export const GiftCardRight3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
