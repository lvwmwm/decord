...
// Dependencies: [21, 558, 568, 6453, 5802, 2]

// Module 6452 (LanternSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/LanternSpotIllustration.native.tsx");

export const LanternSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
