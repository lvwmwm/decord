...
// Dependencies: [21, 558, 568, 5931, 5802, 2]

// Module 5930 (AccountAgeTier5SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AccountAgeTier5SmallBadge.native.tsx");

export const AccountAgeTier5SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
