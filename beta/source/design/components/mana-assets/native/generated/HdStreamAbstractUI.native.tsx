...
// Dependencies: [21, 558, 568, 6455, 5834, 2]

// Module 6454 (HdStreamAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/HdStreamAbstractUI.native.tsx");

export const HdStreamAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
