...
// Dependencies: [21, 558, 568, 5985, 5834, 2]

// Module 5984 (ActivitiesTogetherSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ActivitiesTogetherSpotIllustration.native.tsx");

export const ActivitiesTogetherSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
