...
// Dependencies: [21, 558, 568, 6423, 5834, 2]

// Module 6422 (GiftingTier1LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftingTier1LargeBadge.native.tsx");

export const GiftingTier1LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
