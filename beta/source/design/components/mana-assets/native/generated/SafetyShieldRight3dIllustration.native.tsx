...
// Dependencies: [21, 558, 568, 6677, 5834, 2]

// Module 6676 (SafetyShieldRight3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/SafetyShieldRight3dIllustration.native.tsx");

export const SafetyShieldRight3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
