...
// Dependencies: [21, 558, 568, 6751, 5834, 2]

// Module 6750 (SpeakerSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/SpeakerSpotIllustration.native.tsx");

export const SpeakerSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
