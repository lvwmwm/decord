...
// Dependencies: [21, 558, 568, 6793, 5802, 2]

// Module 6792 (VendingMachineSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/VendingMachineSpotIllustration.native.tsx");

export const VendingMachineSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
