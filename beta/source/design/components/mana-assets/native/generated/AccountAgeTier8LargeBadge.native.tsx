...
// Dependencies: [21, 558, 568, 5941, 5802, 2]

// Module 5940 (AccountAgeTier8LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AccountAgeTier8LargeBadge.native.tsx");

export const AccountAgeTier8LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
