...
// Dependencies: [21, 558, 568, 6655, 5802, 2]

// Module 6654 (ServerBannerUnderboxExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerBannerUnderboxExample.native.tsx");

export const ServerBannerUnderboxExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
