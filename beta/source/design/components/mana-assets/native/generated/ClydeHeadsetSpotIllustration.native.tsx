...
// Dependencies: [21, 558, 568, 6127, 5834, 2]

// Module 6126 (ClydeHeadsetSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ClydeHeadsetSpotIllustration.native.tsx");

export const ClydeHeadsetSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
