...
// Dependencies: [21, 558, 568, 6629, 5802, 2]

// Module 6628 (RubberDuckSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/RubberDuckSpotIllustration.native.tsx");

export const RubberDuckSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
