...
// Dependencies: [21, 558, 568, 6283, 5802, 2]

// Module 6282 (GameDepthTier9LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier9LargeBadge.native.tsx");

export const GameDepthTier9LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
