...
// Dependencies: [21, 558, 568, 6187, 5834, 2]

// Module 6186 (DiscountsMegaphoneSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/DiscountsMegaphoneSpotIllustration.native.tsx");

export const DiscountsMegaphoneSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
