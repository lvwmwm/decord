...
// Dependencies: [21, 558, 568, 5943, 5834, 2]

// Module 5942 (AccountAgeTier10SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AccountAgeTier10SmallBadge.native.tsx");

export const AccountAgeTier10SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
