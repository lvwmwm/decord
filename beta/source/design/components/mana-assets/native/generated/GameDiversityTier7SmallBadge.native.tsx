...
// Dependencies: [21, 558, 568, 6317, 5802, 2]

// Module 6316 (GameDiversityTier7SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDiversityTier7SmallBadge.native.tsx");

export const GameDiversityTier7SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
