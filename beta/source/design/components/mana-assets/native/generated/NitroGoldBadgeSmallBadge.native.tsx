...
// Dependencies: [21, 558, 568, 6511, 5802, 2]

// Module 6510 (NitroGoldBadgeSmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroGoldBadgeSmallBadge.native.tsx");

export const NitroGoldBadgeSmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
