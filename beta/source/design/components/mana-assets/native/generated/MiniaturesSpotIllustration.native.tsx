...
// Dependencies: [21, 558, 568, 6513, 5834, 2]

// Module 6512 (MiniaturesSpotIllustration)
...
export const MiniaturesSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
