...
// Dependencies: [21, 558, 568, 6727, 5802, 2]

// Module 6726 (StreamSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/StreamSpotIllustration.native.tsx");

export const StreamSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
