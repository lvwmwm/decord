...
// Dependencies: [21, 558, 568, 6271, 5802, 2]

// Module 6270 (GameDepthTier6LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier6LargeBadge.native.tsx");

export const GameDepthTier6LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
