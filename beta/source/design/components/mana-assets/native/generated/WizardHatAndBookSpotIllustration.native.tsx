...
// Dependencies: [21, 558, 568, 6849, 5834, 2]

// Module 6848 (WizardHatAndBookSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/WizardHatAndBookSpotIllustration.native.tsx");

export const WizardHatAndBookSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
