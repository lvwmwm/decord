...
// Dependencies: [21, 558, 568, 6643, 5802, 2]

// Module 6642 (SafetyShieldLeft3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/SafetyShieldLeft3dIllustration.native.tsx");

export const SafetyShieldLeft3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
