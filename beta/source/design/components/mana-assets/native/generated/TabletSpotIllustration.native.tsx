...
// Dependencies: [21, 558, 568, 6777, 5802, 2]

// Module 6776 (TabletSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/TabletSpotIllustration.native.tsx");

export const TabletSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
