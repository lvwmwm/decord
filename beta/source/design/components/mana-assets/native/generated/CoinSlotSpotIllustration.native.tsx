...
// Dependencies: [21, 558, 568, 6135, 5834, 2]

// Module 6134 (CoinSlotSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/CoinSlotSpotIllustration.native.tsx");

export const CoinSlotSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
