...
// Dependencies: [21, 558, 568, 6299, 5834, 2]

// Module 6298 (GameDepthTier5LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier5LargeBadge.native.tsx");

export const GameDepthTier5LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
