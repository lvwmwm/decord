...
// Dependencies: [21, 558, 568, 6005, 5802, 2]

// Module 6004 (AvatarLokyExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AvatarLokyExample.native.tsx");

export const AvatarLokyExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
