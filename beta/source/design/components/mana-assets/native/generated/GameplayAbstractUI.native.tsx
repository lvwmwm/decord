...
// Dependencies: [21, 558, 568, 6365, 5834, 2]

// Module 6364 (GameplayAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameplayAbstractUI.native.tsx");

export const GameplayAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
