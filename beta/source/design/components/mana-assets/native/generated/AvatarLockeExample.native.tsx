...
// Dependencies: [21, 558, 568, 6035, 5834, 2]

// Module 6034 (AvatarLockeExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AvatarLockeExample.native.tsx");

export const AvatarLockeExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
