...
// Dependencies: [21, 558, 568, 6709, 5834, 2]

// Module 6708 (ServerIconStaffServerExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerIconStaffServerExample.native.tsx");

export const ServerIconStaffServerExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
