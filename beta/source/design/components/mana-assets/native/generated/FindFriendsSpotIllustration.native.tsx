...
// Dependencies: [21, 558, 568, 6233, 5802, 2]

// Module 6232 (FindFriendsSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/FindFriendsSpotIllustration.native.tsx");

export const FindFriendsSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
