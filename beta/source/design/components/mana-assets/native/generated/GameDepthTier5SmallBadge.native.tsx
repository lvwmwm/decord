...
// Dependencies: [21, 558, 568, 6301, 5834, 2]

// Module 6300 (GameDepthTier5SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier5SmallBadge.native.tsx");

export const GameDepthTier5SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
