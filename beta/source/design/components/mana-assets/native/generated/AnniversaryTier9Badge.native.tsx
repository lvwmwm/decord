...
// Dependencies: [21, 558, 568, 6011, 5834, 2]

// Module 6010 (AnniversaryTier9Badge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AnniversaryTier9Badge.native.tsx");

export const AnniversaryTier9Badge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
