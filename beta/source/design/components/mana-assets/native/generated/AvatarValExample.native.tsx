...
// Dependencies: [21, 558, 568, 6017, 5802, 2]

// Module 6016 (AvatarValExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AvatarValExample.native.tsx");

export const AvatarValExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
