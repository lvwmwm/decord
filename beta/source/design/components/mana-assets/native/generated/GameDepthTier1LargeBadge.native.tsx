...
// Dependencies: [21, 558, 568, 6251, 5802, 2]

// Module 6250 (GameDepthTier1LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier1LargeBadge.native.tsx");

export const GameDepthTier1LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
