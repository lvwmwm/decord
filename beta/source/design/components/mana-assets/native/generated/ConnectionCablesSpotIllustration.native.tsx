...
// Dependencies: [21, 558, 568, 6141, 5834, 2]

// Module 6140 (ConnectionCablesSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ConnectionCablesSpotIllustration.native.tsx");

export const ConnectionCablesSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
