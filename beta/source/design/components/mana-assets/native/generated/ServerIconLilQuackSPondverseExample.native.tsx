...
// Dependencies: [21, 558, 568, 6671, 5802, 2]

// Module 6670 (ServerIconLilQuackSPondverseExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerIconLilQuackSPondverseExample.native.tsx");

export const ServerIconLilQuackSPondverseExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
