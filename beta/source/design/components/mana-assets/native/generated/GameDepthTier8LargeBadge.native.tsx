...
// Dependencies: [21, 558, 568, 6311, 5834, 2]

// Module 6310 (GameDepthTier8LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier8LargeBadge.native.tsx");

export const GameDepthTier8LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
