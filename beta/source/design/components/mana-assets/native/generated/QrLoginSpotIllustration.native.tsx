...
// Dependencies: [21, 558, 568, 6647, 5834, 2]

// Module 6646 (QrLoginSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/QrLoginSpotIllustration.native.tsx");

export const QrLoginSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
