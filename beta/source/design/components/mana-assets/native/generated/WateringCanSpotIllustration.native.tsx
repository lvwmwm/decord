...
// Dependencies: [21, 558, 568, 6839, 5834, 2]

// Module 6838 (WateringCanSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/WateringCanSpotIllustration.native.tsx");

export const WateringCanSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
