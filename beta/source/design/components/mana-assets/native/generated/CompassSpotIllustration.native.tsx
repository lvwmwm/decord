...
// Dependencies: [21, 558, 568, 6107, 5802, 2]

// Module 6106 (CompassSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/CompassSpotIllustration.native.tsx");

export const CompassSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
