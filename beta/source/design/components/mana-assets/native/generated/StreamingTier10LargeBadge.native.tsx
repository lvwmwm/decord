...
// Dependencies: [21, 558, 568, 6729, 5802, 2]

// Module 6728 (StreamingTier10LargeBadge)
...
export const StreamingTier10LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
