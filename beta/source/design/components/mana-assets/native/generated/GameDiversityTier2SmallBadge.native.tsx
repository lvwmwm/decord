...
// Dependencies: [21, 558, 568, 6297, 5802, 2]

// Module 6296 (GameDiversityTier2SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDiversityTier2SmallBadge.native.tsx");

export const GameDiversityTier2SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
