...
// Dependencies: [21, 558, 568, 6515, 5834, 2]

// Module 6514 (MissionScrollSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/MissionScrollSpotIllustration.native.tsx");

export const MissionScrollSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
