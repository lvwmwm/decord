...
// Dependencies: [21, 558, 568, 6715, 5834, 2]

// Module 6714 (ServerIconUnderboxExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/ServerIconUnderboxExample.native.tsx");

export const ServerIconUnderboxExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
