...
// Dependencies: [21, 558, 568, 6249, 5802, 2]

// Module 6248 (GameDepthTier10SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier10SmallBadge.native.tsx");

export const GameDepthTier10SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
