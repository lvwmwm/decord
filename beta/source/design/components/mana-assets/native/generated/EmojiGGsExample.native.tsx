...
// Dependencies: [21, 558, 568, 6221, 5834, 2]

// Module 6220 (EmojiGGsExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/EmojiGGsExample.native.tsx");

export const EmojiGGsExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
