...
// Dependencies: [21, 558, 568, 6007, 5802, 2]

// Module 6006 (AvatarMallowExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AvatarMallowExample.native.tsx");

export const AvatarMallowExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
