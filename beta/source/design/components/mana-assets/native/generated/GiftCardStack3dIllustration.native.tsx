...
// Dependencies: [21, 558, 568, 6413, 5834, 2]

// Module 6412 (GiftCardStack3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftCardStack3dIllustration.native.tsx");

export const GiftCardStack3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
