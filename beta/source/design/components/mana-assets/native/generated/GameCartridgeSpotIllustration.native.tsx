...
// Dependencies: [21, 558, 568, 6277, 5834, 2]

// Module 6276 (GameCartridgeSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameCartridgeSpotIllustration.native.tsx");

export const GameCartridgeSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
