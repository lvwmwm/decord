...
// Dependencies: [21, 558, 568, 6613, 5802, 2]

// Module 6612 (PuzzleCubeSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/PuzzleCubeSpotIllustration.native.tsx");

export const PuzzleCubeSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
