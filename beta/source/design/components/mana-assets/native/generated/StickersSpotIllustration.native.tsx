...
// Dependencies: [21, 558, 568, 6757, 5834, 2]

// Module 6756 (StickersSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/StickersSpotIllustration.native.tsx");

export const StickersSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
