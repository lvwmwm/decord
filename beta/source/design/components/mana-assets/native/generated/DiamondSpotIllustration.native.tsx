...
// Dependencies: [21, 558, 568, 6143, 5802, 2]

// Module 6142 (DiamondSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/DiamondSpotIllustration.native.tsx");

export const DiamondSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
