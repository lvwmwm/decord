...
// Dependencies: [21, 558, 568, 6299, 5802, 2]

// Module 6298 (GameDiversityTier3LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDiversityTier3LargeBadge.native.tsx");

export const GameDiversityTier3LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
