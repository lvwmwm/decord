...
// Dependencies: [21, 558, 568, 6013, 5802, 2]

// Module 6012 (AvatarRoseExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/AvatarRoseExample.native.tsx");

export const AvatarRoseExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
