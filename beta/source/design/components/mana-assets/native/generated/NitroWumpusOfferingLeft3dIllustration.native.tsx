...
// Dependencies: [21, 558, 568, 6561, 5802, 2]

// Module 6560 (NitroWumpusOfferingLeft3dIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/NitroWumpusOfferingLeft3dIllustration.native.tsx");

export const NitroWumpusOfferingLeft3dIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
