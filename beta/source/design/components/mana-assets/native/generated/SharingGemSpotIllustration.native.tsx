...
// Dependencies: [21, 558, 568, 6691, 5802, 2]

// Module 6690 (SharingGemSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/SharingGemSpotIllustration.native.tsx");

export const SharingGemSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
