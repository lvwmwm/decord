...
// Dependencies: [21, 558, 568, 6437, 5802, 2]

// Module 6436 (HelloWumpusSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/HelloWumpusSpotIllustration.native.tsx");

export const HelloWumpusSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
