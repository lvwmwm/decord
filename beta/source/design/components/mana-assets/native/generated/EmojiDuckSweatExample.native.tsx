...
// Dependencies: [21, 558, 568, 6185, 5802, 2]

// Module 6184 (EmojiDuckSweatExample)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/EmojiDuckSweatExample.native.tsx");

export const EmojiDuckSweatExample = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
