...
// Dependencies: [21, 558, 568, 6153, 5834, 2]

// Module 6152 (CustomTypingAbstractUI)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/CustomTypingAbstractUI.native.tsx");

export const CustomTypingAbstractUI = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
