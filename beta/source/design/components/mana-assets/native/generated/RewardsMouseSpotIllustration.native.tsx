...
// Dependencies: [21, 558, 568, 6625, 5802, 2]

// Module 6624 (RewardsMouseSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/RewardsMouseSpotIllustration.native.tsx");

export const RewardsMouseSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
