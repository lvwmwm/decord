...
// Dependencies: [21, 558, 568, 6281, 5802, 2]

// Module 6280 (GameDepthTier8SmallBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GameDepthTier8SmallBadge.native.tsx");

export const GameDepthTier8SmallBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
