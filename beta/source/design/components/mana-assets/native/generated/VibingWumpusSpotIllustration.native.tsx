...
// Dependencies: [21, 558, 568, 6795, 5802, 2]

// Module 6794 (VibingWumpusSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/VibingWumpusSpotIllustration.native.tsx");

export const VibingWumpusSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
