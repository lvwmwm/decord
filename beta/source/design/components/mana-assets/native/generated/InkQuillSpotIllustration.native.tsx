...
// Dependencies: [21, 558, 568, 6481, 5834, 2]

// Module 6480 (InkQuillSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/InkQuillSpotIllustration.native.tsx");

export const InkQuillSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
