...
// Dependencies: [21, 558, 568, 6093, 5834, 2]

// Module 6092 (CampfireSceneSpotIllustration)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/CampfireSceneSpotIllustration.native.tsx");

export const CampfireSceneSpotIllustration = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
