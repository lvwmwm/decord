...
// Dependencies: [21, 558, 568, 6355, 5834, 2]

// Module 6354 (GameDiversityTier9LargeBadge)
...
export const GameDiversityTier9LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
