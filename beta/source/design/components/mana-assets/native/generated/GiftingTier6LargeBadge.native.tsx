...
// Dependencies: [21, 558, 568, 6411, 5802, 2]

// Module 6410 (GiftingTier6LargeBadge)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/GiftingTier6LargeBadge.native.tsx");

export const GiftingTier6LargeBadge = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  const cResult = c.c(9);
