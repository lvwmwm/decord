...
// Dependencies: [17, 21, 558, 568, 580, 4494, 6185, 2]

// Module 6184 (DiscordWordmarkLogo)
...
let result = size.fileFinishedImporting("design/components/mana-assets/native/generated/DiscordWordmarkLogo.native.tsx");

export const DiscordWordmarkLogo = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
