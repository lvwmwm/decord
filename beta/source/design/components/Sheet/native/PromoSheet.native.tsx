...
// Function ID: 10650
// Name: PromoSheet
// Dependencies: [109, 19, 17, 21, 4790, 580, 558, 568, 10501, 10500, 4786, 5218, 7429, 2]

// Module 10649 (PromoSheet)
...
export const PromoSheet = ReactCompilerGating.isReactCompilerEnabled() ? ((actions) => {
  ...
  if (null == tmp6) {
          ...
          if (cResult[13] === tmp13.illustration) {
            if (cResult[15] === tmp13.title) {
              ...
              if (cResult[18] === tmp5) {
                ...
                if (cResult[21] === tmp25) {
                  ...
                  if (cResult[24] === tmp4) {
                    if (cResult[25] === tmp16) {
                      ...
                      obj2.children = tmp34;
                      const tmp42 = closure_8(tmp(7429).BottomSheet, obj2);
                  ...
                  obj3.children = items;
                  const tmp36 = closure_9(tmp(5218).Stack, obj3);
                  cResult[24] = tmp4;
                  cResult[25] = tmp16;
                  cResult[26] = tmp31;
                  cResult[27] = tmp36;
                ...
                const tmp33 = closure_9(tmp(5218).Stack, obj4);
                cResult[21] = tmp25;
                cResult[22] = tmp28;
                cResult[23] = tmp33;
                tmp31 = tmp33;
              ...
              if (null != tmp5) {
                ...
                tmp29 = closure_8(tmp(4786).Text, obj5);
              }
              cResult[18] = tmp5;
            ...
            const tmp27 = closure_8(tmp(4786).Text, obj6);
    ...
    if (null != tmp7) {
      ...
      let tmp17 = closure_8(tmp(10500).Graphic, obj7);
    } else {
      tmp17 = null;
  ...
  const memo = noop.useMemo(() => null != gradientColor ? ((arg0) => {
    const obj = {};
    const merged = Object.assign(arg0);
    obj.children = closure_2_8(gradientColor(10501).ExpressiveGradient, { offsetBottom: 0.25, color, backgroundColor: nativeDefault.colors.MOBILE_ACTIONSHEET_BACKGROUND });
    return closure_2_8(View, obj);
  }) : undefined, items);
  let obj = {};
  ...
  if (null != graphic) {
    ...
    let tmp4Result = tmp4(tmp5(10500).Graphic, obj2);
  } else {
    tmp4Result = null;
    if (null != illustration) {
  ...
  const items2 = [closure_8(gradientColor(4786).Text, { variant: "heading-xl/semibold", color: "mobile-text-heading-primary", style: tmp2.title, children: title }), ];
  ...
  if (null != description) {
    ...
    tmp4Result2 = tmp4(tmp5(4786).Text, obj5);
  }
  const obj6 = { spacing: 24, children: null };
  items2[1] = tmp4Result2;
  items1[1] = closure_9(gradientColor(5218).Stack, { children: items2 });
  items1[2] = actions;
  obj6.children = items1;
  obj.children = closure_9(gradientColor(5218).Stack, obj6);
  return closure_8(gradientColor(7429).BottomSheet, obj);
});
