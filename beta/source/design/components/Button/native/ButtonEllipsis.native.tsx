...
// Function ID: 5203
// Name: ButtonEllipsis
// Dependencies: [19, 21, 4492, 4756, 576, 4757, 5192, 5203, 2]
// Exports: Ellipsis
  ...
  const mountLayoutEffect = offset(sharedValue1[7]).useMountLayoutEffect(() => {
    if (typeof withEllipsisAnimation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        const tmp5Result3 = tmp5(4492);
        tmp11(tmp5Result.withDelay(result1, tmp5Result3.withRepeat(tmp5(4757).withTiming(1, tmp8, "animate-always"), -1, true)));
        return () => {
...
ELLIPSIS_APPEAR_TIMING.easing = Easing.inOut(fn(4492).Easing.quad);
...
withEllipsisAnimation.__closure = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: fn(4492).withDelay, withRepeat: fn(4492).withRepeat, withTiming: fn(4757).withTiming, ELLIPSIS_APPEAR_TIMING };
