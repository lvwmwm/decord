...
// Function ID: 8175
// Name: experiment
// Dependencies: [32, 1191, 1220, 1221, 8175, 8176, 2]

// Module 8174 (experiment)
import _mod1191 from "module_1191" /* 1191 */;
import timestamp from "timestamp" /* 1220 */;
import wrappers from "wrappers" /* 1221 */;
import rules from "rules" /* 8175 */;
import lifecycle_plan from "lifecycle_plan" /* 8176 */;
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(id, tag, writeUnknownFields) {
  ...
  if ("" !== id.name) {
    tag.tag(2, _mod1191.WireType.LengthDelimited).string(id.name);
  ...
  if (id.createdAt) {
    ...
    const joined = Timestamp.internalBinaryWrite(id.createdAt, tag.tag(3, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = Timestamp.internalBinaryWrite(id.createdAt, tag.tag(3, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("0" !== id.creatorId) {
    tag.tag(4, _mod1191.WireType.Bit64).fixed64(id.creatorId);
    const tagResult3 = tag.tag(4, _mod1191.WireType.Bit64);
  }
  if (0 !== id.version) {
    tag.tag(5, _mod1191.WireType.Varint).int32(id.version);
  ...
  if (id.editedAt) {
    ...
    const joined1 = Timestamp2.internalBinaryWrite(id.editedAt, tag.tag(6, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = Timestamp2.internalBinaryWrite(id.editedAt, tag.tag(6, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("0" !== id.editorId) {
    tag.tag(7, _mod1191.WireType.Bit64).fixed64(id.editorId);
    const tagResult6 = tag.tag(7, _mod1191.WireType.Bit64);
  }
  if ("" !== id.title) {
    tag.tag(8, _mod1191.WireType.LengthDelimited).string(id.title);
    const tagResult7 = tag.tag(8, _mod1191.WireType.LengthDelimited);
  }
  if ("" !== id.description) {
    tag.tag(9, _mod1191.WireType.LengthDelimited).string(id.description);
  ...
  if (id.hypothesis) {
    ...
    const joined2 = StringValue.internalBinaryWrite(id.hypothesis, tag.tag(10, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = StringValue.internalBinaryWrite(id.hypothesis, tag.tag(10, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (id.techSpecLink) {
    const StringValue2 = wrappers.StringValue;
    const tagResult10 = tag.tag(11, _mod1191.WireType.LengthDelimited);
    const joined3 = StringValue2.internalBinaryWrite(id.techSpecLink, tag.tag(11, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = StringValue2.internalBinaryWrite(id.techSpecLink, tag.tag(11, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (0 !== id.revision) {
    tag.tag(12, _mod1191.WireType.Varint).int32(id.revision);
    const tagResult11 = tag.tag(12, _mod1191.WireType.Varint);
  }
  if ("" !== id.hashKey) {
    tag.tag(13, _mod1191.WireType.LengthDelimited).string(id.hashKey);
    const tagResult12 = tag.tag(13, _mod1191.WireType.LengthDelimited);
  }
  if (0 !== id.unitType) {
    tag.tag(14, _mod1191.WireType.Varint).int32(id.unitType);
    const tagResult13 = tag.tag(14, _mod1191.WireType.Varint);
  }
  let num15 = 0;
  if (0 < id.variations.length) {
    do {
      let tagResult14 = tag.tag(15, _mod1191.WireType.LengthDelimited);
  ...
  if (0 < id.rules.length) {
    do {
      let Rule = rules.Rule;
      let tagResult15 = tag.tag(16, _mod1191.WireType.LengthDelimited);
  ...
  if (0 !== id.phase) {
    tag.tag(18, _mod1191.WireType.Varint).int32(id.phase);
    const tagResult16 = tag.tag(18, _mod1191.WireType.Varint);
  }
  if (id.surfaces.length) {
    tag.tag(19, _mod1191.WireType.LengthDelimited).fork();
    let num19 = 0;
  ...
  if ("" !== id.owningTeamId) {
    tag.tag(20, _mod1191.WireType.LengthDelimited).string(id.owningTeamId);
    const tagResult18 = tag.tag(20, _mod1191.WireType.LengthDelimited);
  }
  if ("0" !== id.cachedNotificationChannelId) {
    tag.tag(21, _mod1191.WireType.Bit64).fixed64(id.cachedNotificationChannelId);
    const tagResult19 = tag.tag(21, _mod1191.WireType.Bit64);
  }
  if (0 !== id.exposureTracking) {
    tag.tag(22, _mod1191.WireType.Varint).int32(id.exposureTracking);
    const tagResult20 = tag.tag(22, _mod1191.WireType.Varint);
  }
  if (0 !== id.assignmentMode) {
    tag.tag(25, _mod1191.WireType.Varint).int32(id.assignmentMode);
    const tagResult21 = tag.tag(25, _mod1191.WireType.Varint);
  }
  if (false !== id.enableEditRawJsonUi) {
    tag.tag(23, _mod1191.WireType.Varint).bool(id.enableEditRawJsonUi);
    const tagResult22 = tag.tag(23, _mod1191.WireType.Varint);
  }
  if (id.dynamicConfigSizeLimitOverride) {
    const Int32Value = wrappers.Int32Value;
    const tagResult23 = tag.tag(46, _mod1191.WireType.LengthDelimited);
    const joined7 = Int32Value.internalBinaryWrite(id.dynamicConfigSizeLimitOverride, tag.tag(46, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult6 = Int32Value.internalBinaryWrite(id.dynamicConfigSizeLimitOverride, tag.tag(46, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (0 !== id.winningVariationId) {
    tag.tag(24, _mod1191.WireType.Varint).int32(id.winningVariationId);
    const tagResult24 = tag.tag(24, _mod1191.WireType.Varint);
  }
  if ("" !== id.extraOutcomeContext) {
    tag.tag(34, _mod1191.WireType.LengthDelimited).string(id.extraOutcomeContext);
    const tagResult25 = tag.tag(34, _mod1191.WireType.LengthDelimited);
  }
  if (0 !== id.type) {
    tag.tag(26, _mod1191.WireType.Varint).int32(id.type);
    const tagResult26 = tag.tag(26, _mod1191.WireType.Varint);
  }
  if (false !== id.isTemplate) {
    tag.tag(27, _mod1191.WireType.Varint).bool(id.isTemplate);
    const tagResult27 = tag.tag(27, _mod1191.WireType.Varint);
  }
  if (id.fieldNumbersToCopy.length) {
    tag.tag(28, _mod1191.WireType.LengthDelimited).fork();
    let num31 = 0;
    ...
    const tagResult28 = tag.tag(28, _mod1191.WireType.LengthDelimited);
  }
  let num32 = 0;
  if (0 < id.engineFeatureFlags.length) {
    do {
      let tagResult29 = tag.tag(29, _mod1191.WireType.LengthDelimited);
  ...
  if (id.debugConfig) {
    const tagResult30 = tag.tag(30, _mod1191.WireType.LengthDelimited);
    const joined9 = closure_20.internalBinaryWrite(id.debugConfig, tag.tag(30, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult7 = closure_20.internalBinaryWrite(id.debugConfig, tag.tag(30, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (id.expectedEndDate) {
    const Timestamp3 = timestamp.Timestamp;
    const tagResult31 = tag.tag(31, _mod1191.WireType.LengthDelimited);
    const joined10 = Timestamp3.internalBinaryWrite(id.expectedEndDate, tag.tag(31, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult8 = Timestamp3.internalBinaryWrite(id.expectedEndDate, tag.tag(31, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (false !== id.isAutomatedChange) {
    tag.tag(32, _mod1191.WireType.Varint).bool(id.isAutomatedChange);
    const tagResult32 = tag.tag(32, _mod1191.WireType.Varint);
  }
  if (false !== id.suppressEditorMention) {
    tag.tag(44, _mod1191.WireType.Varint).bool(id.suppressEditorMention);
    const tagResult33 = tag.tag(44, _mod1191.WireType.Varint);
  }
  if (id.archiveAt) {
    const Timestamp4 = timestamp.Timestamp;
    const tagResult34 = tag.tag(33, _mod1191.WireType.LengthDelimited);
    const joined11 = Timestamp4.internalBinaryWrite(id.archiveAt, tag.tag(33, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult9 = Timestamp4.internalBinaryWrite(id.archiveAt, tag.tag(33, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (id.guildExperimentVersion) {
    const Int32Value2 = wrappers.Int32Value;
    const tagResult35 = tag.tag(35, _mod1191.WireType.LengthDelimited);
    const joined12 = Int32Value2.internalBinaryWrite(id.guildExperimentVersion, tag.tag(35, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult10 = Int32Value2.internalBinaryWrite(id.guildExperimentVersion, tag.tag(35, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (0 !== id.customUnitPrefix) {
    tag.tag(36, _mod1191.WireType.Varint).int32(id.customUnitPrefix);
    const tagResult36 = tag.tag(36, _mod1191.WireType.Varint);
  }
  if (id.exposurePoints.length) {
    tag.tag(45, _mod1191.WireType.LengthDelimited).fork();
    let num41 = 0;
    ...
    const tagResult37 = tag.tag(45, _mod1191.WireType.LengthDelimited);
  }
  if ("" !== id.dynamicConfigModel) {
    tag.tag(47, _mod1191.WireType.LengthDelimited).string(id.dynamicConfigModel);
    const tagResult38 = tag.tag(47, _mod1191.WireType.LengthDelimited);
  }
  let num43 = 0;
  if (0 < id.growthbookTags.length) {
    do {
      let tagResult39 = tag.tag(37, _mod1191.WireType.LengthDelimited);
  ...
  if (false !== id.allocateRightToLeft) {
    tag.tag(38, _mod1191.WireType.Varint).bool(id.allocateRightToLeft);
    const tagResult40 = tag.tag(38, _mod1191.WireType.Varint);
  }
  if (false !== id.isManaged) {
    tag.tag(39, _mod1191.WireType.Varint).bool(id.isManaged);
    const tagResult41 = tag.tag(39, _mod1191.WireType.Varint);
  }
  if (id.numberLineSettings) {
    const tagResult42 = tag.tag(43, _mod1191.WireType.LengthDelimited);
    const joined14 = closure_17.internalBinaryWrite(id.numberLineSettings, tag.tag(43, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult11 = closure_17.internalBinaryWrite(id.numberLineSettings, tag.tag(43, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (0 !== id.eligibilityPersistence) {
    tag.tag(42, _mod1191.WireType.Varint).int32(id.eligibilityPersistence);
    const tagResult43 = tag.tag(42, _mod1191.WireType.Varint);
  }
  if (id.lifecyclePlan) {
    const LifecyclePlan = lifecycle_plan.LifecyclePlan;
    const tagResult44 = tag.tag(48, _mod1191.WireType.LengthDelimited);
    const joined15 = LifecyclePlan.internalBinaryWrite(id.lifecyclePlan, tag.tag(48, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult12 = LifecyclePlan.internalBinaryWrite(id.lifecyclePlan, tag.tag(48, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype2["internalBinaryWrite"] = function internalBinaryWrite(mode, tag, writeUnknownFields) {
  if (0 !== mode.mode) {
    tag.tag(1, _mod1191.WireType.Varint).int32(mode.mode);
    const tagResult = tag.tag(1, _mod1191.WireType.Varint);
  }
  if ("0" !== mode.linkedId) {
    tag.tag(2, _mod1191.WireType.Bit64).fixed64(mode.linkedId);
    const tagResult1 = tag.tag(2, _mod1191.WireType.Bit64);
  }
  if (false !== mode.sharedControl) {
    tag.tag(3, _mod1191.WireType.Varint).bool(mode.sharedControl);
...
prototype3["internalBinaryWrite"] = function internalBinaryWrite(id, tag, writeUnknownFields) {
  let length;
  if (0 !== id.id) {
    tag.tag(1, _mod1191.WireType.Varint).int32(id.id);
    const tagResult = tag.tag(1, _mod1191.WireType.Varint);
  }
  if ("" !== id.label) {
    tag.tag(2, _mod1191.WireType.LengthDelimited).string(id.label);
    const tagResult1 = tag.tag(2, _mod1191.WireType.LengthDelimited);
  }
  if (0 !== id.targetAllocation) {
    tag.tag(3, _mod1191.WireType.Varint).int32(id.targetAllocation);
    const tagResult2 = tag.tag(3, _mod1191.WireType.Varint);
  }
  let num4 = 0;
  ...
  if (0 !== id.type) {
    tag.tag(5, _mod1191.WireType.Varint).int32(id.type);
    const tagResult4 = tag.tag(5, _mod1191.WireType.Varint);
  }
  if (id.configuration) {
    const StringValue = wrappers.StringValue;
    const tagResult5 = tag.tag(6, _mod1191.WireType.LengthDelimited);
    const joined1 = StringValue.internalBinaryWrite(id.configuration, tag.tag(6, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = StringValue.internalBinaryWrite(id.configuration, tag.tag(6, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("0" !== id.owningExperimentId) {
    tag.tag(7, _mod1191.WireType.Bit64).fixed64(id.owningExperimentId);
    const tagResult6 = tag.tag(7, _mod1191.WireType.Bit64);
  }
  if (0 !== id.owningSlotId) {
    tag.tag(8, _mod1191.WireType.Varint).int32(id.owningSlotId);
...
prototype4["internalBinaryWrite"] = function internalBinaryWrite(start, tag, writeUnknownFields) {
  if (0 !== start.start) {
    tag.tag(1, _mod1191.WireType.Varint).int32(start.start);
    const tagResult = tag.tag(1, _mod1191.WireType.Varint);
  }
  if (0 !== start.stop) {
    tag.tag(2, _mod1191.WireType.Varint).int32(start.stop);
    const tagResult1 = tag.tag(2, _mod1191.WireType.Varint);
  }
  if (0 !== start.type) {
    tag.tag(3, _mod1191.WireType.Varint).int32(start.type);
    const tagResult2 = tag.tag(3, _mod1191.WireType.Varint);
  }
  if (0 !== start.assignmentMode) {
    tag.tag(5, _mod1191.WireType.Varint).int32(start.assignmentMode);
    const tagResult3 = tag.tag(5, _mod1191.WireType.Varint);
  }
  if (0 !== start.exposureMode) {
    tag.tag(6, _mod1191.WireType.Varint).int32(start.exposureMode);
...
prototype7["internalBinaryWrite"] = function internalBinaryWrite(enableDecisionLogging, tag, writeUnknownFields) {
  if (false !== enableDecisionLogging.enableDecisionLogging) {
    tag.tag(1, _mod1191.WireType.Varint).bool(enableDecisionLogging.enableDecisionLogging);
    const tagResult = tag.tag(1, _mod1191.WireType.Varint);
  }
  if (0 !== enableDecisionLogging.metricsSampleRate) {
    tag.tag(2, _mod1191.WireType.Bit64).double(enableDecisionLogging.metricsSampleRate);
    const tagResult1 = tag.tag(2, _mod1191.WireType.Bit64);
  }
  if (false !== enableDecisionLogging.logContextOnFailure) {
    tag.tag(3, _mod1191.WireType.Varint).bool(enableDecisionLogging.logContextOnFailure);
    const tagResult2 = tag.tag(3, _mod1191.WireType.Varint);
  }
  if (false !== enableDecisionLogging.logRawHeaders) {
    tag.tag(4, _mod1191.WireType.Varint).bool(enableDecisionLogging.logRawHeaders);
    const tagResult3 = tag.tag(4, _mod1191.WireType.Varint);
  }
  if (false !== enableDecisionLogging.tagFilterMetrics) {
    tag.tag(5, _mod1191.WireType.Varint).bool(enableDecisionLogging.tagFilterMetrics);
    const tagResult4 = tag.tag(5, _mod1191.WireType.Varint);
  }
  if (0 !== enableDecisionLogging.decisionLogSampleRate) {
    tag.tag(6, _mod1191.WireType.Bit64).double(enableDecisionLogging.decisionLogSampleRate);
