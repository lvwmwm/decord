...
// Function ID: 8177
// Name: lifecycle_plan
// Dependencies: [32, 1191, 8177, 1220, 2]

// Module 8176 (lifecycle_plan)
import _mod1191 from "module_1191" /* 1191 */;
import timestamp from "timestamp" /* 1220 */;
import duration from "duration" /* 8177 */;
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(measurementPlan, tag, writeUnknownFields) {
  if (measurementPlan.measurementPlan) {
    ...
    const joined = closure_5.internalBinaryWrite(measurementPlan.measurementPlan, tag.tag(1, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = closure_5.internalBinaryWrite(measurementPlan.measurementPlan, tag.tag(1, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (measurementPlan.rolloutPlan) {
    const tagResult1 = tag.tag(2, _mod1191.WireType.LengthDelimited);
    const joined1 = measurementPlanType.internalBinaryWrite(measurementPlan.rolloutPlan, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = measurementPlanType.internalBinaryWrite(measurementPlan.rolloutPlan, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype4["internalBinaryWrite"] = function internalBinaryWrite(targetBasisPoints, tag, writeUnknownFields) {
  if (0 !== targetBasisPoints.targetBasisPoints) {
    tag.tag(1, _mod1191.WireType.Varint).int32(targetBasisPoints.targetBasisPoints);
    const tagResult = tag.tag(1, _mod1191.WireType.Varint);
  }
  if (targetBasisPoints.holdDuration) {
    const Duration = duration.Duration;
    const tagResult1 = tag.tag(2, _mod1191.WireType.LengthDelimited);
    const joined = Duration.internalBinaryWrite(targetBasisPoints.holdDuration, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = Duration.internalBinaryWrite(targetBasisPoints.holdDuration, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (false !== targetBasisPoints.requireManualApproval) {
    tag.tag(3, _mod1191.WireType.Varint).bool(targetBasisPoints.requireManualApproval);
  ...
  if (targetBasisPoints.startedAt) {
    ...
    const joined1 = Timestamp.internalBinaryWrite(targetBasisPoints.startedAt, tag.tag(4, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = Timestamp.internalBinaryWrite(targetBasisPoints.startedAt, tag.tag(4, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (0 !== targetBasisPoints.status) {
    tag.tag(5, _mod1191.WireType.Varint).int32(targetBasisPoints.status);
