...
// Function ID: 13987
// Name: mute
// Dependencies: [32, 1191, 1220, 1221, 2]
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(endTime, tag, writeUnknownFields) {
  if (endTime.endTime) {
    ...
    const joined = Timestamp.internalBinaryWrite(endTime.endTime, tag.tag(1, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = Timestamp.internalBinaryWrite(endTime.endTime, tag.tag(1, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (endTime.selectedTimeWindow) {
    ...
    const joined1 = Int32Value.internalBinaryWrite(endTime.selectedTimeWindow, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = Int32Value.internalBinaryWrite(endTime.selectedTimeWindow, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
