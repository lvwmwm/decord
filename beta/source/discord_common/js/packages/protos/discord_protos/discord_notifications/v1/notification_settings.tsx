...
// Dependencies: [32, 1191, 1221, 1219, 13986, 2]

// Module 13985 (notification_settings)
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(userId, tag, writeUnknownFields) {
  if ("0" !== userId.userId) {
    tag.tag(1, _mod1191.WireType.Bit64).fixed64(userId.userId);
  ...
  if (userId.emailSettings) {
    ...
    const joined = closure_3.internalBinaryWrite(userId.emailSettings, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = closure_3.internalBinaryWrite(userId.emailSettings, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (userId.flags) {
    const UInt64Value = wrappers.UInt64Value;
    const tagResult2 = tag.tag(6, _mod1191.WireType.LengthDelimited);
    const joined1 = UInt64Value.internalBinaryWrite(userId.flags, tag.tag(6, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = UInt64Value.internalBinaryWrite(userId.flags, tag.tag(6, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  const keys = Object.keys(userId.guilds);
  const iter = keys[Symbol.iterator]();
  const nextResult = iter.next();
  while (iter !== undefined) {
    let tagResult3 = tag.tag(4, _mod1191.WireType.LengthDelimited);
    let forkResult = tagResult3.fork();
    let tagResult4 = forkResult.tag(1, _mod1191.WireType.Bit64);
    let fixed64Result1 = tagResult4.fixed64(nextResult);
    let tagResult5 = tag.tag(2, _mod1191.WireType.LengthDelimited);
  ...
  if (0 !== userId.version) {
    tag.tag(5, _mod1191.WireType.Varint).uint32(userId.version);
    const tagResult6 = tag.tag(5, _mod1191.WireType.Varint);
  }
  if (userId.data) {
    const tagResult7 = tag.tag(7, _mod1191.WireType.LengthDelimited);
    const joined4 = items11.internalBinaryWrite(userId.data, tag.tag(7, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = items11.internalBinaryWrite(userId.data, tag.tag(7, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype2["internalBinaryWrite"] = function internalBinaryWrite(categories, tag, writeUnknownFields) {
  ...
  while (iter !== undefined) {
    ...
    let tagResult2 = stringResult.tag(2, _mod1191.WireType.Varint);
...
prototype3["internalBinaryWrite"] = function internalBinaryWrite(mutedGames, tag, writeUnknownFields) {
  ...
  while (iter !== undefined) {
    let tagResult = tag.tag(1, _mod1191.WireType.LengthDelimited);
    let forkResult = tagResult.fork();
    let tagResult1 = forkResult.tag(1, _mod1191.WireType.Bit64);
    let fixed64Result = tagResult1.fixed64(nextResult);
    let tagResult2 = fixed64Result.tag(2, _mod1191.WireType.Varint);
  ...
  if (mutedGames.declarativeSettings) {
    ...
    const joined1 = items12.internalBinaryWrite(mutedGames.declarativeSettings, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = items12.internalBinaryWrite(mutedGames.declarativeSettings, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype4["internalBinaryWrite"] = function internalBinaryWrite(versions, tag, writeUnknownFields) {
  if (versions.versions) {
    ...
    const joined = Versions.internalBinaryWrite(versions.versions, tag.tag(1, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = Versions.internalBinaryWrite(versions.versions, tag.tag(1, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  while (iter !== undefined) {
    ...
    let tagResult2 = forkResult.tag(1, _mod1191.WireType.Varint);
    let _parseInt = parseInt;
    let uint32Result = tagResult2.uint32(parseInt(nextResult));
    let tagResult3 = tag.tag(2, _mod1191.WireType.LengthDelimited);
...
prototype5["internalBinaryWrite"] = function internalBinaryWrite(toggle, tag, writeUnknownFields) {
  if (false !== toggle.toggle) {
    tag.tag(1, _mod1191.WireType.Varint).bool(toggle.toggle);
    const tagResult = tag.tag(1, _mod1191.WireType.Varint);
  }
  if (0 !== toggle.radio) {
    tag.tag(2, _mod1191.WireType.Varint).uint32(toggle.radio);
...
prototype6["internalBinaryWrite"] = function internalBinaryWrite(suppressEveryone, tag, writeUnknownFields) {
  ...
  if (false !== suppressEveryone.suppressEveryone) {
    tag.tag(1, _mod1191.WireType.Varint).bool(suppressEveryone.suppressEveryone);
    const tagResult = tag.tag(1, _mod1191.WireType.Varint);
  }
  if (0 !== suppressEveryone.messageNotifications) {
    tag.tag(2, _mod1191.WireType.Varint).uint32(suppressEveryone.messageNotifications);
    const tagResult1 = tag.tag(2, _mod1191.WireType.Varint);
  }
  if (false !== suppressEveryone.mobilePush) {
    tag.tag(3, _mod1191.WireType.Varint).bool(suppressEveryone.mobilePush);
  ...
  if (suppressEveryone.mute) {
    ...
    const joined = MuteNotificationSettings.internalBinaryWrite(suppressEveryone.mute, tag.tag(4, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = MuteNotificationSettings.internalBinaryWrite(suppressEveryone.mute, tag.tag(4, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let num5 = 0;
  ...
  if (false !== suppressEveryone.suppressRoles) {
    tag.tag(6, _mod1191.WireType.Varint).bool(suppressEveryone.suppressRoles);
    const tagResult5 = tag.tag(6, _mod1191.WireType.Varint);
  }
  if (0 !== suppressEveryone.version) {
    tag.tag(7, _mod1191.WireType.Varint).uint32(suppressEveryone.version);
    const tagResult6 = tag.tag(7, _mod1191.WireType.Varint);
  }
  if (false !== suppressEveryone.hideMutedChannels) {
    tag.tag(8, _mod1191.WireType.Varint).bool(suppressEveryone.hideMutedChannels);
    const tagResult7 = tag.tag(8, _mod1191.WireType.Varint);
  }
  if (false !== suppressEveryone.muteScheduledEvents) {
    tag.tag(9, _mod1191.WireType.Varint).bool(suppressEveryone.muteScheduledEvents);
    const tagResult8 = tag.tag(9, _mod1191.WireType.Varint);
  }
  if (0 !== suppressEveryone.notifyHighlights) {
    tag.tag(10, _mod1191.WireType.Varint).uint32(suppressEveryone.notifyHighlights);
    const tagResult9 = tag.tag(10, _mod1191.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype7["internalBinaryWrite"] = function internalBinaryWrite(channelId, tag, writeUnknownFields) {
  if ("0" !== channelId.channelId) {
    tag.tag(1, _mod1191.WireType.Bit64).fixed64(channelId.channelId);
    const tagResult = tag.tag(1, _mod1191.WireType.Bit64);
  }
  if (0 !== channelId.messageNotifications) {
    tag.tag(7, _mod1191.WireType.Varint).uint32(channelId.messageNotifications);
    const tagResult1 = tag.tag(7, _mod1191.WireType.Varint);
  }
  if (channelId.mute) {
    const MuteNotificationSettings = mute.MuteNotificationSettings;
    const tagResult2 = tag.tag(3, _mod1191.WireType.LengthDelimited);
    const joined = MuteNotificationSettings.internalBinaryWrite(channelId.mute, tag.tag(3, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = MuteNotificationSettings.internalBinaryWrite(channelId.mute, tag.tag(3, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (false !== channelId.collapsed) {
    tag.tag(4, _mod1191.WireType.Varint).bool(channelId.collapsed);
