...
// Dependencies: [32, 1191, 1219, 2]

// Module 1225 (frecency_user_settings)
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(versions, tag, writeUnknownFields) {
  ...
  if (versions.favoriteGifs) {
    ...
    const joined1 = object.internalBinaryWrite(versions.favoriteGifs, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = object.internalBinaryWrite(versions.favoriteGifs, tag.tag(2, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.favoriteStickers) {
    const tagResult2 = tag.tag(3, _mod1191.WireType.LengthDelimited);
    const joined2 = object11.internalBinaryWrite(versions.favoriteStickers, tag.tag(3, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = object11.internalBinaryWrite(versions.favoriteStickers, tag.tag(3, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.stickerFrecency) {
    const tagResult3 = tag.tag(4, _mod1191.WireType.LengthDelimited);
    const joined3 = object12.internalBinaryWrite(versions.stickerFrecency, tag.tag(4, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = object12.internalBinaryWrite(versions.stickerFrecency, tag.tag(4, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.favoriteEmojis) {
    const tagResult4 = tag.tag(5, _mod1191.WireType.LengthDelimited);
    const joined4 = object13.internalBinaryWrite(versions.favoriteEmojis, tag.tag(5, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = object13.internalBinaryWrite(versions.favoriteEmojis, tag.tag(5, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.emojiFrecency) {
    const tagResult5 = tag.tag(6, _mod1191.WireType.LengthDelimited);
    const joined5 = object14.internalBinaryWrite(versions.emojiFrecency, tag.tag(6, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = object14.internalBinaryWrite(versions.emojiFrecency, tag.tag(6, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.applicationCommandFrecency) {
    const tagResult6 = tag.tag(7, _mod1191.WireType.LengthDelimited);
    const joined6 = object15.internalBinaryWrite(versions.applicationCommandFrecency, tag.tag(7, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult6 = object15.internalBinaryWrite(versions.applicationCommandFrecency, tag.tag(7, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.favoriteSoundboardSounds) {
    const tagResult7 = tag.tag(8, _mod1191.WireType.LengthDelimited);
    const joined7 = object17.internalBinaryWrite(versions.favoriteSoundboardSounds, tag.tag(8, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult7 = object17.internalBinaryWrite(versions.favoriteSoundboardSounds, tag.tag(8, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.applicationFrecency) {
    const tagResult8 = tag.tag(9, _mod1191.WireType.LengthDelimited);
    const joined8 = playedSoundFrecencyType.internalBinaryWrite(versions.applicationFrecency, tag.tag(9, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult8 = playedSoundFrecencyType.internalBinaryWrite(versions.applicationFrecency, tag.tag(9, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.heardSoundFrecency) {
    const tagResult9 = tag.tag(10, _mod1191.WireType.LengthDelimited);
    const joined9 = object18.internalBinaryWrite(versions.heardSoundFrecency, tag.tag(10, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult9 = object18.internalBinaryWrite(versions.heardSoundFrecency, tag.tag(10, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.playedSoundFrecency) {
    const tagResult10 = tag.tag(11, _mod1191.WireType.LengthDelimited);
    const joined10 = heardSoundFrecencyType.internalBinaryWrite(versions.playedSoundFrecency, tag.tag(11, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult10 = heardSoundFrecencyType.internalBinaryWrite(versions.playedSoundFrecency, tag.tag(11, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.guildAndChannelFrecency) {
    const tagResult11 = tag.tag(12, _mod1191.WireType.LengthDelimited);
    const joined11 = closure_16.internalBinaryWrite(versions.guildAndChannelFrecency, tag.tag(12, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult11 = closure_16.internalBinaryWrite(versions.guildAndChannelFrecency, tag.tag(12, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (versions.emojiReactionFrecency) {
    const tagResult12 = tag.tag(13, _mod1191.WireType.LengthDelimited);
    const joined12 = object14.internalBinaryWrite(versions.emojiReactionFrecency, tag.tag(13, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult12 = object14.internalBinaryWrite(versions.emojiReactionFrecency, tag.tag(13, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype2["internalBinaryWrite"] = function internalBinaryWrite(gifs, tag, writeUnknownFields) {
  ...
  if (false !== gifs.hideTooltip) {
    tag.tag(2, _mod1191.WireType.Varint).bool(gifs.hideTooltip);
...
prototype3["create"] = function create(arr) {
  ...
  const _Object = Object;
  _Object.defineProperty(size, _mod1191.MESSAGE_TYPE, { enumerable: false, value: this });
  if (undefined !== arr) {
    const result = _mod1191.reflectionMergePartial(this, size, arr);
    const tmpResult = _mod1191;
  }
  return size;
};
...
prototype3["internalBinaryWrite"] = function internalBinaryWrite(format, tag, writeUnknownFields) {
  if (0 !== format.format) {
    tag.tag(1, _mod1191.WireType.Varint).int32(format.format);
    const tagResult = tag.tag(1, _mod1191.WireType.Varint);
  }
  if ("" !== format.src) {
    tag.tag(2, _mod1191.WireType.LengthDelimited).string(format.src);
    const tagResult1 = tag.tag(2, _mod1191.WireType.LengthDelimited);
  }
  if (0 !== format.width) {
    tag.tag(3, _mod1191.WireType.Varint).uint32(format.width);
    const tagResult2 = tag.tag(3, _mod1191.WireType.Varint);
  }
  if (0 !== format.height) {
    tag.tag(4, _mod1191.WireType.Varint).uint32(format.height);
    const tagResult3 = tag.tag(4, _mod1191.WireType.Varint);
  }
  if (0 !== format.order) {
    tag.tag(5, _mod1191.WireType.Varint).uint32(format.order);
...
prototype9["internalBinaryWrite"] = function internalBinaryWrite(totalUses, tag, writeUnknownFields) {
  ...
  if (0 !== totalUses.totalUses) {
    tag.tag(1, _mod1191.WireType.Varint).uint32(totalUses.totalUses);
    const tagResult = tag.tag(1, _mod1191.WireType.Varint);
  }
  ...
  if (0 !== totalUses.frecency) {
    tag.tag(3, _mod1191.WireType.Varint).int32(totalUses.frecency);
    const tagResult2 = tag.tag(3, _mod1191.WireType.Varint);
  }
  if (0 !== totalUses.score) {
    tag.tag(4, _mod1191.WireType.Varint).int32(totalUses.score);
    const tagResult3 = tag.tag(4, _mod1191.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
