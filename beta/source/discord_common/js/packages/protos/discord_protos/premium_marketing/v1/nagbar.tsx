...
// Function ID: 11023
// Name: nagbar
// Dependencies: [32, 1191, 11006, 11005, 11004, 1221, 2]
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(body, tag, writeUnknownFields) {
  if ("" !== body.body) {
    tag.tag(1, _mod1191.WireType.LengthDelimited).string(body.body);
    const tagResult = tag.tag(1, _mod1191.WireType.LengthDelimited);
  }
  if ("" !== body.ctaLabel) {
    tag.tag(2, _mod1191.WireType.LengthDelimited).string(body.ctaLabel);
    const tagResult1 = tag.tag(2, _mod1191.WireType.LengthDelimited);
  }
  if (0 !== body.ctaAction) {
    tag.tag(3, _mod1191.WireType.Varint).int32(body.ctaAction);
    const tagResult2 = tag.tag(3, _mod1191.WireType.Varint);
  }
  if ("" !== body.deeplinkSection) {
    tag.tag(4, _mod1191.WireType.LengthDelimited).string(body.deeplinkSection);
  ...
  if (body.helpArticle) {
    ...
    const joined = HelpArticle.internalBinaryWrite(body.helpArticle, tag.tag(5, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = HelpArticle.internalBinaryWrite(body.helpArticle, tag.tag(5, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (body.bodyLocalized) {
    const LocalizedString = localized_string.LocalizedString;
    const tagResult5 = tag.tag(6, _mod1191.WireType.LengthDelimited);
    const joined1 = LocalizedString.internalBinaryWrite(body.bodyLocalized, tag.tag(6, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = LocalizedString.internalBinaryWrite(body.bodyLocalized, tag.tag(6, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (body.ctaLabelLocalized) {
    const LocalizedString2 = localized_string.LocalizedString;
    const tagResult6 = tag.tag(7, _mod1191.WireType.LengthDelimited);
    const joined2 = LocalizedString2.internalBinaryWrite(body.ctaLabelLocalized, tag.tag(7, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = LocalizedString2.internalBinaryWrite(body.ctaLabelLocalized, tag.tag(7, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (body.navigableStorefrontApplicationId) {
    ...
    const joined3 = UInt64Value.internalBinaryWrite(body.navigableStorefrontApplicationId, tag.tag(8, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = UInt64Value.internalBinaryWrite(body.navigableStorefrontApplicationId, tag.tag(8, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
