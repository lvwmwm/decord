...
prototype["internalBinaryWrite"] = function internalBinaryWrite(id, tag, writeUnknownFields) {
  if ("" !== id.id) {
    tag.tag(1, _mod1191.WireType.LengthDelimited).string(id.id);
    const tagResult = tag.tag(1, _mod1191.WireType.LengthDelimited);
  }
  if ("" !== id.linkText) {
    tag.tag(2, _mod1191.WireType.LengthDelimited).string(id.linkText);
  ...
  if (id.linkTextLocalized) {
    ...
    const joined = LocalizedString.internalBinaryWrite(id.linkTextLocalized, tag.tag(3, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = LocalizedString.internalBinaryWrite(id.linkTextLocalized, tag.tag(3, _mod1191.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
