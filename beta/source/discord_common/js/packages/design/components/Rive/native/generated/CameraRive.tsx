...
// Function ID: 4584
// Name: CameraRive
// Dependencies: [109, 19, 21, 558, 4523, 568, 4584, 4576, 2]

// Module 4583 (CameraRive)
import c from "c" /* 568 */;
...
let obj = {
  "Icon Camera": ReactCompilerGating.isReactCompilerEnabled() ? ((reducedMotionEnabled) => {
...
let closure_11 = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0, ref) => {
  ...
  if (cResult[7] === str) {
    if (cResult[8] === tmp4) {
      ...
      const obj2 = { ref, src: require("module_4584"), artboard: str, artboardProperties, artboardViewModelInstances, defaultViewModelInstance: null, stateMachine: null, renderDataBinding: null };
      class E {
        constructor(arg0) {
          tmp = closure_10[closure_2];
          tmp2 = null;
      ...
      const tmp23 = jsx(require("BaseRive").BaseRive, { ref, src: require("module_4584"), artboard: str, artboardProperties, artboardViewModelInstances, defaultViewModelInstance: null, stateMachine: null, renderDataBinding: null });
      cResult[11] = str;
      cResult[12] = str2;
      cResult[13] = ref;
      cResult[14] = tmp13;
...
export const CameraRive = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((fallback, ref) => {
  const cResult = c.c(6);
