...
// Dependencies: [109, 19, 21, 558, 4491, 568, 4564, 4544, 2]

// Module 4563 (GameServerHostingRive)
import c from "c" /* 568 */;
...
let obj = {
  Game_Server_Hosting_Main: ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
...
obj.hytale_gameplay = ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ({ instance, reducedMotionEnabled, playIfNeeded } = arg0);
  const booleanBinding = BaseRive.useBooleanBinding("reducedMotion", instance, reducedMotionEnabled, undefined, playIfNeeded);
  return null;
}) : ((arg0) => {
...
let closure_11 = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0, ref) => {
  ...
  if (cResult[7] === str) {
    if (cResult[8] === tmp4) {
      ...
      const obj2 = { ref, src: require("module_4564"), artboard: str, artboardProperties, artboardViewModelInstances, defaultViewModelInstance: null, stateMachine: null, renderDataBinding: null };
      class E {
        constructor(arg0) {
          tmp = closure_10[closure_2];
          tmp2 = null;
      ...
      const tmp23 = jsx(require("BaseRive").BaseRive, { ref, src: require("module_4564"), artboard: str, artboardProperties, artboardViewModelInstances, defaultViewModelInstance: null, stateMachine: null, renderDataBinding: null });
      cResult[11] = str;
      cResult[12] = str2;
      cResult[13] = ref;
      cResult[14] = tmp13;
...
export const GameServerHostingRive = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((fallback, ref) => {
  const cResult = c.c(6);
