...
// Dependencies: [109, 19, 21, 558, 4523, 568, 4590, 4576, 2]

// Module 4589 (CheckpointIntroRive)
import c from "c" /* 568 */;
...
let closure_11 = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0, ref) => {
  ...
  if (cResult[7] === str) {
    if (cResult[8] === tmp4) {
      ...
      const obj2 = { ref, src: require("module_4590"), artboard: str, artboardProperties, artboardViewModelInstances, defaultViewModelInstance: str2, stateMachine: tmp7, renderDataBinding: tmp13 };
      let merged = Object.assign(tmp6);
      const tmp23 = jsx(require("BaseRive").BaseRive, { ref, src: require("module_4590"), artboard: str, artboardProperties, artboardViewModelInstances, defaultViewModelInstance: str2, stateMachine: tmp7, renderDataBinding: tmp13 });
      cResult[11] = str;
      cResult[12] = str2;
      cResult[13] = ref;
      cResult[14] = tmp13;
