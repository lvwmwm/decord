...
// Function ID: 4566
// Name: MicrophoneRive
// Dependencies: [109, 19, 21, 558, 4491, 568, 4566, 4544, 2]

// Module 4565 (MicrophoneRive)
import c from "c" /* 568 */;
...
let closure_11 = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((arg0, ref) => {
  ...
  if (cResult[7] === str) {
    if (cResult[8] === tmp4) {
      ...
      const obj2 = { ref, src: require("module_4566"), artboard: str, artboardProperties, artboardViewModelInstances, defaultViewModelInstance: null, stateMachine: null, renderDataBinding: null };
      class V {
        constructor(arg0) {
          tmp = closure_10[closure_2];
          tmp2 = null;
      ...
      const tmp23 = jsx(require("BaseRive").BaseRive, { ref, src: require("module_4566"), artboard: str, artboardProperties, artboardViewModelInstances, defaultViewModelInstance: null, stateMachine: null, renderDataBinding: null });
      cResult[11] = str;
      cResult[12] = str2;
      cResult[13] = ref;
      cResult[14] = tmp13;
