...
let obj = {
  "Nitro Wishlist": ReactCompilerGating.isReactCompilerEnabled() ? ((reducedMotionEnabled) => {
...
export const ThemeAwareNitroWishlistingWumpusRive = noop.forwardRef(ReactCompilerGating.isReactCompilerEnabled() ? ((fallback, ref) => {
  const cResult = c.c(6);
