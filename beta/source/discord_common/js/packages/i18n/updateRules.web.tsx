...
// Dependencies: [19, 21, 1933, 2]
// Exports: default

// Module 1935 (i18n/updateRules)
...
export default function updateRules(paragraph) {
  paragraph.heading = _mod1933.defaultRules.heading;
  paragraph.lheading = _mod1933.defaultRules.lheading;
  paragraph.list = _mod1933.defaultRules.list;
  let obj = {};
  ...
  obj2.react = function react(context, fn, key) {
    ...
    if (null == obj.onClick) {
      const sanitizeUrlResult = _mod1933.sanitizeUrl(context.target);
