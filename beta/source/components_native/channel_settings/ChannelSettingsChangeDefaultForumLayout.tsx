...
// Dependencies: [32, 19, 17, 2045, 21, 4790, 580, 558, 568, 10666, 1119, 2055, 5932, 17299, 7372, 5933, 4786, 5935, 17339, 17340, 5834, 504, 2]

// Module 17338 (ChannelSettingsChangeDefaultForumLayout)
...
const tmp3 = ReactCompilerGating.isReactCompilerEnabled() ? ((channel) => {
  ...
  if (cResult[3] === Symbol.for("react.memo_cache_sentinel")) {
    let obj2 = { icon: closure_7(tmp(17299).GridSquareIcon, {}), label: null, value: null };
    const intl2 = tmp(1119).intl;
    obj2.label = intl2.string(tmp(1119).t["U+rQfW"]);
    obj2.value = tmp(2055).ForumLayout.GRID;
    const tmp12 = closure_7(tmp(5932).TableRadioRow, obj2);
    cResult[3] = tmp12;
    let tmp10 = tmp12;
  } else {
    tmp10 = cResult[3];
  ...
  if (cResult[4] === Symbol.for("react.memo_cache_sentinel")) {
    const obj3 = { icon: closure_7(tmp(7372).ListViewIcon, {}), label: null, value: null };
    const intl3 = tmp(1119).intl;
    obj3.label = intl3.string(tmp(1119).t.tuHPRX);
    obj3.value = tmp(2055).ForumLayout.LIST;
    const tmp15 = closure_7(tmp(5932).TableRadioRow, obj3);
    cResult[4] = tmp15;
    let tmp13 = tmp15;
  } else {
    tmp13 = cResult[4];
  ...
  if (cResult[5] === tmp7) {
    ...
    if (cResult[9] !== tmp4.description) {
      ...
      const tmp22 = closure_7(tmp(4786).Text, obj4);
    ...
    if (cResult[11] === Symbol.for("react.memo_cache_sentinel")) {
      ...
      const tmp25 = closure_7(tmp(5935).TableRowGroupTitle, obj5);
      cResult[11] = tmp25;
      let tmp23 = tmp25;
    } else {
      tmp23 = cResult[11];
    ...
    const tmp32 = closure_7(tmp27(5834), obj7);
  ...
  const tmp17 = closure_8(channel(5933).TableRadioGroup, obj8);
  cResult[5] = tmp7;
  cResult[6] = LIST;
  cResult[7] = tmp17;
  tmp16 = tmp17;
  ...
  const obj3 = { icon: closure_7(channel(17299).GridSquareIcon, {}), label: null, value: null };
  const intl2 = tmp7(1119).intl;
  obj3.label = intl2.string(channel(1119).t["U+rQfW"]);
  obj3.value = channel(2055).ForumLayout.GRID;
  const items1 = [closure_7(channel(5932).TableRadioRow, obj3), ];
  const obj4 = { icon: closure_7(channel(7372).ListViewIcon, {}), label: null, value: null };
  const intl3 = tmp7(1119).intl;
  obj4.label = intl3.string(channel(1119).t.tuHPRX);
  obj4.value = channel(2055).ForumLayout.LIST;
  items1[1] = closure_7(channel(5932).TableRadioRow, obj4);
  obj2.children = items1;
  const items2 = [closure_8(channel(5933).TableRadioGroup, obj2), , , ];
  ...
  items2[1] = closure_7(channel(4786).Text, obj5);
  const obj6 = { title: null };
  const intl5 = tmp7(1119).intl;
  obj6.title = intl5.string(channel(1119).t.e4oMl4);
  items2[2] = closure_7(channel(5935).TableRowGroupTitle, obj6);
  ...
  if (tmp3 === channel(2055).ForumLayout.GRID) {
    let tmp10Result = tmp10(17339);
  } else {
    tmp10Result = tmp10(17340);
  }
