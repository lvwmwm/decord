...
export default function StreamFeedbackActionSheet(stream) {
  ...
  dependencyMap = stream(7985).useGetStreamApplication(stream);
  let obj = stream(7985);
  ...
  obj3.problemOptions = stream(11751).getStreamFeedbackOptions({ isStreamer: stateFromStores });
