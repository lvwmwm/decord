...
// Dependencies: [19, 17, 2113, 1376, 1078, 7676, 1378, 21, 4758, 580, 4708, 1119, 1885, 558, 568, 504, 4418, 4754, 13807, 13808, 9501, 5188, 5198, 1098, 2]
...
const PremiumUtilsDefault = intl(4418);
const LinearGradientDefault = intl(5198);
const PremiumFeatureListDefault = intl(9501);
const _modDef13807 = intl(13807);
const _modDef13808 = intl(13808);
require = fn;
...
export default ReactCompilerGating.isReactCompilerEnabled() ? ((arg0) => {
  ...
  if (obj3.canUsePremiumGuildMemberProfile(title)) {
    ...
    if (cResult[2] === style) {
        ...
        if (cResult[6] === tmp4.subtitle) {
          if (cResult[7] === tmp4.title) {
            if (cResult[9] !== tmp4.upsellFeatureSubLogo) {
              const obj2 = { style: tmp4.upsellFeatureSubLogo, source: tmp8(13807) };
            ...
            if (cResult[11] !== tmp4.upsellFeatureLogoTier2) {
              const obj4 = { style: tmp4.upsellFeatureLogoTier2, source: tmp8(13808) };
                  ...
                  if (cResult[19] === tmp30) {
                    if (cResult[20] === tmp19) {
                      ...
                      if (cResult[24] !== onLearnMorePremium) {
                        ...
                        const tmp41 = v65535(tmp(5188).Button, obj5);
                      ...
                      if (cResult[26] === tmp4.upsellButton) {
                        ...
                        const tmp50 = __initData(tmp8(5198), obj7);
            ...
            const tmp32 = v65535(tmp8(9501), obj10);
      ...
      if (tmp8Result2.isPremium(title)) {
        ...
        const items3 = [v65535(tmp(4754).Text, obj13), ];
        ...
        items3[1] = v65535(tmp(4754).Text, obj14);
        ...
        tmp13 = v65535(tmp(4754).Text, obj16);
      }
      cResult[5] = title;
      ({ subtitle: tmp3[6], title } = tmp4);
      cResult[7] = title;
      cResult[8] = tmp13;
      tmp8Result2 = tmp8(4418);
    }
  ...
  if (obj2.canUsePremiumGuildMemberProfile(stateFromStores)) {
    ...
    if (intlResult1.isPremium(stateFromStores)) {
      ...
      const items2 = [tmp5(tmp2(4754).Text, obj6), ];
      ...
      items2[1] = tmp5(tmp2(4754).Text, obj7);
      ...
      tmp5Result1 = tmp5(tmp2(4754).Text, obj9);
    }
    const items3 = [tmp5Result1, , ];
    const obj10 = { style: tmp.upsellFeatures, children: null };
    const obj11 = { style: tmp.upsellFeatureSubLogo, source: _modDef13807 };
    const items4 = [v65535(React4, obj11), , ];
    const obj12 = { style: tmp.upsellFeatureLogoTier2, source: _modDef13808 };
    ...
    tmp = tmp5(tmp2(5188).Button, obj16);
    obj15.children = tmp;
