...
// Function ID: 1681
// Name: resolvePath
// Dependencies: [1681, 1684, 1692, 1645]
// Exports: withStyleAnimation

// Module 1680 (resolvePath)
const require = fn;
...
function withStyleAnimation(animations) {
  ...
  const obj = require("module_1681");
  fn.__closure = { ColorProperties: require("module_1684").ColorProperties, setPath, processColor: require("module_1684").processColor, styleAnimations: animations, resolvePath, __DEV__: false, logger: require("module_1645").logger, isValidLayoutAnimationProp: require("module_1681").isValidLayoutAnimationProp, withTiming: require("module_1692").withTiming };
  fn.__workletHash = 1293354823532;
  fn.__initData = __initData;
  return obj.defineAnimation({}, fn);
}
withStyleAnimation.__closure = { defineAnimation: fn(1681).defineAnimation, ColorProperties: fn(1684).ColorProperties, setPath, processColor: fn(1684).processColor, resolvePath, __DEV__: false, logger: fn(1645).logger, isValidLayoutAnimationProp: fn(1681).isValidLayoutAnimationProp, withTiming: fn(1692).withTiming };
