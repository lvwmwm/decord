...
// Dependencies: [1700, 1666]
// Exports: CurvedTransition, prepareCurvedTransition

// Module 1734 (prepareCurvedTransition)
import _mod1666 from "module_1666" /* 1666 */;
import WebEasings from "WebEasings" /* 1700 */;
...
export const prepareCurvedTransition = function prepareCurvedTransition(cloneNode, duration, easingY, dummyTransitionKeyframeName) {
  let length;
  const dummyAnimationConfig = { animationName: dummyTransitionKeyframeName, animationType: _mod1666.LayoutAnimationType.LAYOUT, duration: duration.duration, delay: duration.delay, easing: WebEasings.getEasingByName(easingY.easingY), callback: null, reversed: false };
