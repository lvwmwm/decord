...
// Function ID: 1598
// Name: clone
// Dependencies: [19, 17, 1487, 1584, 1506, 1598]
...
export const useLinkProps = function useLinkProps(arg0) {
  ...
  if (null == context1) {
    ...
    const options = obj.useContext(tmp2(1584).LinkingContext).options;
    ...
    const items = [merged.href, tmp2(1598).useDeepStableValue(undefined), , ];
