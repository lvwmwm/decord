...
// Dependencies: [32, 1551, 1552, 1553, 1549, 1515, 1544]
// Exports: getStateFromPath

// Module 1550 (prepareConfigResources)
import findFocusedRoute from "findFocusedRoute" /* 1515 */;
import validateArrayFormatSeparatorAll from "validateArrayFormatSeparator" /* 1544 */;
import _mod1549 from "module_1549" /* 1549 */;
import arrayStartsWith from "arrayStartsWith" /* 1553 */;
...
function getStaticSegmentPattern(arg0) {
  return Array.from(arg0, (str) => {
    ...
    return "(?:" + path(1551)(str) + "|" + path(1551)(encodeURIComponentResult) + ")";
  }).join("");
}
...
function createConfigItem(screen, items1, items2, parse, arg4) {
  ...
  function _loop2(screen) {
    const patternParts = _mod1549.getPatternParts(path);
    items = [
