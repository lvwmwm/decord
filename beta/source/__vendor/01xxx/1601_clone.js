...
// Function ID: 1602
// Name: clone
// Dependencies: [19, 17, 1491, 1588, 1510, 1602]
...
export const useLinkProps = function useLinkProps(arg0) {
  ...
  if (null == context1) {
    ...
    options = obj.useContext(tmp2(1588).LinkingContext).options;
    const tmp14 = _modDef1510((preventDefault) => {
    ...
    const items = [merged.href, tmp2(1602).useDeepStableValue(undefined), , ];
