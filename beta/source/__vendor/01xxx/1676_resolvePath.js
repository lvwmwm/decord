...
// Function ID: 1677
// Name: resolvePath
// Dependencies: [1677, 1680, 1688, 1641]
// Exports: withStyleAnimation

// Module 1676 (resolvePath)
const require = fn;
...
function withStyleAnimation(animations) {
  ...
  const obj = require("module_1677");
  fn.__closure = { ColorProperties: require("module_1680").ColorProperties, setPath, processColor: require("module_1680").processColor, styleAnimations: animations, resolvePath, __DEV__: false, logger: require("module_1641").logger, isValidLayoutAnimationProp: require("module_1677").isValidLayoutAnimationProp, withTiming: require("module_1688").withTiming };
  fn.__workletHash = 1293354823532;
  fn.__initData = __initData;
  return obj.defineAnimation({}, fn);
}
withStyleAnimation.__closure = { defineAnimation: fn(1677).defineAnimation, ColorProperties: fn(1680).ColorProperties, setPath, processColor: fn(1680).processColor, resolvePath, __DEV__: false, logger: fn(1641).logger, isValidLayoutAnimationProp: fn(1677).isValidLayoutAnimationProp, withTiming: fn(1688).withTiming };
