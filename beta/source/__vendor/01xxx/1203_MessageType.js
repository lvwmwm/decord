...
// Function ID: 1204
// Name: MessageType
// Dependencies: [41, 42, 1204, 1206, 1208, 1210, 1211, 1213, 1214, 1215, 1216, 1196, 1201, 1199, 1192]

// Module 1203 (MessageType)
...
const entry = {
  ...
  value: function create(arr) {
    const reflectionCreateResult = MessageType(1214).reflectionCreate(this);
    if (undefined !== arr) {
      const result = MessageType(1215).reflectionMergePartial(this, reflectionCreateResult, arr);
      const tmpResult = MessageType(1215);
    }
...
const items = [
  entry,
  {
    ...
    value: function clone(arr) {
      ...
      const result = MessageType(1215).reflectionMergePartial(this, obj2, arr);
      return obj2;
    }
  },
  {
    ...
    value: function equals(arg0, arg1) {
      return MessageType(1216).reflectionEquals(this, arg0, arg1);
    }
  },
  {
    key: "is",
  ...
  },
  {
    ...
    value: function mergePartial(EmojiFrecency, arr) {
      const result = MessageType(1215).reflectionMergePartial(this, EmojiFrecency, arr);
    }
  },
  {
    key: "fromBinary",
    value: function fromBinary(toBinaryResult, BINARY_READ_OPTIONS) {
      const binaryReadOptionsResult = MessageType(1196).binaryReadOptions(BINARY_READ_OPTIONS);
  ...
  },
  {
    ...
    value: function fromJson(arg0, arg1) {
      return this.internalJsonRead(arg0, MessageType(1201).jsonReadOptions(arg1));
    }
  },
  {
    key: "fromJsonString",
  ...
  },
  {
    ...
    value: function toJson(arg0, prettySpaces) {
      return this.internalJsonWrite(arg0, MessageType(1201).jsonWriteOptions(prettySpaces));
    }
  },
  {
    key: "toJsonString",
  ...
  },
  {
    ...
    value: function toBinary(favoriteGifs, arg1) {
      const binaryWriteOptionsResult = MessageType(1199).binaryWriteOptions(arg1);
      const obj = MessageType(1199);
  ...
  },
  {
    ...
    value: function internalJsonRead(obj, arg1, arg2) {
      ...
      const error = new Error("Unable to parse message " + self.typeName + " from JSON " + MessageType(1192).typeofJsonValue(obj) + ".");
      throw error;
    }
  },
  {
