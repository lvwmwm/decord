...
// Dependencies: [41, 42, 90, 91, 1640, 1681]

// Module 1742 (WorkletEventHandlerNative)
...
const entry = {
  ...
  value: function updateEventHandler(worklet, eventNames) {
    ...
    const item1 = Array.from(_classPrivateFieldBase(this, closure_4)[closure_4]).forEach((item) => {
      ...
      const mapped = eventNames.map((item) => WorkletEventHandlerWeb(1681).registerEventHandler(self.worklet, item, closure_0));
