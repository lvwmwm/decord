...
// Function ID: 1469
// Name: configure
// Dependencies: [32, 19, 17, 1469, 1470, 1475]
// Exports: addEventListener, configure, fetch, refresh, useNetInfo, useNetInfoInstance

// Module 1468 (configure)
import StateDefault from "State" /* 1470 */;
import NetInfoStateTypeAll from "NetInfoStateType" /* 1475 */;
import _slicedToArray from "module_32" /* 32 */;
import module_1469 from "module_1469" /* 1469 */;

const require = globalThis.__r;

function configure(arg0) {
  const merged = Object.assign(module_1469);
  const merged1 = Object.assign(arg0);
  module_1469 = {};
  if (closure_8) {
    closure_8.tearDown();
    if (typeof createState === "function") {
      const tmp10 = new StateDefault(module_1469);
      closure_8 = tmp10;
    } else {
...
function fetch(arg0) {
  ...
  if (!closure_8) {
    if (typeof createState === "function") {
      const tmp7 = new StateDefault(module_1469);
      closure_8 = tmp7;
      obj = tmp7;
    } else {
      throw new TypeError("Trying to call a non-function");
...
function useNetInfo(arg0) {
  ...
  closure_5(() => {
    let f83923 = closure_0;
    obj = closure_8;
    if (!closure_8) {
      if (typeof createState === "function") {
        const tmp8 = new StateDefault(module_1469);
        closure_8 = tmp8;
        obj = tmp8;
      } else {
        throw new TypeError("Trying to call a non-function");
