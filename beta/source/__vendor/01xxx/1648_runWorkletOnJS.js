    ...
    if (module_1644) {
      ...
      if (1 === closure_1_5.length) {
        ...
        queueMicrotask(() => {
          closure_0 = queue;
          queue = [];
          const ReanimatedModule = closure_1(1649).ReanimatedModule;
          fn = function n() {
          ...
          fn.__initData = __initData;
          ReanimatedModule.scheduleOnUI(closure_1(1671).makeShareableCloneRecursive(fn));
        });
      }
    }
  };
}
runOnUI.__closure = { __DEV__: false, SHOULD_BE_USE_WEB: module_1644, isWorkletFunction: _mod1666.isWorkletFunction, IS_JEST: module_1644, ReanimatedModule: ReanimatedModule2.ReanimatedModule, makeShareableCloneRecursive: freezeObjectInDev.makeShareableCloneRecursive, callMicrotasks: callMicrotasksOnUIThread };
...
let obj = { __DEV__: false, SHOULD_BE_USE_WEB: module_1644, isWorkletFunction: _mod1666.isWorkletFunction, IS_JEST: module_1644, ReanimatedModule: ReanimatedModule2.ReanimatedModule, makeShareableCloneRecursive: freezeObjectInDev.makeShareableCloneRecursive, callMicrotasks: callMicrotasksOnUIThread };
runOnUIImmediately.__closure = { __DEV__: false, SHOULD_BE_USE_WEB: module_1644, isWorkletFunction: _mod1666.isWorkletFunction, ReanimatedModule: ReanimatedModule2.ReanimatedModule, makeShareableCloneRecursive: freezeObjectInDev.makeShareableCloneRecursive };
...
function runOnJS(__remoteFunction) {
  if (!module_1644) {
    if (globalThis._WORKLET) {
      ...
      obj = _scheduleRemoteFunctionOnJS(1666);
    }
  }
  return () => {
    const items = [...arguments];
...
let obj2 = { __DEV__: false, SHOULD_BE_USE_WEB: module_1644, isWorkletFunction: _mod1666.isWorkletFunction, ReanimatedModule: ReanimatedModule2.ReanimatedModule, makeShareableCloneRecursive: freezeObjectInDev.makeShareableCloneRecursive };
runOnJS.__closure = { SHOULD_BE_USE_WEB: module_1644, isWorkletFunction: _mod1666.isWorkletFunction, runWorkletOnJS, makeShareableCloneOnUIRecursive: freezeObjectInDev.makeShareableCloneOnUIRecursive };
