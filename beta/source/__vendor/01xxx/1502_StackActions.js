...
// Function ID: 1503
// Name: StackActions
// Dependencies: [1496, 1497, 1503, 1501]
// Exports: StackRouter

// Module 1502 (StackActions)
import BaseRouter2 from "BaseRouter" /* 1496 */;
  ...
  actionCreators.getStateForAction = function getStateForAction(key, type, routeParamList) {
    ...
    if ("REPLACE" === type) {
        ...
        if (-1 === index4) {
          ...
          if (routeNames5.includes(type.payload.name)) {
            ...
            if (found) {
              ...
              const paramsFromAction = tmp135(1501).createParamsFromAction(obj3);
              if (found.params !== paramsFromAction) {
                const obj5 = {};
                let merged = Object.assign(found);
                obj5.params = paramsFromAction;
              }
              const tmp135Result = tmp135(1501);
            } else {
              const obj7 = { action: type, routeParamList };
              tmp135(1503).createRouteFromAction(obj7);
              const tmp135Result2 = tmp135(1503);
            }
            const obj9 = {};
          ...
          if ("NAVIGATE_DEPRECATED" === type) {
            ...
            if (routeNames2.includes(type.payload.name)) {
              ...
              if (preloadedRoutes2.find((name) => {
                ...
                if (-1 === index3) {
                  ...
                  items[arraySpreadResult] = _mod1503.createRouteFromAction(obj11);
                  const obj12 = {};
                  ...
                  const paramsFromAction1 = _mod1501.createParamsFromAction(obj14);
                  const obj15 = {};
                ...
                if (routeNames4.includes(type.payload.name)) {
                  ...
                  if (-1 === num3) {
                    ...
                    if (found1) {
                      ...
                      const paramsFromAction2 = tmp43(1501).createParamsFromAction(obj20);
                      ...
                      const tmp43Result = tmp43(1501);
                    } else {
                      const obj22 = { action: type, routeParamList };
                      routeFromAction = tmp43(1503).createRouteFromAction(obj22);
                      const tmp43Result2 = tmp43(1503);
                    }
                    ...
                    const paramsFromAction3 = _mod1501.createParamsFromAction(obj26);
                    const obj27 = {};
            ...
            if (routeNames.includes(type.payload.name)) {
              ...
              if (tmp7) {
                ...
                obj29.preloadedRoutes = found3.concat(_mod1503.createRouteFromAction(obj31));
                tmp14 = obj29;
              }
              return tmp14;
            } else {
      ...
      if (routeNames3.includes(type.payload.name)) {
        ...
        const paramsFromAction4 = _mod1501.createParamsFromAction(obj35);
        if (tmp95) {
          if ("NAVIGATE" === type.type) {
            if (type.payload.pop) {
              const items3 = [];
