...
// Function ID: 1177
// Name: DEFAULT_LOCALE
// Dependencies: [32, 41, 42, 1160, 1159, 1162]

// Module 1176 (DEFAULT_LOCALE)
...
let items = [
  ...
  },
  {
    ...
    value: function setLocale(currentLocale) {
      ...
      this.data = IntlManager(1159).makeDataFormatters(items, this.formatConfig, this._forceLookupMatcher);
  ...
  },
  {
    ...
    value: function bindFormatValues(Builder, ast, values) {
      ...
      ({ currentLocale: arr[0], defaultLocale: arr[1] } = this);
      obj.locales = items;
      return IntlManager(1162).bindFormatValues(obj);
    }
  }
];
