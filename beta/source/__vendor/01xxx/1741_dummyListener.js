...
// Function ID: 1742
// Name: dummyListener
// Dependencies: [41, 42, 1734, 1709, 1733, 1742, 1686, 1640]

// Module 1741 (dummyListener)
      ...
      if ("style" === key10014) {
        ...
        obj[key10014] = flattenArrayResult.map((viewDescriptors) => {
          if (viewDescriptors) {
            if (viewDescriptors.viewDescriptors) {
              if (iter._isFirstRender) {
                ...
                const merged1 = Object.assign(PropsFilter(1709).initialUpdaterRun(viewDescriptors.initial.updater));
                const result = _initialPropsMap.set(viewDescriptors, obj3);
                const obj4 = PropsFilter(1709);
              }
          ...
          if (obj.hasInlineStyles(viewDescriptors)) {
            inlineStyle = PropsFilter(1733).getInlineStyle(viewDescriptors, iter._isFirstRender);
            const obj2 = PropsFilter(1733);
          }
          return inlineStyle;
        });
        continue;
