...
// Dependencies: [1640, 1662, 1674, 1676, 1644]
      ...
      withStyleAnimationResult.callback = (arg0) => {
        if (arg0) {
          ...
          if (typeof stopObservingProgress === "function") {
            ...
            global._notifyAboutEnd(tmp2, tmp6 === _mod1662.LayoutAnimationType.EXITING);
            const tmp10 = tmp6 === _mod1662.LayoutAnimationType.EXITING;
          } else {
            throw new TypeError("Trying to call a non-function");
          }
          obj = mutableUI;
