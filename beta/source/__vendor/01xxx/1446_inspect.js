...
import _mod1465 from "module_1465" /* 1465 */;
...
export const isBuffer = _mod1464;
export const log = () => {
  const date = new Date();
...
export const inherits = _mod1465;
