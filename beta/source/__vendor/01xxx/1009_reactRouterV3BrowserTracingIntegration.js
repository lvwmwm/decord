  ...
  obj3.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f110545 = (name) => {
        ...
        result = feedbackAsyncIntegration.startBrowserTracingPageLoadSpan(f110545, obj2);
      };
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f123013 = (name) => {
            ...
            obj2.attributes = obj3;
            result = result(889).startBrowserTracingNavigationSpan(f123013, obj2);
          };
