...
// Dependencies: [1644, 1666, 1678, 1680, 1648]

// Module 1677 (startObservingProgress)
import _mod1666 from "module_1666" /* 1666 */;
import _mod1678 from "module_1678" /* 1678 */;
import resolvePath from "resolvePath" /* 1680 */;
...
function startObservingProgress(arg0, addListener, arg2) {
  ...
  dependencyMap = arg2 === require("module_1666").LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
  addListener.addListener(arg0 + 1000000000, () => {
    map._notifyAboutProgress(closure_0, value2.value, closure_2);
  });
}
startObservingProgress.__closure = { LayoutAnimationType: _mod1666.LayoutAnimationType, TAG_OFFSET: 1000000000 };
      ...
      withStyleAnimationResult.callback = (arg0) => {
        if (arg0) {
          ...
          if (typeof stopObservingProgress === "function") {
            ...
            global._notifyAboutEnd(tmp2, tmp6 === _mod1666.LayoutAnimationType.EXITING);
            const tmp10 = tmp6 === _mod1666.LayoutAnimationType.EXITING;
          } else {
            throw new TypeError("Trying to call a non-function");
          }
          obj = mutableUI;
...
let obj = { LayoutAnimationType: _mod1666.LayoutAnimationType, TAG_OFFSET: 1000000000 };
createLayoutAnimationManager.__closure = { LayoutAnimationType: _mod1666.LayoutAnimationType, makeMutableUI: _mod1678.makeMutableUI, stopObservingProgress, withStyleAnimation: resolvePath.withStyleAnimation, startObservingProgress, IS_ANDROID: module_1644 };
