...
// Dependencies: [32, 41, 42, 1192, 1204, 1200, 1209, 1198, 1193]

// Module 1208 (ReflectionJsonReader)
...
let items = [
  entry,
  {
    ...
    value: function assert(arg0, arg1, arg2) {
      if (!arg0) {
        const typeofJsonValueResult = ReflectionJsonReader(1192).typeofJsonValue(arg2);
        ...
        if (tmp10) {
          ...
          if ("map" == obj.kind) {
            if (null === tmp9) {
              ...
              let obj6 = ReflectionJsonReader(1192);
              ...
              for (const item10165 of entries1) {
                ...
                if (obj.K == ReflectionJsonReader(1204).ScalarType.BOOL) {
                ...
                let str3 = self.scalar(first, obj.K, tmp82(1204).LongType.STRING, obj.name);
  ...
  },
  {
    ...
    value: function _enum(arg0, str, arg2, arg3) {
      ...
      if ("google.protobuf.NullValue" == arg0[0]) {
        const _HermesInternal = HermesInternal;
        ReflectionJsonReader(1200).assert(null === str, "Unable to parse field " + self.info.typeName + "#" + arg2 + ", enum " + arg0[0] + " only accepts null.");
        const obj = ReflectionJsonReader(1200);
      }
      if (null === str) {
        return 0;
        ...
        const obj4 = ReflectionJsonReader(1200);
        ...
        if (tmp16) {
          ...
          ReflectionJsonReader(1200).assert(typeof tmp15 === "number", "Unable to parse field " + self.info.typeName + "#" + arg2 + ", enum " + arg0[0] + " has no value for \"" + str + "\".");
          tmp16 = tmp15;
          const obj3 = ReflectionJsonReader(1200);
        }
        return tmp16;
      } else {
        const _HermesInternal2 = HermesInternal;
        ReflectionJsonReader(1200).assert(false, "Unable to parse field " + self.info.typeName + "#" + arg2 + ", cannot parse enum value from " + tmp31 + "\".");
      }
    }
  },
  {
    ...
    value: function scalar(flag, arg1, STRING, arg3) {
      try {
        if (ReflectionJsonReader(1204).ScalarType.DOUBLE !== arg1) {
          if (tmp3(1204).ScalarType.FLOAT !== arg1) {
            if (tmp3(1204).ScalarType.INT32 !== arg1) {
              if (tmp3(1204).ScalarType.FIXED32 !== arg1) {
                if (tmp3(1204).ScalarType.SFIXED32 !== arg1) {
                  if (tmp3(1204).ScalarType.SINT32 !== arg1) {
                    if (tmp3(1204).ScalarType.UINT32 !== arg1) {
                      if (tmp3(1204).ScalarType.INT64 !== arg1) {
                        if (tmp3(1204).ScalarType.SFIXED64 !== arg1) {
                          if (tmp3(1204).ScalarType.SINT64 !== arg1) {
                            if (tmp3(1204).ScalarType.FIXED64 !== arg1) {
                              if (tmp3(1204).ScalarType.UINT64 !== arg1) {
                                if (tmp3(1204).ScalarType.BOOL === arg1) {
                                  if (null === flag) {
                                    return false;
                                  } else if (typeof flag === "boolean") {
                                    return flag;
                                  }
                                } else if (tmp3(1204).ScalarType.STRING === arg1) {
                                  if (null === flag) {
                                    return "";
                                ...
                                } else if (tmp3(1204).ScalarType.BYTES === arg1) {
                                  if (null !== flag) {
                                    if ("" !== flag) {
                                      if (typeof flag === "string") {
                                        return tmp3(1193).base64decode(flag);
                                      }
                                    }
                                  }
                            ...
                            if (null === flag) {
                              ...
                              const PbULong = tmp3(1198).PbULong;
                              return tmp3(1209).reflectionLongConvert(PbULong.from(flag), STRING);
                            }
                          }
                        }
                      }
                      if (null === flag) {
                        ...
                        const PbLong = tmp3(1198).PbLong;
                        return tmp3(1209).reflectionLongConvert(PbLong.from(flag), STRING);
                      }
                    }
                  }
                }
            ...
            if (null === flag) {
              ...
              if (undefined !== NumberResult) {
                if (arg1 == tmp3(1204).ScalarType.UINT32) {
                  tmp3(1200).assertUInt32(NumberResult);
                  const tmp3Result12 = tmp3(1200);
                } else {
                  tmp3(1200).assertInt32(NumberResult);
                  const tmp3Result13 = tmp3(1200);
                }
                return NumberResult;
              }
            }
          ...
          if (typeof flag === "string") {
            ...
            if (Number.isNaN(NumberResult1)) {
              ...
              if (Number.isFinite(tmp26)) {
                if (arg1 == tmp3(1204).ScalarType.FLOAT) {
                  tmp3(1200).assertFloat32(tmp26);
                  const tmp3Result14 = tmp3(1200);
                }
