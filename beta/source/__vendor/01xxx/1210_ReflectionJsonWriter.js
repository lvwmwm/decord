...
// Dependencies: [32, 41, 42, 1200, 1204, 1198, 1193]

// Module 1210 (ReflectionJsonWriter)
    ...
    while (iter !== undefined) {
      ...
      if (nextResult.oneof) {
        ...
        if (tmp8.oneofKind === tmp2.localName) {
          ...
          let obj2 = ReflectionJsonWriter(1200);
  ...
  entry,
  {
    ...
    value: function field(kind, obj, enumAsInteger) {
      ...
      if ("map" == kind.kind) {
        ...
        ReflectionJsonWriter(1200).assert(tmp49);
        ...
        if ("scalar" === kind3) {
          ...
          while (tmp95 !== undefined) {
            ...
            let obj11 = ReflectionJsonWriter(1200);
          ...
          while (tmp77 !== undefined) {
            ...
            let obj10 = ReflectionJsonWriter(1200);
          ...
          while (tmp118 !== undefined) {
            ...
            let obj8 = ReflectionJsonWriter(1200);
        ...
        const obj6 = ReflectionJsonWriter(1200);
      } else if (kind.repeat) {
        const _Array = Array;
        ReflectionJsonWriter(1200).assert(Array.isArray(obj));
        ...
        if ("scalar" === kind2) {
          ...
          if (0 < obj.length) {
            do {
              ...
              let obj5 = ReflectionJsonWriter(1200);
          ...
          for (let num2 = 0; num2 < obj.length; num2 = num2 + 1) {
            ...
            let obj3 = ReflectionJsonWriter(1200);
  ...
  },
  {
    ...
    value: function _enum(arg0, key10009, arg2, arg3, arg4, arg5) {
      ...
      if ("google.protobuf.NullValue" == arg0[0]) {
        ...
        ReflectionJsonWriter(1200).assert(typeof key10009 === "number");
        const obj2 = ReflectionJsonWriter(1200);
        const _Number = Number;
        ReflectionJsonWriter(1200).assert(Number.isInteger(key10009));
        let tmp12 = key10009;
        if (!arg5) {
          tmp12 = key10009;
        ...
        ReflectionJsonWriter(1200).assert(arg3);
        const obj = ReflectionJsonWriter(1200);
      }
    }
  },
  {
  ...
  },
  {
    ...
    value: function scalar(arg0, NumberResult, arg2, arg3, arg4) {
      ...
      if (undefined !== NumberResult) {
        ...
        if (ReflectionJsonWriter(1204).ScalarType.INT32 !== arg0) {
          if (tmp7(1204).ScalarType.SFIXED32 !== arg0) {
            if (tmp7(1204).ScalarType.SINT32 !== arg0) {
              if (tmp7(1204).ScalarType.FIXED32 !== arg0) {
                if (tmp7(1204).ScalarType.UINT32 !== arg0) {
                  if (tmp7(1204).ScalarType.FLOAT === arg0) {
                    tmp7(1200).assertFloat32(tmp);
                    const tmp7Result = tmp7(1200);
                  } else if (tmp7(1204).ScalarType.DOUBLE !== arg0) {
                    if (tmp7(1204).ScalarType.STRING === arg0) {
                      if ("" === tmp) {
                        let str5;
                        if (tmp5) {
                          str5 = "";
                        ...
                        tmp7(1200).assert(typeof tmp === "string");
                        tmp19 = tmp;
                        const tmp7Result10 = tmp7(1200);
                      }
                      return tmp19;
                    } else if (tmp7(1204).ScalarType.BOOL === arg0) {
                      if (false === tmp) {
                        let tmp16 = !tmp5;
                        const tmp17 = !tmp5;
                      } else {
                        tmp7(1200).assert(typeof tmp === "boolean");
                        tmp16 = tmp;
                        const tmp7Result11 = tmp7(1200);
                      }
                      return tmp16;
                    } else {
                      if (tmp7(1204).ScalarType.UINT64 !== arg0) {
                        if (tmp7(1204).ScalarType.FIXED64 !== arg0) {
                          if (tmp7(1204).ScalarType.INT64 !== arg0) {
                            if (tmp7(1204).ScalarType.SFIXED64 !== arg0) {
                              if (tmp7(1204).ScalarType.SINT64 !== arg0) {
                                if (tmp7(1204).ScalarType.BYTES === arg0) {
                                  const _Uint8Array = Uint8Array;
                                  tmp7(1200).assert(tmp instanceof Uint8Array);
                                  if (tmp.byteLength) {
                                    let str = tmp7(1193).base64encode(tmp);
                                    const tmp7Result13 = tmp7(1193);
                                  } else if (tmp5) {
                                    str = "";
                                  }
                                  return str;
                          ...
                          tmp7(1200).assert(tmp11);
                          const PbLong = tmp7(1198).PbLong;
                      ...
                      tmp7(1200).assert(tmp13);
                      const PbULong = tmp7(1198).PbULong;
                  ...
                  if (0 === tmp) {
                    ...
                    tmp7(1200).assert(typeof tmp === "number");
                    const _Number = Number;
                    str6 = "NaN";
                    if (!Number.isNaN(tmp)) {
              ...
              if (0 === tmp) {
                ...
                tmp7(1200).assertUInt32(tmp);
                tmp24 = tmp;
                const tmp7Result17 = tmp7(1200);
              }
              return tmp24;
            }
          }
        ...
        if (0 === tmp) {
          ...
          tmp7(1200).assertInt32(tmp);
          const tmp7Result18 = tmp7(1200);
        }
        return tmp;
      } else {
        ReflectionJsonWriter(1200).assert(arg3);
