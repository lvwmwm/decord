...
// Dependencies: [32, 1541, 1542, 1543, 1544]
// Exports: exclude, extract, parseUrl, pick, stringify, stringifyUrl

// Module 1540 (validateArrayFormatSeparator)
              ...
              if (!closure_0.skipNull) {
                ...
                if (null === arg1) {
                  ...
                  if (!encode) {
                    ...
                    let encodeURIComponentResult = closure_0(1541)(tmp24);
                  } else {
              ...
              if (!closure_0.skipNull) {
                ...
                if (null === arg1) {
                  ...
                  if (!tmp25.encode) {
                    ...
                    let encodeURIComponentResult = closure_0(1541)(tmp18);
                  } else {
                    const _encodeURIComponent3 = encodeURIComponent;
                  ...
                  if (!tmp25.encode) {
                    ...
                    let encodeURIComponentResult2 = closure_0(1541)(tmp30);
                  } else {
                    const _encodeURIComponent = encodeURIComponent;
                ...
                if (0 === arg0.length) {
                  if (!tmp25.encode) {
                    ...
                    if (!tmp25.encode) {
                      ...
                      let encodeURIComponentResult = closure_0(1541)(str3);
                    } else {
                      const _encodeURIComponent3 = encodeURIComponent;
                      encodeURIComponentResult = encodeURIComponent(str3);
                    }
                  } else if (tmp25.strict) {
                    let encodeURIComponentResult1 = closure_0(1541)(tmp10);
                  } else {
                    const _encodeURIComponent2 = encodeURIComponent;
                  ...
                  if (!tmp25.encode) {
                    ...
                    let encodeURIComponentResult2 = closure_0(1541)(str3);
                  } else {
                    const _encodeURIComponent = encodeURIComponent;
    ...
    const mapped = keys1.map((item) => {
      if (undefined === dependencyMap[item]) {
        ...
        if (!merged.encode) {
          ...
          let encodeURIComponentResult = _mod1541(item);
        } else {
          const _encodeURIComponent3 = encodeURIComponent;
        ...
        if (Array.isArray(arr)) {
          ...
          if (!tmp13.encode) {
            ...
            let encodeURIComponentResult1 = _mod1541(item);
          } else {
          ...
          if (!tmp.encode) {
            ...
            let encodeURIComponentResult2 = _mod1541(arr);
          } else {
            const _encodeURIComponent2 = encodeURIComponent;
            encodeURIComponentResult2 = encodeURIComponent(arr);
          }
        } else if (tmp.strict) {
          let encodeURIComponentResult3 = _mod1541(item);
        } else {
          const _encodeURIComponent = encodeURIComponent;
...
export const parseUrl = (arr, arg1) => {
  ...
  [str, tmp5] = _mod1543(arr, "#");
  const tmp4 = _slicedToArray(_mod1543(arr, "#"), 2);
  ...
  if (!url.fragmentIdentifier) {
    ...
    if (merged[tmp]) {
      if (!merged.encode) {
        ...
        let encodeURIComponentResult = _mod1541(fragmentIdentifier);
      } else {
        const _encodeURIComponent = encodeURIComponent;
...
export const pick = (arg0, arg1, arg2) => {
  ...
  const request = { url: parseUrlResult.url, query: _mod1544(query, arg1), fragmentIdentifier };
