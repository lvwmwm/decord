...
function instrumentReactRouter(f133600, arg1, arg2, location, reactrouter_v4, arg5, arg6) {
  _require = f133600;
  ...
  if (arg1) {
    if (location.location) {
      ...
      if (require("feedbackAsyncIntegration").WINDOW.location) {
        pathname = tmp(893).WINDOW.location.pathname;
      }
      tmp = _require;
    }
    if (pathname) {
      ...
      let obj3 = {};
      obj3[require("module_686").SEMANTIC_ATTRIBUTE_SENTRY_OP] = "pageload";
      let _HermesInternal = HermesInternal;
      obj3[require("module_686").SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = "auto.pageload.react." + reactrouter_v4;
      obj3[require("module_686").SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = tmp6;
      obj2.attributes = obj3;
      let result = require("feedbackAsyncIntegration").startBrowserTracingPageLoadSpan(f133600, obj2);
    ...
    location.listen((pathname, arg1) => {
      if (arg1) {
        if ("PUSH" === arg1) {
          ...
          obj3[_mod686.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = "auto.navigation.react." + closure_1;
          obj3[_mod686.SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = tmp6;
          obj2.attributes = obj3;
...
export const reactRouterV4BrowserTracingIntegration = function reactRouterV4BrowserTracingIntegration(instrumentNavigation) {
  ...
  obj3.afterAllSetup = function afterAllSetup(f133600) {
    result.afterAllSetup(f133600);
    instrumentReactRouter(f133600, closure_4, closure_5, dependencyMap, "reactrouter_v4", _slicedToArray, noop);
  };
  return obj3;
};
export const reactRouterV5BrowserTracingIntegration = function reactRouterV5BrowserTracingIntegration(instrumentNavigation) {
  ...
  obj3.afterAllSetup = function afterAllSetup(f133600) {
    result.afterAllSetup(f133600);
    instrumentReactRouter(f133600, closure_4, closure_5, dependencyMap, "reactrouter_v5", _slicedToArray, noop);
  };
  return obj3;
};
export const withSentryRouting = function withSentryRouting(displayName) {
  ...
  require("module_1009").hoistNonReactStatics(WrappedRoute, displayName);
  return WrappedRoute;
};
