...
// Dependencies: [1828, 1826]
// Exports: getSwipeSimulator

// Module 1827 (computeEasingProgress)
import applyStyle from "applyStyle" /* 1826 */;
import RNScreensTurboModule2 from "RNScreensTurboModule" /* 1828 */;
...
function maybeScheduleNextFrame(step, arg1, onFinishAnimation, translationX, arg4) {
  if (arg1) {
...
maybeScheduleNextFrame.__closure = { computeProgress, RNScreensTurboModule: fn(1828).RNScreensTurboModule };
          ...
          if (typeof easing === "function") {
            ...
            if (typeof tmp11 === "function") {
              ...
              if (y2) {
                ...
                const result = tmp19(1826).applyStyleForBelowTopScreen(tmp21, tmp7);
                const tmp19Result = tmp19(1826);
              }
              if (typeof maybeScheduleNextFrame === "function") {
                if (y2) {
                  ...
                  const RNScreensTurboModule = tmp19(1828).RNScreensTurboModule;
            ...
            if (typeof tmp11 === "function") {
              ...
              if (typeof tmp26 === "function") {
                if (y2) {
                  ...
                  const RNScreensTurboModule = tmp22(1828).RNScreensTurboModule;
...
let obj = { computeProgress, RNScreensTurboModule: fn(1828).RNScreensTurboModule };
getSwipeSimulator.__closure = { BASE_VELOCITY: 400, ADDITIONAL_VELOCITY_FACTOR_X: 400, ADDITIONAL_VELOCITY_FACTOR_Y: 500, ADDITIONAL_VELOCITY_FACTOR_XY: 600, applyStyleForBelowTopScreen: fn(1826).applyStyleForBelowTopScreen, computeEasingProgress, easing, applyStyle: fn(1826).applyStyle, maybeScheduleNextFrame };
