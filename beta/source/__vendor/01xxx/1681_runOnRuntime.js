...
// Function ID: 1682
// Name: runOnRuntime
// Dependencies: [1682, 1640, 1648, 1645, 1683, 1667, 1685, 1674, 1687, 1644]
...
export const makeMutable = _mod1674.makeMutable;
export const createWorkletRuntime = _mod1687.createWorkletRuntime;
export const runOnRuntime = _mod1687.runOnRuntime;
...
export const getViewProp = function getViewProp(arg0, arg1, arg2) {
  ...
  if (obj.isFabric()) {
    if (!arg2) {
      const reanimatedError = new tmp(1648).ReanimatedError("Function `getViewProp` requires a component to be passed as an argument on Fabric.");
      throw reanimatedError;
    }
  }
  obj = require("module_1640");
  tmp = _require;
