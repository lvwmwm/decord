  ...
  obj3.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f133600 = (name) => {
        ...
        result = feedbackAsyncIntegration.startBrowserTracingPageLoadSpan(f133600, obj2);
      };
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f148682 = (name) => {
            ...
            obj2.attributes = obj3;
            result = result(893).startBrowserTracingNavigationSpan(f148682, obj2);
          };
