...
// Dependencies: [109, 19, 17, 21, 1675, 1781, 1779, 1780]

// Module 1674 (ReanimatedFlatList)
...
export const ReanimatedFlatList = module_1780.componentWithRef((skipEnteringExitingAnimations, ref) => {
  ...
  if (undefined !== skipEnteringExitingAnimations.skipEnteringExitingAnimations) {
    ...
    tmp5Result = jsx(require("module_1779").LayoutAnimationConfig, { skipEntering: true, skipExiting: true, children: tmp7 });
  }
  return tmp5Result;
});
