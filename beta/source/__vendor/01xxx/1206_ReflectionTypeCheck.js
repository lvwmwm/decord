...
// Dependencies: [41, 42, 1207, 1204]

// Module 1206 (ReflectionTypeCheck)
...
let items = [
    ...
    value: function field(keys, opt, arg2, arg3) {
      ...
      if ("scalar" === kind) {
        ...
        if (undefined === keys) {
          ...
          opt = self.scalars(keys, ReflectionTypeCheck(1204).ScalarType.INT32, arg3);
        } else {
          opt = self.scalar(keys, ReflectionTypeCheck(1204).ScalarType.INT32);
        }
        return opt;
            ...
            if (null !== keys) {
              if (arg3 < 2) {
                ...
                if ("scalar" === kind2) {
                  ...
                  return self.scalars(values, ReflectionTypeCheck(1204).ScalarType.INT32, arg3);
  ...
  },
  {
    ...
    value: function scalar(flag, arg1, arg2) {
      if (ReflectionTypeCheck(1204).ScalarType.UINT64 !== arg1) {
        if (tmp(1204).ScalarType.FIXED64 !== arg1) {
          if (tmp(1204).ScalarType.INT64 !== arg1) {
            if (tmp(1204).ScalarType.SFIXED64 !== arg1) {
              if (tmp(1204).ScalarType.SINT64 !== arg1) {
                if (tmp(1204).ScalarType.BOOL === arg1) {
                  ...
                  if (tmp(1204).ScalarType.DOUBLE !== arg1) {
                    if (tmp(1204).ScalarType.FLOAT !== arg1) {
      ...
      if (ReflectionTypeCheck(1204).LongType.BIGINT === arg2) {
        return typeof flag === "bigint";
      } else if (tmp(1204).LongType.NUMBER === arg2) {
  ...
  },
  {
    ...
    value: function mapKeys(arg0, INT32, arg2) {
      ...
      if (ReflectionTypeCheck(1204).ScalarType.INT32 !== INT32) {
        if (tmp(1204).ScalarType.FIXED32 !== INT32) {
          if (tmp(1204).ScalarType.SFIXED32 !== INT32) {
            if (tmp(1204).ScalarType.SINT32 !== INT32) {
              if (tmp(1204).ScalarType.UINT32 !== INT32) {
                if (tmp(1204).ScalarType.BOOL === INT32) {
                  ...
                  return self.scalars(keys, INT32, arg2, tmp(1204).LongType.STRING);
                }
              }
            }
          }
