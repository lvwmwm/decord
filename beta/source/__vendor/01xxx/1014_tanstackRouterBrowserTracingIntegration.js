...
// Module 1014 (tanstackRouterBrowserTracingIntegration)
...
export const tanstackRouterBrowserTracingIntegration = function tanstackRouterBrowserTracingIntegration(arg0) {
  ...
  obj4.afterAllSetup = function afterAllSetup(f133600) {
    let obj3 = f133600;
    _undefined.afterAllSetup(f133600);
    ...
    if (closure_2) {
      if (_location) {
        ...
        obj.attributes = obj2;
        obj = tmp2(tmp3[0]).startBrowserTracingPageLoadSpan(f133600, obj);
      ...
      const subscription = obj3.subscribe("onBeforeNavigate", (fromLocation) => {
        if (fromLocation.fromLocation) {
          if (fromLocation.toLocation.state !== fromLocation.fromLocation.state) {
            ...
            obj3[_mod686.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = "auto.navigation.react.tanstack_router";
            let str4 = "url";
            if (tmp2) {
              str4 = "route";
            }
            obj3[_mod686.SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str4;
            ...
            dependencyMap = obj3.subscribe("onResolved", (toLocation) => {
              ...
              if (closure_0) {
                ...
                if (forEach) {
                  ...
                  const attr = obj.setAttribute(closure_0(686).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE, "route");
                  const obj2 = {};
                  if (forEach) {
