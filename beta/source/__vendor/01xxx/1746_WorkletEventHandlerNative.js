...
// Dependencies: [41, 42, 90, 91, 1644, 1685]

// Module 1746 (WorkletEventHandlerNative)
...
const entry = {
  ...
  value: function updateEventHandler(worklet, eventNames) {
    ...
    const item1 = Array.from(_classPrivateFieldBase(this, closure_4)[closure_4]).forEach((item) => {
      ...
      const mapped = eventNames.map((item) => WorkletEventHandlerWeb(1685).registerEventHandler(self.worklet, item, closure_0));
