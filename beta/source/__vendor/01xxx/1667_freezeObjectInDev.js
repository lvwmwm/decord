...
// Dependencies: [32, 1640, 1668, 1648, 1662, 1653, 1641]
                          ...
                          const fn = function s() {
                            if (closure_9.includes(name)) {
                              if (undefined === global[tmp]) {
                                ...
                                const reanimatedError = new require("module_1648").ReanimatedError("[Reanimated] Constructor for `" + tmp + "` not found.");
                                throw reanimatedError;
                              } else {
                              ...
                              const _HermesInternal = HermesInternal;
                              const reanimatedError1 = new require("module_1648").ReanimatedError("[Reanimated] Invalid array view name `" + tmp + "`.");
