...
// Function ID: 6992
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6896, 6963, 6992, 6993, 6994, 6995, 6996, 6989, 6904, 6902]
// Exports: default

// Module 6991 (hitSlop)
import _mod6963 from "module_6963" /* 6963 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6992 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6995 */;
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6963.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(6992).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(6992);
          } else {
