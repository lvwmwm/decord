...
// Function ID: 6991
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6903, 6904, 6923, 6963, 6959]
// Exports: FlatList

// Module 6990 (ScrollView)
import DEFAULT_PROPS_TRANSFORMER from "DEFAULT_PROPS_TRANSFORMER" /* 6959 */;
import _slicedToArray from "module_32" /* 32 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;
import "module_6903";
import module_6903 from "module_6903" /* 6903 */;
...
const jsx = fn(21).jsx;
let closure_11 = module_6903(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6904).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6903(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6904).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6903(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6903(TextInput);
