...
// Dependencies: [109, 19, 17, 21, 6966, 1748, 6938]

// Module 6996 (NativeEventsManager1)
...
const jsx = fn(21).jsx;
const Reanimated = fn(6966).Reanimated;
...
if (tmp4) {
  ...
  if (tmp5 != null) {
    ...
    LeanReanimatedNativeDetector = obj.createAnimatedComponent(_modDef6938);
  }
}
