...
// Function ID: 8593
// Name: StepsIndicator
// Dependencies: [19, 17, 21, 8590, 8591, 8593, 8594]
// Exports: StepsIndicator

// Module 8592 (StepsIndicator)
import _mod8590 from "module_8590" /* 8590 */;
import _mod8591 from "module_8591" /* 8591 */;
import SliderTrackMark from "SliderTrackMark" /* 8593 */;
import StepNumber from "StepNumber" /* 8594 */;
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8590.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8590.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8591.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8590.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8591.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8590).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8591).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8591).styles.stepIndicatorElement;
    }
