...
// Dependencies: [19, 17, 21, 8609, 8610]
// Exports: defaultRenderError, defaultRenderLoading, useWebWiewLogic

// Module 8608 (originWhitelistToRegex)
...
function originWhitelistToRegex(arg0) {
  return "^".concat(_modDef8609(arg0).replace(/\\\*/g, ".*"));
}
...
export const defaultRenderLoading = () => v65535(React5, { style: _modDef8610.loadingOrErrorView, children: v65535(closure_1_8, {}) });
export const defaultRenderError = (arg0, arg1, arg2) => {
  const obj = { style: _modDef8610.loadingOrErrorView, children: null };
  const items = [v65535(options, { style: _modDef8610.errorTextTitle, children: "Error loading page" }), , , ];
  const obj2 = { style: _modDef8610.errorTextTitle, children: "Error loading page" };
  items[1] = v65535(options, { style: _modDef8610.errorText, children: "Domain: ".concat(arg0) });
  const obj3 = { style: _modDef8610.errorText, children: "Domain: ".concat(arg0) };
  items[2] = v65535(options, { style: _modDef8610.errorText, children: "Error Code: ".concat(arg1) });
  const obj4 = { style: _modDef8610.errorText, children: "Error Code: ".concat(arg1) };
  items[3] = v65535(options, { style: _modDef8610.errorText, children: "Description: ".concat(arg2) });
  obj.children = items;
