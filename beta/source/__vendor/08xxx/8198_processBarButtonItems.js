...
// Dependencies: [32, 109, 17, 21, 5889, 1489, 8199, 5880, 5150]
// Exports: useHeaderConfigProps

// Module 8198 (processBarButtonItems)
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  const tmpResult = colors(8199);
  let fontSize;
  [tmp10, tmp11, tmp12] = colors(8199).processFonts(items3);
  if ("fontSize" in tmp4) {
    fontSize = tmp4.fontSize;
  }
  const tmp9 = _slicedToArray(colors(8199).processFonts(items3), 3);
  ...
  const isSearchBarAvailableForCurrentPlatform = tmp(5150).isSearchBarAvailableForCurrentPlatform;
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = tmp(5150).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      ...
      let tmp32Result = tmp32(tmp(5150).ScreenStackHeaderLeftView, obj11);
    } else {
      if (typeof headerTitle === "function") {
  ...
  if ("center" === headerTitleAlign) {
    ...
    tmp38Result = tmp38(tmp(5150).ScreenStackHeaderCenterView, obj16);
  }
  ...
  if (undefined !== headerBackIcon) {
    ...
    const obj17 = { source };
    let tmp40Result = closure_10(tmp(5150).ScreenStackHeaderBackButtonImage, obj17);
  } else {
    tmp40Result = null;
  }
  ...
  if (null != headerRightResult) {
    ...
    tmp42 = closure_10(tmp(5150).ScreenStackHeaderRightView, obj18);
  }
  items7[2] = tmp42;
  let tmp44 = null;
  if (isSearchBarAvailableForCurrentPlatform2) {
    ...
    obj19.children = closure_10(tmp(5150).SearchBar, obj20);
    tmp44 = closure_10(tmp(5150).ScreenStackHeaderSearchBarView, obj19);
  }
  items7[3] = tmp44;
