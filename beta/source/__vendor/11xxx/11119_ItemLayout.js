...
// Function ID: 11120
// Name: ItemLayout
// Dependencies: [19, 21, 11102, 11120, 1641]
// Exports: ItemLayout

// Module 11119 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod11102.useGlobalState().props;
  ...
  const offsetX = _mod11120.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod11120;
  const fn = function k() {
