...
// Function ID: 11118
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 11118, 1641, 11095, 11119]
// Exports: ItemRenderer

// Module 11117 (ItemRenderer)
...
export const ItemRenderer = (arg0) => {
  ...
  const visibleRanges = _mod11118.useVisibleRanges({ total: dataLength, viewSize: size, translation: handlerOffset, windowSize, loop });
