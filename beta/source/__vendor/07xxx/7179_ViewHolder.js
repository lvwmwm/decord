...
// Function ID: 7180
// Name: ViewHolder
// Dependencies: [19, 21, 7142, 7175]

// Module 7179 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_7142").getInvertedTransformStyle(horizontal);
    let obj = require("module_7142");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
