...
// Dependencies: [7125, 19, 21, 7144, 7143]

// Module 7194 (LayoutCommitObserver)
...
const memoResult = noop.memo((children) => {
  ...
  [r10018, tmp3] = _mod7143.useLayoutState(0);
  _slicedToArray = tmp3;
  const tmp2 = _slicedToArray(_mod7143.useLayoutState(0), 2);
  ...
  return jsx(_mod7144.RecyclerViewContextProvider, { value, children: children.children });
});
