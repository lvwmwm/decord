...
// Function ID: 7093
// Name: RecyclerView
// Dependencies: [7093, 7099, 19, 17, 21, 7101, 7110, 7111, 7113, 7135, 7140, 7141, 7130, 7133, 7139, 7112, 7142, 7090, 7146, 7143, 7148, 7149]

// Module 7092 (RecyclerView)
import ErrorMessages from "ErrorMessages" /* 7090 */;
import areDimensionsNotEqual from "areDimensionsNotEqual" /* 7130 */;
import WarningMessages from "WarningMessages" /* 7133 */;
import CompatView from "CompatView" /* 7143 */;
import StickyHeaders from "StickyHeaders" /* 7146 */;
import ScrollAnchor from "ScrollAnchor" /* 7148 */;
import _slicedToArray from "module_7093" /* 7093 */;
import _objectWithoutProperties from "module_7099" /* 7099 */;
...
class RecyclerViewComponent {
  constructor(arg0, arg1) {
          ...
          if (stickyHeaderIndices) {
            if (arr2.length > 0) {
              if (horizontal) {
                ...
                return __initData2(StickyHeaders.StickyHeaders, obj);
              }
            }
          }
        }
    ...
    tmp20Result4 = tmp20(() => {
      ...
      size.width = num2;
      return __initData2(CompatView.CompatView, { style: size, ref: ref2 });
    }, items6);
    items7 = [, ];
    items7[0] = horizontal;
    items7[1] = result1;
    ...
    tmp20Result5 = tmp20(() => {
      ...
      if (result1) {
        ...
        tmp = __initData2(ScrollAnchor.ScrollAnchor, obj);
      }
      return tmp;
    }, items7);
