...
// Dependencies: [7125, 19, 21, 7144, 7175, 7179]
// Exports: ViewHolderCollection

// Module 7181 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 7179 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(7144).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7175).CompatView, { style: tmp19, children: null });
};
