...
// Dependencies: [7093, 19, 21, 7112, 7143, 7147]
// Exports: ViewHolderCollection

// Module 7149 (ViewHolderCollection)
import ViewHolder from "ViewHolder" /* 7147 */;
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(7112).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7143).CompatView, { style: tmp19, children: null });
};
