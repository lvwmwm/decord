...
// Dependencies: [32, 19, 17, 21, 7001, 6928, 7003, 6990, 6999, 6998, 6977]
// Exports: VirtualDetector

// Module 7002 (VirtualDetector)
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("module_7001").useInterceptingDetectorContext();
