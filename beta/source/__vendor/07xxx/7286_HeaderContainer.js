...
// Dependencies: [19, 17, 21, 5880, 1489, 7287, 7288]
// Exports: HeaderContainer

// Module 7286 (HeaderContainer)
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_7287").forSlideRight;
                    } else {
                      forSlideUp = require("module_7287").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_7287").forSlideUp;
              }
            } else {
              forNoAnimation = require("module_7287").forNoAnimation;
            }
