...
// Function ID: 7301
// Name: CardContainer
// Dependencies: [19, 17, 21, 1489, 5880, 7301, 7302, 7303, 7290]

// Module 7300 (CardContainer)
import Link from "Link" /* 1489 */;
import _mod5880 from "module_5880" /* 5880 */;
import ModalPresentationContext from "ModalPresentationContext" /* 7290 */;
import _mod7301 from "module_7301" /* 7301 */;
import CardA11yWrapper from "CardA11yWrapper" /* 7302 */;
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let obj2 = Link;
  const keyboardManager = _mod7301.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7301;
  ...
  obj4.children = React4(_mod7303.Card, obj5);
