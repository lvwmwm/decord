...
// Function ID: 7023
// Name: ScrollView
// Dependencies: [32, 109, 19, 17, 21, 6935, 6936, 6955, 6995, 6991]
// Exports: FlatList

// Module 7022 (ScrollView)
...
const jsx = fn(21).jsx;
let closure_11 = module_6935(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6936).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6935(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6936).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6935(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
export const TextInput = module_6935(TextInput);
