...
// Dependencies: [19, 17, 21, 5848, 1489, 7255, 7256]
// Exports: HeaderContainer

// Module 7254 (HeaderContainer)
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_7255").forSlideRight;
                    } else {
                      forSlideUp = require("module_7255").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_7255").forSlideUp;
              }
            } else {
              forNoAnimation = require("module_7255").forNoAnimation;
            }
