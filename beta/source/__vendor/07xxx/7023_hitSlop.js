...
// Function ID: 7024
// Name: hitSlop
// Dependencies: [32, 109, 19, 17, 21, 6928, 6995, 7024, 7025, 7026, 7027, 7028, 7021, 6936, 6934]
// Exports: default
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6995.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
    ...
    onBegin() {
      ...
      if (!ref5.current) {
        if (Platform.isTV) {
          ...
          if (isScreenReaderEnabled) {
            handleEvent(NATIVE_BEGIN, tmp5(7024).viewCenterToPressableEvent(closure_20.current));
            const tmp5Result = tmp5(7024);
          } else {
