...
// Function ID: 7148
// Name: ViewHolder
// Dependencies: [19, 21, 7110, 7143]

// Module 7147 (ViewHolder)
...
export const ViewHolder = noop.memo((index) => {
  ...
  if (inverted) {
    invertedTransformStyle = require("module_7110").getInvertedTransformStyle(horizontal);
    let obj = require("module_7110");
  }
  let str = "column";
  if (horizontal) {
    str = "row";
