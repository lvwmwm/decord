...
// Dependencies: [14524, 14532]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14531 (InsertUnicodeExtensionAndCanonicalize)
import _mod14524 from "module_14524" /* 14524 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14532 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14524.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
