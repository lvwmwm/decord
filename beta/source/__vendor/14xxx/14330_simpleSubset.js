...
// Function ID: 14331
// Name: simpleSubset
// Dependencies: [14317, 14316, 14302, 14319]

// Module 14330 (simpleSubset)
import _mod14302 from "module_14302" /* 14302 */;
import Comparator from "Comparator" /* 14316 */;
...
function simpleSubset(arg0, item10015, includePrerelease) {
  ...
  if (arg0 === item10015) {
    ...
    if (1 === arg0.length) {
      ...
      if (arg0[0].semver === Comparator.ANY) {
        if (1 === item10015.length) {
          if (item10015[0].semver === tmp6(14316).ANY) {
            return true;
          }
        }
      }
    ...
    if (set.size > 1) {
      ...
      if (tmp) {
        if (tmp2) {
          const tmp46 = _mod14302(tmp.semver, tmp2.semver, includePrerelease);
          if (tmp46 > 0) {
            return null;
          } else {
            let tmp39 = tmp46;
...
function higherGT(semver, semver2, includePrerelease) {
  if (semver) {
    const tmp4 = _mod14302(semver.semver, semver2.semver, includePrerelease);
    let tmp5 = semver;
    if (tmp4 <= 0) {
      if (tmp4 < 0) {
        let tmp6 = semver2;
...
export default (arg0, arg1, includePrerelease) => {
  ...
  if (arg0 === arg1) {
    ...
    const tmp22 = new _mod14317(arg0, obj);
    const tmp27 = new _mod14317(arg1, obj);
    let flag = false;
