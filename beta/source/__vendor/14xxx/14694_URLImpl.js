...
// Function ID: 14695
// Name: URLImpl
// Dependencies: [41, 42, 14695, 14699, 14698]

// Module 14694 (URLImpl)
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(14695).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(14695).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(14698).parseUrlencoded(query);
          const tmpResult = tmp(14698);
        }
      }
      const obj = URLImpl(14695);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(14695).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
    ...
    set(arg0) {
      URLImpl(14695).basicURLParse(`${arg0}:`, { url: this._url, stateOverride: "scheme start" });
    }
  },
  {
    key: "username",
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14695).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(14695);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14695).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(14695);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(14695).serializeHost(host);
        const obj3 = URLImpl(14695);
      } else {
        const obj = URLImpl(14695);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(14695).serializeInteger(host.port)}`;
        const obj2 = URLImpl(14695);
      }
    },
    set(arg0) {
      if (!this._url.cannotBeABaseURL) {
        const obj2 = { url: tmp._url, stateOverride: "host" };
        URLImpl(14695).basicURLParse(arg0, obj2);
        const obj = URLImpl(14695);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(14695).serializeHost(tmp._url.host);
        const obj = URLImpl(14695);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(14695).serializeInteger(tmp._url.port);
        const obj = URLImpl(14695);
      }
      return str;
    },
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        URLImpl(14695).basicURLParse(substr, obj2);
        const obj = URLImpl(14695);
        self._query._list = URLImpl(14698).parseUrlencoded(substr);
      }
    }
  },
  {
