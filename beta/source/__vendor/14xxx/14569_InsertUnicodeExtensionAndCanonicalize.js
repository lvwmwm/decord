...
// Dependencies: [14562, 14570]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14569 (InsertUnicodeExtensionAndCanonicalize)
import _mod14562 from "module_14562" /* 14562 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14570 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14562.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
