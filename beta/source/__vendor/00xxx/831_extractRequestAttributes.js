...
// Dependencies: [5, 827, 832, 708, 829, 735, 834, 709, 738, 717]
// Exports: instrumentOpenAiClient

// Module 831 (extractRequestAttributes)
...
import extractRequestParameters from "extractRequestParameters" /* 832 */;
    ...
    if (typeof model[0] === "object") {
      if (null !== model[0]) {
        ...
        if (first.web_search_options) {
          ...
          if (json) {
            obj[tmp(827).GEN_AI_REQUEST_AVAILABLE_TOOLS_ATTRIBUTE] = json;
          }
          const _Object = Object;
          const merged1 = Object.assign(obj, tmp(832).extractRequestParameters(first));
          const tmpResult = tmp(832);
        }
        items2 = [];
      }
      return obj;
...
function addRequestAttributes(setAttribute, input) {
  ...
  if (input) {
    if (0 !== length) {
      const truncatedJsonString = _mod829.getTruncatedJsonString(input);
      ...
      if (length) {
        const attr1 = setAttribute.setAttribute(tmp2(827).GEN_AI_REQUEST_MESSAGES_ORIGINAL_LENGTH_ATTRIBUTE, length);
      }
      tmp2 = require;
    }
  }
                  ...
                  if (0 === c3) {
                    ...
                    if (closure_129_4) {
                      ...
                      obj5.startSpanManual(obj9, (() => {
                        closure_0 = closure_2(/* F153793 */ function() { ... });
                        return () => { ... };
                      })());
                      let obj7 = str(tmp2[2]);
                    }
                    ...
                    obj2.startSpan(obj10, (() => {
                      closure_0 = closure_2(/* F153795 */ function() { ... });
                      return () => { ... };
                    })());
                    let obj4 = str(tmp2[2]);
                  }
