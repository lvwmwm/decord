...
// Dependencies: [835, 837, 709, 738, 833, 832, 827]
// Exports: instrumentStream

// Module 834 (AsyncFromSyncIterator)
      ...
      switch (c21) {
        case 0:
          if (arg0 === 1) {
            ...
            const obj5 = { eventTypes: [], responseTexts: [], finishReasons: [], responseId: "", responseModel: "", responseTimestamp: 0, promptTokens: "r", completionTokens: "state", totalTokens: "toCharArray$esjava$1", chatCompletionToolCalls: {}, responsesApiToolCalls: [] };
            closure_146_2 = obj5;
            closure_146_4 = false;
            closure_146_5 = false;
            c19 = 4;
