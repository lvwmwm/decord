...
function y$1(span, arg1, formTitle) {
  ...
  const element = { type: span, props: obj, key: tmp5, ref: tmp4, __k: null, __: null, __b: 0, __e: null, __d: "Array", __c: "Array", constructor: -1, __v: 0, __i: "isLoadedFromFileSystem", __u: null };
  const sum = sum2 + 1;
  sum2 = sum;
  element.__v = sum;
  if (null != obj.vnode) {
      ...
      if (null != vnodeResult2) {
        ...
        if (typeof vnodeResult2 !== "boolean") {
          ...
          if (typeof vnodeResult2 !== "function") {
                ...
                if (typeof vnodeResult2 !== "bigint") {
                  ...
                  if (vnodeResult2.constructor != String) {
                    if (isArray(vnodeResult2)) {
                      ...
                      let element = { type: g$1, props: obj, key: null, ref: null, __k: null, __: null, __b: 0, __e: null, __d: "Array", __c: "Array", constructor: -1, __v: 0, __i: "isLoadedFromFileSystem", __u: null };
                      let sum = sum2 + 1;
                      sum2 = sum;
                      element.__v = sum;
                      let obj4 = obj;
                      ...
                      if (vnodeResult2.__b > 0) {
                        ...
                        let element1 = { type: type2, props, key: key2, ref, __k: null, __: null, __b: 0, __e: null, __d: "Array", __c: "Array", constructor: -1, __v: 0, __i: "isLoadedFromFileSystem", __u: null };
                        let tmp10 = __v;
                        if (null == __v) {
                          let sum1 = sum2 + 1;
                          sum2 = sum1;
            ...
            let element2 = { type: null, props: vnodeResult2, key: null, ref: null, __k: null, __: null, __b: 0, __e: null, __d: "Array", __c: "Array", constructor: -1, __v: 0, __i: "isLoadedFromFileSystem", __u: null };
...
function Form(onSubmitError) {
  ({ options, defaultEmail, defaultName, onSubmit: f133261, onSubmitSuccess } = onSubmitError);
  ...
  closure_15 = fn2(() => f82052, items);
  f133261 = screenshotInput(function*(arg0, value) {
    if (c6 === 2) {
      c6 = 3;
      ...
      try {
        ...
        if (0 === c5) {
          ...
          if (3 === tmp8) {
            ...
            if (messageLabel) {
              const debug = f133261(onSubmitSuccess[2]).debug;
  ...
  f133261 = function(arg0) {
    const self = this;
    const apply = f133261.apply;
  ...
  obj = { class: "form", onSubmit: tmp13(() => f82052, items1) };
...
function Dialog(onFormSubmitted) {
  ...
  const tmp2 = fn2(() => {
    obj = { __html: null };
    const _document = f82052(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document2 = f82052(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document3 = f82052(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document4 = f82052(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document5 = f82052(merged[2]).GLOBAL_OBJ.document;
    const elementNS4 = _document5.createElementNS("http://www.w3.org/2000/svg", "defs");
    const _document6 = f82052(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document7 = f82052(merged[2]).GLOBAL_OBJ.document;
...
const document = _mod686.GLOBAL_OBJ.document;
const navigator = _mod686.GLOBAL_OBJ.navigator;
let c6 = "Report a Bug";
function sendFeedback(message) {
  ...
  if (message.message) {
    ...
    if (client) {
      ...
      if (length) {
        const currentScope = tmp6(686).getCurrentScope();
        currentScope.setTags(message.tags);
        const tmp6Result = tmp6(686);
      }
      const obj3 = { source: "api", url: null };
      const tmp6Result3 = tmp6(686);
      obj3.url = tmp6(686).getLocationHref();
...
export const buildFeedbackIntegration = (arg0) => {
  ...
  return () => {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (scriptNonce) {
                ...
                closure_129_1 = tmp11();
                _mod686.addIntegration(closure_129_1);
                c3 = 2;
                let tmp36;
                if (closure_129_3) {
                  if (tmp4) {
                ...
                if (closure_129_4) {
                  ...
                  _mod686.addIntegration(closure_129_2);
                }
                c3 = 0;
    ...
    function _createActor(arg0) {
      ...
      const _document2 = _mod686.GLOBAL_OBJ.document;
      const elementNS1 = _document2.createElementNS("http://www.w3.org/2000/svg", "g");
      ...
      const _document3 = _mod686.GLOBAL_OBJ.document;
      const elementNS2 = _document3.createElementNS("http://www.w3.org/2000/svg", "path");
      ...
      const _document4 = _mod686.GLOBAL_OBJ.document;
      const elementNS3 = _document4.createElementNS("http://www.w3.org/2000/svg", "defs");
      const _document5 = _mod686.GLOBAL_OBJ.document;
      ...
      const _document6 = _mod686.GLOBAL_OBJ.document;
    ...
    return {
      name: "Feedback",
      setupOnce() {
        let autoInject = _mod686.isBrowser();
        if (autoInject) {
...
export () => ({
  ...
  createDialog(options) {
    ...
    const currentScope = options(686).getCurrentScope();
    let user = currentScope.getUser();
    obj = options(686);
    const isolationScope = options(686).getIsolationScope();
    const user1 = isolationScope.getUser();
    const obj3 = options(686);
    const globalScope = options(686).getGlobalScope();
                ...
                try {
                  ...
                  if (0 === v2) {
                    if (arg0 === 1) {
                      ...
                      const size = { width: tmp2(686).GLOBAL_OBJ.innerWidth * React, height: tmp2(686).GLOBAL_OBJ.innerHeight * React };
                      obj4.video = size;
                      v2 = 1;
                      c3 = 1;
