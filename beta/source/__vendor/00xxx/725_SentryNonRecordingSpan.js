...
// Dependencies: [41, 42, 698, 688]

// Module 725 (SentryNonRecordingSpan)
...
const entry = {
  ...
  value: function spanContext() {
    return { spanId: this._spanId, traceId: this._traceId, traceFlags: SentryNonRecordingSpan(688).TRACE_FLAG_NONE };
  }
};
const items = [
  entry,
