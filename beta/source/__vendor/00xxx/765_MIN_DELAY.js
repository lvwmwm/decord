...
// Function ID: 766
// Name: MIN_DELAY
// Dependencies: [5, 692, 693, 733, 748]
// Exports: makeOfflineTransport

// Module 765 (MIN_DELAY)
      ...
      if (1 === tmp6) {
        ...
        return {
          value: (function shouldQueue(arg0, arg1, arg2) {
              const result = createStore(733).envelopeContainsItemType(arg0, ["client_report"]);
              let tmp2 = !result;
              if (!result) {
        ...
        if (arg0 === 1) {
          ...
          closure_130_3 = createStore(748).parseRetryAfterHeader(closure_130_2.headers["retry-after"]);
          createStore(748);
        }
      } else if (6 === tmp6) {
        if (arg0 === 1) {
