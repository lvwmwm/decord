...
// Dependencies: [5, 735, 708, 850, 827, 709, 738, 851, 847, 830]
// Exports: instrumentLangGraph, instrumentStateGraphCompile

// Module 849 (instrumentLangGraph)
...
export const instrumentLangGraph = function instrumentLangGraph(compile, arg1) {
  ...
  let proxy = new Proxy(compile.bind(compile), {
    apply(arg0, arg1, arg2) {
      ...
      let obj3 = {};
      obj3[obj(708).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = obj(850).LANGGRAPH_ORIGIN;
      obj3[obj(708).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "gen_ai.create_agent";
      obj3[obj(827).GEN_AI_OPERATION_NAME_ATTRIBUTE] = "create_agent";
            ...
            applyResult.invoke = (function instrumentCompiledGraphInvoke(arg0, applyResult, arg2, arg3) {
              ...
              const proxy = new Proxy(arg0, {
                apply(arg0, arg1, arg2) {
                  ...
                  let obj3 = {};
                  obj3[applyResult(708).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = applyResult(850).LANGGRAPH_ORIGIN;
                  obj3[applyResult(708).SEMANTIC_ATTRIBUTE_SENTRY_OP] = applyResult(827).GEN_AI_INVOKE_AGENT_OPERATION_ATTRIBUTE;
                  obj3[applyResult(827).GEN_AI_OPERATION_NAME_ATTRIBUTE] = "invoke_agent";
                  obj2.attributes = obj3;
                  applyResult = closure_2(/* F154070 */ function() { ... });
                  return applyResult(735).startSpan(obj2, () => { ... });
                }
              });
              return proxy;
