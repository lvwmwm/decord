...
// Dependencies: [5, 827, 829, 708, 839, 738, 709, 735, 841, 736, 717]
// Exports: instrumentAnthropicAiClient

// Module 838 (instrumentAnthropicAiClient)
import SPAN_STATUS_ERROR from "SPAN_STATUS_ERROR" /* 709 */;
import captureCheckIn from "captureCheckIn" /* 738 */;
import messagesFromParams from "messagesFromParams" /* 839 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;

const require = globalThis.__r;

const ANTHROPIC_AI_RESPONSE_TIMESTAMP_ATTRIBUTE = tmp(827);
                                      ...
                                      if (!BooleanResult) {
                                        if (!tmp12) {
                                          ...
                                          return tmp2Result5.startSpan(obj3, (setAttributes) => {
                                            ...
                                            return str(_function[9]).handleCallbackErrors(() => { ... }, () => { ... }, /* F148420 */ function() { ... }, () => { ... });
                                          });
                                        }
                                      }
                                      dependencyMap = arr;
                                            ...
                                            apply(arr, arg1, arg2) {
                                                  ...
                                                  if (arg2.length > 0) {
                                                    if (typeof arg2[0] === "object") {
                                                      ...
                                                      if (BooleanResult) {
                                                        if (!tmp12) {
                                                          closure_0 = _self(/* F152582 */ function() { ... });
