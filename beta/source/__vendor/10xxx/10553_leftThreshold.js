...
// Function ID: 10554
// Name: leftThreshold
// Dependencies: [109, 19, 17, 21, 1641, 10554, 6972, 6904]
// Exports: default

// Module 10553 (leftThreshold)
...
function _default(hitSlop) {
  ...
  let fn2 = function p(arg0, arg1) {
    ...
    if (!tmp2) {
      ...
      if (tmp12) {
        if (arg0 > 0) {
          let RIGHT = _mod10554.SwipeDirection.LEFT;
        } else {
          RIGHT = _mod10554.SwipeDirection.RIGHT;
        }
      ...
      if (arg1 > 0) {
        let LEFT = _mod10554.SwipeDirection.RIGHT;
      } else {
        LEFT = _mod10554.SwipeDirection.LEFT;
      }
