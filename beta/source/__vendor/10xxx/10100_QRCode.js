...
// Function ID: 10101
// Name: QRCode
// Dependencies: [10101, 10105, 10110, 19, 10113]

// Module 10100 (QRCode)
import QRCode_mod from "module_10101" /* 10101 */;
import module_10105_mod from "module_10105" /* 10105 */;
import emptyFunction from "module_10110" /* 10110 */;
import noop_mod from "module_19" /* 19 */;
import QRCodeSvg_mod from "QRCodeSvg" /* 10113 */;
...
QRCode = tmp3;
let module_10105 = module_10105_mod;
if (!module_10105) {
  let obj2 = { default: module_10105 };
  let tmp5 = obj2;
} else {
  tmp5 = module_10105;
}
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const _default1 = new QRCode.default(-1, module_10105.default[level]);
