...
// Function ID: 4638
// Name: registerHost
// Dependencies: [4638, 4633]

// Module 4637 (registerHost)
import ACTIONS from "ACTIONS" /* 4633 */;
import print from "print" /* 4638 */;
...
function reducer(arg0, type) {
  ...
  if (ACTIONS.ACTIONS.REGISTER_HOST === type) {
  ...
  } else if (tmp4(4633).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4633).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4633).ACTIONS.REMOVE_PORTAL === type) {
