...
// Dependencies: [3999, 3845, 3846]
// Exports: default

// Module 4052 (eachHourOfInterval)
      ...
      if (!isNaN(NumberResult)) {
        ...
        if (defaultResult1.getTime() <= time1) {
          do {
            ...
            let defaultResult3 = module_3999.default(defaultResult1, NumberResult);
