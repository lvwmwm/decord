...
// Dependencies: [3849, 4035, 4025, 3850, 4048]
// Exports: default

// Module 4047 (differenceInMonths)
...
if (!module_4048) {
  const obj5 = { default: module_4048 };
  let tmp11 = obj5;
} else {
  tmp11 = module_4048;
}
...
export default function differenceInMonths(date, friendsSince) {
  ...
  if (absolute >= 1) {
    ...
    tmp11 = module_4048.default(_typeof.default(date)) && 1 === absolute && 1 === obj3.default(date, defaultResult2);
  }
  let num4 = 0;
  if (0 !== num) {
    num4 = num;
