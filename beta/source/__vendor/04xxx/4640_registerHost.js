...
// Function ID: 4641
// Name: registerHost
// Dependencies: [4641, 4636]

// Module 4640 (registerHost)
import ACTIONS from "ACTIONS" /* 4636 */;
import print from "print" /* 4641 */;
...
function reducer(arg0, type) {
  ...
  if (ACTIONS.ACTIONS.REGISTER_HOST === type) {
  ...
  } else if (tmp4(4636).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4636).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4636).ACTIONS.REMOVE_PORTAL === type) {
