...
// Function ID: 4673
// Name: registerHost
// Dependencies: [4673, 4668]

// Module 4672 (registerHost)
import ACTIONS from "ACTIONS" /* 4668 */;
import print from "print" /* 4673 */;
...
function reducer(arg0, type) {
  ...
  if (ACTIONS.ACTIONS.REGISTER_HOST === type) {
  ...
  } else if (tmp4(4668).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4668).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4668).ACTIONS.REMOVE_PORTAL === type) {
