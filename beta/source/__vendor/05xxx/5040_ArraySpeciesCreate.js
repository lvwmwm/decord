...
// Dependencies: [1281, 5041, 1282, 5042, 5044, 5050, 5004, 5052]
...
export default function ArraySpeciesCreate(arg0, arg1) {
  if (_mod5041(arg1)) {
    if (arg1 >= 0) {
      if (tmp(5042)(arg0)) {
        const tmp3 = tmp(5050)(arg0, "constructor");
        let tmp5 = closure_2;
        if (closure_2) {
          tmp5 = tmp(5004)(tmp3);
        }
        let tmp6 = tmp3;
        if (tmp5) {
          const tmp7 = tmp(5050)(tmp3, tmp4);
          tmp5 = null === tmp7;
          tmp6 = tmp7;
        }
        if (undefined === tmp6) {
          return tmp(5044)(arg1);
        } else if (tmp(5052)(tmp6)) {
