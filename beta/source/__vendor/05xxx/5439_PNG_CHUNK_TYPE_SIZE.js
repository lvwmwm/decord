...
// Dependencies: [5432, 5435]

// Module 5439 (PNG_CHUNK_TYPE_SIZE)
...
export default {
  isPngFile(dataView) {
    let tmp = dataView;
    if (tmp) {
      tmp = _mod5432.getStringFromDataView(dataView, 0, u0089PNGrnu001An.length) === u0089PNGrnu001An;
    }
    return tmp;
  },
