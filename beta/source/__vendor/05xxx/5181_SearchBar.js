...
// Function ID: 5182
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 5182, 5174]
// Exports: default

// Module 5181 (SearchBar)
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(5182).Commands;
  ...
  if (ref1(5174).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(5174).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(5174);
    obj.hideNavigationBar = tmp3(5174).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
