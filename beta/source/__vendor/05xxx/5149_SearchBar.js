...
// Function ID: 5150
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 5150, 5142]
// Exports: default

// Module 5149 (SearchBar)
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(5150).Commands;
  ...
  if (ref1(5142).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(5142).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(5142);
    obj.hideNavigationBar = tmp3(5142).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
