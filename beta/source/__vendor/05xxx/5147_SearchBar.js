...
// Function ID: 5148
// Name: SearchBar
// Dependencies: [109, 19, 17, 21, 5148, 5140]
// Exports: default

// Module 5147 (SearchBar)
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref1(5148).Commands;
  ...
  if (ref1(5140).isSearchBarAvailableForCurrentPlatform) {
    ...
    obj.obscureBackground = tmp3(5140).parseBooleanToOptionalBooleanNativeProp(obscureBackground);
    const tmp3Result = tmp3(5140);
    obj.hideNavigationBar = tmp3(5140).parseBooleanToOptionalBooleanNativeProp(hideNavigationBar);
