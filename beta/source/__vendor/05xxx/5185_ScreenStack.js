...
// Function ID: 5186
// Name: ScreenStack
// Dependencies: [109, 19, 21, 5186, 5187, 5188]
// Exports: default

// Module 5185 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_mod5187.GHContext);
  ...
  _modDef5186("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  _modDef5186(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  return jsx(_mod5187.RNSScreensRefContext.Provider, { value: ref, children: null });
};
