...
// Function ID: 5154
// Name: ScreenStack
// Dependencies: [109, 19, 21, 5154, 5155, 5156]
// Exports: default

// Module 5153 (ScreenStack)
...
export default function ScreenStack(arg0) {
  ...
  const context = obj.useContext(_mod5155.GHContext);
  ...
  _modDef5154("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  _modDef5154(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  return jsx(_mod5155.RNSScreensRefContext.Provider, { value: ref, children: null });
};
