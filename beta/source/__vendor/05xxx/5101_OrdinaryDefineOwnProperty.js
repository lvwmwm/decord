...
// Dependencies: [5038, 1286, 5085, 5089, 1287, 5102, 1307, 5094, 5090, 5103, 5104]

// Module 5101 (OrdinaryDefineOwnProperty)
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod5038(arg0)) {
    if (tmp(5085)(arg1)) {
      if (tmp(5089)(__Writable__)) {
        if (tmp(1287)) {
          const tmp30 = tmp(1287)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(5090)(tmp30);
          }
          return tmp(5104)(arg0, arg1, tmp(5103)(arg0), __Writable__, tmp31);
        } else if (tmp(5102)(__Writable__)) {
          ...
          return tmp(5094)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
