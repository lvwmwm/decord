...
// Dependencies: [109, 19, 17, 21, 1641, 5167, 1619, 16276, 16277]

// Module 16275 (ReanimatedNativeStackScreen)
...
const jsx = fn(21).jsx;
let closure_7 = cancelAnimation.createAnimatedComponent(fn(5167).InnerScreen);
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  const safeAreaFrame = _mod1619.useSafeAreaFrame();
  let y = _mod1619.useSafeAreaInsets().top;
  ...
  const obj4 = { value: sharedValue, children: jsx(_modDef16277.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) };
  obj3.children = jsx(_modDef16276.Provider, { value: sharedValue, children: jsx(_modDef16277.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) });
