...
// Function ID: 13103
// Name: SessionFlusher
// Dependencies: [41, 42, 13055, 13076]

// Module 13102 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(13055).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(13076).getIsolationScope();
        ...
        const obj = SessionFlusher(13076);
      }
    }
  },
  {
