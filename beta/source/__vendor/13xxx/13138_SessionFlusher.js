...
// Function ID: 13139
// Name: SessionFlusher
// Dependencies: [41, 42, 13091, 13112]

// Module 13138 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(13091).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(13112).getIsolationScope();
        ...
        const obj = SessionFlusher(13112);
      }
    }
  },
  {
