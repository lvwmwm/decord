...
// Dependencies: [13075, 13056, 13055, 13086]
...
export const applyScopeDataToEvent = function applyScopeDataToEvent(extra, arg1) {
  ...
  if (span) {
    const obj6 = { trace: tmp3(13055).spanToTraceContext(span) };
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj6;
    const obj7 = { dynamicSamplingContext: null };
    const tmp3Result9 = tmp3(13055);
    obj7.dynamicSamplingContext = tmp3(13086).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj7;
    const tmp3Result10 = tmp3(13086);
    const rootSpan = tmp3(13055).getRootSpan(span);
    const tmp3Result11 = tmp3(13055);
    const description = tmp3(13055).spanToJSON(rootSpan).description;
