...
export const applyScopeDataToEvent = function applyScopeDataToEvent(extra, arg1) {
  ...
  const dropUndefinedKeysResult = _mod13091.dropUndefinedKeys(extra);
  ...
  const dropUndefinedKeysResult1 = _mod13091.dropUndefinedKeys(tags);
  ...
  const tmp3Result = _mod13091;
  const dropUndefinedKeysResult2 = _mod13091.dropUndefinedKeys(user);
  ...
  const tmp3Result7 = _mod13091;
  const dropUndefinedKeysResult3 = _mod13091.dropUndefinedKeys(contexts);
  ...
  if (span) {
    const obj6 = { trace: tmp3(13090).spanToTraceContext(span) };
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj6;
    const obj7 = { dynamicSamplingContext: null };
    const tmp3Result9 = tmp3(13090);
    obj7.dynamicSamplingContext = tmp3(13121).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj7;
    const tmp3Result10 = tmp3(13121);
    const rootSpan = tmp3(13090).getRootSpan(span);
    const tmp3Result11 = tmp3(13090);
    const description = tmp3(13090).spanToJSON(rootSpan).description;
...
export const mergeAndOverwriteScopeData = function mergeAndOverwriteScopeData(arg0, arg1, arg2) {
  arg0[arg1] = _mod13110.merge(arg0[arg1], arg2, 1);
};
export const mergeScopeData = function mergeScopeData(extra, arg1) {
  ...
  extra.extra = _mod13110.merge(extra.extra, extra, 1);
  extra.tags = _mod13110.merge(extra.tags, tags, 1);
  extra.user = _mod13110.merge(extra.user, user, 1);
  extra.contexts = _mod13110.merge(extra.contexts, contexts, 1);
  extra.sdkProcessingMetadata = _mod13110.merge(extra.sdkProcessingMetadata, sdkProcessingMetadata, 2);
  if (level) {
    extra.level = level;
  }
  if (transactionName) {
