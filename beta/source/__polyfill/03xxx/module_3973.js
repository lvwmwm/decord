...
if (!module_3975) {
  const obj2 = { default: module_3975 };
  let tmp5 = obj2;
} else {
  tmp5 = module_3975;
}
if (!module_3976) {
  const obj3 = { default: module_3976 };
  let tmp7 = obj3;
} else {
  tmp7 = module_3976;
}
