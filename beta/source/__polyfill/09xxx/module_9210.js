...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.core = fn(require("module_9211"));
    fn2(_mod9277, exports);
    fn2(lt, exports);
    fn2(_mod9281, exports);
    fn2(_mod9280, exports);
    fn2(_mod9282, exports);
    require("module_9211").config(fn3(_mod9230).default());
    const _Object4 = Object;
    let obj = {
      enumerable: true,
      get() {
            return require("module_9211").globalRegistry;
          }
    };
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_9211").registry;
          }
    };
    ...
    const obj4 = {
      enumerable: true,
      get() {
            return require("module_9211").$output;
          }
    };
    ...
    const obj5 = {
      enumerable: true,
      get() {
            return require("module_9211").$input;
          }
    };
    ...
    const obj7 = {
      enumerable: true,
      get() {
            return require("module_9211").clone;
          }
    };
    ...
    const obj8 = {
      enumerable: true,
      get() {
            return require("module_9211").regexes;
          }
    };
    ...
    const obj9 = {
      enumerable: true,
      get() {
            return require("module_9211").treeifyError;
          }
    };
    ...
    const obj10 = {
      enumerable: true,
      get() {
            return require("module_9211").prettifyError;
          }
    };
    ...
    const obj11 = {
      enumerable: true,
      get() {
            return require("module_9211").formatError;
          }
    };
    ...
    const obj12 = {
      enumerable: true,
      get() {
            return require("module_9211").flattenError;
          }
    };
    ...
    const obj13 = {
      enumerable: true,
      get() {
            return require("module_9211").TimePrecision;
          }
    };
    ...
    const obj14 = {
      enumerable: true,
      get() {
            return require("module_9211").util;
          }
    };
    ...
    const obj15 = {
      enumerable: true,
      get() {
            return require("module_9211").NEVER;
          }
    };
    ...
    const obj18 = {
      enumerable: true,
      get() {
            return require("module_9279").ZodISODateTime;
          }
    };
    ...
    const obj19 = {
      enumerable: true,
      get() {
            return require("module_9279").ZodISODate;
          }
    };
    ...
    const obj20 = {
      enumerable: true,
      get() {
            return require("module_9279").ZodISOTime;
          }
    };
    ...
    const obj21 = {
      enumerable: true,
      get() {
            return require("module_9279").ZodISODuration;
          }
    };
    Object.defineProperty(exports, "ZodISODuration", obj21);
    exports.iso = fn(require("module_9279"));
    exports.coerce = fn(_mod9284);
  } else {
