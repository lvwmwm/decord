// Module ID: 7077
// Function ID: 7078
// Dependencies: [19, 21, 6900, 1641, 6896, 6906]
// Exports: default
...
export default function _default(children) {
  ...
  if (useGestureEventsHandlersDefault === undefined) {
    useGestureEventsHandlersDefault = _mod6900.useGestureEventsHandlersDefault;
  }
  ...
  const gestureHandler = _mod6900.useGestureHandler(value2.GESTURE_SOURCE.CONTENT, animatedContentGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
  const gestureHandler1 = _mod6900.useGestureHandler(value2.GESTURE_SOURCE.HANDLE, animatedHandleGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
