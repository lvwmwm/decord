// Module ID: 7006
// Function ID: 7007
// Dependencies: [19, 6945, 6928, 7007, 6991, 6967, 6954, 6927]
// Exports: useGesture
...
export const useGesture = function useGesture(Fling, clonedAndRemappedConfig) {
  ...
  if (clonedAndRemappedConfig.disableReanimated !== jsEventHandler(() => config.disableReanimated, [])) {
    ...
    const gestureCallbacks = require("module_7007").useGestureCallbacks(tmp2, clonedAndRemappedConfig);
    ...
    handlerTag(() => {
      ...
      return () => {
        closure_0(6991).unbindSharedValues(dependencyMap, handlerTag);
        const obj = closure_0(6991);
        closure_0(6927).unregisterGesture(handlerTag);
      };
    }, items3);
    return tmpResult2;
  }
