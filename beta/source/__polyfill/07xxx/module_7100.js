// Module ID: 7100
// Function ID: 7101
// Dependencies: [32, 109, 19, 21, 7101, 6900, 4664, 7102, 6912, 6897]

// Module 7100
import normalizeSnapPoint from "normalizeSnapPoint" /* 6912 */;
import id from "id" /* 7102 */;
...
const memoResult = memo(forwardRef(function BottomSheetModalComponent(name, arg1) {
  ...
  closure_9 = tmp9[1];
  const bottomSheetModalInternal = require("module_6900").useBottomSheetModalInternal();
