// Module ID: 7068
// Function ID: 7069
// Dependencies: [32, 109, 19, 21, 7069, 6868, 4632, 7070, 6880, 6865]

// Module 7068
import normalizeSnapPoint from "normalizeSnapPoint" /* 6880 */;
import id from "id" /* 7070 */;
...
let noop = noop_mod;
const jsx = fn(21).jsx;
let closure_14 = { mount: false, data: "Set" };
const memoResult = memo(forwardRef(function BottomSheetModalComponent(name, arg1) {
  ...
  closure_9 = tmp9[1];
  const bottomSheetModalInternal = require("module_6868").useBottomSheetModalInternal();
