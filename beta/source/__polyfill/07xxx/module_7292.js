// Module ID: 7292
// Function ID: 7293
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 7293, 7295, 5880, 7297, 7299, 7300, 7309, 7310]
...
let obj = { default: fn(7293).DefaultTransition, fade: fn(7293).ModalFadeTransition, fade_from_bottom: fn(7293).FadeFromBottomAndroid, fade_from_right: fn(7293).FadeFromRightAndroid, none: fn(7293).DefaultTransition, reveal_from_bottom: fn(7293).RevealFromBottomAndroid, scale_from_center: fn(7293).ScaleFromCenterAndroid, slide_from_left: fn(7293).SlideFromLeftIOS, slide_from_right: fn(7293).SlideFromRightIOS, slide_from_bottom: fn(7293).BottomSheetAndroid };
...
function getDistanceFromOptions(size, gestureDirection, arg2) {
  ...
  if (gestureDirection1) {
    return CardStack(7297).getDistanceForDirection(size, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(7293).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(7293).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
    ...
    return tmp3(7297).getDistanceForDirection(size, gestureDirection, arg2);
  }
}
...
const entry = {
  ...
  value: function render() {
    ...
    obj4.children = items3.map((key, index) => {
      ...
      options = tmp2.descriptor.options;
        ...
        if (typeof getIsModal === "function") {
          ...
          if (!tmp16) {
            ...
            if (typeof getIsModalPresentation === "function") {
              let tmp20 = cardStyleInterpolator === CardStack(7295).forModalPresentationIOS;
              if (!tmp20) {
                tmp20 = "forModalPresentationIOS" === cardStyleInterpolator.name;
              }
              if (tmp20) {
          ...
          obj.children = closure_2_8(CardStack(7300).CardContainer, obj3);
          return closure_2_8(CardStack(7299).MaybeScreen, obj, key.key);
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      } else {
    ...
    items2[1] = renderHeader(CardStack(7299).MaybeScreenContainer, obj4);
    obj.children = items2;
...
const entry1 = {
  ...
  value: function getDerivedStateFromProps(routes, routes2) {
    ...
    const modalRouteKeys = CardStack(7309).getModalRouteKeys(items1, {});
      ...
      if (tmp8) {
        ...
        if (index !== arg2.length - 1) {
          ...
          if ("default" !== str2) {
            ...
            ModalTransition = CardStack(7293).ModalFadeTransition;
          } else {
            if ("modal" !== options.presentation) {
              if (!hasItem1) {
                ModalTransition = CardStack(7293).DefaultTransition;
              }
            }
            ModalTransition = CardStack(7293).ModalTransition;
          }
          ...
          if (undefined !== cardStyleInterpolator) {
            ...
            if (undefined === cardOverlayEnabled) {
              ...
              if (!tmp38) {
                if (typeof getIsModalPresentation === "function") {
                  let tmp42 = cardStyleInterpolator === CardStack(7295).forModalPresentationIOS;
                  if (!tmp42) {
            ...
            if (str10 == null) {
              ...
              if (tmp43) {
                if (typeof getIsModalPresentation === "function") {
                  str10 = "screen";
                  if (cardStyleInterpolator !== CardStack(7295).forModalPresentationIOS) {
            ...
            forNoAnimation = CardStack(7295).forNoAnimation;
          }
    ...
    if (routes.routes.length !== routes2.routes.length) {
      ...
      if (0 <= diff) {
        while (true) {
          options = mapped[diff].descriptor.options;
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 = cardStyleInterpolator === CardStack(7295).forModalPresentationIOS || "forModalPresentationIOS" === cardStyleInterpolator.name;
                let tmp10 = !tmp9;
                if (tmp9) {
                  let tmp7Result = tmp7(7310);
