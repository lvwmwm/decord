// Module ID: 7045
// Function ID: 7046
// Dependencies: [19, 21, 6868, 1641, 6864, 6874]
// Exports: default
...
export default function _default(children) {
  ...
  if (useGestureEventsHandlersDefault === undefined) {
    useGestureEventsHandlersDefault = _mod6868.useGestureEventsHandlersDefault;
  }
  ...
  const gestureHandler = _mod6868.useGestureHandler(value2.GESTURE_SOURCE.CONTENT, animatedContentGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
  const gestureHandler1 = _mod6868.useGestureHandler(value2.GESTURE_SOURCE.HANDLE, animatedHandleGestureState, sharedValue, handleOnStart, handleOnChange, handleOnEnd, handleOnFinalize);
