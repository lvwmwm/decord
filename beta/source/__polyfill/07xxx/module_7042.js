// Module ID: 7042
// Function ID: 7043
// Dependencies: [32, 109, 19, 17, 21, 6928, 7024, 7025, 7026, 7027, 7043, 7021, 6946, 7019]
// Exports: default

// Module 7042
import tagMessage2 from "tagMessage" /* 6928 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 7024 */;
import StateMachineEvent2 from "StateMachineEvent" /* 7027 */;
import GestureObjects2 from "GestureObjects" /* 7043 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(arg0) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(7024).gestureToPressableEvent(arg0));
        let obj = hitSlop(7024);
      }
    };
