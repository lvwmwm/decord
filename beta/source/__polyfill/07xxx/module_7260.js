// Module ID: 7260
// Function ID: 7261
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 7261, 7263, 5848, 7265, 7267, 7268, 7277, 7278]
...
let obj = { default: fn(7261).DefaultTransition, fade: fn(7261).ModalFadeTransition, fade_from_bottom: fn(7261).FadeFromBottomAndroid, fade_from_right: fn(7261).FadeFromRightAndroid, none: fn(7261).DefaultTransition, reveal_from_bottom: fn(7261).RevealFromBottomAndroid, scale_from_center: fn(7261).ScaleFromCenterAndroid, slide_from_left: fn(7261).SlideFromLeftIOS, slide_from_right: fn(7261).SlideFromRightIOS, slide_from_bottom: fn(7261).BottomSheetAndroid };
...
function getDistanceFromOptions(size, gestureDirection, arg2) {
  ...
  if (gestureDirection1) {
    return CardStack(7265).getDistanceForDirection(size, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(7261).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(7261).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
    ...
    return tmp3(7265).getDistanceForDirection(size, gestureDirection, arg2);
  }
}
...
const entry = {
  ...
  value: function render() {
        ...
        if (typeof getIsModal === "function") {
          ...
          if (!tmp16) {
            ...
            if (typeof getIsModalPresentation === "function") {
              let tmp20 = cardStyleInterpolator === CardStack(7263).forModalPresentationIOS;
              if (!tmp20) {
                tmp20 = "forModalPresentationIOS" === cardStyleInterpolator.name;
              }
              if (tmp20) {
          ...
          obj.children = closure_2_8(CardStack(7268).CardContainer, obj3);
          return closure_2_8(CardStack(7267).MaybeScreen, obj, key.key);
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      } else {
    ...
    items2[1] = renderHeader(CardStack(7267).MaybeScreenContainer, obj4);
    obj.children = items2;
...
const entry1 = {
  ...
  value: function getDerivedStateFromProps(routes, routes2) {
    ...
    const modalRouteKeys = CardStack(7277).getModalRouteKeys(items1, {});
      ...
      if (tmp8) {
        ...
        if (index !== arg2.length - 1) {
          ...
          if ("default" !== str2) {
            ...
            ModalTransition = CardStack(7261).ModalFadeTransition;
          } else {
            if ("modal" !== options.presentation) {
              if (!hasItem1) {
                ModalTransition = CardStack(7261).DefaultTransition;
              }
            }
            ModalTransition = CardStack(7261).ModalTransition;
          }
          ...
          if (undefined !== cardStyleInterpolator) {
            ...
            if (undefined === cardOverlayEnabled) {
              ...
              if (!tmp38) {
                if (typeof getIsModalPresentation === "function") {
                  let tmp42 = cardStyleInterpolator === CardStack(7263).forModalPresentationIOS;
                  if (!tmp42) {
            ...
            if (str10 == null) {
              ...
              if (tmp43) {
                if (typeof getIsModalPresentation === "function") {
                  str10 = "screen";
                  if (cardStyleInterpolator !== CardStack(7263).forModalPresentationIOS) {
            ...
            forNoAnimation = CardStack(7263).forNoAnimation;
          }
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 = cardStyleInterpolator === CardStack(7263).forModalPresentationIOS || "forModalPresentationIOS" === cardStyleInterpolator.name;
                let tmp10 = !tmp9;
                if (tmp9) {
                  let tmp7Result = tmp7(7278);
