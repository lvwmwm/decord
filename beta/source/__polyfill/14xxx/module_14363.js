// Module ID: 14363
// Function ID: 14364
// Dependencies: [14326, 14355, 14346, 14351, 14347, 14350, 14357, 14354]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14326")(arg0, arg3);
  const tmp4 = new require("module_14355")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14346);
    let tmpResult = tmp(14351);
    const tmpResult3 = tmp(14347);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14347);
      tmpResult = tmp(14350);
      tmpResult4 = tmp(14346);
  ...
  if (require("module_14357")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
