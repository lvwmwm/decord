// Module ID: 14554
// Function ID: 14555
// Dependencies: [14555, 14556, 1165, 14557, 14558]
...
import calendars from "calendars" /* 14555 */;
import hourCycles from "hourCycles" /* 14556 */;
import timezones from "timezones" /* 14557 */;
import weekData from "weekData" /* 14558 */;
...
export const getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = hourCycles.hourCycles[formatted] || tmp2(14556).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
    v001 = tmp2(14556).hourCycles["".concat("", formatted, "-001")];
  }
  if (!v001) {
    v001 = tmp2(14556).hourCycles["001"];
  }
...
export const getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  if (timezones.timezones[formatted]) {
    return tmp2(1165).__spreadArray(items, tmp2(14557).timezones[formatted], true);
  } else {
    return items;
  }
};
