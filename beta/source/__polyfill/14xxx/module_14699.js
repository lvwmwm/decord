// Module ID: 14699
// Function ID: 14700
// Dependencies: [41, 42, 32, 14693, 14700, 14701]

// Module 14699
import _mod14693 from "module_14693" /* 14693 */;
import URLSearchParamsImpl from "URLSearchParamsImpl" /* 14700 */;
...
let obj = {
  next: {
    value: function next() {
      const tmp3 = this[_mod14693.iterInternalSymbol];
      ({ kind, index } = tmp3);
      const arr = Array.from(tmp3.target[_mod14693.implSymbol]);
      if (index >= arr.length) {
        return { value: "IconComponent", done: null };
      } else {
        tmp3.index = index + 1;
        [tmp7, tmp8] = arr[index].map(_mod14693.tryWrapperForImpl);
        if ("key" === kind) {
          let tmp4 = tmp7;
        } else if ("value" === kind) {
          tmp4 = tmp8;
...
let closure_6 = Object.create(_mod14693.IteratorPrototype, obj);
let obj2 = {
  _mixedIntoPredicates: [],
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, _mod14693.implSymbol)) {
        if (arg0[tmp(undefined, 14693).implSymbol] instanceof tmp(14700).implementation) {
          return true;
        }
      }
  ...
  createDefaultIterator(self, key) {
    ...
    Object.defineProperty(obj2, _mod14693.iterInternalSymbol, obj);
    return obj2;
  },
  create(arg0, arg1, arg2) {
    if (undefined === arg0[_mod14693.ctorRegistrySymbol]) {
      ...
      const _URLSearchParams = arg0[_mod14693.ctorRegistrySymbol].URLSearchParams;
  ...
  createImpl(arg0, arg1, arg2) {
    ...
    return _mod14693.implForWrapper(obj2);
  },
  _internalSetup(arg0) {
  ...
  setup(wrapper, arg1) {
    ...
    if (URLSearchParamsImpl.init) {
      tmp2(14700).init(wrapper[tmp2(undefined, 14693).implSymbol], obj);
      const tmp2Result = tmp2(14700);
    }
    return wrapper;
  },
  install(arg0) {
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(URLSearchParams(14701).USVString(arguments[0], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 1" }));
              const obj = URLSearchParams(14701);
              items.push(URLSearchParams(14701).USVString(arguments[1], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 2" }));
              const tmp12 = self[URLSearchParams(undefined, 14693).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(14701).USVString(arguments[0], { context: "Failed to execute 'delete' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 14693).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(14701).USVString(arguments[0], { context: "Failed to execute 'get' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 14693).implSymbol];
                const get = tmp6.get;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(14701).USVString(arguments[0], { context: "Failed to execute 'getAll' on 'URLSearchParams': parameter 1" }));
                const obj = URLSearchParams(14701);
                const tmp11 = self[URLSearchParams(undefined, 14693).implSymbol];
                const getAll = tmp11.getAll;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return URLSearchParams(14693).tryWrapperForImpl(HermesBuiltin.apply(items1, tmp11));
              }
            }
          }
          const typeError1 = new TypeError("Illegal invocation");
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(14701).USVString(arguments[0], { context: "Failed to execute 'has' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 14693).implSymbol];
                const has = tmp6.has;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 2) {
                ...
                const items = [];
                items.push(URLSearchParams(14701).USVString(arguments[0], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 1" }));
                const obj = URLSearchParams(14701);
                items.push(URLSearchParams(14701).USVString(arguments[1], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 2" }));
                const tmp12 = self[URLSearchParams(undefined, 14693).implSymbol];
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return HermesBuiltin.apply(items1, tmp12);
      ...
      },
      {
        ...
        value: function sort() {
          ...
          if (this) {
            const _exports = module.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 14693).implSymbol].sort();
            }
          }
      ...
      },
      {
        ...
        value: function toString() {
          ...
          if (this) {
            const _exports = module.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 14693).implSymbol].toString();
            }
          }
          const typeError = new TypeError("Illegal invocation");
          throw typeError;
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const _Array2 = Array;
                const arr2 = Array.from(self[URLSearchParams(undefined, 14693).implSymbol]);
                let num2 = 0;
                let tmp11 = arr2;
                if (0 < arr2.length) {
                  do {
                    ...
                    let tmp6 = _slicedToArray(arr.map(URLSearchParams(14693).tryWrapperForImpl), 2);
                    [tmp7, tmp8] = tmp6;
                    call = call.call;
                    ...
                    let _Array = Array;
                    arr3 = Array.from(self[tmp3(undefined, 14693).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr3;
    ...
    if (undefined === arg0[URLSearchParams(undefined, 14693).ctorRegistrySymbol]) {
      let _Object = Object;
    ...
    arg0[URLSearchParams(undefined, 14693).ctorRegistrySymbol].URLSearchParams = tmp;
