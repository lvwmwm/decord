// Module ID: 14524
// Function ID: 14525
// Dependencies: [14525, 1165, 14526]
// Exports: findBestMatch, invariant

// Module 14524
import e from "e" /* 1165 */;
import data from "data" /* 14525 */;
import regions from "regions" /* 14526 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14525).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14525).data.supplemental.languageMatching["written-new"];
