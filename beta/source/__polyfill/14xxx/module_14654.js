// Module ID: 14654
// Function ID: 14655
// Dependencies: [14655, 14656, 1252, 14657]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14657.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14657.percentDecode(_Buffer.from(buffer));
  }
}
