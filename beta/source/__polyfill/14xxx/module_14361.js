// Module ID: 14361
// Function ID: 14362
// Dependencies: [14355, 14326, 14346]
...
export default (arg0, arg1) => {
  obj = new obj(14355)(arg0, arg1);
  const tmp3 = new obj(14326)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14326)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14326(semver.semver.version);
