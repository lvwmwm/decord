// Module ID: 14315
// Function ID: 14316
// Dependencies: [14288, 14292, 14287]
...
export default (num, arg1) => {
  if (num instanceof _mod14288) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(14292).safeRe;
        const t2 = tmp(14292).t;
      ...
      if (null === match2) {
        ...
        return _mod14287("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
