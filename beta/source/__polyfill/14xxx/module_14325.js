// Module ID: 14325
// Function ID: 14326
// Dependencies: [14288, 14317, 14308, 14313, 14309, 14312, 14319, 14316]
...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  const tmp3 = new require("module_14288")(arg0, arg3);
  const tmp4 = new require("module_14317")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14308);
    let tmpResult = tmp(14313);
    const tmpResult3 = tmp(14309);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14309);
      tmpResult = tmp(14312);
      tmpResult4 = tmp(14308);
  ...
  if (require("module_14319")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
