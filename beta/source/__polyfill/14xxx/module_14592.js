// Module ID: 14592
// Function ID: 14593
// Dependencies: [14593, 14594, 1165, 14595, 14596]
...
import calendars from "calendars" /* 14593 */;
import hourCycles from "hourCycles" /* 14594 */;
import timezones from "timezones" /* 14595 */;
import weekData from "weekData" /* 14596 */;
...
export const getHourCyclesPreferenceDataForLocaleOrRegion = function getHourCyclesPreferenceDataForLocaleOrRegion(locale, region) {
  ...
  let v001 = hourCycles.hourCycles[formatted] || tmp2(14594).hourCycles[str];
  if (!v001) {
    const concat = "".concat;
    v001 = tmp2(14594).hourCycles["".concat("", formatted, "-001")];
  }
  if (!v001) {
    v001 = tmp2(14594).hourCycles["001"];
  }
...
export const getTimeZonePreferenceForRegion = function getTimeZonePreferenceForRegion(region) {
  ...
  if (timezones.timezones[formatted]) {
    return tmp2(1165).__spreadArray(items, tmp2(14595).timezones[formatted], true);
  } else {
    return items;
  }
};
