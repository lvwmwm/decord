// Module ID: 14481
// Function ID: 14482
// Dependencies: [1165, 14482, 14483, 14547, 14554, 14559, 14574, 14575]
...
function addLikelySubtags(arr3) {
  const parseUnicodeLocaleIdResult = _mod14547.parseUnicodeLocaleId(arr3);
  ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
  if (script) {
    if (region) {
      const obj = { lang, script, region, variants: [] };
      const tmp4 = tmp(14547).likelySubtags[tmp(undefined, 14547).emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = tmp(14547).parseUnicodeLanguageId(tmp4);
  ...
  if (script) {
    ...
    const tmp5 = tmp(14547).likelySubtags[tmp(undefined, 14547).emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = tmp(14547).parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = tmp(14547).likelySubtags[tmp(undefined, 14547).emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = tmp(14547).parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = tmp(14547).likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = tmp(14547).likelySubtags[tmp(undefined, 14547).emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = tmp(14547).parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
...
const module_14482 = e.__importDefault(_mod14482);
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(14547).emitUnicodeLanguageId(obj.__assign(Locale(1165).__assign({}, Locale(14547).parseUnicodeLanguageId(tmp2)), obj3));
            const parseUnicodeLocaleIdResult = Locale(14547).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            const obj4 = { lang, variants: [] };
            if (tmp(Locale(14547).emitUnicodeLanguageId(obj4)) === result) {
              ...
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (tmp(tmp3(14547).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = tmp3(14547).emitUnicodeLocaleId(tmp3Result7.__assign(tmp3(1165).__assign({}, parseUnicodeLocaleIdResult), obj8));
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (tmp(tmp3(14547).emitUnicodeLanguageId(obj10)) === result) {
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = tmp3(14547).emitUnicodeLocaleId(tmp3Result9.__assign(tmp3(1165).__assign({}, parseUnicodeLocaleIdResult), obj11));
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(14547).emitUnicodeLanguageId(Locale(14547).parseUnicodeLanguageId(module_14482.default(this).locale));
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "calendar", {
    get() {
      return module_14482.default(this).calendar;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "collation", {
    get() {
      return module_14482.default(this).collation;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "caseFirst", {
    get() {
      return module_14482.default(this).caseFirst;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numeric", {
    get() {
      return module_14482.default(this).numeric;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "numberingSystem", {
    get() {
      return module_14482.default(this).numberingSystem;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(14547).parseUnicodeLanguageId(module_14482.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(14547).parseUnicodeLanguageId(module_14482.default(this).locale).script;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(14547).parseUnicodeLanguageId(module_14482.default(this).locale).region;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      const defaultResult = module_14482.default(this);
      if (Locale(14483).HasOwnProperty(defaultResult, "initializedLocale")) {
