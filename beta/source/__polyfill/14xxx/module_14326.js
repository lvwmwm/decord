// Module ID: 14326
// Function ID: 14327
// Dependencies: [41, 42, 14327, 14328, 14329, 14330, 14331]
...
let items = [
  ...
  },
  {
    ...
    value: function compare(tmp2Result) {
      const self = this;
      SemVer(14329)("SemVer.compare", this.version, this.options, tmp2Result);
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      let compareIdentifiersResult = SemVer(14331).compareIdentifiers(self.major, tmpResult.major);
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14331).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = tmp3(14331);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14331).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = tmp3(14331);
      }
  ...
  },
  {
    ...
    value: function comparePre(tmp2Result) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14329)("prerelease compare", num3, tmp3, tmp4);
  ...
  },
  {
    ...
    value: function compareBuild(arg0) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14329)("build compare", num, tmp3, tmp4);
        let tmp11 = undefined === tmp3;
        if (tmp11) {
          if (undefined === tmp4) {
            break;
