// Module ID: 14657
// Function ID: 14658
// Dependencies: [14658, 14659, 1256, 14660]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14660.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14660.percentDecode(_Buffer.from(buffer));
  }
}
