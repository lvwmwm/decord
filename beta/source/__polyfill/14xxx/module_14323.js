// Module ID: 14323
// Function ID: 14324
// Dependencies: [14317, 14288, 14308]
...
export default (arg0, arg1) => {
  obj = new obj(14317)(arg0, arg1);
  const tmp3 = new obj(14288)("0.0.0");
  if (obj.test(tmp3)) {
    return tmp3;
  } else {
    const tmp6 = new tmp(14288)("0.0.0-0");
    if (obj.test(tmp6)) {
      return tmp6;
    } else {
      let num = 0;
      ...
      if (0 < obj.set.length) {
        do {
          ...
          let item = arr.forEach((semver) => {
            obj = new _mod14288(semver.semver.version);
