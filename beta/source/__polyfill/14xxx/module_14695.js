// Module ID: 14695
// Function ID: 14696
// Dependencies: [14696, 14697, 1256, 14698]
...
function parseHost(buffer, arg1) {
  if ("[" === buffer[0]) {
    ...
    let str1 = _mod14698.percentDecode(_Buffer.from(buffer)).toString();
    if (null === str1) {
      str1 = closure_4;
    }
    if (str1 === closure_4) {
    ...
    const str = _mod14698.percentDecode(_Buffer.from(buffer));
  }
}
