// Module ID: 14562
// Function ID: 14563
// Dependencies: [14563, 1165, 14564]
// Exports: findBestMatch, invariant

// Module 14562
import e from "e" /* 1165 */;
import data from "data" /* 14563 */;
import regions from "regions" /* 14564 */;
...
function findMatchingDistance(arg0, matchedSupportedLocale) {
  ...
  if (!obj3) {
    ...
    const prop = tmp4(14563).data.supplemental.languageMatching["written-new"];
    let substr = prop.slice(1, 5);
    const prop1 = tmp4(14563).data.supplemental.languageMatching["written-new"];
