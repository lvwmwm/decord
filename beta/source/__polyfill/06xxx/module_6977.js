// Module ID: 6977
// Function ID: 6978
// Dependencies: [41, 42, 93, 95, 98, 19, 6928, 6966]
...
const entry = {
  ...
  value: function render() {
    try {
      ...
      const _Error = Error;
      const error = new Error(Wrap(6928).tagMessage("GestureDetector got more than one view as a child. If you want the gesture to work on multiple views, wrap them with a common parent and attach the gesture to that view."));
      throw error;
    }
  }
};
