// Module ID: 6974
// Function ID: 6975
// Dependencies: [19, 6913, 6896, 6975, 6959, 6935, 6922, 6895]
// Exports: useGesture
...
export const useGesture = function useGesture(Fling, clonedAndRemappedConfig) {
  ...
  if (clonedAndRemappedConfig.disableReanimated !== jsEventHandler(() => config.disableReanimated, [])) {
    ...
    const gestureCallbacks = require("module_6975").useGestureCallbacks(tmp2, clonedAndRemappedConfig);
    ...
    handlerTag(() => {
      ...
      return () => {
        closure_0(6959).unbindSharedValues(dependencyMap, handlerTag);
        const obj = closure_0(6959);
        closure_0(6895).unregisterGesture(handlerTag);
      };
    }, items3);
    return tmpResult2;
  }
