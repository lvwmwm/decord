...
wrappedSetGestureState.__closure = { tagMessage: fn(6928).tagMessage };
...
function create(handlerTag) {
  ...
  const wrappedSetGestureState = function p() {
    const BEGAN = _mod6929.State.BEGAN;
  ...
  wrappedSetGestureState.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6929").State };
  ...
  const obj2 = { wrappedSetGestureState, handlerTag, State: require("module_6929").State };
  fn2.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6929").State };
  ...
  const obj3 = { wrappedSetGestureState, handlerTag, State: require("module_6929").State };
  S.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6929").State };
  ...
  const obj4 = { wrappedSetGestureState, handlerTag, State: require("module_6929").State };
  fn3.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6929").State };
  fn3.__workletHash = 6198601582791;
  fn3.__initData = __initData4;
  obj.end = fn3;
  return obj;
}
let obj = { tagMessage: fn(6928).tagMessage };
create.__closure = { wrappedSetGestureState, State: fn(6929).State };
