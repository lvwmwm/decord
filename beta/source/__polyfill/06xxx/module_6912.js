// Module ID: 6912
// Function ID: 6913
// Dependencies: [93, 95, 98, 42, 41, 6913, 6896]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6913).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6896).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6896);
      }
      return tmp;
    }
  }
