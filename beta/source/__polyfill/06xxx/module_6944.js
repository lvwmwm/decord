// Module ID: 6944
// Function ID: 6945
// Dependencies: [93, 95, 98, 42, 41, 6945, 6928]
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      this.handlerTag = ContinousBaseGesture(6945).getNextHandlerTag();
      const obj2 = {};
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(6928).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(6928);
      }
      return tmp;
    }
  }
