// Module ID: 6914
// Function ID: 6915
// Dependencies: [19, 21, 6915, 6936, 6941, 6937, 6942, 6943, 6926, 6939, 6938, 6944, 6945]
...
export const GestureDetector = (gesture) => {
  if (gesture.gesture) {
    ...
    const isomorphicLayoutEffect = gesture(webEventHandlers[7]).useIsomorphicLayoutEffect(() => {
      ...
      const tmp = _modDef6926(current.viewRef);
      gesturesToAttach.attachHandlers({ preparedGesture: current2, gestureConfig: gesture, gesturesToAttach, webEventHandlersRef: webEventHandlers, viewTag: _modDef6926(current.viewRef) });
      return () => {
