...
fn.__closure = { ANIMATION_CONFIGS: fn(6896).ANIMATION_CONFIGS, ANIMATION_METHOD: fn(6896).ANIMATION_METHOD, withTiming: fn(1641).withTiming, withSpring: fn(1641).withSpring };
