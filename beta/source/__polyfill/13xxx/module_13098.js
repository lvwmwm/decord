// Module ID: 13098
// Function ID: 13099
// Dependencies: [13060, 13063, 13076, 13099, 13100, 13086, 13058, 13101, 13094, 13070]
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = _mod13058.truncate(environment.message, num);
  }
  value = iter;
  ...
  if (value) {
    iter.value = _mod13058.truncate(iter.value, num);
  }
  ...
  if (url) {
    request.url = _mod13058.truncate(request.url, num);
  }
}
function applyDebugIds(exception, arg1) {
  const filenameToDebugIdMap = _mod13101.getFilenameToDebugIdMap(arg1);
  try {
