// Module ID: 13191
// Function ID: 13192
// Dependencies: [5, 13081, 13084, 13085, 13113, 13099, 13109, 13133, 13112, 13130, 13119, 13100]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(13112).getClient();
            options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(13130);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(13130);
        ...
        closure_0(13112).withScope((setContext) => {
