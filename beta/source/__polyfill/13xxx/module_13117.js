// Module ID: 13117
// Function ID: 13118
// Dependencies: [5, 13094, 13097, 13104]
    ...
    function getTransport(arg0, arg1) {
      ...
      if (value) {
        ...
        if (dsnFromStringResult) {
          let merged = tunnel;
          const envelopeEndpointWithUrlEncodedAuth = tmp4(13104).getEnvelopeEndpointWithUrlEncodedAuth(dsnFromStringResult, tunnel.tunnel);
          let tmp9 = tunnel;
          let obj3 = {};
          if (arg1) {
