// Module ID: 13156
// Function ID: 13157
// Dependencies: [5, 13046, 13049, 13050, 13078, 13064, 13074, 13098, 13077, 13095, 13084, 13065]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(13077).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(13095);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(13095);
        ...
        closure_0(13077).withScope((setContext) => {
