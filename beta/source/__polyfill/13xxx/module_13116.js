// Module ID: 13116
// Function ID: 13117
// Dependencies: [722, 13112, 13117, 13118, 13090, 13099, 13107, 13100, 13085, 13102, 13113, 13119]
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod13102.SPAN_STATUS_ERROR, message: "cancelled" };
    ...
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod13099.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod13102.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
