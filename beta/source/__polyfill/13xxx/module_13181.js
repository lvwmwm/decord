// Module ID: 13181
// Function ID: 13182
// Dependencies: [13081, 13084, 13086, 13112, 13090, 13113, 13085, 13182, 13099, 13119, 13120]
...
import COUNTER_METRIC_TYPE from "COUNTER_METRIC_TYPE" /* 13182 */;
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (client) {
    ...
    let rootSpan;
    if (activeSpan) {
      rootSpan = tmp3(13090).getRootSpan(activeSpan);
      const tmp3Result = tmp3(13090);
    }
    let description = rootSpan;
    if (rootSpan) {
      description = tmp3(13090).spanToJSON(rootSpan).description;
      const tmp3Result3 = tmp3(13090);
    }
    ...
    const globalSingleton = _mod13086.getGlobalSingleton("globalMetricsAggregators", () => {
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("module_13099").timestampInSeconds();
      c4 = timestampInSecondsResult;
      const obj = require("module_13099");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("module_13119").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
        return closure_0(name[10]).handleCallbackErrors(() => fn(), () => {

        }, () => {
          const timestampInSecondsResult = _mod13099.timestampInSeconds();
