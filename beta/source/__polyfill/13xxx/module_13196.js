// Module ID: 13196
// Function ID: 13197
// Dependencies: [32, 5, 13083, 13197, 13091, 13086, 13099, 13092]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod13083;
      obj2.endTimestamp = 1000 * _mod13099.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod13083.addHandler("fetch-body-resolved", arg0);
  _mod13083.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(13091).fill(closure_0(13086).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(13083);
                    obj5.endTimestamp = 1000 * stack(13099).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(13099);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(13083);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(13099).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(13099);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(13092);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(13091).addNonEnumerableProperty(error, "framesToPop", 1);
      ...
      const obj = closure_0(13091);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_13083").addHandler("fetch", arg0);
  let obj = require("module_13083");
  require("module_13083").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod13091.fill(_mod13086.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
