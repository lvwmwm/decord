// Module ID: 13151
// Function ID: 13152
// Dependencies: [5, 13113, 13085, 13129, 13150]
          ...
          if (0 === c6) {
            ...
            const obj10 = {
              value: (function shouldQueue(arg0, arg1, arg2) {
                      const result = createStore(13129).envelopeContainsItemType(arg0, ["client_report"]);
                      let tmp2 = !result;
                      if (!result) {
            ...
            if (arg0 === 1) {
              ...
              closure_130_3 = createStore(13150).parseRetryAfterHeader(closure_130_2.headers["retry-after"]);
              const obj5 = createStore(13150);
            }
          } else {
            if (6 === tmp6) {
              if (arg0 === 1) {
