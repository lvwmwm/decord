// Module ID: 13160
// Function ID: 13161
// Dependencies: [32, 5, 13047, 13161, 13055, 13050, 13063, 13056]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod13047;
      obj2.endTimestamp = 1000 * _mod13063.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod13047.addHandler("fetch-body-resolved", arg0);
  _mod13047.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(13055).fill(closure_0(13050).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(13047);
                    obj5.endTimestamp = 1000 * stack(13063).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(13063);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(13047);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(13063).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(13063);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(13056);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(13055).addNonEnumerableProperty(error, "framesToPop", 1);
      ...
      const obj = closure_0(13055);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_13047").addHandler("fetch", arg0);
  let obj = require("module_13047");
  require("module_13047").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod13055.fill(_mod13050.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
