// Module ID: 957
// Function ID: 958
// Dependencies: [5, 93, 95, 98, 158, 32, 41, 42, 686, 902]
...
function addBreadcrumbEvent(triggerUserActivity, category) {
  ...
  if ("sentry.transaction" !== category.category) {
    ...
    triggerUserActivity.addUpdate(() => {
      ...
      const normalizer = f133477(map[8]);
...
function getLargestContentfulPaint(arg0) {
  ...
  ({ value, rating } = arg0);
  const result = ((_mod686.browserPerformanceTimeOrigin() || _mod686.GLOBAL_OBJ.performance.timeOrigin) + value) / 1000;
  const obj2 = { type: "web-vital", name: "largest-contentful-paint", start: result, end: result, data: null };
  const obj3 = { value, size: value, rating, nodeIds: null, attributions: "forEach" };
  let mapped;
  if (tmp3) {
...
function hasSessionStorage() {
  try {
    let sessionStorage = "sessionStorage" in _mod686.GLOBAL_OBJ;
    if (sessionStorage) {
      sessionStorage = _mod686.GLOBAL_OBJ.sessionStorage;
    }
...
function clearSession(arg0) {
  (function deleteSession() {
    if (hasSessionStorage()) {
      try {
        const sessionStorage = require("module_686").GLOBAL_OBJ.sessionStorage;
...
function saveSession(session) {
  if (hasSessionStorage()) {
    try {
      const sessionStorage = _mod686.GLOBAL_OBJ.sessionStorage;
      const _JSON = JSON;
...
function resetReplayIdOnDynamicSamplingContext() {
  ...
  if (activeSpan) {
    const dynamicSamplingContextFromSpan = tmp5(686).getDynamicSamplingContextFromSpan(activeSpan);
    delete tmp2[tmp];
    const tmp5Result2 = tmp5(686);
  }
}
...
function addNetworkBreadcrumb(isEnabled, name) {
  ...
  if (isEnabledResult) {
    ...
    if (isSentryRequestUrlResult) {
      ...
      isSentryRequestUrlResult = obj.isSentryRequestUrl(name.name, require("module_686").getClient());
...
function mergeWarning(_meta, arg1) {
  ...
  if (_meta) {
    ...
    const obj2 = { headers, size: "Array", _meta: true };
...
function urlMatches(str, arg1) {
  const baseURI = _mod686.GLOBAL_OBJ.document.baseURI;
  let substr = str;
  if (!str.startsWith("http://")) {
    substr = str;
    if (!str.startsWith("https://")) {
      substr = str;
      if (!str.startsWith(tmp(686).GLOBAL_OBJ.location.origin)) {
        const _URL = URL;
  ...
  return _mod686.stringMatchesSomePattern(substr, arg1);
}
            ...
            if (tmp15) {
              let tmp17 = (function _getRequestInfo(networkRequestHeaders, input, request_body_size) {
                ...
                if (input) {
                  ...
                  headers = {};
                  if (tmp) {
                    const fetchRequestArgBody = data(902).getFetchRequestArgBody(input);
                    const obj12 = data(902);
                    const obj13 = data(902);
                    [tmp20, tmp21] = closure_1_6(data(902).getBodyString(fetchRequestArgBody, closure_1_133), 2);
                    ...
                    if (tmp21) {
                      ...
                      if (tmp23) {
                        ...
                        obj14 = { headers: obj11, size: "Array", _meta: true };
                    ...
                    const tmp19 = closure_1_6(data(902).getBodyString(fetchRequestArgBody, closure_1_133), 2);
                  } else {
                    if (request_body_size) {
                      if (request_body_size) {
                      ...
                      if (!tmp14) {
                        ...
                        if (!tmp17) {
                          ...
                          if (tmp22) {
                            ...
                            obj10 = { headers: obj9, size: "Array", _meta: true };
                        ...
                        if (tmp18) {
                          ...
                          obj13 = { headers: obj12, size: "Array", _meta: true };
    ...
    try {
      ...
      if (0 === c2) {
        if (arg0 === 1) {
          ...
          c3 = 1;
          const _Date = Date;
          ({ jsHeapSizeLimit, totalJSHeapSize, usedJSHeapSize } = require("module_686").GLOBAL_OBJ.performance.memory);
    ...
    try {
      ...
      if (0 === c3) {
        ...
        if (arg0 === 1) {
          ...
          options = closure_129_0.getOptions();
          c3 = 2;
          c4 = 1;
        ...
        if (arg0 === 1) {
          ...
          if (closure_129_16) {
            ...
            closure_129_18 = (function createReplayEnvelope(arg0, str, arg2, tunnel) {
              ...
              const items1 = [items, ];
              const eventEnvelopeHeaders = obj2.createEventEnvelopeHeaders(arg0, closure_1_0(686).getSdkMetadataForEnvelopeHeader(arg0), tunnel, arg2);
              if (typeof str === "string") {
                const _TextEncoder = TextEncoder;
                const encoder = new TextEncoder();
