// Module ID: 842
// Function ID: 843
// Dependencies: [5, 827, 843, 829, 708, 844, 830, 735, 845, 709, 738, 736, 717]
...
import contentUnionToMessages from "contentUnionToMessages" /* 844 */;
                                ...
                                let obj = {
                                  apply(arr, arg1, arg2) {
                                          ...
                                          if (isStreamingMethodResult) {
                                            ...
                                            obj5.op = tmp4(tmp5[3]).getSpanOperation(tmp2);
                                            obj5.attributes = obj;
                                            closure_0 = closure_2(/* F148423 */ function() { ... });
                              ...
                              apply(arr, arg1, arg2) {
                                      ...
                                      if (isStreamingMethodResult) {
                                        ...
                                        startSpanManualResult = tmp4Result6.startSpan(obj6, (_function) => {
                                          ...
                                          return str(dependencyMap[11]).handleCallbackErrors(() => { ... }, () => { ... }, /* F148427 */ function() { ... }, () => { ... });
                                        });
                                        const tmp4Result8 = tmp4(tmp5[3]);
                                      }
                                      return startSpanManualResult;
