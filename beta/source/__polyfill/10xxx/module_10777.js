// Module ID: 10777
// Function ID: 10778
// Dependencies: [41, 42, 93, 95, 96, 98, 10769, 10778]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10769).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10769).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
