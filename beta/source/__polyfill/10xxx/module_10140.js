// Module ID: 10140
// Function ID: 10141
// Dependencies: [10141, 10143, 10145, 10146, 10147]

// Module 10140
import QR8bitByte from "QR8bitByte" /* 10141 */;
import QRRSBlock from "QRRSBlock" /* 10143 */;
import QRBitBuffer from "QRBitBuffer" /* 10145 */;
import _mod10146 from "module_10146" /* 10146 */;
import QRPolynomial from "QRPolynomial" /* 10147 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod10146.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10146.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10146.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
