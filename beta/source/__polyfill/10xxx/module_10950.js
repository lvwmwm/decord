// Module ID: 10950
// Function ID: 10951
// Dependencies: [10760, 10767, 10769, 10793, 10805, 10951, 10953, 10954, 10955, 10800]
...
fn(_mod10953);
fn(_mod10954);
const _isNativeReflectConstruct = fn(_mod10955);
...
obj7.parsers = items;
obj7.refiners = [];
const chrono1 = new require("module_10760").Chrono(includeCommonConfiguration.includeCommonConfiguration(obj7, true));
