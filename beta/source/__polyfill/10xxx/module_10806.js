// Module ID: 10806
// Function ID: 10807
// Dependencies: [41, 42, 10798, 10755]
...
const items = [
  entry,
  {
    ...
    value: function extract(reference, arg1) {
      const tmp3 = JPWeekdayWithParenthesesParser(10798).WEEKDAY_OFFSET[arg1.groups.weekday];
      let parsingComponentsAtWeekday = null;
      if (undefined !== tmp3) {
        parsingComponentsAtWeekday = JPWeekdayWithParenthesesParser(10755).createParsingComponentsAtWeekday(reference.reference, tmp3);
      }
