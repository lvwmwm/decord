// Module ID: 10741
// Function ID: 10742
// Dependencies: [41, 42, 93, 95, 96, 98, 10733, 10742]
        ...
        if (first.endsWith("night")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10733).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10733).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
