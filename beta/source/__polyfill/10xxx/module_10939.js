// Module ID: 10939
// Function ID: 10940
// Dependencies: [41, 42, 93, 95, 96, 98, 10758, 10778]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10758).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10758).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
