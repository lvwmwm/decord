// Module ID: 10755
// Function ID: 10756
// Dependencies: [10731, 10733]
// Exports: createParsingComponentsAtWeekday, getBackwardDaysToWeekday, getDaysForwardToWeekday, getDaysToWeekdayClosest

// Module 10755
import ReferenceWithTimezone from "ReferenceWithTimezone" /* 10731 */;
import Meridiem from "Meridiem" /* 10733 */;
...
function getDaysToWeekday(dateWithAdjustedTimezone, sum, next) {
  ...
  if ("this" === next) {
    ...
    if (day == Meridiem.Weekday.SUNDAY) {
      let num12 = 7;
      if (sum != tmp6(10733).Weekday.SUNDAY) {
        num12 = sum;
      }
      let sum3 = num12;
    } else if (day == tmp6(10733).Weekday.SATURDAY) {
      let num9 = 7;
      if (sum != tmp6(10733).Weekday.SATURDAY) {
        let num10 = 8;
        if (sum != tmp6(10733).Weekday.SUNDAY) {
          num10 = 1 + sum;
        }
