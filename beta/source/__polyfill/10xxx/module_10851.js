// Module ID: 10851
// Function ID: 10852
// Dependencies: [41, 42, 93, 95, 98, 10769, 10770, 10771]
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(refDate, arg1) {
      ...
      if ("tarde" === formatted) {
        parsingComponents.imply("meridiem", PTCasualTimeParser(10769).Meridiem.PM);
        ...
        if ("manha" !== formatted) {
          if ("manh\u00E3" !== formatted) {
            if ("meia-noite" === formatted) {
              ...
              PTCasualTimeParser(10770).assignSimilarDate(parsingComponents, date);
              PTCasualTimeParser(10770).implySimilarTime(parsingComponents, date);
              parsingComponents.imply("hour", 0);
              parsingComponents.imply("minute", 0);
              parsingComponents.imply("second", 0);
            } else if ("meio-dia" === formatted) {
              parsingComponents.imply("meridiem", PTCasualTimeParser(10769).Meridiem.AM);
