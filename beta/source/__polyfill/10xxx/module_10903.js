// Module ID: 10903
// Function ID: 10904
// Dependencies: [41, 42, 93, 95, 96, 98, 10722, 10742]
        ...
        if (first.endsWith("sera")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", ENTimeExpressionParser(10722).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", ENTimeExpressionParser(10722).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
