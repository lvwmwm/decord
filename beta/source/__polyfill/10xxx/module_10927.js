// Module ID: 10927
// Function ID: 10928
// Dependencies: [41, 42, 93, 95, 98, 10788, 10770, 10920]
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    _inherits(UKCasualTimeParser, _mod10920.AbstractParserWithLeftRightBoundaryChecking);
    const entry = {
                      ...
                      if (!str2.endsWith("\u0437\u0440\u0430\u043D\u043A\u0443")) {
                        if (str2.endsWith("\u043E\u043F\u0456\u0432\u0434\u043D\u0456")) {
                          ...
                          if (str2.match(/наступної\s*ночі/)) {
                            ...
                            UKCasualTimeParser(10770).assignSimilarDate(parsingComponents, date);
