// Module ID: 10949
// Function ID: 10950
// Dependencies: [41, 42, 93, 95, 98, 10933, 10766, 10767, 10783]
...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, text, start) {
      const parseDurationResult = ENMergeRelativeDateRefiner(10933).parseDuration(text.text);
      ...
      return new ENMergeRelativeDateRefiner(10767).ParsingResult(start.reference, text.index, "" + text.text + arg0 + start.text, relativeFromReference);
    }
  }
];
