// Module ID: 10862
// Function ID: 10863
// Dependencies: [41, 42, 93, 95, 98, 10861, 10692, 10693, 10699]
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10861).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = tmp2(10861).parseOrdinalNumberPattern(index[2]);
