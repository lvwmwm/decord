// Module ID: 10914
// Function ID: 10915
// Dependencies: [10724, 10731, 10733, 10757, 10769, 10915, 10917, 10918, 10919, 10764]
...
fn(_mod10917);
fn(_mod10918);
const _isNativeReflectConstruct = fn(_mod10919);
...
obj7.parsers = items;
obj7.refiners = [];
const chrono1 = new require("module_10724").Chrono(includeCommonConfiguration.includeCommonConfiguration(obj7, true));
