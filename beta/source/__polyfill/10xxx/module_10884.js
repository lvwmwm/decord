// Module ID: 10884
// Function ID: 10885
// Dependencies: [41, 42, 93, 95, 98, 10882, 10735]
...
const entry = {
  ...
  value: function patternLeftBoundary() {
    return AbstractParserWithLeftRightBoundaryChecking(10882).REGEX_PARTS.leftBoundary;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerPattern(arg0) {
      const regExp = new RegExp(this.innerPatternString(arg0), AbstractParserWithLeftRightBoundaryChecking(10882).REGEX_PARTS.flags);
      return regExp;
    }
  },
  {
...
const entry1 = {
  key: "innerPattern",
  value: function innerPattern(arg0) {
    const combined = "" + this.innerPatternString(arg0) + AbstractParserWithLeftRightBoundaryChecking(10882).REGEX_PARTS.rightBoundary;
    const regExp = new RegExp(combined, AbstractParserWithLeftRightBoundaryChecking(10882).REGEX_PARTS.flags);
    return regExp;
  }
};
const items1 = [entry1];
