// Module ID: 10726
// Function ID: 10727
// Dependencies: [41, 42, 93, 95, 98, 10727, 10731, 10735]
...
const regExp = new RegExp("(?:(?:within|in|for)\\s*)?(?:(?:about|around|roughly|approximately|just)\\s*(?:~\\s*)?)?(" + _mod10727.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
const regExp1 = new RegExp("(?:within|in|for)\\s*(?:(?:about|around|roughly|approximately|just)\\s*(?:~\\s*)?)?(" + _mod10727.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
const regExp2 = new RegExp("(?:within|in|for)\\s*(?:(?:about|around|roughly|approximately|just)\\s*(?:~\\s*)?)?(" + _mod10727.TIME_UNITS_NO_ABBR_PATTERN + ")(?=\\W|$)", "i");
  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      if (str.match(/^for\s*the\s*\w+/)) {
        ...
        const parseDurationResult = ENTimeUnitWithinFormatParser(10727).parseDuration(arg1[1]);
