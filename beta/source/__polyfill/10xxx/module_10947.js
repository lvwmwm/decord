// Module ID: 10947
// Function ID: 10948
// Dependencies: [41, 42, 93, 95, 98, 10764, 10933, 10767, 10771]
...
const regExp = new RegExp("(questo|ultimo|scorso|prossimo|dopo\\s*questo|questa|ultima|scorsa|prossima\\s*questa)\\s*(" + repeatedTimeunitPattern.matchAnyPattern(_mod10933.TIME_UNIT_DICTIONARY) + ")(?=\\s*)(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp3 = ITRelativeDateFormatParser(10933).TIME_UNIT_DICTIONARY[str3];
      ...
      const ParsingComponents2 = tmp(10767).ParsingComponents;
