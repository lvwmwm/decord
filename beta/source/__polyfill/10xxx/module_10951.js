// Module ID: 10951
// Function ID: 10952
// Dependencies: [41, 42, 93, 95, 98, 10764, 10952, 10791, 10771]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:p\u00E5\\s*?)?(?:(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10952.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(f\u00F6rra|senaste|n\u00E4sta|kommande)\\s*vecka)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return SVWeekdayParser(10791).createParsingComponentsAtWeekday(reference.reference, SVWeekdayParser(10952).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
