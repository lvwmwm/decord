// Module ID: 10866
// Function ID: 10867
// Dependencies: [41, 42, 93, 95, 98, 10858, 10766, 10767, 10771]
...
const regExp = new RegExp("(dit|deze|vorig|afgelopen|(?:aan)?komend|over|\\+|-)e?\\s*(" + _mod10858.TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const parseDurationResult = NLTimeUnitCasualRelativeFormatParser(10858).parseDuration(arg1[2]);
      if ("vorig" !== formatted) {
