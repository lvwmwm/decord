// Module ID: 10861
// Function ID: 10862
// Dependencies: [41, 42, 93, 95, 98, 10764, 10858, 10765, 10771]
...
const regExp = new RegExp("(" + repeatedTimeunitPattern.matchAnyPattern(_mod10858.MONTH_DICTIONARY) + ")\\s*(?:[,-]?\\s*(" + _mod10858.YEAR_PATTERN + ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLMonthNameParser(10858).MONTH_DICTIONARY[arg1[1].toLowerCase(arg1[1])];
      parsingComponents.assign("month", tmp4);
      if (arg1[2]) {
        parsingComponents.assign("year", tmp2(10858).parseYear(arg1[2]));
      } else {
        parsingComponents.imply("year", tmp2(10765).findYearClosestToRef(createParsingComponents.refDate, 1, tmp4));
      }
