// Module ID: 10101
// Function ID: 10102
// Dependencies: [10102, 10104, 10106, 10107, 10108]

// Module 10101
import QR8bitByte from "QR8bitByte" /* 10102 */;
import QRRSBlock from "QRRSBlock" /* 10104 */;
import QRBitBuffer from "QRBitBuffer" /* 10106 */;
import _mod10107 from "module_10107" /* 10107 */;
import QRPolynomial from "QRPolynomial" /* 10108 */;
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod10107.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10107.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10107.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
