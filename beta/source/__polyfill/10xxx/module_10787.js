// Module ID: 10787
// Function ID: 10788
// Dependencies: [41, 42, 93, 95, 98, 10692, 10786, 10719, 10699]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:op\\s*?)?(?:(deze|vorige|volgende)\\s*(?:week\\s*)?)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10786.WEEKDAY_DICTIONARY) + ")(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return NLWeekdayParser(10719).createParsingComponentsAtWeekday(reference.reference, NLWeekdayParser(10786).WEEKDAY_DICTIONARY[formatted], str3);
    }
  }
];
