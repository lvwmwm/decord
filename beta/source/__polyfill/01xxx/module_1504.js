// Module ID: 1504
// Function ID: 1505
// Dependencies: [109, 19, 21, 1505, 1506, 1508, 1511, 1512, 1513, 1510, 1514, 1493, 1515, 1516, 1517, 1507, 1519, 1518, 1520, 1521, 1522, 1523, 1524]

// Module 1504
import CommonActions2 from "CommonActions" /* 1493 */;
...
export const BaseNavigationContainer = noop.forwardRef(function BaseNavigationContainer(onReady, ref) {
  ...
  obj2 = require("module_1506");
  const syncState = require("module_1508").useSyncState(() => {
  ...
  const tmpResult = require("module_1508");
  const lazyValue = require("module_1511").useLazyValue(() => {
  ...
  const tmpResult6 = require("module_1511");
  const childListeners = require("module_1512").useChildListeners();
  ({ listeners: c12, addListener } = childListeners);
  const tmpResult7 = require("module_1512");
  const keyedChildListeners = require("module_1513").useKeyedChildListeners();
  ...
  isReady = tmp20;
  const tmpResult8 = require("module_1513");
  eventEmitter = require("module_1516").useEventEmitter();
  const tmpResult9 = require("module_1516");
  const optionsGetters = require("module_1517").useOptionsGetters({});
  ...
  const tmpResult10 = require("module_1517");
  ...
  obj9.children = scheduleUpdate(require("module_1523").EnsureSingleNavigator, { children: scheduleUpdate(require("ThemeProvider").ThemeProvider, { value: theme, children }) });
