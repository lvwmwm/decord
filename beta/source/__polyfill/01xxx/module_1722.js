...
function withSequence(withTimingResult) {
  ...
  if (!withTimingResult) {
    if (0 === substr.length) {
      const logger = substr(1645).logger;
      ...
      const fn2 = function c() {
        const obj = {
          ...
          current: 0,
          animationIndex: 0,
          reduceMotion: _mod1681.getReduceMotionForAnimation(closure_1)
        };
        return obj;
      };
      const obj2 = { getReduceMotionForAnimation: substr(1681).getReduceMotionForAnimation, reduceMotion: undefined };
      fn2.__closure = obj2;
      fn2.__workletHash = 3306563388298;
      fn2.__initData = __initData;
      let defineAnimationResult = substr(1681).defineAnimation(0, fn2);
      const obj3 = substr(1681);
    } else {
      const fn = function s() {
      ...
      const obj4 = { _animations: substr, getReduceMotionForAnimation: substr(1681).getReduceMotionForAnimation, reduceMotion: undefined };
      fn.__closure = obj4;
      fn.__workletHash = 13427604040510;
      fn.__initData = __initData2;
      defineAnimationResult = substr(1681).defineAnimation(substr[0], fn);
      let obj = substr(1681);
    }
...
withSequence.__closure = { logger: fn(1645).logger, defineAnimation: fn(1681).defineAnimation, getReduceMotionForAnimation: fn(1681).getReduceMotionForAnimation };
