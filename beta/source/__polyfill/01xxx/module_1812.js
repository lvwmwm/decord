...
function convertRgbToOklab(arg0) {
  const convert = _modDef1813.convert;
...
convertRgbToOklab.__closure = { lrgb: fn(1813), convertLrgbToOklab };
...
const obj = { lrgb: fn(1813), convertLrgbToOklab };
convertOklabToRgb.__closure = { convertOklabToLrgb, lrgb: fn(1813) };
