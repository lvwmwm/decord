// Module ID: 1562
// Function ID: 1563
// Dependencies: [32, 109, 19, 21, 1492, 1535, 1536, 1563, 1529, 1520, 1511, 1505, 1518, 1510, 1552, 1493, 1564, 1565, 1509, 1516, 1567, 1512, 1513, 1568, 1570, 1521, 1571, 1572, 1573, 1574, 1578, 1579, 1557, 1554, 1580, 1530, 1559]
...
export const useNavigationBuilder = function useNavigationBuilder(StackRouter, UNSTABLE_routeNamesChangeBehavior) {
  ...
  dependencyMap = require("module_1563").useRegisterNavigator();
  const context = noop.useContext(require("module_1529").NavigationRouteContext);
  ...
  if (mapped.length) {
    ...
    const tmp35 = _modDef1510((current) => {
      if (ref.current) {
    ...
    let found = keys.filter((item) => {
      ...
      if (tmp3) {
        tmp3 = !_mod1552.isArrayEqual(tmp, tmp2);
      }
      return tmp3;
    });
    ...
    if (null != tmp43) {
          ...
          if (isNavigationState(context.params.state)) {
            if (!tmp5) {
              ...
              if (null != tmp61) {
                ...
                const CommonActions = tmp30(1493).CommonActions;
          ...
          if (typeof context.params.screen === "string") {
            ...
            if ("lastUnhandled" === UNSTABLE_routeNamesChangeBehavior.UNSTABLE_routeNamesChangeBehavior) {
              if (!mapped.includes(context.params.screen)) {
                ...
                tmp67 = null == tmp66 || tmp34(1564)(tmp66, tmp43);
              }
            }
      ...
      const scheduleUpdate = tmp30(1565).useScheduleUpdate(() => {
        if (closure_38) {
      ...
      const tmp30Result = tmp30(1565);
      const eventEmitter = tmp30(1516).useEventEmitter((target) => {
        const items = [];
      ...
      const tmp30Result14 = tmp30(1516);
      const obj11 = { state: tmp58, emitter: eventEmitter };
      const focusEvents = tmp30(1567).useFocusEvents(obj11);
      ...
      const tmp30Result15 = tmp30(1567);
      const childListeners = tmp30(1512).useChildListeners();
      ({ listeners, addListener } = childListeners);
      const tmp30Result16 = tmp30(1512);
      const keyedChildListeners = tmp30(1513).useKeyedChildListeners();
      ({ keyedListeners, addKeyedListener } = keyedChildListeners);
      const tmp30Result17 = tmp30(1513);
      ...
      const onAction = tmp30(1568).useOnAction(obj12);
      const tmp30Result18 = tmp30(1568);
      ...
      const onRouteFocus = tmp30(1570).useOnRouteFocus(obj14);
      closure_41 = obj10.useContext(tmp30(1521).UnhandledActionContext);
      const tmp30Result19 = tmp30(1570);
      const tmp85 = tmp34(1510)((type) => {
        if ("lastUnhandled" === UNSTABLE_routeNamesChangeBehavior.UNSTABLE_routeNamesChangeBehavior) {
      ...
      const navigationHelpers = tmp30(1571).useNavigationHelpers(obj15);
      const tmp30Result20 = tmp30(1571);
      const obj16 = { navigation: navigationHelpers, focusedListeners: listeners.focus };
      const focusedListenersChildrenAdapter = tmp30(1572).useFocusedListenersChildrenAdapter(obj16);
      const tmp30Result21 = tmp30(1572);
      const obj17 = { getState: tmp75, getStateListeners: keyedListeners.getState };
      const onGetState = tmp30(1573).useOnGetState(obj17);
      const tmp30Result22 = tmp30(1573);
      ...
      const descriptors1 = tmp30(1574).useDescriptors(obj18);
      const descriptors = descriptors1.descriptors;
      const tmp30Result23 = tmp30(1574);
      const obj19 = { state: tmp58, navigation: navigationHelpers, descriptors };
      const currentRender = tmp30(1578).useCurrentRender(obj19);
      const tmp30Result24 = tmp30(1578);
      const obj20 = {
        state: tmp58,
        navigation: navigationHelpers,
        describe: descriptors1.describe,
        descriptors,
        NavigationContent: tmp30(1579).useComponent((children) => {
    ...
    const tmp30Result26 = require("module_1552");
    rehydratedState = tmp39;
    if (!tmp51) {
    ...
    tmp51 = require("module_1552").isArrayEqual(tmp39.routeNames, mapped) && 0 === found.length;
  } else {
    let _Error = Error;
