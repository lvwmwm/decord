...
_inherits(RotateInDownLeft, fn(1711).ComplexAnimationBuilder);
const entry = {
  key: "createInstance",
...
_inherits(RotateInDownRight, fn(1711).ComplexAnimationBuilder);
const entry1 = {
  key: "createInstance",
  value: function createInstance() {
    return _slicedToArray();
...
_inherits(RotateInUpLeft, fn(1711).ComplexAnimationBuilder);
const entry2 = {
  key: "createInstance",
  value: function createInstance() {
    return _slicedToArray();
...
_inherits(RotateInUpRight, fn(1711).ComplexAnimationBuilder);
const entry3 = {
  key: "createInstance",
  value: function createInstance() {
    return _slicedToArray();
...
_inherits(RotateOutDownLeft, fn(1711).ComplexAnimationBuilder);
const entry4 = {
  key: "createInstance",
  value: function createInstance() {
    return _slicedToArray();
...
_inherits(RotateOutDownRight, fn(1711).ComplexAnimationBuilder);
const entry5 = {
  key: "createInstance",
  value: function createInstance() {
    return _slicedToArray();
...
_inherits(RotateOutUpLeft, fn(1711).ComplexAnimationBuilder);
const entry6 = {
  key: "createInstance",
  value: function createInstance() {
    return _slicedToArray();
...
_inherits(RotateOutUpRight, fn(1711).ComplexAnimationBuilder);
const entry7 = {
  key: "createInstance",
  value: function createInstance() {
    return _slicedToArray();
