// Module ID: 1779
// Function ID: 1780
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 1644, 1749, 1685]
...
let closure_10 = module_1644.isReact19();
  ...
  entry,
  {
    ...
    value: function setShouldAnimateExiting() {
      ...
      if (1 === hasOwnProperty.count(this.props.children)) {
        const findNodeHandleResult = LayoutAnimationConfig(1749).findNodeHandle(self);
        if (findNodeHandleResult) {
          const result = tmp(1685).setShouldAnimateExitingForTag(findNodeHandleResult, !self.props.skipExiting);
          const tmpResult = tmp(1685);
        }
        const obj = LayoutAnimationConfig(1749);
