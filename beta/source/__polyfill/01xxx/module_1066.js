// Module ID: 1066
// Function ID: 1067
// Dependencies: [93, 95, 98, 41, 42, 1067, 871, 686]
...
export const showFeedbackButton = () => {
  const result = ScreenshotButtonManager(1067).lazyLoadAutoInjectFeedbackButtonIntegration();
...
export const showFeedbackWidget = () => {
  const result = ScreenshotButtonManager(1067).lazyLoadAutoInjectFeedbackIntegration();
...
export const showScreenshotButton = () => {
  if (obj.isWeb()) {
    ...
    const result = tmp(1067).lazyLoadAutoInjectScreenshotButtonIntegration();
    importDefaultResult1Result3.show();
    const tmpResult = tmp(1067);
  }
};
