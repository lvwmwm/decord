...
fn = function t(toValue, userConfig, callback) {
  ...
  fn.__closure = { Easing: require("linear").Easing, userConfig, toValue, callback, getReduceMotionForAnimation: require("module_1677").getReduceMotionForAnimation };
  fn.__workletHash = 16704866504175;
  fn.__initData = __initData;
  return obj.defineAnimation(toValue, fn);
};
fn.__closure = { __DEV__: false, assertEasingIsWorklet: fn(1677).assertEasingIsWorklet, defineAnimation: fn(1677).defineAnimation, Easing: fn(1689).Easing, getReduceMotionForAnimation: fn(1677).getReduceMotionForAnimation };
