// Module ID: 1773
// Function ID: 1774
// Dependencies: [41, 42, 17, 1644, 1681, 1640, 1648]
...
const items = [
  entry,
  {
    ...
    value: function removeProgressAnimation(viewTag) {
      ...
      flag(1644).runOnUIImmediately(fn)();
    }
  },
  {
...
if (module_1640.shouldBeUseWeb()) {
  function maybeThrowError() {
    if (!obj.isJest()) {
      const reanimatedError = new tmp(1648).ReanimatedError("`ProgressTransitionRegister` is not available on non-native platform.");
