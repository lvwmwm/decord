// Module ID: 1651
// Function ID: 1652
// Dependencies: [32, 41, 42, 91, 1640, 1652, 1653, 1662, 1648, 1641]
...
if (!module_1640.isJest()) {
    ...
    value: function enableLayoutAnimations() {
        if (obj.isWeb()) {
          ...
          if (tmpResult.isJest()) {
            ...
            isChromeDebuggerResult = tmp(1640).isChromeDebugger();
          }
          tmpResult = tmp(1640);
        }
      }
  ...
  const entry12 = {
    ...
    value: function initializeSensor(arg0, arg1) {
        ...
        } else if (tmp(1662).SensorType.GYROSCOPE === arg0) {
          const _window4 = window;
          const gyroscope = new window.Gyroscope(obj);
          return gyroscope;
        } else if (tmp(1662).SensorType.GRAVITY === arg0) {
          const _window3 = window;
          const gravitySensor = new window.GravitySensor(obj);
          return gravitySensor;
        } else if (tmp(1662).SensorType.MAGNETIC_FIELD === arg0) {
          const _window2 = window;
          const magnetometer = new window.Magnetometer(obj);
          return magnetometer;
        } else if (tmp(1662).SensorType.ROTATION === arg0) {
          const _window = window;
