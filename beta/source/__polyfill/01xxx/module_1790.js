// Module ID: 1790
// Function ID: 1791
// Dependencies: [19, 1789, 1640, 1681]
...
export const useAnimatedReaction = function useAnimatedReaction(fn, fn2, items) {
  _require = fn;
  dependencyMap = fn2;
  useEffect = require("module_1789").useSharedValue(null);
  let __closure = fn.__closure;
  if (__closure == null) {
    __closure = {};
  }
  const values = Object.values(__closure);
  const obj = require("module_1789");
  let tmp3 = require("module_1640").shouldBeUseWeb() && !values.length;
  let arr2 = items;
  if (tmp3) {
    let length;
    if (arr2 != null) {
