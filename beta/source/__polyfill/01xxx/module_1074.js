// Module ID: 1074
// Function ID: 1075
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 1065, 686, 871, 870, 1070, 1067, 1068, 1071, 1073, 1075, 1066]
...
class FeedbackWidget {
  constructor(arg0) {
      ...
      if (!closure_0.props.isNameRequired) {
        if (!obj.props.isEmailRequired) {
          if (trimmed2) {
            if (obj.props.shouldValidateEmail) {
              if (obj.props.isEmailRequired) {
                if (!obj3.isValidEmail(trimmed1)) {
                  closure_0(1065).feedbackAlertDialog(props2.errorTitle, props2.emailError);
                  const obj4 = closure_0(1065);
                }
                obj3 = closure_0(1065);
              }
            }
            ...
            const obj6 = { message: trimmed2, name: trimmed, email: trimmed1, associatedEventId: closure_0(686).lastEventId() };
            try {
              if (!onFormSubmitted) {
              ...
              closure_0(686).captureFeedback(obj6, tmp19);
              const obj10 = { name: trimmed, email: trimmed1, message: trimmed2, attachments: tmp13 };
              tmp4(obj10);
              const obj8 = closure_0(686);
              closure_0(1065).feedbackAlertDialog(props2.successMessageText, "");
              onFormSubmitted();
              obj._didSubmitForm = true;
              const obj11 = closure_0(1065);
            } catch (tmp26) {
              const _Error = Error;
              const _HermesInternal = HermesInternal;
              const error = new Error("Feedback form submission failed: " + tmp26);
              tmp3(error);
              closure_0(1065).feedbackAlertDialog(tmp2.errorTitle, tmp2.genericError);
              const debug = closure_0(686).debug;
              const _HermesInternal2 = HermesInternal;
              debug.error("Feedback form submission failed: " + tmp26);
              const obj12 = closure_0(1065);
            }
            const obj7 = closure_0(686);
          }
        }
      }
      closure_0(1065).feedbackAlertDialog(props2.errorTitle, props2.formError);
    };
                ...
                if (self._hasScreenshot()) {
                  ...
                  if (num2) {
                    ...
                    if (fn) {
                      ...
                      const debug2 = closure_2_0(686).debug;
                    ...
                    Object.assign(Object.assign({}, closure_2_0(1070).defaultConfiguration), debug.props).onAddScreenshot((attachmentUri) => {
              ...
              if (assets) {
                if (closure_129_7.assets.length > num2) {
                  ...
                  if (!obj9.isWeb()) {
                    ...
                    closure_129_0 = uri;
                    if (closure_129_0) {
                      let dataFromUri = closure_2_0(870).getDataFromUri(closure_129_0);
                      let obj = closure_2_0(870);
                      dataFromUri.then((attachment) => {
                        if (null != attachment) {
                ...
                if (closure_129_10) {
                  base64ToUint8ArrayResult = closure_2_0(1065).base64ToUint8Array(closure_129_10);
                  let obj2 = closure_2_0(1065);
                }
                tmp54 = closure_1;
    ...
    tmp4Result._setCapturedScreenshot = (data) => {
      if (null != data.data) {
        const debug2 = FeedbackWidget(686).debug;
        debug2.log("Setting captured screenshot:", data.filename);
        const NATIVE = FeedbackWidget(870).NATIVE;
        ...
        let debug = FeedbackWidget(686).debug;
        debug.error("Failed to read image data from:", data.filename);
      }
    };
    ...
    tmp4Result._getUser = () => {
      const currentScope = closure_0(686).getCurrentScope();
      ...
      if (user) {
        ...
        if (!user1) {
          const globalScope = tmp(686).getGlobalScope();
    ...
    tmp4Result._showImageRetrievalDevelopmentNote = () => {
      if (obj.isExpoGo()) {
        closure_0(1065).feedbackAlertDialog("Development note", "The feedback widget cannot retrieve image data in Expo Go. Please build your app to test this functionality.");
        const tmpResult = closure_0(1065);
      }
    };
        ...
        if (!tmp48) {
          ...
          if (element5) {
            const obj15 = {
              ...
              onPress() {
                      FeedbackWidget(1066).hideFeedbackButton();
                      if (typeof onCancel === "function") {
                        ...
                        tmp(1066).showScreenshotButton();
                      } else {
                        throw new TypeError("Trying to call a non-function");
                      }
                      const obj = FeedbackWidget(1066);
                      tmp = FeedbackWidget;
                    }
            };
