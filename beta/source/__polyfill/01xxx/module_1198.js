// Module ID: 1198
// Function ID: 1199
// Dependencies: [32, 93, 95, 98, 41, 42, 1197]
    ...
    if (closure_7) {
      ...
      if ("0" == trimmed) {
        ...
        if (regex.test(trimmed)) {
          ...
          tmp24 = _slicedToArray(PbLong(1197).int64fromString(trimmed), 3);
        } else {
          const _Error3 = Error;
  ...
  },
  {
    ...
    value: function toString() {
      ...
      if (obj) {
        ...
        return "-" + PbLong(1197).int64toString(negateResult.lo, negateResult.hi);
      } else {
        obj = PbLong(1197);
  ...
  value: function from(trimmed) {
    ...
    if (closure_7) {
      ...
      if ("0" == trimmed) {
        ...
        trimmed = trimmed.trim();
        if (regex.test(trimmed)) {
          const obj3 = PbLong(1197);
          [tmp24, tmp26, tmp27] = PbLong(1197).int64fromString(trimmed);
