// Module ID: 1771
// Function ID: 1772
// Dependencies: [41, 42, 93, 95, 98, 1760, 1713, 1645, 1711]
...
class EntryExitTransition {
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      fn.__closure = { enteringAnimation: buildResult, exitingAnimation: buildResult1, delayFunction, delay, withSequence: EntryExitTransition(1713).withSequence, withTiming: EntryExitTransition(1713).withTiming, exitingDuration: duration, logger: EntryExitTransition(1645).logger, callback: callbackV };
...
_inherits(EntryExitTransition, fn(1711).BaseAnimationBuilder);
const entry = {
  key: "entering",
