// Module ID: 1738
// Function ID: 1739
// Dependencies: [1640, 1647, 1680, 1739, 1740, 1644, 1648]
...
if (module_1640.shouldBeUseWeb()) {
  function maybeThrowError() {
    if (!obj.isJest()) {
      const reanimatedError = new tmp(1648).ReanimatedError("`UpdatePropsManager` is not available on non-native platform.");
