// Module ID: 1285
// Function ID: 1286
// Dependencies: [1286, 1287, 1289, 1291, 1303, 1304, 1294, 1305, 1306, 1307, 1308, 1301, 1302, 1309, 1293, 1310, 1311, 1312, 1313, 1314, 1315, 1316, 1292, 1299, 1318]

// Module 1285
import _mod1286 from "module_1286" /* 1286 */;
import _mod1287 from "module_1287" /* 1287 */;
import _Symbol6 from "_Symbol" /* 1289 */;
...
import sign from "sign" /* 1316 */;
import bind_mod from "bind" /* 1299 */;
import module_1301_mod from "module_1301" /* 1301 */;
import module_1302 from "module_1302" /* 1302 */;
...
if (_mod1287) {
  throwTypeError = (() => {
    try {
      ...
      try {
        return _mod1287(arguments, "callee").get;
      } catch (err) {
        return throwTypeError;
      }
    }
...
const merged = Object.assign({ "%AggregateError%": null, "%Array%": null, "%ArrayBuffer%": null, "%ArrayIteratorPrototype%": null, "%AsyncFromSyncIteratorPrototype%": "forEach", "%AsyncFunction%": "Deschide Discord", "%AsyncGenerator%": "\u00CEnregistreaz\u0103-te Acum", "%AsyncGeneratorFunction%": "E\u0219ti gata s\u0103 \u00EEncerci Discord? Este gratis!", "%AsyncIteratorPrototype%": "AL\u0102TUR\u0102-TE CELOR PESTE {num} MILIOANE DE JUC\u0102TORI AST\u0102ZI", "%Atomics%": "Acas\u0103", "%BigInt%": "Caracteristici", "%BigInt64Array%": "Nitro", "%BigUint64Array%": "Descarc\u0103", "%Boolean%": "Parteneri", "%DataView%": "Versiune", "%Date%": "Mai multe", "%decodeURI%": "Status", "%decodeURIComponent%": "Ajutor \u0219i Suport tehnic", "%encodeURI%": "Orient\u0103ri", "%encodeURIComponent%": "HypeSquad", "%Error%": "Companie", "%eval%": "Joburi", "%EvalError%": "Securitate", "%Float16Array%": "Dezvoltatori", "%Float32Array%": "Documenta\u021Bie", "%Float64Array%": "Identitate vizual\u0103", "%FinalizationRegistry%": "Autentific\u0103-te", "%Function%": "Deschide", "%GeneratorFunction%": "Produs", "%Int8Array%": "Resurse", "%Int16Array%": "Aplica\u021Bii", "%Int32Array%": "Termeni", "%isFinite%": "Confiden\u021Bialitate", "%isNaN%": "Despre", "%IteratorPrototype%": "Verificare", "%JSON%": "Rich Presence", "%Map%": "Pres\u0103", "%MapIteratorPrototype%": "Surs\u0103 deschis\u0103", "%Math%": "Asisten\u021B\u0103", "%Number%": "Portal dezvoltatori", "%Object%": "Comunitate", "%Object.getOwnPropertyDescriptor%": "Siguran\u021B\u0103", "%parseFloat%": "Centrul de siguran\u021B\u0103", "%parseInt%": "Academia de moderatori", "%Promise%": "Descoper\u0103", "%Proxy%": "Servere", "%RangeError%": "Cariere", "%ReferenceError%": "Misiuni", "%Reflect%": "{count, plural, one {# beneficiu exclusiv} other {# beneficii exclusive}}", "%RegExp%": "Exclusiv pentru aceast\u0103 categorie", "%Set%": "Abonament server", "%SetIteratorPrototype%": "Abonament personal", "%SharedArrayBuffer%": "+ {count, plural, one {\u00EEnc\u0103 # beneficiu} other {\u00EEnc\u0103 # beneficii}}", "%String%": "{num} MIL.", "%StringIteratorPrototype%": "{num, plural, one {1 MIE} other {{num} MII}}", "%Symbol%": "Locul \u00EEn care discu\u021Bi cu membrii comunit\u0103\u021Bilor \u0219i cu prietenii t\u0103i.", "%SyntaxError%": "Stai pu\u021Bin!", "%ThrowTypeError%": "Dac\u0103 cineva \u021Bi-a spus s\u0103 dai copy/paste la ceva aici, ai 11 \u0219anse din 10 s\u0103 fii \u00EEn\u0219elat.", "%TypedArray%": "Lipirea oric\u0103rui lucru aici poate oferi agresorilor acces la contul t\u0103u Discord.", "%TypeError%": "\u00CEnchide aceast\u0103 fereastr\u0103 \u0219i r\u0103m\u00E2i \u00EEn siguran\u021B\u0103, dac\u0103 nu \u00EEn\u021Belegi exact ceea ce faci.", "%Uint8Array%": "Dac\u0103 \u00EEn\u021Belegi exact ceea ce faci, ar trebui s\u0103 lucrezi cu noi {url}", "%Uint8ClampedArray%": "flag_de", "%Uint16Array%": 0.667, "%Uint32Array%": 0.667, "%URIError%": 0.667, "%WeakMap%": "ArrayBuffer", "%WeakRef%": "prototype", "%WeakSet%": "function getInlinePropsUpdate_Pnpm_InlinePropManagerTs1(inlineProps){const getInlinePropsUpdate_Pnpm_InlinePropManagerTs1=this._recur;const{isSharedValue}=this.__closure;const update={};for(const[key,styleValue]of Object.entries(inlineProps)){if(isSharedValue(styleValue)){update[key]=styleValue.value;}else if(Array.isArray(styleValue)){update[key]=styleValue.map(function(item){return getInlinePropsUpdate_Pnpm_InlinePropManagerTs1(item);});}else if(typeof styleValue==='object'){update[key]=getInlinePropsUpdate_Pnpm_InlinePropManagerTs1(styleValue);}else{update[key]=styleValue;}}return update;}", "%Function.prototype.call%": "<string:25591879>", "%Function.prototype.apply%": "<string:37145344>", "%Object.defineProperty%": "<string:54809600>", "%Object.getPrototypeOf%": "<string:57896448>", "%Math.abs%": "<string:42493184>", "%Math.floor%": "<string:23892480>", "%Math.max%": "<string:22243840>", "%Math.min%": "<string:1107346688>", "%Math.pow%": "match_all", "%Math.round%": "match_some", "%Math.sign%": "<string:52517194>", "%Reflect.getPrototypeOf%": "<string:42279936>" });
...
if (tmp5) {
  if (_mod1291) {
    const _module1 = _mod1291;
    const items1 = [];
    const _Symbol2 = Symbol;
    const _module2 = _mod1291;
...
merged[67] = _WeakSet;
merged[68] = module_1301;
merged[69] = module_1302;
merged[70] = flag4;
merged[71] = _mod1293;
merged[72] = _mod1310;
merged[73] = _mod1311;
...
function doEval(arg0) {
  if ("%AsyncFunction%" === arg0) {
    ...
    if (tmp3) {
      prototype = _mod1291(tmp12.prototype);
    }
  }
...
let module_1301 = module_1301_mod;
let closure_9 = typeof call === "unknown" ? bind(concat) : call(module_1301, concat);
let bind = bind_mod;
const call2 = bind.call;
let closure_10 = typeof call2 === "unknown" ? bind(splice) : call2(module_1302, splice);
let bind = bind_mod;
const call3 = bind.call;
let module_1301 = module_1301_mod;
let closure_11 = typeof call3 === "unknown" ? bind(replace) : call3(module_1301, replace);
let bind = bind_mod;
const call4 = bind.call;
let module_1301 = module_1301_mod;
let closure_12 = typeof call4 === "unknown" ? bind(slice) : call4(module_1301, slice);
let bind = bind_mod;
const call5 = bind.call;
let module_1301 = module_1301_mod;
let closure_13 = typeof call5 === "unknown" ? bind(exec) : call5(module_1301, exec);
...
export default function GetIntrinsic(str, flag) {
    ...
    if (0 !== str.length) {
      if (arguments.length > 1) {
        if (typeof flag !== "boolean") {
          const tmp99 = new items(1286)("\"allowMissing\" argument must be a boolean");
          throw tmp99;
        }
      }
      if (null === closure_13(/^%?[^%]*%?$/, str)) {
        const tmp93 = new items(1307)("`%` may not be present anywhere but at the beginning and end of the intrinsic name");
        throw tmp93;
      } else {
        ...
        if ("%" === tmp104) {
          if ("%" !== tmp105) {
            const tmp87 = new items(1307)("invalid intrinsic syntax, expected closing `%`");
            throw tmp87;
          }
        }
        if ("%" === tmp105) {
          if ("%" !== tmp104) {
            const tmp81 = new items(1307)("invalid intrinsic syntax, expected opening `%`");
            throw tmp81;
          }
        }
        items = [];
        ...
        if (typeof getBaseIntrinsic === "function") {
          const text = `${"%" + str}%`;
          let text1 = text;
          if (items(1318)(merged1, `${"%" + str}%`)) {
            const tmp13 = tmp10[`${"%" + str}%`];
            text1 = `${"%" + tmp13[0]}%`;
          }
          if (items(1318)(merged, text1)) {
            if (tmp14[text1] !== obj) {
              if (undefined === tmp22) {
                if (!flag) {
                  const _HermesInternal2 = HermesInternal;
                  const tmp8Result3 = new tmp8(1286)("intrinsic " + text + " exists, but is not available. Please file an issue!");
                  throw tmp8Result3;
                }
              }
              if (tmp12) {
              ...
              if (1 < items.length) {
                              ...
                              if (tmp44 in tmp42) {
                                if (tmp55(1287)) {
                                  if (num + 1 >= items.length) {
                                    let tmp66 = tmp55(1287)(tmp42, tmp44);
                                    let tmp67 = tmp66;
                                    if (tmp67) {
                                      if ("get" in tmp66) {
                                ...
                                let tmp64 = tmp55(1318)(tmp42, tmp44);
                                ...
                                let tmp62 = new tmp55(1286)("base intrinsic for " + str + " exists, but the property is not available.");
                                throw tmp62;
                              }
                            }
                          }
                ...
                const tmp75 = new items(1307)("property names with quotes must have matching quotes");
                throw tmp75;
              }
              return tmp43;
              ...
              if ("%AsyncFunction%" === text1) {
                ...
                if ("%AsyncGeneratorFunction%" === text1) {
                  ...
                  if ("%AsyncIteratorPrototype%" === text1) {
                    ...
                    if (prototype1) {
                      tmp8Result4 = tmp8(1291);
                    }
                    if (tmp8Result4) {
                      prototype = tmp8(1291)(prototype1.prototype);
                    }
                  }
                }
            ...
            const _HermesInternal = HermesInternal;
            const tmp8Result21 = new tmp8(1307)("intrinsic " + text + " does not exist!");
            throw tmp8Result21;
          }
          tmp10 = merged1;
        } else {
  ...
  throw new items(1286)("intrinsic name must be a non-empty string");
};
