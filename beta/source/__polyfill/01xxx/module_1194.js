    ...
    if (closure_7) {
      ...
      if ("0" == trimmed) {
        ...
        if (regex.test(trimmed)) {
          ...
          tmp24 = _slicedToArray(PbLong(1193).int64fromString(trimmed), 3);
        } else {
          const _Error3 = Error;
  ...
  },
  {
    ...
    value: function toString() {
      ...
      if (obj) {
        ...
        return "-" + PbLong(1193).int64toString(negateResult.lo, negateResult.hi);
      } else {
        obj = PbLong(1193);
  ...
  value: function from(trimmed) {
    ...
    if (closure_7) {
      ...
      if ("0" == trimmed) {
        ...
        trimmed = trimmed.trim();
        if (regex.test(trimmed)) {
          const obj3 = PbLong(1193);
          [tmp24, tmp26, tmp27] = PbLong(1193).int64fromString(trimmed);
