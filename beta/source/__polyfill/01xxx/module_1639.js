// Module ID: 1639
// Function ID: 1640
// Dependencies: [5, 32, 19, 17, 21, 1640, 1641, 1631, 1830, 1832, 1833, 1834]
...
const controlEdgeToEdgeValues = fn(1640);
let closure_12 = controlEdgeToEdgeValues.isEdgeToEdge();
let closure_13 = cancelAnimation.createAnimatedComponent(Animated.createAnimatedComponent(fn(1631).KeyboardControllerView));
...
export const KeyboardProvider = (enabled) => {
  ...
  closure_4 = require("module_1830").useAnimatedValue(0);
  let obj = require("module_1830");
  closure_5 = require("module_1830").useAnimatedValue(0);
  let obj2 = require("module_1830");
  ...
  Animated = require("module_1830").useEventHandlerRegistration(tmp3);
  const obj6 = require("module_1830");
  const obj7 = require("module_1830");
  ...
  let items = [enabled];
  const setInputHandlers = require("module_1830").useEventHandlerRegistration(tmp3);
  ...
  const obj9 = require("module_1832");
  const animatedKeyboardHandler = require("module_1832").useAnimatedKeyboardHandler(obj10, []);
  ...
  const obj11 = require("module_1832");
  closure_5(() => {
    if (closure_0) {
  ...
  obj14.onFocusedInputLayoutChangedReanimated = require("module_1832").useFocusedInputLayoutHandler(obj12, []);
