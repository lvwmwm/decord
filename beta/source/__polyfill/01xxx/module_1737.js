// Module ID: 1737
// Function ID: 1738
// Dependencies: [41, 42, 32, 1690, 1738, 1739, 1740, 1741, 1689]
...
function getInlinePropsUpdate(viewDescriptors) {
  ...
  while (tmp2 !== undefined) {
    ...
    [tmp6, tmp7] = tmp5;
    let iter = tmp7;
    let obj2 = InlinePropManager(1690);
...
getInlinePropsUpdate.__closure = { isSharedValue: fn(1690).isSharedValue };
  ...
  value: function attachInlineProps(self, self2) {
    ...
    if ((function inlinePropsHasChanged(arg0, _inlineProps) {
      ...
      if (!self._inlinePropsViewDescriptors) {
        self._inlinePropsViewDescriptors = _inlineProps(1739).makeViewDescriptorsSet();
        const viewConfig = self2.viewConfig;
        let _Object = Object;
        ({ viewTag, viewName, shadowNodeWrapper } = self2);
        const obj4 = _inlineProps(1739);
        const tmp7 = _inlineProps;
        if (tmp10) {
          tmp7(1740).adaptViewConfig(viewConfig);
          const tmp7Result = tmp7(1740);
        }
      ...
      const fn = function o() {
        obj = InlinePropManager(1741);
        obj.updateProps(dependencyMap, getInlinePropsUpdate(obj));
      };
      const obj6 = { getInlinePropsUpdate, newInlineProps: _inlineProps, updateProps: _inlineProps(1741).updateProps, shareableViewDescriptors };
      fn.__closure = obj6;
      fn.__workletHash = 4459550727912;
      fn.__initData = __initData;
      self._inlineProps = _inlineProps;
      if (self._inlinePropsMapperId) {
        tmp14(1689).stopMapper(self._inlinePropsMapperId);
        const tmp14Result = tmp14(1689);
      }
      self._inlinePropsMapperId = null;
      const _Object2 = Object;
      if (Object.keys(_inlineProps).length) {
        const _Object3 = Object;
        self._inlinePropsMapperId = tmp14(1689).startMapper(fn, Object.values(_inlineProps));
        const tmp14Result2 = tmp14(1689);
      }
    }
  }
};
  ...
  entry,
  {
    ...
    value: function detachInlineProps() {
      if (this._inlinePropsMapperId) {
        InlinePropManager(1689).stopMapper(tmp._inlinePropsMapperId);
        const obj = InlinePropManager(1689);
      }
    }
  }
];
