// Module ID: 1725
// Function ID: 1726
// Dependencies: [41, 42, 93, 95, 98, 1713, 1712]
...
_inherits(ComplexAnimationBuilder, fn(1712).BaseAnimationBuilder);
const entry = {
  key: "easing",
...
let items = [
  ...
  },
  {
    ...
    value: function springify(durationV) {
      return { durationV, type: ComplexAnimationBuilder(1713).withSpring };
    }
  },
  {
    key: "dampingRatio",
