// Module ID: 1851
// Function ID: 1852
// Dependencies: [5, 19, 21, 1641, 1849, 1852, 1835, 1831, 1631, 1853, 1854, 1855]
...
export default forwardRef((bottomOffset, arg1) => {
  ...
  const reanimatedFocusedInput = require("module_1835").useReanimatedFocusedInput();
  const input = reanimatedFocusedInput.input;
  const update = reanimatedFocusedInput.update;
  const obj10 = require("module_1835");
  ...
  let height = require("module_1835").useWindowDimensions().height;
  ...
  const obj17 = require("module_1835");
  M.__closure = { enabled: flag2, layout: sharedValue8, scrollViewTarget: sharedValue, height, keyboardHeight: sharedValue3, bottomOffset: num, interpolate: require("cancelAnimation").interpolate, initialKeyboardSize: sharedValue6, scrollDistanceWithRespectToSnapPoints: require("module_1853").scrollDistanceWithRespectToSnapPoints, scrollPosition: sharedValue1, snapToOffsets, scrollTo: require("cancelAnimation").scrollTo, scrollViewAnimatedRef: animatedRef, scrollViewPageY: sharedValue13 };
  ...
  closure_35 = tmp32;
  const items8 = [tmp32];
  const tmp33 = animatedRef(() => _mod1853.debounce(closure_35, 200), items8);
  closure_36 = tmp33;
  class N {
    constructor(arg0) {
      iter = closure_23;
  ...
  const items10 = [tmp34];
  require("module_1835").useFocusedInputHandler({ onSelectionChange: tmp34 }, items10);
  const obj22 = require("module_1835");
  ...
  require("module_1854").useSmoothKeyboardHandler(obj24, items11);
  ...
  const obj23 = require("module_1854");
  class De {
    constructor() {
      return input.value;
    }
