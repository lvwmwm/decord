// Module ID: 1795
// Function ID: 1796
// Dependencies: [32, 19, 1644, 1749, 1678, 1669, 1672, 1671]

// Module 1795
import findHostInstance from "findHostInstance" /* 1669 */;
import findNodeHandle from "findNodeHandle" /* 1749 */;
...
module_1644 = fn(1644);
module_1644 = module_1644.isIOS();
if (!module_1644) {
  module_1644 = fn(1644).isMacOS();
  const obj3 = fn(1644);
}
...
export const useAnimatedRef = module_1644 ? (function useAnimatedRefWeb() {
  const f84890 = (getScrollableNode) => {
