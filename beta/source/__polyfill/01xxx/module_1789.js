...
export const useAnimatedKeyboard = function useAnimatedKeyboard() {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = { isStatusBarTranslucentAndroid: "state", isNavigationBarTranslucentAndroid: "toCharArray$esjava$1" };
  }
  let ref2;
  let obj2;
  const tmp = ref2(null);
  ...
  ref2 = tmp3;
  if (null === tmp.current) {
    obj2 = { state: obj(1685).makeMutable(obj(1666).KeyboardState.UNKNOWN), height: null };
    const obj3 = obj(1685);
    obj2.height = obj(1685).makeMutable(0);
    const obj4 = obj(1685);
    ...
    fn.__initData = obj2;
    tmp2.current = obj(1685).subscribeForKeyboardEvents(fn, obj);
    tmp.current = obj2;
    tmp3.current = true;
    const obj5 = obj(1685);
  }
