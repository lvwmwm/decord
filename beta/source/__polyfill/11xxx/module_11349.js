// Module ID: 11349
// Function ID: 11350
// Dependencies: [5, 17, 11350, 11351, 11356, 11357, 11358, 11359, 11360]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11357 */;
import _modAll11358 from "module_11358" /* 11358 */;
import _modAll11359 from "module_11359" /* 11359 */;
import syncAll from "sync" /* 11360 */;
...
const subs = fn(11350).ProductType.subs;
const inapp = fn(11350).ProductType.inapp;
...
export const IapAndroid = _modAll11358;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11359;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11351).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11351.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11351.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11351.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11351.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11351.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11351).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11356).singleProductAndroidMap);
      return tmp2(11351).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11351).getAndroidModuleType();
      const androidModule = tmp2(11351).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11350).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11351).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11350).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11351).getAndroidModule();
            ...
            const androidModule1 = v3(11351).getAndroidModule();
