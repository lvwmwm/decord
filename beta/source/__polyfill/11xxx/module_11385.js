// Module ID: 11385
// Function ID: 11386
// Dependencies: [5, 17, 11386, 11387, 11392, 11393, 11394, 11395, 11396]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11393 */;
import _modAll11394 from "module_11394" /* 11394 */;
import _modAll11395 from "module_11395" /* 11395 */;
import syncAll from "sync" /* 11396 */;
...
const subs = fn(11386).ProductType.subs;
const inapp = fn(11386).ProductType.inapp;
...
export const IapAndroid = _modAll11394;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11395;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11387).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11387.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11387.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11387.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11387.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11387.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11387).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11392).singleProductAndroidMap);
      return tmp2(11387).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11387).getAndroidModuleType();
      const androidModule = tmp2(11387).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11386).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11387).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11386).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11387).getAndroidModule();
            ...
            const androidModule1 = v3(11387).getAndroidModule();
