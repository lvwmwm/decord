...
export const useIAP = () => {
  const iAPContext = require("module_11400").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11385").requestPurchase,
    requestSubscription: require("module_11385").requestSubscription
  };
};
