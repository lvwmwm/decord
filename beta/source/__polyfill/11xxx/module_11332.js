...
export const useIAP = () => {
  const iAPContext = require("module_11333").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11318").requestPurchase,
    requestSubscription: require("module_11318").requestSubscription
  };
};
