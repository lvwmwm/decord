...
export const horizontalStackLayout = function horizontalStackLayout(modeConfig) {
  ...
  fn.__closure = { screen, modeConfig, getCommonVariables, getCommonStyles, interpolate: modeConfig(1641).interpolate, Extrapolation: modeConfig(1641).Extrapolation };
