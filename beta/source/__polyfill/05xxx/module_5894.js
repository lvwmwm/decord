// Module ID: 5894
// Function ID: 5895
// Dependencies: [5892, 5895]

// Module 5894
import _mod5892 from "module_5892" /* 5892 */;
import swizzle from "swizzle" /* 5895 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5892")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5892");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5892")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5892)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
