// Module ID: 5162
// Function ID: 5163
// Dependencies: [109, 19, 17, 21, 5163, 5164, 5165]
// Exports: default
...
export default function TabsScreen(arg0) {
  ...
  const result = _mod5165.parseAndroidIconToNativeProps(icon);
  const tmp5Result = _mod5165;
  const result1 = _mod5165.parseAndroidIconToNativeProps(selectedIcon);
