// Module ID: 5862
// Function ID: 5863
// Dependencies: [5860, 5863]

// Module 5862
import _mod5860 from "module_5860" /* 5860 */;
import swizzle from "swizzle" /* 5863 */;

const require = globalThis.__r;

const obj2 = Object.create(null);
for (const key10013 in require("module_5860")) {
  let call = hasOwnProperty.call;
  let tmp4 = require("module_5860");
  ...
  if (!hasOwnPropertyResult) {
    ...
    obj2[require("module_5860")[key10013]] = key10013;
    continue;
  }
  continue;
}
          ...
          if (match3) {
            ...
            if (!match4) {
              ...
              if (typeof call === "unknown" ? tmp9(match4[1]) : call(tmp12, match4[1])) {
                const tmp15 = tmp10(5860)[match4[1]];
                tmp15[3] = 1;
                items1 = tmp15;
              }
              tmp10 = require;
