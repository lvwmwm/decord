// Module ID: 17672
// Function ID: 17673
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8765, 10149]
...
import emptyFunction_mod from "module_10149" /* 10149 */;
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = tmp23(tmp24(8765).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = tmp23(tmp24(8765).Path, obj5);
      }
      items[1] = tmp23Result3;
      items[2] = renderCapResult;
      obj3.children = items;
      size2.children = React5(CircularProgress(8765).G, obj3);
      const items1 = [timestampProducer(CircularProgress(8765).Svg, size2), ];
