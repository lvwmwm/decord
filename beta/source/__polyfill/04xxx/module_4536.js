// Module ID: 4536
// Function ID: 4537
// Dependencies: [19, 4525, 4529, 4517]
// Exports: useViewModelInstance

// Module 4536
import ArtboardByIndex from "ArtboardByIndex" /* 4525 */;
...
export const useViewModelInstance = function useViewModelInstance(arg0, instanceName) {
  ...
  const disposableMemo = require("module_4529").useDisposableMemo(() => {
    if (closure_0) {
      let tmp6 = null != obj;
      if (tmp6) {
