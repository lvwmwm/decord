// Module ID: 4565
// Function ID: 4566
// Dependencies: [32, 19, 568, 4560, 4555]
...
const RiveColor2 = tmp(4555);
require = fn;
fn(19).useCallback;
const f31384 = (colorProperty, arg1) => colorProperty.colorProperty(arg1);

export const useRiveColor = function useRiveColor(arg0, arg1) {
  const cResult = c.c(8);
  const tmp4 = _slicedToArray(_mod4560.useRiveProperty(arg1, arg0, f31384), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
