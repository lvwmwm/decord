// Module ID: 4097
// Function ID: 4098
// Dependencies: [4025, 4047, 4052, 4095, 3849, 4098, 4099, 4012, 3850, 3854]
// Exports: default
...
import cloneObject_mod from "cloneObject" /* 4098 */;
...
if (!module_4012) {
  const obj8 = { default: module_4012 };
  let tmp17 = obj8;
} else {
  tmp17 = module_4012;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_4012.default(defaultResult5) - module_4012.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_4012.default(defaultResult5);
    }
  } else {
