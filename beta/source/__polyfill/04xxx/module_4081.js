// Module ID: 4081
// Function ID: 4082
// Dependencies: [4031, 4082, 3849, 4083, 4094, 4012, 3853, 3850, 4095, 3854, 4096]
// Exports: default

// Module 4081
import throwProtectedError from "throwProtectedError" /* 4096 */;
...
import G from "G" /* 4083 */;
import dateLongFormatter_mod from "dateLongFormatter" /* 4094 */;
...
if (!module_3853) {
  const obj7 = { default: module_3853 };
  let tmp15 = obj7;
} else {
  tmp15 = module_3853;
}
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = require("module_3854").getDefaultOptions();
  let locale1;
  if (null != locale) {
  ...
  if (defaultResult1 >= 1) {
    if (defaultResult1 <= 7) {
      ...
      const defaultResult2 = module_3853.default(num4);
      if (defaultResult2 >= 0) {
        if (defaultResult2 <= 6) {
          if (locale1.localize) {
            if (locale1.formatLong) {
              const defaultResult3 = _typeof.default(arg0);
              if (module_4031.default(defaultResult3)) {
                _typeof = locale1.default(defaultResult3, module_4012.default(defaultResult3));
