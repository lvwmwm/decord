// Module ID: 4587
// Function ID: 4588
// Dependencies: [19, 4588, 1112, 1113, 1106, 4591]
...
export const MemoryRouter = Component2(4591).MemoryRouter;
export const Prompt = Component2(4591).Prompt;
export const Redirect = Component2(4591).Redirect;
export const Route = Component2(4591).Route;
export const Router = Component2(4591).Router;
export const StaticRouter = Component2(4591).StaticRouter;
export const Switch = Component2(4591).Switch;
export const generatePath = Component2(4591).generatePath;
export const matchPath = Component2(4591).matchPath;
export const useHistory = Component2(4591).useHistory;
export const useLocation = Component2(4591).useLocation;
export const useParams = Component2(4591).useParams;
export const useRouteMatch = Component2(4591).useRouteMatch;
export const withRouter = Component2(4591).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4591).matchPath(_location.pathname, obj2);
          const obj = Component2(4591);
        }
