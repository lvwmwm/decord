// Module ID: 4636
// Function ID: 4637
// Dependencies: [32, 19, 21, 4637, 4633, 4632, 4634]

// Module 4636
import _mod4632 from "module_4632" /* 4632 */;
import ACTIONS from "ACTIONS" /* 4633 */;
import PortalHost from "PortalHost" /* 4634 */;
import registerHost from "registerHost" /* 4637 */;
...
const memoResult = memo((rootHostName) => {
  ...
  items[1] = flag;
  obj2.children = items;
  obj.children = hasOwnProperty(_mod4632.PortalStateContext.Provider, obj2);
  return React4(_mod4632.PortalDispatchContext.Provider, obj);
});
