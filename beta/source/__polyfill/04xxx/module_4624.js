// Module ID: 4624
// Function ID: 4625
// Dependencies: [19, 4620, 1112, 1113, 4625, 4627, 4629, 1106]
...
import parse_mod from "module_4625" /* 4625 */;
import AsyncMode from "AsyncMode" /* 4627 */;
import module_4629_mod from "module_4629" /* 4629 */;
...
let module_4629 = module_4629_mod;
if (module_4629) {
  if (typeof module_4629 === "object") {
    if ("default" in module_4629) {
      module_4629 = module_4629.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F153896 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4629(fn, displayName);
};
