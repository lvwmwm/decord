// Module ID: 4671
// Function ID: 4672
// Dependencies: [32, 19, 21, 4672, 4668, 4667, 4669]

// Module 4671
import _mod4667 from "module_4667" /* 4667 */;
import ACTIONS from "ACTIONS" /* 4668 */;
import PortalHost from "PortalHost" /* 4669 */;
import registerHost from "registerHost" /* 4672 */;
...
const memoResult = memo((rootHostName) => {
  ...
  items[1] = flag;
  obj2.children = items;
  obj.children = hasOwnProperty(_mod4667.PortalStateContext.Provider, obj2);
  return React4(_mod4667.PortalDispatchContext.Provider, obj);
});
