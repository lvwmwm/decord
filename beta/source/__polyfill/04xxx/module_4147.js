// Module ID: 4147
// Function ID: 4148
// Dependencies: [4091, 4078, 3845, 4095, 4090, 4008, 3849, 3846, 3850, 4148, 4092, 4149]
// Exports: default

// Module 4147
import throwProtectedError from "throwProtectedError" /* 4092 */;
import parsers from "parsers" /* 4149 */;
  ...
  if (locale1.match) {
    ...
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        ...
        const defaultResult2 = module_3849.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(4148).DateToSystemTimezoneSetter();
