// Module ID: 4129
// Function ID: 4130
// Dependencies: [4057, 4079, 4084, 4127, 3881, 4130, 4131, 4044, 3882, 3886]
// Exports: default
...
if (!module_4044) {
  const obj8 = { default: module_4044 };
  let tmp17 = obj8;
} else {
  tmp17 = module_4044;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_4044.default(defaultResult5) - module_4044.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_4044.default(defaultResult5);
    }
  } else {
