// Module ID: 4568
// Function ID: 4569
// Dependencies: [19, 4557, 4561, 4549]
// Exports: useViewModelInstance

// Module 4568
import ArtboardByIndex from "ArtboardByIndex" /* 4557 */;
...
export const useViewModelInstance = function useViewModelInstance(arg0, instanceName) {
  ...
  const disposableMemo = require("module_4561").useDisposableMemo(() => {
    if (closure_0) {
      let tmp6 = null != obj;
      if (tmp6) {
