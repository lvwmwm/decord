// Module ID: 4093
// Function ID: 4094
// Dependencies: [4021, 4043, 4048, 4091, 3845, 4094, 4095, 4008, 3846, 3850]
// Exports: default
...
if (!module_4008) {
  const obj8 = { default: module_4008 };
  let tmp17 = obj8;
} else {
  tmp17 = module_4008;
}
...
export default function formatDistance(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const _Math = Math;
      const rounded = Math.round((defaultResult6 - (module_4008.default(defaultResult5) - module_4008.default(defaultResult4)) / 1000) / 60);
      if (rounded < 2) {
        if (null != locale) {
      ...
      const defaultResult7 = module_4008.default(defaultResult5);
    }
  } else {
