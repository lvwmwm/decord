// Module ID: 4639
// Function ID: 4640
// Dependencies: [32, 19, 21, 4640, 4636, 4635, 4637]

// Module 4639
import _mod4635 from "module_4635" /* 4635 */;
import ACTIONS from "ACTIONS" /* 4636 */;
import PortalHost from "PortalHost" /* 4637 */;
import registerHost from "registerHost" /* 4640 */;
...
const memoResult = memo((rootHostName) => {
  ...
  items[1] = flag;
  obj2.children = items;
  obj.children = hasOwnProperty(_mod4635.PortalStateContext.Provider, obj2);
  return React4(_mod4635.PortalDispatchContext.Provider, obj);
});
