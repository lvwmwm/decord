// Module ID: 4133
// Function ID: 4134
// Dependencies: [4111, 4112, 4065, 3850, 3853, 3854]
// Exports: default
...
export default function getWeekOfMonth(arg0, weekStartsOn) {
  ...
  if (defaultResult1 >= 0) {
    if (defaultResult1 <= 6) {
      const defaultResult2 = module_4111.default(arg0);
      const _isNaN = isNaN;
      if (isNaN(defaultResult2)) {
        return NaN;
      } else {
        const diff = defaultResult1 - module_4112.default(startOfMonth.default(arg0));
        let sum = diff;
        if (diff <= 0) {
          sum = diff + 7;
        }
