...
let fn = () => {
  let handler = function r(arg0, _exports22, firstResult) {
    let fn;
    let _exports = arg0;
    const dependencyMap = _exports22;
        ...
        constructor(arg0) {
          ...
          if (typeof global !== "function") {
            ...
            if (obj.shouldCatchExceptions(obj1)) {
              ...
              catchPromise = _promise.catch(/* F152818 */ function() { ... });
            }
        ...
        arg0.loadAxo = function loadAxo(arg0) {
          ...
          const f152835 = () => {
            ...
            if (typeof Symbol === "function") {
              let _Symbol = Symbol;
              obj[Symbol.iterator] = /* F152829 */ function() { ... };
            }
            return obj;
          };
  ...
  const items41 = [
    function(arg0, arg1, arg2) {
      ...
      closure_0 = fn;
      const dependencyMap = global("./lib/card-types");
      ...
      class Framebus {
        ...
        targetFramesAsWindows() {
          if (this.limitBroadcastToFramesArray) {
            ...
            found = mapped.filter(/* F152842 */ function() { ... });
          } else {
            found = [];
          }
          return found;
        ...
        hasMatchingTargetFrame(arg0) {
          ...
          if (this.limitBroadcastToFramesArray) {
            ...
            tmp = globalThis;
            _Boolean = Boolean;
            return Boolean(result.find(/* F152843 */ function() { ... }));
          } else {
            flag = true;
            return true;
          }
    ...
    (arg0, arg1, arg2) => {
      class ApplePay {
        ...
        _createPaymentRequestSynchronously(arg0) {
          ...
          obj.supportedNetworks = supportedNetworks.map(/* F149095 */ function() { ... });
  ...
  const items156 = [
    (arg0, arg1, arg2) => {
      ...
      constants2 = global("../shared/errors");
    ...
    (arg0, arg1, arg2) => {
      ...
      module.exports = {
        atob(placeholder) {
          ...
          const _window = window;
          return typeof call === "unknown" ? _atob(placeholder) : call(_window, placeholder);
        },
        _atob: atobPolyfill
      };
    },
  ...
  const items186 = [
    (arg0, arg1, arg2) => {
      ...
      constants2 = global("../shared/constants");
      const INTEGRATION_TIMEOUT_MS = global("../../lib/constants").INTEGRATION_TIMEOUT_MS;
    ...
    (arg0, arg1, arg2) => {
      class PayPalCheckout {
        ...
        teardown() {
          ...
          catchPromise = _frameServicePromise.catch(/* F149260 */ function() { ... });
    ...
    (arg0, arg1, arg2) => {
      class InlineIframeFramework {
        ...
        _addV1IframeToPage() {
          ...
          _emitResult = this._emit(InlineIframeFramework.events.AUTHENTICATION_IFRAME_AVAILABLE, obj, /* F149306 */ function() { ... });
          return;
        }
    ...
    (arg0, arg1, arg2) => {
      class SongbirdFramework {
        ...
        prepareLookup(arg0) {
          ...
          nextPromise1 = nextPromise.then(() => { ... });
          catchPromise = nextPromise1.catch(/* F149320 */ function() { ... });
  ...
  const items244 = [
    (arg0, arg1, arg2) => {
      ...
      constants2 = global("./external/queries");
      c18 = "3.112.1";
