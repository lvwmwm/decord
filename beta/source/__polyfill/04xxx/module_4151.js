// Module ID: 4151
// Function ID: 4152
// Dependencies: [4095, 4082, 3849, 4099, 4094, 4012, 3853, 3850, 3854, 4152, 4096, 4153]
// Exports: default

// Module 4151
import throwProtectedError from "throwProtectedError" /* 4096 */;
import parsers from "parsers" /* 4153 */;
  ...
  if (locale1.match) {
    ...
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        ...
        const defaultResult2 = module_3853.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(4152).DateToSystemTimezoneSetter();
