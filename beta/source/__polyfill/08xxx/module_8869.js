// Module ID: 8869
// Function ID: 8870
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8781, 8870, 8780, 8789]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8781).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8780).withoutXY(this, props));
