// Module ID: 8554
// Function ID: 8555
// Dependencies: [8555, 32, 109, 19, 17, 8556, 21, 8558, 8559, 8560]
...
const _slicedToArray = module_8555(_mod32);
const _objectWithoutProperties = module_8555(_objectWithoutProperties2);
...
const __INTERNAL_VIEW_CONFIG = module_8555(_mod8556);
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (undefined === SLIDER_DEFAULT_INITIAL_VALUE) {
    SLIDER_DEFAULT_INITIAL_VALUE = _mod8558.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (undefined === lowerLimit) {
    ...
    const obj = { web: num, default: _mod8558.constants.LIMIT_MIN_VALUE };
  ...
  if (undefined === upperLimit) {
    ...
    const obj2 = { web: num2, default: _mod8558.constants.LIMIT_MAX_VALUE };
  ...
  if (null == SLIDER_DEFAULT_INITIAL_VALUE2) {
    SLIDER_DEFAULT_INITIAL_VALUE2 = _mod8558.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (!num3) {
    DEFAULT_STEP_RESOLUTION = _mod8558.constants.DEFAULT_STEP_RESOLUTION;
  }
  ...
  if ("ios" === get_ActivityIndicator.Platform.OS) {
    let defaultSlider = _mod8559.styles.defaultSlideriOS;
    let tmp24 = require;
  } else {
    tmp24 = require;
    defaultSlider = _mod8559.styles.defaultSlider;
  }
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = obj6.jsx(tmp24(8560).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
