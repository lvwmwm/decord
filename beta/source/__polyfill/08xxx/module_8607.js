// Module ID: 8607
// Function ID: 8608
// Dependencies: [19, 17, 21, 113, 8608, 39, 38, 8610, 8611]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8610").container, require("module_8610").webView, style];
  const items4 = [require("module_8610").container, containerStyle];
