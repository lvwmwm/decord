// Module ID: 8737
// Function ID: 8738
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 8738, 8739, 8740, 8741, 8745, 8746, 8747, 8757]

// Module 8737
import extractOpacityDefault from "extractOpacity" /* 8739 */;
import extractResponderDefault from "extractResponder" /* 8740 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8738).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8738).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8757);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8741).extractTransformSvgView(tmp);
      const obj3 = Svg(8741);
    }
    const obj4 = {};
    ...
    const merged4 = Object.assign(tmp21(8746)({ viewBox, preserveAspectRatio }));
    obj4.children = jsx(_modDef8747, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8745, {});
  }
};
let items = [entry];
