// Module ID: 8830
// Function ID: 8831
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 21, 8736, 8744, 8750, 8743, 8831, 8827, 8752]
...
class TextPath {
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(matrix, TextPath(8744).pickNotNil(extractFontDefault(matrix, true)));
      if (closure_0.root) {
...
_inherits(TextPath, _modDef8752);
const entry = {
  key: "render",
  value: function render() {
    ...
    let match = href;
    if (href) {
      match = href.match(TextPath(8744).idPattern);
    }
    let tmp5 = match;
    if (match) {
      tmp5 = match[1];
    ...
    if (tmp5) {
      const withoutXYResult = TextPath(8743).withoutXY(self, tmp);
      ...
      const obj5 = {};
      const obj2 = TextPath(8743);
      const merged1 = Object.assign(withoutXYResult);
      return jsx(_modDef8831, {});
    } else {
      ...
      return jsx(_modDef8827, { ref: self.refMethod, children });
    }
