// Module ID: 8575
// Function ID: 8576
// Dependencies: [19, 17, 21, 113, 8576, 39, 38, 8578, 8579]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8578").container, require("module_8578").webView, style];
  const items4 = [require("module_8578").container, containerStyle];
