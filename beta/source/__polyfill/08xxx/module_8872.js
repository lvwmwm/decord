// Module ID: 8872
// Function ID: 8873
// Dependencies: [5, 41, 42, 93, 95, 98, 32, 19, 21, 8873, 8874]
...
export { SvgAst };
export { SvgXml };
export const SvgUri = function SvgUri(c2) {
  let onError = c2.onError;
  if (undefined === onError) {
    onError = closure_13;
  }
  const uri = c2.uri;
  const onLoad = c2.onLoad;
  let fallback = c2.fallback;
  ...
  if (first) {
    ...
    let obj = { xml: tmp2[0], override: c2, fallback };
...
export const tags = fn(8873).tags;
