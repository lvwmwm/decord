// Module ID: 8838
// Function ID: 8839
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8780, 8839, 8789]
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ x1, y1, x2, y2 } = props);
    const merged = Object.assign(Line(8780).extract(this, props));
    obj.x1 = x1;
    obj.y1 = y1;
    obj.x2 = x2;
    obj.y2 = y2;
    const obj2 = Line(8780);
    const obj3 = {
      ref(arg0) {
