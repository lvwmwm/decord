// Module ID: 8570
// Function ID: 8571
// Dependencies: [19, 17, 21, 113, 8571, 39, 38, 8573, 8574]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8573").container, require("module_8573").webView, style];
  const items4 = [require("module_8573").container, containerStyle];
