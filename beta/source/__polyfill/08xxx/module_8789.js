// Module ID: 8789
// Function ID: 8790
// Dependencies: [93, 95, 98, 41, 42, 19, 17, 8790, 8783, 8791, 8792]
...
let items = [
  ...
  },
  {
    ...
    value: function scale(translateY) {
      const obj2 = Object.create(Shape.prototype);
      hasOwnProperty(obj2, Shape);
      ({ a: tmp.a, b: tmp.b, c: tmp.c, d: tmp.d, e: tmp.e, f: tmp.f } = { a: this.a * translateY, c: this.c * translateY, e: this.e, b: this.b * translateY, d: this.d * translateY, f: this.f });
      return obj2;
    }
  },
  {
  ...
  constructor(arg0) {
    ...
    tmp3Result.setNativeProps = (obj) => {
      for (const key10004 in arg0) {
        let BrushProperties = Shape(8790).BrushProperties;
    ...
    tmp3Result.getBBox = (arg0) => {
      ...
      return Shape(8791).default.getBBox(tmp5, { fill: fill2, stroke: stroke2, markers: markers2, clipped: clipped2 });
    };
    tmp3Result.getCTM = () => {
      const tmp = findNodeHandle(closure_0.root);
      const _default = Shape(8791).default;
      return new importDefaultResult1Result(Shape(8791).default.getCTM(tmp));
    };
    tmp3Result.getScreenCTM = () => {
      const tmp = findNodeHandle(closure_0.root);
      const _default = Shape(8791).default;
      return new importDefaultResult1Result(Shape(8791).default.getScreenCTM(tmp));
    };
    tmp3Result.isPointInFill = (arg0) => {
      const tmp = findNodeHandle(closure_0.root);
      return Shape(8791).default.isPointInFill(tmp, arg0);
    };
    tmp3Result.isPointInStroke = (arg0) => {
      const tmp = findNodeHandle(closure_0.root);
      return Shape(8791).default.isPointInStroke(tmp, arg0);
    };
    tmp3Result.getTotalLength = () => {
      const tmp = findNodeHandle(closure_0.root);
      return Shape(8791).default.getTotalLength(tmp);
    };
    tmp3Result.getPointAtLength = (length) => {
      const tmp = findNodeHandle(closure_0.root);
      const _default = Shape(8791).default;
      const obj = { length };
      return new importDefaultResult1Result1(Shape(8791).default.getPointAtLength(tmp, { length }));
    };
