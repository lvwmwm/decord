// Module ID: 8836
// Function ID: 8837
// Dependencies: [41, 42, 93, 95, 98, 19, 17, 21, 8778, 8837, 8780, 8789]
...
_inherits(SvgImage, _modDef8789);
const entry = {
  key: "render",
  value: function render() {
    ...
    const size = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: SvgImage(8778).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
    [tmp2, tmp3] = parts;
    const tmp6 = SvgImage(8778).meetOrSliceTypes[tmp3] || 0;
    size.align = SvgImage(8778).alignEnum[tmp2] || "xMidYMid";
    ...
    const tmp7 = SvgImage(8778).alignEnum[tmp2] || "xMidYMid";
    const merged = Object.assign(SvgImage(8780).withoutXY(this, props));
