// Module ID: 8837
// Function ID: 8838
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8749, 8838, 8748, 8757]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8749).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8748).withoutXY(this, props));
