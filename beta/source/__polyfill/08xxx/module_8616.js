// Module ID: 8616
// Function ID: 8617
// Dependencies: [5, 41, 42, 93, 95, 98, 19, 17, 21, 81, 8617, 4620, 8619, 8620, 8621, 8639]
      ...
      if (closure_0.props.drm) {
        ...
        if (tmp.props.drm.getLicense instanceof Function) {
          ...
          if (React5.VideoManager.setLicenseError) {
            ...
            VideoManager.setLicenseError("No spc received", v65535(tmp._root));
          }
        }
      }
    };
...
let items = [
  ...
  },
  {
    ...
    value: function render() {
      ...
      const items1 = [__initData(closure_16, obj5), ];
      let showPoster = self.state.showPoster;
      if (showPoster) {
        const obj6 = { style: obj3, source: null };
        const obj7 = { uri: self.props.poster };
        obj6.source = obj7;
        showPoster = __initData(options, obj6);
      }
      items1[1] = showPoster;
      obj4.children = items1;
      return __initData2(closure_1_8, obj4);
    }
  }
];
...
let items1 = [_modDef8619.NONE, _modDef8619.INVERT, _modDef8619.MONOCHROME, _modDef8619.POSTERIZE, _modDef8619.FALSE, _modDef8619.MAXIMUMCOMPONENT, _modDef8619.MINIMUMCOMPONENT, _modDef8619.CHROME, _modDef8619.FADE, _modDef8619.INSTANT, _modDef8619.MONO, _modDef8619.NOIR, _modDef8619.PROCESS, _modDef8619.TONAL, _modDef8619.TRANSFER, _modDef8619.SEPIA];
...
let emptyFunction = emptyFunction_mod;
const items4 = [_modDef8620.CLEARKEY, _modDef8620.FAIRPLAY, _modDef8620.WIDEVINE, _modDef8620.PLAYREADY];
...
obj.posterResizeMode = fn(8621).ImagePropTypes.resizeMode;
...
let emptyFunction = emptyFunction_mod;
const items8 = [_modDef8639.SRT, _modDef8639.TTML, _modDef8639.VTT];
...
let merged = Object.assign(fn(8621).ViewPropTypes);
...
export const TextTrackType = _modDef8639;
export const FilterType = _modDef8619;
export const DRMType = _modDef8620;
