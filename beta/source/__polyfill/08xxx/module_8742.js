// Module ID: 8742
// Function ID: 8743
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8736, 8743, 8750, 8751, 8752]
...
_inherits(G, _modDef8752);
const entry = {
  key: "render",
  value: function render() {
    const self = this;
    const props = this.props;
    const propsAndStylesResult = G(8743).propsAndStyles(props);
    const tmp5 = extractPropsDefault(propsAndStylesResult, this);
    const obj = G(8743);
    const extractFontResult = G(8750).extractFont(propsAndStylesResult);
