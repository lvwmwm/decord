// Module ID: 8747
// Function ID: 8748
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8741, 8748, 8755, 8756, 8757]
...
_inherits(G, _modDef8757);
const entry = {
  key: "render",
  value: function render() {
    const self = this;
    const props = this.props;
    const propsAndStylesResult = G(8748).propsAndStyles(props);
    const tmp5 = extractPropsDefault(propsAndStylesResult, this);
    const obj = G(8748);
    const extractFontResult = G(8755).extractFont(propsAndStylesResult);
