...
// Dependencies: [1277, 1278, 1324, 1325, 1326, 1327, 1328]
// Exports: agent, del, delete, get, getXHR, head, options, parseString, patch, post, put, serializeObject

// Module 1276 (_createForOfIteratorHelper)
import _mod1278 from "module_1278" /* 1278 */;
import defaultOptions from "defaultOptions" /* 1324 */;
import ResponseBase from "ResponseBase" /* 1325 */;
import Emitter from "Emitter" /* 1326 */;
import RequestBase from "RequestBase" /* 1327 */;
import _mod1328 from "module_1328" /* 1328 */;
import _createForOfIteratorHelper_mod from "module_1277" /* 1277 */;
...
if (0 < items.length) {
  do {
    str2 = items[num2];
    _mod1328.prototype[str2.toLowerCase()] = function(arg0, arg1) {
...
_mod1328.prototype.del = _mod1328.prototype.delete;
...
export const serialize = { "application/x-www-form-urlencoded": _mod1278.stringify, "application/json": defaultOptions };
export const parse = { "application/x-www-form-urlencoded": parseString, "application/json": JSON.parse };
export { Response };
export const agent = () => new str2(1328)();
