...
// Function ID: 11542
// Name: _saveDocuments
// Dependencies: [5, 17, 11534]
// Exports: saveDocuments

// Module 11541 (_saveDocuments)
...
let closure_3 = async function _saveDocuments() {
  ...
  await asyncGeneratorStep(async () => {
    ...
    const NativeDocumentPicker2 = tmp2(11534).NativeDocumentPicker;
    closure_128_0 = await NativeDocumentPicker2.saveDocument(tmp2);
    const NativeDocumentPicker = tmp2(11534).NativeDocumentPicker;
