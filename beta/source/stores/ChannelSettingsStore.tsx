...
// Dependencies: [2049, 8656, 1390, 2045, 1078, 1118, 4411, 4413, 2054, 2055, 1275, 577, 12, 2059, 4352, 504, 2]

// Module 10631 (ChannelSettingsStore)
...
function _createInvite(code) {
  ...
  obj.createdAt = _modDef4352(code.created_at);
