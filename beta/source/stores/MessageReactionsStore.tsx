...
// Dependencies: [4400, 1390, 2045, 1376, 8010, 504, 8011, 577, 2]

// Module 8009 (MessageReactionsStore)
...
const dependencyMap = {};
const items = [fn(8010).ReactionTypes.NORMAL, fn(8010).ReactionTypes.BURST];
