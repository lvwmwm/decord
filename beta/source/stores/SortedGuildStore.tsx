...
// Dependencies: [4581, 4400, 1224, 5658, 5108, 2109, 2067, 1077, 4939, 1376, 5659, 1335, 38, 1374, 2021, 2]
...
function convertNodeToGuildFolder(type) {
  ...
  if (obj42(5659).GuildsNodeType.FOLDER === type) {
    ...
    return obj3;
  } else if (tmp(5659).GuildsNodeType.GUILD === type) {
  ...
  if (null != node) {
    if (null != node1) {
      ...
      if (combine) {
        ...
        if (node1.type !== tmp13(5659).GuildsNodeType.FOLDER) {
