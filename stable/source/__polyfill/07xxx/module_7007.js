// Module ID: 7007
// Function ID: 7008
// Dependencies: [17, 19, 21, 6975, 7008, 7009, 7010]
...
import CompatScroller from "CompatScroller" /* 7010 */;
...
export const useSecondaryProps = function useSecondaryProps(ListHeaderComponent) {
  ...
  let tmp7 = ListEmptyComponentStyle(() => {
    ...
    if (ListHeaderComponent) {
      ...
      obj.style = items;
      obj.children = _mod7009.getValidComponent(tmp);
  ...
  obj2.renderStickyHeaderBackdrop = ListEmptyComponentStyle(() => {
    ...
    if (backdropComponent) {
      ...
      obj.children = _mod7009.getValidComponent(backdropComponent1);
