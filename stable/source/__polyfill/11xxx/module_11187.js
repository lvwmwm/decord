// Module ID: 11187
// Function ID: 11188
// Dependencies: [5, 17, 11188, 11189, 11194, 11195, 11196, 11197, 11198]
...
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 11195 */;
import _modAll11196 from "module_11196" /* 11196 */;
import _modAll11197 from "module_11197" /* 11197 */;
import syncAll from "sync" /* 11198 */;
...
const subs = fn(11188).ProductType.subs;
const inapp = fn(11188).ProductType.inapp;
...
export const IapAndroid = _modAll11196;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11197;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11189).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11189.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11189.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11189.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11189.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11189.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11189).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = arg1.map(tmp2(11194).singleProductAndroidMap);
      return tmp2(11189).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11189).getAndroidModuleType();
      const androidModule = tmp2(11189).getAndroidModule();
      closure_128_1 = await androidModule.getItemsByType(closure_1_6, skus);
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11188).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      closure_128_2 = await tmp2(11189).fillProductsWithAdditionalData(closure_128_2);
      return addSubscriptionPlatform(closure_128_2, tmp2(11188).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11189).getAndroidModule();
            ...
            const androidModule1 = v3(11189).getAndroidModule();
