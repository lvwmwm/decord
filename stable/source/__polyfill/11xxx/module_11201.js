...
export const useIAP = () => {
  const iAPContext = require("module_11202").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("module_11187").requestPurchase,
    requestSubscription: require("module_11187").requestSubscription
  };
};
