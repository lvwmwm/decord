// Module ID: 8417
// Function ID: 8418
// Dependencies: [19, 17, 21, 113, 8418, 39, 38, 8420, 8421]
...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8420").container, require("module_8420").webView, style];
  const items4 = [require("module_8420").container, containerStyle];
