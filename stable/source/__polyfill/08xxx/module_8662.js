// Module ID: 8662
// Function ID: 8663
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8663, 8658, 8598]
  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (points) => {
      ...
      if (points) {
        ...
        points.d = "M" + Polygon(8663)(points) + "z";
      }
      if (closure_0.root) {
...
const entry = {
  ...
  value: function render() {
    ...
    if (points) {
      const _HermesInternal = HermesInternal;
      combined = "M" + Polygon(8663)(points) + "z";
    }
    obj.d = combined;
    const merged = Object.assign(props);
    return jsx(Polygon(8658), { ref: this.refMethod, d: null });
  }
};
let items = [entry];
