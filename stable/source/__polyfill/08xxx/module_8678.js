// Module ID: 8678
// Function ID: 8679
// Dependencies: [41, 42, 93, 95, 98, 19, 21, 8590, 8679, 8589, 8598]
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8590).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8589).withoutXY(this, props));
