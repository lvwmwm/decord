// Module ID: 8396
// Function ID: 8397
// Dependencies: [8397, 32, 109, 19, 17, 8398, 21, 8400, 8401, 8402]
...
const _slicedToArray = module_8397(_mod32);
const _objectWithoutProperties = module_8397(_objectWithoutProperties2);
...
const __INTERNAL_VIEW_CONFIG = module_8397(_mod8398);
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (undefined === SLIDER_DEFAULT_INITIAL_VALUE) {
    SLIDER_DEFAULT_INITIAL_VALUE = _mod8400.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (null == SLIDER_DEFAULT_INITIAL_VALUE2) {
    SLIDER_DEFAULT_INITIAL_VALUE2 = _mod8400.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if ("ios" === get_ActivityIndicator.Platform.OS) {
    ...
    tmp24 = require;
    defaultSlider = _mod8401.styles.defaultSlider;
  }
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = obj6.jsx(tmp24(8402).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
