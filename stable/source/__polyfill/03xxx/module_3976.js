// Module ID: 3976
// Function ID: 3977
// Dependencies: [3888, 3901, 3725, 3974, 3975, 3971, 3726, 3730]
// Exports: default
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_3888.default(defaultResult5) - module_3888.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_3888.default(defaultResult5);
    }
  } else {
