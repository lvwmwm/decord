// Module ID: 13041
// Function ID: 13042
// Dependencies: [32, 5, 12928, 13042, 12936, 12931, 12944, 12937]
...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(arg0, arg1) {
      ...
      const obj = _mod12928;
      obj2.endTimestamp = 1000 * _mod12944.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  _mod12928.addHandler("fetch-body-resolved", arg0);
  _mod12928.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(12936).fill(closure_0(12931).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
              ...
              try {
                ...
                if (arg0 === 1) {
                  ...
                  if (stack) {
                    ...
                    obj = stack(12928);
                    obj5.endTimestamp = 1000 * stack(12944).timestampInSeconds();
                    obj5.response = tmp16;
                    obj.triggerHandlers("fetch", obj5);
                    const obj3 = stack(12944);
                  }
                  c1 = 3;
                }
              } catch (tmp11) {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(12928);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(12944).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(12944);
            const tmp = closure_3_0;
            const obj4 = closure_3_0(12937);
            if (tmp5) {
              error.stack = stack.stack;
              const result = tmp(12936).addNonEnumerableProperty(error, "framesToPop", 1);
      ...
      const obj = closure_0(12936);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  _require = arg1;
  require("module_12928").addHandler("fetch", arg0);
  let obj = require("module_12928");
  require("module_12928").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod12936.fill(_mod12931.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
