// Module ID: 13036
// Function ID: 13037
// Dependencies: [5, 12926, 12929, 12930, 12958, 12944, 12954, 12978, 12957, 12975, 12964, 12945]
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const client = closure_0(12957).getClient();
            let options = client;
            if (client) {
            ...
            if (sendDefaultPii) {
              if (undefined !== rawInput) {
                const normalizer2 = closure_0(12975);
          ...
          if (1 === tmp8) {
            ...
            closure_129_3 = value;
            const normalizer = closure_0(12975);
        ...
        closure_0(12957).withScope((setContext) => {
