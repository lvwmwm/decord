// Module ID: 12989
// Function ID: 12990
// Dependencies: [32, 41, 42, 93, 95, 96, 98, 12929, 12944, 12926, 12990, 12954, 12957, 12958, 12930, 12983, 12941, 12991, 12952, 12935, 12966, 12985]
...
_inherits(ServerRuntimeClient, _mod12985.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(12990).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(12990);
    return ServerRuntimeClient(12954).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      return obj.resolvedSyncPromise(ServerRuntimeClient(12990).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12957).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12957);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new tmp2(12983).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12958).DEBUG_BUILD) {
        const logger = tmp2(12930).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(12991);
          ...
          if (ServerRuntimeClient(12958).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12930).logger;
          ...
          if (ServerRuntimeClient(12958).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12930).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      checkInId = ServerRuntimeClient(12941).uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12952)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = tmp(12935).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = tmp(12935);
        } else {
          spanToTraceContextResult = tmp(12957).getTraceContextFromScope(arg0);
          const tmpResult3 = tmp(12957);
        }
        const tmpResult4 = ServerRuntimeClient(12966);
        if (_getSpanForScopeResult) {
