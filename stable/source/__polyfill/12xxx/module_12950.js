// Module ID: 12950
// Function ID: 12951
// Dependencies: [41, 42, 12951, 12937, 12948, 12956]
...
function withScope(arg0) {
  const mainCarrier = AsyncContextStack(12948).getMainCarrier();
  const obj = AsyncContextStack(12948);
  const sentryCarrier = AsyncContextStack(12948).getSentryCarrier(mainCarrier);
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = tmp(12956).getDefaultCurrentScope();
    const tmpResult = tmp(12956);
    stack = new _moduleResult(defaultCurrentScope, tmp(12956).getDefaultIsolationScope());
    const tmpResult2 = tmp(12956);
  }
...
function withIsolationScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = tmp(12956).getDefaultCurrentScope();
    const tmpResult = tmp(12956);
    stack = new closure_3(defaultCurrentScope, tmp(12956).getDefaultIsolationScope());
    const tmpResult2 = tmp(12956);
  }
  sentryCarrier.stack = stack;
  return stack.withScope(() => {
    ...
    let stack = sentryCarrier.stack;
    if (!stack) {
      const defaultCurrentScope = tmp2(12956).getDefaultCurrentScope();
      const tmp2Result = tmp2(12956);
      stack = new closure_2_3(defaultCurrentScope, tmp2(12956).getDefaultIsolationScope());
      const tmp2Result2 = tmp2(12956);
    }
    sentryCarrier.stack = stack;
...
export function getStackAsyncContextStrategy() {
  return {
    ...
    withSetIsolationScope(arg0, arg1) {
      closure_0 = arg1;
      let mainCarrier = closure_0(12948).getMainCarrier();
      let obj = closure_0(12948);
      let sentryCarrier = closure_0(12948).getSentryCarrier(mainCarrier);
      let stack = sentryCarrier.stack;
      if (!stack) {
        let defaultCurrentScope = tmp(12956).getDefaultCurrentScope();
        const tmpResult = tmp(12956);
        stack = new closure_3(defaultCurrentScope, tmp(12956).getDefaultIsolationScope());
        const tmpResult2 = tmp(12956);
      }
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = tmp(12956).getDefaultCurrentScope();
        const tmpResult = tmp(12956);
        stack = new closure_1_3(defaultCurrentScope, tmp(12956).getDefaultIsolationScope());
        const tmpResult2 = tmp(12956);
      }
      sentryCarrier.stack = stack;
