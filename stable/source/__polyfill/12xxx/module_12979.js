// Module ID: 12979
// Function ID: 12980
// Dependencies: [12941, 12944, 12957, 12980, 12981, 12967, 12939, 12982, 12975, 12951]
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = _mod12939.truncate(environment.message, num);
  }
  value = iter;
  ...
  if (value) {
    iter.value = _mod12939.truncate(iter.value, num);
  }
  ...
  if (url) {
    request.url = _mod12939.truncate(request.url, num);
  }
}
function applyDebugIds(exception, arg1) {
  const filenameToDebugIdMap = _mod12982.getFilenameToDebugIdMap(arg1);
  try {
