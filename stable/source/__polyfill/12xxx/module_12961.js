// Module ID: 12961
// Function ID: 12962
// Dependencies: [718, 12957, 12962, 12963, 12935, 12944, 12952, 12945, 12930, 12947, 12958, 12964]
    ...
    if (spanToJSONResult.start_timestamp) {
      ...
      const item1 = found.forEach((isRecording) => {
        if (isRecording.isRecording()) {
          const obj = { code: _mod12947.SPAN_STATUS_ERROR, message: "cancelled" };
    ...
    if (tmp5Result.hasTracingEnabled()) {
      ...
      let obj3 = {
        apply(arg0, arg1, current) {
              ...
              if (!first) {
                first = _mod12944.timestampInSeconds();
              }
      ...
      const timerId = setTimeout(() => {
        if (!c2) {
          const obj = { code: _mod12947.SPAN_STATUS_ERROR, message: "deadline_exceeded" };
