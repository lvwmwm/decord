// Module ID: 6825
// Function ID: 6826
// Dependencies: [32, 19, 6823, 6813, 6826, 6799, 6814, 6761]
  ...
  while (tmp12 !== undefined) {
    ...
    if (!allowedNativeProps.has(first)) {
      if (!EMPTY_WHITE_LIST.has(tmp17)) {
        let PropsToFilter = tmp19(6814).PropsToFilter;
        if (PropsToFilter.has(tmp17)) {
          continue;
        } else {
          let _console = console;
          let tmp19Result = tmp19(6761);
    ...
    let Reanimated = tmp19(6799).Reanimated;
