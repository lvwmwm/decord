// Module ID: 6869
// Function ID: 6870
// Dependencies: [109, 41, 42, 93, 95, 98, 19, 17, 21, 6870, 6852, 6762]
...
class InnerBaseButton {
  constructor(arg0) {
    ...
    tmp3Result.handleEvent = (nativeEvent) => {
      ...
      let tmp18 = state !== InnerBorderlessButton(6762).State.ACTIVE || pointerInside || undefined === tmp7.longPressTimeout;
      if (tmp18) {
