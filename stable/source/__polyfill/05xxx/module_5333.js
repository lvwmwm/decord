// Module ID: 5333
// Function ID: 5334
// Dependencies: [32, 5294, 5311, 5334]
  ...
  read(arg0, arg1) {
    ...
    if (0 < arg0.length) {
      ...
      if (stringFromDataView === c4) {
        const dataView1 = tmp5(5294).getDataView(dataView.buffer, sum3, longAt);
        const obj7 = { id: shortAt, value: null };
        const tmp5Result = tmp5(5294);
        obj7.value = tmp5(5294).getStringFromDataView(dataView1, 0, longAt);
        if (tmp10(5334)[shortAt]) {
          try {
            obj7.description = tmp10(5334)[shortAt].description(dataView1);
            if (!name) {
              name = tmp10(5334)[shortAt].name;
            }
            obj2[name] = obj7;
            const obj6 = tmp10(5334)[shortAt];
          } catch (err) {
