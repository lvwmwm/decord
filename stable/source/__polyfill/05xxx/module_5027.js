// Module ID: 5027
// Function ID: 5028
// Dependencies: [109, 19, 17, 21, 5015, 5025, 5024, 5028, 5029, 5032, 5014, 5034, 5005]
...
export default noop.forwardRef(function ScreenStackItem(arg0, ref) {
  ...
  dependencyMap = flag5.useContext(tmp4(5025).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = tmp4(5028).isIOS26OrHigher;
  }
  ...
  if (screenId(5028).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(tmp4(5032).SafeAreaView, obj5);
  }
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(tmp4(5034).FooterComponent, obj7);
  }
