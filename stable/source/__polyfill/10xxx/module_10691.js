// Module ID: 10691
// Function ID: 10692
// Dependencies: [41, 42, 93, 95, 98, 10690, 10561, 10562, 10692]
...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return "(?:\u0441)?\\s*(" + RUMonthNameLittleEndianParser(10690).ORDINAL_NUMBER_PATTERN + ")(?:\\s{0,3}(?:\u043F\u043E|-|\u2013|\u0434\u043E)?\\s{0,3}(" + RUMonthNameLittleEndianParser(10690).ORDINAL_NUMBER_PATTERN + "))?(?:-|\\/|\\s{0,3}(?:of)?\\s{0,3})(" + RUMonthNameLittleEndianParser(10561).matchAnyPattern(RUMonthNameLittleEndianParser(10690).MONTH_DICTIONARY) + ")(?:(?:-|\\/|,?\\s{0,3})(" + RUMonthNameLittleEndianParser(10690).YEAR_PATTERN + "(?![^\\s]\\d)))?";
  }
};
const items = [
  entry,
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start.imply("year", tmp2(10562).findYearClosestToRef(createParsingResult.refDate, result, tmp4));
        }
        if (index[2]) {
