// Module ID: 10627
// Function ID: 10628
// Dependencies: [41, 42, 93, 95, 98, 10623, 10564, 10568]
...
const entry = {
  ...
  value: function innerPattern() {
    const regExp = new RegExp("(?:dans|en|pour|pendant|de)\\s*(" + FRTimeUnitWithinFormatParser(10623).TIME_UNITS_PATTERN + ")(?=\\W|$)", "i");
    return regExp;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      const ParsingComponents = FRTimeUnitWithinFormatParser(10564).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, FRTimeUnitWithinFormatParser(10623).parseDuration(arg1[1]));
    }
  }
];
