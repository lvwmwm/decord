// Module ID: 10731
// Function ID: 10732
// Dependencies: [41, 42, 93, 95, 98, 10730, 10561, 10562, 10568]
...
const regExp = new RegExp("(?:on\\s{0,3})?(" + _mod10730.ORDINAL_NUMBER_PATTERN + ")(?:\\s{0,3}(?:al|\\-|\\\u2013|fino|alle|allo)?\\s{0,3}(" + _mod10730.ORDINAL_NUMBER_PATTERN + "))?(?:-|/|\\s{0,3}(?:dal)?\\s{0,3})(" + repeatedTimeunitPattern.matchAnyPattern(_mod10730.MONTH_DICTIONARY) + ")(?:(?:-|/|,?\\s{0,3})(" + _mod10730.YEAR_PATTERN + "(?![^\\s]\\d)))?(?=\\W|$)", "i");
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", tmp2(10730).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = tmp2(10730).parseOrdinalNumberPattern(index[2]);
