// Module ID: 10606
// Function ID: 10607
// Dependencies: [41, 42, 93, 95, 98, 10561, 10607, 10588, 10568]
...
const regExp = new RegExp("(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:a[mn]\\s*?)?(?:(diese[mn]|letzte[mn]|n(?:\u00E4|ae)chste[mn])\\s*)?(" + repeatedTimeunitPattern.matchAnyPattern(_mod10607.WEEKDAY_DICTIONARY) + ")(?:\\s*(?:\\,|\\)|\\\uFF09))?(?:\\s*(diese|letzte|n(?:\u00E4|ae)chste)\\s*woche)?(?=\\W|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return DEWeekdayParser(10588).createParsingComponentsAtWeekday(reference.reference, DEWeekdayParser(10607).WEEKDAY_DICTIONARY[formatted], str4);
    }
  }
];
