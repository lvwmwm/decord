// Module ID: 10557
// Function ID: 10558
// Dependencies: [41, 42, 10558, 10564]

// Module 10557
import ENDefaultConfiguration2 from "ENDefaultConfiguration" /* 10558 */;
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      if (extractResult instanceof ParsingContext(10564).ParsingResult) {
      ...
      } else if (!(extractResult instanceof tmp6(10564).ParsingComponents)) {
...
const entry2 = {
  ...
  value: function createParsingComponents(date) {
    ...
    if (!(date instanceof ParsingContext(10564).ParsingComponents)) {
      const self = this;
      parsingComponents = new ParsingContext(10564).ParsingComponents(this.reference, date);
    }
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10564).ParsingResult(self.reference, sum, substr, parsingComponents, parsingComponents1);
    }
  },
  {
    key: "debug",
