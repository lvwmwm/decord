// Module ID: 10555
// Function ID: 10556
// Dependencies: [10556, 10557, 10564, 10566, 10604, 10616, 10629, 10640, 10649, 10667, 10688, 10703, 10713, 10728, 10747]

// Module 10555
import Chrono from "Chrono" /* 10556 */;
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const obj2 = {
      enumerable: true,
      get() {
            return require("module_10557").ParsingContext;
          }
    };
    ...
    exports.de = fn(_mod10604);
    exports.fr = fn(_mod10616);
    exports.ja = fn(_mod10629);
    exports.pt = fn(_mod10640);
    exports.nl = fn(_mod10649);
    exports.zh = fn(_mod10667);
    exports.ru = fn(_mod10688);
    exports.es = fn(_mod10703);
    exports.uk = fn(_mod10713);
    exports.it = fn(_mod10728);
    exports.sv = fn(_mod10747);
