// Module ID: 10658
// Function ID: 10659
// Dependencies: [41, 42, 93, 95, 98, 10561, 10655, 10562, 10568]
...
const regExp = new RegExp("(" + repeatedTimeunitPattern.matchAnyPattern(_mod10655.MONTH_DICTIONARY) + ")\\s*(?:[,-]?\\s*(" + _mod10655.YEAR_PATTERN + ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)", "i");
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      const tmp4 = NLMonthNameParser(10655).MONTH_DICTIONARY[arg1[1].toLowerCase(arg1[1])];
      parsingComponents.assign("month", tmp4);
      if (arg1[2]) {
        parsingComponents.assign("year", tmp2(10655).parseYear(arg1[2]));
      } else {
        parsingComponents.imply("year", tmp2(10562).findYearClosestToRef(createParsingComponents.refDate, 1, tmp4));
      }
