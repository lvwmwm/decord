// Module ID: 4465
// Function ID: 4466
// Dependencies: [19, 4466, 1107, 1108, 1101, 4469]
...
export const StaticRouter = Component2(4469).StaticRouter;
export const Switch = Component2(4469).Switch;
export const generatePath = Component2(4469).generatePath;
export const matchPath = Component2(4469).matchPath;
export const useHistory = Component2(4469).useHistory;
export const useLocation = Component2(4469).useLocation;
export const useParams = Component2(4469).useParams;
export const useRouteMatch = Component2(4469).useRouteMatch;
export const withRouter = Component2(4469).withRouter;
