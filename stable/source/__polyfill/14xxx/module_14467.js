// Module ID: 14467
// Function ID: 14468
// Dependencies: [41, 42, 32, 14461, 14468, 14469]
...
let obj2 = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, _mod14461.implSymbol)) {
        if (arg0[tmp(undefined, 14461).implSymbol] instanceof tmp(14468).implementation) {
          return true;
        }
      }
  ...
  setup(wrapper, arg1) {
    ...
    if (URLSearchParamsImpl.init) {
      tmp2(14468).init(wrapper[tmp2(undefined, 14461).implSymbol], obj);
      const tmp2Result = tmp2(14468);
    }
    return wrapper;
  },
  install(arg0) {
              ...
              if (arguments.length < 1) {
                ...
                if (0 < arr2.length) {
                  do {
                    ...
                    let _Array = Array;
                    arr3 = Array.from(self[tmp3(undefined, 14461).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr3;
