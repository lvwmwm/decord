// Module ID: 14130
// Function ID: 14131
// Dependencies: [14103, 14107, 14102]
...
export default (num, arg1) => {
  if (num instanceof _mod14103) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(14107).safeRe;
        const t2 = tmp(14107).t;
      ...
      if (null === match2) {
        ...
        return _mod14102("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
