// Module ID: 14103
// Function ID: 14104
// Dependencies: [41, 42, 14104, 14105, 14106, 14107, 14108]
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14108).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = tmp3(14108);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = tmp3(14108).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = tmp3(14108);
      }
