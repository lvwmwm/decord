...
// Dependencies: [19, 21, 576, 4337, 5694, 2]
// Exports: ChevronSmallRightIcon

// Module 7312 (ChevronSmallRightIcon)
...
export const ChevronSmallRightIcon = function ChevronSmallRightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5694, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
