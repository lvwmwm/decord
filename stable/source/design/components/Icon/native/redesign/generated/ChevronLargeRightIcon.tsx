...
// Dependencies: [19, 21, 576, 4337, 12502, 2]
// Exports: ChevronLargeRightIcon

// Module 12501 (ChevronLargeRightIcon)
...
export const ChevronLargeRightIcon = function ChevronLargeRightIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod12502, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
