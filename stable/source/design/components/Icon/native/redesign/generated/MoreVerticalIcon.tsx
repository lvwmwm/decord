...
// Dependencies: [19, 21, 576, 4337, 13102, 2]
// Exports: MoreVerticalIcon

// Module 13101 (MoreVerticalIcon)
...
export const MoreVerticalIcon = function MoreVerticalIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod13102, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
