...
// Dependencies: [19, 21, 576, 4337, 15450, 2]
// Exports: EmojiColdFaceIcon

// Module 15449 (EmojiColdFaceIcon)
...
export const EmojiColdFaceIcon = function EmojiColdFaceIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15450, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
