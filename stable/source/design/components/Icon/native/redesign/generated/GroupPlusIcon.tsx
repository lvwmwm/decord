...
// Function ID: 10162
// Name: GroupPlusIcon
// Dependencies: [19, 21, 576, 4337, 10160, 2]
// Exports: GroupPlusIcon

// Module 10161 (GroupPlusIcon)
...
export const GroupPlusIcon = function GroupPlusIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod10160, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
