...
// Dependencies: [19, 17, 21, 576, 4486, 4347, 5046, 4338, 5045, 4373, 5055, 5059, 2]
...
const VisualEffectViewAnimatedDefault = tmp3(5045);
const VisualEffectViewDefault = tmp3(5046);
require = fn;
