...
// Function ID: 9271
// Name: _asyncLoop
// Dependencies: [41, 42, 5, 9271, 9272]
...
export const randomBytes = function randomBytes(result) {
  ...
  if (Hash(9272).crypto) {
    if (typeof tmp(9272).crypto.getRandomValues === "function") {
      const _crypto2 = tmp(9272).crypto;
      const _Uint8Array = Uint8Array;
  ...
  if (Hash(9272).crypto) {
    if (typeof tmp(9272).crypto.randomBytes === "function") {
      const _crypto = tmp(9272).crypto;
