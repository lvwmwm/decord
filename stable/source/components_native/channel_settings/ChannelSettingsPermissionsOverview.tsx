...
// Dependencies: [32, 5, 19, 17, 2016, 1957, 2015, 1979, 4285, 1371, 1074, 21, 4636, 576, 4980, 1114, 4789, 4280, 11743, 9870, 8748, 12, 5768, 5686, 15239, 1483, 12886, 10399, 15398, 504, 1894, 11077, 16941, 5662, 7966, 4649, 2]
// Exports: default
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              const syncedPermissionOverwrites = obj8.getSyncedPermissionOverwrites(tmp5, tmp2(11743).getAppChannelBotUserId(tmp2));
              closure_128_0 = syncedPermissionOverwrites;
              const obj9 = tmp2(11743);
              c2 = 1;
              c3 = 1;
...
function AddPermission(isEditing) {
  ...
  if (isEditing.isEditing) {
    ...
    const obj4 = { icon: closure_16(tmp2(12886).PlusMediumIcon, {}), label: null, onPress: null };
    ...
    const obj5 = { icon: closure_16(tmp2(12886).PlusMediumIcon, {}), label: null, onPress: null };
