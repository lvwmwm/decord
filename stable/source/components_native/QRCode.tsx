...
// Dependencies: [109, 19, 17, 21, 4636, 576, 4347, 9995, 5046, 10009, 8361, 2]

// Module 9994 (components_native/QRCode)
import nativeDefault from "native" /* 576 */;
import VisualEffectViewThemedDefault from "VisualEffectViewThemed" /* 8361 */;
import QRCodeDefault from "QRCode" /* 9995 */;
import _mod10009 from "module_10009" /* 10009 */;
import _objectWithoutProperties from "_objectWithoutProperties" /* 109 */;
import noop from "module_19" /* 19 */;

const VisualEffectViewDefault = tmp7(5046);
require = fn;
...
QRCode.contextType = fn(4347).ThemeContext;
...
QRCodeWithOverlay.prototype["render"] = function render() {
  ...
  obj3.style = items1;
  obj4 = { style: tmp[frozen[SIZE_40]], source: _mod10009 };
...
QRCodeWithOverlay.contextType = fn(4347).ThemeContext;
