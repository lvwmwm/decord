...
function Form(onSubmitError) {
  ({ options, defaultEmail, defaultName, onSubmit: f108342, onSubmitSuccess } = onSubmitError);
  ...
  f108342 = screenshotInput(function*(arg0, value) {
    if (c6 === 2) {
      c6 = 3;
      ...
      try {
        ...
        if (0 === c5) {
          ...
          if (3 === tmp8) {
            ...
            if (messageLabel) {
              const debug = f108342(onSubmitSuccess[2]).debug;
  ...
  f108342 = function(arg0) {
    const self = this;
    const apply = f108342.apply;
