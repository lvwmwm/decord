...
// Function ID: 1172
// Name: DEFAULT_LOCALE
// Dependencies: [32, 41, 42, 1155, 1154, 1157]

// Module 1171 (DEFAULT_LOCALE)
...
let items = [
  ...
  },
  {
    ...
    value: function setLocale(currentLocale) {
      ...
      this.data = IntlManager(1154).makeDataFormatters(items, this.formatConfig, this._forceLookupMatcher);
  ...
  },
  {
    ...
    value: function bindFormatValues(Builder, ast, values) {
      ...
      ({ currentLocale: arr[0], defaultLocale: arr[1] } = this);
      obj.locales = items;
      return IntlManager(1157).bindFormatValues(obj);
    }
  }
];
