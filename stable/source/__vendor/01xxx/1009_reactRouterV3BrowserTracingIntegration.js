  ...
  obj3.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f108681 = (name) => {
        ...
        result = feedbackAsyncIntegration.startBrowserTracingPageLoadSpan(f108681, obj2);
      };
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f120933 = (name) => {
            ...
            obj2.attributes = obj3;
            result = result(889).startBrowserTracingNavigationSpan(f120933, obj2);
          };
