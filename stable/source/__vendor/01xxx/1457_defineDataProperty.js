...
// Dependencies: [1281, 1282, 1304, 1302]
...
export default function defineDataProperty(obj, str, value) {
  if (obj) {
    ...
    if (flag) {
      ...
      if (!tmp6) {
        const tmp13 = new tmp7(1302)("This environment does not support defining a property as non-configurable, non-writable, or non-enumerable.");
        throw tmp13;
      }
      obj[str] = value;
    }
