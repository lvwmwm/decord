...
// Dependencies: [32, 41, 42, 1192, 1190, 1193]
  ...
  entry,
  {
    ...
    value: function skip(arg0) {
      ...
      if (BinaryReader(1190).WireType.Varint === arg0) {
        ...
        if (tmp(1190).WireType.Bit64 === arg0) {
          self.pos = self.pos + 4;
        } else if (tmp(1190).WireType.Bit32 !== arg0) {
          if (tmp(1190).WireType.LengthDelimited === arg0) {
            self.pos = self.pos + self.uint32();
          } else if (tmp(1190).WireType.StartGroup === arg0) {
            const tmp8 = self.tag()[1];
            if (tmp8 !== tmp(1190).WireType.EndGroup) {
              do {
