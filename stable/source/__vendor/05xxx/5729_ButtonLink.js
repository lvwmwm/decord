...
// Function ID: 5730
// Name: ButtonLink
// Dependencies: [19, 17, 21, 1484, 5721, 5730, 5731]
// Exports: Button

// Module 5729 (ButtonLink)
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj11.isDark()) {
      const obj2 = tmp9(5721)(color);
      str4 = tmp9(5721)(color).darken(0.71).string();
      const darkenResult = tmp9(5721)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
