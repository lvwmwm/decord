...
// Function ID: 5304
// Name: findOffsets
// Dependencies: [5304, 5297, 5294]
// Exports: findOffsets

// Module 5303 (findOffsets)
import _mod5294 from "module_5294" /* 5294 */;
import _modDef5297 from "module_5297" /* 5297 */;
import get64BitValue from "get64BitValue" /* 5304 */;
      ...
      if (1835365473 === uint321) {
        ...
        if (uint8 >= 2) {
          ...
          if (obj17.itemType === c4) {
            obj17.contentType = tmp13(5294).getNullTerminatedStringFromDataView(getUint32, sum13);
            const sum14 = sum13 + (obj17.contentType.length + 1);
            parseItemLocationBoxResult = obj17;
            if (sum + length > sum14) {
              obj17.contentEncoding = tmp13(5294).getNullTerminatedStringFromDataView(getUint32, sum14);
              const sum15 = obj17.contentEncoding.length + 1;
              parseItemLocationBoxResult = obj17;
              const tmp13Result3 = tmp13(5294);
            }
            const tmp13Result = tmp13(5294);
          } else {
            parseItemLocationBoxResult = obj17;
            if (obj17.itemType === c5) {
              obj17.itemUri = tmp13(5294).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj17.itemUri.length + 1;
              parseItemLocationBoxResult = obj17;
              const tmp13Result4 = tmp13(5294);
            }
          }
        }
      } else {
