...
// Function ID: 14463
// Name: URLImpl
// Dependencies: [41, 42, 14463, 14467, 14466]

// Module 14462 (URLImpl)
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(14463).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(14463).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(14466).parseUrlencoded(query);
          const tmpResult = tmp(14466);
        }
      }
      const obj = URLImpl(14463);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(14463).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
    ...
    set(arg0) {
      URLImpl(14463).basicURLParse(`${arg0}:`, { url: this._url, stateOverride: "scheme start" });
    }
  },
  {
    key: "username",
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14463).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(14463);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14463).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(14463);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(14463).serializeHost(host);
        const obj3 = URLImpl(14463);
      } else {
        const obj = URLImpl(14463);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(14463).serializeInteger(host.port)}`;
        const obj2 = URLImpl(14463);
      }
    },
    set(arg0) {
      if (!this._url.cannotBeABaseURL) {
        const obj2 = { url: tmp._url, stateOverride: "host" };
        URLImpl(14463).basicURLParse(arg0, obj2);
        const obj = URLImpl(14463);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(14463).serializeHost(tmp._url.host);
        const obj = URLImpl(14463);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(14463).serializeInteger(tmp._url.port);
        const obj = URLImpl(14463);
      }
      return str;
    },
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        URLImpl(14463).basicURLParse(substr, obj2);
        const obj = URLImpl(14463);
        self._query._list = URLImpl(14466).parseUrlencoded(substr);
      }
    }
  },
  {
