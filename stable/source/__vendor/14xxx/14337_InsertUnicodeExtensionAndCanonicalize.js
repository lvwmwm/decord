...
// Dependencies: [14330, 14338]
// Exports: InsertUnicodeExtensionAndCanonicalize

// Module 14337 (InsertUnicodeExtensionAndCanonicalize)
import _mod14330 from "module_14330" /* 14330 */;
import CanonicalizeUnicodeLocaleId from "CanonicalizeUnicodeLocaleId" /* 14338 */;
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14330.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
