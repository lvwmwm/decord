...
// Function ID: 14146
// Name: simpleSubset
// Dependencies: [14132, 14131, 14117, 14134]

// Module 14145 (simpleSubset)
...
function simpleSubset(arg0, item10015, includePrerelease) {
  ...
  if (arg0 === item10015) {
    ...
    if (1 === arg0.length) {
      ...
      if (arg0[0].semver === Comparator.ANY) {
        if (1 === item10015.length) {
          if (item10015[0].semver === tmp6(14131).ANY) {
            return true;
          }
        }
      }
    ...
    if (set.size > 1) {
      ...
      if (tmp) {
        if (tmp2) {
          const tmp46 = _mod14117(tmp.semver, tmp2.semver, includePrerelease);
          if (tmp46 > 0) {
            return null;
          } else {
            let tmp39 = tmp46;
...
function higherGT(semver, semver2, includePrerelease) {
  if (semver) {
    const tmp4 = _mod14117(semver.semver, semver2.semver, includePrerelease);
    let tmp5 = semver;
    if (tmp4 <= 0) {
      if (tmp4 < 0) {
        let tmp6 = semver2;
...
export default (arg0, arg1, includePrerelease) => {
  ...
  if (arg0 === arg1) {
    ...
    const tmp22 = new _mod14132(arg0, obj);
    const tmp27 = new _mod14132(arg1, obj);
    let flag = false;
