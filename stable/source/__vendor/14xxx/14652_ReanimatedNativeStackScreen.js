...
// Dependencies: [109, 19, 17, 21, 1636, 5005, 1614, 14653, 14654]

// Module 14652 (ReanimatedNativeStackScreen)
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  const obj4 = { value: sharedValue, children: jsx(_modDef14654.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) };
  obj3.children = jsx(_modDef14653.Provider, { value: sharedValue, children: jsx(_modDef14654.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) });
