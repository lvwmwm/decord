...
// Function ID: 14329
// Name: ResolveLocale
// Dependencies: [14329, 14334, 14335, 14330, 14336, 14337]
...
export const ResolveLocale = function ResolveLocale(arg0, arg1, localeMatcher, arg3, arg4, fn) {
  ...
  if (0 < arg3.length) {
    do {
      ...
      let invariantResult2 = tmp14(14330).invariant(tmp24, "optionsValue must be a string or undefined");
      let str3 = tmp23;
      if (typeof tmp23 === "string") {
        let formatted = str.toLowerCase();
        str3 = tmp14(14336).CanonicalizeUValue(formatted, tmp23);
        if ("" === str3) {
          str3 = "true";
        }
      }
