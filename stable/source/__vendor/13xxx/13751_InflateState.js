...
// Function ID: 13752
// Name: InflateState
// Dependencies: [13741, 13752, 13748, 13753, 13747]
                                                                ...
                                                                if (bits >= 32) {
                                                                  ...
                                                                  if (!diff12) {
                                                                    ...
                                                                    if (state.flags) {
                                                                      ...
                                                                      tmp46 = tmp41(13747)(check, tmp15, diff12, next_out - diff12);
                                                                    }
                                                                    state.check = tmp46;
                                                                    state.adler = tmp46;
                                                                  }
                                            ...
                                            if (state.mode === 30) {
                                              ...
                                              if (0 === state.lens[256]) {
                                                ...
                                                if (tmp643) {
                                                  ...
                                                  let tmp191 = tmp639(13752)(2, lens2, state.nlen, state.ndist, state.distcode, 0, state.work, obj7);
