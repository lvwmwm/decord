...
// Dependencies: [41, 42, 10559, 10569, 10570, 10571, 10572, 10573, 10574, 10576, 10577, 10578, 10581, 10584, 10586, 10587, 10589, 10590, 10591, 10592, 10593, 10594, 10595, 10596, 10597]

// Module 10558 (ENDefaultConfiguration)
...
const regExp = fn(_mod10595);
const _isNativeReflectConstruct = fn(_mod10596);
...
let items = [
  entry,
  {
    ...
    value: function createConfiguration(flag) {
      ...
      obj.refiners = items1;
      const result = ENDefaultConfiguration(10597).includeCommonConfiguration(obj, flag);
