...
// Function ID: 10917
// Name: ItemLayout
// Dependencies: [19, 21, 10899, 10917, 1636]
// Exports: ItemLayout

// Module 10916 (ItemLayout)
...
export const ItemLayout = (animationStyle) => {
  ...
  const props = _mod10899.useGlobalState().props;
  ...
  const offsetX = _mod10917.useOffsetX(obj2, visibleRanges);
  const tmpResult = _mod10917;
  const fn = function k() {
