...
// Function ID: 10915
// Name: ItemRenderer
// Dependencies: [32, 19, 21, 10915, 1636, 10892, 10916]
// Exports: ItemRenderer

// Module 10914 (ItemRenderer)
...
export const ItemRenderer = (arg0) => {
  ...
  const visibleRanges = _mod10915.useVisibleRanges({ total: dataLength, viewSize: size, translation: handlerOffset, windowSize, loop });
