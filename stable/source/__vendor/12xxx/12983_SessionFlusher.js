...
// Function ID: 12984
// Name: SessionFlusher
// Dependencies: [41, 42, 12936, 12957]

// Module 12983 (SessionFlusher)
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12936).dropUndefinedKeys(obj);
    }
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12957).getIsolationScope();
        ...
        const obj = SessionFlusher(12957);
      }
    }
  },
  {
