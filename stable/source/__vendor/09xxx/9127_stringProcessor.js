...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(9126).process(_idmap, initializeContextResult);
    tmp2(9126).extractDefs(initializeContextResult, _idmap);
    return tmp2(9126).finalize(initializeContextResult, _idmap);
  }
