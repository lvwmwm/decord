...
// Dependencies: [19, 17, 21, 5712, 1484, 7112, 7113]
// Exports: HeaderContainer

// Module 7111 (HeaderContainer)
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_7112").forSlideRight;
                    } else {
                      forSlideUp = require("module_7112").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_7112").forSlideUp;
              }
            } else {
