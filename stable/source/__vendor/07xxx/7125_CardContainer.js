...
// Function ID: 7126
// Name: CardContainer
// Dependencies: [19, 17, 21, 1484, 5712, 7126, 7127, 7128, 7115]

// Module 7125 (CardContainer)
import Link from "Link" /* 1484 */;
import _mod5712 from "module_5712" /* 5712 */;
import ModalPresentationContext from "ModalPresentationContext" /* 7115 */;
import _mod7126 from "module_7126" /* 7126 */;
import CardA11yWrapper from "CardA11yWrapper" /* 7127 */;
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = tmp2(5712).getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = tmp2(5712);
  }
  closure_15 = tmp12;
