...
// Dependencies: [19, 17, 21, 4636, 576, 9055, 9142, 9143, 2]
// Exports: default

// Module 9146 (UserProfileApplicationWidgetTopContainedLayout)
...
export default function UserProfileApplicationWidgetTopContainedLayout(header) {
  ...
  if (null != fieldValue) {
    ...
    tmp12Result = tmp12(tmp2(9143).ImageSkeleton, obj10);
  }
