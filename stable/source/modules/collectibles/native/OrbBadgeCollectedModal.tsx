...
// Dependencies: [19, 17, 4628, 21, 4636, 576, 5705, 4839, 8975, 11228, 504, 5668, 11918, 8425, 11919, 7226, 8970, 4632, 1114, 5056, 8284, 8973, 7103, 2]
// Exports: default

// Module 13292 (OrbBadgeCollectedModal)
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    const obj4 = { uri: onPressViewBadge(11918) };
    obj3.source = obj4;
    ...
    const obj6 = { uri: onPressViewBadge(11919) };
    obj5.source = obj6;
    obj5.poster = onPressViewBadge(11918);
