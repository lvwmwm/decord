...
// Dependencies: [19, 17, 1074, 1373, 21, 4636, 576, 8971, 5668, 13294, 4571, 7690, 4488, 10853, 10854, 4632, 1114, 2024, 4331, 7253, 7534, 5204, 11243, 5056, 4603, 7257, 2]
// Exports: default

// Module 13293 (FractionalNitroCollectedActionSheet)
...
function NitroAcquiredHeader(skuId) {
  ...
  const obj2 = { source: _modDef13294 };
...
export default function FractionalNitroCollectedActionSheet(skuId) {
  ...
  obj5.children = tmp15(skuId(11243).CircleQuestionIcon, { style: tmp.questionIcon, color: consumed(576).colors.WHITE });
