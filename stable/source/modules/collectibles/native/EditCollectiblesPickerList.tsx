...
// Dependencies: [32, 19, 17, 21, 4636, 13304, 4632, 12, 9003, 2]
// Exports: EditCollectiblesPickerList

// Module 13309 (EditCollectiblesPickerList)
...
let obj = { list: { flex: 1, marginTop: 12 }, listContent: { paddingBottom: 88 }, loadingContainer: { paddingVertical: 80, alignItems: "center" }, header: { paddingHorizontal: fn(13304).GUTTER_SIZE, paddingTop: 10, paddingBottom: 5 } };
  ...
  const memo = obj.useMemo(() => {
    ...
    if (flag) {
      ...
      let item = sections.forEach((header) => {
        ...
        const obj2 = items(12);
        const item = items(12).chunk(header.items, items(13304).ROW_SIZE).forEach((items, index) => {
