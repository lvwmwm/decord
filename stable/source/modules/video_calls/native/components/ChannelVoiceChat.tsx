...
// Dependencies: [19, 17, 9597, 21, 4636, 576, 10071, 1611, 9719, 12, 9601, 4571, 5206, 10206, 9611, 4488, 11477, 5204, 1114, 1176, 11712, 12907, 2]
...
export default noop.memo((channel) => {
  ...
  items3[3] = closure_6(guild_id(11477), { guildId: guild_id, channelId: id, chatInputRef: ref, screenIndex: "voice-panel" });
  ...
  obj10.children = closure_6(id(1176).Icon, { source: guild_id(11712), size: id(1176).Icon.Sizes.MEDIUM });
  const items7 = [closure_6(id(5204).PressableOpacity, obj10), ];
  const obj11 = { source: guild_id(11712), size: id(1176).Icon.Sizes.MEDIUM };
  items7[1] = closure_6(View, { style: tmp.chatHeaderTitleContainer, children: closure_6(id(12907).ChannelTitle, { guildId: guild_id, channelId: id }) });
