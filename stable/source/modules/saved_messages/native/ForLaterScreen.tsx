...
// Function ID: 13418
// Name: ForLaterScreen
// Dependencies: [32, 19, 17, 11793, 21, 4636, 576, 4373, 5055, 13418, 7963, 7957, 504, 7265, 7285, 8894, 1248, 1090, 13420, 13426, 9003, 13430, 2]

// Module 13417 (ForLaterScreen)
...
import useSavedMessagesForPageDefault from "useSavedMessagesForPage" /* 13418 */;
import ForLaterMessageCardDefault from "ForLaterMessageCard" /* 13420 */;
...
function ForLaterPage(type) {
  ...
  if (0 === arr.length) {
    ...
    const obj6 = { type };
    obj5.children = closure_7(tmp2(13426), obj6);
    ...
    if (tmp9) {
      ...
      tmp25Result = tmp25(tmp2(13430), obj10);
    }
