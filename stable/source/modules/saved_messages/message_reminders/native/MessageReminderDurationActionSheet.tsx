...
// Dependencies: [32, 19, 11793, 21, 4636, 576, 504, 1090, 11844, 7252, 1114, 5204, 5709, 11845, 5686, 4603, 4839, 11846, 1896, 4228, 7253, 5768, 4587, 2]
// Exports: default

// Module 11843 (MessageReminderDurationActionSheet)
import nativeDefault from "native" /* 576 */;
import util from "util" /* 1114 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4603 */;
import TableRow from "TableRow" /* 5686 */;
import BottomSheetTitleHeader from "BottomSheetTitleHeader" /* 7252 */;
import MessageRemindersTypes from "MessageRemindersTypes" /* 11845 */;
...
export default function MessageReminderDurationActionSheet(createReminder) {
  ...
  let obj3 = createReminder(11844);
  const dueInString = obj3.useDueInString({ dueAt, now: tmp7, type: createReminder(11844).DueInStringTypes.SHORT });
