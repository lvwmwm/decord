...
// Dependencies: [32, 19, 17, 1074, 1954, 12543, 21, 4636, 576, 1240, 9188, 4632, 1114, 5056, 12544, 5204, 5761, 15568, 7491, 1943, 2]
// Exports: default
...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj9.onPress = function onPress() {
    const pushNotificationPermission = onDismiss(12544).requestPushNotificationPermission(constants2.ALLOW_TO_REQUEST, constants3.NOTIFICATION_CENTER, closure_1_8);
    const obj = onDismiss(12544);
