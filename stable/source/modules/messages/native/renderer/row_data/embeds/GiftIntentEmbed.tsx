...
// Dependencies: [8183, 1371, 1373, 4636, 576, 1114, 8187, 4481, 8050, 4572, 8188, 8189, 2]
  ...
  if (null == giftingPrompt) {
    ...
    if (null == user) {
      ...
      if (null == tmp) {
        ...
        obj9.subHeaderIconUrl = renderer_EmbedUtils.getAssetUriForEmbed(tmp8(4572));
        const intl3 = util.intl;
        obj9.primaryCtaLabel = intl3.string(util.t.ilhtIa);
        obj9.primaryCtaIconUrl = renderer_EmbedUtils.getAssetUriForEmbed(tmp8(8188));
        obj9.secondaryCtaIconUrl = renderer_EmbedUtils.getAssetUriForEmbed(tmp8(8189));
