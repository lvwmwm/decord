...
// Dependencies: [502, 1074, 7854, 4859, 1384, 12087, 12088, 2]
// Exports: tryCreateInjectedMessage

// Module 12086 (tryInjectMessage)
        ...
        if (id2.isDM()) {
          ...
          if (id.author.id !== AuthenticationStore.getId()) {
            ...
            if (null == id.activity) {
              ...
              tmp4 = null;
              if (!tmpResult.hasFlag(num, tmp(12087).ChannelRecipientPrivateUserDataFlags.DISMISSED_IN_GAME_MESSAGE_NUX)) {
                tmp4 = null;
                if (!obj.has(id2.id)) {
                  ...
                  const setFlagResult = tmp(1384).setFlag(num2, tmp(12087).ChannelRecipientPrivateUserDataFlags.DISMISSED_IN_GAME_MESSAGE_NUX, true);
                  const result1 = tmp6(12088).updatePrivateChannelRecipientFlags(id2.id, setFlagResult);
                  tmp4 = messageRecord1;
                  const tmp6Result = tmp6(12088);
                }
              }
              tmpResult = tmp(1384);
            }
