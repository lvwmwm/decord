...
// Dependencies: [19, 17, 1957, 7254, 7311, 21, 4636, 576, 8357, 8346, 8343, 8354, 8296, 16681, 8362, 8372, 11249, 13194, 13254, 504, 12766, 4460, 5056, 5152, 1114, 4461, 9159, 4632, 6717, 4318, 11, 4596, 5514, 8202, 4587, 4589, 1611, 16684, 2]
...
function OpenInterviewButton(arg0) {
  ...
  const joinRequestButtonActions = interviewChannelId(12766).useJoinRequestButtonActions(joinRequest, interviewChannelId);
  ({ handleOpenInterview, submitting } = joinRequestButtonActions);
  const obj2 = interviewChannelId(12766);
...
let closure_12 = noop.memo((user) => {
  ...
  if (null != user) {
    ...
    const items4 = [closure_8(tmp6(13194).PrimaryInfo, obj10), ];
    const obj11 = { user };
    items4[1] = closure_8(tmp(13254), obj11);
    obj9.children = items4;
    obj7.children = closure_9(View, obj9);
    items2[1] = closure_8(tmp(11249), obj7);
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  const joinRequestButtonActions = joinRequest(12766).useJoinRequestButtonActions(joinRequest, joinRequest.interviewChannelId, callback);
