...
// Dependencies: [1074, 11021, 7841, 11022, 1114, 11023, 11024, 8462, 2]
// Exports: default

// Module 11020 (getActivityStatusText)
...
export default function getActivityStatusText(name) {
  ...
  if (status_display_type !== StatusDisplayTypes.StatusDisplayTypes.NAME) {
    ...
    if (status_display_type1 !== tmp15(11021).StatusDisplayTypes.STATE) {
      ...
      tmp20 = status_display_type2 === tmp15(11021).StatusDisplayTypes.DETAILS && null != tmp5;
    } else {
      tmp17 = tmp8;
    }
  } else {
