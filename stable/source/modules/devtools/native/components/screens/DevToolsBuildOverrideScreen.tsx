...
// Dependencies: [32, 19, 17, 11562, 21, 4636, 576, 8987, 15670, 7084, 504, 11923, 5054, 5768, 5686, 4583, 7292, 4334, 15239, 4594, 5766, 5769, 6707, 5056, 1369, 2]
...
export default noop.memo(() => {
  ...
  const stateFromStores = first(504).useStateFromStores(items, () => {
    ...
    let tmp;
    if (overrides != null) {
      tmp = overrides[first(undefined, 11923).DEVICE_FIELD];
    }
    return tmp;
  });
  ...
  if (null != stateFromStores) {
    ...
    const obj6 = { icon: tmp7(tmp3(15239).RefreshIcon, {}), label: "Refresh Override", onPress: tmp3(11923).refreshBuildOverride, arrow: true };
    items1[1] = tmp7(tmp3(5686).TableRow, obj6);
    const obj7 = { icon: tmp7(tmp3(4594).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Override", variant: "danger", onPress: tmp3(11923).clearBuildOverride, arrow: true };
