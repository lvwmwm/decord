...
// Dependencies: [32, 19, 17, 1371, 14487, 1074, 21, 4636, 576, 4632, 5686, 10513, 4228, 9933, 5204, 7292, 4583, 504, 9003, 5054, 5768, 7303, 12284, 4594, 15663, 7153, 2]
// Exports: default
...
export default function DevToolsAnalyticsScreen() {
  ...
  const items2 = [closure_8(trimmed(7303).TableSwitchRow, { icon: closure_8(trimmed(12284).ArrowsUpDownIcon, {}), label: "Reverse Events", value: first, onValueChange: tmp5[1] }), ];
  const obj4 = { icon: closure_8(trimmed(12284).ArrowsUpDownIcon, {}), label: "Reverse Events", value: first, onValueChange: tmp5[1] };
