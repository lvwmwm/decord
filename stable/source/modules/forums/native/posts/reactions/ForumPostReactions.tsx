...
export const MaxForumPostReactions = function MaxForumPostReactions(thread) {
  ...
  const tmp = closure_6();
  dependencyMap = tmp;
  const disableReactionCreates = reactionContainerStyle(11451)(thread).disableReactionCreates;
  let num = 28;
