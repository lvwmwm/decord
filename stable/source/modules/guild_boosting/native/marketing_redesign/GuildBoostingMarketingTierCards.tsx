...
// Dependencies: [32, 19, 17, 1074, 1373, 21, 8883, 1114, 10242, 12665, 5182, 5178, 10510, 13676, 9501, 4579, 13678, 4636, 576, 13670, 5522, 4373, 4637, 4632, 4571, 4488, 5068, 5204, 4530, 13679, 13681, 4486, 1176, 13683, 13684, 5662, 12697, 2]
// Exports: default
...
items[2] = {
  isIncluded: true,
  IconComponent: fn(12665).ScreenArrowIcon,
  getCopy() {
    const intl = util.intl;
