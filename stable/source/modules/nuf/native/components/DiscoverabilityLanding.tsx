...
// Dependencies: [19, 17, 12810, 1074, 21, 4636, 576, 5605, 1611, 4603, 12882, 1896, 5763, 5668, 12883, 4632, 1114, 8716, 12837, 5056, 2]
// Exports: default

// Module 12881 (DiscoverabilityLanding)
...
export default function DiscoverabilityLanding(onNext) {
  ...
  noop = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12882, dependencyMap.paths), "Discoverability Landing", { allowPhone, allowEmail });
  }, items);
