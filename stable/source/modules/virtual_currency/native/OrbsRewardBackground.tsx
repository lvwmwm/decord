...
// Dependencies: [32, 19, 4628, 1895, 21, 504, 1093, 5668, 11918, 8425, 11919, 2]
// Exports: OrbsRewardBackground

// Module 11917 (OrbsRewardBackground)
...
const _modDef11919 = tmp15(11919);
const require = fn;
const jsxProd = fn(21);
