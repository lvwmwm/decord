...
// Function ID: 12468
// Name: CreateGuild
// Dependencies: [19, 17, 1371, 1074, 21, 4636, 576, 5043, 5052, 5054, 4632, 1114, 11932, 6707, 7303, 5056, 7042, 2]
// Exports: default

// Module 12467 (CreateGuild)
...
export default function CreateGuild(arg0) {
  ...
  items1[2] = closure_7(ref(11932), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
