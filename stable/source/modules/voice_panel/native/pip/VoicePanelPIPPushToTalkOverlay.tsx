...
// Dependencies: [32, 19, 17, 12406, 21, 4373, 5670, 1176, 4636, 576, 9826, 17203, 5055, 17198, 6756, 17279, 2]
// Exports: default
...
require = fn;
const PUSH_TO_TALK_PIP_PHYSICS = fn(12406).PUSH_TO_TALK_PIP_PHYSICS;
const jsxProd = fn(21);
