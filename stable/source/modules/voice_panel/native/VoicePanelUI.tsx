...
// Function ID: 17205
// Name: VoicePanelUI
// Dependencies: [32, 19, 17, 4652, 8408, 4844, 12406, 12404, 4657, 12407, 21, 3, 5055, 4636, 576, 4373, 1608, 12405, 1611, 6756, 9625, 11491, 17205, 4604, 17198, 4338, 12410, 9809, 17203, 17191, 11129, 9740, 7705, 7176, 7265, 7285, 1247, 17206, 7259, 17207, 17208, 9638, 17209, 17211, 17242, 17271, 17275, 17280, 2]
...
function AnimatedWrapper(children) {
  ...
  dependencyMap = tmp3;
  const context = connected.useContext(height(12405));
    ...
    if (!obj.cheapWorkletShallowEqual(safeAreaState, windowHeight)) {
      ...
      if (modeToSet !== VoicePanelModes.PIP) {
        ...
        if (modeToSet === tmp8.PANEL) {
          ...
          tmp16(11491)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
        }
      }
    }
  };
  let obj5 = wrapperOffset(4373);
  fn3.__closure = { cheapWorkletShallowEqual: wrapperOffset(9625).cheapWorkletShallowEqual, VoicePanelModes: animatedStyle1, wrapperDimensions, updateSharedValueIfChanged: height(11491), wrapperOffset, getMaxPanelWidth: wrapperOffset(17191).getMaxPanelWidth, getPanelX: wrapperOffset(17191).getPanelX, roundToNearestPixel: height(11129), windowDimensions };
...
const POP_RESISTANCE = fn(12407).POP_RESISTANCE;
const jsxProd = fn(21);
  ...
  const memo1 = noop.useMemo(() => {
    ...
    const fn2 = function u(arg0) {
      if (!gestureState.get().cancel) {
        closure_1(11491)(wrapperOffset, { x: 0, y: 0 });
        ...
        if (merged1 !== setMode.PIP) {
          ...
          if (lockScrolling.get()) {
            ...
            if (!obj.get().requiresPop) {
              ...
              closure_1(11491)(wrapperOffset, point);
            } else {
              const _Math = Math;
          ...
          closure_1(11491)(wrapperOffset, point1);
          const tmp7 = closure_1(11491);
        }
      }
    };
    ...
    const fn5 = function s() {
      ...
      closure_1(11491)(gestureState, { cancel: false, active: false });
      closure_1(11491)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
    };
    ...
    const fn6 = function n(velocityY) {
      if (!gestureState.get().cancel) {
        ...
        if (mode.get() === setMode.PIP) {
          ...
          closure_1(11491)(wrapperDimensions, obj7);
          closure_1(11491)(wrapperOffset, { gestureActive: false });
          ...
          if (velocityY > 0) {
            if (connected.get()) {
              ...
              if (wrapperOffset.get().y > 0.2 * diff) {
                closure_1(11491)(tmp12, { gestureActive: false });
                channelId(4373).runOnJS(dismissPanel)();
                const obj3 = channelId(4373);
              } else {
                closure_1(11491)(tmp12, { gestureActive: false, x: 0, y: 0 });
