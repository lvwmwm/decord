...
// Dependencies: [19, 17, 4458, 16379, 1074, 11222, 21, 4636, 576, 7445, 4338, 504, 4373, 5055, 16117, 16392, 1114, 16449, 16391, 5670, 16403, 4632, 2]
...
const MODE_CHANGE_PHYSICS = fn(11222).MODE_CHANGE_PHYSICS;
const jsxProd = fn(21);
