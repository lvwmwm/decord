...
// Dependencies: [2025, 7331, 1074, 10953, 1114, 3460, 2]
...
// Module 10952 (SlayerStorefrontDisclaimerUtils)
...
let closure_6 = { [fn(10953).StorefrontPlatform.DESKTOP]: "PC", [fn(10953).StorefrontPlatform.XBOX]: "Xbox", [fn(10953).StorefrontPlatform.PLAYSTATION]: "PlayStation", [fn(10953).StorefrontPlatform.SWITCH]: "Switch", [fn(10953).StorefrontPlatform.APPLE_ARCADE]: "Apple Arcade", [fn(10953).StorefrontPlatform.NETFLIX]: "Netflix", [fn(10953).StorefrontPlatform.AMAZON_KIDS_PLUS]: "Amazon Kids+" };
let items = [fn(10953).StorefrontPlatform.PLAYSTATION];
const size = fn(2);
