...
// Dependencies: [32, 19, 17, 7660, 1887, 2021, 1074, 21, 4636, 576, 8287, 7265, 7285, 1240, 8281, 8288, 7253, 4632, 1114, 8289, 10863, 504, 14725, 8283, 14726, 13308, 13309, 8290, 8944, 5068, 11357, 2]
// Exports: default
...
function NameplateActionSheetPreview(arg0) {
  ...
  const items3 = [closure_11(View, obj3), closure_10(tmp10(11357).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
