...
// Dependencies: [19, 17, 16299, 1074, 10246, 21, 576, 4636, 16203, 1114, 3236, 5761, 7152, 16300, 16301, 5056, 11117, 2]
    ...
    const obj4 = {
      ...
      children: arr.map((item, index) => {
          ...
          obj3.onPress = function onPress() {
            ...
            return tmp(arr(11117).getDestinationIdFromResult(closure_0));
          };
