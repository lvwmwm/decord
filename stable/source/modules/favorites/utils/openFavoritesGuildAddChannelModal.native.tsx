...
// Dependencies: [11113, 11114, 1896, 4839, 2]
// Exports: closeFavoritesGuildAddChannelModal, default

// Module 11112 (openFavoritesGuildAddChannelModal)
...
export default function openFavoritesGuildAddChannelModal(arg0) {
  ...
  showSearchableDestinationListModalDefault(asyncRequireImpl(11114, dependencyMap.paths), { parentId, source }, FavoritesGuildAddChannelModal);
};
