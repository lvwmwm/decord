...
function genSubmitData(version, name, arr, email_token) {
  ...
  let obj2 = { channel_id: "Array", message_id: "call", stage_instance_id: "find", guild_id: "window", guild_scheduled_event_id: "HermesInternal", user_id: "w", email_token: "__closure", application_id: "__closure", entrypoint: "__closure", widget_id: "__closure" };
  obj.language = str;
  ...
  if (DevSettingsStore.get("iar_skip_api_report_submit")) {
    ...
    if (REPORT_TO_MOD.has(name.name)) {
      ...
      if (name.name === tmp4(8753).ModeratorReportNames.MESSAGE) {
        let obj2 = { channel_id: "getCurrentUser", message_id: "call", guild_id: "skuId" };
        obj4 = {};
