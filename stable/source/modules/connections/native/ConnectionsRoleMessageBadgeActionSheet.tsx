...
// Dependencies: [32, 19, 17, 1385, 502, 2021, 2015, 1979, 11954, 5489, 1074, 21, 4636, 576, 1114, 5488, 4587, 4632, 4571, 12, 4338, 5364, 11699, 9568, 1176, 1396, 4488, 38, 7265, 7285, 504, 1240, 4816, 5601, 7253, 7306, 5056, 4603, 11702, 8296, 2]
// Exports: default

// Module 11953 (ConnectionsRoleMessageBadgeActionSheet)
...
import GuildRoleConnectionEligibilityStore from "GuildRoleConnectionEligibilityStore" /* 11954 */;
    ...
    obj1 = {
      children: keys.map((item, index) => {
            ...
            if (officialApplicationIds.includes(str)) {
              ...
              let tmp12 = value2(tmp2(11699), obj2);
            } else if (null != tmp7) {
            ...
            if (null == value) {
              ...
              let tmp26 = null;
              if (null != tmp7) {
                const obj6 = { style: tmp21.popoutCheckGroupPlatformIcon, user: tmp7, size: tmp11(1176).AvatarSizes.XSMALL, guildId: "a" };
