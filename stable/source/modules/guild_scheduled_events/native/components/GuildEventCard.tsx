...
// Function ID: 9939
// Name: GuildEventCard
// Dependencies: [19, 17, 4659, 7629, 1963, 21, 4636, 576, 9902, 5514, 504, 9834, 5688, 8528, 9926, 2]

// Module 9938 (GuildEventCard)
import nativeDefault from "native" /* 576 */;
import ButtonGroup from "ButtonGroup" /* 5514 */;
import GuildEventCardComponents from "GuildEventCardComponents" /* 9902 */;
...
function GuildEventCardControls(onCloseAction) {
  ...
  if (tmp6Result) {
    const obj3 = { event };
    tmp6Result = tmp6(tmp2(9902).GuildEventCardRSVPAction, obj3);
  }
  items[1] = tmp6Result;
...
let closure_5 = fn(7629).isGuildScheduledEventActive;
