...
// Function ID: 12475
// Name: SearchTokens
// Dependencies: [32, 1957, 2012, 4285, 2011, 4482, 1371, 12475, 12476, 1074, 4228, 12, 1114, 4789, 4481, 12473, 12477, 5598, 5523, 9965, 12478, 12479, 2]
...
import SearchTokensUtils from "SearchTokensUtils" /* 12477 */;
import SearchTokenStreamerModeUtils from "SearchTokenStreamerModeUtils" /* 12478 */;
import QueryTokenizer from "QueryTokenizer" /* 12479 */;
...
export const isValidFilterAnswerForSubmit = function isValidFilterAnswerForSubmit(searchTokenType, trimmed) {
  if (null == closure_37[searchTokenType]) {
    ...
    if (SearchTokenTypes.ANSWER_HAS === tmp) {
      return tmp7(12477).validateForMapWithNegation("has", getHasMap(), token);
      ...
      return tmp7(12477).validateForMapWithNegation("author_type", obj, token);
