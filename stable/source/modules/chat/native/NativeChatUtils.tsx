...
// Dependencies: [17, 1363, 11409, 1230, 11410, 11411, 2]

// Module 11408 (NativeChatUtils)
import SentryUtilsDefault from "SentryUtils" /* 1230 */;
import PlatformUtils from "PlatformUtils" /* 1363 */;
import ChatNativeComponent from "ChatNativeComponent" /* 11409 */;
import NativeChatModuleDefault from "NativeChatModule" /* 11411 */;
...
export default {
  scrollTo(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp5(11409).Commands;
  ...
  scrollToBottom(arg0, arg1) {
    if (null != arg0) {
      if (obj.isIOS()) {
        ...
        const Commands = tmp2(11409).Commands;
  ...
  scrollIntoView(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp4(11409).Commands;
  ...
  updateRows(arg0, rows) {
    if (null != arg0) {
      if (obj6.isIOS()) {
        const andIncrementChangesetIdForChat = tmp31(11410).getAndIncrementChangesetIdForChat(arg0);
        ({ rows, forceReload } = rows);
        if (forceReload == null) {
          forceReload = false;
        }
        const tmp31Result = tmp31(11410);
        ...
        const Commands = tmp31(11409).Commands;
        const _JSON2 = JSON;
        ...
        if (null != tmp2) {
          ...
          const andIncrementChangesetIdForChat1 = tmp31(11410).getAndIncrementChangesetIdForChat(arg0);
          ...
          const tmp31Result2 = tmp31(11410);
        }
      }
      obj6 = PlatformUtils;
    }
  ...
  clearRows(arg0) {
    if (null != arg0) {
      if (obj4.isIOS()) {
        const Commands = tmp6(11409).Commands;
        Commands.clearRows(arg0, tmp6(11410).getAndIncrementChangesetIdForChat(arg0));
        const tmp6Result = tmp6(11410);
      } else {
        const tmp2 = React4(arg0);
        if (null != tmp2) {
          const obj = NativeChatModuleDefault;
          obj.clearRows(tmp2, tmp6(11410).getAndIncrementChangesetIdForChat(arg0));
          const tmp6Result2 = tmp6(11410);
        }
      }
      obj4 = PlatformUtils;
    }
