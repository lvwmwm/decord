...
// Dependencies: [19, 17, 21, 4636, 576, 1176, 12371, 4632, 1114, 5056, 2]
...
export default noop.memo((onCreateThreadPress) => {
  ...
  const obj2 = { style: tmp.iconWrapper, children: React4(native.Icon, { source: _modDef12371, size: native.Icon.Sizes.MEDIUM }) };
