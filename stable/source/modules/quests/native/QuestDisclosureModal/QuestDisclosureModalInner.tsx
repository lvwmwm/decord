...
// Dependencies: [17, 1074, 21, 4636, 576, 1935, 9415, 1114, 9015, 11959, 9352, 5773, 4632, 11432, 5688, 2024, 5056, 2]
// Exports: default
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  if (setting) {
    ...
    items1 = [obj, , ];
    const obj2 = { icon: tmp5(tmp2(11959).UserIcon, { size: "xs" }), text: null };
