...
// Dependencies: [32, 5, 19, 17, 4628, 1371, 1895, 5525, 21, 4839, 11912, 1896, 4636, 576, 8962, 5712, 5761, 1114, 5668, 8935, 1364, 11913, 11914, 11915, 504, 8975, 1093, 11427, 11916, 11900, 5528, 11917, 7226, 4632, 5056, 2]
// Exports: default, openQuestOrbsRewardModal

// Module 11912 (QuestOrbsRewardModal)
...
function AnimatedOrbContainer(isAppActive) {
  ...
  const items1 = [tmp13, , ];
  const obj3 = { uri: _modDef11914, style: null, onLoad: null, animate: null };
  ...
  if (tmp15Result) {
    const obj5 = { uri: _modDef11915, style: null, onLoad: null, animate: null };
...
export default function QuestOrbsRewardModal(quest) {
  ...
  if (num2 == null) {
    num2 = tmp2(11427).getQuestOrbRewardQuantityForUser(quest.config, stateFromStores2);
    const tmp2Result = tmp2(11427);
  }
  const effect = obj3.useEffect(() => {
    num(11916).applyOrientationLock("PORTRAIT");
    return () => {
  ...
  const obj7 = { style: absoluteFill.absoluteFill, accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: closure_13(num(11917).OrbsRewardBackground, { style: tmp.background, onReady: callback }) };
