...
// Dependencies: [19, 17, 7807, 21, 4636, 576, 15207, 11620, 7826, 4259, 11649, 4632, 1114, 15229, 2]
// Exports: default
...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11649).getVideoQuestProgressRemainingAccessibilityLabel(questTaskDetails, tmp8);
    const tmp3Result = tmp3(11649);
  }
