...
// Dependencies: [32, 19, 1895, 11333, 1074, 21, 9003, 8390, 504, 11623, 11624, 5532, 2]
// Exports: BillableAdPlacementImpressionTrackerNative, QuestContentImpressionTrackerNative

// Module 11911 (QuestContentImpressionTracker)
...
function AdContentImpressionTrackerBaseNative(skipRemountKey) {
  ...
  const adContentImpressionTrackerProps = adContentIds2(11623).useAdContentImpressionTrackerProps(skipRemountKey);
  ...
  const obj2 = adContentIds2(11623);
  let items1 = [joined];
  ...
  return createElement(adContentIds2(11624).QuestContentImpressionTracker, tmp19);
}
let closure_6 = fn(11333).MIN_QUEST_CONTENT_VISIBILITY_PERCENTAGE;
