...
// Dependencies: [32, 19, 17, 21, 4636, 576, 7226, 9179, 1114, 13093, 10140, 13094, 13095, 13096, 8381, 11646, 1363, 5046, 13097, 8411, 13099, 4373, 13103, 8380, 13104, 13105, 13098, 8378, 8383, 2]
// Exports: default

// Module 13092 (MediaModalOverlay)
...
import useMediaModalFooterAction from "useMediaModalFooterAction" /* 11646 */;
import useOverlayLayoutDriver from "useOverlayLayoutDriver" /* 13096 */;
import MediaViewerThumbnailsDefault from "MediaViewerThumbnails" /* 13097 */;
import MediaModalOverlayHeader from "MediaModalOverlayHeader" /* 13099 */;
import MediaModalOverlayAltTextDefault from "MediaModalOverlayAltText" /* 13103 */;
...
function OverlayMuteButton(arg0) {
  ...
  obj.source = importDefault(isMuted ? 13093 : 10140);
...
function OverlayObscureToggleButton(arg0) {
  ...
  const rect = { left: true, right: true, children: null };
  obj.source = importDefault(spoilerActive ? 13094 : 13095);
  obj.color = nativeDefault.unsafe_rawColors.WHITE;
...
function MediaModalOverlay(getVideoControls) {
  ...
  obj2.obscure = flag;
  obj2.spoilerActive = _slicedToArray(index(13098).useMediaItemSpoilerState(index), 1)[0];
...
let closure_13 = noop.memo((arg0) => {
  ...
  if (null != mediaModalFooterActionStore) {
    ...
    tmp22Result5 = tmp22(tmp2(13104).MediaModalOverlayFooterAction, obj13);
    ...
    tmp22Result5 = tmp22(tmp2(13105).MediaModalOverlayFooter, obj15);
  }
