...
// Dependencies: [32, 19, 17, 4628, 1979, 17724, 1074, 21, 4636, 576, 7046, 1477, 5043, 4373, 1240, 4816, 8396, 5204, 4632, 10889, 1176, 11697, 5056, 1114, 2]
// Exports: default
...
import PaginationDefault from "Pagination" /* 10889 */;
    ...
    children: closure_14(PaginationDefault, {
      ...
      renderItem(item) {
        ...
        obj8.children = item.contents().map((children, index) => {
          ...
          const items = [closure_3_14(native.Icon, { source: _modDef11697, size: native.IconSizes.MEDIUM, color: nativeDefault.unsafe_rawColors.GREEN_360 }), closure_3_14(Text_Text.Text, { style: closure_3.templateContentText, variant: "text-sm/medium", children })];
          obj.children = items;
