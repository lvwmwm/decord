...
// Dependencies: [32, 19, 17, 1074, 5489, 21, 4636, 576, 4571, 11696, 1176, 1396, 4488, 5686, 1114, 5204, 5761, 7303, 17754, 1363, 4632, 5364, 5768, 2]
// Exports: default
...
function Header(arg0) {
  ...
  if (null != application2) {
    const obj2 = { size: tmp3(1176).AvatarSizes.XSMALL, user: null, guildId: "r" };
    let bot;
    if (integration != null) {
    ...
    if (undefined === getOrFetchApplicationBatched) {
      ...
      let tmp11;
      if (null != bot1) {
        const obj3 = { size: tmp3(1176).AvatarSizes.XSMALL, user: getOrFetchApplicationBatched.bot, guildId: "r" };
