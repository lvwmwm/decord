...
// Dependencies: [19, 17, 21, 4636, 576, 12761, 12762, 5688, 4632, 1114, 6711, 7310, 2]
// Exports: ChatProvisionalAccountExplainerCard, UserProfileProvisionalAccountExplainerCard

// Module 12760 (ProvisionalAccountExplainer)
...
export const ChatProvisionalAccountExplainerCard = function ChatProvisionalAccountExplainerCard(iconSize) {
  ...
  const provisionalAccountExplanationText = iconSize(12762).useProvisionalAccountExplanationText({ userId, renderApplicationName: callback });
