...
// Dependencies: [19, 17, 11562, 21, 4636, 576, 4571, 4488, 13959, 13960, 504, 11923, 4228, 7226, 4632, 1114, 5056, 4839, 2]
// Exports: default
...
export default function BuildOverrideModal(overrideUrl) {
  ...
  if (override != null) {
    ...
    if (targetBuildOverride != null) {
      const tmp9 = targetBuildOverride[tmp5(undefined, 11923).DEVICE_FIELD];
      if (tmp9 != null) {
        id = tmp9.id;
      }
    }
