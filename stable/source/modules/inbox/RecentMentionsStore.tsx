...
// Dependencies: [4286, 502, 1957, 4857, 4651, 4285, 4458, 4817, 1371, 1074, 510, 4859, 4847, 4874, 12, 4665, 7373, 7740, 504, 573, 2]
        ...
        if (!tmp2(7740)(message, id)) {
          ...
          if (tmp2(4874)(obj)) {
            ...
            if (tmp2ResultResult) {
              ...
              tmp2ResultResult = tmp2(4874)(obj3);
