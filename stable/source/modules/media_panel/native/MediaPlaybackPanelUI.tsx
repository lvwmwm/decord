...
// Dependencies: [32, 19, 9788, 14626, 12407, 12406, 21, 4636, 576, 1611, 1477, 17334, 4373, 9625, 11491, 17130, 4637, 4640, 5055, 17132, 7259, 6756, 17336, 2]
// Exports: default
...
const BORDER_RADIUS_PHYSICS = fn(12406).BORDER_RADIUS_PHYSICS;
const jsx = fn(21).jsx;
