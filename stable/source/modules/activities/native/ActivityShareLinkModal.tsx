...
// Dependencies: [5, 32, 19, 17, 1957, 1371, 1956, 10992, 4629, 21, 4636, 576, 504, 11117, 12265, 14574, 7271, 1369, 14576, 7559, 7784, 4335, 1114, 7292, 4334, 1477, 1611, 1363, 5712, 7966, 5705, 7480, 4579, 5206, 11120, 11131, 2]
// Exports: default
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != first3) {
              dependencyMap = 1;
              c3 = 1;
              let obj4 = { value: Promise.all(first1.map(tmp2(11117).getOrResolveChannelIdFromDestinationId)), done: false };
              return obj4;
            } else {
              c3 = 3;
            }
