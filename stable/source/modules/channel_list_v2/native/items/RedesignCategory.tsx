...
// Dependencies: [19, 17, 7634, 7220, 4817, 10246, 21, 4636, 1363, 576, 4632, 12886, 5204, 11291, 11691, 11048, 504, 4789, 11111, 16204, 16205, 7216, 1114, 7298, 11692, 6717, 2]
...
import useFavoritesGuildCategoryAddActionDefault from "useFavoritesGuildCategoryAddAction" /* 11111 */;
import CategoryCollapseActionCreators from "CategoryCollapseActionCreators" /* 11691 */;
...
function renderCategoryItem(muted) {
  ...
  if (Icon == null) {
    Icon = trailingAction(12886).PlusMediumIcon;
  }
...
export const CategoryChannel = function CategoryChannel(channel) {
  ...
  obj7.icon = closure_11(channel(11291).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed2 ? obj3 : obj4 });
...
export const RecentlyActiveCategory = function RecentlyActiveCategory(guildId) {
  ...
  obj3 = {};
  const merged1 = Object.assign(merged);
  obj3.icon = closure_11(tmp2(11291).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed ? obj3 : obj4 });
