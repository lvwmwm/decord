...
// Dependencies: [19, 17, 4285, 1074, 11519, 21, 4636, 576, 12725, 504, 9171, 11002, 12753, 4481, 4603, 11520, 1896, 8752, 4649, 5056, 1114, 4632, 2]
// Exports: default
...
let closure_8 = fn(11519).BLOCK_CONFIRMATION_ACTION_SHEET_KEY;
const jsxProd = fn(21);
...
export default function RestrictedMessagePreviewActions(channel) {
  ...
  const callback4 = noop.useCallback(() => {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11520, dependencyMap.paths), closure_8, { userId: user.id, channelId: channel.id });
  }, items6);
