...
// Dependencies: [19, 17, 12095, 21, 4347, 4373, 4637, 12380, 2]
// Exports: default, interactivityProps

// Module 12379 (ChatInputActionButtonTransitionItem)
...
const CHAT_INPUT_TIMING_CONFIG = fn(12095).CHAT_INPUT_TIMING_CONFIG;
const jsx = fn(21).jsx;
