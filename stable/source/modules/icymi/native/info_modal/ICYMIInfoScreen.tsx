...
// Dependencies: [32, 5, 19, 17, 1085, 21, 4636, 576, 5763, 1611, 4571, 1483, 8477, 16566, 4839, 7966, 7974, 1114, 5668, 16568, 16569, 16570, 16571, 4632, 9415, 13143, 4596, 4603, 16572, 1896, 5056, 2]
// Exports: default
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  const items11 = [closure_9(closure_6, { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13143).NewUserIcon, { size: "sm", color: "interactive-text-active" }) }), ];
  ...
  const obj21 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13143).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
