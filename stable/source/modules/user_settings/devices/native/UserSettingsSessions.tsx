...
// Dependencies: [32, 19, 17, 1371, 1074, 21, 4636, 5605, 576, 14758, 504, 15039, 5054, 5768, 1114, 5686, 7226, 4632, 1369, 5204, 1176, 7095, 1483, 12397, 7093, 15040, 9008, 10193, 7061, 15041, 2]
// Exports: default
...
function UnknownLegacySessionsInfo() {
  ...
  obj2.icon = closure_10(require("TableRow").TableRow.Icon, { variant: "translucent", source: _modDef12397 });
