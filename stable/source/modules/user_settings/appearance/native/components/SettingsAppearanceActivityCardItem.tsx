...
// Dependencies: [19, 17, 2025, 15380, 21, 4373, 1176, 4636, 576, 563, 8940, 5668, 4632, 1880, 15381, 15382, 15383, 2]
// Exports: default

// Module 15379 (SettingsAppearanceActivityCardItem)
...
obj.userCounter = { flexDirection: "row", alignItems: "center", justifyContent: "center", marginLeft: -4, height: fn(1176).AVATAR_SIZE_MAP[fn(undefined, 1176).AvatarSizes.XSMALL_20], minWidth: fn(1176).AVATAR_SIZE_MAP[fn(undefined, 1176).AvatarSizes.XSMALL_20], borderRadius: nativeDefault.radii.round, paddingHorizontal: 4, paddingTop: 1 };
  ...
  if (null != avatars) {
    mapped = substr.map((source, index) => {
      ...
      if (index !== diff) {
        ...
        const point = { shape: tmp3(8940).CutoutShape.Circle, x: tmp3(1176).AVATAR_SIZE_MAP[tmp3(undefined, 1176).AvatarSizes.XSMALL_20] - 4 - 2, y: -2, size: tmp3(1176).AVATAR_SIZE_MAP[tmp3(undefined, 1176).AvatarSizes.XSMALL_20] + 4 };
        const items = [point];
        obj3.cutouts = items;
        obj3.children = tmp5;
