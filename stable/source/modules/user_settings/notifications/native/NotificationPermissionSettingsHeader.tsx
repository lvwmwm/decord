...
// Dependencies: [19, 17, 1074, 12543, 21, 4636, 576, 12544, 1240, 5688, 9188, 4632, 1114, 5056, 2]
// Exports: default
...
export default function NotificationPermissionSettingsHeader() {
  ...
  canSeePushNotificationNudge = canSeePushNotificationNudge(12544).useCanSeePushNotificationNudge();
