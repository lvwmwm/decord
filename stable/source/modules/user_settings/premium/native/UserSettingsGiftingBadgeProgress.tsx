...
// Dependencies: [32, 19, 17, 8309, 21, 4636, 576, 10876, 7265, 7285, 504, 8301, 4632, 1114, 2492, 10881, 5056, 11168, 10790, 13661, 11291, 2]
// Exports: default

// Module 13660 (UserSettingsGiftingBadgeProgress)
...
function GiftingBadgeIntro(analyticsLocation) {
  ...
  importDefault = tmp;
  dependencyMap = analyticsLocation(10876).useIsGiftingBadgeComplexArtEnabled(UserSettingsGiftingBadgeProgress);
  let obj = analyticsLocation(10876);
  ...
  if (null != stateFromStores) {
    ...
    obj5.children = intl.string(tmp4(2492)["4Yp0mI"]);
    obj4.children = closure_9(tmp2(4632).Text, obj5);
    ...
    const obj6 = {
      ...
      children: stateFromStores.map((name) => {
          ...
          obj5.children = intl.format(_modDef2492.qvx9E4, { count: closure_8(name) });
    ...
    obj7.icon = closure_9(tmp2(11168).GiftIcon, obj8);
    const intl2 = tmp2(1114).intl;
    obj7.text = intl2.string(tmp4(2492).DZnomS);
    obj7.onPress = function onPress() {
      utils_openGiftModal.openGiftModal({ analyticsLocation, analyticsLocations });
    };
    items1[2] = closure_9(tmp2(5056).Button, obj7);
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  const isGiftingBadgeComplexArtEnabled = analyticsLocation(10876).useIsGiftingBadgeComplexArtEnabled(UserSettingsGiftingBadgeProgress);
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(10876).getGiftingBadgeProgressPercent(badgeProgress, currentTier, nextTier);
    const tmp7Result = tmp7(10876);
    let giftingBadgeTierIconUrl = tmp7(10876).getGiftingBadgeTierIconUrl(currentTier, isGiftingBadgeComplexArtEnabled);
    const tmp7Result3 = tmp7(10876);
    const giftingBadgeTierIconUrl1 = tmp7(10876).getGiftingBadgeTierIconUrl(nextTier, isGiftingBadgeComplexArtEnabled);
    if (null != nextTier) {
      ...
      obj4.nextTier = str2;
      let formatToPlainStringResult = intl2.formatToPlainString(tmp4(2492).XTX3OO, obj4);
    } else {
      ...
      formatToPlainStringResult = intl.formatToPlainString(tmp4(2492).LnsdbK, obj5);
    }
    ...
    obj17.count = tmp19;
    obj18.children = intl3.format(tmp4(2492).iIpfQe, obj17);
    obj16.children = closure_9(tmp7(4632).Text, obj18);
    ...
    obj19.icon = closure_9(tmp7(11168).GiftIcon, obj20);
    const intl4 = tmp7(1114).intl;
    obj19.text = intl4.string(tmp4(2492).DZnomS);
    obj19.onPress = function onPress() {
      utils_openGiftModal.openGiftModal({ analyticsLocation, analyticsLocations });
    };
    items5[1] = closure_9(tmp7(5056).Button, obj19);
    ...
    obj23.children = intl5.string(tmp4(2492).WZ4cXA);
    const items6 = [closure_9(tmp7(4632).Text, obj23), ];
    if (tmp11Result) {
    ...
    if (tmp11Result) {
      ...
      const obj26 = {
        ...
        children: tiers.map((key) => {
              ...
              obj5.children = intl.format(_modDef2492.qvx9E4, { count: closure_8(key) });
      ...
      obj27.children = intl6.string(tmp4(2492)["4Yp0mI"]);
      items7[1] = tmp15(tmp7(4632).Text, obj27);
  ...
  let obj2 = analyticsLocation(10876);
};
