...
// Dependencies: [32, 19, 17, 8548, 8537, 1074, 21, 4636, 576, 9179, 8711, 4632, 1114, 13661, 11291, 8536, 11, 14863, 8538, 4839, 12012, 1896, 12016, 504, 1240, 12014, 2]
...
import useSafetyHubClassifications from "useSafetyHubClassifications" /* 12014 */;
...
function SafetyHubViolationsHeader(count) {
  ...
  if (opened) {
    ...
    ChevronSmallDownIcon = tmp7(11291).ChevronSmallDownIcon;
  }
...
function ClassificationDetail(classification) {
  ...
  let obj4 = {
    onPress() {
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(12012, dependencyMap.paths), { classificationId: id, source: React6.StandingTab });
    },
    children: null
  };
