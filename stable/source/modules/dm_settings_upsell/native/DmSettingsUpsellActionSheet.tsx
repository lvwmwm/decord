...
// Dependencies: [19, 17, 1979, 21, 4636, 576, 504, 17455, 17459, 7300, 11511, 4632, 1114, 5665, 5056, 7098, 1935, 4335, 9696, 4603, 13995, 2]
// Exports: default
...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj4 = { source: stateFromStores(11511), style: tmp.headerImage };
