...
// Function ID: 7074
// Name: AuthFormView
// Dependencies: [19, 17, 21, 4636, 576, 7045, 7074, 7075, 7076, 7079, 2]
// Exports: default
...
export default function AuthFormView(arg0) {
  ...
  if (tmp3) {
    ...
    if (null != headerText) {
      ...
      tmp15 = timestampProducer(tmp(7075), obj3);
    }
    const items1 = [tmp15, , ];
    let tmp17 = null;
    if (null != subHeader) {
    ...
    const items3 = [timestampProducer(tmp(7076), obj5), timestampProducer(tmp(7079), {}), ];
