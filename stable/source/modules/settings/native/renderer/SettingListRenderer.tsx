...
// Dependencies: [19, 17, 14778, 14671, 11606, 21, 4636, 576, 5768, 4632, 14779, 1611, 14780, 14784, 9003, 14785, 14788, 14789, 1874, 2]
...
const ListItemType = fn(11606).ListItemType;
const jsx = fn(21).jsx;
