...
// Dependencies: [19, 17, 1074, 1954, 21, 4636, 576, 7485, 7253, 7226, 7257, 12103, 1379, 12105, 12106, 12107, 12108, 12109, 12110, 12111, 1176, 1114, 4632, 3592, 5056, 2]
// Exports: default

// Module 12102 (CustomTypingIndicatorAnnounceActionSheet)
...
export default function CustomTypingIndicatorAnnounceActionSheet(markAsDismissed) {
  ...
  const items5 = [ref(12105), ref(12106), ref(12105)];
  obj7.emojiSource = items5;
  obj7.style = tmp2.outerStack;
  obj6.children = closure_7(ref(12103), obj7);
