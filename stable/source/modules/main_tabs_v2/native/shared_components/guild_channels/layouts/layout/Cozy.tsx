...
// Function ID: 10254
// Name: Cozy
// Dependencies: [10251, 10252, 576, 1176, 5665, 7275, 2]
...
obj.messagePreview = { text: { variant: "redesign/message-preview/medium" }, messageTypeIconSize: fn(1176).IconSizes.REFRESH_SMALL_16, messageTypeIconSizeNew: "xs", height: 18, margin: { marginTop: 2 } };
obj.inviteRow = { text: { variant: "text-md/semibold" } };
const obj4 = { text: { variant: "redesign/message-preview/medium" }, messageTypeIconSize: fn(1176).IconSizes.REFRESH_SMALL_16, messageTypeIconSizeNew: "xs", height: 18, margin: { marginTop: 2 } };
obj.icon = { avatarSize: fn(1176).AvatarSizes.LARGE_48, guildIconSize: fn(5665).GuildIconSizes.LARGE, guildBadgeIconSize: fn(5665).GuildIconSizes.XSMALL_20, wrapper: { size: 48 }, channelIcon: { size: 24 }, margin: { marginRight: 12 }, emoji: { size: 24, lineHeight: 32 } };
...
const obj5 = { avatarSize: fn(1176).AvatarSizes.LARGE_48, guildIconSize: fn(5665).GuildIconSizes.LARGE, guildBadgeIconSize: fn(5665).GuildIconSizes.XSMALL_20, wrapper: { size: 48 }, channelIcon: { size: 24 }, margin: { marginRight: 12 }, emoji: { size: 24, lineHeight: 32 } };
