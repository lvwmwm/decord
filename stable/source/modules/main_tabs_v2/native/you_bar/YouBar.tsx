...
// Function ID: 16461
// Name: YouBar
// Dependencies: [5, 32, 19, 17, 4456, 4458, 1371, 15179, 1074, 1954, 21, 4636, 576, 1477, 15172, 11661, 4497, 15178, 15182, 4373, 5055, 8470, 16461, 14804, 504, 8334, 16463, 4495, 4604, 1369, 12, 16466, 1896, 4494, 11355, 7445, 1943, 1114, 7485, 16107, 6756, 1176, 16480, 16481, 16482, 16487, 16490, 4347, 16492, 16493, 2]
...
let closure_26 = noop.memo(() => {
  ...
  const drawerWidth = isMobileQuestDockRenderedBase(11661).useDrawerWidth();
  let obj3 = isMobileQuestDockRenderedBase(11661);
