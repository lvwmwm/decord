...
// Dependencies: [32, 19, 17, 1371, 1074, 12811, 21, 4636, 576, 12813, 4481, 1240, 1114, 8479, 7966, 1363, 5206, 4632, 13944, 13946, 2]
// Exports: default
...
export default function AddFriendScreen(navigation) {
  ...
  let callback;
  let tmp = closure_13();
  const contactSyncAccount = navigation(12813).useContactSyncAccount();
  let obj = navigation(12813);
  let obj2 = navigation(12813);
  [tmp5, c2] = callback(noop.useState(!navigation(12813).isContactSyncEnabled(contactSyncAccount)), 2);
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    ...
    result.then((result) => {
      ...
      if (!tmp5) {
        tmp5 = !tmp2(12813).isContactSyncEnabled(contactSyncAccount);
        const tmp2Result = tmp2(12813);
      }
      dependencyMap(tmp5);
    });
  }, items);
