...
// Function ID: 15770
// Name: SmsScreen
// Dependencies: [5, 32, 19, 17, 1074, 21, 7045, 15762, 1114, 1270, 15766, 15761, 6707, 5056, 15764, 2]
// Exports: default

// Module 15769 (SmsScreen)
...
export default function SmsScreen(mfaChallenge) {
  ...
  const screenStyles = finish(15762).useScreenStyles(tmp2);
  const tmp4 = first(noop.useState(null), 2);
  dependencyMap = tmp4[1];
  let obj = finish(15762);
  ...
  let obj4 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15766).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, placeholder: null, errorMessage: null };
  ...
  if (!tmp6) {
    tmp6 = first.length !== tmp8(15766).SMS_CODE_LENGTH;
  }
  obj6.disabled = tmp6;
  obj2.submit = handleChange(finish(15764), obj6);
