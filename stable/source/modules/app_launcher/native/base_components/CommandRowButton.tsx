...
// Dependencies: [5, 32, 19, 21, 12161, 9418, 12126, 7626, 5693, 5056, 1114, 4581, 2]
// Exports: default, useCommandRowSend

// Module 12238 (CommandRowButton)
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            obj6.optionValues = tmp3(12126).parseOptionValuesForSend(commandContext.channel, command, {});
