...
// Dependencies: [19, 17, 1371, 9538, 1482, 1074, 21, 576, 4636, 4373, 504, 12184, 4338, 8249, 12189, 9418, 8981, 12264, 4632, 1176, 8202, 4580, 1240, 7292, 12265, 4334, 1114, 12266, 2]
// Exports: default

// Module 12263 (application_view/Header)
...
import AppLauncherBackButtonDefault from "AppLauncherBackButton" /* 12264 */;
...
export default function Header(application) {
  ...
  if (null != application) {
    appLauncherIconSource = tmp(12184).getAppLauncherIconSource(application);
    const tmpResult = tmp(12184);
  }
  ...
  if (null != appLauncherIconSource) {
    ...
    let tmp12 = closure_8(tmp5(12189), obj2);
    let tmp13 = closure_8;
  } else {
  ...
  if (null != application) {
    ...
    if (tmpResult16.isRealApplication(application)) {
      ...
      items7[1] = tmp13(tmp5(12266), obj16);
