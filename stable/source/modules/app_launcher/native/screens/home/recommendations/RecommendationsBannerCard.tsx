...
// Dependencies: [19, 17, 1074, 21, 4636, 576, 9418, 8304, 1396, 12216, 5204, 12225, 1894, 12219, 4632, 1114, 12189, 5693, 2]
// Exports: default

// Module 12224 (RecommendationsBannerCard)
...
export default function RecommendationsBannerCard(application) {
  ...
  if (isLandscape) {
    ...
    let tmp12Result2 = closure_6(tmp4(12216).BaseAppRow, obj5);
  } else {
    ...
    if (showsPromoted) {
      ...
      const items3 = [tmp14(tmp10(12219), obj12), ];
      if (showsPromoted) {
    ...
    if (tmp14Result) {
      ...
      tmp14Result = tmp14(tmp10(12189), obj16);
    }
