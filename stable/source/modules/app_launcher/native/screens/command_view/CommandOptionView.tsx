...
// Dependencies: [19, 17, 4628, 21, 1894, 4636, 576, 504, 4373, 12294, 12295, 4632, 12296, 1176, 10544, 2]
// Exports: default

// Module 12293 (CommandOptionView)
import nativeDefault from "native" /* 576 */;
import ReanimatedRexportDefault from "ReanimatedRexport" /* 4373 */;
import AppLauncherCommandOptionDefault from "AppLauncherCommandOption" /* 12296 */;
...
export default function CommandOptionView(option) {
  ...
  const optionEnteringAnimation = option(12294).useOptionEnteringAnimation();
  ...
  if (set.has(option.type)) {
    ...
    const obj5 = {
      ...
      exiting: tmp2(12294).ExitingAnimation,
      layout: tmp2(12294).LayoutAnimation,
      onLayout(arg0) {
    ...
    obj3.children = closure_5(tmp2(12295).AwaitAnimationContext, obj4);
    return closure_5(tmp2(4373).LayoutAnimationConfig, obj3);
  } else {
    return null;
  }
  const tmp2Result = option(12294);
};
