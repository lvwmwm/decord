...
// Dependencies: [5, 32, 19, 17, 4628, 9419, 2015, 1482, 1074, 1607, 21, 4636, 576, 12287, 504, 4373, 4637, 4640, 4604, 5068, 4486, 5057, 1114, 4581, 11352, 4816, 7084, 12288, 7626, 8390, 12184, 1247, 12161, 12290, 1894, 9418, 12126, 9702, 1477, 11493, 10764, 12291, 10765, 5219, 1874, 5209, 12292, 9539, 6728, 4632, 12293, 12294, 12325, 1176, 38, 12261, 9546, 7624, 9424, 9535, 12326, 12327, 12247, 12248, 2]
// Exports: default

// Module 12286 (AppLauncherCommandViewScreen)
...
import _modDef12247 from "module_12247" /* 12247 */;
import _modDef12248 from "module_12248" /* 12248 */;
import AppLauncherCommandViewHeader from "AppLauncherCommandViewHeader" /* 12287 */;
import ApplicationCommandValidationUtils from "ApplicationCommandValidationUtils" /* 12288 */;
...
import CommandOptionViewDefault from "CommandOptionView" /* 12293 */;
  ...
  callback3 = obj2.useCallback(() => {
    if (null != command) {
      ...
      if (null != firstInvalidOption) {
        ...
        obj4.optionValues = tmp14(12126).parseOptionValuesForSend(commandContext.channel, tmp, optionValues.current);
        ...
        const tmp14Result4 = tmp14(12126);
        result1.then(() => {
...
function NotFoundState(onPress) {
  ...
  const obj3 = { style: tmp.emptyState, lightSource: _modDef12326, darkSource: _modDef12327, title: null, body: null, children: null };
...
function NoPermsState(command) {
  ...
  const obj6 = { style: tmp.emptyState, lightSource: _modDef12247, darkSource: _modDef12248, title: null, body: null, children: null };
  const intl = util.intl;
...
obj2.optionsContainer = { paddingTop: fn(12287).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4, paddingHorizontal: DEFAULT_CONTENT_PADDING, paddingBottom: DEFAULT_CONTENT_PADDING, backgroundColor: nativeDefault.colors.MOBILE_KEYBOARD_PANEL_BACKGROUND };
...
let obj4 = { paddingTop: fn(12287).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4, paddingHorizontal: DEFAULT_CONTENT_PADDING, paddingBottom: DEFAULT_CONTENT_PADDING, backgroundColor: nativeDefault.colors.MOBILE_KEYBOARD_PANEL_BACKGROUND };
...
obj2.emptyStateContainer = { paddingTop: fn(12287).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4, flex: 1 };
obj2.failureStateButtonWrapper = { marginTop: 24, alignSelf: "center" };
let obj7 = { paddingTop: fn(12287).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4, flex: 1 };
