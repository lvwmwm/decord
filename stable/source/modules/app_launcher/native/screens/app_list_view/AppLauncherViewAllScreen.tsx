...
// Dependencies: [19, 17, 1482, 21, 4636, 576, 12264, 1611, 11352, 12184, 7626, 5204, 1114, 5709, 4632, 1176, 12226, 12189, 12262, 12231, 12234, 12235, 12185, 9539, 2]
// Exports: default

// Module 12328 (AppLauncherViewAllScreen)
...
import AppLauncherBackButton from "AppLauncherBackButton" /* 12264 */;
...
let size = { width: fn(12264).BACK_BUTTON_SIZE, height: fn(12264).BACK_BUTTON_SIZE, alignItems: "center", justifyContent: "center" };
