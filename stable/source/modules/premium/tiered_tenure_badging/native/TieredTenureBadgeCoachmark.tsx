...
// Dependencies: [32, 19, 17, 1074, 1954, 21, 4636, 11296, 5668, 7736, 1943, 7491, 1114, 7485, 11265, 2]
// Exports: default

// Module 11327 (TieredTenureBadgeCoachmark)
...
export default function TieredTenureBadgeCoachmark(arg0) {
  ...
  const coachmark = tieredTenureBadgeData(11265).useCoachmark(targetRef, memo);
  return null;
};
