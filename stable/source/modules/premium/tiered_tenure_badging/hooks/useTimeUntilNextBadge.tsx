...
// Dependencies: [19, 4228, 13521, 11322, 2]
// Exports: computeDaysUntilNextBadgeDate, useTimeUntilNextBadge

// Module 13520 (useTimeUntilNextBadge)
...
export const useTimeUntilNextBadge = function useTimeUntilNextBadge() {
  nextTenureBadge = nextTenureBadge(13521).useNextTenureBadge();
  let obj = nextTenureBadge(13521);
  const premiumSince = nextTenureBadge(11322).usePremiumSince();
