...
// Dependencies: [19, 17, 4628, 10794, 1074, 1954, 21, 4636, 576, 1363, 504, 10885, 17043, 8390, 4603, 7265, 7285, 10790, 7253, 8935, 5668, 4632, 5056, 11168, 1114, 2]
// Exports: default
...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  const themeAndReducedMotionAwareAssetUrl = markAsDismissed(10885).useThemeAndReducedMotionAwareAssetUrl(asset);
  let obj2 = markAsDismissed(10885);
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      obj10.icon = tmp18(tmp2(11168).GiftIcon, obj11);
