...
// Dependencies: [32, 19, 17, 1074, 12832, 21, 4636, 576, 5763, 5063, 4632, 4481, 1396, 5685, 1176, 1114, 4338, 4486, 11, 8716, 9003, 5068, 1093, 5056, 1240, 2]
// Exports: default

// Module 12831 (ContactSyncSuggestions)
...
const SuggestedFriendSource = fn(12832).SuggestedFriendSource;
const jsxProd = fn(21);
