...
// Dependencies: [5, 19, 1371, 12812, 1074, 21, 12813, 4335, 1114, 5678, 12817, 1240, 12809, 504, 1935, 1384, 8716, 4839, 14935, 1896, 2]
...
export default function ContactSyncSettings() {
  contactSyncAccount = contactSyncAccount(12813).useContactSyncAccount();
  let obj = contactSyncAccount(12813);
  ...
  const tmpResult = contactSyncAccount(12813);
  const FriendDiscoverySettings = tmp(1935).FriendDiscoverySettings;
  const setting = FriendDiscoverySettings.useSetting();
  const isContactSyncEnabledResult = contactSyncAccount(12813).isContactSyncEnabled(contactSyncAccount);
  ...
  if (isStaffResult) {
    ...
    const obj5 = { label: "STAFF ONLY - Find your friends deletion", value: true, onValueChange: tmp(12813).adminDeleteContactSync };
  ...
  obj11.children = intl4.format(contactSyncAccount(1114).t.BoR0dO, { onClick: contactSyncAccount(12813).handleOpenLearnMoreLink });
