...
// Dependencies: [19, 17, 4628, 11726, 1074, 21, 4636, 576, 504, 11724, 1240, 4603, 11730, 10096, 11731, 7253, 4632, 1114, 5056, 8785, 2]
// Exports: default

// Module 11729 (GroupDMNitroCapLimitSheet)
import nativeDefault from "native" /* 576 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1240 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4603 */;
import usePremiumFeatureUpsellGetNitroDefault from "usePremiumFeatureUpsellGetNitro" /* 10096 */;
import PremiumMarketingUtil from "PremiumMarketingUtil" /* 11730 */;
import useGroupDMNitroUpsellActionDefault from "useGroupDMNitroUpsellAction" /* 11731 */;
import noop from "module_19" /* 19 */;
import AccessibilityStore from "AccessibilityStore" /* 4628 */;

require = fn;
const View = fn(17).View;
const number = fn(11726).MAX_GROUP_DM_NITRO_PARTICIPANTS;
...
export default function GroupDMNitroCapLimitSheet(location) {
  ...
  const groupDMNitroAudience = _location(11724).useGroupDMNitroAudience();
  importDefault = tmp6;
  ...
  let obj2 = _location(11724);
  let obj3 = noop;
  obj4.acquisitionStrategy = _location(11724).GroupDMNitroAcquisitionStrategy.CHECKOUT;
  ...
  obj11.text = intl3.string(_location(11724).getGroupDMNitroCapCTAMessage(groupDMNitroAudience));
  const tmp2Result = _location(11724);
