...
// Dependencies: [19, 17, 1074, 21, 4636, 576, 9372, 8457, 1114, 4336, 9551, 9352, 7483, 4632, 9553, 2]
// Exports: default
...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(OAuth2Scopes.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    const obj3 = { iconComponent: tmp4(4336).FriendsIcon, text: null };
    ...
    const obj6 = { iconComponent: tmp4(9551).ChatSmileIcon, text: null };
    ...
    const obj7 = { iconComponent: tmp4(9352).GameControllerIcon, text: null };
    ...
    let obj8 = { iconComponent: tmp4(7483).SettingsIcon, text: null };
    ...
    if (accountScopes.includes(tmp4(8457).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      const obj9 = { iconComponent: tmp4(4336).FriendsIcon, text: null };
      ...
      const obj12 = { iconComponent: tmp4(9352).GameControllerIcon, text: null };
      ...
      const obj13 = { iconComponent: tmp4(7483).SettingsIcon, text: null };
    ...
    if (0 !== items.length) {
      ...
      if (null != arr2) {
        ...
        if (arr2.length > 0) {
          ...
          tmp27 = hasOwnProperty(tmp4(4632).Text, obj15);
        }
      }
      ...
      const items2 = [timestampProducer(View, obj14), hasOwnProperty(tmp4(9553).AuthorizeFormSeparator, {})];
