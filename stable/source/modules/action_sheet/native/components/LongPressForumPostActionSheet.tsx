...
// Dependencies: [19, 4276, 4277, 7409, 502, 1979, 4651, 1074, 1964, 21, 10351, 10372, 1114, 10373, 10375, 7071, 7213, 4577, 7867, 9906, 4599, 4589, 10377, 5176, 10379, 10380, 11, 7285, 7483, 8748, 11387, 4603, 11385, 1896, 4579, 11389, 9188, 10272, 11097, 11449, 11089, 4980, 4594, 7559, 1176, 10758, 7292, 4334, 504, 7407, 7372, 7989, 1935, 4789, 11110, 5665, 7300, 1608, 11136, 7302, 2]
// Exports: default
...
import useFavoritesGuildChannelActionsDefault from "useFavoritesGuildChannelActions" /* 11110 */;
    ...
    if (!stateFromStores3) {
      ...
      if (canManageThread) {
        ...
        if (parentChannel.availableTags.length > 0) {
          ...
          obj26.IconComponent = tmp(11387).TagsIcon;
          obj26.onPress = function onPress() {
            ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11385, dependencyMap.paths), "ForumPostTagsActionSheet", { thread, parentChannel, canManageThread });
          };
          buttons7.push(obj26);
        }
      }
      ...
      if (stateFromStores4) {
        ...
        if (isThreadModerator) {
          ...
          if (hasFlagResult) {
            ...
            obj29.IconComponent = tmp(11089).PinIcon;
        ...
        if (!isThreadModerator) {
          if (!tmp24) {
            ...
            obj32.header = tmp20(tmp(11136).ActionSheetIconHeader, obj33);
        ...
        obj37.IconComponent = tmp(11097).ChannelNotificationIcon;
