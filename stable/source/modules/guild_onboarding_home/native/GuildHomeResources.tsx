...
// Dependencies: [19, 17, 1957, 2012, 4857, 4275, 1074, 21, 4636, 576, 504, 8001, 12142, 16669, 7559, 12417, 1396, 5204, 4632, 4626, 16662, 1100, 1114, 16670, 5056, 2]
// Exports: default
...
function ResourceChannelRow(channelId) {
  ...
  let flag = channelId(12142).useSharedMediaProps({ channel: stateFromStores, media: first }).shouldObscure;
        ...
        if (null != firstResult) {
          ...
          if (!blocked) {
            ...
            if (null != first) {
              ...
              tmp19Result6 = tmp19(tmp2(12142).ForumPostMediaThumbnail, obj17);
