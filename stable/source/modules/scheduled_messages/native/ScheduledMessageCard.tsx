...
// Dependencies: [19, 17, 1957, 1074, 21, 4636, 576, 504, 1100, 4839, 5688, 12348, 5658, 12349, 10240, 4632, 1114, 7947, 12350, 12342, 12351, 2]

// Module 12347 (ScheduledMessageCard)
import nativeDefault from "native" /* 576 */;
import router_utils from "router_utils" /* 1100 */;
import ModalActionCreatorsDefault from "ModalActionCreators" /* 4839 */;
import ScheduledMessageUtils from "ScheduledMessageUtils" /* 7947 */;
import CalendarPlusIcon from "CalendarPlusIcon" /* 12342 */;
import ForLaterCardStatusHeader from "ForLaterCardStatusHeader" /* 12350 */;
import ScheduledMessageCardActionButtonsDefault from "ScheduledMessageCardActionButtons" /* 12351 */;
...
export default noop.memo(function ScheduledMessageCard(scheduledMessage) {
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = closure_7(tmp2(12348).ForLaterCardHeader, obj4);
    ...
    if (isPendingRemoval) {
      ...
      tmp10Result = tmp10(tmp2(12349).ForLaterMessageRow, obj7);
    }
