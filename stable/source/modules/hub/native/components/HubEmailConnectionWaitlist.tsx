...
// Dependencies: [19, 17, 1074, 21, 4636, 576, 1483, 7480, 1114, 12868, 1176, 4632, 5056, 2]
// Exports: default

// Module 12867 (HubEmailConnectionWaitlist)
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  const items1 = [closure_6(closure_5, { source: navigation(12868), style: tmp.header }), , , ];
