...
// Dependencies: [32, 1186, 10801, 1943, 10800, 10799, 2]

// Module 10805 (mobile_bottom_sheet)
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(assetUrl, tag, writeUnknownFields) {
  ...
  if ("" !== assetUrl.helpArticleId) {
    tag.tag(4, _mod1186.WireType.LengthDelimited).string(assetUrl.helpArticleId);
  ...
  if (assetUrl.button) {
    ...
    const joined = CTAButton.internalBinaryWrite(assetUrl.button, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = CTAButton.internalBinaryWrite(assetUrl.button, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (0 !== assetUrl.dismissibleContent) {
    tag.tag(6, _mod1186.WireType.Varint).int32(assetUrl.dismissibleContent);
  ...
  if (assetUrl.helpArticle) {
    ...
    const joined1 = HelpArticle.internalBinaryWrite(assetUrl.helpArticle, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = HelpArticle.internalBinaryWrite(assetUrl.helpArticle, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (assetUrl.headerLocalized) {
    const LocalizedString = localized_string.LocalizedString;
    const tagResult7 = tag.tag(8, _mod1186.WireType.LengthDelimited);
    const joined2 = LocalizedString.internalBinaryWrite(assetUrl.headerLocalized, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = LocalizedString.internalBinaryWrite(assetUrl.headerLocalized, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (assetUrl.bodyLocalized) {
    const LocalizedString2 = localized_string.LocalizedString;
    const tagResult8 = tag.tag(9, _mod1186.WireType.LengthDelimited);
    const joined3 = LocalizedString2.internalBinaryWrite(assetUrl.bodyLocalized, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = LocalizedString2.internalBinaryWrite(assetUrl.bodyLocalized, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
