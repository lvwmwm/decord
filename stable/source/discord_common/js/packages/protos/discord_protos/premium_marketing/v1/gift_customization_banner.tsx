...
// Dependencies: [32, 1186, 10807, 10809, 10799, 2]

// Module 10811 (gift_customization_banner)
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(assetUrl, tag, writeUnknownFields) {
  ...
  if ("" !== assetUrl.desktopBody) {
    tag.tag(2, _mod1186.WireType.LengthDelimited).string(assetUrl.desktopBody);
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
  }
  if ("" !== assetUrl.mobileBody) {
    tag.tag(3, _mod1186.WireType.LengthDelimited).string(assetUrl.mobileBody);
  ...
  if (assetUrl.gradient) {
    ...
    const joined = Gradient.internalBinaryWrite(assetUrl.gradient, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = Gradient.internalBinaryWrite(assetUrl.gradient, tag.tag(4, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("" !== assetUrl.backgroundAssetUrl) {
    tag.tag(5, _mod1186.WireType.LengthDelimited).string(assetUrl.backgroundAssetUrl);
  ...
  if (assetUrl.asset) {
    ...
    const joined1 = ThemeAwareAsset.internalBinaryWrite(assetUrl.asset, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = ThemeAwareAsset.internalBinaryWrite(assetUrl.asset, tag.tag(6, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (assetUrl.backgroundAsset) {
    ...
    const joined2 = ThemeAwareAsset2.internalBinaryWrite(assetUrl.backgroundAsset, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = ThemeAwareAsset2.internalBinaryWrite(assetUrl.backgroundAsset, tag.tag(7, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (assetUrl.mobileBackgroundAsset) {
    ...
    const joined3 = ThemeAwareAsset3.internalBinaryWrite(assetUrl.mobileBackgroundAsset, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = ThemeAwareAsset3.internalBinaryWrite(assetUrl.mobileBackgroundAsset, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (0 !== assetUrl.assetVariant) {
    tag.tag(9, _mod1186.WireType.Varint).int32(assetUrl.assetVariant);
  ...
  if (assetUrl.desktopBodyLocalized) {
    ...
    const joined4 = LocalizedString.internalBinaryWrite(assetUrl.desktopBodyLocalized, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = LocalizedString.internalBinaryWrite(assetUrl.desktopBodyLocalized, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (assetUrl.mobileBodyLocalized) {
    const LocalizedString2 = localized_string.LocalizedString;
    const tagResult10 = tag.tag(11, _mod1186.WireType.LengthDelimited);
    const joined5 = LocalizedString2.internalBinaryWrite(assetUrl.mobileBodyLocalized, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = LocalizedString2.internalBinaryWrite(assetUrl.mobileBodyLocalized, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
