...
// Dependencies: [2025, 10494, 1074, 1084, 4816, 10496, 10497, 1270, 573, 12, 1254, 1365, 10072, 1940, 1220, 4980, 1114, 1240, 2]
      ...
      if (null != tmp3.gifSrc) {
        if ("" !== tmp3.gifSrc) {
          ...
          if (FavoriteGIFs.toBinary(gifs).length > closure_2_10) {
            ...
            tmp(1240).track(constants.GIF_FAVORITED, obj6);
          }
