...
// Dependencies: [5, 5639, 7629, 1961, 502, 1957, 2012, 2021, 1979, 8497, 4620, 4275, 4285, 4458, 1371, 1074, 1098, 1964, 4678, 7838, 5495, 1384, 8510, 7325, 1112, 1100, 5492, 1896, 8511, 9218, 4691, 4778, 13064, 7626, 5138, 5650, 9676, 7198, 9919, 573, 13065, 4847, 13066, 5601, 1240, 1270, 4538, 1090, 4829, 1248, 1969, 4621, 5603, 7314, 4317, 13068, 13069, 11568, 4959, 4877, 13070, 13071, 1253, 13073, 2]
...
import CodedLinkActionCreatorsDefault from "CodedLinkActionCreators" /* 11568 */;
import generateDynamicLinkDefault from "generateDynamicLink" /* 13071 */;
...
export default {
  resolveInvite(code, arg1, arg2) {
    ...
    if (obj.isDispatching()) {
      ...
      nextPromise = tmp(13065)(code, arg1, arg2).then((result) => {
        ({ invite, code } = result);
        if (null != invite) {
          const obj2 = { type: "INVITE_RESOLVE_SUCCESS", invite, code };
          closure_1(dependencyMap[39]).dispatch(obj2);
      ...
      const promise = tmp(13065)(code, arg1, arg2);
    }
    return nextPromise;
  },
  ...
  transitionToInvite(flags, arg1) {
    ...
    if (null != guild) {
      ...
      if (hasItem) {
        obj(13068).onOpenHubInvite(flags);
        const obj6 = obj(13068);
      }
    }
    let num = flags.flags;
    if (num == null) {
      ...
      if (!hasFlagResult) {
        if (flags.new_member) {
          if (tmp6Result3.inviteGuildHasPendingMemberDisabledVerification(guild)) {
            const result1 = tmp6(13069).openVerificationModalOrTransitionToApplication(guild.id);
            const tmp6Result4 = tmp6(13069);
          }
          tmp6Result3 = tmp6(13069);
        }
      }
    }
    if (null != channel) {
  ...
  openApp(code, targetChannelId, fingerprint, username, inviteType) {
    ...
    if ("Android" !== family) {
      ...
      if ("iOS" !== family1) {
        ...
        tmp7(13073).launch(combined, (arg0) => {
          if (arg0) {
    ...
    const attemptId = tmp18(13071).generateAttemptId();
    inviteType = undefined;
    const tmp18Result = tmp18(13071);
    if (inviteType != null) {
