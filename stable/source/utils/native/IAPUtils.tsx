...
// Function ID: 11186
// Name: IAPUtils
// Dependencies: [5, 17, 4635, 4852, 1371, 7340, 1074, 1373, 11186, 3, 38, 1363, 11205, 7343, 12, 1254, 4309, 504, 11206, 1362, 4615, 11207, 2]
// Exports: makeIAPRequest, manageSubscription, shouldMockIAPForceEnable, useCanPurchaseIAP

// Module 11185 (IAPUtils)
...
import StorekitIAPQueueDefault from "StorekitIAPQueue" /* 11205 */;
import GeneratedPaymentCurrencies from "GeneratedPaymentCurrencies" /* 11206 */;
      ...
      if (0 === c4) {
        if (arg0 === 1) {
          ...
          if (isStorekit2Available()) {
            ...
            c4 = 2;
            c5 = 1;
            const obj6 = { value: require("module_11186").getStorefront(), done: false };
            return obj6;
          } else {
            c5 = 3;
...
let items = [fn(11186).ErrorCode.E_USER_CANCELLED, Constants.StoreKitErrors.PAYMENT_CANCELED];
            ...
            if (0 === c6) {
              if (arg0 === 1) {
                ...
                if (null != currentUser.getCurrentUser()) {
                  ...
                  c6 = 2;
                  c7 = 1;
                  const obj5 = { value: sku(11186).clearTransactionIOS(), done: false };
                  return obj5;
                } else {
                  const _Error2 = Error;
              ...
              if (1 === tmp7) {
                ...
                if (arg0 === 1) {
                  ...
                  c6 = 3;
                  c7 = 1;
                  const obj9 = { value: sku(11186).requestPurchase(obj8), done: false };
                  return obj9;
                }
              } else if (arg0 === 1) {
                c7 = 3;
          ...
          if (0 === c6) {
            if (arg0 === 1) {
              ...
              if (null != currentUser) {
                ...
                c6 = 2;
                c7 = 1;
                const obj7 = { value: requestJSONString(11186).requestPurchase(obj6), done: false };
                return obj7;
              } else {
                const _Error2 = Error;
                const error = new Error("purchaseProduct: no valid user");
